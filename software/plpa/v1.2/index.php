...
include_once("$topdir/software/plpa/v1.2/version.inc");
$title = "Portable Linux Processor Affinity (PLPA): Version $ver_v1_2";
...
<P><?php $dir = "svn.open-mpi.org/svn/plpa/branches/v$ver_v1_2/NEWS";
      print("<a href=\"http://$dir\">"); ?>This
file</a> contains a list of changes between the releases in the PLPA
releases in the v<?php print($ver_v1_2); ?> series</p>
