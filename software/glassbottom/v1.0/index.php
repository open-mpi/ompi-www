...
$title = "GlassBottom: Version $ver_v1_0";

include_once("$topdir/projects/glassbottom/nav.inc");
...
if (isset($t_stable)) {
    ...
    $n[] = "glassbottom-$ver_v1_0.tar.bz2";
    $n[] = "glassbottom-$ver_v1_0.tar.gz";
    $n[] = "glassbottom-$ver_v1_0-1.src.rpm";
...
if (preg_match("/[a-z]/i", $v) &&
    (file_exists("downloads/glassbottom-$v.tar.bz2") ||
     file_exists("downloads/glassbottom-$v.tar.gz") ||
     file_exists("downloads/glassbottom-$v-1.src.rpm"))) {
    ...
    $n = array();
    $n[] = "glassbottom-$v.tar.bz2";
    $n[] = "glassbottom-$v.tar.gz";
    $n[] = "glassbottom-$v-1.src.rpm";
...
?>/software/glassbottom/versions/timeline.php">version timeline</a> for
information on the chronology of glassbottom releases.</p>
