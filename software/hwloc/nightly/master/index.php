<?php
  ...
  $title = "Hardware Locality (hwloc): Master nightly snapshot tarballs";
  include_once("$topdir/projects/hwloc/nav.inc");
  include_once("$topdir/includes/header.inc");
  include_once("$topdir/includes/downloads.inc");
  include_once("$topdir/includes/mailto.inc");
  $dir = "$topdir/software/hwloc/nightly/master";
?>
...
<?php
$latest = get_latest_snapshot("open-mpi-nightly", "nightly/hwloc/master/");
if ($latest == "") {
    ...
    print_nightly_table("open-mpi-nightly", "nightly/hwloc/master/",
                        "https://download.open-mpi.org/nightly/hwloc/master/");
