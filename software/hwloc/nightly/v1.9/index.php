<?php
  ...
  $title = "Hardware Locality (hwloc): v1.9 series nightly snapshot tarballs";
  include_once("$topdir/projects/hwloc/nav.inc");
  include_once("$topdir/includes/header.inc");
  include_once("$topdir/includes/downloads.inc");
  $dir = "$topdir/software/hwloc/nightly/v1.9";
?>
...
<p>Tarballs are made from the Git v1.9 branch nightly at approximately
