...
if (isset($t_stable)) {
    ...
    $names = array("hwloc-$ver_v1_11.tar.gz", "hwloc-$ver_v1_11.tar.bz2",
		   "hwloc-win32-build-$ver_v1_11.zip", "hwloc-win64-build-$ver_v1_11.zip");
...
if (isset($t_older)) {
    $versions = array("1.11.9", "1.11.8", "1.11.7", "1.11.6", "1.11.5", "1.11.4", "1.11.3", "1.11.2", "1.11.1", "1.11.0");
...
$prev_describe = "the v$ver_v1_11 download page";
...
<P><?php print("<a href=\"https://raw.github.com/open-mpi/hwloc/$ver_v1_11_dir/NEWS\">"); ?>This
file</a> contains a list of changes between the releases in the hwloc
releases in the <?php print($ver_v1_11_dir); ?> series</p>
