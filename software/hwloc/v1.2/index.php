...
include_once("$topdir/software/hwloc/v1.2/version.inc");
$title = "Portable Hardware Locality (hwloc): Version $ver_v1_2";
...
if (isset($t_stable)) {
    $src = "Version $ver_v1_2";
    $names = array("hwloc-$ver_v1_2.tar.gz", "hwloc-$ver_v1_2.tar.bz2",
                   "hwloc-win32-build-$ver_v1_2.zip");
...
<P><?php print("<a href=\"https://raw.github.com/open-mpi/hwloc/$ver_v1_2_dir/NEWS\">"); ?>This
