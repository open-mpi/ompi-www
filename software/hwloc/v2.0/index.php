...
include_once("$topdir/software/hwloc/v2.0/version.inc");
$title = "Portable Hardware Locality (hwloc): Version $ver_v2_0";
...
$prev_describe = "the v$ver_v2_0 download page";
...
<P><?php print("<a href=\"https://raw.github.com/open-mpi/hwloc/$ver_v2_0_dir/NEWS\">"); ?>This
file</a> contains a list of changes between the releases in the hwloc
releases in the <?php print($ver_v2_0_dir); ?> series</p>
