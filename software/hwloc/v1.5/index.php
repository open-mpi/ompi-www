...
include_once("$topdir/software/hwloc/v1.5/version.inc");
$title = "Portable Hardware Locality (hwloc): Version $ver_v1_5";
...
if (isset($t_stable)) {
    $src = "Version $ver_v1_5";
    $names = array("hwloc-$ver_v1_5.tar.gz", "hwloc-$ver_v1_5.tar.bz2",
		   "hwloc-win32-build-$ver_v1_5.zip", "hwloc-win64-build-$ver_v1_5.zip");
...
<P><?php print("<a href=\"https://raw.github.com/open-mpi/hwloc/$ver_v1_5_dir/NEWS\">"); ?>This
file</a> contains a list of changes between the releases in the hwloc
releases in the <?php print($ver_v1_5_dir); ?> series</p>
