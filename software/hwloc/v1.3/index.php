...
include_once("$topdir/software/hwloc/v1.3/version.inc");
$title = "Portable Hardware Locality (hwloc): Version $ver_v1_3";
...
if (isset($t_stable)) {
    ...
    $names = array("hwloc-$ver_v1_3.tar.gz", "hwloc-$ver_v1_3.tar.bz2",
		   "hwloc-win32-build-$ver_v1_3.zip", "hwloc-win64-build-$ver_v1_3.zip");
...
if (isset($t_older)) {
    $versions = array("1.3.2", "1.3.1", "1.3");
...
<P><?php print("<a href=\"https://raw.github.com/open-mpi/hwloc/$ver_v1_3_dir/NEWS\">"); ?>This
file</a> contains a list of changes between the releases in the hwloc
releases in the <?php print($ver_v1_3_dir); ?> series</p>
