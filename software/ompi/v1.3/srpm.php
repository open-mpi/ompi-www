<?php
  ...
  $title = "Open MPI: Version $ver_v1_3 Source RPM Notes";
  ...
  $base_url = "http://svn.open-mpi.org/svn/ompi/branches/v1.3";
...
<p>The text below is specific to the v1.3 series of Open MPI and <a
