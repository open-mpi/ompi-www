...
$title = "Open MPI: Version $ver_v1_7";
...
if (isset($t_stable)) {
    $src = "Version $ver_v1_7<br>$notes";

    $n[] = "openmpi-$ver_v1_7.tar.bz2";
    $n[] = "openmpi-$ver_v1_7.tar.gz";
    $n[] = "openmpi-$ver_v1_7-1.src.rpm";
    $n[] = "openmpi-$ver_v1_7-2.src.rpm";
    $n[] = "openmpi-$ver_v1_7-1.dmg.gz";
    $n[] = "openmpi-$ver_v1_7-1.dmg.bz2";
    $n[] = "OpenMPI_v$ver_v1_7-1_win32.exe";
    $n[] = "OpenMPI_v$ver_v1_7-1_win64.exe";
    # Need this for some versions
    $n[] = "OpenMPI_v$ver_v1_7-2_win32.exe";
    $n[] = "OpenMPI_v$ver_v1_7-2_win64.exe";
...
<P><?php $dir = "https://github.com/open-mpi/ompi-release/blob/v1.7/NEWS";
      print("<a href=\"$dir\">"); ?>This
file</a> contains a list of changes between the releases in the Open
MPI releases in the v1.7 series</p>
