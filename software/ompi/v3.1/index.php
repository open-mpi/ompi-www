...
$title = "Open MPI: Version $ver_v3_1";
...
if (isset($t_stable)) {
    ...
    $n[] = "openmpi-$ver_v3_1.tar.bz2";
    $n[] = "openmpi-$ver_v3_1.tar.gz";
    $n[] = "openmpi-$ver_v3_1-1.src.rpm";
