...
$title = "Open MPI: Version $ver_v2_1";
...
if (isset($t_stable)) {
    $src = "Version $ver_v2_1<br>$notes";
    $check = False;

    $n[] = "openmpi-$ver_v2_1.tar.bz2";
    $n[] = "openmpi-$ver_v2_1.tar.gz";
    $n[] = "openmpi-$ver_v2_1-1.src.rpm";
...
MPI releases in the v2.1 series</p>
