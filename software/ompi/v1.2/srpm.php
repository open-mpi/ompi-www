<?php
  ...
  $title = "Open MPI: Version $ver_v1_2 Source RPM Notes";
  ...
  # JMS needs to change when it is finally committed to trunk
  $base_url = "http://svn.open-mpi.org/svn/ompi/branches/v1.2";
...
<p>The text below is specific to the v1.2 series of Open MPI and <a
