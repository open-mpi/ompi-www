<?php
  ...
  $title = "Open MPI: Version $ver_v1_6 Windows Binary Installer Notes";
...
<p><blockquote>
<div align="center"><strong><font color="red">NOTE - NOTE - NOTE -
NOTE - NOTE</font></strong></div>

<p>Due to
lack of interest and anyone to maintain them, binary support for a
Microsoft Windows Open MPI build has been discontinued.  There will be
no further releases of them unless a new maintainer can be found.
Windows-based Open MPI users may choose to use the <a
href="http://cygwin.com/packages/">Cygwin-based Open MPI
builds</a>, instead.<p>
