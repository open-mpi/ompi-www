...
news("Open MPI v3.1.0 released",
     "Bug fix release",
     "https://www.mail-archive.com/announce@lists.open-mpi.org//msg00109.html");
news("Open MPI v3.0.1 released",
     "Bug fix release",
     "https://www.mail-archive.com/announce@lists.open-mpi.org//msg00108.html");
news("Open MPI v2.1.3 released",
     "Bug fix release",
     "https://www.mail-archive.com/announce@lists.open-mpi.org//msg00107.html");
news("Open MPI v2.0.4 released",
     "Bug fix release -- likely the last in the v2.0.x series",
...
news("Open MPI v1.10.7 released",
     "Bug fix release - final in the v1.10.x series",
     "https://www.mail-archive.com/announce@lists.open-mpi.org/msg00100.html");
news("hwloc v2.0.1 released",
     "Stable release",
     "https://mail-archive.com/hwloc-announce@lists.open-mpi.org/msg00112.html");
?>
