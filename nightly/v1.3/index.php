<?php
  ...
  $title = "Open MPI: v1.3 nightly snapshot tarballs";
  include_once("$topdir/software/ompi/nav.inc");
  include_once("$topdir/includes/header.inc");
  include_once("$topdir/includes/downloads.inc");
  $dir = "$topdir/nightly/v1.3";
?>
...
the v1.3 branch in the Git ompi repository.  This may be less than once a day!</p>

<p>Tarballs are made from the Git v1.3 branch nightly at approximately
9pm US Eastern time.</p>

<?php
$latest = get_latest_snapshot("open-mpi-nightly", "nightly/open-mpi/v1.3/");
if ($latest == "") {
    ...
    print_nightly_table("open-mpi-nightly", "nightly/open-mpi/v1.3/",
                        "https://download.open-mpi.org/nightly/open-mpi/v1.3/");
