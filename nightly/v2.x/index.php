...
<?php
$latest = get_latest_snapshot("open-mpi-nightly", "nightly/open-mpi/v2.x/");
if ($latest == "") {
    ...
    print_nightly_table("open-mpi-nightly", "nightly/open-mpi/v2.x/",
                        "https://download.open-mpi.org/nightly/open-mpi/v2.x/");
