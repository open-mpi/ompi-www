...
<p>These are snapshots of the 1.2 branch of the Open MPI source code.
...
<p>Tarballs are made from the Git <code>v1.2</code> branch
nightly at approximately 9pm US Eastern time.</p>

<?php
$latest = get_latest_snapshot("open-mpi-nightly", "nightly/open-mpi/v1.2/");
if ($latest == "") {
    ...
    print_nightly_table("open-mpi-nightly", "nightly/open-mpi/v1.2/",
                        "https://download.open-mpi.org/nightly/open-mpi/v1.2/");
