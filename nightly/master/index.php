...
<?php
$latest = get_latest_snapshot("open-mpi-nightly", "nightly/open-mpi/master/");
if ($latest == "") {
    ...
    print_nightly_table("open-mpi-nightly", "nightly/open-mpi/master/",
                        "https://download.open-mpi.org/nightly/open-mpi/master/");
