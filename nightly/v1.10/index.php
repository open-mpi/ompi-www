...
<?php
$latest = get_latest_snapshot("open-mpi-nightly", "nightly/open-mpi/v1.10/");
if ($latest == "") {
    ...
    print_nightly_table("open-mpi-nightly", "nightly/open-mpi/v1.10/",
                        "https://download.open-mpi.org/nightly/open-mpi/v1.10/");
