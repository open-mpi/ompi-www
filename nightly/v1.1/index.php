<?php
  ...
  $title = "Open MPI: 1.1 series nightly snapshot tarballs";
  include_once("$topdir/software/ompi/nav.inc");
  include_once("$topdir/includes/header.inc");
  include_once("$topdir/includes/downloads.inc");
  $dir = "$topdir/nightly/v1.1";
?>
...
<?php
$latest = get_latest_snapshot("open-mpi-nightly", "nightly/open-mpi/v1.1/");
if ($latest == "") {
    ...
    print_nightly_table("open-mpi-nightly", "nightly/open-mpi/v1.1/",
                        "https://download.open-mpi.org/nightly/open-mpi/v1.1/");
