<?
$subject_val = "[Open MPI Announce] 1.10.1rc2 available";
...
<!-- subject="[Open MPI Announce] 1.10.1rc2 available" -->
...
<p class="headers">
<strong>Subject:</strong> [Open MPI Announce] 1.10.1rc2 available<br>
<strong>From:</strong> Jeff Squyres (jsquyres) (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2015-10-08 10:47:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0075.php">Jeff Squyres (jsquyres): "[Open MPI Announce] Open MPI State of the Union BOF @SC15"</a>
<li><strong>Previous message:</strong> <a href="0073.php">Jeff Squyres (jsquyres): "[Open MPI Announce] Open MPI v1.10.1rc1 release"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
