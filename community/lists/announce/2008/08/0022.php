<?
$subject_val = "[Open MPI Announce] Open MPI v1.2.7 released";
...
<!-- subject="[Open MPI Announce] Open MPI v1.2.7 released" -->
...
<p class="headers">
<strong>Subject:</strong> [Open MPI Announce] Open MPI v1.2.7 released<br>
<strong>From:</strong> Tim Mattox (<em>timattox_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-08-28 10:47:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0023.php">Tim Mattox: "[Open MPI Announce] [OMPI users] Open MPI v1.2.7 released"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/announce/2008/05/0021.php">Jeff Squyres: "Re: [Open MPI Announce] Open MPI instructional videos"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
