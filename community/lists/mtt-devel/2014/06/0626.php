...
?>
<!-- received="Mon Jun 23 04:37:03 2014" -->
<!-- isoreceived="20140623083703" -->
<!-- sent="Mon, 23 Jun 2014 11:37:01 +0300" -->
<!-- isosent="20140623083701" -->
<!-- name="Mike Dubman" -->
<!-- email="miked_at_[hidden]" -->
<!-- subject="Re: [MTT devel] [MTT svn] GIT: MTT branch master updated. 016088f2a0831b32ab5fd6f60f4cabe67e92e594" -->
<!-- id="CAAO1KyYLi6CRpkZO2ba57uUU6_a=9+0wfUhO7bGpLNgWcedXKg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="20140621123008.ADEF925EFEF_at_jaguar.crest.iu.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-23 04:37:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0627.php">Jeff Squyres (jsquyres): "Re: [MTT devel] [MTT svn] GIT: MTT branch master updated.	016088f2a0831b32ab5fd6f60f4cabe67e92e594"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/mtt-devel/2014/04/0625.php">Jeff Squyres (jsquyres): "[MTT devel] MTT moved to final github location"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0627.php">Jeff Squyres (jsquyres): "Re: [MTT devel] [MTT svn] GIT: MTT branch master updated.	016088f2a0831b32ab5fd6f60f4cabe67e92e594"</a>
<li><strong>Reply:</strong> <a href="0627.php">Jeff Squyres (jsquyres): "Re: [MTT devel] [MTT svn] GIT: MTT branch master updated.	016088f2a0831b32ab5fd6f60f4cabe67e92e594"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>- some child processes still running after timeout and mtt killed the job.
<br>
<p>before this commit - it worked fine.
<br>
please revert and test more.
<br>
<p><p><p>On Sat, Jun 21, 2014 at 3:30 PM, MPI Team &lt;mpiteam_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; -    return &quot;mpirun died right at end of timeout (MTT did not have to kill
</span><br>
...
<span class="quotelev1">&gt; +    return &quot;$argv0 died right at end of timeout (MTT did not have to kill
</span><br>
<span class="quotelev1">&gt; it)&quot;
</span><br>
...
<span class="quotelev1">&gt; -        Verbose(&quot;** Kill KILL didn't work!  Sleeping and trying
</span><br>
...
<span class="quotelev1">&gt; +        Debug(&quot;=== killing child proc: $process-&gt;{pid},
</span><br>
...
<span class="quotelev1">&gt;                  if (defined($timeout_backtrace_program) and
</span><br>
...
<span class="quotelev1">&gt;                  $gdb_cmd = &quot;gdb - $p --command=$gdb_command_filename
</span><br>
...
<span class="quotelev1">&gt;                  Verbose(&quot;*** Past timeout of $timeout seconds by $over
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/mtt-devel/att-0626/attachment">attachment</a>
</ul>
