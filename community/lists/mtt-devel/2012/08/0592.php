...
?>
<!-- received="Sat Aug  4 12:41:17 2012" -->
<!-- isoreceived="20120804164117" -->
<!-- sent="Sat, 4 Aug 2012 16:40:40 +0000" -->
<!-- isosent="20120804164040" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [MTT devel] [MTT svn] svn:mtt-svn r1481 - in trunk: client	lib/MTT/Reporter" -->
<!-- id="23603558-6A1D-4B08-9538-A5DCA879B3B9_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAL3GGtrgNjGw2faGdJERpR_cm-yApkACYggDDg9Npd5DP+0+=g_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-08-04 12:40:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0593.php">Mike Dubman: "Re: [MTT devel] [MTT svn] svn:mtt-svn r1481 - in trunk: client lib/MTT/Reporter"</a>
<li><strong>Previous message:</strong> <a href="0591.php">Mike Dubman: "Re: [MTT devel] [MTT svn] svn:mtt-svn r1481 - in trunk: client lib/MTT/Reporter"</a>
<li><strong>In reply to:</strong> <a href="0591.php">Mike Dubman: "Re: [MTT devel] [MTT svn] svn:mtt-svn r1481 - in trunk: client lib/MTT/Reporter"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0593.php">Mike Dubman: "Re: [MTT devel] [MTT svn] svn:mtt-svn r1481 - in trunk: client lib/MTT/Reporter"</a>
<li><strong>Reply:</strong> <a href="0593.php">Mike Dubman: "Re: [MTT devel] [MTT svn] svn:mtt-svn r1481 - in trunk: client lib/MTT/Reporter"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Sounds sweet!
<br>
<p>Will you guys be contributing This stuff, perchance?
<br>
<p>Sent from my phone. No type good.
<br>
<p>On Aug 4, 2012, at 11:56 AM, &quot;Mike Dubman&quot; &lt;mike.ompi_at_[hidden]&lt;mailto:mike.ompi_at_[hidden]&gt;&gt; wrote:
<br>
<p>Hi,
<br>
<p>We are switching from datastore (feature we added a couple of years ago) to MongoDB NoSQL DB to keep mtt results.
<br>
<p>We are adding some &quot;regression&quot; capability based on  MTT and MongoDB reporter:
<br>
<p>- run mtt
<br>
- when mtt finishes, extract results for previous runs of the same test with same parameters
<br>
...
<br>
- query results, group them and generate regression statistics, place report into excel (mongo-query.pl&lt;<a href="http://mongo-query.pl">http://mongo-query.pl</a>&gt;)
<br>
- Generate report which can be attached to mtt report (breport.pl&lt;<a href="http://breport.pl">http://breport.pl</a>&gt;)
<br>
<p><p>So, we have reporter and query tool for Mongo, which is simple and customizable.
<br>
<p>regards
<br>
M
<br>
<p><p>On Wed, Aug 1, 2012 at 2:00 PM, Jeff Squyres &lt;jsquyres_at_[hidden]&lt;mailto:jsquyres_at_[hidden]&gt;&gt; wrote:
<br>
Mike --
<br>
...
<br>
<p><p>On Aug 1, 2012, at 5:46 AM, &lt;svn-commit-mailer_at_[hidden]&lt;mailto:svn-commit-mailer_at_[hidden]&gt;&gt; wrote:
<br>
...
<span class="quotelev1">&gt;   trunk/client/mongobquery.pl&lt;<a href="http://mongobquery.pl">http://mongobquery.pl</a>&gt;   (contents, props changed)
</span><br>
<span class="quotelev1">&gt;   trunk/lib/MTT/Reporter/MTTMongodb.pm
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Added: trunk/client/mongobquery.pl&lt;<a href="http://mongobquery.pl">http://mongobquery.pl</a>&gt;
</span><br>
<span class="quotelev1">&gt; ==============================================================================
</span><br>
<span class="quotelev1">&gt; --- /dev/null 00:00:00 1970   (empty, because file is newly added)
</span><br>
<span class="quotelev1">&gt; +++ trunk/client/mongobquery.pl&lt;<a href="http://mongobquery.pl">http://mongobquery.pl</a>&gt;       2012-08-01 05:46:03 EDT (Wed, 01 Aug 2012)      (r1481)
</span><br>
...
<span class="quotelev1">&gt; mtt-svn_at_[hidden]&lt;mailto:mtt-svn_at_[hidden]&gt;
</span><br>
...
mtt-devel_at_[hidden]&lt;mailto:mtt-devel_at_[hidden]&gt;
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/mtt-devel/att-0592/attachment">attachment</a>
</ul>
