...
<!-- received="Mon Oct 15 11:54:42 2007" -->
<!-- isoreceived="20071015155442" -->
<!-- sent="Mon, 15 Oct 2007 11:54:33 -0400" -->
<!-- isosent="20071015155433" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [MTT devel] MTT server error (user: uh)" -->
<!-- id="232FE5BF-8B71-4497-8BCA-B804B46FEC36_at_cisco.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2007-10-15 11:54:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0163.php">Ethan Mallove: "[MTT devel] Handling &quot;Interrupted system call&quot; with MTT"</a>
<li><strong>Previous message:</strong> <a href="0161.php">Josh Hursey: "Re: [MTT devel] MTT server error (user: uh)"</a>
<li><strong>In reply to:</strong> <a href="0159.php">Mohamad Chaarawi: "Re: [MTT devel] MTT server error (user: uh)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0160.php">Jeff Squyres: "Re: [MTT devel] MTT server error (user: uh)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Note that --trial does submit to the db; it just marks the results as  
<br>
&quot;trials&quot;.  And &quot;trial&quot; results don't show up in default searches (you  
<br>
have to specifically enable showing trial results).
<br>
<p><p><p>On Oct 15, 2007, at 11:50 AM, Mohamad Chaarawi wrote:
<br>
