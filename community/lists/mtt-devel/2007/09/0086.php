...
<!-- received="Thu Sep  6 10:25:25 2007" -->
<!-- isoreceived="20070906142525" -->
<!-- sent="Thu, 6 Sep 2007 10:25:21 -0400" -->
<!-- isosent="20070906142521" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [MTT devel] [MTT users]   Test runs not getting into database" -->
<!-- id="1A340991-AE33-48F0-9BF0-7CF3F6A50E53_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2007-09-06 10:25:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0087.php">Josh Hursey: "Re: [MTT devel] [MTT users]   Test runs not getting into database"</a>
<li><strong>Previous message:</strong> <a href="0085.php">Josh Hursey: "Re: [MTT devel] [MTT users] Test runs not getting into database"</a>
<li><strong>In reply to:</strong> <a href="0085.php">Josh Hursey: "Re: [MTT devel] [MTT users] Test runs not getting into database"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0087.php">Josh Hursey: "Re: [MTT devel] [MTT users]   Test runs not getting into database"</a>
<li><strong>Reply:</strong> <a href="0087.php">Josh Hursey: "Re: [MTT devel] [MTT users]   Test runs not getting into database"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>A bit of debug output:
<br>
$_SERVER[&quot;SERVER_NAME&quot;] = s10c2b3.dim
<br>
$mother_site = www.open-mpi.org
<br>
<p>So it looks like the relay is doing something a bit odd. :/
<br>
