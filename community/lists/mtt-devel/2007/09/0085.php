...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0086.php">Josh Hursey: "Re: [MTT devel] [MTT users]   Test runs not getting into database"</a>
<li><strong>Previous message:</strong> <a href="0084.php">Jeff Squyres: "[MTT devel] First cut at MTT web pages"</a>
<li><strong>In reply to:</strong> <a href="0083.php">Josh Hursey: "Re: [MTT devel] [MTT users] Test runs not getting into database"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0086.php">Josh Hursey: "Re: [MTT devel] [MTT users]   Test runs not getting into database"</a>
<li><strong>Reply:</strong> <a href="0086.php">Josh Hursey: "Re: [MTT devel] [MTT users]   Test runs not getting into database"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
