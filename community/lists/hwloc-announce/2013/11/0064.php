<?
$subject_val = "[hwloc-announce] Hardware locality (hwloc) v1.8 released";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Nov 18 09:25:34 2013" -->
<!-- isoreceived="20131118142534" -->
<!-- sent="Mon, 18 Nov 2013 07:25:24 -0700" -->
<!-- isosent="20131118142524" -->
<!-- name="Brice Goglin" -->
<!-- email="Brice.Goglin_at_[hidden]" -->
<!-- subject="[hwloc-announce] Hardware locality (hwloc) v1.8 released" -->
<!-- id="528A2354.1090908_at_inria.fr" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [hwloc-announce] Hardware locality (hwloc) v1.8 released<br>
<strong>From:</strong> Brice Goglin (<em>Brice.Goglin_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-11-18 09:25:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="http://www.open-mpi.org/community/lists/hwloc-announce/2014/01/0065.php">Brice Goglin: "[hwloc-announce] Hardware locality (hwloc) v1.8.1rc1 released"</a>
<li><strong>Previous message:</strong> <a href="0063.php">Brice Goglin: "[hwloc-announce] hwloc @ SC13 next week"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>v1.8 is a major new release series.
<br>
...
<br>
<p><p>Changes since v1.8rc1 only consists in minor documentation updates,
<br>
