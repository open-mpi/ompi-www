<?
$subject_val = "[hwloc-announce] Hardware locality (hwloc) v1.11.0rc1 released";
include("../../include/msg-header.inc");
?>
<!-- received="Tue Jun  2 11:06:40 2015" -->
<!-- isoreceived="20150602150640" -->
<!-- sent="Tue, 02 Jun 2015 17:06:38 +0200" -->
<!-- isosent="20150602150638" -->
<!-- name="Brice Goglin" -->
<!-- email="Brice.Goglin_at_[hidden]" -->
<!-- subject="[hwloc-announce] Hardware locality (hwloc) v1.11.0rc1 released" -->
<!-- id="556DC67E.2000009_at_inria.fr" -->
<!-- charset="utf-8" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [hwloc-announce] Hardware locality (hwloc) v1.11.0rc1 released<br>
<strong>From:</strong> Brice Goglin (<em>Brice.Goglin_at_[hidden]</em>)<br>
<strong>Date:</strong> 2015-06-02 11:06:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0077.php">Brice Goglin: "[hwloc-announce] Hardware locality (hwloc) v1.11.0rc2 released"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/hwloc-announce/2015/01/0075.php">Brice Goglin: "[hwloc-announce] Hardware Locality (hwloc) v1.10.1 released"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0077.php">Brice Goglin: "[hwloc-announce] Hardware locality (hwloc) v1.11.0rc2 released"</a>
<li><strong>Reply:</strong> <a href="0077.php">Brice Goglin: "[hwloc-announce] Hardware locality (hwloc) v1.11.0rc2 released"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>v1.11.0rc1 is the first milestone of a major feature release.
<br>
