<?
$subject_val = "[hwloc-announce] Hardware locality (hwloc) v1.2 released";
include("../../include/msg-header.inc");
?>
<!-- received="Thu Apr 14 16:58:09 2011" -->
<!-- isoreceived="20110414205809" -->
<!-- sent="Thu, 14 Apr 2011 22:58:03 +0200" -->
<!-- isosent="20110414205803" -->
<!-- name="Brice Goglin" -->
<!-- email="Brice.Goglin_at_[hidden]" -->
<!-- subject="[hwloc-announce] Hardware locality (hwloc) v1.2 released" -->
<!-- id="4DA75FDB.2010404_at_inria.fr" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [hwloc-announce] Hardware locality (hwloc) v1.2 released<br>
<strong>From:</strong> Brice Goglin (<em>Brice.Goglin_at_[hidden]</em>)<br>
<strong>Date:</strong> 2011-04-14 16:58:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="http://www.open-mpi.org/community/lists/hwloc-announce/2011/08/0017.php">Brice Goglin: "[hwloc-announce] Hardware Locality (hwloc) v1.2.1rc1 released"</a>
<li><strong>Previous message:</strong> <a href="0015.php">Brice Goglin: "[hwloc-announce] Hardware locality (hwloc) v1.2rc1 released"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>The next release series (v1.3.x) will focus on adding I/O devices to the
<br>
topology.
<br>
<p><pre>
