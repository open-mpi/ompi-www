<?
$subject_val = "[hwloc-announce] Hardware locality (hwloc) v1.5 released";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Jul 30 10:35:45 2012" -->
<!-- isoreceived="20120730143545" -->
<!-- sent="Mon, 30 Jul 2012 16:35:39 +0200" -->
<!-- isosent="20120730143539" -->
<!-- name="Brice Goglin" -->
<!-- email="Brice.Goglin_at_[hidden]" -->
<!-- subject="[hwloc-announce] Hardware locality (hwloc) v1.5 released" -->
<!-- id="50169BBB.4070007_at_inria.fr" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [hwloc-announce] Hardware locality (hwloc) v1.5 released<br>
<strong>From:</strong> Brice Goglin (<em>Brice.Goglin_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-07-30 10:35:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="http://www.open-mpi.org/community/lists/hwloc-announce/2012/10/0044.php">Brice Goglin: "[hwloc-announce] Hardware locality (hwloc) v1.5.1rc1 released"</a>
<li><strong>Previous message:</strong> <a href="0042.php">Brice Goglin: "[hwloc-announce] Hardware locality (hwloc) v1.5rc2 released"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>v1.5 is a major new release series.  It includes many new features and
<br>
