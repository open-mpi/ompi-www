...
use lib ( '/opt/swish-e/2.4.7/lib/swish-e/perl' );
...
sub default_config {
    ...
    return {
        ...
        swish_binary    => '/opt/swish-e/2.4.7/bin/swish-e',  # Location of swish-e binary
        ...
        xtemplate => {
            ...
            file            => 'swish.tt',
            options         => {
                INCLUDE_PATH    => '/opt/swish-e/2.4.7/share/swish-e',
                #PRE_PROCESS     => 'config',
            },
        },
        ...
        xtemplate => {
            ...
            options         => {
                filename            => 'swish.tmpl',
                path                => '/opt/swish-e/2.4.7/share/swish-e',
                die_on_bad_params   => 0,
                loop_context_vars   => 1,
                cache               => 1,
            },
...
sub set_navigation {
    ...
    $self->{query_href} = "search.php" . '?' . join '&amp;', @query_string;
