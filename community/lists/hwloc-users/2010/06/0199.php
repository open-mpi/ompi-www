...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0200.php">Samuel Thibault: "Re: [hwloc-users] [hwloc-devel]  hwloc and rpath"</a>
<li><strong>Previous message:</strong> <a href="0198.php">Jirka Hladky: "[hwloc-users] hwloc is failing for Pentium D"</a>
<li><strong>In reply to:</strong> <a href="0191.php">Jirka Hladky: "Re: [hwloc-users] [hwloc-devel]  hwloc and rpath"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0205.php">Jirka Hladky: "Re: [hwloc-users] [hwloc-devel]  hwloc and rpath"</a>
<li><strong>Reply:</strong> <a href="0205.php">Jirka Hladky: "Re: [hwloc-users] [hwloc-devel]  hwloc and rpath"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
