...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0196.php">Jeff Squyres: "Re: [hwloc-users] [hwloc-devel]    hwloc and rpath"</a>
<li><strong>Previous message:</strong> <a href="0194.php">Jeff Squyres: "Re: [hwloc-users] [hwloc-devel]    hwloc and rpath"</a>
<li><strong>In reply to:</strong> <a href="0194.php">Jeff Squyres: "Re: [hwloc-users] [hwloc-devel]    hwloc and rpath"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0196.php">Jeff Squyres: "Re: [hwloc-users] [hwloc-devel]    hwloc and rpath"</a>
<li><strong>Reply:</strong> <a href="0196.php">Jeff Squyres: "Re: [hwloc-users] [hwloc-devel]    hwloc and rpath"</a>
<li><strong>Reply:</strong> <a href="0201.php">Samuel Thibault: "Re: [hwloc-users] [hwloc-devel]    hwloc and rpath"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
