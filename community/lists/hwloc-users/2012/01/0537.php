...
?>
<!-- received="Mon Jan 30 13:41:04 2012" -->
<!-- isoreceived="20120130184104" -->
<!-- sent="Mon, 30 Jan 2012 13:40:59 -0500" -->
<!-- isosent="20120130184059" -->
<!-- name="Devendar Bureddy" -->
<!-- email="bureddy_at_[hidden]" -->
<!-- subject="Re: [hwloc-users] build issue with CFLAGS='-mcmodel=medium'" -->
<!-- id="CABB+w0T4ThAw=YfQyiQ5PBjsgWWXTw99QNU=qpxYPN8-fvj+AQ_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2012-01-30 13:40:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0538.php">Christopher Samuel: "Re: [hwloc-users] build issue with CFLAGS='-mcmodel=medium'"</a>
<li><strong>Previous message:</strong> <a href="0536.php">Devendar Bureddy: "Re: [hwloc-users] build issue with CFLAGS='-mcmodel=medium'"</a>
<li><strong>In reply to:</strong> <a href="0535.php">Samuel Thibault: "Re: [hwloc-users] build issue with CFLAGS='-mcmodel=medium'"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0538.php">Christopher Samuel: "Re: [hwloc-users] build issue with CFLAGS='-mcmodel=medium'"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><hr>
<ul>
<li>application/x-gzip attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-0537/config.log.gz">config.log.gz</a>
</ul>
