...
?>
<!-- received="Mon Apr 23 10:13:15 2012" -->
<!-- isoreceived="20120423141315" -->
<!-- sent="Mon, 23 Apr 2012 10:13:01 -0400" -->
<!-- isosent="20120423141301" -->
<!-- name="Vlad" -->
<!-- email="vlad_at_[hidden]" -->
<!-- subject="Re: [hwloc-users] possible concurrency issue with reading /proc data on Linux" -->
<!-- id="951A4FC2-0F40-4F82-B8DE-A83FBC818661_at_demoninsight.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-04-23 10:13:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0623.php">Brice Goglin: "Re: [hwloc-users] possible concurrency issue with reading /proc data on Linux"</a>
<li><strong>Previous message:</strong> <a href="0621.php">Vlad: "Re: [hwloc-users] possible concurrency issue with reading /proc data on Linux"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0623.php">Brice Goglin: "Re: [hwloc-users] possible concurrency issue with reading /proc data on Linux"</a>
<li><strong>Reply:</strong> <a href="0623.php">Brice Goglin: "Re: [hwloc-users] possible concurrency issue with reading /proc data on Linux"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Note that it should always be possible to read at least the current thread's /proc data. In my workaround, should I run out of retries I default to hwloc_get_last_cpu_location(... HWLOC_CPUBIND_THREAD) -- since presumably that can't fail and the result is technically valid given hwloc_get_last_cpu_location() semantics (it reads state that's inherently transient). 
<br>
<p>On Apr 23, 2012, at 7:53 AM, Brice Goglin wrote:
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-0622/attachment">attachment</a>
</ul>
