...
?>
<!-- received="Tue Jan  7 09:41:02 2014" -->
<!-- isoreceived="20140107144102" -->
<!-- sent="Tue, 7 Jan 2014 14:40:49 +0000" -->
<!-- isosent="20140107144049" -->
<!-- name="Eloi Gaudry" -->
<!-- email="Eloi.Gaudry_at_[hidden]" -->
<!-- subject="Re: [hwloc-users] [windows] build from source using visual studio" -->
<!-- id="2a755b31eb3346cb84fe923ddf08ef9e_at_DM2PR08MB512.namprd08.prod.outlook.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="c252c9ee3d0a45efa1dfea23e464fabe_at_DM2PR08MB512.namprd08.prod.outlook.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-01-07 09:40:49
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0941.php">Brice Goglin: "Re: [hwloc-users] [windows] build from source using visual studio"</a>
<li><strong>Previous message:</strong> <a href="0939.php">Eloi Gaudry: "Re: [hwloc-users] [windows] build from source using visual studio"</a>
<li><strong>In reply to:</strong> <a href="0939.php">Eloi Gaudry: "Re: [hwloc-users] [windows] build from source using visual studio"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0941.php">Brice Goglin: "Re: [hwloc-users] [windows] build from source using visual studio"</a>
<li><strong>Reply:</strong> <a href="0941.php">Brice Goglin: "Re: [hwloc-users] [windows] build from source using visual studio"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-0940/attachment">attachment</a>
</ul>
