...
?>
<!-- received="Tue Apr  1 04:43:23 2014" -->
<!-- isoreceived="20140401084323" -->
<!-- sent="Tue, 1 Apr 2014 10:43:21 +0200" -->
<!-- isosent="20140401084321" -->
<!-- name="Jiri Hladky" -->
<!-- email="hladky.jiri_at_[hidden]" -->
<!-- subject="Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.9 released" -->
<!-- id="CALT_uBSm1FLe2bmHP3a4Y_70bHgJ2nCgJi5vE5jFE47GfLgYgg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2014-04-01 04:43:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1015.php">Jiri Hladky: "Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.9 released"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/hwloc-users/2014/03/1013.php">Christopher Samuel: "Re: [hwloc-users] BGQ question."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1015.php">Jiri Hladky: "Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.9 released"</a>
<li><strong>Maybe reply:</strong> <a href="1015.php">Jiri Hladky: "Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.9 released"</a>
<li><strong>Reply:</strong> <a href="1016.php">Brice Goglin: "Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.9 released"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Brice,
<br>
<p>I see some compiler warnings when building rpm package for Fedora:
<br>
<p>topology-windows.c: In function 'hwloc_win_get_VirtualAllocExNumaProc':
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-1014/attachment">attachment</a>
</ul>
