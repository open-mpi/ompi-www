...
?>
<!-- received="Tue Mar 25 04:56:06 2014" -->
<!-- isoreceived="20140325085606" -->
<!-- sent="Tue, 25 Mar 2014 08:56:02 +0000" -->
<!-- isosent="20140325085602" -->
<!-- name="Biddiscombe, John A." -->
<!-- email="biddisco_at_[hidden]" -->
<!-- subject="Re: [hwloc-users] BGQ question." -->
<!-- id="50320452A334BD42A5EC72BAD2145099102D8F6E_at_MBX110.d.ethz.ch" -->
<!-- charset="utf-8" -->
<!-- inreplyto="53313E0B.3070007_at_inria.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-25 04:56:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0993.php">Samuel Thibault: "Re: [hwloc-users] BGQ question."</a>
<li><strong>Previous message:</strong> <a href="0991.php">Brice Goglin: "Re: [hwloc-users] BGQ question."</a>
<li><strong>In reply to:</strong> <a href="0991.php">Brice Goglin: "Re: [hwloc-users] BGQ question."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0993.php">Samuel Thibault: "Re: [hwloc-users] BGQ question."</a>
<li><strong>Reply:</strong> <a href="0993.php">Samuel Thibault: "Re: [hwloc-users] BGQ question."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
Looking at /proc/cpuinfo on the io node itself, I see only 60 cores listed. I wonder if they&#226;&#128;&#153;ve reserved one socket of 4 cores for IO purposes and in fact hwloc is seeing the correct information.
<br>

<br>
Attached is the foo zip of the run just now (assuming it doesn&#226;&#128;&#153;t bounce)
<br>
...
<br>
Le 25/03/2014 08:55, Biddiscombe, John A. a &#195;&#169;crit :
<br>
Brice,
<br>
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-0992/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-0992/foo.tar.bz2">foo.tar.bz2</a>
</ul>
