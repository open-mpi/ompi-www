...
?>
<!-- received="Tue Aug 19 13:03:58 2014" -->
<!-- isoreceived="20140819170358" -->
<!-- sent="Tue, 19 Aug 2014 19:03:56 +0200" -->
<!-- isosent="20140819170356" -->
<!-- name="Brice Goglin" -->
<!-- email="Brice.Goglin_at_[hidden]" -->
<!-- subject="Re: [hwloc-users] setting memory bindings" -->
<!-- id="53F3837C.6090609_at_inria.fr" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2014-08-19 13:03:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1062.php">Aulwes, Rob: "Re: [hwloc-users] setting memory bindings"</a>
<li><strong>Previous message:</strong> <a href="1060.php">Aulwes, Rob: "Re: [hwloc-users] setting memory bindings"</a>
<li><strong>In reply to:</strong> <a href="1060.php">Aulwes, Rob: "Re: [hwloc-users] setting memory bindings"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1062.php">Aulwes, Rob: "Re: [hwloc-users] setting memory bindings"</a>
<li><strong>Reply:</strong> <a href="1062.php">Aulwes, Rob: "Re: [hwloc-users] setting memory bindings"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I'll look at clarifying the doc and/or returning an error and/or adding
<br>
a way to find out.
<br>
<p>Brice
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-1061/attachment">attachment</a>
</ul>
