...
?>
<!-- received="Wed Oct  8 18:49:07 2014" -->
<!-- isoreceived="20141008224907" -->
<!-- sent="Thu, 9 Oct 2014 00:49:06 +0200" -->
<!-- isosent="20141008224906" -->
<!-- name="Jiri Hladky" -->
<!-- email="hladky.jiri_at_[hidden]" -->
<!-- subject="Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.10.0 release" -->
<!-- id="CALT_uBSDv2m9SuYOp6UVriRi_W8VTbzXj8iCcE85b8z7-uKMrA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2014-10-08 18:49:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1110.php">Jiri Hladky: "Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.10.0 release"</a>
<li><strong>Previous message:</strong> <a href="1108.php">Brice Goglin: "Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.10.0 release"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1112.php">Brice Goglin: "Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.10.0 release"</a>
<li><strong>Reply:</strong> <a href="1112.php">Brice Goglin: "Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.10.0 release"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Brice,
<br>
<p>this sounds perfectly reasonable to me. I will make the arrangements on
<br>
packing side.
<br>
<p>Perhaps you could add this in README file?
<br>
<p>Thanks
<br>
Jirka
<br>
<p><p><p>On Wed, Oct 8, 2014 at 11:26 AM, Brice Goglin &lt;Brice.Goglin_at_[hidden]&gt; wrote:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-1109/attachment">attachment</a>
</ul>
