...
?>
<!-- received="Wed Sep 17 11:45:39 2014" -->
<!-- isoreceived="20140917154539" -->
<!-- sent="Wed, 17 Sep 2014 17:45:19 +0200 (CEST)" -->
<!-- isosent="20140917154519" -->
<!-- name="Siegmar Gross" -->
<!-- email="Siegmar.Gross_at_[hidden]" -->
<!-- subject="Re: [hwloc-users] problem with X11 using Solaris" -->
<!-- id="201409171545.s8HFjJ4d028909_at_tyr.informatik.hs-fulda.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-09-17 11:45:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1083.php">Brice Goglin: "Re: [hwloc-users] more detailed errors"</a>
<li><strong>Previous message:</strong> <a href="1081.php">Aulwes, Rob: "[hwloc-users] more detailed errors"</a>
<li><strong>Maybe in reply to:</strong> <a href="1078.php">Siegmar Gross: "[hwloc-users] problem with X11 using Solaris"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1085.php">Brice Goglin: "Re: [hwloc-users] problem with X11 using Solaris"</a>
<li><strong>Reply:</strong> <a href="1085.php">Brice Goglin: "Re: [hwloc-users] problem with X11 using Solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>sorry, I pressed the send button, before my attachements were complete.
<br>
...
tyr local 113 
<br>
<p>The error message came up, when I closed the lstopo window. Do you need
<br>
anything else?
<br>
<p><p>Kind regards
...
<br><hr>
<ul>
<li>TEXT/x-sun-h-file attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-1082/Xutil.h">Xutil.h</a>
</ul>
<!-- attachment="Xutil.h" -->
<hr>
<ul>
<li>APPLICATION/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-1082/hwloc-1.9.1-SunOS.sparc.tar.gz">hwloc-1.9.1-SunOS.sparc.tar.gz</a>
</ul>
<!-- attachment="hwloc-1.9.1-SunOS.sparc.tar.gz" -->
<hr>
<ul>
<li>APPLICATION/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-1082/hwloc-1.9.1-SunOS.sparc_unmodified-Xutil.h.tar.gz">hwloc-1.9.1-SunOS.sparc_unmodified-Xutil.h.tar.gz</a>
</ul>
<!-- attachment="hwloc-1.9.1-SunOS.sparc_unmodified-Xutil.h.tar.gz" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
