<?
$subject_val = "[hwloc-users] CPU binding";
include("../../include/msg-header.inc");
?>
<!-- received="Wed Oct  2 20:56:53 2013" -->
<!-- isoreceived="20131003005653" -->
<!-- sent="Thu, 3 Oct 2013 02:56:52 +0200" -->
<!-- isosent="20131003005652" -->
<!-- name="Panos Labropoulos" -->
<!-- email="panos.labropoulos_at_[hidden]" -->
<!-- subject="[hwloc-users] CPU binding" -->
<!-- id="CAGj8tX-k3aCdzio=1KL4sT4HrZ8LcvEu+rEUAzvPMiR3jed7Gg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [hwloc-users] CPU binding<br>
<strong>From:</strong> Panos Labropoulos (<em>panos.labropoulos_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-10-02 20:56:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0908.php">Brice Goglin: "Re: [hwloc-users] CPU binding"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/hwloc-users/2013/08/0906.php">Jiri Hladky: "Re: [hwloc-users] [hwloc-announce] Hardware locality (hwloc) v1.7.2rc1 released"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0908.php">Brice Goglin: "Re: [hwloc-users] CPU binding"</a>
<li><strong>Reply:</strong> <a href="0908.php">Brice Goglin: "Re: [hwloc-users] CPU binding"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hallo,
<br>
<p><p>I initially posted this at users_at_open-mpi.org.
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-users/att-0907/attachment">attachment</a>
</ul>
