...
?>
<!-- received="Mon Jun 18 09:06:39 2012" -->
<!-- isoreceived="20120618130639" -->
<!-- sent="Mon, 18 Jun 2012 09:06:35 -0400" -->
<!-- isosent="20120618130635" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Pineapple Runtime Interposition Project" -->
<!-- id="CAANzjEnFp3FnWyA7fB0w+-aENdW0iZHaFLun8fzPP6w1NCmOEQ_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="7CD7F149-2B8A-4AEF-8039-6359DBAB4014_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-18 09:06:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11117.php">TERRY DONTJE: "Re: [OMPI devel] openib Dynamic SL opensm-devel usage"</a>
<li><strong>Previous message:</strong> <a href="11115.php">TERRY DONTJE: "[OMPI devel] openib Dynamic SL opensm-devel usage"</a>
<li><strong>In reply to:</strong> <a href="11113.php">Ralph Castain: "Re: [OMPI devel] RFC: Pineapple Runtime Interposition Project"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11118.php">Ralph Castain: "Re: [OMPI devel] RFC: Pineapple Runtime Interposition Project"</a>
<li><strong>Reply:</strong> <a href="11118.php">Ralph Castain: "Re: [OMPI devel] RFC: Pineapple Runtime Interposition Project"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; I had a chance to review your code this morning, and generally find it is okay with me. I see a couple of things that appear to limit it, though they may be intentional:
</span><br>
<p>In this pass of the pineapple interface I included only those
<br>
...
more.
<br>
<p>Extending this interface to be more flexible and extensible I saw as a
<br>
...
<span class="quotelev1">&gt; 1. the call to pineapple_init really needs a third flag to define the process type. Locking the underlying orte_init to MPI seems to somewhat defeat your goal of allowing pineapple to be used for non-MPI purposes
</span><br>
<p><p>For OMPI, we only ever pass one type to the orte_init function. As
<br>
such, I eliminated the third parameter since it was unnecessary for
<br>
OMPI in this baseline pass.
<br>
<p>However, it may be useful to have for non-MPI purposes. Maybe a 'int'
<br>
...
<span class="quotelev1">&gt; 2. the barrier and other collectives are locked to the MPI_Init and MPI_Finalize procedures due to hardcoding of the collective id. You might want to consider altering the API to pass a collective id down so these functions can be used in other places.
</span><br>
<p><p>Making this more generic would be useful. I'll see what I can do when
<br>
...
better.
<br>
<p>However, as you allude to in the next paragraph, we do not want to
<br>
...
between OMPI/ORTE.
<br>
<p>However, if we consider calling it the 'ORte Abstraction Layer' for
<br>
...
<span class="quotelev1">&gt; On Jun 15, 2012, at 12:55 PM, Josh Hursey wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; &lt;Pineapple-Teleconf.pdf&gt;_______________________________________________
</span><br>
