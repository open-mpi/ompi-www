...
?>
<!-- received="Thu Mar 22 11:04:39 2012" -->
<!-- isoreceived="20120322150439" -->
<!-- sent="Thu, 22 Mar 2012 11:04:32 -0400" -->
<!-- isosent="20120322150432" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI svn-full] svn:open-mpi r26172" -->
<!-- id="F646324A-7029-4E27-A1CD-E05369592DD6_at_eecs.utk.edu" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAANzjEnGtiRa55-wfNoHbGZixsC70__Z8ftAbAp0h1C8jSQFXA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-03-22 11:04:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10756.php">Ralph Castain: "Re: [OMPI devel] MPI_Init_thread problem on ubuntu ARM (open-mpi 1.4.3)"</a>
<li><strong>Previous message:</strong> <a href="10754.php">Josh Hursey: "Re: [OMPI devel] [OMPI svn-full] svn:open-mpi r26172"</a>
<li><strong>In reply to:</strong> <a href="10754.php">Josh Hursey: "Re: [OMPI devel] [OMPI svn-full] svn:open-mpi r26172"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p>&nbsp;&nbsp;george.
<br>
<p>On Mar 22, 2012, at 10:09 , Josh Hursey wrote:
<br>
<p><span class="quotelev1">&gt; Should be fixed in r26177.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Thu, Mar 22, 2012 at 7:51 AM, Josh Hursey &lt;jjhursey_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Fair enough. Upon further inspection of the request_invoke() handler,
</span><br>
<span class="quotelev2">&gt;&gt; you are correct that it is not required here if we do not modify the
</span><br>
<span class="quotelev2">&gt;&gt; default value for req_status.MPI_ERROR.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I'll work on a revised patch this morning and commit. One that does
</span><br>
<span class="quotelev2">&gt;&gt; not use this field.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Per your comment from your first message:
</span><br>
<span class="quotelev2">&gt;&gt;  &quot;The usage we're doing in the default_wait_all of MPI_ERR_PENDING is
</span><br>
<span class="quotelev2">&gt;&gt; incorrect as well.&quot;
</span><br>
<span class="quotelev2">&gt;&gt; I'm glad that you no longer think the patch is &quot;incorrect&quot;, but just
</span><br>
<span class="quotelev2">&gt;&gt; not implemented as well as it could be.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Thu, Mar 22, 2012 at 1:40 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Mar 21, 2012, at 15:13 , Josh Hursey wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I see your point about setting MPI_ERR_PENDING on the internal status
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; versus the status returned by MPI_Waitall. As I mentioned, the reason
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I choose to do that is to support the ompi_errhandler_request_invoke()
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; function. I could not think of an better way to fix this, so I'm open
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; to ideas.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If MPI_ERR_PENDING is not set on the request status then I don't see any issues with the ompi_errhandler_request_invoke. Do I miss something obvious?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_Waitall returns MPI_ERR_PENDING for 'not completed' requests (or
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; sets the exposed status.MPI_ERROR field appropriately, depending on
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the completion function used). The user must still call a completion
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; function to complete the request at which point the true error value
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is reported (MPI_SUCCESS, or something else). So I think we are on the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; same page here.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Setting the request-&gt;req_status.MPI_ERROR to MPI_ERR_PENDING in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_Waitall does not prevent the OMPI system from overwriting that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; value with the correct error (e.g., MPI_ERR_TRUNCATE). When the OMPI
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; system wants to set an error on the request it sets the value (without
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; checking the previous value in req_status.MPI_ERROR) before calling
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the completion operation. We reset the value from MPI_ERR_PENDING to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_SUCCESS at the start of the test/wait operations so that the rest
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; of the checks for (MPI_SUCCESS != req-&gt;req_status.MPI_ERROR) complete
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; appropriately in those functions.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So I am still failing to see why the patch is incorrect. Is it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 'incorrect' or just 'not implemented the way you think it should be'?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; If the latter, then I'd love to see a patch. If the former, then I
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; would really like to understand why.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I didn't say it is incorrect, just that it is an overkill that is (1) not required by the MPI standard; (2) potentially not thread safe; (3) sub-optimal in terms of memory writes; (4) way to complex for what MPI_ERR_PENDING is supposed to achieve. Moreover, I guess your patch is indeed correct if the MPICH test you were using pass.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Do we both agree that before this patch Open MPI did not support
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_ERR_PENDING?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Who dares claim the opposite?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Wed, Mar 21, 2012 at 2:45 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
