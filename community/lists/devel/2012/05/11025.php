...
?>
<!-- received="Wed May 23 17:28:28 2012" -->
<!-- isoreceived="20120523212828" -->
<!-- sent="Wed, 23 May 2012 15:28:20 -0600" -->
<!-- isosent="20120523212820" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release" -->
<!-- id="FA9478C7-B168-4393-BC68-5933AF665A38_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-05-23 17:28:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11026.php">Jeff Squyres: "Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release"</a>
<li><strong>Previous message:</strong> <a href="11024.php">Barrett, Brian W: "Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release"</a>
...
<!-- body="start" -->
<p>
I sent David a patch to test - will wait to commit to trunk until I hear from him, then will CMR.
<br>
<p><p>On May 23, 2012, at 3:23 PM, Jeff Squyres wrote:
<br>
<p><span class="quotelev1">&gt; Yea, the CANONICAL_HOST thing is because of hwloc; sorry...  It needs to be very, very early in configure.ac.  So getting the ordering wrong there was probably my fault; sorry.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Not sure what you mean; the file's loaded in OMPI_LOAD_PLATFORM, at which
</span><br>
<span class="quotelev3">&gt;&gt;&gt; point all the contents of the file are evaluated as environment variables.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The real problem is that someone really screwed up configure somewhere
</span><br>
<span class="quotelev3">&gt;&gt;&gt; along the way and called AC_CONONICAL_HOST before AM_INIT_AUTOMAKE, which
</span><br>
<span class="quotelev3">&gt;&gt;&gt; means AC_PROG_GCC got evaluated really early, before OMPI_LOAD_PLATFORM is
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; We pickup the file at the right place, but we don't pull any of the flags
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Yup, it sucks.  But that's not supported functionality.  Someone could
</span><br>
