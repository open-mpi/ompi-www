...
?>
<!-- received="Wed May 23 16:44:47 2012" -->
<!-- isoreceived="20120523204447" -->
<!-- sent="Wed, 23 May 2012 14:44:39 -0600" -->
<!-- isosent="20120523204439" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release" -->
<!-- id="2512C1F2-89A0-4983-9886-6428A14D80A6_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CBE2A73C.ECC0%bwbarre_at_sandia.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-05-23 16:44:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11021.php">Barrett, Brian W: "Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release"</a>
<li><strong>Previous message:</strong> <a href="11019.php">Josh Hursey: "Re: [OMPI devel] Building Open MPI without Java"</a>
<li><strong>In reply to:</strong> <a href="11018.php">Barrett, Brian W: "Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11021.php">Barrett, Brian W: "Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release"</a>
<li><strong>Reply:</strong> <a href="11021.php">Barrett, Brian W: "Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
I'm looking at it...
<br>
<p>We pickup the file at the right place, but we don't pull any of the flags out of it until later. I'm trying to see if I can adjust it.
<br>
<p>BTW: none of this changed from the 1.5 series, so this has been the situation for a very long time.
<br>
<p><p>On May 23, 2012, at 2:41 PM, Barrett, Brian W wrote:
<br>
<p><span class="quotelev1">&gt; Yup, it sucks.  But that's not supported functionality.  Someone could
</span><br>
...
<span class="quotelev1">&gt; platform thing is a real hack to begin with in terms of what it does to
</span><br>
...
<span class="quotelev2">&gt;&gt; So perhaps I should stop calling them environment variables. Since one
</span><br>
...
<span class="quotelev2">&gt;&gt; different OMPI builds. We have different paths for the IB libs, Panasas
</span><br>
<span class="quotelev2">&gt;&gt; file system libs and includes, etc.  Essentially, we're not going to 1.6
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Where exactly the platform file gets evaluated depends on a number of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; things that the OMPI developers don't have a lot of control over.  It
</span><br>
<span class="quotelev3">&gt;&gt;&gt; was
</span><br>
<span class="quotelev3">&gt;&gt;&gt; never meant to be used to set environment variables, only command line
</span><br>
<span class="quotelev3">&gt;&gt;&gt; arguments.  It looks like something bad has happened with ordering; I'm
</span><br>
<span class="quotelev3">&gt;&gt;&gt; not sure when I'll be able to take a look, but we should be able to make
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I think I have some understanding of what is happening. In version 1.6,
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I thought the purpose of the platform file was to be equivalent to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; setting things on the command-line to configure. Still, it has always
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; configure: error: in `/usr/projects/hpctools/dog/openmpi/openmpi-1.6':
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; The error happens because this particular compiler, pgi-12.4, needs
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; two
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; flags: -lnomp and -lnuma. Thus the reason for the LDFLAGS line in the
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; through, like some output from &quot;make V=1&quot; and or from config.log?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Offhand, I don't know if we ever formally supported setting env
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; variables other than enable and with flag variables in the platform
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On May 23, 2012, at 12:49 PM, &quot;Gunter, David O&quot; &lt;dog_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am trying to set LDFLAGS, CFLAGS, etc, in a platform file but the
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 1.6 release does not seem to pick these up.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Here's the tail end of one of our platform files, for building with
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; The same platform file will configure the 1.4.5 release just fine
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; but
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; does not work with 1.6. If I set these variables in my environment
</span><br>
