...
?>
<!-- received="Wed May 23 21:53:32 2012" -->
<!-- isoreceived="20120524015332" -->
<!-- sent="Wed, 23 May 2012 19:53:25 -0600" -->
<!-- isosent="20120524015325" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release" -->
<!-- id="6EAE3CDE-D1E8-4CAD-B88D-06807E54DDE2_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CDAB181D-64EF-4401-9977-165DD07C9B48_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-05-23 21:53:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11028.php">TERRY DONTJE: "[OMPI devel] MPI_Cart_coords_f segv with Intel compiler"</a>
<li><strong>Previous message:</strong> <a href="11026.php">Jeff Squyres: "Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release"</a>
<li><strong>In reply to:</strong> <a href="11026.php">Jeff Squyres: "Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11025.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL] Re: Unable to set flags using platform files in the 1.6 release"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Here's the patch I provided - seems to work just fine. Just waiting for David's confirmation on his system.
<br>
<p><p>

<br><p>
<p>On May 23, 2012, at 7:50 PM, Jeff Squyres wrote:
<br>
<p><span class="quotelev1">&gt; On May 23, 2012, at 5:25 PM, Barrett, Brian W wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; It shouldn't be before AM_INIT_AUTOMAKE, that's just busted and needs to
</span><br>
<span class="quotelev2">&gt;&gt; be fixed in hwloc...
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I don't think that's right.  It's an AC macro, not an AM macro, so it can come before AM_INIT_AUTOMAKE.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Here's what happens if you put it before AM_INIT_AUTOMAKE:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; ----
</span><br>
<span class="quotelev1">&gt; [21:49] jsquyres-mac:~/tmp/foo % cat configure.ac
</span><br>
<span class="quotelev1">&gt; AC_INIT([bogus], [1.0], [<a href="http://example.com">http://example.com</a>], [bogus])
</span><br>
...
<span class="quotelev1">&gt; AC_CANONICAL_TARGET
</span><br>
<span class="quotelev1">&gt; AM_INIT_AUTOMAKE([1.10 foreign -Wall -Werror])
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; AC_CONFIG_FILES([Makefile])
</span><br>
<span class="quotelev1">&gt; AC_OUTPUT
</span><br>
<span class="quotelev1">&gt; [21:49] jsquyres-mac:~/tmp/foo % autoreconf -ivf &amp;&amp; ./configure
</span><br>
...
<span class="quotelev1">&gt; But if you flip CANONICAL_TARGET / INIT_AUTOMAKE:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; -----
</span><br>
<span class="quotelev1">&gt; [21:50] jsquyres-mac:~/tmp/foo % autoreconf -ivf &amp;&amp; ./configure
</span><br>
<span class="quotelev1">&gt; autoreconf: Entering directory `.'
</span><br>
...
<span class="quotelev1">&gt; configure.ac:6: warning: AC_ARG_PROGRAM was called before AC_CANONICAL_TARGET
</span><br>
<span class="quotelev1">&gt; ../../lib/autoconf/general.m4:1834: AC_CANONICAL_TARGET is expanded from...
</span><br>
<span class="quotelev1">&gt; configure.ac:6: the top level
</span><br>
...
<span class="quotelev1">&gt; autoreconf: running: /opt/local/bin/autoconf --force
</span><br>
<span class="quotelev1">&gt; configure.ac:6: warning: AC_ARG_PROGRAM was called before AC_CANONICAL_TARGET
</span><br>
<span class="quotelev1">&gt; ../../lib/autoconf/general.m4:1834: AC_CANONICAL_TARGET is expanded from...
...
<span class="quotelev1">&gt; autoreconf: configure.ac: not using Autoheader
</span><br>
...
<span class="quotelev1">&gt; configure does seem to run ok, but I didn't include any other tests (like AC_PROG_CC), etc.  I have a dim recollection that other things would break, but am too tired to test that right now.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt;&gt; On 5/23/12 3:23 PM, &quot;Jeff Squyres&quot; &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Yea, the CANONICAL_HOST thing is because of hwloc; sorry...  It needs to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; be very, very early in configure.ac.  So getting the ordering wrong there
</span><br>
<span class="quotelev3">&gt;&gt;&gt; was probably my fault; sorry.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On May 23, 2012, at 4:53 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Ah, okay - didn't realize that ordering. I'll fix it - thanks!
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On May 23, 2012, at 2:49 PM, Barrett, Brian W wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Not sure what you mean; the file's loaded in OMPI_LOAD_PLATFORM, at
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; which
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; point all the contents of the file are evaluated as environment
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; along the way and called AC_CONONICAL_HOST before AM_INIT_AUTOMAKE,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; which
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; means AC_PROG_GCC got evaluated really early, before
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; OMPI_LOAD_PLATFORM is
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; We pickup the file at the right place, but we don't pull any of the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Yup, it sucks.  But that's not supported functionality.  Someone
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; platform thing is a real hack to begin with in terms of what it does
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; So perhaps I should stop calling them environment variables. Since
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; different OMPI builds. We have different paths for the IB libs,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Panasas
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Where exactly the platform file gets evaluated depends on a number
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; of
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; things that the OMPI developers don't have a lot of control over.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; It
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; was
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; never meant to be used to set environment variables, only command
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I thought the purpose of the platform file was to be equivalent
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; to
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The error happens because this particular compiler, pgi-12.4,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; through, like some output from &quot;make V=1&quot; and or from
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; variables other than enable and with flag variables in the
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The same platform file will configure the 1.4.5 release just
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; fine
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; but
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; does not work with 1.6. If I set these variables in my
</span><br>
...
<p><p><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-11027/config.diff">config.diff</a>
</ul>
