...
?>
<!-- received="Tue May  1 09:29:06 2012" -->
<!-- isoreceived="20120501132906" -->
<!-- sent="Tue, 1 May 2012 06:29:01 -0700" -->
<!-- isosent="20120501132901" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] libevent socket code" -->
<!-- id="C86AFD9A-341C-4FF3-8BD2-5DFAAF3E6ACD_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AE45F2F55FE69B4F99BB3455E821D71516FBA6FE_at_ECS-EXG-P-MB07.win.lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-05-01 09:29:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10948.php">Ralph Castain: "Re: [OMPI devel] libevent socket code"</a>
<li><strong>Previous message:</strong> <a href="10946.php">Hjelm, Nathan T: "Re: [OMPI devel] libevent socket code"</a>
<li><strong>In reply to:</strong> <a href="10946.php">Hjelm, Nathan T: "Re: [OMPI devel] libevent socket code"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10948.php">Ralph Castain: "Re: [OMPI devel] libevent socket code"</a>
<li><strong>Reply:</strong> <a href="10948.php">Ralph Castain: "Re: [OMPI devel] libevent socket code"</a>
<li><strong>Reply:</strong> <a href="10950.php">Hjelm, Nathan T: "Re: [OMPI devel] libevent socket code"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Is there a libevent configure switch we can use to disable those unused libevent functions?
<br>
