...
?>
<!-- received="Tue Feb  7 15:14:23 2012" -->
<!-- isoreceived="20120207201423" -->
<!-- sent="Tue, 7 Feb 2012 13:14:15 -0700" -->
<!-- isosent="20120207201415" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Java MPI bindings" -->
<!-- id="9D67E2F6-032A-4076-AB77-1F0EBE344612_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAHwLALNek8+jVK=sKF8r+8i=AcDOxXrUmu1io2Pz1JWmOqnNvw_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-02-07 15:14:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10322.php">Ralph Castain: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<li><strong>Previous message:</strong> <a href="10320.php">Rayson Ho: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<li><strong>In reply to:</strong> <a href="10320.php">Rayson Ho: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10323.php">Rayson Ho: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<li><strong>Reply:</strong> <a href="10323.php">Rayson Ho: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
The community is aware of the issue. However, the corporations interested/involved in this area are not running on EC2 nor concerned about having allocations taken away. The question of failed nodes is something we plan to address over time, but is not considered an immediate show-stopper.
<br>
<p>On Feb 7, 2012, at 1:05 PM, Rayson Ho wrote:
<br>
<p><span class="quotelev1">&gt; Currently, Hadoop tasks (in a job) are independent of each. If Hadoop
</span><br>
<span class="quotelev1">&gt; is going to use MPI for inter-task communication, then make sure they
</span><br>
<span class="quotelev1">&gt; understand that the MPI standard currently does not address fault
</span><br>
<span class="quotelev1">&gt; folerant.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Note that it is not uncommon to run map reduce jobs on Amazon EC2's
</span><br>
<span class="quotelev1">&gt; spot instances, which can be taken back by Amazon at any time if the
</span><br>
<span class="quotelev1">&gt; spot price rises above the bid price of the user. If Hadoop is going
</span><br>
<span class="quotelev1">&gt; to use MPI, and without a fault folerant MPI implementation, then the
</span><br>
<span class="quotelev1">&gt; whole job needs to be rerun.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; <a href="http://www.youtube.com/watch?v=66rfnFA0jpM">http://www.youtube.com/watch?v=66rfnFA0jpM</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Wed, Feb 1, 2012 at 3:20 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
