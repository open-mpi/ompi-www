...
?>
<!-- received="Tue Feb  7 15:39:09 2012" -->
<!-- isoreceived="20120207203909" -->
<!-- sent="Tue, 7 Feb 2012 13:39:01 -0700" -->
<!-- isosent="20120207203901" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Java MPI bindings" -->
<!-- id="CC2BAB6E-A088-410F-8839-2684C59DCF0A_at_open-mpi.org" -->
...
<strong>Date:</strong> 2012-02-07 15:39:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10327.php">Paul H. Hargrove: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<li><strong>Previous message:</strong> <a href="10325.php">Paul H. Hargrove: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<li><strong>In reply to:</strong> <a href="10325.php">Paul H. Hargrove: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10327.php">Paul H. Hargrove: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<li><strong>Reply:</strong> <a href="10327.php">Paul H. Hargrove: "Re: [OMPI devel] RFC: Java MPI bindings"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
We already have a stable, standard interface for non-C language bindings, Paul - the C++ bindings, for example, are built on top of them.
<br>
<p>The binding codes are all orthogonal to the base code. All they do is massage data access and then loop back to the C bindings. This is the normal way we handle all non-C bindings, so nothing different there.
<br>
<p>The work has been done on a branch, and an RFC issued. The bindings conform to the MPI standard, and the implementation uses an existing external, third-party binding that has been tested.
<br>
<p>So I'm not sure what you are asking that hasn't already been done&#133;
<br>
<p>On Feb 7, 2012, at 1:33 PM, Paul H. Hargrove wrote:
<br>
<p><span class="quotelev1">&gt; As an HPC software developer and user of OMPI, I'd like to add my $0.02 here even though I am not an OMPI developer.
</span><br>
