...
?>
<!-- received="Tue Oct 30 16:35:21 2012" -->
<!-- isoreceived="20121030203521" -->
<!-- sent="Tue, 30 Oct 2012 13:35:13 -0700" -->
<!-- isosent="20121030203513" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] 1.7 rc4 compilation error" -->
<!-- id="42B9EC1A-1850-4F10-965F-5DB6E5F579EC_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="11785B3B-0BF3-4E90-AEE1-12BD862FD7F9_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-10-30 16:35:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11689.php">Nathan Hjelm: "Re: [OMPI devel] [OMPI svn-full] svn:open-mpi r27526 - trunk/orte/mca/plm/rsh"</a>
<li><strong>Previous message:</strong> <a href="11687.php">Ralph Castain: "Re: [OMPI devel] [OMPI svn-full] svn:open-mpi r27526 - trunk/orte/mca/plm/rsh"</a>
<li><strong>In reply to:</strong> <a href="11681.php">Ralph Castain: "Re: [OMPI devel] 1.7 rc4 compilation error"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>I found that the Lustre headers and libs are indeed on the system, and so your analysis of the problem is correct.
<br>
<p>When I build with nothing on the configure line, we only build shared and so the executable is dynamic - and the problem goes away.
<br>
<p>HTH
<br>
Ralph
<br>
<p>On Oct 30, 2012, at 12:06 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Sure - I can do that.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Oct 30, 2012, at 11:29 AM, Edgar Gabriel &lt;gabriel_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; glad to hear that. However, since we are also having the problem with
</span><br>
<span class="quotelev2">&gt;&gt; the lustre-fs module for static builds, I think it would still make
</span><br>
<span class="quotelev2">&gt;&gt; sense to disable fs/lustre/ for 1.7.0
</span><br>
...
<span class="quotelev2">&gt;&gt; On 10/30/2012 12:34 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I hate odin :-(
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; FWIW: it all works fine today, no matter how I configure it. No earthly idea what happened.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ignore these droids....
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Oct 30, 2012, at 7:28 AM, Edgar Gabriel &lt;gabriel_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ok, so a couple of things.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I still think it is the same issue that I observed 1-2 days ago. Could
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; you try to remove the fs/lustre component from your compilation, e.g. by
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; adding an .ompi_ignore file into that directory, and see whether this
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; fixes the issue?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I tried on my machine (no lustre, no ib) compilations with
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --disable-mpi-io *or* --disable-io-romio, and both worked correctly and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I could run things. Note, that the flags are truly different meanwhile,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; since the second flag is now equivalent to --enable-mca-no-build=io:romio
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The first flag disables the io, fcoll, fs and sharedfp frameworks.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (prior to ompio they had basically the same effect).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; In your particular case this means, that you disabled romio, but the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; entire ompio stack is still compiled, and error must come from that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; portion. If my suspecion is correct, it is still liblustre
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; messing around with the malloc hooks, and that causes the stack frame to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; be completely broken. I thought I fixed that since we did not have the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; issue on trunk, but we did observe that in the 1.7 branch 1-2 days back
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; as well, and I was looking into that.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; That being said, there is another malloc-hooks issue that makes me a bit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; nervous. The compilation of the otf stuff produced a ton of warnings on
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; my machine with gcc4.6.2 also with respect to the _malloc_hooks and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; _realloc_hooks. Not sure whether this contributed to the problem as
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; well, just thought I bring it up since we seem to have a corrupted stack
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; frame problem.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 10/30/2012 8:29 AM, Edgar Gabriel wrote:
</span><br>
