...
?>
<!-- received="Wed Oct 31 15:16:26 2012" -->
<!-- isoreceived="20121031191626" -->
<!-- sent="Wed, 31 Oct 2012 12:16:19 -0700" -->
<!-- isosent="20121031191619" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Compile-time MPI_Datatype checking" -->
<!-- id="25B2A0ED-D93B-44FA-8B9F-772B5FC4EEB7_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAAvDA17uHXv76aZvRQwktefHM_m6NaLwTxoCmB+BhdG1S=47vg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-10-31 15:16:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11713.php">Dmitri Gribenko: "Re: [OMPI devel] Compile-time MPI_Datatype checking"</a>
<li><strong>Previous message:</strong> <a href="11711.php">Paul Hargrove: "Re: [OMPI devel] Compile-time MPI_Datatype checking"</a>
<li><strong>In reply to:</strong> <a href="11711.php">Paul Hargrove: "Re: [OMPI devel] Compile-time MPI_Datatype checking"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11714.php">Paul Hargrove: "Re: [OMPI devel] Compile-time MPI_Datatype checking"</a>
<li><strong>Reply:</strong> <a href="11714.php">Paul Hargrove: "Re: [OMPI devel] Compile-time MPI_Datatype checking"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>If we want to raise the issue of what is best for developers, then I tend to err on the side of generating warnings. However, those warnings must not appear for users when the code is in fact valid.
<br>
<p>The fact that some compilers do that is irrelevant - we are talking about what we want OMPI to do.
<br>
<p><p>On Oct 31, 2012, at 12:11 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Ralph,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I work at a National Lab, and like many of my peers I develop/prototype codes on my desktop and/or laptop.  So, I think the default behavior of mpicc on a Clang-based Mac is entirely relevant.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; FWIW:
</span><br>
<span class="quotelev1">&gt; I agree w/ Jeff that these datatype checking warnings &quot;feel&quot; like a candidate for &quot;-Wall&quot; (or &quot;-Wextra&quot;), rather than enabled by default.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Understood, but also remember that the national labs don't have Mac clusters - and so they couldn't care less about Clang. The concerns over these changes were from the national labs, so my point was that this discussion may all be irrelevant.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt;&gt; Note that with Apple's latest versions of Xcode (4.2 and higher, IIRC) Clang is now the default C compiler.  I am told that Clang is the ONLY bundled compiler for OSX 10.8 (Mountain Lion) unless you take extra steps to install gcc (which is actually llvm-gcc and cross-compiles for OSX 10.7).
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; So, Clang *is* gaining some &quot;market share&quot;, though not yet in major HPC systems.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; If it's only on for Clang, I very much doubt anyone will care - I'm unaware of any of our users that currently utilize that compiler, and certainly not on the clusters in the national labs (gcc, Intel, etc. - but I've never seen them use Clang).
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Not saying anything negative about Clang - just noting it isn't much used in our current community that I've heard.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Oct 31, 2012, at 11:19 AM, Dmitri Gribenko &lt;gribozavr_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt; &gt; On Wed, Oct 31, 2012 at 5:04 PM, Jeff Squyres &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; On Oct 31, 2012, at 9:38 AM, Dmitri Gribenko wrote:
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; &gt;&gt;&gt;&gt; The rationale here is that correct MPI applications should not need to add any extra compiler files to compile without warnings.
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; a) MPI explicitly allows this kind of deliberate mismatch.  It does not make sense to warn for things that are correct in MPI.
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; b) Warnings are significantly less useful if the user looks at them and says, &quot;the compiler is wrong; I know that MPI says that this deliberate mismatch in my code is ok.&quot;
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; c) as such, these warnings are really only useful for the application where type/MPI_Datatype matching is expected/desired.
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; Can these warnings be enabled as part of the warnings rollup -Wall option?  That would be an easy way to find/enable these warnings.
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; I agree that most applications *probably* don't do this.  But significant developer in this community (i.e., Sandia) has at least multiple applications that *do* do it.  I can't ignore that.  :-(
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-11712/attachment">attachment</a>
</ul>
