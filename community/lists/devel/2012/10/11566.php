<?
$subject_val = "[OMPI devel]  Open-mpi in Fedora 5";
include("../../include/msg-header.inc");
?>
<!-- received="Fri Oct  5 15:40:09 2012" -->
<!-- isoreceived="20121005194009" -->
<!-- sent="Fri, 5 Oct 2012 12:40:03 -0700" -->
<!-- isosent="20121005194003" -->
<!-- name="Sandra Guija" -->
<!-- email="sguija_at_[hidden]" -->
<!-- subject="[OMPI devel]  Open-mpi in Fedora 5" -->
<!-- id="BAY166-W21A8471CA29EE85420F453CC8B0_at_phx.gbl" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="BAY166-W36348F22A6E4928C46744DCC8B0_at_phx.gbl" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel]  Open-mpi in Fedora 5<br>
<strong>From:</strong> Sandra Guija (<em>sguija_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-10-05 15:40:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11567.php">Jeff Squyres: "Re: [OMPI devel] Open-mpi in Fedora 5"</a>
<li><strong>Previous message:</strong> <a href="11565.php">Sandra Guija: "Re: [OMPI devel] Open-mpi in Fedora 5"</a>
<li><strong>In reply to:</strong> <a href="11565.php">Sandra Guija: "Re: [OMPI devel] Open-mpi in Fedora 5"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11567.php">Jeff Squyres: "Re: [OMPI devel] Open-mpi in Fedora 5"</a>
<li><strong>Reply:</strong> <a href="11567.php">Jeff Squyres: "Re: [OMPI devel] Open-mpi in Fedora 5"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello,
<br>
<p><p><p><p>I decided to use an environment with Fedora 5 and gcc 4.1.0.I tried to installed 1.6.2 and it failed, then tried 1.4.5 and it failed, then 1.2.9 and I did not get any error.
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-11566/attachment">attachment</a>
</ul>
