...
?>
<!-- received="Wed Oct 10 12:54:34 2012" -->
<!-- isoreceived="20121010165434" -->
<!-- sent="Wed, 10 Oct 2012 16:54:27 +0000" -->
<!-- isosent="20121010165427" -->
<!-- name="Santhosh Kokala" -->
<!-- email="Santhosh.Kokala_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] MPI_Reduce Hangs in my Application" -->
<!-- id="E6D5D6AF68E4194BAC1905E29435983190C50CB5_at_365EXCH-MBX-P3.nbttech.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="88C7EBCD-ED06-4D80-BB1F-C230C009A599_at_eecs.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-10-10 12:54:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11586.php">George Bosilca: "Re: [OMPI devel] MPI_Reduce Hangs in my Application"</a>
<li><strong>Previous message:</strong> <a href="11584.php">Paul Kapinos: "[OMPI devel] Another case of 'secret' disabling of InfiniBand"</a>
<li><strong>In reply to:</strong> <a href="11583.php">George Bosilca: "Re: [OMPI devel] MPI_Reduce Hangs in my Application"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11586.php">George Bosilca: "Re: [OMPI devel] MPI_Reduce Hangs in my Application"</a>
<li><strong>Reply:</strong> <a href="11586.php">George Bosilca: "Re: [OMPI devel] MPI_Reduce Hangs in my Application"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>I have a problem with my MPI code, it hangs when the code is run on multiple nodes. It successfullycompletes when run on a single node. I am not sure how to debug this. Can someone help me debug this issue?
<br>
Program Usage:
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-11585/attachment">attachment</a>
</ul>
