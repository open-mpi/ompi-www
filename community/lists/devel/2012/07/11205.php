...
?>
<!-- received="Mon Jul  2 13:59:38 2012" -->
<!-- isoreceived="20120702175938" -->
<!-- sent="Mon, 2 Jul 2012 13:59:33 -0400" -->
<!-- isosent="20120702175933" -->
<!-- name="Shamis, Pavel" -->
...
<!-- id="501CC256-00DE-435C-A48C-283CF5BE35A8_at_ornl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="385B40A3-5D28-447B-9539-FFD32816B9B5_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-07-02 13:59:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11206.php">Shamis, Pavel: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r26707 - in trunk/ompi: config mca/btl/ofud mca/btl/openib mca/common/ofacm mca/common/ofautils mca/dpm"</a>
<li><strong>Previous message:</strong> <a href="11204.php">Barrett, Brian W: "Re: [OMPI devel] [EXTERNAL]  Trunk compilation broken"</a>
<li><strong>In reply to:</strong> <a href="11201.php">Jeff Squyres: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r26707 - in trunk/ompi: config mca/btl/ofud mca/btl/openib mca/common/ofacm mca/common/ofautils mca/dpm"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11203.php">TERRY DONTJE: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r26707 - in trunk/ompi: config mca/btl/ofud mca/btl/openib mca/common/ofacm mca/common/ofautils mca/dpm"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
<span class="quotelev1">&gt; Keep in mind that this is currently not used for the openib BTL.  It is only used in the upcoming OpenFabrics-based collectives component.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The iWARP-required connector-must-send-first logic is not yet included in this code, as I understand it.  That must be added before it can be used with the openib BTL.
</span><br>
<p>It seems that IB and Iwarp vendors aren't interested to support it RDMACM or IBCM.
<br>
<p>Pasha.
<br>
