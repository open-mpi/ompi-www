...
?>
<!-- received="Thu Jul 26 10:46:27 2012" -->
<!-- isoreceived="20120726144627" -->
<!-- sent="Thu, 26 Jul 2012 16:46:18 +0200" -->
<!-- isosent="20120726144618" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [patch] MPI_Cancel should not cancel a request if	it has a matched recv frag" -->
<!-- id="D4EF510B-751D-4592-99B0-E8EA745627B7_at_eecs.utk.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="3D8F945A4E59E644AE9205E5CD3708E517FB77CD_at_MTIDAG02.mtl.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-07-26 10:46:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11320.php">Richard Graham: "Re: [OMPI devel] [patch] MPI_Cancel should not cancel a request	if	it has a matched recv frag"</a>
<li><strong>Previous message:</strong> <a href="11318.php">Richard Graham: "Re: [OMPI devel] [patch] MPI_Cancel should not cancel a request if	it has a matched recv frag"</a>
<li><strong>In reply to:</strong> <a href="11318.php">Richard Graham: "Re: [OMPI devel] [patch] MPI_Cancel should not cancel a request if	it has a matched recv frag"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11320.php">Richard Graham: "Re: [OMPI devel] [patch] MPI_Cancel should not cancel a request	if	it has a matched recv frag"</a>
<li><strong>Reply:</strong> <a href="11320.php">Richard Graham: "Re: [OMPI devel] [patch] MPI_Cancel should not cancel a request	if	it has a matched recv frag"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; Subject: Re: [OMPI devel] [patch] MPI_Cancel should not cancel a request if it has a matched recv frag
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; cancellation, it must push the recv frag to the unexpected message 
</span><br>
<span class="quotelev2">&gt;&gt; queue back and redo matching. Furthermore, the receive buffer must be 
</span><br>
<span class="quotelev2">&gt;&gt; reverted if the received message has been written to the receive 
</span><br>
<span class="quotelev2">&gt;&gt; buffer partially in a pipeline protocol.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Attached patch cancel-recv.patch is a sample fix for this bug for Open 
</span><br>
<span class="quotelev2">&gt;&gt; MPI trunk. Though this patch has 65 lines, main modifications are 
</span><br>
<span class="quotelev2">&gt;&gt; adding one if-statement and deleting one if-statement. Other lines are 
</span><br>
<span class="quotelev2">&gt;&gt; just for indent alignment.
</span><br>
...
<span class="quotelev2">&gt;&gt; &lt;cancelled.c&gt;&lt;cancel-recv.patch&gt;&lt;License.txt&gt;_________________________
</span><br>
