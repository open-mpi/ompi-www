...
?>
<!-- received="Fri Jul  6 02:52:14 2012" -->
<!-- isoreceived="20120706065214" -->
<!-- sent="Fri, 6 Jul 2012 08:51:10 +0200" -->
<!-- isosent="20120706065110" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] SM component init unload" -->
<!-- id="E62680B8-00B6-4A36-8710-716AB02D58DE_at_eecs.utk.edu" -->
<!-- charset="utf-8" -->
<!-- inreplyto="4EE5AAB7-8DC6-4829-9732-3E69587F0AD4_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-07-06 02:51:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11243.php">TERRY DONTJE: "Re: [OMPI devel] openib max_cqe"</a>
<li><strong>Previous message:</strong> <a href="11241.php">George Bosilca: "Re: [OMPI devel] non-blocking barrier"</a>
<li><strong>In reply to:</strong> <a href="11238.php">Ralph Castain: "Re: [OMPI devel] SM component init unload"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p>&nbsp;&nbsp;George
<br>
<p><p><p>On Jul 6, 2012, at 2:20, Ralph Castain &lt;rhc.openmpi_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; George: is there any reason for opening and selecting the coll framework so early in mpi_init? I'm wondering if we can move that code to the end of the procedure so we wouldn't need the locality info until later.
</span><br>
...
<span class="quotelev1">&gt; On Jul 5, 2012, at 10:05 AM, Jeff Squyres &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Thanks George.  I filed <a href="https://svn.open-mpi.org/trac/ompi/ticket/3162">https://svn.open-mpi.org/trac/ompi/ticket/3162</a> about this.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Jul 4, 2012, at 5:34 AM, Juan A. Rico wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Thanks all of you for your time and early responses.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; After applying the patch, SM can be used by raising its priority. It is enough for me (I hope so). But it continues failing when I specify --mca coll sm,self in the command line (with tuned too).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I am not going to use this release in production, only for playing with the code :-)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Regards,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Juan Antonio.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; El 04/07/2012, a las 02:59, George Bosilca escribi&#195;&#179;:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Something weird is going on there. The selection mechanism for the SM coll and SM BTL should be very similar. However, the SM BTL successfully select itself while the SM coll fails to determine that all processes are local.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; In the coll SM the issue is that the remote procs do not have the LOCAL flag set, even when they are on the local node (however the ompi_proc_local() return has a special flag stating that all processes in the job are local). I compared the initialization of the SM BTL and the SM coll. It turns out that somehow the procs returned by ompi_proc_all() and the procs provided to the add_proc of the BTLs are not identical. The second have the local flag correctly set, so I went a little bit deeper.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Here is what I found while toying with gdb inside:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; breakpoint 1, mca_coll_sm_init_query (enable_progress_threads=false, enable_mpi_threads=false) at coll_sm_module.c:132
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb) p procs[0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $1 = (ompi_proc_t *) 0x109a1e8c0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb) p procs[1]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $2 = (ompi_proc_t *) 0x109a1e970
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb) p procs[0]-&gt;proc_flags
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $3 = 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb) p procs[1]-&gt;proc_flags
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $4 = 4095
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Breakpoint 2, mca_btl_sm_add_procs (btl=0x109baa1c0, nprocs=2, procs=0x109a319e0, peers=0x109a319f0, reachability=0x7fff691378e8) at btl_sm.c:427
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb) p procs[0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $5 = (struct ompi_proc_t *) 0x109a1e8c0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb) p procs[1]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $6 = (struct ompi_proc_t *) 0x109a1e970
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb) p procs[0]-&gt;proc_flags
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $7 = 1920
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb) p procs[1]-&gt;proc_flags
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $8 = 4095
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Thus the problem seems to come from the fact that during the initialization of the SM coll the flags are not correctly set. However, this is somehow expected &#226;&#128;&#166; as the call to the initialization happens before the exchange of the business cards (and therefore there is no way to have any knowledge about the remote procs).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So, either something changed drastically in the way we set the flags for remote processes or we did not use the SM coll for the last 3 years. I think the culprit is r21967 (<a href="https://svn.open-mpi.org/trac/ompi/changeset/21967">https://svn.open-mpi.org/trac/ompi/changeset/21967</a>) who added a &quot;selection&quot; logic based on knowledge about remote procs in the coll SM initialization function. But this selection logic was way to early !!!
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I would strongly encourage you not to use this SM collective component in anything related to production runs.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; PS: However, if you want to toy with the SM coll apply the following patch:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Index: coll_sm_module.c
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ===================================================================
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --- coll_sm_module.c    (revision 26737)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; +++ coll_sm_module.c    (working copy)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; @@ -128,6 +128,7 @@
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; int mca_coll_sm_init_query(bool enable_progress_threads,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;                           bool enable_mpi_threads)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; {
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; +#if 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;    ompi_proc_t *my_proc, **procs;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;    size_t i, size;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; @@ -158,7 +159,7 @@
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;                            &quot;coll:sm:init_query: no other local procs; disqualifying myself&quot;);
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;        return OMPI_ERR_NOT_AVAILABLE;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;    }
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -
...
<span class="quotelev4">&gt;&gt;&gt;&gt;    /* Don't do much here because we don't really want to allocate any
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;       shared memory until this component is selected to be used. */
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;    opal_output_verbose(10, mca_coll_base_output,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jul 4, 2012, at 02:05 , Ralph Castain wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Okay, please try this again with r26739 or above. You can remove the rest of the &quot;verbose&quot; settings and the --display-map so we declutter the output. Please add &quot;-mca orte_nidmap_verbose 20&quot; to your cmd line.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; El 03/07/2012, a las 21:44, Ralph Castain escribi&#195;&#179;:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; El 03/07/2012, a las 21:01, Jeff Squyres escribi&#195;&#179;:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
