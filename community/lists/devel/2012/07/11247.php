...
?>
<!-- received="Fri Jul  6 10:55:29 2012" -->
<!-- isoreceived="20120706145529" -->
<!-- sent="Fri, 6 Jul 2012 14:47:11 +0000" -->
<!-- isosent="20120706144711" -->
<!-- name="Richard Graham" -->
<!-- email="richardg_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] non-blocking barrier" -->
<!-- id="3D8F945A4E59E644AE9205E5CD3708E5057641CD_at_MTIDAG01.mtl.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="E5142F83-C981-4627-8483-BBF26CCA08DF_at_eecs.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-07-06 10:47:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11248.php">Holger Mickler: "Re: [OMPI devel] VampirTrace: time not increasing"</a>
<li><strong>Previous message:</strong> <a href="11246.php">Richard Graham: "Re: [OMPI devel] non-blocking barrier"</a>
<li><strong>In reply to:</strong> <a href="11241.php">George Bosilca: "Re: [OMPI devel] non-blocking barrier"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11249.php">Barrett, Brian W: "Re: [OMPI devel] [EXTERNAL] Re:  non-blocking barrier"</a>
<li><strong>Reply:</strong> <a href="11249.php">Barrett, Brian W: "Re: [OMPI devel] [EXTERNAL] Re:  non-blocking barrier"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Forget what I just posted - I looked at George's words, and not the code - wait() is the synchronization point, so George's response is correct.
<br>
<p>Rich
<br>
<p>-----Original Message-----
...
Subject: Re: [OMPI devel] non-blocking barrier
<br>
<p>No, it is not right. With the ibarrier usage you're making below, the output should be similar to the first case (all should leave at earlist at 6.0). The ibarrier is still a synchronizing point, all processes MUST reach it before anyone is allowed to leave.
<br>
