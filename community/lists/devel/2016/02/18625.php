...
?>
<!-- received="Thu Feb 25 17:44:22 2016" -->
<!-- isoreceived="20160225224422" -->
<!-- sent="Thu, 25 Feb 2016 17:44:20 -0500" -->
<!-- isosent="20160225224420" -->
<!-- name="dpchoudh ." -->
<!-- email="dpchoudh_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] Adding a new BTL" -->
<!-- id="CAHXxYDheXUACi96UkOXpN9A+RxX=F5GSsg1BeHnBwgMnkxSM9Q_at_mail.gmail.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2016-02-25 17:44:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18626.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] Adding a new BTL"</a>
<li><strong>Previous message:</strong> <a href="18624.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] MTT setup updated to gcc-6.0 (pre)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18626.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] Adding a new BTL"</a>
<li><strong>Reply:</strong> <a href="18626.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] Adding a new BTL"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18625/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/x-log attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18625/autogen.log">autogen.log</a>
</ul>
<!-- attachment="autogen.log" -->
<hr>
<ul>
<li>text/x-log attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18625/configure.log">configure.log</a>
</ul>
<!-- attachment="configure.log" -->
<hr>
<ul>
<li>text/x-log attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18625/config.log">config.log</a>
</ul>
<!-- attachment="config.log" -->
<hr>
<ul>
<li>application/x-m4 attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18625/configure.m4">configure.m4</a>
</ul>
<!-- attachment="configure.m4" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18625/Makefile.am">Makefile.am</a>
</ul>
