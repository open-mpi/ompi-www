...
?>
<!-- received="Thu Feb 25 21:12:29 2016" -->
<!-- isoreceived="20160226021229" -->
<!-- sent="Fri, 26 Feb 2016 02:12:26 +0000" -->
<!-- isosent="20160226021226" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] Adding a new BTL" -->
<!-- id="76858A13-CC14-4BFF-BEAE-71CAC266535F_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAMJJpkX1TrM7quJ7bpF1eypk8PCUwHfd7dn+oLmZkBY0URR7RQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-02-25 21:12:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18631.php">Monika Hemnani: "[OMPI devel] error while compiling openmpi"</a>
<li><strong>Previous message:</strong> <a href="18629.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI users] Adding a new BTL"</a>
<li><strong>In reply to:</strong> <a href="18628.php">George Bosilca: "Re: [OMPI devel] [OMPI users] Adding a new BTL"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18629.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI users] Adding a new BTL"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>If you look at various components around Open MPI, many component and/or module functions *are* actually static because they aren't needed outside that .c file in the component.  It just depends on the individual component code base.
<br>
<p><p><span class="quotelev1">&gt; On Feb 25, 2016, at 8:48 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; If we declare these functions as static we are forced to have the functions defined and used in the same source file. The fact that they are declared as extern allows us to use these functions in all files in the same component. Once linked in the corresponding shared library, all symbols not marked with OPAL_DECLSPEC will not be visible, forcing all interactions with the component to go through the component structure (mca_btl_template_module_t mca_btl_template_module) which is the only visible symbol.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Thu, Feb 25, 2016 at 7:41 PM, dpchoudh . &lt;dpchoudh_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; I really appreciate how all the principle of object oriented design principles have been used in OMPI architecture and have been implemented in a language that is not object oriented. It is a textbook example in software engineering.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; However, I see that functions that are indirectly referenced, via a structure of function pointers, have been declared 'extern' in header files. This, to me, looks like against the principle of code design. Making these 'static' and removing them from the headers does not break the build of course, and does not even generate warnings. As an example, the following functions need not be externalized, except, perhaps, for debugging:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Is there any reason why it is done this way? If I made them 'static' in my own BTL code, would I get into trouble down the road?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Thu, Feb 25, 2016 at 7:02 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; on master/v2.x, you also have to
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt; 1-2: Full output from autogen.pl and configure, captured with: ./&lt;cmd&gt; 2&gt;&amp;1
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Thank you very much for your advice. Yes, I copied the templates from the
</span><br>
<span class="quotelev3">&gt; &gt;&gt; master branch to the 1.10.2 release, since the release does not have them.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; And yes, changing the Makefile.am as you suggest did make the autogen error
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Makefile.in from Makefile.am (via autogen) and a Makefile from Makefile.in
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; On Thu, Feb 25, 2016 at 3:54 PM, dpchoudh . &lt;dpchoudh_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2016/02/18626.php">http://www.open-mpi.org/community/lists/devel/2016/02/18626.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2016/02/18627.php">http://www.open-mpi.org/community/lists/devel/2016/02/18627.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2016/02/18628.php">http://www.open-mpi.org/community/lists/devel/2016/02/18628.php</a>
</span><br>
<p><p><pre>
-- 
Jeff Squyres
