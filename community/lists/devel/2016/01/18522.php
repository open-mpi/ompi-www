...
?>
<!-- received="Mon Jan 25 18:22:34 2016" -->
<!-- isoreceived="20160125232234" -->
<!-- sent="Mon, 25 Jan 2016 15:22:25 -0800" -->
<!-- isosent="20160125232225" -->
<!-- name="Paul Hargrove" -->
<!-- email="phhargrove_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] tm-less tm module" -->
<!-- id="CAAvDA16J5rxzb+Y8ytNtfeUQm6nCLbpkbnrAw0_wGSrNZSf=cg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-01-25 18:22:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18523.php">Ralph Castain: "Re: [OMPI devel] tm-less tm module"</a>
<li><strong>Previous message:</strong> <a href="18521.php">Ralph Castain: "Re: [OMPI devel] tm-less tm module"</a>
<li><strong>In reply to:</strong> <a href="18520.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] tm-less tm module"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18523.php">Ralph Castain: "Re: [OMPI devel] tm-less tm module"</a>
<li><strong>Reply:</strong> <a href="18523.php">Ralph Castain: "Re: [OMPI devel] tm-less tm module"</a>
<li><strong>Reply:</strong> <a href="18530.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] tm-less tm module"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Jeff,
<br>
<p>Excellent point about the --with-foo behavior.
<br>
...
<br>
<p>Even so, if folks feel (as Nathan or Howard seem to) that a configure
<br>
summary is useful, then I can't see any *harm* in adding it.
<br>
Since once the build is complete ompi_info can tell one essentially
<br>
everything about the build, I don't think Jeff's &quot;slippery slope&quot;/&quot;eye
<br>
chart&quot; concern is a real problem - the summary (if any) would remain very
<br>
high level (such as a list of configured components and language bindings).
<br>
<p>If at the end of this line of discussion no new summary output is to be
<br>
generated, then I stand my original proposal of having &quot;make install&quot; print
<br>
a suggestion that admins run ompi_info to double-check what they have
<br>
built/installed.
<br>
...
<p>-Paul
<br>
<p>On Mon, Jan 25, 2016 at 2:37 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18522/attachment">attachment</a>
</ul>
