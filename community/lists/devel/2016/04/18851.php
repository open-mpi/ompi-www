...
?>
<!-- received="Fri Apr 29 14:08:42 2016" -->
<!-- isoreceived="20160429180842" -->
<!-- sent="Fri, 29 Apr 2016 18:08:39 +0000" -->
<!-- isosent="20160429180839" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] 2.0.0 is coming: what do we need to	communicate	to	users?" -->
<!-- id="90639AC4-B373-4F9E-AC54-CBDDE83F4A00_at_cisco.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="7799B319-E490-43B6-B927-EE798DE6BE18_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-29 14:08:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18852.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] 2.0.0 is coming: what do we need	to	communicate	to	users?"</a>
<li><strong>Previous message:</strong> <a href="18850.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] 2.0.0 is coming: what do we need to communicate	to	users?"</a>
<li><strong>In reply to:</strong> <a href="18850.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] 2.0.0 is coming: what do we need to communicate	to	users?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18853.php">Swpoole-Gmail: "Re: [OMPI devel] 2.0.0 is coming: what do we need to communicate to users?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Let's iterate over this in a wiki page -- seems easier than iterating over email:
<br>

<br>
<a href="https://github.com/open-mpi/ompi/wiki/User-Migration-Guide%3A-1.8.x-and-v1.10.x-to-v2.0.0">https://github.com/open-mpi/ompi/wiki/User-Migration-Guide%3A-1.8.x-and-v1.10.x-to-v2.0.0</a>
<br>

<br>
(I put a link to this on the main OMPI wiki page too, but currently have it labeled as DRAFT, just to make it clear that this is not definitive [yet])
<br>

<br>

<br>
<span class="quotelev1">&gt; On Apr 29, 2016, at 2:03 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Apr 29, 2016, at 2:00 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; Yeah, actually, we don't have much in NEWS about OSHMEM -- Mellanox: what should be in there?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Up to you.  Do you have enough support in 2.0.0 that you want to say something about it in NEWS / this migration guide?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2016/04/18850.php">http://www.open-mpi.org/community/lists/devel/2016/04/18850.php</a>
</span><br>
