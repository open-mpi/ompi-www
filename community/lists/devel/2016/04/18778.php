...
?>
<!-- received="Fri Apr 15 17:38:43 2016" -->
<!-- isoreceived="20160415213843" -->
<!-- sent="Fri, 15 Apr 2016 14:38:35 -0700" -->
<!-- isosent="20160415213835" -->
<!-- name="Larry Baker" -->
<!-- email="baker_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Missing support for 2 types in MPI_Sizeof()" -->
<!-- id="12D90B6B-3E17-4C24-A9B5-2FE87165106B_at_usgs.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="E023FD40-AD01-433B-A66D-75E38AA6F2C0_at_usgs.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-15 17:38:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18779.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Missing support for 2 types in MPI_Sizeof()"</a>
<li><strong>Previous message:</strong> <a href="18777.php">Larry Baker: "Re: [OMPI devel] Missing support for 2 types in MPI_Sizeof()"</a>
<li><strong>In reply to:</strong> <a href="18777.php">Larry Baker: "Re: [OMPI devel] Missing support for 2 types in MPI_Sizeof()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18779.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Missing support for 2 types in MPI_Sizeof()"</a>
<li><strong>Reply:</strong> <a href="18779.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Missing support for 2 types in MPI_Sizeof()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I also remember reading in the past about problems with C sizeof and multibyte characters.  I just looked over the C90 standard.  In C90 code, the sizeof operator returns size_t in bytes.  Except that it always returns 1 for char, signed char, or unsigned char.  For an array, C90 says sizeof returns the number of bytes.  I interpret this to mean that when the execution character set is a 16-bit multibyte character set, sizeof a char is 1, while sizeof a char[1] is 2.  I've never actually tested this.
<br>
<p>Any programs that marshall character strings for interchange have to be quite specific, I think, in the character set being exchanged.  I don't think MPI SIZEOF has a way to know or specify the semantics of the character set.
<br>
<p>Larry Baker
<br>
...
<span class="quotelev1">&gt; On 15 Apr 2016, at 5:34 AM, Jeff Squyres (jsquyres) wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; I believe that the character and logical types are not in this script already because the description of MPI_SIZEOF in MPI-3.1 says that the input choice buffer parameter is:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; As I understand it (and my usual disclaimer here: I am *not* a Fortran expert), CHARACTER and LOGICAL types are not numeric in Fortran.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; I guess I don't have a strong opinion here.  If you file a PR for this patch, I won't object.  :-)
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Apr 15, 2016, at 3:22 AM, DERBEY, NADIA &lt;nadia.derbey_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; nadia.derbey_at_[hidden]
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2016/04/18765.php">http://www.open-mpi.org/community/lists/devel/2016/04/18765.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2016/04/18766.php">http://www.open-mpi.org/community/lists/devel/2016/04/18766.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18778/attachment">attachment</a>
</ul>
