...
?>
<!-- received="Fri Apr 29 13:55:45 2016" -->
<!-- isoreceived="20160429175545" -->
<!-- sent="Fri, 29 Apr 2016 10:55:42 -0700" -->
<!-- isosent="20160429175542" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] 2.0.0 is coming: what do we need to communicate	to	users?" -->
<!-- id="B0864D38-F0A3-4CB9-8248-55BF9017EF99_at_open-mpi.org" -->
<!-- charset="utf-8" -->
<!-- inreplyto="563D549E-F37F-4F72-A39A-C27733B2A6FD_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-29 13:55:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18848.php">Ralph Castain: "Re: [OMPI devel] 2.0.0 is coming: what do we need to communicate to	users?"</a>
<li><strong>Previous message:</strong> <a href="18846.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] 2.0.0 is coming: what do we need to communicate to	users?"</a>
<li><strong>In reply to:</strong> <a href="18845.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] 2.0.0 is coming: what do we need to communicate	to	users?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18849.php">Cabral, Matias A: "Re: [OMPI devel] 2.0.0 is coming: what do we need to	communicate	to	users?"</a>
<li><strong>Reply:</strong> <a href="18849.php">Cabral, Matias A: "Re: [OMPI devel] 2.0.0 is coming: what do we need to	communicate	to	users?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><span class="quotelev1">&gt; On Apr 29, 2016, at 10:47 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2016/04/18845.php">http://www.open-mpi.org/community/lists/devel/2016/04/18845.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
