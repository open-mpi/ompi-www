...
?>
<!-- received="Mon Apr 18 02:23:25 2016" -->
<!-- isoreceived="20160418062325" -->
<!-- sent="Mon, 18 Apr 2016 06:23:20 +0000" -->
<!-- isosent="20160418062320" -->
<!-- name="DERBEY, NADIA" -->
<!-- email="nadia.derbey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Missing support for 2 types in MPI_Sizeof()" -->
<!-- id="57147D2A.5040304_at_atos.net" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="5325FC99-0A72-41A5-B853-B628E3E63F27_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-18 02:23:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18781.php">Howard Pritchard: "Re: [OMPI devel] psm2 and psm2_ep_open problems"</a>
<li><strong>Previous message:</strong> <a href="18779.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Missing support for 2 types in MPI_Sizeof()"</a>
<li><strong>In reply to:</strong> <a href="18779.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Missing support for 2 types in MPI_Sizeof()"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Agreed!
<br>
<p>On 04/15/2016 11:46 PM, Jeff Squyres (jsquyres) wrote:
<br>
<span class="quotelev1">&gt; All sounds like good reasons to amend the Bull test suite to no longer check for character and logical.  :-)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Apr 15, 2016, at 5:38 PM, Larry Baker &lt;baker_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I also remember reading in the past about problems with C sizeof and multibyte characters.  I just looked over the C90 standard.  In C90 code, the sizeof operator returns size_t in bytes.  Except that it always returns 1 for char, signed char, or unsigned char.  For an array, C90 says sizeof returns the number of bytes.  I interpret this to mean that when the execution character set is a 16-bit multibyte character set, sizeof a char is 1, while sizeof a char[1] is 2.  I've never actually tested this.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Any programs that marshall character strings for interchange have to be quite specific, I think, in the character set being exchanged.  I don't think MPI SIZEOF has a way to know or specify the semantics of the character set.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 15 Apr 2016, at 5:34 AM, Jeff Squyres (jsquyres) wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I believe that the character and logical types are not in this script already because the description of MPI_SIZEOF in MPI-3.1 says that the input choice buffer parameter is:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; IN x     a Fortran variable of numeric intrinsic type (choice)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; As I understand it (and my usual disclaimer here: I am *not* a Fortran expert), CHARACTER and LOGICAL types are not numeric in Fortran.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; However, we could add such interfaces as an extension.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I just checked MPICH 3.2, and they *do* include MPI_SIZEOF interfaces for CHARACTER and LOGICAL, but they are missing many of the other MPI_SIZEOF interfaces that we have in OMPI.  Meaning: OMPI and MPICH already diverge wildly on MPI_SIZEOF.  :-\
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I guess I don't have a strong opinion here.  If you file a PR for this patch, I won't object.  :-)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Apr 15, 2016, at 3:22 AM, DERBEY, NADIA &lt;nadia.derbey_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2016/04/18766.php">http://www.open-mpi.org/community/lists/devel/2016/04/18766.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
