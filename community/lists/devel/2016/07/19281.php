...
?>
<!-- received="Mon Jul 25 22:38:27 2016" -->
<!-- isoreceived="20160726023827" -->
<!-- sent="Tue, 26 Jul 2016 11:38:13 +0900" -->
<!-- isosent="20160726023813" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OpenMPI 2.0 and Petsc 3.7.2" -->
<!-- id="0655029b-7145-e822-1acd-e560254b749a_at_rist.or.jp" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="99090192-103a-b58c-8bbb-273b938fb748_at_giref.ulaval.ca" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-07-25 22:38:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19282.php">Nathan Hjelm: "Re: [OMPI devel] OpenMPI 2.0 and Petsc 3.7.2"</a>
<li><strong>Previous message:</strong> <a href="19280.php">Gilles Gouaillardet: "Re: [OMPI devel] PGI built Open MPI vs GNU built slurm"</a>
<li><strong>In reply to:</strong> <a href="19276.php">Eric Chamberland: "[OMPI devel] OpenMPI 2.0 and Petsc 3.7.2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19282.php">Nathan Hjelm: "Re: [OMPI devel] OpenMPI 2.0 and Petsc 3.7.2"</a>
<li><strong>Reply:</strong> <a href="19282.php">Nathan Hjelm: "Re: [OMPI devel] OpenMPI 2.0 and Petsc 3.7.2"</a>
<li><strong>Reply:</strong> <a href="19285.php">Eric Chamberland: "Re: [OMPI devel] OpenMPI 2.0 and Petsc 3.7.2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Eric,
<br>
<p>where can your test case be downloaded ? how many nodes and tasks do you 
<br>
need to reproduce the bug ?
<br>
<p>fwiw, currently there are two Open MPI repositories
<br>
- <a href="https://github.com/open-mpi/ompi">https://github.com/open-mpi/ompi</a>
<br>
...
<p>Gilles
<br>
<p>On 7/26/2016 3:33 AM, Eric Chamberland wrote:
<br>
...
<span class="quotelev1">&gt; (in fact, I am testing the ompi-release branch, a sort of petsc-master 
</span><br>
<span class="quotelev1">&gt; branch, since I need the commit 9ba6678156).
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; I feel like I should wait until someone else from Petsc have tested it 
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2016/07/19276.php">http://www.open-mpi.org/community/lists/devel/2016/07/19276.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
