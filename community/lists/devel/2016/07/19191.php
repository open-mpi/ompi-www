<?
$subject_val = "Re: [OMPI devel] [OMPI users]   Class information in OpenMPI";
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI devel] [OMPI users]   Class information in OpenMPI<br>
<strong>From:</strong> Jeff Squyres (jsquyres) (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2016-07-12 15:12:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19192.php">Eric Chamberland: "Re: [OMPI devel] 2.0.0rc4 Crash in MPI_File_write_all_end"</a>
<li><strong>Previous message:</strong> <a href="19190.php">Emani, Murali: "Re: [OMPI devel] Class information in OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="19189.php">Emani, Murali: "Re: [OMPI devel] [OMPI users] Class information in OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19193.php">Emani, Murali: "Re: [OMPI devel] [OMPI users]   Class information in OpenMPI"</a>
<li><strong>Reply:</strong> <a href="19193.php">Emani, Murali: "Re: [OMPI devel] [OMPI users]   Class information in OpenMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
