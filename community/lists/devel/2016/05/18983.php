...
?>
<!-- received="Mon May 16 11:00:40 2016" -->
<!-- isoreceived="20160516150040" -->
<!-- sent="Tue, 17 May 2016 00:00:38 +0900" -->
<!-- isosent="20160516150038" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Process connectivity map" -->
<!-- id="CAAkFZ5vzyxBiZMw7P8dd=1HUf+MGbLBq9eD0vHbuX0aoEiRGiQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="E50CAAEE-C5DE-48FA-A882-D9A601940D79_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-05-16 11:00:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18984.php">Ralph Castain: "Re: [OMPI devel] Process connectivity map"</a>
<li><strong>Previous message:</strong> <a href="18982.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Process connectivity map"</a>
<li><strong>In reply to:</strong> <a href="18982.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Process connectivity map"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18984.php">Ralph Castain: "Re: [OMPI devel] Process connectivity map"</a>
<li><strong>Reply:</strong> <a href="18984.php">Ralph Castain: "Re: [OMPI devel] Process connectivity map"</a>
<li><strong>Reply:</strong> <a href="18986.php">Nathan Hjelm: "Re: [OMPI devel] Process connectivity map"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Gilles
<br>
<p>On Monday, May 16, 2016, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; We changed the way BTL add_procs is invoked on master and v2.x for
</span><br>
...
<span class="quotelev1">&gt; peer.  The cutoff switch is an override to that -- if the sizeof COMM_WORLD
</span><br>
<span class="quotelev1">&gt; is less than the cutoff, we revert to the old behavior of calling add_procs
</span><br>
<span class="quotelev1">&gt; for all procs.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; As for why one BTL would be chosen over another, be sure to look at not
</span><br>
<span class="quotelev1">&gt; only the priority of the component/module, but also the exclusivity level.
</span><br>
<span class="quotelev1">&gt; In short, only BTLs with the same exclusivity level will be considered
</span><br>
<span class="quotelev1">&gt; (e.g., this is how we exclude TCP when using HPC-class networks), and then
</span><br>
<span class="quotelev1">&gt; the BTL modules with the highest priority will be used for a given peer.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev2">&gt; &gt; note mca_btl_tcp_add_procs is invoked once per tcp component (e.g. once
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Sorry, I accidentally pressed 'Send' before I was done writing the last
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Setting -mca mpi_add_procs_cutoff 1024 indeed makes a difference to the
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On Sunday, May 15, 2016, dpchoudh . &lt;dpchoudh_at_[hidden] &lt;javascript:;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; of your suggestions before asking for help.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; was invoked for Send()/Recv() and the pointer itself was NULL when invoked
</span><br>
<span class="quotelev1">&gt; for Barrier()
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; BTL implementations are doing, yet in mca_bml_r2_endpoint_add_btl() by BTL
</span><br>
<span class="quotelev1">&gt; is not being picked up, left me puzzled. Please note that the interconnect
</span><br>
...
<span class="quotelev1">&gt; be a good idea to ask for help.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18983/attachment">attachment</a>
</ul>
