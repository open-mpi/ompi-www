<?
$subject_val = "[OMPI devel] Openmpi 1.10.1: BUG in orterun.c";
...
<!-- subject="[OMPI devel] Openmpi 1.10.1: BUG in orterun.c" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Openmpi 1.10.1: BUG in orterun.c<br>
<strong>From:</strong> Stefano Garzarella (<em>s.garzarella_at_[hidden]</em>)<br>
<strong>Date:</strong> 2015-12-01 09:42:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18398.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Openmpi 1.10.1: BUG in orterun.c"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/devel/2015/11/18396.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Proposal on RFCs"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18398.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Openmpi 1.10.1: BUG in orterun.c"</a>
<li><strong>Reply:</strong> <a href="18398.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Openmpi 1.10.1: BUG in orterun.c"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
