...
?>
<!-- received="Fri Jan  9 14:28:00 2015" -->
<!-- isoreceived="20150109192800" -->
<!-- sent="Fri, 9 Jan 2015 12:27:59 -0700" -->
<!-- isosent="20150109192759" -->
<!-- name="Howard Pritchard" -->
<!-- email="hppritcha_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Changed behaviour with PSM on master" -->
<!-- id="CAF1Cqj5Hf=uDEZN-FrPhpcLafn8k56RCOC1uk97AoZ1xiZ2XCw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2015-01-09 14:27:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16770.php">Adrian Reber: "Re: [OMPI devel] Changed behaviour with PSM on master"</a>
<li><strong>Previous message:</strong> <a href="16768.php">Howard Pritchard: "Re: [OMPI devel] Changed behaviour with PSM on master"</a>
<li><strong>In reply to:</strong> <a href="16766.php">Friedley, Andrew: "Re: [OMPI devel] Changed behaviour with PSM on master"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16770.php">Adrian Reber: "Re: [OMPI devel] Changed behaviour with PSM on master"</a>
<li><strong>Reply:</strong> <a href="16770.php">Adrian Reber: "Re: [OMPI devel] Changed behaviour with PSM on master"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
HI Adrian, Andrew,
<br>
<p>Sorry try again,  both the libfabric psm provider and the open mpi psm
<br>
mtl are trying to use psm_init.
<br>
<p>So, to avoid this problem, add
<br>
<p>--mca mtl psm
<br>
<p>to your mpirun command line.
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16769/attachment">attachment</a>
</ul>
