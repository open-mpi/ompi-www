...
?>
<!-- received="Mon Nov  9 13:13:42 2015" -->
<!-- isoreceived="20151109181342" -->
<!-- sent="Mon, 9 Nov 2015 10:13:35 -0800" -->
<!-- isosent="20151109181335" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] PMIX deadlock" -->
<!-- id="6DDFE31F-7344-42D0-A439-60CD720465DC_at_open-mpi.org" -->
<!-- charset="utf-8" -->
<!-- inreplyto="CAMJJpkVF6mMx7+SZptxt_U=402xTi5kc+HbAVgCCgiV2fW9WCA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-11-09 13:13:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18348.php">George Bosilca: "Re: [OMPI devel] PMIX deadlock"</a>
<li><strong>Previous message:</strong> <a href="18346.php">George Bosilca: "Re: [OMPI devel] PMIX deadlock"</a>
<li><strong>In reply to:</strong> <a href="18346.php">George Bosilca: "Re: [OMPI devel] PMIX deadlock"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18348.php">George Bosilca: "Re: [OMPI devel] PMIX deadlock"</a>
<li><strong>Reply:</strong> <a href="18348.php">George Bosilca: "Re: [OMPI devel] PMIX deadlock"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Thanks Nysal - I believe this should indeed fix the problem!
<br>
<p><p><span class="quotelev1">&gt; On Nov 9, 2015, at 9:04 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Clearly Nyal got a valid point there. I launched a stress test with Nysal suggestion in the code, and so far it's up to few hundreds iterations
</span><br>
<span class="quotelev1">&gt; without deadlock. I would not claim victory yet, I launched a 10k cycle to see where we stand (btw this never passed before).
</span><br>
...
<span class="quotelev1">&gt; On Mon, Nov 9, 2015 at 11:55 AM, Artem Polyakov &lt;artpol84_at_[hidden] &lt;mailto:artpol84_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 2015-11-09 22:42 GMT+06:00 Artem Polyakov &lt;artpol84_at_[hidden] &lt;mailto:artpol84_at_[hidden]&gt;&gt;:
</span><br>
<span class="quotelev1">&gt; This is the very good point, Nysal!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; This is definitely a problem and I can say even more: avg. 3 from every 10 tasks was affected by this bug. Once the PR (<a href="https://github.com/pmix/master/pull/8">https://github.com/pmix/master/pull/8</a> &lt;<a href="https://github.com/pmix/master/pull/8">https://github.com/pmix/master/pull/8</a>&gt;) was applied I was able to run 100 testing tasks without any hangs.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Here some more information on my symptoms. I was observing this without OMPI, just running pmix_client test binary from PMIx test suite with SLURM PMIx plugin.
</span><br>
<span class="quotelev1">&gt; Periodicaly application was hanging. Investigation shows that not all processes are able to initialize correctly. 
</span><br>
<span class="quotelev1">&gt; Here is how such client's backtrace looks like:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; P.S. I think that this backtrace may be relevant to George's problem as well. In my case not all of the processes was hanging in the connect_to_server, most of them were able to move forward and reach Fence.
</span><br>
<span class="quotelev1">&gt; George, the backtrace that you've posted was the same on both processes or it was the &quot;random&quot; one from one of them?
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; (gdb) bt
</span><br>
<span class="quotelev1">&gt; #0  0x00007f1448f1b7eb in recv () from /lib/x86_64-linux-gnu/libpthread.so.0
</span><br>
<span class="quotelev1">&gt; #1  0x00007f144914c191 in pmix_usock_recv_blocking (sd=9, data=0x7fff367f7c64 &quot;&quot;, size=4) at src/usock/usock.c:166
</span><br>
<span class="quotelev1">&gt; #2  0x00007f1449152d18 in recv_connect_ack (sd=9) at src/client/pmix_client.c:837
</span><br>
<span class="quotelev1">&gt; #3  0x00007f14491546bf in usock_connect (addr=0x7fff367f7d60) at src/client/pmix_client.c:1103
</span><br>
<span class="quotelev1">&gt; #4  0x00007f144914f94c in connect_to_server (address=0x7fff367f7d60, cbdata=0x7fff367f7dd0) at src/client/pmix_client.c:179
</span><br>
<span class="quotelev1">&gt; #5  0x00007f1449150421 in PMIx_Init (proc=0x7fff367f81d0) at src/client/pmix_client.c:355
</span><br>
<span class="quotelev1">&gt; #6  0x0000000000401b97 in main (argc=9, argv=0x7fff367f83d8) at pmix_client.c:62
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; [cn33:00482] pmix:server _register_client for nspace slurm.pmix.22.0 rank 10
</span><br>
...
<span class="quotelev1">&gt; [cn33:00491] usock_peer_try_connect: attempting to connect to server on socket 10
</span><br>
...
<span class="quotelev1">&gt; [cn33:00491] blocking_recv received error 11:Resource temporarily unavailable from remote - cycling
</span><br>
<span class="quotelev1">&gt; [cn33:00491] blocking_recv received error 11:Resource temporarily unavailable from remote - cycling
</span><br>
...
<span class="quotelev1">&gt; 2015-11-09 10:53 GMT+06:00 Nysal Jan K A &lt;jnysal_at_[hidden] &lt;mailto:jnysal_at_[hidden]&gt;&gt;:
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/11/18341.php">http://www.open-mpi.org/community/lists/devel/2015/11/18341.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/devel/2015/11/18341.php">http://www.open-mpi.org/community/lists/devel/2015/11/18341.php</a>&gt;
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/11/18345.php">http://www.open-mpi.org/community/lists/devel/2015/11/18345.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/devel/2015/11/18345.php">http://www.open-mpi.org/community/lists/devel/2015/11/18345.php</a>&gt;
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/11/18346.php">http://www.open-mpi.org/community/lists/devel/2015/11/18346.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18347/attachment">attachment</a>
</ul>
