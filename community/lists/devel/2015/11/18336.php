...
?>
<!-- received="Sat Nov  7 11:58:42 2015" -->
<!-- isoreceived="20151107165842" -->
<!-- sent="Sat, 7 Nov 2015 11:58:38 -0500" -->
<!-- isosent="20151107165838" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] PMIX deadlock" -->
<!-- id="CAMJJpkWkvR6woeMFkM5k-RyMT_beyaXTULKcYnX00x+RVO26Cg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="2C2B8710-BF4C-4EAD-A23F-9326C501A347_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-11-07 11:58:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18337.php">Ralph Castain: "Re: [OMPI devel] PMIX deadlock"</a>
<li><strong>Previous message:</strong> <a href="18335.php">Ralph Castain: "Re: [OMPI devel] PMIX deadlock"</a>
<li><strong>In reply to:</strong> <a href="18335.php">Ralph Castain: "Re: [OMPI devel] PMIX deadlock"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18337.php">Ralph Castain: "Re: [OMPI devel] PMIX deadlock"</a>
<li><strong>Reply:</strong> <a href="18337.php">Ralph Castain: "Re: [OMPI devel] PMIX deadlock"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>&nbsp;&nbsp;George.
<br>
<p><p>On Sat, Nov 7, 2015 at 11:26 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; George was looking into it, but I don&#226;&#128;&#153;t know if he has had time recently
</span><br>
<span class="quotelev1">&gt; to continue the investigation. We understand &#226;&#128;&#156;what&#226;&#128;&#157; is happening (accept
</span><br>
<span class="quotelev1">&gt; sometimes ignores the connection), but we don&#226;&#128;&#153;t yet know &#226;&#128;&#156;why&#226;&#128;&#157;. I&#226;&#128;&#153;ve done
</span><br>
<span class="quotelev1">&gt; some digging around the web, and found that sometimes you can try to talk
</span><br>
<span class="quotelev1">&gt; to a Unix Domain Socket too quickly - i.e., you open it and then send to
</span><br>
<span class="quotelev1">&gt; it, but the OS hasn&#226;&#128;&#153;t yet set it up. In those cases, you can hang the
</span><br>
<span class="quotelev1">&gt; socket. However, I&#226;&#128;&#153;ve tried adding some artificial delay, and while it
</span><br>
<span class="quotelev1">&gt; helped, it didn&#226;&#128;&#153;t completely solve the problem.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I have an idea for a workaround (set a timer and retry after awhile), but
</span><br>
<span class="quotelev1">&gt; would obviously prefer a real solution. I&#226;&#128;&#153;m not even sure it will work as
</span><br>
<span class="quotelev1">&gt; it is unclear that the server (who is the one hung in accept) will break
</span><br>
...
<span class="quotelev1">&gt; On Nov 6, 2015, at 10:53 PM, Artem Polyakov &lt;artpol84_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; I&#226;&#128;&#153;ve verified that the orte/util/listener thread is not being started, so
</span><br>
<span class="quotelev2">&gt;&gt; I don&#226;&#128;&#153;t think it should be involved in this problem.
</span><br>
...
<span class="quotelev2">&gt;&gt; So the only listener thread that should exist is the one inside the PMIx
</span><br>
<span class="quotelev2">&gt;&gt; server itself. If something else is happening, then that would be a bug. I
</span><br>
<span class="quotelev2">&gt;&gt; can look at the orte listener code to ensure that the thread isn&#226;&#128;&#153;t
</span><br>
...
<span class="quotelev2">&gt;&gt; Some progress, that puzzles me but might help you understand. Once the
</span><br>
<span class="quotelev2">&gt;&gt; deadlock appears, if I manually kill the MPI process on the node where the
</span><br>
<span class="quotelev2">&gt;&gt; deadlock was created, the local orte daemon doesn't notice and will just
</span><br>
<span class="quotelev2">&gt;&gt; keep waiting.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Quick question: I am under the impression that the issue is not in the
</span><br>
<span class="quotelev2">&gt;&gt; PMIX server but somewhere around the listener_thread_fn in
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Should have also clarified: the prior fixes are indeed in the current
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; So that problem occurred -after- the server had correctly called accept.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The listener code is in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; opal/mca/pmix/pmix1xx/pmix/src/server/pmix_server_listener.c
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; It looks to me like the only way we could drop the accept (assuming the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; OS doesn&#226;&#128;&#153;t lose it) is if the file descriptor lies outside the expected
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;              * set with a subset consisting of those descriptors that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; are ready
</span><br>
<span class="quotelev3">&gt;&gt;&gt;              * for the specified operation - in this case, a read. So we
</span><br>
<span class="quotelev3">&gt;&gt;&gt; need to
</span><br>
<span class="quotelev3">&gt;&gt;&gt;              * first check to see if this file descriptor is included in
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;              * request has been received - so harvest it. All we want to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; do
</span><br>
<span class="quotelev3">&gt;&gt;&gt;              * here is accept the connection and push the info onto the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;              * process the connection here as it takes too long, and so
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             event_assign(&amp;pending_connection-&gt;ev, pmix_globals.evbase,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;                         pmix_output(0, &quot;listen_thread: accept() failed:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; %s (%d).&quot;,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Oct 28, 2015, at 12:25 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Oct 28, 2015, at 12:22 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Here is the discussion - afraid it is fairly lengthy. Ignore the hwloc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; references in it as that was a separate issue:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Looking with &quot;netstat -ax&quot; at the status of the UDS while the processes
</span><br>
<span class="quotelev3">&gt;&gt;&gt; are deadlocked, I see 2 UDS with the same name: one from the server which
</span><br>
<span class="quotelev3">&gt;&gt;&gt; is in LISTEN state, and one for the client which is being in CONNECTING
</span><br>
<span class="quotelev3">&gt;&gt;&gt; state (while the client already sent a message in the socket and is now
</span><br>
<span class="quotelev3">&gt;&gt;&gt; waiting in a blocking receive). This somehow suggest that the server has
</span><br>
<span class="quotelev3">&gt;&gt;&gt; not yet called accept on the UDS. Unfortunately, there are 3 threads all
</span><br>
<span class="quotelev3">&gt;&gt;&gt; doing different flavors of even_base and select, so I have a hard time
</span><br>
<span class="quotelev3">&gt;&gt;&gt; tracking the path of the UDS on the server side.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So in order to validate my assumption I wrote a minimalistic UDS client
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and server application and tried different scenarios. The conclusion is
</span><br>
<span class="quotelev3">&gt;&gt;&gt; that in order to see the same type of output from &quot;netstat -ax&quot; I have to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; call listen on the server, connect on the client and do not call accept on
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, Oct 27, 2015 at 7:52 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hmmm&#226;&#128;&#166;this looks like it might be that problem we previously saw where
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the blocking recv hangs in a proc when the blocking send tries to send
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; before the domain socket is actually ready, and so the send fails on the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; other end. As I recall, it was something to do with the socketoptions - and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; then Paul had a problem on some of his machines, and we backed it out?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I wonder if that&#226;&#128;&#153;s what is biting us here again, and what we need is to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; either remove the blocking send/recv&#226;&#128;&#153;s altogether, or figure out a way to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; wait until the socket is really ready.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; It appear the branch solve the problem at least partially. I asked one
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; of my students to hammer it pretty badly, and he reported that the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #3  0x00007f4bd306e6d2 in pmix1_fence (procs=0x0, collect_data=1) at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; pmix1_client.c:306
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #4  0x00007f4bd57d5cc3 in ompi_mpi_init (argc=3, argv=0x7fff3c561ea8,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #1  0x00007f7b9b0aa42d in opal_pmix_pmix1xx_pmix_usock_recv_blocking
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (sd=13, data=0x7ffd62139004 &quot;&quot;,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #4  0x00007f7b9b0acc24 in connect_to_server (address=0x7ffd62139330,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; cbdata=0x7ffd621390e0)
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #7  0x00007f7b9b4eb95f in pmi_component_query (module=0x7ffd62139490,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; priority=0x7ffd6213948c)
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;     components_available=0x7f7b9d431eb0, best_module=0x7ffd621394d0,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; best_component=0x7ffd621394d8,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #10 0x00007f7b9d160449 in orte_init (pargc=0x0, pargv=0x0, flags=32) at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; runtime/orte_init.c:219
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #11 0x00007f7b9da4377a in ompi_mpi_init (argc=3, argv=0x7ffd621397f8,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; requested=3,
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Would you mind giving it a try? It fixes some other race conditions
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; and might pick this one up too.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Okay, I&#226;&#128;&#153;ll take a look - I&#226;&#128;&#153;ve been chasing a race condition that might
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; be related
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On my machines this is reproducible at 100% after anywhere between 50
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; and 100 iterations.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18336/attachment">attachment</a>
</ul>
