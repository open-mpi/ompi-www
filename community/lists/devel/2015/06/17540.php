...
?>
<!-- received="Thu Jun 25 19:59:27 2015" -->
<!-- isoreceived="20150625235927" -->
<!-- sent="Fri, 26 Jun 2015 08:59:23 +0900" -->
<!-- isosent="20150625235923" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] simple mpi hello world segfaults when coll ml not disabled" -->
<!-- id="558C95DB.2060809_at_rist.or.jp" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="CAAvDA142oLe-QyO+hc9ZtR4QNqqU4Tg=3AGcUm+aAjZGsJHEvg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-06-25 19:59:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17541.php">Paul Hargrove: "Re: [OMPI devel] [OMPI users] simple mpi hello world segfaults when coll ml not disabled"</a>
<li><strong>Previous message:</strong> <a href="17539.php">Paul Hargrove: "Re: [OMPI devel] [OMPI users] simple mpi hello world segfaults when coll ml not disabled"</a>
<li><strong>In reply to:</strong> <a href="17539.php">Paul Hargrove: "Re: [OMPI devel] [OMPI users] simple mpi hello world segfaults when coll ml not disabled"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17541.php">Paul Hargrove: "Re: [OMPI devel] [OMPI users] simple mpi hello world segfaults when coll ml not disabled"</a>
<li><strong>Reply:</strong> <a href="17541.php">Paul Hargrove: "Re: [OMPI devel] [OMPI users] simple mpi hello world segfaults when coll ml not disabled"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Paul,
<br>
<p>generally speaking, that is a good point.
<br>
an other option could be to write a script that detects symbols defined 
<br>
more than once.
<br>
<p>In this case, mca_coll_hcoll module is linked with the proprietary 
<br>
libhcoll.so.
<br>
...
<p>Gilles
<br>
<p>On 6/26/2015 8:12 AM, Paul Hargrove wrote:
<br>
<span class="quotelev1">&gt; I can see cloning of existing component's source as a starting point 
</span><br>
<span class="quotelev1">&gt; for a new one as a common occurrence (at least relative to creating 
</span><br>
<span class="quotelev1">&gt; new components from zero).
</span><br>
<span class="quotelev1">&gt; So, this is probably not the last time this will ever occur.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Would a build with --disable-dlopen have detected this problem (by 
</span><br>
<span class="quotelev1">&gt; failing to build libmpi due to multiply defined symbols)?
</span><br>
<span class="quotelev1">&gt; If so, then maybe Jenkins should apply this test (which would NOT 
</span><br>
<span class="quotelev1">&gt; depend on the dlopen load order).
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Thu, Jun 25, 2015 at 3:03 PM, Jeff Squyres (jsquyres) 
</span><br>
<span class="quotelev1">&gt; &lt;jsquyres_at_[hidden] &lt;mailto:jsquyres_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;     Devendar literally just reproduced here at the developer meeting, too.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;     Devendar/Mellanox is going to talk about this internally and get
</span><br>
<span class="quotelev1">&gt;     back to us.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev2">&gt;     &gt; On Thursday, June 25, 2015, Jeff Squyres (jsquyres)
</span><br>
<span class="quotelev1">&gt;     &lt;jsquyres_at_[hidden] &lt;mailto:jsquyres_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;     &gt; Gilles --
...
<span class="quotelev2">&gt;     &gt; 2. coll ml is queried, and disqualifies itself (but is not
</span><br>
<span class="quotelev1">&gt;     dlclosed yet)
</span><br>
<span class="quotelev2">&gt;     &gt; 3. coll hcol is queried, which ends up calling down into
</span><br>
<span class="quotelev1">&gt;     libhcol.  libhcol calls a coll_ml_* symbol (which is apparently in
</span><br>
<span class="quotelev1">&gt;     a different .o file in the library), but the linker has already
</span><br>
<span class="quotelev1">&gt;     resolved that coll_ml_* symbol in the coll ml DSO.  So the
</span><br>
<span class="quotelev1">&gt;     execution transfers back up into the coll ml DSO, and ... kaboom.
</span><br>
<span class="quotelev2">&gt;     &gt;
</span><br>
<span class="quotelev2">&gt;     &gt; A simple stack trace will confirm this -- it should show
</span><br>
<span class="quotelev1">&gt;     execution going down into libhcol and then back up into coll ml.
</span><br>
<span class="quotelev2">&gt;     &gt;
</span><br>
<span class="quotelev2">&gt;     &gt;
...
<span class="quotelev3">&gt;     &gt; &gt; On Jun 25, 2015, at 1:03 AM, Gilles Gouaillardet
</span><br>
...
<span class="quotelev3">&gt;     &gt; &gt; this is a followup on an issue reported by Daniel on the users
</span><br>
...
<span class="quotelev3">&gt;     &gt; &gt; i was able to reproduce the crash by tweaking
</span><br>
<span class="quotelev1">&gt;     mca_base_component_path and ensure
</span><br>
...
<span class="quotelev1">&gt;     hpcx-v1.3.336-gcc-OFED-1.5.4.1-redhat6.2-x86_64) seems to include
</span><br>
<span class="quotelev1">&gt;     its own coll ml, since there are some *public* symbols that are
</span><br>
<span class="quotelev1">&gt;     common to this module (ml_open, ml_coll_hier_barrier_setup, ...)
</span><br>
<span class="quotelev3">&gt;     &gt; &gt; 2) coll ml priority is zero, and even if the library is
</span><br>
<span class="quotelev1">&gt;     dlclose'd, it seems this is uneffective
</span><br>
...
<span class="quotelev3">&gt;     &gt; &gt; mpirun --mca coll ^hcoll ... (probably not what is needed
</span><br>
...
<span class="quotelev3">&gt;     &gt; &gt; i guess it would work if the ml_ symbols were private to the
</span><br>
<span class="quotelev1">&gt;     library.
</span><br>
<span class="quotelev3">&gt;     &gt; &gt; if not, the only workaround is to mpirun --mca coll ^ml
</span><br>
<span class="quotelev3">&gt;     &gt; &gt; otherwise, it might crash (if coll_ml is loaded before
</span><br>
<span class="quotelev1">&gt;     coll_hcoll, which is really system dependent)
</span><br>
<span class="quotelev3">&gt;     &gt; &gt;
</span><br>
...
<span class="quotelev4">&gt;     &gt; &gt;&gt; i was able to reproduce the issue, and it surprisingly occurs
</span><br>
<span class="quotelev1">&gt;     only if the coll_ml module is loaded *before* the hcoll module.
</span><br>
...
<span class="quotelev4">&gt;     &gt; &gt;&gt; as far as i understand, libhcoll is a proprietary software,
</span><br>
<span class="quotelev1">&gt;     so i cannot dig into it.
</span><br>
<span class="quotelev4">&gt;     &gt; &gt;&gt; that being said, i noticed libhcoll defines some symbols
</span><br>
<span class="quotelev1">&gt;     (such as ml_coll_hier_barrier_setup) that are also defined by the
</span><br>
<span class="quotelev1">&gt;     coll_ml module, so it is likely hcoll coll_ml and openmpi coll_ml
</span><br>
<span class="quotelev1">&gt;     are not binary compatible hence the error.
</span><br>
<span class="quotelev4">&gt;     &gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;     &gt; &gt;&gt; i will dig a bit more and see if this is even supposed to
</span><br>
<span class="quotelev1">&gt;     happen (since coll_ml_priority is zero, why is the module still
</span><br>
<span class="quotelev1">&gt;     loaded ?)
</span><br>
<span class="quotelev4">&gt;     &gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;     &gt; &gt;&gt; as far as i am concerned, you *have to* mpirun --mca coll ^ml
</span><br>
<span class="quotelev1">&gt;     or update your user/system wide config file to blacklist the
</span><br>
<span class="quotelev1">&gt;     coll_ml module to ensure this is working.
</span><br>
<span class="quotelev4">&gt;     &gt; &gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;     &gt; &gt;&gt;&gt;&gt; i double checked this and i cannot make any sense with
</span><br>
<span class="quotelev1">&gt;     these logs.
</span><br>
<span class="quotelev2">&gt;     &gt; &gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;     &gt; &gt;&gt;&gt;&gt;&gt; it seems that even if priority is zero, some code gets
</span><br>
<span class="quotelev1">&gt;     executed
</span><br>
<span class="quotelev3">&gt;     &gt; &gt;&gt;&gt;&gt;&gt; I will confirm this tomorrow and send you a patch to work
</span><br>
<span class="quotelev1">&gt;     around the issue if that if my guess is proven right
</span><br>
<span class="quotelev3">&gt;     &gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;     &gt; &gt;&gt;&gt;&gt;&gt; Cheers,
...
<span class="quotelev3">&gt;     &gt; &gt;&gt;&gt;&gt;&gt; Not sure how to read this, but for any n&gt;1 mpirun only
</span><br>
<span class="quotelev1">&gt;     works with --mca coll ^ml
</span><br>
<span class="quotelev3">&gt;     &gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;     &gt; &gt;&gt;&gt;&gt;&gt;&gt; On Thursday, June 18, 2015, Daniel Letai
</span><br>
<span class="quotelev1">&gt;     &lt;dani_at_[hidden] &lt;mailto:dani_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt;     figure out which option enabled it, so I could remove it from the
</span><br>
...
<span class="quotelev1">&gt;     &gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; using mellanox ofed 2.3-2.0.5-rhel6.4-x86_64, if it's at
</span><br>
<span class="quotelev1">&gt;     all relevant.
</span><br>
...
<span class="quotelev1">&gt;     --with-hwloc=internal --with-verbs --with-x --with-slurm
</span><br>
<span class="quotelev1">&gt;     --with-pmi=/opt/slurm --with-fca=/opt/mellanox/fca
</span><br>
<span class="quotelev1">&gt;     --with-mxm=/opt/mellanox/mxm --with-hcoll=/opt/mellanox/hcoll'
</span><br>
<span class="quotelev1">&gt;     openmpi-1.8.5-1.src.rpm
</span><br>
<span class="quotelev1">&gt;     &gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;     <a href="http://www.open-mpi.org/community/lists/users/2015/06/27157.php">http://www.open-mpi.org/community/lists/users/2015/06/27157.php</a>
</span><br>
<span class="quotelev3">&gt;     &gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;     &gt; &gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/06/17539.php">http://www.open-mpi.org/community/lists/devel/2015/06/17539.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17540/attachment">attachment</a>
</ul>
