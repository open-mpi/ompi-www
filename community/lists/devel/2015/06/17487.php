...
?>
<!-- received="Tue Jun  9 12:35:18 2015" -->
<!-- isoreceived="20150609163518" -->
<!-- sent="Tue, 9 Jun 2015 12:35:13 -0400" -->
<!-- isosent="20150609163513" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] master seg fault in CM PML" -->
<!-- id="CAMJJpkXJb_ATJaL8ny6oVN0qoUOXsA=UuzS9JNG9AVDBR1PGpA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2015-06-09 12:35:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17488.php">Ralph Castain: "Re: [OMPI devel] master seg fault in CM PML"</a>
<li><strong>Previous message:</strong> <a href="17486.php">Friedley, Andrew: "[OMPI devel] master seg fault in CM PML"</a>
<li><strong>In reply to:</strong> <a href="17486.php">Friedley, Andrew: "[OMPI devel] master seg fault in CM PML"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17488.php">Ralph Castain: "Re: [OMPI devel] master seg fault in CM PML"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Andrew,
<br>
<p>The assert indicates that the convertor was either not correctly
<br>
initialized, or not correctly cleaned-up after the previous use.
<br>
<p>&nbsp;&nbsp;George.
<br>
<p><p>On Tue, Jun 9, 2015 at 12:08 PM, Friedley, Andrew &lt;andrew.friedley_at_[hidden]
<br>
...
<span class="quotelev1">&gt; I'm seeing an issue running various tests from the Intel MPI test suite.
</span><br>
<span class="quotelev1">&gt; Has anyone else seen this?  Any ideas?  RHEL7, master git hash
</span><br>
<span class="quotelev1">&gt; 090922887b92c9764cc5, no CFLAGS set,  no special configure options.  The
</span><br>
<span class="quotelev1">&gt; mpirun command and output are included below.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Failure happens with '-mca pml cm -mca mtl psm', but '-mca pml ob1 -mca
</span><br>
<span class="quotelev1">&gt; btl tcp,sm,self' works.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; mpirun -np 6 -H sperf-05,sperf-06 -mca pml cm -mca mtl psm --
</span><br>
<span class="quotelev1">&gt; `pwd`/src/MPI_Allreduce_loc_c
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; MPI_Allreduce_loc_c:127662 terminated with signal 11 at PC=7fde548b7b45
</span><br>
<span class="quotelev1">&gt; SP=7fff344f8180.  Backtrace:
</span><br>
<span class="quotelev1">&gt; MPI_Allreduce_loc_c: opal_convertor.c:566:
</span><br>
<span class="quotelev1">&gt; opal_convertor_prepare_for_recv: Assertion `convertor-&gt;pStack ==
</span><br>
<span class="quotelev1">&gt; convertor-&gt;static_stack' failed.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; MPI_Allreduce_loc_c:127663 terminated with signal 6 at PC=7f492a3b35c9
</span><br>
<span class="quotelev1">&gt; SP=7fffc7374438.  Backtrace:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; MPI_Allreduce_loc_c:127664 terminated with signal 11 at PC=7f3eabe88b45
</span><br>
<span class="quotelev1">&gt; SP=7fff9e686f70.  Backtrace:
</span><br>
...
<span class="quotelev1">&gt; MPI_Allreduce_loc_c:8148 terminated with signal 6 at PC=7f5bcafa75c9
</span><br>
<span class="quotelev1">&gt; SP=7fff65830328.  Backtrace:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2015/06/17486.php">http://www.open-mpi.org/community/lists/devel/2015/06/17486.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17487/attachment">attachment</a>
</ul>
