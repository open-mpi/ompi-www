...
?>
<!-- received="Fri Jun 26 00:04:00 2015" -->
<!-- isoreceived="20150626040400" -->
<!-- sent="Thu, 25 Jun 2015 22:03:59 -0600" -->
<!-- isosent="20150626040359" -->
<!-- name="Howard Pritchard" -->
<!-- email="hppritcha_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] === CREATE FAILURE (dev-1979-g13425e7) ===" -->
<!-- id="CAF1Cqj6kjxQnvz-93ttHsKxQv_eno=WDwTGgZ5YYYA3Ro6PHjA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2015-06-26 00:03:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17547.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] === CREATE FAILURE (dev-1979-g13425e7) ==="</a>
<li><strong>Previous message:</strong> <a href="17545.php">Ralph Castain: "Re: [OMPI devel] === CREATE FAILURE (dev-1979-g13425e7) ==="</a>
<li><strong>In reply to:</strong> <a href="17544.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] === CREATE FAILURE (dev-1979-g13425e7) ==="</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17547.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] === CREATE FAILURE (dev-1979-g13425e7) ==="</a>
<li><strong>Reply:</strong> <a href="17547.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] === CREATE FAILURE (dev-1979-g13425e7) ==="</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>2015-06-25 21:46 GMT-06:00 Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt;:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17546/attachment">attachment</a>
</ul>
