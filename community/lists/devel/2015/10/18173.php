...
?>
<!-- received="Wed Oct 14 21:25:34 2015" -->
<!-- isoreceived="20151015012534" -->
<!-- sent="Thu, 15 Oct 2015 10:25:16 +0900" -->
<!-- isosent="20151015012516" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] fatal error: openmpi-v2.x-dev-415-g5c9b192 andopenmpi-dev-2696-gd579a07" -->
<!-- id="561F007C.6060305_at_rist.or.jp" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2015-10-14 21:25:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18174.php">Ralph Castain: "Re: [OMPI devel] orte-dvm / orte-submit race condition"</a>
<li><strong>Previous message:</strong> <a href="18172.php">Larry Baker: "Re: [OMPI devel] 16 byte real in Fortran"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18176.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI users] fatal error:	openmpi-v2.x-dev-415-g5c9b192 andopenmpi-dev-2696-gd579a07"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Folks,
<br>
<p>i made PR #1028 <a href="https://github.com/open-mpi/ompi/pull/1028">https://github.com/open-mpi/ompi/pull/1028</a>
<br>
<p>it is not 100% clean (so i will not commit it before a review)
<br>
...
<p>Gilles
<br>
<p>On 10/14/2015 3:37 PM, Gilles Gouaillardet wrote:
<br>
...
<br><hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18173/pmix1xx_configury.patch">pmix1xx_configury.patch</a>
</ul>
<!-- attachment="pmix1xx_configury.patch" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
