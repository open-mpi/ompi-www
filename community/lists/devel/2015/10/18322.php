...
?>
<!-- received="Fri Oct 30 11:07:22 2015" -->
<!-- isoreceived="20151030150722" -->
<!-- sent="Fri, 30 Oct 2015 08:07:15 -0700" -->
<!-- isosent="20151030150715" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] PMIX deadlock" -->
<!-- id="A278D430-43F8-41D5-9F4B-47DAD5494A91_at_open-mpi.org" -->
<!-- charset="utf-8" -->
<!-- inreplyto="CAMJJpkUqa-4cfcY7f5AVVLJgBCT3H0A_MieiVTOAjZdszO46zA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-10-30 11:07:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18323.php">Ralph Castain: "Re: [OMPI devel] PMIX deadlock"</a>
<li><strong>Previous message:</strong> <a href="18321.php">Kawashima, Takahiro: "Re: [OMPI devel] Please test: v1.10.1rc3"</a>
<li><strong>In reply to:</strong> <a href="18320.php">George Bosilca: "Re: [OMPI devel] PMIX deadlock"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18323.php">Ralph Castain: "Re: [OMPI devel] PMIX deadlock"</a>
<li><strong>Reply:</strong> <a href="18323.php">Ralph Castain: "Re: [OMPI devel] PMIX deadlock"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Hmmm&#226;&#128;&#166;there is a hook that would allow the PMIx server to utilize that listener thread, but we aren&#226;&#128;&#153;t currently using it. Each daemon plus mpirun will call orte_start_listener, but nothing is currently registering and so the listener in that code is supposed to just return without starting the thread.
<br>
<p>So the only listener thread that should exist is the one inside the PMIx server itself. If something else is happening, then that would be a bug. I can look at the orte listener code to ensure that the thread isn&#226;&#128;&#153;t incorrectly starting.
<br>
<p><p><span class="quotelev1">&gt; On Oct 29, 2015, at 10:03 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/10/18320.php">http://www.open-mpi.org/community/lists/devel/2015/10/18320.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18322/attachment">attachment</a>
</ul>
