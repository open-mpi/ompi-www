...
?>
<!-- received="Wed Oct 21 11:33:03 2015" -->
<!-- isoreceived="20151021153303" -->
<!-- sent="Wed, 21 Oct 2015 08:32:56 -0700" -->
<!-- isosent="20151021153256" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Specifying networks/APIs for OMPI (was: topic for	agenda)" -->
<!-- id="369E18A2-1FBE-4F73-96AA-0B1FC3EE8B50_at_open-mpi.org" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2015-10-21 11:32:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18234.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Specifying networks/APIs for OMPI (was: topic	for	agenda)"</a>
<li><strong>Previous message:</strong> <a href="18232.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Specifying networks/APIs for OMPI (was: topic for	agenda)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18234.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Specifying networks/APIs for OMPI (was: topic	for	agenda)"</a>
<li><strong>Reply:</strong> <a href="18234.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Specifying networks/APIs for OMPI (was: topic	for	agenda)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Let&#226;&#128;&#153;s face it: the default is what 90+% of the world is going to use. This all seems rather complex to expect the average user to figure out.
<br>
<p><p><span class="quotelev1">&gt; On Oct 21, 2015, at 8:09 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; REVISION 2 (based on feedback in last 24 hours).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
