...
?>
<!-- received="Tue Oct 20 05:35:47 2015" -->
<!-- isoreceived="20151020093547" -->
<!-- sent="Tue, 20 Oct 2015 18:35:43 +0900" -->
<!-- isosent="20151020093543" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Issue with OpenMPI 1.8.4 + Xcode 7.0.1" -->
<!-- id="CAAkFZ5sJtun9RXJAV8rSdb4rycGq7YzHjKvHA8mHgGjBTtc_Nw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="5C9FA064-D958-4A57-854C-4DDE428C7D89_at_tu-dresden.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-10-20 05:35:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18200.php">Gilles Gouaillardet: "Re: [OMPI devel] Issue with OpenMPI 1.8.4 + Xcode 7.0.1"</a>
<li><strong>Previous message:</strong> <a href="18198.php">Tobias Hilbrich: "[OMPI devel] Issue with OpenMPI 1.8.4 + Xcode 7.0.1"</a>
<li><strong>In reply to:</strong> <a href="18198.php">Tobias Hilbrich: "[OMPI devel] Issue with OpenMPI 1.8.4 + Xcode 7.0.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18200.php">Gilles Gouaillardet: "Re: [OMPI devel] Issue with OpenMPI 1.8.4 + Xcode 7.0.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Tobias,
<br>
<p>Fwiw, MPI_Comm_compare can be used to compare communicators.
<br>
...
<p>Gilles
<br>
<p>On Tuesday, October 20, 2015, Tobias Hilbrich &lt;tobias.hilbrich_at_[hidden]&gt;
<br>
wrote:
<br>
...
<span class="quotelev1">&gt; Attached source file builds with Xcode 7.0.0, but fails since the release
</span><br>
<span class="quotelev1">&gt; of Xcode 7.0.1. I post it here since it results from an &quot;if (MPI_COMM_NULL
</span><br>
<span class="quotelev1">&gt; == MPI_COMM_SELF)&quot;. I am actually curious whether this is somehow off by
</span><br>
<span class="quotelev1">&gt; itself, or whether it has something to do with how you define these
</span><br>
<span class="quotelev1">&gt; constants. Overall, the situation is that this worked with previous clang
</span><br>
<span class="quotelev1">&gt; compilers (and that it again works for more recent versions from
</span><br>
<span class="quotelev1">&gt; mac-ports), so likely not your fault at all.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; clang: error: clang frontend command failed due to signal (use -v to see
</span><br>
...
<span class="quotelev1">&gt; clang: note: diagnostic msg: PLEASE submit a bug report to
</span><br>
<span class="quotelev1">&gt; <a href="http://developer.apple.com/bugreporter/">http://developer.apple.com/bugreporter/</a> and include the crash backtrace,
</span><br>
<span class="quotelev1">&gt; preprocessed source, and associated run script.
</span><br>
...
<span class="quotelev1">&gt; Maybe you already know of the issue. Maybe you can provide something to
</span><br>
<span class="quotelev1">&gt; alleviate this issue in your releases, since it may take a while until we
</span><br>
<span class="quotelev1">&gt; get a newer Xcode version on most OSX'es.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; With that thanks for your looking into this, and many thanks for your
</span><br>
<span class="quotelev1">&gt; wonderful MPI implementation,
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18199/attachment">attachment</a>
</ul>
