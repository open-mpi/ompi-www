...
?>
<!-- received="Wed Oct 28 01:22:13 2015" -->
<!-- isoreceived="20151028052213" -->
<!-- sent="Wed, 28 Oct 2015 01:22:09 -0400" -->
<!-- isosent="20151028052209" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Fwd: [OMPI commits] Git: open-mpi/ompi branch master updated. dev-2921-gb603307" -->
<!-- id="CAMJJpkXshRsvz2FGY76aPGrtmBB0tUc9A+T5=K3Ghvk=VAj-6Q_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="56305847.6060008_at_rist.or.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-10-28 01:22:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18304.php">Gilles Gouaillardet: "Re: [OMPI devel] Fwd: [OMPI commits] Git: open-mpi/ompi branch master updated. dev-2921-gb603307"</a>
<li><strong>Previous message:</strong> <a href="18302.php">George Bosilca: "Re: [OMPI devel] PMIX deadlock"</a>
<li><strong>In reply to:</strong> <a href="18301.php">Gilles Gouaillardet: "Re: [OMPI devel] Fwd: [OMPI commits] Git: open-mpi/ompi branch master updated. dev-2921-gb603307"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18304.php">Gilles Gouaillardet: "Re: [OMPI devel] Fwd: [OMPI commits] Git: open-mpi/ompi branch master updated. dev-2921-gb603307"</a>
<li><strong>Reply:</strong> <a href="18304.php">Gilles Gouaillardet: "Re: [OMPI devel] Fwd: [OMPI commits] Git: open-mpi/ompi branch master updated. dev-2921-gb603307"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gilles,
<br>
<p>Supposing that pmix_common.h has been already included, by adding it again
<br>
I should have obtained nothing new. I don't know which one is picked up,
<br>
but now there is at least one pmix_common.h to be included.
<br>
<p>If you look carrefully you will notice that the pmix_server.h
<br>
includes pmix/pmix_common.h and not pmix_common.h. If you want to figure
<br>
this one, that a good starting point. Btw, why do we have 3 headers with
<br>
the same name (it's soooo confusing) ?
<br>
<p>&nbsp;&nbsp;George.
<br>
<p><p>On Wed, Oct 28, 2015 at 1:08 AM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;
<br>
wrote:
<br>
...
<span class="quotelev1">&gt; so maybe the wrong pmix_server.h was #include'd ... and your fix hides the
</span><br>
<span class="quotelev1">&gt; real issue,
</span><br>
...
<span class="quotelev1">&gt; Interesting, I wonder how your compiler gets to know the definition of the
</span><br>
<span class="quotelev1">&gt; PMIX_ERR_SILENT without the pmix_common.h. I just pushed a fix.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; if build still breaks for you, could you send me your configure command
</span><br>
...
<span class="quotelev2">&gt;&gt; PMIX_ERR_SILENT is defined in opal/mca/pmix/pmix1xx/pmix/include/pmix/
</span><br>
<span class="quotelev2">&gt;&gt; pmix_common.h.in
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; From: &lt; &lt;gitdub_at_[hidden]&gt;gitdub_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Author: Ralph Castain &lt; &lt;rhc_at_[hidden]&gt;rhc_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; pmix_base_async_modex that will cause the async modex to be used when set
</span><br>
<span class="quotelev2">&gt;&gt; to 1. Default it to 0 for now
</span><br>
...
<span class="quotelev2">&gt;&gt; blocking fence shall return all data to each process. Obviously, this param
</span><br>
<span class="quotelev2">&gt;&gt; has no effect if async_
</span><br>
...
<span class="quotelev2">&gt;&gt;      /* exchange connection info - this function may also act as a barrier
</span><br>
<span class="quotelev2">&gt;&gt;       * if data exchange is required. The modex occurs solely across procs
</span><br>
...
<span class="quotelev2">&gt;&gt; +    (void) mca_base_var_register(&quot;opal&quot;, &quot;pmix&quot;, &quot;base&quot;, &quot;async_modex&quot;,
</span><br>
<span class="quotelev2">&gt;&gt; &quot;Use asynchronous modex mode&quot;,
</span><br>
...
<span class="quotelev2">&gt;&gt; &amp;opal_pmix_base_async_modex);
</span><br>
<span class="quotelev2">&gt;&gt; +    opal_pmix_collect_all_data = true;
</span><br>
<span class="quotelev2">&gt;&gt; +    (void) mca_base_var_register(&quot;opal&quot;, &quot;pmix&quot;, &quot;base&quot;, &quot;collect_data&quot;,
</span><br>
<span class="quotelev2">&gt;&gt; &quot;Collect all data during modex&quot;,
</span><br>
<span class="quotelev2">&gt;&gt; +                                 MCA_BASE_VAR_TYPE_BOOL, NULL, 0, 0,
</span><br>
<span class="quotelev2">&gt;&gt; OPAL_INFO_LVL_9,
...
<span class="quotelev2">&gt;&gt; -#define PMIX_ERROR_MIN  -41  // set equal to number of non-zero entries
</span><br>
<span class="quotelev2">&gt;&gt; in enum
</span><br>
<span class="quotelev2">&gt;&gt; +#define PMIX_ERROR_MIN  -42  // set equal to number of non-zero entries
</span><br>
<span class="quotelev2">&gt;&gt; in enum
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; @@ -141,8 +141,7 @@ static void _queue_message(int fd, short args, void
</span><br>
...
<span class="quotelev2">&gt;&gt; -                        &quot;[%s:%d] queue callback called: reply to %s:%d
</span><br>
<span class="quotelev2">&gt;&gt; on tag %d,&quot;
</span><br>
...
<span class="quotelev2">&gt;&gt; @@ -179,12 +178,10 @@ static void _queue_message(int fd, short args, void
</span><br>
<span class="quotelev2">&gt;&gt; *cbdata)
</span><br>
...
<span class="quotelev2">&gt;&gt; @@ -723,7 +720,7 @@ static void _register_client(int sd, short args, void
</span><br>
<span class="quotelev2">&gt;&gt; *cbdata)
</span><br>
...
<span class="quotelev2">&gt;&gt; +        /* if we don't have direct modex feature, just respond with &quot;not
</span><br>
...
<span class="quotelev2">&gt;&gt; &amp;lcd-&gt;super);
</span><br>
...
<span class="quotelev2">&gt;&gt; +    rc = PMIX_ERR_NOT_FOUND;  // indicates that we created a new request
</span><br>
...
<span class="quotelev2">&gt;&gt; +    /* Now that we know all local ranks, go along request list and ask
</span><br>
<span class="quotelev2">&gt;&gt; for remote data
</span><br>
...
<span class="quotelev2">&gt;&gt; +    PMIX_LIST_FOREACH_SAFE(cd, cd_next, &amp;pmix_server_globals.local_reqs,
</span><br>
<span class="quotelev2">&gt;&gt; pmix_dmdx_local_t) {
</span><br>
...
<span class="quotelev2">&gt;&gt; +        if (0 != strncmp(nptr-&gt;nspace, cd-&gt;proc.nspace, PMIX_MAX_NSLEN)
</span><br>
<span class="quotelev2">&gt;&gt; ) {
</span><br>
<span class="quotelev2">&gt;&gt; +            continue;
...
<span class="quotelev2">&gt;&gt; +        PMIX_LIST_FOREACH(info, &amp;nptr-&gt;server-&gt;ranks, pmix_rank_info_t) {
</span><br>
...
<span class="quotelev2">&gt;&gt; +                pmix_host_server.direct_modex(&amp;cd-&gt;proc, cd-&gt;info,
</span><br>
<span class="quotelev2">&gt;&gt; cd-&gt;ninfo, dmdx_cbfunc, cd);
</span><br>
<span class="quotelev2">&gt;&gt; +            } else {
</span><br>
...
<span class="quotelev2">&gt;&gt; +            /* if we've got an error for this request - just forward it*/
</span><br>
<span class="quotelev2">&gt;&gt; +            PMIX_LIST_FOREACH(req, &amp;lcd-&gt;loc_reqs, pmix_dmdx_request_t) {
</span><br>
<span class="quotelev2">&gt;&gt; +                /* if we can't satisfy this request - respond with error
</span><br>
<span class="quotelev2">&gt;&gt; */
</span><br>
...
<span class="quotelev2">&gt;&gt; +        if (PMIX_SUCCESS != (rc = pmix_hash_store(&amp;nptr-&gt;server-&gt;remote,
</span><br>
<span class="quotelev2">&gt;&gt; caddy-&gt;lcd-&gt;proc.rank, kp))) {
</span><br>
<span class="quotelev2">&gt;&gt; +            PMIX_ERROR_LOG(rc);
</span><br>
<span class="quotelev2">&gt;&gt; +        }
...
<span class="quotelev2">&gt;&gt; -     * pmix_pending_localy_fin would be called to resolve this. Just add
</span><br>
...
<span class="quotelev2">&gt;&gt; -                pmix_host_server.direct_modex(&amp;lcd-&gt;proc, info, ninfo,
</span><br>
<span class="quotelev2">&gt;&gt; dmdx_cbfunc, lcd);
</span><br>
<span class="quotelev2">&gt;&gt; -            } else {
</span><br>
<span class="quotelev2">&gt;&gt; -                /* if we don't have direct modex feature, just respond
</span><br>
<span class="quotelev2">&gt;&gt; with &quot;not found&quot; */
</span><br>
<span class="quotelev2">&gt;&gt; -                cbfunc(PMIX_ERR_NOT_FOUND, NULL, 0, cbdata, NULL, NULL);
</span><br>
<span class="quotelev2">&gt;&gt; -                PMIX_INFO_FREE(info, ninfo);
...
<span class="quotelev2">&gt;&gt; -    /* Now when we know all local ranks, go along request list and ask
</span><br>
<span class="quotelev2">&gt;&gt; for remote data
</span><br>
<span class="quotelev2">&gt;&gt; -     * for the non-local ranks, and resolve all pending requests for
...
<span class="quotelev2">&gt;&gt; @@ -436,13 +196,7 @@ pmix_status_t pmix_server_commit(pmix_peer_t *peer,
</span><br>
<span class="quotelev2">&gt;&gt; pmix_buffer_t *buf)
</span><br>
<span class="quotelev2">&gt;&gt;               * may not be a contribution */
</span><br>
<span class="quotelev2">&gt;&gt;              if (PMIX_SUCCESS == pmix_hash_fetch(&amp;nptr-&gt;server-&gt;myremote,
</span><br>
<span class="quotelev2">&gt;&gt; info-&gt;rank, &quot;modex&quot;, &amp;val) &amp;&amp;
</span><br>
...
<span class="quotelev2">&gt;&gt; @@ -457,7 +211,7 @@ pmix_status_t pmix_server_commit(pmix_peer_t *peer,
</span><br>
<span class="quotelev2">&gt;&gt; pmix_buffer_t *buf)
</span><br>
...
<span class="quotelev2">&gt;&gt; -    /* see if anyone local is waiting on this data- could be more than
</span><br>
...
<span class="quotelev2">&gt;&gt; @@ -826,163 +580,6 @@ pmix_status_t pmix_server_fence(pmix_server_caddy_t
</span><br>
...
<span class="quotelev2">&gt;&gt; -    /* if we don't have any ranks for this job, protect ourselves here */
</span><br>
...
<span class="quotelev2">&gt;&gt; -    return pmix_pending_request(nptr, rank, info, ninfo, cbfunc, cbdata);
</span><br>
<span class="quotelev2">&gt;&gt; -}
</span><br>
<span class="quotelev2">&gt;&gt; -
...
<span class="quotelev2">&gt;&gt; @@ -168,10 +168,17 @@ int pmix1_server_register_nspace(opal_jobid_t jobid,
</span><br>
<span class="quotelev2">&gt;&gt;      pmix_status_t rc;
</span><br>
...
<span class="quotelev2">&gt;&gt; @@ -220,10 +227,10 @@ int pmix1_server_register_nspace(opal_jobid_t jobid,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; @@ -275,7 +282,7 @@ static void dmdx_response(pmix_status_t status, char
</span><br>
<span class="quotelev2">&gt;&gt; *data, size_t sz, void *cbd
</span><br>
<span class="quotelev2">&gt;&gt;  }
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; -        if (OPAL_SUCCESS != (rc = opal_pmix.store_local(&amp;target, &amp;kv))) {
</span><br>
...
<span class="quotelev2">&gt;&gt;  .../pmix1xx/pmix/include/pmix/pmix_common.h.in     |   3 +-
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18303/attachment">attachment</a>
</ul>
