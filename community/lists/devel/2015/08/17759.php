...
?>
<!-- received="Mon Aug 17 11:18:21 2015" -->
<!-- isoreceived="20150817151821" -->
<!-- sent="Mon, 17 Aug 2015 09:18:20 -0600" -->
<!-- isosent="20150817151820" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] open mpi 1.8.6. MPI_T" -->
<!-- id="20150817151820.GB30503_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2015-08-17 11:18:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17760.php">Jeff Squyres (jsquyres): "[OMPI devel] standard verbosity levels"</a>
<li><strong>Previous message:</strong> <a href="17758.php">Nathan Hjelm: "Re: [OMPI devel] [OMPI users] open mpi 1.8.6. MPI_T"</a>
<li><strong>In reply to:</strong> <a href="17747.php">George Bosilca: "Re: [OMPI devel] [OMPI users] open mpi 1.8.6. MPI_T"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17753.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI users] open mpi 1.8.6. MPI_T"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>err = MPI_T_pvar_get_index(name, varClass, &amp;pvar_idx);
<br>
...
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17759/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
