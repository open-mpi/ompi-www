...
?>
<!-- received="Mon Aug 24 09:31:07 2015" -->
<!-- isoreceived="20150824133107" -->
<!-- sent="Mon, 24 Aug 2015 22:31:05 +0900" -->
<!-- isosent="20150824133105" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] reachable_netlink mca, libnl and libnl3" -->
<!-- id="CAAkFZ5s75iMZjtwjswTxdAN2azxBYvr-ADOj+TMzpFO8OidVbQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2015-08-24 09:31:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17815.php">Gilles Gouaillardet: "Re: [OMPI devel] reachable_netlink mca, libnl and libnl3"</a>
<li><strong>Previous message:</strong> <a href="17813.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] reachable_netlink mca, libnl and libnl3"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17816.php">Gilles Gouaillardet: "Re: [OMPI devel] reachable_netlink mca, libnl and libnl3"</a>
<li><strong>Reply:</strong> <a href="17816.php">Gilles Gouaillardet: "Re: [OMPI devel] reachable_netlink mca, libnl and libnl3"</a>
<li><strong>Reply:</strong> <a href="17818.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] reachable_netlink mca, libnl and libnl3"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I am not sure if handling this at run time is even possible
<br>
<p>why not handle this at configure time ?
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17814/attachment">attachment</a>
</ul>
