...
?>
<!-- received="Tue Feb 24 00:09:20 2015" -->
<!-- isoreceived="20150224050920" -->
<!-- sent="Tue, 24 Feb 2015 00:09:18 -0500" -->
<!-- isosent="20150224050918" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] RoCE plus QDR IB tunable parameters" -->
<!-- id="CAMJJpkWj95gZ43J70g_dqPiH6xn-hvb1NUPxpOONwoBbhYMtEA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2015-02-24 00:09:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17024.php">Jeff Squyres (jsquyres): "[OMPI devel] RFC: DL / DSO functionality"</a>
<li><strong>Previous message:</strong> <a href="17022.php">Dave Turner: "Re: [OMPI devel] OMPI devel] RoCE plus QDR IB tunable parameters"</a>
<li><strong>In reply to:</strong> <a href="17022.php">Dave Turner: "Re: [OMPI devel] OMPI devel] RoCE plus QDR IB tunable parameters"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17029.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] OMPI devel] RoCE plus QDR IB tunable parameters"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Dave,
<br>
<p>The PML is the layer with the smartness (or so we hope) that moves the data
<br>
...
<br>
precedence, in which case it is normal that you don't see the bandwidth
<br>
going up as it is limited by the most efficient of the two.
<br>
<p>&nbsp;&nbsp;George.
<br>
<p><p>On Mon, Feb 23, 2015 at 9:53 PM, Dave Turner &lt;drdaveturner_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Jeff, George,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;       When I try to use yalla with the dev master I get the error message
</span><br>
...
<span class="quotelev1">&gt; *** Error in `/homes/daveturner/openmpi-master/bin/orted': free():
</span><br>
<span class="quotelev1">&gt; corrupted unsorted chunks: 0x0000000002351270 ***
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; *** Error in `/homes/daveturner/openmpi-master/bin/orted': corrupted
</span><br>
...
<span class="quotelev1">&gt; George:  I'm not sure what the PML ob1 is that you refer to.  I'm running
</span><br>
<span class="quotelev1">&gt; with the
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; default settings for the most part and trying to tune those.  When we had
</span><br>
...
<span class="quotelev1">&gt; On Sun, Feb 22, 2015 at 5:37 AM, Jeff Squyres (jsquyres) &lt;
</span><br>
...
<span class="quotelev2">&gt;&gt; MXM?  (e.g., the yalla PML on master)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; aggregate tests
</span><br>
<span class="quotelev3">&gt;&gt; &gt; across my system with QDR IB and 10 Gbps RoCE.
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
<span class="quotelev3">&gt;&gt; &gt;      The attached unidirectional.pdf graph is the ping-pong performance
</span><br>
<span class="quotelev2">&gt;&gt; for 1 core
</span><br>
<span class="quotelev3">&gt;&gt; &gt; on 1 machine to 1 core on the 2nd.  The red curve for OpenMPI 1.8.3
</span><br>
<span class="quotelev2">&gt;&gt; shows lower
</span><br>
...
<span class="quotelev2">&gt;&gt; likewise show
</span><br>
...
<span class="quotelev2">&gt;&gt; Gbps card
</span><br>
<span class="quotelev3">&gt;&gt; &gt; which will give us QDR performance but not allow us to use the extra 10
</span><br>
<span class="quotelev2">&gt;&gt; Gbps
</span><br>
...
<span class="quotelev2">&gt;&gt; than they
</span><br>
...
<span class="quotelev2">&gt;&gt; opportunities
</span><br>
...
<span class="quotelev2">&gt;&gt; MXs+9Yw_at_[hidden]&gt;
</span><br>
<span class="quotelev3">&gt;&gt; &gt; Content-Type: text/plain; charset=&quot;utf-8&quot;
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
...
<span class="quotelev3">&gt;&gt; &gt; I'd say commit cf377db82 explains the vanishing of the bandwidth metric
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt; &gt; engine from correctly ordering the BTL for small messages (the latency
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt; &gt;&gt; If I just do an aggregate test of 16 cores on one machine talking to
</span><br>
<span class="quotelev2">&gt;&gt; 16 on
</span><br>
...
<span class="quotelev2">&gt;&gt; &gt; &gt;&gt;&gt; suggested to me.  The attached graph shows the base red line, along
</span><br>
<span class="quotelev2">&gt;&gt; with
</span><br>
...
<span class="quotelev3">&gt;&gt; &gt; &gt;&gt;&gt;&gt; Based on your ompi_info.all the following bandwidth are reported on
</span><br>
...
<span class="quotelev2">&gt;&gt; drdaveturner_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt; &gt;&gt;&gt;&gt;&gt;      So by default the slower interface is being chosen on the low
</span><br>
...
<span class="quotelev2">&gt;&gt; aggregate
</span><br>
...
<span class="quotelev2">&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2015/02/17004.php">http://www.open-mpi.org/community/lists/devel/2015/02/17004.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2015/02/17022.php">http://www.open-mpi.org/community/lists/devel/2015/02/17022.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17023/attachment">attachment</a>
</ul>
