...
?>
<!-- received="Tue Feb 24 17:16:10 2015" -->
<!-- isoreceived="20150224221610" -->
<!-- sent="Tue, 24 Feb 2015 22:16:07 +0000" -->
<!-- isosent="20150224221607" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] RoCE plus QDR IB tunable parameters" -->
<!-- id="D2E75849-7821-4828-A0A3-F0F740CD8984_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAFGXdkxJcYi0b+aooiaMXqPX5j2aO310UzJwj=iOEG79qamz7w_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-02-24 17:16:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17030.php">Paul Hargrove: "Re: [OMPI devel] RFC: DL / DSO functionality"</a>
<li><strong>Previous message:</strong> <a href="17028.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] RFC: DL / DSO functionality"</a>
<li><strong>In reply to:</strong> <a href="17022.php">Dave Turner: "Re: [OMPI devel] OMPI devel] RoCE plus QDR IB tunable parameters"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17032.php">Joshua Ladd: "Re: [OMPI devel] OMPI devel] RoCE plus QDR IB tunable parameters"</a>
<li><strong>Reply:</strong> <a href="17032.php">Joshua Ladd: "Re: [OMPI devel] OMPI devel] RoCE plus QDR IB tunable parameters"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Dave --
<br>
<p>That's an unfortunate segv in the runtime, not the the MPI layer.  Did you get a corefile, perchance?  Could you send a backtrace?
<br>
<p><p><span class="quotelev1">&gt; On Feb 23, 2015, at 9:53 PM, Dave Turner &lt;drdaveturner_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt;       When I try to use yalla with the dev master I get the error message below:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; ~/openmpi-master/bin/mpirun -np 2 --mca pml yalla ./NPmpi.master -o np.out
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; *** Error in `/homes/daveturner/openmpi-master/bin/orted': free(): corrupted unsorted chunks: 0x0000000002351270 ***
</span><br>
<span class="quotelev1">&gt; *** Error in `/homes/daveturner/openmpi-master/bin/orted': corrupted double-linked list: 0x0000000002351260 ***
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; George:  I'm not sure what the PML ob1 is that you refer to.  I'm running with the
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; default settings for the most part and trying to tune those.  When we had nodes
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; with just RoCE over 10 Gbps and just QDR IB, the latencies were the same
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; at around 3 microseconds.  The bandwidths were around 10 Gbps and 30 Gbps.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; On Sun, Feb 22, 2015 at 5:37 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; Dave --
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Just out of curiosity, what kind of performance do you get when you use MXM?  (e.g., the yalla PML on master)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt; &gt;      I've downloaded the OpenMPI master as suggested and rerun all my aggregate tests
</span><br>
<span class="quotelev2">&gt; &gt; across my system with QDR IB and 10 Gbps RoCE.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;      The attached unidirectional.pdf graph is the ping-pong performance for 1 core
</span><br>
<span class="quotelev2">&gt; &gt; on 1 machine to 1 core on the 2nd.  The red curve for OpenMPI 1.8.3 shows lower
</span><br>
<span class="quotelev2">&gt; &gt; performance for small and also medium message sizes for the base test without
</span><br>
<span class="quotelev2">&gt; &gt; using any tuning parameters.  The green line from the OpenMPI master shows lower
</span><br>
<span class="quotelev2">&gt; &gt; performance only for small messages, but great for medium size.  Turning off the
</span><br>
<span class="quotelev2">&gt; &gt; 10 Gbps card entirely produces great performance for all message sizes.  So the
</span><br>
<span class="quotelev2">&gt; &gt; fixes in the master at least help, but it still seems to be choosing to use RoCE for
</span><br>
<span class="quotelev2">&gt; &gt; small messages rather than QDR IB.  They both use the openib btl so I assume it
</span><br>
<span class="quotelev2">&gt; &gt; just chooses one at random so this is probably not that surprising.  Since there are
</span><br>
<span class="quotelev2">&gt; &gt; no tunable parameters for multiple openib btl's, this cannot be manually tuned.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;      The bi-directional ping-pong tests show basically the same thing with lower
</span><br>
<span class="quotelev2">&gt; &gt; performance for small message sizes for 1.8.3 and the master.  However, I'm
</span><br>
...
<span class="quotelev2">&gt; &gt; yelling at 20 cores on the 2nd machine (bi-directional too).  They likewise show
</span><br>
...
<span class="quotelev2">&gt; &gt;      Our solution for now is to simply exclude mlx4_1 which is the 10 Gbps card
</span><br>
<span class="quotelev2">&gt; &gt; which will give us QDR performance but not allow us to use the extra 10 Gbps
</span><br>
<span class="quotelev2">&gt; &gt; to channel bond for large messages.  It is more worrisome that max bandwidth
</span><br>
<span class="quotelev2">&gt; &gt; on the bi-directional and aggregate tests using the master are slower than they
</span><br>
...
<span class="quotelev2">&gt; &gt;         &lt;CAMJJpkXC6e_y34fU5VeJ0uHrrJ2z4CA89mN7WfWa5dSfx52s7A_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; <a href="https://github.com/open-mpi/ompi/commit/e173f9b0c0c63c3ea24b8d8bc0ebafe1f1736acb">https://github.com/open-mpi/ompi/commit/e173f9b0c0c63c3ea24b8d8bc0ebafe1f1736acb</a>.
</span><br>
...
<span class="quotelev2">&gt; &gt; On Mon, Feb 9, 2015 at 2:57 PM, Dave Turner &lt;drdaveturner_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;      I tried running with btl_openib_cpc_include rdmacm and saw no change.
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; is that I don't think there are parameters to allow for tuning of multiple
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; the manual balanced blue line and auto balanced green line (0's for both).
</span><br>
...
<span class="quotelev2">&gt; &gt;         &lt;CAF1Cqj5=GPfi=t8Jw6SSUBKjqut0ChgntTyXfU0diM=MXs+9Yw_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt; &gt; Content-Type: text/plain; charset=&quot;utf-8&quot;
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev2">&gt; &gt; I'd say commit cf377db82 explains the vanishing of the bandwidth metric as
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; (latency) was mislabeled. This mishap not only prevented the communication
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; <a href="https://github.com/open-mpi/ompi/commit/e173f9b0c0c63c3ea24b8d8bc0ebafe1f1736acb">https://github.com/open-mpi/ompi/commit/e173f9b0c0c63c3ea24b8d8bc0ebafe1f1736acb</a>.
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Once validated this should be moved over the 1.8 branch.
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Dave do you think it is possible to renew your experiment with the current
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;       Let's simplify the problem by forgetting about the channel bonding.
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; If I just do an aggregate test of 16 cores on one machine talking to 16 on
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; then it switches over to QDR IB for large messages.  I don't see channel
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;      I think there are 2 problems here, both related to the fact that QDR
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; IB link and RoCE
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; both use the same openib btl.  The first problem is that the slower RoCE
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; value: &quot;4&quot;, data source: default, level: 5 tuner/detail, type: unsigned)
</span><br>
...
<span class="quotelev2">&gt; &gt; &lt;unidirectional.pdf&gt;&lt;bidirectional.pdf&gt;&lt;aggregate.pdf&gt;_______________________________________________
</span><br>
<span class="quotelev2">&gt; &gt; devel mailing list
</span><br>
<span class="quotelev2">&gt; &gt; devel_at_[hidden]
...
<span class="quotelev2">&gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/02/17004.php">http://www.open-mpi.org/community/lists/devel/2015/02/17004.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
