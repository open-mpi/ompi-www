...
?>
<!-- received="Wed Apr 22 15:17:14 2015" -->
<!-- isoreceived="20150422191714" -->
<!-- sent="Wed, 22 Apr 2015 13:17:11 -0600" -->
<!-- isosent="20150422191711" -->
...
<!-- id="CAF1Cqj4RmcoLHuyVcyzyLNr7Ax9JD=TOeGziM2tRa2U9wv2ycA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2015-04-22 15:17:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17315.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<li><strong>Previous message:</strong> <a href="17313.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17316.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<li><strong>Reply:</strong> <a href="17316.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Rafael,
<br>
<p>I give you an A+ for effort.   We always appreciate patches.
<br>
<p>Howard
<br>
<p><p>2015-04-22 12:43 GMT-06:00 Nathan Hjelm &lt;hjelmn_at_[hidden]&gt;:
<br>
...
<span class="quotelev1">&gt; On Wed, Apr 22, 2015 at 04:55:57PM +0200, Rapha&#195;&#171;l Fouassier wrote:
</span><br>
...
<span class="quotelev2">&gt; &gt;  static int udcm_module_init (udcm_module_t *m, mca_btl_openib_module_t
</span><br>
...
<span class="quotelev2">&gt; &gt; +        opal_btl_openib_fd_unmonitor(m-&gt;cm_channel-&gt;fd, udcm_unmonitor,
</span><br>
<span class="quotelev1">&gt; (void *)&amp;barrier);
</span><br>
<span class="quotelev2">&gt; &gt; +        while (0 == barrier) {
</span><br>
<span class="quotelev2">&gt; &gt; +            sched_yield();
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17314/attachment">attachment</a>
</ul>
