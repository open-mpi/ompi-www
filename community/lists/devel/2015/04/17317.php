...
?>
<!-- received="Wed Apr 22 15:27:10 2015" -->
<!-- isoreceived="20150422192710" -->
<!-- sent="Wed, 22 Apr 2015 19:27:05 +0000" -->
<!-- isosent="20150422192705" -->
<!-- name="Tom Wurgler" -->
<!-- email="twurgl_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Assigning processes to cores 1.4.2, 1.6.4 and 1.8.4" -->
<!-- id="1429730825362.10009_at_goodyear.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="713CF79E-DD70-4B56-83F6-1C5C37FBCC1F_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-22 15:27:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17318.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<li><strong>Previous message:</strong> <a href="17316.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<li><strong>In reply to:</strong> <a href="17262.php">Ralph Castain: "Re: [OMPI devel] Assigning processes to cores 1.4.2, 1.6.4 and 1.8.4"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17335.php">Ralph Castain: "Re: [OMPI devel] Assigning processes to cores 1.4.2, 1.6.4 and 1.8.4"</a>
<li><strong>Reply:</strong> <a href="17335.php">Ralph Castain: "Re: [OMPI devel] Assigning processes to cores 1.4.2, 1.6.4 and 1.8.4"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>(note: ideally, at this point, we really want 1.6.4 ,not 1.8.4 (yet)).
<br>
<p><p>1.6.4 using --bind-to-socket --bind-to-core
<br>
<p><p>--------------------------------------------------------------------------
<br>
...
=========================================================================
<br>
<p>Now using 1.8.4 and --map-by socket --bind-to core, the job runs and is on the cores I want, namely 0,1,2,3,4,5,6,7
<br>
BUT when a job lands on a node with other jobs, it over-subcribes the cores.  I tried adding --nooversubscribe with no effect.
<br>
<p>The already running jobs were submitted with openmpi 1.6.4 using --mca mpi-paffinity-alone 1
<br>
and none of the bind-core etc args.
<br>
<p>We have nodes with 4 sockets with 12 cores each, so we really want to make use of as many cores as we can, in the most optimized way.  So if we had a 24 way job and then a second  24 way job we want them packed on the same node with processor and memory affinity.
<br>
...
<br>
<p><p>On Apr 17, 2015, at 11:16 AM, Tom Wurgler &lt;twurgl_at_[hidden]&lt;mailto:twurgl_at_[hidden]&gt;&gt; wrote:
<br>
<p>Note where I said &quot;1 hour 14 minutes&quot; it should have read &quot;1 hour 24 minutes&quot;...
<br>
...
Subject: Re: [OMPI devel] Assigning processes to cores 1.4.2, 1.6.4 and 1.8.4
<br>
<p>Ok, seems like I am making some progress here.  Thanks for the help.
<br>
I turned HT off.
<br>
...
devel_at_[hidden]&lt;mailto:devel_at_[hidden]&gt;
Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/devel">http://www.open-mpi.org/mailman/listinfo.cgi/devel</a>
Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/04/17249.php">http://www.open-mpi.org/community/lists/devel/2015/04/17249.php</a>
</pre>
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17317/attachment">attachment</a>
</ul>
