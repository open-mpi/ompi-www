...
?>
<!-- received="Wed Apr 15 10:26:35 2015" -->
<!-- isoreceived="20150415142635" -->
<!-- sent="Wed, 15 Apr 2015 18:26:13 +0400" -->
<!-- isosent="20150415142613" -->
<!-- name="Elena Elkina" -->
...
<!-- id="CANhOtjaiewpN6UqcqKcCRsmH-pRaExw2nC0Jj18aes09WRa2Pw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="4D15A124-A5FA-4BBB-ABF7-F1DD2D3A9271_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-15 10:26:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17226.php">Ralph Castain: "Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch revert-520-valgrind_cleanness created. dev-1504-g7a8a4a0"</a>
<li><strong>Previous message:</strong> <a href="17224.php">Ralph Castain: "Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch revert-520-valgrind_cleanness created. dev-1504-g7a8a4a0"</a>
<li><strong>In reply to:</strong> <a href="17224.php">Ralph Castain: "Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch revert-520-valgrind_cleanness created. dev-1504-g7a8a4a0"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17226.php">Ralph Castain: "Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch revert-520-valgrind_cleanness created. dev-1504-g7a8a4a0"</a>
<li><strong>Reply:</strong> <a href="17226.php">Ralph Castain: "Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch revert-520-valgrind_cleanness created. dev-1504-g7a8a4a0"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph.
<br>
<p>We don't need to revert the whole commit, just to fix this small part. I
<br>
...
Elena
<br>
<p>On Wed, Apr 15, 2015 at 6:08 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I&#226;&#128;&#153;m really puzzled - I saw where you fixed the one part of this commit
</span><br>
<span class="quotelev1">&gt; that caused a problem for you. But what happened to the rest of it? Was it
</span><br>
<span class="quotelev1">&gt; really necessary to revert the entire thing, or was it only that piece that
</span><br>
...
<span class="quotelev2">&gt; &gt;                                      &quot;Set SHELL env variables delimiter.
</span><br>
<span class="quotelev1">&gt; Default: semicolon ';'&quot;,
</span><br>
<span class="quotelev2">&gt; &gt;                                      MCA_BASE_VAR_TYPE_STRING, NULL, 0,
</span><br>
<span class="quotelev1">&gt; 0, OPAL_INFO_LVL_3,
...
<span class="quotelev2">&gt; &gt; @@ -1249,31 +1241,15 @@ static int fixup_files(char **file_list, char *
</span><br>
<span class="quotelev1">&gt; path, bool rel_path_search, char
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; static int read_files(char *file_list, opal_list_t *file_values, char
</span><br>
<span class="quotelev1">&gt; sep)
</span><br>
<span class="quotelev2">&gt; &gt; {
</span><br>
...
<span class="quotelev1">&gt; MCA_BASE_VAR_SCOPE_GROUP, &amp;mca_btl_vader_component.single_copy_mechanism);
</span><br>
...
<span class="quotelev2">&gt; &gt;     /* Currently disabling DMA mode by default; it's not clear that this
</span><br>
<span class="quotelev1">&gt; is useful in all applications and architectures. */
</span><br>
...
<span class="quotelev2">&gt; &gt;                                   &quot;The name of output file for timing
</span><br>
<span class="quotelev1">&gt; information. If this parameter is not set then output will be directed into
</span><br>
<span class="quotelev1">&gt; OPAL debug channel.&quot;,
</span><br>
<span class="quotelev2">&gt; &gt;                                   MCA_BASE_VAR_TYPE_STRING, NULL, 0, 0,
</span><br>
...
<span class="quotelev2">&gt; &gt;                                   &quot;Timing framework introduce additional
</span><br>
<span class="quotelev1">&gt; overhead (malloc's mostly).&quot;
</span><br>
...
<span class="quotelev2">&gt; &gt; -    /* opal_finalize_util will call free on this pointer so set from
</span><br>
<span class="quotelev1">&gt; strdup */
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17225/attachment">attachment</a>
</ul>
