...
?>
<!-- received="Wed Apr 22 15:22:23 2015" -->
<!-- isoreceived="20150422192223" -->
<!-- sent="Wed, 22 Apr 2015 13:22:21 -0600" -->
<!-- isosent="20150422192221" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low" -->
<!-- id="20150422192221.GD68930_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAF1Cqj4RmcoLHuyVcyzyLNr7Ax9JD=TOeGziM2tRa2U9wv2ycA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-22 15:22:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17317.php">Tom Wurgler: "Re: [OMPI devel] Assigning processes to cores 1.4.2, 1.6.4 and 1.8.4"</a>
<li><strong>Previous message:</strong> <a href="17315.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<li><strong>In reply to:</strong> <a href="17314.php">Howard Pritchard: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17318.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>-Nathan
<br>
<p>On Wed, Apr 22, 2015 at 01:17:11PM -0600, Howard Pritchard wrote:
<br>
<span class="quotelev1">&gt;    Hi Rafael,
</span><br>
<span class="quotelev1">&gt;    I give you an A+ for effort.   We always appreciate patches.
</span><br>
<span class="quotelev1">&gt;    Howard
</span><br>
<span class="quotelev1">&gt;    2015-04-22 12:43 GMT-06:00 Nathan Hjelm &lt;hjelmn_at_[hidden]&gt;:
</span><br>
...
<span class="quotelev1">&gt;      On Wed, Apr 22, 2015 at 04:55:57PM +0200, Raphael Fouassier wrote:
</span><br>
...
<span class="quotelev2">&gt;      &gt; diff --git a/ompi/mca/btl/openib/connect/btl_openib_connect_udcm.c
</span><br>
...
<span class="quotelev2">&gt;      &gt;   * Copyright (c) 2011-2014 Los Alamos National Security, LLC.  All
</span><br>
...
<span class="quotelev2">&gt;      &gt; @@ -460,6 +461,8 @@ static int
</span><br>
<span class="quotelev1">&gt;      udcm_component_query(mca_btl_openib_module_t *btl,
</span><br>
<span class="quotelev2">&gt;      &gt;
</span><br>
...
<span class="quotelev2">&gt;      &gt; @@ -536,9 +539,19 @@ static int udcm_endpoint_finalize(struct
</span><br>
<span class="quotelev1">&gt;      mca_btl_base_endpoint_t *lcl_ep)
</span><br>
...
<span class="quotelev2">&gt;      &gt;  static int udcm_module_init (udcm_module_t *m,
</span><br>
...
<span class="quotelev2">&gt;      &gt; @@ -549,7 +562,7 @@ static int udcm_module_init (udcm_module_t *m,
</span><br>
<span class="quotelev1">&gt;      mca_btl_openib_module_t *btl)
</span><br>
<span class="quotelev2">&gt;      &gt;      m-&gt;cm_channel = ibv_create_comp_channel
</span><br>
<span class="quotelev1">&gt;      (btl-&gt;device-&gt;ib_dev_context);
</span><br>
...
<span class="quotelev2">&gt;      &gt; @@ -558,29 +571,33 @@ static int udcm_module_init (udcm_module_t *m,
</span><br>
<span class="quotelev1">&gt;      mca_btl_openib_module_t *btl)
</span><br>
...
<span class="quotelev2">&gt;      &gt; +        mca_btl_openib_show_init_error(__FILE__, __LINE__,
</span><br>
...
<span class="quotelev2">&gt;      &gt; @@ -633,12 +650,41 @@ static int udcm_module_init (udcm_module_t *m,
</span><br>
<span class="quotelev1">&gt;      mca_btl_openib_module_t *btl)
</span><br>
...
<span class="quotelev2">&gt;      &gt; +                                     udcm_unmonitor, (void
</span><br>
...
<span class="quotelev2">&gt;      &gt; @@ -691,15 +737,6 @@
</span><br>
<span class="quotelev1">&gt;      udcm_module_start_connect(ompi_btl_openib_connect_base_module_t *cpc,
</span><br>
<span class="quotelev2">&gt;      &gt;      return rc;
</span><br>
<span class="quotelev2">&gt;      &gt;  }
...
<span class="quotelev2">&gt;      &gt;                                  ompi_btl_openib_connect_base_module_t
</span><br>
...
<span class="quotelev2">&gt;      &gt; diff --git a/opal/mca/btl/openib/connect/btl_openib_connect_udcm.c
</span><br>
...
<span class="quotelev2">&gt;      &gt;   * Copyright (c) 2014-2015 Research Organization for Information
</span><br>
<span class="quotelev1">&gt;      Science
</span><br>
<span class="quotelev2">&gt;      &gt;   *                         and Technology (RIST). All rights
</span><br>
...
<span class="quotelev2">&gt;      &gt; @@ -470,6 +470,8 @@ static int
</span><br>
<span class="quotelev1">&gt;      udcm_component_query(mca_btl_openib_module_t *btl,
</span><br>
<span class="quotelev2">&gt;      &gt;
...
<span class="quotelev2">&gt;      &gt; @@ -646,9 +648,19 @@ static int udcm_endpoint_finalize(struct
</span><br>
<span class="quotelev1">&gt;      mca_btl_base_endpoint_t *lcl_ep)
</span><br>
...
<span class="quotelev2">&gt;      &gt; @@ -659,7 +671,7 @@ static int udcm_module_init (udcm_module_t *m,
</span><br>
<span class="quotelev1">&gt;      mca_btl_openib_module_t *btl)
</span><br>
<span class="quotelev2">&gt;      &gt;      m-&gt;cm_channel = ibv_create_comp_channel
...
<span class="quotelev2">&gt;      &gt; @@ -668,29 +680,33 @@ static int udcm_module_init (udcm_module_t *m,
</span><br>
<span class="quotelev1">&gt;      mca_btl_openib_module_t *btl)
</span><br>
<span class="quotelev2">&gt;      &gt;                                     m-&gt;cm_channel, 0);
...
<span class="quotelev2">&gt;      &gt; @@ -743,12 +759,40 @@ static int udcm_module_init (udcm_module_t *m,
</span><br>
<span class="quotelev1">&gt;      mca_btl_openib_module_t *btl)
</span><br>
<span class="quotelev2">&gt;      &gt;      /* Finally, request CQ notification */
...
<span class="quotelev2">&gt;      &gt; +        opal_btl_openib_fd_unmonitor(m-&gt;cm_channel-&gt;fd,
</span><br>
...
<span class="quotelev2">&gt;      &gt; @@ -801,15 +845,6 @@
</span><br>
<span class="quotelev1">&gt;      udcm_module_start_connect(opal_btl_openib_connect_base_module_t *cpc,
</span><br>
<span class="quotelev2">&gt;      &gt;      return rc;
</span><br>
<span class="quotelev2">&gt;      &gt;  }
...
<span class="quotelev2">&gt;      &gt;                                  opal_btl_openib_connect_base_module_t
</span><br>
<span class="quotelev1">&gt;      *cpc)
</span><br>
<span class="quotelev2">&gt;      &gt;  {
...
<span class="quotelev1">&gt;      <a href="http://www.open-mpi.org/community/lists/devel/2015/04/17311.php">http://www.open-mpi.org/community/lists/devel/2015/04/17311.php</a>
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/04/17314.php">http://www.open-mpi.org/community/lists/devel/2015/04/17314.php</a>
</span><br>
<p><p>
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17316/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
