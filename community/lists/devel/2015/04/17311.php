...
?>
<!-- received="Wed Apr 22 14:43:57 2015" -->
<!-- isoreceived="20150422184357" -->
<!-- sent="Wed, 22 Apr 2015 12:43:56 -0600" -->
<!-- isosent="20150422184356" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low" -->
<!-- id="20150422184356.GA68930_at_pn1246003.lanl.gov" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2015-04-22 14:43:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17312.php">Paul Hargrove: "[OMPI devel] Incorrect timer frequency [w/ patch]"</a>
<li><strong>Previous message:</strong> <a href="17310.php">Paul Hargrove: "[OMPI devel] Broken flex-required error message"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17313.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<li><strong>Reply:</strong> <a href="17313.php">Nathan Hjelm: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<li><strong>Reply:</strong> <a href="17314.php">Howard Pritchard: "Re: [OMPI devel] Fwd: OpenIB module initialisation causes segmentation fault when locked memory limit too low"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I will take a look now and apply the appropriate fix.
<br>
<p>-Nathan
<br>
...
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17311/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
