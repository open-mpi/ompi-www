...
?>
<!-- received="Wed Apr 15 11:42:18 2015" -->
<!-- isoreceived="20150415154218" -->
<!-- sent="Wed, 15 Apr 2015 09:42:16 -0600" -->
<!-- isosent="20150415154216" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch revert-520-valgrind_cleanness created. dev-1504-g7a8a4a0" -->
<!-- id="20150415154216.GE21644_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2015-04-15 11:42:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17230.php">Nathan Hjelm: "Re: [OMPI devel] Common symbols warning"</a>
<li><strong>Previous message:</strong> <a href="17228.php">Dave Goodell (dgoodell): "Re: [OMPI devel] Common symbols warning"</a>
...
<!-- body="start" -->
<p>
Looks like they just accidentally created a branch on the github repo. I
<br>
can confirm that they indeed did not revert the commit but only fixed
<br>
the relevant issue.
<br>
<p>-Nathan
<br>
<p>On Wed, Apr 15, 2015 at 07:36:16AM -0700, Ralph Castain wrote:
<br>
<span class="quotelev1">&gt;    Soooo....are you going to restore the rest of it? Or are we asking Nathan
</span><br>
<span class="quotelev1">&gt;    to refile it without that one piece?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;      On Apr 15, 2015, at 7:26 AM, Elena Elkina &lt;elena.elkina_at_[hidden]&gt;
</span><br>
...
<span class="quotelev1">&gt;      proposed a fast fix for that in the PR but probably we need to fix it
</span><br>
<span class="quotelev1">&gt;      more intellectually.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt;        I'm really puzzled - I saw where you fixed the one part of this commit
</span><br>
<span class="quotelev1">&gt;        that caused a problem for you. But what happened to the rest of it?
</span><br>
<span class="quotelev1">&gt;        Was it really necessary to revert the entire thing, or was it only
</span><br>
<span class="quotelev1">&gt;        that piece that caused a problem?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;        &gt; On Apr 15, 2015, at 5:41 AM, gitdub_at_[hidden] wrote:
</span><br>
<span class="quotelev2">&gt;        &gt;
</span><br>
<span class="quotelev2">&gt;        &gt; This is an automated email from the git hooks/post-receive script.
</span><br>
<span class="quotelev1">&gt;        It was
</span><br>
...
<span class="quotelev2">&gt;        &gt; diff --git a/ompi/runtime/ompi_mpi_init.c
</span><br>
...
<span class="quotelev2">&gt;        &gt;  * Copyright (c) 2004-2010 The Trustees of Indiana University and
</span><br>
...
<span class="quotelev2">&gt;        &gt; - * Copyright (c) 2006-2015 Los Alamos National Security, LLC.  All
</span><br>
<span class="quotelev1">&gt;        rights
</span><br>
<span class="quotelev2">&gt;        &gt; + * Copyright (c) 2006-2013 Los Alamos National Security, LLC.  All
</span><br>
<span class="quotelev1">&gt;        rights
</span><br>
<span class="quotelev2">&gt;        &gt;  *                         reserved.
</span><br>
<span class="quotelev2">&gt;        &gt;  * Copyright (c) 2006-2009 University of Houston. All rights
</span><br>
<span class="quotelev1">&gt;        reserved.
</span><br>
<span class="quotelev2">&gt;        &gt;  * Copyright (c) 2008-2009 Sun Microsystems, Inc.  All rights
</span><br>
<span class="quotelev1">&gt;        reserved.
</span><br>
<span class="quotelev2">&gt;        &gt; @@ -343,10 +342,7 @@ void ompi_mpi_thread_level(int requested, int
</span><br>
...
<span class="quotelev2">&gt;        &gt;                                      MCA_BASE_VAR_TYPE_STRING, NULL,
</span><br>
<span class="quotelev1">&gt;        0, 0, OPAL_INFO_LVL_3,
</span><br>
...
<span class="quotelev2">&gt;        &gt;         (void)mca_base_var_register (&quot;opal&quot;, &quot;mca&quot;, &quot;base&quot;,
</span><br>
<span class="quotelev1">&gt;        &quot;env_list_delimiter&quot;,
</span><br>
<span class="quotelev2">&gt;        &gt;                                      &quot;Set SHELL env variables
</span><br>
<span class="quotelev1">&gt;        delimiter. Default: semicolon ';'&quot;,
</span><br>
<span class="quotelev2">&gt;        &gt;                                      MCA_BASE_VAR_TYPE_STRING, NULL,
</span><br>
<span class="quotelev1">&gt;        0, 0, OPAL_INFO_LVL_3,
</span><br>
<span class="quotelev2">&gt;        &gt; @@ -433,7 +430,6 @@ static int mca_base_var_cache_files(bool
</span><br>
<span class="quotelev1">&gt;        rel_path_search)
</span><br>
...
<span class="quotelev2">&gt;        &gt;     (void) mca_base_var_register_synonym (ret, &quot;opal&quot;, &quot;mca&quot;, NULL,
</span><br>
<span class="quotelev1">&gt;        &quot;param_files&quot;,
</span><br>
...
<span class="quotelev2">&gt;        &gt; @@ -1249,31 +1241,15 @@ static int fixup_files(char **file_list,
</span><br>
<span class="quotelev1">&gt;        char * path, bool rel_path_search, char
</span><br>
<span class="quotelev2">&gt;        &gt;
</span><br>
<span class="quotelev2">&gt;        &gt; static int read_files(char *file_list, opal_list_t *file_values,
</span><br>
<span class="quotelev1">&gt;        char sep)
</span><br>
<span class="quotelev2">&gt;        &gt; {
</span><br>
...
<span class="quotelev2">&gt;        &gt; -        ret = opal_argv_insert (&amp;mca_base_var_file_list, count,
</span><br>
...
<span class="quotelev2">&gt;        &gt;     /* Iterate through all the files passed in -- read them in
</span><br>
<span class="quotelev1">&gt;        reverse
</span><br>
<span class="quotelev2">&gt;        &gt;        order so that we preserve unix/shell path-like semantics
</span><br>
...
<span class="quotelev2">&gt;        &gt;         mca_base_parse_paramfile(mca_base_var_file_list[i],
</span><br>
<span class="quotelev1">&gt;        file_values);
</span><br>
<span class="quotelev2">&gt;        &gt;     }
</span><br>
<span class="quotelev2">&gt;        &gt; diff --git a/opal/mca/btl/vader/btl_vader_component.c
</span><br>
...
<span class="quotelev2">&gt;        &gt; @@ -209,7 +209,6 @@ static int mca_btl_vader_component_register
</span><br>
<span class="quotelev1">&gt;        (void)
</span><br>
<span class="quotelev2">&gt;        &gt;                                            &quot;single_copy_mechanism&quot;,
</span><br>
<span class="quotelev1">&gt;        &quot;Single copy mechanism to use (defaults to best available)&quot;,
</span><br>
<span class="quotelev2">&gt;        &gt;                                            MCA_BASE_VAR_TYPE_INT,
</span><br>
<span class="quotelev1">&gt;        new_enum, 0, MCA_BASE_VAR_FLAG_SETTABLE,
</span><br>
<span class="quotelev2">&gt;        &gt;                                            OPAL_INFO_LVL_3,
</span><br>
<span class="quotelev1">&gt;        MCA_BASE_VAR_SCOPE_GROUP,
</span><br>
...
<span class="quotelev2">&gt;        &gt;     /* Currently disabling DMA mode by default; it's not clear that
</span><br>
<span class="quotelev1">&gt;        this is useful in all applications and architectures. */
</span><br>
<span class="quotelev2">&gt;        &gt; diff --git a/opal/mca/installdirs/base/installdirs_base_components.c
</span><br>
...
<span class="quotelev2">&gt;        &gt;     return mca_base_framework_components_close
</span><br>
<span class="quotelev1">&gt;        (&amp;opal_installdirs_base_framework, NULL);
</span><br>
<span class="quotelev2">&gt;        &gt; }
</span><br>
<span class="quotelev2">&gt;        &gt; diff --git a/opal/runtime/opal_finalize.c
</span><br>
...
<span class="quotelev2">&gt;        &gt;     (void) mca_base_var_register (&quot;opal&quot;, &quot;opal&quot;, NULL,
</span><br>
<span class="quotelev1">&gt;        &quot;timing_sync_file&quot;,
</span><br>
<span class="quotelev2">&gt;        &gt;                                   &quot;Clock synchronisation information
</span><br>
<span class="quotelev1">&gt;        generated by mpisync tool. You don't need to touch this if you use
</span><br>
<span class="quotelev1">&gt;        mpirun_prof tool.&quot;,
</span><br>
<span class="quotelev2">&gt;        &gt;                                   MCA_BASE_VAR_TYPE_STRING, NULL, 0,
</span><br>
<span class="quotelev1">&gt;        0,
</span><br>
<span class="quotelev2">&gt;        &gt; @@ -241,14 +240,12 @@ int opal_register_params(void)
</span><br>
<span class="quotelev2">&gt;        &gt;         opal_output(0, &quot;Cannot read file %s containing clock
</span><br>
<span class="quotelev1">&gt;        synchronisation information\n&quot;, opal_timing_sync_file);
</span><br>
<span class="quotelev2">&gt;        &gt;     }
</span><br>
<span class="quotelev2">&gt;        &gt;
...
<span class="quotelev1">&gt;        &quot;timing_output&quot;,
</span><br>
<span class="quotelev2">&gt;        &gt;                                   &quot;The name of output file for
</span><br>
<span class="quotelev1">&gt;        timing information. If this parameter is not set then output will be
</span><br>
<span class="quotelev1">&gt;        directed into OPAL debug channel.&quot;,
</span><br>
<span class="quotelev2">&gt;        &gt;                                   MCA_BASE_VAR_TYPE_STRING, NULL, 0,
</span><br>
<span class="quotelev1">&gt;        0,
...
<span class="quotelev1">&gt;        &quot;timing_overhead&quot;,
</span><br>
<span class="quotelev2">&gt;        &gt;                                   &quot;Timing framework introduce
</span><br>
<span class="quotelev1">&gt;        additional overhead (malloc's mostly).&quot;
</span><br>
<span class="quotelev2">&gt;        &gt;                                   &quot; The time spend in such costly
</span><br>
<span class="quotelev1">&gt;        routines is measured and may be accounted&quot;
</span><br>
...
<span class="quotelev2">&gt;        &gt; @@ -182,8 +182,7 @@ int orte_init(int* pargc, char*** pargv,
</span><br>
<span class="quotelev1">&gt;        orte_proc_type_t flags)
</span><br>
...
<span class="quotelev2">&gt;        &gt; -    /* opal_finalize_util will call free on this pointer so set
</span><br>
<span class="quotelev1">&gt;        from strdup */
</span><br>
<span class="quotelev2">&gt;        &gt; -    opal_process_info.nodename = strdup
</span><br>
...
<span class="quotelev1">&gt;        mca_base_framework_open(&amp;opal_dstore_base_framework, 0))) {
</span><br>
<span class="quotelev2">&gt;        &gt;
</span><br>
<span class="quotelev2">&gt;        &gt;
...
<span class="quotelev1">&gt;        <a href="http://www.open-mpi.org/community/lists/devel/2015/04/17224.php">http://www.open-mpi.org/community/lists/devel/2015/04/17224.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;      _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/04/17226.php">http://www.open-mpi.org/community/lists/devel/2015/04/17226.php</a>
</span><br>
<p><p>
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-17229/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
