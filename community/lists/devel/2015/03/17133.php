...
?>
<!-- received="Fri Mar 13 16:28:31 2015" -->
<!-- isoreceived="20150313202831" -->
<!-- sent="Fri, 13 Mar 2015 14:28:29 -0600" -->
<!-- isosent="20150313202829" -->
<!-- name="Orion Poplawski" -->
<!-- email="orion_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] hangs/crashes with openmpi-1.8.4-99-20150228" -->
<!-- id="5503486D.4050005_at_cora.nwra.com" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="CAMJJpkXeDDfS1D7eYVFe2yGB0ixiU-X087WiNX-d87EJOcCW6A_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-03-13 16:28:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17134.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] hangs/crashes with openmpi-1.8.4-99-20150228"</a>
<li><strong>Previous message:</strong> <a href="17132.php">George Bosilca: "Re: [OMPI devel] hangs/crashes with openmpi-1.8.4-99-20150228"</a>
<li><strong>In reply to:</strong> <a href="17132.php">George Bosilca: "Re: [OMPI devel] hangs/crashes with openmpi-1.8.4-99-20150228"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17134.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] hangs/crashes with openmpi-1.8.4-99-20150228"</a>
<li><strong>Reply:</strong> <a href="17134.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] hangs/crashes with openmpi-1.8.4-99-20150228"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On 03/13/2015 01:08 PM, George Bosilca wrote:
<br>
<span class="quotelev1">&gt; Do you have the same behavior when you disable the vader BTL ? (--mca btl ^vader).
</span><br>
...
<span class="quotelev1">&gt; On Fri, Mar 13, 2015 at 2:20 PM, Orion Poplawski &lt;orion_at_[hidden]
</span><br>
<span class="quotelev1">&gt; &lt;mailto:orion_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;     We currently have openmpi-1.8.4-99-20150228 built in Fedora Rawhide.  I'm now
</span><br>
...
<span class="quotelev1">&gt;     [mock1:23702] *** reported by process [3653173249 &lt;tel:%5B3653173249&gt;,1]
</span><br>
...
<span class="quotelev1">&gt;     Hangs (100%cpu) seem to be in opal_condition_wait() -&gt; opal_progress() calling
</span><br>
...
<span class="quotelev1">&gt;     #3  0xf40b4695 in opal_condition_wait (c=&lt;optimized out&gt;, m=&lt;optimized out&gt;)
</span><br>
...
<span class="quotelev1">&gt;         rdtype=rdtype_at_entry=0xf4148240 &lt;ompi_mpi_int&gt;, comm=comm_at_entry=0xf7b051d8,
</span><br>
<span class="quotelev1">&gt;         module=module_at_entry=0xf7a2b4d0) at coll_tuned_alltoall.c:700
</span><br>
<span class="quotelev1">&gt;     #6  0xf28b4d08 in ompi_coll_tuned_alltoall_intra_dec_fixed (sbuf=0xf7a2d328,
</span><br>
...
<span class="quotelev1">&gt;         count_my_req_per_proc=0xf7a2d328, my_req=0xf7b00750, nprocs=4, myrank=0,
</span><br>
<span class="quotelev1">&gt;         count_others_req_procs_ptr=count_others_req_procs_ptr_at_entry=0xffbea6e8,
</span><br>
...
<span class="quotelev1">&gt;     #9  0xe9796a14 in ADIOI_GEN_WriteStridedColl (fd=0xf7b12640, buf=0xf7aa0148,
</span><br>
...
<span class="quotelev1">&gt;         offset=offset_at_entry=0, buf=buf_at_entry=0xf7aa0148, count=count_at_entry=2440,
</span><br>
<span class="quotelev1">&gt;         datatype=datatype_at_entry=0xf4148840 &lt;ompi_mpi_byte&gt;,
</span><br>
...
<span class="quotelev1">&gt;         mpi_buf_count=&lt;optimized out&gt;, type_info=0xffbeab1c, io_info=0xffbeab60)
</span><br>
...
<span class="quotelev1">&gt;     #23 H5D__pre_write (dset=dset_at_entry=0xf7a3eb40, direct_write=&lt;optimized out&gt;,
</span><br>
<span class="quotelev1">&gt;         mem_type_id=mem_type_id_at_entry=50331747,
</span><br>
<span class="quotelev1">&gt;     mem_space=mem_space_at_entry=0xf7a38120,
</span><br>
...
<span class="quotelev1">&gt;     #27 NC4_put_vara (ncid=65536, varid=3, startp=0xffbf6a08, countp=0xffbf6a10,
</span><br>
...
<span class="quotelev1">&gt;     #29 0xf460b541 in nc_put_vara_float (ncid=65536, varid=3, startp=0xffbf6a08,
</span><br>
...
<span class="quotelev1">&gt;     &lt;tel:303-415-9701%20x222&gt;
</span><br>
<span class="quotelev1">&gt;     NWRA, Boulder/CoRA Office             FAX: 303-415-9702 &lt;tel:303-415-9702&gt;
</span><br>
<span class="quotelev1">&gt;     3380 Mitchell Lane                       orion_at_[hidden]
</span><br>
<span class="quotelev1">&gt;     &lt;mailto:orion_at_[hidden]&gt;
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/03/17132.php">http://www.open-mpi.org/community/lists/devel/2015/03/17132.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<p><p><pre>
