...
?>
<!-- received="Wed Sep 16 13:42:56 2015" -->
<!-- isoreceived="20150916174256" -->
<!-- sent="Wed, 16 Sep 2015 11:42:54 -0600" -->
<!-- isosent="20150916174254" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] The issue with OMPI_FREE_LIST_GET_MT()" -->
<!-- id="20150916174254.GI98529_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAMJJpkVKPBHmkSaQKJunOGodk6RwBJzJ3+8wv-V1wM6a7YiQ5w_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-09-16 13:42:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18052.php">Rolf vandeVaart: "Re: [OMPI devel] The issue with OMPI_FREE_LIST_GET_MT()"</a>
<li><strong>Previous message:</strong> <a href="18050.php">George Bosilca: "Re: [OMPI devel] The issue with OMPI_FREE_LIST_GET_MT()"</a>
<li><strong>In reply to:</strong> <a href="18050.php">George Bosilca: "Re: [OMPI devel] The issue with OMPI_FREE_LIST_GET_MT()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18052.php">Rolf vandeVaart: "Re: [OMPI devel] The issue with OMPI_FREE_LIST_GET_MT()"</a>
<li><strong>Reply:</strong> <a href="18052.php">Rolf vandeVaart: "Re: [OMPI devel] The issue with OMPI_FREE_LIST_GET_MT()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>-Nathan
<br>
<p>On Wed, Sep 16, 2015 at 01:19:24PM -0400, George Bosilca wrote:
<br>
<span class="quotelev1">&gt;    As they don't even compile why are we keeping them around?
</span><br>
<span class="quotelev1">&gt;      George.
</span><br>
<span class="quotelev1">&gt;    On Wed, Sep 16, 2015 at 12:05 PM, Nathan Hjelm &lt;hjelmn_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;      &gt;    On Wed, Sep 16, 2015 at 11:59 AM, George Bosilca
</span><br>
...
<span class="quotelev2">&gt;      &gt;      This is not necessarily the fix for all cases. Most of the
</span><br>
<span class="quotelev1">&gt;      internal uses
</span><br>
<span class="quotelev2">&gt;      &gt;      of the free_list can easily accommodate to the fact that no more
</span><br>
<span class="quotelev2">&gt;      &gt;      elements are available. Based on your description of the problem
</span><br>
...
<span class="quotelev2">&gt;      &gt;      problem is that fact that we call OMPI_FREE_LIST_GET_MT and that
</span><br>
<span class="quotelev1">&gt;      the
</span><br>
...
<span class="quotelev2">&gt;      &gt;      blocking version of the free_list accessor (similar to the case
</span><br>
...
<span class="quotelev2">&gt;      &gt;        MCA_PML_OB1_RECV_REQUEST_ALLOC()  because 
</span><br>
<span class="quotelev1">&gt;      OMPI_FREE_LIST_GET_MT()
</span><br>
<span class="quotelev2">&gt;      &gt;         returned NULL.  Investigating this bug we found that sometimes
</span><br>
<span class="quotelev1">&gt;      the
</span><br>
<span class="quotelev2">&gt;      &gt;        thread calling ompi_free_list_grow()  don't have any free items
</span><br>
<span class="quotelev1">&gt;      in
</span><br>
<span class="quotelev2">&gt;      &gt;        LIFO list at exit because other threads  retrieved  all new
</span><br>
<span class="quotelev1">&gt;      items at
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2015/09/18050.php">http://www.open-mpi.org/community/lists/devel/2015/09/18050.php</a>
</span><br>
<p><p>
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18051/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
