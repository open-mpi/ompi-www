...
?>
<!-- received="Mon Sep 21 00:32:07 2015" -->
<!-- isoreceived="20150921043207" -->
<!-- sent="Sun, 20 Sep 2015 21:32:02 -0700" -->
<!-- isosent="20150921043202" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] PMIX vs Solaris" -->
<!-- id="D85CC309-D361-46D4-9B23-5F1E2507049B_at_open-mpi.org" -->
<!-- charset="utf-8" -->
<!-- inreplyto="CAAvDA15+Et-_EjcZVwt-4SPCTdSwcOTUwibpz6JfZCXUzraVqA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-09-21 00:32:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18093.php">Paul Hargrove: "Re: [OMPI devel] PMIX vs Solaris"</a>
<li><strong>Previous message:</strong> <a href="18091.php">Ralph Castain: "Re: [OMPI devel] OpenMPI 1.10.0: Arch Linux PkgSrc build suggests configure script patch"</a>
<li><strong>In reply to:</strong> <a href="18089.php">Paul Hargrove: "Re: [OMPI devel] PMIX vs Solaris"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18093.php">Paul Hargrove: "Re: [OMPI devel] PMIX vs Solaris"</a>
<li><strong>Reply:</strong> <a href="18093.php">Paul Hargrove: "Re: [OMPI devel] PMIX vs Solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
?? Just so this old fossilized brain gets this right: you are saying there was a 64s pause before the hwloc error appeared, and then another 64s pause after the second server_setup_fork message appeared?
<br>
<p>If that&#226;&#128;&#153;s true, then I&#226;&#128;&#153;m chasing the wrong problem - it sounds like something is messed up in the mpirun startup. Did you have more than one node in the allocation by chance? I&#226;&#128;&#153;m wondering if we are getting held up by something in the daemon launch/callback area.
<br>
<p><p><p><span class="quotelev1">&gt; On Sep 20, 2015, at 4:08 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; On Sun, Sep 20, 2015 at 2:15 PM, Ralph Castain &lt;rhc_at_[hidden] &lt;mailto:rhc_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; On Sep 20, 2015, at 12:40 PM, Paul Hargrove &lt;phhargrove_at_[hidden] &lt;mailto:phhargrove_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; On Sun, Sep 20, 2015 at 8:19 AM, Ralph Castain &lt;rhc_at_[hidden] &lt;mailto:rhc_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Paul - can you please confirm that you gave mpirun a level of 10 for the pmix_base_verbose param? This output isn&#226;&#128;&#153;t what I would have expected from that level - it looks more like the verbosity was set to 5, and so the error number isn&#226;&#128;&#153;t printed.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Sep 20, 2015, at 3:42 AM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden] &lt;mailto:gilles.gouaillardet_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; at that time, the issue in ompi was that the global errno was uses instead of the per thread errno.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; though the man pages tells -mt should be used fir multithreaded apps, you tried -D_REENTRANT on all your platforms, and it was enough to get the expected result.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I just wanted to check pmix1xx (sub)configure did correctly pass the -D_REENTRANT flag, and it does. so this is very likely a new and unrelated error
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Sunday, September 20, 2015, Paul Hargrove &lt;phhargrove_at_[hidden] &lt;mailto:phhargrove_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Gilles,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Yes every $CC invocation in opal/mca/pmix/pmix1xx includes &quot;-D_REENTRANT&quot;.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; However, they don't include &quot;-mt&quot;.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I believe we concluded (when we had problems previously) that &quot;-mt&quot; was the proper flag (at compile and link) for multi-threaded with the Studio compilers.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -Paul
...
<span class="quotelev3">&gt;&gt;&gt; On Sat, Sep 19, 2015 at 11:29 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden] &lt;&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Paul,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; We ran into similar issues in the past, and they only occurred with Solaris 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Cheers,
...
<span class="quotelev3">&gt;&gt;&gt; Ah, okay - that makes more sense. I&#226;&#128;&#153;ll have to let Brice see if he can figure out how to silence the hwloc error message as I can&#226;&#128;&#153;t find where it came from. The other errors are real and are the reason why the job was terminated.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The problem is that we are trying to establish a communication between the app and the daemon via unix domain socket, and we failed to do so. The error tells me that we were able to create and connect to the socket, but failed when the daemon tried to do a blocking send to the app.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Can you rerun it with -mca pmix_base_verbose 10? It will tell us the value of the error number that was returned
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The complete output (which I really should have included in the first place) is below.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [pcp-d-3:26054] PMIX ERROR: ERROR in file /export/home/phargrov/OMPI/openmpi-master-solaris11-x64-ss12u3/openmpi-dev-2559-g567c9e3/opal/mca/pmix/pmix1xx/pmix/src/client/pmix_client.c at line 181
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [pcp-d-3:26053] PMIX ERROR: UNREACHABLE in file /export/home/phargrov/OMPI/openmpi-master-solaris11-x64-ss12u3/openmpi-dev-2559-g567c9e3/opal/mca/pmix/pmix1xx/pmix/src/server/pmix_server_listener.c at line 463
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [pcp-d-3:26054] Local abort before MPI_INIT completed completed successfully, but am not able to aggregate error messages, and not able to guarantee that all other processes were killed!
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -------------------------------------------------------
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun detected that one or more processes exited with non-zero status, thus causing
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sat, Sep 19, 2015 at 8:50 PM, Ralph Castain &lt;rhc_at_[hidden] &lt;&gt;&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Paul, can you clarify something for me? The error in this case indicates that the client wasn&#226;&#128;&#153;t able to reach the daemon - this should have resulted in termination of the job. Did the job actually run?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Thu, Sep 17, 2015 at 11:13 PM, Paul Hargrove &lt;phhargrove_at_[hidden] &lt;&gt;&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Thu, Sep 17, 2015 at 11:00 PM, Gilles Gouaillardet &lt;gilles_at_[hidden] &lt;&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Paul,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Lawrence Berkeley National Laboratory     Fax: +1-510-486-6900 &lt;tel:%2B1-510-486-6900&gt;&lt;typescript&gt;_______________________________________________
</span><br>
<span class="quotelev2">&gt;&gt; devel mailing list
</span><br>
<span class="quotelev2">&gt;&gt; devel_at_[hidden] &lt;mailto:devel_at_[hidden]&gt;
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18092/attachment">attachment</a>
</ul>
