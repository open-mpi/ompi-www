...
?>
<!-- received="Sun Sep 20 19:08:16 2015" -->
<!-- isoreceived="20150920230816" -->
<!-- sent="Sun, 20 Sep 2015 16:08:08 -0700" -->
<!-- isosent="20150920230808" -->
<!-- name="Paul Hargrove" -->
<!-- email="phhargrove_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] PMIX vs Solaris" -->
<!-- id="CAAvDA15+Et-_EjcZVwt-4SPCTdSwcOTUwibpz6JfZCXUzraVqA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="8B4FAA29-758F-4807-9999-7316FA0202B6_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-09-20 19:08:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18090.php">Kevin Buckley: "[OMPI devel] OpenMPI 1.10.0: Arch Linux PkgSrc build suggests configure script patch"</a>
<li><strong>Previous message:</strong> <a href="18088.php">Ralph Castain: "Re: [OMPI devel] PMIX vs Solaris"</a>
<li><strong>In reply to:</strong> <a href="18088.php">Ralph Castain: "Re: [OMPI devel] PMIX vs Solaris"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18092.php">Ralph Castain: "Re: [OMPI devel] PMIX vs Solaris"</a>
<li><strong>Reply:</strong> <a href="18092.php">Ralph Castain: "Re: [OMPI devel] PMIX vs Solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>Still failing with that patch, but with the addition of a fairly long pause
<br>
(64s) before the first error message appears, and again after the second
<br>
&quot;server setup_fork&quot; (64s again)
<br>
<p>New output is attached.
<br>
<p>-Paul
<br>
<p>On Sun, Sep 20, 2015 at 2:15 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Argh - found a typo in the output line. Could you please try the attached
</span><br>
<span class="quotelev1">&gt; patch and do it again? This might fix it, but if not it will provide me
</span><br>
<span class="quotelev1">&gt; with some idea of the returned error.
</span><br>
...
<span class="quotelev2">&gt;&gt; Paul - can you please confirm that you gave mpirun a level of 10 for the
</span><br>
<span class="quotelev2">&gt;&gt; pmix_base_verbose param? This output isn&#226;&#128;&#153;t what I would have expected from
</span><br>
<span class="quotelev2">&gt;&gt; that level - it looks more like the verbosity was set to 5, and so the
</span><br>
<span class="quotelev2">&gt;&gt; error number isn&#226;&#128;&#153;t printed.
</span><br>
...
<span class="quotelev2">&gt;&gt; at that time, the issue in ompi was that the global errno was uses
</span><br>
<span class="quotelev2">&gt;&gt; instead of the per thread errno.
</span><br>
<span class="quotelev2">&gt;&gt; though the man pages tells -mt should be used fir multithreaded apps, you
</span><br>
<span class="quotelev2">&gt;&gt; tried -D_REENTRANT on all your platforms, and it was enough to get the
</span><br>
<span class="quotelev2">&gt;&gt; expected result.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I just wanted to check pmix1xx (sub)configure did correctly pass the
</span><br>
<span class="quotelev2">&gt;&gt; -D_REENTRANT flag, and it does. so this is very likely a new and unrelated
</span><br>
...
<span class="quotelev2">&gt;&gt; On Sunday, September 20, 2015, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Yes every $CC invocation in opal/mca/pmix/pmix1xx includes
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;-D_REENTRANT&quot;.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; However, they don't include &quot;-mt&quot;.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I believe we concluded (when we had problems previously) that &quot;-mt&quot; was
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the proper flag (at compile and link) for multi-threaded with the Studio
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Sat, Sep 19, 2015 at 11:29 PM, Gilles Gouaillardet &lt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Can you please double check pmix1xx is compiled with -D_REENTRANT ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; We ran into similar issues in the past, and they only occurred with
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Ah, okay - that makes more sense. I&#226;&#128;&#153;ll have to let Brice see if he
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; can figure out how to silence the hwloc error message as I can&#226;&#128;&#153;t find where
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; it came from. The other errors are real and are the reason why the job was
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; terminated.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; The problem is that we are trying to establish a communication
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; between the app and the daemon via unix domain socket, and we failed to do
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; so. The error tells me that we were able to create and connect to the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; socket, but failed when the daemon tried to do a blocking send to the app.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Paul, can you clarify something for me? The error in this case
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; indicates that the client wasn&#226;&#128;&#153;t able to reach the daemon - this should
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; have resulted in termination of the job. Did the job actually run?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Sep 18, 2015, at 2:50 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Any suggestion how I (as a non-root user) can avoid seeing this
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; hwloc error message on every run?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -Paul
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; gilles_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Paul,
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; IIRC, the &quot;Permission denied&quot; is coming from hwloc that cannot
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; collect all the info it would like.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2015/09/18083.php">http://www.open-mpi.org/community/lists/devel/2015/09/18083.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2015/09/18085.php">http://www.open-mpi.org/community/lists/devel/2015/09/18085.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18089/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-18089/typescript">typescript</a>
</ul>
