...
<!-- received="Fri Jan 20 21:38:31 2006" -->
<!-- isoreceived="20060121023831" -->
<!-- sent="Fri, 20 Jan 2006 21:38:24 -0500" -->
<!-- isosent="20060121023824" -->
<!-- name="Brian Barrett" -->
<!-- email="brbarret_at_[hidden]" -->
<!-- subject="Re:  ompi_get_version" -->
<!-- id="120644F1-B78F-49B0-A850-E9589FD5E7FD_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2006-01-20 21:38:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0703.php">Ralf Wildenhues: "Re:  ompi_get_version"</a>
<li><strong>Previous message:</strong> <a href="0701.php">George Bosilca: "Re:  while-loop around opal_condition_wait"</a>
<li><strong>In reply to:</strong> <a href="0687.php">Ralf Wildenhues: "ompi_get_version"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0703.php">Ralf Wildenhues: "Re:  ompi_get_version"</a>
<li><strong>Reply:</strong> <a href="0703.php">Ralf Wildenhues: "Re:  ompi_get_version"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralf -
<br>
<p>I'm running into some problems with the patch.  Unfortunately, sed is  
<br>
not my strong point.  On Mac OS X 10.4 (possibly others), I get the  
<br>
errors below.  Any ideas?  If you need a machine to play on, try  
<br>
frood.osl.iu.edu -- your normal IU username / password should work.
<br>
<p>Brian
<br>
<p>[Running] aclocal
