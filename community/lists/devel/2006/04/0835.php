...
<!-- received="Thu Apr 20 13:28:11 2006" -->
<!-- isoreceived="20060420172811" -->
<!-- sent="Thu, 20 Apr 2006 11:28:08 -0600" -->
<!-- isosent="20060420172808" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] opal_event_loop exiting" -->
<!-- id="4447C4A8.6010401_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="1CBADB41-7795-4305-B097-DA9A0C80C769_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-04-20 13:28:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0836.php">Galen M. Shipman: "[OMPI devel] Pack data mismatch in file dps_unpack.c 95/121"</a>
<li><strong>Previous message:</strong> <a href="0834.php">Greg Watson: "Re: [OMPI devel] opal_event_loop exiting"</a>
<li><strong>In reply to:</strong> <a href="0834.php">Greg Watson: "Re: [OMPI devel] opal_event_loop exiting"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Looks reasonable - let me see what can be done.<br>
<br>
Thanks<br>
Ralph<br>
<br>
<br>
Greg Watson wrote:
<blockquote cite="mid1CBADB41-7795-4305-B097-DA9A0C80C769@lanl.gov"
 type="cite">Ok, thanks.
  <br>
  <br>
...
On Apr 20, 2006, at 10:21 AM, Ralph Castain wrote:
  <br>
  <br>
  <blockquote type="cite">You make a good point about the library not
...
Greg Watson wrote:
    <br>
    <blockquote type="cite">The simplest thing for us would be for
...
Brian Barrett wrote:
        <br>
        <blockquote type="cite">On Apr 19, 2006, at 4:15 PM, Greg
Watson wrote:
          <br>
