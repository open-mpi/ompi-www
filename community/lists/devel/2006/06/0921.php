...
<!-- received="Fri Jun  2 12:55:52 2006" -->
<!-- isoreceived="20060602165552" -->
<!-- sent="Fri, 02 Jun 2006 10:55:47 -0600" -->
<!-- isosent="20060602165547" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] SIGSTOP and SIGCONT on orted" -->
<!-- id="44806D93.70606_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="C835B9C9CB0F1C4E9DA48913C9E8F8AF94C663_at_xmb-rtp-215.amer.cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-06-02 12:55:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0922.php">Jonathan Day: "[OMPI devel] Query on zero-copy sends"</a>
<li><strong>Previous message:</strong> <a href="0920.php">Jeff Squyres \(jsquyres\): "Re: [OMPI devel] SIGSTOP and SIGCONT on orted"</a>
<li><strong>In reply to:</strong> <a href="0919.php">Jeff Squyres \(jsquyres\): "Re: [OMPI devel] SIGSTOP and SIGCONT on orted"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0923.php">Josh Hursey: "Re: [OMPI devel] SIGSTOP and SIGCONT on orted"</a>
<li><strong>Reply:</strong> <a href="0923.php">Josh Hursey: "Re: [OMPI devel] SIGSTOP and SIGCONT on orted"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<blockquote
 cite="midC835B9C9CB0F1C4E9DA48913C9E8F8AF94C663@xmb-rtp-215.amer.cisco.com"
 type="cite">
  <title></title>
  <meta http-equiv="Content-Type" content="text/html; ">
  <meta content="MSHTML 6.00.2900.2883" name="GENERATOR">
  <div><span class="914013613-02062006"><font color="#0000ff"
 face="Arial" size="2">I guess I had in my head that Josh&nbsp;already
...
issues I mentioned. Quite a ways from having something for general use.<br>
<blockquote
 cite="midC835B9C9CB0F1C4E9DA48913C9E8F8AF94C663@xmb-rtp-215.amer.cisco.com"
 type="cite">
  <div><span class="914013613-02062006"></span>&nbsp;</div>
  <div><span class="914013613-02062006"><font color="#0000ff"
 face="Arial" size="2">This also brings up another [minor] point -- we
...
been a pretty low priority.</font></span></div>
  <div><span class="914013613-02062006"></span>&nbsp;</div>
  <div><span class="914013613-02062006"><font color="#0000ff"
 face="Arial" size="2">Sorry for all the confusion, though&nbsp;-- I keyed
...
as "our implementation prohibits this."&nbsp;&nbsp;:-)</font></span></div>
</blockquote>
My fault - should have been clearer.<br>
<blockquote
 cite="midC835B9C9CB0F1C4E9DA48913C9E8F8AF94C663@xmb-rtp-215.amer.cisco.com"
 type="cite">
  <div>&nbsp;</div>
...
Behalf Of </b>Ralph Castain<br>
    <b>Sent:</b> Friday, June 02, 2006 9:12 AM<br>
