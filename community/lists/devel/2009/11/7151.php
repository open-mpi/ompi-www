...
?>
<!-- received="Thu Nov 26 15:19:37 2009" -->
<!-- isoreceived="20091126201937" -->
<!-- sent="Thu, 26 Nov 2009 13:19:27 -0700" -->
<!-- isosent="20091126201927" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm" -->
<!-- id="ADB23E40-72CF-498F-B914-422AEBBE4E4D_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2009-11-26 15:19:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7152.php">Sylvain Jeaugey: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<li><strong>Previous message:</strong> <a href="7150.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7152.php">Sylvain Jeaugey: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Just to clarify something: I have been testing with the trunk, NOT the 1.5 branch. I haven't even bothered to look at that code since it was branched.
<br>
<p><span class="quotelev1">&gt;From what little I have heard plus what I (and others) have done since the branch, I strongly suspect a complete ORTE refresh will be required on that branch prior to any release. So I wouldn't personally spend a lot of time chasing a problem on that branch.
</span><br>
<p>See if you can replicate it on the trunk - if you can, please let me know as I am unable to do so.
<br>
<p>HTH
<br>
Ralph
<br>
<p>On Nov 26, 2009, at 12:28 PM, Ralph Castain wrote:
<br>
