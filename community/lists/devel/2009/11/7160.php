...
?>
<!-- received="Mon Nov 30 11:07:52 2009" -->
<!-- isoreceived="20091130160752" -->
<!-- sent="Mon, 30 Nov 2009 17:09:53 +0100 (CET)" -->
<!-- isosent="20091130160953" -->
<!-- name="Sylvain Jeaugey" -->
<!-- email="sylvain.jeaugey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm" -->
<!-- id="alpine.DEB.2.00.0911301706370.3715_at_jeaugeys.frec.bull.fr" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="054033D8-F71B-4FCD-BEC1-BBEDC5AF32AD_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-11-30 11:09:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7161.php">Jeff Squyres: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<li><strong>Previous message:</strong> <a href="7159.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<li><strong>In reply to:</strong> <a href="7159.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/devel/2009/12/7176.php">Sylvain Jeaugey: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/devel/2009/12/7176.php">Sylvain Jeaugey: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>About the compilers, I've tried with both gcc and intel and it doesn't 
<br>
seem to make a difference.
<br>
<p>On Mon, 30 Nov 2009, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; Interesting. The only difference I see is the FC11 - I haven't seen 
</span><br>
<span class="quotelev1">&gt; anyone running on that OS yet. I wonder if that is the source of the 
</span><br>
<span class="quotelev1">&gt; trouble? Do we know that our code works on that one? I know we had 
</span><br>
<span class="quotelev1">&gt; problems in the past with FC9, for example, that required fixes.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Also, what compiler are you using? I wonder if there is some 
</span><br>
<span class="quotelev1">&gt; optimization issue here, or some weird interaction between FC11 and the 
</span><br>
