...
?>
<!-- received="Fri Nov 20 09:08:48 2009" -->
<!-- isoreceived="20091120140848" -->
<!-- sent="Fri, 20 Nov 2009 07:08:36 -0700" -->
<!-- isosent="20091120140836" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm" -->
<!-- id="74801544-6830-41D6-A81E-D4A8CEC0FEB9_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="2094B351-4C1F-4B3F-BA95-C150D6639409_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-11-20 09:08:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7139.php">Jeff Squyres: "[OMPI devel] Fwd: Call for participation: MPI Forum User Survey"</a>
<li><strong>Previous message:</strong> <a href="7137.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<li><strong>In reply to:</strong> <a href="7137.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7150.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Nov 20, 2009, at 7:06 AM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; Thanks! I'll give it a try.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; My tests are all conducted with fast launches (just running slurm on large clusters) and using an mpi hello world that calls mpi_init at first instruction. I'll see if adding the delay causes it to misbehave.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
