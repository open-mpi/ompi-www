...
?>
<!-- received="Fri Nov 20 08:53:44 2009" -->
<!-- isoreceived="20091120135344" -->
<!-- sent="Fri, 20 Nov 2009 14:55:03 +0100 (CET)" -->
<!-- isosent="20091120135503" -->
<!-- name="Sylvain Jeaugey" -->
<!-- email="sylvain.jeaugey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm" -->
<!-- id="alpine.DEB.2.00.0911201445470.14773_at_jeaugeys" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="8CA55878-A100-4896-AB7B-187E79D77DE9_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-11-20 08:55:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7137.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<li><strong>Previous message:</strong> <a href="7135.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<li><strong>In reply to:</strong> <a href="7135.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7137.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<li><strong>Reply:</strong> <a href="7137.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<li><strong>Reply:</strong> <a href="7150.php">Ralph Castain: "Re: [OMPI devel] Deadlocks with new (routed) orted launch algorithm"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>Thanks for your efforts. I will look at our configuration and see how it 
<br>
may differ from ours.
<br>
<p>Here is a patch which helps reproducing the bug even with a small number 
<br>
of nodes.
<br>
<p>diff -r b622b9e8f1ac orte/orted/orted_comm.c
<br>
...
<p>&nbsp;&nbsp;CLEANUP:
<br>
<p>Just set ORTE_RELAY_DELAY to 1 (second) and you should reproduce the bug.
<br>
<p>During our experiments, the bug disappeared when we added a delay before 
<br>
...
<br>
<p>We usually reproduce the bug with one ppn (faster to spawn).
<br>
<p>Sylvain
<br>
