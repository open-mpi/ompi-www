...
?>
<!-- received="Tue Jan 20 07:07:16 2009" -->
<!-- isoreceived="20090120120716" -->
<!-- sent="Tue, 20 Jan 2009 07:06:03 -0500" -->
<!-- isosent="20090120120603" -->
<!-- name="Graham, Richard L." -->
<!-- email="rlgraham_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: sm Latency" -->
<!-- id="537C6C0940C6C143AA46A88946B854170F0FC125_at_ORNLEXCHANGE.ornl.gov" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="[OMPI devel] RFC: sm Latency" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-01-20 07:06:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5230.php">Jonathan Billings: "Re: [OMPI devel] OpenMPI rpm build 1.3rc3r20226 build failed"</a>
<li><strong>Previous message:</strong> <a href="5228.php">Terry Dontje: "Re: [OMPI devel] RFC: sm Latency"</a>
<li><strong>Maybe in reply to:</strong> <a href="5224.php">Eugene Loh: "[OMPI devel] RFC: sm Latency"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5266.php">Ron Brightwell: "Re: [OMPI devel] RFC: sm Latency"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; looks like the btl needs to start &#226;&#128;&#156;knowing&#226;&#128;&#157; about MPI level semantics.
</span><br>
...
<span class="quotelev1">&gt; same process count ? &#226;&#128;&#156;Real&#226;&#128;&#157; apps would be interesting, but even hpl
</span><br>
...
<span class="quotelev1">&gt; the fifo&#226;&#128;&#153;s with a single link list per process in shared memory, with
</span><br>
...
<span class="quotelev1">&gt; other optimizations to lower the absolute latency &#226;&#128;&#147; perhaps what you
</span><br>
...
<span class="quotelev1">&gt; most apps don&#226;&#128;&#153;t have that behaviour.
</span><br>
...
<span class="quotelev1">&gt;     the limiting factor) to 2&#195;&#151; or more (if MPI software overhead is
</span><br>
<span class="quotelev1">&gt;     the limiting factor). At high process counts, the improvement can
</span><br>
<span class="quotelev1">&gt;     be 10&#195;&#151; or more.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;     where hardware is the bottleneck) to 2&#195;&#151; (np=2 measurements where
</span><br>
<span class="quotelev1">&gt;     software is the bottleneck) to over 10&#195;&#151; (large np).
</span><br>
...
<span class="quotelev1">&gt;                             *Here are pingpong latencies, in &#206;&#188;sec,
</span><br>
...
<span class="quotelev1">&gt;                             OMPI 0.74 0.84 &#206;&#188;sec
</span><br>
...
<span class="quotelev1">&gt;                             &#206;&#188;sec) for the np=40 case as a function of
</span><br>
...
<span class="quotelev1">&gt;                                   flat. This can represent a 10&#195;&#151; or
</span><br>
...
<span class="quotelev1">&gt;                                   a 2&#195;&#151; improvement in shared-memory
</span><br>
...
<span class="quotelev1">&gt;                                   optimizations provided a nearly 2&#195;&#151;
</span><br>
...
<span class="quotelev1">&gt;                                   rises to about 10-20 &#206;&#188;sec. So,
</span><br>
...
<span class="quotelev1">&gt;                                   &#206;&#188;secs for a performance measurement
</span><br>
