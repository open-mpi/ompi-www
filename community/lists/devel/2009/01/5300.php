...
<!-- id="692B042C-CB13-4526-924A-2D98D32087FE_at_eecs.utk.edu" -->
<!-- charset="US-ASCII" -->
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5301.php">George Bosilca: "Re: [OMPI devel] Open-MX vs OMPI 1.3 using MX internal symbols"</a>
<li><strong>Previous message:</strong> <a href="5299.php">doriankrause: "[OMPI devel] segfault in opal_free_list_grow"</a>
<li><strong>In reply to:</strong> <a href="5298.php">Brice Goglin: "[OMPI devel] Open-MX vs OMPI 1.3 using MX internal symbols"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5306.php">Jeff Squyres: "Re: [OMPI devel] Open-MX vs OMPI 1.3 using MX internal symbols"</a>
<li><strong>Reply:</strong> <a href="5306.php">Jeff Squyres: "Re: [OMPI devel] Open-MX vs OMPI 1.3 using MX internal symbols"</a>
<li><strong>Reply:</strong> <a href="5309.php">Brice Goglin: "Re: [OMPI devel] Open-MX vs OMPI 1.3 using MX internal	symbols"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
