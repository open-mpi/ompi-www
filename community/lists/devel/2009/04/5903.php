<?
$subject_val = "[OMPI devel] Fwd: Purify found bugs inside open-mpi library";
include("../../include/msg-header.inc");
?>
<!-- received="Wed Apr 29 13:21:14 2009" -->
<!-- isoreceived="20090429172114" -->
<!-- sent="Wed, 29 Apr 2009 13:21:07 -0400" -->
<!-- isosent="20090429172107" -->
<!-- name="Brian Blank" -->
<!-- email="brianblank_at_[hidden]" -->
<!-- subject="[OMPI devel] Fwd: Purify found bugs inside open-mpi library" -->
<!-- id="b10b717f0904291021t2c2211baqd1c548e466eeb40c_at_mail.gmail.com" -->
<!-- charset="US-ASCII" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Fwd: Purify found bugs inside open-mpi library<br>
<strong>From:</strong> Brian Blank (<em>brianblank_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-04-29 13:21:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5904.php">Jerry Ye: "[OMPI devel] OpenMPI without RSH"</a>
<li><strong>Previous message:</strong> <a href="5902.php">Jeff Squyres: "Re: [OMPI devel] r21096"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5910.php">Jeff Squyres: "Re: [OMPI devel] Fwd: Purify found bugs inside open-mpi library"</a>
<li><strong>Reply:</strong> <a href="5910.php">Jeff Squyres: "Re: [OMPI devel] Fwd: Purify found bugs inside open-mpi library"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I originally sent this to the users list, but realizing now that this might
<br>
...
Brian
<br>
<p><p><p><p>On Tue, Apr 28, 2009 at 9:58 PM, Brian Blank &lt;brianblank_at_[hidden]&gt; wrote:
<br>
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-5903/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/x-chdr attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-5903/datatype_pack.h">datatype_pack.h</a>
</ul>
<!-- attachment="datatype_pack.h" -->
<hr>
<ul>
<li>text/x-chdr attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-5903/datatype_unpack.h">datatype_unpack.h</a>
</ul>
<!-- attachment="datatype_unpack.h" -->
<hr>
<ul>
<li>text/x-csrc attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-5903/test.c">test.c</a>
</ul>
<!-- attachment="test.c" -->
<!-- body="end" -->
<hr>
