...
?>
<!-- received="Mon Dec 14 14:58:53 2009" -->
<!-- isoreceived="20091214195853" -->
<!-- sent="Mon, 14 Dec 2009 14:57:43 -0500" -->
<!-- isosent="20091214195743" -->
<!-- name="Terry Dontje" -->
<!-- email="Terry.Dontje_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] SEGFAULT in mpi_init from paffinity with intel 11.1.059 compiler" -->
<!-- id="4B2698B7.50305_at_sun.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2009-12-14 14:57:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7231.php">Jeff Squyres: "[OMPI devel] carto vs. hwloc"</a>
<li><strong>Previous message:</strong> <a href="7229.php">Ralph Castain: "Re: [OMPI devel] SEGFAULT in mpi_init from paffinity with intel 11.1.059 compiler"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7251.php">Daan van Rossum: "Re: [OMPI devel] SEGFAULT in mpi_init from paffinity with intel 11.1.059 compiler"</a>
<li><strong>Reply:</strong> <a href="7251.php">Daan van Rossum: "Re: [OMPI devel] SEGFAULT in mpi_init from paffinity with intel 11.1.059 compiler"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>It might be interesting to see if using certain optimization levels with 
<br>
the Intel 11.1 compiler produces a working OMPI library.
<br>
<p>--td
<br>
<p>Daan van Rossum wrote:
<br>
