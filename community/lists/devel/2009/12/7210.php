<?
$subject_val = "[OMPI devel] Open MPI v1.4 release: explanation";
...
<!-- subject="[OMPI devel] Open MPI v1.4 release: explanation" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Open MPI v1.4 release: explanation<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-12-08 17:29:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7211.php">Ashley Pittman: "Re: [OMPI devel] [patch] Verifying the message queue DLL build"</a>
<li><strong>Previous message:</strong> <a href="7209.php">Jeff Squyres: "Re: [OMPI devel] Crash when using MPI_REAL8"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
