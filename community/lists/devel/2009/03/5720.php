<?
$subject_val = "[OMPI devel] Critical bug notice";
...
<!-- subject="[OMPI devel] Critical bug notice" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Critical bug notice<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-03-27 14:34:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5721.php">Shaun Jackman: "Re: [OMPI devel] Bug in MPI_Request_get_status (1.3.1) [PATCH]"</a>
<li><strong>Previous message:</strong> <a href="5719.php">George Bosilca: "Re: [OMPI devel] Bug in MPI_Request_get_status (1.3.1) [PATCH]"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5723.php">Brad Benton: "[OMPI devel] Fwd: [Open MPI Announce] Critical bug notice"</a>
<li><strong>Reply:</strong> <a href="5723.php">Brad Benton: "[OMPI devel] Fwd: [Open MPI Announce] Critical bug notice"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
