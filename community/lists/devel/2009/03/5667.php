<?
$subject_val = "[OMPI devel] Open MPI v1.3.1 released";
...
<!-- subject="[OMPI devel] Open MPI v1.3.1 released" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Open MPI v1.3.1 released<br>
<strong>From:</strong> Ralph Castain (<em>rhc_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-03-19 09:37:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5668.php">Kees Verstoep: "[OMPI devel] opal_util_register_stackhandlers()"</a>
<li><strong>Previous message:</strong> <a href="5666.php">Brad Benton: "Re: [OMPI devel] 1.3.1rc5"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
