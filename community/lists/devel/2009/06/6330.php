...
?>
<!-- received="Wed Jun 24 16:15:43 2009" -->
<!-- isoreceived="20090624201543" -->
<!-- sent="Wed, 24 Jun 2009 14:15:37 -0600" -->
<!-- isosent="20090624201537" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI svn] svn:open-mpi r21513" -->
<!-- id="71d2d8cc0906241315m2a58d604ne4dc6d023e9523bf_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="200906241951.n5OJprDd001650_at_sourcehaven.osl.iu.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-06-24 16:15:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6331.php">Jeff Squyres: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r21513"</a>
<li><strong>Previous message:</strong> <a href="6329.php">Eugene Loh: "Re: [OMPI devel] trac ticket 1944 and pending sends"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6331.php">Jeff Squyres: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r21513"</a>
<li><strong>Reply:</strong> <a href="6331.php">Jeff Squyres: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r21513"</a>
<li><strong>Reply:</strong> <a href="6334.php">George Bosilca: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r21513"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Yo George
<br>
<p>This commit is going to break non-rsh launchers. While it is true that the
<br>
...
<br>
<p>This is why we specifically put the inclusion of multi-word options in the
<br>
...
Ralph
<br>
<p><p>On Wed, Jun 24, 2009 at 1:51 PM, &lt;bosilca_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; When we get a report from an orted about its state, don't use the sender of
</span><br>
<span class="quotelev1">&gt; the message to update the structures, but instead use the information from
</span><br>
<span class="quotelev1">&gt; the URI. The reason is that even the launch report messages can get routed.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; +++ trunk/orte/mca/plm/base/plm_base_launch_support.c   2009-06-24 15:51:52
</span><br>
<span class="quotelev1">&gt; EDT (Wed, 24 Jun 2009)
</span><br>
...
<span class="quotelev1">&gt; -                         &quot;%s plm:base:orted_report_launch from daemon %s&quot;,
</span><br>
...
<span class="quotelev1">&gt;     if (ORTE_SUCCESS != (rc = opal_dss.unpack(buffer, &amp;rml_uri, &amp;idx,
</span><br>
<span class="quotelev1">&gt; OPAL_STRING))) {
</span><br>
...
<span class="quotelev1">&gt; -                         &quot;%s plm:base:orted_report_launch %s for daemon %s
</span><br>
<span class="quotelev1">&gt; at contact %s&quot;,
</span><br>
<span class="quotelev1">&gt; +                         &quot;%s plm:base:orted_report_launch %s for daemon %s
</span><br>
<span class="quotelev1">&gt; (via %s) at contact %s&quot;,
</span><br>
<span class="quotelev1">&gt;                          ORTE_NAME_PRINT(ORTE_PROC_MY_NAME),
</span><br>
...
<span class="quotelev1">&gt; -            /* if the specified option is more than one word, we don't
</span><br>
<span class="quotelev1">&gt; -             * have a generic way of passing it as some environments
</span><br>
<span class="quotelev1">&gt; ignore
</span><br>
<span class="quotelev1">&gt; -             * any quotes we add, while others don't - so we ignore any
</span><br>
<span class="quotelev1">&gt; -             * such options. In most cases, this won't be a problem as
</span><br>
<span class="quotelev1">&gt; -             * they typically only apply to things of interest to the HNP.
</span><br>
<span class="quotelev1">&gt; -             * Individual environments can add these back into the cmd
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-6330/attachment">attachment</a>
</ul>
