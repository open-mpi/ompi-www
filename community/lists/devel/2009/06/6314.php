...
?>
<!-- received="Tue Jun 23 19:17:16 2009" -->
<!-- isoreceived="20090623231716" -->
<!-- sent="Tue, 23 Jun 2009 17:17:02 -0600" -->
<!-- isosent="20090623231702" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI svn] svn:open-mpi r21504" -->
<!-- id="FCB1F1C9-CD82-4CA0-8A33-3E6AD1D8AC30_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2009-06-23 19:17:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6315.php">Ralph Castain: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r21504"</a>
<li><strong>Previous message:</strong> <a href="6313.php">Ralph Castain: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r21504"</a>
<li><strong>Maybe in reply to:</strong> <a href="6313.php">Ralph Castain: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r21504"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6347.php">Iain Bason: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r21504"</a>
<li><strong>Reply:</strong> <a href="6347.php">Iain Bason: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r21504"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Jun 23, 2009, at 4:10 PM, bosilca_at_[hidden] wrote:
<br>
<p><span class="quotelev1">&gt; The solution is to add a new option to the children orte_parent_uri,  
</span><br>
...
<p><p>This is now accomplished whenever you use the regex launch, without  
<br>
adding a new uri. The orteds are now able to build a complete picture  
<br>
of the routing tree and the job at startup, without needing a  
<br>
handshake with the HNP. This lets them launch their procs much faster,  
<br>
and avoid the issues you encountered.
<br>
<p>Again, you might want to look at what has been committed over the last  
<br>
few days - could simplify what you are doing.
<br>
...
<p>Not any more, when using regex - the only message that comes back is  
<br>
...
<br>
<p>Next in the plan (once this is fully debugged) is to convert the proc  
<br>
started reporting into another &quot;one-sided&quot; collective like we now do  
<br>
at orted termination...
<br>
<p><p><span class="quotelev1">&gt;
</span><br>
