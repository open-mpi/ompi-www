...
?>
<!-- received="Mon Jun  8 06:58:08 2009" -->
<!-- isoreceived="20090608105808" -->
<!-- sent="Mon, 8 Jun 2009 12:57:54 +0200 (CEST)" -->
<!-- isosent="20090608105754" -->
<!-- name="Sylvain Jeaugey" -->
<!-- email="sylvain.jeaugey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] problem in the ORTE notifier framework" -->
<!-- id="alpine.DEB.2.00.0905271412200.4598_at_jeaugeys.frec.bull.fr" -->
<!-- charset="ISO-8859-15" -->
...
<strong>Date:</strong> 2009-06-08 06:57:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6188.php">Ralph Castain: "Re: [OMPI devel] problem in the ORTE notifier framework"</a>
<li><strong>Previous message:</strong> <a href="6186.php">Sylvain Jeaugey: "Re: [OMPI devel] Multi-rail on openib"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/devel/2009/05/6105.php">Ralph Castain: "Re: [OMPI devel] problem in the ORTE notifier framework"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6188.php">Ralph Castain: "Re: [OMPI devel] problem in the ORTE notifier framework"</a>
<li><strong>Reply:</strong> <a href="6188.php">Ralph Castain: "Re: [OMPI devel] problem in the ORTE notifier framework"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>Sorry for answering on this old thread, but it seems that my answer was 
<br>
blocked in the &quot;postponed&quot; folder.
<br>
<p>About the if-then, I thought it was 1 cycle. I mean, if you don't break 
<br>
...
<br>
<p>So, in these if-then cases where we know which branch is the more likely 
<br>
to be used, I don't think that 1 CPU cycle is really a problem, especially 
<br>
if we are already in a slow code path.
<br>
<p>Is there a multi-compiler,multi-arch,multi-os reason not to use likely() 
<br>
directives ?
<br>
<p>Sylvain
