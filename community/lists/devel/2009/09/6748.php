...
?>
<!-- received="Wed Sep  2 14:04:58 2009" -->
<!-- isoreceived="20090902180458" -->
<!-- sent="Wed, 2 Sep 2009 12:04:42 -0600" -->
<!-- isosent="20090902180442" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] XML request" -->
<!-- id="83C9984F-E419-4744-AA33-9E4B33D6FF10_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2009-09-02 14:04:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6749.php">Ralph Castain: "[OMPI devel] Failed datatype test"</a>
<li><strong>Previous message:</strong> <a href="6747.php">Lisandro Dalcin: "[OMPI devel] more bug/comments for current trunk"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6806.php">Greg Watson: "Re: [OMPI devel] XML request"</a>
<li><strong>Reply:</strong> <a href="6806.php">Greg Watson: "Re: [OMPI devel] XML request"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Okay Greg - give r21930 a whirl. It takes a new cmd line arg -xml-file  
<br>
foo as discussed below.
<br>
<p>You can also specify it as an MCA param: -mca orte_xml_file foo, or  
<br>
