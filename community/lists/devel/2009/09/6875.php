...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6876.php">Chris Samuel: "Re: [OMPI devel] application hangs with multiple dup"</a>
<li><strong>Previous message:</strong> <a href="6874.php">Pallab Datta: "Re: [OMPI devel] [OMPI users] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless"</a>
<li><strong>Maybe in reply to:</strong> <a href="6873.php">Pallab Datta: "Re: [OMPI devel] [OMPI users] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
