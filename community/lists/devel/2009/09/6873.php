...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6874.php">Pallab Datta: "Re: [OMPI devel] [OMPI users] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless"</a>
<li><strong>Previous message:</strong> <a href="6872.php">Jeff Squyres: "[OMPI devel] coll sm ramifications"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6874.php">Pallab Datta: "Re: [OMPI devel] [OMPI users] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless"</a>
<li><strong>Reply:</strong> <a href="6874.php">Pallab Datta: "Re: [OMPI devel] [OMPI users] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless"</a>
<li><strong>Maybe reply:</strong> <a href="6875.php">Pallab Datta: "Re: [OMPI devel] [OMPI users] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
