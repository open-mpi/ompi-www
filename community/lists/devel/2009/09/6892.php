...
?>
<!-- received="Fri Sep 25 02:03:25 2009" -->
<!-- isoreceived="20090925060325" -->
<!-- sent="Fri, 25 Sep 2009 00:03:13 -0600" -->
<!-- isosent="20090925060313" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] bug?" -->
<!-- id="2280732C-FD52-42EA-A52D-B6852011F760_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2009-09-25 02:03:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6893.php">Eugene Loh: "Re: [OMPI devel] bug?"</a>
<li><strong>Previous message:</strong> <a href="6891.php">Ralph Castain: "Re: [OMPI devel] bug?"</a>
<li><strong>In reply to:</strong> <a href="6890.php">Eugene Loh: "Re: [OMPI devel] bug?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6893.php">Eugene Loh: "Re: [OMPI devel] bug?"</a>
<li><strong>Reply:</strong> <a href="6893.php">Eugene Loh: "Re: [OMPI devel] bug?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
What the cmd
<br>
<p>mpirun -n 2 -slot-list 1,3 foo
<br>
<p>appears to do is cause us to launch a 2-process job consisting of  
<br>
vpid=1 and vpid=3, as opposed to the normal vpid=0 and 1.
<br>
<p>Not only is ORTE not prepared to handle this scenario, I believe it  
<br>
will cause problems in some areas within OMPI.
<br>
<p>I can try to make it fail nicer - someone with more knowledge of the  
<br>
