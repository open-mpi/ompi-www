...
?>
<!-- received="Sun Aug  2 18:20:09 2009" -->
<!-- isoreceived="20090802222009" -->
<!-- sent="Sun, 2 Aug 2009 16:19:56 -0600" -->
<!-- isosent="20090802221956" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Device failover on ob1" -->
<!-- id="FBADE741-D12C-490A-BFC2-A07F1AD84358_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="C69B7C6F.3A2BC%rlgraham_at_ornl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-08-02 18:19:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6552.php">Graham, Richard L.: "Re: [OMPI devel] Device failover on ob1"</a>
<li><strong>Previous message:</strong> <a href="6550.php">Graham, Richard L.: "Re: [OMPI devel] Device failover on ob1"</a>
<li><strong>In reply to:</strong> <a href="6550.php">Graham, Richard L.: "Re: [OMPI devel] Device failover on ob1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6552.php">Graham, Richard L.: "Re: [OMPI devel] Device failover on ob1"</a>
<li><strong>Reply:</strong> <a href="6552.php">Graham, Richard L.: "Re: [OMPI devel] Device failover on ob1"</a>
<li><strong>Reply:</strong> <a href="6561.php">Brian W. Barrett: "Re: [OMPI devel] Device failover on ob1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
