<?
$subject_val = "[OMPI devel] Error: system limit exceeded on number of pipes that can be open";
include("../../include/msg-header.inc");
?>
<!-- received="Tue Aug 11 12:29:42 2009" -->
<!-- isoreceived="20090811162942" -->
<!-- sent="Tue, 11 Aug 2009 19:29:37 +0300" -->
<!-- isosent="20090811162937" -->
<!-- name="Mike Dubman" -->
<!-- email="mike.ompi_at_[hidden]" -->
<!-- subject="[OMPI devel] Error: system limit exceeded on number of pipes that can be open" -->
<!-- id="b20b52800908110929s56ba85b1xcbb66bbf88a46b0e_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="b20b52800908110633o36e11140r6997da68b8d4ba18_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Error: system limit exceeded on number of pipes that can be open<br>
<strong>From:</strong> Mike Dubman (<em>mike.ompi_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-08-11 12:29:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6616.php">Eugene Loh: "Re: [OMPI devel] Error: system limit exceeded on number of pipes that	can be open"</a>
<li><strong>Previous message:</strong> <a href="6614.php">Jeff Squyres: "Re: [OMPI devel] sm_coll segv"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6616.php">Eugene Loh: "Re: [OMPI devel] Error: system limit exceeded on number of pipes that	can be open"</a>
<li><strong>Reply:</strong> <a href="6616.php">Eugene Loh: "Re: [OMPI devel] Error: system limit exceeded on number of pipes that	can be open"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><p><p>Do you know what OS params should be changed in order to resolve it?
<br>
<p>Thanks
<br>
<p>Mike
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-6615/attachment">attachment</a>
</ul>
