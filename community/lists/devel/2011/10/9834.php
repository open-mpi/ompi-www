...
?>
<!-- received="Tue Oct 18 06:24:37 2011" -->
<!-- isoreceived="20111018102437" -->
<!-- sent="Tue, 18 Oct 2011 06:24:32 -0400" -->
<!-- isosent="20111018102432" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI bugs] [Open MPI] #2888: base.h inclusion breaks Solaris build" -->
<!-- id="B6A5B106-DC73-49A1-A262-B8989467F0FA_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-10-18 06:24:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9835.php">TERRY DONTJE: "Re: [OMPI devel] [OMPI bugs] [Open MPI] #2888: base.h inclusion breaks Solaris build"</a>
<li><strong>Previous message:</strong> <a href="9833.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI bugs] [Open MPI] #2888: base.h inclusion breaks Solaris build"</a>
<li><strong>Maybe in reply to:</strong> <a href="9833.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI bugs] [Open MPI] #2888: base.h inclusion breaks Solaris build"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9836.php">TERRY DONTJE: "Re: [OMPI devel] [OMPI bugs] [Open MPI] #2888: base.h inclusion breaks Solaris build"</a>
<li><strong>Reply:</strong> <a href="9836.php">TERRY DONTJE: "Re: [OMPI devel] [OMPI bugs] [Open MPI] #2888: base.h inclusion breaks Solaris build"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
