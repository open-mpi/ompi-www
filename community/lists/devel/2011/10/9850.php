...
?>
<!-- received="Wed Oct 19 13:32:38 2011" -->
<!-- isoreceived="20111019173238" -->
<!-- sent="Wed, 19 Oct 2011 11:32:27 -0600" -->
<!-- isosent="20111019173227" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI svn] svn:open-mpi r25323" -->
<!-- id="80E8C26F-0C64-4969-8F24-B12E642AE047_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-10-19 13:32:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9851.php">Jeff Squyres: "Re: [OMPI devel] make check fails for Intel 2011.6.233 (OpenMPI 1.4.3)"</a>
<li><strong>Previous message:</strong> <a href="9849.php">George Bosilca: "Re: [OMPI devel] [OMPI svn-full] svn:open-mpi r25323"</a>
<li><strong>Maybe in reply to:</strong> <a href="9843.php">Ralph Castain: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r25323"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9852.php">Barrett, Brian W: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r25323"</a>
<li><strong>Reply:</strong> <a href="9852.php">Barrett, Brian W: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r25323"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I've been wrestling with something from this commit, and I'm unsure of the right answer. So please consider this a general design question for the community.
<br>
<p>This commit removes all the OMPI &lt;-&gt; ORTE equivalent constants - i.e., we used to declare OMPI-prefixed equivalents to every ORTE-prefixed constant. I understand the thinking (or at least, what I suspect was the thought), but it creates an issue.
<br>
<p>Suppose I have an ompi-level function (A) that calls another ompi-level function (B). Invisible to A is that B calls an orte-level function. B dutifully checks the error return from the orte-level function against an ORTE-prefixed constant.
<br>
<p>However, if that return isn't &quot;success&quot;, what does B return up to A? It cannot return the OMPI equivalent to the orte error constant because it no longer exists. It could return the orte error code, but A has no way of knowing it is going to get a non-OMPI constant, and therefore won't be able to understand it - it will be an &quot;unrecognized error&quot;.
<br>
<p>I guess one option is to require that B &quot;translate&quot; the return code and pass some OMPI error up the chain, but this prevents anything upwards from understanding the nature of the problem and potentially taking corrective and/or alternative action. Seems awfully limiting, as most of the time the only option will be the vanilla &quot;OMPI_ERROR&quot;.
<br>
<p>Thoughts?
<br>
