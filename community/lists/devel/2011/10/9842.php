...
?>
<!-- received="Wed Oct 19 08:24:39 2011" -->
<!-- isoreceived="20111019122439" -->
<!-- sent="Wed, 19 Oct 2011 08:24:34 -0400" -->
<!-- isosent="20111019122434" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] make check fails for Intel 2011.6.233 (OpenMPI 1.4.3)" -->
<!-- id="FF2B7EA6-A5E4-429F-B80F-A3D2F266421A_at_eecs.utk.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="C06591CF-0513-41A5-8232-BBE1BE691BCF_at_usgs.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-10-19 08:24:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9843.php">Ralph Castain: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r25323"</a>
<li><strong>Previous message:</strong> <a href="9841.php">Larry Baker: "Re: [OMPI devel] make check fails for Intel 2011.6.233 (OpenMPI 1.4.3)"</a>
<li><strong>In reply to:</strong> <a href="9841.php">Larry Baker: "Re: [OMPI devel] make check fails for Intel 2011.6.233 (OpenMPI 1.4.3)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9851.php">Jeff Squyres: "Re: [OMPI devel] make check fails for Intel 2011.6.233 (OpenMPI 1.4.3)"</a>
<li><strong>Reply:</strong> <a href="9851.php">Jeff Squyres: "Re: [OMPI devel] make check fails for Intel 2011.6.233 (OpenMPI 1.4.3)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Thanks Larry,
<br>
<p>Will forward this info upstream.
<br>
<p>&nbsp;&nbsp;george.
<br>
<p>On Oct 18, 2011, at 21:56 , Larry Baker wrote:
<br>
<p><span class="quotelev1">&gt; George,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Thanks for the update.  FYI, here's all the version numbers reported by the compiler releases I have installed:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module load compilers/intel/11.1.080
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ icc -v
</span><br>
<span class="quotelev2">&gt;&gt; Version 11.1 
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module unload compilers/intel/11.1.080
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module load compilers/intel/2011.3.174
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ icc -v
</span><br>
<span class="quotelev2">&gt;&gt; Version 12.0.3
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module unload compilers/intel/2011.3.174
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module load compilers/intel/2011.4.191
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ icc -v
</span><br>
<span class="quotelev2">&gt;&gt; Version 12.0.4
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module unload compilers/intel/2011.4.191
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module load compilers/intel/2011.5.220
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ icc -v
</span><br>
<span class="quotelev2">&gt;&gt; Version 12.0.5
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module unload compilers/intel/2011.5.220
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module load compilers/intel/2011.6.233
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ icc -v
</span><br>
<span class="quotelev2">&gt;&gt; icc version 12.1.0 (gcc version 4.1.2 compatibility)
</span><br>
<span class="quotelev2">&gt;&gt; [baker_at_hydra ~]$ module unload compilers/intel/2011.6.233
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Another problem I found with the Intel 12.1.0 compiler: I started to look at adding a test for the Intel compiler version around the #pragma that disables optimization for OpenMPI and I found the __ICC and __INTEL_COMPILER predefined macros (compiler version no.) are not properly defined:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; $ icc -E -dD hello.c | grep __INTEL_COMPILER
</span><br>
...
<span class="quotelev1">&gt; $ icc -E -dD hello.c | grep __ICC           
</span><br>
...
<span class="quotelev1">&gt; I do not know if there is code in OpenMPI that looks at __ICC and __INTEL_COMPILER, but that could cause problems.  (Pass this on upstream to the libtool people?)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-9842/attachment">attachment</a>
</ul>
