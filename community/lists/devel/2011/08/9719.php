...
?>
<!-- received="Mon Aug 29 12:12:21 2011" -->
<!-- isoreceived="20110829161221" -->
<!-- sent="Mon, 29 Aug 2011 10:12:13 -0600" -->
<!-- isosent="20110829161213" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] known limitation or bug in hwloc?" -->
<!-- id="D23EBEC2-5146-451C-A0FA-C066E7660D27_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="OF3E513564.C68A280C-ONC12578FB.00582689-C12578FB.0058ADAC_at_bull.net" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-08-29 12:12:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9720.php">Kenneth Lloyd: "Re: [OMPI devel] known limitation or bug in hwloc?"</a>
<li><strong>Previous message:</strong> <a href="9718.php">nadia.derbey_at_[hidden]: "Re: [OMPI devel] known limitation or bug in hwloc?"</a>
<li><strong>In reply to:</strong> <a href="9718.php">nadia.derbey_at_[hidden]: "Re: [OMPI devel] known limitation or bug in hwloc?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9724.php">nadia.derbey_at_[hidden]: "Re: [OMPI devel] known limitation or bug in hwloc?"</a>
<li><strong>Reply:</strong> <a href="9724.php">nadia.derbey_at_[hidden]: "Re: [OMPI devel] known limitation or bug in hwloc?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; devel-bounces_at_[hidden] wrote on 08/29/2011 05:57:59 PM:
</span><br>
...
<span class="quotelev2">&gt; &gt; Date : 08/29/2011 05:58 PM 
</span><br>
...
<span class="quotelev2">&gt; &gt; But I'm afraid the fix won't be trivial at all: hwloc in itself is 
</span><br>
<span class="quotelev2">&gt; &gt; coherent: it loops overs NUM_BITS, but it uses masks that are 
</span><br>
<span class="quotelev2">&gt; &gt; NUM_BITS wide (hwloc_bitmap_t set)... 
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; I guess I'm missing that - I just did a search and cannot find any 
</span><br>
<span class="quotelev2">&gt; &gt; reference to OPAL_PAFFINITY_BITMASK_T_NUM_BITS anywhere in 
</span><br>
<span class="quotelev2">&gt; &gt; paffinity/hwloc after the last change. 
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; Can you point me to where you believe a problem exists? Or feel free
</span><br>
<span class="quotelev2">&gt; &gt; to submit a patch to fix it :-)  We can push it upstream to the 
</span><br>
<span class="quotelev2">&gt; &gt; hwloc folks for their consideration. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; file: opal/mca/paffinity/hwloc/paffinity_hwloc_module.c 
</span><br>
<span class="quotelev1">&gt; routine: module_set() 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; You hae a reference to OPAL_PAFFINITY_BITMASK_T_NUM_BITS both in the trunk and in v1.5 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; But may be this issue has been fixed already? 
</span><br>
<p>I fixed it in the trunk (r25102) per this thread and filed a CMR to move it to v1.5. You should be copied on the CMR ticket.
<br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt;&gt; Interesting. I haven't tried pushing this to levels above 8 on 
</span><br>
<span class="quotelev2">&gt; &gt; a particular
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-9719/attachment">attachment</a>
</ul>
