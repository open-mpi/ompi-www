...
?>
<!-- received="Sat Jul  9 09:29:09 2011" -->
<!-- isoreceived="20110709132909" -->
<!-- sent="Sat, 9 Jul 2011 07:28:59 -0600" -->
<!-- isosent="20110709132859" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] opal_init/finalize counter --&amp;gt; boolean" -->
<!-- id="7DF02B28-94C0-4A07-B1A0-F52C8880B277_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-07-09 09:28:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9492.php">Jeff Squyres: "Re: [OMPI devel] Tarball distribution"</a>
<li><strong>Previous message:</strong> <a href="9490.php">Jeff Squyres: "Re: [OMPI devel] opal_init/finalize counter --&gt; boolean"</a>
<li><strong>In reply to:</strong> <a href="9490.php">Jeff Squyres: "Re: [OMPI devel] opal_init/finalize counter --&gt; boolean"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9493.php">George Bosilca: "Re: [OMPI devel] opal_init/finalize counter --&gt; boolean"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Works for me :-)
<br>
<p>On Jul 9, 2011, at 5:43 AM, Jeff Squyres wrote:
<br>
...
<span class="quotelev1">&gt; - Take what is (essentially) in opal_init() today and rename it to be opal_init_frameworks() -- because it's (mostly) initializing the OPAL MCA frameworks.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; If we ever want to use OPAL utility behavior after orte_finalize() someday, we can.  E.g., we can pass a flag to orte_finalize() saying &quot;use opal_finalize_frameworks() instead of opal_finalize()&quot;, or perhaps even &quot;don't finalize OPAL at all.&quot;
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
