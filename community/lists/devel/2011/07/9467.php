...
?>
<!-- received="Mon Jul  4 07:40:30 2011" -->
<!-- isoreceived="20110704114030" -->
<!-- sent="Mon, 4 Jul 2011 07:40:25 -0400" -->
<!-- isosent="20110704114025" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] TIPC BTL Segmentation fault" -->
<!-- id="895E544C-4C49-443F-A8DF-F89647735CD7_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4E1182F2.1080106_at_ericsson.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-07-04 07:40:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9468.php">Jeff Squyres: "Re: [OMPI devel] &quot;Open MPI&quot;-based MPI library used by K computer"</a>
<li><strong>Previous message:</strong> <a href="9466.php">Xin He: "Re: [OMPI devel] TIPC BTL Segmentation fault"</a>
<li><strong>In reply to:</strong> <a href="9466.php">Xin He: "Re: [OMPI devel] TIPC BTL Segmentation fault"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9469.php">Xin He: "Re: [OMPI devel] TIPC BTL Segmentation fault"</a>
<li><strong>Reply:</strong> <a href="9469.php">Xin He: "Re: [OMPI devel] TIPC BTL Segmentation fault"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>If you run this through valgrind, does anything obvious show up?  I ask because this kind of error is typically a symptom of the real error.  I.e., the real error was some kind of memory corruption that occurred earlier, and this is the memory access that exposes that prior memory corruption.
<br>
<p><p>On Jul 4, 2011, at 5:08 AM, Xin He wrote:
<br>
<p><span class="quotelev1">&gt; Yes, it is a opal_object.
</span><br>
