...
?>
<!-- received="Wed Nov  2 13:23:43 2011" -->
<!-- isoreceived="20111102172343" -->
<!-- sent="Wed, 2 Nov 2011 13:23:40 -0400" -->
<!-- isosent="20111102172340" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: MCA param registration errors" -->
<!-- id="973778BA-0195-4E47-8CD6-193A4BF9F7D2_at_eecs.utk.edu" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="4EB11AC0.4010605_at_oracle.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-11-02 13:23:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9887.php">Jeff Squyres: "Re: [OMPI devel] RFC: MCA param registration errors"</a>
<li><strong>Previous message:</strong> <a href="9885.php">TERRY DONTJE: "Re: [OMPI devel] RFC: MCA param registration errors"</a>
<li><strong>In reply to:</strong> <a href="9885.php">TERRY DONTJE: "Re: [OMPI devel] RFC: MCA param registration errors"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9887.php">Jeff Squyres: "Re: [OMPI devel] RFC: MCA param registration errors"</a>
<li><strong>Reply:</strong> <a href="9887.php">Jeff Squyres: "Re: [OMPI devel] RFC: MCA param registration errors"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>&nbsp;&nbsp;george.
<br>
<p>On Nov 2, 2011, at 06:26 , TERRY DONTJE wrote:
<br>
...
<span class="quotelev2">&gt;&gt; So this was slightly different than the opinion that was discussed on the call today, which was 2.  The rationale for #2 was to punish developers, but if such a bug did make it through to production, users wouldn't be annoyed with show_help messages all the time.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt; I think a show_help + return is very helpful in this case.  I wouldn't think that we'd run into this case that much and it would seem that it would be a rare occurance that one could just fix when they run into it.  However, since there was some opposition to having show_help messages possibly coming up all over the place I thought a fall back of only doing the show_help on enable_debug builds was a reasonable middle ground.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Can you clarify -- I can parse your text multiple ways.  Which are you voting for?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 1. show_help + return error code in all cases.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 2. if OPAL_ENABLE_DEBUG, show_help + exit(1), else silently return error code.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 3. show_help.  if OPAL_ENABLE_DEBUG, exit(1), else return error code.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; This is a much saner solution. We [mostly] stayed away from calling exit deep into our libraries, there is no reason to add it now. I'll vote in favor of show_help + return code.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-9886/attachment">attachment</a>
</ul>
