...
?>
<!-- received="Thu Feb 10 10:50:45 2011" -->
<!-- isoreceived="20110210155045" -->
<!-- sent="Thu, 10 Feb 2011 07:50:48 -0800" -->
<!-- isosent="20110210155048" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Debugger problem with srun and openmpi 1.5 (hang in OMPI)" -->
<!-- id="09BB4B12-2E20-4D40-8DEC-AC8CFBB07044_at_cisco.com" -->
...
<strong>Date:</strong> 2011-02-10 10:50:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8974.php">Nikolay Piskun: "Re: [OMPI devel] Debugger problem with srun and openmpi 1.5 (hang	in OMPI)"</a>
<li><strong>Previous message:</strong> <a href="8972.php">Ralph Castain: "Re: [OMPI devel] Debugger problem with srun and openmpi 1.5 (hang in OMPI)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8974.php">Nikolay Piskun: "Re: [OMPI devel] Debugger problem with srun and openmpi 1.5 (hang	in OMPI)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Feb 10, 2011, at 7:46 AM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; If you srun a job, then there is no &quot;mpirun&quot; to provide a proc_table. So running a  job directly via srun means you cannot run TV on it.
</span><br>
