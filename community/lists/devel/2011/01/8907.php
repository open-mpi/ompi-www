...
?>
<!-- received="Thu Jan 20 15:21:20 2011" -->
<!-- isoreceived="20110120202120" -->
<!-- sent="Thu, 20 Jan 2011 15:21:14 -0500" -->
<!-- isosent="20110120202114" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: use ISO C99 style struct initialization" -->
<!-- id="C387C956-5142-459D-86B9-65B886A0684A_at_eecs.utk.edu" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-01-20 15:21:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8908.php">George Bosilca: "Re: [OMPI devel] RFC: use ISO C99 style struct initialization"</a>
<li><strong>Previous message:</strong> <a href="8906.php">Jeff Squyres: "Re: [OMPI devel] Building Open MPI components outside of the	sourcetree"</a>
<li><strong>In reply to:</strong> <a href="8902.php">Terry Dontje: "Re: [OMPI devel] RFC: use ISO C99 style struct initialization"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8908.php">George Bosilca: "Re: [OMPI devel] RFC: use ISO C99 style struct initialization"</a>
<li><strong>Reply:</strong> <a href="8908.php">George Bosilca: "Re: [OMPI devel] RFC: use ISO C99 style struct initialization"</a>
<li><strong>Reply:</strong> <a href="8909.php">Nathan Hjelm: "Re: [OMPI devel] RFC: use ISO C99 style struct initialization"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>../../../../../ompi/orte/mca/debugger/dummy/dummy_component.c:25: warning: ISO C90 forbids specifying subobject to initialize
<br>
...
<p><p><p>&nbsp;&nbsp;george.
<br>
<p><p><p><p>On Jan 19, 2011, at 20:36 , Terry Dontje wrote:
<br>
