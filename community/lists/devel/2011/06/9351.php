...
?>
<!-- received="Fri Jun 10 08:48:14 2011" -->
<!-- isoreceived="20110610124814" -->
<!-- sent="Fri, 10 Jun 2011 08:48:08 -0400" -->
<!-- isosent="20110610124808" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Fix missing code in MPI_Abort functionality" -->
<!-- id="BANLkTi=d_c8pYg+z2QwFneitZsR1QE5b8Q_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="93FEB0AE-FAE0-4995-A393-F9382AF7BE9F_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-06-10 08:48:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9352.php">Ralph Castain: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Previous message:</strong> <a href="9350.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>In reply to:</strong> <a href="9345.php">Ralph Castain: "Re: [OMPI devel] RFC: Fix missing code in MPI_Abort functionality"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9353.php">Ralph Castain: "Re: [OMPI devel] RFC: Fix missing code in MPI_Abort functionality"</a>
<li><strong>Reply:</strong> <a href="9353.php">Ralph Castain: "Re: [OMPI devel] RFC: Fix missing code in MPI_Abort functionality"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I guess I'm unclear about this concern since it should be a concern in
<br>
...
<br>
<p><p>Something that might help those listening to this thread. The current
<br>
...
--------------
<br>
<p>Semantically, this patch just makes the group actually being aborted
<br>
...
<p>-- Josh
<br>
<p><p>On Fri, Jun 10, 2011 at 7:30 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt; I have no issue with uncommenting the code. However, I do see a future littered with lots of zombied processes and complaints over poor cleanup again....
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Jun 9, 2011, at 6:08 PM, Joshua Hursey wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Ah I see what you are getting at now.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; The construction of the list of connected processes is something I, intentionally, did not modify from the current Open MPI code. The list is calculated based on the locally known set of local and remote process groups attached to the communicator. So this is the set of directly connected processes in the specified communicator known to the calling process at the OMPI level.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; ORTE is asked to abort this defined set of processes. Once those processes are terminated then ORTE needs to eventually inform all of the processes (in the jobid(s) specified - maybe other jobids too?) that these processes have failed/aborted. Upon notification of the failed/aborted processes the local process (at the OMPI level) needs to determine if that process loss is critical based upon the error handlers attached to communicators that it shares with the failed/aborted processes. &#160;That should be handled in the callback from the errmgr at the OMPI level, since connectedness is an MPI construct. If the process failure/abort is critical to the local process, then upon notification the local process can call abort on the communicator effected.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; So this has the possibility for a rolling abort effect [the abort of one communicator triggers the abort of another due to MPI_ERR_ARE_FATAL]. From which (depending upon the error handlers at the user level) the system will eventually converge to either some stable subset of process or all processes aborting resulting in job termination.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; The rolling abort effect relies heavily upon the ability of the runtime to make sure that all process failures/abort are eventually known to all alive processes. Since all alive processes will know of the failure/abort, it can then determine if they are transitively effected by the failure based upon the local list of communicators and associated error handlers. But to complete this aspect of the abort procedure, we do need the callback mechanism from the runtime - but since ORTE (today) will kill the job for OMPI then it is not a big deal for end users since the job will terminate anyway. Once we have the callback, then we can finish tightening up the OMPI layer code.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; It is not perfect, but I think it does address the transitive nature of the connectivity of MPI processes by relying on the runtime to provide uniform notification of failures. I figure that we will need to look over this code again and verify that the implementation of MPI_Comm_disconnect and associated underpinnings do the 'right thing' with regard to updating the communicator structures. But I think that is best addressed as a second set of patches.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; The goal of this patch is to put back in functionality that was commented out during the last reorganization of the errmgr. What will likely follow, once we have notification of failure/abort at the OMPI level, is a cleanup of the connected groups code paths.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; On Jun 9, 2011, at 16:59 , Josh Hursey wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Thu, Jun 9, 2011 at 4:47 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Open MPI does abort everything by default - decided by the runtime at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the moment (but addressed in your RFC). So it does not matter if one
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; process aborts or if many do. So the behavior of MPI_Abort experienced
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; by the user will not change. Effectively the only change is an extra
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; message in the runtime before the process actually calls
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; errmgr.abort().
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; This branch just makes the implementation complete by first telling
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ORTE that a group of processes, defined by the communicator, should be
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; terminated along with the calling process. Currently ORTE notices that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; there was an abort, and terminates the job. Once your RFC goes through
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; then this may no longer be the case, and OMPI can determine what to do
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; when it receives a process failure notification.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Currently, ORTE will abort them as well. When your RFC goes through
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; then the OMPI layer will be notified of the error and can take the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; appropriate action, as determined by the MPI standard.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; What about all the other connected processes (based on the connectivity as defined in the MPI standard in Section 10.5.4) ? Do they see this as a fault?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; They are informed of the fault via the ORTE errmgr callback routine
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (that we have an RFC for), and then can take the appropriate action
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; based on MPI semantics. So we are pushing the decision of the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; implication of the fault to the OMPI layer - where it should be.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The remainder of the OMPI layer logic for MPI_ERRORS_RETURN and other
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; connected error management scenarios is not included in this patch
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; since that depends on there being a callback to the OMPI layer - which
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; does not exist just yet. So a small patch to wire in the ORTE piece to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; allow the OMPI layer to request a set of processes to be terminated -
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; to more accurately support MPI_Abort semantics.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Does that answer your questions?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
