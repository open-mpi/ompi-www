...
?>
<!-- received="Tue Jun  7 14:37:19 2011" -->
<!-- isoreceived="20110607183719" -->
<!-- sent="Tue, 7 Jun 2011 12:37:13 -0600" -->
<!-- isosent="20110607183713" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Resilient ORTE" -->
<!-- id="BANLkTi=QkWmz+BXcdSNKijTOJeTiTzmHDg_at_mail.gmail.com" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="F1C8D5CA586F4DB58E1174B6CDC9F9A6_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-06-07 14:37:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9316.php">Ralph Castain: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Previous message:</strong> <a href="9314.php">George Bosilca: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>In reply to:</strong> <a href="9313.php">Wesley Bland: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9317.php">Wesley Bland: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Reply:</strong> <a href="9317.php">Wesley Bland: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
On Tue, Jun 7, 2011 at 10:35 AM, Wesley Bland &lt;wbland_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  On Tuesday, June 7, 2011 at 12:14 PM, Ralph Castain wrote:
</span><br>
...
<span class="quotelev1">&gt; On Tue, Jun 7, 2011 at 9:45 AM, Wesley Bland &lt;wbland_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  To adress your concerns about putting the epoch in the process name
</span><br>
...
<span class="quotelev1">&gt; Not really concerned - I was just noting we had done it a tad differently,
</span><br>
<span class="quotelev1">&gt; but nothing important.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; But the epoch is process-unique - i.e., it is the number of times that this
</span><br>
<span class="quotelev1">&gt; specific process has been started, which differs per proc since we don't
</span><br>
<span class="quotelev1">&gt; restart all the procs every time one fails. So if I look at the epoch of the
</span><br>
<span class="quotelev1">&gt; proc sending me a message, I really can't check it against my own value as
</span><br>
<span class="quotelev1">&gt; the comparison is meaningless. All I really can do is check to see if it
</span><br>
<span class="quotelev1">&gt; changed from the last time I heard from that proc, which would tell me that
</span><br>
<span class="quotelev1">&gt; the proc has been restarted in the interim.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; But that is the point of the epoch. It prevents communication with a failed
</span><br>
<span class="quotelev1">&gt; process. If the epoch. If the epoch is too low, you know you're
</span><br>
<span class="quotelev1">&gt; communicating with an old process and you need to drop the message. If it is
</span><br>
<span class="quotelev1">&gt; too high, you know that the process has been restarted and you need to
</span><br>
<span class="quotelev1">&gt; update your known epoch.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Maybe I'm misunderstanding what you're saying?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p>Perhaps it would help if you folks could provide a little explanation about
<br>
...
envisioned.
<br>
<p>I'm not sure how you can talk about an epoch being too high or too low,
<br>
...
<span class="quotelev1">&gt; This is also true for things like reporting failures. To prevent duplicate
</span><br>
...
<span class="quotelev1">&gt; I'm not sure of the relevance here. We handle this without problem right
</span><br>
<span class="quotelev1">&gt; now (at least, within orcm - haven't looked inside orte yet to see what
</span><br>
<span class="quotelev1">&gt; needs to be brought back, if anything) without an epoch - and the state
</span><br>
<span class="quotelev1">&gt; machine will resolve the remaining race conditions, which really don't
</span><br>
<span class="quotelev1">&gt; pertain to epoch anyway.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; An example here might be if a process fails and two other processes detect
</span><br>
<span class="quotelev1">&gt; it. By marking which version of the process failed, the HNP knows that it is
</span><br>
<span class="quotelev1">&gt; one failure detected by two processes rather than two failures being
</span><br>
<span class="quotelev1">&gt; detected in quick succession.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p>Are you then thinking that MPI processes are going to detect failure instead
<br>
...
sigchild??
<br>
<p>So right now the HNP can -never- receive more than one failure report at a
<br>
...
<br>
<p>Not the same issue as having MPI procs reporting failures...
<br>
...
<p>We aren't having any problems with process recovery and process state -
<br>
...
<br>
<p>Could you clarify why you are having a problem in this regard? Might help to
<br>
...
<span class="quotelev1">&gt; No argument - I don't mind having the value in the name. Makes no
</span><br>
<span class="quotelev1">&gt; difference to me.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  On Tuesday, June 7, 2011 at 11:21 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-9315/attachment">attachment</a>
</ul>
