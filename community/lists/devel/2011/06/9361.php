...
?>
<!-- received="Fri Jun 10 16:07:03 2011" -->
<!-- isoreceived="20110610200703" -->
<!-- sent="Fri, 10 Jun 2011 16:06:57 -0400" -->
<!-- isosent="20110610200657" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Resilient ORTE" -->
<!-- id="BANLkTikBSNkR1a3KDbn-1txqM8XkiY63gg_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="AF861B79-F4CE-48AD-8680-5EC7593D5E61_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-06-10 16:06:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9362.php">Ralph Castain: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Previous message:</strong> <a href="9360.php">Josh Hursey: "Re: [OMPI devel] RFC: Fortran support in Open MPI Extensions"</a>
<li><strong>In reply to:</strong> <a href="9359.php">Ralph Castain: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9362.php">Ralph Castain: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Reply:</strong> <a href="9362.php">Ralph Castain: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
the fatal action.
<br>
<p>As long as I can replace that callback, or selectively get rid of it
<br>
then I'm ok.
<br>
<p><p>On Fri, Jun 10, 2011 at 3:55 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Jun 10, 2011, at 6:32 AM, Josh Hursey wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Fri, Jun 10, 2011 at 7:37 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Jun 9, 2011, at 6:12 PM, Joshua Hursey wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jun 9, 2011, at 6:47 PM, George Bosilca wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Well, you're way to trusty. ;)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; It's the midwestern boy in me :)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Still need to shake that corn out of your head... :-)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; This is a fair point. I think hiding the ordering of callbacks in the errmgr could be dangerous since it takes control from the upper layers, but, conversely, trusting the upper layers to 'do the right thing' with the previous callback is probably too optimistic, esp. for layers that are not designed together.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To that I would suggest that you leave the code as is - registering a callback overwrites the existing callback. That will allow me to replace the default OMPI callback when I am able to in MPI_Init, and, if I need to, swap back in the default version at MPI_Finalize.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Does that sound like a reasonable way forward on this design point?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; It doesn't solve the problem that George alluded to - just because you overwrite the callback, it doesn't mean that someone else won't overwrite you when their component initializes. Only the last one wins - the rest of you lose.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm not sure how you guarantee that you win, which is why I'm unclear how this callback can really work unless everyone agrees that only one place gets it. Put that callback in a base function of a new error handling framework, and then let everyone create components within that for handling desired error responses?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Yep, that is a problem, but one that we can deal with in the immediate
</span><br>
<span class="quotelev2">&gt;&gt; case. Since OMPI is the only layer registering the callback, when I
</span><br>
<span class="quotelev2">&gt;&gt; replace it in OMPI I will have to make sure that no other place in
</span><br>
<span class="quotelev2">&gt;&gt; OMPI replaces the callback.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; If at some point we need more than one callback above ORTE then we may
</span><br>
<span class="quotelev2">&gt;&gt; want to revisit this point. But since we only have one layer on top of
</span><br>
<span class="quotelev2">&gt;&gt; ORTE, it is the responsibility of that layer to be internally
</span><br>
<span class="quotelev2">&gt;&gt; consistent with regard to which callback it wants to be triggered.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; If the layers above ORTE want more than one callback I would suggest
</span><br>
<span class="quotelev2">&gt;&gt; that that layer design some mechanism for coordinating these multiple
</span><br>
<span class="quotelev2">&gt;&gt; - possibly conflicting - callbacks (by the way this is policy
</span><br>
<span class="quotelev2">&gt;&gt; management, which can get complex fast as you add more interested
</span><br>
<span class="quotelev2">&gt;&gt; parties). Meaning that if OMPI wanted multiple callbacks to be active
</span><br>
<span class="quotelev2">&gt;&gt; at the same time, then OMPI would create a mechanism for managing
</span><br>
<span class="quotelev2">&gt;&gt; these callbacks, not ORTE. ORTE should just have one callback provided
</span><br>
<span class="quotelev2">&gt;&gt; to the upper layer, and keep it -simple-. If the upper layer wants to
</span><br>
<span class="quotelev2">&gt;&gt; toy around with something more complex it must manage the complexity
</span><br>
<span class="quotelev2">&gt;&gt; instead of artificially pushing it down to the ORTE layer.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I was thinking some more about this, and wonder if we aren't over-complicating the question.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Do you need to actually control the sequence of callbacks, or just ensure that your callback gets called prior to the default one that calls abort?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Meeting the latter requirement is trivial - subsequent calls to register_callback get pushed onto the top of the callback list. Since the default one always gets registered first (which we can ensure since it occurs in MPI_Init), it will always be at the bottom of the callback list and hence called last.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Keeping that list in ORTE is simple and probably the right place to do it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; However, if you truly want to control the callback order in detail - then yeah, that should go up in &#160;OMPI. I sure don't want to write all that code :-)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
