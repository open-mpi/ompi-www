...
?>
<!-- received="Fri Jun 10 08:56:40 2011" -->
<!-- isoreceived="20110610125640" -->
<!-- sent="Fri, 10 Jun 2011 06:56:30 -0600" -->
<!-- isosent="20110610125630" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Resilient ORTE" -->
<!-- id="EE4EA455-1FE2-4873-8F40-88FE2F6C0E82_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-06-10 08:56:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9355.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Previous message:</strong> <a href="9353.php">Ralph Castain: "Re: [OMPI devel] RFC: Fix missing code in MPI_Abort functionality"</a>
<li><strong>In reply to:</strong> <a href="9348.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9359.php">Ralph Castain: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>I agree - I was just proposing one way of doing that in the MPI layer so you wouldn't have to play policeman on the rest of the code base to ensure nobody else inserts a callback without realizing they overwrote yours. I can envision, for example, UTK wanting to do something different from you, and perhaps committing a callback that unintentionally overrode you.
<br>
<p>Up to you...just making a suggestion.
<br>
