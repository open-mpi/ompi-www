...
?>
<!-- received="Fri Jun 10 15:55:17 2011" -->
<!-- isoreceived="20110610195517" -->
<!-- sent="Fri, 10 Jun 2011 13:55:07 -0600" -->
<!-- isosent="20110610195507" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Resilient ORTE" -->
<!-- id="AF861B79-F4CE-48AD-8680-5EC7593D5E61_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="BANLkTimDK8ABCQNSJnos8LLnze=g0T4Y-Q_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-06-10 15:55:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9360.php">Josh Hursey: "Re: [OMPI devel] RFC: Fortran support in Open MPI Extensions"</a>
<li><strong>Previous message:</strong> <a href="9358.php">Josh Hursey: "Re: [OMPI devel] RFC: Fortran support in Open MPI Extensions"</a>
<li><strong>In reply to:</strong> <a href="9348.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9361.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Reply:</strong> <a href="9361.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; On Fri, Jun 10, 2011 at 7:37 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
...
<p>I was thinking some more about this, and wonder if we aren't over-complicating the question.
<br>
<p>Do you need to actually control the sequence of callbacks, or just ensure that your callback gets called prior to the default one that calls abort?
<br>
<p>Meeting the latter requirement is trivial - subsequent calls to register_callback get pushed onto the top of the callback list. Since the default one always gets registered first (which we can ensure since it occurs in MPI_Init), it will always be at the bottom of the callback list and hence called last.
<br>
<p>Keeping that list in ORTE is simple and probably the right place to do it.
<br>
<p>However, if you truly want to control the callback order in detail - then yeah, that should go up in  OMPI. I sure don't want to write all that code :-)
<br>
