...
?>
<!-- received="Tue Jun  7 11:22:45 2011" -->
<!-- isoreceived="20110607152245" -->
<!-- sent="Tue, 7 Jun 2011 09:21:54 -0600" -->
<!-- isosent="20110607152154" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Resilient ORTE" -->
<!-- id="BANLkTinDCBECktFcp9j4GBmuVC+vMDCggQ_at_mail.gmail.com" -->
...
<strong>Date:</strong> 2011-06-07 11:21:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9311.php">Wesley Bland: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Previous message:</strong> <a href="9309.php">Jeff Squyres: "Re: [OMPI devel] VT support for 1.5"</a>
<li><strong>In reply to:</strong> <a href="9307.php">Wesley Bland: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9311.php">Wesley Bland: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Reply:</strong> <a href="9311.php">Wesley Bland: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I know I'll have merge conflicts with my state machine branch, which would
<br>
be ready for commit in the same time frame, but I'll hold off on that one
<br>
and deal with the merge issues on my side.
<br>
<p><p><p>On Tue, Jun 7, 2011 at 8:46 AM, Wesley Bland &lt;wbland_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt;  This could certainly work alongside another ORCM or any other fault
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-9310/attachment">attachment</a>
</ul>
