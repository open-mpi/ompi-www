...
?>
<!-- received="Fri Jun 10 16:40:56 2011" -->
<!-- isoreceived="20110610204056" -->
<!-- sent="Fri, 10 Jun 2011 14:40:47 -0600" -->
<!-- isosent="20110610204047" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Resilient ORTE" -->
<!-- id="D3462602-96B5-4B90-872A-0EB8F1A2A29D_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="BANLkTikBSNkR1a3KDbn-1txqM8XkiY63gg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-06-10 16:40:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9363.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Previous message:</strong> <a href="9361.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>In reply to:</strong> <a href="9361.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9363.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<li><strong>Reply:</strong> <a href="9363.php">Josh Hursey: "Re: [OMPI devel] RFC: Resilient ORTE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Jun 10, 2011, at 2:06 PM, Josh Hursey wrote:
<br>
<p><span class="quotelev1">&gt; Yeah I do not want the default fatal callback in OMPI. I want to
</span><br>
<span class="quotelev1">&gt; replace it with something that allows OMPI to continue running when
</span><br>
<span class="quotelev1">&gt; there are process failures (if the error handlers associated with the
</span><br>
<span class="quotelev1">&gt; communicators permit such an action). So having the default fatal
</span><br>
<span class="quotelev1">&gt; callback called after mine would not be useful, since I do not want
</span><br>
<span class="quotelev1">&gt; the fatal action.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; As long as I can replace that callback, or selectively get rid of it
</span><br>
<span class="quotelev1">&gt; then I'm ok.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Fri, Jun 10, 2011 at 3:55 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Jun 10, 2011, at 6:32 AM, Josh Hursey wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Fri, Jun 10, 2011 at 7:37 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Still need to shake that corn out of your head... :-)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; It doesn't solve the problem that George alluded to - just because you overwrite the callback, it doesn't mean that someone else won't overwrite you when their component initializes. Only the last one wins - the rest of you lose.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm not sure how you guarantee that you win, which is why I'm unclear how this callback can really work unless everyone agrees that only one place gets it. Put that callback in a base function of a new error handling framework, and then let everyone create components within that for handling desired error responses?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Yep, that is a problem, but one that we can deal with in the immediate
</span><br>
<span class="quotelev3">&gt;&gt;&gt; case. Since OMPI is the only layer registering the callback, when I
</span><br>
<span class="quotelev3">&gt;&gt;&gt; replace it in OMPI I will have to make sure that no other place in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; OMPI replaces the callback.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If at some point we need more than one callback above ORTE then we may
</span><br>
<span class="quotelev3">&gt;&gt;&gt; want to revisit this point. But since we only have one layer on top of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ORTE, it is the responsibility of that layer to be internally
</span><br>
<span class="quotelev3">&gt;&gt;&gt; consistent with regard to which callback it wants to be triggered.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If the layers above ORTE want more than one callback I would suggest
</span><br>
<span class="quotelev3">&gt;&gt;&gt; that that layer design some mechanism for coordinating these multiple
</span><br>
<span class="quotelev3">&gt;&gt;&gt; - possibly conflicting - callbacks (by the way this is policy
</span><br>
<span class="quotelev3">&gt;&gt;&gt; management, which can get complex fast as you add more interested
</span><br>
<span class="quotelev3">&gt;&gt;&gt; parties). Meaning that if OMPI wanted multiple callbacks to be active
</span><br>
<span class="quotelev3">&gt;&gt;&gt; at the same time, then OMPI would create a mechanism for managing
</span><br>
<span class="quotelev3">&gt;&gt;&gt; these callbacks, not ORTE. ORTE should just have one callback provided
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to the upper layer, and keep it -simple-. If the upper layer wants to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; toy around with something more complex it must manage the complexity
</span><br>
<span class="quotelev3">&gt;&gt;&gt; instead of artificially pushing it down to the ORTE layer.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I was thinking some more about this, and wonder if we aren't over-complicating the question.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Do you need to actually control the sequence of callbacks, or just ensure that your callback gets called prior to the default one that calls abort?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Meeting the latter requirement is trivial - subsequent calls to register_callback get pushed onto the top of the callback list. Since the default one always gets registered first (which we can ensure since it occurs in MPI_Init), it will always be at the bottom of the callback list and hence called last.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Keeping that list in ORTE is simple and probably the right place to do it.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; However, if you truly want to control the callback order in detail - then yeah, that should go up in  OMPI. I sure don't want to write all that code :-)
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
