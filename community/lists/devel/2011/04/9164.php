...
?>
<!-- received="Fri Apr  8 11:12:50 2011" -->
<!-- isoreceived="20110408151250" -->
<!-- sent="Fri, 8 Apr 2011 09:12:40 -0600" -->
<!-- isosent="20110408151240" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Add child to another parent." -->
<!-- id="D2F6941E-B71A-4D60-B617-4B4D15E4644B_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="BANLkTikSCw+E71hD+ZVAMJKEyXWyEHc+9g_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-08 11:12:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9165.php">Andriy Gapon: "[OMPI devel] problem with absent L3 on AMD CPU"</a>
<li><strong>Previous message:</strong> <a href="9163.php">Hugo Meyer: "Re: [OMPI devel] Add child to another parent."</a>
<li><strong>In reply to:</strong> <a href="9163.php">Hugo Meyer: "Re: [OMPI devel] Add child to another parent."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9166.php">Hugo Meyer: "Re: [OMPI devel] Add child to another parent."</a>
<li><strong>Reply:</strong> <a href="9166.php">Hugo Meyer: "Re: [OMPI devel] Add child to another parent."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; I found a set_lifeline with that i think i solve that error, but, now i'm dealing with another.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [clus3:32001] [[44269,0],2] -&gt; [[44269,1],1] (node: node3) oob-tcp: Number of attempts to create TCP connection has been exceeded.  Can not communicate with peer
</span><br>
<span class="quotelev1">&gt; Open MPI Error Report:[32001]: While communicating to proc [[44269,1],1] on node node3, proc [[44269,0],2] on node clus3 encountered an error 'Communication failure':OOB Connection retries exceeded.  Can not communicate with peer
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I think that this occurs because the daemon [[44269,0],2] doesn't know in wich port and address has been restored the proc. I will look for a way to update this information.
</span><br>
<p>When the proc restarts, it calls orte_routed.init_routes. If you look in routed cm, you should see a call to &quot;register_sync&quot; - this is where the proc sends a message to the local daemon, allowing it to &quot;learn&quot; the port/address where the proc resides.
<br>
...
<span class="quotelev1">&gt; 2011/4/6 Ralph Castain &lt;rhc_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; Looks like the lifeline is still pointing to its old daemon instead of being updated to the new one. Look in orte/mca/routed/cm/routed_cm.c - should be something in there that updates the lifeline during restart of a checkpoint.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt;&gt; I corrected the error with the port. The mistake was because he tried to start theprocess back and the ports are static, the process was taking a port where an app was already running.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Initially, the process was running on [[65478,0],1] and then it moves to [[65478,0],2].
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; So now i get the socket binded, but i'm getting a communication failure in [[65478,0],1]. I'm sending as an atachment my debug output (there are some things in spanish, but there still are the open-mpi default debug output), where you can see the moment where i kill the process running con clus5 to the moment where it is restored in clus3. And then i get a TERMINATED WITHOUT SYNC in the proc restarted:
</span><br>
<span class="quotelev2">&gt;&gt; clus3:21615] [[65478,0],2] errmgr:orted got state TERMINATED WITHOUT SYNC for proc [[65478,1],1] pid 21705
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Here i put the output of my stdout after the socket is binded again when the process restarts.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:SOCKET BINDED 
</span><br>
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[clus5:19425] App) notify_response: Waiting for final handshake.
</span><br>
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[clus5:19425] App) update_status: Update checkpoint status (13, /tmp/radic/1) for [[65478,1],1]
</span><br>
...
<span class="quotelev2">&gt;&gt; [1,2]&lt;stdout&gt;:INICIEI O BROADCAST (6)
</span><br>
<span class="quotelev2">&gt;&gt; [1,3]&lt;stdout&gt;:FINALIZEI O BROADCAST (6)
</span><br>
<span class="quotelev2">&gt;&gt; [1,3]&lt;stdout&gt;:INICIEI O BROADCAST
</span><br>
<span class="quotelev2">&gt;&gt; [1,2]&lt;stdout&gt;:FINALIZEI O BROADCAST (6)
</span><br>
<span class="quotelev2">&gt;&gt; [1,2]&lt;stdout&gt;:INICIEI O BROADCAST
</span><br>
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[clus5:19425] [[65478,1],1] errmgr:app: job [65478,0] reported state COMMUNICATION FAILURE for proc [[65478,0],1] state COMMUNICATION FAILURE exit_code 1
</span><br>
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[clus5:19425] [[65478,1],1] routed:cm: Connection to lifeline [[65478,0],1] lost
</span><br>
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[[65478,1],1] assigned port 31256
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Any help on how to solve this error, or how to interpret it will be greatly appreciated.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; 2011/4/5 Hugo Meyer &lt;meyer.hugo_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Hello Ralph and @ll.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Ralph, by following your recomendations i've already restart the process in another node from his checkpoint. But now i'm having a small problem with the oob_tcp. There is the output:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[clus5:13374] mca_oob_tcp_init: unable to create IPv4 listen socket: Unable to open a TCP socket for out-of-band communications
</span><br>
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[clus5:13374] App) notify_response: Waiting for final handshake.
</span><br>
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[clus5:13374] App) update_status: Update checkpoint status (13, /tmp/radic/1) for [[34224,1],1]
</span><br>
<span class="quotelev2">&gt;&gt; [1,0]&lt;stdout&gt;:INICIEI O BROADCAST (6)
</span><br>
<span class="quotelev2">&gt;&gt; [1,0]&lt;stdout&gt;:FINALIZEI O BROADCAST (6)
...
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[clus5:13374] [[34224,1],1] errmgr:app: job [34224,0] reported state COMMUNICATION FAILURE for proc [[34224,0],1] state COMMUNICATION FAILURE exit_code 1
</span><br>
<span class="quotelev2">&gt;&gt; [1,1]&lt;stdout&gt;:[clus5:13374] [[34224,1],1] routed:cm: Connection to lifeline [[34224,0],1] lost
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I'm thinking that this error ocurrs because the process want to create the socket using the port that was previously assigned to it. So, if i want to restart it using another port or something how the other daemons and process will find out about this? Is this a good choice?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Best regards.
...
<span class="quotelev3">&gt;&gt;&gt; I'm not the expert on this area - Josh is, so I'll defer to him. I did take a quick glance at the sstore framework, though, and it looks like there are some params you could set that might help.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; should tell you what's available. Also, note that Josh created a man page to explain how sstore works. It's in section 7, looks like &quot;man orte_sstore&quot; should get it.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm working in the launch code to handle my checkpoints, but i'm a little stuck in how to set the path to my checkpoint and the executable (ompi_blcr_context.PID). I take a look at the code in odls_base_default_fns.c and this piece of code took my attention:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;              * OPAL CRS components need the opportunity to take action before a process
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;                 if( OPAL_SUCCESS != (rc = opal_crs.crs_prelaunch(child-&gt;name-&gt;vpid,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; But i didn't find out how to set orte_sstore_base_prelaunch_location, i now that initially this is set in the sstore_base_open. For example, as i'm transfering my checkpoint from one node to another, i store the checkpoint that has to be restore in /tmp/1/ and it has a name like ompi_blcr_context.PID.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Is there any function that i didn't see that allows me to do this? I'm asking this because I do not want to change the signature of the functions to pass the details of the checkpoint and the PID.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I have finished the (a) point, and now its working, now i have to work to relaunch from my checkpoint as you said.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Best regards.
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The resilient mapper -only- works on procs being restarted - it cannot map a job for its initial launch. You shouldn't set any rmaps flag and things will work correctly - the default round-robin mapper will map the initial launch, and then the resilient mapper will handle restarts.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-9164/attachment">attachment</a>
</ul>
