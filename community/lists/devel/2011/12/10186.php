...
?>
<!-- received="Tue Dec 20 20:23:33 2011" -->
<!-- isoreceived="20111221012333" -->
<!-- sent="Tue, 20 Dec 2011 18:23:25 -0700" -->
<!-- isosent="20111221012325" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] missing file when running autogen - ALSO in 1.4.5rc1" -->
<!-- id="28AF6205-CB3D-41E7-9355-67DA09FED662_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-12-20 20:23:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10187.php">Larry Baker: "Re: [OMPI devel] openmpi-1.5.5rc1: 2nd gmake dependence (mostly VT)"</a>
<li><strong>Previous message:</strong> <a href="10185.php">Paul H. Hargrove: "Re: [OMPI devel] missing file when running autogen - ALSO in 1.4.5rc1"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10193.php">TERRY DONTJE: "Re: [OMPI devel] missing file when running autogen - ALSO in 1.4.5rc1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
:-)
<br>
<p>We usually do a better job of ensuring files are properly included in the tarball, though....
<br>
<p>On Dec 20, 2011, at 6:21 PM, Paul H. Hargrove wrote:
<br>
<p><span class="quotelev1">&gt; Not too bizarre.
</span><br>
<span class="quotelev1">&gt; This probably just means that nobody has ever run autogen.sh from a tarball on a system using Sun's FORTRAN compiler.
</span><br>
...
<span class="quotelev2">&gt;&gt; Bizarre - fixed it too, but no promise when that might appear in a release.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; $ tar tfj openmpi-1.4.5rc1.tar.bz2 | grep modify-configure-for-sun-fortran.pl || echo NOPE
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; You are quite correct - it was indeed missing from Makefile.am! Fixed - and thanks!
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Regardless of any other issues the referenced file does not appear in the tarball at all:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
