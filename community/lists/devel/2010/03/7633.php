...
?>
<!-- received="Thu Mar 18 08:59:54 2010" -->
<!-- isoreceived="20100318125954" -->
<!-- sent="Thu, 18 Mar 2010 08:59:50 -0400" -->
<!-- isosent="20100318125950" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Some questions about checkpoint/restart (7)" -->
<!-- id="DBB30A7B-5511-4C7A-AED4-0DA561882131_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2010-03-18 08:59:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7634.php">George Bosilca: "Re: [OMPI devel] Some questions about checkpoint/restart (7)"</a>
<li><strong>Previous message:</strong> <a href="7632.php">Takayuki Seki: "[OMPI devel] Some questions about checkpoint/restart (7)"</a>
<li><strong>In reply to:</strong> <a href="7632.php">Takayuki Seki: "[OMPI devel] Some questions about checkpoint/restart (7)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7634.php">George Bosilca: "Re: [OMPI devel] Some questions about checkpoint/restart (7)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
and I will be happy to look over them and include them in the Open MPI  
<br>
trunk, if appropriate.
<br>
<p>Briefly reading through your previous messages, I suspect that much of  
<br>
your conclusions about the bugs are correct. Unfortunately, I will not  
<br>
be able to take a good look at these bug reports for another few weeks  
<br>
(probably early April). I wanted to reply so that you knew that the  
<br>
messages were not being ignored.
<br>
<p>Thanks again,
<br>
Josh
<br>
<p>On Mar 18, 2010, at 5:23 AM, Takayuki Seki wrote:
<br>
...
<span class="quotelev1">&gt; (7) The result of communication which use derived datatype after  
</span><br>
<span class="quotelev1">&gt; taking checkpoint is incorrect.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;  printf(&quot;   rank=%d pass-1 x-&gt;x =%d[%d] x-&gt;a=%d[%d] x-&gt;y=%d[%d] x-&gt;b= 
</span><br>
<span class="quotelev1">&gt; %d[%d] x-&gt;c=%d[%d]\n&quot;
</span><br>
...
<span class="quotelev1">&gt;  if (ans_dd_buf.a != buf.a) { MPI_Abort(MPI_COMM_WORLD,1); }  /* The  
</span><br>
<span class="quotelev1">&gt; error occurs at this point */
</span><br>
...
<span class="quotelev1">&gt; * Take checkpoint while Rank 0 and Rank 1 are performing sleep  
</span><br>
...
<span class="quotelev1">&gt; * I think that image of memory mapping of the derived datatype is as  
</span><br>
...
<span class="quotelev1">&gt;  The obtained value is 14.(Does it means total size in the memory is  
</span><br>
<span class="quotelev1">&gt; 14bytes?)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  struct dd {
...
<span class="quotelev1">&gt; * But the returned value of ddt_size should be 20bytes, considering  
</span><br>
<span class="quotelev1">&gt; the memory mapping.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;  ft_event_post_drain_message:Irecv drain_msg_ref=c89200 rank=0  
</span><br>
<span class="quotelev1">&gt; tag=1000 cnt=1 ddt=14 to=c929b0 [datatype-&gt;size=1]
</span><br>
<span class="quotelev1">&gt;  wait_quiesce_drained: x=1 a=142658605493679655240073216.000000 y=4  
</span><br>
<span class="quotelev1">&gt; b=0.000000 c=32
</span><br>
...
<span class="quotelev1">&gt;  ft_event_post_drain_message:Irecv drain_msg_ref=a51280 rank=0  
</span><br>
<span class="quotelev1">&gt; tag=1000 cnt=1 ddt=20 to=a5b6b0 [datatype-&gt;size=1]
</span><br>
