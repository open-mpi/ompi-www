...
?>
<!-- received="Fri Mar  5 13:40:52 2010" -->
<!-- isoreceived="20100305184052" -->
<!-- sent="Fri, 5 Mar 2010 19:40:41 +0100" -->
<!-- isosent="20100305184041" -->
<!-- name="Leonardo Fialho" -->
<!-- email="leonardofialho_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Missing Symbol" -->
<!-- id="96C3B340-CD36-4D6B-B206-3CE0A4AE76E7_at_caos.uab.es" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="6AA80510-CA04-4E55-A755-669FE18A20D4_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-03-05 13:40:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7538.php">Ralph Castain: "Re: [OMPI devel] Missing Symbol"</a>
<li><strong>Previous message:</strong> <a href="7536.php">Ralph Castain: "Re: [OMPI devel] Missing Symbol"</a>
<li><strong>In reply to:</strong> <a href="7536.php">Ralph Castain: "Re: [OMPI devel] Missing Symbol"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7538.php">Ralph Castain: "Re: [OMPI devel] Missing Symbol"</a>
<li><strong>Reply:</strong> <a href="7538.php">Ralph Castain: "Re: [OMPI devel] Missing Symbol"</a>
<li><strong>Reply:</strong> <a href="7541.php">Terry Dontje: "Re: [OMPI devel] Missing Symbol"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Yes,
<br>
<p>I renamed all references to Aurelien's componant name and removed all code regarding to the component itself. There are only functions which returns OMPI_SUCCESS. No other function is called.
<br>
<p>I'm debugging with LD_DEBUG=symbols, but the output is really huge! Probably the error is in the mca_pml_v symbol:
<br>
<p>19643:	/home/lfialho/lib/openmpi/mca_vprotocol_receiver.so: error: symbol lookup error: undefined symbol: mca_pml_v (fatal)
<br>
<p>Leonardo
<br>
<p>On Mar 5, 2010, at 7:35 PM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; You said this component was a copy of Aurelien's component? Did you rename the critical elements (e.g., component, module) inside it to avoid name confusion?
</span><br>
...
<span class="quotelev2">&gt;&gt; [lfialho_at_aoclsb-clus openmpi]$ nm mca_vprotocol_receiver.so 
</span><br>
<span class="quotelev2">&gt;&gt; 0000000000201208 a _DYNAMIC
</span><br>
