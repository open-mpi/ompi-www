...
?>
<!-- received="Fri Mar  5 14:35:35 2010" -->
<!-- isoreceived="20100305193535" -->
<!-- sent="Fri, 5 Mar 2010 20:35:26 +0100" -->
<!-- isosent="20100305193526" -->
<!-- name="Leonardo Fialho" -->
<!-- email="leonardofialho_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Missing Symbol" -->
<!-- id="9FA5EA86-CF11-46BA-98C7-4198F69AD60C_at_caos.uab.es" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="DB81622E-9822-4FE0-A89F-33BF0A08E211_at_eecs.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-03-05 14:35:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7548.php">George Bosilca: "Re: [OMPI devel] Missing Symbol"</a>
<li><strong>Previous message:</strong> <a href="7546.php">George Bosilca: "Re: [OMPI devel] Adding error/verbose messages to the TCP BTL"</a>
<li><strong>In reply to:</strong> <a href="7544.php">George Bosilca: "Re: [OMPI devel] Missing Symbol"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7548.php">George Bosilca: "Re: [OMPI devel] Missing Symbol"</a>
<li><strong>Reply:</strong> <a href="7548.php">George Bosilca: "Re: [OMPI devel] Missing Symbol"</a>
<li><strong>Reply:</strong> <a href="7549.php">Terry Dontje: "Re: [OMPI devel] Missing Symbol"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Leonardo
<br>
<p>On Mar 5, 2010, at 8:12 PM, George Bosilca wrote:
<br>
<p><span class="quotelev1">&gt; I would first try the Open MPI configure option --disable-visibility. If this doesn't fix it, you should make sure that dlopen is called with the GLOBAL flag on (don't remember where exactly in the code and unfortunately I can't check right now). Use gdb and set a breakpoint to dlopen and you will find it.
</span><br>
...
<span class="quotelev1">&gt; On Mar 5, 2010, at 14:00 , Leonardo Fialho wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Yeah, probably ompi_request_null and opal_output are not good candidates. I'm trying with mca_pml_v. But I'm not familiarized with this framework although it is really small.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; George, you said to change this (opal/mca/base/mca_base_component_find.c):
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; #if OPAL_HAVE_LTDL_ADVISE
</span><br>
<span class="quotelev2">&gt;&gt; component_handle = lt_dlopenadvise(target_file-&gt;filename, opal_mca_dladvise);
</span><br>
...
<span class="quotelev2">&gt;&gt; to use lt_dladvise_global instead of lt_dladvise_local?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Mar 5, 2010, at 7:47 PM, Terry Dontje wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I would also start nm'ing the .so's you think the U symbols are resolved in to make sure they are exposed.  Luckily you only have 3 symbols to look for.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; It's probably a visibility issue - check for an OMPI_DECLSPEC missing from the declaration of a symbol.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mar 5, 2010, at 11:40 AM, Leonardo Fialho wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I renamed all references to Aurelien's componant name and removed all code regarding to the component itself. There are only functions which returns OMPI_SUCCESS. No other function is called.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I'm debugging with LD_DEBUG=symbols, but the output is really huge! Probably the error is in the mca_pml_v symbol:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 19643:	/home/lfialho/lib/openmpi/mca_vprotocol_receiver.so: error: symbol lookup error: undefined symbol: mca_pml_v (fatal)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Mar 5, 2010, at 7:35 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; You said this component was a copy of Aurelien's component? Did you rename the critical elements (e.g., component, module) inside it to avoid name confusion?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Mar 5, 2010, at 11:27 AM, Leonardo Fialho wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [lfialho_at_aoclsb-clus openmpi]$ nm mca_vprotocol_receiver.so 0000000000201208 a _DYNAMIC
</span><br>
