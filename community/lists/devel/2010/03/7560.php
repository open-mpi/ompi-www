...
?>
<!-- received="Sat Mar  6 04:03:46 2010" -->
<!-- isoreceived="20100306090346" -->
<!-- sent="Sat, 6 Mar 2010 10:03:35 +0100" -->
<!-- isosent="20100306090335" -->
<!-- name="Leonardo Fialho" -->
<!-- email="leonardofialho_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Missing Symbol" -->
<!-- id="39435D3B-8002-4854-AA29-C6BE04658B00_at_caos.uab.es" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="D15707BF-25AB-4BE4-84D6-512A3E8B6193_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-03-06 04:03:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7561.php">George Bosilca: "Re: [OMPI devel] Adding error/verbose messages to the TCP BTL"</a>
<li><strong>Previous message:</strong> <a href="7559.php">Ralph Castain: "Re: [OMPI devel] Adding error/verbose messages to the TCP BTL"</a>
<li><strong>In reply to:</strong> <a href="7557.php">Jeff Squyres: "Re: [OMPI devel] Missing Symbol"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7556.php">Jeff Squyres: "Re: [OMPI devel] Missing Symbol"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>As George said the problem is that as mca_pml_v is dynamically loaded and then it loads mca_vprotocol_receiver which uses the problematic symbol. The symbol should be available in global symbols. I don't know why, but it is not occurring.
<br>
<p>Jeff, it is really good to have a better output for those kind of errors, but it does not change the problem. I think that the vprotocol is the only component which load other components in this way. But, all components are loaded by libopal in the same way, no?
<br>
<p>Leonardo
<br>
<p><p>On Mar 6, 2010, at 12:27 AM, Jeff Squyres wrote:
<br>
<p><span class="quotelev1">&gt; We already use global symbols; mca_base_component_repository.c invokes:
</span><br>
...
<span class="quotelev1">&gt; On Mar 5, 2010, at 6:18 PM, George Bosilca wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Unfortunately this will not fix his issues ;( I pretty sure that his problem is related to the fact that mca_pml_v is exported by another dynamic module, and therefore not available via dlsym. I don't think there is a simple solution for this problem, except going back to GLOBAL symbols.
</span><br>
...
<span class="quotelev2">&gt;&gt; On Mar 5, 2010, at 18:02 , Jeff Squyres wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; This looks do-able.  I'll commit in a bit.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; On Mar 5, 2010, at 1:27 PM, Leonardo Fialho wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
