...
?>
<!-- received="Wed Mar 17 10:29:34 2010" -->
<!-- isoreceived="20100317142934" -->
<!-- sent="Wed, 17 Mar 2010 15:29:23 +0100" -->
<!-- isosent="20100317142923" -->
<!-- name="Leonardo Fialho" -->
<!-- email="leonardofialho_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Signals" -->
<!-- id="AD8A58F4-35B2-4ECE-9CC1-781AE71098A0_at_caos.uab.es" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4BA0E3FA.6090802_at_oracle.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-03-17 10:29:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7624.php">Pascal Deveze: "[OMPI devel] Problem with MPI_Type_indexed and hole (defined with MPI_Type_create_resized )"</a>
<li><strong>Previous message:</strong> <a href="7622.php">Terry Dontje: "Re: [OMPI devel] Signals"</a>
<li><strong>In reply to:</strong> <a href="7622.php">Terry Dontje: "Re: [OMPI devel] Signals"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7625.php">Ralph Castain: "Re: [OMPI devel] Signals"</a>
<li><strong>Reply:</strong> <a href="7625.php">Ralph Castain: "Re: [OMPI devel] Signals"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I'm trying to call orte_plm.signal_job from a PML component. I think PLM stays resident after launching but it doesn't only for mpirun and orted, you're right.
<br>
<p>On Mar 17, 2010, at 3:15 PM, Terry Dontje wrote:
<br>
<p><span class="quotelev1">&gt; On 03/17/2010 10:10 AM, Leonardo Fialho wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Wow... orte_plm.signal_job points to zero. Is it correct from the PML point of view?
</span><br>
<span class="quotelev1">&gt; It might be because plm's are really only used at launch time not in MPI processes.  Note plm != pml.
</span><br>
...
<span class="quotelev2">&gt;&gt; On Mar 17, 2010, at 2:52 PM, Leonardo Fialho wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; To clarify a little bit more: I'm calling orte_plm.signal_job from a PML component, I know that ORTE is bellow OMPI, but I think that this function could not be available, or something like this. I can't figure out where is this snprintf too, in my code there is only
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     opal_output(0, &quot;receiver: sending SIGUSR1 &lt;%d&gt; to RADIC Event Logger &lt;%s&gt;&quot;,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                 SIGUSR1, ORTE_NAME_PRINT(&amp;el_proc));
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     orte_plm.signal_job(el_proc.jobid, SIGUSR1);
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; And the first output/printf works fine. Well... I used gdb to run the program, I can see this:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Program received signal EXC_BAD_ACCESS, Could not access memory.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Reason: KERN_INVALID_ADDRESS at address: 0x0000000000000000
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #1  0x000000010065c319 in vprotocol_receiver_eventlog_connect (el_comm=0x10065d178) at ../../../../../../../../ompi/mca/pml/v/mca/vprotocol/receiver/vprotocol_receiver_eventlog.c:67
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #2  0x000000010065ba9a in mca_vprotocol_receiver_send (buf=0x100500000, count=262144, datatype=0x100263d60, dst=1, tag=1, sendmode=MCA_PML_BASE_SEND_STANDARD, comm=0x1002760c0) at ../../../../../../../../ompi/mca/pml/v/mca/vprotocol/receiver/vprotocol_receiver_send.c:46
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #3  0x0000000100077d44 in MPI_Send ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #4  0x0000000100000a97 in main (argc=3, argv=0x7fff5fbff0c8) at ping.c:45
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The line 67 of vprotocol_receiver_eventlog.c is the orte_plm_signal_job call. After that zeros and interrogations... the signal_job function is already available? I really don't understand what means all those zeros.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Mar 17, 2010, at 2:06 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Thanks for clarifying - guess I won't chew just yet. :-)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I still don't see in your trace where it is failing in signal_job. I didn't see the message indicating it was sending the signal cmd out in your prior debug output, and there isn't a printf in that code loop other than the debug output. Can you attach to the process and get more info?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mar 17, 2010, at 6:50 AM, Leonardo Fialho wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Ralph don't swallow your message yet... Both jobs are not running over the same mpirun. There are two instances of mpirun in which one runs with &quot;-report-uri ../contact.txt&quot; and the other receives its contact info using &quot;-ompi-server file:../contact.txt&quot;. And yes, both processes are running with plm_base_verbose activated. When a deactivate the plm_base_verbose the error is practically the same:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] receiver: sending SIGUSR1 &lt;30&gt; to RADIC Event Logger &lt;[[47640,1],0]&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] *** Process received signal ***
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] Signal: Segmentation fault (11)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] Signal code: Address not mapped (1)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] Failing at address: 0x0
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] [ 0] 2   libSystem.B.dylib                   0x00007fff83a6eeaa _sigtramp + 26
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] [ 1] 3   libSystem.B.dylib                   0x00007fff83a210b7 snprintf + 496
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] [ 2] 4   mca_vprotocol_receiver.so           0x000000010065ba0a mca_vprotocol_receiver_send + 177
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] [ 3] 5   libmpi.0.dylib                      0x0000000100077d44 MPI_Send + 734
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] [ 4] 6   ping                                0x0000000100000a97 main + 431
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] [ 5] 7   ping                                0x00000001000008e0 start + 52
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [aopclf:54106] *** End of error message ***
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Mar 17, 2010, at 5:43 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I'm going to have to eat my last message. It slipped past me that your other job was started via comm_spawn. Since both &quot;jobs&quot; are running under the same mpirun, there shouldn't be a problem sending a signal between them.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Mar 16, 2010, at 6:59 PM, Leonardo Fialho wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Well, thank you anyway :)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Mar 17, 2010, at 1:54 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Yeah, that probably won't work. The current code isn't intended to cross jobs like that - I'm sure nobody ever tested it for that idea, and I'm pretty sure it won't support it.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I don't currently know any way to do what you are trying to do. We could extend the signal code to handle it, I would think...but I'm not sure how soon that might happen.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Mar 16, 2010, at 6:47 PM, Leonardo Fialho wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Yes... but something wrong is going on... maybe the problem is that the jobid is different than the process' jobid, I don't know.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-7623/attachment">attachment</a>
</ul>
