...
?>
<!-- received="Wed Mar 17 09:06:12 2010" -->
<!-- isoreceived="20100317130612" -->
<!-- sent="Wed, 17 Mar 2010 07:06:01 -0600" -->
<!-- isosent="20100317130601" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Signals" -->
<!-- id="56B652F3-3B34-4D91-8057-37D0EE9040B7_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="7F0FCA62-5552-4D0B-B2C7-9BEECD639943_at_caos.uab.es" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-03-17 09:06:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7619.php">Leonardo Fialho: "Re: [OMPI devel] Signals"</a>
<li><strong>Previous message:</strong> <a href="7617.php">Leonardo Fialho: "Re: [OMPI devel] Signals"</a>
<li><strong>In reply to:</strong> <a href="7617.php">Leonardo Fialho: "Re: [OMPI devel] Signals"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7619.php">Leonardo Fialho: "Re: [OMPI devel] Signals"</a>
<li><strong>Reply:</strong> <a href="7619.php">Leonardo Fialho: "Re: [OMPI devel] Signals"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I still don't see in your trace where it is failing in signal_job. I didn't see the message indicating it was sending the signal cmd out in your prior debug output, and there isn't a printf in that code loop other than the debug output. Can you attach to the process and get more info?
<br>
<p>On Mar 17, 2010, at 6:50 AM, Leonardo Fialho wrote:
<br>
<p><span class="quotelev1">&gt; Ralph don't swallow your message yet... Both jobs are not running over the same mpirun. There are two instances of mpirun in which one runs with &quot;-report-uri ../contact.txt&quot; and the other receives its contact info using &quot;-ompi-server file:../contact.txt&quot;. And yes, both processes are running with plm_base_verbose activated. When a deactivate the plm_base_verbose the error is practically the same:
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-7618/attachment">attachment</a>
</ul>
