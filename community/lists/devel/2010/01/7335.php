...
?>
<!-- received="Fri Jan 22 08:38:41 2010" -->
<!-- isoreceived="20100122133841" -->
<!-- sent="Fri, 22 Jan 2010 08:38:34 -0500" -->
<!-- isosent="20100122133834" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] flex.exe" -->
<!-- id="BE01423F-5B94-4A4B-9265-400B70C3D408_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4B59A303.4070606_at_hlrs.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-01-22 08:38:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7336.php">Jeff Squyres: "Re: [OMPI devel] [OMPI users] flex.exe"</a>
<li><strong>Previous message:</strong> <a href="7334.php">Shiqing Fan: "Re: [OMPI devel] [OMPI users] flex.exe"</a>
<li><strong>Maybe in reply to:</strong> <a href="7333.php">Ralph Castain: "Re: [OMPI devel] [OMPI users] flex.exe"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7336.php">Jeff Squyres: "Re: [OMPI devel] [OMPI users] flex.exe"</a>
<li><strong>Reply:</strong> <a href="7336.php">Jeff Squyres: "Re: [OMPI devel] [OMPI users] flex.exe"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Let's figure out how to generate the relevant code that you need at &quot;make dist&quot; time and not include flex.exe in the tarball -- it can still be in svn if you want/need it.  You might want to note in README.windows that flex.exe is not included in the tarball for the reasons cited on the users thread.
<br>
<p>I'll poke around and see if I can get the .c files in the tarball and therefore be able to exclude flex.exe -- let me get back to you later today...
<br>
<p><p><p>On Jan 22, 2010, at 8:07 AM, Shiqing Fan wrote:
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Yes, that should work but only with newer version of flex, I didn't think about it before. But the windows flex.exe should still be available for svn checkout build.
</span><br>
...
<span class="quotelev2">&gt;&gt; What prevents us from generating the code during make dist time and therefore not shipping flex.exe?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Sent: Fri Jan 22 03:56:52 2010
</span><br>
...
<span class="quotelev2">&gt;&gt; No, that's not true, we did ship the flex-generated code a time ago, but
</span><br>
<span class="quotelev2">&gt;&gt; as that part of code changes sometimes, we decided to generate it during
</span><br>
<span class="quotelev2">&gt;&gt; compilation time, and the flex.exe came with the first support of
</span><br>
<span class="quotelev2">&gt;&gt; Windows (CMake).
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
