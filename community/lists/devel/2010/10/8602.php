...
?>
<!-- received="Tue Oct 12 11:28:35 2010" -->
<!-- isoreceived="20101012152835" -->
<!-- sent="Tue, 12 Oct 2010 09:28:25 -0600" -->
<!-- isosent="20101012152825" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Threading" -->
<!-- id="CFBA0AC4-B3E8-4FA4-B4CC-19733882F8BC_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="002501cb6a20$54025d90$fc0718b0$_at_lloyd@wattsys.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-10-12 11:28:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8603.php">Kenneth Lloyd: "Re: [OMPI devel] Threading"</a>
<li><strong>Previous message:</strong> <a href="8601.php">Kenneth Lloyd: "Re: [OMPI devel] Threading"</a>
<li><strong>In reply to:</strong> <a href="8601.php">Kenneth Lloyd: "Re: [OMPI devel] Threading"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8603.php">Kenneth Lloyd: "Re: [OMPI devel] Threading"</a>
<li><strong>Reply:</strong> <a href="8603.php">Kenneth Lloyd: "Re: [OMPI devel] Threading"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I honestly wasn't casting aspersions - just sounds like a very strange operational mode. Never heard of something like that before.
<br>
<p>The problem is that we continue to have issues with clean termination and &quot;hangs&quot;, largely because the program counter gets &quot;hung&quot; as we try to work with an event-driven system constrained to a single thread. We also have performance problems because we cannot progress communications asynchronously.
<br>
<p>So the movement is to threading mpirun and the orte daemons to solve the problems. Maintaining both threaded and unthreaded operations inside a single code becomes a study in spaghetti, and so it may prove intractable. In that case, I'll &quot;freeze&quot; an unthreaded version at the current level, and we'll focus further development on the threaded version.
<br>
<p>If we go that route (and that isn't a given yet), then I'll rig the build system so configuring without threads generates the unthreaded version, with the correct accompanying man page.
<br>
<p>HTH
<br>
Ralph
...
<span class="quotelev1">&gt; There is really no need to do anything different to accommodate us &quot;oddball&quot;
</span><br>
...
<span class="quotelev1">&gt; version for such oddball purposes, and offer a higher capability version for
</span><br>
<span class="quotelev1">&gt; everyone else. I'll see if I can keep a single version, though, assuming the
</span><br>
