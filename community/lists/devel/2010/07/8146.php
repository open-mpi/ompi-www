...
?>
<!-- received="Tue Jul  6 22:48:59 2010" -->
<!-- isoreceived="20100707024859" -->
<!-- sent="Wed, 7 Jul 2010 10:48:54 +0800" -->
<!-- isosent="20100707024854" -->
<!-- name="&#213;&#197;&#190;&#167;" -->
<!-- email="iam.chilli_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] How to disable paffinity" -->
<!-- id="AANLkTikUJi0dmBEFGFmhHjg0EDMHIt0OU7bQc9iygAaX_at_mail.gmail.com" -->
<!-- charset="GB2312" -->
...
<strong>Date:</strong> 2010-07-06 22:48:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8147.php">’≈æß: "Re: [OMPI devel] How to disable paffinity"</a>
<li><strong>Previous message:</strong> <a href="8145.php">Jeff Squyres: "Re: [OMPI devel] v1.5: thumbs up or down? - Thumbs Down"</a>
<li><strong>In reply to:</strong> <a href="8141.php">Ralph Castain: "Re: [OMPI devel] How to disable paffinity"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8148.php">Jeff Squyres: "Re: [OMPI devel] How to disable paffinity"</a>
<li><strong>Reply:</strong> <a href="8148.php">Jeff Squyres: "Re: [OMPI devel] How to disable paffinity"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi all ,
<br>
It is really easy to create a new component , copy the origin one and modify
<br>
&nbsp;names ,run autogen.sh .thanks to the mca .But it is really hard to get out
<br>
what the role of the plm component play.I simpily know plm is used to launch
<br>
jobs. I tried to read the rsh component to figure out the mechanism ,however
<br>
it is time consuming and inefficiency. I have some questions.
<br>
1.If I write a rlogin component ,can I just login in the node in the cluster
<br>
and launch the process .  If it is ,what the role the odls plays ??
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-8146/attachment">attachment</a>
</ul>
