...
?>
<!-- received="Tue Apr 13 03:27:36 2010" -->
<!-- isoreceived="20100413072736" -->
<!-- sent="Tue, 13 Apr 2010 01:27:28 -0600" -->
<!-- isosent="20100413072728" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] problem when binding to socket on a single socket	node" -->
<!-- id="42562823-0A2C-4C3E-8980-4AF2C72201FA_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="1271142134.2561.406.camel_at_frecb014522.frec.bull.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-04-13 03:27:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7745.php">Nadia Derbey: "Re: [OMPI devel] problem when binding to socket on a single	socket	node"</a>
<li><strong>Previous message:</strong> <a href="7743.php">Nadia Derbey: "Re: [OMPI devel] problem when binding to socket on a single socket	node"</a>
<li><strong>In reply to:</strong> <a href="7743.php">Nadia Derbey: "Re: [OMPI devel] problem when binding to socket on a single socket	node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7745.php">Nadia Derbey: "Re: [OMPI devel] problem when binding to socket on a single	socket	node"</a>
<li><strong>Reply:</strong> <a href="7745.php">Nadia Derbey: "Re: [OMPI devel] problem when binding to socket on a single	socket	node"</a>
<li><strong>Reply:</strong> <a href="7746.php">Jeff Squyres: "Re: [OMPI devel] problem when binding to socket on a singlesocket	node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; On Mon, 2010-04-12 at 10:07 -0600, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; By definition, if you bind to all available cpus in the OS, you are
</span><br>
<span class="quotelev2">&gt;&gt; bound to nothing (i.e., &quot;unbound&quot;) as your process runs on any
</span><br>
<span class="quotelev2">&gt;&gt; available cpu.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; PLPA doesn't care, and I personally don't care. I was just explaining
</span><br>
<span class="quotelev2">&gt;&gt; why it generates an error in the odls.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; A user app would detect its binding by (a) getting the affiinity mask
</span><br>
<span class="quotelev2">&gt;&gt; from the OS, and then (b) seeing if the bits are set to '1' for all
</span><br>
<span class="quotelev2">&gt;&gt; available processors. If it is, then you are not bound - there is no
</span><br>
<span class="quotelev2">&gt;&gt; mechanism available for checking &quot;are the bits set only for the
</span><br>
<span class="quotelev2">&gt;&gt; processors I asked to be bound to&quot;. The OS doesn't track what you
</span><br>
<span class="quotelev2">&gt;&gt; asked for, it only tracks where you are bound - and a mask with all
</span><br>
<span class="quotelev2">&gt;&gt; '1's is defined as &quot;unbound&quot;.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; So the reason for my question was simple: a user asked us to &quot;bind&quot;
</span><br>
<span class="quotelev2">&gt;&gt; their process. If their process checks to see if it is bound, it will
</span><br>
<span class="quotelev2">&gt;&gt; return &quot;no&quot;. The user would therefore be led to believe that OMPI had
</span><br>
<span class="quotelev2">&gt;&gt; failed to execute their request, when in fact we did execute it - but
</span><br>
<span class="quotelev2">&gt;&gt; the result was (as Nadia says) a &quot;no-op&quot;.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; After talking with Jeff, I think he has the right answer. It is a
</span><br>
<span class="quotelev2">&gt;&gt; method we have used elsewhere, so it isn't unexpected behavior.
</span><br>
<span class="quotelev2">&gt;&gt; Basically, he proposed that we use an mca param to control this
</span><br>
...
<span class="quotelev2">&gt;&gt; * default: generate an error message as the &quot;bind&quot; results in a no-op,
</span><br>
<span class="quotelev2">&gt;&gt; and this is our current behavior
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; * warn: generate a warning that the binding wound up being a &quot;no-op&quot;,
</span><br>
<span class="quotelev2">&gt;&gt; but continue working
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; * quiet: just ignore it and keep going
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Excellent, I completely agree (though I would have put the 2nd star as
</span><br>
<span class="quotelev1">&gt; the default behavior, but never mind, I don't want to restart the
</span><br>
<span class="quotelev1">&gt; discussion ;-) )
</span><br>
<p>I actually went back/forth on that as well - I personally think it might be better to just have warn and quiet, with warn being the default. The warning could be generated with orte_show_help so the messages would be consolidated across nodes. Given that the enhanced paffinity behavior is fairly new, and that no-one has previously raised this issue, I don't think the prior behavior is relevant.
<br>
<p>Would that make sense? If so, we could extend that to the other binding options for consistency.
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Also this is a good opportunity to fix the other issue I talked about in
</span><br>
<span class="quotelev1">&gt; the first message in this thread: the tag
</span><br>
<span class="quotelev1">&gt; &quot;odls-default:could-not-bind-to-socket&quot; does not exist in
</span><br>
<span class="quotelev1">&gt; orte/mca/odls/default/help-odls-default.txt
</span><br>
<p>I'll take that one - my fault for missing it. I'll cross-check the other messages as well. Thanks for catching it!
<br>
<p>As for your other change: let me think on it. I -think- I understand your logic, but honestly haven't had time to really walk through it properly. Got an ORCM deadline to meet, but hope to break free towards the end of this week.
<br>
...
<span class="quotelev2">&gt;&gt; Fairly trivial to implement, and Bull could set the default mca param
</span><br>
<span class="quotelev2">&gt;&gt; file to &quot;quiet&quot; to get what they want. I'm not sure if that's what the
</span><br>
<span class="quotelev2">&gt;&gt; community wants or not - like I said, it makes no diff to me so long
</span><br>
<span class="quotelev2">&gt;&gt; as the code logic is understandable.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; On Apr 12, 2010, at 8:27 AM, Terry Dontje wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ralph, I guess I am curious why is it that if there is only one
</span><br>
<span class="quotelev3">&gt;&gt;&gt; socket we cannot bind to it?  Does plpa actually error on this or is
</span><br>
<span class="quotelev3">&gt;&gt;&gt; this a condition we decided was an error at odls?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I am somewhat torn on whether this makes sense.  On the one hand it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; is definitely useless as to the result if you allow it.  However if
</span><br>
<span class="quotelev3">&gt;&gt;&gt; you don't allow it and you have a script or running tests on
</span><br>
<span class="quotelev3">&gt;&gt;&gt; multiple systems it would be nice to have this run because you are
</span><br>
<span class="quotelev3">&gt;&gt;&gt; not really running into a resource starvation issue.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; At a minimum I think the error condition/message needs to be spelled
</span><br>
<span class="quotelev3">&gt;&gt;&gt; out (defined).    As to whether we allow binding when only one
</span><br>
<span class="quotelev3">&gt;&gt;&gt; socket exist I could go either way slightly leaning towards allowing
</span><br>
<span class="quotelev3">&gt;&gt;&gt; such a specification to work.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Guess I'll jump in here as I finally had a few minutes to look at the code and think about your original note. In fact, I believe your original statement is the source of contention.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; If someone tells us -bind-to-socket, but there is only one socket, then we really cannot bind them to anything. Any check by their code would reveal that they had not, in fact, been bound - raising questions as to whether or not OMPI is performing the request. Our operating standard has been to error out if the user specifies something we cannot do to avoid that kind of confusion. This is what generated the code in the system today.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Now I can see an argument that -bind-to-socket with one socket maybe shouldn't generate an error, but that decision then has to get reflected in other code areas as well.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; As for the test you cite -  it actually performs a valuable function and was added to catch specific scenarios. In particular, if you follow the code flow up just a little, you will see that it is possible to complete the loop without ever actually setting a bit in the mask. This happens when none of the cpus in that socket have been assigned to us via an external bind. People actually use that as a means of suballocating nodes, so the test needs to be there. Again, if the user said &quot;bind to socket&quot;, but none of that socket's cores are assigned for our use, that is an error.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I haven't looked at your specific fix, but I agree with Terry's question. It seems to me that whether or not we were externally bound is irrelevant. Even if the overall result is what you want, I think a more logically understandable test would help others reading the code.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; But first we need to resolve the question: should this scenario return an error or not?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Apr 12, 2010, at 1:43 AM, Nadia Derbey wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Fri, 2010-04-09 at 14:23 -0400, Terry Dontje wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
