...
?>
<!-- received="Tue Apr 13 07:45:44 2010" -->
<!-- isoreceived="20100413114544" -->
<!-- sent="Tue, 13 Apr 2010 13:34:58 +0200" -->
<!-- isosent="20100413113458" -->
<!-- name="Nadia Derbey" -->
<!-- email="Nadia.Derbey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] problem when binding to socket on a single	socket	node" -->
<!-- id="1271158498.2561.418.camel_at_frecb014522.frec.bull.fr" -->
<!-- charset="utf-8" -->
<!-- inreplyto="42562823-0A2C-4C3E-8980-4AF2C72201FA_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-04-13 07:34:58
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7746.php">Jeff Squyres: "Re: [OMPI devel] problem when binding to socket on a singlesocket	node"</a>
<li><strong>Previous message:</strong> <a href="7744.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single socket	node"</a>
<li><strong>In reply to:</strong> <a href="7744.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single socket	node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7767.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single	socket	node"</a>
<li><strong>Reply:</strong> <a href="7767.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single	socket	node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; On Apr 13, 2010, at 1:02 AM, Nadia Derbey wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt; &gt; On Mon, 2010-04-12 at 10:07 -0600, Ralph Castain wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt; By definition, if you bind to all available cpus in the OS, you are
</span><br>
<span class="quotelev3">&gt; &gt;&gt; bound to nothing (i.e., &quot;unbound&quot;) as your process runs on any
</span><br>
<span class="quotelev3">&gt; &gt;&gt; available cpu.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; PLPA doesn't care, and I personally don't care. I was just explaining
</span><br>
<span class="quotelev3">&gt; &gt;&gt; why it generates an error in the odls.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; A user app would detect its binding by (a) getting the affiinity mask
</span><br>
<span class="quotelev3">&gt; &gt;&gt; from the OS, and then (b) seeing if the bits are set to '1' for all
</span><br>
<span class="quotelev3">&gt; &gt;&gt; available processors. If it is, then you are not bound - there is no
</span><br>
<span class="quotelev3">&gt; &gt;&gt; mechanism available for checking &quot;are the bits set only for the
</span><br>
<span class="quotelev3">&gt; &gt;&gt; processors I asked to be bound to&quot;. The OS doesn't track what you
</span><br>
<span class="quotelev3">&gt; &gt;&gt; asked for, it only tracks where you are bound - and a mask with all
</span><br>
<span class="quotelev3">&gt; &gt;&gt; '1's is defined as &quot;unbound&quot;.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; So the reason for my question was simple: a user asked us to &quot;bind&quot;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; their process. If their process checks to see if it is bound, it will
</span><br>
<span class="quotelev3">&gt; &gt;&gt; return &quot;no&quot;. The user would therefore be led to believe that OMPI had
</span><br>
<span class="quotelev3">&gt; &gt;&gt; failed to execute their request, when in fact we did execute it - but
</span><br>
<span class="quotelev3">&gt; &gt;&gt; the result was (as Nadia says) a &quot;no-op&quot;.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; After talking with Jeff, I think he has the right answer. It is a
</span><br>
<span class="quotelev3">&gt; &gt;&gt; method we have used elsewhere, so it isn't unexpected behavior.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Basically, he proposed that we use an mca param to control this
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; * default: generate an error message as the &quot;bind&quot; results in a no-op,
</span><br>
<span class="quotelev3">&gt; &gt;&gt; and this is our current behavior
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; * warn: generate a warning that the binding wound up being a &quot;no-op&quot;,
</span><br>
<span class="quotelev3">&gt; &gt;&gt; but continue working
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; * quiet: just ignore it and keep going
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; Excellent, I completely agree (though I would have put the 2nd star as
</span><br>
<span class="quotelev2">&gt; &gt; the default behavior, but never mind, I don't want to restart the
</span><br>
<span class="quotelev2">&gt; &gt; discussion ;-) )
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I actually went back/forth on that as well - I personally think it might be better to just have warn and quiet, with warn being the default. The warning could be generated with orte_show_help so the messages would be consolidated across nodes. Given that the enhanced paffinity behavior is fairly new, and that no-one has previously raised this issue, I don't think the prior behavior is relevant.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Would that make sense? If so, we could extend that to the other binding options for consistency.
</span><br>
<p>Sure!
<br>
<p>Patch proposal attached.
<br>
<p>Regards,
<br>
Nadia
...
<span class="quotelev2">&gt; &gt; Also this is a good opportunity to fix the other issue I talked about in
</span><br>
<span class="quotelev2">&gt; &gt; the first message in this thread: the tag
</span><br>
<span class="quotelev2">&gt; &gt; &quot;odls-default:could-not-bind-to-socket&quot; does not exist in
</span><br>
<span class="quotelev2">&gt; &gt; orte/mca/odls/default/help-odls-default.txt
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I'll take that one - my fault for missing it. I'll cross-check the other messages as well. Thanks for catching it!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; As for your other change: let me think on it. I -think- I understand your logic, but honestly haven't had time to really walk through it properly. Got an ORCM deadline to meet, but hope to break free towards the end of this week.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev3">&gt; &gt;&gt; Fairly trivial to implement, and Bull could set the default mca param
</span><br>
<span class="quotelev3">&gt; &gt;&gt; file to &quot;quiet&quot; to get what they want. I'm not sure if that's what the
</span><br>
<span class="quotelev3">&gt; &gt;&gt; community wants or not - like I said, it makes no diff to me so long
</span><br>
<span class="quotelev3">&gt; &gt;&gt; as the code logic is understandable.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
...
<span class="quotelev3">&gt; &gt;&gt; On Apr 12, 2010, at 8:27 AM, Terry Dontje wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Ralph, I guess I am curious why is it that if there is only one
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; socket we cannot bind to it?  Does plpa actually error on this or is
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; this a condition we decided was an error at odls?
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; I am somewhat torn on whether this makes sense.  On the one hand it
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; is definitely useless as to the result if you allow it.  However if
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; you don't allow it and you have a script or running tests on
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; multiple systems it would be nice to have this run because you are
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; not really running into a resource starvation issue.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; At a minimum I think the error condition/message needs to be spelled
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; out (defined).    As to whether we allow binding when only one
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; socket exist I could go either way slightly leaning towards allowing
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; such a specification to work.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 
</span><br>
...
<p><hr>
<ul>
<li>text/x-patch attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-7745/003_bind_to_socket_on_single_socket.patch__charset_utf-8">003_bind_to_socket_on_single_socket.patch__charset_utf-8</a>
</ul>
<!-- attachment="003_bind_to_socket_on_single_socket.patch__charset_utf-8" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
