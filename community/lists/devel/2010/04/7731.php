...
?>
<!-- received="Mon Apr 12 10:29:02 2010" -->
<!-- isoreceived="20100412142902" -->
<!-- sent="Mon, 12 Apr 2010 10:27:37 -0400" -->
<!-- isosent="20100412142737" -->
<!-- name="Terry Dontje" -->
<!-- email="terry.dontje_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] problem when binding to socket on a single socket node" -->
<!-- id="4BC32DD9.8000000_at_oracle.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2010-04-12 10:27:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7732.php">Eugene Loh: "Re: [OMPI devel] problem when binding to socket on a single socket node"</a>
<li><strong>Previous message:</strong> <a href="7730.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single socket	node"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7736.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single socket node"</a>
<li><strong>Reply:</strong> <a href="7736.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single socket node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I am somewhat torn on whether this makes sense.  On the one hand it is 
<br>
...
<br>
<p>At a minimum I think the error condition/message needs to be spelled out 
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-7731/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/devel/att-7731/02-part" alt="picture">
<!-- attachment="02-part" -->
<!-- body="end" -->
<hr>
<ul class="links">
