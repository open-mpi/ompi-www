...
?>
<!-- received="Tue Apr 13 03:13:00 2010" -->
<!-- isoreceived="20100413071300" -->
<!-- sent="Tue, 13 Apr 2010 09:02:14 +0200" -->
<!-- isosent="20100413070214" -->
<!-- name="Nadia Derbey" -->
<!-- email="Nadia.Derbey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] problem when binding to socket on a single socket	node" -->
<!-- id="1271142134.2561.406.camel_at_frecb014522.frec.bull.fr" -->
<!-- inreplyto="A7E2BC86-A245-4623-938B-2A888CD2F638_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-04-13 03:02:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7744.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single socket	node"</a>
<li><strong>Previous message:</strong> <a href="7742.php">Jeff Squyres: "Re: [OMPI devel] kernel 2.6.23 vs 2.6.24 - communication/wait times"</a>
<li><strong>In reply to:</strong> <a href="7736.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single socket node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7744.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single socket	node"</a>
<li><strong>Reply:</strong> <a href="7744.php">Ralph Castain: "Re: [OMPI devel] problem when binding to socket on a single socket	node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Excellent, I completely agree (though I would have put the 2nd star as
<br>
the default behavior, but never mind, I don't want to restart the
<br>
discussion ;-) )
<br>
<p>Also this is a good opportunity to fix the other issue I talked about in
<br>
