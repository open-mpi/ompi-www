...
?>
<!-- received="Tue Jun  8 11:41:04 2010" -->
<!-- isoreceived="20100608154104" -->
<!-- sent="Tue, 8 Jun 2010 15:40:55 +0000" -->
<!-- isosent="20100608154055" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] amd64 atomic.h warnings" -->
<!-- id="33BE12B6-B3BB-4AEE-9442-F46F37FB2306_at_eecs.utk.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4D0125B1-01C6-47AE-B122-7D0AC489541E_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-06-08 11:40:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8074.php">Jeff Squyres: "Re: [OMPI devel] amd64 atomic.h warnings"</a>
<li><strong>Previous message:</strong> <a href="8072.php">Jeff Squyres: "Re: [OMPI devel] amd64 atomic.h warnings"</a>
<li><strong>In reply to:</strong> <a href="8072.php">Jeff Squyres: "Re: [OMPI devel] amd64 atomic.h warnings"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8074.php">Jeff Squyres: "Re: [OMPI devel] amd64 atomic.h warnings"</a>
<li><strong>Reply:</strong> <a href="8074.php">Jeff Squyres: "Re: [OMPI devel] amd64 atomic.h warnings"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; ## -cmdline +pgcc george2.c -O3 -c -S -x 123 4 -x 123 0x80000000 -alwaysinline /opt/pgi/7.0.7/linux86-64/7.0-7/lib/libintrinsics.il 4
</span><br>
<span class="quotelev1">&gt; ## -asm george2.s
</span><br>
<span class="quotelev1">&gt; ## lineno: 7
</span><br>
...
<span class="quotelev1">&gt; 	movl	%esi, -4(%rbp)
</span><br>
<span class="quotelev1">&gt; 	movl	%edx, -8(%rbp)
</span><br>
<span class="quotelev1">&gt; ..EN1:
</span><br>
<span class="quotelev1">&gt; ## lineno: 16
</span><br>
<span class="quotelev1">&gt; 	movl	-8(%rbp), %edx
</span><br>
<span class="quotelev1">&gt; 	movl	-4(%rbp), %eax
</span><br>
<p>oldval is moved into the %eax ... once
<br>
<p><span class="quotelev1">&gt; lock;cmpxchgl %edx,(%rdi)   
</span><br>
<span class="quotelev1">&gt; 	sete     %cl      
</span><br>
<p>The CCR is retrieved
<br>
<p><span class="quotelev1">&gt; 	movb	%cl, -9(%rbp)
</span><br>
<p>And stored.
<br>
<p>But the loop disappeared. I really have a doubt about the correctness of this assembly code.
<br>
<p>&nbsp;&nbsp;george.
<br>
<p><span class="quotelev1">&gt; ## lineno: 17
</span><br>
<span class="quotelev1">&gt; 	movzbl	-9(%rbp), %eax
</span><br>
<span class="quotelev1">&gt; ## lineno: 0
</span><br>
<span class="quotelev1">&gt; 	popq	%rbp
</span><br>
<span class="quotelev1">&gt; 	ret
</span><br>
<span class="quotelev1">&gt; 	.type	opal_atomic_cmpset_32,@function
</span><br>
<span class="quotelev1">&gt; 	.size	opal_atomic_cmpset_32,.-opal_atomic_cmpset_32
</span><br>
<span class="quotelev1">&gt; ..Dcfe0:
</span><br>
<span class="quotelev1">&gt; __opal_atomic_cmpset_32END:
</span><br>
<span class="quotelev1">&gt; 	.section	.pgi_trace
</span><br>
<span class="quotelev1">&gt; 	.align	8
</span><br>
<span class="quotelev1">&gt; 	.quad	opal_atomic_cmpset_32	## address of routine
</span><br>
<span class="quotelev1">&gt; 	.quad	__opal_atomic_cmpset_32END - opal_atomic_cmpset_32	## size of routine
</span><br>
<span class="quotelev1">&gt; 	.2byte	0	## flags for future use
</span><br>
<span class="quotelev1">&gt; 	.2byte	21	## length of following string
</span><br>
<span class="quotelev1">&gt; ## name:opal_atomic_cmpset_32:
</span><br>
<span class="quotelev1">&gt; 	.byte	0x6f,0x70,0x61,0x6c,0x5f,0x61,0x74,0x6f,0x6d,0x69,0x63
</span><br>
<span class="quotelev1">&gt; 	.byte	0x5f,0x63,0x6d,0x70,0x73,0x65,0x74,0x5f,0x33,0x32,0x00
</span><br>
<span class="quotelev1">&gt; ## lineno: 20
</span><br>
<span class="quotelev1">&gt; 	.text
</span><br>
<span class="quotelev1">&gt; 	.align	16
...
<span class="quotelev1">&gt; ..Dcfb1:
</span><br>
<span class="quotelev1">&gt; 	pushq	%rbp
</span><br>
<span class="quotelev1">&gt; ..Dcfi2:
</span><br>
<span class="quotelev1">&gt; 	movq	%rsp, %rbp
</span><br>
<span class="quotelev1">&gt; ..Dcfi3:
</span><br>
<span class="quotelev1">&gt; 	subq	$16, %rsp
</span><br>
<span class="quotelev1">&gt; 	movq	%rbx, -16(%rbp)
</span><br>
<span class="quotelev1">&gt; 	pushq	%rax
</span><br>
<span class="quotelev1">&gt; 	pushq	%rax
</span><br>
<span class="quotelev1">&gt; 	stmxcsr	(%rsp)
</span><br>
<span class="quotelev1">&gt; 	popq	%rax
</span><br>
<span class="quotelev1">&gt; 	orq	$64, %rax
</span><br>
<span class="quotelev1">&gt; 	pushq	%rax
</span><br>
<span class="quotelev1">&gt; 	ldmxcsr	(%rsp)
</span><br>
<span class="quotelev1">&gt; 	popq	%rax
</span><br>
<span class="quotelev1">&gt; 	popq	%rax
...
<span class="quotelev1">&gt; ..EN2:
</span><br>
<span class="quotelev1">&gt; ## lineno: 21
</span><br>
<span class="quotelev1">&gt; 	movl	$0, -4(%rbp)
</span><br>
<span class="quotelev1">&gt; 	.align	8
</span><br>
<span class="quotelev1">&gt; .LB191:
</span><br>
<span class="quotelev1">&gt; ## lineno: 24
</span><br>
<span class="quotelev1">&gt; 	movl	-4(%rbp), %ebx
</span><br>
<span class="quotelev1">&gt; 	leaq	-4(%rbp), %rdi
</span><br>
<span class="quotelev1">&gt; 	leal	1(%rbx), %edx
</span><br>
<span class="quotelev1">&gt; 	movl	%ebx, %esi
</span><br>
<span class="quotelev1">&gt; 	call	opal_atomic_cmpset_32
</span><br>
<span class="quotelev1">&gt; 	testl	%eax, %eax
</span><br>
<span class="quotelev1">&gt; 	je	.LB191
</span><br>
<span class="quotelev1">&gt; ## lineno: 27
</span><br>
<span class="quotelev1">&gt; 	addl	$1, %ebx
</span><br>
<span class="quotelev1">&gt; 	movl	%ebx, %eax
</span><br>
<span class="quotelev1">&gt; ## lineno: 28
</span><br>
<span class="quotelev1">&gt; 	movq	-16(%rbp), %rbx
</span><br>
...
<span class="quotelev1">&gt; ..Dcfe1:
</span><br>
<span class="quotelev1">&gt; __mainEND:
</span><br>
<span class="quotelev1">&gt; 	.section	.pgi_trace
</span><br>
<span class="quotelev1">&gt; 	.align	8
</span><br>
<span class="quotelev1">&gt; 	.quad	main	## address of routine
</span><br>
<span class="quotelev1">&gt; 	.quad	__mainEND - main	## size of routine
</span><br>
<span class="quotelev1">&gt; 	.2byte	0	## flags for future use
</span><br>
<span class="quotelev1">&gt; 	.2byte	4	## length of following string
</span><br>
<span class="quotelev1">&gt; ## name:main:
</span><br>
<span class="quotelev1">&gt; 	.byte	0x6d,0x61,0x69,0x6e,0x00
</span><br>
...
<span class="quotelev1">&gt; 	.4byte	..Dfdee1-..Dfdeb1	## FDE length
</span><br>
<span class="quotelev1">&gt; ..Dfdeb1:
</span><br>
<span class="quotelev1">&gt; 	.4byte	..Dcieb0	## CIE pointer
</span><br>
<span class="quotelev1">&gt; 	.quad	..Dcfb1	## initial location
</span><br>
<span class="quotelev1">&gt; 	.quad	..Dcfe1-..Dcfb1	## address range
</span><br>
<span class="quotelev1">&gt; 	.byte	0x4	## DW_CFA_advance_loc4
</span><br>
<span class="quotelev1">&gt; 	.4byte	..Dcfi2-..Dcfb1
</span><br>
<span class="quotelev1">&gt; 	.byte	0xe	## DW_CFA_def_cfa_offset
</span><br>
<span class="quotelev1">&gt; 	.byte	0x10	## ULEB128 16
...
<span class="quotelev1">&gt; 	.4byte	..Dcfi3-..Dcfi2
</span><br>
<span class="quotelev1">&gt; 	.byte	0xd	## DW_CFA_def_cfa_register (col 6)
</span><br>
<span class="quotelev1">&gt; 	.byte	0x6	## ULEB128 6
...
<span class="quotelev1">&gt; ..Dfdee1:
</span><br>
<span class="quotelev1">&gt; 	.ident	&quot;PGC 7.0-7&quot;
</span><br>
<span class="quotelev1">&gt; [7:49] svbu-mpi:~/tmp % 
</span><br>
...
<span class="quotelev1">&gt; On Jun 8, 2010, at 10:46 AM, George Bosilca wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; It didn't work. Let's try with this small complete application:
</span><br>
...
<span class="quotelev2">&gt;&gt; #define SMPLOCK &quot;lock;&quot;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; int32_t value = 0, oldval = 0, delta = 1;
</span><br>
<span class="quotelev2">&gt;&gt; int32_t* addr = &amp;value;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Jun 8, 2010, at 14:42 , Jeff Squyres wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Look at my output -- I did...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Jun 8, 2010, at 10:40 AM, George Bosilca wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Still no good, the opal_atomic_cmpset_32 is not inlined. Try to add -O3 to your command line, this helped for gcc.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jun 8, 2010, at 14:14 , Jeff Squyres wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Jun 8, 2010, at 9:53 AM, George Bosilca wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
