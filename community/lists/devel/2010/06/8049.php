...
?>
<!-- received="Fri Jun  4 08:20:32 2010" -->
<!-- isoreceived="20100604122032" -->
<!-- sent="Fri, 4 Jun 2010 08:20:26 -0400" -->
<!-- isosent="20100604122026" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Migrate OpenMPI to the VxWorks" -->
<!-- id="2AA43580-4CEC-4940-9482-DF70CFC9349E_at_cisco.com" -->
<!-- charset="iso-2022-cn" -->
<!-- inreplyto="AANLkTinDZxqUtYvoeA158lkFP-MnNPRvyYtSe8QEDHDn_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-06-04 08:20:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8050.php">Ralph Castain: "Re: [OMPI devel] Migrate OpenMPI to the VxWorks"</a>
<li><strong>Previous message:</strong> <a href="8048.php">&#213;&#197;&#190;&#167;: "Re: [OMPI devel] Migrate OpenMPI to the VxWorks"</a>
<li><strong>In reply to:</strong> <a href="8048.php">&#213;&#197;&#190;&#167;: "Re: [OMPI devel] Migrate OpenMPI to the VxWorks"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8050.php">Ralph Castain: "Re: [OMPI devel] Migrate OpenMPI to the VxWorks"</a>
<li><strong>Reply:</strong> <a href="8050.php">Ralph Castain: "Re: [OMPI devel] Migrate OpenMPI to the VxWorks"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Also, for fork/exec, I think that should be mostly limited to orte/odls/default, right?  If so, perhaps the right thing to do is to clone that plugin and adapt it for you platform.
<br>
<p>&nbsp;
<br>
On Jun 4, 2010, at 1:43 AM, $)AUE&gt;' wrote:
<br>
<p><span class="quotelev1">&gt; Hi Castain ,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Your last mail to me is really helpful . I met most of the issues
</span><br>
<span class="quotelev1">&gt; listed and fixed them as the off-list solution or mine .
</span><br>
<span class="quotelev1">&gt; Also as the openmpi code changed there are some other issues (almost
</span><br>
<span class="quotelev1">&gt; the missing function ) that are not reported .For example , the
</span><br>
<span class="quotelev1">&gt; gettimeofday posix function is not implemented by vxworks library ,I
</span><br>
<span class="quotelev1">&gt; just wrote a small library for those function. Until now I have
</span><br>
<span class="quotelev1">&gt; successfully compiled  the  libopen-rte.a  and libopen-pal.a , but now
</span><br>
<span class="quotelev1">&gt; I stuck
</span><br>
<span class="quotelev1">&gt; at the problem of fork and exec ,which is not available in the
</span><br>
<span class="quotelev1">&gt; vxworks. It is not possible to implement the fork and exec by myself.I
</span><br>
<span class="quotelev1">&gt; have to read through the code using the fork ,then substitute them
</span><br>
<span class="quotelev1">&gt; with rtpspawn() . It is a challenging work.I really want to know how
</span><br>
<span class="quotelev1">&gt; Brian Barrett deals with the fork() and exec() .
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Jing
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 2010/3/18 Ralph Castain &lt;rhc_at_[hidden]&gt;:
</span><br>
<span class="quotelev2">&gt; &gt; Hi Jing
</span><br>
<span class="quotelev2">&gt; &gt; Someone else took a look at this off-list a few years ago. It was mostly a
</span><br>
<span class="quotelev2">&gt; &gt; problem with the build system (some flags are different) and header file
</span><br>
<span class="quotelev2">&gt; &gt; names. I don't believe the port was ever completed though.
</span><br>
<span class="quotelev2">&gt; &gt; I have appended the results of that conversation - the last message
</span><br>
<span class="quotelev2">&gt; &gt; contained a list of the issues. You would need to update that to the trunk
</span><br>
<span class="quotelev2">&gt; &gt; of course as the code has changed considerably since that discussion took
</span><br>
<span class="quotelev2">&gt; &gt; place. Brian Barrett subsequently created a first-cut at fixing some of
</span><br>
<span class="quotelev2">&gt; &gt; these, but that appears to have been lost in the years since it was done -
</span><br>
<span class="quotelev2">&gt; &gt; and wouldn't really be current anyway.
</span><br>
<span class="quotelev2">&gt; &gt; I would be happy to assist as I can.
</span><br>
<span class="quotelev2">&gt; &gt; Ralph
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; 1. configure issues with &quot;checking prefix for global symbol labels&quot;
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; if test &quot;$CC&quot; = &quot;$CCAS&quot; ; then
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;    ompi_assemble=&quot;$CCAS $CCASFLAGS -c conftest.s &gt;conftest.out 2&gt;&amp;1&quot;
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt;    ompi_assemble=&quot;$CCAS $CCASFLAGS conftest.s &gt;conftest.out 2&gt;&amp;1&quot;
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt;   ompi_link=&quot;$CC $CFLAGS conftest_c.$OBJEXT conftest.$OBJEXT -o conftest &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; #include &lt;ioLib.h&gt;        /* for pipe() */
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; /* VxWorks signal.h defines _NSIGS, not NSIG */
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #ifdef MCS_VXWORKS
...
<span class="quotelev2">&gt; &gt; #define NSIG (_NSIGS+1)
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #endif
...
<span class="quotelev2">&gt; &gt;        if (pipe(ev_signal_pair) == -1)
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;                event_err(1, &quot;%s: pipe&quot;, __func__);
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #else
...
<span class="quotelev2">&gt; &gt;    if (socketpair(AF_UNIX, SOCK_STREAM, 0, ev_signal_pair) == -1)
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;        event_err(1, &quot;%s: socketpair&quot;, __func__);
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #endif
...
<span class="quotelev2">&gt; &gt;        strncpy( ret, filename, p - filename);
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #else
...
<span class="quotelev2">&gt; &gt;                strncpy_s( ret, (p - filename + 1), filename, p - filename );
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #endif
...
<span class="quotelev2">&gt; &gt;    return strdup(&quot;.&quot;);
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #else
...
<span class="quotelev2">&gt; &gt;    return _strdup(&quot;.&quot;);
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #endif
...
<span class="quotelev2">&gt; &gt; #include &lt;sockLib.h&gt;
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #endif
...
<span class="quotelev2">&gt; &gt; #ifdef HAVE_SYS_IOCTL_H
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #include &lt;sys/ioctl.h&gt;
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #ifdef MCS_VXWORKS
...
<span class="quotelev2">&gt; &gt; #include &lt;ioLib.h&gt;
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #endif
...
<span class="quotelev2">&gt; &gt; I rolled my own in mca_base_open.c (temporary fix, since we may come across
</span><br>
<span class="quotelev2">&gt; &gt; this problem elsewhere in the code).
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; I changed it to be just like the header I found somewhere under Linux
</span><br>
<span class="quotelev2">&gt; &gt; /usr/include:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #ifdef MCS_VXWORKS
...
<span class="quotelev2">&gt; &gt; On Mar 17, 2010, at 9:54 PM, $)AUE&gt;' wrote:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; In order to add some real-time feature to the OpenMPI for some research ,I
</span><br>
<span class="quotelev2">&gt; &gt; need a OpenMPI version running on VxWorks. But after going through the
</span><br>
<span class="quotelev2">&gt; &gt; Open-MPI website ,I can't found any indication that it supports VxWorks .
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev2">&gt; &gt; Follow the thread posted by Ralph Castain ,
</span><br>
<span class="quotelev2">&gt; &gt; <a href="http://www.open-mpi.org/community/lists/users/2006/06/1371.php">http://www.open-mpi.org/community/lists/users/2006/06/1371.php</a> .
</span><br>
<span class="quotelev2">&gt; &gt; I read some paper about the OpenRTE ,like &quot;Creating a transparent,
</span><br>
<span class="quotelev2">&gt; &gt; distributed, and resilient computing environment: the OpenRTE project&quot; and
</span><br>
<span class="quotelev2">&gt; &gt; &quot;The Open Run-Time Environment (OpenRTE):A Transparent Multi-cluster
</span><br>
<span class="quotelev2">&gt; &gt; Environment for High-Performance Computing&quot;which is written by Ralph H.
</span><br>
<span class="quotelev2">&gt; &gt; Castain $)G!&amp; Jeffrey M. Squyres and others .
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev2">&gt; &gt; Now I have a basic understanding of the OpenRTE , however ,there is too few
</span><br>
<span class="quotelev2">&gt; &gt; document of the OpenRTE describing the implement of the OpenRTE . I don't
</span><br>
<span class="quotelev2">&gt; &gt; know
</span><br>
<span class="quotelev2">&gt; &gt; where and how to begin the migration . Any advice will be appreciated.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;
