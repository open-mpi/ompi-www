<?
$subject_val = "[OMPI devel] Question on MCA_BASE_METADATA_PARAM_NONE";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Aug 23 12:51:26 2010" -->
<!-- isoreceived="20100823165126" -->
<!-- sent="Mon, 23 Aug 2010 09:50:15 -0700" -->
<!-- isosent="20100823165015" -->
<!-- name="ananda.mudar_at_[hidden]" -->
<!-- email="ananda.mudar_at_[hidden]" -->
<!-- subject="[OMPI devel] Question on MCA_BASE_METADATA_PARAM_NONE" -->
<!-- id="1E3BF6B8D1243842A175F7C7069EB0E7080FEE04_at_usa-mv-msg.wipro.com" -->
<!-- charset="us-ascii" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Question on MCA_BASE_METADATA_PARAM_NONE<br>
...
<strong>Date:</strong> 2010-08-23 12:50:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8309.php">ananda.mudar_at_[hidden]: "Re: [OMPI devel] Question on MCA_BASE_METADATA_PARAM_NONE"</a>
<li><strong>Previous message:</strong> <a href="8307.php">Samuel K. Gutierrez: "Re: [OMPI devel] Trunk Commit Heads-up: New Common Shared Memory Component"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8309.php">ananda.mudar_at_[hidden]: "Re: [OMPI devel] Question on MCA_BASE_METADATA_PARAM_NONE"</a>
<li><strong>Maybe reply:</strong> <a href="8309.php">ananda.mudar_at_[hidden]: "Re: [OMPI devel] Question on MCA_BASE_METADATA_PARAM_NONE"</a>
<li><strong>Reply:</strong> <a href="8310.php">Joshua Hursey: "Re: [OMPI devel] Question on MCA_BASE_METADATA_PARAM_NONE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-8308/attachment">attachment</a>
</ul>
