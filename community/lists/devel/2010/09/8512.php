...
?>
<!-- received="Mon Sep 20 13:27:08 2010" -->
<!-- isoreceived="20100920172708" -->
<!-- sent="Mon, 20 Sep 2010 10:26:42 -0700" -->
<!-- isosent="20100920172642" -->
...
<!-- id="1E3BF6B8D1243842A175F7C7069EB0E717D713_at_usa-mv-msg.wipro.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="[OMPI devel] Question regarding recently common shared-memory component" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-09-20 13:26:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8513.php">Samuel K. Gutierrez: "Re: [OMPI devel] Question regarding recently common shared-memory component"</a>
<li><strong>Previous message:</strong> <a href="8511.php">Steve Wise: "Re: [OMPI devel] NP64 _gather_ problem"</a>
<li><strong>Maybe in reply to:</strong> <a href="8509.php">ananda.mudar_at_[hidden]: "[OMPI devel] Question regarding recently common shared-memory component"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8513.php">Samuel K. Gutierrez: "Re: [OMPI devel] Question regarding recently common shared-memory component"</a>
<li><strong>Reply:</strong> <a href="8513.php">Samuel K. Gutierrez: "Re: [OMPI devel] Question regarding recently common shared-memory component"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
./configure CC=/usr/bin/gcc CXX=/usr/bin/c++ F77=/usr/bin/gfortran FC=/usr/bin/gfortran --prefix /users/amudar/openmpi-1.7 --with-tm=/usr/local/pbs --with-openib --with-threads=posix --enable-mpi-thread-multiple --enable-ft-thread --enable-debug --with-ft=cr --with-blcr=/usr/blcr --with-blcr-libdir=/usr/blcr/lib
<br>
&nbsp;
<br>
...
<br>
<p><p>Let me take a look at it. How did you configure your build? 
<br>
<p><p>Thanks, 
<br>
<p><p><pre>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-8512/attachment">attachment</a>
</ul>
