...
?>
<!-- received="Tue Feb  9 03:43:24 2010" -->
<!-- isoreceived="20100209084324" -->
<!-- sent="Tue, 9 Feb 2010 09:44:44 +0100 (CET)" -->
<!-- isosent="20100209084444" -->
<!-- name="Sylvain Jeaugey" -->
<!-- email="sylvain.jeaugey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: s/ENABLE_MPI_THREADS/ENABLE_THREAD_SAFETY/g" -->
<!-- id="alpine.DEB.2.00.1002090927110.30045_at_jeaugeys.frec.bull.fr" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="FAE89E01-A911-45D4-917F-8B629E93D853_at_sandia.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-02-09 03:44:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7386.php">Ralph Castain: "Re: [OMPI devel] RFC: s/ENABLE_MPI_THREADS/ENABLE_THREAD_SAFETY/g"</a>
<li><strong>Previous message:</strong> <a href="7384.php">Barrett, Brian W: "Re: [OMPI devel] RFC: s/ENABLE_MPI_THREADS/ENABLE_THREAD_SAFETY/g"</a>
<li><strong>In reply to:</strong> <a href="7384.php">Barrett, Brian W: "Re: [OMPI devel] RFC: s/ENABLE_MPI_THREADS/ENABLE_THREAD_SAFETY/g"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7386.php">Ralph Castain: "Re: [OMPI devel] RFC: s/ENABLE_MPI_THREADS/ENABLE_THREAD_SAFETY/g"</a>
<li><strong>Reply:</strong> <a href="7386.php">Ralph Castain: "Re: [OMPI devel] RFC: s/ENABLE_MPI_THREADS/ENABLE_THREAD_SAFETY/g"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>About ORTE and OPAL, if you have --enable-thread-multiple=yes, it may 
<br>
force the usage of --enable-thread-safety to configure OPAL and/or ORTE.
<br>
<p>I know there are other projects using ORTE and OPAL, but the vast majority 
<br>
...
<p>Sylvain
<br>
<p>On Mon, 8 Feb 2010, Barrett, Brian W wrote:
<br>
<p><span class="quotelev1">&gt; Well, does --disable-multi-threads disable progress threads?  And do you want to disable thread support in ORTE because you don't want MPI_THREAD_MULTIPLE?  Perhaps a third option is a rational way to go?
</span><br>
...
<span class="quotelev1">&gt; On Feb 8, 2010, at 6:54 PM, Jeff Squyres wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;  --enable-mpi-threads  ==&gt;  --enable-multi-threads
</span><br>
<span class="quotelev2">&gt;&gt;    ENABLE_MPI_THREADS  ==&gt;    ENABLE_MULTI_THREADS
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Essentially, s/mpi/multi/ig.  This gives us &quot;progress thread&quot; support and &quot;multi thread&quot; support.  Similar, but different.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Another possibility instead of &quot;mpi&quot; could be &quot;concurrent&quot;.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; On Jan 28, 2010, at 9:24 PM, Barrett, Brian W wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
