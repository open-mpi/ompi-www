...
?>
<!-- received="Tue Sep 24 09:11:30 2013" -->
<!-- isoreceived="20130924131130" -->
<!-- sent="Tue, 24 Sep 2013 15:11:26 +0200" -->
<!-- isosent="20130924131126" -->
<!-- name="Suraj Prabhakaran" -->
<!-- email="suraj.prabhakaran_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Intercomm Merge" -->
<!-- id="B185F5D5-DD68-419D-AD54-8494093A50BB_at_gmail.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="2C961A9B-0820-4BFA-B7C3-4DFFE2036BAA_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-09-24 09:11:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12980.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<li><strong>Previous message:</strong> <a href="12978.php">Jeff Squyres (jsquyres): "[OMPI devel] ddt-raw &quot;make check&quot; failure"</a>
<li><strong>In reply to:</strong> <a href="12974.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12980.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<li><strong>Reply:</strong> <a href="12980.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>I tested it with the trunk r29228. I still have the following problem. Now, it even spawns the daemon on the new node through torque but then suddently quits. The following is the output. Can you please have a look? 
<br>
<p>Thanks
<br>
Suraj
<br>
<p>[grsacc20:04511] [[6253,0],0] plm:base:receive processing msg
<br>
...
<br>
<p><p><p><p>On Sep 23, 2013, at 1:55 AM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; Found a bug in the Torque support - we were trying to connect to the MOM again, which would hang (I imagine). I pushed a fix to the trunk (r29227) and scheduled it to come to 1.7.3 if you want to try it again.
</span><br>
