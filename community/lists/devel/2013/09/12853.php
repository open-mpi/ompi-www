...
?>
<!-- received="Tue Sep  3 18:06:51 2013" -->
<!-- isoreceived="20130903220651" -->
<!-- sent="Tue, 3 Sep 2013 15:06:48 -0700" -->
<!-- isosent="20130903220648" -->
<!-- name="Rolf vandeVaart" -->
<!-- email="rvandevaart_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] openib BTL problems with ORTE async changes" -->
<!-- id="3AF945EBF4D3EC41AFE44EED9B0585F3600673CA48_at_HQMAIL02.nvidia.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="3AF945EBF4D3EC41AFE44EED9B0585F3600673C9EB_at_HQMAIL02.nvidia.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-09-03 18:06:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12854.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] GNU Automake 1.14 released"</a>
<li><strong>Previous message:</strong> <a href="12852.php">Rolf vandeVaart: "Re: [OMPI devel] openib BTL problems with ORTE async changes"</a>
<li><strong>In reply to:</strong> <a href="12852.php">Rolf vandeVaart: "Re: [OMPI devel] openib BTL problems with ORTE async changes"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Between a few off-list emails, Ralph was able to reproduce this problem on odin when he forced the use of the oob connection code in the openib BTL.
<br>
I have created a ticket to track this issue.  Not sure what we will do with this issue.
<br>
<p><a href="https://svn.open-mpi.org/trac/ompi/ticket/3746">https://svn.open-mpi.org/trac/ompi/ticket/3746</a>
<br>
...
Subject: Re: [OMPI devel] openib BTL problems with ORTE async changes
<br>
<p>Correction: That line below should be:
<br>
...
<br>
<p>Dang - I just finished running it on odin without a problem. Are you seeing this with a debug or optimized build?
<br>
<p><p>On Sep 3, 2013, at 12:16 PM, Rolf vandeVaart &lt;rvandevaart_at_[hidden]&lt;mailto:rvandevaart_at_[hidden]&gt;&gt; wrote:
<br>
<p>Yes, it fails on the current trunk (r29112).  That is what started me on the journey to figure out when things went wrong.  It was working up until r29058.
<br>
...
<br>
<p><p>As mentioned in the weekly conference call, I am seeing some strange errors when using the openib BTL.  I have narrowed down the changeset that broke things to the ORTE async code.
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-12853/attachment">attachment</a>
</ul>
