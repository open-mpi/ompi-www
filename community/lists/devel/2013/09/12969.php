...
?>
<!-- received="Sat Sep 21 20:48:57 2013" -->
<!-- isoreceived="20130922004857" -->
<!-- sent="Sat, 21 Sep 2013 17:48:54 -0700" -->
<!-- isosent="20130922004854" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Intercomm Merge" -->
<!-- id="102CB620-90AF-4897-A824-75ECD5300E12_at_open-mpi.org" -->
<!-- charset="utf-8" -->
<!-- inreplyto="EF34CDF7-FF96-4D48-A8DE-0B6530EF5912_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-09-21 20:48:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12970.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<li><strong>Previous message:</strong> <a href="12968.php">Suraj Prabhakaran: "Re: [OMPI devel] Intercomm Merge"</a>
<li><strong>In reply to:</strong> <a href="12968.php">Suraj Prabhakaran: "Re: [OMPI devel] Intercomm Merge"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12970.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<li><strong>Reply:</strong> <a href="12970.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Yes - it means we don't quite have this right yet :-(
<br>
...
<br>
<p>This is in the trunk now - will come over to 1.7.4
<br>
<p><p><span class="quotelev1">&gt; I want to use MPI_Comm_spawn() to spawn new processes in the new hosts. With my extended torque/maui batch system, I was able to perfectly use the &quot;add-host&quot; info argument to MPI_Comm_spawn() to spawn new processes on these hosts. Since MPI and Torque refer to the hosts through the nodeids, I made sure that OpenMPI uses the correct nodeid's for these new hosts. 
</span><br>
...
<p>I'll take a look - probably some stale code that hasn't been updated yet for async ORTE operations
<br>
<p><span class="quotelev1">&gt; 
</span><br>
...
<p>Yeah, the 1.7 series doesn't have the reentrant test in it - so we &quot;illegally&quot; re-enter libevent. The error again means we don't have Intercomm_create correct just yet.
<br>
<p>I'll see what I can do about this and get back to you
<br>
<p><span class="quotelev1">&gt; 
</span><br>
