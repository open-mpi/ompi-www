...
?>
<!-- received="Wed Sep 25 08:00:41 2013" -->
<!-- isoreceived="20130925120041" -->
<!-- sent="Wed, 25 Sep 2013 14:00:36 +0200" -->
<!-- isosent="20130925120036" -->
<!-- name="Suraj Prabhakaran" -->
<!-- email="suraj.prabhakaran_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Intercomm Merge" -->
<!-- id="795C2EE8-7508-41EB-A38B-820EEED7AFAD_at_gmail.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="234BC65F-37B2-4B97-B71C-FF45560BDE43_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-09-25 08:00:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12988.php">Sylvestre Ledru: "Re: [OMPI devel] Openmpi 1.6.5 is freezing under GNU/Linux ia64"</a>
<li><strong>Previous message:</strong> <a href="12986.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<li><strong>In reply to:</strong> <a href="12986.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12989.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<li><strong>Reply:</strong> <a href="12989.php">Ralph Castain: "Re: [OMPI devel] Intercomm Merge"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Dear Ralph,
<br>
<p>I am sorry but I think I missed adding plm verbosity to 5 last time. Here is the output of the complete program with and without -novm to the following mpiexec.
<br>
<p>mpiexec -mca state_base_verbose 10 -mca errmgr_base_verbose 10 -mca plm_base_verbose 5 -mca btl tcp,sm,self -np 2 ./addhosttest
<br>
...
<br>
<p>Here you can see that although I spawn only one process on grsacc18, something is also done with grsacc19.
<br>
<p>Sorry and thanks!
<br>
Suraj
...
<br><p>
<p><p><p>On Sep 24, 2013, at 8:24 PM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; What I find puzzling is that I don't see any output indicating that you went thru the Torque launcher to launch the daemons - not a peep of debug output. This makes me suspicious that something else is going on. Are you sure you sent me all the output?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Try adding -novm to your mpirun cmd line and let's see if that mode works
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Sep 24, 2013, at 9:06 AM, Suraj Prabhakaran &lt;suraj.prabhakaran_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; So here is what I do. I spawn just a &quot;single&quot; process on a new node which is basically not in the $PBS_NODEFILE list. 
</span><br>
<span class="quotelev2">&gt;&gt; My $PBS_NODEFILE list contains
</span><br>
<span class="quotelev2">&gt;&gt; grsacc20
</span><br>
<span class="quotelev2">&gt;&gt; grsacc19
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I then start the app with just 2 processes. So one host gets one process and they are successfully spawned through the torque (through tm_spawn()). MPI would have stored grsacc20 and grsacc19 to its list of hosts with launchid 0 and 1 correspondingly. 
</span><br>
<span class="quotelev2">&gt;&gt; I then use the add-host info and spawn ONE new process on a new host &quot;grsacc18&quot; through MPI_Comm_spawn. From what I saw in the code, the launchid of this new host is -1 since openmpi does not know about this and it is not available in the $PBS_NODEFILE. Since withouth the launchid, torque would not know where to spawn, I just retrieve the correct launchid of this host from a file just before tm_spawn() and use this launchid. This is the only modification that I made to openmpi. 
</span><br>
<span class="quotelev2">&gt;&gt; So, the host &quot;grsacc18&quot; will have a new launchid = 2 and will be used to spawn the process through torque. This worked perfectly until 1.6.5. 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; As we see here from the outputs, although I spawn only a single process on grsacc18, I too have no clue why openmpi tries to spawn something on grsacc19. Of course, without pbs/torque involved, everything works fine. 
</span><br>
<span class="quotelev2">&gt;&gt; I have attached the simple test code. Please modify hostnames and executable path before use. 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; &lt;addhosttest.c&gt;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Sep 24, 2013, at 4:59 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm going to need a little help here. The problem is that you launch two new daemons, and one of them exits immediately because it thinks it lost the connection back to mpirun - before it even gets a chance to create it.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Can you give me a little more info as to exactly what you are doing? Perhaps send me your test code?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Sep 24, 2013, at 7:48 AM, Suraj Prabhakaran &lt;suraj.prabhakaran_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Output attached in a file.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sep 24, 2013, at 4:11 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Afraid I don't see the problem offhand - can you add the following to your cmd line?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<p><p><hr>
<ul>
<li>text/rtf attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-12987/output.rtf">output.rtf</a>
</ul>
<!-- attachment="output.rtf" -->
<hr>
<ul>
<li>text/rtf attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-12987/output-novm.rtf">output-novm.rtf</a>
</ul>
<!-- attachment="output-novm.rtf" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
