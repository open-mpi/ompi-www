...
?>
<!-- received="Tue Jul 23 08:06:19 2013" -->
<!-- isoreceived="20130723120619" -->
<!-- sent="Tue, 23 Jul 2013 12:06:13 +0000" -->
<!-- isosent="20130723120613" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] basename: a faulty warning 'extra operand --test-name' in tests causes test-driver to fail" -->
<!-- id="EF66BBEB19BADC41AC8CCF5F684F07FC4F7466EC_at_xmb-rcd-x01.cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAHYyVz7ymfv=qP22d-q45OJeot8oDhJzn=XUTYYJYZ8jUVayeA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-07-23 08:06:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12678.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] 'make re-install' : remove 'ortecc' symlink also"</a>
<li><strong>Previous message:</strong> <a href="12676.php">Joshua Ladd: "Re: [OMPI devel] Open-MPI build of NAMD launched from srun over 20% slowed than with mpirun"</a>
<li><strong>In reply to:</strong> <a href="12594.php">Vasiliy: "Re: [OMPI devel] basename: a faulty warning 'extra operand --test-name' in tests causes test-driver to fail"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p>Great!
<br>
<p>In run_tests, does changing
<br>
<p>progname=&quot;`basename $*`&quot;
<br>
<p>to
<br>
<p>progname=&quot;`basename $1`&quot;
<br>
<p>fix the problem for you?
<br>
<p><p>On Jul 14, 2013, at 3:51 AM, Vasiliy &lt;testtest_2005_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I'm happy to provide you with an update on 'extra operand --test-name'
</span><br>
<span class="quotelev1">&gt; occasionally being fed to 'basename' by Open MPI's testsuite, which
</span><br>
<span class="quotelev1">&gt; was fixed by Automake maintainers:
</span><br>
<span class="quotelev1">&gt; <a href="http://debbugs.gnu.org/cgi/bugreport.cgi?bug=14840">http://debbugs.gnu.org/cgi/bugreport.cgi?bug=14840</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; You may still want to look at 'test/asm/run_tests' why it was passed through.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Fri, Jul 12, 2013 at 9:30 PM, Vasiliy &lt;testtest_2005_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; I've just gone through a test suite, and in 'test/asm/run_tests' there
</span><br>
<span class="quotelev2">&gt;&gt; is a statement:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; progname=&quot;`basename $*`&quot;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; where '--test-name' could accidentally get in, causing the reported
</span><br>
<span class="quotelev2">&gt;&gt; issues, since 'basename' does not have such an option. Somebody
</span><br>
<span class="quotelev2">&gt;&gt; familiar with a test suite may want to look into it.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Fri, Jul 12, 2013 at 5:17 PM, Vasiliy &lt;testtest_2005_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Sorry again, my report was a stub because I didn't have enough time to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; investigate the issue. Due to the verbose level was set to zero, I've
</span><br>
<span class="quotelev3">&gt;&gt;&gt; assumed from the log that 'basename' belongs to the Open MPI source
</span><br>
<span class="quotelev3">&gt;&gt;&gt; whereas it is not. Thank you for drawing my attention it's actually a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; utility from 'coreutils' Cygwin package. I'll report it to their team.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I've also filed a report with Automake's team about their part.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 1. I'm testing the Open MPI SVN patched source, that is, 1.9a1-svn
</span><br>
<span class="quotelev3">&gt;&gt;&gt; with the latest autotools assembled from their git/svn sources, and my
</span><br>
<span class="quotelev3">&gt;&gt;&gt; humble patches, yet have to be polished.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 2. Indeed, I'm running 'make check' when seeing those failures.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Unfortunately, that failure with 'test-driver' obscures how many (how
</span><br>
<span class="quotelev3">&gt;&gt;&gt; less), if any, true tests have been failed. I've just run it now on
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the latest sources (bzw, there's still an old rot with 'trace.c') and,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; if I could manage to make 'test-drive' working, it passes *ALL* the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; tests, except those with bogus 'test-drive' crashes, that is:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; atomic_spinlock_noinline.exe
</span><br>
<span class="quotelev3">&gt;&gt;&gt; atomic_cmpset_noinline.exe
</span><br>
<span class="quotelev3">&gt;&gt;&gt; atomic_math_noinline.exe
</span><br>
<span class="quotelev3">&gt;&gt;&gt; atomic_spinlock_noinline.exe
</span><br>
<span class="quotelev3">&gt;&gt;&gt; atomic_cmpset_noinline.exe
...
<span class="quotelev3">&gt;&gt;&gt; Clearly, they're inline/noinline issues, need to be looked into at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; some time later.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I can now give a feedback why I've got early reported warning about
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the shared libraries which haven't got created, and a blowout of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 'undefined symbols'. Indeed, that was a problem with Makefile.am's.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I've tested just two from about a hundred of other successfully
</span><br>
<span class="quotelev3">&gt;&gt;&gt; compiled static libraries, which DSO counterparts weren't created upon
</span><br>
<span class="quotelev3">&gt;&gt;&gt; compilation process, though being requested to:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; - 'ompi/datatype's Makefile compiles 'libdatatype' without very much
</span><br>
<span class="quotelev3">&gt;&gt;&gt; needed 'libopen-pal' and 'libmpi' libraries, what causes a shared
</span><br>
<span class="quotelev3">&gt;&gt;&gt; library not to be created because of undefined symbols; bzw, even if
</span><br>
<span class="quotelev3">&gt;&gt;&gt; added to the libtool (v2.4.2-374) invocation command line they are
</span><br>
<span class="quotelev3">&gt;&gt;&gt; still not being produced, gcc doesn't have this kind of a problem;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; - 'ompi/debuggers's Makefile does not make a 'libompi_dbg_msgq.dll.a'
</span><br>
<span class="quotelev3">&gt;&gt;&gt; import library (though there is a shared library), the corresponding
</span><br>
<span class="quotelev3">&gt;&gt;&gt; part has to be created manually;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I haven't checked other 95's.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 3. We don't have a test named &quot;basename&quot; or &quot;test-driver&quot;; basename is usually an OS utility, and test-driver is part of the new Automake testing framework.  If there's a mistake in how these are being invoked, it's coming from Automake, and you should report the bug to them.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ...unless we're doing something wrong in our Makefile.am's in how we list the tests to be run.  Is that what you're saying?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jul 12, 2013, at 3:59 AM, Vasiliy &lt;testtest_2005_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Oh, sorry. It is an Automake bug in terms of reacting to the
</span><br>
