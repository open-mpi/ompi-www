...
?>
<!-- received="Thu Nov 14 14:08:12 2013" -->
<!-- isoreceived="20131114190812" -->
<!-- sent="Thu, 14 Nov 2013 14:08:04 -0500" -->
<!-- isosent="20131114190804" -->
<!-- name="Shamis, Pavel" -->
...
<!-- id="48A41753-1C34-482F-B281-664588417393_at_ornl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="8EDEBDDE2C39D447A738659597BBB63A37F6ED32_at_MTIDAG01.mtl.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-14 14:08:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13259.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL] Re: [OMPI svn-full] svn:open-mpi	r29703	- in trunk: contrib/platform/iu/odin	ompi/mca/btl/openib	ompi/mca/btl/openib/connect"</a>
<li><strong>Previous message:</strong> <a href="13257.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL] What to do about openib/ofacm/cpc (was: r29703 - in trunk: contrib/p...)"</a>
<li><strong>In reply to:</strong> <a href="13256.php">Joshua Ladd: "Re: [OMPI devel] [EXTERNAL] Re: [OMPI svn-full] svn:open-mpi r29703	- in trunk: contrib/platform/iu/odin ompi/mca/btl/openib	ompi/mca/btl/openib/connect"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13259.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL] Re: [OMPI svn-full] svn:open-mpi	r29703	- in trunk: contrib/platform/iu/odin	ompi/mca/btl/openib	ompi/mca/btl/openib/connect"</a>
<li><strong>Reply:</strong> <a href="13259.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL] Re: [OMPI svn-full] svn:open-mpi	r29703	- in trunk: contrib/platform/iu/odin	ompi/mca/btl/openib	ompi/mca/btl/openib/connect"</a>
<li><strong>Reply:</strong> <a href="13262.php">Joshua Ladd: "Re: [OMPI devel] [EXTERNAL] Re: [OMPI svn-full]	svn:open-mpi	r29703	- in trunk:	contrib/platform/iu/odin	ompi/mca/btl/openib	ompi/mca/btl/openib/connect"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
There is some confusion in the thread. UDCM is just another CPC, like XOOB, OOB, and RDMACM (I think IBCM is officially dead).
<br>
XOOB and OOB don't use UDCM, they relay on ORTE out-of-band communication.
<br>
<p>OpenIB/connect supports UDCM,XOOB,OOB, and RDMACM
<br>
...
<br>
The situation is a bit different today, since ROCEE relays on RDMACM. It worth noting that you may setup
<br>
ROCEE connections with a regular OOB with a some restrictions (we did it for mvapich-1).
<br>
<p>The code between ofacm and openib is similar, but NOT the same. We change the API in a way that it allows
<br>
to hide XRC QP management (there is hash table that manages QP to EP mapping) in OFACM instead of OPENIB.
<br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &quot;... you cannot use the oob connection manager. It doesn't work and 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; was deprecated. You must use udcm, which is why things are supposed 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; to be set to do so by default. Please check the openib connect 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; priorities and correct them if necessary.&quot;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
