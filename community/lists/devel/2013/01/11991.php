...
?>
<!-- received="Fri Jan 25 17:13:48 2013" -->
<!-- isoreceived="20130125221348" -->
<!-- sent="Fri, 25 Jan 2013 14:13:41 -0800" -->
<!-- isosent="20130125221341" -->
<!-- name="Paul Hargrove" -->
<!-- email="phhargrove_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Open MPI (not quite) on Cray XC30" -->
<!-- id="CAAvDA16vobqB4xmXCjPyKige8pAsyNwcTVYKEoti_RgA4fnJjA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="6387BE30-33F0-4743-B467-4BED5F84EA89_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-25 17:13:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11992.php">Nathan Hjelm: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Previous message:</strong> <a href="11990.php">Jeremy McCaslin: "[OMPI devel] Looking for a replacement call for repeated call to MPI_IPROBE"</a>
<li><strong>In reply to:</strong> <a href="11989.php">Ralph Castain: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11992.php">Nathan Hjelm: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Reply:</strong> <a href="11992.php">Nathan Hjelm: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Reply:</strong> <a href="11994.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
MPI app:
<br>
<p>$ ./INSTALL/bin/mpicc -o ring_c examples/ring_c.c
<br>
...
<p><p>It appears that lustre support was found at configure time using a test
<br>
that used &quot;-llustre -llusterapi&quot;:
<br>
<p><span class="quotelev1">&gt; configure:157666: checking if possible to link LUSTRE
</span><br>
...
<p><p>However, those two libs are NOT included when linking an MPI application:
<br>
<p><span class="quotelev1">&gt; $ ./INSTALL/bin/mpicc -o ring_c examples/ring_c.c -v 2&gt;&amp;1 | grep collect
</span><br>
...
<span class="quotelev1">&gt; /scratch1/scratchdirs/hargrove/cceRJNtp.o -lmpi -lpmi -lalpslli -lalpsutil
</span><br>
...
<span class="quotelev1">&gt; -lnsl -lutil -lrca -L/opt/cray/atp/1.6.0/lib/ --undefined=_ATP_Data_Globals
</span><br>
...
<p><p>Of course the obvious work-around to try is adding &quot;-llustre -llustreapi&quot;
<br>
...
<br>
<p>Note that this is a --disable-shared/--enable-static build which may differ
<br>
from other systems where LUSTRE support gets used/tested.
<br>
<p>-Paul
<br>
<p><p>On Fri, Jan 25, 2013 at 12:01 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; On Jan 25, 2013, at 10:50 AM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; I went ahead and removed the duplicate code, so this should work now. The
</span><br>
<span class="quotelev2">&gt;&gt; problem is that we re-factored the ompi_info/orte-info code, but didn't
</span><br>
<span class="quotelev2">&gt;&gt; complete the job - specifically, the orte-info tool didn't get updated.
</span><br>
...
<span class="quotelev2">&gt;&gt; On Jan 22, 2013, at 4:20 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I am using the openmpi-1.9a1r27886 tarball and I still see an error for
</span><br>
...
<span class="quotelev2">&gt;&gt; ../../orte/runtime/orte_info_support.c:(.text+0xe10): multiple definition
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Jan 18, 2013, at 06:21 , Paul Hargrove &lt;PHHargrove_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; However, since this is Intel h/w, I commented-out the following 2 lines
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I am using PrgEnv-gnu/5.0.15, though PrgEnv-intel is the default on our
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Perhaps one should CMR the updated-for-CLE-5 configure logic to the 1.7
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ../../../../../orte/mca/db/pmi/db_pmi.c:202: error: for each function it
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; simple fix for somebody who knows OMPI's build infrastructure better than I.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-11991/attachment">attachment</a>
</ul>
