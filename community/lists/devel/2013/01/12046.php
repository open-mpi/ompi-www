...
?>
<!-- received="Mon Jan 28 21:23:33 2013" -->
<!-- isoreceived="20130129022333" -->
<!-- sent="Mon, 28 Jan 2013 21:23:28 -0500" -->
<!-- isosent="20130129022328" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Open MPI on Cray XC30 - suspicous configury" -->
<!-- id="CAMJJpkVnOLHufpaOuYS-sp-cX-CTT9-p+vvgHYmLGSz601G0mw_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2013-01-28 21:23:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12047.php">Paul Hargrove: "Re: [OMPI devel] Open MPI on Cray XC30 - suspicous configury"</a>
<li><strong>Previous message:</strong> <a href="12045.php">Paul Hargrove: "Re: [OMPI devel] 1.7rc6 build failure: bogus errmgr code"</a>
<li><strong>In reply to:</strong> <a href="12044.php">Ralph Castain: "Re: [OMPI devel] Open MPI on Cray XC30 - suspicous configury"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12049.php">Ralph Castain: "Re: [OMPI devel] Open MPI on Cray XC30 - suspicous configury"</a>
<li><strong>Reply:</strong> <a href="12049.php">Ralph Castain: "Re: [OMPI devel] Open MPI on Cray XC30 - suspicous configury"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Mon, Jan 28, 2013 at 9:14 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; By that I mean the first appears to mean that &quot;--with-alps&quot; with no argument
</span><br>
<span class="quotelev1">&gt; means /opt/cray/alps/default/... for CLE5 and /usr/... for CLE4, while the
</span><br>
<span class="quotelev1">&gt; second fragment appears to be doing the opposite:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; At least based on header and lib locations on NERSC's XC30 (CLE 5.0.15) and
</span><br>
<span class="quotelev1">&gt; XE6 (CLE 4.1.40), the first fragment is correctwhile the second fragment is
</span><br>
<span class="quotelev1">&gt; &quot;backwards&quot; (the two calls to AS_IF should be exchanged, or the initial
</span><br>
<span class="quotelev1">&gt; &quot;test&quot; should be inverted).
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
