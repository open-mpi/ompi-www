...
?>
<!-- received="Fri Jan 25 19:53:12 2013" -->
<!-- isoreceived="20130126005312" -->
<!-- sent="Fri, 25 Jan 2013 16:53:04 -0800" -->
<!-- isosent="20130126005304" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Open MPI (not quite) on Cray XC30" -->
<!-- id="B6F069CE-B0FC-493C-86D2-A9781EC068C8_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAAvDA17uH8FEkemgY1FPfuyzPygaog_VW=7qjdumiuuu_cQrkg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-25 19:53:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12003.php">Ralph Castain: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Previous message:</strong> <a href="12001.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>In reply to:</strong> <a href="12001.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12003.php">Ralph Castain: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Reply:</strong> <a href="12003.php">Ralph Castain: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Reply:</strong> <a href="12005.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; LANL's platform file for the XE6 has enabled shared libs, which I must disable on our XC30 which is not setup for them.
</span><br>
<p>I'm not sure why it does as we build everything strictly static on the XE6.
<br>
<p><span class="quotelev1">&gt; So, I believe Nathan's text
</span><br>
<span class="quotelev2">&gt;&gt; A number of libraries (-lxpmem, -lugni, etc) are missing from libs_static.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;  is the &quot;borkedness&quot; in mpicc, and shared-vs-static is probably why you don't have a problem on LANL's XE6.
</span><br>
<p>I don't think so - I went ahead and disabled shared libs, and still get this in mpicc:
<br>
<p>ct-fe1 rcastain/openmpi-1.9a1&gt; mpicc --showme
<br>
gcc -I/usr/aprojects/hpctools/rhc/build/include/openmpi/opal/mca/hwloc/hwloc151/hwloc/include -I/usr/aprojects/hpctools/rhc/build/include/openmpi/opal/mca/event/libevent2019/libevent -I/usr/aprojects/hpctools/rhc/build/include/openmpi/opal/mca/event/libevent2019/libevent/include -I/usr/aprojects/hpctools/rhc/build/include -I/usr/aprojects/hpctools/rhc/build/include/openmpi -pthread -march=native -L/opt/cray/ugni/2.3-1.0400.4127.5.20.gem/lib64 -L/opt/cray/xpmem/0.1-2.0400.30792.5.6.gem/lib64 -L/usr//lib64 -L/opt/cray/pmi/2.1.4-1.0000.8596.8.9.gem/lib64 -L/usr/lib/alps -Wl,-rpath=/usr/lib64/alps -Wl,-rpath=/opt/cray/pmi/2.1.4-1.0000.8596.8.9.gem/lib64 -Wl,-rpath=/opt/cray/ugni/2.3-1.0400.4127.5.20.gem/lib64 -Wl,-rpath=/opt/cray/xpmem/0.1-2.0400.30792.5.6.gem/lib64 -L/usr/aprojects/hpctools/rhc/build/lib -lmpi -lugni -lxpmem -llustre -llustreapi -lrt -lnsl -lutil -lm -ldl -lpmi -lalpslli -lalpsutil -lrt -lnsl -lutil -lm -lnsl -lutil -lm -lopen-rte -ldl -lpmi -lalpslli -lalpsutil -lrt -lnsl -lutil -lm -lnsl -lutil -lm -lopen-pal -ldl -lpmi -lalpslli -lalpsutil -lrt -lnsl -lutil -lm -lnsl -lutil -lm
<br>
<p><p>The repeated libs is something we obviously should fix, but all the libs are there - including lustre. I guess those were dropped due to the shared lib setting, so we probably should fix that in the platform file.
<br>
<p>Perhaps that is the cause of Nathan's issue? shrug...regardless, apps build and run just fine using mpicc for me.
<br>
...
<span class="quotelev1">&gt; FWIW: I can build it fine without setting any of the CC... flags on LANL's Cray XE6, and mpicc worked just fine for me once built that way.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-12002/attachment">attachment</a>
</ul>
