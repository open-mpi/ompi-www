...
?>
<!-- received="Tue Jan 29 10:18:02 2013" -->
<!-- isoreceived="20130129151802" -->
<!-- sent="Tue, 29 Jan 2013 09:17:57 -0600" -->
<!-- isosent="20130129151757" -->
<!-- name="Steve Wise" -->
<!-- email="swise_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] openib unloaded before last mem dereg" -->
<!-- id="5107E825.8020409_at_opengridcomputing.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="8EDEBDDE2C39D447A738659597BBB63A016C7597_at_MTIDAG01.mtl.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-29 10:17:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12066.php">Steve Wise: "Re: [OMPI devel] openib unloaded before last mem dereg"</a>
<li><strong>Previous message:</strong> <a href="12064.php">Joshua Ladd: "Re: [OMPI devel] openib unloaded before last mem dereg"</a>
<li><strong>In reply to:</strong> <a href="12064.php">Joshua Ladd: "Re: [OMPI devel] openib unloaded before last mem dereg"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12066.php">Steve Wise: "Re: [OMPI devel] openib unloaded before last mem dereg"</a>
<li><strong>Reply:</strong> <a href="12066.php">Steve Wise: "Re: [OMPI devel] openib unloaded before last mem dereg"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
1.6.3 too.
<br>
<p><p>On 1/29/2013 9:11 AM, Joshua Ladd wrote:
<br>
<span class="quotelev1">&gt; It should apply cleanly to 1.6.3 branch, I tested it this morning. From top level OMPI directory do
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; patch -p1 &lt; yossi_openib.patch
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Sent: Tuesday, January 29, 2013 10:05 AM
</span><br>
...
<span class="quotelev1">&gt; It's on the ticket that I just assigned to you.  :-)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Jan 29, 2013, at 10:03 AM, Steve Wise &lt;swise_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Will do...once I get a patch.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; STeve
</span><br>
<span class="quotelev2">&gt;&gt; On 1/29/2013 7:40 AM, Jeff Squyres (jsquyres) wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Thanks Josh.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Steve -- if you can confirm that this fixes your problem in the v1.6 series, we'll go ahead and commit the patch.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; FWIW: the OpenFabrics startup code got a little cleanup/revamp on the trunk/v1.7 -- I suspect that's why you're not seeing the problem on trunk/v1.7 (e.g., look at the utility routines that were abstracted out to ompi/mca/common/verbs).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; On Jan 29, 2013, at 2:41 AM, Joshua Ladd &lt;joshual_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So, we (Mellanox) have observed this ourselves when no suitable CPC can be found. Seems the BTL associated with this port is not destroyed and the ref count is not decreased.  Not sure why you don't see the problem in 1.7. But we have a patch that I'll CMR today. Please review our symptoms, diagnosis, and proposed change. Ralph, maybe I can list you as a reviewer of the patch? I've reviewed myself and it looks fine, but wouldn't mind having another set of eyes on it since I don't want to be responsible for breaking the OpenIB BTL.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Josh Ladd
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Reported by Yossi:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hi,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; There is a bug in open mpi (openib component) when one of the active ports is Ethernet.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The fix is attached, probably needs to be reviewed and submitted to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ompi
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Error flow:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 1.	Openib component creates a btl instance for every active port (including Ethernet)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 2.	Every btl holds a reference count to the device (mca_btl_openib_device_t::btls)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 3.	Openib tries to create a &quot;connection module&quot; for every btl
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 4.	It fails to create connection module for the Ethernet port
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 5.	The btl for Ethernet port is not returned by openib component, in the list of btl modules
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 6.	The btl for Ethernet port is not destroyed during openib component finalize
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 7.	The device is not destroyed, because of the reference count
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 8.	The memory pool created by the device is not destroyed
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 9.	Later, rdma mpool module cleans up remaining pools during its finalize
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 10.	The memory pool created by openib is destroyed by rdma mpool component finalize
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 11.	The memory pool points to a function (openib_dereg_mr) which is already unloaded from memory (because mca_btl_openib.so was unloaded)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 12.	Segfault because of a call to invalid function
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The fix:  If a btl module is not going to be returned from openib component init, destroy it.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Sent: Monday, January 28, 2013 8:35 PM
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To: Steve Wise
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Cc: Open MPI Developers
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Subject: Re: [OMPI devel] openib unloaded before last mem dereg
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Out of curiosity, could you tell us how you configured OMPI?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jan 28, 2013, at 12:46 PM, Steve Wise &lt;swise_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On 1/28/2013 2:04 PM, Ralph Castain wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; configured like yours, and so I can't trigger the problem.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Afraid I can't be of help after all... :-(
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -------- No OpenFabrics connection schemes reported that they
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; were able to be used on a specific port.  As such, the openib
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; BTL (OpenFabrics
</span><br>
