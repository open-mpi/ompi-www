...
?>
<!-- received="Fri Jan 25 19:09:24 2013" -->
<!-- isoreceived="20130126000924" -->
<!-- sent="Fri, 25 Jan 2013 16:09:16 -0800" -->
<!-- isosent="20130126000916" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Open MPI (not quite) on Cray XC30" -->
<!-- id="B9C0D726-9F0D-483E-B074-E4FC865FE00A_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAAvDA17YY88VTa3AYNTgFMdROWOSg511UyFmXCKSvvkcthKAAA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-25 19:09:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11999.php">Paul Hargrove: "Re: [OMPI devel] New ARM patch"</a>
<li><strong>Previous message:</strong> <a href="11997.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] New ARM patch"</a>
<li><strong>In reply to:</strong> <a href="11996.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12000.php">Ralph Castain: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Reply:</strong> <a href="12000.php">Ralph Castain: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Reply:</strong> <a href="12001.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Reply:</strong> <a href="12016.php">Nathan Hjelm: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>So I'm not quite sure I understand the &quot;mpicc is completely borked in the trunk&quot;. Can you elaborate?
<br>
<p>On Jan 25, 2013, at 3:59 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; So, I am surprised that nobody objected before now to my use of the Cray-provided wrapper compilers.
</span><br>
<span class="quotelev1">&gt; I mistakenly believed that if I don't use them then I wouldn't get through configure w/ ugni and alps support.
</span><br>
<span class="quotelev1">&gt; However, I've just now completed configure w/o setting CC, CXX, FC and see the expected components.
</span><br>
<span class="quotelev1">&gt; I'll report more from this build later (&quot;make all&quot; is running now).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I would appreciate (perhaps off-list) receiving any module or platform file or additional instructions that maybe appropriate to building on a Cray XE, XK or XC system.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Getting OMPI running on our XC30 is of exactly ZERO importance beyond my own edification.
</span><br>
...
<span class="quotelev1">&gt; Hmm, I see mpicc in there. It will use the compiler directly instead of Cray's wrappers. We didn't want Open MPI's wrapper linking in MPT afterall ;). mpicc is completely borked in the trunk.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; If you want to use the Cray wrappers with Open MPI I can give you a module file that sets up the environment correctly (link against -lmpi not -lmpich, etc).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; /scratch1/scratchdirs/hargrove/ccQ1f0sx.o -lrca -L/opt/cray/atp/1.6.0/lib/
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; -lsci_gnu_mp -lstdc++ -lgfortran -lmpich_gnu_47 -lmpl -lrt -lsma -lxpmem
</span><br>
<span class="quotelev3">&gt; &gt; &gt; -ldmapp -lugni -lpmi -lalpslli -lalpsutil -lalps -ludreg -lpthread -lm
</span><br>
<span class="quotelev3">&gt; &gt; &gt; --end-group -lgomp -lpthread --start-group -lgcc -lgcc_eh -lc --end-group
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; -lugni, etc) are missing from libs_static. Might be a similar issue with eh
</span><br>
<span class="quotelev3">&gt; &gt; &gt; missing -llustreapi. Going to create a critical bug to track this issue.
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; Still having problems on the Cray XC30, but now they are when linking an
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; It appears that lustre support was found at configure time using a test
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; -I/usr//include/lustre/   -fexceptions  -L/usr//lib64 conftest.c  -lnsl
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; However, those two libs are NOT included when linking an MPI application:
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; --sysroot= -m elf_x86_64 -static -o ring_c -u pthread_mutex_trylock -u
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; -lnsl -lutil -lnsl -lutil -lopen-rte -lpmi -lalpslli -lalpsutil -lnsl
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; -lutil -lnsl -lutil -lopen-pal -lpmi -lalpslli -lalpsutil -lnsl -lutil
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; --start-group -lgfortran -lscicpp_gnu -lsci_gnu_mp -lstdc++ -lgfortran
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; -lmpich_gnu_47 -lmpl -lrt -lsma -lxpmem -ldmapp -lugni -lpmi -lalpslli
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; -lalpsutil -lalps -ludreg -lpthread -lm --end-group -lgomp -lpthread
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; Of course the obvious work-around to try is adding &quot;-llustre -llustreapi&quot;
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; to my command line.  However, that doesn't work because mpicc places my
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; &quot;-l&quot; args BEFORE its own &quot;-lmpi&quot;.  Since &quot;-static&quot; is also among the
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; arguments, no symbols are picked up from the luster libs when they appear
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; OR the variable set by config/ompi_check_lustre.m4 isn't making its way
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; I'm currently tracking down a problem on the Cray XE6 - it appears that
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; I'll report again when I've had an opportunity to run something like
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt;&gt; I went ahead and removed the duplicate code, so this should work now.
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt;&gt; I am using the openmpi-1.9a1r27886 tarball and I still see an error
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt;&gt; On Fri, Jan 18, 2013 at 3:52 AM, George Bosilca &lt;bosilca_at_[hidden]
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;wrote:
</span><br>
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; Luckily for us all the definitions contain the same constant (orte).
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; My employer has a nice new Cray XC30 (aka Cascade), and I thought I'd
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; I am using PrgEnv-gnu/5.0.15, though PrgEnv-intel is the default on
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; I gave openmpi-1.7rc6 a try, but the ALPS headers and libs have moved
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; (as mentioned in ompi-trunk/config/orte_check_alps.m4).
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; Perhaps one should CMR the updated-for-CLE-5 configure logic to the
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; However, it looks like there is some untested code, protected by &quot;#if
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; ../../../../../orte/mca/db/pmi/db_pmi.c:202: error: 'ptr' undeclared
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; (first use in this function)
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; ../../../../../orte/mca/db/pmi/db_pmi.c:202: error: (Each undeclared
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; I added the missing &quot;char *ptr&quot; declaration a few lines before it's
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; And so I started back at configure (after a &quot;make distclean&quot;, to be
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; I am not sure how to fix this, but I would guess this is probably a
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt;&gt;&gt; simple fix for somebody who knows OMPI's build infrastructure better
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-11998/attachment">attachment</a>
</ul>
