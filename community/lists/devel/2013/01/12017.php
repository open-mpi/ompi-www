...
?>
<!-- received="Mon Jan 28 10:52:55 2013" -->
<!-- isoreceived="20130128155255" -->
<!-- sent="Mon, 28 Jan 2013 07:52:48 -0800" -->
<!-- isosent="20130128155248" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Open MPI (not quite) on Cray XC30" -->
<!-- id="D8ABD2A9-F67D-479C-9E04-9484D9DF3F8E_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="20130128154506.GA99519_at_pantheralanlgov.local" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-28 10:52:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12018.php">Steve Wise: "Re: [OMPI devel] openib unloaded before last mem dereg"</a>
<li><strong>Previous message:</strong> <a href="12016.php">Nathan Hjelm: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>In reply to:</strong> <a href="12016.php">Nathan Hjelm: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12034.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Reply:</strong> <a href="12034.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Brian was already aware of it and fixed it this weekend. I tested the fix and it works fine. Waiting for Jeff to review it before committing to the trunk.
<br>
<p><p>On Jan 28, 2013, at 7:45 AM, Nathan Hjelm &lt;hjelmn_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Try building static. Lots of errors due to missing libraries in libs_static.
</span><br>
...
<span class="quotelev1">&gt; On Fri, Jan 25, 2013 at 04:09:16PM -0800, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; FWIW: I can build it fine without setting any of the CC... flags on LANL's Cray XE6, and mpicc worked just fine for me once built that way.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; So I'm not quite sure I understand the &quot;mpicc is completely borked in the trunk&quot;. Can you elaborate?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; The 2nd and 3rd non-blank lines of my original post:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; So, I am surprised that nobody objected before now to my use of the Cray-provided wrapper compilers.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I mistakenly believed that if I don't use them then I wouldn't get through configure w/ ugni and alps support.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; However, I've just now completed configure w/o setting CC, CXX, FC and see the expected components.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'll report more from this build later (&quot;make all&quot; is running now).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I would appreciate (perhaps off-list) receiving any module or platform file or additional instructions that maybe appropriate to building on a Cray XE, XK or XC system.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Getting OMPI running on our XC30 is of exactly ZERO importance beyond my own edification.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So, I am likely to stop fighting this battle soon.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Fri, Jan 25, 2013 at 3:21 PM, Nathan Hjelm &lt;hjelmn_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hmm, I see mpicc in there. It will use the compiler directly instead of Cray's wrappers. We didn't want Open MPI's wrapper linking in MPT afterall ;). mpicc is completely borked in the trunk.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If you want to use the Cray wrappers with Open MPI I can give you a module file that sets up the environment correctly (link against -lmpi not -lmpich, etc).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -Nathan
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Cray's &quot;cc&quot; wrapper is adding xpmem, ugni, pmi, alps and others already:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /scratch1/scratchdirs/hargrove/ccQ1f0sx.o -lrca -L/opt/cray/atp/1.6.0/lib/
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; --undefined=_ATP_Data_Globals --undefined=__atpHandlerInstall
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -lAtpSigHCommData -lAtpSigHandler --start-group -lgfortran -lscicpp_gnu
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -lsci_gnu_mp -lstdc++ -lgfortran -lmpich_gnu_47 -lmpl -lrt -lsma -lxpmem
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -ldmapp -lugni -lpmi -lalpslli -lalpsutil -lalps -ludreg -lpthread -lm
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; --end-group -lgomp -lpthread --start-group -lgcc -lgcc_eh -lc --end-group
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -lugni, etc) are missing from libs_static. Might be a similar issue with eh
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; missing -llustreapi. Going to create a critical bug to track this issue.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Still having problems on the Cray XC30, but now they are when linking an
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; It appears that lustre support was found at configure time using a test
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -finline-functions -fno-strict-aliasing -fexceptions   -D_REENTRANT
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -I/usr//include/lustre/   -fexceptions  -L/usr//lib64 conftest.c  -lnsl
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; However, those two libs are NOT included when linking an MPI application:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; --sysroot= -m elf_x86_64 -static -o ring_c -u pthread_mutex_trylock -u
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -lnsl -lutil -lnsl -lutil -lopen-rte -lpmi -lalpslli -lalpsutil -lnsl
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -lutil -lnsl -lutil -lopen-pal -lpmi -lalpslli -lalpsutil -lnsl -lutil
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; --start-group -lgfortran -lscicpp_gnu -lsci_gnu_mp -lstdc++ -lgfortran
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -lmpich_gnu_47 -lmpl -lrt -lsma -lxpmem -ldmapp -lugni -lpmi -lalpslli
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -lalpsutil -lalps -ludreg -lpthread -lm --end-group -lgomp -lpthread
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Of course the obvious work-around to try is adding &quot;-llustre -llustreapi&quot;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; to my command line.  However, that doesn't work because mpicc places my
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; &quot;-l&quot; args BEFORE its own &quot;-lmpi&quot;.  Since &quot;-static&quot; is also among the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; arguments, no symbols are picked up from the luster libs when they appear
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; OR the variable set by config/ompi_check_lustre.m4 isn't making its way
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; into the application link command for some reason
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Note that this is a --disable-shared/--enable-static build which may
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'm currently tracking down a problem on the Cray XE6 - it appears that
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'll report again when I've had an opportunity to run something like
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I went ahead and removed the duplicate code, so this should work now.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; It's about to get revamped yet again when the ompi-rte branch gets
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; committed to the trunk, so I'd rather not do any more with it now.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am using the openmpi-1.9a1r27886 tarball and I still see an error
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; version.o:../../../../orte/tools/orte-info/version.c:(.text+0x2370):
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Fri, Jan 18, 2013 at 3:52 AM, George Bosilca &lt;bosilca_at_[hidden]
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Luckily for us all the definitions contain the same constant (orte).
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; My employer has a nice new Cray XC30 (aka Cascade), and I thought I'd
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; give Open MPI a quick test.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Given that it is INTENDED to be API-compatible with the XE series, I
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; However, since this is Intel h/w, I commented-out the following 2
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am using PrgEnv-gnu/5.0.15, though PrgEnv-intel is the default on
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I gave openmpi-1.7rc6 a try, but the ALPS headers and libs have moved
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; (as mentioned in ompi-trunk/config/orte_check_alps.m4).
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Perhaps one should CMR the updated-for-CLE-5 configure logic to the
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; As I mentioned above, the trunk has the right logic for locating
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I added the missing &quot;char *ptr&quot; declaration a few lines before it's
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; And so I started back at configure (after a &quot;make distclean&quot;, to be
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am not sure how to fix this, but I would guess this is probably a
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; simple fix for somebody who knows OMPI's build infrastructure better
</span><br>
