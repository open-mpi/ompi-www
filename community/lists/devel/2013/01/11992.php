...
?>
<!-- received="Fri Jan 25 17:46:16 2013" -->
<!-- isoreceived="20130125224616" -->
<!-- sent="Fri, 25 Jan 2013 15:46:11 -0700" -->
<!-- isosent="20130125224611" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Open MPI (not quite) on Cray XC30" -->
<!-- id="20130125224611.GE89496_at_pantheralanlgov.local" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2013-01-25 17:46:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11993.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Previous message:</strong> <a href="11991.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>In reply to:</strong> <a href="11991.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11993.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<li><strong>Reply:</strong> <a href="11993.php">Paul Hargrove: "Re: [OMPI devel] Open MPI (not quite) on Cray XC30"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Something is wrong with the wrappers. A number of libraries (-lxpmem, -lugni, etc) are missing from libs_static. Might be a similar issue with eh missing -llustreapi. Going to create a critical bug to track this issue.
<br>
<p>Works in 1.7 :-/ ... If you add -lnuma to libs_static in mpicc-wrapper-data.txt.
<br>
<p>-Nathan
<br>
HPC-3, LANL
<br>
<p>On Fri, Jan 25, 2013 at 02:13:41PM -0800, Paul Hargrove wrote:
<br>
...
<span class="quotelev1">&gt; EITHER config/ompi_check_lustre.m4 is failing to add &quot;-llustre -llustreapi&quot;
</span><br>
...
<span class="quotelev1">&gt; Note that this is a --disable-shared/--enable-static build which may differ
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; I went ahead and removed the duplicate code, so this should work now. The
</span><br>
<span class="quotelev3">&gt; &gt;&gt; problem is that we re-factored the ompi_info/orte-info code, but didn't
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; ../../orte/runtime/orte_info_support.c:(.text+0xe10): multiple definition
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;     CC=cc CXX=CC FC=ftn --with-platform=lanl/cray_xe6/optimized-nopanasas
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; ../../../../../orte/mca/db/pmi/db_pmi.c:202: error: for each function it
</span><br>
