...
?>
<!-- received="Fri Dec  6 09:22:37 2013" -->
<!-- isoreceived="20131206142237" -->
<!-- sent="Fri, 6 Dec 2013 14:22:35 +0000" -->
<!-- isosent="20131206142235" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [PATCH 1/4] Trying to get the C/R code to compile again. (void value not ignored)" -->
<!-- id="A24C702E-732F-452C-B2EA-6410BE38DDE4_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAANzjEmpnFcYQTuaCW_qLPENQwpd-Am1cc3ZKcsD6UprcWchrQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-06 09:22:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13390.php">Josh Hursey: "Re: [OMPI devel] [PATCH 2/4] Trying to get the C/R code to compile again. (send_*_nb)"</a>
<li><strong>Previous message:</strong> <a href="13388.php">Josh Hursey: "Re: [OMPI devel] [PATCH 1/4] Trying to get the C/R code to compile again. (void value not ignored)"</a>
<li><strong>In reply to:</strong> <a href="13388.php">Josh Hursey: "Re: [OMPI devel] [PATCH 1/4] Trying to get the C/R code to compile again. (void value not ignored)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/devel/2013/11/13334.php">Adrian Reber: "[OMPI devel] [PATCH 2/4] Trying to get the C/R code to compile again. (send_*_nb)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Dec 6, 2013, at 9:21 AM, Josh Hursey &lt;jjhursey_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; This patch looks good to me. Let me look at some of the others.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Fri, Dec 6, 2013 at 7:14 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; Let's see what Josh says (he said he'd review the patches today).  I'm guessing he'll be ok with this one, but let's see.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev4">&gt; &gt;&gt;&gt; diff --git a/orte/mca/errmgr/base/errmgr_base_tool.c b/orte/mca/errmgr/base/errmgr_base_tool.c
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -290,16 +290,10 @@ static int errmgr_base_tool_stop_cmdline_listener(void)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;    OPAL_OUTPUT_VERBOSE((5, orte_errmgr_base_framework.framework_output,
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;                         &quot;errmgr:base:tool: Shutdown Command Line Channel&quot;));
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -    if (ORTE_SUCCESS != (ret = orte_rml.recv_cancel(ORTE_NAME_WILDCARD,
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; diff --git a/orte/mca/rml/ftrm/rml_ftrm.h b/orte/mca/rml/ftrm/rml_ftrm.h
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; -    int orte_rml_ftrm_recv_cancel(orte_process_name_t* peer, orte_rml_tag_t tag);
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; +    void orte_rml_ftrm_recv_cancel(orte_process_name_t* peer, orte_rml_tag_t tag);
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;    /*
...
<span class="quotelev4">&gt; &gt;&gt;&gt; diff --git a/orte/mca/rml/ftrm/rml_ftrm_module.c b/orte/mca/rml/ftrm/rml_ftrm_module.c
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; -        if( ORTE_SUCCESS != (ret = orte_rml_ftrm_wrapped_module.set_contact_info(contact_info) ) ) {
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -330,20 +324,14 @@ int orte_rml_ftrm_recv_buffer_nb(orte_process_name_t* peer,
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; /*
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; * Recv Cancel
...
<span class="quotelev4">&gt; &gt;&gt;&gt; -        if( ORTE_SUCCESS != (ret = orte_rml_ftrm_wrapped_module.recv_cancel(peer, tag) ) ) {
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -            return ret;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        }
...
<span class="quotelev4">&gt; &gt;&gt;&gt; -        if( ORTE_SUCCESS != (ret = orte_rml_ftrm_wrapped_module.purge(peer) ) ) {
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -            return ret;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        }
...
<span class="quotelev4">&gt; &gt;&gt;&gt;    OPAL_OUTPUT_VERBOSE((5, mca_snapc_full_component.super.output_handle,
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; -                                                    ORTE_RML_TAG_SNAPC_FULL))) {
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        ORTE_ERROR_LOG(ret);
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        exit_status = ret;
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -959,26 +950,17 @@ static int snapc_full_global_start_cmdline_listener(void)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; -                                                    ORTE_RML_TAG_CKPT))) {
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        ORTE_ERROR_LOG(ret);
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        exit_status = ret;
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -378,8 +378,6 @@ static int snapc_full_local_start_hnp_listener(void)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -393,18 +391,11 @@ static int snapc_full_local_stop_hnp_listener(void)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;    OPAL_OUTPUT_VERBOSE((5, mca_snapc_full_component.super.output_handle,
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -439,26 +430,17 @@ static int snapc_full_local_start_app_listener(void)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; -                                                    ORTE_RML_TAG_SNAPC))) {
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        ORTE_ERROR_LOG(ret);
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        exit_status = ret;
...
<span class="quotelev4">&gt; &gt;&gt;&gt; diff --git a/orte/mca/sstore/central/sstore_central_global.c b/orte/mca/sstore/central/sstore_central_global.c
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -824,19 +824,10 @@ static int sstore_central_global_start_listener(void)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; -                                                    ORTE_RML_TAG_SSTORE_INTERNAL))) {
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        ORTE_ERROR_LOG(ret);
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -        exit_status = ret;
...
<span class="quotelev4">&gt; &gt;&gt;&gt; +    orte_rml.recv_cancel(ORTE_NAME_WILDCARD, ORTE_RML_TAG_SSTORE_INTERNAL);
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; diff --git a/orte/mca/sstore/central/sstore_central_local.c b/orte/mca/sstore/central/sstore_central_local.c
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -643,19 +643,10 @@ static int sstore_central_local_start_listener(void)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; static int process_global_pull(orte_process_name_t* peer, opal_buffer_t* buffer, orte_sstore_central_local_snapshot_info_t *handle_info)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; diff --git a/orte/mca/sstore/stage/sstore_stage_global.c b/orte/mca/sstore/stage/sstore_stage_global.c
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -1016,19 +1016,10 @@ static int sstore_stage_global_start_listener(void)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; diff --git a/orte/mca/sstore/stage/sstore_stage_local.c b/orte/mca/sstore/stage/sstore_stage_local.c
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; @@ -1067,19 +1067,9 @@ static int sstore_stage_local_start_listener(void)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; diff --git a/orte/tools/orte-checkpoint/orte-checkpoint.c b/orte/tools/orte-checkpoint/orte-checkpoint.c
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; diff --git a/orte/tools/orte-migrate/orte-migrate.c b/orte/tools/orte-migrate/orte-migrate.c
</span><br>
