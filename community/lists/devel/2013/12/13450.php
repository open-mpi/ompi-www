...
?>
<!-- received="Mon Dec 16 12:21:08 2013" -->
<!-- isoreceived="20131216172108" -->
<!-- sent="Mon, 16 Dec 2013 17:21:05 +0000" -->
<!-- isosent="20131216172105" -->
<!-- name="Joshua Ladd" -->
<!-- email="joshual_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] bug in mca framework?" -->
<!-- id="8EDEBDDE2C39D447A738659597BBB63A3EBECF67_at_MTIDAG01.mtl.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2013-12-16 12:21:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13451.php">Nathan Hjelm: "Re: [OMPI devel] bug in mca framework?"</a>
<li><strong>Previous message:</strong> <a href="13449.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] bug in mca framework?"</a>
<li><strong>In reply to:</strong> <a href="13449.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] bug in mca framework?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13452.php">Nathan Hjelm: "Re: [OMPI devel] bug in mca framework?"</a>
<li><strong>Reply:</strong> <a href="13452.php">Nathan Hjelm: "Re: [OMPI devel] bug in mca framework?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>1. Valgrind comes up clean.
<br>
2. The issue is not reproduced with a static build.
<br>
3. A bisection study reveals that problems first appear after commit: 
<br>
<a href="https://svn.open-mpi.org/trac/ompi/changeset/28800/trunk/opal/mca/base/mca_base_var.c">https://svn.open-mpi.org/trac/ompi/changeset/28800/trunk/opal/mca/base/mca_base_var.c</a>
<br>
<p><p>Josh
<br>
<p>-----Original Message-----
...
Subject: Re: [OMPI devel] bug in mca framework?
<br>
<p>It might be worthwhile to run this through valgrind and see if something is being freed incorrectly...?
<br>
<p><p>On Dec 16, 2013, at 12:11 PM, Nathan Hjelm &lt;hjelmn_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I took a look at the stacktraces last week and could not identify 
</span><br>
<span class="quotelev1">&gt; where the bug is. I will dig deeper this week and see if I can come up with the correct fix.
</span><br>
...
<span class="quotelev2">&gt;&gt;         searching itself in global array and refreshing their fields 
</span><br>
