...
?>
<!-- received="Mon Dec 16 10:37:51 2013" -->
<!-- isoreceived="20131216153751" -->
<!-- sent="Mon, 16 Dec 2013 16:37:50 +0100" -->
<!-- isosent="20131216153750" -->
<!-- name="Adrian Reber" -->
<!-- email="adrian_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)" -->
<!-- id="20131216153750.GU7886_at_lisas.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2013-12-16 10:37:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13446.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)"</a>
<li><strong>Previous message:</strong> <a href="13444.php">George Bosilca: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r29917 - trunk/ompi/mca/rte/orte"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13446.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)"</a>
<li><strong>Reply:</strong> <a href="13446.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adrian
<br>
<p>On Mon, Dec 09, 2013 at 03:39:11PM -0600, Josh Hursey wrote:
<br>
<span class="quotelev1">&gt; With the modification that Ralph mentioned below, I think the patch it good
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; I see some things in here that concern me. First, there are variables
</span><br>
<span class="quotelev2">&gt; &gt; being added to functions that would appear to generate &quot;not used&quot; warnings
</span><br>
<span class="quotelev2">&gt; &gt; if ft is not enabled - they need to be properly protected. Second, I see
</span><br>
<span class="quotelev2">&gt; &gt; references like this one:
</span><br>
...
<span class="quotelev2">&gt; &gt; orte_rml_oob_module.super.ft_event(state)) ) {
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; Took me awhile to grok what you were doing with the above line - it's
</span><br>
<span class="quotelev2">&gt; &gt; actually okay, but you could avoid going thru the module dereference by
</span><br>
<span class="quotelev2">&gt; &gt; just calling
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; This doesn't seem right - if we are referencing the OOB, then we need to
</span><br>
<span class="quotelev2">&gt; &gt; go directly to it. I'll have to check/correct the code, but the RML
</span><br>
<span class="quotelev2">&gt; &gt; shouldn't even be storing a pointer to the OOB in it as there no longer is
</span><br>
<span class="quotelev2">&gt; &gt; a direct linkage.
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
...
<span class="quotelev4">&gt; &gt; &gt;&gt; * explain why mca_base_component_distill_checkpoint_ready no longer
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;                if( NULL !=
</span><br>
<span class="quotelev2">&gt; &gt; procs[p]-&gt;proc_endpoints[OMPI_PROC_ENDPOINT_TAG_BML]) {
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -                    OBJ_RELEASE((mca_bml_base_endpoint_t*)
</span><br>
<span class="quotelev2">&gt; &gt; procs[p]-&gt;proc_endpoints[OMPI_PROC_ENDPOINT_TAG_BML]);
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +
...
<span class="quotelev4">&gt; &gt; &gt;&gt;                    procs[p]-&gt;proc_endpoints[OMPI_PROC_ENDPOINT_TAG_BML]
</span><br>
...
<span class="quotelev2">&gt; &gt; btl_list[0] : &quot;&quot;);
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/opal/mca/base/mca_base_components_open.c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; @@ -141,9 +141,18 @@ static int open_components(mca_base_framework_t
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; +     * was removed by commit 8181c8273c486bba59b3dead324939eac1a58b8c
</span><br>
<span class="quotelev2">&gt; &gt; (r28237)
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +     * &quot;Introduce the MCA framework system. This formalizes the
</span><br>
<span class="quotelev2">&gt; &gt; interface frameworks must provide.&quot;
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +     *
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +     * */
...
<span class="quotelev4">&gt; &gt; &gt;&gt;    /* If mca_base_framework_register_components was called with the
</span><br>
<span class="quotelev2">&gt; &gt; MCA_BASE_COMPONENTS_ALL flag
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/opal/mca/crs/self/crs_self_component.c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;    ret = mca_base_component_var_register
</span><br>
<span class="quotelev2">&gt; &gt; (&amp;mca_crs_self_component.super.base_version,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;                                           &quot;priority&quot;, &quot;Priority of the
</span><br>
<span class="quotelev2">&gt; &gt; CRS self component &quot;
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -                                           &quot;(default: 20)&quot;,
</span><br>
<span class="quotelev2">&gt; &gt; MCA_BASE_VAR_TYPE_INT, NULL,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +                                           &quot;(default: 20)&quot;,
</span><br>
<span class="quotelev2">&gt; &gt; MCA_BASE_VAR_TYPE_INT, NULL, 0,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;                                           MCA_BASE_VAR_FLAG_SETTABLE,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -                                           OPAL_INFO_LVL_9,
</span><br>
<span class="quotelev2">&gt; &gt; MPI_BASE_VAR_SCOPE_ALL_EQ,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +                                           OPAL_INFO_LVL_9,
</span><br>
<span class="quotelev2">&gt; &gt; MCA_BASE_VAR_SCOPE_ALL_EQ,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;                                           &quot;Verbose level for the CRS
</span><br>
<span class="quotelev2">&gt; &gt; self component&quot;,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -                                           MCA_BASE_VAR_TYPE_INT,
</span><br>
<span class="quotelev2">&gt; &gt; NULL,MCA_BASE_VAR_FLAG_SETTABLE,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -                                           OPAL_INFO_LVL_9,
</span><br>
<span class="quotelev2">&gt; &gt; MPI_BASE_VAR_SCOPE_LOCAL,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +                                           MCA_BASE_VAR_TYPE_INT,
</span><br>
<span class="quotelev2">&gt; &gt; NULL, 0, MCA_BASE_VAR_FLAG_SETTABLE,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +                                           OPAL_INFO_LVL_9,
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;                                           &quot;Prefix for user defined
</span><br>
<span class="quotelev2">&gt; &gt; callback functions&quot;,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -                                           MCA_BASE_VAR_TYPE_STRING,
</span><br>
<span class="quotelev2">&gt; &gt; NULL, MCA_BASE_VAR_FLAG_SETTABLE,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -                                           OPAL_INFO_LVL_9,
...
<span class="quotelev4">&gt; &gt; &gt;&gt;                                           &quot;Start execution by calling
</span><br>
<span class="quotelev2">&gt; &gt; restart callback&quot;,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -                                           MCA_BASE_VAR_TYPE_BOOL,
</span><br>
<span class="quotelev2">&gt; &gt; NULL, MCA_BASE_VAR_FLAG_SETTABLE,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -                                           OPAL_INFO_LVL_9,
...
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/opal/tools/opal-restart/opal-restart.c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;     * restart on this node because it doesn't have the proper
</span><br>
<span class="quotelev2">&gt; &gt; checkpointer
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; +    if( OPAL_SUCCESS != (ret =
</span><br>
<span class="quotelev2">&gt; &gt; opal_crs_base_open(MCA_BASE_OPEN_DEFAULT)) ) {
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;        opal_show_help(&quot;help-opal-restart.txt&quot;, &quot;comp_select_failure&quot;,
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/orte/mca/errmgr/base/errmgr_base_fns.c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; @@ -366,7 +366,7 @@ void orte_errmgr_base_migrate_state_notify(int
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; -void orte_errmgr_base_proc_state_notify(orte_proc_state_t state,
</span><br>
<span class="quotelev2">&gt; &gt; orte_process_name_t *proc)
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +int orte_errmgr_base_proc_state_notify(orte_proc_state_t state,
</span><br>
<span class="quotelev2">&gt; &gt; orte_process_name_t *proc)
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; {
...
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/orte/mca/ess/env/ess_env_module.c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/orte/mca/plm/base/plm_base_launch_support.c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; @@ -333,6 +333,7 @@ void orte_plm_base_complete_setup(int fd, short
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/orte/mca/snapc/base/snapc_base_frame.c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; @@ -79,7 +79,7 @@ static int
</span><br>
<span class="quotelev2">&gt; &gt; orte_snapc_base_register(mca_base_register_flag_t flags)
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/orte/mca/snapc/full/snapc_full_app.c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; static orte_sstore_base_handle_t current_ss_handle =
</span><br>
<span class="quotelev2">&gt; &gt; ORTE_SSTORE_HANDLE_INVALID, last_ss_handle = ORTE_SSTORE_HANDLE_INVALID;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; @@ -1673,3 +1679,12 @@ int
</span><br>
<span class="quotelev2">&gt; &gt; app_coord_request_op(orte_snapc_base_request_op_t *datum)
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; +/* dummy implementation of a callback function to get it to compile
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/orte/mca/snapc/full/snapc_full_component.c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;    mca_base_component_t *component =
</span><br>
<span class="quotelev2">&gt; &gt; &amp;mca_snapc_full_component.super.base_version;
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;    /*
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;    /* recheck the progress meter (it may have changed between register
</span><br>
<span class="quotelev2">&gt; &gt; and open) */
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -    orte_snapc_full_progress_meter = (value % 101);
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; +    orte_snapc_full_progress_meter %= 101;
...
<span class="quotelev4">&gt; &gt; &gt;&gt; @@ -513,7 +513,7 @@ int global_coord_end_ckpt(orte_snapc_base_quiesce_t
</span><br>
<span class="quotelev2">&gt; &gt; *datum)
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;    if( currently_migrating ) {
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;        OPAL_OUTPUT_VERBOSE((10,
</span><br>
<span class="quotelev2">&gt; &gt; mca_snapc_full_component.super.output_handle,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;                             &quot;Global) End Ckpt: Flush the modex cached
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;                                 &quot;Global) Command: Job State Update
</span><br>
<span class="quotelev2">&gt; &gt; (quick)&quot;));
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; @@ -1974,7 +1974,7 @@ static void
</span><br>
<span class="quotelev2">&gt; &gt; snapc_full_process_job_update_cmd(orte_process_name_t* sender,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; @@ -1998,7 +1998,7 @@ static int snapc_full_establish_snapshot_dir(bool
</span><br>
<span class="quotelev2">&gt; &gt; empty_metadata)
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;        opal_show_help(&quot;help-orte-restart.txt&quot;, &quot;amca_param_not_found&quot;,
</span><br>
<span class="quotelev2">&gt; &gt; true);
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;    }
...
<span class="quotelev4">&gt; &gt; &gt;&gt; -        mca_base_var_get_value (idx, &amp;value, sizeof (value), NULL,
</span><br>
<span class="quotelev2">&gt; &gt; NULL);
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; @@ -1776,7 +1776,7 @@ static void snapc_full_local_comm_read_event(int
</span><br>
<span class="quotelev2">&gt; &gt; fd, short flags, void *arg)
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt;                             &quot;Local) Read Event: Flush the modex cached
</span><br>
<span class="quotelev2">&gt; &gt; data\n&quot;));
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; -        if (ORTE_SUCCESS != (ret = orte_db.remove(NULL, NULL))) {
...
<span class="quotelev4">&gt; &gt; &gt;&gt; diff --git a/orte/mca/sstore/stage/sstore_stage_component.c
</span><br>
