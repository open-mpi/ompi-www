...
?>
<!-- received="Tue Dec 10 12:10:09 2013" -->
<!-- isoreceived="20131210171009" -->
<!-- sent="Tue, 10 Dec 2013 09:09:33 -0800" -->
<!-- isosent="20131210170933" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)" -->
<!-- id="FFBBA06E-E97D-48E2-B978-30427150A11F_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="20131210105759.GH12961_at_lisas.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-10 12:09:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13412.php">Kawashima, Takahiro: "[OMPI devel] [patch] async-signal-safe signal handler"</a>
<li><strong>Previous message:</strong> <a href="13410.php">Philipp Thomas: "[OMPI devel] Test suite of openMPI 1.7.3 fails"</a>
<li><strong>In reply to:</strong> <a href="13409.php">Adrian Reber: "Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13445.php">Adrian Reber: "Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>I'll request it.
<br>
<p>On Dec 10, 2013, at 2:57 AM, Adrian Reber &lt;adrian_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I can commit it. How do I get an account?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Mon, Dec 09, 2013 at 01:54:39PM -0800, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Adrian - are you going to commit this? Or do you want one of us to do so for you?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Dec 9, 2013, at 1:39 PM, Josh Hursey &lt;jjhursey_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; With the modification that Ralph mentioned below, I think the patch it good to go.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Mon, Dec 9, 2013 at 2:19 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Dec 9, 2013, at 10:07 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I see some things in here that concern me. First, there are variables being added to functions that would appear to generate &quot;not used&quot; warnings if ft is not enabled - they need to be properly protected. Second, I see references like this one:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Took me awhile to grok what you were doing with the above line - it's actually okay, but you could avoid going thru the module dereference by just calling
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; This doesn't seem right - if we are referencing the OOB, then we need to go directly to it. I'll have to check/correct the code, but the RML shouldn't even be storing a pointer to the OOB in it as there no longer is a direct linkage.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
