...
?>
<!-- received="Sat Dec 21 18:23:47 2013" -->
<!-- isoreceived="20131221232347" -->
<!-- sent="Sun, 22 Dec 2013 00:23:44 +0100" -->
<!-- isosent="20131221232344" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] C/R code: opal_list_item_destruct: Assertion" -->
<!-- id="9B035D64-40F3-499D-B167-64F585EDA86A_at_icl.utk.edu" -->
...
<strong>Date:</strong> 2013-12-21 18:23:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13558.php">Adrian Reber: "Re: [OMPI devel] C/R code: opal_list_item_destruct: Assertion"</a>
<li><strong>Previous message:</strong> <a href="13556.php">Ralph Castain: "Re: [OMPI devel] C/R code: opal_list_item_destruct: Assertion"</a>
<li><strong>In reply to:</strong> <a href="13555.php">Adrian Reber: "[OMPI devel] C/R code: opal_list_item_destruct: Assertion"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13558.php">Adrian Reber: "Re: [OMPI devel] C/R code: opal_list_item_destruct: Assertion"</a>
<li><strong>Reply:</strong> <a href="13558.php">Adrian Reber: "Re: [OMPI devel] C/R code: opal_list_item_destruct: Assertion"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Adrian,
<br>
<p>Yes, your patch is correct. However, I noticed that each framework clean it&#146;s modules differently, so I tried to enforce some level of consistency. Please try r30045 and let me know if it fixes your issue.
<br>
<p>George.
<br>
<p><p>On Dec 21, 2013, at 22:05 , Adrian Reber &lt;adrian_at_[hidden]&gt; wrote:
<br>
