<?
$subject_val = "[OMPI devel] Problem with memory in mpi program";
...
<!-- subject="[OMPI devel] Problem with memory in mpi program" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Problem with memory in mpi program<br>
<strong>From:</strong> Yeni Lora (<em>yenisleidi.lora_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-12-18 14:37:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13472.php">Thomas Naughton: "[OMPI devel] Q: MPI-RTE / ompi_proc_t vs. ompi_process_info_t ?"</a>
<li><strong>Previous message:</strong> <a href="13470.php">Nathan Hjelm: "Re: [OMPI devel] Bus error with openmpi-1.7.4rc1 on Solaris"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
