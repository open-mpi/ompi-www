<?
$subject_val = "[OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Dec  9 08:38:03 2013" -->
<!-- isoreceived="20131209133803" -->
<!-- sent="Mon,  9 Dec 2013 14:38:02 +0100" -->
<!-- isosent="20131209133802" -->
<!-- name="Adrian Reber" -->
<!-- email="adrian_at_[hidden]" -->
<!-- subject="[OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)" -->
<!-- id="1386596282-2570-1-git-send-email-adrian_at_lisas.de" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)<br>
<strong>From:</strong> Adrian Reber (<em>adrian_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-12-09 08:38:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13402.php">Ralph Castain: "Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)"</a>
<li><strong>Previous message:</strong> <a href="13400.php">Mike Dubman: "Re: [OMPI devel] bug in mca framework?"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13402.php">Ralph Castain: "Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)"</a>
<li><strong>Reply:</strong> <a href="13402.php">Ralph Castain: "Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)"</a>
<li><strong>Reply:</strong> <a href="13403.php">Ralph Castain: "Re: [OMPI devel] [PATCH v2] Trying to get the C/R code to compile again. (last)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
