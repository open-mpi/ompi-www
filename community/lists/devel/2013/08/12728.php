...
?>
<!-- received="Thu Aug 15 12:06:32 2013" -->
<!-- isoreceived="20130815160632" -->
<!-- sent="Thu, 15 Aug 2013 16:06:28 +0000" -->
<!-- isosent="20130815160628" -->
<!-- name="Joshua Ladd" -->
<!-- email="joshual_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [EXTERNAL]  OpenSHMEM round 2" -->
<!-- id="8EDEBDDE2C39D447A738659597BBB63A22000C70_at_MTIDAG01.mtl.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="9B48CE89-7598-4D0A-8E2D-DA4BA7ECBF79_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-08-15 12:06:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12729.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL]  OpenSHMEM round 2"</a>
<li><strong>Previous message:</strong> <a href="12727.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL]  OpenSHMEM round 2"</a>
<li><strong>In reply to:</strong> <a href="12727.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL]  OpenSHMEM round 2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12729.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL]  OpenSHMEM round 2"</a>
<li><strong>Reply:</strong> <a href="12729.php">Ralph Castain: "Re: [OMPI devel] [EXTERNAL]  OpenSHMEM round 2"</a>
<li><strong>Reply:</strong> <a href="12730.php">George Bosilca: "Re: [OMPI devel] [EXTERNAL]  OpenSHMEM round 2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Subject: Re: [OMPI devel] [EXTERNAL] OpenSHMEM round 2
<br>
<p>I see the problem. Yoda is directly calling bml_get without first checking to see if the bml_btl supports rdma operations. If you only have the tcp btl, then rdma isn't supported, the bml_get function is NULL, and you segfault.
<br>
...
<span class="quotelev1">&gt; #1  0x00007fac6b8d8921 in mca_bml_base_get (bml_btl=0x239a130, 
</span><br>
<span class="quotelev1">&gt; des=0x220e880) at ../../../../ompi/mca/bml/bml.h:326
</span><br>
<span class="quotelev1">&gt; #2  0x00007fac6b8db767 in mca_spml_yoda_get (src_addr=0x601500, 
</span><br>
<span class="quotelev1">&gt; size=4, dst_addr=0x7fff3b00b370, src=1) at spml_yoda.c:1091
</span><br>
<span class="quotelev1">&gt; #3  0x00007fac6f1ea56d in shmem_int_g (addr=0x601500, pe=1) at 
</span><br>
<span class="quotelev1">&gt; shmem_g.c:47
</span><br>
...
<span class="quotelev2">&gt;&gt; bend001 running on bend002 [bend001:06590] *** Process received 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; In general, I don't have a strong opinion of whether OpenSHMEM is 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; on by default or not.  It might cause unexpected behavior for some 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; users (like on Crays, where one should really use Cray's SHMEM), 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; but maybe it's better on other platforms.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Brian observed are we on a good course to getting this upstream? 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Is it reasonable to file an RFC for three weeks out?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Josh
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ptype_get_true_extent_x_f.c:69: warning: no previous prototype 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; for 'ompi_type_get_true_extent_x_f'
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; FWIW, I couldn't get it to build - this is on a simple 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Xeon-based system under CentOS 6.2:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; spml_yoda_getreq.c:98: error: pointer targets in passing 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; spml_yoda_putreq.c:81: error: pointer targets in passing 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; argument
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 1 of 'opal_atomic_add_32' differ in signedness
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; spml_yoda.c:1107: error: pointer targets in passing argument 1 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; thing doesn't happen if the CM PML is used (at least, when 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; using the Portals
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Address not mapped (1) [shannon:90397] Failing at address: 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; (nil) [shannon:90398] *** Process received signal *** 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [shannon:90398]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Signal: Segmentation fault (11) [shannon:90398] Signal code: 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Address not mapped (1) [shannon:90398] Failing at address: 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; (nil) [shannon:90397] [ 0] /lib64/libpthread.so.0() 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [0x38b7a0f4a0] [shannon:90397] *** End of error message *** 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [shannon:90398] [ 0]
</span><br>
