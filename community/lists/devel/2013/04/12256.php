...
?>
<!-- received="Fri Apr  5 15:51:02 2013" -->
<!-- isoreceived="20130405195102" -->
<!-- sent="Fri, 5 Apr 2013 12:50:55 -0700" -->
<!-- isosent="20130405195055" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: initial MPI_T support" -->
<!-- id="3CA58140-1147-4A33-88CE-69755176AEB9_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="C04646EC-3274-43E5-96F6-FEBBD6F5D7BE_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-04-05 15:50:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12257.php">Nathan Hjelm: "Re: [OMPI devel] RFC: initial MPI_T support"</a>
<li><strong>Previous message:</strong> <a href="12255.php">Ralph Castain: "Re: [OMPI devel] RFC: initial MPI_T support"</a>
<li><strong>In reply to:</strong> <a href="12255.php">Ralph Castain: "Re: [OMPI devel] RFC: initial MPI_T support"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12257.php">Nathan Hjelm: "Re: [OMPI devel] RFC: initial MPI_T support"</a>
<li><strong>Reply:</strong> <a href="12257.php">Nathan Hjelm: "Re: [OMPI devel] RFC: initial MPI_T support"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>[rhc_at_bend001 openmpi]$ git clone  <a href="https://github.com/hjelmn/ompi-mca-var/tree/mpit-commit">https://github.com/hjelmn/ompi-mca-var/tree/mpit-commit</a>
<br>
Initialized empty Git repository in /home/common/openmpi/mpit-commit/.git/
<br>
fatal: <a href="https://github.com/hjelmn/ompi-mca-var/tree/mpit-commit/info/refs">https://github.com/hjelmn/ompi-mca-var/tree/mpit-commit/info/refs</a> not found: did you run git update-server-info on the server?
<br>
<p>Can you please let me know how I can get a copy of this code?
<br>
<p><p>On Apr 5, 2013, at 12:44 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Let's bump it to Thurs - I trust what you say, but haven't had a chance to glance at the changes. Likewise, it would be nice to let Jeff return from vacation and look at it too.
</span><br>
