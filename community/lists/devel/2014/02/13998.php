...
?>
<!-- received="Wed Feb  5 15:00:18 2014" -->
<!-- isoreceived="20140205200018" -->
<!-- sent="Wed, 5 Feb 2014 11:59:53 -0800" -->
<!-- isosent="20140205195953" -->
<!-- name="Paul Hargrove" -->
<!-- email="phhargrove_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] mpirun oddity w/ PBS on an SGI UV" -->
<!-- id="CAAvDA17q1Cjtd3vUvHqLTd_d=MW6Ght-yYo1YKD8h5QQG6eTbg_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="F3902801-A058-4191-AFC1-69E24632B72E_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-02-05 14:59:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13999.php">Ralph Castain: "Re: [OMPI devel] 1.7.4rc4 is out"</a>
<li><strong>Previous message:</strong> <a href="13997.php">Ralph Castain: "Re: [OMPI devel] mpirun oddity w/ PBS on an SGI UV"</a>
<li><strong>In reply to:</strong> <a href="13997.php">Ralph Castain: "Re: [OMPI devel] mpirun oddity w/ PBS on an SGI UV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14007.php">Paul Hargrove: "Re: [OMPI devel] mpirun oddity w/ PBS on an SGI UV"</a>
<li><strong>Reply:</strong> <a href="14007.php">Paul Hargrove: "Re: [OMPI devel] mpirun oddity w/ PBS on an SGI UV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>I will try to build tonight's trunk tarball and then test a run tomorrow.
<br>
Please ping me if I don't post my results by Thu evening (PST).
<br>
<p>-Paul
<br>
<p><p>On Wed, Feb 5, 2014 at 7:52 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I added this to the trunk in r30568 - a new MCA param &quot;ras_tm_smp_mode&quot;
</span><br>
<span class="quotelev1">&gt; will tell us to use the PBS_PPN envar to get the number of slots allocated
</span><br>
<span class="quotelev1">&gt; per node. We then just use the PBS_Nodefile to read the names of the nodes,
</span><br>
<span class="quotelev1">&gt; which I expect will be one for each partition.
</span><br>
...
<span class="quotelev1">&gt; No worries about PBS itself - better to allow you to just run this way.
</span><br>
<span class="quotelev1">&gt; Easy to add a switch for this purpose.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Using &quot;tar -d&quot; to compare that to the pristine torque-2.3.13 tarball show
</span><br>
<span class="quotelev1">&gt; the following files were modified:
</span><br>
...
<span class="quotelev1">&gt; That includes providing (off-list) the actual diffs of PSC's torque
</span><br>
<span class="quotelev1">&gt; against the tarball, if desired.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Interesting - because that isn't the standard way Torque behaves. It is
</span><br>
<span class="quotelev2">&gt;&gt; supposed to put one line/slot in the nodefile, each line containing the
</span><br>
<span class="quotelev2">&gt;&gt; name of the node. Clearly, SGI has reconfigured Torque to do something
</span><br>
...
<span class="quotelev2">&gt;&gt; So, the contents odf$PBS_NODESFILE has exactly 2 possible values, each 1
</span><br>
<span class="quotelev2">&gt;&gt; line.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; The values of PBS_PPN and PBS_NCPUS both reflect the size of the
</span><br>
<span class="quotelev2">&gt;&gt; allocation.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; At a minimum, shouldn't Open MPI be multiplying the lines in
</span><br>
<span class="quotelev2">&gt;&gt; $PBS_NODESFILE by the value of $PBS_PPN?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; No, as above, that isn't the way Torque generally behaves. It would
</span><br>
<span class="quotelev2">&gt;&gt; appear that we need a &quot;switch&quot; here to handle SGI's modifications. Should
</span><br>
<span class="quotelev2">&gt;&gt; be doable - just haven't had anyone using an SGI machine before :-)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Additionally, when I try &quot;mpirun -npernode 16 ./ring_c&quot; I am still told
</span><br>
<span class="quotelev2">&gt;&gt; there are not enough slots.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I am trying to test the trunk on an SGI UV (to validate Nathan's port of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; btl:vader to SGI's variant of xpmem).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; because that is what this installation requires (not nodes, mppnodes, or
</span><br>
<span class="quotelev3">&gt;&gt;&gt; anything like that).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; One is allocating cpus on a large shared-memory machine, not a set of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; nodes in a cluster.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; PBS_NODEFILE=/var/spool/torque/aux//
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 314827.tg-login1.blacklight.psc.teragrid.org
</span><br>
<span class="quotelev3">&gt;&gt;&gt; PBS_O_PATH=[...removed...]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If any additional info is needed to help make mpirun &quot;just work&quot;, please
</span><br>
<span class="quotelev3">&gt;&gt;&gt; let me know.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; However, at this point I am mostly interested in any work-arounds that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; will let me run something other than a singleton on this system.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-13998/attachment">attachment</a>
</ul>
