...
?>
<!-- received="Mon Feb 10 16:32:53 2014" -->
<!-- isoreceived="20140210213253" -->
<!-- sent="Mon, 10 Feb 2014 13:31:13 -0800" -->
<!-- isosent="20140210213113" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] 1.7.5 fails on simple test" -->
<!-- id="D1EE49B6-EFE8-4ED8-9D5B-C8EE37C5272C_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAAvDA17Atb1bBLY=jX3myng7_=OWwECHKtbzspbS15_ocUvYBg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-02-10 16:31:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14077.php">Ralph Castain: "Re: [OMPI devel] 1.7.5 fails on simple test"</a>
<li><strong>Previous message:</strong> <a href="14075.php">Paul Hargrove: "Re: [OMPI devel] 1.7.5 fails on simple test"</a>
<li><strong>In reply to:</strong> <a href="14075.php">Paul Hargrove: "Re: [OMPI devel] 1.7.5 fails on simple test"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14077.php">Ralph Castain: "Re: [OMPI devel] 1.7.5 fails on simple test"</a>
<li><strong>Reply:</strong> <a href="14077.php">Ralph Castain: "Re: [OMPI devel] 1.7.5 fails on simple test"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Generating it now - sorry for my lack of response, my OMPI email was down for some reason. I can now receive it, but still haven't gotten the backlog from the down period.
<br>
<p><p>On Feb 10, 2014, at 1:23 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Ralph,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; If you give me a heads-up when this makes it into a tarball, I will retest my failing ppc and sparc platforms.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; I have tracked this down.  There is a missing commit that affects ompi_mpi_init.c causing it to initialize bml twice.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; From: devel [mailto:devel-bounces_at_[hidden]] On Behalf Of Rolf vandeVaart
</span><br>
...
<span class="quotelev1">&gt; I have seen this same issue although my core dump is a little bit different.  I am running with tcp,self.  The first entry in the list of BTLs is garbage, but then there is tcp and self in the list.   Strange.  This is my core dump.  Line 208 in bml_r2.c is where I get the SEGV.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;  
...
<span class="quotelev1">&gt; Missing separate debuginfos, use: debuginfo-install glibc-2.12-1.107.el6_4.5.x86_64
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; #3  0x00007fb6e4103de2 in mca_bml_r2_add_procs (nprocs=2, procs=0x2061440, reachable=0x7fff80487b40)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; #5  0x00007fb6e8570dca in ompi_mpi_init (argc=1, argv=0x7fff80488158, requested=0, provided=0x7fff80487cc8)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; #6  0x00007fb6e85a3606 in PMPI_Init (argc=0x7fff80487d8c, argv=0x7fff80487d80) at pinit.c:84
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; #7  0x0000000000401c56 in main (argc=1, argv=0x7fff80488158) at MPI_Isend_ator_c.c:143
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; 208                 rc = btl-&gt;btl_add_procs(btl, n_new_procs, new_procs, btl_endpoints, reachable);
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; $1 = {btl_component = 0x7fb6e82ffee8, btl_eager_limit = 140423556234984, btl_rndv_eager_limit = 140423556235000,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_max_send_size = 140423556235000, btl_rdma_pipeline_send_length = 140423556235016,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_rdma_pipeline_frag_size = 140423556235016, btl_min_rdma_pipeline_size = 140423556235032,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_exclusivity = 3895459608, btl_latency = 32694, btl_bandwidth = 3895459624, btl_flags = 32694,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_seg_size = 140423556235048, btl_add_procs = 0x7fb6e82fff38 &lt;main_arena+184&gt;,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_del_procs = 0x7fb6e82fff38 &lt;main_arena+184&gt;, btl_register = 0x7fb6e82fff48 &lt;main_arena+200&gt;,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_finalize = 0x7fb6e82fff48 &lt;main_arena+200&gt;, btl_alloc = 0x7fb6e82fff58 &lt;main_arena+216&gt;,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_free = 0x7fb6e82fff58 &lt;main_arena+216&gt;, btl_prepare_src = 0x7fb6e82fff68 &lt;main_arena+232&gt;,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_prepare_dst = 0x7fb6e82fff68 &lt;main_arena+232&gt;, btl_send = 0x7fb6e82fff78 &lt;main_arena+248&gt;,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_sendi = 0x7fb6e82fff78 &lt;main_arena+248&gt;, btl_put = 0x7fb6e82fff88 &lt;main_arena+264&gt;,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_get = 0x7fb6e82fff88 &lt;main_arena+264&gt;, btl_dump = 0x7fb6e82fff98 &lt;main_arena+280&gt;,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   btl_mpool = 0x7fb6e82fff98, btl_register_error = 0x7fb6e82fffa8 &lt;main_arena+296&gt;,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-14076/attachment">attachment</a>
</ul>
