...
?>
<!-- received="Thu Feb  6 12:20:14 2014" -->
<!-- isoreceived="20140206172014" -->
<!-- sent="Thu, 6 Feb 2014 09:19:03 -0800" -->
<!-- isosent="20140206171903" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI svn] svn:open-mpi r30571 - trunk/ompi/runtime" -->
<!-- id="CEF62D33-5BAF-42E7-B615-C8EA6ABD858E_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2014-02-06 12:19:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14005.php">Joshua Ladd: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r30571 - trunk/ompi/runtime"</a>
<li><strong>Previous message:</strong> <a href="14003.php">Mike Dubman: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r30571 - trunk/ompi/runtime"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14005.php">Joshua Ladd: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r30571 - trunk/ompi/runtime"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Okay, so let's revert this commit and instead CMR over the one that includes the required code.
<br>
<p>On Feb 6, 2014, at 9:16 AM, Mike Dubman &lt;miked_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; It seems that similar code in not in v1.7 tree.
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-14004/attachment">attachment</a>
</ul>
