...
?>
<!-- received="Wed Feb 12 13:38:35 2014" -->
<!-- isoreceived="20140212183835" -->
<!-- sent="Wed, 12 Feb 2014 19:38:34 +0100" -->
<!-- isosent="20140212183834" -->
<!-- name="Adrian Reber" -->
<!-- email="adrian_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] openmpi-1.7.5a1r30692 and slurm problems" -->
<!-- id="20140212183834.GG31985_at_lisas.de" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="9330AD9A-B46A-492C-A727-DBA7FF4C938B_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-02-12 13:38:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14131.php">Ralph Castain: "Re: [OMPI devel] openmpi-1.7.5a1r30692 and slurm problems"</a>
<li><strong>Previous message:</strong> <a href="14129.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] fail when linking against libmpi.so"</a>
<li><strong>In reply to:</strong> <a href="14128.php">Ralph Castain: "Re: [OMPI devel] openmpi-1.7.5a1r30692 and slurm problems"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14131.php">Ralph Castain: "Re: [OMPI devel] openmpi-1.7.5a1r30692 and slurm problems"</a>
<li><strong>Reply:</strong> <a href="14131.php">Ralph Castain: "Re: [OMPI devel] openmpi-1.7.5a1r30692 and slurm problems"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
number of cores.
<br>
<p>On Wed, Feb 12, 2014 at 07:50:40AM -0800, Ralph Castain wrote:
<br>
<span class="quotelev1">&gt; Another possibility to check - it is entirely possible that Moab is miscommunicating the values to Slurm. You might need to check it - I'll install a copy of 2.6.5 on my machines and see if I get similar issues when Slurm does the allocation itself.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Feb 12, 2014, at 7:47 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; On Feb 12, 2014, at 7:32 AM, Adrian Reber &lt;adrian_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; salloc: Job is in held state, pending scheduler release
</span><br>
<span class="quotelev3">&gt; &gt;&gt; salloc: Pending job allocation 131828
</span><br>
<span class="quotelev3">&gt; &gt;&gt; salloc: job 131828 queued and waiting for resources
</span><br>
<span class="quotelev3">&gt; &gt;&gt; salloc: job 131828 has been allocated resources
</span><br>
<span class="quotelev3">&gt; &gt;&gt; salloc: Granted job allocation 131828
</span><br>
<span class="quotelev3">&gt; &gt;&gt; sh-4.1$ echo $SLURM_TASKS_PER_NODE 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 1
</span><br>
<span class="quotelev3">&gt; &gt;&gt; sh-4.1$ rpm -q slurm
</span><br>
<span class="quotelev3">&gt; &gt;&gt; slurm-2.6.5-1.el6.x86_64
</span><br>
<span class="quotelev3">&gt; &gt;&gt; sh-4.1$ echo $SLURM_NNODES 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 1
</span><br>
<span class="quotelev3">&gt; &gt;&gt; sh-4.1$ echo $SLURM_JOB_NODELIST 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; xxxx[107-108,176]
</span><br>
<span class="quotelev3">&gt; &gt;&gt; sh-4.1$ echo $SLURM_JOB_CPUS_PER_NODE 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 8(x3)
</span><br>
<span class="quotelev3">&gt; &gt;&gt; sh-4.1$ echo $SLURM_NODELIST 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; xxxx[107-108,176]
</span><br>
<span class="quotelev3">&gt; &gt;&gt; sh-4.1$ echo $SLURM_NPROCS  
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 1
</span><br>
<span class="quotelev3">&gt; &gt;&gt; sh-4.1$ echo $SLURM_NTASKS 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 1
</span><br>
<span class="quotelev3">&gt; &gt;&gt; sh-4.1$ echo $SLURM_TASKS_PER_NODE 
...
<span class="quotelev3">&gt; &gt;&gt; The information in *_NODELIST seems to make sense, but all the other
</span><br>
<span class="quotelev3">&gt; &gt;&gt; variables (PROCS, TASKS, NODES) report '1', which seems wrong.
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; Indeed - and that's the problem. Slurm 2.6.5 is the most recent release, and my guess is that SchedMD once again has changed the @$!#%#@ meaning of their envars. Frankly, it is nearly impossible to track all the variants they have created over the years.
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; Please check to see if someone did a little customizing on your end as sometimes people do that to Slurm. Could also be they did something in the Slurm config file that is causing the changed behavior.
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; Meantime, I'll try to ponder a potential solution in case this really is the &quot;latest&quot; Slurm screwup.
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; 
...
<span class="quotelev3">&gt; &gt;&gt; On Wed, Feb 12, 2014 at 07:19:54AM -0800, Ralph Castain wrote:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; ...and your version of Slurm?
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; On Feb 12, 2014, at 7:19 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; What is your SLURM_TASKS_PER_NODE?
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; There's got to be more to life than compile-and-go.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; _______________________________________________
</span><br>
<span class="quotelev3">&gt; &gt;&gt; devel mailing list
