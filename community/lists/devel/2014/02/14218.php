...
?>
<!-- received="Sat Feb 22 12:30:46 2014" -->
<!-- isoreceived="20140222173046" -->
<!-- sent="Sat, 22 Feb 2014 18:30:40 +0100" -->
<!-- isosent="20140222173040" -->
<!-- name="Suraj Prabhakaran" -->
<!-- email="suraj.prabhakaran_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] MPI_Comm_spawn under Torque" -->
<!-- id="1516B53C-884D-4D54-BE67-6A5A71102AA0_at_gmail.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="3E39B7ED-F3E0-4885-9EAB-8870093E87FE_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-02-22 12:30:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14219.php">Ralph Castain: "Re: [OMPI devel] MPI_Comm_spawn under Torque"</a>
<li><strong>Previous message:</strong> <a href="14217.php">Ralph Castain: "Re: [OMPI devel] MPI_Comm_spawn under Torque"</a>
<li><strong>In reply to:</strong> <a href="14217.php">Ralph Castain: "Re: [OMPI devel] MPI_Comm_spawn under Torque"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14219.php">Ralph Castain: "Re: [OMPI devel] MPI_Comm_spawn under Torque"</a>
<li><strong>Reply:</strong> <a href="14219.php">Ralph Castain: "Re: [OMPI devel] MPI_Comm_spawn under Torque"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Thanks Ralph.
<br>
<p>I cannot get rid of Torque since I am actually working on dynamic allocation of nodes for a running job on Torque. What I actually want to do is spawn processes on the dynamically assigned nodes since that is the most easiest way to expand MPI processes when a resource allocation is expanded. 
<br>
<p>I also contemplated on whether any of my changes to the Torque daemons could be the problem but it cannot be because of 2 reasons.
<br>
<p>1. For the cases which I have sent you, no dynamic allocation is done. Just using MPI_Comm_spawn on a normal allocation of resources. So my changes to torque are irrelevant here as they are not even called. 
<br>
2. Further, the processes start successfully on all the nodes. Torque logs don't report any problems and the processes do exist on all the nodes. And the fact that &quot;sometimes&quot; they work and don't have a problem! 
<br>
<p>I am not sure how many users really use MPI_Comm_spawn (spawning large processes) under the Torque environment to actually not such a problem. Because, mpiexec works just fine for any number of processes. 
<br>
<p>Any suggestions or hints on this would be highly appreciated. OpenMPI also seems to be the only implementation we can use for this work at the moment because of the &quot;add-host&quot; info argument for MPI_Comm_spawn which we are using comfortably when spawning onto dynamically allocated hosts which were not a part of the original allocation. 
<br>
<p>Best,
<br>
Suraj
<br>
<p><p>On Feb 22, 2014, at 4:30 PM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Feb 21, 2014, at 5:55 PM, Suraj Prabhakaran &lt;suraj.prabhakaran_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Hmm.. but in actual the MPI_Comm_spawn of parents and MPI_Init of children never returned!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Understood - my point was that the output shows no errors or issues. For some reason, the progress thread appears to just stop. This usually indicates some kind of recursive behavior, but that isn't showing up in the output.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I configured MPI with 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; ./configure --prefix=/dir/ --enable-debug --with-tm=/usr/local/
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Should be fine. I don't have access to a Torque-based system, and we aren't hearing issues from other Torque users, so this may have something to do with how Torque is configured on your system. Perhaps someone with a Torque-based system on the list could also test this?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Meantime, I would suggest just using rsh/ssh (since you said that works) for now as Torque really isn't doing anything for you in this use-case.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt;&gt; On Feb 22, 2014, at 12:53 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Strange - it all looks just fine. How was OMPI configured?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Feb 21, 2014, at 3:31 PM, Suraj Prabhakaran &lt;suraj.prabhakaran_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Ok, I figured out that it was not a problem with the node grsacc04 because I now conducted the same on totally different set of nodes. 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I must really say that with --bind-to none option, the program completed &quot;many&quot; times compared to earlier but still &quot;sometimes&quot; it hangs! Attaching now the output of the same case conducted on different set of nodes with the --bind-to none option.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpiexec  -mca plm_base_verbose 5 -mca ess_base_verbose 5 -mca grpcomm_base_verbose 5 --bind-to none -np 3 ./example
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;output.rtf&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Feb 21, 2014, at 5:03 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Well, that all looks fine. However, I note that the procs on grsacc04 all stopped making progress at the same point, which is why the job hung. All the procs on the other nodes were just fine.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
