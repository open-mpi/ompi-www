<?
$subject_val = "[OMPI devel] v1.7.5a1(regresion): MPI_Init crash on ppc/linux and sparc/solaris";
include("../../include/msg-header.inc");
?>
<!-- received="Sun Feb  9 19:05:49 2014" -->
<!-- isoreceived="20140210000549" -->
<!-- sent="Sun, 9 Feb 2014 16:05:45 -0800" -->
<!-- isosent="20140210000545" -->
<!-- name="Paul Hargrove" -->
<!-- email="phhargrove_at_[hidden]" -->
<!-- subject="[OMPI devel] v1.7.5a1(regresion): MPI_Init crash on ppc/linux and sparc/solaris" -->
<!-- id="CAAvDA17d8zDv_9Qm+jHixpVAS86MvRTK7fr3XQ3sLjPkL+ozAg_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] v1.7.5a1(regresion): MPI_Init crash on ppc/linux and sparc/solaris<br>
<strong>From:</strong> Paul Hargrove (<em>phhargrove_at_[hidden]</em>)<br>
<strong>Date:</strong> 2014-02-09 19:05:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14065.php">Paul Hargrove: "[OMPI devel] [PATCH] Re: Still having issues w/ opal_path_nfs and EPERM"</a>
<li><strong>Previous message:</strong> <a href="14063.php">Paul Hargrove: "Re: [OMPI devel] v1.7.5a1: mpirun failure on ppc/linux (regression vs 1.7.4)"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I alluded in an earlier email to problems on SPARC/Solaris that I had yet
<br>
to triage.
<br>
It turns out the problem there is the same as on ppc/linux.
<br>
<p><span class="quotelev1">&gt;From a core generated by ring_c run without mpirun:
</span><br>
<p>&nbsp;&nbsp;[1] strcmp(0x100274390, 0x48, 0x100274347, 0x1, 0x8080808080808080,
<br>
0x101010101010101), at 0xffffffff7f13af04
<br>
=&gt;[2] mca_bml_r2_add_btls(), line 103 in &quot;bml_r2.c&quot;
<br>
&nbsp;&nbsp;[3] mca_bml_r2_add_procs(nprocs = 1U, procs = 0x100254230, reachable =
<br>
0xffffffff7ffff400), line 156 in &quot;bml_r2.c&quot;
<br>
&nbsp;&nbsp;[4] mca_pml_ob1_add_procs(procs = 0x100254230, nprocs = 1U), line 334 in
<br>
&quot;pml_ob1.c&quot;
<br>
&nbsp;&nbsp;[5] ompi_mpi_init(argc = 1, argv = 0xffffffff7ffff848, requested = 0,
<br>
provided = 0xffffffff7ffff684), line 776 in &quot;ompi_mpi_init.c&quot;
<br>
&nbsp;&nbsp;[6] PMPI_Init(argc = 0xffffffff7ffff78c, argv = 0xffffffff7ffff780), line
<br>
84 in &quot;pinit.c&quot;
<br>
&nbsp;&nbsp;[7] main(argc = 1, argv = 0xffffffff7ffff848), line 19 in &quot;ring_c.c&quot;
<br>
<p>The backtrace when run via mpirun (either &quot;-np 1&quot; or &quot;-np 2&quot;) shows the
<br>
same stack for all but frame 2, for which there is no function name.
<br>
<p>-Paul
<br>
<p><p>On Sun, Feb 9, 2014 at 2:35 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Below is some info collected from a core generated from running ring_c
</span><br>
<span class="quotelev1">&gt; without mpirun.
</span><br>
<span class="quotelev1">&gt; It looks like a bogus btl_module pointer or corrupted object is the
</span><br>
...
<span class="quotelev1">&gt; #2  0x00000fffa1490f1c in mca_bml_r2_add_procs (nprocs=1,
</span><br>
...
<span class="quotelev1">&gt; #3  0x00000fffa169df3c in mca_pml_ob1_add_procs (procs=0x1002b1ebac0,
</span><br>
...
<span class="quotelev1">&gt; #4  0x00000fffa13b11f0 in ompi_mpi_init (argc=1, argv=0xfffed51b778,
</span><br>
...
<span class="quotelev1">&gt; #5  0x00000fffa13ff670 in PMPI_Init (argc=0xfffed51b360,
</span><br>
...
<span class="quotelev1">&gt; 100             for (i = 0; NULL != btl_names_argv &amp;&amp; NULL !=
</span><br>
...
<span class="quotelev1">&gt; $4 = {btl_component = 0x0, btl_eager_limit = 33, btl_rndv_eager_limit =
</span><br>
<span class="quotelev1">&gt; 5715139723404663124,
</span><br>
<span class="quotelev1">&gt;   btl_max_send_size = 4998801257537028948, btl_rdma_pipeline_send_length =
</span><br>
<span class="quotelev1">&gt; 32,
</span><br>
<span class="quotelev1">&gt;   btl_rdma_pipeline_frag_size = 113, btl_min_rdma_pipeline_size =
</span><br>
<span class="quotelev1">&gt; 16046253926196952813,
</span><br>
<span class="quotelev1">&gt;   btl_exclusivity = 4095, btl_latency = 2700574648, btl_bandwidth = 1,
</span><br>
<span class="quotelev1">&gt; btl_flags = 1886351212,
</span><br>
<span class="quotelev1">&gt;   btl_seg_size = 17590591428656, btl_add_procs = 0x1af00000000,
</span><br>
<span class="quotelev1">&gt; btl_del_procs = 0xfffa0dc5b80,
</span><br>
<span class="quotelev1">&gt;   btl_register = 0xfffa0dc5b80, btl_finalize = 0x100000001, btl_alloc =
</span><br>
<span class="quotelev1">&gt; 0xfffa0dc5b58,
</span><br>
<span class="quotelev1">&gt;   btl_free = 0x1002b1d0760, btl_prepare_src = 0x25, btl_prepare_dst =
</span><br>
<span class="quotelev1">&gt; 0x221, btl_send = 0, btl_sendi = 0x31,
</span><br>
<span class="quotelev1">&gt;   btl_put = 0x62746c5f75736e69, btl_get = 0x635f77616e745f6e, btl_dump =
</span><br>
<span class="quotelev1">&gt; 0x756d615f64657669,
</span><br>
<span class="quotelev1">&gt;   btl_mpool = 0x63655f6173736967, btl_register_error = 0x6e6d656e74000000,
</span><br>
<span class="quotelev1">&gt; btl_ft_event = 0x31}
</span><br>
<span class="quotelev1">&gt; [...]
</span><br>
<span class="quotelev1">&gt; (gdb) print btl
...
<span class="quotelev1">&gt; $11 = {super = {super = {obj_magic_id = 16046253926196952813, obj_class =
</span><br>
<span class="quotelev1">&gt; 0xfffa17bf290,
</span><br>
<span class="quotelev1">&gt;       obj_reference_count = 1,
</span><br>
<span class="quotelev1">&gt;       cls_init_file_name = 0xfffa173e6e0
</span><br>
...
<span class="quotelev1">&gt;     opal_list_prev = 0x1002b1c1eb0, item_free = 1, opal_list_item_refcount
</span><br>
<span class="quotelev1">&gt; = 1,
</span><br>
<span class="quotelev1">&gt;     opal_list_item_belong_to = 0xfffa18b59a0}, btl_component =
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-14064/attachment">attachment</a>
</ul>
