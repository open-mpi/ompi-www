...
?>
<!-- received="Mon Feb 10 17:34:30 2014" -->
<!-- isoreceived="20140210223430" -->
<!-- sent="Mon, 10 Feb 2014 14:34:20 -0800" -->
<!-- isosent="20140210223420" -->
<!-- name="Paul Hargrove" -->
<!-- email="phhargrove_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] 1.7.5 fails on simple test" -->
<!-- id="CAAvDA15Dq5hSjfptWbAjRNkVB9xp00gSnSmKaU+sWxWhBGwEkA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="555CE733-9252-47CD-A486-85C95DAD4D3C_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-02-10 17:34:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14081.php">George Bosilca: "Re: [OMPI devel] RFC: optimize probe in ob1"</a>
<li><strong>Previous message:</strong> <a href="14079.php">Andreas Sch&#228;fer: "Re: [OMPI devel] Reviewing MPI_Dims_create"</a>
<li><strong>In reply to:</strong> <a href="14077.php">Ralph Castain: "Re: [OMPI devel] 1.7.5 fails on simple test"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14091.php">Paul Hargrove: "Re: [OMPI devel] 1.7.5 fails on simple test"</a>
<li><strong>Reply:</strong> <a href="14091.php">Paul Hargrove: "Re: [OMPI devel] 1.7.5 fails on simple test"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>-Paul
<br>
<p><p>On Mon, Feb 10, 2014 at 1:52 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Tarball is now posted
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Feb 10, 2014, at 1:31 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Generating it now - sorry for my lack of response, my OMPI email was down
</span><br>
<span class="quotelev1">&gt; for some reason. I can now receive it, but still haven't gotten the backlog
</span><br>
<span class="quotelev1">&gt; from the down period.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; If you give me a heads-up when this makes it into a tarball, I will retest
</span><br>
<span class="quotelev1">&gt; my failing ppc and sparc platforms.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Mon, Feb 10, 2014 at 1:13 PM, Rolf vandeVaart &lt;rvandevaart_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I have tracked this down.  There is a missing commit that affects
</span><br>
<span class="quotelev2">&gt;&gt; ompi_mpi_init.c causing it to initialize bml twice.
</span><br>
...
<span class="quotelev2">&gt;&gt; *From:* devel [mailto:devel-bounces_at_[hidden]] *On Behalf Of *Rolf
</span><br>
...
<span class="quotelev2">&gt;&gt; I have seen this same issue although my core dump is a little bit
</span><br>
<span class="quotelev2">&gt;&gt; different.  I am running with tcp,self.  The first entry in the list of
</span><br>
<span class="quotelev2">&gt;&gt; BTLs is garbage, but then there is tcp and self in the list.   Strange.
</span><br>
<span class="quotelev2">&gt;&gt; This is my core dump.  Line 208 in bml_r2.c is where I get the SEGV.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; glibc-2.12-1.107.el6_4.5.x86_64
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; #3  0x00007fb6e4103de2 in mca_bml_r2_add_procs (nprocs=2,
</span><br>
<span class="quotelev2">&gt;&gt; procs=0x2061440, reachable=0x7fff80487b40)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; #4  0x00007fb6df50a751 in mca_pml_ob1_add_procs (procs=0x2060bc0,
</span><br>
...
<span class="quotelev2">&gt;&gt; #5  0x00007fb6e8570dca in ompi_mpi_init (argc=1, argv=0x7fff80488158,
</span><br>
<span class="quotelev2">&gt;&gt; requested=0, provided=0x7fff80487cc8)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; #6  0x00007fb6e85a3606 in PMPI_Init (argc=0x7fff80487d8c,
</span><br>
<span class="quotelev2">&gt;&gt; argv=0x7fff80487d80) at pinit.c:84
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; #7  0x0000000000401c56 in main (argc=1, argv=0x7fff80488158) at
</span><br>
<span class="quotelev2">&gt;&gt; MPI_Isend_ator_c.c:143
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; 208                 rc = btl-&gt;btl_add_procs(btl, n_new_procs, new_procs,
</span><br>
<span class="quotelev2">&gt;&gt; btl_endpoints, reachable);
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; $1 = {btl_component = 0x7fb6e82ffee8, btl_eager_limit = 140423556234984,
</span><br>
<span class="quotelev2">&gt;&gt; btl_rndv_eager_limit = 140423556235000,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_max_send_size = 140423556235000, btl_rdma_pipeline_send_length =
</span><br>
<span class="quotelev2">&gt;&gt; 140423556235016,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_rdma_pipeline_frag_size = 140423556235016,
</span><br>
<span class="quotelev2">&gt;&gt; btl_min_rdma_pipeline_size = 140423556235032,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_exclusivity = 3895459608, btl_latency = 32694, btl_bandwidth =
</span><br>
<span class="quotelev2">&gt;&gt; 3895459624, btl_flags = 32694,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_seg_size = 140423556235048, btl_add_procs = 0x7fb6e82fff38
</span><br>
<span class="quotelev2">&gt;&gt; &lt;main_arena+184&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_del_procs = 0x7fb6e82fff38 &lt;main_arena+184&gt;, btl_register =
</span><br>
<span class="quotelev2">&gt;&gt; 0x7fb6e82fff48 &lt;main_arena+200&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_finalize = 0x7fb6e82fff48 &lt;main_arena+200&gt;, btl_alloc =
</span><br>
<span class="quotelev2">&gt;&gt; 0x7fb6e82fff58 &lt;main_arena+216&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_free = 0x7fb6e82fff58 &lt;main_arena+216&gt;, btl_prepare_src =
</span><br>
<span class="quotelev2">&gt;&gt; 0x7fb6e82fff68 &lt;main_arena+232&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_prepare_dst = 0x7fb6e82fff68 &lt;main_arena+232&gt;, btl_send =
</span><br>
<span class="quotelev2">&gt;&gt; 0x7fb6e82fff78 &lt;main_arena+248&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_sendi = 0x7fb6e82fff78 &lt;main_arena+248&gt;, btl_put = 0x7fb6e82fff88
</span><br>
<span class="quotelev2">&gt;&gt; &lt;main_arena+264&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_get = 0x7fb6e82fff88 &lt;main_arena+264&gt;, btl_dump = 0x7fb6e82fff98
</span><br>
<span class="quotelev2">&gt;&gt; &lt;main_arena+280&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;   btl_mpool = 0x7fb6e82fff98, btl_register_error = 0x7fb6e82fffa8
</span><br>
<span class="quotelev2">&gt;&gt; &lt;main_arena+296&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; *On Behalf Of *Mike Dubman
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-14080/attachment">attachment</a>
</ul>
