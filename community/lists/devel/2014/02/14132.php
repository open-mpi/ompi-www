...
?>
<!-- received="Wed Feb 12 14:03:51 2014" -->
<!-- isoreceived="20140212190351" -->
<!-- sent="Wed, 12 Feb 2014 11:03:47 -0800" -->
<!-- isosent="20140212190347" -->
<!-- name="Paul Hargrove" -->
<!-- email="phhargrove_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] v1.7.5a1: mpirun failure on ppc/linux (regression vs 1.7.4)" -->
<!-- id="CAAvDA15d7P5eALHb=LZ1kVxYcG8C81ypyVi534wboB4qJRcfMw_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2014-02-12 14:03:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14133.php">Ralph Castain: "Re: [OMPI devel] v1.7.4, mpiexec &quot;exit 1&quot; and no other warning - behaviour changed to previous versions"</a>
<li><strong>Previous message:</strong> <a href="14131.php">Ralph Castain: "Re: [OMPI devel] openmpi-1.7.5a1r30692 and slurm problems"</a>
...
<p>-Paul
<br>
<p><p>On Wed, Feb 12, 2014 at 5:58 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]
<br>
...
<span class="quotelev2">&gt; &gt; Below is some info collected from a core generated from running ring_c
</span><br>
<span class="quotelev1">&gt; without mpirun.
</span><br>
<span class="quotelev2">&gt; &gt; It looks like a bogus btl_module pointer or corrupted object is the
</span><br>
<span class="quotelev1">&gt; culprit in this crash.
</span><br>
...
<span class="quotelev1">&gt; glibc-2.12-1.47.el6_2.5.ppc64 libibverbs-1.1.5-3.el6.ppc64
</span><br>
<span class="quotelev1">&gt; librdmacm-1.0.14.1-3.el6.ppc64 numactl-2.0.3-9.el6.ppc64
</span><br>
<span class="quotelev1">&gt; sssd-client-1.5.1-66.el6_2.3.ppc64
</span><br>
...
<span class="quotelev1">&gt; /home/hargrov1/OMPI/openmpi-1.7-latest-linux-ppc64-gcc/openmpi-1.7.5a1r30639/ompi/mca/bml/r2/bml_r2.c:101
</span><br>
<span class="quotelev2">&gt; &gt; #2  0x00000fffa1490f1c in mca_bml_r2_add_procs (nprocs=1,
</span><br>
<span class="quotelev1">&gt; procs=0x1002b1ebac0, reachable=0xfffed51b058)
</span><br>
<span class="quotelev2">&gt; &gt;     at
</span><br>
<span class="quotelev1">&gt; /home/hargrov1/OMPI/openmpi-1.7-latest-linux-ppc64-gcc/openmpi-1.7.5a1r30639/ompi/mca/bml/r2/bml_r2.c:156
</span><br>
<span class="quotelev2">&gt; &gt; #3  0x00000fffa169df3c in mca_pml_ob1_add_procs (procs=0x1002b1ebac0,
</span><br>
<span class="quotelev1">&gt; nprocs=1)
</span><br>
<span class="quotelev2">&gt; &gt;     at
</span><br>
<span class="quotelev1">&gt; /home/hargrov1/OMPI/openmpi-1.7-latest-linux-ppc64-gcc/openmpi-1.7.5a1r30639/ompi/mca/pml/ob1/pml_ob1.c:332
</span><br>
<span class="quotelev2">&gt; &gt; #4  0x00000fffa13b11f0 in ompi_mpi_init (argc=1, argv=0xfffed51b778,
</span><br>
<span class="quotelev1">&gt; requested=0, provided=0xfffed51b264)
</span><br>
<span class="quotelev2">&gt; &gt;     at
</span><br>
<span class="quotelev1">&gt; /home/hargrov1/OMPI/openmpi-1.7-latest-linux-ppc64-gcc/openmpi-1.7.5a1r30639/ompi/runtime/ompi_mpi_init.c:776
</span><br>
<span class="quotelev2">&gt; &gt; #5  0x00000fffa13ff670 in PMPI_Init (argc=0xfffed51b360,
</span><br>
<span class="quotelev1">&gt; argv=0xfffed51b368) at pinit.c:84
</span><br>
<span class="quotelev2">&gt; &gt; #6  0x00000000100009ac in main (argc=1, argv=0xfffed51b778) at
</span><br>
...
<span class="quotelev2">&gt; &gt; 96              selected_btl !=
</span><br>
<span class="quotelev1">&gt; (mca_btl_base_selected_module_t*)opal_list_get_end(btls);
</span><br>
<span class="quotelev2">&gt; &gt; 97              selected_btl =
</span><br>
<span class="quotelev1">&gt;  (mca_btl_base_selected_module_t*)opal_list_get_next(selected_btl)) {
</span><br>
<span class="quotelev2">&gt; &gt; 98              mca_btl_base_module_t *btl = selected_btl-&gt;btl_module;
</span><br>
<span class="quotelev2">&gt; &gt; 99              mca_bml_r2.btl_modules[mca_bml_r2.num_btl_modules++] =
</span><br>
<span class="quotelev1">&gt; btl;
</span><br>
<span class="quotelev2">&gt; &gt; 100             for (i = 0; NULL != btl_names_argv &amp;&amp; NULL !=
</span><br>
<span class="quotelev1">&gt; btl_names_argv[i]; ++i) {
</span><br>
<span class="quotelev2">&gt; &gt; 101                 if (0 ==
</span><br>
...
<span class="quotelev2">&gt; &gt; $4 = {btl_component = 0x0, btl_eager_limit = 33, btl_rndv_eager_limit =
</span><br>
<span class="quotelev1">&gt; 5715139723404663124,
</span><br>
<span class="quotelev2">&gt; &gt;   btl_max_send_size = 4998801257537028948, btl_rdma_pipeline_send_length
</span><br>
<span class="quotelev1">&gt; = 32,
</span><br>
<span class="quotelev2">&gt; &gt;   btl_rdma_pipeline_frag_size = 113, btl_min_rdma_pipeline_size =
</span><br>
<span class="quotelev1">&gt; 16046253926196952813,
</span><br>
<span class="quotelev2">&gt; &gt;   btl_exclusivity = 4095, btl_latency = 2700574648, btl_bandwidth = 1,
</span><br>
<span class="quotelev1">&gt; btl_flags = 1886351212,
</span><br>
<span class="quotelev2">&gt; &gt;   btl_seg_size = 17590591428656, btl_add_procs = 0x1af00000000,
</span><br>
<span class="quotelev1">&gt; btl_del_procs = 0xfffa0dc5b80,
</span><br>
<span class="quotelev2">&gt; &gt;   btl_register = 0xfffa0dc5b80, btl_finalize = 0x100000001, btl_alloc =
</span><br>
<span class="quotelev1">&gt; 0xfffa0dc5b58,
</span><br>
<span class="quotelev2">&gt; &gt;   btl_free = 0x1002b1d0760, btl_prepare_src = 0x25, btl_prepare_dst =
</span><br>
<span class="quotelev1">&gt; 0x221, btl_send = 0, btl_sendi = 0x31,
</span><br>
<span class="quotelev2">&gt; &gt;   btl_put = 0x62746c5f75736e69, btl_get = 0x635f77616e745f6e, btl_dump =
</span><br>
<span class="quotelev1">&gt; 0x756d615f64657669,
</span><br>
<span class="quotelev2">&gt; &gt;   btl_mpool = 0x63655f6173736967, btl_register_error =
</span><br>
<span class="quotelev1">&gt; 0x6e6d656e74000000, btl_ft_event = 0x31}
</span><br>
<span class="quotelev2">&gt; &gt; [...]
</span><br>
<span class="quotelev2">&gt; &gt; (gdb) print btl
...
<span class="quotelev2">&gt; &gt; $11 = {super = {super = {obj_magic_id = 16046253926196952813, obj_class
</span><br>
<span class="quotelev1">&gt; = 0xfffa17bf290,
</span><br>
<span class="quotelev2">&gt; &gt;       obj_reference_count = 1,
</span><br>
<span class="quotelev2">&gt; &gt;       cls_init_file_name = 0xfffa173e6e0
</span><br>
<span class="quotelev1">&gt; &quot;/home/hargrov1/OMPI/openmpi-1.7-latest-linux-ppc64-gcc/openmpi-1.7.5a1r30639/ompi/mca/btl/base/btl_base_select.c&quot;,
</span><br>
<span class="quotelev1">&gt; cls_init_lineno = 139}, opal_list_next = 0xfffa18b59c8,
</span><br>
<span class="quotelev2">&gt; &gt;     opal_list_prev = 0x1002b1c1eb0, item_free = 1,
</span><br>
<span class="quotelev1">&gt; opal_list_item_refcount = 1,
</span><br>
<span class="quotelev2">&gt; &gt;     opal_list_item_belong_to = 0xfffa18b59a0}, btl_component =
</span><br>
<span class="quotelev1">&gt; 0xfffa17c2570, btl_module = 0x1002b1d03d0}
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; On Sun, Feb 9, 2014 at 12:32 AM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt; I have tried building the current v1.7 tarball (1.7.5a1r30639) with gcc
</span><br>
<span class="quotelev1">&gt; on two ppc64/linux machines and one ppc32/linux.  All three die in MPI_Init
</span><br>
<span class="quotelev1">&gt; when I try to run ring_c.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; I've retested 1.7.4 on both ppc64 machines, and thankfully the problem
</span><br>
<span class="quotelev1">&gt; is not present.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev1">&gt; /lib64/libc.so.6(__libc_start_main-0x15730c)[0x804a8299b4]
</span><br>
...
<span class="quotelev1">&gt; (!prev): 0x101b5560 ***
</span><br>
<span class="quotelev2">&gt; &gt; ======= Backtrace: =========
</span><br>
...
<span class="quotelev1">&gt; memory initialization that should unlink failed.
</span><br>
...
<span class="quotelev2">&gt; &gt; mpirun noticed that process rank 1 with PID 2574 on node pcp-k-421
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-14132/attachment">attachment</a>
</ul>
