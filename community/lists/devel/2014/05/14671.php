...
?>
<!-- received="Thu May  1 00:31:44 2014" -->
<!-- isoreceived="20140501043144" -->
<!-- sent="Wed, 30 Apr 2014 21:31:35 -0700" -->
<!-- isosent="20140501043135" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI svn] svn:open-mpi r31577	- trunk/ompi/mca/rte/base" -->
<!-- id="46AABB00-0A84-405C-8B67-80CE1814D69A_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="A640387C-6983-43FF-8641-A73030F9AD53_at_icl.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-05-01 00:31:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14672.php">VandeVondele  Joost: "Re: [OMPI devel] memory leaks upon dup/split/create	of	communicators?"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/devel/2014/04/14670.php">George Bosilca: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r31577	- trunk/ompi/mca/rte/base"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/devel/2014/04/14670.php">George Bosilca: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r31577	- trunk/ompi/mca/rte/base"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14673.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI svn] svn:open-mpi r31577	-	trunk/ompi/mca/rte/base"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Even simpler solution: revert back to the initial agreement made when we created the RTE abstraction that the process name is 64-bits and the problem goes away. If/when someone comes along who truly needs something else, and can make a compelling case for the change, then we can worry about complicating things. Why make life harder in the meantime? I think we all have higher priority work on our plate.
<br>
<p><p>Jeff and others are using opal_dstore to retrieve the ompi_process_name_t of another process - in Jeff's case, it is local_rank=0 for this node. So he asks for the local &quot;leader&quot; for his proc, and gets the other proc's name back.
<br>
<p><p>On Apr 30, 2014, at 7:06 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Another solution will be to get rid of ompi_process_name_t and use everywhere the opal_identifier_t. We can shift the responsibility to convert between this unique identifier (and we have 64 bits to ensure uniqueness) and the orte_process_name_t to the RTE. Similar to the opal_help we can implement:
</span><br>
<span class="quotelev1">&gt; - a naming function converting an opal_identifier_t into a const string
</span><br>
<span class="quotelev1">&gt; - a comparaison function comparing two opal_identifier_t for identical jobid, and so on
</span><br>
<span class="quotelev1">&gt; - maybe an accessor for the jobid/vpid.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; These function will default to some trivial local information, but will be changed by the RTE ASAP, allowing simple and flexible access to the RTE naming scheme. Moreover, this information will only be used sporadically (during connection setup and error reporting), so using functions will not have a significant overhead. Btw, this is the approach I implemented into the OPAL BTL branch, and seems to work pretty well so far.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Apr 30, 2014, at 22:01 , George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Apr 30, 2014, at 20:04 , Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; All we need in usnic is the ompi_process_name_t of the local process leader.  However that happens is fine with me.  :-)
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Apr 30, 2014, at 6:46 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; George makes a fair point - I was unaware they were hashing down to the opal_identifier_t. Only real requirement is that there be some way to reduce to 64-bits when accessing the common data.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I think the usnic BTL may have an issue with that approach, so maybe some way of &quot;unhashing&quot; will be required?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Apr 30, 2014, at 3:42 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Apr 30, 2014, at 6:35 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/04/14667.php">http://www.open-mpi.org/community/lists/devel/2014/04/14667.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/04/14668.php">http://www.open-mpi.org/community/lists/devel/2014/04/14668.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/04/14670.php">http://www.open-mpi.org/community/lists/devel/2014/04/14670.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-14671/attachment">attachment</a>
</ul>
