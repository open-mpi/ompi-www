...
?>
<!-- received="Thu May  1 09:43:57 2014" -->
<!-- isoreceived="20140501134357" -->
<!-- sent="Thu, 1 May 2014 06:43:48 -0700" -->
<!-- isosent="20140501134348" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI svn] svn:open-mpi r31577	-	trunk/ompi/mca/rte/base" -->
<!-- id="FABF0DF2-41BF-4134-87A7-D211FDCF042A_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="E61BFA9F-F1BA-4BE3-9982-AEB045D2BF12_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-05-01 09:43:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14675.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI svn] svn:open-mpi	r31577	-	trunk/ompi/mca/rte/base"</a>
<li><strong>Previous message:</strong> <a href="14673.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI svn] svn:open-mpi r31577	-	trunk/ompi/mca/rte/base"</a>
<li><strong>In reply to:</strong> <a href="14673.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI svn] svn:open-mpi r31577	-	trunk/ompi/mca/rte/base"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14675.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI svn] svn:open-mpi	r31577	-	trunk/ompi/mca/rte/base"</a>
<li><strong>Reply:</strong> <a href="14675.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [OMPI svn] svn:open-mpi	r31577	-	trunk/ompi/mca/rte/base"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>For example, suppose I define ompi_process_name_t to be a string. I can hash the string down to an opal_identifier_t, but that is a structureless 64-bit value - there is no concept of a jobid or vpid in it. So if you now want to extract a jobid for that identifier, the only way you can do it is to &quot;up-call&quot; back to the RTE to parse it.
<br>
<p>This means that every RTE would have to initialize OPAL with a registration of its opal_identifier parser function(s), which seems like a really ugly solution.
<br>
<p>Maybe it is time to shift the process identifier down to the opal layer? If we define opal_identifier_t to include the required jobid/vpid, perhaps adding a void* so someone can put whatever they want in it?
<br>
<p>Note that I'm not wild about extending the identifier size beyond 64-bits as the memory footprint issue is growing in concern, and I still haven't seen any real use-case proposed for extending it.
<br>
<p><p>On May 1, 2014, at 3:41 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; On Apr 30, 2014, at 10:01 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
