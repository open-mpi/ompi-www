...
?>
<!-- received="Sat May 31 10:32:11 2014" -->
<!-- isoreceived="20140531143211" -->
<!-- sent="Sat, 31 May 2014 14:32:07 +0000" -->
<!-- isosent="20140531143207" -->
...
<!-- id="3647E454F318284EAF10851638CD92520638CBF8_at_UUSNWE1M.na.utcmail.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="D02D7FA8-A7E7-4C23-934E-175ACE4605D8_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-05-31 10:32:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14918.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [External] Re: Open	MPI	1.6.5	opal_paffinity_base_get_physical_socket_id"</a>
<li><strong>Previous message:</strong> <a href="14916.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Open MPI 1.6.5	opal_paffinity_base_get_physical_socket_id"</a>
<li><strong>In reply to:</strong> <a href="14916.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] Open MPI 1.6.5	opal_paffinity_base_get_physical_socket_id"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14918.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [External] Re: Open	MPI	1.6.5	opal_paffinity_base_get_physical_socket_id"</a>
<li><strong>Reply:</strong> <a href="14918.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] [External] Re: Open	MPI	1.6.5	opal_paffinity_base_get_physical_socket_id"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I'm installing mpi 1.8.1 now to see if I see the same issue.
<br>
<p>I just installed and ran hwloc.  What am I looking for?  I see basic information PCI (ib0, ib1, mix4_0) PCI(eth0) PCI(eth1) PCI() PCI(sda)  and others...
<br>
<p>When I launch the mpi process I'm using mpirun --mca btl self,sm,openib
<br>
<p>I have not explicitly specified in mpirun to use processor affinity.  When running top (1) I do see that the processes migrate from core to core from time to time.  Am I using processor affinity and if so shouldn't the process(s) remain on each individual core throughout execution?  Hyperthreading is off.  I am not using a rank file nor specifying the mpirun command to explicitly use processor affinity.
<br>
<p>skl
<br>
860-557-2895
...
<br>
<p>The super short answer is: 1.6.x is old and deprecated; can you upgrade to the 1.8.x series?
<br>
...
<span class="quotelev1">&gt; opal_paffinity_base_get_physical_socket_id (libmpi.so.1.0.8: 
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/05/14915.php">http://www.open-mpi.org/community/lists/devel/2014/05/14915.php</a>
</span><br>
<p><p><pre>
--
Jeff Squyres
...
Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/05/14916.php">http://www.open-mpi.org/community/lists/devel/2014/05/14916.php</a>
</pre>
<!-- body="end" -->
<hr>
<ul class="links">
