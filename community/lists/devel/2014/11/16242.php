...
?>
<!-- received="Thu Nov  6 14:15:14 2014" -->
<!-- isoreceived="20141106191514" -->
<!-- sent="Thu, 6 Nov 2014 12:15:13 -0700" -->
<!-- isosent="20141106191513" -->
<!-- name="Howard Pritchard" -->
<!-- email="hppritcha_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: revamp btl rdma interface" -->
<!-- id="CAF1Cqj4MGYs8CdvGOP7rNi4ikebjpiHCxqtSk42GYUsyk5dQ0Q_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="20141106190801.GR6508_at_pn1246003.lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-06 14:15:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16243.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] thread-tests hang"</a>
<li><strong>Previous message:</strong> <a href="16241.php">Nathan Hjelm: "Re: [OMPI devel] RFC: revamp btl rdma interface"</a>
<li><strong>In reply to:</strong> <a href="16241.php">Nathan Hjelm: "Re: [OMPI devel] RFC: revamp btl rdma interface"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16244.php">Nathan Hjelm: "Re: [OMPI devel] RFC: revamp btl rdma interface"</a>
<li><strong>Reply:</strong> <a href="16244.php">Nathan Hjelm: "Re: [OMPI devel] RFC: revamp btl rdma interface"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
HI Nathan,
<br>
<p>How would you get things right with atomics and multirail?
<br>
<p>Getting the memory consistency right would be really difficult.
<br>
...
<br>
multiple updates to a given target addr being in flight.
<br>
<p>Howard
<br>
<p><p>2014-11-06 12:08 GMT-07:00 Nathan Hjelm &lt;hjelmn_at_[hidden]&gt;:
<br>
<p><span class="quotelev1">&gt; I haven't look at that yet. Would be great to get the new osc component
</span><br>
...
<span class="quotelev2">&gt; &gt;    On Thu, Nov 6, 2014 at 5:23 PM, Nathan Hjelm &lt;hjelmn_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;      At the moment I select the lowest latency BTL that can reach all of
</span><br>
<span class="quotelev1">&gt; the
</span><br>
<span class="quotelev2">&gt; &gt;      ranks in the communicator used to create the window. I can add code
</span><br>
<span class="quotelev1">&gt; to
</span><br>
<span class="quotelev2">&gt; &gt;      round-robin windows over the available BTLs on multi-rail systems.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;      &gt;    MODULE,  since atomics from two IB HCAs, for instance, are not
</span><br>
...
<span class="quotelev3">&gt; &gt;      &gt;      In the new osc component I don't try to handle that case. All
</span><br>
...
<span class="quotelev3">&gt; &gt;      &gt;      this because with the default setup of Gemini they can not be
</span><br>
...
<span class="quotelev3">&gt; &gt;      &gt;      On Wed, Nov 05, 2014 at 03:41:58AM -0500, Joshua Ladd wrote:
</span><br>
<span class="quotelev4">&gt; &gt;      &gt;      &gt;    Quick question. Out of curiosity, how do you handle the
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;    initiators, one initiator is on host with the target, so
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;       - Provide access to network atomic operations. I only
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;         btl_atomic_fop, and btl_atomic_cswap. Additionally
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;         btl_atomics_flags field has been added to indicate
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;       - Provide an interface that will allow simultaneous
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;         operation. In some cases this is a complete waste
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;       - Allow the registration of an entire region even if
</span><br>
<span class="quotelev1">&gt; the
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;         be modified with a single rdma operation. At this
</span><br>
<span class="quotelev1">&gt; time
</span><br>
<span class="quotelev3">&gt; &gt;      &gt;      prepare_src
</span><br>
<span class="quotelev4">&gt; &gt;      &gt;      &gt;         and prepare_dst may modify the size and register a
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;         This is done in the new interface through the new
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;         examples: the Gemini interconnect has an alignment
</span><br>
<span class="quotelev2">&gt; &gt;      restriction
</span><br>
<span class="quotelev3">&gt; &gt;      &gt;      on
</span><br>
<span class="quotelev4">&gt; &gt;      &gt;      &gt;         get, openib devices may have a limit on how large a
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;      This is a big change and I do not expect everyone to
</span><br>
...
<span class="quotelev4">&gt; &gt;      &gt;      &gt;      face-to-face discussion if anyone has any concerns or
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16242/attachment">attachment</a>
</ul>
