...
?>
<!-- received="Mon Nov 10 15:39:04 2014" -->
<!-- isoreceived="20141110203904" -->
<!-- sent="Mon, 10 Nov 2014 21:39:03 +0100" -->
<!-- isosent="20141110203903" -->
<!-- name="Adrian Reber" -->
<!-- email="adrian_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] 1.8.3 and PSM errors" -->
<!-- id="20141110203903.GF18884_at_lisas.de" -->
<!-- charset="utf-8" -->
<!-- inreplyto="0429C22EBDB44040B478F8F77EF14518C5AE80_at_ORSMSX114.amr.corp.intel.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-10 15:39:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16278.php">Friedley, Andrew: "Re: [OMPI devel] 1.8.3 and PSM errors"</a>
<li><strong>Previous message:</strong> <a href="16276.php">Tom Wurgler: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/devel/2014/10/16103.php">Friedley, Andrew: "Re: [OMPI devel] 1.8.3 and PSM errors"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16278.php">Friedley, Andrew: "Re: [OMPI devel] 1.8.3 and PSM errors"</a>
<li><strong>Reply:</strong> <a href="16278.php">Friedley, Andrew: "Re: [OMPI devel] 1.8.3 and PSM errors"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Andrew,
<br>
<p>thanks for looking into this. I was able to reproduce this error on RHEL 7
<br>
with PSM provided by RHEL:
<br>
<p>infinipath-psm-3.2-2_ga8c3e3e_open.2.el7.x86_64
<br>
infinipath-psm-devel-3.2-2_ga8c3e3e_open.2.el7.x86_64
<br>
<p>$ mpirun -np 32 mpi_test_suite -t &quot;environment&quot; 
<br>
<p>mpi_test_suite:4877 terminated with signal 11 at PC=7f5a2f4a2150
<br>
...
<br>
<p>Source RPM  : infinipath-psm-3.2-2_ga8c3e3e_open.2.el7.src.rpm
<br>
...
Vendor      : Red Hat, Inc.
<br>
URL         : <a href="http://www.openfabrics.org/downloads/infinipath-psm/infinipath-psm-3.2-2_ga8c3e3e_open.tar.gz">http://www.openfabrics.org/downloads/infinipath-psm/infinipath-psm-3.2-2_ga8c3e3e_open.tar.gz</a>
<br>
Summary     : QLogic PSM Libraries
<br>
<p>Is this supposed to work? Or is this something Red Hat has to fix?
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adrian
<br>
<p>On Mon, Oct 27, 2014 at 10:22:08PM +0000, Friedley, Andrew wrote:
<br>
<span class="quotelev1">&gt; Hi Adrian,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I'm unable to reproduce here with OMPI v1.8.3 (I assume you're doing this with one 8-core node):
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; $ mpirun -np 32 -mca pml cm -mca mtl psm ./mpi_test_suite -t &quot;environment&quot;
</span><br>
...
<span class="quotelev1">&gt; (Rank:0) tst_test_array[3]:Get_version
</span><br>
...
<span class="quotelev2">&gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b6d107fa9a
</span><br>
<span class="quotelev2">&gt; &gt; 4]
</span><br>
<span class="quotelev2">&gt; &gt; /usr/lib64/libpsm_infinipath.so.1(__psm_ep_connect+0x692)[0x2b6d107eb1
</span><br>
...
<span class="quotelev2">&gt; &gt; Primary job  terminated normally, but 1 process returned a non-zero exit
</span><br>
<span class="quotelev2">&gt; &gt; code.. Per user-direction, the job has been aborted.
</span><br>
<span class="quotelev2">&gt; &gt; -------------------------------------------------------
</span><br>
<span class="quotelev2">&gt; &gt; 
...
<span class="quotelev2">&gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b2c27d0d9a
</span><br>
<span class="quotelev2">&gt; &gt; 4]
</span><br>
<span class="quotelev2">&gt; &gt; /usr/lib64/libpsm_infinipath.so.1(__psm_ep_connect+0x692)[0x2b2c27cfe17
</span><br>
...
<span class="quotelev2">&gt; &gt; thus causing the job to be terminated. The first process to do so was:
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; I&#226;&#128;&#153;m afraid I can&#226;&#128;&#153;t quite decipher from all this what actually fails. Of course,
</span><br>
<span class="quotelev2">&gt; &gt; PSM doesn&#226;&#128;&#153;t support dynamic operations like comm_spawn or
</span><br>
<span class="quotelev2">&gt; &gt; connect_accept, so if you are running those tests that just won&#226;&#128;&#153;t work. Is
</span><br>
<span class="quotelev2">&gt; &gt; that the heart of the problem here?
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; Running Open MPI 1.8.3 with PSM does not seem to work right now at all.
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; I am getting the same errors also on trunk from my newly set up MTT.
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; Before trying to debug this I just wanted to make sure this is not a
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; configuration error. I have following PSM packages installed:
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; P2P tests Many-to-one with MPI_Iprobe (MPI_ANY_SOURCE) (21/48),
</span><br>
<span class="quotelev2">&gt; &gt; comm
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; Intracomm merged of the Halved Intercomm (13/13), type
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; MPI_TYPE_MIX_ARRAY (28/29) P2P tests Many-to-one with MPI_Iprobe
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; MPI_COMM_WORLD (1/13), type MPI_CHAR (1/29) n050304:2.0.Cannot
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; cancel send requests (req=0x2b25143fbd88) n050302:7.0.Cannot cancel
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; send requests (req=0x2b4d95eb0f80) n050301:4.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2adf03e14f80) n050304:4.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ad877257ed8) n050301:6.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ba47634af80) n050304:8.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ae8ac16cf80) n050302:3.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ab81dcb4d88) n050303:4.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b9ef4ef8f80) n050303:2.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ab0f03f9f80) n050302:9.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b214f9ebed8) n050301:2.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b31302d4f80) n050302:4.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b0581bd3f80) n050301:8.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ae53776bf80) n050303:6.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b13eeb78f80) n050304:7.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b4e99715f80) n050304:9.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b10429c2f80) n050304:3.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b9196f5fe30) n050304:6.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b30d6c69ed8) n050301:9.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b93c9e04f80) n050303:9.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ab4d6ce0f80) n050301:5.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b6ad851ef80) n050303:3.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b8ef52a0f80) n050301:3.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b277a4aff80) n050303:7.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ba570fa9f80) n050301:7.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ba707dfbf80) n050302:2.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b90f2e51e30) n050303:5.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b1250ba8f80) n050302:8.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b22e0129ed8) n050303:8.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b6609792f80) n050302:6.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2b2b6081af80) n050302:5.0.Cannot cancel send
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; requests (req=0x2ab24f6f1f80)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; --------------------------------------------------------------------
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; ------ mpirun has exited due to process rank 14 with PID 4496 on
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; node n050303 exiting improperly. There are two reasons this could occur:
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; [adrian_at_n050304 mpi_test_suite]$ mpirun  -np 32  mpi_test_suite -t
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; mpi_test_suite:16905 terminated with signal 11 at PC=2ae4cad209a4
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; mpi_test_suite:16906 terminated with signal 11 at PC=2b4c9fa019a4
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; mpi_test_suite:16907 terminated with signal 11 at PC=2ad6eb8589a4
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; mpi_test_suite:16908 terminated with signal 11 at PC=2b4e6e5589a4
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; mpi_test_suite:16909 terminated with signal 11 at PC=2b252219d9a4
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; mpi_test_suite:16910 terminated with signal 11 at PC=2b7f83fc49a4
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; mpi_test_suite:16903 terminated with signal 11 at PC=2ac5249249a4
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; mpi_test_suite:16904 terminated with signal 11 at PC=2ad0265099a4
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2ab6154
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b11438
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b43082
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b477a1
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b26799
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b2e4ae
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2ac8d5c
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b57daa
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b08466
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b593ef
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b7049b
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b4e6e5
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b15418
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b606b1
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b06dde
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b6dde9
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2ad6eb8
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; 589a4]
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2ac5249
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2adc01f
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2ba7904
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b25221
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2ae4cad
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2ad0265
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b7f83f
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(ips_proto_connect+0x334)[0x2b4c9fa
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; 019a4]
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/lib64/libpsm_infinipath.so.1(__psm_ep_connect+0x692)[0x2b4c9f9f
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; 2172]
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; /opt/bwhpc/common/mpi/openmpi/1.8.3-gnu-
...
<span class="quotelev4">&gt; &gt; &gt; &gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/10/16093.php">http://www.open-mpi.org/community/lists/devel/2014/10/16093.php</a>
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/10/16103.php">http://www.open-mpi.org/community/lists/devel/2014/10/16103.php</a>
</span><br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Adrian
<br>
<p><pre>
