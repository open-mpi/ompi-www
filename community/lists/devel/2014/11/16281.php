...
?>
<!-- received="Mon Nov 10 16:28:20 2014" -->
<!-- isoreceived="20141110212820" -->
<!-- sent="Mon, 10 Nov 2014 21:28:16 +0000" -->
<!-- isosent="20141110212816" -->
<!-- name="Tom Wurgler" -->
<!-- email="twurgl_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] mpirun does not honor rankfile" -->
<!-- id="1415654895958.46853_at_goodyear.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="D0A29D6D-EFCA-46E2-8B28-38F78466E22D_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-10 16:28:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16282.php">Friedley, Andrew: "Re: [OMPI devel] 1.8.3 and PSM errors"</a>
<li><strong>Previous message:</strong> <a href="16280.php">Adrian Reber: "Re: [OMPI devel] 1.8.3 and PSM errors"</a>
<li><strong>In reply to:</strong> <a href="16279.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Subject: Re: [OMPI devel] mpirun does not honor rankfile
<br>
<p>Here&#146;s what I can do. It looks like LSF is providing PU numbers instead of core numbers, probably to get around the uniqueness issue. This works fine for me as I can just lookup the correct PU number and then bind you to the core that includes that PU. It means you have to provide the physical rankfile in PUs and not cores, but that shouldn&#146;t be an issue for you as that is what LSF is providing.
<br>
...
<br>
<p><p>On Nov 10, 2014, at 12:35 PM, Tom Wurgler &lt;twurgl_at_[hidden]&lt;mailto:twurgl_at_[hidden]&gt;&gt; wrote:
<br>
<p>On all but the 2 machines with the newer bios (just the first socket):
<br>
...
<br>
<p>Now for the 2 with the bios update:
<br>
mach2:~ #  lstopo -p --of console
<br>
&nbsp;&nbsp;&nbsp;&nbsp;NUMANode P#0 (12GB) + L3 (5118KB)
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;L2 (512KB) + L1 (64KB) + Core P#0 + PU P#0
...
devel_at_[hidden]&lt;mailto:devel_at_[hidden]&gt;
Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/devel">http://www.open-mpi.org/mailman/listinfo.cgi/devel</a>
Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/11/16276.php">http://www.open-mpi.org/community/lists/devel/2014/11/16276.php</a>
</pre>
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16281/attachment">attachment</a>
</ul>
