...
?>
<!-- received="Wed Nov 26 10:16:32 2014" -->
<!-- isoreceived="20141126151632" -->
<!-- sent="Wed, 26 Nov 2014 09:16:35 -0600" -->
<!-- isosent="20141126151635" -->
<!-- name="Edgar Gabriel" -->
<!-- email="gabriel_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] question to OMPI_DECLSPEC" -->
<!-- id="5475EED3.3050305_at_cs.uh.edu" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="13F44FD9-FBCE-4370-A6A1-B2667D7C7242_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-26 10:16:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16359.php">Ralph Castain: "Re: [OMPI devel] question to OMPI_DECLSPEC"</a>
<li><strong>Previous message:</strong> <a href="16357.php">Gilles Gouaillardet: "[OMPI devel] race condition in abort can cause mpirun v1.8 hang"</a>
<li><strong>In reply to:</strong> <a href="16339.php">Ralph Castain: "Re: [OMPI devel] question to OMPI_DECLSPEC"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16359.php">Ralph Castain: "Re: [OMPI devel] question to OMPI_DECLSPEC"</a>
<li><strong>Reply:</strong> <a href="16359.php">Ralph Castain: "Re: [OMPI devel] question to OMPI_DECLSPEC"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>As an explanation on why there are so many functions in ompio that are 
<br>
...
<br>
<p>Before I start to move code around however, just want to confirm two things:
<br>
<p>1. I can move some of functionality of ompio to the base of various 
<br>
...
<br>
<p>2. I will have to extend the io framework interfaces a bit ( I will try 
<br>
...
Edgar
<br>
<p>On 11/25/2014 11:43 AM, Ralph Castain wrote:
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Nov 25, 2014, at 9:36 AM, Edgar Gabriel &lt;gabriel_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On 11/25/2014 11:31 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Nov 25, 2014, at 8:24 AM, Edgar Gabriel &lt;gabriel_at_[hidden]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;mailto:gabriel_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On 11/25/2014 10:18 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Hmmm&#133;no, nothing has changed with regard to declspec that I know
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; about. I&#146;ll ask the obvious things to check:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; header is included, I double checked.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; * is that function in the base code, or down in a component? If the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; latter, then that&#146;s a problem, but I&#146;m assuming you didn&#146;t make that
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I am not sure what you mean. The function is in a component, but I am
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; not aware that it is illegal to call a function of a component from
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; another component.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Of course that is illegal - you can only access a function via the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; framework interface, not directly. You have no way of knowing that the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; other component has been loaded. Doing it directly violates the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; abstraction rules.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; well, ok. I know that the other componen has been loaded because that component triggered the initialization of these sub-frameworks.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I think we&#146;ve seen that before, and run into problems with that approach (i.e., components calling framework opens).
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I can move that functionality to the base, however, none of the 20+ functions are required for the other components of the io framework (i.e. ROMIO). So I would basically add functionality required for one component only into the base.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Sounds like you&#146;ve got an abstraction problem. If the fcoll component requires certain functions from another framework, then the framework should be exposing those APIs. If ROMIO doesn&#146;t provide them, then it needs to return an error if someone attempts to call it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; You are welcome to bring this up on next week&#146;s call if you like. IIRC, this has come up before when people have tried this hard links between components. Maybe someone else will have a better solution, but is just seems to me like you have to go thru the framework to avoid the problem.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev1">&gt; Probably because the fcoll component didn&#146;t explicitly link against the ompio component. You were likely getting away with it out of pure luck.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/mailman/listinfo.cgi/develLink">http://www.open-mpi.org/mailman/listinfo.cgi/develLink</a> to this post:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;<a href="http://pstl.cs.uh.edu/">http://pstl.cs.uh.edu/</a>&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; post:<a href="http://www.open-mpi.org/community/lists/devel/2014/11/16334.php">http://www.open-mpi.org/community/lists/devel/2014/11/16334.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/11/16336.php">http://www.open-mpi.org/community/lists/devel/2014/11/16336.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/11/16338.php">http://www.open-mpi.org/community/lists/devel/2014/11/16338.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/11/16339.php">http://www.open-mpi.org/community/lists/devel/2014/11/16339.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><pre>
