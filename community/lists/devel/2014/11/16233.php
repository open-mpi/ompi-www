...
?>
<!-- received="Thu Nov  6 11:31:01 2014" -->
<!-- isoreceived="20141106163101" -->
<!-- sent="Thu, 6 Nov 2014 16:30:58 +0000" -->
<!-- isosent="20141106163058" -->
<!-- name="Tom Wurgler" -->
<!-- email="twurgl_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] mpirun does not honor rankfile" -->
<!-- id="1415291457623.8254_at_goodyear.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="0FED79F7-D838-4DF9-AE90-3B955F1C45DC_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-06 11:30:58
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16234.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<li><strong>Previous message:</strong> <a href="16232.php">Dave Goodell (dgoodell): "Re: [OMPI devel] simple_spawn test fails using different set of	btls."</a>
<li><strong>In reply to:</strong> <a href="16231.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16234.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<li><strong>Reply:</strong> <a href="16234.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Well, unless we can get LSF to use physical numbering, we are dead in the water without a translator of some sort.
<br>
<p><p>We are trying to figure how we can automate the translation in the meantime, but we have a mix of clusters and the mapping is different between them.
<br>
<p><p>We daily use 1.6.4 openmpi (vs all this current testing has been with 1.8.3).  In reading the 1.8.1 man page for mpirun, it states that
<br>
<p><p>&quot;Starting with Open MPI v1.7, all socket/core slot locations are be specified as logical indexes (the Open MPI v1.6 series used physical indexes).&quot;
<br>
<p><p>But testing using rankfiles with 1.6.4, it behaves like 1.8.3, ie using logical indexes.  Is there maybe a switch in 1.6.4 to use physical indexes?  I am not seeing it in the mpirun --help...
<br>
<p>thanks
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16233/attachment">attachment</a>
</ul>
