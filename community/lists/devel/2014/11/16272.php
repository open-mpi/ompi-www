...
?>
<!-- received="Mon Nov 10 13:42:11 2014" -->
<!-- isoreceived="20141110184211" -->
<!-- sent="Mon, 10 Nov 2014 18:42:09 +0000" -->
<!-- isosent="20141110184209" -->
<!-- name="Tom Wurgler" -->
<!-- email="twurgl_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] mpirun does not honor rankfile" -->
<!-- id="1415644929097.2175_at_goodyear.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="502F34F2-9476-4B96-94D1-FF3B22ABB1B0_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-10 13:42:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16273.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<li><strong>Previous message:</strong> <a href="16271.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<li><strong>In reply to:</strong> <a href="16271.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16273.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<li><strong>Reply:</strong> <a href="16273.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>I have also filed a service ticket with LSF to see if they can change to logical numbering etc.
<br>
<p><p>In the meantime we have written a translator, but this is cluster, actually node, specific and should not be called a solution.  Running lstopo on the whole cluster found 2 nodes giving logical numbering and the rest giving physical.
<br>
<p>Which is interesting in itself.  We find those 2 nodes having a newer bios level. Still investigating this...
<br>
<p><p>thanks
<br>
<p>tom
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16272/attachment">attachment</a>
</ul>
