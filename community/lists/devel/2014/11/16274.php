...
?>
<!-- received="Mon Nov 10 14:27:34 2014" -->
<!-- isoreceived="20141110192734" -->
<!-- sent="Mon, 10 Nov 2014 19:27:31 +0000" -->
<!-- isosent="20141110192731" -->
<!-- name="Tom Wurgler" -->
<!-- email="twurgl_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] mpirun does not honor rankfile" -->
<!-- id="1415647650594.73953_at_goodyear.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="3072F494-8ADF-48D1-81B2-C5978A756428_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-10 14:27:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16275.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<li><strong>Previous message:</strong> <a href="16273.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<li><strong>In reply to:</strong> <a href="16273.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16275.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<li><strong>Reply:</strong> <a href="16275.php">Ralph Castain: "Re: [OMPI devel] mpirun does not honor rankfile"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
If we run
<br>
<p><span class="quotelev1">&gt; lstopo --output-format fig
</span><br>
<p>we get a diagram of the socket/numa/core layouts and all but those 2 give &quot;PU P#0&quot;, PU P#4,
<br>
<p>PU P#8....in the smallest box.  and in the lower left corner it says &quot;physical&quot;
<br>
<p><p>If we then add an option
<br>
<p><p><span class="quotelev1">&gt; lstopo --logical --output-format fig
</span><br>
<p>we get PU L#0, PU L#1, PU L#2 ... and its says logical.
<br>
<p><p>On the 2 boxes with the newer bios, both --logical and default physical have the same NUMBERS, even though
<br>
<p>one is PU L#  and the other is PU P#, and the numbers just go 0, 1,2,3....
<br>
<p><p>So is this a BIOS setting that is causing it to report one way on some and a different way on others?  And LSF takes what it gets?
<br>
<p><p>I am attempting to print the bios settings for each so I can compare them....
<br>
<p><p>For a given node, the numbers LSF gives are unique.
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16274/attachment">attachment</a>
</ul>
