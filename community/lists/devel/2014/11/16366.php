...
?>
<!-- received="Wed Nov 26 20:06:33 2014" -->
<!-- isoreceived="20141127010633" -->
<!-- sent="Thu, 27 Nov 2014 10:06:25 +0900" -->
<!-- isosent="20141127010625" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] OMPI devel] race condition in abort can cause mpirun v1.8 hang" -->
<!-- id="4l0ednln3sn9845ijdtdp4ig.1417050385842_at_email.android.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="[OMPI devel] OMPI devel] OMPI devel] race condition in abort can cause mpirun v1.8 hang" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-26 20:06:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16367.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] OMPI devel] race condition in abort can cause mpirun v1.8 hang"</a>
<li><strong>Previous message:</strong> <a href="16365.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] race condition in abort can cause mpirun v1.8 hang"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16367.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] OMPI devel] race condition in abort can cause mpirun v1.8 hang"</a>
<li><strong>Reply:</strong> <a href="16367.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] OMPI devel] race condition in abort can cause mpirun v1.8 hang"</a>
<li><strong>Reply:</strong> <a href="16368.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] OMPI devel] race condition in abort can cause mpirun v1.8 hang"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Iirc, crash vs mpi error is ruled by --with-param-check or something like this...
<br>
<p>Cheers,
<br>
<p>Gilles 
...
<span class="quotelev1">&gt;On Nov 26, 2014, at 4:26 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16366/attachment">attachment</a>
</ul>
