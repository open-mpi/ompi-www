...
?>
<!-- received="Tue Oct  7 12:12:30 2014" -->
<!-- isoreceived="20141007161230" -->
<!-- sent="Tue, 7 Oct 2014 10:12:29 -0600" -->
<!-- isosent="20141007161229" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Issue with MPI_Put in version 1.8.3" -->
<!-- id="20141007161229.GR1319_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-10-07 12:12:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16025.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] RFC: calloc instead of malloc in opal_obj_new()"</a>
<li><strong>Previous message:</strong> <a href="16023.php">Mike Dubman: "Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch master updated. dev-49-g86f1d5a"</a>
<li><strong>In reply to:</strong> <a href="16016.php">Berk Hess: "[OMPI devel] Issue with MPI_Put in version 1.8.3"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16026.php">Nathan Hjelm: "Re: [OMPI devel] Issue with MPI_Put in version 1.8.3"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>BTW, MPI_Win_allocate is preferred over MPI_Win_create. It allows the
<br>
...
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16024/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
