...
?>
<!-- received="Tue Apr  1 19:34:00 2014" -->
<!-- isoreceived="20140401233400" -->
<!-- sent="Tue, 1 Apr 2014 16:34:00 -0700" -->
<!-- isosent="20140401233400" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI svn] svn:open-mpi r31302 - in trunk: opal/mca/base orte/tools/orterun" -->
<!-- id="CAMD57odX3x+DujUWF+oPvZPcm0XYupYYmdqBPNCOZ-qZOMOBBA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2014-04-01 19:34:00
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14446.php">Mike Dubman: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r31302 - in trunk: opal/mca/base orte/tools/orterun"</a>
<li><strong>Previous message:</strong> <a href="14444.php">Ralph Castain: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r31302 - in trunk: opal/mca/base orte/tools/orterun"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14446.php">Mike Dubman: "Re: [OMPI devel] [OMPI svn] svn:open-mpi r31302 - in trunk: opal/mca/base orte/tools/orterun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>So what does this new capability add? Is it just the ability to do -x from
<br>
within an am-file? If so, why not just update the am parser to support it?
<br>
<p>If -x isn't working, or isn't doing something we want, then it might be
<br>
better to update it as opposed to creating another parallel mechanism...
<br>
<p><p><p>On Tue, Apr 1, 2014 at 4:23 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-14445/attachment">attachment</a>
</ul>
