...
?>
<!-- received="Tue Apr 22 11:05:35 2014" -->
<!-- isoreceived="20140422150535" -->
<!-- sent="Tue, 22 Apr 2014 15:05:33 +0000" -->
<!-- isosent="20140422150533" -->
<!-- name="Hjelm, Nathan T" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] coll/tuned MPI_Bcast can crash or silently fail when using distinct datatypes across tasks" -->
<!-- id="AE45F2F55FE69B4F99BB3455E821D7153A8A972B_at_ECS-EXG-P-MB07.win.lanl.gov" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-04-22 11:05:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14574.php">Jeff Squyres (jsquyres): "[OMPI devel] 1.8.1rc1 posted"</a>
<li><strong>Previous message:</strong> <a href="14572.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] v1.8.1 release"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14579.php">Gilles Gouaillardet: "Re: [OMPI devel] coll/tuned MPI_Bcast can crash or silently fail when using distinct datatypes across tasks"</a>
<li><strong>Reply:</strong> <a href="14579.php">Gilles Gouaillardet: "Re: [OMPI devel] coll/tuned MPI_Bcast can crash or silently fail when using distinct datatypes across tasks"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I need the flatten datatype call for handling true rdma in the one-sided code as well. Is there a plan to implement this feature soon?
<br>
<p>-Nathan
<br>
...
Subject: Re: [OMPI devel] coll/tuned MPI_Bcast can crash or silently fail when using distinct datatypes across tasks
<br>
<p>Indeed there are many potential solutions, but all require too much
<br>
...
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/04/14571.php">http://www.open-mpi.org/community/lists/devel/2014/04/14571.php</a>
<br>
<!-- body="end" -->
<hr>
<ul class="links">
