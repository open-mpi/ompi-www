...
?>
<!-- received="Wed Jul 30 03:04:21 2014" -->
<!-- isoreceived="20140730070421" -->
<!-- sent="Wed, 30 Jul 2014 16:03:11 +0900" -->
<!-- isosent="20140730070311" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] openmpi-1.8.2rc2 and f08 interface built with PGI-14.7	causes link error" -->
<!-- id="OF69AD5893.EF27C58B-ON49257D25.0026087E-49257D25.0026D72B_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2014-07-30 03:03:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15350.php">tmishima_at_[hidden]: "Re: [OMPI devel] openmpi-1.8.2rc2 and f08 interface built with PGI-14.7	causes link error"</a>
<li><strong>Previous message:</strong> <a href="15348.php">Gilles Gouaillardet: "Re: [OMPI devel] trunk compilation errors in jenkins"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15350.php">tmishima_at_[hidden]: "Re: [OMPI devel] openmpi-1.8.2rc2 and f08 interface built with PGI-14.7	causes link error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Jeff,
<br>
<p>Sorry for poor information and late reply. Today, I attended a very very
<br>
long meeting ...
<br>
<p>Anyway, I attached compile-output and configure-log.
<br>
(due to file size limitation, I send them in twice)
<br>
<p>I hope you could find the problem.
<br>
<p>(See attached file: openmpi-1.8-pgi14.7.tar.gz)
<br>
<p>Regards,
<br>
Tetsuya
...
<p><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15349/openmpi-1.8-pgi14.7.tar.gz">openmpi-1.8-pgi14.7.tar.gz</a>
</ul>
<!-- attachment="openmpi-1.8-pgi14.7.tar.gz" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
