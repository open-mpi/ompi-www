...
?>
<!-- received="Thu Jul 31 11:06:44 2014" -->
<!-- isoreceived="20140731150644" -->
<!-- sent="Thu, 31 Jul 2014 15:06:43 +0000" -->
<!-- isosent="20140731150643" -->
<!-- name="Pritchard Jr., Howard" -->
<!-- email="howardp_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: job size info in OPAL" -->
<!-- id="5F6FB0CDAF4F98419A0D970E1F65ED05ACC0AE_at_ECS-EXG-P-MB05.win.lanl.gov" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-07-31 11:06:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15396.php">George Bosilca: "Re: [OMPI devel] RFC: job size info in OPAL"</a>
<li><strong>Previous message:</strong> <a href="15394.php">Nathan Hjelm: "Re: [OMPI devel] RFC: job size info in OPAL"</a>
<li><strong>In reply to:</strong> <a href="15394.php">Nathan Hjelm: "Re: [OMPI devel] RFC: job size info in OPAL"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15396.php">George Bosilca: "Re: [OMPI devel] RFC: job size info in OPAL"</a>
<li><strong>Reply:</strong> <a href="15396.php">George Bosilca: "Re: [OMPI devel] RFC: job size info in OPAL"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Folks,
<br>
<p>I think given the way we want to use the btl's in lower levels like opal,
<br>
...
<br>
<p>I'll see if there's something clever that can be done in ugni for now.
<br>
...
<p><p>+2^10000000
<br>
<p>This information is absolutely necessary at this point. If someone has a better solution they can provide it as an alternative RFC. Until then this is how it should be done... Otherwise we loose uGNI support on the trunk. Because we ARE NOT going to remove the mailbox size optimization.
<br>
<p>-Nathan
<br>
...
<span class="quotelev1">&gt; - usnic: for a minor latency optimization / sizing of a shared receive 
</span><br>
