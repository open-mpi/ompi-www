...
?>
<!-- received="Fri Jul 11 15:33:21 2014" -->
<!-- isoreceived="20140711193321" -->
<!-- sent="Fri, 11 Jul 2014 12:32:48 -0700" -->
<!-- isosent="20140711193248" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] hwloc and pmi" -->
<!-- id="757FDFFE-8B0B-4A2F-8AA6-C454D06B5867_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAAO1Kya6RoUD0txpEXcEud8NoChU1d7+FkVS6HcgQq1cYp9uMw_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-07-11 15:32:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15113.php">Ralph Castain: "Re: [OMPI devel] 1.8.2rc1 available for test"</a>
<li><strong>Previous message:</strong> <a href="15111.php">Pritchard, Howard P: "Re: [OMPI devel] RFC: Move the Open MPI	communication	infrastructure in OPAL"</a>
<li><strong>In reply to:</strong> <a href="15110.php">Mike Dubman: "Re: [OMPI devel] hwloc and pmi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15130.php">Mike Dubman: "Re: [OMPI devel] hwloc and pmi"</a>
<li><strong>Reply:</strong> <a href="15130.php">Mike Dubman: "Re: [OMPI devel] hwloc and pmi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>The slurm check shouldn't be throwing anything into the global cppflags, and I don't think common/pmi calls the slurm .m4 check - at least, it probably shouldn't
<br>
<p>On Jul 11, 2014, at 11:57 AM, Mike Dubman &lt;miked_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I think the problem related to new version of SLURM which was upgraded on our machines.
</span><br>
...
<span class="quotelev1">&gt; libtool: link: gcc -std=gnu99 -shared  -fPIC -DPIC  .libs/common_pmi.o   /usr/lib64/libpmi2.so /usr/lib64/libpmi.so -L/usr/lib64 /usr/lib64/libslurm.so -ldl -lhwloc -lpthread -lrt -lnsl -lutil -lm  -O3 -pthread -Wl,-rpath=   -pthread -Wl,-soname -Wl,libmca_common_pmi.so.1 -o .libs/libmca_common_pmi.so.1.1.2
</span><br>
...
<span class="quotelev1">&gt; The Makefile in opal/mca/common/pmi/Makefile has no references to &quot;-lhwloc&quot;, so it comes as dependancy from outside.
</span><br>
...
<span class="quotelev1">&gt; mtt_at_sputnik7 /hpc/scrap/mtt/scratch/shmem/20140711_210002_6937_8974_sputnik7.vbench.com/mpi-install/NoDd/src/ompi-vendor.git
</span><br>
...
<span class="quotelev1">&gt; Nope, just added a missing file to the tarball.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt;    IIRC, I thought I saw a change to that makefile.am flow thru yesterday?
</span><br>
<span class="quotelev2">&gt; &gt;    Could be there was an error in it
</span><br>
<span class="quotelev2">&gt; &gt;    On Jul 10, 2014, at 5:26 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt;      I'm AFK and can't look at this. Have a look at other components that use
</span><br>
...
<span class="quotelev2">&gt; &gt;      On Jul 10, 2014, at 8:22 AM, &quot;Mike Dubman&quot; &lt;miked_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt; &gt;      wrote:
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev2">&gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/07/15096.php">http://www.open-mpi.org/community/lists/devel/2014/07/15096.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/07/15099.php">http://www.open-mpi.org/community/lists/devel/2014/07/15099.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/07/15110.php">http://www.open-mpi.org/community/lists/devel/2014/07/15110.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15112/attachment">attachment</a>
</ul>
