...
?>
<!-- received="Tue Jul 15 17:58:14 2014" -->
<!-- isoreceived="20140715215814" -->
<!-- sent="Tue, 15 Jul 2014 14:57:26 -0700" -->
<!-- isosent="20140715215726" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Move the Open MPI communication infrastructure in OPAL" -->
<!-- id="9E923C50-E3B7-4FE7-BFEB-8A7C7E4176E3_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-07-15 17:57:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15155.php">Joshua Ladd: "Re: [OMPI devel] RFC: Add an __attribute__((destructor)) function to opal"</a>
<li><strong>Previous message:</strong> <a href="15153.php">Paul Hargrove: "Re: [OMPI devel] RFC: Add an __attribute__((destructor)) function to opal"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15225.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] RFC: Move the Open MPI communication infrastructure in OPAL"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
George: I've asked the various BTL developers of the components you listed below (minus Portals4 as I couldn't get hold of them), and we are agreed that we can move forward.
<br>
<p>So please go ahead and commit this merge - it'll break things, but we all agreed it would be easier to resolve in the trunk at this stage.
<br>
<p><p>On Jul 14, 2014, at 11:06 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15154/attachment">attachment</a>
</ul>
