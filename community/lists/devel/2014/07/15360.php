...
?>
<!-- received="Wed Jul 30 11:34:07 2014" -->
<!-- isoreceived="20140730153407" -->
<!-- sent="Wed, 30 Jul 2014 08:34:02 -0700" -->
<!-- isosent="20140730153402" -->
<!-- name="Rolf vandeVaart" -->
<!-- email="rvandevaart_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins" -->
<!-- id="3AF945EBF4D3EC41AFE44EED9B0585F360477A17DA_at_HQMAIL02.nvidia.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-07-30 11:34:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15361.php">KAWASHIMA Takahiro: "Re: [OMPI devel] MPI_T SEGV on DSO"</a>
<li><strong>Previous message:</strong> <a href="15359.php">Gilles GOUAILLARDET: "Re: [OMPI devel] OMPI devel] openmpi-1.8.2rc2 and f08 interface built with PGI-14.7 causes link error"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15363.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Subject: Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins
<br>
<p>I just fixed this one - all that was required was an ampersand as the name was being passed into the function instead of a pointer to the name
<br>
<p>r32357
<br>
<p>On Jul 30, 2014, at 7:43 AM, Gilles GOUAILLARDET &lt;gilles.gouaillardet_at_[hidden]&lt;mailto:gilles.gouaillardet_at_[hidden]&gt;&gt; wrote:
<br>
<p><p>Rolf,
<br>
...
<p>Gilles
<br>
<p>Rolf vandeVaart &lt;rvandevaart_at_[hidden]&lt;mailto:rvandevaart_at_[hidden]&gt;&gt; wrote:
<br>
<p>Just an FYI that my trunk version (r32355) does not work at all anymore if I do not include &quot;--mca coll ^ml&quot;.    Here is a stack trace from the ibm/pt2pt/send test running on a single node.
<br>
<p><p><p>(gdb) where
<br>
...
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/07/15355.php">http://www.open-mpi.org/community/lists/devel/2014/07/15355.php</a>
<br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15360/attachment">attachment</a>
</ul>
