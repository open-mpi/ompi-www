...
?>
<!-- received="Wed Jul 23 22:49:04 2014" -->
<!-- isoreceived="20140724024904" -->
<!-- sent="Wed, 23 Jul 2014 19:47:47 -0700" -->
<!-- isosent="20140724024747" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: Move the Open MPI communication	infrastructure in OPAL" -->
<!-- id="7C349B45-3626-4574-BBBB-A114F9E5A6A0_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="2DBAEB30-EFDD-4FA4-8B23-B3726D33B549_at_icl.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-07-23 22:47:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15233.php">Marco Atzeri: "Re: [OMPI devel] 1.8.2rc2 ready for test"</a>
<li><strong>Previous message:</strong> <a href="15231.php">George Bosilca: "Re: [OMPI devel] RFC: Move the Open MPI communication	infrastructure in OPAL"</a>
<li><strong>In reply to:</strong> <a href="15231.php">George Bosilca: "Re: [OMPI devel] RFC: Move the Open MPI communication	infrastructure in OPAL"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p><p>On Jul 23, 2014, at 7:36 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; A BTL should be completely agnostic to the notions of vpid and jobid.  Unfortunately, as you mentioned, some of the BTLs are relying on this information in diverses ways.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; - If they rely for output purposes, this is a trivial matter as a BTL is supposed to rely upward any error and some upper layer will decide how to handle it. As the callers are in the OMPI layer, they can output the meaningful message (including rank and what not).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; - Some other BTLs use this information to create connections. Clearly not the best decision, as it bit us for quite some time (as an example being the major reason preventing SM support across different MPI worlds). Moreover, other programming paradigms that can use the BTLs, are not subject to a rank-base concept. Thus, this usage should be banned and replaced by a more sensible approach (to be defined). Until then, the current solution provide an acceptable band-aid.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; PS: The PML and MTL remaining at the OMPI later do not create any issues with accessing the local or the MPI rank.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Jul 23, 2014, at 22:19 , Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Sounds reasonable. However, keep in mind that some BTLs actually require the notion of a jobid and rank-within-that-job. If the current ones don't, I assure you that at least one off-trunk one definitely does
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Some of the MTL's, of course, definitely rely on those fields.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Jul 23, 2014, at 7:15 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I was struggling with a similar issue while trying to fix the OpenIB compilation. And I choose to implement a different approach, which does not require knowledge of what&#146;s inside opal_process_name_t.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Look in opal/util/proc.h. You should be able to use: opal_process_name_vpid and opal_process_name_jobid. They will remain there until we figure out a nice way to get rid of them completely.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; HINT: I personally prefer to get rid of void and jobid completely. As long as need the info only for a visual clue, the output of OPAL_NAME_PRINT might be enough.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Jul 23, 2014, at 22:11 , Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Ralph and I chatted in IM.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; For the moment, I'm masking off the lower 32 bits to get the VPID, the uppermost 16 as the job family, and the next 16 as the sub-family.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; If George makes the name be a handle with accessors to get the parts, we can switch to using that.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jul 23, 2014, at 9:57 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; You should be able to memcpy it to an ompi_process_name_t and then extract it as usual
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/07/15227.php">http://www.open-mpi.org/community/lists/devel/2014/07/15227.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/07/15228.php">http://www.open-mpi.org/community/lists/devel/2014/07/15228.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/07/15230.php">http://www.open-mpi.org/community/lists/devel/2014/07/15230.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/07/15231.php">http://www.open-mpi.org/community/lists/devel/2014/07/15231.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
