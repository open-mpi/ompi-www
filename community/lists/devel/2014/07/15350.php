...
?>
<!-- received="Wed Jul 30 03:05:56 2014" -->
<!-- isoreceived="20140730070556" -->
<!-- sent="Wed, 30 Jul 2014 16:04:51 +0900" -->
<!-- isosent="20140730070451" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] openmpi-1.8.2rc2 and f08 interface built with PGI-14.7	causes link error" -->
<!-- id="OF8B5ADBAE.8F30A430-ON49257D25.0026C161-49257D25.0026FE5D_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2014-07-30 03:04:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15351.php">tmishima_at_[hidden]: "Re: [OMPI devel] openmpi-1.8.2rc2 and f08 interface built with PGI-14.7 causes link error"</a>
<li><strong>Previous message:</strong> <a href="15349.php">tmishima_at_[hidden]: "Re: [OMPI devel] openmpi-1.8.2rc2 and f08 interface built with PGI-14.7	causes link error"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15353.php">tmishima_at_[hidden]: "Re: [OMPI devel] openmpi-1.8.2rc2 and f08 interface built with PGI-14.7	causes link error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
This is another one.
<br>
<p>(See attached file: openmpi-1.8.2rc2-pgi14.7.tar.gz)
<br>
<p>Tetusya
<br>
...
<p><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15350/openmpi-1.8.2rc2-pgi14.7.tar.gz">openmpi-1.8.2rc2-pgi14.7.tar.gz</a>
</ul>
<!-- attachment="openmpi-1.8.2rc2-pgi14.7.tar.gz" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
