...
?>
<!-- received="Mon Jun  2 12:44:36 2014" -->
<!-- isoreceived="20140602164436" -->
<!-- sent="Mon, 2 Jun 2014 19:44:34 +0300" -->
<!-- isosent="20140602164434" -->
<!-- name="Mike Dubman" -->
<!-- email="miked_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] trunk failure" -->
<!-- id="CAAO1KybdnwgfGJOT4AHOxCHJC_rgtFpS9aQzLr7gQUvdx9yyuQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="3D8899FA-D6EC-44FE-8D11-897E37096A6F_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-02 12:44:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14958.php">Ralph Castain: "Re: [OMPI devel] trunk failure"</a>
<li><strong>Previous message:</strong> <a href="14956.php">Ralph Castain: "Re: [OMPI devel] trunk failure"</a>
<li><strong>In reply to:</strong> <a href="14956.php">Ralph Castain: "Re: [OMPI devel] trunk failure"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14958.php">Ralph Castain: "Re: [OMPI devel] trunk failure"</a>
<li><strong>Reply:</strong> <a href="14958.php">Ralph Castain: "Re: [OMPI devel] trunk failure"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Changes:
<br>
<p>&nbsp;&nbsp;&nbsp;1. Revert r31926 and replace it with a more complete checking of
<br>
&nbsp;&nbsp;&nbsp;availability and accessibility of the required freq control paths.
<br>
&nbsp;&nbsp;&nbsp;2. Break the loop caused by retrying to send a message to a hop that is
<br>
&nbsp;&nbsp;&nbsp;unknown by the TCP oob component. We attempt to provide a way for other
<br>
...
<br>
<p><p><p>*19:36:19* + timeout -s SIGSEGV 3m
<br>
/scrap/jenkins/scrap/workspace/hpc-ompi-shmem/label/hpc-test-node/ompi_install1/bin/mpirun
<br>
-np 8 /scrap/jenkins/scrap/workspace/hpc-ompi-shmem/label/hpc-test-node/ompi_install1/examples/hello_usempi*19:36:19*
<br>
[vegas12:03383] *** Process received signal ****19:36:19*
<br>
[vegas12:03383] Signal: Segmentation fault (11)*19:36:19*
<br>
[vegas12:03383] Signal code: Address not mapped (1)*19:36:19*
<br>
[vegas12:03383] Failing at address: 0x20*19:36:19* [vegas12:03383] [
<br>
0] /lib64/libpthread.so.0[0x3937c0f500]*19:36:19* [vegas12:03383] [ 1]
<br>
...
<br>
[vegas12:03383] *** End of error message ****19:36:20* Build step
<br>
'Execute shell' marked build as failure*19:36:21* [BFA] Scanning build
<br>
for known causes...
<br>
<p><p><p>On Mon, Jun 2, 2014 at 7:00 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I fixed this - key was that it only would happen if the MCA param
</span><br>
<span class="quotelev1">&gt; orte_startup_timeout was set.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; It really does help, folks, if you include info on what MCA params were
</span><br>
<span class="quotelev1">&gt; set when you get these failures. Otherwise, it is impossible to replicate
</span><br>
...
<span class="quotelev1">&gt; /scrap/jenkins/scrap/workspace/hpc-ompi-shmem/label/hpc-test-node/ompi_install1/examples/hello_usempiProgram
</span><br>
<span class="quotelev1">&gt; terminated with signal 11, Segmentation fault.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; #0  orte_plm_base_post_launch (fd=&lt;value optimized out&gt;, args=&lt;value
</span><br>
<span class="quotelev1">&gt; optimized out&gt;, cbdata=0x7393b0) at base/plm_base_launch_support.c:607
</span><br>
...
<span class="quotelev1">&gt; glibc-2.12-1.107.el6.x86_64 libgcc-4.4.7-3.el6.x86_64
</span><br>
<span class="quotelev1">&gt; libpciaccess-0.13.1-2.el6.x86_64 numactl-2.0.7-6.el6.x86_64
</span><br>
...
<span class="quotelev1">&gt; #1  0x00007ffff7b1076c in event_process_active_single_queue
</span><br>
<span class="quotelev1">&gt; (base=0x630d30, flags=&lt;value optimized out&gt;) at event.c:1367
</span><br>
<span class="quotelev1">&gt; #2  event_process_active (base=0x630d30, flags=&lt;value optimized out&gt;) at
</span><br>
<span class="quotelev1">&gt; event.c:1437
</span><br>
<span class="quotelev1">&gt; #3  opal_libevent2021_event_base_loop (base=0x630d30, flags=&lt;value
</span><br>
<span class="quotelev1">&gt; optimized out&gt;) at event.c:1645
</span><br>
<span class="quotelev1">&gt; #4  0x000000000040501d in orterun (argc=10, argv=0x7fffffffe208) at
</span><br>
<span class="quotelev1">&gt; orterun.c:1080
</span><br>
...
<span class="quotelev1">&gt; On Mon, Jun 2, 2014 at 3:31 PM, Gilles Gouaillardet &lt;
</span><br>
...
<span class="quotelev2">&gt;&gt; then i can only review the code and hope i can find the root cause of the
</span><br>
<span class="quotelev2">&gt;&gt; error i am unable to reproduce in my environment
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On Mon, Jun 2, 2014 at 9:03 PM, Mike Dubman &lt;miked_at_[hidden]&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; The jenkins took your commit and applied automatically, I tried with mca
</span><br>
<span class="quotelev3">&gt;&gt;&gt; flag later.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Also, we don`t
</span><br>
<span class="quotelev3">&gt;&gt;&gt; have /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor in our system,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the cpuspeed daemon is off by default on all our nodes.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Mon, Jun 2, 2014 at 3:00 PM, Gilles Gouaillardet &lt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; *both* are required (--mca rtc_freq_priority 0 is not enough without
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the patch)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; can you please confirm there is no /sys/devices/system/cpu/cpu0/cpufreq/scaling_governor
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (pseudo) file on your system ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; if this still does not work for you, then this might be a different
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; issue i was unable to reproduce.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mon, Jun 2, 2014 at 8:26 PM, Mike Dubman &lt;miked_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; more info, specifying --mca rtc_freq_priority 0 explicitly, generates
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [vegas12:13887] [ 5]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /lib64/libc.so.6(__libc_start_main+0xfd)[0x393741ecdd]
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; and filename is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &quot;/sys/devices/system/cpu/cpu0/cpufreq/scaling_governor&quot;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/06/14947.php">http://www.open-mpi.org/community/lists/devel/2014/06/14947.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/06/14948.php">http://www.open-mpi.org/community/lists/devel/2014/06/14948.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/06/14949.php">http://www.open-mpi.org/community/lists/devel/2014/06/14949.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/06/14950.php">http://www.open-mpi.org/community/lists/devel/2014/06/14950.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/06/14956.php">http://www.open-mpi.org/community/lists/devel/2014/06/14956.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-14957/attachment">attachment</a>
</ul>
