...
?>
<!-- received="Wed Jan  8 11:57:08 2014" -->
<!-- isoreceived="20140108165708" -->
<!-- sent="Wed, 8 Jan 2014 09:57:07 -0700" -->
<!-- isosent="20140108165707" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RFC: OB1 optimizations" -->
<!-- id="20140108165707.GI61812_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-01-08 11:57:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13588.php">Paul Hargrove: "Re: [OMPI devel] RFC: OB1 optimizations"</a>
<li><strong>Previous message:</strong> <a href="13586.php">George Bosilca: "Re: [OMPI devel] RFC: OB1 optimizations"</a>
<li><strong>In reply to:</strong> <a href="13586.php">George Bosilca: "Re: [OMPI devel] RFC: OB1 optimizations"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13588.php">Paul Hargrove: "Re: [OMPI devel] RFC: OB1 optimizations"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>-Nathan
<br>
<p>On Wed, Jan 08, 2014 at 05:50:34PM +0100, George Bosilca wrote:
<br>
<span class="quotelev1">&gt; These results are way worst that the one you send on your previous email? What is the reason?
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;   The local request is not correctly released, leading to assert in debug
</span><br>
<span class="quotelev3">&gt; &gt;&gt;   mode. This is because you avoid calling MCA_PML_BASE_RECV_REQUEST_FINI,
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;   send_sequence without storing it. If you create a gap in the send_sequence
</span><br>
<span class="quotelev3">&gt; &gt;&gt;   a deadlock will __definitively__ occur. I strongly suggest you turn off
</span><br>
<span class="quotelev3">&gt; &gt;&gt;   the mca_pml_ob1_send_inline optimization on the multithreaded case. All
</span><br>
...
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-13587/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
