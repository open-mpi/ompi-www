...
?>
<!-- received="Thu Jan  9 17:36:17 2014" -->
<!-- isoreceived="20140109223617" -->
<!-- sent="Thu, 9 Jan 2014 14:36:08 -0800" -->
<!-- isosent="20140109223608" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] trunk build failure on {Free,Net,Open}BSD" -->
<!-- id="8F753191-42C4-4CA9-978B-C85A1B94FF70_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2014-01-09 17:36:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13644.php">Adrian Reber: "Re: [OMPI devel] orte_barrier: Assertion `0 == item-&gt;opal_list_item_refcount' failed."</a>
<li><strong>Previous message:</strong> <a href="13642.php">Paul Hargrove: "Re: [OMPI devel] trunk - ibverbs configure error on Solaris-11"</a>
<li><strong>In reply to:</strong> <a href="13641.php">Paul Hargrove: "Re: [OMPI devel] trunk build failure on {Free,Net,Open}BSD"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13740.php">Paul Hargrove: "Re: [OMPI devel] trunk build failure on {Free,Net,Open}BSD"</a>
<li><strong>Reply:</strong> <a href="13740.php">Paul Hargrove: "Re: [OMPI devel] trunk build failure on {Free,Net,Open}BSD"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Jan 9, 2014, at 2:08 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Jeff,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The changes as described in the commit message make good sense to me except for one thing:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; In the 1.7 branch there is still a defined(__WINDOWS__) case for which opal_path_nfs() is currently a no-op .  So, I fear that if CMR'ed blindly both the configure-time and build-time checks to ensure that at least one of statfs() or statvs() will abort the build on Windows.  Maybe Marco can say more on the subject, but I think Cygwin will detect one or both of the stat calls, but opal_path_nfs() will still be a no-op due to the __WINDOWS__ guard.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I'll be building tonight's trunk tarball on all of my Solaris and *BSD systems.  So, I can at least confirm that the code builds (finds at least one of statfs() or statvfs()) on each platform.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; However, only my Solaris (10/SPARC and 11/x86-64) systems have NFS-mounted filesystems.  So, I don't have any means to ensure that the &quot;newly active&quot; code performs correctly on the BSD systems.  In other words, opal_path_nfs() might continue to always return false on BSD systems and I'd not know the difference.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; P.S. the commit message says &quot;modern flavors of *BSD OSs no longer define __BSD&quot;, but the FreeBSD-6.3 (circa 2008) system I also test doesn't define __BSD either.  So, I wonder if this code ever did worked as intended on the BSD systems.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Thu, Jan 9, 2014 at 1:30 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; Fixed on trunk in <a href="https://svn.open-mpi.org/trac/ompi/changeset/30198">https://svn.open-mpi.org/trac/ompi/changeset/30198</a>.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I can't test on all the kinds of systems Paul/Marco have, though -- we'll have to see what happens when he tries.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt; &gt; I fully concur - just limited by my available time to fix it. Jeff has volunteered to step in, though.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; On Jan 8, 2014, at 11:44 PM, marco atzeri &lt;marco.atzeri_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; list of all the systems for the latter actually is intended to amount to
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-13643/attachment">attachment</a>
</ul>
