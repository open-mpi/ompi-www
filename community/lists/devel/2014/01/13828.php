...
?>
<!-- received="Tue Jan 21 15:28:30 2014" -->
<!-- isoreceived="20140121202830" -->
<!-- sent="Tue, 21 Jan 2014 12:27:55 -0800" -->
<!-- isosent="20140121202755" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] callback debugging" -->
<!-- id="6E3F2DA1-8EEE-4340-84F9-340DE64572F3_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="20140121195649.GH30959_at_lisas.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-01-21 15:27:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13829.php">Adrian Reber: "Re: [OMPI devel] callback debugging"</a>
<li><strong>Previous message:</strong> <a href="13827.php">Adrian Reber: "Re: [OMPI devel] callback debugging"</a>
<li><strong>In reply to:</strong> <a href="13827.php">Adrian Reber: "Re: [OMPI devel] callback debugging"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13829.php">Adrian Reber: "Re: [OMPI devel] callback debugging"</a>
<li><strong>Reply:</strong> <a href="13829.php">Adrian Reber: "Re: [OMPI devel] callback debugging"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Jan 21, 2014, at 11:56 AM, Adrian Reber &lt;adrian_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Good to know that it does not make any sense. So it not just me.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Looking at the call chain I can see
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; orte_snapc_base_select(ORTE_PROC_IS_HNP, !ORTE_PROC_IS_DAEMON);
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; and the second parameter is used to decide if it is an app or not:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; int orte_snapc_base_select(bool seed, bool app) in orte/mca/snapc/base/snapc_base_select.c
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; and if it is true the code with the barrier is used.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; In orte/mca/snapc/base/snapc_base_select.c there is also following
</span><br>
<span class="quotelev1">&gt; comment:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; /* XXX -- TODO -- framework_subsytem -- this shouldn't be necessary once the framework system is in place */
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Is this something which needs to be changed and which might be the cause
</span><br>
<span class="quotelev1">&gt; for this problem?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Tue, Jan 21, 2014 at 07:27:32AM -0800, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; That doesn't make any sense - I can't imagine a reason for orte-checkpoint itself to be running a barrier. I wonder if it is selecting the wrong component in snapc?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; As for the patch, that isn't going to work. The collective id has to be *globally* unique, which means that only orterun can issue a new one. So you have to get thru orte_init before you can request one as it requires a communication.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; However, like I said, it makes no sense for orte-checkpoint to do a barrier as it is a singleton - there is nothing for it to &quot;barrier&quot; with.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Jan 21, 2014, at 7:24 AM, Adrian Reber &lt;adrian_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I think I still do not really understand how it works.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The barrier on which orte-checkpoint is currently hanging is in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; app_coord_init(). You are also saying that orte-checkpoint
</span><br>
<span class="quotelev3">&gt;&gt;&gt; should not be calling a barrier. The backtrace of the point where it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; is hanging now looks like:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #0  0x00007ffff69befa0 in __nanosleep_nocancel () at ../sysdeps/unix/syscall-template.S:81
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #1  0x00007ffff7b45712 in app_coord_init () at ../../../../../orte/mca/snapc/full/snapc_full_app.c:208
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #2  0x00007ffff7b3a5ce in orte_snapc_full_module_init (seed=false, app=true) at ../../../../../orte/mca/snapc/full/snapc_full_module.c:207
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #3  0x00007ffff7b375de in orte_snapc_base_select (seed=false, app=true) at ../../../../orte/mca/snapc/base/snapc_base_select.c:96
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #4  0x00007ffff7a9884a in orte_ess_base_tool_setup () at ../../../../orte/mca/ess/base/ess_base_std_tool.c:192
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #5  0x00007ffff7a9fe85 in rte_init () at ../../../../../orte/mca/ess/tool/ess_tool_module.c:83
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #6  0x00007ffff7a4647f in orte_init (pargc=0x7fffffffd94c, pargv=0x7fffffffd940, flags=8) at ../../orte/runtime/orte_init.c:158
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #7  0x0000000000402859 in ckpt_init (argc=51, argv=0x7fffffffda78) at ../../../../orte/tools/orte-checkpoint/orte-checkpoint.c:610
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #8  0x0000000000401d7a in main (argc=51, argv=0x7fffffffda78) at ../../../../orte/tools/orte-checkpoint/orte-checkpoint.c:245
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Maybe I am doing something completely wrong. I am currently
</span><br>
<span class="quotelev3">&gt;&gt;&gt; running 'orterun -np 2 test-programm'.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; In another terminal I am starting orte-checkpoint with the PID of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; orterun and the barrier in app_coord_init() is just before it tries
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to communicate with orterun. Is this the correct setup?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Mon, Jan 20, 2014 at 05:33:59PM -0600, Josh Hursey wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; If it is the application, then there is probably a barrier in the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; app_coord_init() to make sure all the applications are up and running.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; After this point then the global coordinator knows that the application can
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; be checkpointed.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I don't think orte-checkpoint should be calling a barrier - from what I
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mon, Jan 20, 2014 at 4:46 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Is it orte-checkpoint that is hanging, or the app you are trying to
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; QOTD:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 	&quot;I tried buying a goat instead of a lawn tractor; had to return
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 	it though.  Couldn't figure out a way to connect the snow blower.&quot;
</span><br>
...
<span class="quotelev1">&gt; Hempstone's Question:
</span><br>
<span class="quotelev1">&gt; 	If you have to travel on the Titanic, why not go first class?
</span><br>
<span class="quotelev1">&gt; _______________________________________________
</span><br>
<span class="quotelev1">&gt; devel mailing list
