<?
$subject_val = "Re: [OMPI devel] Specific use case - very very new to MPI";
...
<!-- subject="Re: [OMPI devel] Specific use case - very very new to MPI" -->
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI devel] Specific use case - very very new to MPI<br>
<strong>From:</strong> Kenneth Adam Miller (<em>kennethadammiller_at_[hidden]</em>)<br>
<strong>Date:</strong> 2014-01-24 13:22:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13909.php">Ralph Castain: "Re: [OMPI devel] 1.7.4rc: yet another launch failure"</a>
<li><strong>Previous message:</strong> <a href="13907.php">Ralph Castain: "Re: [OMPI devel] 1.7.4rc2r30403 testing report"</a>
<li><strong>In reply to:</strong> <a href="13902.php">Kenneth Adam Miller: "[OMPI devel] Specific use case - very very new to MPI"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-13908/attachment">attachment</a>
</ul>
