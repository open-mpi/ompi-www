...
?>
<!-- received="Wed Jan  8 23:23:47 2014" -->
<!-- isoreceived="20140109042347" -->
<!-- sent="Wed, 8 Jan 2014 20:23:45 -0800" -->
<!-- isosent="20140109042345" -->
<!-- name="Paul Hargrove" -->
<!-- email="phhargrove_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] 1.7.4rc2r30148 - crash in MPI_Init on Linux/x86" -->
<!-- id="CAAvDA17Sw5BFbL-6AZ9BnW_8RVQYCfHNTYUM00KJkF6k4W3-MQ_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="D8A98097-DE55-4FBE-B8B1-E4B2FDE186AF_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-01-08 23:23:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13606.php">Ralph Castain: "Re: [OMPI devel] 1.7.4rc2r30148 - crash in MPI_Init on Linux/x86"</a>
<li><strong>Previous message:</strong> <a href="13604.php">Ralph Castain: "Re: [OMPI devel] 1.7.4rc2r30148 run failure NetBSD6-x86"</a>
<li><strong>In reply to:</strong> <a href="13602.php">Ralph Castain: "Re: [OMPI devel] 1.7.4rc2r30148 - crash in MPI_Init on Linux/x86"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13606.php">Ralph Castain: "Re: [OMPI devel] 1.7.4rc2r30148 - crash in MPI_Init on Linux/x86"</a>
<li><strong>Reply:</strong> <a href="13606.php">Ralph Castain: "Re: [OMPI devel] 1.7.4rc2r30148 - crash in MPI_Init on Linux/x86"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>Building with gcc-4.1.2 fixed the problem for me.  I also removed an old
<br>
...
<br>
<p>I can build again with gcc-4.0.0 and --enable-debug if you are still
<br>
...
<br>
<p><span class="quotelev1">&gt; Most likely problem is a bad backing store site - any chance you could
</span><br>
<span class="quotelev1">&gt; give me a line number from this? There are a lot of calls to register
</span><br>
<span class="quotelev1">&gt; params in that code and I'd need some help in figuring out which one wasn't
</span><br>
...
<span class="quotelev1">&gt; I am still testing the current 1.7.4rc tarball on my various systems.  The
</span><br>
<span class="quotelev1">&gt; latest failure (shown below) is a SEGV somewhere below MPI_Init on a old,
</span><br>
<span class="quotelev1">&gt; but otherwise fairly normal, Linux/x86 (32-bit) system.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; mpirun noticed that process rank 0 with PID 29031 on node pcp-j-6 exited
</span><br>
...
<span class="quotelev1">&gt; Linux pcp-j-6 2.6.18-238.1.1.el5PAE #1 SMP Tue Jan 18 19:28:42 EST 2011
</span><br>
<span class="quotelev1">&gt; i686 athlon i386 GNU/Linux
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-13605/attachment">attachment</a>
</ul>
