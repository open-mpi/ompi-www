...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15627.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] OpenMPI fails with np &gt; 65"</a>
<li><strong>Previous message:</strong> <a href="15625.php">Gilles Gouaillardet: "Re: [OMPI devel] Grammar error in git master: 'You job will now abort'"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15627.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] OpenMPI fails with np &gt; 65"</a>
<li><strong>Reply:</strong> <a href="15627.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] OpenMPI fails with np &gt; 65"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15626/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/x-compressed attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15626/mpi65.tgz">mpi65.tgz</a>
</ul>
