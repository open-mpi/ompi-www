...
?>
<!-- received="Fri Aug  8 00:45:56 2014" -->
<!-- isoreceived="20140808044556" -->
<!-- sent="Fri, 8 Aug 2014 04:45:50 +0000" -->
<!-- isosent="20140808044550" -->
<!-- name="Kawashima, Takahiro" -->
<!-- email="t-kawashima_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc" -->
<!-- id="20140808134551.3eec01b48529f3885c048c7e_at_jp.fujitsu.com" -->
<!-- charset="iso-2022-jp" -->
<!-- inreplyto="53E45050.4030500_at_iferc.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-08 00:45:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15547.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Previous message:</strong> <a href="15545.php">George Bosilca: "Re: [OMPI devel] RFC: add atomic compare-and-swap that returns old value"</a>
<li><strong>In reply to:</strong> <a href="15543.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15547.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Reply:</strong> <a href="15547.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gilles, George,
<br>
<p>The problem is the one Gilles pointed.
<br>
I temporarily modified the code bellow and the bus error disappeared.
<br>
<p>--- orte/util/nidmap.c  (revision 32447)
<br>
...
<span class="quotelev1">&gt; note the patch is not enough (and will not apply on the v1.8 branch anyway),
</span><br>
...
<span class="quotelev2">&gt; &gt; #0 0xffffffff00db4740 (__waitpid_nocancel + 0x44) (0x200,0x0,0x0,0xa0,0xfffff80100064af0,0x35b4)
</span><br>
<span class="quotelev2">&gt; &gt; #1 0xffffffff0001a310 (handle_signal + 0x574) (signo=10,info=(struct siginfo *) 0x000007feffffd100,p=(void *) 0x000007feffffd100) at line 277 in ../sigattach.c &lt;SIGNAL HANDLER&gt;
</span><br>
<span class="quotelev2">&gt; &gt; #2 0xffffffff0282aff4 (store + 0x540) (uid=(unsigned long *) 0xffffffff0118a128,scope=8:'\b',key=(char *) 0xffffffff0106a0a8 &quot;opal.local.ldr&quot;,data=(void *) 0x000007feffffde74,type=15:'\017') at line 252 in db_hash.c
</span><br>
<span class="quotelev2">&gt; &gt; #3 0xffffffff01266350 (opal_db_base_store + 0xc4) (proc=(unsigned long *) 0xffffffff0118a128,scope=8:'\b',key=(char *) 0xffffffff0106a0a8 &quot;opal.local.ldr&quot;,object=(void *) 0x000007feffffde74,type=15:'\017') at line 49 in db_base_fns.c
</span><br>
<span class="quotelev2">&gt; &gt; #4 0xffffffff00fdbab4 (orte_util_decode_pidmap + 0x790) (bo=(struct *) 0x0000000000281d70) at line 975 in nidmap.c
</span><br>
<span class="quotelev2">&gt; &gt; #5 0xffffffff00fd6d20 (orte_util_nidmap_init + 0x3dc) (buffer=(struct opal_buffer_t *) 0x0000000000241fc0) at line 141 in nidmap.c
</span><br>
<span class="quotelev2">&gt; &gt; #6 0xffffffff01e298cc (rte_init + 0x2a0) () at line 153 in ess_env_module.c
</span><br>
<span class="quotelev2">&gt; &gt; #7 0xffffffff00f9f28c (orte_init + 0x308) (pargc=(int *) 0x0000000000000000,pargv=(char ***) 0x0000000000000000,flags=32) at line 148 in orte_init.c
</span><br>
<span class="quotelev2">&gt; &gt; #8 0xffffffff001a6f08 (ompi_mpi_init + 0x31c) (argc=1,argv=(char **) 0x000007fefffff348,requested=0,provided=(int *) 0x000007feffffe698) at line 464 in ompi_mpi_init.c
</span><br>
<span class="quotelev2">&gt; &gt; #9 0xffffffff001ff79c (MPI_Init + 0x2b0) (argc=(int *) 0x000007feffffe814,argv=(char ***) 0x000007feffffe818) at line 84 in init.c
</span><br>
<span class="quotelev2">&gt; &gt; #10 0x0000000000100ae4 (main + 0x44) (argc=1,argv=(char **) 0x000007fefffff348) at line 8 in mpiinitfinalize.c
</span><br>
<span class="quotelev2">&gt; &gt; #11 0xffffffff00d2b81c (__libc_start_main + 0x194) (0x100aa0,0x1,0x7fefffff348,0x100d24,0x100d14,0x0)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; ../openmpi-1.8.2rc3/configure --prefix=/usr/local/openmpi-1.8.2_64_gcc \
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; To remove this message, put `dbxenv suppress_startup_message 7.9' in your 
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;  [2] list_files_by_dir(0x100138fd8, 0xffffffff7fffd1f0, 0xffffffff7fffd1e8, 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 0xffffffff7fffd210, 0x0, 0xffffffff702a0010), at 
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; 0xffffffff63174594 
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;  [3] foreachfile_callback(0x100138fd8, 0xffffffff7fffd458, 0x0, 0x2e, 0x0, 
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;  [5] lt_dlforeachfile(0x1001d8a28, 0xffffffff6319656c, 0x0, 0x53, 0x2f, 
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;  [7] mca_base_component_find(0x0, 0xffffffff6323b570, 0xffffffff6335e1b0, 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 0x0, 0xffffffff7fffd6a0, 0x1), at 0xffffffff631954d8 
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;  [8] mca_base_framework_components_register(0xffffffff6335e1c0, 0x0, 0x3e, 
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; mpiexec noticed that process rank 0 with PID 27867 on node tyr exited on 
</span><br>
