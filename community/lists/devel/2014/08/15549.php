...
?>
<!-- received="Fri Aug  8 01:58:34 2014" -->
<!-- isoreceived="20140808055834" -->
<!-- sent="Fri, 8 Aug 2014 01:58:32 -0400" -->
<!-- isosent="20140808055832" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc" -->
<!-- id="CAMJJpkX9NmE2NM5ayDWG-dgwwrutxan=4dRvRKfKHQPkaYcn1g_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="53E45A77.5060600_at_iferc.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-08 01:58:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15550.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Previous message:</strong> <a href="15548.php">Kawashima, Takahiro: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>In reply to:</strong> <a href="15547.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15550.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Reply:</strong> <a href="15550.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Looking at the code one might notice that the orte_process_name_t is stored
<br>
...
<p>&nbsp;&nbsp;George.
<br>
<p><p><p>On Fri, Aug 8, 2014 at 1:04 AM, Gilles Gouaillardet &lt;
<br>
gilles.gouaillardet_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Kawashima-san and all,
</span><br>
...
<span class="quotelev2">&gt; &gt; Gilles, George,
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; The problem is the one Gilles pointed.
</span><br>
<span class="quotelev2">&gt; &gt; I temporarily modified the code bellow and the bus error disappeared.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; --- orte/util/nidmap.c  (revision 32447)
</span><br>
<span class="quotelev2">&gt; &gt; +++ orte/util/nidmap.c  (working copy)
</span><br>
<span class="quotelev2">&gt; &gt; @@ -885,7 +885,7 @@
</span><br>
<span class="quotelev2">&gt; &gt;      orte_proc_state_t state;
</span><br>
<span class="quotelev2">&gt; &gt;      orte_app_idx_t app_idx;
</span><br>
<span class="quotelev2">&gt; &gt;      int32_t restarts;
</span><br>
<span class="quotelev2">&gt; &gt; -    orte_process_name_t proc, dmn;
</span><br>
<span class="quotelev2">&gt; &gt; +    orte_process_name_t proc __attribute__((__aligned__(8))), dmn;
</span><br>
<span class="quotelev2">&gt; &gt;      char *hostname;
</span><br>
<span class="quotelev2">&gt; &gt;      uint8_t flag;
</span><br>
<span class="quotelev2">&gt; &gt;      opal_buffer_t *bptr;
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; This is interesting :-)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; proc is in the stack and has type orte_process_name_t
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; typedef uint32_t orte_jobid_t;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; typedef uint32_t orte_vpid_t;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; so there is really no reason to align this on 8 bytes...
</span><br>
<span class="quotelev3">&gt; &gt;&gt; but later, proc is casted into an uint64_t ...
</span><br>
<span class="quotelev3">&gt; &gt;&gt; so proc should have been aligned on 8 bytes but it is too late,
</span><br>
<span class="quotelev3">&gt; &gt;&gt; and hence the glory SIGBUS
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; this is loosely related to
</span><br>
<span class="quotelev3">&gt; &gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15532.php">http://www.open-mpi.org/community/lists/devel/2014/08/15532.php</a>
</span><br>
<span class="quotelev3">&gt; &gt;&gt; (see heterogeneous.v2.patch)
</span><br>
<span class="quotelev3">&gt; &gt;&gt; if we make opal_process_name_t an union of uint64_t and a struct of two
</span><br>
<span class="quotelev3">&gt; &gt;&gt; uint32_t, the compiler
</span><br>
<span class="quotelev3">&gt; &gt;&gt; will align this on 8 bytes.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; note the patch is not enough (and will not apply on the v1.8 branch
</span><br>
<span class="quotelev1">&gt; anyway),
</span><br>
<span class="quotelev3">&gt; &gt;&gt; we could simply remove orte_process_name_t and ompi_process_name_t and
</span><br>
<span class="quotelev3">&gt; &gt;&gt; use only
</span><br>
<span class="quotelev3">&gt; &gt;&gt; opal_process_name_t (and never declare variables with type
</span><br>
<span class="quotelev3">&gt; &gt;&gt; opal_proc_name_t otherwise alignment might be incorrect)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; as a workaround, you can declare an opal_process_name_t (for alignment),
</span><br>
<span class="quotelev3">&gt; &gt;&gt; and cast it to an orte_process_name_t
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; i will write a patch (i will not be able to test on sparc ...)
</span><br>
<span class="quotelev3">&gt; &gt;&gt; please note this issue might be present in other places
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On 2014/08/08 13:03, Kawashima, Takahiro wrote:
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; I've finally reproduced the bus error in my SPARC environment.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #0 0xffffffff00db4740 (__waitpid_nocancel + 0x44)
</span><br>
<span class="quotelev1">&gt; (0x200,0x0,0x0,0xa0,0xfffff80100064af0,0x35b4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #1 0xffffffff0001a310 (handle_signal + 0x574) (signo=10,info=(struct
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; #2 0xffffffff0282aff4 (store + 0x540) (uid=(unsigned long *)
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; #3 0xffffffff01266350 (opal_db_base_store + 0xc4) (proc=(unsigned long
</span><br>
<span class="quotelev1">&gt; *) 0xffffffff0118a128,scope=8:'\b',key=(char *) 0xffffffff0106a0a8
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; #4 0xffffffff00fdbab4 (orte_util_decode_pidmap + 0x790) (bo=(struct *)
</span><br>
<span class="quotelev1">&gt; 0x0000000000281d70) at line 975 in nidmap.c
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #5 0xffffffff00fd6d20 (orte_util_nidmap_init + 0x3dc) (buffer=(struct
</span><br>
<span class="quotelev1">&gt; opal_buffer_t *) 0x0000000000241fc0) at line 141 in nidmap.c
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #6 0xffffffff01e298cc (rte_init + 0x2a0) () at line 153 in
</span><br>
<span class="quotelev1">&gt; ess_env_module.c
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #7 0xffffffff00f9f28c (orte_init + 0x308) (pargc=(int *)
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; #8 0xffffffff001a6f08 (ompi_mpi_init + 0x31c) (argc=1,argv=(char **)
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; #9 0xffffffff001ff79c (MPI_Init + 0x2b0) (argc=(int *)
</span><br>
<span class="quotelev1">&gt; 0x000007feffffe814,argv=(char ***) 0x000007feffffe818) at line 84 in init.c
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #10 0x0000000000100ae4 (main + 0x44) (argc=1,argv=(char **)
</span><br>
<span class="quotelev1">&gt; 0x000007fefffff348) at line 8 in mpiinitfinalize.c
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #11 0xffffffff00d2b81c (__libc_start_main + 0x194)
</span><br>
<span class="quotelev1">&gt; (0x100aa0,0x1,0x7fefffff348,0x100d24,0x100d14,0x0)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #12 0x000000000010094c (_start + 0x2c) ()
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; The line 252 in opal/mca/db/hash/db_hash.c is:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;     case OPAL_UINT64:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;         if (NULL == data) {
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;             OPAL_ERROR_LOG(OPAL_ERR_BAD_PARAM);
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;             return OPAL_ERR_BAD_PARAM;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;         }
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;         kv-&gt;type = OPAL_UINT64;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;         kv-&gt;data.uint64 = *(uint64_t*)(data); // !!! here !!!
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;         break;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; My environment is:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;   Open MPI v1.8 branch r32447 (latest)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;   configure --enable-debug
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;   SPARC-V9 (Fujitsu SPARC64 IXfx)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;   Linux (custom)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;   gcc 4.2.4
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; I could not reproduce it with Open MPI trunk nor with Fujitsu compiler.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Can this information help?
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;  [2] list_files_by_dir(0x100138fd8, 0xffffffff7fffd1f0,
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;  [3] foreachfile_callback(0x100138fd8, 0xffffffff7fffd458, 0x0,
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;  [5] lt_dlforeachfile(0x1001d8a28, 0xffffffff6319656c, 0x0, 0x53,
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;  [7] mca_base_component_find(0x0, 0xffffffff6323b570,
</span><br>
<span class="quotelev1">&gt; 0xffffffff6335e1b0,
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; 0x0, 0xffffffff7fffd6a0, 0x1), at 0xffffffff631954d8
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;  [8] mca_base_framework_components_register(0xffffffff6335e1c0,
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; Starting program: /usr/local/openmpi-1.8.2_64_gcc/bin/mpiexec -np 1
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; mpiexec noticed that process rank 0 with PID 27867 on node tyr
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; #4  0xffffffff7f624574 in remove_hdl () from
</span><br>
<span class="quotelev1">&gt; /usr/lib/sparcv9/ld.so.1
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; #5  0xffffffff7f61d97c in dlclose_core () from
</span><br>
<span class="quotelev1">&gt; /usr/lib/sparcv9/ld.so.1
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; #6  0xffffffff7f61d9d4 in dlclose_intn () from
</span><br>
<span class="quotelev1">&gt; /usr/lib/sparcv9/ld.so.1
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; #11 0xffffffff7ec98488 in opal_obj_run_destructors
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;    components=0xffffffff7f12b430 &lt;orte_oob_base_framework+80&gt;,
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; Is the above information helpful to track down the error? Do you
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15547.php">http://www.open-mpi.org/community/lists/devel/2014/08/15547.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15549/attachment">attachment</a>
</ul>
