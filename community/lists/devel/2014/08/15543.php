...
?>
<!-- received="Fri Aug  8 00:21:36 2014" -->
<!-- isoreceived="20140808042136" -->
<!-- sent="Fri, 08 Aug 2014 13:21:36 +0900" -->
<!-- isosent="20140808042136" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc" -->
<!-- id="53E45050.4030500_at_iferc.org" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="20140808130353.bd7dc1b05950ce3004d7cb33_at_jp.fujitsu.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-08 00:21:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15544.php">Kawashima, Takahiro: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Previous message:</strong> <a href="15542.php">George Bosilca: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>In reply to:</strong> <a href="15541.php">Kawashima, Takahiro: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15546.php">Kawashima, Takahiro: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Reply:</strong> <a href="15546.php">Kawashima, Takahiro: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>proc is in the stack and has type orte_process_name_t
<br>
<p>with
<br>
<p>typedef uint32_t orte_jobid_t;
<br>
...
<br>
<p><p>so there is really no reason to align this on 8 bytes...
<br>
...
<br>
<p><p>this is loosely related to
<br>
...
<br>
<p>as a workaround, you can declare an opal_process_name_t (for alignment),
<br>
and cast it to an orte_process_name_t
<br>
<p>i will write a patch (i will not be able to test on sparc ...)
<br>
...
<p>Gilles
<br>
<p>On 2014/08/08 13:03, Kawashima, Takahiro wrote:
<br>
...
<span class="quotelev1">&gt; #0 0xffffffff00db4740 (__waitpid_nocancel + 0x44) (0x200,0x0,0x0,0xa0,0xfffff80100064af0,0x35b4)
</span><br>
<span class="quotelev1">&gt; #1 0xffffffff0001a310 (handle_signal + 0x574) (signo=10,info=(struct siginfo *) 0x000007feffffd100,p=(void *) 0x000007feffffd100) at line 277 in ../sigattach.c &lt;SIGNAL HANDLER&gt;
</span><br>
<span class="quotelev1">&gt; #2 0xffffffff0282aff4 (store + 0x540) (uid=(unsigned long *) 0xffffffff0118a128,scope=8:'\b',key=(char *) 0xffffffff0106a0a8 &quot;opal.local.ldr&quot;,data=(void *) 0x000007feffffde74,type=15:'\017') at line 252 in db_hash.c
</span><br>
<span class="quotelev1">&gt; #3 0xffffffff01266350 (opal_db_base_store + 0xc4) (proc=(unsigned long *) 0xffffffff0118a128,scope=8:'\b',key=(char *) 0xffffffff0106a0a8 &quot;opal.local.ldr&quot;,object=(void *) 0x000007feffffde74,type=15:'\017') at line 49 in db_base_fns.c
</span><br>
<span class="quotelev1">&gt; #4 0xffffffff00fdbab4 (orte_util_decode_pidmap + 0x790) (bo=(struct *) 0x0000000000281d70) at line 975 in nidmap.c
</span><br>
<span class="quotelev1">&gt; #5 0xffffffff00fd6d20 (orte_util_nidmap_init + 0x3dc) (buffer=(struct opal_buffer_t *) 0x0000000000241fc0) at line 141 in nidmap.c
</span><br>
<span class="quotelev1">&gt; #6 0xffffffff01e298cc (rte_init + 0x2a0) () at line 153 in ess_env_module.c
</span><br>
<span class="quotelev1">&gt; #7 0xffffffff00f9f28c (orte_init + 0x308) (pargc=(int *) 0x0000000000000000,pargv=(char ***) 0x0000000000000000,flags=32) at line 148 in orte_init.c
</span><br>
<span class="quotelev1">&gt; #8 0xffffffff001a6f08 (ompi_mpi_init + 0x31c) (argc=1,argv=(char **) 0x000007fefffff348,requested=0,provided=(int *) 0x000007feffffe698) at line 464 in ompi_mpi_init.c
</span><br>
<span class="quotelev1">&gt; #9 0xffffffff001ff79c (MPI_Init + 0x2b0) (argc=(int *) 0x000007feffffe814,argv=(char ***) 0x000007feffffe818) at line 84 in init.c
</span><br>
<span class="quotelev1">&gt; #10 0x0000000000100ae4 (main + 0x44) (argc=1,argv=(char **) 0x000007fefffff348) at line 8 in mpiinitfinalize.c
</span><br>
<span class="quotelev1">&gt; #11 0xffffffff00d2b81c (__libc_start_main + 0x194) (0x100aa0,0x1,0x7fefffff348,0x100d24,0x100d14,0x0)
</span><br>
...
<span class="quotelev2">&gt;&gt; ../openmpi-1.8.2rc3/configure --prefix=/usr/local/openmpi-1.8.2_64_gcc \
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; To remove this message, put `dbxenv suppress_startup_message 7.9' in your 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;  [2] list_files_by_dir(0x100138fd8, 0xffffffff7fffd1f0, 0xffffffff7fffd1e8, 
</span><br>
<span class="quotelev2">&gt;&gt; 0xffffffff7fffd210, 0x0, 0xffffffff702a0010), at 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 0xffffffff63174594 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  [3] foreachfile_callback(0x100138fd8, 0xffffffff7fffd458, 0x0, 0x2e, 0x0, 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;  [5] lt_dlforeachfile(0x1001d8a28, 0xffffffff6319656c, 0x0, 0x53, 0x2f, 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;  [7] mca_base_component_find(0x0, 0xffffffff6323b570, 0xffffffff6335e1b0, 
</span><br>
<span class="quotelev2">&gt;&gt; 0x0, 0xffffffff7fffd6a0, 0x1), at 0xffffffff631954d8 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  [8] mca_base_framework_components_register(0xffffffff6335e1c0, 0x0, 0x3e, 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Starting program: /usr/local/openmpi-1.8.2_64_gcc/bin/mpiexec -np 1 a.out
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; mpiexec noticed that process rank 0 with PID 27867 on node tyr exited on 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #11 0xffffffff7ec98488 in opal_obj_run_destructors (object=0x1001ead30)
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;    component=0xffffffff7b023cf0 &lt;mca_oob_tcp_component&gt;, output_id=-1)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;    at 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;    components=0xffffffff7f12b430 &lt;orte_oob_base_framework+80&gt;, skip=0x0)
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;    at ../../../../openmpi-1.8.2rc3/orte/mca/oob/base/oob_base_frame.c:94
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;    at ../../../../openmpi-1.8.2rc3/opal/mca/base/mca_base_framework.c:187
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #19 0xffffffff7bf078c0 in rte_finalize ()
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;    at ../../../../../openmpi-1.8.2rc3/orte/mca/ess/hnp/ess_hnp_module.c:858
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Is the above information helpful to track down the error? Do you need
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15541.php">http://www.open-mpi.org/community/lists/devel/2014/08/15541.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
