...
?>
<!-- received="Tue Aug  5 13:16:16 2014" -->
<!-- isoreceived="20140805171616" -->
<!-- sent="Tue, 5 Aug 2014 10:15:53 -0700" -->
<!-- isosent="20140805171553" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins" -->
<!-- id="A021C39E-8A5C-4759-8B14-582A4B7A13B6_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="CAMJJpkUyGv3xd04wCeaFcoFgiqWn0_ym=0Bv3Jm6d=CFJ53=FA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-05 13:15:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15520.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Previous message:</strong> <a href="15518.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>In reply to:</strong> <a href="15518.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15520.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Reply:</strong> <a href="15520.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Hmmm...wouldn't that then require that you know (a) the other side is little endian, and (b) that you are on a big endian? Otherwise, you wind up with the same issue in reverse, yes?
<br>
<p>In the ORTE methods, we explicitly set the fields (e.g., jobid = ntohl(remote-jobid)) to get around this problem. I missed that he did it by location instead of named fields - perhaps we should do that instead?
<br>
<p><p>On Aug 5, 2014, at 10:06 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Technically speaking, converting a 64 bits to a big endian representation requires the swap of the 2 32 bits parts. So the correct approach would have been:
</span><br>
...
<span class="quotelev1">&gt; On Aug 4, 2014, at 10:25 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; i am not convinced i chose the most elegant way to achieve the desired result ...
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Aug 1, 2014, at 06:52 , Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15509.php">http://www.open-mpi.org/community/lists/devel/2014/08/15509.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15519/attachment">attachment</a>
</ul>
