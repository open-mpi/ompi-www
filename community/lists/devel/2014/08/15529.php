...
?>
<!-- received="Wed Aug  6 07:02:30 2014" -->
<!-- isoreceived="20140806110230" -->
<!-- sent="Wed, 06 Aug 2014 20:02:28 +0900" -->
<!-- isosent="20140806110228" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins" -->
<!-- id="53E20B44.5010704_at_iferc.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="CAAkFZ5td8mmFk=gBFN6rON3c8hc8_2ytKcZ2ohRJrLpBc2Jkww_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-06 07:02:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15530.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Previous message:</strong> <a href="15528.php">Gilles Gouaillardet: "Re: [OMPI devel] [1.8.2rc3] static linking fails on linux when not building ROMIO"</a>
<li><strong>In reply to:</strong> <a href="15527.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15530.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Reply:</strong> <a href="15530.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph and George,
<br>
<p>here is attached a patch that fixes the heterogeneous support without
<br>
...
<p>Gilles
<br>
<p>On 2014/08/06 9:40, Gilles Gouaillardet wrote:
<br>
...
<span class="quotelev1">&gt; On Wed, Aug 6, 2014 at 8:17 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Ah yes, so it is - sorry I missed that last test :-/
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Aug 5, 2014, at 10:50 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; The code committed by Gilles is correctly protected for big endian (
</span><br>
<span class="quotelev2">&gt;&gt; <a href="https://svn.open-mpi.org/trac/ompi/changeset/32425">https://svn.open-mpi.org/trac/ompi/changeset/32425</a>). I was merely
</span><br>
<span class="quotelev2">&gt;&gt; pointing out that I think he should also swap the 2 32 bits in his
</span><br>
...
<span class="quotelev2">&gt;&gt; On Tue, Aug 5, 2014 at 1:32 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Aug 5, 2014, at 10:23 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Tue, Aug 5, 2014 at 1:15 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hmmm...wouldn't that then require that you know (a) the other side is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; little endian, and (b) that you are on a big endian? Otherwise, you wind up
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; with the same issue in reverse, yes?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; This is similar to the 32 bits ntohl that we are using in other parts of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the project. Any  little endian participant will do the conversion, while
</span><br>
<span class="quotelev3">&gt;&gt;&gt; every big endian participant will use an empty macro instead.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; In the ORTE methods, we explicitly set the fields (e.g., jobid =
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ntohl(remote-jobid)) to get around this problem. I missed that he did it by
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; location instead of named fields - perhaps we should do that instead?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; As soon as we impose the ORTE naming scheme at the OPAL level (aka. the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; notion of jobid and vpid) this approach will become possible.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Not proposing that at all so long as the other method will work without
</span><br>
<span class="quotelev3">&gt;&gt;&gt; knowing the other side's endianness. Sounds like your approach should work
</span><br>
<span class="quotelev3">&gt;&gt;&gt; fine as long as Gilles adds a #if so big endian defines the macro away
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Aug 5, 2014, at 10:06 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Technically speaking, converting a 64 bits to a big endian
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; representation requires the swap of the 2 32 bits parts. So the correct
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; approach would have been:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; uint64_t htonll(uint64_t v)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; {
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     return ((((uint64_t)ntohl(n)) &lt;&lt; 32 | (uint64_t)ntohl(n &gt;&gt; 32));
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; }
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Tue, Aug 5, 2014 at 5:52 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15518.php">http://www.open-mpi.org/community/lists/devel/2014/08/15518.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15519.php">http://www.open-mpi.org/community/lists/devel/2014/08/15519.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15520.php">http://www.open-mpi.org/community/lists/devel/2014/08/15520.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15521.php">http://www.open-mpi.org/community/lists/devel/2014/08/15521.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15523.php">http://www.open-mpi.org/community/lists/devel/2014/08/15523.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15526.php">http://www.open-mpi.org/community/lists/devel/2014/08/15526.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev1">&gt;
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15529/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15529/heterogeneous.patch">heterogeneous.patch</a>
</ul>
