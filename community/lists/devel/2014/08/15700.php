...
?>
<!-- received="Mon Aug 25 04:19:02 2014" -->
<!-- isoreceived="20140825081902" -->
<!-- sent="Mon, 25 Aug 2014 17:19:11 +0900" -->
<!-- isosent="20140825081911" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] MPI_Abort does not make mpirun return with the right exit code" -->
<!-- id="53FAF17F.5090800_at_iferc.org" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="BEF789B7-88F7-4284-B3F3-EA6A8C3C7032_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-25 04:19:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15701.php">Gilles Gouaillardet: "[OMPI devel] pmix: race condition in dynamic/intercomm_create from the ibm test suite"</a>
<li><strong>Previous message:</strong> <a href="15699.php">Jeff Squyres (jsquyres): "Re: [OMPI devel] 1.8.2rc4 problem: only 32 out of 48 cores are working"</a>
<li><strong>In reply to:</strong> <a href="15697.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] MPI_Abort does not make mpirun return with the right exit code"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Thanks Ralph !
<br>
<p>i confirm my all test cases pass now :-)
<br>
<p>FYI, i commited r32592 in order to fix a parsing bug on 32bits platform
<br>
...
<p>Gilles
<br>
<p><p>On 2014/08/23 4:59, Ralph Castain wrote:
<br>
<span class="quotelev1">&gt; I think these are fixed now - at least, your test cases all pass for me
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Aug 22, 2014, at 9:12 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Aug 22, 2014, at 9:06 AM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Will do on Monday
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; About the first test, in my case echo $? returns 0
</span><br>
<span class="quotelev2">&gt;&gt; My &quot;showcode&quot; is just an alias for the echo
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I noticed this confusing message in your output :
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpirun noticed that process rank 0 with PID 24382 on node bend002 exited on signal 0 (Unknown signal 0).
</span><br>
<span class="quotelev2">&gt;&gt; I'll take a look at why that happened
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; About the second test, please note my test program return 3;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; whereas your mpi_no_op.c return 0;
</span><br>
<span class="quotelev2">&gt;&gt; I didn't see that little cuteness - sigh
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; You might want to try again with current head of trunk as something seems off in what you are seeing - more below
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Aug 22, 2014, at 3:12 AM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; i tried again after the merge and found the same behaviour, though the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; internals are very different.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; i run without any batch manager
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; from node0:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun -np 1 --mca btl tcp,self -host node1 ./abort
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; exit with exit code zero :-(
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hmmm...it works fine for me, without your patch:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 07:35:41  $ mpirun -n 1 -mca btl tcp,self -host bend002 ./abort
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 07:35:56  $ showcode
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 130
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; short story : i applied pmix.2.patch and that fixed my problem
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; could you please review this ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; long story :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; i initially applied pmix.1.patch and it solved my problem
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; then i ran
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun -np 1 --mca btl openib,self -host node1 ./abort
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; and i came back to square one : exit code is zero
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; so i used the debugger and was unable to reproduce the issue
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (one more race condition, yeah !)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; finally, i wrote pmix.2.patch, fixed my issue and realized that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; pmix.1.patch was no more needed.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; currently, and assuming pmix.2.patch is correct, i cannot tell wether
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; pmix.1.patch is needed or not
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; since this part of the code is no more executed.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; i also found one hang with the following trivial program within one node :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; $ mpirun -np 1 ./test
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -------------------------------------------------------
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; AND THE PROGRAM HANGS
</span><br>
<span class="quotelev3">&gt;&gt;&gt; This also works fine for me:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 07:37:27  $ mpirun -n 1 ./mpi_no_op
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 07:37:36  $ cat mpi_no_op.c
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;  * The most basic of MPI applications
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  */
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; $ mpirun -np 1 -host node1 ./test
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -------------------------------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Primary job  terminated normally, but 1 process returned
...
<span class="quotelev4">&gt;&gt;&gt;&gt;  Process name: [[22080,1],0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  Exit code:    3
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; return with exit code 3.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Likewise here - works just fine for me
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; then i found a strange behaviour with helloworld if only the self btl is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; used :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $ mpirun -np 1 --mca btl self ./hw
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [helios91:23319] OPAL dss:unpack: got type 12 when expecting type 3
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [helios91:23319] [[22303,0],0] ORTE_ERROR_LOG: Pack data mismatch in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; file ../../../src/ompi-trunk/orte/orted/pmix/pmix_server_sendrecv.c at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; line 722
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the program returns with exit code zero, but display an error message.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 2014/08/21 6:21, Ralph Castain wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;pmix.1.patch&gt;&lt;pmix.2.patch&gt;_______________________________________________
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15689.php">http://www.open-mpi.org/community/lists/devel/2014/08/15689.php</a>
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15692.php">http://www.open-mpi.org/community/lists/devel/2014/08/15692.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15697.php">http://www.open-mpi.org/community/lists/devel/2014/08/15697.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15700/attachment">attachment</a>
</ul>
