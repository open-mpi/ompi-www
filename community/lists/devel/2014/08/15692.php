...
?>
<!-- received="Fri Aug 22 12:06:15 2014" -->
<!-- isoreceived="20140822160615" -->
<!-- sent="Sat, 23 Aug 2014 01:06:07 +0900" -->
<!-- isosent="20140822160607" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] MPI_Abort does not make mpirun return with the right exit code" -->
<!-- id="7q91e9hrdjd2xy05ct1reifo.1408723567704_at_email.android.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="[OMPI devel] OMPI devel] MPI_Abort does not make mpirun return with the right exit code" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-22 12:06:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15693.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] MPI_Abort does not make mpirun return with the right exit code"</a>
<li><strong>Previous message:</strong> <a href="15691.php">Ralph Castain: "Re: [OMPI devel] MPI_Abort does not make mpirun return with the right exit code"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15693.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] MPI_Abort does not make mpirun return with the right exit code"</a>
<li><strong>Reply:</strong> <a href="15693.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] MPI_Abort does not make mpirun return with the right exit code"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Will do on Monday
<br>
<p>About the first test, in my case echo $? returns 0
<br>
...
<br>
<p>About the second test, please note my test program return 3;
<br>
...
<span class="quotelev1">&gt;07:35:41&#194;&#160; $ mpirun -n 1 -mca btl tcp,self -host bend002 ./abort
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;MPI_ABORT was invoked on rank 0 in communicator MPI_COMM_WORLD&#194;&#160;
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;07:35:56&#194;&#160; $ showcode
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;&#194;&#160;&#194;&#160;MPI_Init(&amp;argc, &amp;argv);
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;&#194;&#160;MPI_Finalize();
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;&#194;&#160;return 3;
</span><br>
<span class="quotelev1">&gt;}
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;07:37:27&#194;&#160; $ mpirun -n 1 ./mpi_no_op
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;07:37:36&#194;&#160; $ cat mpi_no_op.c
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;&#194;&#160;* The most basic of MPI applications
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160;*/
...
<span class="quotelev1">&gt;&#194;&#160; &#194;&#160; MPI_Init(&amp;argc, &amp;argv);
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; &#194;&#160; MPI_Finalize();
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; &#194;&#160; return 0;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;}
...
<span class="quotelev1">&gt;&#194;&#160;Process name: [[22080,1],0]
</span><br>
<span class="quotelev1">&gt;&#194;&#160;Exit code: &#194;&#160;&#194;&#160;&#194;&#160;3
</span><br>
<span class="quotelev1">&gt;--------------------------------------------------------------------------
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;int rank, size;
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;MPI_Init(&amp;argc, &amp;argv);
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;MPI_Comm_size(MPI_COMM_WORLD, &amp;size);
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;MPI_Comm_rank(MPI_COMM_WORLD, &amp;rank);
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;printf (&quot;I am %d/%d and i abort\n&quot;, rank, size);
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;MPI_Abort(MPI_COMM_WORLD, 2);
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;printf (&quot;%d/%d aborted !\n&quot;, rank, size);
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;return 3;
</span><br>
<span class="quotelev1">&gt;}
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;Exit code: &#194;&#160;&#194;&#160;&#194;&#160;2
</span><br>
<span class="quotelev1">&gt;--------------------------------------------------------------------------
</span><br>
<span class="quotelev1">&gt;node0 $ echo $?
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15692/attachment">attachment</a>
</ul>
