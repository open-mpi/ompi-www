<?
$subject_val = "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc4r32485 and gcc-4.9.0";
...
<!-- subject="Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc4r32485 and gcc-4.9.0" -->
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc4r32485 and gcc-4.9.0<br>
<strong>From:</strong> Kawashima, Takahiro (<em>t-kawashima_at_[hidden]</em>)<br>
<strong>Date:</strong> 2014-08-11 03:33:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15604.php">Matthias Jurenz: "Re: [OMPI devel] [vt] --with-openmpi-inside configure argument"</a>
<li><strong>Previous message:</strong> <a href="15602.php">Gilles Gouaillardet: "Re: [OMPI devel] errors and warnings with show_help() usage"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15605.php">Kawashima, Takahiro: "Re: [OMPI devel] bus error with openmpi-1.8.2rc4r32485 and gcc-4.9.0"</a>
<li><strong>Reply:</strong> <a href="15605.php">Kawashima, Takahiro: "Re: [OMPI devel] bus error with openmpi-1.8.2rc4r32485 and gcc-4.9.0"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
