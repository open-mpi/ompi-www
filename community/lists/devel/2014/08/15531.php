...
?>
<!-- received="Wed Aug  6 22:27:35 2014" -->
<!-- isoreceived="20140807022735" -->
<!-- sent="Wed, 6 Aug 2014 19:27:06 -0700" -->
<!-- isosent="20140807022706" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins" -->
<!-- id="3074BC01-6C86-4C69-B6C4-972B711D2F37_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="CAMJJpkVzAVif_Nf=WaHTEY1ZG4gTsLXkvoWXavjyitWC+mcgww_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-06 22:27:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15532.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Previous message:</strong> <a href="15530.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>In reply to:</strong> <a href="15530.php">George Bosilca: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15532.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Reply:</strong> <a href="15532.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Are we maybe approaching this from the wrong direction? I ask because we had to do some gyrations in the pmix framework to work around the difference in naming schemes between OPAL and the rest of the code base, and now we have more gyrations here.
<br>
<p>Given that the MPI and RTE layers both rely on the structured form of the name, what about if we just mimic that down in OPAL? I think we could perhaps do this in a way that still allows someone to overlay it with a 64-bit unstructured identifier if they want, but that would put the extra work on their side. In other words, we make it easy to work with the other parts of our own code base, acknowledging that those wanting to do something else may have to do some extra work.
<br>
<p>I ask because every resource manager out there assigns each process a jobid and vpid in some form of integer format. So we have to absorb that information in {jobid, vpid} format regardless of what we may want to do internally. What we now have to do is immediately convert that into the unstructured form for OPAL (where we take it in via PMI), then convert it back to structured form when passing it up to ORTE so it can be handed to OMPI, and then convert it back to unstructured form every time either OMPI or ORTE accesses the OPAL layer.
<br>
<p>Seems awfully convoluted and error prone. Simplifying things for ourselves might make more sense.
<br>
<p><p>On Aug 6, 2014, at 1:21 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Gilles,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; This looks right. It is really unfortunately that we have to change the definition of orte_process_name_t for big endian architectures, but I don't think there is a way around.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Regarding your patch I have two comments:
</span><br>
<span class="quotelev1">&gt; 1. There is a flagrant lack of comments ... especially on the ORTE side
</span><br>
<span class="quotelev1">&gt; 2. at the OPAL level we are really implementing a htonll, and I really think we should stick to the POSIX prototype (aka. returning the changes value instead of doing things inplace).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Wed, Aug 6, 2014 at 7:02 AM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; Ralph and George,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; here is attached a patch that fixes the heterogeneous support without the abstraction violation.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; hummm
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; i intentionally did not swap the two 32 bits (!)
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; from the top level, what we have is :
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;       uint64_t opal;
</span><br>
<span class="quotelev2">&gt;&gt;       struct {
</span><br>
<span class="quotelev2">&gt;&gt;            uint32_t jobid;
</span><br>
<span class="quotelev2">&gt;&gt;            uint32_t vpid;
</span><br>
<span class="quotelev2">&gt;&gt;        } orte;
</span><br>
<span class="quotelev2">&gt;&gt; } meta_process_name_t;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; OPAL is agnostic about jobid and vpid.
</span><br>
<span class="quotelev2">&gt;&gt; jobid and vpid are set in ORTE/MPI and OPAL is used only
</span><br>
<span class="quotelev2">&gt;&gt; to transport the 64 bits
</span><br>
<span class="quotelev2">&gt;&gt; /* opal_process_name_t and orte_process_name_t are often casted into each
</span><br>
<span class="quotelev2">&gt;&gt; other */
</span><br>
<span class="quotelev2">&gt;&gt; at ORTE/MPI level, jobid and vpid are set individually
</span><br>
<span class="quotelev2">&gt;&gt; /* e.g. we do *not* do something like opal = jobid | (vpid&lt;&lt;32) */
</span><br>
<span class="quotelev2">&gt;&gt; this is why everything works fine on homogeneous clusters regardless
</span><br>
<span class="quotelev2">&gt;&gt; endianness.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; now in heterogeneous cluster, thing get a bit trickier ...
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; i was initially unhappy with my commit and i think i found out why :
</span><br>
<span class="quotelev2">&gt;&gt; this is an abstraction violation !
</span><br>
<span class="quotelev2">&gt;&gt; the two 32 bits are not swapped by OPAL because this is what is expected by
</span><br>
<span class="quotelev2">&gt;&gt; the ORTE/OMPI.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; now i d like to suggest the following lightweight approach :
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; at OPAL, use #if protected htonll/ntohll
</span><br>
<span class="quotelev2">&gt;&gt; (e.g. swap the two 32bits)
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; do the trick at the ORTE level :
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; simply replace
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; so we keep OPAL agnostic about how the uint64_t is really used at the upper
</span><br>
<span class="quotelev2">&gt;&gt; level.
</span><br>
<span class="quotelev2">&gt;&gt; an other option is to make OPAL aware of jobid and vpid but this is a bit
</span><br>
<span class="quotelev2">&gt;&gt; more heavyweight imho.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; i'll try this today and make sure it works.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Wed, Aug 6, 2014 at 8:17 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ah yes, so it is - sorry I missed that last test :-/
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Aug 5, 2014, at 10:50 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The code committed by Gilles is correctly protected for big endian (
</span><br>
<span class="quotelev3">&gt;&gt;&gt; <a href="https://svn.open-mpi.org/trac/ompi/changeset/32425">https://svn.open-mpi.org/trac/ompi/changeset/32425</a>). I was merely
</span><br>
<span class="quotelev3">&gt;&gt;&gt; pointing out that I think he should also swap the 2 32 bits in his
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, Aug 5, 2014 at 1:32 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Aug 5, 2014, at 10:23 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Tue, Aug 5, 2014 at 1:15 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; This is similar to the 32 bits ntohl that we are using in other parts of
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the project. Any  little endian participant will do the conversion, while
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; every big endian participant will use an empty macro instead.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; As soon as we impose the ORTE naming scheme at the OPAL level (aka. the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; notion of jobid and vpid) this approach will become possible.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Not proposing that at all so long as the other method will work without
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; knowing the other side's endianness. Sounds like your approach should work
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; fine as long as Gilles adds a #if so big endian defines the macro away
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Jul 30, 2014, at 7:43 AM, Gilles GOUAILLARDET &lt;gilles.gouaillardet_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;  wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15520.php">http://www.open-mpi.org/community/lists/devel/2014/08/15520.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15521.php">http://www.open-mpi.org/community/lists/devel/2014/08/15521.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15523.php">http://www.open-mpi.org/community/lists/devel/2014/08/15523.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15526.php">http://www.open-mpi.org/community/lists/devel/2014/08/15526.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15527.php">http://www.open-mpi.org/community/lists/devel/2014/08/15527.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15529.php">http://www.open-mpi.org/community/lists/devel/2014/08/15529.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15530.php">http://www.open-mpi.org/community/lists/devel/2014/08/15530.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15531/attachment">attachment</a>
</ul>
