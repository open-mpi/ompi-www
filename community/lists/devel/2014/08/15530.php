...
?>
<!-- received="Wed Aug  6 16:21:21 2014" -->
<!-- isoreceived="20140806202121" -->
<!-- sent="Wed, 6 Aug 2014 16:21:18 -0400" -->
<!-- isosent="20140806202118" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins" -->
<!-- id="CAMJJpkVzAVif_Nf=WaHTEY1ZG4gTsLXkvoWXavjyitWC+mcgww_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="53E20B44.5010704_at_iferc.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-06 16:21:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15531.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Previous message:</strong> <a href="15529.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>In reply to:</strong> <a href="15529.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15531.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Reply:</strong> <a href="15531.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gilles,
<br>
<p>This looks right. It is really unfortunately that we have to change the
<br>
definition of orte_process_name_t for big endian architectures, but I don't
<br>
think there is a way around.
<br>
<p>Regarding your patch I have two comments:
<br>
...
<p>&nbsp;&nbsp;George.
<br>
<p><p><p>On Wed, Aug 6, 2014 at 7:02 AM, Gilles Gouaillardet &lt;
<br>
gilles.gouaillardet_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt;  Ralph and George,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; here is attached a patch that fixes the heterogeneous support without the
</span><br>
<span class="quotelev1">&gt; abstraction violation.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On 2014/08/06 9:40, Gilles Gouaillardet wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; hummm
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; i intentionally did not swap the two 32 bits (!)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; from the top level, what we have is :
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;       uint64_t opal;
</span><br>
<span class="quotelev1">&gt;       struct {
</span><br>
<span class="quotelev1">&gt;            uint32_t jobid;
</span><br>
<span class="quotelev1">&gt;            uint32_t vpid;
</span><br>
<span class="quotelev1">&gt;        } orte;
</span><br>
<span class="quotelev1">&gt; } meta_process_name_t;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; OPAL is agnostic about jobid and vpid.
</span><br>
<span class="quotelev1">&gt; jobid and vpid are set in ORTE/MPI and OPAL is used only
</span><br>
<span class="quotelev1">&gt; to transport the 64 bits
</span><br>
<span class="quotelev1">&gt; /* opal_process_name_t and orte_process_name_t are often casted into each
</span><br>
<span class="quotelev1">&gt; other */
</span><br>
<span class="quotelev1">&gt; at ORTE/MPI level, jobid and vpid are set individually
</span><br>
<span class="quotelev1">&gt; /* e.g. we do *not* do something like opal = jobid | (vpid&lt;&lt;32) */
</span><br>
<span class="quotelev1">&gt; this is why everything works fine on homogeneous clusters regardless
</span><br>
<span class="quotelev1">&gt; endianness.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; now in heterogeneous cluster, thing get a bit trickier ...
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; i was initially unhappy with my commit and i think i found out why :
</span><br>
<span class="quotelev1">&gt; this is an abstraction violation !
</span><br>
<span class="quotelev1">&gt; the two 32 bits are not swapped by OPAL because this is what is expected by
</span><br>
<span class="quotelev1">&gt; the ORTE/OMPI.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; now i d like to suggest the following lightweight approach :
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; at OPAL, use #if protected htonll/ntohll
</span><br>
<span class="quotelev1">&gt; (e.g. swap the two 32bits)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; do the trick at the ORTE level :
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; simply replace
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; so we keep OPAL agnostic about how the uint64_t is really used at the upper
</span><br>
<span class="quotelev1">&gt; level.
</span><br>
<span class="quotelev1">&gt; an other option is to make OPAL aware of jobid and vpid but this is a bit
</span><br>
<span class="quotelev1">&gt; more heavyweight imho.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; i'll try this today and make sure it works.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Wed, Aug 6, 2014 at 8:17 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  Ah yes, so it is - sorry I missed that last test :-/
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Aug 5, 2014, at 10:50 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; The code committed by Gilles is correctly protected for big endian (<a href="https://svn.open-mpi.org/trac/ompi/changeset/32425">https://svn.open-mpi.org/trac/ompi/changeset/32425</a>). I was merely
</span><br>
...
<span class="quotelev1">&gt; On Tue, Aug 5, 2014 at 1:32 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  On Aug 5, 2014, at 10:23 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Tue, Aug 5, 2014 at 1:15 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  Hmmm...wouldn't that then require that you know (a) the other side is
</span><br>
...
<span class="quotelev1">&gt;  In the ORTE methods, we explicitly set the fields (e.g., jobid =
</span><br>
...
<span class="quotelev1">&gt; On Aug 5, 2014, at 10:06 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Technically speaking, converting a 64 bits to a big endian
</span><br>
<span class="quotelev1">&gt; representation requires the swap of the 2 32 bits parts. So the correct
</span><br>
<span class="quotelev1">&gt; approach would have been:
</span><br>
...
<span class="quotelev1">&gt; On Tue, Aug 5, 2014 at 5:52 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  FWIW: that's exactly how we do it in ORTE
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Aug 4, 2014, at 10:25 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]
</span><br>
...
<span class="quotelev1">&gt; On Aug 1, 2014, at 06:52 , Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; &lt;gilles.gouaillardet_at_[hidden]&gt; &lt;gilles.gouaillardet_at_[hidden]&gt; &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; On Wed, Jul 30, 2014 at 12:19 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; On Jul 30, 2014, at 9:17 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; &lt;bosilca_at_[hidden]&gt; &lt;bosilca_at_[hidden]&gt; &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Wed, Jul 30, 2014 at 12:09 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; On Jul 30, 2014, at 9:06 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; &lt;bosilca_at_[hidden]&gt; &lt;bosilca_at_[hidden]&gt; &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Wed, Jul 30, 2014 at 11:50 AM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; On Wed, Jul 30, 2014 at 11:49 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt; &lt;rhc_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Jul 30, 2014, at 7:43 AM, Gilles GOUAILLARDET &lt;gilles.gouaillardet_at_[hidden]&gt; &lt;gilles.gouaillardet_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt;  wrote:
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Rolf vandeVaart &lt;rvandevaart_at_[hidden]&gt; &lt;rvandevaart_at_[hidden]&gt; &lt;rvandevaart_at_[hidden]&gt; &lt;rvandevaart_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; From: devel [mailto:devel-bounces_at_[hidden] &lt;devel-bounces_at_[hidden]&gt; &lt;devel-bounces_at_[hidden]&gt; &lt;devel-bounces_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; &lt;devel-bounces_at_[hidden]&gt; &lt;devel-bounces_at_[hidden]&gt; &lt;devel-bounces_at_[hidden]&gt; &lt;devel-bounces_at_[hidden]&gt;] On Behalf Of Gilles
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post:<a href="http://www.open-mpi.org/community/lists/devel/2014/08/15514.php">http://www.open-mpi.org/community/lists/devel/2014/08/15514.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  _______________________________________________
...
<span class="quotelev1">&gt; Link to this post:<a href="http://www.open-mpi.org/community/lists/devel/2014/08/15518.php">http://www.open-mpi.org/community/lists/devel/2014/08/15518.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post:<a href="http://www.open-mpi.org/community/lists/devel/2014/08/15519.php">http://www.open-mpi.org/community/lists/devel/2014/08/15519.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  _______________________________________________
...
<span class="quotelev1">&gt; Link to this post:<a href="http://www.open-mpi.org/community/lists/devel/2014/08/15520.php">http://www.open-mpi.org/community/lists/devel/2014/08/15520.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post:<a href="http://www.open-mpi.org/community/lists/devel/2014/08/15526.php">http://www.open-mpi.org/community/lists/devel/2014/08/15526.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15527.php">http://www.open-mpi.org/community/lists/devel/2014/08/15527.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15529.php">http://www.open-mpi.org/community/lists/devel/2014/08/15529.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15530/attachment">attachment</a>
</ul>
