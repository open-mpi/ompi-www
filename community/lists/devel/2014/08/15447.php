...
?>
<!-- received="Fri Aug  1 07:00:09 2014" -->
<!-- isoreceived="20140801110009" -->
<!-- sent="Fri, 01 Aug 2014 20:00:09 +0900" -->
<!-- isosent="20140801110009" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins" -->
<!-- id="53DB7339.3020807_at_iferc.org" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="53DB7172.6020708_at_iferc.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-01 07:00:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15448.php">Ralph Castain: "Re: [OMPI devel] [1.8.2rc3] Build failure on FreeBSD (missing header)"</a>
<li><strong>Previous message:</strong> <a href="15446.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>In reply to:</strong> <a href="15446.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15450.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Reply:</strong> <a href="15450.php">Ralph Castain: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
one last point :
<br>
<p>in orte_process_name_t, jobid and vpid have type orte_jobid_t and
<br>
orte_vpid_t which really is uint32_t.
<br>
<p>in orte/util/proc.c, the function pointers opal_process_name_vpid and
<br>
opal_process_name_jobid
<br>
return an int32_t
<br>
<p>should it be an uint32_t instead ?
<br>
...
<p>Gilles
<br>
<p>On 2014/08/01 19:52, Gilles Gouaillardet wrote:
<br>
...
<span class="quotelev1">&gt; anyway, today Paul and i ran basic tests on big endian machines and did
</span><br>
<span class="quotelev1">&gt; not face any issue related to big endianness.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; so i made my homework, digged into the code, and basically,
</span><br>
<span class="quotelev1">&gt; opal_process_name_t is used as an orte_process_name_t.
</span><br>
<span class="quotelev1">&gt; for example, in ompi_proc_init :
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; OMPI_CAST_ORTE_NAME(&amp;proc-&gt;super.proc_name)-&gt;jobid =
</span><br>
<span class="quotelev1">&gt; OMPI_PROC_MY_NAME-&gt;jobid;
</span><br>
...
<span class="quotelev1">&gt; so as long as an opal_process_name_t is used as an orte_process_name_t,
</span><br>
<span class="quotelev1">&gt; there is no problem,
</span><br>
...
<span class="quotelev1">&gt;     if(mca_btl_tcp_endpoint_send_blocking(btl_endpoint, &amp;guid,
</span><br>
<span class="quotelev1">&gt; sizeof(guid)) !=
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; and with
...
<span class="quotelev1">&gt; - for this case, the fix is to have a different version of the
</span><br>
<span class="quotelev1">&gt; OPAL_PROCESS_NAME_xTOy
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15447/attachment">attachment</a>
</ul>
