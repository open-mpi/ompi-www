...
?>
<!-- received="Fri Aug  1 11:14:39 2014" -->
<!-- isoreceived="20140801151439" -->
<!-- sent="Fri, 1 Aug 2014 11:14:35 -0400" -->
<!-- isosent="20140801151435" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins" -->
<!-- id="3FE5F0A2-B802-4322-AB01-D066542678EC_at_icl.utk.edu" -->
...
<strong>Date:</strong> 2014-08-01 11:14:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15455.php">Pritchard Jr., Howard: "Re: [OMPI devel] openmpi-1.8.2rc2 and f08 interface built with PGI-14.7	causes link error"</a>
<li><strong>Previous message:</strong> <a href="15453.php">Ralph Castain: "Re: [OMPI devel] Further questions about BTL OPAL move..."</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15509.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<li><strong>Reply:</strong> <a href="15509.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] trunk compilation errors in jenkins"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gilles,
<br>
<p>The design of the BTL move was to let the opal_process_name_t be agnostic to what is stored inside, and all accesses should be done through the provided accessors. Thus, big endian or little endian doesn&#146;t make a difference, as long as everything goes through the accessors.
<br>
<p>I&#146;m skeptical about the support of heterogeneous environments in the current code, so I didn&#146;t pay much attention to handling the case in the TCP BTL. But in case we do care it is enough to make  the 2 macros point to something meaningful instead of being empty (bswap_64 or something).
<br>
<p>&nbsp;&nbsp;George.
<br>
<p>On Aug 1, 2014, at 06:52 , Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; George and Ralph,
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15454/attachment">attachment</a>
</ul>
