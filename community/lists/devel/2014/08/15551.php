...
?>
<!-- received="Fri Aug  8 05:21:41 2014" -->
<!-- isoreceived="20140808092141" -->
<!-- sent="Fri, 8 Aug 2014 02:21:07 -0700" -->
<!-- isosent="20140808092107" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc" -->
<!-- id="98659F56-2D3D-46B5-92E5-DCC67C5E7DA4_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="53E4724D.5040409_at_iferc.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-08 05:21:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15552.php">Gilles Gouaillardet: "[OMPI devel] ibm abort test hangs on one node"</a>
<li><strong>Previous message:</strong> <a href="15550.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>In reply to:</strong> <a href="15550.php">Gilles Gouaillardet: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15559.php">Ralph Castain: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Reply:</strong> <a href="15559.php">Ralph Castain: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Reply:</strong> <a href="15564.php">George Bosilca: "Re: [OMPI devel] [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>The easiest solution is probably to change the opal/db/hash code so that 64-bit fields are memcpy'd instead of simply passed by &quot;=&quot;. This should eliminate the problem with the least fuss.
<br>
<p>There is a performance penalty for using non-aligned data, and ideally we should use aligned data whenever possible. This code isn't in the critical path and so this is less of an issue, but still would be nice to do. However, I didn't do so for the following reasons:
<br>
<p>* I couldn't find a way for the compiler to check/require alignment down in opal_db.store when passed a parameter. If someone knows of a way to do that, please feel free to suggest it
<br>
<p>* none of our current developers have access to a Solaris SPARC machine, and thus our developers cannot detect violations when they occur
<br>
<p>* the current solution avoids the issue, albeit with a slight performance penalty
<br>
<p>I'm open to alternative methods - I'm not happy with the ugliness this required, but couldn't come up with a cleaner solution that would be easy for developers to know when they violated the alignment requirement.
<br>
<p>FWIW: it is possible, I suppose, that the other discussion about using an opal_process_name_t that exactly mirrors orte_process_name_t could also resolve this problem in a cleaner fashion. I didn't impose that requirement here, but maybe it's another motivator for doing so?
<br>
<p>Ralph
<br>
<p><p>On Aug 7, 2014, at 11:46 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt;                    if (ORTE_SUCCESS != (rc = opal_db.store((opal_identifier_t*)ORTE_PROC_MY_NAME, OPAL_SCOPE_INTERNAL,
</span><br>
...
<span class="quotelev1">&gt; as you pointed, replacing OPAL_ID_T with ORTE_NAME will very likely fix the issue (i have no arch to test...)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt;         if (ORTE_SUCCESS != (rc = opal_db.store((opal_identifier_t*)&amp;proc, OPAL_SCOPE_INTERNAL,
</span><br>
<span class="quotelev1">&gt;                                                 ORTE_DB_NPROC_OFFSET, &amp;offset, OPAL_UINT32))) {
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; the first argument of store is an (opal_identifier_t *)
</span><br>
<span class="quotelev1">&gt; strictly speaking this is &quot;a pointer to a 64 bits aligned address&quot;, and proc might not be 64 bits aligned.
</span><br>
<span class="quotelev1">&gt; /* that being said, there is no crash :-) */
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; in this case, opal_db.store pointer points to the store function (db_hash.c:178)
</span><br>
<span class="quotelev1">&gt; and proc is only used id memcpy at line 194, so 64 bits alignment is not required.
</span><br>
...
<span class="quotelev1">&gt; (e.g. cast to (opal_identifier_t *), followed by a memcpy  in case the pointer was not 64 bits aligned
</span><br>
...
<span class="quotelev2">&gt;&gt; This is a gigantic patch for an almost trivial issue. The current problem
</span><br>
<span class="quotelev2">&gt;&gt; is purely related to the fact that in a single location (nidmap.c) the
</span><br>
<span class="quotelev2">&gt;&gt; orte_process_name_t (which is a structure of 2 integers) is supposed to be
</span><br>
<span class="quotelev2">&gt;&gt; aligned based on the uint64_t requirements. Bad assumption!
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Looking at the code one might notice that the orte_process_name_t is stored
</span><br>
<span class="quotelev2">&gt;&gt; using a particular DSS type OPAL_ID_T. This is a shortcut that doesn't hold
</span><br>
<span class="quotelev2">&gt;&gt; on the SPARC architecture because the two types (int32_t and int64_t) have
</span><br>
<span class="quotelev2">&gt;&gt; different alignments.  However, ORTE define a type for orte_process_name_t.
</span><br>
<span class="quotelev2">&gt;&gt; Thus, I think that if instead of saving the orte_process_name_t as an
</span><br>
<span class="quotelev2">&gt;&gt; OPAL_ID_T, we save it as an ORTE_NAME the issue will go away.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Fri, Aug 8, 2014 at 1:04 AM, Gilles Gouaillardet &lt;
</span><br>
<span class="quotelev2">&gt;&gt; gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Kawashima-san and all,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Here is attached a one off patch for v1.8.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /* it does not use the __attribute__ modifier that might not be
</span><br>
<span class="quotelev3">&gt;&gt;&gt; supported by all compilers */
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; as far as i am concerned, the same issue is also in the trunk,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and if you do not hit it, it just means you are lucky :-)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the same issue might also be in other parts of the code :-(
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 2014/08/08 13:45, Kawashima, Takahiro wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Gilles, George,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The problem is the one Gilles pointed.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I temporarily modified the code bellow and the bus error disappeared.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --- orte/util/nidmap.c  (revision 32447)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; +++ orte/util/nidmap.c  (working copy)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; @@ -885,7 +885,7 @@
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      orte_proc_state_t state;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      orte_app_idx_t app_idx;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      int32_t restarts;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -    orte_process_name_t proc, dmn;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; +    orte_process_name_t proc __attribute__((__aligned__(8))), dmn;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      char *hostname;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      uint8_t flag;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      opal_buffer_t *bptr;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; this is loosely related to
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I've finally reproduced the bus error in my SPARC environment.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #0 0xffffffff00db4740 (__waitpid_nocancel + 0x44)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (0x200,0x0,0x0,0xa0,0xfffff80100064af0,0x35b4)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #1 0xffffffff0001a310 (handle_signal + 0x574) (signo=10,info=(struct
</span><br>
<span class="quotelev3">&gt;&gt;&gt; siginfo *) 0x000007feffffd100,p=(void *) 0x000007feffffd100) at line 277 in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../sigattach.c &lt;SIGNAL HANDLER&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #2 0xffffffff0282aff4 (store + 0x540) (uid=(unsigned long *)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0xffffffff0118a128,scope=8:'\b',key=(char *) 0xffffffff0106a0a8
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;opal.local.ldr&quot;,data=(void *) 0x000007feffffde74,type=15:'\017') at line
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 252 in db_hash.c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #3 0xffffffff01266350 (opal_db_base_store + 0xc4) (proc=(unsigned long
</span><br>
<span class="quotelev3">&gt;&gt;&gt; *) 0xffffffff0118a128,scope=8:'\b',key=(char *) 0xffffffff0106a0a8
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;opal.local.ldr&quot;,object=(void *) 0x000007feffffde74,type=15:'\017') at line
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 49 in db_base_fns.c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #4 0xffffffff00fdbab4 (orte_util_decode_pidmap + 0x790) (bo=(struct *)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0x0000000000281d70) at line 975 in nidmap.c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #5 0xffffffff00fd6d20 (orte_util_nidmap_init + 0x3dc) (buffer=(struct
</span><br>
<span class="quotelev3">&gt;&gt;&gt; opal_buffer_t *) 0x0000000000241fc0) at line 141 in nidmap.c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #6 0xffffffff01e298cc (rte_init + 0x2a0) () at line 153 in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ess_env_module.c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #7 0xffffffff00f9f28c (orte_init + 0x308) (pargc=(int *)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0x0000000000000000,pargv=(char ***) 0x0000000000000000,flags=32) at line
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 148 in orte_init.c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #8 0xffffffff001a6f08 (ompi_mpi_init + 0x31c) (argc=1,argv=(char **)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0x000007fefffff348,requested=0,provided=(int *) 0x000007feffffe698) at line
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 464 in ompi_mpi_init.c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #9 0xffffffff001ff79c (MPI_Init + 0x2b0) (argc=(int *)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0x000007feffffe814,argv=(char ***) 0x000007feffffe818) at line 84 in init.c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #10 0x0000000000100ae4 (main + 0x44) (argc=1,argv=(char **)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0x000007fefffff348) at line 8 in mpiinitfinalize.c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #11 0xffffffff00d2b81c (__libc_start_main + 0x194)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (0x100aa0,0x1,0x7fefffff348,0x100d24,0x100d14,0x0)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #12 0x000000000010094c (_start + 0x2c) ()
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; The line 252 in opal/mca/db/hash/db_hash.c is:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;     case OPAL_UINT64:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         if (NULL == data) {
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             OPAL_ERROR_LOG(OPAL_ERR_BAD_PARAM);
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             return OPAL_ERR_BAD_PARAM;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         }
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         kv-&gt;type = OPAL_UINT64;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         kv-&gt;data.uint64 = *(uint64_t*)(data); // !!! here !!!
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         break;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; My environment is:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;   Open MPI v1.8 branch r32447 (latest)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;   configure --enable-debug
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;   SPARC-V9 (Fujitsu SPARC64 IXfx)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;   Linux (custom)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;   gcc 4.2.4
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I could not reproduce it with Open MPI trunk nor with Fujitsu compiler.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Can this information help?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'm sorry once more to answer late, but the last two days our mail
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; server was down (hardware error).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Did you configure this --enable-debug?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Yes, I used the following command.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; ../openmpi-1.8.2rc3/configure
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --prefix=/usr/local/openmpi-1.8.2_64_gcc \
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;   --libdir=/usr/local/openmpi-1.8.2_64_gcc/lib64 \
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;   LDFLAGS=&quot;-m64 -L/usr/local/gcc-4.9.0/lib/amd64&quot; \
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; If so, you should get a line number in the backtrace
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I got them for gdb (see below), but not for &quot;dbx&quot;.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Aug 5, 2014, at 2:59 AM, Siegmar Gross
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /usr/local/openmpi-1.8.2_64_gcc/bin/mpiexec
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; in your
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; .dbxrc
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; _PROCEDURE_LINKAGE_TABLE_+0x2380 [PLT] ! 0xffffffff55342a80
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff79f00300), at 0xffffffff55174da0
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [2] list_files_by_dir(0x100138fd8, 0xffffffff7fffd1f0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0xffffffff7fffd1e8,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff7fffd210, 0x0, 0xffffffff702a0010), at
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff63174594
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [3] foreachfile_callback(0x100138fd8, 0xffffffff7fffd458, 0x0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0x2e, 0x0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff702a0010), at 0xffffffff6317461c
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [4] foreach_dirinpath(0x1001d8a28, 0x0, 0xffffffff631745e0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff7fffd458, 0x0, 0xffffffff702a0010), at 0xffffffff63171684
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [5] lt_dlforeachfile(0x1001d8a28, 0xffffffff6319656c, 0x0, 0x53,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0x2f,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xf), at 0xffffffff63174748
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [6] find_dyn_components(0x0, 0xffffffff6323b570, 0x0, 0x1,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff7fffd6a0, 0xffffffff702a0010), at 0xffffffff63195e38
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [7] mca_base_component_find(0x0, 0xffffffff6323b570,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0xffffffff6335e1b0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0x0, 0xffffffff7fffd6a0, 0x1), at 0xffffffff631954d8
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [8] mca_base_framework_components_register(0xffffffff6335e1c0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0x0, 0x3e,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0x0, 0x3b, 0x100800), at 0xffffffff631b1638
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [9] mca_base_framework_register(0xffffffff6335e1c0, 0x0, 0x2,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff7fffd8d0, 0x0, 0xffffffff702a0010), at 0xffffffff631b24d4
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [10] mca_base_framework_open(0xffffffff6335e1c0, 0x0, 0x2,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff7fffd990, 0x0, 0xffffffff702a0010), at 0xffffffff631b25d0
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [11] opal_init(0xffffffff7fffdd70, 0xffffffff7fffdd78, 0x100117c60,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff7fffde58, 0x400, 0x100117c60), at
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff63153694
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [12] orterun(0x4, 0xffffffff7fffde58, 0x2, 0xffffffff7fffdda0, 0x0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0xffffffff702a0010), at 0x100005078
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [13] main(0x4, 0xffffffff7fffde58, 0xffffffff7fffde80, 0x100117c60,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0x100000000, 0xffffffff6a700200), at 0x100003d68
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/bin/orterun...done.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/libopen-pal.so.6.2.0:opal_b
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; acktrace_print+0x2c
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/libopen-pal.so.6.2.0:0xccfa
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/openmpi/mca_db_hash.so:0x3e
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; e8 [ Signal 10 (BUS)]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/libopen-pal.so.6.2.0:opal_d
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; b_base_store+0xc8
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/libopen-rte.so.7.0.4:orte_u
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; til_decode_pidmap+0x798
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/libopen-rte.so.7.0.4:orte_u
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; til_nidmap_init+0x3cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/openmpi/mca_ess_env.so:0x22
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 6c
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/libopen-rte.so.7.0.4:orte_i
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; nit+0x308
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/libmpi.so.1.5.2:ompi_mpi_in
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; it+0x31c
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/libmpi.so.1.5.2:PMPI_Init+0
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; x2a8
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; found to
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; satisfy query
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; (gdb) bt
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; #0  0xffffffff7f6173d0 in rtld_db_dlactivity () from
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /usr/lib/sparcv9/ld.so.1
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ../../../../openmpi-1.8.2rc3/opal/mca/base/mca_base_component_repository.c:391
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; #11 0xffffffff7ec98488 in opal_obj_run_destructors
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (object=0x1001ead30)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ../../../../openmpi-1.8.2rc3/opal/mca/base/mca_base_component_repository.c:244
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; #13 0xffffffff7ec9b734 in mca_base_component_unload (
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    component=0xffffffff7b023cf0 &lt;mca_oob_tcp_component&gt;,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; output_id=-1)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../../../openmpi-1.8.2rc3/opal/mca/base/mca_base_components_close.c:47
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ../../../../openmpi-1.8.2rc3/opal/mca/base/mca_base_components_close.c:60
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; skip=0x0)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ---Type &lt;return&gt; to continue, or q &lt;return&gt; to quit---
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../../../openmpi-1.8.2rc3/opal/mca/base/mca_base_components_close.c:86
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ../../../../openmpi-1.8.2rc3/opal/mca/base/mca_base_components_close.c:66
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; #17 0xffffffff7efae1e4 in orte_oob_base_close ()
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../../../openmpi-1.8.2rc3/orte/mca/oob/base/oob_base_frame.c:94
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ../../../../openmpi-1.8.2rc3/opal/mca/base/mca_base_framework.c:187
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; #19 0xffffffff7bf078c0 in rte_finalize ()
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../../../../openmpi-1.8.2rc3/orte/mca/ess/hnp/ess_hnp_module.c:858
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Jul 25, 2014, at 2:08 AM, Siegmar Gross
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; &lt;Siegmar.Gross_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Hi,
...
<span class="quotelev3">&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.8.2_64_gcc/lib64/libopen-pal.so.6.2.0:0xccfd
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 0
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15546.php">http://www.open-mpi.org/community/lists/devel/2014/08/15546.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15547.php">http://www.open-mpi.org/community/lists/devel/2014/08/15547.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15549.php">http://www.open-mpi.org/community/lists/devel/2014/08/15549.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15550.php">http://www.open-mpi.org/community/lists/devel/2014/08/15550.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-15551/attachment">attachment</a>
</ul>
