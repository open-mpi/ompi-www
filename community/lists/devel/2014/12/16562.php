...
?>
<!-- received="Fri Dec 12 18:10:35 2014" -->
<!-- isoreceived="20141212231035" -->
<!-- sent="Sat, 13 Dec 2014 08:10:24 +0900" -->
<!-- isosent="20141212231024" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] [1.8.4rc2] orterun SEGVs on Solaris-10/SPARC" -->
<!-- id="0lrge8y4682pil26xu2dd8dy.1418425656968_at_email.android.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="[OMPI devel] OMPI devel] [1.8.4rc2] orterun SEGVs on Solaris-10/SPARC" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-12 18:10:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16563.php">Paul Hargrove: "Re: [OMPI devel] OMPI devel] [1.8.4rc2] orterun SEGVs on Solaris-10/SPARC"</a>
<li><strong>Previous message:</strong> <a href="16561.php">Ralph Castain: "Re: [OMPI devel] [1.8.4rc3] REGRESSION: connection problem on (multi-homed) Solaris host"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16563.php">Paul Hargrove: "Re: [OMPI devel] OMPI devel] [1.8.4rc2] orterun SEGVs on Solaris-10/SPARC"</a>
<li><strong>Reply:</strong> <a href="16563.php">Paul Hargrove: "Re: [OMPI devel] OMPI devel] [1.8.4rc2] orterun SEGVs on Solaris-10/SPARC"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>I cannot find a case for the %u format is guess_strlen
<br>
...
<br>
<span class="quotelev1">&gt;Afraid I&#226;&#128;&#153;m drawing a blank, Paul - I can&#226;&#128;&#153;t see how we got to a bad address down there. This is at the beginning of orte_init, so there are no threads running nor has anything much happened.
</span><br>
...
<span class="quotelev1">&gt;&#194;&#160;2134 &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160;nnuma, nsocket, nl3, nl2, nl1, ncore, nhwt, arch);
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;&#194;&#160; 194 &#194;&#160; &#194;&#160; &#194;&#160; length = opal_vasprintf(ptr, fmt, ap);
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;&#194;&#160; &#194;&#160;71 &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; len += (int)strlen(sarg);
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;Hmmm&#226;&#128;&#166;.this is really odd. I actually do have a protection for that arch value being NULL, and you are in the code section when it isn&#226;&#128;&#153;t.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;Do you still have the core file around? If so, can you print out the value of the &#226;&#128;&#156;arch&#226;&#128;&#157; variable? It would be in the opal_hwloc_base_get_topo_signature level.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;I&#226;&#128;&#153;m wondering if that value has been hosed, and the problem is memory corruption somewhere.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;Thanks Paul - I will post a fix for this tomorrow. Looks like Sparc isn&#226;&#128;&#153;t returning an architecture type for some reason, and I didn&#226;&#128;&#153;t protect against it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;0xffffffff7d93b634: strlen+0x0014: &#194;&#160; &#194;&#160; &#194;&#160;lduh &#194;&#160; &#194;&#160; [%o2], %o1
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;Current function is guess_strlen
...
<span class="quotelev1">&gt;&#194;&#160; [1] strlen(0x2, 0x73000000, 0x2, 0x80808080, 0x2, 0x80808080), at 0xffffffff7d93b634&#194;&#160;
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;&#194;&#160; [3] opal_vasprintf(ptr = 0xffffffff7ffff0b8, fmt = 0xffffffff7eeada98 &quot;%uN:%uS:%uL3:%uL2:%uL1:%uC:%uH:%s&quot;, ap = 0xffffffff7ffff050), line 218 in &quot;printf.c&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; [4] opal_asprintf(ptr = 0xffffffff7ffff0b8, fmt = 0xffffffff7eeada98 &quot;%uN:%uS:%uL3:%uL2:%uL1:%uC:%uH:%s&quot;, ... = 0x807ede0103, ...), line 194 in &quot;printf.c&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; [5] opal_hwloc_base_get_topo_signature(topo = 0x100128ea0), line 2134 in &quot;hwloc_base_util.c&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; [6] rte_init(), line 205 in &quot;ess_hnp_module.c&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; [7] orte_init(pargc = 0xffffffff7ffff61c, pargv = 0xffffffff7ffff610, flags = 4U), line 148 in &quot;orte_init.c&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; [8] orterun(argc = 7, argv = 0xffffffff7ffff7a8), line 856 in &quot;orterun.c&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; [9] main(argc = 7, argv = 0xffffffff7ffff7a8), line 13 in &quot;main.c&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;No, that looks different - it&#226;&#128;&#153;s failing in mpirun itself. Can you get a line number on it?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;Sorry for delay - I&#226;&#128;&#153;m generating rc3 now
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;Ah crud - incomplete commit means we didn&#226;&#128;&#153;t send the topo string. Will roll rc3 in a few minutes.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;bash: line 1: 18762 Segmentation Fault &#194;&#160; &#194;&#160; &#194;&#160;(core dumped) /shared/OMPI/openmpi-1.8.4rc2-solaris11-x64-ib-gcc452/INST/bin/orted -mca ess &quot;env&quot; -mca orte_ess_jobid &quot;911343616&quot; -mca orte_ess_vpid 1 -mca orte_ess_num_procs &quot;2&quot; -mca orte_hnp_uri &quot;911343616.0;tcp://172.16.0.120,172.18.0.120:50362&quot; --tree-spawn -mca btl &quot;sm,self,openib&quot; -mca plm &quot;rsh&quot; -mca shmem_mmap_enable_nfs_warning &quot;0&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;#0 &#194;&#160;0xfea1cb45 in strcmp () from /lib/libc.so.1
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;#1 &#194;&#160;0xfeef4900 in orte_daemon (argc=26, argv=0x80479b0)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; &#194;&#160; at /shared/OMPI/openmpi-1.8.4rc2-solaris11-x86-ib-gcc452/openmpi-1.8.4rc2/orte/orted/orted_main.c:789
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;#2 &#194;&#160;0x08050fb1 in main (argc=26, argv=0x80479b0)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; &#194;&#160; at /shared/OMPI/openmpi-1.8.4rc2-solaris11-x86-ib-gcc452/openmpi-1.8.4rc2/orte/tools/orted/orted.c:62
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/12/16515.php">http://www.open-mpi.org/community/lists/devel/2014/12/16515.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/12/16522.php">http://www.open-mpi.org/community/lists/devel/2014/12/16522.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/12/16541.php">http://www.open-mpi.org/community/lists/devel/2014/12/16541.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16562/attachment">attachment</a>
</ul>
