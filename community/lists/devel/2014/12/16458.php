...
?>
<!-- received="Tue Dec  9 03:25:13 2014" -->
<!-- isoreceived="20141209082513" -->
<!-- sent="Tue, 9 Dec 2014 09:25:08 +0100" -->
<!-- isosent="20141209082508" -->
<!-- name="Pim Schellart" -->
...
<!-- id="F4B0C7AB-696D-4FDC-8BE7-939D7947A91D_at_gmail.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="8B95375F-0F36-46EE-A76E-062DAF3B9BCE_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-09 03:25:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16459.php">Pascal Deveze: "[OMPI devel] Patch proposed: opal_set_using_threads(true) in ompi/runtime/ompi_mpi_init.c is called to late"</a>
<li><strong>Previous message:</strong> <a href="16457.php">Ralph Castain: "Re: [OMPI devel] autogen broken"</a>
<li><strong>In reply to:</strong> <a href="16453.php">Ralph Castain: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16460.php">Ralph Castain: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<li><strong>Reply:</strong> <a href="16460.php">Ralph Castain: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
The version that &#226;&#128;&#156;lstopo --version&#226;&#128;&#157; reports is the same (1.8) on all nodes, but we may indeed be hitting the second issue. We can try to compile a new version of openmpi, but how do we ensure that the external programs (e.g. SLURM) are using the same hwloc version as the one embedded in openmpi? Is it enough to just compile hwloc 1.9 separately as well and link against that? Also, if this is an issue, should we file a bug against hwloc or openmpi on Ubuntu for mismatching versions?
<br>
<p><span class="quotelev1">&gt; On 09 Dec 2014, at 00:50, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
