...
?>
<!-- received="Tue Dec  9 03:38:26 2014" -->
<!-- isoreceived="20141209083826" -->
<!-- sent="Tue, 09 Dec 2014 17:38:36 +0900" -->
<!-- isosent="20141209083836" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6" -->
<!-- id="5486B50C.6010506_at_iferc.org" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="ABE1CE77-0A65-4EE7-9BF2-39B2598CE9E1_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-09 03:38:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16466.php">Piotr Lesnicki: "Re: [OMPI devel] openmpi and XRC API from ofed-3.12"</a>
<li><strong>Previous message:</strong> <a href="16464.php">Pim Schellart: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<li><strong>In reply to:</strong> <a href="16464.php">Pim Schellart: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16492.php">Pim Schellart: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<li><strong>Reply:</strong> <a href="16492.php">Pim Schellart: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Pim,
<br>
<p>if you configure OpenMPI with --with-hwloc=external (or something like
<br>
...
is used by SLURM
<br>
<p>/* i do not know how Ubuntu packages OpenMPI ... */
<br>
<p><p>The default (e.g. no --with-hwloc parameter in the configure command
<br>
line) is to use the hwloc library that is embedded within OpenMPI
<br>
<p>Gilles
<br>
<p>On 2014/12/09 17:34, Pim Schellart wrote:
<br>
