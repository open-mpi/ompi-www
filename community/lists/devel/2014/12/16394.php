...
?>
<!-- received="Tue Dec  2 01:10:34 2014" -->
<!-- isoreceived="20141202061034" -->
<!-- sent="Tue, 02 Dec 2014 15:10:38 +0900" -->
<!-- isosent="20141202061038" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RTLD_GLOBAL question" -->
<!-- id="547D57DE.4070509_at_iferc.org" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2014-12-02 01:10:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16395.php">Ralph Castain: "Re: [OMPI devel] RTLD_GLOBAL question"</a>
<li><strong>Previous message:</strong> <a href="16393.php">Artem Polyakov: "Re: [OMPI devel] RTLD_GLOBAL question"</a>
...
<p>no problem :
<br>
<p>I just tried slurm-14-11-11-1 and *both* pmi1 and pmi2 fail with the
<br>
same error message :
<br>
<p>symbol lookup error: /opt/slurm-14-11.11.1/lib/slurm/auth_munge.so:
<br>
undefined symbol: slurm_debug
<br>
<p>on the bright side, auth_munge.so has no slurm_auth_get_arg_desc
<br>
undefined symbol.
<br>
...
<p>Gilles
<br>
<p>On 2014/12/02 13:15, Ralph Castain wrote:
<br>
<span class="quotelev1">&gt; If it isn't too much trouble, it would be good to confirm that it remains broken. I strongly suspect it is based on Moe's comments.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Obviously, other people are making this work. For Intel MPI, all you do is point it at libpmi and they can run. However, they do explicitly dlopen it in their code, and I don't know what flags they might pass when they do so.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; If necessary, I suppose we could follow that pattern. In other words, rather than specifically linking the &quot;s1&quot; component to libpmi, instead require that the user point us to a pmi library via an MCA param, then explicitly dlopen that library with RTLD_GLOBAL. This avoids the issues cited by Jeff, but resolves the pmi linkage problem.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/12/16390.php">http://www.open-mpi.org/community/lists/devel/2014/12/16390.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/12/16391.php">http://www.open-mpi.org/community/lists/devel/2014/12/16391.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16394/attachment">attachment</a>
</ul>
