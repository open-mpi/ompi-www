...
?>
<!-- received="Wed Dec 17 16:43:17 2014" -->
<!-- isoreceived="20141217214317" -->
<!-- sent="Wed, 17 Dec 2014 21:43:14 +0000" -->
<!-- isosent="20141217214314" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch master	updated. dev-564-g6c468b8" -->
<!-- id="8503020D-576B-4947-A7C2-113CBFAF33A6_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAF1Cqj6ohOjWARHvfb5NeHjw-tOmeCGnngpSWAfWU8EoR_9+kQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-17 16:43:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16658.php">Tom Wurgler: "Re: [OMPI devel] 1.8.4rc Status"</a>
<li><strong>Previous message:</strong> <a href="16656.php">Howard Pritchard: "Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch master updated. dev-564-g6c468b8"</a>
<li><strong>In reply to:</strong> <a href="16656.php">Howard Pritchard: "Re: [OMPI devel] [OMPI commits] Git: open-mpi/ompi branch master updated. dev-564-g6c468b8"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Blarg -- I had a typo in my command-line search for an alps component, and thought that it wasn't in the tree any longer.
<br>
<p>I just replaced it; sorry.
<br>
<p><p>On Dec 17, 2014, at 4:40 PM, Howard Pritchard &lt;hppritcha_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Hi Jeff,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Why did you delete the il
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; libmca_common_alps_so_version
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; thats going to break my stuff.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 2014-12-17 14:36 GMT-07:00 &lt;gitdub_at_[hidden]&gt;:
</span><br>
...
<span class="quotelev1">&gt; diff --git a/opal/mca/common/libfabric/Makefile.am b/opal/mca/common/libfabric/Makefile.am
</span><br>
...
<span class="quotelev1">&gt;  lib_at_OPAL_LIB_PREFIX_at_mca_common_libfabric_la_SOURCES = $(headers) $(sources)
</span><br>
...
<span class="quotelev1">&gt;  lib_at_OPAL_LIB_PREFIX_at_mca_common_libfabric_noinst_la_SOURCES = $(headers) $(sources)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; diff --git a/opal/mca/btl/usnic/configure.m4 b/opal/mca/btl/usnic/configure.m4
</span><br>
...
<span class="quotelev1">&gt; +          [AC_MSG_CHECKING([if building embedded libfabric with usnic provider])
</span><br>
<span class="quotelev1">&gt;             AS_IF([test $opal_common_libfabric_happy -eq 1 &amp;&amp; \
</span><br>
...
<span class="quotelev1">&gt; @@ -292,6 +301,13 @@ AC_DEFUN([_OPAL_COMMON_LIBFABRIC_EMBEDDED_PROVIDER_USNIC_CONDITIONALS],[
</span><br>
<span class="quotelev1">&gt;  ])
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/devel/2014/12/16656.php">http://www.open-mpi.org/community/lists/devel/2014/12/16656.php</a>
</span><br>
<p><p><pre>
-- 
Jeff Squyres
