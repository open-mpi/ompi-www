...
?>
<!-- received="Fri Dec 12 02:58:56 2014" -->
<!-- isoreceived="20141212075856" -->
<!-- sent="Fri, 12 Dec 2014 07:58:54 +0000" -->
<!-- isosent="20141212075854" -->
<!-- name="Pascal Deveze" -->
...
<!-- id="DC31D20C207C9643AEEE0D83E753E5C9918CA11F_at_BUMSG3WM.fr.ad.bull.net" -->
<!-- charset="utf-8" -->
<!-- inreplyto="CAMJJpkUZD7Zfeki=Q5c--iDHJxJrOFjd+yi4rYoEiVjrccvO-A_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-12 02:58:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16538.php">Brice Goglin: "Re: [OMPI devel] [OMPI users] OpenMPI 1.8.4 and hwloc in Fedora 14 using a beta gcc 5.0 compiler."</a>
<li><strong>Previous message:</strong> <a href="16536.php">Paul Hargrove: "[OMPI devel] [1.8.4rc3] dangling symlinks"</a>
<li><strong>In reply to:</strong> <a href="16532.php">George Bosilca: "Re: [OMPI devel] Patch proposed: opal_set_using_threads(true) in ompi/runtime/ompi_mpi_init.c is called to late"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16583.php">George Bosilca: "Re: [OMPI devel] Patch proposed: opal_set_using_threads(true) in ompi/runtime/ompi_mpi_init.c is called to late"</a>
<li><strong>Reply:</strong> <a href="16583.php">George Bosilca: "Re: [OMPI devel] Patch proposed: opal_set_using_threads(true) in ompi/runtime/ompi_mpi_init.c is called to late"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16537/attachment">attachment</a>
</ul>
