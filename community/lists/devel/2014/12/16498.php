...
?>
<!-- received="Wed Dec 10 21:14:32 2014" -->
<!-- isoreceived="20141211021432" -->
<!-- sent="Thu, 11 Dec 2014 11:14:42 +0900" -->
<!-- isosent="20141211021442" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6" -->
<!-- id="5488FE12.1080200_at_iferc.org" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2014-12-10 21:14:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16499.php">Ralph Castain: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<li><strong>Previous message:</strong> <a href="16497.php">Nathan Hjelm: "Re: [OMPI devel] opal_lifo/opal_fifo fail with make distcheck"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16499.php">Ralph Castain: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<li><strong>Reply:</strong> <a href="16499.php">Ralph Castain: "Re: [OMPI devel] hwloc out-of-order topology discovery with SLURM 14.11.0 and openmpi 1.6"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Pim,
<br>
<p>at this stage, all i can do is acknowledge your slurm is configured to
<br>
use cgroups.
<br>
<p>and based on your previous comment (e.g. problem only occurs with
<br>
several jobs on the same node)
<br>
that *could* be a bug in OpenMPI (or hwloc).
<br>
<p>by the way, how do you start your mpi application ?
<br>
- do you use mpirun ?
<br>
- do you use srun --resv-ports ?
<br>
<p>i'll try to reproduce this in my test environment.
<br>
<p>Cheers,
<br>
<p>Gilles
<br>
<p>On 2014/12/11 2:45, Pim Schellart wrote:
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16498/attachment">attachment</a>
</ul>
