...
?>
<!-- received="Wed Dec 17 01:39:32 2014" -->
<!-- isoreceived="20141217063932" -->
<!-- sent="Tue, 16 Dec 2014 22:39:30 -0800" -->
<!-- isosent="20141217063930" -->
<!-- name="Paul Hargrove" -->
<!-- email="phhargrove_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] OMPI devel] 1.8.4rc Status" -->
<!-- id="CAAvDA14=aO58ntC09fhGVFvcyS-E5jt1BMHm7mr0S8aFiD_mXA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="54912344.7070106_at_iferc.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-17 01:39:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16630.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] 1.8.4rc Status"</a>
<li><strong>Previous message:</strong> <a href="16628.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] 1.8.4rc Status"</a>
<li><strong>In reply to:</strong> <a href="16628.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] 1.8.4rc Status"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16630.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] 1.8.4rc Status"</a>
<li><strong>Reply:</strong> <a href="16630.php">Gilles Gouaillardet: "Re: [OMPI devel] OMPI devel] 1.8.4rc Status"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gilles,
<br>
<p>If I have done my testing correctly (not 100% sure) then adding
<br>
&quot;-D_REENTRANT&quot; was NOT sufficient, where &quot;-mt&quot; was.
<br>
<p>I can at least test 1 tarball with one set of configure args each evening.
<br>
Anything more than that I cannot commit to.
<br>
<p>My scripts are capable of grabbing the v1.8 nightly instead of the rc if
<br>
that helps.
<br>
<p>-Paul
<br>
<p>On Tue, Dec 16, 2014 at 10:31 PM, Gilles Gouaillardet &lt;
<br>
...
<span class="quotelev1">&gt; this tarball must include
</span><br>
...
<span class="quotelev1">&gt; On Tue, Dec 16, 2014 at 9:59 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; &lt;phhargrove_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  Gilles,
...
<span class="quotelev1">&gt; On Tue, Dec 16, 2014 at 8:10 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; &lt;phhargrove_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/12/16628.php">http://www.open-mpi.org/community/lists/devel/2014/12/16628.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><p><pre>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-16629/attachment">attachment</a>
</ul>
