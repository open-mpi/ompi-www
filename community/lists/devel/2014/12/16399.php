...
?>
<!-- received="Tue Dec  2 08:56:43 2014" -->
<!-- isoreceived="20141202135643" -->
<!-- sent="Tue, 2 Dec 2014 13:56:41 +0000" -->
<!-- isosent="20141202135641" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RTLD_GLOBAL question" -->
<!-- id="5F03333D-1FCD-4B79-8728-69A7D18D03AE_at_cisco.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="CAJ2Qj5oWtSMUjZSx5SQTBAdAyXtmnQoSUvZ_PDxXdpUn6+o5oA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-02 08:56:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16400.php">Edgar Gabriel: "Re: [OMPI devel] RTLD_GLOBAL question"</a>
<li><strong>Previous message:</strong> <a href="16398.php">Artem Polyakov: "Re: [OMPI devel] RTLD_GLOBAL question"</a>
<li><strong>In reply to:</strong> <a href="16398.php">Artem Polyakov: "Re: [OMPI devel] RTLD_GLOBAL question"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16400.php">Edgar Gabriel: "Re: [OMPI devel] RTLD_GLOBAL question"</a>
<li><strong>Reply:</strong> <a href="16400.php">Edgar Gabriel: "Re: [OMPI devel] RTLD_GLOBAL question"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Looks like I was totally lying in <a href="http://www.open-mpi.org/community/lists/devel/2014/12/16381.php">http://www.open-mpi.org/community/lists/devel/2014/12/16381.php</a> (where I said we should not use RTLD_GLOBAL).  We *do* use RTLD_GLOBAL:
<br>

<br>
<a href="https://github.com/open-mpi/ompi/blob/master/opal/mca/base/mca_base_component_repository.c#L124">https://github.com/open-mpi/ompi/blob/master/opal/mca/base/mca_base_component_repository.c#L124</a>
<br>

<br>
This ltdl advice object is passed to lt_dlopen() for all components.  My mistake; sorry.
<br>
...
<br>
*If* you add that workaround (which is a whole separate discussion), I would suggest adding a configure.m4 test to see if adding the additional -llibs are necessary.  Perhaps AC_LINK_IFELSE looking for a symbol, and then if that fails, AC_LINK_IFELSE again with the additional -llibs to see if that works.
<br>
...
<br>
On Dec 2, 2014, at 6:38 AM, Artem Polyakov &lt;artpol84_at_[hidden]&gt; wrote:
<br>
