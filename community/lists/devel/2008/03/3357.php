...
?>
<!-- received="Tue Mar  4 16:50:46 2008" -->
<!-- isoreceived="20080304215046" -->
<!-- sent="Tue, 04 Mar 2008 14:50:33 -0700" -->
<!-- isosent="20080304215033" -->
<!-- name="Ralph H Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Fwd: OpenMPI changes" -->
<!-- id="C3F31239.C802%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-03-04 16:50:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3358.php">Greg Watson: "Re: [OMPI devel] Fwd: OpenMPI changes"</a>
<li><strong>Previous message:</strong> <a href="3356.php">Jeff Squyres: "Re: [OMPI devel] Fwd: OpenMPI changes"</a>
<li><strong>In reply to:</strong> <a href="3356.php">Jeff Squyres: "Re: [OMPI devel] Fwd: OpenMPI changes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3359.php">Greg Watson: "Re: [OMPI devel] Fwd: OpenMPI changes"</a>
<li><strong>Reply:</strong> <a href="3359.php">Greg Watson: "Re: [OMPI devel] Fwd: OpenMPI changes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
not it wants it.
<br>
<p>Restoring the ability to have such changes &quot;callback&quot; to user functions
<br>
...
<br>
<p>I realize there is some difference between ORTE calling back into itself vs
<br>
...
<br>
<p>The tool interface library was built to accomplish two things:
<br>
<p>1. help reduce the impact on external tools of changes to ORTE/OMPI
<br>
interfaces, and
<br>
<p>2. provide a degree of separation to prevent the tool from inadvertently
<br>
causing OMPI to &quot;behave badly&quot;
<br>
<p>I think we accomplished that - I would encourage you to at least consider
<br>
using the library. If there is something missing, we can always add it.
<br>
<p>Ralph
<br>
<p><p><p>On 3/4/08 2:37 PM, &quot;Jeff Squyres&quot; &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev2">&gt;&gt; ORTE in 1.3. Unfortunately this functionality was being used by PTP to
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; runtime. At this point, I can't see either interface supporting PTP.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; tools. I may be worrying needlessly if this new interface becomes an
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; gave a presentation on it to IBM Rochester MN) and discuss required
</span><br>
