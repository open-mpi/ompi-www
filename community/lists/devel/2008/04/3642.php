...
?>
<!-- received="Wed Apr  2 21:11:38 2008" -->
<!-- isoreceived="20080403011138" -->
<!-- sent="Wed, 02 Apr 2008 19:11:17 -0600" -->
<!-- isosent="20080403011117" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Ssh tunnelling broken in trunk?" -->
<!-- id="C4198AD5.4C19%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-04-02 21:11:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3643.php">Gleb Natapov: "Re: [OMPI devel] RFC: changes to modex"</a>
<li><strong>Previous message:</strong> <a href="3641.php">Ralph Castain: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<li><strong>In reply to:</strong> <a href="3641.php">Ralph Castain: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3647.php">Jon Mason: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
so.
<br>
<p>If the orted executables back there are &quot;stale&quot;, then you will get the
<br>
...
<p>Ralph
<br>
<p><p><p>On 4/2/08 7:04 PM, &quot;Ralph Castain&quot; &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Hmmm...something isn't making sense. Can I see the command line you used to
</span><br>
<span class="quotelev1">&gt; generate this?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I'll tell you why I'm puzzled. If orte_debug_flag is set, then the
</span><br>
...
<span class="quotelev1">&gt; When I tested here and on odin, though, I found that the -d option correctly
</span><br>
<span class="quotelev1">&gt; set the flag and everything works just fine.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; --debug-devel, or had OMPI_MCA_orte_debug=1 in the environment, then I am at
</span><br>
<span class="quotelev1">&gt; a loss - everywhere I've tried it, it works fine.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Here's a real simple diagnostic you can do: set -mca plm_base_verbose 1 and
</span><br>
<span class="quotelev3">&gt;&gt;&gt; look at the cmd line being executed (send it here). It will look like:
</span><br>
...
<span class="quotelev2">&gt;&gt; [vic20:01863] [[40388,0],0] plm:rsh: executing: (//usr/bin/ssh) [/usr/bin/ssh
</span><br>
<span class="quotelev2">&gt;&gt; vic12 orted --daemonize -mca ess env -mca orte_ess_jobid 2646867968 -mca
</span><br>
<span class="quotelev2">&gt;&gt; orte_ess_vpid 1 -mca orte_ess_num_procs
</span><br>
...
3
<br>
<span class="quotelev2">&gt;&gt; 0.10:39057&quot; --nodename
</span><br>
...
<span class="quotelev2">&gt;&gt; It looks like what you say is happening.  Is this configured somewhere, so
</span><br>
<span class="quotelev2">&gt;&gt; that I can remove it?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
