<?
$subject_val = "[OMPI devel] Fwd: Intel MPI Benchmark(IMB) using OpenMPI - Segmentation-fault error message.";
include("../../include/msg-header.inc");
?>
<!-- received="Wed Apr 30 09:04:04 2008" -->
<!-- isoreceived="20080430130404" -->
<!-- sent="Wed, 30 Apr 2008 16:03:55 +0300" -->
<!-- isosent="20080430130355" -->
<!-- name="Lenny Verkhovsky" -->
<!-- email="lenny.verkhovsky_at_[hidden]" -->
<!-- subject="[OMPI devel] Fwd: Intel MPI Benchmark(IMB) using OpenMPI - Segmentation-fault error message." -->
<!-- id="453d39990804300603ice26d58t6ab1616c16490dde_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="453d39990804300602mbcefad8j61c02971597978f8_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Fwd: Intel MPI Benchmark(IMB) using OpenMPI - Segmentation-fault error message.<br>
<strong>From:</strong> Lenny Verkhovsky (<em>lenny.verkhovsky_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-04-30 09:03:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3786.php">Jeff Squyres: "[OMPI devel] Mercurial discussion in Chicago"</a>
<li><strong>Previous message:</strong> <a href="3784.php">Lenny Verkhovsky: "Re: [OMPI devel] Intel MPI Benchmark(IMB) using OpenMPI - Segmentation-fault error message."</a>
<li><strong>In reply to:</strong> <a href="3784.php">Lenny Verkhovsky: "Re: [OMPI devel] Intel MPI Benchmark(IMB) using OpenMPI - Segmentation-fault error message."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/devel/2008/05/3790.php">Lenny Verkhovsky: "Re: [OMPI devel] Intel MPI Benchmark(IMB) using OpenMPI - Segmentation-fault error message."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-3785/attachment">attachment</a>
</ul>
