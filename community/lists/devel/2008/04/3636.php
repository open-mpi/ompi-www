...
?>
<!-- received="Wed Apr  2 17:15:09 2008" -->
<!-- isoreceived="20080402211509" -->
<!-- sent="Wed, 2 Apr 2008 17:14:51 -0400" -->
<!-- isosent="20080402211451" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Ssh tunnelling broken in trunk?" -->
<!-- id="6FEC0B00-1CAC-42A1-9C56-1DB450BC7E7E_at_cisco.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="200804021558.59412.jon_at_opengridcomputing.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-04-02 17:14:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3637.php">Ralph Castain: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<li><strong>Previous message:</strong> <a href="3635.php">Jon Mason: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<li><strong>In reply to:</strong> <a href="3635.php">Jon Mason: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3637.php">Ralph Castain: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<li><strong>Reply:</strong> <a href="3637.php">Ralph Castain: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>1. in the case where it works, can you verify that the ssh to launch  
<br>
the orteds is still running?
<br>
<p>2. in the case where it doesn't work, can you verify that the ssh to  
<br>
launch the orteds has actually died?
<br>
<p><p>On Apr 2, 2008, at 4:58 PM, Jon Mason wrote:
<br>
