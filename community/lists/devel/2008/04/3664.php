...
?>
<!-- received="Fri Apr  4 14:55:34 2008" -->
<!-- isoreceived="20080404185534" -->
<!-- sent="Fri, 04 Apr 2008 12:55:20 -0600" -->
<!-- isosent="20080404185520" -->
<!-- name="Ralph H Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] MPI_Comm_connect/Accept" -->
<!-- id="C41BD5B8.CF47%rhc_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="C41BCEF2.CF41%rhc_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-04-04 14:55:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3665.php">Ralph H Castain: "Re: [OMPI devel] MPI_Comm_connect/Accept"</a>
<li><strong>Previous message:</strong> <a href="3663.php">Edgar Gabriel: "Re: [OMPI devel] Affect of compression on modex and launch messages"</a>
<li><strong>In reply to:</strong> <a href="3660.php">Ralph H Castain: "Re: [OMPI devel] MPI_Comm_connect/Accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3665.php">Ralph H Castain: "Re: [OMPI devel] MPI_Comm_connect/Accept"</a>
<li><strong>Reply:</strong> <a href="3665.php">Ralph H Castain: "Re: [OMPI devel] MPI_Comm_connect/Accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On 4/4/08 12:26 PM, &quot;Ralph H Castain&quot; &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Yeah, you didn't specify the file correctly...plus I found a bug in the code
</span><br>
<span class="quotelev1">&gt; when I looked (out-of-date a little in orterun).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I am updating orterun (commit soon) and will include a better help message
</span><br>
<span class="quotelev1">&gt; about the proper format of the orterun cmd-line option. The syntax is:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; -ompi-server uri
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; or -ompi-server file:filename-where-uri-exists
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Problem here is that you gave it a uri of &quot;test&quot;, which means nothing. ;-)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Should have it up-and-going soon.
</span><br>
<span class="quotelev1">&gt; Ralph
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On 4/4/08 12:02 PM, &quot;Aur&#233;lien Bouteiller&quot; &lt;bouteill_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; I've not been very successful at using ompi-server. I tried this :
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; xterm1$ ompi-server --debug-devel -d --report-uri test
</span><br>
<span class="quotelev2">&gt;&gt; [grosse-pomme.local:01097] proc_info: hnp_uri NULL
</span><br>
<span class="quotelev2">&gt;&gt; daemon uri NULL
</span><br>
<span class="quotelev2">&gt;&gt; [grosse-pomme.local:01097] [[34900,0],0] ompi-server: up and running!
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; xterm2$ mpirun -ompi-server test -np 1 mpi_accept_test
</span><br>
<span class="quotelev2">&gt;&gt; Port name:
</span><br>
<span class="quotelev2">&gt;&gt; 2285895681.0;tcp://192.168.0.101:50065;tcp://192.168.0.150:50065:300
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; xterm3$ mpirun -ompi-server test  -np 1 simple_connect
</span><br>
<span class="quotelev2">&gt;&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt; Process rank 0 attempted to lookup from a global ompi_server that
</span><br>
<span class="quotelev2">&gt;&gt; could not be contacted. This is typically caused by either not
</span><br>
<span class="quotelev2">&gt;&gt; specifying the contact info for the server, or by the server not
</span><br>
<span class="quotelev2">&gt;&gt; currently executing. If you did specify the contact info for a
</span><br>
<span class="quotelev2">&gt;&gt; server, please check to see that the server is running and start
</span><br>
<span class="quotelev2">&gt;&gt; it again (or have your sys admin start it) if it isn't.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt; [grosse-pomme.local:01122] *** An error occurred in MPI_Lookup_name
</span><br>
<span class="quotelev2">&gt;&gt; [grosse-pomme.local:01122] *** on communicator MPI_COMM_WORLD
</span><br>
<span class="quotelev2">&gt;&gt; [grosse-pomme.local:01122] *** MPI_ERR_NAME: invalid name argument
</span><br>
<span class="quotelev2">&gt;&gt; [grosse-pomme.local:01122] *** MPI_ERRORS_ARE_FATAL (goodbye)
</span><br>
<span class="quotelev2">&gt;&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; The server code Open_port, and then PublishName. Looks like the
</span><br>
<span class="quotelev2">&gt;&gt; LookupName function cannot reach the ompi-server. The ompi-server in
</span><br>
<span class="quotelev2">&gt;&gt; debug mode does not show any output when a new event occurs (like when
</span><br>
<span class="quotelev2">&gt;&gt; the server is launched). Is there something wrong in the way I use it ?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Le 3 avr. 08 &#224; 17:21, Ralph Castain a &#233;crit :
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Take a gander at ompi/tools/ompi-server - I believe I put a man page
</span><br>
<span class="quotelev3">&gt;&gt;&gt; in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; there. You might just try &quot;man ompi-server&quot; and see if it shows up.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Holler if you have a question - not sure I documented it very
</span><br>
<span class="quotelev3">&gt;&gt;&gt; thoroughly at
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 4/3/08 3:10 PM, &quot;Aur&#233;lien Bouteiller&quot; &lt;bouteill_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I am using trunk. Is there a documentation for ompi-server ? Sounds
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; exactly like what I need to fix point 1.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Le 3 avr. 08 &#224; 17:06, Ralph Castain a &#233;crit :
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; which) on the head node - there are various ways to tell mpirun
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I have tested publish/lookup pretty thoroughly and it seems to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; work. I
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; haven't spent much time testing connect/accept except via
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; comm_spawn, which
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; seems to be working. Since that uses the same mechanism, I would
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; printf-scanf) the port_name string generated by Open_port;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; standard ? Is it because my two applications does not share the
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; clients. Am I understanding correctly the standard here and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; should we
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; /*        MPI_Publish_name(&quot;test_service_el&quot;, MPI_INFO_NULL,
</span><br>
