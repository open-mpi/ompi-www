...
?>
<!-- received="Wed Apr  2 16:59:05 2008" -->
<!-- isoreceived="20080402205905" -->
<!-- sent="Wed, 2 Apr 2008 15:58:59 -0500" -->
<!-- isosent="20080402205859" -->
<!-- name="Jon Mason" -->
<!-- email="jon_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Ssh tunnelling broken in trunk?" -->
<!-- id="200804021558.59412.jon_at_opengridcomputing.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="200804021321.31942.jon_at_opengridcomputing.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-04-02 16:58:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3636.php">Jeff Squyres: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<li><strong>Previous message:</strong> <a href="3634.php">Gleb Natapov: "Re: [OMPI devel] RFC: changes to modex"</a>
<li><strong>In reply to:</strong> <a href="3630.php">Jon Mason: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3636.php">Jeff Squyres: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<li><strong>Reply:</strong> <a href="3636.php">Jeff Squyres: "Re: [OMPI devel] Ssh tunnelling broken in trunk?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev2">&gt; &gt; I remember that someone had found a bug that caused orte_debug_flag to not
</span><br>
<span class="quotelev2">&gt; &gt; get properly set (local var covering over a global one) - could be that
</span><br>
...
<span class="quotelev1">&gt; I updated my ompi-trunk tree, did a clean build, and I still seem the same 
</span><br>
<span class="quotelev1">&gt; problem.  I regressed trunk to rev 17589 and everything works as I expect.  
</span><br>
<span class="quotelev1">&gt; So I think the problem is still there in the top of trunk.
</span><br>
<p><p>I stepped through the revs of trunk and found the first failing rev to be
<br>
17632.  Its a big patch, so I'll defer to those more in the know to determine
<br>
what is breaking in there.
<br>
<p><p><span class="quotelev1">&gt; I don't discount user error, but I don't think I am doing anyting different.  
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; I'm using this feature on the trunk with the version from yesterday.
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; I pulled it out of the command used to update the branch, which was:
</span><br>
