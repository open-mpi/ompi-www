...
?>
<!-- received="Mon Aug  4 14:08:18 2008" -->
<!-- isoreceived="20080804180818" -->
<!-- sent="Mon, 4 Aug 2008 14:08:11 -0400" -->
<!-- isosent="20080804180811" -->
<!-- name="Greg Watson" -->
<!-- email="g.watson_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Problem with SVN access." -->
<!-- id="B5AF00A0-4E8E-4649-9387-32AC797F80E4_at_computer.org" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-08-04 14:08:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4526.php">Ralph Castain: "Re: [OMPI devel] OMPI 1.3 problems"</a>
<li><strong>Previous message:</strong> <a href="4524.php">Greg Watson: "[OMPI devel] OMPI 1.3 problems"</a>
<li><strong>In reply to:</strong> <a href="4523.php">Anton Soppelsa: "[OMPI devel] Problem with SVN access."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4529.php">Shiqing Fan: "Re: [OMPI devel] Problem with SVN access."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Anton,
<br>
<p>I'm using Subversive and it seems to work fine. I wonder if there's  
<br>
something wrong with your setup?
<br>
<p>Greg
<br>
<p>On Aug 4, 2008, at 2:01 PM, Anton Soppelsa wrote:
<br>
