...
?>
<!-- received="Sat Dec 13 15:02:30 2008" -->
<!-- isoreceived="20081213200230" -->
<!-- sent="Sat, 13 Dec 2008 15:02:24 -0500" -->
<!-- isosent="20081213200224" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Fwd: [OMPI users] Onesided + derived datatypes" -->
<!-- id="D6520864-86FE-44B1-B1CB-69A55BC78118_at_eecs.utk.edu" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-12-13 15:02:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5062.php">Brian Barrett: "Re: [OMPI devel] Fwd: [OMPI users] Onesided + derived datatypes"</a>
<li><strong>Previous message:</strong> <a href="5060.php">Richard Graham: "Re: [OMPI devel] shared-memory allocations"</a>
<li><strong>In reply to:</strong> <a href="5045.php">Brian Barrett: "Re: [OMPI devel] Fwd: [OMPI users] Onesided + derived datatypes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5062.php">Brian Barrett: "Re: [OMPI devel] Fwd: [OMPI users] Onesided + derived datatypes"</a>
<li><strong>Reply:</strong> <a href="5062.php">Brian Barrett: "Re: [OMPI devel] Fwd: [OMPI users] Onesided + derived datatypes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Brian,
<br>
<p>I found a second problem with rebuilding the datatype on the remote.  
<br>
...
remote.
<br>
<p>I can confirm that the packed message contains only 0 instead of the  
<br>
