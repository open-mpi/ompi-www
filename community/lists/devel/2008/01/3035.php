...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3036.php">Aurélien Bouteiller: "Re: [OMPI devel] Fwd: === CREATE FAILURE ==="</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3036.php">Aurélien Bouteiller: "Re: [OMPI devel] Fwd: === CREATE FAILURE ==="</a>
<li><strong>Reply:</strong> <a href="3036.php">Aurélien Bouteiller: "Re: [OMPI devel] Fwd: === CREATE FAILURE ==="</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
