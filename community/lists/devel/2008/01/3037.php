...
?>
<!-- received="Thu Jan 24 15:43:20 2008" -->
<!-- isoreceived="20080124204320" -->
<!-- sent="Thu, 24 Jan 2008 14:43:12 -0600 (CST)" -->
<!-- isosent="20080124204312" -->
<!-- name="Brian W. Barrett" -->
<!-- email="brbarret_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Fwd: === CREATE FAILURE ===" -->
<!-- id="Pine.LNX.4.64.0801241442400.5937_at_marvin.we-be-smart.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="5D9ABB52-976C-4233-B363-C127487463A9_at_eecs.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-01-24 15:43:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3038.php">Ralf Wildenhues: "Re: [OMPI devel] Fwd: === CREATE FAILURE ==="</a>
<li><strong>Previous message:</strong> <a href="3036.php">Aur&#233;lien Bouteiller: "Re: [OMPI devel] Fwd: === CREATE FAILURE ==="</a>
<li><strong>In reply to:</strong> <a href="3036.php">Aur&#233;lien Bouteiller: "Re: [OMPI devel] Fwd: === CREATE FAILURE ==="</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3038.php">Ralf Wildenhues: "Re: [OMPI devel] Fwd: === CREATE FAILURE ==="</a>
<li><strong>Reply:</strong> <a href="3038.php">Ralf Wildenhues: "Re: [OMPI devel] Fwd: === CREATE FAILURE ==="</a>
<li><strong>Reply:</strong> <a href="3040.php">Aurélien Bouteiller: "Re: [OMPI devel] Fwd: === CREATE FAILURE ==="</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Brian
<br>
<p>On Thu, 24 Jan 2008, Aur&#233;lien Bouteiller wrote:
<br>
<p><span class="quotelev1">&gt; According to posix, tar should not limit the file name length. Only
</span><br>
<span class="quotelev1">&gt; the v7 implementation of tar is limited to 99 characters. GNU tar has
</span><br>
<span class="quotelev1">&gt; never been limited in the number of characters file names can have.
</span><br>
<span class="quotelev1">&gt; You should check with tar --help that tar on your machine defaults to
</span><br>
<span class="quotelev1">&gt; format=gnu or format=posix. If it defaults to format=v7 I am curious
</span><br>
<span class="quotelev1">&gt; why. Are you using solaris ?
</span><br>
...
<span class="quotelev1">&gt; Le 24 janv. 08 &#224; 15:18, Jeff Squyres a &#233;crit :
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I'm trying to replicate and getting a lot of these:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; tar: openmpi-1.3a1r17212M/ompi/mca/pml/v/vprotocol/mca/vprotocol/
</span><br>
<span class="quotelev2">&gt;&gt; pessimist/vprotocol_pessimist_sender_based.c: file name is too long
</span><br>
<span class="quotelev2">&gt;&gt; (max 99); not dumped
</span><br>
<span class="quotelev2">&gt;&gt; tar: openmpi-1.3a1r17212M/ompi/mca/pml/v/vprotocol/mca/vprotocol/
</span><br>
<span class="quotelev2">&gt;&gt; pessimist/vprotocol_pessimist_component.c: file name is too long (max
</span><br>
<span class="quotelev2">&gt;&gt; 99); not dumped
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I'll bet that this is the real problem.  GNU tar on linux defaults to
</span><br>
<span class="quotelev2">&gt;&gt; 99 characters max, and the _component.c filename is 102, for example.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Can you shorten your names?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Jan 24, 2008, at 3:02 PM, George Bosilca wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; We cannot reproduce this one. A simple &quot;make checkdist&quot; exit long
</span><br>
<span class="quotelev3">&gt;&gt;&gt; before doing anything in the ompi directory. It is difficult to see
</span><br>
<span class="quotelev3">&gt;&gt;&gt; where exactly it fails, but it is somewhere in the opal directory. I
</span><br>
<span class="quotelev3">&gt;&gt;&gt; suspect the new carto framework ...
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Jan 24, 2008, at 7:12 AM, Jeff Squyres wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Can you fix please?  Last night's tests didn't run because of this
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; From: MPI Team &lt;mpiteam_at_[hidden]&gt;
</span><br>
