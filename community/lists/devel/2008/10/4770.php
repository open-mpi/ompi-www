...
?>
<!-- received="Fri Oct 17 09:35:11 2008" -->
<!-- isoreceived="20081017133511" -->
<!-- sent="Fri, 17 Oct 2008 09:34:59 -0400" -->
<!-- isosent="20081017133459" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init" -->
<!-- id="F6D28D85-A24F-4D34-8966-19A39BF08C60_at_eecs.utk.edu" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="48F7CE44.6090605_at_imperial.ac.uk" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-10-17 09:34:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4771.php">Ralph Castain: "[OMPI devel] IOF 2.0"</a>
<li><strong>Previous message:</strong> <a href="4769.php">Jeff Squyres: "Re: [OMPI devel] 1.3 release date?"</a>
<li><strong>In reply to:</strong> <a href="4768.php">Stephan Kramer: "Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4776.php">Stephan Kramer: "Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init"</a>
<li><strong>Reply:</strong> <a href="4776.php">Stephan Kramer: "Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Stephan,
<br>
<p>You might be right. intptr_t is a signed type, which allows the result  
<br>
...
<br>
<p>Did you try to apply your patch to Open MPI ? If yes does it resolve  
<br>
the issue ?
<br>
<p>&nbsp;&nbsp;&nbsp;george.
<br>
<p>On Oct 16, 2008, at 7:29 PM, Stephan Kramer wrote:
<br>
...
<span class="quotelev2">&gt;&gt; same output as you, all addresses are in the correct range. I went  
</span><br>
<span class="quotelev2">&gt;&gt; over the code manually, and to be honest I cannot imagine how this  
</span><br>
<span class="quotelev2">&gt;&gt; might happens IF the compiler is doing what it is supposed to do.
</span><br>
...
<span class="quotelev1">&gt; Thanks a lot for your effort of looking into this. I think I've come  
</span><br>
<span class="quotelev1">&gt; a bit further with this. The reproducibility may in fact have to do  
</span><br>
<span class="quotelev1">&gt; with 32bit/64 bit differences.
</span><br>
...
<span class="quotelev1">&gt; above 0x7fff ffff the outcome of mod will be negative. Thus ptr will  
</span><br>
<span class="quotelev1">&gt; be increased with more than CACHE_LINE_SIZE, which is not accounted  
</span><br>
<span class="quotelev1">&gt; for in the allocated buffer size in line 93, and a buffer overrun  
</span><br>
<span class="quotelev1">&gt; will appear in the subsequent element loop. This is confirmed with  
</span><br>
<span class="quotelev1">&gt; the output of some debugging statements I've pasted below. Also I  
</span><br>
<span class="quotelev1">&gt; haven't come across the same bug on 64bit machines.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Would someone mind having another look at the bug reported below?  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm hitting exactly the same problem with Debian Unstable,  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; openmpi  1.2.7~rc2. Both valgrind and efence are indispensable  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; tools for any developper,  where both may catch errors the other  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; won't report. Electric fence is especially good at catching buffer  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; overruns as it protects the beginning and end of each allocated  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; buffer. The original bug report shows an undeniable buffer overrun  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; in MPI::Init, i.e. the attached patch prints out exactly the  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; address it's trying to access which is over the end of the buffer.  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm unable to reproduce the buffer overrun with the latest trunk. I
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; the code, and I cannot imagine how we can overrun the buffer in the
</span><br>
...
<br><hr>
<ul>
<li>application/pkcs7-signature attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-4770/smime.p7s">smime.p7s</a>
</ul>
