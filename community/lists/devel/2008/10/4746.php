...
?>
<!-- received="Tue Oct  7 13:18:57 2008" -->
<!-- isoreceived="20081007171857" -->
<!-- sent="Tue, 7 Oct 2008 13:18:37 -0400" -->
<!-- isosent="20081007171837" -->
<!-- name="Matt Burgess" -->
<!-- email="burgess.matt_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions" -->
<!-- id="a2f40f560810071018p2ef27982i56715c96e43106f8_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="48EB8D56.3050100_at_dev.mellanox.co.il" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-10-07 13:18:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4747.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions"</a>
<li><strong>Previous message:</strong> <a href="4745.php">Pavel Shamis (Pasha): "[OMPI devel] OpenIB BTL - removing btl_openib_ib_pkey_ix parameter"</a>
<li><strong>In reply to:</strong> <a href="4744.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4747.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions"</a>
<li><strong>Reply:</strong> <a href="4747.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Pasha,
<br>
<p>With your patch and parameter suggestion, it works! So to be clear
<br>
...
Matt
<br>
<p>On Tue, Oct 7, 2008 at 12:24 PM, Pavel Shamis (Pasha) &lt;
<br>
pasha_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Matt,
</span><br>
<span class="quotelev1">&gt; Can you please run &quot; cat /sys/class/infiniband/mlx4_0/ports/1/pkeys/* &quot; on
</span><br>
<span class="quotelev1">&gt; your d2-ib,d3-ib.
</span><br>
...
<span class="quotelev1">&gt; &quot;btl_openib_ib_pkey_val&quot; for ompi-1.2.6 and my patch accepts HEX/DEC
</span><br>
<span class="quotelev1">&gt; values):
</span><br>
<span class="quotelev1">&gt; /opt/openmpi-ib/1.2.6/bin/mpirun -np 2 -H d2-ib,d3-ib -mca btl openib,self
</span><br>
<span class="quotelev1">&gt; -mca btl_openib_ib_pkey_val 0x8109 /cluster/pallas/x86_64-ib/IMB-MPI1
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Thanks for the patch. Unfortunately, it doesn't seem like that fixed the
</span><br>
<span class="quotelev2">&gt;&gt; problem. I realized earlier I didn't mention what version of OpenMPI I was
</span><br>
<span class="quotelev2">&gt;&gt; trying - it's 1.2.6. &lt;<a href="http://1.2.6">http://1.2.6</a>.&gt; Should I be trying 1.2.7 with this
</span><br>
...
<span class="quotelev2">&gt;&gt; 2008/10/7 Pavel Shamis (Pasha) &lt;pasha_at_[hidden] &lt;mailto:
</span><br>
...
<span class="quotelev2">&gt;&gt;    Can you please try attached patch ? I guess it will resolve this
</span><br>
...
<span class="quotelev2">&gt;&gt;        Thanks for the info. It doesn't seem to be be working still.
</span><br>
...
<span class="quotelev2">&gt;&gt;        I don't have a &quot;/sys/class/infiniband/mthca0/ports/1/pkeys/&quot;
</span><br>
<span class="quotelev2">&gt;&gt;        but I do have &quot;/sys/class/infiniband/mlx4_0/ports/1/pkeys/&quot;.
</span><br>
<span class="quotelev2">&gt;&gt;        It's contents are:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;        0    106  114  122  16   24   32   40   49   57   65   73   81
</span><br>
<span class="quotelev2">&gt;&gt;          9    98
</span><br>
<span class="quotelev2">&gt;&gt;        1    107  115  123  17   25   33   41   5    58   66   74   82
</span><br>
<span class="quotelev2">&gt;&gt;          90   99
</span><br>
<span class="quotelev2">&gt;&gt;        10   108  116  124  18   26   34   42   50   59   67   75   83
</span><br>
<span class="quotelev2">&gt;&gt;          91  100  109  117  125  19   27   35   43   51   6    68
</span><br>
<span class="quotelev2">&gt;&gt;  76   84   92  101  11   118  126  2    28   36   44   52   60
</span><br>
<span class="quotelev2">&gt;&gt;          69   77   85   93  102  110  119  127  20   29   37   45
</span><br>
<span class="quotelev2">&gt;&gt;  53   61   7    78   86   94  103  111  12   13   21   3    38
</span><br>
<span class="quotelev2">&gt;&gt;          46   54   62   70   79   87   95  104  112  120  14   22
</span><br>
<span class="quotelev2">&gt;&gt;  30   39   47   55   63   71   8    88   96  105  113  121  15
</span><br>
<span class="quotelev2">&gt;&gt;          23   31   4    48   56   64   72   80   89   97
</span><br>
<span class="quotelev2">&gt;&gt;        We aren't using the opensm, but voltaire's SM on a 2012 switch.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;           when the value is a decimal number of the pkey, in your case
</span><br>
<span class="quotelev2">&gt;&gt;           0x8109 = 33033, and no need for btl_openib_ib_pkey_ix value.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;           /sys/class/infiniband/mthca0/ports/1/pkeys/* for pkeys ans SM,
</span><br>
...
<span class="quotelev2">&gt;&gt;               FWIW, if this configuration is for all of your users, you
</span><br>
<span class="quotelev2">&gt;&gt;               might want to specify these MCA params in the default MCA
</span><br>
<span class="quotelev2">&gt;&gt;               param file, or the environment, ...etc.  Just so that you
</span><br>
<span class="quotelev2">&gt;&gt;               don't have to specify it on every mpirun command line.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;                   -mca btl openib,self -mca btl_openib_of_pkey_val 0x8109
</span><br>
...
<span class="quotelev2">&gt;&gt;                   #mpirun -np 2 -H witch2,witch3 -mca btl openib,self
</span><br>
...
<span class="quotelev2">&gt;&gt;                   Really?  I thought we only took OpenFabrics device
</span><br>
<span class="quotelev2">&gt;&gt;        names
</span><br>
<span class="quotelev2">&gt;&gt;                   in the openib_if_include MCA param...?  It looks like
</span><br>
...
<span class="quotelev2">&gt;&gt;                   On 10/3/08, Matt Burgess &lt;burgess.matt_at_[hidden]
</span><br>
...
<span class="quotelev2">&gt;&gt;                   On this cluster, the partition number is 0x109. The ib
</span><br>
<span class="quotelev2">&gt;&gt;                   interfaces are pingable over the appropriate ib0.8109
</span><br>
...
<span class="quotelev2">&gt;&gt;                           inet addr:10.21.48.2 &lt;<a href="http://10.21.48.2">http://10.21.48.2</a>&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;                           UP BROADCAST RUNNING MULTICAST  MTU:65520
</span><br>
...
<span class="quotelev2">&gt;&gt;                           TX packets:15848 errors:0 dropped:1 overruns:0
</span><br>
...
<span class="quotelev2">&gt;&gt;                   /opt/openmpi-ib/1.2.6/bin/mpirun -np 2 -machinefile
</span><br>
...
<span class="quotelev2">&gt;&gt;                   but I just get a RETRY EXCEEDED ERROR. Is there a MCA
</span><br>
...
<span class="quotelev2">&gt;&gt;    --- ompi/mca/btl/openib/btl_openib_component.c  (revision 19490)
</span><br>
...
<span class="quotelev2">&gt;&gt;                    for (j=0; j &lt; hca-&gt;ib_dev_attr.max_pkeys; j++) {
</span><br>
<span class="quotelev2">&gt;&gt;                        ibv_query_pkey(hca-&gt;ib_dev_context, i, j, &amp;pkey);
</span><br>
<span class="quotelev2">&gt;&gt;    -                    pkey=ntohs(pkey);
</span><br>
<span class="quotelev2">&gt;&gt;    +                    pkey=ntohs(pkey) &amp; 0x7fff;
</span><br>
<span class="quotelev2">&gt;&gt;                        if(pkey == mca_btl_openib_component.ib_pkey_val){
</span><br>
<span class="quotelev2">&gt;&gt;                            ret = init_one_port(btl_list, hca, i, j,
</span><br>
...
<span class="quotelev2">&gt;&gt;    --- ompi/mca/btl/openib/btl_openib_ini.c        (revision 19490)
</span><br>
...
<span class="quotelev2">&gt;&gt;    -static int intify_list(char *str, uint32_t **values, int *len);
</span><br>
...
<span class="quotelev2">&gt;&gt;           all whitespace at the beginning and ending of the value. */
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     * Do string-to-integer conversion, for both hex and decimal numbers
</span><br>
<span class="quotelev2">&gt;&gt;     */
</span><br>
...
<span class="quotelev2">&gt;&gt;    -static int intify_list(char *value, uint32_t **values, int *len)
</span><br>
...
<span class="quotelev2">&gt;&gt;    +        *values[0] = (uint32_t) ompi_btl_openib_ini_intify(str);
</span><br>
...
<span class="quotelev2">&gt;&gt;                *values = realloc(*values, sizeof(uint32_t) * (*len + 2));
</span><br>
...
<span class="quotelev2">&gt;&gt;    +        (*values)[*len] = (uint32_t) ompi_btl_openib_ini_intify(str);
</span><br>
<span class="quotelev2">&gt;&gt;            ++(*len);
</span><br>
<span class="quotelev2">&gt;&gt;        }
...
<span class="quotelev2">&gt;&gt;    --- ompi/mca/btl/openib/btl_openib_ini.h        (revision 19490)
</span><br>
...
<span class="quotelev2">&gt;&gt;    --- ompi/mca/btl/openib/btl_openib_mca.c        (revision 19490)
</span><br>
...
<span class="quotelev2">&gt;&gt;        CHECK(reg_int(&quot;ib_psn&quot;, &quot;InfiniBand packet sequence starting
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-4746/attachment">attachment</a>
</ul>
