...
?>
<!-- received="Mon Oct 20 17:43:57 2008" -->
<!-- isoreceived="20081020214357" -->
<!-- sent="Mon, 20 Oct 2008 17:43:26 -0400" -->
<!-- isosent="20081020214326" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init" -->
<!-- id="F2D92127-DB8F-4D2E-A486-E62F325ADF4C_at_eecs.utk.edu" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="48FB71C0.6070508_at_imperial.ac.uk" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-10-20 17:43:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4780.php">George Bosilca: "Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init"</a>
<li><strong>Previous message:</strong> <a href="4778.php">Ralph Castain: "Re: [OMPI devel] -display-map"</a>
<li><strong>In reply to:</strong> <a href="4776.php">Stephan Kramer: "Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4780.php">George Bosilca: "Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init"</a>
<li><strong>Reply:</strong> <a href="4780.php">George Bosilca: "Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Stephen,
<br>
<p>I think you're completely right, and that I had a wrong understanding  
<br>
...
<br>
programming language (<a href="http://en.wikipedia.org/wiki/Modulo_operation">http://en.wikipedia.org/wiki/Modulo_operation</a>).
<br>
<p>I will apply your patch to all places where we use modulus in Open  
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;george.
<br>
<p>On Oct 19, 2008, at 1:43 PM, Stephan Kramer wrote:
<br>
...
<span class="quotelev2">&gt;&gt; You might be right. intptr_t is a signed type, which allows the  
</span><br>
<span class="quotelev2">&gt;&gt; result of % to be potentially negative. However, on the other side,  
</span><br>
<span class="quotelev2">&gt;&gt; mod is defined as a size_t which [based on my memory] is  
</span><br>
<span class="quotelev2">&gt;&gt; definitively unsigned as it represent a size.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Did you try to apply your patch to Open MPI ? If yes does it  
</span><br>
...
<span class="quotelev1">&gt; Yes, I have applied the patch intptr_t -&gt; uintptr_t and it does  
</span><br>
<span class="quotelev1">&gt; resolve the issue.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I think the way this works, I'm not a C programmer myself, is:
</span><br>
<span class="quotelev1">&gt; - the outcome of the % is a signed and negative number, say -x
</span><br>
<span class="quotelev1">&gt; - this number gets wrapped in the assignment to the signed integer  
</span><br>
<span class="quotelev1">&gt; mod: UINT_MAX+1-x
</span><br>
<span class="quotelev1">&gt; - in the subtraction CACHE_LINE_SIZE-mod, the result is wrapped  
</span><br>
<span class="quotelev1">&gt; around again, giving CACHE_LINE_SIZE+x
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On Oct 16, 2008, at 7:29 PM, Stephan Kramer wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; George Bosilca wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I did investigate this issue for about 3 hours yesterday. Neither  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; valgrind nor efence report any errors on my cluster. I'm using  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; debian unstable with gcc-4.1.2. Adding printfs doesn't shows the  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; same output as you, all addresses are in the correct range. I  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; went over the code manually, and to be honest I cannot imagine  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; how this might happens IF the compiler is doing what it is  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; supposed to do.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I run out of options on this one. If you can debug it and figure  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; out what's the problem there I'll be happy to hear.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Thanks a lot for your effort of looking into this. I think I've  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; come a bit further with this. The reproducibility may in fact have  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to do with 32bit/64 bit differences.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I think the culprit is line 105 of opal_free_list.c:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  mod = (intptr_t)ptr % CACHE_LINE_SIZE;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  if(mod != 0) {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;      ptr += (CACHE_LINE_SIZE - mod);
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  }
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; As intptr_t casts to a signed integer, for 32 bit with addresses  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; above 0x7fff ffff the outcome of mod will be negative. Thus ptr  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; will be increased with more than CACHE_LINE_SIZE, which is not  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; accounted for in the allocated buffer size in line 93, and a  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; buffer overrun will appear in the subsequent element loop. This is  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; confirmed with the output of some debugging statements I've pasted  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; below. Also I haven't come across the same bug on 64bit machines.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I guess this should be uintptr_t instead?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; The debugging output:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpidebug: num_elements  = 1, flist-&gt;fl_elem_size = 40
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpidebug: sizeof(opal_list_item_t) = 16
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpidebug: allocating 184
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpidebug: allocated at memory address 0xb2d29f48
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpidebug: mod = -40, CACHE_LINE_SIZE = 128
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and at point of the buffer overrun/efence segfault in gdb:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (gdb) print item
</span><br>
<span class="quotelev3">&gt;&gt;&gt; $23 = (opal_free_list_item_t *) 0xb2d2a000
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; which is exactly at (over) the end of the buffer:  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0xb2d2a000=0xb2d29f48 + 184
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Oct 14, 2008, at 11:03 AM, Stephan Kramer wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Would someone mind having another look at the bug reported  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; below? I'm hitting exactly the same problem with Debian  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Unstable, openmpi  1.2.7~rc2. Both valgrind and efence are  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; indispensable tools for any developper,  where both may catch  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; errors the other won't report. Electric fence is especially good  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; at catching buffer overruns as it protects the beginning and end  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; of each allocated buffer. The original bug report shows an  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; undeniable buffer overrun in MPI::Init, i.e. the attached patch  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; prints out exactly the address it's trying to access which is  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; over the end of the buffer. Any help would be much appreciated
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I'm unable to reproduce the buffer overrun with the latest  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; trunk. I
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; run valgrind (with the memchekcer tool) on a regular basis on the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; trunk, and I never noticed anything like that. Moreover, I went  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; over
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the code, and I cannot imagine how we can overrun the buffer in  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; requested=0, provided=0xbfd61e78) at runtime/ompi_mpi_init.c: 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 411
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; #5 0xb7911a87 in PMPI_Init (argc=0xbfd61f00, argv=0xbfd61f04)  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; macro with its definition in opal/class/opal_object.h, and  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ran it
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; +++ openmpi-1.2.5-modified/opal/class/opal_free_list.c  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 2008-08-23
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; flist-&gt;fl_elem_size) + sizeof(opal_list_item_t) +  
</span><br>
...
<br><hr>
<ul>
<li>application/pkcs7-signature attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-4779/smime.p7s">smime.p7s</a>
</ul>
