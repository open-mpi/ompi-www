...
?>
<!-- received="Tue Oct  7 11:48:13 2008" -->
<!-- isoreceived="20081007154813" -->
<!-- sent="Tue, 7 Oct 2008 11:48:07 -0400" -->
<!-- isosent="20081007154807" -->
<!-- name="Matt Burgess" -->
<!-- email="burgess.matt_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions" -->
<!-- id="a2f40f560810070848r5721d093m736c164e15a1f5ef_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="48EB6F1B.30400_at_dev.mellanox.co.il" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-10-07 11:48:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4744.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions"</a>
<li><strong>Previous message:</strong> <a href="4742.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions"</a>
<li><strong>In reply to:</strong> <a href="4742.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4744.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions"</a>
<li><strong>Reply:</strong> <a href="4744.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Fwd: [OMPI users] OpenMPI with openib partitions"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Pasha,
<br>
<p>Thanks for the patch. Unfortunately, it doesn't seem like that fixed the
<br>
...
Matt
<br>
<p>2008/10/7 Pavel Shamis (Pasha) &lt;pasha_at_[hidden]&gt;
<br>
<p><span class="quotelev1">&gt; Matt,
</span><br>
<span class="quotelev1">&gt; Can you please try attached patch ? I guess it will resolve this issue.
</span><br>
...
<span class="quotelev2">&gt;&gt; Thanks for the info. It doesn't seem to be be working still. My command
</span><br>
<span class="quotelev2">&gt;&gt; line is:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; /opt/openmpi-ib/1.2.6/bin/mpirun -np 2 -H d2-ib,d3-ib -mca btl openib,self
</span><br>
<span class="quotelev2">&gt;&gt; -mca btl_openib_of_pkey_val 33033 /cluster/pallas/x86_64-ib/IMB-MPI1
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I don't have a &quot;/sys/class/infiniband/mthca0/ports/1/pkeys/&quot; but I do have
</span><br>
<span class="quotelev2">&gt;&gt; &quot;/sys/class/infiniband/mlx4_0/ports/1/pkeys/&quot;. It's contents are:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; 0    106  114  122  16   24   32   40   49   57   65   73   81   9    98
</span><br>
<span class="quotelev2">&gt;&gt; 1    107  115  123  17   25   33   41   5    58   66   74   82   90   99
</span><br>
<span class="quotelev2">&gt;&gt; 10   108  116  124  18   26   34   42   50   59   67   75   83   91  100
</span><br>
<span class="quotelev2">&gt;&gt;  109  117  125  19   27   35   43   51   6    68   76   84   92  101  11
</span><br>
<span class="quotelev2">&gt;&gt; 118  126  2    28   36   44   52   60   69   77   85   93  102  110  119
</span><br>
<span class="quotelev2">&gt;&gt;  127  20   29   37   45   53   61   7    78   86   94  103  111  12   13
</span><br>
<span class="quotelev2">&gt;&gt; 21   3    38   46   54   62   70   79   87   95  104  112  120  14   22   30
</span><br>
<span class="quotelev2">&gt;&gt;   39   47   55   63   71   8    88   96  105  113  121  15   23   31   4
</span><br>
<span class="quotelev2">&gt;&gt;  48   56   64   72   80   89   97
</span><br>
...
<span class="quotelev2">&gt;&gt; lenny.verkhovsky_at_[hidden] &lt;mailto:lenny.verkhovsky_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;            btl_openib_of_pkey_val 0x8001 -mca btl_openib_of_pkey_ix 1
</span><br>
...
<span class="quotelev2">&gt;&gt;            Really?  I thought we only took OpenFabrics device names
</span><br>
...
<span class="quotelev2">&gt;&gt;            I'm trying to get openmpi working over openib partitions.
</span><br>
...
<span class="quotelev2">&gt;&gt;                    RX bytes:102229428 (97.4 Mb)  TX bytes:102324172
</span><br>
...
<span class="quotelev2">&gt;&gt;            machinefile -mca btl openib,self -mca btl_openib_max_btls
</span><br>
<span class="quotelev2">&gt;&gt;            1 -mca btl_openib_ib_pkey_val 0x8109 -mca
</span><br>
<span class="quotelev2">&gt;&gt;            btl_openib_ib_pkey_ix 1 /cluster/pallas/x86_64-ib/IMB-MPI1
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;            machinefile -mca btl tcp,self -mca btl_openib_max_btls 1
</span><br>
...
<span class="quotelev1">&gt;  static void reset_section(bool had_previous_value, parsed_section_values_t
</span><br>
...
<span class="quotelev1">&gt; -        if (OMPI_SUCCESS != (ret = intify_list(value, &amp;sv-&gt;vendor_ids,
</span><br>
<span class="quotelev1">&gt; +        if (OMPI_SUCCESS != (ret = ompi_btl_openib_ini_intify_list(value,
</span><br>
...
<span class="quotelev1">&gt; +        sv-&gt;values.mtu = (uint32_t) ompi_btl_openib_ini_intify(value);
</span><br>
...
<span class="quotelev1">&gt; +int ompi_btl_openib_ini_intify_list(char *value, uint32_t **values, int
</span><br>
...
<span class="quotelev1">&gt; +            (*values)[*len] = (int32_t) ompi_btl_openib_ini_intify(str);
</span><br>
<span class="quotelev1">&gt;             ++(*len);
</span><br>
...
<span class="quotelev1">&gt; +    int ompi_btl_openib_ini_intify_list(char *str, uint32_t **values, int
</span><br>
<span class="quotelev1">&gt; *len);
</span><br>
<span class="quotelev1">&gt; +
...
<span class="quotelev1">&gt;     CHECK(reg_int(&quot;ib_psn&quot;, &quot;InfiniBand packet sequence starting number &quot;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-4743/attachment">attachment</a>
</ul>
