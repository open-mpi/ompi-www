<?
$subject_val = "[OMPI devel] Open MPI v1.2.8 released";
...
<!-- subject="[OMPI devel] Open MPI v1.2.8 released" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI devel] Open MPI v1.2.8 released<br>
<strong>From:</strong> Tim Mattox (<em>timattox_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-10-14 15:14:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4765.php">George Bosilca: "Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init"</a>
<li><strong>Previous message:</strong> <a href="4763.php">Stephan Kramer: "Re: [OMPI devel] Possible buffer overrun bug in opal_free_list_grow, called by MPI::Init"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
