...
?>
<!-- received="Thu Jun 12 10:12:52 2008" -->
<!-- isoreceived="20080612141252" -->
<!-- sent="Thu, 12 Jun 2008 09:12:41 -0500" -->
<!-- isosent="20080612141241" -->
<!-- name="Brad Benton" -->
<!-- email="bradford.benton_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Memory hooks change testing" -->
<!-- id="44079e5f0806120712m576abe1fk764b9c4a32396295_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2008-06-12 10:12:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4125.php">Lenny Verkhovsky: "Re: [OMPI devel] SM BTL NUMA awareness patches"</a>
<li><strong>Previous message:</strong> <a href="4123.php">Rolf vandeVaart: "Re: [OMPI devel] Pallas fails"</a>
<li><strong>In reply to:</strong> <a href="4120.php">Brian W. Barrett: "Re: [OMPI devel] Memory hooks change testing"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4126.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Memory hooks change testing"</a>
<li><strong>Reply:</strong> <a href="4126.php">Pavel Shamis (Pasha): "Re: [OMPI devel] Memory hooks change testing"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Brian,
<br>
<p>This is working smoothly now:  both the configuration/build and execution.
<br>
So,
<br>
...
<p>--brad
<br>
<p><p><p>On Wed, Jun 11, 2008 at 4:50 PM, Brian W. Barrett &lt;brbarret_at_[hidden]&gt;
<br>
wrote:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-4124/attachment">attachment</a>
</ul>
