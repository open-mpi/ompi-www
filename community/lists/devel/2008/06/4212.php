...
?>
<!-- received="Mon Jun 23 15:44:40 2008" -->
<!-- isoreceived="20080623194440" -->
<!-- sent="Mon, 23 Jun 2008 15:44:32 -0400 (EDT)" -->
<!-- isosent="20080623194432" -->
<!-- name="Brian W. Barrett" -->
<!-- email="brbarret_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] PML selection logic" -->
<!-- id="Pine.LNX.4.64.0806231544220.14475_at_marvin.we-be-smart.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="C485589B.DF5D%rhc_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-06-23 15:44:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4213.php">Shipman, Galen M.: "Re: [OMPI devel] PML selection logic"</a>
<li><strong>Previous message:</strong> <a href="4211.php">Ralph H Castain: "Re: [OMPI devel] PML selection logic"</a>
<li><strong>In reply to:</strong> <a href="4211.php">Ralph H Castain: "Re: [OMPI devel] PML selection logic"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4213.php">Shipman, Galen M.: "Re: [OMPI devel] PML selection logic"</a>
<li><strong>Reply:</strong> <a href="4213.php">Shipman, Galen M.: "Re: [OMPI devel] PML selection logic"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Brian
<br>
<p>On Mon, 23 Jun 2008, Ralph H Castain wrote:
<br>
<p><span class="quotelev1">&gt; Okay, so let's explore an alternative that preserves the support you are
</span><br>
<span class="quotelev1">&gt; seeking for the &quot;ignorant user&quot;, but doesn't penalize everyone else. What we
</span><br>
...
<span class="quotelev1">&gt; 2. if it is not provided, then only rank=0 inserts the data. All other procs
</span><br>
<span class="quotelev1">&gt; simply check their own selection against the one given by rank=0
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Now, if a knowledgeable user or sys admin specifies what to use for their
</span><br>
<span class="quotelev1">&gt; system, we won't penalize their startup time. A user who doesn't know what
</span><br>
<span class="quotelev1">&gt; to do gets to run, albeit less scalably on startup.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Looking forward from there, we can look to a day where failing to initialize
</span><br>
<span class="quotelev1">&gt; something that exists on the system could be detected in some other fashion,
</span><br>
...
<span class="quotelev2">&gt;&gt; The problem is that we default to OB1, but that's not the right choice for
</span><br>
...
<span class="quotelev2">&gt;&gt; MPI, starts running, gets horrible performance, bad mouths Open MPI, and
</span><br>
<span class="quotelev2">&gt;&gt; now we're in that game again.  Yeah, the sys admin should know what to do,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #1 is not adequate, IMHO, as it forces us to -always- do a modex. It seems
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to me that a simpler solution to what you describe is for the user to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; specify -mca pml ob1, or -mca pml cm. If the latter, then you could deal
</span><br>
<span class="quotelev3">&gt;&gt;&gt; with the failed-to-initialize problem cleanly by having the proc directly
</span><br>
<span class="quotelev3">&gt;&gt;&gt; abort.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Again, sometimes I think we attempt to automate too many things. This seems
</span><br>
<span class="quotelev3">&gt;&gt;&gt; like a pretty clear case where you know what you want - the sys admin, if
</span><br>
<span class="quotelev3">&gt;&gt;&gt; nobody else, can certainly set that mca param in the default param file!
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Otherwise, it seems to me that you are relying on the modex to detect that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; your proc failed to init the correct subsystem. I hate to force a modex just
</span><br>
<span class="quotelev3">&gt;&gt;&gt; for that - if so, then perhaps this could again be a settable option to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; avoid requiring non-scalable behavior for those of us who want scalability?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The selection code was added because frequently high speed interconnects
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; fail to initialize properly due to random stuff happening (yes, that's a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; horrible statement, but true).  We ran into a situation with some really
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; flaky machines where most of the processes would chose CM, but a couple
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; would fail to initialize the MTL and therefore chose OB1.  This lead to a
</span><br>
