...
?>
<!-- received="Mon Jun 23 15:42:02 2008" -->
<!-- isoreceived="20080623194202" -->
<!-- sent="Mon, 23 Jun 2008 13:41:47 -0600" -->
<!-- isosent="20080623194147" -->
<!-- name="Ralph H Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] PML selection logic" -->
<!-- id="C485589B.DF5D%rhc_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="Pine.LNX.4.64.0806231530000.14475_at_marvin.we-be-smart.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-06-23 15:41:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4212.php">Brian W. Barrett: "Re: [OMPI devel] PML selection logic"</a>
<li><strong>Previous message:</strong> <a href="4210.php">Brian W. Barrett: "Re: [OMPI devel] PML selection logic"</a>
<li><strong>In reply to:</strong> <a href="4210.php">Brian W. Barrett: "Re: [OMPI devel] PML selection logic"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4212.php">Brian W. Barrett: "Re: [OMPI devel] PML selection logic"</a>
<li><strong>Reply:</strong> <a href="4212.php">Brian W. Barrett: "Re: [OMPI devel] PML selection logic"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>1. if -mca plm xyz is provided, then no modex data is added
<br>
<p>2. if it is not provided, then only rank=0 inserts the data. All other procs
<br>
simply check their own selection against the one given by rank=0
<br>
<p>Now, if a knowledgeable user or sys admin specifies what to use for their
<br>
...
<br>
<p>Looking forward from there, we can look to a day where failing to initialize
<br>
...
&nbsp;
<br>
<p><p>On 6/23/08 1:31 PM, &quot;Brian W. Barrett&quot; &lt;brbarret_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; The problem is that we default to OB1, but that's not the right choice for
</span><br>
<span class="quotelev1">&gt; some platforms (like Pathscale / PSM), where there's a huge performance
</span><br>
<span class="quotelev1">&gt; hit for using OB1.  So we run into a situation where user installs Open
</span><br>
<span class="quotelev1">&gt; MPI, starts running, gets horrible performance, bad mouths Open MPI, and
</span><br>
<span class="quotelev1">&gt; now we're in that game again.  Yeah, the sys admin should know what to do,
</span><br>
...
<span class="quotelev2">&gt;&gt; #1 is not adequate, IMHO, as it forces us to -always- do a modex. It seems
</span><br>
<span class="quotelev2">&gt;&gt; to me that a simpler solution to what you describe is for the user to
</span><br>
<span class="quotelev2">&gt;&gt; specify -mca pml ob1, or -mca pml cm. If the latter, then you could deal
</span><br>
<span class="quotelev2">&gt;&gt; with the failed-to-initialize problem cleanly by having the proc directly
</span><br>
<span class="quotelev2">&gt;&gt; abort.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Again, sometimes I think we attempt to automate too many things. This seems
</span><br>
<span class="quotelev2">&gt;&gt; like a pretty clear case where you know what you want - the sys admin, if
</span><br>
<span class="quotelev2">&gt;&gt; nobody else, can certainly set that mca param in the default param file!
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Otherwise, it seems to me that you are relying on the modex to detect that
</span><br>
<span class="quotelev2">&gt;&gt; your proc failed to init the correct subsystem. I hate to force a modex just
</span><br>
<span class="quotelev2">&gt;&gt; for that - if so, then perhaps this could again be a settable option to
</span><br>
<span class="quotelev2">&gt;&gt; avoid requiring non-scalable behavior for those of us who want scalability?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On 6/23/08 1:21 PM, &quot;Brian W. Barrett&quot; &lt;brbarret_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The selection code was added because frequently high speed interconnects
</span><br>
<span class="quotelev3">&gt;&gt;&gt; fail to initialize properly due to random stuff happening (yes, that's a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; horrible statement, but true).  We ran into a situation with some really
</span><br>
<span class="quotelev3">&gt;&gt;&gt; flaky machines where most of the processes would chose CM, but a couple
</span><br>
<span class="quotelev3">&gt;&gt;&gt; would fail to initialize the MTL and therefore chose OB1.  This lead to a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; hang situation, which is the worst of the worst.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I think #1 is adequate, although it doesn't handle spawn particularly
</span><br>
<span class="quotelev3">&gt;&gt;&gt; well.  And spawn is generally used in environments where such network
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; installations, could you give me a brief understanding of this eventual PML
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; selection logic? It would help to hear an example of how and why different
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; procs could get different answers - and why we would want to allow them to
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 6/23/08 11:59 AM, &quot;Aur&#233;lien Bouteiller&quot; &lt;bouteill_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; The first approach sounds fair enough to me. We should avoid 2 and 3
</span><br>
