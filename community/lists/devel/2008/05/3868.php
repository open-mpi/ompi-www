...
?>
<!-- received="Thu May  8 19:41:56 2008" -->
<!-- isoreceived="20080508234156" -->
<!-- sent="Thu, 8 May 2008 19:41:58 -0400" -->
<!-- isosent="20080508234158" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [RFC] mca_base_select()" -->
<!-- id="BE984526-6735-4EC0-A8AE-F12ABD606C61_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="482378DA.5040402_at_Sun.COM" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-05-08 19:41:58
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3869.php">Caciano Machado: "[OMPI devel] Recv from MTL module hanging on pml_cm_recv.c:mca_pml_cm_recv()"</a>
<li><strong>Previous message:</strong> <a href="3867.php">Jeff Squyres: "Re: [OMPI devel] &quot;__printf__&quot; attribute"</a>
<li><strong>In reply to:</strong> <a href="3864.php">Pak Lui: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3870.php">Pak Lui: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<li><strong>Reply:</strong> <a href="3870.php">Pak Lui: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>-- Josh
<br>
<p>On May 8, 2008, at 6:04 PM, Pak Lui wrote:
<br>
<p><span class="quotelev1">&gt; I think I have a problem but I am not sure. I used to be able to  
</span><br>
<span class="quotelev1">&gt; use the
</span><br>
<span class="quotelev1">&gt; circumflex (^) to switch between the gridengine launcher and the ssh
</span><br>
<span class="quotelev1">&gt; launchers by doing something like this, e.g. -mca plm ^gridengine, to
</span><br>
<span class="quotelev1">&gt; exclude some of the components plm (and also in ras). It doesn't seem
</span><br>
<span class="quotelev1">&gt; like the 'negate' is in mca_base_component anymore. I guess I just  
</span><br>
