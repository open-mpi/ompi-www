...
?>
<!-- received="Tue May  6 14:56:15 2008" -->
<!-- isoreceived="20080506185615" -->
<!-- sent="Tue, 06 May 2008 12:56:06 -0600" -->
<!-- isosent="20080506185606" -->
<!-- name="Ralph H Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [RFC] mca_base_select()" -->
<!-- id="C44605E6.D5E8%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-05-06 14:56:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3848.php">Josh Hursey: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<li><strong>Previous message:</strong> <a href="3846.php">Josh Hursey: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<li><strong>In reply to:</strong> <a href="3846.php">Josh Hursey: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3848.php">Josh Hursey: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<li><strong>Reply:</strong> <a href="3848.php">Josh Hursey: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Open MPI developer):
<br>
<p>&nbsp;&nbsp;orte_filem_base_select failed
<br>
&nbsp;&nbsp;--&gt; Returned value Error (-1) instead of ORTE_SUCCESS
<br>
<p>--------------------------------------------------------------------------
<br>
<p>After looking at the source code for filem_select, I can run just fine if I
<br>
...
selectable?
<br>
<p>Is that generally true, or is your filem framework the exception? I think
<br>
...
<p>Ralph
<br>
<p><p><p>On 5/6/08 12:09 PM, &quot;Josh Hursey&quot; &lt;jjhursey_at_[hidden]&gt; wrote:
<br>
