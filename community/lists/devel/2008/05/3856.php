<?
$subject_val = "Re: [OMPI devel] [OMPI users] OpenMPI Internals &amp; Static-Analysis.";
...
<!-- subject="Re: [OMPI devel] [OMPI users] OpenMPI Internals &amp;amp; Static-Analysis." -->
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI devel] [OMPI users] OpenMPI Internals &amp; Static-Analysis.<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-05-08 07:24:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3857.php">Jeff Squyres: "Re: [OMPI devel] [RFC] mca_base_open() NULL"</a>
<li><strong>Previous message:</strong> <a href="3855.php">Mukesh K Srivastava: "[OMPI devel] OpenMPI Internals &amp; Static-Analysis."</a>
<li><strong>In reply to:</strong> <a href="3855.php">Mukesh K Srivastava: "[OMPI devel] OpenMPI Internals &amp; Static-Analysis."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3863.php">Mukesh K Srivastava: "Re: [OMPI devel] [OMPI users] OpenMPI Internals &amp; Static-Analysis."</a>
<li><strong>Maybe reply:</strong> <a href="3863.php">Mukesh K Srivastava: "Re: [OMPI devel] [OMPI users] OpenMPI Internals &amp; Static-Analysis."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
