...
?>
<!-- received="Fri May  9 10:41:51 2008" -->
<!-- isoreceived="20080509144151" -->
<!-- sent="Fri, 09 May 2008 08:41:33 -0600" -->
<!-- isosent="20080509144133" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] [RFC] mca_base_select()" -->
<!-- id="C449BEBD.51B7%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="4823A323.9090303_at_sun.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-05-09 10:41:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3878.php">Josh Hursey: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<li><strong>Previous message:</strong> <a href="3876.php">Caciano Machado: "Re: [OMPI devel] Recv from MTL module hanging on pml_cm_recv.c:mca_pml_cm_recv()"</a>
<li><strong>In reply to:</strong> <a href="3870.php">Pak Lui: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3878.php">Josh Hursey: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<li><strong>Reply:</strong> <a href="3878.php">Josh Hursey: "Re: [OMPI devel] [RFC] mca_base_select()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>We have several frameworks where we have components that are only allowed be
<br>
...
<br>
<p>The new select logic will not allow a negative priority to be selected, even
<br>
if the user specifically requested that component.
<br>
<p>If we set the priority to be 0, then the system will allow the component to
<br>
be automatically selected. This is not allowed as it can lead to bad
<br>
behavior.
<br>
<p>So what we need the select system to do is say &quot;if someone specified a
<br>
specific component, don't worry about the returned priority - just use it&quot;
<br>
<p>Josh: could you please modify this?
<br>
<p>Thanks!
<br>
Ralph
<br>
<p><p><p>On 5/8/08 7:04 PM, &quot;Pak Lui&quot; &lt;Pak.Lui_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Thanks very much Josh! Will try it out soon.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I think I have a problem but I am not sure. I used to be able to use the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; circumflex (^) to switch between the gridengine launcher and the ssh
</span><br>
<span class="quotelev3">&gt;&gt;&gt; launchers by doing something like this, e.g. -mca plm ^gridengine, to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; exclude some of the components plm (and also in ras). It doesn't seem
</span><br>
<span class="quotelev3">&gt;&gt;&gt; like the 'negate' is in mca_base_component anymore. I guess I just have
</span><br>
