...
<!-- received="Tue Jun 12 19:38:38 2007" -->
<!-- isoreceived="20070612233838" -->
<!-- sent="Wed, 13 Jun 2007 01:38:26 +0200" -->
<!-- isosent="20070612233826" -->
<!-- name="Rainer Keller" -->
<!-- email="keller_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Bug with MPI_TYPE_CREATE_STRUCT, MPI_BOTTOM and MPI_BCAST in fortran" -->
<!-- id="200706130138.27084.keller_at_hlrs.de" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2007-06-12 19:38:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1671.php">Ralph Castain: "[OMPI devel] Fast ORTE"</a>
<li><strong>Previous message:</strong> <a href="1669.php">George Bosilca: "Re: [OMPI devel] Bug with MPI_TYPE_CREATE_STRUCT, MPI_BOTTOM and MPI_BCAST in fortran"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1672.php">Daniel Spångberg: "Re: [OMPI devel] Bug with MPI_TYPE_CREATE_STRUCT, MPI_BOTTOM and MPI_BCAST in fortran"</a>
<li><strong>Reply:</strong> <a href="1672.php">Daniel Spångberg: "Re: [OMPI devel] Bug with MPI_TYPE_CREATE_STRUCT, MPI_BOTTOM and MPI_BCAST in fortran"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
MPI_BOTTOM in the fortran interface should be using OMPI_ADDR to convert for 
<br>
the C-interface....
<br>
<p>Aaah, I see George has a similar commit -- possibly, we need to sync.
<br>
Please see the code attached, compared r15030, it adapts the macros to use 
<br>
OMPI_F2C_...
<br>
<p>Thanks,
...
Rainer
<br>
<p>On Tuesday 12 June 2007 23:15, Daniel Sp&#229;ngberg wrote:
<br>
...
<span class="quotelev1">&gt; /opt/openmpi-1.2.1-gcc4/lib/openmpi/mca_pml_ob1.so(mca_pml_ob1_send_request
</span><br>
<span class="quotelev1">&gt;_start_copy+0x24c) [0x2a982851dc]
</span><br>
...
<span class="quotelev1">&gt; /opt/openmpi-1.2.1-gcc4/lib/openmpi/mca_coll_tuned.so(ompi_coll_tuned_bcast
</span><br>
<span class="quotelev1">&gt;_intra_generic+0x354) [0x2a98ac08b4]
</span><br>
<span class="quotelev1">&gt; [auchentoshan:21021] [ 6]
</span><br>
<span class="quotelev1">&gt; /opt/openmpi-1.2.1-gcc4/lib/openmpi/mca_coll_tuned.so(ompi_coll_tuned_bcast
</span><br>
<span class="quotelev1">&gt;_intra_binomial+0xc8) [0x2a98ac0bd8]
</span><br>
...
<hr>
<ul>
<li>text/x-diff attachment: <a href="http://www.open-mpi.org/community/lists/devel/att-1670/ompi_fortran_bottom_fix-2007.06.13.patch">ompi_fortran_bottom_fix-2007.06.13.patch</a>
</ul>
<!-- attachment="ompi_fortran_bottom_fix-2007.06.13.patch" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
