...
<!-- subject="Re: [OMPI devel] [MTT users] IBM thread tests" -->
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1721.php">Jeff Squyres: "[OMPI devel] 1.2.3rc1 is released"</a>
<li><strong>Previous message:</strong> <a href="1719.php">Galen Shipman: "Re: [OMPI devel] Problem with openib on demand connection bring up."</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
