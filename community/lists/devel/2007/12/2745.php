...
?>
<!-- received="Thu Dec  6 10:06:40 2007" -->
<!-- isoreceived="20071206150640" -->
<!-- sent="Thu, 06 Dec 2007 10:06:34 -0500" -->
<!-- isosent="20071206150634" -->
<!-- name="Shipman, Galen M." -->
<!-- email="gshipman_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] RTE Issue IV: RTE/MPI relative modex responsibilities" -->
<!-- id="C37D7A2A.1F7A%gshipman_at_ornl.gov" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2007-12-06 10:06:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2746.php">Tim Prins: "Re: [OMPI devel] opal_condition_wait"</a>
<li><strong>Previous message:</strong> <a href="2744.php">Jeff Squyres: "Re: [OMPI devel] RTE Issue IV: RTE/MPI relative modex responsibilities"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2749.php">Ralph H Castain: "Re: [OMPI devel] RTE Issue IV: RTE/MPI relative modex responsibilities"</a>
<li><strong>Reply:</strong> <a href="2749.php">Ralph H Castain: "Re: [OMPI devel] RTE Issue IV: RTE/MPI relative modex responsibilities"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev2">&gt;&gt; Do we really need a complete node map? A far as I can tell, it looks
</span><br>
<span class="quotelev2">&gt;&gt; like the MPI layer only needs a list of local processes. So maybe it
</span><br>
<span class="quotelev2">&gt;&gt; would be better to forget about the node ids at the mpi layer and just
</span><br>
<span class="quotelev2">&gt;&gt; return the local procs.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I agree, though I don't think we want a parallel list of procs. We just need
</span><br>
<span class="quotelev1">&gt; to set the &quot;local&quot; flag in the existing ompi_proc_t structures.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<p>Having a parallel list of procs makes perfect sense. That way ORTE can store
<br>
...
<br>
<p>Having a global map makes sense, particularly for numerous communication
<br>
...
everyone else.
<br>
<p><p><span class="quotelev1">&gt; One option is for the RTE to just pass in an enviro variable with a
</span><br>
