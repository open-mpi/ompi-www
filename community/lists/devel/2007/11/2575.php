...
?>
<!-- received="Wed Nov  7 23:20:02 2007" -->
<!-- isoreceived="20071108042002" -->
<!-- sent="Wed, 07 Nov 2007 23:19:48 -0400" -->
<!-- isosent="20071108031948" -->
<!-- name="Richard Graham" -->
<!-- email="rlgraham_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] collective problems" -->
<!-- id="C357F894.10654%rlgraham_at_ornl.gov" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2007-11-07 22:19:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2576.php">Patrick Geoffray: "Re: [OMPI devel] collective problems"</a>
<li><strong>Previous message:</strong> <a href="2574.php">Brian Barrett: "Re: [OMPI devel] collective problems"</a>
<li><strong>In reply to:</strong> <a href="2574.php">Brian Barrett: "Re: [OMPI devel] collective problems"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2576.php">Patrick Geoffray: "Re: [OMPI devel] collective problems"</a>
<li><strong>Reply:</strong> <a href="2576.php">Patrick Geoffray: "Re: [OMPI devel] collective problems"</a>
<li><strong>Reply:</strong> <a href="2577.php">Shipman, Galen M.: "Re: [OMPI devel] collective problems"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Rich
<br>
<p><p>On 11/8/07 12:07 AM, &quot;Brian Barrett&quot; &lt;brbarret_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; As it stands today, the problem is that we can inject things into the
</span><br>
<span class="quotelev1">&gt; BTL successfully that are not injected into the NIC (due to software
</span><br>
<span class="quotelev1">&gt; flow control).  Once a message is injected into the BTL, the PML marks
</span><br>
<span class="quotelev1">&gt; completion on the MPI request.  If it was a blocking send that got
</span><br>
<span class="quotelev1">&gt; marked as complete, but the message isn't injected into the NIC/NIC
</span><br>
<span class="quotelev1">&gt; library, and the user doesn't re-enter the MPI library for a
</span><br>
<span class="quotelev1">&gt; considerable amount of time, then we have a problem.
</span><br>
