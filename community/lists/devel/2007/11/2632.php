...
?>
<!-- received="Mon Nov 19 09:01:28 2007" -->
<!-- isoreceived="20071119140128" -->
<!-- sent="Mon, 19 Nov 2007 09:01:19 -0500" -->
<!-- isosent="20071119140119" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI devel] Multiworld MCA parameter values broken" -->
<!-- id="53FA9B3C-F7BA-48D8-A217-6226746EE5A6_at_cisco.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="C366E00A.B57F%rhc_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-11-19 09:01:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2633.php">Ralph H Castain: "Re: [OMPI devel] Multiworld MCA parameter values broken"</a>
<li><strong>Previous message:</strong> <a href="2631.php">Ralph H Castain: "Re: [OMPI devel] Multiworld MCA parameter values broken"</a>
<li><strong>In reply to:</strong> <a href="2631.php">Ralph H Castain: "Re: [OMPI devel] Multiworld MCA parameter values broken"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2633.php">Ralph H Castain: "Re: [OMPI devel] Multiworld MCA parameter values broken"</a>
<li><strong>Reply:</strong> <a href="2633.php">Ralph H Castain: "Re: [OMPI devel] Multiworld MCA parameter values broken"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>It should obey all quoting from shells, etc.  I.e., it shouldn't care  
<br>
...
<br>
<p>Is it doing something wrong?
<br>
<p><p><p>On Nov 19, 2007, at 8:39 AM, Ralph H Castain wrote:
<br>
<p><span class="quotelev1">&gt; I'm not sure it is really necessary - the problem is solely within
</span><br>
<span class="quotelev1">&gt; opal_cmd_line_parse and (if someone can parse that code ;-)) is  
</span><br>
<span class="quotelev1">&gt; truly simple
</span><br>
<span class="quotelev1">&gt; to fix. The overly long cmd line issue is due to a bug that Josh was  
</span><br>
...
<span class="quotelev2">&gt;&gt; processes, such as via stdin (or any file descriptor)?  I.e., during
</span><br>
<span class="quotelev2">&gt;&gt; the command line parsing to check for command line MCA params,  
</span><br>
<span class="quotelev2">&gt;&gt; perhaps
</span><br>
<span class="quotelev2">&gt;&gt; a new argument could be introduced: -mcauri &lt;uri&gt;, where &lt;uri&gt; could
</span><br>
...
<span class="quotelev2">&gt;&gt; - rml://...rml contact info...: read in the MCA params via the RML
</span><br>
<span class="quotelev2">&gt;&gt; (although I assume that reading via the RML would be *waaaay* to late
</span><br>
...
<span class="quotelev2">&gt;&gt; - ip://ipaddress:port: open a socket back and read the MCA params in
</span><br>
<span class="quotelev2">&gt;&gt; over a socket.  This could have some scalability issues...?  But who
</span><br>
<span class="quotelev2">&gt;&gt; knows; it could be tied into the hierarchical startup such that we
</span><br>
<span class="quotelev2">&gt;&gt; wouldn't have to have an all-to-one connection scheme.  Certainly it
</span><br>
<span class="quotelev2">&gt;&gt; would cause scalability problems when paired with today's all-to-one
</span><br>
<span class="quotelev2">&gt;&gt; RML connection scheme for the OOB.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I'm not sure that the rml: and ip: schemes are worthwhile.  Maybe a
</span><br>
<span class="quotelev2">&gt;&gt; file://stdin kind of approach could work?  Or perhaps some other kind
</span><br>
<span class="quotelev2">&gt;&gt; of URI/IPC...?  (I really haven't thought through the issues -- this
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; It deals with some of these issues and explains the boundaries of  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; problem. As for what a string param can contain, I have no opinion.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I only
</span><br>
<span class="quotelev3">&gt;&gt;&gt; note that it must handle special characters such as ';', '/', etc.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The alias option you presented does not work. I think we do some
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; weird
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; things to find the absolute path for ssh, instead of just issuing  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; could quote all the param values, and change the parser to remove  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; So I guess there are 2 questions that need to be answered before a
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 2. Which mca parameters should be forwarded? Should it be just the
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; various mca params to get to the orteds to control their behavior.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; The only
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; way to resolve that problem was to pass the params via the command
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I have no objection to a more general fix. Like I said in my note,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; though,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the general fix will take a larger effort. If someone is willing
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; to do so,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; that is fine with me - I was only offering solutions that would
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; fill the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; interim time as I haven't heard anyone step up to say they would
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Please feel free to jump in and volunteer! ;-) I'm willing to put
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the quotes
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; around things if you will fix the mca cmd line parser to cleanly
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; string mca params to have spaces (as far as I understand it). So
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; There are several fixes to this problem - ranging in order from
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 1. just alias &quot;ssh&quot; to be &quot;ssh -Y&quot; and run without setting the
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mca param.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; It won't affect anything on the backend because the daemon/procs
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2. include &quot;pls_rsh_agent&quot; in the array of mca params not to be
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; passed to
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; the orted in orte/mca/pls/base/pls_base_general_support_fns.c,  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; orte_pls_base_orted_append_basic_args function. This would fix
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; the specific
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; problem cited here, but I admit that listing every such param by
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 3. we could easily detect that a &quot;problem&quot; character was in the
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mca param
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; value when we add it to the orted's argv, and then put &quot;&quot; around
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; it. The
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; problem, however, is that the mca param parser on the far end
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Will crash and burn, because the value &quot;ssh -Y&quot; is being stored
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; into the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; argv orted_cmd_line in orterun.c:1506. This is then added to
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; /usr/bin/ssh -Y odin004  PATH=/san/homedirs/tprins/usr/rsl/bin:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; export LD_LIBRARY_PATH ; /san/homedirs/tprins/usr/rsl/bin/orted
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 129.79.240.100:40907;tcp6://2001:18e8:2:240:2e0:81ff:fe2d:21a0
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; /u/tprins/usr/rsl/share/openmpi/amca-param-sets:/san/homedirs/
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; tprins/rsl/
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; examp les
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -mca mca_base_param_file_path_force /san/homedirs/tprins/rsl/
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; examples
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Notice that in this command we now have &quot;-mca pls_rsh_agent ssh
</span><br>
