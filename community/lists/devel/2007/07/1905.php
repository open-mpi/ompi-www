...
<!-- subject="[OMPI devel] MTT OMPI results" -->
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1906.php">Matthew Moskewicz: "Re: [OMPI devel] devel Digest, Vol 801, Issue 1"</a>
<li><strong>Previous message:</strong> <a href="1904.php">Brian Barrett: "[OMPI devel] RML/OOB change heads up"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
