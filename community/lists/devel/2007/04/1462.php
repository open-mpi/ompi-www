...
<!-- subject="[OMPI devel] Checkpoint/Restart Process Fault Tolerance Support" -->
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1463.php">Adrian Knoth: "[OMPI devel] sockaddr* vs. sockaddr_storage*"</a>
<li><strong>Previous message:</strong> <a href="1461.php">Aurelien Bouteiller: "Re: [OMPI devel] Fancy ORTE/MPIRUN bugs"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
