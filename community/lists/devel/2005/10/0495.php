...
<!-- received="Tue Oct 25 10:12:31 2005" -->
<!-- isoreceived="20051025151231" -->
<!-- sent="Tue, 25 Oct 2005 10:12:29 -0500" -->
<!-- isosent="20051025151229" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re:  MPI_Barrier in Netpipe causes segfault" -->
<!-- id="435E4B5D.2000902_at_open-mpi.org" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2005-10-25 10:12:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0496.php">Gleb Natapov: "[PATCH] fix ompi_free_list_grow"</a>
<li><strong>Previous message:</strong> <a href="0494.php">Jeff Squyres: "Re:  MPI_Barrier in Netpipe causes segfault"</a>
<li><strong>In reply to:</strong> <a href="0491.php">Troy Benjegerdes: "MPI_Barrier in Netpipe causes segfault"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0501.php">Brian Barrett: "Re:  MPI_Barrier in Netpipe causes segfault"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Troy --
<br>
<p>We've managed to replicate this problem and are looking into it.  Thanks 
<br>
for reporting it!
<br>
