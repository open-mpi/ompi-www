...
<!-- received="Thu Aug 18 11:18:17 2005" -->
<!-- isoreceived="20050818161817" -->
<!-- sent="Thu, 18 Aug 2005 10:18:13 -0600" -->
<!-- isosent="20050818161813" -->
<!-- name="Tim S. Woodall" -->
<!-- email="twoodall_at_[hidden]" -->
<!-- subject="Re:  OMPI 32bit on a 64bit Linux box" -->
<!-- id="4304B4C5.4010402_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="200508181745.05280.Keller_at_hlrs.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2005-08-18 11:18:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0202.php">Brian Barrett: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>Previous message:</strong> <a href="0200.php">Rainer Keller: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>In reply to:</strong> <a href="0200.php">Rainer Keller: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0202.php">Brian Barrett: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>Reply:</strong> <a href="0202.php">Brian Barrett: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Brian,
<br>
<p>Wasn't the introduction of sds part of your changes for redstorm? Any ideas
<br>
...
<span class="quotelev1">&gt;see the &quot;same&quot; (well probably not exactly same) thing here in Opteron with 
</span><br>
...
<span class="quotelev1">&gt;#3  0x00000000400148f5 in orte_init () at ../../../orte/runtime/orte_init.c:46
</span><br>
...
<span class="quotelev2">&gt;&gt;FYI, this only happens when I let OMPI compile 64bit on Linux.  When I
</span><br>
<span class="quotelev2">&gt;&gt;throw in there CFLAGS=FFLAGS=CXXFLAGS=-m32 orted, my myriad of test
</span><br>
<span class="quotelev2">&gt;&gt;codes, mpirun, registry subscription codes, and JNI all work like a champ.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;I'll try to reproduce this sometime this week - but I'm pretty swamped.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;To expand on this further, orte_init() seg faults on both bluesteel
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;#1  0x000000000045997d in orte_init_stage1 () at orte_init_stage1.c:419
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;#2  0x00000000004156a7 in orte_system_init () at orte_system_init.c:38
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;1: no orted started (meaning the MPIrun or registry programs will
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;start one by themselves) causes those programs to lock up.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;2: starting orted by hand (trying to get these programs to connect to
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;So I dropped an .ompi_ignore into that directory, reconfigured, and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;compile worked (yay!).
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;However, not a lot of progress: mpirun locks up, all my registry test
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;programs lock up as well.  If I start the orted by hand, then any of my
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;orte_init_stage1.c:419 #2  0x00000000004155cf in orte_system_init ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;at orte_system_init.c:38 #3  0x00000000004150ef in orte_init () at
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;Here's an example of me trying something a little more complicated
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;(which I believe locks up for the same reason - something borked with
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;ndebard_at_sparkplug:~/ompi-test&gt; export OMPI_MCA_ptl_base_exclude=sm
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;and set these envvars like we need to use Greg's bproc, without the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;---x--x--x root     root    ndebard_at_sparkplug:~/ompi-test&gt; env | grep
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;ndebard_at_sparkplug:~/ompi-test&gt; ls /tmp/openmpi-sessions-ndebard*
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;/bin/ls: /tmp/openmpi-sessions-ndebard*: No such file or directory
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;                
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;I'm not sure why this is even building... Is someone working on this?
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;today yet I can't get it to compile.  Am I out here in limbo on this
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;or
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;are others in the same boat?  The errors I'm seeing are about some
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;Back from training and trying to test this but now OMPI doesn't
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;We've got a 64bit Linux (SUSE) box here.  For a variety of
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;reasons (Java, JNI, linking in with OMPI libraries, etc which I
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;won't get into)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;I need to compile OMPI 32 bit (or get 64bit versions of a lot of
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;other
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;libraries).
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;I get various compile errors when I try different things, but
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;This goes on and on and on actually.  And the 'is incompatible
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;with
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;i386:x86-64 output' looks to be repeated for every line before
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;I don't think anyone has tried to build 32 bit on an Opteron,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;which is the cause of the problems...
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;I think I know how to fix this, but won't happen until later in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;the weekend.  I can't think of a good workaround until then. 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;Well, one possibility is to set the target like you were doing
</span><br>
