...
<!-- received="Fri Aug 19 05:16:54 2005" -->
<!-- isoreceived="20050819101654" -->
<!-- sent="Fri, 19 Aug 2005 12:16:43 +0200" -->
<!-- isosent="20050819101643" -->
<!-- name="Rainer Keller" -->
<!-- email="Keller_at_[hidden]" -->
<!-- subject="Re:  OMPI 32bit on a 64bit Linux box" -->
<!-- id="200508191216.43359.Keller_at_hlrs.de" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="9CCF5984-9854-439A-B88D-D8DFB8B1263A_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2005-08-19 05:16:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0214.php">Tim S. Woodall: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>Previous message:</strong> <a href="0212.php">Josh Hursey: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>In reply to:</strong> <a href="0207.php">Brian Barrett: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0212.php">Josh Hursey: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; Rainer's problem looks different than the one in orte_init_stage1.
</span><br>
<span class="quotelev1">&gt; ompi_info reports that he doesn't have any sds components built.
</span><br>
You're right, also Your patch is right, as far as I can tell -- had a similar 
<br>
check, but wasn't brave enough to checkin ,-]
<br>
<p>The components were not build...
<br>
...
<p>Fixed thusly.
<br>
<p>Will check the rest of the build.
<br>
<p>Thanks,
<br>
Rainer
<br>
<p><p><span class="quotelev1">&gt; Actually, it doesn't list *any* orte components, which seems broken
</span><br>
<span class="quotelev1">&gt; to me.  I should pretty print an error message and abort if an sds
</span><br>
<span class="quotelev1">&gt; isn't found, but it looks like the bigger problem is a lack of
</span><br>
<span class="quotelev1">&gt; components in his install.
</span><br>
...
<span class="quotelev2">&gt; &gt; the rmgr - and only initialized on the seed. The proxy rmgr is
</span><br>
<span class="quotelev2">&gt; &gt; loaded when
</span><br>
<span class="quotelev2">&gt; &gt; a persistent daemon is available - and therefore the rds is not
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; #5  0x0000002a95c0c017 in __libc_start_main () from /lib64/
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; throw in there CFLAGS=FFLAGS=CXXFLAGS=-m32 orted, my myriad of
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; condition is that orted must be running first (which of
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; course we
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 16-25                              up              ---
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; x------
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ndebard  ndebard
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 26-27                              up              ---
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; x------
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -I../../../../include -I../../../../opal -I../../../../
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; and disable ROMIO.  Actually, you'll also need to
</span><br>
