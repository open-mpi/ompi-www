...
<!-- received="Tue Aug 16 15:16:22 2005" -->
<!-- isoreceived="20050816201622" -->
<!-- sent="Tue, 16 Aug 2005 14:16:19 -0600" -->
<!-- isosent="20050816201619" -->
<!-- name="Nathan DeBardeleben" -->
<!-- email="ndebard_at_[hidden]" -->
<!-- subject="Re:  OMPI 32bit on a 64bit Linux box" -->
<!-- id="43024993.7030808_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="430211FC.9080104_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2005-08-16 15:16:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0165.php">Tim S. Woodall: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>Previous message:</strong> <a href="0163.php">Gleb Natapov: "Re:  Memory registration question."</a>
<li><strong>In reply to:</strong> <a href="0157.php">Nathan DeBardeleben: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0165.php">Tim S. Woodall: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>Reply:</strong> <a href="0165.php">Tim S. Woodall: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt;Back from training and trying to test this but now OMPI doesn't compile 
</span><br>
...
<span class="quotelev2">&gt;&gt;make[4]: Leaving directory `/home/ndebard/ompi/orte/mca/ras/lsf_bproc'
</span><br>
...
<span class="quotelev2">&gt;&gt;--without-threads --prefix=/home/ndebard/local/ompi --with-devel-headers
</span><br>
<span class="quotelev2">&gt;&gt;    
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;I need to compile OMPI 32 bit (or get 64bit versions of a lot of other
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;libraries).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;I get various compile errors when I try different things, but first
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;This goes on and on and on actually.  And the 'is incompatible with
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;i386:x86-64 output' looks to be repeated for every line before this
</span><br>
