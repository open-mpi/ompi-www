...
<!-- received="Thu Aug 18 10:42:26 2005" -->
<!-- isoreceived="20050818154226" -->
<!-- sent="Thu, 18 Aug 2005 09:42:21 -0600" -->
<!-- isosent="20050818154221" -->
<!-- name="Nathan DeBardeleben" -->
<!-- email="ndebard_at_[hidden]" -->
<!-- subject="Re:  OMPI 32bit on a 64bit Linux box" -->
<!-- id="4304AC5D.6070404_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2005-08-18 10:42:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0200.php">Rainer Keller: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>Previous message:</strong> <a href="0198.php">Jeff Squyres: "Re:  ob1 -&gt; default?"</a>
<li><strong>In reply to:</strong> <a href="0196.php">Nathan DeBardeleben: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0200.php">Rainer Keller: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; [bluesteel]~/ompi-test &gt; gdb mpirun
</span><br>
...
<span class="quotelev1">&gt; (gdb) run -np 2 test-mpi
</span><br>
<span class="quotelev1">&gt; Starting program: /home/ndebard/local/ompi/bin/mpirun -np 2 test-mpi
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Program received signal SIGSEGV, Segmentation fault.
</span><br>
<span class="quotelev1">&gt; 0x00000000 in ?? ()
</span><br>
<span class="quotelev1">&gt; (gdb) where
</span><br>
<span class="quotelev1">&gt; #0  0x00000000 in ?? ()
</span><br>
<span class="quotelev1">&gt; #1  0x0809db81 in orte_init_stage1 () at orte_init_stage1.c:419
</span><br>
<span class="quotelev1">&gt; #2  0x0805d4bd in orte_system_init () at orte_system_init.c:38
</span><br>
<span class="quotelev1">&gt; #3  0x0805d144 in orte_init () at orte_init.c:46
</span><br>
<span class="quotelev1">&gt; #4  0x0805990b in main (argc=4, argv=0xffffd3c4) at orterun.c:291
</span><br>
<span class="quotelev1">&gt; (gdb) 
</span><br>
<p>If I look at the messages coming out of orted, I see:
<br>
<p><span class="quotelev1">&gt; [0,0,0]-[0,1,0] mca_oob_tcp_msg_recv: readv failed with errno=104
</span><br>
<span class="quotelev1">&gt; [0,0,0]-[0,2,0] mca_oob_tcp_msg_recv: readv failed with errno=104
</span><br>
<p>One for each line as I try and run mpirun.
<br>
<p>-- Nathan
<br>
Correspondence
...
<br>
<p><span class="quotelev1">&gt;FYI, this only happens when I let OMPI compile 64bit on Linux.  When I 
</span><br>
