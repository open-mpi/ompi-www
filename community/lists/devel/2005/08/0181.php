...
<!-- received="Wed Aug 17 12:18:43 2005" -->
<!-- isoreceived="20050817171843" -->
<!-- sent="Wed, 17 Aug 2005 11:18:39 -0600" -->
<!-- isosent="20050817171839" -->
<!-- name="Tim S. Woodall" -->
<!-- email="twoodall_at_[hidden]" -->
<!-- subject="Re:  OMPI 32bit on a 64bit Linux box" -->
<!-- id="4303716F.8030103_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="430362DE.70705_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2005-08-17 12:18:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0182.php">James W. Barker: "Autogen.sh errors"</a>
<li><strong>Previous message:</strong> <a href="0180.php">Jeff Squyres: "Re:  ompi_comm_size / ompi_comm_remote_size"</a>
<li><strong>In reply to:</strong> <a href="0179.php">Nathan DeBardeleben: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0196.php">Nathan DeBardeleben: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>Reply:</strong> <a href="0196.php">Nathan DeBardeleben: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Nathan,
<br>
<p>I'll try to reproduce this sometime this week - but I'm pretty swamped.
<br>
...
<span class="quotelev2">&gt;&gt;#1  0x000000000045997d in orte_init_stage1 () at orte_init_stage1.c:419
</span><br>
<span class="quotelev2">&gt;&gt;#2  0x00000000004156a7 in orte_system_init () at orte_system_init.c:38
</span><br>
...
<span class="quotelev2">&gt;&gt; 2: starting orted by hand (trying to get these programs to connect to 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;So I dropped an .ompi_ignore into that directory, reconfigured, and 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;compile worked (yay!).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;However, not a lot of progress: mpirun locks up, all my registry test 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;programs lock up as well.  If I start the orted by hand, then any of my 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;#1  0x00000000004598a5 in orte_init_stage1 () at orte_init_stage1.c:419
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;#2  0x00000000004155cf in orte_system_init () at orte_system_init.c:38
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;#3  0x00000000004150ef in orte_init () at orte_init.c:46
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;Here's an example of me trying something a little more complicated 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;(which I believe locks up for the same reason - something borked with 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;ndebard_at_sparkplug:~/ompi-test&gt; export OMPI_MCA_ptl_base_exclude=sm
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;and set these envvars like we need to use Greg's bproc, without the 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;---x--x--x root     root    ndebard_at_sparkplug:~/ompi-test&gt; env | grep 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;ndebard_at_sparkplug:~/ompi-test&gt; ls /tmp/openmpi-sessions-ndebard*
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;/bin/ls: /tmp/openmpi-sessions-ndebard*: No such file or directory
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;    
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;I'm not sure why this is even building... Is someone working on this?
</span><br>
