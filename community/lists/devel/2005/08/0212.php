...
<!-- received="Thu Aug 18 19:22:06 2005" -->
<!-- isoreceived="20050819002206" -->
<!-- sent="Thu, 18 Aug 2005 19:21:52 -0500" -->
<!-- isosent="20050819002152" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re:  OMPI 32bit on a 64bit Linux box" -->
<!-- id="8ffc9fac95d3f1769df8a34f6e638018_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2005-08-18 19:21:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0213.php">Rainer Keller: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>Previous message:</strong> <a href="0211.php">Brian Barrett: "Re:  Question on ROMIO"</a>
<li><strong>In reply to:</strong> <a href="0206.php">Tim S. Woodall: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0214.php">Tim S. Woodall: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<li><strong>Reply:</strong> <a href="0214.php">Tim S. Woodall: "Re:  OMPI 32bit on a 64bit Linux box"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hey all,
<br>
<p>Sorry for my lag on this thread, I'm still settling back into  
<br>
Bloomington and catching up on email traffic.
<br>
<p>This is certainly my fault WRT the addition of the RDS call to  
<br>
orte_init_stage1(). I never tested the case where a process is a  
<br>
singleton and not the seed. :(
<br>
<p>Since the RAS (or functionality represented by this subsystem) was  
<br>
...
singleton process.
<br>
<p>A quick repair would be to protect the RDS section from all non-seed  
<br>
processes. E.g.
<br>
...
<br>
<p>An additional fix would be to add a call to the rmgr to setup singleton  
<br>
...
<br>
<p>if (orte_process_info.singleton) {
<br>
&nbsp;&nbsp;&nbsp;if (ORTE_SUCCESS != (ret =  
<br>
...
<br>
<p>Currently this would only contain the addition of the singleton process  
<br>
to the RDS and RAS, but Ralph mentioned last week that he ran across  
<br>
some other 'singleton only' stuff that might be needed.
<br>
<p>Is there a design issue in adding this functionality to the rmgr, with  
<br>
the proper protection around access to the RDS?
<br>
<p>I guess my overall argument is that the RDS should be called in the  
<br>
...
<br>
<p>It is likely that I could have things confused a bit with how we define  
<br>
a singleton process, and how they are created with relation to the  
<br>
seed.
<br>
<p>As a general bug notice in ORTE: There is an outstanding bug in the  
<br>
...
<p>Thoughts?
<br>
<p>Sorry for causing trouble,
<br>
<p>Josh
<br>
<p>On Aug 18, 2005, at 3:33 PM, Tim S. Woodall wrote:
<br>
...
<span class="quotelev1">&gt; the rmgr - and only initialized on the seed. The proxy rmgr is loaded  
</span><br>
<span class="quotelev1">&gt; when
</span><br>
<span class="quotelev1">&gt; a persistent daemon is available - and therefore the rds is not loaded.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #5  0x0000002a95c0c017 in __libc_start_main () from /lib64/libc.so.6
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -I../../../../include -I../../../../opal  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -I../../../../orte
</span><br>
