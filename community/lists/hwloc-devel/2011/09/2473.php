...
?>
<!-- received="Sat Sep 24 18:36:47 2011" -->
<!-- isoreceived="20110924223647" -->
<!-- sent="Sat, 24 Sep 2011 16:36:38 -0600" -->
<!-- isosent="20110924223638" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [hwloc-devel] Something lighter-weight than XML?" -->
<!-- id="04FEF4C6-B774-43FA-9C7B-C0D00289F650_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="4E7E3B33.4040601_at_inria.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-09-24 18:36:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2474.php">MPI Team: "[hwloc-devel] Create success (hwloc r1.4a1r3861)"</a>
<li><strong>Previous message:</strong> <a href="2472.php">Brice Goglin: "Re: [hwloc-devel] Something lighter-weight than XML?"</a>
<li><strong>In reply to:</strong> <a href="2472.php">Brice Goglin: "Re: [hwloc-devel] Something lighter-weight than XML?"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Thanks!
<br>
<p>On Sep 24, 2011, at 2:18 PM, Brice Goglin wrote:
<br>
<p><span class="quotelev1">&gt; I fixed one parsing bug in commit 3660 on the v1.2-ompi branch. Things
</span><br>
<span class="quotelev1">&gt; should work better now.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Parsing XML distance matrices was broken when the XML file came from the
</span><br>
<span class="quotelev1">&gt; no-libxml exporter. That's why you had problems on your dual-amd machine
</span><br>
<span class="quotelev1">&gt; (those have distance matrices) and not on your mac (single processor, no
</span><br>
<span class="quotelev1">&gt; distances, no bug).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The v1.2 branch doesn't report parsing failure well, so it just crashed.
</span><br>
<span class="quotelev1">&gt; Trunk exits with an error instead of crashing.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
