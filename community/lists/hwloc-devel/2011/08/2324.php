<?
$subject_val = "[hwloc-devel] === CREATE FAILURE (v1.2) ===";
include("../../include/msg-header.inc");
?>
<!-- received="Sun Aug 28 21:02:45 2011" -->
<!-- isoreceived="20110829010245" -->
<!-- sent="Sun, 28 Aug 2011 21:02:45 -0400" -->
<!-- isosent="20110829010245" -->
<!-- name="MPI Team" -->
<!-- email="mpiteam_at_[hidden]" -->
<!-- subject="[hwloc-devel] === CREATE FAILURE (v1.2) ===" -->
<!-- id="201108290102.p7T12jEj016275_at_eddie.osl.iu.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [hwloc-devel] === CREATE FAILURE (v1.2) ===<br>
<strong>From:</strong> MPI Team (<em>mpiteam_at_[hidden]</em>)<br>
<strong>Date:</strong> 2011-08-28 21:02:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2325.php">MPI Team: "[hwloc-devel] === CREATE FAILURE (v1.3) ==="</a>
<li><strong>Previous message:</strong> <a href="2323.php">MPI Team: "[hwloc-devel] === CREATE FAILURE (trunk) ==="</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
ERROR: Command returned a non-zero exist status (v1.2):
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;make distcheck
<br>
<p>Start time: Sun Aug 28 21:01:57 EDT 2011
<br>
End time:   Sun Aug 28 21:02:45 EDT 2011
<br>
<p>=======================================================================
<br>
...
<br>
make[1]: Leaving directory `/home/mpiteam/hwloc/nightly-tarball-build-root/v1.2/create-r3694/hwloc/doc'
<br>
