...
?>
<!-- received="Wed Nov  2 10:23:38 2011" -->
<!-- isoreceived="20111102142338" -->
<!-- sent="Wed, 2 Nov 2011 10:23:32 -0400" -->
<!-- isosent="20111102142332" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [hwloc-devel] hwloc problem" -->
<!-- id="E298A101-2BEB-492D-BB6B-4732647AADA3_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="4EB14E28.9030908_at_inria.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-11-02 10:23:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2526.php">Jeff Squyres: "[hwloc-devel] Fwd:  hwloc problem"</a>
<li><strong>Previous message:</strong> <a href="2524.php">Brice Goglin: "Re: [hwloc-devel] hwloc problem"</a>
<li><strong>In reply to:</strong> <a href="2524.php">Brice Goglin: "Re: [hwloc-devel] hwloc problem"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Chris --
<br>
<p>Can you verify the attached patch?  If so, I'll commit it to the SVN trunk and the pending OMPI v1.5 patch.
<br>
<p><p>On Nov 2, 2011, at 10:05 AM, Brice Goglin wrote:
<br>
<p><span class="quotelev1">&gt; If we can't find any other way, filtering (during export) would be an
</span><br>
<span class="quotelev1">&gt; easy solution.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; For the v1.2 branch, the attached patch seems to help. It just prevents
</span><br>
<span class="quotelev1">&gt; the creation of internal matrices with invalid relative depth. No
</span><br>
<span class="quotelev1">&gt; internal matrix, means no XML export, which means you don't break your
</span><br>
...
<span class="quotelev1">&gt; Le 02/11/2011 14:59, Jeff Squyres a &#233;crit :
</span><br>
<span class="quotelev2">&gt;&gt; Should we just filter out the &quot;distance&quot; attribute in the XML on the v1.2ompi branch?  We're not using it (yet) in OMPI.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Nov 2, 2011, at 9:32 AM, Brice Goglin wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; The v1.2 branch has known problems with distance matrices when the topology is asymmetric (especially when Linux cpuset make some NUMA nodes CPU-less). This is what causes wrong relative_depth here. It can even be negative is some cases which is obviously wrong.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; This should be fixed in v1.3 but it's NOT easy to backport in v1.2. Can you check that you can export and reimport with v1.3 properly? I will see if I can find a workaround for v1.2, but it will likely be something like ignore distance matrices if reldepth is &lt;= 0.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; In the meantime, you can remove &quot;&amp;&amp; reldepth&quot; from the &quot;if&quot; line below. It may help.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Le 02/11/2011 13:42, Jeff Squyres (jsquyres) a &#233;crit :
</span><br>
...
<span class="quotelev1">&gt; &lt;ignore_invalid_reldepth.patch&gt;_______________________________________________
</span><br>
