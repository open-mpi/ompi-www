<?
$subject_val = "[hwloc-devel] Hardware Locality (hwloc) v0.9.3 released";
...
<!-- subject="[hwloc-devel] Hardware Locality (hwloc) v0.9.3 released" -->
...
<p class="headers">
<strong>Subject:</strong> [hwloc-devel] Hardware Locality (hwloc) v0.9.3 released<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-12-01 12:40:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0452.php">Chris Samuel: "Re: [hwloc-devel] 0.9.3rc2 out"</a>
<li><strong>Previous message:</strong> <a href="0450.php">Jeff Squyres: "[hwloc-devel] Release 0.9.3?"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
