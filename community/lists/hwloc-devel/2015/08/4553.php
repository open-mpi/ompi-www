...
?>
<!-- received="Mon Aug 17 13:17:26 2015" -->
<!-- isoreceived="20150817171726" -->
<!-- sent="Mon, 17 Aug 2015 17:17:22 +0000" -->
<!-- isosent="20150817171722" -->
<!-- name="Tannenbaum, Barry M" -->
<!-- email="barry.m.tannenbaum_at_[hidden]" -->
<!-- subject="Re: [hwloc-devel] hwloc on Windows?" -->
<!-- id="6B86B7F2A4026246AA81BA1ABF9756906A7A7DB6_at_fmsmsx107.amr.corp.intel.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="55D20A96.3000006_at_inria.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-08-17 13:17:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4554.php">Brice Goglin: "Re: [hwloc-devel] hwloc on Windows?"</a>
<li><strong>Previous message:</strong> <a href="4552.php">Brice Goglin: "Re: [hwloc-devel] hwloc on Windows?"</a>
<li><strong>In reply to:</strong> <a href="4552.php">Brice Goglin: "Re: [hwloc-devel] hwloc on Windows?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4554.php">Brice Goglin: "Re: [hwloc-devel] hwloc on Windows?"</a>
<li><strong>Reply:</strong> <a href="4554.php">Brice Goglin: "Re: [hwloc-devel] hwloc on Windows?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><p>The second question is how do you build hwloc on Windows? I'm building with Cygwin and Visual Studio 2013. I managed to coerce the configuration script to run, but when I tried to issue the &quot;make&quot; command, it bombed out, starting with a message from cl that it didn't know the &quot;-g&quot; option.
<br>
...
Could this help?
<br>
<p><p><p><p>Trying to use the Visual Studio project provided, I got a pile of warnings, and then errors looking for definitions of HWLOC_VERSION.
<br>
...
<br>
<p><p><p><p>Obviously I'm doing this wrong. Can someone suggest how to build hwloc on Windows?
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-devel/att-4553/attachment">attachment</a>
</ul>
