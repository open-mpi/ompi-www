...
?>
<!-- received="Wed Apr 23 18:11:14 2014" -->
<!-- isoreceived="20140423221114" -->
<!-- sent="Wed, 23 Apr 2014 22:11:13 +0000" -->
<!-- isosent="20140423221113" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [hwloc-devel] PATCH: Mark fd as close-on-exec" -->
<!-- id="C5B6BD1D-A3BA-44C9-9ACC-6843C1AC6AB7_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAAvDA17cZeKpOYov+=5oYBSeViHOKmACAYO0qzyKGchQQxU1VQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-04-23 18:11:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4136.php">Paul Hargrove: "Re: [hwloc-devel] PATCH: Mark fd as close-on-exec"</a>
<li><strong>Previous message:</strong> <a href="4134.php">Jeff Squyres (jsquyres): "Re: [hwloc-devel] PATCH: Mark fd as close-on-exec"</a>
<li><strong>In reply to:</strong> <a href="4133.php">Paul Hargrove: "Re: [hwloc-devel] PATCH: Mark fd as close-on-exec"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4136.php">Paul Hargrove: "Re: [hwloc-devel] PATCH: Mark fd as close-on-exec"</a>
<li><strong>Reply:</strong> <a href="4136.php">Paul Hargrove: "Re: [hwloc-devel] PATCH: Mark fd as close-on-exec"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
We opened the fd a few lines above with default flags -- is the addition GETFD necessary?
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;<a href="https://github.com/open-mpi/hwloc/blob/master/src/topology-linux.c#L4595">https://github.com/open-mpi/hwloc/blob/master/src/topology-linux.c#L4595</a>
<br>
<p><p>On Apr 23, 2014, at 6:04 PM, Paul Hargrove &lt;phhargrove_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; In order to preserve any existing flags, shouldn't this be more like:
</span><br>
<span class="quotelev1">&gt;   int prev;
</span><br>
<span class="quotelev1">&gt;   if ((-1 == (prev =  fcntl(root, F_GETFD, 0)) ||
</span><br>
<span class="quotelev1">&gt;       (-1 == fcntl(root, F_SETFD, FD_CLOEXEC | prev)))
</span><br>
...
<span class="quotelev1">&gt; On Wed, Apr 23, 2014 at 2:55 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
