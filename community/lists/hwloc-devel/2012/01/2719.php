<?
$subject_val = "[hwloc-devel] hwloc and HTX device ?";
...
<!-- subject="[hwloc-devel] hwloc and HTX device ?" -->
...
<p class="headers">
<strong>Subject:</strong> [hwloc-devel] hwloc and HTX device ?<br>
<strong>From:</strong> Brice Goglin (<em>Brice.Goglin_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-01-27 03:21:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2720.php">MPI Team: "[hwloc-devel] Create success (hwloc r1.5a1r4210)"</a>
<li><strong>Previous message:</strong> <a href="2718.php">MPI Team: "[hwloc-devel] Create success (hwloc r1.4.1a1r4203)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2727.php">Brice Goglin: "Re: [hwloc-devel] hwloc and HTX device ?"</a>
<li><strong>Maybe reply:</strong> <a href="2727.php">Brice Goglin: "Re: [hwloc-devel] hwloc and HTX device ?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
