...
?>
<!-- received="Tue May  7 18:02:24 2013" -->
<!-- isoreceived="20130507220224" -->
<!-- sent="Tue, 7 May 2013 22:02:18 +0000" -->
<!-- isosent="20130507220218" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [hwloc-devel] hwloc embedding vs libltdl" -->
<!-- id="EF66BBEB19BADC41AC8CCF5F684F07FC4F60DCBF_at_xmb-rcd-x01.cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2013-05-07 18:02:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3714.php">Brice Goglin: "Re: [hwloc-devel] hwloc embedding vs libltdl"</a>
<li><strong>Previous message:</strong> <a href="3712.php">Jeff Squyres (jsquyres): "Re: [hwloc-devel] hwloc embedding vs libltdl"</a>
<li><strong>In reply to:</strong> <a href="3712.php">Jeff Squyres (jsquyres): "Re: [hwloc-devel] hwloc embedding vs libltdl"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3714.php">Brice Goglin: "Re: [hwloc-devel] hwloc embedding vs libltdl"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><p>On May 7, 2013, at 6:00 PM, &quot;Jeff Squyres (jsquyres)&quot; &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Sorry for the high latency reply.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I thought about this quite a bit today.  Here's a thinking-out-of-the-box question: should we just use the default/system installed libltdl instead of embedding?  If we don't embed, many of these problems go away, right?  I.e., we can still have the same options for plugins: non-default, but available if you ask for it *and* there's a system-level libltdl available.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; FWIW: I see RHEL 6.x uses libtool/libltdl 2.2.6.  Do we:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; a) care about supporting plugins by default on distros with older ltdl versions?
</span><br>
...
<span class="quotelev1">&gt; Attached is a patch that does a few minor things:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; - avoid the use of AM_CONDITIONAL for the libltdl subdir
</span><br>
<span class="quotelev1">&gt; - ensure to have libtool avoid setting up Fortran and C++ (a trick we learned from MPICH :-) )
</span><br>
<span class="quotelev1">&gt; - disallow embedded mode and plugins (per our phone discussion the other day)
</span><br>
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-devel/att-3713/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-devel/att-3713/minor-plugin-changes.diff">minor-plugin-changes.diff</a>
</ul>
