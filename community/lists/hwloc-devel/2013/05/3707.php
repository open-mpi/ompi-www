...
?>
<!-- received="Tue May  7 10:54:04 2013" -->
<!-- isoreceived="20130507145404" -->
<!-- sent="Tue, 07 May 2013 16:53:56 +0200" -->
<!-- isosent="20130507145356" -->
<!-- name="Brice Goglin" -->
<!-- email="Brice.Goglin_at_[hidden]" -->
<!-- subject="Re: [hwloc-devel] hwloc-1.7 issue roundup" -->
<!-- id="51891584.8010004_at_inria.fr" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2013-05-07 10:53:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3708.php">Pavan Balaji: "Re: [hwloc-devel] hwloc-1.7 issue roundup"</a>
<li><strong>Previous message:</strong> <a href="3706.php">Brice Goglin: "Re: [hwloc-devel] Fwd: [hwloc-svn] svn:hwloc r5588 - trunk/config"</a>
<li><strong>In reply to:</strong> <a href="3680.php">Pavan Balaji: "[hwloc-devel] hwloc-1.7 issue roundup"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3708.php">Pavan Balaji: "Re: [hwloc-devel] hwloc-1.7 issue roundup"</a>
<li><strong>Reply:</strong> <a href="3708.php">Pavan Balaji: "Re: [hwloc-devel] hwloc-1.7 issue roundup"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Pavan,
<br>
<p>I just pushed another round of commits to trunk, which hopefully address
<br>
everything said earlier (except the LDTL problem waiting for Jeff's review).
<br>
<p>1) autogen args
<br>
<a href="https://svn.open-mpi.org/trac/hwloc/changeset/5586">https://svn.open-mpi.org/trac/hwloc/changeset/5586</a>
<br>
2) sys/sysctl.h #ifdef fix
<br>
<a href="https://svn.open-mpi.org/trac/hwloc/changeset/5587">https://svn.open-mpi.org/trac/hwloc/changeset/5587</a>
<br>
3) sysctl/sysctlbyname check fix (include additional fix for icc)
<br>
<a href="https://svn.open-mpi.org/trac/hwloc/changeset/5598">https://svn.open-mpi.org/trac/hwloc/changeset/5598</a>
<br>
4) HWLOC_CHECK_DECL improvement
<br>
<a href="https://svn.open-mpi.org/trac/hwloc/changeset/5599">https://svn.open-mpi.org/trac/hwloc/changeset/5599</a>
<br>
5) strtoull check
<br>
<a href="https://svn.open-mpi.org/trac/hwloc/changeset/5600">https://svn.open-mpi.org/trac/hwloc/changeset/5600</a>
<br>
<p>(1) and (2) will be backported to v1.7 once regression testing is done.
<br>
...
<p>Brice
<br>
<p><p><p><p>Le 05/05/2013 18:18, Pavan Balaji a &#233;crit :
<br>
