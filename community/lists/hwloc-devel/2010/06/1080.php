...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1081.php">Jeff Squyres: "Re: [hwloc-devel] [hwloc-users] hwloc and rpath"</a>
<li><strong>Previous message:</strong> <a href="1079.php">MPI Team: "[hwloc-devel] Create success (hwloc r1.1a1r2234)"</a>
<li><strong>In reply to:</strong> <a href="1073.php">Samuel Thibault: "Re: [hwloc-devel] [hwloc-users] hwloc and rpath"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1081.php">Jeff Squyres: "Re: [hwloc-devel] [hwloc-users] hwloc and rpath"</a>
<li><strong>Reply:</strong> <a href="1081.php">Jeff Squyres: "Re: [hwloc-devel] [hwloc-users] hwloc and rpath"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
