<?
$subject_val = "[hwloc-devel] hwloc and rpath";
include("../../include/msg-header.inc");
?>
<!-- received="Fri Jun 18 16:59:31 2010" -->
<!-- isoreceived="20100618205931" -->
<!-- sent="Fri, 18 Jun 2010 22:59:24 +0200" -->
<!-- isosent="20100618205924" -->
<!-- name="Jirka Hladky" -->
<!-- email="jhladky_at_[hidden]" -->
<!-- subject="[hwloc-devel] hwloc and rpath" -->
<!-- id="201006182259.24504.jhladky_at_redhat.com" -->
<!-- charset="us-ascii" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [hwloc-devel] hwloc and rpath<br>
<strong>From:</strong> Jirka Hladky (<em>jhladky_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-06-18 16:59:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1059.php">Samuel Thibault: "Re: [hwloc-devel] [hwloc-users] hwloc and rpath"</a>
<li><strong>Previous message:</strong> <a href="1057.php">Samuel Thibault: "Re: [hwloc-devel] [hwloc-svn] svn:hwloc r2223"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br><hr>
<ul>
<li>text/x-rpm-spec attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-devel/att-1058/hwloc.spec">hwloc.spec</a>
</ul>
<!-- attachment="hwloc.spec" -->
<hr>
<ul>
<li>text/x-rpm-spec attachment: <a href="http://www.open-mpi.org/community/lists/hwloc-devel/att-1058/hwloc.spec-patching_libtool">hwloc.spec-patching_libtool</a>
</ul>
