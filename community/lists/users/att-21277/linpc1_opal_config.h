...
#define OPAL_PACKAGE_STRING "Open MPI root@linpc1 Distribution"
...
#define WRAPPER_EXTRA_CXXFLAGS "-mt "
...
#define WRAPPER_EXTRA_LIBS "-lm -lpci -ldl -Wl,--export-dynamic -lrt -lnsl -lutil "
