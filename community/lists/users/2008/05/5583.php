...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5584.php">Alberto Giannetti: "[OMPI users] Enabling progress thread"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2008/04/5582.php">Josh Hursey: "Re: [OMPI users] blcr_checkpoint_peer: execvp returned -1"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2008/04/5562.php">Pavel Shamis (Pasha): "Re: [OMPI users] infiniband"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
