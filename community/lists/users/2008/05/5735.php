...
?>
<!-- received="Tue May 27 11:47:49 2008" -->
<!-- isoreceived="20080527154749" -->
<!-- sent="Tue, 27 May 2008 08:47:40 -0700" -->
<!-- isosent="20080527154740" -->
<!-- name="Jim Kusznir" -->
<!-- email="jkusznir_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI+PGI errors" -->
<!-- id="df8c8a6d0805270847s73efcf10m6af5767953522af0_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2008-05-27 11:47:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5736.php">Jim Kusznir: "[OMPI users] Job dies randomly, but only through torque"</a>
<li><strong>Previous message:</strong> <a href="5734.php">Gabriele Fatigati: "Re: [OMPI users] (no subject)"</a>
<li><strong>In reply to:</strong> <a href="5711.php">Jim Kusznir: "[OMPI users] OpenMPI+PGI errors"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5743.php">Jeff Squyres: "Re: [OMPI users] OpenMPI+PGI errors"</a>
<li><strong>Reply:</strong> <a href="5743.php">Jeff Squyres: "Re: [OMPI users] OpenMPI+PGI errors"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
--------------------------
<br>
Any suggestions?  At the moment, we both seem to be stuck in a
<br>
finger-pointing cycle, as neither can find anything wrong with their
<br>
part nor can we come up with any further debugging info.  The job dies
<br>
at random intervals (in timesteps and wall clock time), and the user
<br>
...
--Jim
<br>
<p>On Tue, May 20, 2008 at 1:23 PM, Jim Kusznir &lt;jkusznir_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; CC=pgcc CXX=pgCC F77=pgf77 FC=pgf90 rpmbuild -bb --define 'install_in_opt 1' --d
</span><br>
<span class="quotelev1">&gt; efine 'install_modulefile 1' --define 'modules_rpm_name environment-modules' --d
</span><br>
<span class="quotelev1">&gt; efine 'build_all_in_one_rpm 0'  --define 'configure_options --with-tm=/opt/torqu
</span><br>
<span class="quotelev1">&gt; e' --define '_name openmpi-pgi' --define 'use_default_rpm_opt_flags 0' openmpi.s
</span><br>
