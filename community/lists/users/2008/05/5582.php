...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5583.php">Linwei Wang: "[OMPI users] Install BLACS and ScaLAPACK on Leopard"</a>
<li><strong>Previous message:</strong> <a href="5581.php">Alberto Giannetti: "[OMPI users] Enabling progress thread"</a>
<li><strong>In reply to:</strong> <a href="5581.php">Alberto Giannetti: "[OMPI users] Enabling progress thread"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5602.php">Jeff Squyres: "Re: [OMPI users] Enabling progress thread"</a>
<li><strong>Reply:</strong> <a href="5602.php">Jeff Squyres: "Re: [OMPI users] Enabling progress thread"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
