...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Terminating processes started by MPI_Comm_spawn<br>
<strong>From:</strong> Keith Chan (<em>keith_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-07-01 00:50:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6007.php">Willem Vermin: "[OMPI users] stall with MPI_Scatter and shared memory"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2008/06/6005.php">Doug Roberts: "Re: [OMPI users] Code Seg Faults in Devel Series"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
