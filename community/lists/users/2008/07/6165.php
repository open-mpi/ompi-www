...
?>
<!-- received="Mon Jul 28 15:49:40 2008" -->
<!-- isoreceived="20080728194940" -->
<!-- sent="Mon, 28 Jul 2008 15:44:55 -0400" -->
<!-- isosent="20080728194455" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] how to make a process start and then join a MPI group" -->
<!-- id="C1029CFC-6ECC-4FCF-9BAB-32B5C72C080B_at_cisco.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="488E2115.3040503_at_3db-labs.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-07-28 15:44:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6166.php">Jeff Squyres: "Re: [OMPI users] How to cease the process triggered by OPENMPI"</a>
<li><strong>Previous message:</strong> <a href="6164.php">Jeff Squyres: "Re: [OMPI users] How to cease the process triggered by OPENMPI"</a>
<li><strong>In reply to:</strong> <a href="6162.php">Mark Borgerding: "Re: [OMPI users] how to make a process start and then join a MPI group"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6167.php">Mark Borgerding: "Re: [OMPI users] how to make a process start and then join a MPI group"</a>
<li><strong>Reply:</strong> <a href="6167.php">Mark Borgerding: "Re: [OMPI users] how to make a process start and then join a MPI group"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ok, good.
<br>
<p>One thing to check is that you have put different values for the  
<br>
&quot;high&quot; value between the parent group and the children group.
<br>
<p><p>On Jul 28, 2008, at 3:42 PM, Mark Borgerding wrote:
<br>
<p><span class="quotelev1">&gt; I should've been clearer.  I have observed the same behavior under  
</span><br>
<span class="quotelev1">&gt; both those versions.
</span><br>
<span class="quotelev1">&gt; I was not using the two version in the same cluster.
</span><br>
...
<span class="quotelev2">&gt;&gt; Are you mixing both v1.2.4 and v1.2.5 in a single MPI job?  That  
</span><br>
<span class="quotelev2">&gt;&gt; may have unintended side-effects -- we unfortunately do not  
</span><br>
<span class="quotelev2">&gt;&gt; guarantee binary compatibility between any of our releases.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Jul 28, 2008, at 10:16 AM, Mark Borgerding wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I am using version 1.2.4 (Fedora 9) and 1.2.5 ( CentOS 5.2 )
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; A little clarification:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The children do not actually wake up when the parent *sends* data  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to them, but only after the parent tries to receive data from the  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; merged intercomm.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Here is the timeline:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ...
...
<span class="quotelev3">&gt;&gt;&gt; children call to MPI_Init return
</span><br>
<span class="quotelev3">&gt;&gt;&gt; children call MPI_Intercomm_merge
</span><br>
<span class="quotelev3">&gt;&gt;&gt; parent MPI_Intercomm_merge returns
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  (long pause inserted via parent sleep)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; parent sends data to kid 1
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  (long pause inserted via parent sleep)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; parent starts to receive data from kid 1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; all children's calls to MPI_Intercomm_merge return
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Ok, I'll check to see what happens. Which version of Open MPI are  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; you using ?
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Le 27 juil. 08 &#224; 23:13, Mark Borgerding a &#233;crit :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I got something working, but I'm not 100% sure why.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the parent used the intercomm to send some data to the children  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; via MPI_Send.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; CHECK_MPI_CODE 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; (  MPI_Comm_spawn(&quot;test_mpi&quot;,NULL,nkids,MPI_INFO_NULL, 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'm using MPI_Comm_spawn to start several children  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; processes.  The problem is that the children are in their own  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; group, separate from the parent (just the like the  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; documentation says).  I want to merge the children's group  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; with the parent group so I can efficiently Send/Recv data  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am writing a code module that plugs into a larger  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; application framework.  That framework loads my code module  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; as a shared object.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; So I do not control how the first process gets started, but  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I still want it to be able to start and participate in an  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; MPI group.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; group he just started (e.g. he shows up in MPI_Comm_group,  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; can use MPI_Send, MPI_Recv, etc. )
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
