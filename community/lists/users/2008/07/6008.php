...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Need some help regarding Linpack execution<br>
<strong>From:</strong> Aditya Vasal (<em>Aditya.Vasal_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-07-02 07:36:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6009.php">Geoffroy Pignot: "Re: [OMPI users] Problem with gateway between 2 hosts"</a>
<li><strong>Previous message:</strong> <a href="6007.php">Willem Vermin: "[OMPI users] stall with MPI_Scatter and shared memory"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6010.php">Swamy Kandadai: "Re: [OMPI users] Need some help regarding Linpack execution"</a>
<li><strong>Reply:</strong> <a href="6010.php">Swamy Kandadai: "Re: [OMPI users] Need some help regarding Linpack execution"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-6008/attachment">attachment</a>
</ul>
