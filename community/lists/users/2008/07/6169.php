<?
$subject_val = "[OMPI users] Communitcation between OpenMPI and ClusterTools";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Jul 28 16:59:04 2008" -->
<!-- isoreceived="20080728205904" -->
<!-- sent="Mon, 28 Jul 2008 16:58:57 -0400" -->
<!-- isosent="20080728205857" -->
<!-- name="Alexander Shabarshin" -->
<!-- email="ashabarshin_at_[hidden]" -->
<!-- subject="[OMPI users] Communitcation between OpenMPI and ClusterTools" -->
<!-- id="010001c8f0f4$c1ec8990$e7afcea7_at_Shabarshin" -->
<!-- charset="koi8-r" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Communitcation between OpenMPI and ClusterTools<br>
<strong>From:</strong> Alexander Shabarshin (<em>ashabarshin_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-07-28 16:58:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6170.php">Jeff Squyres: "Re: [OMPI users] how to make a process start and then join a MPI group"</a>
<li><strong>Previous message:</strong> <a href="6168.php">Aur&#233;lien Bouteiller: "Re: [OMPI users] how to make a process start and then join a MPI group"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6180.php">Terry Dontje: "Re: [OMPI users] Communitcation between OpenMPI and ClusterTools"</a>
<li><strong>Maybe reply:</strong> <a href="6180.php">Terry Dontje: "Re: [OMPI users] Communitcation between OpenMPI and ClusterTools"</a>
<li><strong>Maybe reply:</strong> <a href="6190.php">Terry Dontje: "Re: [OMPI users] Communitcation between OpenMPI and ClusterTools"</a>
<li><strong>Maybe reply:</strong> <a href="6199.php">Terry Dontje: "Re: [OMPI users] Communitcation between OpenMPI and ClusterTools"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello
<br>
<p>I try to launch the same MPI sample code on Linux PC (Intel processors) 
<br>
...
<br>
<p>it was launched by this command:
<br>
<p>mpirun --mca btl tcp,self --hostfile mpshosts -np 2 /mpi/sample
<br>
<p>/mpi/sample exists on both platforms compiled properly for each particular 
<br>
platform
<br>
<p>Linux machines have replicated path for SUN-like orted launch: 
<br>
/opt/SUNWhpc/HPC7.1/bin/orted
<br>
<p>Servers are pingable from each other. SSH works fine in both directions. But 
<br>
OpenMPI doesn't work on these servers... How can I make them understand each 
<br>
other? Thank you!
<br>
<p>Alexander Shabarshin
<br>
<p>P.S. This is output of ompi_info diagnostic for ClusterTools 7.1:
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Open MPI: 1.2.5r16572-ct7.1b003r3852
<br>
...
<br>
<p>and output of ompi_info diagnostic for OpenMPI 1.2.5 compiled on Linux:
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Open MPI: 1.2.5
<br>
