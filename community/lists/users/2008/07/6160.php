...
?>
<!-- received="Mon Jul 28 15:09:32 2008" -->
<!-- isoreceived="20080728190932" -->
<!-- sent="Mon, 28 Jul 2008 15:09:24 -0400" -->
<!-- isosent="20080728190924" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] how to make a process start and then join a MPI group" -->
<!-- id="7E23B772-102B-45FD-82FA-5E29C0DA334F_at_cisco.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="488DD4DB.60704_at_3db-labs.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-07-28 15:09:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6161.php">Jeff Squyres: "Re: [OMPI users] MPI_Init segfault on Ubuntu 8.04 version 1.2.7~rc2"</a>
<li><strong>Previous message:</strong> <a href="6159.php">Jeff Squyres: "Re: [OMPI users] TCP Latency"</a>
<li><strong>In reply to:</strong> <a href="6147.php">Mark Borgerding: "Re: [OMPI users] how to make a process start and then join a MPI group"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6162.php">Mark Borgerding: "Re: [OMPI users] how to make a process start and then join a MPI group"</a>
<li><strong>Reply:</strong> <a href="6162.php">Mark Borgerding: "Re: [OMPI users] how to make a process start and then join a MPI group"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Jul 28, 2008, at 10:16 AM, Mark Borgerding wrote:
<br>
<p><span class="quotelev1">&gt; I am using version 1.2.4 (Fedora 9) and 1.2.5 ( CentOS 5.2 )
</span><br>
...
<span class="quotelev1">&gt; The children do not actually wake up when the parent *sends* data to  
</span><br>
<span class="quotelev1">&gt; them, but only after the parent tries to receive data from the  
</span><br>
<span class="quotelev1">&gt; merged intercomm.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev2">&gt;&gt; Ok, I'll check to see what happens. Which version of Open MPI are  
</span><br>
<span class="quotelev2">&gt;&gt; you using ?
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; the parent used the intercomm to send some data to the children  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; via MPI_Send.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I'm using MPI_Comm_spawn to start several children processes.   
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; The problem is that the children are in their own group,  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; separate from the parent (just the like the documentation  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; says).  I want to merge the children's group with the parent  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; group so I can efficiently Send/Recv data between them..
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; processes into one group, I can connect sockets and make  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; intercomms to talk from the parent directly to each child.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; application framework.  That framework loads my code module as  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; a shared object.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; So I do not control how the first process gets started, but I  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; still want it to be able to start and participate in an MPI  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; group he just started (e.g. he shows up in MPI_Comm_group, can  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; use MPI_Send, MPI_Recv, etc. )
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
