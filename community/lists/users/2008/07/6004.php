...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6005.php">Aditya Vasal: "[OMPI users] Need some help regarding Linpack execution"</a>
<li><strong>Previous message:</strong> <a href="6003.php">Keith Chan: "[OMPI users] Terminating processes started by MPI_Comm_spawn"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><p><hr>
<ul>
<li>text/x-csrc attachment: <a href="../../att-6004/scattertest.c">scattertest.c</a>
</ul>
<!-- attachment="scattertest.c" -->
<hr>
<ul>
<li>application/x-bzip attachment: <a href="../../att-6004/config.log.bz2">config.log.bz2</a>
</ul>
<!-- attachment="config.log.bz2" -->
<hr>
<ul>
<li>application/x-bzip attachment: <a href="../../att-6004/ompi_info--all.bz2">ompi_info--all.bz2</a>
</ul>
