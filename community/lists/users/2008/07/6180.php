...
?>
<!-- received="Tue Jul 29 07:20:42 2008" -->
<!-- isoreceived="20080729112042" -->
<!-- sent="Tue, 29 Jul 2008 07:20:37 -0400" -->
<!-- isosent="20080729112037" -->
<!-- name="Terry Dontje" -->
<!-- email="Terry.Dontje_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Communitcation between OpenMPI and ClusterTools" -->
<!-- id="488EFD05.5050409_at_sun.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="mailman.2220.1217278745.9342.users_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-07-29 07:20:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6181.php">Jeff Squyres: "Re: [OMPI users] TCP Latency"</a>
<li><strong>Previous message:</strong> <a href="6179.php">Mark Dixon: "Re: [OMPI users] Open MPI unable to find threading support for PGI or Sun Studio"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6186.php">Alexander Shabarshin: "Re: [OMPI users] Communitcation between OpenMPI and ClusterTools"</a>
<li><strong>Reply:</strong> <a href="6186.php">Alexander Shabarshin: "Re: [OMPI users] Communitcation between OpenMPI and ClusterTools"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>One idea comes to mind is whether the two nodes are on the same subnet?  If they are not on the same subnet I think there is a bug in which the TCP BTL will recuse itself from communications between the two nodes.
<br>
<p>--td
<br>
<p><p><p>Date: Mon, 28 Jul 2008 16:58:57 -0400
<br>
