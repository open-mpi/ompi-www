...
?>
<!-- received="Sun Apr  6 15:02:22 2008" -->
<!-- isoreceived="20080406190222" -->
<!-- sent="Sun, 6 Apr 2008 14:02:15 -0500" -->
<!-- isosent="20080406190215" -->
<!-- name="brian janus" -->
<!-- email="brian.janus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun script and the SYNCLOC option" -->
<!-- id="664f38be0804061202h736beb2avcc84fa73af021864_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="0E6292C7-C0DB-4404-A991-63C202056678_at_umich.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-04-06 15:02:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5330.php">Jeff Squyres: "Re: [OMPI users] mpirun script and the SYNCLOC option"</a>
<li><strong>Previous message:</strong> <a href="5328.php">Brock Palen: "Re: [OMPI users] mpirun script and the SYNCLOC option"</a>
<li><strong>In reply to:</strong> <a href="5328.php">Brock Palen: "Re: [OMPI users] mpirun script and the SYNCLOC option"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5330.php">Jeff Squyres: "Re: [OMPI users] mpirun script and the SYNCLOC option"</a>
<li><strong>Reply:</strong> <a href="5330.php">Jeff Squyres: "Re: [OMPI users] mpirun script and the SYNCLOC option"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Brock,
<br>
<p>Thanks much for the quick reply and information. I thought I might have been
<br>
...
<p>Brian.
<br>
<p>On Sun, Apr 6, 2008 at 1:53 PM, Brock Palen &lt;brockp_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; This if for MPICH's mpirun not OpenMPI's mpi run.  You will need to direct
</span><br>
<span class="quotelev1">&gt; questions to the MPICH team and mailing list.
</span><br>
<span class="quotelev1">&gt; Also be aware that if that is for MPICH-1.x  they nolonger develop it and
</span><br>
<span class="quotelev1">&gt; should move to MPICH-2.x  Or switch to another MPI stack like OpenMPI etc.
</span><br>
...
<span class="quotelev1">&gt; I'm new here so forgive me if I ask any dumb questions. But the first
</span><br>
<span class="quotelev1">&gt; question I have concerns the mpirun script below.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; My question is, what does the SYNCLOC=/bin/sync line for in the script
</span><br>
<span class="quotelev1">&gt; below do, and what complications could arise (if any), from disabling this
</span><br>
<span class="quotelev1">&gt; option by commenting out the line like #SYNCLOC=/bin/sync. In some code we
</span><br>
<span class="quotelev1">&gt; are running, we have found that disabling this option allows high priority
</span><br>
<span class="quotelev1">&gt; jobs to complete in only a couple of seconds, whereas before they would take
</span><br>
<span class="quotelev1">&gt; several minutes.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; What does SYNCLOC do, and if its disabled, what kind of problems might
</span><br>
<span class="quotelev1">&gt; that cause?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; # This script tries to start jobs on whatever kind of machine you're on.
</span><br>
<span class="quotelev1">&gt; # Strategy - This program is built with a default device it uses in
</span><br>
<span class="quotelev1">&gt; # certain ways. The user can override this default from the command line.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; #
</span><br>
<span class="quotelev1">&gt; # This sh script is designed to use other scripts to provide the commands
</span><br>
...
<span class="quotelev1">&gt; # Process common arguments (currently does ALL, but should pass unrecognized
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-5329/attachment">attachment</a>
</ul>
