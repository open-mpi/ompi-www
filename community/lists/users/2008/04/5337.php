<?
$subject_val = "[OMPI users] Open MPI v1.2.6 released";
...
<!-- subject="[OMPI users] Open MPI v1.2.6 released" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Open MPI v1.2.6 released<br>
<strong>From:</strong> Tim Mattox (<em>timattox_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-04-07 12:42:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5338.php">Terry Frankcombe: "Re: [OMPI users] An error occurred in MPI_comm_size"</a>
<li><strong>Previous message:</strong> <a href="5336.php">Brock Palen: "Re: [OMPI users] An error occurred in MPI_comm_size"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
