...
?>
<!-- received="Tue Apr 29 16:18:45 2008" -->
<!-- isoreceived="20080429201845" -->
<!-- sent="Tue, 29 Apr 2008 13:18:37 -0700" -->
<!-- isosent="20080429201837" -->
<!-- name="Sharon Brunett" -->
<!-- email="sharon_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue" -->
<!-- id="4817829D.1050509_at_cacr.caltech.edu" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2008-04-29 16:18:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5576.php">Jeff Squyres: "Re: [OMPI users] &quot;Permission denied&quot; during MPI installation"</a>
<li><strong>Previous message:</strong> <a href="5574.php">Linwei Wang: "Re: [OMPI users] &quot;Permission denied&quot; during MPI installation"</a>
<li><strong>In reply to:</strong> <a href="5568.php">Josh Hursey: "Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5578.php">Josh Hursey: "Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue"</a>
<li><strong>Reply:</strong> <a href="5578.php">Josh Hursey: "Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>&nbsp;&nbsp;&nbsp;&lt;---do an ompi-checkpoint on the mpirun pid from (a) from another 
<br>
terminal---&gt;&gt;
<br>
<p>(b) restart the checkpointed run
<br>
<p>ompi-restart ompi_global_snapshot_30086.ckpt
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&lt;--do an ompi-checkpoint on mpirun pid from (b) from another 
<br>
terminal----&gt;&gt;
<br>
<p>(c) restart the checkpointed run
<br>
...
-bash-2.05b$
<br>
<p>I can restart the previous (30086) ckpt but not the latest one made from 
<br>
a restarted run.
<br>
<p>Any insights would be appreciated.
<br>
<p>thanks,
<br>
Sharon
