...
?>
<!-- received="Tue Apr 15 16:52:44 2008" -->
<!-- isoreceived="20080415205244" -->
<!-- sent="Tue, 15 Apr 2008 16:52:35 -0400" -->
<!-- isosent="20080415205235" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_CANCEL" -->
<!-- id="3E1DBA5C-A278-4022-9A72-99A48668B9A6_at_eecs.utk.edu" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-04-15 16:52:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5398.php">Richard Treumann: "Re: [OMPI users] MPI_CANCEL"</a>
<li><strong>Previous message:</strong> <a href="5396.php">slimtimmy_at_[hidden]: "[OMPI users] MPI_CANCEL"</a>
<li><strong>In reply to:</strong> <a href="5396.php">slimtimmy_at_[hidden]: "[OMPI users] MPI_CANCEL"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5398.php">Richard Treumann: "Re: [OMPI users] MPI_CANCEL"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>&nbsp;&nbsp;&nbsp;george.
<br>
<p>On Apr 15, 2008, at 3:14 PM, slimtimmy_at_[hidden] wrote:
<br>
<span class="quotelev1">&gt; I encountered some problems when using MPI_CANCEL. I call
</span><br>
<span class="quotelev1">&gt; Request::Cancel followed by Request::Wait to ensure that the request  
</span><br>
<span class="quotelev1">&gt; has
</span><br>
<span class="quotelev1">&gt; been cancelled. However Request::Wait does not return when I send  
</span><br>
<span class="quotelev1">&gt; bigger
</span><br>
...
<br><hr>
<ul>
<li>application/pkcs7-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-5397/smime.p7s">smime.p7s</a>
</ul>
