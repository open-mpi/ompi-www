<?
$subject_val = "[OMPI users] Intel MPI Benchmark(IMB) using OpenMPI - Segmentation-fault error message.";
...
<!-- subject="[OMPI users] Intel MPI Benchmark(IMB) using OpenMPI - Segmentation-fault error message." -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Intel MPI Benchmark(IMB) using OpenMPI - Segmentation-fault error message.<br>
<strong>From:</strong> Mukesh K Srivastava (<em>srimks11_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-04-30 06:06:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5581.php">Gabriele FATIGATI: "[OMPI users] (no subject)"</a>
<li><strong>Previous message:</strong> <a href="5579.php">Sharon Brunett: "Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-5580/attachment">attachment</a>
</ul>
