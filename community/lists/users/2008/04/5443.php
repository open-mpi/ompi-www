...
?>
<!-- received="Tue Apr 22 08:57:01 2008" -->
<!-- isoreceived="20080422125701" -->
<!-- sent="Tue, 22 Apr 2008 08:56:51 -0400" -->
<!-- isosent="20080422125651" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problems with program-execution with OpenMPI: Orted: command not found" -->
<!-- id="467F57A0-42FD-4754-8A63-29C87155C367_at_cisco.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="45ae3b650804220511u3bf35aadqd6ad0df30476d448_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-04-22 08:56:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5444.php">Jeff Squyres: "Re: [OMPI users] Problems with program-execution with	OpenMPI:	Orted: command not found"</a>
<li><strong>Previous message:</strong> <a href="5442.php">Jeff Squyres: "Re: [OMPI users] Problems compiling OPENMPI !!"</a>
<li><strong>In reply to:</strong> <a href="5439.php">Simon Hammond: "Re: [OMPI users] Problems with program-execution with OpenMPI: Orted: command not found"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>The check for a non/interactive login may well be there for a reason;  
<br>
there may well be things past that line that are really only suitable  
<br>
for interactive logins.  YMMV.
<br>
<p><p>On Apr 22, 2008, at 8:11 AM, Simon Hammond wrote:
<br>
<p><span class="quotelev1">&gt; Hi,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Have you checked the .bashrc or /etc/bash.bashrc file on the  
</span><br>
<span class="quotelev1">&gt; machine. We have seen this problem before on both Debian and Ubuntu  
</span><br>
<span class="quotelev1">&gt; systems. If you find the following line:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; # If not running interactively, don't do anything
</span><br>
<span class="quotelev1">&gt; [ -z &quot;$PS1&quot; ] &amp;&amp; return
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; It means that the remainder of the file is not processed (which may  
</span><br>
<span class="quotelev1">&gt; include setting up your PATH/LD_LIBRARY_PATH) if you are connecting  
</span><br>
<span class="quotelev1">&gt; via a non-interactive login. Since this command only works for non- 
</span><br>
<span class="quotelev1">&gt; interactive logins the user falsely gets the idea that the PATH/ 
</span><br>
<span class="quotelev1">&gt; LD_LIBRARY_PATH when they log in over SSH.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; We commented this line out and it worked for us, so just an idea.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Performance Modelling and Analysis Team,
</span><br>
...
<span class="quotelev1">&gt; On 22/04/2008, Jeff Squyres &lt;jsquyres_at_[hidden]&gt; wrote: Make sure  
</span><br>
<span class="quotelev1">&gt; you're using the &quot;right&quot; mpirun.  If you have both MPICH and
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; When I tried to run programs I was a little bit confused, that  
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; What might be the problem? How does &quot;orted&quot; work? I'm not  
</span><br>
<span class="quotelev1">&gt; conscious
</span><br>
