<?
$subject_val = "[OMPI users] FW:  problems with hostfile when doing MPMD";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Apr 14 08:38:06 2008" -->
<!-- isoreceived="20080414123806" -->
<!-- sent="Mon, 14 Apr 2008 06:37:51 -0600" -->
<!-- isosent="20080414123751" -->
<!-- name="Ralph H Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="[OMPI users] FW:  problems with hostfile when doing MPMD" -->
<!-- id="C428AC3F.D0FE%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="9b0da5ce0804140123t44b29bbk24f5b6f3fe6a2033_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] FW:  problems with hostfile when doing MPMD<br>
<strong>From:</strong> Ralph H Castain (<em>rhc_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-04-14 08:37:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5393.php">Brian Barrett: "Re: [OMPI users] Problems using Intel MKL with OpenMPI and	Pathscale"</a>
<li><strong>Previous message:</strong> <a href="5391.php">Graham Jenkins: "[OMPI users] Different Interfaces on Different Nodes .. OpenMPI 1.2.3, 1.2.4 .."</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Hi Jody
<br>
<p>I believe this was intended for the Users mailing list, so I'm sending the
<br>
reply there.
<br>
<p>We do plan to provide more explanation on these in the 1.3 release - believe
<br>
...
<br>
<p>Sorry it is confusing - hopefully, it will become clearer soon
<br>
<p>Ralph
<br>
...
<span class="quotelev1">&gt; Date: Mon, 14 Apr 2008 10:23:00 +0200
</span><br>
<span class="quotelev1">&gt; To: Ralph Castain &lt;rhc_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; Subject: Re: [OMPI users] problems with hostfile when doing MPMD
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Ralph, Rolf
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Thanks for your suggestion.
</span><br>
<span class="quotelev1">&gt; After i rebuilt --enable-heterogeneous it did indeed work.
</span><br>
<span class="quotelev1">&gt; Fortunately i have only 8 machines in my cluster otherwise
</span><br>
<span class="quotelev1">&gt; listing all the nodes in the commandline would be quite exhausting.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; BTW: is there a sort of overview over all the parameters one can pass
</span><br>
<span class="quotelev1">&gt; to configure?
</span><br>
<span class="quotelev1">&gt; In the FAQ some of them are spread across all questions, and searching
</span><br>
<span class="quotelev1">&gt; on the MPI
</span><br>
<span class="quotelev1">&gt; also did not work.
</span><br>
<span class="quotelev1">&gt; Given an open-mpi installation, are all parameters given to configure
</span><br>
<span class="quotelev1">&gt; listed there?
</span><br>
<span class="quotelev1">&gt; I found &quot;Heterogeneous support : yes&quot;, and &quot;Prefix : /opt/openmpi&quot;
</span><br>
<span class="quotelev1">&gt; which are the ones
</span><br>
<span class="quotelev1">&gt; i used. As to the others, i assume they are default settings. But if i
</span><br>
<span class="quotelev1">&gt; would want to change
</span><br>
<span class="quotelev1">&gt; any of those settings, it would be difficult to find the parameter name for
</span><br>
...
<span class="quotelev1">&gt; On Mon, Apr 14, 2008 at 1:14 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; I believe this -should- work, but can't verify it myself. The most important
</span><br>
<span class="quotelev2">&gt;&gt;  thing is to be sure you built with --enable-heterogeneous or else it will
</span><br>
<span class="quotelev2">&gt;&gt;  definitely fail.
</span><br>
...
<span class="quotelev2">&gt;&gt;  On 4/10/08 7:17 AM, &quot;Rolf Vandevaart&quot; &lt;Rolf.Vandevaart_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On a CentOS Linux box, I see the following:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; grep 113 /usr/include/asm-i386/errno.h
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #define EHOSTUNREACH 113 /* No route to host */
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I have also seen folks do this to figure out the errno.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; perl -e 'die$!=113'
</span><br>
<span class="quotelev3">&gt;&gt;&gt; No route to host at -e line 1.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I am not sure why this is happening, but you could also check the Open
</span><br>
<span class="quotelev3">&gt;&gt;&gt; MPI User's Mailing List Archives where there are other examples of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; people running into this error.  A search of &quot;113&quot; had a few hits.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users">http://www.open-mpi.org/community/lists/users</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Also, I assume you would see this problem with or without the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; MPI_Barrier if you add this parameter to your mpirun line:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;      --mca mpi_preconnect_all 1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The MPI_Barrier is causing the bad behavior because by default
</span><br>
<span class="quotelev3">&gt;&gt;&gt; connections are setup up lazily. Therefore only when the MPI_Barrier
</span><br>
<span class="quotelev3">&gt;&gt;&gt; call is made and we start communicating and establishing connections do
</span><br>
<span class="quotelev3">&gt;&gt;&gt; we start seeing the communication problems.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I was able to run hostname on the two noes that way,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; and also a simplified version of my testprogram (without a barrier)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; works. Only MPI_Barrier shows bad behaviour.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Do you know what this message means?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [aim-plankton][0,1,2][btl_tcp_endpoint.c:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 572:mca_btl_tcp_endpoint_complete_connect]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; connect() failed with errno=113
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Does it give an idea what could be the problem?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Thu, Apr 10, 2008 at 2:20 PM, Rolf Vandevaart
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;Rolf.Vandevaart_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; interconnect and a 1.2.5 version of Open MPI.  Also, we configure
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; with
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the --enable-heterogeneous flag which may make a difference here.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; btl_tcp_if_include bge1 -gmca btl sm,self,tcp -host burl-ct-v20z-4 -
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; (run_gdb.sh is a script which starts gdb in a xterm for each
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; process)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Process 0 (on aim-plankton) passes the barrier and gets stuck in
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; PMPI_Finalize,
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;   [aim-plankton][0,1,1][btl_tcp_endpoint.c:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; --read-config=pureveg_new.cfg -o output.txt  : -np 3 --host aim-
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; fanta4
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun -np 3 --host aim-plankton -x DISPLAY ./run_gdb.sh ./
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; QHGLauncher
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; --read-config=pureveg_new.cfg -o output.txt  : -np 3 --host aim-
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; fanta4
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -x DISPLAY ./run_gdb.sh ./QHGLauncher_64 --read-
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; config=pureveg_new.cfg
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [aim-plankton][0,1,1][btl_tcp_endpoint.c:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; If i opnly use aim-plankton alone or aim-fanta4 alone everythiung
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; In my network i have some 32 bit machines and some 64 bit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; machines.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; With --host i successfully call my application:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  mpirun -np 3 --host aim-plankton -x DISPLAY ./run_gdb.sh ./
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; MPITest :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -np 3 --host aim-fanta4 -x DISPLAY ./run_gdb.sh ./MPITest64
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; (MPITest64 has the same code as MPITest, but was compiled on the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 64 bit machine)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; But when i use hostfiles:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  mpirun -np 3 --hostfile hosts32 -x DISPLAY ./run_gdb.sh ./
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; MPITest :
</span><br>
