...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5285.php">Danesh Daroui: "[OMPI users] remote host not accessible"</a>
<li><strong>Previous message:</strong> <a href="../../2008/03/5283.php">Joao Vicente Lima: "Re: [OMPI users] Spawn problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5295.php">Jeff Squyres: "Re: [OMPI users] iof, readline, lost stdin buffering"</a>
<li><strong>Reply:</strong> <a href="5295.php">Jeff Squyres: "Re: [OMPI users] iof, readline, lost stdin buffering"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
