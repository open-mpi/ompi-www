...
?>
<!-- received="Tue Apr 29 16:32:02 2008" -->
<!-- isoreceived="20080429203202" -->
<!-- sent="Tue, 29 Apr 2008 15:31:56 -0500" -->
<!-- isosent="20080429203156" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue" -->
<!-- id="0A9A45F1-73AA-46CE-BDF1-C86DA62AC249_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="4817829D.1050509_at_cacr.caltech.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-04-29 16:31:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5579.php">Sharon Brunett: "Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue"</a>
<li><strong>Previous message:</strong> <a href="5577.php">Linwei Wang: "Re: [OMPI users] &quot;Permission denied&quot; during MPI installation"</a>
<li><strong>In reply to:</strong> <a href="5575.php">Sharon Brunett: "Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5579.php">Sharon Brunett: "Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue"</a>
<li><strong>Reply:</strong> <a href="5579.php">Sharon Brunett: "Re: [OMPI users] openmpi-1.3a1r18241  ompi-restart issue"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Josh
<br>
<p>On Apr 29, 2008, at 3:18 PM, Sharon Brunett wrote:
<br>
<p><span class="quotelev1">&gt; Josh,
</span><br>
<span class="quotelev1">&gt; I'm also having trouble using ompi-restart on a snapspot made from a  
</span><br>
...
<span class="quotelev1">&gt; I can restart the previous (30086) ckpt but not the latest one made  
</span><br>
...
<span class="quotelev2">&gt;&gt; This is, unfortunately, to be expected at the moment for this type of
</span><br>
<span class="quotelev2">&gt;&gt; application. Extremely communication intensive applications will most
</span><br>
<span class="quotelev2">&gt;&gt; likely cause the implementation of the current coordination algorithm
</span><br>
<span class="quotelev2">&gt;&gt; to slow down significantly. This is because on a checkpoint Open MPI
</span><br>
<span class="quotelev2">&gt;&gt; does a peerwise check on the description of (possibly) each message  
</span><br>
<span class="quotelev2">&gt;&gt; to
</span><br>
<span class="quotelev2">&gt;&gt; make sure there are no messages in flight. So for a huge number of
</span><br>
<span class="quotelev2">&gt;&gt; messages this could take a long time.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; This is a performance problem with the current implementation of the
</span><br>
<span class="quotelev2">&gt;&gt; algorithm that we use in Open MPI. I've been meaning to go back and
</span><br>
...
<span class="quotelev2">&gt;&gt; algorithm I'm using is based on the algorithm used by LAM/MPI, but
</span><br>
...
<span class="quotelev2">&gt;&gt; If this is critical for you I might be able to take a look at it, but
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I'm finding that using ompi-checkpoint on an application which is
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; It depends on how you configured Open MPI with checkpoint/restart.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; There are two modes of operation: No threads, and with a checkpoint
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; progress on the global checkpoint. For CPU intensive applications
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; weight and will make sure that a checkpoint progresses even when  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Try enabling the checkpoint thread and see if that helps improve  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; First...please pardon the blunder in my earlier mail. Comms bound  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; tried configuring with the above two configure options but still no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; luck
</span><br>
<span class="quotelev3">&gt;&gt;&gt; on improving checkpointing times or gaining completion on larger mpi
</span><br>
<span class="quotelev3">&gt;&gt;&gt; task runs being checkpointed.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; It looks like the checkpointing is just hanging. For example, I can
</span><br>
<span class="quotelev3">&gt;&gt;&gt; checkpoint a 2 way comms bound code (1 task on two nodes) ok. When I
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ask
</span><br>
<span class="quotelev3">&gt;&gt;&gt; for a 4 way run on 2 nodes, 30 minutes after the ompi-checkpoint PID
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I can checkpoint some codes (like xhpl) just fine across 8 mpi tasks
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ( t
</span><br>
<span class="quotelev3">&gt;&gt;&gt; nodes), dumping 254M total. Thus, the very long/stuck checkpointing
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ./configure --prefix=/nfs/ds01/support/sharon/openmpi-1.3a1r18241
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --enable-mpi-threads --enable-ft-thread --with-ft=cr --enable-shared
</span><br>
