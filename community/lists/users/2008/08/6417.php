...
?>
<!-- received="Fri Aug 22 10:12:44 2008" -->
<!-- isoreceived="20080822141244" -->
<!-- sent="Fri, 22 Aug 2008 08:12:36 -0600" -->
<!-- isosent="20080822141236" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem when mpi_paffinity_alone is set to 1" -->
<!-- id="DF3B11B0-8451-41D5-89E4-3A2FDBF55AAC_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2008-08-22 10:12:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6418.php">Jeff Squyres: "Re: [OMPI users] problem when mpi_paffinity_alone is set to 1"</a>
<li><strong>Previous message:</strong> <a href="6416.php">Ralph Castain: "Re: [OMPI users] problem when mpi_paffinity_alone is set to 1"</a>
<li><strong>In reply to:</strong> <a href="6415.php">Camille Coti: "Re: [OMPI users] problem when mpi_paffinity_alone is set to 1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6418.php">Jeff Squyres: "Re: [OMPI users] problem when mpi_paffinity_alone is set to 1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>We'll have to think about this one a little to try and figure out why  
<br>
this is happening.
<br>
Ralph
<br>
<p>On Aug 22, 2008, at 8:00 AM, Camille Coti wrote:
<br>
