...
?>
<!-- received="Wed Aug 20 13:51:37 2008" -->
<!-- isoreceived="20080820175137" -->
<!-- sent="Wed, 20 Aug 2008 19:51:18 +0200" -->
<!-- isosent="20080820175118" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_Type_struct for structs with dynamic arrays" -->
<!-- id="BE9AABA5-73D0-4023-9726-93FF0F008A8A_at_eecs.utk.edu" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-08-20 13:51:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6400.php">Jitendra Kumar: "Re: [OMPI users] MPI_Type_struct for structs with dynamic arrays"</a>
<li><strong>Previous message:</strong> <a href="6398.php">Mi Yan: "Re: [OMPI users] run OpenMPI job on heterogeneous processor"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6400.php">Jitendra Kumar: "Re: [OMPI users] MPI_Type_struct for structs with dynamic arrays"</a>
<li><strong>Reply:</strong> <a href="6400.php">Jitendra Kumar: "Re: [OMPI users] MPI_Type_struct for structs with dynamic arrays"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Jitendra,
<br>
<p>You will not be able to reuse the same data-type. All internal arrays  
<br>
...
<p>&nbsp;&nbsp;&nbsp;george.
<br>
<p>On Aug 19, 2008, at 5:12 PM, Jitendra Kumar wrote:
<br>
...
<span class="quotelev1">&gt; (I have tried to explain the issues below with snippets of codes and  
</span><br>
...
<span class="quotelev1">&gt;    531         MPI_Get_address(&amp;parentPop[0].indiv[0].obj[0],  
</span><br>
<span class="quotelev1">&gt; &amp;disp[4]);
</span><br>
...
<span class="quotelev1">&gt;    539         MPI_Get_address(&amp;parentPop[0].indiv[0].rank, &amp;disp[8]);
</span><br>
<span class="quotelev1">&gt;    540         printf(&quot;disp 8 %ld\n&quot;, disp[8]);
</span><br>
<span class="quotelev1">&gt;    541
</span><br>
<span class="quotelev1">&gt; MPI_Get_address(&amp;parentPop[0].indiv[0].strategyParameter[0],  
</span><br>
<span class="quotelev1">&gt; &amp;disp[9]);
</span><br>
...
<span class="quotelev1">&gt; Though the MPI_Get_elements shows the correct number of elements in  
</span><br>
...
<span class="quotelev1">&gt;    593         fprintf(stdout, &quot;Rank %d: before receive recvind.nobj  
</span><br>
...
<span class="quotelev1">&gt;    597         fprintf(stdout, &quot;Rank %d: after receive recvind.nobj %f
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;   523         MPI_Get_address(&amp;parentPop[0].indiv[0].gene,  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &amp;disp[3]);
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   524         MPI_Get_address(&amp;parentPop[0].indiv[0].obj, &amp;disp[4]);
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;   528         MPI_Get_address(&amp;parentPop[0].indiv[0].rank,  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &amp;disp[8]);
</span><br>
...
<br><hr>
<ul>
<li>application/pkcs7-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-6399/smime.p7s">smime.p7s</a>
</ul>
