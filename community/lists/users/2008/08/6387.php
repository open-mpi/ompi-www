...
?>
<!-- received="Mon Aug 18 19:16:42 2008" -->
<!-- isoreceived="20080818231642" -->
<!-- sent="Tue, 19 Aug 2008 01:16:28 +0200" -->
<!-- isosent="20080818231628" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_ERR_TRUNCATE with MPI_Revc without Infinipath" -->
<!-- id="5414F2CB-4BF8-4B54-9561-E31E7EE5D9D1_at_eecs.utk.edu" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="953820.25720.qm_at_web55401.mail.re4.yahoo.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-08-18 19:16:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6388.php">Robert Kubrick: "Re: [OMPI users] Proper way to throw an error to all nodes?"</a>
<li><strong>Previous message:</strong> <a href="6386.php">Tom Riddle: "Re: [OMPI users] MPI_ERR_TRUNCATE with MPI_Revc without Infinipath"</a>
<li><strong>In reply to:</strong> <a href="6386.php">Tom Riddle: "Re: [OMPI users] MPI_ERR_TRUNCATE with MPI_Revc without Infinipath"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6406.php">Tom Riddle: "Re: [OMPI users] MPI_ERR_TRUNCATE with MPI_Revc without Infinipath"</a>
<li><strong>Reply:</strong> <a href="6406.php">Tom Riddle: "Re: [OMPI users] MPI_ERR_TRUNCATE with MPI_Revc without Infinipath"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
&quot;pending&quot; queue and goes into the wire too early. As this message will  
<br>
...
<span class="quotelev2">&gt; &gt; has Infinipath HCAs  installed and another that doesn't. I run both
</span><br>
...
<br><hr>
<ul>
<li>application/pkcs7-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-6387/smime.p7s">smime.p7s</a>
</ul>
