...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6248.php">Craig Tierney: "[OMPI users] Problems building openmpi 1.2.6 with Lahey Fortran"</a>
<li><strong>Previous message:</strong> <a href="6246.php">Mark Dixon: "Re: [OMPI users] Open MPI unable to find threading support for PGI or Sun Studio"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2008/07/6207.php">James Philbin: "Re: [OMPI users] Segmentation fault: Address not mapped"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6249.php">James Philbin: "Re: [OMPI users] Segmentation fault: Address not mapped"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
