...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7382.php">Gustavo Seabra: "Re: [OMPI users] openmpi-1.2.8 and cygwin..."</a>
<li><strong>Previous message:</strong> <a href="7380.php">Heitor Florido: "Re: [OMPI users] OpenMPI on a LAN"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2008/11/7356.php">Ralph Castain: "Re: [OMPI users] Hybrid program"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7384.php">Edgar Gabriel: "Re: [OMPI users] Hybrid program"</a>
<li><strong>Reply:</strong> <a href="7384.php">Edgar Gabriel: "Re: [OMPI users] Hybrid program"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
