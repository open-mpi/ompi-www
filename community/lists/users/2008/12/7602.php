...
?>
<!-- received="Wed Dec 24 22:36:39 2008" -->
<!-- isoreceived="20081225033639" -->
<!-- sent="Wed, 24 Dec 2008 22:36:31 -0500" -->
<!-- isosent="20081225033631" -->
<!-- name="Win Than Aung" -->
<!-- email="keshunli_at_[hidden]" -->
<!-- subject="Re: [OMPI users] sending message to the source(0) from other processors" -->
<!-- id="9247a3360812241936r45e36876x582205b601e525f1_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2008-12-24 22:36:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7603.php">Win Than Aung: "Re: [OMPI users] sending message to the source(0) from other processors"</a>
<li><strong>Previous message:</strong> <a href="7601.php">Win Than Aung: "Re: [OMPI users] sending message to the source(0) from other processors"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7603.php">Win Than Aung: "Re: [OMPI users] sending message to the source(0) from other processors"</a>
<li><strong>Reply:</strong> <a href="7603.php">Win Than Aung: "Re: [OMPI users] sending message to the source(0) from other processors"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;{
<br>
<p>MPI_Recv(recv_buffer,MAX_STR_LEN,MPI_BYTE,MPI_ANY_TAG,MPI_COMM_WORLD,&amp;status);
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;}
<br>
...
<br>
<p>My question is how do i know which sentbuffer has even add values and which
<br>
...
winthan
<br>
<p>On Tue, Dec 23, 2008 at 3:53 PM, Eugene Loh &lt;Eugene.Loh_at_[hidden]&gt; wrote:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-7602/attachment">attachment</a>
</ul>
