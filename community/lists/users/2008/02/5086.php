...
?>
<!-- received="Wed Feb 27 14:32:29 2008" -->
<!-- isoreceived="20080227193229" -->
<!-- sent="Wed, 27 Feb 2008 14:32:22 -0500" -->
<!-- isosent="20080227193222" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI 1.2.5 race condition / core dump with MPI_Reduce and MPI_Gather" -->
<!-- id="CDED2B35-C65A-423C-8992-2529A4EF5406_at_eecs.utk.edu" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2008-02-27 14:32:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5087.php">Teige,  Scott W: "[OMPI users] Cannot build 1.2.5"</a>
<li><strong>Previous message:</strong> <a href="5085.php">George Bosilca: "Re: [OMPI users] Help understanding build option and warning messages, OMPI 1.2.4"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5094.php">John Markus Bjørndalen: "Re: [OMPI users] OpenMPI 1.2.5 race condition / core dump with	MPI_Reduce and MPI_Gather"</a>
<li><strong>Reply:</strong> <a href="5094.php">John Markus Bjørndalen: "Re: [OMPI users] OpenMPI 1.2.5 race condition / core dump with	MPI_Reduce and MPI_Gather"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
problem.
<br>
<p>Upon receiving a fragment from the BTL (lower layer) we try to match  
<br>
...
<br>
the data inside. When a node is flooded with unexpected messages, we  
<br>
will end up using the whole memory of the host (or reaching the  
<br>
maximum limit of the free list) and will be unable to allocate the  
<br>
unexpected fragment. In order to release some elements from the free  
<br>
list we have to do some progress, which is described here by the call  
<br>
to opal_progress. This is actually quite bad, as progressing the  
<br>
network will NOT release any unexpected messages. Instead, we should  
<br>
go up to the matching layer, and make sure that the original request  
<br>
can now be matched, which will give us one spot in the free list.
<br>
<p>The problem with this new approach is that the BTL will have to be  
<br>
modified to be able to retain a fragment if the PML was unable to take  
<br>
care of it (i.e. copy it in the user memory or in the preallocated  
<br>
space used for unexpected messages).
<br>
<p>On the other side, I hope that not many users write such applications.  
<br>
...
<br>
<p>One more thing, doing a lot of collective in a loop and computing the  
<br>
...
<span class="quotelev2">&gt;&gt; On Feb 22, 2008, at 9:48 AM, John Markus Bj&#195;&#184;rndalen wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; // John Markus Bj&#195;&#184;rndalen
</span><br>
...
<br><hr>
<ul>
<li>application/pkcs7-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-5086/smime.p7s">smime.p7s</a>
</ul>
