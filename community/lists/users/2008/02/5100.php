<?
$subject_val = "Re: [OMPI users] OpenMPI on intel core 2 duo machine for parallel computation.";
include("../../include/msg-header.inc");
?>
<!-- received="Thu Feb 28 17:52:26 2008" -->
<!-- isoreceived="20080228225226" -->
<!-- sent="Thu, 28 Feb 2008 17:51:20 -0500" -->
<!-- isosent="20080228225120" -->
<!-- name="Brock Palen" -->
<!-- email="brockp_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI on intel core 2 duo machine for parallel computation." -->
<!-- id="BE23B7D8-9E33-4A1A-A20D-ECCEBC143373_at_umich.edu" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="3142CF519A6B204896E248FD59CB7FB20E1A06_at_MST-VMAIL3.srv.mst.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] OpenMPI on intel core 2 duo machine for parallel computation.<br>
<strong>From:</strong> Brock Palen (<em>brockp_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-02-28 17:51:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5101.php">Chembeti, Ramesh (S&T-Student): "Re: [OMPI users] OpenMPI on intel core 2 duo machine for parallelcomputation."</a>
<li><strong>Previous message:</strong> <a href="5099.php">Gregory John Orris: "[OMPI users] ScaLapack and BLACS on Leopard"</a>
<li><strong>In reply to:</strong> <a href="5098.php">Chembeti, Ramesh (S&amp;T-Student): "[OMPI users] OpenMPI on intel core 2 duo machine for parallel computation."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5101.php">Chembeti, Ramesh (S&T-Student): "Re: [OMPI users] OpenMPI on intel core 2 duo machine for parallelcomputation."</a>
<li><strong>Reply:</strong> <a href="5101.php">Chembeti, Ramesh (S&T-Student): "Re: [OMPI users] OpenMPI on intel core 2 duo machine for parallelcomputation."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
