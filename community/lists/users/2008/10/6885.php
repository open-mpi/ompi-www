...
?>
<!-- received="Tue Oct  7 12:50:53 2008" -->
<!-- isoreceived="20081007165053" -->
<!-- sent="Tue, 7 Oct 2008 12:48:14 -0400" -->
<!-- isosent="20081007164814" -->
<!-- name="Hahn Kim" -->
<!-- email="hgk_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem launching onto Bourne shell" -->
<!-- id="63CA0FF8-3EB0-445F-BE85-7E7585812D12_at_ll.mit.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="16CBB998-C2E4-45EE-B680-45D432ADFE95_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-10-07 12:48:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6886.php">Terry Dontje: "[OMPI users]  OMPI link error with petsc 2.3.3"</a>
<li><strong>Previous message:</strong> <a href="6884.php">Yann JOBIC: "Re: [OMPI users] OMPI link error with petsc 2.3.3"</a>
<li><strong>In reply to:</strong> <a href="6883.php">Jeff Squyres: "Re: [OMPI users] Problem launching onto Bourne shell"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6887.php">Jeff Squyres: "Re: [OMPI users] Problem launching onto Bourne shell"</a>
<li><strong>Reply:</strong> <a href="6887.php">Jeff Squyres: "Re: [OMPI users] Problem launching onto Bourne shell"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Regarding 1., we're actually using 1.2.5.  We started using Open MPI  
<br>
...
<br>
<p>Regarding 2., are you saying I should run the commands you suggest  
<br>
from the x86 node running bash, so that ssh logs into the Cell node  
<br>
running Bourne?
<br>
<p>When I run &quot;ssh othernode env&quot; from the x86 node, I get the following  
<br>
vanilla environment:
<br>
<p>USER=ha17646
...
PWD=/home/ha17646
<br>
<p>When I run &quot;ssh othernode&quot; from the x86 node, then run &quot;env&quot; on the  
<br>
...
<p>Hahn
<br>
<p>On Oct 7, 2008, at 12:07 PM, Jeff Squyres wrote:
<br>
<p><span class="quotelev1">&gt; Ralph and I just talked about this a bit:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; 1. In all released versions of OMPI, we *do* source the .profile file
</span><br>
<span class="quotelev1">&gt; on the target node if it exists (because vanilla Bourne shells do not
</span><br>
<span class="quotelev1">&gt; source anything on remote nodes -- Bash does, though, per the FAQ).
</span><br>
<span class="quotelev1">&gt; However, looking in 1.2.7, it looks like it might not be executing
</span><br>
<span class="quotelev1">&gt; that code -- there *may* be a bug in this area.  We're checking into  
</span><br>
<span class="quotelev1">&gt; it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; 2. You might want to check your configuration to see if your .bashrc
</span><br>
<span class="quotelev1">&gt; is dumping out early because it's a non-interactive shell.  Check the
</span><br>
...
<span class="quotelev1">&gt; (i.e., a non-interactive running of &quot;env&quot; vs. an interactive login and
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Great, that worked, thanks!  However, it still concerns me that the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; FAQ page says that mpirun will execute .profile which doesn't seem
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to work for me.  Are there any configuration issues that could
</span><br>
<span class="quotelev3">&gt;&gt;&gt; possibly be preventing mpirun from doing this?  It would certainly
</span><br>
<span class="quotelev3">&gt;&gt;&gt; be more convenient if I could maintain my environment in a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; single .profile file instead of adding what could potentially be a
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; tYou can forward your local env with mpirun -x LD_LIBRARY_PATH. As
</span><br>
