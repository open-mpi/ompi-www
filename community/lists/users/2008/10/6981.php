...
?>
<!-- received="Tue Oct 14 15:34:03 2008" -->
<!-- isoreceived="20081014193403" -->
<!-- sent="Tue, 14 Oct 2008 13:33:55 -0600" -->
<!-- isosent="20081014193355" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Passing LD_LIBRARY_PATH to orted" -->
<!-- id="2AAC92D7-22A0-4733-BC49-C3C512AFF319_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="41626378-49E6-4382-ACB4-96B016D7EBF2_at_eecs.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-10-14 15:33:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6982.php">Doug Reeder: "Re: [OMPI users] Passing LD_LIBRARY_PATH to orted"</a>
<li><strong>Previous message:</strong> <a href="6980.php">George Bosilca: "Re: [OMPI users] Passing LD_LIBRARY_PATH to orted"</a>
<li><strong>In reply to:</strong> <a href="6980.php">George Bosilca: "Re: [OMPI users] Passing LD_LIBRARY_PATH to orted"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6982.php">Doug Reeder: "Re: [OMPI users] Passing LD_LIBRARY_PATH to orted"</a>
<li><strong>Reply:</strong> <a href="6982.php">Doug Reeder: "Re: [OMPI users] Passing LD_LIBRARY_PATH to orted"</a>
<li><strong>Reply:</strong> <a href="6984.php">Craig Tierney: "Re: [OMPI users] Passing LD_LIBRARY_PATH to orted"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
work.
<br>
<p>Also, though, I have noted that LD_LIBRARY_PATH does seem to be  
<br>
...
<br>
<p>Craig: what environment are you using? ssh?
<br>
Ralph
<br>
<p><p><p>On Oct 14, 2008, at 1:18 PM, George Bosilca wrote:
<br>
<p><span class="quotelev1">&gt; I use modules too, but they only work locally. Or is there a feature  
</span><br>
<span class="quotelev1">&gt; in &quot;module&quot; to automatically load the list of currently loaded local  
</span><br>
<span class="quotelev1">&gt; modules remotely ?
</span><br>
...
<span class="quotelev2">&gt;&gt; You might consider using something like  &quot;module&quot; - we use that  
</span><br>
<span class="quotelev2">&gt;&gt; system for exactly this reason. Works quite well and solves the  
</span><br>
<span class="quotelev2">&gt;&gt; multiple compiler issue.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The option to expand the remote LD_LIBRARY_PATH, in such a way  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; that Open MPI related applications have their dependencies  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; satisfied, is in the trunk. The fact that the compiler requires  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; some LD_LIBRARY_PATH is out of the scope of an MPI  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; implementation, and I don't think we should take care of it.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Passing the local LD_LIBRARY_PATH to the remote nodes doesn't  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; make much sense. There are plenty of environment, where the head  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; node have a different configuration than the compute nodes.  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Again, in this case my original solution seems not that bad. If  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; you copy (or make a link if you prefer) in the Open MPI lib  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; directory to the compiler shared libraries, this will work.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; george.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; This does work.  It just increases maintenance for each new version
</span><br>
<span class="quotelev3">&gt;&gt;&gt; of OpenMPI.   How often does a head node have a different  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configuration
</span><br>
<span class="quotelev3">&gt;&gt;&gt; than the compute node?  It would see that this would even more  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; support the
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; problem) is to copy these libraries somewhere on my home area  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; and to add the directory to my LD_LIBRARY_PATH.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; george.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; This is ok when you only ever use one compiler, but it isn't  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; very flexible.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; multiple versions of compilers.  I can't just list all of the  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; lib paths
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Or is it better to just build the OpenMPI tools statically?  We  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; also
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; use other compilers (PGI, Lahey) so I need a solution that works  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; correctly.  Mpirun passes LD_LIBRARY_PATH to the executable I  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; am launching, but not orted.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; shared libraries: libintlc.so.5: cannot open shared object  
</span><br>
