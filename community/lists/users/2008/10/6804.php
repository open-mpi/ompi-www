...
<!-- id="36767.138.4.40.23.1222870757.squirrel_at_webmail.grpss.ssr.upm.es" -->
<!-- charset="iso-8859-1" -->
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6805.php">saparicio_at_[hidden]: "Re: [OMPI users] Problem with MPI_Send and MPI_Recv"</a>
<li><strong>Previous message:</strong> <a href="6803.php">Ralph Castain: "Re: [OMPI users] Running application with MPI_Comm_spawn()	in	multithreaded environment"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6805.php">saparicio_at_[hidden]: "Re: [OMPI users] Problem with MPI_Send and MPI_Recv"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
