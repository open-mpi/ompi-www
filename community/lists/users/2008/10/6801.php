...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6802.php">Roberto Fichera: "Re: [OMPI users] Running application with MPI_Comm_spawn()	in	multithreaded environment"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2008/09/6800.php">Ralph Castain: "Re: [OMPI users] Running application with MPI_Comm_spawn() in	multithreaded environment"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6804.php">saparicio_at_[hidden]: "Re: [OMPI users] Problem with MPI_Send and MPI_Recv"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
