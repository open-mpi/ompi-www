...
?>
<!-- received="Tue Oct 21 18:40:26 2008" -->
<!-- isoreceived="20081021224026" -->
<!-- sent="Wed, 22 Oct 2008 00:40:17 +0200" -->
<!-- isosent="20081021224017" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI runtime-specific environment variable?" -->
<!-- id="9CDF1810-19D1-46B1-B4B6-6D0C3A90C0A7_at_staff.uni-marburg.de" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-10-21 18:40:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7068.php">Adams, Brian M: "Re: [OMPI users] OpenMPI runtime-specific environment variable?"</a>
<li><strong>Previous message:</strong> <a href="7066.php">Doug Reeder: "Re: [OMPI users] OpenMPI runtime-specific environment variable?"</a>
<li><strong>In reply to:</strong> <a href="7065.php">Adams, Brian M: "Re: [OMPI users] OpenMPI runtime-specific environment variable?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7070.php">Jed Brown: "Re: [OMPI users] OpenMPI runtime-specific environment variable?"</a>
<li><strong>Reply:</strong> <a href="7070.php">Jed Brown: "Re: [OMPI users] OpenMPI runtime-specific environment variable?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Okay, now I see. Why not just call MPI_Comm_size(MPI_COMM_WORLD,  
<br>
...
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; The binary foo then determines at run-time whether it is to run in  
</span><br>
