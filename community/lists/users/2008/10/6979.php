<?
$subject_val = "[OMPI users] Open MPI v1.2.8 released";
...
<!-- subject="[OMPI users] Open MPI v1.2.8 released" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Open MPI v1.2.8 released<br>
<strong>From:</strong> Tim Mattox (<em>timattox_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-10-14 15:14:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6980.php">George Bosilca: "Re: [OMPI users] Passing LD_LIBRARY_PATH to orted"</a>
<li><strong>Previous message:</strong> <a href="6978.php">Ralph Castain: "Re: [OMPI users] Passing LD_LIBRARY_PATH to orted"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
