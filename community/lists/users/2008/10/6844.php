...
?>
<!-- received="Fri Oct  3 08:54:41 2008" -->
<!-- isoreceived="20081003125441" -->
<!-- sent="Fri, 3 Oct 2008 06:54:34 -0600" -->
<!-- isosent="20081003125434" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running application	with	MPI_Comm_spawn()	in	multithreaded environment" -->
<!-- id="40080603-4BC7-4006-8258-2C17ABC88858_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="48E5FBD9.1070306_at_tekno-soft.it" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-10-03 08:54:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6845.php">Roberto Fichera: "Re: [OMPI users] Running application with MPI_Comm_spawn() in multithreaded environment"</a>
<li><strong>Previous message:</strong> <a href="6843.php">Eric Thibodeau: "[OMPI users] Tuned Collective MCA params"</a>
<li><strong>In reply to:</strong> <a href="6841.php">Roberto Fichera: "Re: [OMPI users] Running application	with	MPI_Comm_spawn()	in	multithreaded environment"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6845.php">Roberto Fichera: "Re: [OMPI users] Running application with MPI_Comm_spawn() in multithreaded environment"</a>
<li><strong>Reply:</strong> <a href="6845.php">Roberto Fichera: "Re: [OMPI users] Running application with MPI_Comm_spawn() in multithreaded environment"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Ralph
<br>
<p>On Oct 3, 2008, at 5:02 AM, Roberto Fichera wrote:
<br>
<p><span class="quotelev1">&gt; Ralph Castain ha scritto:
</span><br>
<span class="quotelev2">&gt;&gt; Actually, it just occurred to me that you may be seeing a problem in
</span><br>
<span class="quotelev2">&gt;&gt; comm_spawn itself that I am currently chasing down. It is in the 1.3
</span><br>
<span class="quotelev2">&gt;&gt; branch and has to do with comm_spawning procs on subsets of nodes
</span><br>
<span class="quotelev2">&gt;&gt; (instead of across all nodes). Could be related to this - you might
</span><br>
<span class="quotelev2">&gt;&gt; want to give me a chance to complete the fix. I have identified the
</span><br>
<span class="quotelev2">&gt;&gt; problem and should have it fixed later today in our trunk - probably
</span><br>
...
<span class="quotelev2">&gt;&gt; On Oct 1, 2008, at 10:43 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Afraid I am somewhat at a loss. The logs indicate that mpirun itself
</span><br>
<span class="quotelev3">&gt;&gt;&gt; is having problems, likely caused by the threading. Only thing I can
</span><br>
<span class="quotelev3">&gt;&gt;&gt; suggest is that you &quot;unthread&quot; the spawning loop and try it that way
</span><br>
<span class="quotelev3">&gt;&gt;&gt; first so we can see if some underlying problem exists.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; FWIW: I have run a loop over calls to comm_spawn without problems.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; However, there are system limits to the number of child processes an
</span><br>
<span class="quotelev3">&gt;&gt;&gt; orted can create. You may hit those at some point - we try to report
</span><br>
<span class="quotelev3">&gt;&gt;&gt; that as a separate error when we see it, but it isn't always easy to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; catch.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Like I said, we really don't support threaded operations like this
</span><br>
<span class="quotelev3">&gt;&gt;&gt; right now, so I have no idea what your app may be triggering. I  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; would
</span><br>
<span class="quotelev3">&gt;&gt;&gt; definitely try it &quot;unthreaded&quot; if possible.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Oct 1, 2008, at 9:04 AM, Roberto Fichera wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Ralph Castain ha scritto:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Okay, I believe I understand the problem. What this error is  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; telling
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; you is that the Torque MOM is refusing our connection request  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; true? The problem with that design is that - since OMPI is not  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; thread
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; safe yet - these threads are all attempting to connect to the  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; MOM at
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the same time. The MOM will only allow one connection at a time,  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; and
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; so at some point we are requesting a connection while already
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 1. you could do this with a single comm_spawn call. Remember,  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; you can
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; provide an MPI_Info key to comm_spawn essentially telling it  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; where to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; place the various process ranks. Unless you truly want each new
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; process to be in its own comm_world, there is no real need to do  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; this
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; with 10000 individual calls to comm_spawn.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I need only a master to single slave communication, the slaves
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; *doesn't*
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; need to communicate all together. The logic within the test program
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is quite easy, it will dispatch as many jobs as the user need  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; across
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; assigned nodes, try to take it busy as much as possible. That's  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; because
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; our algorithms need a tree evolution where a node is master of a  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; bounch
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; of slaves, and a slave can be a sub-master of a bounch of slaves,  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; this
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; depends by how the each leaf will evolve in its computation.  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Generally
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; we don't go to much than 5 o 6 levels in deep. But we need a very
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; dynamic logic for dispatching jobs.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I done it with and without _tm_ support and using a mutex to  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; serialize
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the MPI_Comm_spawn().
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The log below is using the torque/pbs support compiled in:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [roberto_at_master TestOpenMPI]$ mpirun --verbose --debug-daemons - 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; wdir
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; &quot;`pwd`&quot; -np 1 testmaster 100000 $PBS_NODEFILE
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:07844] [[10231,0],0] orted_cmd: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; add_local_procs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:07844] [[10231,0],0] node[0].name master  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:07844] [[10231,0],0] node[1].name cluster4  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:07844] [[10231,0],0] node[2].name cluster3  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:07844] [[10231,0],0] node[3].name cluster2  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:07844] [[10231,0],0] node[4].name cluster1  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; INVALID arch ffc91200
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:07844] [[10231,0],0] orted_recv: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; sync+nidmap from local proc [[10231,1],0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:07844] [[10231,0],0] orted_cmd: received
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; '/var/torque/aux//929.master.tekno-soft.it'
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Daemon [[10231,0],1] checking in as pid 4869 on host
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; cluster4.tekno-soft.it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Daemon [[10231,0],1] not using static ports
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] orted: up and  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] orted_cmd: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; add_local_procs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] node[0].name master  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 0 arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] node[1].name cluster4
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon 1 arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] node[2].name cluster3
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] node[3].name cluster2
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] node[4].name cluster1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] orted_recv: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; sync+nidmap from local proc [[10231,2],0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] orted_cmd: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; collective data cmd
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] routed:binomial:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Connection
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; to lifeline [[10231,0],0] lost
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:04869] [[10231,0],1] routed:binomial:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Connection
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [roberto_at_master TestOpenMPI]$
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; this one is *without-tm*
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [roberto_at_master TestOpenMPI]$ mpirun --verbose --debug-daemons - 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:25143] [[23396,0],0] orted_cmd: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; add_local_procs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:25143] [[23396,0],0] node[0].name master  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:25143] [[23396,0],0] node[1].name cluster4  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:25143] [[23396,0],0] node[2].name cluster3  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:25143] [[23396,0],0] node[3].name cluster2  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:25143] [[23396,0],0] node[4].name cluster1  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; INVALID arch ffc91200
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:25143] [[23396,0],0] orted_recv: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; sync+nidmap from local proc [[23396,1],0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [master.tekno-soft.it:25143] [[23396,0],0] orted_cmd: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; collective data cmd
...
<span class="quotelev4">&gt;&gt;&gt;&gt; '/var/torque/aux//928.master.tekno-soft.it'
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ... adding node #1 host is 'cluster4.tekno-soft.it'
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ... adding node #2 host is 'cluster3.tekno-soft.it'
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Daemon [[23396,0],1] checking in as pid 3653 on host
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; cluster4.tekno-soft.it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Daemon [[23396,0],1] not using static ports
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] orted: up and  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; running -
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; waiting for commands!
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] orted_cmd: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; add_local_procs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] node[0].name master  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 0 arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] node[1].name cluster4
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon 1 arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] node[2].name cluster3
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] node[3].name cluster2
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] node[4].name cluster1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; daemon INVALID arch ffc91200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] orted_recv: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; sync+nidmap from local proc [[23396,2],0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] orted_cmd: received
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; collective data cmd
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [... got a freeze here ... than ^C ...]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun noticed that process rank 0 with PID 25150 on node
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; master.tekno-soft.it exited on signal 0 (Unknown signal 0).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4.tekno-soft.it:03653] [[23396,0],1] orted: finalizing
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun: clean termination accomplished
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4:03653] *** Process received signal ***
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4:03653] Signal: Segmentation fault (11)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4:03653] Signal code: Address not mapped (1)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [cluster4:03653] Failing at address: 0x2aaaab784af0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So it seem that we have some problem in other places, maybe some  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; other
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; functions are not
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; thread safe.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 3. remove the threaded launch scenario and just call comm_spawn  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; gaining you anything. Torque will only do one launch at a time  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Talking about torque/pbs/maui, that's ok! It doen't handle multiple
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; spawn at the same time.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; But in general, if I don't used _tm_ any more, I guess that we can
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; get a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; gain on executing parallel spawn,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; because the spawn will be done using ssh/rsh.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; There is something wrong with this cmd line - perhaps it wasn't
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; copied
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'm not sure if this is the problem or not, but I am unaware  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; of such
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [roberto_at_master TestOpenMPI]$ mpirun --debug-daemons --mca btl
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; tcp,self
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [master.tekno-soft.it:05407] [[11340,0],0] node[0].name master
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; daemon 0
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; arch ffc91200
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [master.tekno-soft.it:05407] [[11340,0],0] node[1].name cluster4
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; INVALID arch ffc91200
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [master.tekno-soft.it:05407] [[11340,0],0] node[2].name cluster3
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; INVALID arch ffc91200
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [master.tekno-soft.it:05407] [[11340,0],0] node[3].name cluster2
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; INVALID arch ffc91200
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [master.tekno-soft.it:05407] [[11340,0],0] node[4].name cluster1
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; daemon
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; INVALID arch ffc91200
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; At least one node is available, let's start to distribute  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 100000 job
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Daemon was launched on cluster3.tekno-soft.it - beginning to
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [master.tekno-soft.it:05407] [[11340,0],0] ORTE_ERROR_LOG:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Resource busy
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; in file base/plm_base_receive.c at line 169
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [master.tekno-soft.it:05414] [[11340,1],0] ORTE_ERROR_LOG: The
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; specified
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; application failed to start in file dpm_orte.c at line 677
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [master.tekno-soft.it:05414] *** An error occurred in  
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [cluster3.tekno-soft.it:09487] [[11340,0],1] orted: up and  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; composed by a master, which spawn a slave in each assigned  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; number of jobs to perform and a filename, containing the  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; list of
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; assigned nodes. The idea is to handle all the dispatching
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; logic within the application, so that the master will try to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; take as
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; busy as possible each assigned node. Said that, for each  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; spawned
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; job, the master allocate a thread for spawning and handling  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; communication, than generate a random number, send it to the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; slave which simply send it back to the master. Finally the  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; slave
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; terminate its job and the relative node become free for a  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; new one.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The things will continue until all the requested jobs are  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; increasing of its internal context id which basically stops  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; application due to a library internal overflow. The internal
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; for each terminated spawned job, are never recycled at  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; moment. The
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; unique MPI-2 implementation, so supporting MPI_Comm_spawn(),
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; which was able to complete the test is currently the HP MPI.  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; So
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; now I
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; My first attempt end up on the error below which I basically  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; don't
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; know
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; where to look further. Note that I've already checked PATHs  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; and
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; LD_LIBRARY_PATH, the application is basically configured  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; correctly
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; since
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; it uses two scripts for starting and all the paths are set  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; there.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Basically I need to start *one* master application which will
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; handle
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; all
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the things for managing slave applications. The  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; communication is
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; At least one node is available, let's start to distribute  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Spawning a task './testslave.sh' on node 'cluster3.tekno- 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Spawning a task './testslave.sh' on node 'cluster2.tekno- 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; soft.it'
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Spawning a task './testslave.sh' on node 'cluster1.tekno- 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; soft.it'
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Spawning a task './testslave.sh' on node 'master.tekno- 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; soft.it'
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
