...
?>
<!-- received="Thu Oct 16 19:05:47 2008" -->
<!-- isoreceived="20081016230547" -->
<!-- sent="Thu, 16 Oct 2008 16:05:32 -0700 (PDT)" -->
<!-- isosent="20081016230532" -->
<!-- name="Mostyn Lewis" -->
<!-- email="Mostyn.Lewis_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem launching onto Bourne shell" -->
<!-- id="Pine.GSO.4.64.0810161602220.6332_at_aragorn.brc.West.Sun.COM" -->
<!-- charset="X-UNKNOWN" -->
...
<strong>Date:</strong> 2008-10-16 19:05:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7006.php">Mostyn Lewis: "[OMPI users] --mca btl_openib_if_include"</a>
<li><strong>Previous message:</strong> <a href="7004.php">Aleksej Saushev: "Re: [OMPI users] OpenMPI portability problems: debug info isn't helpful"</a>
<li><strong>In reply to:</strong> <a href="6927.php">Jeff Squyres: "Re: [OMPI users] Problem launching onto Bourne shell"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7015.php">Jeff Squyres: "Re: [OMPI users] Problem launching onto Bourne shell"</a>
<li><strong>Reply:</strong> <a href="7015.php">Jeff Squyres: "Re: [OMPI users] Problem launching onto Bourne shell"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Jeff,
<br>
<p>You broke my ksh (and I expect something else)
<br>
...
Mostyn
<br>
<p>On Thu, 9 Oct 2008, Jeff Squyres wrote:
<br>
<p><span class="quotelev1">&gt; FWIW, the fix has been pushed into the trunk, 1.2.8, and 1.3 SVN branches. 
</span><br>
<span class="quotelev1">&gt; So I'll probably take down the hg tree (we use those as temporary branches).
</span><br>
...
<span class="quotelev2">&gt;&gt; Thanks for providing a fix, sorry for the delay in response.  Once I found 
</span><br>
<span class="quotelev2">&gt;&gt; out about -x, I've been busy working on the rest of our code, so I haven't 
</span><br>
<span class="quotelev2">&gt;&gt; had the time to try out the fix.  I'll take a look at it soon as I can and 
</span><br>
<span class="quotelev2">&gt;&gt; will let you know how it works out.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; If you're using Bash, it should be running .bashrc.  But it looks like
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; However, according to the OpenMPI FAQ 
</span><br>
