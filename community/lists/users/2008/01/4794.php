<?
$subject_val = "[OMPI users] Open MPI v1.2.5 released";
...
<!-- subject="[OMPI users] Open MPI v1.2.5 released" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Open MPI v1.2.5 released<br>
<strong>From:</strong> Tim Mattox (<em>timattox_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-01-08 14:48:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4795.php">Jeff Squyres: "Re: [OMPI users] MPI/Pro Error"</a>
<li><strong>Previous message:</strong> <a href="4793.php">Parag Kalra: "[OMPI users] MPI/Pro Error"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4796.php">Francesco Pietra: "Re: [OMPI users] Open MPI v1.2.5 released"</a>
<li><strong>Reply:</strong> <a href="4796.php">Francesco Pietra: "Re: [OMPI users] Open MPI v1.2.5 released"</a>
<li><strong>Maybe reply:</strong> <a href="4800.php">Warner Yuen: "Re: [OMPI users] Open MPI v1.2.5 released"</a>
<li><strong>Maybe reply:</strong> <a href="4808.php">8mj6tc902_at_[hidden]: "Re: [OMPI users] Open MPI v1.2.5 released"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
