...
?>
<!-- received="Tue Jun 17 10:35:13 2008" -->
<!-- isoreceived="20080617143513" -->
<!-- sent="Tue, 17 Jun 2008 10:35:06 -0400" -->
<!-- isosent="20080617143506" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] help me please, about Open MPI" -->
<!-- id="2510D75C-F542-4739-89EE-4C803CDED6B5_at_cisco.com" -->
<!-- charset="WINDOWS-1252" -->
<!-- inreplyto="BAY104-W215F357F1E740479BAB695FDA80_at_phx.gbl" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-06-17 10:35:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5904.php">Jeff Squyres: "Re: [OMPI users] OpenMPI with bounds checking"</a>
<li><strong>Previous message:</strong> <a href="5902.php">Tony Smith: "Re: [OMPI users] help me please, about Open MPI"</a>
<li><strong>In reply to:</strong> <a href="5902.php">Tony Smith: "Re: [OMPI users] help me please, about Open MPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5910.php">Tony Smith: "[OMPI users] [SPAM:### 82%] RE:  help me please, about Open MPI"</a>
<li><strong>Reply:</strong> <a href="5910.php">Tony Smith: "[OMPI users] [SPAM:### 82%] RE:  help me please, about Open MPI"</a>
<li><strong>Reply:</strong> <a href="5911.php">Tony Smith: "Re: [OMPI users] help me please, about Open MPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Do you have the TMPDIR or TMP environment variables set?  If so, is  
<br>
that directory also world-writable?  (if set, these will override the  
<br>
default location of /tmp)
<br>
<p>The error you are seeing (session directory failed) usually has to do  
<br>
with ORTE not being able to create a session directory for the user.
<br>
<p><p><p>On Jun 17, 2008, at 10:27 AM, Tony Smith wrote:
<br>
...
<span class="quotelev3">&gt; &gt; &gt; /ptmp/myname/openmpi123/ompi123_install/bin/mpirun -np 8 /ptmp/
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; But, how can I make sure that the application is run by Open  
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; You could enforce a certain mpirun by using its absolute path,  
</span><br>
