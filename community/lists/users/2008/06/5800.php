...
?>
<!-- received="Wed Jun  4 12:50:17 2008" -->
<!-- isoreceived="20080604165017" -->
<!-- sent="Wed, 4 Jun 2008 12:50:06 -0400" -->
<!-- isosent="20080604165006" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi 32-bit g++ compilation issue" -->
<!-- id="F2F8AAC9-9471-4258-A2DE-CA5CF23C5761_at_cisco.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-06-04 12:50:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5801.php">Jeff Squyres: "Re: [OMPI users] ORTE_ERROR_LOG Timeout"</a>
<li><strong>Previous message:</strong> <a href="5799.php">Leonardo Fialho: "[OMPI users] tg3 module"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2008/05/5704.php">Arif Ali: "[OMPI users] openmpi 32-bit g++ compilation issue"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>This looks like a problem on your system -- I think Doug is right:  
<br>
...
<br>
<p><p>On May 19, 2008, at 5:48 PM, Arif Ali wrote:
<br>
...
<span class="quotelev1">&gt; Or is there any other way of getting this to work. I feel that there  
</span><br>
<span class="quotelev1">&gt; may be something very silly here that I have missed out. but I can't  
</span><br>
<span class="quotelev1">&gt; seem to gather it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; 4.1.2/../../../../x86_64-suse-linux/lib -L/usr/lib64/gcc/x86_64-suse- 
</span><br>
<span class="quotelev1">&gt; linux/4.1.2/../../.. /usr/lib64/gcc/x86_64-suse-linux/4.1.2/libstdc+ 
</span><br>
<span class="quotelev1">&gt; +.so -lm -lpthread -lc -lgcc_s /usr/lib64/gcc/x86_64-suse-linux/ 
</span><br>
<span class="quotelev1">&gt; 4.1.2/32/crtendS.o /usr/lib64/gcc/x86_64-suse-linux/ 
</span><br>
