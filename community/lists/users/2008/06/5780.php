...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Proper way to throw an error to all nodes?<br>
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5781.php">Scott Shaw: "[OMPI users] OpenMPI scaling &gt; 512 cores"</a>
<li><strong>Previous message:</strong> <a href="5779.php">Ayer, Timothy  C.: "[OMPI users] HPMPI versus OpenMPI performance"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5784.php">Terry Frankcombe: "Re: [OMPI users] Proper way to throw an error to all nodes?"</a>
<li><strong>Reply:</strong> <a href="5784.php">Terry Frankcombe: "Re: [OMPI users] Proper way to throw an error to all nodes?"</a>
<li><strong>Maybe reply:</strong> <a href="5785.php">David Singleton: "Re: [OMPI users] Proper way to throw an error to all nodes?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
