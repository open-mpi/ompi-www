...
?>
<!-- received="Mon Jun 23 12:17:47 2008" -->
<!-- isoreceived="20080623161747" -->
<!-- sent="Mon, 23 Jun 2008 12:17:39 -0400" -->
<!-- isosent="20080623161739" -->
<!-- name="Sacerdoti, Federico" -->
<!-- email="Federico.Sacerdoti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] SLURM and OpenMPI" -->
<!-- id="AE3C65E73659C647AD0EBCF50DC996BF057E7B_at_maildrd1.nyc.deshaw.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="200806191424.m5JEOhiT020490_at_master.deshaw.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-06-23 12:17:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5971.php">Joshua Bernstein: "Re: [OMPI users] Displaying Selected MCA Modules"</a>
<li><strong>Previous message:</strong> <a href="5969.php">Todd Gamblin: "Re: [OMPI users] Working directory isn't set properly on Linux cluster"</a>
...
Ralph, 
<br>
<p>Thanks for your reply. Let me know if I can help in any way.
<br>
<p>fds 
<br>
<p>-----Original Message-----
...
Subject: Re: [OMPI users] SLURM and OpenMPI
<br>
<p>Well, if the only system I cared about was slurm, there are some things
<br>
I
<br>
...
<br>
<p>Frankly, one reason we don't put more emphasis on it is that we don't
<br>
see a
<br>
...
<br>
<p>So I would say we simply have different objectives than what you stated,
<br>
and
<br>
...
<span class="quotelev1">&gt; no-longer-valid allocation, an srun will correctly exit non-zero with
</span><br>
a
<br>
...
<span class="quotelev1">&gt; srun: error: Unable to confirm allocation for job 745346: Invalid job
</span><br>
id
<br>
<span class="quotelev1">&gt; specified
</span><br>
<span class="quotelev1">&gt; srun: Check SLURM_JOBID environment variable for expired or invalid
</span><br>
job.
<br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Regarding srun to launch the jobs directly (no orteds), I am sad to
</span><br>
hear
<br>
<span class="quotelev1">&gt; the idea is not in favor. We have found srun to be extremely scalable
</span><br>
<span class="quotelev1">&gt; (tested up to 4096 MPI processes) and very good at cleaning up after
</span><br>
an
<br>
...
<span class="quotelev1">&gt; was used for several years. I wrote a lot of logic to run down and
</span><br>
stop
<br>
<span class="quotelev1">&gt; all processes when one had failed, which I understand you have as
</span><br>
well.
<br>
<span class="quotelev1">&gt; We came to the conclusion that slurm was in a better position to
</span><br>
handle
<br>
<span class="quotelev1">&gt; such failures, and in fact did it more effectively. For example if
</span><br>
slurm
<br>
<span class="quotelev1">&gt; detects a node has failed, it will stop the job, allocate an
</span><br>
additional
<br>
...
<span class="quotelev1">&gt; release, but there is no plan to retrofit those changes to 1.2. Part
</span><br>
of
<br>
...
<span class="quotelev1">&gt; internally from inside orterun. The only real difference is that we
</span><br>
use
<br>
...
<span class="quotelev1">&gt; do. The issues you are seeing relate to our ability to detect that
</span><br>
srun
<br>
...
<span class="quotelev1">&gt; something they were supposed to do. The 1.2 system has problems in
</span><br>
that
<br>
...
<span class="quotelev1">&gt; srun to launch the daemons - the only reason we hang is that srun is
</span><br>
not
<br>
...
<span class="quotelev1">&gt; We are unlikely to use srun to directly launch jobs (i.e., to have
</span><br>
slurm
<br>
...
<span class="quotelev2">&gt;&gt; 1. Orterun will happily hang if it is asked to run on an invalid
</span><br>
slurm
<br>
...
<span class="quotelev2">&gt;&gt; error. In this case the executable does not exist, and we would
</span><br>
expect
<br>
...
<span class="quotelev2">&gt;&gt; are only lightly integrated with SLURM at this time. We use SLURM as
</span><br>
a
<br>
...
<span class="quotelev2">&gt;&gt; which leaves the user with little flexibility to specify their
</span><br>
desired
<br>
...
<span class="quotelev2">&gt;&gt; Hope this helps (and we are looking forward to a tighter
</span><br>
orterun/slurm
<br>
...
<span class="quotelev2">&gt;&gt; documentation, it would seem to imply that srun will attempt to
</span><br>
launch
<br>
...
<span class="quotelev2">&gt;&gt; doesn't specify the #procs to mpirun. In that case, mpirun will
</span><br>
launch
<br>
<span class="quotelev1">&gt; a
</span><br>
<span class="quotelev2">&gt;&gt; process on every available slot in the allocation. Given this
</span><br>
command,
<br>
<span class="quotelev2">&gt;&gt; that
...
<span class="quotelev3">&gt;&gt;&gt; Open MPI does things a little bit differently than other MPIs when
</span><br>
it
<br>
...
<span class="quotelev3">&gt;&gt;&gt; SLURM_TASKS_PER_NODE is the &quot;Number  of tasks to be initiated on
</span><br>
each
<br>
<span class="quotelev3">&gt;&gt;&gt; node&quot;. This seems to imply that the value should be &quot;1(x2)&quot;. So
</span><br>
maybe
<br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; large clusters with SLURM and HP-MPI. For our new cluster we want
</span><br>
to
<br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; OpenMPI uses the SLURM_NODELIST and SLURM_TASKS_PER_NODE
</span><br>
environment
<br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; allocate computing power on a per cpu base instead of per node,
</span><br>
i.e.
<br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; mailinglist archive concerning the same problem, where Ralph
</span><br>
Castain
<br>
