...
?>
<!-- received="Wed Jun 18 12:24:49 2008" -->
<!-- isoreceived="20080618162449" -->
<!-- sent="Wed, 18 Jun 2008 17:24:16 +0100" -->
<!-- isosent="20080618162416" -->
<!-- name="SLIM H.A." -->
<!-- email="h.a.slim_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Error in mx_init message" -->
<!-- id="BDDB7C5009659447B2F1747B53854FE801BDF612_at_EXDUR1.mds.ad.dur.ac.uk" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2008-06-18 12:24:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5932.php">Rainer Keller: "Re: [OMPI users] Error in mx_init message"</a>
<li><strong>Previous message:</strong> <a href="5930.php">SLIM H.A.: "Re: [OMPI users] Error in mx_init message"</a>
<li><strong>In reply to:</strong> <a href="5928.php">George Bosilca: "Re: [OMPI users] Error in mx_init message"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5932.php">Rainer Keller: "Re: [OMPI users] Error in mx_init message"</a>
<li><strong>Reply:</strong> <a href="5932.php">Rainer Keller: "Re: [OMPI users] Error in mx_init message"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi George
<br>
<p>I just tried that and got a different error message:
<br>
<p>------------------------------------------------------------------------
<br>
<pre>
