...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5777.php">8mj6tc902_at_[hidden]: "[OMPI users] Proper way to throw an error to all nodes?"</a>
<li><strong>Previous message:</strong> <a href="5775.php">Ralph H Castain: "Re: [OMPI users] specifying hosts in mpi_spawn()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5783.php">Mukesh K Srivastava: "Re: [OMPI users] HPMPI versus OpenMPI performance"</a>
<li><strong>Maybe reply:</strong> <a href="5783.php">Mukesh K Srivastava: "Re: [OMPI users] HPMPI versus OpenMPI performance"</a>
<li><strong>Maybe reply:</strong> <a href="5784.php">Mukesh K Srivastava: "Re: [OMPI users] HPMPI versus OpenMPI performance"</a>
<li><strong>Reply:</strong> <a href="5804.php">Jeff Squyres: "Re: [OMPI users] HPMPI versus OpenMPI performance"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
