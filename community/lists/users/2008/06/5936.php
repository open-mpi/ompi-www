...
?>
<!-- received="Thu Jun 19 10:24:33 2008" -->
<!-- isoreceived="20080619142433" -->
<!-- sent="Thu, 19 Jun 2008 08:24:16 -0600" -->
<!-- isosent="20080619142416" -->
<!-- name="Ralph H Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] null characters in output" -->
<!-- id="C47FC830.DE83%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="AE3C65E73659C647AD0EBCF50DC996BF057E59_at_maildrd1.nyc.deshaw.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-06-19 10:24:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5937.php">Gabriele Fatigati: "Re: [OMPI users] OpenMPI with bounds checking"</a>
<li><strong>Previous message:</strong> <a href="5935.php">Ralph H Castain: "Re: [OMPI users] SLURM and OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5975.php">Sacerdoti, Federico: "Re: [OMPI users] null characters in output"</a>
<li><strong>Maybe reply:</strong> <a href="5975.php">Sacerdoti, Federico: "Re: [OMPI users] null characters in output"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph
<br>
<p><p><p>On 6/19/08 8:15 AM, &quot;Sacerdoti, Federico&quot;
<br>
&lt;Federico.Sacerdoti_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Ralph, another issue perhaps you can shed some light on.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; When launching with orterun, we sometimes see null characters in the
</span><br>
<span class="quotelev1">&gt; stdout output. These do not show up on a terminal, but when piped to a
</span><br>
<span class="quotelev1">&gt; file they are visible in an editor. They also can show up in the middle
</span><br>
<span class="quotelev1">&gt; of a line, and so can interfere with greps on the output, etc.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Have you seen this before? I am working on a simple test case, but
</span><br>
<span class="quotelev1">&gt; unfortunately have not found one that is deterministic so far.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
