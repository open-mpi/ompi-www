...
?>
<!-- received="Wed Jun 18 10:15:51 2008" -->
<!-- isoreceived="20080618141551" -->
<!-- sent="Wed, 18 Jun 2008 10:15:40 -0400" -->
<!-- isosent="20080618141540" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] gfortran bindings apparently not built on mac os leopard" -->
<!-- id="03A30537-F6E6-4833-AD22-E20BC6F26865_at_cisco.com" -->
<!-- charset="WINDOWS-1252" -->
<!-- inreplyto="Pine.LNX.4.64.0806180944020.21120_at_marvin.we-be-smart.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-06-18 10:15:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5927.php">SLIM H.A.: "[OMPI users] Error in mx_init message"</a>
<li><strong>Previous message:</strong> <a href="5925.php">Brian W. Barrett: "Re: [OMPI users] gfortran bindings apparently not built on mac os leopard"</a>
<li><strong>In reply to:</strong> <a href="5925.php">Brian W. Barrett: "Re: [OMPI users] gfortran bindings apparently not built on mac os leopard"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p><p>On Jun 18, 2008, at 9:56 AM, Brian W. Barrett wrote:
<br>
<p><span class="quotelev1">&gt; Thanks for adding the section, but the information contained within  
</span><br>
<span class="quotelev1">&gt; is wrong (as was the information in this e-mail thread).  OS X  
</span><br>
<span class="quotelev1">&gt; essentially *always* adds a -rpath to both executables depending on  
</span><br>
<span class="quotelev1">&gt; libraries and libraries depending on other libraries.  There is no  
</span><br>
<span class="quotelev1">&gt; need to set LD_LIBRARY_PATH, which on OS X is only used by the  
</span><br>
<span class="quotelev1">&gt; linker at link time and by dlopen, but not the linker at run time.   
</span><br>
<span class="quotelev1">&gt; Setting DYLD_LIBRARY_PATH is not only unnecessary, but considered  
</span><br>
<span class="quotelev1">&gt; harmful.  There are very few situations where one would need to set  
</span><br>
<span class="quotelev1">&gt; DYLD_LIBRARY_PATH, and they should never be part of a production  
</span><br>
<span class="quotelev1">&gt; environment.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; If you built Open MPI as a set of static libraries, there is a  
</span><br>
<span class="quotelev1">&gt; library search order problem (which neither of the two LIBRARY_PATH  
</span><br>
<span class="quotelev1">&gt; variables will solve) in that OS X searches the entire library path  
</span><br>
<span class="quotelev1">&gt; for a shared library of the specified name, then searches the entire  
</span><br>
<span class="quotelev1">&gt; library path again for a static library of the specified name.   
</span><br>
<span class="quotelev1">&gt; Since /usr/lib/libmpi.dylib would then always be found before &lt;my  
</span><br>
<span class="quotelev1">&gt; install/lib/libmpi.a, you'd have a problem.  An easy workaround is  
</span><br>
<span class="quotelev1">&gt; to add -Wl,-search_paths_first to the link line when linking MPI  
</span><br>
<span class="quotelev1">&gt; applications.  I'd accomplish this by adding the following to OMPI's  
</span><br>
<span class="quotelev1">&gt; configure:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  --with-wrapper-ldflags=&quot;-Wl,-search_paths_first&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Getting back to the original problem, unless the user already has  
</span><br>
<span class="quotelev1">&gt; set DYLD_LIBRARY_PATH (which they shouldn't do), there is no need to  
</span><br>
<span class="quotelev1">&gt; modify DYLD_LIBRARY_PATH for OMPI to work properly (even with the  
</span><br>
<span class="quotelev1">&gt; system installed version in /usr/lib).  We should not mention  
</span><br>
<span class="quotelev1">&gt; DYLD_LIBRARY_PATH in the FAQ.  If we do mention it, it should only  
</span><br>
<span class="quotelev1">&gt; be to say that it should not be set.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Wed, 18 Jun 2008, Jeff Squyres wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; FWIW, I added this issue to the FAQ under the &quot;OS X&quot; section to  
</span><br>
<span class="quotelev2">&gt;&gt; make it a little easier to find.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Jun 17, 2008, at 5:17 PM, Jeff Squyres wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Sorry for not replying earlier -- glad you figured it out.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Yes, if you didn't also reset the LIBRARY_PATH, the &quot;wrong&quot; libmpi  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (and friends) will get picked up, and it will therefore use the  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; hard-coded directory path in those &quot;wrong&quot; libraries to find the  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; wrapper data text files (the ones without Fortran support).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Jun 17, 2008, at 4:15 PM, Weirs, V Gregory wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Alright, I&#146;m an idiot. I didn&#146;t adjust my DYLD_LIBRARY_PATH.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Sorry about that-
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greg
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On 6/17/08 7:08 AM, &quot;Jeff Squyres&quot; &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; This is pretty odd.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; What files do you see in $prefix/share/openmpi/mpi*txt?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; What do you see from:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  grep required_file $prefix/share/openmpi/mpi*txt
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jun 16, 2008, at 2:12 PM, Weirs, V Gregory wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Dave Gunter:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; According to ./configure &#151;help, by default  &#151;enable-mpi-f77 and &#151;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; enable-mpi-f90 are set. Also, ompi_info (see output in  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; run_output in
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; shows I am using the version I built. (current is a symlink to  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 1.2.6-
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; gcc4.0). In any case, I get the same results with the absolute  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] gfortran bindings apparently not built  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I believe you still must add &quot;--enable-f77&quot; and &quot;--enable-f90&quot;  
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt; &gt; I am having trouble building mpif77/mpif90 with gfortran on  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Mac OS
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt; &gt; 10.5. Or maybe just running. The configure, make all, and make
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt; &gt; install seemed to go just fine, finding my gfortran and  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; apparently
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt; &gt; using it, but the scripts mpif77 and mpif90 give the error  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; that my
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt; &gt; openmpi was not built with fortran bindings. Mpicc and mpicxx  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; If you use the absolute path names to run your mpif77 and mpif90  
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt; &gt; installed, but not fortran bindings, and I was careful to put  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I am trying to install Open MPI on a cluster that has been  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; installed
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &quot;time mpirun -np 16  /ptmp/jxding/openmpi123/openmpi-1.2.3/ 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; So , it means that the application is still using MPICH-GM not  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Please be aware that you have to make those changes within your  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &quot;/ptmp/myname/openmpi123/ompi123_install/bin/mpirun foo&quot; instead  
</span><br>
