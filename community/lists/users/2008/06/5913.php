...
?>
<!-- received="Tue Jun 17 11:59:36 2008" -->
<!-- isoreceived="20080617155936" -->
<!-- sent="Tue, 17 Jun 2008 09:59:25 -0600" -->
<!-- isosent="20080617155925" -->
...
<!-- id="C47D3B7D.5D96%vgweirs_at_sandia.gov" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="54FAF9C8-04E7-4B14-A7F3-2AEF74AFD64D_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-06-17 11:59:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5914.php">SLIM H.A.: "Re: [OMPI users] btl parameter is not set to openib on node with ibcard"</a>
<li><strong>Previous message:</strong> <a href="5912.php">Jeff Squyres: "Re: [OMPI users] help me please, about Open MPI"</a>
<li><strong>In reply to:</strong> <a href="5898.php">Jeff Squyres: "Re: [OMPI users] gfortran bindings apparently not built on mac os leopard"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5922.php">Weirs, V Gregory: "Re: [OMPI users] gfortran bindings apparently not built on mac os leopard"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I tend to believe there is a problem with my path or some other environment variable I am not setting, and there is confusion between the openmpi I built and the one apple installs. Besides the PATH are there any other environment variables I need to set?
<br>
<p>Thanks,
<br>
Greg
<br>
<p><p>On 6/17/08 7:08 AM, &quot;Jeff Squyres&quot; &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
<p>This is pretty odd.
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-5913/attachment">attachment</a>
</ul>
