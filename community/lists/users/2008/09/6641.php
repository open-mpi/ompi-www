...
?>
<!-- received="Sun Sep 21 04:38:35 2008" -->
<!-- isoreceived="20080921083835" -->
<!-- sent="Sun, 21 Sep 2008 01:38:30 -0700 (PDT)" -->
<!-- isosent="20080921083830" -->
<!-- name="Shafagh Jafer" -->
<!-- email="barfy27_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation Fault--libc.so.6(__libc_start_main..." -->
<!-- id="762859.22469.qm_at_web34807.mail.mud.yahoo.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="[OMPI users] Segmentation Fault--libc.so.6(__libc_start_main..." -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-09-21 04:38:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6642.php">Aurélien Bouteiller: "Re: [OMPI users] Segmentation Fault--libc.so.6(__libc_start_main..."</a>
<li><strong>Previous message:</strong> <a href="6640.php">Shafagh Jafer: "Re: [OMPI users] Segmentation Fault--libc.so.6(__libc_start_main..."</a>
<li><strong>Maybe in reply to:</strong> <a href="6635.php">Shafagh Jafer: "[OMPI users] Segmentation Fault--libc.so.6(__libc_start_main..."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6642.php">Aurélien Bouteiller: "Re: [OMPI users] Segmentation Fault--libc.so.6(__libc_start_main..."</a>
<li><strong>Reply:</strong> <a href="6642.php">Aurélien Bouteiller: "Re: [OMPI users] Segmentation Fault--libc.so.6(__libc_start_main..."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>--- On Sat, 9/20/08, Shafagh Jafer &lt;barfy27_at_[hidden]&gt; wrote:
<br>
<p>From: Shafagh Jafer &lt;barfy27_at_[hidden]&gt;
<br>
Subject: Re: [OMPI users] Segmentation Fault--libc.so.6(__libc_start_main...
<br>
...
<br>
<p><p><p><p><p><p>My code was working perfect when I had it with MPICH now I have replaced that with OMPI. Could that be the problem?? Do I need to change any part of my source code if I migrate from MPICH-1.2.6 to OpenMPI-1.2.7?? Please let me know.
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-6641/attachment">attachment</a>
</ul>
