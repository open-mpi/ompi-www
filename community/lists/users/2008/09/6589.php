...
?>
<!-- received="Wed Sep 17 14:21:19 2008" -->
<!-- isoreceived="20080917182119" -->
<!-- sent="Wed, 17 Sep 2008 14:21:12 -0400" -->
<!-- isosent="20080917182112" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] errors returned from openmpi-1.2.7 source code" -->
<!-- id="0566D4D1-A9A2-4973-8FDF-627CB51C3F67_at_cisco.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="395287.79222.qm_at_web34807.mail.mud.yahoo.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-09-17 14:21:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6590.php">Shafagh Jafer: "Re: [OMPI users] errors returned from openmpi-1.2.7 source code"</a>
<li><strong>Previous message:</strong> <a href="6588.php">Shafagh Jafer: "Re: [OMPI users] errors returned from openmpi-1.2.7 source code"</a>
<li><strong>In reply to:</strong> <a href="6588.php">Shafagh Jafer: "Re: [OMPI users] errors returned from openmpi-1.2.7 source code"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6590.php">Shafagh Jafer: "Re: [OMPI users] errors returned from openmpi-1.2.7 source code"</a>
<li><strong>Reply:</strong> <a href="6590.php">Shafagh Jafer: "Re: [OMPI users] errors returned from openmpi-1.2.7 source code"</a>
<li><strong>Reply:</strong> <a href="6591.php">Shafagh Jafer: "Re: [OMPI users] errors returned from openmpi-1.2.7 source code"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; I think you want &quot;mpicc&quot; for CC (note the lower case) -- mpiCC is the
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; openmpi-1.2.7/include/openmpi/ompi/mpi/cxx/*.h&quot; . Please see the
</span><br>
...
<span class="quotelev2">&gt; &gt; MPICH's &quot;mpiCC&quot; with OMPI's &quot;mpiCC&quot;?  FWIW,
</span><br>
<span class="quotelev1">&gt; this is
</span><br>
<span class="quotelev2">&gt; &gt; almost always the
</span><br>
<span class="quotelev2">&gt; &gt; easiest way to compile MPI applications: use that implementation's
</span><br>
<span class="quotelev2">&gt; &gt; &quot;wrapper&quot; compiler (I'm assuming you have a C++ code in this
</span><br>
<span class="quotelev2">&gt; &gt; case).
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; These errors should not normally happen; they look kinda like you're
</span><br>
