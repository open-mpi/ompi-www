...
?>
<!-- received="Mon Sep 22 17:52:26 2008" -->
<!-- isoreceived="20080922215226" -->
<!-- sent="Mon, 22 Sep 2008 15:52:21 -0600" -->
<!-- isosent="20080922215221" -->
<!-- name="Brian Harker" -->
<!-- email="brian.harker_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Configure and Build ok, but mpi module not recognized?" -->
<!-- id="48535380809221452s4e6bea6ep174b7c60497ebeef_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="48D7D59F.8090103_at_ldeo.columbia.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-09-22 17:52:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6674.php">Jeff Squyres: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<li><strong>Previous message:</strong> <a href="6672.php">Brian Harker: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<li><strong>In reply to:</strong> <a href="6663.php">Gus Correa: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6674.php">Jeff Squyres: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<li><strong>Reply:</strong> <a href="6674.php">Jeff Squyres: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<li><strong>Reply:</strong> <a href="6676.php">Doug Reeder: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Looking at the actual mpi.mod module file in the $OPENMPI_HOME/lib
<br>
directory, the very first line is:
<br>
GFORTRAN module created from mpi.f90 on Fri Sep 19 14:01:27 2008
<br>
<p>WTF!?  I specified that I wanted to use the ifort/icc/icpc compiler
<br>
...
troubles...
<br>
<p><p><p>On Mon, Sep 22, 2008 at 11:27 AM, Gus Correa &lt;gus_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; Here on CentOS from Rocks Cluster I have a &quot;native&quot; OpenMPI, with a mpi.mod,
</span><br>
...
<span class="quotelev1">&gt; It may be that mpif90 is not picking the right mpi.mod, as Jeff suggested.
</span><br>
...
<span class="quotelev2">&gt;&gt; On Mon, Sep 22, 2008 at 9:40 AM, Gus Correa &lt;gus_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; were fixed the day I decided to use full path names to the MPI compiler
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Most Linux distributions come with built in MPI implementations (often
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; You end up with a mess of different MPI versions on your &quot;native&quot; PATH,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; distribution packages or anything.  MPICH2 has the modules located in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; /usr/local/include, which I assume would be found (since its in my
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; path), were it not for specifying -I$OPENMPI_HOME/lib at compile time,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; right?  I can't imagine that if you tell it where to look for the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; correct modules, it would search through your path first before going
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; to where you tell it to go.  Or am I too optimistic?  Thanks again for
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Ok.  Have you checked around your machine to ensure that there is no
</span><br>
