...
?>
<!-- received="Mon Sep 22 09:13:14 2008" -->
<!-- isoreceived="20080922131314" -->
<!-- sent="Mon, 22 Sep 2008 09:12:57 -0400" -->
<!-- isosent="20080922131257" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] conflict among differenv MPIs" -->
<!-- id="EB53D3E1-94AA-4A03-B9B8-4FAB8B503EA3_at_cisco.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="933761B1-E915-49F8-BDF8-9BC5265B1B24_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-09-22 09:12:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6652.php">Brian Harker: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<li><strong>Previous message:</strong> <a href="6650.php">Jeff Squyres: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<li><strong>In reply to:</strong> <a href="6649.php">Robert Kubrick: "Re: [OMPI users] conflict among differenv MPIs"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6662.php">Shafagh Jafer: "Re: [OMPI users] conflict among differenv MPIs"</a>
<li><strong>Reply:</strong> <a href="6662.php">Shafagh Jafer: "Re: [OMPI users] conflict among differenv MPIs"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>- I created include-test.c which just does an &quot;#include &lt;stdio.h&gt;&quot;.
<br>
