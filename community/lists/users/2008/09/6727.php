...
?>
<!-- received="Wed Sep 24 14:17:48 2008" -->
<!-- isoreceived="20080924181748" -->
<!-- sent="Wed, 24 Sep 2008 12:17:37 -0600" -->
<!-- isosent="20080924181737" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mca:base:select:( ess) No component selected!" -->
<!-- id="5F1C3896-E2D6-421A-8931-DE3076A796E2_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="e1ac6ccc0809241111n553fcf77j50b7ae2975bb8369_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-09-24 14:17:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6728.php">Will Portnoy: "Re: [OMPI users] mca:base:select:( ess) No component selected!"</a>
<li><strong>Previous message:</strong> <a href="6726.php">Will Portnoy: "Re: [OMPI users] mca:base:select:( ess) No component selected!"</a>
<li><strong>In reply to:</strong> <a href="6726.php">Will Portnoy: "Re: [OMPI users] mca:base:select:( ess) No component selected!"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6728.php">Will Portnoy: "Re: [OMPI users] mca:base:select:( ess) No component selected!"</a>
<li><strong>Reply:</strong> <a href="6728.php">Will Portnoy: "Re: [OMPI users] mca:base:select:( ess) No component selected!"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
orted.
<br>
<p>Do you have ssh in your path? My best immediate guess is that you  
<br>
...
point.
<br>
<p>1.3 is fine to use - still patching some bugs, but nothing that should  
<br>
impact this issue.
<br>
<p>Ralph
<br>
<p>On Sep 24, 2008, at 12:11 PM, Will Portnoy wrote:
<br>
<p><span class="quotelev1">&gt; That was the output with plm_base_verbose set to 99 - it's the same
</span><br>
...
<span class="quotelev2">&gt;&gt; I would like to see the cmd line being used to launch the orted.  
</span><br>
<span class="quotelev2">&gt;&gt; What this
</span><br>
<span class="quotelev2">&gt;&gt; indicates is that we are not getting the cmd line correct. Could  
</span><br>
<span class="quotelev2">&gt;&gt; just be
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I'm trying to use MPI_Comm_Spawn with MPI_Info's host key to spawn
</span><br>
<span class="quotelev3">&gt;&gt;&gt; processes from a process not started with mpirun.  This works with  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I'm using version 1.3a1r19602.  I need to use orte_launch_agent to  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; set
</span><br>
<span class="quotelev3">&gt;&gt;&gt; up my environment a bit before orted is started, but it fails with
</span><br>
<span class="quotelev3">&gt;&gt;&gt; errors listed below.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; When I try to run orted directly on the command line with some of  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca: base: components_open: Looking for ess components
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca: base: components_open: opening ess components
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca: base: components_open: found loaded component env
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca: base: components_open: component env open function
</span><br>
<span class="quotelev3">&gt;&gt;&gt; successful
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca: base: components_open: found loaded component hnp
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca: base: components_open: component hnp open function
</span><br>
<span class="quotelev3">&gt;&gt;&gt; successful
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca: base: components_open: component singleton has no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; register function
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca: base: components_open: component singleton open
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca: base: components_open: found loaded component tool
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca:base:select:(  ess) Skipping component [env]. Query
</span><br>
<span class="quotelev3">&gt;&gt;&gt; failed to return a module
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca:base:select:(  ess) Querying component [hnp]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca:base:select:(  ess) Skipping component [hnp]. Query
</span><br>
<span class="quotelev3">&gt;&gt;&gt; failed to return a module
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca:base:select:(  ess) Querying component [singleton]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca:base:select:(  ess) Skipping component [singleton].
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca:base:select:(  ess) Skipping component [slurm].  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] mca:base:select:(  ess) Skipping component [tool].  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Query
</span><br>
<span class="quotelev3">&gt;&gt;&gt; failed to return a module
...
<span class="quotelev3">&gt;&gt;&gt; [fqdn:24761] [[INVALID],INVALID] ORTE_ERROR_LOG: Not found in file
</span><br>
