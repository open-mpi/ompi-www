...
?>
<!-- received="Mon Sep 22 20:38:04 2008" -->
<!-- isoreceived="20080923003804" -->
<!-- sent="Mon, 22 Sep 2008 18:37:59 -0600" -->
<!-- isosent="20080923003759" -->
<!-- name="Brian Harker" -->
<!-- email="brian.harker_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Configure and Build ok, but mpi module not recognized?" -->
<!-- id="48535380809221737j2da6f0bfs363fdafa892335a7_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2008-09-22 20:37:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6686.php">Jeff Squyres: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<li><strong>Previous message:</strong> <a href="6684.php">Brian Harker: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6686.php">Jeff Squyres: "Re: [OMPI users] Configure and Build ok, but mpi module not recognized?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
your time and input.
<br>
<p>On Mon, Sep 22, 2008 at 6:36 PM, Brian Harker &lt;brian.harker_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt; Nope, no user-defined types or arrays greater than 2 dimensions.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Mon, Sep 22, 2008 at 6:24 PM, Jeff Squyres &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; The F90 MPI bindings have some well-known design flaws (i.e., problems with
</span><br>
<span class="quotelev2">&gt;&gt; the standard itself, not any particular implementation).  Many of them
</span><br>
<span class="quotelev2">&gt;&gt; center around the fact that F90 is a strongly-typed language.  See this
</span><br>
...
<span class="quotelev2">&gt;&gt; - This also means that *every* pre-defined type must have a F90 MPI binding.
</span><br>
<span class="quotelev2">&gt;&gt;  There are approximately 15 intrinsic size/type combinations.  There are 50
</span><br>
<span class="quotelev2">&gt;&gt; MPI functions that take one choice buffer (e.g., MPI_SEND, etc.), and 25
</span><br>
<span class="quotelev2">&gt;&gt; functions that take two choice buffers (e.g., MPI_REDUCE).  I'm copying this
</span><br>
<span class="quotelev2">&gt;&gt; math from the paper, and I think we got it slightly wrong (there was a
</span><br>
<span class="quotelev2">&gt;&gt; discussion about it on this list a while ago), but it results in many
</span><br>
<span class="quotelev2">&gt;&gt; *millions* of F90 MPI bindings functions.  There's no compiler on the planet
</span><br>
...
<span class="quotelev2">&gt;&gt; - F90 bindings are not created for any of the 2-choice-buffer functions
</span><br>
<span class="quotelev2">&gt;&gt; - F90 bindings are created for all the 1-choice-buffer functions, but only
</span><br>
<span class="quotelev2">&gt;&gt; for dimensions up to N dimensions (N defaults to 4, IIRC).  You can change
</span><br>
...
<span class="quotelev2">&gt;&gt; So -- your app failed to compile because you either used a user-defined
</span><br>
<span class="quotelev2">&gt;&gt; datatype or you used an array with a dimension greater than 4.  If it was a
</span><br>
<span class="quotelev2">&gt;&gt; greater-dimension issue, you can reconfigure/recompile/reinstall OMPI
</span><br>
<span class="quotelev2">&gt;&gt; (again, sorry) with a larger N value.  If it was a user-defined datatype,
</span><br>
<span class="quotelev2">&gt;&gt; you unfortunately have to &quot;include mpif.h&quot; in that
</span><br>
<span class="quotelev2">&gt;&gt; subroutine/function/whatever, sorry (and you lose the type checking).  :-(
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; FWIW, we're arguing^H^H^H^H^H^H^Hdiscussing new Fortran 2003 bindings for
</span><br>
<span class="quotelev2">&gt;&gt; MPI in the MPI-3 Forum right now.  We have already addressed the problems
</span><br>
<span class="quotelev2">&gt;&gt; discussed above (F03 now has an equivalent of (void*)), and hope to do a few
</span><br>
<span class="quotelev2">&gt;&gt; more minor things as well.  There's also discussion of the possibility of a
</span><br>
<span class="quotelev2">&gt;&gt; Boost.MPI-like Fortran 2003 MPI library that would take advantage of many of
</span><br>
<span class="quotelev2">&gt;&gt; the features of the language, but be a little farther away from the official
</span><br>
