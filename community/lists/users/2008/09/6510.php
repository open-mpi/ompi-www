...
?>
<!-- received="Thu Sep 11 12:04:41 2008" -->
<!-- isoreceived="20080911160441" -->
<!-- sent="Thu, 11 Sep 2008 12:04:37 -0400" -->
<!-- isosent="20080911160437" -->
<!-- name="Eric Thibodeau" -->
<!-- email="kyron_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Need help resolving No route to host error with OpenMPI 1.1.2" -->
<!-- id="48C94195.7010901_at_neuralbs.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="FB0771D7-A325-4454-AD9F-96DA10849124_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-09-11 12:04:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6511.php">Jeff Squyres: "Re: [OMPI users] Need help resolving No route to host error with OpenMPI 1.1.2"</a>
<li><strong>Previous message:</strong> <a href="6509.php">Jeff Squyres: "Re: [OMPI users] Need help resolving No route to host error with OpenMPI 1.1.2"</a>
<li><strong>In reply to:</strong> <a href="6509.php">Jeff Squyres: "Re: [OMPI users] Need help resolving No route to host error with OpenMPI 1.1.2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6504.php">Prasanna Ranganathan: "Re: [OMPI users] Need help resolving No route to host error with OpenMPI 1.1.2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Jeff Squyres wrote:
<br>
<span class="quotelev1">&gt; I'm not sure what USE=-threads means, but I would discourage the use 
</span><br>
<span class="quotelev1">&gt; of threads in the v1.2 series; our thread support is pretty much 
</span><br>
<span class="quotelev1">&gt; broken in the 1.2 series.
</span><br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;epause 5
<br>
<p>...ok, so it's maybe not that B and F but it's still there to be noticed 
<br>
and logged ;)
<br>
...
<span class="quotelev1">&gt; On Sep 10, 2008, at 7:52 PM, Eric Thibodeau wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Prasanna, also make sure you try with USE=-threads ...as the ebuild 
</span><br>
<span class="quotelev2">&gt;&gt; states, it's _experimental_  ;)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Keep your eye on: 
</span><br>
<span class="quotelev2">&gt;&gt; <a href="https://svn.open-mpi.org/trac/ompi/wiki/ThreadSafetySupport">https://svn.open-mpi.org/trac/ompi/wiki/ThreadSafetySupport</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I have upgraded my openMPI to 1.2.6 (We have gentoo and emerge showed
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 1.2.6-r1 to be the latest stable version of openMPI).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I do still get the following error message when running my test 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; helloWorld
</span><br>
<span class="quotelev3">&gt;&gt;&gt; program:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [10.12.77.21][0,1,95][btl_tcp_endpoint.c:572:mca_btl_tcp_endpoint_complete_c 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; onnect] connect() failed with
</span><br>
<span class="quotelev3">&gt;&gt;&gt; errno=113[10.12.16.13][0,1,408][btl_tcp_endpoint.c:572:mca_btl_tcp_endpoint_ 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; complete_connect] connect() failed with errno=113
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [10.12.77.15][0,1,89][btl_tcp_endpoint.c:572:mca_btl_tcp_endpoint_complete_c 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; onnect] connect() failed with errno=113
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [10.12.77.22][0,1,96][btl_tcp_endpoint.c:572:mca_btl_tcp_endpoint_complete_c 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; onnect] connect() failed with errno=113
...
<span class="quotelev3">&gt;&gt;&gt; Again, this error does not happen with every run of the test program 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and
</span><br>
<span class="quotelev3">&gt;&gt;&gt; occurs only certain times.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; How do I take care of this?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 9/9/08 9:00 AM, &quot;users-request_at_[hidden]&quot; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Date: Mon, 8 Sep 2008 16:43:33 -0400
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; From: Jeff Squyres &lt;jsquyres_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] Need help resolving No route to host error
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; with OpenMPI 1.1.2
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To: Open MPI Users &lt;users_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Message-ID: &lt;AF302D68-0D30-469E-AFD3-566FF962814B_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Are you able to upgrade to Open MPI v1.2.7?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; There were *many* bug fixes and changes in the 1.2 series compared to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the 1.1 series, some, in particular, were dealing with TCP socket
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; timeouts (which are important when dealing with large numbers of MPI
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sep 8, 2008, at 4:36 PM, Prasanna Ranganathan wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;           RX bytes:339687635 (323.9 Mb)  TX bytes:339687635 (323.9 
</span><br>
