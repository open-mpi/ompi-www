<?
$subject_val = "[OMPI users] error while loading shared libraries: libmpi_cxx.so.0";
include("../../include/msg-header.inc");
?>
<!-- received="Fri Sep 19 17:31:02 2008" -->
<!-- isoreceived="20080919213102" -->
<!-- sent="Fri, 19 Sep 2008 14:30:57 -0700 (PDT)" -->
<!-- isosent="20080919213057" -->
<!-- name="Shafagh Jafer" -->
<!-- email="barfy27_at_[hidden]" -->
<!-- subject="[OMPI users] error while loading shared libraries: libmpi_cxx.so.0" -->
<!-- id="997824.31634.qm_at_web34801.mail.mud.yahoo.com" -->
<!-- charset="us-ascii" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] error while loading shared libraries: libmpi_cxx.so.0<br>
<strong>From:</strong> Shafagh Jafer (<em>barfy27_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-09-19 17:30:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="6627.php">Jeff Squyres: "Re: [OMPI users] error while loading shared libraries: libmpi_cxx.so.0"</a>
<li><strong>Previous message:</strong> <a href="6625.php">Shafagh Jafer: "Re: [OMPI users] what is inside mpicc/mpic++"</a>
<li><strong>In reply to:</strong> <a href="6601.php">Jeff Squyres: "Re: [OMPI users] what is inside mpicc/mpic++"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="6627.php">Jeff Squyres: "Re: [OMPI users] error while loading shared libraries: libmpi_cxx.so.0"</a>
<li><strong>Reply:</strong> <a href="6627.php">Jeff Squyres: "Re: [OMPI users] error while loading shared libraries: libmpi_cxx.so.0"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-6626/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-6626/Makefile.common">Makefile.common</a>
</ul>
