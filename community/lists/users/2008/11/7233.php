...
?>
<!-- received="Thu Nov  6 15:43:13 2008" -->
<!-- isoreceived="20081106204313" -->
<!-- sent="Thu, 6 Nov 2008 13:42:57 -0700" -->
<!-- isosent="20081106204257" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI and OAR issues" -->
<!-- id="B189131D-B189-4B3D-AD1B-83EB70648413_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-11-06 15:42:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7234.php">Andrea Pellegrini: "Re: [OMPI users] OpenMPI and OAR issues"</a>
<li><strong>Previous message:</strong> <a href="7232.php">Jeff Squyres: "Re: [OMPI users] OpenMPI and OAR issues"</a>
<li><strong>In reply to:</strong> <a href="7231.php">George Bosilca: "Re: [OMPI users] OpenMPI and OAR issues"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7234.php">Andrea Pellegrini: "Re: [OMPI users] OpenMPI and OAR issues"</a>
<li><strong>Reply:</strong> <a href="7234.php">Andrea Pellegrini: "Re: [OMPI users] OpenMPI and OAR issues"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Sorry - I should have been clearer in my comment. I was trying to  
<br>
indicate that the cmd starting with &quot;set&quot; is indicating a bash syntax  
<br>
error, and that is why the launch fails.
<br>
<p>The rsh launcher uses a little &quot;probe&quot; technique to try and guess the  
<br>
remote shell. Apparently, it thinks this is tcsh, while the remote  
<br>
node thinks it will use bash.
<br>
<p>Are you running this from bash? If so, you could perhaps resolve the  
<br>
...
<br>
<p>Alternatively, you could set -mca pls_rsh_debug 1 to see all the debug  
<br>
...
<p>Ralph
<br>
<p><p>On Nov 6, 2008, at 1:31 PM, George Bosilca wrote:
<br>
