...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7179.php">Hahn Kim: "Re: [OMPI users] problem running Open MPI on Cells"</a>
<li><strong>Previous message:</strong> <a href="7177.php">Jeff Squyres: "Re: [OMPI users] problem running Open MPI on Cells"</a>
<li><strong>In reply to:</strong> <a href="../../2008/10/7161.php">Rajesh Ramaya: "Re: [OMPI users] MPI + Mixed language coding(Fortran90 + C++)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7181.php">Terry Frankcombe: "Re: [OMPI users] MPI + Mixed language coding(Fortran90 + C++)"</a>
<li><strong>Reply:</strong> <a href="7181.php">Terry Frankcombe: "Re: [OMPI users] MPI + Mixed language coding(Fortran90 + C++)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
