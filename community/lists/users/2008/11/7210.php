...
?>
<!-- received="Wed Nov  5 08:55:54 2008" -->
<!-- isoreceived="20081105135554" -->
<!-- sent="Wed, 5 Nov 2008 06:55:44 -0700" -->
<!-- isosent="20081105135544" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Beowulf cluster and openmpi" -->
<!-- id="BDD460D4-0714-49EE-BDBE-70A12A35C90F_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2008-11-05 08:55:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7211.php">Kelley, Sean: "Re: [OMPI users] Beowulf cluster and openmpi"</a>
<li><strong>Previous message:</strong> <a href="7209.php">Mehdi Bozzo-Rey: "[OMPI users] ompi 1.3 make distclean broken ?"</a>
<li><strong>In reply to:</strong> <a href="7198.php">Rima Chaudhuri: "Re: [OMPI users] Beowulf cluster and openmpi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7211.php">Kelley, Sean: "Re: [OMPI users] Beowulf cluster and openmpi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>The problem here is with how you named your nodes. On bproc clusters,  
<br>
...
&quot;number&quot;.
<br>
<p>So the bproc system has no way to launch on a node name given as an IP  
<br>
address.
<br>
<p>What you need to do is alter your hostfile to provide node numbers  
<br>
...
<br>
<p>export NODES=1,2,3,4
<br>
<p>or whatever syntax is appropriate for your shell. Note that the bproc  
<br>
master is usually node=0.
<br>
<p>Ralph
<br>
<p><p>On Nov 3, 2008, at 3:50 PM, Rima Chaudhuri wrote:
<br>
<p><span class="quotelev1">&gt; I added the option for -hostfile machinefile where the machinefile is
</span><br>
<span class="quotelev1">&gt; a file with the IP of the nodes:
</span><br>
...
<span class="quotelev1">&gt; [helios.structure.uic.edu:29836] mpirun: spawn failed with errno=-1
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; For your fortran issue, the Fortran 90 interface needs the  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Fortran 77
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; ugly hack: I have to go into those files and remove the &quot;std::&quot;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; the OpenMPI source has some macro redefining max, but that's what I
</span><br>
<span class="quotelev3">&gt;&gt;&gt; could not find :-(
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; repository is only private because it contains a lot of other  
</span><br>
<span class="quotelev2">&gt;&gt; people's
</span><br>
...
<span class="quotelev2">&gt;&gt; I just found out I need to switch from mpich2 to openMPI for some  
</span><br>
...
<span class="quotelev2">&gt;&gt; but when I was using mpich2 I seemed to have better luck compiling it
</span><br>
<span class="quotelev2">&gt;&gt; from code.  This is the line I used:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; But usually I left the &quot;--prefix=&quot; off and just let it install to  
</span><br>
...
<span class="quotelev2">&gt;&gt; in the PATH and very usable.  I guess my question is whether or not  
</span><br>
<span class="quotelev2">&gt;&gt; the
</span><br>
<span class="quotelev2">&gt;&gt; defaults and configuration syntax have stayed the same in openMPI.  I
</span><br>
<span class="quotelev2">&gt;&gt; also could use a &quot;quickstart&quot; guide for a non-programming user  
</span><br>
<span class="quotelev2">&gt;&gt; (e.g., I
</span><br>
<span class="quotelev2">&gt;&gt; think I have to start a daemon before running parallelized programs).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; OMPI didn't see anything from one, but it could be that we just  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I corrected the no_local to nolocal and now when I try to execute  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; script step1 (pls find it attached)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [rchaud_at_helios amber10]$ ./step1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [helios.structure.uic.edu:16335] [0,0,0] ORTE_ERROR_LOG: Not  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; available
</span><br>
<span class="quotelev3">&gt;&gt;&gt; in file ras_bjs.c at line 247
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; out of resource in file base/rmaps_base_support_fns.c at line 168
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [helios.structure.uic.edu:16335] [0,0,0] ORTE_ERROR_LOG: Temporarily
</span><br>
<span class="quotelev3">&gt;&gt;&gt; out of resource in file rmaps_rr.c at line 402
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [helios.structure.uic.edu:16335] [0,0,0] ORTE_ERROR_LOG: Temporarily
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; If I use the script without the --nolocal option, I get the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 1. Scyld Beowulf and openmpi (Rima Chaudhuri)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 2. Re: Scyld Beowulf and openmpi (Ralph Castain)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 3. Problems installing in Cygwin - Problem with GCC 3.4.4
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; fine and lists all the files in the home directory where I have  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [helios.structure.uic.edu:23611] mpirun: spawn failed with  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; errno=-13
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; to look at mpirun --help, or man mpirun.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; amber10
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; MD simulation package.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; The nodes can see the home directory i.e. a bpsh to the nodes  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [0,0,0] ORTE_ERROR_LOG: Not available in file ras_bjs.c at line  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [helios.structure.uic.edu:23611] [0,0,0] ORTE_ERROR_LOG: Not found
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; because, at come point, the source code being compiled redefined  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Can anybody comment on the meaning of those test results? Should  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I be
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; starts, I get the following:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; /local/openmpi/openmpi-1.3b1/bin/mpif90 -c -O3  -fno-second-
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; underscore
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -ffree-form  -o constants.o _constants.f
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; functional.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; -DOMPI_CONFIGURE_USER=&quot;\&quot;seabra\&quot;&quot; - 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; DOMPI_CONFIGURE_HOST=&quot;\&quot;ACS02\&quot;&quot;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; -DNDEBUG -finline-functions  -MT param.o -MD -MP -MF $depbase.Tpo  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -c
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -o param.o param.cc
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; In file included from /usr/lib/gcc/i686-pc-cygwin/3.4.4/include/c+ 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; +/
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; /usr/lib/gcc/i686-pc-cygwin/3.4.4/include/c++/bits/stl_bvector.h:  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Quantum Theory Project - University of Florida
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Gainesville - Florida - USA
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] MPI + Mixed language coding(Fortran90 +  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; C+
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; +)
...
<span class="quotelev4">&gt;&gt;&gt;&gt; blocks.  Try taking MPI out of the picture and see if that makes  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; either -- try random things until you find what you want.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; compiler code generation for C, C++ &amp; FORTRAN. I even tried to  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; look
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; at some of the common block symbols. The name of the symbol  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; remains
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the same. The only difference that I observe is in FORTRAN  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] MPI + Mixed language coding(Fortran90  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; recognized by FORTRAN executable as you thought. What compilers  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Different compiler has different convention to handle symbols.  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; E.g.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; if there is a variable &quot;var_foo&quot; in your FORTRAN code, some FORTRN
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; compiler will save &quot;var_foo_&quot; in the object file by default; if  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; FORTAN compiler, some FORTRAN compiler may append the module  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; access the data from the common block but the values are zero.  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; library is not taken in to account by the executable. Can you  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; code and the update made to the common block is taken in to  
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; runtime and resolves all undefined symbols etc  The shared  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; common blocks between Fortran and the main C Open MPI
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; have the values you expect (e.g., perhaps you're seeing all  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; zeros)?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Finally, I was *almost* able to compile OpenMPI in Cygwin using  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; the F77 interface was disabled).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; caused
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; because, at come point, the source code being compiled redefined  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &quot;max&quot; function with a macro, g++ cannot recognize the &quot;std::max&quot;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; check'), and I didn't get any alarming message, except that in  
</span><br>
