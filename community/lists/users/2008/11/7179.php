...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7180.php">Mi Yan: "Re: [OMPI users] MPI + Mixed language coding(Fortran90 + C++)"</a>
<li><strong>Previous message:</strong> <a href="7178.php">Jeff Squyres: "Re: [OMPI users] MPI + Mixed language coding(Fortran90 + C++)"</a>
<li><strong>In reply to:</strong> <a href="7177.php">Jeff Squyres: "Re: [OMPI users] problem running Open MPI on Cells"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="../../2008/10/7174.php">Mi Yan: "Re: [OMPI users] problem running Open MPI on Cells"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
