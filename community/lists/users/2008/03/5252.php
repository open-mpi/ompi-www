...
?>
<!-- received="Thu Mar 20 18:40:54 2008" -->
<!-- isoreceived="20080320224054" -->
<!-- sent="Thu, 20 Mar 2008 16:40:41 -0600" -->
<!-- isosent="20080320224041" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] SLURM and OpenMPI" -->
<!-- id="C4084409.4ADE%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="47E2DBA4.9050608_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-03-20 18:40:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5253.php">Terry Frankcombe: "Re: [OMPI users] More on AlltoAll"</a>
<li><strong>Previous message:</strong> <a href="5251.php">Tim Prins: "Re: [OMPI users] SLURM and OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="5251.php">Tim Prins: "Re: [OMPI users] SLURM and OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5254.php">Sacerdoti, Federico: "Re: [OMPI users] SLURM and OpenMPI"</a>
<li><strong>Reply:</strong> <a href="5254.php">Sacerdoti, Federico: "Re: [OMPI users] SLURM and OpenMPI"</a>
<li><strong>Reply:</strong> <a href="5279.php">Werner Augustin: "Re: [OMPI users] SLURM and OpenMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>It is possible that the interpretation of SLURM_TASKS_PER_NODE is different
<br>
...
<p>will cause mpirun to launch two processes, mapped byslot against the slurm
<br>
...
<br>
<p>I don't know if I would say we &quot;interfere&quot; with SLURM - I would say that we
<br>
...
<br>
<p>Using the SLURM-defined mapping will require launching without our mpirun.
<br>
...
<br>
<p>Anyone who wants to help accelerate that timetable is welcome to contact me.
<br>
...
<span class="quotelev1">&gt; After trying the commands you sent, I am actually a bit surprised by the
</span><br>
<span class="quotelev1">&gt; results. I would have expected this mode of operation to work. But
</span><br>
<span class="quotelev1">&gt; looking at the environment variables that SLURM is setting for us, I can
</span><br>
...
<span class="quotelev1">&gt; this is a SLURM problem? If this value were correctly reported, Open MPI
</span><br>
...
<span class="quotelev1">&gt; 2. In regards to your second example below, Open MPI by default maps 'by
</span><br>
...
<span class="quotelev2">&gt;&gt; some 'resource management' and interferes with slurm. OK, I can fix that
</span><br>
<span class="quotelev2">&gt;&gt; with a mpirun wrapper script which calls mpirun with the right -np and
</span><br>
...
<span class="quotelev2">&gt;&gt; different user might share a node. In addition slurm allows to schedule
</span><br>
<span class="quotelev2">&gt;&gt; according to memory usage. Therefore it is important that on every node
</span><br>
<span class="quotelev2">&gt;&gt; there is exactly the number of tasks running that slurm wants. The only
</span><br>
...
<span class="quotelev2">&gt;&gt; announced that he is working on two new launch methods which would fix
</span><br>
<span class="quotelev2">&gt;&gt; my problems. Unfortunately his email address is deleted from the
</span><br>
<span class="quotelev2">&gt;&gt; archive, so it would be really nice if the friendly elf mentioned there
</span><br>
