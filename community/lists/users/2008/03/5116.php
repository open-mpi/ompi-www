...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5117.php">Reuti: "Re: [OMPI users] Openmpi with SGE"</a>
<li><strong>Previous message:</strong> <a href="5115.php">Giovanni Davide Vergine: "Re: [OMPI users] Loopback Communication"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5120.php">Sacerdoti, Federico: "[OMPI users] slurm and all-srun orterun"</a>
<li><strong>Reply:</strong> <a href="5120.php">Sacerdoti, Federico: "[OMPI users] slurm and all-srun orterun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
