...
?>
<!-- received="Mon Mar  3 20:19:05 2008" -->
<!-- isoreceived="20080304011905" -->
<!-- sent="Mon, 03 Mar 2008 18:18:42 -0700" -->
<!-- isosent="20080304011842" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] slurm and all-srun orterun" -->
<!-- id="C3F1F182.488A%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="0A676550-82C3-45B4-AB1B-8926844D6B04_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-03-03 20:18:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5124.php">Ashley Pittman: "[OMPI users] -prefix option to mpirun."</a>
<li><strong>Previous message:</strong> <a href="5122.php">Brian W. Barrett: "Re: [OMPI users] eager limits?"</a>
<li><strong>Maybe in reply to:</strong> <a href="5120.php">Sacerdoti, Federico: "[OMPI users] slurm and all-srun orterun"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5138.php">Sacerdoti, Federico: "Re: [OMPI users] slurm and all-srun orterun"</a>
<li><strong>Reply:</strong> <a href="5138.php">Sacerdoti, Federico: "Re: [OMPI users] slurm and all-srun orterun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello
<br>
<p>I don't monitor the user list any more, but a friendly elf sent this along
<br>
to me.
<br>
...
<br>
<p>If a daemon is aborting, that will cause problems in 1.2.x. We have noted
<br>
...
<br>
<p>The most likely reason for the behavior you describe is that an application
<br>
...
<br>
<p>That said, we know that 1.2.x has problems with clean shutdown in abnormal
<br>
...
<br>
<p>As for your question, I am working as we speak on two new launch modes for
<br>
Open MPI:
<br>
<p>1. &quot;direct&quot; - this uses mpirun to directly launch the application processes
<br>
without use of the intermediate daemons.
<br>
<p>2. &quot;standalone&quot; - this uses the native launch command to simply launch the
<br>
application processes, without use of mpirun or the intermediate daemons.
<br>
<p>The initial target environments for these capabilities are TM and SLURM. The
<br>
...
<br>
<p>I can keep you posted if you like - once this gets into our repository, you
<br>
...
<span class="quotelev2">&gt;&gt; While orterun supports slurm, it only uses the srun facility to launch
</span><br>
...
<span class="quotelev2">&gt;&gt; orted and user processes, or alternatively use srun only. Either would
</span><br>
...
<span class="quotelev2">&gt;&gt; all processes associated with a job since processes can become a child
</span><br>
