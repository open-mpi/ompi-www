<?
$subject_val = "[OMPI users] RE :  RE : MPI_Comm_connect() fails";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Mar 17 16:32:43 2008" -->
<!-- isoreceived="20080317203243" -->
<!-- sent="Mon, 17 Mar 2008 16:28:39 -0400" -->
<!-- isosent="20080317202839" -->
<!-- name="Audet, Martin" -->
<!-- email="Martin.Audet_at_[hidden]" -->
<!-- subject="[OMPI users] RE :  RE : MPI_Comm_connect() fails" -->
<!-- id="9D96C3B9C12B4C4A9BD31761B4F8241029859E856F_at_imibou-nt-1-ex.IMI.LOCAL" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="47DECD8F.3040005_at_cs.uh.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] RE :  RE : MPI_Comm_connect() fails<br>
<strong>From:</strong> Audet, Martin (<em>Martin.Audet_at_[hidden]</em>)<br>
<strong>Date:</strong> 2008-03-17 16:28:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="5219.php">Edgar Gabriel: "Re: [OMPI users] RE :  RE : MPI_Comm_connect() fails"</a>
<li><strong>Previous message:</strong> <a href="5217.php">Siekas, Greg: "[OMPI users] equivalent to mpichgm --gm-recv blocking?"</a>
<li><strong>In reply to:</strong> <a href="5216.php">Edgar Gabriel: "Re: [OMPI users] RE : MPI_Comm_connect() fails"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="5219.php">Edgar Gabriel: "Re: [OMPI users] RE :  RE : MPI_Comm_connect() fails"</a>
<li><strong>Reply:</strong> <a href="5219.php">Edgar Gabriel: "Re: [OMPI users] RE :  RE : MPI_Comm_connect() fails"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Edgar,
<br>
<p>I merged the changes you did from -r17848:17849 in the trunk to OpenMPI version 1.2.6rc2 with George's patch and my small examples now work.
<br>
<p>Martin
<br>
________________________________________
<br>
De : users-bounces_at_[hidden] [users-bounces_at_[hidden]] de la part de Edgar Gabriel [gabriel_at_[hidden]]
<br>
...
<br>
<p>already working on it, together with a move_request....
<br>
Thanks
<br>
Edgar
...
<span class="quotelev1">&gt; Can you make a patch for the 1.2 series?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Mar 17, 2008, at 3:45 PM, Edgar Gabriel wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; I found the problem in the inter-allgather, and fixed it in patch
</span><br>
<span class="quotelev2">&gt;&gt; 17849.
</span><br>
<span class="quotelev2">&gt;&gt; The same test using however MPI_Intercomm_create (just to simplify my
</span><br>
<span class="quotelev2">&gt;&gt; life compared to Connect/Accept) using 2 vs 4 processes in the two
</span><br>
<span class="quotelev2">&gt;&gt; groups passes for me -- and did fail with the previous version.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; As I said in my last message (see bellow) the patch (or at least
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the patch I got) don't fixes the problem for me. Whether I apply it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; over OpenMPI 1.2.5 or 1.2.6rc2, I still get the same problem:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  The client aborts with a truncation error message while the server
</span><br>
<span class="quotelev3">&gt;&gt;&gt; freeze when for example the server is started on 3 process and the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; client on 2 process.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Feel free to try yourself the two small client and server programs
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I posted in my first message.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Subject: [OMPI users] RE : users Digest, Vol 841, Issue 3
</span><br>
<span class="quotelev3">&gt;&gt;&gt; From: Audet, Martin (Martin.Audet_at_[hidden])
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Date: 2008-03-13 17:04:25
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hi Georges,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Thanks for your patch, but I'm not sure I got it correctly. The
</span><br>
<span class="quotelev3">&gt;&gt;&gt; patch I got modify a few arguments passed to isend()/irecv()/recv()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; in coll_basic_allgather.c. Here is the patch I applied:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Index: ompi/mca/coll/basic/coll_basic_allgather.c
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ===================================================================
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --- ompi/mca/coll/basic/coll_basic_allgather.c (revision 17814)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; +++ ompi/mca/coll/basic/coll_basic_allgather.c (working copy)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; @@ -149,7 +149,7 @@
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         }
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         /* Do a send-recv between the two root procs. to avoid
</span><br>
<span class="quotelev3">&gt;&gt;&gt; deadlock */
</span><br>
<span class="quotelev3">&gt;&gt;&gt; - err = MCA_PML_CALL(isend(sbuf, scount, sdtype, 0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; + err = MCA_PML_CALL(isend(sbuf, scount, sdtype, root,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                                  MCA_COLL_BASE_TAG_ALLGATHER,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                                  MCA_PML_BASE_SEND_STANDARD,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                                  comm, &amp;reqs[rsize]));
</span><br>
<span class="quotelev3">&gt;&gt;&gt; @@ -157,7 +157,7 @@
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             return err;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         }
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; - err = MCA_PML_CALL(irecv(rbuf, rcount, rdtype, 0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; + err = MCA_PML_CALL(irecv(rbuf, rcount, rdtype, root,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                                  MCA_COLL_BASE_TAG_ALLGATHER, comm,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                                  &amp;reqs[0]));
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         if (OMPI_SUCCESS != err) {
</span><br>
<span class="quotelev3">&gt;&gt;&gt; @@ -186,14 +186,14 @@
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             return err;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         }
...
<span class="quotelev3">&gt;&gt;&gt; - err = MCA_PML_CALL(isend(rbuf, rsize * rcount, rdtype, 0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; + err = MCA_PML_CALL(isend(rbuf, rsize * scount, sdtype, root,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                                  MCA_COLL_BASE_TAG_ALLGATHER,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                                  MCA_PML_BASE_SEND_STANDARD, comm,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &amp;req));
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         if (OMPI_SUCCESS != err) {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             goto exit;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         }
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; - err = MCA_PML_CALL(recv(tmpbuf, size * scount, sdtype, 0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; + err = MCA_PML_CALL(recv(tmpbuf, size * rcount, rdtype, root,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                                 MCA_COLL_BASE_TAG_ALLGATHER, comm,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; However with this patch, I still have the problem. Suppose I start
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the server with three process and the client with two, the clients
</span><br>
<span class="quotelev3">&gt;&gt;&gt; prints:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [audet_at_linux15 dyn_connect]$ mpiexec --universe univ1 -n 2 ./
</span><br>
<span class="quotelev3">&gt;&gt;&gt; aclient '0.2.0:2000'
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [linux15:26114] *** An error occurred in MPI_Allgather
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [linux15:26114] *** on communicator
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [linux15:26114] *** MPI_ERR_TRUNCATE: message truncated
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [linux15:26114] *** MPI_ERRORS_ARE_FATAL (goodbye)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpiexec noticed that job rank 0 with PID 26113 on node linux15
</span><br>
<span class="quotelev3">&gt;&gt;&gt; exited on signal 15 (Terminated).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [audet_at_linux15 dyn_connect]$
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and abort. The server on the other side simply hang (as before).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; mpi.org] On Behalf Of Jeff Squyres
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Sent: March 14, 2008 19:45
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Yes, please let us know if this fixes it.  We're working on a 1.2.6
</span><br>
<span class="quotelev3">&gt;&gt;&gt; release; we can definitely put this fix in there if it's correct.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Thanks!
...
<span class="quotelev3">&gt;&gt;&gt; On Mar 13, 2008, at 4:07 PM, George Bosilca wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I dig into the sources and I think you correctly pinpoint the bug.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; It seems we have a mismatch between the local and remote sizes in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the inter-communicator allgather in the 1.2 series (which explain
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the message truncation error when the local and remote groups have a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; different number of processes). Attached to this email you can find
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; a patch that [hopefully] solve this problem. If you can please test
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; it and let me know if this solve your problem.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;inter_allgather.patch&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mar 13, 2008, at 1:11 PM, Audet, Martin wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; MPI_Comm_Connect()/MPI_Comm_accept() over an MPI port and
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; exchanging data over it with MPI_Allgather() is correct. Especially
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; calling MPI_Allgather() with recvcount=1 (its third argument)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; instead of the total number of MPI_INT that will be received (e.g.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; all-to-all type of operations over an intercommunicator, the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; process send and receives data from the remote group only (anyway
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; it is not possible to exchange data with process of the local group
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; over an intercommunicator).
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; So, for me there is no reason for stopping the process with an
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; error message complaining about message truncation. There should be
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; no truncation, sendcount, sendtype, recvcount and recvtype
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; arguments of MPI_Allgather() are correct and consistent.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I think the recvcount argument you pass to MPI_Allgather should not
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Furthermore, i'm not sure, but i think your receive buffer should
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; be
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; large enough
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; to contain messages from *all* processes, and not just from the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &quot;far side&quot;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I am not aware of any problems with the allreduce/allgather. But,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; we
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; are aware of the problem with valgrind that report non initialized
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; values when used with TCP. It's a long story, but I can guarantee
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; PS: For those who want to know the details: we have to send a
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; header
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; over TCP which contain some very basic information, including the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; size
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; of the fragment. Unfortunately, we have a 2 bytes gap in the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; header.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; As we never initialize these 2 unused bytes, but we send them over
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; single &quot;int&quot; over the new intercommunicator to test
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; communication a
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; litle bit and I did encountered problems. I am now wondering if
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; there is a problem in MPI_Allreduce() itself for
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; intercommunicators.
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ==29821== Syscall param writev(vector[...]) points to
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; uninitialised
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; byte(s)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ==29821==    at 0x36235C2130: writev (in /lib64/libc-2.3.5.so)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ==29821==    by 0x7885583: mca_btl_tcp_frag_send (in /home/
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; publique/
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ==29821==    by 0x798BF9D: mca_coll_basic_allgather_inter (in /
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ==29821==  Address 0x40d6cac is not stack'd, malloc'd or
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; So is there a problem with MPI_Allgather() on intercommunicators
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; rem_rank_tbl =
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; malloc(intercomm_remote_size*sizeof(*rem_rank_tbl));
</span><br>
