...
?>
<!-- received="Fri Feb 19 21:59:45 2016" -->
<!-- isoreceived="20160220025945" -->
<!-- sent="Sat, 20 Feb 2016 11:59:44 +0900" -->
<!-- isosent="20160220025944" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Nondeterministic SIGSEGV in MPI_Send to dynamically created processes" -->
<!-- id="CAAkFZ5saSX5GPPMjUE-vgEFE7sR3PfAw5-mN4Qp6OaNa3V8UZg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-02-19 21:59:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28558.php">George Bosilca: "Re: [OMPI users] Nondeterministic SIGSEGV in MPI_Send to dynamically created processes"</a>
<li><strong>Previous message:</strong> <a href="28556.php">Gilles Gouaillardet: "Re: [OMPI users] Nondeterministic SIGSEGV in MPI_Send to dynamically created processes"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28558.php">George Bosilca: "Re: [OMPI users] Nondeterministic SIGSEGV in MPI_Send to dynamically created processes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Artur,
<br>
<p>do you check all the error codes returned by MPI_Comm_spawn_multiple ?
<br>
(so you can confirm the requested number of tasks was spawned)
<br>
<p>since the error occurs only on the first MPI_Send, you might want to
<br>
...
<br>
<p>out of curiosity, did you try your application with an other MPI library
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28557/attachment">attachment</a>
</ul>
