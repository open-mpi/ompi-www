...
?>
<!-- received="Thu Feb 11 15:46:36 2016" -->
<!-- isoreceived="20160211204636" -->
<!-- sent="Thu, 11 Feb 2016 13:46:35 -0700" -->
<!-- isosent="20160211204635" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] shared memory zero size segment" -->
<!-- id="20160211204635.GA41700_at_mordor.lanl.gov" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2016-02-11 15:46:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28515.php">Stephen Guzik: "[OMPI users] How to map to sockets with 1 per core, but bind to a single hwthread"</a>
<li><strong>Previous message:</strong> <a href="28513.php">Nathan Hjelm: "Re: [OMPI users] shared memory zero size segment"</a>
<li><strong>In reply to:</strong> <a href="28513.php">Nathan Hjelm: "Re: [OMPI users] shared memory zero size segment"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28517.php">Jeff Hammond: "Re: [OMPI users] shared memory zero size segment"</a>
<li><strong>Reply:</strong> <a href="28517.php">Jeff Hammond: "Re: [OMPI users] shared memory zero size segment"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>-Nathan
<br>
<p>On Thu, Feb 11, 2016 at 01:35:28PM -0700, Nathan Hjelm wrote:
<br>
...
<span class="quotelev2">&gt; &gt;    Thanks Jeff, that was an interesting result. The pointers are here well
</span><br>
<span class="quotelev2">&gt; &gt;    defined, also for the zero size segment.
</span><br>
<span class="quotelev2">&gt; &gt;    However I can't reproduce your output. I still get null pointers (output
</span><br>
...
<span class="quotelev2">&gt; &gt;      See attached.  Output below.  Note that the base you get for ranks 0 and
</span><br>
<span class="quotelev2">&gt; &gt;      1 is the same, so you need to use the fact that size=0 at rank=0 to know
</span><br>
<span class="quotelev2">&gt; &gt;      not to dereference that pointer and expect to be writing into rank 0's
</span><br>
...
<span class="quotelev2">&gt; &gt;      On Thu, Feb 11, 2016 at 8:55 AM, Jeff Hammond &lt;jeff.science_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt; &gt;      wrote:
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt;        On Thu, Feb 11, 2016 at 8:46 AM, Nathan Hjelm &lt;hjelmn_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt; &gt;        &gt; &gt;    This will work fine as long as no segment as size zero. It can
</span><br>
...
<span class="quotelev3">&gt; &gt;        &gt; unfortunately does not define what pointer value is returned for a
</span><br>
...
<span class="quotelev2">&gt; &gt;        MPI_Alloc_mem doesn't say what happens if you pass size=0 either.  The
</span><br>
<span class="quotelev2">&gt; &gt;        RMA working group intentionally tries to maintain consistency with the
</span><br>
<span class="quotelev2">&gt; &gt;        rest of the MPI standard whenever possible, so we did not create a new
</span><br>
<span class="quotelev2">&gt; &gt;        semantic here.
</span><br>
<span class="quotelev2">&gt; &gt;        MPI_Win_shared_query text includes this:
</span><br>
<span class="quotelev2">&gt; &gt;        &quot;If all processes in the group attached to the window specified size =
</span><br>
<span class="quotelev2">&gt; &gt;        0, then the call returns size = 0 and a baseptr as if MPI_ALLOC_MEM
</span><br>
...
<span class="quotelev2">&gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/02/28511.php">http://www.open-mpi.org/community/lists/users/2016/02/28511.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/02/28513.php">http://www.open-mpi.org/community/lists/users/2016/02/28513.php</a>
</span><br>
<p><p>
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28514/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
