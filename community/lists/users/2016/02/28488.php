...
?>
<!-- received="Wed Feb 10 06:43:27 2016" -->
<!-- isoreceived="20160210114327" -->
<!-- sent="Wed, 10 Feb 2016 11:43:25 +0000 (UTC)" -->
<!-- isosent="20160210114325" -->
<!-- name="Peter Wind" -->
<!-- email="peter.wind_at_[hidden]" -->
<!-- subject="Re: [OMPI users] shared memory zero size segment" -->
<!-- id="1269689244.175094.1455104605745.JavaMail.zimbra_at_met.no" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2016-02-10 06:43:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28489.php">Edgar Gabriel: "Re: [OMPI users] error openmpi check hdf5"</a>
<li><strong>Previous message:</strong> <a href="28487.php">Peter Wind: "Re: [OMPI users] shared memory zero size segment"</a>
<li><strong>In reply to:</strong> <a href="28486.php">Jeff Squyres (jsquyres): "Re: [OMPI users] shared memory zero size segment"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28493.php">Gilles Gouaillardet: "Re: [OMPI users] shared memory zero size segment"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><hr>
<ul>
<li>text/x-fortran attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28488/sharetest.f90">sharetest.f90</a>
</ul>
