...
?>
<!-- received="Thu Jan 21 03:31:29 2016" -->
<!-- isoreceived="20160121083129" -->
<!-- sent="Thu, 21 Jan 2016 17:31:25 +0900" -->
<!-- isosent="20160121083125" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI hangs on poll_device() with rdma" -->
<!-- id="56A0975D.3080107_at_rist.or.jp" -->
...
<strong>Date:</strong> 2016-01-21 03:31:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28318.php">Eva: "Re: [OMPI users] MPI hangs on poll_device() with rdma"</a>
<li><strong>Previous message:</strong> <a href="28316.php">Eva: "Re: [OMPI users] MPI hangs on poll_device() with rdma"</a>
<li><strong>In reply to:</strong> <a href="28316.php">Eva: "Re: [OMPI users] MPI hangs on poll_device() with rdma"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28318.php">Eva: "Re: [OMPI users] MPI hangs on poll_device() with rdma"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Gilles
<br>
<p>On 1/21/2016 5:25 PM, Eva wrote:
<br>
...
<span class="quotelev1">&gt;     After some random rounds of communications, the communication
</span><br>
<span class="quotelev1">&gt;     hangs. When I debug into the program, I found:
</span><br>
<span class="quotelev1">&gt;     process1 sent a message to process2;
</span><br>
<span class="quotelev1">&gt;     process2 received the message from process1 and then start to
</span><br>
<span class="quotelev1">&gt;     receive messages from other processes.
</span><br>
<span class="quotelev1">&gt;     But process1 doesn't get notice: process2 has received its message
</span><br>
<span class="quotelev1">&gt;     and then hang on MPI_Send-&gt;...-&gt;poll_device() of rdmav2.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;     move it onto rdma, it starts to hang. And I can't debug into any
</span><br>
<span class="quotelev1">&gt;     rdma details
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/01/28316.php">http://www.open-mpi.org/community/lists/users/2016/01/28316.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28317/attachment">attachment</a>
</ul>
