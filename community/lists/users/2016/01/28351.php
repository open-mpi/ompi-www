...
?>
<!-- received="Sun Jan 24 08:25:54 2016" -->
<!-- isoreceived="20160124132554" -->
<!-- sent="Sun, 24 Jan 2016 22:25:53 +0900" -->
<!-- isosent="20160124132553" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Raspberry Pi 2 Beowulf Cluster for OpenFOAM" -->
<!-- id="CAAkFZ5vdytSJMne2WMXG4i-ZYiXnovhycgr836XxCgkWDFYWEg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-01-24 08:25:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28352.php">Ibrahim Ikhlawi: "[OMPI users] how to benchmark a server with openmpi?"</a>
<li><strong>Previous message:</strong> <a href="28350.php">John Hearns: "Re: [OMPI users] Raspberry Pi 2 Beowulf Cluster for OpenFOAM"</a>
<li><strong>In reply to:</strong> <a href="28349.php">Steve O'Hara: "[OMPI users] Raspberry Pi 2 Beowulf Cluster for OpenFOAM"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28358.php">Steve O'Hara: "Re: [OMPI users] Raspberry Pi 2 Beowulf Cluster for OpenFOAM"</a>
<li><strong>Reply:</strong> <a href="28358.php">Steve O'Hara: "Re: [OMPI users] Raspberry Pi 2 Beowulf Cluster for OpenFOAM"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Steve,
<br>
<p>if I understand correctly, running on one node with 4 MPI tasks is three
<br>
times faster than running on 10 nodes with 40 (10 ?) tasks.
<br>
<p>did you try this test on a x86 cluster and with tcp interconnect, and
<br>
did you get better performance when increasing the number of nodes ?
<br>
<p>can you try to run on the pi cluster with one task per node, and increase
<br>
...
performances.
<br>
<p>you can also run some standard MPI benchmark (osu, imb) and see if you get
<br>
...
<p>Gilles
<br>
<p>On Sunday, January 24, 2016, Steve O'Hara &lt;sohara_at_[hidden]&gt;
<br>
wrote:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28351/attachment">attachment</a>
</ul>
