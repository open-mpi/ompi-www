...
?>
<!-- received="Wed Jan  6 15:51:26 2016" -->
<!-- isoreceived="20160106205126" -->
<!-- sent="Wed, 6 Jan 2016 12:51:21 -0800" -->
<!-- isosent="20160106205121" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Open MPI MPI-OpenMP Hybrid Binding Question" -->
<!-- id="529C051B-E2A0-4580-944A-817B6A9DEC7E_at_open-mpi.org" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2016-01-06 15:51:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28226.php">Ralph Castain: "Re: [OMPI users] Open MPI MPI-OpenMP Hybrid Binding Question"</a>
<li><strong>Previous message:</strong> <a href="28224.php">Nick Papior: "Re: [OMPI users] Open MPI MPI-OpenMP Hybrid Binding Question"</a>
<li><strong>In reply to:</strong> <a href="28223.php">Matt Thompson: "Re: [OMPI users] Open MPI MPI-OpenMP Hybrid Binding Question"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28220.php">Matt Thompson: "Re: [OMPI users] Open MPI MPI-OpenMP Hybrid Binding Question"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Hmmm&#226;&#128;&#166;let me see if I can remember :-)
<br>
<p>Procs-per-object is what it does, of course, but I honestly forget what that last &#226;&#128;&#156;r&#226;&#128;&#157; stands for!
<br>
<p>So what your command line is telling us is:
<br>
<p>map 2 processes on each socket, binding each process to 7 cpu&#226;&#128;&#153;s (&#226;&#128;&#156;pe&#226;&#128;&#157; = processing element)
<br>
<p>In this case, we have defaulted to using cores as cpu&#226;&#128;&#153;s (or &#226;&#128;&#156;pe&#226;&#128;&#153;s&#226;&#128;&#157;). You could also set &#226;&#128;&#148;use-hwthread-cpus and then &#226;&#128;&#156;pe&#226;&#128;&#157; would indicate the number of HTs to use for each process.
<br>
<p>For a hybrid app, you probably want to ensure you have at least one pe for each thread you intend to spawn - but that is something you can experiment with to find the best option. I had hoped to someday make that a little easier by integrating OpenMP with OMPI a little better, but that ran into some controversy and so I abandoned it.
<br>
<p>HTH
<br>
Ralph
<br>
<p><span class="quotelev1">&gt; On Jan 6, 2016, at 12:33 PM, Matt Thompson &lt;fortran_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/01/28223.php">http://www.open-mpi.org/community/lists/users/2016/01/28223.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28225/attachment">attachment</a>
</ul>
