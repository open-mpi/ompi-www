...
?>
<!-- received="Fri Jan 22 13:11:13 2016" -->
<!-- isoreceived="20160122181113" -->
<!-- sent="Fri, 22 Jan 2016 18:11:10 +0000" -->
<!-- isosent="20160122181110" -->
<!-- name="Kuhl, Spencer J" -->
<!-- email="spencer-kuhl_at_[hidden]" -->
<!-- subject="Re: [OMPI users] configuring open mpi 10.1.2 with cuda on NVIDIA TK1" -->
<!-- id="BY2PR04MB712206F9422E70009AB237E8EC40_at_BY2PR04MB712.namprd04.prod.outlook.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2016-01-22 13:11:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28344.php">Matt Thompson: "[OMPI users] Issues Building Open MPI static with Intel Fortran 16"</a>
<li><strong>Previous message:</strong> <a href="28342.php">Sylvain Jeaugey: "Re: [OMPI users] configuring open mpi 10.1.2 with cuda on NVIDIA TK1"</a>
<li><strong>In reply to:</strong> <a href="28342.php">Sylvain Jeaugey: "Re: [OMPI users] configuring open mpi 10.1.2 with cuda on NVIDIA TK1"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Thanks for looking in to this.  I am looking for other CUDA aware mpi code that I can test on my 32 bit arm system, the Jetson TK1
<br>
...
Subject: Re: [OMPI users] configuring open mpi 10.1.2 with cuda on NVIDIA TK1
<br>
<p>It looks like the errors are produced by the hwloc configure ; this one somehow can't find CUDA (I have to check if that's a problem btw). Anyway, later in the configure, the VT configure finds cuda correctly, so it seems specific to the hwloc configure.
<br>
...
<br>
From: users &lt;users-bounces_at_[hidden]&gt;&lt;mailto:users-bounces_at_[hidden]&gt; on behalf of Sylvain Jeaugey &lt;sjeaugey_at_[hidden]&gt;&lt;mailto:sjeaugey_at_[hidden]&gt;
<br>
...
<br>
Link to this post: &lt;<a href="http://www.open-mpi.org/community/lists/users/2016/01/28331.php">http://www.open-mpi.org/community/lists/users/2016/01/28331.php</a>&gt; <a href="http://www.open-mpi.org/community/lists/users/2016/01/28331.php">http://www.open-mpi.org/community/lists/users/2016/01/28331.php</a>
<br>
...
Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/01/28341.php">http://www.open-mpi.org/community/lists/users/2016/01/28341.php</a>
<br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28343/attachment">attachment</a>
</ul>
