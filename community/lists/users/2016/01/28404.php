...
?>
<!-- received="Thu Jan 28 21:33:10 2016" -->
<!-- isoreceived="20160129023310" -->
<!-- sent="Fri, 29 Jan 2016 11:33:07 +0900" -->
<!-- isosent="20160129023307" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Any changes to rmaps in 1.10.2?" -->
<!-- id="56AACF63.60606_at_rist.or.jp" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="005601d15a3a$02a58520$07f08f60$_at_nci.org.au" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-01-28 21:33:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28405.php">Ben Menadue: "Re: [OMPI users] Any changes to rmaps in 1.10.2?"</a>
<li><strong>Previous message:</strong> <a href="28403.php">Gilles Gouaillardet: "Re: [OMPI users] Any changes to rmaps in 1.10.2?"</a>
<li><strong>In reply to:</strong> <a href="28402.php">Ben Menadue: "Re: [OMPI users] Any changes to rmaps in 1.10.2?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28405.php">Ben Menadue: "Re: [OMPI users] Any changes to rmaps in 1.10.2?"</a>
<li><strong>Reply:</strong> <a href="28405.php">Ben Menadue: "Re: [OMPI users] Any changes to rmaps in 1.10.2?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; Okay, it definitely seems to be due to the cpuset having only one of the
</span><br>
<span class="quotelev1">&gt; hyperthreads of each physical core:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; 13:03 bjm900_at_r60 ~ &gt; cat /cgroup/cpuset/pbspro/4363542.r-man2/cpuset.cpus
</span><br>
...
<span class="quotelev1">&gt; From: users [mailto:users-bounces_at_[hidden]] On Behalf Of Ben Menadue
</span><br>
...
<span class="quotelev1">&gt; 1.10.2 are attached from inside the same job - they look identical (apart
</span><br>
<span class="quotelev1">&gt; from the pids), except at the very end where 1.10.2 errors out while 1.10.1
</span><br>
...
<span class="quotelev1">&gt; The &quot;-np 2&quot; is because that's what I was using to benchmark the install
</span><br>
<span class="quotelev1">&gt; (osu_bibw) and I just copied it over from when I realised it wasn't even
</span><br>
<span class="quotelev1">&gt; starting. But it does the same regardless of whether I specify the number of
</span><br>
<span class="quotelev1">&gt; processes or not (without it gets the number of tasks from PBS).
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; The nodes are 2 x 8-core sockets with hyper-threading on, and you can chose
</span><br>
<span class="quotelev1">&gt; whether to use the extra hardware threads when submitting the job. If you
</span><br>
<span class="quotelev1">&gt; want them, your cgroup includes both threads on each core (e.g. 0-31),
</span><br>
<span class="quotelev1">&gt; otherwise only one thread (e.g. 0-15) (cores 16-32 are the thread siblings
</span><br>
<span class="quotelev1">&gt; of cores 0-15).
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; For reference, the PBS job I was using above had ncpus=32,mem=16G, which
</span><br>
...
<span class="quotelev1">&gt; under the hood with a cpuset containing cores 0-15 on each of the two nodes.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Interestingly, if I use a cpuset containing both threads of each physical
</span><br>
<span class="quotelev1">&gt; core (i.e. ask for hyperthreading on job submission), then it runs fine
</span><br>
<span class="quotelev1">&gt; under 1.10.2.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Cheers,
...
<span class="quotelev1">&gt; that is not needed if you submit with qsub -l nodes=1:ppn=2 do you observe
</span><br>
<span class="quotelev1">&gt; the same behavior without -np 2 ?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev2">&gt;&gt; hostname [r47:18709] mca: base: components_register: registering rmaps
</span><br>
<span class="quotelev2">&gt;&gt; components [r47:18709] mca: base: components_register: found loaded
</span><br>
<span class="quotelev2">&gt;&gt; component resilient [r47:18709] mca: base: components_register:
</span><br>
...
<span class="quotelev2">&gt;&gt; open function successful [r47:18709] mca: base: components_open: found
</span><br>
<span class="quotelev2">&gt;&gt; loaded component rank_file [r47:18709] mca: base: components_open:
</span><br>
...
<span class="quotelev2">&gt;&gt; components_open: component staged open function successful [r47:18709]
</span><br>
...
<span class="quotelev2">&gt;&gt; mca:rmaps:select: checking available component round_robin [r47:18709]
</span><br>
...
<span class="quotelev2">&gt;&gt; with bindings CORE [r47:18709] [[63529,0],0] reset_usage: node r47 has
</span><br>
...
<span class="quotelev2">&gt;&gt; staged closed [r47:18709] mca: base: close: unloading component staged
</span><br>
<span class="quotelev2">&gt;&gt; [r47:18709] mca: base: close: component ppr closed [r47:18709] mca:
</span><br>
<span class="quotelev2">&gt;&gt; base: close: unloading component ppr [r47:18709] mca: base: close:
</span><br>
<span class="quotelev2">&gt;&gt; component seq closed [r47:18709] mca: base: close: unloading component
</span><br>
<span class="quotelev2">&gt;&gt; seq [r47:18709] mca: base: close: component round_robin closed
</span><br>
...
<span class="quotelev2">&gt;&gt; hostname [r47:18733] mca: base: components_register: registering rmaps
</span><br>
<span class="quotelev2">&gt;&gt; components [r47:18733] mca: base: components_register: found loaded
</span><br>
<span class="quotelev2">&gt;&gt; component resilient [r47:18733] mca: base: components_register:
</span><br>
...
<span class="quotelev2">&gt;&gt; open function successful [r47:18733] mca: base: components_open: found
</span><br>
<span class="quotelev2">&gt;&gt; loaded component rank_file [r47:18733] mca: base: components_open:
</span><br>
...
<span class="quotelev2">&gt;&gt; components_open: component staged open function successful [r47:18733]
</span><br>
...
<span class="quotelev2">&gt;&gt; mca:rmaps:select: checking available component round_robin [r47:18733]
</span><br>
...
<span class="quotelev2">&gt;&gt; close: component staged closed [r47:18733] mca: base: close: unloading
</span><br>
<span class="quotelev2">&gt;&gt; component staged [r47:18733] mca: base: close: component ppr closed
</span><br>
<span class="quotelev2">&gt;&gt; [r47:18733] mca: base: close: unloading component ppr [r47:18733] mca:
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/01/28402.php">http://www.open-mpi.org/community/lists/users/2016/01/28402.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<!-- body="end" -->
