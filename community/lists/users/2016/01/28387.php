...
?>
<!-- received="Tue Jan 26 10:48:05 2016" -->
<!-- isoreceived="20160126154805" -->
<!-- sent="Tue, 26 Jan 2016 16:47:43 +0100" -->
<!-- isosent="20160126154743" -->
<!-- name="Nick Papior" -->
<!-- email="nickpapior_at_[hidden]" -->
<!-- subject="Re: [OMPI users] build failure with NAG Fortran" -->
<!-- id="CAAbhqc5HQE7GU14O-A4vet463bVeQGOy5CnAgFHWOfBpLBqXyA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-01-26 10:47:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28388.php">Dave Love: "[OMPI users] Fortran features and interfaces (was: Strange behaviour OpenMPI in Fortran)"</a>
<li><strong>Previous message:</strong> <a href="28386.php">Dave Love: "Re: [OMPI users] cleaning up old ROMIO (MPI-IO) drivers"</a>
<li><strong>In reply to:</strong> <a href="28385.php">Dave Love: "[OMPI users] build failure with NAG Fortran"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28389.php">Gilles Gouaillardet: "Re: [OMPI users] build failure with NAG Fortran"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Try and add this flag to the nagfor compiler.
<br>
<p>-width=90
<br>
<p>it seems may be related to line-length limit?
<br>
<p><p>2016-01-26 16:26 GMT+01:00 Dave Love &lt;d.love_at_[hidden]&gt;:
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28387/attachment">attachment</a>
</ul>
