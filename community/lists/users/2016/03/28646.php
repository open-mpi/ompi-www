...
?>
<!-- received="Sun Mar  6 21:40:43 2016" -->
<!-- isoreceived="20160307024043" -->
<!-- sent="Sun, 6 Mar 2016 21:40:39 -0500" -->
<!-- isosent="20160307024039" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Sending string causes memory errors" -->
<!-- id="CAMJJpkV2GTfJrhNjmJtOtikBbbCr2Oxcv_fFZR2t+hDQ0fBiBA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="56DCE76A.7040204_at_rist.or.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-03-06 21:40:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28647.php">Gilles Gouaillardet: "Re: [OMPI users] Sending string causes memory errors"</a>
<li><strong>Previous message:</strong> <a href="28645.php">Gilles Gouaillardet: "Re: [OMPI users] Sending string causes memory errors"</a>
<li><strong>In reply to:</strong> <a href="28645.php">Gilles Gouaillardet: "Re: [OMPI users] Sending string causes memory errors"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28647.php">Gilles Gouaillardet: "Re: [OMPI users] Sending string causes memory errors"</a>
<li><strong>Reply:</strong> <a href="28647.php">Gilles Gouaillardet: "Re: [OMPI users] Sending string causes memory errors"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gilles,
<br>
<p>memchecker is intended to be used together with some suppression rules.
<br>
<p>For the receive the rationale of making the buffer unaccessible after the
<br>
...
<br>
<p>For the send, the rationale is now obsolete as the MPI Forum removed the
<br>
...
<p>&nbsp;&nbsp;George.
<br>
<p><p>On Sun, Mar 6, 2016 at 9:28 PM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;
<br>
wrote:
<br>
...
<span class="quotelev1">&gt; on rhel7, valgrind complains about an invalid read when accessing the recv
</span><br>
<span class="quotelev1">&gt; buffer after MPI_Recv.
</span><br>
...
<span class="quotelev1">&gt; i added some trace, and OpenMPI told valgrind to mark the buffer as non
</span><br>
...
<span class="quotelev1">&gt; the issue can be seen on both master and v1.10 when OpenMPI is configure'd
</span><br>
...
<span class="quotelev1">&gt; what is the rationale for marking the buffer an unaccessable after the
</span><br>
...
<span class="quotelev1">&gt; also, in MPI_Send (ompi/mpi/c/isend.c) what is the rationale for marking
</span><br>
<span class="quotelev1">&gt; the buffer as non accessible before calling the PML isend ?
</span><br>
...
<span class="quotelev1">&gt; - MPI_Isend/MPI_Recv issues three warning, one in the test, and two in
</span><br>
<span class="quotelev1">&gt; OpenMPI
</span><br>
<span class="quotelev1">&gt; i previously reported a very weird behaviour ... and the root cause is one
</span><br>
<span class="quotelev1">&gt; subroutine in
</span><br>
<span class="quotelev1">&gt; the test program was called &quot;send&quot;, which conflicts with the send libc
</span><br>
...
<span class="quotelev2">&gt;&gt; All of those valgrind reports below are from within your code -- not from
</span><br>
<span class="quotelev2">&gt;&gt; within Open MPI.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; All Open MPI can do is pass the contents of your message properly; you
</span><br>
<span class="quotelev2">&gt;&gt; can verify that it is being sent and received properly by checking the byte
</span><br>
<span class="quotelev2">&gt;&gt; contents of your received array (e.g., assert that the string is there
</span><br>
<span class="quotelev2">&gt;&gt; correctly and is \0-terminated).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; If cout or some other std:: thing is going beyond the end of your
</span><br>
<span class="quotelev2">&gt;&gt; allocated buffer, that's a different problem -- perhaps you have a busted
</span><br>
<span class="quotelev2">&gt;&gt; std:: implementation...?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; ==5324== Using Valgrind-3.12.0.SVN and LibVEX; rerun with -h for
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ==5325== Using Valgrind-3.12.0.SVN and LibVEX; rerun with -h for
</span><br>
<span class="quotelev3">&gt;&gt;&gt; copyright info
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ==5325==    by 0x56852D8: std::basic_ostream&lt;char,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; std::char_traits&lt;char&gt; &gt;&amp; std::operator&lt;&lt; &lt;std::char_traits&lt;char&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;(std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp;, char const*)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (ostream:562)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ==5325==    by 0x5684F75: std::basic_ostream&lt;char,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; std::char_traits&lt;char&gt; &gt;&amp; std::__ostream_insert&lt;char,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; std::char_traits&lt;char&gt; &gt;(std::basic_ostream&lt;char, std::char_traits&lt;char&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&amp;, char const*, long) (ostream_insert.h:101)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==5325==    by 0x56852E6: std::basic_ostream&lt;char,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; std::char_traits&lt;char&gt; &gt;&amp; std::operator&lt;&lt; &lt;std::char_traits&lt;char&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;(std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp;, char const*)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (ostream:561)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==5325==    by 0x408A45: receive() (mpi_gilles.cpp:22)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==5325==    by 0x408B88: main (mpi_gilles.cpp:44)
...
<span class="quotelev3">&gt;&gt;&gt; ==5325==   total heap usage: 15,007 allocs, 14,760 frees, 13,362,050
</span><br>
<span class="quotelev3">&gt;&gt;&gt; bytes allocated
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==5325==
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ==5324==   total heap usage: 15,028 allocs, 14,781 frees, 13,370,286
</span><br>
<span class="quotelev3">&gt;&gt;&gt; bytes allocated
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==5324==
...
<span class="quotelev3">&gt;&gt;&gt; Am Donnerstag, 3. M&#195;&#164;rz 2016, 14:53:24 CET schrieb Gilles Gouaillardet:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Am Mittwoch, 2. M&#195;&#164;rz 2016, 23:36:56 CET schrieb Gilles Gouaillardet:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28646/attachment">attachment</a>
</ul>
