...
?>
<!-- received="Sun Mar  6 21:28:58 2016" -->
<!-- isoreceived="20160307022858" -->
<!-- sent="Mon, 7 Mar 2016 11:28:58 +0900" -->
<!-- isosent="20160307022858" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Sending string causes memory errors" -->
<!-- id="56DCE76A.7040204_at_rist.or.jp" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="875186F8-363C-4208-A0A7-7B2C5EDCD19F_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-03-06 21:28:58
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28646.php">George Bosilca: "Re: [OMPI users] Sending string causes memory errors"</a>
<li><strong>Previous message:</strong> <a href="28644.php">Gilles Gouaillardet: "Re: [OMPI users] openmpi bug on mac os 10.11.3 ?"</a>
<li><strong>In reply to:</strong> <a href="28627.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Sending string causes memory errors"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28646.php">George Bosilca: "Re: [OMPI users] Sending string causes memory errors"</a>
<li><strong>Reply:</strong> <a href="28646.php">George Bosilca: "Re: [OMPI users] Sending string causes memory errors"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Folks,
<br>
<p>Here is attached a simplified C only version of the test program.
<br>
it can be ran with two or one task.
<br>
<p>on rhel7, valgrind complains about an invalid read when accessing the 
<br>
...
<br>
<p>i added some trace, and OpenMPI told valgrind to mark the buffer as non 
<br>
accessible
<br>
...
<br>
<p>the issue can be seen on both master and v1.10 when OpenMPI is 
<br>
configure'd with
<br>
--enable-memchecker --with-valgrind
<br>
<p>in mca_pml_ob1_recv_request_progress_match() from 
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;);
<br>
<p>also, in MPI_Send (ompi/mpi/c/isend.c) what is the rationale for marking 
<br>
...
<br>
<p>if i #if out these two calls, then the test program runs just fine
<br>
<p>fwiw :
<br>
...
<p>Gilles
<br>
<p>On 3/3/2016 9:43 PM, Jeff Squyres (jsquyres) wrote:
<br>
<span class="quotelev1">&gt; All of those valgrind reports below are from within your code -- not from within Open MPI.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; All Open MPI can do is pass the contents of your message properly; you can verify that it is being sent and received properly by checking the byte contents of your received array (e.g., assert that the string is there correctly and is \0-terminated).
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; If cout or some other std:: thing is going beyond the end of your allocated buffer, that's a different problem -- perhaps you have a busted std:: implementation...?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Mar 3, 2016, at 2:47 AM, Florian Lindner &lt;mailinglists_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; % mpicxx -std=c++11 -g -O0 -Wall -Wextra -fno-builtin-strlen mpi_gilles.cpp &amp;&amp; mpirun -n 2 ./a.out
</span><br>
...
<span class="quotelev2">&gt;&gt; % LD_PRELOAD=/usr/lib/valgrind/libmpiwrap-amd64-linux.so mpirun -n 2 valgrind ./a.out
</span><br>
...
<span class="quotelev2">&gt;&gt; ==5324== Using Valgrind-3.12.0.SVN and LibVEX; rerun with -h for copyright info
</span><br>
...
<span class="quotelev2">&gt;&gt; ==5325== Using Valgrind-3.12.0.SVN and LibVEX; rerun with -h for copyright info
</span><br>
...
<span class="quotelev2">&gt;&gt; ==5325==    at 0x4C2D992: strlen (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x56852D8: length (char_traits.h:267)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x56852D8: std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp; std::operator&lt;&lt; &lt;std::char_traits&lt;char&gt; &gt;(std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp;, char const*) (ostream:562)
</span><br>
...
<span class="quotelev2">&gt;&gt; ==5325==    at 0x4C2D9A4: strlen (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x56852D8: length (char_traits.h:267)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x56852D8: std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp; std::operator&lt;&lt; &lt;std::char_traits&lt;char&gt; &gt;(std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp;, char const*) (ostream:562)
...
<span class="quotelev2">&gt;&gt; ==5325==    at 0x60A0FF1: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/libc-2.23.so)
</span><br>
...
<span class="quotelev2">&gt;&gt; ==5325==    by 0x5684F75: __ostream_write&lt;char, std::char_traits&lt;char&gt; &gt; (ostream_insert.h:50)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x5684F75: std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp; std::__ostream_insert&lt;char, std::char_traits&lt;char&gt; &gt;(std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp;, char const*, long) (ostream_insert.h:101)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x56852E6: std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp; std::operator&lt;&lt; &lt;std::char_traits&lt;char&gt; &gt;(std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp;, char const*) (ostream:561)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x408A45: receive() (mpi_gilles.cpp:22)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x408B88: main (mpi_gilles.cpp:44)
...
<span class="quotelev2">&gt;&gt; ==5325==    at 0x60A100D: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/libc-2.23.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x6096D1A: fwrite (in /usr/lib/libc-2.23.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x5684F75: sputn (streambuf:451)
...
<span class="quotelev2">&gt;&gt; ==5325==    at 0x4C2F758: __GI_memcpy (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x60A0F3A: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/libc-2.23.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x6096D1A: fwrite (in /usr/lib/libc-2.23.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x5684F75: sputn (streambuf:451)
...
<span class="quotelev2">&gt;&gt; ==5325==    at 0x4C2F766: __GI_memcpy (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x60A0F3A: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/libc-2.23.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x6096D1A: fwrite (in /usr/lib/libc-2.23.so)
...
<span class="quotelev2">&gt;&gt; ==5325==    at 0x4C2F7B0: __GI_memcpy (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x60A0F3A: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/libc-2.23.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x6096D1A: fwrite (in /usr/lib/libc-2.23.so)
...
<span class="quotelev2">&gt;&gt; ==5325==    at 0x4C2F7BE: __GI_memcpy (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x60A0F3A: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/libc-2.23.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x6096D1A: fwrite (in /usr/lib/libc-2.23.so)
...
<span class="quotelev2">&gt;&gt; ==5325==    at 0x4C2F7E8: __GI_memcpy (in /usr/lib/valgrind/vgpreload_memcheck-amd64-linux.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x60A0F3A: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/libc-2.23.so)
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==    by 0x6096D1A: fwrite (in /usr/lib/libc-2.23.so)
...
<span class="quotelev2">&gt;&gt; ==5325==   total heap usage: 15,007 allocs, 14,760 frees, 13,362,050 bytes allocated
</span><br>
<span class="quotelev2">&gt;&gt; ==5325==
</span><br>
...
<span class="quotelev2">&gt;&gt; ==5324==   total heap usage: 15,028 allocs, 14,781 frees, 13,370,286 bytes allocated
</span><br>
<span class="quotelev2">&gt;&gt; ==5324==
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; They are still there. But, was this meant as a joke or didn't I understand?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/03/28619.php">http://www.open-mpi.org/community/lists/users/2016/03/28619.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/03/28623.php">http://www.open-mpi.org/community/lists/users/2016/03/28623.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><p>
<br><hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28645/sendrecv.c">sendrecv.c</a>
</ul>
