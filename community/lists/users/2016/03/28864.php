<?
$subject_val = "[OMPI users] CUDA IPC/RDMA Not Working";
include("../../include/msg-header.inc");
?>
<!-- received="Wed Mar 30 11:37:36 2016" -->
<!-- isoreceived="20160330153736" -->
<!-- sent="Wed, 30 Mar 2016 15:37:29 +0000" -->
<!-- isosent="20160330153729" -->
<!-- name="Justin Luitjens" -->
<!-- email="jluitjens_at_[hidden]" -->
<!-- subject="[OMPI users] CUDA IPC/RDMA Not Working" -->
<!-- id="84c072717a034e9f9aa10784dd6453bd_at_HQMAIL111.nvidia.com" -->
<!-- charset="us-ascii" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] CUDA IPC/RDMA Not Working<br>
<strong>From:</strong> Justin Luitjens (<em>jluitjens_at_[hidden]</em>)<br>
<strong>Date:</strong> 2016-03-30 11:37:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28865.php">Justin Luitjens: "Re: [OMPI users] CUDA IPC/RDMA Not Working"</a>
<li><strong>Previous message:</strong> <a href="28863.php">Sebastian Rettenberger: "Re: [OMPI users] Collective MPI-IO + MPI_THREAD_MULTIPLE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28865.php">Justin Luitjens: "Re: [OMPI users] CUDA IPC/RDMA Not Working"</a>
<li><strong>Maybe reply:</strong> <a href="28865.php">Justin Luitjens: "Re: [OMPI users] CUDA IPC/RDMA Not Working"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28864/attachment">attachment</a>
</ul>
