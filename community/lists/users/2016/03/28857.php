...
?>
<!-- received="Mon Mar 28 02:51:58 2016" -->
<!-- isoreceived="20160328065158" -->
<!-- sent="Mon, 28 Mar 2016 02:51:57 -0400" -->
<!-- isosent="20160328065157" -->
<!-- name="dpchoudh ." -->
<!-- email="dpchoudh_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Error running mpicc" -->
<!-- id="CAHXxYDhtk9XmaOnsk9HrFeQ2DziCzW5TTYjDunLRZ_JKgyYA3Q_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-03-28 02:51:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28858.php">Gilles Gouaillardet: "Re: [OMPI users] Error running mpicc"</a>
<li><strong>Previous message:</strong> <a href="28856.php">Gilles Gouaillardet: "Re: [OMPI users] Error running mpicc"</a>
<li><strong>In reply to:</strong> <a href="28856.php">Gilles Gouaillardet: "Re: [OMPI users] Error running mpicc"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28858.php">Gilles Gouaillardet: "Re: [OMPI users] Error running mpicc"</a>
<li><strong>Reply:</strong> <a href="28858.php">Gilles Gouaillardet: "Re: [OMPI users] Error running mpicc"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello Gilles
<br>
<p>Thank you very much for your prompt response!
<br>
<p>Here are the answers to your questions:
<br>
<p>[durga_at_smallMPI ~]$ ldd `which mpicc` | grep libnl
<br>
...
<br>
<p>So yes, mpicc does seem to need both libnl and libnl3. And this is even
<br>
though libnl3-devel is NOT installed on my system:
<br>
...
@base
<br>
<p><p>Could it be because of the --disable-dlopen switch to ./configure? The
<br>
other two switches (--enable-debug and --enable-debug-symbols seem pretty
<br>
harmless).
<br>
<p>I'll try your other suggestion and let you know the outcome shortly.
<br>
<p>Thanks
<br>
Durga
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28857/attachment">attachment</a>
</ul>
