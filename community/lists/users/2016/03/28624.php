...
?>
<!-- received="Thu Mar  3 03:51:02 2016" -->
<!-- isoreceived="20160303085102" -->
<!-- sent="Thu, 3 Mar 2016 17:50:59 +0900" -->
<!-- isosent="20160303085059" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Sending string causes memory errors" -->
<!-- id="CAAkFZ5stdy7LNTb2VmRoAVrJN82P-6rppYZVzfMesPGOcjeUiw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-03-03 03:50:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28625.php">Florian Lindner: "Re: [OMPI users] Sending string causes memory errors"</a>
<li><strong>Previous message:</strong> <a href="28623.php">Florian Lindner: "Re: [OMPI users] Sending string causes memory errors"</a>
<li><strong>In reply to:</strong> <a href="28623.php">Florian Lindner: "Re: [OMPI users] Sending string causes memory errors"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28626.php">Florian Lindner: "Re: [OMPI users] Sending string causes memory errors"</a>
<li><strong>Reply:</strong> <a href="28626.php">Florian Lindner: "Re: [OMPI users] Sending string causes memory errors"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Florian,
<br>
<p>which distro are you running on ?
<br>
...
<p>Gilles
<br>
<p>On Thursday, March 3, 2016, Florian Lindner &lt;mailinglists_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I am still getting errors, even with your script.
</span><br>
...
<span class="quotelev1">&gt; % mpicxx -std=c++11 -g -O0 -Wall -Wextra -fno-builtin-strlen
</span><br>
<span class="quotelev1">&gt; mpi_gilles.cpp &amp;&amp; mpirun -n 2 ./a.out
</span><br>
...
<span class="quotelev1">&gt; % LD_PRELOAD=/usr/lib/valgrind/libmpiwrap-amd64-linux.so mpirun -n 2
</span><br>
...
<span class="quotelev1">&gt; ==5324== Using Valgrind-3.12.0.SVN and LibVEX; rerun with -h for copyright
</span><br>
...
<span class="quotelev1">&gt; ==5325== Using Valgrind-3.12.0.SVN and LibVEX; rerun with -h for copyright
</span><br>
<span class="quotelev1">&gt; info
</span><br>
...
<span class="quotelev1">&gt; ==5325==    by 0x56852D8: std::basic_ostream&lt;char, std::char_traits&lt;char&gt;
</span><br>
...
<span class="quotelev1">&gt; ==5325==    at 0x60A0FF1: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/
</span><br>
...
<span class="quotelev1">&gt; ==5325==    by 0x5684F75: __ostream_write&lt;char, std::char_traits&lt;char&gt; &gt;
</span><br>
<span class="quotelev1">&gt; (ostream_insert.h:50)
</span><br>
<span class="quotelev1">&gt; ==5325==    by 0x5684F75: std::basic_ostream&lt;char, std::char_traits&lt;char&gt;
</span><br>
...
<span class="quotelev1">&gt; ==5325==    by 0x56852E6: std::basic_ostream&lt;char, std::char_traits&lt;char&gt;
</span><br>
<span class="quotelev2">&gt; &gt;&amp; std::operator&lt;&lt; &lt;std::char_traits&lt;char&gt; &gt;(std::basic_ostream&lt;char,
</span><br>
...
<span class="quotelev1">&gt; ==5325==    at 0x60A100D: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/
</span><br>
<span class="quotelev1">&gt; libc-2.23.so)
</span><br>
<span class="quotelev1">&gt; ==5325==    by 0x6096D1A: fwrite (in /usr/lib/libc-2.23.so)
...
<span class="quotelev1">&gt; ==5325==    by 0x60A0F3A: _IO_file_xsputn@@GLIBC_2.2.5 (in /usr/lib/
</span><br>
<span class="quotelev1">&gt; libc-2.23.so)
</span><br>
<span class="quotelev1">&gt; ==5325==    by 0x6096D1A: fwrite (in /usr/lib/libc-2.23.so)
...
<span class="quotelev1">&gt; ==5325==   total heap usage: 15,007 allocs, 14,760 frees, 13,362,050 bytes
</span><br>
...
<span class="quotelev1">&gt; ==5324==   total heap usage: 15,028 allocs, 14,781 frees, 13,370,286 bytes
</span><br>
<span class="quotelev1">&gt; allocated
</span><br>
<span class="quotelev1">&gt; ==5324==
...
<span class="quotelev1">&gt; Am Donnerstag, 3. M&#195;&#164;rz 2016, 14:53:24 CET schrieb Gilles Gouaillardet:
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; Am Mittwoch, 2. M&#195;&#164;rz 2016, 23:36:56 CET schrieb Gilles Gouaillardet:
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; Florian,
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; under the hood, strlen() can use vector instructions, and then read
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; They are still there. But, was this meant as a joke or didn't I
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; On Wednesday, March 2, 2016, Florian Lindner &lt;mailinglists_at_[hidden]
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; using OpenMPI 1.10.2 and valgrind 3.11.0 I try to use the code below
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; It works fine, but running through valgrind gives a lot of memory
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; % mpicxx -std=c++11 -g -O0 -Wall -Wextra mpi.cpp &amp;&amp; mpirun -n 2
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9290== Copyright (C) 2002-2015, and GNU GPL'd, by Julian Seward et
</span><br>
<span class="quotelev1">&gt; al.
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9290== Using Valgrind-3.11.0 and LibVEX; rerun with -h for
</span><br>
<span class="quotelev1">&gt; copyright info
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9291== Copyright (C) 2002-2015, and GNU GPL'd, by Julian Seward et
</span><br>
<span class="quotelev1">&gt; al.
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9291== Using Valgrind-3.11.0 and LibVEX; rerun with -h for
</span><br>
<span class="quotelev1">&gt; copyright info
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; valgrind MPI wrappers  9290: Try MPIWRAP_DEBUG=help for possible
</span><br>
<span class="quotelev1">&gt; options
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; valgrind MPI wrappers  9291: Try MPIWRAP_DEBUG=help for possible
</span><br>
<span class="quotelev1">&gt; options
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; Stringlength = 6
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9291==    by 0x56852D8: std::basic_ostream&lt;char,
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9291==    by 0x5684F75: __ostream_write&lt;char,
</span><br>
<span class="quotelev1">&gt; std::char_traits&lt;char&gt; &gt;
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; (ostream_insert.h:50)
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9291==    by 0x5684F75: std::basic_ostream&lt;char,
</span><br>
<span class="quotelev1">&gt; std::char_traits&lt;char&gt;
</span><br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; &amp; std::__ostream_insert&lt;char, std::char_traits&lt;char&gt;
</span><br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; (std::basic_ostream&lt;char, std::char_traits&lt;char&gt; &gt;&amp;, char const*,
</span><br>
<span class="quotelev1">&gt; long)
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; (ostream_insert.h:101)
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9291==    by 0x56852E6: std::basic_ostream&lt;char,
</span><br>
<span class="quotelev1">&gt; std::char_traits&lt;char&gt;
</span><br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; &amp; std::operator&lt;&lt; &lt;std::char_traits&lt;char&gt; &gt;(std::basic_ostream&lt;char,
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9291==   total heap usage: 15,020 allocs, 14,773 frees, 13,362,383
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9291== ERROR SUMMARY: 14 errors from 6 contexts (suppressed: 0
</span><br>
<span class="quotelev1">&gt; from 0)
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9290==
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9290==   total heap usage: 15,018 allocs, 14,771 frees, 13,370,045
</span><br>
<span class="quotelev1">&gt; bytes
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; allocated
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; ==9290== ERROR SUMMARY: 0 errors from 0 contexts (suppressed: 0 from
</span><br>
<span class="quotelev1">&gt; 0)
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt;
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; users_at_[hidden] &lt;javascript:;&gt; &lt;javascript:;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28624/attachment">attachment</a>
</ul>
