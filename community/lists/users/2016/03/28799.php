...
?>
<!-- received="Wed Mar 23 10:20:54 2016" -->
<!-- isoreceived="20160323142054" -->
<!-- sent="Wed, 23 Mar 2016 10:13:47 -0400" -->
<!-- isosent="20160323141347" -->
<!-- name="Ronald Cohen" -->
<!-- email="recohen3_at_[hidden]" -->
<!-- subject="Re: [OMPI users] terrible infiniband performance for" -->
<!-- id="CAEcVHtMCBUMw7Un=tYWh4HFZO0z5CEph3-yvEBHTHDDuKKgCaA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAG4F6z-FRjLw4dQq38KP3M4x1Sd33rQsXyFGjLJG4xrQ9EgT4w_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-03-23 10:13:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28800.php">Ronald Cohen: "Re: [OMPI users] terrible infiniband performance for"</a>
<li><strong>Previous message:</strong> <a href="28798.php">Gilles Gouaillardet: "Re: [OMPI users] Strange problem with mpirun and LIGGGHTS after reboot of machine"</a>
<li><strong>In reply to:</strong> <a href="28795.php">Joshua Ladd: "Re: [OMPI users] terrible infiniband performance for"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28796.php">Gilles Gouaillardet: "Re: [OMPI users] terrible infiniband performance for"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
I have tried:
<br>
<p>mpirun --mca btl openib,self -hostfile $PBS_NODEFILE -n 16  xhpl  &gt; xhpl.out
<br>
<p>and
<br>
<p>mpirun -hostfile $PBS_NODEFILE -n 16  xhpl  &gt; xhpl.out
<br>
<p>How do I run &quot;sanity checks, like OSU latency and bandwidth benchmarks
<br>
...
twitter: @recohen3
On Wed, Mar 23, 2016 at 9:28 AM, Joshua Ladd &lt;jladd.mlnx_at_[hidden]&gt; wrote:
&gt; Hi, Ron
&gt;
...
&gt; Josh
&gt;
&gt; On Wed, Mar 23, 2016 at 8:47 AM, Ronald Cohen &lt;recohen3_at_[hidden]&gt; wrote:
&gt;&gt;
...
&gt; Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>
&gt; Link to this post:
&gt; <a href="http://www.open-mpi.org/community/lists/users/2016/03/28795.php">http://www.open-mpi.org/community/lists/users/2016/03/28795.php</a>
</pre>
<!-- body="end" -->
<hr>
<ul class="links">
