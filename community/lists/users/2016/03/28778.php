...
?>
<!-- received="Mon Mar 21 16:14:54 2016" -->
<!-- isoreceived="20160321201454" -->
<!-- sent="Mon, 21 Mar 2016 13:14:33 -0700" -->
<!-- isosent="20160321201433" -->
<!-- name="Jeff Hammond" -->
<!-- email="jeff.science_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Q: Fortran, MPI_VERSION and #defines" -->
<!-- id="CAGKz=uLkTfu5U+qkLw41NSaJbe45pvbeqESmD8a462h_LD=cOw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-03-21 16:14:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28779.php">Jeff Hammond: "Re: [OMPI users] Q: Fortran, MPI_VERSION and #defines"</a>
<li><strong>Previous message:</strong> <a href="28777.php">Brian Dobbins: "[OMPI users] Q: Fortran, MPI_VERSION and #defines"</a>
<li><strong>In reply to:</strong> <a href="28777.php">Brian Dobbins: "[OMPI users] Q: Fortran, MPI_VERSION and #defines"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28779.php">Jeff Hammond: "Re: [OMPI users] Q: Fortran, MPI_VERSION and #defines"</a>
<li><strong>Reply:</strong> <a href="28779.php">Jeff Hammond: "Re: [OMPI users] Q: Fortran, MPI_VERSION and #defines"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I end up doing this (except for the Fortran part) with MPI RMA code.  For
<br>
...
<p>Jeff
<br>
<p>On Mon, Mar 21, 2016 at 10:27 AM, Brian Dobbins &lt;bdobbins_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt;   I'm working on some code that'll be used and downloaded by others on
</span><br>
...
<span class="quotelev1">&gt;   Obviously I can just have the user supply the -DMPI_VERSION=3 flag (or a
</span><br>
...
<span class="quotelev1">&gt; projects that aren't using Cmake?  Scientists don't typically know what
</span><br>
<span class="quotelev1">&gt; version of MPI they're running, so the more that can be detected and
</span><br>
<span class="quotelev1">&gt; handled automatically the better.  (Providing stub versions that link
</span><br>
...
<span class="quotelev1">&gt; Or any other suggestions?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/users/2016/03/28777.php">http://www.open-mpi.org/community/lists/users/2016/03/28777.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><p><p><pre>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28778/attachment">attachment</a>
</ul>
