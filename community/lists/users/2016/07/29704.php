...
?>
<!-- received="Sat Jul 23 21:13:19 2016" -->
<!-- isoreceived="20160724011319" -->
<!-- sent="Sun, 24 Jul 2016 10:13:08 +0900" -->
<!-- isosent="20160724011308" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ompi_info -c does not print configure arguments" -->
<!-- id="CAAkFZ5tDxEx3RLDr3mQ3F-5eT_Tz4RZ5JGMSORgfr-iXgSDnNw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAGKz=uJ3AsF1T7qOT46Bfy57DachNL2Mbtgu1AdS8LJ6XUjNdA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-07-23 21:13:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29705.php">Gilles Gouaillardet: "Re: [OMPI users] ompi_info -c does not print configure arguments"</a>
<li><strong>Previous message:</strong> <a href="29703.php">Jeff Hammond: "[OMPI users] ompi_info -c does not print configure arguments"</a>
<li><strong>In reply to:</strong> <a href="29703.php">Jeff Hammond: "[OMPI users] ompi_info -c does not print configure arguments"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29705.php">Gilles Gouaillardet: "Re: [OMPI users] ompi_info -c does not print configure arguments"</a>
<li><strong>Reply:</strong> <a href="29705.php">Gilles Gouaillardet: "Re: [OMPI users] ompi_info -c does not print configure arguments"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Jeff,
<br>
<p>currently there is no way to retrieve the configure command line.
<br>
<p>I previously discussed this with Jeff S. and it seems autotools do not
<br>
...
<p>Gilles
<br>
<p>On Sunday, July 24, 2016, Jeff Hammond &lt;jeff.science_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; ompi_info -h indicates that -c shows configuration options, ie configure
</span><br>
<span class="quotelev1">&gt; arguments:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; $ /home/projects/x86-64-knl/openmpi/1.10.2/intel/17.0.042/bin/ompi_info -h
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; --------------------------------------------------------------------------
...
<span class="quotelev1">&gt; -a|--all                 Show all configuration options and MCA parameters
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; So I expect something like what mpichversion gives me, which I find
</span><br>
<span class="quotelev1">&gt; incredibly useful:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Unfortunately, I see nothing that is directly convertible to configure
</span><br>
<span class="quotelev1">&gt; arguments in the following:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; $ /home/projects/x86-64-knl/openmpi/1.10.2/intel/17.0.042/bin/ompi_info -c
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;                           compiler, does not support the following: array
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;                           subsections, direct passthru (where possible) to
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; How do I extract configure arguments from an OpenMPI installation?  I am
</span><br>
<span class="quotelev1">&gt; trying to reproduce a build exactly and I do not have access to config.log
</span><br>
<span class="quotelev1">&gt; from the origin build.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29704/attachment">attachment</a>
</ul>
