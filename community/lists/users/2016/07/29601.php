...
?>
<!-- received="Fri Jul  8 06:32:28 2016" -->
<!-- isoreceived="20160708103228" -->
<!-- sent="Fri, 8 Jul 2016 19:32:14 +0900" -->
<!-- isosent="20160708103214" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Java-OpenMPI returns with SIGSEGV" -->
<!-- id="CAAkFZ5tur17oc2kL7h4seoTdcv9YfwT6F56abH9mX3yMewGWWA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="577F6F45.2060705_at_uni-rostock.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-07-08 06:32:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29602.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Previous message:</strong> <a href="29600.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>In reply to:</strong> <a href="29600.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29602.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Reply:</strong> <a href="29602.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>an other test is to
<br>
ulimit -s 10240
<br>
before invoking mpirun.
<br>
<p>btw, do you use mpirun or srun ?
<br>
<p>can you reproduce the crash with 1 or 2 tasks ?
<br>
<p>Cheers,
<br>
<p>Gilles
...
<span class="quotelev1">&gt; 1 node with 3 cores. I use SLURM to allocate one node. I changed --mem,
</span><br>
<span class="quotelev1">&gt; but it has no effect.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; &lt;javascript:_e(%7B%7D,'cvml','gundram.leifert_at_[hidden]');&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;javascript:_e(%7B%7D,'cvml','gilles_at_[hidden]');&gt;gilles_at_[hidden]
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29601/attachment">attachment</a>
</ul>
