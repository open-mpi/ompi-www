...
?>
<!-- received="Thu Jul  7 04:05:58 2016" -->
<!-- isoreceived="20160707080558" -->
<!-- sent="Thu, 7 Jul 2016 17:05:57 +0900" -->
<!-- isosent="20160707080557" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Java-OpenMPI returns with SIGSEGV" -->
<!-- id="6aa56ea7-a735-ad46-eec3-306bce28a022_at_rist.or.jp" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="577E0209.7090008_at_uni-rostock.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-07-07 04:05:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29594.php">Emani, Murali: "[OMPI users] Class information in OpenMPI"</a>
<li><strong>Previous message:</strong> <a href="29592.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>In reply to:</strong> <a href="29592.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29595.php">Nathaniel Graham: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Reply:</strong> <a href="29595.php">Nathaniel Graham: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Reply:</strong> <a href="29600.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gundram,
<br>
<p><p>can you please provide more information on your environment :
<br>
<p>- configure command line
<br>
<p>- OS
<br>
<p>- memory available
...
<p>- number of nodes
<br>
<p>- number of tasks used
<br>
<p>- interconnect used (if any)
<br>
<p>- batch manager (if any)
<br>
<p><p>Cheers,
<br>
<p><p>Gilles
<br>
<p>On 7/7/2016 4:17 PM, Gundram Leifert wrote:
<br>
...
<span class="quotelev1">&gt; Meanwhile I think Java and MPI use the same memory because when I 
</span><br>
<span class="quotelev1">&gt; delete the hash-call, the program runs sometimes more than 9k iterations.
</span><br>
<span class="quotelev1">&gt; When it crashes, there are different lines (see (2) and (3)). The 
</span><br>
<span class="quotelev1">&gt; crashes also occurs on rank 0.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; de.uros.citlab.executor.test.TestSendBigFiles2.hashcode([BI)I (42 
</span><br>
<span class="quotelev1">&gt; bytes) @ 0x00002b03242dc9c4 [0x00002b03242dc860+0x164]
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; JavaCallWrapper::JavaCallWrapper(methodHandle, Handle, JavaValue*, 
</span><br>
<span class="quotelev1">&gt; Thread*)+0xb6
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; ideally, the garbage collector can take care of that and this should 
</span><br>
<span class="quotelev2">&gt;&gt; not be an issue.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     thank you for your hints! I did 3 changes, unfortunately the
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     same error occures:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     Now I get this error message - to 100%, after different number
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     of iterations (15-300):
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     # JRE version: Java(TM) SE Runtime Environment (8.0_92-b14)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     (build 1.8.0_92-b14)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     # Java VM: Java HotSpot(TM) 64-Bit Server VM (25.92-b14 mixed
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     mode linux-amd64 compressed oops)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     # Problematic frame:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     # V  [libjvm.so+0x414d24]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     ciEnv::get_field_by_index(ciInstanceKlass*, int)+0x94
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     #
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     # Failed to write core dump. Core dumps have been disabled. To
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     enable core dumping, try &quot;ulimit -c unlimited&quot; before starting
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     Java again
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     #
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     mpirun noticed that process rank 2 with PID 0 on node titan01
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     exited on signal 6 (Aborted).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     --------------------------------------------------------------------------
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     I don't know if it is a  problem of java or ompi - but the last
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     years, java worked with no problems on my machine...
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;     Note a race condition in MPI_Init has been fixed yesterday in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     the master.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;     Can you reproduce the crash with a simpler (and ideally
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     deterministic) version of your program.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     the crash occurs in hashcode, and this makes little sense to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     me. can you also update your jdk ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         thanks for your response! I thing it is another problem. I
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         try to send 100MB bytes. So there are not many tries
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         (between 10 and 30). I realized that the execution of this
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         code can result 3 different errors:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         2. in &lt;10% the cases i have a live lock. I can see 3
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         java-processes, one with 200% and two with 100% processor
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         utilization. After ~15 minutes without new system outputs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         this error occurs.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         # A fatal error has been detected by the Java Runtime
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         Environment:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         #
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         #  Internal Error (safepoint.cpp:317), pid=24256,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         tid=47500347131648
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         # Java VM: Java HotSpot(TM) 64-Bit Server VM (23.25-b01
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         mixed mode linux-amd64 compressed oops)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         # Failed to write core dump. Core dumps have been disabled.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         To enable core dumping, try &quot;ulimit -c unlimited&quot; before
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         starting Java again
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         #
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         mpirun noticed that process rank 0 with PID 0 on node
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         titan01 exited on signal 6 (Aborted).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         --------------------------------------------------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         3. in &lt;10% the cases i have a dead lock while MPI.init.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         This stays for more than 15 minutes without returning with
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         an error message...
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         Can I enable some debug-flags to see what happens on C /
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         OpenMPI side?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         After reading your thread looks like it may be related to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         an issue I had a few weeks ago (I'm a novice though).
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         When you say &quot;After a specific number of repetitions the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         process either hangs up or returns with a SIGSEGV.&quot;  does
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         you mean that a single call hangs, or that at some point
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         during the for loop a call hangs? If you mean the latter,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         then it might relate to my issue. Otherwise my thread
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             I try to send many byte-arrays via broadcast. After a
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             specific number of repetitions the process either
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             hangs up or returns with a SIGSEGV. Does any one can
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             help me solving the problem:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;                 public static void main(String args[]) throws
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             MPIException {
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             MPI.COMM_WORLD.bcast(saveMem, lengthData[0], MPI.BYTE, 0);
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             # Java VM: Java HotSpot(TM) 64-Bit Server VM
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             (23.25-b01 mixed mode linux-amd64 compressed oops)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             # Problematic frame:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             # #
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;             mpirun noticed that process rank 1 with PID 0 on node
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29593/attachment">attachment</a>
</ul>
