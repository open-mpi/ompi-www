...
?>
<!-- received="Fri Jul  8 10:19:56 2016" -->
<!-- isoreceived="20160708141956" -->
<!-- sent="Fri, 8 Jul 2016 08:19:51 -0600" -->
<!-- isosent="20160708141951" -->
<!-- name="Howard Pritchard" -->
<!-- email="hppritcha_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Java-OpenMPI returns with SIGSEGV" -->
<!-- id="CAF1Cqj7fWSnPuBEwyL-OZcduYAijziwvC-zymC837ZatgUE6hQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAAkFZ5shh2Tq=mPdFrm5EQHpZcY++Uthco7HwMLjmzUSrbm2ow_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-07-08 10:19:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29611.php">George Bosilca: "Re: [OMPI users] mpi_reduce implementation"</a>
<li><strong>Previous message:</strong> <a href="29609.php">Juan Francisco Mart&#237;nez: "Re: [OMPI users] mpi_reduce implementation"</a>
<li><strong>In reply to:</strong> <a href="29605.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29647.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Reply:</strong> <a href="29647.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Gundram
<br>
<p>Could you configure without the disable dlopen option and retry?
<br>
<p>Howard
<br>
<p>Am Freitag, 8. Juli 2016 schrieb Gilles Gouaillardet :
<br>
<p><span class="quotelev1">&gt; the JVM sets its own signal handlers, and it is important openmpi dones
</span><br>
<span class="quotelev1">&gt; not override them.
</span><br>
<span class="quotelev1">&gt; this is what previously happened with PSM (infinipath) but this has been
</span><br>
<span class="quotelev1">&gt; solved since.
</span><br>
<span class="quotelev1">&gt; you might be linking with a third party library that hijacks signal
</span><br>
<span class="quotelev1">&gt; handlers and cause the crash
</span><br>
<span class="quotelev1">&gt; (which would explain why I cannot reproduce the issue)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; the master branch has a revamped memory patcher (compared to v2.x or
</span><br>
<span class="quotelev1">&gt; v1.10), and that could have some bad interactions with the JVM, so you
</span><br>
<span class="quotelev1">&gt; might also give v2.x a try
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Friday, July 8, 2016, Gundram Leifert &lt;gundram.leifert_at_[hidden]
</span><br>
<span class="quotelev1">&gt; &lt;javascript:_e(%7B%7D,'cvml','gundram.leifert_at_[hidden]');&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; You made the best of it... thanks a lot!
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Whithout MPI it runs.
</span><br>
<span class="quotelev2">&gt;&gt; Just adding MPI.init() causes the crash!
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; maybe I installed something wrong...
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; install newest automake, autoconf, m4, libtoolize in right order and same
</span><br>
<span class="quotelev2">&gt;&gt; prefix
</span><br>
<span class="quotelev2">&gt;&gt; check out ompi,
</span><br>
<span class="quotelev2">&gt;&gt; autogen
</span><br>
<span class="quotelev2">&gt;&gt; configure with same prefix, pointing to the same jdk, I later use
</span><br>
...
<span class="quotelev2">&gt;&gt; I will test some different configurations of ./configure...
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On 07/08/2016 01:40 PM, Gilles Gouaillardet wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; or what if you configure without --disable-dlopen --disable-mca-dso ?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; then MPI_Bcast and MPI_Barrier are basically no-op, so it is really weird
</span><br>
<span class="quotelev2">&gt;&gt; your program is still crashing. an other test is to comment out MPI_Bcast
</span><br>
<span class="quotelev2">&gt;&gt; and MPI_Barrier and try again with -np 1
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; In any cases the same error.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; mpirun -np 3 java -cp executor.jar
</span><br>
<span class="quotelev3">&gt;&gt;&gt; de.uros.citlab.executor.test.TestSendBigFiles2
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; also for 1 or two cores, the process crashes.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On 07/08/2016 12:32 PM, Gilles Gouaillardet wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Friday, July 8, 2016, Gundram Leifert &lt;gundram.leifert_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 1 node with 3 cores. I use SLURM to allocate one node. I changed --mem,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; but it has no effect.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; salloc -n 3
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Linux titan01.service 3.10.0-327.13.1.el7.x86_64 #1 SMP Thu Mar 31
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 16:04:38 UTC 2016 x86_64 x86_64 x86_64 GNU/Linux
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; cat /etc/system-release
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; CentOS Linux release 7.2.1511 (Core)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; what else do you need?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Cheers, Gundram
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On 07/07/2016 10:05 AM, Gilles Gouaillardet wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; can you please provide more information on your environment :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I tried you code and it crashes after 3-15 iterations (see (1)). It is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; always the same error (only the &quot;94&quot; varies).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Meanwhile I think Java and MPI use the same memory because when I
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; delete the hash-call, the program runs sometimes more than 9k iterations.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; When it crashes, there are different lines (see (2) and (3)). The
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; crashes also occurs on rank 0.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; # J 94 C2 de.uros.citlab.executor.test.TestSendBigFiles2.hashcode([BI)I
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; JavaCallWrapper::JavaCallWrapper(methodHandle, Handle, JavaValue*,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Thread*)+0xb6
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; ideally, the garbage collector can take care of that and this should
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; not be an issue.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; # V  [libjvm.so+0x414d24]  ciEnv::get_field_by_index(ciInstanceKlass*,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; int)+0x94
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [titan01:16578] [ 1] /usr/lib64/libc.so.6(gsignal+0x37)[0x2b3d01b5c5f7]
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mpirun noticed that process rank 2 with PID 0 on node titan01 exited
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I don't know if it is a  problem of java or ompi - but the last years,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; java worked with no problems on my machine...
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Note a race condition in MPI_Init has been fixed yesterday in the
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; thanks for your response! I thing it is another problem. I try to
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; send 100MB bytes. So there are not many tries (between 10 and 30). I
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; realized that the execution of this code can result 3 different errors:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 2. in &lt;10% the cases i have a live lock. I can see 3 java-processes,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; one with 200% and two with 100% processor utilization. After ~15 minutes
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; without new system outputs this error occurs.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #  Internal Error (safepoint.cpp:317), pid=24256, tid=47500347131648
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [titan01:24256] [ 2] /usr/lib64/libc.so.6(abort+0x148)[0x2b336a982ce8]
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [titan01:24256] [11] /usr/lib64/libc.so.6(clone+0x6d)[0x2b336aa4228d]
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; mpirun noticed that process rank 0 with PID 0 on node titan01 exited
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 3. in &lt;10% the cases i have a dead lock while MPI.init. This stays
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; for more than 15 minutes without returning with an error message...
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Can I enable some debug-flags to see what happens on C / OpenMPI side?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; After reading your thread looks like it may be related to an issue I
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; had a few weeks ago (I'm a novice though). Maybe my thread will be of help:
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; either hangs up or returns with a SIGSEGV.&quot;  does you mean that a single
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; call hangs, or that at some point during the for loop a call hangs? If you
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; mean the latter, then it might relate to my issue. Otherwise my thread
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I try to send many byte-arrays via broadcast. After a specific
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; number of repetitions the process either hangs up or returns with a
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; SIGSEGV. Does any one can help me solving the problem:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;                     int[] lengthData = new int[]{saveMem.length};
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;                     log(&quot;object hash = &quot; + hashcode(saveMem));
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;                     log(&quot;length = &quot; + lengthData[0]);
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;                     MPI.COMM_WORLD.bcast(lengthData, 1, MPI.INT, 0);
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;                 MPI.COMM_WORLD.bcast(new int[]{0}, 1, MPI.INT, 0);
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; J  de.uros.citlab.executor.test.TestSendBigFiles.hashcode([B)I
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; #
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; # Failed to write core dump. Core dumps have been disabled. To
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; enable core dumping, try &quot;ulimit -c unlimited&quot; before starting Java again
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; #
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; # Java VM: Java HotSpot(TM) 64-Bit Server VM (23.25-b01 mixed mode
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [titan01:01173] [ 1] /usr/lib64/libc.so.6(+0x35670)[0x2b7e95fc7670]
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [titan01:01173] [ 6] /usr/lib64/libc.so.6(+0x35670)[0x2af69544a670]
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun noticed that process rank 1 with PID 0 on node titan01 exited
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; --with-jdk-dir=/home/gl069/bin/jdk1.7.0_25 --disable-dlopen
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29610/attachment">attachment</a>
</ul>
