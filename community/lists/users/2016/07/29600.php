...
?>
<!-- received="Fri Jul  8 05:25:14 2016" -->
<!-- isoreceived="20160708092514" -->
<!-- sent="Fri, 8 Jul 2016 11:15:49 +0200" -->
<!-- isosent="20160708091549" -->
<!-- name="Gundram Leifert" -->
<!-- email="gundram.leifert_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Java-OpenMPI returns with SIGSEGV" -->
<!-- id="577F6F45.2060705_at_uni-rostock.de" -->
...
<strong>Date:</strong> 2016-07-08 05:15:49
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29601.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Previous message:</strong> <a href="29599.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun has exited due to process rank N"</a>
<li><strong>In reply to:</strong> <a href="29593.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29601.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Reply:</strong> <a href="29601.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>1 node with 3 cores. I use SLURM to allocate one node. I changed --mem, 
<br>
but it has no effect.
<br>
salloc -n 3
<br>
<p><p>core file size          (blocks, -c) 0
<br>
...
<br>
<p>what else do you need?
<br>
<p>Cheers, Gundram
<br>
<p>On 07/07/2016 10:05 AM, Gilles Gouaillardet wrote:
<br>
...
<span class="quotelev2">&gt;&gt; I tried you code and it crashes after 3-15 iterations (see (1)). It 
</span><br>
<span class="quotelev2">&gt;&gt; is always the same error (only the &quot;94&quot; varies).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Meanwhile I think Java and MPI use the same memory because when I 
</span><br>
<span class="quotelev2">&gt;&gt; delete the hash-call, the program runs sometimes more than 9k iterations.
</span><br>
<span class="quotelev2">&gt;&gt; When it crashes, there are different lines (see (2) and (3)). The 
</span><br>
<span class="quotelev2">&gt;&gt; crashes also occurs on rank 0.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; # J 94 C2 
</span><br>
<span class="quotelev2">&gt;&gt; de.uros.citlab.executor.test.TestSendBigFiles2.hashcode([BI)I (42 
</span><br>
<span class="quotelev2">&gt;&gt; bytes) @ 0x00002b03242dc9c4 [0x00002b03242dc860+0x164]
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; # V  [libjvm.so+0x68d0f6] 
</span><br>
<span class="quotelev2">&gt;&gt; JavaCallWrapper::JavaCallWrapper(methodHandle, Handle, JavaValue*, 
</span><br>
<span class="quotelev2">&gt;&gt; Thread*)+0xb6
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; # V  [libjvm.so+0x4183bf] 
</span><br>
<span class="quotelev2">&gt;&gt; ThreadInVMfromNative::ThreadInVMfromNative(JavaThread*)+0x4f
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Any more idea?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On 07/07/2016 03:00 AM, Gilles Gouaillardet wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; fwiw, i cannot reproduce the issue on my box
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; - centos 7
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; - java version &quot;1.8.0_71&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   Java(TM) SE Runtime Environment (build 1.8.0_71-b15)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   Java HotSpot(TM) 64-Bit Server VM (build 25.71-b15, mixed mode)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; i noticed on non zero rank saveMem is allocated at each iteration.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ideally, the garbage collector can take care of that and this should 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; not be an issue.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; would you mind giving the attached file a try ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 7/7/2016 7:41 AM, Gilles Gouaillardet wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I will have a look at it today
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; how did you configure OpenMPI ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Thursday, July 7, 2016, Gundram Leifert 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;gundram.leifert_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     Hello Giles,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     thank you for your hints! I did 3 changes, unfortunately the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     same error occures:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     update ompi:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     commit ae8444682f0a7aa158caea08800542ce9874455e
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     Author: Ralph Castain &lt;rhc_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     &lt;javascript:_e(%7B%7D,'cvml','rhc_at_[hidden]');&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     Date:   Tue Jul 5 20:07:16 2016 -0700
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     update java:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     java version &quot;1.8.0_92&quot;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     Java(TM) SE Runtime Environment (build 1.8.0_92-b14)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     Java HotSpot(TM) Server VM (build 25.92-b14, mixed mode)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     delete hashcode-lines.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     Now I get this error message - to 100%, after different number
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     of iterations (15-300):
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      0/ 3:length = 100000000
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      0/ 3:bcast length done (length = 100000000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      1/ 3:bcast length done (length = 100000000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;      2/ 3:bcast length done (length = 100000000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     #
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;     #  SIGSEGV (0xb) at pc=0x00002b3d022fcd24, pid=16578,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     tid=0x00002b3d29716700
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     #
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     # JRE version: Java(TM) SE Runtime Environment (8.0_92-b14)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     (build 1.8.0_92-b14)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     # Java VM: Java HotSpot(TM) 64-Bit Server VM (25.92-b14 mixed
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     mode linux-amd64 compressed oops)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     # Problematic frame:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     # V  [libjvm.so+0x414d24]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     ciEnv::get_field_by_index(ciInstanceKlass*, int)+0x94
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     #
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     # Failed to write core dump. Core dumps have been disabled. To
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     enable core dumping, try &quot;ulimit -c unlimited&quot; before starting
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;     # /home/gl069/ompi/bin/executor/hs_err_pid16578.log
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     #
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     # Compiler replay data is saved as:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     # /home/gl069/ompi/bin/executor/replay_pid16578.log
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     #
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     # If you would like to submit a bug report, please visit:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     # <a href="http://bugreport.java.com/bugreport/crash.jsp">http://bugreport.java.com/bugreport/crash.jsp</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     #
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] *** Process received signal ***
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] Signal: Aborted (6)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] Signal code:  (-6)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /usr/lib64/libpthread.so.0(+0xf100)[0x2b3d01500100]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 1]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /usr/lib64/libc.so.6(gsignal+0x37)[0x2b3d01b5c5f7]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 2]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /usr/lib64/libc.so.6(abort+0x148)[0x2b3d01b5dce8]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 3]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x91e605)[0x2b3d02806605]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 4]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0xabda63)[0x2b3d029a5a63]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 5]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(JVM_handle_linux_signal+0x14f)[0x2b3d0280be2f]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 6]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x91a5c3)[0x2b3d028025c3]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 7] /usr/lib64/libc.so.6(+0x35670)[0x2b3d01b5c670]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 8]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x414d24)[0x2b3d022fcd24]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [ 9]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x43c5ae)[0x2b3d023245ae]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [10]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x369ade)[0x2b3d02251ade]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [11]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x36eda0)[0x2b3d02256da0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [12]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x37091b)[0x2b3d0225891b]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [13]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x3712b6)[0x2b3d022592b6]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [14]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x36d2cf)[0x2b3d022552cf]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [15]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x36e412)[0x2b3d02256412]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [16]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x36ed8d)[0x2b3d02256d8d]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [17]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x37091b)[0x2b3d0225891b]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [18]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x3712b6)[0x2b3d022592b6]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [19]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x36d2cf)[0x2b3d022552cf]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [20]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x36e412)[0x2b3d02256412]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [21]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x36ed8d)[0x2b3d02256d8d]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [22]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x3708c2)[0x2b3d022588c2]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [23]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x3724e7)[0x2b3d0225a4e7]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [24]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x37a817)[0x2b3d02262817]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [25]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x37a92f)[0x2b3d0226292f]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [26]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x358edb)[0x2b3d02240edb]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [27]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x35929e)[0x2b3d0224129e]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [28]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x3593ce)[0x2b3d022413ce]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] [29]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /home/gl069/bin/jdk1.8.0_92/jre/lib/amd64/server/libjvm.so(+0x35973e)[0x2b3d0224173e]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     [titan01:16578] *** End of error message ***
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     -------------------------------------------------------
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;     mpirun noticed that process rank 2 with PID 0 on node titan01
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     exited on signal 6 (Aborted).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     --------------------------------------------------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     I don't know if it is a  problem of java or ompi - but the last
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     years, java worked with no problems on my machine...
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     Thank you for your tips in advance!
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     Gundram
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     On 07/06/2016 03:10 PM, Gilles Gouaillardet wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;     Note a race condition in MPI_Init has been fixed yesterday in
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;     Can you reproduce the crash with a simpler (and ideally
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;     deterministic) version of your program.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;     the crash occurs in hashcode, and this makes little sense to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;     me. can you also update your jdk ?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;     Cheers,
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         thanks for your response! I thing it is another problem. I
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         try to send 100MB bytes. So there are not many tries
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         (between 10 and 30). I realized that the execution of this
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         code can result 3 different errors:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         utilization. After ~15 minutes without new system outputs
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         this error occurs.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         #  Internal Error (safepoint.cpp:317), pid=24256,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         tid=47500347131648
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         # Java VM: Java HotSpot(TM) 64-Bit Server VM (23.25-b01
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         [titan01:24256] [ 2]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         /usr/lib64/libc.so.6(abort+0x148)[0x2b336a982ce8]
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         [titan01:24256] [11]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         /usr/lib64/libc.so.6(clone+0x6d)[0x2b336aa4228d]
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         mpirun noticed that process rank 0 with PID 0 on node
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         3. in &lt;10% the cases i have a dead lock while MPI.init.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         This stays for more than 15 minutes without returning with
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         an error message...
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         Can I enable some debug-flags to see what happens on C /
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         OpenMPI side?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         After reading your thread looks like it may be related to
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         an issue I had a few weeks ago (I'm a novice though).
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         Maybe my thread will be of help:
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         When you say &quot;After a specific number of repetitions the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         process either hangs up or returns with a SIGSEGV.&quot;  does
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         you mean that a single call hangs, or that at some point
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         during the for loop a call hangs? If you mean the latter,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         then it might relate to my issue. Otherwise my thread
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         probably won't be helpful.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             specific number of repetitions the process either
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             hangs up or returns with a SIGSEGV. Does any one can
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             help me solving the problem:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             MPI.COMM_WORLD.getRank(), MPI.COMM_WORLD.getSize(),
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                 public static void main(String args[]) throws
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             MPIException {
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                                 int[] lengthData = new
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             int[]{saveMem.length};
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                                 log(&quot;object hash = &quot; +
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             hashcode(saveMem));
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                                 log(&quot;length = &quot; + lengthData[0]);
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             MPI.COMM_WORLD.bcast(lengthData, 1, MPI.INT
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             de.uros.citlab.executor.test.TestSendBigFiles.hashcode([B)I
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             #
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             mpirun noticed that process rank 1 with PID 0 on node
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;             --with-jdk-dir=/home/gl069/bin/jdk1.7.0_25
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post:<a href="http://www.open-mpi.org/community/lists/users/2016/07/29589.php">http://www.open-mpi.org/community/lists/users/2016/07/29589.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post:<a href="http://www.open-mpi.org/community/lists/users/2016/07/29590.php">http://www.open-mpi.org/community/lists/users/2016/07/29590.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; Link to this post:<a href="http://www.open-mpi.org/community/lists/users/2016/07/29592.php">http://www.open-mpi.org/community/lists/users/2016/07/29592.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/07/29593.php">http://www.open-mpi.org/community/lists/users/2016/07/29593.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29600/attachment">attachment</a>
</ul>
