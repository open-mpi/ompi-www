...
?>
<!-- received="Fri Jul  8 07:40:56 2016" -->
<!-- isoreceived="20160708114056" -->
<!-- sent="Fri, 8 Jul 2016 20:40:52 +0900" -->
<!-- isosent="20160708114052" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Java-OpenMPI returns with SIGSEGV" -->
<!-- id="CAAkFZ5veKU5WVUYAwtnEp2PdTuJxH0jK2dpPa+K5y52JpEWbnQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="577F8695.9000000_at_uni-rostock.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-07-08 07:40:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29604.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Previous message:</strong> <a href="29602.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>In reply to:</strong> <a href="29602.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29604.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Reply:</strong> <a href="29604.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>what if you do not run within slurm ?
<br>
...
wrote:
<br>
<p><span class="quotelev1">&gt; In any cases the same error.
</span><br>
...
<span class="quotelev2">&gt;&gt; 1 node with 3 cores. I use SLURM to allocate one node. I changed --mem,
</span><br>
<span class="quotelev2">&gt;&gt; but it has no effect.
</span><br>
...
<span class="quotelev2">&gt;&gt; Linux titan01.service 3.10.0-327.13.1.el7.x86_64 #1 SMP Thu Mar 31
</span><br>
<span class="quotelev2">&gt;&gt; 16:04:38 UTC 2016 x86_64 x86_64 x86_64 GNU/Linux
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; I tried you code and it crashes after 3-15 iterations (see (1)). It is
</span><br>
<span class="quotelev2">&gt;&gt; always the same error (only the &quot;94&quot; varies).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Meanwhile I think Java and MPI use the same memory because when I delete
</span><br>
<span class="quotelev2">&gt;&gt; the hash-call, the program runs sometimes more than 9k iterations.
</span><br>
<span class="quotelev2">&gt;&gt; When it crashes, there are different lines (see (2) and (3)). The crashes
</span><br>
<span class="quotelev2">&gt;&gt; also occurs on rank 0.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; # J 94 C2 de.uros.citlab.executor.test.TestSendBigFiles2.hashcode([BI)I
</span><br>
<span class="quotelev2">&gt;&gt; (42 bytes) @ 0x00002b03242dc9c4 [0x00002b03242dc860+0x164]
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; # V  [libjvm.so+0x68d0f6]  JavaCallWrapper::JavaCallWrapper(methodHandle,
</span><br>
<span class="quotelev2">&gt;&gt; Handle, JavaValue*, Thread*)+0xb6
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;   Java(TM) SE Runtime Environment (build 1.8.0_71-b15)
</span><br>
<span class="quotelev2">&gt;&gt;   Java HotSpot(TM) 64-Bit Server VM (build 25.71-b15, mixed mode)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; i noticed on non zero rank saveMem is allocated at each iteration.
</span><br>
<span class="quotelev2">&gt;&gt; ideally, the garbage collector can take care of that and this should not
</span><br>
<span class="quotelev2">&gt;&gt; be an issue.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; thank you for your hints! I did 3 changes, unfortunately the same error
</span><br>
<span class="quotelev3">&gt;&gt;&gt; occures:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Java(TM) SE Runtime Environment (build 1.8.0_92-b14)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Java HotSpot(TM) Server VM (build 25.92-b14, mixed mode)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Now I get this error message - to 100%, after different number of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; iterations (15-300):
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #  SIGSEGV (0xb) at pc=0x00002b3d022fcd24, pid=16578,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; tid=0x00002b3d29716700
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #
</span><br>
<span class="quotelev3">&gt;&gt;&gt; # JRE version: Java(TM) SE Runtime Environment (8.0_92-b14) (build
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 1.8.0_92-b14)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; # Java VM: Java HotSpot(TM) 64-Bit Server VM (25.92-b14 mixed mode
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linux-amd64 compressed oops)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; # Problematic frame:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; # V  [libjvm.so+0x414d24]  ciEnv::get_field_by_index(ciInstanceKlass*,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [titan01:16578] [ 0] /usr/lib64/libpthread.so.0(+0xf100)[0x2b3d01500100]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [titan01:16578] [ 1] /usr/lib64/libc.so.6(gsignal+0x37)[0x2b3d01b5c5f7]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [titan01:16578] [ 2] /usr/lib64/libc.so.6(abort+0x148)[0x2b3d01b5dce8]
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [titan01:16578] [ 7] /usr/lib64/libc.so.6(+0x35670)[0x2b3d01b5c670]
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; mpirun noticed that process rank 2 with PID 0 on node titan01 exited on
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I don't know if it is a  problem of java or ompi - but the last years,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; java worked with no problems on my machine...
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 07/06/2016 03:10 PM, Gilles Gouaillardet wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Note a race condition in MPI_Init has been fixed yesterday in the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Can you reproduce the crash with a simpler (and ideally deterministic)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; version of your program.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the crash occurs in hashcode, and this makes little sense to me. can you
</span><br>
<span class="quotelev3">&gt;&gt;&gt; also update your jdk ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; thanks for your response! I thing it is another problem. I try to send
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 100MB bytes. So there are not many tries (between 10 and 30). I realized
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; that the execution of this code can result 3 different errors:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 1. most often the posted error message occures.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 2. in &lt;10% the cases i have a live lock. I can see 3 java-processes,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one with 200% and two with 100% processor utilization. After ~15 minutes
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; without new system outputs this error occurs.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #  Internal Error (safepoint.cpp:317), pid=24256, tid=47500347131648
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #  guarantee(PageArmed == 0) failed: invariant
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:24256] *** Process received signal ***
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:24256] Signal: Aborted (6)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:24256] Signal code:  (-6)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:24256] [ 0] /usr/lib64/libpthread.so.0(+0xf100)[0x2b336a324100]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:24256] [ 1] /usr/lib64/libc.so.6(gsignal+0x37)[0x2b336a9815f7]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:24256] [ 2] /usr/lib64/libc.so.6(abort+0x148)[0x2b336a982ce8]
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:24256] [10] /usr/lib64/libpthread.so.0(+0x7dc5)[0x2b336a31cdc5]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:24256] [11] /usr/lib64/libc.so.6(clone+0x6d)[0x2b336aa4228d]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:24256] *** End of error message ***
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -------------------------------------------------------
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun noticed that process rank 0 with PID 0 on node titan01 exited on
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 3. in &lt;10% the cases i have a dead lock while MPI.init. This stays for
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; more than 15 minutes without returning with an error message...
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Can I enable some debug-flags to see what happens on C / OpenMPI side?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 07/05/2016 06:05 PM, Jason Maldonis wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; After reading your thread looks like it may be related to an issue I
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; had a few weeks ago (I'm a novice though). Maybe my thread will be of help:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; When you say &quot;After a specific number of repetitions the process
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; either hangs up or returns with a SIGSEGV.&quot;  does you mean that a single
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; call hangs, or that at some point during the for loop a call hangs? If you
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mean the latter, then it might relate to my issue. Otherwise my thread
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; probably won't be helpful.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; maldonis_at_[hidden] &lt;javascript:_e(%7B%7D,'cvml','maldonis_at_[hidden]');&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I try to send many byte-arrays via broadcast. After a specific number
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; of repetitions the process either hangs up or returns with a SIGSEGV. Does
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; any one can help me solving the problem:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mpirun noticed that process rank 1 with PID 0 on node titan01 exited
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29603/attachment">attachment</a>
</ul>
