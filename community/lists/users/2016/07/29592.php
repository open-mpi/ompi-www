...
?>
<!-- received="Thu Jul  7 03:26:21 2016" -->
<!-- isoreceived="20160707072621" -->
<!-- sent="Thu, 7 Jul 2016 09:17:29 +0200" -->
<!-- isosent="20160707071729" -->
<!-- name="Gundram Leifert" -->
<!-- email="gundram.leifert_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Java-OpenMPI returns with SIGSEGV" -->
<!-- id="577E0209.7090008_at_uni-rostock.de" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="9effc2ea-ec56-cd1a-7efe-e106aa71bdc5_at_rist.or.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-07-07 03:17:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29593.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Previous message:</strong> <a href="29591.php">Saliya Ekanayake: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>In reply to:</strong> <a href="29590.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29593.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Reply:</strong> <a href="29593.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello Gilles,
<br>
<p>I tried you code and it crashes after 3-15 iterations (see (1)). It is 
<br>
always the same error (only the &quot;94&quot; varies).
<br>
<p>Meanwhile I think Java and MPI use the same memory because when I delete 
<br>
...
<p>Any more idea?
<br>
<p>On 07/07/2016 03:00 AM, Gilles Gouaillardet wrote:
<br>
...
<span class="quotelev1">&gt; ideally, the garbage collector can take care of that and this should 
</span><br>
<span class="quotelev1">&gt; not be an issue.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     thank you for your hints! I did 3 changes, unfortunately the same
</span><br>
<span class="quotelev2">&gt;&gt;     error occures:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     # JRE version: Java(TM) SE Runtime Environment (8.0_92-b14)
</span><br>
<span class="quotelev2">&gt;&gt;     (build 1.8.0_92-b14)
</span><br>
<span class="quotelev2">&gt;&gt;     # Java VM: Java HotSpot(TM) 64-Bit Server VM (25.92-b14 mixed
</span><br>
...
<span class="quotelev2">&gt;&gt;     # Failed to write core dump. Core dumps have been disabled. To
</span><br>
<span class="quotelev2">&gt;&gt;     enable core dumping, try &quot;ulimit -c unlimited&quot; before starting
</span><br>
<span class="quotelev2">&gt;&gt;     Java again
</span><br>
<span class="quotelev2">&gt;&gt;     #
</span><br>
...
<span class="quotelev2">&gt;&gt;     mpirun noticed that process rank 2 with PID 0 on node titan01
</span><br>
...
<span class="quotelev2">&gt;&gt;     I don't know if it is a  problem of java or ompi - but the last
</span><br>
<span class="quotelev2">&gt;&gt;     years, java worked with no problems on my machine...
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     Note a race condition in MPI_Init has been fixed yesterday in
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     the master.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     Can you reproduce the crash with a simpler (and ideally
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     deterministic) version of your program.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     the crash occurs in hashcode, and this makes little sense to me.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     can you also update your jdk ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;         thanks for your response! I thing it is another problem. I
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         try to send 100MB bytes. So there are not many tries
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         (between 10 and 30). I realized that the execution of this
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         code can result 3 different errors:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;         2. in &lt;10% the cases i have a live lock. I can see 3
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         java-processes, one with 200% and two with 100% processor
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         utilization. After ~15 minutes without new system outputs
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         this error occurs.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt;         #  Internal Error (safepoint.cpp:317), pid=24256,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         tid=47500347131648
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;         # Failed to write core dump. Core dumps have been disabled.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         To enable core dumping, try &quot;ulimit -c unlimited&quot; before
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         starting Java again
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         #
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;         mpirun noticed that process rank 0 with PID 0 on node
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;         3. in &lt;10% the cases i have a dead lock while MPI.init. This
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         stays for more than 15 minutes without returning with an
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         error message...
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         Can I enable some debug-flags to see what happens on C /
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         OpenMPI side?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         After reading your thread looks like it may be related to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         an issue I had a few weeks ago (I'm a novice though). Maybe
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         my thread will be of help:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         When you say &quot;After a specific number of repetitions the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         process either hangs up or returns with a SIGSEGV.&quot;  does
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         you mean that a single call hangs, or that at some point
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         during the for loop a call hangs? If you mean the latter,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         then it might relate to my issue. Otherwise my thread
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;             I try to send many byte-arrays via broadcast. After a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             specific number of repetitions the process either hangs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             up or returns with a SIGSEGV. Does any one can help me
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             solving the problem:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;                 public static void main(String args[]) throws
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             MPIException {
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;                                 int[] lengthData = new
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             int[]{saveMem.length};
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;                                 log(&quot;object hash = &quot; +
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             hashcode(saveMem));
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;             MPI.COMM_WORLD.bcast(saveMem, lengthData[0], MPI.BYTE, 0);
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;             MPI.COMM_WORLD.bcast(saveMem, saveMem.length, MPI.BYTE, 0);
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;                                 log(&quot;bcast data done&quot;);
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             MPI.COMM_WORLD.barrier();
...
<span class="quotelev4">&gt;&gt;&gt;&gt;             #  SIGSEGV (0xb) at pc=0x00002b7e9c86e3a1, pid=1172,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             tid=47822674495232
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             #
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             #
...
<span class="quotelev4">&gt;&gt;&gt;&gt;             #  SIGSEGV (0xb) at pc=0x00002af69c0693a1, pid=1173,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             tid=47238546896640
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             #
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             # JRE version: 7.0_25-b15
...
<span class="quotelev4">&gt;&gt;&gt;&gt;             # Failed to write core dump. Core dumps have been
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             disabled. To enable core dumping, try &quot;ulimit -c
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             unlimited&quot; before starting Java again
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             #
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;             # Java VM: Java HotSpot(TM) 64-Bit Server VM (23.25-b01
...
<span class="quotelev4">&gt;&gt;&gt;&gt;             mpirun noticed that process rank 1 with PID 0 on node
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;             Author: Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29592/attachment">attachment</a>
</ul>
