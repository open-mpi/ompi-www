...
?>
<!-- received="Fri Jul  8 08:36:47 2016" -->
<!-- isoreceived="20160708123647" -->
<!-- sent="Fri, 8 Jul 2016 21:36:43 +0900" -->
<!-- isosent="20160708123643" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Java-OpenMPI returns with SIGSEGV" -->
<!-- id="CAAkFZ5shh2Tq=mPdFrm5EQHpZcY++Uthco7HwMLjmzUSrbm2ow_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="577F9947.2000805_at_uni-rostock.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-07-08 08:36:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29606.php">Juan Francisco Martínez: "[OMPI users] mpi_reduce implementation"</a>
<li><strong>Previous message:</strong> <a href="29604.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>In reply to:</strong> <a href="29604.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29610.php">Howard Pritchard: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Reply:</strong> <a href="29610.php">Howard Pritchard: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>the master branch has a revamped memory patcher (compared to v2.x or
<br>
...
<p>Gilles
<br>
<p>On Friday, July 8, 2016, Gundram Leifert &lt;gundram.leifert_at_[hidden]&gt;
<br>
wrote:
<br>
<p><span class="quotelev1">&gt; You made the best of it... thanks a lot!
</span><br>
...
<span class="quotelev1">&gt; install newest automake, autoconf, m4, libtoolize in right order and same
</span><br>
...
<span class="quotelev1">&gt; then MPI_Bcast and MPI_Barrier are basically no-op, so it is really weird
</span><br>
<span class="quotelev1">&gt; your program is still crashing. an other test is to comment out MPI_Bcast
</span><br>
<span class="quotelev1">&gt; and MPI_Barrier and try again with -np 1
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On Friday, July 8, 2016, Gundram Leifert &lt;gundram.leifert_at_[hidden]
</span><br>
<span class="quotelev2">&gt;&gt; &lt;javascript:_e(%7B%7D,'cvml','gundram.leifert_at_[hidden]');&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ./configure --enable-mpi-java --with-jdk-dir=/home/gl069/bin/jdk1.7.0_25
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 1 node with 3 cores. I use SLURM to allocate one node. I changed --mem,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; but it has no effect.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Linux titan01.service 3.10.0-327.13.1.el7.x86_64 #1 SMP Thu Mar 31
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 16:04:38 UTC 2016 x86_64 x86_64 x86_64 GNU/Linux
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I tried you code and it crashes after 3-15 iterations (see (1)). It is
</span><br>
<span class="quotelev3">&gt;&gt;&gt; always the same error (only the &quot;94&quot; varies).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Meanwhile I think Java and MPI use the same memory because when I delete
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the hash-call, the program runs sometimes more than 9k iterations.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; When it crashes, there are different lines (see (2) and (3)). The
</span><br>
<span class="quotelev3">&gt;&gt;&gt; crashes also occurs on rank 0.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; # J 94 C2 de.uros.citlab.executor.test.TestSendBigFiles2.hashcode([BI)I
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; JavaCallWrapper::JavaCallWrapper(methodHandle, Handle, JavaValue*,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Thread*)+0xb6
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ideally, the garbage collector can take care of that and this should not
</span><br>
<span class="quotelev3">&gt;&gt;&gt; be an issue.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; thank you for your hints! I did 3 changes, unfortunately the same error
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Now I get this error message - to 100%, after different number of
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; iterations (15-300):
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; # JRE version: Java(TM) SE Runtime Environment (8.0_92-b14) (build
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 1.8.0_92-b14)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; # Java VM: Java HotSpot(TM) 64-Bit Server VM (25.92-b14 mixed mode
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; linux-amd64 compressed oops)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; # Problematic frame:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; # V  [libjvm.so+0x414d24]  ciEnv::get_field_by_index(ciInstanceKlass*,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; int)+0x94
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:16578] [ 0] /usr/lib64/libpthread.so.0(+0xf100)[0x2b3d01500100]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:16578] [ 1] /usr/lib64/libc.so.6(gsignal+0x37)[0x2b3d01b5c5f7]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [titan01:16578] [ 2] /usr/lib64/libc.so.6(abort+0x148)[0x2b3d01b5dce8]
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun noticed that process rank 2 with PID 0 on node titan01 exited on
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I don't know if it is a  problem of java or ompi - but the last years,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; java worked with no problems on my machine...
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Note a race condition in MPI_Init has been fixed yesterday in the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; master.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; can you please update your OpenMPI and try again ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Can you reproduce the crash with a simpler (and ideally deterministic)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; version of your program.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the crash occurs in hashcode, and this makes little sense to me. can
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; you also update your jdk ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 2. in &lt;10% the cases i have a live lock. I can see 3 java-processes,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; one with 200% and two with 100% processor utilization. After ~15 minutes
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; core dumping, try &quot;ulimit -c unlimited&quot; before starting Java again
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mpirun noticed that process rank 0 with PID 0 on node titan01 exited
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; had a few weeks ago (I'm a novice though). Maybe my thread will be of help:
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; either hangs up or returns with a SIGSEGV.&quot;  does you mean that a single
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; call hangs, or that at some point during the for loop a call hangs? If you
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mean the latter, then it might relate to my issue. Otherwise my thread
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; probably won't be helpful.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I try to send many byte-arrays via broadcast. After a specific number
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; of repetitions the process either hangs up or returns with a SIGSEGV. Does
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; any one can help me solving the problem:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; mpirun noticed that process rank 1 with PID 0 on node titan01 exited
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29605/attachment">attachment</a>
</ul>
