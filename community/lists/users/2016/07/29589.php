...
?>
<!-- received="Wed Jul  6 18:41:45 2016" -->
<!-- isoreceived="20160706224145" -->
<!-- sent="Thu, 7 Jul 2016 07:41:41 +0900" -->
<!-- isosent="20160706224141" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Java-OpenMPI returns with SIGSEGV" -->
<!-- id="CAAkFZ5sBT+AGartZdcL3X2a9DPYihbGbxpSqo5PfUaqrRP1-Bg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="577D2BC2.6010806_at_uni-rostock.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-07-06 18:41:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29590.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Previous message:</strong> <a href="29588.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>In reply to:</strong> <a href="29588.php">Gundram Leifert: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29590.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<li><strong>Reply:</strong> <a href="29590.php">Gilles Gouaillardet: "Re: [OMPI users] Java-OpenMPI returns with SIGSEGV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>how did you configure OpenMPI ?
<br>
<p>Cheers,
<br>
<p>Gilles
<br>
<p>On Thursday, July 7, 2016, Gundram Leifert &lt;gundram.leifert_at_[hidden]&gt;
<br>
wrote:
<br>
<p><span class="quotelev1">&gt; Hello Giles,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; thank you for your hints! I did 3 changes, unfortunately the same error
</span><br>
<span class="quotelev1">&gt; occures:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; [titan01:16578] [ 0] /usr/lib64/libpthread.so.0(+0xf100)[0x2b3d01500100]
</span><br>
...
<span class="quotelev1">&gt; mpirun noticed that process rank 2 with PID 0 on node titan01 exited on
</span><br>
...
<span class="quotelev1">&gt; the crash occurs in hashcode, and this makes little sense to me. can you
</span><br>
<span class="quotelev1">&gt; also update your jdk ?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; thanks for your response! I thing it is another problem. I try to send
</span><br>
<span class="quotelev2">&gt;&gt; 100MB bytes. So there are not many tries (between 10 and 30). I realized
</span><br>
<span class="quotelev2">&gt;&gt; that the execution of this code can result 3 different errors:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; 2. in &lt;10% the cases i have a live lock. I can see 3 java-processes, one
</span><br>
<span class="quotelev2">&gt;&gt; with 200% and two with 100% processor utilization. After ~15 minutes
</span><br>
...
<span class="quotelev2">&gt;&gt; [titan01:24256] [ 0] /usr/lib64/libpthread.so.0(+0xf100)[0x2b336a324100]
</span><br>
<span class="quotelev2">&gt;&gt; [titan01:24256] [ 1] /usr/lib64/libc.so.6(gsignal+0x37)[0x2b336a9815f7]
</span><br>
...
<span class="quotelev2">&gt;&gt; [titan01:24256] [10] /usr/lib64/libpthread.so.0(+0x7dc5)[0x2b336a31cdc5]
</span><br>
...
<span class="quotelev2">&gt;&gt; mpirun noticed that process rank 0 with PID 0 on node titan01 exited on
</span><br>
...
<span class="quotelev2">&gt;&gt; 3. in &lt;10% the cases i have a dead lock while MPI.init. This stays for
</span><br>
<span class="quotelev2">&gt;&gt; more than 15 minutes without returning with an error message...
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; After reading your thread looks like it may be related to an issue I had
</span><br>
<span class="quotelev2">&gt;&gt; a few weeks ago (I'm a novice though). Maybe my thread will be of help:
</span><br>
...
<span class="quotelev2">&gt;&gt; When you say &quot;After a specific number of repetitions the process either
</span><br>
<span class="quotelev2">&gt;&gt; hangs up or returns with a SIGSEGV.&quot;  does you mean that a single call
</span><br>
<span class="quotelev2">&gt;&gt; hangs, or that at some point during the for loop a call hangs? If you mean
</span><br>
<span class="quotelev2">&gt;&gt; the latter, then it might relate to my issue. Otherwise my thread probably
</span><br>
<span class="quotelev2">&gt;&gt; won't be helpful.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I try to send many byte-arrays via broadcast. After a specific number of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; repetitions the process either hangs up or returns with a SIGSEGV. Does any
</span><br>
<span class="quotelev3">&gt;&gt;&gt; one can help me solving the problem:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;                     log(&quot;bcast length done (length = &quot; + lengthData[0] +
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;)&quot;);
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                     MPI.COMM_WORLD.barrier();
...
<span class="quotelev3">&gt;&gt;&gt; #  SIGSEGV (0xb) at pc=0x00002b7e9c86e3a1, pid=1172, tid=47822674495232
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #
...
<span class="quotelev3">&gt;&gt;&gt; #  SIGSEGV (0xb) at pc=0x00002af69c0693a1, pid=1173, tid=47238546896640
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #
</span><br>
<span class="quotelev3">&gt;&gt;&gt; # JRE version: 7.0_25-b15
...
<span class="quotelev3">&gt;&gt;&gt; [titan01:01172] [ 0] /usr/lib64/libpthread.so.0(+0xf100)[0x2b7e9596a100]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [titan01:01172] [ 1] /usr/lib64/libc.so.6(gsignal+0x37)[0x2b7e95fc75f7]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [titan01:01172] [ 2] /usr/lib64/libc.so.6(abort+0x148)[0x2b7e95fc8ce8]
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [titan01:01173] [ 2] /usr/lib64/libc.so.6(abort+0x148)[0x2af69544bce8]
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; mpirun noticed that process rank 1 with PID 0 on node titan01 exited on
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29589/attachment">attachment</a>
</ul>
