...
?>
<!-- received="Thu Jun  9 08:06:41 2016" -->
<!-- isoreceived="20160609120641" -->
<!-- sent="Thu, 9 Jun 2016 12:06:02 +0000" -->
<!-- isosent="20160609120602" -->
...
<!-- id="95110DC63CB062409084890E698980AD1D83D5C0_at_VAW1PWINFMBXP1.veriskdom.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="b3b412c1-b055-567c-9d61-0d70230e1a8b_at_rist.or.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-06-09 08:06:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29417.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows"</a>
<li><strong>Previous message:</strong> <a href="29415.php">Kristina Tesch: "Re: [OMPI users] . cuda-memcheck reports errors for MPI functions after use of cudaSetDevice"</a>
<li><strong>In reply to:</strong> <a href="29413.php">Gilles Gouaillardet: "Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29417.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows"</a>
<li><strong>Reply:</strong> <a href="29417.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows"</a>
<li><strong>Reply:</strong> <a href="29418.php">Gilles Gouaillardet: "Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Subject: Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows
<br>
<p><p>On Jun 8, 2016, at 4:30 AM, Roth, Christopher &lt;CRoth_at_[hidden]&lt;mailto:CRoth_at_[hidden]&gt;&gt; wrote:
<br>
...
<br>
<p><p>On Jun 7, 2016, at 12:16 PM, Roth, Christopher &lt;&lt;mailto:CRoth_at_[hidden]&gt;CRoth_at_[hidden]&lt;mailto:CRoth_at_[hidden]&gt;&gt; wrote:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29416/attachment">attachment</a>
</ul>
