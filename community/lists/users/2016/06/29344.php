...
?>
<!-- received="Wed Jun  1 18:13:19 2016" -->
<!-- isoreceived="20160601221319" -->
<!-- sent="Wed, 1 Jun 2016 22:13:03 +0000 (UTC)" -->
<!-- isosent="20160601221303" -->
<!-- name="Megdich Islem" -->
<!-- email="megdich_islem_at_[hidden]" -->
<!-- subject="Re: [OMPI users] users Digest, Vol 3518, Issue 2" -->
<!-- id="1563435733.5633407.1464819183947.JavaMail.yahoo_at_mail.yahoo.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="mailman.15.1464796801.16301.users_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-06-01 18:13:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29345.php">Jeff Squyres (jsquyres): "Re: [OMPI users] users Digest, Vol 3518, Issue 2"</a>
<li><strong>Previous message:</strong> <a href="29343.php">Jeff Squyres (jsquyres): "Re: [OMPI users] users Digest, Vol 3514, Issue 1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29345.php">Jeff Squyres (jsquyres): "Re: [OMPI users] users Digest, Vol 3518, Issue 2"</a>
<li><strong>Reply:</strong> <a href="29345.php">Jeff Squyres (jsquyres): "Re: [OMPI users] users Digest, Vol 3518, Issue 2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi!
<br>
Thank you Jeff. I was able to run a case of OF &#194;&#160;by setting the absolute path name &#194;&#160;for mpiexec. But, when I wanted to run a coupled case in which &#194;&#160;OF is coupled with dummyCSM through EMPIRE using these three command lines:
<br>
...
<br>
<p>I was still getting OF not able to connect. In the user guide of EMPIRE, it is said that emperor (the client) &#194;&#160;has to recognize the clients which are dummyCSM and OpenFOAM. For some reasons emperor is not able to recognize OpenFoam but it recognizes dummyCSM.&#194;&#160;
<br>
What can be the cause that a server can not recognize a client ?
<br>
Regards,Islem 
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;Le Mercredi 1 juin 2016 17h00, &quot;users-request_at_[hidden]&quot; &lt;users-request_at_[hidden]&gt; a &#195;&#169;crit :
<br>
&nbsp;
<br>
...
<p><p>Today's Topics:
<br>
<p>&#194;&#160; 1. Re: Firewall settings for MPI communication
<br>
&#194;&#160; &#194;&#160; &#194;&#160; (Jeff Squyres (jsquyres))
<br>
&#194;&#160; 2. Re: users Digest, Vol 3514, Issue 1 (Jeff Squyres (jsquyres))
<br>
<p><p>----------------------------------------------------------------------
<br>
<p>Message: 1
...
<br>
Message-ID: &lt;AE97B273-C16B-4BC3-BC30-924D2569717D_at_[hidden]&gt;
<br>
...
<span class="quotelev1">&gt; mpirun --mca oob_tcp_dynamic_ports 49990-50010 -np 4 --hostfile machines simpleFoam ?parallel. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;&#194;&#160; 
...
<span class="quotelev1">&gt; Nobelstra?e 15
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/06/29340.php">http://www.open-mpi.org/community/lists/users/2016/06/29340.php</a>
</span><br>
<p><p><pre>
-- 
Jeff Squyres
...
Message-ID: &lt;C44110CB-7576-4272-BC53-9C274EF1E2D5_at_[hidden]&gt;
Content-Type: text/plain; charset=&quot;utf-8&quot;
The example you list below has all MPICH paths -- I don't see any Open MPI setups in there.
What I was suggesting was that if you absolutely need to have both Open MPI and MPICH installed and in your PATH / LD_LIBRARY_PATH / MANPATH, then you can use the full, absolute path name to each of the Open MPI executables -- e.g., /path/to/openmpi/install/bin/mpicc, etc.&#194;&#160; That way, you can use Open MPI's mpicc without having it in your path.
Additionally, per <a href="https://www.open-mpi.org/faq/?category=running#mpirun-prefix">https://www.open-mpi.org/faq/?category=running#mpirun-prefix</a>, if you specify the absolute path name to mpirun (or mpiexec -- they're identical in Open MPI) and you're using the rsh/ssh launcher in Open MPI, then Open MPI will set the right PATH / LD_LIBRARY_PATH on remote servers for you.&#194;&#160; See the FAQ link for more detail.
&gt; On Jun 1, 2016, at 8:41 AM, Megdich Islem &lt;megdich_islem_at_[hidden]&gt; wrote:
&gt; 
&gt; Hi!
&gt; 
...
&gt; export MPICH_LINK_CXX=&quot;-L/home/Desktop/mpich/lib/ -Wl,-rpath -Wl,/home/islem/Desktop/mpich/lib -lmpichcxx -lmpich -lopa -lmpl -lrt -lpthread&quot;
&gt; 
&gt; export PATH=$PATH:/opt/intel/bin/
&gt; LD_LIBRARY_PATH=&quot;/opt/intel/lib/intel64:$LD_LIBRARY_PATH&quot;
&gt; export LD_LIBRARY_PATH
&gt; source /opt/intel/compilers_and_libraries_2016.3.210/linux/mpi/intel64/mpivars.sh intel64
&gt; 
&gt; alias startEMPIRE=&quot;. /home/islem/software/empire/EMPIRE-Core/etc/bashrc.sh ICC&quot;
&gt; 
&gt; mpirun --version gives mpich 3.0.4
&gt; 
&gt; This is how I run one example that couples 2 clients through the server EMPIRE.
&gt; I use three terminals, in each I write one of these command lines
&gt; 
&gt; mpiexec -np 1 Emperor emperorInput.xml&#194;&#160; (I got a message in the terminal saying that Empire started)
&gt; 
&gt; mpiexec -np 1 dummyCSM dummyCSMInput (I get a message that Emperor acknowledged connection)
&gt; mpiexec -np 1 pimpleDyMFoam -case OF (I got no message in the terminal which means no connection)
&gt; 
...
&gt; 
&gt; 
&gt; Le Vendredi 27 mai 2016 17h00, &quot;users-request_at_[hidden]&quot; &lt;users-request_at_[hidden]&gt; a ?crit :
&gt; 
&gt; 
&gt; Send users mailing list submissions to
&gt;&#194;&#160; &#194;&#160; users_at_[hidden]
&gt; 
&gt; To subscribe or unsubscribe via the World Wide Web, visit
&gt;&#194;&#160; &#194;&#160; <a href="https://www.open-mpi.org/mailman/listinfo.cgi/users">https://www.open-mpi.org/mailman/listinfo.cgi/users</a>
&gt; or, via email, send a message with subject or body 'help' to
&gt;&#194;&#160; &#194;&#160; users-request_at_[hidden]
&gt; 
&gt; You can reach the person managing the list at
&gt;&#194;&#160; &#194;&#160; users-owner_at_[hidden]
&gt; 
...
&gt; Today's Topics:
&gt; 
&gt;&#194;&#160; 1. Re: users Digest, Vol 3510, Issue 2 (Jeff Squyres (jsquyres))
...
&gt; 
&gt; 
&gt; &gt; On May 26, 2016, at 3:46 PM, Megdich Islem &lt;megdich_islem_at_[hidden]&gt; wrote:
&gt; &gt; 
...
&gt; &gt;&#194;&#160; 
&gt; &gt; FAQ: Running MPI jobs
&gt; &gt; Table of contents: What pre-requisites are necessary for running an Open MPI job? What ABI guarantees does Open MPI provide? Do I need a common filesystem on a...
&gt; &gt; Afficher sur www.open-mpi.org
&gt; &gt; Aper?u par Yahoo
&gt; &gt;&#194;&#160; 
&gt; &gt; which suggests to use mpirun's&#194;&#160; prefix command line option or to use the mpirun wrapper.
&gt; &gt; 
&gt; &gt; I modified my command&#194;&#160; to the following
&gt; &gt;&#194;&#160; mpirun --prefix /opt/openfoam30/platforms/linux64GccDPInt32Opt/lib/Openmpi-system -np 1 pimpleDyMFoam -case OF
&gt; &gt; 
...
&gt; &gt; 
&gt; &gt; 
&gt; &gt; Le Mercredi 25 mai 2016 16h40, Dave Love &lt;d.love_at_[hidden]&gt; a ?crit :
&gt; &gt; 
&gt; &gt; 
&gt; &gt; I wrote:
&gt; &gt; 
...
&gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/05/29317.php">http://www.open-mpi.org/community/lists/users/2016/05/29317.php</a>
&gt; 
&gt; 
&gt; -- 
&gt; Jeff Squyres
...
&gt;&#194;&#160; &#194;&#160; openmpi-1.10.3rc2
&gt; Message-ID:
&gt;&#194;&#160; &#194;&#160; &lt;f5653a5c-174f-4569-c730-082a9db82e6a_at_[hidden]&gt;
...
&gt; Message-ID:
&gt;&#194;&#160; &#194;&#160; &lt;CABi-01XH+vdi2egBD=KNEN_CYXPEcG0j-+3rTvnFNc6mTD+nUg_at_[hidden]&gt;
&gt; Content-Type: text/plain; charset=&quot;utf-8&quot;
&gt; 
...
&gt; users_at_[hidden]
&gt; Subscription: <a href="https://www.open-mpi.org/mailman/listinfo.cgi/users">https://www.open-mpi.org/mailman/listinfo.cgi/users</a>
&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/06/29341.php">http://www.open-mpi.org/community/lists/users/2016/06/29341.php</a>
-- 
Jeff Squyres
jsquyres_at_[hidden]
For corporate legal information go to: <a href="http://www.cisco.com/web/about/doing_business/legal/cri/">http://www.cisco.com/web/about/doing_business/legal/cri/</a>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29344/attachment">attachment</a>
</ul>
