...
?>
<!-- received="Thu Jun 16 09:56:02 2016" -->
<!-- isoreceived="20160616135602" -->
<!-- sent="Thu, 16 Jun 2016 07:55:41 -0600" -->
<!-- isosent="20160616135541" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;failed to create queue pair&amp;quot; problem, but settings appear OK" -->
<!-- id="B71814B0-6AEA-48CB-A078-E63485D9834F_at_me.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="4F505D9A84D1D74E9397FB427DDF95BC52AAAE53_at_CINURCNA10.e2k.ad.ge.com" -->
<!-- expires="-1" -->
<div class="center">
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29469.php">Sasso, John (GE Power, Non-GE): "[OMPI users]  &quot;failed to create queue pair&quot; problem,	but settings appear OK"</a>
<li><strong>Previous message:</strong> <a href="29467.php">Sasso, John (GE Power, Non-GE): "[OMPI users]  &quot;failed to create queue pair&quot; problem,	but settings appear OK"</a>
<li><strong>In reply to:</strong> <a href="29467.php">Sasso, John (GE Power, Non-GE): "[OMPI users]  &quot;failed to create queue pair&quot; problem,	but settings appear OK"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29469.php">Sasso, John (GE Power, Non-GE): "[OMPI users]  &quot;failed to create queue pair&quot; problem,	but settings appear OK"</a>
<li><strong>Reply:</strong> <a href="29469.php">Sasso, John (GE Power, Non-GE): "[OMPI users]  &quot;failed to create queue pair&quot; problem,	but settings appear OK"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>When calculating the required number of queue pairs you also have to divide by the number of queue pairs in the btl_openib_receive_queues parameter. Additionally Open MPI uses 1 qp/rank for connections (1.7+) and there are some in use by IPoIB and other services.
<br>
<p>-Nathan
<br>
<p><span class="quotelev1">&gt; On Jun 16, 2016, at 7:15 AM, Sasso, John (GE Power, Non-GE) &lt;John1.Sasso_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; --mca btl openib,sm,self --mca btl_openib_receive_queues X,128,256,192,128:X,2048,256,128,32:X,12288,256,128,32:X,65536,256,128,32
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; --mca btl openib,sm,self --mca btl_openib_receive_queues X,4096,1024:X,12288,512:X,65536,512
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; From: users [mailto:users-bounces_at_[hidden]] On Behalf Of Nathan Hjelm
</span><br>
...
<span class="quotelev1">&gt; mpool_rdma_rcache_size_limit = 0 ==&gt; Open MPI will register as much user memory as necessary
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/06/29467.php">http://www.open-mpi.org/community/lists/users/2016/06/29467.php</a>
</span><br>
<p><p>
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29468/signature.asc">Message signed with OpenPGP using GPGMail</a>
</ul>
