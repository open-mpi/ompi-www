...
?>
<!-- received="Thu Jun  9 08:56:36 2016" -->
<!-- isoreceived="20160609125636" -->
<!-- sent="Thu, 9 Jun 2016 12:56:32 +0000" -->
<!-- isosent="20160609125632" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows" -->
<!-- id="92FEBD3C-7C19-4164-8617-9B378F8D7B42_at_cisco.com" -->
...
<strong>Date:</strong> 2016-06-09 08:56:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29418.php">Gilles Gouaillardet: "Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows"</a>
<li><strong>Previous message:</strong> <a href="29416.php">Roth, Christopher: "Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29419.php">Roth, Christopher: "Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows"</a>
<li><strong>Reply:</strong> <a href="29419.php">Roth, Christopher: "Re: [OMPI users] Processes unable to communicate when using MPI_Comm_spawn on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I think there were a few not-entirely-correct data points in this thread.  Let me clarify a few things:
<br>
