...
?>
<!-- received="Mon Jun 13 18:53:03 2016" -->
<!-- isoreceived="20160613225303" -->
<!-- sent="Mon, 13 Jun 2016 17:52:32 -0500" -->
<!-- isosent="20160613225232" -->
<!-- name="Jason Maldonis" -->
<!-- email="maldonis_at_[hidden]" -->
<!-- subject="[OMPI users] runtime error in orte/loop_spawn test using OMPI 1.10.2" -->
<!-- id="CA+LevYKbqQp0vGemzYLz7cGKFs-1JkyQbV45oje+Jek8_zKWMg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-06-13 18:52:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29427.php">Ralph Castain: "Re: [OMPI users] runtime error in orte/loop_spawn test using OMPI 1.10.2"</a>
<li><strong>Previous message:</strong> <a href="29425.php">Jason Maldonis: "[OMPI users] runtime error in orte/loop_spawn test using OMPI 1.10.2"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>Below is the output of the loop_spawn test on our university-wide cluster,
<br>
which I know very little about in terms of architecture but can get
<br>
information if it's helpful. The people who manage this cluster are
<br>
excellent, however.
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29426/attachment">attachment</a>
</ul>
