...
?>
<!-- received="Mon Apr 18 01:12:58 2016" -->
<!-- isoreceived="20160418051258" -->
<!-- sent="Mon, 18 Apr 2016 01:12:47 -0400" -->
<!-- isosent="20160418051247" -->
<!-- name="dpchoudh ." -->
<!-- email="dpchoudh_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Possible bug in MPI_Barrier() ?" -->
<!-- id="CAHXxYDin2OSciLTCGNt6Q_b4C0uymXKwpGS+cR8yM64BN7awEw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="571466E2.7080900_at_rist.or.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-18 01:12:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28948.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<li><strong>Previous message:</strong> <a href="28946.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<li><strong>In reply to:</strong> <a href="28946.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28948.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<li><strong>Reply:</strong> <a href="28948.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello Gilles
<br>
<p>Thank you very much for your feedback. You are right that my original stack
<br>
...
(gdb)
<br>
<p>And my configuration was done as follows:
<br>
<p>&nbsp;$ ./configure --enable-debug --enable-debug-symbols
<br>
<p>I double checked to ensure that there is not an older installation of
<br>
...
<br>
<p>On Mon, Apr 18, 2016 at 12:47 AM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;
<br>
wrote:
<br>
<p><span class="quotelev1">&gt; here is your stack trace
</span><br>
...
<span class="quotelev1">&gt; that would be line 259 in current master, and this file was updated 21
</span><br>
<span class="quotelev1">&gt; days ago
</span><br>
<span class="quotelev1">&gt; and that suggests your master is not quite up to date.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; even if the message is sent eagerly, the ob1 pml does use an internal
</span><br>
<span class="quotelev1">&gt; request it will wait for.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; there could be some side effects if some old modules were not removed
</span><br>
<span class="quotelev1">&gt; and/or if you are
</span><br>
<span class="quotelev1">&gt; not using the modules you expect.
</span><br>
<span class="quotelev1">&gt; /* when it hangs, you can pmap &lt;pid&gt; and check the path of the openmpi
</span><br>
<span class="quotelev1">&gt; libraries are the one you expect */
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28947/attachment">attachment</a>
</ul>
