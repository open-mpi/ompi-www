...
?>
<!-- received="Fri Apr 29 12:01:09 2016" -->
<!-- isoreceived="20160429160109" -->
<!-- sent="Fri, 29 Apr 2016 09:01:01 -0700" -->
<!-- isosent="20160429160101" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8" -->
<!-- id="1D753261-EFF9-4D07-AEF3-952350C0DC36_at_open-mpi.org" -->
<!-- charset="utf-8" -->
<!-- inreplyto="17EB37BD-0ED5-4012-98CB-0471C152FBE3_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-29 12:01:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29054.php">Siegmar Gross: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<li><strong>Previous message:</strong> <a href="29052.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<li><strong>In reply to:</strong> <a href="29052.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29054.php">Siegmar Gross: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
<a href="https://github.com/open-mpi/ompi-release/pull/1117">https://github.com/open-mpi/ompi-release/pull/1117</a> &lt;<a href="https://github.com/open-mpi/ompi-release/pull/1117">https://github.com/open-mpi/ompi-release/pull/1117</a>&gt;
<br>
<p><p><span class="quotelev1">&gt; On Apr 29, 2016, at 7:38 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Ah, okay - I can fix that line. Thanks for pointing it out.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Given that the rest of the code uses the app[i] syntax, I&#226;&#128;&#153;d rather leave that alone.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Apr 29, 2016, at 7:27 AM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden] &lt;mailto:gilles.gouaillardet_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; the second for loop is incorrect
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; it reads
</span><br>
<span class="quotelev2">&gt;&gt; for (j=0; j &lt; app-&gt;argc; j++)
</span><br>
<span class="quotelev2">&gt;&gt; but should be
</span><br>
<span class="quotelev2">&gt;&gt; for (j=0; j &lt; app[i].argc; j++)
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; as a matter of taste, I'd rather replace all app[i]. with app-&gt;
</span><br>
<span class="quotelev2">&gt;&gt; and
</span><br>
<span class="quotelev2">&gt;&gt; app++;
</span><br>
<span class="quotelev2">&gt;&gt; at the end (or in the for) of the outermost loop
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Friday, April 29, 2016, Ralph Castain &lt;rhc_at_[hidden] &lt;mailto:rhc_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Hmmm&#226;&#128;&#166;well, I may have to wait and let Gilles fix this. So far as I can see, the code in the current OMPI 2.x tarball (and upstream) is correct:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; int pmix_bfrop_pack_app(pmix_buffer_t *buffer, const void *src,
</span><br>
<span class="quotelev2">&gt;&gt;                         int32_t num_vals, pmix_data_type_t type)
</span><br>
<span class="quotelev2">&gt;&gt; {
</span><br>
<span class="quotelev2">&gt;&gt;     pmix_app_t *app;
</span><br>
<span class="quotelev2">&gt;&gt;     int32_t i, j, nvals;
</span><br>
<span class="quotelev2">&gt;&gt;     int ret;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;     app = (pmix_app_t *) src;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;     for (i = 0; i &lt; num_vals; ++i) {
</span><br>
<span class="quotelev2">&gt;&gt;         if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_string(buffer, &amp;app[i].cmd, 1, PMIX_STRING))) {
</span><br>
...
<span class="quotelev2">&gt;&gt;         if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_int(buffer, &amp;app[i].argc, 1, PMIX_INT))) {
</span><br>
<span class="quotelev2">&gt;&gt;             return ret;
</span><br>
<span class="quotelev2">&gt;&gt;         }
...
<span class="quotelev2">&gt;&gt;             if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_string(buffer, &amp;app[i].argv[j], 1, PMIX_STRING))) {
</span><br>
<span class="quotelev2">&gt;&gt;                 return ret;
</span><br>
<span class="quotelev2">&gt;&gt;             }
...
<span class="quotelev2">&gt;&gt;         nvals = pmix_argv_count(app[i].env);
</span><br>
<span class="quotelev2">&gt;&gt;         if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_int32(buffer, &amp;nvals, 1, PMIX_INT32))) {
</span><br>
<span class="quotelev2">&gt;&gt;             return ret;
</span><br>
<span class="quotelev2">&gt;&gt;         }
</span><br>
<span class="quotelev2">&gt;&gt;         for (j=0; j &lt; nvals; j++) {
</span><br>
<span class="quotelev2">&gt;&gt;             if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_string(buffer, &amp;app[i].env[j], 1, PMIX_STRING))) {
</span><br>
<span class="quotelev2">&gt;&gt;                 return ret;
</span><br>
<span class="quotelev2">&gt;&gt;             }
...
<span class="quotelev2">&gt;&gt;         if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_int(buffer, &amp;app[i].maxprocs, 1, PMIX_INT))) {
</span><br>
<span class="quotelev2">&gt;&gt;             return ret;
</span><br>
<span class="quotelev2">&gt;&gt;         }
</span><br>
<span class="quotelev2">&gt;&gt;         /* info array */
</span><br>
<span class="quotelev2">&gt;&gt;         if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_sizet(buffer, &amp;app[i].ninfo, 1, PMIX_SIZE))) {
</span><br>
<span class="quotelev2">&gt;&gt;             return ret;
</span><br>
<span class="quotelev2">&gt;&gt;         }
</span><br>
<span class="quotelev2">&gt;&gt;         if (0 &lt; app[i].ninfo) {
</span><br>
<span class="quotelev2">&gt;&gt;             if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_info(buffer, app[i].info, app[i].ninfo, PMIX_INFO))) {
</span><br>
<span class="quotelev2">&gt;&gt;                 return ret;
</span><br>
<span class="quotelev2">&gt;&gt;             }
...
<span class="quotelev2">&gt;&gt; Siegmar: have you tried the latest release candidate?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Apr 28, 2016, at 11:08 PM, Siegmar Gross &lt;Siegmar.Gross_at_[hidden] &lt;&gt;&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; thank you very much for identifying the reason for the problem
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and fixing it.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Have a nice weekend
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Am 29.04.2016 um 03:38 schrieb Gilles Gouaillardet:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Siegmar,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; in pmix_bfrop_pack_app,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; app-&gt;argc
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; must be replaced with
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; app[i].argc
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I will PR to pmix, ompi and ompi-release when I am back at work on Monday
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Thursday, April 28, 2016, Gilles Gouaillardet &lt;gilles_at_[hidden] &lt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;    can you please also post the source of spawn_slave ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt;    On 4/28/2016 1:17 AM, Siegmar Gross wrote:
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;    SunOS tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt; &lt;<a href="http://tyr.informatik.hs-fulda.de">http://tyr.informatik.hs-fulda.de</a> &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;    5.10 Generic_150400-11 sun4u sparc SUNW,A70 Solaris
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;    tyr spawn 121 mpiexec -np 1 --host tyr,tyr,tyr,tyr spawn_multiple_master
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;    Parent process 0 running on tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;    [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;:27286
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://tyr.informatik.hs-fulda.de:27286">http://tyr.informatik.hs-fulda.de:27286</a> &lt;<a href="http://tyr.informatik.hs-fulda.de:27286/">http://tyr.informatik.hs-fulda.de:27286/</a>&gt;&gt;] PMIX ERROR: UNPACK-PAST-END
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    this is no more a widely used environment, and I am not sure I can find
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;        Shall I add it permanently to my configure command or will you add it,
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;        yesterday for my gcc-version of Open MPI. Hopefully you can solve the
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;            &quot;/usr/include/stdbool.h&quot;, line 42: #error: &quot;Use of &lt;stdbool.h&gt; is
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;            could you please re-configure with '-std=c99' appended to your
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                I was able to sort out my mess. In my last email I compared
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                files from &quot;SunOS_sparc/openmpi-2.0.0_64_gcc/lib64/openmpi&quot;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                of my email so that it is easier to see the relevant files.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    Below
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                I try to give you more information that may be relevant to
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    track
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    mca_pmix_pmix112.la &lt;<a href="http://mca_pmix_pmix112.la/">http://mca_pmix_pmix112.la/</a>&gt; &lt;<a href="http://mca_pmix_pmix112.la">http://mca_pmix_pmix112.la</a> &lt;<a href="http://mca_pmix_pmix112.la/">http://mca_pmix_pmix112.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://mca_pmix_pmix112.la">http://mca_pmix_pmix112.la</a> &lt;<a href="http://mca_pmix_pmix112.la/">http://mca_pmix_pmix112.la/</a>&gt;&gt; &lt;<a href="http://mca_pmix_pmix112.la">http://mca_pmix_pmix112.la</a> &lt;<a href="http://mca_pmix_pmix112.la/">http://mca_pmix_pmix112.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                -rwxr-xr-x 1 root root 3906526 Apr 19 16:45
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    mca_pmix_pmix112.so
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                -rwxr-xr-x 1 root root     966 Apr 19 16:51 mca_pml_cm.la &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt; &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                -rwxr-xr-x 1 root root     972 Apr 19 16:46 mca_pml_cm.la &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt; &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                -rwxr-xr-x 1 root root     970 Apr 19 20:00 mca_pml_cm.la &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt; &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                -rwxr-xr-x 1 root root     971 Apr 19 19:52 mca_pml_cm.la &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt; &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                -rwxr-xr-x 1 root root     970 Apr 19 17:23 mca_pml_cm.la &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt; &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                -rwxr-xr-x 1 root root     971 Apr 19 17:46 mca_pml_cm.la &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt; &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                Yesterday I've installed openmpi-v2.x-dev-1290-gbd0e4e1 so
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                configure:128523: checking for MCA component pmix:external
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                mca/allocator/libmca_allocator.la &lt;<a href="http://libmca_allocator.la/">http://libmca_allocator.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_allocator.la">http://libmca_allocator.la</a> &lt;<a href="http://libmca_allocator.la/">http://libmca_allocator.la/</a>&gt;&gt; &lt;<a href="http://libmca_allocator.la">http://libmca_allocator.la</a> &lt;<a href="http://libmca_allocator.la/">http://libmca_allocator.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_allocator.la">http://libmca_allocator.la</a> &lt;<a href="http://libmca_allocator.la/">http://libmca_allocator.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_allocator_STATIC_LTLIBS)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                mca/backtrace/libmca_backtrace.la &lt;<a href="http://libmca_backtrace.la/">http://libmca_backtrace.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_backtrace.la">http://libmca_backtrace.la</a> &lt;<a href="http://libmca_backtrace.la/">http://libmca_backtrace.la/</a>&gt;&gt; &lt;<a href="http://libmca_backtrace.la">http://libmca_backtrace.la</a> &lt;<a href="http://libmca_backtrace.la/">http://libmca_backtrace.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_backtrace.la">http://libmca_backtrace.la</a> &lt;<a href="http://libmca_backtrace.la/">http://libmca_backtrace.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_backtrace_STATIC_LTLIBS)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                mca/btl/libmca_btl.la &lt;<a href="http://libmca_btl.la/">http://libmca_btl.la/</a>&gt; &lt;<a href="http://libmca_btl.la">http://libmca_btl.la</a> &lt;<a href="http://libmca_btl.la/">http://libmca_btl.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_btl.la">http://libmca_btl.la</a> &lt;<a href="http://libmca_btl.la/">http://libmca_btl.la/</a>&gt;&gt; &lt;<a href="http://libmca_btl.la">http://libmca_btl.la</a> &lt;<a href="http://libmca_btl.la/">http://libmca_btl.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_btl_STATIC_LTLIBS) mca/dl/libmca_dl.la &lt;<a href="http://libmca_dl.la/">http://libmca_dl.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_dl.la">http://libmca_dl.la</a> &lt;<a href="http://libmca_dl.la/">http://libmca_dl.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_dl.la">http://libmca_dl.la</a> &lt;<a href="http://libmca_dl.la/">http://libmca_dl.la/</a>&gt;&gt; &lt;<a href="http://libmca_dl.la">http://libmca_dl.la</a> &lt;<a href="http://libmca_dl.la/">http://libmca_dl.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_dl_STATIC_LTLIBS) mca/event/libmca_event.la &lt;<a href="http://libmca_event.la/">http://libmca_event.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_event.la">http://libmca_event.la</a> &lt;<a href="http://libmca_event.la/">http://libmca_event.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_event.la">http://libmca_event.la</a> &lt;<a href="http://libmca_event.la/">http://libmca_event.la/</a>&gt;&gt; &lt;<a href="http://libmca_event.la">http://libmca_event.la</a> &lt;<a href="http://libmca_event.la/">http://libmca_event.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_event_STATIC_LTLIBS) mca/hwloc/libmca_hwloc.la &lt;<a href="http://libmca_hwloc.la/">http://libmca_hwloc.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_hwloc.la">http://libmca_hwloc.la</a> &lt;<a href="http://libmca_hwloc.la/">http://libmca_hwloc.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_hwloc.la">http://libmca_hwloc.la</a> &lt;<a href="http://libmca_hwloc.la/">http://libmca_hwloc.la/</a>&gt;&gt; &lt;<a href="http://libmca_hwloc.la">http://libmca_hwloc.la</a> &lt;<a href="http://libmca_hwloc.la/">http://libmca_hwloc.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_hwloc_STATIC_LTLIBS) mca/if/libmca_if.la &lt;<a href="http://libmca_if.la/">http://libmca_if.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_if.la">http://libmca_if.la</a> &lt;<a href="http://libmca_if.la/">http://libmca_if.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_if.la">http://libmca_if.la</a> &lt;<a href="http://libmca_if.la/">http://libmca_if.la/</a>&gt;&gt; &lt;<a href="http://libmca_if.la">http://libmca_if.la</a> &lt;<a href="http://libmca_if.la/">http://libmca_if.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_if_STATIC_LTLIBS)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    mca/installdirs/libmca_installdirs.la &lt;<a href="http://libmca_installdirs.la/">http://libmca_installdirs.la/</a>&gt; &lt;<a href="http://libmca_installdirs.la">http://libmca_installdirs.la</a> &lt;<a href="http://libmca_installdirs.la/">http://libmca_installdirs.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_installdirs.la">http://libmca_installdirs.la</a> &lt;<a href="http://libmca_installdirs.la/">http://libmca_installdirs.la/</a>&gt;&gt; &lt;<a href="http://libmca_installdirs.la">http://libmca_installdirs.la</a> &lt;<a href="http://libmca_installdirs.la/">http://libmca_installdirs.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_installdirs_STATIC_LTLIBS)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                mca/memchecker/libmca_memchecker.la &lt;<a href="http://libmca_memchecker.la/">http://libmca_memchecker.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_memchecker.la">http://libmca_memchecker.la</a> &lt;<a href="http://libmca_memchecker.la/">http://libmca_memchecker.la/</a>&gt;&gt; &lt;<a href="http://libmca_memchecker.la">http://libmca_memchecker.la</a> &lt;<a href="http://libmca_memchecker.la/">http://libmca_memchecker.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_memchecker.la">http://libmca_memchecker.la</a> &lt;<a href="http://libmca_memchecker.la/">http://libmca_memchecker.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_memchecker_STATIC_LTLIBS)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    mca/memcpy/libmca_memcpy.la &lt;<a href="http://libmca_memcpy.la/">http://libmca_memcpy.la/</a>&gt; &lt;<a href="http://libmca_memcpy.la">http://libmca_memcpy.la</a> &lt;<a href="http://libmca_memcpy.la/">http://libmca_memcpy.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_memcpy.la">http://libmca_memcpy.la</a> &lt;<a href="http://libmca_memcpy.la/">http://libmca_memcpy.la/</a>&gt;&gt; &lt;<a href="http://libmca_memcpy.la">http://libmca_memcpy.la</a> &lt;<a href="http://libmca_memcpy.la/">http://libmca_memcpy.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_memcpy_STATIC_LTLIBS)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    mca/memory/libmca_memory.la &lt;<a href="http://libmca_memory.la/">http://libmca_memory.la/</a>&gt; &lt;<a href="http://libmca_memory.la">http://libmca_memory.la</a> &lt;<a href="http://libmca_memory.la/">http://libmca_memory.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_memory.la">http://libmca_memory.la</a> &lt;<a href="http://libmca_memory.la/">http://libmca_memory.la/</a>&gt;&gt; &lt;<a href="http://libmca_memory.la">http://libmca_memory.la</a> &lt;<a href="http://libmca_memory.la/">http://libmca_memory.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_memory_STATIC_LTLIBS) mca/mpool/libmca_mpool.la &lt;<a href="http://libmca_mpool.la/">http://libmca_mpool.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_mpool.la">http://libmca_mpool.la</a> &lt;<a href="http://libmca_mpool.la/">http://libmca_mpool.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_mpool.la">http://libmca_mpool.la</a> &lt;<a href="http://libmca_mpool.la/">http://libmca_mpool.la/</a>&gt;&gt; &lt;<a href="http://libmca_mpool.la">http://libmca_mpool.la</a> &lt;<a href="http://libmca_mpool.la/">http://libmca_mpool.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_mpool_STATIC_LTLIBS) mca/pmix/libmca_pmix.la &lt;<a href="http://libmca_pmix.la/">http://libmca_pmix.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_pmix.la">http://libmca_pmix.la</a> &lt;<a href="http://libmca_pmix.la/">http://libmca_pmix.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_pmix.la">http://libmca_pmix.la</a> &lt;<a href="http://libmca_pmix.la/">http://libmca_pmix.la/</a>&gt;&gt; &lt;<a href="http://libmca_pmix.la">http://libmca_pmix.la</a> &lt;<a href="http://libmca_pmix.la/">http://libmca_pmix.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_pmix_STATIC_LTLIBS) mca/pstat/libmca_pstat.la &lt;<a href="http://libmca_pstat.la/">http://libmca_pstat.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_pstat.la">http://libmca_pstat.la</a> &lt;<a href="http://libmca_pstat.la/">http://libmca_pstat.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_pstat.la">http://libmca_pstat.la</a> &lt;<a href="http://libmca_pstat.la/">http://libmca_pstat.la/</a>&gt;&gt; &lt;<a href="http://libmca_pstat.la">http://libmca_pstat.la</a> &lt;<a href="http://libmca_pstat.la/">http://libmca_pstat.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_pstat_STATIC_LTLIBS) mca/rcache/libmca_rcache.la &lt;<a href="http://libmca_rcache.la/">http://libmca_rcache.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_rcache.la">http://libmca_rcache.la</a> &lt;<a href="http://libmca_rcache.la/">http://libmca_rcache.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_rcache.la">http://libmca_rcache.la</a> &lt;<a href="http://libmca_rcache.la/">http://libmca_rcache.la/</a>&gt;&gt; &lt;<a href="http://libmca_rcache.la">http://libmca_rcache.la</a> &lt;<a href="http://libmca_rcache.la/">http://libmca_rcache.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_rcache_STATIC_LTLIBS) mca/sec/libmca_sec.la &lt;<a href="http://libmca_sec.la/">http://libmca_sec.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_sec.la">http://libmca_sec.la</a> &lt;<a href="http://libmca_sec.la/">http://libmca_sec.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_sec.la">http://libmca_sec.la</a> &lt;<a href="http://libmca_sec.la/">http://libmca_sec.la/</a>&gt;&gt; &lt;<a href="http://libmca_sec.la">http://libmca_sec.la</a> &lt;<a href="http://libmca_sec.la/">http://libmca_sec.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_sec_STATIC_LTLIBS) mca/shmem/libmca_shmem.la &lt;<a href="http://libmca_shmem.la/">http://libmca_shmem.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_shmem.la">http://libmca_shmem.la</a> &lt;<a href="http://libmca_shmem.la/">http://libmca_shmem.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_shmem.la">http://libmca_shmem.la</a> &lt;<a href="http://libmca_shmem.la/">http://libmca_shmem.la/</a>&gt;&gt; &lt;<a href="http://libmca_shmem.la">http://libmca_shmem.la</a> &lt;<a href="http://libmca_shmem.la/">http://libmca_shmem.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                $(MCA_opal_shmem_STATIC_LTLIBS) mca/timer/libmca_timer.la &lt;<a href="http://libmca_timer.la/">http://libmca_timer.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libmca_timer.la">http://libmca_timer.la</a> &lt;<a href="http://libmca_timer.la/">http://libmca_timer.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libmca_timer.la">http://libmca_timer.la</a> &lt;<a href="http://libmca_timer.la/">http://libmca_timer.la/</a>&gt;&gt; &lt;<a href="http://libmca_timer.la">http://libmca_timer.la</a> &lt;<a href="http://libmca_timer.la/">http://libmca_timer.la/</a>&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    opal_pmix_pmix112_LIBS='$(OPAL_TOP_BUILDDIR)/opal/mca/pmix/pmix112/pmix/libpmix.la &lt;<a href="http://libpmix.la/">http://libpmix.la/</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    &lt;<a href="http://libpmix.la">http://libpmix.la</a> &lt;<a href="http://libpmix.la/">http://libpmix.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                &lt;<a href="http://libpmix.la">http://libpmix.la</a> &lt;<a href="http://libpmix.la/">http://libpmix.la/</a>&gt;&gt; &lt;<a href="http://libpmix.la">http://libpmix.la</a> &lt;<a href="http://libpmix.la/">http://libpmix.la/</a>&gt;&gt;'
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                ...
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                    and they were definitely available when I answered the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    email from
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    mca_plm_rsh.la &lt;<a href="http://mca_plm_rsh.la/">http://mca_plm_rsh.la/</a>&gt; &lt;<a href="http://mca_plm_rsh.la">http://mca_plm_rsh.la</a> &lt;<a href="http://mca_plm_rsh.la/">http://mca_plm_rsh.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                    &lt;<a href="http://mca_plm_rsh.la">http://mca_plm_rsh.la</a> &lt;<a href="http://mca_plm_rsh.la/">http://mca_plm_rsh.la/</a>&gt;&gt; &lt;<a href="http://mca_plm_rsh.la">http://mca_plm_rsh.la</a> &lt;<a href="http://mca_plm_rsh.la/">http://mca_plm_rsh.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                    -rwxr-xr-x 1 root root  153280 Apr 19 19:49 mca_plm_rsh.so
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                    -rwxr-xr-x 1 root root    1007 Apr 19 19:47
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;    mca_pml_cm.la &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt; &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                    &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt; &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a> &lt;<a href="http://mca_pml_cm.la/">http://mca_pml_cm.la/</a>&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                    -rwxr-xr-x 1 root root  342440 Apr 19 19:52 mca_pml_cm.so
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;                            I've already used &quot;-enable-debug&quot;. &quot;SYSTEM_ENV&quot; is
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29053/attachment">attachment</a>
</ul>
