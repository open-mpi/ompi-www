...
?>
<!-- received="Thu Apr 28 02:06:51 2016" -->
<!-- isoreceived="20160428060651" -->
<!-- sent="Thu, 28 Apr 2016 08:06:28 +0200" -->
<!-- isosent="20160428060628" -->
<!-- name="Siegmar Gross" -->
<!-- email="siegmar.gross_at_[hidden]" -->
<!-- subject="Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8" -->
<!-- id="4d024e03-cdc5-48a4-58cb-7891c132824d_at_informatik.hs-fulda.de" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-04-28 02:06:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29045.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Add release dates to release notes"</a>
<li><strong>Previous message:</strong> <a href="29043.php">dpchoudh .: "[OMPI users] Add release dates to release notes"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29047.php">Gilles Gouaillardet: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Gilles,
<br>
<p>I'm sorry that I forgot the file.
<br>
<p><p>Kind regards
<br>
<p>Siegmar
<br>
<p>Am 28.04.2016 um 03:34 schrieb Gilles Gouaillardet:
<br>
...
<span class="quotelev2">&gt;&gt; SunOS tyr.informatik.hs-fulda.de 5.10 Generic_150400-11 sun4u sparc SUNW,A70
</span><br>
...
<span class="quotelev2">&gt;&gt; [tyr.informatik.hs-fulda.de:27286] PMIX ERROR: UNPACK-PAST-END in file
</span><br>
...
<span class="quotelev2">&gt;&gt; [tyr:27288] *** MPI_ERRORS_ARE_FATAL (processes in this communicator will
</span><br>
...
<span class="quotelev2">&gt;&gt; sunpc1 fd1026 105 ompi_info | grep -e &quot;OPAL repo revision&quot; -e &quot;C compiler
</span><br>
...
<span class="quotelev2">&gt;&gt; [sunpc1:370] *** MPI_ERRORS_ARE_FATAL (processes in this communicator will
</span><br>
<span class="quotelev2">&gt;&gt; now abort,
</span><br>
...
<span class="quotelev2">&gt;&gt; linpc1 fd1026 105 ompi_info | grep -e &quot;OPAL repo revision&quot; -e &quot;C compiler
</span><br>
<span class="quotelev2">&gt;&gt; absolute&quot;
</span><br>
<span class="quotelev2">&gt;&gt;       OPAL repo revision: v2.x-dev-1290-gbd0e4e1
...
<span class="quotelev2">&gt;&gt; Linux linpc1 3.1.10-1.29-desktop #1 SMP PREEMPT Fri May 31 20:10:04 UTC 2013
</span><br>
<span class="quotelev2">&gt;&gt; (2529847) x86_64 x86_64 x86_64 GNU/Linux
</span><br>
...
<span class="quotelev2">&gt;&gt; [linpc1:21507] *** MPI_ERRORS_ARE_FATAL (processes in this communicator will
</span><br>
<span class="quotelev2">&gt;&gt; now abort,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; configure tries to detect which flags must be added for C99 support, and it
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             &lt;<a href="http://mca_pmix_pmix112.la">http://mca_pmix_pmix112.la</a>&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             configure:127916: checking if MCA component pmix:pmix112 can
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             configure:129054: checking if MCA component pmix:external can
</span><br>
<span class="quotelev3">&gt;&gt;&gt; compile
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             MCA_opal_FRAMEWORKS='common  allocator backtrace btl dl event
</span><br>
<span class="quotelev3">&gt;&gt;&gt; hwloc if
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             mca/allocator/libmca_allocator.la &lt;<a href="http://libmca_allocator.la">http://libmca_allocator.la</a>&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             $(MCA_opal_allocator_STATIC_LTLIBS)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             mca/backtrace/libmca_backtrace.la &lt;<a href="http://libmca_backtrace.la">http://libmca_backtrace.la</a>&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             &lt;<a href="http://libmca_installdirs.la">http://libmca_installdirs.la</a>&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             $(MCA_opal_installdirs_STATIC_LTLIBS)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             mca/memchecker/libmca_memchecker.la &lt;<a href="http://libmca_memchecker.la">http://libmca_memchecker.la</a>&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             $(MCA_opal_memchecker_STATIC_LTLIBS) mca/memcpy/libmca_memcpy.la
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             &lt;<a href="http://libmca_memcpy.la">http://libmca_memcpy.la</a>&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             $(MCA_opal_memcpy_STATIC_LTLIBS) mca/memory/libmca_memory.la
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             &lt;<a href="http://libmca_memory.la">http://libmca_memory.la</a>&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             configure:128379: checking if MCA component pmix:pmix112 can
</span><br>
<span class="quotelev3">&gt;&gt;&gt; compile
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;                 I don't know what happened, but the files are not available
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;                 Ralph. The files also have a different timestamp now. This
</span><br>
<span class="quotelev3">&gt;&gt;&gt; is an
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;                 &lt;<a href="http://mca_plm_rsh.la">http://mca_plm_rsh.la</a>&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                 -rwxr-xr-x 1 root root  153280 Apr 19 19:49 mca_plm_rsh.so
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;                                     mca_base_component_show_load_errors 1&#148; to
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;                                                     line? I need to see why
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;                                                 tyr spawn 111 mpiexec -np 1
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;         <a href="http://www.open-mpi.org/community/lists/users/2016/04/29038.php">http://www.open-mpi.org/community/lists/users/2016/04/29038.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/04/29041.php">http://www.open-mpi.org/community/lists/users/2016/04/29041.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/04/29042.php">http://www.open-mpi.org/community/lists/users/2016/04/29042.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><p>
<br><hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29044/spawn_slave.c">spawn_slave.c</a>
</ul>
