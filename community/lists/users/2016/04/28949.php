...
?>
<!-- received="Mon Apr 18 01:53:56 2016" -->
<!-- isoreceived="20160418055356" -->
<!-- sent="Mon, 18 Apr 2016 01:53:52 -0400" -->
<!-- isosent="20160418055352" -->
<!-- name="dpchoudh ." -->
<!-- email="dpchoudh_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Possible bug in MPI_Barrier() ?" -->
<!-- id="CAHXxYDgaRJp2SxnQ79qMEfhGJmu_VH0uvS07WVz9qgzsHkHi6Q_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="57146EE9.60009_at_rist.or.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-18 01:53:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28950.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<li><strong>Previous message:</strong> <a href="28948.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<li><strong>In reply to:</strong> <a href="28948.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28950.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<li><strong>Reply:</strong> <a href="28950.php">Gilles Gouaillardet: "Re: [OMPI users] Possible bug in MPI_Barrier() ?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>What I find a bit strange is that only I seem to be getting into this
<br>
...
<br>
<p>On Mon, Apr 18, 2016 at 1:21 AM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;
<br>
wrote:
<br>
<p><span class="quotelev1">&gt; so you might want to
</span><br>
...
<span class="quotelev1">&gt; stack trace was on code that was several weeks behind, but updating it just
</span><br>
<span class="quotelev1">&gt; now did not seem to make a difference: I am copying the stack from the
</span><br>
<span class="quotelev1">&gt; latest code below:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; libraries are coming from /usr/local/lib, which seems to be correct. I am
</span><br>
<span class="quotelev1">&gt; also quite sure about the firewall issue (that there is none). I will try
</span><br>
<span class="quotelev1">&gt; out your suggestion on installing from a tarball and see how it goes.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; that would be line 259 in current master, and this file was updated 21
</span><br>
<span class="quotelev2">&gt;&gt; days ago
</span><br>
<span class="quotelev2">&gt;&gt; and that suggests your master is not quite up to date.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; even if the message is sent eagerly, the ob1 pml does use an internal
</span><br>
<span class="quotelev2">&gt;&gt; request it will wait for.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; using a new install dir, and check if the issue is still here or not.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; there could be some side effects if some old modules were not removed
</span><br>
<span class="quotelev2">&gt;&gt; and/or if you are
</span><br>
<span class="quotelev2">&gt;&gt; not using the modules you expect.
</span><br>
<span class="quotelev2">&gt;&gt; /* when it hangs, you can pmap &lt;pid&gt; and check the path of the openmpi
</span><br>
<span class="quotelev2">&gt;&gt; libraries are the one you expect */
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; what if you do not send/recv but invoke MPI_Barrier multiple times ?
</span><br>
...
<span class="quotelev2">&gt;&gt; Thank you for your suggestion, Ralph. But it did not make any difference.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Let me say that my code is about a week stale. I just did a git pull and
</span><br>
<span class="quotelev2">&gt;&gt; am building it right now. The build takes quite a bit of time, so I avoid
</span><br>
<span class="quotelev2">&gt;&gt; doing that unless there is a reason. But what I am trying out is the most
</span><br>
<span class="quotelev2">&gt;&gt; basic functionality, so I'd think a week or so of lag would not make a
</span><br>
<span class="quotelev2">&gt;&gt; difference.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Does the stack trace suggest something to you? It seems that the send
</span><br>
<span class="quotelev2">&gt;&gt; hangs; but a 4 byte send should be sent eagerly.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Try adding -mca oob_tcp_if_include eno1 to your cmd line and see if that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; makes a difference
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I am sorry to be bugging the developers, but this issue seems to be
</span><br>
<span class="quotelev3">&gt;&gt;&gt; nagging me, and I am surprised it does not seem to affect anybody else. But
</span><br>
<span class="quotelev3">&gt;&gt;&gt; then again, I am using the master branch, and most users are probably using
</span><br>
<span class="quotelev3">&gt;&gt;&gt; a released version.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; This time I am using a totally different cluster. This has NO verbs
</span><br>
<span class="quotelev3">&gt;&gt;&gt; capable interface; just 2 Ethernet (1 of which has no IP address and hence
</span><br>
<span class="quotelev3">&gt;&gt;&gt; is unusable) plus 1 proprietary interface that currently supports only IP
</span><br>
<span class="quotelev3">&gt;&gt;&gt; traffic. The two IP interfaces (Ethernet and proprietary) are on different
</span><br>
<span class="quotelev3">&gt;&gt;&gt; IP subnets.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; MPI_Send(host, strlen(host) + 1, MPI_CHAR, 1, 1, MPI_COMM_WORLD);
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; MPI_Recv(host,  4, MPI_CHAR, 0, 1, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; This program, when run between two nodes, hangs. The command was:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [durga_at_b-1 ~]$ mpirun -np 2 -hostfile ~/hostfile -mca btl self,tcp -mca
</span><br>
<span class="quotelev3">&gt;&gt;&gt; pml ob1 -mca btl_tcp_if_include eno1 ./mpitest
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; And the hang is with the following output: (eno1 is one of the gigEth
</span><br>
<span class="quotelev3">&gt;&gt;&gt; interfaces, that takes OOB traffic as well)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Note that if I uncomment the #if 0 - #endif (i.e. comment out the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; MPI_Send()/MPI_Recv() part, the program runs to completion. Also note that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the printfs following MPI_Send()/MPI_Recv() do not show up on console.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Upon attaching gdb, the stack trace from the master node is as follows:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #3  0x00007f72a4c4e692 in opal_progress () at runtime/opal_progress.c:171
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #5  0x00007f72a0d07ca2 in ompi_request_wait_completion (req=0x113eb80)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     at ../../../../ompi/request/request.h:383
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #6  0x00007f72a0d09cd5 in mca_pml_ob1_send (buf=0x7fff81057db0, count=4,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #8  0x0000000000400afa in main (argc=1, argv=0x7fff81057f18) at
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #2  0x00007ff3b0c922de in OPAL_PMIX_PMIX120_PMIx_Fence (procs=0x0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; nprocs=0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     info=0x0, ninfo=0) at src/client/pmix_client_fence.c:100
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #3  0x00007ff3b0c5f1a6 in pmix120_fence (procs=0x0, collect_data=0)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #6  0x0000000000400958 in main (argc=1, argv=0x7fff785e8788) at
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; And the ifconfig output from the master node is as follows (the other
</span><br>
<span class="quotelev3">&gt;&gt;&gt; node is similar; all the IP interfaces are in their respective subnets) :
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;         inet 10.4.70.10  netmask 255.255.255.0  broadcast 10.4.70.255
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         inet6 fe80::21e:c9ff:fefe:13df  prefixlen 64  scopeid 0x20&lt;link&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;         inet 192.168.1.2  netmask 255.255.255.0  broadcast 192.168.1.255
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         inet6 fe80::3002:ff:fe33:3333  prefixlen 64  scopeid 0x20&lt;link&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Please help me with this. I am stuck with the TCP transport, which is
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the most basic of all transports.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; This is quite unlikely, and fwiw, your test program works for me.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; i suggest you check your 3 TCP networks are usable, for example
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $ mpirun -np 2 -hostfile ~/hostfile -mca btl self,tcp -mca pml ob1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --mca btl_tcp_if_include xxx ./mpitest
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; btw, are your 3 interfaces in 3 different subnet ? is routing required
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; between two interfaces of the same type ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I have reported this issue before, but then had brushed it off as
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; something that was caused by my modifications to the source tree. It looks
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; like that is not the case.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 2. Configured with the following flags, built and installed it in my
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; two-node &quot;cluster&quot;.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --enable-debug --enable-debug-symbols --disable-dlopen
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 3. Compiled the following program, mpitest.c with these flags: -g3
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -Wall -Wextra
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; With this, the code hangs at MPI_Barrier() on both nodes, after
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; generating the following output:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Attaching to the hung process at one node gives the following backtrace:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #2  0x00007f55b03c4a90 in opal_libevent2022_event_base_loop
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (base=0x70e7b0, flags=2) at event.c:1630
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #3  0x00007f55b02f0144 in opal_progress () at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; runtime/opal_progress.c:171
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #4  0x00007f55b14b4d8b in opal_condition_wait (c=0x7f55b19fec40
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;ompi_request_cond&gt;, m=0x7f55b19febc0 &lt;ompi_request_lock&gt;) at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ../opal/threads/condition.h:76
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #5  0x00007f55b14b531b in ompi_request_default_wait_all (count=2,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; requests=0x7ffd1bb55370, statuses=0x7ffd1bb55340) at request/req_wait.c:287
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #6  0x00007f55b157a225 in ompi_coll_base_sendrecv_zero (dest=1,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #7  0x00007f55b157a92a in ompi_coll_base_barrier_intra_two_procs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (comm=0x601280 &lt;ompi_mpi_comm_world&gt;, module=0x7c2630) at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; base/coll_base_barrier.c:308
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #8  0x00007f55b15aafec in ompi_coll_tuned_barrier_intra_dec_fixed
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (comm=0x601280 &lt;ompi_mpi_comm_world&gt;, module=0x7c2630) at
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #10 0x0000000000400b0b in main (argc=1, argv=0x7ffd1bb55658) at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpitest.c:26
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Thinking that this might be a bug in tuned collectives, since that is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; what the stack shows, I ran the program like this (basically adding the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ^tuned part)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [durga_at_smallMPI ~]$ mpirun -np 2 -hostfile ~/hostfile -mca btl
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; self,tcp -mca pml ob1 -mca coll ^tuned ./mpitest
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #2  0x00007f910c80da90 in opal_libevent2022_event_base_loop
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (base=0x1a317b0, flags=2) at event.c:1630
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #3  0x00007f910c739144 in opal_progress () at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; runtime/opal_progress.c:171
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #4  0x00007f910db130f7 in opal_condition_wait (c=0x7f910de47c40
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;ompi_request_cond&gt;, m=0x7f910de47bc0 &lt;ompi_request_lock&gt;)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     at ../../../../opal/threads/condition.h:76
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #5  0x00007f910db132d8 in ompi_request_wait_completion (req=0x1b07680)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; at ../../../../ompi/request/request.h:383
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #6  0x00007f910db1533b in mca_pml_ob1_send (buf=0x0, count=0,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; datatype=0x7f910de1e340 &lt;ompi_mpi_byte&gt;, dst=1, tag=-16,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; sendmode=MCA_PML_BASE_SEND_STANDARD,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     comm=0x601280 &lt;ompi_mpi_comm_world&gt;) at pml_ob1_isend.c:259
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #7  0x00007f910d9c3b38 in ompi_coll_base_barrier_intra_basic_linear
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (comm=0x601280 &lt;ompi_mpi_comm_world&gt;, module=0x1b092c0) at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; base/coll_base_barrier.c:368
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #8  0x00007f910d91c6fd in PMPI_Barrier (comm=0x601280
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;ompi_mpi_comm_world&gt;) at pbarrier.c:63
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #9  0x0000000000400b0b in main (argc=1, argv=0x7fff43ee3a58) at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpitest.c:26
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb)
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The two nodes are connected by three physical and 3 logical networks:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Physical: Gigabit Ethernet, 10G iWARP, 20G Infiniband
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Logical: IP (all 3), PSM (Qlogic Infiniband), Verbs (iWARP and
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Is this a bug (perhaps a side effect of --disable-dlopen) or something
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I am doing wrong?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28949/attachment">attachment</a>
</ul>
