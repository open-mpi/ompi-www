...
?>
<!-- received="Sun Apr 24 22:03:44 2016" -->
<!-- isoreceived="20160425020344" -->
<!-- sent="Mon, 25 Apr 2016 11:03:37 +0900" -->
<!-- isosent="20160425020337" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Cannot run a simple MPI program" -->
<!-- id="36e15c51-b903-eb98-8fb1-39d96166be80_at_rist.or.jp" -->
...
<strong>Date:</strong> 2016-04-24 22:03:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29024.php">Dave Love: "Re: [OMPI users] MPI_Bcast implementations in OpenMPI"</a>
<li><strong>Previous message:</strong> <a href="29022.php">dpchoudh .: "Re: [OMPI users] Cannot run a simple MPI program"</a>
<li><strong>In reply to:</strong> <a href="29020.php">dpchoudh .: "Re: [OMPI users] Cannot run a simple MPI program"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29027.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Cannot run a simple MPI program"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>since the link is down, the psm component should simply disqualify itself,
<br>
<p>it will follow-up this on the devel ML
<br>
<p><p>Cheers,
<br>
<p><p>Gilles
<br>
<p><p>On 4/25/2016 10:36 AM, dpchoudh . wrote:
<br>
<span class="quotelev1">&gt; Hello Gilles
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Thank you for finding the bug; it was not there in the original code; 
</span><br>
<span class="quotelev1">&gt; I added it while trying to 'simplify' the code.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; With the bug fixed, the code now runs in the last scenario. But it 
</span><br>
<span class="quotelev1">&gt; still hangs with the following command line (even after updating to 
</span><br>
<span class="quotelev1">&gt; latest git tree, rebuilding and reinstalling):
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; #5  0x00007f4e4c52ef6b in mca_pml_cm_add_procs (procs=0x23bb420, 
</span><br>
...
<span class="quotelev1">&gt; As you can see, OMPI is trying the PSM link to communicate, even 
</span><br>
<span class="quotelev1">&gt; though the link is down and it is not mentioned in the arguments to 
</span><br>
<span class="quotelev1">&gt; mpirun. (There are not even multiple nodes mentioned in the arguments.)
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Sun, Apr 24, 2016 at 8:12 PM, Gilles Gouaillardet 
</span><br>
<span class="quotelev1">&gt; &lt;gilles_at_[hidden] &lt;mailto:gilles_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;     two comments :
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;     - the program is incorrect : slave() should MPI_Recv(...,
</span><br>
...
<span class="quotelev1">&gt;       so your master is out of sync, or pmix120 is an old module that
</span><br>
<span class="quotelev1">&gt;     was not manually removed.
</span><br>
...
<span class="quotelev2">&gt;&gt;     Attached is a simple MPI program (a modified version of a similar
</span><br>
<span class="quotelev2">&gt;&gt;     program that was posted by another user). This program, when run
</span><br>
<span class="quotelev2">&gt;&gt;     on a single node machine, hangs most of the time, as follows: (in
</span><br>
<span class="quotelev2">&gt;&gt;     all cases, OS was CentOS 7)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;     Scenario 1: OMPI v 1.10, single socket quad core machine, with
</span><br>
<span class="quotelev2">&gt;&gt;     Chelsio T3 card, link down, and GigE, link up
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     #1  0x00007f6475c6722a in opal_progress () at
</span><br>
<span class="quotelev2">&gt;&gt;     runtime/opal_progress.c:187
</span><br>
...
<span class="quotelev2">&gt;&gt;     #3  ompi_request_default_wait_all (count=2,
</span><br>
<span class="quotelev2">&gt;&gt;     requests=0x7ffd1d921530, statuses=0x7ffd1d921540)
</span><br>
<span class="quotelev2">&gt;&gt;         at request/req_wait.c:281
</span><br>
<span class="quotelev2">&gt;&gt;     #4  0x00007f64709dd591 in ompi_coll_tuned_sendrecv_zero
</span><br>
<span class="quotelev2">&gt;&gt;     (stag=-16, rtag=-16,
</span><br>
<span class="quotelev2">&gt;&gt;         comm=&lt;optimized out&gt;, source=1, dest=1) at
</span><br>
<span class="quotelev2">&gt;&gt;     coll_tuned_barrier.c:78
</span><br>
...
<span class="quotelev2">&gt;&gt;     #1  0x00007feeae7dc22a in opal_progress () at
</span><br>
<span class="quotelev2">&gt;&gt;     runtime/opal_progress.c:187
</span><br>
...
<span class="quotelev2">&gt;&gt;         src=&lt;optimized out&gt;, tag=&lt;optimized out&gt;, comm=&lt;optimized
</span><br>
<span class="quotelev2">&gt;&gt;     out&gt;, status=0x7fff4a618000)
</span><br>
...
<span class="quotelev2">&gt;&gt;         type=0x6020c0 &lt;ompi_mpi_char&gt;, source=&lt;optimized out&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;     tag=&lt;optimized out&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;         comm=0x6022c0 &lt;ompi_mpi_comm_world&gt;, status=0x7fff4a618000)
</span><br>
...
<span class="quotelev2">&gt;&gt;     Dual socket Hexcore machine with Qlogic IB, Chelsio iWARP and
</span><br>
<span class="quotelev2">&gt;&gt;     Fibre Channel, all link down, GigE, link up, OpenMPI compiled
</span><br>
<span class="quotelev2">&gt;&gt;     from master branch, crashes as follows:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     mpirun noticed that process rank 0 with PID 0 on node smallMPI
</span><br>
...
<span class="quotelev2">&gt;&gt;     Exactly same as scenario 2, but with command line more explicit
</span><br>
...
<span class="quotelev2">&gt;&gt;     #2  0x00007ff662f72796 in OPAL_PMIX_PMIX120_PMIx_Fence
</span><br>
<span class="quotelev2">&gt;&gt;     (procs=0x0, nprocs=0, info=0x0, ninfo=0)
</span><br>
<span class="quotelev2">&gt;&gt;         at src/client/pmix_client_fence.c:100
</span><br>
<span class="quotelev2">&gt;&gt;     #3  0x00007ff662f4f0bc in pmix120_fence (procs=0x0,
</span><br>
<span class="quotelev2">&gt;&gt;     collect_data=0) at pmix120_client.c:255
</span><br>
<span class="quotelev2">&gt;&gt;     #4  0x00007ff663f941af in ompi_mpi_init (argc=1,
</span><br>
<span class="quotelev2">&gt;&gt;     argv=0x7ffc18c9afd8, requested=0, provided=0x7ffc18c9adac)
</span><br>
...
<span class="quotelev2">&gt;&gt;     #4  0x00007f5af7d94a69 in ompi_mtl_psm_add_procs
</span><br>
<span class="quotelev2">&gt;&gt;     (mtl=0x7f5af80f8500 &lt;ompi_mtl_psm&gt;, nprocs=2, procs=0xf53e60)
</span><br>
<span class="quotelev2">&gt;&gt;         at mtl_psm.c:312
</span><br>
<span class="quotelev2">&gt;&gt;     #5  0x00007f5af7df3630 in mca_pml_cm_add_procs (procs=0xf53e60,
</span><br>
<span class="quotelev2">&gt;&gt;     nprocs=2) at pml_cm.c:134
</span><br>
<span class="quotelev2">&gt;&gt;     #6  0x00007f5af7bcc0d1 in ompi_mpi_init (argc=1,
</span><br>
<span class="quotelev2">&gt;&gt;     argv=0x7ffc485a2f98, requested=0, provided=0x7ffc485a2d6c)
</span><br>
...
<span class="quotelev2">&gt;&gt;     This seems to suggest that it is trying PSM to connect even when
</span><br>
<span class="quotelev2">&gt;&gt;     the link was down and it was not mentioned in the command line.
</span><br>
<span class="quotelev2">&gt;&gt;     Is this behavior expected?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt;     [durga_at_smallMPI Desktop]$ mpirun -np 2 -mca btl self,sm -mca pml
</span><br>
<span class="quotelev2">&gt;&gt;     ob1 ./mpi_hello_master_slave
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;     This hangs towards the end, after printing the output (as opposed
</span><br>
<span class="quotelev2">&gt;&gt;     to scenario 3 where it hangs at the connection setup stage,
</span><br>
<span class="quotelev2">&gt;&gt;     without printing anything.)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     #1  0x00007f10f46e50e4 in opal_progress () at
</span><br>
<span class="quotelev2">&gt;&gt;     runtime/opal_progress.c:161
</span><br>
...
<span class="quotelev2">&gt;&gt;     #4  0x00007f10f596f225 in ompi_coll_base_sendrecv_zero (dest=1,
</span><br>
<span class="quotelev2">&gt;&gt;     stag=-16, source=1, rtag=-16,
</span><br>
<span class="quotelev2">&gt;&gt;         comm=0x6022c0 &lt;ompi_mpi_comm_world&gt;) at
</span><br>
<span class="quotelev2">&gt;&gt;     base/coll_base_barrier.c:63
</span><br>
...
<span class="quotelev2">&gt;&gt;     #2  0x00007f704b4deea5 in opal_timer_base_get_usec_clock_gettime
</span><br>
<span class="quotelev2">&gt;&gt;     () at timer_linux_component.c:183
</span><br>
<span class="quotelev2">&gt;&gt;     #3  0x00007f704b2f50e4 in opal_progress () at
</span><br>
<span class="quotelev2">&gt;&gt;     runtime/opal_progress.c:161
</span><br>
...
<span class="quotelev2">&gt;&gt;     #5  0x00007f704c6cc560 in ompi_request_wait_completion
</span><br>
<span class="quotelev2">&gt;&gt;     (req=0x165e580) at ../../../../ompi/request/request.h:383
</span><br>
...
<span class="quotelev2">&gt;&gt;     #7  0x00007f704c4ff434 in PMPI_Recv (buf=0x7fffe9cafa10,
</span><br>
<span class="quotelev2">&gt;&gt;     count=255, type=0x6020c0 &lt;ompi_mpi_char&gt;, source=0,
</span><br>
<span class="quotelev2">&gt;&gt;         tag=1, comm=0x6022c0 &lt;ompi_mpi_comm_world&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;     status=0x7fffe9caf9f0) at precv.c:79
</span><br>
...
<span class="quotelev2">&gt;&gt;     I am going to try the tarball shortly, but hopefully someone can
</span><br>
<span class="quotelev2">&gt;&gt;     get some insight out of this much information. BTW, the code was
</span><br>
<span class="quotelev2">&gt;&gt;     compiled with the following flags:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     Let me rehash that NO network communication was involved in any
</span><br>
<span class="quotelev2">&gt;&gt;     of these experiments; they were all single node shared memory (sm
</span><br>
<span class="quotelev2">&gt;&gt;     btl) jobs.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/04/29020.php">http://www.open-mpi.org/community/lists/users/2016/04/29020.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29023/attachment">attachment</a>
</ul>
