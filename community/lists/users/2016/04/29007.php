...
?>
<!-- received="Sat Apr 23 11:04:03 2016" -->
<!-- isoreceived="20160423150403" -->
<!-- sent="Sat, 23 Apr 2016 15:03:55 +0000" -->
<!-- isosent="20160423150355" -->
<!-- name="Elio Physics" -->
<!-- email="Elio-Physics_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPIRUN SEGMENTATION FAULT" -->
<!-- id="BLUPR10MB0754FBA8620B608F070C0555EA600_at_BLUPR10MB0754.namprd10.prod.outlook.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="571B8B70.4080404_at_hpe.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-23 11:03:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29008.php">Ralph Castain: "Re: [OMPI users] MPIRUN SEGMENTATION FAULT"</a>
<li><strong>Previous message:</strong> <a href="29006.php">Andy Riebs: "Re: [OMPI users] MPIRUN SEGMENTATION FAULT"</a>
<li><strong>In reply to:</strong> <a href="29006.php">Andy Riebs: "Re: [OMPI users] MPIRUN SEGMENTATION FAULT"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29008.php">Ralph Castain: "Re: [OMPI users] MPIRUN SEGMENTATION FAULT"</a>
<li><strong>Reply:</strong> <a href="29008.php">Ralph Castain: "Re: [OMPI users] MPIRUN SEGMENTATION FAULT"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
From: users &lt;users-bounces_at_[hidden]&gt; on behalf of Andy Riebs &lt;andy.riebs_at_[hidden]&gt;
<br>
...
<br>
<p>I am not really an expert with gdb. What is the core file? and how to use gdb? I have got three files as an output when the executable is used. One is the actual output which stops and the other two are error files (from which I knew about the segmentation fault).
<br>
<p><p><p>thanks
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29007/attachment">attachment</a>
</ul>
