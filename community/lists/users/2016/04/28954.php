...
?>
<!-- received="Mon Apr 18 08:04:19 2016" -->
<!-- isoreceived="20160418120419" -->
<!-- sent="Mon, 18 Apr 2016 14:04:16 +0200" -->
<!-- isosent="20160418120416" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI users] Possible bug in MPI_Barrier() ?" -->
<!-- id="CAMJJpkW2K=So4ghnE5y0VVxdG0d6f9UbHhj-d0tTD+cwKf7AEg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="98kk8voajs7t8dly4x7hehji.1460970336733_at_email.android.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-18 08:04:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28955.php">Farid Parpia: "[OMPI users] LSF's LSB_PJL_TASK_GEOMETRY + OpenMPI 1.10.2"</a>
<li><strong>Previous message:</strong> <a href="28953.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] Possible bug in MPI_Barrier() ?"</a>
<li><strong>In reply to:</strong> <a href="28951.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] Possible bug in MPI_Barrier() ?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28957.php">dpchoudh .: "Re: [OMPI users] OMPI users] Possible bug in MPI_Barrier() ?"</a>
<li><strong>Reply:</strong> <a href="28957.php">dpchoudh .: "Re: [OMPI users] OMPI users] Possible bug in MPI_Barrier() ?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Durga,
<br>
<p>Can you run a simple netpipe over TCP using any of the two interfaces you
<br>
mentioned?
<br>
<p>George
...
<br>
<p><span class="quotelev1">&gt; An other test is to swap the hostnames.
</span><br>
...
<span class="quotelev1">&gt; Gilles Gouaillardet &lt;gilles_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; on both nodes. But that did not make a difference. I will try your tarball
</span><br>
<span class="quotelev1">&gt; build suggestion a bit later.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Mon, Apr 18, 2016 at 1:21 AM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Thank you very much for your feedback. You are right that my original
</span><br>
<span class="quotelev2">&gt;&gt; stack trace was on code that was several weeks behind, but updating it just
</span><br>
<span class="quotelev2">&gt;&gt; now did not seem to make a difference: I am copying the stack from the
</span><br>
<span class="quotelev2">&gt;&gt; latest code below:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; #3  0x00007fc051de9a00 in opal_progress () at runtime/opal_progress.c:171
</span><br>
...
<span class="quotelev2">&gt;&gt; #5  0x00007fc04ce46cec in ompi_request_wait_completion (req=0x1b7b580)
</span><br>
<span class="quotelev2">&gt;&gt;     at ../../../../ompi/request/request.h:383
</span><br>
<span class="quotelev2">&gt;&gt; #6  0x00007fc04ce48d4f in mca_pml_ob1_send (buf=0x7fff29fcb480, count=4,
</span><br>
...
<span class="quotelev2">&gt;&gt; #2  0x00007fad296412de in OPAL_PMIX_PMIX120_PMIx_Fence (procs=0x0,
</span><br>
<span class="quotelev2">&gt;&gt; nprocs=0, info=0x0, ninfo=0)
</span><br>
<span class="quotelev2">&gt;&gt;     at src/client/pmix_client_fence.c:100
</span><br>
<span class="quotelev2">&gt;&gt; #3  0x00007fad2960e1a6 in pmix120_fence (procs=0x0, collect_data=0) at
</span><br>
<span class="quotelev2">&gt;&gt; pmix120_client.c:258
</span><br>
...
<span class="quotelev2">&gt;&gt; I double checked to ensure that there is not an older installation of
</span><br>
<span class="quotelev2">&gt;&gt; OpenMPI that is getting mixed up with the master branch.
</span><br>
...
<span class="quotelev2">&gt;&gt; libraries are coming from /usr/local/lib, which seems to be correct. I
</span><br>
<span class="quotelev2">&gt;&gt; am also quite sure about the firewall issue (that there is none). I will
</span><br>
<span class="quotelev2">&gt;&gt; try out your suggestion on installing from a tarball and see how it goes.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On Mon, Apr 18, 2016 at 12:47 AM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; that would be line 259 in current master, and this file was updated 21
</span><br>
<span class="quotelev3">&gt;&gt;&gt; days ago
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and that suggests your master is not quite up to date.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; even if the message is sent eagerly, the ob1 pml does use an internal
</span><br>
<span class="quotelev3">&gt;&gt;&gt; request it will wait for.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; btw, did you configure with --enable-mpi-thread-multiple ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; did you configure with --enable-mpirun-prefix-by-default ?
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; using a new install dir, and check if the issue is still here or not.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; there could be some side effects if some old modules were not removed
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and/or if you are
</span><br>
<span class="quotelev3">&gt;&gt;&gt; not using the modules you expect.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /* when it hangs, you can pmap &lt;pid&gt; and check the path of the openmpi
</span><br>
<span class="quotelev3">&gt;&gt;&gt; libraries are the one you expect */
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; what if you do not send/recv but invoke MPI_Barrier multiple times ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; what if you send/recv a one byte message instead ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; did you double check there is no firewall running on your nodes ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Thank you for your suggestion, Ralph. But it did not make any difference.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Let me say that my code is about a week stale. I just did a git pull and
</span><br>
<span class="quotelev3">&gt;&gt;&gt; am building it right now. The build takes quite a bit of time, so I avoid
</span><br>
<span class="quotelev3">&gt;&gt;&gt; doing that unless there is a reason. But what I am trying out is the most
</span><br>
<span class="quotelev3">&gt;&gt;&gt; basic functionality, so I'd think a week or so of lag would not make a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; difference.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Does the stack trace suggest something to you? It seems that the send
</span><br>
<span class="quotelev3">&gt;&gt;&gt; hangs; but a 4 byte send should be sent eagerly.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Sun, Apr 17, 2016 at 11:55 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Try adding -mca oob_tcp_if_include eno1 to your cmd line and see if
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; that makes a difference
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Apr 17, 2016, at 8:43 PM, dpchoudh . &lt;dpchoudh_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I am sorry to be bugging the developers, but this issue seems to be
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; nagging me, and I am surprised it does not seem to affect anybody else. But
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; then again, I am using the master branch, and most users are probably using
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; a released version.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; This time I am using a totally different cluster. This has NO verbs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; capable interface; just 2 Ethernet (1 of which has no IP address and hence
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is unusable) plus 1 proprietary interface that currently supports only IP
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; traffic. The two IP interfaces (Ethernet and proprietary) are on different
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; IP subnets.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_Send(host, strlen(host) + 1, MPI_CHAR, 1, 1, MPI_COMM_WORLD);
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_Recv(host,  4, MPI_CHAR, 0, 1, MPI_COMM_WORLD, MPI_STATUS_IGNORE);
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; This program, when run between two nodes, hangs. The command was:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [durga_at_b-1 ~]$ mpirun -np 2 -hostfile ~/hostfile -mca btl self,tcp
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -mca pml ob1 -mca btl_tcp_if_include eno1 ./mpitest
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; And the hang is with the following output: (eno1 is one of the gigEth
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; interfaces, that takes OOB traffic as well)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Note that if I uncomment the #if 0 - #endif (i.e. comment out the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_Send()/MPI_Recv() part, the program runs to completion. Also note that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the printfs following MPI_Send()/MPI_Recv() do not show up on console.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Upon attaching gdb, the stack trace from the master node is as follows:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #2  0x00007f72a4caede0 in opal_libevent2022_event_base_loop
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (base=0xee33d0,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #5  0x00007f72a0d07ca2 in ompi_request_wait_completion (req=0x113eb80)
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #7  0x00007f72a58d6be3 in PMPI_Send (buf=0x7fff81057db0, count=4,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #8  0x0000000000400afa in main (argc=1, argv=0x7fff81057f18) at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpitest.c:19
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #2  0x00007ff3b0c922de in OPAL_PMIX_PMIX120_PMIx_Fence (procs=0x0,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; nprocs=0,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     info=0x0, ninfo=0) at src/client/pmix_client_fence.c:100
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; #3  0x00007ff3b0c5f1a6 in pmix120_fence (procs=0x0, collect_data=0)
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #6  0x0000000000400958 in main (argc=1, argv=0x7fff785e8788) at
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpitest.c:30
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; And the ifconfig output from the master node is as follows (the other
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; node is similar; all the IP interfaces are in their respective subnets) :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         inet 10.4.70.10  netmask 255.255.255.0  broadcast 10.4.70.255
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         inet6 fe80::21e:c9ff:fefe:13df  prefixlen 64  scopeid 0x20&lt;link&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         TX errors 0  dropped 0 overruns 0  carrier 0  collisions 0
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         inet 192.168.1.2  netmask 255.255.255.0  broadcast 192.168.1.255
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         inet6 fe80::3002:ff:fe33:3333  prefixlen 64  scopeid 0x20&lt;link&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Please help me with this. I am stuck with the TCP transport, which is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the most basic of all transports.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Tue, Apr 12, 2016 at 9:32 PM, Gilles Gouaillardet &lt;gilles_at_[hidden]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; --mca btl_tcp_if_include xxx ./mpitest
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Attaching to the hung process at one node gives the following
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; what the stack shows, I ran the program like this (basically adding the
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Logical: IP (all 3), PSM (Qlogic Infiniband), Verbs (iWARP and
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28954/attachment">attachment</a>
</ul>
