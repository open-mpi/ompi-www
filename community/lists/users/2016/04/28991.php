...
?>
<!-- received="Thu Apr 21 11:52:36 2016" -->
<!-- isoreceived="20160421155236" -->
<!-- sent="Thu, 21 Apr 2016 17:52:18 +0200" -->
<!-- isosent="20160421155218" -->
<!-- name="Siegmar Gross" -->
<!-- email="siegmar.gross_at_[hidden]" -->
<!-- subject="Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8" -->
<!-- id="db520be8-9789-60e9-274b-01dfd3cc99aa_at_informatik.hs-fulda.de" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="5E3449FD-6E78-4E9D-9FA7-24BBD342CC7E_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-21 11:52:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28992.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<li><strong>Previous message:</strong> <a href="28990.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<li><strong>In reply to:</strong> <a href="28990.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28992.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<li><strong>Reply:</strong> <a href="28992.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>I don't see any additional information.
<br>
<p>tyr hello_1 108 mpiexec -np 4 --host tyr,sunpc1,linpc1,ruester -mca 
<br>
...
--------------------------------------------------------------------------
<br>
<p><p>tyr hello_1 109 mpiexec -np 4 --host tyr,sunpc1,linpc1,ruester -mca 
<br>
mca_base_component_show_load_errors 1 -mca pmix_base_verbose 10 -mca 
<br>
pmix_server_verbose 5 hello_1_mpi
<br>
[tyr.informatik.hs-fulda.de:06212] mca: base: components_register: registering 
<br>
...
components
<br>
[tyr.informatik.hs-fulda.de:06212] mca:base:select: Auto-selecting pmix components
<br>
[tyr.informatik.hs-fulda.de:06212] mca:base:select:( pmix) No component selected!
<br>
...
<p>Siegmar
<br>
<p><p>Am 21.04.2016 um 17:24 schrieb Ralph Castain:
<br>
<span class="quotelev1">&gt; Hmmm&#133;it looks like you built the right components, but they are not being picked up. Can you run your mpiexec command again, adding &#147;-mca mca_base_component_show_load_errors 1&#148; to the cmd line?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Apr 21, 2016, at 8:16 AM, Siegmar Gross &lt;siegmar.gross_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; I have attached ompi_info output for both compilers from my
</span><br>
<span class="quotelev2">&gt;&gt; sparc machine and the listings for both compilers from the
</span><br>
<span class="quotelev2">&gt;&gt; &lt;prefix&gt;/lib/openmpi directories. Hopefully that helps to
</span><br>
...
<span class="quotelev2">&gt;&gt; -rw-r--r-- root/root     10969 2016-04-21 17:06 ompi_info_SunOS_sparc_cc.txt
</span><br>
<span class="quotelev2">&gt;&gt; -rw-r--r-- root/root     11044 2016-04-21 17:06 ompi_info_SunOS_sparc_gcc.txt
</span><br>
<span class="quotelev2">&gt;&gt; -rw-r--r-- root/root     71252 2016-04-21 17:02 lib64_openmpi.txt
</span><br>
...
<span class="quotelev2">&gt;&gt; Kind regards and thank you very much once more for your help
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Odd - it would appear that none of the pmix components built? Can you send
</span><br>
<span class="quotelev3">&gt;&gt;&gt; along the output from ompi_info? Or just send a listing of the files in the
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Could you please rerun these test and add &#147;-mca pmix_base_verbose 10
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -mca pmix_server_verbose 5&#148; to your cmd line? I need to see why the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; tyr spawn 111 mpiexec -np 1 --host tyr,sunpc1,linpc1,ruester -mca
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; pmix_base_verbose 10 -mca pmix_server_verbose 5 spawn_multiple_master
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;:26652] mca:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; base: components_register: registering framework pmix components
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;:26652] mca:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; base: components_open: opening pmix components
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;:26652]
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; tyr hello_1 116 mpiexec -np 1 --host tyr,sunpc1,linpc1,ruester -mca
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; pmix_base_verbose 10 -mca pmix_server_verbose 5 hello_1_mpi
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;:27261] mca:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; base: components_register: registering framework pmix components
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;:27261] mca:
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;:27261]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mca:base:select: Auto-selecting pmix components
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de/">http://tyr.informatik.hs-fulda.de/</a>&gt;:27261]
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Apr 20, 2016, at 10:12 AM, Siegmar Gross
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de">http://tyr.informatik.hs-fulda.de</a>&gt;:22373]
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [[61763,0],0] ORTE_ERROR_LOG: Not found in file
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; tyr spawn 121 mpiexec -np 1 --host tyr,sunpc1,linpc1,ruester
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de">http://tyr.informatik.hs-fulda.de</a>&gt;:25366]
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [tyr:25377] *** MPI_ERRORS_ARE_FATAL (processes in this communicator will
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; post: <a href="http://www.open-mpi.org/community/lists/users/2016/04/28986.php">http://www.open-mpi.org/community/lists/users/2016/04/28986.php</a>
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; post: <a href="http://www.open-mpi.org/community/lists/users/2016/04/28987.php">http://www.open-mpi.org/community/lists/users/2016/04/28987.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/04/28988.php">http://www.open-mpi.org/community/lists/users/2016/04/28988.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/04/28989.php">http://www.open-mpi.org/community/lists/users/2016/04/28989.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/04/28990.php">http://www.open-mpi.org/community/lists/users/2016/04/28990.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<!-- body="end" -->
