...
?>
<!-- received="Fri Apr 29 10:28:04 2016" -->
<!-- isoreceived="20160429142804" -->
<!-- sent="Fri, 29 Apr 2016 23:27:59 +0900" -->
<!-- isosent="20160429142759" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8" -->
<!-- id="CAAkFZ5ueW3F8pi+OzgbDDgfBQmmXKR8+LzNfF7Omj34xUPaGcg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="830B404A-B4CD-4EF3-8F68-218471CD598D_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-04-29 10:27:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29052.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<li><strong>Previous message:</strong> <a href="29050.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<li><strong>In reply to:</strong> <a href="29050.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29052.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<li><strong>Reply:</strong> <a href="29052.php">Ralph Castain: "Re: [OMPI users] runtime errors for openmpi-v2.x-dev-1280-gc110ae8"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>as a matter of taste, I'd rather replace all app[i]. with app-&gt;
<br>
and
<br>
app++;
...
<p>Gilles
<br>
<p><p>On Friday, April 29, 2016, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Hmmm&#226;&#128;&#166;well, I may have to wait and let Gilles fix this. So far as I can
</span><br>
<span class="quotelev1">&gt; see, the code in the current OMPI 2.x tarball (and upstream) is correct:
</span><br>
...
<span class="quotelev1">&gt;         if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_string(buffer,
</span><br>
<span class="quotelev1">&gt; &amp;app[i].cmd, 1, PMIX_STRING))) {
</span><br>
...
<span class="quotelev1">&gt;         if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_int(buffer,
</span><br>
<span class="quotelev1">&gt; &amp;app[i].argc, 1, PMIX_INT))) {
</span><br>
<span class="quotelev1">&gt;             return ret;
</span><br>
<span class="quotelev1">&gt;         }
...
<span class="quotelev1">&gt; &amp;app[i].argv[j], 1, PMIX_STRING))) {
</span><br>
<span class="quotelev1">&gt;                 return ret;
</span><br>
<span class="quotelev1">&gt;             }
...
<span class="quotelev1">&gt;         if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_int32(buffer, &amp;nvals,
</span><br>
<span class="quotelev1">&gt; 1, PMIX_INT32))) {
</span><br>
<span class="quotelev1">&gt;             return ret;
</span><br>
<span class="quotelev1">&gt;         }
...
<span class="quotelev1">&gt; &amp;app[i].env[j], 1, PMIX_STRING))) {
</span><br>
<span class="quotelev1">&gt;                 return ret;
</span><br>
<span class="quotelev1">&gt;             }
...
<span class="quotelev1">&gt; &amp;app[i].maxprocs, 1, PMIX_INT))) {
</span><br>
<span class="quotelev1">&gt;             return ret;
</span><br>
<span class="quotelev1">&gt;         }
...
<span class="quotelev1">&gt;         if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_sizet(buffer,
</span><br>
<span class="quotelev1">&gt; &amp;app[i].ninfo, 1, PMIX_SIZE))) {
</span><br>
<span class="quotelev1">&gt;             return ret;
</span><br>
<span class="quotelev1">&gt;         }
...
<span class="quotelev1">&gt;             if (PMIX_SUCCESS != (ret = pmix_bfrop_pack_info(buffer,
</span><br>
<span class="quotelev1">&gt; app[i].info, app[i].ninfo, PMIX_INFO))) {
</span><br>
<span class="quotelev1">&gt;                 return ret;
</span><br>
<span class="quotelev1">&gt;             }
...
<span class="quotelev1">&gt; On Apr 28, 2016, at 11:08 PM, Siegmar Gross &lt;
</span><br>
...
<span class="quotelev1">&gt;    SunOS tyr.informatik.hs-fulda.de &lt;<a href="http://tyr.informatik.hs-fulda.de">http://tyr.informatik.hs-fulda.de</a>&gt;
</span><br>
...
<span class="quotelev1">&gt;    [tyr.informatik.hs-fulda.de:27286
</span><br>
<span class="quotelev1">&gt;    &lt;<a href="http://tyr.informatik.hs-fulda.de:27286">http://tyr.informatik.hs-fulda.de:27286</a>&gt;] PMIX ERROR: UNPACK-PAST-END
</span><br>
...
<span class="quotelev1">&gt;        Shall I add it permanently to my configure command or will you add
</span><br>
...
<span class="quotelev1">&gt;        yesterday for my gcc-version of Open MPI. Hopefully you can solve
</span><br>
<span class="quotelev1">&gt; the
</span><br>
...
<span class="quotelev1">&gt;            &quot;/usr/include/stdbool.h&quot;, line 42: #error: &quot;Use of &lt;stdbool.h&gt;
</span><br>
...
<span class="quotelev1">&gt;                timestamps. The other problem was that Ralph didn't
</span><br>
<span class="quotelev1">&gt; recognize
</span><br>
...
<span class="quotelev1">&gt;                down the problem. I still get an error running one of my
</span><br>
...
<span class="quotelev1">&gt;                $(MCA_opal_if_ALL_SUBDIRS)
</span><br>
<span class="quotelev1">&gt; $(MCA_opal_installdirs_ALL_SUBDIRS)
</span><br>
...
<span class="quotelev1">&gt;                $(MCA_opal_if_DSO_SUBDIRS)
</span><br>
<span class="quotelev1">&gt; $(MCA_opal_installdirs_DSO_SUBDIRS)
</span><br>
...
<span class="quotelev1">&gt;                mca/backtrace/libmca_backtrace.la
</span><br>
...
<span class="quotelev1">&gt;    &lt;<a href="http://libmca_btl.la">http://libmca_btl.la</a>&gt; &lt;<a href="http://libmca_btl.la">http://libmca_btl.la</a>&gt;
</span><br>
...
<span class="quotelev1">&gt;    mca/installdirs/libmca_installdirs.la &lt;<a href="http://libmca_installdirs.la">http://libmca_installdirs.la</a>&gt;
</span><br>
...
<span class="quotelev1">&gt;    &lt;<a href="http://libmca_memchecker.la">http://libmca_memchecker.la</a>&gt;
</span><br>
<span class="quotelev1">&gt;                $(MCA_opal_memchecker_STATIC_LTLIBS)
</span><br>
<span class="quotelev1">&gt;    mca/memcpy/libmca_memcpy.la &lt;<a href="http://libmca_memcpy.la">http://libmca_memcpy.la</a>&gt;
</span><br>
...
<span class="quotelev1">&gt;    mca/memory/libmca_memory.la &lt;<a href="http://libmca_memory.la">http://libmca_memory.la</a>&gt;
</span><br>
...
<span class="quotelev1">&gt;    mca_plm_rsh.la &lt;<a href="http://mca_plm_rsh.la">http://mca_plm_rsh.la</a>&gt;
</span><br>
<span class="quotelev1">&gt;                    &lt;<a href="http://mca_plm_rsh.la">http://mca_plm_rsh.la</a>&gt; &lt;<a href="http://mca_plm_rsh.la">http://mca_plm_rsh.la</a>&gt;
</span><br>
<span class="quotelev1">&gt;                    -rwxr-xr-x 1 root root  153280 Apr 19 19:49
</span><br>
...
<span class="quotelev1">&gt;    mca_pml_cm.la &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a>&gt;
</span><br>
<span class="quotelev1">&gt;                    &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a>&gt; &lt;<a href="http://mca_pml_cm.la">http://mca_pml_cm.la</a>&gt;
</span><br>
<span class="quotelev1">&gt;                    -rwxr-xr-x 1 root root  342440 Apr 19 19:52
</span><br>
<span class="quotelev1">&gt; mca_pml_cm.so
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;                    -rwxr-xr-x 1 root root  319816 Apr 19 19:58
</span><br>
<span class="quotelev1">&gt; mca_plm_rsh.so
</span><br>
...
<span class="quotelev1">&gt;                    -rwxr-xr-x 1 root root 1507440 Apr 19 20:00
</span><br>
<span class="quotelev1">&gt; mca_pml_cm.so
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;                        I will try to reproduce this on my solaris11 x86_64
</span><br>
...
<span class="quotelev1">&gt;                            I've already used &quot;-enable-debug&quot;. &quot;SYSTEM_ENV&quot;
</span><br>
<span class="quotelev1">&gt; is
</span><br>
<span class="quotelev1">&gt;                        &quot;SunOS&quot; or
</span><br>
<span class="quotelev1">&gt;                            &quot;Linux&quot; and &quot;MACHINE_ENV&quot; is &quot;sparc&quot; or
</span><br>
<span class="quotelev1">&gt; &quot;x86_84&quot;.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29051/attachment">attachment</a>
</ul>
