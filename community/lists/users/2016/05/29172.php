...
?>
<!-- received="Wed May 11 09:39:23 2016" -->
<!-- isoreceived="20160511133923" -->
<!-- sent="Wed, 11 May 2016 09:39:19 -0400" -->
<!-- isosent="20160511133919" -->
...
<!-- id="002601d1ab8a$8515a5c0$8f40f140$_at_soft-forge.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-05-11 09:39:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29173.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun command won't run unless the firewalld daemon is disabled"</a>
<li><strong>Previous message:</strong> <a href="29171.php">Ilias Miroslav: "Re: [OMPI users] 'AINT' undeclared"</a>
<li><strong>In reply to:</strong> <a href="29164.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun command won't run unless the firewalld daemon is disabled"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29173.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun command won't run unless the firewalld daemon is disabled"</a>
<li><strong>Reply:</strong> <a href="29173.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun command won't run unless the firewalld daemon is disabled"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>&nbsp;
<br>
<p>Thank you for clarifying this.
<br>
<p>&nbsp;
<br>
<p>We have three ports but the RoCE traffic is supposed to use one of the internal ports. However, we do allow use of one of the external ports which we assign a static address.
<br>
<p>&nbsp;
<br>
<p>I thank you.
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29172/attachment">attachment</a>
</ul>
