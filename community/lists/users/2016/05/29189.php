<?
$subject_val = "Re: [OMPI users] OMPI users] No core dump in some cases";
include("../../include/msg-header.inc");
?>
<!-- received="Thu May 12 05:26:38 2016" -->
<!-- isoreceived="20160512092638" -->
<!-- sent="Thu, 12 May 2016 18:26:23 +0900" -->
<!-- isosent="20160512092623" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI users] No core dump in some cases" -->
<!-- id="t60u3119icvjpxd6pfk5dg63.1463045183618_at_email.android.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="[OMPI users] OMPI users] No core dump in some cases" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] OMPI users] No core dump in some cases<br>
<strong>From:</strong> Gilles Gouaillardet (<em>gilles.gouaillardet_at_[hidden]</em>)<br>
<strong>Date:</strong> 2016-05-12 05:26:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29190.php">Gilles Gouaillardet: "Re: [OMPI users] No core dump in some cases"</a>
<li><strong>Previous message:</strong> <a href="29188.php">dpchoudh .: "Re: [OMPI users] No core dump in some cases"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>Restoring signal handlers when libinfinipath.so is unloaded (when mca_mtl_psm.so is unloaded from our point of view) can only be fixed within libinfinipath.so.
<br>
It might have already been fixed in the latest OFED versions, but i am not sure about that ...
<br>
<p>Cheers,
<br>
<p>Gilles
<br>
<p>&quot;dpchoudh .&quot; &lt;dpchoudh_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt;&lt;quote&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;If you configure with --disable-dlopen, then libinfinipath.so is slurped and hence the infinipath signal handler is always set, even if you disable the psm mtl or choose to only use the ob1 pml.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;if you do not configure with --disable-dlopen, then the infinipath signal handler is set when mca_mtl_psm.so is loaded. and it is not loaded if it is disabled or if only ob1 is used.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&lt;/quote&gt;
...
<span class="quotelev1">&gt;Aah, I see. But you said that this was recently fixed, right? (I mean, the signal handlers are now uninstalled if PSM is unloaded). I do have the latest from master.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;I ran your patches, and *both* of them fix the crash. In case it is useful, I am attaching the console output after applying the patch (the output from the app proper is omitted.)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&lt;From patch 1&gt;
</span><br>
<span class="quotelev1">&gt;[durga_at_smallMPI ~]$ mpirun -np 2&#194;&#160; ./mpitest
</span><br>
<span class="quotelev1">&gt;--------------------------------------------------------------------------
</span><br>
...
<span class="quotelev1">&gt;them).&#194;&#160; This is most certainly not what you wanted.&#194;&#160; Check your
</span><br>
<span class="quotelev1">&gt;cables, subnet manager configuration, etc.&#194;&#160; The openib BTL will be
</span><br>
<span class="quotelev1">&gt;ignored for this job.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; Local host: smallMPI
</span><br>
<span class="quotelev1">&gt;--------------------------------------------------------------------------
</span><br>
<span class="quotelev1">&gt;smallMPI.26487PSM found 0 available contexts on InfiniPath device(s). (err=21)
</span><br>
<span class="quotelev1">&gt;smallMPI.26488PSM found 0 available contexts on InfiniPath device(s). (err=21)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;smallMPI.7486PSM found 0 available contexts on InfiniPath device(s). (err=21)
</span><br>
<span class="quotelev1">&gt;smallMPI.7487PSM found 0 available contexts on InfiniPath device(s). (err=21)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;On Thu, May 12, 2016 at 4:29 AM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;If you configure with --disable-dlopen, then libinfinipath.so is slurped and hence the infinipath signal handler is always set, even if you disable the psm mtl or choose to only use the ob1 pml.
...
<span class="quotelev1">&gt;I am not sure if I understand you correctly, but let me answer based on what I think you mean:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&lt;quote&gt;
...
<span class="quotelev1">&gt;If this is true, then there is a bug in OMPI proper, since it is crashing inside MPI_Init(). Here is the stack:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;(gdb) bt
</span><br>
<span class="quotelev1">&gt;#0&#194;&#160; 0x00007ff3104ac7d8 in main_arena () from /lib64/libc.so.6
</span><br>
<span class="quotelev1">&gt;#1&#194;&#160; 0x00007ff30f6869ac in device_destruct (device=0x1284b30) at btl_openib_component.c:985
</span><br>
<span class="quotelev1">&gt;#2&#194;&#160; 0x00007ff30f6820ae in opal_obj_run_destructors (object=0x1284b30) at ../../../../opal/class/opal_object.h:460
</span><br>
<span class="quotelev1">&gt;#3&#194;&#160; 0x00007ff30f689d3c in init_one_device (btl_list=0x7fff96c3a200, ib_dev=0x12843f0) at btl_openib_component.c:2255
</span><br>
<span class="quotelev1">&gt;#4&#194;&#160; 0x00007ff30f68b800 in btl_openib_component_init (num_btl_modules=0x7fff96c3a330, enable_progress_threads=true, 
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;&#194;&#160; enable_mpi_threads=false) at btl_openib_component.c:2752
</span><br>
<span class="quotelev1">&gt;#5&#194;&#160; 0x00007ff30f648971 in mca_btl_base_select (enable_progress_threads=true, enable_mpi_threads=false) at base/btl_base_select.c:110
</span><br>
<span class="quotelev1">&gt;#6&#194;&#160; 0x00007ff3108100a0 in mca_bml_r2_component_init (priority=0x7fff96c3a3fc, enable_progress_threads=true, enable_mpi_threads=false)
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;&#194;&#160; at bml_r2_component.c:86
</span><br>
<span class="quotelev1">&gt;#7&#194;&#160; 0x00007ff31080d033 in mca_bml_base_init (enable_progress_threads=true, enable_mpi_threads=false) at base/bml_base_init.c:74
</span><br>
<span class="quotelev1">&gt;#8&#194;&#160; 0x00007ff310754675 in ompi_mpi_init (argc=1, argv=0x7fff96c3a7b8, requested=0, provided=0x7fff96c3a56c)
</span><br>
<span class="quotelev1">&gt;&#194;&#160;&#194;&#160;&#194;&#160; at runtime/ompi_mpi_init.c:590
</span><br>
<span class="quotelev1">&gt;#9&#194;&#160; 0x00007ff3107918b7 in PMPI_Init (argc=0x7fff96c3a5ac, argv=0x7fff96c3a5a0) at pinit.c:66
</span><br>
<span class="quotelev1">&gt;#10 0x0000000000400aa0 in main (argc=1, argv=0x7fff96c3a7b8) at mpitest.c:17
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;As you can see, the crash happens inside the verbs library and the following gets printed to the console:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;That sort of tells me the perhaps the signal handler does more than simply prints the stack; it might be manipulating page permissions (since I see a different behaviour when PSM signal handlers are enabled.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;The MPI app that I am running is a simple program and it runs fine with the work around you mention.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;I confirm that I have the latest from master (by running 'git pull'). Also, I have a single Qlogic card with a single port and here is the output:
</span><br>
...
<span class="quotelev1">&gt;I did configure with --disable-dlopen, but why does that make a difference? This is the part that I don't understand.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;And yes, I do have a reasonable work around now, but I am passing on my observations so that if there is a bug, the developers can fix it, or if I am doing something wrong, then they can correct me.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;On Thu, May 12, 2016 at 12:38 AM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;Date:&#194;&#160; &#194;&#160;Wed May 11 17:43:17 2016 -0700
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; &#194;&#160; Merge pull request #1661 from matcabral/master
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;&#194;&#160; &#194;&#160; PSM and PSM2 MTLs to detect drivers and link
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;On Thu, May 12, 2016 at 12:42 PM, dpchoudh . &lt;dpchoudh_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; There must be a reason why PSM is installing its signal handlers; often this
</span><br>
<span class="quotelev2">&gt;&gt; is done to modify the permission of a page in response to a SEGV and attempt
</span><br>
<span class="quotelev2">&gt;&gt; access again. By disabling the handlers, I am preventing the library from
</span><br>
<span class="quotelev2">&gt;&gt; doing that, and here is what it tells me:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; [durga_at_smallMPI ~]$ mpirun -np 2&#194;&#160; ./mpitest
</span><br>
...
<span class="quotelev2">&gt;&gt; [smallMPI:20496] [ 0] /lib64/libpthread.so.0(+0xf100)[0x7f0b2fdcb100]
</span><br>
...
<span class="quotelev2">&gt;&gt; [smallMPI:20497] [ 0] /lib64/libpthread.so.0(+0xf100)[0x7fbfe2b4e100]
</span><br>
...
<span class="quotelev2">&gt;&gt; Primary job&#194;&#160; terminated normally, but 1 process returned
</span><br>
...
<span class="quotelev2">&gt;&gt; mpitest:22009 terminated with signal 11 at PC=7f908bb2a7d8 SP=7ffebb4ee5b8.
</span><br>
...
<span class="quotelev2">&gt;&gt; mpitest:22010 terminated with signal 11 at PC=7f7a2caa67d8 SP=7ffd73dec3e8.
</span><br>
<span class="quotelev2">&gt;&gt; Backtrace:
</span><br>
...
<span class="quotelev2">&gt;&gt; The PC is at a different location but I do not have any more information
</span><br>
<span class="quotelev2">&gt;&gt; without a core file.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; It seems like some interaction between OMPI and PSM library is incorrect.
</span><br>
...
<span class="quotelev2">&gt;&gt; On Wed, May 11, 2016 at 11:23 PM, dpchoudh . &lt;dpchoudh_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Mystery solved! In fact, this one line is exactly what was needed!! It
</span><br>
<span class="quotelev3">&gt;&gt;&gt; turns out the OMPI signal handlers are irrelevant. (i.e. don't make any
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 1. The difference in the behaviour in the two clusters (one has PSM, the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; other does not)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 2. Why you couldn't find where in OMPI code the .btr files are being
</span><br>
<span class="quotelev3">&gt;&gt;&gt; generated (looks like they are being generated in PSM library)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; And, now that I can get a core file (finally!), I can present the back
</span><br>
<span class="quotelev3">&gt;&gt;&gt; trace where the crash in MPI_Init() is happening. It is as follows:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #0&#194;&#160; 0x00007f1c114977d8 in main_arena () from /lib64/libc.so.6
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #1&#194;&#160; 0x00007f1c106719ac in device_destruct (device=0x1c85b70) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; btl_openib_component.c:985
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #2&#194;&#160; 0x00007f1c1066d0ae in opal_obj_run_destructors (object=0x1c85b70) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../../../opal/class/opal_object.h:460
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #3&#194;&#160; 0x00007f1c10674d3c in init_one_device (btl_list=0x7ffd00dada50,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ib_dev=0x1c85430) at btl_openib_component.c:2255
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #4&#194;&#160; 0x00007f1c10676800 in btl_openib_component_init
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;at btl_openib_component.c:2752
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #5&#194;&#160; 0x00007f1c10633971 in mca_btl_base_select
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #6&#194;&#160; 0x00007f1c117fb0a0 in mca_bml_r2_component_init
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (priority=0x7ffd00dadc4c, enable_progress_threads=true,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; enable_mpi_threads=false)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;at bml_r2_component.c:86
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #7&#194;&#160; 0x00007f1c117f8033 in mca_bml_base_init (enable_progress_threads=true,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; enable_mpi_threads=false) at base/bml_base_init.c:74
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #8&#194;&#160; 0x00007f1c1173f675 in ompi_mpi_init (argc=1, argv=0x7ffd00dae008,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; requested=0, provided=0x7ffd00daddbc) at runtime/ompi_mpi_init.c:590
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #9&#194;&#160; 0x00007f1c1177c8b7 in PMPI_Init (argc=0x7ffd00daddfc,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wed, May 11, 2016 at 10:55 PM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Note the psm library sets its own signal handler, possibly after the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Thank you for your continued support. With your help, I have a better
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; understanding of what is happening. Here are the details.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 1. Yes, I am sure that ulimit -c is 'unlimited' (and for the test in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; question, I am running it on a single node, so there are no other nodes)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; It looks to me, after running your test code, that what is crashing is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_Init() itself. The output from your code (I called it 'btrtest') is as
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; SP=7ffec47e7578.&#194;&#160; Backtrace:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; SP=7ffc516ac8d8.&#194;&#160; Backtrace:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; /lib64/libc.so.6(+0x3ba7d8)[0x7f1ba21897d8]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -------------------------------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Primary job&#194;&#160; terminated normally, but 1 process returned
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160;Process name: [[7936,1],1]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160;Exit code:&#194;&#160; &#194;&#160; 1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
...
<span class="quotelev4">&gt;&gt;&gt;&gt; different forms and have reported on the forum a few times also. Let me
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; elaborate:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Both my 'well-behaving' and crashing clusters run CentOS 7 (the crashing
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one has the latest updates, the well-behaving one does not as I am not
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; allowed to apply updates on that). They both have OMPI, from the master
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; branch, compiled from the source. Both consist of 64 bit Dell servers,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The well behaved one (if it does core dump, that is because there is a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; bug in the MPI app) has very simple network hardware: two different NICs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (one Broadcom GbE, one proprietary NIC that is currently being exposed as an
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; In this situation, WITH ALL BUT THE GbE LINK DOWN (the GbE connects the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; machine to the WAN link), it seems just the presence of these NICs matter.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; SP=7ffcae2b2ef8.&#194;&#160; Backtrace:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; SP=7ffe61a92088.&#194;&#160; Backtrace:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160;Process name: [[9294,1],0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160;Exit code:&#194;&#160; &#194;&#160; 1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; SP=7ffebb106028.&#194;&#160; Backtrace:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; SP=7ffea4f4fdf8.&#194;&#160; Backtrace:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160;Process name: [[9266,1],0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160;Exit code:&#194;&#160; &#194;&#160; 1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [durga_at_smallMPI ~]$ mpirun -np 2 -mca pml ob1 -mca btl self,sm ./btrtest
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; before MPI_Init : -1 -1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; before MPI_Init : -1 -1
...
<span class="quotelev4">&gt;&gt;&gt;&gt; btrtest:10198 terminated with signal 11 at PC=400829 SP=7ffe6e148870.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Backtrace:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; btrtest:10197 terminated with signal 11 at PC=400829 SP=7ffe87be6cd0.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Backtrace:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160;Process name: [[9384,1],1]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160;Exit code:&#194;&#160; &#194;&#160; 1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; core file size&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; (blocks, -c) unlimited
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; data seg size&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160;(kbytes, -d) unlimited
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; scheduling priority&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160;(-e) 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; file size&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160;(blocks, -f) unlimited
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; pending signals&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160;(-i) 216524
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; max locked memory&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160;(kbytes, -l) unlimited
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; max memory size&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160;(kbytes, -m) unlimited
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; open files&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; (-n) 1024
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; pipe size&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; (512 bytes, -p) 8
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; POSIX message queues&#194;&#160; &#194;&#160; &#194;&#160;(bytes, -q) 819200
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; real-time priority&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; (-r) 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; stack size&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; (kbytes, -s) 8192
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; cpu time&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160;(seconds, -t) unlimited
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; max user processes&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; (-u) 4096
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; virtual memory&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; (kbytes, -v) unlimited
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; file locks&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; (-x) unlimited
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I do realize that my setup is very unusual (I am a quasi-developer of MPI
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; whereas most other folks in this list are likely end-users), but somehow
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; just disabling this 'execinfo' MCA would allow me to make progress (and also
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; find out why/where MPI_Init() is crashing!). Is there any way I can do that?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Wed, May 11, 2016 at 8:58 PM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;struct rlimit rlim;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;char * c = (char *)0;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;getrlimit(RLIMIT_CORE, &amp;rlim);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;printf (&quot;before MPI_Init : %d %d\n&quot;, rlim.rlim_cur, rlim.rlim_max);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;MPI_Init(&amp;argc, &amp;argv);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;getrlimit(RLIMIT_CORE, &amp;rlim);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;printf (&quot;after MPI_Init : %d %d\n&quot;, rlim.rlim_cur, rlim.rlim_max);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;*c = 0;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; difference. Here is what I did (on the cluster that generates .btr files for
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; MCA opal base: parameter &quot;opal_signal&quot; (current value:
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #define&#194;&#160; &#194;&#160; SIGABRT&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; 6&#194;&#160; &#194;&#160; /* Abort (ANSI).&#194;&#160; */
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #define&#194;&#160; &#194;&#160; SIGBUS&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; 7&#194;&#160; &#194;&#160; /* BUS error (4.2 BSD).&#194;&#160; */
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #define&#194;&#160; &#194;&#160; SIGFPE&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; 8&#194;&#160; &#194;&#160; /* Floating-point exception (ANSI).&#194;&#160; */
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #define&#194;&#160; &#194;&#160; SIGSEGV&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; 11&#194;&#160; &#194;&#160; /* Segmentation violation (ANSI).&#194;&#160; */
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;signal(SIGABRT, SIG_DFL);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;signal(SIGBUS, SIG_DFL);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;signal(SIGFPE, SIG_DFL);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;signal(SIGSEGV, SIG_DFL);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160;signal(SIGTERM, SIG_DFL);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; &#194;&#160; MCA backtrace: execinfo (MCA v2.1.0, API v2.0.0, Component
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; opal_backtrace_buffer and opal_backtrace_print are only used with
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; stderr.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; so i am puzzled who creates the tracefile name and where ...
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; also, no stack is printed by default unless opal_abort_print_stack is
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Wed, May 11, 2016 at 3:43 PM, dpchoudh . &lt;dpchoudh_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; Hello Nathan
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; Thank you for your response. Could you please be more specific?
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&#194;&#160; &#194;&#160; &#194;&#160;MPI_Init(&amp;argc, &amp;argv);
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&#194;&#160; &#194;&#160;signal(SIGABRT, SIG_DFL);
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&#194;&#160; &#194;&#160;signal(SIGTERM, SIG_DFL);
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; I also find it puzzling that nearly identical OMPI distro running on
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt; I am launching mpirun from the bash shell.). In fact, both of the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt; two
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt; clusters I talked about run CentOS 7 and I launch the job the same
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt; core files when an MPI job crashes. The other creates a text file
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt; I'd much prefer a core file because that allows me to debug with a
</span><br>
...
<span class="quotelev1">&gt;Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/05/29185.php">http://www.open-mpi.org/community/lists/users/2016/05/29185.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;_______________________________________________ users mailing list users_at_[hidden] Subscription: <a href="https://www.open-mpi.org/mailman/listinfo.cgi/users">https://www.open-mpi.org/mailman/listinfo.cgi/users</a> Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/05/29186.php">http://www.open-mpi.org/community/lists/users/2016/05/29186.php</a> 
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/05/29187.php">http://www.open-mpi.org/community/lists/users/2016/05/29187.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29189/attachment">attachment</a>
</ul>
