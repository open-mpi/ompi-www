...
?>
<!-- received="Fri May  6 03:46:06 2016" -->
<!-- isoreceived="20160506074606" -->
<!-- sent="Fri, 6 May 2016 09:45:15 +0200" -->
<!-- isosent="20160506074515" -->
<!-- name="Giacomo Rossi" -->
<!-- email="giacombum_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation Fault (Core Dumped) on mpif90 -v" -->
<!-- id="CAMP0BNa0szn_6e8x-igHm7wEATnw8LRrzyVa+6xGSPqO9Wy1PQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-05-06 03:45:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29109.php">Jiri Kraus: "Re: [OMPI users] Multiple Non-blocking Send/Recv calls with MPI_Waitall fails when CUDA IPC is in use"</a>
<li><strong>Previous message:</strong> <a href="29107.php">Gilles Gouaillardet: "Re: [OMPI users] barrier algorithm 5"</a>
<li><strong>In reply to:</strong> <a href="29093.php">Giacomo Rossi: "Re: [OMPI users] Segmentation Fault (Core Dumped) on mpif90 -v"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29111.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Segmentation Fault (Core Dumped) on mpif90 -v"</a>
<li><strong>Reply:</strong> <a href="29111.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Segmentation Fault (Core Dumped) on mpif90 -v"</a>
<li><strong>Reply:</strong> <a href="29137.php">Giacomo Rossi: "Re: [OMPI users] Segmentation Fault (Core Dumped) on mpif90 -v"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>2016-05-05 11:15 GMT+02:00 Giacomo Rossi &lt;giacombum_at_[hidden]&gt;:
<br>
<p><span class="quotelev1">&gt;  gdb /opt/openmpi/1.10.2/intel/16.0.3/bin/mpif90
</span><br>
...
<span class="quotelev2">&gt;&gt; /opt/openmpi/1.10.2/intel/16.0.3/lib/libopen-pal.so.13 (0x00007fa9597a9000)
</span><br>
...
<span class="quotelev2">&gt;&gt; program with mpifort... I've always the error 'core dumped' also when I try
</span><br>
<span class="quotelev2">&gt;&gt; to compile a program with mpifort, and of course there isn't any core file.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; I&#226;&#128;&#153;ve installed the latest version of Intel Parallel Studio (16.0.3),
</span><br>
<span class="quotelev3">&gt;&gt;&gt; then I&#226;&#128;&#153;ve downloaded the latest version of openmpi (1.10.2) and I&#226;&#128;&#153;ve
</span><br>
<span class="quotelev3">&gt;&gt;&gt; compiled it with
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; `./configure CC=icc CXX=icpc F77=ifort FC=ifort
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --prefix=/opt/openmpi/1.10.2/intel/16.0.3`
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; then I've installed and everything seems ok, but when I try the simple
</span><br>
<span class="quotelev3">&gt;&gt;&gt; command
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ' /opt/openmpi/1.10.2/intel/16.0.3/bin/mpif90 -v'
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I receive the following error
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I'm on ArchLinux, with kernel 4.5.1-1-ARCH; I've attache to this email
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the config.log file compressed with bzip2.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Any help will be appreciated!
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29108/attachment">attachment</a>
</ul>
