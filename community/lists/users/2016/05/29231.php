...
?>
<!-- received="Tue May 17 11:49:04 2016" -->
<!-- isoreceived="20160517154904" -->
<!-- sent="Tue, 17 May 2016 09:49:03 -0600" -->
<!-- isosent="20160517154903" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Eager sending on InfiniBand" -->
<!-- id="20160517154903.GD80855_at_mordor.lanl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAOEhc2Ax3nwR3xU=74CkxrAsaedExK93RjBnAQzZ4XjppMQ=pg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-05-17 11:49:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29232.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>Previous message:</strong> <a href="29230.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>In reply to:</strong> <a href="29230.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29232.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>Reply:</strong> <a href="29232.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>Reply:</strong> <a href="29233.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<a href="https://www.open-mpi.org/software/ompi/v2.x/">https://www.open-mpi.org/software/ompi/v2.x/</a>
<br>
<p>I know the per-peer queue pair will prevent totally asynchronous
<br>
connections even in 2.x but SRQ/XRC only should work.
<br>
<p>-Nathan
<br>
<p>On Tue, May 17, 2016 at 11:31:01AM -0400, Xiaolong Cui wrote:
<br>
<span class="quotelev1">&gt;    I think it is the connection manager that blocks the first message. If I
</span><br>
<span class="quotelev1">&gt;    add a pair of send/recv at the very beginning, the problem is gone. But
</span><br>
<span class="quotelev1">&gt;    removing the per-peer queue pair does not help. 
</span><br>
<span class="quotelev1">&gt;    Do you know any document that discusses the open mpi internals, especially
</span><br>
<span class="quotelev1">&gt;    related to this problem?
</span><br>
<span class="quotelev1">&gt;    On Tue, May 17, 2016 at 11:00 AM, Nathan Hjelm &lt;hjelmn_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;      &gt;    The &quot;credits&quot; make sense for the purpose of flow control. However,
</span><br>
...
<span class="quotelev2">&gt;      &gt;    seem to be the symptom of running out of credits. Is there any
</span><br>
<span class="quotelev1">&gt;      reason for
</span><br>
...
<span class="quotelev2">&gt;      &gt;      messages will be placed in the ob1 unexpected queue and the
</span><br>
<span class="quotelev1">&gt;      credits will
</span><br>
...
<span class="quotelev2">&gt;      &gt;      per-peer queue pair to btl_openib_receive_queues. We have not
</span><br>
<span class="quotelev1">&gt;      seen any
</span><br>
...
<span class="quotelev3">&gt;      &gt;      &gt;    sender being blocked by the receiver when using openib
</span><br>
<span class="quotelev1">&gt;      module for
</span><br>
...
<span class="quotelev3">&gt;      &gt;      &gt;    but didn't find the answer. My understanding of &quot;eager
</span><br>
<span class="quotelev1">&gt;      sending
</span><br>
<span class="quotelev2">&gt;      &gt;      protocol&quot;
</span><br>
<span class="quotelev3">&gt;      &gt;      &gt;    is that if a message is &quot;small&quot;, it will be transported to
</span><br>
<span class="quotelev1">&gt;      the
</span><br>
...
<span class="quotelev3">&gt;      &gt;      &gt;    I am trying to observe such behavior with a simple program
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/05/29230.php">http://www.open-mpi.org/community/lists/users/2016/05/29230.php</a>
</span><br>
<p><p>
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29231/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
