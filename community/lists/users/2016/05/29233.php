...
?>
<!-- received="Wed May 18 15:25:06 2016" -->
<!-- isoreceived="20160518192506" -->
<!-- sent="Wed, 18 May 2016 15:24:24 -0400" -->
<!-- isosent="20160518192424" -->
<!-- name="Xiaolong Cui" -->
<!-- email="sunshine870_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Eager sending on InfiniBand" -->
<!-- id="CAOEhc2ChZ0ChkKVCAQ9LoPnWFLsZCgzqe=nfDEWkghNm1YwFbQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2016-05-18 15:24:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29234.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>Previous message:</strong> <a href="29232.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>In reply to:</strong> <a href="29231.php">Nathan Hjelm: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29234.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>Reply:</strong> <a href="29234.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Nathan,
<br>
<p>I got one more question. I am measuring the number of messages that can be
<br>
...
<br>
<p>I measured the time for rank 0 to send out all the messages, and
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29233/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/users/att-29233/experiment.png" alt="experiment.png">
<!-- attachment="experiment.png" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/users/att-29233/result.png" alt="result.png">
