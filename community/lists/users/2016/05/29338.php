...
?>
<!-- received="Tue May 31 22:43:41 2016" -->
<!-- isoreceived="20160601024341" -->
<!-- sent="Wed, 1 Jun 2016 12:43:36 +1000" -->
<!-- isosent="20160601024336" -->
<!-- name="Cihan Altinay" -->
<!-- email="c.altinay_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Regression in MPI_File_close?!" -->
<!-- id="574E4BD8.30401_at_uq.edu.au" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2016-05-31 22:43:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2016/06/29339.php">Ping Wang: "[OMPI users] Firewall settings for MPI communication"</a>
<li><strong>Previous message:</strong> <a href="29337.php">Gilles Gouaillardet: "Re: [OMPI users] Regression in MPI_File_close?!"</a>
<li><strong>In reply to:</strong> <a href="29337.php">Gilles Gouaillardet: "Re: [OMPI users] Regression in MPI_File_close?!"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2016/06/29348.php">Edgar Gabriel: "Re: [OMPI users] Regression in MPI_File_close?!"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gilles,
<br>
<p>This is not an answer to your question, but:
<br>
<p>MPI_File_write_at() is itself a blocking collective routine so your 
<br>
example, would not work, would it?
<br>
<p>Also, the standard has a few extra words (emphasis mine):
<br>
<a href="https://www.mpi-forum.org/docs/mpi-3.1/mpi31-report/node309.htm#Node309">https://www.mpi-forum.org/docs/mpi-3.1/mpi31-report/node309.htm#Node309</a>
<br>
<p>&quot;The user is responsible for ensuring that all outstanding *nonblocking* 
<br>
...
Cihan
<br>
<p>On 01/06/16 12:33, Gilles Gouaillardet wrote:
<br>
...
<span class="quotelev1">&gt; &quot;MPI_File_close  first  synchronizes  file  state, then closes the file
</span><br>
<span class="quotelev1">&gt; associated with fh.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; MPI_File_close is a collective routine. The user is responsible for
</span><br>
<span class="quotelev1">&gt; ensuring that all outstanding requests associated with fh have completed
</span><br>
<span class="quotelev1">&gt; before calling MPI_File_close.&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/05/29337.php">http://www.open-mpi.org/community/lists/users/2016/05/29337.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<!-- body="end" -->
