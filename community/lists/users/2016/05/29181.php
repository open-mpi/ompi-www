...
?>
<!-- received="Wed May 11 22:57:21 2016" -->
<!-- isoreceived="20160512025721" -->
<!-- sent="Thu, 12 May 2016 11:55:41 +0900" -->
<!-- isosent="20160512025541" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI users] No core dump in some cases" -->
<!-- id="10d8a97b-39c0-f5f1-3433-e911f587ee18_at_rist.or.jp" -->
...
<strong>Date:</strong> 2016-05-11 22:55:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29182.php">dpchoudh .: "Re: [OMPI users] No core dump in some cases"</a>
<li><strong>Previous message:</strong> <a href="29180.php">dpchoudh .: "Re: [OMPI users] No core dump in some cases"</a>
<li><strong>In reply to:</strong> <a href="29178.php">dpchoudh .: "Re: [OMPI users] No core dump in some cases"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29183.php">dpchoudh .: "Re: [OMPI users] No core dump in some cases"</a>
<li><strong>Reply:</strong> <a href="29183.php">dpchoudh .: "Re: [OMPI users] No core dump in some cases"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
OpenMPI one.
<br>
<p>that can be disabled by
<br>
<p>|export IPATH_NO_BACKTRACE=1 Cheers, Gilles |
<br>
<p><p>On 5/12/2016 11:34 AM, dpchoudh . wrote:
<br>
...
<span class="quotelev1">&gt; me elaborate:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Both my 'well-behaving' and crashing clusters run CentOS 7 (the 
</span><br>
<span class="quotelev1">&gt; crashing one has the latest updates, the well-behaving one does not as 
</span><br>
<span class="quotelev1">&gt; I am not allowed to apply updates on that). They both have OMPI, from 
</span><br>
<span class="quotelev1">&gt; the master branch, compiled from the source. Both consist of 64 bit 
</span><br>
<span class="quotelev1">&gt; Dell servers, although not identical models (I doubt if that matters)
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; NICs (one Broadcom GbE, one proprietary NIC that is currently being 
</span><br>
<span class="quotelev1">&gt; exposed as an IP interface). There is no RDMA capability there at all.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; the machine to the WAN link), it seems just the presence of these NICs 
</span><br>
...
<span class="quotelev1">&gt; MPI whereas most other folks in this list are likely end-users), but 
</span><br>
<span class="quotelev1">&gt; somehow just disabling this 'execinfo' MCA would allow me to make 
</span><br>
<span class="quotelev1">&gt; progress (and also find out why/where MPI_Init() is crashing!). Is 
</span><br>
<span class="quotelev1">&gt; there any way I can do that?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     difference. Here is what I did (on the cluster that generates
</span><br>
<span class="quotelev2">&gt;&gt;     .btr files for core dumps):
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;                MCA backtrace: execinfo (MCA v2.1.0, API v2.0.0,
</span><br>
<span class="quotelev2">&gt;&gt;     Component v3.0.0)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     And the strange thing is, on the cluster where regular core dump
</span><br>
<span class="quotelev2">&gt;&gt;     is happening, the output of
</span><br>
<span class="quotelev2">&gt;&gt;     $ ompi_info | grep backtrace
</span><br>
<span class="quotelev2">&gt;&gt;     is identical to the above. (Which kind of makes sense because
</span><br>
<span class="quotelev2">&gt;&gt;     they were created from the same source with the same configure
</span><br>
<span class="quotelev2">&gt;&gt;     options.)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;     Sorry to harp on this, but without a core file it is hard to
</span><br>
<span class="quotelev2">&gt;&gt;     debug the application (e.g. examine stack variables).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     and quit ageing.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;         signals as well
</span><br>
...
<span class="quotelev2">&gt;&gt;         candidates :
</span><br>
...
<span class="quotelev2">&gt;&gt;         with stderr.
</span><br>
...
<span class="quotelev2">&gt;&gt;         opal_abort_print_stack is true
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;         specific? Adding the
</span><br>
...
<span class="quotelev2">&gt;&gt;         regularly and quit
</span><br>
...
<span class="quotelev2">&gt;&gt;         &lt;hjelmn_at_[hidden] &lt;mailto:hjelmn_at_[hidden]&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;         resource manager (i.e.
</span><br>
<span class="quotelev4">&gt;&gt;         &gt;&gt; I am launching mpirun from the bash shell.). In fact, both
</span><br>
<span class="quotelev2">&gt;&gt;         of the two
</span><br>
<span class="quotelev4">&gt;&gt;         &gt;&gt; clusters I talked about run CentOS 7 and I launch the job
</span><br>
<span class="quotelev2">&gt;&gt;         the same way on
</span><br>
<span class="quotelev4">&gt;&gt;         &gt;&gt; both of these, yet one of them creates standard core files
</span><br>
<span class="quotelev2">&gt;&gt;         and the other
</span><br>
<span class="quotelev4">&gt;&gt;         &gt;&gt; creates the 'btr; files. Strange thing is, I could not
</span><br>
<span class="quotelev2">&gt;&gt;         find anything on the
</span><br>
<span class="quotelev4">&gt;&gt;         &gt;&gt; .btr (= Backtrace?) files on Google, which is any I asked
</span><br>
<span class="quotelev2">&gt;&gt;         on this forum.
</span><br>
<span class="quotelev4">&gt;&gt;         &gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;         lovely POS).
</span><br>
...
<span class="quotelev2">&gt;&gt;         has some kind of
</span><br>
...
<span class="quotelev2">&gt;&gt;         &lt;mailto:dpchoudh_at_[hidden]&gt;&lt;mailto:dpchoudh_at_[hidden]
</span><br>
...
<span class="quotelev2">&gt;&gt;         debug with a lot
</span><br>
<span class="quotelev4">&gt;&gt;         &gt;&gt; more options than a static text file with addresses. How
</span><br>
<span class="quotelev2">&gt;&gt;         do I get a core
</span><br>
<span class="quotelev4">&gt;&gt;         &gt;&gt; file in all situations? I am using MPI source from the
</span><br>
<span class="quotelev2">&gt;&gt;         master branch.
</span><br>
<span class="quotelev4">&gt;&gt;         &gt;&gt;
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29181/attachment">attachment</a>
</ul>
