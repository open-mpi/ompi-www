...
?>
<!-- received="Tue May 17 11:00:56 2016" -->
<!-- isoreceived="20160517150056" -->
<!-- sent="Tue, 17 May 2016 09:00:42 -0600" -->
<!-- isosent="20160517150042" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Eager sending on InfiniBand" -->
<!-- id="20160517150042.GC80855_at_mordor.lanl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAOEhc2CygLLimCN4oHoWJfVP+x7ivi36up-EKDzndcjdzKffdQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2016-05-17 11:00:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="29230.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>Previous message:</strong> <a href="29228.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>In reply to:</strong> <a href="29228.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="29230.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<li><strong>Reply:</strong> <a href="29230.php">Xiaolong Cui: "Re: [OMPI users] Eager sending on InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>-Nathan
<br>
<p>On Mon, May 16, 2016 at 10:11:29PM -0400, Xiaolong Cui wrote:
<br>
<span class="quotelev1">&gt;    Hi Nathan,
</span><br>
<span class="quotelev1">&gt;    Thanks for your answer. 
</span><br>
<span class="quotelev1">&gt;    The &quot;credits&quot; make sense for the purpose of flow control. However, the
</span><br>
<span class="quotelev1">&gt;    sender in my case will be blocked even for the first message. This doesn't
</span><br>
<span class="quotelev1">&gt;    seem to be the symptom of running out of credits. Is there any reason for
</span><br>
<span class="quotelev1">&gt;    this? Also, is there a mac parameter for the number of credits? 
</span><br>
<span class="quotelev1">&gt;    Best,
</span><br>
<span class="quotelev1">&gt;    Michael
</span><br>
<span class="quotelev1">&gt;    On Mon, May 16, 2016 at 6:35 PM, Nathan Hjelm &lt;hjelmn_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;      &gt;    I am using Open MPI 1.8.6. I guess my question is related to the
</span><br>
<span class="quotelev1">&gt;      flow
</span><br>
<span class="quotelev2">&gt;      &gt;    control algorithm for small messages. The question is how to avoid
</span><br>
...
<span class="quotelev2">&gt;      &gt;    I am trying to observe such behavior with a simple program of two
</span><br>
...
<span class="quotelev2">&gt;      &gt;    &quot;vader&quot; module (shared memory) when running the two ranks on the
</span><br>
...
<span class="quotelev2">&gt;      &gt;    but I cannot see it when running them on two nodes using the
</span><br>
...
<span class="quotelev2">&gt;      &gt;    So anyone knows the reason? My runtime configuration is also
</span><br>
...
<span class="quotelev2">&gt;      &gt;            MPI_Send(code, length, MPI_INT, rank + 1, 0,
</span><br>
...
<span class="quotelev2">&gt;      &gt;            MPI_Recv(code, length, MPI_INT, rank - 1, 0,
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2016/05/29228.php">http://www.open-mpi.org/community/lists/users/2016/05/29228.php</a>
</span><br>
<p><p>
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-29229/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
