...
<!-- received="Tue Jan 30 09:57:53 2007" -->
<!-- isoreceived="20070130145753" -->
<!-- sent="Tue, 30 Jan 2007 08:57:39 -0600" -->
<!-- isosent="20070130145739" -->
<!-- name="Fisher, Mark S" -->
<!-- email="mark.s.fisher_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Scrambled communications using ssh starteronmultiple nodes." -->
<!-- id="A24ED13E8792884EBC90BE07F48DCE1502141198_at_XCH-MW-1V1.mw.nos.boeing.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="BFD7C20F-0E89-47D0-9278-D6581D7AFC63_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-01-30 09:57:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2568.php">Jeff Squyres: "Re: [OMPI users] Scrambled communications using ssh starteronmultiple nodes."</a>
<li><strong>Previous message:</strong> <a href="2566.php">Jeff Squyres: "Re: [OMPI users] Scrambled communications using ssh starter onmultiple nodes."</a>
<li><strong>In reply to:</strong> <a href="2566.php">Jeff Squyres: "Re: [OMPI users] Scrambled communications using ssh starter onmultiple nodes."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2568.php">Jeff Squyres: "Re: [OMPI users] Scrambled communications using ssh starteronmultiple nodes."</a>
<li><strong>Reply:</strong> <a href="2568.php">Jeff Squyres: "Re: [OMPI users] Scrambled communications using ssh starteronmultiple nodes."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>The fact that it run ok on one host but not more than one host seems to
<br>
...
<br>
<p>On Jan 30, 2007, at 9:35 AM, Fisher, Mark S wrote:
<br>
...
<br>
<p><span class="quotelev1">&gt; We have run the code through valgrid for a number of cases including 
</span><br>
<span class="quotelev1">&gt; the one being used here.
</span><br>
<p>Excellent.
<br>
<p><span class="quotelev1">&gt; The code is Fortran 90 and we are using the FORTRAN 77 interface so I 
</span><br>
<span class="quotelev1">&gt; do not believe this is a problem.
</span><br>
...
<p>Ok, good.
<br>
<p><span class="quotelev1">&gt; I could look at LAM again to see if it would work. The code needs to 
</span><br>
<span class="quotelev1">&gt; be in a specific working directory and we need some environment 
</span><br>
<span class="quotelev1">&gt; variable set. This was not supported well in pre MPI 2. versions of 
</span><br>
<span class="quotelev1">&gt; MPI. For
</span><br>
...
<p><span class="quotelev1">&gt; OpenMPI and it had an internal error in orterun. This is not a problem
</span><br>
...
<span class="quotelev1">&gt; worth while I will download and try it.
</span><br>
...
<p><span class="quotelev1">&gt; may send fragments out of order, but we do, of course, provide the 
</span><br>
<span class="quotelev1">&gt; same message ordering guarantees that MPI mandates.  So let me ask a 
</span><br>
<span class="quotelev1">&gt; few leading questions:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; - Are you using any wildcards in your receives, such as MPI_ANY_SOURCE
</span><br>
<p><span class="quotelev1">&gt; or MPI_ANY_TAG?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; integers for MPI handles.  Have you tried LAM/MPI as well?  It, like 
</span><br>
<span class="quotelev1">&gt; Open MPI, uses pointers for MPI handles.  I mention this because apps 
</span><br>
<span class="quotelev1">&gt; that unintentionally have code that takes advantage of integer handles
</span><br>
<p><span class="quotelev1">&gt; can sometimes behave unpredictably when switching to a pointer-based 
</span><br>
...
<span class="quotelev2">&gt;&gt; When testing the code with Openmpi 1.1.2 it ran fine when running on 
</span><br>
...
<p><span class="quotelev2">&gt;&gt; will run further before it fails.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I have included a tar file with the build and configuration info. The
</span><br>
<p><span class="quotelev2">&gt;&gt; two nodes are identical Xeon 2.8 GHZ machines running SLED 10. I am 
</span><br>
