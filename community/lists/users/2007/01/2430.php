...
<!-- received="Wed Jan  3 13:00:43 2007" -->
<!-- isoreceived="20070103180043" -->
<!-- sent="Wed, 3 Jan 2007 12:00:30 -0600" -->
<!-- isosent="20070103180030" -->
<!-- name="Grobe, Gary L. \(JSC-EV\)[ESCG]" -->
<!-- email="gary.l.grobe_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Ompi failing on mx only" -->
<!-- id="559847D38F12F742B0EE27727596F42901A7E965_at_NDJSEVS14.ndc.nasa.gov" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2007-01-03 13:00:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2431.php">Reese Faucette: "Re: [OMPI users] Ompi failing on mx only"</a>
<li><strong>Previous message:</strong> <a href="2429.php">Ralph H Castain: "Re: [OMPI users] orted: command not found"</a>
<li><strong>In reply to:</strong> <a href="2425.php">Brian W. Barrett: "Re: [OMPI users] Ompi failing on mx only"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2431.php">Reese Faucette: "Re: [OMPI users] Ompi failing on mx only"</a>
<li><strong>Reply:</strong> <a href="2431.php">Reese Faucette: "Re: [OMPI users] Ompi failing on mx only"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>$ mpirun --prefix /usr/local/openmpi-1.2b2 --hostfile ./h1-3 -np 1 --mca
<br>
btl mx,sm,self ./cpi
<br>
