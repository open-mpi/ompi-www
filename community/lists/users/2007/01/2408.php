<?
$subject_val = "Re: [OMPI users] openmpi / mpirun problem on aix: poll failed with errno=25, opal_event_loop: ompi_evesel-&gt;dispatch() failed.";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2409.php">jcolmenares_at_[hidden]: "[OMPI users] orted: command not found"</a>
<li><strong>Previous message:</strong> <a href="2407.php">Jeff Squyres: "Re: [OMPI users] segv at runtime with ifort"</a>
<li><strong>In reply to:</strong> <a href="../../2006/12/2403.php">Michael Marti: "[OMPI users] openmpi / mpirun problem on aix: poll failed with errno=25, opal_event_loop: ompi_evesel-&gt;dispatch() failed."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2447.php">Michael Marti: "Re: [OMPI users] openmpi / mpirun problem on aix: poll failed with errno=25, opal_event_loop: ompi_evesel-&gt;dispatch() failed."</a>
<li><strong>Reply:</strong> <a href="2447.php">Michael Marti: "Re: [OMPI users] openmpi / mpirun problem on aix: poll failed with errno=25, opal_event_loop: ompi_evesel-&gt;dispatch() failed."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
