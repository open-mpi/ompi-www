<?
$subject_val = "Re: [OMPI users] segv at runtime with ifort";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2408.php">Jeff Squyres: "Re: [OMPI users] openmpi / mpirun problem on aix: poll failed with errno=25, opal_event_loop: ompi_evesel-&gt;dispatch() failed."</a>
<li><strong>Previous message:</strong> <a href="2406.php">Jeff Squyres: "Re: [OMPI users] mpicc problems finding libraries (mostly)"</a>
<li><strong>In reply to:</strong> <a href="../../2006/12/2377.php">Brock Palen: "[OMPI users] segv at runtime with ifort"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2410.php">Brock Palen: "Re: [OMPI users] segv at runtime with ifort"</a>
<li><strong>Reply:</strong> <a href="2410.php">Brock Palen: "Re: [OMPI users] segv at runtime with ifort"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
