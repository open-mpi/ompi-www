...
<!-- received="Thu Jan  4 16:06:48 2007" -->
<!-- isoreceived="20070104210648" -->
<!-- sent="Thu, 4 Jan 2007 16:06:36 -0500" -->
<!-- isosent="20070104210636" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Ompi failing on mx only" -->
<!-- id="0B3D6095-A116-4D41-8B98-901FE8D3D174_at_cs.utk.edu" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2007-01-04 16:06:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2435.php">lund_at_[hidden]: "[OMPI users] external32 i/o not implemented?"</a>
<li><strong>Previous message:</strong> <a href="2433.php">Jeff Squyres: "Re: [OMPI users] Ompi failing on mx only"</a>
<li><strong>In reply to:</strong> <a href="2432.php">Grobe, Gary L. \(JSC-EV\)[ESCG]: "Re: [OMPI users] Ompi failing on mx only"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2436.php">Grobe, Gary L. \(JSC-EV\)[ESCG]: "Re: [OMPI users] Ompi failing on mx only"</a>
<li><strong>Reply:</strong> <a href="2436.php">Grobe, Gary L. \(JSC-EV\)[ESCG]: "Re: [OMPI users] Ompi failing on mx only"</a>
<li><strong>Reply:</strong> <a href="2439.php">Grobe, Gary L. \(JSC-EV\)[ESCG]: "Re: [OMPI users] Ompi failing on mx only"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Second thing. From one of your previous emails, I see that MX is  
<br>
configured with 4 instance by node. Your running with exactly 4  
<br>
processes on the first 2 nodes. Weirds things might happens ...
<br>
<p>Now, if you use the latest trunk, you can use the new MX BTL which  
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;george.
<br>
<p>PS: Is there any way you can attach to the processes with gdb ? I  
<br>
would like to see the backtrace as showed by gdb in order to be able  
<br>
to figure out what's wrong there.
<br>
<p><p>On Jan 4, 2007, at 2:00 PM, Grobe, Gary L. ((JSC-EV))[ESCG] wrote:
<br>
