...
<!-- received="Sat Sep 29 10:36:10 2007" -->
<!-- isoreceived="20070929143610" -->
<!-- sent="Sat, 29 Sep 2007 10:36:06 -0400" -->
<!-- isosent="20070929143606" -->
<!-- name="Tim Mattox" -->
<!-- email="timattox_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI Giving problems when using -mca btl mx, sm, self" -->
<!-- id="ea86ce220709290736t1b3894afqa764be2f1435bb31_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2007-09-29 10:36:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4102.php">James Conway: "[OMPI users] Make error - MacOSX, Intel v10 compilers and Xgrid MCA"</a>
<li><strong>Previous message:</strong> <a href="4100.php">Tim Prins: "Re: [OMPI users] OpenMPI Giving problems when using -mca btl mx, sm, self"</a>
<li><strong>In reply to:</strong> <a href="4100.php">Tim Prins: "Re: [OMPI users] OpenMPI Giving problems when using -mca btl mx, sm, self"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2007/10/4106.php">Hammad Siddiqi: "Re: [OMPI users] OpenMPI Giving problems when using -mca btl mx, sm, self"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On 9/29/07, Tim Prins &lt;tprins_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; /opt/SUNWhpc/HPC7.0/bin/mpirun -np 2 -mca btl
</span><br>
<span class="quotelev1">&gt; mx,self  -host &quot;indus1,indus2&quot; -mca btl_base_debug 1000 ./hello
</span><br>
<span class="quotelev1">&gt;
</span><br>
