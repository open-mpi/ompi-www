...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3973.php">Glenn Carver: "Re: [OMPI users] memory leaks on solaris"</a>
<li><strong>Previous message:</strong> <a href="3971.php">Corey Putkunz: "[OMPI users] MPI_Read_file and MPI_Write_file fails"</a>
<li><strong>In reply to:</strong> <a href="3971.php">Corey Putkunz: "[OMPI users] MPI_Read_file and MPI_Write_file fails"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3974.php">Corey Putkunz: "Re: [OMPI users] MPI_Read_file and MPI_Write_file fails"</a>
<li><strong>Reply:</strong> <a href="3974.php">Corey Putkunz: "Re: [OMPI users] MPI_Read_file and MPI_Write_file fails"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
