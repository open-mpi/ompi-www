<?
$subject_val = "Re: [OMPI users] memory leaks on solaris";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3971.php">Corey Putkunz: "Re: [OMPI users] MPI_Read_file and MPI_Write_file fails"</a>
<li><strong>Previous message:</strong> <a href="3969.php">Edgar Gabriel: "Re: [OMPI users] MPI_Read_file and MPI_Write_file fails"</a>
<li><strong>In reply to:</strong> <a href="../../2007/08/3838.php">Don Kerr: "Re: [OMPI users] memory leaks on solaris"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
