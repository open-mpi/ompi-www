...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3972.php">Edgar Gabriel: "Re: [OMPI users] MPI_Read_file and MPI_Write_file fails"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2007/08/3970.php">Bernd Schubert: "Re: [OMPI users] buildsystem / adio-lustre-mpich2-v02.patch"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3972.php">Edgar Gabriel: "Re: [OMPI users] MPI_Read_file and MPI_Write_file fails"</a>
<li><strong>Reply:</strong> <a href="3972.php">Edgar Gabriel: "Re: [OMPI users] MPI_Read_file and MPI_Write_file fails"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
