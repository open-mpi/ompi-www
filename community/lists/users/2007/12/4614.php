...
?>
<!-- received="Thu Dec  6 10:16:29 2007" -->
<!-- isoreceived="20071206151629" -->
<!-- sent="Thu, 6 Dec 2007 09:16:18 -0600" -->
<!-- isosent="20071206151618" -->
<!-- name="Jeffrey M Ceason" -->
<!-- email="ceason_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Using mtrace with openmpi segfaults" -->
<!-- id="OFA20E2BF5.F4017897-ON862573A9.00538ED1-862573A9.0053E58C_at_us.ibm.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="E834CEE4-6DAE-49B0-986A-46AF722FE052_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-12-06 10:16:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4615.php">Jeff Squyres: "Re: [OMPI users] Using mtrace with openmpi segfaults"</a>
<li><strong>Previous message:</strong> <a href="4613.php">Sajjad Tabib: "Re: [OMPI users] Using mtrace with openmpi segfaults"</a>
<li><strong>In reply to:</strong> <a href="4604.php">Jeff Squyres: "Re: [OMPI users] Using mtrace with openmpi segfaults"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4620.php">Jeff Squyres: "Re: [OMPI users] Using mtrace with openmpi segfaults"</a>
<li><strong>Reply:</strong> <a href="4620.php">Jeff Squyres: "Re: [OMPI users] Using mtrace with openmpi segfaults"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>We have these options set but are getting memory corruption that moves 
<br>
around realloc in the program.
<br>
<p>&nbsp;mallopt(M_MMAP_MAX, 0);
<br>
&nbsp;mallopt(M_TRIM_THRESHOLD, -1);
<br>
<p><p><p><p><p>Jeff Squyres &lt;jsquyres_at_[hidden]&gt; 
<br>
...
<br>
<p><p><p><p><p><p>I have not tried to use mtrace myself.  But I can see how it would be 
<br>
...
configuring with:
<br>
<p>&nbsp;&nbsp;&nbsp;./configure --without-memory-manager
<br>
<p><p>On Dec 3, 2007, at 6:23 PM, Jeffrey M Ceason wrote:
<br>
<p><span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Having trouble using mtrace with openmpi.  Whenever I use the mtrace 
</span><br>
<span class="quotelev1">&gt; call before or after MPI_Init the application terminates.  This only 
</span><br>
<span class="quotelev1">&gt; seems to happen using mpi.  Is there a way to disable the open-mpi 
</span><br>
<span class="quotelev1">&gt; memory wrappers?  Is there known issues with users applications 
</span><br>
<span class="quotelev1">&gt; using mallopts and the mallopts used by open-mpi?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Machine is AMD64 Fedora Core 7
</span><br>
<span class="quotelev1">&gt; [ceason_at_n01-044-0 minib]$ uname -a
</span><br>
<span class="quotelev1">&gt; Linux n01-044-0 2.6.22-rr #1 SMP Fri Nov 16 15:28:53 CST 2007 x86_64 
</span><br>
<span class="quotelev1">&gt; x86_64 x86_64 GNU/Linux
</span><br>
<span class="quotelev1">&gt; [ceason_at_n01-044-0 minib]$
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Test source.
</span><br>
...
<span class="quotelev1">&gt; #include &lt;mcheck.h&gt;
</span><br>
...
<span class="quotelev1">&gt; [ceason_at_n01-044-0 minib]$ mpiCC dacs_test.cc -o trace_test
</span><br>
<span class="quotelev1">&gt; [ceason_at_n01-044-0 minib]$ mpirun -np 1 trace_test
</span><br>
<span class="quotelev1">&gt; mpirun noticed that job rank 0 with PID 7078 on node n01-044-0 
</span><br>
<span class="quotelev1">&gt; exited on signal 8 (Floating point exception).
</span><br>
<span class="quotelev1">&gt; [ceason_at_n01-044-0 minib]$
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; backtrace of core
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Core was generated by `trace_test'.
</span><br>
<span class="quotelev1">&gt; Program terminated with signal 8, Arithmetic exception.
</span><br>
<span class="quotelev1">&gt; #0  0x00002b33169d4abc in sYSTRIm () from /lib64/libc.so.6
</span><br>
<span class="quotelev1">&gt; (gdb) bt
</span><br>
<span class="quotelev1">&gt; #0  0x00002b33169d4abc in sYSTRIm () from /lib64/libc.so.6
</span><br>
<span class="quotelev1">&gt; #1  0x00002b33169d71c2 in _int_free () from /lib64/libc.so.6
</span><br>
<span class="quotelev1">&gt; #2  0x00002b33169dab1c in free () from /lib64/libc.so.6
</span><br>
<span class="quotelev1">&gt; #3  0x00002b33169dcee8 in tr_freehook () from /lib64/libc.so.6
</span><br>
<span class="quotelev1">&gt; #4  0x00002b33157674f3 in free () from /usr/local/openmpi/lib64/ 
</span><br>
<span class="quotelev1">&gt; libopen-pal.so.0
</span><br>
<span class="quotelev1">&gt; #5  0x00002b33169ceaf1 in vasprintf () from /lib64/libc.so.6
</span><br>
<span class="quotelev1">&gt; #6  0x00002b33169b3088 in asprintf () from /lib64/libc.so.6
</span><br>
<span class="quotelev1">&gt; #7  0x00002b3315760c7d in opal_output_init () from /usr/local/ 
</span><br>
<span class="quotelev1">&gt; openmpi/lib64/libopen-pal.so.0
</span><br>
<span class="quotelev1">&gt; #8  0x00002b3315760a2a in do_open () from /usr/local/openmpi/lib64/ 
</span><br>
<span class="quotelev1">&gt; libopen-pal.so.0
</span><br>
<span class="quotelev1">&gt; #9  0x00002b331575f958 in opal_malloc_init () from /usr/local/ 
</span><br>
<span class="quotelev1">&gt; openmpi/lib64/libopen-pal.so.0
</span><br>
<span class="quotelev1">&gt; #10 0x00002b331574ac27 in opal_init_util () from /usr/local/openmpi/ 
</span><br>
<span class="quotelev1">&gt; lib64/libopen-pal.so.0
</span><br>
<span class="quotelev1">&gt; #11 0x00002b331574ad06 in opal_init () from /usr/local/openmpi/lib64/ 
</span><br>
<span class="quotelev1">&gt; libopen-pal.so.0
</span><br>
<span class="quotelev1">&gt; #12 0x00002b3315283edf in ompi_mpi_init () from /usr/local/openmpi/ 
</span><br>
<span class="quotelev1">&gt; lib64/libmpi.so.0
</span><br>
<span class="quotelev1">&gt; #13 0x00002b33152a54f0 in PMPI_Init () from /usr/local/openmpi/lib64/ 
</span><br>
<span class="quotelev1">&gt; libmpi.so.0
</span><br>
<span class="quotelev1">&gt; #14 0x0000000000408397 in main ()
</span><br>
<span class="quotelev1">&gt; (gdb)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Shouldn't involve communications between machines but here is the IB 
</span><br>
<span class="quotelev1">&gt; Info.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; [ceason_at_n01-044-0 minib]$ ibv_devinfo
</span><br>
<span class="quotelev1">&gt; hca_id: mlx4_0
</span><br>
<span class="quotelev1">&gt;         fw_ver:                         2.2.000
</span><br>
<span class="quotelev1">&gt;         node_guid:                      0002:c903:0000:17d0
</span><br>
<span class="quotelev1">&gt;         sys_image_guid:                 0002:c903:0000:17d3
</span><br>
...
<span class="quotelev1">&gt;         board_id:                       MT_04A0110002
</span><br>
...
<span class="quotelev1">&gt; [ceason_at_n01-044-0 minib]$ ulimit -l
</span><br>
...
<span class="quotelev1">&gt; ompi_info -all output
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;                  MCA ras: tm (MCA v1.0, API v1.3, Component v1.2.4)
</span><br>
...
<span class="quotelev1">&gt;                  MCA pls: tm (MCA v1.0, API v1.3, Component v1.2.4)
</span><br>
...
<span class="quotelev1">&gt;                   Bindir: /usr/local/openmpi/bin
</span><br>
<span class="quotelev1">&gt;                   Libdir: /usr/local/openmpi/lib64
</span><br>
<span class="quotelev1">&gt;                   Incdir: /usr/local/openmpi/include
</span><br>
<span class="quotelev1">&gt;                Pkglibdir: /usr/local/openmpi/lib64/openmpi
</span><br>
<span class="quotelev1">&gt;               Sysconfdir: /usr/local/openmpi/etc
</span><br>
<span class="quotelev1">&gt;  Configured architecture: x86_64-redhat-linux-gnu
</span><br>
<span class="quotelev1">&gt;            Configured by: root
</span><br>
<span class="quotelev1">&gt;            Configured on: Sun Nov 18 14:44:52 CST 2007
</span><br>
<span class="quotelev1">&gt;           Configure host: wwim0-0
</span><br>
<span class="quotelev1">&gt;                 Built by: root
</span><br>
<span class="quotelev1">&gt;                 Built on: Sun Nov 18 14:51:43 CST 2007
</span><br>
<span class="quotelev1">&gt;               Built host: wwim0-0
</span><br>
...
<span class="quotelev1">&gt;             Build CFLAGS: -O3 -DNDEBUG -m64 -I/usr/local/OFED/ 
</span><br>
<span class="quotelev1">&gt; include -finline-functions -fno-strict-aliasing -pthread
</span><br>
<span class="quotelev1">&gt;           Build CXXFLAGS: -O3 -DNDEBUG -m64 -I/usr/local/OFED/ 
</span><br>
<span class="quotelev1">&gt; include -finline-functions -pthread
</span><br>
...
<span class="quotelev1">&gt;            Build LDFLAGS: -export-dynamic -m64 -L/lib64 -L/usr/lib64 
</span><br>
<span class="quotelev1">&gt; -L/usr/local/OFED/lib64
</span><br>
...
<span class="quotelev1">&gt; value: &quot;/home/usr1/ceason/.openmpi/mca-params.conf:/usr/local/ 
</span><br>
...
<span class="quotelev1">&gt; value: &quot;/usr/local/openmpi/lib64/openmpi:/home/usr1/ceason/.openmpi/ 
</span><br>
...
<span class="quotelev1">&gt; negative delay value means to never abort).  This allows attaching 
</span><br>
<span class="quotelev1">&gt; of a debugger before quitting the job.
</span><br>
...
<span class="quotelev1">&gt; repeatedly sending and receiving large messages with the same 
</span><br>
...
<span class="quotelev1">&gt; @mpirun_args@ : ddt -n @np@ -start @executable@ @executable_argv@ 
</span><br>
<span class="quotelev1">&gt; @single_app@ : fxp @mpirun@ -a @mpirun_args@&quot;)
</span><br>
...
<span class="quotelev1">&gt; &quot;paffinity_base_verbose&quot; (current value: &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt; &quot;maffinity_base_verbose&quot; (current value: &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt; you have a 100'000 nodes you might not want to pre-allocate 200'000 
</span><br>
...
<span class="quotelev1">&gt; an operation, it build it dynamically. This parameter is only for 
</span><br>
...
<span class="quotelev1">&gt;                MCA mpool: parameter &quot;mpool_sm_verbose&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt; &quot;btl_openib_warn_no_hca_params_found&quot; (current value: &quot;1&quot;)
</span><br>
<span class="quotelev1">&gt;                           Warn when no HCA-specific parameters are 
</span><br>
<span class="quotelev1">&gt; found in the INI file specified by the btl_openib_hca_param_files 
</span><br>
<span class="quotelev1">&gt; MCA parameter (0 = do not warn; any other value = warn)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_warn_default_gid_prefix&quot; (current value: &quot;1&quot;)
</span><br>
...
<span class="quotelev1">&gt; default GID prefix configured (0 = do not warn; any other value = 
</span><br>
<span class="quotelev1">&gt; warn)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_want_fork_support&quot; (current value: &quot;-1&quot;)
</span><br>
<span class="quotelev1">&gt;                           Whether fork support is desired or not 
</span><br>
<span class="quotelev1">&gt; (negative = try to enable fork support, but continue even if it is 
</span><br>
<span class="quotelev1">&gt; not available, 0 = do not enable fork support, positive = try to 
</span><br>
<span class="quotelev1">&gt; enable fork support and fail if it is not available)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_hca_param_files&quot; (current value: &quot;/usr/local/openmpi/ 
</span><br>
<span class="quotelev1">&gt; share/openmpi/mca-btl-openib-hca-params.ini&quot;)
</span><br>
<span class="quotelev1">&gt;                           Colon-delimited list of INI-style files 
</span><br>
<span class="quotelev1">&gt; that contain HCA vendor/part-specific parameters
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_max_btls&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;-1&quot;)
</span><br>
<span class="quotelev1">&gt;                           Maximum number of HCA ports to use (-1 = 
</span><br>
<span class="quotelev1">&gt; use all available, otherwise must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_free_list_num&quot; (current value: &quot;8&quot;)
</span><br>
<span class="quotelev1">&gt;                           Intial size of free lists (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_free_list_max&quot; (current value: &quot;-1&quot;)
</span><br>
...
<span class="quotelev1">&gt; &quot;btl_openib_free_list_inc&quot; (current value: &quot;32&quot;)
</span><br>
<span class="quotelev1">&gt;                           Increment size of free lists (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_mpool&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;rdma&quot;)
</span><br>
...
<span class="quotelev1">&gt; &quot;btl_openib_reg_mru_len&quot; (current value: &quot;16&quot;)
</span><br>
...
<span class="quotelev1">&gt;                           Size of the IB completion queue (will 
</span><br>
<span class="quotelev1">&gt; automatically be set to a minimum of (2 * number_of_peers * 
</span><br>
<span class="quotelev1">&gt; btl_openib_rd_num))
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_ib_sg_list_size&quot; (current value: &quot;4&quot;)
</span><br>
<span class="quotelev1">&gt;                           Size of IB segment list (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_ib_pkey_ix&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt; &quot;btl_openib_ib_pkey_val&quot; (current value: &quot;0&quot;)
</span><br>
<span class="quotelev1">&gt;                           InfiniBand pkey value(must be &gt; 0 and &lt; 
</span><br>
<span class="quotelev1">&gt; 0xffff)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_ib_psn&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
<span class="quotelev1">&gt;                           InfiniBand packet sequence starting number 
</span><br>
<span class="quotelev1">&gt; (must be &gt;= 0)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_ib_qp_ous_rd_atom&quot; (current value: &quot;4&quot;)
</span><br>
<span class="quotelev1">&gt;                           InfiniBand outstanding atomic reads (must 
</span><br>
...
<span class="quotelev1">&gt;                           IB MTU, in bytes (if not specified in INI 
</span><br>
<span class="quotelev1">&gt; files).  Valid values are: 1=256 bytes, 2=512 bytes, 3=1024 bytes, 
</span><br>
<span class="quotelev1">&gt; 4=2048 bytes, 5=4096 bytes
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_ib_min_rnr_timer&quot; (current value: &quot;5&quot;)
</span><br>
...
<span class="quotelev1">&gt; and &lt;= 31)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_ib_retry_count&quot; (current value: &quot;7&quot;)
</span><br>
<span class="quotelev1">&gt;                           InfiniBand transmit retry count (must be 
</span><br>
<span class="quotelev2">&gt; &gt;= 0 and &lt;= 7)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_ib_rnr_retry&quot; (current value: &quot;7&quot;)
</span><br>
<span class="quotelev1">&gt;                           InfiniBand &quot;receiver not ready&quot; retry 
</span><br>
<span class="quotelev1">&gt; count (must be &gt;= 0 and &lt;= 7)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_ib_max_rdma_dst_ops&quot; (current value: &quot;4&quot;)
</span><br>
<span class="quotelev1">&gt;                           InfiniBand maximum pending RDMA 
</span><br>
<span class="quotelev1">&gt; destination operations (must be &gt;= 0)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_ib_service_level&quot; (current value: &quot;0&quot;)
</span><br>
<span class="quotelev1">&gt;                           InfiniBand service level (must be &gt;= 0)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_ib_static_rate&quot; (current value: &quot;0&quot;)
</span><br>
<span class="quotelev1">&gt;                           InfiniBand static rate (must be &gt;= 0; 
</span><br>
<span class="quotelev1">&gt; defulat: %d)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_exclusivity&quot; (current value: &quot;1024&quot;)
</span><br>
<span class="quotelev1">&gt;                           OpenIB BTL exclusivity (must be &gt;= 0)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_rd_num&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;8&quot;)
</span><br>
<span class="quotelev1">&gt;                           Number of receive descriptors to post to a 
</span><br>
<span class="quotelev1">&gt; queue pair (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_rd_low&quot; (current 
</span><br>
...
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_rd_win&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;4&quot;)
</span><br>
<span class="quotelev1">&gt;                           Window size at which generate explicit 
</span><br>
<span class="quotelev1">&gt; credit message (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_use_srq&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
<span class="quotelev1">&gt;                           If nonzero, use the InfiniBand shared 
</span><br>
<span class="quotelev1">&gt; receive queue (&quot;SRQ&quot;)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_srq_rd_max&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;1000&quot;)
</span><br>
<span class="quotelev1">&gt;                           Maxium number of receive descriptors 
</span><br>
<span class="quotelev1">&gt; posted per SRQ (only relevant if btl_openib_use_srq is true; must be 
</span><br>
<span class="quotelev2">&gt; &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_srq_rd_per_peer&quot; (current value: &quot;16&quot;)
</span><br>
<span class="quotelev1">&gt;                           Number of receive descriptors posted per 
</span><br>
<span class="quotelev1">&gt; peer in the SRQ (only relevant if btl_openib_use_srq is true; must 
</span><br>
<span class="quotelev1">&gt; be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_srq_sd_max&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;8&quot;)
</span><br>
<span class="quotelev1">&gt;                           Maximum number of send descriptors posted 
</span><br>
<span class="quotelev1">&gt; (only relevant if btl_openib_use_srq is true; must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_use_eager_rdma&quot; (current value: &quot;1&quot;)
</span><br>
<span class="quotelev1">&gt;                           Use RDMA for eager messages
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_eager_rdma_threshold&quot; (current value: &quot;16&quot;)
</span><br>
...
<span class="quotelev1">&gt; &quot;btl_openib_max_eager_rdma&quot; (current value: &quot;16&quot;)
</span><br>
<span class="quotelev1">&gt;                           Maximum number of peers allowed to use 
</span><br>
<span class="quotelev1">&gt; RDMA for short messages (RDMA is used for all long messages, except 
</span><br>
<span class="quotelev1">&gt; if explicitly disabled, such as with the &quot;dr&quot; pml) (must be &gt;= 0)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_eager_rdma_num&quot; (current value: &quot;16&quot;)
</span><br>
<span class="quotelev1">&gt;                           Number of RDMA buffers to allocate for 
</span><br>
<span class="quotelev1">&gt; small messages(must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_btls_per_lid&quot; (current value: &quot;1&quot;)
</span><br>
<span class="quotelev1">&gt;                           Number of BTLs to create for each 
</span><br>
<span class="quotelev1">&gt; InfiniBand LID (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_max_lmc&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
<span class="quotelev1">&gt;                           Maximum number of LIDs to use for each HCA 
</span><br>
<span class="quotelev1">&gt; port (must be &gt;= 0, where 0 = use all available)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_buffer_alignment&quot; (current value: &quot;64&quot;)
</span><br>
<span class="quotelev1">&gt;                           Prefered communication buffer alignment, 
</span><br>
<span class="quotelev1">&gt; in bytes (must be &gt;= 0)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_eager_limit&quot; (current value: &quot;12288&quot;)
</span><br>
<span class="quotelev1">&gt;                           Eager send limit, in bytes (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_min_send_size&quot; (current value: &quot;32768&quot;)
</span><br>
<span class="quotelev1">&gt;                           Minimum send size, in bytes (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_max_send_size&quot; (current value: &quot;65536&quot;)
</span><br>
<span class="quotelev1">&gt;                           Maximum send size, in bytes (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_min_rdma_size&quot; (current value: &quot;1048576&quot;)
</span><br>
<span class="quotelev1">&gt;                           Minimum RDMA size, in bytes (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_max_rdma_size&quot; (current value: &quot;1048576&quot;)
</span><br>
<span class="quotelev1">&gt;                           Maximium RDMA size, in bytes (must be &gt;= 1)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_flags&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;54&quot;)
</span><br>
<span class="quotelev1">&gt;                           BTL flags, added together: SEND=1, PUT=2, 
</span><br>
<span class="quotelev1">&gt; GET=4 (cannot be 0)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: parameter &quot;btl_openib_bandwidth&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
<span class="quotelev1">&gt;                           Approximate maximum bandwidth of each 
</span><br>
<span class="quotelev1">&gt; network interface in megabits per second (if 0, filled in at run- 
</span><br>
<span class="quotelev1">&gt; time by querying the HCA, otherwise must be &gt; 0)
</span><br>
<span class="quotelev1">&gt;                  MCA btl: information 
</span><br>
<span class="quotelev1">&gt; &quot;btl_openib_have_fork_support&quot; (value: &quot;1&quot;)
</span><br>
<span class="quotelev1">&gt;                           Whether the OpenFabrics stack supports 
</span><br>
<span class="quotelev1">&gt; applications that invoke the &quot;fork()&quot; system call or not (0 = no, 1 
</span><br>
<span class="quotelev1">&gt; = yes).  Note that this value does NOT indicate whether the system 
</span><br>
<span class="quotelev1">&gt; being run on supports &quot;fork()&quot; with OpenFabrics applications or not.
</span><br>
...
<span class="quotelev1">&gt; value: &quot;apnet0,apnet1,apnet2,apnet3&quot;)
</span><br>
...
<span class="quotelev1">&gt;                  MCA gpr: parameter &quot;gpr_base_verbose&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt;                  MCA iof: parameter &quot;iof_base_verbose&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt;                   MCA ns: parameter &quot;ns_base_verbose&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt;                  MCA oob: parameter &quot;oob_base_include&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &lt;none&gt;)
</span><br>
<span class="quotelev1">&gt;                           Components to include for oob framework 
</span><br>
<span class="quotelev1">&gt; selection
</span><br>
<span class="quotelev1">&gt;                  MCA oob: parameter &quot;oob_base_exclude&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &lt;none&gt;)
</span><br>
<span class="quotelev1">&gt;                           Components to exclude for oob framework 
</span><br>
<span class="quotelev1">&gt; selection
</span><br>
<span class="quotelev1">&gt;                  MCA ras: parameter &quot;ras_base_verbose&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
<span class="quotelev1">&gt;                           Enable debugging for the RAS framework 
</span><br>
<span class="quotelev1">&gt; (nonzero = enabled)
</span><br>
...
<span class="quotelev1">&gt;                  MCA ras: parameter &quot;ras_tm_nodefile_dir&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;/var/torque/aux&quot;)
</span><br>
<span class="quotelev1">&gt;                           The directory where the PBS nodefile can 
</span><br>
<span class="quotelev1">&gt; be found
</span><br>
<span class="quotelev1">&gt;                  MCA rds: parameter &quot;rds_base_verbose&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt; value: &quot;/usr/local/openmpi/etc/openmpi-default-hostfile&quot;)
</span><br>
...
<span class="quotelev1">&gt; &quot;rmaps_base_display_map&quot; (current value: &quot;0&quot;)
</span><br>
<span class="quotelev1">&gt;                           Whether to display the process map after 
</span><br>
<span class="quotelev1">&gt; it is computed
</span><br>
...
<span class="quotelev1">&gt;                 MCA rmgr: parameter &quot;rmgr_base_verbose&quot; (current 
</span><br>
<span class="quotelev1">&gt; value: &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt;                  MCA rml: parameter &quot;rml_base_debug&quot; (current value: 
</span><br>
<span class="quotelev1">&gt; &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt;                  MCA pls: parameter &quot;pls_tm_verbose&quot; (current value: 
</span><br>
<span class="quotelev1">&gt; &quot;0&quot;)
</span><br>
...
<span class="quotelev1">&gt; &quot;pls_tm_want_path_check&quot; (current value: &quot;1&quot;)
</span><br>
<span class="quotelev1">&gt;                           Whether the launching process should check 
</span><br>
<span class="quotelev1">&gt; for the pls_tm_orted executable in the PATH before launching (the TM 
</span><br>
<span class="quotelev1">&gt; API does not give an idication of failure; this is a somewhat-lame 
</span><br>
...
<span class="quotelev1">&gt; Jeff  Ceason
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-4614/attachment">attachment</a>
</ul>
