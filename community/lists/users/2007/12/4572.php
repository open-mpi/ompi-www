...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4573.php">Prakash Velayutham: "[OMPI users] Simple MPI_Comm_spawn program hangs"</a>
<li><strong>Previous message:</strong> <a href="4571.php">George Bosilca: "Re: [OMPI users] Shared memory communication limits parallelism?"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2007/11/4568.php">Madireddy Samuel Vijaykumar: "Re: [OMPI users] Newbie: Using hostfile"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
