<?
$subject_val = "[OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3163.php">Jeff Squyres: "Re: [OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error"</a>
<li><strong>Previous message:</strong> <a href="../../2007/04/3161.php">Brian Barrett: "Re: [OMPI users] Problem running hpcc with a threaded BLAS"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3163.php">Jeff Squyres: "Re: [OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error"</a>
<li><strong>Reply:</strong> <a href="3163.php">Jeff Squyres: "Re: [OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error"</a>
<li><strong>Reply:</strong> <a href="3166.php">Brian Barrett: "Re: [OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error"</a>
<li><strong>Maybe reply:</strong> <a href="3167.php">Rob: "Re: [OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-3162/attachment">attachment</a>
</ul>
