<?
$subject_val = "Re: [OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3164.php">Jeff Squyres: "Re: [OMPI users] MPI_Comm_Accept / MPI::Comm::Accept problem."</a>
<li><strong>Previous message:</strong> <a href="3162.php">Rob: "[OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error"</a>
<li><strong>In reply to:</strong> <a href="3162.php">Rob: "[OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3166.php">Brian Barrett: "Re: [OMPI users] OpenMPI 1.2.1: &quot;configure --enable-static&quot;: then make ends with error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
