...
<!-- received="Wed May  9 14:19:23 2007" -->
<!-- isoreceived="20070509181923" -->
<!-- sent="Wed, 9 May 2007 11:19:18 -0700" -->
<!-- isosent="20070509181918" -->
<!-- name="Steven Truong" -->
<!-- email="midair77_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Newbie question. Please help." -->
<!-- id="28bb77d30705091119y31ce2d7bk8678a4e4275f695c_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="28bb77d30705091102h3cbc3978u9284ef2e7f2b8b87_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-05-09 14:19:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3226.php">Jeff Squyres: "Re: [OMPI users] Newbie question. Please help."</a>
<li><strong>Previous message:</strong> <a href="3224.php">Steven Truong: "Re: [OMPI users] Newbie question. Please help."</a>
<li><strong>In reply to:</strong> <a href="3224.php">Steven Truong: "Re: [OMPI users] Newbie question. Please help."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3226.php">Jeff Squyres: "Re: [OMPI users] Newbie question. Please help."</a>
<li><strong>Reply:</strong> <a href="3226.php">Jeff Squyres: "Re: [OMPI users] Newbie question. Please help."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; I forgot to mention that our environment has Intel MKL 9.0 or 8.1 and
</span><br>
...
<span class="quotelev1">&gt; Attached is my makefile for VASP and I am not sure if I missed anything again.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; Thank Kevin and Brook for replying to my question.  I am going to try
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; We use VASP 4.6 in parallel with opemmpi 1.1.2 without any problems on
</span><br>
<span class="quotelev3">&gt; &gt; &gt; x86_64 with opensuse and compiled with gcc and Intel fortran and use
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; I used the ACLM math lapack libs and built Blacs and Scalapack with them
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; to the end of the make file, It doesn't look like it is in the example
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; Hi, all.  I am new to OpenMPI and after initial setup I tried to run
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; mpiexec noticed that job rank 2 with PID 16675 on node node07 exited
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;            MCA backtrace: execinfo (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;               MCA memory: ptmalloc2 (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;            MCA paffinity: linux (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;            MCA maffinity: first_use (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;            MCA maffinity: libnuma (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                MCA timer: linux (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;          MCA installdirs: env (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;          MCA installdirs: config (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;                MCA mpool: rdma (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA ras: dash_host (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA ras: gridengine (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA ras: localhost (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA ras: slurm (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA ras: tm (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA rds: hostfile (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA rds: proxy (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA rds: resfile (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                MCA rmaps: round_robin (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA pls: gridengine (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA pls: slurm (MCA v1.0, API v1.3, Component v1.2.1)
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA sds: singleton (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;                  MCA sds: slurm (MCA v1.0, API v1.0, Component v1.2.1)
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; As you can see, I used Gnu gcc and g++ with Intel Fortran Compiler to
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; compile Open MPI and I am not sure if there are any special flags that
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; After getting mpif90, I compiled my application (VASP) with this new
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/local/openmpi-1.2.1/bin/mpiexec -mca mpi_paffinity_alone 1 -np
</span><br>
