<?
$subject_val = "[OMPI users] mpirun does not set the PATH and LD_LIBRARY_PATH under zsh";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2742.php">Ralph Castain: "Re: [OMPI users] MPI_Comm_Spawn"</a>
<li><strong>Previous message:</strong> <a href="2740.php">Rozzen.VINCONT_at_[hidden]: "Re: [OMPI users] MPI_Comm_Spawn"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2746.php">Jeff Squyres: "Re: [OMPI users] mpirun does not set the PATH and LD_LIBRARY_PATH under zsh"</a>
<li><strong>Reply:</strong> <a href="2746.php">Jeff Squyres: "Re: [OMPI users] mpirun does not set the PATH and LD_LIBRARY_PATH under zsh"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>application/octet-stream attachment: <a href="../../att-2741/openmpi-1.2b4-zsh.patch">openmpi-1.2b4-zsh.patch</a>
</ul>
