...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2744.php">Götz Waschk: "[OMPI users] mpirun does not set the PATH and LD_LIBRARY_PATH under zsh"</a>
<li><strong>Previous message:</strong> <a href="2742.php">Jeff Squyres: "Re: [OMPI users] Cygwin build"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2745.php">Ralph Castain: "Re: [OMPI users] MPI_Comm_Spawn"</a>
<li><strong>Reply:</strong> <a href="2745.php">Ralph Castain: "Re: [OMPI users] MPI_Comm_Spawn"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-2743/ompi_info.txt">ompi_info.txt</a>
</ul>
