...
<!-- received="Sun Mar 18 17:28:25 2007" -->
<!-- isoreceived="20070318212825" -->
<!-- sent="Sun, 18 Mar 2007 15:28:18 -0600" -->
<!-- isosent="20070318212818" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Signal 13" -->
<!-- id="C2230B12.20AE%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="d0b79b10703181306u4f201ad1h13ab205484fd5c25_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-03-18 17:28:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2827.php">David Bronke: "Re: [OMPI users] Signal 13"</a>
<li><strong>Previous message:</strong> <a href="2825.php">David Bronke: "Re: [OMPI users] Signal 13"</a>
<li><strong>In reply to:</strong> <a href="2825.php">David Bronke: "Re: [OMPI users] Signal 13"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2827.php">David Bronke: "Re: [OMPI users] Signal 13"</a>
<li><strong>Reply:</strong> <a href="2827.php">David Bronke: "Re: [OMPI users] Signal 13"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Also, be aware that other users have reported problems on LDAP-based systems
<br>
...
<br>
<p>I promised another user to concoct a fix for this problem, but am taking a
<br>
...
<p>Ralph
<br>
<p><p><p>On 3/18/07 2:06 PM, &quot;David Bronke&quot; &lt;whitelynx_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I just received an email from a friend who is helping me work on
</span><br>
<span class="quotelev1">&gt; resolving this; he was able to trace the problem back to a pipe() call
</span><br>
<span class="quotelev1">&gt; in OpenMPI apparently:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; The problem is with the pipe() system call (which is invoked by the
</span><br>
<span class="quotelev2">&gt;&gt; MPI_Send() as far as I can tell) by a LDAP authenticated user.  Still
</span><br>
<span class="quotelev2">&gt;&gt; working out where exactly that goes wrong, but the fact is that it isn't
</span><br>
<span class="quotelev2">&gt;&gt; actually a permissions problem - the reason it works as root is because
</span><br>
<span class="quotelev2">&gt;&gt; root is a local user and does /etc/passwd normal authentication.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I had forgotten to mention that we use LDAP for authentication on this
</span><br>
<span class="quotelev1">&gt; machine; PAM and NSS are set up to use it, but I'm guessing that
</span><br>
<span class="quotelev1">&gt; either OpenMPI itself or the pipe() system call won't check with them
</span><br>
<span class="quotelev1">&gt; when needed... We have made some local users on the machine to get
</span><br>
<span class="quotelev1">&gt; things going, but I'll probably have to find an LDAP mailing list to
</span><br>
<span class="quotelev1">&gt; get this issue resolved.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Thanks for all the help so far!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On 3/16/07, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; I'm afraid I have zero knowledge or experience with gentoo portage, so I
</span><br>
<span class="quotelev2">&gt;&gt; can't help you there. I always install our releases from the tarball source
</span><br>
<span class="quotelev2">&gt;&gt; as it is pretty trivial to do and avoids any issues.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I will have to defer to someone who knows that system to help you from here.
</span><br>
<span class="quotelev2">&gt;&gt; It sounds like an installation or configuration issue.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On 3/16/07 3:15 PM, &quot;David Bronke&quot; &lt;whitelynx_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On 3/15/07, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hmmm...well, a few thoughts to hopefully help with the debugging. One
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; initial comment, though - 1.1.2 is quite old. You might want to upgrade to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 1.2 (releasing momentarily - you can use the last release candidate in the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; interim as it is identical).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Version 1.2 doesn't seem to be in gentoo portage yet, so I may end up
</span><br>
<span class="quotelev3">&gt;&gt;&gt; having to compile from source... I generally prefer to do everything
</span><br>
<span class="quotelev3">&gt;&gt;&gt; from portage if possible, because it makes upgrades and maintenance
</span><br>
<span class="quotelev3">&gt;&gt;&gt; much cleaner.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Meantime, looking at this output, there appear to be a couple of common
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; possibilities. First, I don't see any of the diagnostic output from after
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; we
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; do a local fork (we do this prior to actually launching the daemon). Is it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; possible your system doesn't allow you to fork processes (some don't,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; though
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; it's unusual)?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I don't see any problems with forking on this system... I'm able to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; start a dbus daemon as a regular user without any problems.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Second, it could be that the &quot;orted&quot; program isn't being found in your
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; path.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; People often forget that the path in shells started up by programs isn't
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; necessarily the same as that in their login shell. You might try executing
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; simple shellscript that outputs the results of &quot;which orted&quot; to verify this
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is correct.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 'which orted' from a shell script gives me '/usr/bin/orted', which
</span><br>
<span class="quotelev3">&gt;&gt;&gt; seems to be correct.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; BTW, I should have asked as well: what are you running this on, and how did
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; you configure openmpi?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm running this on two identical machines with 2 dual-core
</span><br>
<span class="quotelev3">&gt;&gt;&gt; hyperthreading Xeon processors. (EM64T) I simply installed OpenMPI
</span><br>
<span class="quotelev3">&gt;&gt;&gt; using portage, with the USE flags &quot;debug fortran pbs -threads&quot;. (I've
</span><br>
<span class="quotelev3">&gt;&gt;&gt; also tried it with &quot;-debug fortran pbs threads&quot;)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 3/15/07 5:33 PM, &quot;David Bronke&quot; &lt;whitelynx_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I'm using OpenMPI version 1.1.2. I installed it using gentoo portage,
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; $ mpirun -aborted 8 -v -d --debug-daemons -np 8
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [trixie:25228] unidir:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /tmp/openmpi-sessions-bronke_at_trixie_0/default-universe
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [trixie:25228] ERROR: A daemon on node localhost failed to start as
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; subdirectories for temporary storage used for things like your shared
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; memory
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; file - the location of the head of that tree can be specified at run
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; time,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; but has a series of built-in defaults it can search if you don't specify
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; it
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; (we look at your environmental variables - e.g., TMP or TMPDIR - as well
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; as
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the typical Linux/Unix places). You might check to see what your tmp
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; directory is, and that you have write permission into it. Alternatively,
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 2. execute or access the various binaries and/or libraries. This is
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; usually
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; caused when someone installs OpenMPI as root, and then tries to execute
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; as
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I've been trying to get OpenMPI working on two of the computers at a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; lab
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; application, (/workspace/bronke/mpi/hello in this case) but there are
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; no
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; pipes in use in this app, and the fact that it works as expected as
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; sort of dead-end on this issue. Does anyone know of any way I can
</span><br>
