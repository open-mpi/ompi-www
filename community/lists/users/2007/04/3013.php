...
<!-- received="Wed Apr  4 10:26:20 2007" -->
<!-- isoreceived="20070404142620" -->
<!-- sent="Wed, 04 Apr 2007 08:26:15 -0600" -->
<!-- isosent="20070404142615" -->
<!-- name="Ralph H Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_Comm_Spawn" -->
<!-- id="C23911A7.877D%rhc_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2007-04-04 10:26:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3014.php">Jeff Squyres: "Re: [OMPI users] Hi!! Can anybody tell me how to use open mpi profiling PMPI???"</a>
<li><strong>Previous message:</strong> <a href="3012.php">pooja_at_[hidden]: "[OMPI users] Hi!! Can anybody tell me how to use open mpi profiling PMPI???"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2007/03/2763.php">Rozzen.VINCONT_at_[hidden]: "Re: [OMPI users] MPI_Comm_Spawn"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Hi there
<br>
<p>I apologize for the lengthy delay in responding to this question with a
<br>
resolution.
<br>
<p>There may be multiple issues here. The segfault you show in one test would
<br>
most likely be a symptom of a thread safety issue - I haven't been able to
<br>
replicate that specific issue. I can only recommend running without threads.
<br>
<p>The issue with the number of comm_spawns you can perform stems from a
<br>
fundamental operating system limit on the number of child processes you can
<br>
have at any one time. Since you have no nodes defined, you are running all
<br>
of your processes on your local node. In this situation, Open MPI &quot;forks&quot; a
<br>
copy of its daemon (called &quot;orted&quot;) on your node for each call to
<br>
comm_spawn. This orted subsequently &quot;forks&quot; your application process. Thus,
<br>
each call to comm_spawn results in *two* child processes on your node.
<br>
<p>Hence, you can quickly run into the limit on the number of child processes
<br>
each user is allowed to have concurrently operating.
<br>
<p>Unfortunately, there is no way around this problem at this time. We are
<br>
looking into at least providing a warning and aborting cleanly when this is
<br>
encountered, but that &quot;patch&quot; would not be back-ported to the 1.1 code
<br>
family.
<br>
<p>The only real solution to the problem you have encountered, therefore, is to
<br>
spread your processes across other nodes. Is that possible?
<br>
<p>Ralph
<br>
&nbsp;
<br>
<p><p>On 3/6/07 10:00 AM, &quot;Rozzen.VINCONT_at_[hidden]&quot;
<br>
