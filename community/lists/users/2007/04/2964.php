<?
$subject_val = "Re: [OMPI users] mca_btl_mx_init: mx_open_endpoint() failed withstatus=20";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2965.php">Barry Evans: "Re: [OMPI users] Torque/OpenMPI[Scanned]"</a>
<li><strong>Previous message:</strong> <a href="2963.php">Tim Prins: "Re: [OMPI users] Torque/OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="../../2007/03/2961.php">Tim Prins: "Re: [OMPI users] mca_btl_mx_init: mx_open_endpoint() failed with status=20"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2968.php">de Almeida, Valmor F.: "Re: [OMPI users] mca_btl_mx_init: mx_open_endpoint() failed withstatus=20"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
