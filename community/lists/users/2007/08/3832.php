...
<!-- received="Tue Aug  7 16:19:22 2007" -->
<!-- isoreceived="20070807201922" -->
<!-- sent="Tue, 7 Aug 2007 21:15:34 +0100" -->
<!-- isosent="20070807201534" -->
<!-- name="Glenn Carver" -->
<!-- email="Glenn.Carver_at_[hidden]" -->
<!-- subject="Re: [OMPI users] memory leaks on solaris" -->
<!-- id="p05111b11c2de7d450a27_at_[10.0.1.6]" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="46B86DF2.1010506_at_Sun.COM" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-08-07 16:15:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3833.php">Graham Jenkins: "Re: [OMPI users] NAMD/Charm++ Looking for libmpich"</a>
<li><strong>Previous message:</strong> <a href="3831.php">Michael Komm: "Re: [OMPI users] OpenMPI and PathScale problem"</a>
<li><strong>In reply to:</strong> <a href="3825.php">Don Kerr: "Re: [OMPI users] memory leaks on solaris"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3841.php">Don Kerr: "Re: [OMPI users] memory leaks on solaris"</a>
<li><strong>Reply:</strong> <a href="3841.php">Don Kerr: "Re: [OMPI users] memory leaks on solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Don,
<br>
<p>Following up on this, here are the results of the tests. All is well 
<br>
...
<br>
<p>The batch jobs run vmstat before and after the mpirun command. Here's 
<br>
...
<span class="quotelev1">&gt;While I look into the possibility of registered memory not being freed
</span><br>
<span class="quotelev1">&gt;could you run your same tests but without shared memory or udapl.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;If this is successful, i.e. frees memory as expected. The next step
</span><br>
<span class="quotelev1">&gt;would be to run including shared memory,  &quot;--mca btl self,sm,tcp&quot;.  If
</span><br>
<span class="quotelev1">&gt;this is successful the last step would be to add in udapl, &quot;--mca btl
</span><br>
<span class="quotelev1">&gt;self,sm,udapl&quot;.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;Guess I don't see how stale shared memory files would cause swapping to
</span><br>
<span class="quotelev3">&gt;&gt;&gt;occur. Besides, the user provided no indication that the applications were
</span><br>
<span class="quotelev3">&gt;&gt;&gt;abnormally terminating, which makes it likely we cleaned up the session
</span><br>
<span class="quotelev3">&gt;&gt;&gt;directories as we should.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;However, we definitely leak memory (i.e., we don't free all memory we malloc
</span><br>
<span class="quotelev3">&gt;&gt;&gt;while supporting execution of an application), so if the OS isn't cleaning
</span><br>
<span class="quotelev3">&gt;&gt;&gt;up after us, it is quite possible we could be causing the problem as
</span><br>
<span class="quotelev3">&gt;&gt;&gt;described. It would appear exactly as described - a slow leak that gradually
</span><br>
<span class="quotelev3">&gt;&gt;&gt;builds up until the &quot;dead&quot; area was so big that it forces applications to
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;1. are the Open MPI applications exiting cleanly? Do you see any stale
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&quot;orted&quot; executables still in the process table?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;2. can you check the temp directory where we would be operating? This is
</span><br>
<span class="quotelev3">&gt;&gt;&gt;usually your /tmp directory, unless you specified some other location. Look
</span><br>
<span class="quotelev3">&gt;&gt;&gt;for our session directories - they have a name that includes &quot;openmpi&quot; in
</span><br>
<span class="quotelev3">&gt;&gt;&gt;them. Are they being cleaned up (i.e., removed) when the applications exit?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;  only memory that we should be leaking after MPI processes exit would
</span><br>
<span class="quotelev4">&gt;  &gt;&gt;&gt; be shared memory files that are [somehow] not getting removed properly.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  Hmmm...just to clarify as I think there may be some confusion here.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
