...
<!-- received="Wed Aug  8 16:27:04 2007" -->
<!-- isoreceived="20070808202704" -->
<!-- sent="Wed, 8 Aug 2007 15:26:52 -0500" -->
<!-- isosent="20070808202652" -->
<!-- name="Guillaume THOMAS-COLLIGNON" -->
<!-- email="guillaume.thomas-collignon_at_[hidden]" -->
<!-- subject="[OMPI users] Help : Need some tuning, or is it a bug ?" -->
<!-- id="6428A311-9EDF-428D-945F-1F136629CCFB_at_cggveritas.com" -->
<!-- charset="US-ASCII" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-08-08 16:26:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3836.php">Ron Brightwell: "[OMPI users] Cluster'07 Call for Participation"</a>
<li><strong>Previous message:</strong> <a href="3834.php">Marcus R. Epperson: "[OMPI users] orterun mangling executable's &quot;-host&quot; argument"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3849.php">Tim Prins: "Re: [OMPI users] Help : Need some tuning, or is it a bug ?"</a>
<li><strong>Reply:</strong> <a href="3849.php">Tim Prins: "Re: [OMPI users] Help : Need some tuning, or is it a bug ?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>I wrote an application which works fine on a small number of nodes  
<br>
(eg. 4), but it crashes on a large number of CPUs.
<br>
<p>In this application, all the slaves send many small messages to the  
<br>
...
<br>
<p>But it crashes when there are too many slaves. So it looks like at  
<br>
...
<br>
<p>I have 2 questions regarding this :
<br>
<p>1) What kind of tuning would help handling more messages and keep the  
<br>
master from crashing ?
<br>
<p>2) Is this the expected behaviour ? I don't think my code is doing  
<br>
anything wrong, so I would not expect a brutal crash.
<br>
<p><p>The workaround I've found so far is to do an MPI_Ssend for the  
<br>
...
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-Guillaume
<br>
<p><p>Here is the code, so you get a better idea of the communication  
<br>
...
<br>
<p>&nbsp;&nbsp;&nbsp;if ((data = (int *) calloc (BLOCKSIZE, sizeof (int))) == NULL)
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;return -10;
<br>
<p>&nbsp;&nbsp;&nbsp;// Master
...
request, slave);
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;/* Receive the data blocks from this slave */
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;for (j=0; j&lt;request; j++) {
<br>
...
<br>
<p><p><p>Here is some info about my OpenMPI build :
<br>
<p>/usr/local/openmpi-1.2.3/bin/ompi_info --all
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Open MPI: 1.2.3
<br>
