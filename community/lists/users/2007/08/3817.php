...
<!-- received="Mon Aug  6 21:00:35 2007" -->
<!-- isoreceived="20070807010035" -->
<!-- sent="Tue, 7 Aug 2007 02:00:07 +0100" -->
<!-- isosent="20070807010007" -->
<!-- name="Glenn Carver" -->
<!-- email="Glenn.Carver_at_[hidden]" -->
<!-- subject="Re: [OMPI users] memory leaks on solaris" -->
<!-- id="p05111b12c2dd71b865f1_at_[10.0.1.6]" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="C2DD1B57.3808%rhc_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-08-06 21:00:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3818.php">Brock Palen: "Re: [OMPI users] NAMD/Charm++ Looking for libmpich"</a>
<li><strong>Previous message:</strong> <a href="3816.php">Ralph Castain: "Re: [OMPI users] memory leaks on solaris"</a>
<li><strong>In reply to:</strong> <a href="3816.php">Ralph Castain: "Re: [OMPI users] memory leaks on solaris"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3823.php">Jeff Squyres: "Re: [OMPI users] memory leaks on solaris"</a>
<li><strong>Reply:</strong> <a href="3823.php">Jeff Squyres: "Re: [OMPI users] memory leaks on solaris"</a>
<li><strong>Reply:</strong> <a href="3825.php">Don Kerr: "Re: [OMPI users] memory leaks on solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
lsof.
<br>
<p>We installed Sun's clustertools 6 (not based on openmpi) and we don't 
<br>
...
<p>Thanks, Glenn
<br>
<p><p><span class="quotelev1">&gt;Guess I don't see how stale shared memory files would cause swapping to
</span><br>
...
<span class="quotelev1">&gt;However, we definitely leak memory (i.e., we don't free all memory we malloc
</span><br>
...
<span class="quotelev1">&gt;described. It would appear exactly as described - a slow leak that gradually
</span><br>
...
<span class="quotelev1">&gt;usually your /tmp directory, unless you specified some other location. Look
</span><br>
<span class="quotelev1">&gt;for our session directories - they have a name that includes &quot;openmpi&quot; in
</span><br>
<span class="quotelev1">&gt;them. Are they being cleaned up (i.e., removed) when the applications exit?
</span><br>
<span class="quotelev1">&gt;
</span><br>
