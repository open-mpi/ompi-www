<?
$subject_val = "Re: [OMPI users] Maximum message size for MPI_Send()/MPI_Recv() functions";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3790.php">Jelena Pjesivac-Grbovic: "Re: [OMPI users] Maximum message size for MPI_Send()/MPI_Recv() functions"</a>
<li><strong>Previous message:</strong> <a href="3788.php">S.Sundar Raman: "[OMPI users] unable to compile open mpi using pgf90 in AMD opteron system"</a>
<li><strong>In reply to:</strong> <a href="../../2007/07/3787.php">Juan Carlos Guzman: "[OMPI users] Maximum message size for MPI_Send()/MPI_Recv() functions"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3790.php">Jelena Pjesivac-Grbovic: "Re: [OMPI users] Maximum message size for MPI_Send()/MPI_Recv() functions"</a>
<li><strong>Reply:</strong> <a href="3790.php">Jelena Pjesivac-Grbovic: "Re: [OMPI users] Maximum message size for MPI_Send()/MPI_Recv() functions"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
