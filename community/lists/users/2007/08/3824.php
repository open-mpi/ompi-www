...
<!-- received="Tue Aug  7 09:00:37 2007" -->
<!-- isoreceived="20070807130037" -->
<!-- sent="Tue, 07 Aug 2007 08:59:30 -0400" -->
<!-- isosent="20070807125930" -->
<!-- name="Don Kerr" -->
<!-- email="Don.Kerr_at_[hidden]" -->
<!-- subject="Re: [OMPI users] memory leaks on solaris" -->
<!-- id="46B86CB2.2030706_at_Sun.COM" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="DD50611B-504E-4822-8C09-0273299E7F84_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-08-07 08:59:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3825.php">Don Kerr: "Re: [OMPI users] memory leaks on solaris"</a>
<li><strong>Previous message:</strong> <a href="3823.php">Jeff Squyres: "Re: [OMPI users] memory leaks on solaris"</a>
<li><strong>In reply to:</strong> <a href="3823.php">Jeff Squyres: "Re: [OMPI users] memory leaks on solaris"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3825.php">Don Kerr: "Re: [OMPI users] memory leaks on solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt;I guess this is a question for Sun: what happens if registered memory  
</span><br>
<span class="quotelev1">&gt;is not freed after a process exits?  Does the kernel leave it allocated?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;On Aug 6, 2007, at 7:00 PM, Glenn Carver wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;  
...
<span class="quotelev2">&gt;&gt;Just to clarify, the MPI applications exit cleanly. We have our own
</span><br>
<span class="quotelev2">&gt;&gt;f90 code (in various configurations) and I'm also testing using
</span><br>
<span class="quotelev2">&gt;&gt;Intel's IMB.  If I watch the applications whilst they run, there is a
</span><br>
<span class="quotelev2">&gt;&gt;drop in free memory as our code begins, the free memory then steadily
</span><br>
<span class="quotelev2">&gt;&gt;drops as the code runs. When it exits normally, free memory increases
</span><br>
<span class="quotelev2">&gt;&gt;but falls short of where it was before the code started. The longer
</span><br>
<span class="quotelev2">&gt;&gt;we run the code for the bigger the final drop in memory.  Taking the
</span><br>
<span class="quotelev2">&gt;&gt;machine down to single user mode doesn't help so it's not an issue of
</span><br>
<span class="quotelev2">&gt;&gt;processes still running. Neither can I find any files still open with
</span><br>
<span class="quotelev2">&gt;&gt;lsof.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;We installed Sun's clustertools 6 (not based on openmpi) and we don't
</span><br>
<span class="quotelev2">&gt;&gt;see the same problem.  I'm currently testing whether setting
</span><br>
<span class="quotelev2">&gt;&gt;btl_udapl_flags=1 makes a difference.  I'm guessing that registered
</span><br>
<span class="quotelev2">&gt;&gt;memory is leaking?  We're also trying some mca parameters to turn off
</span><br>
<span class="quotelev2">&gt;&gt;features we don't need to see if that makes a difference.  I'll
</span><br>
<span class="quotelev2">&gt;&gt;report back on point 2. below and further tests later.  If there's
</span><br>
<span class="quotelev2">&gt;&gt;specific mca parameters you'd like to see specified let me know?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;Guess I don't see how stale shared memory files would cause  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;swapping to
</span><br>
<span class="quotelev3">&gt;&gt;&gt;occur. Besides, the user provided no indication that the  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;applications were
</span><br>
<span class="quotelev3">&gt;&gt;&gt;abnormally terminating, which makes it likely we cleaned up the  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;session
</span><br>
<span class="quotelev3">&gt;&gt;&gt;directories as we should.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;However, we definitely leak memory (i.e., we don't free all memory  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;we malloc
</span><br>
<span class="quotelev3">&gt;&gt;&gt;while supporting execution of an application), so if the OS isn't  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;cleaning
</span><br>
<span class="quotelev3">&gt;&gt;&gt;up after us, it is quite possible we could be causing the problem as
</span><br>
<span class="quotelev3">&gt;&gt;&gt;described. It would appear exactly as described - a slow leak that  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;gradually
</span><br>
<span class="quotelev3">&gt;&gt;&gt;builds up until the &quot;dead&quot; area was so big that it forces  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;applications to
</span><br>
<span class="quotelev3">&gt;&gt;&gt;swap to find enough room to work.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;So I guess we should ask for clarification:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;1. are the Open MPI applications exiting cleanly? Do you see any  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;stale
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&quot;orted&quot; executables still in the process table?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;2. can you check the temp directory where we would be operating?  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;This is
</span><br>
<span class="quotelev3">&gt;&gt;&gt;usually your /tmp directory, unless you specified some other  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;location. Look
</span><br>
<span class="quotelev3">&gt;&gt;&gt;for our session directories - they have a name that includes  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&quot;openmpi&quot; in
</span><br>
<span class="quotelev3">&gt;&gt;&gt;them. Are they being cleaned up (i.e., removed) when the  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;applications exit?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;On 8/6/07 5:53 PM, &quot;Jeff Squyres&quot; &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;      
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Unless there's something weird going on in the Solaris kernel, the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; only memory that we should be leaking after MPI processes exit  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;would
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; be shared memory files that are [somehow] not getting removed  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Aug 6, 2007, at 8:15 AM, Ralph H Castain wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;        
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Hmmm...just to clarify as I think there may be some confusion  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;here.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Orte-clean will kill any outstanding Open MPI daemons (which  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; If you are having problems with zombied processes or stale  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; been &quot;leaked&quot; by Open MPI. We don't have any tools for doing  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;that, I'm
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; With CT7 there is a utility which can be used to clean up left  
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; p.s. orte-clean does not exist in the ompi v1.2 branch, it is  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; On 8/5/07 6:35 PM, &quot;Glenn Carver&quot;  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&lt;Glenn.Carver_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; We have ruled out our applications (fortran codes); we see  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;the same
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; behaviour with  Intel's IMB. We know it's not a network  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;issue as a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; parallel job running solely on the 4 cores on each node  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;produces
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; same effect. All nodes have been brought up to the very  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;latest OS
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; patches and we still see the same problem.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Details: we're running Solaris 10/06, Sun Studio 12,  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;Clustertools 7
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; for the 1.2.1 release but none have been noticed since so  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;I'm not
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; we haven't noticed any leaks since 1.2.1. We know we have  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;quite a
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; few memory
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; leaks in the code base, many of which are small in themselves  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; travels). Running a simple hello_world app under valgrind  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;will show
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; rebooting our cluster nodes every day to keep things going.  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;So any
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;            MCA paffinity: solaris (MCA v1.0, API v1.0,  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;                MCA timer: solaris (MCA v1.0, API v1.0,  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;Component
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; v1.2.1)
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;               MCA rcache: rb (MCA v1.0, API v1.0, Component  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;v1.2.1)
</span><br>
