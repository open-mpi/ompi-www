...
<!-- received="Wed Feb  7 12:28:55 2007" -->
<!-- isoreceived="20070207172855" -->
<!-- sent="Wed, 7 Feb 2007 12:28:46 -0500" -->
<!-- isosent="20070207172846" -->
<!-- name="Heywood, Todd" -->
<!-- email="heywood_at_[hidden]" -->
<!-- subject="Re: [OMPI users] large jobs hang on startup (deadlock?)" -->
<!-- id="44233CA5B57295409DA4423AECEFFEE701E64DE2_at_mailbox01.cshl.edu" -->
<!-- charset="windows-1257" -->
<!-- inreplyto="C1EE61C5.18BD%rhc_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-02-07 12:28:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2633.php">Ralph Castain: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<li><strong>Previous message:</strong> <a href="2631.php">Ralph Castain: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<li><strong>In reply to:</strong> <a href="2631.php">Ralph Castain: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2633.php">Ralph Castain: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<li><strong>Reply:</strong> <a href="2633.php">Ralph Castain: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>Unfortunately, adding &quot;-mca pls_rsh_num_concurrent 50&quot; to mpirun (with just -np and -hostfile) has no effect. The number of established connections for slapd grows to the same number at the same rate as without it. 
<br>
...
<span class="quotelev1">&gt; (1)     When I run with &#173;debug-daemons (but WITHOUT &#173;d), I
</span><br>
<span class="quotelev1">&gt; get &#179;Daemon&gt;
</span><br>
<span class="quotelev1">&gt; [0,0,27] checking in as pid 7620 on host blade28&#178; (for example)
</span><br>
...
<span class="quotelev1">&gt; sessions, and I&#185;m not sure
</span><br>
...
<span class="quotelev1">&gt; &#173;debug-daemons AND the debug
</span><br>
...
<span class="quotelev1">&gt; job is hung, I get told my username doesn&#185;t exist.
</span><br>
<span class="quotelev1">&gt; However,
</span><br>
<span class="quotelev1">&gt; I tried adding
</span><br>
<span class="quotelev1">&gt; &#173;debug to the mpirun, and got the same sequence of
</span><br>
