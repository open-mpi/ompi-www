...
<!-- received="Tue Feb  6 09:54:24 2007" -->
<!-- isoreceived="20070206145424" -->
<!-- sent="Tue, 06 Feb 2007 07:54:17 -0700" -->
<!-- isosent="20070206145417" -->
<!-- name="Ralph H Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] large jobs hang on startup (deadlock?)" -->
<!-- id="C1EDE4A9.7790%rhc_at_lanl.gov" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="44233CA5B57295409DA4423AECEFFEE701E64DD7_at_mailbox01.cshl.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-02-06 09:54:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2621.php">Jeff Squyres: "Re: [OMPI users] [OMPI Users] OpenMPI 1.1.4 over ethernet fails"</a>
<li><strong>Previous message:</strong> <a href="2619.php">Avishay Traeger: "Re: [OMPI users] MPI_Type_create_subarray fails!"</a>
<li><strong>In reply to:</strong> <a href="2618.php">Heywood, Todd: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2630.php">Heywood, Todd: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<li><strong>Reply:</strong> <a href="2630.php">Heywood, Todd: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; (1)     When I run with &#194;&#173;debug-daemons (but WITHOUT &#194;&#173;d), I get &#194;&#179;Daemon&gt;
</span><br>
<span class="quotelev1">&gt; [0,0,27] checking in as pid 7620 on host blade28&#194;&#178; (for example) messages for
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; I also notice &#194;&#179;reconnecting to LDAP server&#194;&#178; messages in various
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; /var/log/secure files, and cannot login while things are hung (with &#194;&#179;su:&gt;
</span><br>
<span class="quotelev1">&gt; pam_ldap: ldap_result Can't contact LDAP server&#194;&#178; in /var/log/messages). So
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; apparently LDAP hits some limit to opening ssh sessions, and I&#194;&#185;m not sure
</span><br>
<span class="quotelev1">&gt; how
</span><br>
<span class="quotelev1">&gt; to address this.
</span><br>
<span class="quotelev1">&gt; (2)     When I run with &#194;&#173;debug-daemons AND the debug
</span><br>
...
<span class="quotelev1">&gt; job is hung, I get told my username doesn&#194;&#185;t exist. However,
</span><br>
<span class="quotelev1">&gt; I tried adding
</span><br>
<span class="quotelev1">&gt; &#194;&#173;debug to the mpirun, and got the same sequence of output as
</span><br>
<span class="quotelev1">&gt; for successful
</span><br>
<span class="quotelev1">&gt; smaller runs, until it hung again. So I added &#194;&#173;-debug-daemons
</span><br>
