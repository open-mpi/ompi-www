<?
$subject_val = "[OMPI users] [OMPI Users] OpenMPI 1.1.4 over ethernet fails";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2575.php">Jeff Squyres: "Re: [OMPI users] no MPI_2COMPLEX and MPI_2DOUBLE_COMPLEX"</a>
<li><strong>Previous message:</strong> <a href="2573.php">Michael Alexander: "[OMPI users] CfP Workshops on Virtualization/XEN in HPC Cluster and Grid Computing (Deadline Extended)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2577.php">Alex Tumanov: "Re: [OMPI users] [OMPI Users] OpenMPI 1.1.4 over ethernet fails"</a>
<li><strong>Reply:</strong> <a href="2577.php">Alex Tumanov: "Re: [OMPI users] [OMPI Users] OpenMPI 1.1.4 over ethernet fails"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
