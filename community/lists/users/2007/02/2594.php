...
<!-- received="Fri Feb  2 18:07:48 2007" -->
<!-- isoreceived="20070202230748" -->
<!-- sent="Fri, 2 Feb 2007 18:07:43 -0500" -->
<!-- isosent="20070202230743" -->
<!-- name="Dennis McRitchie" -->
<!-- email="dmcr_at_[hidden]" -->
<!-- subject="[OMPI users] Can't run simple job with openmpi using the Intel compiler" -->
<!-- id="5927226A3D285F40AB95CA2A3D2369D4FEC584_at_EXCLUSTER.pu.win.princeton.edu" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2007-02-02 18:07:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2595.php">Dennis McRitchie: "Re: [OMPI users] Can't run simple job with openmpi using the Intel compiler"</a>
<li><strong>Previous message:</strong> <a href="2593.php">Ralph Castain: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<li><strong>In reply to:</strong> <a href="2593.php">Ralph Castain: "Re: [OMPI users] large jobs hang on startup (deadlock?)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2595.php">Dennis McRitchie: "Re: [OMPI users] Can't run simple job with openmpi using the Intel compiler"</a>
<li><strong>Maybe reply:</strong> <a href="2595.php">Dennis McRitchie: "Re: [OMPI users] Can't run simple job with openmpi using the Intel compiler"</a>
<li><strong>Reply:</strong> <a href="2596.php">Joe Griffin: "[OMPI users] -prefix not working"</a>
<li><strong>Reply:</strong> <a href="2600.php">Gurhan Ozen: "Re: [OMPI users] Can't run simple job with openmpi using the Intel compiler"</a>
<li><strong>Reply:</strong> <a href="2603.php">Brian Barrett: "Re: [OMPI users] Can't run simple job with openmpi using the Intel compiler"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
