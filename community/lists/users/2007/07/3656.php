...
<!-- received="Wed Jul 11 20:51:07 2007" -->
<!-- isoreceived="20070712005107" -->
<!-- sent="Wed, 11 Jul 2007 18:50:52 -0600" -->
<!-- isosent="20070712005052" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Recursive use of &amp;quot;orterun&amp;quot; (Ralph H Castain)" -->
<!-- id="C2BAD70C.343E%rhc_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="Pine.LNX.4.61.0707111911570.25340_at_globe.wustl.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-07-11 20:50:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3657.php">anyi li: "Re: [OMPI users] MPI_Reduce problem"</a>
<li><strong>Previous message:</strong> <a href="3655.php">Lev Gelb: "Re: [OMPI users] Recursive use of &quot;orterun&quot; (Ralph H Castain)"</a>
<li><strong>In reply to:</strong> <a href="3655.php">Lev Gelb: "Re: [OMPI users] Recursive use of &quot;orterun&quot; (Ralph H Castain)"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>The problem here is that you might actually want to provide a set of
<br>
variables to direct that second orterun's behavior. Fortunately, we actually
<br>
provided you with a way to do it!
<br>
<p>You can set any MCA param on the command line by just doing &quot;-mca param
<br>
...
<br>
<p>If you still want to use os.system instead of os.execve, I could give you a
<br>
...
<br>
<p>Would that help? If so, I could send you a patch you could try - might take
<br>
me a day or two to compose and test it.
<br>
<p>Alternatively, if os.execve is an acceptable option, I could give you a list
<br>
...
<br>
<p>Let me know which way you would like to go...
<br>
Ralph
<br>
<p><p><p>On 7/11/07 6:32 PM, &quot;Lev Gelb&quot; &lt;gelb_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Well done, that was exactly the problem -
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Python's os.environ passes the complete collection of shell variables.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I tried a different os method (os.execve) , where I could specify the
</span><br>
<span class="quotelev1">&gt; environment (I took out all the OMPI_* variables) and the second orterun
</span><br>
<span class="quotelev1">&gt; call worked!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Now I just need a cleaner way to reset the environment within the
</span><br>
<span class="quotelev1">&gt; spawned process.  (Or,  a way to tell orterun to ignore/overwrite the
</span><br>
<span class="quotelev1">&gt; existing OMPI_* variables...?)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Wed, 11 Jul 2007, Ralph Castain wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Hmmm...interesting. As a cross-check on something - if you os.system, does
</span><br>
<span class="quotelev2">&gt;&gt; your environment by any chance get copied across? Reason I ask: we set a
</span><br>
<span class="quotelev2">&gt;&gt; number of environmental variables when orterun spawns a process. If you call
</span><br>
<span class="quotelev2">&gt;&gt; orterun from within that process - and the new orterun sees the enviro
</span><br>
<span class="quotelev2">&gt;&gt; variables from the parent process - then I can guarantee it won't work.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; What you need is for os.system to start its child with a clean environment.
</span><br>
<span class="quotelev2">&gt;&gt; I would imagine if you just os.system'd something that output'd the
</span><br>
<span class="quotelev2">&gt;&gt; environment, that would suffice to identify the problem. If you see anything
</span><br>
<span class="quotelev2">&gt;&gt; that starts with OMPI_MCA_..., then we are indeed doomed.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Which would definitely explain why the persistent orted wouldn't help solve
</span><br>
...
<span class="quotelev2">&gt;&gt; On 7/11/07 3:05 PM, &quot;Lev Gelb&quot; &lt;gelb_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Thanks for the suggestions.  The separate 'orted' scheme (below) did
</span><br>
<span class="quotelev3">&gt;&gt;&gt; not work, unfortunately;  same behavior as before.  I have conducted
</span><br>
<span class="quotelev3">&gt;&gt;&gt; a few other simple tests, and found:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 1.  The problem only occurs if the first process is &quot;in&quot; MPI;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; if it doesn't call MPI_Init or calls MPI_Finalize before it executes
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the second orterun, everything works.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 2.  Whether or not the second process actually uses MPI doesn't matter.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 3.  Using the standalone orted in &quot;debug&quot; mode with &quot;universe&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; specified throughout, there does not appear to be any communication to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; orted upon the second invocation of orterun
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (Also, I've been able to get working nested orteruns using simple shell
</span><br>
<span class="quotelev3">&gt;&gt;&gt; scripts, but these don't call MPI_Init.)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wed, 11 Jul 2007, Ralph H Castain wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hmmm...well, what that indicates is that your application program is losing
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the connection to orterun, but that orterun is still alive and kicking (it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is alive enough to send the [0,0,1] daemon a message ordering it to exit).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So the question is: why is your application program dropping the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; connection?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I haven't tried doing embedded orterun commands, so there could be a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; conflict there that causes the OOB connection to drop. Best guess is that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; there is confusion over which orterun it is supposed to connect to. I can
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; give it a try and see - this may not be a mode we can support.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Alternatively, you could start a persistent daemon and then just allow both
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; orterun instances to report to it. Our method for doing that isn't as
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; convenient as we want it to be, and hope to soon have it, but it does work.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; What you have to do is:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 1. to start the persistent daemon, type:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; where foo can be whatever name you like.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 2. when you execute your application, use:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; orterun -np 1 --universe foo python ./test.py
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; where the &quot;foo&quot; matches the name given above.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 3. in your os.system command, you'll need that same &quot;--universe foo&quot; option
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; That may solve the problem (let me know if it does). Meantime, I'll take a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; look at the embedded approach without the persistent daemon...may take me
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; awhile as I'm in the middle of something, but I will try to get to it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; shortly.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 7/11/07 1:40 PM, &quot;Lev Gelb&quot; &lt;gelb_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; os.system command, the output from that might help us understand why it
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; active.  The system is running Fedora Core 6 x86-64, I'm using the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Lev Gelb Associate Professor Department of Chemistry, Washington
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Lev Gelb
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Associate Professor
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Department of Chemistry,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Washington University in St. Louis,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; St. Louis, MO 63130  USA
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; email: gelb_at_[hidden]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; phone: (314)935-5026
</span><br>
<span class="quotelev3">&gt;&gt;&gt; fax:   (314)935-4481
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.chemistry.wustl.edu/~gelb">http://www.chemistry.wustl.edu/~gelb</a>
