...
<!-- received="Thu Jun 21 14:27:39 2007" -->
<!-- isoreceived="20070621182739" -->
<!-- sent="Thu, 21 Jun 2007 13:27:35 -0500 (CDT)" -->
<!-- isosent="20070621182735" -->
<!-- name="Anthony Chan" -->
<!-- email="chan_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [Fwd: MPI question/problem] including	code	attachments" -->
<!-- id="Pine.LNX.4.58.0706211314310.26552_at_triumph.mcs.anl.gov" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2007-06-21 14:27:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3536.php">흆e Sandgren: "Re: [OMPI users] [Fwd: MPI question/problem]	including	code	attachments"</a>
<li><strong>Previous message:</strong> <a href="3534.php">George Bosilca: "Re: [OMPI users] [Fwd: MPI question/problem] including	code	attachments"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3536.php">흆e Sandgren: "Re: [OMPI users] [Fwd: MPI question/problem]	including	code	attachments"</a>
<li><strong>Reply:</strong> <a href="3536.php">흆e Sandgren: "Re: [OMPI users] [Fwd: MPI question/problem]	including	code	attachments"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
terminal
<br>
<p>~/openmpi/install_linux64_123_gcc4_thd/bin/mpiexec test_comm_rank.c
<br>
--------------------------------------------------------------------------
<br>
Failed to find the following executable:
<br>
<p>Host:       octagon.mcs.anl.gov
<br>
...
--------------------------------------------------------------------------
<br>
<p>This has to be killed by hand on a separate terminal.  I can reproduce
<br>
...
<br>
<p><span class="quotelev1">&gt; With OpenMPI:
</span><br>
