...
<!-- received="Sat Jun 30 09:50:46 2007" -->
<!-- isoreceived="20070630135046" -->
<!-- sent="Sat, 30 Jun 2007 09:50:10 -0400" -->
<!-- isosent="20070630135010" -->
<!-- name="Pak Lui" -->
<!-- email="Pak.Lui_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI over IB not working : &amp;quot;Connection event not handled: 16391&amp;quot;" -->
<!-- id="46865F92.90200_at_sun.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="p05111b02c2abcf4063a2_at_[10.0.1.6]" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-06-30 09:50:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3561.php">Glenn Carver: "Re: [OMPI users] MPI over IB not working : &quot;Connection event not handled: 16391&quot;"</a>
<li><strong>Previous message:</strong> <a href="3559.php">Glenn Carver: "Re: [OMPI users] MPI over IB not working : &quot;Connection event not handled: 16391&quot;"</a>
<li><strong>In reply to:</strong> <a href="3559.php">Glenn Carver: "Re: [OMPI users] MPI over IB not working : &quot;Connection event not handled: 16391&quot;"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3561.php">Glenn Carver: "Re: [OMPI users] MPI over IB not working : &quot;Connection event not handled: 16391&quot;"</a>
<li><strong>Reply:</strong> <a href="3561.php">Glenn Carver: "Re: [OMPI users] MPI over IB not working : &quot;Connection event not handled: 16391&quot;"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Glenn,
<br>
<p>Are you running with Solaris 10 Update 3 (11/06) and with this patch 
<br>
125793-01? It is required for running with udapl btl.
<br>
<p><a href="http://www.sun.com/products-n-solutions/hardware/docs/html/819-7478-11/body.html#93180">http://www.sun.com/products-n-solutions/hardware/docs/html/819-7478-11/body.html#93180</a>
<br>
<p>Glenn Carver wrote:
<br>
<span class="quotelev1">&gt; Further to my email below regarding problems with uDAPL across IB, I 
</span><br>
<span class="quotelev1">&gt; found a bug report lodged with Sun (also reported with Opensolaris at:
</span><br>
<span class="quotelev1">&gt; <a href="http://bugs.opensolaris.org/bugdatabase/view_bug.do?bug_id=6545187">http://bugs.opensolaris.org/bugdatabase/view_bug.do?bug_id=6545187</a>). 
</span><br>
<span class="quotelev1">&gt; I will lodge a support call with Sun first thing Monday though it 
</span><br>
<span class="quotelev1">&gt; might not get me very far.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Would ditching clustertools and compiling the latest open-mpi and 
</span><br>
<span class="quotelev1">&gt; trying the IB / OpenIB interface work for me?  Another option would 
</span><br>
<span class="quotelev1">&gt; be to revert to clustertools 6 but ideally I need the better 
</span><br>
<span class="quotelev1">&gt; implementation of MPI2 that's in open-mpi.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Any workarounds on the first issue appreciated and advice on the 
</span><br>
<span class="quotelev1">&gt; second question appreciated too!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; I'm trying to set up a new small cluster. It's based on Sun's X4100
</span><br>
<span class="quotelev2">&gt;&gt; servers running Solaris 10_x86. I have Open MPI that comes within
</span><br>
<span class="quotelev2">&gt;&gt; Clustertools 7.  In addition, I have an Infiniband network between
</span><br>
<span class="quotelev2">&gt;&gt; the nodes.  I can run parallel jobs fine if processes remain on one
</span><br>
<span class="quotelev2">&gt;&gt; node (each node has 4 cores). However, as soon as I try to run across
</span><br>
<span class="quotelev2">&gt;&gt; the nodes I get these errors from the job:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; [node3][0,1,8][/ws/hpc-ct-7/builds/7.0.build-ct7-030/ompi-ct7/ompi/mca/btl/udapl/btl_udapl_component.c:827:mca_btl_udapl_component_progress]
</span><br>
<span class="quotelev2">&gt;&gt; WARNING : Connection event not handled : 16391
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I've had a good look through the archives but can't find a reference
</span><br>
<span class="quotelev2">&gt;&gt; to this error. I realise the udapl interface is a sun addition to
</span><br>
<span class="quotelev2">&gt;&gt; OpenMPI but I'm hoping someone else will have seen this before and
</span><br>
<span class="quotelev2">&gt;&gt; know what's wrong. I have checked my IB network is functioning
</span><br>
<span class="quotelev2">&gt;&gt; correctly (seemed the obvious thing that could be wrong).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Any pointers on what could be wrong much appreciated.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; ifconfig for the IB port reports:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; $ ifconfig ibd1
</span><br>
<span class="quotelev2">&gt;&gt; ibd1: flags=1000843&lt;UP,BROADCAST,RUNNING,MULTICAST,IPv4&gt; mtu 2044 index 3
</span><br>
<span class="quotelev2">&gt;&gt;          inet 192.168.50.200 netmask ffffff00 broadcast 192.168.50.255
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; .. and for the other configured interface:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; $ ifconfig e1000g0
</span><br>
<span class="quotelev2">&gt;&gt; e1000g0: flags=1000843&lt;UP,BROADCAST,RUNNING,MULTICAST,IPv4&gt; mtu 1500 index 2
</span><br>
<span class="quotelev2">&gt;&gt;          inet 192.168.47.190 netmask ffffff00 broadcast 192.168.47.255
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Output from ompi_info is:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; ompi_info | more
</span><br>
