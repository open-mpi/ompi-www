...
<!-- received="Tue Jun 19 09:28:23 2007" -->
<!-- isoreceived="20070619132823" -->
<!-- sent="Tue, 19 Jun 2007 14:18:23 +0100" -->
<!-- isosent="20070619131823" -->
<!-- name="Chris Reeves" -->
<!-- email="chris.reeves_at_[hidden]" -->
<!-- subject="[OMPI users] Processes stuck in MPI_BARRIER" -->
<!-- id="20070619131823.GB14843_at_defiant" -->
<!-- charset="us-ascii" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-06-19 09:18:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3502.php">Alf Wachsmann: "[OMPI users] Problem with user shell and mpirun-prefix"</a>
<li><strong>Previous message:</strong> <a href="3500.php">Chris Reeves: "[OMPI users] Processes stuck in MPI_BARRIER"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3503.php">Jeff Squyres: "Re: [OMPI users] Processes stuck in MPI_BARRIER"</a>
<li><strong>Reply:</strong> <a href="3503.php">Jeff Squyres: "Re: [OMPI users] Processes stuck in MPI_BARRIER"</a>
<li><strong>Reply:</strong> <a href="3505.php">George Bosilca: "Re: [OMPI users] Processes stuck in MPI_BARRIER"</a>
<li><strong>Reply:</strong> <a href="3511.php">Marcin Skoczylas: "Re: [OMPI users] Processes stuck in MPI_BARRIER"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-3501/ompi_config.log.gz">ompi_config.log.gz</a>
</ul>
<!-- attachment="ompi_config.log.gz" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-3501/ompi_info.out.gz">ompi_info.out.gz</a>
</ul>
<!-- attachment="ompi_info.out.gz" -->
<hr>
<ul>
<li>text/x-diff attachment: <a href="http://www.open-mpi.org/community/lists/users/att-3501/openmpi-cluster_firewall.patch">openmpi-cluster_firewall.patch</a>
</ul>
<!-- attachment="openmpi-cluster_firewall.patch" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
