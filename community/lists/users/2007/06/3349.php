...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3350.php">Daniel Pfenniger: "[OMPI users] Compilation bug in libtool"</a>
<li><strong>Previous message:</strong> <a href="3348.php">George Bosilca: "Re: [OMPI users] mixing MX and TCP"</a>
<li><strong>In reply to:</strong> <a href="3348.php">George Bosilca: "Re: [OMPI users] mixing MX and TCP"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3362.php">Jeff Squyres: "Re: [OMPI users] mixing MX and TCP"</a>
<li><strong>Reply:</strong> <a href="3362.php">Jeff Squyres: "Re: [OMPI users] mixing MX and TCP"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
