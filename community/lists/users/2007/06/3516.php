...
<!-- received="Wed Jun 20 12:24:06 2007" -->
<!-- isoreceived="20070620162406" -->
<!-- sent="Wed, 20 Jun 2007 12:23:43 -0400" -->
<!-- isosent="20070620162343" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] error -- libtool unsupported hardcode properties" -->
<!-- id="0B72A0A3-00FF-4BA1-8C77-F9981CE30D85_at_cisco.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2007-06-20 12:23:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="3517.php">Mostyn Lewis: "Re: [OMPI users] error -- libtool unsupported hardcode properties"</a>
<li><strong>Previous message:</strong> <a href="3515.php">Andrew Friedley: "Re: [OMPI users] error -- libtool unsupported hardcode properties"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="3517.php">Mostyn Lewis: "Re: [OMPI users] error -- libtool unsupported hardcode properties"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; Using pathf90 for both FC and F77 does not change anything.  Should  
</span><br>
...
<span class="quotelev1">&gt; Even more interesting -- I just tried configuring with --disable- 
</span><br>
<span class="quotelev1">&gt; mpi-f77
</span><br>
...
<p>Bummer.  :-(
<br>
<p><span class="quotelev1">&gt; Is there anywhere else I should be looking?  I have to admit, I'm
</span><br>
<span class="quotelev1">&gt; stumped here..
</span><br>
<p>It could be a gcc bug...?  What I would do is try to replicate this  
<br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /bin/sh ../../../libtool --tag=CXX --mode=link g++  -g -O2 - 
</span><br>
