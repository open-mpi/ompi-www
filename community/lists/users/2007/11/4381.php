...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4382.php">Jeff Squyres: "Re: [OMPI users] How to construct a datatype over two different arrays?"</a>
<li><strong>Previous message:</strong> <a href="4380.php">Amit Kumar Saha: "Re: [OMPI users] How to construct a datatype over two different arrays?"</a>
<li><strong>In reply to:</strong> <a href="4379.php">Neeraj Chourasia: "[OMPI users] Re :Re:  OpenMP and OpenMPI Issue"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/07/19801.php">Jack Galloway: "Re: [OMPI users] Re :Re:  OpenMP and OpenMPI Issue"</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/07/19801.php">Jack Galloway: "Re: [OMPI users] Re :Re:  OpenMP and OpenMPI Issue"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
