<?
$subject_val = "[OMPI users] FW: [mpi-21] Follow up on the MPI Forum meeting";
include("../../include/msg-header.inc");
?>
<!-- received="Sat Nov 17 10:06:40 2007" -->
<!-- isoreceived="20071117150640" -->
<!-- sent="Sat, 17 Nov 2007 10:06:31 -0500" -->
<!-- isosent="20071117150631" -->
<!-- name="Richard Graham" -->
<!-- email="rlgraham_at_[hidden]" -->
<!-- subject="[OMPI users] FW: [mpi-21] Follow up on the MPI Forum meeting" -->
<!-- id="C3646DA8.10F3F%rlgraham_at_ornl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="C363D66C.10F26%rlgraham_at_ornl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] FW: [mpi-21] Follow up on the MPI Forum meeting<br>
<strong>From:</strong> Richard Graham (<em>rlgraham_at_[hidden]</em>)<br>
<strong>Date:</strong> 2007-11-17 10:06:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4489.php">Lydia Heck: "[OMPI users] errno=131 ?"</a>
<li><strong>Previous message:</strong> <a href="4487.php">Jeff Squyres: "[OMPI users] MPI-2.1: Getting the band back together"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>Here is a brief summary of the meeting held at SC07 in Reno.
<br>
<p>We decided to reconvene the MPI forum with the intent of producing the MPI
<br>
2.1, 2.2, and 3.0 documents (the actual number may end up being different).
<br>
<p>MPI 2.1, which is current is strictly a for clarification of the current 2.0
<br>
...
July, 2007.
<br>
<p>MPI 2.2 is intended to introduce &quot;small&quot; additions to the standard, with the
<br>
...
<br>
<p>MPI 3.0 (or what ever it is called) is where I expect most of the
<br>
...
<br>
<p>We also decided to stick with the current voting procedures:
<br>
...
<br>
<p>We decided that the face-to-face meetings will take place in Chicago, every
<br>
...
&nbsp;&nbsp;December 15-17, 2008.
<br>
<p>Several of us are working to see if we can secure funding to help pay for
<br>
...
<br>
<p>Finally, please advertise this activity as widely as you can, as the more
<br>
...
<br>
<p><p>Looking forward to a fun process,
<br>
Rich
<br>
<p>&nbsp;
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-4488/attachment">attachment</a>
</ul>
