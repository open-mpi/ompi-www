...
?>
<!-- received="Tue Nov 27 16:54:15 2007" -->
<!-- isoreceived="20071127215415" -->
<!-- sent="Tue, 27 Nov 2007 15:54:01 -0600" -->
<!-- isosent="20071127215401" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenIB problems" -->
<!-- id="19045289-961D-48C0-91AE-C11FE8AAEBC9_at_cisco.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2007-11-27 16:54:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4534.php">Keshetti Mahesh: "[OMPI users] [openMPI-infiniband] openMPI in IB network when openSM with LASH is running"</a>
<li><strong>Previous message:</strong> <a href="4532.php">Jeff Squyres: "Re: [OMPI users] OpenIB problems"</a>
<li><strong>In reply to:</strong> <a href="4528.php">Andrew Friedley: "Re: [OMPI users] OpenIB problems"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4540.php">Jeff Squyres: "Re: [OMPI users] OpenIB problems"</a>
<li><strong>Reply:</strong> <a href="4540.php">Jeff Squyres: "Re: [OMPI users] OpenIB problems"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
IBTA-defined value.
<br>
<p>The help message was wrong on the 1.2 branch for a while; I think it's  
<br>
been corrected in more recent versions of OMPI (i.e., &gt;1.2 -- I don't  
<br>
recall which version specifically).
<br>
<p><p>On Nov 27, 2007, at 3:19 PM, Andrew Friedley wrote:
<br>
...
<span class="quotelev3">&gt;&gt;&gt; The other IB guys can probably answer better than I can -- I'm not  
</span><br>
