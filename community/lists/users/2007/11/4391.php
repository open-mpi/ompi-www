...
?>
<!-- received="Fri Nov  2 12:38:42 2007" -->
<!-- isoreceived="20071102163842" -->
<!-- sent="Fri, 2 Nov 2007 11:38:38 -0500" -->
<!-- isosent="20071102163838" -->
<!-- name="Jon Mason" -->
<!-- email="jon_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun udapl problem" -->
<!-- id="20071102163837.GA6181_at_opengridcomputing.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="FAF2C80E-9E6B-4FC3-9FD3-0A66C3A8A203_at_eecs.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2007-11-02 12:38:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4392.php">Jeff Squyres: "Re: [OMPI users] mpirun udapl problem"</a>
<li><strong>Previous message:</strong> <a href="4390.php">himanshu khandelia: "[OMPI users] Node assignment using openmpi for multiple simulations in the same submission script in PBS (GROMACS)"</a>
<li><strong>In reply to:</strong> <a href="4388.php">George Bosilca: "Re: [OMPI users] mpirun udapl problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4393.php">Jeff Squyres: "Re: [OMPI users] mpirun udapl problem"</a>
<li><strong>Reply:</strong> <a href="4393.php">Jeff Squyres: "Re: [OMPI users] mpirun udapl problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; There are two things that are reflected in your email.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 1. You can run Open MPI (or at least ompi_info) on the head node, and  
</span><br>
<span class="quotelev1">&gt; udapl is in the list of BTL. This means the head node has all  
</span><br>
<span class="quotelev1">&gt; libraries required to load udapl, and your LD_LIBRARY_PATH is  
</span><br>
<span class="quotelev1">&gt; correctly configured on the head node.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 2. When running between vic12-10g and vic20-10g udapl cannot or refuse  
</span><br>
<span class="quotelev1">&gt; to be loaded. This can means 2 things: some of the shared libraries  
</span><br>
<span class="quotelev1">&gt; are missing or not in the LD_LIBRARY_PATH or once initialized udapl  
</span><br>
<span class="quotelev1">&gt; detect that the connection to the remote node is impossible.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The next thing to do is to test that your LD_LIBRARY_PATH is correctly  
</span><br>
<span class="quotelev1">&gt; (which means it contain not only the path to the Open MPI libraries  
</span><br>
<span class="quotelev1">&gt; but the path to the udapl libraries) set for non-interactive shells on  
</span><br>
<span class="quotelev1">&gt; each node in the cluster. A &quot;ssh vic12-10g printenv | grep  
</span><br>
<span class="quotelev1">&gt; LD_LIBRARY_PATH&quot; should give you the answer.
</span><br>
<p>Thanks for the help.  Per your request, I get the following:
<br>
# ssh vic12-10g printenv | grep LD
<br>
LD_LIBRARY_PATH=/usr/mpi/gcc/openmpi-1.2-svn/lib64:
<br>
<p>That directory contains the btl udapl libraries, as you said.
<br>
...
mca_btl_udapl.so
<br>
<p>A search on the system shows libdaplcma and libdat in /usr/lib/.  For
<br>
giggles, I added /usr/lib to the env, but the programs still fails to
<br>
run with the same error.
<br>
<p>I believe I have the correct rpms installed for the libs.  Here is what
<br>
...
dapl-utils-1.2.1-0
<br>
<p>What should I be looking to link against?
<br>
<p>Thanks,
<br>
Jon
...
<span class="quotelev1">&gt;     georg.e
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Nov 1, 2007, at 6:52 PM, Jon Mason wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
