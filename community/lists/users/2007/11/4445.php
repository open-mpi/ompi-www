...
?>
<!-- received="Wed Nov  7 19:37:09 2007" -->
<!-- isoreceived="20071108003709" -->
<!-- sent="Wed, 7 Nov 2007 16:37:05 -0800" -->
<!-- isosent="20071108003705" -->
<!-- name="Andrus, Mr. Brian (Contractor)" -->
<!-- email="brian.andrus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openib errors as user, but not root" -->
<!-- id="D392D4803D14354CBC49D772E19DD0CD84C29F_at_zeus.w2k.nrlmry.navy.mil" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2007-11-07 19:37:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="4446.php">Andrus, Mr. Brian (Contractor): "Re: [OMPI users] openib errors as user, but not root"</a>
<li><strong>Previous message:</strong> <a href="4444.php">Jeff Squyres: "Re: [OMPI users] openib errors as user, but not root"</a>
<li><strong>In reply to:</strong> <a href="4444.php">Jeff Squyres: "Re: [OMPI users] openib errors as user, but not root"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="4446.php">Andrus, Mr. Brian (Contractor): "Re: [OMPI users] openib errors as user, but not root"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I am trying to test limits. If I ssh directly to a node and check,
<br>
everything is ok:
<br>
...
unlimited
<br>
<p>The settings in /etc/security/limits.conf are right too. 
<br>
