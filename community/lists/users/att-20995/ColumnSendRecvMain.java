 ...
 *   mpijavac ColumnSendRecvMain.java
 *
 * Usage:
 *   mpiexec [parameters] java [parameters] ColumnSendRecvMain
 *
 * Examples:
 *   mpiexec -np 7 java ColumnSendRecvMain
 *   mpiexec -np 7 java -cp $HOME/mpi_classfiles ColumnSendRecvMain
 *
 *
 * File: ColumnSendRecvMain		Author: S. Gross
 * Date: 10.10.2012
 *
 */
