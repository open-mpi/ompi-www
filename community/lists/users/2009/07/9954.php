<?
$subject_val = "[OMPI users] Fwd: Open MPI v1.3.3 released";
...
<!-- subject="[OMPI users] Fwd: Open MPI v1.3.3 released" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Fwd: Open MPI v1.3.3 released<br>
<strong>From:</strong> Ralph Castain (<em>rhc_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-07-14 14:15:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9955.php">Evans, Thomas M.: "[OMPI users] Solution for dynamic loading with python"</a>
<li><strong>Previous message:</strong> <a href="9953.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
