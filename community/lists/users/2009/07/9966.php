...
?>
<!-- received="Wed Jul 15 02:09:29 2009" -->
<!-- isoreceived="20090715060929" -->
<!-- sent="Wed, 15 Jul 2009 09:09:23 +0300" -->
<!-- isosent="20090715060923" -->
<!-- name="Lenny Verkhovsky" -->
<!-- email="lenny.verkhovsky_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="453d39990907142309p19ee07fan9f012b57e0695370_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="7331C781-49C6-4DD9-9191-E34474307AA6_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-15 02:09:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9967.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Previous message:</strong> <a href="9965.php">vipin kumar: "Re: [OMPI users] Spawning processes through MPI::Intracomm::Spawn_multiple"</a>
<li><strong>In reply to:</strong> <a href="9963.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9967.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9967.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I still have a problem running app file with rankfile, by providing full
<br>
hostlist in mpirun command and not in app file.
<br>
Is is planned behaviour, or it can be fixed ?
<br>
<p>See Working example:
<br>
<p>$cat rankfile
<br>
rank 0=+n1 slot=0
...
<br>
<p><p><p>On Wed, Jul 15, 2009 at 6:58 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Took a deeper look into this, and I think that your first guess was
</span><br>
<span class="quotelev1">&gt; correct.
</span><br>
<span class="quotelev1">&gt; When we changed hostfile and -host to be per-app-context options, it became
</span><br>
<span class="quotelev1">&gt; necessary for you to put that info in the appfile itself. So try adding it
</span><br>
<span class="quotelev1">&gt; there. What you would need in your appfile is the following:
</span><br>
...
<span class="quotelev2">&gt;&gt; Run it without the appfile, just putting the apps on the cmd line - does
</span><br>
<span class="quotelev2">&gt;&gt; it work right then?
</span><br>
...
<span class="quotelev2">&gt;&gt; I am running mpirun on hostA, and providing hostlist with hostB and hostC.
</span><br>
<span class="quotelev2">&gt;&gt; I expect that each application would run on hostB and hostC, but I get all
</span><br>
<span class="quotelev2">&gt;&gt; of them running on hostA.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Strange - let me have a look at it later today. Probably something simple
</span><br>
<span class="quotelev3">&gt;&gt;&gt; that another pair of eyes might spot.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I can't use rankfile with app, even after all those fixes ( working with
</span><br>
<span class="quotelev3">&gt;&gt;&gt; trunk 1.4a1r21657).
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; The problem is, that rankfile mapper tries to find an appropriate host in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the partial ( and not full ) hostlist.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; If you hostfile and rank file limit you at N procs, you can ask mpirun
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; for N+1 and it wil be not rejected.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Although in reality there will be N tasks.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; So, if your hostfile limit is 4, then &quot;mpirun -np 4&quot; and &quot;mpirun -np 5&quot;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; both works, but in both cases there are only 4 tasks. It isn't crucial,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; because there is nor real oversubscription, but there is still some bug
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; which can affect something in future.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; --
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Although removing this check solves problem of having more slots in
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; rankfile than necessary, there is another problem.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; but &quot;mpirun -np 3 ./something&quot; will work though. It works, when you
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; ask for 1 CPU less. And the same behavior in any case (shared nodes,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; non-shared nodes, multi-node)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; If you switch off rmaps_base_no_oversubscribe, then it works and all
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; affinities set as it requested in rankfile, there is no oversubscription.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Ah - thx for catching that, I'll remove that check. It no longer is
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; If I remember correctly, I used an array to map ranks, and since the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; length of array is NP, maximum index must be less than np, so if you have
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the number of rank &gt; NP, you have no place to put it inside array.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; proc.&quot;  - Correct point.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On 5/5/09, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote: Sorry Lenny, but
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that isn't correct. The rankfile mapper doesn't care if the rankfile
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Likewise, if you have more procs than the rankfile specifies, we map
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the additional procs either byslot (default) or bynode (if you specify that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; option). So the rankfile doesn't need to contain an entry for every proc.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I agree with you Ralph , and that 's what I expect from openmpi but
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; I agree that my examples are not very clear. What I want to do is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; launch a multiexes application (masters-slaves) and benefit from
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9966/attachment">attachment</a>
</ul>
