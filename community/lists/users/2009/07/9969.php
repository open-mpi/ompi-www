...
?>
<!-- received="Wed Jul 15 08:25:18 2009" -->
<!-- isoreceived="20090715122518" -->
<!-- sent="Wed, 15 Jul 2009 14:25:11 +0200" -->
<!-- isosent="20090715122511" -->
<!-- name="Geoffroy Pignot" -->
<!-- email="geopignot_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="b4f9bf870907150525id737e95m6bb60fc651822c9d_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-07-15 08:25:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9970.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Previous message:</strong> <a href="9968.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Maybe in reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2009/04/8858.php">Geoffroy Pignot: "[OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9970.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9970.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9992.php">Geoffroy Pignot: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Lenny and Ralph,
<br>
<p>I saw nothing about rankfile in the 1.3.3 press release. Does it means that
<br>
...
<p>Geoffroy
<br>
<p>2009/7/15 &lt;users-request_at_[hidden]&gt;
<br>
...
<span class="quotelev1">&gt; cmd. If I didnt provide hostlist in the appfile line, mpirun uses local
</span><br>
...
<span class="quotelev2">&gt; &gt; Sorry to have to keep asking you to try things - I don't have a setup
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; On Wed, May 13, 2009 at 1:55 AM, Ralph Castain &lt;rhc_at_[hidden]
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; 5&quot; both works, but in both cases there are only 4 tasks. It isn't
</span><br>
<span class="quotelev1">&gt; crucial,
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; because there is nor real oversubscription, but there is still some
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ask for 1 CPU less. And the same behavior in any case (shared
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; have the number of rank &gt; NP, you have no place to put it inside
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; map the additional procs either byslot (default) or bynode (if
</span><br>
<span class="quotelev1">&gt; you specify
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that option). So the rankfile doesn't need to contain an entry
</span><br>
<span class="quotelev1">&gt; for every
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; contains additional info - it only maps up to the number of
</span><br>
<span class="quotelev1">&gt; processes, and
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ignores anything beyond that number. So there is no need to
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9969/attachment">attachment</a>
</ul>
