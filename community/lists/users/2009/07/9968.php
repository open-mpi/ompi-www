...
?>
<!-- received="Wed Jul 15 08:08:45 2009" -->
<!-- isoreceived="20090715120845" -->
<!-- sent="Wed, 15 Jul 2009 15:08:39 +0300" -->
<!-- isosent="20090715120839" -->
<!-- name="Lenny Verkhovsky" -->
<!-- email="lenny.verkhovsky_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="453d39990907150508j33ffa3f0qefc0801ea40f0d34_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="0714472D-AB7A-413D-B56B-D2108005AF63_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-15 08:08:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9969.php">Geoffroy Pignot: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Previous message:</strong> <a href="9967.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>In reply to:</strong> <a href="9967.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9971.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9971.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>$orte/mca/rmaps/rank_file/rmaps_rank_file.c at line 338
<br>
<p>&nbsp;&nbsp;if(ORTE_SUCCESS != (rc = orte_rmaps_base_get_target_nodes(&amp;node_list,
<br>
&amp;num_slots, app,
<br>
<p>map-&gt;policy))) {
<br>
<p>node_list will be partial, according to app, and not full provided by mpirun
<br>
cmd. If I didnt provide hostlist in the appfile line, mpirun uses local host
<br>
and not hosts from the hostfile.
<br>
<p><p>Tell me if I am wrong by expecting the following behaivor
<br>
<p>I provide to mpirun NP, full_hostlist, full_rankfile, appfile
<br>
I provide in appfile only partial NP and partial hostlist.
<br>
and it works.
<br>
<p>Currently, in order to get it working I need to provide full hostlist in the
<br>
appfile. Which is quit a problematic.
<br>
<p><p>$mpirun -np 2 -rf rankfile -app appfile
<br>
--------------------------------------------------------------------------
<br>
...
Lenny.
<br>
<p><p>On Wed, Jul 15, 2009 at 2:02 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Try your &quot;not working&quot; example without the -H on the mpirun cmd line -
</span><br>
<span class="quotelev1">&gt; i.e.,, just use &quot;mpirun -np 2 -rf rankfile -app appfile&quot;. Does that work?
</span><br>
<span class="quotelev1">&gt; Sorry to have to keep asking you to try things - I don't have a setup here
</span><br>
<span class="quotelev1">&gt; where I can test this as everything is RM managed.
</span><br>
...
<span class="quotelev1">&gt; I still have a problem running app file with rankfile, by providing full
</span><br>
<span class="quotelev1">&gt; hostlist in mpirun command and not in app file.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Run it without the appfile, just putting the apps on the cmd line - does
</span><br>
<span class="quotelev3">&gt;&gt;&gt; it work right then?
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I expect that each application would run on hostB and hostC, but I get
</span><br>
<span class="quotelev3">&gt;&gt;&gt; all of them running on hostA.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I can't use rankfile with app, even after all those fixes ( working with
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; trunk 1.4a1r21657).
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The problem is, that rankfile mapper tries to find an appropriate host
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; in the partial ( and not full ) hostlist.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; If you hostfile and rank file limit you at N procs, you can ask mpirun
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; for N+1 and it wil be not rejected.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Although in reality there will be N tasks.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; So, if your hostfile limit is 4, then &quot;mpirun -np 4&quot; and &quot;mpirun -np
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 5&quot; both works, but in both cases there are only 4 tasks. It isn't crucial,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; but &quot;mpirun -np 3 ./something&quot; will work though. It works, when you
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ask for 1 CPU less. And the same behavior in any case (shared nodes,
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the length of array is NP, maximum index must be less than np, so if you
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; have the number of rank &gt; NP, you have no place to put it inside array.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &quot;Likewise, if you have more procs than the rankfile specifies, we
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; map the additional procs either byslot (default) or bynode (if you specify
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that option). So the rankfile doesn't need to contain an entry for every
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; proc.&quot;  - Correct point.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; but that isn't correct. The rankfile mapper doesn't care if the rankfile
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I agree with you Ralph , and that 's what I expect from openmpi but
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; I agree that my examples are not very clear. What I want to do is
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; to
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; launch a multiexes application (masters-slaves) and benefit from
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; mpirun --hostfile hostfile.0 -rf rankfile.0 -n 1 hostname : -n
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9968/attachment">attachment</a>
</ul>
