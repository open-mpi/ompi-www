...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9779.php">Jeff Squyres: "Re: [OMPI users] btl_openib_connect_oob.c:459:qp_create_one: errorcreating qp"</a>
<li><strong>Previous message:</strong> <a href="../../2009/06/9777.php">David Ronis: "[OMPI users] Network Problem?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9779.php">Jeff Squyres: "Re: [OMPI users] btl_openib_connect_oob.c:459:qp_create_one: errorcreating qp"</a>
<li><strong>Reply:</strong> <a href="9779.php">Jeff Squyres: "Re: [OMPI users] btl_openib_connect_oob.c:459:qp_create_one: errorcreating qp"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><p><hr>
<ul>
<li>application/x-gzip attachment: <a href="../../att-9778/ompi_info.log.gz">ompi_info.log.gz</a>
</ul>
