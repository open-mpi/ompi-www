...
?>
<!-- received="Wed Jul 15 09:38:59 2009" -->
<!-- isoreceived="20090715133859" -->
<!-- sent="Wed, 15 Jul 2009 07:38:53 -0600" -->
<!-- isosent="20090715133853" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="71d2d8cc0907150638s75394f02i6e16f8e9428c41ef_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="453d39990907150628v4ad2ea66l88ef20a5b4557ba6_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-15 09:38:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9980.php">Rolf Vandevaart: "Re: [OMPI users] selectively bind MPI to one HCA out of	available ones"</a>
<li><strong>Previous message:</strong> <a href="9978.php">Matthias Jurenz: "Re: [OMPI users] questions about tracing OpenMPI program"</a>
<li><strong>In reply to:</strong> <a href="9975.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9987.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9987.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Sorry for the problem! Thanks for patience in tracking it down...
<br>
Ralph
<br>
<p>On Wed, Jul 15, 2009 at 7:28 AM, Lenny Verkhovsky &lt;
<br>
...
<span class="quotelev1">&gt; Rankfile claimed host +n1 by index that is bigger than number of allocated
</span><br>
...
<span class="quotelev1">&gt; On Wed, Jul 15, 2009 at 4:10 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; 1. each line of the appfile causes us to create a new app_context. We
</span><br>
<span class="quotelev2">&gt;&gt; store the provided -host info in that object.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; 2. when we create the &quot;allocation&quot;, we cycle through -all- the
</span><br>
<span class="quotelev2">&gt;&gt; app_contexts and add -all- of their -host info into the list of allocated
</span><br>
<span class="quotelev2">&gt;&gt; nodes
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; 3. when we get_target_nodes, we start with the entire list of allocated
</span><br>
<span class="quotelev2">&gt;&gt; nodes, and then use -host for that app_context to filter down to the hosts
</span><br>
<span class="quotelev2">&gt;&gt; allowed for that specific app_context
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; So you should have to only provide -np 1 and 1 host on each line. My guess
</span><br>
<span class="quotelev2">&gt;&gt; is that the rankfile mapper isn't correctly behaving for multiple
</span><br>
<span class="quotelev2">&gt;&gt; app_contexts.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Add --display-allocation to your mpirun cmd line for the &quot;not working&quot; cse
</span><br>
<span class="quotelev2">&gt;&gt; and let's see what mpirun thinks the total allocation is - I'll bet that
</span><br>
<span class="quotelev2">&gt;&gt; both nodes show up, which would tell us that my &quot;guess&quot; is correct. Then
</span><br>
<span class="quotelev2">&gt;&gt; I'll know what needs to be fixed.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On Wed, Jul 15, 2009 at 6:08 AM, Lenny Verkhovsky &lt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I still suspect that rankfile claims for node in small hostlist provided
</span><br>
<span class="quotelev3">&gt;&gt;&gt; by line in the app file, and not from the hostlist provided by mpirun on HNP
</span><br>
<span class="quotelev3">&gt;&gt;&gt; node.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; According to my suspections your proposal should not work(and it does
</span><br>
<span class="quotelev3">&gt;&gt;&gt; not), since in appfile line I provide np=1, and 1 host, while rankfile tries
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to allocate all ranks (np=2).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; $orte/mca/rmaps/rank_file/rmaps_rank_file.c at line 338
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   if(ORTE_SUCCESS != (rc = orte_rmaps_base_get_target_nodes(&amp;node_list,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &amp;num_slots, app,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; map-&gt;policy))) {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; node_list will be partial, according to app, and not full provided by
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpirun cmd. If I didnt provide hostlist in the appfile line, mpirun uses
</span><br>
<span class="quotelev3">&gt;&gt;&gt; local host and not hosts from the hostfile.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Tell me if I am wrong by expecting the following behaivor
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I provide to mpirun NP, full_hostlist, full_rankfile, appfile
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I provide in appfile only partial NP and partial hostlist.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and it works.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Currently, in order to get it working I need to provide full hostlist in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the appfile. Which is quit a problematic.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; $mpirun -np 2 -rf rankfile -app appfile
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --------------------------------------------------------------------------
...
<span class="quotelev3">&gt;&gt;&gt; [dellix7:17277] [[23928,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wed, Jul 15, 2009 at 2:02 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Try your &quot;not working&quot; example without the -H on the mpirun cmd line -
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; i.e.,, just use &quot;mpirun -np 2 -rf rankfile -app appfile&quot;. Does that work?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Sorry to have to keep asking you to try things - I don't have a setup
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; here where I can test this as everything is RM managed.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  On Jul 15, 2009, at 12:09 AM, Lenny Verkhovsky wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Thanks Ralph, after playing with prefixes it worked,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I still have a problem running app file with rankfile, by providing full
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; hostlist in mpirun command and not in app file.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Is is planned behaviour, or it can be fixed ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; See Working example:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; -np 1 -H witch1,witch2  ./hello_world
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -np 1 -H witch1,witch2 ./hello_world
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $mpirun -rf rankfile -app appfile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hello world! I'm 1 of 2 on witch1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hello world! I'm 0 of 2 on witch2
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; See NOT working example:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $cat appfile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -np 1 -H witch1 ./hello_world
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -np 1 -H witch2 ./hello_world
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [dellix7:16405] [[24080,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Wed, Jul 15, 2009 at 6:58 AM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Took a deeper look into this, and I think that your first guess was
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; correct.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; When we changed hostfile and -host to be per-app-context options, it
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; became necessary for you to put that info in the appfile itself. So try
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; adding it there. What you would need in your appfile is the following:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -np 1 -H witch1 hostname
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -np 1 -H witch2 hostname
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; That should get you what you want.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Ralph
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  On Jul 14, 2009, at 10:29 AM, Lenny Verkhovsky wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  No,  it's not working as I expect , unless I expect somthing wrong .
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; ( sorry for the long PATH, I needed to provide it )
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; $LD_LIBRARY_PATH=/hpc/home/USERS/lennyb/work/svn/ompi/trunk/build_x86-64/install/lib/
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /hpc/home/USERS/lennyb/work/svn/ompi/trunk/build_x86-64/install/bin/mpirun
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -np 2 -H witch1,witch2 hostname
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -np 2 -H witch1,witch2 -app appfile
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Tue, Jul 14, 2009 at 7:08 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Run it without the appfile, just putting the apps on the cmd line -
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; does it work right then?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;  On Jul 14, 2009, at 10:04 AM, Lenny Verkhovsky wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;  additional info
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I am running mpirun on hostA, and providing hostlist with hostB and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; hostC.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I expect that each application would run on hostB and hostC, but I get
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; all of them running on hostA.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;  dellix7$cat appfile
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; -np 1 hostname
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; -np 1 hostname
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;  dellix7$mpirun -np 2 -H witch1,witch2 -app appfile
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Tue, Jul 14, 2009 at 4:59 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Strange - let me have a look at it later today. Probably something
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; simple that another pair of eyes might spot.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;  On Jul 14, 2009, at 7:43 AM, Lenny Verkhovsky wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;  Seems like connected problem:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I can't use rankfile with app, even after all those fixes ( working
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; with trunk 1.4a1r21657).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; This is my case :
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [dellix7:13414] [[10851,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; ../../../../../orte/mca/rmaps/rank_file/rmaps_rank_file.c at line 422
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [dellix7:13414] [[10851,0],0] ORTE_ERROR_LOG: Bad parameter in file
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; The problem is, that rankfile mapper tries to find an appropriate
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; host in the partial ( and not full ) hostlist.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Any suggestions how to fix it?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Thanks
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Wed, May 13, 2009 at 1:55 AM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Okay, I fixed this today too....r21219
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On May 11, 2009, at 11:27 PM, Anton Starikov wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Now there is another problem :)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -np 5&quot; both works, but in both cases there are only 4 tasks. It isn't
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; crucial, because there is nor real oversubscription, but there is still some
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; bug which can affect something in future.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; --
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Although removing this check solves problem of having more slots
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &quot;There are not enough slots available in the system to satisfy
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the 4 slots
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; you ask for 1 CPU less. And the same behavior in any case (shared nodes,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; non-shared nodes, multi-node)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Ah - thx for catching that, I'll remove that check. It no longer
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Tue, May 5, 2009 at 7:04 AM, Lenny Verkhovsky &lt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; lenny.verkhovsky_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the length of array is NP, maximum index must be less than np, so if you
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; have the number of rank &gt; NP, you have no place to put it inside array.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &quot;Likewise, if you have more procs than the rankfile specifies,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; we map the additional procs either byslot (default) or bynode (if you
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; specify that option). So the rankfile doesn't need to contain an entry for
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; every proc.&quot;  - Correct point.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; but that isn't correct. The rankfile mapper doesn't care if the rankfile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; contains additional info - it only maps up to the number of processes, and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ignores anything beyond that number. So there is no need to remove the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; map the additional procs either byslot (default) or bynode (if you specify
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that option). So the rankfile doesn't need to contain an entry for every
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Tue, May 5, 2009 at 5:59 AM, Lenny Verkhovsky &lt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; lenny.verkhovsky_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Mon, May 4, 2009 at 11:14 AM, Geoffroy Pignot &lt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; geopignot_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Hi ,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; doesn't get to it first), but it won't be until later in the
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; orterun noticed that the job aborted, but has no info as to
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; app_context basis. So the ranks in your rankfile must correspond
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; only have four, so that makes life easier. Your rankfile would
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; Could you show me how to convert this command , using -rf
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; master.x options2 : -n 1 -host r001n001 slave.x options3 : -n
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; ~/work/svn/ompi/trunk/build_x86-64/install/bin/mpirun
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; fail during opal_init; some of which are due to configuration
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; line ; there is no global understanding of the ranking
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; inside a
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; Assuming that , I tried to provide a rankfile to each
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; I hope that I've found a bug because it would be very
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9979/attachment">attachment</a>
</ul>
