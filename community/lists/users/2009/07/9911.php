<?
$subject_val = "Re: [OMPI users] Bug: coll_tuned_dynamic_rules_filename and duplicatecommunicators";
include("../../include/msg-header.inc");
?>
<!-- received="Sat Jul 11 08:29:41 2009" -->
<!-- isoreceived="20090711122941" -->
<!-- sent="Sat, 11 Jul 2009 08:29:35 -0400" -->
<!-- isosent="20090711122935" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Bug: coll_tuned_dynamic_rules_filename and duplicatecommunicators" -->
<!-- id="9086049A-5D5A-48BA-9194-0B03C2A97BED_at_cisco.com" -->
<!-- charset="US-ASCII" -->
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] Bug: coll_tuned_dynamic_rules_filename and duplicatecommunicators<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-07-11 08:29:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9912.php">Jeff Squyres: "Re: [OMPI users] MPI IO bug test case for OpenMPI 1.3"</a>
<li><strong>Previous message:</strong> <a href="9910.php">Ashley Pittman: "Re: [OMPI users] Problems in OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="9872.php">Jumper, John: "[OMPI users] Bug: coll_tuned_dynamic_rules_filename and duplicate communicators"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9913.php">John R. Cary: "[OMPI users] default host file ignore?  (also, what limits connections?)"</a>
<li><strong>Reply:</strong> <a href="9913.php">John R. Cary: "[OMPI users] default host file ignore?  (also, what limits connections?)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I've filed <a href="https://svn.open-mpi.org/trac/ompi/ticket/1974">https://svn.open-mpi.org/trac/ompi/ticket/1974</a> about this.
<br>
<p><p>On Jul 7, 2009, at 1:04 PM, Jumper, John wrote:
<br>
