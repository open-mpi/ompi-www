...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9787.php">Michael Di Domenico: "[OMPI users] quadrics support?"</a>
<li><strong>Previous message:</strong> <a href="9785.php">Jeff Squyres: "Re: [OMPI users] btl_openib_connect_oob.c:459:qp_create_one: errorcreating qp"</a>
<li><strong>In reply to:</strong> <a href="9785.php">Jeff Squyres: "Re: [OMPI users] btl_openib_connect_oob.c:459:qp_create_one: errorcreating qp"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
