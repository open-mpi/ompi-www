...
?>
<!-- received="Wed Jul 15 09:28:25 2009" -->
<!-- isoreceived="20090715132825" -->
<!-- sent="Wed, 15 Jul 2009 16:28:19 +0300" -->
<!-- isosent="20090715132819" -->
<!-- name="Lenny Verkhovsky" -->
<!-- email="lenny.verkhovsky_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="453d39990907150628v4ad2ea66l88ef20a5b4557ba6_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="71d2d8cc0907150610h29a3f8bdlde86e7281bd832da_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-15 09:28:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9976.php">neeraj_at_[hidden]: "Re: [OMPI users] selectively bind MPI to one HCA out of available	ones"</a>
<li><strong>Previous message:</strong> <a href="9974.php">Ralph Castain: "Re: [OMPI users] selectively bind MPI to one HCA out of available ones"</a>
<li><strong>In reply to:</strong> <a href="9971.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9979.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9979.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>======================   ALLOCATED NODES   ======================
<br>
<p>&nbsp;Data for node: Name: dellix7   Num slots: 0    Max slots: 0
<br>
...
hosts.
<br>
<p><p>On Wed, Jul 15, 2009 at 4:10 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; What is supposed to happen is this:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; 1. each line of the appfile causes us to create a new app_context. We store
</span><br>
<span class="quotelev1">&gt; the provided -host info in that object.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; 2. when we create the &quot;allocation&quot;, we cycle through -all- the app_contexts
</span><br>
<span class="quotelev1">&gt; and add -all- of their -host info into the list of allocated nodes
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; 3. when we get_target_nodes, we start with the entire list of allocated
</span><br>
<span class="quotelev1">&gt; nodes, and then use -host for that app_context to filter down to the hosts
</span><br>
<span class="quotelev1">&gt; allowed for that specific app_context
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; So you should have to only provide -np 1 and 1 host on each line. My guess
</span><br>
<span class="quotelev1">&gt; is that the rankfile mapper isn't correctly behaving for multiple
</span><br>
<span class="quotelev1">&gt; app_contexts.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Add --display-allocation to your mpirun cmd line for the &quot;not working&quot; cse
</span><br>
<span class="quotelev1">&gt; and let's see what mpirun thinks the total allocation is - I'll bet that
</span><br>
<span class="quotelev1">&gt; both nodes show up, which would tell us that my &quot;guess&quot; is correct. Then
</span><br>
<span class="quotelev1">&gt; I'll know what needs to be fixed.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Wed, Jul 15, 2009 at 6:08 AM, Lenny Verkhovsky &lt;
</span><br>
...
<span class="quotelev2">&gt;&gt; by line in the app file, and not from the hostlist provided by mpirun on HNP
</span><br>
<span class="quotelev2">&gt;&gt; node.
</span><br>
<span class="quotelev2">&gt;&gt; According to my suspections your proposal should not work(and it does
</span><br>
<span class="quotelev2">&gt;&gt; not), since in appfile line I provide np=1, and 1 host, while rankfile tries
</span><br>
<span class="quotelev2">&gt;&gt; to allocate all ranks (np=2).
</span><br>
...
<span class="quotelev2">&gt;&gt; mpirun cmd. If I didnt provide hostlist in the appfile line, mpirun uses
</span><br>
<span class="quotelev2">&gt;&gt; local host and not hosts from the hostfile.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; the appfile. Which is quit a problematic.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; i.e.,, just use &quot;mpirun -np 2 -rf rankfile -app appfile&quot;. Does that work?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Sorry to have to keep asking you to try things - I don't have a setup
</span><br>
<span class="quotelev3">&gt;&gt;&gt; here where I can test this as everything is RM managed.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wed, Jul 15, 2009 at 6:58 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; $LD_LIBRARY_PATH=/hpc/home/USERS/lennyb/work/svn/ompi/trunk/build_x86-64/install/lib/
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; /hpc/home/USERS/lennyb/work/svn/ompi/trunk/build_x86-64/install/bin/mpirun
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Tue, Jul 14, 2009 at 7:08 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Run it without the appfile, just putting the apps on the cmd line -
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; does it work right then?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Tue, Jul 14, 2009 at 4:59 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; with trunk 1.4a1r21657).
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; The problem is, that rankfile mapper tries to find an appropriate host
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Wed, May 13, 2009 at 1:55 AM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; So, if your hostfile limit is 4, then &quot;mpirun -np 4&quot; and &quot;mpirun -np
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 5&quot; both works, but in both cases there are only 4 tasks. It isn't crucial,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; because there is nor real oversubscription, but there is still some bug
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Although removing this check solves problem of having more slots in
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; you ask for 1 CPU less. And the same behavior in any case (shared nodes,
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; all affinities set as it requested in rankfile, there is no
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; is required.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the length of array is NP, maximum index must be less than np, so if you
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; have the number of rank &gt; NP, you have no place to put it inside array.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &quot;Likewise, if you have more procs than the rankfile specifies, we
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; map the additional procs either byslot (default) or bynode (if you specify
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that option). So the rankfile doesn't need to contain an entry for every
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; but that isn't correct. The rankfile mapper doesn't care if the rankfile
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; contains additional info - it only maps up to the number of processes, and
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ignores anything beyond that number. So there is no need to remove the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; my command doesn't work
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; it (if Lenny
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; LD_LIBRARY_PATH to
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; line ; there is no global understanding of the ranking inside
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9975/attachment">attachment</a>
</ul>
