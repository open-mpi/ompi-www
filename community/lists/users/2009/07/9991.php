<?
$subject_val = "Re: [OMPI users] [OMPI devel] selectively bind MPI to one HCA out of available ones";
...
<!-- subject="Re: [OMPI users] [OMPI devel] selectively bind MPI to one HCA out of available ones" -->
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] [OMPI devel] selectively bind MPI to one HCA out of available ones<br>
<strong>From:</strong> Pavel Shamis (Pasha) (<em>pashash_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-07-16 04:16:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9992.php">Geoffroy Pignot: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Previous message:</strong> <a href="9990.php">Mike Dubman: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
