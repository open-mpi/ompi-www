...
?>
<!-- received="Tue Jul 14 23:58:17 2009" -->
<!-- isoreceived="20090715035817" -->
<!-- sent="Tue, 14 Jul 2009 21:58:02 -0600" -->
<!-- isosent="20090715035802" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="7331C781-49C6-4DD9-9191-E34474307AA6_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="453d39990907140929sb57faeat6d6fff7e8380ecbe_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-14 23:58:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9964.php">Prasadcse Perera: "Re: [OMPI users] Receiving an unknown number of messages"</a>
<li><strong>Previous message:</strong> <a href="9962.php">Zou, Lin (GE, Research, Consultant): "[OMPI users] questions about tracing OpenMPI program"</a>
<li><strong>In reply to:</strong> <a href="9953.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9966.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9966.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
correct.
<br>
<p>When we changed hostfile and -host to be per-app-context options, it  
<br>
...
following:
<br>
<p>-np 1 -H witch1 hostname
<br>
-np 1 -H witch2 hostname
<br>
<p>That should get you what you want.
<br>
Ralph
<br>
<p>On Jul 14, 2009, at 10:29 AM, Lenny Verkhovsky wrote:
<br>
<p><span class="quotelev1">&gt; No,  it's not working as I expect , unless I expect somthing wrong .
</span><br>
<span class="quotelev1">&gt; ( sorry for the long PATH, I needed to provide it )
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; $LD_LIBRARY_PATH=/hpc/home/USERS/lennyb/work/svn/ompi/trunk/ 
</span><br>
<span class="quotelev1">&gt; build_x86-64/install/lib/ /hpc/home/USERS/lennyb/work/svn/ompi/trunk/ 
</span><br>
<span class="quotelev1">&gt; build_x86-64/install/bin/mpirun -np 2 -H witch1,witch2 hostname
</span><br>
...
<span class="quotelev1">&gt; build_x86-64/install/bin/mpirun -np 2 -H witch1,witch2 -app appfile
</span><br>
...
<span class="quotelev1">&gt; On Tue, Jul 14, 2009 at 7:08 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;  
</span><br>
...
<span class="quotelev2">&gt;&gt; I expect that each application would run on hostB and hostC, but I  
</span><br>
<span class="quotelev2">&gt;&gt; get all of them running on hostA.
</span><br>
...
<span class="quotelev2">&gt;&gt; On Tue, Jul 14, 2009 at 4:59 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I can't use rankfile with app, even after all those fixes  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ( working with trunk 1.4a1r21657).
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [dellix7:13414] [[10851,0],0] ORTE_ERROR_LOG: Bad parameter in  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wed, May 13, 2009 at 1:55 AM, Ralph Castain &lt;rhc_at_[hidden]&gt;  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; So, if your hostfile limit is 4, then &quot;mpirun -np 4&quot; and &quot;mpirun - 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; np 5&quot; both works, but in both cases there are only 4 tasks. It  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; isn't crucial, because there is nor real oversubscription, but  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; there is still some bug which can affect something in future.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, May 5, 2009 at 7:04 AM, Lenny Verkhovsky &lt;lenny.verkhovsky_at_[hidden] 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; the length of array is NP, maximum index must be less than np, so  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; if you have the number of rank &gt; NP, you have no place to put it  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; inside array.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;Likewise, if you have more procs than the rankfile specifies, we  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; map the additional procs either byslot (default) or bynode (if you  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; specify that option). So the rankfile doesn't need to contain an  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; entry for every proc.&quot;  - Correct point.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; rankfile contains additional info - it only maps up to the number  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; of processes, and ignores anything beyond that number. So there is  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; no need to remove the additional info.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Likewise, if you have more procs than the rankfile specifies, we  
...
<span class="quotelev3">&gt;&gt;&gt; entry for every proc.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, May 5, 2009 at 5:59 AM, Lenny Verkhovsky &lt;lenny.verkhovsky_at_[hidden] 
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Mon, May 4, 2009 at 11:14 AM, Geoffroy Pignot &lt;geopignot_at_[hidden] 
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hi ,
...
<span class="quotelev4">&gt;&gt;&gt; &gt; launch a multiexes application (masters-slaves) and benefit from  
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9963/attachment">attachment</a>
</ul>
