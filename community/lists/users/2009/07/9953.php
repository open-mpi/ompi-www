...
?>
<!-- received="Tue Jul 14 12:29:29 2009" -->
<!-- isoreceived="20090714162929" -->
<!-- sent="Tue, 14 Jul 2009 19:29:23 +0300" -->
<!-- isosent="20090714162923" -->
<!-- name="Lenny Verkhovsky" -->
<!-- email="lenny.verkhovsky_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="453d39990907140929sb57faeat6d6fff7e8380ecbe_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="45AA5793-192D-4840-913E-CDACB4297FCE_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-14 12:29:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9954.php">Ralph Castain: "[OMPI users] Fwd: Open MPI v1.3.3 released"</a>
<li><strong>Previous message:</strong> <a href="9952.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>In reply to:</strong> <a href="9952.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9963.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9963.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>$LD_LIBRARY_PATH=/hpc/home/USERS/lennyb/work/svn/ompi/trunk/build_x86-64/install/lib/
<br>
...
-np 1 hostname
<br>
<p><p>On Tue, Jul 14, 2009 at 7:08 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Run it without the appfile, just putting the apps on the cmd line - does it
</span><br>
<span class="quotelev1">&gt; work right then?
</span><br>
...
<span class="quotelev1">&gt; I am running mpirun on hostA, and providing hostlist with hostB and hostC.
</span><br>
<span class="quotelev1">&gt; I expect that each application would run on hostB and hostC, but I get all
</span><br>
<span class="quotelev1">&gt; of them running on hostA.
</span><br>
...
<span class="quotelev2">&gt;&gt; Strange - let me have a look at it later today. Probably something simple
</span><br>
<span class="quotelev2">&gt;&gt; that another pair of eyes might spot.
</span><br>
...
<span class="quotelev2">&gt;&gt; I can't use rankfile with app, even after all those fixes ( working with
</span><br>
...
<span class="quotelev2">&gt;&gt; The problem is, that rankfile mapper tries to find an appropriate host in
</span><br>
<span class="quotelev2">&gt;&gt; the partial ( and not full ) hostlist.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; If you hostfile and rank file limit you at N procs, you can ask mpirun
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; for N+1 and it wil be not rejected.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Although in reality there will be N tasks.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So, if your hostfile limit is 4, then &quot;mpirun -np 4&quot; and &quot;mpirun -np 5&quot;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; both works, but in both cases there are only 4 tasks. It isn't crucial,
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; &quot;There are not enough slots available in the system to satisfy the 4
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; but &quot;mpirun -np 3 ./something&quot; will work though. It works, when you
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ask for 1 CPU less. And the same behavior in any case (shared nodes,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; non-shared nodes, multi-node)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; If you switch off rmaps_base_no_oversubscribe, then it works and all
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; affinities set as it requested in rankfile, there is no oversubscription.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; If I remember correctly, I used an array to map ranks, and since the
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; length of array is NP, maximum index must be less than np, so if you have
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; the number of rank &gt; NP, you have no place to put it inside array.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; &quot;Likewise, if you have more procs than the rankfile specifies, we map
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; the additional procs either byslot (default) or bynode (if you specify that
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; option). So the rankfile doesn't need to contain an entry for every proc.&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;  - Correct point.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; On 5/5/09, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote: Sorry Lenny, but
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; that isn't correct. The rankfile mapper doesn't care if the rankfile
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun  --rankfile rankf --hostfile hostf  --host node1 -n 1 hostname
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; : --host node2 -n 1 hostname
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I agree with you Ralph , and that 's what I expect from openmpi but
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; I agree that my examples are not very clear. What I want to do is
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; uses an MCA interface that is not recognized (component MCA v1.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; !=
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9953/attachment">attachment</a>
</ul>
