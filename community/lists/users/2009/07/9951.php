...
?>
<!-- received="Tue Jul 14 12:04:45 2009" -->
<!-- isoreceived="20090714160445" -->
<!-- sent="Tue, 14 Jul 2009 19:04:40 +0300" -->
<!-- isosent="20090714160440" -->
<!-- name="Lenny Verkhovsky" -->
<!-- email="lenny.verkhovsky_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="453d39990907140904n3ba85782l61ce904f4ddaa9b2_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="64F8C282-3781-46A7-AA74-E3605F175154_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-14 12:04:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9952.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Previous message:</strong> <a href="9950.php">Evans, Thomas M.: "[OMPI users] Stumped again by dynamic loading"</a>
<li><strong>In reply to:</strong> <a href="9947.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9952.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9952.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Lenny.
<br>
<p>On Tue, Jul 14, 2009 at 4:59 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Strange - let me have a look at it later today. Probably something simple
</span><br>
<span class="quotelev1">&gt; that another pair of eyes might spot.
</span><br>
...
<span class="quotelev1">&gt; I can't use rankfile with app, even after all those fixes ( working with
</span><br>
...
<span class="quotelev1">&gt; The problem is, that rankfile mapper tries to find an appropriate host in
</span><br>
<span class="quotelev1">&gt; the partial ( and not full ) hostlist.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; If you hostfile and rank file limit you at N procs, you can ask mpirun
</span><br>
<span class="quotelev3">&gt;&gt;&gt; for N+1 and it wil be not rejected.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Although in reality there will be N tasks.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So, if your hostfile limit is 4, then &quot;mpirun -np 4&quot; and &quot;mpirun -np 5&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; both works, but in both cases there are only 4 tasks. It isn't crucial,
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; but &quot;mpirun -np 3 ./something&quot; will work though. It works, when you ask
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; for 1 CPU less. And the same behavior in any case (shared nodes, non-shared
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; nodes, multi-node)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; If you switch off rmaps_base_no_oversubscribe, then it works and all
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; affinities set as it requested in rankfile, there is no oversubscription.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; orte_show_help(&quot;help-rmaps_rank_file.txt&quot;, &quot;bad-rankfile&quot;, true, ival,
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; If I remember correctly, I used an array to map ranks, and since the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; length of array is NP, maximum index must be less than np, so if you have
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the number of rank &gt; NP, you have no place to put it inside array.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; &quot;Likewise, if you have more procs than the rankfile specifies, we map
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the additional procs either byslot (default) or bynode (if you specify that
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; option). So the rankfile doesn't need to contain an entry for every proc.&quot;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;  - Correct point.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; that isn't correct. The rankfile mapper doesn't care if the rankfile
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; if np=1 then there is only rank 0 in the system, so rank 1 is invalid.
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; mpirun  --rankfile rankf --hostfile hostf  --host node1 -n 1 hostname
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; : --host node2 -n 1 hostname
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [r011n006:28986] [[45541,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Ralph, could you tell me if my command syntax is correct or not ? if
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9951/attachment">attachment</a>
</ul>
