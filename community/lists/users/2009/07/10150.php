...
?>
<!-- received="Thu Jul 30 18:36:24 2009" -->
<!-- isoreceived="20090730223624" -->
<!-- sent="Thu, 30 Jul 2009 16:36:09 -0600" -->
<!-- isosent="20090730223609" -->
<!-- name="Adams, Brian M" -->
...
<!-- id="A0801CEC7AFED846978515099D145DA5153BD55350_at_ES01SNLNT.srn.sandia.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="3022E989-1B8A-4FF1-BC7E-5D6CFC02937F_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-30 18:36:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10151.php">Ralph Castain: "Re: [OMPI users] Multiple mpiexec's within a job (schedule within a scheduled machinefile/job allocation)"</a>
<li><strong>Previous message:</strong> <a href="10149.php">Ralph Castain: "Re: [OMPI users] Multiple mpiexec's within a job (schedule within a scheduled machinefile/job allocation)"</a>
<li><strong>In reply to:</strong> <a href="10149.php">Ralph Castain: "Re: [OMPI users] Multiple mpiexec's within a job (schedule within a scheduled machinefile/job allocation)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10151.php">Ralph Castain: "Re: [OMPI users] Multiple mpiexec's within a job (schedule within a scheduled machinefile/job allocation)"</a>
<li><strong>Reply:</strong> <a href="10151.php">Ralph Castain: "Re: [OMPI users] Multiple mpiexec's within a job (schedule within a scheduled machinefile/job allocation)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>My quick impression is that this will meet at least 90% of user needs out of the box as most (all?) users will run with number of job processors that divides into PPN or is a multiple of PPN.
<br>
<p>The docs imply that the relative indexing is relative to nodes as opposed to slots.  If so, it's easy to cover my cases 1 and 2 with modulo arithmetic right on the command line, but the edge case 3 might require creation of host files or a maps file, specifying specific nodes and slots.  I'm still trying to fully wrap my head around the way the scheduling works and the nodes/slots distinction, so have to think on this.  For example, in a PBS/Torque environment, I guess each processor gets an entry as a &quot;node&quot; in the $PBS_NODEFILE, so maybe this won't be an issue for many of our machines.
<br>
<p>Another potential gotcha is the scheduler driving my M scheduler processes ideally runs asynchronously (since not all compute jobs take equal time as parameters vary), so initially jobs 0--M could be on resource blocks 0--M in order, but if job 2 finishes first, I'd want to put job M+1 on block 2.  So I might end up needing some glue code anyway for the dynamic scheduling case.  What's in ORTE today will likely work great in the static scheduling case.
<br>
<p>Brian
<br>
...
Subject: Re: [OMPI users] Multiple mpiexec's within a job (schedule within a scheduled machinefile/job allocation)
<br>
<p>Let me know how it goes, if you don't mind. It would be nice to know if we actually met your needs, or if a tweak might help make it easier.
<br>
<p>Thanks
<br>
Ralph
...
<br>
<p>Thanks Ralph, I wasn't aware of the relative indexing or sequential mapper capabilities.  I will check those out and report back if I still have a feature request. -- Brian
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-10150/attachment">attachment</a>
</ul>
