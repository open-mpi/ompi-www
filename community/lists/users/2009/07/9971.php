...
?>
<!-- received="Wed Jul 15 09:10:19 2009" -->
<!-- isoreceived="20090715131019" -->
<!-- sent="Wed, 15 Jul 2009 07:10:13 -0600" -->
<!-- isosent="20090715131013" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="71d2d8cc0907150610h29a3f8bdlde86e7281bd832da_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="453d39990907150508j33ffa3f0qefc0801ea40f0d34_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-15 09:10:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9972.php">neeraj_at_[hidden]: "[OMPI users] selectively bind MPI to one HCA out of available ones"</a>
<li><strong>Previous message:</strong> <a href="9970.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>In reply to:</strong> <a href="9968.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9975.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9975.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>1. each line of the appfile causes us to create a new app_context. We store
<br>
the provided -host info in that object.
<br>
<p>2. when we create the &quot;allocation&quot;, we cycle through -all- the app_contexts
<br>
and add -all- of their -host info into the list of allocated nodes
<br>
<p>3. when we get_target_nodes, we start with the entire list of allocated
<br>
nodes, and then use -host for that app_context to filter down to the hosts
<br>
allowed for that specific app_context
<br>
<p>So you should have to only provide -np 1 and 1 host on each line. My guess
<br>
is that the rankfile mapper isn't correctly behaving for multiple
<br>
app_contexts.
<br>
<p>Add --display-allocation to your mpirun cmd line for the &quot;not working&quot; cse
<br>
...
Ralph
<br>
<p><p>On Wed, Jul 15, 2009 at 6:08 AM, Lenny Verkhovsky &lt;
<br>
lenny.verkhovsky_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Same result.
</span><br>
<span class="quotelev1">&gt; I still suspect that rankfile claims for node in small hostlist provided by
</span><br>
<span class="quotelev1">&gt; line in the app file, and not from the hostlist provided by mpirun on HNP
</span><br>
<span class="quotelev1">&gt; node.
</span><br>
<span class="quotelev1">&gt; According to my suspections your proposal should not work(and it does not),
</span><br>
<span class="quotelev1">&gt; since in appfile line I provide np=1, and 1 host, while rankfile tries to
</span><br>
...
<span class="quotelev1">&gt; node_list will be partial, according to app, and not full provided by
</span><br>
<span class="quotelev1">&gt; mpirun cmd. If I didnt provide hostlist in the appfile line, mpirun uses
</span><br>
<span class="quotelev1">&gt; local host and not hosts from the hostfile.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Currently, in order to get it working I need to provide full hostlist in
</span><br>
<span class="quotelev1">&gt; the appfile. Which is quit a problematic.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; On Wed, Jul 15, 2009 at 2:02 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Try your &quot;not working&quot; example without the -H on the mpirun cmd line -
</span><br>
<span class="quotelev2">&gt;&gt; i.e.,, just use &quot;mpirun -np 2 -rf rankfile -app appfile&quot;. Does that work?
</span><br>
<span class="quotelev2">&gt;&gt; Sorry to have to keep asking you to try things - I don't have a setup here
</span><br>
...
<span class="quotelev2">&gt;&gt; I still have a problem running app file with rankfile, by providing full
</span><br>
...
<span class="quotelev2">&gt;&gt; On Wed, Jul 15, 2009 at 6:58 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; When we changed hostfile and -host to be per-app-context options, it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; became necessary for you to put that info in the appfile itself. So try
</span><br>
<span class="quotelev3">&gt;&gt;&gt; adding it there. What you would need in your appfile is the following:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; $LD_LIBRARY_PATH=/hpc/home/USERS/lennyb/work/svn/ompi/trunk/build_x86-64/install/lib/
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /hpc/home/USERS/lennyb/work/svn/ompi/trunk/build_x86-64/install/bin/mpirun
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, Jul 14, 2009 at 7:08 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Run it without the appfile, just putting the apps on the cmd line - does
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I am running mpirun on hostA, and providing hostlist with hostB and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; hostC.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I expect that each application would run on hostB and hostC, but I get
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Tue, Jul 14, 2009 at 4:59 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Strange - let me have a look at it later today. Probably something
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I can't use rankfile with app, even after all those fixes ( working
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; with trunk 1.4a1r21657).
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [dellix7:13414] [[10851,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; ../../../../../orte/mca/rmaps/rank_file/rmaps_rank_file.c at line 422
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [dellix7:13414] [[10851,0],0] ORTE_ERROR_LOG: Bad parameter in file
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; The problem is, that rankfile mapper tries to find an appropriate host
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Wed, May 13, 2009 at 1:55 AM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; If you hostfile and rank file limit you at N procs, you can ask
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun for N+1 and it wil be not rejected.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Although in reality there will be N tasks.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; So, if your hostfile limit is 4, then &quot;mpirun -np 4&quot; and &quot;mpirun -np
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 5&quot; both works, but in both cases there are only 4 tasks. It isn't crucial,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; because there is nor real oversubscription, but there is still some bug
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Although removing this check solves problem of having more slots in
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Ah - thx for catching that, I'll remove that check. It no longer is
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the length of array is NP, maximum index must be less than np, so if you
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; have the number of rank &gt; NP, you have no place to put it inside array.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &quot;Likewise, if you have more procs than the rankfile specifies, we
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; map the additional procs either byslot (default) or bynode (if you specify
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that option). So the rankfile doesn't need to contain an entry for every
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; but that isn't correct. The rankfile mapper doesn't care if the rankfile
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; contains additional info - it only maps up to the number of processes, and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ignores anything beyond that number. So there is no need to remove the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; [r011n002:25129] [[63976,0],0] ORTE_ERROR_LOG: Bad parameter
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; mpirun --hostfile hostfile.0 -rf rankfile.0 -n 1 hostname : -n
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; line ; there is no global understanding of the ranking inside
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9971/attachment">attachment</a>
</ul>
