...
?>
<!-- received="Tue Jul 14 09:59:52 2009" -->
<!-- isoreceived="20090714135952" -->
<!-- sent="Tue, 14 Jul 2009 07:59:36 -0600" -->
<!-- isosent="20090714135936" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="64F8C282-3781-46A7-AA74-E3605F175154_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="453d39990907140643i361e1e63r3ca352e7fe7aba51_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-14 09:59:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9948.php">Evans, Thomas M.: "Re: [OMPI users] Python bindings for openmpi"</a>
<li><strong>Previous message:</strong> <a href="9946.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>In reply to:</strong> <a href="9946.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9951.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9951.php">Lenny Verkhovsky: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Jul 14, 2009, at 7:43 AM, Lenny Verkhovsky wrote:
<br>
<p><span class="quotelev1">&gt; Seems like connected problem:
</span><br>
...
<span class="quotelev1">&gt; The problem is, that rankfile mapper tries to find an appropriate  
</span><br>
<span class="quotelev1">&gt; host in the partial ( and not full ) hostlist.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9947/attachment">attachment</a>
</ul>
