...
?>
<!-- received="Fri Jul 31 14:01:01 2009" -->
<!-- isoreceived="20090731180101" -->
<!-- sent="Fri, 31 Jul 2009 14:00:05 -0400" -->
<!-- isosent="20090731180005" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] programs are segfaulting using Torque &amp;amp; OpenMPI" -->
<!-- id="4A733125.4050408_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="ca3302690907311035q16656e2dxc405a7067a3ea2aa_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-31 14:00:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10163.php">W.Keegstra: "Re: [OMPI users] programs are segfaulting using Torque &amp; OpenMPI"</a>
<li><strong>Previous message:</strong> <a href="10161.php">Ralph Castain: "Re: [OMPI users] programs are segfaulting using Torque &amp; OpenMPI"</a>
<li><strong>Maybe in reply to:</strong> <a href="10152.php">Wilko Keegstra: "[OMPI users] programs are segfaulting using Torque &amp; OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10163.php">W.Keegstra: "Re: [OMPI users] programs are segfaulting using Torque &amp; OpenMPI"</a>
<li><strong>Reply:</strong> <a href="10163.php">W.Keegstra: "Re: [OMPI users] programs are segfaulting using Torque &amp; OpenMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Two wild guesses:
<br>
<p>1) Check if the pbs_mom daemon script on your nodes (in /etc/init.d on 
<br>
...
Gus Correa
<br>
<p><span class="quotelev1">&gt; On Fri, Jul 31, 2009 at 11:31 AM, Ralph Castain&lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; You might check with your sys admin - or checkout the &quot;ulimit&quot; cmd. Depends
</span><br>
<span class="quotelev2">&gt;&gt; on what the sys admin has set for system limits.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Can you run gdb (or your favorite debugger) against a core file from
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; your app? It looks like something in your app is crashing.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; As far as I can tell, everything is working fine. We launch and wireup
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /usr/local/bin/mpiexec -v -mca ras_base_verbose 5 -mca plm_base_verbose
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; really use anything else from Torque, and run on Torque-based clusters
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; could then do a run with -mca ras_base_verbose 5 -mca plm_base_verbose
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; however mpiexec programs from script (script submiited through torque)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; are only running on 1 node, so I need openmpi compiled with --with-tm
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &lt;tm.3.gz&gt;&lt;AlignImages.o34.gz&gt;&lt;momlog-20090731.gz&gt;_______________________________________________
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
