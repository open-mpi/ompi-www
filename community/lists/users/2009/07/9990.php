...
?>
<!-- received="Thu Jul 16 02:01:50 2009" -->
<!-- isoreceived="20090716060150" -->
<!-- sent="Thu, 16 Jul 2009 09:01:44 +0300" -->
<!-- isosent="20090716060144" -->
<!-- name="Mike Dubman" -->
<!-- email="mike.ompi_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="b20b52800907152301m5988de1fv4bd4cd195aaa2c8d_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="F30A1A02-208D-406E-8630-9C53550076A4_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-07-16 02:01:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9991.php">Pavel Shamis (Pasha): "Re: [OMPI users] [OMPI devel] selectively bind MPI to one HCA out of available ones"</a>
<li><strong>Previous message:</strong> <a href="9989.php">vipin kumar: "[OMPI users] Network connection check"</a>
<li><strong>In reply to:</strong> <a href="9987.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9993.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9993.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello Ralph,
<br>
<p>It seems that Option2 is preferred, because it is more intuitive for
<br>
end-user to create rankfile for mpi job, which is described by -app cmd
<br>
line.
<br>
<p>All hosts definitions used inside -app &lt;file&gt;, will be treated like a single
<br>
...
<p>Mike
<br>
<p><p>P.S. man mpirun claims, that:
<br>
<p>-app &lt;appfile&gt; Provide an appfile, ignoring all other command line options.
<br>
<p>but it seems that it does not ignore all other command line options.
<br>
...
<br>
<p><p><p><p><p><p><p><p>On Thu, Jul 16, 2009 at 2:00 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Hmmm...well actually, there isn't a bug in the code. This is an interesting
</span><br>
<span class="quotelev1">&gt; question!
</span><br>
<span class="quotelev1">&gt; Here is the problem. It has to do with how -host is processed. Remember, in
</span><br>
<span class="quotelev1">&gt; the new scheme (as of 1.3.0), in the absence of any other info (e.g., an RM
</span><br>
<span class="quotelev1">&gt; allocation or hostfile), we cycle across -all- the -host specifications to
</span><br>
<span class="quotelev1">&gt; create a global pool of allocated nodes. Hence, you got the following:
</span><br>
...
<span class="quotelev1">&gt; When we start mapping, we call the base function to get the available nodes
</span><br>
<span class="quotelev1">&gt; for this particular app_context. The function starts with the entire
</span><br>
<span class="quotelev1">&gt; allocation. It then checks for a hostfile, which in this case it won't find.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Subsequently, it looks at the -host spec and removes -all- nodes in the
</span><br>
<span class="quotelev1">&gt; list that were not included in -host. In the case of app_context=0, the
</span><br>
<span class="quotelev1">&gt; &quot;-host witch1&quot; causes us to remove dellix7 and witch2 from the list -
</span><br>
<span class="quotelev1">&gt; leaving only witch1.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; This list is passed back to the rank_file mapper. The rf mapper then looks
</span><br>
<span class="quotelev1">&gt; at your rankfile, which tells it to put rank=0 on the +n1 node on the list.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; But the list only has ONE node on the list, which would correspond to +n0!
</span><br>
...
<span class="quotelev1">&gt; Option 1. we can leave things as they are, and you adjust your rankfile to:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Since you specified -host witch2 for the second app_context, this will work
</span><br>
<span class="quotelev1">&gt; to put rank0 on witch1 and rank1 on witch2. However, I admit that it looks a
</span><br>
<span class="quotelev1">&gt; little weird.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Note you could have -host witch1,witch2 on the second line too, if you
</span><br>
<span class="quotelev1">&gt; wanted. Now your current rankfile would put rank0 on witch2 and rank1 on
</span><br>
<span class="quotelev1">&gt; witch1.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Option 2. we could modify your relative node syntax to be based on the
</span><br>
<span class="quotelev1">&gt; eventual total allocation. In this case, we would not use the base function
</span><br>
<span class="quotelev1">&gt; to give us a list, but instead would construct it from the allocated node
</span><br>
<span class="quotelev1">&gt; pool.
</span><br>
<span class="quotelev1">&gt; Your current rankfile would give you what you wanted since we wouldn't count the HNP's node in the pool as it wasn't included in the allocation.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Any thoughts on how you'd like to do this? I can make it work either way, but have no personal preference.
</span><br>
...
<span class="quotelev1">&gt; Okay, I'll dig into it - must be a bug in my code.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Wed, Jul 15, 2009 at 7:28 AM, Lenny Verkhovsky &lt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On Wed, Jul 15, 2009 at 4:10 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; What is supposed to happen is this:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 1. each line of the appfile causes us to create a new app_context. We
</span><br>
<span class="quotelev3">&gt;&gt;&gt; store the provided -host info in that object.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 2. when we create the &quot;allocation&quot;, we cycle through -all- the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; app_contexts and add -all- of their -host info into the list of allocated
</span><br>
<span class="quotelev3">&gt;&gt;&gt; nodes
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 3. when we get_target_nodes, we start with the entire list of allocated
</span><br>
<span class="quotelev3">&gt;&gt;&gt; nodes, and then use -host for that app_context to filter down to the hosts
</span><br>
<span class="quotelev3">&gt;&gt;&gt; allowed for that specific app_context
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So you should have to only provide -np 1 and 1 host on each line. My
</span><br>
<span class="quotelev3">&gt;&gt;&gt; guess is that the rankfile mapper isn't correctly behaving for multiple
</span><br>
<span class="quotelev3">&gt;&gt;&gt; app_contexts.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Add --display-allocation to your mpirun cmd line for the &quot;not working&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; cse and let's see what mpirun thinks the total allocation is - I'll bet that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; both nodes show up, which would tell us that my &quot;guess&quot; is correct. Then
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'll know what needs to be fixed.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wed, Jul 15, 2009 at 6:08 AM, Lenny Verkhovsky &lt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I still suspect that rankfile claims for node in small hostlist provided
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; by line in the app file, and not from the hostlist provided by mpirun on HNP
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; node.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; According to my suspections your proposal should not work(and it does
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; not), since in appfile line I provide np=1, and 1 host, while rankfile tries
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; to allocate all ranks (np=2).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $orte/mca/rmaps/rank_file/rmaps_rank_file.c at line 338
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;   if(ORTE_SUCCESS != (rc = orte_rmaps_base_get_target_nodes(&amp;node_list,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; &amp;num_slots, app,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; map-&gt;policy))) {
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; node_list will be partial, according to app, and not full provided by
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun cmd. If I didnt provide hostlist in the appfile line, mpirun uses
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; local host and not hosts from the hostfile.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Tell me if I am wrong by expecting the following behaivor
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I provide to mpirun NP, full_hostlist, full_rankfile, appfile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I provide in appfile only partial NP and partial hostlist.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; and it works.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Currently, in order to get it working I need to provide full hostlist in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the appfile. Which is quit a problematic.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $mpirun -np 2 -rf rankfile -app appfile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Rankfile claimed host +n1 by index that is bigger than number of
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; allocated hosts.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [dellix7:17277] [[23928,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ../../../../../orte/mca/rmaps/rank_file/rmaps_rank_file.c at line 422
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [dellix7:17277] [[23928,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ../../../../orte/mca/rmaps/base/rmaps_base_map_job.c at line 85
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [dellix7:17277] [[23928,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ../../../../orte/mca/plm/base/plm_base_launch_support.c at line 103
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [dellix7:17277] [[23928,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ../../../../../orte/mca/plm/rsh/plm_rsh_module.c at line 1001
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Wed, Jul 15, 2009 at 2:02 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Try your &quot;not working&quot; example without the -H on the mpirun cmd line -
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; i.e.,, just use &quot;mpirun -np 2 -rf rankfile -app appfile&quot;. Does that work?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Sorry to have to keep asking you to try things - I don't have a setup
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; here where I can test this as everything is RM managed.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Thanks Ralph, after playing with prefixes it worked,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I still have a problem running app file with rankfile, by providing
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; full hostlist in mpirun command and not in app file.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Is is planned behaviour, or it can be fixed ?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; See Working example:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -np 1 -H witch1,witch2  ./hello_world
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -np 1 -H witch1,witch2 ./hello_world
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; $mpirun -rf rankfile -app appfile
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Hello world! I'm 1 of 2 on witch1
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Hello world! I'm 0 of 2 on witch2
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; See NOT working example:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; $cat appfile
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -np 1 -H witch1 ./hello_world
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -np 1 -H witch2 ./hello_world
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [dellix7:16405] [[24080,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Wed, Jul 15, 2009 at 6:58 AM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; When we changed hostfile and -host to be per-app-context options, it
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; became necessary for you to put that info in the appfile itself. So try
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; adding it there. What you would need in your appfile is the following:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;  No,  it's not working as I expect , unless I expect somthing wrong .
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ( sorry for the long PATH, I needed to provide it )
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; -np 2 -H witch1,witch2 hostname
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; witch1
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; -np 2 -H witch1,witch2 -app appfile
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; dellix7
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; dellix7
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;  $cat appfile
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Tue, Jul 14, 2009 at 7:08 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am running mpirun on hostA, and providing hostlist with hostB and
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; hostC.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I expect that each application would run on hostB and hostC, but I
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; get all of them running on hostA.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;  dellix7$cat appfile
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -np 1 hostname
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -np 1 hostname
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;  dellix7$mpirun -np 2 -H witch1,witch2 -app appfile
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Tue, Jul 14, 2009 at 4:59 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Strange - let me have a look at it later today. Probably something
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; simple that another pair of eyes might spot.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  On Jul 14, 2009, at 7:43 AM, Lenny Verkhovsky wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  Seems like connected problem:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I can't use rankfile with app, even after all those fixes ( working
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; with trunk 1.4a1r21657).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; This is my case :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; $cat rankfile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; rank 0=+n1 slot=0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; rank 1=+n0 slot=0
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; $mpirun -np 2 -H witch1,witch2 -rf rankfile -app appfile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [dellix7:13414] [[10851,0],0] ORTE_ERROR_LOG: Bad parameter in file
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ../../../../../orte/mca/rmaps/rank_file/rmaps_rank_file.c at line 422
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [dellix7:13414] [[10851,0],0] ORTE_ERROR_LOG: Bad parameter in file
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The problem is, that rankfile mapper tries to find an appropriate
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; host in the partial ( and not full ) hostlist.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Any suggestions how to fix it?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Thanks
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Wed, May 13, 2009 at 1:55 AM, Ralph Castain &lt;rhc_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; So, if your hostfile limit is 4, then &quot;mpirun -np 4&quot; and &quot;mpirun
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -np 5&quot; both works, but in both cases there are only 4 tasks. It isn't
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; crucial, because there is nor real oversubscription, but there is still some
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; bug which can affect something in future.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; --
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; in rankfile than necessary, there is another problem.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the 4 slots
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that were requested by the application&quot;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; but &quot;mpirun -np 3 ./something&quot; will work though. It works, when
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; you ask for 1 CPU less. And the same behavior in any case (shared nodes,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; non-shared nodes, multi-node)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; If you switch off rmaps_base_no_oversubscribe, then it works and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; all affinities set as it requested in rankfile, there is no
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; orte_show_help(&quot;help-rmaps_rank_file.txt&quot;, &quot;bad-rankfile&quot;,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; true, ival, rankfile);
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; If I remember correctly, I used an array to map ranks, and
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; since the length of array is NP, maximum index must be less than np, so if
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; you have the number of rank &gt; NP, you have no place to put it inside array.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &quot;Likewise, if you have more procs than the rankfile specifies,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; we map the additional procs either byslot (default) or bynode (if you
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; specify that option). So the rankfile doesn't need to contain an entry for
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; every proc.&quot;  - Correct point.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On 5/5/09, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote: Sorry
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Lenny, but that isn't correct. The rankfile mapper doesn't care if the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; rankfile contains additional info - it only maps up to the number of
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; processes, and ignores anything beyond that number. So there is no need to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; remove the additional info.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Likewise, if you have more procs than the rankfile specifies,
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; every proc.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Ralph, could you tell me if my command syntax is correct or not
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ? if not, give me the expected one ?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun --hostfile hostfile.0 -rf rankfile.0 -n 1 hostname : -n
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The rankfile cuts across the entire job - it isn't applied on
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; The first &quot;crash&quot; is OK, since your rankfile has ranks 0 and
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 1
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; fail during opal_init; some of which are due to configuration
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; There may be more information reported by the environment
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; [r011n002:28778] [ 3]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; /tmp/HALMPI/openmpi-1.3.1/lib/openmpi/
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &gt; &gt; [r011n002:28778] [ 6]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; /lib/libc.so.6(__libc_start_main+0xdc)
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9990/attachment">attachment</a>
</ul>
