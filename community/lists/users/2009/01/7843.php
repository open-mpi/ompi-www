...
?>
<!-- received="Mon Jan 26 15:22:12 2009" -->
<!-- isoreceived="20090126202212" -->
<!-- sent="Mon, 26 Jan 2009 21:22:07 +0100" -->
<!-- isosent="20090126202207" -->
<!-- name="jody" -->
<!-- email="jody.xha_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Handling output of processes" -->
<!-- id="9b0da5ce0901261222u2f919398yf1e85edd83cf1a9b_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-01-26 15:22:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7844.php">Ralph Castain: "Re: [OMPI users] Handling output of processes"</a>
<li><strong>Previous message:</strong> <a href="7842.php">jody: "Re: [OMPI users] Handling output of processes"</a>
<li><strong>In reply to:</strong> <a href="7842.php">jody: "Re: [OMPI users] Handling output of processes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7844.php">Ralph Castain: "Re: [OMPI users] Handling output of processes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Mon, Jan 26, 2009 at 9:20 PM, jody &lt;jody.xha_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev2">&gt;&gt; I would rather not have mpirun doing an xhost command - I think that is
</span><br>
<span class="quotelev2">&gt;&gt; beyond our comfort zone. Frankly, if someone wants to do this, it is up to
</span><br>
<span class="quotelev2">&gt;&gt; them to have things properly setup on their machine - as a rule, we don't
</span><br>
...
<span class="quotelev1">&gt; If not, how else can i have xterms from another machine display locally?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; However, I can check to ensure that the DISPLAY value is locally set and
</span><br>
<span class="quotelev2">&gt;&gt; automatically export it for you (so you don't have to do the -x DISPLAY
</span><br>
<span class="quotelev2">&gt;&gt; option). What I have done is provided a param whereby you can tell us what
</span><br>
<span class="quotelev2">&gt;&gt; command to use to generate the new screen, with it defaulting to &quot;xterm -e&quot;.
</span><br>
<span class="quotelev2">&gt;&gt; I also allow you to specify which ranks you want displayed this way - you
</span><br>
...
<span class="quotelev2">&gt;&gt; Will hopefully have this done today or tomorrow. It will be in the OMPI
</span><br>
<span class="quotelev2">&gt;&gt; trunk repo for now. I'll send out a note pointing to it so people can check
</span><br>
<span class="quotelev2">&gt;&gt; all these options out - I would really appreciate the help to ensure things
</span><br>
<span class="quotelev2">&gt;&gt; are working across as many platforms as possible before we put it in the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I have been impressed by the various methods used to grab the output from
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; processes. Since this is clearly something of interest to a broad
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; audience,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I would like to try and make this easier to do by adding some options to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun. Coming in 1.3.1 will be --tag-output, which will automatically
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; tag
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; each line of output with the rank of the process - this was already in
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I have done some prelim work on a couple of options based on this thread:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 1. spawn a screen and redirect process output to it, with the ability to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; request separate screens for each specified rank. Obviously, specifying
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; all
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ranks would be the equivalent of replacing &quot;my_app&quot; on the mpirun cmd
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; line
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; with &quot;xterm my_app&quot;. However, there are cases where you only need to see
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; output from a subset of the ranks, and that is the intent of this option.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 2. redirect output of specified processes to files using the provided
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; It is also possible to write a dedicated app such as Jody described, but
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; that is outside my purview for now due to priorities. However, I can
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I derive the name of the logfile from the mpi_id. It prefixes the lines
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; with
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; a time-stamp, so you also get some basic profile information. I can send
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; &lt;run_gdb.sh&gt;&lt;run_vg.sh&gt;&lt;run_sh.sh&gt;_______________________________________________
</span><br>
