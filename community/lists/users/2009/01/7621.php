...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7622.php">Mahmoud Payami: "Re: [OMPI users] question running on heterogeneous systems"</a>
<li><strong>Previous message:</strong> <a href="7620.php">doriankrause: "Re: [OMPI users] question running on heterogeneous systems"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2008/12/7610.php">Pavel Shamis (Pasha): "Re: [OMPI users] Problem with openmpi and infiniband"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2008/12/7608.php">Biagio Lucini: "Re: [OMPI users] Problem with openmpi and infiniband"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
