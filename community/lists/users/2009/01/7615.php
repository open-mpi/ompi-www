...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7616.php">Biagio Lucini: "Re: [OMPI users] Problem with openmpi and infiniband"</a>
<li><strong>Previous message:</strong> <a href="7614.php">Mahmoud Payami: "[OMPI users] question running on heterogeneous systems"</a>
<li><strong>In reply to:</strong> <a href="7614.php">Mahmoud Payami: "[OMPI users] question running on heterogeneous systems"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7617.php">Mahmoud Payami: "Re: [OMPI users] question running on heterogeneous systems"</a>
<li><strong>Reply:</strong> <a href="7617.php">Mahmoud Payami: "Re: [OMPI users] question running on heterogeneous systems"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
