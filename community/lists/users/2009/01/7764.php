<?
$subject_val = "Re: [OMPI users] 1.3 hangs running 2 exes with different names";
include("../../include/msg-header.inc");
?>
<!-- received="Thu Jan 22 11:47:43 2009" -->
<!-- isoreceived="20090122164743" -->
<!-- sent="Thu, 22 Jan 2009 09:47:35 -0700" -->
<!-- isosent="20090122164735" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3 hangs running 2 exes with different names" -->
<!-- id="5833D20D-FDF6-4F62-BDAB-2ECAD1148A96_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="b4f9bf870901220442h3472f8bfr4ec5dda39808db26_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] 1.3 hangs running 2 exes with different names<br>
<strong>From:</strong> Ralph Castain (<em>rhc_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-01-22 11:47:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7765.php">Ralph Castain: "Re: [OMPI users] Handling output of processes"</a>
<li><strong>Previous message:</strong> <a href="7763.php">Josh Hursey: "Re: [OMPI users] 1.3 and --preload-files and --preload-binary"</a>
<li><strong>In reply to:</strong> <a href="7758.php">Geoffroy Pignot: "[OMPI users] 1.3 hangs running 2 exes with different names"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>Can you provide more info as to how this was built? Also, be sure to  
<br>
...
<p>Ralph
<br>
<p><p>On Jan 22, 2009, at 5:42 AM, Geoffroy Pignot wrote:
<br>
<p><span class="quotelev1">&gt; Hello , still a bug ???
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; compil03% /tmp/openmpi-1.3/bin/mpirun -n 1 --wdir /tmp --host  
</span><br>
<span class="quotelev1">&gt; compil03 a.out : -n 1 --host compil02 a.out
</span><br>
...
<span class="quotelev1">&gt; compil03% mv a.out a.out_32
</span><br>
<span class="quotelev1">&gt; compil03% /tmp/openmpi-1.3/bin/mpirun -n 1 --wdir /tmp --host  
</span><br>
<span class="quotelev1">&gt; compil03 a.out_32 : -n 1 --host compil02 a.out
</span><br>
<span class="quotelev1">&gt; HANGS
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Thanks in advance for your expertise
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; 2009/1/22 &lt;users-request_at_[hidden]&gt;
</span><br>
...
<span class="quotelev1">&gt;   4. Re: One additional (unwanted) process when        using    
</span><br>
<span class="quotelev1">&gt; dynamical
</span><br>
<span class="quotelev1">&gt;      process management (Ralph Castain)
</span><br>
...
<span class="quotelev2">&gt; &gt; when it runs just on one pc with a few cores (let say  
</span><br>
<span class="quotelev1">&gt; nodes=1:ppn=4),
</span><br>
...
<span class="quotelev2">&gt; &gt; Not that I've seen. What version of OMPI are you using, and on  
</span><br>
<span class="quotelev1">&gt; what type
</span><br>
...
<span class="quotelev1">&gt; Subject: Re: [OMPI users] One additional (unwanted) process  
</span><br>
...
<span class="quotelev2">&gt; &gt; Looks like I'll have to swot up on my linker configuration  
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-7764/attachment">attachment</a>
</ul>
