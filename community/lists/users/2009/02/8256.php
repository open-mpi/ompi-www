...
?>
<!-- received="Fri Feb 27 18:14:51 2009" -->
<!-- isoreceived="20090227231451" -->
<!-- sent="Fri, 27 Feb 2009 18:14:44 -0500" -->
<!-- isosent="20090227231444" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Latest SVN failures" -->
<!-- id="BF753DB6-C1AD-413C-94C9-5B9FC466D9A1_at_cisco.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="49A863B2.2070105_at_Sun.COM" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-02-27 18:14:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8257.php">Jeff Squyres: "Re: [OMPI users] TCP instead of openIB doesn't work"</a>
<li><strong>Previous message:</strong> <a href="8255.php">Vittorio Giovara: "Re: [OMPI users] TCP instead of openIB doesn't work"</a>
<li><strong>In reply to:</strong> <a href="8253.php">Rolf Vandevaart: "Re: [OMPI users] Latest SVN failures"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8262.php">Ralph Castain: "Re: [OMPI users] Latest SVN failures"</a>
<li><strong>Reply:</strong> <a href="8262.php">Ralph Castain: "Re: [OMPI users] Latest SVN failures"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>[15:12] svbu-mpi:~/mpi % mpirun --mca bogus foo --bynode -np 2 uptime
<br>
...
--------------------------------------------------------------------------
<br>
<p>Notice that I'm not trying to run an MPI app -- it's just &quot;uptime&quot;.
<br>
<p>The following things seem to be necessary to make this error occur for  
<br>
me:
<br>
<p>1. --bynode
...
<br>
<p>If I remove any of those, it seems to run file
<br>
<p><p>On Feb 27, 2009, at 5:05 PM, Rolf Vandevaart wrote:
<br>
<p><span class="quotelev1">&gt; With further investigation, I have reproduced this problem.  I think  
</span><br>
...
<span class="quotelev2">&gt;&gt; although my configuration was rather different.  I ran across 100 2- 
</span><br>
<span class="quotelev2">&gt;&gt; CPU sparc nodes, np=256, connected with TCP.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; intel64/10.1.015/openib/suse_sles_10/x86_64/opteron -np 256 -- 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mca btl sm,openib,self -x OMPI_MCA_btl_openib_use_eager_rdma -x  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; OMPI_MCA_btl_openib_eager_limit -x OMPI_MCA_btl_self_eager_limit  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; -x OMPI_MCA_btl_sm_eager_limit -machinefile /tmp/48292.1.all.q/ 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; NAMD_2.6_Source/Linux-amd64-MPI/namd2 stmv.namd
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /tools/openmpi/1.4a1r20643_svn/connectx/intel64/10.1.015/ 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; openib/suse_sles_10/x86_6
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; NAMD_2.6_Source/Li
</span><br>
