...
?>
<!-- received="Tue Feb  3 12:30:45 2009" -->
<!-- isoreceived="20090203173045" -->
<!-- sent="Tue, 3 Feb 2009 10:30:30 -0700" -->
<!-- isosent="20090203173030" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Handling output of processes" -->
<!-- id="96A2F795-B841-4928-8F53-CA31C17BE49A_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="9b0da5ce0902030916n6a925c64v6c763a2fbe9c6243_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-02-03 12:30:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7950.php">jody: "Re: [OMPI users] Handling output of processes"</a>
<li><strong>Previous message:</strong> <a href="7948.php">jody: "Re: [OMPI users] Handling output of processes"</a>
<li><strong>In reply to:</strong> <a href="7948.php">jody: "Re: [OMPI users] Handling output of processes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7950.php">jody: "Re: [OMPI users] Handling output of processes"</a>
<li><strong>Reply:</strong> <a href="7950.php">jody: "Re: [OMPI users] Handling output of processes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; Thanks for the fixes and the &quot;!&quot;.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; --xterm:
</span><br>
<span class="quotelev1">&gt; The &quot;!&quot; works, but i still don't have any xterms from my remote nodes
</span><br>
<span class="quotelev1">&gt; even with all my xhost+ and -x DISPLAY tricks explained below :(
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p>Did you give a location that is on an NFS mount?
<br>
<p>I'm willing to bet the files are being created - they are on your  
<br>
remote nodes. The daemons create their own local files for output from  
<br>
their local procs. We decided to do this for scalability reasons - if  
<br>
we have mpirun open all the output files, then you could easily hit  
<br>
the file descriptor limit on that node and cause the job not to launch.
<br>
<p>Check your remote nodes and see if the files are there.
<br>
<p><span class="quotelev1">&gt; ---
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Regarding xterms - i'm also no big expert on xterms, but i managed to
</span><br>
<span class="quotelev1">&gt; get things working for my environment...
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Generally, in order to enable X-forwarding, i *would* set the option
</span><br>
<span class="quotelev1">&gt;   X11Fowarding yes
</span><br>
<span class="quotelev1">&gt; in the /etc/ssh/sshd_config on the server, and
</span><br>
<span class="quotelev1">&gt;   X11Fowarding yes
</span><br>
<span class="quotelev1">&gt; in the /etc/ssh/ssh_config on the client.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I say 'would', because to actually use x forwarding you need to call
</span><br>
<span class="quotelev1">&gt; ssh with the '-X' option.
</span><br>
<span class="quotelev1">&gt; Correct me if i'm wrong, but i suspect the -X option is not used when
</span><br>
<span class="quotelev1">&gt; Open-MPI makes a connection.
</span><br>
<p>I can fix that easily enough - we'll just test to see if the xterm  
<br>
option has been set, and add the -X to ssh if so.
<br>
<p>Note that you can probably set this yourself right now by -mca  
<br>
plm_rsh_agent &quot;ssh -X&quot;
<br>
...
<span class="quotelev1">&gt;  mpirun -np 4 -hostfile myfiles -x DISPLAY run_xterm.sh  
</span><br>
<span class="quotelev1">&gt; MyApplication arg1 arg2
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; and remote
</span><br>
<span class="quotelev1">&gt; processes created their xterm windows. (In other words, the  
</span><br>
<span class="quotelev1">&gt; environment was
</span><br>
...
<span class="quotelev1">&gt;   mpirun -np 8 -hostfile testhosts --xterm 2,3,4,5! -x DISPLAY ./ 
</span><br>
...
<span class="quotelev2">&gt;&gt; This is a problem we wrestled with for some time. The issue is that  
</span><br>
...
<span class="quotelev2">&gt;&gt; like you do in your script. It is fine for a user to do whatever  
</span><br>
<span class="quotelev2">&gt;&gt; they want,
</span><br>
<span class="quotelev2">&gt;&gt; but for OMPI to do it...that's another matter. We can't even know  
</span><br>
<span class="quotelev2">&gt;&gt; for sure
</span><br>
<span class="quotelev2">&gt;&gt; what to do because of the wide range of scenarios that might occur  
</span><br>
<span class="quotelev2">&gt;&gt; (e.g., is
</span><br>
...
<span class="quotelev2">&gt;&gt; What you (the user) need to do is ensure that X11 is setup properly  
</span><br>
<span class="quotelev2">&gt;&gt; so that
</span><br>
<span class="quotelev2">&gt;&gt; an Xwindow opened on the remote host is displayed on your screen.  
</span><br>
<span class="quotelev2">&gt;&gt; In this
</span><br>
<span class="quotelev2">&gt;&gt; case, I believe you have to enable xforwarding - I'm not an xterm  
</span><br>
<span class="quotelev2">&gt;&gt; expert, so
</span><br>
<span class="quotelev2">&gt;&gt; I can't advise you on how to do this. Suspect you may already know  
</span><br>
<span class="quotelev2">&gt;&gt; - in
</span><br>
<span class="quotelev2">&gt;&gt; which case, can you please pass it along and I'll add it to our  
</span><br>
<span class="quotelev2">&gt;&gt; docs? :-)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt; Strange - the install should put them in the right place, but I  
</span><br>
<span class="quotelev2">&gt;&gt; wonder if
</span><br>
