...
?>
<!-- received="Sun Feb  1 10:00:36 2009" -->
<!-- isoreceived="20090201150036" -->
<!-- sent="Sun, 1 Feb 2009 20:30:30 +0530" -->
<!-- isosent="20090201150030" -->
<!-- name="Sangamesh B" -->
<!-- email="forum.san_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE" -->
<!-- id="cb60cbc40902010700m539b7f10o1f2e2c0b89c7b187_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="4F575D47-8BD8-4F10-A3EC-A33D093E0EBC_at_staff.uni-marburg.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-02-01 10:00:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7922.php">Ted Yu: "Re: [OMPI users] Question about compatibility issues"</a>
<li><strong>Previous message:</strong> <a href="7920.php">Jeff Squyres: "Re: [OMPI users] Handling output of processes"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2009/01/7909.php">Reuti: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7923.php">Reuti: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<li><strong>Reply:</strong> <a href="7923.php">Reuti: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev3">&gt;&gt;&gt; I think this might already be the reason why it's not working. A mpihello
</span><br>
...
reprioritize                 0
<br>
<p>I think its better to check once with Open MPI 1.2.8
<br>
<p><span class="quotelev1">&gt; What is your mpirun command in the jobscript - you are getting there the
</span><br>
<span class="quotelev1">&gt; mpirun from Open MPI? According to the output below, it's not a loose
</span><br>
<span class="quotelev1">&gt; integration, but you prepare alraedy a machinefile, which is superfluous for
</span><br>
...
<br>
<p>/opt/mpi/openmpi/1.3/intel/bin/mpirun -np $NSLOTS
<br>
$CPMDBIN/cpmd311-ompi-mkl.x  wf1.in $PP_LIBRARY &gt;
<br>
wf1.out_OMPI$NSLOTS.$JOB_ID
<br>
<p>For loose integration job:
<br>
...
<br>
<p>I think I should check with Open MPI 1.2.8. That may work..
<br>
<p>Thanks,
<br>
Sangamesh
...
<span class="quotelev2">&gt;&gt; But qhost -u &lt;user name&gt; shows that it is scheduled/running on two nodes.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Any body successful in running Open MPI 1.3 tightly integrated with SGE?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; A daemon (pid 31947) died unexpectedly with status 129 while attempting
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The hostnames for infiniband interfaces are ibc0, ibc1, ibc2 .. ibc23.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; May be Open MPI is not able to identify hosts as it is using node-0-..
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; But the same job runs well, if it runs on a single node but with an
</span><br>
