...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7914.php">Jeff Squyres: "Re: [OMPI users] Question about compatibility issues"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2009/01/7912.php">Jack Bryan: "[OMPI users] Open mpi 123 install error for BLACS"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2009/01/7849.php">Hartzman, Leslie D (MS): "Re: [OMPI users] Newbie needs help! MPI_Wait/MPI_Start/MPI_Issend"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
