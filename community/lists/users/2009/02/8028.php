...
?>
<!-- received="Wed Feb 11 22:19:55 2009" -->
<!-- isoreceived="20090212031955" -->
<!-- sent="Wed, 11 Feb 2009 20:19:45 -0700" -->
<!-- isosent="20090212031945" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI hangs across multiple nodes." -->
<!-- id="B43AB656-E867-4503-8814-61C30EA1986E_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2009-02-11 22:19:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8029.php">Åke Sandgren: "Re: [OMPI users] undefined symbol: tm_init"</a>
<li><strong>Previous message:</strong> <a href="8027.php">Robertson Burgess: "Re: [OMPI users] OpenMPI hangs across multiple nodes."</a>
<li><strong>In reply to:</strong> <a href="8027.php">Robertson Burgess: "Re: [OMPI users] OpenMPI hangs across multiple nodes."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8040.php">George Bosilca: "Re: [OMPI users] OpenMPI hangs across multiple nodes."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Unfortunately, that isn't possible with the current version :-/
<br>
<p>Ralph
<br>
<p>On Feb 11, 2009, at 7:49 PM, Robertson Burgess wrote:
<br>
