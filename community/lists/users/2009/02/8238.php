<?
$subject_val = "[OMPI users] Fwd: more XGrid Problems with openmpi1.2.9 (error find)";
include("../../include/msg-header.inc");
?>
<!-- received="Fri Feb 27 08:25:09 2009" -->
<!-- isoreceived="20090227132509" -->
<!-- sent="Fri, 27 Feb 2009 14:25:04 +0100" -->
<!-- isosent="20090227132504" -->
<!-- name="Ricardo Fern&#225;ndez-Perea" -->
<!-- email="rfernandezperea_at_[hidden]" -->
<!-- subject="[OMPI users] Fwd: more XGrid Problems with openmpi1.2.9 (error find)" -->
<!-- id="ebd2bd0b0902270525g372cc477l72ea6b715f42820_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Fwd: more XGrid Problems with openmpi1.2.9 (error find)<br>
<strong>From:</strong> Ricardo Fern&#225;ndez-Perea (<em>rfernandezperea_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-02-27 08:25:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8239.php">Rolf Vandevaart: "Re: [OMPI users] Latest SVN failures"</a>
<li><strong>Previous message:</strong> <a href="8237.php">Ricardo Fern&#225;ndez-Perea: "[OMPI users] more XGrid Problems with openmpi1.2.9"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>orte_pls_base_get_active_daemons is been call as
<br>
orte_pls_base_get_active_daemons(&amp;daemons, jobid)
<br>
<p>when the correct way of doing it is
<br>
<p>orte_pls_base_get_active_daemons(&amp;daemons, jobid, attrs)
<br>
<p>yours.
<br>
<p>Ricardo
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-8238/attachment">attachment</a>
</ul>
