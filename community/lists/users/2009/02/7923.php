...
?>
<!-- received="Sun Feb  1 12:07:25 2009" -->
<!-- isoreceived="20090201170725" -->
<!-- sent="Sun, 1 Feb 2009 18:07:15 +0100" -->
<!-- isosent="20090201170715" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE" -->
<!-- id="86B2F7F0-971E-4783-8BA8-4B43750BAE03_at_staff.uni-marburg.de" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="cb60cbc40902010700m539b7f10o1f2e2c0b89c7b187_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-02-01 12:07:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7924.php">Ralph Castain: "Re: [OMPI users] Handling output of processes"</a>
<li><strong>Previous message:</strong> <a href="7922.php">Ted Yu: "Re: [OMPI users] Question about compatibility issues"</a>
<li><strong>In reply to:</strong> <a href="7921.php">Sangamesh B: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7925.php">Sangamesh B: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<li><strong>Reply:</strong> <a href="7925.php">Sangamesh B: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; On Sat, Jan 31, 2009 at 6:27 PM, Reuti &lt;reuti_at_[hidden]&gt;  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Fri, Jan 30, 2009 at 10:20 PM, Reuti &lt;reuti_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I think this might already be the reason why it's not working. A  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; single node (i.e. 8processes on 8 cores of a single node). If number
</span><br>
<span class="quotelev3">&gt;&gt;&gt; of processes is more than 8, then SGE will schedule it on 2 nodes -
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the job will fail with the above error.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Now I did a loose integration of Open MPI 1.3 with SGE. The job  
</span><br>
...
<p>Do you must use ssh? Often in a private cluster the rsh based one is  
<br>
ok, or with SGE 6.2 the built-in mechanism of SGE. Otherwise please  
<br>
follow this:
<br>
<p><a href="http://gridengine.sunsource.net/howto/qrsh_qlogin_ssh.html">http://gridengine.sunsource.net/howto/qrsh_qlogin_ssh.html</a>
<br>
<p><p><span class="quotelev1">&gt; I think its better to check once with Open MPI 1.2.8
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; What is your mpirun command in the jobscript - you are getting  
</span><br>
<span class="quotelev2">&gt;&gt; there the
</span><br>
<span class="quotelev2">&gt;&gt; mpirun from Open MPI? According to the output below, it's not a loose
</span><br>
<span class="quotelev2">&gt;&gt; integration, but you prepare alraedy a machinefile, which is  
</span><br>
<span class="quotelev2">&gt;&gt; superfluous for
</span><br>
...
<span class="quotelev1">&gt; $TMPDIR/machines  $CPMDBIN/cpmd311-ompi-mkl.x  wf1.in $PP_LIBRARY &gt;
</span><br>
<span class="quotelev1">&gt; wf1.out_OMPI_$JOB_ID.$NSLOTS
</span><br>
<p>a) you compiled Open MPI with &quot;--with-sge&quot;?
<br>
<p>b) when the $SGE_ROOT variable is set, Open MPI will use a Tight  
<br>
Integration automatically.
<br>
<p>c) The machine file you presented looks like being for MPICH(1), the  
<br>
...
ibc12 slots=8
<br>
<p>So you would have to adjust the format of the generated file and  
<br>
...
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; I think I should check with Open MPI 1.2.8. That may work..
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; $ cat out.83.Hello-OMPI
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /opt/gridengine/default/spool/node-0-17/active_jobs/83.1/pe_hostfile
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ibc17
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ibc17
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ibc17
...
<span class="quotelev3">&gt;&gt;&gt; Greetings: 1 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 10 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 15 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 9 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 14 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 8 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 11 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 12 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 6 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 0 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 5 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 3 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 13 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 4 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 7 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Greetings: 2 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; But qhost -u &lt;user name&gt; shows that it is scheduled/running on  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; two nodes.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Any body successful in running Open MPI 1.3 tightly integrated  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; with SGE?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; For a Tight Integration there's a FAQ:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; The hostnames for infiniband interfaces are ibc0, ibc1, ibc2 ..  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; ibc23.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; May be Open MPI is not able to identify hosts as it is using  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Mon, Jan 26, 2009 at 5:09 PM, mihlon &lt;vaclam1_at_[hidden]&gt;  
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; (Specific frameworks and version numbers may vary, depending  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; The Open MPI parallel jobs run successfully through command  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; line, but
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; But the same job runs well, if it runs on a single node but  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; with an
</span><br>
