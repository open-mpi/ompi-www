...
?>
<!-- received="Wed Feb 11 21:50:23 2009" -->
<!-- isoreceived="20090212025023" -->
<!-- sent="Thu, 12 Feb 2009 13:49:50 +1100" -->
<!-- isosent="20090212024950" -->
<!-- name="Robertson Burgess" -->
<!-- email="Robertson.Burgess_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI hangs across multiple nodes." -->
<!-- id="499428FD.1AFE.00C7.0_at_newcastle.edu.au" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="49942093.1AFE.00C7.0_at_newcastle.edu.au" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-02-11 21:49:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8028.php">Ralph Castain: "Re: [OMPI users] OpenMPI hangs across multiple nodes."</a>
<li><strong>Previous message:</strong> <a href="8026.php">Robertson Burgess: "Re: [OMPI users] users Digest, Vol 1142, Issue 1"</a>
<li><strong>In reply to:</strong> <a href="8026.php">Robertson Burgess: "Re: [OMPI users] users Digest, Vol 1142, Issue 1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8028.php">Ralph Castain: "Re: [OMPI users] OpenMPI hangs across multiple nodes."</a>
<li><strong>Reply:</strong> <a href="8028.php">Ralph Castain: "Re: [OMPI users] OpenMPI hangs across multiple nodes."</a>
<li><strong>Reply:</strong> <a href="8040.php">George Bosilca: "Re: [OMPI users] OpenMPI hangs across multiple nodes."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Thankyou for that. I have not yet been able to get the IT department to help me with disabling the firewalls, but hopefully that is the problem. Sorry for the late response, I was hoping the IT department would be faster.
<br>
<p>Robertson
<br>
<p>Message: 2
