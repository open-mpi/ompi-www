...
?>
<!-- received="Fri Feb 27 10:22:29 2009" -->
<!-- isoreceived="20090227152229" -->
<!-- sent="Fri, 27 Feb 2009 08:22:17 -0700" -->
<!-- isosent="20090227152217" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] TCP instead of openIB doesn't work" -->
<!-- id="E3C4683C-1F97-4558-AB68-006E39A8334B_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2009-02-27 10:22:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8243.php">Matt Hughes: "Re: [OMPI users] openib RETRY EXCEEDED ERROR"</a>
<li><strong>Previous message:</strong> <a href="8241.php">Vittorio Giovara: "[OMPI users] TCP instead of openIB doesn't work"</a>
<li><strong>In reply to:</strong> <a href="8241.php">Vittorio Giovara: "[OMPI users] TCP instead of openIB doesn't work"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8255.php">Vittorio Giovara: "Re: [OMPI users] TCP instead of openIB doesn't work"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>mpirun  --mca btl tcp,self  -np 2 -host randori,tatami hostname
<br>
<p>I'm not entirely sure what OMPI does when it gets two separate -host  
<br>
arguments - could be equivalent to the above syntax, but could also  
<br>
cause some unusual behavior.
<br>
<p>Could you retry your job with the revised syntax? Also, could you add  
<br>
...
Ralph
<br>
<p><p>On Feb 27, 2009, at 8:00 AM, Vittorio Giovara wrote:
<br>
