...
?>
<!-- received="Sun Feb  1 23:44:16 2009" -->
<!-- isoreceived="20090202044416" -->
<!-- sent="Mon, 2 Feb 2009 10:14:11 +0530" -->
<!-- isosent="20090202044411" -->
<!-- name="Sangamesh B" -->
<!-- email="forum.san_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE" -->
<!-- id="cb60cbc40902012044q76ae8c81g718b57d36f5efdf7_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="86B2F7F0-971E-4783-8BA8-4B43750BAE03_at_staff.uni-marburg.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-02-01 23:44:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7926.php">Reuti: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<li><strong>Previous message:</strong> <a href="7924.php">Ralph Castain: "Re: [OMPI users] Handling output of processes"</a>
<li><strong>In reply to:</strong> <a href="7923.php">Reuti: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7926.php">Reuti: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<li><strong>Reply:</strong> <a href="7926.php">Reuti: "Re: [OMPI users] Fwd: [GE users] Open MPI job fails when run thru SGE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev2">&gt;&gt; On Sat, Jan 31, 2009 at 6:27 PM, Reuti &lt;reuti_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Fri, Jan 30, 2009 at 10:20 PM, Reuti &lt;reuti_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; single node (i.e. 8processes on 8 cores of a single node). If number
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Now I did a loose integration of Open MPI 1.3 with SGE. The job runs,
</span><br>
...
<span class="quotelev1">&gt; Do you must use ssh? Often in a private cluster the rsh based one is ok, or
</span><br>
<span class="quotelev1">&gt; with SGE 6.2 the built-in mechanism of SGE. Otherwise please follow this:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; What is your mpirun command in the jobscript - you are getting there the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpirun from Open MPI? According to the output below, it's not a loose
</span><br>
<span class="quotelev3">&gt;&gt;&gt; integration, but you prepare alraedy a machinefile, which is superfluous
</span><br>
...
<br>
<p><span class="quotelev1">&gt; b) when the $SGE_ROOT variable is set, Open MPI will use a Tight Integration
</span><br>
...
<br>
<p>And run a loose integration job. It failed to run with following error:
<br>
...
ibc17
<br>
<p><p><span class="quotelev1">&gt; c) The machine file you presented looks like being for MPICH(1), the syntax
</span><br>
<span class="quotelev1">&gt; for Open MPI in the machine is different:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; ibc17 slots=8
</span><br>
<span class="quotelev1">&gt; ibc12 slots=8
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
It works.
<br>
<p>So in a loose integration job,
<br>
Open MPI may not be able to find $TMPDIR/machines file
<br>
Or it might be running in a Tight integration style.
<br>
<span class="quotelev1">&gt; So you would have to adjust the format of the generated file and reset
</span><br>
<span class="quotelev1">&gt; SGE_ROOT inside your jobscript, to force Open MPI to do a loose integration
</span><br>
...
<span class="quotelev2">&gt;&gt; I think I should check with Open MPI 1.2.8. That may work..
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; $ cat out.83.Hello-OMPI
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; /opt/gridengine/default/spool/node-0-17/active_jobs/83.1/pe_hostfile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ibc17
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ibc17
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ibc17
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 1 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 10 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 15 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 9 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 14 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 8 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 11 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 12 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 6 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 0 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 5 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 3 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 13 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 4 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 7 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Greetings: 2 of 16 from the node node-0-17.local
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; But qhost -u &lt;user name&gt; shows that it is scheduled/running on two
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; nodes.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Any body successful in running Open MPI 1.3 tightly integrated with SGE?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; For a Tight Integration there's a FAQ:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; A daemon (pid 31947) died unexpectedly with status 129 while
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The Open MPI parallel jobs run successfully through command line,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node-0-4.local:07869] Set MCA parameter &quot;orte_base_help_aggregate&quot;
</span><br>
