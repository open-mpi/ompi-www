<?
$subject_val = "[OMPI users] Open MPI v1.2.9 released";
...
<!-- subject="[OMPI users] Open MPI v1.2.9 released" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Open MPI v1.2.9 released<br>
<strong>From:</strong> Tim Mattox (<em>timattox_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-02-17 11:04:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8077.php">Gabriele Fatigati: "Re: [OMPI users] Ssh problem"</a>
<li><strong>Previous message:</strong> <a href="8075.php">jody: "Re: [OMPI users] Ssh problem"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
