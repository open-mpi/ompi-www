...
?>
<!-- received="Mon Feb  2 16:48:31 2009" -->
<!-- isoreceived="20090202214831" -->
<!-- sent="Mon, 02 Feb 2009 16:48:26 -0500" -->
<!-- isosent="20090202214826" -->
<!-- name="Prentice Bisbal" -->
<!-- email="prentice_at_[hidden]" -->
<!-- subject="Re: [OMPI users] v1.3: mca_common_sm_mmap_init error" -->
<!-- id="49876A2A.3070208_at_ias.edu" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-02-02 16:48:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="7941.php">Prentice Bisbal: "Re: [OMPI users] v1.3: mca_common_sm_mmap_init error"</a>
<li><strong>Previous message:</strong> <a href="7939.php">c.j.kao_at_[hidden]: "[OMPI users] Open MPI error"</a>
<li><strong>In reply to:</strong> <a href="7917.php">Jeff Squyres: "Re: [OMPI users] v1.3: mca_common_sm_mmap_init error"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="7941.php">Prentice Bisbal: "Re: [OMPI users] v1.3: mca_common_sm_mmap_init error"</a>
<li><strong>Reply:</strong> <a href="7941.php">Prentice Bisbal: "Re: [OMPI users] v1.3: mca_common_sm_mmap_init error"</a>
<li><strong>Reply:</strong> <a href="7946.php">Jeff Squyres: "Re: [OMPI users] v1.3: mca_common_sm_mmap_init error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
disappeared.
<br>
<p>Interestingly enough, I just upgraded my cluster to PU_IAS 5.3, and now
<br>
