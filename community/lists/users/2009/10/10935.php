...
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="[OMPI users] [OMPI devel] processor affinity -- OpenMPI / batch system integration" -->
<!-- expires="-1" -->
<div class="center">
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10936.php">Eugene Loh: "Re: [OMPI users] Any way to make &quot;btl_tcp_if_exclude&quot; option system wide?"</a>
<li><strong>Previous message:</strong> <a href="10934.php">Mike Hanby: "[OMPI users] Any way to make &quot;btl_tcp_if_exclude&quot; option system wide?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10937.php">Ralph Castain: "Re: [OMPI users] [OMPI devel] processor affinity -- OpenMPI / batch system integration"</a>
<li><strong>Reply:</strong> <a href="10937.php">Ralph Castain: "Re: [OMPI users] [OMPI devel] processor affinity -- OpenMPI / batch system integration"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
