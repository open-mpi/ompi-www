...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10834.php">Mallikarjuna Shastry: "[OMPI users] error in checkpointing an mpi application"</a>
<li><strong>Previous message:</strong> <a href="10832.php">vighnesh_at_[hidden]: "Re: [OMPI users] Openmpi setup with intel compiler."</a>
