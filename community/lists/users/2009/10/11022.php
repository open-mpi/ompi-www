...
?>
<!-- received="Fri Oct 30 10:09:01 2009" -->
<!-- isoreceived="20091030140901" -->
<!-- sent="Fri, 30 Oct 2009 19:38:25 +0530" -->
<!-- isosent="20091030140825" -->
<!-- name="basant.lakhotiya_at_[hidden]" -->
<!-- email="basant.lakhotiya_at_[hidden]" -->
<!-- subject="[OMPI users] (no subject)" -->
<!-- id="23DA2F26196D9B4DB6F773D07E76756E13C684_at_BLR-EC-MBX05.wipro.com" -->
<!-- charset="iso-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:basant.lakhotiya_at_[hidden]?Subject=Re:%20[OMPI%20users]%20(no%20subject)"><em>basant.lakhotiya_at_[hidden]</em></a><br>
<strong>Date:</strong> 2009-10-30 10:08:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11023.php">basant.lakhotiya_at_[hidden]: "[OMPI users] Runtime error while running mpirun"</a>
<li><strong>Previous message:</strong> <a href="11021.php">Georg A. Reichstein: "Re: [OMPI users] Fortran Library Problem using openMPI"</a>
<!-- nextthread="start" -->
...
<li><strong>Reply:</strong> <a href="11023.php">basant.lakhotiya_at_[hidden]: "[OMPI users] Runtime error while running mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11022/attachment">attachment</a>
</ul>
