...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] error in checkpointing an mpi application<br>
<strong>From:</strong> Constantinos Makassikis (<em>cmakassikis_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-10-01 03:21:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10842.php">vipin kumar: "Re: [OMPI users] how to SPMD on openmpi"</a>
<li><strong>Previous message:</strong> <a href="10840.php">Mallikarjuna Shastry: "[OMPI users] error in checkpointing an mpi application"</a>
<li><strong>In reply to:</strong> <a href="10840.php">Mallikarjuna Shastry: "[OMPI users] error in checkpointing an mpi application"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
