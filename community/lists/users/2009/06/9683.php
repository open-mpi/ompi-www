...
?>
<!-- received="Tue Jun 23 15:32:03 2009" -->
<!-- isoreceived="20090623193203" -->
<!-- sent="Tue, 23 Jun 2009 15:31:56 -0400" -->
<!-- isosent="20090623193156" -->
<!-- name="Jim Kress" -->
...
<!-- id="AC2353FC52454A06860EBA1E345D2588_at_inspiron9100" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="71d2d8cc0906231142n2ec0371cm240cf8db068326b2_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-06-23 15:31:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9684.php">Gus Correa: "Re: [OMPI users] MPI over ethernet non default-adapter - Need	Help/Advice"</a>
<li><strong>Previous message:</strong> <a href="9682.php">Jim Kress: "Re: [OMPI users] 50% performance reduction due to OpenMPI v 1.3.2 forcing all MPI	traffic over Ethernet instead of using Infiniband"</a>
<li><strong>In reply to:</strong> <a href="9681.php">Ralph Castain: "Re: [OMPI users] 50% performance reduction due to OpenMPI v 1.3.2 forcing all MPI traffic over Ethernet instead of using Infiniband"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p>Also,
<br>
<p><span class="quotelev1">&gt; BTW: did you set that mpi_show_mca_params option to ensure 
</span><br>
<span class="quotelev1">&gt; the app is actually seeing these params?
</span><br>
<p>I'm working to get to a point where I can get some time to try that.
<br>
...
<span class="quotelev1">&gt; Sent: Tuesday, June 23, 2009 2:43 PM
</span><br>
...
<span class="quotelev1">&gt; Assuming you aren't oversubscribing your nodes, set 
</span><br>
<span class="quotelev1">&gt; mpi_paffinity_alone=1.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; BTW: did you set that mpi_show_mca_params option to ensure 
</span><br>
<span class="quotelev1">&gt; the app is actually seeing these params?
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; On Tue, Jun 23, 2009 at 12:35 PM, Jim Kress 
</span><br>
<span class="quotelev1">&gt; &lt;jimkress_58_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 	I assume you a referring to the openmpi-mca-params.conf file
</span><br>
<span class="quotelev1">&gt; 	
</span><br>
...
<span class="quotelev1">&gt; 	As the only entry in the openmpi-mca-params.conf file.  
</span><br>
<span class="quotelev1">&gt; This my default
</span><br>
...
<span class="quotelev1">&gt; 	As the only entries in the openmpi-mca-params.conf 
</span><br>
<span class="quotelev1">&gt; file.  No difference in
</span><br>
...
<span class="quotelev1">&gt; 	As the only entries in the openmpi-mca-params.conf file 
</span><br>
<span class="quotelev1">&gt; and also set the
</span><br>
...
<span class="quotelev1">&gt; 	By the way, did you read the message where I retracted 
</span><br>
<span class="quotelev1">&gt; my assumption about
</span><br>
...
<span class="quotelev3">&gt; 	&gt; &gt; was compiled using openMPI 1.2.8 and run under 
</span><br>
<span class="quotelev1">&gt; 1.2.8 with the
</span><br>
...
<span class="quotelev3">&gt; 	&gt; &gt; the app ran fine with no traffic over my Ethernet 
</span><br>
<span class="quotelev1">&gt; network and all
</span><br>
...
<span class="quotelev3">&gt; 	&gt; &gt; under 1.3.2 (using the same openmpi-mca-params.conf 
</span><br>
...
<span class="quotelev3">&gt; 	&gt; &gt; a 50% reduction in performance is just not 
</span><br>
<span class="quotelev1">&gt; acceptable.  Ideas/
</span><br>
