...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9477.php">Jeff Squyres: "Re: [OMPI users] make vt_tracefilter.cc:133: internal compilererror: Segmentation fault - openmpi-1.3.2"</a>
<li><strong>Previous message:</strong> <a href="9475.php">Gus Correa: "Re: [OMPI users] sync problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9508.php">tsilva_at_[hidden]: "Re: [OMPI users] top question"</a>
<li><strong>Reply:</strong> <a href="9508.php">tsilva_at_[hidden]: "Re: [OMPI users] top question"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
