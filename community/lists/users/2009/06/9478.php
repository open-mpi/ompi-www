...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9479.php">Jeff Squyres: "Re: [OMPI users] Problem getting OpenMPI to run"</a>
<li><strong>Previous message:</strong> <a href="9477.php">Jeff Squyres: "Re: [OMPI users] make vt_tracefilter.cc:133: internal compilererror: Segmentation fault - openmpi-1.3.2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9479.php">Jeff Squyres: "Re: [OMPI users] Problem getting OpenMPI to run"</a>
<li><strong>Reply:</strong> <a href="9479.php">Jeff Squyres: "Re: [OMPI users] Problem getting OpenMPI to run"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
