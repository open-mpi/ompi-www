...
?>
<!-- received="Thu Jun 11 14:18:54 2009" -->
<!-- isoreceived="20090611181854" -->
<!-- sent="Thu, 11 Jun 2009 20:20:15 +0200" -->
<!-- isosent="20090611182015" -->
...
<!-- id="4A314ADF.9040108_at_labri.fr" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-06-11 14:20:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9606.php">Brian Barrett: "Re: [OMPI users] Problem with OpenMPI (MX btl and mtl) and threads"</a>
<li><strong>Previous message:</strong> <a href="9604.php">Scott Atchley: "Re: [OMPI users] Problem with OpenMPI (MX btl and mtl) and threads"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9606.php">Brian Barrett: "Re: [OMPI users] Problem with OpenMPI (MX btl and mtl) and threads"</a>
<li><strong>Reply:</strong> <a href="9606.php">Brian Barrett: "Re: [OMPI users] Problem with OpenMPI (MX btl and mtl) and threads"</a>
<li><strong>Reply:</strong> <a href="9608.php">Scott Atchley: "Re: [OMPI users] Problem with OpenMPI (MX btl and mtl) and threads"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; Brian and George,
</span><br>
...
<span class="quotelev1">&gt; multiple threads trying to complete the same request. It does show an 
</span><br>
<span class="quotelev1">&gt; assert failed.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; safety.  There's not much code to cause problems in the CM PML.  The 
</span><br>
<span class="quotelev2">&gt;&gt; MX MTL would likely need some work to ensure the restrictions Scott 
</span><br>
<span class="quotelev2">&gt;&gt; mentioned are met (currently, there's no such guarantee in the MX MTL).
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; others BTL, it is their developers responsibility to do the required 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; modifications to make them thread safe.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; In addition, I have to confess that I never tested the MTL for 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; thread safety. It is a completely different implementations for the 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; message passing, supposed to map directly on top of the underlying 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; network capabilities. However, there are clearly few places where 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; thread safety should be enforced in the MTL layer, and I don't know 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; if this is the case.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; It mentions that thread support is designed in, but lightly tested. 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; It is also possible that the FAQ is out of date and 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; mx_test(), mx_wait(), mx_test_any() and/or mx_wait_any() where the 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; latter two have match bits and match mask that could complete a 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; request being tested/waited by another thread.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Well, according to George Bosilca 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; (<a href="http://www.open-mpi.org/community/lists/users/2005/02/0005.php">http://www.open-mpi.org/community/lists/users/2005/02/0005.php</a>), 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; ((mca_pml_cm_thin_recv_request_t*)base_request)-&gt;req_base.req_pml_complete' 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /home/ftrahay/sources/openmpi/trunk/install//lib/libopen-pal.so.0(opal_free+0x4e) 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /home/ftrahay/sources/openmpi/trunk/install/lib/openmpi/mca_mtl_mx.so 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /home/ftrahay/sources/openmpi/trunk/install//lib/libopen-pal.so.0(opal_progress+0xbc) 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /home/ftrahay/sources/openmpi/trunk/install/lib/openmpi/mca_pml_cm.so 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /home/ftrahay/sources/openmpi/trunk/install//lib/libmpi.so.0(MPI_Recv+0x2bc) 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<br><hr>
<ul>
<li>text/x-log attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9605/backtrace_btl.log">backtrace_btl.log</a>
</ul>
<!-- attachment="backtrace_btl.log" -->
<hr>
<ul>
<li>text/x-log attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9605/backtrace_mtl.log">backtrace_mtl.log</a>
</ul>
<!-- attachment="backtrace_mtl.log" -->
<hr>
<ul>
<li>text/x-csrc attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9605/concurrent_ping.c">concurrent_ping.c</a>
</ul>
