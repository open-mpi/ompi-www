...
?>
<!-- received="Mon Jun  8 17:04:28 2009" -->
<!-- isoreceived="20090608210428" -->
<!-- sent="Mon, 8 Jun 2009 17:04:15 -0400" -->
<!-- isosent="20090608210415" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Valgrind writev() errors with 1.3.2." -->
<!-- id="863C02EF-6BB3-4B26-90B2-075647B48183_at_eecs.utk.edu" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="71d2d8cc0906081224i7ef119e3ga1b3174e3b116bba_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-06-08 17:04:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9568.php">Lars Andersson: "Re: [OMPI users] &quot;Re: Best way to overlap computation and transfer using MPI over TCP/Ethernet?&quot;"</a>
<li><strong>Previous message:</strong> <a href="9566.php">Ralph Castain: "Re: [OMPI users] Valgrind writev() errors with 1.3.2."</a>
<li><strong>In reply to:</strong> <a href="9566.php">Ralph Castain: "Re: [OMPI users] Valgrind writev() errors with 1.3.2."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9571.php">tom fogal: "Re: [OMPI users] Valgrind writev() errors with 1.3.2."</a>
<li><strong>Reply:</strong> <a href="9571.php">tom fogal: "Re: [OMPI users] Valgrind writev() errors with 1.3.2."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
read <a href="http://valgrind.org/docs/manual/manual-core.html#manual-core.suppress">http://valgrind.org/docs/manual/manual-core.html#manual-core.suppress</a> 
<br>
&nbsp;&nbsp;for more information.
<br>
<p>&nbsp;&nbsp;&nbsp;george.
<br>
<p>On Jun 8, 2009, at 15:24 , Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; We deliberately choose to not initialize our msg buffers as this  
</span><br>
<span class="quotelev1">&gt; takes considerable time. Instead, we fill in only the portion  
</span><br>
<span class="quotelev1">&gt; required by a given message, and then send only that much of the  
</span><br>
<span class="quotelev1">&gt; buffer. Thus, the uninitialized portion is ignored.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I don't know of a way to tell valgrind to ignore it, I'm afraid -  
</span><br>
<span class="quotelev1">&gt; perhaps a valgrind guru can be of help. :-/
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Mon, Jun 8, 2009 at 1:09 PM, tom fogal &lt;tfogal_at_[hidden]&gt;  
</span><br>
...
<span class="quotelev1">&gt; [1], and I'm seeing a lot of errors with writev() when I run this  
</span><br>
...
<span class="quotelev1">&gt;  ==12342==    by 0x767D19A: orte_rml_oob_send_buffer (rml_oob_send.c: 
</span><br>
...
<span class="quotelev1">&gt; ==12342== Copyright (C) 2002-2008, and GNU GPL'd, by Julian Seward  
</span><br>
<span class="quotelev1">&gt; et al.
</span><br>
<span class="quotelev1">&gt; ==12342== Using LibVEX rev 1884, a library for dynamic binary  
</span><br>
<span class="quotelev1">&gt; translation.
</span><br>
<span class="quotelev1">&gt; ==12342== Copyright (C) 2004-2008, and GNU GPL'd, by OpenWorks LLP.
</span><br>
<span class="quotelev1">&gt; ==12342== Using valgrind-3.4.1, a dynamic binary instrumentation  
</span><br>
<span class="quotelev1">&gt; framework.
</span><br>
<span class="quotelev1">&gt; ==12342== Copyright (C) 2000-2008, and GNU GPL'd, by Julian Seward  
</span><br>
<span class="quotelev1">&gt; et al.
</span><br>
...
<span class="quotelev1">&gt; ==12342==    by 0x53DE4BA: opal_dss_copy_payload (dss_load_unload.c: 
</span><br>
...
<span class="quotelev1">&gt; ==12342== ERROR SUMMARY: 1 errors from 1 contexts (suppressed: 307  
</span><br>
<span class="quotelev1">&gt; from 3)
</span><br>
