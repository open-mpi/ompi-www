...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9481.php">tsilva_at_[hidden]: "[OMPI users] overlapping communicators?"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2009/05/9479.php">Danesh Daroui: "[OMPI users] sync problem"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2009/05/9479.php">Danesh Daroui: "[OMPI users] sync problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9499.php">Danesh Daroui: "Re: [OMPI users] sync problem"</a>
<li><strong>Reply:</strong> <a href="9499.php">Danesh Daroui: "Re: [OMPI users] sync problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
