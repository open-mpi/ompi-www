<?
$subject_val = "Re: [OMPI users] Mac OSX 10.6 (SL) + openMPI 1.3.3 + Intel Compilers11.1.076";
include("../../include/msg-header.inc");
?>
<!-- received="Thu Nov  5 08:26:58 2009" -->
<!-- isoreceived="20091105132658" -->
<!-- sent="Thu, 5 Nov 2009 08:26:48 -0500" -->
<!-- isosent="20091105132648" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Mac OSX 10.6 (SL) + openMPI 1.3.3 + Intel Compilers11.1.076" -->
<!-- id="B2684534-F8D8-4A4A-B579-A6CF70D2938C_at_cisco.com" -->
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] Mac OSX 10.6 (SL) + openMPI 1.3.3 + Intel Compilers11.1.076<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-11-05 08:26:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11064.php">Christophe Peyret: "Re: [OMPI users] Mac OSX 10.6 (SL) + openMPI 1.3.3 + Intel Compilers 11.1.076"</a>
<li><strong>Previous message:</strong> <a href="11062.php">Christophe Peyret: "[OMPI users] Mac OSX 10.6 (SL) + openMPI 1.3.3 + Intel Compilers 11.1.076"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11064.php">Christophe Peyret: "Re: [OMPI users] Mac OSX 10.6 (SL) + openMPI 1.3.3 + Intel Compilers 11.1.076"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Note that Open MPI itself works fine on Snow Leopard -- it's just the  
<br>
xgrid launching support that is broken.
<br>
<p><p>On Nov 5, 2009, at 7:18 AM, Christophe Peyret wrote:
<br>
