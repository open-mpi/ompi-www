...
?>
<!-- received="Mon Nov  2 08:37:51 2009" -->
<!-- isoreceived="20091102133751" -->
<!-- sent="Mon, 2 Nov 2009 19:07:44 +0530" -->
<!-- isosent="20091102133744" -->
...
<!-- id="23DA2F26196D9B4DB6F773D07E76756E13C688_at_BLR-EC-MBX05.wipro.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2009-11-02 08:37:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11048.php">George Markomanolis: "[OMPI users] using specific algorithm for collective communication, and knowing the root cpu?"</a>
<li><strong>Previous message:</strong> <a href="11046.php">Andreea m. \(Costea\): "Re: [OMPI users] Checkpoint/Restart in OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="11043.php">Shiqing Fan: "Re: [OMPI users] Runtime error while running mpirun"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11049.php">Shiqing Fan: "Re: [OMPI users] Runtime error while running mpirun"</a>
<li><strong>Reply:</strong> <a href="11049.php">Shiqing Fan: "Re: [OMPI users] Runtime error while running mpirun"</a>
<li><strong>Reply:</strong> <a href="11050.php">Shiqing Fan: "Re: [OMPI users] Runtime error while running mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
&nbsp;
<br>
Sorry for misunderstanding. I checked its not creating mca_paffinity_windows.dll and mca_paffinity_windowsd.dll instead that files are libmca_paffinity_windows.dll and libmca_paffinity_windowsd.dll. Only .lib files are there for mca_paffinity_windows and mca_paffinity_windowsd.
<br>
&nbsp;
<br>
&nbsp;
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11047/attachment">attachment</a>
</ul>
