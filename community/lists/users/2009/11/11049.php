...
?>
<!-- received="Mon Nov  2 09:03:48 2009" -->
<!-- isoreceived="20091102140348" -->
<!-- sent="Mon, 02 Nov 2009 15:03:39 +0100" -->
<!-- isosent="20091102140339" -->
<!-- name="Shiqing Fan" -->
<!-- email="fan_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Runtime error while running mpirun" -->
<!-- id="4AEEE6BB.40402_at_hlrs.de" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-11-02 09:03:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11050.php">Shiqing Fan: "Re: [OMPI users] Runtime error while running mpirun"</a>
<li><strong>Previous message:</strong> <a href="11048.php">George Markomanolis: "[OMPI users] using specific algorithm for collective communication, and knowing the root cpu?"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11050.php">Shiqing Fan: "Re: [OMPI users] Runtime error while running mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Basant,
<br>
<p><p>It sounds very strange to me, because all the mca libraries on Windows 
<br>
doesn't have the &quot;lib&quot; prefix, they should all have the name like 
<br>
mca_xxxx_xxx.dll, so I'm wondering how the libmca_pafinity_windows stuff 
<br>
comes, might be a bug too.
<br>
<p>Could you provide more information about your build process, and cmake 
<br>
configure options? Is there any other mca libraries that has the &quot;lib&quot; 
<br>
prefix?
<br>
<p><p>Regards,
