...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11039.php">basant.lakhotiya_at_[hidden]: "Re: [OMPI users] Runtime error while running mpirun"</a>
<li><strong>Previous message:</strong> <a href="11037.php">Andreea m. \(Costea\): "Re: [OMPI users] Checkpoint/Restart in OpenMPI for Sergio"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11039.php">basant.lakhotiya_at_[hidden]: "Re: [OMPI users] Runtime error while running mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11038/attachment">attachment</a>
</ul>
