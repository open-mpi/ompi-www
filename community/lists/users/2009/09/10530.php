...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10531.php">Eugene Loh: "Re: [OMPI users] Job distribution on many-core NUMA system"</a>
<li><strong>Previous message:</strong> <a href="10529.php">Greg Fischer: "[OMPI users] OMPI error in MPI_Cart_create (in code that works with MPICH2)"</a>
<li><strong>In reply to:</strong> <a href="../../2009/08/10515.php">Marcus Daniels: "[OMPI users] problems with one sided MPI"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
