...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10535.php">Greg Fischer: "[OMPI users] OMPI error in MPI_Cart_create (in code that works with MPICH2)"</a>
<li><strong>Previous message:</strong> <a href="10533.php">Lenny Verkhovsky: "Re: [OMPI users] rankfile error on openmpi/1.3.3"</a>
<li><strong>In reply to:</strong> <a href="10533.php">Lenny Verkhovsky: "Re: [OMPI users] rankfile error on openmpi/1.3.3"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-10534/attachment">attachment</a>
</ul>
