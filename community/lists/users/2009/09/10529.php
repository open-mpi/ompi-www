...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10530.php">Dorian Krause: "Re: [OMPI users] problems with one sided MPI"</a>
<li><strong>Previous message:</strong> <a href="10528.php">Lenny Verkhovsky: "Re: [OMPI users] rankfile error on openmpi/1.3.3"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10540.php">Jeff Squyres: "Re: [OMPI users] OMPI error in MPI_Cart_create (in code that works withMPICH2)"</a>
<li><strong>Reply:</strong> <a href="10540.php">Jeff Squyres: "Re: [OMPI users] OMPI error in MPI_Cart_create (in code that works withMPICH2)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-10529/attachment">attachment</a>
</ul>
