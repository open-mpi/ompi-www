...
?>
<!-- received="Tue Sep 22 21:20:22 2009" -->
<!-- isoreceived="20090923012022" -->
<!-- sent="Tue, 22 Sep 2009 21:20:14 -0400" -->
<!-- isosent="20090923012014" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [OMPI devel] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless" -->
<!-- id="6770C232-BAFC-4EF7-9AA9-43B0BB150471_at_cisco.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="53369.198.133.185.25.1253654825.squirrel_at_mercury.nsi.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-09-22 21:20:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10734.php">Jonathan Dursi: "Re: [OMPI users] Random hangs using btl sm with OpenMPI 1.3.2/1.3.3 + gcc4.4?"</a>
<li><strong>Previous message:</strong> <a href="10732.php">Jeff Squyres: "Re: [OMPI users] Random hangs using btl sm with OpenMPI 1.3.2/1.3.3 + gcc4.4?"</a>
<li><strong>In reply to:</strong> <a href="10728.php">Pallab Datta: "Re: [OMPI users] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10747.php">Jeff Squyres: "Re: [OMPI users] [OMPI devel] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless"</a>
<li><strong>Maybe reply:</strong> <a href="10747.php">Jeff Squyres: "Re: [OMPI users] [OMPI devel] Open-MPI between Mac and Linux (ubuntu 9.04) over wireless"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Some suggestions:
<br>
<p>- MPI seems to startup but the additional TCP connections required for  
<br>
...
local machine
<br>
<p><p>On Sep 22, 2009, at 5:27 PM, Pallab Datta wrote:
<br>
<p><span class="quotelev1">&gt; The following are the ifconfig for both the Mac and the Linux  
</span><br>
...
<span class="quotelev1">&gt; The mac is a Two 2.26GHz Quad-Core Intel Xeon Mac Pro and the Linux  
</span><br>
...
<span class="quotelev1">&gt; Please help me any way I can fix this issue. It really needs to work  
</span><br>
...
<span class="quotelev2">&gt;&gt; My other concern was the following but I am not sure it applies here.
</span><br>
<span class="quotelev2">&gt;&gt; If you have multiple interfaces on the node, and they are on the same
</span><br>
<span class="quotelev2">&gt;&gt; subnet, then you cannot actually select what IP address to go out of.
</span><br>
<span class="quotelev2">&gt;&gt; You can only select the IP address you want to connect to. In these
</span><br>
...
<span class="quotelev2">&gt;&gt; Perhaps you can send the User's list the output from &quot;ifconfig&quot; on  
</span><br>
...
<span class="quotelev2">&gt;&gt; right arguments for ifconfig depending on the OS you are running on.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The -enable-heterogeneous should do the trick.  And to answer the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; previous question, yes, put both of the interfaces in the include  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Do i need to configure openmpi with some specific options apart  
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; time out, yes?  I guess I have two suggestions. First, can you  
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; may want to specify the specific interfaces you want it to use  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; on the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; two machines.  You can do that via the &quot;--mca btl_tcp_if_include&quot;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 36900 -mca btl_tcp_port_range_v4 32 --mca btl_base_verbose 30  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; --mca
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; btl
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; tcp,self --mca OMPI_mca_mpi_preconnect_all 1 -np 2 -hetero -H
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; localhost,10.11.14.205 /tmp/hello
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [fuji.local:01316] mca: base: components_open: Looking for btl
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [fuji.local:01316] mca: base: components_open: component self  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [apex-backpack:04753] mca: base: components_open: Looking for  
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; btl
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; components
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [apex-backpack:04753] mca: base: components_open: opening btl
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; components
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [apex-backpack:04753] mca: base: components_open: found loaded
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; component
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; self
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [apex-backpack:04753] mca: base: components_open: component self
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; open
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; function successful
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [apex-backpack:04753] select: initializing btl component self
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [apex-backpack:04753] select: init of component self returned
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; success
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am trying to run open-mpi 1.3.3. between a linux box running
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ubuntu
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; server v.9.04 and a Macintosh. I have configured openmpi with  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; it hangs on a send receive function between the two ends. All  
</span><br>
