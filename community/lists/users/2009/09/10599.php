<?
$subject_val = "[OMPI users] Messages getting lost during transmission (?)";
include("../../include/msg-header.inc");
?>
<!-- received="Wed Sep  9 11:47:24 2009" -->
<!-- isoreceived="20090909154724" -->
<!-- sent="Wed, 09 Sep 2009 17:47:12 +0200" -->
<!-- isosent="20090909154712" -->
<!-- name="Dennis Luxen" -->
<!-- email="luxen_at_[hidden]" -->
<!-- subject="[OMPI users] Messages getting lost during transmission (?)" -->
<!-- id="4AA7CE00.30706_at_kit.edu" -->
<!-- charset="ISO-8859-15" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Messages getting lost during transmission (?)<br>
<strong>From:</strong> Dennis Luxen (<em>luxen_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-09-09 11:47:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10600.php">Richard Treumann: "Re: [OMPI users] Messages getting lost during transmission (?)"</a>
<li><strong>Previous message:</strong> <a href="10598.php">George Bosilca: "Re: [OMPI users] [OMPI devel] Error message improvement"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10600.php">Richard Treumann: "Re: [OMPI users] Messages getting lost during transmission (?)"</a>
<li><strong>Reply:</strong> <a href="10600.php">Richard Treumann: "Re: [OMPI users] Messages getting lost during transmission (?)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi all,
<br>
<p>I have a very strange behaviour in a program. It seems that messages 
<br>
that are sent from one processor to another are getting lost.
<br>
<p>The problem is isolated in the attached source code. The code works as 
<br>
...
<br>
<p>I already debugged the application and found that at one point during 
<br>
...
<br>
<p>The program is started with two processes on a single machine and no 
<br>
...
D-76131 Karlsruhe, Germany           | Email: luxen_at_[hidden]
--------------------------------------------------------------------


</pre>
<p>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Package: Open MPI abuild_at_build26 Distribution
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Open MPI: 1.3.2
<br>
...
<p><hr>
<ul>
<li>text/x-c++src attachment: <a href="http://www.open-mpi.org/community/lists/users/att-10599/mpi_test2.cpp">mpi_test2.cpp</a>
</ul>
<!-- attachment="mpi_test2.cpp" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
