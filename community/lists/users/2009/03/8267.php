...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8268.php">Jeff Squyres: "Re: [OMPI users] defining different values for same environment variable"</a>
<li><strong>Previous message:</strong> <a href="8266.php">Nicolas Deladerriere: "Re: [OMPI users] defining different values for same environment variable"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8268.php">Jeff Squyres: "Re: [OMPI users] defining different values for same environment variable"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
