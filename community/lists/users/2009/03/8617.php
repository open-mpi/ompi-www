<?
$subject_val = "[OMPI users] Critical bug notice";
...
<!-- subject="[OMPI users] Critical bug notice" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Critical bug notice<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-03-27 14:34:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8618.php">흆e Sandgren: "Re: [OMPI users] [Open MPI Announce] Critical bug notice"</a>
<li><strong>Previous message:</strong> <a href="8616.php">Ralph Castain: "Re: [OMPI users] [Fwd: Re: Configure OpenMPI and SLURMon	Debian	(Lenny)]"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8618.php">흆e Sandgren: "Re: [OMPI users] [Open MPI Announce] Critical bug notice"</a>
<li><strong>Reply:</strong> <a href="8618.php">흆e Sandgren: "Re: [OMPI users] [Open MPI Announce] Critical bug notice"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
