...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8264.php">Jeff Squyres: "Re: [OMPI users] OpenMPI 1.3.1 rpm build error"</a>
<li><strong>Previous message:</strong> <a href="8262.php">jody: "Re: [OMPI users] defining different values for same environment variable"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8265.php">Josh Hursey: "Re: [OMPI users] defining different values for same environment variable"</a>
<li><strong>Reply:</strong> <a href="8265.php">Josh Hursey: "Re: [OMPI users] defining different values for same environment variable"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
