<?
$subject_val = "[OMPI users] New Open MPI release numbering scheme";
...
<!-- subject="[OMPI users] New Open MPI release numbering scheme" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] New Open MPI release numbering scheme<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-03-20 07:09:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8527.php">Marcelo Souza: "[OMPI users] OpenMPI 1.3.1 x86_64 (amd64) Package for Debian 5.0 (Lenny)"</a>
<li><strong>Previous message:</strong> <a href="8525.php">Cristian KLEIN: "Re: [OMPI users] mpirun exit status"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
