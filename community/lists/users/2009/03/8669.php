...
?>
<!-- received="Mon Mar 30 23:40:19 2009" -->
<!-- isoreceived="20090331034019" -->
<!-- sent="Tue, 31 Mar 2009 11:40:05 +0800" -->
<!-- isosent="20090331034005" -->
<!-- name="Jerome BENOIT" -->
<!-- email="ml.jgmbenoit_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI 1.3.1 svn Debian trouble" -->
<!-- id="49D19095.6030505_at_mailsnare.net" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-03-30 23:40:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8670.php">Alessandro Surace: "Re: [OMPI users] [OMPI devel] mpirun: symbol lookup error:/usr/local/lib/openmpi/mca_plm_lsf.so: undefined symbol: ls b_init"</a>
<li><strong>Previous message:</strong> <a href="8668.php">Jeff Squyres: "Re: [OMPI users] Cannot build OpenMPI 1.3 with PGI pgf90 and Gnu gcc/g++."</a>
<li><strong>In reply to:</strong> <a href="8662.php">Jeff Squyres: "Re: [OMPI users] OpenMPI 1.3.1 svn Debian trouble"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2009/04/8743.php">Jerome BENOIT: "[OMPI users] openmpi 1.3.1: bind() failed: Permission denied (13)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello List !
<br>
<p>The test was a preliminary test:
<br>
1] the configuration files are the untouched ones as installed by default by Debian.
<br>
2] the firewall was stopped for the test.
<br>
<p>Otherwise, the test job is launched with sbatch:
<br>
<p>sbatch phello.sh
<br>
<p>This preliminary test was working with the Lenny version.
<br>
(Currently, it is working if the number of node is one, and the number of task is less than 4,
<br>
each node being a quadcore).
<br>
<p>After sending my email, I found this archive which may contain the solution
<br>
<p>www.open-mpi.org/community/lists/users/2009/03/8480.php
<br>
<p>But I have never played with selinux so I do not what to do right now,
<br>
and a quick googling did not give me the answer. Anyhow, as the test is
<br>
rather aordinary, I guess that something must be setup by Debian
<br>
