...
?>
<!-- received="Tue Mar 24 11:41:00 2009" -->
<!-- isoreceived="20090324154100" -->
<!-- sent="Tue, 24 Mar 2009 23:40:52 +0800" -->
<!-- isosent="20090324154052" -->
<!-- name="Jerome BENOIT" -->
<!-- email="ml.jgmbenoit_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Configure OpenMPI and SLURM on Debian (Lenny)" -->
<!-- id="49C8FF04.6080908_at_mailsnare.net" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-03-24 11:40:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8566.php">Jerome BENOIT: "Re: [OMPI users] Configure OpenMPI and SLURM on Debian (Lenny)"</a>
<li><strong>Previous message:</strong> <a href="8564.php">Eugene Loh: "Re: [OMPI users] Collective operations and synchronization"</a>
<li><strong>In reply to:</strong> <a href="8562.php">Manuel Prinz: "Re: [OMPI users] Configure OpenMPI and SLURM on Debian (Lenny)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8576.php">Jeff Squyres: "Re: [OMPI users] Configure OpenMPI and SLURM on Debian (Lenny)"</a>
<li><strong>Reply:</strong> <a href="8576.php">Jeff Squyres: "Re: [OMPI users] Configure OpenMPI and SLURM on Debian (Lenny)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Manuel !
<br>
<p>I read what you said on the web before I sent my email.
<br>
But it does not work with my sample. It is an old LAM source C.
<br>
<p>Anyway, thanks a lot for your reply.
<br>
Jerome
<br>
