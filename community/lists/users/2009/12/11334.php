...
?>
<!-- received="Tue Dec  1 18:31:24 2009" -->
<!-- isoreceived="20091201233124" -->
<!-- sent="Tue, 1 Dec 2009 16:31:16 -0700" -->
<!-- isosent="20091201233116" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun is using one PBS node only" -->
<!-- id="D20568CF-C1A9-40D4-8529-ECD8612AE117_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2009-12-01 18:31:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11335.php">Gus Correa: "Re: [OMPI users] mpirun is using one PBS node only"</a>
<li><strong>Previous message:</strong> <a href="11333.php">Abhishek Kulkarni: "Re: [OMPI users] MPI_Comm_spawn lots of times"</a>
<li><strong>In reply to:</strong> <a href="11327.php">Belaid MOA: "Re: [OMPI users] mpirun is using one PBS node only"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11337.php">Belaid MOA: "Re: [OMPI users] mpirun is using one PBS node only"</a>
<li><strong>Reply:</strong> <a href="11337.php">Belaid MOA: "Re: [OMPI users] mpirun is using one PBS node only"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I'm having a little trouble following this email thread, so forgive any misunderstanding.
<br>
<p>If I understand this correctly, you are able to correctly run if you provide a -hostfile option. The issue is that mpirun does not appear to be picking up the PBS_NODEFILE automatically and using it - correct?
<br>
<p>If that is true, then the problem is most likely that mpirun isn't finding the file. There should be an environmental variable $PBS_NODEFILE that contains the full path to the file. Also, that file (and the entire path to it) must be readable by the user.
<br>
<p>Can you check that this is the case?
<br>
<p>Thanks
<br>
Ralph
<br>
<p>On Dec 1, 2009, at 4:08 PM, Belaid MOA wrote:
<br>
<p><span class="quotelev1">&gt; I tried -bynode option but it did not change anything. I also tried the &quot;hostname&quot; name command and 
</span><br>
<span class="quotelev1">&gt; I keep getting only the name of one node repeated according to the -n value. 
</span><br>
...
<span class="quotelev1">&gt; -- On the head node (HN), I installed openMPI using the --with-tm option as follows:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; -- On the worker nodes (WN1 and WN2), I installed openMPI without tm option as follows (it is a local installation on each worker node):
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; The -n X option (no matter what the value of X is) shows X processes 
</span><br>
...
<span class="quotelev2">&gt; &gt; Yes, if you compiled OpenMPI you are using with Torque (&quot;tm) support.
</span><br>
...
<span class="quotelev2">&gt; &gt; True assuming the first condition above (OpenMPI *with* &quot;tm&quot; suport).
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; in the FAQ section of www.open-mpi.org with a simple hello world 
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; When the job is submitted, only one process is ran. When I add the 
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; Check &quot;man mpiexec&quot; for the options that control on which nodes and
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11334/attachment">attachment</a>
</ul>
