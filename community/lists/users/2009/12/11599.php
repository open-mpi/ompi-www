...
?>
<!-- received="Fri Dec 18 12:06:46 2009" -->
<!-- isoreceived="20091218170646" -->
<!-- sent="Fri, 18 Dec 2009 10:01:10 -0700" -->
<!-- isosent="20091218170110" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How to detect a failure to start-up and MPI_Init()?" -->
<!-- id="9C165CF3-2206-4CBD-84B1-AF38C332ACC3_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="89F8C511E9BE1F41AE2F1BB0424037F201D6A1E99A_at_hasmsx504.ger.corp.intel.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-12-18 12:01:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11600.php">Nicolas Bock: "Re: [OMPI users] MPI_Comm_spawn lots of times"</a>
<li><strong>Previous message:</strong> <a href="11598.php">Katz, Jacob: "Re: [OMPI users] How to detect a failure to start-up and MPI_Init()?"</a>
<li><strong>In reply to:</strong> <a href="11598.php">Katz, Jacob: "Re: [OMPI users] How to detect a failure to start-up and MPI_Init()?"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>mpirun has exited due to process rank 0 with PID 72438 on
<br>
...
<br>
<p><p>On Dec 18, 2009, at 8:32 AM, Katz, Jacob wrote:
<br>
<p><span class="quotelev1">&gt; Thanks for the fix. What will be the exact behavior after your fix?
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; Re timeouts: Timeout may be indefinite for compliance with the standard. However, apps might optionally use it for their convenience, like in my case. No need to guess anything, but would prevent stuck apps.
</span><br>
<span class="quotelev1">&gt; Unlike regular communication, where one may implement timeout mechanism at application level using non-blocking communication, there is no way to implement an app-level time-out for bootstrapping process since MPI_Init blocks.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt;  
...
<span class="quotelev1">&gt; Sent: Friday, December 18, 2009 16:50
</span><br>
...
<span class="quotelev1">&gt; Unfortunately, the timeout won't work as there is no MPI requirement to call MPI_Init before some specific point in the application. This would create an experimental process to &quot;guess&quot; the correct timeout on an application-by-application basis - ugly.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; I have committed code to the OMPI trunk that fixes this problem for the general case. Managed to do it without the extra communication, though it required a little more complexity in the launch logic.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; Anyway, the problem appears resolved on that code branch. Given the required change, I do not expect this to appear in the 1.4 series - work is progressing on the first release of the next feature series (1.5), and it will be in there. Meantime, you are welcome to use a nightly tarball from the devel trunk as it appears to be in pretty good shape right now in prep for the 1.5 branch.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; On Dec 18, 2009, at 7:06 AM, Katz, Jacob wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Yes, the scenario is as you described: one of the processes didn&#146;t call MPI_Init and exited &#147;normally&#148;. All the rest of the processes got stuck forever in MPI_Init.
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11599/attachment">attachment</a>
</ul>
