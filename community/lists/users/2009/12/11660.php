...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11661.php">Daniel Spångberg: "Re: [OMPI users] openmpi 1.4 broken -mca coll_tuned_use_dynamic_rules 1"</a>
<li><strong>Previous message:</strong> <a href="11659.php">Daniel Sp&#229;ngberg: "[OMPI users] openmpi 1.4 broken -mca coll_tuned_use_dynamic_rules 1"</a>
<li><strong>In reply to:</strong> <a href="11659.php">Daniel Sp&#229;ngberg: "[OMPI users] openmpi 1.4 broken -mca coll_tuned_use_dynamic_rules 1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11661.php">Daniel Spångberg: "Re: [OMPI users] openmpi 1.4 broken -mca coll_tuned_use_dynamic_rules 1"</a>
<li><strong>Reply:</strong> <a href="11661.php">Daniel Spångberg: "Re: [OMPI users] openmpi 1.4 broken -mca coll_tuned_use_dynamic_rules 1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11660/attachment">attachment</a>
</ul>
