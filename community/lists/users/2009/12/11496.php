...
?>
<!-- received="Wed Dec  9 20:03:45 2009" -->
<!-- isoreceived="20091210010345" -->
<!-- sent="Wed, 09 Dec 2009 20:03:35 -0500" -->
<!-- isosent="20091210010335" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun only works when -np &amp;lt;4 (Gus Correa)" -->
<!-- id="4B2048E7.3040700_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="76aeda4a0912091543h4b4aa5ceobb44aa58472a8647_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-12-09 20:03:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11497.php">Ashley Pittman: "Re: [OMPI users] Mimicking timeout for MPI_Wait"</a>
<li><strong>Previous message:</strong> <a href="11495.php">Matthew MacManes: "[OMPI users] OMPI 1.4: connectivity_c fails, ring_c and hello_c work"</a>
<li><strong>In reply to:</strong> <a href="11494.php">Matthew MacManes: "Re: [OMPI users] mpirun only works when -np &lt;4 (Gus Correa)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11499.php">Mark Bolstad: "Re: [OMPI users] mpirun only works when -np &lt;4 (Gus Correa)"</a>
<li><strong>Reply:</strong> <a href="11499.php">Mark Bolstad: "Re: [OMPI users] mpirun only works when -np &lt;4 (Gus Correa)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Matthew
<br>
<p>Save any misinterpretation I may have made of the code:
<br>
<p>Hello_c has no real communication, except for a final Barrier
<br>
synchronization.
<br>
Each process prints &quot;hello world&quot; and that's it.
<br>
<p>Ring probes a little more, with processes Send(ing) and
<br>
...
<br>
<p>In connectivity every pair of processes exchange a message.
<br>
Therefore it probes all pairwise connections.
<br>
In verbose mode you can see that.
<br>
<p>These programs shouldn't hang at all, if the system were sane.
<br>
...
<p>Suggestions
<br>
<p>1) Stick to the OpenMPI you compiled.
<br>
<p>**
<br>
<p>2) You can run connectivity_c in verbose mode:
<br>
<p>home/macmanes/apps/openmpi1.4/bin/mpirun -np 8 connectivity_c -v
<br>
<p>(Note the trailing &quot;-v&quot;.)
<br>
<p>It should tell more about who's talking to who.
<br>
<p>**
<br>
<p>3) I wonder if there are any BIOS settings that may be required
<br>
(and perhaps not in place) to make the Nehalem hyperthreading to
<br>
work properly in your computer.
<br>
<p>You reach the BIOS settings by typing &lt;DEL&gt; or &lt;F2&gt;
<br>
...
<br>
<p>You may ask the computer vendor about the recommended BIOS settings.
<br>
...
<p>**
<br>
<p>4) What I read about Nehalem DDR3 memory is that it is optimal
<br>
...
<p>See this:
<br>
<a href="http://en.community.dell.com/blogs/dell_tech_center/archive/2009/04/08/nehalem-and-memory-configurations.aspx">http://en.community.dell.com/blogs/dell_tech_center/archive/2009/04/08/nehalem-and-memory-configurations.aspx</a>
<br>
<p>**
<br>
<p>5) As I said before, typing &quot;f&quot; then &quot;j&quot; on &quot;top&quot; will add
<br>
...
<p>***
<br>
<p>It is very disconcerting when MPI processes hang.
<br>
You are not alone.
<br>
...
---------------------------------------------------------------------
<br>
<p><p><p><p><p>Matthew MacManes wrote:
<br>
<span class="quotelev1">&gt; Hi Gus and List,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 1st of all Gus, I want to say thanks.. you have been a huge help, and 
</span><br>
<span class="quotelev1">&gt; when I get this fixed, I owe you big time!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; I formatted the HD, reinstalled OS to make sure that I was working from 
</span><br>
<span class="quotelev1">&gt; scratch.  I did your step A, which seemed to go fine:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; this is maddening because ring_c works.. and connectivity_c worked the 
</span><br>
<span class="quotelev1">&gt; 1st time, but not the second... I did it 10 times, and it worked twice.. 
</span><br>
<span class="quotelev1">&gt; here is the TOP screenshot:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; What is the difference between connectivity_c and ring_c? Under what 
</span><br>
<span class="quotelev1">&gt; circumstances should one fail and not the other...
</span><br>
<span class="quotelev1">&gt; 
</span><br>
