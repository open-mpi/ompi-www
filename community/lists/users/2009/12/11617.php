...
?>
<!-- received="Sun Dec 20 10:17:03 2009" -->
<!-- isoreceived="20091220151703" -->
<!-- sent="Sun, 20 Dec 2009 08:16:55 -0700" -->
<!-- isosent="20091220151655" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Torque 2.4.3 fails with OpenMPI 1.3.4; no startup at all" -->
<!-- id="1B362800-35AD-4698-96C1-B9B07F6F8E9B_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2009-12-20 10:16:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11618.php">vipin kumar: "Re: [OMPI users] fault tolerance in open mpi"</a>
<li><strong>Previous message:</strong> <a href="11616.php">Johann Knechtel: "Re: [OMPI users] Torque 2.4.3 fails with OpenMPI 1.3.4; no startup at all"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11630.php">Johann Knechtel: "Re: [OMPI users] Torque 2.4.3 fails with OpenMPI 1.3.4; no startup at all"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
The &quot;mca plm rsh&quot; param tells OMPI to use the rsh launcher instead of the Torque launcher. The only real difference between them is that the rsh launcher &quot;pre-sets&quot; the prefix into the remote environment prior to executing the orted - and the Torque launcher doesn't.
<br>
<p>So it sounds like you aren't getting the remote path setup properly by Torque when it starts the remote daemon. This might have something to do with your Torque config - IIRC, there are some controls relating to such behavior. I'm not an expert in that area, so you might want to chat with the Torque folks or look at their FAQ area.
<br>
<p>Meantime, the rsh launcher works just as well and is just as fast as the Torque launcher. Only negative is that the Torque local daemons don't know of the existence of your procs, which can impact cleanup if something goes wrong.
<br>
<p>Ralph
<br>
<p><p>On Dec 20, 2009, at 5:28 AM, Johann Knechtel wrote:
<br>
<p><span class="quotelev1">&gt; Ralph, thank you very much for your input! The parameter &quot;mca plm rsh&quot;
</span><br>
