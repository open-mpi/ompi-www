...
?>
<!-- received="Tue Dec  1 18:36:25 2009" -->
<!-- isoreceived="20091201233625" -->
<!-- sent="Tue, 01 Dec 2009 18:36:15 -0500" -->
<!-- isosent="20091201233615" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun is using one PBS node only" -->
<!-- id="4B15A86F.1070505_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-12-01 18:36:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11336.php">Nicolas Bock: "Re: [OMPI users] MPI_Comm_spawn lots of times"</a>
<li><strong>Previous message:</strong> <a href="11334.php">Ralph Castain: "Re: [OMPI users] mpirun is using one PBS node only"</a>
<li><strong>In reply to:</strong> <a href="11327.php">Belaid MOA: "Re: [OMPI users] mpirun is using one PBS node only"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11339.php">Belaid MOA: "Re: [OMPI users] mpirun is using one PBS node only"</a>
<li><strong>Reply:</strong> <a href="11339.php">Belaid MOA: "Re: [OMPI users] mpirun is using one PBS node only"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Belaid Moa
<br>
<p>The OpenMPI I install and use is on a NFS mounted directory.
<br>
Hence, all the nodes see the same version, which has &quot;tm&quot; support.
<br>
<p>After reading your OpenMPI configuration parameters on the headnode
<br>
...
<br>
<p>However, you should first verify that this is really the case,
<br>
...
<br>
<p>If there is no Torque on WN1 and WN2 then OpenMPI won't find it
<br>
and you won't have &quot;tm&quot; support on the nodes.
<br>
<p>In any case, if OpenMPI &quot;tm&quot; support is missing on WN[1,2},
<br>
...
<br>
<p>A low-tech alternative is to copy over your OpenMPI directory tree to 
<br>
the WN1 and WN2 nodes.
<br>
<p>A yet simpler alternative is to reinstall OpenMPI on the headnode
<br>
...
variables.
<br>
<p>Think about maintenance, and upgrades:
<br>
...
<br>
<span class="quotelev1">&gt; I tried -bynode option but it did not change anything. I also tried the 
</span><br>
<span class="quotelev1">&gt; &quot;hostname&quot; name command and
</span><br>
<span class="quotelev1">&gt; I keep getting only the name of one node repeated according to the -n 
</span><br>
...
<span class="quotelev1">&gt; -- On the head node (HN), I installed openMPI using the --with-tm option 
</span><br>
