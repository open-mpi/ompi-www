...
?>
<!-- received="Tue Dec 29 17:40:41 2009" -->
<!-- isoreceived="20091229224041" -->
<!-- sent="Tue, 29 Dec 2009 14:40:26 -0800 (PST)" -->
<!-- isosent="20091229224026" -->
<!-- name="Mostyn Lewis" -->
...
<!-- id="Pine.GSO.4.64.0912291437440.6439_at_aragorn.brc.West.Sun.COM" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2009-12-29 17:40:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11655.php">Galaxia: "[OMPI users] Running error after upgrading from OpenMPI 1.27 to 1.32"</a>
<li><strong>Previous message:</strong> <a href="11653.php">Joshua Bernstein: "Re: [OMPI users] Problem compiling 1.4.0 snap with PGI 10.0-1 and openib flags turned on ..."</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/01/11712.php">Jeff Squyres: "Re: [OMPI users] Problem compiling 1.4.0 snap with PGI 10.0-1 and openib flags turned on ..."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>CFLAGS=-D__GNUC__
<br>
<p>A small test case just using those headers works, thus wise.
<br>
BTW, PGI 9.0-1 also fails on those headers.
<br>
<p>DM
<br>
<p>On Tue, 29 Dec 2009, Richard Walsh wrote:
<br>
