...
?>
<!-- received="Thu May 28 01:04:06 2009" -->
<!-- isoreceived="20090528050406" -->
<!-- sent="Wed, 27 May 2009 22:04:01 -0700 (PDT)" -->
<!-- isosent="20090528050401" -->
<!-- name="Michael Kuklik" -->
<!-- email="mkkuklik_at_[hidden]" -->
<!-- subject="Re: [OMPI users] users Digest, Vol 1242, Issue 5" -->
<!-- id="845813.9178.qm_at_web31404.mail.mud.yahoo.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="mailman.7080.1243473840.6040.users_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-05-28 01:04:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9453.php">vasilis: "Re: [OMPI users] &quot;An error occurred in MPI_Recv&quot; with more than 2 CPU"</a>
<li><strong>Previous message:</strong> <a href="9451.php">Joe Griffin: "Re: [OMPI users] problem with installing openmpi with intelcompiler onubuntu"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9457.php">Jeff Squyres: "Re: [OMPI users] users Digest, Vol 1242, Issue 5"</a>
<li><strong>Reply:</strong> <a href="9457.php">Jeff Squyres: "Re: [OMPI users] users Digest, Vol 1242, Issue 5"</a>
<li><strong>Reply:</strong> <a href="9459.php">Joe Griffin: "Re: [OMPI users] users Digest, Vol 1242, Issue 5"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
Do you think I should put the intel env script in the global shell config file like /etc/profile in order for libtool to see icc?
<br>
<p>Thanks for help,
<br>
<p>mike
...
<p>MK,
<br>
<p>Hmm.. What if you put CC=/usr/local/intel/Compiler/11.0/083/bin/intel64/icc
<br>
on the build line.
<br>
<p>Joe
...
<br>
/bin/bash ../libtool  --mode=install /usr/bin/install -c  'libopen-rte.la &lt;<a href="http://libopen-rte.la/">http://libopen-rte.la/</a>&gt; ' '/usr/local/intel/openmpi/lib/libopen-rte.la'
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9452/attachment">attachment</a>
</ul>
