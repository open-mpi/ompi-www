...
?>
<!-- received="Sat May 16 11:43:54 2009" -->
<!-- isoreceived="20090516154354" -->
<!-- sent="Sat, 16 May 2009 11:41:55 -0400" -->
<!-- isosent="20090516154155" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] scaling problem with openmpi" -->
<!-- id="4A0EDEC3.9080306_at_ldeo.columbia.edu" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2009-05-16 11:41:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9360.php">John Boccio: "[OMPI users] Openmpi -MacOSX-mpif90 won't compile"</a>
<li><strong>Previous message:</strong> <a href="9358.php">Roman Martonak: "Re: [OMPI users] scaling problem with openmpi"</a>
<li><strong>In reply to:</strong> <a href="9357.php">Gus Correa: "Re: [OMPI users] scaling problem with openmpi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9361.php">Pavel Shamis (Pasha): "Re: [OMPI users] scaling problem with openmpi"</a>
<li><strong>Reply:</strong> <a href="9361.php">Pavel Shamis (Pasha): "Re: [OMPI users] scaling problem with openmpi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Roman, list
<br>
<p>Sorry, now I see I totally missed your well taken point.
<br>
...
<br>
<p>All I can think of now is:
<br>
<p>1) I was told to add &quot;-mca mpi_leave_pinned 0&quot; to avoid problems with 
<br>
Infinband.  This was with OpenMPI 1.3.1.  Not sure if the problems were 
<br>
fixed on 1.3.2, but I am hanging on to that setting just in case.
<br>
<p>2) As you increase the number of processors, presumably the message size 
<br>
goes down, and perhaps you reach the threshold between eager and 
<br>
rendevous communication mode.  I wonder if this may have an impact on 
<br>
scaling also. My recollection is that there are ways to set that 
<br>
threshold to a different value.
<br>
<p>Hopefully the OpenMPI developers have some comment on what is going on.
<br>
<p>Once again, I am sorry for not reading your original message with the 
<br>
due attention.
<br>
<p>Gus Correa
...
<span class="quotelev1">&gt; web page stop at 32 processors (except for one with 128 processors ran 
</span><br>
<span class="quotelev1">&gt; on a Cray-TE-600,
</span><br>
...
<span class="quotelev2">&gt;&gt; Typically this happens as the number of processors reach some high 
</span><br>
<span class="quotelev2">&gt;&gt; number (which depends on the size of the problem).
</span><br>
<span class="quotelev2">&gt;&gt; So, what you are seeing may not be a problem with OpenMPI scaling,
</span><br>
<span class="quotelev2">&gt;&gt; but just that your problem is not large enough to require the use of, 
</span><br>
<span class="quotelev2">&gt;&gt; say, 48 or 64 processors.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; of any subdomain to be calculated in parallel (i.e. decomposing the 
</span><br>
<span class="quotelev2">&gt;&gt; domain in parts).
</span><br>
