...
?>
<!-- received="Mon May  4 13:01:30 2009" -->
<!-- isoreceived="20090504170130" -->
<!-- sent="Mon, 4 May 2009 19:01:24 +0200" -->
<!-- isosent="20090504170124" -->
<!-- name="Vicente Puig" -->
<!-- email="vpuibor_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1" -->
<!-- id="3e9a21680905041001y6871a4f2g25b6984bb11a1146_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="1983ADEF-2F22-4BCB-8FC2-5A02344CB928_at_apple.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-05-04 13:01:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9197.php">Vicente Puig: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Previous message:</strong> <a href="9195.php">Warner Yuen: "[OMPI users]  How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>In reply to:</strong> <a href="9195.php">Warner Yuen: "[OMPI users]  How do I compile OpenMPI in Xcode 3.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9197.php">Vicente Puig: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Reply:</strong> <a href="9197.php">Vicente Puig: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Vincent
<br>
<p>2009/5/4 Warner Yuen &lt;wyuen_at_[hidden]&gt;
<br>
<p><span class="quotelev1">&gt; Admittedly, I don't use Xcode to build Open MPI either.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; You can just compile Open MPI from the command line and install everything
</span><br>
<span class="quotelev1">&gt; in /usr/local/. Make sure that gfortran is set in your path and you should
</span><br>
<span class="quotelev1">&gt; just be able to do a './configure --prefix=/usr/local'
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; After the installation, just make sure that your path is set correctly when
</span><br>
<span class="quotelev1">&gt; you go to use the newly installed Open MPI. If you don't set your path, it
</span><br>
<span class="quotelev1">&gt; will always default to using the version of OpenMPI that ships with Leopard.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; as my mpif90 compiler. But I've seen when I use the mpif90 on /usr/bin
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; and on  /Developer/usr/bin says it:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; That should be the problem, I will have to change the path to use the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; gfortran I have installed.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; How could I do it? (Sorry, I am beginner)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; El 04/05/2009, a las 17:38, Warner Yuen escribi?:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  Have you installed a Fortran compiler? Mac OS X's developer tools do
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9196/attachment">attachment</a>
</ul>
