...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9152.php">Ralph Castain: "Re: [OMPI users] compilation application with openmpi question"</a>
<li><strong>Previous message:</strong> <a href="../../2009/04/9150.php">Eugene Loh: "Re: [OMPI users] MPI processes hang when using OpenMPI 1.3.2 and Gcc-4.4.0"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9152.php">Ralph Castain: "Re: [OMPI users] compilation application with openmpi question"</a>
<li><strong>Reply:</strong> <a href="9152.php">Ralph Castain: "Re: [OMPI users] compilation application with openmpi question"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
