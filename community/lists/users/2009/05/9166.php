...
?>
<!-- received="Fri May  1 17:12:12 2009" -->
<!-- isoreceived="20090501211212" -->
<!-- sent="Fri, 01 May 2009 17:12:02 -0400" -->
<!-- isosent="20090501211202" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] HPL with OpenMPI: Do I have a memory leak?" -->
<!-- id="49FB65A2.7060403_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="71d2d8cc0905011023g68da691cxbf2ef1587a3c860e_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-05-01 17:12:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9167.php">Brian W. Barrett: "Re: [OMPI users] HPL with OpenMPI: Do I have a memory leak?"</a>
<li><strong>Previous message:</strong> <a href="9165.php">Josh Hursey: "Re: [OMPI users] Problem with Filem"</a>
<li><strong>In reply to:</strong> <a href="9160.php">Ralph Castain: "Re: [OMPI users] HPL with OpenMPI: Do I have a memory leak?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9167.php">Brian W. Barrett: "Re: [OMPI users] HPL with OpenMPI: Do I have a memory leak?"</a>
<li><strong>Reply:</strong> <a href="9167.php">Brian W. Barrett: "Re: [OMPI users] HPL with OpenMPI: Do I have a memory leak?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph
<br>
<p>Thank you very much for the prompt answer.
<br>
Sorry for being so confusing on my original message.
<br>
<p>Yes, I am saying that the inclusion of openib is causing the difference
<br>
in behavior.
<br>
...
<br>
<p>And yes, all the procs run on a single node in both cases.
<br>
...
<br>
<p>BTW, I successfully ran HPL across the whole cluster two days ago,
<br>
...
<br>
<p>Finally, on your email you use the syntax &quot;btl=openib,sm,self&quot;,
<br>
...
<br>
<span class="quotelev1">&gt; If you are running on a single node, then btl=openib,sm,self would be 
</span><br>
<span class="quotelev1">&gt; equivalent to btl=sm,self. OMPI is smart enough to know not to use IB if 
</span><br>
<span class="quotelev1">&gt; you are on a single node, and instead uses the shared memory subsystem.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Are you saying that the inclusion of openib is causing a difference in 
</span><br>
<span class="quotelev1">&gt; behavior, even though all procs are on the same node??
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Just want to ensure I understand the problem.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Fri, May 1, 2009 at 11:16 AM, Gus Correa &lt;gus_at_[hidden] 
</span><br>
