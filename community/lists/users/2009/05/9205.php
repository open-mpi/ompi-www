...
?>
<!-- received="Mon May  4 19:28:06 2009" -->
<!-- isoreceived="20090504232806" -->
<!-- sent="Tue, 5 May 2009 01:28:00 +0200" -->
<!-- isosent="20090504232800" -->
<!-- name="Vicente Puig" -->
<!-- email="vpuibor_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1" -->
<!-- id="3e9a21680905041628g67a3c586jfb181a20724051b9_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-05-04 19:28:00
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9206.php">Gus Correa: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Previous message:</strong> <a href="9204.php">Vicente Puig: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>In reply to:</strong> <a href="9204.php">Vicente Puig: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9229.php">Jeff Squyres: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>2009/5/5 Vicente Puig &lt;vpuibor_at_[hidden]&gt;
<br>
<p><span class="quotelev1">&gt; But it doesn't work well.
</span><br>
<span class="quotelev1">&gt; For example, I am trying to debug a program, &quot;floyd&quot; in this case, and when
</span><br>
<span class="quotelev1">&gt; I make a breakpoint:
</span><br>
...
<span class="quotelev1">&gt; I am getting disappointed and frustrated that I can not work well with
</span><br>
<span class="quotelev1">&gt; openmpi in my Mac. There should be a was to make it run in Xcode, uff...
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; I get those as well.  I believe that they are (annoying but) harmless --
</span><br>
<span class="quotelev2">&gt;&gt; an artifact of how the freeware gcc/gofrtran that I use was built.
</span><br>
...
<span class="quotelev2">&gt;&gt;  Maybe I had to open a new thread, but if you have any idea why I receive
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9205/attachment">attachment</a>
</ul>
