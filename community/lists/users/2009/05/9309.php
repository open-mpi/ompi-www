...
?>
<!-- received="Tue May 12 09:37:06 2009" -->
<!-- isoreceived="20090512133706" -->
<!-- sent="Tue, 12 May 2009 09:37:00 -0400" -->
<!-- isosent="20090512133700" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Bug in return status of MPI_WAIT()?" -->
<!-- id="3A95E7AF-C91F-41D8-8238-1049DC3480BE_at_cisco.com" -->
<!-- charset="WINDOWS-1252" -->
<!-- inreplyto="89F8C511E9BE1F41AE2F1BB0424037F2D009FFFC_at_hasmsx504.ger.corp.intel.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-05-12 09:37:00
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9310.php">Jeff Squyres: "Re: [OMPI users] Bug in return status of MPI_WAIT()?"</a>
<li><strong>Previous message:</strong> <a href="9308.php">Matthieu Brucher: "Re: [OMPI users] New warning messages in 1.3.2 (not present in1.2.8)"</a>
<li><strong>In reply to:</strong> <a href="9282.php">Katz, Jacob: "[OMPI users] Bug in return status of MPI_WAIT()?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9310.php">Jeff Squyres: "Re: [OMPI users] Bug in return status of MPI_WAIT()?"</a>
<li><strong>Reply:</strong> <a href="9310.php">Jeff Squyres: "Re: [OMPI users] Bug in return status of MPI_WAIT()?"</a>
<li><strong>Reply:</strong> <a href="9314.php">Katz, Jacob: "Re: [OMPI users] Bug in return status of MPI_WAIT()?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
