...
?>
<!-- received="Mon May  4 12:13:50 2009" -->
<!-- isoreceived="20090504161350" -->
<!-- sent="Mon, 4 May 2009 18:13:45 +0200" -->
<!-- isosent="20090504161345" -->
<!-- name="Vicente Puig" -->
<!-- email="vpuibor_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1" -->
<!-- id="3e9a21680905040913u3f36d3c9rdcd3413bfdcd0c9_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="0AEB295F-8344-483B-830C-6A47F92C79B2_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-05-04 12:13:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9195.php">Warner Yuen: "[OMPI users]  How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Previous message:</strong> <a href="9193.php">Jeff Squyres: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>In reply to:</strong> <a href="9193.php">Jeff Squyres: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p>Vincent
<br>
<p><p>2009/5/4 Jeff Squyres &lt;jsquyres_at_[hidden]&gt;
<br>
<p><span class="quotelev1">&gt; Open MPI comes pre-installed in Leopard; as Warner noted, since Leopard
</span><br>
<span class="quotelev1">&gt; doesn't ship with a Fortran compiler, the Open MPI that Apple ships has
</span><br>
...
<span class="quotelev1">&gt; compilers, and therefore will have functional mpif77 and mpif90 wrapper
</span><br>
<span class="quotelev1">&gt; compilers.  Hence, you probably need to be sure to use the &quot;right&quot; wrapper
</span><br>
<span class="quotelev1">&gt; compilers.  It looks like you specified the full path specified to ExecPath,
</span><br>
<span class="quotelev1">&gt; so I'm not sure why Xcode wouldn't work with that (like I mentioned, I
</span><br>
<span class="quotelev1">&gt; unfortunately don't use Xcode myself, so I don't know why that wouldn't
</span><br>
...
<span class="quotelev2">&gt;&gt; as my mpif90 compiler. But I've seen when I use the mpif90 on /usr/bin
</span><br>
...
<span class="quotelev2">&gt;&gt; El 04/05/2009, a las 17:38, Warner Yuen escribi&#243;:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt;  1. How do I compile OpenMPI in Xcode 3.1 (Vicente)
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;  2. Re: 1.3.1 -rf rankfile behaviour ?? (Ralph Castain)
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
...
<span class="quotelev4">&gt;&gt; &gt;&gt; Date: Mon, 4 May 2009 16:12:44 +0200
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; From: Vicente &lt;vpuibor_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Subject: [OMPI users] How do I compile OpenMPI in Xcode 3.1
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; To: users_at_[hidden]
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Message-ID: &lt;1C2C0085-940F-43BB-910F-975871AE2F09_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; Hi, I've seen the FAQ &quot;How do I use Open MPI wrapper compilers in
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Xcode&quot;, but it's only for MPICC. I am using MPIF90, so I did the
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; same,
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; but changing MPICC for MPIF90, and also the path, but it did not
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; work.
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Building target ?fortran? of project ?fortran? with configuration
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; Checking Dependencies
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Invalid value 'MPIF90' for GCC_VERSION
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; The file &quot;MPIF90.cpcompspec&quot; looks like this:
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;  1 /**
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;  2         Xcode Coompiler Specification for MPIF90
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt;  6 {   Type = Compiler;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;  7     Identifier = com.apple.compilers.mpif90;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;  8     BasedOn = com.apple.compilers.gcc.4_0;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;  9     Name = &quot;MPIF90&quot;;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; 10     Version = &quot;Default&quot;;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; 11     Description = &quot;MPI GNU C/C++ Compiler 4.0&quot;;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; 12     ExecPath = &quot;/usr/local/bin/mpif90&quot;;      // This gets
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; converted to the g++ variant automatically
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; 13     PrecompStyle = pch;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; 14 }
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; and is located in &quot;/Developer/Library/Xcode/Plug-ins&quot;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; and when I do mpif90 -v on terminal it works well:
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Using built-in specs.
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Target: i386-apple-darwin8.10.1
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Configured with: /tmp/gfortran-20090321/ibin/../gcc/configure --
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; prefix=/usr/local/gfortran --enable-languages=c,fortran --with-gmp=/
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; tmp/gfortran-20090321/gfortran_libs --enable-bootstrap
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Thread model: posix
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; gcc version 4.4.0 20090321 (experimental) [trunk revision 144983]
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; Date: Mon, 4 May 2009 08:28:26 -0600
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt;      &lt;71d2d8cc0905040728h2002f4d7s4c49219eee29e86f_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Content-Type: text/plain; charset=&quot;iso-8859-1&quot;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Unfortunately, I didn't write any of that code - I was just fixing
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; the
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; mapper so it would properly map the procs. From what I can tell,
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; the proper
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; things are happening there.
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; I'll have to dig into the code that specifically deals with parsing
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; the
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; results to bind the processes. Afraid that will take awhile longer
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; - pretty
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; dark in that hole.
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; On Mon, May 4, 2009 at 8:04 AM, Geoffroy Pignot
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; End of users Digest, Vol 1221, Issue 6
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; **************************************
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9194/attachment">attachment</a>
</ul>
