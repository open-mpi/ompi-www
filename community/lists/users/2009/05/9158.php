...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9159.php">Gus Correa: "[OMPI users] HPL with OpenMPI: Do I have a memory leak?"</a>
<li><strong>Previous message:</strong> <a href="9157.php">Ralph Castain: "Re: [OMPI users] compilation application with openmpi question"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9176.php">Simone Pellegrini: "Re: [OMPI users] MPI processes hang when using OpenMPI 1.3.2 and Gcc-4.4.0"</a>
<li><strong>Reply:</strong> <a href="9176.php">Simone Pellegrini: "Re: [OMPI users] MPI processes hang when using OpenMPI 1.3.2 and Gcc-4.4.0"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
