...
?>
<!-- received="Mon May  4 11:42:55 2009" -->
<!-- isoreceived="20090504154255" -->
<!-- sent="Mon, 4 May 2009 11:42:48 -0400" -->
<!-- isosent="20090504154248" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1" -->
<!-- id="ACA9C95C-5A79-4CFD-BC05-F2BF8674D0CC_at_cisco.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2009-05-04 11:42:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9191.php">Vicente: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Previous message:</strong> <a href="9189.php">Warner Yuen: "[OMPI users]  How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>In reply to:</strong> <a href="9189.php">Warner Yuen: "[OMPI users]  How do I compile OpenMPI in Xcode 3.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9192.php">Vicente: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Reply:</strong> <a href="9192.php">Vicente: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Reply:</strong> <a href="9233.php">Luis Vitorio Cargnini: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><p>On May 4, 2009, at 11:38 AM, Warner Yuen wrote:
<br>
<p><span class="quotelev1">&gt; Have you installed a Fortran compiler? Mac OS X's developer tools do
</span><br>
<span class="quotelev1">&gt; not come with a Fortran compiler, so you'll need to install one if you
</span><br>
<span class="quotelev1">&gt; haven't already done so. I routinely use the Intel IFORT compilers
</span><br>
<span class="quotelev1">&gt; with success. However, I hear many good things about the gfortran
</span><br>
<span class="quotelev1">&gt; compilers on Mac OS X, you can't beat the price of gfortran!
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; on the CPU 3. I was looking for it on CPU 0 accordind to my cpuinfo
</span><br>
