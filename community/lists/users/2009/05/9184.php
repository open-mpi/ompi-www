...
?>
<!-- received="Mon May  4 10:04:44 2009" -->
<!-- isoreceived="20090504140444" -->
<!-- sent="Mon, 4 May 2009 16:04:37 +0200" -->
<!-- isosent="20090504140437" -->
<!-- name="Geoffroy Pignot" -->
<!-- email="geopignot_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="b4f9bf870905040704n100d0d93i8668ebc13aaa4b6f_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-05-04 10:04:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9185.php">Vicente: "[OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Previous message:</strong> <a href="9183.php">Kritiraj Sajadah: "Re: [OMPI users] mca: base: component_find: unable to open/usr/local/lib/openmpi/mca_crs_blcr: file not found (ignored)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9186.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9186.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>So, there are no more crashes with my &quot;crazy&quot; mpirun command. But the
<br>
paffinity feature seems to be broken. Indeed I am not able to pin my
<br>
processes.
<br>
<p>Simple test with a program using your plpa library :
<br>
<p>r011n006% cat hostf
<br>
r011n006 slots=4
<br>
<p>r011n006% cat rankf
<br>
rank 0=r011n006 slot=0   ----&gt; bind to CPU 0 , exact ?
<br>
<p>r011n006% /tmp/HALMPI/openmpi-1.4a/bin/mpirun --hostfile hostf --rankfile
<br>
...
r011n006%bg
<br>
<p>r011n006% ps axo stat,user,psr,pid,pcpu,comm | grep gpignot
<br>
R+   gpignot    3  9271 97.8 a.out
<br>
<p>In fact whatever the slot number I put in my rankfile , a.out always runs on
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9184/attachment">attachment</a>
</ul>
