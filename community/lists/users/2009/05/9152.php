...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9153.php">Eugene Loh: "Re: [OMPI users] MPI processes hang when using OpenMPI 1.3.2 and Gcc-4.4.0"</a>
<li><strong>Previous message:</strong> <a href="9151.php">David Wong: "[OMPI users] compilation application with openmpi question"</a>
<li><strong>In reply to:</strong> <a href="9151.php">David Wong: "[OMPI users] compilation application with openmpi question"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-9152/attachment">attachment</a>
</ul>
