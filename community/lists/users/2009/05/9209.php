...
?>
<!-- received="Tue May  5 05:38:00 2009" -->
<!-- isoreceived="20090505093800" -->
<!-- sent="Tue, 5 May 2009 11:37:54 +0200" -->
<!-- isosent="20090505093754" -->
<!-- name="Geoffroy Pignot" -->
<!-- email="geopignot_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="b4f9bf870905050237u152a7f3k26cbd9f0ec505ad_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-05-05 05:37:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9210.php">Matthieu Brucher: "[OMPI users] LSF launch with OpenMPI"</a>
<li><strong>Previous message:</strong> <a href="9208.php">Pavel Shamis (Pasha): "Re: [OMPI users] users Digest, Vol 1217, Issue 2, Message3"</a>
<li><strong>In reply to:</strong> <a href="9203.php">Geoffroy Pignot: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9211.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9211.php">Ralph Castain: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi
<br>
<p>&nbsp;The result is : everything works fine with MPI executables : logical !!!
<br>
<p>What I was trying to do , was to run non MPI exes thanks to mpirun. There ,
<br>
...
<br>
<p>Could it be possible to have the paffinity features working without any
<br>
...
<br>
<p>I am looking forward to downloading, trying and deploying the next official
<br>
release
<br>
<p>Regards
...
<p>Geoffroy
<br>
<p><p><p>2009/5/4 Geoffroy Pignot &lt;geopignot_at_[hidden]&gt;
<br>
<p><span class="quotelev1">&gt; Hi Ralph
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Thanks for your extra tests.  Before leaving , I just pointed out a problem
</span><br>
<span class="quotelev1">&gt; coming from running plpa across different rh distribs (&lt;=&gt; different Linux
</span><br>
<span class="quotelev1">&gt; kernels). Indeed, I configure and compile openmpi on rhel4 , then I run on
</span><br>
<span class="quotelev1">&gt; rhel5. I think my problem comes from this approximation. I'll do few more
</span><br>
<span class="quotelev1">&gt; tests tomorrow morning (France) and keep you inform.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Hmmm...I'm afraid I can't replicate the problem. All seems to be working
</span><br>
<span class="quotelev2">&gt;&gt; just fine on the RHEL systems available to me. The procs indeed bind to
</span><br>
...
<span class="quotelev2">&gt;&gt; [odin001.cs.indiana.edu:09297 &lt;<a href="http://odin001.cs.indiana.edu:9297/">http://odin001.cs.indiana.edu:9297/</a>&gt;]
</span><br>
...
<span class="quotelev2">&gt;&gt; [odin002.cs.indiana.edu:13566] paffinity slot assignment: slot_list == 1
</span><br>
<span class="quotelev2">&gt;&gt; [odin002.cs.indiana.edu:13566] paffinity slot assignment: rank 1 runs on
</span><br>
...
<span class="quotelev2">&gt;&gt; On Mon, May 4, 2009 at 8:28 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt; &gt; Unfortunately, I didn't write any of that code - I was just fixing the
</span><br>
<span class="quotelev3">&gt;&gt; &gt; mapper so it would properly map the procs. From what I can tell, the
</span><br>
<span class="quotelev2">&gt;&gt; proper
</span><br>
<span class="quotelev3">&gt;&gt; &gt; things are happening there.
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
<span class="quotelev3">&gt;&gt; &gt; I'll have to dig into the code that specifically deals with parsing the
</span><br>
...
<span class="quotelev3">&gt;&gt; &gt; On Mon, May 4, 2009 at 8:04 AM, Geoffroy Pignot &lt;geopignot_at_[hidden]
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; So, there are no more crashes with my &quot;crazy&quot; mpirun command. But the
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; In fact whatever the slot number I put in my rankfile , a.out always
</span><br>
<span class="quotelev2">&gt;&gt; runs
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; on the CPU 3. I was looking for it on CPU 0 accordind to my cpuinfo
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; Linux r011n006 2.6.18-92.1.1NOMAP32.el5 #1 SMP Sat Mar 15 01:46:39 CDT
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt;  ./configure --prefix=/tmp/openmpi-1.4a --libdir='${exec_prefix}/lib64'
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; flags           : fpu vme de pse tsc msr pae mce cx8 apic sep mtrr pge
</span><br>
<span class="quotelev2">&gt;&gt; mca
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; cmov pat pse36 clflush dts acpi mmx fxsr sse sse2 ss ht tm syscall nx
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; My apologies - I wasn't clear enough. You need a tarball from r21111
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9209/attachment">attachment</a>
</ul>
