<?
$subject_val = "Re: [OMPI users] problem with installing openmpi with intelcompiler onubuntu";
include("../../include/msg-header.inc");
?>
<!-- received="Wed May 27 21:24:00 2009" -->
<!-- isoreceived="20090528012400" -->
<!-- sent="Wed, 27 May 2009 18:23:10 -0700" -->
<!-- isosent="20090528012310" -->
<!-- name="Joe Griffin" -->
<!-- email="joe.griffin_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem with installing openmpi with intelcompiler onubuntu" -->
<!-- id="1D367926756E9848BABD800E249AA5E04BFF88_at_NASCMEX01.na.mscsoftware.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="11543.54323.qm_at_web31402.mail.mud.yahoo.com" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] problem with installing openmpi with intelcompiler onubuntu<br>
<strong>From:</strong> Joe Griffin (<em>joe.griffin_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-05-27 21:23:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9452.php">Michael Kuklik: "Re: [OMPI users] users Digest, Vol 1242, Issue 5"</a>
<li><strong>Previous message:</strong> <a href="9450.php">Michael Kuklik: "Re: [OMPI users] problem with installing openmpi with intel compiler onubuntu"</a>
<li><strong>In reply to:</strong> <a href="9450.php">Michael Kuklik: "Re: [OMPI users] problem with installing openmpi with intel compiler onubuntu"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9451/attachment">attachment</a>
</ul>
