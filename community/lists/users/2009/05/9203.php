...
?>
<!-- received="Mon May  4 16:00:12 2009" -->
<!-- isoreceived="20090504200012" -->
<!-- sent="Mon, 4 May 2009 22:00:05 +0200" -->
<!-- isosent="20090504200005" -->
<!-- name="Geoffroy Pignot" -->
<!-- email="geopignot_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="b4f9bf870905041300o6955e9acr6ac4660b26370d7b_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-05-04 16:00:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9204.php">Vicente Puig: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Previous message:</strong> <a href="9202.php">Jeff Squyres: "Re: [OMPI users] users Digest, Vol 1217, Issue 2, Message3"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9206.php">Gus Correa: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9206.php">Gus Correa: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<li><strong>Reply:</strong> <a href="9209.php">Geoffroy Pignot: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph
<br>
<p>Thanks for your extra tests.  Before leaving , I just pointed out a problem
<br>
...
<span class="quotelev1">&gt; just fine on the RHEL systems available to me. The procs indeed bind to the
</span><br>
...
<span class="quotelev1">&gt; [rhc_at_odin mpi]$ mpirun -rf ../../../rankfile -n 2 --leave-session-attached
</span><br>
...
<span class="quotelev1">&gt; [odin002.cs.indiana.edu:13566] paffinity slot assignment: slot_list == 1
</span><br>
<span class="quotelev1">&gt; [odin002.cs.indiana.edu:13566] paffinity slot assignment: rank 1 runs on
</span><br>
...
<span class="quotelev1">&gt; Not sure where to go from here...perhaps someone else can spot the problem?
</span><br>
...
<span class="quotelev1">&gt; On Mon, May 4, 2009 at 8:28 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt; &gt; Unfortunately, I didn't write any of that code - I was just fixing the
</span><br>
<span class="quotelev2">&gt; &gt; mapper so it would properly map the procs. From what I can tell, the
</span><br>
...
<span class="quotelev2">&gt; &gt; I'll have to dig into the code that specifically deals with parsing the
</span><br>
...
<span class="quotelev2">&gt; &gt; On Mon, May 4, 2009 at 8:04 AM, Geoffroy Pignot &lt;geopignot_at_[hidden]
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; So, there are no more crashes with my &quot;crazy&quot; mpirun command. But the
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; In fact whatever the slot number I put in my rankfile , a.out always
</span><br>
<span class="quotelev1">&gt; runs
</span><br>
<span class="quotelev3">&gt; &gt;&gt; on the CPU 3. I was looking for it on CPU 0 accordind to my cpuinfo file
</span><br>
<span class="quotelev3">&gt; &gt;&gt; (see below)
</span><br>
<span class="quotelev3">&gt; &gt;&gt; The result is the same if I try another syntax (rank 0=r011n006 slot=0:0
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Linux r011n006 2.6.18-92.1.1NOMAP32.el5 #1 SMP Sat Mar 15 01:46:39 CDT
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;  ./configure --prefix=/tmp/openmpi-1.4a --libdir='${exec_prefix}/lib64'
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; cmov pat pse36 clflush dts acpi mmx fxsr sse sse2 ss ht tm syscall nx lm
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; My apologies - I wasn't clear enough. You need a tarball from r21111
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9203/attachment">attachment</a>
</ul>
