...
?>
<!-- received="Mon May  4 13:47:31 2009" -->
<!-- isoreceived="20090504174731" -->
<!-- sent="Mon, 4 May 2009 19:47:25 +0200" -->
<!-- isosent="20090504174725" -->
<!-- name="Vicente Puig" -->
<!-- email="vpuibor_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1" -->
<!-- id="3e9a21680905041047u6233b324ta8c34a0967b86c74_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="3e9a21680905041001y6871a4f2g25b6984bb11a1146_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-05-04 13:47:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9198.php">Kritiraj Sajadah: "[OMPI users] error while loading shared libraries: libcr.so.0: cannot open shared object file: No such file or directory."</a>
<li><strong>Previous message:</strong> <a href="9196.php">Vicente Puig: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>In reply to:</strong> <a href="9196.php">Vicente Puig: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9199.php">Jeff Squyres: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Reply:</strong> <a href="9199.php">Jeff Squyres: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>warning: Could not find object file
<br>
...
.......
<br>
<p><p><p>There is no 'admin' so I don't know why it happen. It works well with a C
<br>
program.
<br>
<p>Any idea??.
...
<p><p>Vincent
<br>
<p><p><p><p><p>2009/5/4 Vicente Puig &lt;vpuibor_at_[hidden]&gt;
<br>
<p><span class="quotelev1">&gt; I can run openmpi perfectly with command line, but I wanted a graphic
</span><br>
<span class="quotelev1">&gt; interface for debugging because I was having problems.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; doesn't ship with a Fortran compiler, the Open MPI that Apple ships has
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; non-functional mpif77 and mpif90 wrapper compilers.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So the Open MPI that you installed manually will use your Fortran
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; compilers, and therefore will have functional mpif77 and mpif90 wrapper
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; compilers.  Hence, you probably need to be sure to use the &quot;right&quot;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; wrapper
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; compilers.  It looks like you specified the full path specified to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ExecPath,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; so I'm not sure why Xcode wouldn't work with that (like I mentioned, I
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; unfortunately don't use Xcode myself, so I don't know why that wouldn't
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On May 4, 2009, at 11:53 AM, Vicente wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Yes, I already have gfortran compiler on /usr/local/bin, the same path
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; So, there are no more crashes with my &quot;crazy&quot; mpirun command. But
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; paffinity feature seems to be broken. Indeed I am not able to pin my
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; always runs
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; on the CPU 3. I was looking for it on CPU 0 accordind to my
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; cpuinfo file
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; (see below)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The result is the same if I try another syntax (rank 0=r011n006
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; slot=0:0
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Linux r011n006 2.6.18-92.1.1NOMAP32.el5 #1 SMP Sat Mar 15 01:46:39
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; CDT 2008
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ./configure --prefix=/tmp/openmpi-1.4a --libdir='${exec_prefix}/
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; lib64'
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; model name      : Intel(R) Xeon(R) CPU            5150  @ 2.66GHz
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; flags           : fpu vme de pse tsc msr pae mce cx8 apic sep mtrr
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; pge mca
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; cmov pat pse36 clflush dts acpi mmx fxsr sse sse2 ss ht tm syscall
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; nx lm
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9197/attachment">attachment</a>
</ul>
