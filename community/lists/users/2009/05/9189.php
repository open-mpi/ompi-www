...
?>
<!-- received="Mon May  4 11:38:44 2009" -->
<!-- isoreceived="20090504153844" -->
<!-- sent="Mon, 4 May 2009 08:38:37 -0700" -->
<!-- isosent="20090504153837" -->
<!-- name="Warner Yuen" -->
<!-- email="wyuen_at_[hidden]" -->
<!-- subject="[OMPI users]  How do I compile OpenMPI in Xcode 3.1" -->
<!-- id="B9210E3E-EA80-4261-AFB4-A550F6136FC2_at_apple.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="mailman.5070.1241447316.6040.users_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-05-04 11:38:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9190.php">Jeff Squyres: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Previous message:</strong> <a href="9188.php">Bogdan Costescu: "Re: [OMPI users] Myrinet optimization with OMP1.3 and macosX"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9190.php">Jeff Squyres: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Reply:</strong> <a href="9190.php">Jeff Squyres: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<li><strong>Reply:</strong> <a href="9191.php">Vicente: "Re: [OMPI users] How do I compile OpenMPI in Xcode 3.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Tel: 408.718.2859
<br>
<p><p><p><p>On May 4, 2009, at 7:28 AM, users-request_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; Xcode&quot;, but it's only for MPICC. I am using MPIF90, so I did the same,
</span><br>
<span class="quotelev1">&gt; but changing MPICC for MPIF90, and also the path, but it did not work.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Unfortunately, I didn't write any of that code - I was just fixing the
</span><br>
<span class="quotelev1">&gt; mapper so it would properly map the procs. From what I can tell, the  
</span><br>
...
<span class="quotelev2">&gt;&gt; on the CPU 3. I was looking for it on CPU 0 accordind to my cpuinfo  
</span><br>
