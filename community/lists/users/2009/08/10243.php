...
?>
<!-- received="Fri Aug  7 09:13:22 2009" -->
<!-- isoreceived="20090807131322" -->
<!-- sent="Fri, 07 Aug 2009 07:12:45 -0600" -->
<!-- isosent="20090807131245" -->
<!-- name="Craig Tierney" -->
<!-- email="craig.tierney_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Performance question about OpenMPI and MVAPICH2 on	IB" -->
<!-- id="4A7C284D.3040603_at_noaa.gov" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-08-07 09:12:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10244.php">Craig Tierney: "Re: [OMPI users] Performance question about OpenMPI and MVAPICH2 on	IB"</a>
<li><strong>Previous message:</strong> <a href="10242.php">neeraj_at_[hidden]: "Re: [OMPI users] Performance question about OpenMPI and MVAPICH2	on	IB"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10247.php">Craig Tierney: "Re: [OMPI users] Performance question about OpenMPI and MVAPICH2 on	IB"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>The script binds them to sockets and also binds memory per node.
<br>
...
<br>
<p><span class="quotelev1">&gt; Also, if you think the main issue is collectives performance you may 
</span><br>
...
<p>I don't know what it is slow.  OpenMPI is so flexible in how the
<br>
...
in most cases.
<br>
<p>I will try the above options and get back to you.
<br>
<p>Craig
<br>
