...
?>
<!-- received="Wed Aug  5 09:23:19 2009" -->
<!-- isoreceived="20090805132319" -->
<!-- sent="Wed, 5 Aug 2009 07:23:13 -0600" -->
<!-- isosent="20090805132313" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Performance difference on OpenMPI, IntelMPI and 	ScaliMPI" -->
<!-- id="71d2d8cc0908050623o165b7116ydeea6b34eb7fe9bd_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2009-08-05 09:23:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="10206.php">David Doria: "Re: [OMPI users] Two remote machines - asymmetric behavior"</a>
<li><strong>Previous message:</strong> <a href="10204.php">Torgny Faxen: "Re: [OMPI users] Performance difference on OpenMPI, IntelMPI and ScaliMPI"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="10211.php">Torgny Faxen: "Re: [OMPI users] Performance difference on OpenMPI, IntelMPI and 	ScaliMPI"</a>
<li><strong>Reply:</strong> <a href="10211.php">Torgny Faxen: "Re: [OMPI users] Performance difference on OpenMPI, IntelMPI and 	ScaliMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>(a) upgrade to 1.3.3 - it looks like you are using some kind of pre-release
<br>
version
<br>
<p>(b) add -mca mpi_show_mca_params env,file - this will cause rank=0 to output
<br>
what mca params it sees, and where they came from
<br>
<p>(c) check that you built a non-debug version, and remembered to compile your
<br>
...
Ralph
<br>
<p><p>On Wed, Aug 5, 2009 at 7:15 AM, Torgny Faxen &lt;faxen_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev3">&gt;&gt;&gt; we are seeing a large difference in performance for some applications
</span><br>
<span class="quotelev3">&gt;&gt;&gt; depending on what MPI is being used.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Attached are performance numbers and oprofile output (first 30 lines)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; from one out of 14 nodes from one application run using OpenMPI, IntelMPI
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and Scali MPI respectively.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; MPI_Iprobe followed by MPI_Recv (in case of there being a message). Quite
</span><br>
<span class="quotelev3">&gt;&gt;&gt; often MPI_Iprobe is being called just to check whether there is a certain
</span><br>
<span class="quotelev3">&gt;&gt;&gt; message pending.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; &quot;mca_btl_sm_component_progress&quot;, &quot;btl_openib_component_progress&quot; and other
</span><br>
<span class="quotelev3">&gt;&gt;&gt; internal routines.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The code is running on a cluster with 140 HP ProLiant DL160 G5 compute
</span><br>
<span class="quotelev3">&gt;&gt;&gt; servers. Infiniband interconnect. Intel Xeon E5462 processors. The profiled
</span><br>
<span class="quotelev3">&gt;&gt;&gt; application is using 144 cores on 18 nodes over Infiniband.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 441828   14.6846  rco2.24pe                rco2.24pe                step_
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 335929   11.1650  libmlx4-rdmav2.so        rco2.24pe                (no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; symbols)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 99526     3.3079  no-vmlinux               no-vmlinux               (no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; symbols)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 20986     0.6975  rco2.24pe                rco2.24pe                diag_
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 10003     0.3325  libimf.so                rco2.24pe                exp.L
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 486712   17.7537  rco2                     rco2                     step_
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 431941   15.7558  no-vmlinux               no-vmlinux               (no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; symbols)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 48621     1.7735  libmpi.so.3.2            rco2                     .plt
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 38582     1.4073  libdaplcma.so.1.0.2      rco2                     (no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; symbols)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 35597     1.2985  libc-2.5.so              rco2                     free
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 19146     0.6984  rco2                     rco2                     diag_
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 484267   30.0664  rco2.24pe                rco2.24pe                step_
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 111949    6.9505  libmlx4-rdmav2.so        rco2.24pe                (no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; symbols)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 29707     1.8444  no-vmlinux               no-vmlinux               (no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; symbols)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 22615     1.4041  libmpi.so                rco2.24pe                .plt
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 21172     1.3145  rco2.24pe                rco2.24pe                diag_
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 12427     0.7715  libibverbs.so.1.0.0      rco2.24pe                (no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; symbols)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 9888      0.6139  libimf.so                rco2.24pe                exp.L
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 6341      0.3937  rco2.24pe                rco2.24pe                snap_
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-10205/attachment">attachment</a>
</ul>
