...
?>
<!-- received="Tue Apr 14 09:57:54 2009" -->
<!-- isoreceived="20090414135754" -->
<!-- sent="Tue, 14 Apr 2009 07:57:44 -0600" -->
<!-- isosent="20090414135744" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??" -->
<!-- id="BEB90473-0747-43BF-A1E9-6FA4E77778D7_at_lanl.gov" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="b4f9bf870904140618m2374e36axa580369dc61ea5ef_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-04-14 09:57:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8897.php">Prentice Bisbal: "Re: [OMPI users] PGI Fortran pthread support"</a>
<li><strong>Previous message:</strong> <a href="8895.php">Eugene Loh: "Re: [OMPI users] Problem with running openMPI program"</a>
<li><strong>In reply to:</strong> <a href="8894.php">Geoffroy Pignot: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8975.php">Geoffroy Pignot: "Re: [OMPI users] 1.3.1 -rf rankfile behaviour ??"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Clearly a bug exists in the program. I'll try to take a look at it (if  
<br>
Lenny doesn't get to it first), but it won't be until later in the week.
<br>
<p>On Apr 14, 2009, at 7:18 AM, Geoffroy Pignot wrote:
<br>
<p><span class="quotelev1">&gt; I agree with you Ralph , and that 's what I expect from openmpi but  
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-8896/attachment">attachment</a>
</ul>
