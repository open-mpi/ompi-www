...
?>
<!-- received="Fri Apr 10 12:24:25 2009" -->
<!-- isoreceived="20090410162425" -->
<!-- sent="Fri, 10 Apr 2009 12:24:18 -0400" -->
<!-- isosent="20090410162418" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] shared libraries issue compiling 1.3.1/intel10.1.022" -->
<!-- id="9B29F7DF-D4B8-4F85-9E21-F409BAF5975C_at_cisco.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2009-04-10 12:24:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8862.php">Francesco Pietra: "[OMPI users] Fwd: shared libraries issue compiling 1.3.1/intel 10.1.022"</a>
<li><strong>Previous message:</strong> <a href="8860.php">Francesco Pietra: "Re: [OMPI users] shared libraries issue compiling 1.3.1/intel 10.1.022"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8882.php">Francesco Pietra: "Re: [OMPI users] shared libraries issue compiling 1.3.1/intel10.1.022"</a>
<li><strong>Reply:</strong> <a href="8882.php">Francesco Pietra: "Re: [OMPI users] shared libraries issue compiling 1.3.1/intel10.1.022"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
See this FAQ entry:
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="http://www.open-mpi.org/faq/?category=running#intel-compilers">http://www.open-mpi.org/faq/?category=running#intel-compilers</a>- 
<br>
static
<br>
<p><p><p>On Apr 10, 2009, at 12:16 PM, Francesco Pietra wrote:
<br>
...
<span class="quotelev1">&gt; /usr/local/bin/mpirun -host -n 4 connectivity_c 2&gt;&amp;1 | tee  
</span><br>
<span class="quotelev1">&gt; connectivity.out
</span><br>
...
<span class="quotelev1">&gt; export TESTsander=/usr/local/amber10/exe/sander.MPI; make  
</span><br>
<span class="quotelev1">&gt; test.sander.BASIC
</span><br>
...
<span class="quotelev1">&gt; /opt/intel/mkl/10.1.2.024/lib/em64t:/opt/intel/cce/10.1..022/lib:/ 
</span><br>
<span class="quotelev1">&gt; opt/intel/fce/10.1.022/lib:/usr/local/lib
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Thu, Apr 9, 2009 at 9:29 PM, Gus Correa &lt;gus_at_[hidden]&gt;  
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; As failure to find &quot;limits.h&quot; in my attempted compilations of  
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; &quot;mak install&quot; gave no error signals. However, the compilation  
</span><br>
...
<span class="quotelev2">&gt; &gt; (.bashrc or .cshrc), to setup the Intel environment variables  
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; /opt/intel/mkl/10.1.2.024/lib/em64t:/opt/intel/mkl/10.1.2.024/lib/ 
</span><br>
<span class="quotelev1">&gt; em64t:/opt/intel/cce/10.1.022/lib:/opt/intel/fce/10.1.022/lib
</span><br>
...
<span class="quotelev2">&gt; &gt; You man have sourced twice the mkl shell that sets up the MKL  
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; I surely miss to understand something fundamental. Hope other  
</span><br>
...
<span class="quotelev2">&gt; &gt; I think it is just a matter of setting the Intel environment  
</span><br>
