...
?>
<!-- received="Tue Apr 28 17:30:35 2009" -->
<!-- isoreceived="20090428213035" -->
<!-- sent="Tue, 28 Apr 2009 15:30:19 -0600" -->
<!-- isosent="20090428213019" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file" -->
<!-- id="0D8A83C1-5EE3-43DC-9579-EF9DF788ECF5_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="63448C3A-3B63-44AC-9137-D6E86B332877_at_dur.ac.uk" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-04-28 17:30:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9136.php">Hugh Dickinson: "Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file"</a>
<li><strong>Previous message:</strong> <a href="9134.php">Gus Correa: "Re: [OMPI users] Problem with running openMPI program"</a>
<li><strong>In reply to:</strong> <a href="9133.php">Hugh Dickinson: "Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9136.php">Hugh Dickinson: "Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file"</a>
<li><strong>Reply:</strong> <a href="9136.php">Hugh Dickinson: "Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>1. add the following to your default mca parameter file:  btl =  
<br>
...
<br>
<p>2. add OMPI_MCA_btl=tcp,sm,self to the environment in your .cshrc (or  
<br>
equivalent) file
<br>
<p>Next, have you looked at the following FAQ:
<br>
<p><a href="http://www.open-mpi.org/faq/?category=running#missing-prereqs">http://www.open-mpi.org/faq/?category=running#missing-prereqs</a>
<br>
<p>Are those things all okay? Have you tried providing a complete  
<br>
absolute path when running mpirun (e.g., using /usr/local/openmpi/bin/ 
<br>
mpirun instead of just mpirun on the cmd line)?
<br>
<p>Another thing to try: add --debug-devel to the cmd line and send us  
<br>
the (probably verbose) output.
<br>
<p><p>On Apr 28, 2009, at 3:19 PM, Hugh Dickinson wrote:
<br>
<p><span class="quotelev1">&gt; Hi,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Yes I'm using ethernet connections. Doing as you suggest removes the  
</span><br>
<span class="quotelev1">&gt; errors generated by running the small test program, but still  
</span><br>
<span class="quotelev1">&gt; doesn't allow programs (including the small test program) to execute  
</span><br>
<span class="quotelev1">&gt; on any node other than the one launching mpirun. If I try to do  
</span><br>
<span class="quotelev1">&gt; that, the command hangs until I interrupt it, whereupon it gives the  
</span><br>
<span class="quotelev1">&gt; same timeout errors. It seems that there must be some problem with  
</span><br>
<span class="quotelev1">&gt; the setup of my Open MPI installation. Do you agree, and do you have  
</span><br>
<span class="quotelev1">&gt; any idea what it is? Also, is there a global settings file so I can  
</span><br>
<span class="quotelev1">&gt; instruct Open MPI to always only try ethernet?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On 28 Apr 2009, at 20:12, Ralph Castain wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; In this instance, OMPI is complaining that you are attempting to  
</span><br>
<span class="quotelev2">&gt;&gt; use Infiniband, but no suitable devices are found.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I assume you have Ethernet between your nodes? Can you run this  
</span><br>
<span class="quotelev2">&gt;&gt; with the following added to your mpirun cmd line:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; That will cause OMPI to ignore the Infiniband subsystem and attempt  
</span><br>
<span class="quotelev2">&gt;&gt; to run via TCP over any available Ethernet.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; On Tue, Apr 28, 2009 at 12:16 PM, Hugh Dickinson &lt;h.j.dickinson_at_[hidden] 
</span><br>
<span class="quotelev3">&gt;&gt; &gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Many thanks for your help nonetheless.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On 28 Apr 2009, at 17:23, jody wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; I'm sorry, but i must admit that i have never encountered these  
</span><br>
...
<span class="quotelev2">&gt;&gt; Almost none of these mpirun commands work. The only working case is  
</span><br>
<span class="quotelev2">&gt;&gt; if
</span><br>
<span class="quotelev2">&gt;&gt; nodenameX is the node from which you are running the command. I  
</span><br>
<span class="quotelev2">&gt;&gt; don't know
</span><br>
<span class="quotelev2">&gt;&gt; if this gives you extra diagnostic information, but if I explicitly  
</span><br>
<span class="quotelev2">&gt;&gt; set the
</span><br>
<span class="quotelev2">&gt;&gt; wrong prefix (using --prefix), then I get errors from all the nodes  
</span><br>
<span class="quotelev2">&gt;&gt; telling
</span><br>
<span class="quotelev2">&gt;&gt; me the daemon would not start. I don't get these errors normally.  
</span><br>
<span class="quotelev2">&gt;&gt; It seems
</span><br>
<span class="quotelev2">&gt;&gt; to me that the communication is working okay, at least in the  
</span><br>
<span class="quotelev2">&gt;&gt; outwards
</span><br>
<span class="quotelev2">&gt;&gt; direction (and from all nodes). Could this be a problem with  
</span><br>
<span class="quotelev2">&gt;&gt; forwarding of
</span><br>
<span class="quotelev2">&gt;&gt; standard output? If I were to try a simple hello world program, is  
</span><br>
<span class="quotelev2">&gt;&gt; this more
</span><br>
...
<span class="quotelev2">&gt;&gt; You're right, there is no initialization command (like lamboot)  you
</span><br>
<span class="quotelev2">&gt;&gt; have to call.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I don't really know why your sewtup doesn't work, so i'm making some
</span><br>
<span class="quotelev2">&gt;&gt; more &quot;blind shots&quot;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; can you do passwordless ssh from between any two of your nodes?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; does
</span><br>
<span class="quotelev2">&gt;&gt;  mpirun -np 1 --host nodenameX uptime
</span><br>
<span class="quotelev2">&gt;&gt; work for every X when called from any of your nodes?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Have you tried
</span><br>
<span class="quotelev2">&gt;&gt;  mpirun -np 2 --host nodename1,nodename2  uptime
</span><br>
<span class="quotelev2">&gt;&gt; (i.e. not using the host file)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Jody
...
<span class="quotelev2">&gt;&gt; On Tue, Apr 28, 2009 at 4:37 PM, Hugh Dickinson
</span><br>
<span class="quotelev2">&gt;&gt; &lt;h.j.dickinson_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; attaching the output of ompi_info --all as I've seen it's suggested  
</span><br>
...
<span class="quotelev2">&gt;&gt; I've tried to set up Open MPI to use SSH to communicate between nodes
</span><br>
<span class="quotelev2">&gt;&gt; on
</span><br>
<span class="quotelev2">&gt;&gt; a
</span><br>
<span class="quotelev2">&gt;&gt; heterogeneous cluster. I've set up passwordless SSH and it seems to
</span><br>
...
<span class="quotelev2">&gt;&gt; I then tried running a non-MPI program on all the nodes at the same
</span><br>
...
<span class="quotelev2">&gt;&gt; Where hostfile is a list of the 10 cluster node names with slots=1
</span><br>
...
<span class="quotelev2">&gt;&gt; [gamma2.phyastcl.dur.ac.uk:18124] [0,0,0] ORTE_ERROR_LOG: Timeout in
</span><br>
...
<span class="quotelev2">&gt;&gt; If, instead of using the hostfile, I specify on the command line the
</span><br>
...
<span class="quotelev2">&gt;&gt; I need to tell Open MPI it should be using SSH to communicate? If so,
</span><br>
<span class="quotelev2">&gt;&gt; how
</span><br>
<span class="quotelev2">&gt;&gt; do
</span><br>
<span class="quotelev2">&gt;&gt; I do this? To be honest I think it's trying to do so, because before
</span><br>
...
<span class="quotelev2">&gt;&gt; I'm running Open MPI 1.2.5 installed with Scientific Linux 5.2. Let
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9135/attachment">attachment</a>
</ul>
