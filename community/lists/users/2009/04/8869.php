...
?>
<!-- received="Fri Apr 10 17:30:25 2009" -->
<!-- isoreceived="20090410213025" -->
<!-- sent="Fri, 10 Apr 2009 14:30:20 -0700" -->
<!-- isosent="20090410213020" -->
<!-- name="Steve Kargl" -->
<!-- email="sgk_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Factor of 10 loss in performance with 1.3.x" -->
<!-- id="20090410213020.GA49311_at_troutmask.apl.washington.edu" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2009-04-10 17:30:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8870.php">Steve Kargl: "Re: [OMPI users] Factor of 10 loss in performance with 1.3.x"</a>
<li><strong>Previous message:</strong> <a href="8868.php">Jeff Squyres: "Re: [OMPI users] Factor of 10 loss in performance with 1.3.x"</a>
<li><strong>In reply to:</strong> <a href="8868.php">Jeff Squyres: "Re: [OMPI users] Factor of 10 loss in performance with 1.3.x"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8872.php">Jeff Squyres: "Re: [OMPI users] Factor of 10 loss in performance with 1.3.x"</a>
<li><strong>Reply:</strong> <a href="8872.php">Jeff Squyres: "Re: [OMPI users] Factor of 10 loss in performance with 1.3.x"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Thanks for looking into this issue.  As a side note, FreeBSD 7.1
<br>
