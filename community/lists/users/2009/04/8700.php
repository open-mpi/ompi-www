...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="8701.php">Jerome BENOIT: "Re: [OMPI users] Beginner's question: how to avoid a running mpi job hang if host or network failed or orted deamon killed?"</a>
<li><strong>Previous message:</strong> <a href="8699.php">Guanyinzhu: "[OMPI users] Beginner's question: how to avoid a running mpi job hang if host or network failed or orted deamon killed?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="8707.php">Ralph Castain: "Re: [OMPI users] Strange Net problem"</a>
<li><strong>Reply:</strong> <a href="8707.php">Ralph Castain: "Re: [OMPI users] Strange Net problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
