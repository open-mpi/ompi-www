...
?>
<!-- received="Thu Apr 23 07:59:24 2009" -->
<!-- isoreceived="20090423115924" -->
<!-- sent="Thu, 23 Apr 2009 04:59:20 -0700 (PDT)" -->
<!-- isosent="20090423115920" -->
<!-- name="shan axida" -->
<!-- email="axida2009_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_Bcast from OpenMPI" -->
<!-- id="361304.33087.qm_at_web62007.mail.re1.yahoo.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2009-04-23 07:59:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9063.php">Ankush Kaul: "Re: [OMPI users] Problem with running openMPI program"</a>
<li><strong>Previous message:</strong> <a href="9061.php">Jeff Squyres: "Re: [OMPI users] Problem with running openMPI program"</a>
<li><strong>In reply to:</strong> <a href="9059.php">Jeff Squyres: "Re: [OMPI users] MPI_Bcast from OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9065.php">shan axida: "Re: [OMPI users] MPI_Bcast from OpenMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9062/attachment">attachment</a>
</ul>
