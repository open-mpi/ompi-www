...
?>
<!-- received="Tue Apr 28 18:54:33 2009" -->
<!-- isoreceived="20090428225433" -->
<!-- sent="Tue, 28 Apr 2009 23:57:32 +0100" -->
<!-- isosent="20090428225732" -->
<!-- name="Hugh Dickinson" -->
<!-- email="h.j.dickinson_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file" -->
<!-- id="7BDCBB71-2B98-4128-A642-02B0A5207886_at_dur.ac.uk" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="0D8A83C1-5EE3-43DC-9579-EF9DF788ECF5_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-04-28 18:57:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="9137.php">Ralph Castain: "Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file"</a>
<li><strong>Previous message:</strong> <a href="9135.php">Ralph Castain: "Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file"</a>
<li><strong>In reply to:</strong> <a href="9135.php">Ralph Castain: "Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="9137.php">Ralph Castain: "Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file"</a>
<li><strong>Reply:</strong> <a href="9137.php">Ralph Castain: "Re: [OMPI users] ORTE_ERROR_LOG: Timeout in file"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>[gamma2.censored_domain:22554] pls:rsh: local csh: 0, local sh: 1
<br>
...
<br>
<p>If so is there a way to make it use bash?
<br>
<p>Cheers,
<br>
<p>Hugh
<br>
<p>On 28 Apr 2009, at 22:30, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; Okay, that's one small step forward. You can lock that in by setting  
</span><br>
<span class="quotelev1">&gt; the appropriate MCA parameter in one of two ways:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; 1. add the following to your default mca parameter file:  btl =  
</span><br>
<span class="quotelev1">&gt; tcp,sm,self (I added the shared memory subsystem as this will help  
</span><br>
<span class="quotelev1">&gt; with performance). You can see how to do this here:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; 2. add OMPI_MCA_btl=tcp,sm,self to the environment in your .cshrc  
</span><br>
<span class="quotelev1">&gt; (or equivalent) file
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Next, have you looked at the following FAQ:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/faq/?category=running#missing-prereqs">http://www.open-mpi.org/faq/?category=running#missing-prereqs</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Are those things all okay? Have you tried providing a complete  
</span><br>
<span class="quotelev1">&gt; absolute path when running mpirun (e.g., using /usr/local/openmpi/ 
</span><br>
<span class="quotelev1">&gt; bin/mpirun instead of just mpirun on the cmd line)?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Another thing to try: add --debug-devel to the cmd line and send us  
</span><br>
<span class="quotelev1">&gt; the (probably verbose) output.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Apr 28, 2009, at 3:19 PM, Hugh Dickinson wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Yes I'm using ethernet connections. Doing as you suggest removes  
</span><br>
<span class="quotelev2">&gt;&gt; the errors generated by running the small test program, but still  
</span><br>
<span class="quotelev2">&gt;&gt; doesn't allow programs (including the small test program) to  
</span><br>
<span class="quotelev2">&gt;&gt; execute on any node other than the one launching mpirun. If I try  
</span><br>
<span class="quotelev2">&gt;&gt; to do that, the command hangs until I interrupt it, whereupon it  
</span><br>
<span class="quotelev2">&gt;&gt; gives the same timeout errors. It seems that there must be some  
</span><br>
<span class="quotelev2">&gt;&gt; problem with the setup of my Open MPI installation. Do you agree,  
</span><br>
<span class="quotelev2">&gt;&gt; and do you have any idea what it is? Also, is there a global  
</span><br>
<span class="quotelev2">&gt;&gt; settings file so I can instruct Open MPI to always only try ethernet?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On 28 Apr 2009, at 20:12, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; In this instance, OMPI is complaining that you are attempting to  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; use Infiniband, but no suitable devices are found.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I assume you have Ethernet between your nodes? Can you run this  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; with the following added to your mpirun cmd line:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -mca btl tcp,self
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; That will cause OMPI to ignore the Infiniband subsystem and  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; attempt to run via TCP over any available Ethernet.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, Apr 28, 2009 at 12:16 PM, Hugh Dickinson &lt;h.j.dickinson_at_[hidden] 
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Many thanks for your help nonetheless.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 28 Apr 2009, at 17:23, jody wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I'm sorry, but i must admit that i have never encountered these  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; messages,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and i don't know what their cause exactly is.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Perhaps one of the developers can give an explanation?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, Apr 28, 2009 at 5:52 PM, Hugh Dickinson
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; It didn't work over all the nodes, again same problem - the system  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; However, as before the program does work in this special case, and  
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; The node names are exactly the same. I wanted to avoid updating the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; version
</span><br>
<span class="quotelev3">&gt;&gt;&gt; because I'm not the system administrator, and it could take some  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; time
</span><br>
<span class="quotelev3">&gt;&gt;&gt; before
</span><br>
<span class="quotelev3">&gt;&gt;&gt; it gets done. If it's likely to fix the problem though I'll try  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; it. I'm
</span><br>
<span class="quotelev3">&gt;&gt;&gt; assuming that I don't have to do something analogous to the old
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;lamboot&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; command to initialise Open MPI on all the nodes. I've seen no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; documentation
</span><br>
<span class="quotelev3">&gt;&gt;&gt; anywhere that says I should.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Cheers,
...
<span class="quotelev3">&gt;&gt;&gt; On 28 Apr 2009, at 15:28, jody wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hi Hugh
...
<span class="quotelev3">&gt;&gt;&gt; was incorrect to describe the cluster as heterogeneous. In fact, all
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; nodes run the same operating system (Scientific Linux 5.2), it's  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; only
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; hardware that's different and even then they're all i386 or i686.  
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9136/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9136/debug_output">debug_output</a>
</ul>
<!-- attachment="debug_output" -->
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-9136/03-attachment">attachment</a>
</ul>
