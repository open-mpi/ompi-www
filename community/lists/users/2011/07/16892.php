...
?>
<!-- received="Mon Jul 11 14:18:22 2011" -->
<!-- isoreceived="20110711181822" -->
<!-- sent="Mon, 11 Jul 2011 13:18:14 -0500" -->
<!-- isosent="20110711181814" -->
<!-- name="Mohan, Ashwin" -->
<!-- email="ashmohan_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Error using hostfile" -->
<!-- id="C47F8344CE6D9B459A06E351D9CF25C904227ABB_at_POSTOFFICE.seas.wustl.edu" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-07-11 14:18:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16893.php">Denis: "[OMPI users] icc erroring when trying to use a directory as a source file (Catastrophic error: cannot open source file &quot;paddress.c&quot;: is a directory )"</a>
<li><strong>Previous message:</strong> <a href="16891.php">yanyg_at_[hidden]: "Re: [OMPI users] Error-Open MPI over Infiniband: polling LP CQ with status LOCAL LENGTH ERROR"</a>
<li><strong>In reply to:</strong> <a href="16865.php">Ralph Castain: "Re: [OMPI users] Error using hostfile"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16844.php">Reuti: "Re: [OMPI users] Error using hostfile"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Thank you Ralph. I was able to ssh back and forth between nodes. It also
<br>
seemed that the environment variables were all set fine. Turning the
<br>
firewall down seems to make this work just fine. 
<br>
<p>&nbsp;
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16892/attachment">attachment</a>
</ul>
