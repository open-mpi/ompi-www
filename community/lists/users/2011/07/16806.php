...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16807.php">hi: "[OMPI users] Windows: msv*.dll files presence in Release build"</a>
<li><strong>Previous message:</strong> <a href="16805.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Open-MPI maffinity policy"</a>
<li><strong>In reply to:</strong> <a href="16805.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Open-MPI maffinity policy"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16847.php">Jeff Squyres: "Re: [OMPI users] Open-MPI maffinity policy"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16806/attachment">attachment</a>
</ul>
