...
?>
<!-- received="Fri Jul  1 17:13:39 2011" -->
<!-- isoreceived="20110701211339" -->
<!-- sent="Fri, 1 Jul 2011 16:13:29 -0500" -->
<!-- isosent="20110701211329" -->
<!-- name="Rob Latham" -->
<!-- email="robl_at_[hidden]" -->
<!-- subject="Re: [OMPI users] File seeking with shared filepointer issues" -->
<!-- id="20110701211329.GE26363_at_mcs.anl.gov" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-07-01 17:13:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16803.php">Christian Anonymous: "Re: [OMPI users] File seeking with shared filepointer issues"</a>
<li><strong>Previous message:</strong> <a href="16801.php">Rob Latham: "Re: [OMPI users] File seeking with shared filepointer issues"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/06/16762.php">Jeff Squyres: "Re: [OMPI users] File seeking with shared filepointer issues"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/06/16780.php">Christian Anonymous: "Re: [OMPI users] File seeking with shared filepointer issues"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; Rob -- can you comment on this, perchance?  Is this a bug in ROMIO, or if not, how is one supposed to use this interface can get consistent answers in all MPI processes?
</span><br>
<p>Maybe the problem here is that shared file pointers were intended for
<br>
things like reading from a work queue or writing to a log file.
<br>
<p>Determining the file size or the position of the file pointer is a
<br>
...
collective)
<br>
<p>When writing a log file or reading from a work queue the exact value
<br>
of the shared file pointer is actually irrelevant.  The program just
<br>
wants &quot;the next&quot; item, or &quot;the last&quot; item. 
<br>
<p>The more robust way to do this file size determination, if that's
<br>
