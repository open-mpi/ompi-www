...
?>
<!-- received="Fri Jul 15 09:31:21 2011" -->
<!-- isoreceived="20110715133121" -->
<!-- sent="Fri, 15 Jul 2011 09:31:15 -0400" -->
<!-- isosent="20110715133115" -->
<!-- name="Jeffrey A Cummings" -->
<!-- email="Jeffrey.A.Cummings_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Urgent Question regarding, MPI_ANY_SOURCE." -->
<!-- id="OFDC7CFE44.1F997EF9-ON852578CE.004A0252-852578CE.004A45BE_at_notes.aero.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="EEC54EBC-E8D7-4526-BF3C-C11721A7B7D4_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-07-15 09:31:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16938.php">Jeff Squyres: "Re: [OMPI users] Mixed Mellanox and Qlogic problems"</a>
<li><strong>Previous message:</strong> <a href="16936.php">Jeff Squyres: "Re: [OMPI users] Urgent Question regarding, MPI_ANY_SOURCE."</a>
<li><strong>In reply to:</strong> <a href="16936.php">Jeff Squyres: "Re: [OMPI users] Urgent Question regarding, MPI_ANY_SOURCE."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16939.php">Mudassar Majeed: "Re: [OMPI users] Urgent Question regarding, MPI_ANY_SOURCE."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><span class="quotelev3">&gt;&gt; &gt; (even not targetted for it)&quot; is incorrect.
</span><br>
<p><p>When process A calls MPI_SEND to send to process B, then the message is 
<br>
...
<br>
<p><span class="quotelev1">&gt; Well MPI_Recv does give you the message that was sent specifically to 
</span><br>
...
<span class="quotelev3">&gt;&gt; &gt; receive a load value from a sender that it does not know. On the 
</span><br>
other 
<br>
...
<span class="quotelev3">&gt;&gt; &gt; *Subject:* Re: [OMPI users] Urgent Question regarding, 
</span><br>
MPI_ANY_SOURCE.
<br>
<span class="quotelev3">&gt;&gt; &gt;
...
<p><span class="quotelev3">&gt;&gt; &gt; (even not targetted for it).
</span><br>
<span class="quotelev4">&gt;&gt; &gt; &gt;
</span><br>
...
<span class="quotelev3">&gt;&gt; &gt; help me. Suppose a process A sends a message to process B. The 
</span><br>
process 
<br>
<span class="quotelev3">&gt;&gt; &gt; B will receive the message with MPI_Recv with MPI_ANY_SOURCE in the 
</span><br>
<span class="quotelev3">&gt;&gt; &gt; source argument. Let say process B does not know that A is the 
</span><br>
sender. 
<br>
<span class="quotelev3">&gt;&gt; &gt; But I want B to receive message from process A (the one who actually 
</span><br>
<span class="quotelev3">&gt;&gt; &gt; sends the message to process B). But if I use MPI_ANY_SOURCE, then 
</span><br>
any 
<br>
...
<p><span class="quotelev3">&gt;&gt; &gt; use A in the source argument as B does not know about the sender. 
</span><br>
What 
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16937/attachment">attachment</a>
</ul>
