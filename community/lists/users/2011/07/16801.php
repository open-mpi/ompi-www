...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16802.php">Rob Latham: "Re: [OMPI users] File seeking with shared filepointer issues"</a>
<li><strong>Previous message:</strong> <a href="16800.php">christophe petit: "[OMPI users] need help for a mpi 2d heat equation solving code"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16802.php">Rob Latham: "Re: [OMPI users] File seeking with shared filepointer issues"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
