...
?>
<!-- received="Tue Jul 26 15:40:06 2011" -->
<!-- isoreceived="20110726194006" -->
<!-- sent="Tue, 26 Jul 2011 21:39:52 +0200" -->
<!-- isosent="20110726193952" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Can run OpenMPI testcode on 86 or fewer slots in	cluster, but nothing more than that" -->
<!-- id="6470E688-C479-4D5C-9EE1-5BF51C88867B_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-07-26 15:39:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16984.php">Ralph Castain: "Re: [OMPI users] Can run OpenMPI testcode on 86 or fewer slots in	cluster, but nothing more than that"</a>
<li><strong>Previous message:</strong> <a href="16982.php">Lane, William: "Re: [OMPI users] Can run OpenMPI testcode on 86 or fewer slots in	cluster, but nothing more than that"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16985.php">Ralph Castain: "Re: [OMPI users] Can run OpenMPI testcode on 86 or fewer slots in	cluster, but nothing more than that"</a>
<li><strong>Reply:</strong> <a href="16985.php">Ralph Castain: "Re: [OMPI users] Can run OpenMPI testcode on 86 or fewer slots in	cluster, but nothing more than that"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Am 26.07.2011 um 21:19 schrieb Lane, William:
<br>
<p><span class="quotelev1">&gt; I can successfully run the MPI testcode via OpenMPI 1.3.3 on less than 87 slots w/both the btl_tcp_if_exclude and btl_tcp_if_include switches
</span><br>
...
<p>did you setup a JSV for it, as PE have no sequence numbers in case a PE is requested?
<br>
<p><p><span class="quotelev1">&gt; Here's the PE that I'm using:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<p>These both above can be set to NONE when you compiled Open MPI with SGE integration --with-sge
<br>
<p>NB: what is defined in rsh_daemon/rsh_command in `qconf -sconf`?
<br>
<p><p><span class="quotelev1">&gt; allocation_rule    $fill_up
</span><br>
<p>Here you specify to fill one machine after the other completely before gathering slots from the next machine. You can change this to $round_robin to get one slot form each node before taking a second from particular machines. If you prefer a fixed allocation, you could also put an integer here.
<br>
...
<span class="quotelev1">&gt; Wouldn't the -bynode allocation be really inefficient? Does the -bynode switch imply only one slot is used on each node before it moves on to the next?
</span><br>
<p>Do I get it right: inside the granted slots by SGE you want the allocation inside Open MPI to follow a specific pattern, i.e.: which rank is where?
<br>
<p>-- Reuti
<br>
