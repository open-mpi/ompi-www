...
?>
<!-- received="Sun Feb 13 00:42:59 2011" -->
<!-- isoreceived="20110213054259" -->
<!-- sent="Sun, 13 Feb 2011 00:42:42 -0500" -->
<!-- isosent="20110213054242" -->
<!-- name="Gustavo Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="E9D243C2-9901-4D71-BE81-B91C107C3C79_at_ldeo.columbia.edu" -->
...
<strong>Date:</strong> 2011-02-13 00:42:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15587.php">Nguyen Toan: "Re: [OMPI users] Unknown overhead in &quot;mpirun -am ft-enable-cr&quot;"</a>
<li><strong>Previous message:</strong> <a href="15585.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15589.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15589.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15592.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Tena
<br>
<p>Thank you for taking the time to explain the details of
<br>
the EC2 procedure.
<br>
<p>I am afraid everything in my bag of tricks was used.
<br>
As Ralph and Jeff suggested, this seems to be a very specific
<br>
problem with EC2.
<br>
<p>The difference in behavior when you run as root vs. when you
<br>
...
<br>
<p>Besides Ralph suggestion of trying the EC2 mailing list archive,
<br>
...
<br>
and the very peculiar fact that the program fails for normal users but runs for root.
<br>
This should help the EC2 support to start looking for a solution.
<br>
<p>I am running out of suggestions of what you could try on your own.
<br>
But let me try:
<br>
<p>1) You may try to reduce the problem to its less common denominator,
<br>
...
<br>
<p>I don't know if this suggestion may  really help, though.
<br>
It is not clear to me where the thing fails, whether it is during program execution,
<br>
or while mpiexec is setting up the environment for the program to run.
<br>
If it is very early in the process, before the program starts, my suggestion won't work.
<br>
Jeff and Ralph, who know OpenMPI inside out, may have better advice in this regard. 
<br>
<p>2) Another thing would be to try to run R on E2C in serial mode, without mpiexec, 
<br>
interactively or via script, to see who EC2 doesn't like: R or OpenMPI (but maybe it's both).
<br>
<p>Gus Correa
<br>
<p>On Feb 11, 2011, at 9:54 PM, Tena Sakai wrote:
<br>
