...
?>
<!-- received="Fri Feb 11 18:51:53 2011" -->
<!-- isoreceived="20110211235153" -->
<!-- sent="Fri, 11 Feb 2011 15:17:58 -0800" -->
<!-- isosent="20110211231758" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="2134EB70-3A76-447A-80EB-ADBF7CD5A8C1_at_cisco.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="4D557AE4.3030100_at_ldeo.columbia.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-02-11 18:17:58
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15578.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Previous message:</strong> <a href="15576.php">Dennis McRitchie: "Re: [OMPI users] Totalview not showing main program on startup with OpenMPI 1.3.x and 1.4.x"</a>
<li><strong>In reply to:</strong> <a href="15575.php">Gus Correa: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15578.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15578.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Feb 11, 2011, at 10:08 AM, &quot;Gus Correa&quot; &lt;gus_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev3">&gt;&gt;&gt;   Warning: Identity file tsakai not accessible: No such file or directory.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;   lrwxrwxrwx 1 root root      15 Feb  8 23:06 libmpi.so -&gt; libmpi.so.0.0.2
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Your prior mails were about ssh issues, but this one sounds like you might
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; have firewall issues.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; That is, the &quot;orted&quot; command attempts to open a TCP socket back to mpirun for
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; various command and control reasons.  If it is blocked from doing so by a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; firewall, Open MPI won't run.  In general, you can either disable your
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; firewall or you can setup a trust relationship for TCP connections within
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; okay. Sometimes the protection of the home directory must be adjusted too,
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; No. It's convenient inside a private cluster as it won't fill each users'
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; known_hosts file and you don't need to create any ssh-keys. But when the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; hostname changes every time it might also create new hostkeys. It uses
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; hostkeys (private and public), this way it works for all users. Just for
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; your local machine is Linux like, but the execution hosts are Macs? I saw
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; it's necessary to specify exactly this name. When the settings are the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Is this a private cluster (or at least private interfaces)? It would also
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; be
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; an option to use hostbased authentication, which will avoid setting any
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Does someone have an example .ssh/config file I can look at?  There are
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; so
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; many keyword-argument paris for this config file and I would like to
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  -H vixen.egcrc.org   -np 1 Rscript
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; /Users/tsakai/Notes/R/parallel/Rmpi/local/fib.R 5
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  -H vixen.egcrc.org   -np 1 Rscript
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; /Users/tsakai/Notes/R/parallel/Rmpi/local/fib.R 6
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  -H blitzen.egcrc.org -np 1 Rscript
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; /Users/tsakai/Notes/R/parallel/Rmpi/local/fib.R 7
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  -H blitzen.egcrc.org -np 1 Rscript
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; /Users/tsakai/Notes/R/parallel/Rmpi/local/fib.R 8
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Here&#194;&#185;s the program fib.R:
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; It reads an argument from command line and produces a fibonacci number
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; corresponds to that index, followed by the machine name.  Pretty simple
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; stuff.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Here&#194;&#185;s the run output:
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Now I want to run the same thing on cloud.  I launch 2 instances of the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; same
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; virtual machine, to which I get to by:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [tsakai_at_vixen local]$ ssh &#194;&#173;A I ~/.ssh/tsakai
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; machine-instance-A-public-dns
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [tsakai_at_domU-12-31-39-00-D1-F2 ~]$ # and I can go to machine B
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [tsakai_at_domU-12-31-39-00-D1-F2 ~]$ ssh -i .ssh/tsakai
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [tsakai_at_domU-12-31-39-0C-C8-01 ~]$ # now show I can get to machine A
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; without using password
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [tsakai_at_domU-12-31-39-0C-C8-01 ~]$
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [tsakai_at_domU-12-31-39-0C-C8-01 ~]$ ssh -i .ssh/tsakai
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; domU-12-31-39-00-D1-F2
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  The authenticity of host 'domu-12-31-39-00-d1-f2 (10.254.214.4)'
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; can't
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; be established.
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  Warning: Permanently added 'domu-12-31-39-00-d1-f2' (RSA) to the list
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; As you can see, neither machine uses password for authentication; it
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; uses
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; public/private key pairs.  There is no problem (that I can see) for ssh
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; invocation
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; from one machine to the other.  This is so because I have a copy of
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Here&#194;&#185;s what happens with mpirun:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Mpirun (or somebody else?) asks me password, which I don&#194;&#185;t have.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I end up typing control-C.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Here&#194;&#185;s my question:
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &lt;session4Reuti.text&gt;_______________________________________________
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; users mailing list
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; users_at_[hidden]
