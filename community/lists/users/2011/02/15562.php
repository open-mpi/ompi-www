...
?>
<!-- received="Thu Feb 10 16:05:38 2011" -->
<!-- isoreceived="20110210210538" -->
<!-- sent="Thu, 10 Feb 2011 13:05:41 -0800" -->
<!-- isosent="20110210210541" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="4E906CAE-404B-4107-A1FD-28F21472D84D_at_cisco.com" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="C9799131.E47A%tsakai_at_gallo.ucsf.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-02-10 16:05:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15563.php">Reuti: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Previous message:</strong> <a href="15561.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>In reply to:</strong> <a href="15561.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15564.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15564.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Your prior mails were about ssh issues, but this one sounds like you might have firewall issues.
<br>
<p>That is, the &quot;orted&quot; command attempts to open a TCP socket back to mpirun for various command and control reasons.  If it is blocked from doing so by a firewall, Open MPI won't run.  In general, you can either disable your firewall or you can setup a trust relationship for TCP connections within your cluster.
<br>
<p><p><p>On Feb 10, 2011, at 1:03 PM, Tena Sakai wrote:
<br>
...
<span class="quotelev2">&gt;&gt; okay. Sometimes the protection of the home directory must be adjusted too, but
</span><br>
...
<span class="quotelev2">&gt;&gt; In your ~/.ssh/config. Maybe we can see what he's trying to negotiate before
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; it's necessary to specify exactly this name. When the settings are the same
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Is this a private cluster (or at least private interfaces)? It would also be
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;   [tsakai_at_vixen local]$ ssh &#150;A &#150;I ~/.ssh/tsakai
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;   [tsakai_at_domU-12-31-39-00-D1-F2 ~]$ # and I can go to machine B without
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;   The authenticity of host 'domu-12-31-39-00-d1-f2 (10.254.214.4)' can't
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; from one machine to the other.  This is so because I have a copy of public
</span><br>
