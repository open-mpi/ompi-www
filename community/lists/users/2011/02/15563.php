...
?>
<!-- received="Thu Feb 10 16:44:55 2011" -->
<!-- isoreceived="20110210214455" -->
<!-- sent="Thu, 10 Feb 2011 22:44:40 +0100" -->
<!-- isosent="20110210214440" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="C332A56B-083E-4C91-A3AA-2639E380D857_at_staff.uni-marburg.de" -->
...
<strong>Date:</strong> 2011-02-10 16:44:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15564.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Previous message:</strong> <a href="15562.php">Jeff Squyres: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15605.php">Kevin.Buckley_at_[hidden]: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Am 10.02.2011 um 22:03 schrieb Tena Sakai:
<br>
...
<p>yes. I hoped to see the point where &quot;Permission denied.&quot; is output, but when I reread your post now, it could mean that this was sloved already.
<br>
<p>I agree with Jeff, that right now it look like a firewall issue.
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev2">&gt;&gt; From mpirun invocation, I see a line:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
