...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15462.php">Jeff Squyres (jsquyres): "Re: [OMPI users] printing text fixes a problem?"</a>
<li><strong>Previous message:</strong> <a href="15460.php">abc def: "[OMPI users] printing text fixes a problem?"</a>
<li><strong>In reply to:</strong> <a href="15460.php">abc def: "[OMPI users] printing text fixes a problem?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15462.php">Jeff Squyres (jsquyres): "Re: [OMPI users] printing text fixes a problem?"</a>
<li><strong>Reply:</strong> <a href="15462.php">Jeff Squyres (jsquyres): "Re: [OMPI users] printing text fixes a problem?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-15461/attachment">attachment</a>
</ul>
