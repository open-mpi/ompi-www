...
?>
<!-- received="Mon Feb 14 07:38:53 2011" -->
<!-- isoreceived="20110214123853" -->
<!-- sent="Mon, 14 Feb 2011 13:38:35 +0100" -->
<!-- isosent="20110214123835" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="3EFDD5E4-86E0-4E9A-A786-9C740ABCE561_at_staff.uni-marburg.de" -->
...
<strong>Date:</strong> 2011-02-14 07:38:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15595.php">Jeff Squyres: "Re: [OMPI users] (no subject)"</a>
<li><strong>Previous message:</strong> <a href="15593.php">Ashley Pittman: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15602.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15602.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Am 14.02.2011 um 04:54 schrieb Tena Sakai:
<br>
<p><span class="quotelev1">&gt; I have digressed and started downward descent...
</span><br>
...
<p>a) can you ssh from dasher to vixen?
<br>
<p>b) firewall on vixen?
<br>
<p>-- Reuti
<br>
...
<span class="quotelev2">&gt;&gt; openMPI setup or with your program, otherwise root would not be able to run
</span><br>
...
<span class="quotelev2">&gt;&gt; and the very peculiar fact that the program fails for normal users but runs
</span><br>
...
<span class="quotelev2">&gt;&gt; perhaps by trying to run non-R based MPI programs on EC2, maybe the hello_c.c,
</span><br>
...
<span class="quotelev2">&gt;&gt; Even simpler would be to run 'hostname' with mpiexec (mpiexec -np 2 hostname).
</span><br>
<span class="quotelev2">&gt;&gt; I.e. go in a progression of increasing complexity, see where you hit the wall.
</span><br>
...
<span class="quotelev2">&gt;&gt; If it is very early in the process, before the program starts, my suggestion
</span><br>
<span class="quotelev2">&gt;&gt; won't work.
</span><br>
<span class="quotelev2">&gt;&gt; Jeff and Ralph, who know OpenMPI inside out, may have better advice in this
</span><br>
...
<span class="quotelev2">&gt;&gt; interactively or via script, to see who EC2 doesn't like: R or OpenMPI (but
</span><br>
