...
?>
<!-- received="Fri Feb 11 20:26:11 2011" -->
<!-- isoreceived="20110212012611" -->
<!-- sent="Fri, 11 Feb 2011 17:25:58 -0800" -->
<!-- isosent="20110212012558" -->
<!-- name="Tena Sakai" -->
<!-- email="tsakai_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="C97B2057.E4DD%tsakai_at_gallo.ucsf.edu" -->
<!-- charset="euc-kr" -->
<!-- inreplyto="2134EB70-3A76-447A-80EB-ADBF7CD5A8C1_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-02-11 20:25:58
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15579.php">Gus Correa: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Previous message:</strong> <a href="15577.php">Jeff Squyres (jsquyres): "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>In reply to:</strong> <a href="15577.php">Jeff Squyres (jsquyres): "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15579.php">Gus Correa: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15579.php">Gus Correa: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I have pretty much ruled out PATH issues by setting tsakai's PATH
<br>
...
cannot.
<br>
<p>I have also checked out permission on /tmp directory.  tsakai has
<br>
no problem creating files under /tmp.
<br>
<p>I am trying to come up with a strategy to show that each and every
<br>
programs in the PATH has &quot;world&quot; executable permission.  It is a
<br>
stone to turn over, but I am not holding my breath.
<br>
<p><span class="quotelev1">&gt; ... you are running out of file descriptors. Are file descriptors
</span><br>
<span class="quotelev1">&gt; limited on a per-process basis, perchance?
</span><br>
<p>I have never heard there is such restriction on Amazon EC2.  There
<br>
...
<br>
<p>Your mentioned file descriptors made me think of something under
<br>
/dev.  But I don't know exactly what I am fishing.  Do you have
<br>
some suggestions?
<br>
<p>I wish I could reproduce this (weired) behavior on a different
<br>
...
<p>Tena
<br>
<p><p>On 2/11/11 3:17 PM, &quot;Jeff Squyres (jsquyres)&quot; &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; It is concerning if the pipe system call fails - I can't think of why that
</span><br>
<span class="quotelev1">&gt; would happen. Thats not usually a permissions issue but rather a deeper
</span><br>
<span class="quotelev1">&gt; indication that something is either seriously wrong on your system or you are
</span><br>
<span class="quotelev1">&gt; running out of file descriptors. Are file descriptors limited on a per-process
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;  mpirun was unable to launch the specified application as it encountered an
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;   Warning: Identity file tsakai not accessible: No such file or directory.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;   lrwxrwxrwx 1 root root      15 Feb  8 23:06 libmpi.so -&gt; libmpi.so.0.0.2
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Your prior mails were about ssh issues, but this one sounds like you might
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; have firewall issues.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; That is, the &quot;orted&quot; command attempts to open a TCP socket back to mpirun
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; firewall or you can setup a trust relationship for TCP connections within
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; okay. Sometimes the protection of the home directory must be adjusted
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; In your ~/.ssh/config. Maybe we can see what he's trying to negotiate
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; your local machine is Linux like, but the execution hosts are Macs? I
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I made a config file in my .ssh directory on the cloud.  It looks
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Is this a private cluster (or at least private interfaces)? It would
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  mpirun was unable to cleanly terminate the daemons on the nodes
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;      domU-12-31-39-07-35-21.compute-1.internal - daemon did not
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Does someone have an example .ssh/config file I can look at?  There
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; are
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; so
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; many keyword-argument paris for this config file and I would like to
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Here&#169;&#246;s the program fib.R:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; It reads an argument from command line and produces a fibonacci
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; number
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; corresponds to that index, followed by the machine name.  Pretty
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Here&#169;&#246;s the run output:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Now I want to run the same thing on cloud.  I launch 2 instances of
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [tsakai_at_domU-12-31-39-00-D1-F2 ~]$ # and I can go to machine B
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  [tsakai_at_domU-12-31-39-0C-C8-01 ~]$ # now show I can get to machine
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; A
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  The authenticity of host 'domu-12-31-39-00-d1-f2 (10.254.214.4)'
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;  Warning: Permanently added 'domu-12-31-39-00-d1-f2' (RSA) to the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; public/private key pairs.  There is no problem (that I can see) for
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Here&#169;&#246;s what happens with mpirun:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Mpirun (or somebody else?) asks me password, which I don&#169;&#246;t have.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I end up typing control-C.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Here&#169;&#246;s my question:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; How can I get past authentication by mpirun where there is no
</span><br>
