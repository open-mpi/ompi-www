...
?>
<!-- received="Mon Feb 14 17:26:28 2011" -->
<!-- isoreceived="20110214222628" -->
<!-- sent="Mon, 14 Feb 2011 17:26:18 -0500" -->
<!-- isosent="20110214222618" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="4D59AC0A.6090706_at_ldeo.columbia.edu" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2011-02-14 17:26:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15609.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Previous message:</strong> <a href="15607.php">Gus Correa: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15597.php">Jeff Squyres: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Tena
<br>
<p>Ashley already answered the main point.
<br>
...
<p>Well, IPtables syntax is kind of unfriendly.
<br>
...
<span class="quotelev1"> &gt; vixen has a normal, or empty config and as such has no firewall,
</span><br>
<span class="quotelev1"> &gt; dasher has a number of firewall rules configured which could easily
</span><br>
<span class="quotelev1"> &gt; be the cause of the problem on these two machines.
</span><br>
<span class="quotelev1"> &gt; To be able to run OpenMPI across these two machines you'll need to
</span><br>
<span class="quotelev1"> &gt; disable the firewall on dasher.
</span><br>
<span class="quotelev1"> &gt;
</span><br>
<span class="quotelev1"> &gt; To disable the firewall the command (as root) is &quot;service iptables off&quot;
</span><br>
<span class="quotelev1"> &gt; to turn it off until next boot or &quot;chkconfig iptables off&quot; to do it 
</span><br>
permanently
<br>
<span class="quotelev1"> &gt; from the next boot, obviously you should check with your network
</span><br>
<span class="quotelev1"> &gt; administrator before doing this.
</span><br>
<span class="quotelev1"> &gt;
</span><br>
...
<p>Ditto.
<br>
<p>But Ashley, I'd guess among other hats, Tena may be wearing a network
<br>
...
<br>
<p>ifconfig should give more info about IPs.
<br>
lspci will tell about existing Ethernet interfaces.
<br>
<p>Public IP with no firewall is kind of risky.
<br>
...
<br>
<p>Is this reminiscent of dashen and vixen?
<br>
...
<br>
<p>If the machines have more than one Ethernet port,
<br>
you can create private IPs on idle Ether ports, connect the machines 
<br>
(even directly with an Ethernet cable, if there are two machines only
<br>
...
<span class="quotelev1">&gt; I have verified that
</span><br>
<span class="quotelev1">&gt;  1) /etc/hosts files on both machines vixen and dasher are identical
</span><br>
<span class="quotelev1">&gt;  2) both machines have nothing but comments in hosts.allow and hosts.deny
</span><br>
<span class="quotelev1">&gt; Regarding firewall, they are different:
</span><br>
<span class="quotelev1">&gt; On vixen this how it looks:
</span><br>
<span class="quotelev1">&gt;   [root_at_vixen ec2]# cat /etc/sysconfig/iptables
</span><br>
<span class="quotelev1">&gt;   cat: /etc/sysconfig/iptables: No such file or directory
</span><br>
<span class="quotelev1">&gt;   [root_at_vixen ec2]#
</span><br>
<span class="quotelev1">&gt;   [root_at_vixen ec2]# /sbin/iptables --list
</span><br>
...
<span class="quotelev1">&gt; On dasher:
</span><br>
<span class="quotelev1">&gt;   [tsakai_at_dasher Rmpi]$ sudo cat /etc/sysconfig/iptables
</span><br>
<span class="quotelev1">&gt;   # Firewall configuration written by system-config-securitylevel
</span><br>
<span class="quotelev1">&gt;   # Manual customization of this file is not recommended.
</span><br>
<span class="quotelev1">&gt;   *filter
</span><br>
<span class="quotelev1">&gt;   :INPUT ACCEPT [0:0]
</span><br>
<span class="quotelev1">&gt;   :FORWARD ACCEPT [0:0]
</span><br>
<span class="quotelev1">&gt;   :OUTPUT ACCEPT [0:0]
</span><br>
<span class="quotelev1">&gt;   :RH-Firewall-1-INPUT - [0:0]
</span><br>
<span class="quotelev1">&gt;   -A INPUT -j RH-Firewall-1-INPUT
</span><br>
<span class="quotelev1">&gt;   -A FORWARD -j RH-Firewall-1-INPUT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -i lo -j ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -p icmp --icmp-type any -j ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -p 50 -j ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -p 51 -j ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -p udp --dport 5353 -d 224.0.0.251 -j ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -p udp -m udp --dport 631 -j ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -p tcp -m tcp --dport 631 -j ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -m state --state ESTABLISHED,RELATED -j ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -m state --state NEW -m tcp -p tcp --dport 22 -j
</span><br>
<span class="quotelev1">&gt; ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -m state --state NEW -m tcp -p tcp --dport 80 -j
</span><br>
<span class="quotelev1">&gt; ACCEPT
</span><br>
<span class="quotelev1">&gt;   -A RH-Firewall-1-INPUT -j REJECT --reject-with icmp-host-prohibited
</span><br>
<span class="quotelev1">&gt;   COMMIT
</span><br>
<span class="quotelev1">&gt;   [tsakai_at_dasher Rmpi]$
</span><br>
<span class="quotelev1">&gt;   [tsakai_at_dasher Rmpi]$ sudo /sbin/iptables --list
</span><br>
<span class="quotelev1">&gt;   [sudo] password for tsakai:
</span><br>
<span class="quotelev1">&gt;   Chain INPUT (policy ACCEPT)
</span><br>
<span class="quotelev1">&gt;   target     prot opt source               destination
</span><br>
<span class="quotelev1">&gt;   RH-Firewall-1-INPUT  all  --  anywhere             anywhere
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;   Chain FORWARD (policy ACCEPT)
...
<span class="quotelev1">&gt;   Chain RH-Firewall-1-INPUT (2 references)
</span><br>
<span class="quotelev1">&gt;   target     prot opt source               destination
</span><br>
<span class="quotelev1">&gt;   ACCEPT     all  --  anywhere             anywhere
</span><br>
<span class="quotelev1">&gt;   ACCEPT     icmp --  anywhere             anywhere            icmp any
</span><br>
<span class="quotelev1">&gt;   ACCEPT     esp  --  anywhere             anywhere
</span><br>
<span class="quotelev1">&gt;   ACCEPT     ah   --  anywhere             anywhere
</span><br>
<span class="quotelev1">&gt;   ACCEPT     udp  --  anywhere             224.0.0.251         udp dpt:mdns
</span><br>
<span class="quotelev1">&gt;   ACCEPT     udp  --  anywhere             anywhere            udp dpt:ipp
</span><br>
<span class="quotelev1">&gt;   ACCEPT     tcp  --  anywhere             anywhere            tcp dpt:ipp
</span><br>
<span class="quotelev1">&gt;   ACCEPT     all  --  anywhere             anywhere            state
</span><br>
<span class="quotelev1">&gt; RELATED,ESTABLISHED
</span><br>
<span class="quotelev1">&gt;   ACCEPT     tcp  --  anywhere             anywhere            state NEW tcp
</span><br>
<span class="quotelev1">&gt; dpt:ssh
</span><br>
<span class="quotelev1">&gt;   ACCEPT     tcp  --  anywhere             anywhere            state NEW tcp
</span><br>
<span class="quotelev1">&gt; dpt:http
</span><br>
<span class="quotelev1">&gt;   REJECT     all  --  anywhere             anywhere            reject-with
</span><br>
<span class="quotelev1">&gt; icmp-host-prohibited
</span><br>
<span class="quotelev1">&gt;   [tsakai_at_dasher Rmpi]$
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I don't understand what they mean.  Can you see any clue as to
</span><br>
<span class="quotelev1">&gt; why vixen can and dasher cannot run mpirun with the app file:
</span><br>
...
<span class="quotelev1">&gt; On 2/14/11 11:15 AM, &quot;Gus Correa&quot; &lt;gus_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; a) can you ssh from dasher to vixen?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Yes, no problem.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   [tsakai_at_dasher Rmpi]$
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   [tsakai_at_dasher Rmpi]$ hostname
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   dasher.egcrc.org
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   [tsakai_at_dasher Rmpi]$
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   [tsakai_at_dasher Rmpi]$ ssh vixen
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   Last login: Mon Feb 14 10:39:20 2011 from dasher.egcrc.org
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   [tsakai_at_vixen ~]$
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   [tsakai_at_vixen ~]$ hostname
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; b) firewall on vixen?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; There is no firewall on vixen that I know of, but I don't
</span><br>
<span class="quotelev3">&gt;&gt;&gt; know how I can definitively show it one way or the other.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Can you please suggest how I can do this?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Besides Reuti suggestions:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Check the consistency of /etc/hosts on both machines.
</span><br>
<span class="quotelev2">&gt;&gt; Check if there are restrictions on /etc/hosts.allow and
</span><br>
<span class="quotelev2">&gt;&gt; /etc/hosts.deny on both machines.
</span><br>
<span class="quotelev2">&gt;&gt; Check if both the MPI directories and your home/work directory
</span><br>
<span class="quotelev2">&gt;&gt; is mounted/available on both machines.
</span><br>
<span class="quotelev2">&gt;&gt; (We may have been through this checklist before, sorry if I forgot.)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Firewall info (not very friendly syntax ...):
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; iptables --list
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; or maybe better:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; cat /etc/sysconfig/iptables
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 2/14/11 4:38 AM, &quot;Reuti&quot; &lt;reuti_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Am 14.02.2011 um 04:54 schrieb Tena Sakai:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I have digressed and started downward descent...
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I was trying to make a simple and clear case.  Everything
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I write in this very mail is about local machines.  There
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; is no virtual machines involved.  I am talking about two
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; machines, vixen and dasher, which share the same file
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; structure.  Vixen is a nfs server and dasher is an nfs
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; client.  I have just installed openmpi 1.4.3 on dasher,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; which is the same version I have on vixen.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I have a file app.ac3, which looks like:
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Vixen can run this without any problem:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_vixen Rmpi]$ mpirun -app app.ac3
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  vixen.egcrc.org
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  vixen.egcrc.org
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  dasher.egcrc.org
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  dasher.egcrc.org
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_vixen Rmpi]$
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; But I can't run this very command from dasher:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_vixen Rmpi]$
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_vixen Rmpi]$ ssh dasher
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  Last login: Sun Feb 13 19:26:57 2011 from vixen.egcrc.org
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_dasher ~]$
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_dasher ~]$ cd Notes/R/parallel/Rmpi/
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_dasher Rmpi]$
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_dasher Rmpi]$ mpirun -app app.ac3
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;        vixen.egcrc.org - daemon did not report back when launched
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_dasher Rmpi]$
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; After I issue the mpirun command, it hangs and I had to Cntrol-C out
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; of it at which point it generated all lines &quot; mpirun: killing job...&quot;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; and below.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; A strange thing is that dahser has no problem executing the same
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; thing via ssh:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_dasher Rmpi]$ ssh vixen.egcrc.org hostname
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  vixen.egcrc.org
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_dasher Rmpi]$
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; In fact, dasher can run it via mpirun so long as no foreign machine
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; is present in the app file.  Ie.,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_dasher Rmpi]$ cat app.ac4
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  -H dasher.egcrc.org  -np 1 hostname
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  -H dasher.egcrc.org  -np 1 hostname
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  [tsakai_at_dasher Rmpi]$ mpirun -app app.ac4
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  dasher.egcrc.org
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  dasher.egcrc.org
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Can you please tell me why I can go one way (from vixen to dasher)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; and not the other way (dasher to vixen)?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On 2/12/11 9:42 PM, &quot;Gustavo Correa&quot; &lt;gus_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Hi Tena
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Thank you for taking the time to explain the details of
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the EC2 procedure.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I am afraid everything in my bag of tricks was used.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; As Ralph and Jeff suggested, this seems to be a very specific
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; problem with EC2.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; The difference in behavior when you run as root vs. when you
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; run as Tena, tells that there is some use restriction to regular users
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; in EC2 that isn't present in common machines (Linux or other), I guess.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; This may be yet another  'stone to turn', as you like to say.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; It also suggests that there is nothing wrong in principle with your
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; openMPI setup or with your program, otherwise root would not be able to
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Besides Ralph suggestion of trying the EC2 mailing list archive,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I wonder if EC2 has any type of user support where you could ask
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; for help.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; After all, it is a paid sevice, isn't it?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; (OpenMPI is not paid and has a great customer service, doesn't it?  :) )
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; You have a well documented case to present,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; and the very peculiar fact that the program fails for normal users but
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; runs
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; for root.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; This should help the EC2 support to start looking for a solution.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I am running out of suggestions of what you could try on your own.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; But let me try:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 1) You may try to reduce the problem to its less common denominator,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; perhaps by trying to run non-R based MPI programs on EC2, maybe the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; hello_c.c,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ring_c.c, and connectivity_c.c programs in the OpenMPi examples directory.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; This would be to avoid the extra layer of complexity introduced by R.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Even simpler would be to run 'hostname' with mpiexec (mpiexec -np 2
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; hostname).
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I.e. go in a progression of increasing complexity, see where you hit the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; wall.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; This may shed some light on what is going on.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I don't know if this suggestion may  really help, though.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; It is not clear to me where the thing fails, whether it is during program
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; execution,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; or while mpiexec is setting up the environment for the program to run.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; If it is very early in the process, before the program starts, my
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; suggestion
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; won't work.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Jeff and Ralph, who know OpenMPI inside out, may have better advice in
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 2) Another thing would be to try to run R on E2C in serial mode, without
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; mpiexec,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; interactively or via script, to see who EC2 doesn't like: R or OpenMPI
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; (but
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; maybe it's both).
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Gus Correa
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Feb 11, 2011, at 9:54 PM, Tena Sakai wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On 2/11/11 3:17 PM, &quot;Jeff Squyres (jsquyres)&quot; &lt;jsquyres_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; It is concerning if the pipe system call fails - I can't think of why
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; would happen. Thats not usually a permissions issue but rather a
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; deeper
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; indication that something is either seriously wrong on your system or
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Feb 11, 2011, at 10:08 AM, &quot;Gus Correa&quot; &lt;gus_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; cation problem is behind me now.  I am still having a problem
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; encountered
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Thanks for the firewall tip.  I tried it while allowing all tip
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; traffic
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; and got interesting and preplexing result.  Here's what's
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; interesting
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; (BTW, I got rid of &quot;LogLevel DEBUG3&quot; from ./ssh/config on this
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [tsakai_at_ip-10-203-21-132 ~]$ export
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; LD_LIBRARY_PATH='/usr/local/lib'
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [tsakai_at_ip-10-203-21-132 ~]$
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [tsakai_at_ip-10-203-21-132 ~]$ # I better to this on machine B as
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [tsakai_at_ip-10-195-171-159 ~]$ export
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; LD_LIBRARY_PATH='/usr/local/lib'
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [tsakai_at_ip-10-195-171-159 ~]$
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Your prior mails were about ssh issues, but this one sounds like
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; various command and control reasons.  If it is blocked from doing
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; firewall, Open MPI won't run.  In general, you can either disable
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; orte_ess_jobid 3344891904 -mca orte_ess_vpid 1 -mca
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; orte_ess_num_procs
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; okay. Sometimes the protection of the home directory must be
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; adjusted
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; known_hosts file and you don't need to create any ssh-keys. But
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; when
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; hostname changes every time it might also create new hostkeys. It
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; uses
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; hostkeys (private and public), this way it works for all users.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; - Can you try to use a command when connecting from A to B? E.g.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; In your ~/.ssh/config. Maybe we can see what he's trying to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; negotiate
</span><br>
