...
?>
<!-- received="Fri Feb 11 01:40:54 2011" -->
<!-- isoreceived="20110211064054" -->
<!-- sent="Thu, 10 Feb 2011 22:40:44 -0800" -->
<!-- isosent="20110211064044" -->
<!-- name="Tena Sakai" -->
<!-- email="tsakai_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="C97A189A.E493%tsakai_at_gallo.ucsf.edu" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="C979BD97.E485%tsakai_at_gallo.ucsf.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-02-11 01:40:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15566.php">Marcela Castro León: "Re: [OMPI users] runtime error"</a>
<li><strong>Previous message:</strong> <a href="15564.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>In reply to:</strong> <a href="15564.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15575.php">Gus Correa: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15575.php">Gus Correa: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>I have made a bit more progress.  I think I can say ssh authenti-
<br>
...
<br>
<p>&nbsp;&nbsp;[tsakai_at_vixen ec2]$ 2ec2 ec2-184-73-104-242.compute-1.amazonaws.com
<br>
...
&nbsp;&nbsp;[tsakai_at_vixen ec2]$
<br>
<p>So, why does it say &quot;pipe function call failed when setting up
<br>
...
<br>
<p>If you could enlighten me why this is happening, I would really
<br>
Appreciate it.
<br>
<p>Thank you.
...
<p>Tena
<br>
<p><p>On 2/10/11 4:12 PM, &quot;Tena Sakai&quot; &lt;tsakai_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev2">&gt;&gt; That is, the &quot;orted&quot; command attempts to open a TCP socket back to mpirun for
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; okay. Sometimes the protection of the home directory must be adjusted too,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; No. It's convenient inside a private cluster as it won't fill each users'
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; your local machine is Linux like, but the execution hosts are Macs? I saw
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I made a config file in my .ssh directory on the cloud.  It looks like:
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Is this a private cluster (or at least private interfaces)? It would also
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; be
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; an option to use hostbased authentication, which will avoid setting any
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;       domU-12-31-39-07-35-21.compute-1.internal - daemon did not report
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Does someone have an example .ssh/config file I can look at?  There are
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; It reads an argument from command line and produces a fibonacci number
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; corresponds to that index, followed by the machine name.  Pretty simple
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Now I want to run the same thing on cloud.  I launch 2 instances of the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;   [tsakai_at_domU-12-31-39-0C-C8-01 ~]$ # now show I can get to machine A
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;   Warning: Permanently added 'domu-12-31-39-00-d1-f2' (RSA) to the list
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; public/private key pairs.  There is no problem (that I can see) for ssh
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; How can I get past authentication by mpirun where there is no password?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; &lt;session4Reuti.text&gt;_______________________________________________
</span><br>
<span class="quotelev3">&gt;&gt;&gt; users mailing list
</span><br>
<span class="quotelev3">&gt;&gt;&gt; users_at_[hidden]
