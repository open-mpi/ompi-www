...
?>
<!-- received="Wed Feb 16 18:17:40 2011" -->
<!-- isoreceived="20110216231740" -->
<!-- sent="Wed, 16 Feb 2011 15:17:34 -0800" -->
<!-- isosent="20110216231734" -->
<!-- name="Tena Sakai" -->
<!-- email="tsakai_at_[hidden]" -->
<!-- subject="Re: [OMPI users] This must be ssh problem, but I can't figure out what it is..." -->
<!-- id="C98199D2.E655%tsakai_at_gallo.ucsf.edu" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2011-02-16 18:17:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15632.php">Gus Correa: "Re: [OMPI users] This must be ssh problem, but I can't figure out what it is..."</a>
<li><strong>Previous message:</strong> <a href="15630.php">Jeff Squyres: "Re: [OMPI users] MPI_TYPE_CREATE_SUBARRAY not in mpif90 library"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15632.php">Gus Correa: "Re: [OMPI users] This must be ssh problem, but I can't figure out what it is..."</a>
<li><strong>Reply:</strong> <a href="15632.php">Gus Correa: "Re: [OMPI users] This must be ssh problem, but I can't figure out what it is..."</a>
<li><strong>Reply:</strong> <a href="15640.php">Jeff Squyres: "Re: [OMPI users] This must be ssh problem, but I can't figure out what it is..."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Gus,
<br>
<p>Thank you for your reply and suggestions.
<br>
<p>I will follow up on these in a bit and will give you an
<br>
update.  Looking at what vixen and/or dasher generates
<br>
from DEBUG3 would be interesting.
<br>
<p>For now, may I point out something I noticed out of the
<br>
DEBUG3 Output last night?
<br>
<p>I found this line:
<br>
<p><span class="quotelev1">&gt;   debug1: Sending command:  orted --daemonize -mca ess env -mca
</span><br>
...
<p>Followed by:
<br>
<p><span class="quotelev1">&gt;   debug2: channel 0: request exec confirm 1
</span><br>
...
<p>It appears, to my untrained eye/mind, a directive from instance A
<br>
to B was issued and then what happened?  I don't see that was
<br>
honored by the instance B.
<br>
<p>Can you please comment on this?
<br>
<p>Thank you.
<br>
<p>Regards,
...
<p>Tena
<br>
<p>On 2/16/11 1:34 PM, &quot;Gus Correa&quot; &lt;gus_at_[hidden]&gt; wrote:
<br>
