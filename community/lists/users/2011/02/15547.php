...
?>
<!-- received="Thu Feb 10 01:08:17 2011" -->
<!-- isoreceived="20110210060817" -->
<!-- sent="Wed, 9 Feb 2011 22:08:11 -0800" -->
<!-- isosent="20110210060811" -->
<!-- name="Tena Sakai" -->
<!-- email="tsakai_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="C978BF75.E42A%tsakai_at_gallo.ucsf.edu" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="C9789F95.E41A%tsakai_at_gallo.ucsf.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-02-10 01:08:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15548.php">David Zhang: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Previous message:</strong> <a href="15546.php">Tena Sakai: "[OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>In reply to:</strong> <a href="15546.php">Tena Sakai: "[OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15548.php">David Zhang: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15548.php">David Zhang: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15549.php">Reuti: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
tsakai_at_[hidden]
<br>
<p>On 2/9/11 7:52 PM, &quot;Tena Sakai&quot; &lt;tsakai_at_[hidden]&gt; wrote:
<br>
<p>Hi
<br>
...
<p><p><p><p><p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-15547/attachment">attachment</a>
</ul>
