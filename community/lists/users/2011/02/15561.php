...
?>
<!-- received="Thu Feb 10 16:03:11 2011" -->
<!-- isoreceived="20110210210311" -->
<!-- sent="Thu, 10 Feb 2011 13:03:00 -0800" -->
<!-- isosent="20110210210300" -->
<!-- name="Tena Sakai" -->
<!-- email="tsakai_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="C9799131.E47A%tsakai_at_gallo.ucsf.edu" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="4E1B841E-0D10-4B04-BEE9-FC93E187C0C8_at_staff.uni-marburg.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-02-10 16:03:00
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15562.php">Jeff Squyres: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Previous message:</strong> <a href="15560.php">Jeremiah Willcock: "[OMPI users] Deadlock/NULL pointer dereference in openib BTL"</a>
<li><strong>In reply to:</strong> <a href="15557.php">Reuti: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15562.php">Jeff Squyres: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15562.php">Jeff Squyres: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15563.php">Reuti: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Reuti,
<br>
<p>Thanks for suggesting &quot;LogLevel DEBUG3.&quot;  I did so and complete
<br>
session is captured in the attached file.
<br>
<p>What I did is much similar to what I have done before: verify
<br>
...
<br>
<p><span class="quotelev1">&gt;From mpirun invocation, I see a line:
</span><br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;debug1: Sending command:  orted --daemonize -mca ess env -mca
<br>
...
mean.
<br>
<p>If you could shed some light, I would appreciate it very much.
<br>
<p>Regards,
<br>
<p>Tena
<br>
<p><p>On 2/10/11 10:57 AM, &quot;Reuti&quot; &lt;reuti_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; okay. Sometimes the protection of the home directory must be adjusted too, but
</span><br>
...
<span class="quotelev1">&gt; In your ~/.ssh/config. Maybe we can see what he's trying to negotiate before
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; it's necessary to specify exactly this name. When the settings are the same
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Is this a private cluster (or at least private interfaces)? It would also be
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Does this mean I am past authentication and something else is the problem?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Does someone have an example .ssh/config file I can look at?  There are so
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; many keyword-argument paris for this config file and I would like to look
</span><br>
...
<br><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-15561/session4Reuti.text">session4Reuti.text</a>
</ul>
<!-- attachment="session4Reuti.text" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
