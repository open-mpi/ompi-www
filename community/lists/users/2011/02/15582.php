...
?>
<!-- received="Fri Feb 11 22:45:11 2011" -->
<!-- isoreceived="20110212034511" -->
<!-- sent="Fri, 11 Feb 2011 22:45:01 -0500" -->
<!-- isosent="20110212034501" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)" -->
<!-- id="4D56023D.4070207_at_ldeo.columbia.edu" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2011-02-11 22:45:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15583.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Previous message:</strong> <a href="15581.php">Jeff Squyres (jsquyres): "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15583.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<li><strong>Reply:</strong> <a href="15583.php">Tena Sakai: "Re: [OMPI users] How does authentication between nodes work without password? (Newbie alert on)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Tena
<br>
<p>We setup the cluster nodes to run MPI programs
<br>
...
<br>
<p>However, some are quite big codes,
<br>
and from what you said yours is not (or not yet).
<br>
<p>Your stack limit sounds quite small, but when
<br>
...
<br>
<p>If you want to do this, put these lines on the bottom
<br>
...
*   -   nofile      4096
<br>
<p>I don't think you should give unlimited number of processes to
<br>
regular users; keep this privilege to root (which is where
<br>
the two have different limits).
<br>
<p>You may want to monitor /proc/sys/fs/file-nr while the program runs.
<br>
...
out of memory.
<br>
<p>If you are using two nodes, check the same stuff on the other node too.
<br>
...
<br>
<p>One of the error messages mentions LD_LIBRARY_PATH.
<br>
Is it set to point to the OpenMPI lib directory?
<br>
Remember, OpenMPI requires both PATH and LD_LIBRARY_PATH properly set.
<br>
<p>I hope this helps, although I am afraid I may be missing the point.
<br>
<p>Gus Correa
<br>
<p>Tena Sakai wrote:
