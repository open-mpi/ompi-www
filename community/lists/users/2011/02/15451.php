...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15452.php">abc def: "[OMPI users] printing text fixes a problem?"</a>
<li><strong>Previous message:</strong> <a href="15450.php">Eugene Loh: "Re: [OMPI users] Calculate time spent on non blocking communication?"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15471.php">Bibrak Qamar: "Re: [OMPI users] Calculate time spent on non blocking communication?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
