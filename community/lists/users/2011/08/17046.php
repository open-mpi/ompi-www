...
?>
<!-- received="Wed Aug 10 12:00:20 2011" -->
<!-- isoreceived="20110810160020" -->
<!-- sent="Wed, 10 Aug 2011 12:00:16 -0400" -->
<!-- isosent="20110810160016" -->
<!-- name="Matthew Russell" -->
<!-- email="mrussel2_at_[hidden]" -->
<!-- subject="Re: [OMPI users] CMAQ crashes with OpenMPI" -->
<!-- id="CAFmqpWo-9fkRyq7DGWYRUkKRvrFoHvH6bNvPAoomKhJ+p7qJag_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2011-08-10 12:00:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17047.php">Matthew Russell: "Re: [OMPI users] CMAQ crashes with OpenMPI"</a>
<li><strong>Previous message:</strong> <a href="17045.php">Sylvestre Ledru: "[OMPI users] MPI with dynamic arrays"</a>
<li><strong>In reply to:</strong> <a href="17039.php">Ralph Castain: "Re: [OMPI users] CMAQ crashes with OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17044.php">Matthew Russell: "Re: [OMPI users] CMAQ crashes with OpenMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Tue, Aug 9, 2011 at 5:18 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Also, please be aware that we haven't done any testing of OMPI on Lion, so
</span><br>
<span class="quotelev1">&gt; this is truly new ground.
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17046/attachment">attachment</a>
</ul>
