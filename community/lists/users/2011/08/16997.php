...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16998.php">Yevgeny Kliteynik: "Re: [OMPI users] Open MPI 1.4: [connect/btl_openib_connect_oob.c:463:qp_create_one] error creating qp errno says Cannot allocate memory"</a>
<li><strong>Previous message:</strong> <a href="16996.php">Faisal Shahzad: "[OMPI users] help regarding SELF checkpointing, c or c++"</a>
<li><strong>In reply to:</strong> <a href="16996.php">Faisal Shahzad: "[OMPI users] help regarding SELF checkpointing, c or c++"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16999.php">Faisal Shahzad: "Re: [OMPI users] help regarding SELF checkpointing, c or c++"</a>
<li><strong>Reply:</strong> <a href="16999.php">Faisal Shahzad: "Re: [OMPI users] help regarding SELF checkpointing, c or c++"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
