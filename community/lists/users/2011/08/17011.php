...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17012.php">Barrett, Brian W: "Re: [OMPI users] OpenMPI on Tile architectures (no atomic primitives)"</a>
<li><strong>Previous message:</strong> <a href="17010.php">Yevgeny Kliteynik: "Re: [OMPI users] Open MPI 1.4: [connect/btl_openib_connect_oob.c:463:qp_create_one] error creating qp errno says Cannot allocate memory"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/07/16816.php">Ralph Castain: "Re: [OMPI users] OpenMPI on Tile architectures (no atomic primitives)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17012.php">Barrett, Brian W: "Re: [OMPI users] OpenMPI on Tile architectures (no atomic primitives)"</a>
<li><strong>Reply:</strong> <a href="17012.php">Barrett, Brian W: "Re: [OMPI users] OpenMPI on Tile architectures (no atomic primitives)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
