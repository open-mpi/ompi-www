...
?>
<!-- received="Wed Aug 10 06:15:05 2011" -->
<!-- isoreceived="20110810101505" -->
<!-- sent="Wed, 10 Aug 2011 12:14:57 +0200" -->
<!-- isosent="20110810101457" -->
<!-- name="Christopher Jones" -->
<!-- email="Chris.Jones_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Open MPI via SSH noob issue" -->
<!-- id="FA60B5EB-43C2-4E48-88F2-EB426AD83AA6_at_mikrob.slu.se" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="D9DF7FA4-2CEA-4DFB-A72C-F844C1DCC7D0_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-08-10 06:14:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17042.php">Jeff Squyres: "Re: [OMPI users] Open MPI via SSH noob issue"</a>
<li><strong>Previous message:</strong> <a href="17040.php">Barrett, Brian W: "Re: [OMPI users] CMAQ crashes with OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="17033.php">Jeff Squyres: "Re: [OMPI users] Open MPI via SSH noob issue"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17042.php">Jeff Squyres: "Re: [OMPI users] Open MPI via SSH noob issue"</a>
<li><strong>Reply:</strong> <a href="17042.php">Jeff Squyres: "Re: [OMPI users] Open MPI via SSH noob issue"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; No, Open MPI doesn't use the names in the hostfile to figure out which TCP/IP addresses to use (for example).  Each process ends up publishing a list of IP addresses at which it can be connected, and OMPI does routability computations to figure out which is the &quot;best&quot; address to contact a given peer on.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; If you're just starting with Open MPI, can you upgrade?  1.2.8 is pretty ancient.  Open MPI 1.4.3 is the most recent stable release; 1.5.3 is our &quot;feature&quot; series, but it's also relatively stable (new releases are coming in both the 1.4.x and 1.5.x series soon, FWIW).
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Aug 9, 2011, at 12:14 PM, David Warren wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I don't know if this is it, but if you use the name localhost, won't processes on both machines try to talk to 127.0.0.1? I believe you need to use the real hostname in you host file. I think that your two tests work because there is no interprocess communication, just stdout.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On 08/08/11 23:46, Christopher Jones wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hi again,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I changed the subject of my previous posting to reflect a new problem encountered when I changed my strategy to using SSH instead of Xgrid on two mac pros. I've set up a login-less ssh communication between the two macs (connected via direct ethernet, both running openmpi 1.2.8 on OSX 10.6.8) per the instructions on the FAQ. I can type in 'ssh computer-name.local' on either computer and connect without a password prompt. From what I can see, the ssh-agent is up and running - the following is listed in my ENV:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; SSH_AUTH_SOCK=/tmp/launch-5FoCc1/Listeners
</span><br>
<span class="quotelev3">&gt;&gt;&gt; SSH_AGENT_PID=61058
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; My host file simply lists 'localhost' and 'chrisjones2_at_allana-welshs-mac-pro.local'. When I run a simple hello_world test, I get what seems like a reasonable output:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; chris-joness-mac-pro:~ chrisjones$ mpirun -np 8 -hostfile hostfile ./test_hello
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I can also run hostname and get what seems to be an ok response (unless I'm wrong about this):
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; chris-joness-mac-pro:~ chrisjones$ mpirun -np 8 -hostfile hostfile hostname
</span><br>
<span class="quotelev3">&gt;&gt;&gt; allana-welshs-mac-pro.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; allana-welshs-mac-pro.local
</span><br>
<span class="quotelev3">&gt;&gt;&gt; allana-welshs-mac-pro.local
...
<span class="quotelev3">&gt;&gt;&gt; quadcore.mikrob.slu.se
</span><br>
<span class="quotelev3">&gt;&gt;&gt; quadcore.mikrob.slu.se
</span><br>
<span class="quotelev3">&gt;&gt;&gt; quadcore.mikrob.slu.se
...
<span class="quotelev3">&gt;&gt;&gt; However, when I run the ring_c test, it freezes:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; chris-joness-mac-pro:~ chrisjones$ mpirun -np 8 -hostfile hostfile ./ring_c
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; (I noted that processors on both computers are active).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ring_c was compiled separately on each computer, however both have the same version of openmpi and OSX. I've gone through the FAQ and searched the user forum, but I can't quite seems to get this problem unstuck.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Many thanks for your time,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Chris
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Aug 5, 2011, at 6:00 PM,&lt;users-request_at_[hidden]&gt;  &lt;users-request_at_[hidden]&gt;  wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;  1. Re: OpenMPI causing WRF to crash (Jeff Squyres)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  2. Re: OpenMPI causing WRF to crash (Anthony Chan)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  3. Re: Program hangs on send when run with nodes on  remote
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     machine (Jeff Squyres)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  4. Re: openmpi 1.2.8 on Xgrid noob issue (Jeff Squyres)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;  5. Re: parallel I/O on 64-bit indexed arays (Rob Latham)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Date: Thu, 4 Aug 2011 19:18:36 -0400
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; From: Jeff Squyres&lt;jsquyres_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] OpenMPI causing WRF to crash
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To: Open MPI Users&lt;users_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Message-ID:&lt;3F0E661F-A74F-4E51-86C0-1F84FEB0764D_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Content-Type: text/plain; charset=windows-1252
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Signal 15 is usually SIGTERM on Linux, meaning that some external entity probably killed the job.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The OMPI error message you describe is also typical for that kind of scenario -- i.e., a process exited without calling MPI_Finalize could mean that it called exit() or some external process killed it.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Aug 3, 2011, at 7:24 AM, BasitAli Khan wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I am trying to run a rather heavy wrf simulation with spectral nudging but the simulation crashes after 1.8 minutes of integration.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Date: Thu, 4 Aug 2011 18:59:59 -0500 (CDT)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; From: Anthony Chan&lt;chan_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] OpenMPI causing WRF to crash
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To: Open MPI Users&lt;users_at_[hidden]&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;       &lt;660521091.191111.1312502399225.JavaMail.root_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; If you want to debug this on BGP, you could set BG_COREDUMPONERROR=1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; and look at the backtrace in the light weight core files
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (you probably need to recompile everything with -g).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Date: Thu, 4 Aug 2011 20:46:16 -0400
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; From: Jeff Squyres&lt;jsquyres_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] Program hangs on send when run with nodes on
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;       remote machine
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To: Open MPI Users&lt;users_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Message-ID:&lt;F344F301-AD7B-4E83-B0DF-A6E0010725A6_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Content-Type: text/plain; charset=us-ascii
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I notice that in the worker, you have:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; eth2      Link encap:Ethernet  HWaddr 00:1b:21:77:c5:d4
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         inet addr:192.168.1.155  Bcast:192.168.1.255  Mask:255.255.255.0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         inet6 addr: fe80::21b:21ff:fe77:c5d4/64 Scope:Link
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         UP BROADCAST RUNNING MULTICAST  MTU:1500  Metric:1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         RX packets:9225846 errors:0 dropped:75175 overruns:0 frame:0
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;         RX bytes:1336628768 (1.3 GB)  TX bytes:552 (552.0 B)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; eth3      Link encap:Ethernet  HWaddr 00:1b:21:77:c5:d5
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         inet addr:192.168.1.156  Bcast:192.168.1.255  Mask:255.255.255.0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         inet6 addr: fe80::21b:21ff:fe77:c5d5/64 Scope:Link
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         UP BROADCAST RUNNING MULTICAST  MTU:1500  Metric:1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         RX packets:26481809 errors:0 dropped:75059 overruns:0 frame:0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         TX packets:18030236 errors:0 dropped:0 overruns:0 carrier:0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         collisions:0 txqueuelen:1000
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         RX bytes:70061260271 (70.0 GB)  TX bytes:11844181778 (11.8 GB)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Two different NICs are on the same subnet -- that doesn't seem like a good idea...?  I think this topic has come up on the users list before, and, IIRC, the general consensus is &quot;don't do that&quot; because it's not clear as to which NIC Linux will actually send outgoing traffic across bound for the 192.168.1.x subnet.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Aug 4, 2011, at 1:59 PM, Keith Manville wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I am having trouble running my MPI program on multiple nodes. I can
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Date: Thu, 4 Aug 2011 20:48:30 -0400
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; From: Jeff Squyres&lt;jsquyres_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] openmpi 1.2.8 on Xgrid noob issue
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To: Open MPI Users&lt;users_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Message-ID:&lt;C2EA7FD0-BADB-4D05-851C-C444BE26FA5A_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Content-Type: text/plain; charset=us-ascii
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm afraid our Xgrid support has lagged, and Apple hasn't show much interest in MPI + Xgrid support -- much less HPC.  :-\
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Have you see the FAQ items about Xgrid?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;   <a href="http://www.open-mpi.org/faq/?category=osx#xgrid-howto">http://www.open-mpi.org/faq/?category=osx#xgrid-howto</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Aug 4, 2011, at 4:16 AM, Christopher Jones wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Date: Fri, 5 Aug 2011 08:41:58 -0500
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; From: Rob Latham&lt;robl_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] parallel I/O on 64-bit indexed arays
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To: Open MPI Users&lt;users_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Cc: Quincey Koziol&lt;koziol_at_[hidden]&gt;, Fab Tillier
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;       &lt;ftillier_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Message-ID:&lt;20110805134158.GA28241_at_[hidden]&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Content-Type: text/plain; charset=us-ascii
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Wed, Jul 27, 2011 at 06:13:05PM +0200, Troels Haugboelle wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Ordered mode as implemented in ROMIO is awful.  Entirely serialized.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; We pass a token from process to process. Each process acquires the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; token, updates the shared file pointer, does its i/o, then passes the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; token to the next process.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; What we should do, and have done in test branches [1], is use MPI_SCAN
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; to look at the shared file pointer once, tell all the processors their
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; offset, then update the shared file pointer while all processes do I/O
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; in parallel.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [1]: Robert Latham, Robert Ross, and Rajeev Thakur. &quot;Implementing
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI-IO Atomic Mode and Shared File Pointers Using MPI One-Sided
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Communication&quot;. International Journal of High Performance Computing
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Applications, 21(2):132-143, 2007
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Since no one uses the shared file pointers, and even fewer people use
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ordered mode, we just haven't seen the need to do so.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Do you want to rebuild your MPI library on BlueGene?  I can pretty
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; quickly generate and send a patch that will make ordered mode go whip
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; fast.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; End of users Digest, Vol 1977, Issue 1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; **************************************
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt; &lt;warren.vcf&gt;_______________________________________________
</span><br>
