...
?>
<!-- received="Wed Jun 22 13:55:20 2011" -->
<!-- isoreceived="20110622175520" -->
<!-- sent="Wed, 22 Jun 2011 21:55:15 +0400" -->
<!-- isosent="20110622175515" -->
<!-- name="Dmitry N. Mikushin" -->
<!-- email="maemarcus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpif90 compiler non-functional" -->
<!-- id="BANLkTimiXbo_zeKc4b2e6f4EE0ZKo7QqKA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2011-06-22 13:55:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16748.php">Vasiliy G Tolstov: "Re: [OMPI users] Need Source Code MPI"</a>
<li><strong>Previous message:</strong> <a href="16746.php">Jeff Squyres: "Re: [OMPI users] mpif90 compiler non-functional"</a>
...
Alexandre,
<br>
<p><span class="quotelev1">&gt; How can I make to point to the new installed version in
</span><br>
<span class="quotelev1">&gt; /opt/openmpi-1.4.3, when calling mpif90 or mpif77 as a common user ?
</span><br>
<p>If you need to switch between multiple working MPI implementations
<br>
