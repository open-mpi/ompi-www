...
?>
<!-- received="Tue Jun 28 16:23:46 2011" -->
<!-- isoreceived="20110628202346" -->
<!-- sent="Tue, 28 Jun 2011 14:23:37 -0600" -->
<!-- isosent="20110628202337" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problems with Mpi Accept - ORTE_ERROR_LOG" -->
<!-- id="66D5BD68-5699-4D9B-B286-F36F7E7C4BA5_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-06-28 16:23:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16776.php">yanyg_at_[hidden]: "Re: [OMPI users] mpirun does not propagate environment from master node to slave nodes"</a>
<li><strong>Previous message:</strong> <a href="16774.php">Ralph Castain: "Re: [OMPI users] mpirun does not propagate environment from master node to slave nodes"</a>
<li><strong>In reply to:</strong> <a href="16771.php">Rodrigo Oliveira: "[OMPI users] Problems with Mpi Accept - ORTE_ERROR_LOG"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16779.php">Ralph Castain: "Re: [OMPI users] Problems with Mpi Accept - ORTE_ERROR_LOG"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
How are you passing the port info between the server and client? You're hitting a race condition between the two sides.
<br>
<p>On Jun 27, 2011, at 9:29 AM, Rodrigo Oliveira wrote:
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16775/attachment">attachment</a>
</ul>
