<?
$subject_val = "[OMPI users] ifort 12.0.4 install problem";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Jun  6 10:43:08 2011" -->
<!-- isoreceived="20110606144308" -->
<!-- sent="Mon, 6 Jun 2011 16:43:03 +0200" -->
<!-- isosent="20110606144303" -->
<!-- name="Virginie trinite" -->
<!-- email="vtrinite_at_[hidden]" -->
<!-- subject="[OMPI users] ifort 12.0.4 install problem" -->
<!-- id="BANLkTimxxxXABWX4bb7V1eV9FtrVMmVKAQ_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] ifort 12.0.4 install problem<br>
<strong>From:</strong> Virginie trinite (<em>vtrinite_at_[hidden]</em>)<br>
<strong>Date:</strong> 2011-06-06 10:43:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16680.php">Rolf vandeVaart: "Re: [OMPI users] Program hangs when using OpenMPI and CUDA"</a>
<li><strong>Previous message:</strong> <a href="16678.php">Troels Haugboelle: "[OMPI users] parallel I/O on 64-bit indexed arays"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16682.php">Jeff Squyres: "Re: [OMPI users] ifort 12.0.4 install problem"</a>
<li><strong>Reply:</strong> <a href="16682.php">Jeff Squyres: "Re: [OMPI users] ifort 12.0.4 install problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello
<br>
<p>I try to compile open-mpi with ifort 12.0.4. My system is ubuntu
<br>
lucid. Previous intallation with ifort 11.1 was fine.
<br>
<p>configure and make all seems to work well, but make install report an error:
<br>
...
<br>
<p>I want to underline that icc is a knom command for bash.
<br>
...
error message:
<br>
<p>No available pml components were found
<br>
This mean ......
<br>
<p>....
...
<br>
<p>The output of ompi_info is:
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Package: Open MPI user_at_CAPYS Distribution
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Open MPI: 1.4.3
<br>
