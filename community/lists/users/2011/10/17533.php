<?
$subject_val = "[OMPI users] [Open MPI Announce] Open MPI 1.4.4 released";
...
<!-- subject="[OMPI users] [Open MPI Announce] Open MPI 1.4.4 released" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] [Open MPI Announce] Open MPI 1.4.4 released<br>
<strong>From:</strong> George Bosilca (<em>bosilca_at_[hidden]</em>)<br>
<strong>Date:</strong> 2011-10-13 12:07:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17534.php">Gabriele Fatigati: "[OMPI users] Memory mapped memory"</a>
<li><strong>Previous message:</strong> <a href="17532.php">Philippe Gouret: "[OMPI users] crash with hardware virtualization"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
