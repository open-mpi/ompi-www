...
?>
<!-- received="Mon Oct  3 17:44:26 2011" -->
<!-- isoreceived="20111003214426" -->
<!-- sent="Mon, 3 Oct 2011 17:44:20 -0400" -->
<!-- isosent="20111003214420" -->
...
<!-- id="4E8A2CB4.30506_at_gtri.gatech.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="7B3048B0-E8CE-411E-9846-E09AFCA1B0C7_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-10-03 17:44:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17494.php">Jeff Squyres: "Re: [OMPI users] [SOLVED] unresolvable R_X86_64_64 relocation against symbol `mpi_fortran_*"</a>
<li><strong>Previous message:</strong> <a href="17492.php">Jeff Squyres: "Re: [OMPI users] Proper way to stop MPI process"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/09/17470.php">Jeff Squyres: "Re: [OMPI users] Segfault on any MPI communication on head node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17495.php">Ralph Castain: "Re: [OMPI users] Segfault on any MPI communication on head node"</a>
<li><strong>Reply:</strong> <a href="17495.php">Ralph Castain: "Re: [OMPI users] Segfault on any MPI communication on head node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
make -j8 all install
<br>
<p>and it hangs at this when I try to run my code (I commented out all the 
<br>
host name stuff, so it's just MPI code now)
<br>
<p>[hostname:16574] [[17705,0],0] ORTE_ERROR_LOG: Buffer type (described vs 
<br>
non-described) mismatch - operation not allowed in file 
<br>
base/odls_base_default_fns.c at line 2600
<br>
<p>I'm googling for more info but does anyone have any ideas?
<br>
<p>On 9/28/11 8:30 PM, Jeff Squyres wrote:
<br>
<span class="quotelev1">&gt; Use --enable-debug on your configure line.  This will add in some debugging code to OMPI, and it'll compile everything with -g so that you can get stack traces.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Beware that the extra debugging junk makes OMPI slightly slower; don't do any benchmarking with this install, etc.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Sep 28, 2011, at 6:27 PM, Phillip Vassenkov wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I tried 1.4.4rc4, same problem. Where do I get a debugging version?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On 9/28/11 8:32 AM, Jeff Squyres wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Agreed that the original program had the char*[20]/char[20] bug, but his segv is occurring before trying to use that array.  So it's a bug - but he just hadn't hit it yet.  :-)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'd still like to see a debugging version so that we can get a real stack trace, and/or try the latest 1.4.4 RC (posted yesterday).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Sep 27, 2011, at 3:08 PM, German Hoecht wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; char* name[20]; yields 20 (undefined) pointers to char, guess you mean
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; char name[20];
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So Brent's suggestion should work as well(?)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To be safe I would also add:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; gethostname(name,maxlen);
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; name[19] = '\0';
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 09/27/2011 07:40 PM, Phillip Vassenkov wrote:
</span><br>
