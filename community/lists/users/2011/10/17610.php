...
?>
<!-- received="Tue Oct 25 10:20:40 2011" -->
<!-- isoreceived="20111025142040" -->
<!-- sent="Tue, 25 Oct 2011 08:20:32 -0600" -->
<!-- isosent="20111025142032" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem-Bug with MPI_Intercomm_create()" -->
<!-- id="200A69C0-5A0A-44B0-9EF9-11305E1B1B99_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="4EA6B32A.8090305_at_labri.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-10-25 10:20:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17611.php">TERRY DONTJE: "Re: [OMPI users] exited on signal 11 (Segmentation fault)."</a>
<li><strong>Previous message:</strong> <a href="17609.php">Mouhamad Al-Sayed-Ali: "Re: [OMPI users] exited on signal 11 (Segmentation fault)."</a>
<li><strong>In reply to:</strong> <a href="17605.php">orel: "[OMPI users] Problem-Bug with MPI_Intercomm_create()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17617.php">Ralph Castain: "Re: [OMPI users] Problem-Bug with MPI_Intercomm_create()"</a>
<li><strong>Reply:</strong> <a href="17617.php">Ralph Castain: "Re: [OMPI users] Problem-Bug with MPI_Intercomm_create()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Oct 25, 2011, at 7:01 AM, orel wrote:
<br>
