...
?>
<!-- received="Wed Oct  5 10:38:09 2011" -->
<!-- isoreceived="20111005143809" -->
<!-- sent="Wed, 5 Oct 2011 10:38:04 -0400" -->
<!-- isosent="20111005143804" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Private and public IP mixing." -->
<!-- id="93B60D8E-D855-4E45-BD85-1D24FBDB8BAE_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-10-05 10:38:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17511.php">.-=Kiwi=-.: "Re: [OMPI users] Private and public IP mixing."</a>
<li><strong>Previous message:</strong> <a href="17509.php">Jeff Squyres: "Re: [OMPI users] problem running with RoCE over 10GbE"</a>
<li><strong>In reply to:</strong> <a href="17500.php">Ralph Castain: "Re: [OMPI users] Private and public IP mixing."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17511.php">.-=Kiwi=-.: "Re: [OMPI users] Private and public IP mixing."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Does a &quot;hello world&quot; MPI app (with no MPI_SEND/MPI_RECV) in it work without those params, but an MPI app with MPI_SEND/MPI_RECV hang?
<br>
<p>If so, that's a little disappointing -- OMPI's MPI layer should be able to tell the difference between the different networks and should be able to figure out routability between them.
<br>
<p>But if hello world doesn't even run, then try running with &quot;mpirun --mca oob_tcp_if_include &lt;the interface(s) you want to use&gt; ...&quot;, per Ralph's suggestion.  If *that* doesn't work, also add &quot;--mca btl_tcp_if_include ...&quot; as well.
<br>
<p><p>On Oct 4, 2011, at 7:54 PM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; OMPI always tries to use the lowest numbered address first - just a natural ordering. You need to tell it to use just the public ones for this topology. Use the oob_tcp and btl_tcp parameters to do this. See &quot;ompi_info --param oob tcp&quot; and &quot;ompi_info --param btl tcp&quot; for the exact syntax.
</span><br>
