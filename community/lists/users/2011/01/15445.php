...
?>
<!-- received="Fri Jan 28 02:51:00 2011" -->
<!-- isoreceived="20110128075100" -->
<!-- sent="Fri, 28 Jan 2011 08:50:55 +0100" -->
<!-- isosent="20110128075055" -->
<!-- name="Gabriele Fatigati" -->
<!-- email="g.fatigati_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Argument parsing issue" -->
<!-- id="AANLkTin4hHqoFETSokF31bErJWPmQp4sxgg=LwXDCq38_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="84E65EB3-2760-4369-9DB7-D6709C4C7AD5_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-01-28 02:50:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15446.php">Jeff Squyres: "Re: [OMPI users] Argument parsing issue"</a>
<li><strong>Previous message:</strong> <a href="15444.php">Michael Curtis: "Re: [OMPI users] Segmentation fault with SLURM and non-local nodes"</a>
<li><strong>In reply to:</strong> <a href="15442.php">Jeff Squyres: "Re: [OMPI users] Argument parsing issue"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15446.php">Jeff Squyres: "Re: [OMPI users] Argument parsing issue"</a>
<li><strong>Reply:</strong> <a href="15446.php">Jeff Squyres: "Re: [OMPI users] Argument parsing issue"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Jeff,
<br>
<p>i'm trying your patch on openmpi-1.7a1r24319 version and it works well!
<br>
<p>Arguments are parsed well with totalview:
<br>
<p>Command:
<br>
<p>mpirun --debug -n 2 ./a.out  a b &quot;c d&quot;
<br>
<p>output:
<br>
<p>a
...
c d
<br>
<p><p><p><p>2011/1/27 Jeff Squyres &lt;jsquyres_at_[hidden]&gt;
<br>
<p><span class="quotelev1">&gt; I did my patch against the development trunk; could you try the attached
</span><br>
<span class="quotelev1">&gt; patch to a trunk nightly tarball and see if that works for you?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; If it does, I can provide patches for v1.4 and v1.5 (the code moved a bit
</span><br>
...
<span class="quotelev2">&gt; &gt; Specifically: it *is* OMPI that is dropping your quoting / splitting &quot;foo
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; The problem is that mpirun regenerates itself to exec a command of
</span><br>
<span class="quotelev1">&gt; &quot;totalview mpirun ....&quot;, and the quotes are lost in the process.
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Just start your debugged job with &quot;totalview mpirun ...&quot; and it should
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; The problem is how mpirun scan input parameters when Totalview is
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; Whoa - your applications without the debugger is running fine - so I
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt; &gt; &gt; i'm using OpenMPI 1.4.3 and Intel compiler. My simple application
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt; &gt; this double expansion can happen with certain wrappers (also with
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt; &gt; &gt; I think there is an issue in parsing the arguments invoking
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-15445/attachment">attachment</a>
</ul>
