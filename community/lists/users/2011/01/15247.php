...
<p class="headers">
<strong>Subject:</strong> [OMPI users] can't use &quot;--mca btl_openib_cpc_include xoob&quot;<br>
<strong>From:</strong> &#227;&#219;&#202;&#165;&#213;&#220; (<em>ksz_at_[hidden]</em>)<br>
<strong>Date:</strong> 2011-01-01 01:30:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15248.php">Richard Treumann: "[OMPI users] AUTO: Richard Treumann/Poughkeepsie/IBM has retired"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/12/15246.php">Gilbert Grosdidier: "Re: [OMPI users] Trouble with Memlock when using OpenIB on an SGI ICE Cluster"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15285.php">Jeff Squyres: "Re: [OMPI users] can't use &quot;--mca btl_openib_cpc_include xoob&quot;"</a>
<li><strong>Reply:</strong> <a href="15285.php">Jeff Squyres: "Re: [OMPI users] can't use &quot;--mca btl_openib_cpc_include xoob&quot;"</a>
<li><strong>Reply:</strong> <a href="15358.php">Shamis, Pavel: "Re: [OMPI users] can't use &quot;--mca btl_openib_cpc_include xoob&quot;"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
