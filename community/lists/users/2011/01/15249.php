...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15250.php">Shiqing Fan: "Re: [OMPI users] Windows installers of 1.5.1 - No Fortan ?"</a>
<li><strong>Previous message:</strong> <a href="15248.php">Richard Treumann: "[OMPI users] AUTO: Richard Treumann/Poughkeepsie/IBM has retired"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/12/15206.php">Eloi Gaudry: "[OMPI users] memory consumption on rank 0 and btl_openib_receive_queues use"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15404.php">Eloi Gaudry: "Re: [OMPI users] memory consumption on rank 0 and	btl_openib_receive_queues use"</a>
<li><strong>Reply:</strong> <a href="15404.php">Eloi Gaudry: "Re: [OMPI users] memory consumption on rank 0 and	btl_openib_receive_queues use"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
