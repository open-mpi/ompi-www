...
?>
<!-- received="Mon Jan  3 11:43:40 2011" -->
<!-- isoreceived="20110103164340" -->
<!-- sent="Mon, 3 Jan 2011 11:43:02 -0500" -->
<!-- isosent="20110103164302" -->
...
<!-- id="2B00361EE3107A4F88383EC1B041DC9A07E39AF8_at_VFOHMLAO01.Enterprise.afmc.ds.af.mil" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="F681C8BB-35FD-49FB-B42B-687B604B7D11_at_sandia.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-01-03 11:43:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15256.php">Brock Palen: "[OMPI users] Sending large boradcasts"</a>
<li><strong>Previous message:</strong> <a href="15254.php">Barrett, Brian W: "Re: [OMPI users] Using MPI_Put/Get correctly?"</a>
<li><strong>In reply to:</strong> <a href="15254.php">Barrett, Brian W: "Re: [OMPI users] Using MPI_Put/Get correctly?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15272.php">Grismer, Matthew J Civ USAF AFMC AFRL/RBAT: "Re: [OMPI users] Using MPI_Put/Get correctly?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Matt -
<br>
<p>There's a known bug in the datatype engine of Open MPI 1.5 that breaks
<br>
...
<p>Brian
<br>
<p>On Jan 3, 2011, at 9:18 AM, Grismer,	Matthew J Civ USAF AFMC
<br>
AFRL/RBAT wrote:
<br>
<p><span class="quotelev1">&gt; Unfortunately correcting the integer type for the displacement does
</span><br>
not fix
<br>
<span class="quotelev1">&gt; the problem in my code, argh! So, thinking this might have something
</span><br>
to do
<br>
<span class="quotelev1">&gt; with the large arrays and amount of data being passed in the actual
</span><br>
code, I
<br>
<span class="quotelev1">&gt; modified my example (attached putbothways2.f90) so that the array
</span><br>
sizes and
<br>
<span class="quotelev1">&gt; amount of data swapped are nearly identical to the code giving me the
</span><br>
issue.
<br>
<span class="quotelev1">&gt; I also filled the array that is shared with random data, instead of
</span><br>
0's and
<br>
<span class="quotelev1">&gt; 1's, to ensure nothing special was happening due to the simple,
</span><br>
uniform
<br>
<span class="quotelev1">&gt; data. Unfortunately, the example works great, but my actual code still
</span><br>
seg
<br>
...
<span class="quotelev1">&gt; So, the summary is the example code that uses MPI_Put calls with
</span><br>
indexed
<br>
<span class="quotelev1">&gt; datatypes to swap data between 2 processors works without issue, while
</span><br>
the
<br>
<span class="quotelev1">&gt; actual code that communicates in the same manner fails.  The only
</span><br>
difference
<br>
<span class="quotelev1">&gt; is the actual code allocates many other arrays, which are communicated
</span><br>
in
<br>
<span class="quotelev1">&gt; various ways (sends, puts, broadcasts, etc).  I checked and re-checked
</span><br>
all
<br>
<span class="quotelev1">&gt; the argument lists associated with the indexed data, window, and puts;
</span><br>
<span class="quotelev1">&gt; everything looks correct.  Any thoughts or suggestions on how to
</span><br>
proceed?
<br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Someone correctly pointed out the bug in my examples.  In the MPI_Put
</span><br>
I
<br>
<span class="quotelev1">&gt; pass a 0 as the displacement, however, the argument must be of type
</span><br>
<span class="quotelev1">&gt; integer (kind=MPI_ADDRESS_KIND), which is NOT the default integer
</span><br>
type.
<br>
<span class="quotelev1">&gt; Replacing the 0 with the correct integer type fixes both examples.
</span><br>
Now
<br>
...
<span class="quotelev1">&gt; window'ed array at the same time.  So, each process is sending from
</span><br>
and
<br>
...
<span class="quotelev1">&gt; and received data.  Once again I'm using indexed data types for both
</span><br>
the
<br>
...
<span class="quotelev1">&gt; implementations catch up.  If users need one-sided now, they should
</span><br>
use
<br>
...
<span class="quotelev1">&gt; MPI-3 RMA extends MPI-2 RMA and will be backward compatible, so
</span><br>
anything
<br>
<span class="quotelev1">&gt; you write now will still work.  It's still unclear to me whether
</span><br>
MPI-3's
<br>
...
<span class="quotelev1">&gt; So, my advice: don't be scared of MPI-2.  I agree, it's complicated,
</span><br>
but
<br>
