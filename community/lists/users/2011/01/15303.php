...
?>
<!-- received="Fri Jan  7 05:14:33 2011" -->
<!-- isoreceived="20110107101433" -->
<!-- sent="Fri, 07 Jan 2011 11:14:26 +0100" -->
<!-- isosent="20110107101426" -->
...
<!-- id="4D26E782.5050308_at_cea.fr" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="4D26E0FD.3040706_at_cea.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-01-07 05:14:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15304.php">Bernard Secher - SFME/LGLS: "Re: [OMPI users] change between openmpi 1.4.1 and 1.5.1 about MPI2 publish name"</a>
<li><strong>Previous message:</strong> <a href="15302.php">Bernard Secher - SFME/LGLS: "Re: [OMPI users] change between openmpi 1.4.1 and 1.5.1 about MPI2 publish name"</a>
<li><strong>In reply to:</strong> <a href="15302.php">Bernard Secher - SFME/LGLS: "Re: [OMPI users] change between openmpi 1.4.1 and 1.5.1 about MPI2 publish name"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15304.php">Bernard Secher - SFME/LGLS: "Re: [OMPI users] change between openmpi 1.4.1 and 1.5.1 about MPI2 publish name"</a>
<li><strong>Reply:</strong> <a href="15304.php">Bernard Secher - SFME/LGLS: "Re: [OMPI users] change between openmpi 1.4.1 and 1.5.1 about MPI2 publish name"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; The dead lock is not in MPI_Comm_accept and MPI_Comm_connect, but 
</span><br>
<span class="quotelev1">&gt; before in MPI_Publish_name and MPI_Lookup_name.
</span><br>
<span class="quotelev1">&gt; So the broadcast of srv is not involved in the dead lock.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Only the processes of the program where process 0 successed to 
</span><br>
<span class="quotelev2">&gt;&gt; publish name, have srv=1 and then call MPI_Comm_accept.
</span><br>
<span class="quotelev2">&gt;&gt; The processes of the program where process 0 failed to publish name, 
</span><br>
<span class="quotelev2">&gt;&gt; have srv=0 and then call MPI_Comm_connect.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-15303/attachment">attachment</a>
</ul>
