...
?>
<!-- received="Thu Mar 10 00:51:37 2011" -->
<!-- isoreceived="20110310055137" -->
<!-- sent="Thu, 10 Mar 2011 05:51:31 +0000" -->
<!-- isosent="20110310055131" -->
<!-- name="Belaid MOA" -->
<!-- email="belaid_moa_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Open MPI access the same file in parallel ?" -->
<!-- id="BAY161-w49D80498D5BA9578A83ECCF4C80_at_phx.gbl" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="[OMPI users] Open MPI access the same file in parallel ?" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-03-10 00:51:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15833.php">Jack Bryan: "Re: [OMPI users] Open MPI access the same file in parallel ?"</a>
<li><strong>Previous message:</strong> <a href="15831.php">David Zhang: "Re: [OMPI users] Open MPI access the same file in parallel ?"</a>
<li><strong>Maybe in reply to:</strong> <a href="15827.php">Jack Bryan: "[OMPI users] Open MPI access the same file in parallel ?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15833.php">Jack Bryan: "Re: [OMPI users] Open MPI access the same file in parallel ?"</a>
<li><strong>Reply:</strong> <a href="15833.php">Jack Bryan: "Re: [OMPI users] Open MPI access the same file in parallel ?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-15832/attachment">attachment</a>
</ul>
