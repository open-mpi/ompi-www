...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15770.php">Blosch, Edwin L: "[OMPI users] Basic question on portability"</a>
<li><strong>Previous message:</strong> <a href="15768.php">Jeff Squyres: "Re: [OMPI users] RoCE (IBoE) &amp; OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="15766.php">Eye RCS 51: "[OMPI users] using MPI through Qt"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15780.php">Eye RCS 51: "Re: [OMPI users] using MPI through Qt"</a>
<li><strong>Reply:</strong> <a href="15780.php">Eye RCS 51: "Re: [OMPI users] using MPI through Qt"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-15769/attachment">attachment</a>
</ul>
