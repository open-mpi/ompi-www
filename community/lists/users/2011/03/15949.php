...
?>
<!-- received="Mon Mar 21 15:38:33 2011" -->
<!-- isoreceived="20110321193833" -->
<!-- sent="Mon, 21 Mar 2011 12:38:28 -0700" -->
<!-- isosent="20110321193828" -->
<!-- name="Randall Svancara" -->
<!-- email="rsvancara_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI and Torque" -->
<!-- id="AANLkTi=XDXnY15dYMfC_6nbBDXyxwaKSexj9O7oH6vUC_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="AD0FA5D9-7B6D-45D6-9A16-C276C933D5FD_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-03-21 15:38:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15950.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<li><strong>Previous message:</strong> <a href="15948.php">Ralph Castain: "Re: [OMPI users] OpenMPI and Torque"</a>
<li><strong>In reply to:</strong> <a href="15948.php">Ralph Castain: "Re: [OMPI users] OpenMPI and Torque"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15950.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<li><strong>Reply:</strong> <a href="15950.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>I wish there was some kind of TM test tool, that would be really nice
<br>
for testing.
<br>
<p>I will ping the Torque list again.  Originally they forwarded me to
<br>
the openmpi list.
<br>
<p>On Mon, Mar 21, 2011 at 12:29 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt; mpiexec doesn't use pbsdsh (we use a TM API), but the affect is the same. Been so long since I ran on a Torque machine, though, that I honestly don't remember how to set the LD_LIBRARY_PATH on the backend.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Do you have a sys admin there whom you could ask? Or you could ping the Torque list about it - pretty standard issue.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Mar 21, 2011, at 1:19 PM, Randall Svancara wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Hi. &#160;The pbsdsh tool is great. &#160;I ran an interactive qsub session
</span><br>
<span class="quotelev2">&gt;&gt; (qsub -I -lnodes=2:ppn=12) and then rand the pbsdsh tool like this:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; [rsvancara_at_node164 ~]$ /usr/local/bin/pbsdsh &#160;-h node164 printenv
</span><br>
<span class="quotelev2">&gt;&gt; PATH=/bin:/usr/bin
</span><br>
...
<span class="quotelev2">&gt;&gt; PBS_O_WORKDIR=/home/admins/rsvancara/TEST
</span><br>
...
<span class="quotelev2">&gt;&gt; PBS_JOBID=1672.mgt1.wsuhpc.edu
</span><br>
<span class="quotelev2">&gt;&gt; PBS_QUEUE=batch
</span><br>
<span class="quotelev2">&gt;&gt; PBS_JOBCOOKIE=50E4985E63684BA781EE9294F21EE25E
</span><br>
<span class="quotelev2">&gt;&gt; PBS_NODENUM=0
</span><br>
<span class="quotelev2">&gt;&gt; PBS_TASKNUM=146
</span><br>
<span class="quotelev2">&gt;&gt; PBS_MOMPORT=15003
</span><br>
<span class="quotelev2">&gt;&gt; PBS_NODEFILE=/var/spool/torque/aux//1672.mgt1.wsuhpc.edu
</span><br>
...
<span class="quotelev2">&gt;&gt; ENVIRONMENT=BATCH
</span><br>
<span class="quotelev2">&gt;&gt; [rsvancara_at_node164 ~]$ /usr/local/bin/pbsdsh &#160;-h node163 printenv
</span><br>
<span class="quotelev2">&gt;&gt; PATH=/bin:/usr/bin
</span><br>
<span class="quotelev2">&gt;&gt; LANG=C
...
<span class="quotelev2">&gt;&gt; PBS_NODENUM=1
</span><br>
<span class="quotelev2">&gt;&gt; PBS_TASKNUM=147
</span><br>
<span class="quotelev2">&gt;&gt; PBS_MOMPORT=15003
</span><br>
<span class="quotelev2">&gt;&gt; PBS_VERSION=TORQUE-2.4.7
</span><br>
<span class="quotelev2">&gt;&gt; PBS_VNODENUM=12
</span><br>
<span class="quotelev2">&gt;&gt; PBS_ENVIRONMENT=PBS_BATCH
</span><br>
<span class="quotelev2">&gt;&gt; ENVIRONMENT=BATCH
...
<span class="quotelev2">&gt;&gt; So one thing that strikes me as bad is the LD_LIBRARY_PATH does not
</span><br>
<span class="quotelev2">&gt;&gt; appear available. &#160;Attempted to run mpiexec like this and it fails.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; [rsvancara_at_node164 ~]$ /usr/local/bin/pbsdsh &#160;-h node163
</span><br>
<span class="quotelev2">&gt;&gt; /home/software/mpi/intel/openmpi-1.4.3/bin/mpiexec hostname
</span><br>
<span class="quotelev2">&gt;&gt; /home/software/mpi/intel/openmpi-1.4.3/bin/mpiexec: error while
</span><br>
<span class="quotelev2">&gt;&gt; loading shared libraries: libimf.so: cannot open shared object file:
</span><br>
<span class="quotelev2">&gt;&gt; No such file or directory
</span><br>
<span class="quotelev2">&gt;&gt; pbsdsh: task 12 exit status 127
</span><br>
<span class="quotelev2">&gt;&gt; [rsvancara_at_node164 ~]$ /usr/local/bin/pbsdsh &#160;-h node164
</span><br>
<span class="quotelev2">&gt;&gt; /home/software/mpi/intel/openmpi-1.4.3/bin/mpiexec hostname
</span><br>
<span class="quotelev2">&gt;&gt; /home/software/mpi/intel/openmpi-1.4.3/bin/mpiexec: error while
...
<span class="quotelev2">&gt;&gt; pbsdsh: task 0 exit status 127
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; If this is how the openmpi processes are being launched, then it is no
</span><br>
<span class="quotelev2">&gt;&gt; wonder they are failing and the LD_LIBRARY_PATH error message is
</span><br>
<span class="quotelev2">&gt;&gt; indeed somewhat accurate.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; So the next question is how to I ensure that this information is
</span><br>
<span class="quotelev2">&gt;&gt; available to pbsdsh?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On Mon, Mar 21, 2011 at 11:24 AM, Randall Svancara &lt;rsvancara_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ok, these are good things to check. &#160;I am going to follow through with
</span><br>
<span class="quotelev3">&gt;&gt;&gt; this in the next hour after our GPFS upgrade. &#160;Thanks!!!
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Mon, Mar 21, 2011 at 11:14 AM, Brock Palen &lt;brockp_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mar 21, 2011, at 1:59 PM, Jeff Squyres wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I no longer run Torque on my cluster, so my Torqueology is pretty rusty -- but I think there's a Torque command to launch on remote nodes. &#160;tmrsh or pbsrsh or something like that...?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; pbsdsh
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; If TM is working pbsdsh should work fine.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Torque+OpenMPI has been working just fine for us.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Do you have libtorque on all your compute hosts? &#160;You should see it open on all hosts if it works.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
