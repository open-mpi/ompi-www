...
?>
<!-- received="Tue Mar 15 12:13:59 2011" -->
<!-- isoreceived="20110315161359" -->
<!-- sent="Tue, 15 Mar 2011 16:13:52 +0000" -->
<!-- isosent="20110315161352" -->
<!-- name="Belaid MOA" -->
<!-- email="belaid_moa_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI seg fault by a class with weird address." -->
<!-- id="BAY161-w53EDF2E62354614C3AF45F4CF0_at_phx.gbl" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="SNT134-w446E747B4B4D83EA918DD4CBCF0_at_phx.gbl" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-03-15 12:13:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15872.php">Jeff Squyres: "Re: [OMPI users] OMPI seg fault by a class with weird address."</a>
<li><strong>Previous message:</strong> <a href="15870.php">Jack Bryan: "Re: [OMPI users] OMPI seg fault by a class with weird address."</a>
<li><strong>In reply to:</strong> <a href="15870.php">Jack Bryan: "Re: [OMPI users] OMPI seg fault by a class with weird address."</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Subject: Re: [OMPI users] OMPI seg fault by a class with weird address.
<br>
<p><p><p><p><p><p><p><p>This should be the configure info about Open MPI which I am using. 
<br>
-bash-3.2$ mpic++ -v
<br>
<p>Using built-in
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-15871/attachment">attachment</a>
</ul>
