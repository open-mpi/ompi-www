...
?>
<!-- received="Mon Mar 21 15:29:58 2011" -->
<!-- isoreceived="20110321192958" -->
<!-- sent="Mon, 21 Mar 2011 13:29:47 -0600" -->
<!-- isosent="20110321192947" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI and Torque" -->
<!-- id="AD0FA5D9-7B6D-45D6-9A16-C276C933D5FD_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AANLkTi=cROuNJfKtVoL33iVBONkgBeRbKcF1hf2zr68Z_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-03-21 15:29:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15949.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<li><strong>Previous message:</strong> <a href="15947.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<li><strong>In reply to:</strong> <a href="15947.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15949.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<li><strong>Reply:</strong> <a href="15949.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Do you have a sys admin there whom you could ask? Or you could ping the Torque list about it - pretty standard issue.
<br>
<p><p>On Mar 21, 2011, at 1:19 PM, Randall Svancara wrote:
<br>
<p><span class="quotelev1">&gt; Hi.  The pbsdsh tool is great.  I ran an interactive qsub session
</span><br>
<span class="quotelev1">&gt; (qsub -I -lnodes=2:ppn=12) and then rand the pbsdsh tool like this:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [rsvancara_at_node164 ~]$ /usr/local/bin/pbsdsh  -h node164 printenv
</span><br>
<span class="quotelev1">&gt; PATH=/bin:/usr/bin
</span><br>
...
<span class="quotelev1">&gt; PBS_O_WORKDIR=/home/admins/rsvancara/TEST
</span><br>
...
<span class="quotelev1">&gt; PBS_JOBID=1672.mgt1.wsuhpc.edu
</span><br>
<span class="quotelev1">&gt; PBS_QUEUE=batch
</span><br>
<span class="quotelev1">&gt; PBS_JOBCOOKIE=50E4985E63684BA781EE9294F21EE25E
</span><br>
<span class="quotelev1">&gt; PBS_NODENUM=0
</span><br>
<span class="quotelev1">&gt; PBS_TASKNUM=146
</span><br>
<span class="quotelev1">&gt; PBS_MOMPORT=15003
</span><br>
<span class="quotelev1">&gt; PBS_NODEFILE=/var/spool/torque/aux//1672.mgt1.wsuhpc.edu
</span><br>
...
<span class="quotelev1">&gt; [rsvancara_at_node164 ~]$ /usr/local/bin/pbsdsh  -h node163 printenv
</span><br>
<span class="quotelev1">&gt; PATH=/bin:/usr/bin
</span><br>
<span class="quotelev1">&gt; LANG=C
...
<span class="quotelev1">&gt; PBS_NODENUM=1
</span><br>
<span class="quotelev1">&gt; PBS_TASKNUM=147
</span><br>
<span class="quotelev1">&gt; PBS_MOMPORT=15003
</span><br>
<span class="quotelev1">&gt; PBS_VERSION=TORQUE-2.4.7
</span><br>
<span class="quotelev1">&gt; PBS_VNODENUM=12
</span><br>
<span class="quotelev1">&gt; PBS_ENVIRONMENT=PBS_BATCH
</span><br>
<span class="quotelev1">&gt; ENVIRONMENT=BATCH
...
<span class="quotelev1">&gt; So one thing that strikes me as bad is the LD_LIBRARY_PATH does not
</span><br>
<span class="quotelev1">&gt; appear available.  Attempted to run mpiexec like this and it fails.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [rsvancara_at_node164 ~]$ /usr/local/bin/pbsdsh  -h node163
</span><br>
<span class="quotelev1">&gt; /home/software/mpi/intel/openmpi-1.4.3/bin/mpiexec hostname
</span><br>
<span class="quotelev1">&gt; /home/software/mpi/intel/openmpi-1.4.3/bin/mpiexec: error while
</span><br>
<span class="quotelev1">&gt; loading shared libraries: libimf.so: cannot open shared object file:
</span><br>
<span class="quotelev1">&gt; No such file or directory
</span><br>
<span class="quotelev1">&gt; pbsdsh: task 12 exit status 127
</span><br>
<span class="quotelev1">&gt; [rsvancara_at_node164 ~]$ /usr/local/bin/pbsdsh  -h node164
</span><br>
<span class="quotelev1">&gt; /home/software/mpi/intel/openmpi-1.4.3/bin/mpiexec hostname
</span><br>
<span class="quotelev1">&gt; /home/software/mpi/intel/openmpi-1.4.3/bin/mpiexec: error while
...
<span class="quotelev1">&gt; pbsdsh: task 0 exit status 127
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; If this is how the openmpi processes are being launched, then it is no
</span><br>
<span class="quotelev1">&gt; wonder they are failing and the LD_LIBRARY_PATH error message is
</span><br>
<span class="quotelev1">&gt; indeed somewhat accurate.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; So the next question is how to I ensure that this information is
</span><br>
<span class="quotelev1">&gt; available to pbsdsh?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Mon, Mar 21, 2011 at 11:24 AM, Randall Svancara &lt;rsvancara_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Ok, these are good things to check.  I am going to follow through with
</span><br>
<span class="quotelev2">&gt;&gt; this in the next hour after our GPFS upgrade.  Thanks!!!
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Mon, Mar 21, 2011 at 11:14 AM, Brock Palen &lt;brockp_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Mar 21, 2011, at 1:59 PM, Jeff Squyres wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I no longer run Torque on my cluster, so my Torqueology is pretty rusty -- but I think there's a Torque command to launch on remote nodes.  tmrsh or pbsrsh or something like that...?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; pbsdsh
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If TM is working pbsdsh should work fine.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Torque+OpenMPI has been working just fine for us.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Do you have libtorque on all your compute hosts?  You should see it open on all hosts if it works.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Try that and make sure it works.  Open MPI should be using the same API as that command under the covers.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I also have a dim recollection that the TM API support library(ies?) may not be installed by default.  You may have to ensure that they're available on all nodes...?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mar 21, 2011, at 1:53 PM, Randall Svancara wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I am not sure if there is any extra configuration necessary for torque
</span><br>
