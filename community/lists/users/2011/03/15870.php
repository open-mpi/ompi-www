...
?>
<!-- received="Tue Mar 15 11:44:41 2011" -->
<!-- isoreceived="20110315154441" -->
<!-- sent="Tue, 15 Mar 2011 09:44:35 -0600" -->
<!-- isosent="20110315154435" -->
<!-- name="Jack Bryan" -->
<!-- email="dtustudy68_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI seg fault by a class with weird address." -->
<!-- id="SNT134-w446E747B4B4D83EA918DD4CBCF0_at_phx.gbl" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="34A80259-F793-4465-8DD0-BBF753F24251_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-03-15 11:44:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15871.php">Belaid MOA: "Re: [OMPI users] OMPI seg fault by a class with weird address."</a>
<li><strong>Previous message:</strong> <a href="15869.php">Jack Bryan: "Re: [OMPI users] OMPI seg fault by a class with weird address."</a>
<li><strong>In reply to:</strong> <a href="15868.php">Samuel K. Gutierrez: "Re: [OMPI users] OMPI seg fault by a class with weird address."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15871.php">Belaid MOA: "Re: [OMPI users] OMPI seg fault by a class with weird address."</a>
<li><strong>Reply:</strong> <a href="15871.php">Belaid MOA: "Re: [OMPI users] OMPI seg fault by a class with weird address."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Subject: Re: [OMPI users] OMPI seg fault by a class with weird address.
<br>
<p>I -think- setting OMPI_MCA_memory_ptmalloc2_disable to 1 will turn off OMPI's memory wrappers without having to rebuild.  Someone please correct me if I'm wrong :-).
<br>
...
<br>
<p><p>_______________________________________________ users mailing list users_at_[hidden] <a href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>_______________________________________________
<br>
users mailing list
<br>
users_at_[hidden]
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-15870/attachment">attachment</a>
</ul>
