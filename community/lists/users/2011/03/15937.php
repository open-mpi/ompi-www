...
?>
<!-- received="Mon Mar 21 14:00:26 2011" -->
<!-- isoreceived="20110321180026" -->
<!-- sent="Mon, 21 Mar 2011 13:59:45 -0400" -->
<!-- isosent="20110321175945" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI and Torque" -->
<!-- id="2423B270-3B75-442D-9F83-DDD37628237C_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-03-21 13:59:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15938.php">Peter Thompson: "Re: [OMPI users] Displaying MAIN in Totalview"</a>
<li><strong>Previous message:</strong> <a href="15936.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<li><strong>In reply to:</strong> <a href="15936.php">Randall Svancara: "Re: [OMPI users] OpenMPI and Torque"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15941.php">Ralph Castain: "Re: [OMPI users] OpenMPI and Torque"</a>
<li><strong>Reply:</strong> <a href="15941.php">Ralph Castain: "Re: [OMPI users] OpenMPI and Torque"</a>
<li><strong>Reply:</strong> <a href="15944.php">Brock Palen: "Re: [OMPI users] OpenMPI and Torque"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I no longer run Torque on my cluster, so my Torqueology is pretty rusty -- but I think there's a Torque command to launch on remote nodes.  tmrsh or pbsrsh or something like that...?
<br>
<p>Try that and make sure it works.  Open MPI should be using the same API as that command under the covers.
<br>
<p>I also have a dim recollection that the TM API support library(ies?) may not be installed by default.  You may have to ensure that they're available on all nodes...?
<br>
<p><p>On Mar 21, 2011, at 1:53 PM, Randall Svancara wrote:
<br>
