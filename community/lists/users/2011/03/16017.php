...
?>
<!-- received="Sun Mar 27 15:08:48 2011" -->
<!-- isoreceived="20110327190848" -->
<!-- sent="Sun, 27 Mar 2011 13:08:31 -0600" -->
<!-- isosent="20110327190831" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI error terminate w/o reasons" -->
<!-- id="37787CBD-DD0E-4022-824A-5030163F1C7B_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="SNT134-w884361BB43FA7B2DA0B89CBBB0_at_phx.gbl" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-03-27 15:08:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16018.php">Jack Bryan: "Re: [OMPI users] OMPI error terminate w/o reasons"</a>
<li><strong>Previous message:</strong> <a href="16016.php">Jack Bryan: "Re: [OMPI users] OMPI error terminate w/o reasons"</a>
<li><strong>In reply to:</strong> <a href="16016.php">Jack Bryan: "Re: [OMPI users] OMPI error terminate w/o reasons"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16018.php">Jack Bryan: "Re: [OMPI users] OMPI error terminate w/o reasons"</a>
<li><strong>Reply:</strong> <a href="16018.php">Jack Bryan: "Re: [OMPI users] OMPI error terminate w/o reasons"</a>
<li><strong>Reply:</strong> <a href="16022.php">Jeff Squyres: "Re: [OMPI users] OMPI error terminate w/o reasons"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Talk to your sys admin about imposed limits. Usually, there are flags you can provide to your job submission that allow you to change limits for your program.
<br>
<p><p>On Mar 27, 2011, at 12:59 PM, Jack Bryan wrote:
<br>
<p><span class="quotelev1">&gt; Hi, I have figured out how to run the command. 
</span><br>
...
<span class="quotelev1">&gt;  mpirun -np 200  -rf $OMPI_RANKFILE --mca btl self,sm,openib -output-filename 700g200i200p14ye  ./myapplication 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; =&gt;&gt; PBS: job killed: node 18 (n314) requested job terminate, 'EOF' (code 1099) - received SISTER_EOF attempting to communicate with sister MOM's
</span><br>
...
<span class="quotelev1">&gt; After searching, I find that the error is probably related to the highly frequent I/O activities. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I have also run valgrind to do mem check in  order to find the possible reason for the original 
</span><br>
<span class="quotelev1">&gt; signal 9 (SIGKILL) problem. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; mpirun -np 200 -rf $OMPI_RANKFILE --mca btl self,sm,openib  /usr/bin/valgrind --tool=memcheck --error-limit=no --leak-check=yes --log-file=nsga2b_g700_pop200_p200_valg_cystorm_mpi.log  ./myapplication 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; I only want to find a way to find the bug, which only appears in the case that the problem size is very large. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; That command line cannot possibly work. Both the -rf and --output-filename options require arguments.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; PLEASE read the documentation? mpirun -h, or &quot;man mpirun&quot; will tell you how to correctly use these options.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; If you use that mpirun option, mpirun will place the output from each rank into a -separate- file for you. Give it:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16017/attachment">attachment</a>
</ul>
