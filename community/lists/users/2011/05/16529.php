...
?>
<!-- received="Thu May 12 10:22:23 2011" -->
<!-- isoreceived="20110512142223" -->
<!-- sent="Thu, 12 May 2011 07:22:28 -0700" -->
<!-- isosent="20110512142228" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Windows: MPI_Allreduce() crashes when using MPI_DOUBLE_PRECISION" -->
<!-- id="EFD938FC-768A-4E50-B785-BC8116E5540B_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-05-12 10:22:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16530.php">hi: "Re: [OMPI users] Windows: MPI_Allreduce() crashes when using MPI_DOUBLE_PRECISION"</a>
<li><strong>Previous message:</strong> <a href="16528.php">Brock Palen: "Re: [OMPI users] btl_openib_cpc_include rdmacm questions"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16531.php">Rainer Keller: "Re: [OMPI users] Windows: MPI_Allreduce() crashes when using MPI_DOUBLE_PRECISION"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Shiqing -- 
<br>
<p>Got any ideas here?  Are you able to run this sample program with mpif.h or use mpi on Windows?
<br>
<p><p>On May 11, 2011, at 12:29 AM, hi wrote:
<br>
...
<span class="quotelev1">&gt; From the HELP page...
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; see output of pre-built openmpi-1.5.3_x64/bin/ompi_info --all&quot; in attachments.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; You forgot ierr in the call to MPI_Finalize.  You also paired DOUBLE_PRECISION data with MPI_INTEGER in the call to allreduce.  And you mixed sndbuf and rcvbuf in the call to allreduce, meaning that when your print rcvbuf afterwards, it'll always still be 0.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; &lt;ompi_info_openmpi-1.5.3_x64.txt&gt;&lt;mar_f_dp.f&gt;
</span><br>
<p><p><pre>
-- 
Jeff Squyres
