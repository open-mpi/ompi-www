...
?>
<!-- received="Mon May  2 10:30:33 2011" -->
<!-- isoreceived="20110502143033" -->
<!-- sent="Mon, 2 May 2011 08:30:20 -0600" -->
<!-- isosent="20110502143020" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problems with the -xterm option" -->
<!-- id="8D3D6A79-7D5D-43DE-9F1D-F03FC1CF4287_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="BANLkTinAcMM=6ob_M7hR=drWRwMrtsxK_g_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-05-02 10:30:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16400.php">Jack Bryan: "Re: [OMPI users] OMPI vs. network socket communcation"</a>
<li><strong>Previous message:</strong> <a href="16398.php">jody: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>In reply to:</strong> <a href="16398.php">jody: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16412.php">jody: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>Reply:</strong> <a href="16412.php">jody: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; Well, the difference is that one time i call the application
</span><br>
<span class="quotelev1">&gt; 'HelloMPI' with the '--xterm' option,
</span><br>
<span class="quotelev1">&gt; whereas in my previous mail i am calling the application 'xterm'
</span><br>
<span class="quotelev1">&gt; (without the '--xterm' option)
</span><br>
<p>Ah, well that might explain it. I don't know how xterm would react to just being launched by mpirun onto a remote platform without any command to run. I can't explain what the plm verbosity has to do with anything, though.
<br>
<p><span class="quotelev1">&gt; Jody
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Mon, May 2, 2011 at 4:08 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On May 2, 2011, at 7:56 AM, jody wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Thank You for doing the fix.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Do you perhaps also have an idea what is going on when i try to start
</span><br>
<span class="quotelev3">&gt;&gt;&gt; xterm (or probably an other X application) on a remote host?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; In this case it is not enough to specify the '--leave-session-attached' option.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; These calls won't open any xterms
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  mpirun -np 4 -host squid_0 -mca plm_rsh_agent &quot;ssh -Y&quot;  -mca
</span><br>
<span class="quotelev3">&gt;&gt;&gt; plm_base_verbose 1 xterm
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  mpirun -np 4 -host squid_0 -mca plm_rsh_agent &quot;ssh -Y&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --leave-session-attached xterm
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  mpirun -np 4 -host squid_0 -mca plm_rsh_agent &quot;ssh -Y&quot;  -mca
</span><br>
<span class="quotelev3">&gt;&gt;&gt; odls_base_verbose 5 xterm
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  mpirun -np 4 -host squid_0 -mca plm_rsh_agent &quot;ssh -Y&quot;  -mca
</span><br>
<span class="quotelev3">&gt;&gt;&gt; odls_base_verbose 5 --leave-session-attached xterm
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; But this will open the xterms:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  mpirun -np 4 -host squid_0 -mca plm_rsh_agent &quot;ssh -Y&quot;  -mca
</span><br>
<span class="quotelev3">&gt;&gt;&gt; plm_base_verbose 1  --leave-session-attached xterm
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Any verbosity level &gt; 0 will open xterms, but with ' -mca
</span><br>
<span class="quotelev3">&gt;&gt;&gt; plm_base_verbose 0' there are again no xterms.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; No earthly idea...this seems to contradict what you had below. You said you were seeing the xterms with this cmd line:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Mon, May 2, 2011 at 2:29 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On May 2, 2011, at 2:34 AM, jody wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Okay, that's also expected. Like I said, without the &quot;hold&quot;, the output is generated so quickly that the window just flashes at best. I've had similar experiences - hence the &quot;hold&quot; option.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Okay, I can understand why. The --leave-session-attached option just tells mpirun to not daemonize the backend daemons - thus leaving the ssh session alive. The debug options do the same thing, but turn on all the debug output.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The problem is that if you don't leave the ssh session alive, then the xterm has no way back to your screen. By daemonizing, we severe that connection.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; What I should do (and maybe used to do, but it got removed) is automatically turn &quot;on&quot; the leave-session-attached option if you give --xterm. I can enter that patch.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Note that this does limit the size of the launch to the number of ssh sessions the system allows you to have open at the same time. We default to a limit of 128 nodes, which is likely adequate for an xterm-based debugging session. However, you can increase it using an mca param (see ompi_info) to as high as the system allows.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Thanks for helping debug this! I'll add you to the patch list so you can track it.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
