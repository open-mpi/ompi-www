...
?>
<!-- received="Thu May 26 00:42:10 2011" -->
<!-- isoreceived="20110526044210" -->
<!-- sent="Wed, 25 May 2011 23:42:05 -0500" -->
<!-- isosent="20110526044205" -->
<!-- name="Jagannath Mondal" -->
<!-- email="jagannath.mondal_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem using mpirun over multiple nodes" -->
<!-- id="BANLkTinyENNDtLuwWQLQ2cGzGOeUG8VPDw_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="098579E8-2BD2-4465-BE71-7C6168AC318A_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-05-26 00:42:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16638.php">francoise.roch_at_[hidden]: "Re: [OMPI users] MPI_COMM_DUP freeze with OpenMPI 1.4.1"</a>
<li><strong>Previous message:</strong> <a href="16636.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem using mpirun over multiple nodes"</a>
<li><strong>In reply to:</strong> <a href="16636.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem using mpirun over multiple nodes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16640.php">Jeff Squyres: "Re: [OMPI users] problem using mpirun over multiple nodes"</a>
<li><strong>Reply:</strong> <a href="16640.php">Jeff Squyres: "Re: [OMPI users] problem using mpirun over multiple nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Jagannath
<br>
<p>On Wed, May 25, 2011 at 10:42 PM, Jeff Squyres (jsquyres) &lt;
<br>
jsquyres_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Are you running any firewall software?
</span><br>
...
<span class="quotelev1">&gt; On May 25, 2011, at 10:41 PM, &quot;Jagannath Mondal&quot; &lt;
</span><br>
...
<span class="quotelev1">&gt; To run a job  over two 8-core processors, I generated a hostfile as
</span><br>
...
<span class="quotelev1">&gt; Then If I try to run the replica exchange simulation using the following
</span><br>
<span class="quotelev1">&gt; command:
</span><br>
<span class="quotelev1">&gt; mpirun -np 16 --hostfile  hostfile  mdrun_4mpi -s topol_.tpr -multi 16
</span><br>
...
<span class="quotelev1">&gt; btl_tcp_endpoint.c:636:mca_btl_tcp_endpoint_complete_connect] connect() to
</span><br>
<span class="quotelev1">&gt; 192.168.0.31 failed: No route to host (113)
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; I am not sure how to resolve this issue. In general, I can go from one
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16637/attachment">attachment</a>
</ul>
