...
?>
<!-- received="Mon May  2 09:56:52 2011" -->
<!-- isoreceived="20110502135652" -->
<!-- sent="Mon, 2 May 2011 15:56:48 +0200" -->
<!-- isosent="20110502135648" -->
<!-- name="jody" -->
<!-- email="jody.xha_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problems with the -xterm option" -->
<!-- id="BANLkTimi9stL1FQAa6DPo+cEVHc6PWwhJA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="09B97E83-2884-4903-8ACE-928BDA1B977B_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-05-02 09:56:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16397.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>Previous message:</strong> <a href="16395.php">Terry Dontje: "Re: [OMPI users] OMPI vs. network socket communcation"</a>
<li><strong>In reply to:</strong> <a href="16394.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16397.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>Reply:</strong> <a href="16397.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph
<br>
<p>Thank You for doing the fix.
<br>
<p>Do you perhaps also have an idea what is going on when i try to start
<br>
...
<br>
<p>These calls won't open any xterms
<br>
...
<br>
<p>But this will open the xterms:
<br>
&nbsp;&nbsp;mpirun -np 4 -host squid_0 -mca plm_rsh_agent &quot;ssh -Y&quot;  -mca
<br>
plm_base_verbose 1  --leave-session-attached xterm
<br>
<p>Any verbosity level &gt; 0 will open xterms, but with ' -mca
<br>
...
&nbsp;&nbsp;Jody
<br>
<p>On Mon, May 2, 2011 at 2:29 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
