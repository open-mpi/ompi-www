...
?>
<!-- received="Mon May  2 04:34:23 2011" -->
<!-- isoreceived="20110502083423" -->
<!-- sent="Mon, 2 May 2011 10:34:15 +0200" -->
<!-- isosent="20110502083415" -->
<!-- name="jody" -->
<!-- email="jody.xha_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problems with the -xterm option" -->
<!-- id="BANLkTinsGksziaxQVZWX3kGTrHrfi+i-XA_at_mail.gmail.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="BANLkTimLC=t4BwP7rYzOY=RYgXFyFHyYfw_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-05-02 04:34:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16402.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/04/16400.php">Jack Bryan: "[OMPI users] OMPI vs. network socket communcation"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/04/16391.php">jody: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16402.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>Reply:</strong> <a href="16402.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph
<br>
<p>I rebuilt open MPI 1.4.2 with the debug option on both chefli and squid_0.
<br>
The results are interesting!
<br>
<p>I wrote a small HelloMPI app which basically calls usleep for a pause
<br>
of 5 seconds.
<br>
<p>Now calling it as i did before, no MPI errors appear anymore, only the
<br>
display problems:
<br>
&nbsp;&nbsp;jody_at_chefli ~/share/neander $ mpirun -np 1 -host squid_0 -mca
<br>
plm_rsh_agent &quot;ssh -Y&quot; --xterm 0 ./HelloMPI
<br>
&nbsp;&nbsp;/usr/bin/xterm Xt error: Can't open display: localhost:10.0
<br>
<p>When i do the same call *with* the debug option, the xterm appears and
<br>
...
<br>
<p>Calling hostname the same way does not open an xterm (cf. ompidbg_2.txt).
<br>
<p>If i use the hold-option, the xterm appears with the output of
<br>
...
written (line 59)
<br>
<p>I just found that everything works as expected if i use the the
<br>
'--leave-session-attached' option (without the debug options):
<br>
&nbsp;&nbsp;jody_at_chefli ~/share/neander $ mpirun -np 4 -host squid_0 -mca
<br>
...
<br>
<p>What does *not* work is
<br>
&nbsp;&nbsp;jody_at_aim-triops ~/share/neander $ mpirun -np 2 -host squid_0 -mca
<br>
...
&nbsp;&nbsp;xterm:  DISPLAY is not set
<br>
<p>But then again, this call works (i.e. an xterm is opened) if all the
<br>
debug-options are used (ompidbg_4.txt).
<br>
Here the '--leave-session-attached' is necessary - without it, no xterm.
<br>
<p><span class="quotelev1">&gt;From these results i would say that there is no basic mishandling of
</span><br>
...
<br>
<p>I hope these observations are helpful
<br>
&nbsp;&nbsp;Jody
<br>
<p><p>On Fri, Apr 29, 2011 at 12:08 AM, jody &lt;jody.xha_at_[hidden]&gt; wrote:
<br>
...
<br><hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16401/ompidbg_1.txt">ompidbg_1.txt</a>
</ul>
<!-- attachment="ompidbg_1.txt" -->
<hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16401/ompidbg_2.txt">ompidbg_2.txt</a>
</ul>
<!-- attachment="ompidbg_2.txt" -->
<hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16401/ompidbg_3.txt">ompidbg_3.txt</a>
</ul>
<!-- attachment="ompidbg_3.txt" -->
<hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16401/ompidbg_4.txt">ompidbg_4.txt</a>
</ul>
<!-- attachment="ompidbg_4.txt" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
