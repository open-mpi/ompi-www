...
?>
<!-- received="Thu May 12 01:29:53 2011" -->
<!-- isoreceived="20110512052953" -->
<!-- sent="Thu, 12 May 2011 10:59:46 +0530" -->
<!-- isosent="20110512052946" -->
<!-- name="hi" -->
<!-- email="hiralsmaillist_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Windows: MPI_Allreduce() crashes when using MPI_DOUBLE_PRECISION" -->
<!-- id="BANLkTikoUxU4KgVCqE2i-NHszd6e-xRfWA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2011-05-12 01:29:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16524.php">hi: "Re: [OMPI users] Sorry! You were supposed to get help about: But couldn't open help-orterun.txt"</a>
<li><strong>Previous message:</strong> <a href="16522.php">alex su: "[OMPI users] Invitation to connect on LinkedIn"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16530.php">hi: "Re: [OMPI users] Windows: MPI_Allreduce() crashes when using MPI_DOUBLE_PRECISION"</a>
<li><strong>Reply:</strong> <a href="16530.php">hi: "Re: [OMPI users] Windows: MPI_Allreduce() crashes when using MPI_DOUBLE_PRECISION"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><p>On Wed, May 11, 2011 at 12:59 PM, hi &lt;hiralsmaillist_at_[hidden]&gt; wrote:
<br>
