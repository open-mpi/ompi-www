...
?>
<!-- received="Sun Apr  3 12:42:04 2011" -->
<!-- isoreceived="20110403164204" -->
<!-- sent="Sun, 3 Apr 2011 10:41:53 -0600" -->
<!-- isosent="20110403164153" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi/pbsdsh/Torque problem" -->
<!-- id="F8CAF544-F614-49AB-B3E8-16E6E2C7113D_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="BANLkTi=jHbhp=4EPWRowGtFEuco5A4EdFA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-03 12:41:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16084.php">Laurence Marks: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<li><strong>Previous message:</strong> <a href="16082.php">Laurence Marks: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<li><strong>In reply to:</strong> <a href="16082.php">Laurence Marks: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16084.php">Laurence Marks: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<li><strong>Reply:</strong> <a href="16084.php">Laurence Marks: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; On Sun, Apr 3, 2011 at 9:56 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; Somebody is playing an April Fools joke on you. The majority of supercomputers use ssh as their sole launch mechanism, and I have seen no indication that anyone intends to change that situation. That said, Torque is certainly popular and a good environment.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Alas, it is not an April fools joke, to quote from
</span><br>
<span class="quotelev1">&gt; <a href="http://www.bear.bham.ac.uk/bluebear/pbsdsh.shtml">http://www.bear.bham.ac.uk/bluebear/pbsdsh.shtml</a>
</span><br>
<span class="quotelev1">&gt; &quot;pbsdsh can be used as a replacement for an ssh or rsh command which
</span><br>
<span class="quotelev1">&gt; invokes a user command on a worker machine. Some applications expect
</span><br>
<span class="quotelev1">&gt; the availability of rsh or ssh  in order to invoke parts of the
</span><br>
<span class="quotelev1">&gt; computation on the sister worker nodes of the main worker. Using
</span><br>
<span class="quotelev1">&gt; pbsdsh instead is necessary on this cluster because direct use of ssh
</span><br>
<span class="quotelev1">&gt; or rsh is not allowed, for accounting and security reasons.&quot;
</span><br>
<p>Ah, but that is an administrative decision by a single organization - not the global supercomputer industry. :-)
<br>
...
<p>Not true with OMPI. Torque will kill mpirun, which will in turn cause all MPI procs to die. Yes, it's true that Torque won't know about the MPI procs itself. However, OMPI is designed such that termination of mpirun by the resource manager will cause all apps to die.
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev1">&gt; This can be done, and in fact I have a job running where non-mpi is
</span><br>
<span class="quotelev1">&gt; launched using pbsdsh but all the mpi is launched locally and this
</span><br>
<span class="quotelev1">&gt; seems to be working. This may be a viable, general solution but there
</span><br>
<span class="quotelev1">&gt; could also be issues with SCRATCH and other directories. In principle
</span><br>
<span class="quotelev1">&gt; there could also be issues with launching N mpi tasks from one node.
</span><br>
<span class="quotelev1">&gt; The executables I am using work well with very scattered cores, e.g.
</span><br>
<span class="quotelev1">&gt; using procs=64 or procs=256 but (at least with the system I am using)
</span><br>
<span class="quotelev1">&gt; I may only end up with 1 or 2 cores on the local node where the job
</span><br>
<span class="quotelev1">&gt; starts. (I've asked the sys admin people to find a way to do this
</span><br>
<span class="quotelev1">&gt; better, e.g. prefer launching from the node with the largest number of
</span><br>
<span class="quotelev1">&gt; cores available which I think can be done, but they do not have this
</span><br>
<span class="quotelev1">&gt; setup as yet.)
</span><br>
<p><p>Running multiple mpirun's in parallel on the same nodes definitely won't work, at least with OMPI. You would have to either ensure that each mpirun is launching apps on unique nodes (i.e., no two mpiruns have apps on the same node), or execute them serially.
<br>
<p>That is a pretty common constraint, not just one on OMPI - but I can't speak as definitively about the other MPIs out there.
<br>
