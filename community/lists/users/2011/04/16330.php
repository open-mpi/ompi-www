...
?>
<!-- received="Sat Apr 23 13:58:14 2011" -->
<!-- isoreceived="20110423175814" -->
<!-- sent="Sat, 23 Apr 2011 11:58:05 -0600" -->
<!-- isosent="20110423175805" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted" -->
<!-- id="18996F67-F381-4EC3-B79D-F79977AB497B_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4DB3128A.80601_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-23 13:58:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16331.php">Pablo Lopez Rios: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<li><strong>Previous message:</strong> <a href="16329.php">Pablo Lopez Rios: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<li><strong>In reply to:</strong> <a href="16329.php">Pablo Lopez Rios: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16332.php">Pablo Lopez Rios: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<li><strong>Reply:</strong> <a href="16332.php">Pablo Lopez Rios: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<li><strong>Reply:</strong> <a href="16333.php">Reuti: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev2">&gt;&gt; What about setsid and pushing it in a new
</span><br>
<span class="quotelev2">&gt;&gt; seesion instead of using&amp;  in the script?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; :-) That works. Thanks!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; NB, the working script looks like:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; setsid bash -c &quot;mpirun command&gt;&amp;  out&quot;&amp;
</span><br>
<span class="quotelev1">&gt; tail -f out
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<p>Yes - but now you can't kill mpirun when something goes wrong....&lt;shrug&gt;
<br>
...
<span class="quotelev1">&gt; On 23/04/11 18:39, Reuti wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Am 23.04.2011 um 19:33 schrieb Ralph Castain:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Apr 23, 2011, at 10:40 AM, Pablo Lopez Rios wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I'm not sure what you are actually trying to accomplish
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I simply want a script that runs the equivalent of:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun command&gt;&amp;   out&amp;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; tail -f out
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; such that hitting Ctrl+C stops tail but leaves mpirun running. I can certainly do this without mpirun,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I don't think that's true. If both commands are in a script, then at least for me, a ctrl-c of the -script- will cause ctrl-c to be sent to -both- processes.
</span><br>
<span class="quotelev2">&gt;&gt; What about setsid and pushing it in a new seesion instead of using&amp;  in the script?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; At least when I test it, even non-mpirun processes will abort.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; it's not unreasonable to expect to be able to do the same with mpirun.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm afraid it won't work, per my earlier comments.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I need mpirun to either ignore the SIGINT or not receive it at all -- and as per your comments, ignoring it is not an option.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Let me rephrase my question then. With the following script:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun command&gt;&amp;   out&amp;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; SIGINT stops tail AND mpirun. That's OK. The following:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; trap : SIGINT
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun command&gt;&amp;   out&amp;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; )
...
<span class="quotelev4">&gt;&gt;&gt;&gt; has the same effect, idicating that mpirun overrides previous traps in the same subshell. That's OK too. However the following:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (
...
<span class="quotelev4">&gt;&gt;&gt;&gt; also has the same effect. How is mpirun overriding the trap in the *parent* subshell so that it ends up getting the SIGINT that was supposedly blocked at that level? Am I missing something trivial? How can I avoid this?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I keep telling you - you can't. The better way to do this is to execute mpirun, and then run tail in a -separate- command. Now you can ctrl-c tail without mpirun seeing it.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; But you are welcome to not believe me and continue thrashing... :-/
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 23/04/11 16:27, Ralph Castain wrote:
</span><br>
