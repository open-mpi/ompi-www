...
?>
<!-- received="Wed Apr  6 09:30:49 2011" -->
<!-- isoreceived="20110406133049" -->
<!-- sent="Wed, 6 Apr 2011 13:30:43 +0000" -->
<!-- isosent="20110406133043" -->
<!-- name="Hellm&#252;ller  Roman" -->
<!-- email="hroman_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi self checkpointing - error while running	example" -->
<!-- id="41409C086371124DB9E054F9B1A8506F9382_at_MBX10.d.ethz.ch" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="BANLkTimAXqh-XfOUCDwGTZgHy=QhKBUHUg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-06 09:30:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16154.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>Previous message:</strong> <a href="16152.php">Nguyen Toan: "Re: [OMPI users] openmpi self checkpointing - error while running example"</a>
<li><strong>In reply to:</strong> <a href="16152.php">Nguyen Toan: "Re: [OMPI users] openmpi self checkpointing - error while running example"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/05/16618.php">Faisal: "Re: [OMPI users] openmpi self checkpointing - error while running	example"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Toan
<br>
<p>no that didn't change anything. i'm trying to restart the program on the computer it run before and i execute the ompi-restart on the same.
<br>
<p>machinefile_cbl1 contains just cbl1
<br>
<p>hroman_at_cbl1 ~/checkpoints $ ompi-restart -v -machinefile machinefile_cbl1 ompi_global_snapshot_28952.ckpt/
<br>
...
node2
<br>
<p>Now try to checkpoint and restart again with &quot;-machinefile MACHINES_FILE&quot;. Hope it works.
<br>
<p>On Wed, Apr 6, 2011 at 9:13 PM, Hellm&#252;ller Roman &lt;hroman_at_[hidden]&lt;mailto:hroman_at_[hidden]&gt;&gt; wrote:
<br>
Hi Toan
<br>
...
Nguyen Toan
<br>
<p>On Wed, Apr 6, 2011 at 7:05 PM, Hellm&#252;ller Roman &lt;hroman_at_[hidden]&lt;mailto:hroman_at_[hidden]&gt;&lt;mailto:hroman_at_[hidden]&lt;mailto:hroman_at_[hidden]&gt;&gt;&gt; wrote:
<br>
Hi
<br>
