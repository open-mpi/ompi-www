...
?>
<!-- received="Wed Apr 13 12:07:56 2011" -->
<!-- isoreceived="20110413160756" -->
<!-- sent="Wed, 13 Apr 2011 17:07:38 +0100" -->
<!-- isosent="20110413160738" -->
<!-- name="Rushton Martin" -->
<!-- email="JMRUSHTON_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Over committing?" -->
<!-- id="130271087079521072_at_towy" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="8E4700A0-7F9F-4404-88E5-C6A974DBC10D_at_staff.uni-marburg.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-13 12:07:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16227.php">Jack Bryan: "Re: [OMPI users] OMPI monitor each process behavior"</a>
<li><strong>Previous message:</strong> <a href="16225.php">Rushton Martin: "Re: [OMPI users] Over committing?"</a>
<li><strong>In reply to:</strong> <a href="16224.php">Reuti: "Re: [OMPI users] Over committing?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16238.php">Ralph Castain: "Re: [OMPI users] Over committing?"</a>
<li><strong>Reply:</strong> <a href="16238.php">Ralph Castain: "Re: [OMPI users] Over committing?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
the cluster.
<br>
<p>It could be memory, but I think not.  The jobs are well within memory
<br>
...
Subject: Re: [OMPI users] Over committing?
<br>
<p>Am 13.04.2011 um 17:09 schrieb Rushton Martin:
<br>
...
<p>How many cores do you have in each system? Looks like 8 is the maximum
<br>
IBM offers from their datasheet, and still you can request 16 per node?
<br>
<p>Can it be a memory porblem?
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; We have also tried test jobs on 8+7 (or 7+8) with inconclusive
</span><br>
results.
<br>
