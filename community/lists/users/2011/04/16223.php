...
?>
<!-- received="Wed Apr 13 11:52:04 2011" -->
<!-- isoreceived="20110413155204" -->
<!-- sent="Wed, 13 Apr 2011 11:51:50 -0400" -->
<!-- isosent="20110413155150" -->
...
<!-- id="45A45D8D2A0DBB49B1BE570660FCE2F503C319E9_at_naeapaxrez04v.nadsusea.nads.navy.mil" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="130270855379529040_at_towy" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-13 11:51:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16224.php">Reuti: "Re: [OMPI users] Over committing?"</a>
<li><strong>Previous message:</strong> <a href="16222.php">Rushton Martin: "Re: [OMPI users] Over committing?"</a>
<li><strong>In reply to:</strong> <a href="16222.php">Rushton Martin: "Re: [OMPI users] Over committing?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16225.php">Rushton Martin: "Re: [OMPI users] Over committing?"</a>
<li><strong>Reply:</strong> <a href="16225.php">Rushton Martin: "Re: [OMPI users] Over committing?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Martin,
<br>
<p>We have seen similar behavior when using certain codes.  CodeA can run at ppn=8 with no problem, but CodeB will run much more slowly (or hang) with ppn=8; instead we use ppn=7 for CodeB. 
<br>
<p>This becomes complicated when we run CodeA and CodeB together (coupled simulations).  It requires a bit of fancy language in the Torque script, but we are able to get these coupled jobs to run successfully. 
<br>
<p>Question: do you see this &quot;ppn=8 hanging behavior&quot; on every parallel code you run, or only on specific applications?  Do you see it with and without Torque?  Can you try running ppn=7 and ppn=8 on a simple mpi code? 
<br>
<p><p><p>-----Original Message-----
<br>
From: users-bounces_at_[hidden] [mailto:users-bounces_at_[hidden]] On Behalf Of Rushton Martin
<br>
...
<br><hr>
<ul>
<li>application/x-pkcs7-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16223/smime.p7s">smime.p7s</a>
</ul>
