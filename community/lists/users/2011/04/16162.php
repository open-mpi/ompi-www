...
?>
<!-- received="Wed Apr  6 14:29:18 2011" -->
<!-- isoreceived="20110406182918" -->
<!-- sent="Wed, 6 Apr 2011 12:29:08 -0600" -->
<!-- isosent="20110406182908" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problems with the -xterm option" -->
<!-- id="D2EA081C-BC70-4085-8506-EA8BA3799FB6_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="BANLkTimALLJkOf-aqcAPpt=5nL_+4WCeOA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-06 14:29:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16163.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>Previous message:</strong> <a href="16161.php">Terry Dontje: "Re: [OMPI users] mpi problems,"</a>
<li><strong>In reply to:</strong> <a href="16155.php">jody: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16163.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>Reply:</strong> <a href="16163.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; When trying to set up x11 forwarding over an ssh session to a remote server with the -X switch, I was getting an error like Warning: No xauth data; using fake authentication data for X11 forwarding.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; When doing something like:
</span><br>
<span class="quotelev1">&gt; ssh -Xl root 10.1.1.9 to a remote server, the authentication worked, but I got an error message like:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<p><p>See if that works for you - if it does, we may have to modify OMPI to accommodate.
<br>
<p><p>On Apr 6, 2011, at 9:19 AM, jody wrote:
<br>
...
<span class="quotelev2">&gt;&gt; If I read your error messages correctly, it looks like mpirun is crashing - the daemon is complaining that it lost the socket connection back to mpirun, and hence will abort.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; $ mpirun -np 4  -x DISPLAY -host squid_0 -xterm 1,2  printenv | grep WORLD_RANK
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16162/attachment">attachment</a>
</ul>
