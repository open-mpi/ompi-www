...
?>
<!-- received="Thu Apr  7 12:20:29 2011" -->
<!-- isoreceived="20110407162029" -->
<!-- sent="Thu, 7 Apr 2011 11:20:22 -0500" -->
<!-- isosent="20110407162022" -->
<!-- name="Nehemiah Dacres" -->
<!-- email="dacresni_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpi problems," -->
<!-- id="BANLkTimXz_2e6145jyYFzXudV9MHvnSCsw_at_mail.gmail.com" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="4D9D9274.6050204_at_oracle.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-07 12:20:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16188.php">Jeff Squyres: "Re: [OMPI users] OMPI 1.4.3 and &quot;make distclean&quot; error"</a>
<li><strong>Previous message:</strong> <a href="16186.php">Prentice Bisbal: "Re: [OMPI users] SGE and openmpi"</a>
<li><strong>In reply to:</strong> <a href="16181.php">Terry Dontje: "Re: [OMPI users] mpi problems,"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16127.php">Samuel K. Gutierrez: "Re: [OMPI users] mpi problems,"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt;  Nehemiah,
</span><br>
<span class="quotelev1">&gt; I took a look at an old version of a hpl Makefile I have.  I think what you
</span><br>
<span class="quotelev1">&gt; really want to do is not set the MP* variables to anything and near the end
</span><br>
<span class="quotelev1">&gt; of the Makefile set CC and LINKER to mpicc.  You may need to also change the
</span><br>
<span class="quotelev1">&gt; CFLAGS and LINKERFLAGS variables to match which compiler/arch you are
</span><br>
...
<span class="quotelev1">&gt; On 04/07/2011 06:20 AM, Terry Dontje wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Is there a reason you are trying to link with a static libmpi.  You really
</span><br>
<span class="quotelev1">&gt; want to link with libmpi.so.  It also seems like whatever Makefile you are
</span><br>
<span class="quotelev1">&gt; using is not using mpicc, is that true.  The reason that is important is
</span><br>
<span class="quotelev1">&gt; mpicc would pick up the right libs you needed.  Which brings me to Ralph's
</span><br>
<span class="quotelev1">&gt; comment, if you really want to go around the mpicc way of compiling use
</span><br>
<span class="quotelev1">&gt; mpicc --showme, copy the compile line shown in that commands output and
</span><br>
<span class="quotelev1">&gt; insert your files accordingly.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; --td
...
<span class="quotelev2">&gt;&gt;  also, I'm not sure if I'm reading the results right. According to the
</span><br>
<span class="quotelev2">&gt;&gt; last run, did using the sun compilers (update 1 )  result in higher
</span><br>
<span class="quotelev2">&gt;&gt; performance with sunct?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16187/attachment">attachment</a>
</ul>
