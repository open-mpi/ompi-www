...
?>
<!-- received="Sun Apr  3 11:12:29 2011" -->
<!-- isoreceived="20110403151229" -->
<!-- sent="Sun, 3 Apr 2011 17:12:16 +0200" -->
<!-- isosent="20110403151216" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi/pbsdsh/Torque problem" -->
<!-- id="BC3C38E3-3774-431B-A406-DA3CA3A0B9CF_at_staff.uni-marburg.de" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2011-04-03 11:12:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16081.php">Ralph Castain: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<li><strong>Previous message:</strong> <a href="16079.php">Ralph Castain: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<li><strong>In reply to:</strong> <a href="16079.php">Ralph Castain: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16081.php">Ralph Castain: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<li><strong>Reply:</strong> <a href="16081.php">Ralph Castain: "Re: [OMPI users] openmpi/pbsdsh/Torque problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; On Apr 3, 2011, at 8:14 AM, Laurence Marks wrote:
</span><br>
...
<span class="quotelev1">&gt; Somebody is playing an April Fools joke on you. The majority of supercomputers use ssh as their sole launch mechanism, and I have seen no
</span><br>
<span class="quotelev1">&gt; indication that anyone intends to change that situation. That said, Torque is certainly popular and a good environment.
</span><br>
<p>I operate my Linux clusters without `ssh` or `rsh`. I use SGE's `qrsh` instead. How will you get a tight integration with correct accounting and job control otherwise? This might be different when you have an AIX or NEC SX machine, as they provide additonal control mechanisms.
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev2">&gt;&gt; Getting pbsdsh is
</span><br>
...
<span class="quotelev2">&gt;&gt; pbsdsh -h $1 /bin/bash -lc &quot; $PBS_O_WORKDIR/.tmp_$1  &quot;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; echo source $HOME/.bashrc                       &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo cd $PBS_O_WORKDIR                          &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PATH=$PBS_O_PATH                    &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export TMPDIR=$TMPDIR                      &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export SCRATCH=$SCRATCH                    &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export LD_LIBRARY_PATH=$LD_LIBRARY_PATH    &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; echo export PBS_ENVIRONMENT=$PBS_ENVIRONMENT    &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_JOBCOOKIE=$PBS_JOBCOOKIE        &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_JOBID=$PBS_JOBID                &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_JOBNAME=$PBS_JOBNAME            &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_MOMPORT=$PBS_MOMPORT            &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_NODENUM=$PBS_NODENUM            &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_O_HOME=$PBS_O_HOME              &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_O_HOST=$PBS_O_HOST              &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_O_LANG=$PBS_O_LANG              &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_O_LOGNAME=$PBS_O_LOGNAME        &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_O_MAIL=$PBS_O_MAIL              &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_O_PATH=$PBS_O_PATH              &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_O_QUEUE=$PBS_O_QUEUE            &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_O_SHELL=$PBS_O_SHELL            &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_O_WORKDIR=$PBS_O_WORKDIR        &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_QUEUE=$PBS_QUEUE                &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_TASKNUM=$PBS_TASKNUM            &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; echo export PBS_VNODENUM=$PBS_VNODENUM          &gt;&gt; $PBS_O_WORKDIR/.tmp_$1
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
