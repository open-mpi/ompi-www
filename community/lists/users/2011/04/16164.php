...
?>
<!-- received="Wed Apr  6 14:32:30 2011" -->
<!-- isoreceived="20110406183230" -->
<!-- sent="Wed, 6 Apr 2011 12:32:21 -0600" -->
<!-- isosent="20110406183221" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problems with the -xterm option" -->
<!-- id="7A29DCCC-2E9A-4D80-9B7D-6AB7ABC5BCCE_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="2B91D5A7-248D-4BE3-BBFC-8596BBB569B2_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-06 14:32:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16165.php">David Gunter: "[OMPI users] OMPI 1.4.3 and &quot;make distclean&quot; error"</a>
<li><strong>Previous message:</strong> <a href="16163.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>In reply to:</strong> <a href="16163.php">Ralph Castain: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16185.php">jody: "Re: [OMPI users] problems with the -xterm option"</a>
<li><strong>Reply:</strong> <a href="16185.php">jody: "Re: [OMPI users] problems with the -xterm option"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Here's a little more info - it's for Cygwin, but I don't see anything Cygwin-specific in the answers:
<br>
<p><a href="http://x.cygwin.com/docs/faq/cygwin-x-faq.html#q-ssh-no-x11forwarding">http://x.cygwin.com/docs/faq/cygwin-x-faq.html#q-ssh-no-x11forwarding</a>
<br>
<p><p>On Apr 6, 2011, at 12:30 PM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; Sorry Jody - I should have read your note more carefully to see that you already tried -Y. :-(
</span><br>
...
<span class="quotelev2">&gt;&gt; Like I said, I'm not expert. However, a quick &quot;google&quot; of revealed this result:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; When trying to set up x11 forwarding over an ssh session to a remote server with the -X switch, I was getting an error like Warning: No xauth data; using fake authentication data for X11 forwarding.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; When doing something like:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ssh -Xl root 10.1.1.9 to a remote server, the authentication worked, but I got an error message like:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; See if that works for you - if it does, we may have to modify OMPI to accommodate.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; If I read your error messages correctly, it looks like mpirun is crashing - the daemon is complaining that it lost the socket connection back to mpirun, and hence will abort.
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16164/attachment">attachment</a>
</ul>
