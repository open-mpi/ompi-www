...
?>
<!-- received="Sat Apr 23 11:15:25 2011" -->
<!-- isoreceived="20110423151525" -->
<!-- sent="Sat, 23 Apr 2011 09:15:16 -0600" -->
<!-- isosent="20110423151516" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted" -->
<!-- id="62D86865-6843-4827-90DE-8F62D83DD3D2_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-04-23 11:15:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16324.php">Ralph Castain: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<li><strong>Previous message:</strong> <a href="16322.php">Pablo Lopez Rios: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16325.php">Reuti: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; I think I'm off by one in interpreting the above masks (for instance I would expect signals 30 and 31 to be caught, not 31 and 32), but I'm already assuming that the least significant bit is &quot;signal 0&quot;; assuming it is &quot;signal 1&quot; would just worsen the values.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Anyway, why does mpirun bypass the traps I try to set and how do I stop it doing so?
</span><br>
<p>You can't - this is a design requirement for clean termination of MPI jobs when the user interrupts execution.
<br>
