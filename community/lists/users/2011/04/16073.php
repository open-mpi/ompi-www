...
<p class="headers">
<strong>Subject:</strong> [OMPI users] OMPI not calling finalize error<br>
<strong>From:</strong> Jack Bryan (<em>dtustudy68_at_[hidden]</em>)<br>
<strong>Date:</strong> 2011-04-02 11:05:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16074.php">David Zhang: "Re: [OMPI users] OMPI not calling finalize error"</a>
<li><strong>Previous message:</strong> <a href="16072.php">Satoi Ogawa: "[OMPI users] MPI-2 I/O functions (Open MPI 1.5.x on Windows)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16074.php">David Zhang: "Re: [OMPI users] OMPI not calling finalize error"</a>
<li><strong>Reply:</strong> <a href="16074.php">David Zhang: "Re: [OMPI users] OMPI not calling finalize error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-16073/attachment">attachment</a>
</ul>
