...
?>
<!-- received="Sat Apr 23 14:07:36 2011" -->
<!-- isoreceived="20110423180736" -->
<!-- sent="Sat, 23 Apr 2011 20:07:22 +0200" -->
<!-- isosent="20110423180722" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted" -->
<!-- id="20F0F1A4-9069-4FC4-BF21-CC2070B6CFB8_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="18996F67-F381-4EC3-B79D-F79977AB497B_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-04-23 14:07:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="16334.php">Ralph Castain: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<li><strong>Previous message:</strong> <a href="16332.php">Pablo Lopez Rios: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<li><strong>In reply to:</strong> <a href="16330.php">Ralph Castain: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="16334.php">Ralph Castain: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<li><strong>Reply:</strong> <a href="16334.php">Ralph Castain: "Re: [OMPI users] OpenMPI exits when subsequent tail -f in script is interrupted"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; On Apr 23, 2011, at 11:55 AM, Pablo Lopez Rios wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; What about setsid and pushing it in a new
</span><br>
<span class="quotelev3">&gt;&gt;&gt; seesion instead of using&amp;  in the script?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; :-) That works. Thanks!
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; NB, the working script looks like:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; setsid bash -c &quot;mpirun command&gt;&amp;  out&quot;&amp;
</span><br>
...
<span class="quotelev1">&gt; Yes - but now you can't kill mpirun when something goes wrong....&lt;shrug&gt;
</span><br>
<p>You can still send a sigint from the command line to the mpirun process or its process group besides killall.
<br>
<p>-- Reuti
<br>
...
<span class="quotelev2">&gt;&gt; On 23/04/11 18:39, Reuti wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Am 23.04.2011 um 19:33 schrieb Ralph Castain:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Apr 23, 2011, at 10:40 AM, Pablo Lopez Rios wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I'm not sure what you are actually trying to accomplish
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I don't think that's true. If both commands are in a script, then at least for me, a ctrl-c of the -script- will cause ctrl-c to be sent to -both- processes.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; What about setsid and pushing it in a new seesion instead of using&amp;  in the script?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; At least when I test it, even non-mpirun processes will abort.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; it's not unreasonable to expect to be able to do the same with mpirun.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm afraid it won't work, per my earlier comments.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I need mpirun to either ignore the SIGINT or not receive it at all -- and as per your comments, ignoring it is not an option.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I keep telling you - you can't. The better way to do this is to execute mpirun, and then run tail in a -separate- command. Now you can ctrl-c tail without mpirun seeing it.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; But you are welcome to not believe me and continue thrashing... :-/
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
