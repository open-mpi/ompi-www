...
?>
<!-- received="Mon Nov 28 18:56:20 2011" -->
<!-- isoreceived="20111128235620" -->
<!-- sent="Mon, 28 Nov 2011 16:56:11 -0700" -->
<!-- isosent="20111128235611" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How are the Open MPI processes spawned?" -->
<!-- id="B7956569-2B50-4166-A164-9757E4FF06EC_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="A9C264C2-8175-4E83-927E-0245086E0F21_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-11-28 18:56:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17849.php">Jeff Squyres: "Re: [OMPI users] How are the Open MPI processes spawned?"</a>
<li><strong>Previous message:</strong> <a href="17847.php">Jeff Squyres: "Re: [OMPI users] How are the Open MPI processes spawned?"</a>
<li><strong>In reply to:</strong> <a href="17846.php">Jeff Squyres: "Re: [OMPI users] How are the Open MPI processes spawned?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17849.php">Jeff Squyres: "Re: [OMPI users] How are the Open MPI processes spawned?"</a>
<li><strong>Reply:</strong> <a href="17849.php">Jeff Squyres: "Re: [OMPI users] How are the Open MPI processes spawned?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I'm afraid that example is incorrect - you were running under slurm on your cluster, not rsh. If you look at the actual code, you will see that we slurp up the envars into the environment of each app_context, and then send that to the backend.
<br>
<p>In environments like slurm, we can also apply those envars to the launch of the orteds as we pass the env to the API that launches the orteds. You cannot do that with rsh, as you know.
<br>
<p>So on rsh, we do not put envar mca params onto the orted cmd line. This has been noted repeatedly on the user and devel lists, so it really has always been the case.
<br>
<p>HTH
<br>
Ralph
<br>
<p>On Nov 28, 2011, at 3:39 PM, Jeff Squyres wrote:
<br>
<p><span class="quotelev1">&gt; (off list)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Are you sure about OMPI_MCA_* params not being treated specially?  I know for a fact that they *used* to be.  I.e., we bundled up all env variables that began with OMPI_MCA_* and sent them with the job to back-end nodes.  It allowed sysadmins to set global MCA param values without editing the MCA param file on every node.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; It looks like this is still happening on the trunk:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [14:38] svbu-mpi:~ % cat run
</span><br>
<span class="quotelev1">&gt; #!/bin/csh -f
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; echo on `hostname`, foo is: $OMPI_MCA_foo
</span><br>
<span class="quotelev1">&gt; exit 0
</span><br>
<span class="quotelev1">&gt; [14:38] svbu-mpi:~ % setenv OMPI_MCA_foo bar
</span><br>
<span class="quotelev1">&gt; [14:38] svbu-mpi:~ % ./run
</span><br>
<span class="quotelev1">&gt; on svbu-mpi.cisco.com, foo is: bar
</span><br>
<span class="quotelev1">&gt; [14:38] svbu-mpi:~ % mpirun -np 2 --bynode run
</span><br>
<span class="quotelev1">&gt; on svbu-mpi044, foo is: bar
</span><br>
<span class="quotelev1">&gt; on svbu-mpi043, foo is: bar
</span><br>
<span class="quotelev1">&gt; [14:38] svbu-mpi:~ % unsetenv OMPI_MCA_foo
</span><br>
<span class="quotelev1">&gt; [14:38] svbu-mpi:~ % mpirun -np 2 --bynode run
</span><br>
<span class="quotelev1">&gt; OMPI_MCA_foo: Undefined variable.
</span><br>
<span class="quotelev1">&gt; OMPI_MCA_foo: Undefined variable.
</span><br>
<span class="quotelev1">&gt; -------------------------------------------------------
...
<span class="quotelev1">&gt; [14:38] svbu-mpi:~ % 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; (I did not read this thread too carefully, so perhaps I missed an inference in here somewhere...)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; On Nov 25, 2011, at 5:21 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Nov 25, 2011, at 12:29 PM, Paul Kapinos wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; It is indeed supposed to do the former - as I implied, this is a bug in the 1.5 series.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Thanks for clarification. I was not sure about this is a bug or a feature :-)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; We have debated about this for some time - there is a timeout mca param one can set, but we'll consider again making it default.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Probably the right approach at this time.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ahhh.. sorry, did not understand what you mean.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Did you filed it, or someone else, or should I do it in some way? Or should not?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I'll take care of it, and copy you on the ticket so you can see what happens.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I'll also do the same for the connection bug - sorry for the problem :-(
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; No, that isn't what is happening. The problem lies in the behavior of rsh/ssh. This environment does not forward environmental variables. Because of limits on cmd line length, we don't automatically forward MCA params from the environment, but only from the cmd line. It is an annoying limitation, but one outside our control.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; We know about &quot;ssh does not forward environmental variables.&quot; But in this case, are these parameters not the parameters of mpiexec itself, too?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The crucial thing is, that setting of the parameters works over the command line but *does not work* over the envvar way (as in <a href="http://www.open-mpi.org/faq/?category=tuning#setting-mca-params">http://www.open-mpi.org/faq/?category=tuning#setting-mca-params</a> described). This looks like a bug for me!
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Put those envars in the default mca param file and the problem will be resolved.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; You mean e.g. $prefix/etc/openmpi-mca-params.conf as described in 4. of <a href="http://www.open-mpi.org/faq/?category=tuning#setting-mca-params">http://www.open-mpi.org/faq/?category=tuning#setting-mca-params</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Well, this is possible, but not flexible enough for us (because there are some machines which only can run if the parameters are *not* set - on those the ssh goes just over these eth0 devices).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; By now we use the command line parameters and hope the envvar way will work sometimes.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm surprised by that - they should be picked up and forwarded. Could be a bug
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Well, I also mean this is a bug, but as said not on providing the values of envvars but on detecting of these parameters at all. Or maybe on both.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Well, they are OMPI_ variables and should be provided in any case).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; No, they aren't - they are not treated differently than any other envar.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [after performing some RTFM...]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; at least the man page of mpiexec says, the OMPI_ environment variables are always provided and thus treated *differently* than other envvars:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; $ man mpiexec
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ....
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Exported Environment Variables
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     All environment variables that are named in the form OMPI_* will  automatically  be  exported to new processes on the local and remote nodes.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So, tells the man page lies, or this is an removed feature, or something else?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
