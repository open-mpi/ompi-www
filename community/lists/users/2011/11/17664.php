...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17665.php">Jeff Squyres (jsquyres): "Re: [OMPI users] probl&#195;&#168;me with MPI_FINALIZE"</a>
<li><strong>Previous message:</strong> <a href="17663.php">Blosch, Edwin L: "[OMPI users] How to set up state-less node /tmp for OpenMPI usage"</a>
<li><strong>In reply to:</strong> <a href="17662.php">Mudassar Majeed: "[OMPI users] Sending vector elements of type T using MPI_Ssend, plz help."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17666.php">German Hoecht: "Re: [OMPI users] Sending vector elements of type T using MPI_Ssend, plz help."</a>
<li><strong>Reply:</strong> <a href="17666.php">German Hoecht: "Re: [OMPI users] Sending vector elements of type T using MPI_Ssend, plz help."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17664/attachment">attachment</a>
</ul>
