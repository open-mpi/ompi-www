...
?>
<!-- received="Tue Nov 29 08:59:06 2011" -->
<!-- isoreceived="20111129135906" -->
<!-- sent="Tue, 29 Nov 2011 13:59:32 -0000" -->
<!-- isosent="20111129135932" -->
<!-- name="MM" -->
<!-- email="finjulhich_at_[hidden]" -->
<!-- subject="Re: [OMPI users] orte_debugger_select and orte_ess_set_name failed" -->
<!-- id="000701ccae9f$207a97c0$616fc740$_at_com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-11-29 08:59:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17858.php">Shiqing Fan: "Re: [OMPI users] orte_debugger_select and orte_ess_set_name failed"</a>
<li><strong>Previous message:</strong> <a href="17856.php">MM: "Re: [OMPI users] orte_debugger_select and orte_ess_set_name failed"</a>
<li><strong>Maybe in reply to:</strong> <a href="17790.php">MM: "[OMPI users] orte_debugger_select and orte_ess_set_name failed"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17858.php">Shiqing Fan: "Re: [OMPI users] orte_debugger_select and orte_ess_set_name failed"</a>
<li><strong>Reply:</strong> <a href="17858.php">Shiqing Fan: "Re: [OMPI users] orte_debugger_select and orte_ess_set_name failed"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>components_available list appears to be empty, ie 
<br>
orte_debugger_base_components_available appears to be empty (opal list
<br>
length=0)
<br>
<p>Is this an indication of something meaningful?
<br>
<p>Note, I built opnempi static libs (with dll c/c++ runtime)
<br>
