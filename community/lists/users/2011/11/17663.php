...
<p class="headers">
<strong>Subject:</strong> [OMPI users] How to set up state-less node /tmp for OpenMPI usage<br>
<strong>From:</strong> Blosch, Edwin L (<em>edwin.l.blosch_at_[hidden]</em>)<br>
<strong>Date:</strong> 2011-11-01 19:31:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17664.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Sending vector elements of type T using MPI_Ssend, plz help."</a>
<li><strong>Previous message:</strong> <a href="17662.php">Mudassar Majeed: "[OMPI users] Sending vector elements of type T using MPI_Ssend, plz help."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17677.php">Jeff Squyres: "Re: [OMPI users] How to set up state-less node /tmp for OpenMPI usage"</a>
<li><strong>Reply:</strong> <a href="17677.php">Jeff Squyres: "Re: [OMPI users] How to set up state-less node /tmp for OpenMPI usage"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17663/attachment">attachment</a>
</ul>
