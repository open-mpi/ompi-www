...
?>
<!-- received="Sun Nov 13 10:34:45 2011" -->
<!-- isoreceived="20111113153445" -->
<!-- sent="Sun, 13 Nov 2011 10:34:39 -0500" -->
<!-- isosent="20111113153439" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Troubles using MPI_Isend/MPI_Irecv/MPI_Waitany and MPI_Allreduce" -->
<!-- id="41033DA3-DB11-4D18-A019-9EC6C453970A_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="1321182913.1928.1.camel_at_laika" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-11-13 10:34:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17764.php">Naor Movshovitz: "[OMPI users] Is it not possible to run a program with MPI code without mpirun/mpiexec?"</a>
<li><strong>Previous message:</strong> <a href="17762.php">Pedro Gonnet: "Re: [OMPI users] Troubles using MPI_Isend/MPI_Irecv/MPI_Waitany and MPI_Allreduce"</a>
<li><strong>In reply to:</strong> <a href="17762.php">Pedro Gonnet: "Re: [OMPI users] Troubles using MPI_Isend/MPI_Irecv/MPI_Waitany and MPI_Allreduce"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Glad it worked!
<br>
<p>On Nov 13, 2011, at 6:15 AM, Pedro Gonnet wrote:
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Sorry for the long delay on my behalf too.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Using MPI_Init_thread with MPI_THREAD_MULTIPLE fixes this problem!
</span><br>
<span class="quotelev1">&gt; Should have had a closer look at the documentation...
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; I think you need to use MPI_INIT_THREAD with a level of
</span><br>
<span class="quotelev2">&gt;&gt; MPI_THREAD_MULTIPLE instead of MPI_INIT. This sets up internal locking
</span><br>
<span class="quotelev2">&gt;&gt; in Open MPI to protect against multiple threads inside the progress
</span><br>
<span class="quotelev2">&gt;&gt; engine, etc. 
</span><br>
<span class="quotelev2">&gt;&gt; Be aware that only some of Open MPI's transports are THREAD_MULTIPLE
</span><br>
<span class="quotelev2">&gt;&gt; safe -- see the README for more detail. 
</span><br>
<span class="quotelev2">&gt;&gt; On Oct 23, 2011, at 1:11 PM, Pedro Gonnet wrote: 
</span><br>
