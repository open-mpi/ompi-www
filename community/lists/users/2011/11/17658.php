...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17659.php">Durga Choudhury: "Re: [OMPI users] probl&#232;me with MPI_FINALIZE"</a>
<li><strong>Previous message:</strong> <a href="17657.php">Jeff Squyres (jsquyres): "Re: [OMPI users] probl&#195;&#168;me with MPI_FINALIZE"</a>
<li><strong>In reply to:</strong> <a href="17656.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Sending vector elements of type T using MPI_Ssend, plz help."</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
