...
?>
<!-- received="Tue Nov  8 17:14:25 2011" -->
<!-- isoreceived="20111108221425" -->
<!-- sent="Tue, 8 Nov 2011 17:14:21 -0500" -->
<!-- isosent="20111108221421" -->
<!-- name="Gustavo Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem building OpenMPI 1.4.4 with PGI 11.7 compilers" -->
<!-- id="6C5EEE2D-E1D7-434F-8348-222B9823342B_at_ldeo.columbia.edu" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-11-08 17:14:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17728.php">George Bosilca: "[OMPI users] [OMPI devel] Open MPI BOF"</a>
<li><strong>Previous message:</strong> <a href="17726.php">Samuel K. Gutierrez: "Re: [OMPI users] Problem building OpenMPI 1.4.4 with PGI 11.7 compilers"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17730.php">Jeff Squyres: "Re: [OMPI users] Problem building OpenMPI 1.4.4 with PGI 11.7 compilers"</a>
<li><strong>Reply:</strong> <a href="17730.php">Jeff Squyres: "Re: [OMPI users] Problem building OpenMPI 1.4.4 with PGI 11.7 compilers"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Thank you, Samuel
<br>
<p>I was hoping not to have to change my Gnu auto tools in the cluster.
<br>
I remain a bit skeptical that libtool is the main culprit.
<br>
<p>Somehow OpenMPI 1.4.3 builds fine in the very same computer
<br>
with the same libtool, same PGI 11.7, same compiler flags.
<br>
In the OMPI 1.4.3 make log there are several lines with 'libtool: link: pgcc' followed 
<br>
...
<br>
I would guess this is the right thing to do, no funny optimization flags chosen by 
<br>
the user in a malloc library. 
<br>
Here it is:
<br>
<p>libtool: link: pgcc -shared  -fpic -DPIC  .libs/dummy.o   -lnsl -lutil -lc    -Wl,-soname -Wl,libopenmpi_malloc.so.0 -o .libs/libopenmpi_malloc.so.0.0.0
<br>
<p>However, the same setup doesn't work with OMPI 1.4.4.
<br>
That particular line in the make log is [note the added '-tp']:
<br>
<p>libtool: link: pgcc -shared  -fpic -DPIC  .libs/dummy.o   -lnsl -lutil -lc  -tp   -Wl,-soname -Wl,libopenmpi_malloc.so.0 -o .libs/libopenmpi_malloc.so.0.0.0
<br>
<p>Hence, I am more inclined to think that there was a change from  the 1.4.3 to  
<br>
...
<br>
<p>I can send the gzipped configure and make logs of 1.4.3 and 1.4.4 if that helps.
<br>
...
Gus Correa
<br>
<p><p>On Nov 8, 2011, at 4:24 PM, Samuel K. Gutierrez wrote:
<br>
