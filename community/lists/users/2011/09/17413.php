...
?>
<!-- received="Fri Sep 23 14:34:33 2011" -->
<!-- isoreceived="20110923183433" -->
<!-- sent="Fri, 23 Sep 2011 15:34:20 -0300" -->
<!-- isosent="20110923183420" -->
<!-- name="Guilherme V" -->
<!-- email="list.vilela_at_[hidden]" -->
<!-- subject="[OMPI users] Fault Tolerant with openib" -->
<!-- id="CAB-q1Yv=-Cj-6SOzx6KT8bUHg9aty+6BL78SoAc+WVF_7icuMA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-09-23 14:34:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17414.php">Guilherme V: "[OMPI users] Fault Tolerant with openib"</a>
<li><strong>Previous message:</strong> <a href="17412.php">Waclaw Kusnierczyk: "Re: [OMPI users] openmpi -cc=&lt;compiler name&gt; option"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17415.php">Ralph Castain: "Re: [OMPI users] Fault Tolerant with openib"</a>
<li><strong>Reply:</strong> <a href="17415.php">Ralph Castain: "Re: [OMPI users] Fault Tolerant with openib"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17413/attachment">attachment</a>
</ul>
