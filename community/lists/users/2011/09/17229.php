...
?>
<!-- received="Mon Sep 12 13:08:11 2011" -->
<!-- isoreceived="20110912170811" -->
<!-- sent="Mon, 12 Sep 2011 11:08:00 -0600" -->
<!-- isosent="20110912170800" -->
<!-- name="Blosch, Edwin L" -->
<!-- email="edwin.l.blosch_at_[hidden]" -->
<!-- subject="Re: [OMPI users] qp memory allocation problem" -->
<!-- id="E9F276A0010AF44ABD2C03ED2EDAE7DB275E2E5B31_at_HDXMSPB.us.lmco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-09-12 13:08:00
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17230.php">Nathan Hjelm: "Re: [OMPI users] EXTERNAL: Re:  qp memory allocation problem"</a>
<li><strong>Previous message:</strong> <a href="17228.php">Nathan Hjelm: "Re: [OMPI users] EXTERNAL: Re:  qp memory allocation problem"</a>
<li><strong>In reply to:</strong> <a href="17226.php">Shamis, Pavel: "Re: [OMPI users] qp memory allocation problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17231.php">Jeff Squyres: "Re: [OMPI users] qp memory allocation problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Actually we were already aware of this FAQ and already have the limits set to hard and soft unlimited in the PAM limits.conf as well as in the pbs_mom resource manager startup script.  We encountered those issues a few years ago and definitely are aware of having process limits set too low.  I don't think we are suffering from that particular problem.
<br>
<p><p>Samuel's suggestion worked, and we're trying Nathan's suggestion now.
<br>
<p>-----Original Message-----
<br>
From: users-bounces_at_[hidden] [mailto:users-bounces_at_[hidden]] On Behalf Of Shamis, Pavel
<br>
...
<br>
<p>Alternative solution for the problem is updating your memory limits
<br>
Please see below: <a href="http://www.open-mpi.org/faq/?category=openfabrics#ib-locked-pages">http://www.open-mpi.org/faq/?category=openfabrics#ib-locked-pages</a>
<br>
<p>Apparently you memory limit is low and the driver fails to create QPs
<br>
<p><p>What happens when you add the following to your mpirun command?
<br>
<p>-mca btl_openib_receive_queues S,4096,128:S,12288,128:S,65536,12
<br>
<p>And if you have connectX-2/or 3 device I would suggest replace &quot;S&quot; by &quot;X&quot;  - X enables much more efficient XRC QP,  instead of SRQ.
<br>
<p><p>OMPI Developers:
<br>
...
<br>
<p>It is cons-and-pros of using per-peer queues. It really depends on application behavior.
<br>
I would suggest some dynamic-adjustment solution. If NP &gt; some_threshould -&gt; switch to SRQ or XRC.
<br>
<p>Also I would recommend to print our some informative error message for &quot;qp errno says Cannot allocate memory&quot; error.
<br>
<p>Regards,
<br>
Pasha.
...
<br>
<p>I am getting this error message below and I don't know what it means or how to fix it.   It only happens when I run on a large number of processes, e.g. 960.  Things work fine on 480, and I don't think the application has a bug.  Any help is appreciated...
<br>
<p>[c1n01][[30697,1],3][connect/btl_openib_connect_oob.c:464:qp_create_one] error creating qp errno says Cannot allocate memory
<br>
[c1n01][[30697,1],4][connect/btl_openib_connect_oob.c:464:qp_create_one] error creating qp errno says Cannot allocate memory
<br>
<p>Here's the mpirun command I used:
<br>
...
<br>
<p>Here's the applicable hardware from the /usr/mpi/intel/openmpi-1.4.3/share/openmpi/mca-btl-openib-device-params.ini file:
<br>
# A.k.a. ConnectX
<br>
[Mellanox Hermon]
...
max_inline_data = 128
<br>
<p>And this is the output of ompi_info -param btl openib:
<br>
