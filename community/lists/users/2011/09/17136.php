...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17137.php">Tru Huynh: "[OMPI users] Open MPI 1.5.4/Intel XE make check failure (CentOS-5.6 x86_64)"</a>
<li><strong>Previous message:</strong> <a href="17135.php">Jeff Squyres: "Re: [OMPI users] I want to check our own modified Ofed stack with MPI application"</a>
<li><strong>In reply to:</strong> <a href="17133.php">Eugene Loh: "Re: [OMPI users] High CPU usage with yield_when_idle =1 on CFS"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17140.php">Randolph Pullen: "Re: [OMPI users] High CPU usage with yield_when_idle =1 on CFS"</a>
<li><strong>Reply:</strong> <a href="17140.php">Randolph Pullen: "Re: [OMPI users] High CPU usage with yield_when_idle =1 on CFS"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
