...
?>
<!-- received="Tue Sep 13 18:36:16 2011" -->
<!-- isoreceived="20110913223616" -->
<!-- sent="Wed, 14 Sep 2011 00:36:06 +0200" -->
<!-- isosent="20110913223606" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE" -->
<!-- id="B2107BDC-266D-4B78-B7A6-24BEA994C5DF_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="7F610271-116B-4E65-9C4B-584AC77C1728_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-09-13 18:36:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17278.php">Blosch, Edwin L: "Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE"</a>
<li><strong>Previous message:</strong> <a href="17276.php">Reuti: "Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE"</a>
<li><strong>In reply to:</strong> <a href="17273.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17272.php">Blosch, Edwin L: "Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; On Sep 13, 2011, at 4:25 PM, Reuti wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Am 13.09.2011 um 23:54 schrieb Blosch, Edwin L:
</span><br>
...
<span class="quotelev1">&gt; Just an FYI: that could still yield no output and not mean that qrsh won't be used by the launcher. The rsh launcher has the qrsh command embedded within it, so it won't show on ompi_info.
</span><br>
<p>Got it - thx. - Reuti
<br>
<p><p><span class="quotelev2">&gt;&gt; Any output?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; Yes, I did supply a machinefile on my own.  It is formed on the fly within the submitted script by parsing the PE_HOSTFILE, and I leave the
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Parsing the PE_HOSTFILE and prepare it in a format suitable for the actual parallel library is usually defined in start_proc_args to do it once for all users and applications using this parallel library. With a tight integration they could be set to NONE though.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; resulting file lying around, and the result appears to be correct, i.e. it includes those nodes (and only those nodes) allocated to the job.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Well, even without compilation --with-sge you could achieve a so called tight integration and confuse the startup when. What does your PE look like? Depending whether Open MPI will start an task on the master node of the job by a local `qrsh -inherit ...` job_is_first_task needs to be set to FALSE (this allows one `qrsh -inherit ...`call to be made local). But if all is fine, the job script is already the first task and TRUE should work.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
