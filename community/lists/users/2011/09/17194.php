...
?>
<!-- received="Thu Sep  8 10:28:01 2011" -->
<!-- isoreceived="20110908142801" -->
<!-- sent="Thu, 8 Sep 2011 10:27:36 -0400" -->
<!-- isosent="20110908142736" -->
<!-- name="Jai Dayal" -->
<!-- email="dayalsoap_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem with MPI_BARRIER" -->
<!-- id="CAMJ-YiQRgEmS6s-Pss9j6DiePJu4tRJDV+uRB_ivXrxEBKk54Q_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="AEEE8DB3-E8E1-44FB-A3CB-600A1FE9EBB9_at_coria.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-09-08 10:27:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17195.php">Teng Ma: "Re: [OMPI users] Problem with MPI_BARRIER"</a>
<li><strong>Previous message:</strong> <a href="17193.php">Ghislain Lartigue: "Re: [OMPI users] Problem with MPI_BARRIER"</a>
<li><strong>In reply to:</strong> <a href="17193.php">Ghislain Lartigue: "Re: [OMPI users] Problem with MPI_BARRIER"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17196.php">Eugene Loh: "Re: [OMPI users] Problem with MPI_BARRIER"</a>
<li><strong>Reply:</strong> <a href="17196.php">Eugene Loh: "Re: [OMPI users] Problem with MPI_BARRIER"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Thu, Sep 8, 2011 at 10:25 AM, Ghislain Lartigue &lt;
<br>
...
<span class="quotelev1">&gt; I understand this but the delays that I measure are huge compared to a
</span><br>
<span class="quotelev1">&gt; classical ack procedure... (1000x more)
</span><br>
<span class="quotelev1">&gt; And this is repeatable: as far as I understand it, this shows that the
</span><br>
<span class="quotelev1">&gt; network is not involved.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; I guess you forget to count the &quot;leaving time&quot;(fan-out).  When everyone
</span><br>
<span class="quotelev2">&gt; &gt; hits the barrier, it still needs &quot;ack&quot; to leave.  And remember in most
</span><br>
<span class="quotelev2">&gt; &gt; cases, leader process will send out &quot;acks&quot; in a sequence way.  It's very
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; reflective of what order things were actually printers.  Remember that
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI process -&gt; local Open MPI daemon -&gt; mpirun -&gt; printed to mpirun's
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Thank you for this explanation but indeed this confirms that the LAST
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; process that hits the barrier should go through nearly instantaneously
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; (except for the broadcast time for the acknowledgment signal).
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; And this is not what happens in my code : EVERY process waits for a
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; very long time before going through the barrier (thousands of times
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; Order in which processes hit the barrier is only one factor in the
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; time it takes for that process to finish the barrier.
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; An easy way to think of a barrier implementation is a &quot;fan in/fan
</span><br>
<span class="quotelev1">&gt; out&quot;
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; model.  When each nonzero rank process calls MPI_BARRIER, it sends a
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; message saying &quot;I have hit the barrier!&quot; (it usually sends it to its
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; parent in a tree of all MPI processes in the communicator, but you
</span><br>
<span class="quotelev1">&gt; can
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; simplify this model and consider that it sends it to rank 0).  Rank 0
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; collects all of these messages.  When it has messages from all
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; processes in the communicator, it sends out &quot;ok, you can leave the
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; barrier now&quot; messages (again, it's usually via a tree distribution,
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; but you can pretend that it directly, linearly sends a message to
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; is relative to when every other process enters the communicator.  But
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; I expected that the values of &quot;new_time&quot; would range from 0 to Tmax
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; (1700 in my case)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; As I understand it, the first process that hits the barrier should
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; print Tmax and the last process that hits the barrier should print 0
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; (or a very low value).
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; But this is not the case: all processes print values in the range
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17194/attachment">attachment</a>
</ul>
