...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17131.php">Faisal Shahzad: "Re: [OMPI users] Question regarding SELF-checkpointing"</a>
<li><strong>Previous message:</strong> <a href="../../2011/08/17129.php">Jeff Squyres: "Re: [OMPI users] Does MPI_Finalize() behaves like MPI_Barrier() ?"</a>
<li><strong>In reply to:</strong> <a href="../../2010/09/14298.php">Ralph Castain: "Re: [OMPI users] function fgets hangs a mpi program when it is used ompi-ps command"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17133.php">Eugene Loh: "Re: [OMPI users] High CPU usage with yield_when_idle =1 on CFS"</a>
<li><strong>Reply:</strong> <a href="17133.php">Eugene Loh: "Re: [OMPI users] High CPU usage with yield_when_idle =1 on CFS"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-17130/attachment">attachment</a>
</ul>
