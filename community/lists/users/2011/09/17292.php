...
?>
<!-- received="Wed Sep 14 15:25:37 2011" -->
<!-- isoreceived="20110914192537" -->
<!-- sent="Wed, 14 Sep 2011 13:23:25 -0600" -->
<!-- isosent="20110914192325" -->
<!-- name="Blosch, Edwin L" -->
<!-- email="edwin.l.blosch_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re: Can you set the gid of	the	processes	created by mpirun?" -->
<!-- id="E9F276A0010AF44ABD2C03ED2EDAE7DB275E50745E_at_HDXMSPB.us.lmco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="60B20034-A265-4EFE-9255-0F3E614EC080_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-09-14 15:23:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17293.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of	the	processes	created by mpirun?"</a>
<li><strong>Previous message:</strong> <a href="17291.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the	processes	created by mpirun?"</a>
<li><strong>In reply to:</strong> <a href="17291.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the	processes	created by mpirun?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17293.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of	the	processes	created by mpirun?"</a>
<li><strong>Reply:</strong> <a href="17293.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of	the	processes	created by mpirun?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
<span class="quotelev1">&gt; Try -mca orte_launch_agent &quot;sg N orted&quot;, where N is the desired group ID.
</span><br>
<p>There is a catch in the way the orted process is started. 
<br>
<p>I get messages like this:
<br>
<p>bash: sg /home/install/openmpi/bin/(null) --daemonize -mca ess env -mca orte_ess_jobid 3913285632 -mca orte_ess_vpid 9 -mca orte_ess_num_procs 10 --hnp-uri 3913285632.0: No such file or directory
<br>
<p><p>I think it is taking &quot;sg&quot; as the orted command and ignoring the groupid and the orted arguments to sg.  Probably some detail of how the orted process is being created.
<br>
