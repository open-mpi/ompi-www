...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17144.php">Jeff Squyres: "Re: [OMPI users] High CPU usage with yield_when_idle =1 on CFS"</a>
<li><strong>Previous message:</strong> <a href="17142.php">bhimesh akula: "[OMPI users] I want to check our own modified Ofed stack with MPI application"</a>
<li><strong>In reply to:</strong> <a href="17142.php">bhimesh akula: "[OMPI users] I want to check our own modified Ofed stack with MPI application"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17158.php">bhimesh akula: "Re: [OMPI users] I want to check our own modified Ofed stack with MPI application"</a>
<li><strong>Reply:</strong> <a href="17158.php">bhimesh akula: "Re: [OMPI users] I want to check our own modified Ofed stack with MPI application"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
