...
?>
<!-- received="Wed Sep 14 13:41:21 2011" -->
<!-- isoreceived="20110914174121" -->
<!-- sent="Wed, 14 Sep 2011 11:02:46 -0600" -->
<!-- isosent="20110914170246" -->
<!-- name="Blosch, Edwin L" -->
<!-- email="edwin.l.blosch_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the	processes	created by mpirun?" -->
<!-- id="E9F276A0010AF44ABD2C03ED2EDAE7DB275E484142_at_HDXMSPB.us.lmco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-09-14 13:02:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17291.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the	processes	created by mpirun?"</a>
<li><strong>Previous message:</strong> <a href="17289.php">Steve Jones: "Re: [OMPI users] IO issue with OpenMPI 1.4.1 and earlier versions"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17291.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the	processes	created by mpirun?"</a>
<li><strong>Reply:</strong> <a href="17291.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the	processes	created by mpirun?"</a>
<li><strong>Reply:</strong> <a href="17294.php">Reuti: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the	processes	created by mpirun?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Thanks for trying. 
<br>
<p>Do you feel that this is an impossible request without the assistance of some process running as root, for example, as Reuti mentioned, the daemons of a job scheduler?  Or are you saying it will just not be as straightforward as calling setgid as you had hoped?
<br>
<p>Also, do you think there is a way I could make use of the sg command below?  Perhaps there is a way to have the rsh/ssh launcher start the application processes with a command like 'sg &lt;group&gt; &lt;executable name&gt;'?
<br>
<p>Ed
<br>
<p><p>NAME
...
Subject: Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the processes created by mpirun?
<br>
<p><p>On Sep 14, 2011, at 9:39 AM, Blosch, Edwin L wrote:
<br>
