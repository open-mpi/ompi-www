...
?>
<!-- received="Wed Sep 14 19:20:37 2011" -->
<!-- isoreceived="20110914232037" -->
<!-- sent="Wed, 14 Sep 2011 17:15:22 -0600" -->
<!-- isosent="20110914231522" -->
<!-- name="Blosch, Edwin L" -->
<!-- email="edwin.l.blosch_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the processes	created by mpirun?" -->
<!-- id="E9F276A0010AF44ABD2C03ED2EDAE7DB275E5078B9_at_HDXMSPB.us.lmco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="3ECBB2BA-E6E9-4A92-817E-2B2922C86AEA_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-09-14 19:15:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17300.php">Kevin.Buckley_at_[hidden]: "Re: [OMPI users] OpenIB error messages: reporting the default or telling you what's happening?"</a>
<li><strong>Previous message:</strong> <a href="17298.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the processes created by mpirun?"</a>
<li><strong>In reply to:</strong> <a href="17298.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the processes created by mpirun?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17303.php">Reuti: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the processes	created by mpirun?"</a>
<li><strong>Reply:</strong> <a href="17303.php">Reuti: "Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the processes	created by mpirun?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I think OpenMPI should be able to launch all processes with the same uid and gid even when the user has launched the job while using one of his secondary groups.  Whether it should be a change request or bug (unexpected, counter-intuitive), I'll leave that to your judgment.
<br>
<p>Thank you again for the support
<br>
...
<p>Hi Ed
<br>
<p>I finally had some time to dig around a little. I believe we could make this work if I fix the multi-word cmd line param issue. Either &quot;newgrp&quot; or &quot;sg&quot; should resolve the problem - both are user-level cmds.
<br>
<p>Up to you - let me know if you want me to pursue this.
<br>
Ralph
<br>
<p><p>On Sep 14, 2011, at 3:31 PM, Blosch, Edwin L wrote:
<br>
<p><p>Thank you -  I did pursue this kind of workaround, and it worked, but you'll be happy to know that nothing had to be owned by root.
<br>
<p>ASIDE ----
<br>
...
<p>Thank you
<br>
<p><p>From: users-bounces_at_[hidden]&lt;mailto:users-bounces_at_[hidden]&gt; [mailto:users-bounces_at_[hidden]] On Behalf Of Randall Svancara
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17299/attachment">attachment</a>
</ul>
