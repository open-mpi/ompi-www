...
?>
<!-- received="Tue Sep 13 18:25:36 2011" -->
<!-- isoreceived="20110913222536" -->
<!-- sent="Wed, 14 Sep 2011 00:25:26 +0200" -->
<!-- isosent="20110913222526" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE" -->
<!-- id="32A603C5-0B81-4E7A-ADBE-CC7122A2FC8F_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-09-13 18:25:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17272.php">Blosch, Edwin L: "Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE"</a>
<li><strong>Previous message:</strong> <a href="17270.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE"</a>
<li><strong>In reply to:</strong> <a href="17267.php">Blosch, Edwin L: "Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17273.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE"</a>
<li><strong>Reply:</strong> <a href="17273.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re:  Problem running under SGE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Whether SGE is installed on the built machine is not relevant. In contrast to Torque (and I think also SLURM) nothing is compiled into Open MPI which needs a library from the designated queuing system to support it. It will in case of SGE just check for the existence of some environment variables and call `qrsh -inherit ...`. Further startup is handled by SGE by the defined qrsh_daemon/qrsh_command.
<br>
<p>So, to check it you can issue:
<br>
<p>ompi_info | grep grid
<br>
<p>Any output?
<br>
<p><p><span class="quotelev1">&gt; My hope is that OpenMPI will not attempt to use SGE in any way. But perhaps it is trying to. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Yes, I did supply a machinefile on my own.  It is formed on the fly within the submitted script by parsing the PE_HOSTFILE, and I leave the
</span><br>
<p>Parsing the PE_HOSTFILE and prepare it in a format suitable for the actual parallel library is usually defined in start_proc_args to do it once for all users and applications using this parallel library. With a tight integration they could be set to NONE though.
<br>
<p><p><span class="quotelev1">&gt; resulting file lying around, and the result appears to be correct, i.e. it includes those nodes (and only those nodes) allocated to the job.
</span><br>
