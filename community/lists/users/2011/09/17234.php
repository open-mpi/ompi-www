...
?>
<!-- received="Mon Sep 12 15:29:07 2011" -->
<!-- isoreceived="20110912192907" -->
<!-- sent="Mon, 12 Sep 2011 13:29:02 -0600" -->
<!-- isosent="20110912192902" -->
<!-- name="Samuel K. Gutierrez" -->
<!-- email="samuel_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re:  qp memory allocation problem" -->
<!-- id="024D82B2-F258-4CAC-9754-78E87D4B8759_at_lanl.gov" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="E9F276A0010AF44ABD2C03ED2EDAE7DB275E2E59E7_at_HDXMSPB.us.lmco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-09-12 15:29:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17235.php">Riku: "[OMPI users] OpenMPI 1.5.4 with VS2008 and example code fails at orte_init"</a>
<li><strong>Previous message:</strong> <a href="17233.php">Jeff Squyres: "Re: [OMPI users] openmpi 1.5.4 paffinity with Magny-Cours"</a>
<li><strong>In reply to:</strong> <a href="17225.php">Blosch, Edwin L: "Re: [OMPI users] EXTERNAL: Re:  qp memory allocation problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17226.php">Shamis, Pavel: "Re: [OMPI users] qp memory allocation problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; This worked. 
</span><br>
<p>Great!
<br>
<p><span class="quotelev1">&gt; Did this magic line disable the use of per-peer queue pairs? 
</span><br>
<p>Yes, it sure did.
<br>
<p><span class="quotelev1">&gt; I have seen a previous post by Jeff that explains what this line does generally, but I didn&#146;t study the post in detail, so if you could provide a little explanation I would appreciate it.
</span><br>
<p><p>The btl_openib_receive_queues MCA parameter takes a comma and colon delimited list of parameters.  The most general form is:
<br>
<p>Queue pair type identifier,Buffer size (Required),Number of buffers (Required):Queue pair type identifier,Buffer size (Required),Number of buffers (Required):...:Queue pair type identifier,Buffer size (Required),Number of buffers (Required)
<br>
<p>NOTE: Optional QP parameters omitted - see the OMPI FAQ regarding OpenFabrics tuning for more details.
<br>
<p>The 'S' queue pair type identifier corresponds to &quot;Shared queues.&quot;
<br>
...
<span class="quotelev1">&gt; From: users-bounces_at_[hidden] [mailto:users-bounces_at_[hidden]] On Behalf Of Samuel K. Gutierrez
</span><br>
<span class="quotelev1">&gt; Sent: Monday, September 12, 2011 10:49 AM
</span><br>
<span class="quotelev1">&gt; To: Open MPI Users
</span><br>
<span class="quotelev1">&gt; Subject: EXTERNAL: Re: [OMPI users] qp memory allocation problem
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; This problem can be  caused by a variety of things, but I suspect our default queue pair parameters (QP) aren't helping the situation :-).
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; I am getting this error message below and I don&#146;t know what it means or how to fix it.   It only happens when I run on a large number of processes, e.g. 960.  Things work fine on 480, and I don&#146;t think the application has a bug.  Any help is appreciated&#133;
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17234/attachment">attachment</a>
</ul>
