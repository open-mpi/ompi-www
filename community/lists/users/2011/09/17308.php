...
?>
<!-- received="Thu Sep 15 10:43:42 2011" -->
<!-- isoreceived="20110915144342" -->
<!-- sent="Thu, 15 Sep 2011 08:43:34 -0600" -->
<!-- isosent="20110915144334" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re: Can you set the gid of the	processes	created by mpirun?" -->
<!-- id="A79F3EE7-AA60-4CDE-97BD-0CAC3DF14602_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-09-15 10:43:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17309.php">Ghislain Lartigue: "Re: [OMPI users] Problem with MPI_Wtime()"</a>
<li><strong>Previous message:</strong> <a href="17307.php">Eugene Loh: "Re: [OMPI users] Problem with MPI_Wtime()"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17311.php">Reuti: "Re: [OMPI users] sg riddle (was: EXTERNAL: Re: Can you set the gid of the	processes	created by mpirun?)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Setting aside possible syntax issues, this should work - I've used similar things myself in the past with success.
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Also, Ralph, 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<p>We are supposed to support multi-word arguments, so it's mostly just finding a few minutes to check if that is in the 1.4 series or not. I also need to check about the semi-colon required for using newgrp instead of sg - I don't think we can handle that at the moment, but probably should.
<br>
<p><span class="quotelev1">&gt; 
</span><br>
