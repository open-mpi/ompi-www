...
?>
<!-- received="Tue Sep 20 19:55:07 2011" -->
<!-- isoreceived="20110920235507" -->
<!-- sent="Tue, 20 Sep 2011 17:54:57 -0600" -->
<!-- isosent="20110920235457" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Large TCP cluster timeout issue" -->
<!-- id="C792E88F-DE68-4C89-B8F5-10BD79C9BBE6_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="8BC9254C6D66C746B00D00661FAD9AF070901E65BC_at_GVW1341EXA.americas.hpqcorp.net" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2011-09-20 19:54:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17370.php">Björn Regnström: "[OMPI users] Building with thread support on Windows?"</a>
<li><strong>Previous message:</strong> <a href="17368.php">Henderson, Brent: "Re: [OMPI users] Large TCP cluster timeout issue"</a>
<li><strong>In reply to:</strong> <a href="17368.php">Henderson, Brent: "Re: [OMPI users] Large TCP cluster timeout issue"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17374.php">Henderson, Brent: "Re: [OMPI users] Large TCP cluster timeout issue"</a>
<li><strong>Reply:</strong> <a href="17374.php">Henderson, Brent: "Re: [OMPI users] Large TCP cluster timeout issue"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; Nope, but if I didn&#146;t that would have saved me about an hour of coding time! 
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; I&#146;m still curious if it would be beneficial to inject some barriers at certain locations so that if you had a slow node, not everyone would end up connecting to it all at once.  Anyway, if I get access to another large TCP cluster, I&#146;ll give it a try.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; Sent: Tuesday, September 20, 2011 4:15 PM
</span><br>
<span class="quotelev1">&gt; To: Open MPI Users
</span><br>
<span class="quotelev1">&gt; Subject: Re: [OMPI users] Large TCP cluster timeout issue
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; Hmmm....perhaps you didn't notice the mpi_preconnect_all option? It does precisely what you described - it pushes zero-byte messages around a ring to force all the connections open at MPI_Init.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; On Sep 20, 2011, at 3:06 PM, Henderson, Brent wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I recently had access to a 200+ node Magny Cours (24 ranks/host) 10G Linux cluster.  I was able to use OpenMPI v1.5.4 with hello world, IMB and HPCC, but there were a couple of issues along the way.  After setting some system tunables up a little bit on all of the nodes a hello_world program worked just fine &#150; it appears that the TCP connections between most or all of the ranks are deferred until they are actually used so the easy test ran reasonably quickly.  I then moved to IMB. 
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17369/attachment">attachment</a>
</ul>
