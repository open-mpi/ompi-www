...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17142.php">bhimesh akula: "[OMPI users] I want to check our own modified Ofed stack with MPI application"</a>
<li><strong>Previous message:</strong> <a href="17140.php">Fabien: "Re: [OMPI users] Mingw - Gfortran - Cmake : 'gettimeofday'"</a>
<li><strong>In reply to:</strong> <a href="17138.php">Randolph Pullen: "[OMPI users] High CPU usage with yield_when_idle =1 on CFS"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17144.php">Jeff Squyres: "Re: [OMPI users] High CPU usage with yield_when_idle =1 on CFS"</a>
<li><strong>Reply:</strong> <a href="17144.php">Jeff Squyres: "Re: [OMPI users] High CPU usage with yield_when_idle =1 on CFS"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17141/attachment">attachment</a>
</ul>
