...
?>
<!-- received="Mon Sep 12 12:16:34 2011" -->
<!-- isoreceived="20110912161634" -->
<!-- sent="Mon, 12 Sep 2011 10:16:20 -0600" -->
<!-- isosent="20110912161620" -->
<!-- name="Blosch, Edwin L" -->
<!-- email="edwin.l.blosch_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re:  qp memory allocation problem" -->
<!-- id="E9F276A0010AF44ABD2C03ED2EDAE7DB275E2E59E7_at_HDXMSPB.us.lmco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-09-12 12:16:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17226.php">Shamis, Pavel: "Re: [OMPI users] qp memory allocation problem"</a>
<li><strong>Previous message:</strong> <a href="17224.php">Jeff Squyres: "Re: [OMPI users] OpenIB error messages: reporting the default or telling you what's happening?"</a>
<li><strong>In reply to:</strong> <a href="17221.php">Samuel K. Gutierrez: "Re: [OMPI users] qp memory allocation problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17234.php">Samuel K. Gutierrez: "Re: [OMPI users] EXTERNAL: Re:  qp memory allocation problem"</a>
<li><strong>Reply:</strong> <a href="17234.php">Samuel K. Gutierrez: "Re: [OMPI users] EXTERNAL: Re:  qp memory allocation problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Samuel,
<br>
<p>This worked.  Did this magic line disable the use of per-peer queue pairs?    I have seen a previous post by Jeff that explains what this line does generally, but I didn't study the post in detail, so if you could provide a little explanation I would appreciate it.
<br>
<p>Ed
<br>
<p>From: users-bounces_at_[hidden] [mailto:users-bounces_at_[hidden]] On Behalf Of Samuel K. Gutierrez
<br>
...
<br>
<p><p>I am getting this error message below and I don't know what it means or how to fix it.   It only happens when I run on a large number of processes, e.g. 960.  Things work fine on 480, and I don't think the application has a bug.  Any help is appreciated...
<br>
...
<p><p><p><p><p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17225/attachment">attachment</a>
</ul>
