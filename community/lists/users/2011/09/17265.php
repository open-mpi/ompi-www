...
?>
<!-- received="Tue Sep 13 17:25:05 2011" -->
<!-- isoreceived="20110913212505" -->
<!-- sent="Tue, 13 Sep 2011 23:24:55 +0200" -->
<!-- isosent="20110913212455" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem running under SGE" -->
<!-- id="3DBB37B0-A667-4A50-A082-B0AAA90FE6AF_at_staff.uni-marburg.de" -->
...
<strong>Date:</strong> 2011-09-13 17:24:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17266.php">Reuti: "Re: [OMPI users] Problem running under SGE"</a>
<li><strong>Previous message:</strong> <a href="17264.php">Blosch, Edwin L: "[OMPI users] Problem running under SGE"</a>
<li><strong>In reply to:</strong> <a href="17264.php">Blosch, Edwin L: "[OMPI users] Problem running under SGE"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17266.php">Reuti: "Re: [OMPI users] Problem running under SGE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Did you compile Open MPI with --with-sge?
<br>
<p>What's the setting of qrsh_command and qrsh_daemon in SGE (qconf -sconf) and/or do local configurations exist overwriting this (qconf -sconfl)? 
<br>
<p>-- Reuti
<br>
...
<span class="quotelev1">&gt; error: executing task of job 139362 failed: execution daemon on host &quot;f8312&quot; didn't accept task
</span><br>
<span class="quotelev1">&gt; --------------------------------------------------------------------------
</span><br>
