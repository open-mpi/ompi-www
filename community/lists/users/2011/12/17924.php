<?
$subject_val = "[OMPI users] Process mapping and affinity on the devel trunk";
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Process mapping and affinity on the devel trunk<br>
<strong>From:</strong> Ralph Castain (<em>rhc_at_[hidden]</em>)<br>
<strong>Date:</strong> 2011-12-11 00:14:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17925.php">MM: "Re: [OMPI users] How to justify the use MPI codes on multicore	systems/PCs?"</a>
<li><strong>Previous message:</strong> <a href="17923.php">amjad ali: "[OMPI users] How to justify the use MPI codes on multicore systems/PCs?"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
