...
?>
<!-- received="Wed Dec  7 14:30:25 2011" -->
<!-- isoreceived="20111207193025" -->
<!-- sent="Wed, 7 Dec 2011 12:30:15 -0700" -->
<!-- isosent="20111207193015" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] orte_ess_base_select failed" -->
<!-- id="93025559-C984-40A7-A1FD-FEC5086DE4E2_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-12-07 14:30:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17910.php">tim: "Re: [OMPI users] orte_ess_base_select failed"</a>
<li><strong>Previous message:</strong> <a href="17908.php">Gustavo Correa: "Re: [OMPI users] orte_ess_base_select failed"</a>
<li><strong>In reply to:</strong> <a href="17905.php">John Doe: "Re: [OMPI users] orte_ess_base_select failed"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17913.php">John Doe: "Re: [OMPI users] orte_ess_base_select failed"</a>
<li><strong>Reply:</strong> <a href="17913.php">John Doe: "Re: [OMPI users] orte_ess_base_select failed"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>I'm not sure why you would ever want to generate those files without their appropriate extensions - that's what the system is looking for. It sounds like everything is being built correctly, so the problem is just that you aren't finding them.
<br>
<p>I would check a couple of things. First, make sure that the &quot;mpirun&quot; you are executing is the one you think you are executing - i.e., do &quot;which mpirun&quot; to see that there isn't another one in the way.
<br>
<p>Second, check that you really do have the correct path in LD_LIBRARY_PATH and it isn't misspelled. I know you say you have it, but you'd be amazed how many times someone asks only to eventually find a typo.
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17909/attachment">attachment</a>
</ul>
