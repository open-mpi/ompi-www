...
?>
<!-- received="Wed Dec  7 12:11:51 2011" -->
<!-- isoreceived="20111207171151" -->
<!-- sent="Wed, 7 Dec 2011 10:11:42 -0700" -->
<!-- isosent="20111207171142" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] orte_ess_base_select failed" -->
<!-- id="785AE169-732E-4A26-931C-C4E6E31070FB_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2011-12-07 12:11:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="17904.php">John Doe: "Re: [OMPI users] orte_ess_base_select failed"</a>
<li><strong>Previous message:</strong> <a href="17902.php">John Doe: "Re: [OMPI users] orte_ess_base_select failed"</a>
<li><strong>In reply to:</strong> <a href="17902.php">John Doe: "Re: [OMPI users] orte_ess_base_select failed"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="17904.php">John Doe: "Re: [OMPI users] orte_ess_base_select failed"</a>
<li><strong>Reply:</strong> <a href="17904.php">John Doe: "Re: [OMPI users] orte_ess_base_select failed"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>If you want a debug version, try just this:
<br>
<p>./configure --prefix=/opt/ompi/gnu/1.4.4 --enable-debug --with-valgrind=/opt/valgrind --enable-orterun-prefix-by-default --enable-memchecker --enable-mem-profile
<br>
<p>You don't need --with-devel-headers unless you intend to write code that directly drives the OMPI internals.
<br>
<p><p>On Dec 7, 2011, at 10:00 AM, John Doe wrote:
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-17903/attachment">attachment</a>
</ul>
