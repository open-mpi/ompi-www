...
?>
<!-- received="Wed Mar 14 19:44:38 2012" -->
<!-- isoreceived="20120314234438" -->
<!-- sent="Thu, 15 Mar 2012 00:44:25 +0100" -->
<!-- isosent="20120314234425" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segfaults w/ both 1.4 and 1.5 on CentOS 6.2/SGE" -->
<!-- id="AC2CBF8D-A0CF-46D6-8606-470B21D4DE42_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-03-14 19:44:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18775.php">Ralph Castain: "Re: [OMPI users] Segfaults w/ both 1.4 and 1.5 on CentOS 6.2/SGE"</a>
<li><strong>Previous message:</strong> <a href="18773.php">Ralph Castain: "Re: [OMPI users] Segfaults w/ both 1.4 and 1.5 on CentOS 6.2/SGE"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18775.php">Ralph Castain: "Re: [OMPI users] Segfaults w/ both 1.4 and 1.5 on CentOS 6.2/SGE"</a>
<li><strong>Reply:</strong> <a href="18775.php">Ralph Castain: "Re: [OMPI users] Segfaults w/ both 1.4 and 1.5 on CentOS 6.2/SGE"</a>
<li><strong>Reply:</strong> <a href="18777.php">Joshua Baker-LePain: "Re: [OMPI users] Segfaults w/ both 1.4 and 1.5 on CentOS 6.2/SGE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Which version of SGE are you using? The traditional rsh startup was replaced by the builtin startup some time ago (although it should still work).
<br>
<p><p><span class="quotelev1">&gt; jlb       9677  0.0  0.0   8988   700 ?        S    14:31   0:00  |       \_ /ccpr1/sge6/utilbin/lx24-amd64/qrsh_starter /var/spool/sge/opt95/active_jobs/6997934.1/1.opt95
</span><br>
...
<p>Maybe this shows already the problem: there are two `qrsh -inherit`, as Open MPI thinks these are different machines (I ran only with one slot on each host hence didn't get it first but can reproduce it now). But for SGE both may end up in the same queue overriding the openmpi-session in $TMPDIR.
<br>
<p>Although it's running: you get all output? If I request 4 slots and get one from each queue on both machines the mpihello outputs only 3 lines: the &quot;Hello World from Node 3&quot; is always missing.
<br>
<p>(I was just typing when Ralph's message came in: I can confirm this. To avoid it, it would mean for Open MPI to collect all lines from the hostfile which are on the same machine. SGE creates entries for each queue/host pair in the machinefile).
<br>
<p>==
<br>
<p>@Ralph: it could work if SGE would have a facility to request the desired queue in `qrsh -inherit ...`, because then the $TMPDIR would be unique for each orted again (assuming its using different ports for each).
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; Case &quot;it doesn't&quot;:
</span><br>
...
<p><p><p><span class="quotelev2">&gt;&gt; Joshua: the Centos6 is the same on all nodes and the you recompiled the application with the actual version of the library? By &quot;threads&quot; you refer to &quot;processes&quot;?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
