...
?>
<!-- received="Mon Mar  5 16:38:38 2012" -->
<!-- isoreceived="20120305213838" -->
<!-- sent="Mon, 5 Mar 2012 15:38:32 -0600" -->
<!-- isosent="20120305213832" -->
<!-- name="Jeffrey Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] compilation error with pgcc Unknown switch" -->
<!-- id="12012DBF-AA31-4D95-A99D-07B988373850_at_cisco.com" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="alpine.OSX.2.00.1203050919040.12520_at_panthera.lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-03-05 16:38:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18686.php">bin Wang: "[OMPI users]  can't run the code on Jaguar"</a>
<li><strong>Previous message:</strong> <a href="18684.php">Jeffrey Squyres: "Re: [OMPI users] Configure MPI_ADDRESS_KIND and MPI_OFFSET_KIND (OSX 10.6; gcc, g95, openmpi-1.4.5.)"</a>
<li><strong>In reply to:</strong> <a href="18683.php">Nathan Hjelm: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18688.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Reply:</strong> <a href="18688.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>So I don't think this should have caused a new error... should it?
<br>
<p><p>On Mar 5, 2012, at 10:21 AM, Nathan Hjelm wrote:
<br>
<p><span class="quotelev1">&gt; Try pulling a fresh trunk. Jeff made a recent commit that may be relevant. Something about inline assembly being broken on PGI (I personally wouldn't recommend using that compiler unless you are using fortran).
</span><br>
