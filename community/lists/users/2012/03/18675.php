...
?>
<!-- received="Fri Mar  2 15:17:33 2012" -->
<!-- isoreceived="20120302201733" -->
<!-- sent="Fri, 2 Mar 2012 20:17:28 +0000" -->
<!-- isosent="20120302201728" -->
<!-- name="Denver Smith" -->
<!-- email="denver.smith_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ssh between nodes" -->
<!-- id="2190BA584788164982F798330F63AC4042C3EF13_at_mb03.aggies.usu.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4F50F0CB.3040302_at_ias.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> Denver Smith (<em>denver.smith_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-03-02 15:17:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18676.php">Yiguang Yan: "Re: [OMPI users] orted daemon not found! --- environment not passed to slave nodes"</a>
<li><strong>Previous message:</strong> <a href="18674.php">Jeffrey Squyres: "Re: [OMPI users] orted daemon not found! --- environment not passed to slave nodes"</a>
<li><strong>In reply to:</strong> <a href="18665.php">Prentice Bisbal: "Re: [OMPI users] ssh between nodes"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Does anybody know if STARCCM software requires passwordless ssh?
<br>
<p>Big Thanks
<br>
<p><p>________________________________________
<br>
From: users-bounces_at_[hidden] [users-bounces_at_[hidden]] on behalf of Prentice Bisbal [prentice_at_[hidden]]
<br>
...
Subject: Re: [OMPI users] ssh between nodes
<br>
<p>On 02/29/2012 04:51 PM, Martin Siegert wrote:
<br>
