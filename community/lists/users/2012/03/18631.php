...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18632.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Previous message:</strong> <a href="18630.php">PukkiMonkey: "Re: [OMPI users] Could not execute the executable &quot;/home/MET/hrm/bin/hostlist&quot;: Exec format error"</a>
<li><strong>Maybe in reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/02/18599.php">Pinero, Pedro_jose: "[OMPI users] Very slow MPI_GATHER"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18634.php">Ralph Castain: "Re: [OMPI users] Very slow MPI_GATHER"</a>
<li><strong>Reply:</strong> <a href="18634.php">Ralph Castain: "Re: [OMPI users] Very slow MPI_GATHER"</a>
<li><strong>Reply:</strong> <a href="18636.php">Jeffrey Squyres: "Re: [OMPI users] Very slow MPI_GATHER"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18631/attachment">attachment</a>
</ul>
