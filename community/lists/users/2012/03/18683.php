...
?>
<!-- received="Mon Mar  5 11:21:27 2012" -->
<!-- isoreceived="20120305162127" -->
<!-- sent="Mon, 5 Mar 2012 09:21:21 -0700 (MST)" -->
<!-- isosent="20120305162121" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] compilation error with pgcc Unknown switch" -->
<!-- id="alpine.OSX.2.00.1203050919040.12520_at_panthera.lanl.gov" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="CADbPk83q5vhY+wQN58UqBaeJKOyjFwXy2k_A4iLhO8T+R2u_tA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-03-05 11:21:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18684.php">Jeffrey Squyres: "Re: [OMPI users] Configure MPI_ADDRESS_KIND and MPI_OFFSET_KIND (OSX 10.6; gcc, g95, openmpi-1.4.5.)"</a>
<li><strong>Previous message:</strong> <a href="18682.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>In reply to:</strong> <a href="18682.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18685.php">Jeffrey Squyres: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Reply:</strong> <a href="18685.php">Jeffrey Squyres: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Try pulling a fresh trunk. Jeff made a recent commit that may be relevant. Something about inline assembly being broken on PGI (I personally wouldn't recommend using that compiler unless you are using fortran).
<br>
<p>-Nathan
<br>
<p>On Sun, 4 Mar 2012, Abhinav Sarje wrote:
<br>
<p><span class="quotelev1">&gt; The same options/configuration in the GNU environment (compiler
</span><br>
