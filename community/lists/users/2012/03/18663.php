...
?>
<!-- received="Fri Mar  2 10:48:18 2012" -->
<!-- isoreceived="20120302154818" -->
<!-- sent="Fri, 2 Mar 2012 10:48:13 -0500" -->
<!-- isosent="20120302154813" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] compilation error with pgcc Unknown switch" -->
<!-- id="76FF7120-8E90-41DF-B257-7815DAF653DF_at_eecs.utk.edu" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="4C2E0FE0-ACB8-414F-8EC7-191296DB6EE1_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-03-02 10:48:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18664.php">Prentice Bisbal: "Re: [OMPI users] [EXTERNAL] Re: Question regarding osu-benchamarks 3.1.1"</a>
<li><strong>Previous message:</strong> <a href="18662.php">Yiguang Yan: "Re: [OMPI users] orted daemon not found! --- environment not passed to slave nodes"</a>
<li><strong>In reply to:</strong> <a href="18661.php">Jeffrey Squyres: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18679.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Reply:</strong> <a href="18679.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>The &quot;undefined&quot; function is defined in atomic_impl.h as a static inline (static inline int64_t opal_atomic_swap_64(volatile int64_t *addr,&#133;). So either the compiler should have complained during compilation, or it should be inlined when you reach the linking step. Or, and this is the unusual part, you're compiling 32 bits only (thus no atomic 64 bits are available), and we are forcing atomic operations on a 64 bits value. That would be quite strange &#133; 
<br>
<p>Are you trying to compile 32 or 64 bits?
<br>
<p>&nbsp;&nbsp;george.
<br>
<p>On Mar 2, 2012, at 06:12 , Jeffrey Squyres wrote:
<br>
<p><span class="quotelev1">&gt; I'm going to have to defer this to those who regularly build on Crays...
</span><br>
