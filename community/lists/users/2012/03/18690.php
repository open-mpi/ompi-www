...
?>
<!-- received="Tue Mar  6 07:20:46 2012" -->
<!-- isoreceived="20120306122046" -->
<!-- sent="Tue, 6 Mar 2012 06:20:33 -0600" -->
<!-- isosent="20120306122033" -->
<!-- name="Jeffrey Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] compilation error with pgcc Unknown switch" -->
<!-- id="2E95B226-8EAD-4B38-A18B-2437BB1BF8CD_at_cisco.com" -->
...
<strong>Date:</strong> 2012-03-06 07:20:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18691.php">Timothy Stitt: "[OMPI users] Scatter+Group Communicator Issue"</a>
<li><strong>Previous message:</strong> <a href="18689.php">Anthony Rollett: "Re: [OMPI users] Configure MPI_ADDRESS_KIND and MPI_OFFSET_KIND (OSX 10.6; gcc, g95, openmpi-1.4.5.)"</a>
<li><strong>In reply to:</strong> <a href="18688.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18701.php">Nathan Hjelm: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Reply:</strong> <a href="18701.php">Nathan Hjelm: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I'm afraid that I have neither a Cray nor the PGI compiler, so I'm not in a good position to help here.
<br>
<p>Would someone with the PGI compiler give the trunk a whirl to see if disabling the CXX inline assembly for PGI broke something?  I'd be a little surprised, since we already had it disabled for C, but who knows...
<br>
<p><p>On Mar 6, 2012, at 2:55 AM, Abhinav Sarje wrote:
<br>
