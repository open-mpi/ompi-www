...
?>
<!-- received="Thu Mar  8 18:06:01 2012" -->
<!-- isoreceived="20120308230601" -->
<!-- sent="Thu, 8 Mar 2012 18:05:55 -0500" -->
<!-- isosent="20120308230555" -->
<!-- name="Jeffrey Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] compilation error with pgcc Unknown switch" -->
<!-- id="043AAE97-A4EB-4666-B3FF-54606928D08D_at_cisco.com" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="CADbPk81AsD5dLaUG+3oDoop=6RB2ooM73LLvZhFNRz5oCuUSXA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-03-08 18:05:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18717.php">George Bosilca: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Previous message:</strong> <a href="18715.php">Reuti: "Re: [OMPI users] Illegal Instruction on Checkpoint with BLCR"</a>
<li><strong>In reply to:</strong> <a href="18688.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18718.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Reply:</strong> <a href="18718.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>They have always used GNU and it works fine.
<br>
<p>That being said, there may well be something broken with our non-inlined assembly, and this is the only platform it's showing up on.  So I'll file a ticket and CC you, but I don't know if it'll get fixed soon if the only platform it shows up on is one where we don't recommend that compiler.
<br>
<p>(that being said, we'll happily accept patches :-) )
<br>
<p>Make sense?
<br>
<p><p><p>On Mar 6, 2012, at 3:55 AM, Abhinav Sarje wrote:
<br>
<p><span class="quotelev1">&gt; I pulled fresh copy of the dev trunk, and tried building. It did not
</span><br>
<span class="quotelev1">&gt; change anything - I am still getting the same error:
</span><br>
<span class="quotelev1">&gt; ../../../ompi/.libs/libmpi.so: undefined reference to
</span><br>
<span class="quotelev1">&gt; `opal_atomic_swap_64'
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; GNU version still builds fine.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Tue, Mar 6, 2012 at 5:38 AM, Jeffrey Squyres &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; I disabled C++ inline assembly for PGI (we already had C inline assembly for PGI).
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; So I don't think this should have caused a new error... should it?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Mar 5, 2012, at 10:21 AM, Nathan Hjelm wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Try pulling a fresh trunk. Jeff made a recent commit that may be relevant. Something about inline assembly being broken on PGI (I personally wouldn't recommend using that compiler unless you are using fortran).
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Sun, 4 Mar 2012, Abhinav Sarje wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The same options/configuration in the GNU environment (compiler
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; version 4.6.1) builds smoothly. PGI env still gives the aforementioned
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; error. Has anyone experienced similar problem? May be some more flags
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; need to be set for PGI?
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sat, Mar 3, 2012 at 10:58 PM, Abhinav Sarje &lt;asarje_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Hi, I am trying to compile 64 bits.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Fri, Mar 2, 2012 at 11:48 PM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Something is definitively weird in your compilation environment.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; The &quot;undefined&quot; function is defined in atomic_impl.h as a static inline (static inline int64_t opal_atomic_swap_64(volatile int64_t *addr,&#133;). So either the compiler should have complained during compilation, or it should be inlined when you reach the linking step. Or, and this is the unusual part, you're compiling 32 bits only (thus no atomic 64 bits are available), and we are forcing atomic operations on a 64 bits value. That would be quite strange &#133;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Are you trying to compile 32 or 64 bits?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Mar 2, 2012, at 06:12 , Jeffrey Squyres wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'm going to have to defer this to those who regularly build on Crays...
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Sandia / LANL?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Mar 2, 2012, at 12:12 AM, Abhinav Sarje wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I just tried building afresh -&gt; svn co, autogen, configure, make. And
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; it failed at the same point as before:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Any more ideas/fixes?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Thanks all.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Abhinav.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Fri, Mar 2, 2012 at 8:14 AM, Abhinav Sarje &lt;asarje_at_[hidden]&gt; wrote:
</span><br>
