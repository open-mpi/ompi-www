...
?>
<!-- received="Wed Mar 28 11:22:03 2012" -->
<!-- isoreceived="20120328152203" -->
<!-- sent="Wed, 28 Mar 2012 17:21:39 +0200" -->
<!-- isosent="20120328152139" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Can not run a parallel job on all the nodes in the cluster" -->
<!-- id="0A873BFE-671A-4261-8201-476E68E39213_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="COL105-W637646255DD083818A71B39D4B0_at_phx.gbl" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-03-28 11:21:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18861.php">Hameed Alzahrani: "Re: [OMPI users] Can not run a parallel job on all the nodes in the cluster"</a>
<li><strong>Previous message:</strong> <a href="18859.php">Hameed Alzahrani: "Re: [OMPI users] Can not run a parallel job on all the nodes in the cluster"</a>
<li><strong>In reply to:</strong> <a href="18859.php">Hameed Alzahrani: "Re: [OMPI users] Can not run a parallel job on all the nodes in the cluster"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18861.php">Hameed Alzahrani: "Re: [OMPI users] Can not run a parallel job on all the nodes in the cluster"</a>
<li><strong>Reply:</strong> <a href="18861.php">Hameed Alzahrani: "Re: [OMPI users] Can not run a parallel job on all the nodes in the cluster"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Am 28.03.2012 um 16:55 schrieb Hameed Alzahrani:
<br>
<p><span class="quotelev1">&gt; I ran hello program which return the host name when I run it using 
</span><br>
...
<p>If you want to specify the number of slots you can put it in a hostfile (otherwise a round robin assignment is just used). I'm not aware that it can be specified on the command line with different values for each machine:
<br>
<p>host1 slots=4
<br>
host2 slots=2
