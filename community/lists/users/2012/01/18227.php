...
?>
<!-- received="Thu Jan 19 22:17:23 2012" -->
<!-- isoreceived="20120120031723" -->
<!-- sent="Thu, 19 Jan 2012 19:17:17 -0800 (PST)" -->
<!-- isosent="20120120031717" -->
<!-- name="Randolph Pullen" -->
<!-- email="randolph_pullen_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fw:  system() call corrupts MPI processes" -->
<!-- id="1327029437.60435.YahooMailNeo_at_web121006.mail.ne1.yahoo.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="6BE71254-9519-49EB-959B-AF28CD36C2BB_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-01-19 22:17:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18228.php">Randolph Pullen: "Re: [OMPI users] Fw:  system() call corrupts MPI processes"</a>
<li><strong>Previous message:</strong> <a href="18226.php">Ralph Castain: "Re: [OMPI users] Fw:  system() call corrupts MPI processes"</a>
<li><strong>In reply to:</strong> <a href="18226.php">Ralph Castain: "Re: [OMPI users] Fw:  system() call corrupts MPI processes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18228.php">Randolph Pullen: "Re: [OMPI users] Fw:  system() call corrupts MPI processes"</a>
<li><strong>Reply:</strong> <a href="18228.php">Randolph Pullen: "Re: [OMPI users] Fw:  system() call corrupts MPI processes"</a>
<li><strong>Reply:</strong> <a href="18229.php">Randolph Pullen: "Re: [OMPI users] Fw:  system() call corrupts MPI processes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18227/attachment">attachment</a>
</ul>
