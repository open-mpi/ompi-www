...
?>
<!-- received="Thu Jan  5 12:29:34 2012" -->
<!-- isoreceived="20120105172934" -->
<!-- sent="Thu, 5 Jan 2012 17:29:29 +0000 (GMT)" -->
<!-- isosent="20120105172929" -->
<!-- name="devendra rai" -->
<!-- email="rai.devendra_at_[hidden]" -->
<!-- subject="[OMPI users] Strange segfault in mpirun: orterun.c:486" -->
<!-- id="1325784569.66667.YahooMailNeo_at_web29602.mail.ird.yahoo.com" -->
<!-- charset="iso-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-01-05 12:29:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18100.php">Ralph Castain: "Re: [OMPI users] Strange Segfault in mpirun: orterun.c:486"</a>
<li><strong>Previous message:</strong> <a href="18098.php">devendra rai: "[OMPI users] Strange Segfault in mpirun: orterun.c:486"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
ago. Since then, there has been some upgrades on my Linux OS (basically, the ones which the system picks up automatically). 


Now, I rebuild and rerun the same application, I get this:

mpirun: orterun.c:486: orterun: Assertion `((0xdeafbeedULL &lt;&lt; 32) + 
0xdeafbeedULL) == ((opal_object_t *) (&amp;cmd_line))-&gt;obj_magic_id' 
failed.
...
--enable-mem-profile --enable-mem-debug --enable-debug --enable-trace --enable-memchecker --with-valgrind=/usr 
--with-threads=posix&#160;
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18099/attachment">attachment</a>
</ul>
