...
?>
<!-- received="Fri Jan 20 13:02:14 2012" -->
<!-- isoreceived="20120120180214" -->
...
<!-- id="AA9E9D2D-6125-481C-A7B7-6E072E3722E3_at_GMAIL.COM" -->
<!-- charset="us-ascii" -->
<!-- expires="-1" -->
<div class="center">
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18238.php">Ralph Castain: "Re: [OMPI users] OpenMPI failed when running across two mac machines"</a>
<li><strong>Previous message:</strong> <a href="18236.php">Teng Lin: "[OMPI users] OpenMPI failed when running across two mac machines"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18237/plm_rsh_module.c.patch">plm_rsh_module.c.patch</a>
</ul>
