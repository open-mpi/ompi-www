<?
$subject_val = "[OMPI users] FW: mpirun hangs when used on more than 2 CPUs ( mpirun compiled without thread support )";
include("../../include/msg-header.inc");
?>
<!-- received="Thu Jan 19 05:52:47 2012" -->
<!-- isoreceived="20120119105247" -->
<!-- sent="Thu, 19 Jan 2012 10:51:32 +0000" -->
<!-- isosent="20120119105132" -->
<!-- name="Theiner, Andre" -->
...
<!-- id="088B9CB56632924D9EAE7A408BB76580845AA2D3AF_at_GVW1102EXC.americas.hpqcorp.net" -->
<!-- charset="us-ascii" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] FW: mpirun hangs when used on more than 2 CPUs ( mpirun compiled without thread support )<br>
<strong>From:</strong> Theiner, Andre (<em>andre.theiner_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-01-19 05:51:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18210.php">Jeff Squyres: "Re: [OMPI users] mpirun hangs when used on more than 2 CPUs ( mpirun compiled without thread support )"</a>
<li><strong>Previous message:</strong> <a href="18208.php">Shiqing Fan: "Re: [OMPI users] How to configure Intel Visual Fortran to work with OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18211.php">Jeff Squyres: "Re: [OMPI users] FW: mpirun hangs when used on more than 2 CPUs ( mpirun compiled without thread support )"</a>
<li><strong>Reply:</strong> <a href="18211.php">Jeff Squyres: "Re: [OMPI users] FW: mpirun hangs when used on more than 2 CPUs ( mpirun compiled without thread support )"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I found out that OpenFoam does not use threaded MPI-calls.
<br>
...
Importance: High
<br>
<p>Thanks, Jeff and Ralph for your good help.
<br>
