...
<p class="headers">
<strong>Subject:</strong> [OMPI users] MPI-2 in MX (was: MPI 2 support in sm btl)<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-01-04 08:04:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18091.php">Richard Walsh: "Re: [OMPI users] Latest Intel Compilers (ICS, version 12.1.0.233 Build 20110811) issues ..."</a>
<li><strong>Previous message:</strong> <a href="18089.php">Jeff Squyres: "Re: [OMPI users] possibly undefined macro: AC_PROG_LIBTOOL"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/12/18065.php">Sabela Ramos Garea: "Re: [OMPI users] MPI 2 support in sm btl"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
