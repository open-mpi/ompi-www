<?
$subject_val = "[OMPI users] SIGSEGV on MPI_Test";
include("../../include/msg-header.inc");
?>
<!-- received="Thu Jan 12 11:05:37 2012" -->
<!-- isoreceived="20120112160537" -->
<!-- sent="Thu, 12 Jan 2012 16:05:31 +0000 (GMT)" -->
<!-- isosent="20120112160531" -->
<!-- name="devendra rai" -->
<!-- email="dev641_at_[hidden]" -->
<!-- subject="[OMPI users] SIGSEGV on MPI_Test" -->
<!-- id="1326384331.8226.YahooMailNeo_at_web29604.mail.ird.yahoo.com" -->
<!-- charset="iso-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] SIGSEGV on MPI_Test<br>
<strong>From:</strong> devendra rai (<em>dev641_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-01-12 11:05:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18154.php">devendra rai: "Re: [OMPI users] SIGSEGV on MPI_Test"</a>
<li><strong>Previous message:</strong> <a href="18152.php">Roberto Rey: "Re: [OMPI users] Strange TCP latency results on Amazon EC2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18154.php">devendra rai: "Re: [OMPI users] SIGSEGV on MPI_Test"</a>
<li><strong>Reply:</strong> <a href="18154.php">devendra rai: "Re: [OMPI users] SIGSEGV on MPI_Test"</a>
<li><strong>Reply:</strong> <a href="18155.php">devendra rai: "Re: [OMPI users] SIGSEGV on MPI_Test"</a>
<li><strong>Reply:</strong> <a href="18308.php">Jeff Squyres: "Re: [OMPI users] SIGSEGV on MPI_Test"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
/*This is line 111 */MPI_Test(&amp;(this-&gt;Isend_request), &amp;(this-&gt;SendComplete), &amp;(this-&gt;ISend_status));
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18153/attachment">attachment</a>
</ul>
