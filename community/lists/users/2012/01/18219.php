...
?>
<!-- received="Thu Jan 19 10:44:58 2012" -->
<!-- isoreceived="20120119154458" -->
<!-- sent="Thu, 19 Jan 2012 08:44:49 -0700" -->
<!-- isosent="20120119154449" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Possible bug in finalize, OpenMPI v1.5, head revision" -->
<!-- id="6790A575-B547-479E-B09F-E47F4ECC2EED_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="5CE14FFD-00E4-496A-9304-568F6744BFF2_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-01-19 10:44:49
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18220.php">Ralph Castain: "Re: [OMPI users] localhost only"</a>
<li><strong>Previous message:</strong> <a href="18218.php">Jeff Squyres: "Re: [OMPI users] MPI_Type_struct for template class with dynamic arrays and objs. instantiated from other classes"</a>
<li><strong>In reply to:</strong> <a href="18213.php">Jeff Squyres: "Re: [OMPI users] Possible bug in finalize, OpenMPI v1.5, head revision"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18242.php">Mike Dubman: "Re: [OMPI users] Possible bug in finalize, OpenMPI v1.5, head revision"</a>
<li><strong>Reply:</strong> <a href="18242.php">Mike Dubman: "Re: [OMPI users] Possible bug in finalize, OpenMPI v1.5, head revision"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>As I told Mike off-list, I think it may have been that the binary was compiled against a different OMPI version by mistake. It looks very much like what I'd expect to have happen in that scenario.
<br>
<p>On Jan 19, 2012, at 7:52 AM, Jeff Squyres wrote:
<br>
<p><span class="quotelev1">&gt; Did you &quot;svn up&quot;?  I ask because Ralph committed some stuff yesterday that may have fixed this.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Jan 18, 2012, at 5:19 PM, Andrew Senin wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; No, nothing specific. Only basic settings (--mca btl openib,self
</span><br>
<span class="quotelev2">&gt;&gt; --npernode 1, etc).
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Actually I'm were confused with this error because today it just
</span><br>
<span class="quotelev2">&gt;&gt; disapeared. I had 2 separate folders where it was reproduced in 100%
</span><br>
<span class="quotelev2">&gt;&gt; of test runs. Today I recompiled the source and it is gone in both
</span><br>
<span class="quotelev2">&gt;&gt; folders. But yesterday I tried recompiling multiple times with no
</span><br>
<span class="quotelev2">&gt;&gt; effect. So I believe this must be somehow related to some unknown
</span><br>
<span class="quotelev2">&gt;&gt; settings in the lab which have been changed. Trying to reproduce the
</span><br>
<span class="quotelev2">&gt;&gt; crash now...
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Thu, Jan 19, 2012 at 12:05 AM, Jeff Squyres &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Jumping in pretty late in this thread here...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I see that it's failing in opal_hwloc_base_close().  That's a little worrysome.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I do see an odd path through the hwloc initialization that *could* cause an error during finalization -- but it would involve you setting an invalid value for an MCA parameter.  Are you setting hwloc_base_mem_bind_failure_action or
</span><br>
<span class="quotelev3">&gt;&gt;&gt; hwloc_base_mem_alloc_policy, perchance?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Jan 16, 2012, at 1:56 PM, Andrew Senin wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [mir1:05542] [ 8] /lib64/libc.so.6(__libc_start_main+0xfd) [0x390ca1ec5d]
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [mir2:10218] [ 8] /lib64/libc.so.6(__libc_start_main+0xfd) [0x3a6d41ec5d]
</span><br>
