...
?>
<!-- received="Fri Jan 27 11:59:03 2012" -->
<!-- isoreceived="20120127165903" -->
<!-- sent="Fri, 27 Jan 2012 11:58:57 -0500" -->
<!-- isosent="20120127165857" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_AllGather null terminator character" -->
<!-- id="DD4A706E-A90D-4762-ABF1-E9037638CDE2_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-01-27 11:58:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18303.php">Jeff Squyres: "Re: [OMPI users] pure static &quot;mpirun&quot; launcher"</a>
<li><strong>Previous message:</strong> <a href="18301.php">Jeff Squyres: "Re: [OMPI users] MPI_Comm_split and intercommunicator - Problem"</a>
<li><strong>In reply to:</strong> <a href="18295.php">Gabriele Fatigati: "Re: [OMPI users] MPI_AllGather null terminator character"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18306.php">Gabriele Fatigati: "Re: [OMPI users] MPI_AllGather null terminator character"</a>
<li><strong>Reply:</strong> <a href="18306.php">Gabriele Fatigati: "Re: [OMPI users] MPI_AllGather null terminator character"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>If you have a buffer of size 128, and gethostname() only fills in, say, the first 32 bytes (including the \0), the other 128-32=96 bytes are uninitialized.  You can MPI_Allgather these, in which case those 96 uninitialized bytes will be copied over to the hostname_recv_buf buffer.
<br>
<p>For each rank, valgrind can actually track the local memcpy from local_hostname to hostnam_recv_buf[rank * MAX_LEN_SIZE], and it knows that those 96 bytes are still uninitialized.
<br>
<p>So when you go to strcmp them later, valgrind says &quot;ah ha! those are uninitialized!&quot;
<br>
<p>Meaning: I think that in some cases, valgrind is actually tracking the memcpy of uninitialized bytes and then alerting you later when you access those secondary uninitialized bytes.
<br>
<p>If I'm right, you can memset the local_hostname buffer (or use calloc), and then valgrind warnings will go away.
<br>
<p><p><p>On Jan 27, 2012, at 8:21 AM, Gabriele Fatigati wrote:
<br>
