...
?>
<!-- received="Wed Jan  4 10:06:43 2012" -->
<!-- isoreceived="20120104150643" -->
<!-- sent="Wed, 4 Jan 2012 15:06:35 +0000" -->
<!-- isosent="20120104150635" -->
<!-- name="Richard Walsh" -->
<!-- email="Richard.Walsh_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Latest Intel Compilers (ICS, version 12.1.0.233 Build 20110811) issues ..." -->
<!-- id="762096C11C5A044A9D92961C2E1A7CE8192A4C86_at_MBOX1.FLAS.CSI.CUNY.EDU" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="alpine.LRH.2.00.1201031343520.22438_at_scorpion.emsl.pnl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-01-04 10:06:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18092.php">devendra rai: "Re: [OMPI users] MPI::Request::Test not working"</a>
<li><strong>Previous message:</strong> <a href="18090.php">Jeff Squyres: "[OMPI users] MPI-2 in MX (was: MPI 2 support in sm btl)"</a>
<li><strong>In reply to:</strong> <a href="18086.php">Tim Carlson: "Re: [OMPI users] Latest Intel Compilers (ICS, version 12.1.0.233 Build 20110811) issues ..."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18315.php">Götz Waschk: "Re: [OMPI users] Latest Intel Compilers (ICS, version 12.1.0.233 Build 20110811) issues ..."</a>
<li><strong>Reply:</strong> <a href="18315.php">Götz Waschk: "Re: [OMPI users] Latest Intel Compilers (ICS, version 12.1.0.233 Build 20110811) issues ..."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Tim/All,
<br>
<p>Thanks ... !! ... your response is on target, version 12.1.0.233 of the Intel
<br>
compiler has a vectorization bug.
<br>
<p>Moreover, this problem has been addressed with the following go-around
<br>
in the 1.5.5 OpenMPI release with the following fix in opal/mca/memory/linux/malloc.c:
<br>
<p>/* With Intel Composer XE V12.1.0, release 2011.6.233, any launch   */
<br>
...
<br>
<p>#ifdef __INTEL_COMPILER_BUILD_DATE
<br>
...
#endif
<br>
<p>So, anyone with the NEWEST Intel compiler should either use the 1.5.5
<br>
...
Subject: Re: [OMPI users] Latest Intel Compilers (ICS, version 12.1.0.233 Build 20110811) issues ...
<br>
<p>On Tue, 3 Jan 2012, Richard Walsh wrote:
<br>
