...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18903.php">vladimir marjanovic: "[OMPI users] (no subject)"</a>
<li><strong>Previous message:</strong> <a href="18901.php">Rayson Ho: "Re: [OMPI users] Error while loading shared libraries"</a>
<li><strong>In reply to:</strong> <a href="18901.php">Rayson Ho: "Re: [OMPI users] Error while loading shared libraries"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18904.php">Reuti: "Re: [OMPI users] Error while loading shared libraries"</a>
<li><strong>Reply:</strong> <a href="18904.php">Reuti: "Re: [OMPI users] Error while loading shared libraries"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18902/attachment">attachment</a>
</ul>
