...
?>
<!-- received="Thu Apr 19 07:22:00 2012" -->
<!-- isoreceived="20120419112200" -->
<!-- sent="Thu, 19 Apr 2012 13:21:55 +0200" -->
<!-- isosent="20120419112155" -->
...
<!-- id="OFA2F00E57.A246CEDB-ONC12579E5.003C4B28-C12579E5.003E6EC3_at_bull.net" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAFAE9jgByR9gFejiWDQEzNBtPF9ZrKa=0jmnwmNOCH0KkWSt6w_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-04-19 07:21:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19052.php">pascal.deveze_at_[hidden]: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<li><strong>Previous message:</strong> <a href="19050.php">Simone Pellegrini: "[OMPI users] send/recv implementation details"</a>
<li><strong>In reply to:</strong> <a href="19046.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19053.php">Jeffrey Squyres: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<li><strong>Reply:</strong> <a href="19053.php">Jeffrey Squyres: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
users-bounces_at_[hidden] a &#233;crit sur 19/04/2012 10:24:16 :
<br>
<p><span class="quotelev1">&gt; De : Rohan Deshpande &lt;rohand87_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; A : Open MPI Users &lt;users_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; Date : 19/04/2012 10:24
</span><br>
...
<span class="quotelev1">&gt; The offset is received from the master task. so no need to 
</span><br>
<span class="quotelev1">&gt; initialize for non master tasks?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; not sure what u meant exactly.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
This is OK.
<br>
<p>I have two remarks:
<br>
1)  In the update() subroutine, you declare a table of int of size 
<br>
&quot;myoffset+chunk&quot; that will be allocated in the process stack.
<br>
&nbsp;
<br>
&nbsp;&nbsp;&nbsp;&nbsp;For the task number 2, the size of this table is 4*3*1,000,000 = 12 
<br>
Mbytes
<br>
&nbsp;&nbsp;&nbsp;&nbsp;For the task number 3, the size of this table is 4*4*1,000,000 = 16 
<br>
Mbytes
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;This huge table is not used. Try to delete the declaration (or comment 
<br>
it).
<br>
<p>2) When you increase the size of ARRAYSIZE = 20,000,000, the value of sum 
<br>
in the first process  should be:
<br>
&nbsp;&nbsp;&nbsp;(10**6)*(10**6+1)/2. That's approximatly 10**12 or 2**40. This cannot 
<br>
be calcultated with the variable sum (int).
<br>
...
<p><span class="quotelev1">&gt; On Thu, Apr 19, 2012 at 3:36 PM, &lt;pascal.deveze_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; I do not see where you initialize the offset on the &quot;Non-master tasks
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;   /* Send each task its portion of the array - master keeps 1st 
</span><br>
part */
<br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;     MPI_Recv(&amp;offset, 1, MPI_INT, source, tag1, 
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19051/attachment">attachment</a>
</ul>
