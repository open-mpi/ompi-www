...
?>
<!-- received="Mon Apr  2 12:20:56 2012" -->
<!-- isoreceived="20120402162056" -->
<!-- sent="Mon, 2 Apr 2012 16:20:50 +0000" -->
<!-- isosent="20120402162050" -->
...
<!-- id="A5E16E86-C5EA-4C2E-9275-3AC563EF4260_at_lanl.gov" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2012-04-02 12:20:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18910.php">Reuti: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<li><strong>Previous message:</strong> <a href="18908.php">Ralph Castain: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18915.php">Ralph Castain: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<li><strong>Reply:</strong> <a href="18915.php">Ralph Castain: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Some of our users oversubscribe a node with multiple mpiruns in order to run their regression tests.  Recently, a user reported the same &quot;Could not detect network connectivity&quot; error.
<br>
<p>My question:  is there a way to allow this type of behavior?  That is, oversubscribe a node with multiple mpiruns.  For example, say I have a node with 16 processing elements and I want to run 8 instances of &quot;mpirun -n 3 mpi_foo&quot; on a single node simultaneously and don't care about performance.
<br>
<p>Please note that oversubscription within one node and a **single** mpirun works as expected.  The error only shows up when another mpirun wants to join the party.
<br>
<p>Thanks,
<br>
<p>Lost in Los Alamos
<br>
<p>&nbsp;
<br>
