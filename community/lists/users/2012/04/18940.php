...
?>
<!-- received="Wed Apr  4 12:12:15 2012" -->
<!-- isoreceived="20120404161215" -->
<!-- sent="Wed, 4 Apr 2012 09:12:10 -0700 (PDT)" -->
<!-- isosent="20120404161210" -->
<!-- name="anas trad" -->
<!-- email="tradat84_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Need Performance estimation of MPI_Bcast" -->
<!-- id="1333555930.3601.YahooMailClassic_at_web161202.mail.bf1.yahoo.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="A2CBF07A-A6CC-40CB-A548-F1451956E240_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-04-04 12:12:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18941.php">Thatyene Louise Alves de Souza Ramos: "Re: [OMPI users] Problem with MPI_Barrier (Inter-communicator)"</a>
<li><strong>Previous message:</strong> <a href="18939.php">Jeffrey Squyres: "Re: [OMPI users] Cluster : received unexpected process identifier"</a>
<li><strong>In reply to:</strong> <a href="18938.php">Jeffrey Squyres: "Re: [OMPI users] Need Performance estimation of MPI_Bcast"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
OK Jeffrey thanks a lot, the answer was very helpful to me, at least I got to know the complexity of this issue.&#194;&#160;
<br>
<p>--- On Wed, 4/4/12, Jeffrey Squyres &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
...
<br>
Date: Wednesday, April 4, 2012, 5:43 PM
<br>
<p>On Apr 4, 2012, at 9:56 AM, anas trad wrote:
<br>
...
<p>I can't cite any specific papers (collectives are not my focus area, and I left academia several years ago); you'll need to do some literature searches.&#194;&#160; I know that there have been quite a few papers and research projects over the past 15+ years about algorithms for MPI collective operations (including bcast).&#194;&#160; A good starting place would probably be proceedings from Euro MPI (and its predecessor, Euro PVM/MPI).
<br>
<p>I'm guessing that there are probably also some papers/projects that do modeling of collective algorithms in heterogeneous latency environments (e.g., shared memory + network), but this is even farther off my focus area, so I don't even have any general areas to point to.&#194;&#160; Sorry!
<br>
...
<span class="quotelev2">&gt; &gt; Hi&#194;&#160; Envoy&#195;&#169; ,
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18940/attachment">attachment</a>
</ul>
