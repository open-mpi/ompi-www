...
?>
<!-- received="Mon Apr  2 23:29:09 2012" -->
<!-- isoreceived="20120403032909" -->
<!-- sent="Mon, 2 Apr 2012 20:29:04 -0700" -->
<!-- isosent="20120403032904" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)" -->
<!-- id="CAMD57ocj5KtunO9ZvOm0fH7_RNtG1oLjGw0CETXodRyj93+TbA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="A5E16E86-C5EA-4C2E-9275-3AC563EF4260_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-04-02 23:29:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18916.php">Ralph Castain: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<li><strong>Previous message:</strong> <a href="18914.php">Rohan Deshpande: "Re: [OMPI users] Error while loading shared libraries"</a>
<li><strong>In reply to:</strong> <a href="18909.php">Gutierrez, Samuel K: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm	allocation (with QLogic PSM)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18910.php">Reuti: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I'm afraid not, even with the changes in the developer trunk. What happens
<br>
is that the local and node ranks for each mpirun start over at 0 because
<br>
the instances of mpirun don't know about each other. PSM uses the local
<br>
rank as an index for determining endpoint. So running multiple mpiruns on
<br>
the same nodes causes PSM to incorrectly map endpoints on top of each other.
<br>
<p>It would be possible to support the desired behavior by adding appropriate
<br>
options to mpirun - essentially telling mpirun to &quot;assume N ranks already
<br>
exist on each node&quot;. Clunky, but would work.
<br>
<p><p>On Mon, Apr 2, 2012 at 9:20 AM, Gutierrez, Samuel K &lt;samuel_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Sorry to hijack the thread, but I have a question regarding the failed PSM
</span><br>
<span class="quotelev1">&gt; initialization.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Some of our users oversubscribe a node with multiple mpiruns in order to
</span><br>
<span class="quotelev1">&gt; run their regression tests.  Recently, a user reported the same &quot;Could not
</span><br>
<span class="quotelev1">&gt; detect network connectivity&quot; error.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; My question:  is there a way to allow this type of behavior?  That is,
</span><br>
<span class="quotelev1">&gt; oversubscribe a node with multiple mpiruns.  For example, say I have a node
</span><br>
<span class="quotelev1">&gt; with 16 processing elements and I want to run 8 instances of &quot;mpirun -n 3
</span><br>
<span class="quotelev1">&gt; mpi_foo&quot; on a single node simultaneously and don't care about performance.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Please note that oversubscription within one node and a **single** mpirun
</span><br>
<span class="quotelev1">&gt; works as expected.  The error only shows up when another mpirun wants to
</span><br>
<span class="quotelev1">&gt; join the party.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Lost in Los Alamos
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Apr 2, 2012, at 9:40 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18915/attachment">attachment</a>
</ul>
