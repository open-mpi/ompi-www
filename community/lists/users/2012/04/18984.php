...
?>
<!-- received="Tue Apr 10 13:57:27 2012" -->
<!-- isoreceived="20120410175727" -->
<!-- sent="Tue, 10 Apr 2012 19:57:14 +0200" -->
<!-- isosent="20120410175714" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] sge tight intregration leads to bad allocation" -->
<!-- id="C8D5ACCE-FAD9-4AA2-83BB-A2D9A4FA077D_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-04-10 13:57:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18985.php">Ralph Castain: "Re: [OMPI users] sge tight intregration leads to bad allocation"</a>
<li><strong>Previous message:</strong> <a href="18983.php">toufik hadjazi: "Re: [OMPI users] configuration of openmpi-1.5.4 with visual studio"</a>
<li><strong>In reply to:</strong> <a href="18979.php">Eloi Gaudry: "Re: [OMPI users] sge tight intregration leads to bad allocation"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18985.php">Ralph Castain: "Re: [OMPI users] sge tight intregration leads to bad allocation"</a>
<li><strong>Reply:</strong> <a href="18985.php">Ralph Castain: "Re: [OMPI users] sge tight intregration leads to bad allocation"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Yes, it should work without problem to specify -np. As it didn't hit me in my tests (normally I don't specify -np), I would really be interested in the underlying cause.
<br>
<p>Especially as the example in Open MPI's FAQ lists -np to start with GirdEngine integration, it should have hit other users too.
<br>
<p>-- Reuti
<br>
