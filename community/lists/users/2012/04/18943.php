...
?>
<!-- received="Wed Apr  4 16:09:45 2012" -->
<!-- isoreceived="20120404200945" -->
<!-- sent="Wed, 4 Apr 2012 17:09:19 -0300" -->
<!-- isosent="20120404200919" -->
...
<!-- id="CAEyYoRoGEzRGDVQ4myEpkAGdqvdUaWEFgferajurFueDexF+ug_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="4F7CA95C.4010008_at_cs.uh.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-04-04 16:09:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18944.php">Rohan Deshpande: "Re: [OMPI users] Cluster : received unexpected process identifier"</a>
<li><strong>Previous message:</strong> <a href="18942.php">Edgar Gabriel: "Re: [OMPI users] Problem with MPI_Barrier (Inter-communicator)"</a>
<li><strong>In reply to:</strong> <a href="18942.php">Edgar Gabriel: "Re: [OMPI users] Problem with MPI_Barrier (Inter-communicator)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18955.php">Edgar Gabriel: "Re: [OMPI users] Problem with MPI_Barrier (Inter-communicator)"</a>
<li><strong>Reply:</strong> <a href="18955.php">Edgar Gabriel: "Re: [OMPI users] Problem with MPI_Barrier (Inter-communicator)"</a>
<li><strong>Reply:</strong> <a href="18960.php">Edgar Gabriel: "Re: [OMPI users] Problem with MPI_Barrier (Inter-communicator)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Unfortunately, I've tried with and without this option. In both the result
<br>
was the same... =(
<br>
<p>On Wed, Apr 4, 2012 at 5:04 PM, Edgar Gabriel &lt;gabriel_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; did you try to start the program with the --mca coll ^inter switch that
</span><br>
...
<span class="quotelev2">&gt; &gt; do not work with Inter communicators. I've try this in the client group:/
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; The server_comm is the original inter communicator with the server group.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;     &gt; you suggested and the program worked fine, even when I use 1 server
</span><br>
<span class="quotelev3">&gt; &gt;     &gt; instance.
</span><br>
<span class="quotelev3">&gt; &gt;     &gt;
</span><br>
<span class="quotelev3">&gt; &gt;     &gt; What is the modification caused by this parameter? I did not find
</span><br>
...
<span class="quotelev3">&gt; &gt;     &gt; &lt;rsilva.oliveira_at_[hidden] &lt;mailto:rsilva.oliveira_at_[hidden]&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;     &gt;     Thanks for the response. I just did not understand why the
</span><br>
...
<span class="quotelev3">&gt; &gt;     &gt;     I tryed it with 1 server and 3 clients and it worked properly.
</span><br>
<span class="quotelev2">&gt; &gt;     After
</span><br>
<span class="quotelev3">&gt; &gt;     &gt;     I removed 1 of the clients, it stops working. So, the removal
</span><br>
...
<span class="quotelev3">&gt; &gt;     &gt;         I do not recall on what the agreement was on how to treat
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18943/attachment">attachment</a>
</ul>
