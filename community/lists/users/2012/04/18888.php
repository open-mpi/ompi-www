...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18889.php">Rohan Deshpande: "[OMPI users] Error while loading shared libraries"</a>
<li><strong>Previous message:</strong> <a href="18887.php">seshendra seshu: "Re: [OMPI users] Regarding the error while running an mpi program"</a>
<li><strong>In reply to:</strong> <a href="18887.php">seshendra seshu: "Re: [OMPI users] Regarding the error while running an mpi program"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-18888/attachment">attachment</a>
</ul>
