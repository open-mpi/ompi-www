...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)<br>
<strong>From:</strong> R&#195;&#169;mi Palancher (<em>remi_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-04-02 08:53:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18907.php">Prentice Bisbal: "Re: [OMPI users] redirecting output"</a>
<li><strong>Previous message:</strong> <a href="18905.php">Nico Mittenzwey: "Re: [OMPI users] Help with multicore AMD machine performance"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18908.php">Ralph Castain: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<li><strong>Reply:</strong> <a href="18908.php">Ralph Castain: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>application/x-gzip attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18906/config.log.gz">config.log.gz</a>
</ul>
<!-- attachment="config.log.gz" -->
<hr>
<ul>
<li>application/x-gzip attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18906/ompi_info_all.txt.gz">ompi_info_all.txt.gz</a>
</ul>
<!-- attachment="ompi_info_all.txt.gz" -->
<hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18906/ompi_nodes.txt">ompi_nodes.txt</a>
</ul>
