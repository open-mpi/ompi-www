...
?>
<!-- received="Thu Apr 19 05:59:35 2012" -->
<!-- isoreceived="20120419095935" -->
<!-- sent="Thu, 19 Apr 2012 05:59:30 -0400" -->
<!-- isosent="20120419095930" -->
<!-- name="Jeffrey Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] machine exited on signal 11 (Segmentation fault)." -->
<!-- id="513318FA-7F48-48C3-A892-0031EBFA6EAA_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2012-04-19 05:59:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19048.php">Bernhard Knapp: "[OMPI users] hostname not known only in fedora 15"</a>
<li><strong>Previous message:</strong> <a href="19046.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19049.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<li><strong>Reply:</strong> <a href="19049.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Have you tried running it through a memory-checking debugger, like valgrind?
<br>
<p><p>On Apr 19, 2012, at 4:24 AM, Rohan Deshpande wrote:
<br>
<p><span class="quotelev1">&gt; Hi Pascal, 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The offset is received from the master task. so no need to initialize for non master tasks?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Thu, Apr 19, 2012 at 3:36 PM, &lt;pascal.deveze_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; I do not see where you initialize the offset on the &quot;Non-master tasks&quot;. This could be the problem. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt; On Wed, Apr 18, 2012 at 8:11 PM, Jeffrey Squyres &lt;jsquyres_at_[hidden]&gt; wrote: 
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; On Tue, Apr 17, 2012 at 6:01 PM, Jeffrey Squyres &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;     MPI_Recv(&amp;offset, 1, MPI_INT, source, tag1, MPI_COMM_WORLD, &amp;status);
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;   MPI_Reduce(&amp;mysum, &amp;sum, 1, MPI_INT, MPI_SUM, MASTER, MPI_COMM_WORLD);
</span><br>
