...
?>
<!-- received="Thu Apr  5 16:10:58 2012" -->
<!-- isoreceived="20120405201058" -->
<!-- sent="Thu, 05 Apr 2012 15:10:53 -0500" -->
<!-- isosent="20120405201053" -->
<!-- name="Edgar Gabriel" -->
<!-- email="gabriel_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem with MPI_Barrier (Inter-communicator)" -->
<!-- id="4F7DFC4D.9090501_at_cs.uh.edu" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2012-04-05 16:10:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18961.php">Anton Morgan: "Re: [OMPI users] Myid changes to 0 after using a mpi_recv"</a>
<li><strong>Previous message:</strong> <a href="18959.php">Anton Morgan: "[OMPI users] Myid changes to 0 after using a mpi_recv"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18973.php">Thatyene Louise Alves de Souza Ramos: "Re: [OMPI users] Problem with MPI_Barrier (Inter-communicator)"</a>
<li><strong>Reply:</strong> <a href="18973.php">Thatyene Louise Alves de Souza Ramos: "Re: [OMPI users] Problem with MPI_Barrier (Inter-communicator)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Having your code to see what your code precisely does would help me to
<br>
hunt the problem down, since I am otherwise not able to reproduce the
<br>
problem.
<br>
<p>Also, which version of Open MPI did you use?
<br>
<p>Thanks
<br>
Edgar
...
<hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18960/signature.asc">OpenPGP digital signature</a>
</ul>
