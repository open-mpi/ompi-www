...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18894.php">Nico Mittenzwey: "Re: [OMPI users] Help with multicore AMD machine performance"</a>
<li><strong>Previous message:</strong> <a href="18892.php">vladimir marjanovic: "[OMPI users] (no subject)"</a>
<li><strong>In reply to:</strong> <a href="18891.php">Rohan Deshpande: "Re: [OMPI users] Error while loading shared libraries"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18903.php">Rohan Deshpande: "Re: [OMPI users] Error while loading shared libraries"</a>
<li><strong>Reply:</strong> <a href="18903.php">Rohan Deshpande: "Re: [OMPI users] Error while loading shared libraries"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
