...
?>
<!-- received="Tue Apr 17 22:43:43 2012" -->
<!-- isoreceived="20120418024343" -->
<!-- sent="Wed, 18 Apr 2012 10:43:39 +0800" -->
<!-- isosent="20120418024339" -->
<!-- name="Rohan Deshpande" -->
<!-- email="rohand87_at_[hidden]" -->
<!-- subject="Re: [OMPI users] machine exited on signal 11 (Segmentation fault)." -->
<!-- id="CAFAE9ji7jqQaO6=Onccd2Utg=AATZ8x=A+ZRZPOdvYt2MrH-Tg_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="61E824D2-ACDB-432E-ADF5-93BF4E82ABA2_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-04-17 22:43:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19037.php">Peter Sels: "Re: [OMPI users] MPI_Send, MPI_Recv problem on Mac and Linux"</a>
<li><strong>Previous message:</strong> <a href="19035.php">Rayson Ho: "Re: [OMPI users] Sharing (not copying) data with OpenMPI?"</a>
<li><strong>In reply to:</strong> <a href="19027.php">Jeffrey Squyres: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19038.php">Jeffrey Squyres: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<li><strong>Reply:</strong> <a href="19038.php">Jeffrey Squyres: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Thanks
<br>
<p><p><p>On Tue, Apr 17, 2012 at 6:01 PM, Jeffrey Squyres &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Try malloc'ing your array instead of creating it statically on the stack.
</span><br>
...
<span class="quotelev2">&gt; &gt; int   numtasks, taskid, rc, dest, offset, i, j, tag1, tag2, source,
</span><br>
...
<span class="quotelev2">&gt; &gt;     MPI_Send(&amp;data[offset], chunksize, MPI_INT, dest, tag2,
</span><br>
<span class="quotelev1">&gt; MPI_COMM_WORLD);
</span><br>
<span class="quotelev2">&gt; &gt;     printf(&quot;Sent %d elements to task %d offset=
</span><br>
...
<span class="quotelev2">&gt; &gt;   MPI_Recv(&amp;data[offset], chunksize, MPI_INT, source,
</span><br>
...
<span class="quotelev2">&gt; &gt;   printf(&quot;time taken by process %d to recieve elements and caluclate own
</span><br>
<span class="quotelev1">&gt; sum is = %lf seconds \n&quot;, taskid, time);
</span><br>
...
<span class="quotelev2">&gt; &gt;   MPI_Send(&amp;data[offset], chunksize, MPI_INT, MASTER, tag2,
</span><br>
<span class="quotelev1">&gt; MPI_COMM_WORLD);
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev2">&gt; &gt; // printf(&quot;Total time taken for distribution is -  %lf  seconds&quot;,
</span><br>
...
<span class="quotelev2">&gt; &gt; When I run it with ARRAYSIZE = 2000000 The program works fine. But when
</span><br>
<span class="quotelev1">&gt; I increase the size ARRAYSIZE = 20000000. The program ends with
</span><br>
<span class="quotelev1">&gt; segmentation fault.
</span><br>
<span class="quotelev2">&gt; &gt; I am running it on a cluster (machine 4 is master, machine 5,6 are
</span><br>
...
<span class="quotelev2">&gt; &gt; time taken by process 1 to recieve elements and caluclate own sum is =
</span><br>
...
<span class="quotelev2">&gt; &gt; time taken by process 2 to recieve elements and caluclate own sum is =
</span><br>
...
<span class="quotelev2">&gt; &gt; mpirun noticed that process rank 3 with PID 5695 on node machine4 exited
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19036/attachment">attachment</a>
</ul>
