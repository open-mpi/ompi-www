...
?>
<!-- received="Thu Apr 19 07:46:46 2012" -->
<!-- isoreceived="20120419114646" -->
<!-- sent="Thu, 19 Apr 2012 13:46:39 +0200" -->
<!-- isosent="20120419114639" -->
...
<!-- id="OFB995009C.E76A425D-ONC12579E5.004079B4-C12579E5.0040B2A3_at_bull.net" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAFAE9jgsrACX=MS1A-Uvj_FW-QJw86KaYib-bL6YFnqSAtYgWA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-04-19 07:46:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19053.php">Jeffrey Squyres: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<li><strong>Previous message:</strong> <a href="19051.php">pascal.deveze_at_[hidden]: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<li><strong>In reply to:</strong> <a href="19049.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19051.php">pascal.deveze_at_[hidden]: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
users-bounces_at_[hidden] a &#233;crit sur 19/04/2012 12:42:44 :
<br>
<p><span class="quotelev1">&gt; De : Rohan Deshpande &lt;rohand87_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; A : Open MPI Users &lt;users_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; Date : 19/04/2012 12:44
</span><br>
...
<span class="quotelev1">&gt; No I havent tried using valgrind. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; here is the latest code - 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; #define  ARRAYSIZE 200000
</span><br>
...
<span class="quotelev1">&gt; int   numtasks, taskid, rc, dest, offset, i, j, tag1, tag2, source, 
</span><br>
...
<span class="quotelev1">&gt; if (numtasks % 4 != 0) {
</span><br>
<span class="quotelev1">&gt;    printf(&quot;Quitting. Number of MPI tasks must be divisible by 4.\n&quot;);
</span><br>
...
<span class="quotelev1">&gt;     printf(&quot;Data null&quot;);
</span><br>
<span class="quotelev1">&gt;   }
</span><br>
<p><p>==&gt; This array is used in the update subroutine that is called by all 
<br>
processes
<br>
So this initialisation should be done in the common code.
<br>
<p><p><span class="quotelev1">&gt;   sum = 0;
</span><br>
...
MPI_COMM_WORLD);
<br>
<span class="quotelev1">&gt;     printf(&quot;Sent %d elements to task %d offset= 
</span><br>
...
<span class="quotelev1">&gt;   printf(&quot;time taken by process %d to recieve elements and caluclate
</span><br>
...
<span class="quotelev1">&gt; // printf(&quot;Total time taken for distribution is -  %lf  seconds&quot;, 
</span><br>
totaltime);
<br>
<span class="quotelev1">&gt; MPI_Finalize();
...
<span class="quotelev1">&gt; On Thu, Apr 19, 2012 at 5:59 PM, Jeffrey Squyres &lt;jsquyres_at_[hidden]&gt; 
</span><br>
wrote:
<br>
<span class="quotelev1">&gt; Send the most recent version of your code.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; initialize for non master tasks?
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; I do not see where you initialize the offset on the &quot;Non-master 
</span><br>
<span class="quotelev1">&gt; tasks&quot;. This could be the problem.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; Double check the buffers that you're sending to 
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; On Tue, Apr 17, 2012 at 6:01 PM, Jeffrey Squyres 
</span><br>
&lt;jsquyres_at_[hidden]
<br>
<span class="quotelev2">&gt; &gt; wrote:
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; When I exceed the certain data size the segmentation fault 
</span><br>
occurs.
<br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt;
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt;   /* Send each task its portion of the array - master keeps 
</span><br>
<span class="quotelev1">&gt; 1st part */
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt;   offset = chunksize;
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt;   for (dest=1; dest&lt;numtasks; dest++) {
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt;   /* Perform addition to each of my array elements and keep my 
</span><br>
sum */
<br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt;   mysum = 0;
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19052/attachment">attachment</a>
</ul>
