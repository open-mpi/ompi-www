...
?>
<!-- received="Tue Apr 17 11:13:05 2012" -->
<!-- isoreceived="20120417151305" -->
<!-- sent="Tue, 17 Apr 2012 08:12:59 -0700 (PDT)" -->
<!-- isosent="20120417151259" -->
<!-- name="kidd" -->
<!-- email="q19860103_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ompi-restart failed &amp;amp;&amp;amp; ompi-migrate" -->
<!-- id="1334675579.39442.YahooMailNeo_at_web130105.mail.mud.yahoo.com" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2012-04-17 11:12:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19033.php">Jeffrey Squyres: "Re: [OMPI users] MPI_Send, MPI_Recv problem on Mac and Linux"</a>
<li><strong>Previous message:</strong> <a href="19031.php">toufik hadjazi: "[OMPI users] scope of MPI_publish/Lookup_name of openmpi on windows 7"</a>
...
<!-- body="start" -->
<p>
Hello ,thank your reply,but I still can't&#194;&#160; Ompi-Restart&#194;&#160; Multiple-Node.
I checked my Node(ubuntu11.04&#194;&#160; &amp;&amp; openmpi1.5.5), they did not install the&#194;&#160; prelink.
Whether there are other reasons failed to ompi-restart?
ps: 

if Ompi-Restart&#194;&#160; Multiple-Node can be successful. 

Can start in another new node, rather than the original node?
example : checkpoint (node1,node2) ,then&#194;&#160; restart (node1,node3)
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19032/attachment">attachment</a>
</ul>
