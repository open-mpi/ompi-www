...
?>
<!-- received="Thu Apr 19 03:36:43 2012" -->
<!-- isoreceived="20120419073643" -->
<!-- sent="Thu, 19 Apr 2012 09:36:37 +0200" -->
<!-- isosent="20120419073637" -->
...
<!-- id="OF334CEB49.D7EBB823-ONC12579E5.0029A610-C12579E5.0029CE8B_at_bull.net" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAFAE9jhpDi2QAR3hcA-RFYdcZ0dw-G__wNYz5FmrLNPaFUiM5Q_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:pascal.deveze_at_[hidden]?Subject=Re:%20[OMPI%20users]%20machine%20exited%20on%20signal%2011%20(Segmentation%20fault)."><em>pascal.deveze_at_[hidden]</em></a><br>
<strong>Date:</strong> 2012-04-19 03:36:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19046.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<li><strong>Previous message:</strong> <a href="19044.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<li><strong>In reply to:</strong> <a href="19044.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19046.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<li><strong>Reply:</strong> <a href="19046.php">Rohan Deshpande: "Re: [OMPI users] machine exited on signal 11 (Segmentation fault)."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Pascal
<br>
<p>users-bounces_at_[hidden] a &#233;crit sur 19/04/2012 09:18:31 :
<br>
<p><span class="quotelev1">&gt; De : Rohan Deshpande &lt;rohand87_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; A : Open MPI Users &lt;users_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; Date : 19/04/2012 09:18
</span><br>
<span class="quotelev1">&gt; Objet : Re: [OMPI users] machine exited on signal 11 (Segmentation 
</span><br>
fault).
<br>
...
<span class="quotelev1">&gt; Hi Jeffy,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I checked the SEND RECV buffers and it looks ok to me. The code I 
</span><br>
<span class="quotelev1">&gt; have sent works only when I statically initialize the array. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The code fails everytime I use malloc to initialize the array. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Can you please look at code and let me know what is wrong.
</span><br>
<p><span class="quotelev1">&gt; On Wed, Apr 18, 2012 at 8:11 PM, Jeffrey Squyres &lt;jsquyres_at_[hidden]&gt; 
</span><br>
wrote:
<br>
<span class="quotelev1">&gt; As a guess, you're passing in a bad address.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
--------------------------------------------------------------------------
<br>
<span class="quotelev2">&gt; &gt; mpirun noticed that process rank 1 with PID 2936 on node machine4 
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; int   numtasks, taskid, rc, dest, offset, i, j, tag1, tag2, 
</span><br>
<span class="quotelev1">&gt; source, chunksize, namelen;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;     printf(&quot;Sent %d elements to task %d offset= %d
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;   printf(&quot;time taken by process %d to recieve elements and 
</span><br>
<span class="quotelev1">&gt; caluclate own sum is = %lf seconds \n&quot;, taskid, time);
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; // printf(&quot;Total time taken for distribution is -  %lf 
</span><br>
<span class="quotelev1">&gt;  seconds&quot;, totaltime);
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; When I run it with ARRAYSIZE = 2000000 The program works fine. 
</span><br>
<span class="quotelev1">&gt; But when I increase the size ARRAYSIZE = 20000000. The program ends 
</span><br>
<span class="quotelev1">&gt; with segmentation fault.
</span><br>
<span class="quotelev3">&gt; &gt; &gt; I am running it on a cluster (machine 4 is master, machine 5,6 
</span><br>
<span class="quotelev1">&gt; are slaves)  and np=20
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; time taken by process 1 to recieve elements and caluclate own 
</span><br>
<span class="quotelev1">&gt; sum is = 0.249345 seconds
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; time taken by process 2 to recieve elements and caluclate own 
</span><br>
<span class="quotelev1">&gt; sum is = 0.274285 seconds
</span><br>
...
--------------------------------------------------------------------------
<br>
<span class="quotelev3">&gt; &gt; &gt; mpirun noticed that process rank 3 with PID 5695 on node 
</span><br>
<span class="quotelev1">&gt; machine4 exited on signal 11 (Segmentation fault).
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
...
<span class="quotelev1">&gt; For corporate legal information go to: <a href="http://www.cisco.com/web/">http://www.cisco.com/web/</a>
</span><br>
<span class="quotelev1">&gt; about/doing_business/legal/cri/
</span><br>
<span class="quotelev1">&gt; 
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19045/attachment">attachment</a>
</ul>
