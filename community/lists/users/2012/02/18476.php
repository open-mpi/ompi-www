...
?>
<!-- received="Wed Feb 15 10:42:38 2012" -->
<!-- isoreceived="20120215154238" -->
<!-- sent="Wed, 15 Feb 2012 10:42:34 -0500" -->
<!-- isosent="20120215154234" -->
<!-- name="Gustavo Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] compilation error with pgcc Unknown switch" -->
<!-- id="3C901D11-BEB2-4923-93B8-75A6DBF36D73_at_ldeo.columbia.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CADbPk820zx7E5TLPixZ3LLq=Ds+LUZLkADSw8gtEbuS7ewGT3A_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-02-15 10:42:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18477.php">Jeff Squyres: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Previous message:</strong> <a href="18475.php">Jeff Squyres: "Re: [OMPI users] Strange OpenMPI messages"</a>
<li><strong>In reply to:</strong> <a href="18468.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18494.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Reply:</strong> <a href="18494.php">Abhinav Sarje: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Abhinav
<br>
<p>Did you add to your compiler flags -Bstatic [or perhaps -static],
<br>
...
<br>
[~/.mypggcc and friends] to see if -Bstatic is there, maybe inadvertently, and is set by default.
<br>
...
<br>
<p><span class="quotelev1">&gt; Hi Gus, I had tried with the -noswitcherror flags, which removed the
</span><br>
