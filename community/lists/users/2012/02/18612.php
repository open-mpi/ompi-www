...
?>
<!-- received="Wed Feb 29 13:49:05 2012" -->
<!-- isoreceived="20120229184905" -->
<!-- sent="Wed, 29 Feb 2012 13:49:00 -0500" -->
<!-- isosent="20120229184900" -->
<!-- name="Jeffrey Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [EXTERNAL] Re: Question regarding osu-benchamarks 3.1.1" -->
<!-- id="92310C35-B4E2-4CBC-A4A9-BD5378B1BA13_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAOf_+-UX35RX+b7zK8ehyoH26JvuuHEBLCEXhaP92CcKRWSdmQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-02-29 13:49:00
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18613.php">Jingcha Joba: "Re: [OMPI users] [EXTERNAL] Re: Question regarding osu-benchamarks 3.1.1"</a>
<li><strong>Previous message:</strong> <a href="18611.php">Jingcha Joba: "Re: [OMPI users] Very slow MPI_GATHER"</a>
<li><strong>In reply to:</strong> <a href="18610.php">Jingcha Joba: "Re: [OMPI users] [EXTERNAL] Re: Question regarding osu-benchamarks 3.1.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18613.php">Jingcha Joba: "Re: [OMPI users] [EXTERNAL] Re: Question regarding osu-benchamarks 3.1.1"</a>
<li><strong>Reply:</strong> <a href="18613.php">Jingcha Joba: "Re: [OMPI users] [EXTERNAL] Re: Question regarding osu-benchamarks 3.1.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>The fact is that the MPI-2 one-sided stuff is extremely complicated and somewhat open to interpretation.  In practice, I haven't seen the MPI-2 one-sided stuff used much in the wild.  The MPI-3 working group just revamped the one-sided support and generally made it much mo'betta.  Brian is re-implementing that stuff, and I believe it'll also be much mo'betta.
<br>
<p>My point: I wouldn't worry if not all one-sided benchmarks run with OMPI.  No one uses them (yet) anyway.
<br>
<p><p>On Feb 29, 2012, at 1:42 PM, Jingcha Joba wrote:
<br>
<p><span class="quotelev1">&gt; When I ran my osu tests , I was able to get the numbers out of all the tests except latency_mt (which was obvious, as I didnt compile open-mpi with multi threaded support).
</span><br>
<span class="quotelev1">&gt; A good way to know if the problem is with openmpi or with your custom OFED stack would be to use some other device like tcp instead of ib and rerun these one sided comm tests.
</span><br>
<span class="quotelev1">&gt; On Wed, Feb 29, 2012 at 10:04 AM, Barrett, Brian W &lt;bwbarre_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; I'm pretty sure that they are correct.  Our one-sided implementation is
</span><br>
