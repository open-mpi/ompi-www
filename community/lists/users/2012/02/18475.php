...
?>
<!-- received="Wed Feb 15 10:32:17 2012" -->
<!-- isoreceived="20120215153217" -->
<!-- sent="Wed, 15 Feb 2012 10:32:12 -0500" -->
<!-- isosent="20120215153212" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Strange OpenMPI messages" -->
<!-- id="E84D5BBD-2673-4380-B1A8-61D5EBC9C0CD_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-02-15 10:32:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18476.php">Gustavo Correa: "Re: [OMPI users] compilation error with pgcc Unknown switch"</a>
<li><strong>Previous message:</strong> <a href="18474.php">Reuti: "Re: [OMPI users] [Open MPI Announce] Open MPI v1.4.5 released"</a>
<li><strong>In reply to:</strong> <a href="18469.php">Tohiko Looka: "Re: [OMPI users] Strange OpenMPI messages"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18486.php">Tohiko Looka: "Re: [OMPI users] Strange OpenMPI messages"</a>
<li><strong>Reply:</strong> <a href="18486.php">Tohiko Looka: "Re: [OMPI users] Strange OpenMPI messages"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>You probably just want to unload those drivers, and then Open MPI should not try to use OpenFabrics.  Sometimes distros have init scripts that load the OpenFabrics drivers automatically -- Gus suggested &quot;service openibd status&quot; to see if your system has a service named &quot;openibd&quot; (although it might be a different name, depending on your distro).  If you find such a service, you might want to disable it.  
<br>
<p><p>On Feb 15, 2012, at 1:27 AM, Tohiko Looka wrote:
<br>
