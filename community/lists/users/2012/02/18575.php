...
?>
<!-- received="Tue Feb 28 05:49:38 2012" -->
<!-- isoreceived="20120228104938" -->
<!-- sent="Tue, 28 Feb 2012 05:49:33 -0500" -->
<!-- isosent="20120228104933" -->
<!-- name="Jeffrey Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Could not execute the executable &amp;quot;/home/MET/hrm/bin/hostlist&amp;quot;: Exec format error" -->
<!-- id="9016FAF0-2044-4A90-8F40-6E39996503CA_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AB8991DC-5032-4C82-B348-0248D3091A01_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-02-28 05:49:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18576.php">Muhammad Wahaj Sethi: "[OMPI users] mpirun fails with no allocated resources"</a>
<li><strong>Previous message:</strong> <a href="18574.php">Ralph Castain: "Re: [OMPI users] Could not execute the executable &quot;/home/MET/hrm/bin/hostlist&quot;: Exec format error"</a>
<li><strong>In reply to:</strong> <a href="18574.php">Ralph Castain: "Re: [OMPI users] Could not execute the executable &quot;/home/MET/hrm/bin/hostlist&quot;: Exec format error"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18585.php">Syed Ahsan Ali: "Re: [OMPI users] Could not execute the executable &quot;/home/MET/hrm/bin/hostlist&quot;: Exec format error"</a>
<li><strong>Reply:</strong> <a href="18585.php">Syed Ahsan Ali: "Re: [OMPI users] Could not execute the executable &quot;/home/MET/hrm/bin/hostlist&quot;: Exec format error"</a>
<li><strong>Reply:</strong> <a href="18592.php">Jeffrey Squyres: "Re: [OMPI users] Could not execute the executable&quot;/home/MET/hrm/bin/hostlist&quot;: Exec format error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Yes, this is known behavior for our CLI parser.  We could probably improve that a bit...
<br>
<p>On Feb 28, 2012, at 4:55 AM, Ralph Castain wrote:
<br>
...
<span class="quotelev3">&gt;&gt;&gt; Afraid I have to agree with the prior reply - sounds like NPROC isn't getting defined, which causes your cmd line to look like your original posting.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; But: is this the intended behavior of mpirun? It looks like -np is eating -hostlist as a numeric argument? Shouldn't it complain about: argument for -np missing or argument not being numeric?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Probably - I'm sure that the atol is returning zero, which should cause an error output. I'll check.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; ${MPIRUN} -np ${NPROC} -hostfile ${ABSDIR}/hostlist -mca btl sm,openib,self --mca btl_openib_use_srq 1 ./hrm &gt;&gt; ${OUTFILE}_hrm 2&gt;&amp;1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; where NPROC in defined in someother file. The same application is running on the other system with same configuration.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Tue, Feb 28, 2012 at 10:12 AM, PukkiMonkey &lt;pukkimonkey_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Feb 27, 2012, at 8:47 PM, Syed Ahsan Ali &lt;ahsanshah01_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
