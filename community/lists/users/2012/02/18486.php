...
?>
<!-- received="Wed Feb 15 12:50:58 2012" -->
<!-- isoreceived="20120215175058" -->
<!-- sent="Wed, 15 Feb 2012 20:50:54 +0300" -->
<!-- isosent="20120215175054" -->
<!-- name="Tohiko Looka" -->
<!-- email="tohiko.looka_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Strange OpenMPI messages" -->
<!-- id="CALd0-53d9wheFThJgcnfjmm3hQofPi6K6ZTcE_p84tkyHHta8g_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="E84D5BBD-2673-4380-B1A8-61D5EBC9C0CD_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-02-15 12:50:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18487.php">Tohiko Looka: "Re: [OMPI users] Strange OpenMPI messages"</a>
<li><strong>Previous message:</strong> <a href="18485.php">Tohiko Looka: "Re: [OMPI users] Different Prefix for different nodes"</a>
<li><strong>In reply to:</strong> <a href="18475.php">Jeff Squyres: "Re: [OMPI users] Strange OpenMPI messages"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18489.php">Jeff Squyres: "Re: [OMPI users] Strange OpenMPI messages"</a>
<li><strong>Reply:</strong> <a href="18489.php">Jeff Squyres: "Re: [OMPI users] Strange OpenMPI messages"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Wed, Feb 15, 2012 at 6:32 PM, Jeff Squyres &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; It is possible to have the OpenFabrics drivers loaded in your kernel, even
</span><br>
<span class="quotelev1">&gt; if you have no OpenFabrics-based devices in your hardware.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; You probably just want to unload those drivers, and then Open MPI should
</span><br>
<span class="quotelev1">&gt; not try to use OpenFabrics.  Sometimes distros have init scripts that load
</span><br>
<span class="quotelev1">&gt; the OpenFabrics drivers automatically -- Gus suggested &quot;service openibd
</span><br>
<span class="quotelev1">&gt; status&quot; to see if your system has a service named &quot;openibd&quot; (although it
</span><br>
<span class="quotelev1">&gt; might be a different name, depending on your distro).  If you find such a
</span><br>
<span class="quotelev1">&gt; service, you might want to disable it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-18486/attachment">attachment</a>
</ul>
