...
?>
<!-- received="Tue Feb 14 06:57:27 2012" -->
<!-- isoreceived="20120214115727" -->
<!-- sent="Tue, 14 Feb 2012 11:57:26 -0000" -->
<!-- isosent="20120214115726" -->
<!-- name="Richard Bardwell" -->
<!-- email="richard_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI orte_init fails on remote nodes" -->
<!-- id="ADB2FBBF80D74CBCAC0513010A526185_at_starfish" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2012-02-14 06:57:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18455.php">Richard Bardwell: "Re: [OMPI users] MPI orte_init fails on remote nodes"</a>
<li><strong>Previous message:</strong> <a href="18453.php">Jeff Squyres: "Re: [OMPI users] Strange OpenMPI messages"</a>
<li><strong>In reply to:</strong> <a href="18451.php">Jeff Squyres: "Re: [OMPI users] MPI orte_init fails on remote nodes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18455.php">Richard Bardwell: "Re: [OMPI users] MPI orte_init fails on remote nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
OK, I get it running if I specify /usr/local/bin/mpiexec instead of just mpiexec.
<br>
