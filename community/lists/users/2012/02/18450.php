...
?>
<!-- received="Tue Feb 14 05:40:50 2012" -->
<!-- isoreceived="20120214104050" -->
<!-- sent="Tue, 14 Feb 2012 10:40:49 -0000" -->
<!-- isosent="20120214104049" -->
<!-- name="Richard Bardwell" -->
<!-- email="richard_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI orte_init fails on remote nodes" -->
<!-- id="4998C16E11854748AD4F9727BA0B9D4B_at_starfish" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2012-02-14 05:40:49
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="18451.php">Jeff Squyres: "Re: [OMPI users] MPI orte_init fails on remote nodes"</a>
<li><strong>Previous message:</strong> <a href="18449.php">Tohiko Looka: "[OMPI users] Strange OpenMPI messages"</a>
<li><strong>In reply to:</strong> <a href="18445.php">Jeff Squyres: "Re: [OMPI users] MPI orte_init fails on remote nodes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="18451.php">Jeff Squyres: "Re: [OMPI users] MPI orte_init fails on remote nodes"</a>
<li><strong>Reply:</strong> <a href="18451.php">Jeff Squyres: "Re: [OMPI users] MPI orte_init fails on remote nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Jeff,
<br>
<p>I wiped out all versions of openmpi on all the nodes including the distro installed version.
<br>
...
Subject: Re: [OMPI users] MPI orte_init fails on remote nodes
<br>
<p><p><span class="quotelev1">&gt; You might want to fully uninstall the disto-installed version of Open MPI on all the nodes (e.g., Red Hat may have installed a 
</span><br>
<span class="quotelev1">&gt; different version of Open MPI, and that version is being found in your $PATH before your custom-installedversion).
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Launch the OpenMPI 1.4.4 configure script from this new work directory with the --prefix pointing to your desired installation 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; directory [e.g. /home/richard/openmpi/1.4.4/].
</span><br>
