...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19713.php">Jeff Squyres: "Re: [OMPI users] Cannot build openmpi-1.6 on"</a>
<li><strong>Previous message:</strong> <a href="19711.php">John R. Cary: "Re: [OMPI users] Cannot build openmpi-1.6 on"</a>
<li><strong>In reply to:</strong> <a href="../../2012/06/19707.php">Secretan Yves: "[OMPI users] RE : fortran program with integer kind=8 using openmpi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19719.php">Secretan Yves: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<li><strong>Reply:</strong> <a href="19719.php">Secretan Yves: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
