...
?>
<!-- received="Mon Jul  2 15:55:14 2012" -->
<!-- isoreceived="20120702195514" -->
<!-- sent="Mon, 2 Jul 2012 15:55:10 -0400" -->
<!-- isosent="20120702195510" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] fortran program with integer kind=8 using openmpi" -->
<!-- id="1615C584-9E2D-44E4-B294-B15A7DA2FF7E_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="0DA854E5D5F4C8428ABC1701AE2621CD02AFDD6A713F_at_INRSEXCH02.AD.INRS.CA" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-07-02 15:55:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19724.php">Jeff Squyres: "Re: [OMPI users] Cannot build openmpi-1.6 on"</a>
<li><strong>Previous message:</strong> <a href="19722.php">John R. Cary: "Re: [OMPI users] Cannot build openmpi-1.6 on"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/06/19718.php">Secretan Yves: "[OMPI users] RE : fortran program with integer kind=8 using openmpi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19730.php">Secretan Yves: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<li><strong>Reply:</strong> <a href="19730.php">Secretan Yves: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; With openmpi compiled with Fortran default integer*8, MPI_TYPE_2INTEGER seem to have an incorrect size. The attached Fortran program shows it,  
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; De : users-bounces_at_[hidden] [users-bounces_at_[hidden]] de la part de William Au [au_wai_chung_at_[hidden]]
</span><br>
<span class="quotelev1">&gt; Date d'envoi : 29 juin 2012 19:15
</span><br>
