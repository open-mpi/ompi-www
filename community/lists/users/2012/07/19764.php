<?
$subject_val = "Re: [OMPI users] [OMPI devel] Still bothered / cannot run an application";
...
<!-- subject="Re: [OMPI users] [OMPI devel] Still bothered / cannot run an application" -->
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] [OMPI devel] Still bothered / cannot run an application<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-07-13 19:53:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19765.php">Alexander Brock: "[OMPI users] Beginners Tutorial Link broken"</a>
<li><strong>Previous message:</strong> <a href="19763.php">Paul Kapinos: "[OMPI users] Still bothered / cannot run an application"</a>
<li><strong>In reply to:</strong> <a href="19763.php">Paul Kapinos: "[OMPI users] Still bothered / cannot run an application"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
