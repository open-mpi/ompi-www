...
?>
<!-- received="Tue Jul 24 10:58:21 2012" -->
<!-- isoreceived="20120724145821" -->
<!-- sent="Tue, 24 Jul 2012 07:58:16 -0700" -->
<!-- isosent="20120724145816" -->
<!-- name="David Warren" -->
<!-- email="warren_at_[hidden]" -->
<!-- subject="Re: [OMPI users] compiling openMPI 1.6 with Intel compilers on Ubuntu, getting error" -->
<!-- id="CAPNKQoqF4r+sucP=uj513rukdmZkO9zqubay-D-7nEQAG2XV3Q_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2012-07-24 10:58:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19814.php">Stephen J. Barr: "Re: [OMPI users] compiling openMPI 1.6 with Intel compilers on Ubuntu, getting error"</a>
<li><strong>Previous message:</strong> <a href="19812.php">Stephen J. Barr: "Re: [OMPI users] compiling openMPI 1.6 with Intel compilers on Ubuntu, getting error"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19814.php">Stephen J. Barr: "Re: [OMPI users] compiling openMPI 1.6 with Intel compilers on Ubuntu, getting error"</a>
<li><strong>Reply:</strong> <a href="19814.php">Stephen J. Barr: "Re: [OMPI users] compiling openMPI 1.6 with Intel compilers on Ubuntu, getting error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
make install
<br>
<p>Once you sudo you are starting a new shell as root, not a subshell. So,
<br>
your environment does not go with it. You need to become root, then set the
<br>
environment.
<br>
<p>On Tue, Jul 24, 2012 at 7:47 AM, Stephen J. Barr &lt;stephenjbarr_at_[hidden]&gt;wrote:
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19813/attachment">attachment</a>
</ul>
