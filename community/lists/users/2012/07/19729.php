...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Getting MPI to access processes on a 2nd computer.<br>
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19730.php">Secretan Yves: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<li><strong>Previous message:</strong> <a href="19728.php">Jeff Squyres: "[OMPI users] Fwd: EuroMPI 2012 Call for participation"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19734.php">Shiqing Fan: "Re: [OMPI users] Getting MPI to access processes on a 2nd computer."</a>
<li><strong>Reply:</strong> <a href="19734.php">Shiqing Fan: "Re: [OMPI users] Getting MPI to access processes on a 2nd computer."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19729/attachment">attachment</a>
</ul>
