...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] About the Open-MPI point-to-point messaging layers<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-07-02 17:21:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19726.php">Jeff Squyres: "Re: [OMPI users] How does OpenMPI's progress engine determine progress?"</a>
<li><strong>Previous message:</strong> <a href="19724.php">Jeff Squyres: "Re: [OMPI users] Cannot build openmpi-1.6 on"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/06/19720.php">S&#233;bastien Boisvert: "[OMPI users] About the Open-MPI point-to-point messaging layers"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
