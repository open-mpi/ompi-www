...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19732.php">William Au: "[OMPI users] fortran program with integer kind=8 using openmpi&#254;"</a>
<li><strong>Previous message:</strong> <a href="19730.php">Secretan Yves: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<li><strong>In reply to:</strong> <a href="19730.php">Secretan Yves: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19721.php">George Bosilca: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
