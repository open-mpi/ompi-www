<?
$subject_val = "[OMPI users] Still bothered / cannot run an application";
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Still bothered / cannot run an application<br>
<strong>From:</strong> Paul Kapinos (<em>kapinos_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-07-12 12:04:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19764.php">Jeff Squyres: "Re: [OMPI users] [OMPI devel] Still bothered / cannot run an application"</a>
<li><strong>Previous message:</strong> <a href="19762.php">Jonathan Dursi: "[OMPI users] Can't read more than 2^31 bytes with MPI_File_read, regardless of type?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19764.php">Jeff Squyres: "Re: [OMPI users] [OMPI devel] Still bothered / cannot run an application"</a>
<li><strong>Reply:</strong> <a href="19764.php">Jeff Squyres: "Re: [OMPI users] [OMPI devel] Still bothered / cannot run an application"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>application/pkcs7-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19763/smime.p7s">S/MIME Cryptographic Signature</a>
</ul>
