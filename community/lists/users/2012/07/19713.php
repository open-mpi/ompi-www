...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19714.php">Jeff Squyres: "Re: [OMPI users] About the Open-MPI point-to-point messaging layers"</a>
<li><strong>Previous message:</strong> <a href="19712.php">Jeff Squyres: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<li><strong>In reply to:</strong> <a href="19711.php">John R. Cary: "Re: [OMPI users] Cannot build openmpi-1.6 on"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
