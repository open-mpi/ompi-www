...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19723.php">Jeff Squyres: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<li><strong>Previous message:</strong> <a href="19721.php">George Bosilca: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/06/19717.php">Ralph Castain: "Re: [OMPI users] Cannot build openmpi-1.6 on"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19724.php">Jeff Squyres: "Re: [OMPI users] Cannot build openmpi-1.6 on"</a>
<li><strong>Reply:</strong> <a href="19724.php">Jeff Squyres: "Re: [OMPI users] Cannot build openmpi-1.6 on"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
