...
<p class="headers">
<strong>Subject:</strong> [OMPI users] make check fails with OpenMPI 1.6.3 and Intel Compilers<br>
<strong>From:</strong> J R Jones (<em>j.r.jones_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-11-01 11:56:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20611.php">Ralph Castain: "Re: [OMPI users] make check fails with OpenMPI 1.6.3 and Intel Compilers"</a>
<li><strong>Previous message:</strong> <a href="20609.php">Hodge, Gary C: "Re: [OMPI users] EXTERNAL: Re:  openmpi shared memory feature"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20611.php">Ralph Castain: "Re: [OMPI users] make check fails with OpenMPI 1.6.3 and Intel Compilers"</a>
<li><strong>Reply:</strong> <a href="20611.php">Ralph Castain: "Re: [OMPI users] make check fails with OpenMPI 1.6.3 and Intel Compilers"</a>
<li><strong>Reply:</strong> <a href="20628.php">Orion Poplawski: "Re: [OMPI users] make check fails with OpenMPI 1.6.3 and Intel Compilers"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><hr>
<ul>
<li>application/x-bzip attachment: <a href="http://www.open-mpi.org/community/lists/users/att-20610/ompi-output.tar.bz2">ompi-output.tar.bz2</a>
</ul>
