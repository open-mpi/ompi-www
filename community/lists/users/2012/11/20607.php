<?
$subject_val = "Re: [OMPI users] [OMPI devel] Multirail + Open MPI 1.6.1 = very big latency for the first communication";
...
<!-- subject="Re: [OMPI users] [OMPI devel] Multirail + Open MPI 1.6.1 = very big latency for the first communication" -->
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] [OMPI devel] Multirail + Open MPI 1.6.1 = very big latency for the first communication<br>
<strong>From:</strong> George Bosilca (<em>bosilca_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-11-01 00:35:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20608.php">Mahmood Naderan: "Re: [OMPI users] openmpi shared memory feature"</a>
<li><strong>Previous message:</strong> <a href="20606.php">Omar Andr&#233;s Zapata Mesa: "Re: [OMPI users] tester for cygwin openmpi-1.6.3 package"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/10/20603.php">Paul Kapinos: "[OMPI users] Multirail + Open MPI 1.6.1 = very big latency for the first communication"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
