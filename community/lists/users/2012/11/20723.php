...
?>
<!-- received="Thu Nov 15 12:28:17 2012" -->
<!-- isoreceived="20121115172817" -->
<!-- sent="Thu, 15 Nov 2012 17:22:40 +0000" -->
<!-- isosent="20121115172240" -->
<!-- name="Hodge, Gary C" -->
<!-- email="gary.c.hodge_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re:  gathering problem" -->
<!-- id="3258BBCAE92D924BB7419ABF3554AC041313EB_at_HVXDSP24.us.lmco.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="21641DB7-3399-4CBF-8D83-B2D4B10B41B5_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-11-15 12:22:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20724.php">John Marshall: "[OMPI users] specifying launch-agent"</a>
<li><strong>Previous message:</strong> <a href="20722.php">Number Cruncher: "[OMPI users] MPI_Alltoallv performance regression 1.6.0 to 1.6.1"</a>
<li><strong>In reply to:</strong> <a href="20707.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re:  gathering problem"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
(one connector was suspect in that it was not clicked in, the white tab was doubled over in the socket)
<br>

<br>
We are going to try to increase the number of connections between the two switches
<br>
...
<br>
On Nov 12, 2012, at 3:15 PM, &quot;Hodge, Gary C&quot; &lt;gary.c.hodge_at_[hidden]&lt;mailto:gary.c.hodge_at_[hidden]&gt;&gt; wrote:
<br>
...
<br>
In the failing test below, the sender (proc39) was on the second blade chassis and the receiver (proc28) was on the first blade chassis.
<br>
...
<br>
Each chassis has a switch to which all blades are internally connected.  The two switches are connected by 4 external cables.
<br>

<br>
Are there any tests I can run to diagnose why there are intermittent connection problems between the switches?
<br>

<br>

<br>
From: users-bounces_at_[hidden]&lt;mailto:users-bounces_at_[hidden]&gt; [mailto:users-bounces_at_[hidden]] On Behalf Of George Bosilca
<br>
...
<br>
Looking at the trace it become clear that the culprit is the receiving process and not the sending one.
<br>

<br>
Let me walk you over. I split the trace in several groups. The first one will look at the sender (proc39) and the receiver (proc28) for the first message.
<br>
...
<br>
If there is something that should be understood better is the lag on the receiver for the detection of the completion of the first operation (as highlighted by the following two lines):
<br>
...
<br>
On Nov 9, 2012, at 12:36 , &quot;Hodge, Gary C&quot; &lt;gary.c.hodge_at_[hidden]&lt;mailto:gary.c.hodge_at_[hidden]&gt;&gt; wrote:
<br>
...
<br>
I configured 1.6.2 with &#226;&#128;&#147;enable-peruse and have implemented PERUSE callbacks.
<br>
...
<br>
After the delaying MPI_Send, the page faults have increased by 1309 (132207 &#226;&#128;&#147; 130898) !!!
<br>
...
<br>
I have set mpi_leave_pinned to 1 and have increased the btl_openib_receive_queues to &#226;&#128;&#166;:S,65536,512,256,64
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-20723/attachment">attachment</a>
</ul>
