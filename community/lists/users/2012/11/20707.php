...
?>
<!-- received="Mon Nov 12 18:07:36 2012" -->
<!-- isoreceived="20121112230736" -->
<!-- sent="Mon, 12 Nov 2012 16:07:24 -0700" -->
<!-- isosent="20121112230724" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc.openmpi_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re:  gathering problem" -->
<!-- id="21641DB7-3399-4CBF-8D83-B2D4B10B41B5_at_gmail.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="3258BBCAE92D924BB7419ABF3554AC041301B0_at_HVXDSP24.us.lmco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-11-12 18:07:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20708.php">Lim Jiew Meng: "[OMPI users] Add/remove &quot;Event Listeners&quot; in MPI?"</a>
<li><strong>Previous message:</strong> <a href="20706.php">Hodge, Gary C: "Re: [OMPI users] EXTERNAL: Re:  gathering problem"</a>
<li><strong>In reply to:</strong> <a href="20706.php">Hodge, Gary C: "Re: [OMPI users] EXTERNAL: Re:  gathering problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20723.php">Hodge, Gary C: "Re: [OMPI users] EXTERNAL: Re:  gathering problem"</a>
<li><strong>Reply:</strong> <a href="20723.php">Hodge, Gary C: "Re: [OMPI users] EXTERNAL: Re:  gathering problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Try reseating connectors
<br>
<p>Sent from my iPhone
<br>
<p>On Nov 12, 2012, at 3:15 PM, &quot;Hodge, Gary C&quot; &lt;gary.c.hodge_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Today I tried a test where all sender and receiver processes were located on nodes on the same blade chassis.
</span><br>
<span class="quotelev1">&gt; With this process deployment, I did not detect any delayed send/receive processing, all tests ran as expected!!!
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; In the failing test below, the sender (proc39) was on the second blade chassis and the receiver (proc28) was on the first blade chassis.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; So I must have some problem in the Infiniband fabric?
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; Each chassis has a switch to which all blades are internally connected.  The two switches are connected by 4 external cables.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; Are there any tests I can run to diagnose why there are intermittent connection problems between the switches?
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; From: users-bounces_at_[hidden] [mailto:users-bounces_at_[hidden]] On Behalf Of George Bosilca
</span><br>
<span class="quotelev1">&gt; Sent: Friday, November 09, 2012 6:02 PM
</span><br>
<span class="quotelev1">&gt; To: Open MPI Users
</span><br>
<span class="quotelev1">&gt; Subject: EXTERNAL: Re: [OMPI users] gathering problem
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; Looking at the trace it become clear that the culprit is the receiving process and not the sending one.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; Let me walk you over. I split the trace in several groups. The first one will look at the sender (proc39) and the receiver (proc28) for the first message.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; You can see that the sender send the matching information (27178 bytes line 2). This message arrives on the receiver at line 1. There seems to be a small time drift between the two, so don't use the absolute time to compare. The first piece of data (aka 27178 bytes) is then copied on the receiver memory (line 7). As the pipeline protocol is on, the receiver ask for the second piece of data right after (line 8). The receiver will detect the completion of the last piece of data transfer at line 9, which is about 1.8 ms later.
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; On the sender side, don't take in account the completion time, it is irrelevant, as it is only the local reception (and thus barely indicate the cost of the local memcpy).
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; Now on to the second communication:
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; On Nov 9, 2012, at 12:36 , &quot;Hodge, Gary C&quot; &lt;gary.c.hodge_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Answering my own question, I have downloaded openMPI 1.6.2 and still get the delay in the MPI_Send.  Previously, I was using openMPI 1.4.1
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; I configured 1.6.2 with &#226;&#128;&#147;enable-peruse and have implemented PERUSE callbacks.
</span><br>
...
<span class="quotelev1">&gt; After the delaying MPI_Send, the page faults have increased by 1309 (132207 &#226;&#128;&#147; 130898) !!!
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; I have set mpi_leave_pinned to 1 and have increased the btl_openib_receive_queues to &#226;&#128;&#166;:S,65536,512,256,64
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-20707/attachment">attachment</a>
</ul>
