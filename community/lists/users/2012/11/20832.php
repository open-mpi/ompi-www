...
?>
<!-- received="Fri Nov 30 18:28:13 2012" -->
<!-- isoreceived="20121130232813" -->
<!-- sent="Fri, 30 Nov 2012 15:28:05 -0800" -->
<!-- isosent="20121130232805" -->
<!-- name="shiny knight" -->
<!-- email="theshinyknight_at_[hidden]" -->
<!-- subject="Re: [OMPI users] cluster with iOS or Android devices?" -->
<!-- id="6F71019D-EA51-46FE-8DA6-92CA84A35DC4_at_me.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2012-11-30 18:28:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20833.php">shiny knight: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<li><strong>Previous message:</strong> <a href="20831.php">Jeff Squyres: "Re: [OMPI users] MPI_Allreduce with F90 Handles"</a>
<li><strong>In reply to:</strong> <a href="20824.php">Ralph Castain: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/12/20839.php">Reuti: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>So I just check out the source for OMPI and build it in Xcode with target iOS? Sounds pretty straight forward. I will probably have to deal with errors but it seems that you did it already and it should not be that hard (I am still learning many things).
<br>
<p>My iPad runs 5.1 so should be fine with the multitasking side. My first objective will be to run just one process on the iPad, sent by the main computer; then it will be interesting to explore a way to let the various device to communicate.
<br>
<p>Much appreciated the help!
<br>
<p>-lou
<br>
<p><p>On Nov 30, 2012, at 7:25 AM, Ralph Castain wrote:
<br>
