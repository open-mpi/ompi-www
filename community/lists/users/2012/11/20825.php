...
?>
<!-- received="Fri Nov 30 10:35:56 2012" -->
<!-- isoreceived="20121130153556" -->
<!-- sent="Fri, 30 Nov 2012 10:35:47 -0500" -->
<!-- isosent="20121130153547" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] cluster with iOS or Android devices?" -->
<!-- id="F62B8D3E-8272-4643-A246-66AF1191E5A0_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="EECAC96F-BC9F-4BAD-A541-09D6FB83BBC7_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-11-30 10:35:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20826.php">Josh Hursey: "Re: [OMPI users] (no subject)"</a>
<li><strong>Previous message:</strong> <a href="20824.php">Ralph Castain: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<li><strong>In reply to:</strong> <a href="20824.php">Ralph Castain: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20833.php">shiny knight: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<li><strong>Reply:</strong> <a href="20833.php">shiny knight: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Not to throw cold water on this, but I think the canonical problem cited with doing distributed computations on mobile devices is the power requirement.  Meaning: if the devices are running on battery, you're really not going to get much computation out of them.  
<br>
<p>And if you have them plugged in, you have a potential IO issue (i.e., how to get the input onto the device and the output out of the device).  You probably only have 802.11g (maybe 802.11n?) wifi available, and you might have to deal with a LOT of I/O.  Meaning: you might need to restrict this work to applications that are compute-heavy but IO-light.  But then again, you're dealing with small, &quot;slow&quot; processors, so compute-heavy problems on such processors might not do so well.  Or, more precisely, you might get much more compute efficiency with traditional &quot;big&quot; HPC servers.
<br>
<p>Don't get me wrong; I'm not trying to say this is a bad idea.  I'm just saying that it's worth doing some back-of-the-envelope calculations before you spend a lot of effort on porting code to mobile platforms.
<br>
<p>For example, here's some interesting data points that would be good to calculate:
<br>
<p>1. How many (pick your favorite mobile device; say -- iPhone 5) would it take to equal the power of one cheap Intel Sandy Bridge-based server with 16 cores?  Compare things like max sustained FLOPS and IOPS (integer ops, not IO ops), RAM sizes, etc.
<br>
<p>2. What's the procurement cost differential between 1 Intel Sandy Bridge-based server and N iPhone 5s?  What's the operational cost differential?
<br>
<p><p><p>On Nov 30, 2012, at 10:25 AM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; Just an FYI: xgrid is no longer being distributed or supported.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I'd start by first building OMPI against the iOS simulator in Xcode. You may run into some issues with the atomics that will need addressing, and there may be other issues with syntax and header file locations. Best to resolve those first.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Once you get that to build, you can test running several procs on a single iPad. If you have older iPads, I'm not sure that will work as they don't multi-task. But might be worth a try.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; You'll then need to find a way to launch the processes across iPads. I don't know if ssh will work, so you may have to devise a new plm module. I can advise as you go.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; FWIW: I have an iPad 1 and iOS development kit, so I can potentially help with problems.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Nov 29, 2012, at 10:16 PM, shiny knight &lt;theshinyknight_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
