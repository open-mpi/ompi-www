...
?>
<!-- received="Fri Nov 30 01:16:52 2012" -->
<!-- isoreceived="20121130061652" -->
<!-- sent="Thu, 29 Nov 2012 22:16:42 -0800" -->
<!-- isosent="20121130061642" -->
<!-- name="shiny knight" -->
<!-- email="theshinyknight_at_[hidden]" -->
<!-- subject="Re: [OMPI users] cluster with iOS or Android devices?" -->
<!-- id="2C35C994-A424-4B00-9791-C7E680294D25_at_me.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="CCDD3A7F.B405%daniel.beatty_at_navy.mil" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-11-30 01:16:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20824.php">Ralph Castain: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<li><strong>Previous message:</strong> <a href="20822.php">Joseph Farran: "Re: [OMPI users] OpenMPI 1.6.3 and Memory Issues"</a>
<li><strong>In reply to:</strong> <a href="20820.php">Beatty, Daniel D CIV NAVAIR, 474300D: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20824.php">Ralph Castain: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<li><strong>Reply:</strong> <a href="20824.php">Ralph Castain: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/12/20839.php">Reuti: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>As now I have access to 3 iOS devices and 1 Android, so if possible I would be oriented to pursue more the iOS route.
<br>
<p>So it seems that there is not yet a simple way to do so on these devices (Thanks for the paper posted Dominik); I will have to look deeper in that project that you mentioned and wait for some official release (at least for the Android side)
<br>
<p>I may install linux distro on a virtual machine; mostly I work on OSX so it should not be that bad (OSX allows me to work with both Android and iOS hassle free; that's why I had the thought to use my devices for MPI).
<br>
<p>Beatty: My idea is to use the devices only when plugged in; I was reading a paper about how to use MPI and dynamically change the number of nodes attached, while crunching data for a process. So it would be possible to add and remove nodes on the fly, and was trying to apply it to a portable device (<a href="http://www.cs.rpi.edu/~szymansk/papers/ppam05.pdf">http://www.cs.rpi.edu/~szymansk/papers/ppam05.pdf</a>) before realizing that there is no MPI implementation for them.
<br>
<p>I would never envision a system where a user has a device in his pocket that is actually doing &quot;something&quot; behind is back...mine was a simple issue with having devices sitting on my desk, which I use to test my apps, and I could use these devices in a more productive way, while I have them tethered to my main machine (which is the main server where MPI development is done).
<br>
<p>Would you mind elaborate on the approach that you mentioned? I never used Xgrid, so I am not sure about how your solution would work.
<br>
<p>Thanks!
<br>
<p>Lou
<br>
<p><p>On Nov 29, 2012, at 4:14 PM, Beatty, Daniel D CIV NAVAIR, 474300D wrote:
<br>
