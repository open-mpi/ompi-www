...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20601.php">Ralph Castain: "Re: [OMPI users] tester for cygwin openmpi-1.6.3 package"</a>
<li><strong>Previous message:</strong> <a href="20599.php">J R Jones: "[OMPI users] make check fails with OpenMPI 1.6.3 and Intel Compilers"</a>
<li><strong>In reply to:</strong> <a href="20599.php">J R Jones: "[OMPI users] make check fails with OpenMPI 1.6.3 and Intel Compilers"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20617.php">Orion Poplawski: "Re: [OMPI users] make check fails with OpenMPI 1.6.3 and Intel Compilers"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
