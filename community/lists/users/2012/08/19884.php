...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] Mpi_leave_pinned=1 is thread safe?<br>
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19885.php">Syed Ahsan Ali: "Re: [OMPI users] UC Permission denied, please try again."</a>
<li><strong>Previous message:</strong> <a href="19883.php">Dmitry N. Mikushin: "Re: [OMPI users] bug in CUDA support for dual-processor systems?"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/07/19820.php">tmishima_at_[hidden]: "[OMPI users] Mpi_leave_pinned=1 is thread safe?"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
