...
?>
<!-- received="Tue Aug 28 17:46:46 2012" -->
<!-- isoreceived="20120828214646" -->
<!-- sent="Tue, 28 Aug 2012 14:46:38 -0700" -->
<!-- isosent="20120828214638" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration" -->
<!-- id="B4C5C2D1-3B7E-442B-B0FA-EA39598E29ED_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CANjXV6_OZfjCRrbh6KXJ0w=yvXaJK-czAj3d0Xeg=uHjzrjBqA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-08-28 17:46:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20046.php">Reuti: "Re: [OMPI users] &#232;&#189;&#172;&#229;&#143;&#145;&#239;&#188;&#154;lwkmpi"</a>
<li><strong>Previous message:</strong> <a href="20044.php">Ralph Castain: "Re: [OMPI users] MPI_Init"</a>
<li><strong>In reply to:</strong> <a href="20043.php">Brian Budge: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20047.php">Brian Budge: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<li><strong>Reply:</strong> <a href="20047.php">Brian Budge: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt;   MPI_Attr_get(MPI_COMM_WORLD, MPI_UNIVERSE_SIZE, &amp;puniverseSize, &amp;flag);
</span><br>
...
<p>The universe size is set to 1 on a singleton because the attribute gets set at the beginning of time - we haven't any way to go back and change it. The sequence of events explains why. The singleton starts up and sets its attributes, including universe_size. It also spins off an orte daemon to act as its own private &quot;mpirun&quot; in case you call comm_spawn. At this point, however, no hostfile has been read - the singleton is just an MPI proc doing its own thing, and the orte daemon is just sitting there on &quot;stand-by&quot;.
<br>
<p>When your app calls comm_spawn, then the orte daemon gets called to launch the new procs. At that time, it (not the original singleton!) reads the hostfile to find out how many nodes are around, and then does the launch.
<br>
<p>You are trying to check the number of nodes from within the singleton, which won't work - it has no way of discovering that info.
<br>
<p><p><p><p>On Aug 28, 2012, at 2:38 PM, Brian Budge &lt;brian.budge_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev2">&gt;&gt; echo hostsfile
</span><br>
