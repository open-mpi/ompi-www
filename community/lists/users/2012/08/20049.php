...
?>
<!-- received="Tue Aug 28 19:51:21 2012" -->
<!-- isoreceived="20120828235121" -->
<!-- sent="Tue, 28 Aug 2012 16:51:16 -0700" -->
<!-- isosent="20120828235116" -->
<!-- name="Brian Budge" -->
<!-- email="brian.budge_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration" -->
<!-- id="CANjXV69ZuALmzUQg89hcZtZa832mZg-r3HHdJLLLfbKBe=SRzg_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="FBC725D8-7B85-4CCE-9936-FBF5BCD7568E_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-08-28 19:51:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20050.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<li><strong>Previous message:</strong> <a href="20048.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<li><strong>In reply to:</strong> <a href="20048.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20050.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<li><strong>Reply:</strong> <a href="20050.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Here's the output:
<br>
<p>OMPI_MCA_orte_default_hostfile=/home/budgeb/p4/pseb/external/install/openmpi-1.6.1/orte/test/mpi/hostsfile
<br>
./simple_spawn
<br>
...
<br>
<p>I had to ^C to kill the hung process.
<br>
<p>When I run using mpirun:
<br>
<p>OMPI_MCA_orte_default_hostfile=/home/budgeb/p4/pseb/external/install/openmpi-1.6.1/orte/test/mpi/hostsfile
<br>
...
30764: exiting
<br>
<p>As you can see, I'm using openmpi v 1.6.1.  I just barely freshly
<br>
...
<p>&nbsp;&nbsp;Brian
<br>
<p>On Tue, Aug 28, 2012 at 4:39 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
