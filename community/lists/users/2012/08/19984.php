...
?>
<!-- received="Wed Aug 22 11:56:41 2012" -->
<!-- isoreceived="20120822155641" -->
<!-- sent="Wed, 22 Aug 2012 08:56:36 -0700" -->
<!-- isosent="20120822155636" -->
<!-- name="Brian Budge" -->
<!-- email="brian.budge_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration" -->
<!-- id="CANjXV6-5qy6gTu0Rb9kSMmim-_8keP8X5Y7i-q31ZOo+tFCMUQ_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="3C80AB26-4821-4A82-97FF-DE734CB587C3_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-08-22 11:56:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19985.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<li><strong>Previous message:</strong> <a href="19983.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<li><strong>In reply to:</strong> <a href="19983.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19985.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<li><strong>Reply:</strong> <a href="19985.php">Ralph Castain: "Re: [OMPI users] MPI::Intracomm::Spawn and cluster configuration"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
server somewhere?
<br>
<p>if my current ip is 192.168.0.1,
<br>
<p>0 &gt; echo 192.168.0.11 &gt; /tmp/hostfile
<br>
...
3 &gt; ./mySpawningExe
<br>
<p>At this point, mySpawningExe will be the master, running on
<br>
...
<p>&nbsp;&nbsp;Brian
<br>
<p>On Wed, Aug 22, 2012 at 7:15 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
