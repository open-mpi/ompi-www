...
?>
<!-- received="Wed Sep 26 08:00:27 2012" -->
<!-- isoreceived="20120926120027" -->
<!-- sent="Wed, 26 Sep 2012 13:53:36 +0200 (CEST)" -->
<!-- isosent="20120926115336" -->
<!-- name="Siegmar Gross" -->
<!-- email="Siegmar.Gross_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem with 32-bit mpiJava on openmpi-1.9a1r27361" -->
<!-- id="201209261153.q8QBraYW010734_at_tyr.informatik.hs-fulda.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-09-26 07:53:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20333.php">Siegmar Gross: "[OMPI users] problems with mpiJava in openmpi-1.9a1r27362"</a>
<li><strong>Previous message:</strong> <a href="20331.php">Siegmar Gross: "Re: [OMPI users] bindings not reported and other problems in openmpi-1.7a1r27358"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20334.php">Ralph Castain: "Re: [OMPI users] problem with 32-bit mpiJava on openmpi-1.9a1r27361"</a>
<li><strong>Reply:</strong> <a href="20334.php">Ralph Castain: "Re: [OMPI users] problem with 32-bit mpiJava on openmpi-1.9a1r27361"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>Everything works fine with openmpi-1.6.2rc5r27346.
<br>
<p>tyr mpi_classfiles 108 javac HelloMainWithoutMPI.java
<br>
...
<br>
<p><p>In my opinion it is a problem with openmpi-1.9. I used the following
<br>
...
<br>
<p>Can I provide anything to track the problem? Thank you very much for
<br>
any help in advance.
<br>
<p><p>Kind regards
...
<p>Siegmar
<br>
<p><p><p><span class="quotelev4">&gt; &gt;&gt;&gt; I tried mpiJava on a 32-bit installation of openmpi-1.9a1r27361.
</span><br>
...
<span class="quotelev1">&gt; I see the problem - our heterogeneous support could use some improvement, but 
</span><br>
it'll be awhile before I can get to it.
<br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; What's happening is that we are picking up and propagating the prefix you 
</span><br>
...
<span class="quotelev1">&gt; Also, you'll need to add --enable-heterogeneous to your configure so the MPI 
</span><br>
