...
?>
<!-- received="Tue Sep 25 05:08:09 2012" -->
<!-- isoreceived="20120925090809" -->
<!-- sent="Tue, 25 Sep 2012 17:08:01 +0800 (CST)" -->
<!-- isosent="20120925090801" -->
<!-- name="Richard " -->
<!-- email="codemonkee_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpi job is blocked" -->
<!-- id="234411af.3ffb.139fcaedd0d.Coremail.codemonkee_at_163.com" -->
<!-- charset="GBK" -->
<!-- inreplyto="2d84e776.3e55.139fca1ddf2.Coremail.codemonkee_at_163.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-09-25 05:08:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20297.php">Jeff Squyres: "Re: [OMPI users] mpi job is blocked"</a>
<li><strong>Previous message:</strong> <a href="20295.php">Richard : "Re: [OMPI users] mpi job is blocked"</a>
<li><strong>In reply to:</strong> <a href="20295.php">Richard : "Re: [OMPI users] mpi job is blocked"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20297.php">Jeff Squyres: "Re: [OMPI users] mpi job is blocked"</a>
<li><strong>Reply:</strong> <a href="20297.php">Jeff Squyres: "Re: [OMPI users] mpi job is blocked"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><p><p>[[53402,1],6][btl_tcp_endpoint.c:638:mca_btl_tcp_endpoint_complete_connect] connect() to 192.168.122.1 failed: Connection refused (111
<br>
<p><p><p><p><p><p>At 2012-09-25 16:53:50,Richard &lt;codemonkee_at_[hidden]&gt; wrote:
<br>
<p><p>if I tried the ring program, the first round of pass is fine, but the second round is blocked at some node.
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-20296/attachment">attachment</a>
</ul>
