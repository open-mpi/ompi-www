...
?>
<!-- received="Sat Sep 15 20:22:31 2012" -->
<!-- isoreceived="20120916002231" -->
<!-- sent="Sat, 15 Sep 2012 17:22:23 -0700" -->
<!-- isosent="20120916002223" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Newbie question?" -->
<!-- id="C9B93B2B-A239-416B-9439-0C09464988CE_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CABftzegbEt=o_xQe6L_9_Z35RLwo5qw6Ag98MekX1Pyz2LpUXg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-09-15 20:22:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20226.php">John Chludzinski: "Re: [OMPI users] Newbie question?"</a>
<li><strong>Previous message:</strong> <a href="20224.php">John Chludzinski: "Re: [OMPI users] Newbie question?"</a>
<li><strong>In reply to:</strong> <a href="20224.php">John Chludzinski: "Re: [OMPI users] Newbie question?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20226.php">John Chludzinski: "Re: [OMPI users] Newbie question?"</a>
<li><strong>Reply:</strong> <a href="20226.php">John Chludzinski: "Re: [OMPI users] Newbie question?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Sep 15, 2012, at 12:44 PM, John Chludzinski &lt;john.chludzinski_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; There was a bug in the code.  So now I get this, which is correct but how do I get rid of all these ABI, CMA, etc. messages?
</span><br>
...
<span class="quotelev1">&gt; [[6110,1],1]: A high-performance Open MPI point-to-point messaging module
</span><br>
...
<span class="quotelev1">&gt; [elzbieta:02559] 3 more processes have sent help message help-mpi-btl-base.txt / btl:no-nics
</span><br>
<span class="quotelev1">&gt; [elzbieta:02559] Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to see all help / error messages
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Sat, Sep 15, 2012 at 3:34 PM, John Chludzinski &lt;john.chludzinski_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; On Sat, Sep 15, 2012 at 3:02 PM, John Chludzinski &lt;john.chludzinski_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; Ah - note that there is no LD_LIBRARY_PATH in the environment. That's the problem
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Sep 15, 2012, at 11:19 AM, John Chludzinski &lt;john.chludzinski_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; 1. verify that you executed the &quot;mpiexec&quot; you think you did - a simple &quot;which mpiexec&quot; should suffice
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 2. verify that your environment is correct by &quot;mpiexec -n 1 printenv | grep PATH&quot;. Sometimes the ld_library_path doesn't carry over like you think it should
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Sep 15, 2012, at 10:00 AM, John Chludzinski &lt;john.chludzinski_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I installed OpenMPI (I have a simple dual core AMD notebook with Fedora 16) via:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; ./a.out: error while loading shared libraries: libmpi_f90.so.1: cannot open shared object file: No such file or directory
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ./a.out: error while loading shared libraries: libmpi_f90.so.1: cannot open shared object file: No such file or directory
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ./a.out: error while loading shared libraries: libmpi_f90.so.1: cannot open shared object file: No such file or directory
...
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      25 Sep 15 12:25 libmca_common_sm.so -&gt; libmca_common_sm.so.2.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      25 Sep 14 16:14 libmca_common_sm.so.2 -&gt; libmca_common_sm.so.2.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -rwxr-xr-x. 1 root root    8492 Jan 20  2012 libmca_common_sm.so.2.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      19 Sep 15 12:25 libmpi_cxx.so -&gt; libmpi_cxx.so.1.0.1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      19 Sep 14 16:14 libmpi_cxx.so.1 -&gt; libmpi_cxx.so.1.0.1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -rwxr-xr-x. 1 root root   87604 Jan 20  2012 libmpi_cxx.so.1.0.1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      19 Sep 15 12:25 libmpi_f77.so -&gt; libmpi_f77.so.1.0.2
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      19 Sep 14 16:14 libmpi_f77.so.1 -&gt; libmpi_f77.so.1.0.2
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -rwxr-xr-x. 1 root root  179912 Jan 20  2012 libmpi_f77.so.1.0.2
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      19 Sep 15 12:25 libmpi_f90.so -&gt; libmpi_f90.so.1.1.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      19 Sep 14 16:14 libmpi_f90.so.1 -&gt; libmpi_f90.so.1.1.0
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      15 Sep 14 16:14 libmpi.so.1 -&gt; libmpi.so.1.0.2
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -rwxr-xr-x. 1 root root 1383444 Jan 20  2012 libmpi.so.1.0.2
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      21 Sep 15 12:25 libompitrace.so -&gt; libompitrace.so.0.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      21 Sep 14 16:14 libompitrace.so.0 -&gt; libompitrace.so.0.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -rwxr-xr-x. 1 root root   13572 Jan 20  2012 libompitrace.so.0.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      20 Sep 15 12:25 libopen-pal.so -&gt; libopen-pal.so.3.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      20 Sep 14 16:14 libopen-pal.so.3 -&gt; libopen-pal.so.3.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -rwxr-xr-x. 1 root root  386324 Jan 20  2012 libopen-pal.so.3.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      20 Sep 15 12:25 libopen-rte.so -&gt; libopen-rte.so.3.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      20 Sep 14 16:14 libopen-rte.so.3 -&gt; libopen-rte.so.3.0.0
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      15 Sep 14 16:14 libotf.so.0 -&gt; libotf.so.0.0.1
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      18 Sep 15 12:25 libvt-hyb.so -&gt; libvt-hyb.so.0.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      18 Sep 14 16:14 libvt-hyb.so.0 -&gt; libvt-hyb.so.0.0.0
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      18 Sep 15 12:25 libvt-mpi.so -&gt; libvt-mpi.so.0.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      18 Sep 14 16:14 libvt-mpi.so.0 -&gt; libvt-mpi.so.0.0.0
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      17 Sep 15 12:25 libvt-mt.so -&gt; libvt-mt.so.0.0.0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lrwxrwxrwx. 1 root root      17 Sep 14 16:14 libvt-mt.so.0 -&gt; libvt-mt.so.0.0.0
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; The file (actually, a link) it claims it can't find: libmpi_f90.so.1, is clearly there. And LD_LIBRARY_PATH=/usr/lib/openmpi/lib/.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-20225/attachment">attachment</a>
</ul>
