...
?>
<!-- received="Wed Sep  5 09:16:55 2012" -->
<!-- isoreceived="20120905131655" -->
<!-- sent="Wed, 5 Sep 2012 06:16:48 -0700" -->
<!-- isosent="20120905131648" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem with rankfile" -->
<!-- id="50917CFE-B084-455B-8CCB-81E0A904F76C_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="201209051250.q85CoGba020881_at_tyr.informatik.hs-fulda.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-09-05 09:16:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20130.php">Paul Kapinos: "Re: [OMPI users] OMPI 1.6.x Hang on khugepaged 100% CPU time"</a>
<li><strong>Previous message:</strong> <a href="20128.php">Siegmar Gross: "Re: [OMPI users] problem with rankfile"</a>
<li><strong>In reply to:</strong> <a href="20128.php">Siegmar Gross: "Re: [OMPI users] problem with rankfile"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20152.php">Siegmar Gross: "Re: [OMPI users] problem with rankfile"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Set aside the rankfile for the moment and try to just bind to cores on that machine, something like:
<br>
<p>mpiexec --report-bindings -bind-to-core -host rs0.informatik.hs-fulda.de -n 2 rank_size
<br>
<p>If that doesn't work, then the problem isn't with rankfile
<br>
<p><p>On Sep 5, 2012, at 5:50 AM, Siegmar Gross &lt;Siegmar.Gross_at_[hidden]&gt; wrote:
<br>
