...
?>
<!-- received="Mon Sep 10 11:37:28 2012" -->
<!-- isoreceived="20120910153728" -->
<!-- sent="Mon, 10 Sep 2012 08:37:20 -0700" -->
<!-- isosent="20120910153720" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] segmentation fault with openmpi-1.6.2" -->
<!-- id="44E9DF5C-D6B3-447D-BCE5-DA43386409E9_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-09-10 11:37:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20174.php">Eugene Loh: "Re: [OMPI users] segmentation fault with openmpi-1.6.2"</a>
<li><strong>Previous message:</strong> <a href="20172.php">Aleksey Senin: "Re: [OMPI users] segmentation fault with openmpi-1.6.2"</a>
<li><strong>In reply to:</strong> <a href="20172.php">Aleksey Senin: "Re: [OMPI users] segmentation fault with openmpi-1.6.2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20174.php">Eugene Loh: "Re: [OMPI users] segmentation fault with openmpi-1.6.2"</a>
<li><strong>Reply:</strong> <a href="20174.php">Eugene Loh: "Re: [OMPI users] segmentation fault with openmpi-1.6.2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Really? That shouldn't happen - I'll take a look at that one.
<br>
<p><span class="quotelev1">&gt; By the way, is there any way to disable SLURM usage even OMPI was compiled with it? If yes, what is the option?
</span><br>
<p>Do you mean &quot;ignore the allocation&quot;? Or do you mean &quot;launch the job without using slurm&quot;? The latter is simple - just &quot;-mca plm rsh&quot; will do the trick.
<br>
