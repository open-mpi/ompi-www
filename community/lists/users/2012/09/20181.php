...
?>
<!-- received="Mon Sep 10 14:53:59 2012" -->
<!-- isoreceived="20120910185359" -->
<!-- sent="Mon, 10 Sep 2012 11:53:49 -0700" -->
<!-- isosent="20120910185349" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem with rankfile" -->
<!-- id="A3C3A6EF-D6C9-44DC-9561-56730BC14903_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-09-10 14:53:49
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20182.php">Jeff Squyres: "Re: [OMPI users] gcc problem compiling openmpi-1.6.1 on Solaris 10 sparc"</a>
<li><strong>Previous message:</strong> <a href="20180.php">Brice Goglin: "Re: [OMPI users] [omx-devel]  Open-mx issue with ompi 1.6.1"</a>
<li><strong>In reply to:</strong> <a href="20170.php">Siegmar Gross: "Re: [OMPI users] problem with rankfile"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20184.php">Jeff Squyres: "Re: [OMPI users] problem with rankfile"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I ask because I'd like to better understand if the problem is in the actual binding mechanism (i.e., hwloc), or in the code that computes where to bind the process (i.e., in orte). The trunk uses a completely different method for doing the latter, so if the trunk works, then we can probably rule out hwloc as the culprit here.
<br>
<p><p>On Sep 10, 2012, at 4:34 AM, Siegmar Gross &lt;Siegmar.Gross_at_[hidden]&gt; wrote:
<br>
