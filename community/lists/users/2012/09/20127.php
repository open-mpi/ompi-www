...
?>
<!-- received="Wed Sep  5 07:52:33 2012" -->
<!-- isoreceived="20120905115233" -->
<!-- sent="Wed, 05 Sep 2012 14:52:14 +0300" -->
<!-- isosent="20120905115214" -->
<!-- name="Yevgeny Kliteynik" -->
<!-- email="kliteyn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI 1.6.x Hang on khugepaged 100% CPU time" -->
<!-- id="50473CEE.1090306_at_dev.mellanox.co.il" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CADEJBEVwU=n9OmU5i4YY=UfcNiGyc_jN_MvWm-8E-LKYC4E0UA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-09-05 07:52:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20128.php">Siegmar Gross: "Re: [OMPI users] problem with rankfile"</a>
<li><strong>Previous message:</strong> <a href="20126.php">Reuti: "Re: [OMPI users] OpenMPI-1.6.1: Warning - registering physical memry for mpi jobs"</a>
<li><strong>In reply to:</strong> <a href="20121.php">Yong Qin: "Re: [OMPI users] OMPI 1.6.x Hang on khugepaged 100% CPU time"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20130.php">Paul Kapinos: "Re: [OMPI users] OMPI 1.6.x Hang on khugepaged 100% CPU time"</a>
<li><strong>Reply:</strong> <a href="20130.php">Paul Kapinos: "Re: [OMPI users] OMPI 1.6.x Hang on khugepaged 100% CPU time"</a>
<li><strong>Reply:</strong> <a href="20132.php">Yong Qin: "Re: [OMPI users] OMPI 1.6.x Hang on khugepaged 100% CPU time"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Interesting. Indeed, THP is on be default in RHEL 6.x.
<br>
I run OMPI 1.6.x constantly on RHEL 6.2, and I've never seen this problem.
<br>
<p>I'm checking it with OFED folks, but I doubt that there are some dedicated
<br>
tests for THP.
<br>
<p>So do you see it only with a specific application and only on a specific
<br>
