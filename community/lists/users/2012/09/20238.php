...
?>
<!-- received="Mon Sep 17 20:14:27 2012" -->
<!-- isoreceived="20120918001427" -->
<!-- sent="Mon, 17 Sep 2012 17:14:18 -0700" -->
<!-- isosent="20120918001418" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] segmentation fault / bus error in openmpi-1.9a1r27342 (Solaris, Oracle C)" -->
<!-- id="54E270D3-C630-44AA-BB68-8A77EF2C4C9C_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="201209171135.q8HBYxpf010979_at_tyr.informatik.hs-fulda.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-09-17 20:14:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20239.php">Alidoust: "[OMPI users] trouble_MPI"</a>
<li><strong>Previous message:</strong> <a href="20237.php">Douglas Eadline: "Re: [OMPI users] [omx-devel] Open-mx issue with ompi 1.6.1"</a>
<li><strong>In reply to:</strong> <a href="20235.php">Siegmar Gross: "[OMPI users] segmentation fault / bus error in openmpi-1.9a1r27342 (Solaris, Oracle C)"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Is everything running solely on one node (rs0), or is this running on multiple nodes? I ask because in prior communications you indicated that your nodes weren't all the same. So if you are running across multiple nodes, you must add &quot;--hetero-nodes&quot; to your cmd line so we know that the topology on each node may be different.
<br>
<p>Meantime, I'll take a look at your use-cases tomorrow. Could well be that something is wrong, though they look pretty basic (and so the problem may again lie with how hwloc behaves on your setup).
<br>
<p><p>On Sep 17, 2012, at 4:34 AM, Siegmar Gross &lt;Siegmar.Gross_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Hi,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I have installed openmpi-1.9a1r27342 on Solaris 10 with Oracle
</span><br>
