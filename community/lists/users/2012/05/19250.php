...
?>
<!-- received="Thu May 10 13:37:32 2012" -->
<!-- isoreceived="20120510173732" -->
<!-- sent="Thu, 10 May 2012 18:37:27 +0100 (WEST)" -->
<!-- isosent="20120510173727" -->
<!-- name="Ricardo Reis" -->
<!-- email="rreis_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI-IO puzzlement" -->
<!-- id="alpine.DEB.2.00.1205101831210.12062_at_serodio" -->
<!-- charset="ISO-8859-15" -->
<!-- inreplyto="4FABFA39.4090202_at_cs.uh.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-05-10 13:37:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19251.php">Edgar Gabriel: "Re: [OMPI users] MPI-IO puzzlement"</a>
<li><strong>Previous message:</strong> <a href="19249.php">Edgar Gabriel: "Re: [OMPI users] MPI-IO puzzlement"</a>
<li><strong>In reply to:</strong> <a href="19249.php">Edgar Gabriel: "Re: [OMPI users] MPI-IO puzzlement"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19251.php">Edgar Gabriel: "Re: [OMPI users] MPI-IO puzzlement"</a>
<li><strong>Reply:</strong> <a href="19251.php">Edgar Gabriel: "Re: [OMPI users] MPI-IO puzzlement"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Edgar
<br>
<p><p>world, I only use one comm on this code.
<br>
<p>world = MPI_COMM_WORLD
<br>
<p><p><p><p>&nbsp;&nbsp;&nbsp;&nbsp;CALL MPI_file_open(world, TRIM(flname), &amp;
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;amode, MPI_INFO_NULL, fh, ierr)
<br>
<p><p>I have run this code in other machines, with other configs and got no 
<br>
