...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19155.php">Shanthini Kannan: "[OMPI users] MPI with RDMA CM"</a>
<li><strong>Previous message:</strong> <a href="19153.php">Rohan Deshpande: "[OMPI users] Segmentation fault on master task"</a>
<li><strong>Maybe in reply to:</strong> <a href="19153.php">Rohan Deshpande: "[OMPI users] Segmentation fault on master task"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19159.php">Rohan Deshpande: "Re: [OMPI users] Segmentation fault on master task"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
