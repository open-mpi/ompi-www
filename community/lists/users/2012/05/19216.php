<?
$subject_val = "[OMPI users] GPU and CPU timing - OpenMPI and Thrust";
include("../../include/msg-header.inc");
?>
<!-- received="Mon May  7 21:38:25 2012" -->
<!-- isoreceived="20120508013825" -->
<!-- sent="Tue, 8 May 2012 09:38:20 +0800" -->
<!-- isosent="20120508013820" -->
<!-- name="Rohan Deshpande" -->
<!-- email="rohand87_at_[hidden]" -->
<!-- subject="[OMPI users] GPU and CPU timing - OpenMPI and Thrust" -->
<!-- id="CAFAE9jiYGGGaq742BKF62umwM_6jTCsTuRRnr5d6UJJkSurg=A_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] GPU and CPU timing - OpenMPI and Thrust<br>
<strong>From:</strong> Rohan Deshpande (<em>rohand87_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-05-07 21:38:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19217.php">TERRY DONTJE: "Re: [OMPI users] Regarding the execution time calculation"</a>
<li><strong>Previous message:</strong> <a href="19215.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem in installation"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19222.php">Rolf vandeVaart: "Re: [OMPI users] GPU and CPU timing - OpenMPI and Thrust"</a>
<li><strong>Reply:</strong> <a href="19222.php">Rolf vandeVaart: "Re: [OMPI users] GPU and CPU timing - OpenMPI and Thrust"</a>
<li><strong>Maybe reply:</strong> <a href="19234.php">Eduardo Morras: "Re: [OMPI users] GPU and CPU timing - OpenMPI and Thrust"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>}
<br>
<p>All the tasks just initialize their own array and then calculate the sum
<br>
using cuda thrust.
<br>
My CUDA Thrust code -
...
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;printf(&quot; Task %d on has sum (on GPU): %ld Time for the kernel: %f
<br>
...
&nbsp;&nbsp;return cpu_sum;
<br>
<p>Now when I run the job on cluster with 10 MPI tasks and compare the timings
<br>
...
<br>
<p>Just wondering what might be the cause of this or are these results
<br>
correct? Anything wrong with MPI code?
<br>
<p>My cluster has 3 machines. 4 MPI tasks run on 2 machine and 2 Tasks run on
<br>
1 machine.
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19216/attachment">attachment</a>
</ul>
