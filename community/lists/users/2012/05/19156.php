...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19157.php">Jeff Squyres: "Re: [OMPI users] MPI with RDMA CM"</a>
<li><strong>Previous message:</strong> <a href="19155.php">Shanthini Kannan: "[OMPI users] MPI with RDMA CM"</a>
<li><strong>In reply to:</strong> <a href="../../2012/04/19139.php">Ralph Castain: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19158.php">Ralph Castain: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<li><strong>Reply:</strong> <a href="19158.php">Ralph Castain: "Re: [OMPI users] Error with multiple MPI runs inside one Slurm allocation (with QLogic PSM)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><p><hr>
<ul>
<li>application/x-gzip attachment: <a href="../../att-19156/ompi_info_1.7a1r26338_error_binding.txt.gz">ompi_info_1.7a1r26338_error_binding.txt.gz</a>
</ul>
<!-- attachment="ompi_info_1.7a1r26338_error_binding.txt.gz" -->
<hr>
<ul>
<li>application/x-gzip attachment: <a href="../../att-19156/ompi_info_1.7a1r26338_psm_undefined_symbol.txt.gz">ompi_info_1.7a1r26338_psm_undefined_symbol.txt.gz</a>
</ul>
