...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19164.php">Rohan Deshpande: "[OMPI users] Segmentation fault on master task"</a>
<li><strong>Previous message:</strong> <a href="19162.php">Trent: "Re: [OMPI users] OpenMPI and CUDA on cluster"</a>
<li><strong>In reply to:</strong> <a href="19162.php">Trent: "Re: [OMPI users] OpenMPI and CUDA on cluster"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19174.php">Shamis, Pavel: "Re: [OMPI users] OpenMPI and CUDA on cluster"</a>
<li><strong>Reply:</strong> <a href="19174.php">Shamis, Pavel: "Re: [OMPI users] OpenMPI and CUDA on cluster"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19163/attachment">attachment</a>
</ul>
