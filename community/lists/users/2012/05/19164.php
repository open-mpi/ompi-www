...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Segmentation fault on master task<br>
<strong>From:</strong> Rohan Deshpande (<em>rohand87_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-05-02 02:51:58
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19165.php">Eduardo Morras: "Re: [OMPI users] Segmentation fault on master task"</a>
<li><strong>Previous message:</strong> <a href="19163.php">Rohan Deshpande: "Re: [OMPI users] OpenMPI and CUDA on cluster"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19165.php">Eduardo Morras: "Re: [OMPI users] Segmentation fault on master task"</a>
<li><strong>Maybe reply:</strong> <a href="19165.php">Eduardo Morras: "Re: [OMPI users] Segmentation fault on master task"</a>
<li><strong>Maybe reply:</strong> <a href="19170.php">Rohan Deshpande: "Re: [OMPI users] Segmentation fault on master task"</a>
<li><strong>Maybe reply:</strong> <a href="19173.php">Eduardo Morras: "Re: [OMPI users] Segmentation fault on master task"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19164/attachment">attachment</a>
</ul>
