...
?>
<!-- received="Fri Dec 21 10:54:30 2012" -->
<!-- isoreceived="20121221155430" -->
<!-- sent="Fri, 21 Dec 2012 07:54:23 -0800" -->
<!-- isosent="20121221155423" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] broadcasting basic data items in Java" -->
<!-- id="F65286C3-5AAE-43FC-8646-CBED35AC6322_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="201212211532.qBLFWN1g009395_at_tyr.informatik.hs-fulda.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-12-21 10:54:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21034.php">Jeff Squyres: "[OMPI users] Open MPI planned outage"</a>
<li><strong>Previous message:</strong> <a href="21032.php">Siegmar Gross: "Re: [OMPI users] broadcasting basic data items in Java"</a>
<li><strong>In reply to:</strong> <a href="21032.php">Siegmar Gross: "Re: [OMPI users] broadcasting basic data items in Java"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21035.php">Siegmar Gross: "Re: [OMPI users] broadcasting basic data items in Java"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Is it possible that the program was compiled against a different (perhaps incompatible) version of Java?
<br>
<p>Just shooting in the dark here - I suspect you'll have to ask someone more knowledgeable on JVMs.
<br>
<p><p>On Dec 21, 2012, at 7:32 AM, Siegmar Gross &lt;Siegmar.Gross_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev3">&gt;&gt;&gt; [(null):10586] Local abort before MPI_INIT completed successfully; not able 
</span><br>
