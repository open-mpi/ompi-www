...
?>
<!-- received="Mon Dec 17 12:09:23 2012" -->
<!-- isoreceived="20121217170923" -->
<!-- sent="Mon, 17 Dec 2012 09:09:16 -0800" -->
<!-- isosent="20121217170916" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpi problems/many cpus per node" -->
<!-- id="3B2D6C4F-F635-441E-8F72-EB9259FFB841_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="50CF4EC4.3050204_at_igb.uiuc.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-12-17 12:09:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20976.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>Previous message:</strong> <a href="20974.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>In reply to:</strong> <a href="20974.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20976.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>Reply:</strong> <a href="20976.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Looking at the ssh line, we are going to attempt to send a message from tnode 2-0 to node 2-1 on the 10.1.255.226 address. Is that going to work? Anything preventing it?
<br>
<p><p>On Dec 17, 2012, at 8:56 AM, Daniel Davidson &lt;danield_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; These nodes have not been locked down yet so that jobs cannot be launched from the backend, at least on purpose anyway.  The added logging returns the information below:
</span><br>
