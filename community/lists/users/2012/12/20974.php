...
?>
<!-- received="Mon Dec 17 11:56:55 2012" -->
<!-- isoreceived="20121217165655" -->
<!-- sent="Mon, 17 Dec 2012 10:56:36 -0600" -->
<!-- isosent="20121217165636" -->
<!-- name="Daniel Davidson" -->
<!-- email="danield_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpi problems/many cpus per node" -->
<!-- id="50CF4EC4.3050204_at_igb.uiuc.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="9CB363F3-91B7-4DE2-A760-02FD9C25D764_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-12-17 11:56:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20975.php">Ralph Castain: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>Previous message:</strong> <a href="20973.php">Ralph Castain: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>In reply to:</strong> <a href="20973.php">Ralph Castain: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20975.php">Ralph Castain: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>Reply:</strong> <a href="20975.php">Ralph Castain: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
ess env -mca orte_ess_jobid 2119499776 -mca orte_ess_vpid &lt;template&gt; 
<br>
...
<br>
<p><p><p><p>On 12/17/2012 10:37 AM, Ralph Castain wrote:
<br>
