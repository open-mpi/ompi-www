...
?>
<!-- received="Sat Dec 15 00:47:07 2012" -->
<!-- isoreceived="20121215054707" -->
<!-- sent="Fri, 14 Dec 2012 21:46:59 -0800" -->
<!-- isosent="20121215054659" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpi problems/many cpus per node" -->
<!-- id="985F0086-C7AE-4B16-B254-AB2037412CA4_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="50CBAD0B.2090300_at_igb.uiuc.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-12-15 00:46:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20961.php">Siegmar Gross: "Re: [OMPI users] questions to some open problems"</a>
<li><strong>Previous message:</strong> <a href="20959.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>In reply to:</strong> <a href="20959.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20969.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>Reply:</strong> <a href="20969.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
It must be making contact or ORTE wouldn't be attempting to launch your application's procs. Looks more like it never received the launch command. Looking at the code, I suspect you're getting caught in a race condition that causes the message to get &quot;stuck&quot;.
<br>
<p>Just to see if that's the case, you might try running this with the 1.7 release candidate, or even the developer's nightly build. Both use a different timing mechanism intended to resolve such situations.
<br>
<p><p>On Dec 14, 2012, at 2:49 PM, Daniel Davidson &lt;danield_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Thank you for the help so far.  Here is the information that the debugging gives me.  Looks like the daemon on on the non-local node never makes contact.  If I step NP back two though, it does.
</span><br>
