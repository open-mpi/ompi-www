...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20828.php">Reuti: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<li><strong>Previous message:</strong> <a href="20826.php">Leta Melkamu: "[OMPI users] running &quot;openmpi&quot; with &quot;knem&quot;"</a>
<li><strong>In reply to:</strong> <a href="20825.php">Jaroslaw Slawinski: "[OMPI users] vtrun/otf question"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20845.php">pascal.deveze_at_[hidden]: "Re: [OMPI users] Lustre hints via environment variables/runtime	parameters"</a>
<li><strong>Reply:</strong> <a href="20845.php">pascal.deveze_at_[hidden]: "Re: [OMPI users] Lustre hints via environment variables/runtime	parameters"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
