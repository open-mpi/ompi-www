...
?>
<!-- received="Mon Dec 17 11:10:54 2012" -->
<!-- isoreceived="20121217161054" -->
<!-- sent="Mon, 17 Dec 2012 08:10:45 -0800" -->
<!-- isosent="20121217161045" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re: Problems with shared libraries while launching jobs" -->
<!-- id="A6AF7BEA-64C1-419E-96D0-09CD7D7D28F6_at_open-mpi.org" -->
...
<strong>Date:</strong> 2012-12-17 11:10:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20972.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>Previous message:</strong> <a href="20970.php">Blosch, Edwin L: "Re: [OMPI users] EXTERNAL: Re: Problems with shared libraries while launching jobs"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20984.php">Reuti: "Re: [OMPI users] EXTERNAL: Re: Problems with shared libraries while launching jobs"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
On Dec 17, 2012, at 7:42 AM, &quot;Blosch, Edwin L&quot; &lt;edwin.l.blosch_at_[hidden]&gt; wrote:
<br>
...
<p>Sorry - I forgot that you built from a tarball, and so the debug is &quot;off&quot; by default. You need to reconfigure with --enable-debug to get debug output.
<br>
...
<p>No, it isn't mpirun as the error message specifically says it is &quot;orted&quot; that is failing to resolve the library. Try running with the debug enabled and the same command line and let's see what the actual ssh command looks like - my guess is that the path to that intel library is missing.
<br>
<p><span class="quotelev1">&gt;  
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-20971/attachment">attachment</a>
</ul>
