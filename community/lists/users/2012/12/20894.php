...
?>
<!-- received="Thu Dec  6 16:19:38 2012" -->
<!-- isoreceived="20121206211938" -->
<!-- sent="Thu, 6 Dec 2012 21:19:27 +0000" -->
<!-- isosent="20121206211927" -->
<!-- name="Paul Hatton" -->
<!-- email="p.s.hatton_at_[hidden]" -->
<!-- subject="Re: [OMPI users] error configuring OpenMPI 1.6.3 with gcc 4.7.2" -->
<!-- id="F0658F4E7C8A084AB7E7895A257838CC5AB7C01AEA_at_ADMMBX5.adf.bham.ac.uk" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2012-12-06 16:19:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20895.php">Paul Hatton: "Re: [OMPI users] error configuring OpenMPI 1.6.3 with gcc 4.7.2"</a>
<li><strong>Previous message:</strong> <a href="20893.php">Paul Hatton: "Re: [OMPI users] error configuring OpenMPI 1.6.3 with gcc 4.7.2"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20895.php">Paul Hatton: "Re: [OMPI users] error configuring OpenMPI 1.6.3 with gcc 4.7.2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Oh, sorry - I tried a build with the system gcc and it worked. I'll repeat the failed one and get it to you. Sorry about that.
<br>
<p><pre>
-- 
Paul Hatton
