...
?>
<!-- received="Mon Dec 17 17:13:04 2012" -->
<!-- isoreceived="20121217221304" -->
<!-- sent="Mon, 17 Dec 2012 16:12:41 -0600" -->
<!-- isosent="20121217221241" -->
<!-- name="Daniel Davidson" -->
<!-- email="danield_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpi problems/many cpus per node" -->
<!-- id="50CF98D9.5080806_at_igb.uiuc.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="0FF8CBBE-DB25-4DA4-8129-47557DFBCA5A_at_centurylink.net" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-12-17 17:12:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20981.php">Jeff Squyres: "Re: [OMPI users] [Open MPI] #3351: JAVA scatter error"</a>
<li><strong>Previous message:</strong> <a href="20979.php">Jeff Squyres: "Re: [OMPI users] [Open MPI] #3351: JAVA scatter error"</a>
<li><strong>In reply to:</strong> <a href="20978.php">Doug Reeder: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21016.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<li><strong>Reply:</strong> <a href="21016.php">Daniel Davidson: "Re: [OMPI users] mpi problems/many cpus per node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Dan
<br>
<p>[root_at_compute-2-1 ~]# ssh compute-2-0
<br>
...
[root_at_compute-2-1 ~]#
<br>
<p><p><p>On 12/17/2012 03:39 PM, Doug Reeder wrote:
<br>
<span class="quotelev1">&gt; Daniel,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Does passwordless ssh work. You need to make sure that it is.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Doug
</span><br>
<span class="quotelev1">&gt; On Dec 17, 2012, at 2:24 PM, Daniel Davidson wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I would also add that scp seems to be creating the file in the /tmp directory of compute-2-0, and that /var/log secure is showing ssh connections being accepted.  Is there anything in ssh that can limit connections that I need to look out for?  My guess is that it is part of the client prefs and not the server prefs since I can initiate the mpi command from another machine and it works fine, even when it uses compute-2-0 and 1.
</span><br>
...
<span class="quotelev2">&gt;&gt; [root_at_compute-2-1 /]# date
</span><br>
<span class="quotelev2">&gt;&gt; Mon Dec 17 15:11:50 CST 2012
</span><br>
...
<span class="quotelev2">&gt;&gt; [compute-2-1.local:70237] mca:base:select:(  plm) Querying component [rsh]
</span><br>
<span class="quotelev2">&gt;&gt; [compute-2-1.local:70237] [[INVALID],INVALID] plm:rsh_lookup on agent ssh : rsh path NULL
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; [root_at_compute-2-0 tmp]# ls -ltr
</span><br>
<span class="quotelev2">&gt;&gt; total 24
</span><br>
<span class="quotelev2">&gt;&gt; -rw-------.  1 root    root       0 Nov 28 08:42 yum.log
</span><br>
<span class="quotelev2">&gt;&gt; -rw-------.  1 root    root    5962 Nov 29 10:50 yum_save_tx-2012-11-29-10-50SRba9s.yumtx
</span><br>
<span class="quotelev2">&gt;&gt; drwx------.  3 danield danield 4096 Dec 12 14:56 openmpi-sessions-danield_at_compute-2-0_0
</span><br>
<span class="quotelev2">&gt;&gt; drwx------.  3 root    root    4096 Dec 13 15:38 openmpi-sessions-root_at_compute-2-0_0
</span><br>
<span class="quotelev2">&gt;&gt; drwx------  18 danield danield 4096 Dec 14 09:48 openmpi-sessions-danield_at_compute-2-0.local_0
</span><br>
<span class="quotelev2">&gt;&gt; drwx------  44 root    root    4096 Dec 17 15:14 openmpi-sessions-root_at_compute-2-0.local_0
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; [root_at_compute-2-0 tmp]# tail -10 /var/log/secure
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:13:40 compute-2-0 sshd[24834]: Accepted publickey for root from 10.1.255.226 port 49483 ssh2
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:13:40 compute-2-0 sshd[24834]: pam_unix(sshd:session): session opened for user root by (uid=0)
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:13:42 compute-2-0 sshd[24834]: Received disconnect from 10.1.255.226: 11: disconnected by user
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:13:42 compute-2-0 sshd[24834]: pam_unix(sshd:session): session closed for user root
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:13:50 compute-2-0 sshd[24851]: Accepted publickey for root from 10.1.255.226 port 49484 ssh2
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:13:50 compute-2-0 sshd[24851]: pam_unix(sshd:session): session opened for user root by (uid=0)
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:13:55 compute-2-0 sshd[24851]: Received disconnect from 10.1.255.226: 11: disconnected by user
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:13:55 compute-2-0 sshd[24851]: pam_unix(sshd:session): session closed for user root
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:14:01 compute-2-0 sshd[24868]: Accepted publickey for root from 10.1.255.226 port 49485 ssh2
</span><br>
<span class="quotelev2">&gt;&gt; Dec 17 15:14:01 compute-2-0 sshd[24868]: pam_unix(sshd:session): session opened for user root by (uid=0)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; On 12/17/2012 11:16 AM, Daniel Davidson wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; A very long time (15 mintues or so) I finally received the following in addition to what I just sent earlier:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [compute-2-0.local:24659] [[32341,0],1] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [compute-2-0.local:24659] [[32341,0],1] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [compute-2-0.local:24659] [[32341,0],1] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] daemon 1 failed with status 1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:base:orted_cmd sending orted_exit commands
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Firewalls are down:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [root_at_compute-2-1 /]# iptables -L
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [root_at_compute-2-0 ~]# iptables -L
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Chain INPUT (policy ACCEPT)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; target     prot opt source               destination
...
<span class="quotelev3">&gt;&gt;&gt; On 12/17/2012 11:09 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hmmm...and that is ALL the output? If so, then it never succeeded in sending a message back, which leads one to suspect some kind of firewall in the way.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Looking at the ssh line, we are going to attempt to send a message from tnode 2-0 to node 2-1 on the 10.1.255.226 address. Is that going to work? Anything preventing it?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Dec 17, 2012, at 8:56 AM, Daniel Davidson &lt;danield_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; These nodes have not been locked down yet so that jobs cannot be launched from the backend, at least on purpose anyway.  The added logging returns the information below:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:(  plm) Querying component [rsh]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[INVALID],INVALID] plm:rsh_lookup on agent ssh : rsh path NULL
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:(  plm) Query of component [rsh] set priority to 10
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:(  plm) Querying component [slurm]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:(  plm) Skipping component [slurm]. Query failed to return a module
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:(  plm) Querying component [tm]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:(  plm) Skipping component [tm]. Query failed to return a module
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:(  plm) Selected component [rsh]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] plm:base:set_hnp_name: initial bias 69655 nodename hash 3634869988
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] plm:base:set_hnp_name: final jobfam 32341
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh_setup on agent ssh : rsh path NULL
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:base:receive start comm
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:( odls) Querying component [default]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:( odls) Query of component [default] set priority to 1
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] mca:base:select:( odls) Selected component [default]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:base:setup_job
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:base:setup_vm
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:base:setup_vm creating map
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] setup:vm: working unmanaged allocation
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] using dash_host
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] checking node compute-2-0
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] adding compute-2-0 to list
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] checking node compute-2-1.local
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:base:setup_vm add new daemon [[32341,0],1]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:base:setup_vm assigning new daemon [[32341,0],1] to node compute-2-0
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh: launching vm
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh: local shell: 0 (bash)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh: assuming same remote shell as local shell
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh: remote shell: 0 (bash)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh: final template argv:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         /usr/bin/ssh &lt;template&gt; PATH=/home/apps/openmpi-1.7rc5/bin:$PATH ; export PATH ; LD_LIBRARY_PATH=/home/apps/openmpi-1.7rc5/lib:$LD_LIBRARY_PATH ; export LD_LIBRARY_PATH ; DYLD_LIBRARY_PATH=/home/apps/openmpi-1.7rc5/lib:$DYLD_LIBRARY_PATH ; export DYLD_LIBRARY_PATH ; /home/apps/openmpi-1.7rc5/bin/orted -mca ess env -mca orte_ess_jobid 2119499776 -mca orte_ess_vpid &lt;template&gt; -mca orte_ess_num_procs 2 -mca orte_hnp_uri &quot;2119499776.0;tcp://10.1.255.226:46314;tcp://172.16.28.94:46314&quot; -mca orte_use_common_port 0 --tree-spawn -mca oob tcp -mca odls_base_verbose 5 -mca plm_base_verbose 5 -mca plm rsh -mca orte_leave_session_attached 1
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh:launch daemon 0 not a child of mine
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh: adding node compute-2-0 to launch list
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh: activating launch event
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh: recording launch of daemon [[32341,0],1]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69655] [[32341,0],0] plm:rsh: executing: (//usr/bin/ssh) [/usr/bin/ssh compute-2-0 PATH=/home/apps/openmpi-1.7rc5/bin:$PATH ; export PATH ; LD_LIBRARY_PATH=/home/apps/openmpi-1.7rc5/lib:$LD_LIBRARY_PATH ; export LD_LIBRARY_PATH ; DYLD_LIBRARY_PATH=/home/apps/openmpi-1.7rc5/lib:$DYLD_LIBRARY_PATH ; export DYLD_LIBRARY_PATH ; /home/apps/openmpi-1.7rc5/bin/orted -mca ess env -mca orte_ess_jobid 2119499776 -mca orte_ess_vpid 1 -mca orte_ess_num_procs 2 -mca orte_hnp_uri &quot;2119499776.0;tcp://10.1.255.226:46314;tcp://172.16.28.94:46314&quot; -mca orte_use_common_port 0 --tree-spawn -mca oob tcp -mca odls_base_verbose 5 -mca plm_base_verbose 5 -mca plm rsh -mca orte_leave_session_attached 1]
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24659] mca:base:select:(  plm) Querying component [rsh]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24659] [[32341,0],1] plm:rsh_lookup on agent ssh : rsh path NULL
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24659] mca:base:select:(  plm) Query of component [rsh] set priority to 10
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24659] mca:base:select:(  plm) Selected component [rsh]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24659] mca:base:select:( odls) Querying component [default]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24659] mca:base:select:( odls) Query of component [default] set priority to 1
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24659] mca:base:select:( odls) Selected component [default]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24659] [[32341,0],1] plm:rsh_setup on agent ssh : rsh path NULL
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24659] [[32341,0],1] plm:base:receive start comm
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On 12/17/2012 10:37 AM, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ?? That was all the output? If so, then something is indeed quite wrong as it didn't even attempt to launch the job.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Try adding -mca plm_base_verbose 5 to the cmd line.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I was assuming you were using ssh as the launcher, but I wonder if you are in some managed environment? If so, then it could be that launch from a backend node isn't allowed (e.g., on gridengine).
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Dec 17, 2012, at 8:28 AM, Daniel Davidson &lt;danield_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; This looks to be having issues as well, and I cannot get any number of processors to give me a different result with the new version.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [root_at_compute-2-1 /]# /home/apps/openmpi-1.7rc5/bin/mpirun -host compute-2-0,compute-2-1 -v  -np 50 --leave-session-attached -mca odls_base_verbose 5 hostname
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69417] mca:base:select:( odls) Querying component [default]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69417] mca:base:select:( odls) Query of component [default] set priority to 1
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69417] mca:base:select:( odls) Selected component [default]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24486] mca:base:select:( odls) Querying component [default]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24486] mca:base:select:( odls) Query of component [default] set priority to 1
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24486] mca:base:select:( odls) Selected component [default]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24486] [[24939,0],1] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24486] [[24939,0],1] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-0.local:24486] [[24939,0],1] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69417] [[24939,0],0] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [compute-2-1.local:69417] [[24939,0],0] odls:kill_local_proc working on WILDCARD
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; However from the head node:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [root_at_biocluster openmpi-1.7rc5]# /home/apps/openmpi-1.7rc5/bin/mpirun -host compute-2-0,compute-2-1 -v  -np 50  hostname
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Displays 25 hostnames from each system.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Thank you again for the help so far,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; On 12/17/2012 08:31 AM, Daniel Davidson wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I will give this a try, but wouldn't that be an issue as well if the process was run on the head node or another node?  So long as the mpi job is not started on either of these two nodes, it works fine.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On 12/14/2012 11:46 PM, Ralph Castain wrote:
</span><br>
