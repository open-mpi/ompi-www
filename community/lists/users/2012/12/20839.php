...
?>
<!-- received="Sat Dec  1 16:37:31 2012" -->
<!-- isoreceived="20121201213731" -->
<!-- sent="Sat, 1 Dec 2012 22:37:20 +0100" -->
<!-- isosent="20121201213720" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] cluster with iOS or Android devices?" -->
<!-- id="82805A49-DCD3-48C9-AB28-8C8185630EC1_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-12-01 16:37:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20840.php">Brice Goglin: "Re: [OMPI users] running &quot;openmpi&quot; with &quot;knem&quot;"</a>
<li><strong>Previous message:</strong> <a href="20838.php">Eric Chamberland: "[OMPI users] Lustre hints via environment variables/runtime parameters"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/11/20823.php">shiny knight: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20841.php">shiny knight: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<li><strong>Reply:</strong> <a href="20841.php">shiny knight: "Re: [OMPI users] cluster with iOS or Android devices?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>NB: AFAICS this paper refers to the IOS from Cisco, not iOS from Apple.
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; I would never envision a system where a user has a device in his pocket that is actually doing &quot;something&quot; behind is back...mine was a simple issue with having devices sitting on my desk, which I use to test my apps, and I could use these devices in a more productive way, while I have them tethered to my main machine (which is the main server where MPI development is done).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
