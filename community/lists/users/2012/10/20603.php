<?
$subject_val = "[OMPI users] Multirail + Open MPI 1.6.1 = very big latency for the first communication";
...
<!-- subject="[OMPI users] Multirail + Open MPI 1.6.1 = very big latency for the first communication" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Multirail + Open MPI 1.6.1 = very big latency for the first communication<br>
<strong>From:</strong> Paul Kapinos (<em>kapinos_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-10-31 15:36:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20604.php">marco atzeri: "[OMPI users] tester for cygwin  openmpi-1.6.3 package"</a>
<li><strong>Previous message:</strong> <a href="20602.php">Jeff Squyres: "Re: [OMPI users] Java bindings failed to load required libraries"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/11/20607.php">George Bosilca: "Re: [OMPI users] [OMPI devel] Multirail + Open MPI 1.6.1 = very big latency for the first communication"</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/11/20607.php">George Bosilca: "Re: [OMPI users] [OMPI devel] Multirail + Open MPI 1.6.1 = very big latency for the first communication"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>application/pkcs7-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-20603/smime.p7s">S/MIME Cryptographic Signature</a>
</ul>
