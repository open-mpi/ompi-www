...
?>
<!-- received="Fri Oct 26 08:20:22 2012" -->
<!-- isoreceived="20121026122022" -->
<!-- sent="Fri, 26 Oct 2012 05:20:14 -0700" -->
<!-- isosent="20121026122014" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ompi-clean on single executable" -->
<!-- id="AADFC734-B9F3-4D3B-8E60-7920BAEF54AF_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CABvLwVD6DaO92xtYnDXFowbskL-eWBwUx8nF2prcoFeVmb-=BA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-10-26 08:20:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20549.php">Jeff Squyres: "Re: [OMPI users] running openmpi in debug/verbose mode"</a>
<li><strong>Previous message:</strong> <a href="20547.php">tmishima_at_[hidden]: "Re: [OMPI users] System CPU of openmpi-1.7rc1"</a>
<li><strong>In reply to:</strong> <a href="20546.php">Nicolas Deladerriere: "Re: [OMPI users] ompi-clean on single executable"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
On Oct 26, 2012, at 4:14 AM, Nicolas Deladerriere &lt;nicolas.deladerriere_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Thanks all for your comments
</span><br>
...
<span class="quotelev1">&gt; What I was initially looking at is a tool (or option of orte-clean) that clean up the mess you are talking about, but only the mess that have been created by a single mpirun command. As far I have understood, orte-clean clean all mess on a node associated to all open-mpi process that have run (or are currently running).
</span><br>
<p>That is correct. We could fairly easily modify it to cleanup leftover files from a single mpirun without affecting others. Unfortunately, there really isn't any easy way to tell what processes belong to a specific mpirun, so selectively killing zombies would be very hard to do
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; According to Rolph comment, usually, mpirun command does not leave any zombie processes, Hence it seems that the effect of orte-clean is limited. But, since it exists, I was wondering that it is doing usefull stuff ?
</span><br>
<p>It was created during the early years of our work when zombies were frequently occurring. The need for it has declined over the years, but we keep it around because we do still hit problems on occasion - especially during development.
<br>
<p><span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; 2012/10/25 Ralph Castain &lt;rhc_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; Okay, now I'm confused. If all you want to do is cleanly &quot;kill&quot; a running OMPI job, then why not just issue
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; This will cause mpirun to order the clean termination of all remote procs within that execution, and then cleanly terminate itself. No tool we create could do it any better.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; orte-clean was intended to cleanup the mess if/when the above method doesn't work - i.e., when you have to &quot;kill SIGKILL mpirun&quot;, which forcibly kills mpirun but might leave zombie orteds on the remote nodes.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt; &gt; Or perhaps cloned, renamed to orte-kill, and modified to kill a single (or multiple) specific job(s).  That would be POSIX-like (&quot;kill&quot; vs. &quot;clean&quot;).
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-20548/attachment">attachment</a>
</ul>
