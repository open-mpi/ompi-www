...
?>
<!-- received="Tue Oct  9 10:32:05 2012" -->
<!-- isoreceived="20121009143205" -->
<!-- sent="Tue, 9 Oct 2012 07:39:38 -0700" -->
<!-- isosent="20121009143938" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc.openmpi_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re: unacceptable latency in gathering process" -->
<!-- id="ED26B3DF-A1ED-4BD6-B81C-D3F8C0A1720D_at_gmail.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="CANjXV6-O8heiefCKOqAbKg6e-gyNWxL3udzJ4wc-4jaVdQaJYQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-10-09 10:39:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20433.php">Hodge, Gary C: "Re: [OMPI users] EXTERNAL: Re: unacceptable latency in gathering	process"</a>
<li><strong>Previous message:</strong> <a href="20431.php">Jeff Squyres: "Re: [OMPI users] PAPI errors when compiling OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="20430.php">Brian Budge: "Re: [OMPI users] EXTERNAL: Re: unacceptable latency in gathering process"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20433.php">Hodge, Gary C: "Re: [OMPI users] EXTERNAL: Re: unacceptable latency in gathering	process"</a>
<li><strong>Reply:</strong> <a href="20433.php">Hodge, Gary C: "Re: [OMPI users] EXTERNAL: Re: unacceptable latency in gathering	process"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
If you ask for thread multiple, I believe we return thread funneled or thread serial. You can check, though - I might be remembering wrong, but I'm pretty sure that's true
<br>
<p>Sent from my iPad
<br>
