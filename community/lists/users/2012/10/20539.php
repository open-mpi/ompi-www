...
?>
<!-- received="Thu Oct 25 16:46:32 2012" -->
<!-- isoreceived="20121025204632" -->
<!-- sent="Thu, 25 Oct 2012 22:45:08 +0200 (CEST)" -->
<!-- isosent="20121025204508" -->
<!-- name="Georg Ruzicka" -->
<!-- email="82ruge1bif_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Java bindings failed to load required libraries" -->
<!-- id="a8509b59-db7f-4a22-93f8-888fd84610f0_at_hft-stuttgart.de" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2012-10-25 16:45:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20540.php">Jeff Squyres: "Re: [OMPI users] Java bindings failed to load required libraries"</a>
<li><strong>Previous message:</strong> <a href="20538.php">Georg Ruzicka: "Re: [OMPI users] Java bindings failed to load required libraries"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20540.php">Jeff Squyres: "Re: [OMPI users] Java bindings failed to load required libraries"</a>
<li><strong>Reply:</strong> <a href="20540.php">Jeff Squyres: "Re: [OMPI users] Java bindings failed to load required libraries"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I try it with the newer version...
<br>
