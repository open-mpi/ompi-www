...
?>
<!-- received="Wed Oct  3 08:54:35 2012" -->
<!-- isoreceived="20121003125435" -->
<!-- sent="Wed, 3 Oct 2012 05:54:23 -0700" -->
<!-- isosent="20121003125423" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem with rankfile and openmpi-1.6.2" -->
<!-- id="C02B1D2D-49B7-4F1B-A508-749DEDAB3E19_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2012-10-03 08:54:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="20391.php">Ralph Castain: "Re: [OMPI users] question to binding options in openmpi-1.6.2"</a>
<li><strong>Previous message:</strong> <a href="20389.php">Syed Ahsan Ali: "Re: [OMPI users] Need solution- nodes can't find the paths."</a>
<li><strong>In reply to:</strong> <a href="20386.php">Siegmar Gross: "[OMPI users] problem with rankfile and openmpi-1.6.2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="20396.php">Ralph Castain: "Re: [OMPI users] problem with rankfile and openmpi-1.6.2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Your rankfile looks fine, so undoubtedly a bug has crept into this rarely-used code path.
<br>
