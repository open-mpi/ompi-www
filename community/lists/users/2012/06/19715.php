...
?>
<!-- received="Fri Jun 29 19:15:16 2012" -->
<!-- isoreceived="20120629231516" -->
<!-- sent="Fri, 29 Jun 2012 16:15:11 -0700" -->
<!-- isosent="20120629231511" -->
<!-- name="William Au" -->
<!-- email="au_wai_chung_at_[hidden]" -->
<!-- subject="Re: [OMPI users] fortran program with integer kind=8 using openmpi" -->
<!-- id="SNT134-W2128036BE2177EAE672F5BD3E50_at_phx.gbl" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="[OMPI users] fortran program with integer kind=8 using openmpi" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-29 19:15:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19716.php">John R. Cary: "[OMPI users] Cannot build openmpi-1.6 on"</a>
<li><strong>Previous message:</strong> <a href="19714.php">Jeff Squyres: "Re: [OMPI users] Myricom MX2G Segmentation fault on OMPI 1.6"</a>
<li><strong>Maybe in reply to:</strong> <a href="19698.php">William Au: "[OMPI users] fortran program with integer kind=8 using openmpi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19718.php">Secretan Yves: "[OMPI users] RE : fortran program with integer kind=8 using openmpi"</a>
<li><strong>Reply:</strong> <a href="19718.php">Secretan Yves: "[OMPI users] RE : fortran program with integer kind=8 using openmpi"</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/07/19721.php">George Bosilca: "Re: [OMPI users] fortran program with integer kind=8 using openmpi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
&nbsp;
<br>
<span class="quotelev1">&gt; You should not have to recompile openmpi, but you do have to use the correct type. You can check the size of integers in your fortrana nd use MPI_INTEGER4 or MPI_INTEGER8 depending on what you get.
</span><br>
&nbsp;
<br>
...
&nbsp;
<br>
<span class="quotelev1">&gt; in gfortran use
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19715/attachment">attachment</a>
</ul>
