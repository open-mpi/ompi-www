...
?>
<!-- received="Thu Jun 14 10:19:18 2012" -->
<!-- isoreceived="20120614141918" -->
<!-- sent="Thu, 14 Jun 2012 10:19:13 -0400" -->
<!-- isosent="20120614141913" -->
<!-- name="VimalMathew_at_[hidden]" -->
<!-- email="VimalMathew_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building MPI on Windows" -->
<!-- id="DE2CB86A93428A408B1E6BE8E73DCCB4018B069C_at_CLEOHSMB13.napa.ad.etn.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="DE2CB86A93428A408B1E6BE8E73DCCB4018B066C_at_CLEOHSMB13.napa.ad.etn.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-14 10:19:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19562.php">Damien: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Previous message:</strong> <a href="19560.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>In reply to:</strong> <a href="19560.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19562.php">Damien: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Reply:</strong> <a href="19562.php">Damien: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Selected the wrong version of VS.
<br>
<p>&nbsp;
<br>
<p><pre>
...
1)  Download this:  <a href="http://www.open-mpi.org/software/ompi/v1.6/downloads/openmpi-1.6.tar.gz">http://www.open-mpi.org/software/ompi/v1.6/downloads/openmpi-1.6.tar.gz</a> &lt;<a href="http://www.open-mpi.org/software/ompi/v1.6/downloads/openmpi-1.6.tar.gz">http://www.open-mpi.org/software/ompi/v1.6/downloads/openmpi-1.6.tar.gz</a>&gt; 
Done
...
Does it matter where I run CMake from? I&#226;&#128;&#153;ve put Cmake-2.8.8-win32-x86 in C:\OMPI\openmpi-1.6
...
I have &#226;&#128;&#156;C:/Program Files (x86)/Microsoft Visual Studio 9.0/VC/bin/cl.exe&#226;&#128;&#157;
...
I get an error message saying: Error in configuration process. Project files may be invalid
I&#226;&#128;&#153;ve attached the text that the CMake GUI generated for the error.
--
Vimal
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19561/attachment">attachment</a>
</ul>
