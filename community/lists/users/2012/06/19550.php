...
?>
<!-- received="Wed Jun 13 16:40:26 2012" -->
<!-- isoreceived="20120613204026" -->
<!-- sent="Wed, 13 Jun 2012 15:40:26 -0500" -->
<!-- isosent="20120613204026" -->
<!-- name="Trent Creekmore" -->
<!-- email="tcreek_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building MPI on Windows" -->
<!-- id="033801cd49a4$c4010dc0$4c032940$_at_gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="DE2CB86A93428A408B1E6BE8E73DCCB4018B02B0_at_CLEOHSMB13.napa.ad.etn.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-13 16:40:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19551.php">Jeff Squyres: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Previous message:</strong> <a href="19549.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>In reply to:</strong> <a href="19549.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19551.php">Jeff Squyres: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Reply:</strong> <a href="19551.php">Jeff Squyres: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Reply:</strong> <a href="19557.php">Shiqing Fan: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I would say work with Linux and using the guide I did, to at least get you started on doing some work instead of wasting a lot of time working on that. 
<br>
<p>If you want it to function with Windows that badly just keep working on it in spare time. Meanwhile get to coding now using the method I told you. 
<br>
<p>&nbsp;
<br>
<p>&nbsp;
...
But you won&#226;&#128;&#153;t need to Bin files, 
...
I tried compiling simple &#226;&#128;&#152;Hello World&#226;&#128;&#153;&#226;&#128;&#153; code and I get an error message saying &#226;&#128;&#152;Cannot open &lt;mpi.h&gt;: No such file or directory.
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19550/attachment">attachment</a>
</ul>
