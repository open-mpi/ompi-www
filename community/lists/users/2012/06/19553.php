...
?>
<!-- received="Wed Jun 13 17:38:35 2012" -->
<!-- isoreceived="20120613213835" -->
<!-- sent="Wed, 13 Jun 2012 15:38:12 -0600" -->
<!-- isosent="20120613213812" -->
<!-- name="Damien" -->
<!-- email="damien_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building MPI on Windows" -->
<!-- id="4FD90844.1000204_at_khubla.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2012-06-13 17:38:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19554.php">Shiqing Fan: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Previous message:</strong> <a href="19552.php">Damien: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>In reply to:</strong> <a href="19542.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19560.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Reply:</strong> <a href="19560.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Vimal,
<br>
<p>Here's how to build OpenMPI with Visual Studio and CMake.  These are 
<br>
exact steps.
<br>
<p>1)  Download this:  
...
<br>
<p>3)  Start the CMake GUI.  Set the source and build directories.  Mine 
<br>
were C:/projects6/openmpi-1.6-64 and C:/projects6/openmpi-1.6-64/build
<br>
<p>4)  Press Configure.  Say Yes if it asks you to create the build directory.
<br>
...
<br>
<p>First things first.  If you want a Release build, you have to change a 
<br>
...
<br>
<p>Also, further down the red window there's some options you should 
<br>
...
<br>
<p>9)  Moment of Truth.  Right-click on &quot;Solution 'OpenMPI'&quot; and select 
<br>
...
<p>11)  Wait some more.
<br>
<p>12)  Grab a snack (or a beer.....), this will take a while, 15-20 minutes.
<br>
<p>13)  If the build was successful (it should be), there's one last step.  
<br>
...
<br>
<p>If you'd like to try this and provide feedback, we can tweak the 
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19553/attachment">attachment</a>
</ul>
