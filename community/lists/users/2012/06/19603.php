...
?>
<!-- received="Mon Jun 18 05:37:14 2012" -->
<!-- isoreceived="20120618093714" -->
<!-- sent="Mon, 18 Jun 2012 11:37:08 +0200 (CEST)" -->
<!-- isosent="20120618093708" -->
<!-- name="Xuan Wang" -->
<!-- email="xuan.wang_at_[hidden]" -->
<!-- subject="Re: [OMPI users] An idea about a semi-automatic	optimized	parallel	I/O with Open MPI" -->
<!-- id="30344150.46566.1340012227961.JavaMail.root_at_epsilon" -->
<!-- charset="utf-8" -->
<!-- inreplyto="28A9880D-14D4-4DAF-9F45-A1B8A55D4F44_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-18 05:37:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19604.php">TERRY DONTJE: "Re: [OMPI users] MPI_Comm_spawn and exit of parent process."</a>
<li><strong>Previous message:</strong> <a href="19602.php">Jaison Paul Mulerikkal: "[OMPI users] Naming MPI_Spawn children"</a>
<li><strong>In reply to:</strong> <a href="19587.php">Jeff Squyres: "Re: [OMPI users] An idea about a semi-automatic optimized	parallel	I/O with Open MPI"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Hi Jeff,
<br>
<p>Thank you very much for your suggestions. They help us a lot. We will reconsider the whole model more in details.
<br>
<p>I am thinking of separating the whole process into two different kinds of processes. One is the system process and the other is MPI process, which is invoked (how to invoke is also a key issue here) by the system process.
<br>
<p>I will reconstruct/redesign it and then post it for discussion.
<br>
...
<a href="http://www.hlrs.de">http://www.hlrs.de</a>
</pre>
<!-- body="end" -->
<hr>
<ul class="links">
