...
?>
<!-- received="Thu Jun 14 10:09:40 2012" -->
<!-- isoreceived="20120614140940" -->
<!-- sent="Thu, 14 Jun 2012 10:09:35 -0400" -->
<!-- isosent="20120614140935" -->
<!-- name="VimalMathew_at_[hidden]" -->
<!-- email="VimalMathew_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building MPI on Windows" -->
<!-- id="DE2CB86A93428A408B1E6BE8E73DCCB4018B066C_at_CLEOHSMB13.napa.ad.etn.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="4FD90844.1000204_at_khubla.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-14 10:09:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19561.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Previous message:</strong> <a href="19559.php">Ifeanyi: "[OMPI users] checkpointing"</a>
<li><strong>In reply to:</strong> <a href="19553.php">Damien: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19561.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Reply:</strong> <a href="19561.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>&nbsp;
<br>
<p>Thanks for the detailed instructions!
<br>
<p>Here's my progress:
<br>
<p>&nbsp;
<br>
<p>1)  Download this:  
<br>
<a href="http://www.open-mpi.org/software/ompi/v1.6/downloads/openmpi-1.6.tar.gz">http://www.open-mpi.org/software/ompi/v1.6/downloads/openmpi-1.6.tar.gz</a>
<br>
&lt;<a href="http://www.open-mpi.org/software/ompi/v1.6/downloads/openmpi-1.6.tar.gz">http://www.open-mpi.org/software/ompi/v1.6/downloads/openmpi-1.6.tar.gz</a>
<br>
...
<p>Done
<br>
<p>2)  Extract that to somewhere on your hard drive.  My path was
<br>
C:\projects6\openmpi-1.6.  I renamed it to C:\projects6\openmpi-1.6-64.
<br>
You can use 7-Zip to extract tgz archives on Windows.
<br>
<p>Extracted to C:\OMPI\openmpi-1.6
<br>
<p><p>3)  Start the CMake GUI.  Set the source and build directories.  Mine
<br>
were C:/projects6/openmpi-1.6-64 and C:/projects6/openmpi-1.6-64/build
<br>
<p>Does it matter where I run CMake from? I've put Cmake-2.8.8-win32-x86 in
<br>
C:\OMPI\openmpi-1.6
<br>
<p>4)  Press Configure.  Say Yes if it asks you to create the build
<br>
directory.
<br>
<p>Done
<br>
<p>5)  Look at the generator view that comes up.  I chose Visual Studio 9
<br>
...
compilers.
<br>
<p>I chose Visual Studio 9 2008 Win64.
<br>
<p>In the C and C++ compiler, I put &quot;C:\Program Files (x86)\Microsoft
<br>
Visual Studio 9.0\VC\bin\amd64\cl.exe&quot;.  You can navigate to which one
<br>
you have.
<br>
<p>I have &quot;C:/Program Files (x86)/Microsoft Visual Studio
<br>
9.0/VC/bin/cl.exe&quot;
<br>
<p>In the Fortran compiler, I put &quot;C:/Program Files (x86)/Intel/Composer XE
<br>
2011 SP1/bin/intel64/ifort.exe&quot;.  You can navigate to which one you
<br>
have.
<br>
<p>I do not have a Fortran compiler
<br>
<p>Press Finish once you have selected the compilers and the config will
<br>
start.  Takes a couple of minutes on my laptop.
<br>
<p>I get an error message saying: Error in configuration process. Project
<br>
files may be invalid
<br>
<p>I've attached the text that the CMake GUI generated for the error.
<br>
<p><p><pre>
--
Vimal
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19560/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19560/Error_text.txt">Error text.txt</a>
</ul>
