...
?>
<!-- received="Thu Jun  7 06:44:03 2012" -->
<!-- isoreceived="20120607104403" -->
<!-- sent="Thu, 07 Jun 2012 17:43:54 +0700" -->
<!-- isosent="20120607104354" -->
<!-- name="Duke" -->
<!-- email="duke.lists_at_[hidden]" -->
<!-- subject="Re: [OMPI users] testing for openMPI" -->
<!-- id="4FD085EA.9030403_at_gmx.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="4D641CE8-AE54-4B49-B7AA-3432DB6F2C86_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-07 06:43:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19475.php">TERRY DONTJE: "Re: [OMPI users] testing for openMPI"</a>
<li><strong>Previous message:</strong> <a href="19473.php">Duke: "Re: [OMPI users] testing for openMPI"</a>
<li><strong>In reply to:</strong> <a href="19472.php">Jeff Squyres: "Re: [OMPI users] testing for openMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19476.php">Jeff Squyres: "Re: [OMPI users] testing for openMPI"</a>
<li><strong>Reply:</strong> <a href="19476.php">Jeff Squyres: "Re: [OMPI users] testing for openMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; Check to ensure that you have firewalls disabled between your two machines; that's a common cause of hanging (i.e., Open MPI is trying to open connections and/or send data between your two nodes, and the packets are getting black-holed at the other side).
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Open MPI needs to be able to communicate on random TCP ports between all machines that will be used in MPI jobs.
</span><br>
<p>Thanks!!! After switching iptables off on all the machines, I got it 
<br>
working:
<br>
<p>[mpiuser_at_fantomfs40a ~]$ mpirun -np 8 --machinefile 
<br>
...
<br>
<p>Thanks so much for all the answers/suggestions. I am excited now :).
<br>
<p>D.
<br>
...
<span class="quotelev1">&gt; On Jun 7, 2012, at 3:06 AM, Duke wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Somehow the verbose flag (-v) did not work for me. I tried --debug-daemon and got:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; [mpiuser_at_fantomfs40a ~]$ mpirun --debug-daemons -np 3 --machinefile /home/mpiuser/.mpi_hostfile ./test/mpihello
</span><br>
...
<span class="quotelev2">&gt;&gt; Somehow the program got stuck when checking on hosts. The secure log on hp430a showed that mpiuser logged in just fine:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; tail /var/log/secure
</span><br>
<span class="quotelev2">&gt;&gt; Jun  7 17:07:31 hp430a sshd[3007]: Accepted publickey for mpiuser from 192.168.0.101 port 34037 ssh2
</span><br>
<span class="quotelev2">&gt;&gt; Jun  7 17:07:31 hp430a sshd[3007]: pam_unix(sshd:session): session opened for user mpiuser by (uid=0)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; The way openmpi schedules by default is to fill all the slots in a host, before moving on to next host.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Thanks for quick answer. I checked the FAQ, and tried with processes more than 2, but somehow it got stalled:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [mpiuser_at_fantomfs40a ~]$ mpirun -v -np 4 --machinefile /home/mpiuser/.mpi_hostfile ./test/mpihello
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [mpiuser_at_fantomfs40a ~]$ mpirun -v -np 4 --host hp430a,hp430b ./test/mpihello
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; My configuration must be wrong somewhere. Anyidea how I can check the system?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [mpiuser_at_fantomfs40a ~]$ mpirun -np 2 --machinefile /home/mpiuser/.mpi_hostfile ./test/mpihello
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Unfortunately the result did not show what I wanted. I expected to see somethign like:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
