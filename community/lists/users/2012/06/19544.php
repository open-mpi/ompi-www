...
?>
<!-- received="Wed Jun 13 15:46:06 2012" -->
<!-- isoreceived="20120613194606" -->
<!-- sent="Wed, 13 Jun 2012 14:46:08 -0500" -->
<!-- isosent="20120613194608" -->
<!-- name="Trent Creekmore" -->
<!-- email="tcreek_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building MPI on Windows" -->
<!-- id="027f01cd499d$2df3d4e0$89db7ea0$_at_gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="DE2CB86A93428A408B1E6BE8E73DCCB40187AD82_at_CLEOHSMB13.napa.ad.etn.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> Trent Creekmore (<em>tcreek_at_[hidden]</em>)<br>
<strong>Date:</strong> 2012-06-13 15:46:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19545.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Previous message:</strong> <a href="19543.php">Damien: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>In reply to:</strong> <a href="19539.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19540.php">Ralph Castain: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
There is no complete documentation. It is things I had to figure out along the way..
<br>
<p>&nbsp;
<br>
<p>I guess I could help some.
<br>
<p>&nbsp;
<br>
<p>&nbsp;
<br>
<p>1)      Of course get A SSH client. I personally prefer SSH Secure Shell Client (Version 3.2.9.)  by SSH Security Corporation. This one is free, but no longer available or supported by them. However you may be able to find it online somewhere. Or you can use Putty. Then set the client up for X-Forwarding.
<br>
<p>2)      Get X-Ming  &lt;<a href="http://sourceforge.net/projects/xming/">http://sourceforge.net/projects/xming/</a>&gt; <a href="http://sourceforge.net/projects/xming/">http://sourceforge.net/projects/xming/</a>  Install it, and you only need to run it, nothing else.
<br>
<p>3)       Get Eclipse:   &lt;<a href="http://www.eclipse.org/downloads/">http://www.eclipse.org/downloads/</a>&gt; <a href="http://www.eclipse.org/downloads/">http://www.eclipse.org/downloads/</a> Download the Eclipse IDE for Parallel Application Developers (includes Incubating components) version. Pick 32 or 64 bit.
<br>
<p>Eclipse will need to be run on the remote machine. No installation is needed . Just extract it into the folder of your choosing.  Eclipse requires Java. If Java is not installed on the machine, you will need to install it, or if you cannot you can download Java, extract it,  and place a certain Java .so file in a subdirectory of Eclipse. It will tell you if Java is missing, and what location it is looking at, including the name of the .so file it is looking for. So you will be able to know what file you need and where to place it
<br>
<p>4)      To run Eclipse, using your SSH Client w/X-Forwarding on, and Xming running, log into the remote system. Go to your Eclipse folder then type &#226;&#128;&#156;eclipse&#226;&#128;&#157; (no quotes) and it should start running and you will see the GUI popup unless there is an issue in #3 with Java. Instead you will see an error about Java which you will need to fix.
<br>
<p>&nbsp;
<br>
<p>&nbsp;
...
<p>&nbsp;
<br>
<p>Could you please give me links to documentation that you followed when you set it up, Trent?
<br>
<p>&nbsp;
<br>
<p>Thanks,
...
<p>&nbsp;
<br>
<p>I just gave up and stuck with Unix/Linux.  Eclipse IDE offers a very nice plugin for developing and debugging MPI code named Parallel Tools Platform. Something not available in Visual Studio, except for similar one made by Intel, but I believe you have to use their compiler.
<br>
<p>&nbsp;
<br>
<p>You could always run Eclipse remotely from any Windows OS using a Secure Shell client and Xming (A Windows based X Server). That is what I do, and no more wasting time trying to get OMPI trying to run on Windows.
<br>
<p>&nbsp;
<br>
<p>From: users-bounces_at_[hidden] [mailto:users-bounces_at_[hidden]] On Behalf Of VimalMathew_at_[hidden]
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19544/attachment">attachment</a>
</ul>
