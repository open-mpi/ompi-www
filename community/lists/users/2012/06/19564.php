...
?>
<!-- received="Thu Jun 14 11:42:16 2012" -->
<!-- isoreceived="20120614154216" -->
<!-- sent="Thu, 14 Jun 2012 09:42:07 -0600" -->
<!-- isosent="20120614154207" -->
<!-- name="Damien" -->
<!-- email="damien_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building MPI on Windows" -->
<!-- id="4FDA064F.4090608_at_khubla.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="DE2CB86A93428A408B1E6BE8E73DCCB4018B0723_at_CLEOHSMB13.napa.ad.etn.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-14 11:42:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19565.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Previous message:</strong> <a href="19563.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>In reply to:</strong> <a href="19563.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19565.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Reply:</strong> <a href="19565.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Start with this:
<br>
<p><a href="http://supercomputingblog.com/mpi/getting-started-with-mpi-using-visual-studio-2008-express/">http://supercomputingblog.com/mpi/getting-started-with-mpi-using-visual-studio-2008-express/</a>
<br>
<p>The only difference is that whereever this tutorial says &quot;HPC Pack 2008 
<br>
SDK directory&quot; you should go to &quot;c:\ompi\openmpi-1.6\installed&quot; and use 
<br>
the include, lib and bin directories from there.
<br>
<p>This will give you a simple VS project that you can use to start 
<br>
building your own stuff.
<br>
<p>Damien
<br>
<p>On 14/06/2012 8:55 AM, VimalMathew_at_[hidden] wrote:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19564/attachment">attachment</a>
</ul>
