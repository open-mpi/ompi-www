...
?>
<!-- received="Thu Jun 14 15:50:50 2012" -->
<!-- isoreceived="20120614195050" -->
<!-- sent="Thu, 14 Jun 2012 14:50:51 -0500" -->
<!-- isosent="20120614195051" -->
<!-- name="Trent Creekmore" -->
<!-- email="tcreek_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building MPI on Windows" -->
<!-- id="01f301cd4a67$016b5270$0441f750$_at_gmail.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="DE2CB86A93428A408B1E6BE8E73DCCB4018B0B1C_at_CLEOHSMB13.napa.ad.etn.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-14 15:50:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19584.php">Damien: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Previous message:</strong> <a href="19582.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>In reply to:</strong> <a href="19581.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
And just think, you could have been coding 24 hours ago instead of continuing fighting the Windows problem J
<br>
<p>&nbsp;
<br>
<p>&nbsp;
...
<p>&nbsp;
<br>
<p>I restarted my system and the error message changed to this: 
<br>
<p>&nbsp;
<br>
<p>mpiexec was unable to launch the specified application as it could not find an e
<br>
<p>xecutable:
<br>
<p>&nbsp;
<br>
<p>Executable: Test.exe
<br>
<p>Node: SOUMIWHP5003567
<br>
<p>&nbsp;
<br>
...
Yes, I&#226;&#128;&#153;m trying to do this in C++.
...
Hmmm.  I think that tutorial might be slightly broken.  Calling printf without #include &lt;stdio&gt; causes all kinds of random runtime problems, and printf in a C++ program is generally not awesome.
Is your long-term goal a C++ project?  If you want C++, rename your main.c to main.cpp and update your project.  And change 
printf (&quot;Number of threads = %d, My rank = %d\n&quot;, nTasks, rank);
to
std::cout &lt;&lt; &quot;Number of threads = &quot; &lt;&lt; nTasks &lt;&lt; &quot;, My rank = &quot; &lt;&lt; rank &lt;&lt; &quot;\n&quot;;
Damien
On 14/06/2012 11:52 AM, VimalMathew_at_[hidden] wrote: 
Yeah, that&#226;&#128;&#153;s the only output.
Here&#226;&#128;&#153;s the code:
...
OK.  We might need to see the code for the program you're trying to run with mpiexec to help with that one.  Is that the full output?
Damien
On 14/06/2012 11:41 AM, VimalMathew_at_[hidden] wrote: 
Did the copy paste.
Now I get a message saying: mpiexec noticed that the job aborted, but has no info as to the process that caused that situation
...
Ah.  You installed the OpenMPI binaries too right?  Those are built with VS2010.  I bet the way your paths are set up it's using the installed version of mpiexec that wants VS2010 runtimes, not the mpiexec you compiled today that will use the VS2008 runtimes that you have.
OK, here's a quick fix you can try so you don't have to mess with paths.  Go into the installed\bin directory from your OpenMPI version, select everything, and copy it to the directory where your new project puts its executables (probably the Debug directory).  Then run your mpiexec .... from within that Debug directory and it will use all your OpenMPI exes and dlls because it will look there first.
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19583/attachment">attachment</a>
</ul>
