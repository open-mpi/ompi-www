...
?>
<!-- received="Wed Jun 13 14:47:27 2012" -->
<!-- isoreceived="20120613184727" -->
<!-- sent="Wed, 13 Jun 2012 13:47:27 -0500" -->
<!-- isosent="20120613184727" -->
<!-- name="Trent Creekmore" -->
<!-- email="tcreek_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building MPI on Windows" -->
<!-- id="01fd01cd4994$fbe70060$f3b50120$_at_gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="DE2CB86A93428A408B1E6BE8E73DCCB40187ACCB_at_CLEOHSMB13.napa.ad.etn.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-13 14:47:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19537.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Previous message:</strong> <a href="19535.php">VimalMathew_at_[hidden]: "[OMPI users]  Building MPI on Windows"</a>
<li><strong>In reply to:</strong> <a href="19535.php">VimalMathew_at_[hidden]: "[OMPI users]  Building MPI on Windows"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19537.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<li><strong>Reply:</strong> <a href="19537.php">VimalMathew_at_[hidden]: "Re: [OMPI users] Building MPI on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
This may, or may not be helpful, but I have tried the Windows offerings. I have never gotten anything to function was expected. Compiling, or the available binaries. I think they just don&#226;&#128;&#153;t work at all.
<br>
<p>&nbsp;
<br>
<p>My suggestion which I feel would be easier, and less headache way would be to install something like CygWin, which would give you a Unix/Linux like environment running under Windows. 
<br>
<p>You would only need to compile it in CygWin just like the Linux/Unix docs say to do. 
<br>
<p>&nbsp;
<br>
<p>I don&#226;&#128;&#153;t know if anyone else has done it this way or not.
<br>
<p>&nbsp;
<br>
<p>&nbsp;
...
On Jun 12, 2012, at 2:24 PM,  &lt;mailto:VimalMathew_at_[hidden]&gt; &lt;VimalMathew_at_[hidden]&gt; wrote:
...
On Jun 12, 2012, at 1:25 PM,  &lt;mailto:VimalMathew_at_[hidden]&gt; &lt;VimalMathew_at_[hidden]&gt; wrote:
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19536/attachment">attachment</a>
</ul>
