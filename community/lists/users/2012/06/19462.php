...
?>
<!-- received="Wed Jun  6 14:24:25 2012" -->
<!-- isoreceived="20120606182425" -->
<!-- sent="Wed, 6 Jun 2012 13:24:18 -0500" -->
<!-- isosent="20120606182418" -->
...
<!-- id="CACTdByygwmri+0d8HVj1siBe-ouqivo=8ehjCMEve70QCrSXPg_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CBF4E88D.D098%bwbarre_at_sandia.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2012-06-06 14:24:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="19463.php">Ziaul Haque Olive: "Re: [OMPI users] MPI One-Sided Communication, indexed datatype and segmentation fault."</a>
<li><strong>Previous message:</strong> <a href="19461.php">Barrett, Brian W: "Re: [OMPI users] MPI One-Sided Communication, indexed datatype and segmentation fault."</a>
<li><strong>In reply to:</strong> <a href="19461.php">Barrett, Brian W: "Re: [OMPI users] MPI One-Sided Communication, indexed datatype and segmentation fault."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="19463.php">Ziaul Haque Olive: "Re: [OMPI users] MPI One-Sided Communication, indexed datatype and segmentation fault."</a>
<li><strong>Reply:</strong> <a href="19463.php">Ziaul Haque Olive: "Re: [OMPI users] MPI One-Sided Communication, indexed datatype and segmentation fault."</a>
<li><strong>Reply:</strong> <a href="19464.php">Barrett, Brian W: "Re: [OMPI users] [EXTERNAL] Re:  MPI One-Sided Communication, indexed datatype and segmentation fault."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello Brian,
<br>
<p>Actually, I am not modifying the local communication buffer that contains
<br>
the data. I am modifying the the buffer that contains the indices of the
<br>
data buffer(source_disp and target_disp).
<br>
<p>in MPICH2 this is not a problem. I am not sure about Open MPI.
<br>
<p>Thanks,
<br>
Ziaul
<br>
<p>On Wed, Jun 6, 2012 at 1:05 PM, Barrett, Brian W &lt;bwbarre_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Ziaul -
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-19462/attachment">attachment</a>
</ul>
