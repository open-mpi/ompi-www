...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0457.php">Enzo: "[O-MPI users] Rendezvous Question"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2005/12/0455.php">Michael L. Stokes: "Re: [O-MPI users] (no subject)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0462.php">Brian Barrett: "Re: [O-MPI users] OpenMPI 1.0.1 with Torque 2.0"</a>
<li><strong>Reply:</strong> <a href="0462.php">Brian Barrett: "Re: [O-MPI users] OpenMPI 1.0.1 with Torque 2.0"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-0456/attachment">attachment</a>
</ul>
