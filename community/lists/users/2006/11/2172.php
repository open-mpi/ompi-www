...
<!-- received="Fri Nov 10 21:24:01 2006" -->
<!-- isoreceived="20061111022401" -->
<!-- sent="Sat, 11 Nov 2006 13:23:56 +1100" -->
<!-- isosent="20061111022356" -->
<!-- name="Manal Helal" -->
<!-- email="manalorama_at_[hidden]" -->
<!-- subject="Re: [OMPI users] debugging problem" -->
<!-- id="131b56be0611101823x46e637fci2cec459c2058fab6_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="[OMPI users] debugging problem" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-11-10 21:23:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2173.php">Ralph Castain: "Re: [OMPI users] debugging problem"</a>
<li><strong>Previous message:</strong> <a href="2171.php">Brock Palen: "[OMPI users] problems with gm support on OSX PPC"</a>
<li><strong>Maybe in reply to:</strong> <a href="2169.php">Manal Helal: "[OMPI users] debugging problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2173.php">Ralph Castain: "Re: [OMPI users] debugging problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph
<br>
<p>sorry about this, I understood that -d should make the output directory the
<br>
xterm, but my expectation, was to have separate xterms for each running
<br>
process that I can debug! am I completely off-track?
<br>
<p>where I can find more information about debugging multiprocess-multithreaded
<br>
programs using gdb? I have the -np processes created by mpirun, and then
<br>
each process has a number of threads running in parallel independently (some
<br>
semaphores are used anyway?) will I end up having different xterms for each
<br>
process (hopefully each thread within as well?
<br>
<p>I am  totally lost in this debugging scenario, and need basic help actually
<br>
...
Manal
<br>
<p>Date: Thu, 09 Nov 2006 21:58:57 -0700
<br>
...
<br>
Message-ID: &lt;C1795521.3D5%rhc_at_[hidden]&gt;
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-2172/attachment">attachment</a>
</ul>
