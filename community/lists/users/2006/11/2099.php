<?
$subject_val = "Re: [OMPI users] about the openmpi problem";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2100.php">Jeff Squyres: "Re: [OMPI users] Problem starting rank other than zero"</a>
<li><strong>Previous message:</strong> <a href="2098.php">George Bosilca: "Re: [OMPI users] OMPI Collectives"</a>
<li><strong>In reply to:</strong> <a href="2097.php">calin pal: "[OMPI users] about the openmpi problem"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
