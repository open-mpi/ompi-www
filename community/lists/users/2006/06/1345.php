...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1346.php">Jeff Squyres \(jsquyres\): "Re: [OMPI users] MPI_GATHER: missing f90 interfaces for mixed dimensions"</a>
<li><strong>Previous message:</strong> <a href="1344.php">Jeff Squyres \(jsquyres\): "Re: [OMPI users] Few more questions"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1347.php">Troy Telford: "Re: [OMPI users] Open MPI 1.0.2 and np &gt;=64"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
