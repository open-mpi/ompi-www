...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1811.php">Wang,  Peng: "[OMPI users] question about passing MPI communicator"</a>
<li><strong>Previous message:</strong> <a href="1809.php">Jeff Squyres: "Re: [OMPI users] little endian - big endian conversion"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2006/08/1805.php">Tobias Graf: "[OMPI users] Problem with C++ Binding"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1813.php">Tobias Graf: "Re: [OMPI users] Problem with C++ Binding"</a>
<li><strong>Reply:</strong> <a href="1813.php">Tobias Graf: "Re: [OMPI users] Problem with C++ Binding"</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2006/10/1961.php">Jeff Squyres: "Re: [OMPI users] Problem with C++ Binding"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
