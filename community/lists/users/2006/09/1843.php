...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1844.php">Miguel Figueiredo Mascarenhas Sousa Filipe: "Re: [OMPI users] Does current Intel dual processor support MPI?"</a>
<li><strong>Previous message:</strong> <a href="1842.php">Renato Golin: "Re: [OMPI users] R: Re: MPI_LOOKUP_NAME BUG"</a>
<li><strong>In reply to:</strong> <a href="1842.php">Renato Golin: "Re: [OMPI users] R: Re: MPI_LOOKUP_NAME BUG"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
