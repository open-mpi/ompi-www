...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1812.php">Brian Barrett: "Re: [OMPI users] question about passing MPI communicator"</a>
<li><strong>Previous message:</strong> <a href="1810.php">Jeff Squyres: "Re: [OMPI users] Problem with C++ Binding"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1812.php">Brian Barrett: "Re: [OMPI users] question about passing MPI communicator"</a>
<li><strong>Reply:</strong> <a href="1812.php">Brian Barrett: "Re: [OMPI users] question about passing MPI communicator"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
