...
<!-- subject="[OMPI users] problem with MPI_[Pack|Unpack]_external" -->
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1912.php">Abhishek Pratap: "Re: [OMPI users] Need help in Perl with MPI"</a>
<li><strong>Previous message:</strong> <a href="1910.php">Miguel Figueiredo Mascarenhas Sousa Filipe: "Re: [OMPI users] using both 64 and 32 bit mpi"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
