...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1172.php">Edgar Gabriel: "Re: [OMPI users] MPI_Open_port returns port 0.0.0:2000"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2006/04/1170.php">Brian Barrett: "Re: [OMPI users] Default number of slots when using Torque"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1172.php">Edgar Gabriel: "Re: [OMPI users] MPI_Open_port returns port 0.0.0:2000"</a>
<li><strong>Reply:</strong> <a href="1172.php">Edgar Gabriel: "Re: [OMPI users] MPI_Open_port returns port 0.0.0:2000"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
