...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1174.php">Douglas Kojetin: "[OMPI users] C++ problem with ./configure using Intel version 9.0"</a>
<li><strong>Previous message:</strong> <a href="1172.php">Edgar Gabriel: "Re: [OMPI users] MPI_Open_port returns port 0.0.0:2000"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1178.php">Bernard Knaepen: "Re: [OMPI users] fortran mpi io malloc error"</a>
<li><strong>Reply:</strong> <a href="1178.php">Bernard Knaepen: "Re: [OMPI users] fortran mpi io malloc error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
