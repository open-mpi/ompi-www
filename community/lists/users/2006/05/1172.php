...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1173.php">Brian Barrett: "Re: [OMPI users] fortran mpi io malloc error"</a>
<li><strong>Previous message:</strong> <a href="1171.php">Amit Schreiber: "[OMPI users] MPI_Open_port returns port 0.0.0:2000"</a>
<li><strong>In reply to:</strong> <a href="1171.php">Amit Schreiber: "[OMPI users] MPI_Open_port returns port 0.0.0:2000"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1211.php">Amit Schreiber: "Re: [OMPI users] MPI_Open_port returns port 0.0.0:2000"</a>
<li><strong>Reply:</strong> <a href="1211.php">Amit Schreiber: "Re: [OMPI users] MPI_Open_port returns port 0.0.0:2000"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
