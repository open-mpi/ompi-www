...
<!-- received="Fri Mar  3 16:29:48 2006" -->
<!-- isoreceived="20060303212948" -->
<!-- sent="Fri, 3 Mar 2006 15:29:40 -0600 " -->
<!-- isosent="20060303212940" -->
<!-- name="Adams Samuel D Contr AFRL/HEDR" -->
<!-- email="Samuel.Adams.ctr_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building OpenMPI with Lahey Fortran 95" -->
<!-- id="4F5BE74AB02653448520E9692496874101E4E0_at_fscnbc18.brooks.af.mil" -->
<!-- inreplyto="[OMPI users] Building OpenMPI with Lahey Fortran 95" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-03-03 16:29:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0775.php">Xiaoning (David) Yang: "[OMPI users] MPI_IN_PLACE"</a>
<li><strong>Previous message:</strong> <a href="0773.php">Xiaoning (David) Yang: "Re: [OMPI users] Problem running open mpi across nodes."</a>
<li><strong>Maybe in reply to:</strong> <a href="0751.php">Adams Samuel D Contr AFRL/HEDR: "[OMPI users] Building OpenMPI with Lahey Fortran 95"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>I am trying to build OpenMPI using Lahey Fortran 95 6.2 on a Fedora Core 3
<br>
