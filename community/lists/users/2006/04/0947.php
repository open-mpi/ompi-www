...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0948.php">Rolf Vandevaart: "[OMPI users] Open MPI installed locally"</a>
<li><strong>Previous message:</strong> <a href="0946.php">Prakash Velayutham: "[OMPI users] Open MPI and Torque error"</a>
<li><strong>In reply to:</strong> <a href="0945.php">George Bosilca: "Re: [OMPI users] MPI_Testsome with no requests"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
