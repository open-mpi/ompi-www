...
<!-- received="Mon Apr 10 13:06:12 2006" -->
<!-- isoreceived="20060410170612" -->
<!-- sent="Mon, 10 Apr 2006 12:06:01 -0500" -->
<!-- isosent="20060410170601" -->
<!-- name="Adams Samuel D Contr AFRL/HEDR" -->
<!-- email="Samuel.Adams.ctr_at_[hidden]" -->
<!-- subject="Re: [OMPI users] job running question" -->
<!-- id="4F5BE74AB02653448520E9692496874101E57D_at_fscnbc18.brooks.af.mil" -->
...
<strong>Date:</strong> 2006-04-10 13:06:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1002.php">Jeff Squyres \(jsquyres\): "Re: [OMPI users] job running question"</a>
<li><strong>Previous message:</strong> <a href="1000.php">Josh Hursey: "Re: [OMPI users] any checkpoint/restart function in Open-MPI?"</a>
<li><strong>Maybe in reply to:</strong> <a href="0974.php">Adams Samuel D Contr AFRL/HEDR: "[OMPI users] job running question"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1003.php">Michael Kluskens: "Re: [OMPI users] job running question"</a>
<li><strong>Reply:</strong> <a href="1003.php">Michael Kluskens: "Re: [OMPI users] job running question"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Subject: Re: [OMPI users] job running question
<br>
<p>Mpirun opens separate shell on each machine/node, so the &quot;ulimit&quot; will 
<br>
...
<span class="quotelev1">&gt; But, it was not dropping core files for some reason when I was running
</span><br>
with
<br>
...
<span class="quotelev1">&gt; That would give a segmentation fault.  It dropped a core file like you
</span><br>
would
<br>
