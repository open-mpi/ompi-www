<?
$subject_val = "[OMPI users] Open MPI and Torque error";
...
<li><strong>Previous message:</strong> <a href="0945.php">George Bosilca: "Re: [OMPI users] MPI_Testsome with no requests"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0956.php">Pak Lui: "Re: [OMPI users] Open MPI and Torque error"</a>
<li><strong>Maybe reply:</strong> <a href="0956.php">Pak Lui: "Re: [OMPI users] Open MPI and Torque error"</a>
<li><strong>Maybe reply:</strong> <a href="0974.php">Jeff Squyres \(jsquyres\): "Re: [OMPI users] Open MPI and Torque error"</a>
<li><strong>Maybe reply:</strong> <a href="0977.php">Prakash Velayutham: "Re: [OMPI users] Open MPI and Torque error"</a>
<li><strong>Maybe reply:</strong> <a href="0978.php">Prakash Velayutham: "Re: [OMPI users] Open MPI and Torque error"</a>
<li><strong>Maybe reply:</strong> <a href="0979.php">Jeff Squyres \(jsquyres\): "Re: [OMPI users] Open MPI and Torque error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
