...
<!-- received="Fri Dec  1 18:51:26 2006" -->
<!-- isoreceived="20061201235126" -->
<!-- sent="Fri, 01 Dec 2006 15:51:18 -0800" -->
<!-- isosent="20061201235118" -->
<!-- name="Dave Grote" -->
<!-- email="dpgrote_at_[hidden]" -->
<!-- subject="Re: [OMPI users] x11 forwarding" -->
<!-- id="4570BFF6.9070407_at_lbl.gov" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="4BB7C41E-2C2A-47B5-871B-F6C12C50B26A_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-12-01 18:51:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="2277.php">Ralph Castain: "Re: [OMPI users] x11 forwarding"</a>
<li><strong>Previous message:</strong> <a href="2275.php">Dave Grote: "Re: [OMPI users] x11 forwarding"</a>
<li><strong>In reply to:</strong> <a href="2274.php">Galen Shipman: "Re: [OMPI users] x11 forwarding"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="2277.php">Ralph Castain: "Re: [OMPI users] x11 forwarding"</a>
<li><strong>Reply:</strong> <a href="2277.php">Ralph Castain: "Re: [OMPI users] x11 forwarding"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
Galen Shipman wrote:
<blockquote cite="mid4BB7C41E-2C2A-47B5-871B-F6C12C50B26A@lanl.gov"
 type="cite">-d leaves the ssh session open
  <div>Try using:  </div>
  <div><br class="khtml-block-placeholder">
  </div>
  <div>mpirun -d -host boxtop2 -mca pls_rsh_agent "ssh -X -n" xterm -e
cat </div>
  <div><br class="khtml-block-placeholder">
  </div>
  <div><br class="khtml-block-placeholder">
  </div>
  <div>Note the "ssh -X -n", this will tell ssh not to open stdin.. </div>
  <div><br class="khtml-block-placeholder">
  </div>
  <div>You should then be able to type characters in the resulting
xterm and have them echo'd back correctly. </div>
  <div><br class="khtml-block-placeholder">
  </div>
  <div>- Galen </div>
  <div> </div>
  ...
  <div><br>
  <div>
  <div>On Dec 1, 2006, at 11:48 AM, Dave Grote wrote:</div>
...
Ralph H Castain wrote:
 ...
 style="font-size: 12px;">Actually, I believe at least some of this may
