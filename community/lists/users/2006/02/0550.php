<?
$subject_val = "Re: [O-MPI users] forrtl: severe (39): error during read, unit 5, file /dev/ptmx - OpenMPI 1.0.2";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0551.php">Glenn Morris: "[O-MPI users] tcsh 'Unmatched &quot;.' error on localhost"</a>
<li><strong>Previous message:</strong> <a href="0549.php">Brian Barrett: "Re: [O-MPI users] Bug in C++ bindings"</a>
<li><strong>In reply to:</strong> <a href="../../2006/01/0546.php">Konstantin Kudin: "[O-MPI users] forrtl: severe (39): error during read, unit 5, file /dev/ptmx - OpenMPI 1.0.2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0569.php">Jeff Squyres: "Re: [O-MPI users] forrtl: severe (39): error during read, unit 5, file /dev/ptmx - OpenMPI 1.0.2"</a>
<li><strong>Reply:</strong> <a href="0569.php">Jeff Squyres: "Re: [O-MPI users] forrtl: severe (39): error during read, unit 5, file /dev/ptmx - OpenMPI 1.0.2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
