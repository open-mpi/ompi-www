...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0553.php">Konstantin Kudin: "Re: [O-MPI users] forrtl: severe (39): error during read, unit 5, file /dev/ptmx - OpenMPI 1.0.2"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2006/01/0551.php">Glenn Morris: "Re: [O-MPI users] mpirun tcsh LD_LIBRARY_PATH problem"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2006/01/0550.php">Brian Granger: "[O-MPI users] Bug in C++ bindings"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0561.php">Brian Granger: "Re: [O-MPI users] Bug in C++ bindings"</a>
<li><strong>Reply:</strong> <a href="0561.php">Brian Granger: "Re: [O-MPI users] Bug in C++ bindings"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-0552/ompi_cxx.diff">ompi_cxx.diff</a>
</ul>
