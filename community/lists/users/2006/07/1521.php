...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1522.php">Bert Wesarg: "[OMPI users] MPI_Op_reduce()"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2006/06/1520.php">Brian Barrett: "Re: [OMPI users] Testing one-sided message passing with 1.1"</a>
<li><strong>Maybe in reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2006/06/1478.php">openmpi-user: "Re: [OMPI users] OpenMPI 1.1: Signal:10 info.si_errno:0(Unknown, error:	0), si_code:1(BUS_ADRALN) (Terry D. Dontje)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1523.php">Brian Barrett: "Re: [OMPI users] OpenMPI 1.1: Signal:10 info.si_errno:0(Unknown, error:	0), si_code:1(BUS_ADRALN) (Terry D. Dontje)"</a>
<li><strong>Reply:</strong> <a href="1523.php">Brian Barrett: "Re: [OMPI users] OpenMPI 1.1: Signal:10 info.si_errno:0(Unknown, error:	0), si_code:1(BUS_ADRALN) (Terry D. Dontje)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
