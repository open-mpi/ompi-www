...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1521.php">openmpi-user: "[OMPI users] OS X, OpenMPI 1.1: An error occurred in MPI_Allreduce on communicator MPI_COMM_WORLD"</a>
<li><strong>Previous message:</strong> <a href="1519.php">Bert Wesarg: "[OMPI users] MPI_Op_reduce()"</a>
<li><strong>In reply to:</strong> <a href="1518.php">openmpi-user: "Re: [OMPI users] OpenMPI 1.1: Signal:10 info.si_errno:0(Unknown, error:	0), si_code:1(BUS_ADRALN) (Terry D. Dontje)"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
