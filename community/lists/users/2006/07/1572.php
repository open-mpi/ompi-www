...
<!-- received="Thu Jul  6 12:58:18 2006" -->
<!-- isoreceived="20060706165818" -->
<!-- sent="Thu, 6 Jul 2006 10:58:13 -0600" -->
<!-- isosent="20060706165813" -->
<!-- name="Galen M. Shipman" -->
<!-- email="gshipman_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem with Openmpi 1.1" -->
<!-- id="62389CB1-1B86-4485-981B-32DE4E3F86C0_at_lanl.gov" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="8d39cca0607060949q6d83e6c0q68f1d9a833a85bc2_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-07-06 12:58:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="1573.php">Justin Bronder: "Re: [OMPI users] Problem with Openmpi 1.1"</a>
<li><strong>Previous message:</strong> <a href="1571.php">s anwar: "[OMPI users] MPI_Comm_spawn error messages"</a>
<li><strong>In reply to:</strong> <a href="1570.php">Justin Bronder: "Re: [OMPI users] Problem with Openmpi 1.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="1573.php">Justin Bronder: "Re: [OMPI users] Problem with Openmpi 1.1"</a>
<li><strong>Reply:</strong> <a href="1573.php">Justin Bronder: "Re: [OMPI users] Problem with Openmpi 1.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Justin,
<br>
<p>Is the OS X run showing the same residual failure?
<br>
<p>- Galen
<br>
<p>On Jul 6, 2006, at 10:49 AM, Justin Bronder wrote:
<br>
<p><span class="quotelev1">&gt; Disregard the failure on Linux, a rebuild from scratch of HPL and  
</span><br>
<span class="quotelev1">&gt; OpenMPI
</span><br>
<span class="quotelev1">&gt; seems to have resolved the issue.  At least I'm not getting the  
</span><br>
<span class="quotelev1">&gt; errors during
</span><br>
...
<span class="quotelev1">&gt; /usr/local/$ARCH/bin/mpiexec -mca btl gm -np 2 -path /usr/local/ 
</span><br>
<span class="quotelev1">&gt; $ARCH/bin ./xhpl
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Please provide us your mca parameters (if any), these could be in a  
</span><br>
<span class="quotelev1">&gt; config file, environment variables or on the command line.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Thanks,
...
<span class="quotelev2">&gt; &gt;                  MCA sds: seed (MCA v1.0, APIv1.0, Component v1.1)
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-1572/attachment">attachment</a>
</ul>
