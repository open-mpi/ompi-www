...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23232.php">tmishima_at_[hidden]: "Re: [OMPI users] tcp of openmpi-1.7.3 under our environment is very slow"</a>
<li><strong>Previous message:</strong> <a href="23230.php">Martin Siegert: "Re: [OMPI users] slowdown with infiniband and latest CentOS kernel"</a>
<li><strong>In reply to:</strong> <a href="23222.php">Jeff Squyres (jsquyres): "Re: [OMPI users] [OMPI devel] Recommended tool to measure packet counters"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23231/attachment">attachment</a>
</ul>
