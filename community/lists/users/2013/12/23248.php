...
?>
<!-- received="Thu Dec 19 03:28:59 2013" -->
<!-- isoreceived="20131219082859" -->
<!-- sent="Thu, 19 Dec 2013 17:28:45 +0900" -->
<!-- isosent="20131219082845" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node" -->
<!-- id="OF7978758C.E0E8DB60-ON49257C46.0026F6EB-49257C46.002E98DF_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="49C60548-16E3-46D8-AB3E-91EB24A09AFD_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-19 03:28:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23249.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646	with	-hostfile	option	under	Torque manager"</a>
<li><strong>Previous message:</strong> <a href="23247.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>In reply to:</strong> <a href="23247.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't	work	for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23267.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>Reply:</strong> <a href="23267.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Tetsuya Mishima
<br>
<p><span class="quotelev1">&gt; Yeah, it will impact everything that uses hwloc topology maps, I fear.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; One side note: you'll need to add --hetero-nodes to your cmd line. If we
</span><br>
...
<span class="quotelev1">&gt; I'll try to resolve the hier inversion over the holiday - won't be for
</span><br>
...
<span class="quotelev2">&gt; &gt; By the way, I think this inversion should affect rmaps_lama mapping.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Ick - yeah, that would be a problem. I haven't seen that type of
</span><br>
<span class="quotelev2">&gt; &gt; hierarchical inversion before - is node03 a different type of chip?
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15508] mca:rmaps: compute bindings for job [38286,1]
</span><br>
<span class="quotelev2">&gt; &gt; with
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; policy NUMA
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15508] mca:rmaps: bind upwards for job [38286,1] with
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; bindings NUMA
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15508] [[38286,0],0] bind:upward target NUMANode type
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Machine
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; That's the reason of this trouble. Therefore, adding &quot;-map-by core&quot;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [mishima_at_node03 demos]$ mpirun -np 8 -bind-to numa -map-by core
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; -report-bindings myprog
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target NUMANode type
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 2 bound to socket 0[core 0[hwt 0]],
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 3 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 4 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 5 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 6 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 7 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 0 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 1 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:15508] Type: Machine Number of child objects: 4
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node05.cluster:21750] Type: Machine Number of child objects: 2
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;       Name=NULL
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Hmm...try adding &quot;-mca rmaps_base_verbose 10 -mca ess_base_verbose
</span><br>
5&quot;
<br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15316] [[37582,0],0] bind:upward target NUMANode
</span><br>
type
<br>
...
--------------------------------------------------------------------------
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; A request was made to bind to NUMA, but an appropriate target could
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 4 bound to socket 2[core 16[hwt
</span><br>
0]]:
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][B/././././././.]
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 5 bound to socket 2[core 17[hwt
</span><br>
0]]:
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./B/./././././.]
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 6 bound to socket 3[core 24[hwt
</span><br>
0]]:
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 7 bound to socket 3[core 25[hwt
</span><br>
0]]:
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; L#24 (P#24)&gt;&gt;&gt;&gt;&gt;    L2 L#25 (512KB) + L1d L#25 (64KB) + L1i L#25
</span><br>
(64KB) + Core L#25 +
<br>
<span class="quotelev4">&gt; &gt;&gt;&gt; PU
