...
?>
<!-- received="Fri Dec 20 05:33:24 2013" -->
<!-- isoreceived="20131220103324" -->
<!-- sent="Fri, 20 Dec 2013 19:33:09 +0900" -->
<!-- isosent="20131220103309" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node" -->
<!-- id="OFCF12DAE4.5E862AE5-ON49257C47.00373F0A-49257C47.0039FDC9_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="OF7978758C.E0E8DB60-ON49257C46.0026F6EB-49257C46.002E98DF_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-20 05:33:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23268.php">Brice Goglin: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<li><strong>Previous message:</strong> <a href="23266.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646	with	-hostfile	option	under	Torque manager"</a>
<li><strong>In reply to:</strong> <a href="23248.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23268.php">Brice Goglin: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<li><strong>Reply:</strong> <a href="23268.php">Brice Goglin: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>The numa-node in AMD Mangy-Cours/Interlagos is so called cc(cache
<br>
coherent)NUMA,
<br>
...
in openmpi.
<br>
<p>I notice that ccNUMA object is almost same as L3cache object.
<br>
...
<br>
<p>Anyway, mixing up these two types of numa is the problem.
<br>
<p>Regards,
<br>
Tetsuya Mishima
<br>
<p><span class="quotelev1">&gt; I can wait it'll be fixed in 1.7.5 or later, because putting &quot;-bind-to
</span><br>
...
<span class="quotelev2">&gt; &gt; Yeah, it will impact everything that uses hwloc topology maps, I fear.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; One side note: you'll need to add --hetero-nodes to your cmd line. If
</span><br>
we
<br>
...
<span class="quotelev2">&gt; &gt; I'll try to resolve the hier inversion over the holiday - won't be for
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; By the way, I think this inversion should affect rmaps_lama mapping.
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; hierarchical inversion before - is node03 a different type of chip?
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; That's the reason of this trouble. Therefore, adding &quot;-map-by core&quot;
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 2 bound to socket 0[core 0[hwt 0]],
</span><br>
...
[B/B/B/B/./././.][./././././././.][./././././././.][./././././././.]
<br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 3 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev3">&gt; &gt; &gt; socket
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
[B/B/B/B/./././.][./././././././.][./././././././.][./././././././.]
<br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 4 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev3">&gt; &gt; &gt; socket
</span><br>
...
[././././B/B/B/B][./././././././.][./././././././.][./././././././.]
<br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 5 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev3">&gt; &gt; &gt; socket
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
[././././B/B/B/B][./././././././.][./././././././.][./././././././.]
<br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 6 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev3">&gt; &gt; &gt; socket
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
[././././B/B/B/B][./././././././.][./././././././.][./././././././.]
<br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 7 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev3">&gt; &gt; &gt; socket
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
[././././B/B/B/B][./././././././.][./././././././.][./././././././.]
<br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 0 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev3">&gt; &gt; &gt; socket
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
[B/B/B/B/./././.][./././././././.][./././././././.][./././././././.]
<br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; [node03.cluster:15885] MCW rank 1 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev3">&gt; &gt; &gt; socket
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; Hmm...try adding &quot;-mca rmaps_base_verbose 10 -mca ess_base_verbose
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15316] [[37582,0],0] bind:upward target NUMANode
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 4 bound to socket 2[core 16[hwt
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 5 bound to socket 2[core 17[hwt
</span><br>
<span class="quotelev1">&gt; 0]]:
</span><br>
<span class="quotelev3">&gt; &gt; &gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./B/./././././.]
...
<span class="quotelev3">&gt; &gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 6 bound to socket 3[core 24[hwt
</span><br>
<span class="quotelev1">&gt; 0]]:
</span><br>
<span class="quotelev3">&gt; &gt; &gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
...
<span class="quotelev3">&gt; &gt; &gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 7 bound to socket 3[core 25[hwt
</span><br>
<span class="quotelev1">&gt; 0]]:
</span><br>
<span class="quotelev3">&gt; &gt; &gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
...
<span class="quotelev3">&gt; &gt; &gt;&gt;&gt;&gt;&gt; L#24 (P#24)&gt;&gt;&gt;&gt;&gt;    L2 L#25 (512KB) + L1d L#25 (64KB) + L1i L#25
</span><br>
