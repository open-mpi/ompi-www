...
?>
<!-- received="Thu Dec 19 00:25:28 2013" -->
<!-- isoreceived="20131219052528" -->
<!-- sent="Wed, 18 Dec 2013 21:25:15 -0800" -->
<!-- isosent="20131219052515" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of openmpi-1.7.4rc1 dosen't work	for our magny cours based 32 core node" -->
<!-- id="1AFD4F9F-E564-45B9-B35C-BE36BADE4FCE_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="OFC0FC1F77.55CBBE2E-ON49257C46.001897E6-49257C46.001BFB63_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-19 00:25:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23246.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>Previous message:</strong> <a href="23244.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't work	for our magny cours based 32 core node"</a>
<li><strong>In reply to:</strong> <a href="23244.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't work	for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23246.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>Reply:</strong> <a href="23246.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't	work	for our magny cours based 32 core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Ick - yeah, that would be a problem. I haven't seen that type of hierarchical inversion before - is node03 a different type of chip?
<br>
<p>Might take awhile for me to adjust the code to handle hier inversion... :-(
<br>
<p>On Dec 18, 2013, at 9:05 PM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; [node03.cluster:15508] mca:rmaps: compute bindings for job [38286,1] with
</span><br>
<span class="quotelev1">&gt; policy NUMA
</span><br>
<span class="quotelev1">&gt; [node03.cluster:15508] mca:rmaps: bind upwards for job [38286,1] with
</span><br>
<span class="quotelev1">&gt; bindings NUMA
</span><br>
<span class="quotelev1">&gt; [node03.cluster:15508] [[38286,0],0] bind:upward target NUMANode type
</span><br>
<span class="quotelev1">&gt; Machine
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; That's the reason of this trouble. Therefore, adding &quot;-map-by core&quot; works.
</span><br>
...
<span class="quotelev1">&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target NUMANode type Cache
</span><br>
<span class="quotelev1">&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target NUMANode type Cache
</span><br>
<span class="quotelev1">&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target NUMANode type Cache
</span><br>
<span class="quotelev1">&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target NUMANode type
</span><br>
...
<span class="quotelev1">&gt; [node03.cluster:15885] MCW rank 2 bound to socket 0[core 0[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [node03.cluster:15885] MCW rank 3 bound to socket 0[core 0[hwt 0]], socket
</span><br>
<span class="quotelev1">&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
</span><br>
<span class="quotelev1">&gt; cket 0[core 3[hwt 0]]:
...
<span class="quotelev1">&gt; [node03.cluster:15885] MCW rank 4 bound to socket 0[core 4[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [node03.cluster:15885] MCW rank 5 bound to socket 0[core 4[hwt 0]], socket
</span><br>
<span class="quotelev1">&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
</span><br>
<span class="quotelev1">&gt; cket 0[core 7[hwt 0]]:
...
<span class="quotelev1">&gt; [node03.cluster:15885] MCW rank 6 bound to socket 0[core 4[hwt 0]], socket
</span><br>
<span class="quotelev1">&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
</span><br>
<span class="quotelev1">&gt; cket 0[core 7[hwt 0]]:
...
<span class="quotelev1">&gt; [node03.cluster:15885] MCW rank 7 bound to socket 0[core 4[hwt 0]], socket
</span><br>
<span class="quotelev1">&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
</span><br>
<span class="quotelev1">&gt; cket 0[core 7[hwt 0]]:
...
<span class="quotelev1">&gt; [node03.cluster:15885] MCW rank 0 bound to socket 0[core 0[hwt 0]], socket
</span><br>
<span class="quotelev1">&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
</span><br>
<span class="quotelev1">&gt; cket 0[core 3[hwt 0]]:
...
<span class="quotelev1">&gt; [node03.cluster:15885] MCW rank 1 bound to socket 0[core 0[hwt 0]], socket
</span><br>
<span class="quotelev1">&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
</span><br>
<span class="quotelev1">&gt; cket 0[core 3[hwt 0]]:
...
<span class="quotelev2">&gt;&gt; Hmm...try adding &quot;-mca rmaps_base_verbose 10 -mca ess_base_verbose 5&quot; to
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [mishima_at_node03 demos]$ mpirun -np 8 -report-bindings -bind-to numa
</span><br>
<span class="quotelev1">&gt; myprog
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15316] [[37582,0],0] bind:upward target NUMANode type
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; A request was made to bind to NUMA, but an appropriate target could not
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15282] MCW rank 2 bound to socket 1[core 8[hwt 0]]:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./././././././.][B/././././././.][./././././././.][
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ./././././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15282] MCW rank 3 bound to socket 1[core 9[hwt 0]]:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./././././././.][./B/./././././.][./././././././.][
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ./././././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15282] MCW rank 4 bound to socket 2[core 16[hwt 0]]:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./././././././.][./././././././.][B/././././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./././././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15282] MCW rank 5 bound to socket 2[core 17[hwt 0]]:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./././././././.][./././././././.][./B/./././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./././././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15282] MCW rank 6 bound to socket 3[core 24[hwt 0]]:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [B/././././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15282] MCW rank 7 bound to socket 3[core 25[hwt 0]]:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./B/./././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15282] MCW rank 0 bound to socket 0[core 0[hwt 0]]:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [B/././././././.][./././././././.][./././././././.][
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ./././././././.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15282] MCW rank 1 bound to socket 0[core 1[hwt 0]]:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [./B/./././././.][./././././././.][./././././././.][
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ./././././././.]
