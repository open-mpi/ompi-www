...
?>
<!-- received="Sun Dec 22 00:44:33 2013" -->
<!-- isoreceived="20131222054433" -->
<!-- sent="Sat, 21 Dec 2013 21:44:01 -0800" -->
<!-- isosent="20131222054401" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to	numa&amp;quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours	based 32	core node" -->
<!-- id="DDC3CAB3-B2CC-4922-B93B-75EB6A1208A0_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="OFE4D2D2FB.D306AC43-ON49257C49.0015450C-49257C49.001783F7_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-22 00:44:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23283.php">Javier Garcia Blas: "[OMPI users] Call for Workshops: EuroMPI/ASIA 2014"</a>
<li><strong>Previous message:</strong> <a href="23281.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours	based 32	core node"</a>
<li><strong>In reply to:</strong> <a href="23281.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours	based 32	core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23286.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our	magny cours	based 32	core node"</a>
<li><strong>Reply:</strong> <a href="23286.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our	magny cours	based 32	core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; Is there any possibility to build with external libevent automatically?
</span><br>
<p>No - only happens if you direct it
<br>
...
<span class="quotelev2">&gt;&gt; Not entirely sure - add &quot;-mca rmaps_base_verbose 10 --display-map&quot; to
</span><br>
<span class="quotelev1">&gt; your cmd line and let's see if it finishes the mapping.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Unless you specifically built with an external libevent (which I doubt),
</span><br>
<span class="quotelev1">&gt; there is no conflict. The connection issue is unlikely to be a factor here
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [rhc_at_bend001 tcp]$ mpirun -np 2 -host bend001 -report-bindings -mca
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; (I also checked the internals using &quot;-mca rmaps_base_verbose 10&quot;) so
</span><br>
<span class="quotelev1">&gt; it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; could be your hier inversion causing problems again. Or it could be
</span><br>
<span class="quotelev1">&gt; that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; you are hitting a connection issue we are seeing in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; some scenarios in the OOB subsystem - though if you are able to run
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; But every try failed. At least they were accepted by openmpi-1.7.3 as
</span><br>
<span class="quotelev1">&gt; far
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; as I remember.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Anyway, please check it when you have a time, because using lama comes
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'll try to take a look at it - my expectation is that lama might get
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; stuck because you didn't tell it a pattern to map, and I doubt that
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; By the way, yesterday I tried to check how lama in 1.7.4rc treat numa
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'll make it work so that NUMA can be either above or below socket
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; My opinion was made just considering easy way to adjust the code for
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Also, all these NUMA architectures are reported the same by hwloc,
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [mishima_at_manage ~]$ qsub -I -l nodes=1:ppn=32&gt;&gt; qsub: waiting for job
</span><br>
