...
?>
<!-- received="Fri Dec 20 22:37:32 2013" -->
<!-- isoreceived="20131221033732" -->
<!-- sent="Fri, 20 Dec 2013 19:37:06 -0800" -->
<!-- isosent="20131221033706" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node" -->
<!-- id="7579A5E7-67A3-43BD-AB70-8D668EC45DC6_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="OF3CD8B6A2.ADC6ABA8-ON49257C48.0009033B-49257C48.000A5DB5_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-20 22:37:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23276.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>Previous message:</strong> <a href="23274.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>In reply to:</strong> <a href="23274.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23276.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>Reply:</strong> <a href="23276.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Dec 20, 2013, at 5:52 PM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; By the way, yesterday I tried to check how lama in 1.7.4rc treat numa node.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Then, even wiht this simple command line, it freezed without any massage:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; My opinion was made just considering easy way to adjust the code for
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Also, all these NUMA architectures are reported the same by hwloc, and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; therefore used the same in Open MPI.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; And yes, L3 and NUMA are topologically-identical on AMD Magny-Cours
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; One side note: you'll need to add --hetero-nodes to your cmd line.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'll try to resolve the hier inversion over the holiday - won't be
</span><br>
