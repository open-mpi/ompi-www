...
?>
<!-- received="Wed Dec 25 22:28:06 2013" -->
<!-- isoreceived="20131226032806" -->
<!-- sent="Wed, 25 Dec 2013 19:27:05 -0800" -->
<!-- isosent="20131226032705" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to	numa&amp;quot;	of	openmpi-1.7.4rc1	dosen't	work	for	our	magny	cours	based 32	core node" -->
<!-- id="25EE6D3C-852A-471E-9896-FB4A68E5396C_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="OFA84BD8AE.4C4FFC24-ON49257C4C.0081C819-49257C4C.00823E35_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-25 22:27:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23294.php">Shamis, Pavel: "Re: [OMPI users] [EXTERNAL] Re: Configuration for rendezvous and eager protocols: two-sided comm"</a>
<li><strong>Previous message:</strong> <a href="23292.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for	our	magny	cours	based 32	core node"</a>
<li><strong>In reply to:</strong> <a href="23292.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for	our	magny	cours	based 32	core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/01/23331.php">tmishima_at_[hidden]: "[OMPI users] btl_tcp_use_nagle is negated in openmpi-1.7.4rc1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph
<br>
<p><p>On Dec 25, 2013, at 3:42 PM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; Thank you for your reply. After that, I found more reasonable fix,
</span><br>
<span class="quotelev1">&gt; I guess. I moved OBJ_CONSTRUCT for opal_tree_item_t out of debug
</span><br>
<span class="quotelev1">&gt; part in opal_tree_construct as shown below:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; static void opal_tree_construct(opal_tree_t *tree)
</span><br>
<span class="quotelev1">&gt; {
</span><br>
<span class="quotelev1">&gt;    OBJ_CONSTRUCT( &amp;(tree-&gt;opal_tree_sentinel), opal_tree_item_t ); /*
</span><br>
<span class="quotelev1">&gt; tmishima */
</span><br>
<span class="quotelev1">&gt; #if OPAL_ENABLE_DEBUG
</span><br>
<span class="quotelev1">&gt;    /* These refcounts should never be used in assertions because they
</span><br>
<span class="quotelev1">&gt;       should never be removed from this list, added to another list,
</span><br>
<span class="quotelev1">&gt;       etc.  So set them to sentinel values. */
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_sentinel.opal_tree_item_refcount  = 1;
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_sentinel.opal_tree_item_belong_to = tree;
</span><br>
<span class="quotelev1">&gt; #endif
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_sentinel.opal_tree_container = tree;
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_sentinel.opal_tree_parent = &amp;tree-&gt;opal_tree_sentinel;
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_sentinel.opal_tree_num_ancestors = -1;
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_sentinel.opal_tree_next_sibling =
</span><br>
<span class="quotelev1">&gt;        &amp;tree-&gt;opal_tree_sentinel;
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_sentinel.opal_tree_prev_sibling =
</span><br>
<span class="quotelev1">&gt;        &amp;tree-&gt;opal_tree_sentinel;
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_sentinel.opal_tree_first_child = &amp;tree-&gt;
</span><br>
<span class="quotelev1">&gt; opal_tree_sentinel;
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_sentinel.opal_tree_last_child = &amp;tree-&gt;
</span><br>
<span class="quotelev1">&gt; opal_tree_sentinel;
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;    tree-&gt;opal_tree_num_items = 0;
</span><br>
<span class="quotelev1">&gt;    tree-&gt;comp = NULL;
</span><br>
<span class="quotelev1">&gt;    tree-&gt;serialize = NULL;
</span><br>
<span class="quotelev1">&gt;    tree-&gt;deserialize = NULL;
</span><br>
<span class="quotelev1">&gt;    tree-&gt;get_key = NULL;
</span><br>
<span class="quotelev1">&gt; }
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; In addtion, I checked how lama worked for the hierarchy inversion.
</span><br>
<span class="quotelev1">&gt; Then, it did not work on node04 which has the inversion and worked on
</span><br>
<span class="quotelev1">&gt; node09 which has normal one. Please foward this information to lama
</span><br>
<span class="quotelev1">&gt; developers.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Regerds,
</span><br>
<span class="quotelev1">&gt; Tetsuya Mishima
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; qsub: job 8380.manage.cluster completed
</span><br>
<span class="quotelev1">&gt; [mishima_at_manage openmpi-1.7.4rc2r30069]$ qsub -I -l nodes=4:ppn=8
</span><br>
<span class="quotelev1">&gt; qsub: waiting for job 8381.manage.cluster to start
</span><br>
<span class="quotelev1">&gt; qsub: job 8381.manage.cluster ready
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [mishima_at_node09 ~]$ cd ~/Desktop/openmpi-1.7/demos/
</span><br>
<span class="quotelev1">&gt; [mishima_at_node09 demos]$ mpirun -np 2 -report-bindings -mca rmaps lama -mca
</span><br>
<span class="quotelev1">&gt; rmaps_lama_bind 1N -mca rmaps_lama_map Ncsbnh
</span><br>
<span class="quotelev1">&gt; myprog
</span><br>
<span class="quotelev1">&gt; [node09.cluster:20144] MCW rank 0 bound to socket 0[core 0[hwt 0]], socket
</span><br>
<span class="quotelev1">&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
</span><br>
<span class="quotelev1">&gt; cket 0[core 3[hwt 0]]: [B/B/B/B][./././.]
</span><br>
<span class="quotelev1">&gt; [node09.cluster:20144] MCW rank 1 bound to socket 1[core 4[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [mishima_at_node09 demos]$
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; qsub: job 8383.manage.cluster completed
</span><br>
<span class="quotelev1">&gt; [mishima_at_manage openmpi-1.7.4rc2r30069]$ qsub -I -l nodes=1:ppn=32
</span><br>
<span class="quotelev1">&gt; qsub: waiting for job 8384.manage.cluster to start
</span><br>
<span class="quotelev1">&gt; qsub: job 8384.manage.cluster ready
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [mishima_at_node04 ~]$ cd ~/Desktop/openmpi-1.7/demos/
</span><br>
<span class="quotelev1">&gt; [mishima_at_node04 demos]$ mpirun -np 2 -report-bindings -mca rmaps lama -mca
</span><br>
<span class="quotelev1">&gt; rmaps_lama_bind 1N -mca rmaps_lama_map Ncsbnh
</span><br>
<span class="quotelev1">&gt; myprog
...
<span class="quotelev1">&gt; RMaps LAMA detected that there are not enough resources to map the
</span><br>
<span class="quotelev1">&gt; remainder of the job. Check the command line options, and the number of
</span><br>
<span class="quotelev1">&gt; nodes allocated to this job.
</span><br>
<span class="quotelev1">&gt; Application Context : 0
</span><br>
<span class="quotelev1">&gt; # of Processes Successfully Mapped: 0
</span><br>
<span class="quotelev1">&gt; # of Processes Requested          : 2
</span><br>
<span class="quotelev1">&gt; Mapping  : Ncsbnh
</span><br>
<span class="quotelev1">&gt; Binding  : 1N
</span><br>
<span class="quotelev1">&gt; MPPR     : [Not Provided]
</span><br>
<span class="quotelev1">&gt; Ordering : s
</span><br>
<span class="quotelev1">&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev1">&gt; [node04.cluster:20298] [[21003,0],0] ORTE_ERROR_LOG: Error in file
</span><br>
<span class="quotelev1">&gt; rmaps_lama_module.c at line 309
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [node04.cluster:20298] [[21003,0],0] ORTE_ERROR_LOG: Error in file
</span><br>
<span class="quotelev1">&gt; base/rmaps_base_map_job.c at line 217
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Deeply appreciate all you help! Your fix looks reasonable to me and is
</span><br>
<span class="quotelev1">&gt; the kind of difference we frequently see between compilers and
</span><br>
<span class="quotelev1">&gt; environments, which is why initializing variables is so
</span><br>
<span class="quotelev2">&gt;&gt; important. This one apparently slipped by the lama developers.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I'll apply to trunk and cmr it across to 1.7.4.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Dec 25, 2013, at 3:39 AM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I did valgrind and found uninitialised value errors. All of them
</span><br>
<span class="quotelev3">&gt;&gt;&gt; occured in opal_tree_add_child as shown at the bottom. As a quick
</span><br>
<span class="quotelev3">&gt;&gt;&gt; fix, I puted one line in &quot;opal_tree.c&quot;, although it's not elegant:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; void opal_tree_init(opal_tree_t *tree, opal_tree_comp_fn_t comp,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                   opal_tree_item_serialize_fn_t serialize,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                   opal_tree_item_deserialize_fn_t deserialize,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                   opal_tree_get_key_fn_t get_key)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   tree-&gt;comp = comp;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   tree-&gt;serialize = serialize;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   tree-&gt;deserialize = deserialize;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   tree-&gt;get_key = get_key;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   opal_tree_get_root(tree)-&gt;opal_tree_num_children = 0 ; /* added by
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Then, these errors all disappeared and openmpi with lama worked fine.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; As I told you before, I built openmpi with PGI 13.10. As far as I
</span><br>
<span class="quotelev3">&gt;&gt;&gt; checked, no error was detected by valgrind with openmpi built by
</span><br>
<span class="quotelev3">&gt;&gt;&gt; GNU compiler. Therefore, it might depend on compiler...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Anyway, I would like to ask you (or openmpi team) to continue
</span><br>
<span class="quotelev3">&gt;&gt;&gt; further investigation.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; valgrind -v --error-limit=no --leak-check=yes --show-reachable=no
</span><br>
<span class="quotelev1">&gt; mpirun
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -np 1 -mca rmaps lama -report-bindings -mca rmaps_base_verbose 100
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --display-map ~/Desktop/openmpi-1.7/demos/myprog 2&gt;&amp;1 | tee
</span><br>
<span class="quotelev1">&gt; valgrind.log
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ....
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313== Conditional jump or move depends on uninitialised value(s)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    at 0x4EC52A4: opal_tree_add_child (opal_tree.c:191)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E3314: rmaps_lama_convert_hwloc_subtree
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (rmaps_lama_max_tree.c:320)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E321D: rmaps_lama_convert_hwloc_tree_to_opal_tree
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (rmaps_lama_max_tree.c:267)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E2EE8: rmaps_lama_build_max_tree
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (rmaps_lama_max_tree.c:154)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E0E58: orte_rmaps_lama_map_core
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (rmaps_lama_module.c:664)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E02D7: orte_rmaps_lama_map
</span><br>
<span class="quotelev1">&gt; (rmaps_lama_module.c:303)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x4C6468B: orte_rmaps_base_map_job
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (rmaps_base_map_job.c:204)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x4F094CC: event_process_active_single_queue
</span><br>
<span class="quotelev1">&gt; (event.c:1366)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x4F090D8: event_process_active (event.c:1434)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x4F050FF: opal_libevent2021_event_base_loop
</span><br>
<span class="quotelev1">&gt; (event.c:1645)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x4079A6: orterun (orterun.c:1049)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x40694A: main (main.c:13)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; .....
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313== Conditional jump or move depends on uninitialised value(s)
...
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x4EC5D0E: deserialize_add_tree_item (opal_tree.c:496)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x4EC5578: opal_tree_deserialize (opal_tree.c:524)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x4EC5609: opal_tree_dup (opal_tree.c:544)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E2FF6: rmaps_lama_build_max_tree
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (rmaps_lama_max_tree.c:202)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E0E58: orte_rmaps_lama_map_core
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (rmaps_lama_module.c:664)
...
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E2FF6: ???
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E0E58: ???
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E02D7: ???
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x4C6468B: orte_rmaps_base_map_job
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (rmaps_base_map_job.c:204)
...
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E3314: ???
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E321D: ???
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E2EE8: ???
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E0E58: ???
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ==27313==    by 0x81E02D7: ???
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Here is the output when I put &quot;-mca rmaps_base_verbose 10
</span><br>
<span class="quotelev1">&gt; --display-map&quot;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; and where it stopped(by gdb), which shows it stopped in a function of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lama.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I usually use PGI 13.10, so I tried to change it to gnu compiler.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Then, it works. Therefore, this problem depends on compiler.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; That's all what I could find today.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [mishima_at_manage ~]$ gdb
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; GNU gdb (GDB) CentOS (7.0.1-42.el5.centos.1)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ....
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (gdb) attach 14666
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ....
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 0x00002aaaab4c5c33 in rmaps_lama_prune_max_tree ()
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; at ./rmaps_lama_max_tree.c:814
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [mishima_at_manage demos]$ mpirun -np 2 -mca rmaps lama -report-bindings
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -mca
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; rmaps_base_verbose 10 --display-map myprog
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca: base: components_register: registering
</span><br>
<span class="quotelev1">&gt; rmaps
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; components
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca: base: components_register: found loaded
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; component lama
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: Priority   0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: Map   : NULL
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: Bind  : NULL
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: MPPR  : NULL
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: Order : NULL
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca: base: components_register: component lama
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; register function successful
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca: base: components_open: opening rmaps
</span><br>
<span class="quotelev3">&gt;&gt;&gt; components
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca: base: components_open: found loaded
</span><br>
<span class="quotelev1">&gt; component
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; lama
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:select: checking available component
</span><br>
<span class="quotelev3">&gt;&gt;&gt; lama
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:select: Querying component [lama]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] [[23940,0],0]: Final mapper priorities
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503]  Mapper: lama Priority: 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps: mapping job [23940,1]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps: creating new map for job [23940,1]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps: nprocs 2
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: Mapping job [23940,1]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: Revised Parameters -----
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: Map   : csbnh
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: Bind  : 1c
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: MPPR  : (null)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: Order : s
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama:
</span><br>
<span class="quotelev1">&gt; ---------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Binding  : [1c]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Binding  :    1 x
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : [csbnh]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (0)       Core
</span><br>
<span class="quotelev1">&gt; (7
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; vs 0)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (1)     Socket
</span><br>
<span class="quotelev1">&gt; (3
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; vs 1)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (2)      Board
</span><br>
<span class="quotelev1">&gt; (1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; vs 3)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (3)    Machine
</span><br>
<span class="quotelev1">&gt; (0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; vs 7)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (4) Hw. Thread
</span><br>
<span class="quotelev1">&gt; (8
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; vs 8)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama:
</span><br>
<span class="quotelev1">&gt; ---------------------------------
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Ordering : [s]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Ordering : Sequential
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama:
</span><br>
<span class="quotelev1">&gt; ---------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] AVAILABLE NODES FOR MAPPING:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503]     node: manage daemon: 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama:
</span><br>
<span class="quotelev1">&gt; ---------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Building the Max Tree...
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama:
</span><br>
<span class="quotelev1">&gt; ---------------------------------
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Converting Remote Tree:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; manage
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [mishima_at_manage demos]$ ompi_info | grep &quot;C compiler family&quot;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; C compiler family name: GNU
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [mishima_at_manage demos]$ mpirun -np 2 -mca rmaps lama myprog
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Dec 21, 2013, at 8:16 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Is there any possibility to build with external libevent
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Not entirely sure - add &quot;-mca rmaps_base_verbose 10 --display-map&quot;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; doubt),
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; there is no conflict. The connection issue is unlikely to be a
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [rhc_at_bend001 tcp]$ mpirun -np 2 -host bend001 -report-bindings
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -mca
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; (I also checked the internals using &quot;-mca rmaps_base_verbose 10&quot;)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; so
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; could be your hier inversion causing problems again. Or it could
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; some scenarios in the OOB subsystem - though if you are able to
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; But every try failed. At least they were accepted by
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; stuck because you didn't tell it a pattern to map, and I doubt
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'll make it work so that NUMA can be either above or below
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; My opinion was made just considering easy way to adjust the code
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Also, all these NUMA architectures are reported the same by
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; And yes, L3 and NUMA are topologically-identical on AMD
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Magny-Cours
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; (and
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; coherent)NUMA,&gt;&gt;&gt;&gt;&gt;&gt;&gt; which seems to be a little bit different
</span><br>
<span class="quotelev1">&gt; from the traditional numa
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; So &quot;-bind-to l3cache&quot; or &quot;-map-by l3cache&quot; is valid for what I
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; NUMANode&gt; &gt;&gt;&gt;&gt; type
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Cache
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Hello world from process 0 of 8&gt;&gt;&gt;&gt;&gt;&gt;&gt; [mishima_at_node03 demos]$
</span><br>
<span class="quotelev1">&gt; ~/opt/hwloc/bin/lstopo-no-graphics
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; L2 L#3 (512K
</span><br>
<span class="quotelev1">&gt; B) + L1d L#3 (64KB) + L1i L#3 (64KB) + Core L#3
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; +
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; PU
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; _______________________________
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ________________
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; users mailing list
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; users_at_[hidden]
