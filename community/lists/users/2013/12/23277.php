...
?>
<!-- received="Sat Dec 21 11:32:07 2013" -->
<!-- isoreceived="20131221163207" -->
<!-- sent="Sat, 21 Dec 2013 08:31:36 -0800" -->
<!-- isosent="20131221163136" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node" -->
<!-- id="08E8507F-DE82-46FD-9D86-2253BA8D8B77_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="OF68199873.98C480C8-ON49257C48.0015726D-49257C48.0016D5A2_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-21 11:31:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23278.php">Filippo Spiga: "[OMPI users] Clarification about dual-rail capabilities (sharing)"</a>
<li><strong>Previous message:</strong> <a href="23276.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>In reply to:</strong> <a href="23276.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23279.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32	core node"</a>
<li><strong>Reply:</strong> <a href="23279.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32	core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>[rhc_at_bend001 tcp]$ mpirun -np 2 -host bend001 -report-bindings -mca rmaps_lama_bind 1c -mca rmaps lama hostname
<br>
bend001
<br>
...
<span class="quotelev1">&gt; Anyway, please check it when you have a time, because using lama comes from
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23277/attachment">attachment</a>
</ul>
