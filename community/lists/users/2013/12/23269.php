...
?>
<!-- received="Fri Dec 20 05:57:25 2013" -->
<!-- isoreceived="20131220105725" -->
<!-- sent="Fri, 20 Dec 2013 19:57:12 +0900" -->
<!-- isosent="20131220105712" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node" -->
<!-- id="OF16AE8465.96EF7EA6-ON49257C47.003AE319-49257C47.003C313F_at_jcity.maeda.co.jp" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="52B41DC0.5000602_at_inria.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:tmishima_at_[hidden]?Subject=Re:%20[OMPI%20users]%20&amp;amp;quot;-bind-to%20numa&amp;amp;quot;%20of%20openmpi-1.7.4rc1	dosen't	work%20for%20our%20magny%20cours%20based%2032%20core%20node"><em>tmishima_at_[hidden]</em></a><br>
<strong>Date:</strong> 2013-12-20 05:57:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23270.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<li><strong>Previous message:</strong> <a href="23268.php">Brice Goglin: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<li><strong>In reply to:</strong> <a href="23268.php">Brice Goglin: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23270.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<li><strong>Reply:</strong> <a href="23270.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Brice,
<br>
<p>Thank you for your comment. I understand what you mean.
<br>
<p>My opinion was made just considering easy way to adjust the code for
<br>
inversion of hierarchy in object tree.
<br>
<p>Tetsuya Mishima
<br>
<p><p><span class="quotelev1">&gt; I don't think there's any such difference.
</span><br>
<span class="quotelev1">&gt; Also, all these NUMA architectures are reported the same by hwloc, and
</span><br>
<span class="quotelev1">&gt; therefore used the same in Open MPI.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; And yes, L3 and NUMA are topologically-identical on AMD Magny-Cours (and
</span><br>
...
<span class="quotelev2">&gt; &gt; So &quot;-bind-to l3cache&quot; or &quot;-map-by l3cache&quot; is valid for what I want to
</span><br>
do.
<br>
...
<span class="quotelev3">&gt; &gt;&gt; I can wait it'll be fixed in 1.7.5 or later, because putting &quot;-bind-to
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; One side note: you'll need to add --hetero-nodes to your cmd line. If
</span><br>
<span class="quotelev2">&gt; &gt; we
</span><br>
<span class="quotelev3">&gt; &gt;&gt; don't see that, we assume that all the node topologies are identical -
</span><br>
<span class="quotelev3">&gt; &gt;&gt; which clearly isn't true here.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; I'll try to resolve the hier inversion over the holiday - won't be
</span><br>
for
<br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; By the way, I think this inversion should affect rmaps_lama mapping.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; Ick - yeah, that would be a problem. I haven't seen that type of
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; hierarchical inversion before - is node03 a different type of chip?
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15508] mca:rmaps: bind upwards for job [38286,1]
</span><br>
<span class="quotelev2">&gt; &gt; with
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; bindings NUMA
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15508] [[38286,0],0] bind:upward target NUMANode
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; [mishima_at_node03 demos]$ mpirun -np 8 -bind-to numa -map-by core
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; -report-bindings myprog
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target NUMANode
</span><br>
<span class="quotelev2">&gt; &gt; type
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15508] Type: Machine Number of child objects: 4
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; [node05.cluster:21750] Type: Machine Number of child objects: 2
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;       Name=NULL
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; On Dec 18, 2013, at 6:55 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [mishima_at_node03 demos]$ mpirun -np 8 -report-bindings -bind-to
</span><br>
<span class="quotelev2">&gt; &gt; numa
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; myprog
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15316] [[37582,0],0] bind:upward target NUMANode
</span><br>
...
--------------------------------------------------------------------------
<br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; A request was made to bind to NUMA, but an appropriate target
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 2 bound to socket 1[core 8[hwt
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 3 bound to socket 1[core 9[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0]]:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./././././././.][./B/./././././.][./././././././.][
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 4 bound to socket 2[core 16[hwt
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 5 bound to socket 2[core 17[hwt
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 0]]:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./B/./././././.]
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 6 bound to socket 3[core 24[hwt
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 0]]:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 7 bound to socket 3[core 25[hwt
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 0]]:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 0 bound to socket 0[core 0[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0]]:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [B/././././././.][./././././././.][./././././././.][
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 1 bound to socket 0[core 1[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0]]:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./B/./././././.][./././././././.][./././././././.][
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; L#17 (P#17)&gt; &gt;&gt;&gt;&gt;&gt;    L2 L#18 (512KB) + L1d L#18 (64KB) + L1i
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; L#24 (P#24)&gt;&gt;&gt;&gt;&gt;    L2 L#25 (512KB) + L1d L#25 (64KB) + L1i L#25
</span><br>
