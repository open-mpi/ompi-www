...
?>
<!-- received="Thu Dec 12 13:19:09 2013" -->
<!-- isoreceived="20131212181909" -->
<!-- sent="Thu, 12 Dec 2013 18:19:07 +0000" -->
<!-- isosent="20131212181907" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] environment variables and MPI_Comm_spawn" -->
<!-- id="72F78641-1205-466C-B383-B8242A141A12_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2013-12-12 13:19:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23188.php">Jeff Squyres (jsquyres): "Re: [OMPI users] &#187;&#216;&#184;&#180;&#163;&#186; &#187;&#216;&#184;&#180;&#163;&#186; &#187;&#216;&#184;&#180;&#163;&#186; can you help me please ?thanks"</a>
<li><strong>Previous message:</strong> <a href="23186.php">Dave Love: "Re: [OMPI users] Prototypes for Fortran MPI_ commands using 64-bit	indexing"</a>
<li><strong>In reply to:</strong> <a href="23185.php">Ralph Castain: "Re: [OMPI users] environment variables and MPI_Comm_spawn"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23192.php">tom fogal: "Re: [OMPI users] environment variables and MPI_Comm_spawn"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Dec 12, 2013, at 9:47 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; It would have to be done via MPI_Info arguments, and we never had a request to do so (and hence, don't define such an argument). It would be easy enough to do so (look in the ompi/mca/dpm/orte/dpm_orte.c code).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; MPI implementations generally don't forcibly propagate envars because it is so hard to know which ones to handle - it is easy to propagate a system envar that causes bad things to happen on the remote end.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; One thing you could do, of course, is add that envar to your default shell setup (.bashrc or whatever). This would set the variable by default on your remote locations (assuming you are using rsh/ssh for your launcher), and then any process you start would get it. However, that won't help if this is an envar intended only for the comm_spawned process.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I can add this capability to the OMPI trunk, and port it to the 1.7 release - but we don't go all the way back to the 1.4 series any more.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
