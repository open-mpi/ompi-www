...
?>
<!-- received="Tue Dec  3 08:17:01 2013" -->
<!-- isoreceived="20131203131701" -->
<!-- sent="Tue, 3 Dec 2013 05:16:59 -0800" -->
<!-- isosent="20131203131659" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)" -->
<!-- id="CAMD57oetn8WUo16t21jgyMGc0UoZ+000PhKS62BA14N-vSYwFQ_at_mail.gmail.com" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="2ECD98E6-7425-4E9F-8829-B4F1BD7DBBDB_at_fmglobal.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-03 08:16:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23138.php">ºúÑî: "[OMPI users] &#187;&#216;&#184;&#180;&#163;&#186; &#187;&#216;&#184;&#180;&#163;&#186; can you help me please ?thanks"</a>
<li><strong>Previous message:</strong> <a href="23136.php">Ralph Castain: "Re: [OMPI users] Several questions about new Java bindings"</a>
<li><strong>In reply to:</strong> <a href="23135.php">Meredith, Karl: "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23141.php">Jeff Squyres (jsquyres): "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<li><strong>Reply:</strong> <a href="23141.php">Jeff Squyres (jsquyres): "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<li><strong>Reply:</strong> <a href="23146.php">Meredith, Karl: "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
capability.
<br>
<p>Meantime, you might want to talk to your IT folks and see if that is
<br>
correct and intentional - and if so, why.
<br>
<p><p><p>On Tue, Dec 3, 2013 at 5:04 AM, Meredith, Karl
<br>
&lt;karl.meredith_at_[hidden]&gt;wrote:
<br>
<p><span class="quotelev1">&gt; I disconnected for our corporate network (ethernet connection) and tried
</span><br>
...
<span class="quotelev1">&gt; &quot;eth0,192.168.0.0/16&lt;<a href="http://192.168.0.0/16">http://192.168.0.0/16</a>&gt;&quot;).  Mutually exclusive with
</span><br>
<span class="quotelev1">&gt; oob_tcp_if_exclude.
</span><br>
...
<span class="quotelev1">&gt; 192.168.0.0/16&lt;<a href="http://192.168.0.0/16">http://192.168.0.0/16</a>&gt;&quot;).  If set to a non-default value,
</span><br>
<span class="quotelev1">&gt; it is mutually exclusive with oob_tcp_if_include.
</span><br>
...
<span class="quotelev1">&gt; 192.168.0.0/16&lt;<a href="http://192.168.0.0/16">http://192.168.0.0/16</a>&gt;&quot;).  Mutually exclusive with
</span><br>
<span class="quotelev1">&gt; btl_tcp_if_exclude.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;                MCA btl: parameter &quot;btl_tcp_if_exclude&quot; (current value: &quot;
</span><br>
<span class="quotelev1">&gt; 127.0.0.1/8,sppp&lt;<a href="http://127.0.0.1/8,sppp">http://127.0.0.1/8,sppp</a>&gt;&quot;, data source: default, level:
</span><br>
<span class="quotelev1">&gt; 1 user/basic, type: string)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;                         Comma-delimited list of devices and/or CIDR
</span><br>
...
<span class="quotelev1">&gt; <a href="http://192.168.0.0/16">http://192.168.0.0/16</a>&gt;&quot;).  If set to a non-default value, it is mutually
</span><br>
<span class="quotelev1">&gt; exclusive with btl_tcp_if_include.
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23137/attachment">attachment</a>
</ul>
