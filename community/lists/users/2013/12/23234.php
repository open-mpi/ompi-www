...
?>
<!-- received="Wed Dec 18 19:04:46 2013" -->
<!-- isoreceived="20131219000446" -->
<!-- sent="Thu, 19 Dec 2013 09:04:30 +0900" -->
<!-- isosent="20131219000430" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi-1.7.4a1r29646	with	-hostfile	option	under	Torque manager" -->
<!-- id="OFDB5570BE.DB77D324-ON49257C45.0083980E-49257C46.00006EC1_at_jcity.maeda.co.jp" -->
<!-- charset="ISO-2022-JP" -->
...
<strong>Date:</strong> 2013-12-18 19:04:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23235.php">Jeff Squyres (jsquyres): "Re: [OMPI users] openmpi-1.7.4a1r29646	with	-hostfile	option	under	Torque manager"</a>
<li><strong>Previous message:</strong> <a href="23233.php">Blosch, Edwin L: "[OMPI users] What's the status of OpenMPI and thread safety?"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23235.php">Jeff Squyres (jsquyres): "Re: [OMPI users] openmpi-1.7.4a1r29646	with	-hostfile	option	under	Torque manager"</a>
<li><strong>Reply:</strong> <a href="23235.php">Jeff Squyres (jsquyres): "Re: [OMPI users] openmpi-1.7.4a1r29646	with	-hostfile	option	under	Torque manager"</a>
<li><strong>Reply:</strong> <a href="23236.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646	with	-hostfile	option	under	Torque manager"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>1) When I use 2 nodes(node11,node12), which has 8 cores each(= 2 sockets X
<br>
4 cores/socket),
<br>
...
work well.
<br>
<p>[mishima_at_manage ~]$ qsub -I -l nodes=2:ppn=8
<br>
qsub: waiting for job 8336.manage.cluster to start
<br>
qsub: job 8336.manage.cluster ready
<br>
<p>[mishima_at_node11 ~]$ cd ~/Desktop/openmpi-1.7/demos/
<br>
...
--------------------------------------------------------------------------
<br>
<p>Of course it works well using only one node.
<br>
<p>[mishima_at_node11 demos]$ mpirun -np 2 -cpus-per-proc 4 -report-bindings
<br>
myprog
<br>
...
<br>
<p><p>2) Adding &quot;-bind-to numa&quot;, it works but the message &quot;bind:upward target
<br>
NUMANode type NUMANode&quot; appears.
<br>
As far as I remember, I didn't see such a kind of message before.
<br>
<p>mishima_at_node11 demos]$ mpirun -np 4 -cpus-per-proc 4 -report-bindings
<br>
-bind-to numa myprog
<br>
...
<br>
<p><p>3) I use PGI compiler. It can not accept compiler switch
<br>
&quot;-Wno-variadic-macros&quot;, which is
<br>
included in configure script.
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;btl_usnic_CFLAGS=&quot;-Wno-variadic-macros&quot;
<br>
<p>I removed this switch, then I could continue to build 1.7.4rc1.
<br>
<p>Regards,
<br>
Tetsuya Mishima
