...
?>
<!-- received="Tue Dec 10 19:34:43 2013" -->
<!-- isoreceived="20131211003443" -->
<!-- sent="Tue, 10 Dec 2013 16:34:06 -0800" -->
<!-- isosent="20131211003406" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under	Torque manager" -->
<!-- id="1EE34E1E-33B5-43CE-A74C-53B35A4B4E85_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="OF3A131179.22CB2296-ON49257C3D.00809E29-49257C3D.00823B31_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-10 19:34:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23175.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option	under	Torque manager"</a>
<li><strong>Previous message:</strong> <a href="23173.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under	Torque manager"</a>
<li><strong>In reply to:</strong> <a href="23173.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under	Torque manager"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23175.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option	under	Torque manager"</a>
<li><strong>Reply:</strong> <a href="23175.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option	under	Torque manager"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Dec 10, 2013, at 3:42 PM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; It stopped the error but unfortunately &quot;mapping by socket&quot; itself didn't
</span><br>
...
<span class="quotelev1">&gt; [mishima_at_node04 demos]$ mpirun -np 8 -report-bindings -cpus-per-proc 4
</span><br>
<span class="quotelev1">&gt; -map-by socket myprog
</span><br>
<span class="quotelev1">&gt; [node04.cluster:27489] MCW rank 2 bound to socket 1[core 8[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [node04.cluster:27489] MCW rank 3 bound to socket 1[core 12[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [node04.cluster:27489] MCW rank 4 bound to socket 2[core 16[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [node04.cluster:27489] MCW rank 5 bound to socket 2[core 20[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [node04.cluster:27489] MCW rank 6 bound to socket 3[core 24[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [node04.cluster:27489] MCW rank 7 bound to socket 3[core 28[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [node04.cluster:27489] MCW rank 0 bound to socket 0[core 0[hwt 0]], socket
</span><br>
...
<span class="quotelev1">&gt; [node04.cluster:27489] MCW rank 1 bound to socket 0[core 4[hwt 0]], socket
</span><br>
...
<span class="quotelev2">&gt;&gt; I fixed this under the trunk (was an issue regardless of RM) and have
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; The problem is cpus-per-proc with -map-by option under Torque manager.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [mishima_at_node03 testbed2]$ mpirun -np 8 -report-bindings -cpus-per-proc
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:18128] MCW rank 3 bound to socket 1[core 12[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:18128] MCW rank 4 bound to socket 2[core 16[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:18128] MCW rank 5 bound to socket 2[core 20[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:18128] MCW rank 6 bound to socket 3[core 24[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:18128] MCW rank 7 bound to socket 3[core 28[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Nov 17, 2013, at 6:11 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Thanks! That's precisely where I was going to look when I had time :-)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sun, Nov 17, 2013 at 7:01 PM,  &lt;tmishima_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; This is the continuous story of &quot;Segmentation fault in oob_tcp.c of
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I modified my script file to add &quot;slots=1&quot; to each line of my hostfile
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; random guess. It's related to the treatment of hostfile where slots
</span><br>
