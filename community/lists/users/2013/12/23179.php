...
?>
<!-- received="Tue Dec 10 21:58:11 2013" -->
<!-- isoreceived="20131211025811" -->
<!-- sent="Wed, 11 Dec 2013 11:58:06 +0900" -->
<!-- isosent="20131211025806" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi-1.7.4a1r29646 with	-hostfile	option	under	Torque manager" -->
<!-- id="OF20EA18A4.AEC78D5C-ON49257C3E.000EDB9B-49257C3E.001050B3_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="394E03D2-CF3F-4391-A646-8DCC9E321831_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:tmishima_at_[hidden]?Subject=Re:%20[OMPI%20users]%20openmpi-1.7.4a1r29646%20with	-hostfile	option	under	Torque%20manager"><em>tmishima_at_[hidden]</em></a><br>
<strong>Date:</strong> 2013-12-10 21:58:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23180.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with	-hostfile	option	under	Torque manager"</a>
<li><strong>Previous message:</strong> <a href="23178.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile	option	under	Torque manager"</a>
<li><strong>In reply to:</strong> <a href="23178.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile	option	under	Torque manager"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23180.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with	-hostfile	option	under	Torque manager"</a>
<li><strong>Reply:</strong> <a href="23180.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with	-hostfile	option	under	Torque manager"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
--------------------------------------------------------------------------
<br>
<p>It' strange, but I have to report that &quot;-map-by socket:span&quot; worked well.
<br>
<p>[mishima_at_node03 demos]$ mpirun -np 8 -host node03 -report-bindings
<br>
...
Tetsuya Mishima
<br>
<p><p><span class="quotelev1">&gt; On Dec 10, 2013, at 6:05 PM, tmishima_at_[hidden] wrote:
</span><br>
...
<span class="quotelev2">&gt; &gt; [mishima_at_node03 demos]$ mpirun -np 8 -report-bindings -cpus-per-proc 2
</span><br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:10879] MCW rank 3 bound to socket 1[core 10[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:10879] MCW rank 4 bound to socket 2[core 16[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:10879] MCW rank 5 bound to socket 2[core 18[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:10879] MCW rank 6 bound to socket 3[core 24[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:10879] MCW rank 7 bound to socket 3[core 26[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:10921] MCW rank 5 bound to socket 1[core 10[hwt 0]],
</span><br>
socket
<br>
<span class="quotelev2">&gt; &gt; 1[core 11[hwt 0]]: [./././././././.][././B/B
...
<span class="quotelev2">&gt; &gt; [node03.cluster:10921] MCW rank 6 bound to socket 1[core 12[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:10921] MCW rank 7 bound to socket 1[core 14[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; In this case, I guess &quot;-map-by socket:span&quot; and &quot;-map-by socket&quot; has
</span><br>
same
<br>
...
<span class="quotelev1">&gt; I don't understand the difference here - you are simply starting it from
</span><br>
...
<span class="quotelev1">&gt; If you run this with &quot;-host node03&quot; on the cmd line, do you see the same
</span><br>
problem?
<br>
<span class="quotelev1">&gt;
...
<span class="quotelev2">&gt; &gt; [node03.cluster:11036] MCW rank 3 bound to socket 1[core 12[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:11036] MCW rank 4 bound to socket 2[core 16[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:11036] MCW rank 5 bound to socket 2[core 20[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:11036] MCW rank 6 bound to socket 3[core 24[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node03.cluster:11036] MCW rank 7 bound to socket 3[core 28[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev3">&gt; &gt;&gt; Hmmm...that's strange. I only have 2 sockets on my system, but let me
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:10262] MCW rank 2 bound to socket 1[core 8[hwt 0]],
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:10262] MCW rank 3 bound to socket 1[core 12[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:10262] MCW rank 4 bound to socket 2[core 16[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:10262] MCW rank 5 bound to socket 2[core 20[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:10262] MCW rank 6 bound to socket 3[core 24[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:10262] MCW rank 7 bound to socket 3[core 28[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:10262] MCW rank 0 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:10262] MCW rank 1 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; No, that is actually correct. We map a socket until full, then move
</span><br>
to
<br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; It stopped the error but unfortunately &quot;mapping by socket&quot; itself
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [node04.cluster:27489] MCW rank 2 bound to socket 1[core 8[hwt 0]],
</span><br>
...
[./././././././.][./././././././.][./././././././.][././././B/B/B/B]
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [node04.cluster:27489] MCW rank 0 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; socket
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
[B/B/B/B/./././.][./././././././.][./././././././.][./././././././.]
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; [node04.cluster:27489] MCW rank 1 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; socket
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; I fixed this under the trunk (was an issue regardless of RM) and
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; It's not so serious. Please check it when you have a lot of time.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:18128] MCW rank 2 bound to socket 1[core 8[hwt
</span><br>
0]],
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; socket
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:18128] MCW rank 3 bound to socket 1[core 12[hwt
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:18128] MCW rank 4 bound to socket 2[core 16[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0]],
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; socket
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:18128] MCW rank 5 bound to socket 2[core 20[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0]],
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; socket
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:18128] MCW rank 6 bound to socket 3[core 24[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0]],
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; socket
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:18128] MCW rank 7 bound to socket 3[core 28[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0]],
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; socket
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:18128] MCW rank 0 bound to socket 0[core 0[hwt
</span><br>
0]],
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; socket
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:18128] MCW rank 1 bound to socket 0[core 4[hwt
</span><br>
0]],
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; socket
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Nov 17, 2013, at 6:11 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt; &gt; wrote:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Thanks! That's precisely where I was going to look when I had
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; This is the continuous story of &quot;Segmentation fault in oob_tcp.c
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I modified my script file to add &quot;slots=1&quot; to each line of my
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; random guess. It's related to the treatment of hostfile where
</span><br>
