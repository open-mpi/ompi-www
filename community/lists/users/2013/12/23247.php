...
?>
<!-- received="Thu Dec 19 01:54:35 2013" -->
<!-- isoreceived="20131219065435" -->
<!-- sent="Wed, 18 Dec 2013 22:54:21 -0800" -->
<!-- isosent="20131219065421" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of openmpi-1.7.4rc1 dosen't	work	for our magny cours based 32 core node" -->
<!-- id="49C60548-16E3-46D8-AB3E-91EB24A09AFD_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="OF5E366F96.4F30B5FA-ON49257C46.001E2A53-49257C46.001F963B_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-19 01:54:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23248.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>Previous message:</strong> <a href="23246.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>In reply to:</strong> <a href="23246.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't	work	for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23248.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>Reply:</strong> <a href="23248.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>One side note: you'll need to add --hetero-nodes to your cmd line. If we don't see that, we assume that all the node topologies are identical - which clearly isn't true here.
<br>
<p>I'll try to resolve the hier inversion over the holiday - won't be for 1.7.4, but hopefully for 1.7.5
<br>
<p>Thanks
<br>
Ralph
<br>
<p>On Dec 18, 2013, at 9:44 PM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15508] mca:rmaps: compute bindings for job [38286,1]
</span><br>
<span class="quotelev1">&gt; with
</span><br>
<span class="quotelev3">&gt;&gt;&gt; policy NUMA
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15508] mca:rmaps: bind upwards for job [38286,1] with
</span><br>
<span class="quotelev3">&gt;&gt;&gt; bindings NUMA
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15508] [[38286,0],0] bind:upward target NUMANode type
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Machine
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; That's the reason of this trouble. Therefore, adding &quot;-map-by core&quot;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target NUMANode type
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15885] MCW rank 2 bound to socket 0[core 0[hwt 0]],
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15885] MCW rank 3 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15885] MCW rank 4 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15885] MCW rank 5 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15885] MCW rank 6 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15885] MCW rank 7 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0[core 5[hwt 0]], socket 0[core 6[hwt 0]], so
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15885] MCW rank 0 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
<span class="quotelev3">&gt;&gt;&gt; [node03.cluster:15885] MCW rank 1 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev1">&gt; socket
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Hmm...try adding &quot;-mca rmaps_base_verbose 10 -mca ess_base_verbose 5&quot;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [mishima_at_node03 demos]$ mpirun -np 8 -report-bindings -bind-to numa
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; A request was made to bind to NUMA, but an appropriate target could
</span><br>
