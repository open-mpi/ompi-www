...
?>
<!-- received="Thu Dec 19 00:05:42 2013" -->
<!-- isoreceived="20131219050542" -->
<!-- sent="Thu, 19 Dec 2013 14:05:25 +0900" -->
<!-- isosent="20131219050525" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of openmpi-1.7.4rc1 dosen't work	for our magny cours based 32 core node" -->
<!-- id="OFC0FC1F77.55CBBE2E-ON49257C46.001897E6-49257C46.001BFB63_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2013-12-19 00:05:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23245.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't work	for our magny cours based 32 core node"</a>
<li><strong>Previous message:</strong> <a href="23243.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't work	for our magny cours based 32 core node"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23245.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't work	for our magny cours based 32 core node"</a>
<li><strong>Reply:</strong> <a href="23245.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1 dosen't work	for our magny cours based 32 core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>I found the reason. I attached the main part of output with 32
<br>
core node(node03) and 8 core node(node05) at the bottom.
<br>
<p><span class="quotelev1">&gt;From this information, socket of node03 includes numa-node.
</span><br>
On the other hand, numa-node of node05 includes socket.
<br>
The direction of object tree is opposite.
<br>
<p>Since &quot;-map-by socket&quot; may be assumed as default,
<br>
for node05, &quot;-bind-to numa and -map-by socket&quot; means
<br>
upward search. For node03, this should be downward.
<br>
<p>I guess that openmpi-1.7.4rc1 will always assume numa-node
<br>
...
<br>
<p>[node03.cluster:15508] [[38286,0],0] rmaps:base:compute_usage
<br>
...
Machine
<br>
<p>That's the reason of this trouble. Therefore, adding &quot;-map-by core&quot; works.
<br>
(mapping pattern seems to be strange ...)
<br>
<p>[mishima_at_node03 demos]$ mpirun -np 8 -bind-to numa -map-by core
<br>
...
[././././B/B/B/B][./././././././.][./././././././.][./././././././.]
<br>
[node03.cluster:15885] MCW rank 0 bound to socket 0[core 0[hwt 0]], socket
<br>
0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
<br>
cket 0[core 3[hwt 0]]:
...
[B/B/B/B/./././.][./././././././.][./././././././.][./././././././.]
<br>
[node03.cluster:15885] MCW rank 1 bound to socket 0[core 0[hwt 0]], socket
<br>
0[core 1[hwt 0]], socket 0[core 2[hwt 0]], so
<br>
cket 0[core 3[hwt 0]]:
...
Tetsuya Mishima
<br>
<p>[node03.cluster:15508] Type: Machine Number of child objects: 4
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name=NULL
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;total=132358820KB
...
<br>
<p><p>[node05.cluster:21750] Type: Machine Number of child objects: 2
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Name=NULL
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;total=33080072KB
...
<br>
<p><p><span class="quotelev1">&gt; Hmm...try adding &quot;-mca rmaps_base_verbose 10 -mca ess_base_verbose 5&quot; to
</span><br>
