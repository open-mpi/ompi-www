...
?>
<!-- received="Sat Dec 21 18:43:49 2013" -->
<!-- isoreceived="20131221234349" -->
<!-- sent="Sun, 22 Dec 2013 08:43:32 +0900" -->
<!-- isosent="20131221234332" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32	core node" -->
<!-- id="OFF41FA9A4.4A61338A-ON49257C48.007E7839-49257C48.00825B77_at_jcity.maeda.co.jp" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="08E8507F-DE82-46FD-9D86-2253BA8D8B77_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:tmishima_at_[hidden]?Subject=Re:%20[OMPI%20users]%20&amp;amp;quot;-bind-to%20numa&amp;amp;quot;	of	openmpi-1.7.4rc1	dosen't	work	for%20our%20magny%20cours%20based%2032	core%20node"><em>tmishima_at_[hidden]</em></a><br>
<strong>Date:</strong> 2013-12-21 18:43:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23280.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32	core node"</a>
<li><strong>Previous message:</strong> <a href="23278.php">Filippo Spiga: "[OMPI users] Clarification about dual-rail capabilities (sharing)"</a>
<li><strong>In reply to:</strong> <a href="23277.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23280.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32	core node"</a>
<li><strong>Reply:</strong> <a href="23280.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32	core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Thank you, Ralph.
<br>
<p>Then, this problem should depend on our environment.
<br>
But, at least, inversion problem is not the cause because
<br>
node05 has normal hier order.
<br>
<p>I can not connect to our cluster now. Tuesday, going
<br>
back to my office, I'll send you further report.
<br>
<p>Before that, please let me know your configuration. I will
<br>
...
(on CentOS 5.8)
<br>
<p>The 1.7 series is a llite bit unstable on our cluster yet.
<br>
<p>Similar freezing(hang up) was observed with 1.7.3. At that
<br>
...
recall the name).
<br>
<p>Is this related to your &quot;connection issue in the OOB
<br>
...
<br>
<p>Could you give me any hint or comment?
<br>
<p>Regards,
<br>
Tetsuya Mishima
<br>
<p><p><span class="quotelev1">&gt; It seems to be working fine for me:
</span><br>
...
<span class="quotelev1">&gt; (I also checked the internals using &quot;-mca rmaps_base_verbose 10&quot;) so it
</span><br>
...
<br>
<span class="quotelev1">&gt; some scenarios in the OOB subsystem - though if you are able to run using
</span><br>
...
<span class="quotelev1">&gt; But every try failed. At least they were accepted by openmpi-1.7.3 as far
</span><br>
<span class="quotelev1">&gt; as I remember.
</span><br>
<span class="quotelev1">&gt; Anyway, please check it when you have a time, because using lama comes
</span><br>
from
<br>
...
<span class="quotelev1">&gt; I'll try to take a look at it - my expectation is that lama might get
</span><br>
<span class="quotelev1">&gt; stuck because you didn't tell it a pattern to map, and I doubt that code
</span><br>
...
<span class="quotelev1">&gt; By the way, yesterday I tried to check how lama in 1.7.4rc treat numa
</span><br>
