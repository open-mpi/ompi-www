...
?>
<!-- received="Sat Dec 21 23:16:47 2013" -->
<!-- isoreceived="20131222041647" -->
<!-- sent="Sun, 22 Dec 2013 13:16:32 +0900" -->
<!-- isosent="20131222041632" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to	numa&amp;quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours	based 32	core node" -->
<!-- id="OFE4D2D2FB.D306AC43-ON49257C49.0015450C-49257C49.001783F7_at_jcity.maeda.co.jp" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="63177061-0F51-4A5E-BF8A-2B327535974B_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:tmishima_at_[hidden]?Subject=Re:%20[OMPI%20users]%20&amp;amp;quot;-bind-to	numa&amp;amp;quot;	of	openmpi-1.7.4rc1	dosen't	work	for%20our%20magny%20cours	based%2032	core%20node"><em>tmishima_at_[hidden]</em></a><br>
<strong>Date:</strong> 2013-12-21 23:16:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23282.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours	based 32	core node"</a>
<li><strong>Previous message:</strong> <a href="23280.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32	core node"</a>
<li><strong>In reply to:</strong> <a href="23280.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32	core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23282.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours	based 32	core node"</a>
<li><strong>Reply:</strong> <a href="23282.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our magny cours	based 32	core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Let me confirm one thing. I don't put &quot;-with-libevent&quot; when I build
<br>
openmpi.
<br>
...
<p>Tetsuya Mishima
<br>
<p><p><span class="quotelev1">&gt; Not entirely sure - add &quot;-mca rmaps_base_verbose 10 --display-map&quot; to
</span><br>
your cmd line and let's see if it finishes the mapping.
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Unless you specifically built with an external libevent (which I doubt),
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [rhc_at_bend001 tcp]$ mpirun -np 2 -host bend001 -report-bindings -mca
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; (I also checked the internals using &quot;-mca rmaps_base_verbose 10&quot;) so
</span><br>
it
<br>
...
<span class="quotelev3">&gt; &gt;&gt; some scenarios in the OOB subsystem - though if you are able to run
</span><br>
using
<br>
...
<span class="quotelev3">&gt; &gt;&gt; But every try failed. At least they were accepted by openmpi-1.7.3 as
</span><br>
far
<br>
<span class="quotelev3">&gt; &gt;&gt; as I remember.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Anyway, please check it when you have a time, because using lama comes
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; I'll try to take a look at it - my expectation is that lama might get
</span><br>
<span class="quotelev3">&gt; &gt;&gt; stuck because you didn't tell it a pattern to map, and I doubt that
</span><br>
code
<br>
...
<span class="quotelev3">&gt; &gt;&gt; By the way, yesterday I tried to check how lama in 1.7.4rc treat numa
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; So &quot;-bind-to l3cache&quot; or &quot;-map-by l3cache&quot; is valid for what I want
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [mishima_at_manage ~]$ qsub -I -l nodes=1:ppn=32&gt;&gt; qsub: waiting for job
</span><br>
