...
?>
<!-- received="Wed Dec 25 06:39:28 2013" -->
<!-- isoreceived="20131225113928" -->
<!-- sent="Wed, 25 Dec 2013 20:39:15 +0900" -->
<!-- isosent="20131225113915" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to	numa&amp;quot;	of	openmpi-1.7.4rc1	dosen't	work	for	our	magny cours	based 32	core node" -->
<!-- id="OF19BD782E.787D2074-ON49257C4C.003C2991-49257C4C.0040084D_at_jcity.maeda.co.jp" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="OF5B9C860C.7570FB63-ON49257C4B.0018E0B5-49257C4B.0019055D_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:tmishima_at_[hidden]?Subject=Re:%20[OMPI%20users]%20&amp;amp;quot;-bind-to	numa&amp;amp;quot;	of	openmpi-1.7.4rc1	dosen't	work	for	our	magny%20cours	based%2032	core%20node"><em>tmishima_at_[hidden]</em></a><br>
<strong>Date:</strong> 2013-12-25 06:39:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23290.php">Siddhartha Jana: "Re: [OMPI users] [EXTERNAL] Re: Configuration for rendezvous and eager protocols: two-sided comm"</a>
<li><strong>Previous message:</strong> <a href="23288.php">Jeff Hammond: "Re: [OMPI users] Segmentation fault on OMPI 1.6.5 built with gcc 4.4.7 and PGI pgfortran 11.10"</a>
<li><strong>In reply to:</strong> <a href="23286.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for our	magny cours	based 32	core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23291.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for	our	magny cours	based 32	core node"</a>
<li><strong>Reply:</strong> <a href="23291.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to	numa&quot;	of	openmpi-1.7.4rc1	dosen't	work	for	our	magny cours	based 32	core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>I did valgrind and found uninitialised value errors. All of them
<br>
...
<br>
<p>void opal_tree_init(opal_tree_t *tree, opal_tree_comp_fn_t comp,
<br>
...
<br>
<p>Then, these errors all disappeared and openmpi with lama worked fine.
<br>
...
Tetsuya Mishima
<br>
<p>valgrind -v --error-limit=no --leak-check=yes --show-reachable=no mpirun
<br>
...
==27313==    by 0x40694A: main (main.c:13)
<br>
<p><p><p><span class="quotelev1">&gt; Hi Ralph,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Here is the output when I put &quot;-mca rmaps_base_verbose 10 --display-map&quot;
</span><br>
<span class="quotelev1">&gt; and where it stopped(by gdb), which shows it stopped in a function of
</span><br>
lama.
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I usually use PGI 13.10, so I tried to change it to gnu compiler.
</span><br>
<span class="quotelev1">&gt; Then, it works. Therefore, this problem depends on compiler.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; That's all what I could find today.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; [mishima_at_manage ~]$ gdb
</span><br>
<span class="quotelev1">&gt; GNU gdb (GDB) CentOS (7.0.1-42.el5.centos.1)
</span><br>
<span class="quotelev1">&gt; ....
</span><br>
<span class="quotelev1">&gt; (gdb) attach 14666
</span><br>
<span class="quotelev1">&gt; ....
</span><br>
<span class="quotelev1">&gt; 0x00002aaaab4c5c33 in rmaps_lama_prune_max_tree ()
</span><br>
<span class="quotelev1">&gt; at ./rmaps_lama_max_tree.c:814
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; [mishima_at_manage demos]$ mpirun -np 2 -mca rmaps lama -report-bindings
</span><br>
-mca
<br>
<span class="quotelev1">&gt; rmaps_base_verbose 10 --display-map myprog
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca: base: components_register: registering rmaps
</span><br>
<span class="quotelev1">&gt; components
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca: base: components_register: found loaded
</span><br>
<span class="quotelev1">&gt; component lama
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: Priority   0
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: Map   : NULL
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: Bind  : NULL
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: MPPR  : NULL
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: Order : NULL
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca: base: components_register: component lama
</span><br>
<span class="quotelev1">&gt; register function successful
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca: base: components_open: opening rmaps
</span><br>
components
<br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca: base: components_open: found loaded component
</span><br>
<span class="quotelev1">&gt; lama
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:select: checking available component
</span><br>
lama
<br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:select: Querying component [lama]
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] [[23940,0],0]: Final mapper priorities
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503]  Mapper: lama Priority: 0
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps: mapping job [23940,1]
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps: creating new map for job [23940,1]
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps: nprocs 2
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: Mapping job [23940,1]
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: Revised Parameters -----
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: Map   : csbnh
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: Bind  : 1c
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: MPPR  : (null)
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: Order : s
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ---------------------------------
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Binding  : [1c]
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Binding  :    1 x       Core
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ---------------------------------
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : [csbnh]
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (0)       Core (7
</span><br>
<span class="quotelev1">&gt; vs 0)
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (1)     Socket (3
</span><br>
<span class="quotelev1">&gt; vs 1)
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (2)      Board (1
</span><br>
<span class="quotelev1">&gt; vs 3)
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (3)    Machine (0
</span><br>
<span class="quotelev1">&gt; vs 7)
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Mapping  : (4) Hw. Thread (8
</span><br>
<span class="quotelev1">&gt; vs 8)
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ---------------------------------
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- MPPR     : [(null)]
...
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Ordering : [s]
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Ordering : Sequential
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ---------------------------------
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] AVAILABLE NODES FOR MAPPING:
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503]     node: manage daemon: 0
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ---------------------------------
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Building the Max Tree...
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ---------------------------------
</span><br>
<span class="quotelev1">&gt; [manage.cluster:21503] mca:rmaps:lama: ----- Converting Remote Tree:
</span><br>
manage
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; [mishima_at_manage demos]$ ompi_info | grep &quot;C compiler family&quot;
</span><br>
<span class="quotelev1">&gt; C compiler family name: GNU
</span><br>
<span class="quotelev1">&gt; [mishima_at_manage demos]$ mpirun -np 2 -mca rmaps lama myprog
</span><br>
...
<span class="quotelev2">&gt; &gt; On Dec 21, 2013, at 8:16 PM, tmishima_at_[hidden] wrote:
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; Ralph, thanks. I'll try it on Tuseday.
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Let me confirm one thing. I don't put &quot;-with-libevent&quot; when I build
</span><br>
<span class="quotelev3">&gt; &gt; &gt; openmpi.
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Is there any possibility to build with external libevent
</span><br>
automatically?
<br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; No - only happens if you direct it
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev4">&gt; &gt; &gt;&gt; Not entirely sure - add &quot;-mca rmaps_base_verbose 10 --display-map&quot;
</span><br>
to
<br>
<span class="quotelev3">&gt; &gt; &gt; your cmd line and let's see if it finishes the mapping.
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; Unless you specifically built with an external libevent (which I
</span><br>
<span class="quotelev1">&gt; doubt),
</span><br>
<span class="quotelev3">&gt; &gt; &gt; there is no conflict. The connection issue is unlikely to be a factor
</span><br>
<span class="quotelev1">&gt; here
</span><br>
<span class="quotelev3">&gt; &gt; &gt; as it works when not using the lama mapper.
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; On Dec 21, 2013, at 3:43 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt;
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; [rhc_at_bend001 tcp]$ mpirun -np 2 -host bend001 -report-bindings
</span><br>
-mca
<br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; (I also checked the internals using &quot;-mca rmaps_base_verbose 10&quot;)
</span><br>
so
<br>
<span class="quotelev3">&gt; &gt; &gt; it
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; could be your hier inversion causing problems again. Or it could be
</span><br>
<span class="quotelev3">&gt; &gt; &gt; that
</span><br>
<span class="quotelev1">&gt; &gt; &gt;&gt;&gt; you are hitting a connection issue we are seeing in
</span><br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; some scenarios in the OOB subsystem - though if you are able to
</span><br>
run
<br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; But every try failed. At least they were accepted by openmpi-1.7.3
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; Anyway, please check it when you have a time, because using lama
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; I'll try to take a look at it - my expectation is that lama might
</span><br>
<span class="quotelev1">&gt; get
</span><br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; stuck because you didn't tell it a pattern to map, and I doubt
</span><br>
that
<br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; By the way, yesterday I tried to check how lama in 1.7.4rc treat
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; My opinion was made just considering easy way to adjust the code
</span><br>
for
<br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; And yes, L3 and NUMA are topologically-identical on AMD
</span><br>
Magny-Cours
<br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; (and
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; So &quot;-bind-to l3cache&quot; or &quot;-map-by l3cache&quot; is valid for what I
</span><br>
want
<br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; NUMANode&gt; &gt;&gt;&gt;&gt; type
</span><br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; Cache
</span><br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt;   Backend=Linux&gt;&gt;&gt;&gt;   OSName=Linux
</span><br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt;   OSRelease=2.6.18-308.16.1.el5
</span><br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt;   OSVersion=&quot;#1 SMP Tue Oct 2 22:01:43 EDT 2012&quot;
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; [mishima_at_manage ~]$ qsub -I -l nodes=1:ppn=32&gt;&gt; qsub: waiting for
</span><br>
<span class="quotelev1">&gt; job
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 8352.manage.cluster to start
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; _______________________________
</span><br>
________________
<br>
<span class="quotelev2">&gt; &gt; &gt;&gt;&gt;&gt; users mailing list
