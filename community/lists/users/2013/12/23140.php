...
?>
<!-- received="Tue Dec  3 10:12:23 2013" -->
<!-- isoreceived="20131203151223" -->
<!-- sent="Tue, 3 Dec 2013 10:12:20 -0500" -->
<!-- isosent="20131203151220" -->
<!-- name="Meredith, Karl" -->
<!-- email="karl.meredith_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [EXTERNAL] Re: open-mpi on Mac OS 10.9 (Mavericks)" -->
<!-- id="1DF30296-2F77-4BFF-BCD8-EF66F524F04F_at_fmglobal.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="DCC6040A-59F3-44CB-BBAB-9708501452C7_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-03 10:12:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23141.php">Jeff Squyres (jsquyres): "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<li><strong>Previous message:</strong> <a href="23139.php">Jeff Squyres (jsquyres): "Re: [OMPI users] [EXTERNAL] Re: open-mpi on Mac OS 10.9 (Mavericks)"</a>
<li><strong>In reply to:</strong> <a href="23139.php">Jeff Squyres (jsquyres): "Re: [OMPI users] [EXTERNAL] Re: open-mpi on Mac OS 10.9 (Mavericks)"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p>Karl
<br>
<p><p>On Dec 3, 2013, at 9:54 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Ok, I think we're chasing the same thing in multiple threads -- this looks like a similar result as what you replied to Ralph with.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Let's keep the other thread (with Ralph) going; this looks like some kind of networking issue that we haven't seen before (e.g., unable to open ports to the local host).  Which is a little odd, but let's run it down over in the other thread.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Dec 3, 2013, at 7:44 AM, &quot;Meredith, Karl&quot; &lt;karl.meredith_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Using the latest nightly snapshot (1.7.4) and only Apple compilers/tools (no macports), I configure/build with the following:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; ./configure --prefix=/opt/trunk/apple-only-1.7.4 --enable-shared --disable-static --enable-debug --disable-io-romio --enable-contrib-no-build=vt,libtrace --enable-mpirun-prefix-by-default
</span><br>
<span class="quotelev2">&gt;&gt; make all
</span><br>
<span class="quotelev2">&gt;&gt; make install
</span><br>
<span class="quotelev2">&gt;&gt; export PATH=/opt/trunk/apple-only-1.7.4/bin/:$PATH
</span><br>
<span class="quotelev2">&gt;&gt; export LD_LIBRARY_PATH=/opt/trunk/apple-only-1.7.4/lib:$LD_LIBRARY_PATH
</span><br>
<span class="quotelev2">&gt;&gt; export DYLD_LIBRARY_PATH=/opt/trunk/apple-only-1.7.4/lib:$DYLD_LIBRARY_PATH
</span><br>
<span class="quotelev2">&gt;&gt; cd examples
</span><br>
<span class="quotelev2">&gt;&gt; make all
</span><br>
<span class="quotelev2">&gt;&gt; mpirun -v -np 2 ./hello_cxx
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Here&#146;s the stack trace for one of the hanging process:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; (lldb) bt
</span><br>
<span class="quotelev2">&gt;&gt; * thread #1: tid = 0x57052, 0x00007fff8c991a3a libsystem_kernel.dylib`__semwait_signal + 10, queue = 'com.apple.main-thread, stop reason = signal SIGSTOP
</span><br>
<span class="quotelev2">&gt;&gt;   frame #0: 0x00007fff8c991a3a libsystem_kernel.dylib`__semwait_signal + 10
</span><br>
<span class="quotelev2">&gt;&gt;   frame #1: 0x00007fff8ade4e60 libsystem_c.dylib`nanosleep + 200
</span><br>
<span class="quotelev2">&gt;&gt;   frame #2: 0x0000000100be98e3 libopen-rte.6.dylib`orte_routed_base_register_sync(setup=true) + 2435 at routed_base_fns.c:344
</span><br>
<span class="quotelev2">&gt;&gt;   frame #3: 0x0000000100ecc3a7 mca_routed_binomial.so`init_routes(job=1305542657, ndat=0x0000000000000000) + 2759 at routed_binomial.c:708
</span><br>
<span class="quotelev2">&gt;&gt;   frame #4: 0x0000000100b9e84d libopen-rte.6.dylib`orte_ess_base_app_setup(db_restrict_local=true) + 2109 at ess_base_std_app.c:233
</span><br>
<span class="quotelev2">&gt;&gt;   frame #5: 0x0000000100e3a442 mca_ess_env.so`rte_init + 418 at ess_env_module.c:146
</span><br>
<span class="quotelev2">&gt;&gt;   frame #6: 0x0000000100b59cfe libopen-rte.6.dylib`orte_init(pargc=0x0000000000000000, pargv=0x0000000000000000, flags=32) + 718 at orte_init.c:158
</span><br>
<span class="quotelev2">&gt;&gt;   frame #7: 0x00000001008bd3c8 libmpi.1.dylib`ompi_mpi_init(argc=0, argv=0x0000000000000000, requested=0, provided=0x00007fff5f3cd370) + 616 at ompi_mpi_init.c:451
</span><br>
<span class="quotelev2">&gt;&gt;   frame #8: 0x000000010090b5c3 libmpi.1.dylib`MPI_Init(argc=0x0000000000000000, argv=0x0000000000000000) + 515 at init.c:86
</span><br>
<span class="quotelev2">&gt;&gt;   frame #9: 0x0000000100833a1d hello_cxx`MPI::Init() + 29 at functions_inln.h:128
</span><br>
<span class="quotelev2">&gt;&gt;   frame #10: 0x00000001008332ac hello_cxx`main(argc=1, argv=0x00007fff5f3cd550) + 44 at hello_cxx.cc:18
</span><br>
<span class="quotelev2">&gt;&gt;   frame #11: 0x00007fff8d5df5fd libdyld.dylib`start + 1
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On Dec 2, 2013, at 2:33 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ah -- sorry, I missed this mail before I replied to the other thread (OS X Mail threaded them separately somehow...).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Sorry to ask you to dive deeper, but can you find out where in orte_ess.init() it's failing?  orte_ess.init is actually a function pointer; it's a jump-off point into a dlopen'ed plugin.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Nov 25, 2013, at 11:53 AM, &quot;Meredith, Karl&quot; &lt;karl.meredith_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Digging a little deeper by running the code in the lldb debugger, I found that the stall occurs in a call to init_orte from ompi_mpi_init.c:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 356     /* Setup ORTE - note that we are an MPI process  */
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 357     if (ORTE_SUCCESS != (ret = orte_init(NULL, NULL, ORTE_PROC_MPI))) {
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 358         error = &quot;ompi_mpi_init: orte_init failed&quot;;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 359         goto error;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 360     }
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The code never returns from orte_init.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; It gets stuck in orte_ess.init() called from orte_init.c:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 126     /* initialize the RTE for this environment */
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 127     if (ORTE_SUCCESS != (ret = orte_ess.init())) {
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; When I step through this orte_ess_init in the lldb debugger, I actually get some output from the code (no output if not using the debugger and stepping through):
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; --&gt; Returned &quot;Unable to start a daemon on the local node&quot; (-128) instead of &quot;Success&quot; (0)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Nov 25, 2013, at 9:20 AM, Meredith, Karl &lt;karl.meredith_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Here&#146;s the back trace from lldb:
</span><br>
