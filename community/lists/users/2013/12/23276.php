...
?>
<!-- received="Fri Dec 20 23:09:22 2013" -->
<!-- isoreceived="20131221040922" -->
<!-- sent="Sat, 21 Dec 2013 13:09:08 +0900" -->
<!-- isosent="20131221040908" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node" -->
<!-- id="OF68199873.98C480C8-ON49257C48.0015726D-49257C48.0016D5A2_at_jcity.maeda.co.jp" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="7579A5E7-67A3-43BD-AB70-8D668EC45DC6_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:tmishima_at_[hidden]?Subject=Re:%20[OMPI%20users]%20&amp;amp;quot;-bind-to%20numa&amp;amp;quot;%20of	openmpi-1.7.4rc1	dosen't	work	for%20our%20magny%20cours%20based%2032%20core%20node"><em>tmishima_at_[hidden]</em></a><br>
<strong>Date:</strong> 2013-12-20 23:09:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23277.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>Previous message:</strong> <a href="23275.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>In reply to:</strong> <a href="23275.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23277.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>Reply:</strong> <a href="23277.php">Ralph Castain: "Re: [OMPI users] &quot;-bind-to numa&quot; of	openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>Thank you very much. I tried many things such as:
<br>
<p>mpirun -np 2 -host node05 -report-bindings -mca rmaps lama -mca
<br>
rmaps_lama_bind 1c myprog
<br>
<p>But every try failed. At least they were accepted by openmpi-1.7.3 as far
<br>
as I remember.
<br>
...
Tetsuya Mishima
<br>
<p><p><span class="quotelev1">&gt; I'll try to take a look at it - my expectation is that lama might get
</span><br>
