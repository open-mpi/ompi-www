...
?>
<!-- received="Wed Dec  4 07:25:30 2013" -->
<!-- isoreceived="20131204122530" -->
<!-- sent="Wed, 4 Dec 2013 07:25:29 -0500" -->
<!-- isosent="20131204122529" -->
<!-- name="Meredith, Karl" -->
<!-- email="karl.meredith_at_[hidden]" -->
<!-- subject="Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)" -->
<!-- id="7A6F23F5-C349-489F-A858-B55937B4E5C8_at_fmglobal.com" -->
...
<strong>Date:</strong> 2013-12-04 07:25:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23147.php">Ralph Castain: "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<li><strong>Previous message:</strong> <a href="23145.php">CUDENNEC Loic: "[OMPI users] [CfP] ICCS/Alchemy 2014 - Architecture, Languages, Compilation and Hardware support for Emerging ManYcore systems"</a>
<li><strong>In reply to:</strong> <a href="23137.php">Ralph Castain: "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23147.php">Ralph Castain: "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<li><strong>Reply:</strong> <a href="23147.php">Ralph Castain: "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<li><strong>Reply:</strong> <a href="23148.php">Jeff Squyres (jsquyres): "Re: [OMPI users] open-mpi on Mac OS 10.9 (Mavericks)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>After turning off the firewall, I have these rules:
<br>
<p>$ )sudo ipfw list
<br>
Password:
...
65535 allow ip from any to any
<br>
<p>And the test examples run fine:
<br>
...
<br>
<p>Our local IT expert believes that this problem is related to this bug from way back in openmpi 1.2.3, but it seems like the patch was never implemented:
<br>
<a href="http://www.open-mpi.org/community/lists/users/2007/05/3344.php">http://www.open-mpi.org/community/lists/users/2007/05/3344.php</a>
<br>
<p>I&#146;m not good enough with networking to be able to tell if it is related or not.
<br>
<p>Karl
<br>
<p><p><p><p>On Dec 3, 2013, at 8:16 AM, Ralph Castain &lt;rhc_at_[hidden]&lt;mailto:rhc_at_[hidden]&gt;&gt; wrote:
<br>
<p>Best guess I can offer is that they are blocking loopback on those networks - i.e., they are configured such that you can use them to connect to a remote machine, but not to a process on your local machine. I'll take a look at the connection logic and see if I can get it to failover to the loopback device in that case. I believe we disable use of the loopback if an active TCP network is available as we expect it to include loopback capability.
<br>
<p>Meantime, you might want to talk to your IT folks and see if that is correct and intentional - and if so, why.
<br>
<p><p><p>On Tue, Dec 3, 2013 at 5:04 AM, Meredith, Karl &lt;karl.meredith_at_[hidden]&lt;mailto:karl.meredith_at_[hidden]&gt;&gt; wrote:
<br>
...
<p>Karl
<br>
<p><p><p>On Dec 3, 2013, at 7:54 AM, Ralph Castain &lt;rhc_at_[hidden]&lt;mailto:rhc_at_[hidden]&gt;&lt;mailto:rhc_at_[hidden]&lt;mailto:rhc_at_[hidden]&gt;&gt;&gt; wrote:
<br>
...
<br>
<p><p><p>On Tue, Dec 3, 2013 at 4:51 AM, Meredith, Karl &lt;karl.meredith_at_[hidden]&lt;mailto:karl.meredith_at_[hidden]&gt;&lt;mailto:karl.meredith_at_[hidden]&lt;mailto:karl.meredith_at_[hidden]&gt;&gt;&gt; wrote:
<br>
...
<br>
<p><p>On Dec 2, 2013, at 2:11 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&lt;mailto:jsquyres_at_[hidden]&gt;&lt;mailto:jsquyres_at_[hidden]&lt;mailto:jsquyres_at_[hidden]&gt;&gt;&gt; wrote:
<br>
...
<span class="quotelev1">&gt; On Nov 27, 2013, at 2:56 PM, &quot;Meredith, Karl&quot; &lt;karl.meredith_at_[hidden]&lt;mailto:karl.meredith_at_[hidden]&gt;&lt;mailto:karl.meredith_at_[hidden]&lt;mailto:karl.meredith_at_[hidden]&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;                         Comma-delimited list of devices and/or CIDR notation of networks to use for Open MPI bootstrap communication (e.g., &quot;eth0,192.168.0.0/16&lt;<a href="http://192.168.0.0/16">http://192.168.0.0/16</a>&gt;&lt;<a href="http://192.168.0.0/16">http://192.168.0.0/16</a>&gt;&quot;).  Mutually exclusive with oob_tcp_if_exclude.
</span><br>
...
<span class="quotelev2">&gt;&gt;                         Comma-delimited list of devices and/or CIDR notation of networks to use for MPI communication (e.g., &quot;eth0,192.168.0.0/16&lt;<a href="http://192.168.0.0/16">http://192.168.0.0/16</a>&gt;&lt;<a href="http://192.168.0.0/16">http://192.168.0.0/16</a>&gt;&quot;).  Mutually exclusive with btl_tcp_if_exclude.
</span><br>
<span class="quotelev2">&gt;&gt;                MCA btl: parameter &quot;btl_tcp_if_exclude&quot; (current value: &quot;127.0.0.1/8,sppp&lt;<a href="http://127.0.0.1/8,sppp">http://127.0.0.1/8,sppp</a>&gt;&lt;<a href="http://127.0.0.1/8,sppp">http://127.0.0.1/8,sppp</a>&gt;&quot;, data source: default, level: 1 user/basic, type: string)
</span><br>
...
<span class="quotelev2">&gt;&gt; On Nov 27, 2013, at 2:41 PM, George Bosilca &lt;bosilca_at_[hidden]&lt;mailto:bosilca_at_[hidden]&gt;&lt;mailto:bosilca_at_[hidden]&lt;mailto:bosilca_at_[hidden]&gt;&gt;&lt;mailto:bosilca_at_[hidden]&lt;mailto:bosilca_at_[hidden]&gt;&lt;mailto:bosilca_at_[hidden]&lt;mailto:bosilca_at_[hidden]&gt;&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
