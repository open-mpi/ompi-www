...
?>
<!-- received="Fri Dec 20 05:36:50 2013" -->
<!-- isoreceived="20131220103650" -->
<!-- sent="Fri, 20 Dec 2013 11:36:48 +0100" -->
<!-- isosent="20131220103648" -->
<!-- name="Brice Goglin" -->
<!-- email="Brice.Goglin_at_[hidden]" -->
<!-- subject="Re: [OMPI users] &amp;quot;-bind-to numa&amp;quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node" -->
<!-- id="52B41DC0.5000602_at_inria.fr" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="OFCF12DAE4.5E862AE5-ON49257C47.00373F0A-49257C47.0039FDC9_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-12-20 05:36:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23269.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<li><strong>Previous message:</strong> <a href="23267.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<li><strong>In reply to:</strong> <a href="23267.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work	for our magny cours based 32 core node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23269.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<li><strong>Reply:</strong> <a href="23269.php">tmishima_at_[hidden]: "Re: [OMPI users] &quot;-bind-to numa&quot; of openmpi-1.7.4rc1	dosen't	work for our magny cours based 32 core node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>And yes, L3 and NUMA are topologically-identical on AMD Magny-Cours (and
<br>
most recent AMD and Intel platforms).
<br>
<p>Brice
<br>
<p><p><p>Le 20/12/2013 11:33, tmishima_at_[hidden] a &#233;crit :
<br>
...
<span class="quotelev1">&gt; which seems to be a little bit different from the traditional numa defined
</span><br>
...
<span class="quotelev1">&gt; So &quot;-bind-to l3cache&quot; or &quot;-map-by l3cache&quot; is valid for what I want to do.
</span><br>
...
<span class="quotelev2">&gt;&gt; I can wait it'll be fixed in 1.7.5 or later, because putting &quot;-bind-to
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Yeah, it will impact everything that uses hwloc topology maps, I fear.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; One side note: you'll need to add --hetero-nodes to your cmd line. If
</span><br>
<span class="quotelev1">&gt; we
</span><br>
<span class="quotelev2">&gt;&gt; don't see that, we assume that all the node topologies are identical -
</span><br>
<span class="quotelev2">&gt;&gt; which clearly isn't true here.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'll try to resolve the hier inversion over the holiday - won't be for
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; By the way, I think this inversion should affect rmaps_lama mapping.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Ick - yeah, that would be a problem. I haven't seen that type of
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; hierarchical inversion before - is node03 a different type of chip?
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15508] mca:rmaps: bind upwards for job [38286,1]
</span><br>
<span class="quotelev1">&gt; with
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; bindings NUMA
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15508] [[38286,0],0] bind:upward target NUMANode
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15885] [[38679,0],0] bind:upward target NUMANode
</span><br>
<span class="quotelev1">&gt; type
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Hmm...try adding &quot;-mca rmaps_base_verbose 10 -mca ess_base_verbose
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [mishima_at_node03 demos]$ mpirun -np 8 -report-bindings -bind-to
</span><br>
<span class="quotelev1">&gt; numa
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; myprog
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15316] [[37582,0],0] bind:upward target NUMANode
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; A request was made to bind to NUMA, but an appropriate target
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 2 bound to socket 1[core 8[hwt
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 3 bound to socket 1[core 9[hwt
</span><br>
<span class="quotelev1">&gt; 0]]:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./././././././.][./B/./././././.][./././././././.][
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 4 bound to socket 2[core 16[hwt
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 5 bound to socket 2[core 17[hwt
</span><br>
<span class="quotelev2">&gt;&gt; 0]]:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./B/./././././.]
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 6 bound to socket 3[core 24[hwt
</span><br>
<span class="quotelev2">&gt;&gt; 0]]:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 7 bound to socket 3[core 25[hwt
</span><br>
<span class="quotelev2">&gt;&gt; 0]]:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./././././././.][./././././././.][./././././././.]
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 0 bound to socket 0[core 0[hwt
</span><br>
<span class="quotelev1">&gt; 0]]:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [B/././././././.][./././././././.][./././././././.][
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node03.cluster:15282] MCW rank 1 bound to socket 0[core 1[hwt
</span><br>
<span class="quotelev1">&gt; 0]]:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [./B/./././././.][./././././././.][./././././././.][
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    L2 L#3 (512KB) + L1d L#3 (64KB) + L1i L#3 (64KB) + Core L#3 +
</span><br>
<span class="quotelev1">&gt; PU
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; L#17 (P#17)&gt; &gt;&gt;&gt;&gt;&gt;    L2 L#18 (512KB) + L1d L#18 (64KB) + L1i
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; L#24 (P#24)&gt;&gt;&gt;&gt;&gt;    L2 L#25 (512KB) + L1d L#25 (64KB) + L1i L#25
</span><br>
