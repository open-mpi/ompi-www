...
?>
<!-- received="Tue Dec 10 19:47:45 2013" -->
<!-- isoreceived="20131211004745" -->
<!-- sent="Wed, 11 Dec 2013 09:47:37 +0900" -->
<!-- isosent="20131211004737" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option	under	Torque manager" -->
<!-- id="OF03DD8B9E.799F325F-ON49257C3E.0004069D-49257C3E.00045E9A_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="1EE34E1E-33B5-43CE-A74C-53B35A4B4E85_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:tmishima_at_[hidden]?Subject=Re:%20[OMPI%20users]%20openmpi-1.7.4a1r29646%20with%20-hostfile%20option	under	Torque%20manager"><em>tmishima_at_[hidden]</em></a><br>
<strong>Date:</strong> 2013-12-10 19:47:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23176.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option	under	Torque manager"</a>
<li><strong>Previous message:</strong> <a href="23174.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under	Torque manager"</a>
<li><strong>In reply to:</strong> <a href="23174.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under	Torque manager"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23176.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option	under	Torque manager"</a>
<li><strong>Reply:</strong> <a href="23176.php">Ralph Castain: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option	under	Torque manager"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>Thanks. I didn't know the meaning of &quot;socket:span&quot;.
<br>
<p>But it still causes the problem, which seems socket:span doesn't work.
<br>
<p>[mishima_at_manage demos]$ qsub -I -l nodes=node03:ppn=32
<br>
qsub: waiting for job 8265.manage.cluster to start
<br>
qsub: job 8265.manage.cluster ready
<br>
<p>[mishima_at_node03 ~]$ cd ~/Desktop/openmpi-1.7/demos/
<br>
...
Tetsuya Mishima
<br>
<p><span class="quotelev1">&gt; No, that is actually correct. We map a socket until full, then move to
</span><br>
...
<span class="quotelev2">&gt; &gt; I had a time to try your patch yesterday using openmpi-1.7.4a1r29646.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; [mishima_at_node04 demos]$ mpirun -np 8 -report-bindings -cpus-per-proc 4
</span><br>
...
<span class="quotelev2">&gt; &gt; [node04.cluster:27489] MCW rank 3 bound to socket 1[core 12[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node04.cluster:27489] MCW rank 4 bound to socket 2[core 16[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node04.cluster:27489] MCW rank 5 bound to socket 2[core 20[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node04.cluster:27489] MCW rank 6 bound to socket 3[core 24[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev2">&gt; &gt; [node04.cluster:27489] MCW rank 7 bound to socket 3[core 28[hwt 0]],
</span><br>
socket
<br>
...
<span class="quotelev3">&gt; &gt;&gt; I fixed this under the trunk (was an issue regardless of RM) and have
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:18128] MCW rank 2 bound to socket 1[core 8[hwt 0]],
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:18128] MCW rank 3 bound to socket 1[core 12[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:18128] MCW rank 4 bound to socket 2[core 16[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:18128] MCW rank 5 bound to socket 2[core 20[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:18128] MCW rank 6 bound to socket 3[core 24[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:18128] MCW rank 7 bound to socket 3[core 28[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:18128] MCW rank 0 bound to socket 0[core 0[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; [node03.cluster:18128] MCW rank 1 bound to socket 0[core 4[hwt 0]],
</span><br>
<span class="quotelev2">&gt; &gt; socket
</span><br>
