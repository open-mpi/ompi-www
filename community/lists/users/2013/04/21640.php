...
?>
<!-- received="Tue Apr  2 07:22:24 2013" -->
<!-- isoreceived="20130402112224" -->
<!-- sent="Tue, 02 Apr 2013 18:22:10 +0700" -->
<!-- isosent="20130402112210" -->
<!-- name="Duke Nguyen" -->
<!-- email="duke.lists_at_[hidden]" -->
<!-- subject="Re: [OMPI users] memory per core/process" -->
<!-- id="515ABF62.8020606_at_gmx.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="54694249-9905-4593-96D3-43E46AF16D5B_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-04-02 07:22:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21641.php">Reuti: "Re: [OMPI users] memory per core/process"</a>
<li><strong>Previous message:</strong> <a href="21639.php">Ng Shi Wei: "[OMPI users] Problem with MPI functions"</a>
<li><strong>In reply to:</strong> <a href="21635.php">Ralph Castain: "Re: [OMPI users] memory per core/process"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21641.php">Reuti: "Re: [OMPI users] memory per core/process"</a>
<li><strong>Reply:</strong> <a href="21641.php">Reuti: "Re: [OMPI users] memory per core/process"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; It's probably the same problem - try running 'mpirun -npernode 1 -tag-output ulimit -a&quot;  on the remote nodes and see what it says. I suspect you'll find that they aren't correct.
</span><br>
<p>Somehow I could not run your advised CMD:
<br>
<p>$ qsub -l nodes=4:ppn=8 -I
<br>
qsub: waiting for job 481.biobos to start
<br>
qsub: job 481.biobos ready
<br>
<p>$ /usr/local/bin/mpirun -npernode 1 -tag-output ulimit -a
<br>
--------------------------------------------------------------------------
<br>
...
<br>
<p>But anyway, I figured out the reason. Yes, it is the cluster nodes that 
<br>
...
<br>
<p>Thanks for all the helps :)
<br>
<p>D.
<br>
<p><span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; BTW: the &quot;-tag-output'&quot; option marks each line of output with the rank of the process. Since all the outputs will be interleaved, this will help you identify what came from each node.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Mar 31, 2013, at 11:30 PM, Duke Nguyen &lt;duke.lists_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On 3/31/13 12:20 AM, Duke Nguyen wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I should really have asked earlier. Thanks for all the helps.
</span><br>
<span class="quotelev2">&gt;&gt; I think I was excited too soon :). Increasing stacksize does help if I run a job in a dedicated server. Today I tried to modify the cluster (/etc/security/limits.conf, /etc/init.d/pbs_mom) and tried to run a different job with 4 nodes/8 core each (nodes=4:ppn=8), but I still get the mpirun error. My ulimit now reads:
</span><br>
...
<span class="quotelev2">&gt;&gt; max user processes              (-u) 8192
</span><br>
...
<span class="quotelev2">&gt;&gt; Any other advice???
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On 3/30/13 10:28 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; FWIW: there is an MCA param that helps with such problems:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;          opal_set_max_sys_limits
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;                   &quot;Set to non-zero to automatically set any system-imposed limits to the maximum allowed&quot;,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; At the moment, it only sets the limits on number of files open, and max size of a file we can create. Easy enough to add the stack size, though as someone pointed out, it has some negatives as well.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mar 30, 2013, at 7:35 AM, Gustavo Correa &lt;gus_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
