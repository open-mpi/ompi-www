...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21644.php">Pradeep Jha: "[OMPI users] mpirun error"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2013/03/21642.php">Ralph Castain: "Re: [OMPI users] OpenMPI + BLCR + LSF integration"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2013/03/21641.php">Duke Nguyen: "Re: [OMPI users] memory per core/process"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21646.php">Ralph Castain: "Re: [OMPI users] memory per core/process"</a>
<li><strong>Reply:</strong> <a href="21646.php">Ralph Castain: "Re: [OMPI users] memory per core/process"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
