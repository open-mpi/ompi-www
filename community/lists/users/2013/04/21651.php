...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21652.php">Reuti: "Re: [OMPI users] memory per core/process"</a>
<li><strong>Previous message:</strong> <a href="21650.php">Ng Shi Wei: "[OMPI users] Problem with MPI functions"</a>
<li><strong>In reply to:</strong> <a href="21646.php">Ralph Castain: "Re: [OMPI users] memory per core/process"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21652.php">Reuti: "Re: [OMPI users] memory per core/process"</a>
<li><strong>Reply:</strong> <a href="21652.php">Reuti: "Re: [OMPI users] memory per core/process"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
