...
<p class="headers">
<strong>Subject:</strong> [OMPI users] error configuring OpenMPI 1.6.4 with gcc 4.7.2<br>
<strong>From:</strong> Alan Sayre (<em>ansayre62_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-04-01 17:09:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21649.php">Alan Sayre: "Re: [OMPI users] error configuring OpenMPI 1.6.4 with gcc 4.7.2"</a>
<li><strong>Previous message:</strong> <a href="21647.php">Elken, Tom: "Re: [OMPI users] mpirun error"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21649.php">Alan Sayre: "Re: [OMPI users] error configuring OpenMPI 1.6.4 with gcc 4.7.2"</a>
<li><strong>Maybe reply:</strong> <a href="21649.php">Alan Sayre: "Re: [OMPI users] error configuring OpenMPI 1.6.4 with gcc 4.7.2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21648/attachment">attachment</a>
</ul>
