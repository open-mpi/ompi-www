...
?>
<!-- received="Mon Apr 29 08:29:59 2013" -->
<!-- isoreceived="20130429122959" -->
<!-- sent="Mon, 29 Apr 2013 05:29:51 -0700" -->
<!-- isosent="20130429122951" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] getting opal_init:startup:internal-failure" -->
<!-- id="32838CE5-46C5-469A-AF25-AE5AF38EC978_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CANhoU+gdsunpbAiY-g2AThsoavfM5NT1WcQpjH+EhWYPf0u1kA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-04-29 08:29:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21819.php">E.O.: "Re: [OMPI users] getting opal_init:startup:internal-failure"</a>
<li><strong>Previous message:</strong> <a href="21817.php">E.O.: "Re: [OMPI users] getting opal_init:startup:internal-failure"</a>
<li><strong>In reply to:</strong> <a href="21817.php">E.O.: "Re: [OMPI users] getting opal_init:startup:internal-failure"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21819.php">E.O.: "Re: [OMPI users] getting opal_init:startup:internal-failure"</a>
<li><strong>Reply:</strong> <a href="21819.php">E.O.: "Re: [OMPI users] getting opal_init:startup:internal-failure"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I probably mis-typed the &quot;prefix&quot; option - it has two dashes in front of it and no equal sign:
<br>
<p>mpirun --prefix ./myname ...
<br>
<p>I suspect you only put one dash, and the equal sign was a definite problem, which is why it gave you an error. 
<br>
<p><p>On Apr 29, 2013, at 5:12 AM, E.O. &lt;ooyama.eiichi_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I tried configuring/building an OMPI on the remote host but I was not able to...
</span><br>
<span class="quotelev1">&gt; The remote host (host2) doesn't have any development tools, such as gcc, make, etc...
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Since I am able to run an MPI hello_c binary on the remote host, I believe the host has all the necessary libraries needed for MPI. I am also able to run an MPI hello_c binary on host1 from host2.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; [host2:02499] [[INVALID],INVALID] ORTE_ERROR_LOG: Error in file runtime/orte_init.c at line 79
</span><br>
<span class="quotelev1">&gt; [host2:02499] [[INVALID],INVALID] ORTE_ERROR_LOG: Error in file orted/orted_main.c at line 358
</span><br>
<span class="quotelev1">&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev1">&gt; If you configure/build OMPI on the remote node using the same configure options you used on host1, does the problem go away?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt;&gt; so it will set the remove prefix and see if that helps. If it does, you can add --enable-orterun-prefix-by-default to your configure line so mpirun always adds it.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev3">&gt;&gt; &gt; I downloaded openmpi-1.6.4.tar.gz into my main redhat machine and configure'ed/compiled it successfully.
</span><br>
<span class="quotelev3">&gt;&gt; &gt; ./configure --prefix=/myname
</span><br>
<span class="quotelev3">&gt;&gt; &gt; I installed it to /myname directory successfully. I am able to run a simple hallo.c on my redhat machine.
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt;&gt; &gt;     //share/openmpi/help-opal-runtime.txt: No such file or directory.  Sorry!
</span><br>
<span class="quotelev3">&gt;&gt; &gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev3">&gt;&gt; &gt; [host2:26294] [[INVALID],INVALID] ORTE_ERROR_LOG: Error in file runtime/orte_init.c at line 79
</span><br>
<span class="quotelev3">&gt;&gt; &gt; [host2:26294] [[INVALID],INVALID] ORTE_ERROR_LOG: Error in file orted/orted_main.c at line 358
</span><br>
<span class="quotelev3">&gt;&gt; &gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev3">&gt;&gt; &gt; lrwxrwxrwx    1 root     root            15 Apr 28 10:21 /myname/lib/libmpi.so.1 -&gt; libmpi.so.1.0.7
</span><br>
...
<span class="quotelev3">&gt;&gt; &gt; Can someone help me figure out why I cannot run hello.out in host2 from host1 ?
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21818/attachment">attachment</a>
</ul>
