...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21648.php">Alan Sayre: "[OMPI users] error configuring OpenMPI 1.6.4 with gcc 4.7.2"</a>
<li><strong>Previous message:</strong> <a href="21646.php">Ralph Castain: "Re: [OMPI users] memory per core/process"</a>
<li><strong>In reply to:</strong> <a href="21645.php">Michael Kluskens: "Re: [OMPI users] mpirun error"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21699.php">Pradeep Jha: "Re: [OMPI users] mpirun error"</a>
<li><strong>Reply:</strong> <a href="21699.php">Pradeep Jha: "Re: [OMPI users] mpirun error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
