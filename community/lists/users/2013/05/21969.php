...
?>
<!-- received="Tue May 28 10:08:09 2013" -->
<!-- isoreceived="20130528140809" -->
<!-- sent="Tue, 28 May 2013 14:08:05 +0000" -->
<!-- isosent="20130528140805" -->
<!-- name="mohamed khuili" -->
<!-- email="khuilimohamed_at_[hidden]" -->
<!-- subject="Re: [OMPI users] -Re Post- MPI_SUM is not defined on the MPI_INTEGER datatype" -->
<!-- id="CADj5Vr27U_j4RR6T3heoNgUURVJErZZREE9C252nK7nc=LbcwA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="EF66BBEB19BADC41AC8CCF5F684F07FC4F641C81_at_xmb-rcd-x01.cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> mohamed khuili (<em>khuilimohamed_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-05-28 10:08:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21970.php">mohamed khuili: "Re: [OMPI users] Open RTE was unable to open the hostfile:"</a>
<li><strong>Previous message:</strong> <a href="21968.php">Jeff Squyres (jsquyres): "Re: [OMPI users] -Re Post- MPI_SUM is not defined on the MPI_INTEGER	datatype"</a>
<li><strong>In reply to:</strong> <a href="21968.php">Jeff Squyres (jsquyres): "Re: [OMPI users] -Re Post- MPI_SUM is not defined on the MPI_INTEGER	datatype"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21974.php">George Bosilca: "Re: [OMPI users] -Re Post- MPI_SUM is not defined on the MPI_INTEGER datatype"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
--------------------------------------------------------------------------
<br>
[linux-mwmw.site:01535] [[25215,0],0] ORTE_ERROR_LOG: Not found in file
<br>
...
<br>
<p><p><p>2013/5/28 Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt;
<br>
<p><span class="quotelev1">&gt; Per the email that you forwarded below, I replied to you off list saying
</span><br>
<span class="quotelev1">&gt; that we could figure it out without bothering people, and then post the
</span><br>
<span class="quotelev1">&gt; final resolution back to the list (I do this sometimes when figuring out a
</span><br>
<span class="quotelev1">&gt; problem is going to take a bunch of back-and-forth).  On May 25th, I
</span><br>
<span class="quotelev1">&gt; replied to your mail asking for more information that you did not provide.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Do you want to go reply to that mail from May 25?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; On May 27, 2013, at 7:05 AM, Hayato KUNIIE &lt;kuni255_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; -------------------------------------- All informaion is showd in
</span><br>
<span class="quotelev1">&gt; attached file err.log. and source file is attached as main.f
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Let's figure this out off-list and post the final resolution back to
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; You launched this mpirun from a single node, right?  I'm trying to make
</span><br>
<span class="quotelev1">&gt; sure that you're doing non-interactive logins on the remote nodes to find
</span><br>
<span class="quotelev1">&gt; the ompi_info's, because sometimes there's a difference between paths that
</span><br>
<span class="quotelev1">&gt; are set for interactive and non-interactive logins.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On May 16, 2013, at 9:53 AM, Hayato KUNIIE &lt;kuni255_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
...
<span class="quotelev4">&gt; &gt;&gt;&gt; Package: Open MPI root_at_bwhead.clnet Distribution  Open MPI
</span><br>
<span class="quotelev1">&gt; root_at_bwslv01 Distribution  Open MPI root_at_bwslv02 Distribution
</span><br>
...
<span class="quotelev1">&gt; x86_64-unknown-linux-gnu  x86_64-unknown-linux-gnu
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran77 compiler abs: /usr/bin/gfortran  /usr/bin/gfortran
</span><br>
<span class="quotelev1">&gt; /usr/bin/gfortran
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran90 compiler: gfortran  gfortran  gfortran
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran90 compiler abs: /usr/bin/gfortran  /usr/bin/gfortran
</span><br>
<span class="quotelev1">&gt; /usr/bin/gfortran
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; Package: Open MPI root_at_bwslv01 Distribution  execinfo (MCA v2.0, API
</span><br>
<span class="quotelev1">&gt; v2.0, Component v1.6.4)  execinfo (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open MPI: 1.6.4  linux (MCA v2.0, API v2.0, Component v1.6.4) linux
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open MPI SVN revision: r28081  hwloc (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  hwloc (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open MPI release date: Feb 19, 2013  auto_detect (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  auto_detect (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open RTE: 1.6.4  file (MCA v2.0, API v2.0, Component v1.6.4)  file
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open RTE SVN revision: r28081  mmap (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  mmap (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open RTE release date: Feb 19, 2013  posix (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  posix (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; OPAL: 1.6.4  sysv (MCA v2.0, API v2.0, Component v1.6.4)  sysv (MCA
</span><br>
<span class="quotelev1">&gt; v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; OPAL SVN revision: r28081  first_use (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  first_use (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; OPAL release date: Feb 19, 2013  hwloc (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  hwloc (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI API: 2.1  linux (MCA v2.0, API v2.0, Component v1.6.4)  linux (MCA
</span><br>
<span class="quotelev1">&gt; v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Ident string: 1.6.4  env (MCA v2.0, API v2.0, Component v1.6.4) env
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Prefix: /usr/local  config (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt; config (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Configured architecture: x86_64-unknown-linux-gnu  linux (MCA v2.0,
</span><br>
<span class="quotelev1">&gt; API v2.0, Component v1.6.4)  linux (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Configure host: bwslv01  hwloc132 (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  hwloc132 (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Configured by: root  orte (MCA v2.0, API v2.0, Component v1.6.4) orte
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Configured on: Wed May  8 20:56:45 JST 2013  orte (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  orte (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Configure host: bwslv01  basic (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  basic (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Built by: root  bucket (MCA v2.0, API v2.0, Component v1.6.4) bucket
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Built on: Wed May  8 21:05:43 JST 2013  basic (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  basic (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Built host: bwslv01  hierarch (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  hierarch (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C bindings: yes  inter (MCA v2.0, API v2.0, Component v1.6.4) inter
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C++ bindings: yes  self (MCA v2.0, API v2.0, Component v1.6.4) self
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran77 bindings: yes (all)  sm (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  sm (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran90 bindings: yes  sync (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  sync (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran90 bindings size: small  tuned (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  tuned (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C compiler: gcc  romio (MCA v2.0, API v2.0, Component v1.6.4) romio
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C compiler absolute: /usr/bin/gcc  fake (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  fake (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C compiler family name: GNU  rdma (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  rdma (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C compiler version: 4.4.7  sm (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  sm (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C++ compiler: g++  bfo (MCA v2.0, API v2.0, Component v1.6.4)  bfo
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C++ compiler absolute: /usr/bin/g++  csum (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  csum (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran77 compiler: gfortran  ob1 (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  ob1 (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran77 compiler abs: /usr/bin/gfortran  v (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  v (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran90 compiler: gfortran  r2 (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  r2 (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran90 compiler abs: /usr/bin/gfortran  vma (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  vma (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C profiling: yes  self (MCA v2.0, API v2.0, Component v1.6.4) self
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C++ profiling: yes  sm (MCA v2.0, API v2.0, Component v1.6.4)  sm (MCA
</span><br>
<span class="quotelev1">&gt; v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran77 profiling: yes  tcp (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  tcp (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Fortran90 profiling: yes  unity (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  unity (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; C++ exceptions: no  pt2pt (MCA v2.0, API v2.0, Component v1.6.4) pt2pt
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Thread support: posix (MPI_THREAD_MULTIPLE: no, progress: no) rdma
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)  rdma (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Sparse Groups: no  hnp (MCA v2.0, API v2.0, Component v1.6.4)  hnp
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Internal debug support: no  orted (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  orted (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI interface warnings: no  tool (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  tool (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI parameter check: runtime  tcp (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  tcp (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Memory profiling support: no  default (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  default (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Memory debugging support: no  cm (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  cm (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; libltdl support: yes  loadleveler (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  loadleveler (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Heterogeneous support: no  slurm (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  slurm (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; mpirun default --prefix: no  load_balance (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  load_balance (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI I/O support: yes  rank_file (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  rank_file (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI_WTIME support: gettimeofday  resilient (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  resilient (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Symbol vis. support: yes  round_robin (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  round_robin (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Host topology support: yes  seq (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  seq (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI extensions: affinity example  topo (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  topo (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; FT Checkpoint support: no (checkpoint thread: no)  oob (MCA v2.0, API
</span><br>
<span class="quotelev1">&gt; v2.0, Component v1.6.4)  oob (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; VampirTrace support: yes  binomial (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  binomial (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI_MAX_PROCESSOR_NAME: 256  cm (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  cm (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI_MAX_ERROR_STRING: 256  direct (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  direct (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI_MAX_OBJECT_NAME: 64  linear (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  linear (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI_MAX_INFO_KEY: 36  radix (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  radix (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI_MAX_INFO_VAL: 256  slave (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  slave (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI_MAX_PORT_NAME: 1024  rsh (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  rsh (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI_MAX_DATAREP_STRING: 128  slurm (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  slurm (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Package: Open MPI root_at_bwslv02 Distribution  rsh (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  rsh (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open MPI: 1.6.4  default (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt; default (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open MPI SVN revision: r28081  env (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  env (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open MPI release date: Feb 19, 2013  hnp (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  hnp (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open RTE: 1.6.4  singleton (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt; singleton (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open RTE SVN revision: r28081  slave (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  slave (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Open RTE release date: Feb 19, 2013  slurm (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt; Component v1.6.4)  slurm (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; OPAL: 1.6.4  slurmd (MCA v2.0, API v2.0, Component v1.6.4)  slurmd
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; OPAL SVN revision: r28081  tool (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  tool (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; OPAL release date: Feb 19, 2013  bad (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt; v1.6.4)  bad (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; MPI API: 2.1  basic (MCA v2.0, API v2.0, Component v1.6.4)  basic (MCA
</span><br>
<span class="quotelev1">&gt; v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Ident string: 1.6.4  hier (MCA v2.0, API v2.0, Component v1.6.4) hier
</span><br>
<span class="quotelev1">&gt; (MCA v2.0, API v2.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Prefix: /usr/local  command (MCA v2.0, API v1.0, Component v1.6.4)
</span><br>
<span class="quotelev1">&gt;  command (MCA v2.0, API v1.0, Component v1.6.4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Configured architecture: x86_64-unknown-linux-gnu  syslog (MCA v2.0,
</span><br>
<span class="quotelev1">&gt; API v1.0, Component v1.6.4)  syslog (MCA v2.0, API v1.0, Component v1.6.4)
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; I am unable to replicate your error -- 1.6.4 has MPI_REDUCE defined
</span><br>
<span class="quotelev1">&gt; on MPI_SUM properly.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; (insert whatever hostfile and -np value you're using for your fortran
</span><br>
<span class="quotelev1">&gt; test) and see what is reported as the OMPI version from other nodes.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; On May 15, 2013, at 7:46 AM, Hayato KUNIIE &lt;kuni255_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; Are you sure that you have exactly the same version of Open MPI on
</span><br>
<span class="quotelev1">&gt; all your nodes?
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; On May 14, 2013, at 11:39 AM, Hayato KUNIIE &lt;
</span><br>
<span class="quotelev1">&gt; kuni255_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; And sharing home directory in head node by NFS. so Open MPI is
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; When I test this program on only head node, program is run
</span><br>
<span class="quotelev1">&gt; correctly.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; and output result.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; But When I test this program on only slave node, same error
</span><br>
<span class="quotelev1">&gt; occured.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [bwslv01:30793] *** MPI_ERRORS_ARE_FATAL: your MPI job will now
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; node bwslv01 exiting improperly. There are two reasons this could
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; 2. this process called &quot;init&quot;, but exited without calling
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [bwhead.clnet:02147] Set MCA parameter &quot;orte_base_help_aggregate&quot;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21969/attachment">attachment</a>
</ul>
