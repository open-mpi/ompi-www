...
?>
<!-- received="Wed May 15 20:12:15 2013" -->
<!-- isoreceived="20130516001215" -->
<!-- sent="Thu, 16 May 2013 00:12:08 +0000" -->
<!-- isosent="20130516001208" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_SUM is not defined on the MPI_INTEGER datatype" -->
<!-- id="EF66BBEB19BADC41AC8CCF5F684F07FC4F6249FF_at_xmb-rcd-x01.cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="519375A0.3030309_at_oita.email.ne.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-05-15 20:12:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21909.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Subject: Building openmpi-1.6.4 with 64-bit integers"</a>
<li><strong>Previous message:</strong> <a href="21907.php">H Hogreve: "[OMPI users] Subject: Building openmpi-1.6.4 with 64-bit integers"</a>
<li><strong>In reply to:</strong> <a href="21906.php">Hayato KUNIIE: "Re: [OMPI users] MPI_SUM is not defined on the MPI_INTEGER datatype"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21912.php">Hayato KUNIIE: "Re: [OMPI users] MPI_SUM is not defined on the MPI_INTEGER datatype"</a>
<li><strong>Reply:</strong> <a href="21912.php">Hayato KUNIIE: "Re: [OMPI users] MPI_SUM is not defined on the MPI_INTEGER datatype"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Are you absolutely sure you're using OMPI 1.6.4 on all nodes?
<br>
<p>Try this:
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;mpirun ... ompi_info
<br>
<p>(insert whatever hostfile and -np value you're using for your fortran test) and see what is reported as the OMPI version from other nodes.
<br>
<p><p>On May 15, 2013, at 7:46 AM, Hayato KUNIIE &lt;kuni255_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I using Ver, 1.6.4 in all nodes.
</span><br>
