...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21850.php">Stefan Friedel: "[OMPI users] libtool *.la files with references to install dir"</a>
<li><strong>Previous message:</strong> <a href="21848.php">John Chludzinski: "Re: [OMPI users] Message queue in MPI?"</a>
<li><strong>In reply to:</strong> <a href="21848.php">John Chludzinski: "Re: [OMPI users] Message queue in MPI?"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
