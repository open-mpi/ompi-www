...
<p class="headers">
<strong>Subject:</strong> [OMPI users] libtool *.la files with references to install dir<br>
<strong>From:</strong> Stefan Friedel (<em>stefan.friedel_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-05-03 10:19:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21851.php">Angel de Vicente: "[OMPI users] Help diagnosing problem: not being able to run MPI code across computers"</a>
<li><strong>Previous message:</strong> <a href="21849.php">Aur&#233;lien Bouteiller: "Re: [OMPI users] Message queue in MPI?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21855.php">Jeff Squyres (jsquyres): "Re: [OMPI users] libtool *.la files with references to install dir"</a>
<li><strong>Reply:</strong> <a href="21855.php">Jeff Squyres (jsquyres): "Re: [OMPI users] libtool *.la files with references to install dir"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21850/signature.asc">Digital signature</a>
</ul>
