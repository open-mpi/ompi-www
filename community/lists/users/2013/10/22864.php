...
?>
<!-- received="Wed Oct 30 12:26:40 2013" -->
<!-- isoreceived="20131030162640" -->
<!-- sent="Wed, 30 Oct 2013 09:26:37 -0700" -->
<!-- isosent="20131030162637" -->
<!-- name="Rolf vandeVaart" -->
<!-- email="rvandevaart_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI-1.7.3 - cuda support" -->
<!-- id="3AF945EBF4D3EC41AFE44EED9B0585F3600803E2D5_at_HQMAIL02.nvidia.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="123B4248067C9C49ABB98E5EA3F72B2416327C40_at_E-EXDAGE-B1.extra.cea.fr" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-10-30 12:26:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22865.php">Robo Beans: "[OMPI users] ofed installation"</a>
<li><strong>Previous message:</strong> <a href="22863.php">KESTENER Pierre: "Re: [OMPI users] OpenMPI-1.7.3 - cuda support"</a>
<li><strong>In reply to:</strong> <a href="22863.php">KESTENER Pierre: "Re: [OMPI users] OpenMPI-1.7.3 - cuda support"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22874.php">KESTENER Pierre: "Re: [OMPI users] OpenMPI-1.7.3 - cuda support"</a>
<li><strong>Reply:</strong> <a href="22874.php">KESTENER Pierre: "Re: [OMPI users] OpenMPI-1.7.3 - cuda support"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>This will force the use of the verbs support layer (openib) with the CUDA-aware support.
<br>
<p><p>From: users [mailto:users-bounces_at_[hidden]] On Behalf Of KESTENER Pierre
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22864/attachment">attachment</a>
</ul>
