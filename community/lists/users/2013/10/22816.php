...
?>
<!-- received="Tue Oct 22 15:49:32 2013" -->
<!-- isoreceived="20131022194932" -->
<!-- sent="Tue, 22 Oct 2013 13:49:31 -0600" -->
<!-- isosent="20131022194931" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_IN_PLACE with GATHERV, AGATHERV, and SCATERV" -->
<!-- id="20131022194931.GA3350_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="0A970F4038D541469E279AD555D8781630C1B249_at_mbx256-1.adm.swri.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-10-22 15:49:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22817.php">Gerlach, Charles A.: "Re: [OMPI users] MPI_IN_PLACE with GATHERV, AGATHERV, and SCATERV"</a>
<li><strong>Previous message:</strong> <a href="22815.php">Gerlach, Charles A.: "Re: [OMPI users] MPI_IN_PLACE with GATHERV, AGATHERV, and SCATERV"</a>
<li><strong>In reply to:</strong> <a href="22815.php">Gerlach, Charles A.: "Re: [OMPI users] MPI_IN_PLACE with GATHERV, AGATHERV, and SCATERV"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22817.php">Gerlach, Charles A.: "Re: [OMPI users] MPI_IN_PLACE with GATHERV, AGATHERV, and SCATERV"</a>
<li><strong>Reply:</strong> <a href="22817.php">Gerlach, Charles A.: "Re: [OMPI users] MPI_IN_PLACE with GATHERV, AGATHERV, and SCATERV"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
your reproducer. Both MPI_SCATTER and MPI_SCATTERV had this bug. The bug does not
<br>
exist in 1.6.x though so I don't know why it was failing there.
<br>
<p>I don't see a problem with MPI_GATHER or MPI_GATHERV though. Can you send a
<br>
...
<span class="quotelev1">&gt;                      (All procs print out the correct values.)
</span><br>
<span class="quotelev1">&gt; With Intel (on a Mac Pro): Complains about a null communicator in MPI_FINALIZE and crashes. All procs print out the correct values.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Subject: Re: [OMPI users] MPI_IN_PLACE with GATHERV, AGATHERV, and SCATERV
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; These functions are tested nightly and there has been no indication any of these
</span><br>
<span class="quotelev1">&gt; functions fail with MPI_IN_PLACE. Can you provide a reproducer?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
