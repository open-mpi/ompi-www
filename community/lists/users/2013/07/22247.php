...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22248.php">basma a.azeem: "[OMPI users] checkpoint-restart of version 1.6.5"</a>
<li><strong>Previous message:</strong> <a href="22246.php">Gustavo Correa: "Re: [OMPI users] example program &quot;ring&quot; hangs when running across multiple hardware nodes"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22252.php">Jed O. Kaplan: "Re: [OMPI users] example program &quot;ring&quot; hangs when running across multiple hardware nodes (SOLVED)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
