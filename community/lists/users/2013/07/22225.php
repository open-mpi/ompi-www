...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22226.php">Jeff Squyres (jsquyres): "Re: [OMPI users] [PATCH] hooks: disable malloc override inside of	Gentoo sandbox"</a>
<li><strong>Previous message:</strong> <a href="../../2013/06/22224.php">Ralph Castain: "Re: [OMPI users] Fixing Intel Compiler and OpenMPI 1.6.X (or any version)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22226.php">Jeff Squyres (jsquyres): "Re: [OMPI users] [PATCH] hooks: disable malloc override inside of	Gentoo sandbox"</a>
<li><strong>Reply:</strong> <a href="22226.php">Jeff Squyres (jsquyres): "Re: [OMPI users] [PATCH] hooks: disable malloc override inside of	Gentoo sandbox"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>application/pgp-signature attachment: <a href="../../att-22225/signature.asc">Digital signature</a>
</ul>
