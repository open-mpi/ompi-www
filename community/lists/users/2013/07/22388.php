...
?>
<!-- received="Thu Jul 25 16:51:01 2013" -->
<!-- isoreceived="20130725205101" -->
<!-- sent="Thu, 25 Jul 2013 16:50:35 -0400" -->
<!-- isosent="20130725205035" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] errors testing openmpi1.6.5 ----" -->
<!-- id="51F18F9B.2050107_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="D26659322AE6E9448EE9F7E692F133BF0B1FC0DF_at_EXCHANGE2010.fdwt.local" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-07-25 16:50:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22389.php">Yuping Sun: "Re: [OMPI users] errors testing openmpi1.6.5 ----"</a>
<li><strong>Previous message:</strong> <a href="22387.php">Saliya Ekanayake: "Re: [OMPI users] UnsatisfiedLinkError - libmpi_java.so.0.0.0"</a>
<li><strong>In reply to:</strong> <a href="22386.php">Yuping Sun: "Re: [OMPI users] errors testing openmpi1.6.5 ----"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22389.php">Yuping Sun: "Re: [OMPI users] errors testing openmpi1.6.5 ----"</a>
<li><strong>Reply:</strong> <a href="22389.php">Yuping Sun: "Re: [OMPI users] errors testing openmpi1.6.5 ----"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Yuping
<br>
<p>A simple way to do it is to put in your initialization files,
<br>
...
<br>
<p>Are you running the programs in a single machine,
<br>
or is it a cluster or some farm or networked machines?
<br>
In the second case, you need to make sure your home directory
<br>
is shared across the machines, or if it is not shared,
<br>
you need to make the modifications above in each machine.
<br>
<p>I hope this helps.
<br>
<p>Gus Correa
...
<span class="quotelev2">&gt;&gt; I also try the use ompi_info to get more information, and it give me a
</span><br>
<span class="quotelev2">&gt;&gt; lot error messages and I listed some below:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; /usr/local/openmpi1.6.5/lib/openmpi/mca_btl_tcp: lt_dlerror() returned
</span><br>
<span class="quotelev2">&gt;&gt; NULL! (ignored)
</span><br>
<span class="quotelev2">&gt;&gt;
