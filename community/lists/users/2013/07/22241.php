...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22242.php">Jeff Squyres (jsquyres): "Re: [OMPI users] jemalloc and crash in opal_memory_linux_ptmalloc2_open"</a>
<li><strong>Previous message:</strong> <a href="22240.php">Brian Budge: "[OMPI users] jemalloc and crash in opal_memory_linux_ptmalloc2_open"</a>
<li><strong>In reply to:</strong> <a href="22239.php">Riccardo Murri: "Re: [OMPI users] openmpi 1.6.3 fails to identify local host if its IP is 127.0.1.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22243.php">Riccardo Murri: "Re: [OMPI users] openmpi 1.6.3 fails to identify local host if its IP is 127.0.1.1"</a>
<li><strong>Reply:</strong> <a href="22243.php">Riccardo Murri: "Re: [OMPI users] openmpi 1.6.3 fails to identify local host if its IP is 127.0.1.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
