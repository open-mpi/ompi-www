...
?>
<!-- received="Thu Jul 25 19:22:09 2013" -->
<!-- isoreceived="20130725232209" -->
<!-- sent="Thu, 25 Jul 2013 19:21:55 -0400" -->
<!-- isosent="20130725232155" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] errors testing openmpi1.6.5 ----" -->
<!-- id="51F1B313.3030506_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="D26659322AE6E9448EE9F7E692F133BF0B1FC1BE_at_EXCHANGE2010.fdwt.local" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-07-25 19:21:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22391.php">Yuping Sun: "Re: [OMPI users] errors testing openmpi1.6.5 ----"</a>
<li><strong>Previous message:</strong> <a href="22389.php">Yuping Sun: "Re: [OMPI users] errors testing openmpi1.6.5 ----"</a>
<li><strong>In reply to:</strong> <a href="22389.php">Yuping Sun: "Re: [OMPI users] errors testing openmpi1.6.5 ----"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22391.php">Yuping Sun: "Re: [OMPI users] errors testing openmpi1.6.5 ----"</a>
<li><strong>Reply:</strong> <a href="22391.php">Yuping Sun: "Re: [OMPI users] errors testing openmpi1.6.5 ----"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Yuping
<br>
<p>Something seems to be broken in the way you set your environment
<br>
variables.
<br>
...
<br>
<p>When  a  login  shell  exits, bash reads and executes commands from the
<br>
...
***
<br>
<p>Notice the difference between interactive login shells,
<br>
and interactive shell that is not a login shell.
<br>
<p>However, it is hard to guess what it is going on.
<br>
We (the OMPI list) don't even know if you are running the
<br>
job in a single machine, or on a cluster, or on a few networked
<br>
workstations.
<br>
It would help if you tell more.
<br>
<p>Anyway, you could try to pass along the environment variables
<br>
...
<br>
export LD_LIBRARY_PATH=... (whatever you use)
<br>
mpiexec -x PATH -x LD_LIBRARY_PATH -np 4 ./my_program
<br>
<p>***
<br>
...
<br>
the best approach is to fix for good the problems with
<br>
your environment.
<br>
...
<span class="quotelev3">&gt;&gt;&gt; /usr/local/openmpi1.6.5/lib/openmpi/mca_paffinity_hwloc: lt_dlerror()
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; /usr/local/openmpi1.6.5/lib/openmpi/mca_btl_sm: lt_dlerror() returned
</span><br>
<span class="quotelev3">&gt;&gt;&gt; NULL! (ignored)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [ysunrh.fdwt.com:24920] mca: base: component_find: unable to open
