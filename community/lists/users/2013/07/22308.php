...
?>
<!-- received="Tue Jul  9 14:59:42 2013" -->
<!-- isoreceived="20130709185942" -->
<!-- sent="Tue, 9 Jul 2013 13:59:38 -0500" -->
<!-- isosent="20130709185938" -->
...
<!-- id="CA+OO3AUJjjdYwWH7CPo7SV_pN+RpgB+oSLxGndV0kuBhuRooMg_at_mail.gmail.com" -->
...
<strong>Date:</strong> 2013-07-09 14:59:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22309.php">Mike Dubman: "Re: [OMPI users] using the xrc queues"</a>
<li><strong>Previous message:</strong> <a href="22307.php">Ralph Castain: "Re: [OMPI users] Support for CUDA and GPU-direct with OpenMPI 1.6.5	an 1.7.2"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22310.php">Tim Carlson: "[OMPI users] Hints for running OpenMPI on Intel/Phi (MIC) enabled hosts"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Now you should be able to let part of the same OpenMPI application run on
<br>
...
<br>
<p>I guess you should be able to directly do this from the same OpenMPI mpirun
<br>
command line ...
<br>
<p>thanks
...
Michael
<br>
<p><p>On Tue, Jul 9, 2013 at 12:18 PM, Tim Carlson &lt;tim.carlson_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; On Mon, 8 Jul 2013, Tim Carlson wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Now that I have gone through this process, I'll report that it works with
</span><br>
<span class="quotelev1">&gt; the caveat that you can't use the openmpi wrappers for compiling. Recall
</span><br>
<span class="quotelev1">&gt; that the Phi card does not have either the GNU or Intel compilers
</span><br>
<span class="quotelev1">&gt; installed. While you could build up a tool chain for the GNU compilers,
</span><br>
<span class="quotelev1">&gt; you're not going to get a native Intel compiler unless Intel decides to
</span><br>
<span class="quotelev1">&gt; support it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Here is the process from end to end to get Openmpi to build a native Phi
</span><br>
...
<span class="quotelev1">&gt; . /share/apps/intel/composer_xe_**2013.3.163/bin/iccvars.sh intel64
</span><br>
...
<span class="quotelev1">&gt; That leaves me with a native build of openmpi in
</span><br>
<span class="quotelev1">&gt; /people/tim/mic/openmpi/intel
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; 1) If I try this on the host system I am going to get &quot;wrong architecture&quot;
</span><br>
<span class="quotelev1">&gt; because mpicc was build for the Phi and not for the x86_64 host
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; 2) If I try running it on the Phi, I don't have access to &quot;icc&quot; because I
</span><br>
<span class="quotelev1">&gt; can't run the compiler directly on the Phi.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I can &quot;cheat&quot; and see what the mpicc command really does by using &quot;mpicc
</span><br>
<span class="quotelev1">&gt; --show&quot; for another installation of openmpi and munge the paths correctly.
</span><br>
<span class="quotelev1">&gt; In this case
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; That leaves me with a Phi native version of cpi.x which I can then execute
</span><br>
<span class="quotelev1">&gt; on the Phi
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; ~ $ export LD_LIBRARY_PATH=/share/apps/**intel/composer_xe_2013.3.163/**
</span><br>
<span class="quotelev1">&gt; compiler/lib/mic/
</span><br>
<span class="quotelev1">&gt; ~ $ export LD_LIBRARY_PATH=/people/tim/**mic/openmpi/intel/lib:$LD_**
</span><br>
<span class="quotelev1">&gt; LIBRARY_PATH
</span><br>
...
<span class="quotelev2">&gt;&gt; My mistake on the OFED bits. The host I was installing on did not have
</span><br>
<span class="quotelev2">&gt;&gt; all of the MPSS software installed (my cluster admin node and not one of
</span><br>
<span class="quotelev2">&gt;&gt; the compute nodes). Adding the intel-mic-ofed-card RPM fixed the problem
</span><br>
<span class="quotelev2">&gt;&gt; with compiling the btl:openib bits with both the GNU and Intel compilers
</span><br>
<span class="quotelev2">&gt;&gt; using the cross-compiler route (-mmic on the Intel side)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Still working on getting the resulting mpicc wrapper working on the MIC
</span><br>
<span class="quotelev2">&gt;&gt; side. When I get a working example I'll post the results.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;  Good idea Michael,  With the Intel Compiler, I would use the -mmic flag
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;  Tim wrote: &#147;My first pass at doing a cross-compile with the GNU
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;  ./configure --build=x86_64-unknown-linux-**gnu
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;  On Mon, Jul 8, 2013 at 4:30 PM, Tim Carlson &lt;tim.carlson_at_[hidden]&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;  See this post <a href="http://software.intel.com/en-**us/forums/topic/382057<http://software.intel.com/en-us/forums/topic/382057">http://software.intel.com/en-**us/forums/topic/382057<http://software.intel.com/en-us/forums/topic/382057</a>&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; Environmental Molecular Sciences Laboratory
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22308/attachment">attachment</a>
</ul>
