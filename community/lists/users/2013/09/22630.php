...
?>
<!-- received="Tue Sep 10 05:02:58 2013" -->
<!-- isoreceived="20130910090258" -->
<!-- sent="Tue, 10 Sep 2013 09:02:56 +0000" -->
<!-- isosent="20130910090256" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] how to build a relocatable OpenMPI RPM ?" -->
<!-- id="EF66BBEB19BADC41AC8CCF5F684F07FC4F87843D_at_xmb-rcd-x01.cisco.com" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2013-09-10 05:02:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22631.php">caohaijun: "Re: [OMPI users] how to build a relocatable OpenMPI RPM ?"</a>
<li><strong>Previous message:</strong> <a href="22629.php">Ralph Castain: "Re: [OMPI users] how to build a relocatable OpenMPI RPM ?"</a>
<li><strong>In reply to:</strong> <a href="22628.php">caohaijun: "[OMPI users] how to build a relocatable OpenMPI RPM ?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22633.php">caohaijun: "Re: [OMPI users] how to build a relocatable OpenMPI RPM ?"</a>
<li><strong>Reply:</strong> <a href="22633.php">caohaijun: "Re: [OMPI users] how to build a relocatable OpenMPI RPM ?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Note that Open MPI hard-codes its installation directory into some of its libraries and executables (so that it can find its data files, etc.).  So we don't support relocatable RPMs, in the RPM sense of the word &quot;relocatable&quot;.
<br>

<br>
You can, however, override OMPI's hard-coded installation location with various environment variables, however.  See <a href="http://www.open-mpi.org/faq/?category=building#installdirs.">http://www.open-mpi.org/faq/?category=building#installdirs.</a>
<br>
