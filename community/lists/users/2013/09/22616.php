...
?>
<!-- received="Sat Sep  7 00:08:23 2013" -->
<!-- isoreceived="20130907040823" -->
<!-- sent="Fri, 06 Sep 2013 21:08:14 -0700" -->
<!-- isosent="20130907040814" -->
<!-- name="Tom Rosmond" -->
<!-- email="rosmond_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_IN_PLACE in a call to MPI_Allreduce in Fortran" -->
<!-- id="1378526894.3458.31.camel_at_cedar.reachone.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2013-09-07 00:08:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22617.php">Tom Rosmond: "Re: [OMPI users] MPI_IN_PLACE in a call to MPI_Allreduce in Fortran"</a>
<li><strong>Previous message:</strong> <a href="22615.php">Hugo Gagnon: "Re: [OMPI users] MPI_IN_PLACE in a call to MPI_Allreduce in Fortran"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22617.php">Tom Rosmond: "Re: [OMPI users] MPI_IN_PLACE in a call to MPI_Allreduce in Fortran"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>&nbsp;What fortran compiler are you using?  
<br>
<p>T. Rosmond
<br>
