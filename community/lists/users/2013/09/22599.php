...
?>
<!-- received="Tue Sep  3 18:34:12 2013" -->
<!-- isoreceived="20130903223412" -->
<!-- sent="Tue, 3 Sep 2013 22:33:57 +0000" -->
<!-- isosent="20130903223357" -->
...
<!-- id="CE4BAC84.358F1%knteran_at_sandia.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="9C229F17-2C8E-4215-B1C1-F4DE497E2378_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-09-03 18:33:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22600.php">Nathan Hjelm: "Re: [OMPI users] [EXTERNAL] Re: What version of PMI (Cray XE6) is working for OpenMPI-1.6.5?"</a>
<li><strong>Previous message:</strong> <a href="22598.php">Ralph Castain: "Re: [OMPI users] [EXTERNAL] Re: What version of PMI (Cray XE6) is working for OpenMPI-1.6.5?"</a>
<li><strong>In reply to:</strong> <a href="22598.php">Ralph Castain: "Re: [OMPI users] [EXTERNAL] Re: What version of PMI (Cray XE6) is working for OpenMPI-1.6.5?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22600.php">Nathan Hjelm: "Re: [OMPI users] [EXTERNAL] Re: What version of PMI (Cray XE6) is working for OpenMPI-1.6.5?"</a>
<li><strong>Reply:</strong> <a href="22600.php">Nathan Hjelm: "Re: [OMPI users] [EXTERNAL] Re: What version of PMI (Cray XE6) is working for OpenMPI-1.6.5?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Here is what I put in my PBS script to allocate only single node (I want
<br>
...
#PBS -l mppdepth=1
<br>
<p>Here is the output from aprun (aprun -n 16 -N 16).
<br>
...
<br>
<p><p><p>I am guessing that the CrayXE6 here is different from the others in
<br>
...
Keita
<br>
<p>On 9/3/13 2:51 PM, &quot;Ralph Castain&quot; &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt;Interesting - and do you have an allocation? If so, what was it - i.e.,
</span><br>
<span class="quotelev1">&gt;can you check the allocation envar to see if you have 16 slots?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;On Sep 3, 2013, at 1:38 PM, &quot;Teranishi, Keita&quot; &lt;knteran_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; It is what I got.
</span><br>
...
<span class="quotelev2">&gt;&gt; There are not enough slots available in the system to satisfy the 16
</span><br>
<span class="quotelev2">&gt;&gt;slots
</span><br>
<span class="quotelev2">&gt;&gt; that were requested by the application:
</span><br>
<span class="quotelev2">&gt;&gt;  /home/knteran/test-openmpi/cpi
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On 9/3/13 1:26 PM, &quot;Ralph Castain&quot; &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; How does it fail?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Sep 3, 2013, at 1:19 PM, &quot;Teranishi, Keita&quot; &lt;knteran_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Thanks for the help.  I can run a job using openmpi, assigning a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;signle
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; process per node.  However, I have been failing to run a job using
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; multiple MPI ranks in a single node.  In other words, &quot;mpiexec
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --bind-to-core --npernode 16 --n 16 ./test&quot; never works (apron -n 16
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; works
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; fine).  DO you have any thought about it?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; R&amp;D Principal Staff Member
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 8/30/13 8:49 AM, &quot;Hjelm, Nathan T&quot; &lt;hjelmn_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Replace install_path to where you want Open MPI installed.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; You can then use mpicc, mpicxx, mpif90, etc to compile and either
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mpirun
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; or aprun to run. If you are running at scale I would recommend
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;against
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; using aprun for now. I also recommend you change your programming
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; environment to either PrgEnv-gnu or PrgEnv-intel. The PGI compiler
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; From: users [users-bounces_at_[hidden]] on behalf of Teranishi,
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] [EXTERNAL] Re: What version of PMI (Cray
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Thanks for the info.  Is it still possible to build by myself?  What
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Open MPI 1.6.5 does not have support for the XE-6. Use 1.7.2
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; causes a warning to be printed on every rank when using mpirun. We
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;are
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; working with Cray to resolve the issue. For now use 2.1.4. See the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; platform files in contrib/platform/lanl/cray_xe6. The platform files
</span><br>
