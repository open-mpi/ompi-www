...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22628.php">caohaijun: "[OMPI users] how to build a relocatable OpenMPI RPM ?"</a>
<li><strong>Previous message:</strong> <a href="22626.php">Max Staufer: "Re: [OMPI users] OMPI_LIST_GROW keeps allocating memory"</a>
<li><strong>In reply to:</strong> <a href="22626.php">Max Staufer: "Re: [OMPI users] OMPI_LIST_GROW keeps allocating memory"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
