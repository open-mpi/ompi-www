...
?>
<!-- received="Mon Feb 11 13:38:01 2013" -->
<!-- isoreceived="20130211183801" -->
<!-- sent="Mon, 11 Feb 2013 18:37:56 +0000" -->
<!-- isosent="20130211183756" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Building 1.6.3 on OS X 10.8" -->
<!-- id="EF66BBEB19BADC41AC8CCF5F684F07FC42CF4135_at_xmb-rcd-x01.cisco.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CD3E7461.C25C%daniel.beatty_at_navy.mil" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-02-11 13:37:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21375.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Simple MPI hello world hangs over IB"</a>
<li><strong>Previous message:</strong> <a href="21373.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Building 1.6.3 on OS X 10.8"</a>
<li><strong>In reply to:</strong> <a href="21372.php">Beatty, Daniel D CIV NAVAIR, 474300D: "Re: [OMPI users] Building 1.6.3 on OS X 10.8"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21379.php">Beatty, Daniel D CIV NAVAIR, 474300D: "Re: [OMPI users] Building 1.6.3 on OS X 10.8"</a>
<li><strong>Reply:</strong> <a href="21379.php">Beatty, Daniel D CIV NAVAIR, 474300D: "Re: [OMPI users] Building 1.6.3 on OS X 10.8"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
On Feb 11, 2013, at 1:11 PM, &quot;Beatty, Daniel D CIV NAVAIR, 474300D&quot; &lt;daniel.beatty_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; There are two issues that have concerned me.  One is universal capabilities, namely ensuring that the library allows the same results for binaries in both any of their universal compiled forms.   
</span><br>
<p>Not sure what you mean here -- are you referring to Intel+PPC &quot;universal&quot; OS X binaries?
<br>
<p><span class="quotelev1">&gt; Also, the linking of the MPI host files and marshaling capabilities.  I am hoping to address these issues in design before I get to implementation.  Naturally, there is a matter of tinkering that goes back and forth.  So I will need some help here.  Is there a standard for MPI currently in existence that enables such a thing?    
</span><br>
<p>Er... I'm also not sure what you mean here, either.  :-(
<br>
<p>What exactly do you mean by &quot;linking of MPI host files&quot;?  Host files are just text files; they're not involved with the (run-time or compile-time) linker at all.
<br>
<p>What marshaling capabilities are you referring to, MPI datatypes?
<br>
<p><span class="quotelev1">&gt; If there is a standard, is there a way to accredit such a standard for OSX if it gets built for universal capabilities?   What is the standards body for MPI to facilitate this?   If such a thing is built, how do we contribute back in a standards consistent way?
</span><br>
...
<span class="quotelev1">&gt; On 2/11/13 8:09 AM, &quot;Mark Bolstad&quot; &lt;the.render.dude_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; It's not just one plugin, it was about 6 of them. I just deleted the error message from the others as I believed that opal_init was the problem.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; /Users/bolstadm/papillon/build/macosx-x86_64/Release/openmpi-1.6.3/lib/openmpi/mca_paffinity_hwloc.la &lt;<a href="http://mca_paffinity_hwloc.la">http://mca_paffinity_hwloc.la</a>&gt; *
</span><br>
<span class="quotelev1">&gt; 
</span><br>
