...
?>
<!-- received="Thu Feb 21 19:39:08 2013" -->
<!-- isoreceived="20130222003908" -->
<!-- sent="Thu, 21 Feb 2013 16:38:48 -0800" -->
<!-- isosent="20130222003848" -->
<!-- name="Geoffrey Irving" -->
<!-- email="irving_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb" -->
<!-- id="CAJ1ofpfEjjtDWFAcWPtH3hZ=Ufh2s8CKdBKC7EdUMA2+hwNBtA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="121440D6-0614-41E9-9CE2-7F27F457C0C1_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-02-21 19:38:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21448.php">Geoffrey Irving: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<li><strong>Previous message:</strong> <a href="21446.php">Ralph Castain: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<li><strong>In reply to:</strong> <a href="21446.php">Ralph Castain: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21448.php">Geoffrey Irving: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<li><strong>Reply:</strong> <a href="21448.php">Geoffrey Irving: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
breaks.
<br>
<p>I'm trying to install gdb 7.5.1 now (a nontrivial process on Mac,
<br>
unfortunately) to see if that fixes it.
<br>
<p>Geoffrey
<br>
<p>On Thu, Feb 21, 2013 at 4:28 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt; Hmmm...how about that? Yeah, it doesn't work with the devel trunk either - I'd missed that point.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; No idea why, I'm afraid - never tried it before. Are you sure it &quot;crashes&quot;? I'm still getting a child status of &quot;0&quot;, but no message output. My guess is that the I/O is being lost for some reason.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Feb 21, 2013, at 4:09 PM, Geoffrey Irving &lt;irving_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Actually, I don't see it printing &quot;We're an MPI program!&quot; under gdb,
</span><br>
<span class="quotelev2">&gt;&gt; which means it isn't working.
</span><br>
...
<span class="quotelev2">&gt;&gt; On Thu, Feb 21, 2013 at 4:07 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hmmm...works with 1.6.4 for me on Mac 10.8.2:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ralphs-iMac:v1.6 rhc$ ./fork-bug
</span><br>
<span class="quotelev3">&gt;&gt;&gt; We're an MPI program!
</span><br>
<span class="quotelev3">&gt;&gt;&gt; child status = 0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ralphs-iMac:v1.6 rhc$ gdb ./fork-bug
</span><br>
<span class="quotelev3">&gt;&gt;&gt; GNU gdb 6.3.50-20050815 (Apple version gdb-1820) (Sat Jun 16 02:40:11 UTC 2012)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; This GDB was configured as &quot;x86_64-apple-darwin&quot;...Reading symbols for shared libraries ... done
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (gdb) r
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Starting program: /Volumes/RHCHD/rhc/openmpi/v1.6/fork-bug
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Afraid I have no idea why you might be hitting the problem, though...
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Feb 21, 2013, at 3:50 PM, Geoffrey Irving &lt;irving_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The singleton fork/exec itself is fine, since normal MPI programs work
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; under gdb (e.g., fork-bug.c without the fork).  gdb is has
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; follow-fork-mode set to parent, so it's odd that gdb is looking at the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; child process's trickery at all.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I've confirmed that it's still broken under 1.6.4, unfortunately.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Thu, Feb 21, 2013 at 3:36 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
