...
?>
<!-- received="Fri Feb 22 18:46:34 2013" -->
<!-- isoreceived="20130222234634" -->
<!-- sent="Fri, 22 Feb 2013 15:46:13 -0800" -->
<!-- isosent="20130222234613" -->
<!-- name="Geoffrey Irving" -->
<!-- email="irving_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb" -->
<!-- id="CAJ1ofpeTRyhtbtPmfJG9BPU9AbNo3AVocMjhWX7xDoa11D_W2w_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="8D073E26-6DC5-4792-9CA0-1706C10AF351_at_icl.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-02-22 18:46:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21454.php">Mohammad Mohsenie: "[OMPI users] mpirun (Aborted) error"</a>
<li><strong>Previous message:</strong> <a href="21452.php">Jeff Squyres (jsquyres): "Re: [OMPI users] uDAPL status"</a>
<li><strong>In reply to:</strong> <a href="21449.php">George Bosilca: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Geoffrey
<br>
<p>On Fri, Feb 22, 2013 at 11:18 AM, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt; Geoffrey,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; If I understand correctly your problem, I think it is a gdb issue. You should inform gdb that after the fork call instead of following the parent you expect to follow the child.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; set follow-fork-mode child (should do the trick).
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; For more info: <a href="http://sourceware.org/gdb/onlinedocs/gdb/Forks.html">http://sourceware.org/gdb/onlinedocs/gdb/Forks.html</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Feb 22, 2013, at 19:55 , Geoffrey Irving &lt;irving_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; No luck with gdb 7.5.1.  I can get it to run, but it hits an internal
</span><br>
<span class="quotelev2">&gt;&gt; error and bails out.  Thus, I'm stuck with Apple's 6.3.50.  I suppose
</span><br>
<span class="quotelev2">&gt;&gt; I'll try to restructure the app so that I don't have to spawn the mpi
</span><br>
<span class="quotelev2">&gt;&gt; process with a fork from the other one.
</span><br>
...
<span class="quotelev2">&gt;&gt; On Thu, Feb 21, 2013 at 4:38 PM, Geoffrey Irving &lt;irving_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; No, I don't really have any idea what it's doing.  You have to add
</span><br>
<span class="quotelev3">&gt;&gt;&gt; manual sleeps and attach another instance of gdb if you want to step
</span><br>
<span class="quotelev3">&gt;&gt;&gt; through the child, since I also can't get follow-fork-mode child to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; work.  I only tried that once, and it segfaulted accessing the zero
</span><br>
<span class="quotelev3">&gt;&gt;&gt; pointer destroying the stack in the process.  I haven't done manual
</span><br>
<span class="quotelev3">&gt;&gt;&gt; stepping or printf searches, so I don't know where in MPI_Init it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; breaks.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm trying to install gdb 7.5.1 now (a nontrivial process on Mac,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; unfortunately) to see if that fixes it.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Thu, Feb 21, 2013 at 4:28 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hmmm...how about that? Yeah, it doesn't work with the devel trunk either - I'd missed that point.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; No idea why, I'm afraid - never tried it before. Are you sure it &quot;crashes&quot;? I'm still getting a child status of &quot;0&quot;, but no message output. My guess is that the I/O is being lost for some reason.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Feb 21, 2013, at 4:09 PM, Geoffrey Irving &lt;irving_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Actually, I don't see it printing &quot;We're an MPI program!&quot; under gdb,
</span><br>
