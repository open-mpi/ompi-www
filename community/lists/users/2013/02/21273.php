...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21274.php">Randolph Pullen: "[OMPI users] Hi!!!"</a>
<li><strong>Previous message:</strong> <a href="21272.php">HM Li: "[OMPI users] Fwd: How openmpi-1.6.3 using nodes which not LSF dispatch?"</a>
<li><strong>In reply to:</strong> <a href="21272.php">HM Li: "[OMPI users] Fwd: How openmpi-1.6.3 using nodes which not LSF dispatch?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21283.php">Jeff Squyres (jsquyres): "Re: [OMPI users] How openmpi-1.6.3 using nodes which not LSF	dispatch?"</a>
<li><strong>Reply:</strong> <a href="21283.php">Jeff Squyres (jsquyres): "Re: [OMPI users] How openmpi-1.6.3 using nodes which not LSF	dispatch?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-21273/attachment">attachment</a>
</ul>
