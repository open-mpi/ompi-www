...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21277.php">Paul Hatton: "[OMPI users] FW:  error configuring OpenMPI 1.6.3 with gcc 4.7.2"</a>
<li><strong>Previous message:</strong> <a href="21275.php">Randolph Pullen: "[OMPI users] Re..."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21278.php">George Bosilca: "Re: [OMPI users] Asynchronous parallel I/O concerning MPI_File_write_all_begin() and MPI_File_write_all_end()"</a>
<li><strong>Reply:</strong> <a href="21278.php">George Bosilca: "Re: [OMPI users] Asynchronous parallel I/O concerning MPI_File_write_all_begin() and MPI_File_write_all_end()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
