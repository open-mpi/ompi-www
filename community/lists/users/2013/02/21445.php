...
?>
<!-- received="Thu Feb 21 19:16:43 2013" -->
<!-- isoreceived="20130222001643" -->
<!-- sent="Thu, 21 Feb 2013 16:09:55 -0800" -->
<!-- isosent="20130222000955" -->
<!-- name="Geoffrey Irving" -->
<!-- email="irving_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb" -->
<!-- id="CAJ1ofpeF1gsr2Xw09y7wpOBunrtNZHTXeLnq6uauP2-vLYTEUQ_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="E0F9CFDF-9A08-4A73-9792-9E654761EF0A_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-02-21 19:09:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21446.php">Ralph Castain: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<li><strong>Previous message:</strong> <a href="21444.php">Ralph Castain: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<li><strong>In reply to:</strong> <a href="21444.php">Ralph Castain: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21446.php">Ralph Castain: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<li><strong>Reply:</strong> <a href="21446.php">Ralph Castain: "Re: [OMPI users] openmpi MPI_Init doesn't work after fork under gdb"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Geoffrey
<br>
<p>On Thu, Feb 21, 2013 at 4:07 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
