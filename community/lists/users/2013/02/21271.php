...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21272.php">HM Li: "[OMPI users] Fwd: How openmpi-1.6.3 using nodes which not LSF dispatch?"</a>
<li><strong>Previous message:</strong> <a href="21270.php">Jeff Squyres (jsquyres): "Re: [OMPI users] configure: error: Could not run a simple Fortran 77	program. Aborting."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21365.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mmap and MPI_File_Read"</a>
<li><strong>Reply:</strong> <a href="21365.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mmap and MPI_File_Read"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-21271/attachment">attachment</a>
</ul>
