...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21271.php">Andreas Bok Andersen: "[OMPI users] mmap and MPI_File_Read"</a>
<li><strong>Previous message:</strong> <a href="21269.php">Syed Ahsan Ali: "Re: [OMPI users] configure: error: Could not run a simple Fortran 77 program. Aborting."</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21311.php">Syed Ahsan Ali: "Re: [OMPI users] configure: error: Could not run a simple Fortran 77 program. Aborting."</a>
<li><strong>Reply:</strong> <a href="21311.php">Syed Ahsan Ali: "Re: [OMPI users] configure: error: Could not run a simple Fortran 77 program. Aborting."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
