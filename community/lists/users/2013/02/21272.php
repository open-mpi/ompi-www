...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21273.php">Ralph Castain: "Re: [OMPI users] Fwd: How openmpi-1.6.3 using nodes which not LSF dispatch?"</a>
<li><strong>Previous message:</strong> <a href="21271.php">Andreas Bok Andersen: "[OMPI users] mmap and MPI_File_Read"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21273.php">Ralph Castain: "Re: [OMPI users] Fwd: How openmpi-1.6.3 using nodes which not LSF dispatch?"</a>
<li><strong>Reply:</strong> <a href="21273.php">Ralph Castain: "Re: [OMPI users] Fwd: How openmpi-1.6.3 using nodes which not LSF dispatch?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
