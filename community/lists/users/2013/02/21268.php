...
?>
<!-- received="Fri Feb  1 06:51:46 2013" -->
<!-- isoreceived="20130201115146" -->
<!-- sent="Fri, 1 Feb 2013 11:51:41 +0000" -->
<!-- isosent="20130201115141" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] configure: error: Could not run a simple Fortran 77	program. Aborting." -->
<!-- id="EF66BBEB19BADC41AC8CCF5F684F07FC42CC1314_at_xmb-rcd-x01.cisco.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2013-02-01 06:51:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21269.php">Syed Ahsan Ali: "Re: [OMPI users] configure: error: Could not run a simple Fortran 77 program. Aborting."</a>
<li><strong>Previous message:</strong> <a href="21267.php">Syed Ahsan Ali: "[OMPI users] configure: error: Could not run a simple Fortran 77 program. Aborting."</a>
<li><strong>In reply to:</strong> <a href="21267.php">Syed Ahsan Ali: "[OMPI users] configure: error: Could not run a simple Fortran 77 program. Aborting."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21269.php">Syed Ahsan Ali: "Re: [OMPI users] configure: error: Could not run a simple Fortran 77 program. Aborting."</a>
<li><strong>Reply:</strong> <a href="21269.php">Syed Ahsan Ali: "Re: [OMPI users] configure: error: Could not run a simple Fortran 77 program. Aborting."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
configure is not finding a working Fortran compiler.  Please send all the information listed here:
<br>
