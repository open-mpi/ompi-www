...
?>
<!-- received="Wed Jun 26 03:06:32 2013" -->
<!-- isoreceived="20130626070632" -->
<!-- sent="Wed, 26 Jun 2013 01:06:27 -0600" -->
<!-- isosent="20130626070627" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] error: unknown type name 'ompi_jobid_t'" -->
<!-- id="CAMD57oezLifmMQFS3bnAsbN9DGWSnSSVg7CCkxO0xf+VTTGr5g_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAGKz=uJtzM-SmBLfj1yuqr3yiqUenGZ31e4jS025EnZE2ubDEQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-06-26 03:06:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22216.php">Riccardo Murri: "Re: [OMPI users] openmpi 1.6.3 fails to identify local host if its IP is 127.0.1.1"</a>
<li><strong>Previous message:</strong> <a href="22214.php">Jeff Hammond: "[OMPI users] error: unknown type name 'ompi_jobid_t'"</a>
<li><strong>In reply to:</strong> <a href="22214.php">Jeff Hammond: "[OMPI users] error: unknown type name 'ompi_jobid_t'"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22221.php">Jeff Squyres (jsquyres): "Re: [OMPI users] error: unknown type name 'ompi_jobid_t'"</a>
<li><strong>Reply:</strong> <a href="22221.php">Jeff Squyres (jsquyres): "Re: [OMPI users] error: unknown type name 'ompi_jobid_t'"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
from the web site.
<br>
<p><p><p>On Tue, Jun 25, 2013 at 8:25 PM, Jeff Hammond &lt;jeff.science_at_[hidden]&gt;wrote:
<br>
<p><span class="quotelev1">&gt; I observe this error with the OpenMPI 1.7.1 &quot;feature&quot;:
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22215/attachment">attachment</a>
</ul>
