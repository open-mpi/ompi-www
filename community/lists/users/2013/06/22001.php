...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22002.php">Paul Kapinos: "Re: [OMPI users] 1.7.1 Hang with MPI_THREAD_MULTIPLE set"</a>
<li><strong>Previous message:</strong> <a href="22000.php">Derek Teaney: "[OMPI users] Symbol _mpi_get_address0dr4_ not found when using OSX + gfortran + mpif90"</a>
<li><strong>In reply to:</strong> <a href="22000.php">Derek Teaney: "[OMPI users] Symbol _mpi_get_address0dr4_ not found when using OSX + gfortran + mpif90"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
