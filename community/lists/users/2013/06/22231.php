...
?>
<!-- received="Thu Jun 27 17:03:39 2013" -->
<!-- isoreceived="20130627210339" -->
<!-- sent="Thu, 27 Jun 2013 21:02:41 +0000" -->
<!-- isosent="20130627210241" -->
<!-- name="Blosch, Edwin L" -->
<!-- email="edwin.l.blosch_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re:  Application hangs on mpi_waitall" -->
<!-- id="25AE6277FDC12F408393C11ACE6C400F0CA36B70_at_HDXDSP53.us.lmco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="3902BF22-139B-4668-82C1-5A7E32DC44F7_at_icl.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-06-27 17:02:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22232.php">George Bosilca: "Re: [OMPI users] EXTERNAL: Re:  Application hangs on mpi_waitall"</a>
<li><strong>Previous message:</strong> <a href="22230.php">rmjuberias: "[OMPI users] openmpi install problem ..."</a>
<li><strong>In reply to:</strong> <a href="22229.php">George Bosilca: "Re: [OMPI users] EXTERNAL: Re:  Application hangs on mpi_waitall"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22232.php">George Bosilca: "Re: [OMPI users] EXTERNAL: Re:  Application hangs on mpi_waitall"</a>
<li><strong>Reply:</strong> <a href="22232.php">George Bosilca: "Re: [OMPI users] EXTERNAL: Re:  Application hangs on mpi_waitall"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I'm more than happy to try out any other suggestions...
<br>
<p>From: users-bounces_at_[hidden] [mailto:users-bounces_at_[hidden]] On Behalf Of George Bosilca
<br>
...
Subject: Re: [OMPI users] EXTERNAL: Re: Application hangs on mpi_waitall
<br>
<p>This seems to highlight a possible bug in the MPI implementation. As I suggested earlier, the credit management of the OpenIB might be unsafe.
<br>
...
<p>&nbsp;&nbsp;George.
<br>
<p>On Jun 27, 2013, at 19:59 , &quot;Blosch, Edwin L&quot; &lt;edwin.l.blosch_at_[hidden]&lt;mailto:edwin.l.blosch_at_[hidden]&gt;&gt; wrote:
<br>
<p><p>The debug version also hung, roughly the same amount of progress in the computations (although of course it took much longer to make that progress in comparison to the optimized version).
<br>
<p>On the bright side, the idea of putting an mpi_barrier after the irecvs and before the isends appears to have helped.  I was able to run 5 times farther without any trouble.  So now I'm trying to run 50 times farther and, if no hang, I will declare workaround-victory.
<br>
<p>What could this mean?
<br>
<p>I am guessing that one or more processes may run ahead of the others, just because of the different amounts of work that precedes the communication step.  If a process manages to post all its irecvs and post all its isends well before another process has managed to post any matching irecvs, perhaps there is some buffering resource on the sender side that is getting exhausted?   This is pure guessing on my part.
<br>
<p>Thanks
<br>
<p>From: users-bounces_at_[hidden]&lt;mailto:users-bounces_at_[hidden]&gt; [mailto:users-bounces_at_[hidden]&lt;mailto:bounces_at_[hidden]&gt;] On Behalf Of Ed Blosch
<br>
...
<br>
<p>It ran a bit longer but still deadlocked.  All matching sends are posted 1:1with posted recvs so it is a delivery issue of some kind.  I'm running a debug compiled version tonight to see what that might turn up.  I may try to rewrite with blocking sends and see if that works.  I can also try adding a barrier (irecvs, barrier, isends, waitall) to make sure sends are not buffering waiting for recvs to be posted.
<br>
<p><p>Sent via the Samsung Galaxy S(tm) III, an AT&amp;T 4G LTE smartphone
<br>
...
<p>&nbsp;&nbsp;George.
<br>
<p><p>On Jun 26, 2013, at 04:02 , eblosch_at_[hidden]&lt;mailto:eblosch_at_[hidden]&gt; wrote:
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22231/attachment">attachment</a>
</ul>
