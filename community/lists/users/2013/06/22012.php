...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Symbol _mpi_get_address0dr4_ not found when using OSX + gfortran + mpif90<br>
<strong>From:</strong> Derek Teaney (<em>derek.teaney_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-06-02 17:21:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22013.php">Gustavo Correa: "Re: [OMPI users] Symbol _mpi_get_address0dr4_ not found when using OSX + gfortran + mpif90"</a>
<li><strong>Previous message:</strong> <a href="22011.php">Sabuj Pattanayek: "Re: [OMPI users] I got &quot;ssh_exchange_identification&quot; errors when I mpirun over 1500 times almost at the same time"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22013.php">Gustavo Correa: "Re: [OMPI users] Symbol _mpi_get_address0dr4_ not found when using OSX + gfortran + mpif90"</a>
<li><strong>Reply:</strong> <a href="22013.php">Gustavo Correa: "Re: [OMPI users] Symbol _mpi_get_address0dr4_ not found when using OSX + gfortran + mpif90"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><p><p><p><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22012/test_usempi.f">test_usempi.f</a>
</ul>
<!-- attachment="test_usempi.f" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22012/test_mpifh.f">test_mpifh.f</a>
</ul>
