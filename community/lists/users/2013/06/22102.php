...
?>
<!-- received="Fri Jun 14 22:18:12 2013" -->
<!-- isoreceived="20130615021812" -->
<!-- sent="Sat, 15 Jun 2013 11:18:03 +0900" -->
<!-- isosent="20130615021803" -->
<!-- name="Hayato KUNIIE" -->
<!-- email="kuni255_at_[hidden]" -->
<!-- subject="[OMPI users] -Re Post- MPI_SUM is not defined on the MPI_INTEGER datatype" -->
<!-- id="51BBCEDB.2000400_at_oita.email.ne.jp" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2013-06-14 22:18:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22103.php">Zehan Cui: "[OMPI users] MPI_Iallgatherv performance"</a>
<li><strong>Previous message:</strong> <a href="22101.php">Ralph Castain: "Re: [OMPI users] MPI_THREAD_FUNNELED and enable-mpi-thread-multiple"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
for each nodes.
<br>
<p>Thank you for your coorpolation.
<br>
<p>-------------------------
<br>
...
<br><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22102/ompiReport.tar.xz">ompiReport.tar.xz</a>
</ul>
