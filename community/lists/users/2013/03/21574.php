...
?>
<!-- received="Wed Mar 20 22:05:40 2013" -->
<!-- isoreceived="20130321020540" -->
<!-- sent="Thu, 21 Mar 2013 11:05:20 +0900" -->
<!-- isosent="20130321020520" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8" -->
<!-- id="OF4535B750.9D6923B8-ON49257B35.0009C55C-49257B35.000B802F_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="CF30472F-B281-4039-801C-E918283D00E5_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-03-20 22:05:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21575.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<li><strong>Previous message:</strong> <a href="21573.php">Ralph Castain: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<li><strong>In reply to:</strong> <a href="21572.php">Ralph Castain: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Hi Ralph,
<br>
<p>I have a line below in ~/.openmpi/mca-params.conf to use rsh.
<br>
orte_rsh_agent = /usr/bin/rsh
<br>
<p>I changed this line to:
<br>
plm_rsh_agent = /usr/bin/rsh  # for openmpi-1.7
<br>
<p>Then, the error message disappeared. Thanks.
<br>
<p>Retruning to the subject, I can rebuild with --enable-debug.
<br>
...
Tetsuya Mishima
<br>
<p><span class="quotelev1">&gt; You obviously have some MCA params set somewhere:
</span><br>
...
<span class="quotelev2">&gt; &gt;  Deprecated parameter: orte_rsh_agent
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
--------------------------------------------------------------------------
...
<span class="quotelev1">&gt; Check your environment for anything with OMPI_MCA_xxx, and your default
</span><br>
MCA parameter file to see what has been specified.
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; The allocation looks okay - I'll have to look for other debug flags you
</span><br>
...
<span class="quotelev1">&gt; On Mar 20, 2013, at 4:39 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev2">&gt; &gt; Here is a result of rerun with --display-allocation.
</span><br>
<span class="quotelev2">&gt; &gt; I set OMP_NUM_THREADS=1 to make the problem clear.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; P.S. As far as I checked, these 2 cases are OK(no problem).
</span><br>
<span class="quotelev2">&gt; &gt; (1)mpirun -v -np $NPROCS-x OMP_NUM_THREADS --display-allocation
</span><br>
<span class="quotelev2">&gt; &gt; ~/Ducom/testbed/mPre m02-ld
</span><br>
<span class="quotelev2">&gt; &gt; (2)mpirun -v -x OMP_NUM_THREADS --display-allocation
</span><br>
~/Ducom/testbed/mPre
<br>
<span class="quotelev2">&gt; &gt; m02-ld
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; Script File:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; #!/bin/sh
</span><br>
<span class="quotelev2">&gt; &gt; #PBS -A tmishima
</span><br>
<span class="quotelev2">&gt; &gt; #PBS -N Ducom-run
</span><br>
...
<span class="quotelev2">&gt; &gt; mpirun -v -np $NPROCS -hostfile pbs_hosts -x OMP_NUM_THREADS
</span><br>
<span class="quotelev2">&gt; &gt; --display-allocation ~/Ducom/testbed/mPre m02-ld
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; I've submitted a patch to fix the Torque launch issue - just some
</span><br>
<span class="quotelev2">&gt; &gt; leftover garbage that existed at the time of the 1.7.0 branch and
</span><br>
didn't
<br>
<span class="quotelev2">&gt; &gt; get removed.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; For the hostfile issue, I'm stumped as I can't see how the problem
</span><br>
would
<br>
<span class="quotelev2">&gt; &gt; come about. Could you please rerun your original test and add
</span><br>
<span class="quotelev2">&gt; &gt; &quot;--display-allocation&quot; to your cmd line? Let's see if it is
</span><br>
<span class="quotelev3">&gt; &gt;&gt; correctly finding the original allocation.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On Mar 19, 2013, at 5:08 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; Thank you for your comments. I understand your advice.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Our script used to be --npernode type as well.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; As I told before, our cluster consists of nodes having 4, 8,
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; and 32 cores, although it used to be homogeneous at the
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; starting time. Furthermore, since performance of each core
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; is almost same, a mixed use of nodes with different number
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; of cores is possible, just like #PBS -l nodes=1:ppn=32+4:ppn=8.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; --npernode type is not applicable to such a mixed use.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; That's why I'd like to continue to use modified hostfile.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; By the way, the problem I reported to Jeff yesterday
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; was that openmpi-1.7 with torque is something wrong,
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; because it caused error against such a simple case as
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; shown below, which surprised me. Now, the problem is not
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; limited to modified hostfile, I guess.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #PBS -l nodes=4:ppn=8
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; mpirun -np 8 ./my_program
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Hi Tetsuya
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; Our cluster is a little bit heterogeneous, which has nodes with 4,
</span><br>
8,
<br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; As I mentioned before, I usually use openmpi-1.6.x, which has no
</span><br>
<span class="quotelev2">&gt; &gt; troble
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; against that kind
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; of use. I encountered the issue when I was evaluating openmpi-1.7
</span><br>
to
<br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; move on to it, although we have no positive reason to do that at
</span><br>
this
<br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; As Gus pointed out, I use a script file as shown below for a
</span><br>
<span class="quotelev2">&gt; &gt; practical
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; #PBS -l nodes=2:ppn=32  # even &quot;-l nodes=1:ppn=32+4:ppn=8&quot; works
</span><br>
fine
<br>
...
\
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; -x OMP_NUM_THREADS ./my_program  # 32-core node has 8 numanodes,
</span><br>
<span class="quotelev2">&gt; &gt; 8-core
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; node has 2 numanodes
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; It works well under the combination of openmpi-1.6.x and Torque.
</span><br>
The
<br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; I didn't have much time to test this morning. So, I checked it
</span><br>
<span class="quotelev2">&gt; &gt; again
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; now. Then, the trouble seems to depend on the number of nodes to
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'm afraid we're going to have to wait for Ralph to answer why
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Mar 18, 2013, at 4:45 PM,&lt;tmishima_at_[hidden]&gt;
</span><br>
wrote:
<br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:11946] [[30666,0],3] ORTE_ERROR_LOG: A message
</span><br>
is
<br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mation is unknown in file base/grpcomm_base_rollup.c at line
</span><br>
123
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt; &gt;&gt;&gt; Correa&lt;gus_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; launch two mpi processes with mpiexec, and request a
</span><br>
&quot;-bynode&quot;
<br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; This should work in 1.7, too (I use these kinds of options
</span><br>
with
<br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; However, we should probably verify that the hostfile
</span><br>
<span class="quotelev2">&gt; &gt; functionality
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; in
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; batch jobs hasn't been broken in 1.7, too, because I'm pretty
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; run-time guy, is on vacation this week.  There might be a
</span><br>
delay
<br>
<span class="quotelev2">&gt; &gt; in
