...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21489.php">Ralph Castain: "Re: [OMPI users] Cluster hangs/shows error while executing simple MPI program in C"</a>
<li><strong>Previous message:</strong> <a href="21487.php">George Bosilca: "Re: [OMPI users] Should order of implementation matter for MPI_reduce?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21489.php">Ralph Castain: "Re: [OMPI users] Cluster hangs/shows error while executing simple MPI program in C"</a>
<li><strong>Reply:</strong> <a href="21489.php">Ralph Castain: "Re: [OMPI users] Cluster hangs/shows error while executing simple MPI program in C"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-21488/attachment">attachment</a>
</ul>
