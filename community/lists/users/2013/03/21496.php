...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21497.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Should order of implementation matter for MPI_reduce?"</a>
<li><strong>Previous message:</strong> <a href="21495.php">Andrew J Gomes: "[OMPI users] Should order of implementation matter for MPI_reduce?"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21497.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Should order of implementation matter for MPI_reduce?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21496/attachment">attachment</a>
</ul>
