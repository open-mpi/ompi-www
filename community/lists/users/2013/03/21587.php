...
?>
<!-- received="Thu Mar 21 16:04:02 2013" -->
<!-- isoreceived="20130321200402" -->
<!-- sent="Thu, 21 Mar 2013 13:03:55 -0700" -->
<!-- isosent="20130321200355" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem with mpiexec --cpus-per-proc in multiple nodes in OMPI 1.6.4" -->
<!-- id="F1933A41-6465-4C92-9C4B-CB7A223E0902_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2013-03-21 16:03:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21588.php">Gus Correa: "Re: [OMPI users] Problem with mpiexec --cpus-per-proc in multiple nodes in OMPI 1.6.4"</a>
<li><strong>Previous message:</strong> <a href="21586.php">Gus Correa: "Re: [OMPI users] Problem with mpiexec --cpus-per-proc in multiple nodes in OMPI 1.6.4"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21588.php">Gus Correa: "Re: [OMPI users] Problem with mpiexec --cpus-per-proc in multiple nodes in OMPI 1.6.4"</a>
<li><strong>Reply:</strong> <a href="21588.php">Gus Correa: "Re: [OMPI users] Problem with mpiexec --cpus-per-proc in multiple nodes in OMPI 1.6.4"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I will take a look at it - I don't know of any workaround, I'm afraid.
<br>
<p>On Mar 21, 2013, at 12:01 PM, Gus Correa &lt;gus_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; Oddly enough, the binding map *is* shown on STDERR,
</span><br>
