...
?>
<!-- received="Tue Mar 19 12:14:14 2013" -->
<!-- isoreceived="20130319161414" -->
<!-- sent="Tue, 19 Mar 2013 12:14:04 -0400" -->
<!-- isosent="20130319161404" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8" -->
<!-- id="51488ECC.8080200_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2013-03-19 12:14:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21562.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<li><strong>Previous message:</strong> <a href="21560.php">Reuti: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21562.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<li><strong>Reply:</strong> <a href="21562.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Tetsuya Mishima
<br>
<p>Mpiexec offers you a number of possibilities that you could try:
<br>
--bynode,
<br>
--pernode,
...
and more.
<br>
<p>Most likely one or more of them will fit your needs.
<br>
<p>There are also associated flags to bind processes to cores,
<br>
to sockets, etc, to report the bindings, and so on.
<br>
<p>Check the mpiexec man page for details.
<br>
<p>Nevertheless, I am surprised that modifying the
<br>
$PBS_NODEFILE doesn't work for you in OMPI 1.7.
<br>
I have done this many times in older versions of OMPI.
<br>
<p>Would it work for you to go back to the stable OMPI 1.6.X,
<br>
...
Gus Correa
<br>
<p>On 03/19/2013 03:00 AM, tmishima_at_[hidden] wrote:
<br>
