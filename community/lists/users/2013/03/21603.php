...
?>
<!-- received="Fri Mar 22 10:14:27 2013" -->
<!-- isoreceived="20130322141427" -->
<!-- sent="Fri, 22 Mar 2013 07:14:19 -0700" -->
<!-- isosent="20130322141419" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpi_init waits 64 seconds if vpn is connected" -->
<!-- id="4DD9AB0E-7E45-4B80-A6D2-8054B1CA2823_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="1363954366l.3395668l.0l_at_psu.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-03-22 10:14:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21604.php">Ralph Castain: "Re: [OMPI users] seg fault and 32-/64-bit mismatch in openmpi-1.7rc8r28201"</a>
<li><strong>Previous message:</strong> <a href="21602.php">Ralph Castain: "Re: [OMPI users] Running openmpi jobs on two system"</a>
<li><strong>In reply to:</strong> <a href="21599.php">David A. Boger: "Re: [OMPI users] mpi_init waits 64 seconds if vpn is connected"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21620.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mpi_init waits 64 seconds if vpn is connected"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I'd suggest googling the Ubuntu site (or just in general) to see if someone has a suggestion. Afraid I'm not a Ubuntu nor vpn person and don't have an immediate answer. :-(
<br>
<p>FWIW: it isn't a specific connection - we just ask for any port and use the standard Linux &quot;connect&quot; function.
<br>
<p>On Mar 22, 2013, at 5:12 AM, David A. Boger &lt;dab143_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Following up on your TCP remark, I found that during the delay, netstat -tnp shows
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; tcp        0      1 192.168.1.3:56343       192.168.1.3:47830       SYN_SENT    24191/mpi_hello
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt; and that while the vpn is connected, I am unable to ping 192.168.1.3 (the machine I am on).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On the other hand, on the laptop (where mpi runs fine with vpn connected), the ping-to-self works fine even when the vpn is connected.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; On Fri, Mar 22, 2013 07:37 AM, &quot;David A. Boger&quot; &lt;dab143_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; Thanks Ralph.  I have a Mac OS X 10.6.8 laptop where I can run open-mpi 1.2.8 and open-mpi 1.6.4 with the vpn connected without any problem, even without having to exclude the vpn interface, so you're probably right -- the existence of the vpn interface alone doesn't explain the problem. Nevertheless, disconnecting the vpn on my ubuntu box definitely resolves the problem, so I think it's tied in somehow.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Do you think the process is hanging looking for a specific TCP connection, or just any TCP connection?  If it's a specific one, is there a way to find out which or to test using something outside of mpirun that would show the same delay?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Fri, Mar 22, 2013 12:25 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; The process is hanging trying to open a TCP connection back to mpirun. I would
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21603/attachment">attachment</a>
</ul>
