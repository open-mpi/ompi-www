...
?>
<!-- received="Wed Mar 20 21:38:09 2013" -->
<!-- isoreceived="20130321013809" -->
<!-- sent="Wed, 20 Mar 2013 18:38:01 -0700" -->
<!-- isosent="20130321013801" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8" -->
<!-- id="A75DE05A-2601-4626-B800-69470AABADBA_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2013-03-20 21:38:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21574.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<li><strong>Previous message:</strong> <a href="21572.php">Ralph Castain: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21575.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<li><strong>Reply:</strong> <a href="21575.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<li><strong>Reply:</strong> <a href="21576.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><p>
<p><p>On Mar 20, 2013, at 4:59 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; Check your environment for anything with OMPI_MCA_xxx, and your default MCA parameter file to see what has been specified.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The allocation looks okay - I'll have to look for other debug flags you can set. Meantime, can you please add --enable-debug to your configure cmd line and rebuild?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; (2)mpirun -v -x OMP_NUM_THREADS --display-allocation ~/Ducom/testbed/mPre
</span><br>
...
<span class="quotelev2">&gt;&gt; leftover garbage that existed at the time of the 1.7.0 branch and didn't
</span><br>
<span class="quotelev2">&gt;&gt; get removed.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; For the hostfile issue, I'm stumped as I can't see how the problem would
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; run-time guy, is on vacation this week.  There might be a delay
</span><br>
<span class="quotelev2">&gt;&gt; in
</span><br>
...
<p><p><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21573/user.diff">user.diff</a>
</ul>
