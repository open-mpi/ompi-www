...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21490.php">Chintu: "[OMPI users] MPI_ERR_COMM: invalid communicator"</a>
<li><strong>Previous message:</strong> <a href="21488.php">Justin Joseph: "[OMPI users] Cluster hangs/shows error while executing simple MPI program in C"</a>
<li><strong>In reply to:</strong> <a href="21488.php">Justin Joseph: "[OMPI users] Cluster hangs/shows error while executing simple MPI program in C"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-21489/attachment">attachment</a>
</ul>
