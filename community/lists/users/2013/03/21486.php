...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21487.php">George Bosilca: "Re: [OMPI users] Should order of implementation matter for MPI_reduce?"</a>
<li><strong>Previous message:</strong> <a href="21485.php">George Bosilca: "Re: [OMPI users] Should order of implementation matter for MPI_reduce?"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21487.php">George Bosilca: "Re: [OMPI users] Should order of implementation matter for MPI_reduce?"</a>
<li><strong>Reply:</strong> <a href="21487.php">George Bosilca: "Re: [OMPI users] Should order of implementation matter for MPI_reduce?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
