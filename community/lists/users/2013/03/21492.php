...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21493.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_ERR_COMM: invalid communicator"</a>
<li><strong>Previous message:</strong> <a href="21491.php">Ralph Castain: "Re: [OMPI users] MPI_ERR_COMM: invalid communicator"</a>
<li><strong>In reply to:</strong> <a href="21491.php">Ralph Castain: "Re: [OMPI users] MPI_ERR_COMM: invalid communicator"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21493.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_ERR_COMM: invalid communicator"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-21492/attachment">attachment</a>
</ul>
