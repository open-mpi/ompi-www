...
?>
<!-- received="Sat Mar 30 09:21:14 2013" -->
<!-- isoreceived="20130330132114" -->
<!-- sent="Sat, 30 Mar 2013 14:20:56 +0100" -->
<!-- isosent="20130330132056" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] memory per core/process" -->
<!-- id="73E5E92F-CD91-4D99-843C-5573C0778610_at_staff.uni-marburg.de" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="5156D9DD.8050406_at_aol.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-03-30 09:20:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21636.php">Patrick Bégou: "Re: [OMPI users] memory per core/process"</a>
<li><strong>Previous message:</strong> <a href="21634.php">Tim Prince: "Re: [OMPI users] memory per core/process"</a>
<li><strong>In reply to:</strong> <a href="21634.php">Tim Prince: "Re: [OMPI users] memory per core/process"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21637.php">Duke Nguyen: "Re: [OMPI users] memory per core/process"</a>
<li><strong>Reply:</strong> <a href="21637.php">Duke Nguyen: "Re: [OMPI users] memory per core/process"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; On 03/30/2013 06:36 AM, Duke Nguyen wrote:
</span><br>
...
<p>Even if I would be the only user on a cluster of machines, I would define this in any queuingsystem to set the limits for the job.
<br>
<p>-- Reuti
<br>
