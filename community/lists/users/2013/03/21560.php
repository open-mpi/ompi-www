...
?>
<!-- received="Tue Mar 19 11:52:28 2013" -->
<!-- isoreceived="20130319155228" -->
<!-- sent="Tue, 19 Mar 2013 16:52:15 +0100" -->
<!-- isosent="20130319155215" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8" -->
<!-- id="DEF22422-1360-4C22-8986-FF793BFBB4F4_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="OF1A6B23E6.E75EE8FA-ON49257B33.0025AE97-49257B33.002685AD_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-03-19 11:52:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21561.php">Gus Correa: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<li><strong>Previous message:</strong> <a href="21559.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<li><strong>In reply to:</strong> <a href="21559.php">tmishima_at_[hidden]: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21561.php">Gus Correa: "Re: [OMPI users] modified hostfile does not work with openmpi1.7rc8"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Am 19.03.2013 um 08:00 schrieb tmishima_at_[hidden]:
<br>
<p><span class="quotelev1">&gt; I didn't have much time to test this morning. So, I checked it again
</span><br>
...
<p>we don't use Torque/PBS on our own, but AFAIK the request &quot;-l nodes=4:ppn=8&quot; can give you 4 nodes with 8 slots each, or even some nodes twice or more often when slots are available and it's set up this way. To allow or disallow this behavior is a global setting in Torque/PBS.
<br>
<p>Did you get different nodes or some nodes at least twice?
<br>
<p>I don't know whether this is related to this issue, but at least worth to be mentioned in this context.
<br>
<p>-- Reuti
<br>
...
<span class="quotelev2">&gt;&gt; I'm afraid we're going to have to wait for Ralph to answer why that is
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; But, practical case that more than 1 process was allocated to a node
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mar 17, 2013, at 10:55 PM, Gustavo Correa &lt;gus_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; This should work in 1.7, too (I use these kinds of options with SLURM
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; However, we should probably verify that the hostfile functionality in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; batch jobs hasn't been broken in 1.7, too, because I'm pretty sure that
</span><br>
