...
?>
<!-- received="Sat Aug 10 18:06:33 2013" -->
<!-- isoreceived="20130810220633" -->
<!-- sent="Sat, 10 Aug 2013 15:06:31 -0700" -->
<!-- isosent="20130810220631" -->
<!-- name="Lee-Ping Wang" -->
<!-- email="leeping_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Error launching single-node	tasks	from	multiple-node job." -->
<!-- id="022e01ce9615$df76fd80$9e64f880$_at_stanford.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="021001ce9602$e2ac0b70$a8042250$_at_stanford.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-08-10 18:06:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22468.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node tasks from multiple-node job."</a>
<li><strong>Previous message:</strong> <a href="22466.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node tasks	from	multiple-node job."</a>
<li><strong>In reply to:</strong> <a href="22466.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node tasks	from	multiple-node job."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22469.php">Gustavo Correa: "Re: [OMPI users] Error launching single-node	tasks	from	multiple-node job."</a>
<li><strong>Reply:</strong> <a href="22469.php">Gustavo Correa: "Re: [OMPI users] Error launching single-node	tasks	from	multiple-node job."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Gus,
<br>
<p>I tried your suggestions.  Here is the command line which executes mpirun.
<br>
...
<br>
<p>=== Error message from compute node ===
<br>
...
<p>-----Original Message-----
<br>
From: users [mailto:users-bounces_at_[hidden]] On Behalf Of Lee-Ping Wang
<br>
...
<span class="quotelev1">&gt; &quot;That is to say, these tasks are intended to use OpenMPI parallelism 
</span><br>
...
<span class="quotelev1">&gt; if your OpenMPI was compiled with Torque/PBS support, the 
</span><br>
<span class="quotelev1">&gt; mpiexec/mpirun command will look for the $PBS_NODEFILE to learn in 
</span><br>
<span class="quotelev1">&gt; which node(s) it
</span><br>
should
<br>
<span class="quotelev1">&gt; launch the MPI processes, regardless of whether you are using one node 
</span><br>
<span class="quotelev1">&gt; or more than one node.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; You didn't send your mpiexec command line (which would help), but 
</span><br>
<span class="quotelev1">&gt; assuming that Q-Chem allows some level of standard mpiexec command 
</span><br>
<span class="quotelev1">&gt; options, you
</span><br>
could
<br>
...
<span class="quotelev1">&gt; mpiexec -hostfile $PBS_NODEFILE -np 16 ./my-Q-chem-executable 
</span><br>
...
multiple
<br>
<span class="quotelev1">&gt; single-node parallel tasks.  That is to say, these tasks are intended 
</span><br>
...
<span class="quotelev2">&gt;&gt; Some background: The actual program being executed is Q-Chem 4.0.  I 
</span><br>
<span class="quotelev2">&gt;&gt; use
</span><br>
<span class="quotelev1">&gt; OpenMPI 1.4.2 for this, because Q-Chem is notoriously difficult to 
</span><br>
<span class="quotelev1">&gt; compile and this is the last known version of OpenMPI that this 
</span><br>
<span class="quotelev1">&gt; version of Q-Chem
</span><br>
is
<br>
...
<span class="quotelev2">&gt;&gt; My jobs are failing with the error message below; I do not observe 
</span><br>
...
<br>
<span class="quotelev1">&gt; I believe it is looking for a PBS node file somewhere.  Since my jobs 
</span><br>
<span class="quotelev1">&gt; are only parallel over the node they're running on, I believe that a 
</span><br>
<span class="quotelev1">&gt; node file of any kind is unnecessary.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
that
<br>
<span class="quotelev1">&gt; it is running under a multi-node allocation?  Is there a way I can 
</span><br>
<span class="quotelev1">&gt; change OpenMPI's behavior so it always thinks it's running on a single 
</span><br>
<span class="quotelev1">&gt; node, regardless of the type of job I submit to the batch system?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
