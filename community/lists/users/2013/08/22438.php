...
?>
<!-- received="Sun Aug  4 21:36:48 2013" -->
<!-- isoreceived="20130805013648" -->
<!-- sent="Sun, 4 Aug 2013 18:36:40 -0700" -->
<!-- isosent="20130805013640" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ERROR: At least one pair of MPI processes are unable to reach each other for MPI communications." -->
<!-- id="A470D9BF-91D5-434B-AAD5-1888BFE8F074_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="51FEFF56.3060403_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-08-04 21:36:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22439.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Undefined symbols with MPI_Get_address"</a>
<li><strong>Previous message:</strong> <a href="22437.php">RoboBeans: "Re: [OMPI users] ERROR: At least one pair of MPI processes are unable to reach each other for MPI communications."</a>
<li><strong>In reply to:</strong> <a href="22437.php">RoboBeans: "Re: [OMPI users] ERROR: At least one pair of MPI processes are unable to reach each other for MPI communications."</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>On Aug 4, 2013, at 6:26 PM, RoboBeans &lt;robobeans_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Hi Tom,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; As per your suggestion, i tried 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; ./configure --with-psm --prefix=/opt/openmpi-1.7.2 --enable-event-thread-support --enable-opal-multi-threads --enable-orte-progress-threads --enable-mpi-thread-multiple
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; checking --with-psm value... simple ok (unspecified)
</span><br>
...
<span class="quotelev1">&gt; configure: WARNING: psm.h: present but cannot be compiled
</span><br>
<span class="quotelev1">&gt; configure: WARNING: psm.h:     check for missing prerequisite headers?
</span><br>
<span class="quotelev1">&gt; configure: WARNING: psm.h: see the Autoconf documentation
</span><br>
<span class="quotelev1">&gt; configure: WARNING: psm.h:     section &quot;Present But Cannot Be Compiled&quot;
</span><br>
<span class="quotelev1">&gt; configure: WARNING: psm.h: proceeding with the compiler's result
</span><br>
...
<span class="quotelev1">&gt; Any feedback will be helpful. Thanks for your time!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On 8/4/13 10:31 AM, Elken, Tom wrote:
</span><br>
<span class="quotelev2">&gt;&gt; On 8/3/13 7:09 PM, RoboBeans wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; This is a pretty good clue that OFED is not installed on the last 4 nodes.  You should fix that by installing OFED 1.5.3.2 on the last 4 nodes, OR better (but more work) install a newer OFED such as 1.5.4.1 or 3.5 on ALL the nodes (You need to look at the OFED release notes to see if your OS is supported by these OFEDs).
</span><br>
<span class="quotelev2">&gt;&gt;  
</span><br>
<span class="quotelev2">&gt;&gt; BTW, since you are using QLogic HCAs, they typically work with the best performance when using the PSM API to the HCA.  PSM is part of OFED.  To use this by default with Open MPI, you can build Open MPI as follows:
</span><br>
<span class="quotelev2">&gt;&gt; ./configure --with-psm --prefix=&lt;install directory&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; With an Open MPI that is already built, you can try to use PSM as follows:
</span><br>
<span class="quotelev2">&gt;&gt; mpirun &#133; --mca mtl psm --mca btl ^openib &#133;
</span><br>
<span class="quotelev2">&gt;&gt;  
</span><br>
<span class="quotelev2">&gt;&gt; -Tom
...
<span class="quotelev2">&gt;&gt; Are the ofed versions the same across all the machines? I would suspect that might be the problem.
</span><br>
<span class="quotelev2">&gt;&gt;  
</span><br>
<span class="quotelev2">&gt;&gt;  
</span><br>
<span class="quotelev2">&gt;&gt; On Aug 3, 2013, at 4:06 PM, RoboBeans &lt;robobeans_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Hi Ralph, I tried using 1.5.4, 1.6.5 and 1.7.2 (compiled from source code) with no configuration arguments but I am facing the same issue. When I run a job using 1.5.4 (installed using yum), I get warnings but it doesn't affect my output.                       
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; sv-2.7960ipath_userinit: Mismatched user minor version (12) and driver minor version (11) while context sharing. Ensure that driver and library are from the same release.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Each system has a QLogic card (&quot;QLE7342-CK dual port IB card&quot;), with the same OS but different kernel revision no. (e.g. 2.6.32-358.2.1.el6.x86_64, 2.6.32-358.el6.x86_64).
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; I have installed openmpi 1.5.4 on 11 node cluster using &quot;yum install openmpi openmpi-devel&quot; and everything seems to be working fine. For testing I am using this test program
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; //******************************************************************
...
<span class="quotelev2">&gt;&gt; #export LD_LIBRARY_PATH=/usr/lib64/openmpi/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}
</span><br>
<span class="quotelev2">&gt;&gt; export LD_LIBRARY_PATH=/usr/OPENMPI/openmpi-1.7.2/lib${LD_LIBRARY_PATH:+:$LD_LIBRARY_PATH}
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Now, if I install openmpi 1.7.2 on each node separately then I can only use it on either first 7 nodes or last 4 nodes but not on all of them.  
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; //******************************************************************
...
<span class="quotelev2">&gt;&gt; $ ./configure --prefix=/usr/OPENMPI/openmpi-1.7.2 --enable-event-thread-support --enable-opal-multi-threads --enable-orte-progress-threads --enable-mpi-thread-multiple
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-2:05284] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-2_0/50535/0/0
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-3:28993] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-3_0/50535/0/1
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-6:09087] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-6_0/50535/0/4
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-7:32563] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-7_0/50535/0/5
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-4:15711] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-4_0/50535/0/2
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-5:12534] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-5_0/50535/0/3
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-14:08399] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-14_0/50535/0/6
</span><br>
<span class="quotelev2">&gt;&gt; [SERVER-14:08399] jobdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-14_0/50535/0
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-14:08412] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-14_0/50535/1/6
</span><br>
<span class="quotelev2">&gt;&gt; [SERVER-14:08412] jobdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-14_0/50535/1
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-2:05291] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-2_0/50535/1/0
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-4:15726] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-4_0/50535/1/2
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-6:09100] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-6_0/50535/1/4
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-7:32576] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-7_0/50535/1/5
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-5:12548] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-5_0/50535/1/3
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-3:29009] procdir: /tmp/openmpi-sessions-mpidemo_at_SERVER-3_0/50535/1/1
</span><br>
...
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (0, SERVER-2, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 5291)
</span><br>
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (1, x.x.x.24, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 29009)
</span><br>
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (2, x.x.x.26, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 15726)
</span><br>
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (3, x.x.x.28, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 12548)
</span><br>
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (4, x.x.x.29, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 9100)
</span><br>
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (5, x.x.x.30, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 32576)
</span><br>
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (6, x.x.x.41, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 8412)
</span><br>
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (7, x.x.x.101, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 7514)
</span><br>
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (8, x.x.x.100, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 45712)
</span><br>
<span class="quotelev2">&gt;&gt;     (i, host, exe, pid) = (9, x.x.x.102, /usr2/mpidemo/dev/DISTRIBUTED_COMPUTING/./test, 8363)
</span><br>
<span class="quotelev2">&gt;&gt; MPIR_executable_path: NULL
</span><br>
<span class="quotelev2">&gt;&gt; MPIR_server_arguments: NULL
...
<span class="quotelev2">&gt;&gt; [SERVER-2:5291] *** MPI_ERRORS_ARE_FATAL (processes in this communicator will now abort,
</span><br>
...
<span class="quotelev2">&gt;&gt; [sv-1][[50535,1],8][btl_openib_proc.c:157:mca_btl_openib_proc_create] [btl_openib_proc.c:157] ompi_modex_recv failed for peer [[50535,1],0]
</span><br>
<span class="quotelev2">&gt;&gt; [sv-3][[50535,1],9][btl_openib_proc.c:157:mca_btl_openib_proc_create] [btl_openib_proc.c:157] ompi_modex_recv failed for peer [[50535,1],0]
</span><br>
<span class="quotelev2">&gt;&gt; [sv-3][[50535,1],9][btl_tcp_proc.c:128:mca_btl_tcp_proc_create] mca_base_modex_recv: failed with return value=-13
</span><br>
<span class="quotelev2">&gt;&gt; [sv-3][[50535,1],9][btl_tcp_proc.c:128:mca_btl_tcp_proc_create] mca_base_modex_recv: failed with return value=-13
</span><br>
<span class="quotelev2">&gt;&gt; [sv-1][[50535,1],8][btl_tcp_proc.c:128:mca_btl_tcp_proc_create] mca_base_modex_recv: failed with return value=-13
</span><br>
<span class="quotelev2">&gt;&gt; [sv-1][[50535,1],8][btl_tcp_proc.c:128:mca_btl_tcp_proc_create] mca_base_modex_recv: failed with return value=-13
</span><br>
<span class="quotelev2">&gt;&gt; --------------------------------------------------------------------------
...
<span class="quotelev2">&gt;&gt; [sv-2][[50535,1],7][btl_openib_proc.c:157:mca_btl_openib_proc_create] [btl_openib_proc.c:157] ompi_modex_recv failed for peer [[50535,1],0]
</span><br>
<span class="quotelev2">&gt;&gt; [sv-2][[50535,1],7][btl_tcp_proc.c:128:mca_btl_tcp_proc_create] mca_base_modex_recv: failed with return value=-13
</span><br>
<span class="quotelev2">&gt;&gt; [sv-2][[50535,1],7][btl_tcp_proc.c:128:mca_btl_tcp_proc_create] mca_base_modex_recv: failed with return value=-13
</span><br>
...
<span class="quotelev2">&gt;&gt; [SERVER-2:05284] 6 more processes have sent help message help-mpi-runtime / mpi_init:startup:internal-failure
</span><br>
<span class="quotelev2">&gt;&gt; [SERVER-2:05284] Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to see all help / error messages
</span><br>
<span class="quotelev2">&gt;&gt; [SERVER-2:05284] 9 more processes have sent help message help-mpi-errors.txt / mpi_errors_are_fatal unknown handle
</span><br>
<span class="quotelev2">&gt;&gt; [SERVER-2:05284] 9 more processes have sent help message help-mpi-runtime.txt / ompi mpi abort:cannot guarantee all killed
</span><br>
<span class="quotelev2">&gt;&gt; [SERVER-2:05284] 2 more processes have sent help message help-mca-bml-r2.txt / unreachable proc
</span><br>
<span class="quotelev2">&gt;&gt; [SERVER-2:05284] 2 more processes have sent help message help-mpi-runtime / mpi_init:startup:pml-add-procs-fail
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22438/attachment">attachment</a>
</ul>
