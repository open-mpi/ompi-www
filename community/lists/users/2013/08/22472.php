...
?>
<!-- received="Sat Aug 10 19:28:03 2013" -->
<!-- isoreceived="20130810232803" -->
<!-- sent="Sat, 10 Aug 2013 16:27:59 -0700" -->
<!-- isosent="20130810232759" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Error launching single-node tasks from multiple-node job." -->
<!-- id="25E12C4C-62B7-43F1-B476-69017F335490_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="023801ce961f$df2db3f0$9d891bd0$_at_stanford.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-08-10 19:27:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22473.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node tasks from	multiple-node job."</a>
<li><strong>Previous message:</strong> <a href="22471.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node tasks from multiple-node job."</a>
<li><strong>In reply to:</strong> <a href="22471.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node tasks from multiple-node job."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22473.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node tasks from	multiple-node job."</a>
<li><strong>Reply:</strong> <a href="22473.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node tasks from	multiple-node job."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Regardless, you can always deselect Torque support at runtime. Just put the following in your environment:
<br>
<p>OMPI_MCA_ras=^tm
<br>
<p>That will tell ORTE to ignore the Torque allocation module and it should then look at the machinefile.
<br>
...
<span class="quotelev1">&gt; I agree that $PBS_JOBID should not point to a file in normal situations,
</span><br>
<span class="quotelev1">&gt; because it is the job identifier given by the scheduler.  However,
</span><br>
<span class="quotelev1">&gt; ras_tm_module.c actually does search for a file named $PBS_JOBID, and that
</span><br>
<span class="quotelev1">&gt; seems to be why it was failing.  You can see this in the source code as well
</span><br>
<span class="quotelev1">&gt; (look at ras_tm_module.c, I uploaded it to
</span><br>
...
<span class="quotelev1">&gt; changed the $PBS_JOBID environment variable to the name of the node file,
</span><br>
<span class="quotelev1">&gt; things seemed to work - though I agree, it's not very logical.  
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I doubt Q-Chem is causing the issue, because I was able to &quot;fix&quot; things by
</span><br>
<span class="quotelev1">&gt; changing $PBS_JOBID before Q-Chem is called.  Also, I provided the command
</span><br>
<span class="quotelev1">&gt; line to mpirun in a previous email, where the -machinefile argument
</span><br>
<span class="quotelev1">&gt; correctly points to the custom machine file that I created.  The missing
</span><br>
<span class="quotelev1">&gt; environment variables should not matter.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The PBS_NODEFILE created by Torque is
</span><br>
<span class="quotelev1">&gt; /opt/torque/aux//272139.certainty.stanford.edu and it never gets touched.  I
</span><br>
<span class="quotelev1">&gt; followed the advice in your earlier email and I created my own node file on
</span><br>
<span class="quotelev1">&gt; each node called /scratch/leeping/pbs_nodefile.$HOSTNAME, and I set
</span><br>
<span class="quotelev1">&gt; PBS_NODEFILE to point to this file.  However, this file does not get used
</span><br>
<span class="quotelev1">&gt; either, even if I include it on the mpirun command line, unless I set
</span><br>
<span class="quotelev1">&gt; PBS_JOBID to the file name.  
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Finally, I was not able to build OpenMPI 1.4.2 without pbs support.  I used
</span><br>
<span class="quotelev1">&gt; the configure flag --without-rte-support, but the build failed halfway
</span><br>
...
<span class="quotelev1">&gt; leeping_at_compute-140-4:~$ echo $PBS_JOBID
</span><br>
<span class="quotelev1">&gt; 272139.certainty.stanford.edu
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; PBS_O_PATH=/opt/intel/Compiler/11.1/064/bin/intel64:/opt/intel/Compiler/11.1
</span><br>
<span class="quotelev1">&gt; /064/bin/intel64:/usr/local/cuda/bin:/home/leeping/opt/psi-4.0b5/bin:/home/l
</span><br>
<span class="quotelev1">&gt; eeping/opt/tinker/bin:/home/leeping/opt/cctools/bin:/home/leeping/bin:/home/
</span><br>
<span class="quotelev1">&gt; leeping/local/bin:/home/leeping/opt/bin:/usr/kerberos/bin:/usr/java/latest/b
</span><br>
<span class="quotelev1">&gt; in:/usr/local/bin:/bin:/usr/bin:/opt/ganglia/bin:/opt/ganglia/sbin:/opt/open
</span><br>
<span class="quotelev1">&gt; mpi/bin/:/opt/maui/bin:/opt/torque/bin:/opt/torque/sbin:/opt/rocks/bin:/opt/
</span><br>
<span class="quotelev1">&gt; rocks/sbin:/opt/sun-ct/bin:/home/leeping/bin
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; PBS_NODEFILE contains a list (with repetitions up to the number of cores) of
</span><br>
<span class="quotelev1">&gt; the nodes that torque assigned to the job.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Why things get twisted it is hard to tell, it may be something in the Q-Chem
</span><br>
<span class="quotelev1">&gt; scripts (could it be mixing up PBS_JOBID and PBS_NODEFILE?), it may be
</span><br>
<span class="quotelev1">&gt; something else.
</span><br>
<span class="quotelev1">&gt; A more remote possibility is if the cluster has a Torque qsub wrapper that
</span><br>
<span class="quotelev1">&gt; may perhaps produce the aforementioned confusion.  Unlikely, but possible.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; To sort out, run any simple job (mpiexec -np 32 hostname), or even your very
</span><br>
<span class="quotelev1">&gt; Q-Chem job, but precede it with a bunch of printouts of the PBS environment
</span><br>
...
<span class="quotelev1">&gt; cat $PBS_JOBID [this one should fail, because that is not a file, but may
</span><br>
<span class="quotelev1">&gt; work the PBS variables were messed up along the way]
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; I set the PBS_JOBID environment variable to the name of my custom node 
</span><br>
<span class="quotelev2">&gt;&gt; file.  That is to say, I set PBS_JOBID=pbs_nodefile.compute-3-3.local.  
</span><br>
...
<span class="quotelev2">&gt;&gt; I tried your suggestions.  Here is the command line which executes mpirun.
</span><br>
...
<span class="quotelev2">&gt;&gt; -x QCAUX -x QCCLEAN -x QCFILEPREF -x QCLOCALSCR -x QCPLATFORM -x QCREF 
</span><br>
<span class="quotelev2">&gt;&gt; -x QCRSH -x QCRUNNAME -x QCSCRATCH
</span><br>
...
<span class="quotelev2">&gt;&gt; [compute-3-3.local:28666] Warning: could not find environment variable 
</span><br>
<span class="quotelev2">&gt;&gt; &quot;QCREF&quot;
</span><br>
<span class="quotelev2">&gt;&gt; [compute-3-3.local:28666] Warning: could not find environment variable 
</span><br>
<span class="quotelev2">&gt;&gt; &quot;QCRUNNAME&quot;
</span><br>
...
<span class="quotelev2">&gt;&gt; Thank you.  You gave me many helpful suggestions, which I will try out 
</span><br>
<span class="quotelev2">&gt;&gt; and get back to you.  I will provide more specifics (e.g. how my jobs 
</span><br>
...
<span class="quotelev2">&gt;&gt; policies.  This is why it makes sense to submit a single multiple-node 
</span><br>
<span class="quotelev2">&gt;&gt; batch job, which then executes several independent single-node tasks.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; - Lee-Ping
...
<span class="quotelev2">&gt;&gt; Even if you use pbdsh to launch separate MPI jobs on individual nodes, 
</span><br>
<span class="quotelev2">&gt;&gt; you probably (not 100% sure about that), probably need to specify he 
</span><br>
<span class="quotelev2">&gt;&gt; -hostfile naming the specific node that each job will run on.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; jobs are failing immediately, then I only have a small window to view 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the actual command through &quot;ps&quot; or something.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; Another option is for me to compile OpenMPI without Torque / PBS support.
</span><br>
...
<span class="quotelev2">&gt;&gt; $PBS_NODEFILE into several hostfiles, one per MPI job (so to speak) that
</span><br>
...
<span class="quotelev2">&gt;&gt; I have no idea how the trick above could be reconciled with the Q-Chem 
</span><br>
<span class="quotelev2">&gt;&gt; scripts, though.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Recently, I've begun some calculations on a cluster where I submit a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; multiple node job to the Torque batch system, and the job executes
</span><br>
<span class="quotelev2">&gt;&gt; multiple
</span><br>
<span class="quotelev3">&gt;&gt;&gt; single-node parallel tasks.  That is to say, these tasks are intended 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Some background: The actual program being executed is Q-Chem 4.0.  I 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I believe it is looking for a PBS node file somewhere.  Since my jobs 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; are only parallel over the node they're running on, I believe that a 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; node file of any kind is unnecessary.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; failure in file ras_tm_module.c at line 87 [compute-1-1.local:10911] 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [[42011,0],0]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ORTE_ERROR_LOG: File open failure in file ras_tm_module.c at line 87 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [compute-1-1.local:10910] [[42010,0],0] ORTE_ERROR_LOG: File open 
</span><br>
