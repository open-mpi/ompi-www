...
?>
<!-- received="Thu Aug 29 05:50:05 2013" -->
<!-- isoreceived="20130829095005" -->
<!-- sent="Thu, 29 Aug 2013 11:49:55 +0200" -->
<!-- isosent="20130829094955" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun tries to ssh to local machine" -->
<!-- id="63B7EF19-3DD6-4A80-BFE0-A59C2EF15F4E_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="20130829104137.128275i1tgo471vl_at_webmail.bo.ibimet.cnr.it" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-08-29 05:49:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22566.php">Ralph Castain: "Re: [OMPI users] mpirun tries to ssh to local machine"</a>
<li><strong>Previous message:</strong> <a href="22564.php">Federico Carotenuto: "Re: [OMPI users] mpirun tries to ssh to local machine"</a>
<li><strong>In reply to:</strong> <a href="22564.php">Federico Carotenuto: "Re: [OMPI users] mpirun tries to ssh to local machine"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22566.php">Ralph Castain: "Re: [OMPI users] mpirun tries to ssh to local machine"</a>
<li><strong>Reply:</strong> <a href="22566.php">Ralph Castain: "Re: [OMPI users] mpirun tries to ssh to local machine"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; the output of which mpicc is that such program may be found in various packages (which can be installed with apt-get), while which mpiexec outputs nothing (goes back to the prompt).
</span><br>
<p>You can compile and install Open MPI directly from source - even without being root. You are not limited to what the distribution offers at all.
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; Seems like no mpicc and mpiexec are set on the system...
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt;&gt; Am 26.08.2013 um 18:10 schrieb Federico Carotenuto:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; as you suggested I proceeded to install Openmpi 1.6.5
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; and changed the environmental variable MPI_ROOT
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; No, there is no such variable necessary to be set (at least from Open MPI points of view).
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to the new folder, should I know source the commands in .bashrc to be sure to be able to execute the right mpirun and mpiexec (something like source
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Please check with:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; which you are using. It's also necessary to recompile the application with the new MPI library.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; /home/modelstation/Software/openmpi1.6.5/mpirun, where the directory is the installation directory)?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Am 26.08.2013 um 14:33 schrieb Federico Carotenuto:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; This was normal at that time: one rsh/ssh per parallel instance. Nowadays Open MPI and MPICH2/3 will use only one `rsh`/`ssh` per host and start all other parallel tasks as thread (i.e: on a local machine they don't need a local `rsh` or `ssh` at all). Although you could either adjust `rsh` to disregard passwords (deprecated) or route `rsh` to `ssh` and enable passphraseless login:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPICH(1) is outdated (released 2005) and I suggested already to Portland to exclude it from the package. IMO this adds more confusion than it help.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hence, please install a recent version of Open MPI or MPICH2/3 and then we can look into it again on the appropriate list.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; PS: The above mentioned LAM/MPI is outdated too.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Thanks for your help and patience
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
