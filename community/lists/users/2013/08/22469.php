...
?>
<!-- received="Sat Aug 10 18:47:18 2013" -->
<!-- isoreceived="20130810224718" -->
<!-- sent="Sat, 10 Aug 2013 18:47:04 -0400" -->
<!-- isosent="20130810224704" -->
<!-- name="Gustavo Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Error launching single-node	tasks	from	multiple-node job." -->
<!-- id="C2BA2396-7CE6-4E98-A044-905F49BB4AC6_at_ldeo.columbia.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="022e01ce9615$df76fd80$9e64f880$_at_stanford.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-08-10 18:47:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22470.php">Gustavo Correa: "Re: [OMPI users] Error launching single-node tasks from multiple-node job."</a>
<li><strong>Previous message:</strong> <a href="22468.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node tasks from multiple-node job."</a>
<li><strong>In reply to:</strong> <a href="22467.php">Lee-Ping Wang: "Re: [OMPI users] Error launching single-node	tasks	from	multiple-node job."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22464.php">Gustavo Correa: "Re: [OMPI users] Error launching single-node tasks from multiple-node job."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Lee-Ping
<br>
<p>Is /scratch/leeping/272055.certainty.stanford.edu the actual PBS_NODEFILE provided by Torque?
<br>
...
<br>
<p>If the OpenMPI with torque support won't allow you to tweak with the nodefile the way you want,
<br>
you may want to try building OpenMPI without torque support, capturing the PBS_NODEFILE
<br>
provided by torque, selecting the nodes you need, creating your own hostfile(s), 
<br>
and passing those to the mpiexec command line(s).
<br>
<p>Also, according to the error messages you sent, 
<br>
there seem to be some missing Q-Chem environment variables that you
<br>
need to set.  I don't know what impact  these may cause, it is a Q-Chem thing.
<br>
<p>Gus Correa
<br>
<p>On Aug 10, 2013, at 6:06 PM, Lee-Ping Wang wrote:
<br>
...
<span class="quotelev1">&gt; file ras_tm_module.c at line 155
</span><br>
<span class="quotelev1">&gt; [compute-3-3.local:28666] [[56726,0],0] ORTE_ERROR_LOG: File open failure in
</span><br>
<span class="quotelev1">&gt; file ras_tm_module.c at line 87
</span><br>
<span class="quotelev1">&gt; [compute-3-3.local:28666] [[56726,0],0] ORTE_ERROR_LOG: File open failure in
</span><br>
<span class="quotelev1">&gt; file base/ras_base_allocate.c at line 133
</span><br>
<span class="quotelev1">&gt; [compute-3-3.local:28666] [[56726,0],0] ORTE_ERROR_LOG: File open failure in
</span><br>
<span class="quotelev1">&gt; file base/plm_base_launch_support.c at line 72
</span><br>
<span class="quotelev1">&gt; [compute-3-3.local:28666] [[56726,0],0] ORTE_ERROR_LOG: File open failure in
</span><br>
<span class="quotelev1">&gt; file plm_tm_module.c at line 167
</span><br>
<span class="quotelev1">&gt; 
</span><br>
