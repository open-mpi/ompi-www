...
?>
<!-- received="Mon Aug 26 12:13:45 2013" -->
<!-- isoreceived="20130826161345" -->
<!-- sent="Mon, 26 Aug 2013 18:13:32 +0200" -->
<!-- isosent="20130826161332" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun tries to ssh to local machine" -->
<!-- id="7BD0CDFA-C266-47EA-9A32-5AB440B9CAA1_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="20130826181042.11193aguluvce60y_at_webmail.bo.ibimet.cnr.it" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-08-26 12:13:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22557.php">Ng Shi Wei: "[OMPI users] Unable to schedule an MPI tasks"</a>
<li><strong>Previous message:</strong> <a href="22555.php">Federico Carotenuto: "Re: [OMPI users] mpirun tries to ssh to local machine"</a>
<li><strong>In reply to:</strong> <a href="22555.php">Federico Carotenuto: "Re: [OMPI users] mpirun tries to ssh to local machine"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22564.php">Federico Carotenuto: "Re: [OMPI users] mpirun tries to ssh to local machine"</a>
<li><strong>Reply:</strong> <a href="22564.php">Federico Carotenuto: "Re: [OMPI users] mpirun tries to ssh to local machine"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Am 26.08.2013 um 18:10 schrieb Federico Carotenuto:
<br>
...
<p>Good.
<br>
<p><p><span class="quotelev1">&gt; and changed the environmental variable MPI_ROOT
</span><br>
<p>No, there is no such variable necessary to be set (at least from Open MPI points of view).
<br>
<p><p><span class="quotelev1">&gt; to the new folder, should I know source the commands in .bashrc to be sure to be able to execute the right mpirun and mpiexec (something like source
</span><br>
<p>Please check with:
<br>
<p>which mpicc
...
which mpiexec
<br>
<p>which you are using. It's also necessary to recompile the application with the new MPI library.
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; /home/modelstation/Software/openmpi1.6.5/mpirun, where the directory is the installation directory)?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I'm start thinking I've got some compilation issue with MPI: I'm afraid I've got the MPICH 1 coming with the PGI compiler installation, because if I try to run mpiexec the terminal answers with &quot;The program 'mpiexec' can be found in the following packages: *lam-runtime *mpich2 *openmpi-bin *openmpi1.6-bin. Try: sudo apt-get install &lt;selected package&gt;&quot;.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I've also tried to modify the machinefile that comes by default under /opt/pgi/linux86-64/13.4/mpi/mpich/share/machinefile.LINUX adding the line &quot;modelstation:8&quot;, but still mpirun prompts for the password 8 times.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; This was normal at that time: one rsh/ssh per parallel instance. Nowadays Open MPI and MPICH2/3 will use only one `rsh`/`ssh` per host and start all other parallel tasks as thread (i.e: on a local machine they don't need a local `rsh` or `ssh` at all). Although you could either adjust `rsh` to disregard passwords (deprecated) or route `rsh` to `ssh` and enable passphraseless login:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; MPICH(1) is outdated (released 2005) and I suggested already to Portland to exclude it from the package. IMO this adds more confusion than it help.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Hence, please install a recent version of Open MPI or MPICH2/3 and then we can look into it again on the appropriate list.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; There is a default. But you can also specify it on the command line to test it:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; My etc/hosts contains: 127.0.0.1 localhost and 127.0.1.1 modelstation (modelstation is the machine name I was mentioning in the previous mail)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
