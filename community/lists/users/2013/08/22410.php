...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22411.php">gpaulus: "[OMPI users] OpenMPI 1.7.2 and CLAPACK libs discovery"</a>
<li><strong>Previous message:</strong> <a href="22409.php">Reuti: "Re: [OMPI users] requirement on ssh when run openmpi"</a>
<li><strong>In reply to:</strong> <a href="22409.php">Reuti: "Re: [OMPI users] requirement on ssh when run openmpi"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="../../att-22410/attachment">attachment</a>
</ul>
