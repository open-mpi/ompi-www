...
<p class="headers">
<strong>Subject:</strong> [OMPI users] OpenMPI 1.7.2 and CLAPACK libs discovery<br>
<strong>From:</strong> gpaulus (<em>gpaulus_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-08-01 09:37:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22424.php">Ralph Castain: "Re: [OMPI users] requirement on ssh when run openmpi"</a>
<li><strong>Previous message:</strong> <a href="22422.php">meng : "Re: [OMPI users] requirement on ssh when run openmpi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22425.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.7.2 and CLAPACK libs discovery"</a>
<li><strong>Reply:</strong> <a href="22425.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.7.2 and CLAPACK libs discovery"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>application/x-bzip2 attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22423/gnubuild.bz2__size_7374">gnubuild.bz2__size_7374</a>
</ul>
<!-- attachment="gnubuild.bz2__size_7374" -->
<hr>
<ul>
<li>application/x-bzip2 attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22423/config.out.bz2__size_19757">config.out.bz2__size_19757</a>
</ul>
