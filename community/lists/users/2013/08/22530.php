<?
$subject_val = "[OMPI users] Call For Participation: EuroMPI 2013. Madrid, Spain. September	15-18th";
include("../../include/msg-header.inc");
?>
<!-- received="Tue Aug 20 22:35:24 2013" -->
<!-- isoreceived="20130821023524" -->
<!-- sent="Wed, 21 Aug 2013 04:35:21 +0200" -->
<!-- isosent="20130821023521" -->
<!-- name="Javier Garcia Blas" -->
<!-- email="fjblas_at_[hidden]" -->
<!-- subject="[OMPI users] Call For Participation: EuroMPI 2013. Madrid, Spain. September	15-18th" -->
<!-- id="20130821023521.GA7352_at_piojito.arcos.inf.uc3m.es" -->
<!-- charset="utf-8" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Call For Participation: EuroMPI 2013. Madrid, Spain. September	15-18th<br>
<strong>From:</strong> Javier Garcia Blas (<em>fjblas_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-08-20 22:35:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22531.php">Jeremiah Willcock: "Re: [OMPI users] Addendum to: Assembler instruction errors for push and pop during make"</a>
<li><strong>Previous message:</strong> <a href="22529.php">Richard Haney: "Re: [OMPI users] Addendum to: Assembler instruction errors for push and pop during make"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
------------------------------- 
<br>
<p>- Prof. Alok N. Choudhary: Exascale Systems, Big Data and Knowledge Discovery - Challenges and Opportunities
<br>
...
<br>
<p><p>- Prof. Alex Ramirez: The Mont-Blanc approach towards Exascale
<br>
...
<br>
<p><p>- Prof. Jesper Larsson Tr&#195;&#131;&#226;&#130;&#172;ff: Unique Features of MPI: Collective Operations on Structured Data
<br>
...
<br>
<p>- Dr. Rajeev Thakur: Evolving MPI to Address the Challenges of Exascale Systems
<br>
<p>The vast majority of production parallel scientific applications today use MPI and run successfully on the largest systems in the world. For example, MPI applications are running at full scale on the Sequoia system (on ~1.6 million cores) and achieving 12 to 14 petaflops of sustained performance. As we progress from petascale to exascale systems over the course of this decade, it is essential that MPI must evolve to run as efficiently as possible on future systems, so that applications can continue to gain the benefits of the performance offered by these systems. This talk will examine the challenges in scaling MPI to exascale and discuss current work in addressing those challenges.
<br>
<p>- Dr. Panagiotis Tsarchopoulos: High-Performance Computing in Horizon 2020
<br>
<p>Horizon 2020 is the next European Framework Programme for Research and Innovation that will run from 2014 to 2020. The talk will give an overview of Horizon 2020 and will discuss the perspectives for High-Performance Computing in Horizon 2020.
<br>
<p>WORKSHOPS
<br>
------------------------------- 
...
------------------------------- 
<br>
<p>- Tutorial(s): September 15th, 2012 
<br>
