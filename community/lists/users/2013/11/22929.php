...
?>
<!-- received="Thu Nov  7 19:36:33 2013" -->
<!-- isoreceived="20131108003633" -->
<!-- sent="Fri, 8 Nov 2013 09:37:12 +0900" -->
<!-- isosent="20131108003712" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] LAMA of openmpi-1.7.3 is unstable" -->
<!-- id="OFBBAA83BF.D933B4AB-ON49257C1D.0002AD17-49257C1D.0003599D_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="AC649B56-555C-482F-A823-F06330739A85_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-07 19:37:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22930.php">Ralph Castain: "Re: [OMPI users] LAMA of openmpi-1.7.3 is unstable"</a>
<li><strong>Previous message:</strong> <a href="22928.php">Ralph Castain: "Re: [OMPI users] LAMA of openmpi-1.7.3 is unstable"</a>
<li><strong>In reply to:</strong> <a href="22928.php">Ralph Castain: "Re: [OMPI users] LAMA of openmpi-1.7.3 is unstable"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22930.php">Ralph Castain: "Re: [OMPI users] LAMA of openmpi-1.7.3 is unstable"</a>
<li><strong>Reply:</strong> <a href="22930.php">Ralph Castain: "Re: [OMPI users] LAMA of openmpi-1.7.3 is unstable"</a>
<li><strong>Reply:</strong> <a href="22961.php">tmishima_at_[hidden]: "[OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Thanks, Ralph.
<br>
<p>This is an additional information.
<br>
<p>Just execute directly on the node without Torque:
<br>
mpirun -np 8 -report-bindings -mca rmaps lama -mca rmaps_lama_bind 1c
<br>
Myprog
<br>
<p>Then it also works, which means the combination of LAMA and Torque would
<br>
case
<br>
the problem.
...
<p>Tetsuya Mishima
<br>
<p><span class="quotelev1">&gt; Okay, so the problem is a bug in LAMA itself. I'll file a ticket and let
</span><br>
the LAMA folks look into it.
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Nov 7, 2013, at 4:18 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; I quickly tried 2 runs:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; It works fine in both cases on node03 and node08.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; What happens if you drop the LAMA request and instead run
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; This would do the same thing - does it work? If so, then we know it is
</span><br>
a
<br>
<span class="quotelev2">&gt; &gt; problem in the LAMA mapper. If not, then it is likely a problem in a
</span><br>
<span class="quotelev2">&gt; &gt; different section of the code.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
...
<span class="quotelev3">&gt; &gt;&gt; On Nov 7, 2013, at 3:43 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; I tried the new function LAMA of openmpi-1.7.3 and
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; unfortunately it is not stable under my environment, which
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; is built with torque.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (1) I used 4 scripts as shown below to clarify the problem:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (COMMON PART)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #!/bin/sh
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; #PBS -l nodes=node03:ppn=8 / nodes=node08:ppn=8
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; (SCRIPT1)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; mpirun -report-bindings -mca rmaps lama -mca rmaps_lama_bind 1c
</span><br>
Myprog
<br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (SCRIPT2)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; mpirun -oversubscribe -report-bindings -mca rmaps lama \
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;      -mca rmaps_lama_bind 1c Myprog
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (SCRITP3)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; mpirun -machinefile pbs_hosts -np ${NPROCS} -oversubscribe \
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;      -report-bindings -mca rmaps lama -mca rmaps_lama_bind 1c Myprog
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (SCRIPT4)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; mpirun -machinefile pbs_hosts -np ${NPROCS} -oversubscribe \
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;      -report-bindings -mca rmaps lama -mca rmaps_lama_bind 1c \
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;      -mca rmaps_lama_map Nsbnch \
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;      -mca ess ^tm -mca plm ^tm -mca ras ^tm Myprog
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (2) The results are as follows:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;            NODE03(32cores) NODE08(8cores)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; SCRIPT1      *ERROR1         *ERROR1
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; SCRIPT2      OK              OK
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; SCRIPT3      **ABORT         OK
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; SCRIPT4      **ABORT         **ABORT
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (*)ERROR1 means:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt; &gt;
...
--------------------------------------------------------------------------
<br>
<span class="quotelev4">&gt; &gt;&gt;&gt; RMaps LAMA detected oversubscription after mapping 1 of 8 processes.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Since you have asked not to oversubscribe the resources the job will
</span><br>
<span class="quotelev2">&gt; &gt; not
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; be launched. If you would instead like to oversubscribe the resources
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; try using the --oversubscribe option to mpirun.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt; &gt;
...
--------------------------------------------------------------------------
<br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [node08.cluster:28849] [[50428,0],0] ORTE_ERROR_LOG: Error in file
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; rmaps_lama_module.c at line 310
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [node08.cluster:28849] [[50428,0],0] ORTE_ERROR_LOG: Error in file
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; base/rmaps_base_map_job.c at line 166
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (**)ABORT means &quot;stuck and no answer&quot; until forced termination.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (3) openmpi-1.7.3 configuration (with PGI compiler)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; (4) Cluster information:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 32 cores AMD based node(node03):
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; 8 cores AMD based node(node08):
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;   PCI 10de:036e
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;   PCI 10de:037f
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;     PCI 18ca:0020
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;   PCIBridge
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;     PCI 15b3:6274
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;       Net L#1 &quot;ib0&quot;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;       OpenFabrics L#2 &quot;mthca0&quot;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
