<?
$subject_val = "Re: [OMPI users] Segmentation fault in MPI_Init when passingpointers allocated in main()";
include("../../include/msg-header.inc");
?>
<!-- received="Tue Nov 12 13:25:11 2013" -->
<!-- isoreceived="20131112182511" -->
<!-- sent="Tue, 12 Nov 2013 22:24:14 +0400" -->
<!-- isosent="20131112182414" -->
<!-- name="Alex A. Granovsky" -->
<!-- email="gran_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in MPI_Init when passingpointers allocated in main()" -->
<!-- id="84AD1BB619A24E5AAD853D3FBB2CCD5E_at_chem.msu.ru" -->
<!-- charset="iso-8859-1" -->
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] Segmentation fault in MPI_Init when passingpointers allocated in main()<br>
<strong>From:</strong> Alex A. Granovsky (<em>gran_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-11-12 13:24:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22958.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Prototypes for Fortran MPI_ commands using 64-bit	indexing"</a>
<li><strong>Previous message:</strong> <a href="22956.php">Tang, Yu-Hang: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
...
<p>in
<br>
<p><a href="http://www.open-std.org/jtc1/sc22/wg14/www/C99RationaleV5.10.pdf">http://www.open-std.org/jtc1/sc22/wg14/www/C99RationaleV5.10.pdf</a>
<br>
<p>it is written:
<br>
<p>---------
...
and atexit
<br>
(see &#167;7.20.4.2) has been codified to curb some unwanted variety in the 
<br>
representation of argv
<br>
...
prior practice.
<br>
argv[argc] is required to be a null pointer to provide a redundant check for 
<br>
the end of the
<br>
list, also on the basis of common practice.
<br>
------------------------
<br>
<p>so I believe it was not actually enforced as a standard before C99.
<br>
<p>It would make sense to pass argc not counting on the NULL for better 
<br>
compatibility.
<br>
<p>Kind regards,
...
From: Ralph Castain
<br>
Sent: Tuesday, November 12, 2013 9:18 PM
<br>
To: Open MPI Users
<br>
...
<br>
<p>Kernighan and Richie's C programming language manual - it goes all the way 
<br>
back to the original C definition.
<br>
<p><p>On Nov 12, 2013, at 9:15 AM, Alex A. Granovsky &lt;gran_at_[hidden]&gt; 
<br>
wrote:
<br>
...
<span class="quotelev1">&gt; could you please point to the exact document where this is explicitly 
</span><br>
<span class="quotelev1">&gt; stated?
</span><br>
<span class="quotelev1">&gt; Otherwise, I'd assume this is a bug.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; -----Original Message----- From: Matthieu Brucher
</span><br>
<span class="quotelev1">&gt; Sent: Tuesday, November 12, 2013 8:56 PM
</span><br>
<span class="quotelev1">&gt; To: Open MPI Users
</span><br>
<span class="quotelev1">&gt; Subject: Re: [OMPI users] Segmentation fault in MPI_Init when passing 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I tried the following code without CUDA, the error is still there:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;    sprintf( argv_new[argc+1], &quot;%d&quot;, 0 );
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; At the end of the program the pointer stored in argv is exactly that of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; argv_new so this should not be a problem. Manually inserting printf 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; tells me
</span><br>
<span class="quotelev3">&gt;&gt;&gt; that the fault occured at MPI_Init. The code works fine if I use
</span><br>
<span class="quotelev3">&gt;&gt;&gt; MPI_Init(NULL,NULL) instead. The same code also compiles and runs 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; without a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; problem on my laptop with mpich2-1.4.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Best,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Yu-Hang
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, Nov 12, 2013 at 11:18 AM, Matthieu Brucher
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Are you sure this is the correct code? This seems strange and not a 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Did you mean argc_new and argv_new instead?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Do you have the same error without CUDA?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 2013/11/12 Tang, Yu-Hang &lt;yuhang_tang_at_[hidden]&gt;:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; Hi,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; I tried to augment the command line argument list by allocating my 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; own
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; list
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; of strings and passing them to MPI_Init, yet I got a segmentation &gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; fault
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; for
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; both OpenMPI 1.6.3 and 1.7.2, while the code works fine with MPICH2. 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt;         else if( (var = getenv(&quot;MV2_COMM_WORLD_LOCAL_RANK&quot;))  != 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; NULL)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; local_rank = atoi(var);
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt;         else if( (var = getenv(&quot;OMPI_COMM_WORLD_LOCAL_RANK&quot;)) != 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; NULL)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; local_rank = atoi(var);
...
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt;     // override command line arguments to make sure cudaengine get 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt; &gt; [jueying:16317] [ 4] &gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Room 105, 37 Manning St
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Division of Applied Mathematics, Brown University
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Providence, RI 02912
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
