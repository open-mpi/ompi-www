...
?>
<!-- received="Wed Nov 13 10:33:03 2013" -->
<!-- isoreceived="20131113153303" -->
<!-- sent="Wed, 13 Nov 2013 07:32:14 -0800" -->
<!-- isosent="20131113153214" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646" -->
<!-- id="93F79693-31F0-41A0-AAF9-1448460BC562_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="OFB6A99F21.5596524C-ON49257C22.0028C574-49257C22.00293072_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-13 10:32:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22968.php">Iván Cores González: "[OMPI users] Mpirun performance varies changing the hostfile with equivalent configuration."</a>
<li><strong>Previous message:</strong> <a href="22966.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<li><strong>In reply to:</strong> <a href="22966.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22975.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>Reply:</strong> <a href="22975.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>Reply:</strong> <a href="22977.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Nov 12, 2013, at 11:30 PM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; [node08.cluster:23573] mca:base:select:(  plm) Querying component [rsh]
</span><br>
...
<span class="quotelev1">&gt; [node08.cluster:23573] mca:base:select:(  plm) Query of component [rsh] set
</span><br>
<span class="quotelev1">&gt; priority to 10
</span><br>
<span class="quotelev1">&gt; [node08.cluster:23573] mca:base:select:(  plm) Querying component [slurm]
</span><br>
<span class="quotelev1">&gt; [node08.cluster:23573] mca:base:select:(  plm) Skipping component [slurm].
</span><br>
<span class="quotelev1">&gt; Query failed to return a module
</span><br>
<span class="quotelev1">&gt; [node08.cluster:23573] mca:base:select:(  plm) Querying component [tm]
</span><br>
<span class="quotelev1">&gt; [node08.cluster:23573] mca:base:select:(  plm) Query of component [tm] set
</span><br>
<span class="quotelev1">&gt; priority to 75
</span><br>
<span class="quotelev1">&gt; [node08.cluster:23573] mca:base:select:(  plm) Selected component [tm]
</span><br>
<span class="quotelev1">&gt; [node08.cluster:23573] plm:base:set_hnp_name: initial bias 23573 nodename
</span><br>
...
<span class="quotelev2">&gt;&gt; Okey, I can help you. Please give me some time to report the output.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I can try, but I have no way of testing Torque any more - so all I can
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'd like to report one more regressive issue about Torque support of
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; openmpi-1.7.4a1r29646, which might be related to &quot;#3893: LAMA mapper
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Since this happens without lama request, I guess it's not the problem
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I got a segmentation fault in traial use of openmpi-1.7.4a1r29646
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [mishima_at_manage testbed-openmpi-1.7.3]$ mpirun -np 4 -cpus-per-proc
</span><br>
