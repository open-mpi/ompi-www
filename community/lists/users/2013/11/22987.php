...
?>
<!-- received="Wed Nov 13 22:22:59 2013" -->
<!-- isoreceived="20131114032259" -->
<!-- sent="Thu, 14 Nov 2013 12:23:27 +0900" -->
<!-- isosent="20131114032327" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646" -->
<!-- id="OF83BBD702.71998E48-ON49257C23.0010C301-49257C23.00129540_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="67A2BE3F-EFAC-4370-877A-2C09CAACBC30_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-13 22:23:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22988.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>Previous message:</strong> <a href="22986.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<li><strong>In reply to:</strong> <a href="22986.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22988.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>Reply:</strong> <a href="22988.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Furthremore, in this case, for hybrid application with openmpi+openmp,
<br>
the modification of hostfile is necesarry as follows:
<br>
<p>#PBS -l nodes=1:ppn=32+4:ppn=8
<br>
...
Myprog
<br>
<p>That's why I want to do that.
<br>
<p>Of course I know, If I quit mixed use, -npernode is better for this
<br>
purpose.
<br>
<p>(The script I showed you first is just a simplified one to clarify the
<br>
problem.)
<br>
<p>tmishima
<br>
<p><p><span class="quotelev1">&gt; Why do it the hard way? I'll look at the FAQ because that definitely
</span><br>
