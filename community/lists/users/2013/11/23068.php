...
?>
<!-- received="Tue Nov 26 05:25:05 2013" -->
<!-- isoreceived="20131126102505" -->
<!-- sent="Tue, 26 Nov 2013 19:24:55 +0900" -->
<!-- isosent="20131126102455" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under	Torque manager" -->
<!-- id="OF53DE947E.1B954519-ON49257C2F.00385520-49257C2F.003938F1_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2013-11-26 05:24:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23069.php">Pierre Jolivet: "[OMPI users] Bug Iscatterv/Igatherv"</a>
<li><strong>Previous message:</strong> <a href="23067.php">Reuti: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under Torque manager"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23081.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under Torque manager"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>I used interactive mode just because it was easy to report the behavior.
<br>
I'm sure that submiting job gives the same result.
<br>
Therefore, I think the environment variables are also set in the session.
<br>
<p>Anyway, I'm away from the cluster now. Regarding &quot;$ env | grep PBS&quot;,
<br>
I'll send it later.
<br>
<p>Regards,
