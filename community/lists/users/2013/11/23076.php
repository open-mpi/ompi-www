...
?>
<!-- received="Tue Nov 26 16:41:12 2013" -->
<!-- isoreceived="20131126214112" -->
<!-- sent="Tue, 26 Nov 2013 14:41:11 -0700" -->
<!-- isosent="20131126214111" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [EXTERNAL] Re: (OpenMPI for Cray XE6 ) How to set mca parameters through aprun?" -->
<!-- id="20131126214111.GD55796_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CEBA5353.461B7%knteran_at_sandia.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-26 16:41:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23077.php">Teranishi, Keita: "Re: [OMPI users] [EXTERNAL] Re: (OpenMPI for Cray XE6 ) How to set mca parameters through aprun?"</a>
<li><strong>Previous message:</strong> <a href="23075.php">Teranishi, Keita: "Re: [OMPI users] [EXTERNAL] Re: (OpenMPI for Cray XE6 ) How to set mca parameters through aprun?"</a>
<li><strong>In reply to:</strong> <a href="23075.php">Teranishi, Keita: "Re: [OMPI users] [EXTERNAL] Re: (OpenMPI for Cray XE6 ) How to set mca parameters through aprun?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23077.php">Teranishi, Keita: "Re: [OMPI users] [EXTERNAL] Re: (OpenMPI for Cray XE6 ) How to set mca parameters through aprun?"</a>
<li><strong>Reply:</strong> <a href="23077.php">Teranishi, Keita: "Re: [OMPI users] [EXTERNAL] Re: (OpenMPI for Cray XE6 ) How to set mca parameters through aprun?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Well, no hints as to the error there. Looks identical to the output on my XE-6. How
<br>
about setting -mca rmaps_base_verbose 100 . See what is going on with the mapper.
<br>
<p>-Nathan Hjelm
<br>
Application Readiness, HPC-5, LANL
<br>
<p>On Tue, Nov 26, 2013 at 09:33:20PM +0000, Teranishi, Keita wrote:
<br>
...
<span class="quotelev2">&gt; &gt;Seems like something is going wrong with processor binding. Can you run
</span><br>
<span class="quotelev2">&gt; &gt;with
</span><br>
<span class="quotelev2">&gt; &gt;-mca plm_base_verbose 100 . Might shed some light on why it thinks there
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Now I remove strip_prefix stuff, which was applied to the other versions
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt; &gt;Weird. That is the same configuration we have deployed on Cielito and
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt; &gt;to 0. That will confuse orte since the node hostname will not match
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; I use OpenMPI-1.7.2 (build with gcc-4.7.2) to run the program.  I
</span><br>
<span class="quotelev3">&gt; &gt;&gt;used
</span><br>
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; contrib/platform/lanl/cray_xe6/optimized_lustre and
</span><br>
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; --enable-mpirun-prefix-by-default for configuration.  As I said, it
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt; &gt;&gt; &gt;ct-login1:/lscratch1/hjelmn/ibm/collective hjelmn$ mpirun -np 32
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt;/home/knteran/openmpi/lib/libmpi.so.0(opal_memory_ptmalloc2_int_free+
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;Just talked with our local Cray rep. Sounds like that torque
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;to use qsub (though qsub use is strongly discouraged) if you use
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; Hmm, this seems like either a bug in qsub (torque is full of
</span><br>
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt;serious
</span><br>
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt;bugs) or a bug
</span><br>
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; in alps. I got an allocation using that command and alps only
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; [ct-login1.localdomain:06010] ras:alps:allocate: 47 entries in
</span><br>
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt;file
</span><br>
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; [ct-login1.localdomain:06010] ras:alps:allocate: read data for
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; Which is wrong! I will have to ask Cray what is going on here.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;I
</span><br>
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt;recommend you switch to
</span><br>
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; msub to get an allocation. Moab has fewer bugs. I can't even
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; On Sat, Nov 23, 2013 at 10:13:26PM +0000, Teranishi, Keita
</span><br>
<span class="quotelev3">&gt; &gt;&gt;wrote:
</span><br>
<span class="quotelev2">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;    Hi,
</span><br>
<span class="quotelev2">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;    I installed OpenMPI on our small XE6 using the configure
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;&gt; &gt;    -lmppwidth=32 -lmppnppn=16&quot;, mpirun recognizes it as 2
</span><br>
<span class="quotelev3">&gt; &gt;&gt;slots.
</span><br>
...
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23076/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
