...
?>
<!-- received="Tue Nov 26 05:04:11 2013" -->
<!-- isoreceived="20131126100411" -->
<!-- sent="Tue, 26 Nov 2013 11:03:52 +0100" -->
<!-- isosent="20131126100352" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under Torque manager" -->
<!-- id="6358E06B-BA1A-48DE-A670-C3F0B85F39AF_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2013-11-26 05:03:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23068.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under	Torque manager"</a>
<li><strong>Previous message:</strong> <a href="23066.php">Dominique Orban: "Re: [OMPI users] MPI process hangs if OpenMPI is compiled with --enable-thread-multiple"</a>
<li><strong>In reply to:</strong> <a href="23064.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under Torque manager"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23068.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under	Torque manager"</a>
<li><strong>Reply:</strong> <a href="23068.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under	Torque manager"</a>
<li><strong>Reply:</strong> <a href="23081.php">tmishima_at_[hidden]: "Re: [OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under Torque manager"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Am 26.11.2013 um 01:22 schrieb tmishima_at_[hidden]:
<br>
<p><span class="quotelev1">&gt; Thank you very much for your quick response.
</span><br>
...
<p>Are the environment variables of Torque also set in an interactive session? What is the output of:
<br>
<p>$ env | grep PBS
<br>
<p>inside such a session.
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; [mishima_at_node03 ~]$ cd ~/Ducom/testbed2
</span><br>
