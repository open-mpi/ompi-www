...
?>
<!-- received="Thu Nov 14 09:50:32 2013" -->
<!-- isoreceived="20131114145032" -->
<!-- sent="Thu, 14 Nov 2013 06:49:34 -0800" -->
<!-- isosent="20131114144934" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646" -->
<!-- id="335512B3-AFAA-4C0C-9144-FFDADEF51A42_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2013-11-14 09:49:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22992.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<li><strong>Previous message:</strong> <a href="22990.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22992.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<li><strong>Reply:</strong> <a href="22992.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>[rhc_at_bend001 svn-trunk]$ mpirun -n 3 --bind-to core --cpus-per-proc 4 --report-bindings -hostfile hosts hostname
<br>
...
<p>where
<br>
<p>[rhc_at_bend001 svn-trunk]$ cat hosts
<br>
bend001 slots=12
<br>
<p>The only way I get the &quot;out of resources&quot; error is if I ask for more processes than I have slots - i.e., I give it the hosts file as shown, but ask for 13 or more processes.
<br>
<p><p>BTW: note one important issue with cpus-per-proc, as shown above. Because I specified 4 cpus/proc, and my sockets each have 6 cpus, one of my procs wound up being split across the two sockets (2 cores on each). That's about the worst situation you can have.
<br>
<p>So a word of caution: it is up to the user to ensure that the mapping is &quot;good&quot;. We just do what you asked us to do.
<br>
<p><p>On Nov 13, 2013, at 8:30 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Guess I don't see why modifying the allocation is required - we have mapping options that should support such things. If you specify the total number of procs you want, and cpus-per-proc=4, it should do the same thing I would think. You'd get 2 procs on the 8 slot nodes, 8 on the 32 proc nodes, and up to 6 on the 64 slot nodes (since you specified np=16). So I guess I don't understand the issue.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Regardless, if NPROCS=8 (and you verified that by printing it out, not just assuming wc -l got that value), then it shouldn't think it is oversubscribed. I'll take a look under a slurm allocation as that is all I can access.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; proper subset of the hosts allocated to the Torque / PBS Pro job should
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-22991/attachment">attachment</a>
</ul>
