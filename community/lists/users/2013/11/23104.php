<?
$subject_val = "[OMPI users] OMPI Performance Metrics";
...
<!-- subject="[OMPI users] OMPI Performance Metrics" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] OMPI Performance Metrics<br>
<strong>From:</strong> Ralph Castain (<em>rhc_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-11-27 17:50:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23105.php">George Markomanolis: "Re: [OMPI users] openmpi+torque: How run job in a subset of the allocation?"</a>
<li><strong>Previous message:</strong> <a href="23103.php">Ralph Castain: "Re: [OMPI users] openmpi+torque: How run job in a subset of the allocation?"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23104/attachment">attachment</a>
</ul>
