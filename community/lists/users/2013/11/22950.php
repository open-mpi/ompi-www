...
?>
<!-- received="Tue Nov 12 11:56:56 2013" -->
<!-- isoreceived="20131112165656" -->
<!-- sent="Tue, 12 Nov 2013 16:56:55 +0000" -->
<!-- isosent="20131112165655" -->
...
<!-- id="CAHCaCkJtmys0foJj-iWdGqD71g-nVBE3-XsSA==rB+1Sr3AQkA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAHCaCkKndw-_Wq+Fkch5XP5akdDMLvtPTdZ8vy0=73e-8W9Btg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-12 11:56:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22951.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>Previous message:</strong> <a href="22949.php">Matthieu Brucher: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>In reply to:</strong> <a href="22949.php">Matthieu Brucher: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22951.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>Reply:</strong> <a href="22951.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>Reply:</strong> <a href="22954.php">Alex A. Granovsky: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev4">&gt;&gt;&gt; &gt; of strings and passing them to MPI_Init, yet I got a segmentation fault
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; for
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; both OpenMPI 1.6.3 and 1.7.2, while the code works fine with MPICH2. The
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] [ 4] /opt/openmpi/1.7.2/lib/libmpi.so.1(MPI_Init+0x16b)
</span><br>
