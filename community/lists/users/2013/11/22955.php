...
?>
<!-- received="Tue Nov 12 12:19:22 2013" -->
<!-- isoreceived="20131112171922" -->
<!-- sent="Tue, 12 Nov 2013 09:18:38 -0800" -->
<!-- isosent="20131112171838" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()" -->
<!-- id="7D48BD45-1D5F-45F9-8524-9237972D7D58_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="EBAAE178C0D347D1AC36F9C632B76485_at_chem.msu.ru" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-12 12:18:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22956.php">Tang, Yu-Hang: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>Previous message:</strong> <a href="22954.php">Alex A. Granovsky: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>In reply to:</strong> <a href="22954.php">Alex A. Granovsky: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22956.php">Tang, Yu-Hang: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>Reply:</strong> <a href="22956.php">Tang, Yu-Hang: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>Reply:</strong> <a href="22957.php">Alex A. Granovsky: "Re: [OMPI users] Segmentation fault in MPI_Init when passingpointers allocated in main()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Nov 12, 2013, at 9:15 AM, Alex A. Granovsky &lt;gran_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; could you please point to the exact document where this is explicitly stated?
</span><br>
...
<span class="quotelev1">&gt; Subject: Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()
</span><br>
<span class="quotelev1">&gt; 
</span><br>
