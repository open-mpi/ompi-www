...
?>
<!-- received="Thu Nov 14 22:01:16 2013" -->
<!-- isoreceived="20131115030116" -->
<!-- sent="Fri, 15 Nov 2013 12:01:44 +0900" -->
<!-- isosent="20131115030144" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646" -->
<!-- id="OFE7CA5D42.9E2D90A4-ON49257C24.000E901B-49257C24.001098E1_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="4D8DED6A-6C01-4851-9D68-8AC50E41E565_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-14 22:01:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22995.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>Previous message:</strong> <a href="22993.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<li><strong>In reply to:</strong> <a href="22993.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22995.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>Reply:</strong> <a href="22995.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p>It's no problem that you let it lie until the problem becomes serious
<br>
again.
<br>
<p>So, this is just an information for you.
<br>
<p>I agree with your opinion that the problem will lie in the modified
<br>
hostfile.
<br>
...
<br>
<p>To make it clear and to prove I never modify hostfile given by Torque,
<br>
I change the script like this:
<br>
<p>[mishima_at_manage testbed-openmpi-1.7.3]$ cat myscript.sh
<br>
#!/bin/sh
<br>
...
<br>
<p>Here, $PBS_NODEFILE is the variable prepared by Torque, which contains
<br>
allocated nodes.
<br>
...
Torque.
<br>
<p>Then, you have to submit the job to produce the problem, because direct run
<br>
could work.
<br>
The output of this job is below:
<br>
<p>[mishima_at_manage testbed-openmpi-1.7.3]$ qsub myscript.sh
<br>
7999.manage.cluster
<br>
[mishima_at_manage testbed-openmpi-1.7.3]$ cat myscript.sh.o7999
<br>
node08
<br>
node08
...
--------------------------------------------------------------------------
<br>
<p>As you can see, it still causes the oversbuscribed problem.
<br>
I know that -hostfile option is unnecessary in Torque script, but it should
<br>
run even with this harmless option.
<br>
<p>tmishima
<br>
<p><p><span class="quotelev1">&gt; On Nov 14, 2013, at 3:25 PM, tmishima_at_[hidden] wrote:
</span><br>
...
<span class="quotelev2">&gt; &gt; I checked -cpus-per-proc in openmpi-1.7.4a1r29646.
</span><br>
<span class="quotelev2">&gt; &gt; It works well as I want to do, which can adjust nprocs
</span><br>
<span class="quotelev2">&gt; &gt; of each nodes dividing by number of threads.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; I think my problem is solved so far using -cpus-per-proc,
</span><br>
<span class="quotelev2">&gt; &gt; thank you very mush.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Happy that works for you!
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; Regarding oversbuscribed problem, I checked NPROCS was really 8
</span><br>
<span class="quotelev2">&gt; &gt; by outputing the number.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; SCRIPT:
</span><br>
<span class="quotelev2">&gt; &gt; echo mpirun -machinefile pbs_hosts -np $NPROCS -report-bindings
</span><br>
-bind-to
<br>
<span class="quotelev2">&gt; &gt; core Myprog
</span><br>
...
<span class="quotelev2">&gt; &gt; mpirun -machinefile pbs_hosts -np 8 -report-bindings -bind-to core
</span><br>
Myprog
<br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev2">&gt; &gt; By the way, how did you verify the problem.
</span><br>
<span class="quotelev2">&gt; &gt; It looks like for me that you run the job directly from cmd line.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; [rhc_at_bend001 svn-trunk]$ mpirun -n 3 --bind-to core --cpus-per-proc 4
</span><br>
<span class="quotelev2">&gt; &gt; --report-bindings -hostfile hosts hostname
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; In my environment, such a direct run without Torque script also works
</span><br>
fine.
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Really? Your above cmd line is exactly the same as mine - a hardcoded
</span><br>
value for np, passing in a machinefile (or hostfile - same thing) while in
<br>
a matching allocation. The only difference I can see
<br>
<span class="quotelev1">&gt; is that your hostfile may conflict with the detected allocation since you
</span><br>
...
<span class="quotelev2">&gt; &gt; Anyway, as I already told you, my problem itself was solved. So I think
</span><br>
the
<br>
<span class="quotelev2">&gt; &gt; priority to check is very low.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I suspect there really isn't a bug here - the problem most likely lies in
</span><br>
the modified hostfile working against the detected allocation. I'll let it
<br>
lie for now and see if something reveals itself at
<br>
<span class="quotelev1">&gt; a later date.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; FWIW: I verified that this works fine under a slurm allocation of 2
</span><br>
<span class="quotelev2">&gt; &gt; nodes, each with 12 slots. I filled the node without getting an
</span><br>
<span class="quotelev2">&gt; &gt; &quot;oversbuscribed&quot; error message
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [bend001:24318] MCW rank 0 bound to socket 0[core 0[hwt 0-1]], socket
</span><br>
0
<br>
<span class="quotelev2">&gt; &gt; [core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt
</span><br>
0-1]]:
<br>
<span class="quotelev2">&gt; &gt; [BB/BB/BB/BB/../..][../../../../../..]
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [bend001:24318] MCW rank 1 bound to socket 0[core 4[hwt 0-1]], socket
</span><br>
0
<br>
<span class="quotelev2">&gt; &gt; [core 5[hwt 0-1]], socket 1[core 6[hwt 0-1]], socket 1[core 7[hwt
</span><br>
0-1]]:
<br>
<span class="quotelev2">&gt; &gt; [../../../../BB/BB][BB/BB/../../../..]
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [bend001:24318] MCW rank 2 bound to socket 1[core 8[hwt 0-1]], socket
</span><br>
1
<br>
<span class="quotelev2">&gt; &gt; [core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt
</span><br>
0-1]]:
<br>
<span class="quotelev2">&gt; &gt; [../../../../../..][../../BB/BB/BB/BB]
...
<span class="quotelev3">&gt; &gt;&gt; [rhc_at_bend001 svn-trunk]$ cat hosts
</span><br>
<span class="quotelev3">&gt; &gt;&gt; bend001 slots=12
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; The only way I get the &quot;out of resources&quot; error is if I ask for more
</span><br>
<span class="quotelev2">&gt; &gt; processes than I have slots - i.e., I give it the hosts file as shown,
</span><br>
but
<br>
<span class="quotelev2">&gt; &gt; ask for 13 or more processes.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; BTW: note one important issue with cpus-per-proc, as shown above.
</span><br>
Because
<br>
<span class="quotelev2">&gt; &gt; I specified 4 cpus/proc, and my sockets each have 6 cpus, one of my
</span><br>
procs
<br>
<span class="quotelev2">&gt; &gt; wound up being split across the two sockets (2
</span><br>
<span class="quotelev3">&gt; &gt;&gt; cores on each). That's about the worst situation you can have.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; So a word of caution: it is up to the user to ensure that the mapping
</span><br>
is
<br>
<span class="quotelev2">&gt; &gt; &quot;good&quot;. We just do what you asked us to do.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; On Nov 13, 2013, at 8:30 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Guess I don't see why modifying the allocation is required - we have
</span><br>
<span class="quotelev2">&gt; &gt; mapping options that should support such things. If you specify the
</span><br>
total
<br>
<span class="quotelev2">&gt; &gt; number of procs you want, and cpus-per-proc=4, it should
</span><br>
<span class="quotelev3">&gt; &gt;&gt; do the same thing I would think. You'd get 2 procs on the 8 slot
</span><br>
nodes, 8
<br>
<span class="quotelev2">&gt; &gt; on the 32 proc nodes, and up to 6 on the 64 slot nodes (since you
</span><br>
specified
<br>
<span class="quotelev2">&gt; &gt; np=16). So I guess I don't understand the issue.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Regardless, if NPROCS=8 (and you verified that by printing it out, not
</span><br>
<span class="quotelev2">&gt; &gt; just assuming wc -l got that value), then it shouldn't think it is
</span><br>
<span class="quotelev2">&gt; &gt; oversubscribed. I'll take a look under a slurm allocation as
</span><br>
<span class="quotelev3">&gt; &gt;&gt; that is all I can access.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; On Nov 13, 2013, at 7:23 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
...
<span class="quotelev3">&gt; &gt;&gt; Our cluster consists of three types of nodes. They have 8, 32
</span><br>
<span class="quotelev3">&gt; &gt;&gt; and 64 slots respectively. Since the performance of each core is
</span><br>
<span class="quotelev3">&gt; &gt;&gt; almost same, mixed use of these nodes is possible.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Furthremore, in this case, for hybrid application with openmpi+openmp,
</span><br>
<span class="quotelev3">&gt; &gt;&gt; the modification of hostfile is necesarry as follows:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; #PBS -l nodes=1:ppn=32+4:ppn=8
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; mpirun -hostfile pbs_hosts -np 16 -cpus-per-proc 4 -x OMP_NUM_THREADS
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Myprog
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; That's why I want to do that.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Of course I know, If I quit mixed use, -npernode is better for this
</span><br>
<span class="quotelev3">&gt; &gt;&gt; purpose.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; (The script I showed you first is just a simplified one to clarify the
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; isn't a recommended thing to do - better to use -host to specify the
</span><br>
<span class="quotelev3">&gt; &gt;&gt; subset, or just specify the desired mapping using all the
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Sorry for cross-post.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Nodefile is very simple which consists of 8 lines:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Therefore, NPROCS=8
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; My aim is to modify the allocation as you pointed out. According to
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Openmpi
</span><br>
<span class="quotelev3">&gt; &gt;&gt; FAQ,
</span><br>
<span class="quotelev3">&gt; &gt;&gt; proper subset of the hosts allocated to the Torque / PBS Pro job
</span><br>
should
<br>
<span class="quotelev3">&gt; &gt;&gt; be
</span><br>
<span class="quotelev3">&gt; &gt;&gt; allowed.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; tmishima
...
<span class="quotelev3">&gt; &gt;&gt; Please - can you answer my question on script2? What is the value of
</span><br>
<span class="quotelev3">&gt; &gt;&gt; NPROCS?
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Why would you want to do it this way? Are you planning to modify the
</span><br>
<span class="quotelev3">&gt; &gt;&gt; allocation?? That generally is a bad idea as it can confuse the system
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; On Nov 13, 2013, at 5:55 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
...
<span class="quotelev3">&gt; &gt;&gt; from the outside. I doubt these lines are strange, especially the
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Yes, the node08 has 8 slots but the process I run is also 8.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Therefore, I think it should allow this allocation. Is that right?
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; My question is why scritp1 works and script2 does not. They are
</span><br>
<span class="quotelev3">&gt; &gt;&gt; almost same.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; #PBS -l nodes=node08:ppn=8
...
<span class="quotelev3">&gt; &gt;&gt; invoking
</span><br>
<span class="quotelev3">&gt; &gt;&gt; the hostfile filter on top of it. Different code path. I'll take a
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; possibility that it is a different number? I don't recall, but isn't
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; I guess here's my confusion. If you are using only one node, and
</span><br>
<span class="quotelev3">&gt; &gt;&gt; that
</span><br>
<span class="quotelev3">&gt; &gt;&gt; node has 8 allocated slots, then we will not allow you to run more
</span><br>
<span class="quotelev3">&gt; &gt;&gt; than
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 8
</span><br>
<span class="quotelev3">&gt; &gt;&gt; processes on that node unless you specifically provide
</span><br>
<span class="quotelev3">&gt; &gt;&gt; the --oversubscribe flag. This is because you are operating in a
</span><br>
<span class="quotelev3">&gt; &gt;&gt; managed
</span><br>
<span class="quotelev3">&gt; &gt;&gt; environment (in this case, under Torque), and so we treat the
</span><br>
<span class="quotelev3">&gt; &gt;&gt; allocation as
</span><br>
<span class="quotelev3">&gt; &gt;&gt; &quot;mandatory&quot; by default.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; I suspect that is the issue here, in which case the system is
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On Nov 13, 2013, at 4:11 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; rmaps_base_verbose
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:26952] [[56581,0],0] plm:base:setup_vm creating
</span><br>
<span class="quotelev3">&gt; &gt;&gt; map
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:26952] [[56581,0],0] plm:base:setup_vm only HNP
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:26952] [[56581,0],0] Removing node node08 slots
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 0
</span><br>
<span class="quotelev3">&gt; &gt;&gt; inuse 0
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; oversubscribed -
</span><br>
<span class="quotelev3">&gt; &gt;&gt; performing second pass
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:rr:slot working node node08
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:rr:slot adding up to 8 procs to
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 0 to node
</span><br>
<span class="quotelev3">&gt; &gt;&gt; node08
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 1 to node
</span><br>
<span class="quotelev3">&gt; &gt;&gt; node08
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 2 to node
</span><br>
<span class="quotelev3">&gt; &gt;&gt; node08
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 3 to node
</span><br>
<span class="quotelev3">&gt; &gt;&gt; node08
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 4 to node
</span><br>
<span class="quotelev3">&gt; &gt;&gt; node08
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 5 to node
</span><br>
<span class="quotelev3">&gt; &gt;&gt; node08
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 6 to node
</span><br>
<span class="quotelev3">&gt; &gt;&gt; node08
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 7 to node
</span><br>
<span class="quotelev3">&gt; &gt;&gt; node08
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
...
<span class="quotelev3">&gt; &gt;&gt; Hmmm...looks like we aren't getting your allocation. Can you
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:23573] mca:base:select:(  plm) Querying
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:23573] mca:base:select:(  plm) Query of
</span><br>
<span class="quotelev3">&gt; &gt;&gt; component
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [rsh]
...
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:23573] mca:base:select:(  plm) Skipping
</span><br>
<span class="quotelev3">&gt; &gt;&gt; component
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [slurm].
...
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:23573] mca:base:select:(  plm) Selected
</span><br>
<span class="quotelev3">&gt; &gt;&gt; component
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [tm]
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:23573] plm:base:set_hnp_name: initial bias
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 23573
</span><br>
<span class="quotelev3">&gt; &gt;&gt; nodename
</span><br>
<span class="quotelev3">&gt; &gt;&gt; hash 85176670
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:23573] plm:base:set_hnp_name: final jobfam
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 59480
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:23573] [[59480,0],0] plm:base:receive start
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [node08.cluster:23573] [[59480,0],0] plm:base:setup_vm only
</span><br>
<span class="quotelev3">&gt; &gt;&gt; HNP
</span><br>
<span class="quotelev3">&gt; &gt;&gt; in
</span><br>
<span class="quotelev3">&gt; &gt;&gt; allocation
...
<span class="quotelev3">&gt; &gt;&gt; --with-tm \&gt;&gt; --with-verbs \
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; I can try, but I have no way of testing Torque any more - so
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; is a code review. If you can build --enable-debug and add
</span><br>
<span class="quotelev3">&gt; &gt;&gt; -mca
</span><br>
<span class="quotelev3">&gt; &gt;&gt; plm_base_verbose 5 to your cmd line, I'd appreciate seeing
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; I'd like to report one more regressive issue about Torque
</span><br>
<span class="quotelev3">&gt; &gt;&gt; support
</span><br>
<span class="quotelev3">&gt; &gt;&gt; of
</span><br>
<span class="quotelev3">&gt; &gt;&gt; openmpi-1.7.4a1r29646, which might be related to &quot;#3893:
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; mpirun -machinefile pbs_hosts -np ${NPROCS}
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; If I drop &quot;-machinefile pbs_hosts -np ${NPROCS} &quot;, then it
</span><br>
<span class="quotelev3">&gt; &gt;&gt; works
</span><br>
<span class="quotelev3">&gt; &gt;&gt; fine.
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Since this happens without lama request, I guess it's not
</span><br>
<span class="quotelev3">&gt; &gt;&gt; the
</span><br>
<span class="quotelev3">&gt; &gt;&gt; problem
</span><br>
<span class="quotelev3">&gt; &gt;&gt; in lama itself. Anyway, please look into this issue as
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On Nov 12, 2013, at 7:35 PM, tmishima_at_[hidden]
</span><br>
<span class="quotelev3">&gt; &gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
...
<span class="quotelev3">&gt; &gt;&gt; [manage.cluster:23082] MCW rank 2 bound to socket 0[core
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [manage.cluster:23082] MCW rank 3 bound to socket 1[core
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; [manage.cluster:23082] MCW rank 0 bound to socket 0[core
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 0
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [hwt
...
<span class="quotelev3">&gt; &gt;&gt; [manage.cluster:23082] MCW rank 1 bound to socket 0[core
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 2
</span><br>
<span class="quotelev3">&gt; &gt;&gt; [hwt
...
<span class="quotelev3">&gt; &gt;&gt; core.23082
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; #2  0x00002b5f848eb06a in
</span><br>
<span class="quotelev3">&gt; &gt;&gt; event_process_active_single_queue
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; #4  0x00002b5f848eb849 in
</span><br>
<span class="quotelev3">&gt; &gt;&gt; opal_libevent2021_event_base_loop
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; */&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 625      peer = mca_oob_tcp_peer_lookup(mod, &amp;hdr-&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; origin);
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; opal_hash_table_set_value_uint64
</span><br>
