...
?>
<!-- received="Wed Nov 13 21:29:31 2013" -->
<!-- isoreceived="20131114022931" -->
<!-- sent="Wed, 13 Nov 2013 18:28:37 -0800" -->
<!-- isosent="20131114022837" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646" -->
<!-- id="5BA35991-FB93-4404-AEB0-56FE96F15C61_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="OF607CF942.468D533C-ON49257C23.00084DEF-49257C23.000A80F1_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-13 21:28:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22984.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>Previous message:</strong> <a href="22982.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>In reply to:</strong> <a href="22982.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22985.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<li><strong>Reply:</strong> <a href="22985.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Please - can you answer my question on script2? What is the value of NPROCS?
<br>
<p>Why would you want to do it this way? Are you planning to modify the allocation?? That generally is a bad idea as it can confuse the system
<br>
<p><p>On Nov 13, 2013, at 5:55 PM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; from the outside. I doubt these lines are strange, especially the last one.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; [node08.cluster:26952] [[56581,0],0] Removing node node08 slots 0 inuse 0
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt;                                 &quot;%s Removing node %s slots %d inuse %d&quot;,
</span><br>
...
<span class="quotelev2">&gt;&gt; This version is not only reading the PBS allocation, but also invoking
</span><br>
<span class="quotelev1">&gt; the hostfile filter on top of it. Different code path. I'll take a look -
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I guess here's my confusion. If you are using only one node, and that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; node has 8 allocated slots, then we will not allow you to run more than
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I suspect that is the issue here, in which case the system is behaving
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Nov 13, 2013, at 4:11 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Here is the main part of output by adding &quot;-mca rmaps_base_verbose
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:26952] mca:rmaps:ppr: job [56581,1] not using ppr
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mapper
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:26952] [[56581,0],0] rmaps:seq mapping job [56581,1]
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:26952] mca:rmaps:seq: job [56581,1] not using seq
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mapper
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:26952] mca:rmaps:resilient: cannot perform initial
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:26952] mca:rmaps:mindist: job [56581,1] not using
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; So I added &quot;-oversubscribe&quot; and rerun, then it worked well as show
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:27019] mca:rmaps:base: computing vpids by slot for
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I think something is wrong with treatment of oversubscription, which
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Hmmm...looks like we aren't getting your allocation. Can you rerun
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:23573] mca:base:select:(  plm) Query of component
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [rsh]
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:23573] mca:base:select:(  plm) Selected component
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [tm]
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [node08.cluster:23573] [[59480,0],0] plm:base:setup_vm creating
</span><br>
<span class="quotelev1">&gt; map
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I can try, but I have no way of testing Torque any more - so all
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; openmpi-1.7.4a1r29646, which might be related to &quot;#3893: LAMA
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mapper
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [manage.cluster:23082] MCW rank 2 bound to socket 0[core 4
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [manage.cluster:23082] MCW rank 3 bound to socket 1[core 6
</span><br>
<span class="quotelev1">&gt; [hwt
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 0]],
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [manage.cluster:23082] MCW rank 0 bound to socket 0[core 0
</span><br>
<span class="quotelev1">&gt; [hwt
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 0]],
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [manage.cluster:23082] MCW rank 1 bound to socket 0[core 2
</span><br>
<span class="quotelev1">&gt; [hwt
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 0]],
