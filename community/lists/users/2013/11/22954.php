...
?>
<!-- received="Tue Nov 12 12:16:23 2013" -->
<!-- isoreceived="20131112171623" -->
<!-- sent="Tue, 12 Nov 2013 21:15:25 +0400" -->
<!-- isosent="20131112171525" -->
...
<!-- id="EBAAE178C0D347D1AC36F9C632B76485_at_chem.msu.ru" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAHCaCkJtmys0foJj-iWdGqD71g-nVBE3-XsSA==rB+1Sr3AQkA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-12 12:15:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22955.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>Previous message:</strong> <a href="22953.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>In reply to:</strong> <a href="22950.php">Matthieu Brucher: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22955.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<li><strong>Reply:</strong> <a href="22955.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in MPI_Init when passing pointers allocated in main()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello,
<br>
<p><span class="quotelev1">&gt; It seems that argv[argc] should always be NULL according to the
</span><br>
<span class="quotelev1">&gt; standard. So OMPI failure is not actually a bug!
</span><br>
<p>could you please point to the exact document where this is explicitly 
<br>
stated?
<br>
...
<br>
<p>It seems that argv[argc] should always be NULL according to the
<br>
standard. So OMPI failure is not actually a bug!
<br>
<p>Cheers,
<br>
<p>2013/11/12 Matthieu Brucher &lt;matthieu.brucher_at_[hidden]&gt;:
<br>
...
<span class="quotelev2">&gt;&gt; argv_new so this should not be a problem. Manually inserting printf tells 
</span><br>
<span class="quotelev2">&gt;&gt; me
</span><br>
<span class="quotelev2">&gt;&gt; that the fault occured at MPI_Init. The code works fine if I use
</span><br>
<span class="quotelev2">&gt;&gt; MPI_Init(NULL,NULL) instead. The same code also compiles and runs without 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Are you sure this is the correct code? This seems strange and not a good
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Did you mean argc_new and argv_new instead?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Do you have the same error without CUDA?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt; I tried to augment the command line argument list by allocating my own
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; list
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; of strings and passing them to MPI_Init, yet I got a segmentation 
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; fault
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; for
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; both OpenMPI 1.6.3 and 1.7.2, while the code works fine with MPICH2. 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt; #include &quot;cuda_runtime.h&quot;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt;     int device = 0;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;     int skip = 0;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;     bool skipmode = false;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;     bool specified = false;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;     for( int i = 0 ; i &lt; argc ; i++ )
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;     {
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         if ( strcmp( argv[i], &quot;-device&quot; ) == 0 )
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         {
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             i++;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             if ( argv[i][0] == '-' )
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             {
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;                 skipmode = true;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;                 skip = fabs( atoi( argv[i] ) );
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             }
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt;                 skipmode = false;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;                 device = atoi( argv[i] );
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             }
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             specified = true;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         }
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;     }
...
<span class="quotelev4">&gt;&gt;&gt; &gt;     if ( !specified || skipmode )
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;     {
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         char* var;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         int dev_count, local_rank = 0;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         if ( (var = getenv(&quot;SLURM_LOCALID&quot;)) != NULL) local_rank =
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; atoi(var);
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         else if( (var = getenv(&quot;MV2_COMM_WORLD_LOCAL_RANK&quot;))  != NULL)
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; local_rank = atoi(var);
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         else if( (var = getenv(&quot;OMPI_COMM_WORLD_LOCAL_RANK&quot;)) != NULL)
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; local_rank = atoi(var);
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         cudaGetDeviceCount( &amp;dev_count );
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         if ( skipmode )
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;         {
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             device = 0;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             if ( device == skip ) local_rank++;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             while( local_rank-- &gt; 0 )
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             {
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;                 device = (++device) % dev_count;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;                 if ( device == skip ) local_rank++;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;             }
...
<span class="quotelev4">&gt;&gt;&gt; &gt;         else device = local_rank % dev_count;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;     }
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
...
<span class="quotelev4">&gt;&gt;&gt; &gt;     sprintf( argv_new[argc+1], &quot;%d&quot;, device );
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt;     cudaSetDevice( device );
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt;     cudaDeviceReset();
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt; When compiled using nvcc -ccbin mpic++, The error I got was:
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] *** Process received signal ***
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] Signal: Segmentation fault (11)
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] Signal code: Address not mapped (1)
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] Failing at address: 0x21
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] [ 0] /usr/lib64/libpthread.so.0() [0x39e5e0f000]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] [ 1] /usr/lib64/libc.so.6() [0x39e5760551]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] [ 2]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; /opt/openmpi/1.7.2/lib/libopen-pal.so.5(opal_argv_join+0x39)
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [0x7f460b993079]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] [ 3]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; /opt/openmpi/1.7.2/lib/libmpi.so.1(ompi_mpi_init+0x347)
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [0x7f460c106a57]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] [ 4] 
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; /opt/openmpi/1.7.2/lib/libmpi.so.1(MPI_Init+0x16b)
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [0x7f460c12523b]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] [ 5] ./lmp_jueying() [0x40c035]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] [ 6] /usr/lib64/libc.so.6(__libc_start_main+0xf5)
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [0x39e5621a05]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] [ 7] ./lmp_jueying() [0x40dd21]
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; [jueying:16317] *** End of error message ***
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
