...
?>
<!-- received="Thu Nov 14 18:41:04 2013" -->
<!-- isoreceived="20131114234104" -->
<!-- sent="Thu, 14 Nov 2013 15:40:04 -0800" -->
<!-- isosent="20131114234004" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646" -->
<!-- id="4D8DED6A-6C01-4851-9D68-8AC50E41E565_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="OFD9089918.0C91C973-ON49257C23.007E763E-49257C23.00809A57_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-11-14 18:40:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22994.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>Previous message:</strong> <a href="22992.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<li><strong>In reply to:</strong> <a href="22992.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="22994.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<li><strong>Reply:</strong> <a href="22994.php">tmishima_at_[hidden]: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
On Nov 14, 2013, at 3:25 PM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; I checked -cpus-per-proc in openmpi-1.7.4a1r29646.
</span><br>
<span class="quotelev1">&gt; It works well as I want to do, which can adjust nprocs
</span><br>
<span class="quotelev1">&gt; of each nodes dividing by number of threads.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I think my problem is solved so far using -cpus-per-proc,
</span><br>
<span class="quotelev1">&gt; thank you very mush.
</span><br>
<p>Happy that works for you!
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Regarding oversbuscribed problem, I checked NPROCS was really 8
</span><br>
<span class="quotelev1">&gt; by outputing the number.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; SCRIPT:
</span><br>
<span class="quotelev1">&gt; echo mpirun -machinefile pbs_hosts -np $NPROCS -report-bindings -bind-to
</span><br>
<span class="quotelev1">&gt; core Myprog
</span><br>
...
<span class="quotelev1">&gt; mpirun -machinefile pbs_hosts -np 8 -report-bindings -bind-to core Myprog
</span><br>
<span class="quotelev1">&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev1">&gt; By the way, how did you verify the problem.
</span><br>
<span class="quotelev1">&gt; It looks like for me that you run the job directly from cmd line.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [rhc_at_bend001 svn-trunk]$ mpirun -n 3 --bind-to core --cpus-per-proc 4
</span><br>
<span class="quotelev1">&gt; --report-bindings -hostfile hosts hostname
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; In my environment, such a direct run without Torque script also works fine.
</span><br>
<p>Really? Your above cmd line is exactly the same as mine - a hardcoded value for np, passing in a machinefile (or hostfile - same thing) while in a matching allocation. The only difference I can see is that your hostfile may conflict with the detected allocation since you modified it. I suspect that is causing the confusion.
<br>
<p><p><span class="quotelev1">&gt; Anyway, as I already told you, my problem itself was solved. So I think the
</span><br>
<span class="quotelev1">&gt; priority to check is very low.
</span><br>
<p>I suspect there really isn't a bug here - the problem most likely lies in the modified hostfile working against the detected allocation. I'll let it lie for now and see if something reveals itself at a later date.
<br>
<p>Thanks!
<br>
Ralph
...
<span class="quotelev2">&gt;&gt; FWIW: I verified that this works fine under a slurm allocation of 2
</span><br>
<span class="quotelev1">&gt; nodes, each with 12 slots. I filled the node without getting an
</span><br>
<span class="quotelev1">&gt; &quot;oversbuscribed&quot; error message
</span><br>
...
<span class="quotelev2">&gt;&gt; [bend001:24318] MCW rank 0 bound to socket 0[core 0[hwt 0-1]], socket 0
</span><br>
<span class="quotelev1">&gt; [core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]]:
</span><br>
<span class="quotelev1">&gt; [BB/BB/BB/BB/../..][../../../../../..]
</span><br>
<span class="quotelev2">&gt;&gt; [bend001:24318] MCW rank 1 bound to socket 0[core 4[hwt 0-1]], socket 0
</span><br>
<span class="quotelev1">&gt; [core 5[hwt 0-1]], socket 1[core 6[hwt 0-1]], socket 1[core 7[hwt 0-1]]:
</span><br>
<span class="quotelev1">&gt; [../../../../BB/BB][BB/BB/../../../..]
</span><br>
<span class="quotelev2">&gt;&gt; [bend001:24318] MCW rank 2 bound to socket 1[core 8[hwt 0-1]], socket 1
</span><br>
<span class="quotelev1">&gt; [core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt 0-1]]:
</span><br>
<span class="quotelev1">&gt; [../../../../../..][../../BB/BB/BB/BB]
</span><br>
...
<span class="quotelev2">&gt;&gt; [rhc_at_bend001 svn-trunk]$ cat hosts
</span><br>
<span class="quotelev2">&gt;&gt; bend001 slots=12
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; The only way I get the &quot;out of resources&quot; error is if I ask for more
</span><br>
<span class="quotelev1">&gt; processes than I have slots - i.e., I give it the hosts file as shown, but
</span><br>
<span class="quotelev1">&gt; ask for 13 or more processes.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; BTW: note one important issue with cpus-per-proc, as shown above. Because
</span><br>
<span class="quotelev1">&gt; I specified 4 cpus/proc, and my sockets each have 6 cpus, one of my procs
</span><br>
<span class="quotelev1">&gt; wound up being split across the two sockets (2
</span><br>
<span class="quotelev2">&gt;&gt; cores on each). That's about the worst situation you can have.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; So a word of caution: it is up to the user to ensure that the mapping is
</span><br>
<span class="quotelev1">&gt; &quot;good&quot;. We just do what you asked us to do.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Nov 13, 2013, at 8:30 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Guess I don't see why modifying the allocation is required - we have
</span><br>
<span class="quotelev1">&gt; mapping options that should support such things. If you specify the total
</span><br>
<span class="quotelev1">&gt; number of procs you want, and cpus-per-proc=4, it should
</span><br>
<span class="quotelev2">&gt;&gt; do the same thing I would think. You'd get 2 procs on the 8 slot nodes, 8
</span><br>
<span class="quotelev1">&gt; on the 32 proc nodes, and up to 6 on the 64 slot nodes (since you specified
</span><br>
<span class="quotelev1">&gt; np=16). So I guess I don't understand the issue.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Regardless, if NPROCS=8 (and you verified that by printing it out, not
</span><br>
<span class="quotelev1">&gt; just assuming wc -l got that value), then it shouldn't think it is
</span><br>
<span class="quotelev1">&gt; oversubscribed. I'll take a look under a slurm allocation as
</span><br>
<span class="quotelev2">&gt;&gt; that is all I can access.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Nov 13, 2013, at 7:23 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Why do it the hard way? I'll look at the FAQ because that definitely
</span><br>
...
<span class="quotelev2">&gt;&gt; various mappers we provide.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Nov 13, 2013, at 6:39 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Sorry for cross-post.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Nodefile is very simple which consists of 8 lines:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Therefore, NPROCS=8
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; My aim is to modify the allocation as you pointed out. According to
</span><br>
<span class="quotelev2">&gt;&gt; Openmpi
</span><br>
<span class="quotelev2">&gt;&gt; FAQ,
</span><br>
<span class="quotelev2">&gt;&gt; proper subset of the hosts allocated to the Torque / PBS Pro job should
</span><br>
...
<span class="quotelev2">&gt;&gt; NPROCS?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Why would you want to do it this way? Are you planning to modify the
</span><br>
<span class="quotelev2">&gt;&gt; allocation?? That generally is a bad idea as it can confuse the system
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; I wonder why node-&gt;slots and node-&gt;slots_inuse is 0, which I can read
</span><br>
...
<span class="quotelev2">&gt;&gt; On Nov 13, 2013, at 4:43 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; This version is not only reading the PBS allocation, but also
</span><br>
...
<span class="quotelev2">&gt;&gt; possibility that it is a different number? I don't recall, but isn't
</span><br>
...
<span class="quotelev2">&gt;&gt; node has 8 allocated slots, then we will not allow you to run more
</span><br>
...
<span class="quotelev2">&gt;&gt; On Nov 13, 2013, at 4:11 PM, Ralph Castain &lt;rhc_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Here is the main part of output by adding &quot;-mca
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] [[56581,0],0] plm:base:setup_vm creating
</span><br>
<span class="quotelev2">&gt;&gt; map
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] [[56581,0],0] plm:base:setup_vm only HNP
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] mca:rmaps: creating new map for job
</span><br>
<span class="quotelev2">&gt;&gt; [56581,1]
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] mca:rmaps:ppr: job [56581,1] not using
</span><br>
<span class="quotelev2">&gt;&gt; ppr
</span><br>
<span class="quotelev2">&gt;&gt; mapper
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] [[56581,0],0] rmaps:seq mapping job
</span><br>
<span class="quotelev2">&gt;&gt; [56581,1]
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] mca:rmaps:seq: job [56581,1] not using
</span><br>
<span class="quotelev2">&gt;&gt; seq
</span><br>
<span class="quotelev2">&gt;&gt; mapper
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] mca:rmaps:resilient: cannot perform
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] mca:rmaps:mindist: job [56581,1] not
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] [[56581,0],0] Starting with 1 nodes in
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:26952] [[56581,0],0] Removing node node08 slots
</span><br>
<span class="quotelev2">&gt;&gt; 0
</span><br>
...
<span class="quotelev2">&gt;&gt; So I added &quot;-oversubscribe&quot; and rerun, then it worked well as
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] [[56774,0],0] Starting with 1 nodes in
</span><br>
<span class="quotelev2">&gt;&gt; list
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] [[56774,0],0] Starting bookmark at node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] [[56774,0],0] Starting at node node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:rr: mapping by slot for job
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:rr:slot node node08 is full -
</span><br>
<span class="quotelev2">&gt;&gt; skipping
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:rr:slot job [56774,1] is
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:rr:slot adding up to 8 procs to
</span><br>
<span class="quotelev2">&gt;&gt; node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:base: computing vpids by slot
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 0 to node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 1 to node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 2 to node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 3 to node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 4 to node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 5 to node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 6 to node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:27019] mca:rmaps:base: assigning rank 7 to node
</span><br>
<span class="quotelev2">&gt;&gt; node08
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I think something is wrong with treatment of oversubscription,
</span><br>
...
<span class="quotelev2">&gt;&gt; Hmmm...looks like we aren't getting your allocation. Can you
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:23573] plm:base:set_hnp_name: initial bias
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:23573] plm:base:set_hnp_name: final jobfam
</span><br>
<span class="quotelev2">&gt;&gt; 59480
</span><br>
<span class="quotelev2">&gt;&gt; [node08.cluster:23573] [[59480,0],0] plm:base:receive start
</span><br>
...
<span class="quotelev2">&gt;&gt; [node08.cluster:23573] [[59480,0],0] plm:base:setup_vm only
</span><br>
...
<span class="quotelev2">&gt;&gt; I can try, but I have no way of testing Torque any more - so
</span><br>
...
<span class="quotelev2">&gt;&gt; On Nov 12, 2013, at 9:58 PM, tmishima_at_[hidden]
</span><br>
<span class="quotelev2">&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; openmpi-1.7.4a1r29646, which might be related to &quot;#3893:
</span><br>
...
<span class="quotelev2">&gt;&gt; mpirun -machinefile pbs_hosts -np ${NPROCS}
</span><br>
...
<span class="quotelev2">&gt;&gt; Since this happens without lama request, I guess it's not
</span><br>
<span class="quotelev2">&gt;&gt; the
</span><br>
<span class="quotelev2">&gt;&gt; problem
</span><br>
<span class="quotelev2">&gt;&gt; in lama itself. Anyway, please look into this issue as
</span><br>
...
<span class="quotelev2">&gt;&gt; [manage.cluster:23082] MCW rank 2 bound to socket 0[core
</span><br>
...
<span class="quotelev2">&gt;&gt; [manage.cluster:23082] MCW rank 3 bound to socket 1[core
</span><br>
...
<span class="quotelev2">&gt;&gt; [manage.cluster:23082] MCW rank 0 bound to socket 0[core
</span><br>
<span class="quotelev2">&gt;&gt; 0
</span><br>
<span class="quotelev2">&gt;&gt; [hwt
...
<span class="quotelev2">&gt;&gt; [manage.cluster:23082] MCW rank 1 bound to socket 0[core
</span><br>
<span class="quotelev2">&gt;&gt; 2
</span><br>
<span class="quotelev2">&gt;&gt; [hwt
...
<span class="quotelev2">&gt;&gt; core.23082
</span><br>
...
<span class="quotelev2">&gt;&gt; */&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 625      peer = mca_oob_tcp_peer_lookup(mod, &amp;hdr-&gt;
</span><br>
