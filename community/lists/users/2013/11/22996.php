...
?>
<!-- received="Fri Nov 15 00:57:14 2013" -->
<!-- isoreceived="20131115055714" -->
<!-- sent="Fri, 15 Nov 2013 14:57:40 +0900" -->
<!-- isosent="20131115055740" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in oob_tcp.c of	openmpi-1.7.4a1r29646" -->
<!-- id="OF3ADF5A22.822EB1AF-ON49257C24.001FCC90-49257C24.0020B44E_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2013-11-15 00:57:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="22997.php">Christoffer Hamberg: "[OMPI users] MPI Java bindings compile errors and missing datatype"</a>
<li><strong>Previous message:</strong> <a href="22995.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in oob_tcp.c of openmpi-1.7.4a1r29646"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23000.php">tmishima_at_[hidden]: "[OMPI users] openmpi-1.7.4a1r29646 with -hostfile option under Torque manager"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Further information.
<br>
<p>I first time encountered this problem in openmpi-1.7.4.x,
<br>
while opnempi-1.7.3 and 1.6.x works fine.
<br>
<p>My directory below is &quot;testbed-openmpi-1.7.3&quot;, but it's realy
<br>
1.7.4a1r29646. I'm sorry, if I confuse you.
<br>
<p>[mishima_at_manage testbed-openmpi-1.7.3]$ ompi_info | grep &quot;Open MPI:&quot;
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Open MPI: 1.7.4a1r29646
<br>
<p>It's obvious that the cause is in the difference between 1.7.3 and 1.7.4.x.
<br>
<p>tmishima
<br>
<p><p><span class="quotelev1">&gt; Indeed it should - most puzzling. I'll try playing with it on slurm using
</span><br>
sbatch and see if I get the same behavior. Offhand, I can't see why the
<br>
difference would exist unless somehow the script
<br>
<span class="quotelev1">&gt; itself is taking one of the execution slots, and somehow Torque is
</span><br>
accounting for it.
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Will have to explore and get back to you on a new email thread.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Nov 14, 2013, at 7:01 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; It's no problem that you let it lie until the problem becomes serious
</span><br>
<span class="quotelev2">&gt; &gt; again.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; So, this is just an information for you.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; I agree with your opinion that the problem will lie in the modified
</span><br>
<span class="quotelev2">&gt; &gt; hostfile.
</span><br>
<span class="quotelev2">&gt; &gt; But exactly speaking, it's related to just adding -hostfile option to
</span><br>
<span class="quotelev2">&gt; &gt; mpirun
</span><br>
<span class="quotelev2">&gt; &gt; in Torque script, I think.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; To make it clear and to prove I never modify hostfile given by Torque,
</span><br>
<span class="quotelev2">&gt; &gt; I change the script like this:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; [mishima_at_manage testbed-openmpi-1.7.3]$ cat myscript.sh
</span><br>
...
<span class="quotelev2">&gt; &gt; mpirun -machinefile $PBS_NODEFILE -report-bindings -bind-to core Myprog
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; Here, $PBS_NODEFILE is the variable prepared by Torque, which contains
</span><br>
<span class="quotelev2">&gt; &gt; allocated nodes.
</span><br>
<span class="quotelev2">&gt; &gt; Furthermore, I removed &quot;-np $NPROCS&quot; to use the number given by Torque.
</span><br>
<span class="quotelev2">&gt; &gt; Therefore, this means that I exactly use hostfile and nprocs given by
</span><br>
<span class="quotelev2">&gt; &gt; Torque.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; Then, you have to submit the job to produce the problem, because direct
</span><br>
run
<br>
<span class="quotelev2">&gt; &gt; could work.
</span><br>
<span class="quotelev2">&gt; &gt; The output of this job is below:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; [mishima_at_manage testbed-openmpi-1.7.3]$ qsub myscript.sh
</span><br>
<span class="quotelev2">&gt; &gt; 7999.manage.cluster
</span><br>
<span class="quotelev2">&gt; &gt; [mishima_at_manage testbed-openmpi-1.7.3]$ cat myscript.sh.o7999
</span><br>
...
<span class="quotelev2">&gt; &gt; As you can see, it still causes the oversbuscribed problem.
</span><br>
<span class="quotelev2">&gt; &gt; I know that -hostfile option is unnecessary in Torque script, but it
</span><br>
should
<br>
<span class="quotelev2">&gt; &gt; run even with this harmless option.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On Nov 14, 2013, at 3:25 PM, tmishima_at_[hidden] wrote:
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; I checked -cpus-per-proc in openmpi-1.7.4a1r29646.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; It works well as I want to do, which can adjust nprocs
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; of each nodes dividing by number of threads.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; I think my problem is solved so far using -cpus-per-proc,
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; thank you very mush.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Happy that works for you!
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Regarding oversbuscribed problem, I checked NPROCS was really 8
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; by outputing the number.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; SCRIPT:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; echo mpirun -machinefile pbs_hosts -np $NPROCS -report-bindings
</span><br>
<span class="quotelev2">&gt; &gt; -bind-to
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; core Myprog
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; mpirun -machinefile pbs_hosts -np $NPROCS -report-bindings -bind-to
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; mpirun -machinefile pbs_hosts -np 8 -report-bindings -bind-to core
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; By the way, how did you verify the problem.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; It looks like for me that you run the job directly from cmd line.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [rhc_at_bend001 svn-trunk]$ mpirun -n 3 --bind-to core --cpus-per-proc 4
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; --report-bindings -hostfile hosts hostname
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; In my environment, such a direct run without Torque script also works
</span><br>
<span class="quotelev2">&gt; &gt; fine.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Really? Your above cmd line is exactly the same as mine - a hardcoded
</span><br>
<span class="quotelev2">&gt; &gt; value for np, passing in a machinefile (or hostfile - same thing) while
</span><br>
in
<br>
<span class="quotelev2">&gt; &gt; a matching allocation. The only difference I can see
</span><br>
<span class="quotelev3">&gt; &gt;&gt; is that your hostfile may conflict with the detected allocation since
</span><br>
you
<br>
<span class="quotelev2">&gt; &gt; modified it. I suspect that is causing the confusion.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Anyway, as I already told you, my problem itself was solved. So I
</span><br>
think
<br>
<span class="quotelev2">&gt; &gt; the
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; priority to check is very low.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; I suspect there really isn't a bug here - the problem most likely lies
</span><br>
in
<br>
<span class="quotelev2">&gt; &gt; the modified hostfile working against the detected allocation. I'll let
</span><br>
it
<br>
<span class="quotelev2">&gt; &gt; lie for now and see if something reveals itself at
</span><br>
<span class="quotelev3">&gt; &gt;&gt; a later date.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; FWIW: I verified that this works fine under a slurm allocation of 2
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; nodes, each with 12 slots. I filled the node without getting an
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; &quot;oversbuscribed&quot; error message
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; [rhc_at_bend001 svn-trunk]$ mpirun -n 3 --bind-to core --cpus-per-proc
</span><br>
4
<br>
<span class="quotelev4">&gt; &gt;&gt;&gt; --report-bindings -hostfile hosts hostname
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; [bend001:24318] MCW rank 0 bound to socket 0[core 0[hwt 0-1]],
</span><br>
socket
<br>
<span class="quotelev2">&gt; &gt; 0
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0-1]]:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [BB/BB/BB/BB/../..][../../../../../..]
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; [bend001:24318] MCW rank 1 bound to socket 0[core 4[hwt 0-1]],
</span><br>
socket
<br>
<span class="quotelev2">&gt; &gt; 0
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [core 5[hwt 0-1]], socket 1[core 6[hwt 0-1]], socket 1[core 7[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0-1]]:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [../../../../BB/BB][BB/BB/../../../..]
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; [bend001:24318] MCW rank 2 bound to socket 1[core 8[hwt 0-1]],
</span><br>
socket
<br>
<span class="quotelev2">&gt; &gt; 1
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt
</span><br>
<span class="quotelev2">&gt; &gt; 0-1]]:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; [../../../../../..][../../BB/BB/BB/BB]
...
<span class="quotelev4">&gt; &gt;&gt;&gt; processes than I have slots - i.e., I give it the hosts file as
</span><br>
shown,
<br>
<span class="quotelev2">&gt; &gt; but
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; ask for 13 or more processes.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; BTW: note one important issue with cpus-per-proc, as shown above.
</span><br>
<span class="quotelev2">&gt; &gt; Because
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; I specified 4 cpus/proc, and my sockets each have 6 cpus, one of my
</span><br>
<span class="quotelev2">&gt; &gt; procs
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; wound up being split across the two sockets (2
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; cores on each). That's about the worst situation you can have.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; So a word of caution: it is up to the user to ensure that the
</span><br>
mapping
<br>
<span class="quotelev2">&gt; &gt; is
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; &quot;good&quot;. We just do what you asked us to do.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt; &gt;&gt;&gt; mapping options that should support such things. If you specify the
</span><br>
<span class="quotelev2">&gt; &gt; total
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; number of procs you want, and cpus-per-proc=4, it should
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; do the same thing I would think. You'd get 2 procs on the 8 slot
</span><br>
<span class="quotelev2">&gt; &gt; nodes, 8
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; on the 32 proc nodes, and up to 6 on the 64 slot nodes (since you
</span><br>
<span class="quotelev2">&gt; &gt; specified
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; np=16). So I guess I don't understand the issue.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Regardless, if NPROCS=8 (and you verified that by printing it out,
</span><br>
not
<br>
<span class="quotelev4">&gt; &gt;&gt;&gt; just assuming wc -l got that value), then it shouldn't think it is
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; oversubscribed. I'll take a look under a slurm allocation as
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Furthremore, in this case, for hybrid application with openmpi
</span><br>
+openmp,
<br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; mpirun -hostfile pbs_hosts -np 16 -cpus-per-proc 4 -x
</span><br>
OMP_NUM_THREADS
<br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; (The script I showed you first is just a simplified one to clarify
</span><br>
the
<br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; proper subset of the hosts allocated to the Torque / PBS Pro job
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; allocation?? That generally is a bad idea as it can confuse the
</span><br>
system
<br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; I wonder why node-&gt;slots and node-&gt;slots_inuse is 0, which I can
</span><br>
read
<br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; --with-tm \&gt;&gt; --with-verbs \
</span><br>
