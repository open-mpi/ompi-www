<?
$subject_val = "[OMPI users] Possible memory leak(s) in OpenMPI 1.6.3?";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Jan 21 08:53:34 2013" -->
<!-- isoreceived="20130121135334" -->
<!-- sent="Mon, 21 Jan 2013 13:53:25 +0000" -->
<!-- isosent="20130121135325" -->
<!-- name="Victor Vysotskiy" -->
<!-- email="victor.vysotskiy_at_[hidden]" -->
<!-- subject="[OMPI users] Possible memory leak(s) in OpenMPI 1.6.3?" -->
<!-- id="8D58A4B5E6148C419C6AD6334962375D2E738DC4_at_UWMBX01.uw.lu.se" -->
<!-- charset="iso-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Possible memory leak(s) in OpenMPI 1.6.3?<br>
<strong>From:</strong> Victor Vysotskiy (<em>victor.vysotskiy_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-01-21 08:53:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21173.php">Francesco Simula: "Re: [OMPI users] OMPI 1.6.3, InfiniBand and MTL MXM; unable to make it work!"</a>
<li><strong>Previous message:</strong> <a href="21171.php">George Bosilca: "Re: [OMPI users] Help: OpenMPI Compilation in Raspberry Pi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21181.php">Barrett, Brian W: "Re: [OMPI users] [EXTERNAL] Possible memory leak(s) in OpenMPI 1.6.3?"</a>
<li><strong>Reply:</strong> <a href="21181.php">Barrett, Brian W: "Re: [OMPI users] [EXTERNAL] Possible memory leak(s) in OpenMPI 1.6.3?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21172/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21172/massif.out.15028">massif.out.15028</a>
</ul>
<!-- attachment="massif.out.15028" -->
<hr>
<ul>
<li>text/x-csrc attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21172/mleak.win.c">mleak.win.c</a>
</ul>
<!-- attachment="mleak.win.c" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
