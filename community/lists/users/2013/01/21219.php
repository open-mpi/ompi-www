...
?>
<!-- received="Thu Jan 24 10:35:59 2013" -->
<!-- isoreceived="20130124153559" -->
<!-- sent="Thu, 24 Jan 2013 15:35:50 +0000" -->
<!-- isosent="20130124153550" -->
<!-- name="Number Cruncher" -->
<!-- email="number.cruncher_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_Alltoallv performance regression 1.6.0 to 1.6.1" -->
<!-- id="510154D6.5030807_at_ntlworld.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="[OMPI users] MPI_Alltoallv performance regression 1.6.0 to 1.6.1" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-24 10:35:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21220.php">Ralph Castain: "Re: [OMPI users] openmpi 1.6.3, job submitted through torque/PBS + Moab (scheduler) only land on one node even though multiple nodes/processors are specified"</a>
<li><strong>Previous message:</strong> <a href="21218.php">Brock Palen: "Re: [OMPI users] openmpi 1.6.3, job submitted through torque/PBS + Moab (scheduler) only land on one node even though multiple nodes/processors are specified"</a>
<li><strong>Maybe in reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2012/11/20722.php">Number Cruncher: "[OMPI users] MPI_Alltoallv performance regression 1.6.0 to 1.6.1"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br><hr>
<ul>
<li>text/x-patch attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21219/openmpi-pairwise-nop.patch">openmpi-pairwise-nop.patch</a>
</ul>
<!-- attachment="openmpi-pairwise-nop.patch" -->
<hr>
<ul>
<li>text/x-patch attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21219/openmpi-linear-alltoallv.patch">openmpi-linear-alltoallv.patch</a>
</ul>
