...
?>
<!-- received="Thu Jan 17 05:16:19 2013" -->
<!-- isoreceived="20130117101619" -->
<!-- sent="Thu, 17 Jan 2013 10:16:11 +0000" -->
<!-- isosent="20130117101611" -->
<!-- name="Victor Vysotskiy" -->
<!-- email="victor.vysotskiy_at_[hidden]" -->
<!-- subject="[OMPI users] Possible memory leak(s) in OpenMPI 1.6.3?" -->
<!-- id="8D58A4B5E6148C419C6AD6334962375D2E738A79_at_UWMBX01.uw.lu.se" -->
<!-- charset="iso-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-17 05:16:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21146.php">Jure Pečar: "Re: [OMPI users] help me understand these error msgs"</a>
<li><strong>Previous message:</strong> <a href="21144.php">borja mf: "Re: [OMPI users] Error running program : mca_oob_tcp_msg_send_handler: writev:failed: Bad file descriptor"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21145/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/x-csrc attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21145/mleak.win.c">mleak.win.c</a>
</ul>
<!-- attachment="mleak.win.c" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21145/massif.out.15028">massif.out.15028</a>
</ul>
