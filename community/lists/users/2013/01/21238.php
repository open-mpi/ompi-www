...
?>
<!-- received="Sun Jan 27 02:18:43 2013" -->
<!-- isoreceived="20130127071843" -->
<!-- sent="Sun, 27 Jan 2013 07:18:34 +0000" -->
<!-- isosent="20130127071834" -->
<!-- name="#YEO JINGJIE#" -->
<!-- email="JYEO1_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Error when attempting to run LAMMPS on Centos 6.2	with OpenMPI" -->
<!-- id="009017CD69F590478F7063E1C082325823BB6FB5_at_HKNPRD0111MB375.apcprd01.prod.exchangelabs.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="67E9E6CC-9B55-4DA5-BF35-28D1E10A9A2A_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-27 02:18:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21239.php">Bob Lin: "[OMPI users] very low performance over infiniband"</a>
<li><strong>Previous message:</strong> <a href="21237.php">Ralph Castain: "Re: [OMPI users] Error when attempting to run LAMMPS on Centos 6.2 with OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="21237.php">Ralph Castain: "Re: [OMPI users] Error when attempting to run LAMMPS on Centos 6.2 with OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21241.php">Ralph Castain: "Re: [OMPI users] Error when attempting to run LAMMPS on Centos 6.2	with OpenMPI"</a>
<li><strong>Reply:</strong> <a href="21241.php">Ralph Castain: "Re: [OMPI users] Error when attempting to run LAMMPS on Centos 6.2	with OpenMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>/usr/lib64/openmpi/bin/mpirun -mca mca_component_show_load_errors 1 -n 16 /opt/lammps-21Jan13/lmp_linux &lt; zigzag.in
<br>
<p>Is that correct?
<br>
<p>Regards,
...
Subject: Re: [OMPI users] Error when attempting to run LAMMPS on Centos 6.2     with OpenMPI
<br>
<p>One thing you might try: add &quot;-mca mca_component_show_load_errors 1&quot; to your mpirun cmd line. This will tell us if the libraries have some missing dependencies.
<br>
