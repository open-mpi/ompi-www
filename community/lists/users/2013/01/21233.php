...
?>
<!-- received="Fri Jan 25 22:08:07 2013" -->
<!-- isoreceived="20130126030807" -->
<!-- sent="Sat, 26 Jan 2013 03:07:33 +0000" -->
<!-- isosent="20130126030733" -->
<!-- name="#YEO JINGJIE#" -->
<!-- email="JYEO1_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Error when attempting to run LAMMPS on	Centos	6.2	with OpenMPI" -->
<!-- id="009017CD69F590478F7063E1C082325823BB6F4A_at_HKNPRD0111MB375.apcprd01.prod.exchangelabs.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="AAB3DD08-B30D-4316-BB63-13DE6DD6481B_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-25 22:07:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21234.php">Ralph Castain: "Re: [OMPI users] Error when attempting to run LAMMPS on	Centos	6.2	with OpenMPI"</a>
<li><strong>Previous message:</strong> <a href="21232.php">Ralph Castain: "Re: [OMPI users] Error when attempting to run LAMMPS on Centos	6.2	with OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="21232.php">Ralph Castain: "Re: [OMPI users] Error when attempting to run LAMMPS on Centos	6.2	with OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21234.php">Ralph Castain: "Re: [OMPI users] Error when attempting to run LAMMPS on	Centos	6.2	with OpenMPI"</a>
<li><strong>Reply:</strong> <a href="21234.php">Ralph Castain: "Re: [OMPI users] Error when attempting to run LAMMPS on	Centos	6.2	with OpenMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><p>export PATH=/usr/local/openmpi/bin:$PATH
<br>
...
<br>
<p><p><p>But I still get the same error.
<br>
<p><p><p>Regards,
<br>
Jingjie Yeo
...
Subject: Re: [OMPI users] Error when attempting to run LAMMPS on Centos 6.2 with OpenMPI
<br>
<p>Okay - that's why I don't like package installs...
<br>
...
<br>
<p><p>On Jan 25, 2013, at 6:22 PM, #YEO JINGJIE# &lt;JYEO1_at_[hidden]&lt;mailto:JYEO1_at_[hidden]&gt;&gt; wrote:
<br>
<p>Ok this was what I got:
<br>
<p><p><p>which srun
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21233/attachment">attachment</a>
</ul>
