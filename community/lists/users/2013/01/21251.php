...
?>
<!-- received="Mon Jan 28 14:04:56 2013" -->
<!-- isoreceived="20130128190456" -->
<!-- sent="Mon, 28 Jan 2013 11:04:48 -0800" -->
<!-- isosent="20130128190448" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Checkpointing an MPI application with OMPI" -->
<!-- id="CF88B1A6-23B7-42E9-A489-8E6D93EFB5CE_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2013-01-28 14:04:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21252.php">John Hearns: "Re: [OMPI users] very low performance over infiniband"</a>
<li><strong>Previous message:</strong> <a href="21250.php">Maxime Boissonneault: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21253.php">George Bosilca: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<li><strong>Reply:</strong> <a href="21253.php">George Bosilca: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; Le 2013-01-28 13:15, Ralph Castain a &#233;crit :
</span><br>
<span class="quotelev2">&gt;&gt; On Jan 28, 2013, at 9:52 AM, Maxime Boissonneault &lt;maxime.boissonneault_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Le 2013-01-28 12:46, Ralph Castain a &#233;crit :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jan 28, 2013, at 8:25 AM, Maxime Boissonneault &lt;maxime.boissonneault_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Hmmm...well, most apps can be adjusted to support it - we have some very complex apps that were updated that way. Commercial apps are another story, but we frankly don't find much call for checkpointing those as they typically just don't run long enough - especially if you are only running 256 ranks, so your cluster is small. Failure rates just don't justify it in such cases, in our experience.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Is there some particular reason why you feel you need checkpointing?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; This specific case is that the jobs run for days. The risk of a hardware or power failure for that kind of duration goes too high (we allow for no more than 48 hours of run time).
</span><br>
<span class="quotelev2">&gt;&gt; I'm surprised by that - we run with UPS support on the clusters, but for a small one like you describe, we find the probability that a job will be interrupted even during a multi-week app is vanishingly small.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; FWIW: I do work with the financial industry where we regularly run apps that execute non-stop for about a month with no reported failures. Are you actually seeing failures, or are you anticipating them?
</span><br>
<span class="quotelev1">&gt; While our filesystem and management nodes are on UPS, our compute nodes are not. With one average generic (power/cooling mostly) failure every one or two months, running for weeks is just asking for trouble.
</span><br>
<p>Wow, that is high
<br>
<p><span class="quotelev1">&gt; If you add to that typical dimm/cpu/networking failures (I estimated about 1 node goes down per day because of some sort hardware failure, for a cluster of 960 nodes).
</span><br>
<p>That is incredibly high
<br>
<p><span class="quotelev1">&gt; With these numbers, a job running on 32 nodes for 7 days has a ~35% chance of failing before it is done.
</span><br>
<p>I've never seen anything like that behavior in practice - a 32 node cluster typically runs for quite a few months without a failure. It is a typical size for the financial sector, so we have a LOT of experience with such clusters.
<br>
<p>I suspect you won't see anything like that behavior...
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Having 24GB of ram per node, even if a 32 nodes job takes close to 100% of the ram, that's merely 640 GB of data. Writing that on a lustre filesystem capable of reaching ~15GB/s should take no more than a few minutes if written correctly. Right now, I am getting a few minutes for a hundredth of this amount of data!
</span><br>
<p><p>Agreed - but I don't think you'll get that bandwidth for checkpointing. I suspect you'll find that checkpointing really has troubles when scaling, which is why you don't see it used in production (at least, I haven't). Mostly used for research by a handful of organizations, which is why we haven't been too concerned about its loss.
<br>
<p><p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; While it is true we can dig through the code of the library to make it checkpoint, BLCR checkpointing just seemed easier.
</span><br>
<span class="quotelev2">&gt;&gt; I see - just be aware that checkpoint support in OMPI will disappear in v1.7 and there is no clear timetable for restoring it.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I don't know - that's all done in BLCR, I believe. Either way, it isn't something we can address due to the loss of our supporter for c/r.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I suppose I should contact BLCR instead then.
</span><br>
<span class="quotelev2">&gt;&gt; For the disk op problem, I think that's the way to go - though like I said, I could be wrong and the disk writes could be something we do inside OMPI. I'm not familiar enough with the c/r code to state it with certainty.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Sorry we can't be of more help :-(
</span><br>
