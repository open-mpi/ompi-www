<?
$subject_val = "[OMPI users] help - Problem with mpirun for java codes";
include("../../include/msg-header.inc");
?>
<!-- received="Wed Jan 16 14:48:51 2013" -->
<!-- isoreceived="20130116194851" -->
<!-- sent="Wed, 16 Jan 2013 19:48:46 +0000" -->
<!-- isosent="20130116194846" -->
<!-- name="Karos Lotfifar" -->
<!-- email="foadfbf_at_[hidden]" -->
<!-- subject="[OMPI users] help - Problem with mpirun for java codes" -->
<!-- id="CAGr61r+acyJ-zDRQgKK1r4f_qUkjenKLQ=U+Nu5Qd-V3-LC0Lg_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] help - Problem with mpirun for java codes<br>
<strong>From:</strong> Karos Lotfifar (<em>foadfbf_at_[hidden]</em>)<br>
<strong>Date:</strong> 2013-01-16 14:48:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21141.php">Ralph Castain: "Re: [OMPI users] Problem with mpirun for java codes"</a>
<li><strong>Previous message:</strong> <a href="21139.php">Karos Lotfifar: "[OMPI users] Problem with mpirun for java codes"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21140/attachment">attachment</a>
</ul>
