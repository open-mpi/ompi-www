...
?>
<!-- received="Mon Jan 28 13:53:38 2013" -->
<!-- isoreceived="20130128185338" -->
<!-- sent="Mon, 28 Jan 2013 13:53:34 -0500" -->
<!-- isosent="20130128185334" -->
...
<!-- id="5106C92E.2050909_at_calculquebec.ca" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="29AB11DC-209D-4375-B768-77E5645AA2BE_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-28 13:53:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21251.php">Ralph Castain: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<li><strong>Previous message:</strong> <a href="21249.php">Shamis, Pavel: "Re: [OMPI users] very low performance over infiniband"</a>
<li><strong>In reply to:</strong> <a href="21248.php">Ralph Castain: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21251.php">Ralph Castain: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<li><strong>Reply:</strong> <a href="21251.php">Ralph Castain: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<li><strong>Reply:</strong> <a href="21264.php">Ralph Castain: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; On Jan 28, 2013, at 9:52 AM, Maxime Boissonneault &lt;maxime.boissonneault_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Le 2013-01-28 12:46, Ralph Castain a &#233;crit :
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Jan 28, 2013, at 8:25 AM, Maxime Boissonneault &lt;maxime.boissonneault_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hello Ralph,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I agree that ideally, someone would implement checkpointing in the application itself, but that is not always possible (commercial applications, use of complicated libraries, algorithms with no clear progression points at which you can interrupt the algorithm and start it back from there).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hmmm...well, most apps can be adjusted to support it - we have some very complex apps that were updated that way. Commercial apps are another story, but we frankly don't find much call for checkpointing those as they typically just don't run long enough - especially if you are only running 256 ranks, so your cluster is small. Failure rates just don't justify it in such cases, in our experience.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Is there some particular reason why you feel you need checkpointing?
</span><br>
<span class="quotelev2">&gt;&gt; This specific case is that the jobs run for days. The risk of a hardware or power failure for that kind of duration goes too high (we allow for no more than 48 hours of run time).
</span><br>
<span class="quotelev1">&gt; I'm surprised by that - we run with UPS support on the clusters, but for a small one like you describe, we find the probability that a job will be interrupted even during a multi-week app is vanishingly small.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; FWIW: I do work with the financial industry where we regularly run apps that execute non-stop for about a month with no reported failures. Are you actually seeing failures, or are you anticipating them?
</span><br>
...
<br>
<p>Having 24GB of ram per node, even if a 32 nodes job takes close to 100% 
<br>
...
<br>
<p><span class="quotelev2">&gt;&gt; While it is true we can dig through the code of the library to make it checkpoint, BLCR checkpointing just seemed easier.
</span><br>
<span class="quotelev1">&gt; I see - just be aware that checkpoint support in OMPI will disappear in v1.7 and there is no clear timetable for restoring it.
</span><br>
That is very good to know. Thanks for the information. It is too bad though.
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; There certainly must be a better way to write the information down on disc though. Doing 500 IOPs seems to be completely broken. Why isn't there buffering involved ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I don't know - that's all done in BLCR, I believe. Either way, it isn't something we can address due to the loss of our supporter for c/r.
</span><br>
<span class="quotelev2">&gt;&gt; I suppose I should contact BLCR instead then.
</span><br>
<span class="quotelev1">&gt; For the disk op problem, I think that's the way to go - though like I said, I could be wrong and the disk writes could be something we do inside OMPI. I'm not familiar enough with the c/r code to state it with certainty.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Sorry we can't be of more help :-(
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Le 2013-01-28 10:58, Ralph Castain a &#233;crit :
</span><br>
