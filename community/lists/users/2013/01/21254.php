...
?>
<!-- received="Mon Jan 28 15:46:48 2013" -->
<!-- isoreceived="20130128204648" -->
<!-- sent="Mon, 28 Jan 2013 15:46:42 -0500" -->
<!-- isosent="20130128204642" -->
...
<!-- id="5106E3B2.7060004_at_calculquebec.ca" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAMJJpkWEPKTBnnY4hMbeCnhbJ5uEjYUyJyk-FX4LD54CqrkvYQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2013-01-28 15:46:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="21255.php">George Bosilca: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<li><strong>Previous message:</strong> <a href="21253.php">George Bosilca: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<li><strong>In reply to:</strong> <a href="21253.php">George Bosilca: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="21255.php">George Bosilca: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<li><strong>Reply:</strong> <a href="21255.php">George Bosilca: "Re: [OMPI users] Checkpointing an MPI application with OMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>(Reference being : X. Ouyang, R. Rajachandrasekhar, X. Besseron, H. 
<br>
...
<br>
&lt;<a href="http://nowlab.cse.ohio-state.edu/publications/conf-papers/2011/ouyangx-icpp2011.pdf">http://nowlab.cse.ohio-state.edu/publications/conf-papers/2011/ouyangx-icpp2011.pdf</a>&gt;))
<br>
<p>We did run parallel IO benchmarks. Our filesystem can reach a speed of 
<br>
...
<br>
<p>Not sure there is anything to be done about it.
<br>
<p>Best regards,
<br>
<p><p>Maxime
<br>
<p>Le 2013-01-28 15:40, George Bosilca a &#233;crit :
<br>
...
<span class="quotelev2">&gt;&gt; On Jan 28, 2013, at 10:53 AM, Maxime Boissonneault &lt;maxime.boissonneault_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Le 2013-01-28 13:15, Ralph Castain a &#233;crit :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jan 28, 2013, at 9:52 AM, Maxime Boissonneault &lt;maxime.boissonneault_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm surprised by that - we run with UPS support on the clusters, but for a small one like you describe, we find the probability that a job will be interrupted even during a multi-week app is vanishingly small.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; FWIW: I do work with the financial industry where we regularly run apps that execute non-stop for about a month with no reported failures. Are you actually seeing failures, or are you anticipating them?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; While our filesystem and management nodes are on UPS, our compute nodes are not. With one average generic (power/cooling mostly) failure every one or two months, running for weeks is just asking for trouble.
</span><br>
<span class="quotelev2">&gt;&gt; Wow, that is high
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If you add to that typical dimm/cpu/networking failures (I estimated about 1 node goes down per day because of some sort hardware failure, for a cluster of 960 nodes).
</span><br>
<span class="quotelev2">&gt;&gt; That is incredibly high
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; With these numbers, a job running on 32 nodes for 7 days has a ~35% chance of failing before it is done.
</span><br>
<span class="quotelev2">&gt;&gt; I've never seen anything like that behavior in practice - a 32 node cluster typically runs for quite a few months without a failure. It is a typical size for the financial sector, so we have a LOT of experience with such clusters.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I suspect you won't see anything like that behavior...
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Having 24GB of ram per node, even if a 32 nodes job takes close to 100% of the ram, that's merely 640 GB of data. Writing that on a lustre filesystem capable of reaching ~15GB/s should take no more than a few minutes if written correctly. Right now, I am getting a few minutes for a hundredth of this amount of data!
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Agreed - but I don't think you'll get that bandwidth for checkpointing. I suspect you'll find that checkpointing really has troubles when scaling, which is why you don't see it used in production (at least, I haven't). Mostly used for research by a handful of organizations, which is why we haven't been too concerned about its loss.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; While it is true we can dig through the code of the library to make it checkpoint, BLCR checkpointing just seemed easier.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I see - just be aware that checkpoint support in OMPI will disappear in v1.7 and there is no clear timetable for restoring it.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; That is very good to know. Thanks for the information. It is too bad though.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; For the disk op problem, I think that's the way to go - though like I said, I could be wrong and the disk writes could be something we do inside OMPI. I'm not familiar enough with the c/r code to state it with certainty.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-21254/attachment">attachment</a>
</ul>
