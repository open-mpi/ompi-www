...
?>
<!-- received="Wed Dec 17 17:17:48 2014" -->
<!-- isoreceived="20141217221748" -->
<!-- sent="Wed, 17 Dec 2014 17:17:47 -0500" -->
<!-- isosent="20141217221747" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)" -->
<!-- id="CAMJJpkVDztGUb-41xob0kMsZcYmXu0EDpcJEjRsNAM4_N01MOw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAGs3GVag7baLNCgDpOWu32L-B=dvyaRjh-hnkOdNp17pMsvbmA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-17 17:17:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26015.php">Jeff Squyres (jsquyres): "Re: [OMPI users] ERROR: C_FUNLOC function"</a>
<li><strong>Previous message:</strong> <a href="26013.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>In reply to:</strong> <a href="26013.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26016.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>Reply:</strong> <a href="26016.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Thus a potentially non-portable solution would be to instead of launching
<br>
...
<p>&nbsp;&nbsp;George.
<br>
<p><p>On Wed, Dec 17, 2014 at 5:02 PM, Alex A. Schmidt &lt;aas_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev2">&gt;&gt; Have you tried putting the &quot;&lt;&quot; as a separate parameter? In other words,
</span><br>
<span class="quotelev2">&gt;&gt; since you are specifying the argv, you have to specify each of them
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I have a &quot;child&quot; mpi code that do just 2 things: read the 3 parameters
</span><br>
<span class="quotelev3">&gt;&gt;&gt; passed to it and print them, and then read data from stdin and show it.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On the other hand , calling &quot;child&quot; from MPI_Comm_spawn(&quot;child&quot;,args,...)
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; to execute 'mpirun -n 2 siesta &lt; infile' on the spawnee side. That was
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; my first choice. Well, siesta behaves as if no stdin file was present...
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; You should be able to just include that in your argv that you pass to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the Comm_spawn API.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Thanks for the tip. In fact, calling mpi_comm_spawn right away with
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; However, siesta is launched only by specifying input/output files
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; with i/o redirection like
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; So far, I could not find anything about how to set an stdin file for
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; an spawnee process.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Specifiyng it in a app context file doesn't seem to work. Can it be
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; done? Maybe through
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I would change the way you create the subcoms in the parent. You do
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; a lot of useless operations, as you can achieve exactly the same outcome
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Are you calling MPI_Comm_disconnect in the 3 &quot;master&quot; tasks and
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; with the same remote communicator ?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Well, calling the disconnect on the intercomm handler does halt
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the spwaner
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; to the beginning of the problem since, being a third party app,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that call would
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; never be there. I guess an mpi wrapper to deal with that could be
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; made for
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the app, but I fell the wrapper itself, at the end, would face
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the same problem
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; potential is available the calculation can be made internally and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the workload
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; be done externally by a quantum chemistry code like dftb+, siesta
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; and Gaussian.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; So far, we have been running these codes in serial mode. No need
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; to say that
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; we could do a lot better if they could be executed in parallel.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am not familiar with DMRAA but it seems to be the right choice
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; to deal with
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Or you can retrieve the jobid and qstat periodically to get the
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; job state.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; If you are using third party apps, why dont you do something
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; like
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; system(&quot;env -i qsub ...&quot;)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; with the right options to make qsub blocking or you manually
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; wait for the end of the job ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Ok, I believe I have a simple toy app running as I think it
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; when the spawned processes have finnished running? All I have
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; which greatly benefits from a parallel environment. My code is
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26014/attachment">attachment</a>
</ul>
