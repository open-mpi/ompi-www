...
?>
<!-- received="Thu Dec 11 23:42:50 2014" -->
<!-- isoreceived="20141212044250" -->
<!-- sent="Fri, 12 Dec 2014 02:42:48 -0200" -->
<!-- isosent="20141212044248" -->
<!-- name="Alex A. Schmidt" -->
<!-- email="aas_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI inside MPI (still)" -->
<!-- id="CAGs3GVZtRuEboL2nyj8TmnP_bUxYMZLO5RY7-x7YiE_at99nqw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="548A6F7B.7090607_at_iferc.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-11 23:42:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25973.php">Alex A. Schmidt: "Re: [OMPI users] MPI inside MPI (still)"</a>
<li><strong>Previous message:</strong> <a href="25971.php">Gilles Gouaillardet: "Re: [OMPI users] MPI inside MPI (still)"</a>
<li><strong>In reply to:</strong> <a href="25971.php">Gilles Gouaillardet: "Re: [OMPI users] MPI inside MPI (still)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25973.php">Alex A. Schmidt: "Re: [OMPI users] MPI inside MPI (still)"</a>
<li><strong>Reply:</strong> <a href="25973.php">Alex A. Schmidt: "Re: [OMPI users] MPI inside MPI (still)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Well, yes, I guess....
<br>
<p>I'll do tests with the real third party apps and let you know.
<br>
...
<p>Alex
<br>
<p><p>2014-12-12 2:30 GMT-02:00 Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25972/attachment">attachment</a>
</ul>
