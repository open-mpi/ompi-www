...
?>
<!-- received="Mon Dec 15 12:27:50 2014" -->
<!-- isoreceived="20141215172750" -->
<!-- sent="Mon, 15 Dec 2014 15:27:48 -0200" -->
<!-- isosent="20141215172748" -->
<!-- name="Alex A. Schmidt" -->
<!-- email="aas_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)" -->
<!-- id="CAGs3GVaiu_PCeXaAhRe2m3ofr4yEJubQMeYGwnPwmqGu9GWDxQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAMJJpkVWzBv5R1H3BqUJsiEpP+g021ALQFARKiuv9t2jNkS=jA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-15 12:27:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26003.php">Ralph Castain: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>Previous message:</strong> <a href="26001.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.8.4 and hwloc in Fedora 14 using a beta gcc 5.0 compiler."</a>
<li><strong>In reply to:</strong> <a href="25991.php">George Bosilca: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26003.php">Ralph Castain: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>Reply:</strong> <a href="26003.php">Ralph Castain: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
George,
<br>
<p>Thanks for the tip. In fact, calling mpi_comm_spawn right away with MPI
<br>
_COMM_SELF
<br>
has worked for me just as well -- no subgroups needed at all.
<br>
<p>I am testing this openmpi app named &quot;siesta&quot; in parallel. The source code
<br>
is available,
<br>
...
mpi_comm_disconnect
<br>
<p>into the main code can be done.  If it works, maybe the siesta's developers
<br>
can be convinced
<br>
to add this feature in a future release.
<br>
<p>However, siesta is launched only by specifying input/output files with i/o
<br>
redirection like
<br>
<p>mpirun -n &lt;*some number*&gt;  siesta &lt; infile &gt; outfile
<br>
<p>So far, I could not find anything about how to set an stdin file for an
<br>
spawnee process.
<br>
...
<p>Alex
<br>
<p><p><p><p><p>2014-12-15 2:43 GMT-02:00 George Bosilca &lt;bosilca_at_[hidden]&gt;:
<br>
...
<span class="quotelev1">&gt; I would change the way you create the subcoms in the parent. You do a lot
</span><br>
<span class="quotelev1">&gt; of useless operations, as you can achieve exactly the same outcome (one
</span><br>
...
<span class="quotelev2">&gt;&gt; on the spawnee side I get the proper response in the spawning processes.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Please, take a look at the attached toy codes parent.F and child.F
</span><br>
<span class="quotelev2">&gt;&gt; I've been playing with. 'mpirun -n 2 parent' seems to work as expected.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Are you calling MPI_Comm_disconnect in the 3 &quot;master&quot; tasks and with the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; same remote communicator ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I also read the man page again, and MPI_Comm_disconnect does not ensure
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the remote processes have finished or called MPI_Comm_disconnect, so that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; might not be the thing you need.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; MPI_Comm_disconnect should be a local operation, there is no reason for
</span><br>
<span class="quotelev3">&gt;&gt;&gt; it to deadlock. I looked at the code and everything is local with the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Sat, Dec 13, 2014 at 8:47 AM, Alex A. Schmidt &lt;aas_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Sorry, I was calling mpi_comm_disconnect on the group comm handler, not
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; on the intercomm handler returned from the spawn call as it should be.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; side but the wait is never completed since, as George points out, there
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is no
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; disconnect call being made on the spawnee side.... and that brings me
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; back
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; to the beginning of the problem since, being a third party app, that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; call would
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; never be there. I guess an mpi wrapper to deal with that could be made
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; for
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the app, but I fell the wrapper itself, at the end, would face the same
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; potential is available the calculation can be made internally and the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; workload
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is distributed among slaves nodes from a master node. This is also done
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; when an analytical potential is not available and the energy
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; calculation must
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; be done externally by a quantum chemistry code like dftb+, siesta and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Gaussian.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So far, we have been running these codes in serial mode. No need to say
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; job schedulers as it covers the ones I am interested in (pbs/torque and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; loadlever).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Or you can retrieve the jobid and qstat periodically to get the job
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; with the right options to make qsub blocking or you manually wait for
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the end of the job ?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26002/attachment">attachment</a>
</ul>
