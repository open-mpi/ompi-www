...
?>
<!-- received="Thu Dec 18 11:27:27 2014" -->
<!-- isoreceived="20141218162727" -->
<!-- sent="Thu, 18 Dec 2014 17:27:13 +0100" -->
<!-- isosent="20141218162713" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)" -->
<!-- id="E8569A31-63AA-4739-B19E-D10652C53BAE_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-12-18 11:27:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26037.php">Jeff Squyres (jsquyres): "Re: [OMPI users] [EXTERNAL] Re: How to find MPI ranks located in remote nodes?"</a>
<li><strong>Previous message:</strong> <a href="26035.php">J&#246;rg Stiller: "Re: [OMPI users] Operators for MPI handles not correctly	overloaded	with Intel Fortran"</a>
...
<!-- body="start" -->
<p>
Am 18.12.2014 um 04:24 schrieb Alex A. Schmidt &lt;aas_at_[hidden]&gt;:
<br>
...
<p>You could also redirect the stdin before the `system()` call in your application by dup2(). But I'm somewhat lost in the complete setup: you have a batch scheduler, your MPI application and third party apps (using MPI, Linda, OpenMP,...) with both of the latter working in parallel (how to forward granted machines/cores to siesta in case it should spread further to other machines?).
<br>
<p>What will call what? Do you submit your application or the third party apps as mentioned earlier? Will the batch scheduler honor any redirection which you discussed recently, and/or you can you tell the batch scheduler to use a different stdin/-out/-err in DRMAA by setting drmaa_input_path/drmaa_output_path/drmaa_error_path for example?
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; mpi_comm_spawn(&quot;/bin/sh&quot;,&quot;-c&quot;,&quot;siesta &lt; infile&quot;,..) definitely  does not work.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Patching siesta to start as &quot;siesta -in infile&quot; sounds very promissing.
</span><br>
<span class="quotelev1">&gt; That option as well as a &quot;-o outfile&quot; option should be there to start with. 
</span><br>
<span class="quotelev1">&gt; I can bring that to the attention of the siesta developers. But then we have
</span><br>
<span class="quotelev1">&gt; this other app &quot;dftb+&quot;, and this other one &quot;Gaussian&quot; (just to mention a few).
</span><br>
...
<span class="quotelev1">&gt; 2014-12-17 22:35 GMT-02:00 Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt;:
</span><br>
<span class="quotelev1">&gt; Alex,
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; I think what you need is spawn a shell that do the redirection and then invoke your app.
</span><br>
...
<span class="quotelev1">&gt; That being said, i strongly recommend you patch siesta so it can be invoked like this
</span><br>
...
<span class="quotelev1">&gt; Putting &quot;/bin/sh&quot; in command with info key &quot;ompi_non_mpi&quot;  set to  &quot;.true.&quot; 
</span><br>
...
<span class="quotelev1">&gt; Putting a single string in args as &quot;-c mpirun -n 1 myapp&quot; or  &quot;-c 'mpirun -n 1 myapp' &quot;
</span><br>
...
<span class="quotelev1">&gt; Thus a potentially non-portable solution would be to instead of launching the mpirun directly to launch it through a shell. Maybe something like &quot;/bin/sh&quot;, &quot;-c&quot;, &quot;mpirun -n 1 myapp&quot;. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; into the main code can be done.  If it works, maybe the siesta's developers can be convinced 
</span><br>
...
<span class="quotelev2">&gt;&gt; 2014-12-12 22:35 GMT-02:00 Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt;:
</span><br>
<span class="quotelev2">&gt;&gt; Alex,
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; with the right options to make qsub blocking or you manually wait for the end of the job ?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; together nicely, returning the expected result for an mpi_allreduce call).
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; 2014-12-12 2:30 GMT-02:00 Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt;:
</span><br>
<span class="quotelev2">&gt;&gt; Alex,
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; 2014-12-12 1:32 GMT-02:00 Gilles Gouaillardet &lt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 2014-12-12 0:36 GMT-02:00 Gilles Gouaillardet &lt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/12/25966.php">http://www.open-mpi.org/community/lists/users/2014/12/25966.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/12/25967.php">http://www.open-mpi.org/community/lists/users/2014/12/25967.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/12/25968.php">http://www.open-mpi.org/community/lists/users/2014/12/25968.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/12/25969.php">http://www.open-mpi.org/community/lists/users/2014/12/25969.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/12/25970.php">http://www.open-mpi.org/community/lists/users/2014/12/25970.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/12/25971.php">http://www.open-mpi.org/community/lists/users/2014/12/25971.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/12/25974.php">http://www.open-mpi.org/community/lists/users/2014/12/25974.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
</span><br>
<span class="quotelev2">&gt;&gt; users mailing list
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/12/25975.php">http://www.open-mpi.org/community/lists/users/2014/12/25975.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/12/26021.php">http://www.open-mpi.org/community/lists/users/2014/12/26021.php</a>
</span><br>
<span class="quotelev1">&gt; _______________________________________________
</span><br>
<span class="quotelev1">&gt; users mailing list
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/12/26026.php">http://www.open-mpi.org/community/lists/users/2014/12/26026.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
