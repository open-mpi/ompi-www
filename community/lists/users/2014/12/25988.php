...
?>
<!-- received="Sun Dec 14 22:25:04 2014" -->
<!-- isoreceived="20141215032504" -->
<!-- sent="Sun, 14 Dec 2014 22:25:02 -0500" -->
<!-- isosent="20141215032502" -->
...
<!-- id="548E548E.3020606_at_giref.ulaval.ca" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="548E4DB5.7090709_at_iferc.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-14 22:25:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25989.php">Gilles Gouaillardet: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<li><strong>Previous message:</strong> <a href="25987.php">Gilles Gouaillardet: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<li><strong>In reply to:</strong> <a href="25987.php">Gilles Gouaillardet: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25989.php">Gilles Gouaillardet: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; i checked the source code (v1.8) and the limit for the shared_fp_fname
</span><br>
<span class="quotelev1">&gt; is 256 (hard coded).
</span><br>
...
<p>258 characters !!!!
<br>
<p>If this is it, I hope it can be fixed in some manner... at least an 
<br>
error message!...
<br>
<p>Thanks,
...
<span class="quotelev1">&gt; i am now checking if the overflow is correctly detected (that could
</span><br>
<span class="quotelev1">&gt; explain the one byte overflow reported by valgrind)
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/12/25987.php">http://www.open-mpi.org/community/lists/users/2014/12/25987.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
