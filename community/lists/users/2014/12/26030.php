...
?>
<!-- received="Thu Dec 18 08:05:29 2014" -->
<!-- isoreceived="20141218130529" -->
<!-- sent="Thu, 18 Dec 2014 15:05:26 +0200" -->
<!-- isosent="20141218130526" -->
<!-- name="Mike Dubman" -->
<!-- email="miked_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ERROR: C_FUNLOC function" -->
<!-- id="CAAO1KyapqYO8Ht7SDkYOh42vxxnhLVMQm-0-Q4aOaGXkHi_smQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="A8297688-AA0A-4CAC-8815-D255D44E80DE_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-18 08:05:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26031.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] ERROR: C_FUNLOC function"</a>
<li><strong>Previous message:</strong> <a href="26029.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Deadlock in OpenMPI 1.8.3 and PETSc 3.4.5"</a>
<li><strong>In reply to:</strong> <a href="26015.php">Jeff Squyres (jsquyres): "Re: [OMPI users] ERROR: C_FUNLOC function"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26032.php">Siegmar Gross: "Re: [OMPI users] ERROR: C_FUNLOC function"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>get_mounts: dirs[16]:/misc fs:autofs nfs:No
<br>
get_mounts: dirs[17]:/net fs:autofs nfs:No
<br>
get_mounts: dirs[18]:/home fs:autofs nfs:No
<br>
<p>could you please check if mntent.h and paths.h were detected by &quot;configure&quot;
<br>
in config.log?
<br>
<p>Thanks
<br>
<p><p>On Thu, Dec 18, 2014 at 12:39 AM, Jeff Squyres (jsquyres) &lt;
<br>
...
<span class="quotelev1">&gt; I filed <a href="https://github.com/open-mpi/ompi/issues/317">https://github.com/open-mpi/ompi/issues/317</a> and
</span><br>
<span class="quotelev1">&gt; <a href="https://github.com/open-mpi/ompi/issues/318">https://github.com/open-mpi/ompi/issues/318</a>.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; On Dec 17, 2014, at 3:33 PM, Siegmar Gross &lt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; This fix was just pushed to the OMPI master.  A new master tarball
</span><br>
...
<span class="quotelev2">&gt; &gt; On Linux interprets output from mount(8) to check for nfs and verify
</span><br>
<span class="quotelev1">&gt; opal_path_nfs()
</span><br>
<span class="quotelev2">&gt; &gt; Additionally, you may specify multiple DIR on the cmd-line, of which you
</span><br>
...
<span class="quotelev1">&gt; `/export2/src/openmpi-1.9/openmpi-dev-557-g01a24c4-Linux.x86_64.64_cc/test'
</span><br>
...
<span class="quotelev2">&gt; &gt; tyr openmpi-dev-557-g01a24c4-Linux.x86_64.64_cc 134 libSDtMail: Warning:
</span><br>
<span class="quotelev1">&gt; Xt Warning: Missing charsets in
</span><br>
...
<span class="quotelev2">&gt; &gt;  CC       opal_lifo.o
</span><br>
<span class="quotelev2">&gt; &gt;  CCLD     opal_lifo
</span><br>
<span class="quotelev2">&gt; &gt;  CC       opal_fifo.o
</span><br>
<span class="quotelev2">&gt; &gt;  CCLD     opal_fifo
</span><br>
<span class="quotelev2">&gt; &gt; make[3]: Leaving directory
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev2">&gt; &gt; /bin/sh: line 5:  5746 Illegal instruction     ${dir}$tst
</span><br>
<span class="quotelev2">&gt; &gt; FAIL: opal_lifo
</span><br>
<span class="quotelev2">&gt; &gt; /bin/sh: line 5:  5776 Illegal instruction     ${dir}$tst
</span><br>
...
<span class="quotelev1">&gt; `/export2/src/openmpi-1.9/openmpi-dev-557-g01a24c4-Linux.x86_64.64_gcc/test'
</span><br>
<span class="quotelev2">&gt; &gt; make: *** [check-recursive] Error 1
</span><br>
...
<span class="quotelev2">&gt; &gt; &quot;../../../openmpi-dev-557-g01a24c4/test/class/opal_lifo.c&quot;, line 45:
</span><br>
<span class="quotelev1">&gt; warning: implicit function
</span><br>
...
<span class="quotelev2">&gt; &gt; timersub                            opal_lifo.o
</span><br>
<span class="quotelev2">&gt; &gt; ld: fatal: symbol referencing errors. No output written to
</span><br>
<span class="quotelev1">&gt; .libs/opal_lifo
</span><br>
...
<span class="quotelev1">&gt; `/export2/src/openmpi-1.9/openmpi-dev-557-g01a24c4-SunOS.sparc.64_cc/test'
</span><br>
<span class="quotelev2">&gt; &gt; make: *** [check-recursive] Error 1
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On Dec 15, 2014, at 1:22 AM, Siegmar Gross &lt;
</span><br>
<span class="quotelev1">&gt; Siegmar.Gross_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; f08 binding support is disabled if TS29113 subclause 8.1 is not
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; dler_f08.F90&quot;, Line = 22, Column = 18: ERROR: C_FUNLOC function
</span><br>
<span class="quotelev1">&gt; argument
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; must be
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; a procedure that is interoperable or a procedure pointer associated
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/12/25993.php">http://www.open-mpi.org/community/lists/users/2014/12/25993.php</a>
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/12/26012.php">http://www.open-mpi.org/community/lists/users/2014/12/26012.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/12/26015.php">http://www.open-mpi.org/community/lists/users/2014/12/26015.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><p><pre>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26030/attachment">attachment</a>
</ul>
