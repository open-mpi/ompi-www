...
?>
<!-- received="Sun Dec 14 21:20:09 2014" -->
<!-- isoreceived="20141215022009" -->
<!-- sent="Mon, 15 Dec 2014 11:20:05 +0900" -->
<!-- isosent="20141215022005" -->
...
<!-- id="548E4555.4070203_at_iferc.org" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2014-12-14 21:20:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25985.php">Eric Chamberland: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<li><strong>Previous message:</strong> <a href="25983.php">Eric Chamberland: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25985.php">Eric Chamberland: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<li><strong>Reply:</strong> <a href="25985.php">Eric Chamberland: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Eric,
<br>
<p>can you make your test case (source + input file + howto) available so i
<br>
can try to reproduce and fix this ?
<br>
<p>Based on the stack trace, i assume this is a complete end user application.
<br>
have you tried/been able to reproduce the same kind of crash with a
<br>
trimmed test program ?
<br>
<p>BTW, what kind of filesystem is hosting Resultats.Eta1 ? (e.g. ext4 /
<br>
nfs / lustre / other)
<br>
<p>Cheers,
...
<p>Gilles
<br>
<p>On 2014/12/15 4:06, Eric Chamberland wrote:
<br>
