...
?>
<!-- received="Tue Dec  2 14:03:25 2014" -->
<!-- isoreceived="20141202190325" -->
<!-- sent="Tue, 2 Dec 2014 19:03:23 +0000" -->
<!-- isosent="20141202190323" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mmaped memory and openib btl." -->
<!-- id="4F1FD9AF-1AB9-4887-8328-343EE406DD57_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAPLAFj7sDjYaRvidyTHRWnhuEJU7hJfQ+f5KgkmFQ6HGitohrQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-02 14:03:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25905.php">Wildes Andrew: "Re: [OMPI users] Noob installation problem"</a>
<li><strong>Previous message:</strong> <a href="25903.php">Nick Papior Andersen: "Re: [OMPI users] [EXTERNAL] Re: How to find MPI ranks located in remote nodes?"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/11/25891.php">Emmanuel Thom&#195;&#169;: "Re: [OMPI users] mmaped memory and openib btl."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25907.php">Emmanuel Thomé: "Re: [OMPI users] mmaped memory and openib btl."</a>
<li><strong>Reply:</strong> <a href="25907.php">Emmanuel Thomé: "Re: [OMPI users] mmaped memory and openib btl."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>We talked about this on the weekly call today, and decided the following:
<br>
<p>1. We're going to push this to 1.8.5, for two main reasons:
<br>
<p>1a. There's workarounds available.
<br>
1b. We need some time to figure this out, but would like to get 1.8.4 out in the near future (i.e., we need to fix some things that do *not* have workarounds).
<br>
<p>2. Here's the workarounds you can use in the meantime:
<br>
<p>2a. Set the MCA param mpi_leave_pinned to 0.  This will disable the registration cache, and you should be good to go.
<br>
<p>2b. Install the UMMUnotify kernel module, and reinstall OMPI.  If ummunotify is not in a standard location, set CPPFLAGS point to where the ummunotify header file is located (e.g., &quot;./configure CPPFLAGS=-I/location/of/ummunotify/header ...&quot;).  Ensure you see this in the configure output:
<br>
<p>checking linux/ummunotify.h usability... yes
<br>
checking linux/ummunotify.h presence... yes
<br>
checking for linux/ummunotify.h... yes
<br>
<p>2c. Add -lopen-pal to the wrapper linker line (as you noticed)
<br>
<p>2d. Don't use munmap.
<br>
<p>I've filed <a href="https://github.com/open-mpi/ompi/issues/299">https://github.com/open-mpi/ompi/issues/299</a>; feel free to follow it with your github account to follow the progress.
<br>
<p><p><p>On Nov 29, 2014, at 8:49 AM, Emmanuel Thom&#233; &lt;emmanuel.thome_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Hi,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I am still affected by the bug which I reported in the thread below
</span><br>
<span class="quotelev1">&gt; (munmapped area lingers in registered memory cache). I'd just like to
</span><br>
<span class="quotelev1">&gt; know if this is recognized as a defect, and whether a fix could be
</span><br>
<span class="quotelev1">&gt; considered, or if instead I should consider the failure I observe as
</span><br>
<span class="quotelev1">&gt; being &quot;normal behavior&quot;, or if somehow there's something weird in the
</span><br>
<span class="quotelev1">&gt; tests I'm running.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The explanation I have is that since the compilation command line
</span><br>
<span class="quotelev1">&gt; created by the mpicc wrapper only contains -lmpi and not -lopen-pal,
</span><br>
<span class="quotelev1">&gt; the functions in OPAL which are supposed to wrap some libc functions
</span><br>
<span class="quotelev1">&gt; (munmap in my case) are not activated: indeed, the libc comes first in
</span><br>
<span class="quotelev1">&gt; the list of dynamically loaded objects to be searched for relocations
</span><br>
<span class="quotelev1">&gt; (while -lopen-pal comes only at the second level, since it is only
</span><br>
<span class="quotelev1">&gt; here because it is triggered by -lmpi).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Does this situation make any sense ?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Thu, Nov 13, 2014 at 7:09 PM, Emmanuel Thom&#233;
</span><br>
...
<span class="quotelev2">&gt;&gt; It turns out that the DT_NEEDED libs for my a.out are:
</span><br>
<span class="quotelev2">&gt;&gt; Dynamic Section:
</span><br>
<span class="quotelev2">&gt;&gt;  NEEDED               libmpi.so.1
</span><br>
<span class="quotelev2">&gt;&gt;  NEEDED               libpthread.so.0
</span><br>
<span class="quotelev2">&gt;&gt;  NEEDED               libc.so.6
</span><br>
<span class="quotelev2">&gt;&gt; which is absolutely consistent with the link command line:
</span><br>
<span class="quotelev2">&gt;&gt; catrel-44 ~ $ mpicc -W -Wall -std=c99 -O0 -g prog6.c -show
</span><br>
<span class="quotelev2">&gt;&gt; gcc -W -Wall -std=c99 -O0 -g prog6.c -pthread -Wl,-rpath -Wl,/usr/lib
</span><br>
<span class="quotelev2">&gt;&gt; -Wl,--enable-new-dtags -lmpi
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; As a consequence, the libc wins over libopen-pal, since it appears
</span><br>
<span class="quotelev2">&gt;&gt; deeper in the DSO resolution:
</span><br>
<span class="quotelev2">&gt;&gt; catrel-44 ~ $ ldd ./a.out
</span><br>
<span class="quotelev2">&gt;&gt;        linux-vdso.so.1 =&gt;  (0x00007fffc5811000)
</span><br>
<span class="quotelev2">&gt;&gt;        libmpi.so.1 =&gt; /usr/lib/libmpi.so.1 (0x00007fa5fd904000)
</span><br>
<span class="quotelev2">&gt;&gt;        libpthread.so.0 =&gt; /lib/x86_64-linux-gnu/libpthread.so.0
</span><br>
<span class="quotelev2">&gt;&gt; (0x00007fa5fd6d5000)
</span><br>
<span class="quotelev2">&gt;&gt;        libc.so.6 =&gt; /lib/x86_64-linux-gnu/libc.so.6 (0x00007fa5fd349000)
</span><br>
<span class="quotelev2">&gt;&gt;        libopen-rte.so.7 =&gt; /usr/lib/libopen-rte.so.7 (0x00007fa5fd0cd000)
</span><br>
<span class="quotelev2">&gt;&gt;        libopen-pal.so.6 =&gt; /usr/lib/libopen-pal.so.6 (0x00007fa5fcdf9000)
</span><br>
<span class="quotelev2">&gt;&gt;        libnuma.so.1 =&gt; /usr/lib/libnuma.so.1 (0x00007fa5fcbed000)
</span><br>
<span class="quotelev2">&gt;&gt;        libdl.so.2 =&gt; /lib/x86_64-linux-gnu/libdl.so.2 (0x00007fa5fc9e9000)
</span><br>
<span class="quotelev2">&gt;&gt;        librt.so.1 =&gt; /lib/x86_64-linux-gnu/librt.so.1 (0x00007fa5fc7e1000)
</span><br>
<span class="quotelev2">&gt;&gt;        libm.so.6 =&gt; /lib/x86_64-linux-gnu/libm.so.6 (0x00007fa5fc55e000)
</span><br>
<span class="quotelev2">&gt;&gt;        libutil.so.1 =&gt; /lib/x86_64-linux-gnu/libutil.so.1 (0x00007fa5fc35b000)
</span><br>
<span class="quotelev2">&gt;&gt;        /lib64/ld-linux-x86-64.so.2 (0x00007fa5fdbe0000)
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; If I explicitly add -lopen-pal to the link command line, or if I pass
</span><br>
<span class="quotelev2">&gt;&gt; --openmpi:linkall to the mpicc wrapper, then libopen-pal appears
</span><br>
<span class="quotelev2">&gt;&gt; before the libc, and wins the contest for the munmap relocation. Which
</span><br>
<span class="quotelev2">&gt;&gt; makes my test pass successfully.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Is there supposed to be any smarter mechanism for having the
</span><br>
<span class="quotelev2">&gt;&gt; libopen-pal relocation win, rather than just DSO precedence ?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Wed, Nov 12, 2014 at 7:51 PM, Emmanuel Thom&#233;
</span><br>
<span class="quotelev2">&gt;&gt; &lt;emmanuel.thome_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; yes I confirm. Thanks for saying that this is the supposed behaviour.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; In the binary, the code goes to munmap_at_plt, which goes to the libc,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; not to libopen-pal.so
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; libc is 2.13-38+deb7u1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm a total noob at got/plt relocations. What is the mechanism which
</span><br>
<span class="quotelev3">&gt;&gt;&gt; should make the opal relocation win over the libc one ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wed, Nov 12, 2014 at 7:40 PM, Jeff Squyres (jsquyres)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; FWIW, munmap is *supposed* to be intercepted.  Can you confirm that when your application calls munmap, it doesn't make a call to libopen-pal.so?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; It should be calling this (1-line) function:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -----
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; /* intercept munmap, as the user can give back memory that way as well. */
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; OPAL_DECLSPEC int munmap(void* addr, size_t len)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; {
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;    return opal_memory_linux_free_ptmalloc2_munmap(addr, len, 0);
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; }
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -----
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Nov 12, 2014, at 11:08 AM, Emmanuel Thom&#233; &lt;emmanuel.thome_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &lt;prog6.c&gt;_______________________________________________
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/11/25779.php">http://www.open-mpi.org/community/lists/users/2014/11/25779.php</a>
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/11/25891.php">http://www.open-mpi.org/community/lists/users/2014/11/25891.php</a>
</span><br>
<p><p><pre>
-- 
Jeff Squyres
