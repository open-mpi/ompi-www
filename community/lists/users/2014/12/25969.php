...
?>
<!-- received="Thu Dec 11 22:32:21 2014" -->
<!-- isoreceived="20141212033221" -->
<!-- sent="Fri, 12 Dec 2014 12:32:34 +0900" -->
<!-- isosent="20141212033234" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI inside MPI (still)" -->
<!-- id="548A61D2.6020403_at_iferc.org" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAGs3GVYmPJbs=Vps1X0U+0VK0KZgko0FBLOdiBUpbjv4UpJzZQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-11 22:32:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25970.php">Alex A. Schmidt: "Re: [OMPI users] MPI inside MPI (still)"</a>
<li><strong>Previous message:</strong> <a href="25968.php">Alex A. Schmidt: "Re: [OMPI users] MPI inside MPI (still)"</a>
<li><strong>In reply to:</strong> <a href="25968.php">Alex A. Schmidt: "Re: [OMPI users] MPI inside MPI (still)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25970.php">Alex A. Schmidt: "Re: [OMPI users] MPI inside MPI (still)"</a>
<li><strong>Reply:</strong> <a href="25970.php">Alex A. Schmidt: "Re: [OMPI users] MPI inside MPI (still)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Alex,
<br>
<p>just ask MPI_Comm_spawn to start (up to) 5 tasks via the maxprocs
<br>
parameter :
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;int MPI_Comm_spawn(char *command, char *argv[], int maxprocs,
<br>
MPI_Info info,
<br>
...
<p>Gilles
<br>
<p>On 2014/12/12 12:23, Alex A. Schmidt wrote:
<br>
...
<span class="quotelev2">&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/12/25967.php">http://www.open-mpi.org/community/lists/users/2014/12/25967.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev1">&gt;
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25969/attachment">attachment</a>
</ul>
