...
?>
<!-- received="Sun Dec 14 22:26:24 2014" -->
<!-- isoreceived="20141215032624" -->
<!-- sent="Mon, 15 Dec 2014 12:26:20 +0900" -->
<!-- isosent="20141215032620" -->
...
<!-- id="548E54DC.6010309_at_iferc.org" -->
...
<strong>Date:</strong> 2014-12-14 22:26:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25990.php">Eric Chamberland: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<li><strong>Previous message:</strong> <a href="25988.php">Eric Chamberland: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25990.php">Eric Chamberland: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<li><strong>Reply:</strong> <a href="25990.php">Eric Chamberland: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Eric,
<br>
<p>here is a patch for the v1.8 series, it fixes a one byte overflow.
<br>
<p>valgrind should stop complaining, and assuming this is the root cause of
<br>
the memory corruption,
<br>
that could also fix your program.
<br>
<p>that being said, shared_fp_fname is limited to 255 characters (this is
<br>
...
be kind of random.
<br>
<p>/* from ADIOI_Shfp_fname :
<br>
&nbsp;&nbsp;If the real file is /tmp/thakur/testfile, the shared-file-pointer
<br>
&nbsp;&nbsp;&nbsp;file will be /tmp/thakur/.testfile.shfp.xxxx, where xxxx is
<br>
<p>FWIW, xxxx is a random number that takes between 1 and 10 characters
<br>
<p>could you please give this patch a try and let us know the results ?
<br>
<p>Cheers,
<br>
<p>Gilles
...
<br><hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25989/romio.diff">romio.diff</a>
</ul>
<!-- attachment="romio.diff" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
