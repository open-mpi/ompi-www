...
?>
<!-- received="Sun Dec 14 02:20:09 2014" -->
<!-- isoreceived="20141214072009" -->
<!-- sent="Sun, 14 Dec 2014 05:20:06 -0200" -->
<!-- isosent="20141214072006" -->
<!-- name="Alex A. Schmidt" -->
<!-- email="aas_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)" -->
<!-- id="CAGs3GVY==78hTYQO2emyV65Za7E7t-ST1ssqzHhfSJ5JeVpDXA_at_mail.gmail.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="kigj27mujb4nms6q89d0ptcc.1418521286907_at_email.android.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-14 02:20:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25983.php">Eric Chamberland: "Re: [OMPI users] OpenMPI 1.8.4rc3, 1.6.5 and 1.6.3: segmentation violation in mca_io_romio_dist_MPI_File_close"</a>
<li><strong>Previous message:</strong> <a href="25981.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>In reply to:</strong> <a href="25981.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25991.php">George Bosilca: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>Reply:</strong> <a href="25991.php">George Bosilca: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Sorry, guys. I don't think the newbie here can follow any discussion
<br>
beyond basic mpi...
<br>
<p>Anyway, if I add the pair
<br>
<p>call MPI_COMM_GET_PARENT(mpi_comm_parent,ierror)
<br>
call MPI_COMM_DISCONNECT(mpi_comm_parent,ierror)
<br>
<p>on the spawnee side I get the proper response in the spawning processes.
<br>
<p>Please, take a look at the attached toy codes parent.F and child.F
<br>
I've been playing with. 'mpirun -n 2 parent' seems to work as expected.
<br>
<p>Alex
<br>
<p>2014-12-13 23:46 GMT-02:00 Gilles Gouaillardet &lt;
<br>
...
<span class="quotelev1">&gt; Are you calling MPI_Comm_disconnect in the 3 &quot;master&quot; tasks and with the
</span><br>
<span class="quotelev1">&gt; same remote communicator ?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I also read the man page again, and MPI_Comm_disconnect does not ensure
</span><br>
<span class="quotelev1">&gt; the remote processes have finished or called MPI_Comm_disconnect, so that
</span><br>
<span class="quotelev1">&gt; might not be the thing you need.
</span><br>
...
<span class="quotelev1">&gt; MPI_Comm_disconnect should be a local operation, there is no reason for it
</span><br>
<span class="quotelev1">&gt; to deadlock. I looked at the code and everything is local with the
</span><br>
...
<span class="quotelev2">&gt;&gt; Sorry, I was calling mpi_comm_disconnect on the group comm handler, not
</span><br>
...
<span class="quotelev2">&gt;&gt; side but the wait is never completed since, as George points out, there
</span><br>
<span class="quotelev2">&gt;&gt; is no
</span><br>
<span class="quotelev2">&gt;&gt; disconnect call being made on the spawnee side.... and that brings me back
</span><br>
<span class="quotelev2">&gt;&gt; to the beginning of the problem since, being a third party app, that call
</span><br>
<span class="quotelev2">&gt;&gt; would
</span><br>
<span class="quotelev2">&gt;&gt; never be there. I guess an mpi wrapper to deal with that could be made for
</span><br>
<span class="quotelev2">&gt;&gt; the app, but I fell the wrapper itself, at the end, would face the same
</span><br>
...
<span class="quotelev2">&gt;&gt; (minimum or maximum energy) of cluster of atoms. The work flow bottleneck
</span><br>
...
<span class="quotelev2">&gt;&gt; is distributed among slaves nodes from a master node. This is also done
</span><br>
<span class="quotelev2">&gt;&gt; when an analytical potential is not available and the energy calculation
</span><br>
...
<span class="quotelev2">&gt;&gt; So far, we have been running these codes in serial mode. No need to say
</span><br>
...
<span class="quotelev2">&gt;&gt; I am not familiar with DMRAA but it seems to be the right choice to deal
</span><br>
<span class="quotelev2">&gt;&gt; with
</span><br>
<span class="quotelev2">&gt;&gt; job schedulers as it covers the ones I am interested in (pbs/torque and
</span><br>
<span class="quotelev2">&gt;&gt; loadlever).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; The second point is no more mpi related, and is batch manager specific.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; You will likely find a submit parameter to make the command block until
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the job completes. Or you can write your own wrapper.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; with the right options to make qsub blocking or you manually wait for
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the end of the job ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; when the spawned processes have finnished running? All I have to work
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; with is the intercommunicator returned from the mpi_comm_spawn call...
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Alex
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25982/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/x-fortran attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25982/parent.F">parent.F</a>
</ul>
<!-- attachment="parent.F" -->
<hr>
<ul>
<li>text/x-fortran attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25982/child.F">child.F</a>
</ul>
<!-- attachment="child.F" -->
<!-- body="end" -->
<hr>
