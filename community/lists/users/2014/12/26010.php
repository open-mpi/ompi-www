...
?>
<!-- received="Wed Dec 17 11:07:50 2014" -->
<!-- isoreceived="20141217160750" -->
<!-- sent="Wed, 17 Dec 2014 14:07:48 -0200" -->
<!-- isosent="20141217160748" -->
<!-- name="Alex A. Schmidt" -->
<!-- email="aas_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)" -->
<!-- id="CAGs3GVZGBQRtEarD3_FwiVxA3PUgdQENZ8P8A5S_HkVHKu_m9A_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAGs3GVZ9dosDA_Y=+fRfPpV5SZ=43pMAdDtrOdf5xnkUHwi9qg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-17 11:07:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26011.php">Ralph Castain: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>Previous message:</strong> <a href="26009.php">Jeff Squyres (jsquyres): "Re: [OMPI users] ERROR: C_FUNLOC function"</a>
<li><strong>In reply to:</strong> <a href="26004.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26011.php">Ralph Castain: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>Reply:</strong> <a href="26011.php">Ralph Castain: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>I am afraid I will have to insist on i/o redirection matter
<br>
for the spawnee process.
<br>
<p>I have a &quot;child&quot; mpi code that do just 2 things: read the 3 parameters
<br>
...
20
<br>
<p>executing &quot;mpirun -n 1 child A B &lt; stdin_file&quot; wiil ouput two lines:
<br>
<p>[A]  [B]  []
<br>
10  20
<br>
<p>On the other hand , calling &quot;child&quot; from MPI_Comm_spawn(&quot;child&quot;,args,...)
<br>
where
<br>
<p>args(1) = &quot;A&quot;
...
args(4) = &quot; &quot;
<br>
<p>will make &quot;child&quot; outputs only 1 line
<br>
<p>[A] [B] [&lt; stdin_file]
<br>
<p>and then fails because there is not stdin data to read from.
<br>
<p>Please, note that surprisingly the whole string &quot;&lt; stdin_file&quot; is
<br>
interpreted
<br>
...
<p>Alex
<br>
<p><p><p><p><p><p><p>2014-12-15 17:26 GMT-02:00 Alex A. Schmidt &lt;aas_at_[hidden]&gt;:
<br>
...
<span class="quotelev2">&gt;&gt; You should be able to just include that in your argv that you pass to the
</span><br>
<span class="quotelev2">&gt;&gt; Comm_spawn API.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; Thanks for the tip. In fact, calling mpi_comm_spawn right away with MPI
</span><br>
<span class="quotelev3">&gt;&gt;&gt; _COMM_SELF
</span><br>
<span class="quotelev3">&gt;&gt;&gt; has worked for me just as well -- no subgroups needed at all.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I am testing this openmpi app named &quot;siesta&quot; in parallel. The source
</span><br>
<span class="quotelev3">&gt;&gt;&gt; code is available,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; so making it &quot;spawn ready&quot; by adding the pair mpi_comm_get_parent + mpi_comm_disconnect
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; However, siesta is launched only by specifying input/output files with
</span><br>
<span class="quotelev3">&gt;&gt;&gt; i/o redirection like
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; So far, I could not find anything about how to set an stdin file for an
</span><br>
<span class="quotelev3">&gt;&gt;&gt; spawnee process.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I would change the way you create the subcoms in the parent. You do a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; lot of useless operations, as you can achieve exactly the same outcome (one
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; communicator per node), either by duplicating MPI_COMM_SELF or doing an
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_Comm_split with the color equal to your rank.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sun, Dec 14, 2014 at 2:20 AM, Alex A. Schmidt &lt;aas_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Are you calling MPI_Comm_disconnect in the 3 &quot;master&quot; tasks and with
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the same remote communicator ?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; MPI_Comm_disconnect should be a local operation, there is no reason
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; for it to deadlock. I looked at the code and everything is local with the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Sorry, I was calling mpi_comm_disconnect on the group comm handler,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; not
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; on the intercomm handler returned from the spawn call as it should
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; side but the wait is never completed since, as George points out,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; there is no
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; disconnect call being made on the spawnee side.... and that brings
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; me back
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; to the beginning of the problem since, being a third party app, that
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; call would
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; never be there. I guess an mpi wrapper to deal with that could be
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; made for
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; the app, but I fell the wrapper itself, at the end, would face the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; potential is available the calculation can be made internally and
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; the workload
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; is distributed among slaves nodes from a master node. This is also
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; be done externally by a quantum chemistry code like dftb+, siesta
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; and Gaussian.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; So far, we have been running these codes in serial mode. No need to
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; say that
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; we could do a lot better if they could be executed in parallel.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am not familiar with DMRAA but it seems to be the right choice to
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; deal with
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; job schedulers as it covers the ones I am interested in (pbs/torque
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; and loadlever).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Alex
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; You will likely find a submit parameter to make the command block
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; until the job completes. Or you can write your own wrapper.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; with the right options to make qsub blocking or you manually wait
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; for the end of the job ?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; when the spawned processes have finnished running? All I have to
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; which greatly benefits from a parallel environment. My code is
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26010/attachment">attachment</a>
</ul>
