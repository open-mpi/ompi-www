...
?>
<!-- received="Mon Dec 15 14:07:21 2014" -->
<!-- isoreceived="20141215190721" -->
<!-- sent="Mon, 15 Dec 2014 11:07:19 -0800" -->
<!-- isosent="20141215190719" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)" -->
<!-- id="CAMD57oeyPbaSM4JdC=yWv+q82pxH06ToTeGeSjqODQ-hseRP0Q_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAGs3GVaiu_PCeXaAhRe2m3ofr4yEJubQMeYGwnPwmqGu9GWDxQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-12-15 14:07:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26004.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>Previous message:</strong> <a href="26002.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>In reply to:</strong> <a href="26002.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26004.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<li><strong>Reply:</strong> <a href="26004.php">Alex A. Schmidt: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] MPI inside MPI (still)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Comm_spawn API.
<br>
<p><p>On Mon, Dec 15, 2014 at 9:27 AM, Alex A. Schmidt &lt;aas_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; Thanks for the tip. In fact, calling mpi_comm_spawn right away with MPI
</span><br>
<span class="quotelev1">&gt; _COMM_SELF
</span><br>
<span class="quotelev1">&gt; has worked for me just as well -- no subgroups needed at all.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I am testing this openmpi app named &quot;siesta&quot; in parallel. The source code
</span><br>
...
<span class="quotelev1">&gt; However, siesta is launched only by specifying input/output files with
</span><br>
<span class="quotelev1">&gt; i/o redirection like
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; So far, I could not find anything about how to set an stdin file for an
</span><br>
<span class="quotelev1">&gt; spawnee process.
</span><br>
<span class="quotelev1">&gt; Specifiyng it in a app context file doesn't seem to work. Can it be done?
</span><br>
<span class="quotelev1">&gt; Maybe through
</span><br>
...
<span class="quotelev2">&gt;&gt; I would change the way you create the subcoms in the parent. You do a lot
</span><br>
<span class="quotelev2">&gt;&gt; of useless operations, as you can achieve exactly the same outcome (one
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; on the spawnee side I get the proper response in the spawning processes.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Please, take a look at the attached toy codes parent.F and child.F
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I've been playing with. 'mpirun -n 2 parent' seems to work as expected.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Are you calling MPI_Comm_disconnect in the 3 &quot;master&quot; tasks and with
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the same remote communicator ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I also read the man page again, and MPI_Comm_disconnect does not ensure
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the remote processes have finished or called MPI_Comm_disconnect, so that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; might not be the thing you need.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI_Comm_disconnect should be a local operation, there is no reason for
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; it to deadlock. I looked at the code and everything is local with the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sat, Dec 13, 2014 at 8:47 AM, Alex A. Schmidt &lt;aas_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Well, calling the disconnect on the intercomm handler does halt the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; spwaner
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; side but the wait is never completed since, as George points out,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; there is no
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; disconnect call being made on the spawnee side.... and that brings me
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; back
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; to the beginning of the problem since, being a third party app, that
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; call would
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; never be there. I guess an mpi wrapper to deal with that could be made
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; So far, we have been running these codes in serial mode. No need to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; say that
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; we could do a lot better if they could be executed in parallel.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I am not familiar with DMRAA but it seems to be the right choice to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; deal with
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; job schedulers as it covers the ones I am interested in (pbs/torque
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; and loadlever).
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Alex
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Or you can retrieve the jobid and qstat periodically to get the job
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; with the right options to make qsub blocking or you manually wait
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; for the end of the job ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26003/attachment">attachment</a>
</ul>
