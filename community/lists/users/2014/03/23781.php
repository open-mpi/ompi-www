...
?>
<!-- received="Thu Mar  6 15:50:43 2014" -->
<!-- isoreceived="20140306205043" -->
<!-- sent="Thu, 06 Mar 2014 15:50:42 -0500" -->
<!-- isosent="20140306205042" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI job initializing problem" -->
<!-- id="5318DFA2.8020005_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="D67303F39678724DA65819E042CB369892A81D0B37_at_EXC2.ad.colorado.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-06 15:50:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23782.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Previous message:</strong> <a href="23780.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>In reply to:</strong> <a href="23780.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23782.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Reply:</strong> <a href="23782.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>If I remember right, and unless this changed in recent OMPI vervsions,
<br>
you also need &quot;self&quot;:
<br>
...
<br>
<p>Also, I don't know if you can ask for openib
<br>
and also add --mca btl_tcp_if_include 10.148.0.0/16.
<br>
Note that one turns off tcp (I think),
<br>
whereas the other requests a tcp interface (or that the IB interface 
<br>
with IPoIB functionality).
<br>
That combination sounds weird to me.
<br>
The OMPI developers may clarify if this is
<br>
valid syntax/syntax combination.
<br>
<p>I would try simply -mca btl sm,openib,self, which is likely to give you
<br>
the IB transport with verbs, plus shared memory intra-node, plus the 
<br>
