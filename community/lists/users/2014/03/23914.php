...
?>
<!-- received="Fri Mar 21 09:07:35 2014" -->
<!-- isoreceived="20140321130735" -->
<!-- sent="Fri, 21 Mar 2014 06:05:53 -0700" -->
<!-- isosent="20140321130553" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI job initializing problem" -->
<!-- id="695670B9-1921-4B7D-92C9-5ED0724D7408_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="D67303F39678724DA65819E042CB369892A84D83CA_at_EXC2.ad.colorado.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-21 09:05:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23915.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<li><strong>Previous message:</strong> <a href="23913.php">Ralph Castain: "Re: [OMPI users] coll_ml_priority in openmpi-1.7.5"</a>
<li><strong>In reply to:</strong> <a href="23908.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23926.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Reply:</strong> <a href="23926.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
One thing to check would be the time spent between MPI_Init and MPI_Finalize - i.e., see if the time difference is caused by differences in init and finalize themselves. My guess is that is the source - would help us target the problem.
<br>
...
<span class="quotelev1">&gt; communication overhead = commuT + migraT + print, compuT is computational cost, totalT = compuT + communication overhead, overhead% denotes percentage of communication overhead
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; [compute node]$ stat -f -L -c %T /tmp
</span><br>
<span class="quotelev2">&gt;&gt; tmpfs
</span><br>
<span class="quotelev2">&gt;&gt; [compute node]$ stat -f -L -c %T /home/yanb/scratch lustre
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; you the IB transport with verbs, plus shared memory intra-node, plus
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mount devpts on /dev/pts type devpts (rw,gid=5,mode=620) tmpfs on
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; /tmp type tmpfs (rw,size=150m) none on /proc/sys/fs/binfmt_misc
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; type binfmt_misc
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Start Prologue v2.5 Mon Mar  3 15:47:16 EST 2014 End Prologue
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; cpupercent=0,cput=00:00:00,mem=7028kb,ncpus=128,vmem=495768kb
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ,
</span><br>
