...
?>
<!-- received="Thu Mar 20 16:53:02 2014" -->
<!-- isoreceived="20140320205302" -->
<!-- sent="Thu, 20 Mar 2014 13:51:25 -0700" -->
<!-- isosent="20140320205125" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI job initializing problem" -->
<!-- id="47C01CEF-9186-4A88-BDA4-E982273480B6_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="D67303F39678724DA65819E042CB369892A84D839B_at_EXC2.ad.colorado.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-20 16:51:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23901.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Previous message:</strong> <a href="23899.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>In reply to:</strong> <a href="23899.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23903.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Yeah, those are local - just in RAM, which is fine and quite typical. In 1.7.5, we replaced some of the rendezvous logic, which may be why the problem went away.
<br>
<p><p>On Mar 20, 2014, at 1:48 PM, Beichuan Yan &lt;beichuan.yan_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Ralph and Noam,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Thanks for the clarifications, they are important. I could be wrong in understanding the filesystem.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Spirit appears to use a scratch directory for shared memory backing which is mounted on Lustre, and does not seem to have local directories or does not allow user to change TEMPDIR. Here is the info:
</span><br>
<span class="quotelev1">&gt; [compute node]$ stat -f -L -c %T /tmp
</span><br>
<span class="quotelev1">&gt; tmpfs
</span><br>
<span class="quotelev1">&gt; [compute node]$ stat -f -L -c %T /home/yanb/scratch
</span><br>
<span class="quotelev1">&gt; lustre
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On another university supercomputer, I found the following:
</span><br>
<span class="quotelev1">&gt; node0448[~]$ stat -f -L -c %T /tmp
</span><br>
<span class="quotelev1">&gt; ramfs
</span><br>
<span class="quotelev1">&gt; node0448[~]$ stat -f -L -c %T /home/yanb/scratch/
</span><br>
<span class="quotelev1">&gt; lustre
</span><br>
<span class="quotelev1">&gt; Is this /tmp at compute node a local directory? I don't know how to tell it.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; will abort with an error message, instead of running too slow (if it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is using other networks).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
