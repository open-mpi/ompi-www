...
?>
<!-- received="Tue Mar 25 03:34:15 2014" -->
<!-- isoreceived="20140325073415" -->
<!-- sent="Tue, 25 Mar 2014 08:34:14 +0100" -->
<!-- isosent="20140325073414" -->
<!-- name="Hamid Saeed" -->
<!-- email="e.hamidsaeed_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fwd: problem for multiple clusters using mpirun" -->
<!-- id="CAADBNWw8pM+M4ZZS8ZdcjhauvM=-79zp6krf5=xj1DqQiD6+8A_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAADBNWzGJT7nMHXgDtz7s-_apy6bzYgChkC_1Awgarbd3pykmQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-25 03:34:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23956.php">Reuti: "Re: [OMPI users] Fwd: problem for multiple clusters using mpirun"</a>
<li><strong>Previous message:</strong> <a href="23954.php">tmishima_at_[hidden]: "Re: [OMPI users] coll_ml_priority in openmpi-1.7.5"</a>
<li><strong>In reply to:</strong> <a href="23949.php">Hamid Saeed: "Re: [OMPI users] Fwd: problem for multiple clusters using mpirun"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23956.php">Reuti: "Re: [OMPI users] Fwd: problem for multiple clusters using mpirun"</a>
<li><strong>Reply:</strong> <a href="23956.php">Reuti: "Re: [OMPI users] Fwd: problem for multiple clusters using mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello,
<br>
<p>Is it possible to change the port number for the MPI communication?
<br>
<p>I can see that my program uses port 4 for the MPI communication.
<br>
...
<br>
<p>In my case the ports from 1 to 1024 are reserved.
<br>
MPI tries to use one of the reserve ports and prompts the connection
<br>
refused error.
<br>
<p>I will be very glade for the kind suggestions.
<br>
<p><p>Regards.
<br>
<p><p><p><p><p>On Mon, Mar 24, 2014 at 5:32 PM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; The problem was from the network administrator. The machines on the
</span><br>
...
<span class="quotelev1">&gt; On Mon, Mar 24, 2014 at 4:34 PM, Jeff Squyres (jsquyres) &lt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Try using btl_tcp_if_include and list just the interface(s) that you want
</span><br>
<span class="quotelev2">&gt;&gt; to use.  From your prior email, I'm *guessing* it's just br2 (i.e., the
</span><br>
<span class="quotelev2">&gt;&gt; 10.x address inside your cluster).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt; &gt; hsaeed_at_karp:~/Task4_mpi/scatterv$ mpirun -np 8 --mca btl ^openib --mca
</span><br>
<span class="quotelev2">&gt;&gt; btl_tcp_if_exclude sm,self,lo,br0,br1,ib0,br2 --host karp,wirth ./scatterv
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; / ompi mpi abort:cannot guarantee all killed
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt; &gt; Do you have any firewalling enabled on these machines?  If so, you'll
</span><br>
<span class="quotelev2">&gt;&gt; want to either disable it, or allow random TCP connections between any of
</span><br>
<span class="quotelev2">&gt;&gt; the cluster nodes.
</span><br>
<span class="quotelev4">&gt;&gt; &gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt; &gt;
...
<span class="quotelev3">&gt;&gt; &gt; &gt; &gt; &gt; &gt; I think i have a tcp connection. As for as i know my cluster is
</span><br>
<span class="quotelev2">&gt;&gt; not configured for Infiniband (IB).
</span><br>
<span class="quotelev1">&gt;&gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; connect() to xx.xxx.x.xxx failed: Connection refused (111)
</span><br>
<span class="quotelev1">&gt;&gt; &gt; &gt; &gt;
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23955/attachment">attachment</a>
</ul>
