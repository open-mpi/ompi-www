...
?>
<!-- received="Thu Mar  6 15:35:32 2014" -->
<!-- isoreceived="20140306203532" -->
<!-- sent="Thu, 6 Mar 2014 13:35:43 -0700" -->
<!-- isosent="20140306203543" -->
<!-- name="Beichuan Yan" -->
<!-- email="beichuan.yan_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI job initializing problem" -->
<!-- id="D67303F39678724DA65819E042CB369892A81D0B37_at_EXC2.ad.colorado.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="5318D795.5050103_at_ldeo.columbia.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-06 15:35:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23781.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Previous message:</strong> <a href="23779.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>In reply to:</strong> <a href="23779.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23781.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Reply:</strong> <a href="23781.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gus,
<br>
<p>Yes, 10.148.0.0/16 is the IB subnet.
<br>
<p>I did try others but none worked:
<br>
#export
<br>
...
<p>Hi Beichuan
<br>
<p>So, it looks like that now the program runs, even though with specific settings depending on whether you're using OMPI 1.6.5 or 1.7.4, right?
<br>
<p>It looks like the problem now is performance, right?
<br>
<p>System load affects performance, but unless the network is overwhelmed, or perhaps the Lustre file system is hanging or too slow, I would think that a walltime increase from 1min to 10min is not related to system load, but something else.
<br>
...
<br>
<p>Also helpful to document/troubleshoot is to add -v and -tag-output to your mpiexec command line.
<br>
<p><p>The difference in walltime could be due to some malfunction of IB HCAs on the nodes, for instance.
<br>
...
<br>
(Jeff will cut my list subscription after that one, for spreading misinformation.)
<br>
<p>In either case my impression is that you may have left a door open to the use of non-IB (and non-IB-verbs) transport.
<br>
<p>Is 10.148.0.0/16 the an Infiniband subnet or an Ethernet subnet?
<br>
<p>Did you remeber Jeff's suggestion from a while ago to avoid TCP (over Ethernet or over IB), and stick to IB verbs?
<br>
