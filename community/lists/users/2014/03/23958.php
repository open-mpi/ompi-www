...
?>
<!-- received="Tue Mar 25 05:36:14 2014" -->
<!-- isoreceived="20140325093614" -->
<!-- sent="Tue, 25 Mar 2014 10:36:13 +0100" -->
<!-- isosent="20140325093613" -->
<!-- name="Hamid Saeed" -->
<!-- email="e.hamidsaeed_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fwd: problem for multiple clusters using mpirun" -->
<!-- id="CAADBNWzjKpHk7DYFArd96jzrkfmiU1S1cH7ZLw8jcncqL=sPrw_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAADBNWzCY7HRAR1CxEDtNaH_m+syox4xMNjQXZ2-_KPEkcuSCw_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-25 05:36:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23959.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<li><strong>Previous message:</strong> <a href="23957.php">Hamid Saeed: "Re: [OMPI users] Fwd: problem for multiple clusters using mpirun"</a>
<li><strong>In reply to:</strong> <a href="23957.php">Hamid Saeed: "Re: [OMPI users] Fwd: problem for multiple clusters using mpirun"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23959.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<li><strong>Reply:</strong> <a href="23959.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>and every thing works again.
<br>
<p>Thanks.
<br>
<p>Best regards.
<br>
<p><p><p><p>On Tue, Mar 25, 2014 at 10:23 AM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt;wrote:
<br>
...
<span class="quotelev1">&gt; [karp:23756] btl: tcp: attempting to connect() to address 134.106.3.252 on
</span><br>
<span class="quotelev1">&gt; port 4
</span><br>
...
<span class="quotelev3">&gt;&gt; &gt; [karp:23756] btl: tcp: attempting to connect() to address 134.106.3.252
</span><br>
<span class="quotelev2">&gt;&gt; on port 4
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
<span class="quotelev2">&gt;&gt; [karp][[4612,1],0][btl_tcp_endpoint.c:655:mca_btl_tcp_endpoint_complete_connect]
</span><br>
<span class="quotelev2">&gt;&gt; connect() to 134.106.3.252 failed: Connection refused (111)
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; refused error.
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; any up to 1024 should not be the default:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; network side were halting the mpi...
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; want to use.  From your prior email, I'm *guessing* it's just br2 (i.e.,
</span><br>
<span class="quotelev2">&gt;&gt; the 10.x address inside your cluster).
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
<span class="quotelev3">&gt;&gt; &gt; Also, it looks like you didn't setup your SSH keys properly for logging
</span><br>
<span class="quotelev2">&gt;&gt; in to remote notes automatically.
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
...
<span class="quotelev2">&gt;&gt; --mca btl_tcp_if_exclude sm,self,lo,br0,br1,ib0,br2 --host karp,wirth
</span><br>
<span class="quotelev2">&gt;&gt; ./scatterv
</span><br>
<span class="quotelev4">&gt;&gt; &gt; &gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt; &gt; [karp:29513] 1 more process has sent help message help-mca-bml-r2.txt
</span><br>
<span class="quotelev2">&gt;&gt; / unreachable proc
</span><br>
<span class="quotelev4">&gt;&gt; &gt; &gt; [karp:29513] Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to see
</span><br>
...
<span class="quotelev2">&gt;&gt; mpi_init:startup:pml-add-procs-fail
</span><br>
<span class="quotelev4">&gt;&gt; &gt; &gt; [karp:29513] 1 more process has sent help message help-mpi-errors.txt
</span><br>
<span class="quotelev2">&gt;&gt; / mpi_errors_are_fatal unknown handle
</span><br>
...
<span class="quotelev2">&gt;&gt; loopback interface.  Loopback is excluded by the default value of
</span><br>
<span class="quotelev2">&gt;&gt; btl_tcp_if_exclude, but if you overwrite that value, then you need to
</span><br>
<span class="quotelev2">&gt;&gt; *also* include the loopback interface in the new value.
</span><br>
<span class="quotelev4">&gt;&gt; &gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt; &gt;
...
<span class="quotelev1">&gt;&gt; &gt; &gt; &gt; I checked there is no firewall which is acting as a barrier for the
</span><br>
...
<span class="quotelev2">&gt;&gt; btl_tcp_if_exclude br2 -host wirth,karp ./a.out
</span><br>
<span class="quotelev1">&gt;&gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; you can see in the &quot;ifconfig&quot; output mentioned above.
</span><br>
<span class="quotelev1">&gt;&gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt; &gt; &gt; I know there is something wrong but i am almost unable to figure it
</span><br>
...
<span class="quotelev2">&gt;&gt; you'll want to either disable it, or allow random TCP connections between
</span><br>
<span class="quotelev2">&gt;&gt; any of the cluster nodes.
</span><br>
<span class="quotelev1">&gt;&gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt; &gt; &gt;
...
<span class="quotelev2">&gt;&gt; (219.9 MiB)
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; (221.2 MiB)
</span><br>
...
<span class="quotelev2">&gt;&gt; [wirth][[59430,1],0][btl_tcp_endpoint.c:655:mca_btl_tcp_endpoint_complete_connect]
</span><br>
<span class="quotelev2">&gt;&gt; connect() to 10.231.2.231 failed: Connection refused (111)
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt;
...
<span class="quotelev2">&gt;&gt; is not configured for Infiniband (IB).
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; ./helloworldmpi
</span><br>
...
<span class="quotelev2">&gt;&gt; [btl_tcp_endpoint.c:655:mca_btl_tcp_endpoint_complete_connect] connect() to
</span><br>
<span class="quotelev2">&gt;&gt; xx.xxx.x.xxx failed: Connection refused (111)
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt; What are the IP addresses reported by connect()?  (i.e., the
</span><br>
<span class="quotelev2">&gt;&gt; address you X'ed out)
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt; Send the output from ifconfig on each of your servers.  Note that
</span><br>
<span class="quotelev2">&gt;&gt; some Linux distributions do not put ifconfig in the default PATH of normal
</span><br>
<span class="quotelev2">&gt;&gt; users; look for it in/sbin/ifconfig or /usr/sbin/ifconfig.
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev2">&gt;&gt; &gt; &gt; &gt; &gt; --
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23958/attachment">attachment</a>
</ul>
