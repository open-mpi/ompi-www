...
?>
<!-- received="Thu Mar  6 16:52:21 2014" -->
<!-- isoreceived="20140306215221" -->
<!-- sent="Thu, 6 Mar 2014 14:52:32 -0700" -->
<!-- isosent="20140306215232" -->
<!-- name="Beichuan Yan" -->
<!-- email="beichuan.yan_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI job initializing problem" -->
<!-- id="D67303F39678724DA65819E042CB369892A81D0B4E_at_EXC2.ad.colorado.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="5318DFA2.8020005_at_ldeo.columbia.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-06 16:52:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23783.php">Velickovic Nikola: "[OMPI users] Problems with computation-communication overlap in non-blocking mode"</a>
<li><strong>Previous message:</strong> <a href="23781.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>In reply to:</strong> <a href="23781.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23784.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Reply:</strong> <a href="23784.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I just found, with exact the same code, data and job settings, a job can really run one day while cannot the other day. It is NOT repeatable. I don't know what the problem is: hardware? OpenMPI? PBS Pro?
<br>
<p>Anyway, I may have to give up using OpenMPI on that system and switch to IntelMPI which always work.
<br>
<p>Thanks,
<br>
Beichuan
...
Subject: Re: [OMPI users] OpenMPI job initializing problem
<br>
<p>On 03/06/2014 03:35 PM, Beichuan Yan wrote:
<br>
...
<p>If I remember right, and unless this changed in recent OMPI vervsions, you also need &quot;self&quot;:
<br>
<p>-mca btl sm,openib,self
<br>
<p>Alternatively, you could rule out tcp:
<br>
<p>-mca btl ^tcp
<br>
...
<p>Likewise, &quot;self&quot; is missing here.
<br>
<p>Also, I don't know if you can ask for openib and also add --mca btl_tcp_if_include 10.148.0.0/16.
<br>
Note that one turns off tcp (I think),
<br>
whereas the other requests a tcp interface (or that the IB interface with IPoIB functionality).
<br>
That combination sounds weird to me.
<br>
The OMPI developers may clarify if this is valid syntax/syntax combination.
<br>
<p>I would try simply -mca btl sm,openib,self, which is likely to give you the IB transport with verbs, plus shared memory intra-node, plus the
<br>
...
<span class="quotelev1">&gt; (Jeff will cut my list subscription after that one, for spreading misinformation.)
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;   &gt;  Both 1.6.x and 1.7.x/1.8.x will need verbs.h to use the native verbs
</span><br>
<span class="quotelev2">&gt;   &gt;  network stack.
</span><br>
<span class="quotelev2">&gt;   &gt;
</span><br>
<span class="quotelev2">&gt;   &gt;  You can use emulated TCP over IB (e.g., using the OMPI TCP BTL), but
</span><br>
<span class="quotelev2">&gt;   &gt;  it's nowhere near as fast/efficient the native verbs network stack.
</span><br>
<span class="quotelev2">&gt;   &gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; In this case, if any of the IB HCAs on the nodes is bad,
</span><br>
<span class="quotelev1">&gt; the job will abort with an error message, instead of running too slow
</span><br>
<span class="quotelev1">&gt; (if it is using other networks).
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; There are also ways to tell OMPI to do a more verbose output,
</span><br>
<span class="quotelev1">&gt; that may perhaps help diagnose the problem.
</span><br>
...
<span class="quotelev1">&gt; Hopefully that is not the problem you are facing, but verbose output
</span><br>
<span class="quotelev1">&gt; may help anyways.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; export TMPDIR=/work1/home/yanb/tmp
</span><br>
...
<span class="quotelev2">&gt;&gt; Warning: shared-memory, /work1/home/yanb/tmp/
</span><br>
<span class="quotelev2">&gt;&gt; Run, take 10 minutes, slow
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Warning: shared-memory /work3/yanb/605832.SPIRIT/
</span><br>
<span class="quotelev2">&gt;&gt; Run, take 10 minutess, slow
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; So you see, a) openmpi 1.6.5 and 1.7.4 need different settings to run;
</span><br>
<span class="quotelev1">&gt; b) whether specifying TMPDIR, I got the shared memory warning.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; 3. But a few days ago, OpenMPI 1.6.5 worked great and took only 1 minute
</span><br>
<span class="quotelev1">&gt; (now it takes 10 minutes). I am so confused by the results.
</span><br>
<span class="quotelev1">&gt; Does the system loading level or fluctuation or PBS pro affect OpenMPI
</span><br>
...
<span class="quotelev2">&gt;&gt; I presume you have access and are using only some of the /work[1-4]
</span><br>
...
<span class="quotelev2">&gt;&gt; [You could ask the sys admin about this, and perhaps what he recommends to use to replace /tmp.]
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;                          1.2P  136T  1.1P  12% /work1 -bash-4.1$ mount
</span><br>
<span class="quotelev3">&gt;&gt;&gt; devpts on /dev/pts type devpts (rw,gid=5,mode=620) tmpfs on /tmp type
</span><br>
<span class="quotelev3">&gt;&gt;&gt; tmpfs (rw,size=150m) none on /proc/sys/fs/binfmt_misc type binfmt_misc
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; If the default TMPDIR is on Lustre (did you say this?, anyway I don't
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; cpupercent=0,cput=00:00:00,mem=7028kb,ncpus=128,vmem=495768kb,wall
</span><br>
