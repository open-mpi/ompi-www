...
?>
<!-- received="Fri Mar  7 20:40:44 2014" -->
<!-- isoreceived="20140308014044" -->
<!-- sent="Fri, 07 Mar 2014 20:40:42 -0500" -->
<!-- isosent="20140308014042" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI job initializing problem" -->
<!-- id="531A751A.50705_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="D67303F39678724DA65819E042CB369892A81D0B4E_at_EXC2.ad.colorado.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-07 20:40:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23785.php">Saliya Ekanayake: "[OMPI users] SIGSEV when running OMPI Java binding"</a>
<li><strong>Previous message:</strong> <a href="23783.php">Velickovic Nikola: "[OMPI users] Problems with computation-communication overlap in non-blocking mode"</a>
<li><strong>In reply to:</strong> <a href="23782.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23894.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Reply:</strong> <a href="23894.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Well, this machine may have been setup to run only
<br>
Intel MPI (DAPL?) and SGI MPI.
<br>
...
<span class="quotelev1">&gt; Note that one turns off tcp (I think),
</span><br>
<span class="quotelev1">&gt; whereas the other requests a tcp interface (or that the IB interface with IPoIB functionality).
</span><br>
...
<span class="quotelev1">&gt; I would try simply -mca btl sm,openib,self, which is likely to give you the IB transport with verbs, plus shared memory intra-node, plus the
</span><br>
...
<span class="quotelev2">&gt;&gt; (Jeff will cut my list subscription after that one, for spreading misinformation.)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; In this case, if any of the IB HCAs on the nodes is bad,
</span><br>
<span class="quotelev2">&gt;&gt; the job will abort with an error message, instead of running too slow
</span><br>
<span class="quotelev2">&gt;&gt; (if it is using other networks).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; There are also ways to tell OMPI to do a more verbose output,
</span><br>
<span class="quotelev2">&gt;&gt; that may perhaps help diagnose the problem.
</span><br>
...
<span class="quotelev2">&gt;&gt; cluster that had all sorts of non-homogeneous nodes, some with
</span><br>
<span class="quotelev2">&gt;&gt; faulty IB HCAs, some with incomplete OFED installation, some that
</span><br>
<span class="quotelev2">&gt;&gt; were not mounting shared file systems properly, etc.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Warning: shared-memory, /work1/home/yanb/tmp/
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Run, take 10 minutes, slow
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Warning: shared-memory /work3/yanb/605832.SPIRIT/
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Run, take 10 minutess, slow
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So you see, a) openmpi 1.6.5 and 1.7.4 need different settings to run;
</span><br>
<span class="quotelev2">&gt;&gt; b) whether specifying TMPDIR, I got the shared memory warning.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 3. But a few days ago, OpenMPI 1.6.5 worked great and took only 1 minute
</span><br>
<span class="quotelev2">&gt;&gt; (now it takes 10 minutes). I am so confused by the results.
</span><br>
<span class="quotelev2">&gt;&gt; Does the system loading level or fluctuation or PBS pro affect OpenMPI
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [You could ask the sys admin about this, and perhaps what he recommends to use to replace /tmp.]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;                           1.2P  136T  1.1P  12% /work1 -bash-4.1$ mount
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; devpts on /dev/pts type devpts (rw,gid=5,mode=620) tmpfs on /tmp type
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; tmpfs (rw,size=150m) none on /proc/sys/fs/binfmt_misc type binfmt_misc
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; cpupercent=0,cput=00:00:00,mem=7028kb,ncpus=128,vmem=495768kb,wall
</span><br>
