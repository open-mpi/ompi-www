...
?>
<!-- received="Wed Mar 12 10:34:43 2014" -->
<!-- isoreceived="20140312143443" -->
<!-- sent="Wed, 12 Mar 2014 14:34:41 +0000" -->
<!-- isosent="20140312143441" -->
<!-- name="Dave Goodell (dgoodell)" -->
<!-- email="dgoodell_at_[hidden]" -->
<!-- subject="Re: [OMPI users] trying to use personal copy of 1.7.4" -->
<!-- id="CB4B3ECC-9DDB-479D-8FAE-934C7013FA90_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-03-12 10:34:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23823.php">Bennet Fauber: "Re: [OMPI users] trying to use personal copy of 1.7.4"</a>
<li><strong>Previous message:</strong> <a href="23821.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Cannot run a job with more than 3 nodes"</a>
<li><strong>In reply to:</strong> <a href="23818.php">Jeff Squyres (jsquyres): "Re: [OMPI users] trying to use personal copy of 1.7.4"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23823.php">Bennet Fauber: "Re: [OMPI users] trying to use personal copy of 1.7.4"</a>
<li><strong>Reply:</strong> <a href="23823.php">Bennet Fauber: "Re: [OMPI users] trying to use personal copy of 1.7.4"</a>
<li><strong>Reply:</strong> <a href="23826.php">Ross Boylan: "Re: [OMPI users] trying to use personal copy of 1.7.4"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;--&gt; library ---&gt; ~ross/OMPI
<br>
<p><p>If one of them was first linked against the /usr/OMPI and managed to get an RPATH then it could override your LD_LIBRARY_PATH.
<br>
<p>-Dave
<br>
<p>On Mar 12, 2014, at 5:39 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
<br>
