...
?>
<!-- received="Fri Mar 21 00:00:27 2014" -->
<!-- isoreceived="20140321040027" -->
<!-- sent="Thu, 20 Mar 2014 22:00:40 -0600" -->
<!-- isosent="20140321040040" -->
<!-- name="Beichuan Yan" -->
<!-- email="beichuan.yan_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI job initializing problem" -->
<!-- id="D67303F39678724DA65819E042CB369892A84D83CA_at_EXC2.ad.colorado.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="532B58CC.4010206_at_ldeo.columbia.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-21 00:00:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23909.php">madhurima madhunapanthula: "[OMPI users] Segmentation Fault"</a>
<li><strong>Previous message:</strong> <a href="23907.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>In reply to:</strong> <a href="23903.php">Gus Correa: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23914.php">Ralph Castain: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Reply:</strong> <a href="23914.php">Ralph Castain: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>communication overhead = commuT + migraT + print, compuT is computational cost, totalT = compuT + communication overhead, overhead% denotes percentage of communication overhead
<br>
...
Subject: Re: [OMPI users] OpenMPI job initializing problem
<br>
<p>On 03/20/2014 04:48 PM, Beichuan Yan wrote:
<br>
<span class="quotelev1">&gt; Ralph and Noam,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Thanks for the clarifications, they are important.
</span><br>
I could be wrong in understanding the filesystem.
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Spirit appears to use a scratch directory for
</span><br>
shared memory backing which is mounted on Lustre, and does not seem to have local directories or does not allow user to change TEMPDIR. Here is the info:
<br>
<span class="quotelev1">&gt; [compute node]$ stat -f -L -c %T /tmp
</span><br>
<span class="quotelev1">&gt; tmpfs
</span><br>
<span class="quotelev1">&gt; [compute node]$ stat -f -L -c %T /home/yanb/scratch lustre
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p>So, /tmp is a tmpfs, in memory/RAM.
<br>
Maybe they don't open writing permissions for regular users on /tmp?
<br>
<p><span class="quotelev1">&gt; On another university supercomputer, I found the following:
</span><br>
<span class="quotelev1">&gt; node0448[~]$ stat -f -L -c %T /tmp
</span><br>
<span class="quotelev1">&gt; ramfs
</span><br>
<span class="quotelev1">&gt; node0448[~]$ stat -f -L -c %T /home/yanb/scratch/ lustre Is this /tmp
</span><br>
<span class="quotelev1">&gt; at compute node a local directory? I don't know how to tell it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Sent: Thursday, March 20, 2014 12:13
</span><br>
...
<span class="quotelev1">&gt; We don't enforce anything, but /tmp being network mounted is a VERY
</span><br>
<span class="quotelev1">&gt; unusual situation in the cluster world, and highly unrecommended
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;   Both 1.6.x and 1.7.x/1.8.x will need verbs.h to use the native
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; verbs  network stack.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;   You can use emulated TCP over IB (e.g., using the OMPI TCP BTL),
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; but  it's nowhere near as fast/efficient the native verbs network stack.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; In this case, if any of the IB HCAs on the nodes is bad, the job
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; will abort with an error message, instead of running too slow (if
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; it is using other networks).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; cluster that had all sorts of non-homogeneous nodes, some with
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; faulty IB HCAs, some with incomplete OFED installation, some that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; were not mounting shared file systems properly, etc.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [I didn't administer that one!]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hopefully that is not the problem you are facing, but verbose
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; output may help anyways.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; export TMPDIR=/work1/home/yanb/tmp TCP=&quot;--mca btl_tcp_if_include
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 10.148.0.0/16&quot;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Warning: shared-memory, /work1/home/yanb/tmp/ Run, take 10
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; minutes, slow
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I presume you have access and are using only some of the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /work[1-4]
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Jeff Squyres (jsquyres)
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; #export TMPDIR=/home/yanb/tmp TCP=&quot;--mca btl_tcp_if_include
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; cpupercent=0,cput=00:00:00,mem=7028kb,ncpus=128,vmem=495768kb
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ,
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 1. The job fails for no apparent reason (like above), or 2.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The job complains that your TMPDIR is on a shared filesystem
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
