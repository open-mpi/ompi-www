...
?>
<!-- received="Mon Mar 24 11:34:35 2014" -->
<!-- isoreceived="20140324153435" -->
<!-- sent="Mon, 24 Mar 2014 15:34:32 +0000" -->
<!-- isosent="20140324153432" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fwd: problem for multiple clusters using mpirun" -->
<!-- id="B2886AAE-AF95-4302-8F76-617E43DF7922_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAADBNWzBtwMHnUW6PxfFgrZqTZcKsH2VYJF0OwieT710xVxsfA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-24 11:34:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23948.php">Jeff Squyres (jsquyres): "Re: [OMPI users] usNIC point-to-point messaging module"</a>
<li><strong>Previous message:</strong> <a href="23946.php">Ralph Castain: "Re: [OMPI users] cleanup of round robin mappers"</a>
<li><strong>In reply to:</strong> <a href="23943.php">Hamid Saeed: "Re: [OMPI users] Fwd: problem for multiple clusters using mpirun"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23949.php">Hamid Saeed: "Re: [OMPI users] Fwd: problem for multiple clusters using mpirun"</a>
<li><strong>Reply:</strong> <a href="23949.php">Hamid Saeed: "Re: [OMPI users] Fwd: problem for multiple clusters using mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Try using btl_tcp_if_include and list just the interface(s) that you want to use.  From your prior email, I'm *guessing* it's just br2 (i.e., the 10.x address inside your cluster).
<br>
<p>Also, it looks like you didn't setup your SSH keys properly for logging in to remote notes automatically.
<br>
<p><p><p>On Mar 24, 2014, at 10:56 AM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt; wrote:
<br>
