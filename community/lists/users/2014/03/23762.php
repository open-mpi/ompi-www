...
?>
<!-- received="Mon Mar  3 20:22:32 2014" -->
<!-- isoreceived="20140304012232" -->
<!-- sent="Mon, 03 Mar 2014 20:22:31 -0500" -->
<!-- isosent="20140304012231" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI job initializing problem" -->
<!-- id="53152AD7.2010103_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="D67303F39678724DA65819E042CB369892A81D08C1_at_EXC2.ad.colorado.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-03-03 20:22:31
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23763.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Previous message:</strong> <a href="23761.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>In reply to:</strong> <a href="23761.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23763.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<li><strong>Reply:</strong> <a href="23763.php">Beichuan Yan: "Re: [OMPI users] OpenMPI job initializing problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>The file systems prefixed with IP addresses (work[1-4]) and
<br>
with panfs (cwfs and CWFS[1-6]) and a colon (:)
<br>
are shared exports (not local), but not necessarily NFS (panfs may be 
<br>
Panasas?).
<br>
...
<br>
<p>Anyway, you may need to ask the help of a system administrator of this 
<br>
machine.
<br>
<p>Gus Correa
...
<span class="quotelev4">&gt;&gt;&gt;&gt; cpupercent=0,cput=00:00:00,mem=7028kb,ncpus=128,vmem=495768kb,wallti
</span><br>
