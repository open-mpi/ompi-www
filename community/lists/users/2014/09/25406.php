...
?>
<!-- received="Mon Sep 29 14:48:54 2014" -->
<!-- isoreceived="20140929184854" -->
<!-- sent="Mon, 29 Sep 2014 18:48:52 +0000" -->
<!-- isosent="20140929184852" -->
<!-- name="Dave Goodell (dgoodell)" -->
<!-- email="dgoodell_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI 1.8.2 segfaults while 1.6.5 works?" -->
<!-- id="78C26435-E299-4286-A928-2936271BC1A9_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="912A3568-BA81-489F-956D-382D7EBDCE55_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-09-29 14:48:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25407.php">Amos Anderson: "Re: [OMPI users] OpenMPI 1.8.2 segfaults while 1.6.5 works?"</a>
<li><strong>Previous message:</strong> <a href="25405.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.8.2 segfaults while 1.6.5 works?"</a>
<li><strong>In reply to:</strong> <a href="25405.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.8.2 segfaults while 1.6.5 works?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25407.php">Amos Anderson: "Re: [OMPI users] OpenMPI 1.8.2 segfaults while 1.6.5 works?"</a>
<li><strong>Reply:</strong> <a href="25407.php">Amos Anderson: "Re: [OMPI users] OpenMPI 1.8.2 segfaults while 1.6.5 works?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>-Dave
<br>
<p>On Sep 29, 2014, at 1:34 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Afraid I cannot replicate a problem with singleton behavior in the 1.8 series:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 11:31:52  /home/common/openmpi/v1.8/orte/test/mpi$ ./hello foo bar
</span><br>
<span class="quotelev1">&gt; Hello, World, I am 0 of 1 [0 local peers]: get_cpubind: 0 bitmap 0-23
</span><br>
<span class="quotelev1">&gt; OMPI_MCA_orte_default_hostfile=/home/common/hosts
</span><br>
<span class="quotelev1">&gt; OMPI_COMMAND=./hello
</span><br>
<span class="quotelev1">&gt; OMPI_ARGV=foo bar
</span><br>
<span class="quotelev1">&gt; OMPI_NUM_APP_CTX=1
</span><br>
<span class="quotelev1">&gt; OMPI_FIRST_RANKS=0
</span><br>
<span class="quotelev1">&gt; OMPI_APP_CTX_NUM_PROCS=1
</span><br>
<span class="quotelev1">&gt; OMPI_MCA_orte_ess_num_procs=1
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; You can see that the OMPI_ARGV envar (which is the spot you flagged) is correctly being set and there is no segfault. Not sure what your program may be doing, though, so I'm not sure I've really tested your scenario.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Sep 29, 2014, at 10:55 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Okay, so regression-test.py is calling MPI_Init as a singleton, correct? Just trying to fully understand the scenario
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Singletons are certainly allowed, if that's the scenario
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Sep 29, 2014, at 10:51 AM, Amos Anderson &lt;amos.anderson_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm not calling mpirun in this case because this particular calculation doesn't use more than one processor. What I'm doing on my command line is this:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /home/user/myapp/tools/python/bin/python test/regression/regression-test.py test/regression/regression-jobs
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and internally I check for rank/size. This command is executed in the context of a souped up LD_LIBRARY_PATH. You can see the variable argv in opal_argv_join is ending up with the last argument on my command line.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I suppose your question implies that mpirun is mandatory for executing anything compiled with OpenMPI &gt; 1.6 ?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; On Sep 29, 2014, at 10:28 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Can you pass us the actual mpirun command line being executed? Especially need to see the argv being passed to your application.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sep 27, 2014, at 7:09 PM, Amos Anderson &lt;amos.anderson_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; FWIW, I've confirmed that the segfault also happens with OpenMPI 1.7.5. Also, I have some gdb output (from 1.7.5) for your perusal, including a printout of some of the variables' values.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25401.php">http://www.open-mpi.org/community/lists/users/2014/09/25401.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25403.php">http://www.open-mpi.org/community/lists/users/2014/09/25403.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25405.php">http://www.open-mpi.org/community/lists/users/2014/09/25405.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
