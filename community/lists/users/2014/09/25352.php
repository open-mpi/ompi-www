...
?>
<!-- received="Thu Sep 18 09:34:09 2014" -->
<!-- isoreceived="20140918133409" -->
<!-- sent="Thu, 18 Sep 2014 13:34:07 +0000" -->
<!-- isosent="20140918133407" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Mpirun 1.5.4 problems when request	&amp;gt;	28	slots	(updated findings)" -->
<!-- id="51094EA8-05C4-4643-9D9F-A7FAB78A9637_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="1BAD6351-2EB8-4F96-A4F5-8A7126E09597_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-09-18 09:34:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25353.php">McGrattan, Kevin B. Dr.: "Re: [OMPI users] How does binding option affect network traffic?"</a>
<li><strong>Previous message:</strong> <a href="25351.php">Jeff Squyres (jsquyres): "Re: [OMPI users] How does binding option affect network traffic?"</a>
<li><strong>In reply to:</strong> <a href="25231.php">Ralph Castain: "Re: [OMPI users] Mpirun 1.5.4 problems when request &gt;	28	slots	(updated findings)"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Lane --
<br>
<p>Can you confirm that adding numactl-devel and using --hetero-nodes fixed your problem?
<br>
<p><p><p>On Sep 2, 2014, at 5:08 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; On Sep 2, 2014, at 1:49 PM, Lane, William &lt;William.Lane_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; These latest issues (since 8/28/14) all occurred after we upgraded our cluster
</span><br>
<span class="quotelev2">&gt;&gt; to OpenMPI 1.8.2 on . Maybe I should've created a new thread rather
</span><br>
<span class="quotelev2">&gt;&gt; than tacking on these issues to my existing thread.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Sent: Tuesday, September 02, 2014 11:03 AM
</span><br>
...
<span class="quotelev2">&gt;&gt; On Sep 2, 2014, at 10:48 AM, Lane, William &lt;William.Lane_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; There are at least three different permutations of CPU configurations in the cluster
</span><br>
<span class="quotelev3">&gt;&gt;&gt; involved. Some are blades that have two sockets with two cores per Intel CPU (and not all
</span><br>
<span class="quotelev3">&gt;&gt;&gt; sockets are filled). Some are IBM x3550 systems having two sockets with three cores
</span><br>
<span class="quotelev3">&gt;&gt;&gt; per Intel CPU (and not all sockets are populated). All nodes have hyperthreading turned
</span><br>
<span class="quotelev3">&gt;&gt;&gt; on as well.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I will look into getting the numactl-devel package installed.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I will try the --bind-to none switch again. For some reason the --hetero-nodes switch wasn't
</span><br>
<span class="quotelev3">&gt;&gt;&gt; recognized by mpirun. Is the --hetero-nodes swtich an MCA parameter?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; My bad - I forgot that you are using a very old OMPI version. I think you'll need to upgrade, though, as I don't believe something that old will know how to handle such a hybrid system. I suspect this may be at the bottom of the problem you are seeing.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; You'll really need to get up to the 1.8 series, I'm afraid - I'm not sure even 1.6 can handle this setup.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; Sent: Saturday, August 30, 2014 7:15 AM
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; hwloc requires the numactl-devel package in addition to the numactl one
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If I understand the email thread correctly, it sounds like you have at least some nodes in your system that have fewer cores than others - is that correct?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Here are the definitions of the two parallel environments tested (with orte always failing when
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; If that is the situation, then you need to add --hetero-nodes to your cmd line so we look at the actual topology of every node. Otherwise, for scalability reasons, we only look at the first node in the allocation and assume all nodes are the same.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If that isn't the case, then it sounds like we are seeing fewer cores than exist on the system for some reason. You could try installing hwloc independently, and then running &quot;lstopo&quot; to find out what it detects. Another thing you could do is add &quot;-mca plm_base_verbose 100&quot; to your cmd line (I suggest doing that with just a couple of nodes in your allocation) and that will dump the detected topology to stderr.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm surprised the bind-to none option didn't remove the error - it definitely should as we won't be binding when that is given. However, I note that you misspelled it in your reply, so maybe you just didn't type it correctly? It is &quot;--bind-to none&quot; - note the space between the &quot;to&quot; and the &quot;none&quot;. You'll take a performance hit, but it should at least run.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; On Aug 29, 2014, at 11:29 PM, Lane, William &lt;William.Lane_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The --bind-to-none switch didn't help, I'm still getting the same errors.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The only NUMA package installed on the nodes in this CentOS 6.2 cluster is the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; following:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; numactl-2.0.7-3.el6.x86_64
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; this package is described as: numactl.x86_64 : Library for tuning for Non Uniform Memory Access machines
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Since many of these systems are NUMA systems (with separate memory address spaces
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; for the sockets) could it be that the correct NUMA libraries aren't installed?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Here are some of the other NUMA packages available for CentOS 6.x:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; From: users [users-bounces_at_[hidden]] on behalf of Reuti [reuti_at_[hidden]]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Sent: Thursday, August 28, 2014 3:27 AM
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; To: Open MPI Users
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Subject: Re: [OMPI users] Mpirun 1.5.4 problems when request &gt; 28 slots (updated findings)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Am 28.08.2014 um 10:09 schrieb Lane, William:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I have some updates on these issues and some test results as well.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Does &quot;-bind-to none&quot; help? The binding is switched on by default in Open MPI 1.8 onwards.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; The btl tcp,self switch passed to mpirun made significant differences in performance as per the below:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Whether you prefer $fill_up or $round_robin is up to you - do you prefer all your processes on the least amount of machines or spread around in the cluster. If there is much communication maybe it's better on less machines, but if each process has heavy I/O to the local scratch disk spreading it around may be the preferred choice. This doesn't make any difference to Open MPI, as the generated $PE_HOSTFILE contains just the list of granted slots. Doing it in an $fill_up style will of course fill the first node including the hyperthreading ones before moving to the next machine (`man sge_pe`).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I apologize for the length of this, but I thought it best to provide more
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25179.php">http://www.open-mpi.org/community/lists/users/2014/08/25179.php</a>
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25202.php">http://www.open-mpi.org/community/lists/users/2014/08/25202.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25203.php">http://www.open-mpi.org/community/lists/users/2014/08/25203.php</a>
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25224.php">http://www.open-mpi.org/community/lists/users/2014/09/25224.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25226.php">http://www.open-mpi.org/community/lists/users/2014/09/25226.php</a>
</span><br>
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25229.php">http://www.open-mpi.org/community/lists/users/2014/09/25229.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25231.php">http://www.open-mpi.org/community/lists/users/2014/09/25231.php</a>
</span><br>
<p><p><pre>
-- 
Jeff Squyres
