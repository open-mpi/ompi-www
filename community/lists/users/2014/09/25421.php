...
?>
<!-- received="Tue Sep 30 14:19:22 2014" -->
<!-- isoreceived="20140930181922" -->
<!-- sent="Tue, 30 Sep 2014 11:19:15 -0700" -->
<!-- isosent="20140930181915" -->
<!-- name="Lee-Ping Wang" -->
<!-- email="leeping_at_[hidden]" -->
<!-- subject="Re: [OMPI users] General question about running single-node jobs." -->
<!-- id="EAE94B15-B005-4F75-96D5-8CC99A83A14D_at_stanford.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="1B1B345B-5E45-4611-BD2A-F06CCDA58A59_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-09-30 14:19:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25422.php">Ralph Castain: "Re: [OMPI users] General question about running single-node jobs."</a>
<li><strong>Previous message:</strong> <a href="25420.php">Ralph Castain: "Re: [OMPI users] General question about running single-node jobs."</a>
<li><strong>In reply to:</strong> <a href="25420.php">Ralph Castain: "Re: [OMPI users] General question about running single-node jobs."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25422.php">Ralph Castain: "Re: [OMPI users] General question about running single-node jobs."</a>
<li><strong>Reply:</strong> <a href="25422.php">Ralph Castain: "Re: [OMPI users] General question about running single-node jobs."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p><span class="quotelev2">&gt;&gt;  If so, then I should be able to (1) locate where the port number is defined in the code, and (2) randomize the port number every time it's called to work around the issue.  What do you think?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; That might work, depending on the code. I'm not sure what it is trying to connect to, and if that code knows how to handle arbitrary connections
</span><br>
<p><p>The main reason why Q-Chem is using MPI is for executing parallel tasks on a single node.  Thus, I think it's just the MPI ranks attempting to connect with each other on the same machine.  This could be off the mark because I'm still a novice with respect to MPI concepts - but I am sure it is just one machine.
<br>
<p><span class="quotelev1">&gt; You might check about those warnings - could be that QCLOCALSCR and QCREF need to be set for the code to work.
</span><br>
...
<span class="quotelev1">&gt; On Sep 30, 2014, at 10:49 AM, Lee-Ping Wang &lt;leeping_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Thank you.  I think your diagnosis is probably correct.  Are these sockets the same as TCP/UDP ports (though different numbers) that are used in web servers, email etc?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;  If so, then I should be able to (1) locate where the port number is defined in the code, and (2) randomize the port number every time it's called to work around the issue.  What do you think?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; That might work, depending on the code. I'm not sure what it is trying to connect to, and if that code knows how to handle arbitrary connections
...
<span class="quotelev1">&gt; You might check about those warnings - could be that QCLOCALSCR and QCREF need to be set for the code to work.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; On Sep 29, 2014, at 8:45 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Sep 29, 2014, at 5:49 PM, Lee-Ping Wang &lt;leeping_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Here's another data point that might be useful: The error message is much more rare if I run my application on 4 cores instead of 8.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sep 29, 2014, at 5:38 PM, Lee-Ping Wang &lt;leeping_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Sorry for my last email - I think I spoke too quick.  I realized after reading some more documentation that OpenMPI always uses TCP sockets for out-of-band communication, so it doesn't make sense for me to set OMPI_MCA_oob=^tcp.  That said, I am still running into a strange problem in my application when running on a specific machine (Blue Waters compute node); I don't see this problem on any other nodes.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25412.php">http://www.open-mpi.org/community/lists/users/2014/09/25412.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25413.php">http://www.open-mpi.org/community/lists/users/2014/09/25413.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25419.php">http://www.open-mpi.org/community/lists/users/2014/09/25419.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25420.php">http://www.open-mpi.org/community/lists/users/2014/09/25420.php</a>
</span><br>
<p><p><p>
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25421/attachment">attachment</a>
</ul>
