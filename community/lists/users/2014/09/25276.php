...
?>
<!-- received="Thu Sep  4 18:04:55 2014" -->
<!-- isoreceived="20140904220455" -->
<!-- sent="Fri, 5 Sep 2014 01:04:54 +0300" -->
<!-- isosent="20140904220454" -->
<!-- name="Elio Physics" -->
<!-- email="elio-physics_at_[hidden]" -->
<!-- subject="Re: [OMPI users] compilation problem with ifort" -->
<!-- id="BLU179-W42AAA9D20B611E53EB8FAAEAC50_at_phx.gbl" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2014-09-04 18:04:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25277.php">Gus Correa: "Re: [OMPI users] compilation problem with ifort"</a>
<li><strong>Previous message:</strong> <a href="25275.php">Matt Thompson: "Re: [OMPI users] Issues with OpenMPI 1.8.2, GCC 4.9.1, and SLURM Interactive Jobs"</a>
<li><strong>In reply to:</strong> <a href="25274.php">Elio Physics: "Re: [OMPI users] compilation problem with ifort"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25277.php">Gus Correa: "Re: [OMPI users] compilation problem with ifort"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Something else I have realized. Within the make.sys file of espresso-4.0.3, I have got:
<br>
IFLAGS         = -I../includeMODFLAGS       = -I./  -I../Modules  -I../iotk/src \                 -I../PW  -I../PH
<br>
...
Elie
<br>
<p>From: elio-physics_at_[hidden]
<br>
To: users_at_[hidden]
<br>
...
Subject: Re: [OMPI users] compilation problem with ifort
<br>
<p><p>Firstly I really need to thank you for the effort you are doing to help me and write all these e-mails and in details explaining every step.Secondly, I did all what you wrote; the EPW is indeed inside the QE espresso but I still get the same annoying error. I actually deleted all the tar files and the files themselves and started afresh...
<br>
...
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/09/25274.php">http://www.open-mpi.org/community/lists/users/2014/09/25274.php</a> 		 	   		  
<br>
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25276/attachment">attachment</a>
</ul>
