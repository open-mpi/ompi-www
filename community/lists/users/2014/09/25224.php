...
?>
<!-- received="Tue Sep  2 13:48:24 2014" -->
<!-- isoreceived="20140902174824" -->
<!-- sent="Tue, 2 Sep 2014 17:48:22 +0000" -->
<!-- isosent="20140902174822" -->
<!-- name="Lane, William" -->
<!-- email="William.Lane_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Mpirun 1.5.4 problems when request &amp;gt; 28	slots	(updated findings)" -->
<!-- id="434F2BB0AF80484CA04DE0D8C0738BF293E2F467_at_cshsmsgmbx02.CSMC.EDU" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="E094D1A5-AAF2-42FC-839B-22DB39E93D0F_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-09-02 13:48:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25225.php">Ralph Castain: "Re: [OMPI users] problems and bus error with openmpi-1.9a1r32657"</a>
<li><strong>Previous message:</strong> <a href="25223.php">Ralph Castain: "Re: [OMPI users] problems and bus error with openmpi-1.9a1r32657"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/08/25203.php">Ralph Castain: "Re: [OMPI users] Mpirun 1.5.4 problems when request &gt; 28 slots	(updated findings)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25226.php">Ralph Castain: "Re: [OMPI users] Mpirun 1.5.4 problems when request &gt; 28	slots	(updated findings)"</a>
<li><strong>Reply:</strong> <a href="25226.php">Ralph Castain: "Re: [OMPI users] Mpirun 1.5.4 problems when request &gt; 28	slots	(updated findings)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>There are at least three different permutations of CPU configurations in the cluster
<br>
involved. Some are blades that have two sockets with two cores per Intel CPU (and not all
<br>
sockets are filled). Some are IBM x3550 systems having two sockets with three cores
<br>
per Intel CPU (and not all sockets are populated). All nodes have hyperthreading turned
<br>
on as well.
<br>
<p>I will look into getting the numactl-devel package installed.
<br>
<p>I will try the --bind-to none switch again. For some reason the --hetero-nodes switch wasn't
<br>
...
Subject: Re: [OMPI users] Mpirun 1.5.4 problems when request &gt; 28       slots   (updated findings)
<br>
<p>hwloc requires the numactl-devel package in addition to the numactl one
<br>
...
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25203.php">http://www.open-mpi.org/community/lists/users/2014/08/25203.php</a>
<br>
