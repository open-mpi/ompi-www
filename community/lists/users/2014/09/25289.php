...
?>
<!-- received="Sat Sep  6 11:32:39 2014" -->
<!-- isoreceived="20140906153239" -->
<!-- sent="Sat, 6 Sep 2014 18:32:38 +0300" -->
<!-- isosent="20140906153238" -->
<!-- name="Elio Physics" -->
<!-- email="elio-physics_at_[hidden]" -->
<!-- subject="Re: [OMPI users] compilation problem with ifort" -->
<!-- id="BLU179-W29F14E3F2CB30DE39653CDEAC30_at_phx.gbl" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2014-09-06 11:32:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25290.php">Ralph Castain: "Re: [OMPI users] new overcommitment warning?"</a>
<li><strong>Previous message:</strong> <a href="25288.php">Allin Cottrell: "Re: [OMPI users] new overcommitment warning?"</a>
<li><strong>In reply to:</strong> <a href="25271.php">Gus Correa: "Re: [OMPI users] compilation problem with ifort"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25293.php">Gustavo Correa: "Re: [OMPI users] compilation problem with ifort"</a>
<li><strong>Reply:</strong> <a href="25293.php">Gustavo Correa: "Re: [OMPI users] compilation problem with ifort"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello Gus,
<br>
Thanks once again for your help and guidance. I just want to let you know that I was able to resolve the problem; I actually changed the locations of the libraries before configuring; for example I set:
<br>
BLAS_LIBS      =   -lmkl_intel_lp64  -lmkl_sequential -lmkl_coreLAPACK_LIBS    = /opt/intel/Compiler/11.1/069/mkl/lib/em64t/libmkl_lapack95_lp64.aFFT_LIBS=-L/opt/scilibs/FFTW/fftw-3.2.1_Bull.9005/lib -lfftw3
<br>
and also to link espresso libs with the plugins, i added the following line:
<br>
TOPDIR=/home_cluster/fis718/...../espresso-4.0.3/
<br>
The compilation went with no errors and epw.x was produced.. Once again, thanks for your support and help.
<br>
Regards
<br>
ELIO MOUJAES
<br>
<p><p><p><span class="quotelev1">&gt; Date: Thu, 4 Sep 2014 12:48:44 -0400
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25289/attachment">attachment</a>
</ul>
