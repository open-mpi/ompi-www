<?
$subject_val = "[OMPI users] SIGSEGV with Java, openmpi-1.8.2, and Sun C and gcc-4.9.0";
include("../../include/msg-header.inc");
?>
<!-- received="Tue Sep  2 07:22:18 2014" -->
<!-- isoreceived="20140902112218" -->
<!-- sent="Tue, 2 Sep 2014 13:21:57 +0200 (CEST)" -->
<!-- isosent="20140902112157" -->
<!-- name="Siegmar Gross" -->
<!-- email="Siegmar.Gross_at_[hidden]" -->
<!-- subject="[OMPI users] SIGSEGV with Java, openmpi-1.8.2, and Sun C and gcc-4.9.0" -->
<!-- id="201409021121.s82BLvUg028469_at_tyr.informatik.hs-fulda.de" -->
<!-- charset="us-ascii" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] SIGSEGV with Java, openmpi-1.8.2, and Sun C and gcc-4.9.0<br>
<strong>From:</strong> Siegmar Gross (<em>Siegmar.Gross_at_[hidden]</em>)<br>
<strong>Date:</strong> 2014-09-02 07:21:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25215.php">Siegmar Gross: "Re: [OMPI users] bus error with openmpi-1.8.2 and gcc-4.9.0"</a>
<li><strong>Previous message:</strong> <a href="25213.php">Siegmar Gross: "[OMPI users] bus error with openmpi-1.8.2 and gcc-4.9.0"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25222.php">Ralph Castain: "Re: [OMPI users] SIGSEGV with Java, openmpi-1.8.2, and Sun C and gcc-4.9.0"</a>
<li><strong>Reply:</strong> <a href="25222.php">Ralph Castain: "Re: [OMPI users] SIGSEGV with Java, openmpi-1.8.2, and Sun C and gcc-4.9.0"</a>
<li><strong>Maybe reply:</strong> <a href="25237.php">Siegmar Gross: "Re: [OMPI users] SIGSEGV with Java, openmpi-1.8.2, and Sun C and gcc-4.9.0"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>tyr java 172 where mpijavac
<br>
...
--------------------------------------------------------------------------
<br>
mpiexec noticed that process rank 0 with PID 28334 on node tyr exited on signal 6 (Abort).
<br>
--------------------------------------------------------------------------
<br>
tyr java 175 
<br>
<p><p><p>gbd shows the following backtrace for SunC 5.12.
<br>
<p>tyr java 175 /usr/local/gdb-7.6.1_64_gcc/bin/gdb /usr/local/openmpi-1.8.2_64_cc/bin/mpiexec 
<br>
GNU gdb (GDB) 7.6.1
<br>
...
<br>
Reading symbols from /export2/prog/SunOS_sparc/openmpi-1.8.2_64_cc/bin/orterun...done.
<br>
(gdb) run -np 1 java InitFinalizeMain 
<br>
Starting program: /usr/local/openmpi-1.8.2_64_cc/bin/mpiexec -np 1 java InitFinalizeMain
<br>
...
--------------------------------------------------------------------------
<br>
mpiexec noticed that process rank 0 with PID 28353 on node tyr exited on signal 6 (Abort).
<br>
--------------------------------------------------------------------------
<br>
[LWP    2         exited]
...
<br>
#12 0xffffffff7e91e61c in mca_base_component_repository_release (component=0x10ff)
<br>
&nbsp;&nbsp;&nbsp;&nbsp;at ../../../../openmpi-1.8.2/opal/mca/base/mca_base_component_repository.c:244
<br>
#13 0xffffffff7e924c78 in mca_base_component_unload (component=0xffffff7f73c63800, 
<br>
&nbsp;&nbsp;&nbsp;&nbsp;output_id=67583)
<br>
&nbsp;&nbsp;&nbsp;&nbsp;at ../../../../openmpi-1.8.2/opal/mca/base/mca_base_components_close.c:47
<br>
#14 0xffffffff7e924d1c in mca_base_component_close (component=0xffffff0000000100, 
<br>
&nbsp;&nbsp;&nbsp;&nbsp;output_id=268480767)
<br>
...
<br>
#18 0xffffffff7e954ac0 in mca_base_framework_close (framework=0xffffff0000004b00)
<br>
...
(gdb) 
<br>
<p><p><p><p><p>gbd shows the following backtrace for gcc-4.9.0.
<br>
<p>tyr java 108 mpijavac InitFinalizeMain.java
<br>
tyr java 109 /usr/local/gdb-7.6.1_64_gcc/bin/gdb /usr/local/openmpi-1.8.2_64_gcc/bin/mpiexec 
<br>
GNU gdb (GDB) 7.6.1
<br>
Copyright (C) 2013 Free Software Foundation, Inc.
...
--------------------------------------------------------------------------
<br>
mpiexec noticed that process rank 0 with PID 28454 on node tyr exited on signal 6 (Abort).
<br>
--------------------------------------------------------------------------
<br>
[LWP    2         exited]
