<?
$subject_val = "[OMPI users] bus error in openmpi-1.9a1r32669 on Solaris 10 Sparc";
include("../../include/msg-header.inc");
?>
<!-- received="Fri Sep  5 08:09:47 2014" -->
<!-- isoreceived="20140905120947" -->
<!-- sent="Fri, 5 Sep 2014 14:09:27 +0200 (CEST)" -->
<!-- isosent="20140905120927" -->
<!-- name="Siegmar Gross" -->
<!-- email="Siegmar.Gross_at_[hidden]" -->
<!-- subject="[OMPI users] bus error in openmpi-1.9a1r32669 on Solaris 10 Sparc" -->
<!-- id="201409051209.s85C9RI1009159_at_tyr.informatik.hs-fulda.de" -->
<!-- charset="us-ascii" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] bus error in openmpi-1.9a1r32669 on Solaris 10 Sparc<br>
<strong>From:</strong> Siegmar Gross (<em>Siegmar.Gross_at_[hidden]</em>)<br>
<strong>Date:</strong> 2014-09-05 08:09:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25279.php">Siegmar Gross: "[OMPI users] segmentation fault for Java in openmpi-1.9a1r32669 on Solaris 10 Sparc"</a>
<li><strong>Previous message:</strong> <a href="25277.php">Gus Correa: "Re: [OMPI users] compilation problem with ifort"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>I get the following bus error for my Sun C version on Solaris Sparc.
<br>
<p>tyr small_prog 125 ompi_info | grep -e MPI: -e &quot;C compiler:&quot;
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Open MPI: 1.9a1r32669
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;C compiler: cc
<br>
tyr small_prog 126 mpicc init_finalize.c 
<br>
tyr small_prog 127 /usr/local/gdb-7.6.1_64_gcc/bin/gdb /usr/local/openmpi-1.9_64_cc/bin/mpiexec
<br>
GNU gdb (GDB) 7.6.1
<br>
...
[New LWP    2        ]
<br>
[tyr:08976] *** Process received signal ***
<br>
[tyr:08976] Signal: Bus Error (10)
<br>
[tyr:08976] Signal code: Invalid address alignment (1)
<br>
[tyr:08976] Failing at address: ffffffff7fffd70c
<br>
/export2/prog/SunOS_sparc/openmpi-1.9_64_cc/lib64/libopen-pal.so.0.0.0:opal_backtrace_print+0x1c
<br>
/export2/prog/SunOS_sparc/openmpi-1.9_64_cc/lib64/libopen-pal.so.0.0.0:0x1a4a58
<br>
...
<br>
[tyr:08976] *** End of error message ***
<br>
--------------------------------------------------------------------------
<br>
