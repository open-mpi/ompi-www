...
?>
<!-- received="Sat Nov 29 08:49:32 2014" -->
<!-- isoreceived="20141129134932" -->
<!-- sent="Sat, 29 Nov 2014 14:49:32 +0100" -->
<!-- isosent="20141129134932" -->
<!-- name="Emmanuel Thom&#195;&#169;" -->
<!-- email="emmanuel.thome_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mmaped memory and openib btl." -->
<!-- id="CAPLAFj7sDjYaRvidyTHRWnhuEJU7hJfQ+f5KgkmFQ6HGitohrQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAPLAFj6a_vrObRPWq+-VXFPu46=D5hLVsd=c7vK8siD3KPtXQg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-29 08:49:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/12/25892.php">Siegmar Gross: "[OMPI users] error building openmpi-v1.8.3-202-gb568b6e with Solaris Studio 12.4"</a>
<li><strong>Previous message:</strong> <a href="25890.php">Siegmar Gross: "[OMPI users] error building openmpi-dev-373-gdee243c with Solaris Studio 12.4"</a>
<li><strong>In reply to:</strong> <a href="25805.php">Emmanuel Thom&#195;&#169;: "Re: [OMPI users] mmaped memory and openib btl."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/12/25904.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mmaped memory and openib btl."</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/12/25904.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mmaped memory and openib btl."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>I am still affected by the bug which I reported in the thread below
<br>
...
tests I'm running.
<br>
<p>The explanation I have is that since the compilation command line
<br>
...
<br>
<p>Does this situation make any sense ?
<br>
<p>Regards,
<br>
<p>E.
<br>
<p><p><p>On Thu, Nov 13, 2014 at 7:09 PM, Emmanuel Thom&#195;&#169;
<br>
...
<span class="quotelev1">&gt; It turns out that the DT_NEEDED libs for my a.out are:
</span><br>
<span class="quotelev1">&gt; Dynamic Section:
</span><br>
<span class="quotelev1">&gt;   NEEDED               libmpi.so.1
</span><br>
<span class="quotelev1">&gt;   NEEDED               libpthread.so.0
</span><br>
<span class="quotelev1">&gt;   NEEDED               libc.so.6
</span><br>
<span class="quotelev1">&gt; which is absolutely consistent with the link command line:
</span><br>
<span class="quotelev1">&gt; catrel-44 ~ $ mpicc -W -Wall -std=c99 -O0 -g prog6.c -show
</span><br>
<span class="quotelev1">&gt; gcc -W -Wall -std=c99 -O0 -g prog6.c -pthread -Wl,-rpath -Wl,/usr/lib
</span><br>
<span class="quotelev1">&gt; -Wl,--enable-new-dtags -lmpi
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; As a consequence, the libc wins over libopen-pal, since it appears
</span><br>
<span class="quotelev1">&gt; deeper in the DSO resolution:
</span><br>
<span class="quotelev1">&gt; catrel-44 ~ $ ldd ./a.out
</span><br>
<span class="quotelev1">&gt;         linux-vdso.so.1 =&gt;  (0x00007fffc5811000)
</span><br>
<span class="quotelev1">&gt;         libmpi.so.1 =&gt; /usr/lib/libmpi.so.1 (0x00007fa5fd904000)
</span><br>
<span class="quotelev1">&gt;         libpthread.so.0 =&gt; /lib/x86_64-linux-gnu/libpthread.so.0
</span><br>
<span class="quotelev1">&gt; (0x00007fa5fd6d5000)
</span><br>
<span class="quotelev1">&gt;         libc.so.6 =&gt; /lib/x86_64-linux-gnu/libc.so.6 (0x00007fa5fd349000)
</span><br>
<span class="quotelev1">&gt;         libopen-rte.so.7 =&gt; /usr/lib/libopen-rte.so.7 (0x00007fa5fd0cd000)
</span><br>
<span class="quotelev1">&gt;         libopen-pal.so.6 =&gt; /usr/lib/libopen-pal.so.6 (0x00007fa5fcdf9000)
</span><br>
<span class="quotelev1">&gt;         libnuma.so.1 =&gt; /usr/lib/libnuma.so.1 (0x00007fa5fcbed000)
</span><br>
<span class="quotelev1">&gt;         libdl.so.2 =&gt; /lib/x86_64-linux-gnu/libdl.so.2 (0x00007fa5fc9e9000)
</span><br>
<span class="quotelev1">&gt;         librt.so.1 =&gt; /lib/x86_64-linux-gnu/librt.so.1 (0x00007fa5fc7e1000)
</span><br>
<span class="quotelev1">&gt;         libm.so.6 =&gt; /lib/x86_64-linux-gnu/libm.so.6 (0x00007fa5fc55e000)
</span><br>
<span class="quotelev1">&gt;         libutil.so.1 =&gt; /lib/x86_64-linux-gnu/libutil.so.1 (0x00007fa5fc35b000)
</span><br>
<span class="quotelev1">&gt;         /lib64/ld-linux-x86-64.so.2 (0x00007fa5fdbe0000)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; If I explicitly add -lopen-pal to the link command line, or if I pass
</span><br>
<span class="quotelev1">&gt; --openmpi:linkall to the mpicc wrapper, then libopen-pal appears
</span><br>
<span class="quotelev1">&gt; before the libc, and wins the contest for the munmap relocation. Which
</span><br>
<span class="quotelev1">&gt; makes my test pass successfully.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Is there supposed to be any smarter mechanism for having the
</span><br>
<span class="quotelev1">&gt; libopen-pal relocation win, rather than just DSO precedence ?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Wed, Nov 12, 2014 at 7:51 PM, Emmanuel Thom&#195;&#169;
</span><br>
<span class="quotelev1">&gt; &lt;emmanuel.thome_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; yes I confirm. Thanks for saying that this is the supposed behaviour.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; In the binary, the code goes to munmap_at_plt, which goes to the libc,
</span><br>
<span class="quotelev2">&gt;&gt; not to libopen-pal.so
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; libc is 2.13-38+deb7u1
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I'm a total noob at got/plt relocations. What is the mechanism which
</span><br>
<span class="quotelev2">&gt;&gt; should make the opal relocation win over the libc one ?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On Wed, Nov 12, 2014 at 7:40 PM, Jeff Squyres (jsquyres)
</span><br>
<span class="quotelev2">&gt;&gt; &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; FWIW, munmap is *supposed* to be intercepted.  Can you confirm that when your application calls munmap, it doesn't make a call to libopen-pal.so?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; It should be calling this (1-line) function:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -----
</span><br>
<span class="quotelev3">&gt;&gt;&gt; /* intercept munmap, as the user can give back memory that way as well. */
</span><br>
<span class="quotelev3">&gt;&gt;&gt; OPAL_DECLSPEC int munmap(void* addr, size_t len)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     return opal_memory_linux_free_ptmalloc2_munmap(addr, len, 0);
</span><br>
<span class="quotelev3">&gt;&gt;&gt; }
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -----
...
<span class="quotelev3">&gt;&gt;&gt; On Nov 12, 2014, at 11:08 AM, Emmanuel Thom&#195;&#169; &lt;emmanuel.thome_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; As far as I have been able to understand while looking at the code, it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; very much seems that Joshua pointed out the exact cause for the issue.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; munmap'ing a virtual address space region does not evict it from
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpool_grdma-&gt;pool-&gt;lru_list . If a later mmap happens to return the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; same address (a priori tied to different physical location), the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; userspace believes this segment is already registered, and eventually
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the transfer is directed to a bogus location.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; This also seems to match this old discussion:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://lists.openfabrics.org/pipermail/general/2009-April/058786.html">http://lists.openfabrics.org/pipermail/general/2009-April/058786.html</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; although I didn't read the whole discussion there, it very much seems
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; that the proposal for moving the pinning/caching logic to the kernel
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; did not make it, unfortunately.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So are we here in the situation where this &quot;munmap should be
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; intercepted&quot; logic actually proves too fragile ? (in that it's not
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; intercepted in my case). The memory MCA in my configuration is:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;              MCA memory: linux (MCA v2.0, API v2.0, Component v1.8.3)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I traced a bit what happens at the mmap call, it seems to go straight
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; to the libc, not via openmpi first.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; For the time being, I think I'll have to consider any mmap()/munmap()
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; rather unsafe to play with in an openmpi application.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; P.S: a last version of the test case is attached.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Le 11 nov. 2014 19:48, &quot;Emmanuel Thom&#195;&#169;&quot; &lt;emmanuel.thome_at_[hidden]&gt; a &#195;&#169;crit :
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;prog6.c&gt;_______________________________________________
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/11/25775.php">http://www.open-mpi.org/community/lists/users/2014/11/25775.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/11/25779.php">http://www.open-mpi.org/community/lists/users/2014/11/25779.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
