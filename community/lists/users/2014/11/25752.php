...
?>
<!-- received="Tue Nov 11 11:11:02 2014" -->
<!-- isoreceived="20141111161102" -->
<!-- sent="Tue, 11 Nov 2014 16:10:10 +0000" -->
<!-- isosent="20141111161010" -->
<!-- name="Blosch, Edwin L" -->
<!-- email="edwin.l.blosch_at_[hidden]" -->
<!-- subject="Re: [OMPI users] EXTERNAL: Re: Question on mapping processes to	hosts file" -->
<!-- id="25AE6277FDC12F408393C11ACE6C400F0CC22BC1_at_HDXDSP53.us.lmco.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="60B18B33-84D3-4411-9BE9-8F8A1EEEA029_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-11 11:10:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25753.php">Ralph Castain: "Re: [OMPI users] oversubscription of slots with GridEngine"</a>
<li><strong>Previous message:</strong> <a href="25751.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Question on mapping processes to hosts file"</a>
<li><strong>In reply to:</strong> <a href="25751.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Question on mapping processes to hosts file"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25754.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Question on mapping processes to	hosts file"</a>
<li><strong>Reply:</strong> <a href="25754.php">Ralph Castain: "Re: [OMPI users] EXTERNAL: Re: Question on mapping processes to	hosts file"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Thanks Ralph.  I&#226;&#128;&#153;ll experiment with these options.  Much appreciated.
<br>
...
<br>
On Nov 11, 2014, at 6:11 AM, Blosch, Edwin L &lt;edwin.l.blosch_at_[hidden]&lt;mailto:edwin.l.blosch_at_[hidden]&gt;&gt; wrote:
<br>
...
<br>
Actually, no - it&#226;&#128;&#153;s an intended &#226;&#128;&#156;feature&#226;&#128;&#157;. When the dinosaurs still roamed the earth and OMPI was an infant, we had no way of detecting the number of processors on a node in advance of the map/launch phase. During that time, users were required to tell us that info in the hostfile, which was a source of constant complaint.
<br>

<br>
Since that time, we have changed the launch procedure so we do have access to that info when we need it. Accordingly, we now check to see if you told us the number of slots on each node in the hostfile - if not, then we autodetect it for you.
<br>

<br>
Quite honestly, it sounds to me like you might be happier using the &#226;&#128;&#156;sequential&#226;&#128;&#157; mapper for this use case. It will place one proc on each of the indicated nodes, with the rank set by the order in the hostfile. So a hostfile like this:
<br>
...
<br>
etc. To use it, just add &quot;-mca rmaps seq&quot; to you cmd line. Alternatively, you could add &#226;&#128;&#156;--map-by node&quot; to your cmd line and we will round-robin by node.
<br>
...
<br>
Now that one is indeed a bug! I&#226;&#128;&#153;ll dig it up and fix it.
<br>
...
Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/11/25742.php">http://www.open-mpi.org/community/lists/users/2014/11/25742.php</a>
<br>

<br>
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25752/attachment">attachment</a>
</ul>
