...
?>
<!-- received="Wed Nov  5 05:12:44 2014" -->
<!-- isoreceived="20141105101244" -->
<!-- sent="Wed, 5 Nov 2014 10:12:41 +0000" -->
<!-- isosent="20141105101241" -->
...
<!-- id="8337B490252F0944BF1D38541059627E1736FE6D_at_DLREXMBX01.intra.dlr.de" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2014-11-05 05:12:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25681.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Previous message:</strong> <a href="25679.php">Gilles Gouaillardet: "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25686.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
Von: users [mailto:users-bounces_at_[hidden]] Im Auftrag von Michael.Rachner_at_[hidden]
<br>
...
<p>Dear Gilles,
<br>
<p>My small downsized Ftn-testprogram for testing the shared memory  feature (MPI_WIN_ALLOCATE_SHARED,  MPI_WIN_SHARED_QUERY, C_F_POINTER)  presumes for simplicity that all processes are running on the same node (i.e. the communicator containing the procs on the same node  is just MPI_COMM_WORLD).
<br>
...
Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/11/25678.php">http://www.open-mpi.org/community/lists/users/2014/11/25678.php</a>
<br>
<!-- body="end" -->
<hr>
<ul class="links">
