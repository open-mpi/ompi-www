...
?>
<!-- received="Thu Nov 13 13:09:55 2014" -->
<!-- isoreceived="20141113180955" -->
<!-- sent="Thu, 13 Nov 2014 19:09:54 +0100" -->
<!-- isosent="20141113180954" -->
<!-- name="Emmanuel Thom&#195;&#169;" -->
<!-- email="emmanuel.thome_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mmaped memory and openib btl." -->
<!-- id="CAPLAFj6a_vrObRPWq+-VXFPu46=D5hLVsd=c7vK8siD3KPtXQg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAPLAFj5FgYRZDobhCL8OdAS7nzFDiZ0sePWY_5Px61=T_yduTA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-13 13:09:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25806.php">Gus Correa: "Re: [OMPI users] How OMPI picks ethernet interfaces"</a>
<li><strong>Previous message:</strong> <a href="25804.php">Gus Correa: "Re: [OMPI users] How OMPI picks ethernet interfaces"</a>
<li><strong>In reply to:</strong> <a href="25780.php">Emmanuel Thom&#195;&#169;: "Re: [OMPI users] mmaped memory and openib btl."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25891.php">Emmanuel Thomé: "Re: [OMPI users] mmaped memory and openib btl."</a>
<li><strong>Reply:</strong> <a href="25891.php">Emmanuel Thomé: "Re: [OMPI users] mmaped memory and openib btl."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>It turns out that the DT_NEEDED libs for my a.out are:
<br>
Dynamic Section:
<br>
&nbsp;&nbsp;NEEDED               libmpi.so.1
...
<br>
<p><p>As a consequence, the libc wins over libopen-pal, since it appears
<br>
...
<br>
<p>If I explicitly add -lopen-pal to the link command line, or if I pass
<br>
...
<br>
<p>Is there supposed to be any smarter mechanism for having the
<br>
...
<p>E.
<br>
<p>On Wed, Nov 12, 2014 at 7:51 PM, Emmanuel Thom&#195;&#169;
<br>
&lt;emmanuel.thome_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt; yes I confirm. Thanks for saying that this is the supposed behaviour.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; In the binary, the code goes to munmap_at_plt, which goes to the libc,
</span><br>
<span class="quotelev1">&gt; not to libopen-pal.so
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; libc is 2.13-38+deb7u1
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I'm a total noob at got/plt relocations. What is the mechanism which
</span><br>
<span class="quotelev1">&gt; should make the opal relocation win over the libc one ?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Wed, Nov 12, 2014 at 7:40 PM, Jeff Squyres (jsquyres)
</span><br>
<span class="quotelev1">&gt; &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; FWIW, munmap is *supposed* to be intercepted.  Can you confirm that when your application calls munmap, it doesn't make a call to libopen-pal.so?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; It should be calling this (1-line) function:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; -----
</span><br>
<span class="quotelev2">&gt;&gt; /* intercept munmap, as the user can give back memory that way as well. */
</span><br>
<span class="quotelev2">&gt;&gt; OPAL_DECLSPEC int munmap(void* addr, size_t len)
</span><br>
<span class="quotelev2">&gt;&gt; {
</span><br>
<span class="quotelev2">&gt;&gt;     return opal_memory_linux_free_ptmalloc2_munmap(addr, len, 0);
</span><br>
<span class="quotelev2">&gt;&gt; }
</span><br>
<span class="quotelev2">&gt;&gt; -----
...
<span class="quotelev2">&gt;&gt; On Nov 12, 2014, at 11:08 AM, Emmanuel Thom&#195;&#169; &lt;emmanuel.thome_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; As far as I have been able to understand while looking at the code, it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; very much seems that Joshua pointed out the exact cause for the issue.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; munmap'ing a virtual address space region does not evict it from
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpool_grdma-&gt;pool-&gt;lru_list . If a later mmap happens to return the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; same address (a priori tied to different physical location), the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; userspace believes this segment is already registered, and eventually
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the transfer is directed to a bogus location.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; This also seems to match this old discussion:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; <a href="http://lists.openfabrics.org/pipermail/general/2009-April/058786.html">http://lists.openfabrics.org/pipermail/general/2009-April/058786.html</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; although I didn't read the whole discussion there, it very much seems
</span><br>
<span class="quotelev3">&gt;&gt;&gt; that the proposal for moving the pinning/caching logic to the kernel
</span><br>
<span class="quotelev3">&gt;&gt;&gt; did not make it, unfortunately.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So are we here in the situation where this &quot;munmap should be
</span><br>
<span class="quotelev3">&gt;&gt;&gt; intercepted&quot; logic actually proves too fragile ? (in that it's not
</span><br>
<span class="quotelev3">&gt;&gt;&gt; intercepted in my case). The memory MCA in my configuration is:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;              MCA memory: linux (MCA v2.0, API v2.0, Component v1.8.3)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I traced a bit what happens at the mmap call, it seems to go straight
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to the libc, not via openmpi first.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; For the time being, I think I'll have to consider any mmap()/munmap()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; rather unsafe to play with in an openmpi application.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; P.S: a last version of the test case is attached.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Le 11 nov. 2014 19:48, &quot;Emmanuel Thom&#195;&#169;&quot; &lt;emmanuel.thome_at_[hidden]&gt; a &#195;&#169;crit :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Thanks a lot for your analysis. This seems consistent with what I can
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; obtain by playing around with my different test cases.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; It seems that munmap() does *not* unregister the memory chunk from the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; cache. I suppose this is the reason for the bug.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; In fact using mmap(..., MAP_ANONYMOUS | MAP_PRIVATE) and munmap() as
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; substitutes for malloc()/free() trigger the same problem.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; It looks to me that there is an oversight in the OPAL hooks around the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; memory functions, then. Do you agree ?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Tue, Nov 11, 2014 at 3:17 PM, Joshua Ladd &lt;jladd.mlnx_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; &lt;prog6.c&gt;_______________________________________________
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/11/25775.php">http://www.open-mpi.org/community/lists/users/2014/11/25775.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/11/25779.php">http://www.open-mpi.org/community/lists/users/2014/11/25779.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
