...
?>
<!-- received="Fri Nov  7 20:27:29 2014" -->
<!-- isoreceived="20141108012729" -->
<!-- sent="Sat, 08 Nov 2014 10:27:22 +0900" -->
<!-- isosent="20141108012722" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OMPI users] How OMPI picks ethernet interfaces" -->
<!-- id="wr12cbq4k571ls0vu4fyh516.1415409980598_at_email.android.com" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2014-11-07 20:27:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25712.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] How OMPI picks ethernet interfaces"</a>
<li><strong>Previous message:</strong> <a href="25710.php">Ralph Castain: "Re: [OMPI users] How OMPI picks ethernet interfaces"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25712.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] How OMPI picks ethernet interfaces"</a>
<li><strong>Maybe reply:</strong> <a href="25712.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] How OMPI picks ethernet interfaces"</a>
<li><strong>Maybe reply:</strong> <a href="25783.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] How OMPI picks ethernet interfaces"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Brock,
<br>
<p>Is your post related to ib0/eoib0 being used at all, or being used with load balancing ?
<br>
<p>let me clarify this :
<br>
--mca btl ^openib
<br>
...
<br>
As you already figured out, btl_tcp_if_include (or btl_tcp_if_exclude) can be used for that purpose.
<br>
<p>Cheers,
<br>
<p>Gilles
<br>
<p><p><p><p>Ralph Castain &lt;rhc.openmpi_at_[hidden]&gt; wrote:
<br>
