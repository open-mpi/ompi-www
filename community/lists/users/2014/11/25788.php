...
?>
<!-- received="Thu Nov 13 02:24:25 2014" -->
<!-- isoreceived="20141113072425" -->
<!-- sent="Thu, 13 Nov 2014 12:24:25 +0500" -->
<!-- isosent="20141113072425" -->
<!-- name="Syed Ahsan Ali" -->
<!-- email="ahsanshah01_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun fails across nodes" -->
<!-- id="CAMvdAsL5ix+D1WpBANgDq9Us47qB7O6HDErGA7Pad12CkkbNkQ_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="54645988.2090202_at_iferc.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-13 02:24:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25789.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun fails across nodes"</a>
<li><strong>Previous message:</strong> <a href="25787.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun fails across nodes"</a>
<li><strong>In reply to:</strong> <a href="25787.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun fails across nodes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25789.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun fails across nodes"</a>
<li><strong>Reply:</strong> <a href="25789.php">Gilles Gouaillardet: "Re: [OMPI users] mpirun fails across nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>[pmdtest_at_pmd ~]$ mpirun --mca btl ^openib --host
<br>
...
<br>
<p><p>[pmdtest_at_compute-01-01 ~]$ mpirun --mca btl ^openib --host
<br>
compute-01-01,compute-01-06 ring_c
<br>
Process 0 sending 10 to 1, tag 201 (2 processes in ring)
...
connect() to 192.168.108.10 failed: No route to host (113)
<br>
<p><p>On Thu, Nov 13, 2014 at 12:11 PM, Gilles Gouaillardet
<br>
