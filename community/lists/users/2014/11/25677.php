...
?>
<!-- received="Wed Nov  5 04:45:29 2014" -->
<!-- isoreceived="20141105094529" -->
<!-- sent="Wed, 05 Nov 2014 18:45:35 +0900" -->
<!-- isosent="20141105094535" -->
...
<!-- id="5459F1BF.20108_at_iferc.org" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="8337B490252F0944BF1D38541059627E1736FAC3_at_DLREXMBX01.intra.dlr.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-11-05 04:45:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25678.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Previous message:</strong> <a href="25676.php">Michael.Rachner_at_[hidden]: "[OMPI users] OPENMPI-1.8.3: missing fortran bindings for MPI_SIZEOF"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/10/25654.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25678.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Reply:</strong> <a href="25678.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; It indeed turned out, that the bad (but silent) allocations  by MPI_WIN_ALLOCATE_SHARED, which I observed in the past after ~140 MB of allocated shared memory, 
</span><br>
<span class="quotelev1">&gt; were indeed caused by  a too small available storage for the sharedmem backing files. Applying the MCA parameter resolved the problem.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; According to the attached email of Jeff (see below) of 2014-10-24, 
</span><br>
<span class="quotelev1">&gt; we have alternatively installed and tested the bugfixed OPENMPI Nightly Tarball  of 2014-10-24  (openmpi-dev-176-g9334abc.tar.gz) on Cluster5 .
</span><br>
<span class="quotelev1">&gt; That version worked well, when our CFD-code was running on only 1 node.
</span><br>
<span class="quotelev1">&gt; But I observe now, that when running the CFD-code on 2 node with  2 processes per node,
</span><br>
<span class="quotelev1">&gt; after having allocated a total of 200 MB of data in 20 shared windows, the allocation of the 21-th window fails, 
</span><br>
<span class="quotelev1">&gt; because all 4 processes enter MPI_WIN_ALLOCATE_SHARED but never leave it. The code hangs in that routine, without any message.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Would you mind testing any nightly tarball after tonight?  (i.e., the v1.8 tarballs generated tonight will be the first ones to contain this fix)
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25580.php">http://www.open-mpi.org/community/lists/users/2014/10/25580.php</a>
</span><br>
<span class="quotelev1">&gt; _______________________________________________
</span><br>
<span class="quotelev1">&gt; users mailing list
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25654.php">http://www.open-mpi.org/community/lists/users/2014/10/25654.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
