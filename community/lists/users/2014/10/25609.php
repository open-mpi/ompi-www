...
?>
<!-- received="Mon Oct 27 09:56:00 2014" -->
<!-- isoreceived="20141027135600" -->
<!-- sent="Mon, 27 Oct 2014 22:55:53 +0900" -->
<!-- isosent="20141027135553" -->
...
<!-- id="b7lblhk39vgynjd6lb4lxaad.1414418153977_at_email.android.com" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2014-10-27 09:55:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25610.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in	shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Previous message:</strong> <a href="25608.php">Gilles Gouaillardet: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25611.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Michael,
<br>
<p>The available space must be greater than the requested size + 5%
<br>
<p>From the logs, the error message makes sense to me : there is not enough space in /tmp
<br>
Since the compute nodes have a lot of memory, you might want to try using /dev/shm instead of /tmp for the backing files
<br>
<p>Cheers,
<br>
<p>Gilles
...
<span class="quotelev1">&gt;It appears as if there is not enough space for /tmp/openmpi-sessions-rachner_at_r5i5n13_0/48127/1/shared_window_688.r5i5n13 (the shared-memory backing
</span><br>
...
<span class="quotelev1">&gt;[r5i5n13:26917] *** on communicator MPI_COMM_WORLD
</span><br>
<span class="quotelev1">&gt;[r5i5n13:26917] *** MPI_ERR_INTERN: internal error
</span><br>
<span class="quotelev1">&gt;[r5i5n13:26917] *** MPI_ERRORS_ARE_FATAL (processes in this communicator will now abort,
</span><br>
...
<span class="quotelev1">&gt;It appears as if there is not enough space for /tmp/openmpi-sessions-rachner_at_r5i5n13_0/48029/1/shared_window_234.r5i5n13 (the shared-memory backing
</span><br>
<span class="quotelev1">&gt;file). It is likely that your MPI job will now either abort or experience
</span><br>
<span class="quotelev1">&gt;performance degradation.
...
<span class="quotelev1">&gt;[r5i5n13:26947] *** on communicator MPI_COMM_WORLD
</span><br>
<span class="quotelev1">&gt;[r5i5n13:26947] *** MPI_ERR_INTERN: internal error
</span><br>
<span class="quotelev1">&gt;[r5i5n13:26947] *** MPI_ERRORS_ARE_FATAL (processes in this communicator will now abort,
</span><br>
...
<span class="quotelev1">&gt;Betreff: AW: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25607.php">http://www.open-mpi.org/community/lists/users/2014/10/25607.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
