...
?>
<!-- received="Fri Oct 24 16:44:54 2014" -->
<!-- isoreceived="20141024204454" -->
<!-- sent="Fri, 24 Oct 2014 20:44:53 +0000" -->
<!-- isosent="20141024204453" -->
...
<!-- id="A30E5D79-E16B-412E-BAB0-02A1145209A1_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="8337B490252F0944BF1D38541059627E17362373_at_DLREXMBX01.intra.dlr.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-10-24 16:44:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25581.php">Siegmar Gross: "Re: [OMPI users] which info is needed for SIGSEGV in Java for openmpi-dev-124-g91e9686on Solaris"</a>
<li><strong>Previous message:</strong> <a href="25579.php">Ralph Castain: "Re: [OMPI users] Problem with Yosemite"</a>
<li><strong>In reply to:</strong> <a href="25572.php">Michael.Rachner_at_[hidden]: "[OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25605.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Reply:</strong> <a href="25605.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Reply:</strong> <a href="25607.php">Michael.Rachner_at_[hidden]: "[OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Reply:</strong> <a href="25654.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; That worked well on the 1st cluster (Laki, having 8 procs per node))  when allocating even 1000 shared windows each having 50000 integer*4 array elements,
</span><br>
<span class="quotelev1">&gt; i.e. a total of  200 MBytes.
</span><br>
...
<span class="quotelev1">&gt; I found that this storage limit depends only weakly on  the number of processes (for np=2,4,8,16,24  it is: 144.4 , 144.0, 141.0, 137.0, 132.2 MB)
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; Here is the error message when running with np=2 and an  array dimension of idim_1=50000  for the integer*4 array allocated per shared window
</span><br>
<span class="quotelev1">&gt; on the compute node of Cluster5:
</span><br>
...
<span class="quotelev1">&gt; (722 successfully allocated shared windows * 50000 array elements * 4 Bytes/el. = 144.4 MB)
</span><br>
<span class="quotelev1">&gt;  
</span><br>
<span class="quotelev1">&gt;  
...
<span class="quotelev1">&gt; [1,0]&lt;stderr&gt;:[r5i5n13:12597] Signal code: Non-existant physical address (2)
</span><br>
<span class="quotelev1">&gt; [1,0]&lt;stderr&gt;:[r5i5n13:12597] Failing at address: 0x7fffe08da000
</span><br>
<span class="quotelev1">&gt; [1,0]&lt;stderr&gt;:[r5i5n13:12597] [ 0] [1,0]&lt;stderr&gt;:/lib64/libpthread.so.0(+0xf800)[0x7ffff6d67800]
</span><br>
...
<span class="quotelev1">&gt; [1,0]&lt;stderr&gt;:[r5i5n13:12597] [ 3] [1,0]&lt;stderr&gt;:/lib64/libc.so.6(__libc_start_main+0xe6)[0x7ffff69fec36]
</span><br>
...
<span class="quotelev1">&gt; mpiexec noticed that process rank 0 with PID 12597 on node r5i5n13 exited on signal 7 (Bus error).
</span><br>
<span class="quotelev1">&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev1">&gt;  
...
<span class="quotelev1">&gt; Why does it work on the Laki  (both on login-node and on a compute node)  as well as on the login-node of Cluster5,
</span><br>
<span class="quotelev1">&gt; but fails on an compute node of Cluster5?
</span><br>
<span class="quotelev1">&gt;  
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25572.php">http://www.open-mpi.org/community/lists/users/2014/10/25572.php</a>
</span><br>
<p><p><pre>
-- 
Jeff Squyres
