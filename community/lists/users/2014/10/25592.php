...
?>
<!-- received="Sun Oct 26 22:04:40 2014" -->
<!-- isoreceived="20141027020440" -->
<!-- sent="Sun, 26 Oct 2014 19:04:36 -0700" -->
<!-- isosent="20141027020436" -->
<!-- name="Ralph Castain" -->
...
<!-- id="5033D2D2-EE84-4A5A-A30D-AF0526CCDEB6_at_open-mpi.org" -->
<!-- charset="utf-8" -->
<!-- inreplyto="opl8etty91sjeia7xpjqiw4x.1414371359867_at_email.android.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-10-26 22:04:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25593.php">Brock Palen: "[OMPI users] HAMSTER MPI+Yarn"</a>
<li><strong>Previous message:</strong> <a href="25591.php">Ralph Castain: "Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686on Solaris"</a>
<li><strong>In reply to:</strong> <a href="25589.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] which info is needed for SIGSEGV inJava foropenmpi-dev-124-g91e9686on Solaris"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25595.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] which info is needed for SIGSEGV inJava foropenmpi-dev-124-g91e9686on Solaris"</a>
<li><strong>Reply:</strong> <a href="25595.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] which info is needed for SIGSEGV inJava foropenmpi-dev-124-g91e9686on Solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>If you add changes to your branch, I can pass you a patch with my suggested alterations.
<br>
<p><span class="quotelev1">&gt; On Oct 26, 2014, at 5:55 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; No :-(
</span><br>
<span class="quotelev1">&gt; I need some extra work to stop declaring orte_process_name_t and ompi_process_name_t variables.
</span><br>
<span class="quotelev1">&gt; #249 will make things much easier.
</span><br>
<span class="quotelev1">&gt; One option is to use opal_process_name_t everywhere or typedef orte and ompi types to the opal one.
</span><br>
<span class="quotelev1">&gt; An other (lightweight but error prone imho) is to change variable declaration only.
</span><br>
...
<span class="quotelev2">&gt;&gt; Will PR#249 solve it? If so, we should just go with it as I suspect that is the long-term solution.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Oct 26, 2014, at 4:25 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; It looks like we faced a similar issue :
</span><br>
<span class="quotelev3">&gt;&gt;&gt; opal_process_name_t is 64 bits aligned wheteas orte_process_name_t is 32 bits aligned. If you run an alignment sensitive cpu such as sparc and you are not lucky (so to speak) you can run into this issue.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; i will make a patch for this shortly
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Afraid this must be something about the Sparc - just ran on a Solaris 11 x86 box and everything works fine.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Oct 26, 2014, at 8:22 AM, Siegmar Gross &lt;Siegmar.Gross_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I wanted to explore which function is called, when I call MPI_Init
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; in a C program, because this function should be called from a Java
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; program as well. Unfortunately C programs break with a Bus Error
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; once more for openmpi-dev-124-g91e9686 on Solaris. I assume that's
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the reason why I get no useful backtrace for my Java program.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; tyr small_prog 117 mpicc -o init_finalize init_finalize.c
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; tyr small_prog 118 /usr/local/gdb-7.6.1_64_gcc/bin/gdb mpiexec
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; ...
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; (gdb) run -np 1 init_finalize
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Starting program: /usr/local/openmpi-1.9.0_64_gcc/bin/mpiexec -np 1 init_finalize
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [tyr:19240] *** Process received signal ***
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [tyr:19240] Signal: Bus Error (10)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [tyr:19240] Signal code: Invalid address alignment (1)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [tyr:19240] Failing at address: ffffffff7bd1c10c
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.9.0_64_gcc/lib64/libopen-pal.so.0.0.0:opal_backtrace_print+0x2c
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.9.0_64_gcc/lib64/libopen-pal.so.0.0.0:0xdcc04
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.9.0_64_gcc/lib64/libopen-pal.so.0.0.0:opal_proc_set_name+0x1c [ Signal 10 (BUS)]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /export2/prog/SunOS_sparc/openmpi-1.9.0_64_gcc/lib64/openmpi/mca_pmix_native.so:0x103e8
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /home/fd1026/work/skripte/master/parallel/prog/mpi/small_prog/init_finalize:main+0x20
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /home/fd1026/work/skripte/master/parallel/prog/mpi/small_prog/init_finalize:_start+0x7c
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [tyr:19240] *** End of error message ***
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mpiexec noticed that process rank 0 with PID 0 on node tyr exited on signal 10 (Bus Error).
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #8  0xffffffff7ec87f60 in vm_close (loader_data=0x0, module=0xffffffff7c901fe0)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../openmpi-dev-124-g91e9686/opal/libltdl/loaders/dlopen.c:212
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #9  0xffffffff7ec85534 in lt_dlclose (handle=0x100189b50)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../openmpi-dev-124-g91e9686/opal/libltdl/ltdl.c:1982
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #10 0xffffffff7ecaabd4 in ri_destructor (obj=0x1001893a0)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/opal/mca/base/mca_base_component_repository.c:382
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #11 0xffffffff7eca9504 in opal_obj_run_destructors (object=0x1001893a0)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/opal/class/opal_object.h:446
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #12 0xffffffff7ecaa474 in mca_base_component_repository_release (
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  component=0xffffffff7b1236f0 &lt;mca_oob_tcp_component&gt;)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/opal/mca/base/mca_base_component_repository.c:240
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #13 0xffffffff7ecac774 in mca_base_component_unload (
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  component=0xffffffff7b1236f0 &lt;mca_oob_tcp_component&gt;, output_id=-1)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/opal/mca/base/mca_base_components_close.c:47
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #14 0xffffffff7ecac808 in mca_base_component_close (
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  component=0xffffffff7b1236f0 &lt;mca_oob_tcp_component&gt;, output_id=-1)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/opal/mca/base/mca_base_components_close.c:60
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #15 0xffffffff7ecac8dc in mca_base_components_close (output_id=-1, 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  components=0xffffffff7f14ba58 &lt;orte_oob_base_framework+80&gt;, skip=0x0)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/opal/mca/base/mca_base_components_close.c:86
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #16 0xffffffff7ecac844 in mca_base_framework_components_close (
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  framework=0xffffffff7f14ba08 &lt;orte_oob_base_framework&gt;, skip=0x0)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/opal/mca/base/mca_base_components_close.c:66
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #17 0xffffffff7efcaf58 in orte_oob_base_close ()
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/orte/mca/oob/base/oob_base_frame.c:112
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #18 0xffffffff7ecc136c in mca_base_framework_close (
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  framework=0xffffffff7f14ba08 &lt;orte_oob_base_framework&gt;)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/opal/mca/base/mca_base_framework.c:187
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #19 0xffffffff7be07858 in rte_finalize ()
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../../openmpi-dev-124-g91e9686/orte/mca/ess/hnp/ess_hnp_module.c:857
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #20 0xffffffff7ef338a4 in orte_finalize ()
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../openmpi-dev-124-g91e9686/orte/runtime/orte_finalize.c:66
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #21 0x000000010000723c in orterun (argc=4, argv=0xffffffff7fffe0b8)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/orte/tools/orterun/orterun.c:1103
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; #22 0x0000000100003e80 in main (argc=4, argv=0xffffffff7fffe0b8)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  at ../../../../openmpi-dev-124-g91e9686/orte/tools/orterun/main.c:13
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25582.php">http://www.open-mpi.org/community/lists/users/2014/10/25582.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25584.php">http://www.open-mpi.org/community/lists/users/2014/10/25584.php</a>
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25585.php">http://www.open-mpi.org/community/lists/users/2014/10/25585.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25586.php">http://www.open-mpi.org/community/lists/users/2014/10/25586.php</a>
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25587.php">http://www.open-mpi.org/community/lists/users/2014/10/25587.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25588.php">http://www.open-mpi.org/community/lists/users/2014/10/25588.php</a>
</span><br>
<span class="quotelev1">&gt; _______________________________________________
</span><br>
<span class="quotelev1">&gt; users mailing list
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25589.php">http://www.open-mpi.org/community/lists/users/2014/10/25589.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
