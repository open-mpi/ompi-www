...
?>
<!-- received="Mon Oct 27 02:12:19 2014" -->
<!-- isoreceived="20141027061219" -->
<!-- sent="Mon, 27 Oct 2014 15:12:15 +0900" -->
<!-- isosent="20141027061215" -->
...
<!-- id="544DE23F.4040502_at_iferc.org" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="5033D2D2-EE84-4A5A-A30D-AF0526CCDEB6_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-10-27 02:12:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25596.php">Gilles Gouaillardet: "Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686on Solaris"</a>
<li><strong>Previous message:</strong> <a href="25594.php">Brock Palen: "[OMPI users] Java FAQ Page out of date"</a>
<li><strong>In reply to:</strong> <a href="25592.php">Ralph Castain: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] which info is needed for SIGSEGV inJava foropenmpi-dev-124-g91e9686on Solaris"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25614.php">Ralph Castain: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] which info is needed for SIGSEGV inJava foropenmpi-dev-124-g91e9686on Solaris"</a>
<li><strong>Reply:</strong> <a href="25614.php">Ralph Castain: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] which info is needed for SIGSEGV inJava foropenmpi-dev-124-g91e9686on Solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>as far as i am concerned, i am fine with your proposed suggestion to
<br>
dump opal_identifier_t.
<br>
<p>about the patch, did you mean you have something ready i can apply to my
<br>
PR ?
<br>
...
<p>Gilles
<br>
<p>On 2014/10/27 11:04, Ralph Castain wrote:
<br>
<span class="quotelev1">&gt; Just took a glance thru 249 and have a few suggestions on it - will pass them along tomorrow. I think the right solution is to (a) dump opal_identifier_t in favor of using opal_process_name_t everywhere in the opal layer, (b) typedef orte_process_name_t to opal_process_name_t, and (c) leave ompi_process_name_t as typedef&#226;&#128;&#153;d to the RTE component in the MPI layer. This lets other RTEs decide for themselves how they want to handle it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; If you add changes to your branch, I can pass you a patch with my suggested alterations.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Oct 26, 2014, at 5:55 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; No :-(
</span><br>
<span class="quotelev2">&gt;&gt; I need some extra work to stop declaring orte_process_name_t and ompi_process_name_t variables.
</span><br>
<span class="quotelev2">&gt;&gt; #249 will make things much easier.
</span><br>
<span class="quotelev2">&gt;&gt; One option is to use opal_process_name_t everywhere or typedef orte and ompi types to the opal one.
</span><br>
<span class="quotelev2">&gt;&gt; An other (lightweight but error prone imho) is to change variable declaration only.
</span><br>
<span class="quotelev2">&gt;&gt; Any thought ?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Will PR#249 solve it? If so, we should just go with it as I suspect that is the long-term solution.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Oct 26, 2014, at 4:25 PM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; It looks like we faced a similar issue :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; opal_process_name_t is 64 bits aligned wheteas orte_process_name_t is 32 bits aligned. If you run an alignment sensitive cpu such as sparc and you are not lucky (so to speak) you can run into this issue.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; i will make a patch for this shortly
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25587.php">http://www.open-mpi.org/community/lists/users/2014/10/25587.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; _______________________________________________
</span><br>
<span class="quotelev3">&gt;&gt;&gt; users mailing list
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25588.php">http://www.open-mpi.org/community/lists/users/2014/10/25588.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
</span><br>
<span class="quotelev2">&gt;&gt; users mailing list
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25589.php">http://www.open-mpi.org/community/lists/users/2014/10/25589.php</a>
</span><br>
<span class="quotelev1">&gt; _______________________________________________
</span><br>
<span class="quotelev1">&gt; users mailing list
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25592.php">http://www.open-mpi.org/community/lists/users/2014/10/25592.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
