...
?>
<!-- received="Mon Oct 27 02:16:55 2014" -->
<!-- isoreceived="20141027061655" -->
<!-- sent="Mon, 27 Oct 2014 15:16:52 +0900" -->
<!-- isosent="20141027061652" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686on Solaris" -->
<!-- id="544DE354.5040509_at_iferc.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="120D6330-6BE8-42DE-936C-B2619621AA19_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-10-27 02:16:52
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25597.php">Siegmar Gross: "Re: [OMPI users] which info is needed for SIGSEGV in Javaforopenmpi-dev-124-g91e9686on Solaris"</a>
<li><strong>Previous message:</strong> <a href="25595.php">Gilles Gouaillardet: "Re: [OMPI users] OMPI users] OMPI users] OMPI users] which info is needed for SIGSEGV inJava foropenmpi-dev-124-g91e9686on Solaris"</a>
<li><strong>In reply to:</strong> <a href="25591.php">Ralph Castain: "Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686on Solaris"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25600.php">Oscar Vega-Gisbert: "Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686on Solaris"</a>
<li><strong>Reply:</strong> <a href="25600.php">Oscar Vega-Gisbert: "Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686on Solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Kawashima-san,
<br>
<p>thanks a lot for the detailled explanation.
<br>
...
<br>
<p>i commited a16c1e44189366fbc8e967769e050f517a40f3f8 in order to fix this
<br>
issue
<br>
(i moved the call to mca_base_var_register *after* MPI_Init)
<br>
<p>regarding the BUS error reported by Siegmar, i also commited
<br>
...
<br>
<p>Siegmar, --enable-heterogeneous is known to be broken on the trunk, and
<br>
...
clusters *only* */
<br>
<p>about attaching a process with gdb, i usually run
<br>
gdb none &lt;pid&gt;
<br>
...
<p>Gilles
<br>
<p>On 2014/10/27 10:58, Ralph Castain wrote:
<br>
<span class="quotelev1">&gt; Oh yeah - that would indeed be very bad :-(
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Oct 26, 2014, at 6:06 PM, Kawashima, Takahiro &lt;t-kawashima_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Siegmar, Oscar,
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I suspect that the problem is calling mca_base_var_register
</span><br>
<span class="quotelev2">&gt;&gt; without initializing OPAL in JNI_OnLoad.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; ompi/mpi/java/c/mpi_MPI.c:
</span><br>
<span class="quotelev2">&gt;&gt; ----------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt; jint JNI_OnLoad(JavaVM *vm, void *reserved)
</span><br>
<span class="quotelev2">&gt;&gt; {
</span><br>
<span class="quotelev2">&gt;&gt;    libmpi = dlopen(&quot;libmpi.&quot; OPAL_DYN_LIB_SUFFIX, RTLD_NOW | RTLD_GLOBAL);
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;    if(libmpi == NULL)
</span><br>
<span class="quotelev2">&gt;&gt;    {
</span><br>
<span class="quotelev2">&gt;&gt;        fprintf(stderr, &quot;Java bindings failed to load liboshmem.\n&quot;);
</span><br>
...
<span class="quotelev2">&gt;&gt;    mca_base_var_register(&quot;ompi&quot;, &quot;mpi&quot;, &quot;java&quot;, &quot;eager&quot;,
</span><br>
<span class="quotelev2">&gt;&gt;                          &quot;Java buffers eager size&quot;,
</span><br>
...
<span class="quotelev2">&gt;&gt;                          &amp;ompi_mpi_java_eager);
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;    return JNI_VERSION_1_6;
</span><br>
<span class="quotelev2">&gt;&gt; }
</span><br>
<span class="quotelev2">&gt;&gt; ----------------------------------------------------------------
...
<span class="quotelev2">&gt;&gt; I suppose JNI_OnLoad is the first function in the libmpi_java.so
</span><br>
<span class="quotelev2">&gt;&gt; which is called by JVM. So OPAL is not initialized yet.
</span><br>
<span class="quotelev2">&gt;&gt; As shown in Siegmar's JRE log, SEGV occurred in asprintf called
</span><br>
<span class="quotelev2">&gt;&gt; by mca_base_var_cache_files.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Siegmar's hs_err_pid13080.log:
</span><br>
<span class="quotelev2">&gt;&gt; ----------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt; siginfo:si_signo=SIGSEGV: si_errno=0, si_code=1 (SEGV_MAPERR), si_addr=0x0000000000000000
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Stack: [0xffffffff7b400000,0xffffffff7b500000],  sp=0xffffffff7b4fc730,  free space=1009k
</span><br>
<span class="quotelev2">&gt;&gt; Native frames: (J=compiled Java code, j=interpreted, Vv=VM code, C=native code)
</span><br>
<span class="quotelev2">&gt;&gt; C  [libc.so.1+0x3c7f0]  strlen+0x50
</span><br>
<span class="quotelev2">&gt;&gt; C  [libc.so.1+0xaf640]  vsnprintf+0x84
</span><br>
<span class="quotelev2">&gt;&gt; C  [libc.so.1+0xaadb4]  vasprintf+0x20
</span><br>
<span class="quotelev2">&gt;&gt; C  [libc.so.1+0xaaf04]  asprintf+0x28
</span><br>
<span class="quotelev2">&gt;&gt; C  [libopen-pal.so.0.0.0+0xaf3cc]  mca_base_var_cache_files+0x160
</span><br>
<span class="quotelev2">&gt;&gt; C  [libopen-pal.so.0.0.0+0xaed90]  mca_base_var_init+0x4e8
</span><br>
<span class="quotelev2">&gt;&gt; C  [libopen-pal.so.0.0.0+0xb260c]  register_variable+0x214
</span><br>
<span class="quotelev2">&gt;&gt; C  [libopen-pal.so.0.0.0+0xb36a0]  mca_base_var_register+0x104
</span><br>
<span class="quotelev2">&gt;&gt; C  [libmpi_java.so.0.0.0+0x221e8]  JNI_OnLoad+0x128
</span><br>
<span class="quotelev2">&gt;&gt; C  [libjava.so+0x10860]  Java_java_lang_ClassLoader_00024NativeLibrary_load+0xb8
</span><br>
<span class="quotelev2">&gt;&gt; j  java.lang.ClassLoader$NativeLibrary.load(Ljava/lang/String;Z)V+-665819
</span><br>
<span class="quotelev2">&gt;&gt; j  java.lang.ClassLoader$NativeLibrary.load(Ljava/lang/String;Z)V+0
</span><br>
<span class="quotelev2">&gt;&gt; j  java.lang.ClassLoader.loadLibrary0(Ljava/lang/Class;Ljava/io/File;)Z+328
</span><br>
<span class="quotelev2">&gt;&gt; j  java.lang.ClassLoader.loadLibrary(Ljava/lang/Class;Ljava/lang/String;Z)V+290
</span><br>
<span class="quotelev2">&gt;&gt; j  java.lang.Runtime.loadLibrary0(Ljava/lang/Class;Ljava/lang/String;)V+54
</span><br>
<span class="quotelev2">&gt;&gt; j  java.lang.System.loadLibrary(Ljava/lang/String;)V+7
</span><br>
<span class="quotelev2">&gt;&gt; j  mpi.MPI.&lt;clinit&gt;()V+28
</span><br>
<span class="quotelev2">&gt;&gt; ----------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; mca_base_var_cache_files passes opal_install_dirs.sysconfdir to
</span><br>
<span class="quotelev2">&gt;&gt; asprintf.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; opal/mca/base/mca_base_var.c:
</span><br>
<span class="quotelev2">&gt;&gt; ----------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt;    asprintf(&amp;mca_base_var_files, &quot;%s&quot;OPAL_PATH_SEP&quot;.openmpi&quot; OPAL_PATH_SEP
</span><br>
<span class="quotelev2">&gt;&gt;             &quot;mca-params.conf%c%s&quot; OPAL_PATH_SEP &quot;openmpi-mca-params.conf&quot;,
</span><br>
<span class="quotelev2">&gt;&gt;             home, OPAL_ENV_SEP, opal_install_dirs.sysconfdir);
</span><br>
<span class="quotelev2">&gt;&gt; ----------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; In this situation, opal_install_dirs.sysconfdir is still NULL.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I run a MPI Java program that only calls MPI.Init() and
</span><br>
<span class="quotelev2">&gt;&gt; MPI.Finalize() with MCA variable mpi_show_mca_params=1 on
</span><br>
<span class="quotelev2">&gt;&gt; Linux to confirm this. mca_base_param_files contains &quot;(null)&quot;.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; mpi_show_mca_params=1:
</span><br>
<span class="quotelev2">&gt;&gt; ----------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mca_base_param_files=/home/rivis/.openmpi/mca-params.conf:(null)/openmpi-mca-params.conf (default)
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mca_param_files=/home/rivis/.openmpi/mca-params.conf:(null)/openmpi-mca-params.conf (default)
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mca_base_override_param_file=(null)/openmpi-mca-params-override.conf (default)
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mca_base_suppress_override_warning=false (default)
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mca_base_param_file_prefix= (default)
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mca_base_param_file_path=(null)/amca-param-sets:/home/rivis/src/mpisample (default)
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mca_base_param_file_path_force= (default)
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mca_base_env_list= (default)
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mca_base_env_list_delimiter=; (default)
</span><br>
<span class="quotelev2">&gt;&gt; [ppc:12232] mpi_java_eager=65536 (default)
</span><br>
...
<span class="quotelev2">&gt;&gt; GNU libc sets &quot;(null)&quot; for asprintf(buf, &quot;%s&quot;, NULL) but
</span><br>
<span class="quotelev2">&gt;&gt; Solaris libc raises SEGV for it. I think this is the difference
</span><br>
<span class="quotelev2">&gt;&gt; of Siegmar's runs on Linux and Solaris.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I think this mca_base_var_register should be moved to another
</span><br>
<span class="quotelev2">&gt;&gt; place or opal_init_util or something should be called before
</span><br>
<span class="quotelev2">&gt;&gt; this mca_base_var_register.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25591.php">http://www.open-mpi.org/community/lists/users/2014/10/25591.php</a>
</span><br>
<p><p><p>
<p>
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25596/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25596/heterogeneous.diff">heterogeneous.diff</a>
</ul>
<!-- attachment="heterogeneous.diff" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
