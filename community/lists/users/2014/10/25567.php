...
?>
<!-- received="Fri Oct 24 03:46:04 2014" -->
<!-- isoreceived="20141024074604" -->
<!-- sent="Fri, 24 Oct 2014 16:46:04 +0900" -->
<!-- isosent="20141024074604" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles.gouaillardet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686 on Solaris" -->
<!-- id="544A03BC.5050008_at_iferc.org" -->
...
<strong>Date:</strong> 2014-10-24 03:46:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25568.php">Jeff Squyres (jsquyres): "Re: [OMPI users] low CPU utilization with OpenMPI"</a>
<li><strong>Previous message:</strong> <a href="25566.php">Vinson Leung: "Re: [OMPI users] low CPU utilization with OpenMPI"</a>
...
Siegmar,
<br>
<p>how did you configure openmpi ? which java version did you use ?
<br>
<p>i just found a regression and you currently have to explicitly add
<br>
CFLAGS=-D_REENTRANT CPPFLAGS=-D_REENTRANT
<br>
to your configure command line
<br>
<p>if you want to debug this issue (i cannot reproduce it on a solaris 11
<br>
x86 virtual machine)
<br>
...
<br>
<p>OMPI_ATTACH=1 mpiexec -n 1 java InitFinalizeMain
<br>
<p>then you will need to attach the *java* process with gdb, set the _dbg
<br>
...
<p>Gilles
<br>
<p>On 2014/10/24 0:03, Siegmar Gross wrote:
<br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/10/25562.php">http://www.open-mpi.org/community/lists/users/2014/10/25562.php</a>
</span><br>
<p><p><p>
<p>
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25567/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25567/attach_java.patch">attach_java.patch</a>
</ul>
<!-- attachment="attach_java.patch" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
