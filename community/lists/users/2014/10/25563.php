...
?>
<!-- received="Thu Oct 23 16:15:55 2014" -->
<!-- isoreceived="20141023201555" -->
<!-- sent="Thu, 23 Oct 2014 22:15:17 +0200" -->
<!-- isosent="20141023201517" -->
...
<!-- id="544961D5.4070201_at_dsic.upv.es" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2014-10-23 16:15:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25564.php">Kawashima, Takahiro: "Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686 on Solaris"</a>
<li><strong>Previous message:</strong> <a href="25562.php">Siegmar Gross: "Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686 on Solaris"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25564.php">Kawashima, Takahiro: "Re: [OMPI users] which info is needed for SIGSEGV in Java foropenmpi-dev-124-g91e9686 on Solaris"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello Siegmar,
<br>
<p>If your Java program only calls to MPI.Init and MPI.Finalize you don't 
<br>
...
<br>
<p>But if you want debug 2 processes, you can do the following.
<br>
<p>You must launch 2 instances of the Java debugger (jdb) or NetBeans, 
<br>
Eclipse,... listening on port 8000.
<br>
<p>The 2 processes must be launched with the necessary parameters to attach 
<br>
to the listening debuggers:
<br>
<p>mpirun -np 2 java -agentlib:jdwp=transport=dt_socket,\
<br>
server=n,address=localhost:8000 Hello
<br>
<p>I checked it on NetBeans and it works.
<br>
Here you have more details about debugging:
<br>
<p><a href="http://docs.oracle.com/javase/8/docs/technotes/guides/jpda/conninv.html">http://docs.oracle.com/javase/8/docs/technotes/guides/jpda/conninv.html</a>
<br>
<p>Regards,
<br>
Oscar
<br>
<p>El 23/10/14 17:03, Siegmar Gross escribi&#243;:
<br>
<span class="quotelev1">&gt; Hello Oscar,
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/10/25559.php">http://www.open-mpi.org/community/lists/users/2014/10/25559.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
