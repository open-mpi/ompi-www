...
?>
<!-- received="Mon Oct 27 09:49:05 2014" -->
<!-- isoreceived="20141027134905" -->
<!-- sent="Mon, 27 Oct 2014 22:48:57 +0900" -->
<!-- isosent="20141027134857" -->
...
<!-- id="2euo0p9js4be5l0nvi1ehxh9.1414417737078_at_email.android.com" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2014-10-27 09:48:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25609.php">Gilles Gouaillardet: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Previous message:</strong> <a href="25607.php">Michael.Rachner_at_[hidden]: "[OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25610.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in	shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Reply:</strong> <a href="25610.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in	shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
