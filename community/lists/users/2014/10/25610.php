...
?>
<!-- received="Mon Oct 27 10:02:17 2014" -->
<!-- isoreceived="20141027140217" -->
<!-- sent="Mon, 27 Oct 2014 14:02:12 +0000" -->
<!-- isosent="20141027140212" -->
...
<!-- id="8337B490252F0944BF1D38541059627E173625EB_at_DLREXMBX01.intra.dlr.de" -->
<!-- charset="utf-8" -->
<!-- inreplyto="2euo0p9js4be5l0nvi1ehxh9.1414417737078_at_email.android.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>From:</strong> <a href="mailto:Michael.Rachner_at_[hidden]?Subject=Re:%20[OMPI%20users]%20WG:%20Bug%20in%20OpenMPI-1.8.3:%20storage%20limition%20in	shared%20memory%20allocation%20(MPI_WIN_ALLOCATE_SHARED)%20in%20Ftn-code"><em>Michael.Rachner_at_[hidden]</em></a><br>
<strong>Date:</strong> 2014-10-27 10:02:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25611.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>Previous message:</strong> <a href="25609.php">Gilles Gouaillardet: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<li><strong>In reply to:</strong> <a href="25608.php">Gilles Gouaillardet: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25609.php">Gilles Gouaillardet: "Re: [OMPI users] WG: Bug in OpenMPI-1.8.3: storage limition in shared memory allocation (MPI_WIN_ALLOCATE_SHARED) in Ftn-code"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
