...
?>
<!-- received="Tue Jul 22 17:18:12 2014" -->
<!-- isoreceived="20140722211812" -->
<!-- sent="Tue, 22 Jul 2014 21:18:09 +0000" -->
<!-- isosent="20140722211809" -->
<!-- name="Lane, William" -->
<!-- email="William.Lane_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Mpirun 1.5.4  problems when request &amp;gt; 28 slots" -->
<!-- id="434F2BB0AF80484CA04DE0D8C0738BF293E24668_at_cshsmsgmbx02.CSMC.EDU" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="49412523-4087-4F19-9D7D-4385DA0F3885_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-07-22 17:18:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24853.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Mpirun 1.5.4  problems when request &gt; 28 slots"</a>
<li><strong>Previous message:</strong> <a href="24851.php">Ralph Castain: "Re: [OMPI users] Salloc and mpirun problem"</a>
<li><strong>In reply to:</strong> <a href="24847.php">Ralph Castain: "Re: [OMPI users] Mpirun 1.5.4  problems when request &gt; 28 slots"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24853.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Mpirun 1.5.4  problems when request &gt; 28 slots"</a>
<li><strong>Reply:</strong> <a href="24853.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Mpirun 1.5.4  problems when request &gt; 28 slots"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>The 32 slot systems/nodes I'm running my openMPI test code on only have
<br>
...
<br>
<p>mpirun -np 32 -npernode 8 --prefix /usr/lib64/openmpi --hostfile hostfile --mca btl_tcp_if_include eth0 --mca
<br>
&nbsp;&nbsp;&nbsp;&nbsp;pls_gridengine_verbose 1 /hpc/home/lanew/mpi/openmpi/ProcessColors2
<br>
<p>However, when I run this same testcode on an older cluster (much older version
<br>
of openMPI [1.3.3]) I have no problems using all the cores (including hyperthreading
<br>
cores). The Intel CPU's used are different in each case: the older cluster uses
<br>
two, 6 core Xeons with 12 hyperthreads while the new cluster uses two,
<br>
8 core Sandybridges with 16 hyperthreads apiece.
<br>
<p>Is hyperthreading an issue with openMPI? Should hyperthreading always be turned
<br>
...
Subject: Re: [OMPI users] Mpirun 1.5.4 problems when request &gt; 28 slots
<br>
<p>Hmmm...that's not a &quot;bug&quot;, but just a packaging issue with the way CentOS distributed some variants of OMPI that requires you install/update things in a specific order.
<br>
<p>On Jul 20, 2014, at 11:34 PM, Lane, William &lt;William.Lane_at_[hidden]&lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
<br>
<p>Please see:
<br>
...
Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/07/24832.php">http://www.open-mpi.org/community/lists/users/2014/07/24832.php</a>
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24852/attachment">attachment</a>
</ul>
