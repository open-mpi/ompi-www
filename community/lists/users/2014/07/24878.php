...
?>
<!-- received="Fri Jul 25 13:30:13 2014" -->
<!-- isoreceived="20140725173013" -->
<!-- sent="Fri, 25 Jul 2014 13:30:08 -0400" -->
<!-- isosent="20140725173008" -->
<!-- name="Dan Shell" -->
<!-- email="dshellwireless_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Trying to use openmpi with MOM getting a compile error" -->
<!-- id="F5CCF21EFEFB42F8B2832F92BADEA045_at_WDC" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-07-25 13:30:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24879.php">Oscar Vega-Gisbert: "Re: [OMPI users] SIGSEGV for Java program in openmpi-1.8.2rc2 on Solaris 10"</a>
<li><strong>Previous message:</strong> <a href="24877.php">Gus Correa: "Re: [OMPI users] Trying to use openmpi with MOM getting a compile error"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24880.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Trying to use openmpi with MOM getting a compile error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Change the mkmf.template file and replace the Fortran compiler name
<br>
...
<span class="quotelev1">&gt; installation error below Looking for some help in openmpi to make sure 
</span><br>
<span class="quotelev1">&gt; the mpif.h is loaded correctly Should I use an older version of 
</span><br>
...
<span class="quotelev1">&gt;    public :: stat, mpp_stack, ptr_stack, status, ptr_status, sync,
</span><br>
ptr_sync
<br>
<span class="quotelev1">&gt;                  1
</span><br>
<span class="quotelev1">&gt; Error: The module or main program array 'stat' at (1) must have 
</span><br>
<span class="quotelev1">&gt; constant shape
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/07/24876.php">http://www.open-mpi.org/community/lists/users/2014/07/24876.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
Link to this post:
<br>
<a href="http://www.open-mpi.org/community/lists/users/2014/07/24877.php">http://www.open-mpi.org/community/lists/users/2014/07/24877.php</a>
<br>
<!-- body="end" -->
<hr>
<ul class="links">
