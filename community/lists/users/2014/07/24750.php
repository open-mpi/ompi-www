...
?>
<!-- received="Fri Jul  4 11:22:23 2014" -->
<!-- isoreceived="20140704152223" -->
<!-- sent="Fri, 04 Jul 2014 19:22:21 +0400" -->
<!-- isosent="20140704152221" -->
<!-- name="Timur Ismagilov" -->
<!-- email="tismagilov_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openMP  and mpi problem" -->
<!-- id="1404487341.153071190_at_f395.i.mail.ru" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2014-07-04 11:22:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24751.php">Ralph Castain: "Re: [OMPI users] openMP  and mpi problem"</a>
<li><strong>Previous message:</strong> <a href="24749.php">Ralph Castain: "Re: [OMPI users] openMP  and mpi problem"</a>
<li><strong>Maybe in reply to:</strong> <a href="24738.php">Timur Ismagilov: "[OMPI users] openMP  and mpi problem"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24752.php">Tim Prince: "Re: [OMPI users] openMP  and mpi problem"</a>
<li><strong>Reply:</strong> <a href="24752.php">Tim Prince: "Re: [OMPI users] openMP  and mpi problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
1. Intell mpi is located here:&#194;&#160;/opt/intel/impi/4.1.0/intel64/lib. I have added OMPI path at the start and got the same output.
<br>
2. here is my cmd line:
<br>
export OMP_NUM_THREADS=8; export LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/mnt/data/users/dm2/vol3/semenov/_scratch/openmpi-1.9.0_mxm-3.0/lib; sbatch -p test -t 5 --exclusive -N 1 -o ./results/hybrid-hello_omp$i.out -e ./results/hybrid-hello_omp$i.err ompi_mxm3.0 ./hybrid-hello; done
<br>
$ cat ompi_mxm3.0
<br>
#!/bin/sh
...
<br>
LD_PRELOAD=/mnt/data/users/dm2/vol3/semenov/_scratch/mxm/mxm-3.0/lib/libmxm.so mpirun -x LD_PRELOAD -x MXM_SHM_KCOPY_MODE=off --map-by slot:pe=8 --mca rmaps_base_verbose 20 --hostfile $HOSTFILE &quot;$@&quot;
<br>
rc=$?
<br>
rm -f $HOSTFILE
...
exit $rc
<br>
<p><p>Fri, 4 Jul 2014 07:06:34 -0700 &#208;&#190;&#209;&#130; Ralph Castain &lt;rhc_at_[hidden]&gt;:
<br>
...
<span class="quotelev2">&gt;&gt;echo $LD_LIBRARY_PATH &#194;&#160;
</span><br>
...
<span class="quotelev2">&gt;&gt;$ldd&#194;&#160;hybrid-hello
</span><br>
...
<span class="quotelev2">&gt;&gt;/lib64/ld-linux-x86-64.so.2 (0x000000338a800000) open mpi 1.5.5 was preinstalled to &quot;/opt/mpi/openmpi-1.5.5-icc/&quot;.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;[node1-128-29:21477] mca: base: close: unloading component staged Here is an output after adding &quot;--mca rmaps_base_verbose 20&quot; and &#194;&#160; WITHOUT &#194;&#160;&quot;--map-by slot:pe=8&quot;.
</span><br>
<span class="quotelev2">&gt;&gt;*  outfile:
</span><br>
...
<span class="quotelev2">&gt;&gt;[node1-128-29:21569] mca: base: close: unloading component staged Regards,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;This looks to me like a message from some older version of OMPI. Please check your LD_LIBRARY_PATH and ensure that the 1.9 installation is at the *front* of that list.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;Of course, I'm also assuming that you installed the two versions into different locations - yes?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;Also, add &quot;--mca rmaps_base_verbose 20&quot; to your cmd line - this will tell us what mappers are being considered.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;On Jul 3, 2014, at 1:31 AM, Timur Ismagilov &lt; tismagilov_at_[hidden] &gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;When i used --map-by slot:pe=8, i got the same message&#194;&#160;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;Wed, 2 Jul 2014 07:36:48 -0700 &#208;&#190;&#209;&#130; Ralph Castain &lt; rhc_at_[hidden] &gt;:
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24750/attachment">attachment</a>
</ul>
