...
?>
<!-- received="Tue Jul 22 10:59:05 2014" -->
<!-- isoreceived="20140722145905" -->
<!-- sent="Tue, 22 Jul 2014 07:57:53 -0700" -->
<!-- isosent="20140722145753" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Mpirun 1.5.4  problems when request &amp;gt; 28 slots" -->
<!-- id="49412523-4087-4F19-9D7D-4385DA0F3885_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2014-07-22 10:57:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24848.php">Ralph Castain: "Re: [OMPI users] Using the Hydra process manager to launch Open MPI applications"</a>
<li><strong>Previous message:</strong> <a href="24846.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Mpirun 1.5.4  problems when request &gt; 28 slots"</a>
<li><strong>In reply to:</strong> <a href="24832.php">Lane, William: "Re: [OMPI users] Mpirun 1.5.4  problems when request &gt; 28 slots"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24852.php">Lane, William: "Re: [OMPI users] Mpirun 1.5.4  problems when request &gt; 28 slots"</a>
<li><strong>Reply:</strong> <a href="24852.php">Lane, William: "Re: [OMPI users] Mpirun 1.5.4  problems when request &gt; 28 slots"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Hmmm...that's not a &quot;bug&quot;, but just a packaging issue with the way CentOS distributed some variants of OMPI that requires you install/update things in a specific order.
<br>
<p>On Jul 20, 2014, at 11:34 PM, Lane, William &lt;William.Lane_at_[hidden]&gt; wrote:
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24847/attachment">attachment</a>
</ul>
