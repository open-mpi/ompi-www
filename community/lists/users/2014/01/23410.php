...
?>
<!-- received="Sun Jan 19 04:36:50 2014" -->
<!-- isoreceived="20140119093650" -->
<!-- sent="Sun, 19 Jan 2014 18:36:44 +0900" -->
<!-- isosent="20140119093644" -->
<!-- name="tmishima_at_[hidden]" -->
<!-- email="tmishima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] hosfile issue of openmpi-1.7.4rc2" -->
<!-- id="OF680AB2BF.723EBB87-ON49257C65.002FDD97-49257C65.0034CDDA_at_jcity.maeda.co.jp" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="C7B62C43-E2BC-4354-9ACE-6867C8B39131_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-01-19 04:36:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23411.php">Syed Ahsan Ali: "[OMPI users] Error message related to infiniband"</a>
<li><strong>Previous message:</strong> <a href="23409.php">thomas.forde_at_[hidden]: "[OMPI users] random error bugging me.."</a>
<li><strong>In reply to:</strong> <a href="23408.php">Ralph Castain: "Re: [OMPI users] hosfile issue of openmpi-1.7.4rc2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23415.php">Ralph Castain: "Re: [OMPI users] hosfile issue of openmpi-1.7.4rc2"</a>
<li><strong>Reply:</strong> <a href="23415.php">Ralph Castain: "Re: [OMPI users] hosfile issue of openmpi-1.7.4rc2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Before that, although I could not understand everything,
<br>
let me ask some questions about the new hostfile.c.
<br>
<p>1. The line 244-248 is included in else-clause, which might cause
<br>
memory leak(it seems to me). Should it be out of the clause?
<br>
<p>244            if (NULL != node_alias) {
<br>
...
248            }
<br>
<p>2. For the similar reason, should the line 306-314 be out of else-clause?
<br>
<p>3. I think that node-&gt;slots_given of hosts detected through rank-file
<br>
should
<br>
...
<br>
<p>305            node-&gt;slots_given = true;
<br>
<p>Regards,
<br>
Tetsuya Mishima
<br>
<p><span class="quotelev1">&gt; I believe I now have this working correctly on the trunk and setup for
</span><br>
...
<span class="quotelev1">&gt; On Jan 17, 2014, at 2:16 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt; &gt; Sorry for delay - I understood and was just occupied with something
</span><br>
...
<span class="quotelev2">&gt; &gt; On Jan 17, 2014, at 2:00 PM, tmishima_at_[hidden] wrote:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; I'm sorry that my explanation was not enough ...
</span><br>
<span class="quotelev3">&gt; &gt;&gt; This is the summary of my situation:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 1. I create a hostfile as shown below manually.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 2. I use mpirun to start the job without Torque, which means I'm
</span><br>
running in
<br>
<span class="quotelev3">&gt; &gt;&gt; an un-managed environment.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 3. Firstly, ORTE detects 8 slots on each host(maybe in
</span><br>
<span class="quotelev3">&gt; &gt;&gt; &quot;orte_ras_base_allocate&quot;).
</span><br>
<span class="quotelev3">&gt; &gt;&gt;   node05: slots=8 max_slots=0 slots_inuse=0
</span><br>
<span class="quotelev3">&gt; &gt;&gt;   node06: slots=8 max_slots=0 slots_inuse=0
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 4. Then, the code I identified is resetting the slot counts.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;   node05: slots=1 max_slots=0 slots_inuse=0
</span><br>
<span class="quotelev3">&gt; &gt;&gt;   node06: slots=1 max_slots=0 slots_inuse=0
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 5. Therefore, ORTE believes that there is only one slot on each host.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; No, I didn't use Torque this time.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; This issue is caused only when it is not in the managed
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; environment - namely, orte_managed_allocation is false
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; (and orte_set_slots is NULL).
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Under the torque management, it works fine.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; I hope you can understand the situation.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; I'm sorry, but I'm really confused, so let me try to understand the
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; You then use mpirun to start the job, but pass it a hostfile as
</span><br>
shown
<br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Somehow, ORTE believes that there is only one slot on each host, and
</span><br>
<span class="quotelev3">&gt; &gt;&gt; you
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; believe the code you've identified is resetting the slot counts.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; Torque manager. This time I executed it directly from command line
</span><br>
as
<br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; Then, I checked source files arroud it and found that the line
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 151-160
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; in
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; plm_base_launch_support.c caused this issue. As node-&gt;slots is
</span><br>
<span class="quotelev3">&gt; &gt;&gt; already
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; counted in hostfile.c @ r29765 even when node-&gt;slots_given is
</span><br>
false,
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; I think this part of plm_base_launch_support.c would be
</span><br>
unnecesarry.
<br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt; orte_set_default_slots is still alive. I think this would be better
</span><br>
