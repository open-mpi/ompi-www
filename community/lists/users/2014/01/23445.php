<?
$subject_val = "[OMPI users] Specific use case - very very new to MPI";
...
<!-- subject="[OMPI users] Specific use case - very very new to MPI" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Specific use case - very very new to MPI<br>
<strong>From:</strong> Kenneth Adam Miller (<em>kennethadammiller_at_[hidden]</em>)<br>
<strong>Date:</strong> 2014-01-24 12:28:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23446.php">etcamargo: "[OMPI users] Connection to lifeline lost"</a>
<li><strong>Previous message:</strong> <a href="23444.php">Fischer, Greg A.: "Re: [OMPI users] simple	test	problem	hangs	on	mpi_finalize	and	consumes all system resources"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23450.php">Kenneth Adam Miller: "Re: [OMPI users] Specific use case - very very new to MPI"</a>
<li><strong>Reply:</strong> <a href="23450.php">Kenneth Adam Miller: "Re: [OMPI users] Specific use case - very very new to MPI"</a>
<li><strong>Reply:</strong> <a href="23476.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Specific use case - very very new to MPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23445/attachment">attachment</a>
</ul>
