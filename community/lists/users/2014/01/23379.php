...
?>
<!-- received="Fri Jan 17 12:03:32 2014" -->
<!-- isoreceived="20140117170332" -->
<!-- sent="Fri, 17 Jan 2014 09:03:15 -0800" -->
<!-- isosent="20140117170315" -->
<!-- name="Ronald Cohen" -->
<!-- email="rhcohen_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks" -->
<!-- id="CAMuam9MFwpLAxhZ_AzdH-OyrMw_aKy89uc7UcM5G4QDtHXbOuw_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="9E376C91-AA53-4FEC-8557-7963BC40A20A_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-01-17 12:03:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23380.php">Ralph Castain: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<li><strong>Previous message:</strong> <a href="23378.php">Ralph Castain: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<li><strong>In reply to:</strong> <a href="23378.php">Ralph Castain: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23380.php">Ralph Castain: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<li><strong>Reply:</strong> <a href="23380.php">Ralph Castain: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
from the start.
<br>
<p>But now my problem is trying to get parallel HDF5 to run.  In my first
<br>
...
<br>
<p>Proc 0: *** MPIO File size range test...
<br>
--------------------------------
<br>
...
<br>
<p>And -- the specific errors reported, which processor, which location, and
<br>
the total number of errors changes if I rerun make check.
<br>
<p>I've sent configure, make and make check logs to the HDF5 help desk but
<br>
haven't gotten a response.
<br>
<p>I am now configuring openmpi (still 1.7.4rc1) with:
<br>
...
<br>
<p>and configuring HDF5 (version 1.8.12) with:
<br>
<p>configure --prefix=/usr/local/hdf5/par CC=mpicc CFLAGS=-fPIC FC=mpif90
<br>
FCFLAGS=-fPIC CXX=mpicxx CXXFLAGS=-fPIC --enable-parallel --enable-fortran
<br>
<p>This is the combination that worked for me with Snow Leopard (though it was
<br>
then earlier versions of both openmpi and hdf5.)
<br>
<p>If it matters, the gcc is the stock one with Mavericks' XCode, and gfortran
<br>
is 4.9.0.
<br>
<p>(I just noticed that the mpi fortran wrapper is now mpifort, but I also see
<br>
that mpif90 is still there and is a just link to mpifort.)
<br>
<p>Any suggestions?
<br>
<p><p>On Fri, Jan 17, 2014 at 8:14 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; sorry for delayed response - just getting back from travel. I don't know
</span><br>
<span class="quotelev1">&gt; why you would get that behavior other than a race condition. Afraid that
</span><br>
<span class="quotelev1">&gt; code path is foreign to me, but perhaps one of the folks in the MPI-IO area
</span><br>
<span class="quotelev1">&gt; can respond
</span><br>
...
<span class="quotelev1">&gt; Update: I reconfigured with enable_io_romio=yes, and this time -- mostly
</span><br>
...
<span class="quotelev1">&gt; But when I reran the same mpirun command, the test was successful.   And
</span><br>
...
<span class="quotelev2">&gt;&gt; Aha.   I guess I didn't know what the io-romio option does.   If you look
</span><br>
<span class="quotelev2">&gt;&gt; at my config.log you will see my configure line included
</span><br>
...
<span class="quotelev2">&gt;&gt; probably switch to that rather than 1.7.4rc1.   Am I reading between the
</span><br>
<span class="quotelev2">&gt;&gt; lines correctly?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; Oh, a word of caution on those config params - you might need to check
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to ensure I don't disable romio in them. I don't normally build it as I
</span><br>
<span class="quotelev3">&gt;&gt;&gt; don't use it. Since that is what you are trying to use, just change the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;no&quot; to &quot;yes&quot; (or delete that line altogether) and it will build.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; contrib/platform/intel/bend/mac. You are welcome to use them - just
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; configure --with-platform=intel/bend/mac
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I work on the developer's trunk, of course, but also run the head of
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the 1.7.4 branch (essentially the nightly tarball) on a fairly regular
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; basis.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; As for the opal_bitmap test: it wouldn't surprise me if that one was
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; stale. I can check on it later tonight, but I'd suspect that the test is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; bad as we use that class in the code base and haven't seen an issue.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; I regularly build on Mavericks and run without problem, though I
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; haven't tried a parallel IO app. I'll give yours a try later, when I get
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; back to my Mac.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I have been struggling trying to get a usable build of openmpi on
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Mac OSX Mavericks (10.9.1).  I can get openmpi to configure and build
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; without error, but have problems after that which depend on the openmpi
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ddt_raw tests.  The various atomic_* tests pass.    See checklogs_1.6.5,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; attached as a .gz file.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Following suggestions from openmpi discussions I tried openmpi
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; version 1.7.4rc1.  In this case make check indicates all tests passed.  But
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; when I proceeded to try to build a parallel code (parallel HDF5) it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; failed.  Following an email exchange with the HDF5 support people, they
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; suggested I try to compile and run the attached bit of simple code
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Sample_mpio.c (which they supplied) which does not use any HDF5, but just
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; attempts a parallel write to a file and parallel read.   That test failed
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; when requesting more than 1 processor -- which they say indicates a failure
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; of the openmpi installation.   The error message was:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ./mpitest.data
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; invalid file)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; MPI_ABORT[0]: comm MPI_COMM_WORLD errorcode 1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; MPI_BCAST[1]: buffer 7fff5a483048 count 1 datatype MPI_INT root 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; comm MPI_COMM_WORLD
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I then went back to my openmpi directories and tried running some
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; of the individual tests in the test and examples directories.  In
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; particular in test/class I found one test that seem to not be run as part
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; of make check which failed, even with one processor; this is opal_bitmap.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Not sure if this is because 1.7.4rc1 is incomplete, or there is something
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; wrong with the installation, or maybe a 32 vs 64 bit thing?   The error
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; message is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun detected that one or more processes exited with non-zero
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; status, thus causing the job to be terminated. The first process to do so
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Mavericks to work with sufficient success that they can get the attached
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Sample_mpio.c (or better yet, parallel HDF5) to build?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Details: Running Mac OS X 10.9.1 on a mid-2009 Macbook pro with 4
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; GB memory; tried openmpi 1.6.5 and 1.7.4rc1.  Built openmpi against the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; stock gcc that comes with XCode 5.0.2, and gfortran 4.9.0.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Files attached: config.log.gz, openmpialllog.gz (output of running
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ompi_info --all), checklog2.gz (output of make.check in top openmpi
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; have been successful, but can generate those if that would be helpful.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23379/attachment">attachment</a>
</ul>
