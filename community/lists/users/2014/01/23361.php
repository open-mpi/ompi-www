...
?>
<!-- received="Wed Jan 15 13:36:31 2014" -->
<!-- isoreceived="20140115183631" -->
<!-- sent="Wed, 15 Jan 2014 10:36:30 -0800" -->
<!-- isosent="20140115183630" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks" -->
<!-- id="CAMD57ofwdBrN2VQr8HnsxE+6vCAZ=+6o+Y7f4nFNLzJRsz=yJg_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CAMD57od9mi1c3+0ho1Rnya+Kg+edQFOytxtg1p1uLeRNE0KzvQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-01-15 13:36:30
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23362.php">Ronald Cohen: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<li><strong>Previous message:</strong> <a href="23360.php">Ralph Castain: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<li><strong>In reply to:</strong> <a href="23360.php">Ralph Castain: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23363.php">Ronald Cohen: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<li><strong>Reply:</strong> <a href="23363.php">Ronald Cohen: "Re: [OMPI users] Can't get a fully functional openmpi build on Mac OSX Mavericks"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Wed, Jan 15, 2014 at 10:34 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I regularly build on Mavericks and run without problem, though I haven't
</span><br>
...
<span class="quotelev2">&gt;&gt; I have been struggling trying to get a usable build of openmpi on Mac OSX
</span><br>
<span class="quotelev2">&gt;&gt; Mavericks (10.9.1).  I can get openmpi to configure and build without
</span><br>
...
<span class="quotelev2">&gt;&gt; 1.7.4rc1.  In this case make check indicates all tests passed.  But when I
</span><br>
<span class="quotelev2">&gt;&gt; proceeded to try to build a parallel code (parallel HDF5) it failed.
</span><br>
...
<span class="quotelev2">&gt;&gt; individual tests in the test and examples directories.  In particular in
</span><br>
<span class="quotelev2">&gt;&gt; test/class I found one test that seem to not be run as part of make check
</span><br>
<span class="quotelev2">&gt;&gt; which failed, even with one processor; this is opal_bitmap.  Not sure if
</span><br>
<span class="quotelev2">&gt;&gt; this is because 1.7.4rc1 is incomplete, or there is something wrong with
</span><br>
...
<span class="quotelev2">&gt;&gt; to work with sufficient success that they can get the attached
</span><br>
...
<span class="quotelev2">&gt;&gt; I am not attaching logs of make and install since those seem to have been
</span><br>
<span class="quotelev2">&gt;&gt; successful, but can generate those if that would be helpful.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23361/attachment">attachment</a>
</ul>
