...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23336.php">Axel Viðarsson: "Re: [OMPI users] Failing to MPI run on my linux cluster"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23336.php">Axel Viðarsson: "Re: [OMPI users] Failing to MPI run on my linux cluster"</a>
<li><strong>Reply:</strong> <a href="23336.php">Axel Viðarsson: "Re: [OMPI users] Failing to MPI run on my linux cluster"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
