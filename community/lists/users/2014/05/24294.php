...
?>
<!-- received="Tue May  6 19:29:00 2014" -->
<!-- isoreceived="20140506232900" -->
<!-- sent="Tue, 6 May 2014 18:28:59 -0500" -->
<!-- isosent="20140506232859" -->
<!-- name="Clay Kirkland" -->
<!-- email="clay.kirkland_at_[hidden]" -->
<!-- subject="Re: [OMPI users] users Digest, Vol 2881, Issue 1" -->
<!-- id="CAJDnjA90BuHWu_iHSSnNa1A4P35+O96RRXk19XnHWo-nSd_dqg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="mailman.30.1399392004.2373.users_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-05-06 19:28:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24295.php">Clay Kirkland: "Re: [OMPI users] users Digest, Vol 2881, Issue 1"</a>
<li><strong>Previous message:</strong> <a href="24293.php">Jeff Squyres (jsquyres): "Re: [OMPI users] users Digest, Vol 2879, Issue 1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24295.php">Clay Kirkland: "Re: [OMPI users] users Digest, Vol 2881, Issue 1"</a>
<li><strong>Reply:</strong> <a href="24295.php">Clay Kirkland: "Re: [OMPI users] users Digest, Vol 2881, Issue 1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>&nbsp;Clay
<br>
<p><p>On Tue, May 6, 2014 at 11:00 AM, &lt;users-request_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; Subject: [OMPI users] MPI_Barrier hangs on second attempt but only when
</span><br>
...
<span class="quotelev1">&gt; recommend to me how I can go about doing it (without root access).
</span><br>
...
<span class="quotelev1">&gt; installed via root and you don't have root access), then your best bet is
</span><br>
<span class="quotelev1">&gt; simply to install into a new tree.  E.g., if OMPI is installed into
</span><br>
<span class="quotelev1">&gt; /opt/openmpi-1.6.2, try installing into /opt/openmpi-1.6.5, or even
</span><br>
...
<span class="quotelev1">&gt; My install was in my user directory (i.e $HOME). I managed to locate the
</span><br>
...
<span class="quotelev1">&gt; On May 6, 2014, at 9:40 AM, Imran Ali &lt;imranal_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; $HOME/installs/openmpi-x.y.z.  Then if I don't want that install any more,
</span><br>
<span class="quotelev1">&gt; I can just &quot;rm -rf $HOME/installs/openmpi-x.y.z&quot; -- no need to &quot;make
</span><br>
<span class="quotelev1">&gt; uninstall&quot;.  Specifically: if there's nothing else installed in the same
</span><br>
...
<span class="quotelev1">&gt; If so, another thing to try is to limit the IP interfaces that MPI uses
</span><br>
<span class="quotelev1">&gt; for its traffic to see if there's some kind of problem with specific
</span><br>
...
<span class="quotelev1">&gt; If that works, then try adding in any/all other IP interfaces that you
</span><br>
<span class="quotelev1">&gt; have on your machines.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; A sorta-wild guess: you have some IP interfaces that aren't working, or at
</span><br>
<span class="quotelev1">&gt; least, don't work in the way that OMPI wants them to work.  So the first
</span><br>
<span class="quotelev1">&gt; barrier works because it flows across eth0 (or some other first network
</span><br>
<span class="quotelev1">&gt; that, as far as OMPI is concerned, works just fine).  But then the next
</span><br>
<span class="quotelev1">&gt; barrier round-robin advances to the next IP interface, and it doesn't work
</span><br>
<span class="quotelev1">&gt; for some reason.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; We've seen virtual machine bridge interfaces cause problems, for example.
</span><br>
<span class="quotelev1">&gt;  E.g., if a machine has a Xen virtual machine interface (vibr0, IIRC?),
</span><br>
<span class="quotelev1">&gt; then OMPI will try to use it to communicate with peer MPI processes because
</span><br>
<span class="quotelev1">&gt; it has a &quot;compatible&quot; IP address, and OMPI think it should be
</span><br>
<span class="quotelev1">&gt; connected/reachable to peers.  If this is the case, you might want to
</span><br>
<span class="quotelev1">&gt; disable such interfaces and/or use btl_tcp_if_include or btl_tcp_if_exclude
</span><br>
<span class="quotelev1">&gt; to select the interfaces that you want to use.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Pro tip: if you use btl_tcp_if_exclude, remember to exclude the loopback
</span><br>
<span class="quotelev1">&gt; interface, too.  OMPI defaults to a btl_tcp_if_include=&quot;&quot; (blank) and
</span><br>
<span class="quotelev1">&gt; btl_tcp_if_exclude=&quot;lo0&quot;. So if you override btl_tcp_if_exclude, you need
</span><br>
...
<span class="quotelev1">&gt; On May 4, 2014, at 2:15 PM, Clay Kirkland &lt;clay.kirkland_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev2">&gt; &gt; Hmmm...just testing on my little cluster here on two nodes, it works
</span><br>
...
<span class="quotelev2">&gt; &gt; On May 2, 2014, at 2:24 PM, Clay Kirkland &lt;clay.kirkland_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev3">&gt; &gt; &gt; and reinstalled the same version on both hosts but I still see the
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; one of two machines by itself  many times with no hangs.  Only hangs
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;   Here are three runs of test program.  First with two processes on
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;   Since it is such a simple test and problem and such a widely used
</span><br>
<span class="quotelev1">&gt; MPI function, it must obviously
</span><br>
<span class="quotelev3">&gt; &gt; &gt; be an installation or configuration problem.   A pstack for each of
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24294/attachment">attachment</a>
</ul>
