...
?>
<!-- received="Thu May  8 16:59:51 2014" -->
<!-- isoreceived="20140508205951" -->
<!-- sent="Thu, 8 May 2014 15:59:50 -0500" -->
<!-- isosent="20140508205950" -->
<!-- name="Rob Latham" -->
<!-- email="robl_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ROMIO bug reading darrays" -->
<!-- id="536BF046.8090408_at_mcs.anl.gov" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2014-05-08 16:59:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24324.php">Rob Latham: "Re: [OMPI users] ROMIO bug reading darrays"</a>
<li><strong>Previous message:</strong> <a href="24322.php">George Bosilca: "Re: [OMPI users] MPI_Alltoall with Vector Datatype"</a>
<li><strong>In reply to:</strong> <a href="24286.php">Richard Shaw: "[OMPI users] ROMIO bug reading darrays"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24327.php">Richard Shaw: "Re: [OMPI users] ROMIO bug reading darrays"</a>
<li><strong>Reply:</strong> <a href="24327.php">Richard Shaw: "Re: [OMPI users] ROMIO bug reading darrays"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Richard: may I add this test case to ROMIO's test suite?  I'm always on 
<br>
the hunt for small self-contained tests.
<br>
<p>I found the problem in MPICH, but i don't know how it relates to OpenMPI 
<br>
-- the darray bug is one I introduced on tuesday, so OpenMPI's ROMIO 
<br>
code should not have a problem with this darray type.
<br>
<p>==rob
<br>
