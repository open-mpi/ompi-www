...
?>
<!-- received="Tue May  6 20:14:16 2014" -->
<!-- isoreceived="20140507001416" -->
<!-- sent="Tue, 6 May 2014 19:14:15 -0500" -->
<!-- isosent="20140507001415" -->
<!-- name="Clay Kirkland" -->
<!-- email="clay.kirkland_at_[hidden]" -->
<!-- subject="Re: [OMPI users] users Digest, Vol 2881, Issue 2" -->
<!-- id="CAJDnjA9O8D7Y4pKgVAmpu6OVU5CPV+8hbr8p21ea0SfW8OYfJA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="mailman.3526.1399420252.6754.users_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-05-06 20:14:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24298.php">Ralph Castain: "Re: [OMPI users] users Digest, Vol 2881, Issue 2"</a>
<li><strong>Previous message:</strong> <a href="24296.php">Ralph Castain: "Re: [OMPI users] users Digest, Vol 2881, Issue 1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24298.php">Ralph Castain: "Re: [OMPI users] users Digest, Vol 2881, Issue 2"</a>
<li><strong>Reply:</strong> <a href="24298.php">Ralph Castain: "Re: [OMPI users] users Digest, Vol 2881, Issue 2"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>eth1      Link encap:Ethernet  HWaddr 00:25:90:73:2A:37
<br>
...
<br>
<p>&nbsp;And from one that I can't get to work:
<br>
<p>[root_at_centos ~]# ifconfig -a
<br>
...
<br>
<p>eth1      Link encap:Ethernet  HWaddr 00:14:D1:22:8E:50
<br>
...
<br>
<p><p>&nbsp;The centos machine is using eth1 and not eth0, therein lies the problem.
<br>
<p>&nbsp;I don't really need all this optimization of using multiple ethernet
<br>
...
<br>
<p><p><p><p>On Tue, May 6, 2014 at 6:50 PM, &lt;users-request_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/MailArchives/users/attachments/20140505/5a5ab0ba/attachment.bin">http://www.open-mpi.org/MailArchives/users/attachments/20140505/5a5ab0ba/attachment.bin</a>
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; My install was in my user directory (i.e $HOME). I managed to locate
</span><br>
<span class="quotelev1">&gt; the
</span><br>
<span class="quotelev2">&gt; &gt; source directory and successfully run make uninstall.
...
<span class="quotelev2">&gt; &gt; $HOME/installs/openmpi-x.y.z.  Then if I don't want that install any
</span><br>
...
<span class="quotelev2">&gt; &gt; A sorta-wild guess: you have some IP interfaces that aren't working, or
</span><br>
...
<span class="quotelev2">&gt; &gt; barrier round-robin advances to the next IP interface, and it doesn't
</span><br>
...
<span class="quotelev2">&gt; &gt; then OMPI will try to use it to communicate with peer MPI processes
</span><br>
...
<span class="quotelev2">&gt; &gt; disable such interfaces and/or use btl_tcp_if_include or
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;  I am configuring with all defaults.   Just doing a ./configure and
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; having trouble on either openmpi-1.4.5  or  openmpi-1.6.5 versions
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; I run with two or more hosts the second call to MPI_Barrier always
</span><br>
<span class="quotelev1">&gt; hangs.
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Not the first one,
</span><br>
<span class="quotelev3">&gt; &gt; &gt; but always the second one.   I looked at FAQ's and such but found
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; [root_at_centos MPI]# /usr/local/bin/mpirun -np 2 --host centos,RAID
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; #6  0x00007f5ddc59d8ff in ompi_coll_tuned_barrier_intra_two_procs ()
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; #6  0x00007f7ee06138ff in ompi_coll_tuned_barrier_intra_two_procs ()
</span><br>
<span class="quotelev1">&gt; from
</span><br>
<span class="quotelev3">&gt; &gt; &gt; /usr/local/lib/openmpi/mca_coll_tuned.so
...
<span class="quotelev3">&gt; &gt; &gt; On May 2, 2014, at 2:24 PM, Clay Kirkland &lt;
</span><br>
<span class="quotelev1">&gt; clay.kirkland_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt; &gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
...
<span class="quotelev4">&gt; &gt; &gt; &gt; MPI_Barrier calls to work.   It works fine when I run all processes
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; two processes on another host, and finally with one process on each
</span><br>
...
<span class="quotelev2">&gt; &gt;  That last trick seems to work.  I can get it to work once in a while
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; In the testcase I first initialise an array of 25 doubles (which will
</span><br>
<span class="quotelev1">&gt; be a
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 5x5 grid), then I create a datatype representing a 5x5 matrix
</span><br>
<span class="quotelev1">&gt; distributed
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; think is correct). Then I write the original array of 25 doubles to
</span><br>
<span class="quotelev1">&gt; disk,
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; dorsal script (<a href="https://github.com/FEniCS/dorsal">https://github.com/FEniCS/dorsal</a>) for Redhat Enterprise
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; installed via root and you don't have root access), then your best bet
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt; &gt; If you don't have write access into the installation tree (i.e., it
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; $HOME/installs/openmpi-x.y.z.  Then if I don't want that install any
</span><br>
<span class="quotelev1">&gt; more,
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; at least, don't work in the way that OMPI wants them to work.  So the
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; barrier round-robin advances to the next IP interface, and it doesn't
</span><br>
<span class="quotelev1">&gt; work
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; We've seen virtual machine bridge interfaces cause problems, for
</span><br>
<span class="quotelev1">&gt; example.
</span><br>
<span class="quotelev3">&gt; &gt;&gt;  E.g., if a machine has a Xen virtual machine interface (vibr0, IIRC?),
</span><br>
<span class="quotelev3">&gt; &gt;&gt; then OMPI will try to use it to communicate with peer MPI processes
</span><br>
<span class="quotelev1">&gt; because
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; disable such interfaces and/or use btl_tcp_if_include or
</span><br>
<span class="quotelev1">&gt; btl_tcp_if_exclude
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; btl_tcp_if_exclude=&quot;lo0&quot;. So if you override btl_tcp_if_exclude, you
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt; &gt;  I am configuring with all defaults.   Just doing a ./configure and
</span><br>
<span class="quotelev1">&gt; then
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt; &gt; On May 2, 2014, at 2:24 PM, Clay Kirkland &lt;
</span><br>
<span class="quotelev1">&gt; clay.kirkland_at_[hidden]&gt;
</span><br>
<span class="quotelev3">&gt; &gt;&gt; wrote:
...
<span class="quotelev1">&gt; &gt;&gt; &gt; &gt;  Which looks exactly the same on each machine.  Any thoughts or
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24297/attachment">attachment</a>
</ul>
