...
?>
<!-- received="Thu May 22 06:30:36 2014" -->
<!-- isoreceived="20140522103036" -->
<!-- sent="Thu, 22 May 2014 10:30:33 +0000" -->
<!-- isosent="20140522103033" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How to run Open MPI over TCP (Ethernet)" -->
<!-- id="E41FEA4A-3B93-42F4-BA13-79DF50ED0679_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-05-22 06:30:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24454.php">Jeff Squyres (jsquyres): "Re: [OMPI users] False positive from valgrind in sec_basic.c"</a>
<li><strong>Previous message:</strong> <a href="24452.php">Bibrak Qamar: "[OMPI users] How to run Open MPI over TCP (Ethernet)"</a>
<li><strong>In reply to:</strong> <a href="24452.php">Bibrak Qamar: "[OMPI users] How to run Open MPI over TCP (Ethernet)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24455.php">Bibrak Qamar: "Re: [OMPI users] How to run Open MPI over TCP (Ethernet)"</a>
<li><strong>Reply:</strong> <a href="24455.php">Bibrak Qamar: "Re: [OMPI users] How to run Open MPI over TCP (Ethernet)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Can you send the output of ifconfig on both compute-0-15.local and compute-0-16.local?
<br>
<p><p>On May 22, 2014, at 3:30 AM, Bibrak Qamar &lt;bibrakc_at_[hidden]&gt; wrote:
<br>
