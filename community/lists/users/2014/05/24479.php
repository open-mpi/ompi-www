...
?>
<!-- received="Mon May 26 10:09:37 2014" -->
<!-- isoreceived="20140526140937" -->
<!-- sent="Mon, 26 May 2014 07:09:32 -0700" -->
<!-- isosent="20140526140932" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] divide-by-zero in mca_btl_openib_add_procs" -->
<!-- id="ED39F398-7D66-4EA9-855E-56145219F7B4_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-05-26 10:09:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24480.php">Iván Cores González: "Re: [OMPI users] MPI_Finalize() maintains load at 100%."</a>
<li><strong>Previous message:</strong> <a href="24478.php">Alain Miniussi: "[OMPI users] divide-by-zero in mca_btl_openib_add_procs"</a>
<li><strong>In reply to:</strong> <a href="24478.php">Alain Miniussi: "[OMPI users] divide-by-zero in mca_btl_openib_add_procs"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24481.php">Alain Miniussi: "Re: [OMPI users] divide-by-zero in mca_btl_openib_add_procs"</a>
<li><strong>Reply:</strong> <a href="24481.php">Alain Miniussi: "Re: [OMPI users] divide-by-zero in mca_btl_openib_add_procs"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>mpirun -n 1 ./a.out
<br>
<p>just to see if it is the singleton that is causing the problem, or something in the openib btl itself.
<br>
<p><p>On May 26, 2014, at 6:59 AM, Alain Miniussi &lt;alain.miniussi_at_oca.eu&gt; wrote:
<br>
