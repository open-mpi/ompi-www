...
?>
<!-- received="Thu May  8 15:14:18 2014" -->
<!-- isoreceived="20140508191418" -->
<!-- sent="Thu, 8 May 2014 14:14:17 -0500" -->
<!-- isosent="20140508191417" -->
<!-- name="Rob Latham" -->
<!-- email="robl_at_[hidden]" -->
<!-- subject="Re: [OMPI users] ROMIO bug reading darrays" -->
<!-- id="536BD789.8040602_at_mcs.anl.gov" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2014-05-08 15:14:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24318.php">Spenser Gilliland: "Re: [OMPI users] MPI_Alltoall with Vector Datatype"</a>
<li><strong>Previous message:</strong> <a href="24316.php">Richard Shaw: "Re: [OMPI users] ROMIO bug reading darrays"</a>
<li><strong>In reply to:</strong> <a href="24303.php">Rob Latham: "Re: [OMPI users] ROMIO bug reading darrays"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24324.php">Rob Latham: "Re: [OMPI users] ROMIO bug reading darrays"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Fascinating.  I can reproduce the bug with ROMIO from MPICH master.. 
<br>
.because a patch I put in three days ago is not playing nicely with this 
<br>
particular darray.
<br>
<p>However, mpich/master from last week deals with this datatype just fine.
<br>
<p>But, the ROMIO from mpich/master and the ROMIO in OpenMPI should be 
<br>
