...
?>
<!-- received="Sun Jun  8 16:54:57 2014" -->
<!-- isoreceived="20140608205457" -->
<!-- sent="Sun, 8 Jun 2014 13:54:53 -0700" -->
<!-- isosent="20140608205453" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1" -->
<!-- id="5C6F4BFA-D5A6-467E-ADD8-76372474188C_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-06-08 16:54:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24598.php">tmishima_at_[hidden]: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<li><strong>Previous message:</strong> <a href="24596.php">Ralph Castain: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<li><strong>In reply to:</strong> <a href="24585.php">Dan Dietz: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24600.php">Dan Dietz: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<li><strong>Reply:</strong> <a href="24600.php">Dan Dietz: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<li><strong>Reply:</strong> <a href="24629.php">Dan Dietz: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Out of curiosity, can you try running this with &quot;-mca plm rsh&quot;? This will substitute the rsh/ssh launcher in place of Torque - assuming your system will allow it, this will let me see if the problem is somewhere in the Torque launcher or elsewhere in OMPI.
<br>
<p>Thanks
<br>
Ralph
<br>
<p>On Jun 6, 2014, at 12:48 PM, Dan Dietz &lt;ddietz_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; No problem -
</span><br>
