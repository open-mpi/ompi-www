...
?>
<!-- received="Tue Jun 10 14:57:52 2014" -->
<!-- isoreceived="20140610185752" -->
<!-- sent="Tue, 10 Jun 2014 12:57:50 -0600" -->
<!-- isosent="20140610185750" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openib segfaults with Torque" -->
<!-- id="20140610185750.GB93892_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="C86C7F6037A63C44BCCD0D77E9D59BFE159F01006B_at_SWEC9985.w-intra.net" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-10 14:57:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24626.php">Fischer, Greg A.: "Re: [OMPI users] openib segfaults with Torque"</a>
<li><strong>Previous message:</strong> <a href="24624.php">Fischer, Greg A.: "Re: [OMPI users] openib segfaults with Torque"</a>
<li><strong>In reply to:</strong> <a href="24624.php">Fischer, Greg A.: "Re: [OMPI users] openib segfaults with Torque"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24626.php">Fischer, Greg A.: "Re: [OMPI users] openib segfaults with Torque"</a>
<li><strong>Reply:</strong> <a href="24626.php">Fischer, Greg A.: "Re: [OMPI users] openib segfaults with Torque"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev2">&gt; &gt;       mpirun -mca btl openib,self -mca btl_base_verbose 100 -np 2 ring_c &amp;&gt;
</span><br>
<span class="quotelev2">&gt; &gt; output.txt
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; something in the finalization process didn't take that into account
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; system: udcm_module_init should not be failing! It creates a couple
</span><br>
<span class="quotelev3">&gt; &gt; &gt; of CQs, allocates a small number of registered bufferes and starts
</span><br>
<span class="quotelev3">&gt; &gt; &gt; monitoring the fd for the completion channel. All these things are
</span><br>
<span class="quotelev3">&gt; &gt; &gt; also done in the setup of the openib btl itself. Keep in mind that
</span><br>
<span class="quotelev3">&gt; &gt; &gt; the openib btl will not disqualify itself when running single server.
</span><br>
...
<span class="quotelev2">&gt; &gt; ../../../../../openmpi-1.8.1/ompi/mca/btl/openib/connect/btl_openib_co
</span><br>
...
<span class="quotelev2">&gt; &gt; ../../../../../openmpi-1.8.1/ompi/mca/pml/ob1/pml_ob1_component.c:271
</span><br>
...
<span class="quotelev2">&gt; &gt; #12 0x00007f8b6b3d233c in ompi_mpi_init (argc=1, argv=0x7fffe34cf0e8,
</span><br>
<span class="quotelev2">&gt; &gt; requested=0, provided=0x7fffe34cef98) at
</span><br>
...
<span class="quotelev2">&gt; &gt; base: components_register: component self register function successful
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24591] mca: base: components_open: opening btl components
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24591] mca: base: components_open: found loaded component
</span><br>
<span class="quotelev2">&gt; &gt; openib [binf316:24591] mca: base: components_open: component openib
</span><br>
<span class="quotelev2">&gt; &gt; open function successful [binf316:24591] mca: base: components_open:
</span><br>
...
<span class="quotelev2">&gt; &gt; [binf316:24592] mca: base: components_open: opening btl components
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] mca: base: components_open: found loaded component
</span><br>
<span class="quotelev2">&gt; &gt; openib [binf316:24592] mca: base: components_open: component openib
</span><br>
<span class="quotelev2">&gt; &gt; open function successful [binf316:24592] mca: base: components_open:
</span><br>
...
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],0][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/btl_openib_ip.c:364:add_rdma_addr] Adding addr 9.9.10.75
</span><br>
<span class="quotelev2">&gt; &gt; (0x4b0a0909) subnet 0x9090000 as mlx4_0:1
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],1][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/btl_openib_ip.c:364:add_rdma_addr] Adding addr 9.9.10.75
</span><br>
<span class="quotelev2">&gt; &gt; (0x4b0a0909) subnet 0x9090000 as mlx4_0:1
...
<span class="quotelev2">&gt; &gt; b/btl_openib_component.c:686:init_one_port] looking for mlx4_0:1 GID
</span><br>
<span class="quotelev2">&gt; &gt; index 0
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],0][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/btl_openib_component.c:717:init_one_port] my IB subnet_id for HCA
</span><br>
<span class="quotelev2">&gt; &gt; mlx4_0 port 1 is fe80000000000000
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],0][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/btl_openib_component.c:1294:setup_qps] pp: rd_num is 256 rd_low is
</span><br>
<span class="quotelev2">&gt; &gt; 192 rd_win 128 rd_rsv 4
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],0][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/btl_openib_component.c:1339:setup_qps] srq: rd_num is 1024 rd_low is
</span><br>
...
<span class="quotelev2">&gt; &gt; b/btl_openib_ip.c:132:mca_btl_openib_rdma_get_ipv4addr] Looking for
</span><br>
<span class="quotelev2">&gt; &gt; mlx4_0:1 in IP address list
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],0][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/btl_openib_ip.c:141:mca_btl_openib_rdma_get_ipv4addr] FOUND:
</span><br>
<span class="quotelev2">&gt; &gt; mlx4_0:1 is 9.9.10.75 (0x4b0a0909)
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],0][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/connect/btl_openib_connect_rdmacm.c:1750:ipaddrcheck] Found device
</span><br>
<span class="quotelev2">&gt; &gt; mlx4_0:1 = IP address 9.9.10.75 (0x4b0a0909):51845
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],0][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/connect/btl_openib_connect_rdmacm.c:1776:ipaddrcheck] creating new
</span><br>
<span class="quotelev2">&gt; &gt; server to listen on 9.9.10.75 (0x4b0a0909):51845 [binf316:24591]
</span><br>
<span class="quotelev2">&gt; &gt; openib BTL: rdmacm CPC available for use on mlx4_0:1
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],0][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/connect/btl_openib_connect_udcm.c:542:udcm_module_init] created cpc
</span><br>
<span class="quotelev2">&gt; &gt; module 0x719220 for btl 0x716ee0
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],1][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/btl_openib_component.c:686:init_one_port] looking for mlx4_0:1 GID
...
<span class="quotelev2">&gt; &gt; b/connect/btl_openib_connect_udcm.c:565:udcm_module_init] error
</span><br>
...
<span class="quotelev2">&gt; &gt; server to listen on 9.9.10.75 (0x4b0a0909):57734 [binf316:24592]
</span><br>
<span class="quotelev2">&gt; &gt; openib BTL: rdmacm CPC available for use on mlx4_0:1
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],1][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
...
<span class="quotelev2">&gt; &gt; module 0x7190c0 for btl 0x717060
</span><br>
<span class="quotelev2">&gt; &gt; [binf316][[17980,1],1][../../../../../openmpi-1.8.1/ompi/mca/btl/openi
</span><br>
<span class="quotelev2">&gt; &gt; b/connect/btl_openib_connect_udcm.c:565:udcm_module_init] error
...
<span class="quotelev2">&gt; &gt; Signal: Aborted (6) [binf316:24592] Signal code:  (-6) [binf316:24591]
</span><br>
<span class="quotelev2">&gt; &gt; [ 0] /lib64/libpthread.so.0(+0xf7c0)[0x7fb35959c7c0]
</span><br>
...
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/openmpi/mca_bt
</span><br>
<span class="quotelev2">&gt; &gt; l_openib.so(+0x3784b)[0x7fb3548e284b]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24591] [ 5]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/openmpi/mca_bt
</span><br>
<span class="quotelev2">&gt; &gt; l_openib.so(+0x36474)[0x7fb3548e1474]
</span><br>
...
<span class="quotelev2">&gt; &gt; l_openib.so(+0x18817)[0x7fb3548c3817]
</span><br>
...
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/libmpi.so.1(mc
</span><br>
<span class="quotelev2">&gt; &gt; a_btl_base_select+0x1b2)[0x7fb35986ba5e]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24591] [ 9] /lib64/libc.so.6(gsignal+0x35)[0x7f8b6ae1cb55]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [ 2]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/openmpi/mca_bm
</span><br>
<span class="quotelev2">&gt; &gt; l_r2.so(mca_bml_r2_component_init+0x20)[0x7fb354b05d42]
</span><br>
...
<span class="quotelev2">&gt; &gt; a_bml_base_init+0xd6)[0x7fb35986ad1b]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24591] [11]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/openmpi/mca_pm
</span><br>
<span class="quotelev2">&gt; &gt; l_ob1.so(+0x7739)[0x7fb353a2b739] [binf316:24591] [12]
</span><br>
...
<span class="quotelev2">&gt; &gt; l_openib.so(+0x3784b)[0x7f8b664b684b]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [ 5]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/openmpi/mca_bt
</span><br>
<span class="quotelev2">&gt; &gt; l_openib.so(+0x36474)[0x7f8b664b5474]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [ 6]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/libmpi.so.1(mc
</span><br>
<span class="quotelev2">&gt; &gt; a_pml_base_select+0x26e)[0x7fb3598919b2]
</span><br>
...
<span class="quotelev2">&gt; &gt; l_openib.so(+0x18817)[0x7f8b66497817]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [ 8]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/libmpi.so.1(om
</span><br>
...
<span class="quotelev2">&gt; &gt; a_btl_base_select+0x1b2)[0x7f8b6b43fa5e]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [ 9]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/openmpi/mca_bm
</span><br>
<span class="quotelev2">&gt; &gt; l_r2.so(mca_bml_r2_component_init+0x20)[0x7f8b666d9d42]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [10]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/libmpi.so.1(MP
</span><br>
<span class="quotelev2">&gt; &gt; I_Init+0x17e)[0x7fb359833386]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24591] [15] ring_c[0x40096f]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24591] [16]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/libmpi.so.1(mc
</span><br>
<span class="quotelev2">&gt; &gt; a_bml_base_init+0xd6)[0x7f8b6b43ed1b]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [11]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/openmpi/mca_pm
</span><br>
<span class="quotelev2">&gt; &gt; l_ob1.so(+0x7739)[0x7f8b655ff739] [binf316:24592] [12]
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/libmpi.so.1(mc
</span><br>
<span class="quotelev2">&gt; &gt; a_pml_base_select+0x26e)[0x7f8b6b4659b2]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [13]
</span><br>
<span class="quotelev2">&gt; &gt; /lib64/libc.so.6(__libc_start_main+0xe6)[0x7fb359234c36]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24591] [17] ring_c[0x400889]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24591] *** End of error message ***
</span><br>
<span class="quotelev2">&gt; &gt; /xxxx/yyyy_ib/gcc-4.8.3/toolset/openmpi-1.8.1_debug/lib/libmpi.so.1(om
</span><br>
...
<span class="quotelev2">&gt; &gt; [binf316:24592] [15] ring_c[0x40096f]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [16]
</span><br>
<span class="quotelev2">&gt; &gt; /lib64/libc.so.6(__libc_start_main+0xe6)[0x7f8b6ae08c36]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] [17] ring_c[0x400889]
</span><br>
<span class="quotelev2">&gt; &gt; [binf316:24592] *** End of error message ***
</span><br>
<span class="quotelev2">&gt; &gt; ----------------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt; &gt; ---- mpirun noticed that process rank 0 with PID 24591 on node xxxx316
</span><br>
...
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24625/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
