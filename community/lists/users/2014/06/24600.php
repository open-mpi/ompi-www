...
?>
<!-- received="Mon Jun  9 09:34:18 2014" -->
<!-- isoreceived="20140609133418" -->
<!-- sent="Mon, 9 Jun 2014 09:34:16 -0400" -->
<!-- isosent="20140609133416" -->
<!-- name="Dan Dietz" -->
<!-- email="ddietz_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1" -->
<!-- id="CABy+9wFDvYKSRR58YUtfbOgKLLJOfQKWKbg0=WXfk5y9K=+XmQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="5C6F4BFA-D5A6-467E-ADD8-76372474188C_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-09 09:34:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24601.php">Dan Dietz: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<li><strong>Previous message:</strong> <a href="24599.php">Ralph Castain: "Re: [OMPI users] Determining what parameters a scheduler passes	to	OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="24597.php">Ralph Castain: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24601.php">Dan Dietz: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<li><strong>Reply:</strong> <a href="24601.php">Dan Dietz: "Re: [OMPI users] Bind multiple cores to rank - OpenMPI 1.8.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>This system is down for maintenance for a few days so it'll be a bit
<br>
before I can get more out of it.
<br>
<p>On the slot issue - OK, which machinefile should I use? If I use my
<br>
modified one (2 lines per node) I still get the same error when using
<br>
&quot;socket&quot; or &quot;slot&quot;.
<br>
<p>When using the Torque provided one I seem to get some weird behavior.
<br>
With 2 processes, I end up with 1 on each of my allocated nodes and
<br>
then I get this:
<br>
<p>$ mpirun --display-allocation -np 2 -map-by socket:pe=8 ./hello
<br>
<p>======================   ALLOCATED NODES   ======================
<br>
...
Dan
<br>
<p><p><p>On Sun, Jun 8, 2014 at 4:54 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
