...
?>
<!-- received="Wed Jun  4 16:48:01 2014" -->
<!-- isoreceived="20140604204801" -->
<!-- sent="Wed, 4 Jun 2014 13:47:57 -0700" -->
<!-- isosent="20140604204757" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] intermittent segfaults with openib on ring_c.c" -->
<!-- id="465792FF-6E60-413E-95C1-2A20F08E4875_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="C86C7F6037A63C44BCCD0D77E9D59BFE159ED31609_at_SWEC9985.w-intra.net" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-04 16:47:57
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24541.php">Fischer, Greg A.: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<li><strong>Previous message:</strong> <a href="24539.php">Fischer, Greg A.: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<li><strong>In reply to:</strong> <a href="24539.php">Fischer, Greg A.: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24541.php">Fischer, Greg A.: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<li><strong>Reply:</strong> <a href="24541.php">Fischer, Greg A.: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt; #1  0x00002b82b1a47e38 in opal_memory_ptmalloc2_malloc (bytes=47840385564704) at ../../../../../openmpi-1.8.1/opal/mca/memory/linux/malloc.c:3433
</span><br>
<span class="quotelev1">&gt; #2  0x00002b82b1a47b36 in opal_memory_linux_malloc_hook (sz=47840385564704, caller=0x2b82b53000b8) at ../../../../../openmpi-1.8.1/opal/mca/memory/linux/hooks.c:691
</span><br>
<span class="quotelev1">&gt; #3  0x00002b82b19e7b18 in opal_malloc (size=47840385564704, file=0x2b82b53000b8 &quot;&quot;, line=12) at ../../../openmpi-1.8.1/opal/util/malloc.c:101
</span><br>
<span class="quotelev1">&gt; #4  0x00002b82b199c017 in opal_hash_table_set_value_uint64 (ht=0x2b82b5300020, key=47840385564856, value=0xc) at ../../openmpi-1.8.1/opal/class/opal_hash_table.c:283
</span><br>
<span class="quotelev1">&gt; #5  0x00002b82b170e4ca in process_uri (uri=0x2b82b5300020 &quot;\001&quot;) at ../../../../openmpi-1.8.1/orte/mca/oob/base/oob_base_stubs.c:348
</span><br>
<span class="quotelev1">&gt; #6  0x00002b82b170e941 in orte_oob_base_set_addr (fd=-1255145440, args=184, cbdata=0xc) at ../../../../openmpi-1.8.1/orte/mca/oob/base/oob_base_stubs.c:296
</span><br>
<span class="quotelev1">&gt; #7  0x00002b82b19fba1c in event_process_active_single_queue (base=0x655480, activeq=0x654920) at ../../../../../../openmpi-1.8.1/opal/mca/event/libevent2021/libevent/event.c:1367
</span><br>
<span class="quotelev1">&gt; #8  0x00002b82b19fbcd9 in event_process_active (base=0x655480) at ../../../../../../openmpi-1.8.1/opal/mca/event/libevent2021/libevent/event.c:1437
</span><br>
<span class="quotelev1">&gt; #9  0x00002b82b19fc4c3 in opal_libevent2021_event_base_loop (base=0x655480, flags=1) at ../../../../../../openmpi-1.8.1/opal/mca/event/libevent2021/libevent/event.c:1645
</span><br>
<span class="quotelev1">&gt; #10 0x00002b82b16f8763 in orte_progress_thread_engine (obj=0x2b82b5300020) at ../../../../openmpi-1.8.1/orte/mca/ess/base/ess_base_std_app.c:456
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; ../../../../openmpi-1.8.1/orte/mca/routed/base/routed_base_fns.c:30
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; ../../../../../openmpi-1.8.1/orte/mca/routed/binomial/routed_binomi
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Castain *Sent:*Wednesday, June 04, 2014 11:00 AM *To:*Open MPI
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; line number down as deep as possible might help identify the source
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Jun 4, 2014, at 7:55 AM, Fischer, Greg A.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Oops, ulimit was set improperly. I generated a core file, loaded it
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; in GDB, and ran a backtrace:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Core was generated by `ring_c'.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Program terminated with signal 11, Segmentation fault.
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/libopen-pa
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; l.so.6(opal_memory_ptmalloc2_int_malloc+0x4b3)[0x2b2fa4ff2b03]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [binf112:05845] [ 2]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/libopen-pa
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; l.so.6(opal_memory_ptmalloc2_malloc+0x58)[0x2b2fa4ff5288]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [binf112:05845] [ 3]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/libopen-pa
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; l.so.6(+0xd1f86)[0x2b2fa4ff4f86] [binf112:05845] [ 4]
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/libopen-rt
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; e.so.7(orte_util_convert_process_name_to_string+0xe2)[0x2b2fa4c873e
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; e.so.7(orte_oob_base_get_addr+0x25)[0x2b2fa4cbdb15]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [binf112:05845] [ 8]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/openmpi/mc
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; a_rml_oob.so(orte_rml_oob_get_uri+0xa)[0x2b2fa79c5d2a]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [binf112:05845] [ 9]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/libopen-rt
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; e.so.7(orte_routed_base_register_sync+0x1fd)[0x2b2fa4cdae7d]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [binf112:05845] [10]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/openmpi/mc
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; a_routed_binomial.so(+0x3c7b)[0x2b2fa719bc7b]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [binf112:05845] [11]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/libopen-rt
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; e.so.7(orte_ess_base_app_setup+0x3ad)[0x2b2fa4ca7c8d]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [binf112:05845] [12]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/openmpi/mc
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; a_ess_env.so(+0x169f)[0x2b2fa6b8f69f]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [binf112:05845] [13]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.8.1/lib/libopen-rt
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; e.so.7(orte_init+0x17b)[0x2b2fa4c764bb]
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Castain *Sent:*Tuesday, June 03, 2014 11:54 PM *To:*Open MPI Users
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; *Subject:*Re: [OMPI users] intermittent segfaults with openib on
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; ring_c.c Sounds odd - can you configure OMPI --enable-debug and run it again?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; If it fails and you can get a core dump, could you tell us the line
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; number where it is failing?
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; LD_LIBRARY_PATH is set correctly, and the version of &quot;mpirun&quot; being
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; invoked is correct. The output of ompi_info -all is attached.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; /xxxx/yyyy_ib/intel-12.1.0.233/toolset/openmpi-1.6.5/lib/openmpi/mc
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &lt;ibv_devinfo.txt&gt;&lt;ifconfig.txt&gt;____________________________________
</span><br>
