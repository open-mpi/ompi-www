...
?>
<!-- received="Fri Jun  6 09:47:12 2014" -->
<!-- isoreceived="20140606134712" -->
<!-- sent="Fri, 6 Jun 2014 09:47:01 -0400" -->
<!-- isosent="20140606134701" -->
<!-- name="Fischer, Greg A." -->
<!-- email="fischega_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openib segfaults with Torque" -->
<!-- id="C86C7F6037A63C44BCCD0D77E9D59BFE159EE10CC8_at_SWEC9985.w-intra.net" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4E482633-F4BE-411B-8E37-23517C65F8B9_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-06 09:47:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24565.php">Ralph Castain: "Re: [OMPI users] openib segfaults with Torque"</a>
<li><strong>Previous message:</strong> <a href="24563.php">Ralph Castain: "Re: [OMPI users] [warn] Epoll ADD(1) on fd 0 failed"</a>
<li><strong>In reply to:</strong> <a href="24559.php">Ralph Castain: "Re: [OMPI users] openib segfaults with Torque"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24565.php">Ralph Castain: "Re: [OMPI users] openib segfaults with Torque"</a>
<li><strong>Reply:</strong> <a href="24565.php">Ralph Castain: "Re: [OMPI users] openib segfaults with Torque"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Here are the results when logging in to the compute node via ssh and running as you suggest:
<br>
...
<br>
<p><p>Here's the command I'm invoking and the terminal output.  (Some of this information doesn't appear to be captured in the backtrace.)
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24564/attachment">attachment</a>
</ul>
