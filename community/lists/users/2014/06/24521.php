...
?>
<!-- received="Tue Jun  3 07:43:17 2014" -->
<!-- isoreceived="20140603114317" -->
<!-- sent="Tue, 03 Jun 2014 13:43:15 +0200" -->
<!-- isosent="20140603114315" -->
<!-- name="Alain Miniussi" -->
<!-- email="alain.miniussi_at_[hidden]" -->
<!-- subject="Re: [OMPI users] divide-by-zero in mca_btl_openib_add_procs" -->
<!-- id="538DB4D3.30904_at_oca.eu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="21E1DFEA-9312-4B4E-840A-31EDDE26D847_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-03 07:43:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24522.php">Ralph Castain: "Re: [OMPI users] divide-by-zero in mca_btl_openib_add_procs"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/05/24520.php">Nathan Hjelm: "Re: [OMPI users] Valgrind reports lots of memory leakage"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/05/24499.php">Ralph Castain: "Re: [OMPI users] divide-by-zero in mca_btl_openib_add_procs"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24522.php">Ralph Castain: "Re: [OMPI users] divide-by-zero in mca_btl_openib_add_procs"</a>
<li><strong>Reply:</strong> <a href="24522.php">Ralph Castain: "Re: [OMPI users] divide-by-zero in mca_btl_openib_add_procs"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On 28/05/2014 00:47, Ralph Castain wrote:
<br>
<span class="quotelev1">&gt; On May 27, 2014, at 3:32 PM, Alain Miniussi &lt;alain.miniussi_at_oca.eu&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Unfortunately, the debug library works like a charm (which make the uninitialized variable issue more likely).
</span><br>
<span class="quotelev1">&gt; Indeed - sounds like there is some optimization occurring that triggers the problem.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Still, the stack trace point to mca_btl_openib_add_procs in ompi/mca/btl/openib/btl_openib.c and there is only one division in that function (although not floating point) at the end:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;     openib_btl-&gt;local_procs += local_procs;
</span><br>
<span class="quotelev2">&gt;&gt;     openib_btl-&gt;device-&gt;mem_reg_max = calculate_max_reg () / openib_btl-&gt;local_procs;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; now, I'm not sure how much I would trust the local_procs initialization:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; for (i = 0, local_procs = 0 ; i &lt; (int) nprocs; i++) {
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I suspect that a compiler could (wrongly) decide to pass the init of local_proc if procs = 0 or in  a few other corner cases.
</span><br>
<span class="quotelev1">&gt; Yeah, that could be a source of optimization, I suppose - somewhat troubling wrt the expected behavior, but you could sorta see someone doing that.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Anyway, applying the attache patch on btl_openlib.c seems to fix the issue on my small case (but I have no exhaustive test suite to run).
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; If there is a more serious patch process to follow (based on the dev version?) please let me know.
</span><br>
<span class="quotelev1">&gt; The fact that it resolves the issue would lend credence to the optimizer indeed skipping that step for some odd reason. I'll bring it to the attention of the folks who maintain that component and see if they can grok the problem.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On 27/05/2014 17:30, Ralph Castain wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Ah, good. On the setup that fails, could you use gdb to find the line number where it is dividing by zero? It could be an uninitialized variable that gcc inits one way and icc inits another.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On May 27, 2014, at 4:49 AM, Alain Miniussi &lt;alain.miniussi_at_oca.eu&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So it's working with a gcc compiled openmpi:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [alainm_at_gurney mpi]$ /softs/openmpi-1.8.1-gnu447/bin/mpicc --showme
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; gcc -I/softs/openmpi-1.8.1-gnu447/include -pthread -Wl,-rpath -Wl,/softs/openmpi-1.8.1-gnu447/lib -Wl,--enable-new-dtags -L/softs/openmpi-1.8.1-gnu447/lib -lmpi
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (reverse-i-search)`mpicc': ^Cicc --showme:compile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [alainm_at_gurney mpi]$ /softs/openmpi-1.8.1-gnu447/bin/mpicc --showme
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; gcc -I/softs/openmpi-1.8.1-gnu447/include -pthread -Wl,-rpath -Wl,/softs/openmpi-1.8.1-gnu447/lib -Wl,--enable-new-dtags -L/softs/openmpi-1.8.1-gnu447/lib -lmpi
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [alainm_at_gurney mpi]$ /softs/openmpi-1.8.1-gnu447/bin/mpicc ./test.c
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [alainm_at_gurney mpi]$ /softs/openmpi-1.8.1-gnu447/bin/mpiexec -n 2 ./a.out
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [alainm_at_gurney mpi]$ ldd ./a.out
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     linux-vdso.so.1 =&gt;  (0x00007fffb47ff000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libmpi.so.1 =&gt; /softs/openmpi-1.8.1-gnu447/lib/libmpi.so.1 (0x00002aaee80c1000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libpthread.so.0 =&gt; /lib64/libpthread.so.0 (0x0000003bd9e00000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libc.so.6 =&gt; /lib64/libc.so.6 (0x0000003bd9200000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libopen-rte.so.7 =&gt; /softs/openmpi-1.8.1-gnu447/lib/libopen-rte.so.7 (0x00002aaee83b8000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libopen-pal.so.6 =&gt; /softs/openmpi-1.8.1-gnu447/lib/libopen-pal.so.6 (0x00002aaee8630000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libnuma.so.1 =&gt; /usr/lib64/libnuma.so.1 (0x0000003bd9600000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libdl.so.2 =&gt; /lib64/libdl.so.2 (0x00002aaee8904000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     librt.so.1 =&gt; /lib64/librt.so.1 (0x0000003bda600000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libnsl.so.1 =&gt; /lib64/libnsl.so.1 (0x0000003beb000000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libutil.so.1 =&gt; /lib64/libutil.so.1 (0x0000003bea000000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     libm.so.6 =&gt; /lib64/libm.so.6 (0x0000003bd9a00000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /lib64/ld-linux-x86-64.so.2 (0x0000003bd8e00000)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [alainm_at_gurney mpi]$ ./a.out
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [alainm_at_gurney mpi]$
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So it seems to be specific to Intel's compiler.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On 26/05/2014 17:35, Ralph Castain wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; &lt;btl_openib-1.8.1.diff&gt;_______________________________________________
</span><br>
<span class="quotelev2">&gt;&gt; users mailing list
</span><br>
<span class="quotelev2">&gt;&gt; users_at_[hidden]
