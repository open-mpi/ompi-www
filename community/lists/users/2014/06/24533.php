...
?>
<!-- received="Wed Jun  4 11:07:58 2014" -->
<!-- isoreceived="20140604150758" -->
<!-- sent="Wed, 4 Jun 2014 11:07:49 -0400" -->
<!-- isosent="20140604150749" -->
<!-- name="Fischer, Greg A." -->
<!-- email="fischega_at_[hidden]" -->
<!-- subject="Re: [OMPI users] intermittent segfaults with openib on ring_c.c" -->
<!-- id="C86C7F6037A63C44BCCD0D77E9D59BFE159ED30FF9_at_SWEC9985.w-intra.net" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="6F6FA906-3FC0-4168-9EF9-A85E19BE5F76_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-04 11:07:49
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24534.php">Ralph Castain: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<li><strong>Previous message:</strong> <a href="24532.php">Ralph Castain: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<li><strong>In reply to:</strong> <a href="24532.php">Ralph Castain: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24534.php">Ralph Castain: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<li><strong>Reply:</strong> <a href="24534.php">Ralph Castain: "Re: [OMPI users] intermittent segfaults with openib on ring_c.c"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
#0  opal_memory_ptmalloc2_int_malloc (av=0x2b48f6300020, bytes=47592367980728) at ../../../../../openmpi-1.8.1/opal/mca/memory/linux/malloc.c:4098
<br>
...
#0  opal_memory_ptmalloc2_int_malloc (av=0x2b48f6300020, bytes=47592367980728) at ../../../../../openmpi-1.8.1/opal/mca/memory/linux/malloc.c:4098
<br>
#1  0x00002b48f2a15e38 in opal_memory_ptmalloc2_malloc (bytes=47592367980576) at ../../../../../openmpi-1.8.1/opal/mca/memory/linux/malloc.c:3433
<br>
#2  0x00002b48f2a15b36 in opal_memory_linux_malloc_hook (sz=47592367980576, caller=0x2b48f63000b8) at ../../../../../openmpi-1.8.1/opal/mca/memory/linux/hooks.c:691
<br>
#3  0x00002b48f2374b90 in vasprintf () from /lib64/libc.so.6
<br>
#4  0x00002b48f2354148 in asprintf () from /lib64/libc.so.6
<br>
#5  0x00002b48f26dc7d1 in orte_oob_base_get_addr (uri=0x2b48f6300020) at ../../../../openmpi-1.8.1/orte/mca/oob/base/oob_base_stubs.c:234
<br>
#6  0x00002b48f53e7d4a in orte_rml_oob_get_uri () at ../../../../../openmpi-1.8.1/orte/mca/rml/oob/rml_oob_contact.c:36
<br>
#7  0x00002b48f26fa181 in orte_routed_base_register_sync (setup=32 ' ') at ../../../../openmpi-1.8.1/orte/mca/routed/base/routed_base_fns.c:301
<br>
#8  0x00002b48f4bbcccf in init_routes (job=4130340896, ndat=0x2b48f63000b8) at ../../../../../openmpi-1.8.1/orte/mca/routed/binomial/routed_binomial.c:705
<br>
#9  0x00002b48f26c615d in orte_ess_base_app_setup (db_restrict_local=32 ' ') at ../../../../openmpi-1.8.1/orte/mca/ess/base/ess_base_std_app.c:245
<br>
#10 0x00002b48f45b069f in rte_init () at ../../../../../openmpi-1.8.1/orte/mca/ess/env/ess_env_module.c:146
<br>
#11 0x00002b48f26935ab in orte_init (pargc=0x2b48f6300020, pargv=0x2b48f63000b8, flags=8) at ../../openmpi-1.8.1/orte/runtime/orte_init.c:148
<br>
#12 0x00002b48f1739d38 in ompi_mpi_init (argc=1, argv=0x7fffebf0d1f8, requested=8, provided=0x0) at ../../openmpi-1.8.1/ompi/runtime/ompi_mpi_init.c:464
<br>
#13 0x00002b48f1760a37 in PMPI_Init (argc=0x2b48f6300020, argv=0x2b48f63000b8) at pinit.c:84
<br>
...
Subject: Re: [OMPI users] intermittent segfaults with openib on ring_c.c
<br>
<p>Does the trace go any further back? Your prior trace seemed to indicate an error in our OOB framework, but in a very basic place. Looks like it could be an uninitialized variable, and having the line number down as deep as possible might help identify the source
<br>
<p><p>On Jun 4, 2014, at 7:55 AM, Fischer, Greg A. &lt;fischega_at_[hidden]&lt;mailto:fischega_at_[hidden]&gt;&gt; wrote:
<br>
<p><p>Oops, ulimit was set improperly. I generated a core file, loaded it in GDB, and ran a backtrace:
<br>
<p>Core was generated by `ring_c'.
<br>
Program terminated with signal 11, Segmentation fault.
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24533/attachment">attachment</a>
</ul>
