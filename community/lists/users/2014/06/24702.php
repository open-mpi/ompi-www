...
?>
<!-- received="Wed Jun 25 10:52:46 2014" -->
<!-- isoreceived="20140625145246" -->
<!-- sent="Wed, 25 Jun 2014 10:52:36 -0400" -->
<!-- isosent="20140625145236" -->
<!-- name="Fischer, Greg A." -->
<!-- email="fischega_at_[hidden]" -->
<!-- subject="Re: [OMPI users] poor performance using the openib btl" -->
<!-- id="C86C7F6037A63C44BCCD0D77E9D59BFE159F660AA7_at_SWEC9985.w-intra.net" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="53AAE1CA.3080307_at_calculquebec.ca" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-25 10:52:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24703.php">Sergii Veremieiev: "[OMPI users] Fwd: openmpi linking problem"</a>
<li><strong>Previous message:</strong> <a href="24701.php">Maxime Boissonneault: "Re: [OMPI users] poor performance using the openib btl"</a>
<li><strong>In reply to:</strong> <a href="24701.php">Maxime Boissonneault: "Re: [OMPI users] poor performance using the openib btl"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24707.php">Jeff Squyres (jsquyres): "Re: [OMPI users] poor performance using the openib btl"</a>
<li><strong>Reply:</strong> <a href="24707.php">Jeff Squyres (jsquyres): "Re: [OMPI users] poor performance using the openib btl"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>This option enables threading within OPAL, which was bugged (at least in 1.6.x series). I don't know if it has been fixed in 1.8 series.
<br>
<p>I do not see your configure line in the attached file, to see if it was enabled or not.
<br>
<p>Maxime
<br>
...
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/06/24700.php">http://www.open-mpi.org/community/lists/users/2014/06/24700.php</a>
--
---------------------------------
Maxime Boissonneault
Analyste de calcul - Calcul Qu&#233;bec, Universit&#233; Laval
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24702/attachment">attachment</a>
</ul>
