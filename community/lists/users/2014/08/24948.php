...
?>
<!-- received="Fri Aug  8 00:09:02 2014" -->
<!-- isoreceived="20140808040902" -->
<!-- sent="Fri, 8 Aug 2014 00:09:00 -0400" -->
<!-- isosent="20140808040900" -->
<!-- name="George Bosilca" -->
<!-- email="bosilca_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [OMPI devel] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc" -->
<!-- id="CAMJJpkVz_zqrvRbK0uVunQyb9E+LbUuUXxyMDV8Lu7fA_Oazqg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2014-08-08 00:09:00
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24949.php">Kawashima, Takahiro: "Re: [OMPI users] [OMPI devel] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Previous message:</strong> <a href="24947.php">Kawashima, Takahiro: "Re: [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>In reply to:</strong> <a href="24947.php">Kawashima, Takahiro: "Re: [OMPI users] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24949.php">Kawashima, Takahiro: "Re: [OMPI users] [OMPI devel] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>Reply:</strong> <a href="24949.php">Kawashima, Takahiro: "Re: [OMPI users] [OMPI devel] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Takahiro you can confirm this by printing the value of data when signal is
<br>
raised.
<br>
<p>George.
<br>
<p><p><p>On Fri, Aug 8, 2014 at 12:03 AM, Kawashima, Takahiro &lt;
<br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; To remove this message, put `dbxenv suppress_startup_message 7.9' in
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;  [8] mca_base_framework_components_register(0xffffffff6335e1c0, 0x0,
</span><br>
<span class="quotelev1">&gt; 0x3e,
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; sol_thread_fetch_registers: td_ta_map_id2thr: no thread can be found
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/devel/2014/08/15541.php">http://www.open-mpi.org/community/lists/devel/2014/08/15541.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24948/attachment">attachment</a>
</ul>
