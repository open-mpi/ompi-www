...
?>
<!-- received="Fri Aug 15 14:38:23 2014" -->
<!-- isoreceived="20140815183823" -->
<!-- sent="Fri, 15 Aug 2014 20:38:12 +0200" -->
<!-- isosent="20140815183812" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running a hybrid MPI+openMP program" -->
<!-- id="AD4636A3-D2EF-411E-A2B8-D18D48881358_at_staff.uni-marburg.de" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="BLU177-W243B831F60BE69B90A218D90E90_at_phx.gbl" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-15 14:38:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25039.php">Maxime Boissonneault: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<li><strong>Previous message:</strong> <a href="25037.php">Oscar Mojica: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>In reply to:</strong> <a href="25037.php">Oscar Mojica: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25079.php">Oscar Mojica: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>Reply:</strong> <a href="25079.php">Oscar Mojica: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>Am 15.08.2014 um 19:56 schrieb Oscar Mojica:
<br>
<p><span class="quotelev1">&gt; Yes, my installation of Open MPI is SGE-aware. I got the following
</span><br>
...
<p>Fine.
<br>
<p><p><span class="quotelev1">&gt; I'm a bit slow and I didn't understand the las part of your message. So i made a test trying to solve my doubts.
</span><br>
...
<p>Yes, here you got 10 slots (= cores) granted by SGE. So there is no free core left inside the allocation of SGE to allow the use of additional cores for your threads. If you use more cores than granted by SGE, it will oversubscribe the machines.
<br>
<p>The issue is now:
<br>
<p>a) If you want 8 threads per MPI process, your job will use 80 cores in total - for now SGE isn't aware of it.
<br>
<p>b) Although you specified $fill_up as allocation rule, it looks like $round_robin. Is there more than one slot defined in the queue definition of one.q to get exclusive access?
<br>
<p>c) What version of SGE are you using? Certain ones use cgroups or bind processes directly to cores (although it usually needs to be requested by the job: first line of `qconf -help`).
<br>
<p><p>In case you are alone in the cluster, you could bypass the allocation with b) (unless you are hit by c)). But having a mixture of users and jobs a different handling would be necessary to handle this in a proper way IMO:
<br>
<p>a) having a PE with a fixed allocation rule of 8
<br>
<p>b) requesting this PE with an overall slot count of 80
<br>
<p>c) copy and alter the $PE_HOSTFILE to show only (granted core count per machine) divided by (OMP_NUM_THREADS) per entry, change $PE_HOSTFILE so that it points to the altered file
<br>
<p>d) Open MPI with a Tight Integration will now start only N process per machine according to the altered hostfile, in your case one
<br>
<p>e) Your application can start the desired threads and you stay inside the granted allocation
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; I accessed to the MASTER processor with 'ssh compute-1-2.local' , and with $ ps -e f and got this, I'm showing only the last lines  
</span><br>
<span class="quotelev1">&gt; 
</span><br>
