...
?>
<!-- received="Wed Aug 20 12:05:08 2014" -->
<!-- isoreceived="20140820160508" -->
<!-- sent="Wed, 20 Aug 2014 18:04:55 +0200" -->
<!-- isosent="20140820160455" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running a hybrid MPI+openMP program" -->
<!-- id="24B137DA-12CF-443B-8F6B-F76CFCCD92B1_at_staff.uni-marburg.de" -->
<!-- charset="iso-2022-jp" -->
<!-- inreplyto="FC7B1286-8ED8-49BB-834D-C4849A40D189_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-20 12:04:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25090.php">rf_at_[hidden]: "Re: [OMPI users] No log_num_mtt in Ubuntu 14.04"</a>
<li><strong>Previous message:</strong> <a href="25088.php">Ralph Castain: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>In reply to:</strong> <a href="25088.php">Ralph Castain: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25092.php">Ralph Castain: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>Reply:</strong> <a href="25092.php">Ralph Castain: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; On Aug 20, 2014, at 6:58 AM, Reuti &lt;reuti_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; I played around with giving -np 10 in addition to a Tight Integration. The slot count is not really divided I think, but only 10 out of the granted maximum is used (while on each of the listed machines an `orted` is started). Due to the fixed allocation this is of course the result we want to achieve as it subtracts bunches of 8 from the given list of machines resp. slots. In SGE it's sufficient to use and AFAICS it works (without touching the $PE_HOSTFILE any longer):
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; ===
...
<span class="quotelev2">&gt;&gt; mpirun -map-by slot:pe=$OMP_NUM_THREADS -np $(bc &lt;&lt;&lt;&quot;$NSLOTS / $OMP_NUM_THREADS&quot;) ./inverse.exe
</span><br>
<span class="quotelev2">&gt;&gt; ===
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Nevertheless, using -np in addition to the Tight Integration gives a taste of a kind of half-tight integration in some way. And would not work for us because &quot;--bind-to none&quot; can't be used in such a command (see below) and throws an error.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; I don't know why you want to use pe=N without binding, but unfortunately
</span><br>
...
<span class="quotelev2">&gt;&gt; In a shared cluster with many users and different MPI libraries in use, only the queuingsystem could know which job got which cores granted. This avoids any oversubscription of cores, while others are idle.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; FWIW: we detect the exterior binding constraint and work within it
</span><br>
<p>Aha, this is quite interesting - how do you do this: scanning the /proc/&lt;pid&gt;/status or alike? What happens if you don't find enough free cores as they are used up by other applications already?
<br>
<p>-- Reuti
<br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Thx for pointing me to this option, for now I can't get it working though
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; processes - ok, but does it lower the slot count granted by Torque too? I
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; so that Torque knows, that it should grant and remember this slot count
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I compiled the objects in the Makefile, so the program worked but it didn't
</span><br>
<span class="quotelev3">&gt;&gt;&gt; divide the job
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; in threads. Now the program is working and I can use until 15 cores for
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; in the cluster so i must implement your second suggestion. The steps are
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; it's a much broader issue which targets all users who want to combine MPI
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; information to start the appropriate number of processes (which was an
</span><br>
<span class="quotelev3">&gt;&gt;&gt; achievement for the Tight Integration out-of-the-box of course) and ignores
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; OMP_NUM_THREADS must be defined by &quot;qsub -v ...&quot; outside of the jobscript
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; the list and export the pointer to the $PE_HOSTFILE, but he could change it
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; one.q which has 14 machines (compute-1-2 to compute-1-15). Whit 'qstat -t'
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; one.q_at_compute-1-5.local SLAVE 1.compute-1-5 r 00:48:53 551.49022 0.09410
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev3">&gt;&gt;&gt; one.q_at_compute-1-9.local SLAVE 1.compute-1-9 r 00:50:00 564.22764 0.09409
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev3">&gt;&gt;&gt; one.q_at_compute-1-12.local SLAVE 1.compute-1-12 r 00:47:30 535.30379 0.09379
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev3">&gt;&gt;&gt; one.q_at_compute-1-13.local SLAVE 1.compute-1-13 r 00:49:51 561.69868 0.09379
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev3">&gt;&gt;&gt; one.q_at_compute-1-14.local SLAVE 1.compute-1-14 r 00:49:14 554.60818 0.09379
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev3">&gt;&gt;&gt; one.q_at_compute-1-10.local SLAVE 1.compute-1-10 r 00:49:59 562.95487 0.09349
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev3">&gt;&gt;&gt; one.q_at_compute-1-15.local SLAVE 1.compute-1-15 r 00:50:01 563.27221 0.09361
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev3">&gt;&gt;&gt; one.q_at_compute-1-8.local SLAVE 1.compute-1-8 r 00:49:26 556.68431 0.09349
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev3">&gt;&gt;&gt; one.q_at_compute-1-4.local SLAVE 1.compute-1-4 r 00:49:27 556.87510 0.04967
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Yes, here you got 10 slots (= cores) granted by SGE. So there is no
</span><br>
<span class="quotelev3">&gt;&gt;&gt; free core left inside the allocation of SGE to allow the use of additional
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; a) If you want 8 threads per MPI process, your job will use 80 cores
</span><br>
<span class="quotelev3">&gt;&gt;&gt; in total - for now SGE isn't aware of it.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; b) Although you specified $fill_up as allocation rule, it looks like
</span><br>
<span class="quotelev3">&gt;&gt;&gt; $round_robin. Is there more than one slot defined in the queue definition
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; bind processes directly to cores (although it usually needs to be requested
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; per machine) divided by (OMP_NUM_THREADS) per entry, change $PE_HOSTFILE so
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; -nostdin -V compute-1-4.local PATH=/opt/openmpi/bin:$PATH ; expo
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; So the job is using the 10 machines, Until here is all right OK. Do
</span><br>
<span class="quotelev3">&gt;&gt;&gt; you think that changing the &quot;allocation_rule &quot; to a number instead $fill_up
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I think this is a broader issue in case an MPI library is used in
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; combination like 4+4+3+3 and so on. Depending on the SGE-awareness it's a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; question: will your
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; application just start processes on all nodes and completely disregard
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the granted allocation, or as the other extreme does it stays on one and
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; AFAICS: for now there is no way in the Open MPI + SGE combination
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to specify the number of MPI processes and intended number of threads which
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; requesting 32 processes, would for now start 32 processes by MPI already,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; fixed &quot;allocation_rule&quot;. While this works right now, an extension in SGE
</span><br>
<span class="quotelev3">&gt;&gt;&gt; could be
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; &quot;$fill_up_omp&quot;/&quot;$round_robin_omp&quot; and using OMP_NUM_THREADS there too,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; hence it must not be specified as an `export` in the job script but either
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; $PE_HOSTFILE, it would be an extension to feed this to Open MPI to allow
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; /usr/bin/time -f &quot;%E&quot; /opt/openmpi/bin/mpirun -v --bind-to-socket
</span><br>
<span class="quotelev3">&gt;&gt;&gt; -np $NSLOTS ./inverse.exe
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; before to think in an hybrid application i was using only MPI and
</span><br>
<span class="quotelev3">&gt;&gt;&gt; the program used few processors (14). The cluster possesses 28 machines, 15
</span><br>
<span class="quotelev3">&gt;&gt;&gt; with 16
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; cores and 13 with 8 cores totalizing 344 units of processing. When I
</span><br>
<span class="quotelev3">&gt;&gt;&gt; submitted the job (only MPI), the MPI processes were spread to the cores
</span><br>
<span class="quotelev3">&gt;&gt;&gt; directly, for that
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; reason I created a new queue with 14 machines trying to gain more time.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; your N threads will run on a single core. --bind-to socket would
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I don't know much about OpenMP, but do you need to disable Open
</span><br>
<span class="quotelev3">&gt;&gt;&gt; MPI's default bind-to-core functionality (I'm assuming you're using Open
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; MPI not bind MPI processes to cores, which might allow OpenMP to think that
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I am trying to run a hybrid mpi + openmp program in a cluster.
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; work among the 14 processors with MPI and within each processor a loop
</span><br>
<span class="quotelev3">&gt;&gt;&gt; is also divided into 8 threads for example, using openmp. The problem is
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I made a simple test program that uses openmp and I logged in
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; set the OMP_NUM_THREADS environment variable equal to 8 and when I ran
</span><br>
<span class="quotelev3">&gt;&gt;&gt; directly in the terminal the loop was effectively divided among the cores
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25084.php">http://www.open-mpi.org/community/lists/users/2014/08/25084.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25087.php">http://www.open-mpi.org/community/lists/users/2014/08/25087.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25088.php">http://www.open-mpi.org/community/lists/users/2014/08/25088.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
