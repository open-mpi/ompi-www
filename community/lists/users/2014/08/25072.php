...
?>
<!-- received="Tue Aug 19 08:00:09 2014" -->
<!-- isoreceived="20140819120009" -->
<!-- sent="Tue, 19 Aug 2014 15:59:14 +0400" -->
<!-- isosent="20140819115914" -->
<!-- name="Alex A. Granovsky" -->
<!-- email="gran_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes" -->
<!-- id="63D661AECBBE4FF99F3164E3CEB95C32_at_chem.msu.ru" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="53F27BE7.9030503_at_calculquebec.ca" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-19 07:59:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25073.php">Maxime Boissonneault: "Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes"</a>
<li><strong>Previous message:</strong> <a href="25071.php">Alex A. Granovsky: "Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes"</a>
<li><strong>In reply to:</strong> <a href="25067.php">Maxime Boissonneault: "Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25073.php">Maxime Boissonneault: "Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes"</a>
<li><strong>Reply:</strong> <a href="25073.php">Maxime Boissonneault: "Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Link to this post: 
<a href="http://www.open-mpi.org/community/lists/users/2014/08/25067.php">http://www.open-mpi.org/community/lists/users/2014/08/25067.php</a> 
</pre>
<!-- body="end" -->
<hr>
<ul class="links">
