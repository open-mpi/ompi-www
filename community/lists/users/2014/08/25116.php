...
?>
<!-- received="Thu Aug 21 11:11:12 2014" -->
<!-- isoreceived="20140821151112" -->
<!-- sent="Thu, 21 Aug 2014 17:11:01 +0200" -->
<!-- isosent="20140821151101" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running a hybrid MPI+openMP program" -->
<!-- id="05937868-C6FE-43A0-8CFE-D40099EDA555_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-08-21 11:11:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25117.php">Maxime Boissonneault: "[OMPI users] OpenMPI 1.8.1 to 1.8.2rc4"</a>
<li><strong>Previous message:</strong> <a href="25115.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>In reply to:</strong> <a href="25114.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25161.php">Tetsuya Mishima: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>Reply:</strong> <a href="25161.php">Tetsuya Mishima: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev2">&gt;&gt; and we need to compute the number of procs to start. Okay, the change you requested below will fix that one too. I can make that easily enough.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<p>Ok, less typos:
<br>
<p>BTW: The fact that the queuingsystem is set up in such a way that the machinefile contains a mutiple of  $OMP_NUM_THREADS per node is a premise and can be seen as given here - otherwise generate an error. It's up to admin of the queuingsystem to configure it in such a way.
<br>
<p>-- Reuti
<br>
<p><p><span class="quotelev1">&gt; - the user sets OMP_NUM_THREADS
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; case 1) no interest in any binding, other jobs may exist on the nodes
</span><br>
<span class="quotelev1">&gt; 
</span><br>
