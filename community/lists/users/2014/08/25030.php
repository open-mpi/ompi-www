...
?>
<!-- received="Thu Aug 14 15:18:19 2014" -->
<!-- isoreceived="20140814191819" -->
<!-- sent="Thu, 14 Aug 2014 15:18:19 -0400" -->
<!-- isosent="20140814191819" -->
<!-- name="Joshua Ladd" -->
<!-- email="jladd.mlnx_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1" -->
<!-- id="CAG4F6z_QwgZ+8RA6BobXrnboBJrOc3P9SNPt=6F9rafeZJAVZQ_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2014-08-14 15:18:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25031.php">Joshua Ladd: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<li><strong>Previous message:</strong> <a href="25029.php">Joshua Ladd: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<li><strong>In reply to:</strong> <a href="25029.php">Joshua Ladd: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25031.php">Joshua Ladd: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<li><strong>Reply:</strong> <a href="25031.php">Joshua Ladd: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Josh
<br>
<p><p>On Thu, Aug 14, 2014 at 3:16 PM, Joshua Ladd &lt;jladd.mlnx_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Can you try to run the example code &quot;ring_c&quot; across nodes?
</span><br>
...
<span class="quotelev2">&gt;&gt; Everything has been built with GCC 4.8.x, although x might have changed
</span><br>
<span class="quotelev2">&gt;&gt; between the OpenMPI 1.8.1 build and the gromacs build. For OpenMPI 1.8.2rc4
</span><br>
<span class="quotelev2">&gt;&gt; however, it was the exact same compiler for everything.
</span><br>
...
<span class="quotelev2">&gt;&gt; Le 2014-08-14 14:57, Joshua Ladd a &#195;&#169;crit :
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;  Hmmm...weird. Seems like maybe a mismatch between libraries. Did you
</span><br>
<span class="quotelev2">&gt;&gt; build OMPI with the same compiler as you did GROMACS/Charm++?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I'm stealing this suggestion from an old Gromacs forum with essentially
</span><br>
<span class="quotelev2">&gt;&gt; the same symptom:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; &quot;Did you compile Open MPI and Gromacs with the same compiler (i.e. both
</span><br>
<span class="quotelev2">&gt;&gt; gcc and the same version)? You write you tried different OpenMPI versions
</span><br>
<span class="quotelev2">&gt;&gt; and different GCC versions but it is unclear whether those match. Can you
</span><br>
<span class="quotelev2">&gt;&gt; provide more detail how you compiled (including all options you specified)?
</span><br>
<span class="quotelev2">&gt;&gt; Have you tested any other MPI program linked against those Open MPI
</span><br>
<span class="quotelev2">&gt;&gt; versions? Please make sure (e.g. with ldd) that the MPI and pthread library
</span><br>
<span class="quotelev2">&gt;&gt; you compiled against is also used for execution. If you compiled and run on
</span><br>
<span class="quotelev2">&gt;&gt; different hosts, check whether the error still occurs when executing on the
</span><br>
<span class="quotelev2">&gt;&gt; build host.&quot;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;  I just tried Gromacs with two nodes. It crashes, but with a different
</span><br>
<span class="quotelev3">&gt;&gt;&gt; error. I get
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [gpu-k20-13:142156] [ 0] /lib64/libpthread.so.0(+0xf710)[0x2ac5d070c710]
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; mpiexec noticed that process rank 0 with PID 142156 on node gpu-k20-13
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; We do not have MPI_THREAD_MULTIPLE enabled in our build, so Charm++
</span><br>
<span class="quotelev3">&gt;&gt;&gt; cannot be using this level of threading. The configure line for OpenMPI was
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ./configure --prefix=$PREFIX \
</span><br>
<span class="quotelev3">&gt;&gt;&gt;       --with-threads --with-verbs=yes --enable-shared --enable-static \
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Le 2014-08-14 14:20, Joshua Ladd a &#195;&#169;crit :
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   What about between nodes? Since this is coming from the OpenIB BTL,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; would be good to check this.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Do you know what the MPI thread level is set to when used with the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Charm++ runtime? Is it MPI_THREAD_MULTIPLE? The OpenIB BTL is not thread
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I ran gromacs successfully with OpenMPI 1.8.1 and Cuda 6.0.37 on a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; single node, with 8 ranks and multiple OpenMP threads.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Le 2014-08-14 14:15, Joshua Ladd a &#195;&#169;crit :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;  Just curious, are you able to run a vanilla MPI program? Can you try
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one one of the example programs in the &quot;examples&quot; subdirectory. Looks like
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; a threading issue to me.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25030/attachment">attachment</a>
</ul>
