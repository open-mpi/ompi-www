...
?>
<!-- received="Tue Aug 19 07:56:14 2014" -->
<!-- isoreceived="20140819115614" -->
<!-- sent="Tue, 19 Aug 2014 15:55:18 +0400" -->
<!-- isosent="20140819115518" -->
<!-- name="Alex A. Granovsky" -->
<!-- email="gran_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes" -->
<!-- id="A7AFBEBAECFD4BC69AFD700876593C1B_at_chem.msu.ru" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2014-08-19 07:55:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25072.php">Alex A. Granovsky: "Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes"</a>
<li><strong>Previous message:</strong> <a href="25070.php">Mike Dubman: "Re: [OMPI users] No log_num_mtt in Ubuntu 14.04"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25072.php">Alex A. Granovsky: "Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello,
<br>
<p>I think your cuda program may be incorrect. Add proper cudaSetDevice call at 
<br>
