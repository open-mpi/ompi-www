...
?>
<!-- received="Thu Aug 21 11:08:51 2014" -->
<!-- isoreceived="20140821150851" -->
<!-- sent="Thu, 21 Aug 2014 17:08:40 +0200" -->
<!-- isosent="20140821150840" -->
<!-- name="Reuti" -->
<!-- email="reuti_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running a hybrid MPI+openMP program" -->
<!-- id="383554CC-C6A5-4774-BC1C-28637A31B482_at_staff.uni-marburg.de" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2014-08-21 11:08:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25116.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>Previous message:</strong> <a href="25114.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>In reply to:</strong> <a href="25114.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25116.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>BTW: That fact that the queuingsystem is set up in such a that the machinefile contains a mutiple of  $OMP_NUM_THREADS per node is a premise and can be seen as given here - otherwise generate an error. It's up to admin of the queuingsystem to configure it in such a way.
<br>
<p>-- Reuti
<br>
