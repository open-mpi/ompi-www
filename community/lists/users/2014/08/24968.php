...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24969.php">Siegmar Gross: "[OMPI users] update to problem with rankfiles"</a>
<li><strong>Previous message:</strong> <a href="24967.php">Kawashima, Takahiro: "Re: [OMPI users] bus error with openmpi-1.8.2rc4r32485 and gcc-4.9.0"</a>
<li><strong>In reply to:</strong> <a href="24967.php">Kawashima, Takahiro: "Re: [OMPI users] bus error with openmpi-1.8.2rc4r32485 and gcc-4.9.0"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/x-diff attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24968/db-store-alignment.patch">db-store-alignment.patch</a>
</ul>
