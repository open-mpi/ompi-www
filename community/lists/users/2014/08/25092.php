...
?>
<!-- received="Wed Aug 20 13:05:59 2014" -->
<!-- isoreceived="20140820170559" -->
<!-- sent="Wed, 20 Aug 2014 10:05:29 -0700" -->
<!-- isosent="20140820170529" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running a hybrid MPI+openMP program" -->
<!-- id="7EAB763B-5161-49A0-A86D-B3D2DBCFDF5D_at_open-mpi.org" -->
<!-- charset="iso-2022-jp" -->
<!-- inreplyto="24B137DA-12CF-443B-8F6B-F76CFCCD92B1_at_staff.uni-marburg.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-20 13:05:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25093.php">Ralph Castain: "Re: [OMPI users] ORTE daemon has unexpectedly failed after launch"</a>
<li><strong>Previous message:</strong> <a href="25091.php">Rio Yokota: "Re: [OMPI users] No log_num_mtt in Ubuntu 14.04"</a>
<li><strong>In reply to:</strong> <a href="25089.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25097.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>Reply:</strong> <a href="25097.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
On Aug 20, 2014, at 9:04 AM, Reuti &lt;reuti_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Am 20.08.2014 um 16:26 schrieb Ralph Castain:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Aug 20, 2014, at 6:58 AM, Reuti &lt;reuti_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Am 20.08.2014 um 13:26 schrieb tmishima_at_[hidden]:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; If you want to allocate 10 procs with N threads, the Torque
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; script below should work for you:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; qsub -l nodes=10:ppn=N
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun -map-by slot:pe=N -np 10 -x OMP_NUM_THREADS=N ./inverse.exe
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I played around with giving -np 10 in addition to a Tight Integration. The slot count is not really divided I think, but only 10 out of the granted maximum is used (while on each of the listed machines an `orted` is started). Due to the fixed allocation this is of course the result we want to achieve as it subtracts bunches of 8 from the given list of machines resp. slots. In SGE it's sufficient to use and AFAICS it works (without touching the $PE_HOSTFILE any longer):
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ===
...
<span class="quotelev3">&gt;&gt;&gt; mpirun -map-by slot:pe=$OMP_NUM_THREADS -np $(bc &lt;&lt;&lt;&quot;$NSLOTS / $OMP_NUM_THREADS&quot;) ./inverse.exe
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ===
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; and submit with:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; $ qsub -pe orte 80 job.sh
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; as the variables are distributed to the slave nodes by SGE already.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Nevertheless, using -np in addition to the Tight Integration gives a taste of a kind of half-tight integration in some way. And would not work for us because &quot;--bind-to none&quot; can't be used in such a command (see below) and throws an error.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Then, the openmpi automatically reduces the logical slot count to 10
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; by dividing real slot count 10N by binding width of N.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I don't know why you want to use pe=N without binding, but unfortunately
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the openmpi allocates successive cores to each process so far when you
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; use pe option - it forcibly bind_to core.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; In a shared cluster with many users and different MPI libraries in use, only the queuingsystem could know which job got which cores granted. This avoids any oversubscription of cores, while others are idle.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; FWIW: we detect the exterior binding constraint and work within it
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<p>Remember, when you use mpirun to launch, we launch our own daemons using the native launcher (e.g., qsub). So the external RM will bind our daemons to the specified cores on each node. We use hwloc to determine what cores our daemons are bound to, and then bind our own child processes to cores within that range.
<br>
<p>If the cores we are bound to are the same on each node, then we will do this with no further instruction. However, if the cores are different on the individual nodes, then you need to add --hetero-nodes to your command line (as the nodes appear to be heterogeneous to us).
<br>
<p>So it is up to the RM to set the constraint - we just live within it.
<br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; modification
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; (in fact, I want to use it without binding essentially). This allows to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; tell Open MPI to bind more cores to each of the MPI
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; processes - ok, but does it lower the slot count granted by Torque too? I
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mean, was your submission command like:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; of a total of 80 for the correct accounting?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I compiled the objects in the Makefile, so the program worked but it didn't
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; divide the job
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; in threads. Now the program is working and I can use until 15 cores for
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; machine in the queue one.q.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Anyway i would like to try implement your advice. Well I'm not alone
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; in the cluster so i must implement your second suggestion. The steps are
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; (`qconf -sq one.q`)?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; can add some lines to the script to determine the PE_HOSTFILE path and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; contents, but i
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; exported):
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; awk -v omp_num_threads=$OMP_NUM_THREADS '{ $2/=omp_num_threads;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; print }' $PE_HOSTFILE &gt; $TMPDIR/machines
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; it's a much broader issue which targets all users who want to combine MPI
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; with OpenMP. The
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; queuingsystem should get a proper request for the overall amount of
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; slots the user needs. For now this will be forwarded to Open MPI and it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; will use this
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; information to start the appropriate number of processes (which was an
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; achievement for the Tight Integration out-of-the-box of course) and ignores
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; any setting of
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; OMP_NUM_THREADS. So, where should the generated list of machines be
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; adjusted; there are several options:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; OMP_NUM_THREADS must be defined by &quot;qsub -v ...&quot; outside of the jobscript
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (tricky scanning
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; the same way as Open MPI only
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; the list and export the pointer to the $PE_HOSTFILE, but he could change it
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; forth and back
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; while staying inside the granted allocation automatically
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; very useful
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; message. So i made a test trying to solve my doubts.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; This is the cluster configuration: There are some machines turned
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; off but that is no problem
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q which has 14 machines (compute-1-2 to compute-1-15). Whit 'qstat -t'
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I got:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; ja-task-ID task-ID state cpu mem io stat failed
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-2.local MASTER r 00:49:12 554.13753 0.09163
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; one.q_at_compute-1-2.local SLAVE
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-5.local SLAVE 1.compute-1-5 r 00:48:53 551.49022 0.09410
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-9.local SLAVE 1.compute-1-9 r 00:50:00 564.22764 0.09409
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-12.local SLAVE 1.compute-1-12 r 00:47:30 535.30379 0.09379
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-13.local SLAVE 1.compute-1-13 r 00:49:51 561.69868 0.09379
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-14.local SLAVE 1.compute-1-14 r 00:49:14 554.60818 0.09379
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-10.local SLAVE 1.compute-1-10 r 00:49:59 562.95487 0.09349
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-15.local SLAVE 1.compute-1-15 r 00:50:01 563.27221 0.09361
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-8.local SLAVE 1.compute-1-8 r 00:49:26 556.68431 0.09349
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2726 0.50500 job oscar r 08/15/2014 12:38:21
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one.q_at_compute-1-4.local SLAVE 1.compute-1-4 r 00:49:27 556.87510 0.04967
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Yes, here you got 10 slots (= cores) granted by SGE. So there is no
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; free core left inside the allocation of SGE to allow the use of additional
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; cores for your
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; threads. If you use more cores than granted by SGE, it will
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; oversubscribe the machines.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; in total - for now SGE isn't aware of it.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; b) Although you specified $fill_up as allocation rule, it looks like
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $round_robin. Is there more than one slot defined in the queue definition
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; of one.q to get
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; bind processes directly to cores (although it usually needs to be requested
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; by the job:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; allocation with b) (unless you are hit by c)). But having a mixture of
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; users and jobs a different
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; per machine) divided by (OMP_NUM_THREADS) per entry, change $PE_HOSTFILE so
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; that it points
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; per machine according to the altered hostfile, in your case one
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; e) Your application can start the desired threads and you stay
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; inside the granted allocation
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -- Reuti
...
<span class="quotelev4">&gt;&gt;&gt;&gt; and with $ ps -e f and got this, I'm showing only the last lines
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; -bash /opt/gridengine/default/spool/compute-1-2/job_scripts/2726
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 17797 ? S 0:00 \_ /usr/bin/time -f %E /opt/openmpi/bin/mpirun -v
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -np 10 ./inverse.exe
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; -nostdin -V compute-1-5.local PATH=/opt/openmpi/bin:$PATH ; expo
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 17800 ? Sl 0:00 \_ /opt/gridengine/bin/linux-x64/qrsh -inherit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -nostdin -V compute-1-9.local PATH=/opt/openmpi/bin:$PATH ; expo
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 17801 ? Sl 0:00 \_ /opt/gridengine/bin/linux-x64/qrsh -inherit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -nostdin -V compute-1-12.local PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 17802 ? Sl 0:00 \_ /opt/gridengine/bin/linux-x64/qrsh -inherit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -nostdin -V compute-1-13.local PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 17803 ? Sl 0:00 \_ /opt/gridengine/bin/linux-x64/qrsh -inherit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -nostdin -V compute-1-14.local PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 17804 ? Sl 0:00 \_ /opt/gridengine/bin/linux-x64/qrsh -inherit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -nostdin -V compute-1-10.local PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 17805 ? Sl 0:00 \_ /opt/gridengine/bin/linux-x64/qrsh -inherit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -nostdin -V compute-1-15.local PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 17806 ? Sl 0:00 \_ /opt/gridengine/bin/linux-x64/qrsh -inherit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -nostdin -V compute-1-8.local PATH=/opt/openmpi/bin:$PATH ; expo
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 17807 ? Sl 0:00 \_ /opt/gridengine/bin/linux-x64/qrsh -inherit
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; -nostdin -V compute-1-4.local PATH=/opt/openmpi/bin:$PATH ; expo
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; you think that changing the &quot;allocation_rule &quot; to a number instead $fill_up
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; conjunction with threads while running inside a queuing system. First:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; whether your
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; $fill_up&quot;. This means that SGE will grant you 14 slots in total in any
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; combination on the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; available machines, means 8+4+2 slots allocation is an allowed
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; combination like 4+4+3+3 and so on. Depending on the SGE-awareness it's a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; question: will your
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; application just start processes on all nodes and completely disregard
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the granted allocation, or as the other extreme does it stays on one and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the same machine
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; for all started processes? On the master node of the parallel job you
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; can issue:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; used to reach other machines and their requested process count.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; to specify the number of MPI processes and intended number of threads which
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; are
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; automatically read by Open MPI while staying inside the granted slot
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; count and allocation. So it seems to be necessary to have the intended
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; number of threads being
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; requesting 32 processes, would for now start 32 processes by MPI already,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; as Open MP reads &gt; the $PE_HOSTFILE and acts accordingly.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Open MPI would have to read the generated machine file in a
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; slightly different way regarding threads: a) read the $PE_HOSTFILE, b)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; divide the granted
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; slots per machine by OMP_NUM_THREADS, c) throw an error in case it's
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; not divisible by OMP_NUM_THREADS. Then start one process per quotient.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; fixed &quot;allocation_rule&quot;. While this works right now, an extension in SGE
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; could be
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; &quot;$fill_up_omp&quot;/&quot;$round_robin_omp&quot; and using OMP_NUM_THREADS there too,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; hence it must not be specified as an `export` in the job script but either
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; on the command
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; line or inside the job script in #$ lines as job requests. This would
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mean to collect slots in bunches of OMP_NUM_THREADS on each machine to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; reach the overall
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; specified slot count. Whether OMP_NUM_THREADS or n times
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; OMP_NUM_THREADS is allowed per machine needs to be discussed.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; PS2: As Univa SGE can also supply a list of granted cores in the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $PE_HOSTFILE, it would be an extension to feed this to Open MPI to allow
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; any UGE aware
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; -np $NSLOTS ./inverse.exe
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; '--with-sge'. How can i know that?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; before to think in an hybrid application i was using only MPI and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the program used few processors (14). The cluster possesses 28 machines, 15
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; with 16
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; cores and 13 with 8 cores totalizing 344 units of processing. When I
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; submitted the job (only MPI), the MPI processes were spread to the cores
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; directly, for that
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; reason I created a new queue with 14 machines trying to gain more time.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the results were the same in both cases. In the last case i could prove
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; that the processes
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI's default bind-to-core functionality (I'm assuming you're using Open
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI 1.8.x)?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; You can try &quot;mpirun --bind-to none ...&quot;, which will have Open
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; MPI not bind MPI processes to cores, which might allow OpenMP to think that
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; it can use
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;o_mojical_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I created a queue with 14 machines, each one with 16 cores. The program
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; divides the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; work among the 14 processors with MPI and within each processor a loop
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is also divided into 8 threads for example, using openmp. The problem is
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; that when I submit
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the job to the queue the MPI processes don't divide the work into
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; threads and the program prints the number of threads that are working
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; within each process as one.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I made a simple test program that uses openmp and I logged in
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; one machine of the fourteen. I compiled it using gfortran -fopenmp
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; program.f -o exe,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; set the OMP_NUM_THREADS environment variable equal to 8 and when I ran
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; directly in the terminal the loop was effectively divided among the cores
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; and for example in
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; $NSLOTS ./inverse.exe
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25016.php">http://www.open-mpi.org/community/lists/users/2014/08/25016.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25020.php">http://www.open-mpi.org/community/lists/users/2014/08/25020.php</a>
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25032.php">http://www.open-mpi.org/community/lists/users/2014/08/25032.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25034.php">http://www.open-mpi.org/community/lists/users/2014/08/25034.php</a>
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25037.php">http://www.open-mpi.org/community/lists/users/2014/08/25037.php</a>
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25038.php">http://www.open-mpi.org/community/lists/users/2014/08/25038.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; _______________________________________________
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; users mailing list
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25079.php">http://www.open-mpi.org/community/lists/users/2014/08/25079.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25080.php">http://www.open-mpi.org/community/lists/users/2014/08/25080.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ----
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25081.php">http://www.open-mpi.org/community/lists/users/2014/08/25081.php</a>
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2014/08/25083.php">http://www.open-mpi.org/community/lists/users/2014/08/25083.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25084.php">http://www.open-mpi.org/community/lists/users/2014/08/25084.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25087.php">http://www.open-mpi.org/community/lists/users/2014/08/25087.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25088.php">http://www.open-mpi.org/community/lists/users/2014/08/25088.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25089.php">http://www.open-mpi.org/community/lists/users/2014/08/25089.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25092/attachment">attachment</a>
</ul>
