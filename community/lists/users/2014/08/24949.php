<?
$subject_val = "Re: [OMPI users] [OMPI devel] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc";
include("../../include/msg-header.inc");
?>
<!-- received="Fri Aug  8 00:22:11 2014" -->
<!-- isoreceived="20140808042211" -->
<!-- sent="Fri, 8 Aug 2014 04:22:03 +0000" -->
<!-- isosent="20140808042203" -->
<!-- name="Kawashima, Takahiro" -->
<!-- email="t-kawashima_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [OMPI devel] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc" -->
<!-- id="20140808132203.8d9f85374891101708e52dc4_at_jp.fujitsu.com" -->
<!-- charset="iso-2022-jp" -->
<!-- inreplyto="CAMJJpkVz_zqrvRbK0uVunQyb9E+LbUuUXxyMDV8Lu7fA_Oazqg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] [OMPI devel] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc<br>
<strong>From:</strong> Kawashima, Takahiro (<em>t-kawashima_at_[hidden]</em>)<br>
<strong>Date:</strong> 2014-08-08 00:22:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24950.php">Lane, William: "Re: [OMPI users] Mpirun 1.5.4  problems when request &gt; 28 slots"</a>
<li><strong>Previous message:</strong> <a href="24948.php">George Bosilca: "Re: [OMPI users] [OMPI devel] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<li><strong>In reply to:</strong> <a href="24948.php">George Bosilca: "Re: [OMPI users] [OMPI devel] bus error with openmpi-1.8.2rc2 on Solaris 10 Sparc"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Hi George,
<br>
<p><span class="quotelev1">&gt; Takahiro you can confirm this by printing the value of data when signal is
</span><br>
...
0x000007feffffde74
<br>
<p>#2 0xffffffff0282aff4 (store + 0x540) (uid=(unsigned long *) 0xffffffff0118a128,scope=8:'\b',key=(char *) 0xffffffff0106a0a8 &quot;opal.local.ldr&quot;,data=(void *) 0x000007feffffde74,type=15:'\017') at line 252 in db_hash.c
<br>
<p>I want to dig this issue, but unfortunately I have no time today.
<br>
...
Fujitsu
<br>
<p><span class="quotelev1">&gt; I have an extremely vague recollection about a similar issue in the
</span><br>
<span class="quotelev1">&gt; datatype engine: on the SPARC architecture the 64 bits integers must be
</span><br>
<span class="quotelev1">&gt; aligned on a 64bits boundary or you get a bus error.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Takahiro you can confirm this by printing the value of data when signal is
</span><br>
<span class="quotelev1">&gt; raised.
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; On Fri, Aug 8, 2014 at 12:03 AM, Kawashima, Takahiro &lt;
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; To remove this message, put `dbxenv suppress_startup_message 7.9' in
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt;  [8] mca_base_framework_components_register(0xffffffff6335e1c0, 0x0,
</span><br>
<span class="quotelev2">&gt; &gt; 0x3e,
</span><br>
