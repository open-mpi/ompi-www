...
?>
<!-- received="Tue Aug 26 12:49:12 2014" -->
<!-- isoreceived="20140826164912" -->
<!-- sent="Tue, 26 Aug 2014 09:48:35 -0700" -->
<!-- isosent="20140826164835" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] long initialization" -->
<!-- id="B06FD137-6818-4A4C-9CEF-68D471C5C083_at_open-mpi.org" -->
<!-- charset="utf-8" -->
<!-- inreplyto="1409067169.998939980_at_f221.i.mail.ru" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-26 12:48:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25158.php">Zhang,Lei(Ecom): "[OMPI users] &#180;&#240;&#184;&#180;:  Does multiple Irecv means concurrent receiving ?"</a>
<li><strong>Previous message:</strong> <a href="25156.php">Syed Ahsan Ali: "Re: [OMPI users] openmpi-1.8.1 Unable to compile on CentOS6.5"</a>
<li><strong>In reply to:</strong> <a href="25154.php">Timur Ismagilov: "Re: [OMPI users] long initialization"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25163.php">Timur Ismagilov: "Re: [OMPI users] long initialization"</a>
<li><strong>Reply:</strong> <a href="25163.php">Timur Ismagilov: "Re: [OMPI users] long initialization"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I think something may be messed up with your installation. I went ahead and tested this on a Slurm 2.5.4 cluster, and got the following:
<br>
<p>$ time mpirun -np 1 --host bend001 ./hello
<br>
...
sys	0m0.046s
<br>
<p>$ time mpirun -np 1 --host bend002 ./hello
<br>
Hello, World, I am 0 of 1 [0 local peers]: get_cpubind: 0 bitmap 0,12
<br>
<p>real	0m0.528s
...
<br>
<p>IIRC, you were having some problems with the OOB setup. If you specify the TCP interface to use, does your time come down?
<br>
<p><p>On Aug 26, 2014, at 8:32 AM, Timur Ismagilov &lt;tismagilov_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I'm using slurm 2.5.6
</span><br>
...
<span class="quotelev2">&gt;&gt; I'm also puzzled by your timing statement - I can't replicate it:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 07:41:43  $ time mpirun -n 1 ./hello_c
</span><br>
<span class="quotelev2">&gt;&gt; Hello, world, I am 0 of 1, (Open MPI v1.9a1, package: Open MPI rhc_at_bend001 Distribution, ident: 1.9a1r32577, repo rev: r32577, Unreleased developer copy, 125)
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; real	0m0.547s
</span><br>
<span class="quotelev2">&gt;&gt; user	0m0.043s
</span><br>
<span class="quotelev2">&gt;&gt; sys	0m0.046s
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; The entire thing ran in 0.5 seconds
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Aug 22, 2014, at 6:33 AM, Mike Dubman &lt;miked_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hi,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The default delimiter is &quot;;&quot; . You can change delimiter with mca_base_env_list_delimiter.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Fri, Aug 22, 2014 at 2:59 PM, Timur Ismagilov &lt;tismagilov_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; In programm hello_c initialization takes ~1 min
</span><br>
<span class="quotelev3">&gt;&gt;&gt; In ompi 1.8.2rc4 and ealier it takes ~1 sec(or less)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; if i use 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; $mpirun  --mca mca_base_env_list 'MXM_SHM_KCOPY_MODE=off,OMP_NUM_THREADS=8' --map-by slot:pe=8 -np 1 ./hello_c
</span><br>
<span class="quotelev3">&gt;&gt;&gt; i got error 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; config_parser.c:657  MXM  ERROR Invalid value for SHM_KCOPY_MODE: 'off,OMP_NUM_THREADS=8'. Expected: [off|knem|cma|autodetect]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; but with -x all works fine (but with warn)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; $mpirun  -x MXM_SHM_KCOPY_MODE=off -x OMP_NUM_THREADS=8 -np 1 ./hello_c
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Have i I any opportunity to run mpi jobs?
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Wed, Aug 20, 2014 at 8:06 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; As i can see, the bug is fixed, but in Open MPI v1.9a1r32516  i still have the problem
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; a)
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; $ mpirun  -np 1 ./hello_c
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;     <a href="https://svn.open-mpi.org/trac/ompi/ticket/4857">https://svn.open-mpi.org/trac/ompi/ticket/4857</a>
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/24988.php">http://www.open-mpi.org/community/lists/users/2014/08/24988.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25001.php">http://www.open-mpi.org/community/lists/users/2014/08/25001.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25086.php">http://www.open-mpi.org/community/lists/users/2014/08/25086.php</a>
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25093.php">http://www.open-mpi.org/community/lists/users/2014/08/25093.php</a>
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25094.php">http://www.open-mpi.org/community/lists/users/2014/08/25094.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25095.php">http://www.open-mpi.org/community/lists/users/2014/08/25095.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25105.php">http://www.open-mpi.org/community/lists/users/2014/08/25105.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25127.php">http://www.open-mpi.org/community/lists/users/2014/08/25127.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25128.php">http://www.open-mpi.org/community/lists/users/2014/08/25128.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25129.php">http://www.open-mpi.org/community/lists/users/2014/08/25129.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25154.php">http://www.open-mpi.org/community/lists/users/2014/08/25154.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25157/attachment">attachment</a>
</ul>
