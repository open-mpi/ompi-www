...
?>
<!-- received="Mon Aug 18 14:10:30 2014" -->
<!-- isoreceived="20140818181030" -->
<!-- sent="Mon, 18 Aug 2014 14:10:37 -0400" -->
<!-- isosent="20140818181037" -->
<!-- name="Maxime Boissonneault" -->
<!-- email="maxime.boissonneault_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1" -->
<!-- id="53F2419D.50406_at_calculquebec.ca" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="8FBBB6B5-5F06-46A7-9D62-BFF98A2D5FDF_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-18 14:10:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25061.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<li><strong>Previous message:</strong> <a href="25059.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<li><strong>In reply to:</strong> <a href="25059.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25061.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<li><strong>Reply:</strong> <a href="25061.php">Ralph Castain: "Re: [OMPI users] Segmentation fault in OpenMPI 1.8.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>it works.
<br>
<p>It also works with
<br>
mpiexec -mca oob_tcp_if_include ib0 ring_c
<br>
<p>We have 4 interfaces on this node.
<br>
- lo, the local loop
<br>
- ib0, infiniband
...
<br>
<p>It seems that mpiexec attempts to use the two addresses that do not work 
<br>
...
<br>
<p><p>On the compute nodes, we have eth0 (management), ib0 and lo, and it 
<br>
...
<p>Maxime
<br>
<p><p>Le 2014-08-18 13:37, Ralph Castain a &#233;crit :
<br>
<span class="quotelev1">&gt; Yeah, there are some issues with the internal connection logic that need to get fixed. We haven't had many cases where it's been an issue, but a couple like this have cropped up - enough that I need to set aside some time to fix it.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; My apologies for the problem.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Aug 18, 2014, at 10:31 AM, Maxime Boissonneault &lt;maxime.boissonneault_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Indeed, that makes sense now.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Why isn't OpenMPI attempting to connect with the local loop for same node ? This used to work with 1.6.5.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Le 2014-08-18 13:11, Ralph Castain a &#233;crit :
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Yep, that pinpointed the problem:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [helios-login1:28558] [[63019,1],0] tcp:send_handler CONNECTING
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [helios-login1:28558] [[63019,1],0]:tcp:complete_connect called for peer [[63019,0],0] on socket 11
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [helios-login1:28558] [[63019,1],0]-[[63019,0],0] tcp_peer_complete_connect: connection failed: Connection refused (111)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [helios-login1:28558] [[63019,1],0] tcp_peer_close for [[63019,0],0] sd 11 state CONNECTING
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [helios-login1:28558] [[63019,1],0] tcp:lost connection called for peer [[63019,0],0]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The apps are trying to connect back to mpirun using the following addresses:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; tcp://10.10.1.3,132.219.137.36,10.12.1.3:34237
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The initial attempt is here
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [helios-login1:28558] [[63019,1],0] orte_tcp_peer_try_connect: attempting to connect to proc [[63019,0],0] on 10.10.1.3:34237 - 0 retries
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I know there is a failover bug in the 1.8 series, and so if that connection got rejected the proc would abort. Should we be using a different network? If so, telling us via the oob_tcp_if_include param would be the solution.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Aug 18, 2014, at 10:04 AM, Maxime Boissonneault &lt;maxime.boissonneault_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Le 2014-08-18 12:59, Ralph Castain a &#233;crit :
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;output_ringc_verbose2.txt.gz&gt;_______________________________________________
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; users mailing list
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; users_at_[hidden]
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25056.php">http://www.open-mpi.org/community/lists/users/2014/08/25056.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; _______________________________________________
</span><br>
<span class="quotelev3">&gt;&gt;&gt; users mailing list
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25057.php">http://www.open-mpi.org/community/lists/users/2014/08/25057.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; -- 
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25058.php">http://www.open-mpi.org/community/lists/users/2014/08/25058.php</a>
</span><br>
<span class="quotelev1">&gt; _______________________________________________
</span><br>
<span class="quotelev1">&gt; users mailing list
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25059.php">http://www.open-mpi.org/community/lists/users/2014/08/25059.php</a>
</span><br>
<p><p><pre>
-- 
---------------------------------
