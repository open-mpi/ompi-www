...
?>
<!-- received="Wed Aug 20 09:35:40 2014" -->
<!-- isoreceived="20140820133540" -->
<!-- sent="Wed, 20 Aug 2014 06:35:23 -0700" -->
<!-- isosent="20140820133523" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running a hybrid MPI+openMP program" -->
<!-- id="57509654-897B-4804-82D5-8C6D671ACB2F_at_open-mpi.org" -->
<!-- charset="iso-2022-jp" -->
...
<strong>Date:</strong> 2014-08-20 09:35:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25086.php">Timur Ismagilov: "Re: [OMPI users] ORTE daemon has unexpectedly failed after launch"</a>
<li><strong>Previous message:</strong> <a href="25084.php">tmishima_at_[hidden]: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>In reply to:</strong> <a href="25084.php">tmishima_at_[hidden]: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25087.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Aug 20, 2014, at 4:26 AM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; Then, the openmpi automatically reduces the logical slot count to 10
</span><br>
