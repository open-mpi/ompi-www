...
?>
<!-- received="Tue Aug 19 13:06:54 2014" -->
<!-- isoreceived="20140819170654" -->
<!-- sent="Tue, 19 Aug 2014 12:06:53 -0500" -->
<!-- isosent="20140819170653" -->
<!-- name="Oscar Mojica" -->
<!-- email="o_mojical_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running a hybrid MPI+openMP program" -->
<!-- id="BLU177-W2774C4328E2E9D3DF8145490D50_at_phx.gbl" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="AD4636A3-D2EF-411E-A2B8-D18D48881358_at_staff.uni-marburg.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-08-19 13:06:53
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="25080.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>Previous message:</strong> <a href="25078.php">Maxime Boissonneault: "Re: [OMPI users] Segfault with MPI + Cuda on multiple nodes"</a>
<li><strong>In reply to:</strong> <a href="25038.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="25080.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<li><strong>Reply:</strong> <a href="25080.php">Reuti: "Re: [OMPI users] Running a hybrid MPI+openMP program"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Reuti
<br>
I discovered what was the error. I forgot include the '-fopenmp' when I compiled the objects in the Makefile, so the program worked but it didn't divide the job in threads. Now the program is working and I can use until 15 cores for machine in the queue one.q.
<br>
Anyway i would like to try implement your advice. Well I'm not alone in the cluster so i must implement your second suggestion. The steps are
<br>
a) Use '$ qconf -mp orte' to change the allocation rule to 8
<br>
b) Set '#$ -pe orte 80' in the script
<br>
c) I'm not sure how to do this step. I'd appreciate your help here. I can add some lines to the script to determine the PE_HOSTFILE path and contents, but i don't know how alter it 
<br>
...
<span class="quotelev2">&gt; &gt; I'm a bit slow and I didn't understand the las part of your message. So i made a test trying to solve my doubts.
</span><br>
<span class="quotelev2">&gt; &gt; This is the cluster configuration: There are some machines turned off but that is no problem
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt; I ran my program using only MPI with 10 processors of the queue one.q which has 14 machines (compute-1-2 to compute-1-15). Whit 'qstat -t' I got:
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; [oscar_at_aguia free-noise]$ qstat -t
</span><br>
<span class="quotelev2">&gt; &gt; job-ID  prior   name       user         state submit/start at     queue                          master ja-task-ID task-ID state cpu        mem     io      stat failed 
</span><br>
<span class="quotelev2">&gt; &gt; -----------------------------------------------------------------------------------------------------------------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-2.local        MASTER                        r     00:49:12 554.13753 0.09163 
</span><br>
<span class="quotelev2">&gt; &gt;                                                                   one.q_at_compute-1-2.local        SLAVE         
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-5.local        SLAVE            1.compute-1-5 r     00:48:53 551.49022 0.09410 
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-9.local        SLAVE            1.compute-1-9 r     00:50:00 564.22764 0.09409 
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-12.local       SLAVE            1.compute-1-12 r     00:47:30 535.30379 0.09379 
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-13.local       SLAVE            1.compute-1-13 r     00:49:51 561.69868 0.09379 
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-14.local       SLAVE            1.compute-1-14 r     00:49:14 554.60818 0.09379 
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-10.local       SLAVE            1.compute-1-10 r     00:49:59 562.95487 0.09349 
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-15.local       SLAVE            1.compute-1-15 r     00:50:01 563.27221 0.09361 
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-8.local        SLAVE            1.compute-1-8 r     00:49:26 556.68431 0.09349 
</span><br>
<span class="quotelev2">&gt; &gt;    2726 0.50500 job        oscar        r     08/15/2014 12:38:21 one.q_at_compute-1-4.local        SLAVE            1.compute-1-4 r     00:49:27 556.87510 0.04967 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Yes, here you got 10 slots (= cores) granted by SGE. So there is no free core left inside the allocation of SGE to allow the use of additional cores for your threads. If you use more cores than granted by SGE, it will oversubscribe the machines.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; a) If you want 8 threads per MPI process, your job will use 80 cores in total - for now SGE isn't aware of it.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; b) Although you specified $fill_up as allocation rule, it looks like $round_robin. Is there more than one slot defined in the queue definition of one.q to get exclusive access?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; c) What version of SGE are you using? Certain ones use cgroups or bind processes directly to cores (although it usually needs to be requested by the job: first line of `qconf -help`).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; In case you are alone in the cluster, you could bypass the allocation with b) (unless you are hit by c)). But having a mixture of users and jobs a different handling would be necessary to handle this in a proper way IMO:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; c) copy and alter the $PE_HOSTFILE to show only (granted core count per machine) divided by (OMP_NUM_THREADS) per entry, change $PE_HOSTFILE so that it points to the altered file
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; d) Open MPI with a Tight Integration will now start only N process per machine according to the altered hostfile, in your case one
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; e) Your application can start the desired threads and you stay inside the granted allocation
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt; I accessed to the MASTER processor with 'ssh compute-1-2.local' , and with $ ps -e f and got this, I'm showing only the last lines  
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt; 17695 ?        Ss     0:00      \_ -bash /opt/gridengine/default/spool/compute-1-2/job_scripts/2726
</span><br>
<span class="quotelev2">&gt; &gt; 17797 ?        S      0:00          \_ /usr/bin/time -f %E /opt/openmpi/bin/mpirun -v -np 10 ./inverse.exe
</span><br>
<span class="quotelev2">&gt; &gt; 17798 ?        S      0:01              \_ /opt/openmpi/bin/mpirun -v -np 10 ./inverse.exe
</span><br>
<span class="quotelev2">&gt; &gt; 17799 ?        Sl     0:00                  \_ /opt/gridengine/bin/linux-x64/qrsh -inherit -nostdin -V compute-1-5.local     PATH=/opt/openmpi/bin:$PATH ; expo
</span><br>
<span class="quotelev2">&gt; &gt; 17800 ?        Sl     0:00                  \_ /opt/gridengine/bin/linux-x64/qrsh -inherit -nostdin -V compute-1-9.local     PATH=/opt/openmpi/bin:$PATH ; expo
</span><br>
<span class="quotelev2">&gt; &gt; 17801 ?        Sl     0:00                  \_ /opt/gridengine/bin/linux-x64/qrsh -inherit -nostdin -V compute-1-12.local     PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt; &gt; 17802 ?        Sl     0:00                  \_ /opt/gridengine/bin/linux-x64/qrsh -inherit -nostdin -V compute-1-13.local     PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt; &gt; 17803 ?        Sl     0:00                  \_ /opt/gridengine/bin/linux-x64/qrsh -inherit -nostdin -V compute-1-14.local     PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt; &gt; 17804 ?        Sl     0:00                  \_ /opt/gridengine/bin/linux-x64/qrsh -inherit -nostdin -V compute-1-10.local     PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt; &gt; 17805 ?        Sl     0:00                  \_ /opt/gridengine/bin/linux-x64/qrsh -inherit -nostdin -V compute-1-15.local     PATH=/opt/openmpi/bin:$PATH ; exp
</span><br>
<span class="quotelev2">&gt; &gt; 17806 ?        Sl     0:00                  \_ /opt/gridengine/bin/linux-x64/qrsh -inherit -nostdin -V compute-1-8.local     PATH=/opt/openmpi/bin:$PATH ; expo
</span><br>
<span class="quotelev2">&gt; &gt; 17807 ?        Sl     0:00                  \_ /opt/gridengine/bin/linux-x64/qrsh -inherit -nostdin -V compute-1-4.local     PATH=/opt/openmpi/bin:$PATH ; expo
</span><br>
...
<span class="quotelev2">&gt; &gt; So the job is using the 10 machines, Until here is all right OK. Do you think that changing the &quot;allocation_rule &quot; to a number instead $fill_up the MPI processes would divide the work in that number of threads?
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; I think this is a broader issue in case an MPI library is used in conjunction with threads while running inside a queuing system. First: whether your actual installation of Open MPI is SGE-aware you can check with:
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; (f w/o -) to have a look whether `ssh` or `qrsh -inhert ...` is used to reach other machines and their requested process count.
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 
...
<span class="quotelev3">&gt; &gt; &gt; AFAICS: for now there is no way in the Open MPI + SGE combination to specify the number of MPI processes and intended number of threads which are automatically read by Open MPI while staying inside the granted slot count and allocation. So it seems to be necessary to have the intended number of threads being honored by Open MPI too.
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Hence specifying e.g. &quot;allocation_rule 8&quot; in such a setup while requesting 32 processes, would for now start 32 processes by MPI already, as Open MP reads the $PE_HOSTFILE and acts accordingly.
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Open MPI would have to read the generated machine file in a slightly different way regarding threads: a) read the $PE_HOSTFILE, b) divide the granted slots per machine by OMP_NUM_THREADS, c) throw an error in case it's not divisible by OMP_NUM_THREADS. Then start one process per quotient.
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; I changed the line to run the program in the script with both options
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/bin/time -f &quot;%E&quot; /opt/openmpi/bin/mpirun -v --bind-to-none -np $NSLOTS ./inverse.exe
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; /usr/bin/time -f &quot;%E&quot; /opt/openmpi/bin/mpirun -v --bind-to-socket -np $NSLOTS ./inverse.exe
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; 
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25032.php">http://www.open-mpi.org/community/lists/users/2014/08/25032.php</a>
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 
</span><br>
<span class="quotelev3">&gt; &gt; &gt; _______________________________________________
...
<span class="quotelev3">&gt; &gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25034.php">http://www.open-mpi.org/community/lists/users/2014/08/25034.php</a>
</span><br>
...
<span class="quotelev2">&gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25037.php">http://www.open-mpi.org/community/lists/users/2014/08/25037.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2014/08/25038.php">http://www.open-mpi.org/community/lists/users/2014/08/25038.php</a>
</span><br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<br>
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-25079/attachment">attachment</a>
</ul>
