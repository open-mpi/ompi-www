...
?>
<!-- received="Fri Feb 14 05:15:19 2014" -->
<!-- isoreceived="20140214101519" -->
<!-- sent="Fri, 14 Feb 2014 02:14:59 -0800" -->
<!-- isosent="20140214101459" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] one more finding in openmpi-1.7.5a1" -->
<!-- id="3F49BB4C-0DA6-4196-B593-10B98D4D5872_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="OF6B255AEC.EE815150-ON49257C7F.00222DFD-49257C7F.002280D0_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-02-14 05:14:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23610.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<li><strong>Previous message:</strong> <a href="23608.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<li><strong>In reply to:</strong> <a href="23608.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23610.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<li><strong>Reply:</strong> <a href="23610.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Thanks - hit me in the middle of the night over here that we had missed some options, but nice to find you had also seen it. Slightly modified patch will be applied and brought over to 1.7.5
<br>
<p><p>On Feb 13, 2014, at 10:16 PM, tmishima_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; Please try attached patch - from r30723.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; (See attached file: patch.rmaps_base_frame.from_r30723)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Thanks for prompt help.
</span><br>
<span class="quotelev2">&gt;&gt; Could you please resent the patch as attachment which can be applied with
</span><br>
<span class="quotelev1">&gt; &quot;patch&quot; command, my mail client messes long lines.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Fri, Feb 14, 2014 at 7:40 AM,  &lt;tmishima_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Thanks. I'm not familiar with mindist mapper. But obviously
</span><br>
<span class="quotelev2">&gt;&gt; checking for ORTE_MAPPING_BYDIST is missing. In addition,
</span><br>
<span class="quotelev2">&gt;&gt; ORTE_MAPPING_PPR is missing again by my mistake.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Please try this patch.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt;             } else if (ORTE_MAPPING_PPR == ORTE_GET_MAPPING_POLICY
</span><br>
<span class="quotelev2">&gt;&gt; (mapping)) {
</span><br>
<span class="quotelev2">&gt;&gt;                 ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_SLOT);
</span><br>
<span class="quotelev2">&gt;&gt;             } else if (ORTE_MAPPING_BYDIST == ORTE_GET_MAPPING_POLICY
</span><br>
<span class="quotelev2">&gt;&gt; (mapping)) {
</span><br>
<span class="quotelev2">&gt;&gt;                 ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_SLOT);
...
<span class="quotelev3">&gt;&gt;&gt; after this patch we get this in jenkins:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 07:03:15 [vegas12.mtr.labs.mlnx:01646] [[26922,0],0] ORTE_ERROR_LOG:
</span><br>
<span class="quotelev1">&gt; Not
</span><br>
<span class="quotelev2">&gt;&gt; implemented in file rmaps_mindist_module.c at line 39107:03:15
</span><br>
<span class="quotelev2">&gt;&gt; [vegas12.mtr.labs.mlnx:01646] [[26922,0],0] ORTE_ERROR_LOG: Not
</span><br>
<span class="quotelev3">&gt;&gt;&gt; implemented in file base/rmaps_base_map_job.c at line 285
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; On Fri, Feb 14, 2014 at 6:35 AM,  &lt;tmishima_at_[hidden]&gt;wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Sorry, one more shot - byslot was dropped!
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     if (NULL == spec) {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         /* check for map-by object directives - we set the
</span><br>
<span class="quotelev3">&gt;&gt;&gt;          * ranking to match if one was given
</span><br>
<span class="quotelev3">&gt;&gt;&gt;          */
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         if (ORTE_MAPPING_GIVEN &amp; ORTE_GET_MAPPING_DIRECTIVE(mapping)) {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;             if (ORTE_MAPPING_BYSLOT == ORTE_GET_MAPPING_POLICY
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             } else if (ORTE_MAPPING_BYNODE == ORTE_GET_MAPPING_POLICY
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (mapping)) {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;                 ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_NODE);
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;             } else if (ORTE_MAPPING_BYSOCKET == ORTE_GET_MAPPING_POLICY
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (mapping)) {
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Tetusya Mishima
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I've found it. Please add 2 lines(770, 771) in rmaps_base_frame.c:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 752              if (ORTE_MAPPING_BYCORE == ORTE_GET_MAPPING_POLICY
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (mapping)) {
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 753                  ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_CORE);
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 754              } else if (ORTE_MAPPING_BYNODE ==
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ORTE_GET_MAPPING_POLICY(mapping)) {
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 755                  ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_NODE);
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 765                  ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_NUMA);
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; 770              } else if (ORTE_MAPPING_PPR ==
</span><br>
<span class="quotelev1">&gt; ORTE_GET_MAPPING_POLICY
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (mapping)) {
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 771                  ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_SLOT);
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 772              }
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; You are welcome, Ralph.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; But, after fixing it, I'm facing another problem whin I use ppr
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; [manage.cluster:28057] [[25570,0],0] ORTE_ERROR_LOG: Not
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Thanks - these used to be bitmaps, but changed when we started
</span><br>
<span class="quotelev3">&gt;&gt;&gt; getting
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; so
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; many options. Sadly, they are very rarely used, so bugs like this
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;   748          /* check for map-by object directives - we set
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;   751          if (ORTE_MAPPING_GIVEN &amp;
</span><br>
<span class="quotelev2">&gt;&gt; ORTE_GET_MAPPING_DIRECTIVE
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; (mapping)) {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;   752              if (ORTE_MAPPING_BYCORE ==
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ORTE_GET_MAPPING_POLICY
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; (mapping)) {
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;   753                  ORTE_SET_RANKING_POLICY(tmp,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ORTE_RANK_BY_CORE);
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; ORTE_RANK_BY_NODE);
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; ORTE_RANK_BY_NUMA);
</span><br>
...
<span class="quotelev1">&gt; &lt;patch.rmaps_base_frame.from_r30723&gt;_______________________________________________
</span><br>
<span class="quotelev1">&gt; users mailing list
</span><br>
<span class="quotelev1">&gt; users_at_[hidden]
