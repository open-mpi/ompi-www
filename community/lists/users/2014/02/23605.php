...
?>
<!-- received="Fri Feb 14 00:21:43 2014" -->
<!-- isoreceived="20140214052143" -->
<!-- sent="Fri, 14 Feb 2014 07:21:41 +0200" -->
<!-- isosent="20140214052141" -->
<!-- name="Mike Dubman" -->
<!-- email="miked_at_[hidden]" -->
<!-- subject="Re: [OMPI users] one more finding in openmpi-1.7.5a1" -->
<!-- id="CAAO1Kya3i7nYL9ggQzL6rbRw98b6OHxaLwUJVTLsLbw3TmQMhQ_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="OF3DBA97CF.F03041EB-ON49257C7F.0019065E-49257C7F.00194394_at_jcity.maeda.co.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-02-14 00:21:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="23606.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<li><strong>Previous message:</strong> <a href="23604.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<li><strong>In reply to:</strong> <a href="23604.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="23606.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<li><strong>Reply:</strong> <a href="23606.php">tmishima_at_[hidden]: "Re: [OMPI users] one more finding in openmpi-1.7.5a1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>*07:03:15* [vegas12.mtr.labs.mlnx:01646] [[26922,0],0] ORTE_ERROR_LOG:
<br>
...
<br>
<p><p><p><p><p>On Fri, Feb 14, 2014 at 6:35 AM, &lt;tmishima_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev2">&gt; &gt; 757                  ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_L1CACHE);
</span><br>
<span class="quotelev2">&gt; &gt; 758              } else if (ORTE_MAPPING_BYL2CACHE ==
</span><br>
<span class="quotelev2">&gt; &gt; ORTE_GET_MAPPING_POLICY(mapping)) {
</span><br>
<span class="quotelev2">&gt; &gt; 759                  ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_L2CACHE);
</span><br>
<span class="quotelev2">&gt; &gt; 760              } else if (ORTE_MAPPING_BYL3CACHE ==
</span><br>
<span class="quotelev2">&gt; &gt; ORTE_GET_MAPPING_POLICY(mapping)) {
</span><br>
<span class="quotelev2">&gt; &gt; 761                  ORTE_SET_RANKING_POLICY(tmp, ORTE_RANK_BY_L3CACHE);
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; But, after fixing it, I'm facing another problem whin I use ppr option:
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; [manage.cluster:28057] [[25570,0],0] ORTE_ERROR_LOG: Not implemented in
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-23605/attachment">attachment</a>
</ul>
