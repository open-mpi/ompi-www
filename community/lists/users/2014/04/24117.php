...
?>
<!-- received="Tue Apr  8 12:50:15 2014" -->
<!-- isoreceived="20140408165015" -->
<!-- sent="Tue, 08 Apr 2014 12:50:05 -0400" -->
<!-- isosent="20140408165005" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi query" -->
<!-- id="534428BD.1080705_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="40173FA6-1929-4E06-BB1F-40D7544FA52E_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-04-08 12:50:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24118.php">Daniel Milroy: "[OMPI users] File locking in ADIO, OpenMPI 1.6.4"</a>
<li><strong>Previous message:</strong> <a href="24116.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Simple Question regarding MPI Scatterv"</a>
<li><strong>In reply to:</strong> <a href="24108.php">Jeff Squyres (jsquyres): "Re: [OMPI users] openmpi query"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24054.php">Reuti: "Re: [OMPI users] openmpi query"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; You should ping the Rocks maintainers and ask them to upgrade.
</span><br>
Open MPI 1.4.3 was released in September of 2010.
<br>
<span class="quotelev1">&gt;
</span><br>
<p>On Rocks, you can install OpenMPI from source (and any other software
<br>
...
<br>
<p>Download the OMPI tarball somewhere in your home directory
<br>
(say /home/nisha/Download/ompi-1.8),
<br>
and configure it there with the prefix above.
<br>
Use different directories for download/build and for installation 
<br>
(--prefix below).
<br>
...
<p>Then do:
<br>
<p>./configure --prefix=/share/apps/openmpi/1.8/gnu CC=gcc CXX=g++ 
<br>
...
<p>make install
<br>
<p>Then set your PATH and LD_LIBRARY_PATH as recommended in the OMPI FAQ:
<br>
...
<br>
<p>Compile your application with the OMPI version above (you may need
<br>
to adjust the Makefile, etc).
<br>
<p>Reading the OMPI FAQ is a big time and headache saver:
<br>
<p><a href="http://www.open-mpi.org/faq/">http://www.open-mpi.org/faq/</a>
<br>
<p><span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Apr 8, 2014, at 5:37 AM, Nisha Dhankher -M.Tech(CSE) &lt;nishadhankher-coaeseeit_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; latest rocks 6.2  carry this version only
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Tue, Apr 8, 2014 at 3:49 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Open MPI 1.4.3 is *ancient*.  Please upgrade -- we just released Open MPI 1.8 last week.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; Also, please look at this FAQ entry -- it steps you through a lot of basic troubleshooting steps about getting basic MPI programs working.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Once you get basic MPI programs working, then try with MPI Blast.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; On Apr 5, 2014, at 3:11 AM, Nisha Dhankher -M.Tech(CSE) &lt;nishadhankher-coaeseeit_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Mpirun --mca btl ^openib --mca btl_tcp_if_include eth0  -np 16  -machinefile mf mpiblast -d all.fas -p blastn -i query.fas -o out.txt
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; was the command i executed on cluster...
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; On Sat, Apr 5, 2014 at 12:34 PM, Nisha Dhankher -M.Tech(CSE) &lt;nishadhankher-coaeseeit_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; sorry Ralph my mistake its not names...it is &quot;it does not happen on same nodes.&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Sat, Apr 5, 2014 at 12:33 PM, Nisha Dhankher -M.Tech(CSE) &lt;nishadhankher-coaeseeit_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; same vm on all machines that is virt-manager
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Sat, Apr 5, 2014 at 12:32 PM, Nisha Dhankher -M.Tech(CSE) &lt;nishadhankher-coaeseeit_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Okay, so if you run mpiBlast on all the non-name nodes, everything is okay? What do you mean by &quot;names nodes&quot;?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Apr 4, 2014, at 7:32 AM, Nisha Dhankher -M.Tech(CSE) &lt;nishadhankher-coaeseeit_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm sorry if my questions appear abrasive - I'm just a little frustrated at the communication bottleneck as I can't seem to get a clear picture of your situation. So you really don't need to keep calling me &quot;sir&quot; :-)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The error you are hitting is very unusual - it means that the processes are able to make a connection, but are failing to correctly complete a simple handshake exchange of their process identifications. There are only a few ways that can happen, and I'm trying to get you to test for them.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; So let's try and see if we can narrow this down. You mention that it works on some machines, but not all. Is this consistent - i.e., is it always the same machines that work, and the same ones that generate the error? If you exclude the ones that show the error, does it work? If so, what is different about those nodes? Are they a different architecture?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Apr 3, 2014, at 11:09 PM, Nisha Dhankher -M.Tech(CSE) &lt;nishadhankher-coaeseeit_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; sir
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; smae virt-manager is bein used by all pc's.no i did n't enable openmpi-hetro.Yes openmpi version is same in all through same kickstart file.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; ok...actually sir...rocks itself installed,configured openmpi and mpich on it own through hpc roll.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Apr 3, 2014, at 8:03 PM, Nisha Dhankher -M.Tech(CSE) &lt;nishadhankher-coaeseeit_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; And i haven't made compute nodes on direct physical nodes (pc's) becoz in college it is not possible to take whole lab of 32 pc's for your work  so i ran on vm.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
