...
?>
<!-- received="Mon Apr  7 16:04:07 2014" -->
<!-- isoreceived="20140407200407" -->
<!-- sent="Mon, 7 Apr 2014 22:04:06 +0200" -->
<!-- isosent="20140407200406" -->
<!-- name="Hamid Saeed" -->
<!-- email="e.hamidsaeed_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem for multiple clusters using mpirun" -->
<!-- id="CAADBNWyHPeg0nBk+vb1UaZszumhHhYO2ZQnh5mrksc+pQSHCaA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="C47C42C9-35B7-42C5-A435-3A2729F07ABF_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-04-07 16:04:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24085.php">Blosch, Edwin L: "[OMPI users] Problem with shell when launching jobs with OpenMPI 1.6.5 rsh"</a>
<li><strong>Previous message:</strong> <a href="24083.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<li><strong>In reply to:</strong> <a href="24083.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24086.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<li><strong>Reply:</strong> <a href="24086.php">Jeff Squyres (jsquyres): "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><p><p><p>On Mon, Apr 7, 2014 at 9:52 PM, Jeff Squyres (jsquyres)
<br>
&lt;jsquyres_at_[hidden]&gt;wrote:
<br>
<p><span class="quotelev1">&gt; I was out on vacation / fully disconnected last week, and am just getting
</span><br>
<span class="quotelev1">&gt; to all the backlog now...
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Are you saying that port 1024 was locked as well -- i.e., that we should
</span><br>
<span class="quotelev1">&gt; set the minimum to 1025?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev2">&gt; &gt; I was facing problem in running my Algorithm on multiple processors
</span><br>
<span class="quotelev1">&gt; (using ssh).
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; On Tue, Mar 25, 2014 at 1:27 PM, Jeff Squyres (jsquyres) &lt;
</span><br>
<span class="quotelev1">&gt; jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt; This is very odd -- the default value for btl_tcp_port_min_v4 is 1024.
</span><br>
<span class="quotelev1">&gt;  So unless you have overridden this value, you should not be getting a port
</span><br>
...
<span class="quotelev2">&gt; &gt; mca:btl:tcp:param:btl_tcp_port_min_v4:help:The minimum port where the
</span><br>
<span class="quotelev1">&gt; TCP BTL will try to bind (default 1024)
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; mpiexec -n 2 --host karp,wirth --mca btl ^openib --mca
</span><br>
<span class="quotelev1">&gt; btl_tcp_if_include br0 --mca btl_tcp_port_min_v4 10000 ./a.out
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
...
<span class="quotelev3">&gt; &gt; &gt; On Tue, Mar 25, 2014 at 10:23 AM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Hello,
</span><br>
<span class="quotelev3">&gt; &gt; &gt; I am not sure what approach does the MPI communication follow but when
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; On Tue, Mar 25, 2014 at 9:15 AM, Reuti &lt;reuti_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; [karp:23756] btl: tcp: attempting to connect() to address
</span><br>
<span class="quotelev1">&gt; 134.106.3.252 on port 4
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
...
<span class="quotelev4">&gt; &gt; &gt; &gt; MPI tries to use one of the reserve ports and prompts the connection
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; There are certain parameters to set the range of used ports, but using
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; On Mon, Mar 24, 2014 at 5:32 PM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; The problem was from the network administrator. The machines on the
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; On Mon, Mar 24, 2014 at 4:34 PM, Jeff Squyres (jsquyres) &lt;
</span><br>
<span class="quotelev1">&gt; jsquyres_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; Try using btl_tcp_if_include and list just the interface(s) that you
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; Also, it looks like you didn't setup your SSH keys properly for
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; On Mar 24, 2014, at 10:56 AM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; hsaeed_at_karp:~/Task4_mpi/scatterv$ mpirun -np 8 --mca btl ^openib
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; At least one pair of MPI processes are unable to reach each other
</span><br>
<span class="quotelev1">&gt; for
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; MPI communications.  This means that no Open MPI device has
</span><br>
<span class="quotelev1">&gt; indicated
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; that it can be used to communicate between these processes.  This
</span><br>
<span class="quotelev1">&gt; is
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; an error; Open MPI requires that all MPI processes be able to reach
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; each other.  This error can sometimes be the result of forgetting
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; An MPI process is aborting at a time when it cannot guarantee that
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; node wirth exiting improperly. There are two reasons this could
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; the job did. This can cause a job to hang indefinitely while it
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; By rule, all processes that call &quot;init&quot; MUST call &quot;finalize&quot; prior
</span><br>
<span class="quotelev1">&gt; to
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; [karp:29513] 1 more process has sent help message
</span><br>
<span class="quotelev1">&gt; help-mca-bml-r2.txt / unreachable proc
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; [karp:29513] Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to
</span><br>
<span class="quotelev1">&gt; see all help / error messages
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; [karp:29513] 1 more process has sent help message help-mpi-runtime
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; On Mon, Mar 24, 2014 at 3:25 PM, Jeff Squyres (jsquyres) &lt;
</span><br>
<span class="quotelev1">&gt; jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; If you you use btl_tcp_if_exclude, you also need to exclude the
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; On Mar 24, 2014, at 4:57 AM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt;
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt; &gt; I checked there is no firewall which is acting as a barrier for
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt; &gt; hsaeed_at_karp:~/Task4_mpi/scatterv$ mpiexec -n 2 --mca
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt; &gt; Used &quot;..exclude bt2&quot; because the failed connection was from bt2
</span><br>
<span class="quotelev1">&gt; as you can see in the &quot;ifconfig&quot; output mentioned above.
</span><br>
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt; &gt; I know there is something wrong but i am almost unable to figure
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt; &gt; Do you have any firewalling enabled on these machines?  If so,
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt; &gt; On Mar 21, 2014, at 10:24 AM, Hamid Saeed &lt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX packets:49080961 errors:0 dropped:50263
</span><br>
<span class="quotelev1">&gt; overruns:0 frame:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           TX packets:43279252 errors:0 dropped:0 overruns:0
</span><br>
<span class="quotelev1">&gt; carrier:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           collisions:0 txqueuelen:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX bytes:41348407558 (38.5 GiB)  TX
</span><br>
<span class="quotelev1">&gt; bytes:80505842745 (74.9 GiB)
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX packets:41573060 errors:0 dropped:50261
</span><br>
<span class="quotelev1">&gt; overruns:0 frame:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           TX packets:1693509 errors:0 dropped:0 overruns:0
</span><br>
<span class="quotelev1">&gt; carrier:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           collisions:0 txqueuelen:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX bytes:6177072160 (5.7 GiB)  TX bytes:230617435
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX packets:69108377 errors:0 dropped:0 overruns:0
</span><br>
<span class="quotelev1">&gt; frame:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           TX packets:86459066 errors:0 dropped:0 overruns:0
</span><br>
<span class="quotelev1">&gt; carrier:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           collisions:0 txqueuelen:1000
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX bytes:43533091399 (40.5 GiB)  TX
</span><br>
<span class="quotelev1">&gt; bytes:83359370885 (77.6 GiB)
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX packets:43531546 errors:0 dropped:0 overruns:0
</span><br>
<span class="quotelev1">&gt; frame:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           TX packets:1716151 errors:0 dropped:0 overruns:0
</span><br>
<span class="quotelev1">&gt; carrier:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           collisions:0 txqueuelen:1000
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX bytes:7201915977 (6.7 GiB)  TX bytes:232026383
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX packets:10890707 errors:0 dropped:0 overruns:0
</span><br>
<span class="quotelev1">&gt; frame:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           TX packets:10890707 errors:0 dropped:0 overruns:0
</span><br>
<span class="quotelev1">&gt; carrier:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           collisions:0 txqueuelen:0
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;           RX bytes:36194379576 (33.7 GiB)  TX
</span><br>
<span class="quotelev1">&gt; bytes:36194379576 (33.7 GiB)
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt; hsaeed_at_karp:~/Task4_mpi/scatterv$ mpiexec -n 2 -host
</span><br>
<span class="quotelev1">&gt; wirth,karp ./a.out
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt; On Mar 21, 2014, at 10:09 AM, Hamid Saeed &lt;
</span><br>
<span class="quotelev1">&gt; e.hamidsaeed_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; &gt; I think i have a tcp connection. As for as i know my
</span><br>
<span class="quotelev1">&gt; cluster is not configured for Infiniband (IB).
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt; What are the IP addresses reported by connect()?  (i.e., the
</span><br>
<span class="quotelev1">&gt; address you X'ed out)
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev3">&gt; &gt; &gt; &gt; &gt; &gt; &gt; Send the output from ifconfig on each of your servers.  Note
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24084/attachment">attachment</a>
</ul>
