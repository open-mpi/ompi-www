...
?>
<!-- received="Tue Apr 15 11:57:53 2014" -->
<!-- isoreceived="20140415155753" -->
<!-- sent="Tue, 15 Apr 2014 11:57:46 -0400" -->
<!-- isosent="20140415155746" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun runs in serial even I set np to several processors" -->
<!-- id="534D56FA.2040703_at_ldeo.columbia.edu" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="CACWmqDfq2VA+0FVhgAPQxuSFj_xdzs2sVWJFrpvQYzAey7W9PA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-04-15 11:57:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24204.php">Oscar Mojica: "[OMPI users] Where is the error? (MPI program in fortran)"</a>
<li><strong>Previous message:</strong> <a href="24202.php">Ralph Castain: "Re: [OMPI users] Problem in Open MPI (v1.8) Performance on 10G Ethernet"</a>
<li><strong>In reply to:</strong> <a href="24195.php">Djordje Romanic: "Re: [OMPI users] mpirun runs in serial even I set np to several processors"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24205.php">Djordje Romanic: "Re: [OMPI users] mpirun runs in serial even I set np to several processors"</a>
<li><strong>Reply:</strong> <a href="24205.php">Djordje Romanic: "Re: [OMPI users] mpirun runs in serial even I set np to several processors"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Djordje
<br>
<p>&quot;locate mpirun&quot; shows items labled &quot;intel&quot;, &quot;mpich&quot;, and &quot;openmpi&quot;, 
<br>
maybe more.
<br>
Is it Ubuntu or Debian?
<br>
<p>Anyway, if you got this mess from somebody else,
<br>
...
<br>
<p>0. Make sure you have gcc, g++, and gfortran installed,
<br>
...
<br>
<p>1. Download the Open MPI (a.k.a OMPI) tarball to a work directory
<br>
of your choice,
<br>
...
<br>
<p>2. Configure it to be installed in yet another directory under
<br>
your home, say /home/djordje/sw/openmpi/1.8 (with --prefix).
<br>
<p>cd /home/djordje/inst/openmpi/1.8
<br>
<p>./configure --prefix=/home/djordje/sw/openmpi/1.8 CC=gcc, CXX=g++,
<br>
FC=gfortran
<br>
<p>[Not sure if with 1.8 there is a separate F77 interface, if there is
<br>
...
make install
<br>
<p>3. Setup your environment variables PATH and LD_LIBRARY_PATH
<br>
...
<p>.tcshrc/.cshrc:
<br>
<p>setenv PATH /home/djordje/sw/openmpi/1.8/bin:$PATH
<br>
setenv LD_LIBRARY_PATH /home/djordje/sw/openmpi/1.8/lib:$LD_LIBRARY_PATH
<br>
<p>4. Logout, login again (or open a new terminal), and check if you
<br>
...
which mpirun
<br>
<p>They should point to items in /home/djordje/sw/openmpi/1.8/bin
<br>
<p>5. Rebuild WRF from scratch.
<br>
<p>6. Check if WRF got the libraries right:
<br>
<p>ldd wrf.exe
<br>
<p>This should show mpi libraries in /home/djordje/sw/openmpi/1.8/lib
<br>
<p>7. Run WRF
<br>
mpirun -np 4 wrf.exe
...
Gus Correa
<br>
<p><p><p><p>On 04/14/2014 08:21 PM, Djordje Romanic wrote:
<br>
...
<span class="quotelev1">&gt; */home/djordje/Build_WRF/LIBRARIES/mpich/bin/mpirun*
</span><br>
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/intel/4.1.1.036/linux-x86_64/bin/mpirun
</span><br>
<span class="quotelev1">&gt; &lt;<a href="http://4.1.1.036/linux-x86_64/bin/mpirun">http://4.1.1.036/linux-x86_64/bin/mpirun</a>&gt;
</span><br>
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/intel/4.1.1.036/linux-x86_64/bin64/mpirun
</span><br>
<span class="quotelev1">&gt; &lt;<a href="http://4.1.1.036/linux-x86_64/bin64/mpirun">http://4.1.1.036/linux-x86_64/bin64/mpirun</a>&gt;
</span><br>
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/intel/4.1.1.036/linux-x86_64/ia32/bin/mpirun
</span><br>
<span class="quotelev1">&gt; &lt;<a href="http://4.1.1.036/linux-x86_64/ia32/bin/mpirun">http://4.1.1.036/linux-x86_64/ia32/bin/mpirun</a>&gt;
</span><br>
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/intel/4.1.1.036/linux-x86_64/intel64/bin/mpirun
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/openmpi/1.4.3/linux-x86_64-2.3.4/gnu4.5/bin/mpirun
</span><br>
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/openmpi/1.4.3/linux-x86_64-2.3.4/gnu4.5/share/man/man1/mpirun.1
</span><br>
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/openmpi/1.6.4/linux-x86_64-2.3.4/gnu4.6/bin/mpirun
</span><br>
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/openmpi/1.6.4/linux-x86_64-2.3.4/gnu4.6/share/man/man1/mpirun.1
</span><br>
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/bin/mpirun
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/bin/mpirun.mpich
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/bin/mpirun.mpich2
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/ia32/bin/mpirun
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/ia32/bin/mpirun.mpich
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/ia32/bin/mpirun.mpich2
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/ia32/lib/linux_amd64/libmpirun.so
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/ia32/lib/linux_ia32/libmpirun.so
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/lib/linux_amd64/libmpirun.so
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/lib/linux_ia32/libmpirun.so
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.2.0.0/linux64_2.6-x86-glibc_2.3.4/share/man/man1/mpirun.1.gz
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/bin/mpirun
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/bin/mpirun.mpich
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/bin/mpirun.mpich2
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/ia32/bin/mpirun
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/ia32/bin/mpirun.mpich
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/ia32/bin/mpirun.mpich2
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/ia32/lib/linux_amd64/libmpirun.so
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/ia32/lib/linux_ia32/libmpirun.so
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/lib/linux_amd64/libmpirun.so
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/lib/linux_ia32/libmpirun.so
</span><br>
...
<span class="quotelev1">&gt; /home/djordje/StarCCM/Install/STAR-CCM+8.06.007/mpi/platform/8.3.0.2/linux64_2.6-x86-glibc_2.3.4/share/man/man1/mpirun.1.gz
</span><br>
...
<span class="quotelev1">&gt; /usr/lib/openmpi/include/openmpi/ompi/runtime/mpiruntime.h
</span><br>
<span class="quotelev1">&gt; /usr/share/man/man1/mpirun.1.gz
</span><br>
<span class="quotelev1">&gt; /usr/share/man/man1/mpirun.openmpi.1.gz
</span><br>
<span class="quotelev1">&gt; /var/lib/dpkg/alternatives/mpirun
</span><br>
<span class="quotelev1">&gt; -----------------------------------------
</span><br>
<span class="quotelev1">&gt; This is a single machine. I actually just got it... another user used it
</span><br>
...
<span class="quotelev1">&gt; On Mon, Apr 14, 2014 at 7:06 PM, Gus Correa &lt;gus_at_[hidden]
</span><br>
...
<span class="quotelev1">&gt;         On Apr 14, 2014, at 5:04 PM, &quot;Elken, Tom&quot; &lt;tom.elken_at_[hidden]
</span><br>
<span class="quotelev1">&gt;         &lt;mailto:tom.elken_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;             That&#146;s OK.  Many of us make that mistake, though often as a
</span><br>
<span class="quotelev1">&gt;             typo.
</span><br>
<span class="quotelev1">&gt;             One thing that helps is that the correct spelling of Open
</span><br>
...
<span class="quotelev1">&gt;             What makes it more confusing is that more and more apps.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;             From: users [mailto:users-bounces_at_open-__mpi.org
</span><br>
...
<span class="quotelev1">&gt;             Subject: Re: [OMPI users] mpirun runs in serial even I set
</span><br>
<span class="quotelev1">&gt;             np to several processors
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;             OK guys... Thanks for all this info. Frankly, I didn't know
</span><br>
<span class="quotelev1">&gt;             these diferences between OpenMP and OpenMPI. The commands:
</span><br>
...
<span class="quotelev1">&gt;             provides a test program to test MPI. I ran the program and
</span><br>
...
<span class="quotelev1">&gt;             It uses mpif90 and mpicc for compiling. Below is the output
</span><br>
...
<span class="quotelev1">&gt;             /lib/x86_64-linux-gnu/__libpthread.so.0 (0x00007f4d160ab000)
</span><br>
<span class="quotelev1">&gt;                   libgfortran.so.3 =&gt;
</span><br>
<span class="quotelev1">&gt;             /usr/lib/x86_64-linux-gnu/__libgfortran.so.3
</span><br>
<span class="quotelev1">&gt;             (0x00007f4d15d94000)
</span><br>
<span class="quotelev1">&gt;                   libm.so.6 =&gt; /lib/x86_64-linux-gnu/libm.so.__6
</span><br>
<span class="quotelev1">&gt;             (0x00007f4d15a97000)
</span><br>
<span class="quotelev1">&gt;                   libgcc_s.so.1 =&gt; /lib/x86_64-linux-gnu/libgcc___s.so.1
</span><br>
<span class="quotelev1">&gt;             (0x00007f4d15881000)
</span><br>
<span class="quotelev1">&gt;                   libc.so.6 =&gt; /lib/x86_64-linux-gnu/libc.so.__6
</span><br>
...
<span class="quotelev1">&gt;             /usr/lib/x86_64-linux-gnu/__libquadmath.so.0
</span><br>
...
<span class="quotelev1">&gt;             Your WRF configure file seems to use mpif90 and mpicc (line
</span><br>
...
<span class="quotelev1">&gt;             Whether it is THIS MPI (OpenMPI) or another MPI (say MPICH,
</span><br>
...
<span class="quotelev1">&gt;             Which input do you provide to the command that generates the
</span><br>
...
<span class="quotelev1">&gt;             &lt;mailto:djordje8_at_[hidden] &lt;mailto:djordje8_at_[hidden]&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;                       If you didn't use Open MPI, then this is the wrong
</span><br>
...
<span class="quotelev2">&gt;                        &gt; On Mon, Apr 14, 2014 at 2:37 PM, Jeff Squyres
</span><br>
...
<span class="quotelev1">&gt;                       one MPI implementation (e.g., Open MPI), but then
</span><br>
<span class="quotelev1">&gt;             mistakenly use
</span><br>
<span class="quotelev1">&gt;                       the &quot;mpirun&quot; (or &quot;mpiexec&quot;) from a different MPI
</span><br>
...
<span class="quotelev3">&gt;                        &gt; &gt; I compiled it with: x86_64 Linux, gfortran
</span><br>
...
<span class="quotelev3">&gt;                        &gt; &gt; Attached is the self-generated configuration
</span><br>
<span class="quotelev1">&gt;             file. The
</span><br>
<span class="quotelev1">&gt;                       architecture specification settings start at line
</span><br>
...
<span class="quotelev3">&gt;                        &gt; &gt; On Mon, Apr 14, 2014 at 1:23 PM, Dave Goodell
</span><br>
<span class="quotelev1">&gt;             (dgoodell)
</span><br>
<span class="quotelev1">&gt;                       &lt;dgoodell_at_[hidden] &lt;mailto:dgoodell_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt;             &lt;mailto:dgoodell_at_[hidden] &lt;mailto:dgoodell_at_[hidden]&gt;&gt;&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt;                       implementation than you are using to run it (e.g.,
</span><br>
...
<span class="quotelev1">&gt;             &lt;configure.wrf&gt;___________________________________________________
</span><br>
<span class="quotelev3">&gt;                        &gt; &gt; users mailing list
</span><br>
<span class="quotelev3">&gt;                        &gt; &gt; users_at_[hidden]
