...
?>
<!-- received="Fri Apr  4 10:21:18 2014" -->
<!-- isoreceived="20140404142118" -->
<!-- sent="Fri, 4 Apr 2014 07:21:07 -0700" -->
<!-- isosent="20140404142107" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openmpi query" -->
<!-- id="B2E8CD18-E625-4A52-B4E3-D8A8E28E4D9F_at_open-mpi.org" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAL8-kUDWEmgiyL_aZZ0nWYDWGVnMNorX0hsT4nAAeFZYN3S-sA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-04-04 10:21:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24053.php">Nisha Dhankher -M.Tech(CSE): "Re: [OMPI users] openmpi query"</a>
<li><strong>Previous message:</strong> <a href="24051.php">Nisha Dhankher -M.Tech(CSE): "Re: [OMPI users] openmpi query"</a>
<li><strong>In reply to:</strong> <a href="24051.php">Nisha Dhankher -M.Tech(CSE): "Re: [OMPI users] openmpi query"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24053.php">Nisha Dhankher -M.Tech(CSE): "Re: [OMPI users] openmpi query"</a>
<li><strong>Reply:</strong> <a href="24053.php">Nisha Dhankher -M.Tech(CSE): "Re: [OMPI users] openmpi query"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Nisha
<br>
<p>I'm sorry if my questions appear abrasive - I'm just a little frustrated at the communication bottleneck as I can't seem to get a clear picture of your situation. So you really don't need to keep calling me &quot;sir&quot; :-)
<br>
<p>The error you are hitting is very unusual - it means that the processes are able to make a connection, but are failing to correctly complete a simple handshake exchange of their process identifications. There are only a few ways that can happen, and I'm trying to get you to test for them.
<br>
<p>So let's try and see if we can narrow this down. You mention that it works on some machines, but not all. Is this consistent - i.e., is it always the same machines that work, and the same ones that generate the error? If you exclude the ones that show the error, does it work? If so, what is different about those nodes? Are they a different architecture?
<br>
<p><p>On Apr 3, 2014, at 11:09 PM, Nisha Dhankher -M.Tech(CSE) &lt;nishadhankher-coaeseeit_at_[hidden]&gt; wrote:
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-24052/attachment">attachment</a>
</ul>
