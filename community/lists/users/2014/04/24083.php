...
?>
<!-- received="Mon Apr  7 15:52:53 2014" -->
<!-- isoreceived="20140407195253" -->
<!-- sent="Mon, 7 Apr 2014 19:52:51 +0000" -->
<!-- isosent="20140407195251" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem for multiple clusters using mpirun" -->
<!-- id="C47C42C9-35B7-42C5-A435-3A2729F07ABF_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAADBNWx1-q-XsDhNzcZTy+KaPc9fbptcV2pDfsgnYgMqyXjXQg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-04-07 15:52:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="24084.php">Hamid Saeed: "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<li><strong>Previous message:</strong> <a href="24082.php">Kamal Selvam: "Re: [OMPI users] Open Mpi execution error"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2014/03/24021.php">Hamid Saeed: "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="24084.php">Hamid Saeed: "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<li><strong>Reply:</strong> <a href="24084.php">Hamid Saeed: "Re: [OMPI users] problem for multiple clusters using mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I was out on vacation / fully disconnected last week, and am just getting to all the backlog now...
<br>
<p>Are you saying that port 1024 was locked as well -- i.e., that we should set the minimum to 1025?
<br>
<p><p>On Mar 31, 2014, at 4:32 AM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Yes Jeff,
</span><br>
<span class="quotelev1">&gt; You were right. The default value for btl_tcp_port_min_v4 is 1024.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; I was facing problem in running my Algorithm on multiple processors (using ssh).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Answer:
</span><br>
<span class="quotelev1">&gt; The network administrator locked that port.
</span><br>
<span class="quotelev1">&gt; :(
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; i changed the communication port by forcing mpi to use another.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Thanks again for the nice and effective suggestions.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Tue, Mar 25, 2014 at 1:27 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; This is very odd -- the default value for btl_tcp_port_min_v4 is 1024.  So unless you have overridden this value, you should not be getting a port less than 1024.  You can run this to see:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; mca:btl:tcp:param:btl_tcp_port_min_v4:help:The minimum port where the TCP BTL will try to bind (default 1024)
</span><br>
...
<span class="quotelev2">&gt; &gt; On Tue, Mar 25, 2014 at 10:23 AM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt; Hello,
</span><br>
...
<span class="quotelev2">&gt; &gt; On Tue, Mar 25, 2014 at 9:15 AM, Reuti &lt;reuti_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; MPI tries to use one of the reserve ports and prompts the connection refused error.
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; There are certain parameters to set the range of used ports, but using any up to 1024 should not be the default:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; <a href="http://www.open-mpi.org/community/lists/users/2011/11/17732.php">http://www.open-mpi.org/community/lists/users/2011/11/17732.php</a>
...
<span class="quotelev3">&gt; &gt; &gt; On Mon, Mar 24, 2014 at 5:32 PM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; The problem was from the network administrator. The machines on the network side were halting the mpi...
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; On Mon, Mar 24, 2014 at 4:34 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt; &gt; There is no &quot;self&quot; IP interface in the Linux kernel.
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Try using btl_tcp_if_include and list just the interface(s) that you want to use.  From your prior email, I'm *guessing* it's just br2 (i.e., the 10.x address inside your cluster).
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Also, it looks like you didn't setup your SSH keys properly for logging in to remote notes automatically.
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
...
<span class="quotelev3">&gt; &gt; &gt; On Mar 24, 2014, at 10:56 AM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt; &gt; &gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; hsaeed_at_karp:~/Task4_mpi/scatterv$ mpirun -np 8 --mca btl ^openib --mca btl_tcp_if_exclude sm,self,lo,br0,br1,ib0,br2 --host karp,wirth ./scatterv
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; node wirth exiting improperly. There are two reasons this could occur:
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; [karp:29513] 1 more process has sent help message help-mca-bml-r2.txt / unreachable proc
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; [karp:29513] Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to see all help / error messages
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; [karp:29513] 1 more process has sent help message help-mpi-runtime / mpi_init:startup:pml-add-procs-fail
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; [karp:29513] 1 more process has sent help message help-mpi-errors.txt / mpi_errors_are_fatal unknown handle
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; [karp:29513] 1 more process has sent help message help-mpi-runtime.txt / ompi mpi abort:cannot guarantee all killed
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; On Mon, Mar 24, 2014 at 3:25 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; If you you use btl_tcp_if_exclude, you also need to exclude the loopback interface.  Loopback is excluded by the default value of btl_tcp_if_exclude, but if you overwrite that value, then you need to *also* include the loopback interface in the new value.
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
...
<span class="quotelev4">&gt; &gt; &gt; &gt; On Mar 24, 2014, at 4:57 AM, Hamid Saeed &lt;e.hamidsaeed_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt;
</span><br>
