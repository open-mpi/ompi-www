...
!                                 function to integrate
 ...
 do 
    print *, 'Process ', myid, " before read"
    if ( myid .eq. 0 ) then
       write(*,98)
 98    format('Enter the number of intervals: (0 quits)')
       read(*,99) n
 99    format(i10)
       print *, 'Process ', myid, " read:  n =", n
    endif

    print *, 'Process ', myid, " before MPI_BCAST"
    call MPI_BCAST(n,1,MPI_INTEGER,0,MPI_COMM_WORLD,ierr)
    print *, 'Process ', myid, " after  MPI_BCAST"
...
!                                 node 0 prints the answer.
 ...
 print *, 'Process ', myid, " Normal exit"
 stop
end
