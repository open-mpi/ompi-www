...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0272.php">Jeff Squyres: "Re: [O-MPI users] can't get openmpi to run across two multi-NIC machines"</a>
<li><strong>Previous message:</strong> <a href="0270.php">Jeff Squyres: "Re: [O-MPI users] Tests and Bugs (RC4):"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0272.php">Jeff Squyres: "Re: [O-MPI users] can't get openmpi to run across two multi-NIC machines"</a>
<li><strong>Reply:</strong> <a href="0272.php">Jeff Squyres: "Re: [O-MPI users] can't get openmpi to run across two multi-NIC machines"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
