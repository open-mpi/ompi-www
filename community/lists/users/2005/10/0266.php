...
<!-- received="Mon Oct 31 17:41:21 2005" -->
<!-- isoreceived="20051031224121" -->
<!-- sent="Mon, 31 Oct 2005 14:38:32 -0800" -->
<!-- isosent="20051031223832" -->
<!-- name="Mike Houston" -->
<!-- email="mhouston_at_[hidden]" -->
<!-- subject="Re: [O-MPI users] Infiniband performance problems (mvapi)" -->
<!-- id="43669CE8.7060705_at_graphics.stanford.edu" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2005-10-31 17:38:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0267.php">Jeff Squyres: "Re: [O-MPI users] Tests and Bugs (RC4):"</a>
<li><strong>Previous message:</strong> <a href="0265.php">Mike Houston: "Re: [O-MPI users] Infiniband performance problems (mvapi)"</a>
...
<br>
<p>mpirun -np 2 -mca mpi_leave_pinned 1 -mca btl_mvapi_flags 2 -hostfile 
<br>
...
<br>
<p>The backtrace is bogus, else I'd drop it in.
<br>
<p>Setting the number of messages &lt;=10 always seems to work.
<br>
<p>-Mike
<br>
