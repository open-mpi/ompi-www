...
<!-- received="Mon Oct 31 17:37:06 2005" -->
<!-- isoreceived="20051031223706" -->
<!-- sent="Mon, 31 Oct 2005 14:34:16 -0800" -->
<!-- isosent="20051031223416" -->
<!-- name="Mike Houston" -->
<!-- email="mhouston_at_[hidden]" -->
<!-- subject="Re: [O-MPI users] Infiniband performance problems (mvapi)" -->
<!-- id="43669BE8.6050901_at_graphics.stanford.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="436699D3.4080800_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2005-10-31 17:34:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0266.php">Mike Houston: "Re: [O-MPI users] Infiniband performance problems (mvapi)"</a>
<li><strong>Previous message:</strong> <a href="0264.php">Tim S. Woodall: "Re: [O-MPI users] Infiniband performance problems (mvapi)"</a>
<li><strong>In reply to:</strong> <a href="0264.php">Tim S. Woodall: "Re: [O-MPI users] Infiniband performance problems (mvapi)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0266.php">Mike Houston: "Re: [O-MPI users] Infiniband performance problems (mvapi)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>mpirun -np 2 -mca mpi_leave_pinned 1 -mca btl_mvapi_flags 2 
<br>
...
<p>mpirun -np 2 -mca mpi_leave_pinned 1 -mca btl_mvapi_flags 2 
<br>
mpi_bandwidth 10000 131072
<br>
131072  115.873284 (MillionBytes/sec)   110.505375(MegaBytes/sec)
<br>
<p>Sorry to be such a pain...  We need the speed of MVAPICH with the 
<br>
threading support of OpenMPI...
<br>
<p>-Mike
<br>
<p><p>Tim S. Woodall wrote:
<br>
<p><span class="quotelev1">&gt;Mike,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;There appears to be an issue in our mvapi get protocol. To temporarily
</span><br>
<span class="quotelev1">&gt;disable this:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;/u/twoodall&gt; orterun -np 2 -mca mpi_leave_pinned 1 -mca btl_mvapi_flags 2 ./bw 25 131072
</span><br>
<span class="quotelev1">&gt;131072  801.580272 (MillionBytes/sec)   764.446518(MegaBytes/sec)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt;between nodes.  Actually using the network with the pinned option gives:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;[0,1,0][btl_mvapi_component.c:631:mca_btl_mvapi_component_progress] 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;[0,1,1][btl_mvapi_component.c:631:mca_btl_mvapi_component_progress] Got 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;error : VAPI_WR_FLUSH_ERR, Vendor code : 0 Frag : 0xb74a1c18Got error : 
</span><br>
