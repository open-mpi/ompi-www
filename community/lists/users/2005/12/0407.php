<?
$subject_val = "[O-MPI users] Compiler problems on SGI Origin";
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0408.php">Brian Barrett: "Re: [O-MPI users] Compiler problems on SGI Origin"</a>
<li><strong>Previous message:</strong> <a href="0406.php">Eugen Wintersberger: "Re: [O-MPI users] Compiling RC4 on Alpha56 and SGI Origin"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0408.php">Brian Barrett: "Re: [O-MPI users] Compiler problems on SGI Origin"</a>
<li><strong>Reply:</strong> <a href="0408.php">Brian Barrett: "Re: [O-MPI users] Compiler problems on SGI Origin"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
