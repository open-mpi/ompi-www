...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0410.php">Eugen Wintersberger: "[O-MPI users] Compiler problems on SGI Origin"</a>
<li><strong>Previous message:</strong> <a href="0408.php">Dries Kimpe: "Re: [O-MPI users] pathscale 2.1/2.3 build problem"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2005/10/0242.php">Brian Barrett: "Re: [O-MPI users] Compiling RC4 on Alpha56 and SGI Origin"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
