...
?>
<!-- received="Mon Aug 16 12:21:24 2010" -->
<!-- isoreceived="20100816162124" -->
<!-- sent="Mon, 16 Aug 2010 09:22:45 -0700" -->
<!-- isosent="20100816162245" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [openib] segfault when using openib btl" -->
<!-- id="C7D1494E-0919-478A-90D0-8F84B3C51838_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2010-08-16 12:22:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14040.php">David Ronis: "Re: [OMPI users] Abort"</a>
<li><strong>Previous message:</strong> <a href="14038.php">Jeff Squyres: "Re: [OMPI users] MPI_Allreduce on local machine"</a>
<li><strong>In reply to:</strong> <a href="13958.php">Eloi Gaudry: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14043.php">Eloi Gaudry: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<li><strong>Reply:</strong> <a href="14043.php">Eloi Gaudry: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Odd; the values of the callback function pointer should never be 0.  This seems to suggest some kind of memory corruption is occurring.
<br>
<p>I don't know if it's possible, because the stack trace looks like you're calling through python, but can you run this application through valgrind, or some other memory-checking debugger?
<br>
<p><p>On Aug 10, 2010, at 7:15 AM, Eloi Gaudry wrote:
<br>
...
<span class="quotelev1">&gt; $2 = {btl_component = 0x2b341edd7380, btl_eager_limit = 12288, btl_rndv_eager_limit = 12288, btl_max_send_size = 65536, btl_rdma_pipeline_send_length = 1048576,
</span><br>
<span class="quotelev1">&gt;   btl_rdma_pipeline_frag_size = 1048576, btl_min_rdma_pipeline_size = 1060864, btl_exclusivity = 1024, btl_latency = 10, btl_bandwidth = 800, btl_flags = 310,
</span><br>
<span class="quotelev1">&gt;   btl_add_procs = 0x2b341eb8ee47 &lt;mca_btl_openib_add_procs&gt;, btl_del_procs = 0x2b341eb90156 &lt;mca_btl_openib_del_procs&gt;, btl_register = 0, btl_finalize = 0x2b341eb93186 &lt;mca_btl_openib_finalize&gt;,
</span><br>
<span class="quotelev1">&gt;   btl_alloc = 0x2b341eb90a3e &lt;mca_btl_openib_alloc&gt;, btl_free = 0x2b341eb91400 &lt;mca_btl_openib_free&gt;, btl_prepare_src = 0x2b341eb91813 &lt;mca_btl_openib_prepare_src&gt;,
</span><br>
<span class="quotelev1">&gt;   btl_prepare_dst = 0x2b341eb91f2e &lt;mca_btl_openib_prepare_dst&gt;, btl_send = 0x2b341eb94517 &lt;mca_btl_openib_send&gt;, btl_sendi = 0x2b341eb9340d &lt;mca_btl_openib_sendi&gt;,
</span><br>
<span class="quotelev1">&gt;   btl_put = 0x2b341eb94660 &lt;mca_btl_openib_put&gt;, btl_get = 0x2b341eb94c4e &lt;mca_btl_openib_get&gt;, btl_dump = 0x2b341acd45cb &lt;mca_btl_base_dump&gt;, btl_mpool = 0xf3f4110,
</span><br>
<span class="quotelev1">&gt;   btl_register_error = 0x2b341eb90565 &lt;mca_btl_openib_register_error_cb&gt;, btl_ft_event = 0x2b341eb952e7 &lt;mca_btl_openib_ft_event&gt;}
</span><br>
...
<span class="quotelev2">&gt; &gt; m=0x2aedb888cd20) at ../opal/threads/condition.h:99 #8  0x00002aedb859fa31
</span><br>
...
<span class="quotelev2">&gt; &gt; #14 0x00000000040cb858 in FEMTown::Field::detail::align_itfs_and_neighbhors
</span><br>
...
<span class="quotelev2">&gt; &gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab7550120, globals=&lt;value
</span><br>
...
<span class="quotelev2">&gt; &gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab8b5e738, globals=&lt;value
</span><br>
...
<span class="quotelev2">&gt; &gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab3eb4198, globals=&lt;value
</span><br>
...
<span class="quotelev2">&gt; &gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab3eb4288, globals=&lt;value
</span><br>
...
<span class="quotelev2">&gt; &gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab8b6a738, globals=&lt;value
</span><br>
...
<span class="quotelev2">&gt; &gt; &amp;openib_btl-&gt;super, hdr-&gt;tag, des, reg-&gt;cbdata ); Current language:  auto;
</span><br>
...
<span class="quotelev2">&gt; &gt; 2881            reg-&gt;cbfunc( &amp;openib_btl-&gt;super, hdr-&gt;tag, des, reg-&gt;cbdata
</span><br>
...
<span class="quotelev1">&gt; &gt; &gt; &gt; &gt; segmentation fault i'm observing always happened during a collective
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt;&gt; and see whether this makes a difference. I used to observe sometimes
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt;&gt;&gt;&gt;&gt;&gt; I've found that &quot;--mca coll_tuned_bcast_algorithm 1&quot; allowed to
</span><br>
...
<span class="quotelev2">&gt; &gt; &gt; &gt; &gt;&gt;&gt;&gt;&gt;&gt; Does anyone could give some advice on ways to diagnose the issue
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The outputs of ompi_info and the configure scripts of OpenMPI
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; --mca mpi_warn_on_fork 0 --mca btl_openib_want_fork_support 0
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [...]
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
