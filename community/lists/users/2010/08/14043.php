...
?>
<!-- received="Mon Aug 16 13:05:13 2010" -->
<!-- isoreceived="20100816170513" -->
<!-- sent="Mon, 16 Aug 2010 19:05:03 +0200" -->
<!-- isosent="20100816170503" -->
<!-- name="Eloi Gaudry" -->
<!-- email="eg_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [openib] segfault when using openib btl" -->
<!-- id="4C696FBF.8090104_at_fft.be" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="C7D1494E-0919-478A-90D0-8F84B3C51838_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-08-16 13:05:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14044.php">Jeff Squyres: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<li><strong>Previous message:</strong> <a href="14042.php">Jeff Squyres: "Re: [OMPI users] Abort"</a>
<li><strong>In reply to:</strong> <a href="14039.php">Jeff Squyres: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14044.php">Jeff Squyres: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<li><strong>Reply:</strong> <a href="14044.php">Jeff Squyres: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I did run our application through valgrind but it couldn't find any 
<br>
...
<br>
<p>Another question, you said that the callback function pointer should 
<br>
...
Eloi
<br>
<p><p><p>On 16/08/2010 18:22, Jeff Squyres wrote:
<br>
<span class="quotelev1">&gt; Sorry for the delay in replying.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Odd; the values of the callback function pointer should never be 0.  This seems to suggest some kind of memory corruption is occurring.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I don't know if it's possible, because the stack trace looks like you're calling through python, but can you run this application through valgrind, or some other memory-checking debugger?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev2">&gt;&gt; $2 = {btl_component = 0x2b341edd7380, btl_eager_limit = 12288, btl_rndv_eager_limit = 12288, btl_max_send_size = 65536, btl_rdma_pipeline_send_length = 1048576,
</span><br>
<span class="quotelev2">&gt;&gt;    btl_rdma_pipeline_frag_size = 1048576, btl_min_rdma_pipeline_size = 1060864, btl_exclusivity = 1024, btl_latency = 10, btl_bandwidth = 800, btl_flags = 310,
</span><br>
<span class="quotelev2">&gt;&gt;    btl_add_procs = 0x2b341eb8ee47&lt;mca_btl_openib_add_procs&gt;, btl_del_procs = 0x2b341eb90156&lt;mca_btl_openib_del_procs&gt;, btl_register = 0, btl_finalize = 0x2b341eb93186&lt;mca_btl_openib_finalize&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;    btl_alloc = 0x2b341eb90a3e&lt;mca_btl_openib_alloc&gt;, btl_free = 0x2b341eb91400&lt;mca_btl_openib_free&gt;, btl_prepare_src = 0x2b341eb91813&lt;mca_btl_openib_prepare_src&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;    btl_prepare_dst = 0x2b341eb91f2e&lt;mca_btl_openib_prepare_dst&gt;, btl_send = 0x2b341eb94517&lt;mca_btl_openib_send&gt;, btl_sendi = 0x2b341eb9340d&lt;mca_btl_openib_sendi&gt;,
</span><br>
<span class="quotelev2">&gt;&gt;    btl_put = 0x2b341eb94660&lt;mca_btl_openib_put&gt;, btl_get = 0x2b341eb94c4e&lt;mca_btl_openib_get&gt;, btl_dump = 0x2b341acd45cb&lt;mca_btl_base_dump&gt;, btl_mpool = 0xf3f4110,
</span><br>
<span class="quotelev2">&gt;&gt;    btl_register_error = 0x2b341eb90565&lt;mca_btl_openib_register_error_cb&gt;, btl_ft_event = 0x2b341eb952e7&lt;mca_btl_openib_ft_event&gt;}
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 0x00002aedb8b22ab8 in opal_progress () at runtime/opal_progress.c:207 #7
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 0x00002aedb859f497 in opal_condition_wait (c=0x2aedb888ccc0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; m=0x2aedb888cd20) at ../opal/threads/condition.h:99 #8  0x00002aedb859fa31
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; FEMTown::MPI::Allreduce (sendbuf=0x7ffff279d444, recvbuf=0x7ffff279d440,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; count=1, datatype=0x6788220, op=0x6787a20, comm=0x19d81ff0) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; stubs.cpp:626 #13 0x0000000004058be8 in FEMTown::Domain::align (itf=
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; #14 0x00000000040cb858 in FEMTown::Field::detail::align_itfs_and_neighbhors
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 0x00000000044093a0 in PyEval_EvalFrameEx (f=0x19b52e90, throwflag=&lt;value
</span><br>
<span class="quotelev3">&gt;&gt;&gt; optimized out&gt;) at Python/ceval.c:3921 #20 0x000000000440aae9 in
</span><br>
<span class="quotelev3">&gt;&gt;&gt; PyEval_EvalCodeEx (co=0x2aaab754ad50, globals=&lt;value optimized out&gt;,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; locals=&lt;value optimized out&gt;, args=0x3, argcount=1, kws=0x19ace4a0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; kwcount=2, defs=0x2aaab75e4800, defcount=2, closure=0x0) at
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab7550120, globals=&lt;value
</span><br>
<span class="quotelev3">&gt;&gt;&gt; optimized out&gt;, locals=&lt;value optimized out&gt;, args=0x7, argcount=1,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; kws=0x19acc418, kwcount=3, defs=0x2aaab759e958, defcount=6, closure=0x0)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; at Python/ceval.c:2968
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab8b5e738, globals=&lt;value
</span><br>
<span class="quotelev3">&gt;&gt;&gt; optimized out&gt;, locals=&lt;value optimized out&gt;, args=0x6, argcount=1,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; kws=0x19abd328, kwcount=5, defs=0x2aaab891b7e8, defcount=3, closure=0x0)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; at Python/ceval.c:2968
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab3eb4198, globals=&lt;value
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab3eb4288, globals=&lt;value
</span><br>
<span class="quotelev3">&gt;&gt;&gt; optimized out&gt;, locals=&lt;value optimized out&gt;, args=0x1, argcount=0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; kws=0x19a89330, kwcount=0, defs=0x2aaab8b66668, defcount=1, closure=0x0)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; at Python/ceval.c:2968
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 0x000000000440aae9 in PyEval_EvalCodeEx (co=0x2aaab8b6a738, globals=&lt;value
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Python/pythonrun.c:1335 #33 0x0000000004429690 in PyRun_SimpleStringFlags
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (command=0x192fd3d8 &quot;DIRECT.Actran.main()&quot;, flags=0x0) at
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; &amp;openib_btl-&gt;super, hdr-&gt;tag, des, reg-&gt;cbdata ); Current language:  auto;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; 2881            reg-&gt;cbfunc(&amp;openib_btl-&gt;super, hdr-&gt;tag, des, reg-&gt;cbdata
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm running out of idea here. I wish I could use the &quot;--mca coll tuned&quot;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; with &quot;--mca self,sm,tcp&quot; so that I could check that the issue is not
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; somehow limited to the tuned collective routines.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; segmentation fault i'm observing always happened during a collective
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; and see whether this makes a difference. I used to observe sometimes
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; installed but no NCA was found on a node. It used to work however
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; with the basic component.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; replace MPI_Bcast with a naive implementation (using MPI_Send and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; MPI_Recv) and see if that helps.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; I'll check if I the segmentation fault disappears when using the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; basic bcast linear algorithm using the proper command line you
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; One way to make sure you are typing this in correctly is to use
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; it with ompi_info.  Do the following:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ompi_info -mca coll_tuned_use_dynamic_rules 1 --param coll
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; You should see lots of output with all the different algorithms
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; that can be selected for the various collectives.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Does anyone could give some advice on ways to diagnose the issue
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; segfault when using the openib btl. I'd like to know if there
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; is any way to make OpenMPI switch to a different algorithm
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; than the default one being selected for MPI_Bcast.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; - understand why this issue is observed only when using the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; openib btl and not when using self,sm,tcp
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; The outputs of ompi_info and the configure scripts of OpenMPI
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; --mca mpi_warn_on_fork 0 --mca btl_openib_want_fork_support 0
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [...]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
