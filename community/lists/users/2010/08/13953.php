...
?>
<!-- received="Mon Aug  9 22:43:19 2010" -->
<!-- isoreceived="20100810024319" -->
<!-- sent="Mon, 9 Aug 2010 19:43:14 -0700 (PDT)" -->
<!-- isosent="20100810024314" -->
<!-- name="Randolph Pullen" -->
<!-- email="randolph_pullen_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_Bcast issue" -->
<!-- id="650925.39617.qm_at_web50801.mail.re2.yahoo.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="E1FB7CA1-5D0B-4DBC-9490-B4A6454BB46B_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-08-09 22:43:14
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13954.php">Reuti: "[OMPI users] SGE integration when getting slots from different queues on one and the same host mismatch"</a>
<li><strong>Previous message:</strong> <a href="13952.php">John Hsu: "Re: [OMPI users] deadlock in openmpi 1.5rc5"</a>
<li><strong>In reply to:</strong> <a href="13941.php">Ralph Castain: "Re: [OMPI users] MPI_Bcast issue"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13962.php">Jeff Squyres: "Re: [OMPI users] MPI_Bcast issue"</a>
<li><strong>Reply:</strong> <a href="13962.php">Jeff Squyres: "Re: [OMPI users] MPI_Bcast issue"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
The install was completly vanilla - no extras a plain .configure command line (on FC10 x8x_64 linux)
<br>
<p>Are you saying that all broadcast calls are actually implemented as serial point to point calls?
<br>
<p><p>--- On Tue, 10/8/10, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
...
<br>
<p>No idea what is going on here. No MPI call is implemented as a multicast - it all flows over the MPI pt-2-pt system via one of the various algorithms.
<br>
Best guess I can offer is that there is a race condition in your program that you are tripping when other procs that share the node change the timing.
<br>
How did you configure OMPI when you built it?
<br>
<p>On Aug 8, 2010, at 11:02 PM, Randolph Pullen wrote:
<br>
...
<br>
I
 know I'm scraping the edges here looking for something but I just cant get my head around why it should fail where it has.
<br>
...
<br>
Thanks,&#194;&#160; although &#226;&#128;&#156;An intercommunicator cannot be
 used for collective communication.&#226;&#128;&#157; i.e ,&#194;&#160; bcast calls., I can see how the MPI_Group_xx calls can be used to produce a useful group and then communicator;&#194;&#160; - thanks again but this is really the side issue to my main question about MPI_Bcast.
<br>
...
<span class="quotelev2">&gt;&gt; I seem to be having a problem with
 MPI_Bcast.
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13953/attachment">attachment</a>
</ul>
