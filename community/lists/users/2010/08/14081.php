...
?>
<!-- received="Thu Aug 19 14:33:04 2010" -->
<!-- isoreceived="20100819183304" -->
<!-- sent="Thu, 19 Aug 2010 12:32:58 -0600" -->
<!-- isosent="20100819183258" -->
<!-- name="Ralph Castain" -->
...
<!-- id="AANLkTi=UiSOcUuJ_HH9AXzob1+mO9CGD1wvEPw92m+w0_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="AANLkTi=9pZMgriRh+-MO6W_JV_CRdU3yq=SS3y7jypBd_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-08-19 14:32:58
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14082.php">Rahul Nabar: "[OMPI users] IMB-MPI broadcast test stalls for large core counts: debug ideas?"</a>
<li><strong>Previous message:</strong> <a href="14080.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>In reply to:</strong> <a href="14080.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14086.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>Reply:</strong> <a href="14086.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
should one exist.
<br>
<p>The problem is clearly that get_node_rank is returning the wrong value for
<br>
...
<br>
<p><p><p>On Thu, Aug 19, 2010 at 12:12 PM, Philippe &lt;philmpi_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev2">&gt; &gt; should open port 10000. The next lowest rank on the node will open 10001,
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt; Dev trunk looks okay right now - I think you'll be fine using it.
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt; Anything at r23478 or above will have the new module. Let me know
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-14081/attachment">attachment</a>
</ul>
