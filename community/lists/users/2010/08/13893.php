...
?>
<!-- received="Mon Aug  2 11:45:47 2010" -->
<!-- isoreceived="20100802154547" -->
<!-- sent="Mon, 02 Aug 2010 11:45:47 -0400" -->
<!-- isosent="20100802154547" -->
<!-- name="Terry Dontje" -->
<!-- email="terry.dontje_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Accessing to the send buffer" -->
<!-- id="4C56E82B.6030500_at_oracle.com" -->
<!-- charset="ISO-8859-15" -->
...
<strong>Date:</strong> 2010-08-02 11:45:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13894.php">Richard Treumann: "Re: [OMPI users] Accessing to the send buffer"</a>
<li><strong>Previous message:</strong> <a href="13892.php">Alberto Canestrelli: "Re: [OMPI users] Accessing to the send buffer"</a>
<li><strong>In reply to:</strong> <a href="13892.php">Alberto Canestrelli: "Re: [OMPI users] Accessing to the send buffer"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13894.php">Richard Treumann: "Re: [OMPI users] Accessing to the send buffer"</a>
<li><strong>Reply:</strong> <a href="13894.php">Richard Treumann: "Re: [OMPI users] Accessing to the send buffer"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Anyone on the list care to disagree?
<br>
<p>--td
<br>
...
<span class="quotelev1">&gt; happen if I  am reading the data from the posted send? I do it plenty 
</span><br>
<span class="quotelev1">&gt; of times! possible consequences?Can you guarantee me that this 
</span><br>
<span class="quotelev1">&gt; approach is safe?
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt; I believe it is definitely a no-no to STORE (write) into a send 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; I have a discrete MPI knowledge. I was able to solve by myself 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; all the
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; errors I bumped into but now I am not able to find the bug of my 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; following aspect highlighted in the above ebook (in the follow I 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; (neither for loads nor for STORES) after a nonblocking send 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; a nonblocking receive operation is posted, until the 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; complete-receive
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13893/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/users/att-13893/02-part" alt="picture">
<!-- attachment="02-part" -->
<!-- body="end" -->
<hr>
<ul class="links">
