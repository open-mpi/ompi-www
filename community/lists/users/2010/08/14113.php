...
?>
<!-- received="Tue Aug 24 16:22:28 2010" -->
<!-- isoreceived="20100824202228" -->
<!-- sent="Tue, 24 Aug 2010 16:24:04 -0400" -->
<!-- isosent="20100824202404" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Open-MPI 1.4.2 : mpirun core-dumps when &amp;quot;-npernode N&amp;quot; is used at command line" -->
<!-- id="92386465-9FBA-4B13-A960-6D513758E7DD_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4C741C9F.2020902_at_gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-08-24 16:24:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14114.php">Michael E. Thomadakis: "Re: [OMPI users] Open-MPI 1.4.2 : mpirun core-dumps when &quot;-npernode N&quot; is used at command line"</a>
<li><strong>Previous message:</strong> <a href="14112.php">Michael E. Thomadakis: "Re: [OMPI users] Open-MPI 1.4.2 : mpirun core-dumps when &quot;-npernode N&quot; is used at command line"</a>
<li><strong>In reply to:</strong> <a href="14112.php">Michael E. Thomadakis: "Re: [OMPI users] Open-MPI 1.4.2 : mpirun core-dumps when &quot;-npernode N&quot; is used at command line"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14114.php">Michael E. Thomadakis: "Re: [OMPI users] Open-MPI 1.4.2 : mpirun core-dumps when &quot;-npernode N&quot; is used at command line"</a>
<li><strong>Reply:</strong> <a href="14114.php">Michael E. Thomadakis: "Re: [OMPI users] Open-MPI 1.4.2 : mpirun core-dumps when &quot;-npernode N&quot; is used at command line"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>./configure --prefix=/g/software/openmpi-1.4.3a1r23542/gcc-4.1.2 2 --enable-cxx-exceptions CFLAGS=-O2 CXXFLAGS=-O2 FFLAGS=-O2 FCFLAGS=-O2
<br>
<p>What's the lone &quot;2&quot; in the middle (after the prefix)?
<br>
<p>With that extra &quot;2&quot;, I'm not able to get configure to complete successfully (because it interprets that &quot;2&quot; as a platform name that does not exist).  If I remove that &quot;2&quot;, configure completes properly and the build completes properly.
<br>
<p>I'm afraid I no longer have any RH hosts to test on.  Can you do the following:
<br>
<p>cd top_of_build_dir
<br>
cd ompi/debuggers
<br>
...
make
<br>
<p>Then copy-n-paste the gcc command used to compile the ompi_debuggers.o file, remove &quot;-o .libs/libdebuggers_la-ompi_debuggers.o&quot;, and add &quot;-E&quot;, and redirect the output to a file.  Then send me that file -- it should give more of a clue as to exactly what the problem is that you're seeing.
<br>
<p><p><p><p>On Aug 24, 2010, at 3:25 PM, Michael E. Thomadakis wrote:
<br>
<p><span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On 08/24/10 14:22, Michael E. Thomadakis wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Hi,
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I used a 'tee' command to capture the output but I forgot to also redirect
</span><br>
<span class="quotelev2">&gt;&gt; stderr to the file.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; This is what a fresh make gave (gcc 4.1.2 again) :
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; ------------------------------------------------------------------
</span><br>
<span class="quotelev2">&gt;&gt; ompi_debuggers.c:81: error: missing terminating &quot; character
</span><br>
<span class="quotelev2">&gt;&gt; ompi_debuggers.c:81: error: expected expression before \u2018;\u2019 token
</span><br>
<span class="quotelev2">&gt;&gt; ompi_debuggers.c: In function \u2018ompi_wait_for_debugger\u2019:
</span><br>
<span class="quotelev2">&gt;&gt; ompi_debuggers.c:212: error: \u2018mpidbg_dll_locations\u2019 undeclared
</span><br>
<span class="quotelev2">&gt;&gt; (first use in this function)
</span><br>
<span class="quotelev2">&gt;&gt; ompi_debuggers.c:212: error: (Each undeclared identifier is reported only once
</span><br>
<span class="quotelev2">&gt;&gt; ompi_debuggers.c:212: error: for each function it appears in.)
</span><br>
<span class="quotelev2">&gt;&gt; ompi_debuggers.c:212: warning: passing argument 3 of \u2018check\u2019 from
</span><br>
<span class="quotelev2">&gt;&gt; incompatible pointer type
</span><br>
<span class="quotelev2">&gt;&gt; make[2]: *** [libdebuggers_la-ompi_debuggers.lo] Error 1
</span><br>
...
<span class="quotelev2">&gt;&gt; Is this critical to run OMPI code?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Thanks for the quick reply Ralph,
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Tue, 24 Aug 2010, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; | Date: Tue, 24 Aug 2010 13:16:10 -0600
</span><br>
<span class="quotelev2">&gt;&gt; | From: Ralph Castain&lt;rhc_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt;&gt; | To: Michael E.Thomadakis&lt;miket7777_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt;&gt; | Cc: Open MPI Users&lt;users_at_[hidden]&gt;, miket_at_[hidden]
</span><br>
<span class="quotelev2">&gt;&gt; | Subject: Re: [OMPI users] Open-MPI 1.4.2 : mpirun core-dumps when
</span><br>
<span class="quotelev2">&gt;&gt; |     &quot;-npernode N&quot; is used at command line
</span><br>
<span class="quotelev2">&gt;&gt; |
</span><br>
<span class="quotelev2">&gt;&gt; | Ummm....the configure log terminates normally, indicating it configured fine. The make log ends, but with no error shown - everything was building just fine.
</span><br>
<span class="quotelev2">&gt;&gt; |
</span><br>
<span class="quotelev2">&gt;&gt; | Did you maybe stop it before it was complete? Run out of disk quota? Or...?
</span><br>
<span class="quotelev2">&gt;&gt; |
</span><br>
<span class="quotelev2">&gt;&gt; |
</span><br>
<span class="quotelev2">&gt;&gt; | On Aug 24, 2010, at 1:06 PM, Michael E. Thomadakis wrote:
</span><br>
<span class="quotelev2">&gt;&gt; |
</span><br>
...
<span class="quotelev2">&gt;&gt; |&gt;  I tried to build 1.4.3.a1r23542 (08/02/2010) with
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;  ./configure --prefix=&quot;/g/software/openmpi-1.4.3a1r23542/gcc-4.1.2 2&quot; --enable-cxx-exceptions  CFLAGS=&quot;-O2&quot; CXXFLAGS=&quot;-O2&quot;  FFLAGS=&quot;-O2&quot; FCFLAGS=&quot;-O2&quot;
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;  with the GCC 4.1.2
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;  miket_at_login002[pts/26]openmpi-1.4.3a1r23542 $ gcc -v
</span><br>
...
<span class="quotelev2">&gt;&gt; |&gt;  gcc version 4.1.2 20080704 (Red Hat 4.1.2-46)
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;  but it failed. I am attaching the configure and make logs.
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; |&gt;  On 08/23/10 20:53, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; |&gt;&gt;&gt;  Would using '--cpus-per-proc N' in place of '-npernode N' or just '-bynode' do the trick?
</span><br>
<span class="quotelev2">&gt;&gt; |&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; |&gt;  &lt;config_1.4.3.log.gz&gt;&lt;make_1.4.3.out.gz&gt;
</span><br>
<span class="quotelev2">&gt;&gt; |
</span><br>
<span class="quotelev2">&gt;&gt; |
