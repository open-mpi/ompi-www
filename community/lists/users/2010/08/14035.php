...
?>
<!-- received="Mon Aug 16 04:30:52 2010" -->
<!-- isoreceived="20100816083052" -->
<!-- sent="Mon, 16 Aug 2010 10:32:19 +0200" -->
<!-- isosent="20100816083219" -->
<!-- name="Shiqing Fan" -->
<!-- email="fan_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How to program with openmpi under MFC?" -->
<!-- id="4C68F793.4070207_at_hlrs.de" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2010-08-16 04:32:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14036.php">Eugene Loh: "Re: [OMPI users] problem with .bashrc stetting of openmpi"</a>
<li><strong>Previous message:</strong> <a href="14034.php">Addepalli, Srirangam V: "Re: [OMPI users] problem with .bashrc stetting of openmpi"</a>
<li><strong>In reply to:</strong> <a href="13985.php">lyb: "Re: [OMPI users] How to program with openmpi under MFC?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/09/14157.php">lyb: "[OMPI users] MPI_Comm_accept and MPI_Comm_connect both use 100% one cpu core. Is it a bug?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I've checked your source code, and I didn't find anything wrong, 
<br>
...
mpi libs?
<br>
<p>By the way, I noticed that you put MPI_Init, MPI_Comm_rank, 
<br>
...
Shiqing
<br>
<p><p><p>On 2010-8-12 1:20 PM, lyb wrote:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-14035/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/users/att-14035/02-part" alt="picture">
<!-- attachment="02-part" -->
<!-- body="end" -->
<hr>
<ul class="links">
