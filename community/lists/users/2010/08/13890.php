...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13891.php">Terry Dontje: "Re: [OMPI users] Accessing to the send buffer"</a>
<li><strong>Previous message:</strong> <a href="13889.php">Terry Dontje: "Re: [OMPI users] Accessing to the send buffer"</a>
<li><strong>Maybe in reply to:</strong> <a href="13887.php">Alberto Canestrelli: "[OMPI users] Accessing to the send buffer"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13891.php">Terry Dontje: "Re: [OMPI users] Accessing to the send buffer"</a>
<li><strong>Reply:</strong> <a href="13891.php">Terry Dontje: "Re: [OMPI users] Accessing to the send buffer"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
