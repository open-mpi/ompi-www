<?
$subject_val = "[OMPI users] delivering SIGUSR2 to an ompi process";
...
<!-- subject="[OMPI users] delivering SIGUSR2 to an ompi process" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] delivering SIGUSR2 to an ompi process<br>
<strong>From:</strong> Steve Wise (<em>swise_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-08-25 12:23:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14123.php">Rahul Nabar: "Re: [OMPI users] IMB-MPI broadcast test stalls for large core counts: debug ideas?"</a>
<li><strong>Previous message:</strong> <a href="14121.php">John Hearns: "Re: [OMPI users] IMB-MPI broadcast test stalls for large core counts: debug ideas?"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
