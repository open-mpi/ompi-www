...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14363.php">Chris Jewell: "[OMPI users] Error when using OpenMPI with SGE multiple hosts"</a>
<li><strong>Previous message:</strong> <a href="14361.php">Reuti: "Re: [OMPI users] STDIN"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14365.php">Ralph Castain: "Re: [OMPI users] mpi_comm_spawn have problems with group communicators"</a>
<li><strong>Reply:</strong> <a href="14365.php">Ralph Castain: "Re: [OMPI users] mpi_comm_spawn have problems with group communicators"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
