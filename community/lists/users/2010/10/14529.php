...
?>
<!-- received="Thu Oct 21 10:18:16 2010" -->
<!-- isoreceived="20101021141816" -->
<!-- sent="Thu, 21 Oct 2010 10:18:11 -0400" -->
<!-- isosent="20101021141811" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)" -->
<!-- id="BCF9FEB0-71E0-42C2-B83A-98070811ABBC_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4CC049E0.6010300_at_oracle.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-10-21 10:18:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14530.php">Siegmar Gross: "Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)"</a>
<li><strong>Previous message:</strong> <a href="14528.php">Terry Dontje: "Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)"</a>
<li><strong>In reply to:</strong> <a href="14528.php">Terry Dontje: "Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14532.php">Terry Dontje: "Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)"</a>
<li><strong>Reply:</strong> <a href="14532.php">Terry Dontje: "Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Terry --
<br>
<p>Can you file relevant ticket(s) for v1.5 on Trac?
<br>
<p><p>On Oct 21, 2010, at 10:10 AM, Terry Dontje wrote:
<br>
<p><span class="quotelev1">&gt; I've reproduced Siegmar's issue when I have the threads options on but it does not show up when they are off.  It is actually segv'ing in mca_btl_sm_component_close on an access at address 0 (obviously not a good thing).  I am going compile things with debug on and see if I can track this further but I think I am smelling the smoke of a bug...
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Siegmar, I was able to get stuff working with 32 bits when I removed -with-threads=posix and replaced &quot;-enable-mpi-threads&quot; with --disable-mpi-threads in your configure line.  I think your previous issue with things not building must be left over cruft.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Note, my compiler hang disappeared on me.  So maybe there was an environmental issue on my side.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On 10/21/2010 06:47 AM, Terry Dontje wrote:
</span><br>
<span class="quotelev2">&gt;&gt; On 10/21/2010 06:43 AM, Jeff Squyres (jsquyres) wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Also, i'm not entirely sure what all the commands are that you are showing. Some of those warnings (eg in config.log) are normal. 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The 32 bit test failure is not, though. Terry - any idea there?
</span><br>
<span class="quotelev2">&gt;&gt; The test program is failing in MPI_Finalize which seems odd and the code itself looks pretty dead simple.  I am rebuilding a v1.5 workspace without the different thread options.  Once that is done I'll try the test program.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; BTW, when I tried to build with the original options Siegmar used the compiles looked like they hung, doh.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Oct 21, 2010, at 6:25 AM, &quot;Terry Dontje&quot; &lt;terry.dontje_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I wonder if the error below be due to crap being left over in the source tree.  Can you do a &quot;make clean&quot;.  Note on a new checkout from the v1.5 svn branch I was able to             build 64 bit with the following configure line:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ../configure FC=f95 F77=f77 CC=cc CXX=CC --without-openib --without-udapl -enable-heterogeneous --enable-cxx-exceptions --enable-shared --enable-orterun-prefix-by-default --with-sge --disable-mpi-threads --enable-mpi-f90 --with-mpi-f90-size=small --disable-progress-threads --prefix=/workspace/tdd/ctnext/v15 CFLAGS=-m64 CXXFLAGS=-m64             FFLAGS=-m64 FCFLAGS=-m64
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --td
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On 10/21/2010 05:38 AM, Siegmar Gross wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; terry.dontje_at_[hidden] &lt;mailto:terry.dontje_at_[hidden]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; &lt;mime-attachment.gif&gt;
</span><br>
