...
?>
<!-- received="Thu Oct 21 06:47:37 2010" -->
<!-- isoreceived="20101021104737" -->
<!-- sent="Thu, 21 Oct 2010 06:47:08 -0400" -->
<!-- isosent="20101021104708" -->
<!-- name="Terry Dontje" -->
<!-- email="terry.dontje_at_[hidden]" -->
<!-- subject="Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)" -->
<!-- id="4CC01A2C.4090003_at_oracle.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="55B69029-43DD-4D7E-A0C0-8A617E6D918C_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-10-21 06:47:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14526.php">Storm Zhang: "Re: [OMPI users] Question about MPI_Barrier"</a>
<li><strong>Previous message:</strong> <a href="14524.php">Jeff Squyres (jsquyres): "Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)"</a>
<li><strong>In reply to:</strong> <a href="14524.php">Jeff Squyres (jsquyres): "Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14528.php">Terry Dontje: "Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)"</a>
<li><strong>Reply:</strong> <a href="14528.php">Terry Dontje: "Re: [OMPI users] segmentation fault in mpiexec (Linux, Oracle/Sun C)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; Also, i'm not entirely sure what all the commands are that you are 
</span><br>
<span class="quotelev1">&gt; showing. Some of those warnings (eg in config.log) are normal.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; The 32 bit test failure is not, though. Terry - any idea there?
</span><br>
...
test program.
<br>
<p>BTW, when I tried to build with the original options Siegmar used the 
<br>
...
<span class="quotelev1">&gt; On Oct 21, 2010, at 6:25 AM, &quot;Terry Dontje&quot; &lt;terry.dontje_at_[hidden] 
</span><br>
...
<span class="quotelev2">&gt;&gt; ../configure FC=f95 F77=f77 CC=cc CXX=CC --without-openib 
</span><br>
<span class="quotelev2">&gt;&gt; --without-udapl -enable-heterogeneous --enable-cxx-exceptions 
</span><br>
<span class="quotelev2">&gt;&gt; --enable-shared --enable-orterun-prefix-by-default --with-sge 
</span><br>
<span class="quotelev2">&gt;&gt; --disable-mpi-threads --enable-mpi-f90 --with-mpi-f90-size=small 
</span><br>
<span class="quotelev2">&gt;&gt; --disable-progress-threads --prefix=/workspace/tdd/ctnext/v15 
</span><br>
...
<span class="quotelev2">&gt;&gt; On 10/21/2010 05:38 AM, Siegmar Gross wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hi,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; thank you very much for your reply.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;    Can you remove the -with-threads and -enable-mpi-threads options from
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the configure line and see if that helps your 32 bit problem any?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I cannot build the package when I remove these options.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 189 head -8 config.log
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; It was created by Open MPI configure 1.5, which was
</span><br>
<span class="quotelev3">&gt;&gt;&gt; generated by GNU Autoconf 2.65.  Invocation command line was
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;    CPPFLAGS= LDFLAGS=-m32 C_INCL_PATH= C_INCLUDE_PATH= CPLUS_INCLUDE_PATH=
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    OBJC_INCLUDE_PATH= MPICHHOME= CC=cc CXX=CC F77=f95 FC=f95
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    --without-udapl --enable-shared --enable-heterogeneous
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 190 head -8 ../*.old/config.log
</span><br>
<span class="quotelev3">&gt;&gt;&gt; This file contains any messages produced by compilers while
</span><br>
<span class="quotelev3">&gt;&gt;&gt; running configure, to aid debugging if configure makes a mistake.
...
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 194 dir log.* ../*.old/log.*
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ... 132406 Oct 19 13:01
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    ../openmpi-1.5-Linux.x86_64.32_cc.old/log.configure.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ... 195587 Oct 19 16:09
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    ../openmpi-1.5-Linux.x86_64.32_cc.old/log.make-check.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ... 356672 Oct 19 16:07
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    ../openmpi-1.5-Linux.x86_64.32_cc.old/log.make-install.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ... 280596 Oct 19 13:42
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    ../openmpi-1.5-Linux.x86_64.32_cc.old/log.make.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ... 132265 Oct 21 10:51 log.configure.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ...  10890 Oct 21 10:51 log.make.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 195 grep -i warning:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    log.configure.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING: *** Did not find corresponding C type
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING: MPI_REAL16 and MPI_COMPLEX32 support have been disabled
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING: *** Corresponding Fortran 77 type (REAL*16) not supported
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING: *** Skipping Fortran 90 type (REAL*16)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING: valgrind.h not found
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING: Unknown architecture ... proceeding anyway
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING: File locks may not work with NFS.  See the Installation and
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING:  -xldscope=hidden has been added to CFLAGS
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 196 grep -i warning:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    ../*.old/log.configure.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING: *** Did not find corresponding C type
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: WARNING: MPI_REAL16 and MPI_COMPLEX32 support have been disabled
...
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 197 grep -i error:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    log.configure.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: error: no libz found; check path for ZLIB package first...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: error: no vtf3.h found; check path for VTF3 package first...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: error: no BPatch.h found; check path for Dyninst package first...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: error: no f2c.h found; check path for CLAPACK package first...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: error: MPI Correctness Checking support cannot be built inside Open
</span><br>
<span class="quotelev3">&gt;&gt;&gt; MPI
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: error: no papi.h found; check path for PAPI package first...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: error: no libcpc.h found; check path for CPC package first...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: error: no ctool/ctool.h found; check path for CTool package first...
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 198 grep -i error:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    ../*.old/log.configure.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; configure: error: no libz found; check path for ZLIB package first...
...
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 199
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 199 grep -i warning:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    log.make.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 200 grep -i warning:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    ../*.old/log.make.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;.../opal/mca/crs/none/crs_none_module.c&quot;, line 136: warning:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    statement not reached
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;.../orte/mca/errmgr/errmgr.h&quot;, line 135: warning: attribute
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    &quot;noreturn&quot; may not be applied to variable, ignored
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ... (much more warnings for errmgr.h, line 135)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;.../orte/tools/orte-ps/orte-ps.c&quot;, line 288: warning: initializer
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    does not fit or is out of range: 0xfffffffe
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;.../orte/tools/orte-ps/orte-ps.c&quot;, line 289: warning: initializer
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    does not fit or is out of range: 0xfffffffe
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; f95: Warning: Option -rpath passed to ld, if ld is invoked,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    ignored otherwise
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;.../ompi/mca/io/romio/romio/adio/common/ad_fstype.c&quot;, line 397:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    warning: statement not reached
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;.../ompi/mca/osc/rdma/osc_rdma_data_move.c&quot;, line 296:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    warning: statement not reached
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;.../ompi/mca/osc/rdma/osc_rdma_data_move.c&quot;, line 678:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    warning: statement not reached
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;.../ompi/mca/pml/cm/pml_cm_cancel.c&quot;, line 65: warning:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    statement not reached
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ...
</span><br>
<span class="quotelev3">&gt;&gt;&gt; CC: Warning: Specify a supported level of optimization when using
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    -xopenmp, -xopenmp will not set an optimization level in a
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    future release. Optimization level changed to 3 to support -xopenmp.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ... (a lot more of these warnings)
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Above you have all different warnings if I didn't miss one.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 201 grep -i error:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    log.make.Linux.x86_64.32_cc cc1: error: unrecognized command line
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    option &quot;-fno-directives-only&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 202 grep -i error:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    ../*.old/log.make.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 203
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; linpc4 openmpi-1.5-Linux.x86_64.32_cc 205 tail -15
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    log.make.Linux.x86_64.32_cc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; make[3]: Leaving directory `/.../opal/libltdl'
</span><br>
<span class="quotelev3">&gt;&gt;&gt; make[2]: Leaving directory `/.../opal/libltdl'
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Making all in asm
</span><br>
<span class="quotelev3">&gt;&gt;&gt; make[2]: Entering directory `/.../opal/asm'
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    CC     asm.lo
</span><br>
<span class="quotelev3">&gt;&gt;&gt; rm -f atomic-asm.S
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ln -s &quot;.../opal/asm/generated/atomic-ia32-linux-nongas.s&quot; atomic-asm.S
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    CPPAS  atomic-asm.lo
</span><br>
<span class="quotelev3">&gt;&gt;&gt; cc1: error: unrecognized command line option &quot;-fno-directives-only&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; cc: cpp failed for atomic-asm.S
</span><br>
<span class="quotelev3">&gt;&gt;&gt; make[2]: *** [atomic-asm.lo] Error 1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; make[2]: Leaving directory `/.../opal/asm'
</span><br>
<span class="quotelev3">&gt;&gt;&gt; make[1]: *** [all-recursive] Error 1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; make[1]: Leaving directory `/.../opal'
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; It is the same error which I reported yesterday for &quot;Linux x86_64,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Oracle/Sun C, 64-bit).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Please let me know if you need anything else.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 10/20/2010 09:38 AM, Siegmar Gross wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Emailterry.dontje_at_[hidden]  &lt;mailto:terry.dontje_at_[hidden]&gt;  &lt;mailto:terry.dontje_at_[hidden]&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-14525/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/users/att-14525/02-part" alt="picture">
<!-- attachment="02-part" -->
<!-- body="end" -->
<hr>
<ul class="links">
