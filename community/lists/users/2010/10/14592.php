...
?>
<!-- received="Mon Oct 25 12:26:28 2010" -->
<!-- isoreceived="20101025162628" -->
<!-- sent="Mon, 25 Oct 2010 10:26:22 -0600" -->
<!-- isosent="20101025162622" -->
<!-- name="Jack Bryan" -->
<!-- email="dtustudy68_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Open MPI program cannot complete" -->
<!-- id="SNT134-w152F3EF5599F453A6588FCB410_at_phx.gbl" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="AANLkTimpOHwHrwRv+KZvVzwXGnjQy=3OrRYtjXTFr_u1_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-10-25 12:26:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14593.php">Jed Brown: "Re: [OMPI users] Open MPI program cannot complete"</a>
<li><strong>Previous message:</strong> <a href="14591.php">David Zhang: "Re: [OMPI users] Open MPI program cannot complete"</a>
<li><strong>In reply to:</strong> <a href="14591.php">David Zhang: "Re: [OMPI users] Open MPI program cannot complete"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14593.php">Jed Brown: "Re: [OMPI users] Open MPI program cannot complete"</a>
<li><strong>Reply:</strong> <a href="14593.php">Jed Brown: "Re: [OMPI users] Open MPI program cannot complete"</a>
<li><strong>Reply:</strong> <a href="14595.php">Ashley Pittman: "Re: [OMPI users] Open MPI program cannot complete"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MPI_Barrier(MPI_COMM_WORLD);		cout &lt;&lt; &quot;In main(), I am rank &quot; &lt;&lt; myRank &lt;&lt; &quot; , I am before MPI_Finalize() and after MPI_Barrier(MPI_COMM_WORLD). \n\n&quot;  &lt;&lt; endl ;		MPI_Finalize();	        cout &lt;&lt; &quot;In main(), I am rank &quot; &lt;&lt; myRank &lt;&lt; &quot; , I am after MPI_Finalize(), then return 0 . \n\n&quot;  &lt;&lt; endl ;	        return 0 ;
<br>
...
Subject: Re: [OMPI users] Open MPI program cannot complete
<br>
<p>I think I got this problem before.  Put a mpi_barrier(mpi_comm_world) before mpi_finalize for all processes.  For me, mpi terminates nicely only when all process are calling mpi_finalize the same time.  So I do it for all my programs.
<br>
<p><p><p>On Mon, Oct 25, 2010 at 7:13 AM, Jack Bryan &lt;dtustudy68_at_[hidden]&gt; wrote:
<br>
<p><p><p><p><p><p><p>Thanks, But, I have put a mpi_waitall(request) before
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;cout &lt;&lt; &quot; I am rank &quot; &lt;&lt; rank &lt;&lt; &quot; I am before MPI_Finalize()&quot; &lt;&lt; endl;
<br>
<p><p>If the above sentence has been printed out, it means that all requests have been checked and finished. right ?  
<br>
<p><p>What may be the possible reasons for that stuck ? 
<br>
Any help is appreciated. 
<br>
Jack
...
Oct. 25 2010 
<br>
<p><p><p>Date: Mon, 25 Oct 2010 05:32:44 -0400
<br>
From: terry.dontje_at_[hidden]
<br>
To: users_at_[hidden]
<br>
<p><p>Subject: Re: [OMPI users] Open MPI program cannot complete
<br>
<p><p><p>&nbsp;&nbsp;
<br>
<p><p>&nbsp;&nbsp;&nbsp;&nbsp;
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-14592/attachment">attachment</a>
</ul>
