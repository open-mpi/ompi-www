...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] MPI_Bcast() Vs paired MPI_Send() &amp; MPI_Recv()<br>
<strong>From:</strong> David Zhang (<em>solarbikedz_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-09-01 16:09:54
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14151.php">Brock Palen: "[OMPI users] simplest way to check message queues"</a>
<li><strong>Previous message:</strong> <a href="14149.php">Gus Correa: "Re: [OMPI users] compilation error using pgf90 ver 9.0"</a>
<li><strong>In reply to:</strong> <a href="14148.php">ananda.mudar_at_[hidden]: "[OMPI users] MPI_Bcast() Vs paired MPI_Send() &amp; MPI_Recv()"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
