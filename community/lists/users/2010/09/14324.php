...
?>
<!-- received="Fri Sep 24 09:24:20 2010" -->
<!-- isoreceived="20100924132420" -->
<!-- sent="Fri, 24 Sep 2010 15:23:51 +0200" -->
<!-- isosent="20100924132351" -->
<!-- name="Eloi Gaudry" -->
<!-- email="eg_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [openib] segfault when using openib btl" -->
<!-- id="201009241523.52002.eg_at_fft.be" -->
<!-- charset="iso-8859-15" -->
...
<strong>Date:</strong> 2010-09-24 09:23:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14325.php">Eloi Gaudry: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<li><strong>Previous message:</strong> <a href="14323.php">Richard Treumann: "Re: [OMPI users] &quot;self scheduled&quot; work &amp; mpi receive???"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14325.php">Eloi Gaudry: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Terry,
<br>
<p>No, I haven't tried any other values than P,65536,256,192,128 yet.
<br>
<p>The reason why is quite simple. I've been reading and reading again this thread to understand the btl_openib_receive_queues meaning and I can't figure out why the default values seem to induce the 
<br>
&quot;hdr-&gt;tag=0&quot; issue (<a href="http://www.open-mpi.org/community/lists/users/2009/01/7808.php">http://www.open-mpi.org/community/lists/users/2009/01/7808.php</a>). 
<br>
<p>Do you think that the default shared received queue parameters are erroneous for this specific Mellanox card ? Any help on finding the proper parameters would actually be much appreciated.
<br>
<p>Eloi
<br>
<p>On Friday 24 September 2010 14:27:07 you wrote:
<br>
...
<span class="quotelev1">&gt; I am wondering if it is the first queuing definition causing the issue or
</span><br>
<span class="quotelev1">&gt; possibly the SRQ defined in the default.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt; The messages being send/received can be of any size, but the error seems
</span><br>
<span class="quotelev2">&gt; &gt; to happen more often with small messages (as an int being broadcasted or
</span><br>
<span class="quotelev2">&gt; &gt; allreduced). The failing communication differs from one run to another,
</span><br>
<span class="quotelev2">&gt; &gt; but some spots are more likely to be failing than another. And as far as
</span><br>
<span class="quotelev2">&gt; &gt; I know, there are always located next to a small message (an int being
</span><br>
<span class="quotelev2">&gt; &gt; broadcasted for instance) communication. Other typical messages size are
</span><br>
...
<span class="quotelev2">&gt; &gt;  mca:btl:openib:param:btl_openib_receive_queues:value:P,128,256,192,128:S
</span><br>
<span class="quotelev2">&gt; &gt;  ,2048,256,128,32:S,12288,256,128,32:S,65536,256,128,32
</span><br>
...
<span class="quotelev2">&gt; &gt; I was wondering if these parameters (automatically computed at openib btl
</span><br>
<span class="quotelev2">&gt; &gt; init for what I understood) were not incorrect in some way and I plugged
</span><br>
<span class="quotelev2">&gt; &gt; some others values: &quot;P,65536,256,192,128&quot; (someone on the list used that
</span><br>
<span class="quotelev2">&gt; &gt; values when encountering a different issue) . Since that, I haven't been
</span><br>
<span class="quotelev2">&gt; &gt; able to observe the segfault (occuring as hrd-&gt;tag = 0 in
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Eloi, I am curious about your problem.  Can you tell me what size of job
</span><br>
<span class="quotelev3">&gt; &gt;&gt; it is?  Does it always fail on the same bcast,  or same process?
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; hdr-&gt;tag=0) so far (when using pml csum) but I 'll let you know when I
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; somehow depends on the btl being used (i.e. if I'm using openib, may I
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; use the same number of MPI_Comm object as with tcp) ? Is there
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; mpi/faq/?category=openfabrics#ib-small-message-rdma but the debug-build
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; of OpenMPI asserts if I use a different min-size that 255. Anyway, if I
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; deactivate eager_rdma, the segfaults remains. Does the openib btl
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; handle very small message differently (even with eager_rdma
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt;  is there a way to make sure that large messages and small messages are
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;  handled the same way ?
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Do you mean so they all look like eager messages?  How large of messages
</span><br>
<span class="quotelev3">&gt; &gt;&gt; are we talking about here 1K, 1M or 10M?
</span><br>
<span class="quotelev3">&gt; &gt;&gt; 
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; The checksum verification is done in the PML, which the BTL calls via
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; a callback function. In your case the PML callback is never called
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; because the hdr-&gt;tag is invalid. So enabling checksum tracing also
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; might not be of much use. Is it the first Bcast that fails or the nth
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Bcast and what is the message size? I'm not sure what could be the
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; problem at this moment. I'm afraid you will have to debug the BTL to
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; find out more.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; reproduce it on an IB system. There is also a PML called csum, you
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; can use it via &quot;-mca pml csum&quot;, which will checksum the MPI
</span><br>
<span class="quotelev3">&gt; &gt;&gt;&gt;&gt;&gt;&gt; messages and verify it at the receiver side for any data
</span><br>
