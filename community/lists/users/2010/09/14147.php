...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Observation for OPAL_PREFIX usage in product deployment.<br>
<strong>From:</strong> Roger Martin (<em>roger_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-09-01 07:49:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14148.php">ananda.mudar_at_[hidden]: "[OMPI users] MPI_Bcast() Vs paired MPI_Send() &amp; MPI_Recv()"</a>
<li><strong>Previous message:</strong> <a href="14146.php">Reuti: "Re: [OMPI users] compilation error using pgf90 ver 9.0"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
