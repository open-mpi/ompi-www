...
?>
<!-- received="Mon Mar  1 12:04:38 2010" -->
<!-- isoreceived="20100301170438" -->
<!-- sent="Mon, 01 Mar 2010 09:04:32 -0800" -->
<!-- isosent="20100301170432" -->
<!-- name="David Turner" -->
<!-- email="dpturner_at_[hidden]" -->
<!-- subject="Re: [OMPI users] sm btl choices" -->
<!-- id="4B8BF3A0.20707_at_lbl.gov" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2010-03-01 12:04:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12193.php">Ralph Castain: "Re: [OMPI users] sm btl choices"</a>
<li><strong>Previous message:</strong> <a href="12191.php">Ralph Castain: "Re: [OMPI users] sm btl choices"</a>
<li><strong>In reply to:</strong> <a href="12185.php">Ralph Castain: "Re: [OMPI users] sm btl choices"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12193.php">Ralph Castain: "Re: [OMPI users] sm btl choices"</a>
<li><strong>Reply:</strong> <a href="12193.php">Ralph Castain: "Re: [OMPI users] sm btl choices"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Ralph,
<br>
<p><span class="quotelev1">&gt; Which version of OMPI are you using? We know that the 1.2 series was unreliable about removing the session directories, but 1.3 and above appear to be quite good about it. If you are having problems with the 1.3 or 1.4 series, I would definitely like to know about it.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; When I was at LANL, I ran a number of tests in exactly this configuration. While the sm btl did provide some performance advantage, it wasn't very much (the bandwidth was only about 10% greater, and the latency wasn't all that different either). I set the default configuration for users to include sm as 10% isn't something to sneer at, but you could disable it without an enormous impact.
</span><br>
<p>I realize I have another question about this.  When you say &quot;exactly&quot;
<br>
...
<br>
<p>We have historically redefined TMPDIR to point somewhere other than
<br>
...
<span class="quotelev1">&gt; On Mar 1, 2010, at 1:42 AM, David Turner wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
