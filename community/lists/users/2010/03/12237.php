...
?>
<!-- received="Thu Mar  4 09:02:44 2010" -->
<!-- isoreceived="20100304140244" -->
<!-- sent="Thu, 4 Mar 2010 15:02:19 +0100" -->
<!-- isosent="20100304140219" -->
...
<!-- id="698a35c61003040602v6009cf89g599898a387bef8c0_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="698a35c61003020554j34048527q71ceb764ed8797c_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-03-04 09:02:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12238.php">Prentice Bisbal: "Re: [OMPI users] Limit to number of processes on one node?"</a>
<li><strong>Previous message:</strong> <a href="12236.php">Fernando Lemos: "Re: [OMPI users] checkpointing multi node and multi process applications"</a>
<li><strong>In reply to:</strong> <a href="12198.php">TRINH Minh Hieu: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneouscluster (32/64 bit machines)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12253.php">Aurélien Bouteiller: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneouscluster (32/64 bit machines)"</a>
<li><strong>Reply:</strong> <a href="12253.php">Aurélien Bouteiller: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneouscluster (32/64 bit machines)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>I have some new discovery about this problem :
<br>
<p>It seems that the array size sendable from a 32bit to 64bit machines
<br>
...
<br>
<p>I didn't found much informations about btl_tcp_eager_limit other than
<br>
in the &quot;ompi_info --all&quot; command. If I let it at 2e08, will it impacts
<br>
the performance of OpenMPI ?
<br>
<p>It may be noteworth also that if the master (rank 0) is a 32bit
<br>
machines, I don't have segfault. I can send big array with small
<br>
&quot;btl_tcp_eager_limit&quot; from a 64bit machine to a 32bit one.
<br>
<p>Do I have to move this thread to devel mailing list ?
<br>
<p>Regards,
<br>
<p>&nbsp;&nbsp;&nbsp;TMHieu
<br>
<p>On Tue, Mar 2, 2010 at 2:54 PM, TRINH Minh Hieu &lt;mhtrinh_at_[hidden]&gt; wrote:
<br>
