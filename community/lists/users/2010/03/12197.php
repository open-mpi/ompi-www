...
?>
<!-- received="Tue Mar  2 07:57:41 2010" -->
<!-- isoreceived="20100302125741" -->
<!-- sent="Tue, 2 Mar 2010 07:57:35 -0500" -->
<!-- isosent="20100302125735" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneouscluster (32/64 bit machines)" -->
<!-- id="AA1DF726-57F9-47E6-AE8C-60B97907056F_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2010-03-02 07:57:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12198.php">TRINH Minh Hieu: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneouscluster (32/64 bit machines)"</a>
<li><strong>Previous message:</strong> <a href="12196.php">Ramon: "[OMPI users] MPI_Comm_accept() busy waiting?"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12198.php">TRINH Minh Hieu: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneouscluster (32/64 bit machines)"</a>
<li><strong>Reply:</strong> <a href="12198.php">TRINH Minh Hieu: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneouscluster (32/64 bit machines)"</a>
<li><strong>Maybe reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/04/12777.php">TRINH Minh Hieu: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneouscluster (32/64 bit machines)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Feb 28, 2010, at 1:22 PM, TRINH Minh Hieu wrote:
<br>
