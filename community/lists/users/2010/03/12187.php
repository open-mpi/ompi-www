...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12188.php">TRINH Minh Hieu: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneous cluster (32/64 bit machines)"</a>
<li><strong>Previous message:</strong> <a href="12186.php">Federico Golfr&#232; Andreasi: "Re: [OMPI users] Number of processes and spawn"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12188.php">TRINH Minh Hieu: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneous cluster (32/64 bit machines)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
