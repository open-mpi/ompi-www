...
<p class="headers">
<strong>Subject:</strong> [OMPI users] sm btl choices<br>
<strong>From:</strong> David Turner (<em>dpturner_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-03-01 03:42:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12185.php">Ralph Castain: "Re: [OMPI users] sm btl choices"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/02/12183.php">Fernando Lemos: "[OMPI users] Segfault in ompi-restart (ft-enable-cr)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12185.php">Ralph Castain: "Re: [OMPI users] sm btl choices"</a>
<li><strong>Reply:</strong> <a href="12185.php">Ralph Castain: "Re: [OMPI users] sm btl choices"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
