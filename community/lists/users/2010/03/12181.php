...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12182.php">Ralph Castain: "Re: [OMPI users] Number of processes and spawn"</a>
<li><strong>Previous message:</strong> <a href="12180.php">Timur Magomedov: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneous cluster (32/64 bit machines)"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12190.php">Jeff Squyres: "Re: [OMPI users] Segmentation fault when Send/Recv on heterogeneouscluster (32/64 bit machines)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/x-csrc attachment: <a href="../../att-12181/hetero.c">hetero.c</a>
</ul>
<!-- attachment="hetero.c" -->
<!-- body="end" -->
<hr>
