...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11671.php">Andreas Kn&#252;pfer: "Re: [OMPI users] VampirTrace: time not increasing"</a>
<li><strong>Previous message:</strong> <a href="11669.php">Eugene Loh: "Re: [OMPI users] Dual quad core Opteron hangs on Bcast."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11677.php">Eugene Loh: "Re: [OMPI users] openib btl slows down application"</a>
<li><strong>Reply:</strong> <a href="11677.php">Eugene Loh: "Re: [OMPI users] openib btl slows down application"</a>
<li><strong>Reply:</strong> <a href="11679.php">Eugene Loh: "Re: [OMPI users] openib btl slows down application"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/x-csrc attachment: <a href="../../att-11670/tst-sendrecv-replace.c">tst-sendrecv-replace.c</a>
</ul>
