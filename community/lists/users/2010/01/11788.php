<?
$subject_val = "[OMPI users] Open MPI v1.4.1 released";
...
<!-- subject="[OMPI users] Open MPI v1.4.1 released" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Open MPI v1.4.1 released<br>
<strong>From:</strong> Ralph Castain (<em>rhc_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-01-15 02:42:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11789.php">Ashley Pittman: "Re: [OMPI users] MPI debugger"</a>
<li><strong>Previous message:</strong> <a href="11787.php">cjohnson_at_[hidden]: "Re: [OMPI users] Windows CMake build problems ... (cont.)"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
