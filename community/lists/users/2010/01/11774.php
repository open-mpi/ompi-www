...
?>
<!-- received="Thu Jan 14 13:21:20 2010" -->
<!-- isoreceived="20100114182120" -->
<!-- sent="Thu, 14 Jan 2010 19:20:55 +0100" -->
<!-- isosent="20100114182055" -->
<!-- name="Shiqing Fan" -->
<!-- email="fan_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Windows CMake build problems ... (cont.)" -->
<!-- id="4B4F6087.4080500_at_hlrs.de" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2010-01-14 13:20:55
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11775.php">TONY BASIL: "[OMPI users] Rapid I/O support"</a>
<li><strong>Previous message:</strong> <a href="11773.php">Evan Smyth: "Re: [OMPI users] Problems Using PVFS2 with OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="11762.php">cjohnson_at_[hidden]: "[OMPI users] Windows CMake build problems ... (cont.)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11787.php">cjohnson_at_[hidden]: "Re: [OMPI users] Windows CMake build problems ... (cont.)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Charlie,
<br>
<p>The problem turns out to be the different behavior of one CMake macro in 
<br>
...
<br>
#2169: <a href="https://svn.open-mpi.org/trac/ompi/ticket/2169">https://svn.open-mpi.org/trac/ompi/ticket/2169</a> .
<br>
<p>So you could either switch to use OMPI trunk or use CMake 2.6 to solve 
<br>
