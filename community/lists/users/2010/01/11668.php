...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11669.php">Eugene Loh: "Re: [OMPI users] Dual quad core Opteron hangs on Bcast."</a>
<li><strong>Previous message:</strong> <a href="11667.php">chih lee: "[OMPI users] Cannot get OpenMPI 1.3.3 to work with Torque 2.4.2"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11669.php">Eugene Loh: "Re: [OMPI users] Dual quad core Opteron hangs on Bcast."</a>
<li><strong>Reply:</strong> <a href="11669.php">Eugene Loh: "Re: [OMPI users] Dual quad core Opteron hangs on Bcast."</a>
<li><strong>Maybe reply:</strong> <a href="11674.php">Eugene Loh: "Re: [OMPI users] Dual quad core Opteron hangs on Bcast."</a>
<li><strong>Reply:</strong> <a href="11678.php">Matthew MacManes: "Re: [OMPI users] Dual quad core Opteron hangs on Bcast."</a>
<li><strong>Maybe reply:</strong> <a href="11685.php">Eugene Loh: "Re: [OMPI users] Dual quad core Opteron hangs on Bcast."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>application/x-gzip attachment: <a href="../../att-11668/bcast_example.c.gz">bcast_example.c.gz</a>
</ul>
<!-- attachment="bcast_example.c.gz" -->
<hr>
<ul>
<li>application/x-gzip attachment: <a href="../../att-11668/ompi_info.txt.gz">ompi_info.txt.gz</a>
</ul>
<!-- attachment="ompi_info.txt.gz" -->
<hr>
<ul>
<li>application/x-gzip attachment: <a href="../../att-11668/ifconfig.txt.gz">ifconfig.txt.gz</a>
</ul>
