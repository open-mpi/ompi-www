...
?>
<!-- received="Thu Jan 14 06:43:10 2010" -->
<!-- isoreceived="20100114114310" -->
<!-- sent="Thu, 14 Jan 2010 12:42:20 +0100" -->
<!-- isosent="20100114114220" -->
<!-- name="Shiqing Fan" -->
<!-- email="fan_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Windows CMake build problems ... (cont.)" -->
<!-- id="4B4F031C.3050400_at_hlrs.de" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2010-01-14 06:42:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11766.php">Shiqing Fan: "Re: [OMPI users] Windows CMake build problems ... (cont.)"</a>
<li><strong>Previous message:</strong> <a href="11764.php">Mathieu Gontier: "Re: [OMPI users] OpenMPI less fast than MPICH"</a>
<li><strong>In reply to:</strong> <a href="11762.php">cjohnson_at_[hidden]: "[OMPI users] Windows CMake build problems ... (cont.)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11766.php">Shiqing Fan: "Re: [OMPI users] Windows CMake build problems ... (cont.)"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Charlie,
<br>
<p>It seems that the dependencies among the projects are corrupted. Don't 
<br>
know how this could happen, CMake build system should set them 
<br>
automatically.
<br>
<p>Take the opal-restart as an example, if you right click on that project, 
<br>
...
<br>
<p>I've updated my CMake to 2.8, and I didn't see the problem either. So 
<br>
