...
?>
<!-- received="Wed Jul 28 18:45:44 2010" -->
<!-- isoreceived="20100728224544" -->
<!-- sent="Wed, 28 Jul 2010 18:45:33 -0400" -->
<!-- isosent="20100728224533" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openMPI shared with NFS, but says different version" -->
<!-- id="4C50B30D.2020006_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="AANLkTinPoBRzM3sv8sOxxB2LHS9TocffbN3MZG2FOwCu_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-28 18:45:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13859.php">Rahul Nabar: "[OMPI users] MPI broadcast test fails only when I run within a torque job"</a>
<li><strong>Previous message:</strong> <a href="13857.php">Martin Siegert: "[OMPI users] Alignment of Fortran variables with ifort"</a>
<li><strong>In reply to:</strong> <a href="13856.php">Cristobal Navarro: "Re: [OMPI users] openMPI shared with NFS, but says different version"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/08/13915.php">Cristobal Navarro: "Re: [OMPI users] openMPI shared with NFS, but says different version"</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/08/13915.php">Cristobal Navarro: "Re: [OMPI users] openMPI shared with NFS, but says different version"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Kernel is not my league.
<br>
<p>However, it would be great if somebody clarified
<br>
...
<br>
<p><span class="quotelev1">&gt; at least for the moment i will use this configuration, at least for 
</span><br>
<span class="quotelev1">&gt; deveplopment/testing  of the parallel programs.
</span><br>
<span class="quotelev1">&gt; lag is minimum :)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; whenever i get another kernel update, i will test again to check if sm 
</span><br>
<span class="quotelev1">&gt; works, would be good to know that suddenly another distribution supports 
</span><br>
<span class="quotelev1">&gt; nehalem sm.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<p>Acatenango (I said that before), and Pacaya.
<br>
<p>Maybe: Santa Maria, Santiaguito, Atitlan, Toliman, San Pedro,
<br>
...
<span class="quotelev1">&gt; On Wed, Jul 28, 2010 at 5:50 PM, Gus Correa &lt;gus_at_[hidden] 
</span><br>
...
<span class="quotelev1">&gt;         --i foudn the archives recently about an hour ago, was not sure
</span><br>
...
<span class="quotelev1">&gt;         lstopo, unfortenately i also crashes, so HT may not be the problem.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt;                and somepart it mentions a certain CPU X, where that cpu
</span><br>
<span class="quotelev1">&gt;         can be
</span><br>
<span class="quotelev1">&gt;                any from 0 to 15 (im testing only in main node).  Someone
</span><br>
...
<span class="quotelev1">&gt;         i have 4 nodes, so anyways there will be node comunication, do
</span><br>
<span class="quotelev1">&gt;         you think i can rely on working with -mca btl tcp,self?? i dont
</span><br>
...
<span class="quotelev1">&gt;     Some people reported everything works with OpenMPI+HT+sm in CentOS
</span><br>
<span class="quotelev1">&gt;     and RHEL, see the thread I mentioned in the archives from 1-2 months
</span><br>
...
<span class="quotelev1">&gt;         i just have one more question, is this a problem of the ubuntu
</span><br>
...
<span class="quotelev1">&gt;         and on what depends that in the future, sm could be possible on
</span><br>
...
<span class="quotelev1">&gt;                          Try to put only the head node on the hostfile
</span><br>
...
<span class="quotelev1">&gt;                       --&gt; i will try only with the head node, and post
</span><br>
...
<span class="quotelev1">&gt;                       --&gt; i agree, somewhere there must be the remains
</span><br>
...
<span class="quotelev1">&gt;                          It may be easier/less confusing to install from
</span><br>
...
<span class="quotelev1">&gt;                          the command line, because it will be effective
</span><br>
...
<span class="quotelev1">&gt;                          directory are *also* shared with the nodes via
</span><br>
<span class="quotelev1">&gt;         NFS),
</span><br>
<span class="quotelev1">&gt;                          or use the --prefix option of mpiexec to point
</span><br>
...
<span class="quotelev1">&gt;                       yes, all nodes have their PATH and LD_LIBRARY_PATH
</span><br>
<span class="quotelev1">&gt;         set up
</span><br>
<span class="quotelev1">&gt;                       properly inside the login scripts ( .bashrc in my
</span><br>
<span class="quotelev1">&gt;         case  )
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;                          Needless to say, you need to check and ensure
</span><br>
<span class="quotelev1">&gt;         that the
</span><br>
<span class="quotelev1">&gt;                OpenMPI
</span><br>
<span class="quotelev1">&gt;                          directory (and maybe your home directory, and
</span><br>
