...
?>
<!-- received="Mon Jul 19 12:32:44 2010" -->
<!-- isoreceived="20100719163244" -->
<!-- sent="Mon, 19 Jul 2010 11:32:34 -0500" -->
<!-- isosent="20100719163234" -->
<!-- name="Edgar Gabriel" -->
<!-- email="gabriel_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept" -->
<!-- id="4C447E22.9060307_at_cs.uh.edu" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="1DF334B9-380A-41A5-85C4-2765CFDB3025_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-19 12:32:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13704.php">Daniel Janzon: "Re: [OMPI users] Ok, I've got OpenMPI set up, now what?!"</a>
<li><strong>Previous message:</strong> <a href="13702.php">Stefan Kuhne: "Re: [OMPI users] MPE logging GUI"</a>
<li><strong>In reply to:</strong> <a href="13627.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13713.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>Reply:</strong> <a href="13713.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Additionally, I went through the communicator creation code for dynamic
<br>
...
<br>
<p>Note, that we have other (non-dynamic tests), were comm_set is called
<br>
...
<p>Edgar
<br>
<p><p><p>On 7/13/2010 8:42 PM, Ralph Castain wrote:
<br>
...
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13703/signature.asc">OpenPGP digital signature</a>
</ul>
