...
?>
<!-- received="Wed Jul 14 11:28:52 2010" -->
<!-- isoreceived="20100714152852" -->
<!-- sent="Wed, 14 Jul 2010 08:28:45 -0700 (PDT)" -->
<!-- isosent="20100714152845" -->
<!-- name="Robert Walters" -->
<!-- email="raw19896_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI Hangs, No Error" -->
<!-- id="604928.66255.qm_at_web80806.mail.mud.yahoo.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2010-07-14 11:28:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13635.php">Eugene Loh: "[OMPI users] LS-DYNA profiling [was: OpenMPI Hangs, No Error]"</a>
<li><strong>Previous message:</strong> <a href="13633.php">Ralph Castain: "Re: [OMPI users] Killing openmpi job via programming language"</a>
<li><strong>Maybe in reply to:</strong> <a href="13484.php">Robert Walters: "[OMPI users] OpenMPI Hangs, No Error"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13635.php">Eugene Loh: "[OMPI users] LS-DYNA profiling [was: OpenMPI Hangs, No Error]"</a>
<li><strong>Reply:</strong> <a href="13635.php">Eugene Loh: "[OMPI users] LS-DYNA profiling [was: OpenMPI Hangs, No Error]"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
communication.
<br>
<p>Anyways, please have a look and let me know what 
...
Robert
 Walters
<br>
<p>--- On Tue, 7/13/10, Robert Walters &lt;raw19896_at_[hidden]&gt; wrote:
<br>
...
<br>
<p>Naturally, a forgotten attachment.
<br>
<p>An to edit that, it was compiled to be used with OpenMPI 1.4.1, but as I understand, 1.4.2 is just a bug fix of 1.4.1.
<br>
<p>--- On Tue, 7/13/10, Robert Walters &lt;raw19896_at_[hidden]&gt; wrote:
<br>
<p>From: Robert Walters &lt;raw19896_at_[hidden]&gt;
...
<br>
<p>I think I forgot to mention earlier that the application I am using is pre-compiled. It is a finite element software called LS-DYNA. It is not open source and I likely cannot obtain the code
 it uses for MPP. This version I am using was specifically compiled, by the parent company, for OpenMPI 1.4.2 MPP operations. 
<br>
<p>I recently installed the Sun Studio 12.1 to attempt to analyze the situation. It seems to work partially. It will record various processes individually, which is cryptic. The function it fails on, though, is the MPI Tracing. It errors that &quot;no MPI tracing data file in experiment, MPI Timeline and MPI Charts will not be available&quot;. Sometime during the analysis (about 10,000 iterations later, the VT_MAX_FLUSHES complains that there are too many i/o flushes and its not happy. I've increased this number in the environmental variable and killed the
 analysis before it had a chance to error but still no MPI Trace data is recorded. Not sure if you guys have heard of that happening or know any way to fix it...Did OpenMPI need to be configured/built for Sun Studio use?
<br>
...
<br>
I blacked out items that are related to LS-DYNA but afterward I just realized that I think every function with
...
<br>
<p>I would like to make one last mention. That is that OpenMPI running 8 cores on a single node, with all the
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13634/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/users/att-13634/sungraph.jpg" alt="sungraph.jpg">
<!-- attachment="sungraph.jpg" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
