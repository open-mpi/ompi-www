<?
$subject_val = "Re: [OMPI users] MPI process dies with a route error when usingdynamic process calls to connect more than 2 clients to aserver with InfiniBand";
include("../../include/msg-header.inc");
?>
<!-- received="Thu Jul 22 20:22:14 2010" -->
<!-- isoreceived="20100723002214" -->
<!-- sent="Thu, 22 Jul 2010 20:22:51 -0400" -->
<!-- isosent="20100723002251" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI process dies with a route error when usingdynamic process calls to connect more than 2 clients to aserver with InfiniBand" -->
<!-- id="A1524DF0-19DF-4C9E-9B46-A41E86765DB7_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="3E2411E2-5BC2-4D62-9DFA-09530ED1BDF6_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] MPI process dies with a route error when usingdynamic process calls to connect more than 2 clients to aserver with InfiniBand<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-07-22 20:22:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13760.php">Jeff Squyres: "Re: [OMPI users] OpenMPI killed by signal 9"</a>
<li><strong>Previous message:</strong> <a href="13758.php">Jack Bryan: "[OMPI users] OpenMPI killed by signal 9"</a>
<li><strong>In reply to:</strong> <a href="13754.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13786.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>No specific timeline on 1.5.1 yet, though.
<br>
<p><p>On Jul 22, 2010, at 5:53 PM, Ralph Castain wrote:
<br>
<p><span class="quotelev1">&gt; Dev trunk looks okay right now - I think you'll be fine using it. My new component -might- work with 1.5, but probably not with 1.4. I haven't checked either of them.
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On Jul 22, 2010, at 6:48 AM, Philippe wrote:
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; On Wed, Jul 21, 2010 at 10:44 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; the short answer is yes... although, the longer answer is a bit more
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; complicated. currently I do know the number of connect I need to do on
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; a per-port basis. a job can contains an arbitrary number of MPI
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; processes, each opening one or more ports. so i know the count port by
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; ports but I dont need to worry about how many MPI processes there is
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; globally. to make things a bit more complicated, each MPI operator can
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; be &quot;fused&quot; with other operators to make a process. each fused operator
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; may or may not require MPI. the bottom line is, to get the total
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; number of processes to calculate rank&amp;size, I need to reverse engineer
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; the fusing that the compiler may do.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; but that's ok, I'm willing to do that for our prototype :-)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt; &gt;&gt;&gt; that would be great. I can definitely pass environment variables to
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; each process.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt; &gt;&gt;&gt; i think for our prototype we are fine with the first method. I'd leave
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; the cleaner implementation as a task for the product team ;-)
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; regarding the &quot;generic&quot; module, is that something you can put together
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; quickly? can I help in any way?
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Either way would work. The second is more scalable, but I don't know if you have (or can construct) the map info.
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;   [node003:32274] [[37084,0],0]:route_callback tried routing message
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - server open port
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - server does accept
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - client #1 does connect
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - server and client #1 do merge
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - server does accept
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - client #2 does connect
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - server, client #1 and client #2 do merge
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - server does accept
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - client #3 does connect
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;     - server, client #1, client #2 and client #3 do merge
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    openMPI version = 1.4.1 (I also tried 1.4.2, nightly snapshot of
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; 1.4.3, nightly snapshot of 1.5 --- all show the same error)
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    config.log in the tarball
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    &quot;ompi_info --all&quot; in the tarball
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    OFED version = 1.3 installed from RHEL 5.3
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    Distro = RedHat Entreprise Linux 5.3
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    Kernel = 2.6.18-128.4.1.el5 x86_64
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    subnet manager = built-in SM from the cisco/topspin switch
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    output of ibv_devinfo included in the tarball (there are no &quot;bad&quot; nodes)
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;    &quot;ulimit -l&quot; says &quot;unlimited&quot;
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;   - ben12.c: my test program showing the behavior
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;   - config.log / config.out / make.out / make-install.out /
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ifconfig.txt / ibv-devinfo.txt / ompi_info.txt
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;   - trace-tcp.txt: output of the server and each client when it works
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; with TCP (I added &quot;btl = tcp,self&quot; in ~/.openmpi/mca-params.conf)
</span><br>
<span class="quotelev2">&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;   - trace-ib.txt: output of the server and each client when it fails
</span><br>
