...
?>
<!-- received="Mon Jul 12 09:56:17 2010" -->
<!-- isoreceived="20100712135617" -->
<!-- sent="Mon, 12 Jul 2010 07:56:02 -0600" -->
<!-- isosent="20100712135602" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept" -->
<!-- id="DC3511D4-E260-4C00-973B-B7F4435EAFD2_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AANLkTikrTJvrfHdArwBNSh0Z8hxe4Au0h9vYonvnzT1f_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-12 09:56:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13590.php">Brian Budge: "Re: [OMPI users] Dynamic process tutorials?"</a>
<li><strong>Previous message:</strong> <a href="13588.php">Shiqing Fan: "Re: [OMPI users] Install OpenMPI on Win 7 machine"</a>
<li><strong>In reply to:</strong> <a href="13586.php">Grzegorz Maj: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13598.php">Grzegorz Maj: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>Reply:</strong> <a href="13598.php">Grzegorz Maj: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I have no idea who or why this was done, but somebody set a limit of 64 separate jobids in the dynamic init called by ompi_comm_set, which builds the intercommunicator. Unfortunately, they hard-wired the array size, but never check that size before adding to it.
<br>
<p>So after 64 calls to connect_accept, you are overwriting other areas of the code. As you found, hitting 66 causes it to segfault.
<br>
<p>I'll fix this on the developer's trunk (I'll also add that original patch to it). Rather than my searching this thread in detail, can you remind me what version you are using so I can patch it too?
<br>
<p>Thanks for your patience with this!
<br>
Ralph
<br>
<p><p>On Jul 12, 2010, at 7:20 AM, Grzegorz Maj wrote:
<br>
<p><span class="quotelev1">&gt; 1024 is not the problem: changing it to 2048 hasn't change anything.
</span><br>
