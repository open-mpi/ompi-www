...
?>
<!-- received="Tue Jul 20 00:51:25 2010" -->
<!-- isoreceived="20100720045125" -->
<!-- sent="Mon, 19 Jul 2010 22:51:15 -0600" -->
<!-- isosent="20100720045115" -->
<!-- name="Ralph Castain" -->
...
<!-- id="593E4202-7A5F-406F-AD8E-42554E841F3B_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2010-07-20 00:51:15
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13711.php">Anton Shterenlikht: "[OMPI users] does OpenMPI 1.3.2 support MPI 2.2 standard?"</a>
<li><strong>Previous message:</strong> <a href="13709.php">Jed Brown: "Re: [OMPI users] Ok, I've got OpenMPI set up, now what?!"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13719.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>Reply:</strong> <a href="13719.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On the notion of integrating OMPI to your launch environment: remember that we don't necessarily require that you use mpiexec for that purpose. If your launch environment provides just a little info in the environment of the launched procs, we can usually devise a method that allows the procs to perform an MPI_Init as a single job without all this work you are doing.
<br>
<p>Only difference is that your procs will all block in MPI_Init until they -all- have executed that function. If that isn't a problem, this would be a much more scalable and reliable method than doing it thru massive calls to MPI_Port_connect.
<br>
<p><p>On Jul 18, 2010, at 4:09 PM, Philippe wrote:
<br>
