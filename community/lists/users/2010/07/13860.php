...
?>
<!-- received="Wed Jul 28 19:47:34 2010" -->
<!-- isoreceived="20100728234734" -->
<!-- sent="Wed, 28 Jul 2010 18:47:09 -0500" -->
<!-- isosent="20100728234709" -->
<!-- name="David Akin" -->
<!-- email="nospamou_at_[hidden]" -->
<!-- subject="[OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core" -->
<!-- id="AANLkTim2O9rsSnVLZ+Pj07hkynCgy65cPgAwByYb0A9g_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-28 19:47:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13861.php">David Akin: "[OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<li><strong>Previous message:</strong> <a href="13859.php">Rahul Nabar: "[OMPI users] MPI broadcast test fails only when I run within a torque job"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/08/13913.php">Eugene Loh: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/08/13913.php">Eugene Loh: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>&nbsp;/usr/mpi/gcc/openmpi-1.4/bin/mpirun -host c005,c006 -np 2 -rf
<br>
