...
?>
<!-- received="Wed Jul 28 18:04:52 2010" -->
<!-- isoreceived="20100728220452" -->
<!-- sent="Wed, 28 Jul 2010 18:04:04 -0400" -->
<!-- isosent="20100728220404" -->
<!-- name="Cristobal Navarro" -->
<!-- email="axischire_at_[hidden]" -->
<!-- subject="Re: [OMPI users] openMPI shared with NFS, but says different version" -->
<!-- id="AANLkTinPoBRzM3sv8sOxxB2LHS9TocffbN3MZG2FOwCu_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="4C50A637.80507_at_ldeo.columbia.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-28 18:04:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13857.php">Martin Siegert: "[OMPI users] Alignment of Fortran variables with ifort"</a>
<li><strong>Previous message:</strong> <a href="13855.php">Gus Correa: "Re: [OMPI users] openMPI shared with NFS, but says different version"</a>
<li><strong>In reply to:</strong> <a href="13855.php">Gus Correa: "Re: [OMPI users] openMPI shared with NFS, but says different version"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13858.php">Gus Correa: "Re: [OMPI users] openMPI shared with NFS, but says different version"</a>
<li><strong>Reply:</strong> <a href="13858.php">Gus Correa: "Re: [OMPI users] openMPI shared with NFS, but says different version"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
GNU/Linux
<br>
<p>at least for the moment i will use this configuration, at least for
<br>
deveplopment/testing  of the parallel programs.
<br>
lag is minimum :)
<br>
<p>whenever i get another kernel update, i will test again to check if sm
<br>
works, would be good to know that suddenly another distribution supports
<br>
nehalem sm.
<br>
<p>best regards and thanks again
<br>
Cristobal
<br>
ps: guess what are the names of the other 2 nodes lol
<br>
<p><p><p>On Wed, Jul 28, 2010 at 5:50 PM, Gus Correa &lt;gus_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev2">&gt;&gt; On Wed, Jul 28, 2010 at 3:28 PM, Gus Correa &lt;gus_at_[hidden]&lt;mailto:
</span><br>
...
<span class="quotelev2">&gt;&gt; flags : fpu vme de pse tsc msr pae mce cx8 apic sep mtrr pge mca cmov pat
</span><br>
<span class="quotelev2">&gt;&gt; pse36 clflush dts acpi mmx fxsr sse sse2 ss h
</span><br>
<span class="quotelev2">&gt;&gt; t tm pbe syscall nx rdtscp lm constant_tsc arch_perfmon pebs bts rep_good
</span><br>
<span class="quotelev2">&gt;&gt; xtopology nonstop_tsc aperfmperf pni dtes64 monitor ds_
</span><br>
<span class="quotelev2">&gt;&gt; cpl vmx est tm2 ssse3 cx16 xtpr pdcm dca sse4_1 sse4_2 popcnt lahf_lm ida
</span><br>
<span class="quotelev2">&gt;&gt; tpr_shadow vnmi flexpriority ept vpid
</span><br>
...
<span class="quotelev2">&gt;&gt;    If I remember right, the old hyperthreading on old Xeons was
</span><br>
...
<span class="quotelev2">&gt;&gt;    relatively new Xeon Nehalem machine with (the new) Hyperthreading
</span><br>
...
<span class="quotelev2">&gt;&gt; --i foudn the archives recently about an hour ago, was not sure if it was
</span><br>
<span class="quotelev2">&gt;&gt; the same problem but i removed HT for testing with setting the online flag
</span><br>
<span class="quotelev2">&gt;&gt; to 0 on the extra cpus showed with lstopo, unfortenately i also crashes, so
</span><br>
<span class="quotelev2">&gt;&gt; HT may not be the problem.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; although it was FC13, and I don't know what OS and kernel you're using.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;     Apparently other people got everything (OpenMPI with HT on Nehalem)
</span><br>
...
<span class="quotelev2">&gt;&gt;        and somepart it mentions a certain CPU X, where that cpu can be
</span><br>
<span class="quotelev2">&gt;&gt;        any from 0 to 15 (im testing only in main node).  Someone knows
</span><br>
...
<span class="quotelev2">&gt;&gt;    In any case, depending on the application, it may not help much
</span><br>
...
<span class="quotelev2">&gt;&gt; wow!, this worked really :),  you pointed out the problem, it was shared
</span><br>
...
<span class="quotelev1">&gt; Over a year ago another fellow reported the same problem on Nehalem,
</span><br>
...
<span class="quotelev1">&gt;  i have 4 nodes, so anyways there will be node comunication, do you think i
</span><br>
<span class="quotelev2">&gt;&gt; can rely on working with -mca btl tcp,self?? i dont mind small lag.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev1">&gt; Some people reported everything works with OpenMPI+HT+sm in CentOS and
</span><br>
<span class="quotelev1">&gt; RHEL, see the thread I mentioned in the archives from 1-2 months ago.
</span><br>
<span class="quotelev1">&gt; I don't administer that machine, and didn't have the time to do OS
</span><br>
...
<span class="quotelev1">&gt;  i just have one more question, is this a problem of the ubuntu server
</span><br>
<span class="quotelev2">&gt;&gt; kernel?? from the Nehalem Cpus?? from openMPI (i dont think) ??
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Currently that machine has kernel 2.6.33.6-147.fc13.x86_64 #1 SMP.
</span><br>
<span class="quotelev1">&gt; However, it may have been a slightly older kernel when I installed
</span><br>
<span class="quotelev1">&gt; OpenMPI there.
</span><br>
<span class="quotelev1">&gt; It may have been 2.6.33.5-124.fc13.x86_64 or 2.6.32.14-127.fc12.x86_64.
</span><br>
...
<span class="quotelev1">&gt;  and on what depends that in the future, sm could be possible on the same
</span><br>
<span class="quotelev2">&gt;&gt; configuration i have?? kernel update?.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev1">&gt; You may want to try CentOS or RHEL, but I can't guarantee the results.
</span><br>
...
<span class="quotelev2">&gt;&gt;               --&gt; i will try only with the head node, and post results
</span><br>
...
<span class="quotelev2">&gt;&gt;               no we are just using normal network 100MBit/s , since i
</span><br>
...
<span class="quotelev2">&gt;&gt;               --&gt; i agree, somewhere there must be the remains of the
</span><br>
...
<span class="quotelev2">&gt;&gt;                  Did you configure/build OpenMPI from source, or did
</span><br>
...
<span class="quotelev2">&gt;&gt;                  the command line, because it will be effective only on
</span><br>
...
<span class="quotelev2">&gt;&gt;                  on your .bashrc/.cshrc files (assuming these files and
</span><br>
<span class="quotelev2">&gt;&gt;        your home
</span><br>
<span class="quotelev2">&gt;&gt;                  directory are *also* shared with the nodes via NFS),
</span><br>
<span class="quotelev2">&gt;&gt;                  or use the --prefix option of mpiexec to point to the
</span><br>
...
<span class="quotelev2">&gt;&gt;                  Needless to say, you need to check and ensure that the
</span><br>
<span class="quotelev2">&gt;&gt;        OpenMPI
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13856/attachment">attachment</a>
</ul>
