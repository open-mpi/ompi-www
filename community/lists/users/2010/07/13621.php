...
?>
<!-- received="Tue Jul 13 09:05:44 2010" -->
<!-- isoreceived="20100713130544" -->
<!-- sent="Tue, 13 Jul 2010 06:57:35 -0600" -->
<!-- isosent="20100713125735" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept" -->
<!-- id="009D7B0F-4829-4A42-AEE9-744F208AF6F6_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AANLkTilZjDJd-qWAOHbu8SozQHsuglBjHrCQxLzrJuo0_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-13 08:57:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13622.php">Alexandru Blidaru: "Re: [OMPI users] Install OpenMPI on Win 7 machine"</a>
<li><strong>Previous message:</strong> <a href="13620.php">Reuti: "Re: [OMPI users] OpenMPI load data to multiple nodes"</a>
<li><strong>In reply to:</strong> <a href="13619.php">Grzegorz Maj: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13627.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>Reply:</strong> <a href="13627.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; Bad news..
</span><br>
...
<p>It isn't directly called - it shows in ompi_comm_set as ompi_dpm.mark_dyncomm. You were definitely overrunning that array, but I guess something else is also being hit. Have to look further...
<br>
