...
?>
<!-- received="Tue Jul 13 22:42:33 2010" -->
<!-- isoreceived="20100714024233" -->
<!-- sent="Tue, 13 Jul 2010 19:42:27 -0700 (PDT)" -->
<!-- isosent="20100714024227" -->
<!-- name="Robert Walters" -->
<!-- email="raw19896_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI Hangs, No Error" -->
<!-- id="725121.1653.qm_at_web80801.mail.mud.yahoo.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2010-07-13 22:42:27
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13631.php">Eloi Gaudry: "Re: [OMPI users] [openib] segfault when using openib btl"</a>
<li><strong>Previous message:</strong> <a href="13629.php">Robert Walters: "Re: [OMPI users] OpenMPI Hangs, No Error"</a>
<li><strong>Maybe in reply to:</strong> <a href="13484.php">Robert Walters: "[OMPI users] OpenMPI Hangs, No Error"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13634.php">Robert Walters: "Re: [OMPI users] OpenMPI Hangs, No Error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I think I forgot to mention earlier that the application I am using is pre-compiled. It is a finite element software called LS-DYNA. It is not open source and I likely cannot obtain the code it uses for MPP. This version I am using was specifically compiled, by the parent company, for OpenMPI 1.4.2 MPP operations. 
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13630/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/users/att-13630/usage.jpg" alt="usage.jpg">
<!-- attachment="usage.jpg" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
