...
?>
<!-- received="Thu Jul  8 11:15:45 2010" -->
<!-- isoreceived="20100708151545" -->
<!-- sent="Thu, 08 Jul 2010 11:15:35 -0400" -->
<!-- isosent="20100708151535" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] configure options" -->
<!-- id="4C35EB97.90505_at_ldeo.columbia.edu" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="201007081044010003930_at_nd.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-08 11:15:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13544.php">Zhigang Wei: "Re: [OMPI users] configure options"</a>
<li><strong>Previous message:</strong> <a href="13542.php">Zhigang Wei: "Re: [OMPI users] configure options"</a>
<li><strong>In reply to:</strong> <a href="13542.php">Zhigang Wei: "Re: [OMPI users] configure options"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13544.php">Zhigang Wei: "Re: [OMPI users] configure options"</a>
<li><strong>Reply:</strong> <a href="13544.php">Zhigang Wei: "Re: [OMPI users] configure options"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Zhigang
<br>
<p>So, did setting the LD_LIBRARY_PATH work?
<br>
<p>**
<br>
<p>I don't add many options to the OpenMPI configure,
<br>
besides --prefix.
<br>
...
and that works.
<br>
<p>Since you are using OpenMPI in your university HPC computer,
<br>
...
<br>
<p>Do ./configure --help for a list of options.
<br>
<p>Also, consult the OpenMPI FAQ, which is the best resource to answer
<br>
many of your questions:
<br>
<a href="http://www.open-mpi.org/faq/">http://www.open-mpi.org/faq/</a>
<br>
<p>One way to check what configuration options OpenMPI is really using,
<br>
