...
?>
<!-- received="Mon Jul 26 23:47:47 2010" -->
<!-- isoreceived="20100727034747" -->
<!-- sent="Mon, 26 Jul 2010 21:47:37 -0600" -->
<!-- isosent="20100727034737" -->
<!-- name="Ralph Castain" -->
...
<!-- id="69F23B5B-EDD7-4EF7-9329-A0A37463A4FD_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AANLkTimhJJnP8LYa8H5YBkxB6nbzLFEpaNxYuV=nnt1S_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-26 23:47:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13788.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>Previous message:</strong> <a href="13786.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>In reply to:</strong> <a href="13786.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13788.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>Reply:</strong> <a href="13788.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Thanks!
<br>
<p>On Jul 26, 2010, at 9:28 PM, Philippe wrote:
<br>
...
<span class="quotelev1">&gt;    /* only pick us if directed to do so */
</span><br>
<span class="quotelev1">&gt;    if (NULL != (pick = getenv(&quot;OMPI_MCA_env&quot;)) &amp;&amp;
</span><br>
<span class="quotelev1">&gt;                 0 == strcmp(pick, &quot;generic&quot;)) {
</span><br>
<span class="quotelev1">&gt;        *priority = 1000;
</span><br>
<span class="quotelev1">&gt;        *module = (mca_base_module_t *)&amp;orte_ess_generic_module;
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; ...
...
<span class="quotelev4">&gt;&gt;&gt;&gt; * OMPI_MCA_oob_tcp_static_ports=6000-6010  &lt;== obviously, replace this with your range
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jul 22, 2010, at 6:48 AM, Philippe wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Wed, Jul 21, 2010 at 10:44 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
