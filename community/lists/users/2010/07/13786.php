...
?>
<!-- received="Mon Jul 26 23:28:40 2010" -->
<!-- isoreceived="20100727032840" -->
<!-- sent="Mon, 26 Jul 2010 23:28:35 -0400" -->
<!-- isosent="20100727032835" -->
<!-- name="Philippe" -->
...
<!-- id="AANLkTimhJJnP8LYa8H5YBkxB6nbzLFEpaNxYuV=nnt1S_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2010-07-26 23:28:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13787.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>Previous message:</strong> <a href="13785.php">Hugo Gagnon: "[OMPI users] MPI_Allreduce on local machine"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13787.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>Reply:</strong> <a href="13787.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>i was able to test the generic module and it seems to be working.
<br>
<p>one question tho, the function orte_ess_generic_component_query in
<br>
...
<p>.....
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;/* only pick us if directed to do so */
<br>
...
<p>p.
<br>
<p>On Thu, Jul 22, 2010 at 5:53 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev3">&gt;&gt;&gt; * OMPI_MCA_oob_tcp_static_ports=6000-6010 &#194;&#160;&lt;== obviously, replace this with your range
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
