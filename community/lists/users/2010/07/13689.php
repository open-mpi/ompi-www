...
?>
<!-- received="Sat Jul 17 23:47:33 2010" -->
<!-- isoreceived="20100718034733" -->
<!-- sent="Sat, 17 Jul 2010 21:47:24 -0600" -->
<!-- isosent="20100718034724" -->
<!-- name="Ralph Castain" -->
...
<!-- id="1BA70AF7-5000-4C04-9065-B7FAF4E90E48_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2010-07-17 23:47:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13690.php">Damien: "Re: [OMPI users] Ok, I've got OpenMPI set up, now what?!"</a>
<li><strong>Previous message:</strong> <a href="13688.php">Daniel Janzon: "[OMPI users] Ok, I've got OpenMPI set up, now what?!"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13694.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>Reply:</strong> <a href="13694.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>The program is crashing in the communicator definition, which involves a communication over our internal out-of-band messaging system. That system has zero connection to any BTL, so it should crash either way.
<br>
<p>Regardless, I will play with this a little as time allows. Thanks for the reproducer!
<br>
