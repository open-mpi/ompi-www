...
?>
<!-- received="Mon Jul 12 09:20:45 2010" -->
<!-- isoreceived="20100712132045" -->
<!-- sent="Mon, 12 Jul 2010 15:20:39 +0200" -->
<!-- isosent="20100712132039" -->
<!-- name="Grzegorz Maj" -->
<!-- email="maju3_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept" -->
<!-- id="AANLkTikrTJvrfHdArwBNSh0Z8hxe4Au0h9vYonvnzT1f_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="3EFA5CEA-AA6E-49BD-9028-8347450AAB24_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-12 09:20:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13587.php">Alexandru Blidaru: "Re: [OMPI users] Install OpenMPI on Win 7 machine"</a>
<li><strong>Previous message:</strong> <a href="13585.php">jody: "Re: [OMPI users] OpenMPI how large its buffer size ?"</a>
<li><strong>In reply to:</strong> <a href="13509.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13589.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>Reply:</strong> <a href="13589.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>What's more: when I've added a breakpoint on ompi_comm_set in 66th
<br>
...
<br>
<p>Finally I decided to recompile openmpi using -g flag for gcc. In this
<br>
...
<br>
<p>Any ideas? I'm really confused.
<br>
<p><p><p>2010/7/7 Ralph Castain &lt;rhc_at_[hidden]&gt;:
<br>
