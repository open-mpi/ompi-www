...
?>
<!-- received="Thu Jul 22 17:22:32 2010" -->
<!-- isoreceived="20100722212232" -->
<!-- sent="Thu, 22 Jul 2010 17:22:26 -0400" -->
<!-- isosent="20100722212226" -->
<!-- name="Philippe" -->
...
<!-- id="AANLkTilhjJaMK2YrRR1KM16ezt2zy5KfGoNJnkCF9KjF_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="64C8D681-6B0E-4EFE-BE34-320E9E0C3417_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-22 17:22:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13752.php">amjad ali: "Re: [OMPI users] Help on the big picture.."</a>
<li><strong>Previous message:</strong> <a href="13750.php">Cristobal Navarro: "Re: [OMPI users] Help on the big picture.."</a>
<li><strong>In reply to:</strong> <a href="13749.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13754.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>Reply:</strong> <a href="13754.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Thank you so much!!
<br>
<p>I'll give it a try and let you know.
<br>
<p>I know it's a tough question, but how stable is the dev trunk? Can I
<br>
...
<p>p.
<br>
<p>On Thu, Jul 22, 2010 at 3:50 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; * OMPI_MCA_oob_tcp_static_ports=6000-6010 &#194;&#160;&lt;== obviously, replace this with your range
</span><br>
<span class="quotelev1">&gt;
</span><br>
