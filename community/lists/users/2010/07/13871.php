...
?>
<!-- received="Thu Jul 29 12:43:54 2010" -->
<!-- isoreceived="20100729164354" -->
<!-- sent="Thu, 29 Jul 2010 11:43:29 -0500" -->
<!-- isosent="20100729164329" -->
<!-- name="David Akin" -->
<!-- email="nospamou_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core" -->
<!-- id="AANLkTi=GqALH+0iCxxcoR0wShqBSEF+B0KoJfu521mvA_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="4C519973.1050702_at_oracle.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-29 12:43:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13872.php">Terry Dontje: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<li><strong>Previous message:</strong> <a href="13870.php">Terry Dontje: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<li><strong>In reply to:</strong> <a href="13870.php">Terry Dontje: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13872.php">Terry Dontje: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<li><strong>Reply:</strong> <a href="13872.php">Terry Dontje: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<li><strong>Reply:</strong> <a href="13873.php">Ralph Castain: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On Thu, Jul 29, 2010 at 10:08 AM, Terry Dontje &lt;terry.dontje_at_[hidden]&gt;wrote:
<br>
...
<span class="quotelev1">&gt;  Sorry I did not get that constraint.  So to be clear what is being asked
</span><br>
<span class="quotelev1">&gt; is to have the ability to bind a processes threads to specific cores.  If so
</span><br>
<span class="quotelev1">&gt; then to the letter of what that means I agree you cannot do that.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; However, what may be the next best thing is to specify binding of a process
</span><br>
<span class="quotelev1">&gt; to a group of resources.  That's essentially what my suggestion above is
</span><br>
<span class="quotelev1">&gt; doing.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; I do agree with Ralph that once you start overloading the socket with more
</span><br>
<span class="quotelev1">&gt; threads then it can handle problems will ensue.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13871/attachment">attachment</a>
</ul>
