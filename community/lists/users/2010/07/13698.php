...
?>
<!-- received="Mon Jul 19 09:57:17 2010" -->
<!-- isoreceived="20100719135717" -->
<!-- sent="Mon, 19 Jul 2010 07:57:08 -0600" -->
<!-- isosent="20100719135708" -->
<!-- name="Ralph Castain" -->
...
<!-- id="C4550C98-7F45-4C3B-BC83-B253FDF0EECF_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2010-07-19 09:57:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13699.php">Scott Atchley: "Re: [OMPI users] MPICH2 is working OpenMPI Not"</a>
<li><strong>Previous message:</strong> <a href="13697.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13710.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
I'm wondering if we can't make this simpler. What launch environment are you operating under? I know you said you can't use mpiexec, but I'm wondering if we could add support for your environment to mpiexec so you could.
<br>
