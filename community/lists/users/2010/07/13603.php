...
?>
<!-- received="Mon Jul 12 15:34:08 2010" -->
<!-- isoreceived="20100712193408" -->
<!-- sent="Mon, 12 Jul 2010 13:33:56 -0600" -->
<!-- isosent="20100712193356" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept" -->
<!-- id="29DF1FA9-4399-4847-94B5-C5384AD8AE9A_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AANLkTinKAaMv4qRgzccKJAFOgyVn-xjjvJwhV1pMo28t_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-12 15:33:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13604.php">Ralph Castain: "Re: [OMPI users] Dynamic process tutorials?"</a>
<li><strong>Previous message:</strong> <a href="13602.php">Trent Creekmore: "Re: [OMPI users] Install OpenMPI on Win 7 machine"</a>
<li><strong>In reply to:</strong> <a href="13598.php">Grzegorz Maj: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13619.php">Grzegorz Maj: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>Reply:</strong> <a href="13619.php">Grzegorz Maj: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><p>
<p><p>On Jul 12, 2010, at 12:13 PM, Grzegorz Maj wrote:
<br>
<p><span class="quotelev1">&gt; 2010/7/12 Ralph Castain &lt;rhc_at_[hidden]&gt;:
</span><br>
...
<p><p><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13603/dpm.diff">dpm.diff</a>
</ul>
<!-- attachment="dpm.diff" -->
<!-- body="end" -->
<hr>
