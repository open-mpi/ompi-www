...
?>
<!-- received="Thu Jul 22 15:50:47 2010" -->
<!-- isoreceived="20100722195047" -->
<!-- sent="Thu, 22 Jul 2010 13:50:36 -0600" -->
<!-- isosent="20100722195036" -->
<!-- name="Ralph Castain" -->
...
<!-- id="64C8D681-6B0E-4EFE-BE34-320E9E0C3417_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AANLkTikoXZ_pgRql6FznrNOTpgf_jK1vZC6lGQXlkvaX_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-22 15:50:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13750.php">Cristobal Navarro: "Re: [OMPI users] Help on the big picture.."</a>
<li><strong>Previous message:</strong> <a href="13748.php">Gus Correa: "Re: [OMPI users] Help on the big picture.."</a>
<li><strong>In reply to:</strong> <a href="13743.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13751.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>Reply:</strong> <a href="13751.php">Philippe: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I will commit it this evening (couple of hours from now) as that is our standard practice. You'll need to use the developer's trunk, though, to use it.
<br>
<p>Here are the envars you'll need to provide:
<br>
<p>Each process needs to get the same following values:
<br>
<p>* OMPI_MCA_ess=generic
<br>
...
<br>
<p>Note that I have assumed this last value is a constant for simplicity. If that isn't the case, let me know - you could instead provide it as a comma-separated list of values with an entry for each node.
<br>
<p>In addition, you need to provide the following value that will be unique to each process:
<br>
<p>* OMPI_MCA_orte_rank=&lt;MPI rank&gt;
<br>
<p>Finally, you have to provide a range of static TCP ports for use by the processes. Pick any range that you know will be available across all the nodes. You then need to ensure that each process sees the following envar:
<br>
<p>* OMPI_MCA_oob_tcp_static_ports=6000-6010  &lt;== obviously, replace this with your range
<br>
<p>You will need a port range that is at least equal to the ppn for the job (each proc on a node will take one of the provided ports).
<br>
<p>That should do it. I compute everything else I need from those values.
<br>
<p>Does that work for you?
<br>
Ralph
<br>
<p><p>On Jul 22, 2010, at 6:48 AM, Philippe wrote:
<br>
<p><span class="quotelev1">&gt; On Wed, Jul 21, 2010 at 10:44 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On Jul 21, 2010, at 7:44 AM, Philippe wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Sorry for the late reply -- I was away on vacation.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; no problem at all!
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; regarding your earlier question about how many processes where
</span><br>
<span class="quotelev3">&gt;&gt;&gt; involved when the memory was entirely allocated, it was only two, a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; sender and a receiver. I'm still trying to pinpoint what can be
</span><br>
<span class="quotelev3">&gt;&gt;&gt; different between the standalone case and the &quot;integrated&quot; case. I
</span><br>
<span class="quotelev3">&gt;&gt;&gt; will try to find out what part of the code is allocating memory in a
</span><br>
<span class="quotelev3">&gt;&gt;&gt; loop.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; hmmm....that sounds like a bug in your program. let me know what you find
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, Jul 20, 2010 at 12:51 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Well, I finally managed to make this work without the required ompi-server rendezvous point. The fix is only in the devel trunk right now - I'll have to ask the release managers for 1.5 and 1.4 if they want it ported to those series.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; great -- i'll give it a try
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On the notion of integrating OMPI to your launch environment: remember that we don't necessarily require that you use mpiexec for that purpose. If your launch environment provides just a little info in the environment of the launched procs, we can usually devise a method that allows the procs to perform an MPI_Init as a single job without all this work you are doing.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I'm working on creating operators using MPI for the IBM product
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &quot;InfoSphere Streams&quot;. It has its own launching mechanism to start the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; processes. However I can pass some information to the processes that
</span><br>
<span class="quotelev3">&gt;&gt;&gt; belong to the same job (Streams job -- which should neatly map to MPI
</span><br>
<span class="quotelev3">&gt;&gt;&gt; job).
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Only difference is that your procs will all block in MPI_Init until they -all- have executed that function. If that isn't a problem, this would be a much more scalable and reliable method than doing it thru massive calls to MPI_Port_connect.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; in the general case, that would be a problem, but for my prototype,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; this is acceptable.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; In general, each process is composed of operators, some may be MPI
</span><br>
<span class="quotelev3">&gt;&gt;&gt; related and some may not. But in my case, I know ahead of time which
</span><br>
<span class="quotelev3">&gt;&gt;&gt; processes will be part of the MPI job, so I can easily deal with the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; fact that they would block on MPI_init (actually -- MPI_thread_init
</span><br>
<span class="quotelev3">&gt;&gt;&gt; since its using a lot of threads).
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; We have talked in the past about creating a non-blocking MPI_Init as an extension to the standard. It would lock you to Open MPI, though...
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Regardless, at some point you would have to know how many processes are going to be part of the job so you can know when MPI_Init is complete. I would think you would require that info for the singleton wireup anyway - yes? Otherwise, how would you know when to quit running connect-accept?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; the short answer is yes... although, the longer answer is a bit more
</span><br>
<span class="quotelev1">&gt; complicated. currently I do know the number of connect I need to do on
</span><br>
<span class="quotelev1">&gt; a per-port basis. a job can contains an arbitrary number of MPI
</span><br>
<span class="quotelev1">&gt; processes, each opening one or more ports. so i know the count port by
</span><br>
<span class="quotelev1">&gt; ports but I dont need to worry about how many MPI processes there is
</span><br>
<span class="quotelev1">&gt; globally. to make things a bit more complicated, each MPI operator can
</span><br>
<span class="quotelev1">&gt; be &quot;fused&quot; with other operators to make a process. each fused operator
</span><br>
<span class="quotelev1">&gt; may or may not require MPI. the bottom line is, to get the total
</span><br>
<span class="quotelev1">&gt; number of processes to calculate rank&amp;size, I need to reverse engineer
</span><br>
<span class="quotelev1">&gt; the fusing that the compiler may do.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; but that's ok, I'm willing to do that for our prototype :-)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Is there a documentation or example I can use to see what information
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I can pass to the processes to enable that? Is it just environment
</span><br>
<span class="quotelev3">&gt;&gt;&gt; variables?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; No real documentation - a lack I should probably fill. At the moment, we don't have a &quot;generic&quot; module for standalone launch, but I can create one as it is pretty trivial. I would then need you to pass each process envars telling it the total number of processes in the MPI job, its rank within that job, and a file where some rendezvous process (can be rank=0) has provided that port string. Armed with that info, I can wireup the job.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Won't be as scalable as an mpirun-initiated startup, but will be much better than doing it from singletons.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; that would be great. I can definitely pass environment variables to
</span><br>
<span class="quotelev1">&gt; each process.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Or if you prefer, we could setup an &quot;infosphere&quot; module that we could customize for this system. Main thing here would be to provide us with some kind of regex (or access to a file containing the info) that describes the map of rank to node so we can construct the wireup communication pattern.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; i think for our prototype we are fine with the first method. I'd leave
</span><br>
<span class="quotelev1">&gt; the cleaner implementation as a task for the product team ;-)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; regarding the &quot;generic&quot; module, is that something you can put together
</span><br>
<span class="quotelev1">&gt; quickly? can I help in any way?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; Either way would work. The second is more scalable, but I don't know if you have (or can construct) the map info.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jul 18, 2010, at 4:09 PM, Philippe wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
