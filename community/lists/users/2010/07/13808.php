...
?>
<!-- received="Tue Jul 27 16:19:49 2010" -->
<!-- isoreceived="20100727201949" -->
...
<!-- id="4C4F3F58.6000004_at_oracle.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="1280259701.12833.99.camel_at_plato.home" -->
<!-- expires="-1" -->
<div class="center">
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13809.php">Cristobal Navarro: "[OMPI users] openMPI shared with NFS, but says different version"</a>
<li><strong>Previous message:</strong> <a href="13807.php">Gus Correa: "Re: [OMPI users] MPI_Allreduce on local machine"</a>
<li><strong>In reply to:</strong> <a href="13806.php">Brian Smith: "Re: [OMPI users] Processes stuck after MPI_Waitall() in 1.4.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13822.php">Terry Dontje: "Re: [OMPI users] Processes stuck after MPI_Waitall() in 1.4.1"</a>
<li><strong>Reply:</strong> <a href="13822.php">Terry Dontje: "Re: [OMPI users] Processes stuck after MPI_Waitall() in 1.4.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Brian Smith wrote:
<br>
<span class="quotelev1">&gt; Also, the application I'm having trouble with appears to work fine with
</span><br>
<span class="quotelev1">&gt; MVAPICH2 1.4.1, if that is any help.
</span><br>
...
<span class="quotelev1">&gt; On Tue, 2010-07-27 at 10:48 -0400, Terry Dontje wrote:
</span><br>
<span class="quotelev1">&gt;   
</span><br>
<span class="quotelev2">&gt;&gt; Can you try a simple point-to-point program?
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; After running on two processors across two nodes, the problem occurs
</span><br>
<span class="quotelev3">&gt;&gt;&gt; much earlier during execution:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (gdb) bt
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #0  opal_sys_timer_get_cycles ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; at ../opal/include/opal/sys/amd64/timer.h:46
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #1  opal_timer_base_get_cycles ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; at ../opal/mca/timer/linux/timer_linux.h:31
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #2  opal_progress () at runtime/opal_progress.c:181
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #3  0x00002b4bc3c00215 in opal_condition_wait (count=2,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; requests=0x7fff33372480, statuses=0x7fff33372450)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     at ../opal/threads/condition.h:99
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #4  ompi_request_default_wait_all (count=2, requests=0x7fff33372480,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; statuses=0x7fff33372450) at request/req_wait.c:262
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #5  0x00002b4bc3c915b7 in ompi_coll_tuned_sendrecv_actual
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (sendbuf=0x2aaad11dfaf0, scount=117692, 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     sdatatype=0x2b4bc3fa9ea0, dest=1, stag=-13, recvbuf=&lt;value optimized
</span><br>
<span class="quotelev3">&gt;&gt;&gt; out&gt;, rcount=117692, 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     rdatatype=0x2b4bc3fa9ea0, source=1, rtag=-13, comm=0x12cd98c0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; status=0x0) at coll_tuned_util.c:55
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #6  0x00002b4bc3c982db in ompi_coll_tuned_sendrecv (sbuf=0x2aaad10f9d10,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; scount=117692, sdtype=0x2b4bc3fa9ea0, 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     rbuf=0x2aaae104d010, rcount=117692, rdtype=0x2b4bc3fa9ea0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; comm=0x12cd98c0, module=0x12cda340)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     at coll_tuned_util.h:60
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #7  ompi_coll_tuned_alltoall_intra_two_procs (sbuf=0x2aaad10f9d10,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; scount=117692, sdtype=0x2b4bc3fa9ea0, 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     rbuf=0x2aaae104d010, rcount=117692, rdtype=0x2b4bc3fa9ea0,
...
<span class="quotelev3">&gt;&gt;&gt;     at coll_tuned_alltoall.c:432
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #8  0x00002b4bc3c1b71f in PMPI_Alltoall (sendbuf=0x2aaad10f9d10,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; sendcount=117692, sendtype=0x2b4bc3fa9ea0, 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     recvbuf=0x2aaae104d010, recvcount=117692, recvtype=0x2b4bc3fa9ea0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; comm=0x12cd98c0) at palltoall.c:84
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #9  0x00002b4bc399cc86 in mpi_alltoall_f (sendbuf=0x2aaad10f9d10 &quot;Z\n
</span><br>
<span class="quotelev3">&gt;&gt;&gt; \271\356\023\254\271?&quot;, sendcount=0x7fff33372688, 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     sendtype=&lt;value optimized out&gt;, recvbuf=0x2aaae104d010 &quot;&quot;,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; recvcount=0x7fff3337268c, recvtype=0xb67490, 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     comm=0x12d9d20, ierr=0x7fff33372690) at palltoall_f.c:76
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #10 0x00000000004613b8 in m_alltoall_z_ ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #11 0x00000000004ec55f in redis_pw_ ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #12 0x00000000005643d0 in choleski_mp_orthch_ ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #13 0x000000000043fbba in MAIN__ ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #14 0x000000000042f15c in main ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Tue, 2010-07-27 at 06:14 -0400, Terry Dontje wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   
</span><br>
<span class="quotelev3">&gt;&gt;&gt;       
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; A clarification from your previous email, you had your code working
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; with OMPI 1.4.1 but an older version of OFED?  Then you upgraded to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; OFED 1.4 and things stopped working?  Sounds like your current system
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is set up with OMPI 1.4.2 and OFED 1.5.  Anyways, I am a little
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; confused as to when things might have actually broke.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; My first guess would be something may be wrong with the OFED setup.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Have checked the status of your ib devices with ibv_devinfo?  Have you
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; ran any of the OFED rc tests like ibv_rc_pingpong?  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; If the above seems ok have you tried to run a simpler OMPI test like
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; connectivity?  I would see if a simple np=2 run spanning across two
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; nodes fails?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; What OS distribution and version you are running on?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --td
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Brian Smith wrote: 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13808/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/users/att-13808/02-part" alt="picture">
<!-- attachment="02-part" -->
<!-- body="end" -->
<hr>
<ul class="links">
