...
?>
<!-- received="Mon Jul 12 22:51:02 2010" -->
<!-- isoreceived="20100713025102" -->
<!-- sent="Tue, 13 Jul 2010 02:50:56 +0000" -->
<!-- isosent="20100713025056" -->
<!-- name="Bowen Zhou" -->
<!-- email="bwzhou_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI load data to multiple nodes" -->
<!-- id="SNT137-w14A629D293A35570AA0AC2D2B90_at_phx.gbl" -->
<!-- charset="gb2312" -->
<!-- inreplyto="SNT134-w6048768A7011AD6C507EACCBB90_at_phx.gbl" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-12 22:50:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13618.php">jody: "Re: [OMPI users] hpw to log output of spawned processes"</a>
<li><strong>Previous message:</strong> <a href="13616.php">Jack Bryan: "Re: [OMPI users] OpenMPI load data to multiple nodes"</a>
<li><strong>In reply to:</strong> <a href="13616.php">Jack Bryan: "Re: [OMPI users] OpenMPI load data to multiple nodes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13620.php">Reuti: "Re: [OMPI users] OpenMPI load data to multiple nodes"</a>
<li><strong>Reply:</strong> <a href="13620.php">Reuti: "Re: [OMPI users] OpenMPI load data to multiple nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Subject: Re: [OMPI users] OpenMPI load data to multiple nodes
<br>
<p><p><p><p><p><p><p><p>thanks very much !!!
<br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13617/attachment">attachment</a>
</ul>
