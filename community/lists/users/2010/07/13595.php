...
?>
<!-- received="Mon Jul 12 13:12:39 2010" -->
<!-- isoreceived="20100712171239" -->
<!-- sent="Mon, 12 Jul 2010 10:12:29 -0700" -->
<!-- isosent="20100712171229" -->
<!-- name="Brian Budge" -->
<!-- email="brian.budge_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic process tutorials?" -->
<!-- id="AANLkTinbkTeAuqvaxQAtcgHF_ClCe-yZLoh5kGU6S8jQ_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="9644A00A-4989-413D-97B9-78564D2EC972_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-12 13:12:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13596.php">Brian Budge: "Re: [OMPI users] Dynamic process tutorials?"</a>
<li><strong>Previous message:</strong> <a href="13594.php">Ralph Castain: "Re: [OMPI users] MPI process dies with a route error when using dynamic process calls to connect more than 2 clients to a server with InfiniBand"</a>
<li><strong>In reply to:</strong> <a href="13592.php">Ralph Castain: "Re: [OMPI users] Dynamic process tutorials?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13599.php">Ralph Castain: "Re: [OMPI users] Dynamic process tutorials?"</a>
<li><strong>Reply:</strong> <a href="13599.php">Ralph Castain: "Re: [OMPI users] Dynamic process tutorials?"</a>
<li><strong>Reply:</strong> <a href="13604.php">Ralph Castain: "Re: [OMPI users] Dynamic process tutorials?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
HI Ralph -
<br>
<p>Thanks for the reply.  I think this patch sounds great!  The idea in
<br>
...
<p>&nbsp;&nbsp;Brian
<br>
<p>On Mon, Jul 12, 2010 at 8:29 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; On Jul 12, 2010, at 9:07 AM, Brian Budge wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; They can connect/accept via ompi-server - checkout &quot;man ompi-server&quot;. You can also have them all rendezvous at a common mpirun if you prefer by using the appropriate mca param to give the required contact info.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev1">&gt; Look at &quot;man MPI_Comm_spawn&quot;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev1">&gt; The entire job will automatically abort if it fails to call Finalize as this is considered an abnormal termination event.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev1">&gt; Not possible at the moment. I have provided a patch to another user on this list that made it possible to use ompi-server as a rendezvous point for singletons, but that isn't in any formal release yet.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
