...
?>
<!-- received="Tue Jul 27 11:30:27 2010" -->
<!-- isoreceived="20100727153027" -->
<!-- sent="Tue, 27 Jul 2010 17:30:21 +0200" -->
<!-- isosent="20100727153021" -->
<!-- name="Grzegorz Maj" -->
<!-- email="maju3_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept" -->
<!-- id="AANLkTimt3C1ccbxCa4fFW=uQ4E2BDAvVU_jHCV90UMWR_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="6C3604FF-38D1-45AA-A999-9DDCEEAA5FDA_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-27 11:30:21
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13802.php">David Zhang: "Re: [OMPI users] MPI_Allreduce on local machine"</a>
<li><strong>Previous message:</strong> <a href="13800.php">Brian Smith: "Re: [OMPI users] Processes stuck after MPI_Waitall() in 1.4.1"</a>
<li><strong>In reply to:</strong> <a href="13781.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13803.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>Reply:</strong> <a href="13803.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>But when I try to run the clients on several machines the most
<br>
...
<br>
<p>As I said it's the most frequent scenario. Sometimes I can connect the
<br>
...
<br>
<p>I've tried both versions with and without the first patch (ompi-server
<br>
as orted) but it doesn't change the behavior.
<br>
<p>I've attached gdb to my server, this is bt:
<br>
...
<br>
<p>And this is bt from one of the clients:
<br>
#0  0xffffe410 in __kernel_vsyscall ()
<br>
...
<br>
<p><p><p>What do you think may cause the problem?
<br>
<p><p>2010/7/26 Ralph Castain &lt;rhc_at_[hidden]&gt;:
<br>
