...
?>
<!-- received="Mon Jul 12 15:38:39 2010" -->
<!-- isoreceived="20100712193839" -->
<!-- sent="Mon, 12 Jul 2010 13:38:28 -0600" -->
<!-- isosent="20100712193828" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic process tutorials?" -->
<!-- id="0E6D928F-ED75-489B-8D57-644D07852B53_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2010-07-12 15:38:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13605.php">Brian Budge: "Re: [OMPI users] Dynamic process tutorials?"</a>
<li><strong>Previous message:</strong> <a href="13603.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>In reply to:</strong> <a href="13595.php">Brian Budge: "Re: [OMPI users] Dynamic process tutorials?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13605.php">Brian Budge: "Re: [OMPI users] Dynamic process tutorials?"</a>
<li><strong>Reply:</strong> <a href="13605.php">Brian Budge: "Re: [OMPI users] Dynamic process tutorials?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Just to clarify: while the revised OMPI will allow singleton connect/accept, it will still only do so in the presence of a running ompi-server. There is no way to wireup singletons without that external agent.
<br>
<p>However, ompi-server is not specific to any job, so it can be allowed to run in the background as a daemon, used only when required.
<br>
