...
?>
<!-- received="Wed Jul 28 05:01:47 2010" -->
<!-- isoreceived="20100728090147" -->
<!-- sent="Wed, 28 Jul 2010 11:01:39 +0200" -->
<!-- isosent="20100728090139" -->
<!-- name="Grzegorz Maj" -->
<!-- email="maju3_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept" -->
<!-- id="AANLkTinZ_-vUAZSL71g7MOXpabmcxxAe0q-3TsGn_c3e_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="4C4F33C1.2060602_at_cs.uh.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-28 05:01:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13821.php">Ralph Castain: "Re: [OMPI users] OpenMPI providing rank?"</a>
<li><strong>Previous message:</strong> <a href="13819.php">Yves Caniou: "Re: [OMPI users] OpenMPI providing rank?"</a>
<li><strong>In reply to:</strong> <a href="13805.php">Edgar Gabriel: "Re: [OMPI users] Dynamic processes connection and segfault on	MPI_Comm_accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13827.php">Edgar Gabriel: "Re: [OMPI users] Dynamic processes connection and segfault on	MPI_Comm_accept"</a>
<li><strong>Reply:</strong> <a href="13827.php">Edgar Gabriel: "Re: [OMPI users] Dynamic processes connection and segfault on	MPI_Comm_accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I've tried both scenarios described: when hangs a client connecting
<br>
...
Grzegorz
<br>
<p><p><p>2010/7/27 Edgar Gabriel &lt;gabriel_at_[hidden]&gt;:
<br>
<span class="quotelev1">&gt; based on your output shown here, there is absolutely nothing wrong
</span><br>
<span class="quotelev1">&gt; (yet). Both processes are in the same function and do what they are
</span><br>
<span class="quotelev1">&gt; supposed to do.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; However, I am fairly sure that the client process bt that you show is
</span><br>
<span class="quotelev1">&gt; already part of current_intracomm. Could you try to create a bt of the
</span><br>
<span class="quotelev1">&gt; process that is not yet part of current_intracomm (If I understand your
</span><br>
<span class="quotelev1">&gt; code correctly, the intercommunicator is n-1 configuration, with each
</span><br>
<span class="quotelev1">&gt; client process being part of n after the intercomm_merge). It would be
</span><br>
<span class="quotelev1">&gt; interesting to see where that process is...
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On 7/27/2010 1:42 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; This slides outside of my purview - I would suggest you post this question with a different subject line specifically mentioning failure of intercomm_merge to work so it attracts the attention of those with knowledge of that area.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On Jul 27, 2010, at 9:30 AM, Grzegorz Maj wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So now I have a new question.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; When I run my server and a lot of clients on the same machine,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; everything looks fine.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; But when I try to run the clients on several machines the most
</span><br>
<span class="quotelev3">&gt;&gt;&gt; frequent scenario is:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; * server is stared on machine A
</span><br>
<span class="quotelev3">&gt;&gt;&gt; * X (= 1, 4, 10, ..) clients are started on machine B and they connect
</span><br>
<span class="quotelev3">&gt;&gt;&gt; successfully
</span><br>
<span class="quotelev3">&gt;&gt;&gt; * the first client starting on machine C connects successfully to the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; server, but the whole grid hangs on MPI_Comm_merge (all the processes
</span><br>
<span class="quotelev3">&gt;&gt;&gt; from intercommunicator get there).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; As I said it's the most frequent scenario. Sometimes I can connect the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; clients from several machines. Sometimes it hangs (always on
</span><br>
<span class="quotelev3">&gt;&gt;&gt; MPI_Comm_merge) when connecting the clients from machine B.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The interesting thing is, that if before MPI_Comm_merge I send a dummy
</span><br>
<span class="quotelev3">&gt;&gt;&gt; message on the intercommunicator from process rank 0 in one group to
</span><br>
<span class="quotelev3">&gt;&gt;&gt; process rank 0 in the other one, it will not hang on MPI_Comm_merge.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I've tried both versions with and without the first patch (ompi-server
</span><br>
<span class="quotelev3">&gt;&gt;&gt; as orted) but it doesn't change the behavior.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I've attached gdb to my server, this is bt:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #0 &#160;0xffffe410 in __kernel_vsyscall ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #1 &#160;0x00637afc in sched_yield () from /lib/libc.so.6
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #2 &#160;0xf7e8ce31 in opal_progress () at ../../opal/runtime/opal_progress.c:220
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #3 &#160;0xf7f60ad4 in opal_condition_wait (c=0xf7fd7dc0, m=0xf7fd7e00) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../opal/threads/condition.h:99
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #4 &#160;0xf7f60dee in ompi_request_default_wait_all (count=2,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; requests=0xff8d7754, statuses=0x0) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../ompi/request/req_wait.c:262
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #5 &#160;0xf7d3e221 in mca_coll_inter_allgatherv_inter (sbuf=0xff8d7824,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; scount=1, sdtype=0x8049200, rbuf=0xff8d77e0, rcounts=0x9783df8,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; disps=0x9755520, rdtype=0x8049200, comm=0x978c2a8, module=0x9794b08)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &#160; &#160;at ../../../../../ompi/mca/coll/inter/coll_inter_allgatherv.c:127
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #6 &#160;0xf7f4c615 in ompi_comm_determine_first (intercomm=0x978c2a8,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; high=0) at ../../ompi/communicator/comm.c:1199
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #7 &#160;0xf7f8d1d9 in PMPI_Intercomm_merge (intercomm=0x978c2a8, high=0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; newcomm=0xff8d78c0) at pintercomm_merge.c:84
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #8 &#160;0x0804893c in main (argc=Cannot access memory at address 0xf
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ) at server.c:50
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; And this is bt from one of the clients:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #0 &#160;0xffffe410 in __kernel_vsyscall ()
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #1 &#160;0x0064993b in poll () from /lib/libc.so.6
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #2 &#160;0xf7de027f in poll_dispatch (base=0x8643fb8, arg=0x86442d8,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; tv=0xff82299c) at ../../../opal/event/poll.c:168
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #3 &#160;0xf7dde4b2 in opal_event_base_loop (base=0x8643fb8, flags=2) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../../opal/event/event.c:807
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #4 &#160;0xf7dde34f in opal_event_loop (flags=2) at ../../../opal/event/event.c:730
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #5 &#160;0xf7dcfc77 in opal_progress () at ../../opal/runtime/opal_progress.c:189
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #6 &#160;0xf7ea80b8 in opal_condition_wait (c=0xf7f25160, m=0xf7f251a0) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../opal/threads/condition.h:99
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #7 &#160;0xf7ea7ff3 in ompi_request_wait_completion (req=0x8686680) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../ompi/request/request.h:375
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #8 &#160;0xf7ea7ef1 in ompi_request_default_wait (req_ptr=0xff822ae8,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; status=0x0) at ../../ompi/request/req_wait.c:37
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #9 &#160;0xf7c663a6 in ompi_coll_tuned_bcast_intra_generic
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (buffer=0xff822d20, original_count=1, datatype=0x868bd00, root=0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; comm=0x86aa7f8, module=0x868b700, count_by_segment=1, tree=0x868b3d8)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &#160; &#160;at ../../../../../ompi/mca/coll/tuned/coll_tuned_bcast.c:237
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #10 0xf7c668ea in ompi_coll_tuned_bcast_intra_binomial
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (buffer=0xff822d20, count=1, datatype=0x868bd00, root=0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; comm=0x86aa7f8, module=0x868b700, segsize=0)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &#160; &#160;at ../../../../../ompi/mca/coll/tuned/coll_tuned_bcast.c:368
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #11 0xf7c5af12 in ompi_coll_tuned_bcast_intra_dec_fixed
</span><br>
<span class="quotelev3">&gt;&gt;&gt; (buff=0xff822d20, count=1, datatype=0x868bd00, root=0, comm=0x86aa7f8,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; module=0x868b700)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &#160; &#160;at ../../../../../ompi/mca/coll/tuned/coll_tuned_decision_fixed.c:256
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #12 0xf7c73269 in mca_coll_sync_bcast (buff=0xff822d20, count=1,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; datatype=0x868bd00, root=0, comm=0x86aa7f8, module=0x86aaa28) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../../../../ompi/mca/coll/sync/coll_sync_bcast.c:44
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #13 0xf7c80381 in mca_coll_inter_allgatherv_inter (sbuf=0xff822d64,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; scount=0, sdtype=0x8049400, rbuf=0xff822d20, rcounts=0x868a188,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; disps=0x868abb8, rdtype=0x8049400, comm=0x86aa300,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &#160; &#160;module=0x86aae18) at
</span><br>
<span class="quotelev3">&gt;&gt;&gt; ../../../../../ompi/mca/coll/inter/coll_inter_allgatherv.c:134
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #14 0xf7e9398f in ompi_comm_determine_first (intercomm=0x86aa300,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; high=0) at ../../ompi/communicator/comm.c:1199
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #15 0xf7ed7833 in PMPI_Intercomm_merge (intercomm=0x86aa300, high=0,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; newcomm=0xff8241d0) at pintercomm_merge.c:84
</span><br>
<span class="quotelev3">&gt;&gt;&gt; #16 0x08048afd in main (argc=943274038, argv=0x33393133) at client.c:47
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; What do you think may cause the problem?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 2010/7/26 Ralph Castain &lt;rhc_at_[hidden]&gt;:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; No problem at all - glad it works!
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jul 26, 2010, at 7:58 AM, Grzegorz Maj wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Hi,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I'm very sorry, but the problem was on my side. My installation
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; process was not always taking the newest sources of openmpi. In this
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; case it hasn't installed the version with the latest patch. Now I
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; think everything works fine - I could run over 130 processes with no
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; problems.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I'm sorry again that I've wasted your time. And thank you for the patch.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 2010/7/21 Ralph Castain &lt;rhc_at_[hidden]&gt;:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; We're having some problem replicating this once my patches are applied. Can you send us your configure cmd? Just the output from &quot;head config.log&quot; will do for now.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Jul 20, 2010, at 9:09 AM, Grzegorz Maj wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; My start script looks almost exactly the same as the one published by
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Edgar, ie. the processes are starting one by one with no delay.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 2010/7/20 Ralph Castain &lt;rhc_at_[hidden]&gt;:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Grzegorz: something occurred to me. When you start all these processes, how are you staggering their wireup? Are they flooding us, or are you time-shifting them a little?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Jul 19, 2010, at 10:32 AM, Edgar Gabriel wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Hm, so I am not sure how to approach this. First of all, the test case
</span><br>
