...
?>
<!-- received="Tue Jul  6 10:48:55 2010" -->
<!-- isoreceived="20100706144855" -->
<!-- sent="Tue, 6 Jul 2010 16:48:49 +0200" -->
<!-- isosent="20100706144849" -->
<!-- name="Grzegorz Maj" -->
<!-- email="maju3_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept" -->
<!-- id="AANLkTin5sJunS-LZMaSruuYzQ9vc-T25G22ZTwDGvmHE_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="009B6084-8ED9-41F6-9C1D-05A721A58761_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-07-06 10:48:49
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13478.php">Don Kerr: "Re: [OMPI users] UDAPL 2.0 support"</a>
<li><strong>Previous message:</strong> <a href="13476.php">Jeff Squyres: "Re: [OMPI users] UDAPL 2.0 support"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/04/12763.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13497.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>Reply:</strong> <a href="13497.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
be grateful.
<br>
<p>When I run that code with clients_count &lt;= 65 everything works fine:
<br>
...
<br>
<p>Another thing I would like to know is if it's normal that any of my
<br>
...
Grzegorz Maj
<br>
<p><p>2010/4/24 Ralph Castain &lt;rhc_at_[hidden]&gt;:
<br>
...
<br><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13477/client.c">client.c</a>
</ul>
<!-- attachment="client.c" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13477/server.c">server.c</a>
</ul>
<!-- attachment="server.c" -->
<!-- body="end" -->
<hr>
