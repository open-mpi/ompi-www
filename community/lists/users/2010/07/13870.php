...
?>
<!-- received="Thu Jul 29 11:08:48 2010" -->
<!-- isoreceived="20100729150848" -->
<!-- sent="Thu, 29 Jul 2010 11:08:35 -0400" -->
<!-- isosent="20100729150835" -->
<!-- name="Terry Dontje" -->
<!-- email="terry.dontje_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core" -->
<!-- id="4C519973.1050702_at_oracle.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2010-07-29 11:08:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13871.php">David Akin: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<li><strong>Previous message:</strong> <a href="13869.php">Ralph Castain: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13871.php">David Akin: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<li><strong>Reply:</strong> <a href="13871.php">David Akin: "Re: [OMPI users] Hybrid OpenMPI / OpenMP run pins OpenMP threads to a single core"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev2">&gt;&gt; machine you could to -bind-to-socket -bysocket and spread the 
</span><br>
<span class="quotelev2">&gt;&gt; processes that way.  Also couldn't you use the -cpus-per-proc with 
</span><br>
<span class="quotelev2">&gt;&gt; -bind-to-core to get a process to bind to a non-socket amount of cpus?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Yes, you could do bind-to-socket, though that still constrains the 
</span><br>
<span class="quotelev1">&gt; threads to only that one socket. What was asked about here was the 
</span><br>
<span class="quotelev1">&gt; ability to bind-to-core at the thread level, and that is something 
</span><br>
<span class="quotelev1">&gt; OMPI doesn't support.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<br>
<p>However, what may be the next best thing is to specify binding of a 
<br>
process to a group of resources.  That's essentially what my suggestion 
<br>
above is doing. 
<br>
<p>I do agree with Ralph that once you start overloading the socket with 
<br>
...
<span class="quotelev2">&gt;&gt; That being said, I also am confused, like Ralph, as to why no options 
</span><br>
<span class="quotelev2">&gt;&gt; is causing your code bind.  Maybe add a --report-bindings to your 
</span><br>
<span class="quotelev2">&gt;&gt; mpirun line to see what OMPI thinks it is doing in this regard?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; This is a good suggestion - I'm beginning to believe that the binding 
</span><br>
<span class="quotelev1">&gt; is happening in the user's app and not OMPI.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13870/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<img src="http://www.open-mpi.org/community/lists/users/att-13870/02-part" alt="picture">
<!-- attachment="02-part" -->
<!-- body="end" -->
<hr>
<ul class="links">
