...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11956.php">Lee Manko: "[OMPI users] Cluster Configuration Issue???"</a>
<li><strong>Previous message:</strong> <a href="11954.php">Mathieu Gontier: "Re: [OMPI users] [ompi-1.4.1] compiling without openib, running with openib + ompi141 and gcc3"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/01/11946.php">Jazcek Braden: "Re: [OMPI users] Checkpoint/Restart error"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
