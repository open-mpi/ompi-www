...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Cluster Configuration Issue???<br>
<strong>From:</strong> Lee Manko (<em>lmanko_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-02-01 13:07:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11957.php">Timothy G Thompson: "[OMPI users] crashing on MPI_SEND -- program exited with code 021, when ~1200 cores"</a>
<li><strong>Previous message:</strong> <a href="11955.php">Josh Hursey: "Re: [OMPI users] Checkpoint/Restart error"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11956/attachment">attachment</a>
</ul>
