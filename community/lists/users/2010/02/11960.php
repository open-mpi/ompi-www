...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11961.php">Terry Dontje: "Re: [OMPI users] totalview and message queue, empty windows"</a>
<li><strong>Previous message:</strong> <a href="11959.php">Conboy, James: "[OMPI users] Configuring OpenMPI 1.3.3, 1.4  --with-valgrind 3.5.0"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11988.php">Lionel Chailan: "Re: [OMPI users] Uninterruptible processes on 2*4 multicore"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11960/attachment">attachment</a>
</ul>
