...
?>
<!-- received="Tue Feb  2 12:31:19 2010" -->
<!-- isoreceived="20100202173119" -->
<!-- sent="Tue, 02 Feb 2010 11:31:06 -0600" -->
<!-- isosent="20100202173106" -->
<!-- name="Charles Shuller" -->
<!-- email="charles.shuller_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpirun with WMI on Windows 7" -->
<!-- id="4B68615A.3010704_at_gmail.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="4B685E15.5000506_at_hlrs.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-02-02 12:31:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11968.php">Shiqing Fan: "Re: [OMPI users] mpirun with WMI on Windows 7"</a>
<li><strong>Previous message:</strong> <a href="11966.php">Shiqing Fan: "Re: [OMPI users] mpirun with WMI on Windows 7"</a>
<li><strong>In reply to:</strong> <a href="11966.php">Shiqing Fan: "Re: [OMPI users] mpirun with WMI on Windows 7"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11968.php">Shiqing Fan: "Re: [OMPI users] mpirun with WMI on Windows 7"</a>
<li><strong>Reply:</strong> <a href="11968.php">Shiqing Fan: "Re: [OMPI users] mpirun with WMI on Windows 7"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>When I executed mpirun to launch notepad on the remote machine, It
<br>
crashes again.
<br>
<p>No information is ever printed to the command line unless I enter a bad
<br>
password.
<br>
<p>The very first time I attempt to use mpirun to launch a process on the
<br>
...
<br>
<p>My MPI application (Which just calls init and finalize)  is at C:\bin
<br>
which is in the system path on both machines, this is also the bin
<br>
directory for the openmpi package.
<br>
<p>Is there anyway I can turn on logging, or do I need to go through and
<br>
...
<p><p>Charles
<br>
<p>On 2/2/2010 11:17 AM, Shiqing Fan wrote:
<br>
...
<span class="quotelev1">&gt; On the local machine, which can be considered also as the &quot;head node&quot;,
</span><br>
...
<span class="quotelev1">&gt; To do a simple test, just try to launch notepad on remote node: mpirun
</span><br>
...
<span class="quotelev1">&gt; run the mpirun command line supplied with the application full path or
</span><br>
...
<span class="quotelev2">&gt;&gt; processes to find it, even though I'm currently logged in as the same
</span><br>
...
<span class="quotelev2">&gt;&gt; application starts execution.   Oddly, orted does not appear to start
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Task Manager or Process Viewer, and that also means mpirun will work
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; don't.  Additionally, I have encountered and resolved some security
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Any advice is welcome.  I'm not married to WMI, so if the solution is
</span><br>
...
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11967/signature.asc">OpenPGP digital signature</a>
</ul>
