...
<p class="headers">
<strong>Subject:</strong> [OMPI users] crashing on MPI_SEND -- program exited with code 021, when ~1200 cores<br>
<strong>From:</strong> Timothy G Thompson (<em>Timothy.G.Thompson_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-02-01 14:10:00
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11958.php">Lionel Chailan: "[OMPI users] Uninterruptible processes on 2*4 multicore"</a>
<li><strong>Previous message:</strong> <a href="11956.php">Lee Manko: "[OMPI users] Cluster Configuration Issue???"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11957/attachment">attachment</a>
</ul>
