...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Uninterruptible processes on 2*4 multicore<br>
<strong>From:</strong> Lionel Chailan (<em>lchailan_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-02-02 05:34:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="11959.php">Conboy, James: "[OMPI users] Configuring OpenMPI 1.3.3, 1.4  --with-valgrind 3.5.0"</a>
<li><strong>Previous message:</strong> <a href="11957.php">Timothy G Thompson: "[OMPI users] crashing on MPI_SEND -- program exited with code 021, when ~1200 cores"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="11960.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Uninterruptible processes on 2*4 multicore"</a>
<li><strong>Maybe reply:</strong> <a href="11960.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Uninterruptible processes on 2*4 multicore"</a>
<li><strong>Maybe reply:</strong> <a href="11988.php">Lionel Chailan: "Re: [OMPI users] Uninterruptible processes on 2*4 multicore"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-11958/attachment">attachment</a>
</ul>
