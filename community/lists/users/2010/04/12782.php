<?
$subject_val = "[OMPI users] problem using new OMPI1.4.1 vie SGE";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Apr 26 11:08:35 2010" -->
<!-- isoreceived="20100426150835" -->
<!-- sent="Mon, 26 Apr 2010 08:08:10 -0700" -->
<!-- isosent="20100426150810" -->
<!-- name="Matthew MacManes" -->
<!-- email="macmanes_at_[hidden]" -->
<!-- subject="[OMPI users] problem using new OMPI1.4.1 vie SGE" -->
<!-- id="4BD5AC5A.1030706_at_gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] problem using new OMPI1.4.1 vie SGE<br>
<strong>From:</strong> Matthew MacManes (<em>macmanes_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-04-26 11:08:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12783.php">Ralph Castain: "Re: [OMPI users] problem using new OMPI1.4.1 vie SGE"</a>
<li><strong>Previous message:</strong> <a href="12781.php">Tim Prince: "Re: [OMPI users] open-mpi behaviour on Fedora, Ubuntu, Debian and 	CentOS"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12783.php">Ralph Castain: "Re: [OMPI users] problem using new OMPI1.4.1 vie SGE"</a>
<li><strong>Reply:</strong> <a href="12783.php">Ralph Castain: "Re: [OMPI users] problem using new OMPI1.4.1 vie SGE"</a>
<li><strong>Reply:</strong> <a href="12784.php">Addepalli, Srirangam V: "Re: [OMPI users] problem using new OMPI1.4.1 vie SGE"</a>
<li><strong>Reply:</strong> <a href="12794.php">Dave Love: "Re: [OMPI users] problem using new OMPI1.4.1 vie SGE"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
told that I could install OpenMPI in my home directory, and run jobs 
<br>
using my newer version.. However, I am having problems doing this, 
<br>
getting the error message seen below.
<br>
<p>Its seems that the compute nodes are not accessing all the sufficient 
<br>
libraries for the newer version of OpenMPI.
<br>
<p>Can anybody tell me what I can do to get the jobs running using the 
<br>
newer version of OpenMPI. Thanks!
<br>
...
<br>
<p>Ray Copyright (C) 2010  S&#233;bastien Boisvert, Jacques Corbeil, Fran&#231;ois 
<br>
Laviolette
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-12782/attachment">attachment</a>
</ul>
