...
?>
<!-- received="Sat Apr 17 22:07:17 2010" -->
<!-- isoreceived="20100418020717" -->
<!-- sent="Sat, 17 Apr 2010 20:07:08 -0600" -->
<!-- isosent="20100418020708" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile" -->
<!-- id="8133572B-0DD6-4E7E-A1ED-4D73F90A463B_at_open-mpi.org" -->
<!-- charset="utf-8" -->
<!-- inreplyto="n2ifc029d6c1004171552z6979fe7q1dfa749d046cb219_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-04-17 22:07:08
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12681.php">Mario Ogrizek: "Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile"</a>
<li><strong>Previous message:</strong> <a href="12679.php">Ralph Castain: "Re: [OMPI users] How do I integrate OpenMPI with a local cluster and EC2"</a>
<li><strong>In reply to:</strong> <a href="12676.php">Mario Ogrizek: "Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12681.php">Mario Ogrizek: "Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile"</a>
<li><strong>Reply:</strong> <a href="12681.php">Mario Ogrizek: "Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>printf(&quot;Hello MPI World from process %d!&quot;, my_rank
<br>
<p>&nbsp;in each process? Much more direct - avoids any ambiguity.
<br>
<p>Also, be certain that you compile this program for the specific OMPI version you are running it under. OMPI is NOT binary compatible across releases - you have to recompile the program for the specific release you are going to use.
<br>
<p><p>On Apr 17, 2010, at 4:52 PM, Mario Ogrizek wrote:
<br>
<p><span class="quotelev1">&gt; Ofcourse, its the same program, wasnt recompiled for a week.
</span><br>
...
<span class="quotelev1">&gt; We are using both cores - it is just that they are on the same node. Unless told otherwise, the processes will use shared memory for communication.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; From console, im starting a job like this: mpirun -np 4 Program, where i want to run a Program on 4 processors.
</span><br>
<span class="quotelev2">&gt;&gt; I was just stumbled when i got same output 4 times, like there are 4 processes ranked 0.
</span><br>
<span class="quotelev2">&gt;&gt; While with the old version of mpi (1.2) same execution would give 4 processes ranked 0..3.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; And so you should - if not, then there is something wrong. No way mpirun would start 4 processes ranked 0. How are you printing the rank? Are you sure you are getting it correctly?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; My idea was to try to use dual core machine as two nodes. I have a limited access to a cluster, so this was just for &quot;testing&quot; purposes.
</span><br>
...
<span class="quotelev2">&gt;&gt; I'm afraid not - it is just another processor on that node. So you only have one node as far as OMPI is concerned.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; How are you starting your job? The usual way is with &quot;mpirun -n N ...&quot;. That is what we mean by the &quot;mpirun cmd line&quot; - i.e., what command are you using to start your job?
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; It sounds like things are actually working correctly. You might look at &quot;mpirun -h&quot; for possible options of interest.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I checked the default MCA param file, and found it was there that was (automatically) specified as a relative path, so i changed it.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I am running this on a simple dualcore machine, so i specified it as a localhost with two nodes.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I don't understand this comment - a dual core machine would still be a single node. Just happens to have two processors in it.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sat, Apr 17, 2010 at 12:52 AM, Mario Ogrizek &lt;mario.guardian_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I understand, so, its looking for a working_dir/usr/local/etc/openmpi-default-hostfile
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I managed to run a hello world program from the console, while my wd was just &quot;/&quot; and it worked, altho strangely...
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; So, you are saying i allways have to be in &quot;/&quot; to run mpi programs, or there is a way for mpi to search absolute path?
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Fri, Apr 16, 2010 at 7:40 PM, Timur Magomedov &lt;timur.magomedov_at_[hidden]&gt; wrote:
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-12680/attachment">attachment</a>
</ul>
