...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12512.php">NovA: "[OMPI users] openMPI-1.4.1 on Windows"</a>
<li><strong>Previous message:</strong> <a href="12510.php">Federico Golfr&#232; Andreasi: "Re: [OMPI users] Number of processes and spawn"</a>
<li><strong>Maybe in reply to:</strong> <a href="12509.php">longbow leo: "[OMPI users] mpiblast only run in one node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12520.php">longbow leo: "Re: [OMPI users] mpiblast only run in one node"</a>
<li><strong>Reply:</strong> <a href="12520.php">longbow leo: "Re: [OMPI users] mpiblast only run in one node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-12511/attachment">attachment</a>
</ul>
