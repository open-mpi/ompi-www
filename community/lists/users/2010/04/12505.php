...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12506.php">Oliver Geisler: "Re: [OMPI users] kernel 2.6.23 vs 2.6.24 - communication/wait times"</a>
<li><strong>Previous message:</strong> <a href="12504.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mpiblast only run in one node"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12521.php">Shiqing Fan: "Re: [OMPI users] openMPI-1.4.1 on Windows"</a>
<li><strong>Reply:</strong> <a href="12521.php">Shiqing Fan: "Re: [OMPI users] openMPI-1.4.1 on Windows"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
