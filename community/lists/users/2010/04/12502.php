...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12503.php">Federico Golfr&#232; Andreasi: "Re: [OMPI users] Number of processes and spawn"</a>
<li><strong>Previous message:</strong> <a href="../../2010/03/12501.php">Jeff Squyres: "Re: [OMPI users] openmpi.ld.conf file"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12504.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mpiblast only run in one node"</a>
<li><strong>Maybe reply:</strong> <a href="12504.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mpiblast only run in one node"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-12502/attachment">attachment</a>
</ul>
