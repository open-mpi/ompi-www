...
?>
<!-- received="Fri Apr 23 14:13:09 2010" -->
<!-- isoreceived="20100423181309" -->
<!-- sent="Fri, 23 Apr 2010 12:12:59 -0600" -->
<!-- isosent="20100423181259" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept" -->
<!-- id="063EFDE8-AFBB-4F75-BF57-20F340ADD0A7_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="t2t464cc18f1004230710re24ef4bet69c50aa42b4ef0c8_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-04-23 14:12:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12761.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>Previous message:</strong> <a href="12759.php">Francesco Iannone: "[OMPI users]  Openpi 1.4.1 PGI 10.2.1 libpgnuma issue"</a>
<li><strong>In reply to:</strong> <a href="12750.php">Grzegorz Maj: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12761.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<li><strong>Reply:</strong> <a href="12761.php">Ralph Castain: "Re: [OMPI users] Dynamic processes connection and segfault on MPI_Comm_accept"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>1. launch one process (can just be a spinner) using mpirun that includes the following option:
<br>
<p>mpirun -report-uri file
<br>
<p>where file is some filename that mpirun can create and insert its contact info into it. This can be a relative or absolute path. This process must remain alive throughout your application - doesn't matter what it does. It's purpose is solely to keep mpirun alive.
<br>
<p>2. set OMPI_MCA_dpm_orte_server=FILE:file in your environment, where &quot;file&quot; is the filename given above. This will tell your processes how to find mpirun, which is acting as a meeting place to handle the connect/accept operations
<br>
<p>Now run your processes, and have them connect/accept to each other.
<br>
<p>The reason I cannot guarantee this will work is that these processes will all have the same rank &amp;&amp; name since they all start as singletons. Hence, connect/accept is likely to fail.
<br>
<p>But it -might- work, so you might want to give it a try.
<br>
<p>On Apr 23, 2010, at 8:10 AM, Grzegorz Maj wrote:
<br>
<p><span class="quotelev1">&gt; To be more precise: by 'server process' I mean some process that I
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Okay, but here is the problem. If you don't use mpirun, and are not operating in an environment we support for &quot;direct&quot; launch (i.e., starting processes outside of mpirun), then every one of those processes thinks it is a singleton - yes?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; What you may not realize is that each singleton immediately fork/exec's an orted daemon that is configured to behave just like mpirun. This is required in order to support MPI-2 operations such as MPI_Comm_spawn, MPI_Comm_connect/accept, etc.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So if you launch 64 processes that think they are singletons, then you have 64 copies of orted running as well. This eats up a lot of file descriptors, which is probably why you are hitting this 65 process limit - your system is probably running out of file descriptors. You might check you system limits and see if you can get them revised upward.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
...
<span class="quotelev4">&gt;&gt;&gt;&gt; running my processes provided by the environment in which I'm working
</span><br>
