...
?>
<!-- received="Fri Apr 16 18:52:40 2010" -->
<!-- isoreceived="20100416225240" -->
<!-- sent="Sat, 17 Apr 2010 00:52:34 +0200" -->
<!-- isosent="20100416225234" -->
<!-- name="Mario Ogrizek" -->
<!-- email="mario.guardian_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile" -->
<!-- id="t2jfc029d6c1004161552i5471ffb3z3725617df3ca2e83_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="C4C7C836-C3B1-403C-863A-655C07C00F52_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-04-16 18:52:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12662.php">Mario Ogrizek: "Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile"</a>
<li><strong>Previous message:</strong> <a href="12660.php">Ralph Castain: "Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile"</a>
<li><strong>In reply to:</strong> <a href="12660.php">Ralph Castain: "Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12662.php">Mario Ogrizek: "Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile"</a>
<li><strong>Reply:</strong> <a href="12662.php">Mario Ogrizek: "Re: [OMPI users] Fwd: Open MPI v1.4 cant find default hostfile"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello MPI World From process 0: Num processes: 1
<br>
<p>So, you are saying i allways have to be in &quot;/&quot; to run mpi programs, or there
<br>
is a way for mpi to search absolute path?
<br>
It seems pretty inconvinient this way.
<br>
I think v 1.2 didnt have this limitation.
<br>
<p>Does this have to do anything with LD_LIBRARY_PATH?
<br>
<p>Regards,
<br>
<p>Mario
<br>
<p>On Fri, Apr 16, 2010 at 7:46 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; How did you specify it? Command line? Default MCA param file?
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-12661/attachment">attachment</a>
</ul>
