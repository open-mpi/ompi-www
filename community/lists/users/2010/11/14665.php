...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14666.php">jody: "[OMPI users] link problem on 64bit platform"</a>
<li><strong>Previous message:</strong> <a href="14664.php">Jack Bryan: "[OMPI users] message truncated error"</a>
<li><strong>In reply to:</strong> <a href="14664.php">Jack Bryan: "[OMPI users] message truncated error"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14672.php">Jack Bryan: "Re: [OMPI users] message truncated error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
