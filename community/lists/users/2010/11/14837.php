...
?>
<!-- received="Fri Nov 19 14:11:50 2010" -->
<!-- isoreceived="20101119191150" -->
<!-- sent="Fri, 19 Nov 2010 12:11:45 -0700" -->
<!-- isosent="20101119191145" -->
<!-- name="Tushar Andriyas" -->
<!-- email="thugnomics28_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Unable to find the following executable" -->
<!-- id="AANLkTikNQmnd62EA8rLX2E=-pkJ3h7e_FdC0cNWhe4Ep_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="15F71B097D330B42AA606A4AD8CA9640E72EA85D9B_at_CRATUS.ttu.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-11-19 14:11:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14838.php">Addepalli, Srirangam V: "Re: [OMPI users] Unable to find the following executable"</a>
<li><strong>Previous message:</strong> <a href="14836.php">Addepalli, Srirangam V: "Re: [OMPI users] Unable to find the following executable"</a>
<li><strong>In reply to:</strong> <a href="14836.php">Addepalli, Srirangam V: "Re: [OMPI users] Unable to find the following executable"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14838.php">Addepalli, Srirangam V: "Re: [OMPI users] Unable to find the following executable"</a>
<li><strong>Reply:</strong> <a href="14838.php">Addepalli, Srirangam V: "Re: [OMPI users] Unable to find the following executable"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hey Rangam,
<br>
<p>I tried out the batch script and the error file comes out empty and the
<br>
...
<p>Tushar
<br>
<p>On Fri, Nov 19, 2010 at 10:05 AM, Addepalli, Srirangam V &lt;
<br>
...
<span class="quotelev1">&gt; #mpirun --preload-binary SWMF.exe
</span><br>
<span class="quotelev1">&gt; ls  /home/A00945081/SWMF_v2.3/run/SWMF.exe
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; &lt;mailto:thugnomics28_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-14837/attachment">attachment</a>
</ul>
