...
?>
<!-- received="Wed Nov 24 20:36:53 2010" -->
<!-- isoreceived="20101125013653" -->
<!-- sent="Wed, 24 Nov 2010 18:36:43 -0700" -->
<!-- isosent="20101125013643" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] SIGPIPE handling?" -->
<!-- id="42D507B8-B04B-4B3B-A86B-00DDAE4F318E_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2010-11-24 20:36:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14885.php">Gilbert Grosdidier: "Re: [OMPI users] Trouble with Memlock when using OpenIB on an SGI ICE Cluster"</a>
<li><strong>Previous message:</strong> <a href="14883.php">Jesse Ziser: "[OMPI users] SIGPIPE handling?"</a>
<li><strong>In reply to:</strong> <a href="14883.php">Jesse Ziser: "[OMPI users] SIGPIPE handling?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14886.php">Ralph Castain: "Re: [OMPI users] SIGPIPE handling?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>We already trap SIGPIPE, but ignore it at the request of others (not sure what version that was started). I believe a flag may exist to alter that behavior - could easily be added if not.
<br>
<p><p>On Nov 24, 2010, at 5:08 PM, Jesse Ziser wrote:
<br>
