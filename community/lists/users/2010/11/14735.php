...
?>
<!-- received="Thu Nov 11 08:46:57 2010" -->
<!-- isoreceived="20101111134657" -->
<!-- sent="Thu, 11 Nov 2010 08:46:51 -0500" -->
<!-- isosent="20101111134651" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem with sending messages from one of the machines" -->
<!-- id="6E944997-02D3-4FA6-9CE1-8B66041AA31E_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AANLkTimCvNUWZQJP52Szy_emCznrC2hK6Yp9rN76TZKT_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-11-11 08:46:51
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14736.php">Krzysztof Zarzycki: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<li><strong>Previous message:</strong> <a href="14734.php">Jed Brown: "Re: [OMPI users] memcpy overlap in ompi_ddt_copy_content_same_ddt and glibc 2.12"</a>
<li><strong>In reply to:</strong> <a href="14724.php">David Zhang: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14736.php">Krzysztof Zarzycki: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<li><strong>Reply:</strong> <a href="14736.php">Krzysztof Zarzycki: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Nov 10, 2010, at 12:46 PM, David Zhang wrote:
<br>
<p><span class="quotelev1">&gt; Have you double checked your firewall settings, TCP/IP settings, and SSH keys are all setup correctly for all machines including the host?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; On Wed, Nov 10, 2010 at 2:57 AM, Grzegorz Maj &lt;maju3_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; [host:28186] mca: base: components_open: component self has no register function
</span><br>
<span class="quotelev1">&gt; [host:28186] mca: base: components_open: component self open function successful
</span><br>
<span class="quotelev1">&gt; [host:28186] mca: base: components_open: found loaded component sm
</span><br>
<span class="quotelev1">&gt; [host:28186] mca: base: components_open: component sm has no register function
</span><br>
<span class="quotelev1">&gt; [host:28186] mca: base: components_open: component sm open function successful
</span><br>
<span class="quotelev1">&gt; [host:28186] mca: base: components_open: found loaded component tcp
</span><br>
<span class="quotelev1">&gt; [host:28186] mca: base: components_open: component tcp has no register function
</span><br>
<span class="quotelev1">&gt; [host:28186] mca: base: components_open: component tcp open function successful
</span><br>
...
<span class="quotelev1">&gt; #2  0xf7df07b5 in poll_dispatch () from /home/gmaj/openmpi/lib/libopen-pal.so.0
</span><br>
...
<span class="quotelev1">&gt; #5  0xf7de323b in opal_progress () from /home/gmaj/openmpi/lib/libopen-pal.so.0
</span><br>
