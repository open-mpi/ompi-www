...
?>
<!-- received="Thu Nov 11 14:05:01 2010" -->
<!-- isoreceived="20101111190501" -->
<!-- sent="Thu, 11 Nov 2010 20:04:33 +0100" -->
<!-- isosent="20101111190433" -->
...
<!-- id="AANLkTikN0k18FSFS8ecXAosPVaLQrJV+nsTi-suURirG_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="6E944997-02D3-4FA6-9CE1-8B66041AA31E_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-11-11 14:04:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14737.php">Jeff Squyres: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<li><strong>Previous message:</strong> <a href="14735.php">Jeff Squyres: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<li><strong>In reply to:</strong> <a href="14735.php">Jeff Squyres: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14737.php">Jeff Squyres: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<li><strong>Reply:</strong> <a href="14737.php">Jeff Squyres: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<li><strong>Reply:</strong> <a href="14738.php">Ralph Castain: "Re: [OMPI users] Problem with sending messages from one of the machines"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>So what can be a next reason of this problem?
<br>
<p>By the way, how can I enforce mpirun to use specific ethernet interface  for
<br>
...
Krzysztof
<br>
<p>2010/11/11 Jeff Squyres &lt;jsquyres_at_[hidden]&gt;
<br>
<p><span class="quotelev1">&gt; I'd check the firewall settings.  The stack trace indicates that the one
</span><br>
<span class="quotelev1">&gt; host is trying to connect to the other (Open MPI initiates non-blocking TCP
</span><br>
<span class="quotelev1">&gt; connections that can be polled on later).
</span><br>
...
<span class="quotelev2">&gt; &gt; Have you double checked your firewall settings, TCP/IP settings, and SSH
</span><br>
<span class="quotelev1">&gt; keys are all setup correctly for all machines including the host?
</span><br>
...
<span class="quotelev2">&gt; &gt; [host:28186] mca: base: components_open: component self has no register
</span><br>
<span class="quotelev1">&gt; function
</span><br>
<span class="quotelev2">&gt; &gt; [host:28186] mca: base: components_open: component self open function
</span><br>
<span class="quotelev1">&gt; successful
</span><br>
<span class="quotelev2">&gt; &gt; [host:28186] mca: base: components_open: found loaded component sm
</span><br>
<span class="quotelev2">&gt; &gt; [host:28186] mca: base: components_open: component sm has no register
</span><br>
<span class="quotelev1">&gt; function
</span><br>
<span class="quotelev2">&gt; &gt; [host:28186] mca: base: components_open: component sm open function
</span><br>
<span class="quotelev1">&gt; successful
</span><br>
<span class="quotelev2">&gt; &gt; [host:28186] mca: base: components_open: found loaded component tcp
</span><br>
<span class="quotelev2">&gt; &gt; [host:28186] mca: base: components_open: component tcp has no register
</span><br>
<span class="quotelev1">&gt; function
</span><br>
<span class="quotelev2">&gt; &gt; [host:28186] mca: base: components_open: component tcp open function
</span><br>
<span class="quotelev1">&gt; successful
</span><br>
...
<span class="quotelev2">&gt; &gt; #2  0xf7df07b5 in poll_dispatch () from
</span><br>
...
<span class="quotelev2">&gt; &gt; #5  0xf7de323b in opal_progress () from
</span><br>
<span class="quotelev1">&gt; /home/gmaj/openmpi/lib/libopen-pal.so.0
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-14736/attachment">attachment</a>
</ul>
