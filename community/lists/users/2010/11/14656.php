...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14657.php">jody: "Re: [OMPI users] message truncated error"</a>
<li><strong>Previous message:</strong> <a href="../../2010/10/14655.php">Sudarshan Wadkar: "[OMPI users] random error : btl_tcp_endpoint.c:636:mca_btl_tcp_endpoint_complete_connect connection refused (111)"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14657.php">jody: "Re: [OMPI users] message truncated error"</a>
<li><strong>Reply:</strong> <a href="14657.php">jody: "Re: [OMPI users] message truncated error"</a>
<li><strong>Maybe reply:</strong> <a href="14664.php">Jack Bryan: "Re: [OMPI users] message truncated error"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/html attachment: <a href="../../att-14656/attachment">attachment</a>
</ul>
