...
?>
<!-- received="Sat Nov 20 11:48:35 2010" -->
<!-- isoreceived="20101120164835" -->
<!-- sent="Sat, 20 Nov 2010 09:48:29 -0700" -->
<!-- isosent="20101120164829" -->
<!-- name="Tushar Andriyas" -->
<!-- email="thugnomics28_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Unable to find the following executable" -->
<!-- id="AANLkTim8oVdXKa7wOS6UmZyFEwE9ELvjS-T4kozVehWw_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="15F71B097D330B42AA606A4AD8CA9640E72EA85DA1_at_CRATUS.ttu.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-11-20 11:48:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14845.php">Addepalli, Srirangam V: "Re: [OMPI users] Unable to find the following executable"</a>
<li><strong>Previous message:</strong> <a href="14843.php">Gilbert Grosdidier: "[OMPI users] Trouble with Memlock when using OpenIB on an SGI ICE Cluster (fwd)"</a>
<li><strong>In reply to:</strong> <a href="14838.php">Addepalli, Srirangam V: "Re: [OMPI users] Unable to find the following executable"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14845.php">Addepalli, Srirangam V: "Re: [OMPI users] Unable to find the following executable"</a>
<li><strong>Reply:</strong> <a href="14845.php">Addepalli, Srirangam V: "Re: [OMPI users] Unable to find the following executable"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Rangam,
<br>
<p>I ran the batch file that you gave and have attached the error file. Also,
<br>
...
Tushar
<br>
<p>On Fri, Nov 19, 2010 at 12:31 PM, Addepalli, Srirangam V &lt;
<br>
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-14844/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-14844/SWMF.e143736">SWMF.e143736</a>
</ul>
<!-- attachment="SWMF.e143736" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
