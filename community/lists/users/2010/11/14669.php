...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14670.php">Tim Prince: "Re: [OMPI users] link problem on 64bit platform"</a>
<li><strong>Previous message:</strong> <a href="14668.php">Trent Creekmore: "Re: [OMPI users] link problem on 64bit platform"</a>
<li><strong>In reply to:</strong> <a href="14666.php">jody: "[OMPI users] link problem on 64bit platform"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14670.php">Tim Prince: "Re: [OMPI users] link problem on 64bit platform"</a>
<li><strong>Reply:</strong> <a href="14670.php">Tim Prince: "Re: [OMPI users] link problem on 64bit platform"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
