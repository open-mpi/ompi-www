...
?>
<!-- received="Tue Nov 30 10:23:51 2010" -->
<!-- isoreceived="20101130152351" -->
<!-- sent="Tue, 30 Nov 2010 10:23:46 -0500" -->
<!-- isosent="20101130152346" -->
<!-- name="Prentice Bisbal" -->
<!-- email="prentice_at_[hidden]" -->
<!-- subject="Re: [OMPI users] [Rocks-Discuss] compiling Openmpi on solaris	studio express" -->
<!-- id="4CF51702.5010803_at_ias.edu" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2010-11-30 10:23:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14951.php">Prentice Bisbal: "Re: [OMPI users] Help!!!!!!!!!!!!Openmpi instal for ubuntu 64 bits"</a>
<li><strong>Previous message:</strong> <a href="14949.php">Hicham Mouline: "Re: [OMPI users] failure to launch MPMD program on win32 w 1.4.3"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14952.php">Terry Dontje: "Re: [OMPI users] [Rocks-Discuss] compiling Openmpi on solaris	studio express"</a>
<li><strong>Reply:</strong> <a href="14952.php">Terry Dontje: "Re: [OMPI users] [Rocks-Discuss] compiling Openmpi on solaris	studio express"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Yes, that's exactly what I meant. I should have chosen something better
<br>
than &quot;-notpath&quot; to say &quot;put a value there that was not '-path'&quot;.
<br>
<p>Not sure if my suggestion will help, given the bug report below. If
<br>
you're really determined, you can always try editing all the makefiles
<br>
after configure. Something like this might work:
<br>
<p>find . -name Makefile -exec sed -i.bak s/-path/-L&lt;path&gt;/g \{\} \;
<br>
<p>Use that at your own risk. You might change instances of the string
<br>
...
<span class="quotelev1">&gt;     This problem looks a lot like a thread from earlier today.  Can you
</span><br>
<span class="quotelev1">&gt;     look at this
</span><br>
