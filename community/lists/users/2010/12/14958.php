...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14959.php">Hicham Mouline: "[OMPI users] win: mpic++ -showme reports duplicate .libs"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/11/14957.php">Shiqing Fan: "Re: [OMPI users] failure to launch MPMD program on win32 w 1.4.3"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2010/11/14957.php">Shiqing Fan: "Re: [OMPI users] failure to launch MPMD program on win32 w 1.4.3"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14960.php">Shiqing Fan: "Re: [OMPI users] failure to launch MPMD program on win32 w 1.4.3"</a>
<li><strong>Reply:</strong> <a href="14960.php">Shiqing Fan: "Re: [OMPI users] failure to launch MPMD program on win32 w 1.4.3"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
