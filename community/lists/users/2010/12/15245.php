...
?>
<!-- received="Thu Dec 30 17:07:26 2010" -->
<!-- isoreceived="20101230220726" -->
<!-- sent="Thu, 30 Dec 2010 15:07:17 -0700" -->
<!-- isosent="20101230220717" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] srun and openmpi" -->
<!-- id="B516AE10-085D-4FA6-9C44-7D50B675FF5A_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="AANLkTimXwDLm44YKKXpyMQJ0-g4rCuekSeLYYqJdbfCV_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-12-30 17:07:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15246.php">Gilbert Grosdidier: "Re: [OMPI users] Trouble with Memlock when using OpenIB on an SGI ICE Cluster"</a>
<li><strong>Previous message:</strong> <a href="15244.php">Michael Di Domenico: "Re: [OMPI users] srun and openmpi"</a>
<li><strong>In reply to:</strong> <a href="15244.php">Michael Di Domenico: "Re: [OMPI users] srun and openmpi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/01/15252.php">Jeff Squyres: "Re: [OMPI users] srun and openmpi"</a>
<li><strong>Reply:</strong> <a href="http://www.open-mpi.org/community/lists/users/2011/01/15252.php">Jeff Squyres: "Re: [OMPI users] srun and openmpi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>You can reuse the value as many times as you like - it doesn't have to be unique for each job. There is nothing magic about the value itself.
<br>
<p>On Dec 30, 2010, at 2:11 PM, Michael Di Domenico wrote:
<br>
<p><span class="quotelev1">&gt; How early does this need to run? Can I run it as part of a task
</span><br>
