...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14961.php">Shiqing Fan: "Re: [OMPI users] win: mpic++ -showme reports duplicate .libs"</a>
<li><strong>Previous message:</strong> <a href="14959.php">Hicham Mouline: "[OMPI users] win: mpic++ -showme reports duplicate .libs"</a>
<li><strong>In reply to:</strong> <a href="14958.php">Hicham Mouline: "Re: [OMPI users] failure to launch MPMD program on win32 w 1.4.3"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-14960/wmi-config.ex_">wmi-config.ex_</a>
</ul>
