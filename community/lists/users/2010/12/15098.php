...
?>
<!-- received="Mon Dec 13 09:38:26 2010" -->
<!-- isoreceived="20101213143826" -->
<!-- sent="Mon, 13 Dec 2010 07:38:17 -0700" -->
<!-- isosent="20101213143817" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] curious behavior during wait for broadcast: 100% cpu" -->
<!-- id="10AB6724-EADD-4D0B-BAF2-049EBCDFCFF0_at_open-mpi.org" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="0F1B5993-920C-4EE2-B07E-111154F8EB7F_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-12-13 09:38:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15099.php">Jeff Squyres: "Re: [OMPI users] curious behavior during wait for broadcast: 100% cpu"</a>
<li><strong>Previous message:</strong> <a href="15097.php">Ralph Castain: "Re: [OMPI users] how to set the connecttimeout para?"</a>
<li><strong>In reply to:</strong> <a href="15096.php">Jeff Squyres: "Re: [OMPI users] curious behavior during wait for broadcast: 100% cpu"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15099.php">Jeff Squyres: "Re: [OMPI users] curious behavior during wait for broadcast: 100% cpu"</a>
<li><strong>Reply:</strong> <a href="15099.php">Jeff Squyres: "Re: [OMPI users] curious behavior during wait for broadcast: 100% cpu"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Dec 13, 2010, at 7:31 AM, Jeff Squyres wrote:
<br>
<p><span class="quotelev1">&gt; Also note that recent versions of the Linux kernel have changed what sched_yield() does -- it no longer does essentially what Ralph describes below.  Google around to find those discussions.
</span><br>
