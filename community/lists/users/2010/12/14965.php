...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="14966.php">Price, Brian M (N-KCI): "[OMPI users] Open MPI vs IBM MPI performance help"</a>
<li><strong>Previous message:</strong> <a href="14964.php">Kalin Kanov: "Re: [OMPI users] Problem with MPI_Comm_accept in a dynamic client/server application"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="14970.php">Jeff Squyres: "Re: [OMPI users] How to avoid abort when calling MPI_Finalize without calling MPI_File_close?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
