...
?>
<!-- received="Thu Dec 16 06:36:26 2010" -->
<!-- isoreceived="20101216113626" -->
<!-- sent="Thu, 16 Dec 2010 06:36:23 -0500" -->
<!-- isosent="20101216113623" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] segmentation fault" -->
<!-- id="AC061C98-7E98-4328-AFCC-8374AB393DFC_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2010-12-16 06:36:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15171.php">Jeff Squyres: "Re: [OMPI users] problem when compiling ompenmpiV1.5.1"</a>
<li><strong>Previous message:</strong> <a href="15169.php">Bernard Secher - SFME/LGLS: "[OMPI users] [SPAM:### 85%] Re: [SPAM:### 83%] problem when compiling ompenmpiV1.5.1"</a>
<li><strong>In reply to:</strong> <a href="15164.php">Vaz, Guilherme: "Re: [OMPI users] segmentation fault"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15177.php">Gus Correa: "Re: [OMPI users] segmentation fault"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Dec 16, 2010, at 4:20 AM, Vaz, Guilherme wrote:
<br>
<p><span class="quotelev1">&gt; Ok, ok. It is indeed a CFD program, and Gus got it right. Number of cells per core means memory per core (sorry for the inaccuracy).
</span><br>
<span class="quotelev1">&gt; My PC has 12GB of RAM. And the same calculation runs fine in an old Ubuntu8.04 32bits with 4GB RAM.
</span><br>
<span class="quotelev1">&gt; What I find strange is that the same problems runs with 1 core (without evoking mpiexec) and then for large number of cores/processes, for instance mpiexec -n 32. Something in between not. And it is not a bug in the program because it runs in other machines and the code has not been changed.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Anymore hints?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
