...
?>
<!-- received="Mon Dec  6 14:21:49 2010" -->
<!-- isoreceived="20101206192149" -->
<!-- sent="Mon, 06 Dec 2010 14:21:39 -0500" -->
<!-- isosent="20101206192139" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_Send doesn't work if the data &amp;gt;= 2GB" -->
<!-- id="4CFD37C3.1070603_at_ldeo.columbia.edu" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2010-12-06 14:21:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15014.php">brad baker: "[OMPI users] glut display 'occasionally' opens"</a>
<li><strong>Previous message:</strong> <a href="15012.php">Gus Correa: "Re: [OMPI users] MPI_Send doesn't work if the data &gt;= 2GB"</a>
<li><strong>In reply to:</strong> <a href="15012.php">Gus Correa: "Re: [OMPI users] MPI_Send doesn't work if the data &gt;= 2GB"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15016.php">цооэ╬Э: "Re: [OMPI users] MPI_Send doesn't work if the data &gt;= 2GB"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Your Gsize may be OK.
<br>
Have you checked if your malloc returns a non-NULL pointer?
<br>
It is a lot of bytes ...
<br>
<p>Gus Correa
<br>
<p><span class="quotelev1">&gt; My two cents.
</span><br>
