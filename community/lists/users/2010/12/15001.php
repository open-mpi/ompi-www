...
?>
<!-- received="Sun Dec  5 22:23:54 2010" -->
<!-- isoreceived="20101206032354" -->
<!-- sent="Sun, 05 Dec 2010 19:23:42 -0800" -->
<!-- isosent="20101206032342" -->
<!-- name="Tim Prince" -->
<!-- email="n8tm_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_Send doesn't work if the data &amp;gt;= 2GB" -->
<!-- id="4CFC573E.8000702_at_aol.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2010-12-05 22:23:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="15002.php">цооэ╬Э: "Re: [OMPI users] MPI_Send doesn't work if the data &gt;= 2GB"</a>
<li><strong>Previous message:</strong> <a href="15000.php">&#195;&#207;&#207;&#220;&#190;&#252;: "[OMPI users] MPI_Send doesn't work if the data &gt;= 2GB"</a>
<li><strong>In reply to:</strong> <a href="15000.php">&#195;&#207;&#207;&#220;&#190;&#252;: "[OMPI users] MPI_Send doesn't work if the data &gt;= 2GB"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="15002.php">цооэ╬Э: "Re: [OMPI users] MPI_Send doesn't work if the data &gt;= 2GB"</a>
<li><strong>Reply:</strong> <a href="15002.php">цооэ╬Э: "Re: [OMPI users] MPI_Send doesn't work if the data &gt;= 2GB"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
On 12/5/2010 7:13 PM, &#229;&#173;&#159;&#229;&#174;&#170;&#229;&#134;&#155; wrote:
<br>
...
<br>
see this limit. Did you look at your &lt;mpi.h&gt; ?
<br>
<p><pre>
-- 
Tim Prince
