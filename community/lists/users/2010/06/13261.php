...
?>
<!-- received="Tue Jun  8 16:25:12 2010" -->
<!-- isoreceived="20100608202512" -->
<!-- sent="Tue, 8 Jun 2010 16:24:44 -0400" -->
<!-- isosent="20100608202444" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Res:  Res:  Res:  Res:  Gromacs run in parallel" -->
<!-- id="2BFF84C8-1F0B-4621-950C-8CE6CCCB9293_at_cisco.com" -->
<!-- charset="iso-8859-1" -->
...
<strong>Date:</strong> 2010-06-08 16:24:44
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13262.php">Gus Correa: "Re: [OMPI users] Res:  Res:  Res:  Res:  Gromacs run in parallel"</a>
<li><strong>Previous message:</strong> <a href="13260.php">lauren: "[OMPI users] Res:  Res:  Res:  Res:  Gromacs run in parallel"</a>
<li><strong>In reply to:</strong> <a href="13260.php">lauren: "[OMPI users] Res:  Res:  Res:  Res:  Gromacs run in parallel"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13262.php">Gus Correa: "Re: [OMPI users] Res:  Res:  Res:  Res:  Gromacs run in parallel"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Given all the back-n-forth here, you should probably try to get some simple Open MPI applications running, and then try to get Gromacs running.
<br>
<p>Try running the simple &quot;hello world&quot; and &quot;ring&quot; applications in the examples/ directory in the source tree of Open MPI (just type &quot;make&quot; in there and it should build them).  Try to run these applications on 1 node and across multiple nodes.
<br>
<p><p>On Jun 8, 2010, at 2:07 PM, lauren wrote:
<br>
<p><span class="quotelev1">&gt; One problem with versions or incompatibility can lead to a error like:
</span><br>
...
<span class="quotelev1">&gt; should give you which libraries the binary is looking for.  What does the above command do for your build.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; From: users-bounces_at_[hidden] [users-bounces_at_[hidden]] On Behalf Of lauren [owenlany_at_[hidden]]
</span><br>
...
<span class="quotelev1">&gt; De: Jeff Squyres &lt;jsquyres_at_[hidden]&lt;mailto:jsquyres_at_[hidden]&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt;&gt; De: Carsten Kutzner &lt;ckutzne_at_[hidden]&lt;mailto:ckutzne_at_[hidden]&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt; &gt;&gt; Para: Open MPI Users &lt;users_at_[hidden]&lt;mailto:users_at_[hidden]&gt;&gt;
</span><br>
