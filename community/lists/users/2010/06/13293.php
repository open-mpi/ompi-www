...
?>
<!-- received="Wed Jun  9 19:16:43 2010" -->
<!-- isoreceived="20100609231643" -->
<!-- sent="Wed, 9 Jun 2010 19:17:28 -0400" -->
<!-- isosent="20100609231728" -->
<!-- name="Audet, Martin" -->
<!-- email="Martin.Audet_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Unable to connect to a server using MX MTL with TCP" -->
<!-- id="9D96C3B9C12B4C4A9BD31761B4F824104610F42300_at_imibou-nt-1-ex.IMI.LOCAL" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CDA46015-F51A-41F0-856A-485ECD9AEB0D_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-06-09 19:17:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13294.php">David Zhang: "Re: [OMPI users] mpi_iprobe not behaving as expect"</a>
<li><strong>Previous message:</strong> <a href="13292.php">Gus Correa: "Re: [OMPI users] Running openMPI job with torque"</a>
<li><strong>In reply to:</strong> <a href="13285.php">Jeff Squyres: "Re: [OMPI users] Unable to connect to a server using MX MTL with TCP"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<br>
<p>Next time I have a problem, I will check the README file first (Doh !).
<br>
<p>Also we might mitigate the problem by connecting the workstation to the Myrinet switch.
<br>
<p>Martin
<br>
<p>-----Original Message-----
...
Subject: Re: [OMPI users] Unable to connect to a server using MX MTL with TCP
<br>
<p>On Jun 5, 2010, at 7:52 AM, Scott Atchley wrote:
<br>
