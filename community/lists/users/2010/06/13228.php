<?
$subject_val = "[OMPI users] RE : Unable to connect to a server using MX MTL with TCP";
include("../../include/msg-header.inc");
?>
<!-- received="Fri Jun  4 19:25:13 2010" -->
<!-- isoreceived="20100604232513" -->
<!-- sent="Fri, 4 Jun 2010 19:24:28 -0400" -->
<!-- isosent="20100604232428" -->
<!-- name="Audet, Martin" -->
<!-- email="Martin.Audet_at_[hidden]" -->
<!-- subject="[OMPI users] RE : Unable to connect to a server using MX MTL with TCP" -->
<!-- id="9D96C3B9C12B4C4A9BD31761B4F824104610D90700_at_imibou-nt-1-ex.IMI.LOCAL" -->
<!-- charset="iso-8859-1" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] RE : Unable to connect to a server using MX MTL with TCP<br>
<strong>From:</strong> Audet, Martin (<em>Martin.Audet_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-06-04 19:24:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13229.php">Scott Atchley: "Re: [OMPI users] Unable to connect to a server using MX MTL with TCP"</a>
<li><strong>Previous message:</strong> <a href="13227.php">Audet, Martin: "[OMPI users] Unable to connect to a server using MX MTL with TCP"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13229.php">Scott Atchley: "Re: [OMPI users] Unable to connect to a server using MX MTL with TCP"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Hi OpenMPI_Users and OpenMPI_Developers,
<br>
...
<br><hr>
<ul>
<li>text/x-csrc attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13228/simpleserver.c">simpleserver.c</a>
</ul>
<!-- attachment="simpleserver.c" -->
<hr>
<ul>
<li>text/x-csrc attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13228/simpleclient.c">simpleclient.c</a>
</ul>
<!-- attachment="simpleclient.c" -->
<hr>
<ul>
<li>application/x-gzip attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13228/ompi_info_all_cn18.gz">ompi_info_all_cn18.gz</a>
</ul>
<!-- attachment="ompi_info_all_cn18.gz" -->
<hr>
<ul>
<li>application/x-gzip attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13228/ompi_info_all_linux15.gz">ompi_info_all_linux15.gz</a>
</ul>
<!-- attachment="ompi_info_all_linux15.gz" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
