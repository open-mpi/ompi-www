...
<p class="headers">
<strong>Subject:</strong> [OMPI users] 1.4.2 build problem<br>
<strong>From:</strong> John R. Cary (<em>cary_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-06-01 17:27:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13198.php">Yves Caniou: "[OMPI users] Bugs in MPI_Abort() -- MPI_Finalize()?"</a>
<li><strong>Previous message:</strong> <a href="13196.php">Shiqing Fan: "Re: [OMPI users] heterogeneous cluster setup"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13202.php">Jeff Squyres: "Re: [OMPI users] 1.4.2 build problem"</a>
<li><strong>Reply:</strong> <a href="13202.php">Jeff Squyres: "Re: [OMPI users] 1.4.2 build problem"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
