...
?>
<!-- received="Wed Jun  9 18:42:42 2010" -->
<!-- isoreceived="20100609224242" -->
<!-- sent="Wed, 09 Jun 2010 18:42:32 -0400" -->
<!-- isosent="20100609224232" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running openMPI job with torque" -->
<!-- id="4C1018D8.7090204_at_ldeo.columbia.edu" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2010-06-09 18:42:32
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13293.php">Audet, Martin: "Re: [OMPI users] Unable to connect to a server using MX MTL with TCP"</a>
<li><strong>Previous message:</strong> <a href="13291.php">awwase: "[OMPI users] port_name information between Linux and Windows"</a>
<li><strong>In reply to:</strong> <a href="13287.php">Govind Songara: "Re: [OMPI users] Running openMPI job with torque"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13288.php">Govind Songara: "Re: [OMPI users] Running openMPI job with torque"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1"> &gt; The submission/execution hosts does not have any of the
</span><br>
...
<p>I missed the final part of your message,
<br>
about the Torque environment.
<br>
<p>This is now more of a Torque question,
<br>
and you may want to ask it in the Torque mailing list:
<br>
<p><a href="http://www.supercluster.org/mailman/listinfo/torqueusers">http://www.supercluster.org/mailman/listinfo/torqueusers</a>
<br>
<p>The Torque system administration guide may also help:
<br>
<p><a href="http://www.clusterresources.com/products/torque/docs/">http://www.clusterresources.com/products/torque/docs/</a>
<br>
<p>Anyway, you may not have configured Torque.
<br>
However, how did you figure out that the PBS_O_WORKDIR
<br>
and PBS_NODEFILE are not set?
<br>
<p>Try to put &quot;ls $PBS_O_WORKDIR&quot; and &quot;cat $PBS_NODEFILE&quot; in your
<br>
Torque/PBS script.  You can even comment out the mpirun command,
<br>
just to test the Torque environment.
<br>
<p>I think Torque sets them for each job, PBS_NODEFILE depends on
<br>
...
<br>
<p>Assuming your Torque is in /var/spool/torque (it may be different
<br>
...
<br>
<p>It should look somewhat like this
<br>
...
---------------------------------------------------------------------
<br>
<p><p>&nbsp;&nbsp;On 9 June 2010 18:45, Gus Correa &lt;gus_at_[hidden]
<br>
