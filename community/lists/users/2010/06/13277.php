...
?>
<!-- received="Wed Jun  9 12:00:58 2010" -->
<!-- isoreceived="20100609160058" -->
<!-- sent="Wed, 9 Jun 2010 17:00:33 +0100" -->
<!-- isosent="20100609160033" -->
<!-- name="Govind Songara" -->
<!-- email="govind.songara_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Running openMPI job with torque" -->
<!-- id="AANLkTimqvcWeiw9-MMzGvGjxYiR2kN68pgUH4l81nHUN_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="AB55F22C-9601-4C23-80D7-93A3B99F5352_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-06-09 12:00:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13278.php">Grzegorz Maj: "Re: [OMPI users] Specifying slots in rankfile"</a>
<li><strong>Previous message:</strong> <a href="13276.php">Ralph Castain: "Re: [OMPI users] Running openMPI job with torque"</a>
<li><strong>In reply to:</strong> <a href="13276.php">Ralph Castain: "Re: [OMPI users] Running openMPI job with torque"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13281.php">Ralph Castain: "Re: [OMPI users] Running openMPI job with torque"</a>
<li><strong>Reply:</strong> <a href="13281.php">Ralph Castain: "Re: [OMPI users] Running openMPI job with torque"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
there also a error
<br>
<span class="quotelev1">&gt;cat my-script.sh.e43
</span><br>
stty: standard input: Invalid argument
<br>
<p><p><p>On 9 June 2010 16:46, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; You need to include the path to &quot;hello&quot; unless it sits in your PATH
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I have installed following openMPI packge on worker node from repo
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I could run the  binary directly on the node without any problem.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  mpiexec -n 4 hello
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hello World! from process 2 out of 4 on node56.beowulf.cluster
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hello World! from process 0 out of 4 on node56.beowulf.cluster
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hello World! from process 3 out of 4 on node56.beowulf.cluster
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hello World! from process 1 out of 4 on node56.beowulf.cluster
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13277/attachment">attachment</a>
</ul>
