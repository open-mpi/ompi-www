...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13187.php">Hicham Lahlou: "[OMPI users] heterogeneous cluster setup"</a>
<li><strong>Previous message:</strong> <a href="13185.php">Javier Fern&#225;ndez: "[OMPI users] reasons for jitter other than paffinity"</a>
<li><strong>In reply to:</strong> <a href="../../2010/05/13184.php">guillaume ranquet: "Re: [OMPI users] Segmentation fault in MPI_Finalize with IB	hardware and memory manager."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13193.php">guillaume ranquet: "Re: [OMPI users] Segmentation fault in MPI_Finalize with	IB	hardware and memory manager."</a>
<li><strong>Reply:</strong> <a href="13193.php">guillaume ranquet: "Re: [OMPI users] Segmentation fault in MPI_Finalize with	IB	hardware and memory manager."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
