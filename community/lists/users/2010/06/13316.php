...
<p class="headers">
<strong>Subject:</strong> [OMPI users] A problem with 'mpiexec -launch-agent'<br>
<strong>From:</strong> Zhang Linbo (<em>zlb_at_[hidden]</em>)<br>
<strong>Date:</strong> 2010-06-13 03:02:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13317.php">HeeJin Kim: "[OMPI users] Problem with compilation : statically linked applications"</a>
<li><strong>Previous message:</strong> <a href="13315.php">David Zhang: "Re: [OMPI users] Master / Slave with Fortran / C languages"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13321.php">Reuti: "Re: [OMPI users] A problem with 'mpiexec -launch-agent'"</a>
<li><strong>Reply:</strong> <a href="13321.php">Reuti: "Re: [OMPI users] A problem with 'mpiexec -launch-agent'"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
