...
?>
<!-- received="Wed Jun 23 10:45:33 2010" -->
<!-- isoreceived="20100623144533" -->
<!-- sent="Wed, 23 Jun 2010 07:45:28 -0700 (PDT)" -->
<!-- isosent="20100623144528" -->
<!-- name="Randolph Pullen" -->
<!-- email="randolph_pullen_at_[hidden]" -->
<!-- subject="Re: [OMPI users] more Bugs in MPI_Abort() -- mpirun" -->
<!-- id="781086.96889.qm_at_web50808.mail.re2.yahoo.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="FF1FC5FE-DF3B-40BE-BE47-3A63CF037507_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-06-23 10:45:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13405.php">Ralph Castain: "Re: [OMPI users] more Bugs in MPI_Abort() -- mpirun"</a>
<li><strong>Previous message:</strong> <a href="13403.php">Durga Choudhury: "Re: [OMPI users] Roadrunner blasts past the petaflop mark with Open MPI"</a>
<li><strong>In reply to:</strong> <a href="13402.php">Ralph Castain: "Re: [OMPI users] more Bugs in MPI_Abort() -- mpirun"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13405.php">Ralph Castain: "Re: [OMPI users] more Bugs in MPI_Abort() -- mpirun"</a>
<li><strong>Reply:</strong> <a href="13405.php">Ralph Castain: "Re: [OMPI users] more Bugs in MPI_Abort() -- mpirun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Randolph
<br>
<p>PS: excellent product, keep up the good work
<br>
--- On Thu, 24/6/10, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
...
<br>
<p>mpirun is not an MPI process, so it makes no difference what your processes are doing wrt MPI_Abort or any other MPI function call.
<br>
...
<br>
<p>On Jun 23, 2010, at 6:53 AM, Randolph Pullen wrote:
<br>
ok,
<br>
...
<br>
<p>Open
 MPI's fault tolerance support is fairly rudimentary.&#160; If you kill any process without calling MPI_Finalize, Open MPI will -- by default -- kill all the others in the job.
<br>
...
<span class="quotelev1">&gt; --- On Wed, 23/6/10, David Zhang
...
<span class="quotelev1">&gt; 4G RAM, dual core intel
 all x86_64
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; [bd01:29136]
 [[55293,0],0]-[[55293,0],1] mca_oob_tcp_msg_recv: readv failed: Connection reset by peer (104)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13404/attachment">attachment</a>
</ul>
