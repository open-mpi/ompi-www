...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12862.php">Paul Kapinos: "[OMPI users] MPI_Comm_set_errhandler: error in Fortran90 Interface mpi.mod"</a>
<li><strong>Previous message:</strong> <a href="12860.php">Alan: "Re: [OMPI users] openmpi 1.4.1 and xgrid"</a>
<li><strong>In reply to:</strong> <a href="../../2010/04/12856.php">JiangjunZheng: "[OMPI users] Can compute, but can not output files"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12863.php">Mohamad Chaarawi: "Re: [OMPI users] Can compute, but can not output files"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
