...
?>
<!-- received="Fri May  7 17:49:45 2010" -->
<!-- isoreceived="20100507214945" -->
<!-- sent="Fri, 7 May 2010 17:49:40 -0400" -->
<!-- isosent="20100507214940" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem with mpi_comm_spawn_multiple" -->
<!-- id="FE5F6988-71A5-42EA-BE72-98B29F22A051_at_cisco.com" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2010-05-07 17:49:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12981.php">Andrew J Marquis: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<li><strong>Previous message:</strong> <a href="12979.php">Andrew J Marquis: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<li><strong>In reply to:</strong> <a href="12979.php">Andrew J Marquis: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12981.php">Andrew J Marquis: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<li><strong>Reply:</strong> <a href="12981.php">Andrew J Marquis: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<li><strong>Reply:</strong> <a href="12982.php">Andrew J Marquis: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Here's a simple tarball; can you try this with your compiler?  Just untar it and
<br>
<p>&nbsp;&nbsp;make CC=icc FC=ifort
<br>
&nbsp;&nbsp;./main
<br>
<p>Do you see only 6 entries in the array?
<br>
<p>(I have icc 9.0, but I'm now running RHEL 5.4, and the gcc version with it is too new for icc 9.0 -- so I can't run it)
<br>
<p><p>On May 7, 2010, at 5:44 PM, Andrew J Marquis wrote:
<br>
<p><span class="quotelev1">&gt; Dear Jeff,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;    am afraid not, as I said in my original post I am using the Intel ifort compiler version 9.0, i.e.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; fred_at_prandtl:~&gt;  mpif77 -V
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Intel(R) Fortran Compiler for Intel(R) EM64T-based applications, Version 9.0    Build 20060222 Package ID: &lt;installpackageid&gt;
</span><br>
...
<span class="quotelev1">&gt; I have been looking at this myself and have noted a couple of things, some of these need cross-checking (I am using different computers and different setups and different compilers and different openmpi releases !!!!!!)  but my thoughts at the moment are (point number (4) is possibly the most important so far):
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 1) If I allocate the string array using an allocate statement then I see that ALL of the string locations are initialised to &quot;\0&quot; (character 0).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 2) If I set part of a location in the string array then all the OTHER characters in the same location are set to &quot; &quot; (character 32).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 3) If the character array is defined via a dimension statement then the locations in the array seem to be initialised at random.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 4) Looking at the output from my test program I noticed and odd pattern in the arguments being sent to the slaves (yes I do need to quantify this better !!). However this caused me to look at the ompi source, in particular I am looking at:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;    openmpi-1.4.1/ompi/mpi/f77/base/strings.c
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; In particular at the bottom (line 156( in function &quot;ompi_fortran_multiple_argvs_f2c&quot; at the end of the for statement there is the line:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;    current_array += len * i;
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; The &quot;* i&quot; looks wrong to me I am thinking it should just be:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;    current_array += len;
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; making this change improves things BUT like you suggest in your email there seems to be a problem locating the end of the 2d-array elements.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; I will try and look at this more over the w/e.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Fri, May 07, 2010 at 10:02:48PM +0100, Jeff Squyres wrote:
</span><br>
<span class="quotelev2">&gt; &gt; Greetings Fred.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; After looking at this for more hours than I'd care to admit, I'm wondering if this is a bug in gfortran.  I can replicate your problem with a simple program on gfortran 4.1 on RHEL 5.4, but it doesn't happen with the Intel Fortran compiler (11.1) or the PGI fortran compiler (10.0).
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; One of the issues appears how to determine how Fortran 2d CHARACTER arrays are terminated.  I can't figure out how gfortran is terminating them -- but intel and PGI both terminate them by having an empty string at the end.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; Are you using gfortran 4.1, perchance?
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt;
...
<span class="quotelev2">&gt; &gt; On May 5, 2010, at 2:08 PM, Fred Marquis wrote:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<hr>
<ul>
<li>application/x-bzip2 attachment: <a href="http://www.open-mpi.org/community/lists/users/att-12980/fortran-c-2d-char.tar.bz2">fortran-c-2d-char.tar.bz2</a>
</ul>
