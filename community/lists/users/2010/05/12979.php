...
?>
<!-- received="Fri May  7 17:45:06 2010" -->
<!-- isoreceived="20100507214506" -->
<!-- sent="Fri, 7 May 2010 22:44:59 +0100" -->
<!-- isosent="20100507214459" -->
<!-- name="Andrew J Marquis" -->
<!-- email="a.marquis_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem with mpi_comm_spawn_multiple" -->
<!-- id="20100507214459.GA2025_at_mefred01.me.ic.ac.uk" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="E65F094E-A8D6-4321-9216-554B4B088015_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-05-07 17:44:59
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12980.php">Jeff Squyres: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<li><strong>Previous message:</strong> <a href="12978.php">Cristobal Navarro: "Re: [OMPI users] communicate C++ STL strucutures ??"</a>
<li><strong>In reply to:</strong> <a href="12977.php">Jeff Squyres: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12980.php">Jeff Squyres: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<li><strong>Reply:</strong> <a href="12980.php">Jeff Squyres: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<li><strong>Reply:</strong> <a href="12983.php">Noam Bernstein: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Dear Jeff,
<br>
<p>&nbsp;&nbsp;&nbsp;am afraid not, as I said in my original post I am using the Intel ifort compiler version 9.0, i.e.
<br>
<p>fred_at_prandtl:~&gt;  mpif77 -V
<br>
<p>Intel(R) Fortran Compiler for Intel(R) EM64T-based applications, Version 9.0    Build 20060222 Package ID: &lt;installpackageid&gt;
<br>
Copyright (C) 1985-2006 Intel Corporation.  All rights reserved.
<br>
FOR NON-COMMERCIAL USE ONLY
<br>
<p><p>I have been looking at this myself and have noted a couple of things, some of these need cross-checking (I am using different computers and different setups and different compilers and different openmpi releases !!!!!!)  but my thoughts at the moment are (point number (4) is possibly the most important so far):
<br>
<p>1) If I allocate the string array using an allocate statement then I see that ALL of the string locations are initialised to &quot;\0&quot; (character 0).
<br>
<p>2) If I set part of a location in the string array then all the OTHER characters in the same location are set to &quot; &quot; (character 32). 
<br>
<p>3) If the character array is defined via a dimension statement then the locations in the array seem to be initialised at random.
<br>
<p>4) Looking at the output from my test program I noticed and odd pattern in the arguments being sent to the slaves (yes I do need to quantify this better !!). However this caused me to look at the ompi source, in particular I am looking at:
<br>
<p>&nbsp;&nbsp;&nbsp;openmpi-1.4.1/ompi/mpi/f77/base/strings.c
<br>
<p>In particular at the bottom (line 156( in function &quot;ompi_fortran_multiple_argvs_f2c&quot; at the end of the for statement there is the line:
<br>
&nbsp;
<br>
&nbsp;&nbsp;&nbsp;current_array += len * i;
<br>
<p>The &quot;* i&quot; looks wrong to me I am thinking it should just be:
<br>
<p>&nbsp;&nbsp;&nbsp;current_array += len;
<br>
<p>making this change improves things BUT like you suggest in your email there seems to be a problem locating the end of the 2d-array elements.
<br>
<p><p><p>I will try and look at this more over the w/e.
<br>
<p>Fred Marquis.
<br>
<p><p>On Fri, May 07, 2010 at 10:02:48PM +0100, Jeff Squyres wrote:
<br>
<span class="quotelev1">&gt; Greetings Fred.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; After looking at this for more hours than I'd care to admit, I'm wondering if this is a bug in gfortran.  I can replicate your problem with a simple program on gfortran 4.1 on RHEL 5.4, but it doesn't happen with the Intel Fortran compiler (11.1) or the PGI fortran compiler (10.0).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; One of the issues appears how to determine how Fortran 2d CHARACTER arrays are terminated.  I can't figure out how gfortran is terminating them -- but intel and PGI both terminate them by having an empty string at the end.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Are you using gfortran 4.1, perchance?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; On May 5, 2010, at 2:08 PM, Fred Marquis wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
