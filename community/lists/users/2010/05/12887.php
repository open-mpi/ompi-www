...
?>
<!-- received="Tue May  4 18:51:58 2010" -->
<!-- isoreceived="20100504225158" -->
<!-- sent="Tue, 04 May 2010 18:51:49 -0400" -->
<!-- isosent="20100504225149" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How do I run OpenMPI safely on	a	Nehalem	standalone machine?" -->
<!-- id="4BE0A505.2000005_at_ldeo.columbia.edu" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="0D4ABFDD-9802-4D77-BF70-C7EC3198F32A_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-05-04 18:51:49
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12888.php">Ralph Castain: "Re: [OMPI users] How do I run OpenMPI safely on	a	Nehalem	standalone machine?"</a>
<li><strong>Previous message:</strong> <a href="12886.php">Gus Correa: "Re: [OMPI users] How do I run OpenMPI safely on a	Nehalem	standalone machine?"</a>
<li><strong>In reply to:</strong> <a href="12885.php">Ralph Castain: "Re: [OMPI users] How do I run OpenMPI safely on a	Nehalem	standalone machine?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12888.php">Ralph Castain: "Re: [OMPI users] How do I run OpenMPI safely on	a	Nehalem	standalone machine?"</a>
<li><strong>Reply:</strong> <a href="12888.php">Ralph Castain: "Re: [OMPI users] How do I run OpenMPI safely on	a	Nehalem	standalone machine?"</a>
<li><strong>Reply:</strong> <a href="12903.php">Prentice Bisbal: "Re: [OMPI users] How do I run OpenMPI safely on	a	Nehalem	standalone machine?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<span class="quotelev1">&gt; One possibility is that the sm btl might not like that 
</span><br>
<span class="quotelev1">&gt; you have hyperthreading enabled.
</span><br>
<p>I remember that hyperthreading was discussed months ago,
<br>
...
<br>
<p>I don't really administer that machine,
<br>
...
<br>
<p>I didn't turn on or off any paffinity setting explicitly,
<br>
...
<br>
<p><span class="quotelev1">&gt; Our paffinity system doesn't handle hyperthreading at this time.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<p>OK, so *if* paffinity is on by default (Is it?),
<br>
...
<br>
<p><span class="quotelev1">&gt; I'm just suspicious of the HT since you have a quad-core machine, 
</span><br>
...
<p>Gus
<br>
<p><span class="quotelev1">&gt; On May 4, 2010, at 3:44 PM, Gus Correa wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; It seems to be using tcp, because when I try -np 256 I get this error:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [spinoza:02715] [[11518,0],0] ORTE_ERROR_LOG: The system limit on number
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Error: system limit exceeded on number of network connections that can
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; processors on real jobs anyway (and the very error message suggests a
</span><br>
