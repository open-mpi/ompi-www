...
?>
<!-- received="Tue May  4 17:34:43 2010" -->
<!-- isoreceived="20100504213443" -->
<!-- sent="Tue, 4 May 2010 16:34:38 -0500" -->
<!-- isosent="20100504213438" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] How do I run OpenMPI safely on a Nehalem	standalone machine?" -->
<!-- id="441ACF3B-34A9-4FF5-B78E-B9A8DF4E87F3_at_cisco.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="4BE08F2A.6000101_at_ldeo.columbia.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-05-04 17:34:38
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12884.php">Gus Correa: "Re: [OMPI users] How do I run OpenMPI safely on a	Nehalem	standalone machine?"</a>
<li><strong>Previous message:</strong> <a href="12882.php">Vedran Coralic: "Re: [OMPI users] Fortran derived types"</a>
<li><strong>In reply to:</strong> <a href="12880.php">Gus Correa: "Re: [OMPI users] How do I run OpenMPI safely on a Nehalem	standalone machine?"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12884.php">Gus Correa: "Re: [OMPI users] How do I run OpenMPI safely on a	Nehalem	standalone machine?"</a>
<li><strong>Reply:</strong> <a href="12884.php">Gus Correa: "Re: [OMPI users] How do I run OpenMPI safely on a	Nehalem	standalone machine?"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On May 4, 2010, at 4:18 PM, Gus Correa wrote:
<br>
