...
?>
<!-- received="Mon May 10 08:15:45 2010" -->
<!-- isoreceived="20100510121545" -->
<!-- sent="Mon, 10 May 2010 14:15:39 +0200" -->
<!-- isosent="20100510121539" -->
<!-- name="Miguel &#193;ngel V&#225;zquez" -->
<!-- email="mavazquez.at.cttc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Dynamic libraries in OpenMPI" -->
<!-- id="AANLkTinnG4RUlie82kad8ifKz0k2BTN1tz7EVrdLo2Wf_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="DF419C69-A1B9-436C-8263-C28623F9D41C_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-05-10 08:15:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12995.php">Ralph Castain: "Re: [OMPI users] Dynamic libraries in OpenMPI"</a>
<li><strong>Previous message:</strong> <a href="12993.php">Ralph Castain: "Re: [OMPI users] Dynamic libraries in OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="12993.php">Ralph Castain: "Re: [OMPI users] Dynamic libraries in OpenMPI"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12995.php">Ralph Castain: "Re: [OMPI users] Dynamic libraries in OpenMPI"</a>
<li><strong>Reply:</strong> <a href="12995.php">Ralph Castain: "Re: [OMPI users] Dynamic libraries in OpenMPI"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Shell: bash
<br>
<p>I already fixed the problem with a shell script like
<br>
#!/bin/sh
<br>
...
./montecarlo
<br>
<p>But, it seems that openmpi look neither bash_profile not .bashrc.
<br>
<p>Thank you,
<br>
<p>Miguel
...
<br>
<p><span class="quotelev1">&gt; What version of OMPI? What shell?
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-12994/attachment">attachment</a>
</ul>
