...
?>
<!-- received="Wed May 12 18:09:26 2010" -->
<!-- isoreceived="20100512220926" -->
<!-- sent="Wed, 12 May 2010 16:09:17 -0600" -->
<!-- isosent="20100512220917" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] opal_cr_tmp_dir" -->
<!-- id="73DBF16A-9C00-46A4-8039-BC4ACAE6880B_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="1E3BF6B8D1243842A175F7C7069EB0E70712AF11_at_usa-mv-msg.wipro.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2010-05-12 18:09:17
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13039.php">ananda.mudar_at_[hidden]: "[OMPI users] (no subject)"</a>
<li><strong>Previous message:</strong> <a href="13037.php">ananda.mudar_at_[hidden]: "Re: [OMPI users] opal_cr_tmp_dir"</a>
<li><strong>In reply to:</strong> <a href="13037.php">ananda.mudar_at_[hidden]: "Re: [OMPI users] opal_cr_tmp_dir"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13040.php">ananda.mudar_at_[hidden]: "Re: [OMPI users] opal_cr_tmp_dir"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
You shouldn't have to, but there may be a bug in the system. Try manually setting both envars and see if it fixes the problem.
<br>
<p><p>On May 12, 2010, at 3:59 PM, &lt;ananda.mudar_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; ompi-restart just does a fork/exec of the mpirun, so it should get the param if it is in your environ. How are you setting it? Have you tried adding OMPI_MCA_opal_cr_tmp_dir=&lt;whatever&gt; to your environment?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt; Another question. Even though I am setting opal_cr_tmp_dir to a directory other than /tmp while calling ompi-restart command, this setting is not getting passed to the mpirun command that gets generated by ompi-restart. How do I overcome this constraint? 
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; 
...
<span class="quotelev2">&gt; &gt; Previous message: ananda.mudar_at_[hidden]: &quot;[OMPI users] opal_cr_tmp_dir&quot; 
</span><br>
<span class="quotelev2">&gt; &gt; In reply to: ananda.mudar_at_[hidden]: &quot;[OMPI users] opal_cr_tmp_dir&quot; 
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; I am setting the MCA parameter &#147;opal_cr_tmp_dir&#148; to a directory other than /tmp while calling &#147;mpirun&#148;, &#147;ompi-restart&#148;, and &#147;ompi-checkpoint&#148; commands so that I don&#146;t fill up /tmp filesystem. But I see that openmpi-sessions* directory is still getting created under /tmp. How do I overcome this problem so that openmpi-sessions* directory also gets created under the same directory I have defined for &#147;opal_cr_tmp_dir&#148;? 
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 
</span><br>
<span class="quotelev3">&gt; &gt; &gt; Is there a way to clean up these temporary files after their requirement is over? 
</span><br>
<span class="quotelev3">&gt; &gt; &gt; 
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-13038/attachment">attachment</a>
</ul>
