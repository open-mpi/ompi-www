...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12863.php">Mohamad Chaarawi: "Re: [OMPI users] Can compute, but can not output files"</a>
<li><strong>Previous message:</strong> <a href="12861.php">Jeff Squyres: "Re: [OMPI users] Can compute, but can not output files"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12865.php">Jeff Squyres: "Re: [OMPI users] MPI_Comm_set_errhandler: error in Fortran90 Interfacempi.mod"</a>
<li><strong>Reply:</strong> <a href="12865.php">Jeff Squyres: "Re: [OMPI users] MPI_Comm_set_errhandler: error in Fortran90 Interfacempi.mod"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p><hr>
<ul>
<li>text/x-fortran attachment: <a href="../../att-12862/MPI_Comm_set_errhandler.f90">MPI_Comm_set_errhandler.f90</a>
</ul>
<!-- attachment="MPI_Comm_set_errhandler.f90" -->
<hr>
<ul>
<li>application/x-pkcs7-signature attachment: <a href="../../att-12862/smime.p7s">S/MIME Cryptographic Signature</a>
</ul>
