...
?>
<!-- received="Fri May  7 18:06:48 2010" -->
<!-- isoreceived="20100507220648" -->
<!-- sent="Fri, 7 May 2010 23:06:41 +0100" -->
<!-- isosent="20100507220641" -->
<!-- name="Andrew J Marquis" -->
<!-- email="a.marquis_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problem with mpi_comm_spawn_multiple" -->
<!-- id="20100507220641.GA2492_at_mefred01.me.ic.ac.uk" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2010-05-07 18:06:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="12982.php">Andrew J Marquis: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<li><strong>Previous message:</strong> <a href="12980.php">Jeff Squyres: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<li><strong>In reply to:</strong> <a href="12980.php">Jeff Squyres: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="12982.php">Andrew J Marquis: "Re: [OMPI users] Problem with mpi_comm_spawn_multiple"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>&nbsp;&nbsp;thats odd !!
<br>
<p>fred_at_prandtl:~/test/fortran-c-2d-char&gt; make CC=icc FC=ifort
<br>
ifort -g  -c -o main.o main.f
<br>
icc -g   -c -o c_func.o c_func.c
<br>
<p>Error: A license for CComp is not available (-5,357).
<br>
<p><p><p><p>I will look into this tomorrow, time for bed I am afraid !!
<br>
<p>Fred Marquis.
<br>
<p>On Fri, May 07, 2010 at 10:49:40PM +0100, Jeff Squyres wrote:
<br>
