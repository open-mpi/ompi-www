...
?>
<!-- received="Mon May 31 07:27:46 2010" -->
<!-- isoreceived="20100531112746" -->
...
<!-- id="060AC0B7-C97F-4AEE-92B9-63D044854723_at_icc.uji.es" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="4BF6C97A.7050104_at_myri.com" -->
<!-- expires="-1" -->
<div class="center">
...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="13189.php">guillaume ranquet: "[OMPI users] Segmentation fault in MPI_Finalize with IB hardware and memory manager."</a>
<li><strong>Previous message:</strong> <a href="13187.php">Shiqing Fan: "Re: [OMPI users] Process doesn't exit on remote machine when using hostfile"</a>
<li><strong>In reply to:</strong> <a href="13126.php">Patrick Geoffray: "Re: [OMPI users] GM + OpenMPI bug ..."</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="13309.php">José Ignacio Aliaga Estellés: "Re: [OMPI users] GM + OpenMPI bug ..."</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
