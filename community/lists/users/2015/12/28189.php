<?
$subject_val = "[OMPI users] Open MPI v1.10.2rc1 available";
...
<!-- subject="[OMPI users] Open MPI v1.10.2rc1 available" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Open MPI v1.10.2rc1 available<br>
<strong>From:</strong> Ralph Castain (<em>rhc_at_[hidden]</em>)<br>
<strong>Date:</strong> 2015-12-19 11:35:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28190.php">Matt Thompson: "[OMPI users] Help with Binding in 1.8.8: Use only second socket"</a>
<li><strong>Previous message:</strong> <a href="28188.php">GARMANN, DANIEL J DR-02 USAF AFMC AFRL/RQVA: "Re: [OMPI users] Odd behavior with subarray datatypes in OpenMPI 1.10.1"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28189/attachment">attachment</a>
</ul>
