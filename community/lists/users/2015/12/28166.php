...
?>
<!-- received="Wed Dec 16 14:15:33 2015" -->
<!-- isoreceived="20151216191533" -->
<!-- sent="Wed, 16 Dec 2015 19:15:28 +0000" -->
<!-- isosent="20151216191528" -->
<!-- name="Jingchao Zhang" -->
<!-- email="zhang_at_[hidden]" -->
<!-- subject="Re: [OMPI users] performance issue with OpenMPI 1.10.1" -->
<!-- id="SN2PR0801MB592FCD67782D3550E8DFD58ADEF0_at_SN2PR0801MB592.namprd08.prod.outlook.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="566FAEFB.70904_at_rist.or.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-12-16 14:15:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28167.php">Udayanga Wickramasinghe: "[OMPI users] OpenMPI non blocking I_Allreduce segfaults when using custom function.."</a>
<li><strong>Previous message:</strong> <a href="28165.php">Gilles Gouaillardet: "Re: [OMPI users] Does openMPI allows a 32-bit binary on 32-bit machine to communicate with a 64-bit binary on a 64-bit machine??"</a>
<li><strong>In reply to:</strong> <a href="28162.php">Gilles Gouaillardet: "Re: [OMPI users] performance issue with OpenMPI 1.10.1"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28168.php">Ralph Castain: "Re: [OMPI users] performance issue with OpenMPI 1.10.1"</a>
<li><strong>Reply:</strong> <a href="28168.php">Ralph Castain: "Re: [OMPI users] performance issue with OpenMPI 1.10.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi Gilles,
<br>
<p><p>The LAMMPS jobs for both versions are pure MPI. In the SLURM script, 64 cores are requested from 4 nodes. So it's 64 MPI tasks and not necessarily evenly distributed across all the nodes. (each node is equipped with 64 cores.)
<br>
<p><p>I can reproduce the performance issue using the LAMMPS example &quot;VISCOSITY/in.wall.2d&quot;. The run time difference is a jaw-dropping 20 seconds (v-1.8.4) vs. 45 mins (v-1.10.1). Among the multiple tests, I do have one job using v-1.10.1 finished in 20 seconds. Again, unstable performance. We also tested other software packages such as cp2k, VASP and Quantum Espresso, and they all have similar issues.
<br>
<p><p>Here is the decomposed MPI time in the LAMMPS job outputs.
<br>
<p>v-1.8.4 (Job execution time: 00:00:20)
<br>
...
<br>
<p><p>v-1.10.1 (Job execution time: 00:45:50)
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28166/attachment">attachment</a>
</ul>
