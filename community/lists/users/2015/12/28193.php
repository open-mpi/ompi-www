<?
$subject_val = "[OMPI users] openmpi-2.0.0rc1: wrong ELF class on Solaris";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Dec 21 10:42:48 2015" -->
<!-- isoreceived="20151221154248" -->
<!-- sent="Mon, 21 Dec 2015 12:46:13 +0100" -->
<!-- isosent="20151221114613" -->
<!-- name="Siegmar Gross" -->
<!-- email="Siegmar.Gross_at_[hidden]" -->
<!-- subject="[OMPI users] openmpi-2.0.0rc1: wrong ELF class on Solaris" -->
<!-- id="5677E685.7030809_at_informatik.hs-fulda.de" -->
<!-- charset="utf-8" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] openmpi-2.0.0rc1: wrong ELF class on Solaris<br>
<strong>From:</strong> Siegmar Gross (<em>Siegmar.Gross_at_[hidden]</em>)<br>
<strong>Date:</strong> 2015-12-21 06:46:13
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28194.php">Siegmar Gross: "[OMPI users] openmpi-dev-3241-gc895eb7: wrong ELF class on Solaris"</a>
<li><strong>Previous message:</strong> <a href="28192.php">Siegmar Gross: "[OMPI users] openmpi-1.10.2rc1: wrong ELF class on Solaris"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Hi,
<br>
<p>yesterday I tried to build openmpi-2.0.0rc1 on my machines
<br>
...
<br>
<p>mkdir openmpi-2.0.0rc1-${SYSTEM_ENV}.${MACHINE_ENV}.64_gcc
<br>
cd openmpi-2.0.0rc1-${SYSTEM_ENV}.${MACHINE_ENV}.64_gcc
<br>
<p>../openmpi-2.0.0rc1/configure \
<br>
...
<br>
<p><p><p>sunpc1 openmpi-2.0.0rc1-SunOS.x86_64.64_gcc 77 tail -16 
<br>
...
<br>
<p><p><p>sunpc1 openmpi-2.0.0rc1-SunOS.x86_64.64_cc 79 tail -12 log.make.SunOS.x86_64.64_cc
<br>
