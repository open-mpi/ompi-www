<?
$subject_val = "[OMPI users] Odd behavior with subarray datatypes in OpenMPI 1.10.1";
include("../../include/msg-header.inc");
?>
<!-- received="Tue Dec  8 12:56:22 2015" -->
<!-- isoreceived="20151208175622" -->
<!-- sent="Tue, 8 Dec 2015 17:56:07 +0000" -->
<!-- isosent="20151208175607" -->
...
<!-- id="4641861431110A4D99D995E4B7CC6B4511BB4F3F_at_52ZHTX-D02-01A.area52.afnoapps.usaf.mil" -->
<!-- charset="us-ascii" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] Odd behavior with subarray datatypes in OpenMPI 1.10.1<br>
<strong>From:</strong> GARMANN, DANIEL J DR-02 USAF AFMC AFRL/RQVA (<em>daniel.garmann_at_[hidden]</em>)<br>
<strong>Date:</strong> 2015-12-08 12:56:07
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28143.php">Gilles Gouaillardet: "Re: [OMPI users] Odd behavior with subarray datatypes in OpenMPI 1.10.1"</a>
<li><strong>Previous message:</strong> <a href="28141.php">&#195;&#133;ke Sandgren: "Re: [OMPI users] my_sense in ompi_osc_sm_module_t not always protected by OPAL_HAVE_POSIX_THREADS"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28143.php">Gilles Gouaillardet: "Re: [OMPI users] Odd behavior with subarray datatypes in OpenMPI 1.10.1"</a>
<li><strong>Reply:</strong> <a href="28143.php">Gilles Gouaillardet: "Re: [OMPI users] Odd behavior with subarray datatypes in OpenMPI 1.10.1"</a>
<li><strong>Reply:</strong> <a href="28188.php">GARMANN, DANIEL J DR-02 USAF AFMC AFRL/RQVA: "Re: [OMPI users] Odd behavior with subarray datatypes in OpenMPI 1.10.1"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br><hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28142/test_extent.f90">test_extent.f90</a>
</ul>
<!-- attachment="test_extent.f90" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
