...
?>
<!-- received="Thu Aug  6 13:58:41 2015" -->
<!-- isoreceived="20150806175841" -->
<!-- sent="Thu, 6 Aug 2015 11:58:39 -0600" -->
<!-- isosent="20150806175839" -->
<!-- name="Howard Pritchard" -->
<!-- email="hppritcha_at_[hidden]" -->
<!-- subject="Re: [OMPI users] segfault on java binding from MPI.init()" -->
<!-- id="CAF1Cqj4StwENrjJwdaAXetMh=sQGhqt6K9f8AEUKHzFEeJtLfw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
...
<strong>Date:</strong> 2015-08-06 13:58:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27406.php">Nate Chambers: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<li><strong>Previous message:</strong> <a href="27404.php">Ralph Castain: "Re: [OMPI users] bad XRC API"</a>
<li><strong>In reply to:</strong> <a href="27399.php">Nate Chambers: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27406.php">Nate Chambers: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<li><strong>Reply:</strong> <a href="27406.php">Nate Chambers: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
HI Nate,
<br>
<p>We're trying this out on a mac running mavericks and a cray xc system.
<br>
the mac has java 8
<br>
while the cray xc has java 7.
<br>
<p>We could not get the code to run just using the java launch command,
<br>
although we noticed if you add
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;catch(NoClassDefFoundError e) {
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;System.out.println(&quot;Not using MPI its out to lunch for now&quot;);
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;}
<br>
<p>as one of the catches after the try for firing up MPI, you can get further.
<br>
<p>Instead we tried on the two systems using
<br>
<p>mpirun -np 1 java MPITestBroke tweets repeat.txt
<br>
<p>and, you guessed it, we can't reproduce the error, at least using master.
<br>
<p>Would you mind trying to get a copy of nightly master build off of
<br>
<p><a href="http://www.open-mpi.org/nightly/master/">http://www.open-mpi.org/nightly/master/</a>
<br>
<p>and install that version and give it a try.
<br>
<p>If that works, then I'd suggest using master (or v2.0) for now.
<br>
<p>Howard
<br>
<p><p><p><p>2015-08-05 14:41 GMT-06:00 Nate Chambers &lt;nchamber_at_[hidden]&gt;:
<br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27405/attachment">attachment</a>
</ul>
