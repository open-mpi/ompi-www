...
?>
<!-- received="Sat Aug 15 18:30:14 2015" -->
<!-- isoreceived="20150815223014" -->
<!-- sent="Sat, 15 Aug 2015 16:30:11 -0600" -->
<!-- isosent="20150815223011" -->
<!-- name="Howard Pritchard" -->
<!-- email="hppritcha_at_[hidden]" -->
<!-- subject="Re: [OMPI users] segfault on java binding from MPI.init()" -->
<!-- id="CAF1Cqj4r0ScJY3pbKiZ6C7+tsSYrS0sKN79XTdvAxhpncmiKJA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAAkFZ5siohYBfRE2qX=HdbnQ=GL0i2iADkK4zFWkuV7Y=OoLtA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-08-15 18:30:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27481.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Bug in ompi/errhandler/errcode.h (1.8.6)?"</a>
<li><strong>Previous message:</strong> <a href="27479.php">Gilles Gouaillardet: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<li><strong>In reply to:</strong> <a href="27479.php">Gilles Gouaillardet: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27486.php">Nate Chambers: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<li><strong>Reply:</strong> <a href="27486.php">Nate Chambers: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gilles,
<br>
<p>On hopper there aren't any psm libraries - its an infiniband/infinipath
<br>
free system -
<br>
at least on the compute nodes.
<br>
<p>For my own work, I never use things like the platform files, I just do
<br>
./configure --prefix=blahblah --enable-mpi-java (and whatever else I want
<br>
to test this tie)
<br>
<p>Thanks for the ideas though,
<br>
<p>Howard
<br>
<p><p>2015-08-14 19:20 GMT-06:00 Gilles Gouaillardet &lt;
<br>
...
<span class="quotelev1">&gt; I have no infinipath hardware, but the infinipath libraries are installed.
</span><br>
<span class="quotelev1">&gt; I tried to run with --mca mtl_psm_priority 0 instead of --mca mtl ^psm
</span><br>
<span class="quotelev1">&gt; but that did not work.
</span><br>
<span class="quotelev1">&gt; without psm mtl, I was unable to reproduce the persistent communication
</span><br>
<span class="quotelev1">&gt; issue,
</span><br>
<span class="quotelev1">&gt; so I concluded there was only one issue here.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; do you configure with --disable-dlopen on hopper ?
</span><br>
<span class="quotelev1">&gt; I wonder whether --mca mtl ^psm is effective if dlopen is disabled
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Saturday, August 15, 2015, Howard Pritchard &lt;hppritcha_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; I don't know why Gilles keeps picking on the persistent request problem
</span><br>
<span class="quotelev2">&gt;&gt; and mixing
</span><br>
<span class="quotelev2">&gt;&gt; it up with this user bug.  I do think for this user the psm probably is
</span><br>
...
<span class="quotelev2">&gt;&gt; They don't have anything to do with each other.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; I can reproduce the persistent request problem on hopper consistently.
</span><br>
<span class="quotelev2">&gt;&gt; As I said
</span><br>
<span class="quotelev2">&gt;&gt; on the telecon last week it has something to do with memory corruption
</span><br>
<span class="quotelev2">&gt;&gt; with the
</span><br>
<span class="quotelev2">&gt;&gt; receive buffer that is associated with the persistent request.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; 2015-08-14 11:21 GMT-06:00 Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt;:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hmm.  Oscar's not around to ask any more, but I'd be greatly surprised
</span><br>
<span class="quotelev3">&gt;&gt;&gt; if he had InfiniPath on his systems where he ran into this segv issue...?
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; On Aug 14, 2015, at 1:08 PM, Howard Pritchard &lt;hppritcha_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt; Good catch!  Nate we hadn't been testing on a infinipath system.
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt; 2015-08-14 0:20 GMT-06:00 Gilles Gouaillardet &lt;gilles_at_[hidden]&gt;:
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; Nate,
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; i could get rid of the problem by not using the psm mtl.
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; the infinipath library (used by the psm mtl) sets some signal handlers
</span><br>
<span class="quotelev3">&gt;&gt;&gt; that conflict with the JVM
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; that can be seen by running
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; mpirun -np 1 java -Xcheck:jni MPITestBroke data/
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; so instead of running
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; mpirun -np 1 java MPITestBroke data/
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; please run
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; mpirun --mca mtl ^psm -np 1 java MPITestBroke data/
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; that solved the issue for me
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt; On 8/13/2015 9:19 AM, Nate Chambers wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; I appreciate you trying to help! I put the Java and its compiled
</span><br>
<span class="quotelev3">&gt;&gt;&gt; .class file on Dropbox. The directory contains the .java and .class files,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; as well as a data/ directory:
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; your debug flag. Lots of debug lines.
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; Also, if you could put your MPITestBroke.class file somewhere (like
</span><br>
<span class="quotelev3">&gt;&gt;&gt; google drive)
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; where we could get it and try to run locally or at NERSC, that might
</span><br>
<span class="quotelev3">&gt;&gt;&gt; help us
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; narrow down the problem.    Better yet, if you have the class or jar
</span><br>
<span class="quotelev3">&gt;&gt;&gt; file for
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; I tried the nightly build openmpi-dev-2223-g731cfe3 and it still
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://bugzilla.redhat.com/bugzilla">http://bugzilla.redhat.com/bugzilla</a> --enable-bootstrap --enable-shared
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --enable-threads=posix --enable-checking=release --with-system-zlib
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --enable-__cxa_atexit --disable-libunwind-exceptions
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --enable-gnu-unique-object
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; We're trying this out on a mac running mavericks and a cray xc
</span><br>
<span class="quotelev3">&gt;&gt;&gt; system.   the mac has java 8
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; as one of the catches after the try for firing up MPI, you can get
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; and, you guessed it, we can't reproduce the error, at least using
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; Thanks for looking at all this. Adding System.gc() did not cause it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; to segfault. The segfault still comes much later in the processing.
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; Attached is a tweets.tgz file that you can uncompress to have an
</span><br>
<span class="quotelev3">&gt;&gt;&gt; input directory. The text file is just the same line over and over again.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Run it as:
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; You may have a point about the args string to MPI.init -
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; call immediately after MPI.init call and see if the gc blows up with
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; reproduce the problem locally?
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; On Tue, Aug 4, 2015 at 12:26 PM, Howard Pritchard &lt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; hppritcha_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; but the segfault occurs before our code ever uses MPI functionality like
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; code is so large and
</span><br>
<span class="quotelev3">&gt;&gt;&gt;    complicated. We have run simpler test programs with MPI and the segfault
</span><br>
<span class="quotelev3">&gt;&gt;&gt; does not occur.
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/08/27446.php">http://www.open-mpi.org/community/lists/users/2015/08/27446.php</a>
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/08/27450.php">http://www.open-mpi.org/community/lists/users/2015/08/27450.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/08/27465.php">http://www.open-mpi.org/community/lists/users/2015/08/27465.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; _______________________________________________
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/08/27471.php">http://www.open-mpi.org/community/lists/users/2015/08/27471.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/08/27472.php">http://www.open-mpi.org/community/lists/users/2015/08/27472.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/08/27479.php">http://www.open-mpi.org/community/lists/users/2015/08/27479.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27480/attachment">attachment</a>
</ul>
