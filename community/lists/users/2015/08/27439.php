...
?>
<!-- received="Wed Aug 12 12:42:29 2015" -->
<!-- isoreceived="20150812164229" -->
<!-- sent="Wed, 12 Aug 2015 09:42:26 -0700" -->
<!-- isosent="20150812164226" -->
<!-- name="Deva" -->
<!-- email="devendar.bureddy_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Open MPI 1.8.8 and hcoll in system space" -->
<!-- id="CABB+w0QMoN9U+rB-vOrZVgC1v4LLg3F66xtLagPFFX507z+pVA_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="55CB74AF.4080801_at_lanl.gov" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-08-12 12:42:26
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27440.php">David Shrader: "Re: [OMPI users] Open MPI 1.8.8 and hcoll in system space"</a>
<li><strong>Previous message:</strong> <a href="27438.php">David Shrader: "Re: [OMPI users] Open MPI 1.8.8 and hcoll in system space"</a>
<li><strong>In reply to:</strong> <a href="27438.php">David Shrader: "Re: [OMPI users] Open MPI 1.8.8 and hcoll in system space"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27440.php">David Shrader: "Re: [OMPI users] Open MPI 1.8.8 and hcoll in system space"</a>
<li><strong>Reply:</strong> <a href="27440.php">David Shrader: "Re: [OMPI users] Open MPI 1.8.8 and hcoll in system space"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi David,
<br>
<p>This issue is from hcoll library. This could be because of symbol conflict
<br>
...
<p>-Devendar
<br>
<p>On Wed, Aug 12, 2015 at 9:30 AM, David Shrader &lt;dshrader_at_[hidden]&gt; wrote:
<br>
...
<span class="quotelev1">&gt; Using that patch and re-running autogen.pl, I am able to build 1.8.8 with
</span><br>
<span class="quotelev1">&gt; './configure --with-hcoll' without errors.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; [1439390789.039197] [zo-fe1:31354:0]         shm.c:65   MXM  WARN  Could
</span><br>
...
<span class="quotelev1">&gt; [1439390789.040265] [zo-fe1:31353:0]         shm.c:65   MXM  WARN  Could
</span><br>
<span class="quotelev1">&gt; not open the KNEM device file at /dev/knem : No such file or direc
</span><br>
<span class="quotelev1">&gt; tory. Won't use knem.
...
<span class="quotelev1">&gt; mpirun noticed that process rank 0 with PID 31353 on node zo-fe1 exited on
</span><br>
...
<span class="quotelev1">&gt; autogen.pl, have found that './configure --with-hcoll' does indeed work
</span><br>
<span class="quotelev1">&gt; now. I used Gilles' branch as I wasn't sure how best to get the pull
</span><br>
...
<span class="quotelev1">&gt; I haven't checked whether or not Open MPI builds successfully as I don't
</span><br>
<span class="quotelev1">&gt; have much experience running off of the latest source. For now, I think I
</span><br>
<span class="quotelev1">&gt; will try to generate a patch to the 1.8.8 configure script and see if that
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27439/attachment">attachment</a>
</ul>
