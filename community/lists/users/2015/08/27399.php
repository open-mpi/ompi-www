...
?>
<!-- received="Wed Aug  5 16:41:40 2015" -->
<!-- isoreceived="20150805204140" -->
<!-- sent="Wed, 5 Aug 2015 10:41:18 -1000" -->
<!-- isosent="20150805204118" -->
<!-- name="Nate Chambers" -->
<!-- email="nchamber_at_[hidden]" -->
<!-- subject="Re: [OMPI users] segfault on java binding from MPI.init()" -->
<!-- id="CAKMpcFqiDmg5S83g4XsQrR4Z1K24Z0gxfYbj-ijEi5egeMpJBw_at_mail.gmail.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="CAF1Cqj7QsxPs0dT7c36Wi1JZFYWfT83YZYf8i4U=SaavbXHPBA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-08-05 16:41:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27400.php">Andy Wettstein: "[OMPI users] bad XRC API"</a>
<li><strong>Previous message:</strong> <a href="27398.php">Ralph Castain: "Re: [OMPI users] Son of Grid Engine, Parallel Environments and OpenMPI 1.8.7"</a>
<li><strong>In reply to:</strong> <a href="27396.php">Howard Pritchard: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27401.php">Howard Pritchard: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<li><strong>Reply:</strong> <a href="27401.php">Howard Pritchard: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<li><strong>Reply:</strong> <a href="27405.php">Howard Pritchard: "Re: [OMPI users] segfault on java binding from MPI.init()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Howard,
<br>
<p>Thanks for looking at all this. Adding System.gc() did not cause it to
<br>
segfault. The segfault still comes much later in the processing.
<br>
<p>I was able to reduce my code to a single test file without other
<br>
...
processing to it.
<br>
<p>Attached is a tweets.tgz file that you can uncompress to have an input
<br>
directory. The text file is just the same line over and over again. Run it
<br>
as:
<br>
<p>*java MPITestBroke tweets/*
<br>
<p><p>Nate
<br>
<p><p><p><p><p>On Wed, Aug 5, 2015 at 8:29 AM, Howard Pritchard &lt;hppritcha_at_[hidden]&gt;
<br>
wrote:
<br>
...
<span class="quotelev1">&gt; Sorry for the delay in getting back.  Thanks for the sanity check.  You
</span><br>
<span class="quotelev1">&gt; may have a point about the args string to MPI.init -
</span><br>
<span class="quotelev1">&gt; there's nothing the Open MPI is needing from this but that is a difference
</span><br>
<span class="quotelev1">&gt; with your use case - your app has an argument.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Is your app open source where we could download it and try to reproduce
</span><br>
...
<span class="quotelev2">&gt;&gt; On Tue, Aug 4, 2015 at 12:26 PM, Howard Pritchard &lt;hppritcha_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; that's the proper way to do it. Attached is my config log. The behavior
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; when running our code appears to be the same. The output is the same error
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I pasted in my email above. It occurs when calling MPI.init().
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm not great at debugging this sort of stuff, but happy to try things
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; out if you need me to.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27399/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/x-java attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27399/MPITestBroke.java">MPITestBroke.java</a>
</ul>
<!-- attachment="MPITestBroke.java" -->
<hr>
<ul>
<li>application/x-gzip attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27399/tweets.tgz">tweets.tgz</a>
</ul>
