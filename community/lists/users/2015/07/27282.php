...
?>
<!-- received="Thu Jul 16 01:08:37 2015" -->
<!-- isoreceived="20150716050837" -->
<!-- sent="Wed, 15 Jul 2015 22:08:22 -0700" -->
<!-- isosent="20150716050822" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash" -->
<!-- id="77EDDE3C-E05A-44FF-8049-77C03D9CC144_at_open-mpi.org" -->
...
<strong>Date:</strong> 2015-07-16 01:08:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27283.php">Gilles Gouaillardet: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<li><strong>Previous message:</strong> <a href="27281.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<li><strong>In reply to:</strong> <a href="27281.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27285.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<li><strong>Reply:</strong> <a href="27285.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><span class="quotelev1">&gt; On Jul 15, 2015, at 9:53 PM, Lane, William &lt;William.Lane_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; Can you give it a try? I&#146;m skeptical, but it might work. The rc is out on the web site:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Jul 14, 2015, at 11:17 AM, Lane, William &lt;William.Lane_at_[hidden] &lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; No need for the lstopo data anymore, Bill - I was able to recreate the situation using some very nice hwloc functions plus your prior descriptions. I'm not totally confident that this fix will resolve the problem but it will clear out at least one problem.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Tue, Jul 7, 2015 at 8:07 PM, Lane, William &lt;William.Lane_at_[hidden] &lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; that will run lstopo and output the host information to a file located
</span><br>
...
<span class="quotelev2">&gt;&gt; I may have finally tracked this down. At least, I can now get the correct devel map to come out, and found a memory corruption issue that only impacted hetero operations. I can&#146;t know if this is the root cause of the problem Bill is seeing, however, as I have no way of actually running the job.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; I pushed this into the master and will bring it back to 1.8.7 as well as 1.10.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Bill - would you be able/willing to give it a try there? It would be nice to confirm this actually fixed the problem.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt; &gt; On Jun 29, 2015, at 1:58 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden] &lt;mailto:jsquyres_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
<span class="quotelev3">&gt;&gt; &gt; lstopo will tell you -- if there is more than one &quot;PU&quot; (hwloc terminology for &quot;processing unit&quot;) per core, then hyper threading is enabled.  If there's only one PU per core, then hyper threading is disabled.
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
<span class="quotelev3">&gt;&gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; On Jun 29, 2015, at 4:42 PM, Lane, William &lt;William.Lane_at_[hidden] &lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; Would the output of dmidecode -t processor and/or lstopo tell me conclusively
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; if hyperthreading is enabled or not? Hyperthreading is supposed to be enabled
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; for all the IBM x3550 M3 and M4 nodes, but I'm not sure if it actually is and I
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; Bill - this is such a jumbled collection of machines that I&#146;m having trouble figuring out what I should replicate. I can create something artificial here so I can try to debug this, but I need to know exactly what I&#146;m up against - can you tell me:
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt; * the architecture of each type - how many sockets, how many cores/socket, HT on or off. If two nodes have the same physical setup but one has HT on and the other off, then please consider those two different types
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt; &gt;&gt; Looking at your map output, it looks like the map is being done correctly, but somehow the binding locale isn&#146;t getting set in some cases. You latest error output would seem out-of-step with your prior reports, so something else may be going on there. As I said earlier, this is the most hetero environment we&#146;ve seen, and so there may be some code paths your hitting that haven&#146;t been well exercised before.
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt; &gt;&gt;
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; On Jun 26, 2015, at 5:22 PM, Lane, William &lt;William.Lane_at_[hidden] &lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; Well, I managed to get a successful mpirun @ a slot count of 132 using --mca btl ^sm,
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; however when I increased the slot count to 160, mpirun crashed without any error
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; output:
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; mpirun -np 160 -display-devel-map --prefix /hpc/apps/mpi/openmpi/1.8.6/ --hostfile hostfile-noslots --mca btl ^sm --hetero-nodes --bind-to core /hpc/home/lanew/mpi/openmpi/ProcessColors3 &gt;&gt; out.txt 2&gt;&amp;1
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; --------------------------------------------------------------------------
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; But csclprd3-6-1 (a blade) does have 2 CPU's on 2 separate sockets w/2 cores apiece as shown in my dmidecode output:
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; csclprd3-0-1 information (which looks correct as this particular x3550 should
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; have one socket populated (of two) with a 6 core Xeon (or 12 cores w/hyperthreading
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; I think trying with --mca btl ^sm makes a lot of sense and may solve the problem. I also noted that we are having trouble with the topology of several of the nodes - seeing only one socket, non-HT where you say we should see two sockets and HT-enabled. In those cases, the locality is &quot;unknown&quot; - given that those procs are on remote nodes from the one being impacted, I don't think it should cause a problem. However, it isn't correct, and that raises flags.
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; I suspect the error occurs in mca_btl_sm_add_procs but this is just my best guess.
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; if this is correct, can you check the value of mca_btl_sm_component.num_smp_procs ?
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; I do not see how I can tackle the root cause without being able to reproduce the issue :-(
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; can you try to reproduce the issue with the smallest hostfile, and then run lstopo on all the nodes ?
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; On Wednesday, June 24, 2015, Lane, William &lt;William.Lane_at_[hidden] &lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; Gilles,
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; All the blades only have two core Xeons (without hyperthreading) populating both their sockets. All
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; the x3550 nodes have hyperthreading capable Xeons and Sandybridge server CPU's. It's possible
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; hyperthreading has been disabled on some of these nodes though. The 3-0-n nodes are all IBM x3550
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; nodes while the 3-6-n nodes are all blade nodes.
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; I have run this exact same test code successfully in the past on another cluster (~200 nodes of Sunfire X2100
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; 2x dual-core Opterons) w/no issues on upwards of 390 slots. I even tested it recently on OpenMPI 1.8.5
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; on another smaller R&amp;D cluster consisting of 10 Sunfire X2100 nodes (w/2 dual core Opterons apiece).
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; On this particular cluster I've had success running this code on &lt; 132 slots.
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; mpirun -np 132 -display-devel-map --prefix /hpc/apps/mpi/openmpi/1.8.6/ --hostfile hostfile-noslots --mca btl_tcp_if_include eth0 --hetero-nodes --bind-to core /hpc/home/lanew/mpi/openmpi/ProcessColors3 &gt;&gt; out.txt 2&gt;&amp;1
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; --------------------------------------------------------------------------
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; Mapper requested: NULL  Last mapper: round_robin  Mapping policy: BYSOCKET  Ranking policy: SLOT
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [ 1] [csclprd3-0-13:31616] [ 0] /lib64/libpthread.so.0(+0xf500)[0x7fe6843a4500]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [ 1] [csclprd3-0-13:31620] [ 0] /lib64/libpthread.so.0(+0xf500)[0x7fcc80c54500]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [ 1] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x167f61)[0x7fcc80fc9f61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [ 2] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x168047)[0x7fcc80fca047]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [ 3] [csclprd3-0-13:31615] [ 0] /lib64/libpthread.so.0(+0xf500)[0x7f81385ca500]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [ 1] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x167f61)[0x7f813893ff61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [ 2] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x168047)[0x7f8138940047]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [ 3] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x167f61)[0x7fb851bc6f61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [ 2] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x168047)[0x7fb851bc7047]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [ 3] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x55670)[0x7fb851ab4670]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [ 4] [csclprd3-0-13:31617] [ 0] /lib64/libpthread.so.0(+0xf500)[0x7f062cfe5500]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [ 1] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x167f61)[0x7f062d35af61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [ 2] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x168047)[0x7f062d35b047]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [ 3] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x55670)[0x7f062d248670]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [ 4] [csclprd3-0-13:31619] [ 0] /lib64/libpthread.so.0(+0xf500)[0x7f1384fde500]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [ 1] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x167f61)[0x7f1385353f61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [ 2] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x167f61)[0x7fe684719f61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [ 2] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x168047)[0x7fe68471a047]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [ 3] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x55670)[0x7fe684607670]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [ 4] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x168047)[0x7f1385354047]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [ 3] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x55670)[0x7f1385241670]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [ 4] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_grow+0x3b9)[0x7f13852425ab]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [ 5] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_resize_mt+0xfb)[0x7f1385242751]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [ 6] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_btl_sm_add_procs+0x671)[0x7f13853501c9]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [ 7] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x14a628)[0x7f1385336628]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [ 8] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x55670)[0x7fcc80eb7670]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [ 4] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_grow+0x3b9)[0x7fcc80eb85ab]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [ 5] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_resize_mt+0xfb)[0x7fcc80eb8751]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [ 6] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_btl_sm_add_procs+0x671)[0x7fcc80fc61c9]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [ 7] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x14a628)[0x7fcc80fac628]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [ 8] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_pml_ob1_add_procs+0xff)[0x7fcc8111fd61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [ 9] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x55670)[0x7f813882d670]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [ 4] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_grow+0x3b9)[0x7f813882e5ab]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [ 5] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_resize_mt+0xfb)[0x7f813882e751]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [ 6] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_btl_sm_add_procs+0x671)[0x7f813893c1c9]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [ 7] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x14a628)[0x7f8138922628]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [ 8] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_pml_ob1_add_procs+0xff)[0x7f8138a95d61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [ 9] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_mpi_init+0xbda)[0x7f813885d747]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [10] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_grow+0x3b9)[0x7fb851ab55ab]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [ 5] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_resize_mt+0xfb)[0x7fb851ab5751]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [ 6] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_btl_sm_add_procs+0x671)[0x7fb851bc31c9]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [ 7] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x14a628)[0x7fb851ba9628]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [ 8] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_pml_ob1_add_procs+0xff)[0x7fb851d1cd61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [ 9] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_mpi_init+0xbda)[0x7fb851ae4747]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [10] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_grow+0x3b9)[0x7f062d2495ab]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [ 5] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_resize_mt+0xfb)[0x7f062d249751]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [ 6] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_btl_sm_add_procs+0x671)[0x7f062d3571c9]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [ 7] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x14a628)[0x7f062d33d628]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [ 8] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_pml_ob1_add_procs+0xff)[0x7f062d4b0d61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [ 9] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_mpi_init+0xbda)[0x7f062d278747]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [10] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_grow+0x3b9)[0x7fe6846085ab]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [ 5] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_free_list_resize_mt+0xfb)[0x7fe684608751]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [ 6] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_btl_sm_add_procs+0x671)[0x7fe6847161c9]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [ 7] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(+0x14a628)[0x7fe6846fc628]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [ 8] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(mca_pml_ob1_add_procs+0xff)[0x7fe68486fd61]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [ 9] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_mpi_init+0xbda)[0x7fe684637747]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [10] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(MPI_Init+0x185)[0x7fe68467750b]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [11] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400ad0]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [12] /lib64/libc.so.6(__libc_start_main+0xfd)[0x7fe684021cdd]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31616] [13] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400999]
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [11] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400ad0]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [12] /lib64/libc.so.6(__libc_start_main+0xfd)[0x7f062cc62cdd]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31617] [13] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400999]
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [ 9] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(ompi_mpi_init+0xbda)[0x7f1385271747]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [10] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(MPI_Init+0x185)[0x7f13852b150b]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [11] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400ad0]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [12] /lib64/libc.so.6(__libc_start_main+0xfd)[0x7f1384c5bcdd]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31619] [13] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400999]
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [10] /hpc/apps/mpi/openmpi/1.8.6/lib/libmpi.so.1(MPI_Init+0x185)[0x7fcc80f2750b]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [11] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400ad0]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [12] /lib64/libc.so.6(__libc_start_main+0xfd)[0x7fcc808d1cdd]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31620] [13] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400999]
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [11] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400ad0]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [12] /lib64/libc.so.6(__libc_start_main+0xfd)[0x7f8138247cdd]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31615] [13] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400999]
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [11] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400ad0]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [12] /lib64/libc.so.6(__libc_start_main+0xfd)[0x7fb8514cecdd]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-13:31618] [13] /hpc/home/lanew/mpi/openmpi/ProcessColors3[0x400999]
</span><br>
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; I don't see anyone binding to a single HT if multiple HTs/core are available. I think you are being fooled by those nodes that either don't have HT enabled, or have only 1 HT/core.
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; In both cases, it is node 13 that is the node that fails. I also note that you said everything works okay with &lt; 132 ranks, and node 13 hosts ranks 127-131. So node 13 would host ranks even if you reduced the number in the job to 131. This would imply that it probably isn't something wrong with the node itself.
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; Is there any way you could run a job of this size on a homogeneous cluster? The procs all show bindings that look right, but I'm wondering if the heterogeneity is the source of the trouble here. We may be communicating the binding pattern incorrectly and giving bad info to the backend daemon.
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; Also, rather than --report-bindings, use &quot;--display-devel-map&quot; on the command line and let's see what the mapper thinks it did. If there is a problem with placement, that is where it would exist.
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; On Tue, Jun 23, 2015 at 5:12 PM, Lane, William &lt;William.Lane_at_[hidden] &lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; Ralph,
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-5:16802] MCW rank 44 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-5:16802] MCW rank 45 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-5:16802] MCW rank 46 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-6-5:12480] MCW rank 4 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]]: [B/B][./.]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-6-5:12480] MCW rank 5 bound to socket 1[core 2[hwt 0]], socket 1[core 3[hwt 0]]: [./.][B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-6-5:12480] MCW rank 6 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]]: [B/B][./.]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-6-5:12480] MCW rank 7 bound to socket 1[core 2[hwt 0]], socket 1[core 3[hwt 0]]: [./.][B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-5:16802] MCW rank 47 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-5:16802] MCW rank 48 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-5:16802] MCW rank 49 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-1:14318] MCW rank 22 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-1:14318] MCW rank 23 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-1:14318] MCW rank 24 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-6-1:24682] MCW rank 3 bound to socket 1[core 2[hwt 0]], socket 1[core 3[hwt 0]]: [./.][B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-6-1:24682] MCW rank 0 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]]: [B/B][./.]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-1:14318] MCW rank 25 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-1:14318] MCW rank 20 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-3:13827] MCW rank 34 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-1:14318] MCW rank 21 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-3:13827] MCW rank 35 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-6-1:24682] MCW rank 1 bound to socket 1[core 2[hwt 0]], socket 1[core 3[hwt 0]]: [./.][B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-3:13827] MCW rank 36 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-6-1:24682] MCW rank 2 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]]: [B/B][./.]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-6:30371] MCW rank 51 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-6:30371] MCW rank 52 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-6:30371] MCW rank 53 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-2:05825] MCW rank 30 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-6:30371] MCW rank 54 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-3:13827] MCW rank 37 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-2:05825] MCW rank 31 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-3:13827] MCW rank 32 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-6:30371] MCW rank 55 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-3:13827] MCW rank 33 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-6:30371] MCW rank 50 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-2:05825] MCW rank 26 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-2:05825] MCW rank 27 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-2:05825] MCW rank 28 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-2:05825] MCW rank 29 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-12:12383] MCW rank 121 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-12:12383] MCW rank 122 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-12:12383] MCW rank 123 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-12:12383] MCW rank 124 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-12:12383] MCW rank 125 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-12:12383] MCW rank 120 is not bound (or bound to all available processors)
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 13 bound to socket 1[core 6[hwt 0]], socket 1[core 7[hwt 0]], socket 1[core 8[hwt 0]], socket 1[core 9[hwt 0]], socket 1[core 10[hwt 0]], socket 1[core 11[hwt 0]]: [./././././.][B/B/B/B/B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 14 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], socket 0[core 3[hwt 0]], socket 0[core 4[hwt 0]], socket 0[core 5[hwt 0]]: [B/B/B/B/B/B][./././././.]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 15 bound to socket 1[core 6[hwt 0]], socket 1[core 7[hwt 0]], socket 1[core 8[hwt 0]], socket 1[core 9[hwt 0]], socket 1[core 10[hwt 0]], socket 1[core 11[hwt 0]]: [./././././.][B/B/B/B/B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 16 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], socket 0[core 3[hwt 0]], socket 0[core 4[hwt 0]], socket 0[core 5[hwt 0]]: [B/B/B/B/B/B][./././././.]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-7:20515] MCW rank 68 bound to socket 0[core 0[hwt 0-1]], socket 0[core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]], socket 0[core 4[hwt 0-1]], socket 0[core 5[hwt 0-1]], socket 0[core 6[hwt 0-1]], socket 0[core 7[hwt 0-1]]: [BB/BB/BB/BB/BB/BB/BB/BB][../../../../../../../..]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-10:19096] MCW rank 100 bound to socket 0[core 0[hwt 0-1]], socket 0[core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]], socket 0[core 4[hwt 0-1]], socket 0[core 5[hwt 0-1]], socket 0[core 6[hwt 0-1]], socket 0[core 7[hwt 0-1]]: [BB/BB/BB/BB/BB/BB/BB/BB][../../../../../../../..]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-7:20515] MCW rank 69 bound to socket 1[core 8[hwt 0-1]], socket 1[core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt 0-1]], socket 1[core 12[hwt 0-1]], socket 1[core 13[hwt 0-1]], socket 1[core 14[hwt 0-1]], socket 1[core 15[hwt 0-1]]: [../../../../../../../..][BB/BB/BB/BB/BB/BB/BB/BB]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-10:19096] MCW rank 101 bound to socket 1[core 8[hwt 0-1]], socket 1[core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt 0-1]], socket 1[core 12[hwt 0-1]], socket 1[core 13[hwt 0-1]], socket 1[core 14[hwt 0-1]], socket 1[core 15[hwt 0-1]]: [../../../../../../../..][BB/BB/BB/BB/BB/BB/BB/BB]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 17 bound to socket 1[core 6[hwt 0]], socket 1[core 7[hwt 0]], socket 1[core 8[hwt 0]], socket 1[core 9[hwt 0]], socket 1[core 10[hwt 0]], socket 1[core 11[hwt 0]]: [./././././.][B/B/B/B/B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-7:20515] MCW rank 70 bound to socket 0[core 0[hwt 0-1]], socket 0[core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]], socket 0[core 4[hwt 0-1]], socket 0[core 5[hwt 0-1]], socket 0[core 6[hwt 0-1]], socket 0[core 7[hwt 0-1]]: [BB/BB/BB/BB/BB/BB/BB/BB][../../../../../../../..]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-10:19096] MCW rank 102 bound to socket 0[core 0[hwt 0-1]], socket 0[core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]], socket 0[core 4[hwt 0-1]], socket 0[core 5[hwt 0-1]], socket 0[core 6[hwt 0-1]], socket 0[core 7[hwt 0-1]]: [BB/BB/BB/BB/BB/BB/BB/BB][../../../../../../../..]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-11:31636] MCW rank 116 bound to socket 0[core 0[hwt 0-1]], socket 0[core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]], socket 0[core 4[hwt 0-1]], socket 0[core 5[hwt 0-1]], socket 0[core 6[hwt 0-1]], socket 0[core 7[hwt 0-1]]: [BB/BB/BB/BB/BB/BB/BB/BB][../../../../../../../..]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-11:31636] MCW rank 117 bound to socket 1[core 8[hwt 0-1]], socket 1[core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt 0-1]], socket 1[core 12[hwt 0-1]], socket 1[core 13[hwt 0-1]], socket 1[core 14[hwt 0-1]], socket 1[core 15[hwt 0-1]]: [../../../../../../../..][BB/BB/BB/BB/BB/BB/BB/BB]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 18 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], socket 0[core 3[hwt 0]], socket 0[core 4[hwt 0]], socket 0[core 5[hwt 0]]: [B/B/B/B/B/B][./././././.]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-11:31636] MCW rank 118 bound to socket 0[core 0[hwt 0-1]], socket 0[core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]], socket 0[core 4[hwt 0-1]], socket 0[core 5[hwt 0-1]], socket 0[core 6[hwt 0-1]], socket 0[core 7[hwt 0-1]]: [BB/BB/BB/BB/BB/BB/BB/BB][../../../../../../../..]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 19 bound to socket 1[core 6[hwt 0]], socket 1[core 7[hwt 0]], socket 1[core 8[hwt 0]], socket 1[core 9[hwt 0]], socket 1[core 10[hwt 0]], socket 1[core 11[hwt 0]]: [./././././.][B/B/B/B/B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-7:20515] MCW rank 71 bound to socket 1[core 8[hwt 0-1]], socket 1[core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt 0-1]], socket 1[core 12[hwt 0-1]], socket 1[core 13[hwt 0-1]], socket 1[core 14[hwt 0-1]], socket 1[core 15[hwt 0-1]]: [../../../../../../../..][BB/BB/BB/BB/BB/BB/BB/BB]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-10:19096] MCW rank 103 bound to socket 1[core 8[hwt 0-1]], socket 1[core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt 0-1]], socket 1[core 12[hwt 0-1]], socket 1[core 13[hwt 0-1]], socket 1[core 14[hwt 0-1]], socket 1[core 15[hwt 0-1]]: [../../../../../../../..][BB/BB/BB/BB/BB/BB/BB/BB]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 8 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], socket 0[core 3[hwt 0]], socket 0[core 4[hwt 0]], socket 0[core 5[hwt 0]]: [B/B/B/B/B/B][./././././.]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 9 bound to socket 1[core 6[hwt 0]], socket 1[core 7[hwt 0]], socket 1[core 8[hwt 0]], socket 1[core 9[hwt 0]], socket 1[core 10[hwt 0]], socket 1[core 11[hwt 0]]: [./././././.][B/B/B/B/B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-10:19096] MCW rank 88 bound to socket 0[core 0[hwt 0-1]], socket 0[core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]], socket 0[core 4[hwt 0-1]], socket 0[core 5[hwt 0-1]], socket 0[core 6[hwt 0-1]], socket 0[core 7[hwt 0-1]]: [BB/BB/BB/BB/BB/BB/BB/BB][../../../../../../../..]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-11:31636] MCW rank 119 bound to socket 1[core 8[hwt 0-1]], socket 1[core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt 0-1]], socket 1[core 12[hwt 0-1]], socket 1[core 13[hwt 0-1]], socket 1[core 14[hwt 0-1]], socket 1[core 15[hwt 0-1]]: [../../../../../../../..][BB/BB/BB/BB/BB/BB/BB/BB]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-7:20515] MCW rank 56 bound to socket 0[core 0[hwt 0-1]], socket 0[core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]], socket 0[core 4[hwt 0-1]], socket 0[core 5[hwt 0-1]], socket 0[core 6[hwt 0-1]], socket 0[core 7[hwt 0-1]]: [BB/BB/BB/BB/BB/BB/BB/BB][../../../../../../../..]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 10 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], socket 0[core 3[hwt 0]], socket 0[core 4[hwt 0]], socket 0[core 5[hwt 0]]: [B/B/B/B/B/B][./././././.]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-7:20515] MCW rank 57 bound to socket 1[core 8[hwt 0-1]], socket 1[core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt 0-1]], socket 1[core 12[hwt 0-1]], socket 1[core 13[hwt 0-1]], socket 1[core 14[hwt 0-1]], socket 1[core 15[hwt 0-1]]: [../../../../../../../..][BB/BB/BB/BB/BB/BB/BB/BB]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-10:19096] MCW rank 89 bound to socket 1[core 8[hwt 0-1]], socket 1[core 9[hwt 0-1]], socket 1[core 10[hwt 0-1]], socket 1[core 11[hwt 0-1]], socket 1[core 12[hwt 0-1]], socket 1[core 13[hwt 0-1]], socket 1[core 14[hwt 0-1]], socket 1[core 15[hwt 0-1]]: [../../../../../../../..][BB/BB/BB/BB/BB/BB/BB/BB]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-11:31636] MCW rank 104 bound to socket 0[core 0[hwt 0-1]], socket 0[core 1[hwt 0-1]], socket 0[core 2[hwt 0-1]], socket 0[core 3[hwt 0-1]], socket 0[core 4[hwt 0-1]], socket 0[core 5[hwt 0-1]], socket 0[core 6[hwt 0-1]], socket 0[core 7[hwt 0-1]]: [BB/BB/BB/BB/BB/BB/BB/BB][../../../../../../../..]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 11 bound to socket 1[core 6[hwt 0]], socket 1[core 7[hwt 0]], socket 1[core 8[hwt 0]], socket 1[core 9[hwt 0]], socket 1[core 10[hwt 0]], socket 1[core 11[hwt 0]]: [./././././.][B/B/B/B/B/B]
</span><br>
<span class="quotelev1">&gt;&gt; &gt;&gt;&gt; [csclprd3-0-0:31079] MCW rank 12 bound to socket 0[core 0[hwt 0]], socket 0[core 1[hwt 0]], socket 0[core 2[hwt 0]], socket 0[core 3[hwt 0]], socket 0[core 4[hwt 0]], socket 0[core 5[hwt 0]]: [B/B/B/B/B/B][./././././.]
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27282/attachment">attachment</a>
</ul>
