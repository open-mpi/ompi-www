...
?>
<!-- received="Fri Jul 24 20:39:35 2015" -->
<!-- isoreceived="20150725003935" -->
<!-- sent="Sat, 25 Jul 2015 00:39:10 +0000" -->
<!-- isosent="20150725003910" -->
<!-- name="Lane, William" -->
<!-- email="William.Lane_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash" -->
<!-- id="434F2BB0AF80484CA04DE0D8C0738BF293EEB9BC_at_cshsmsgmbx02.CSMC.EDU" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="434F2BB0AF80484CA04DE0D8C0738BF293EE8DB8_at_cshsmsgmbx02.CSMC.EDU" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-07-24 20:39:10
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27326.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<li><strong>Previous message:</strong> <a href="27324.php">Erik Schnetter: "[OMPI users] Building OpenMPI 1.8.7 on XC30"</a>
<li><strong>In reply to:</strong> <a href="27285.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27326.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<li><strong>Reply:</strong> <a href="27326.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Ralph,
<br>
<p>I re-compiled my test code and ran it on almost our entire cluster (excepting
<br>
the new hyperthread capable blade chassis), anyway, the code ran successfully:
<br>
<p>mpirun -np 185 -display-devel-map --prefix /hpc/apps/mpi/openmpi/1.8.7/ --hostfile hostfile-noslots --mca btl ^sm --hetero-nodes --bind-to core /hpc/home/lanew/mpi/openmpi/ProcessColors3  &gt;&gt; out.txt 2&gt;&amp;1
<br>
<p>I've attached the out.txt file in case you're interested in looking at it.
<br>
<p>One question I have is WRT the warning:
<br>
<p>--------------------------------------------------------------------------
<br>
...
--------------------------------------------------------------------------
<br>
<p>Is it worthwhile to make sure the proper NUMA packages are
<br>
installed on compute nodes?
<br>
<p>Thank you for all your help w/this Ralph, now I can move on and
<br>
...
Subject: Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash
<br>
<p>Will do Ralph. I'll re-compile my test code against OpenMPI 1.8.7 tomorrow
<br>
and run it again.
<br>
<p>There are apparently now four types of systems in our cluster compute
<br>
ring:
<br>
...
and IBM x3550-M4's.
<br>
<p>The only systems that don't support hyperthreading are the older blades
<br>
(the HS21's).
<br>
<p>The submit nodes to the cluster are Sun Sunfire X2100's (which are old
<br>
...
Subject: Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash
<br>
<p>Stable 1.8.7 has been released - please let me know if the problem is resolved.
<br>
<p><p>On Jul 15, 2015, at 9:53 PM, Lane, William &lt;William.Lane_at_[hidden]&lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
<br>
<p>Ralph,
<br>
<p>I'd rather wait for the stable release of 1.8.7, but I'm willing to give
<br>
...
Subject: Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash
<br>
<p>Can you give it a try? I&#146;m skeptical, but it might work. The rc is out on the web site:
<br>
<p><a href="http://www.open-mpi.org/software/ompi/v1.8/">http://www.open-mpi.org/software/ompi/v1.8/</a>
<br>
<p><p>On Jul 14, 2015, at 11:17 AM, Lane, William &lt;William.Lane_at_[hidden]&lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
<br>
<p>Ralph,
<br>
<p>Do you think the 1.8.7 release will solve the problems w/our
<br>
...
Subject: Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash
<br>
<p>No need for the lstopo data anymore, Bill - I was able to recreate the situation using some very nice hwloc functions plus your prior descriptions. I'm not totally confident that this fix will resolve the problem but it will clear out at least one problem.
<br>
<p>We'll just have to see what happens and attack it next.
<br>
Ralph
<br>
<p><p>On Tue, Jul 7, 2015 at 8:07 PM, Lane, William &lt;William.Lane_at_[hidden]&lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
<br>
...
<br>
<p><p><span class="quotelev1">&gt; On Jun 29, 2015, at 1:58 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&lt;mailto:jsquyres_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt;&gt; On Jun 29, 2015, at 4:42 PM, Lane, William &lt;William.Lane_at_[hidden]&lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Jun 26, 2015, at 5:22 PM, Lane, William &lt;William.Lane_at_[hidden]&lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wed, Jun 24, 2015 at 4:07 AM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden]&lt;mailto:gilles.gouaillardet_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wednesday, June 24, 2015, Lane, William &lt;William.Lane_at_[hidden]&lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Gilles,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; On Tue, Jun 23, 2015 at 5:12 PM, Lane, William &lt;William.Lane_at_[hidden]&lt;mailto:William.Lane_at_[hidden]&gt;&gt; wrote:
</span><br>
...
Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/07/27263.php">http://www.open-mpi.org/community/lists/users/2015/07/27263.php</a>
<br>
...
Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/07/27279.php">http://www.open-mpi.org/community/lists/users/2015/07/27279.php</a>
<br>
<p>IMPORTANT WARNING: This message is intended for the use of the person or entity to which it is addressed and may contain information that is privileged and confidential, the disclosure of which is governed by applicable law. If the reader of this message is not the intended recipient, or the employee or agent responsible for delivering it to the intended recipient, you are hereby notified that any dissemination, distribution or copying of this information is strictly prohibited. Thank you for your cooperation. _______________________________________________
<br>
users mailing list
...
Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/07/27281.php">http://www.open-mpi.org/community/lists/users/2015/07/27281.php</a>
<br>
<p>IMPORTANT WARNING: This message is intended for the use of the person or entity to which it is addressed and may contain information that is privileged and confidential, the disclosure of which is governed by applicable law. If the reader of this message is not the intended recipient, or the employee or agent responsible for delivering it to the intended recipient, you are hereby notified that any dissemination, distribution or copying of this information is strictly prohibited. Thank you for your cooperation.
<br>
IMPORTANT WARNING: This message is intended for the use of the person or entity to which it is addressed and may contain information that is privileged and confidential, the disclosure of which is governed by applicable law. If the reader of this message is not the intended recipient, or the employee or agent responsible for delivering it to the intended recipient, you are hereby notified that any dissemination, distribution or copying of this information is strictly prohibited. Thank you for your cooperation.
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27325/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/plain attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27325/out.txt">out.txt</a>
</ul>
<!-- attachment="out.txt" -->
<!-- body="end" -->
<hr>
