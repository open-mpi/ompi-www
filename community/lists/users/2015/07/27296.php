...
?>
<!-- received="Wed Jul 22 03:41:13 2015" -->
<!-- isoreceived="20150722074113" -->
<!-- sent="Wed, 22 Jul 2015 09:41:11 +0200" -->
<!-- isosent="20150722074111" -->
<!-- name="Harald Servat" -->
<!-- email="harald.servat_at_[hidden]" -->
<!-- subject="Re: [OMPI users] shared memory performance" -->
<!-- id="55AF4917.8050608_at_bsc.es" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2015-07-22 03:41:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27297.php">Crisitan RUIZ: "Re: [OMPI users] shared memory performance"</a>
<li><strong>Previous message:</strong> <a href="27295.php">Crisitan RUIZ: "[OMPI users] shared memory performance"</a>
<li><strong>In reply to:</strong> <a href="27295.php">Crisitan RUIZ: "[OMPI users] shared memory performance"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27297.php">Crisitan RUIZ: "Re: [OMPI users] shared memory performance"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Dear Cristian,
<br>
<p>&nbsp;&nbsp;&nbsp;as you probably know C class is one of the large classes for the NAS 
<br>
...
<br>
<p>&nbsp;&nbsp;&nbsp;In order to validate this reasoning, you can profile or trace the 
<br>
...
<p>Regards.
<br>
<p>On 22/07/15 09:19, Crisitan RUIZ wrote:
<br>
...
<span class="quotelev1">&gt; I'm running OpenMPI 1.8.5 on a cluster with the following characteristics:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; The results are similar for other benchmarks. Is this behavior normal? I
</span><br>
<span class="quotelev1">&gt; was expecting to see a better behavior using 8 cores given that they use
</span><br>
<span class="quotelev1">&gt; directly the memory to communicate.
</span><br>
<span class="quotelev1">&gt;
</span><br>
