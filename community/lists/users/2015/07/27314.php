...
?>
<!-- received="Thu Jul 23 11:08:55 2015" -->
<!-- isoreceived="20150723150855" -->
<!-- sent="Thu, 23 Jul 2015 15:08:50 +0000" -->
<!-- isosent="20150723150850" -->
<!-- name="m.delorme_at_[hidden]" -->
<!-- email="m.delorme_at_[hidden]" -->
<!-- subject="Re: [OMPI users] SGE segfaulting with OpenMPI 1.8.6" -->
<!-- id="DB3PR06MB0907AB2EE78CC79B20525920C7820_at_DB3PR06MB0907.eurprd06.prod.outlook.com" -->
<!-- charset="iso-8859-1" -->
<!-- inreplyto="CAPqNE2V+JBZOtqqv2ND2LP83zMqp=so8A3aFFBzFYQDRS-zs=Q_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-07-23 11:08:50
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27315.php">Dave Love: "Re: [OMPI users] File coherence issues with OpenMPI/torque/NFS (?)"</a>
<li><strong>Previous message:</strong> <a href="27313.php">John Hearns: "Re: [OMPI users] SGE segfaulting with OpenMPI 1.8.6"</a>
<li><strong>In reply to:</strong> <a href="27313.php">John Hearns: "Re: [OMPI users] SGE segfaulting with OpenMPI 1.8.6"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27318.php">Ralph Castain: "Re: [OMPI users] SGE segfaulting with OpenMPI 1.8.6"</a>
<li><strong>Reply:</strong> <a href="27318.php">Ralph Castain: "Re: [OMPI users] SGE segfaulting with OpenMPI 1.8.6"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
From: users &lt;users-bounces_at_[hidden]&gt; on behalf of John Hearns &lt;hearnsj_at_[hidden]&gt;
<br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27314/attachment">attachment</a>
</ul>
