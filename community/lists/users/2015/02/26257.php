...
?>
<!-- received="Mon Feb  2 15:26:45 2015" -->
<!-- isoreceived="20150202202645" -->
<!-- sent="Mon, 2 Feb 2015 21:26:40 +0100" -->
<!-- isosent="20150202202640" -->
<!-- name="Mark Santcroos" -->
<!-- email="mark.santcroos_at_[hidden]" -->
<!-- subject="Re: [OMPI users] independent startup of orted and orterun" -->
<!-- id="F22198AA-BE1B-4E76-B8D8-72072501A83E_at_rutgers.edu" -->
<!-- charset="utf-8" -->
<!-- inreplyto="CAMD57ocWgSXNqn5uBO1QfYUVLdEUVNSiuc56g2GdSGN8ytpmvQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-02-02 15:26:40
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26258.php">Mark Santcroos: "Re: [OMPI users] independent startup of orted and orterun"</a>
<li><strong>Previous message:</strong> <a href="26256.php">Ralph Castain: "Re: [OMPI users] independent startup of orted and orterun"</a>
<li><strong>In reply to:</strong> <a href="26256.php">Ralph Castain: "Re: [OMPI users] independent startup of orted and orterun"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26258.php">Mark Santcroos: "Re: [OMPI users] independent startup of orted and orterun"</a>
<li><strong>Reply:</strong> <a href="26258.php">Mark Santcroos: "Re: [OMPI users] independent startup of orted and orterun"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p><span class="quotelev1">&gt; On 02 Feb 2015, at 19:07 , Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Yikes - looks like a bug crept into there at the last minute. I actually had it working just fine - not sure what happened here. I'm on travel this week, but I'll try to dig into this a bit and spot the issue.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On Mon, Feb 2, 2015 at 3:50 AM, Mark Santcroos &lt;mark.santcroos_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; (To aid in debugging I added &quot;--debug-devel&quot; to orte-dvm.c which was useful to detect and come by some initial bumps)
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; [warn] opal_libevent2022_event_base_loop: reentrant invocation.  Only one event_base_loop can run on each event_base at once.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; * orte-submit doesn't return, while I see &quot;[nid02819:20571] [[2120,0],0] dvm: job [2120,9] has completed&quot; on the orte-dvm console.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; * On the orte-dvm console I see the following when submitting (so also for &quot;successful&quot; runs):
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [nid02434:00564] [[9021,0],0] Releasing job data for [INVALID]
</span><br>
<span class="quotelev1">&gt; [nid03388:26474] [[9021,0],2] ORTE_ERROR_LOG: Not found in file ../../../../orte/mca/odls/base/odls_base_default_fns.c at line 433
</span><br>
...
<span class="quotelev1">&gt; * If I dont specify any &quot;-np&quot; on the orte-submit, then I see on the orte-dvm console:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; [nid02434:00564] [[9021,0],0] Releasing job data for [INVALID]
...
<span class="quotelev1">&gt; [nid03534:31544] [[9021,0],1] ORTE_ERROR_LOG: Not found in file ../../../../orte/mca/odls/base/odls_base_default_fns.c at line 433
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; * It only seems to work for single nodes (probably related to the previous point).
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev2">&gt; &gt; I have pushed the changes to the OMPI master. It took a little bit more than I had hoped due to the changes to the ORTE infrastructure, but hopefully this will meet your needs. It consists of two new tools:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; (a) orte-dvm - starts the virtual machine by launching a daemon on every node of the allocation, as constrained by -host and/or -hostfile. Check the options for outputting the URI as you&#226;&#128;&#153;ll need that info for the other tool. The DVM remains &#226;&#128;&#156;up&#226;&#128;&#157; until you issue the orte-submit -terminate command, or hit the orte-dvm process with a sigterm.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; (b) orte-submit - takes the place of mpirun. Basically just packages your app and arguments and sends it to orte-dvm for execution. Requires the URI of orte-dvm. The tool exits once the job has completed execution, though you can run multiple jobs in parallel by backgrounding orte-submit or issuing commands from separate shells.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; I&#226;&#128;&#153;ve added man pages for both tools, though they may not be complete. Also, I don&#226;&#128;&#153;t have all the mapping/ranking/binding options supported just yet as I first wanted to see if this meets your basic needs before worrying about the detail.
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; On Jan 21, 2015, at 4:07 PM, Mark Santcroos &lt;mark.santcroos_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; Let me address your questions up here so you don&#226;&#128;&#153;t have to scan thru the entire note.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; PMIx rationale: PMI has been around for a long time, primarily used inside the MPI library implementations to perform wireup. It provided a link from the MPI library to the local resource manager. However, as we move towards exascale, two things became apparent:
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 1. the current PMI implementations don&#226;&#128;&#153;t scale adequately to get there. The API created too many communications and assumed everything was a blocking operation, thus preventing asynchronous progress
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; 2. there were increasing requests for application-level interactions to the resource manager. People want ways to spawn jobs (and not just from within MPI), request pre-location of data, control power, etc. Rather than having every RM write its own interface (and thus make everyone&#226;&#128;&#153;s code non-portable), we at Intel decided to extend the existing PMI definitions to support those functions. Thus, an application developer can directly access PMIx functions to perform all those operations.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; PMIx v1.0 is about to be released - it&#226;&#128;&#153;ll be backward compatible with PMI-1 and PMI-2, plus add non-blocking operations and significantly reduce the number of communications. PMIx 2.0 is slated for this summer and will include the advanced controls capabilities.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; ORCM is being developed because we needed a BSD-licensed, fully featured resource manager. This will allow us to integrate the RM even more tightly to the file system, networking, and other subsystems, thus achieving higher launch performance and providing desired features such as QoS management. PMIx is a part of that plan, but as you say, they each play their separate roles in the overall stack.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Persistent ORTE: there is a learning curve on ORTE, I fear. We do have some videos on the web site that can help get you started, and I&#226;&#128;&#153;ve given a number of &#226;&#128;&#156;classes&quot; at Intel now for that purpose. I still have it on my &#226;&#128;&#156;to-do&#226;&#128;&#157; list that I summarize those classes and post them on the web site.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; For now, let me summarize how things work. At startup, mpirun reads the allocation (usually from the environment, but it depends on the host RM) and launches a daemon on each allocated node. Each daemon reads its local hardware environment and &#226;&#128;&#156;phones home&#226;&#128;&#157; to let mpirun know it is alive. Once all daemons have reported, mpirun maps the processes to the nodes and sends that map to all the daemons in a scalable broadcast pattern.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; Upon receipt of the launch message, each daemon parses it to identify which procs it needs to locally spawn. Once spawned, each proc connects back to its local daemon via a Unix domain socket for wireup support. As procs complete, the daemon maintains bookkeeping and reports back to mpirun once all procs are done. When all procs are reported complete (or one reports as abnormally terminated), mpirun sends a &#226;&#128;&#156;die&#226;&#128;&#157; message to every daemon so it will cleanly terminate.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt; What I will do is simply tell mpirun to not do that last step, but instead to wait to receive a &#226;&#128;&#156;terminate&#226;&#128;&#157; cmd before ending the daemons. This will allow you to reuse the existing DVM, making each independent job start a great deal faster. You&#226;&#128;&#153;ll need to either manually terminate the DVM, or the RM will do so when the allocation expires.
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; On Jan 21, 2015, at 12:52 PM, Mark Santcroos &lt;mark.santcroos_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Hi Ralph,
...
<span class="quotelev1">&gt; &gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/01/26227.php">http://www.open-mpi.org/community/lists/users/2015/01/26227.php</a>
</span><br>
<span class="quotelev4">&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt; &gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/01/26228.php">http://www.open-mpi.org/community/lists/users/2015/01/26228.php</a>
</span><br>
<span class="quotelev3">&gt; &gt;&gt;
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/01/26229.php">http://www.open-mpi.org/community/lists/users/2015/01/26229.php</a>
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/02/26249.php">http://www.open-mpi.org/community/lists/users/2015/02/26249.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/02/26254.php">http://www.open-mpi.org/community/lists/users/2015/02/26254.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/02/26256.php">http://www.open-mpi.org/community/lists/users/2015/02/26256.php</a>
</span><br>
<!-- body="end" -->
<hr>
<ul class="links">
