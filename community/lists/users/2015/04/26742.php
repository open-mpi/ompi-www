...
?>
<!-- received="Wed Apr 15 15:39:33 2015" -->
<!-- isoreceived="20150415193933" -->
<!-- sent="Wed, 15 Apr 2015 15:39:25 -0400" -->
<!-- isosent="20150415193925" -->
<!-- name="Andy Riebs" -->
<!-- email="andy.riebs_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC" -->
<!-- id="552EBE6D.30306_at_hp.com" -->
...
<strong>Date:</strong> 2015-04-15 15:39:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26743.php">Gilles Gouaillardet: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Previous message:</strong> <a href="26741.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_Init() time"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26743.php">Gilles Gouaillardet: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    ...
    save others from some frustration in the future.<br>
    <br>
    Andy<br>
    <br>
    <br>
    <div class="moz-cite-prefix">On 04/14/2015 11:10 PM, Ralph Castain
      wrote:<br>
    </div>
    <blockquote
      cite="mid:9D9F9A8F-01AB-49CE-94B7-0E7BE8897ECF@open-mpi.org"
      type="cite">
      ...
      <div class="">What we have required, therefore, is that your path
        be setup properly in the remote .bashrc (or pick your shell) to
        handle the libraries.</div>
      <div class=""><br class="">
      </div>
      <div class="">As I indicated, the -x option only forwards envars
        ...
        and cause failures.</div>
      <div class=""><br class="">
      </div>
      <div class="">I’d try the static method first, or perhaps the
        LDFLAGS Gilles suggested.</div>
      <div class=""><br class="">
      </div>
      <div class=""><br class="">
        <div>
          <blockquote type="cite" class="">
            <div class="">On Apr 14, 2015, at 5:11 PM, Gilles
              Gouaillardet &lt;<a moz-do-not-send="true"
                href="mailto:gilles@rist.or.jp" class="">gilles@rist.or.jp</a>&gt;
              wrote:</div>
            <br class="Apple-interchange-newline">
            <div class="">
              <div bgcolor="#FFFFFF" text="#000000" class=""> Andy,<br
                  class="">
                <br class="">
                ...
                original orted<br class="">
                <br class="">
                do you have the same behaviour on non MIC hardware when
                Open MPI is compiled with intel compilers ?<br class="">
                if it works on non MIC hardware, the root cause could be
                in the sshd_config of the MIC that does not<br class="">
                accept to receive LD_LIBRARY_PATH<br class="">
                <br class="">
                my 0.02 US$<br class="">
                <br class="">
                Gilles<br class="">
                <br class="">
                <div class="moz-cite-prefix">On 4/14/2015 11:20 PM,
                  Ralph Castain wrote:<br class="">
                </div>
                <blockquote
                  cite="mid:DA352D43-9531-424B-9346-276544BE79EA@open-mpi.org"
                  type="cite" class=""> Hmmm…certainly looks that way.
                  I’ll investigate.
                  <div class=""><br class="">
                    <div class="">
                      <blockquote type="cite" class="">
                        <div class="">On Apr 14, 2015, at 6:06 AM, Andy
                        ...
                        <div class="">
                          <div bgcolor="#FFFFFF" text="#000000" class="">
                            ...
                            propagated?<br class="">
                            <br class="">
                            $ ldd /home/ariebs/mic/mpi-nightly/bin/orted<br
                              class="">
                                    linux-vdso.so.1 =&gt; 
                            (0x00007fffa1d3b000)<br class="">
                                    libopen-rte.so.0 =&gt;
                            ...
                                    libutil.so.1 =&gt;
                            /lib64/libutil.so.1 (0x00002ab6cf1f9000)<br
                              class="">
                                    libgcc_s.so.1 =&gt;
                            /lib64/libgcc_s.so.1 (0x00002ab6cf3fc000)<br
                              class="">
                                    libpthread.so.0 =&gt;
                            /lib64/libpthread.so.0 (0x00002ab6cf60f000)<br
                              class="">
...
--------------------------------------------------------------------------<br
                            ...
                            specified in the environment or<br class="">
                            on the command line.  Deprecated MCA
                            variables should be avoided;<br class="">
                            they may disappear in future releases.<br
                              class="">
                            <br class="">
                              Deprecated variable:
                            mca_component_show_load_errors<br class="">
                              New variable:       
                            mca_base_component_show_load_errors<br
                              class="">
--------------------------------------------------------------------------<br
                              class="">
                            ...
                            plm:rsh_lookup on agent ssh : rsh path NULL<br
                              class="">
                            [atl1-02-mic0:16183] mca:base:select:(  plm)
                            Query of component [rsh] set priority to 10<br
                              class="">
                            [atl1-02-mic0:16183] mca:base:select:(  plm)
                            ...
                            return a module<br class="">
                            [atl1-02-mic0:16183] mca:base:select:(  plm)
                            Selected component [rsh]<br class="">
                            [atl1-02-mic0:16183] plm:base:set_hnp_name:
                            initial bias 16183 nodename hash 4238360777<br
                              class="">
                            [atl1-02-mic0:16183] plm:base:set_hnp_name:
                            final jobfam 33630<br class="">
                            ...
                            [[33630,0],1] to node mic1<br class="">
                            [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:
                            launching vm<br class="">
                            [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:
                            local shell: 0 (bash)<br class="">
                            [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:
                            assuming same remote shell as local shell<br
                              class="">
                            [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:
                            remote shell: 0 (bash)<br class="">
                            [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:
                            final template argv:<br class="">
                            ...
                            "rsh" -mca rmaps_ppr_n_pernode "2"<br
                              class="">
                            [atl1-02-mic0:16183] [[33630,0],0]
                            plm:rsh:launch daemon 0 not a child of mine<br
                              class="">
                            [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:
                            adding node mic1 to launch list<br class="">
                            [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:
                            activating launch event<br class="">
                            [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:
                            recording launch of daemon [[33630,0],1]<br
                              class="">
                            [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:
                            ...
                            -mca orte_hnp_uri "2203975680.0;usock;<a
                              moz-do-not-send="true"
                              href="tcp://16.113.180.127,192.0.0.122:34640;ud://2883658.78.1"
                              class="">tcp://16.113.180.127,192.0.0.122:34640;ud://2883658.78.1</a>"
                            --tree-spawn --mca spml "yoda" --mca btl
                            ...
                            failed with status 127<br class="">
                            [atl1-02-mic0:16183] [[33630,0],0]
...
--------------------------------------------------------------------------<br
                            ...
                            <div class="moz-cite-prefix">On 04/13/2015
                              07:47 PM, Ralph Castain wrote:<br class="">
                            </div>
                            <blockquote
                              cite="mid:0FD29869-A148-4088-BC82-F56A94C8BBF6@open-mpi.org"
                              type="cite" class=""> Weird. I’m not sure
                              ...
                              <div class=""><br class="">
                                <div class="">
                                  <blockquote type="cite" class="">
                                    <div class="">On Apr 13, 2015, at
                                      1:58 PM, Andy Riebs &lt;<a
                                        moz-do-not-send="true"
                                    ...
                                    <div class="">
                                      <div bgcolor="#FFFFFF"
                                        ...
                                        belongs on the remote system:<br
                                          class="">
                                        <br class="">
                                        ...
                                                libutil.so.1 =&gt;
                                        /lib64/libutil.so.1
                                        (0x00002b059e371000)<br class="">
                                                libgcc_s.so.1 =&gt;
                                        /lib64/libgcc_s.so.1
                                        (0x00002b059e574000)<br class="">
                                                libpthread.so.0 =&gt;
                                        /lib64/libpthread.so.0
                                        (0x00002b059e786000)<br class="">
                                                libc.so.6 =&gt;
                                        /lib64/libc.so.6
                                        ...
                                        btl scif,self $PWD/mic.out<br
                                          class="">
                                        /home/ariebs/mic/mpi-nightly/bin/orted:
                                        <b class="">error while loading
                                          shared libraries: libimf.so</b>:
...
_______________________________________________<br class="">
                          ...
                          Link to this post: <a moz-do-not-send="true"
                            class="moz-txt-link-freetext"
                            href="http://www.open-mpi.org/community/lists/users/2015/04/26716.php">http://www.open-mpi.org/community/lists/users/2015/04/26716.php</a></div>
                      </blockquote>
                    </div>
                    <br class="">
                  </div>
...
<a moz-do-not-send="true" class="moz-txt-link-abbreviated" href="mailto:users@open-mpi.org">users@open-mpi.org</a>
Subscription: <a moz-do-not-send="true" class="moz-txt-link-freetext" href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a>
Link to this post: <a moz-do-not-send="true" class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26718.php">http://www.open-mpi.org/community/lists/users/2015/04/26718.php</a></pre>
                </blockquote>
                <br class="">
              </div>
              ...
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a><br
                class="">
              Link to this post:
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26731.php">http://www.open-mpi.org/community/lists/users/2015/04/26731.php</a></div>
          </blockquote>
        </div>
        <br class="">
      </div>
...
Link to this post: <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26732.php">http://www.open-mpi.org/community/lists/users/2015/04/26732.php</a></pre>
    </blockquote>
    <br>
  </body>
