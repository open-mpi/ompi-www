...
?>
<!-- received="Mon Apr  6 15:09:41 2015" -->
<!-- isoreceived="20150406190941" -->
<!-- sent="Mon, 6 Apr 2015 13:09:18 -0600" -->
<!-- isosent="20150406190918" -->
<!-- name="Hamidreza Anvari" -->
<!-- email="hr.anvari_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI 1.8.4 - Java Library - allToAllv()" -->
<!-- id="CACRiV2jNZQALefEdpxebbYVdUycaXSriCMnOy-F2j_bvoWULiw_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
<!-- inreplyto="CA8AE23F-1EF7-43F9-B6D6-BAF202A1BDE8_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-06 15:09:18
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26618.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.2 problems on CentOS 6.3"</a>
<li><strong>Previous message:</strong> <a href="26616.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.8.4 - Java Library - allToAllv()"</a>
<li><strong>In reply to:</strong> <a href="26616.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.8.4 - Java Library - allToAllv()"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26620.php">Howard Pritchard: "Re: [OMPI users] OpenMPI 1.8.4 - Java Library - allToAllv()"</a>
<li><strong>Reply:</strong> <a href="26620.php">Howard Pritchard: "Re: [OMPI users] OpenMPI 1.8.4 - Java Library - allToAllv()"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hello,
<br>
<p>1. I'm using Java/Javac version 1.8.0_20 under OS X 10.10.2.
<br>
<p>2. I have used the following configuration for making OpenMPI:
<br>
...
<p>make all install
<br>
<p>3. As a logical point of view, size2 is the maximum expected data to
<br>
receive, which in turn might be less that this maximum.
<br>
<p>4. I will try to prepare a working reproducer of my error and send it to
<br>
you.
<br>
<p>Thanks,
...
-- HR
<br>
<p>On Mon, Apr 6, 2015 at 10:46 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I've talked to the folks who wrote the Java bindings. One possibility we
</span><br>
<span class="quotelev1">&gt; identified is that there may be an error in your code when you did the
</span><br>
<span class="quotelev1">&gt; translation
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; My immediate thought is that each process can not receive more elements
</span><br>
<span class="quotelev1">&gt; than it was sent to them. That's the reason of truncation error.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; didn't get translated correctly from your C++ version to the Java version?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; On Apr 6, 2015, at 5:03 AM, Howard Pritchard &lt;hppritcha_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; If not too much trouble, can you extract just the alltoallv portion and
</span><br>
...
<span class="quotelev2">&gt;&gt; MPI.COMM_WORLD.allToAllv(data, subpartition_size, subpartition_offset,
</span><br>
<span class="quotelev2">&gt;&gt; MPI.INT &lt;<a href="http://mpi.int/">http://mpi.int/</a>&gt;,
</span><br>
...
<span class="quotelev2">&gt;&gt; Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to see all help / error
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26617/attachment">attachment</a>
</ul>
