...
?>
<!-- received="Fri Apr 24 09:40:15 2015" -->
<!-- isoreceived="20150424134015" -->
<!-- sent="Fri, 24 Apr 2015 16:40:04 +0300" -->
<!-- isosent="20150424134004" -->
<!-- name="Mike Dubman" -->
<!-- email="miked_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned processes" -->
<!-- id="CAAO1KyZtVK8MZ6DGwtFZTk+_1Q1Kz7iE02_9_Ap1Yiyk3PMwPw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="C6504735-1B45-4218-ACA7-12C8BD8B6C4B_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-24 09:40:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26786.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned processes"</a>
<li><strong>Previous message:</strong> <a href="26784.php">George Bosilca: "Re: [OMPI users] Hang in MPI_Comm_split in 2 RHEL Linux nodes with INTEL MIC cards"</a>
<li><strong>In reply to:</strong> <a href="26783.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned processes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26786.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned processes"</a>
<li><strong>Reply:</strong> <a href="26786.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned processes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I think some minimal kernel version required (2.6.x) which supports these
<br>
flags.
<br>
<p>I can check if internally if you think the behave is different.
<br>
<p><p>On Fri, Apr 24, 2015 at 1:41 PM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]
<br>
...
<span class="quotelev2">&gt; &gt; On Apr 24, 2015, at 2:54 AM, Mike Dubman &lt;miked_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt;
</span><br>
<span class="quotelev2">&gt; &gt; btw, ompi master now calls ibv_fork_init() before initializing
</span><br>
...
<span class="quotelev2">&gt; &gt; On Fri, Apr 24, 2015 at 4:37 AM, Jeff Squyres (jsquyres) &lt;
</span><br>
<span class="quotelev1">&gt; jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt; &gt; Disable the memory manager / don't use leave pinned.  Then you can
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; On Apr 23, 2015, at 9:25 PM, Howard Pritchard &lt;hppritcha_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; this is kind of a lanl thing. Jack and I are working offline.  any
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; I am using a &#226;&#128;&#156;homecooked&#226;&#128;&#157; cluster at LANL, ~500 cores.  There are a
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; From: users [mailto:users-bounces_at_[hidden]] On Behalf Of Howard
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; Subject: Re: [OMPI users] MPI_Finalize not behaving correctly,
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; Are you using a system at LANL? Maybe I could try to reproduce the
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; I have an MPI program that is fairly straight forward, essentially
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; This seems straightforward, but I'm not getting mpi_finalize to work
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;     !&lt;set up some stuff then call MPI_SEND in a loop over number of
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; Now the problem I am seeing occurs around the &quot;got here4&quot;, &quot;got here5&quot;
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt;           inet addr:192.168.6.254  Bcast:192.168.6.255
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; This problem only occurs in this simple implementation, thus my
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26785/attachment">attachment</a>
</ul>
