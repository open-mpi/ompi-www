...
?>
<!-- received="Wed Apr 15 02:32:16 2015" -->
<!-- isoreceived="20150415063216" -->
<!-- sent="Wed, 15 Apr 2015 06:32:11 +0000" -->
<!-- isosent="20150415063211" -->
...
<!-- id="FC64FEF6471E804DA9CA2F6DBDCFD62B014C6677_at_EXDAG0-B2.intra.cea.fr" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="F17CFF81-C8E7-471E-A475-BB9BFBCA0EDD_at_icl.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-15 02:32:11
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26734.php">John Hearns: "[OMPI users] Select a card in a multi card system"</a>
<li><strong>Previous message:</strong> <a href="26732.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>In reply to:</strong> <a href="26721.php">George Bosilca: "Re: [OMPI users] mpi_type_create_struct not working for large counts"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26736.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mpi_type_create_struct not working for large counts"</a>
<li><strong>Reply:</strong> <a href="26736.php">Jeff Squyres (jsquyres): "Re: [OMPI users] mpi_type_create_struct not working for large counts"</a>
<li><strong>Reply:</strong> <a href="26744.php">Howard Pritchard: "Re: [OMPI users] mpi_type_create_struct not working for large counts"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi George,
<br>
<p>I think you forgot the ierror argument in the call to mpi_irecv, but after correcting this it works fine. Thanks a lot for pointing out the issue of the eager limit!
<br>
<p>But as you said, this does not directly solve my one-sided problem...
<br>
<p>Thanks,
<br>
Stephan
...
<br>
Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/04/26721.php">http://www.open-mpi.org/community/lists/users/2015/04/26721.php</a>
<br>
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26733/attachment">attachment</a>
</ul>
