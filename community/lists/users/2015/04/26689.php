...
?>
<!-- received="Mon Apr 13 08:50:05 2015" -->
<!-- isoreceived="20150413125005" -->
<!-- sent="Mon, 13 Apr 2015 08:50:01 -0400" -->
<!-- isosent="20150413125001" -->
<!-- name="Andy Riebs" -->
<!-- email="andy.riebs_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC" -->
<!-- id="552BBB79.2070409_at_hp.com" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2015-04-13 08:50:01
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26690.php">Ralph Castain: "Re: [OMPI users] Running mpi with different account"</a>
<li><strong>Previous message:</strong> <a href="26688.php">Mike Dubman: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26697.php">Andy Riebs: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Reply:</strong> <a href="26697.php">Andy Riebs: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    ...
    allocation<br>
    [atl1-01-mic0:190439] [[31875,0],0] complete_setup on job [31875,1]<br>
    ...
    6029314                            /home/ariebs/bench/hello/mic.out<br>
    ...
    270532608 bytes type=0x1 id=0xFFFFFFFF<br>
      ...
      <div class=""><br class="">
        <div>
          <blockquote type="cite" class="">
            <div class="">On Apr 12, 2015, at 11:30 AM, Andy Riebs &lt;<a
...
href="https://www.open-mpi.org/nightly/v1.8/openmpi-v1.8.4-202-gc2da6a5.tar.bz2"
                ...
                [atl1-01-mic0:190189] [[32137,0],0] ORTE_ERROR_LOG: Not
                found in file base/plm_base_launch_support.c at line 440<br
                  class="">
                [atl1-01-mic0:190189] [[32137,0],0] plm:base:launch_apps
                for job [32137,1]<br class="">
                ...
                [32137,1] is not a dynamic spawn<br class="">
--------------------------------------------------------------------------<br
                  class="">
...
--------------------------------------------------------------------------<br
                ...
                <blockquote
                  ...
                  <div class=""><br class="">
                    <div class="">
                      <blockquote type="cite" class="">
                        <div class="">On Apr 11, 2015, at 9:52 AM, Andy
                        ...
                        <div class="">
                          <div bgcolor="#FFFFFF" text="#000000" class="">
                            Everything is built on the Xeon side, with
                            the icc "-mmic" switch. I then ssh into one
                            of the PHIs, and run shmemrun from there.<br
                              class="">
                            <br class="">
                            <br class="">
                            ...
                            <blockquote
                              ...
                              understand the setup a little better. Are
                              you running shmemrun on the PHI itself? Or
                              is it running on the host processor, and
                              you are trying to spawn a process onto the
                              Phi?
                              <div class=""><br class="">
                              </div>
                              <div class=""><br class="">
                                    ...
                                    <div class="">
                                      <div bgcolor="#FFFFFF"
                                        ...
                                        --enable-mca-no-build=btl-usnic,btl-openib,common-verbs,oob-ud<br
                                          class="">
                                        <br class="">
                                        (Note that I had to add "oob-ud"
                                        to the "--enable-mca-no-build"
                                        option, as the build complained
                                        that mca oob/ud needed mca
                                        common-verbs.)<br class="">
                                        <br class="">
                                        With that configuration, here is
                                        what I am seeing now...<br
                                          class="">
                                        <br class="">
                                        $ export
                                        ...
                                        [atl1-01-mic0:189895]
                                        mca:base:select:(  plm) Query of
                                        component [rsh] set priority to
                                        10<br class="">
                                        [atl1-01-mic0:189895]
                                        mca:base:select:(  plm) Querying
                                        component [isolated]<br class="">
                                        [atl1-01-mic0:189895]
                                        mca:base:select:(  plm) Query of
                                        component [isolated] set
                                        priority to 0<br class="">
                                        [atl1-01-mic0:189895]
                                        mca:base:select:(  plm) Querying
                                        component [slurm]<br class="">
                                        [atl1-01-mic0:189895]
                                        mca:base:select:(  plm) Skipping
                                        component [slurm]. Query failed
                                        to return a module<br class="">
                                        [atl1-01-mic0:189895]
                                        mca:base:select:(  plm) Selected
                                        component [rsh]<br class="">
                                        [atl1-01-mic0:189895]
                                        ...
                                        start comm<br class="">
                                        [atl1-01-mic0:189895]
                                        [[32419,0],0] plm:base:setup_job<br
                                          class="">
                                        [atl1-01-mic0:189895]
                                        [[32419,0],0] plm:base:setup_vm<br
                                          class="">
                                        [atl1-01-mic0:189895]
                                        [[32419,0],0] plm:base:setup_vm
                                        creating map<br class="">
                                        [atl1-01-mic0:189895]
                                        [[32419,0],0] setup:vm: working
                                        unmanaged allocation<br class="">
                                        [atl1-01-mic0:189895]
                                        ...
                                        [atl1-01-mic0:189895]
                                        [[32419,0],0] plm:base:setup_vm
                                        only HNP in allocation<br
                                          class="">
                                        [atl1-01-mic0:189895]
                                        [[32419,0],0] complete_setup on
                                        ...
                                        wiring up iof for job [32419,1]<br
                                          class="">
                                        [atl1-01-mic0:189895]
                                        [[32419,0],0] plm:base:launch
...
-------------------------------------------------------<br class="">
                                        [atl1-01-mic0:189895]
                                        [[32419,0],0] plm:base:orted_cmd
                                        sending orted_exit commands<br
                                          class="">
--------------------------------------------------------------------------<br
                                          class="">
...
--------------------------------------------------------------------------<br
                                        ...
                                        [atl1-01-mic0:189895] 1 more
                                        process has sent help message
                                        help-shmem-runtime.txt / oshmem
                                        shmem abort:cannot guarantee all
                                        killed<br class="">
                                        [atl1-01-mic0:189895]
                                        [[32419,0],0] plm:base:receive
                                        stop comm<br class="">
                                        ...
                                        <blockquote
                                          ...
                                          current 1.8.5 nightly tarball
                                          and see if it helps? The error
                                          log indicates that it is
                                          failing to get the topology
                                          from some daemon, I�m assuming
                                          the one on the Phi?
                                          <div class=""><br class="">
                                          </div>
                                          <div class="">You might also
                                            add �enable-debug to that
                                            configure line and then put
                                            -mca plm_base_verbose on the
                                            shmemrun cmd to get more
                                            help</div>
                                          <div class=""><br class="">
                                          </div>
                                          <div class=""><br class="">
...
Link to this post: <a moz-do-not-send="true" class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26682.php">http://www.open-mpi.org/community/lists/users/2015/04/26682.php</a></pre>
              ...
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a><br
                class="">
              Link to this post:
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26683.php">http://www.open-mpi.org/community/lists/users/2015/04/26683.php</a></div>
          </blockquote>
        </div>
        <br class="">
      </div>
...
Link to this post: <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26684.php">http://www.open-mpi.org/community/lists/users/2015/04/26684.php</a></pre>
    </blockquote>
    <br>
  </body>
