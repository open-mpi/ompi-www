...
?>
<!-- received="Wed Apr 22 00:59:04 2015" -->
<!-- isoreceived="20150422045904" -->
<!-- sent="Tue, 21 Apr 2015 21:59:00 -0700" -->
<!-- isosent="20150422045900" -->
<!-- name="Subhra Mazumdar" -->
<!-- email="subhramazumdar1_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl" -->
<!-- id="CAATkYOWqi9mJZkahWa05ubJdbRQNp6ZsZYsXYQzJiwbws1dB0Q_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAAO1KyZ9EK34XZ+7qhWLSyBxxftO28SeSON7tO727K4QsndHBw_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-22 00:59:00
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26762.php">Mike Dubman: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
<li><strong>Previous message:</strong> <a href="26760.php">Siegmar Gross: "[OMPI users] problem with Java in openmpi-dev-1567-g11e8c20"</a>
<li><strong>In reply to:</strong> <a href="26754.php">Mike Dubman: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26762.php">Mike Dubman: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
<li><strong>Reply:</strong> <a href="26762.php">Mike Dubman: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>I compiled the openmpi that comes inside the mellanox hpcx package with mxm
<br>
...
<p>--------------------------------------------------------------------------
<br>
<p>&lt;application runs fine&gt;
<br>
<p><p>Thanks,
<br>
Subhra.
<br>
<p><p>On Sat, Apr 18, 2015 at 12:28 AM, Mike Dubman &lt;miked_at_[hidden]&gt;
<br>
wrote:
<br>
<p><span class="quotelev1">&gt; could you please check that ofed_info -s indeed prints mofed 2.4-1.0.0?
</span><br>
...
<span class="quotelev2">&gt;&gt; [root_at_JARVICE hpcx-v1.2.0-325-gcc-MLNX_OFED_LINUX-2.4-1.0.0-redhat6.5]#
</span><br>
...
<span class="quotelev2">&gt;&gt; [1429334876.139452] [JARVICE:449  :0]   ib_dev.c:445  MXM  WARN  failed
</span><br>
<span class="quotelev2">&gt;&gt; call to ibv_exp_use_priv_env(): Function not implemented
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; [1429334876.139982] [JARVICE:449  :0]   ib_dev.c:445  MXM  WARN  failed
</span><br>
<span class="quotelev2">&gt;&gt; call to ibv_exp_use_priv_env(): Function not implemented
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; [1429334876.142649] [JARVICE:450  :0]   ib_dev.c:445  MXM  WARN  failed
</span><br>
<span class="quotelev2">&gt;&gt; call to ibv_exp_use_priv_env(): Function not implemented
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; [1429334876.143235] [JARVICE:450  :0]   ib_dev.c:445  MXM  WARN  failed
</span><br>
<span class="quotelev2">&gt;&gt; call to ibv_exp_use_priv_env(): Function not implemented
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; mpirun noticed that process rank 1 with PID 450 on node JARVICE exited on
</span><br>
...
<span class="quotelev2">&gt;&gt; [JARVICE:00447] Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to see
</span><br>
...
<span class="quotelev2">&gt;&gt; On Mon, Apr 13, 2015 at 10:58 PM, Mike Dubman &lt;miked_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun noticed that process rank 0 with PID 564 on node JARVICE exited
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [JARVICE:00562] 1 more process has sent help message help-mca-base.txt
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; / find-available:not-valid
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [JARVICE:00562] Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Sun, Apr 12, 2015 at 10:48 PM, Mike Dubman &lt;miked_at_[hidden]
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I used mxm mtl as follows but getting segfault. It says mxm component
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; not found but I have compiled openmpi with mxm. Any idea what I might be
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; You can use OMPI w/ mxm (-mca mtl mxm) and multiple thread mode
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; lin 1.8 x series or (-mca pml yalla) in the master branch.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Can MPI_THREAD_MULTIPLE and openib btl work together in open
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpi 1.8.4? If so are there any command line options needed during run time?
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Thanks,
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26761/attachment">attachment</a>
</ul>
