...
?>
<!-- received="Wed Apr 15 08:05:32 2015" -->
<!-- isoreceived="20150415120532" -->
<!-- sent="Wed, 15 Apr 2015 12:05:28 +0000" -->
<!-- isosent="20150415120528" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpi_type_create_struct not working for large counts" -->
<!-- id="B0D6D470-1139-4305-BC39-6EBAF6101F88_at_cisco.com" -->
...
<strong>Date:</strong> 2015-04-15 08:05:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26737.php">Ralph Castain: "Re: [OMPI users] MPI_Init() time"</a>
<li><strong>Previous message:</strong> <a href="26735.php">cristian: "[OMPI users] MPI_Init() time"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26744.php">Howard Pritchard: "Re: [OMPI users] mpi_type_create_struct not working for large counts"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
&lt;mandatory Fortran notice&gt;
<br>
<p>Stop using mpif.h.
<br>
<p>Upgrading to use the &quot;mpi&quot; module is a very simple upgrade, and gives you at least some measure of type safety and argument checking (e.g., it would have failed to compile with that missing ierror argument).
<br>
<p>If you have a modern enough Fortran compiler (e.g., gfortran &gt;= 4.9 or any recent ifort or ...), you can upgrade to use the &quot;mpi_f08&quot; module, which gives much better type safety and argument checking than the &quot;mpi&quot; module.  There's a bit of work involved to upgrade your code from mpif.h-&gt;mpi_f08, but it'll be well worth it.
<br>
<p>&lt;/mandatory Fortran notice&gt;
<br>
<p><p><span class="quotelev1">&gt; On Apr 15, 2015, at 2:32 AM, MOHR STEPHAN 239883 &lt;STEPHAN.MOHR_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; I think you forgot the ierror argument in the call to mpi_irecv, but after correcting this it works fine. Thanks a lot for pointing out the issue of the eager limit!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; From: users [users-bounces_at_[hidden]] on behalf of George Bosilca [bosilca_at_[hidden]]
</span><br>
...
<span class="quotelev2">&gt; &gt; On Apr 14, 2015, at 11:07 , MOHR STEPHAN 239883 &lt;STEPHAN.MOHR_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt; &gt; I tried with send/recv, but the outcome is the same. It works for small counts (e.g. n=100), but hangs for larger ones (e.g. n=1000).
</span><br>
...
<span class="quotelev2">&gt; &gt; Subject: Re: [OMPI users] mpi_type_create_struct not working for large counts
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;   From: users [users-bounces_at_[hidden]] on behalf of Howard Pritchard
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;   For starters, would you mind sending the output you get when you run the
</span><br>
<span class="quotelev3">&gt; &gt;&gt;   ompi_info command?
</span><br>
<span class="quotelev3">&gt; &gt;&gt;   If you could, it would be great if you could try running the test against
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;     The problem can be reproduced using the small standalone program which I
</span><br>
<span class="quotelev3">&gt; &gt;&gt;     attached. It just creates a type which should be equivalent to n
</span><br>
<span class="quotelev3">&gt; &gt;&gt;     contiguous elements. This type is then used in a mpi_get. With a value
</span><br>
<span class="quotelev3">&gt; &gt;&gt;     n=100 it works fine, but with n=1000 it either hangs (version 1.8.1) or
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; Fort mpi_f08 compliance: The mpi_f08 module is available, but due to limitations in the ifort compiler, does not support the following: array subsections, direct passthru (where possible) to underlying Open MPI's C functionality
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;     C compiler absolute: /local/stephanm/composer_xe_2013_sp1.0.080/bin/intel64/icc
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;   C++ compiler absolute: /local/stephanm/composer_xe_2013_sp1.0.080/bin/intel64/icpc
</span><br>
<span class="quotelev3">&gt; &gt;&gt;           Fort compiler: ifort
</span><br>
<span class="quotelev3">&gt; &gt;&gt;       Fort compiler abs: /local/stephanm/composer_xe_2013_sp1.0.080/bin/intel64/ifort
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;          Thread support: posix (MPI_THREAD_MULTIPLE: no, OPAL support: yes, OMPI progress: no, ORTE progress: yes, Event lib: yes)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;               MCA event: libevent2021 (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;               MCA hwloc: hwloc191 (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;                  MCA if: posix_ipv4 (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;                  MCA if: linux_ipv6 (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;              MCA errmgr: default_app (MCA v2.0, API v3.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;              MCA errmgr: default_hnp (MCA v2.0, API v3.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;              MCA errmgr: default_orted (MCA v2.0, API v3.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;              MCA errmgr: default_tool (MCA v2.0, API v3.0, Component v1.8.5)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;                 MCA ess: singleton (MCA v2.0, API v3.0, Component v1.8.5)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;                 MCA ras: loadleveler (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;                 MCA ras: simulator (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;               MCA rmaps: rank_file (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;               MCA rmaps: resilient (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;               MCA rmaps: round_robin (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;               MCA state: staged_hnp (MCA v2.0, API v1.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;               MCA state: staged_orted (MCA v2.0, API v1.0, Component v1.8.5)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;                MCA bcol: basesmuma (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;               MCA fcoll: individual (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;               MCA fcoll: static (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;               MCA fcoll: two_phase (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;                MCA sbgp: basesmsocket (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;                MCA sbgp: basesmuma (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;                MCA sbgp: p2p (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;            MCA sharedfp: individual (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev3">&gt; &gt;&gt;            MCA sharedfp: lockedfile (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt;           MCA vprotocol: pessimist (MCA v2.0, API v2.0, Component v1.8.5)
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev3">&gt; &gt;&gt; _______________________________________________
...
<span class="quotelev3">&gt; &gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/04/26713.php">http://www.open-mpi.org/community/lists/users/2015/04/26713.php</a>
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/04/26720.php">http://www.open-mpi.org/community/lists/users/2015/04/26720.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/04/26721.php">http://www.open-mpi.org/community/lists/users/2015/04/26721.php</a>
</span><br>
<span class="quotelev1">&gt; _______________________________________________
</span><br>
<span class="quotelev1">&gt; users mailing list
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/04/26733.php">http://www.open-mpi.org/community/lists/users/2015/04/26733.php</a>
</span><br>
<p><p><pre>
-- 
Jeff Squyres
