...
?>
<!-- received="Fri Apr 24 02:54:38 2015" -->
<!-- isoreceived="20150424065438" -->
<!-- sent="Fri, 24 Apr 2015 09:54:36 +0300" -->
<!-- isosent="20150424065436" -->
<!-- name="Mike Dubman" -->
<!-- email="miked_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned processes" -->
<!-- id="CAAO1KyaYSjrMmEncGKFATNEzoUFWLJccx3jK=pxp_NPGOwBX=g_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="1772D3CC-0012-4040-9B8D-4140DC0D8299_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-24 02:54:36
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26779.php">Mike Dubman: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
<li><strong>Previous message:</strong> <a href="26777.php">Subhra Mazumdar: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
<li><strong>In reply to:</strong> <a href="26776.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned processes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26783.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned processes"</a>
<li><strong>Reply:</strong> <a href="26783.php">Jeff Squyres (jsquyres): "Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned processes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><p>On Fri, Apr 24, 2015 at 4:37 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]
<br>
<span class="quotelev1">&gt; wrote:
</span><br>
<p><span class="quotelev1">&gt; Disable the memory manager / don't use leave pinned.  Then you can
</span><br>
...
<span class="quotelev2">&gt; &gt; On Apr 23, 2015, at 9:25 PM, Howard Pritchard &lt;hppritcha_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt; wrote:
</span><br>
...
<span class="quotelev2">&gt; &gt; this is kind of a lanl thing. Jack and I are working offline.  any
</span><br>
...
<span class="quotelev2">&gt; &gt; I am using a &#226;&#128;&#156;homecooked&#226;&#128;&#157; cluster at LANL, ~500 cores.  There are a
</span><br>
...
<span class="quotelev2">&gt; &gt; Subject: Re: [OMPI users] MPI_Finalize not behaving correctly, orphaned
</span><br>
...
<span class="quotelev2">&gt; &gt; Are you using a system at LANL? Maybe I could try to reproduce the
</span><br>
...
<span class="quotelev2">&gt; &gt; I have an MPI program that is fairly straight forward, essentially
</span><br>
...
<span class="quotelev2">&gt; &gt; This seems straightforward, but I'm not getting mpi_finalize to work
</span><br>
...
<span class="quotelev2">&gt; &gt;     !&lt;set up some stuff then call MPI_SEND in a loop over number of
</span><br>
...
<span class="quotelev2">&gt; &gt; Now the problem I am seeing occurs around the &quot;got here4&quot;, &quot;got here5&quot;
</span><br>
<span class="quotelev1">&gt; and &quot;got here6&quot; statements. I get the appropriate number of print
</span><br>
...
<span class="quotelev2">&gt; &gt; I am running this on an infiniband backbone machine, with the NFS server
</span><br>
...
<span class="quotelev2">&gt; &gt;           inet addr:192.168.6.254  Bcast:192.168.6.255
</span><br>
...
<span class="quotelev2">&gt; &gt; This problem only occurs in this simple implementation, thus my thinking
</span><br>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26778/attachment">attachment</a>
</ul>
