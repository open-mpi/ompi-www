...
?>
<!-- received="Tue Apr 14 09:06:52 2015" -->
<!-- isoreceived="20150414130652" -->
<!-- sent="Tue, 14 Apr 2015 09:06:46 -0400" -->
<!-- isosent="20150414130646" -->
<!-- name="Andy Riebs" -->
<!-- email="andy.riebs_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC" -->
<!-- id="552D10E6.7040709_at_hp.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="0FD29869-A148-4088-BC82-F56A94C8BBF6_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-14 09:06:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26717.php">Ralph Castain: "Re: [OMPI users] hello world can't run in Ubuntu 12.04"</a>
<li><strong>Previous message:</strong> <a href="26715.php">Li Li: "[OMPI users] hello world can't run in Ubuntu 12.04"</a>
<li><strong>In reply to:</strong> <a href="26706.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26718.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Reply:</strong> <a href="26718.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    ...
    (0x00002ab6ce464000)<br>
            libopen-pal.so.0 =&gt;
    /home/ariebs/mic/mpi-nightly/lib/libopen-pal.so.0
    (0x00002ab6ce7d3000)<br>
            libm.so.6 =&gt; /lib64/libm.so.6 (0x00002ab6cebbd000)<br>
            libdl.so.2 =&gt; /lib64/libdl.so.2 (0x00002ab6ceded000)<br>
            librt.so.1 =&gt; /lib64/librt.so.1 (0x00002ab6ceff1000)<br>
            libutil.so.1 =&gt; /lib64/libutil.so.1 (0x00002ab6cf1f9000)<br>
            libgcc_s.so.1 =&gt; /lib64/libgcc_s.so.1
    (0x00002ab6cf3fc000)<br>
            libpthread.so.0 =&gt; /lib64/libpthread.so.0
    (0x00002ab6cf60f000)<br>
            libc.so.6 =&gt; /lib64/libc.so.6 (0x00002ab6cf82c000)<br>
            libimf.so =&gt;
    /opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libimf.so
    (0x00002ab6cfb84000)<br>
            libsvml.so =&gt;
    /opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libsvml.so
    (0x00002ab6cffd6000)<br>
            libirng.so =&gt;
    /opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libirng.so
    (0x00002ab6d086f000)<br>
            libintlc.so.5 =&gt;
    /opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libintlc.so.5
    (0x00002ab6d0a82000)<br>
...
--------------------------------------------------------------------------<br>
    A deprecated MCA variable value was specified in the environment or<br>
    on the command line.  Deprecated MCA variables should be avoided;<br>
    they may disappear in future releases.<br>
    <br>
      Deprecated variable: mca_component_show_load_errors<br>
      New variable:        mca_base_component_show_load_errors<br>
--------------------------------------------------------------------------<br>
    ...
    nodename hash 4238360777<br>
    [atl1-02-mic0:16183] plm:base:set_hnp_name: final jobfam 33630<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:rsh_setup on agent ssh : rsh
    path NULL<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:base:receive start comm<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:base:setup_job<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:base:setup_vm<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:base:setup_vm creating map<br>
    ...
    daemon [[33630,0],1] to node mic1<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: launching vm<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: local shell: 0 (bash)<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: assuming same remote
    shell as local shell<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: remote shell: 0 (bash)<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: final template argv:<br>
    ...
    or directory<br>
    [atl1-02-mic0:16183] [[33630,0],0] daemon 1 failed with status 127<br>
...
--------------------------------------------------------------------------<br>
    [atl1-02-mic0:16183] [[33630,0],0] plm:base:receive stop comm<br>
    <br>
    <br>
    <div class="moz-cite-prefix">On 04/13/2015 07:47 PM, Ralph Castain
      wrote:<br>
    </div>
    <blockquote
      ...
      <div class=""><br class="">
        <div>
          <blockquote type="cite" class="">
            <div class="">On Apr 13, 2015, at 1:58 PM, Andy Riebs &lt;<a
                moz-do-not-send="true" href="mailto:andy.riebs@hp.com"
                class="">andy.riebs@hp.com</a>&gt; wrote:</div>
            <br class="Apple-interchange-newline">
            <div class="">
              <div bgcolor="#FFFFFF" text="#000000" class=""> Ralph and
                Nathan,<br class="">
                <br class="">
                ...
                library is where it belongs on the remote system:<br
                  class="">
                <br class="">
                ...
                $ shmemrun -H mic1 -N 2 --mca btl scif,self $PWD/mic.out<br
                  class="">
                /home/ariebs/mic/mpi-nightly/bin/orted: <b class="">error
                  while loading shared libraries: libimf.so</b>: cannot
                open shared object file: No such file or directory<br
                  class="">
                ...<br class="">
                <br class="">
                <br class="">
                <div class="moz-cite-prefix">On 04/13/2015 04:25 PM,
                  Nathan Hjelm wrote:<br class="">
                </div>
                <blockquote
...
Link to this post: <a moz-do-not-send="true" class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26699.php">http://www.open-mpi.org/community/lists/users/2015/04/26699.php</a></pre>
              ...
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a><br
                class="">
              Link to this post:
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26700.php">http://www.open-mpi.org/community/lists/users/2015/04/26700.php</a></div>
          </blockquote>
        </div>
        <br class="">
      </div>
...
Link to this post: <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26706.php">http://www.open-mpi.org/community/lists/users/2015/04/26706.php</a></pre>
    </blockquote>
    <br>
  </body>
