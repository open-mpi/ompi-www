...
?>
<!-- received="Sat Apr 11 10:55:27 2015" -->
<!-- isoreceived="20150411145527" -->
<!-- sent="Sat, 11 Apr 2015 10:55:24 -0400" -->
<!-- isosent="20150411145524" -->
<!-- name="Andy Riebs" -->
<!-- email="andy.riebs_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC" -->
<!-- id="552935DC.9080007_at_hp.com" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="2E13CA6E-9B06-472F-A315-827348668ECF_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-11 10:55:24
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26679.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Previous message:</strong> <a href="26677.php">Ralph Castain: "Re: [OMPI users] OpenMPI 1.8.2 problems on CentOS 6.3"</a>
<li><strong>In reply to:</strong> <a href="26676.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26679.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Reply:</strong> <a href="26679.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    ...
    <br>
    I grabbed openmpi-dev-1484-g033418f.tar.bz2 and configured it with<br>
    <br>
...
--------------------------------------------------------------------------<br>
    ...
    killed<br>
    [atl1-01-mic0:189895] [[32419,0],0] plm:base:receive stop comm<br>
    <br>
    <br>
    <br>
    <br>
    <div class="moz-cite-prefix">On 04/10/2015 06:37 PM, Ralph Castain
      wrote:<br>
    </div>
    <blockquote
      ...
      <div class="">You might also add —enable-debug to that configure
      ...
      <div class=""><br class="">
        <div>
          <blockquote type="cite" class="">
            <div class="">On Apr 10, 2015, at 11:55 AM, Andy Riebs &lt;<a
            ...
            <div class="">
              <div bgcolor="#FFFFFF" text="#000000" class=""> Summary:
                ...
                be tantalizing, on an Intel Xeon Phi/MIC system.<br
                  class="">
                <br class="">
...
LD_LIBRARY_PATH=/opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic:$LD_LIBRARY_PATH<br
                ...
                think I had 3 successful runs in 30-40 attempts.)<br
                  class="">
                <br class="">
                $ shmemrun -H localhost -N 2 --mca sshmem mmap ./mic.out<br
                  class="">
                [atl1-01-mic0:189372] [[30936,0],0] ORTE_ERROR_LOG: Not
                found in file base/plm_base_launch_support.c at line 426<br
                  class="">
...
My opinions are not necessarily those of HP
              ...
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a><br
                class="">
              Link to this post:
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26670.php">http://www.open-mpi.org/community/lists/users/2015/04/26670.php</a></div>
          </blockquote>
        </div>
        <br class="">
      </div>
...
Link to this post: <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26676.php">http://www.open-mpi.org/community/lists/users/2015/04/26676.php</a></pre>
    </blockquote>
    <br>
  </body>
