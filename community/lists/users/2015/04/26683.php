...
?>
<!-- received="Sun Apr 12 14:30:19 2015" -->
<!-- isoreceived="20150412183019" -->
<!-- sent="Sun, 12 Apr 2015 14:30:16 -0400" -->
<!-- isosent="20150412183016" -->
<!-- name="Andy Riebs" -->
<!-- email="andy.riebs_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC" -->
<!-- id="552AB9B8.2090005_at_hp.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="0A4ECE92-D50F-4E2A-9380-C367B074766A_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-12 14:30:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26684.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Previous message:</strong> <a href="26682.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>In reply to:</strong> <a href="26682.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26684.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Reply:</strong> <a href="26684.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
href="https://www.open-mpi.org/nightly/v1.8/openmpi-v1.8.4-202-gc2da6a5.tar.bz2">openmpi-v1.8.4-202-gc2da6a5.tar.bz2</a>:<br>
    <br>
    $ shmemrun -H localhost -N 2 --mca sshmem mmap  --mca
    plm_base_verbose 5 $PWD/mic.out<br>
...
--------------------------------------------------------------------------<br>
    ...
    killed<br>
    [atl1-01-mic0:190189] [[32137,0],0] plm:base:receive stop comm<br>
    <br>
    <br>
    <div class="moz-cite-prefix">On 04/11/2015 07:41 PM, Ralph Castain
      wrote:<br>
    </div>
    <blockquote
              ...
              <div bgcolor="#FFFFFF" text="#000000" class=""> Everything
                ...
                <blockquote
                  ...
                  <div class=""><br class="">
                    <div class="">
                      <blockquote type="cite" class="">
                        <div class="">On Apr 11, 2015, at 7:55 AM, Andy
                        ...
                        <div class="">
                          <div bgcolor="#FFFFFF" text="#000000" class="">
                            ...
                            common-verbs.)<br class="">
                            <br class="">
                            With that configuration, here is what I am
                            seeing now...<br class="">
                            <br class="">
                            $ export SHMEM_SYMMETRIC_HEAP_SIZE=1G<br
                              class="">
                            $ shmemrun -H localhost -N 2 --mca sshmem
                            mmap  --mca plm_base_verbose 5 $PWD/mic.out<br
                              class="">
                            [atl1-01-mic0:189895] mca:base:select:( 
                            plm) Querying component [rsh]<br class="">
                            ...
                            to 10<br class="">
                            [atl1-01-mic0:189895] mca:base:select:( 
                            plm) Querying component [isolated]<br
                              class="">
                            [atl1-01-mic0:189895] mca:base:select:( 
                            plm) Query of component [isolated] set
                            priority to 0<br class="">
                            [atl1-01-mic0:189895] mca:base:select:( 
                            plm) Querying component [slurm]<br class="">
                            [atl1-01-mic0:189895] mca:base:select:( 
                            plm) Skipping component [slurm]. Query
                            failed to return a module<br class="">
                            [atl1-01-mic0:189895] mca:base:select:( 
                            plm) Selected component [rsh]<br class="">
                            [atl1-01-mic0:189895] plm:base:set_hnp_name:
                            initial bias 189895 nodename hash 4121194178<br
                              class="">
                            [atl1-01-mic0:189895] plm:base:set_hnp_name:
                            final jobfam 32419<br class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            plm:rsh_setup on agent ssh : rsh path NULL<br
                              class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            plm:base:receive start comm<br class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            ...
                            [atl1-01-mic0:189895] [[32419,0],0]
                            setup:vm: working unmanaged allocation<br
                              class="">
                            [atl1-01-mic0:189895] [[32419,0],0] using
                            dash_host<br class="">
                            [atl1-01-mic0:189895] [[32419,0],0] checking
                            node atl1-01-mic0<br class="">
                            [atl1-01-mic0:189895] [[32419,0],0] ignoring
                            myself<br class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            plm:base:setup_vm only HNP in allocation<br
                              class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            complete_setup on job [32419,1]<br class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            ORTE_ERROR_LOG: Not found in file
                            base/plm_base_launch_support.c at line 440<br
                              class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            plm:base:launch_apps for job [32419,1]<br
                              class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            plm:base:launch wiring up iof for job
                            [32419,1]<br class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            plm:base:launch [32419,1] registered<br
                              class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            plm:base:launch job [32419,1] is not a
                            dynamic spawn<br class="">
...
--------------------------------------------------------------------------<br
                              class="">
                            SHMEM_ABORT was invoked on rank 1 (pid
                            189899, host=atl1-01-mic0) with errorcode
                            -1.<br class="">
--------------------------------------------------------------------------<br
                              class="">
--------------------------------------------------------------------------<br
...
--------------------------------------------------------------------------<br
                              class="">
                            [atl1-01-mic0:189895] 1 more process has
                            sent help message help-shmem-runtime.txt /
                            ...
                            [atl1-01-mic0:189895] 1 more process has
                            sent help message help-shmem-api.txt /
                            shmem-abort<br class="">
                            [atl1-01-mic0:189895] 1 more process has
                            sent help message help-shmem-runtime.txt /
                            oshmem shmem abort:cannot guarantee all
                            killed<br class="">
                            [atl1-01-mic0:189895] [[32419,0],0]
                            plm:base:receive stop comm<br class="">
                            <br class="">
                            <br class="">
                            <br class="">
                            <br class="">
                            <div class="moz-cite-prefix">On 04/10/2015
                              06:37 PM, Ralph Castain wrote:<br class="">
                            </div>
                            <blockquote
                              cite="mid:2E13CA6E-9B06-472F-A315-827348668ECF@open-mpi.org"
                              type="cite" class=""> Andy - could you
                              please try the current 1.8.5 nightly
                              tarball and see if it helps? The error log
                              indicates that it is failing to get the
                              topology from some daemon, I�m assuming
                              the one on the Phi?
                              <div class=""><br class="">
                              </div>
                              <div class="">You might also add
                                �enable-debug to that configure line and
                                then put -mca plm_base_verbose on the
                                shmemrun cmd to get more help</div>
                              <div class=""><br class="">
                              </div>
                              <div class=""><br class="">
                                <div class="">
                                  <blockquote type="cite" class="">
                                    <div class="">On Apr 10, 2015, at
                                      11:55 AM, Andy Riebs &lt;<a
                                    ...
                                    <div class="">
                                      <div bgcolor="#FFFFFF"
                                        text="#000000" class="">
                                        Summary: MPI jobs work fine,
                                        SHMEM jobs work just often
                                        enough to be tantalizing, on an
                                        Intel Xeon Phi/MIC system.<br
                                          class="">
                                        <br class="">
                                        Longer version<br class="">
                                        <br class="">
                                        Thanks to the excellent write-up
                                        last June (<a
                                          moz-do-not-send="true"
...
href="https://www.open-mpi.org/community/lists/users/2014/06/24711.php">&lt;https://www.open-mpi.org/community/lists/users/2014/06/24711.php&gt;</a>),
                                        ...
                                        version of Open MPI for the Xeon
                                        Phi coprocessor that runs MPI
                                        jobs on the Phi coprocessor with
                                        no problem, but not SHMEM jobs. 
                                        Just at the point where I was
                                        about to document the problems I
                                        was having with SHMEM, my
                                        trivial SHMEM job worked. And
                                        then failed when I tried to run
                                        it again, immediately
                                        afterwards. I have a feeling I
                                        ...
                                        intel64<br class="">
                                        $ ./configure
                                        --prefix=/home/ariebs/mic/mpi \<br
                                          class="">
                                           CC="icc -mmic" CXX="icpc
                                        -mmic" \<br class="">
                                          
                                        --build=x86_64-unknown-linux-gnu
...
LD_LIBRARY_PATH=/opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic:$LD_LIBRARY_PATH<br
                                        ...
                                        <br class="">
                                        (Note that the program had been
                                        consistently failing. Then, when
                                        I logged back into the system to
                                        capture the results, it worked
                                        once,  and then immediately
                                        failed when I tried again, as
                                        shown below. Logging in and out
                                        isn't sufficient to correct the
                                        problem. Overall, I think I had
                                        3 successful runs in 30-40
                                        attempts.)<br class="">
                                        <br class="">
                                        $ shmemrun -H localhost -N 2
                                        --mca sshmem mmap ./mic.out<br
                                          class="">
                                        [atl1-01-mic0:189372]
                                        [[30936,0],0] ORTE_ERROR_LOG:
                                        Not found in file
                                        ...
                                        --mca sshmem mmap ./mic.out<br
                                          class="">
                                        [atl1-01-mic0:189381]
                                        [[30881,0],0] ORTE_ERROR_LOG:
                                        Not found in file
                                        base/plm_base_launch_support.c
                                        at line 426<br class="">
                                        [atl1-01-mic0:189383] Error:
                                        pshmem_init.c:61 - shmem_init()
                                        SHMEM failed to initialize -
                                        aborting<br class="">
--------------------------------------------------------------------------<br
                                          class="">
                                        It looks like SHMEM_INIT failed
                                        for some reason; your parallel
                                        process is<br class="">
                                        likely to abort.  There are many
                                        reasons that a parallel process
                                        can<br class="">
                                        fail during SHMEM_INIT; some of
                                        which are due to configuration
                                        or environment<br class="">
                                        problems.  This failure appears
                                        to be an internal failure;
                                        here's some<br class="">
                                        additional information (which
                                        may only be relevant to an Open
                                        SHMEM<br class="">
                                        developer):<br class="">
                                        <br class="">
...
--------------------------------------------------------------------------<br
                                          class="">
                                        SHMEM_ABORT was invoked on rank
                                        0 (pid 189383,
...
--------------------------------------------------------------------------<br
                                          class="">
                                        A SHMEM process is aborting at a
                                        time when it cannot guarantee
                                        that all<br class="">
                                        of its peer processes in the job
                                        will be killed properly.  You
                                        should<br class="">
...
Link to this post: <a moz-do-not-send="true" class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26679.php">http://www.open-mpi.org/community/lists/users/2015/04/26679.php</a></pre>
              ...
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a><br
                class="">
              Link to this post:
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26680.php">http://www.open-mpi.org/community/lists/users/2015/04/26680.php</a></div>
          </blockquote>
        </div>
        <br class="">
      </div>
...
Link to this post: <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26682.php">http://www.open-mpi.org/community/lists/users/2015/04/26682.php</a></pre>
    </blockquote>
    <br>
  </body>
