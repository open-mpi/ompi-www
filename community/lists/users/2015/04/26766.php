...
?>
<!-- received="Thu Apr 23 00:47:09 2015" -->
<!-- isoreceived="20150423044709" -->
<!-- sent="Wed, 22 Apr 2015 21:47:04 -0700" -->
<!-- isosent="20150423044704" -->
<!-- name="Subhra Mazumdar" -->
<!-- email="subhramazumdar1_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl" -->
<!-- id="CAATkYOW9OEocn2mWOL9Noodq0xNacuKZhkU=TFiaCvD_J1aK2g_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAAO1KyYsf3-TcMQwSGaDw7Mq9i_Q2yKYrN6SSb1KEu3D7Wgm5g_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-23 00:47:04
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26767.php">Siegmar Gross: "Re: [OMPI users] problem with Java in openmpi-dev-1567-g11e8c20"</a>
<li><strong>Previous message:</strong> <a href="26765.php">Galloway, Jack D: "[OMPI users] MPI_Finalize not behaving correctly, orphaned processes"</a>
<li><strong>In reply to:</strong> <a href="26762.php">Mike Dubman: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26768.php">Mike Dubman: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
<li><strong>Reply:</strong> <a href="26768.php">Mike Dubman: "Re: [OMPI users] MPI_THREAD_MULTIPLE and openib btl"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi,
<br>
<p>where is the command ofed_info located? I searched from / but didn't find
<br>
it.
<br>
<p>Subhra.
<br>
<p>On Tue, Apr 21, 2015 at 10:43 PM, Mike Dubman &lt;miked_at_[hidden]&gt;
<br>
wrote:
<br>
<p><span class="quotelev1">&gt; cool, progress!
</span><br>
...
<span class="quotelev1">&gt; indicates that ofed installed on your nodes is not indeed 2.4.-1.0.0 or
</span><br>
<span class="quotelev1">&gt; there is a mismatch between ofed kernel drivers version and ofed userspace
</span><br>
<span class="quotelev1">&gt; libraries version.
</span><br>
...
<span class="quotelev2">&gt;&gt; I compiled the openmpi that comes inside the mellanox hpcx package with
</span><br>
<span class="quotelev2">&gt;&gt; mxm support instead of separately downloaded openmpi. I also used the
</span><br>
...
<span class="quotelev2">&gt;&gt; On Sat, Apr 18, 2015 at 12:28 AM, Mike Dubman &lt;miked_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I followed the instructions as in the README, now getting a different
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; mpirun noticed that process rank 1 with PID 450 on node JARVICE exited
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; [JARVICE:00447] 1 more process has sent help message help-mtl-mxm.txt /
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; mxm init
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [JARVICE:00447] Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; see all help / error messages
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [root_at_JARVICE hpcx-v1.2.0-325-gcc-MLNX_OFED_LINUX-2.4-1.0.0-redhat6.5]#
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Mon, Apr 13, 2015 at 10:58 PM, Mike Dubman &lt;miked_at_[hidden]
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I tried using LD_PRELOAD for libmxm, but getting a different error
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; stack now as following
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; [JARVICE:00562] Set MCA parameter &quot;orte_base_help_aggregate&quot; to 0 to
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun noticed that process rank 0 with PID 8398 on node JARVICE
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Does ipoib need to be configured on the ib cards for mxm (I have
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; a separate ethernet connection too)? Also are there special flags in mpirun
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Can MPI_THREAD_MULTIPLE and openib btl work together in open
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpi 1.8.4? If so are there any command line options needed during run time?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Thanks,
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26766/attachment">attachment</a>
</ul>
