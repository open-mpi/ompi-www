...
?>
<!-- received="Thu Apr 16 10:51:50 2015" -->
<!-- isoreceived="20150416145150" -->
<!-- sent="Thu, 16 Apr 2015 08:51:46 -0600" -->
<!-- isosent="20150416145146" -->
<!-- name="Nathan Hjelm" -->
<!-- email="hjelmn_at_[hidden]" -->
<!-- subject="Re: [OMPI users] mpi_type_create_struct not working for large counts" -->
<!-- id="20150416145146.GJ21644_at_pn1246003.lanl.gov" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="CAF1Cqj5vz=BX67tCD6nObGn4TV-MEY0Cy8LiAh3VN9-2rZkcrg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-16 10:51:46
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26748.php">Andy Riebs: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Previous message:</strong> <a href="26746.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>In reply to:</strong> <a href="26744.php">Howard Pritchard: "Re: [OMPI users] mpi_type_create_struct not working for large counts"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p>-Nathan
<br>
<p>On Wed, Apr 15, 2015 at 10:11:51PM -0600, Howard Pritchard wrote:
<br>
<span class="quotelev1">&gt;    Hi Stephan,
</span><br>
<span class="quotelev1">&gt;    I&quot;m not able to reproduce your problem using master.  How are you running
</span><br>
<span class="quotelev1">&gt;    the test and how many ranks?  Are you running on a single node?
</span><br>
<span class="quotelev1">&gt;    It may be that the problem is only present for a particular transport,
</span><br>
<span class="quotelev1">&gt;    i.e. btl:sm, btl:vader, etc.
</span><br>
<span class="quotelev1">&gt;    Howard
</span><br>
<span class="quotelev1">&gt;    2015-04-15 0:32 GMT-06:00 MOHR STEPHAN 239883 &lt;STEPHAN.MOHR_at_[hidden]&gt;:
</span><br>
...
<span class="quotelev1">&gt;      I think you forgot the ierror argument in the call to mpi_irecv, but
</span><br>
<span class="quotelev1">&gt;      after correcting this it works fine. Thanks a lot for pointing out the
</span><br>
<span class="quotelev1">&gt;      issue of the eager limit!
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt;      This is one of the most classical bugs with point-to-point applications.
</span><br>
<span class="quotelev1">&gt;      Sends behave as non blocking as long as the amount of data is below the
</span><br>
<span class="quotelev1">&gt;      eager limit. Once the eager limit is passed, sends have a blocking
</span><br>
<span class="quotelev1">&gt;      behavior which requires that the peer has a posted receive. This
</span><br>
<span class="quotelev1">&gt;      explains why it is working for 100 but not for 1000.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;      The correct application is attached below. This doesn't validate the
</span><br>
...
<span class="quotelev2">&gt;      &gt; I tried with send/recv, but the outcome is the same. It works for
</span><br>
<span class="quotelev1">&gt;      small counts (e.g. n=100), but hangs for larger ones (e.g. n=1000).
</span><br>
...
<span class="quotelev2">&gt;      &gt; Can you try using send/recv with the datatype in question? It could be
</span><br>
...
<span class="quotelev3">&gt;      &gt;&gt;   Subject: Re: [OMPI users] mpi_type_create_struct not working for
</span><br>
...
<span class="quotelev3">&gt;      &gt;&gt;   For starters, would you mind sending the output you get when you
</span><br>
...
<span class="quotelev3">&gt;      &gt;&gt;   The test appears to work without problem using mpich, at least with
</span><br>
...
<span class="quotelev3">&gt;      &gt;&gt;   2015-04-13 10:40 GMT-06:00 MOHR STEPHAN 239883
</span><br>
<span class="quotelev1">&gt;      &lt;STEPHAN.MOHR_at_[hidden]&gt;:
</span><br>
<span class="quotelev3">&gt;      &gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;      support: yes, OMPI progress: no, ORTE progress: yes, Event lib: yes)
</span><br>
...
<span class="quotelev3">&gt;      &gt;&gt;               MCA hwloc: hwloc191 (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt;      v1.8.5)
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/04/26744.php">http://www.open-mpi.org/community/lists/users/2015/04/26744.php</a>
</span><br>
<p><p>
<br><hr>
<ul>
<li>application/pgp-signature attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26747/01-part">stored</a>
</ul>
<!-- attachment="01-part" -->
<!-- body="end" -->
<hr>
