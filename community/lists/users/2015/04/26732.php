...
?>
<!-- received="Tue Apr 14 23:10:32 2015" -->
<!-- isoreceived="20150415031032" -->
<!-- sent="Tue, 14 Apr 2015 20:10:12 -0700" -->
<!-- isosent="20150415031012" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC" -->
<!-- id="9D9F9A8F-01AB-49CE-94B7-0E7BE8897ECF_at_open-mpi.org" -->
...
<strong>Date:</strong> 2015-04-14 23:10:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26733.php">MOHR STEPHAN 239883: "Re: [OMPI users] mpi_type_create_struct not working for large counts"</a>
<li><strong>Previous message:</strong> <a href="26731.php">Gilles Gouaillardet: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26742.php">Andy Riebs: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Reply:</strong> <a href="26742.php">Andy Riebs: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Reply:</strong> <a href="26743.php">Gilles Gouaillardet: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>What we have required, therefore, is that your path be setup properly in the remote .bashrc (or pick your shell) to handle the libraries.
<br>
<p>As I indicated, the -x option only forwards envars to the application procs themselves, not the orted. I could try to add another cmd line option to forward things for the orted, but the concern we&#146;ve had in the past (and still harbor) is that the ssh cmd line is limited in length. Thus, adding some potentially long paths to support this option could overwhelm it and cause failures.
<br>
<p>I&#146;d try the static method first, or perhaps the LDFLAGS Gilles suggested.
<br>
<p><p><span class="quotelev1">&gt; On Apr 14, 2015, at 5:11 PM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; what about reconfiguring Open MPI with LDFLAGS=&quot;-Wl,-rpath,/opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic&quot; ?
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; last but not least, you can always replace orted with a simple script that sets the LD_LIBRARY_PATH and exec the original orted
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; do you have the same behaviour on non MIC hardware when Open MPI is compiled with intel compilers ?
</span><br>
<span class="quotelev1">&gt; if it works on non MIC hardware, the root cause could be in the sshd_config of the MIC that does not
</span><br>
<span class="quotelev1">&gt; accept to receive LD_LIBRARY_PATH
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On 4/14/2015 11:20 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev2">&gt;&gt; Hmmm&#133;certainly looks that way. I&#146;ll investigate.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On Apr 14, 2015, at 6:06 AM, Andy Riebs &lt;andy.riebs_at_[hidden] &lt;mailto:andy.riebs_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Still no happiness... It looks like my LD_LIBRARY_PATH just isn't getting propagated?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; $ ldd /home/ariebs/mic/mpi-nightly/bin/orted
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         linux-vdso.so.1 =&gt;  (0x00007fffa1d3b000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libopen-rte.so.0 =&gt; /home/ariebs/mic/mpi-nightly/lib/libopen-rte.so.0 (0x00002ab6ce464000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libopen-pal.so.0 =&gt; /home/ariebs/mic/mpi-nightly/lib/libopen-pal.so.0 (0x00002ab6ce7d3000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libm.so.6 =&gt; /lib64/libm.so.6 (0x00002ab6cebbd000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libdl.so.2 =&gt; /lib64/libdl.so.2 (0x00002ab6ceded000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         librt.so.1 =&gt; /lib64/librt.so.1 (0x00002ab6ceff1000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libutil.so.1 =&gt; /lib64/libutil.so.1 (0x00002ab6cf1f9000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libgcc_s.so.1 =&gt; /lib64/libgcc_s.so.1 (0x00002ab6cf3fc000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libpthread.so.0 =&gt; /lib64/libpthread.so.0 (0x00002ab6cf60f000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libc.so.6 =&gt; /lib64/libc.so.6 (0x00002ab6cf82c000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libimf.so =&gt; /opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libimf.so (0x00002ab6cfb84000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libsvml.so =&gt; /opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libsvml.so (0x00002ab6cffd6000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libirng.so =&gt; /opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libirng.so (0x00002ab6d086f000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         libintlc.so.5 =&gt; /opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libintlc.so.5 (0x00002ab6d0a82000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         /lib64/ld-linux-k1om.so.2 (0x00002ab6ce243000)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; $ shmemrun -x SHMEM_SYMMETRIC_HEAP_SIZE=1M -H mic1 -N 2 --mca spml yoda --mca btl sm,self,tcp --mca plm_base_verbose 5 --mca memheap_base_verbose 100 --leave-session-attached --mca mca_component_show_load_errors 1 $PWD/mic.out
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;   Deprecated variable: mca_component_show_load_errors
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   New variable:        mca_base_component_show_load_errors
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] mca:base:select:(  plm) Querying component [rsh]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[INVALID],INVALID] plm:rsh_lookup on agent ssh : rsh path NULL
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] mca:base:select:(  plm) Query of component [rsh] set priority to 10
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] mca:base:select:(  plm) Querying component [isolated]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] mca:base:select:(  plm) Query of component [isolated] set priority to 0
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] mca:base:select:(  plm) Querying component [slurm]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] mca:base:select:(  plm) Skipping component [slurm]. Query failed to return a module
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] mca:base:select:(  plm) Selected component [rsh]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] plm:base:set_hnp_name: initial bias 16183 nodename hash 4238360777
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] plm:base:set_hnp_name: final jobfam 33630
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh_setup on agent ssh : rsh path NULL
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:base:receive start comm
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:base:setup_job
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:base:setup_vm
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:base:setup_vm creating map
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] setup:vm: working unmanaged allocation
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] using dash_host
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] checking node mic1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:base:setup_vm add new daemon [[33630,0],1]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:base:setup_vm assigning new daemon [[33630,0],1] to node mic1
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: launching vm
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: local shell: 0 (bash)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: assuming same remote shell as local shell
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: remote shell: 0 (bash)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: final template argv:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         /usr/bin/ssh &lt;template&gt;     PATH=/home/ariebs/mic/mpi-nightly/bin:$PATH ; export PATH ; LD_LIBRARY_PATH=/home/ariebs/mic/mpi-nightly/lib:$LD_LIBRARY_PATH ; export LD_LIBRARY_PATH ; DYLD_LIBRARY_PATH=/home/ariebs/mic/mpi-nightly/lib:$DYLD_LIBRARY_PATH ; export DYLD_LIBRARY_PATH ;   /home/ariebs/mic/mpi-nightly/bin/orted -mca orte_leave_session_attached &quot;1&quot; --hnp-topo-sig 0N:1S:0L3:61L2:61L1:61C:244H:k1om -mca ess &quot;env&quot; -mca orte_ess_jobid &quot;2203975680&quot; -mca orte_ess_vpid &quot;&lt;template&gt;&quot; -mca orte_ess_num_procs &quot;2&quot; -mca orte_hnp_uri &quot;2203975680.0;usock;tcp://16.113.180.127,192.0.0.122:34640;ud://2883658.78.1 &lt;tcp://16.113.180.127,192.0.0.122:34640;ud://2883658.78.1&gt;&quot; --tree-spawn --mca spml &quot;yoda&quot; --mca btl &quot;sm,self,tcp&quot; --mca plm_base_verbose &quot;5&quot; --mca memheap_base_verbose &quot;100&quot; --mca mca_component_show_load_errors &quot;1&quot; -mca plm &quot;rsh&quot; -mca rmaps_ppr_n_pernode &quot;2&quot;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh:launch daemon 0 not a child of mine
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: adding node mic1 to launch list
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: activating launch event
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: recording launch of daemon [[33630,0],1]
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:rsh: executing: (/usr/bin/ssh) [/usr/bin/ssh mic1     PATH=/home/ariebs/mic/mpi-nightly/bin:$PATH ; export PATH ; LD_LIBRARY_PATH=/home/ariebs/mic/mpi-nightly/lib:$LD_LIBRARY_PATH ; export LD_LIBRARY_PATH ; DYLD_LIBRARY_PATH=/home/ariebs/mic/mpi-nightly/lib:$DYLD_LIBRARY_PATH ; export DYLD_LIBRARY_PATH ;   /home/ariebs/mic/mpi-nightly/bin/orted -mca orte_leave_session_attached &quot;1&quot; --hnp-topo-sig 0N:1S:0L3:61L2:61L1:61C:244H:k1om -mca ess &quot;env&quot; -mca orte_ess_jobid &quot;2203975680&quot; -mca orte_ess_vpid 1 -mca orte_ess_num_procs &quot;2&quot; -mca orte_hnp_uri &quot;2203975680.0;usock;tcp://16.113.180.127,192.0.0.122:34640;ud://2883658.78.1 &lt;tcp://16.113.180.127,192.0.0.122:34640;ud://2883658.78.1&gt;&quot; --tree-spawn --mca spml &quot;yoda&quot; --mca btl &quot;sm,self,tcp&quot; --mca plm_base_verbose &quot;5&quot; --mca memheap_base_verbose &quot;100&quot; --mca mca_component_show_load_errors &quot;1&quot; -mca plm &quot;rsh&quot; -mca rmaps_ppr_n_pernode &quot;2&quot;]
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] daemon 1 failed with status 127
</span><br>
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:base:orted_cmd sending orted_exit commands
</span><br>
<span class="quotelev3">&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; [atl1-02-mic0:16183] [[33630,0],0] plm:base:receive stop comm
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; On 04/13/2015 07:47 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Weird. I&#146;m not sure what to try at that point - IIRC, building static won&#146;t resolve this problem (but you could try and see). You could add the following to the cmd line and see if it tells us anything useful:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; &#151;leave-session-attached &#151;mca mca_component_show_load_errors 1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; You might also do an ldd on /home/ariebs/mic/mpi-nightly/bin/orted and see where it is looking for libimf since it (and not mic.out) is the one complaining
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On Apr 13, 2015, at 1:58 PM, Andy Riebs &lt;andy.riebs_at_[hidden] &lt;mailto:andy.riebs_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;    &quot;1901330432.0;usock;tcp://16.113.180.125,192.0.0.121:34249;ud://2359370.86.1 &lt;tcp://16.113.180.125,192.0.0.121:34249;ud://2359370.86.1&gt;&quot;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/04/26716.php">http://www.open-mpi.org/community/lists/users/2015/04/26716.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/users/2015/04/26716.php">http://www.open-mpi.org/community/lists/users/2015/04/26716.php</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/04/26718.php">http://www.open-mpi.org/community/lists/users/2015/04/26718.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/users/2015/04/26718.php">http://www.open-mpi.org/community/lists/users/2015/04/26718.php</a>&gt;
</span><br>
<span class="quotelev1">&gt; _______________________________________________
</span><br>
<span class="quotelev1">&gt; users mailing list
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/04/26731.php">http://www.open-mpi.org/community/lists/users/2015/04/26731.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26732/attachment">attachment</a>
</ul>
