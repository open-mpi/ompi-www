...
?>
<!-- received="Sun Apr 26 19:29:48 2015" -->
<!-- isoreceived="20150426232948" -->
<!-- sent="Sun, 26 Apr 2015 19:29:42 -0400" -->
<!-- isosent="20150426232942" -->
<!-- name="Andy Riebs" -->
<!-- email="andy.riebs_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC" -->
<!-- id="553D74E6.4030702_at_hp.com" -->
<!-- charset="utf-8" -->
<!-- inreplyto="C44A4258-7C3F-496B-8775-0AE9DEFF5999_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-04-26 19:29:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26793.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Previous message:</strong> <a href="26791.php">George Bosilca: "Re: [OMPI users] Hang in MPI_Comm_split in 2 RHEL Linux nodes with INTEL MIC cards"</a>
<li><strong>In reply to:</strong> <a href="26790.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26793.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<li><strong>Reply:</strong> <a href="26793.php">Ralph Castain: "Re: [OMPI users] Problems using Open MPI 1.8.4 OSHMEM on Intel Xeon Phi/MIC"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
  ...
  <body bgcolor="#FFFFFF" text="#000000">
    ...
    from my environment, ran again, and it still worked!<br>
    <br>
    Whatever it is that you're doing Ralph, keep it up :-)<br>
    <br>
    Regardless of the cause or result, thanks $$$$$$ for poking at this!<br>
    <br>
    Andy<br>
    <br>
    <div class="moz-cite-prefix">On 04/26/2015 10:35 AM, Ralph Castain
      wrote:<br>
    </div>
    <blockquote
      cite="mid:C44A4258-7C3F-496B-8775-0AE9DEFF5999@open-mpi.org"
      type="cite">
      ...
      <div class="">There have been some other build system changes made
        as a result of more extensive testing of the 1.8 release
        candidate - it is possible that something in that area had an
        impact here.</div>
      <div class=""><br class="">
      </div>
      <div class="">Are you saying it just works, even without passing
        the new param?</div>
      <div class=""><br class="">
      </div>
      <div class=""><br class="">
        <div>
          <blockquote type="cite" class="">
            <div class="">On Apr 26, 2015, at 6:39 AM, Andy Riebs &lt;<a
            ...
            <div class="">
              <div bgcolor="#FFFFFF" text="#000000" class=""> Hi Ralph,<br
                ...
                week, and can't reproduce the problem at all.<br
                  class="">
                <br class="">
                Andy<br class="">
                <br class="">
                <div class="moz-cite-prefix">On 04/16/2015 12:15 PM,
                  Ralph Castain wrote:<br class="">
                </div>
                <blockquote
cite="mid:CAMD57ofTLzP9OXfMBGyjyw7Si2NGO8+uRT=Ntn-c0atWRT+Tqw@mail.gmail.com"
                  type="cite" class="">
                  <div dir="ltr" class="">Sorry - I had to revert the
                  ...
                  <div class="gmail_extra"><br class="">
                    <div class="gmail_quote">On Thu, Apr 16, 2015 at
                      9:41 AM, Andy Riebs <span dir="ltr" class="">&lt;<a
                          moz-do-not-send="true"
                          href="mailto:andy.riebs@hp.com"
                          target="_blank" class="">andy.riebs@hp.com</a>&gt;</span>
                      wrote:<br class="">
                      <blockquote class="gmail_quote" style="margin:0 0
                        ...
                        <div bgcolor="#FFFFFF" text="#000000" class="">
                          ...
                          `/home/ariebs/mic/openmpi-dev-1515-gc869490'<br
                            class="">
                          make[3]:<b class="">
                            ./config/find_common_syms: Command not found</b><br
                            class="">
                          ...
                          -mca plm_rsh_pass_path $PATH<b class=""> -mca
                            plm_rsh_pass_libpath $MIC_LD_LIBRARY_PATH</b>
                          -H mic0,mic1 -n 2 ./mic.out<span class=""><br
                              class="">
                            /home/ariebs/mic/mpi-nightly/bin/orted:
                            error while loading shared libraries:<b
                              class=""> libimf.so: cannot open shared
                              object file</b>: No such file or directory<br
                              class="">
                             ...<br class="">
                          ...
                          <b class="">/opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic</b>:/opt/intel/15.0/composer_xe_2015.2.164/mpirt/lib/mic:/opt/intel/mic/coi/device-linux-release/lib:/opt/intel/mic/myo/lib:/opt/intel/15.0/composer_xe_2015.2.164/ipp/lib/lib/mic:/opt/intel/mic/coi/device-linux-release/lib:/opt/intel/mic/myo/lib:/opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic:/opt/intel/15.0/composer_xe_2015.2.164/mkl/lib/mic:/opt/intel/15.0/composer_xe_2015.2.164/tbb/lib/mic<br
                            class="">
                          $ ls <b class="">/opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libimf.*</b><br
                            class="">
...
/opt/intel/15.0/composer_xe_2015.2.164/compiler/lib/mic/libimf.so<br
                          ...
                          <div class="">
                            <div class="h5"><br class="">
                              <br class="">
                              <br class="">
                              <div class="">On 04/16/2015 07:22 AM,
                                Ralph Castain wrote:<br class="">
                              </div>
                            </div>
                          </div>
                          <blockquote type="cite" class="">
                            <div class="">
                              <div class="h5">
                                <div dir="ltr" class="">FWIW: I just
                                  added (last night) a pair of new MCA
                                  params for this purpose:
                                  <div class=""><br class="">
                                  </div>
                                  <div class="">plm_rsh_pass_path
                                    &lt;foo&gt;   prepends the
                                    designated path to the remote
                                    shell's PATH prior to executing
                                    orted</div>
                                  <div class="">plm_rsh_pass_libpath
                                    &lt;foo&gt;  same thing for
                                    LD_LIBRARY_PATH</div>
                                  <div class=""><br class="">
                                  </div>
                                  <div class="">I believe that will
                                    resolve the problem for Andy
                                    regardless of compiler used. In the
                                    master now, waiting for someone to
                                    verify it before adding to 1.8.5.
                                    Sadly, I am away from any cluster
                                    for the rest of this week, so I'd
                                    welcome anyone having a chance to
                                    test it.</div>
                                  <div class=""><br class="">
                                  </div>
                                </div>
                                <div class="gmail_extra"><br class="">
                                  <div class="gmail_quote">On Thu, Apr
                                    16, 2015 at 2:57 AM, Thomas Jahns <span
                                      dir="ltr" class="">&lt;<a
                                        moz-do-not-send="true"
                                        href="mailto:jahns@dkrz.de"
                                        target="_blank" class="">jahns@dkrz.de</a>&gt;</span>
                                    wrote:<br class="">
                                    <blockquote class="gmail_quote"
                                      ...
                                      <div style="word-wrap:break-word"
                                        ...
                                        <div class=""><span class=""><br
                                          ...
                                          <div class="">let me first
                                            state that I have no
                                            experience developing for
                                            MIC. But regarding the Intel
                                            runtime libraries, the only
                                            sane option in my opinion is
                                            to use the
                                            icc.cfg/ifort.cfg/icpc.cfg
                                            files that get put in the
...
Klimarechenzentrum</div>
                                                      ...
                                                      <div class="">Phone:
                                                        <a
                                                          moz-do-not-send="true"
href="tel:%2B49-40-460094-151" value="+4940460094151" target="_blank"
                                                          class="">+49-40-460094-151</a></div>
                                                      <div class="">Fax:
                                                        <a
                                                          moz-do-not-send="true"
href="tel:%2B49-40-460094-270" value="+4940460094270" target="_blank"
                                                          class="">+49-40-460094-270</a></div>
                                                      <div class="">Email:
                                                        Thomas Jahns
                                                        &lt;<a
                                                          moz-do-not-send="true"
href="mailto:jahns@dkrz.de" target="_blank" class="">jahns@dkrz.de</a>&gt;</div>
                                                      <div class=""><br
                                                          class="">
                                                      </div>
                                                    </div>
...
_______________________________________________<br class="">
                                      ...
                                      <a moz-do-not-send="true"
                                        ...
                                        target="_blank" class="">users@open-mpi.org</a><br
                                        class="">
                                      Subscription: <a
                                        moz-do-not-send="true"
                                      ...
                                      Link to this post: <a
                                        ...
                                        target="_blank" class="">http://www.open-mpi.org/community/lists/users/2015/04/26745.php</a><br
                                        class="">
                                    </blockquote>
                                  </div>
                                  <br class="">
...
Link to this post: <a moz-do-not-send="true" href="http://www.open-mpi.org/community/lists/users/2015/04/26746.php" target="_blank" class="">http://www.open-mpi.org/community/lists/users/2015/04/26746.php</a></pre>
                        ...
                        Link to this post: <a moz-do-not-send="true"
                          ...
                          target="_blank" class="">http://www.open-mpi.org/community/lists/users/2015/04/26748.php</a><br
                          class="">
                      </blockquote>
                    </div>
                    <br class="">
...
Link to this post: <a moz-do-not-send="true" class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26749.php">http://www.open-mpi.org/community/lists/users/2015/04/26749.php</a></pre>
                </blockquote>
                <br class="">
              </div>
              _______________________________________________<br
              ...
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/mailman/listinfo.cgi/users">http://www.open-mpi.org/mailman/listinfo.cgi/users</a><br
                class="">
              Link to this post:
              <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26789.php">http://www.open-mpi.org/community/lists/users/2015/04/26789.php</a></div>
          </blockquote>
        </div>
        <br class="">
      </div>
...
Link to this post: <a class="moz-txt-link-freetext" href="http://www.open-mpi.org/community/lists/users/2015/04/26790.php">http://www.open-mpi.org/community/lists/users/2015/04/26790.php</a></pre>
    </blockquote>
    <br>
  </body>
