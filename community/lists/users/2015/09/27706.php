...
?>
<!-- received="Tue Sep 29 10:08:17 2015" -->
<!-- isoreceived="20150929140817" -->
<!-- sent="Tue, 29 Sep 2015 16:08:16 +0200" -->
<!-- isosent="20150929140816" -->
<!-- name="Diego Avesani" -->
<!-- email="diego.avesani_at_[hidden]" -->
<!-- subject="Re: [OMPI users] send_request error with allocate" -->
<!-- id="CAG8o1y6YweoiKPZNAuRArNuSiy-S_3=C7TgeapkMOia1vaLuGw_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="5EBE02DD-654A-4146-A841-72BF733A1B92_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-09-29 10:08:16
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27707.php">Diego Avesani: "Re: [OMPI users] send_request error with allocate"</a>
<li><strong>Previous message:</strong> <a href="27705.php">Marcin Krotkiewski: "Re: [OMPI users] Using POSIX shared memory as send buffer"</a>
<li><strong>In reply to:</strong> <a href="27704.php">Jeff Squyres (jsquyres): "Re: [OMPI users] send_request error with allocate"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27707.php">Diego Avesani: "Re: [OMPI users] send_request error with allocate"</a>
<li><strong>Reply:</strong> <a href="27707.php">Diego Avesani: "Re: [OMPI users] send_request error with allocate"</a>
<li><strong>Reply:</strong> <a href="27708.php">Jeff Squyres (jsquyres): "Re: [OMPI users] send_request error with allocate"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ENDDO
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CALL MPI_ISEND(send_messageR, MsgLength, MPI_DOUBLE_COMPLEX,
<br>
...
&nbsp;&nbsp;&nbsp;&nbsp;!
<br>
<p><p>&nbsp;&nbsp;&nbsp;&nbsp;!recive message FROM left CPU
<br>
&nbsp;&nbsp;&nbsp;&nbsp;IF(MPIdata%rank.NE.0)THEN
<br>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;MsgLength = MPIdata%jmaxN
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;CALL MPI_IRECV(recv_messageL, MsgLength, MPI_DOUBLE_COMPLEX,
<br>
MPIdata%rank-1, MPIdata%rank, MPI_COMM_WORLD, recv_request(MPIdata%rank),
<br>
MPIdata%iErr)
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;write(*,*) MPIdata%rank-1
<br>
&nbsp;&nbsp;&nbsp;&nbsp;ENDIF
<br>
&nbsp;&nbsp;&nbsp;&nbsp;!
...
<p>Diego
<br>
<p><p>On 29 September 2015 at 00:15, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt;
<br>
wrote:
<br>
<p><span class="quotelev1">&gt; Can you send a small reproducer program?
</span><br>
...
<span class="quotelev2">&gt; &gt; INTEGER :: send_request(nMsg), recv_request(nMsg), I get the following
</span><br>
...
<span class="quotelev2">&gt; &gt; [Lap] *** MPI_ERRORS_ARE_FATAL (processes in this communicator will now
</span><br>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27706/attachment">attachment</a>
</ul>
