...
?>
<!-- received="Tue Sep  1 01:06:34 2015" -->
<!-- isoreceived="20150901050634" -->
<!-- sent="Tue, 1 Sep 2015 14:06:29 +0900" -->
<!-- isosent="20150901050629" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI optimizations for intra-node process communication" -->
<!-- id="55E53255.2050508_at_rist.or.jp" -->
...
<strong>Date:</strong> 2015-09-01 01:06:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27520.php">George Bosilca: "Re: [OMPI users] OpenMPI optimizations for intra-node process communication"</a>
<li><strong>Previous message:</strong> <a href="27518.php">George Bosilca: "Re: [OMPI users] OpenMPI optimizations for intra-node process communication"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27520.php">George Bosilca: "Re: [OMPI users] OpenMPI optimizations for intra-node process communication"</a>
<li><strong>Reply:</strong> <a href="27520.php">George Bosilca: "Re: [OMPI users] OpenMPI optimizations for intra-node process communication"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Saliya,
<br>
<p>btl is a point to point thing only.
<br>
<p>collectives are implemented by the coll mca
<br>
<p>the sm coll mca is optimized for shared memory, but support intra node 
<br>
communicators only.
<br>
...
<p>Gilles
<br>
<p>On 9/1/2015 1:57 PM, Saliya Ekanayake wrote:
<br>
<span class="quotelev1">&gt; One more question. I found this blog from Jeff [1] on vader and I got 
</span><br>
<span class="quotelev1">&gt; the impression that it's used only for peer-to-peer communications and 
</span><br>
<span class="quotelev1">&gt; not for collectives. Is this true or did I misunderstand?
</span><br>
...
<span class="quotelev1">&gt; On Tue, Sep 1, 2015 at 12:40 AM, Gilles Gouaillardet 
</span><br>
...
<span class="quotelev1">&gt;     or you can simply blacklist the btl you do *not* want to use, for
</span><br>
...
<span class="quotelev1">&gt;     of course, reading the source code is the best way to understand
</span><br>
<span class="quotelev1">&gt;     what the vader btl can do and how
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;     Thank you Gilles. Is there some documentation on vader btl and
</span><br>
<span class="quotelev2">&gt;&gt;     how I can check which (sm or vader) is being used?
</span><br>
...
<span class="quotelev2">&gt;&gt;         OpenMPI uses btl for point to point communication, and
</span><br>
<span class="quotelev2">&gt;&gt;         automatically selects the best one per pair.
</span><br>
<span class="quotelev2">&gt;&gt;         Typically, the openib or tcp btl is used for inter node
</span><br>
<span class="quotelev2">&gt;&gt;         communication, and the sm or vader btl for
</span><br>
<span class="quotelev2">&gt;&gt;         intra node.
</span><br>
<span class="quotelev2">&gt;&gt;         note the vader btl uses the knem kernel module when available
</span><br>
<span class="quotelev2">&gt;&gt;         for even more optimized configurations.
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;         Just trying to see if there are any optimizations (or
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         options) in OpenMPI to improve communication between intra
</span><br>
<span class="quotelev3">&gt;&gt;&gt;         node processes. For example do they use something like
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27519/attachment">attachment</a>
</ul>
