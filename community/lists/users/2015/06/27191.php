...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27192.php">Fedele Stabile: "[OMPI users] hybrid programming and OpenMPI compilation"</a>
<li><strong>Previous message:</strong> <a href="27190.php">Ralph Castain: "Re: [OMPI users] Error while launching Jobs in LSF with OpenMPI"</a>
<li><strong>In reply to:</strong> <a href="27183.php">Daniel Letai: "Re: [OMPI users] simple mpi hello world segfaults when coll ml not disabled"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27191/attachment">attachment</a>
</ul>
