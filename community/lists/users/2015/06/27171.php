<?
$subject_val = "[OMPI users] PMIx 2.0: seeking input";
...
<!-- subject="[OMPI users] PMIx 2.0: seeking input" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] PMIx 2.0: seeking input<br>
<strong>From:</strong> Ralph Castain (<em>rhc_at_[hidden]</em>)<br>
<strong>Date:</strong> 2015-06-22 11:54:28
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27172.php">Belgin, Mehmet: "[OMPI users] Anyone successfully running Abaqus with OpenMPI?"</a>
<li><strong>Previous message:</strong> <a href="27170.php">Gilles Gouaillardet: "Re: [OMPI users] simple mpi hello world segfaults when coll ml not disabled"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27171/attachment">attachment</a>
</ul>
