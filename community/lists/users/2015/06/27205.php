...
?>
<!-- received="Sat Jun 27 22:22:12 2015" -->
<!-- isoreceived="20150628022212" -->
<!-- sent="Sat, 27 Jun 2015 19:21:49 -0700" -->
<!-- isosent="20150628022149" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash" -->
<!-- id="5A54B17C-2131-4EBE-BD34-3F4D4E65C353_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="434F2BB0AF80484CA04DE0D8C0738BF293EDFE4A_at_cshsmsgmbx02.CSMC.EDU" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-06-27 22:21:49
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27206.php">Marc-Andre Hermanns: "[OMPI users] Progress on target of MPI_Win_lock on Infiniband"</a>
<li><strong>Previous message:</strong> <a href="27204.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<li><strong>In reply to:</strong> <a href="27204.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27220.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<li><strong>Reply:</strong> <a href="27220.php">Lane, William: "Re: [OMPI users] OpenMPI 1.8.6, CentOS 6.3, too many slots = crash"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Bill - this is such a jumbled collection of machines that I&#146;m having trouble figuring out what I should replicate. I can create something artificial here so I can try to debug this, but I need to know exactly what I&#146;m up against - can you tell me:
<br>
<p>* the architecture of each type - how many sockets, how many cores/socket, HT on or off. If two nodes have the same physical setup but one has HT on and the other off, then please consider those two different types
<br>
<p>* how many nodes of each type
<br>
<p>Looking at your map output, it looks like the map is being done correctly, but somehow the binding locale isn&#146;t getting set in some cases. You latest error output would seem out-of-step with your prior reports, so something else may be going on there. As I said earlier, this is the most hetero environment we&#146;ve seen, and so there may be some code paths your hitting that haven&#146;t been well exercised before.
<br>
<p><p><p><p><span class="quotelev1">&gt; On Jun 26, 2015, at 5:22 PM, Lane, William &lt;William.Lane_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; On Tue, Jun 23, 2015 at 5:12 PM, Lane, William &lt;William.Lane_at_[hidden] &lt;&gt;&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/06/27204.php">http://www.open-mpi.org/community/lists/users/2015/06/27204.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27205/attachment">attachment</a>
</ul>
