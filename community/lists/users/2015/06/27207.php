<?
$subject_val = "Re: [OMPI users] SOLVED hybrid programming: cpu load issues";
include("../../include/msg-header.inc");
?>
<!-- received="Mon Jun 29 06:04:43 2015" -->
<!-- isoreceived="20150629100443" -->
<!-- sent="Mon, 29 Jun 2015 12:04:37 +0200" -->
<!-- isosent="20150629100437" -->
<!-- name="Fedele Stabile" -->
<!-- email="fedele.stabile_at_[hidden]" -->
<!-- subject="Re: [OMPI users] SOLVED hybrid programming: cpu load issues" -->
<!-- id="1435572277.4216.9.camel_at_tango.fis.unical.it" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="CAMD57ocpNBLRTnHYscKnLKVPDV3BDFF2RnU5XyzMztSyLu-ssA_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> Re: [OMPI users] SOLVED hybrid programming: cpu load issues<br>
<strong>From:</strong> Fedele Stabile (<em>fedele.stabile_at_[hidden]</em>)<br>
<strong>Date:</strong> 2015-06-29 06:04:37
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27208.php">Åke Sandgren: "[OMPI users] Bug in ompi/errhandler/errcode.h (1.8.6)?"</a>
<li><strong>Previous message:</strong> <a href="27206.php">Marc-Andre Hermanns: "[OMPI users] Progress on target of MPI_Win_lock on Infiniband"</a>
<li><strong>In reply to:</strong> <a href="27202.php">Ralph Castain: "Re: [OMPI users] hybrid programming: cpu load issues"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
...
Fedele
<br>
<p>Il giorno ven, 26/06/2015 alle 04.42 -0700, Ralph Castain ha scritto:
<br>
<span class="quotelev1">&gt; Starting in the 1.7 series, Open MPI automatically binds application
</span><br>
<span class="quotelev1">&gt; processes. By default, we bind to core if np &lt;= 2, otherwise we bind
</span><br>
<span class="quotelev1">&gt; to socket.. So your proc, and all its threads, are being bound to a
</span><br>
<span class="quotelev1">&gt; single core.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; What you probably want to do is add either &quot;--bind-to none&quot; or
</span><br>
<span class="quotelev1">&gt; &quot;--bind-to socket&quot; to your mpirun cmd line.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
...
<span class="quotelev1">&gt; On Fri, Jun 26, 2015 at 2:00 AM, Fedele Stabile
</span><br>
<span class="quotelev1">&gt; &lt;fedele.stabile_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;         Hi,
</span><br>
<span class="quotelev1">&gt;         I'm trying hybrid programming and I have this strange issue:
</span><br>
<span class="quotelev1">&gt;         Running fortran code listed below it happens that it uses only
</span><br>
<span class="quotelev1">&gt;         the 200%
</span><br>
<span class="quotelev1">&gt;         of cpu on each node also if I request 4 threads with the
</span><br>
<span class="quotelev1">&gt;         command
</span><br>
<span class="quotelev1">&gt;         mpirun -n 2 -npernode 1  -x
</span><br>
<span class="quotelev1">&gt;         OMP_NUM_THREADS=4 ./pi_parallel_do.f.exe
</span><br>
<span class="quotelev1">&gt;         I'll explain: four threads are created but it works as if they
</span><br>
<span class="quotelev1">&gt;         were only
</span><br>
<span class="quotelev1">&gt;         two cores available
</span><br>
<span class="quotelev1">&gt;         
</span><br>
<span class="quotelev1">&gt;         however if I run the OpenMP version it loads 400% of cpu, so
</span><br>
<span class="quotelev1">&gt;         it works on
</span><br>
<span class="quotelev1">&gt;         four core.
</span><br>
<span class="quotelev1">&gt;         This is the code and below is the output of ompi_info (as
</span><br>
<span class="quotelev1">&gt;         requested by
</span><br>
...
<span class="quotelev1">&gt;                    w = 1.0d0/(1.d0*N)          !! width of each
</span><br>
<span class="quotelev1">&gt;         interval
</span><br>
...
<span class="quotelev1">&gt;                 call mpi_reduce(pi_mpi, pi, 1, MPI_DOUBLE_PRECISION,
</span><br>
<span class="quotelev1">&gt;         MPI_SUM, 0,
</span><br>
...
<span class="quotelev1">&gt;                   Thread support: posix (MPI_THREAD_MULTIPLE: yes,
</span><br>
<span class="quotelev1">&gt;         OPAL support:
</span><br>
<span class="quotelev1">&gt;         yes,
</span><br>
<span class="quotelev1">&gt;                                   OMPI progress: no, ORTE progress:
</span><br>
<span class="quotelev1">&gt;         yes, Event
</span><br>
...
<span class="quotelev1">&gt;                        MCA hwloc: hwloc191 (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component
</span><br>
<span class="quotelev1">&gt;         v1.8.4)
...
<span class="quotelev1">&gt;                          MCA ess: slurm (MCA v2.0, API v3.0, Component
</span><br>
<span class="quotelev1">&gt;         v1.8.4)
</span><br>
<span class="quotelev1">&gt;                          MCA ess: tm (MCA v2.0, API v3.0, Component
</span><br>
<span class="quotelev1">&gt;         v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                          MCA iof: mr_hnp (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                          MCA plm: tm (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt;         v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                          MCA ras: tm (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt;         v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                        MCA rmaps: mindist (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                        MCA rmaps: staged (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                         MCA bcol: ptpcoll (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                          MCA btl: smcuda (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                         MCA coll: libnbc (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                        MCA fcoll: dynamic (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                        MCA fcoll: static (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                        MCA mpool: gpusm (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt;         v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                        MCA mpool: rgpusm (MCA v2.0, API v2.0,
</span><br>
<span class="quotelev1">&gt;         Component v1.8.4)
</span><br>
...
<span class="quotelev1">&gt;                          MCA mtl: psm (MCA v2.0, API v2.0, Component
</span><br>
<span class="quotelev1">&gt;         v1.8.4)
</span><br>
