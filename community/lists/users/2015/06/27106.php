...
?>
<!-- received="Thu Jun 11 14:44:04 2015" -->
<!-- isoreceived="20150611184404" -->
<!-- sent="Thu, 11 Jun 2015 18:43:48 +0000" -->
<!-- isosent="20150611184348" -->
...
<!-- id="3338D43B4B3406468B642ACE86F41E7E3AE8026B_at_ucolhpks.easf.csd.disa.mil" -->
...
<strong>Date:</strong> 2015-06-11 14:43:48
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27107.php">Douglas L Reeder: "Re: [OMPI users] orted segmentation fault in pmix on master"</a>
<li><strong>Previous message:</strong> <a href="27105.php">Ralph Castain: "Re: [OMPI users] orted segmentation fault in pmix on master"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27110.php">Leiter, Kenneth W CIV USARMY ARL (US): "Re: [OMPI users] orted segmentation fault in pmix on master"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I can try with a vanilla configure, here is what I configured with:
<br>
<p><p>./configure --with-alps --with-ugni --without-verbs --with-cray-xpmem --with-cray-pmi --with-udreg --without-tm --enable-debug
<br>
<p><p>I am using PrgEnv-intel/5.2.40
<br>
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27106/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/x-bzip2 attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27106/ompi_info_output.tar.bz2">ompi_info_output.tar.bz2</a>
</ul>
