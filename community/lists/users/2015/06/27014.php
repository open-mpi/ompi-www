...
?>
<!-- received="Mon Jun  1 10:53:48 2015" -->
<!-- isoreceived="20150601145348" -->
<!-- sent="Mon, 1 Jun 2015 07:53:33 -0700" -->
<!-- isosent="20150601145333" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] problem starting a ompi job in a mix BE/LE cluster" -->
<!-- id="986B2E84-9D1D-433F-BC74-FCBF942A56C1_at_open-mpi.org" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2015-06-01 10:53:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27015.php">Nathan Hjelm: "Re: [OMPI users] Memory usage for MPI program"</a>
<li><strong>Previous message:</strong> <a href="27013.php">Alejandro: "[OMPI users] Bug report: Message queues debugging not working"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27025.php">Steve Wise: "Re: [OMPI users] problem starting a ompi job in a mix BE/LE cluster"</a>
<li><strong>Reply:</strong> <a href="27025.php">Steve Wise: "Re: [OMPI users] problem starting a ompi job in a mix BE/LE cluster"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Well, I checked and it looks to me like &#226;&#128;&#148;hetero-apps is a stale option in the master at least - I don&#226;&#128;&#153;t see where it gets used.
<br>
<p>Looking at the code, I would suspect that something didn&#226;&#128;&#153;t get configured correctly - either the &#226;&#128;&#148;enable-heterogeneous flag didn&#226;&#128;&#153;t get set on one side, or we incorrectly failed to identify the BE machine, or both. You might run ompi_info on the two sides and verify they both were built correctly
<br>
<p><p><span class="quotelev1">&gt; On Jun 1, 2015, at 7:40 AM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; There is another mpirun flag &#226;&#128;&#148;hetero-apps that you may need to provide. It has been so long since someone tried this that I&#226;&#128;&#153;d have to look to remember what it does.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
