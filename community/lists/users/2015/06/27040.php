...
?>
<!-- received="Thu Jun  4 11:53:52 2015" -->
<!-- isoreceived="20150604155352" -->
<!-- sent="Thu, 04 Jun 2015 18:53:47 +0300" -->
<!-- isosent="20150604155347" -->
<!-- name="Timur Ismagilov" -->
<!-- email="tismagilov_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Fwd[2]: OMPI yalla vs impi" -->
<!-- id="1433433227.500463091_at_f123.i.mail.ru" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2015-06-04 11:53:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27041.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Bug: Disabled mpi_leave_pinned for GPUDirect and InfiniBand during run-time caused by GCC optimizations"</a>
<li><strong>Previous message:</strong> <a href="27039.php">Ren&#195;&#169; Oertel: "[OMPI users] Bug: Disabled mpi_leave_pinned for GPUDirect and InfiniBand during run-time caused by GCC optimizations"</a>
<li><strong>Maybe in reply to:</strong> <a href="27029.php">Timur Ismagilov: "Re: [OMPI users] Fwd[2]: OMPI yalla vs impi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27138.php">Timur Ismagilov: "Re: [OMPI users] Fwd[2]: OMPI yalla vs impi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
2. When i run osu_mbr_mr with key &quot;-x MXM_TLS=self,shm,rc&quot; . It fails with segmentation fault : 
<br>
...
cmd line:
<br>
$HPCX_MPI_DIR/bin/mpirun -mca coll_hcoll_enable 1 -x HCOLL_MAIN_IB=mlx4_0:1 -x MXM_IB_PORTS=mlx4_0:1 -x MXM_SHM_KCOPY_MODE=off --mca pml yalla -x MXM_TLS=self,shm,rc --hostfile hostlist osu_mbw_mr -v -r=0
<br>
osu_mbw_mr.c
<br>
I have changed WINDOW_SIZES in osu_mbw_mr.c:
<br>
#define WINDOW_SIZES {8, 16, 32, 64,  128, 256, 512, 1024 }&#194;&#160; 
<br>
3. I add results of running osu_mbw_mr with yalla and without hcoll on 32 and 64 nodes (512 and 1024 mpi procs
<br>
) to  mvs10p_mpi.xls : list osu_mbr_mr.
<br>
The results are 20 percents smaller than old results (with hcoll).
<br>
<p><p><p>&#208;&#161;&#209;&#128;&#208;&#181;&#208;&#180;&#208;&#176;,  3 &#208;&#184;&#209;&#142;&#208;&#189;&#209;&#143; 2015, 10:29 +03:00 &#208;&#190;&#209;&#130; Alina Sklarevich &lt;alinas_at_[hidden]&gt;:
<br>
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27040/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27040/osu_mbw_mr_n-2_ppn-16.out">osu_mbw_mr_n-2_ppn-16.out</a>
</ul>
<!-- attachment="osu_mbw_mr_n-2_ppn-16.out" -->
<hr>
<ul>
<li>application/octet-stream attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27040/osu_mbw_mr_n-2_ppn-16.err">osu_mbw_mr_n-2_ppn-16.err</a>
</ul>
<!-- attachment="osu_mbw_mr_n-2_ppn-16.err" -->
<hr>
<ul>
<li>application/vnd.openxmlformats-officedocument.spreadsheetml.sheet attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27040/mvs10p_mpi.xlsx">mvs10p_mpi.xlsx</a>
</ul>
