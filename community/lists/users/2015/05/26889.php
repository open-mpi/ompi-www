...
?>
<!-- received="Tue May 19 22:25:26 2015" -->
<!-- isoreceived="20150520022526" -->
<!-- sent="Tue, 19 May 2015 22:25:20 -0400" -->
<!-- isosent="20150520022520" -->
<!-- name="Lev Givon" -->
...
<!-- id="20150520022520.GG5298_at_avicenna.ee.columbia.edu" -->
<!-- charset="us-ascii" -->
...
<strong>Date:</strong> 2015-05-19 22:25:20
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26890.php">Nilo Menezes: "Re: [OMPI users] Openmpi 1.8.5 on Linux with threading support"</a>
<li><strong>Previous message:</strong> <a href="26888.php">Khalid Hasanov: "Re: [OMPI users] Open MPI collectives algorithm selection"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26892.php">Rolf vandeVaart: "Re: [OMPI users] cuIpcOpenMemHandle failure when using OpenMPI 1.8.5 with CUDA 7.0 and Multi-Process Service"</a>
<li><strong>Reply:</strong> <a href="26892.php">Rolf vandeVaart: "Re: [OMPI users] cuIpcOpenMemHandle failure when using OpenMPI 1.8.5 with CUDA 7.0 and Multi-Process Service"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>The error does indeed go away when IPC is disabled, although I do want to
<br>
avoid degrading the performance of data transfers between GPU memory locations.
<br>
<p><span class="quotelev1">&gt; What does your hardware configuration look like?  Can you send me output from
</span><br>
