...
?>
<!-- received="Thu Nov 19 18:53:12 2015" -->
<!-- isoreceived="20151119235312" -->
<!-- sent="Fri, 20 Nov 2015 08:53:09 +0900" -->
<!-- isosent="20151119235309" -->
<!-- name="Gilles Gouaillardet" -->
<!-- email="gilles_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Bug in Fortran-module MPI of OpenMPI 1.10.0 with Intel-Ftn-compiler" -->
<!-- id="564E60E5.2080408_at_rist.or.jp" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="8337B490252F0944BF1D38541059627E173BA33B_at_DLREXMBX01.intra.dlr.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-11-19 18:53:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="28072.php">Jeff Hammond: "Re: [OMPI users] help understand unhelpful ORTE error message"</a>
<li><strong>Previous message:</strong> <a href="28070.php">Saurabh T: "Re: [OMPI users] Openmpi 1.10.1 fails with SIGXFSZ on file limit &lt;= 131072"</a>
<li><strong>In reply to:</strong> <a href="28056.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in Fortran-module MPI of OpenMPI 1.10.0 with	Intel-Ftn-compiler"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="28098.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in Fortran-module MPI of OpenMPI 1.10.0 with Intel-Ftn-compiler"</a>
<li><strong>Reply:</strong> <a href="28098.php">Michael.Rachner_at_[hidden]: "Re: [OMPI users] Bug in Fortran-module MPI of OpenMPI 1.10.0 with Intel-Ftn-compiler"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>Gilles
<br>
<p>On 11/19/2015 10:21 PM, Michael.Rachner_at_[hidden] wrote:
<br>
...
<span class="quotelev1">&gt; I hope the administrators of the cluster will be so kind  and will 
</span><br>
<span class="quotelev1">&gt; update OpenMPI for me (and others) soon.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; *Von:*users [mailto:users-bounces_at_[hidden]] *Im Auftrag von 
</span><br>
...
<span class="quotelev1">&gt; *Betreff:* Re: [OMPI users] Bug in Fortran-module MPI of OpenMPI 
</span><br>
<span class="quotelev1">&gt; 1.10.0 with Intel-Ftn-compiler
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; (intel 16 changed the way gcc pragmas are handled, and ompi has been 
</span><br>
<span class="quotelev1">&gt; made aware in 1.10.1)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; 1.10.1 fixes many bugs from 1.10.0, so I strongly encourage anyone to 
</span><br>
<span class="quotelev1">&gt; use 1.10.1
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On Thursday, November 19, 2015, Nick Papior &lt;nickpapior_at_[hidden] 
</span><br>
...
<span class="quotelev1">&gt; On a side-note, please note that if you require scalapack you may need 
</span><br>
<span class="quotelev1">&gt; to follow this approach:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;  OpenMPI 1.10.1 compared to 1.10.0, I do not remember having seen this 
</span><br>
<span class="quotelev1">&gt; item to be corrected.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; &lt;javascript:_e(%7B%7D,'cvml','users-bounces_at_[hidden]');&gt;] *Im 
</span><br>
<span class="quotelev1">&gt; Auftrag von *Gilles Gouaillardet
</span><br>
...
<span class="quotelev1">&gt; And if that still does not work, can you upgrade icc suite and give it 
</span><br>
<span class="quotelev1">&gt; an other try ?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; Michael.Rachner_at_[hidden] 
</span><br>
<span class="quotelev1">&gt; &lt;javascript:_e(%7B%7D,'cvml','Michael.Rachner_at_[hidden]');&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; I am trying to run our parallelized Ftn-95 code on a Linux cluster 
</span><br>
<span class="quotelev1">&gt; with OpenMPI-1-10.0 and Intel-16.0.0 Fortran compiler.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; In the code I use the  module MPI  (&#147;use MPI&#148;-stmts).
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; The interfaces in the module MPI for the MPI-routines do not accept a 
</span><br>
<span class="quotelev1">&gt; send or receive buffer array, which is
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; #6285: There is no matching specific subroutin for this generic 
</span><br>
<span class="quotelev1">&gt; subroutine call )
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;              ivar=123    ! &#223;ivar is an integer variable, not an array
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; *call* MPI_BCAST( ivar, 1, MPI_INTEGER, 0, MPI_COMM_WORLD), ierr_mpi 
</span><br>
<span class="quotelev1">&gt; )    ! &#223;- this should work, but is not accepted by the compiler
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; ierr_mpi )    ! &#223;- this workaround works
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt;      Any call of an MPI-routine with MPI_IN_PLACE does not work, like 
</span><br>
<span class="quotelev1">&gt; that coding:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-28071/attachment">attachment</a>
</ul>
