...
?>
<!-- received="Mon Oct  5 15:58:51 2015" -->
<!-- isoreceived="20151005195851" -->
<!-- sent="Mon, 5 Oct 2015 12:58:45 -0700" -->
<!-- isosent="20151005195845" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Hybrid OpenMPI+OpenMP tasks using SLURM" -->
<!-- id="75064DAB-6F1C-4ED4-A24F-F4256265386C_at_open-mpi.org" -->
<!-- charset="utf-8" -->
...
<strong>Date:</strong> 2015-10-05 15:58:45
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27805.php">marcin.krotkiewski: "Re: [OMPI users] Hybrid OpenMPI+OpenMP tasks using SLURM"</a>
<li><strong>Previous message:</strong> <a href="27803.php">marcin.krotkiewski: "[OMPI users] Hybrid OpenMPI+OpenMP tasks using SLURM"</a>
<li><strong>In reply to:</strong> <a href="27803.php">marcin.krotkiewski: "[OMPI users] Hybrid OpenMPI+OpenMP tasks using SLURM"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27805.php">marcin.krotkiewski: "Re: [OMPI users] Hybrid OpenMPI+OpenMP tasks using SLURM"</a>
<li><strong>Reply:</strong> <a href="27805.php">marcin.krotkiewski: "Re: [OMPI users] Hybrid OpenMPI+OpenMP tasks using SLURM"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>mpirun &#226;&#128;&#148;map-by core:pe=4
<br>
<p>to get what you are seeking. If we don&#226;&#128;&#153;t already set that qualifier when we see &#226;&#128;&#156;cpus_per_task&#226;&#128;&#157;, then we probably should do so as there isn&#226;&#128;&#153;t any reason to make you set it twice (well, other than trying to track which envar slurm is using now).
<br>
<p><p><span class="quotelev1">&gt; On Oct 5, 2015, at 12:38 PM, marcin.krotkiewski &lt;marcin.krotkiewski_at_[hidden]&gt; wrote:
</span><br>
