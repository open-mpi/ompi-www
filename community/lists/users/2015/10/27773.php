...
?>
<!-- received="Fri Oct  2 17:49:07 2015" -->
<!-- isoreceived="20151002214907" -->
<!-- sent="Sat, 3 Oct 2015 00:49:05 +0300" -->
<!-- isosent="20151002214905" -->
<!-- name="Surivinta Surivinta" -->
<!-- email="surivinta_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Need some help to track problem using openmpi" -->
<!-- id="CAC+Fo8G2V=ETtHLiuRyhut3X+0S_bqLVXE5PTKQHxyrqnDzU=w_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="560927E9.3020208_at_tfd.uni-hannover.de" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-10-02 17:49:05
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27774.php">Ralph Castain: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<li><strong>Previous message:</strong> <a href="27772.php">Nathan Hjelm: "Re: [OMPI users] OpenMPI 1.8.8: Segfault when using non-blocking reduce operations with a user-defined operator"</a>
<li><strong>In reply to:</strong> <a href="http://www.open-mpi.org/community/lists/users/2015/09/27695.php">Sven Schumacher: "[OMPI users] Need some help to track problem using openmpi"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27775.php">Ralph Castain: "Re: [OMPI users] Need some help to track problem using openmpi"</a>
<li><strong>Reply:</strong> <a href="27775.php">Ralph Castain: "Re: [OMPI users] Need some help to track problem using openmpi"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<a href="https://www.open-mpi.org/faq/?category=tuning#setting-mca-params">https://www.open-mpi.org/faq/?category=tuning#setting-mca-params</a>
<br>
also  you can try run gdb via mpirun to get debug info:
<br>
mpirun -np 2 xterm -e gdb ./your_program
<br>
<p><p>2015-09-28 14:43 GMT+03:00 Sven Schumacher &lt;schumacher_at_[hidden]&gt;:
<br>
...
<span class="quotelev1">&gt; doesn't seem there is such a list on open-mpi.org or I didn't find it...
</span><br>
...
<span class="quotelev1">&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/09/27695.php">http://www.open-mpi.org/community/lists/users/2015/09/27695.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><p><p><pre>
...
<hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27773/attachment">attachment</a>
</ul>
