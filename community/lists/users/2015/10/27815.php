...
?>
<!-- received="Tue Oct  6 06:22:15 2015" -->
<!-- isoreceived="20151006102215" -->
<!-- sent="Tue, 6 Oct 2015 12:22:09 +0200" -->
<!-- isosent="20151006102209" -->
...
<!-- id="5613A0D1.7010008_at_gmail.com" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="CAAkFZ5uTPr2rhECEJGSqE-kjtpiMH8wKvEjprqC9SMaQTACuLQ_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-10-06 06:22:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27816.php">Edson Tavares de Camargo: "[OMPI users] Question about checkpoint tools on OpenMPI"</a>
<li><strong>Previous message:</strong> <a href="27814.php">Gilles Gouaillardet: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<li><strong>In reply to:</strong> <a href="27814.php">Gilles Gouaillardet: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27827.php">Gilles Gouaillardet: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<li><strong>Reply:</strong> <a href="27827.php">Gilles Gouaillardet: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Gilles,
<br>
<p>Yes, it seemed that all was fine with binding in the patched 1.10.1rc1 - 
<br>
...
<p>Marcin
<br>
<p><p><p>On 10/06/2015 12:09 PM, Gilles Gouaillardet wrote:
<br>
<span class="quotelev1">&gt; Marcin,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; my understanding is that in this case, patched v1.10.1rc1 is working 
</span><br>
...
<span class="quotelev1">&gt; one to remove the warning when binding on one core if only one core is 
</span><br>
<span class="quotelev1">&gt; available,
</span><br>
<span class="quotelev1">&gt; an other one to add a warning if the user asks a binding policy that 
</span><br>
...
<span class="quotelev2">&gt;&gt;     could you please send the full details (script, allocation and
</span><br>
...
<span class="quotelev1">&gt;     I have attached two output files: one for the original 1.10.1rc1,
</span><br>
<span class="quotelev1">&gt;     one for the patched version.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;     When I said 'failed in one case' I was not precise. I got an error
</span><br>
<span class="quotelev1">&gt;     on node c1-8, which was the first one to have different number of
</span><br>
<span class="quotelev1">&gt;     MPI processes on the two sockets. It would also fail on some later
</span><br>
<span class="quotelev1">&gt;     nodes, just that because of the error we never got there.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     called in rmaps_base_binding.c / bind_downwards being wrong. I
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     do not know the reason, but I think I know when the problem
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     happens (at least on 1.10.1rc1). It seems that by default
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     openmpi maps by socket. The error happens when for a given
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     compute node there is a different number of cores used on each
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     socket. Consider previously studied case (the debug outputs I
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     sent in last post). c1-8, which was source of error, has 5 mpi
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     Binding progresses correctly up to and including core 13 (see
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     I have submitted a few other jobs and I always had an error in
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     such situation. Moreover, if I now use --map-by core instead of
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     socket, the error is gone, and I get my expected binding:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;     1.10.1rc1. However, there is still a difference in behavior
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     between 1.10.1rc1 and earlier versions. In the SLURM job
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     described in last post, 1.10.1rc1 fails to bind only in 1 case,
</span><br>
<span class="quotelev3">&gt;&gt;&gt;     while the earlier versions fail in 21 out of 32 cases. You
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;     tried to bind to cores outside the cpuset.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     /* when a core has more than one thread, would ompi assume all
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     the threads are available if the core is available ? */
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;     On Sunday, October 4, 2015, Ralph Castain &lt;rhc_at_[hidden]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;     &lt;javascript:_e(%7B%7D,'cvml','rhc_at_[hidden]');&gt;&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         Thanks - please go ahead and release that allocation as I&#146;m
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         not going to get to this immediately. I&#146;ve got several hot
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         irons in the fire right now, and I&#146;m not sure when I&#146;ll get
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         a chance to track this down.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         Gilles or anyone else who might have time - feel free to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         take a gander and see if something pops out at you.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;         Ralph
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         --enable-debug and executed
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         BITMAP
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         [login-0-1.local:03399] [[37945,0],0] PROC [[37945,1],27]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         ON c1-26 IS NOT BOUND
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         hours now to work with one example, and not change it for
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         every post :)
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         If you need anything else, let me know. I could introduce
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         some patch/printfs and recompile, if you need it.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;         Marcin
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         multi-tenant. Is this a debug version of OMPI? If not,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;         can you rebuild OMPI with &#151;enable-debug?
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         Here is the output of lstopo. In short, (0,16) are core
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         0, (1,17) - core 1 etc.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         change things around. Could you run lstopo on one of
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         those compute nodes and send the output?
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         I&#146;m just suspicious because I&#146;m not seeing a clear
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         pairing of HT numbers in your output, but HT numbering
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         is BIOS-specific and I may just not be understanding
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         your particular pattern. Our error message is clearly
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         indicating that we are seeing individual HTs (and not
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         complete cores) assigned, and I don&#146;t know the source
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         of that confusion.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         will of course get the right mapping as we&#146;ll just
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         inherit whatever we received.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         Yes. I meant that whatever you received (what SLURM
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         gives) is a correct cpu map and assigns _whole_ CPUs,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         not a single HT to MPI processes. In the case
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         mentioned earlier openmpi should start 6 tasks on
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         c1-30. If HT would be treated as separate and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         independent cores, sched_getaffinity of an MPI
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         process started on c1-30 would return a map with 6
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         entries only. In my case it returns a map with 12
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         entries - 2 for each core. So one process is in fact
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         allocated both HTs, not only one. Is what I'm saying
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         would expect that on c1-30 with --bind-to core
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         openmpi should bind to logical cores 0 and 16 (rank
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         0), 1 and 17 (rank 2) and so on. All those logical
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         cores are available in sched_getaffinity map, and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         there is twice as many logical cores as there are MPI
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         same physical core (logical cores 0 and 16 are two
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         HTs of the same core). If I use --bind-to core, I get
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         the following correct binding
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         improved something, but not everything. Consider this
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         correctly (i.e., map contains two logical cores in
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         ALL cases), except this case that required the
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         using core (13,29)? Clearly, the original
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         SLURM-delivered map has 5 CPUs included, enough for 5
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         intentionally. SLURM starts as many processes as
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         there are physical cores, not threads. To verify
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;         this, consider this test case:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;     Link to this post:<a href="http://www.open-mpi.org/community/lists/users/2015/10/27792.php">http://www.open-mpi.org/community/lists/users/2015/10/27792.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt;
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/10/27814.php">http://www.open-mpi.org/community/lists/users/2015/10/27814.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27815/attachment">attachment</a>
</ul>
