...
?>
<!-- received="Mon Oct  5 05:01:03 2015" -->
<!-- isoreceived="20151005090103" -->
<!-- sent="Mon, 5 Oct 2015 02:00:56 -0700" -->
<!-- isosent="20151005090056" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes" -->
<!-- id="BBD24154-3518-439E-91E7-006B164C1C9C_at_open-mpi.org" -->
<!-- charset="windows-1252" -->
<!-- inreplyto="5612311C.2040606_at_rist.or.jp" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-10-05 05:00:56
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27797.php">marcin.krotkiewski: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<li><strong>Previous message:</strong> <a href="27795.php">Gilles Gouaillardet: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<li><strong>In reply to:</strong> <a href="27795.php">Gilles Gouaillardet: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27797.php">marcin.krotkiewski: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<li><strong>Reply:</strong> <a href="27797.php">marcin.krotkiewski: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I did think of one alternative that might be worth considering. If we have a hetero topology, then we know that things are going to be a little unusual. In that case, we could just default to map-by core (or hwthread if &#151;use-hwthread-cpus was given) and then things would be fine even in non-symmetric topologies. Likewise, if we have a homogeneous topology, we could just quickly check for symmetry on our base topology (the one we will use for mapping) and default to map-by core if non-symmetric.
<br>
<p>I suggest it only because we otherwise wind up with some oddball hybrid mapping scheme. In the case we have here, procs would be mapped by socket except where we have an extra core, where they would look like they were mapped by core. Impossible to predict how the app will react to it.
<br>
<p>The alternative be a more predictable pattern - would it make more sense?
<br>
<p>Ralph
<br>
<p><p><span class="quotelev1">&gt; On Oct 5, 2015, at 1:13 AM, Gilles Gouaillardet &lt;gilles_at_[hidden]&gt; wrote:
</span><br>
...
<span class="quotelev1">&gt; here is a proof of concept for a fix (assert should be replaced with proper error handling)
</span><br>
...
<span class="quotelev2">&gt;&gt; OK, i'll see what i can do :-)
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; On 10/5/2015 12:39 PM, Ralph Castain wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I would consider that a bug, myself - if there is some resource available, we should use it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Oct 4, 2015, at 5:42 PM, Gilles Gouaillardet &lt;gilles_at_[hidden] &lt;mailto:gilles_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; i ran a simple test with v1.10.1rc1 under a cpuset with
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; - one core (two threads 0,16) on socket 0
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; - two cores (two threads each 8,9,24,25) on socket 1
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $ mpirun -np 3 -bind-to core ./hello_c 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; --------------------------------------------------------------------------
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;    Node:        rapid
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; as you already pointed, default mapping is by socket.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; so on one hand, we can consider this behavior is a feature :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; we try to bind two processes to socket 0, so the --oversubscribe option is required
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; (and it does what it should :
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; $ mpirun -np 3 -bind-to core --oversubscribe -report-bindings ./hello_c 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [rapid:16278] MCW rank 0 bound to socket 0[core 0[hwt 0-1]]: [BB/../../../../../../..][../../../../../../../..]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [rapid:16278] MCW rank 1 bound to socket 1[core 8[hwt 0-1]]: [../../../../../../../..][BB/../../../../../../..]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; [rapid:16278] MCW rank 2 bound to socket 0[core 0[hwt 0-1]]: [BB/../../../../../../..][../../../../../../../..]
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hello, world, I am 1 of 3, (Open MPI v1.10.1rc1, package: Open MPI gilles_at_rapid Distribution, ident: 1.10.1rc1, repo rev: v1.10.0-84-g15ae63f, Oct 03, 2015, 128)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hello, world, I am 2 of 3, (Open MPI v1.10.1rc1, package: Open MPI gilles_at_rapid Distribution, ident: 1.10.1rc1, repo rev: v1.10.0-84-g15ae63f, Oct 03, 2015, 128)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Hello, world, I am 0 of 3, (Open MPI v1.10.1rc1, package: Open MPI gilles_at_rapid Distribution, ident: 1.10.1rc1, repo rev: v1.10.0-84-g15ae63f, Oct 03, 2015, 128)
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; and on the other hand, we could consider ompi should be a bit smarter, and uses socket 1 for task 2 since socket 0 is fully allocated and there is room on socket 1.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Ralph, any thoughts ? bug or feature ? 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On Sunday, October 4, 2015, Ralph Castain &lt; &lt;mailto:rhc_at_[hidden]&gt;rhc_at_[hidden] &lt;mailto:rhc_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Oct 3, 2015, at 11:05 AM, marcin.krotkiewski &lt; &lt;mailto:marcin.krotkiewski_at_[hidden]&gt;marcin.krotkiewski_at_[hidden] &lt;mailto:marcin.krotkiewski_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; 
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/10/27793.php">http://www.open-mpi.org/community/lists/users/2015/10/27793.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/users/2015/10/27793.php">http://www.open-mpi.org/community/lists/users/2015/10/27793.php</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/10/27794.php">http://www.open-mpi.org/community/lists/users/2015/10/27794.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/users/2015/10/27794.php">http://www.open-mpi.org/community/lists/users/2015/10/27794.php</a>&gt;
</span><br>
<span class="quotelev1">&gt; &lt;unbalanced.patch&gt;_______________________________________________
</span><br>
<span class="quotelev1">&gt; users mailing list
</span><br>
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/10/27795.php">http://www.open-mpi.org/community/lists/users/2015/10/27795.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27796/attachment">attachment</a>
</ul>
