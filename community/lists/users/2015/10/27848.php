...
?>
<!-- received="Thu Oct  8 15:34:42 2015" -->
<!-- isoreceived="20151008193442" -->
<!-- sent="Thu, 8 Oct 2015 12:34:35 -0700" -->
<!-- isosent="20151008193435" -->
<!-- name="Ralph Castain" -->
<!-- email="rhc_at_[hidden]" -->
<!-- subject="Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes" -->
<!-- id="A554343B-3DB5-4BED-B6DC-DDFA05F48746_at_open-mpi.org" -->
...
<strong>Date:</strong> 2015-10-08 15:34:35
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="27849.php">marcin.krotkiewski: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<li><strong>Previous message:</strong> <a href="27847.php">marcin.krotkiewski: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="27849.php">marcin.krotkiewski: "Re: [OMPI users] Process binding with SLURM and 'heterogeneous' nodes"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev2">&gt;&gt; I&#146;m a little nervous about this one, Gilles. It&#146;s doing a lot more than just addressing the immediate issue, and I&#146;m concerned about any potential side-effects that we don&#146;t fully unocver prior to release.
</span><br>
...
<span class="quotelev2">&gt;&gt; 1. use my alternative method for 1.10.1 to solve the immediate issue. It only affects this one, rather unusual, corner-case that was reported here. So the impact can be easily contained and won&#146;t impact anything else.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; 2. push your proposed solution to the master where it can soak for awhile and give us a chance to fully discover the secondary effects. Removing the unused and &#147;not-allowed&#148; cpus from the topology means a substantial scrub of the code base in a number of places, and your patch doesn&#146;t really get them all. It&#146;s going to take time to ensure everything is working correctly again.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Oct 7, 2015, at 4:29 AM, Gilles Gouaillardet &lt;gilles.gouaillardet_at_[hidden] &lt;mailto:gilles.gouaillardet_at_[hidden]&gt;&gt; wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; there are quite a lot of changes, I did not update master yet (need extra pairs of eyes to review this...)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; so unless you want to make rc2 today and rc3 a week later, it is imho way safer to wait for v1.10.2
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Wednesday, October 7, 2015, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden] &lt;mailto:jsquyres_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Is this something that needs to go into v1.10.1?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; If so, a PR needs to be filed ASAP.  We were supposed to make the next 1.10.1 RC yesterday, but slipped to today due to some last second patches.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; On Oct 7, 2015, at 4:32 AM, Gilles Gouaillardet &lt;gilles_at_[hidden] &lt;javascript:;&gt;&gt; wrote:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt; here is a patch for the master, hopefully it fixes all the issues we discussed
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; i will make sure it applies fine vs latest 1.10 tarball from tomorrow
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; Yes, it seemed that all was fine with binding in the patched 1.10.1rc1 - thank you. Eagerly waiting for the other patches, let me know and I will test them later this week.
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; Marcin
...
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt; my understanding is that in this case, patched v1.10.1rc1 is working just fine.
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt; one to remove the warning when binding on one core if only one core is available,
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt; an other one to add a warning if the user asks a binding policy that makes no sense with the required mapping policy
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt; On Tuesday, October 6, 2015, marcin.krotkiewski &lt;marcin.krotkiewski_at_[hidden] &lt;javascript:;&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt; Hi, Gilles
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt; you mentionned you had one failure with 1.10.1rc1 and -bind-to core
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt; could you please send the full details (script, allocation and output)
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt; in your slurm script, you can do
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt; srun -N $SLURM_NNODES -n $SLURM_NNODES --cpu_bind=none -l grep Cpus_allowed_list /proc/self/status
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt; mpirun --mca rmaps_base_verbose 10 --hetero-nodes --bind-to core --report-bindings --map-by socket -np 32 ./affinity
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt; I have attached two output files: one for the original 1.10.1rc1, one for the patched version.
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt; When I said 'failed in one case' I was not precise. I got an error on node c1-8, which was the first one to have different number of MPI processes on the two sockets. It would also fail on some later nodes, just                 that because of the error we never got there.
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt; called in rmaps_base_binding.c / bind_downwards being wrong. I do not know the reason, but I think I know when the problem happens (at least on 1.10.1rc1). It seems that by default openmpi maps by socket. The error happens when for a given compute node there is a different number of cores used on each socket. Consider previously studied case (the debug outputs I sent in last post). c1-8, which was source of error, has 5 mpi processes assigned, and the cpuset is the following:
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt; Cores 0,5 are on socket 0, cores 9, 13, 14 are on socket 1. Binding progresses correctly up to and including core 13 (see end of file out.1.10.1rc2, before the error). That is 2 cores on socket 0, and 2 cores on socket 1. Error is thrown when core 14 should be bound - extra core on socket 1 with no corresponding core on socket 0. At that point the returned trg_obj points to the first core on the node (os_index 0, socket 0).
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt; I have submitted a few other jobs and I always had an error in such situation. Moreover, if I now use --map-by core instead of socket, the error is gone, and I get my expected binding:
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt; Using --map-by core seems to fix the issue on 1.8.8, 1.10.0 and 1.10.1rc1. However, there is still a difference in behavior between 1.10.1rc1 and earlier versions. In the SLURM job described in last post, 1.10.1rc1 fails to bind only in 1 case, while the earlier versions fail in 21 out of 32 cases. You mentioned there was a bug in hwloc. Not sure if it can explain the difference in behavior.
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt; this could be pretty similar to a previous issue when ompi tried to bind to cores outside the cpuset.
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt; /* when a core has more than one thread, would ompi assume all the threads are available if the core is available ? */
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt; On Sunday, October 4, 2015, Ralph Castain &lt;rhc_at_[hidden] &lt;javascript:;&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt; Thanks - please go ahead and release that allocation as I&#146;m not going to get to this immediately. I&#146;ve got several hot irons in the fire right now, and I&#146;m not sure when I&#146;ll get a chance to track this down.
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt; Gilles or anyone else who might have time - feel free to take a gander and see if something pops out at you.
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt; Ralph
...
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; On Oct 3, 2015, at 11:05 AM, marcin.krotkiewski &lt;marcin.krotkiewski_at_[hidden] &lt;javascript:;&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun --mca rmaps_base_verbose 10 --hetero-nodes --report-bindings --bind-to core -np 32 ./affinity
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; In case of 1.10.rc1 I have also added :overload-allowed - output in a separate file. This option did not make much difference for 1.10.0, so I did not attach it here.
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; [login-0-1.local:03399] [[37945,0],0] PROC [[37945,1],27] ON c1-26 IS NOT BOUND
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; I have submitted an interactive job on screen for 120 hours now to work with one example, and not change it for every post :)
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; If you need anything else, let me know. I could introduce some patch/printfs and recompile, if you need it.
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt; Marcin
...
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Rats - just realized I have no way to test this as none of the machines I can access are setup for cgroup-based multi-tenant. Is this a debug version of OMPI? If not, can you rebuild OMPI with &#151;enable-debug?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Then please run it with &#151;mca rmaps_base_verbose 10 and pass along the output.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Oct 3, 2015, at 10:09 AM, Ralph Castain &lt; &lt;javascript:;&gt;rhc_at_[hidden] &lt;mailto:rhc_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; What version of slurm is this? I might try to debug it here. I&#146;m not sure where the problem lies just yet.
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Oct 3, 2015, at 8:59 AM, marcin.krotkiewski &lt; &lt;javascript:;&gt;marcin.krotkiewski_at_[hidden] &lt;mailto:marcin.krotkiewski_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Oct 3, 2015, at 8:28 AM, marcin.krotkiewski &lt; &lt;javascript:;&gt;marcin.krotkiewski_at_[hidden] &lt;mailto:marcin.krotkiewski_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On Oct 3, 2015, at 7:12 AM, marcin.krotkiewski &lt; &lt;javascript:;&gt;marcin.krotkiewski_at_[hidden] &lt;mailto:marcin.krotkiewski_at_[hidden]&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/10/27790.php">http://www.open-mpi.org/community/lists/users/2015/10/27790.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/users/2015/10/27790.php">http://www.open-mpi.org/community/lists/users/2015/10/27790.php</a>&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev4">&gt;&gt;&gt; &gt;&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/10/27791.php">http://www.open-mpi.org/community/lists/users/2015/10/27791.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/users/2015/10/27791.php">http://www.open-mpi.org/community/lists/users/2015/10/27791.php</a>&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; &gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/10/27792.php">http://www.open-mpi.org/community/lists/users/2015/10/27792.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/users/2015/10/27792.php">http://www.open-mpi.org/community/lists/users/2015/10/27792.php</a>&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt; &gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/10/27814.php">http://www.open-mpi.org/community/lists/users/2015/10/27814.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/users/2015/10/27814.php">http://www.open-mpi.org/community/lists/users/2015/10/27814.php</a>&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt;
...
<span class="quotelev1">&gt;&gt;&gt; &gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/10/27815.php">http://www.open-mpi.org/community/lists/users/2015/10/27815.php</a> &lt;<a href="http://www.open-mpi.org/community/lists/users/2015/10/27815.php">http://www.open-mpi.org/community/lists/users/2015/10/27815.php</a>&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; &lt;heterogeneous_topologies.patch&gt;_______________________________________________
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; users mailing list
</span><br>
<span class="quotelev4">&gt;&gt;&gt; &gt; users_at_[hidden] &lt;javascript:;&gt;
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/10/27847.php">http://www.open-mpi.org/community/lists/users/2015/10/27847.php</a>
</span><br>
<p><p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-27848/attachment">attachment</a>
</ul>
