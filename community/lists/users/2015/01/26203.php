...
?>
<!-- received="Fri Jan 16 12:19:03 2015" -->
<!-- isoreceived="20150116171903" -->
<!-- sent="Fri, 16 Jan 2015 18:19:02 +0100" -->
<!-- isosent="20150116171902" -->
<!-- name="Diego Avesani" -->
<!-- email="diego.avesani_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous" -->
<!-- id="CAG8o1y5U+J7c4dDoJMO4w7nw8_X6aPy--A3Nuo+09u7rLUGmRg_at_mail.gmail.com" -->
<!-- charset="UTF-8" -->
<!-- inreplyto="842096AE-8FF6-434C-AE4F-CF8146294D7B_at_icl.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-01-16 12:19:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26204.php">Diego Avesani: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>Previous message:</strong> <a href="26202.php">George Bosilca: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>In reply to:</strong> <a href="26202.php">George Bosilca: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26204.php">Diego Avesani: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>Reply:</strong> <a href="26204.php">Diego Avesani: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>and what do you think about the previous post?
<br>
<p>Thanks again
<br>
<p>Diego
<br>
<p><p>On 16 January 2015 at 18:11, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; You could but you don&#226;&#128;&#153;t need to. The datatype engine of Open MPI is doing
</span><br>
<span class="quotelev1">&gt; a fair job of packing/unpacking the data on the flight, so you don&#226;&#128;&#153;t have
</span><br>
...
<span class="quotelev1">&gt; On Jan 16, 2015, at 11:32 , Diego Avesani &lt;diego.avesani_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; I send 50 element of QQ. I am in fortran so a two dimensional array is
</span><br>
<span class="quotelev2">&gt;&gt; organized in a 1D array and a new row start after the 9 elements of a colum
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; On 16 January 2015 at 16:02, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The operation you describe is a pack operation, agglomerating together
</span><br>
<span class="quotelev3">&gt;&gt;&gt; in a contiguous buffer originally discontinuous elements. As a result there
</span><br>
<span class="quotelev3">&gt;&gt;&gt; is no need to use the MPI_TYPE_VECTOR, but instead you can just use the
</span><br>
<span class="quotelev3">&gt;&gt;&gt; type you created so far (MPI_my_STRUCT) with a count.
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On Fri, Jan 16, 2015 at 5:32 AM, Diego Avesani &lt;diego.avesani_at_[hidden]&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'm sorry to insist, but I am not able to understand. Moreover, I have
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; realized that I have to explain myself better.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I *DATASEND* is a   *MPI_my_STRUCT.* I can allocate it according to
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the number of particles that I have to send:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; This means that the number of particles which I have to send can change
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; every time.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; After that, I compute for each particles, somethins called QQmls(:,:,:).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; QQmls has all real elements. Now I would like to to the same that I did
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; with PART, but in this case:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; *icount=1*
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;  The subarray creation is an multi-dimension extension of the vector
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; type. You can see it as a vector of vector of vector and so on, one vector
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; per dimension. The stride array is used to declare on each dimension what
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; is the relative displacement (in number of elements) from the beginning of
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the dimension array.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt; &gt; There are good examples in the &quot;MPI - The complete reference&quot; books
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I suggested to you before (actually in vol 1).
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt; &gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt; &gt; There is a very simple 2D example of MPI_Type_vector using strides
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;    MPI_Type_Struct works well for the first part of my problem, so
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt; &gt;&gt;    Indeed, using the subarray is the right approach independent on
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;        [They cover MPI 1 and 2. I guess there is a new/upcoming
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; book
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            I would like to sent form a CPU to another part of it,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; for
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            example,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            sending QQMLS(:,50:100,:). I mean sending the QQMLS of
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            particles
...
<p><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26203/attachment">attachment</a>
</ul>
