...
?>
<!-- received="Fri Jan 16 13:20:04 2015" -->
<!-- isoreceived="20150116182004" -->
<!-- sent="Fri, 16 Jan 2015 19:20:03 +0100" -->
<!-- isosent="20150116182003" -->
<!-- name="Diego Avesani" -->
<!-- email="diego.avesani_at_[hidden]" -->
<!-- subject="Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous" -->
<!-- id="CAG8o1y6TMNP8ad=A9Ps8XrRGxuWxwx1afYx9qYArXJvHYse1Fw_at_mail.gmail.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="CAG8o1y5U+J7c4dDoJMO4w7nw8_X6aPy--A3Nuo+09u7rLUGmRg_at_mail.gmail.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-01-16 13:20:03
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26205.php">Diego Avesani: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>Previous message:</strong> <a href="26203.php">Diego Avesani: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>In reply to:</strong> <a href="26203.php">Diego Avesani: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26205.php">Diego Avesani: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>Reply:</strong> <a href="26205.php">Diego Avesani: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>What do you think of it? is it correct?
<br>
The idea is to build a 2D data_type, to sent 3D data
<br>
<p>Diego
<br>
<p><p>On 16 January 2015 at 18:19, Diego Avesani &lt;diego.avesani_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Dear George, Dear All,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; and what do you think about the previous post?
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev1">&gt; On 16 January 2015 at 18:11, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; You could but you don&#226;&#128;&#153;t need to. The datatype engine of Open MPI is doing
</span><br>
<span class="quotelev2">&gt;&gt; a fair job of packing/unpacking the data on the flight, so you don&#226;&#128;&#153;t have
</span><br>
...
<span class="quotelev2">&gt;&gt; On Jan 16, 2015, at 11:32 , Diego Avesani &lt;diego.avesani_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; Could I use  MPI_PACK?
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; On 16 January 2015 at 16:26, Diego Avesani &lt;diego.avesani_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt;&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev3">&gt;&gt;&gt; I have been studying. It's clear for 2D case QQ(:,:).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; For example if
</span><br>
<span class="quotelev3">&gt;&gt;&gt; real :: QQ(npt,9) , with 9 the characteristic of each particles.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I can simple:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;  call MPI_TYPE_VECTOR(QQ(1:50), 9, 9, MPI_REAL,  my_2D_type, ierr)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I send 50 element of QQ. I am in fortran so a two dimensional array is
</span><br>
<span class="quotelev3">&gt;&gt;&gt; organized in a 1D array and a new row start after the 9 elements of a colum
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; The problem is a 3D array. I belive that I have to create a sort of *vector
</span><br>
<span class="quotelev3">&gt;&gt;&gt; of vectors.*
</span><br>
<span class="quotelev3">&gt;&gt;&gt; More or less like:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; call MPI_TYPE_VECTOR(xxx, xxx, xxx, MPI_REAL,  my_row, ierr)
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; call MPI_TYPE_VECTOR(xxx, xxx, xxx, *my_row*,  my_type, ierr).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; You can note that in the second case I have  *my_row *instead of
</span><br>
<span class="quotelev3">&gt;&gt;&gt; mpi_real.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; I found somethind about it in a tutorial but I am not able to find it
</span><br>
<span class="quotelev3">&gt;&gt;&gt; again in google. I think that is not convinient the use of struct in this
</span><br>
<span class="quotelev3">&gt;&gt;&gt; case, I have only real. Moreover, mpi_struct is think to emulate
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Fortran90 and C structures, as Gus' suggestion.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Let's me look to that tutorial
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 16 January 2015 at 16:02, George Bosilca &lt;bosilca_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; The operation you describe is a pack operation, agglomerating together
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; in a contiguous buffer originally discontinuous elements. As a result there
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; is no need to use the MPI_TYPE_VECTOR, but instead you can just use the
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; type you created so far (MPI_my_STRUCT) with a count.
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On Fri, Jan 16, 2015 at 5:32 AM, Diego Avesani &lt;diego.avesani_at_[hidden]
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I try to explain in may program. Each CPU has *npt* particles. My
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; program understand how many particles each CPU has to send, according to
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; their positions. Then I can do:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; This means that the number of particles which I have to send can
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; change every time.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; After that, I compute for each particles, somethins called
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; QQmls(:,:,:).
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; QQmls has all real elements. Now I would like to to the same that I
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; did with PART, but in this case:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; *icount=1*
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; *MPI_my_STRUCT**) *and not to create every time *MPI_TYPE_VECTOR *
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; because  *DATASEND_REAL *changes size every time.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; On 16 January 2015 at 07:39, George Bosilca &lt;bosilca_at_[hidden]&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; It is important to use regular type creation when you can take
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; advantage of such regularity instead of resorting to use of struct or h*.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; This insure better packing/unpacking performance, as well as possible
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; future support for one-sided communications.
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; George.
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; On Jan 15, 2015, at 19:31, Gus Correa &lt;gus_at_[hidden]&gt;
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt;
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; There are good examples in the &quot;MPI - The complete reference&quot; books
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; I suggested to you before (actually in vol 1).
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt;
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt; &gt; There is a very simple 2D example of MPI_Type_vector using strides
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;    On Jan 15, 2015, at 06:02 , Diego Avesani &lt;
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;    MPI_Type_Struct works well for the first part of my problem,
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;    does (at least I believe). Foe example if I have a matrix
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; define as:
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;    Indeed, using the subarray is the right approach independent on
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;        I guess MPI_Type_Vector is the natural way to send and
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;        Also, MPI type vector should be more easy going (and
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;        PS - These books have a quite complete description and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; several
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;        examples
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;        of all MPI objects and functions, including MPI types
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; (native
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;        [They cover MPI 1 and 2. I guess there is a new/upcoming
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; book
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            I had some wonderful talking about
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; MPI_type_create_struct adn
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            Now I have another question. In may program I have
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            I would like to sent form a CPU to another part of it,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; for
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            example,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            sending QQMLS(:,50:100,:). I mean sending the QQMLS of
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            particles
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt; &gt;&gt;&gt;            particle that I want to sent could be from 25 to 50
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; ecc..
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/01/26199.php">http://www.open-mpi.org/community/lists/users/2015/01/26199.php</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
...
<span class="quotelev2">&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/01/26201.php">http://www.open-mpi.org/community/lists/users/2015/01/26201.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; <a href="http://www.open-mpi.org/community/lists/users/2015/01/26202.php">http://www.open-mpi.org/community/lists/users/2015/01/26202.php</a>
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev1">&gt;
...
<br><hr>
<ul>
<li>text/html attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26204/attachment">attachment</a>
</ul>
<!-- attachment="attachment" -->
<hr>
<ul>
<li>text/x-fortran attachment: <a href="http://www.open-mpi.org/community/lists/users/att-26204/test_2Darray_send.f90">test_2Darray_send.f90</a>
</ul>
<!-- attachment="test_2Darray_send.f90" -->
<!-- body="end" -->
<hr>
<ul class="links">
<!-- next="start" -->
