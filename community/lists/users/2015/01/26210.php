...
?>
<!-- received="Fri Jan 16 17:23:55 2015" -->
<!-- isoreceived="20150116222355" -->
<!-- sent="Fri, 16 Jan 2015 17:23:47 -0500" -->
<!-- isosent="20150116222347" -->
<!-- name="Gus Correa" -->
...
<!-- id="54B98F73.5050309_at_ldeo.columbia.edu" -->
<!-- charset="utf-8" -->
<!-- inreplyto="00C34951-7C8A-40B6-98D2-BF9913C78476_at_icl.utk.edu" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2015-01-16 17:23:47
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26211.php">Diego Avesani: "Re: [OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>Previous message:</strong> <a href="26209.php">Jeff Squyres (jsquyres): "Re: [OMPI users] Problem with connecting to 3 or more nodes"</a>
<li><strong>In reply to:</strong> <a href="26208.php">George Bosilca: "Re: [OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26211.php">Diego Avesani: "Re: [OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>Reply:</strong> <a href="26211.php">Diego Avesani: "Re: [OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>Reply:</strong> <a href="26212.php">George Bosilca: "Re: [OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi George
<br>
<p>Many thanks for your answer and interest in my questions.
<br>
... so ... more questions inline ...
<br>
<p>On 01/16/2015 03:41 PM, George Bosilca wrote:
<br>
<span class="quotelev1">&gt; Gus,
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Please see my answers inline.
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt; It is still not clear to me how to deal with strides in MPI_Create_type_subarray.
</span><br>
<span class="quotelev2">&gt;&gt; The function/subroutine interface doesn&#226;&#128;&#153;t mention strides at all.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; That&#226;&#128;&#153;s indeed a little tricky.
</span><br>
<span class="quotelev1">&gt; However, the trick here is that when you try to understand the subarray
</span><br>
<span class="quotelev1">&gt; type you should think recursively about the datatypes involved in the operation.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev2">&gt;&gt; It is a pity that there is little literature (books) about MPI,
</span><br>
<span class="quotelev2">&gt;&gt; and the existing books are lagging behind the new MPI developments and standards (MPI-2, MPI-3).
</span><br>
<span class="quotelev2">&gt;&gt; My most reliable sources so far were the &quot;MPI - The complete reference&quot; books, vol-1 (2nd ed.) and vol-2 (which presumably covers MPI-2).
</span><br>
<span class="quotelev2">&gt;&gt; However, they do not even mention MPI_Create_type_subarray,
</span><br>
<span class="quotelev2">&gt;&gt; which is part of the MPI-2 standard.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Let me do a wild guess: you two guys must be the firsts to ask questions about it &#226;&#128;&#166;
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p>Did anybody but the MPI developers actually *used* MPI_Create_type_subarray?
<br>
Could this explain the scarcity of questions about it?  :)
<br>
<p><span class="quotelev2">&gt;&gt; I found it in the MPI-2 standard on the web, but it is not clear to me
</span><br>
<span class="quotelev2">&gt;&gt; how to achieve the same effect of strides that are available in MPI_Type_vector.
</span><br>
<span class="quotelev2">&gt;&gt; MPI_Create_type_subarray is in section 4.1.3.
</span><br>
<span class="quotelev2">&gt;&gt; The OMPI MPI_Create_type_subarray man page says there is an example in section 9.9.2 of the MPI-2 standard.
</span><br>
<span class="quotelev2">&gt;&gt; However, there is no section 9.9.2.
</span><br>
<span class="quotelev2">&gt;&gt; Chapter 9 is about something else (&quot;The info object&quot;), not derived types.
</span><br>
<span class="quotelev2">&gt;&gt; No good example of MPI_Create_type_subarray in section 4.1.3 either,
</span><br>
<span class="quotelev2">&gt;&gt; which is written in the typical terse and hermetic style in which
</span><br>
<span class="quotelev2">&gt;&gt; standards are.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; No comments on subjective topics &#226;&#128;&#166; ;)
</span><br>
<p>It flows almost as smoothly as Backus-Naur prose.
<br>
Makes a great reading with some Mozart in the background.
<br>
<p><span class="quotelev1">&gt; You just blew my day away, I was totally under the impression that the
</span><br>
<span class="quotelev1">&gt; MPI standard reads like a children&#226;&#128;&#153;s bedtime story book !!!
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p><p>Did you write it?
<br>
Do you read it for your kids at bed time?
<br>
Do they fall asleep right away?
<br>
<p>Oh, if AEsop, Grimm Brothers, Charles Perrault, Andersen could only have 
<br>
helped as copy-desks ...
<br>
<p><p><span class="quotelev2">&gt;&gt; So, how can one handle strides in MPI_Create_type_subarray?
</span><br>
<span class="quotelev2">&gt;&gt; Would one have to first create several MPI_Type_vector for the various dimensions, then use them as &quot;oldtype&quot; in  MPI_Create_type_subarray?
</span><br>
<span class="quotelev2">&gt;&gt; That sounds awkward, because there is only one &#226;&#128;&#156;oldtype&quot; in MPI_Create_type_subarray, not one for each dimension.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Exactly. Take a look at how we handle the subarray in Open MPI,
</span><br>
<span class="quotelev1">&gt; more precisely at the file ompi/datatype/ompi_datatype_create_subarray.c.
</span><br>
<span class="quotelev1">&gt; My comment from few days ago referred exactly to this code, where the
</span><br>
<span class="quotelev1">&gt; subarray is basically described in terms of vector
</span><br>
<span class="quotelev1">&gt; (well maybe vector as I was lazy to check the LB/UB).
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p>When documentation equates to reading actual function code ...
<br>
... that is when users drop trying to use new developments ...
<br>
<p>BTW, ominously a bug report on LB/UB misuse in MPI_Type_struct
<br>
*and* in  MPI_Type_create_subarray ... gosh ...
<br>
<p><a href="http://lists.mpich.org/pipermail/discuss/2015-January/003608.html">http://lists.mpich.org/pipermail/discuss/2015-January/003608.html</a>
<br>
<p>But hopefully that doesn't affect Open MPI, right?
<br>
<p><span class="quotelev1">&gt; As I said above think recursively.
</span><br>
<span class="quotelev1">&gt; You start with the old type,
</span><br>
<span class="quotelev1">&gt; then build another try on a dimension,
</span><br>
<span class="quotelev1">&gt; then you use this to expose the second dimensions and so on.
</span><br>
<span class="quotelev1">&gt; For each dimension your basic type is not the user provided old type,
</span><br>
<span class="quotelev1">&gt; but the type you built so far.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; - size_array[i] is the number of elements in big data in the dimension i
</span><br>
<span class="quotelev1">&gt; - subsize_array[i] is the of element you will include in your datatype in the dimension i
</span><br>
<span class="quotelev1">&gt; - start_array[i] is how many elements you will skip in the dimension i before you start including them in your datatype. start[i] + subside[i] must be smaller or equal to size[i]
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p>OK, that starts to make more sense than the yawning bedtime story
<br>
in the MPI-2 standard.
<br>
<p>I should peel off (that would be recursive)
<br>
...
<br>
<p>In which regard is this any better than using MPI_Type_Vector,
<br>
which can be setup in a single non-recursive call,
<br>
as long as the sizes, strides, etc, are properly calculated?
<br>
<p><span class="quotelev2">&gt;&gt; Is there any simple example of how to achieve  stride effect with
</span><br>
<span class="quotelev2">&gt;&gt; MPI_Create_type_subarray in a multi-dimensional array?
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Not as far as I know.
</span><br>
<span class="quotelev1">&gt; But now that people expressed interest in this topic,
</span><br>
<span class="quotelev1">&gt; maybe someone will write a blog or something about.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p>An example, just a simple example ...
<br>
...
<br>
<p>Well, even if it is on a blog ...
<br>
...
<br>
<p><span class="quotelev2">&gt;&gt; BTW, when are you gentlemen going to write an updated version of the
</span><br>
<span class="quotelev2">&gt;&gt; &#226;&#128;&#156;MPI - The Complete Reference&quot;?  :)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; Maybe after the release of MPI 4.0 would be a good target &#226;&#128;&#166;
</span><br>
<p>Not any sooner than that?
<br>
...
the examples?
<br>
<p><span class="quotelev1">&gt; A lot of new and exciting technologies will hopefully be going in by then,
</span><br>
<p>... which won't be used if people don't get the word about them,
<br>
on how to use them effectively ... please, don't let MPI-3-4-5-6-
<br>
become a [MPI-]chat only amongst the [[[&gt;&gt;&gt;MPI developers&lt;&lt;&lt;]]] ...
<br>
<p><span class="quotelev1">&gt; writing a new book might be worth the effort.
</span><br>
<span class="quotelev1">&gt;
</span><br>
<p>Always worth it, with examples, etc.
<br>
...
<span class="quotelev2">&gt;&gt; (Hijacking Diego Avesani's thread, apologies to Diego.)
</span><br>
<span class="quotelev2">&gt;&gt; (Also, I know this question is not about Open MPI, but about MPI in general.  But the lack of examples may warrant asking the question here.)
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt; On 01/16/2015 01:39 AM, George Bosilca wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;   The subarray creation is an multi-dimension extension of the vector type.
</span><br>
<span class="quotelev2">&gt;&gt; You can see it as a vector of vector of vector and so on, one vector per dimension.
</span><br>
<span class="quotelev2">&gt;&gt; The stride array is used to declare on each dimension what is the relative displacement
</span><br>
<span class="quotelev2">&gt;&gt; (in number of elements) from the beginning of the dimension array.
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; It is important to use regular type creation when you can take advantage of such
</span><br>
<span class="quotelev2">&gt;&gt; regularity instead of resorting to use of struct or h*. This insure better
</span><br>
<span class="quotelev2">&gt;&gt; packing/unpacking performance, as well as possible future support for one-sided
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Somebody correct me please if I am wrong, but at first sight MPI_Type_Vector sounds more flexible to me than MPI_Type_create_subarray, exactly because the latter doesn't have strides.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; There are good examples in the &quot;MPI - The complete reference&quot; books I suggested to you before (actually in vol 1).
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Online I could find the two man pages (good information, but no example):
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; There is a very simple 2D example of MPI_Type_vector using strides here:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/01/26194.php">http://www.open-mpi.org/community/lists/users/2015/01/26194.php</a>
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/01/26195.php">http://www.open-mpi.org/community/lists/users/2015/01/26195.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev2">&gt;&gt;
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/01/26206.php">http://www.open-mpi.org/community/lists/users/2015/01/26206.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; _______________________________________________
...
<span class="quotelev1">&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/users/2015/01/26208.php">http://www.open-mpi.org/community/lists/users/2015/01/26208.php</a>
</span><br>
<span class="quotelev1">&gt;
</span><br>
<!-- body="end" -->
