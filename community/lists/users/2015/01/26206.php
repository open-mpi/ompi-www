<?
$subject_val = "[OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous";
include("../../include/msg-header.inc");
?>
<!-- received="Fri Jan 16 14:24:17 2015" -->
<!-- isoreceived="20150116192417" -->
<!-- sent="Fri, 16 Jan 2015 14:24:09 -0500" -->
<!-- isosent="20150116192409" -->
<!-- name="Gus Correa" -->
<!-- email="gus_at_[hidden]" -->
<!-- subject="[OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous" -->
<!-- id="54B96559.7080201_at_ldeo.columbia.edu" -->
...
<p class="headers">
<strong>Subject:</strong> [OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous<br>
<strong>From:</strong> Gus Correa (<em>gus_at_[hidden]</em>)<br>
<strong>Date:</strong> 2015-01-16 14:24:09
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="26207.php">Chan, Elbert: "[OMPI users] Problem with connecting to 3 or more nodes"</a>
<li><strong>Previous message:</strong> <a href="26205.php">Diego Avesani: "Re: [OMPI users] MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="26208.php">George Bosilca: "Re: [OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<li><strong>Reply:</strong> <a href="26208.php">George Bosilca: "Re: [OMPI users] How to handle strides in MPI_Create_type_subarray - Re: MPI_type_create_struct + MPI_Type_vector + MPI_Type_contiguous"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
Hi George
<br>
<p>It is still not clear to me how to deal with strides in 
<br>
MPI_Create_type_subarray.
<br>
The function/subroutine interface doesn't mention strides at all.
<br>
<p>It is a pity that there is little literature (books) about MPI,
<br>
...
<br>
<p>I found it in the MPI-2 standard on the web, but it is not clear to me
<br>
...
standards are.
<br>
<p>So, how can one handle strides in MPI_Create_type_subarray?
<br>
...
<br>
<p>Is there any simple example of how to achieve  stride effect with
<br>
MPI_Create_type_subarray in a multi-dimensional array?
<br>
<p>BTW, when are you gentlemen going to write an updated version of the
<br>
...
<br>
<p><p>On 01/16/2015 01:39 AM, George Bosilca wrote:
<br>
