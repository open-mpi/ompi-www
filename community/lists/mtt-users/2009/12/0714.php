<?
$subject_val = "Re: [MTT users] [OMPI users] MTT -trivial :All tests are not getting passed";
...
<!-- subject="Re: [MTT users] [OMPI users] MTT -trivial :All tests are not getting passed" -->
...
<p class="headers">
<strong>Subject:</strong> Re: [MTT users] [OMPI users] MTT -trivial :All tests are not getting passed<br>
<strong>From:</strong> Ethan Mallove (<em>ethan.mallove_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-12-22 09:12:34
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0715.php">vishal shorghar: "[MTT users] [Fwd: MTT -trivial :All tests are not getting passed]"</a>
<li><strong>Previous message:</strong> <a href="0713.php">Jeff Squyres: "[MTT users] Fwd: [OMPI users] MTT trivial test is getting failed:"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
