...
?>
<!-- received="Fri Nov 20 10:44:38 2009" -->
<!-- isoreceived="20091120154438" -->
<!-- sent="Fri, 20 Nov 2009 10:44:29 -0500" -->
<!-- isosent="20091120154429" -->
<!-- name="Ethan Mallove" -->
<!-- email="ethan.mallove_at_[hidden]" -->
<!-- subject="Re: [MTT users] MTT trivial tests failstocomplete" -->
<!-- id="20091120154428.GL53339_at_sun.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="8A71B368A89016469F72CD08050AD33406D9D13C_at_maui.asicdesigners.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-11-20 10:44:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0711.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests failstocomplete"</a>
<li><strong>Previous message:</strong> <a href="0709.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests failstocomplete"</a>
<li><strong>In reply to:</strong> <a href="0709.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests failstocomplete"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0711.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests failstocomplete"</a>
<li><strong>Reply:</strong> <a href="0711.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests failstocomplete"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt;     MTT::Values::Functions::if(MTT::Values::Functions::have_hostfile(),
</span><br>
...
<span class="quotelev2">&gt; &gt; *** ERROR: Syntax error in stdin: Line 36 in file /tmp/UqPeD61ett.ini
</span><br>
...
<span class="quotelev2">&gt; &gt; Attached are the new developer.ini and the /tmp/UqPeD61ett.ini files.
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
...
<span class="quotelev2">&gt; &gt; That developer.ini file is out-of-date. Can you &quot;svn update&quot;, and try
</span><br>
...
<span class="quotelev4">&gt; &gt; &gt; &gt;    Linux 2.6.18-128.el5 #1 SMP Wed Jan 21 10:41:14 EST 2009 x86_64
</span><br>
...
<span class="quotelev1">&gt; /root/mtt-svn/samples/MPI_Install-my_installation-my_installation-1.3.2.
</span><br>
...
<span class="quotelev3">&gt; &gt; &gt; /root/mtt-svn/samples/Test_Build-trivial-my_installation-1.3.2.html
</span><br>
<span class="quotelev4">&gt; &gt; &gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; &gt; &gt;     &gt;&gt; Reported to text file
...
<span class="quotelev1">&gt; Making dir: /root/mtt-svn/samples/installs (cwd: /root/mtt-svn/samples)
</span><br>
<span class="quotelev1">&gt; Making dir: /root/mtt-svn/samples/test_runs (cwd: /root/mtt-svn/samples)
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef23540) MTT save_fast_scratch_files
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef23540) MTT before_all_exec_timeout
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef23540) MTT before_each_exec_timeout
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef23540) MTT after_all_exec_timeout
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef23540) MTT after_each_exec_timeout
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) reporter: text file backup
</span><br>
...
<span class="quotelev1">&gt;    uname: Linux mughal 2.6.18-128.el5 #1 SMP Wed Jan 21 10:41:14 EST 2009
</span><br>
...
<span class="quotelev1">&gt; Making dir: mpi_get__my_installation (cwd: /root/mtt-svn/samples/sources)
</span><br>
...
<span class="quotelev1">&gt; *** WARNING: alreadyinstalled_mpi_type was not specified, defaulting to
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) mpi install: my installation
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef23540) reporter: text file backup
</span><br>
...
<span class="quotelev1">&gt;    /root/mtt-svn/samples/MPI_Install-my_installation-my_installation-1.3.2.tx
</span><br>
<span class="quotelev1">&gt;    t
</span><br>
<span class="quotelev1">&gt; Writing to text file:
</span><br>
<span class="quotelev1">&gt;    /root/mtt-svn/samples/MPI_Install-my_installation-my_installation-1.3.2.ht
</span><br>
<span class="quotelev1">&gt;    ml
</span><br>
<span class="quotelev3">&gt; &gt;&gt; Reported to text file
</span><br>
<span class="quotelev1">&gt;   /root/mtt-svn/samples/MPI_Install-my_installation-my_installation-1.3.2.htm
</span><br>
...
<span class="quotelev1">&gt;   /root/mtt-svn/samples/MPI_Install-my_installation-my_installation-1.3.2.txt
</span><br>
<span class="quotelev1">&gt; Writing to text file:
</span><br>
<span class="quotelev1">&gt;    /root/mtt-svn/samples/MPI_Install-my_installation-my_installation-1.3.2.ht
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test get: trivial skip_section
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test get: trivial unsetenv
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test get: trivial prepend_path
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test get: trivial append_path
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Chdir /root/mtt-svn/samples/sources
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test build: trivial test_get
</span><br>
<span class="quotelev1">&gt; Value returning: trivial
</span><br>
<span class="quotelev1">&gt; Global min free specified as: 5%, resolved as 2539267072
...
<span class="quotelev1">&gt;    Building for [my installation] / [1.3.2] / [my installation] / [trivial]
</span><br>
<span class="quotelev1">&gt; Chdir /root/mtt-svn/samples/installs
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test build: trivial module
</span><br>
<span class="quotelev1">&gt; Value returning: Trivial
</span><br>
...
<span class="quotelev3">&gt; &gt;&gt; copytree copying to /root/mtt-svn/samples/installs/qwaS/tests/trivial
</span><br>
<span class="quotelev1">&gt; Chdir /root/mtt-svn/samples/installs/qwaS/tests/trivial
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test build: trivial env_module
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test build: trivial
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test build: trivial setenv
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test build: trivial unsetenv
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test build: trivial
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial test_build
</span><br>
<span class="quotelev1">&gt; Value returning: trivial
</span><br>
<span class="quotelev1">&gt; Global min free specified as: 5%, resolved as 2539267072
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial skip_mpi_get
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial skip_section
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial
...
<span class="quotelev1">&gt; Chdir /root/mtt-svn/samples/installs/qwaS/tests/trivial/test_get__trivial
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial env_module
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial env_importer
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
...
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial unsetenv
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial prepend_path
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial append_path
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) test run: trivial description
</span><br>
<span class="quotelev1">&gt; Value returning: 
</span><br>
<span class="quotelev1">&gt; Value got: Config::IniFiles=HASH(0x1ef499a0) MTT description
