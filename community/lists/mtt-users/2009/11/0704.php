<?
$subject_val = "Re: [MTT users] MTT trivial tests fails to complete on	Centos5.3-x86_64 bit platform with OFED 1.5";
include("../../include/msg-header.inc");
?>
<!-- received="Wed Nov 18 14:41:30 2009" -->
<!-- isoreceived="20091118194130" -->
<!-- sent="Wed, 18 Nov 2009 14:41:25 -0500" -->
<!-- isosent="20091118194125" -->
<!-- name="Ethan Mallove" -->
<!-- email="ethan.mallove_at_[hidden]" -->
<!-- subject="Re: [MTT users] MTT trivial tests fails to complete on	Centos5.3-x86_64 bit platform with OFED 1.5" -->
<!-- id="20091118194125.GI53339_at_sun.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="8A71B368A89016469F72CD08050AD33406D9CE00_at_maui.asicdesigners.com" -->
<!-- expires="-1" -->
<div class="center">
...
<p class="headers">
<strong>Subject:</strong> Re: [MTT users] MTT trivial tests fails to complete on	Centos5.3-x86_64 bit platform with OFED 1.5<br>
<strong>From:</strong> Ethan Mallove (<em>ethan.mallove_at_[hidden]</em>)<br>
<strong>Date:</strong> 2009-11-18 14:41:25
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0705.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests fails to completeon	Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<li><strong>Previous message:</strong> <a href="0703.php">Venkat Venkatsubra: "[MTT users] MTT trivial tests fails to complete on Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<li><strong>In reply to:</strong> <a href="0703.php">Venkat Venkatsubra: "[MTT users] MTT trivial tests fails to complete on Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0705.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests fails to completeon	Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<li><strong>Reply:</strong> <a href="0705.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests fails to completeon	Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev1">&gt;    Subject: MTT trivial tests fails to complete on Centos5.3-x86_64 bit
</span><br>
...
<span class="quotelev1">&gt;    Linux 2.6.18-128.el5 #1 SMP Wed Jan 21 10:41:14 EST 2009 x86_64 x86_64
</span><br>
...
<span class="quotelev1">&gt;    [root_at_samples]# cat developer.ini trivial.ini | ../client/mtt --verbose -
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt;    ....
...
<span class="quotelev1">&gt;     audispd invoked oom-killer: gfp_mask=0x201d2, order=0, oomkilladj=0
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; 
