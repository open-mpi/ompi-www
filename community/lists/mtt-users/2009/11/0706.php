...
?>
<!-- received="Thu Nov 19 09:35:44 2009" -->
<!-- isoreceived="20091119143544" -->
<!-- sent="Thu, 19 Nov 2009 09:35:39 -0500" -->
<!-- isosent="20091119143539" -->
<!-- name="Ethan Mallove" -->
<!-- email="ethan.mallove_at_[hidden]" -->
<!-- subject="Re: [MTT users] MTT trivial tests fails to completeon	Centos5.3-x86_64 bit platform with OFED 1.5" -->
<!-- id="20091119143539.GJ53339_at_sun.com" -->
<!-- charset="us-ascii" -->
<!-- inreplyto="8A71B368A89016469F72CD08050AD33406D9CE4E_at_maui.asicdesigners.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2009-11-19 09:35:39
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0707.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests fails tocompleteon Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<li><strong>Previous message:</strong> <a href="0705.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests fails to completeon	Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<li><strong>In reply to:</strong> <a href="0705.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests fails to completeon	Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0707.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests fails tocompleteon Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<li><strong>Reply:</strong> <a href="0707.php">Venkat Venkatsubra: "Re: [MTT users] MTT trivial tests fails tocompleteon Centos5.3-x86_64 bit platform with OFED 1.5"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<span class="quotelev2">&gt; &gt;        Using MPI Details [open mpi] with MPI Install [my installation]
</span><br>
<span class="quotelev2">&gt; &gt; 
</span><br>
<span class="quotelev2">&gt; &gt; 
