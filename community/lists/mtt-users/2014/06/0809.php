...
?>
<!-- received="Tue Jun 10 10:46:14 2014" -->
<!-- isoreceived="20140610144614" -->
<!-- sent="Tue, 10 Jun 2014 14:46:12 +0000" -->
<!-- isosent="20140610144612" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [MTT users] To run MTT on our cluster" -->
<!-- id="9E600B9D-E2EA-45BC-99EB-E6ECC3F9C0F2_at_cisco.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="3CADC31A-354E-4ACF-A087-1E768BB5238D_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-10 10:46:12
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0810.php">Ralph Castain: "Re: [MTT users] To run MTT on our cluster"</a>
<li><strong>Previous message:</strong> <a href="0808.php">Ralph Castain: "Re: [MTT users] To run MTT on our cluster"</a>
<li><strong>In reply to:</strong> <a href="0808.php">Ralph Castain: "Re: [MTT users] To run MTT on our cluster"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0810.php">Ralph Castain: "Re: [MTT users] To run MTT on our cluster"</a>
<li><strong>Reply:</strong> <a href="0810.php">Ralph Castain: "Re: [MTT users] To run MTT on our cluster"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
<p>
Sorry for the delay in replying -- I was at the MPI Fourm last week, and my available time for email was limited.
<br>
<p>So I think there's three issues on the table:
<br>
<p>1. Access to the closed ompi-tests SVN repo
<br>
2. Access to some example MTT .ini files
<br>
3. Submitting data to mtt.open-mpi.org
<br>
<p>Forgive me -- as you'll see below, you're raising a corner case that we have not previously encountered...
<br>
<p>Can I ask what your intentions are?  We typically haven't given access to #1 or #3 except to developer organizations in the Open MPI community itself (signing the IP agreement is the first step).  This is not to say that we won't -- it's just that you happen to be the first organization who has expressed a more-than-passing interest in #1 and #3 :-), but you do not appear to be interested in becoming a contributor or member Open MPI organization.  We haven't really thought about this case before.
<br>
<p>I'd like to reiterate two points:
<br>
<p>1. You don't need to sign the Open MPI IP agreement to use MTT; MTT is open source software that anyone can freely use under the BSD license.
<br>
2. Most of the tests in the ompi-tests repo are publicly available; we just don't have redistribution rights (which is why our repo is closed).  We have augmented these publicly-available test suites with a bunch of home-grown tests, too, but I don't know if they're generally useful outside of Open MPI (i.e., some test for specific Open MPI behavior).
<br>
<p>Also, I don't think I was specific about this before, but submitting data to mtt.open-mpi.org is intended for tracking the nightly development tarballs.  It's not meant as a general MTT database hosting platform for individual organizations' internal testing.
<br>
<p>So I guess my questions are:
<br>
<p>1. Do you really want/need access to our SVN repo, or do you just want/need a list of the test suites that you can download from the internet yourself?
<br>
<p>2. Do you intend to test nightly Open MPI tarballs?
<br>
<p>Thanks for your patience in helping us think through the issues; this is what happens when you happen to be first.  :-)
<br>
<p><p><p>On Jun 2, 2014, at 8:22 PM, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
<br>
