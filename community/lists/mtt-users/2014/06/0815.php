...
?>
<!-- received="Fri Jun 13 17:51:45 2014" -->
<!-- isoreceived="20140613215145" -->
<!-- sent="Fri, 13 Jun 2014 21:51:42 +0000" -->
<!-- isosent="20140613215142" -->
<!-- name="Jeff Squyres (jsquyres)" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [MTT users] To run MTT on our cluster" -->
<!-- id="E353669E-A78B-4CFB-BB04-7DE5F4A3B5AA_at_cisco.com" -->
<!-- charset="Windows-1252" -->
<!-- inreplyto="0EAC73ED-1751-482D-BF10-0F4AA7C66A1B_at_auckland.ac.nz" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2014-06-13 17:51:42
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="http://www.open-mpi.org/community/lists/mtt-users/2014/08/0816.php">Adrian Reber: "[MTT users] MTT on PPC64"</a>
<li><strong>Previous message:</strong> <a href="0814.php">Jaison Mulerikkal: "Re: [MTT users] To run MTT on our cluster"</a>
<li><strong>In reply to:</strong> <a href="0814.php">Jaison Mulerikkal: "Re: [MTT users] To run MTT on our cluster"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="http://www.open-mpi.org/community/lists/mtt-users/2014/05/0806.php">Jeff Squyres (jsquyres): "Re: [MTT users] To run MTT on our cluster"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>I'll email you off-list with the read-only SVN URL and password.
<br>
<p><p><p>On Jun 12, 2014, at 5:49 PM, Jaison Mulerikkal &lt;j.mulerikkal_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Hi Ralph,
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; You are pointing in the right direction. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; If you can grant us &quot;read access to ompi-tests without granting write permissions to the entire OMPI repo&#148; will be perfect. We got better confidence in you than anyone else with choosing and maintaining those tests! We shall dumb the results to a our own folder and analyse using some in-house custom tools.
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; Please let me know how can I get read access to those ompi-tests. 
</span><br>
<span class="quotelev1">&gt; 
</span><br>
...
<span class="quotelev1">&gt; On 13/06/2014, at 3:02 am, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Hi Jaison
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; Sounds to me like reporting the results into our database wouldn't be particularly useful for either side. We don't have great visualization support for what you have in mind - we just show failures etc, and the reporting tool is really geared towards testing of nightly tarballs. I suspect you'd be disappointed in it for this purpose.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; It sounds to me like your best solution would be to use MTT to run your tests, but tell it to dump the results into a file for you to examine or post-process with a custom tool as the output format is pretty machine-friendly.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; As for the tests themselves, I think I'd leave that up to you. As Jeff said, we just collected these from various places and there isn't anything &quot;proprietary&quot; about them. I will admit that we did (a) integrate them into MTT a bit, and (b) do a fair amount of cleanup as some of the tests were just plain wrong. We haven't pushed any of those corrections back to the source, so we *might* have something more correct? Hard to say as I don't believe we have ever gone back to the source and checked for updates on their side.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; If you want access to them, I'd have to defer to Jeff to see if we could perhaps grant read access to ompi-tests without granting write permissions to the entire OMPI repo. I don't think that would be appropriate in this situation.
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
...
<span class="quotelev2">&gt;&gt; On Jun 10, 2014, at 4:40 PM, Jaison Mulerikkal &lt;j.mulerikkal_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hi Ralph and Jeff,
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Thanks for our replies and your willingness to help.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Our intentions are as follows:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; There are lots or customers/users that use different variants of MPI and specifically OpenMPI in our clusters. They run various interesting things with MPI/OpenMPI. Sometimes they end up with some issues as they run their programs. We spend lot of time to figure out what their problems are. Sometimes it could be because of the way we have set up our MPI modules. 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; So we need a reliable set of MPI tests/programs to run nightly or at some frequency to see that all our MPI settings are okay. I thought MTT will be a good tool to do that. I assume that you have the right set of testing programs and a way to present the results. 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; My manager thinks that he don&#146;t mind sending the results of this particular set of tests to an external server (as yours), as long as we got access to those test results and we can watch it on some visualisation tool, list, etc.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; We don't intend to test nightly Open MPI tarballs. We are using easy-build to install our libraries/apps. I think it may conflict with easy-build workflow. Or is there any way to integrate it with easy-build?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; We would like to get access to a comprehensive list of tests, that can verify the MPI/OpenMPI health of our systems.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; Hope this clarification helps. Now what do you suggest?
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; On 11/06/2014, at 11:19 am, Ralph Castain &lt;rhc_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I had a chance to think about this some more, and I'm wondering if this falls into some new category of &quot;member&quot;. Personally, I would really welcome getting the MTT results from another site as it would expand coverage of various environments, something we are beginning to lack. So even if Jaison et al aren't going to contribute code, contributing test result data is a valuable contribution in itself.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; I think this fits to your question about testing nightly OMPI tarballs. If Jaison can run tests with our tarballs and tell us the results, and that meets his needs to characterize/validate their cluster, then it seems like both sides win.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; On Jun 10, 2014, at 7:46 AM, Jeff Squyres (jsquyres) &lt;jsquyres_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Sorry for the delay in replying -- I was at the MPI Fourm last week, and my available time for email was limited.
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; 
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Subscription: <a href="http://www.open-mpi.org/mailman/listinfo.cgi/mtt-users">http://www.open-mpi.org/mailman/listinfo.cgi/mtt-users</a>
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/mtt-users/2014/06/0811.php">http://www.open-mpi.org/community/lists/mtt-users/2014/06/0811.php</a>
</span><br>
<span class="quotelev3">&gt;&gt;&gt; 
</span><br>
<span class="quotelev3">&gt;&gt;&gt; _______________________________________________
...
<span class="quotelev3">&gt;&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/mtt-users/2014/06/0813.php">http://www.open-mpi.org/community/lists/mtt-users/2014/06/0813.php</a>
</span><br>
<span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; _______________________________________________
...
<span class="quotelev2">&gt;&gt; Link to this post: <a href="http://www.open-mpi.org/community/lists/mtt-users/2014/06/0814.php">http://www.open-mpi.org/community/lists/mtt-users/2014/06/0814.php</a>
</span><br>
<span class="quotelev1">&gt; 
</span><br>
<span class="quotelev1">&gt; _______________________________________________
