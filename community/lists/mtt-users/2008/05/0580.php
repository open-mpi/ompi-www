...
?>
<!-- received="Wed May 21 14:39:53 2008" -->
<!-- isoreceived="20080521183953" -->
<!-- sent="Wed, 21 May 2008 14:39:19 -0400" -->
<!-- isosent="20080521183919" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [MTT users] Can not find my testing results in OMPI MTT DB" -->
<!-- id="D7FE0116-C58B-4FC9-BB3F-C99DB7F48AA3_at_cisco.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="20080521183614.GG51303_at_sun.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2008-05-21 14:39:19
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0581.php">Pavel Shamis (Pasha): "Re: [MTT users] Can not find my testing results in OMPI MTT DB"</a>
<li><strong>Previous message:</strong> <a href="0579.php">Ethan Mallove: "Re: [MTT users] Can not find my testing results in OMPI MTT DB"</a>
<li><strong>In reply to:</strong> <a href="0579.php">Ethan Mallove: "Re: [MTT users] Can not find my testing results in OMPI MTT DB"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0581.php">Pavel Shamis (Pasha): "Re: [MTT users] Can not find my testing results in OMPI MTT DB"</a>
<li><strong>Reply:</strong> <a href="0581.php">Pavel Shamis (Pasha): "Re: [MTT users] Can not find my testing results in OMPI MTT DB"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>On May 21, 2008, at 2:36 PM, Ethan Mallove wrote:
<br>
<p><span class="quotelev1">&gt; On Wed, May/21/2008 06:46:06PM, Pavel Shamis (Pasha) wrote:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; PHP Warning:  array_shift(): The argument should be an array  
</span><br>
<span class="quotelev3">&gt;&gt;&gt; in .../submit/index.php on line 1683
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
...
<span class="quotelev1">&gt; z -u sun -p sun4sun -d
</span><br>
...
<span class="quotelev1">&gt;  LWP::MediaTypes::read_media_types: Reading media types from /ws/ 
</span><br>
<span class="quotelev1">&gt; ompi-tools/lib/perl5/5.8.8/LWP/media.types
</span><br>
<span class="quotelev1">&gt;  LWP::MediaTypes::read_media_types: Reading media types from /usr/ 
</span><br>
<span class="quotelev1">&gt; perl5/site_perl/5.8.4/LWP/media.types
</span><br>
<span class="quotelev1">&gt;  LWP::MediaTypes::read_media_types: Reading media types from /home/ 
</span><br>
<span class="quotelev1">&gt; em162155/.mime.types
</span><br>
<span class="quotelev1">&gt;  LWP::UserAgent::request: ()
</span><br>
<span class="quotelev1">&gt;  LWP::UserAgent::send_request: POST <a href="http://www.open-mpi.org/mtt/submit/index.php">http://www.open-mpi.org/mtt/submit/index.php</a>
</span><br>
...
<span class="quotelev1">&gt; 33554432 bytes exhausted (tried to allocate 14 bytes) in /nfs/rontok/ 
</span><br>
<span class="quotelev1">&gt; xraid/data/osl/www/www.open-mpi.org/mtt/submit/index.php on line 1559
</span><br>
<span class="quotelev1">&gt;  ...
</span><br>
<span class="quotelev1">&gt;
