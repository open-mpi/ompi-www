...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0761.php">¸ßÐÇ: "[MTT users] test example connectivity_c cannot run on multiple nodes"</a>
<li><strong>Previous message:</strong> <a href="0759.php">Josh Hursey: "Re: [MTT users] [OMPI devel] Open MPI MTT is moving"</a>
<li><strong>In reply to:</strong> <a href="0759.php">Josh Hursey: "Re: [MTT users] [OMPI devel] Open MPI MTT is moving"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
