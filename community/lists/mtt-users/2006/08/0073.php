...
<!-- received="Wed Aug 30 14:28:33 2006" -->
<!-- isoreceived="20060830182833" -->
<!-- sent="Wed, 30 Aug 2006 14:28:02 -0400" -->
<!-- isosent="20060830182802" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [MTT users] Tests timing out" -->
<!-- id="2BDC9706-D740-41A9-A65F-6E78D59AA330_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="C11B35A1.24DE0%jsquyres_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-08-30 14:28:02
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0074.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<li><strong>Previous message:</strong> <a href="0072.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<li><strong>In reply to:</strong> <a href="0072.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0074.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<li><strong>Reply:</strong> <a href="0074.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>So this causes tcsh to emit the error the LD_LIBRARY_PATH is not  
<br>
defined. So it is not set due to the error.
<br>
<p>I fixed this by always declaring it in the .cshrc file to &quot;&quot;. However  
<br>
...
&lt;/code&gt;
<br>
<p>or something of the sort.
<br>
<p>As another note, could we start a &quot;How to debug MTT&quot; Wiki page with  
<br>
...
things started.
<br>
<p>Thanks for all your help, I'm sure I'll have more questions in the  
<br>
near future.
<br>
<p>Cheers,
...
Josh
<br>
<p><p>On Aug 30, 2006, at 12:31 PM, Jeff Squyres wrote:
<br>
<p><span class="quotelev1">&gt; On 8/30/06 12:10 PM, &quot;Josh Hursey&quot; &lt;jjhursey_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; MTT directly sets environment variables in its own environment (via
</span><br>
...
<span class="quotelev2">&gt;&gt; Does it drop them to a file, or is it printed in the debugging output
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; As for setting the values on *remote* nodes, we do it solely via the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; that it can build the tests? How does it export these when it runs
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; I already tried that. However I'm trying it in a couple different
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Well, why don't you try first separating this from MTT? Just run
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; On 8/30/06 8:03 AM, &quot;Josh Hursey&quot; &lt;jjhursey_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; #2  0x0000002a956e28b6 in opal_event_base_loop (base=0x5136d0,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; flags=5) at event.c:584
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; #3  0x0000002a956e26b7 in opal_event_loop (flags=5) at event.c:
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; On 8/29/06 8:57 PM, &quot;Josh Hursey&quot; &lt;jjhursey_at_[hidden]&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Blah.  The trivial tests are simply &quot;hello world&quot;, so they
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Is this running under SLURM?  I put the code in there to
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; know how
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; many procs
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; to use in SLURM but have not tested it in eons.  I doubt  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Yep it is in SLURM. and it seems that the 'number of procs'
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Can you set a super-long timeout (e.g., a few minutes), and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; while
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; one of the
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; trivial tests is running, do some ps's on the relevant nodes
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; and
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; see what,
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; if anything, is running?  E.g., mpirun, the test  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; executable on
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; USER       PID %CPU %MEM   VSZ  RSS TTY      STAT START   TIME
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; COMMAND
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15117  0.5  0.8 113024 33680 ?      S    09:32   0:06
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15294  0.0  0.0     0    0 ?        Z    09:32   0:00
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; [sh]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; &lt;defunct&gt;
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  28453  0.2  0.0 38072 3536 ?        S    09:50   0:00
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -mca btl tcp,self -np 32 --prefix /san/homedirs/mpiteam/tmp/ 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  28454  0.0  0.0 41716 2040 ?        Sl   09:50   0:00
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; srun --
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; nodes=16 --ntasks=16 --
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; nodelist=odin022,odin021,odin020,odin019,odin018,odin017,odin0 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; ,odin014,odin013,odin012,odin011,odin010,odin009,odin008,odin0 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  28455  0.0  0.0 23212 1804 ?        Ssl  09:50   0:00
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; srun --
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; nodes=16 --ntasks=16 --
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; But once the test finishes, mpirun seems to just be hanging  
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; root     15086  0.0  0.0 42884 3172 ?        Ss   09:31   0:00
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; sshd:
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam [priv]
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15088  0.0  0.0 43012 3252 ?        S    09:31   0:00
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; sshd:
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  28453  0.0  0.0 38204 3568 ?        S    09:50   0:00
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; -mca btl tcp,self -np 32 --prefix /san/homedirs/mpiteam/tmp/ 
