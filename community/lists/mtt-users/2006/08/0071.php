...
<!-- received="Wed Aug 30 12:10:38 2006" -->
<!-- isoreceived="20060830161038" -->
<!-- sent="Wed, 30 Aug 2006 12:10:23 -0400" -->
<!-- isosent="20060830161023" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [MTT users] Tests timing out" -->
<!-- id="0AE19388-CDB0-4129-BE1C-085FBC10E941_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="C11B28A6.24DA2%jsquyres_at_cisco.com" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-08-30 12:10:23
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0072.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<li><strong>Previous message:</strong> <a href="0070.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<li><strong>In reply to:</strong> <a href="0069.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0072.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<li><strong>Reply:</strong> <a href="0072.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; (sorry -- been afk much of this morning)
</span><br>
<span class="quotelev1">&gt;
</span><br>
<span class="quotelev1">&gt; MTT directly sets environment variables in its own environment (via
</span><br>
...
<p>Does it drop them to a file, or is it printed in the debugging output  
<br>
...
<span class="quotelev1">&gt; As for setting the values on *remote* nodes, we do it solely via the
</span><br>
...
<span class="quotelev2">&gt;&gt; I'm trying to replicate the MTT environment as much as possible, and
</span><br>
...
<span class="quotelev2">&gt;&gt; MTT. After MTT builds Open MPI, how does it export these variables so
</span><br>
<span class="quotelev2">&gt;&gt; that it can build the tests? How does it export these when it runs
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I already tried that. However I'm trying it in a couple different
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; Well, why don't you try first separating this from MTT? Just run
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; the command
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; manually in batch mode and see if it works. If that works, then the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; On 8/30/06 8:03 AM, &quot;Josh Hursey&quot; &lt;jjhursey_at_[hidden]&gt; wrote:
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; #3  0x0000002a956e26b7 in opal_event_loop (flags=5) at event.c: 
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Does this apply to *all* tests, or only some of the tests  
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; to use in SLURM but have not tested it in eons.  I doubt that's
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; trivial tests is running, do some ps's on the relevant nodes  
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; and
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; see what,
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; if anything, is running?  E.g., mpirun, the test executable on
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; Without setting a long timeout. It seems that mpirun is running,
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15294  0.0  0.0     0    0 ?        Z    09:32   0:00
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; [sh]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; &lt;defunct&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  28453  0.2  0.0 38072 3536 ?        S    09:50   0:00
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; nodelist=odin022,odin021,odin020,odin019,odin018,odin017,odin016 
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  28472  0.0  0.0 36956 2256 ?        S    09:50   0:00 /
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15083  0.0  0.0 52760 1040 ?        S    09:31   0:00 /
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; bin/
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; bash /var/tmp/slurmd/job148126/script
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; root     15086  0.0  0.0 42884 3172 ?        Ss   09:31   0:00
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; sshd:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam [priv]
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15088  0.0  0.0 43012 3252 ?        S    09:31   0:00
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; sshd:
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam_at_pts/1
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15089  0.0  0.0 56680 1912 pts/1    Ss   09:31   0:00 -
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  28453  0.0  0.0 38204 3568 ?        S    09:50   0:00
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpirun
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; -mca btl tcp,self -np 32 --prefix /san/homedirs/mpiteam/tmp/mtt-
