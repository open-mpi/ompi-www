...
<!-- received="Wed Aug 30 10:36:39 2006" -->
<!-- isoreceived="20060830143639" -->
<!-- sent="Wed, 30 Aug 2006 10:36:33 -0400" -->
<!-- isosent="20060830143633" -->
<!-- name="Josh Hursey" -->
<!-- email="jjhursey_at_[hidden]" -->
<!-- subject="Re: [MTT users] Tests timing out" -->
<!-- id="011E4DC8-BD42-46D8-A99B-A6FBE6E4872D_at_open-mpi.org" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="8A98A0A2-F60C-434A-ACC8-952D33E17964_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-08-30 10:36:33
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0069.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<li><strong>Previous message:</strong> <a href="0067.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<li><strong>In reply to:</strong> <a href="0067.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0069.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<li><strong>Reply:</strong> <a href="0069.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>Assume there is no mpirun in my PATH/LD_LIBRARY_PATH when I start  
<br>
...
josh
<br>
<p>On Aug 30, 2006, at 10:25 AM, Josh Hursey wrote:
<br>
<p><span class="quotelev1">&gt; I already tried that. However I'm trying it in a couple different
</span><br>
<span class="quotelev1">&gt; ways and getting some mixed results. Let me formulate the error cases
</span><br>
...
<span class="quotelev2">&gt;&gt; manually in batch mode and see if it works. If that works, then the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; yet another point (sorry for the spam). This may not be an MTT issue
</span><br>
<span class="quotelev3">&gt;&gt;&gt; but a broken ORTE on the trunk :(
</span><br>
<span class="quotelev3">&gt;&gt;&gt;
</span><br>
<span class="quotelev3">&gt;&gt;&gt; When I try to run in a allocation (srun -N 16 -A) things run fine.
</span><br>
<span class="quotelev3">&gt;&gt;&gt; But if I try to run in batch mode (srun -N 16 -b myscript.sh) then I
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I'll try to investigate a bit further today. Any thoughts on what
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #3  0x0000002a956e26b7 in opal_event_loop (flags=5) at event.c:514
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; #6  0x0000000000402f52 in orterun (argc=9, argv=0x7fbffff0b8) at
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; to use in SLURM but have not tested it in eons.  I doubt that's
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; if anything, is running?  E.g., mpirun, the test executable on  
</span><br>
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Without setting a long timeout. It seems that mpirun is running,
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; nodelist=odin022,odin021,odin020,odin019,odin018,odin017,odin016,o 
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mpiteam  28472  0.0  0.0 36956 2256 ?        S    09:50   0:00 /
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mpiteam  15083  0.0  0.0 52760 1040 ?        S    09:31   0:00 /
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; mpiteam  15089  0.0  0.0 56680 1912 pts/1    Ss   09:31   0:00 -
</span><br>
