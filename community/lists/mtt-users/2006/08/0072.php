...
<!-- received="Wed Aug 30 12:31:42 2006" -->
<!-- isoreceived="20060830163142" -->
<!-- sent="Wed, 30 Aug 2006 12:31:29 -0400" -->
<!-- isosent="20060830163129" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [MTT users] Tests timing out" -->
<!-- id="C11B35A1.24DE0%jsquyres_at_cisco.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="0AE19388-CDB0-4129-BE1C-085FBC10E941_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-08-30 12:31:29
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0073.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<li><strong>Previous message:</strong> <a href="0071.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<li><strong>In reply to:</strong> <a href="0071.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0073.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<li><strong>Reply:</strong> <a href="0073.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev2">&gt;&gt; MTT directly sets environment variables in its own environment (via
</span><br>
...
<span class="quotelev1">&gt; Does it drop them to a file, or is it printed in the debugging output
</span><br>
<span class="quotelev1">&gt; anywhere? I'm having a bit of trouble finding these strings in the
</span><br>
<span class="quotelev1">&gt; output.
</span><br>
<p>It does not put these in the -debug output.
<br>
<p>The files that it drops are in the scratch dir.  You'll need to go into
<br>
scratch/installs, and then it depends on what your INI file section names
<br>
are.  You'll go to:
<br>
<p>&nbsp;&nbsp;&nbsp;&nbsp;&lt;scratch&gt;/installs/&lt;mpi get&gt;/&lt;mpi install&gt;/&lt;mpi_version&gt;/
<br>
<p>And there should be files named &quot;mpi_installed_vars.[csh|sh]&quot; that you can
<br>
source, depending on your shell.  IT should set PATH and LD_LIBRARY_PATH.
<br>
<p>The intent of these files is for exactly this purpose -- for a human to test
<br>
borked MPI installs inside the MTT scratch tree.
<br>
<p><span class="quotelev2">&gt;&gt; 
</span><br>
<span class="quotelev2">&gt;&gt; As for setting the values on *remote* nodes, we do it solely via the
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; I'm trying to replicate the MTT environment as much as possible, and
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; MTT. After MTT builds Open MPI, how does it export these variables so
</span><br>
<span class="quotelev3">&gt;&gt;&gt; that it can build the tests? How does it export these when it runs
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I already tried that. However I'm trying it in a couple different
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt; Well, why don't you try first separating this from MTT? Just run
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; #3  0x0000002a956e26b7 in opal_event_loop (flags=5) at event.c:
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Does this apply to *all* tests, or only some of the tests
</span><br>
...
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; Can you set a super-long timeout (e.g., a few minutes), and
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; while
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; one of the
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; trivial tests is running, do some ps's on the relevant nodes
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; and
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; see what,
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; if anything, is running?  E.g., mpirun, the test executable on
</span><br>
<span class="quotelev1">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15294  0.0  0.0     0    0 ?        Z    09:32   0:00
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt;&gt;&gt;&gt;&gt; nodelist=odin022,odin021,odin020,odin019,odin018,odin017,odin016
</span><br>
