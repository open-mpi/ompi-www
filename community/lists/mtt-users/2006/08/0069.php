...
<!-- received="Wed Aug 30 11:36:18 2006" -->
<!-- isoreceived="20060830153618" -->
<!-- sent="Wed, 30 Aug 2006 11:36:06 -0400" -->
<!-- isosent="20060830153606" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [MTT users] Tests timing out" -->
<!-- id="C11B28A6.24DA2%jsquyres_at_cisco.com" -->
<!-- charset="US-ASCII" -->
<!-- inreplyto="011E4DC8-BD42-46D8-A99B-A6FBE6E4872D_at_open-mpi.org" -->
<!-- expires="-1" -->
<div class="center">
...
<strong>Date:</strong> 2006-08-30 11:36:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0070.php">Jeff Squyres: "Re: [MTT users] Tests timing out"</a>
<li><strong>Previous message:</strong> <a href="0068.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<li><strong>In reply to:</strong> <a href="0068.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0071.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<li><strong>Reply:</strong> <a href="0071.php">Josh Hursey: "Re: [MTT users] Tests timing out"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p>MTT directly sets environment variables in its own environment (via
<br>
...
<br>
<p>So if you source the env vars files that MTT drops, that should be
<br>
sufficient.
<br>
<p>As for setting the values on *remote* nodes, we do it solely via the
<br>
...
OMPI...?
<br>
<p><p>On 8/30/06 10:36 AM, &quot;Josh Hursey&quot; &lt;jjhursey_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; I'm trying to replicate the MTT environment as much as possible, and
</span><br>
...
<span class="quotelev1">&gt; MTT. After MTT builds Open MPI, how does it export these variables so
</span><br>
...
<span class="quotelev2">&gt;&gt; ways and getting some mixed results. Let me formulate the error cases
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt; manually in batch mode and see if it works. If that works, then the
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; yet another point (sorry for the spam). This may not be an MTT issue
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; but a broken ORTE on the trunk :(
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; 
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; When I try to run in a allocation (srun -N 16 -A) things run fine.
</span><br>
<span class="quotelev4">&gt;&gt;&gt;&gt; But if I try to run in batch mode (srun -N 16 -b myscript.sh) then I
</span><br>
...
<span class="quotelev4">&gt;&gt;&gt;&gt; I'll try to investigate a bit further today. Any thoughts on what
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; to use in SLURM but have not tested it in eons.  I doubt that's
</span><br>
...
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; if anything, is running?  E.g., mpirun, the test executable on
</span><br>
<span class="quotelev3">&gt;&gt;&gt;&gt;&gt;&gt;&gt; the
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; Without setting a long timeout. It seems that mpirun is running,
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; nodelist=odin022,odin021,odin020,odin019,odin018,odin017,odin016,o
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  28472  0.0  0.0 36956 2256 ?        S    09:50   0:00 /
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15083  0.0  0.0 52760 1040 ?        S    09:31   0:00 /
</span><br>
...
<span class="quotelev2">&gt;&gt;&gt;&gt;&gt;&gt; mpiteam  15089  0.0  0.0 56680 1912 pts/1    Ss   09:31   0:00 -
</span><br>
