...
<!-- received="Mon Nov  6 07:46:08 2006" -->
<!-- isoreceived="20061106124608" -->
<!-- sent="Mon, 6 Nov 2006 07:45:41 -0500" -->
<!-- isosent="20061106124541" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [MTT users] Valid INI file and MPI Details section" -->
<!-- id="DAF0345A-43EF-4431-91B4-4A75BCE59419_at_cisco.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2006-11-06 07:45:41
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0200.php">Josh Hursey: "Re: [MTT users] Valid INI file and MPI Details section"</a>
<li><strong>Previous message:</strong> <a href="0198.php">Jeff Squyres: "Re: [MTT users] &amp;join funclet and EvaluateString"</a>
<li><strong>In reply to:</strong> <a href="0193.php">Josh Hursey: "[MTT users] Valid INI file and MPI Details section"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0200.php">Josh Hursey: "Re: [MTT users] Valid INI file and MPI Details section"</a>
<li><strong>Reply:</strong> <a href="0200.php">Josh Hursey: "Re: [MTT users] Valid INI file and MPI Details section"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<br>
<p><span class="quotelev1">&gt; I have an INI File that looks something like what is enclose at the
</span><br>
...
<p>Yes.  In the MPI Get section, you have to list an &quot;mpi_details&quot; field  
<br>
...
<br>
<p><span class="quotelev1">&gt; As a side question:
</span><br>
...
<p>We hadn't really anticipated having multiple MPI details sections  
<br>
...
<br>
<p>Ethan made a relevant comment here as well.
<br>
<p><span class="quotelev1">&gt; Building trunk
</span><br>
...
<p>You will see this ^^^.  The way it works is that the Test Run phase  
<br>
...
execute.
<br>
<p><span class="quotelev1">&gt; or will I see
</span><br>
<span class="quotelev1">&gt;
</span><br>
...
<p>I'm not quite sure I understand this above example ordering -- I see  
<br>
...
Runing mpirun -mca btl mvapi,self
<br>
<p><span class="quotelev1">&gt; I would actually prefer the last because if something is broken with
</span><br>
...
<p>I could see that.  Unfortunately, that's not currently how the run  
<br>
