...
<!-- received="Thu Jul 20 18:10:58 2006" -->
<!-- isoreceived="20060720221058" -->
<!-- sent="Thu, 20 Jul 2006 18:10:43 -0400" -->
<!-- isosent="20060720221043" -->
<!-- name="Jeff Squyres" -->
<!-- email="jsquyres_at_[hidden]" -->
<!-- subject="Re: [MTT users] nightly results format" -->
<!-- id="C0E577A3.B1A8%jsquyres_at_cisco.com" -->
<!-- charset="US-ASCII" -->
...
<strong>Date:</strong> 2006-07-20 18:10:43
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0049.php">Anna Tatashina: "Re: [MTT users] nightly results format"</a>
<li><strong>Previous message:</strong> <a href="0047.php">Ethan Mallove: "[MTT users] nightly results format"</a>
<li><strong>In reply to:</strong> <a href="0047.php">Ethan Mallove: "[MTT users] nightly results format"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0049.php">Anna Tatashina: "Re: [MTT users] nightly results format"</a>
<li><strong>Reply:</strong> <a href="0049.php">Anna Tatashina: "Re: [MTT users] nightly results format"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
This looks great!
<br>
<p>The only addition that I would ask for is some kind of executive summary at
<br>
...
<br>
<p>Specifically, we might want to have one or more e-mails, each with varying
<br>
levels of detail:
<br>
<p>1. The executive summary (probably with links for more detail)
<br>
...
4. ....?
<br>
<p>I anticipate that since we have such a wide variety of developers, some will
<br>
...
<br>
<p>However, if this is overshooting the immediate goals of getting it running,
<br>
...
<br>
<p><p>On 7/20/06 5:33 PM, &quot;Ethan Mallove&quot; &lt;Ethan.Mallove_at_[hidden]&gt; wrote:
<br>
<p><span class="quotelev1">&gt; Here's a draft for a nightly test results email format. One
</span><br>
...
<span class="quotelev1">&gt; This might be better sent as an attachment, or a link to a
</span><br>
...
<span class="quotelev1">&gt; We are also planning a webpage frontend (e.g.,
</span><br>
...
<span class="quotelev1">&gt; /workspace/em162155/hpc/mtt/trunk/installs/ompi-nightly-v1.0/solaris_i386/inst
</span><br>
