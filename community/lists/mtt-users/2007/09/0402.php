...
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0403.php">Josh Hursey: "Re: [MTT users] [MTT devel]  Test runs not getting into database"</a>
<li><strong>Previous message:</strong> <a href="0401.php">Jeff Squyres: "Re: [MTT users] Test runs not getting into database"</a>
<li><strong>In reply to:</strong> <a href="0401.php">Jeff Squyres: "Re: [MTT users] Test runs not getting into database"</a>
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0403.php">Josh Hursey: "Re: [MTT users] [MTT devel]  Test runs not getting into database"</a>
<li><strong>Reply:</strong> <a href="0403.php">Josh Hursey: "Re: [MTT users] [MTT devel]  Test runs not getting into database"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
