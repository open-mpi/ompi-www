...
<!-- received="Fri Sep 28 13:39:27 2007" -->
<!-- isoreceived="20070928173927" -->
<!-- sent="Fri, 28 Sep 2007 13:39:22 -0400" -->
<!-- isosent="20070928173922" -->
<!-- name="Tim Mattox" -->
<!-- email="timattox_at_[hidden]" -->
<!-- subject="Re: [MTT users] Problems running MTT with already installed MPICH-MX" -->
<!-- id="ea86ce220709281039ta5c9c70x9146b578bb490564_at_mail.gmail.com" -->
<!-- charset="ISO-8859-1" -->
...
<strong>Date:</strong> 2007-09-28 13:39:22
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0438.php">Jelena Pjesivac-Grbovic: "Re: [MTT users] Problems running MTT with already installed MPICH-MX"</a>
<li><strong>Previous message:</strong> <a href="0436.php">Jelena Pjesivac-Grbovic: "Re: [MTT users] Problems running MTT with already installed	MPICH-MX"</a>
...
<!-- nextthread="start" -->
<li><strong>Next in thread:</strong> <a href="0439.php">Ethan Mallove: "Re: [MTT users] Problems running MTT with already installed	MPICH-MX"</a>
<li><strong>Reply:</strong> <a href="0439.php">Ethan Mallove: "Re: [MTT users] Problems running MTT with already installed	MPICH-MX"</a>
<li><strong>Reply:</strong> <a href="0440.php">Mohamad Chaarawi: "Re: [MTT users] Problems running MTT with already installed MPICH-MX"</a>
<!-- reply="end" -->
</ul>
<hr>
<!-- body="start" -->
...
<p>As far as I can tell, the install module should be something like this:
<br>
module = Analyze::MPICH
<br>
<p>But there isn't an MPICH module for that yet...  there are ones for OMPI,
<br>
CrayMPI, HPMPI and IntelMPI.
<br>
<p>The Analyze::OMPI module won't work, since it will try to use ompi_info...
<br>
...
<br>
<p>On 9/28/07, Ethan Mallove &lt;ethan.mallove_at_[hidden]&gt; wrote:
<br>
<span class="quotelev1">&gt; Hi Jelena,
</span><br>
