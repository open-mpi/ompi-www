<?
$subject_val = "Re: [MTT users] [OMPI devel] Using MTT to test the newly added SCTP BTL";
...
<p class="headers">
<strong>Subject:</strong> Re: [MTT users] [OMPI devel] Using MTT to test the newly added SCTP BTL<br>
<strong>From:</strong> Jeff Squyres (<em>jsquyres_at_[hidden]</em>)<br>
<strong>Date:</strong> 2007-12-06 06:48:06
</p>
<ul class="links">
<!-- next="start" -->
<li><strong>Next message:</strong> <a href="0459.php">Karol Mroz: "[MTT users] MTT database access"</a>
<li><strong>Previous message:</strong> <a href="http://www.open-mpi.org/community/lists/mtt-users/2007/11/0457.php">Jeff Squyres: "Re: [MTT users] Using MTT to test the newly added SCTP BTL"</a>
<!-- nextthread="start" -->
<!-- reply="end" -->
</ul>
<hr>
