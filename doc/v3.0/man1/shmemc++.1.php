<?php
$topdir = "../../..";
$title = "shmemc++(1) man page (version 3.0.3)";
$meta_desc = "Open MPI v3.0.3 man page: shmemc++(1)";
...
flags.  For example, both "shmemc++ --showme" and "shmemc++ --showme my_source.c"
will show all the wrapper-supplied flags.  But "shmemc++ --showme -v" will only
...
<i>shmemc++</i> passes its arguments to the underlying
...
compelling reasons <i>not</i> to use <i>shmemc++</i>.  When it is not possible to use
...
by Open SHMEM and installed to <i>$pkgdata/shmemc++-wrapper-data.txt</i>, where <i>$pkgdata</i>
