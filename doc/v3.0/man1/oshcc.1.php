<?php
$topdir = "../../..";
$title = "oshcc(1) man page (version 3.0.4)";
$meta_desc = "Open MPI v3.0.4 man page: oshcc(1)";
...
wrappers for the underlying C compiler.  Translation of an Open SHMEM program
requires the linkage of the Open SHMEM-specific libraries which may not
reside in one of the standard search directories of <i>ld(1)</i>.  It also often
requires the inclusion of header files what may also not be found in a
standard location.  <p>
<i>oshcc</i> passes its arguments to the underlying C compiler
along with the -I, -L and -l options required by Open SHMEM programs.  <p>
The
Open SHMEM Team <i>strongly</i> encourages using the wrapper compilers instead
