<?php
$topdir = "../../..";
$title = "shmemcxx(1) man page (version 3.0.1)";
$meta_desc = "Open MPI v3.0.1 man page: shmemcxx(1)";
...
flags.  For example, both "shmemcxx --showme" and "shmemcxx --showme my_source.c"
will show all the wrapper-supplied flags.  But "shmemcxx --showme -v" will only
...
<i>shmemcxx</i> is
a convenience wrappers for the underlying C++ compiler.  Translation of
...
<i>shmemcxx</i> passes its arguments to the underlying
...
compelling reasons <i>not</i> to use <i>shmemcxx</i>.  When it is not possible to use
the wrappers directly, the <i>-showme:compile</i> and <i>-showme:link</i> options should
...
by Open SHMEM and installed to <i>$pkgdata/shmemcxx-wrapper-data.txt</i>, where <i>$pkgdata</i>
