<?php
$topdir = "../../..";
$title = "oshcxx(1) man page (version 3.0.5)";
$meta_desc = "Open MPI v3.0.5 man page: oshcxx(1)";
...
flags.  For example, both "oshcxx --showme" and "oshcxx --showme my_source.c"
will show all the wrapper-supplied flags.  But "oshcxx --showme -v" will only
...
<i>oshcxx</i> passes its arguments to the underlying
...
compelling reasons <i>not</i> to use <i>oshcxx</i>.  When it is not possible to use the
...
by Open SHMEM and installed to <i>$pkgdata/oshcxx-wrapper-data.txt</i>, where <i>$pkgdata</i>
