<?php
$topdir = "../../..";
$title = "shmem_longdouble_prod_to_all(3) man page (version 3.0.4)";
$meta_desc = "Open MPI v3.0.4 man page: shmem_longdouble_prod_to_all(3)";
...
<p> <i><i>shmem_comp4_prod_to_all</i>(3)</i>, <i><i>shmem_comp8_prod_to_all</i>(3)</i>, <i><i>shmem_complexd_prod_to_all</i>(3)</i>,
<i><i>shmem_complexf_prod_to_all</i>(3)</i>, <i><i>shmem_double_prod_to_all</i>(3)</i>, <i><i>shmem_float_prod_to_all</i>(3)</i>,
<i><i>shmem_int_prod_to_all</i>(3)</i>, <i><i>shmem_int4_prod_to_all</i>(3)</i>, <i><i>shmem_int8_prod_to_all</i>(3)</i>,
<i><i>shmem_long_prod_to_all</i>(3)</i>, <i><i>shmem_longdouble_prod_to_all</i>(3)</i>, <i><i>shmem_longlong_prod_to_all</i>(3)</i>,
<i><i>shmem_real8_prod_to_all</i>(3)</i>, <i><i>shmem_real16_prod_to_all</i>(3)</i>, <i><i>shmem_real4_prod_to_all</i>(3)</i>,
<i><i>shmem_short_prod_to_all</i>(3)</i> - Performs a product reduction across a set of
...
<dt><b>shmem_comp4_prod_to_all</b>: Complex, with
an element size equal to two </dt>
<dd>4-byte real values. </dd>

<dt><b>shmem_comp8_prod_to_all</b>:
Complex, with an element size equal to two </dt>
<dd>8-byte real values. </dd>

<dt><b>shmem_int4_prod_to_all</b>:
Integer, with an element size of 4 bytes </dt>
<dd></dd>

<dt><b>shmem_int8_prod_to_all</b>: Integer,
with an element size of 8 bytes </dt>
<dd></dd>

<dt><b>shmem_real4_prod_to_all</b>: Real, with an
element size of 4 bytes </dt>
<dd></dd>

<dt><b>shmem_real8_prod_to_all</b>: Real, with an element
size of 8 bytes </dt>
<dd></dd>

<dt><b>shmem_real16_prod_to_all</b>: Real, with an element size of
16 bytes </dt>
<dd></dd>
</dl>
</blockquote>
...
<dt>source </dt>
<dd>A symmetric array, of length nreduce elements, that contains
...
or SHMEM_SYNC_VALUE (in Fortran). </dd>
</dl>
<p>
...
the product of the real variable FOO across all the even PEs. <br>
<pre>INCLUDE "mpp/shmem.fh"
INTEGER PSYNC(SHMEM_REDUCE_SYNC_SIZE)
...
IF ( MOD(MY_PE(),2) .EQ. 0) THEN
  ...
  &amp; PWRK, PSYNC)
  PRINT *, &rsquo;Result on PE &rsquo;, MY_PE(), &rsquo; is &rsquo;, FOOPROD
ENDIF
</pre> <b>Example 2:</b> Consider the following C/C++ call: <br>
<pre>shmem_short_prod_to_all(target, source, 3, 0, 0, 8, pwrk, psync);
</pre> The preceding call is more efficient, but semantically equivalent to,
the combination of the following calls: <br>
<pre>shmem_short_prod_to_all(&amp;(target[0]), &amp;(source[0]), 1, 0, 0, 8,
  pwrk1, psync1);
