<?php
$topdir = "../../..";
$title = "MPI_Graph_neighbors_count(3) man page (version 3.0.2)";
$meta_desc = "Open MPI v3.0.2 man page: MPI_GRAPH_NEIGHBORS_COUNT(3)";
...
<b>MPI_Graph_neighbors_count </b> - Returns the number of neighbors of
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(OUT) :: nneighbors
