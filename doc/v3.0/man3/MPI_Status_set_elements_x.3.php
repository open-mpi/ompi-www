<?php
$topdir = "../../..";
$title = "MPI_Status_set_elements_x(3) man page (version 3.0.4)";
$meta_desc = "Open MPI v3.0.4 man page: MPI_STATUS_SET_ELEMENTS_X(3)";
...
portable Fortran syntax for the <i>COUNT</i> argument of MPI_Status_set_elements_x
