<?php
$topdir = "../../..";
$title = "shmem_short_xor_to_all(3) man page (version 3.0.2)";
$meta_desc = "Open MPI v3.0.2 man page: shmem_short_xor_to_all(3)";
...
<p> <i><i>shmem_comp4_xor_to_all</i>(3)</i>, <i><i>shmem_int_xor_to_all</i>(3)</i>, <i><i>shmem_int4_xor_to_all</i>(3)</i>,
<i><i>shmem_int8_xor_to_all</i>(3)</i>, <i><i>shmem_long_xor_to_all</i>(3)</i>, <i><i>shmem_longlong_xor_to_all</i>(3)</i>,
<i><i>shmem_short_xor_to_all</i>(3)</i> - Performs a bitwise XOR operation on symmetric
...
<dt><b>shmem_comp8_xor_to_all:</b> Complex, with
an element size equal to two 8- </dt>
<dd>byte real values </dd>

<dt><b>shmem_comp4_xor_to_all:</b>
Complex, with an element size equal to two 4- </dt>
<dd>byte real values </dd>

<dt><b>shmem_int8_xor_to_all:</b>
Integer, with an element size of 8 bytes </dt>
<dd></dd>

<dt><b>shmem_int4_xor_to_all:</b> Integer,
with an element size of 4 bytes </dt>
<dd></dd>

<dt><b>shmem_real8_xor_to_all:</b> Real, with an element
size of 8 bytes </dt>
<dd></dd>

<dt><b>shmem_real4_xor_to_all:</b> Real, with an element size of 4
bytes </dt>
<dd></dd>
</dl>
</blockquote>
...
<p> <b>Example
1:</b> This Fortran example statically initializes the pSync array and computes
the exclusive OR of variable FOO across all even PEs. <br>
<pre>INCLUDE "mpp/shmem.fh"
INTEGER PSYNC(SHMEM_REDUCE_SYNC_SIZE)
...
IF ( MOD(MY_PE(),2) .EQ. 0) THEN
  ...
  &amp; PWRK, PSYNC)
  PRINT *, &rsquo;Result on PE &rsquo;, MY_PE(), &rsquo; is &rsquo;, FOOXOR
ENDIF
</pre> <b>Example 2:</b> Consider the following C/C++ call: <br>
<pre>shmem_short_xor_to_all( target, source, 3, 0, 0, 8, pwrk, psync );
</pre> The preceding call is more efficient, but semantically equivalent to,
the combination of the following calls: <br>
<pre>shmem_short_xor_to_all(&amp;(target[0]), &amp;(source[0]), 1, 0, 0, 8,
  pwrk1, psync1);
