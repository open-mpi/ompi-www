<?php
$topdir = "../../..";
$title = "MPI_Type_extent(3) man page (version 3.0.0)";
$meta_desc = "Open MPI v3.0.0 man page: MPI_TYPE_EXTENT(3)";
...
Note
that use of this routine is <i>deprecated</i> as of MPI-2. Please use <a href="../man3/MPI_Type_get_extent.3.php">MPI_Type_get_extent</a>
instead. <p>
This deprecated routine is not available in C++. <p>
MPI_Type_extent
returns the extent of a data type, the difference between the upper and
lower bounds of the data type. <p>
In general, if <p>
<br>
