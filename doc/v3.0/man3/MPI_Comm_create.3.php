<?php
$topdir = "../../..";
$title = "MPI_Comm_create(3) man page (version 3.0.1)";
$meta_desc = "Open MPI v3.0.1 man page: MPI_COMM_CREATE(3)";
...
This function
creates a new communicator newcomm with communication group defined by
group and a new context. The function sets <i>newcomm</i> to a new communicator
