<?php
$topdir = "../../..";
$title = "MPI_File_write_at_all_begin(3) man page (version 2.0.4)";
$meta_desc = "Open MPI v2.0.4 man page: MPI_FILE_WRITE_AT_ALL_BEGIN(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write_at_all_begin(MPI_File fh, MPI_Offset
offset, <tt> </tt>&nbsp;<tt> </tt>&nbsp;const void *buf, int count, MPI_Datatype datatype)
  </pre>
