<?php
$topdir = "../../..";
$title = "MPI_File_write_ordered_begin(3) man page (version 2.0.2)";
$meta_desc = "Open MPI v2.0.2 man page: MPI_FILE_WRITE_ORDERED_BEGIN(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write_ordered_begin(MPI_File fh, const
void *buf, <tt> </tt>&nbsp;<tt> </tt>&nbsp;int count, MPI_Datatype datatype)
  </pre>
