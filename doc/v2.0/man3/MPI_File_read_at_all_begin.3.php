<?php
$topdir = "../../..";
$title = "MPI_File_read_at_all_begin(3) man page (version 2.0.0)";
$meta_desc = "Open MPI v2.0.0 man page: MPI_FILE_READ_AT_ALL_BEGIN(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_read_at_all_begin(MPI_File fh, MPI_Offset
