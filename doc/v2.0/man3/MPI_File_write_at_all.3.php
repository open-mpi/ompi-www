<?php
$topdir = "../../..";
$title = "MPI_File_write_at_all(3) man page (version 2.0.2)";
$meta_desc = "Open MPI v2.0.2 man page: MPI_FILE_WRITE_AT_ALL(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write_at_all(MPI_File fh, MPI_Offset
offset, const void *buf, <tt> </tt>&nbsp;<tt> </tt>&nbsp;int count, MPI_Datatype datatype, MPI_Status *status)
  </pre>
