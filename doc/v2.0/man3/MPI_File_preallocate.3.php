<?php
$topdir = "../../..";
$title = "MPI_File_preallocate(3) man page (version 2.0.3)";
$meta_desc = "Open MPI v2.0.3 man page: MPI_FILE_PREALLOCATE(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_preallocate(MPI_File fh, MPI_Offset
size)  </pre>
