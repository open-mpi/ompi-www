<?php
$topdir = "../../..";
$title = "MPI_File_seek_shared(3) man page (version 2.0.4)";
$meta_desc = "Open MPI v2.0.4 man page: MPI_FILE_SEEK_SHARED(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_seek_shared(MPI_File fh, MPI_Offset
offset, <tt> </tt>&nbsp;<tt> </tt>&nbsp;int whence)
  </pre>
