<?php
$topdir = "../../..";
$title = "MPI_File_get_view(3) man page (version 2.0.3)";
$meta_desc = "Open MPI v2.0.3 man page: MPI_FILE_GET_VIEW(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_get_view(MPI_File fh, MPI_Offset *disp,
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI::Datatype&amp; etype,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI::Datatype&amp; filetype, char* datarep) const
</pre>
