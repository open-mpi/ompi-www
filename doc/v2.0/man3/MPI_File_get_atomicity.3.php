<?php
$topdir = "../../..";
$title = "MPI_File_get_atomicity(3) man page (version 2.0.3)";
$meta_desc = "Open MPI v2.0.3 man page: MPI_FILE_GET_ATOMICITY(3)";
...
<b>MPI_File_get_atomicity</b> - Returns current consistency semantics
for data-access operations.
<p>
<h2><a name='sect1' href='#toc1'>Syntax</a></h2>
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_get_atomicity(MPI_File fh, int *flag)
 </pre>
...
<dt>flag </dt>
<dd>true if atomic
mode is enabled, false if nonatomic mode is enabled (boolean). </dd>
...
of file handles created by one collective <a href="../man3/MPI_File_open.3.php">MPI_File_open</a>. If <i>flag</i> is <i>true,</i>
atomic mode is currently enabled; if <i>flag</i> is <i>false,</i> nonatomic mode is currently
enabled.
<p>
