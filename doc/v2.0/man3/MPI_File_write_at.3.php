<?php
$topdir = "../../..";
$title = "MPI_File_write_at(3) man page (version 2.0.4)";
$meta_desc = "Open MPI v2.0.4 man page: MPI_FILE_WRITE_AT(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write_at(MPI_File fh, MPI_Offset offset,
const void *buf, <tt> </tt>&nbsp;<tt> </tt>&nbsp;int count, MPI_Datatype datatype, MPI_Status *status)
  </pre>
