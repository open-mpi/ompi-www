<?php
$topdir = "../../..";
$title = "MPI_File_sync(3) man page (version 2.0.4)";
$meta_desc = "Open MPI v2.0.4 man page: MPI_FILE_SYNC(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_sync(MPI_File fh)  </pre>
...
causes all previous writes to <i>fh</i> by the calling process to be written to
permanent storage. If other processes have made updates to permanent storage,
then all such updates become visible to subsequent reads of <i>fh</i> by the calling
process. <p>
MPI_File_sync is a collective operation. The user is responsible
for ensuring that all nonblocking requests on <i>fh</i> have been completed before
