<?php
$topdir = "../../..";
$title = "MPI_File_seek(3) man page (version 2.0.4)";
$meta_desc = "Open MPI v2.0.4 man page: MPI_FILE_SEEK(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_seek(MPI_File fh, MPI_Offset offset,
