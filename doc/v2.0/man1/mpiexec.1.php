<?php
$topdir = "../../..";
$title = "mpiexec(1) man page (version 2.0.4)";
$meta_desc = "Open MPI v2.0.4 man page: mpiexec(1)";
...
<dt><b>-tune, --tune &lt;tune_file&gt;</b> </dt>
<dd>Specify a tune file to set arguments
for various MCA modules and environment variables. See the "Setting MCA
parameters and environment variables from file" section, below.     </dd>
</dl>
<p>
For
debugging:
...
<dt><b>-debugger, --debugger</b> </dt>
<dd>Sequence of
debuggers to search for when <i>--debug</i> is used (i.e. a synonym for <i>orte_base_user_debugger</i>
MCA parameter).   </dd>
...
<dd>Allow <i>mpirun</i> to run when executed by the root
user (<i>mpirun</i> defaults to aborting when launched as the root user).   </dd>

<dt><b>-aborted,
--aborted &lt;#&gt;</b> </dt>
<dd>Set the maximum number of aborted processes to display.   </dd>
...
<dt><b>-cf,
--cartofile &lt;cartofile&gt;</b> </dt>
<dd>Provide a cartography file.   </dd>

<dt><b>--hetero</b> </dt>
<dd>Indicates that
multiple app_contexts are being provided that are a mix of 32/64-bit binaries.
  </dd>
...
<dd>Specify the URI of the
Open MPI server (or the mpirun to be used as the server) , the name of
the file (specified as file:filename) that contains that info, or the PID
(specified as pid:#) of the mpirun to be used as  the server.<br>
...
<h2><a name='sect5' href='#toc5'>Description</a></h2>
 One invocation
of <i>mpirun</i> starts an MPI application running under Open MPI. If the application
is single process multiple data (SPMD), the application can be specified
on the <i>mpirun</i> command line.
<p> If the application is multiple instruction
