<?php
$topdir = "../../..";
$title = "opal_crs(7) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: opal_crs(7)";
...
Overview of Open PAL&rsquo;s CRS framework, and selected modules.  Open MPI 1.4.5.
...
<dt>crs_base_snapshot_dir </dt>
<dd>The directory to store the checkpoint snapshots.
Default is <b>/tmp</b>.    </dd>
</dl>

<h3><a name='sect5' href='#toc5'>self CRS Component</a></h3>
<p>
The <i>self</i> component invokes user-defined
functions to save and restore checkpoints. It is simply a mechanism for
user-defined functions to be invoked at Open PAL&rsquo;s Checkpoint, Continue,
and Restart phases. Hence, the only data that is saved during the checkpoint
is what is written in the user&rsquo;s checkpoint function. No libary state is
saved at all.  <p>
As such, the model for the <i>self</i> component is slightly differnt
