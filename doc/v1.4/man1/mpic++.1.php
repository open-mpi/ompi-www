<?php
$topdir = "../../..";
$title = "mpic++(1) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: mpic++(1)";
...
<i>not</i> display any additional flags.  For example, both "mpic++ --showme" and
"mpic++ --showme my_source.c" will show all the wrapper-supplied flags.  But
"mpic++ -showme -v" will only show the underlying compiler name and "-v". </dd>
...
<i>mpic++</i> is a convenience wrappers
...
use <i>mpic++</i>.  When it is not possible to use the wrappers directly, the <i>-showme:compile</i>
...
by Open MPI and installed to <i>$pkgdata/mpic++-wrapper-data.txt</i>, where <i>$pkgdata</i>
