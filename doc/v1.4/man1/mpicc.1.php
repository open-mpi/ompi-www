<?php
$topdir = "../../..";
$title = "mpicc(1) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: mpicc(1)";
...
<i>not</i> display any additional flags.  For example, both "mpicc --showme" and
"mpicc --showme my_source.c" will show all the wrapper-supplied flags.  But
"mpicc -showme -v" will only show the underlying compiler name and "-v". </dd>
...
<i>mpicc</i> is a convenience wrappers
...
-I, -L and -l options required by Open MPI programs.  <p>
