<?php
$topdir = "../../..";
$title = "mpif90(1) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: mpif90(1)";
...
<i>not</i> display any additional flags.  For example, both "mpif90 --showme" and
"mpif90 --showme my_source.c" will show all the wrapper-supplied flags.  But
"mpif90 -showme -v" will only show the underlying compiler name and "-v". </dd>

<dt>-showme:compile
</dt>
<dd>Do not invoke the underlying Fortran 90 compiler.  Instead, show the compiler
flags that would be supplied to the Fortran 90 compiler. </dd>

<dt>-showme:link </dt>
<dd>Do
not invoke the underlying Fortran 90 compiler.  Instead, show the linker
flags that would be supplied to the Fortran 90 compiler. </dd>
</dl>
<p>
See the man page
...
<i>mpif90</i> is a convenience wrappers for the underlying Fortran 90
...
<i>mpif90</i> passes
its arguments to the underlying Fortran 90 compiler along with the -I, -L
...
use <i>mpif90</i>.  When it is not possible to use the wrappers directly, the <i>-showme:compile</i>
...
by Open MPI and installed to <i>$pkgdata/mpif90-wrapper-data.txt</i>, where <i>$pkgdata</i>
