<?php
$topdir = "../../..";
$title = "mpif77(1) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: mpif77(1)";
...
<i>not</i> display any additional flags.  For example, both "mpif77 --showme" and
"mpif77 --showme my_source.c" will show all the wrapper-supplied flags.  But
"mpif77 -showme -v" will only show the underlying compiler name and "-v". </dd>

<dt>-showme:compile
</dt>
<dd>Do not invoke the underlying Fortran 77 compiler.  Instead, show the compiler
flags that would be supplied to the Fortran 77 compiler. </dd>
