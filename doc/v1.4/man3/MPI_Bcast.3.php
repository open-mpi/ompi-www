<?php
$topdir = "../../..";
$title = "MPI_Bcast(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_BCAST(3)";
...
<b>MPI_Bcast</b> - Broadcasts a message from the process with rank <i>root</i> to
...
same arguments for comm, root. On return, the contents of root&rsquo;s communication
buffer has been copied to all processes.    <p>
General, derived datatypes are
allowed for datatype. The type signature of count, datatype on any process
must be equal to the type signature of count, datatype at the root. This
implies that the amount of data sent must be equal to the amount received,
pairwise between each process and the root. MPI_Bcast and all other data-movement
collective routines make this restriction. Distinct type maps between sender
and receiver are still allowed.  <p>
<b>Example:</b> Broadcast 100 ints from process
0 to every process in the group. <br>
<pre>    MPI_Comm comm;
    int array[100];
    int root=0;
    ...
