<?php
$topdir = "../../..";
$title = "MPI_Win_create_errhandler(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_WIN_CREATE_ERRHANDLER(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;Errhandler_fn* function)
</pre>
...
MPI_Win_create_errhandler should
be, in C, a function of type MPI_Win_errhandler_fn, which is defined as
 <p>
<br>
<pre>typedef void MPI_Win_errhandler_fn(MPI Win *, int *, ...);
</pre><p>
...
<br>
<pre>SUBROUTINE WIN_ERRHANDLER_FN(WIN, ERROR_CODE, ...)
    INTEGER WIN, ERROR_CODE
</pre><p>
In C++, the user routine should be of the form: <p>
<br>
<pre>typedef void MPI::Win::Errhandler_fn(MPI::Win &amp;, int *, ...);
</pre>
<p>
