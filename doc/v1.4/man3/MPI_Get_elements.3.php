<?php
$topdir = "../../..";
$title = "MPI_Get_elements(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_GET_ELEMENTS(3)";
...
MPI_Get_elements behaves different from <a href="../man3/MPI_Get_count.3.php">MPI_Get_count</a>,
which returns the number of "top-level entries" received, i.e., the number
of "copies" of type datatype. <a href="../man3/MPI_Get_count.3.php">MPI_Get_count</a> may return any integer value
k, where 0 =&lt; k =&lt; count. If <a href="../man3/MPI_Get_count.3.php">MPI_Get_count</a> returns k, then the number of basic
...
"copies," then <a href="../man3/MPI_Get_count.3.php">MPI_Get_count</a> returns the value MPI_UNDEFINED. <p>
<b>Example:</b> Usage
of <a href="../man3/MPI_Get_count.3.php">MPI_Get_count</a> and MPI_Get_element:   <p>
<br>
<pre>  ...
