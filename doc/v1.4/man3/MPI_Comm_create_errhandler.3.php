<?php
$topdir = "../../..";
$title = "MPI_Comm_create_errhandler(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_COMM_CREATE_ERRHANDLER(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI::Comm::Create_errhandler(MPI::Comm::Errhandler_fn*
...
MPI_Comm_create_errhandler creates
an error handler that can be attached to communicators. This function is
identical to <a href="../man3/MPI_Errhandler_create.3.php">MPI_Errhandler_create</a>, the use of which is deprecated.  <p>
In
C, the user routine should be a function of type MPI_Comm_errhandler_fn,
which is defined as  <p>
<br>
<pre>    typedef void MPI_Comm_errhandler_fn(MPI_Comm *, int *, ...);
</pre><p>
...
<br>
<pre>    SUBROUTINE COMM_ERRHANDLER_FN(COMM, ERROR_CODE, ...)
        INTEGER COMM, ERROR_CODE
</pre><p>
In C++, the user routine should be of this form: <p>
<br>
<pre>    typedef void MPI::Comm::Errhandler_fn(MPI_Comm &amp;, int *, ...);
</pre>
<p>
