<?php
$topdir = "../../..";
$title = "MPI_Alltoallw(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_ALLTOALLW(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int *sdispls, MPI_Datatype *sendtypes,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;void *recvbuf, int *recvcounts,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int *rdispls, MPI_Datatype *recvtypes, MPI_Comm comm)
</pre>
...
The MPI_IN_PLACE option is not available for any
form of all-to-all communication. <p>
The specification of counts, types, and
displacements should not cause any location to be written more than once.
<p>
All arguments on all processes are significant. The <i>comm</i> argument, in particular,
must describe the same communicator on all processes. <p>
The offsets of <i>sdispls</i>
and <i>rdispls</i> are measured in bytes. Compare this to <a href="../man3/MPI_Alltoallv.3.php">MPI_Alltoallv</a>, where
these offsets are measured in units of <i>sendtype</i> and <i>recvtype</i>, respectively.
