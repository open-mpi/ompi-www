<?php
$topdir = "../../..";
$title = "MPI_Type_lb(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_TYPE_LB(3)";
...
be used, respectively, to mark the lower bound (or the upper bound) of
