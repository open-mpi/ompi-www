<?php
$topdir = "../../..";
$title = "MPI_Win_create(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_WIN_CREATE(3)";
...
<dt>no_locks  </dt>
<dd>If <a href="../man3/MPI_Win_lock.3.php">MPI_Win_lock</a>
is called on a window created with this info key, the call will fail. If
this info key is present, it is assumed that the local window is never
...
Use memory allocated by <a href="../man3/MPI_Alloc_mem.3.php">MPI_Alloc_mem</a> to
