<?php
$topdir = "../../..";
$title = "MPI_Allgather(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_ALLGATHER(3)";
...
<b>MPI_Allgather</b> - Gathers data from all processes and distributes it
