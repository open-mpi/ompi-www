<?php
$topdir = "../../..";
$title = "MPI_Exscan(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_EXSCAN(3)";
...
<a href="../man3/MPI_Scan.3.php">MPI_SCAN</a>(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, IERROR)
...
the calling processes. The operation returns, in the <i>recvbuf</i> of the process
with rank i, the reduction (calculated according to the function <i>op</i>) of
the values in the <i>sendbuf</i>s of processes with ranks 0, ..., i-1. Compare this
with the functionality of <a href="../man3/MPI_Scan.3.php">MPI_Scan</a>, which calculates over the range 0,
..., i (inclusive). The type of operations supported, their semantics, and
the constraints on send and receive buffers are as for <a href="../man3/MPI_Reduce.3.php">MPI_Reduce</a>. <p>
The value
in <i>recvbuf</i> on process 0 is undefined and unreliable as <i>recvbuf</i> is not significant
for process 0. The value of <i>recvbuf</i> on process 1 is always the value in
<i>sendbuf</i> on process 0. <p>
...
for both processes&rsquo; <i>recvbuf</i> are degenerate. Therefore, all processes, including
0 and 1, must provide the same <i>op</i>. <p>
...
<i>op</i> functions as there is no way for MPI to "know" the unit value for these
custom operations.
<p>
