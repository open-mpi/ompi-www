<?php
$topdir = "../../..";
$title = "MPI_File_iwrite_at(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_FILE_IWRITE_AT(3)";
...
<pre>C Syntax
    ...
    <tt> </tt>&nbsp;<tt> </tt>&nbsp;      void *buf, int count, MPI_Datatype datatype, MPI_Request *request)
</pre>
