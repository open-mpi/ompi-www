<?php
$topdir = "../../..";
$title = "MPI_Group_difference(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_GROUP_DIFFERENCE(3)";
...
<b>MPI_Group_difference </b> - Makes a group from the difference of two groups.
