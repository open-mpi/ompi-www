<?php
$topdir = "../../..";
$title = "MPI_Comm_spawn_multiple(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_COMM_SPAWN_MULTIPLE(3)";
...
<i>array_of_info</i>, is an array of <i>info</i> arguments; however, only the first argument
in that array is used.  Any subsequent arguments in the array are ignored
because an <i>info</i> argument applies to the entire job that is spawned, and
