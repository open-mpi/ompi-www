<?php
$topdir = "../../..";
$title = "MPI_File_read_all_begin(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_FILE_READ_ALL_BEGIN(3)";
...
<b>MPI_File_read_all_begin</b> - Reads a file starting at the locations specified
...
read from the file associated with  <i>fh</i> (at the current individual file
