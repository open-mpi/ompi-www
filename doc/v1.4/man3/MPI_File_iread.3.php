<?php
$topdir = "../../..";
$title = "MPI_File_iread(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_FILE_IREAD(3)";
...
<b>MPI_File_iread</b> - Reads a file starting at the location specified by
