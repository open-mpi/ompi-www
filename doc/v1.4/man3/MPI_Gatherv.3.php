<?php
$topdir = "../../..";
$title = "MPI_Gatherv(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_GATHERV(3)";
...
<b>MPI_Gatherv</b> - Gathers varying amounts of data from all processes to
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;void *recvbuf, int *recvcounts, int *displs, MPI_Datatype recvtype,
...
of <a href="../man3/MPI_Gather.3.php">MPI_Gather</a> by allowing a varying count of data from each process, since
