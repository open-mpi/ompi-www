<?php
$topdir = "../../..";
$title = "MPI_Allgatherv(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_ALLGATHERV(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int *displs, MPI_Datatype recvtype, MPI_Comm comm)
</pre>
