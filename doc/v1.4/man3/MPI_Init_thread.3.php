<?php
$topdir = "../../..";
$title = "MPI_Init_thread(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_INIT_THREAD(3)";
...
switch.  You can check the output of <i><b>ompi_info</b>(1)</i> to see if Open MPI has
