<?php
$topdir = "../../..";
$title = "MPI_File_read(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_FILE_READ(3)";
...
<b>MPI_File_read</b> - Reads a file starting at the location specified by
...
<dd>Initial address of buffer (integer). </dd>
...
items having  <i>datatype</i> type into the user&rsquo;s buffer  <i>buf.</i> The data is taken
