<?php
$topdir = "../../..";
$title = "MPI_Type_get_extent(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_TYPE_GET_EXTENT(3)";
...
the lower bound and the extent of <i>datatype</i>.
<p>
<h2><a name='sect8' href='#toc8'>Note</a></h2>
Use of MPI_Type_get_extent
is strongly recommended over the old MPI-1 functions <a href="../man3/MPI_Type_extent.3.php">MPI_Type_extent</a> and
<a href="../man3/MPI_Type_lb.3.php">MPI_Type_lb</a>.
<p>
<h2><a name='sect9' href='#toc9'>Fortran 77 Notes</a></h2>
The MPI standard prescribes portable Fortran
syntax for the <i>LB</i> and <i>EXTENT</i> arguments only for Fortran 90. FORTRAN 77 users
