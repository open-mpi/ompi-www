<?php
$topdir = "../../..";
$title = "MPI_Type_match_size(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_TYPE_MATCH_SIZE(3)";
...
<p> <b>MPI_Type_match_size</b> - Returns an MPI datatype of a given type and
