<?php
$topdir = "../../..";
$title = "MPI_Graph_map(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_GRAPH_MAP(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int *edges, int *newrank)
</pre>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int edges[]) const
</pre>
