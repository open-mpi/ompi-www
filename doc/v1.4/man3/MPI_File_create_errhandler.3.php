<?php
$topdir = "../../..";
$title = "MPI_File_create_errhandler(3) man page (version 1.4.5)";
$meta_desc = "Open MPI v1.4.5 man page: MPI_FILE_CREATE_ERRHANDLER(3)";
...
#include &lt;mpi.h&gt; static MPI::Errhandler <tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI::File::Create_errhandler(MPI::File::Errhandler_fn*<br>
 <tt> </tt>&nbsp;<tt> </tt>&nbsp;<i>function</i>)<br>
...
Registers the user routine <i>function</i>
for use as an MPI exception handler. Returns in errhandler a handle to the
registered exception handler.  <p>
In the C language, the user routine <i>function</i>
should be a C function of type MPI_File_errhandler_fn, which is defined
as <p>
<br>
<pre>    typedef void (MPI_File_errhandler_fn)(MPI_File *, int *,
    ...);
</pre><p>
...
<br>
<pre>    SUBROUTINE FILE_ERRHANDLER_FN(FILE, ERROR_CODE, ...)
        INTEGER FILE, ERROR_CODE
</pre><p>
In C++, the user routine <i>function</i> should be of the form: <p>
<br>
<pre>    typedef void MPI::File::Errhandler_fn(MPI::File &amp;, int *,
    ...);
</pre><p>
