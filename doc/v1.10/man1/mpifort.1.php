<?php
$topdir = "../../..";
$title = "mpifort(1) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: mpifort(1)";
...
<i>mpifort</i> passes its arguments to the underlying
...
of the same version of Open MPI.  <p>
Indeed, since the wrappers are simply
thin shells on top of an underlying compiler, there are very, very few
compelling reasons <i>not</i> to use <i>mpifort</i>.  When it is not possible to use the
