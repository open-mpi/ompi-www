<?php
$topdir = "../../..";
$title = "mpicxx(1) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: mpicxx(1)";
...
Open MPI program requires the linkage of the Open MPI-specific libraries
...
<i>mpicxx</i> passes its arguments to the underlying
C++ compiler along with the -I, -L and -l options required by Open MPI programs.
 <p>
...
compelling reasons <i>not</i> to use <i>mpicxx</i>.  When it is not possible to use the
