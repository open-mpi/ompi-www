<?php
$topdir = "../../..";
$title = "mpic++(1) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: mpic++(1)";
...
<i>mpic++</i> passes its arguments to the underlying
...
compelling reasons <i>not</i> to use <i>mpic++</i>.  When it is not possible to use the
