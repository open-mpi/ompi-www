<?php
$topdir = "../../..";
$title = "MPI_Comm_get_info(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_COMM_GET_INFO(3)";
...
with  <i>comm</i>.<i></i> The current setting of all hints actually used by the system
related to this communicator is returned in  <i>info_used</i>.<i></i> If no such hints
