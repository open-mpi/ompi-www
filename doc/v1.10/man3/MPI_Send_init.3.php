<?php
$topdir = "../../..";
$title = "MPI_Send_init(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_SEND_INIT(3)";
...
that uses a persistent request is initiated by the function <a href="../man3/MPI_Start.3.php">MPI_Start</a> or
