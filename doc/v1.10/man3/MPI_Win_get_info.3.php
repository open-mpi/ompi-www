<?php
$topdir = "../../..";
$title = "MPI_Win_get_info(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_WIN_GET_INFO(3)";
...
with  <i>win</i>.<i></i> The current setting of all hints actually used by the system
related to this window is returned in  <i>info_used</i>.<i></i> If no such hints exist,
a handle to a newly created info object is returned that contains no key/value
pair. The user is responsible for freeing info_used via <a href="../man3/MPI_Info_free.3.php">MPI_Info_free</a>.
