<?php
$topdir = "../../..";
$title = "MPI_Iallgather(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_IALLGATHER(3)";
...
<b><a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a>, MPI_Iallgather</b> - Gathers data from all processes
...
<dt>sendtype     </dt>
<dd>Datatype of
send buffer elements (handle). </dd>

<dt>recvbuf     </dt>
<dd>Starting address of recv buffer
(choice). </dd>

<dt>recvcount     </dt>
<dd>Number of elements received from any process (integer).
</dd>
...
<a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a> is similar to <a href="../man3/MPI_Gather.3.php">MPI_Gather</a>, except that all processes
receive the result, instead of just the root. In other words, all processes
contribute to the result, and all processes receive the result.   <p>
The type
signature associated with sendcount, sendtype at a process must be equal
to the type signature associated with recvcount, recvtype at any other
process. <p>
The outcome of a call to <a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a>(...) is as if all processes
executed n calls to      <p>
<br>
