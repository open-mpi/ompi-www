<?php
$topdir = "../../..";
$title = "MPI_Type_indexed(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_TYPE_INDEXED(3)";
...
(array of integer for <b>MPI_TYPE_INDEXED</b>, array of  <i>MPI_Aint</i> for  <b><a href="../man3/MPI_Type_create_hindexed.3.php">MPI_TYPE_CREATE_HINDEXED</a></b>).
</dd>
...
The
function MPI_Type_indexed allows replication of an old datatype into a
...
extent 16. Let  B = (3, 1) and let D = (4, 0).  A call to MPI_Type_indexed(2,
