<?php
$topdir = "../../..";
$title = "MPI_Group_free(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_GROUP_FREE(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;GROUP, IERROR
</pre>
...
object for deallocation. The handle group is set to MPI_GROUP_NULL by the
call. Any ongoing operation using this group will complete normally.
<p>
<h2><a name='sect8' href='#toc8'>Note</a></h2>
On
return, group is set to MPI_GROUP_NULL.
<p>
