<?php
$topdir = "../../..";
$title = "MPI_File_get_amode(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_FILE_GET_AMODE(3)";
...
<dt>amode </dt>
<dd>File
access mode used to open the file (integer). </dd>
...
<p> MPI_File_get_amode returns, in  <i>amode,</i> the
access mode associated with the open file  <i>fh.</i>
<p>
