<?php
$topdir = "../../..";
$title = "MPI_Bcast(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_BCAST(3)";
...
process and the root. MPI_Bcast and all other data-movement collective routines
