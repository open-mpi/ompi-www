<?php
$topdir = "../../..";
$title = "MPI_Allgatherv(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_ALLGATHERV(3)";
...
MPI_Allgatherv is similar to <a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a> in that
