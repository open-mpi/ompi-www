<?php
$topdir = "../../..";
$title = "MPI_Ireduce_scatter_block(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_IREDUCE_SCATTER_BLOCK(3)";
...
on vector of <i>count =&nbsp;n * <i>recvcount</i> elements in the send buffer defined by
