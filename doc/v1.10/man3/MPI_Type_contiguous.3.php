<?php
$topdir = "../../..";
$title = "MPI_Type_contiguous(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_TYPE_CONTIGUOUS(3)";
...
The simplest
datatype constructor is MPI_Type_contiguous, which allows replication of
a datatype into contiguous locations.  <p>
<i>newtype</i> is the datatype obtained
by concatenating <i>count</i> copies of <i>oldtype</i>. Concatenation is defined using
the extent of <i>oldtype</i> as the size of the concatenated copies.   <p>
<b>Example:</b>
Let oldtype have type map {(double, 0), (char, 8)}, with extent 16, and
let count = 3. The type map of the datatype returned by newtype is
<p>
<br>
