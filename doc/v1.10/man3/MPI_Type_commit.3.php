<?php
$topdir = "../../..";
$title = "MPI_Type_commit(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_TYPE_COMMIT(3)";
...
The commit operation commits
the data type. A data type is the formal description of a communication
buffer, not the content of that buffer. After a data type has been committed,
it can be repeatedly reused to communicate the changing content of a buffer
