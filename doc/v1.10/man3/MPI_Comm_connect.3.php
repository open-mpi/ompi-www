<?php
$topdir = "../../..";
$title = "MPI_Comm_connect(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_COMM_CONNECT(3)";
...
MPI_Comm_connect establishes communication with
a server specified by <i>port_name</i>. It is collective over the calling communicator
...
being satisfied.
<p> The <i>port_name</i> parameter is the address of the server.
It must be the same as the name returned by <a href="../man3/MPI_Open_port.3.php">MPI_Open_port</a> on the server.
  <br>
