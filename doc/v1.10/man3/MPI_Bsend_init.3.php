<?php
$topdir = "../../..";
$title = "MPI_Bsend_init(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_BSEND_INIT(3)";
...
communication request for a buffered mode send, and binds to it all the
arguments of a send operation.  <p>
A communication (send or receive) that uses
a persistent request is initiated by the function <a href="../man3/MPI_Start.3.php">MPI_Start</a>.
<p>
