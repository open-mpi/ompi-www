<?php
$topdir = "../../..";
$title = "MPI_Errhandler_free(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_ERRHANDLER_FREE(3)";
...
<dt>errhandler </dt>
<dd>MPI error handler (handle). Set to MPI_ERRHANDLER_NULL
on exit.
<p> </dd>
</dl>
...
and sets errhandler to MPI_ERRHANDLER_NULL. The error handler will be deallocated
