<?php
$topdir = "../../..";
$title = "MPI_File_get_size(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_FILE_GET_SIZE(3)";
...
MPI_File_get_size returns, in  <i>size</i> , the current size in
bytes of the file associated with the file handle  <i>fh</i>. Note that the file
...
portable Fortran syntax for the <i>SIZE</i> argument only for Fortran 90. Sun FORTRAN
