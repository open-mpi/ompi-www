<?php
$topdir = "../../..";
$title = "MPI_Type_hindexed(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_TYPE_HINDEXED(3)";
...
<dd>Byte displacement of each block (C: array of  <i>MPI_Aint</i>, Fortran: array
of integer). </dd>
...
<a href="../man3/MPI_Type_create_hindexed.3.php">MPI_Type_create_hindexed</a> instead.  <p>
This deprecated routine is not available
in C++.  <p>
The function is identical to <a href="../man3/MPI_Type_indexed.3.php">MPI_Type_indexed</a>, except that block
displacements in array_of_displacements are specified in bytes, rather
than in multiples of the oldtype extent.  <p>
