<?php
$topdir = "../../..";
$title = "MPI_Status_c2f(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_STATUS_C2F(3)";
...
<b><a href="../man3/MPI_Status_f2c.3.php">MPI_Status_f2c</a>, MPI_Status_c2f </b> - Translates a C status into a
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Status_f2c.3.php">MPI_Status_f2c</a>(const MPI_Fint *f_status, MPI_Status *c_status)
...
the conversion.  <p>
When using <a href="../man3/MPI_Status_f2c.3.php">MPI_Status_f2c</a>, if <i>f_status</i> is a valid Fortran
status, but not the Fortran value of MPI_STATUS_IGNORE or MPI_STATUSES_IGNORE,
then <a href="../man3/MPI_Status_f2c.3.php">MPI_Status_f2c</a> returns in <i>c_status</i> a valid C status with the same
...
or if <i>f_status</i> is not a valid Fortran status, then the call is erroneous.
 <p>
When using MPI_Status_c2f, the opposite conversion is applied. If <i>c_status</i>
