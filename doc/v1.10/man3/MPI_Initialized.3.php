<?php
$topdir = "../../..";
$title = "MPI_Initialized(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_INITIALIZED(3)";
...
<dt>flag </dt>
<dd>Flag is true if <a href="../man3/MPI_Init.3.php">MPI_Init</a> has been called and false
otherwise. </dd>
...
This
routine may be used to determine whether <a href="../man3/MPI_Init.3.php">MPI_Init</a> has been called. It is
the only routine that may be called before <a href="../man3/MPI_Init.3.php">MPI_Init</a> is called.
<p>
