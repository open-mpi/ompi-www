<?php
$topdir = "../../..";
$title = "MPI_File_iread_at(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_FILE_IREAD_AT(3)";
...
the file associated with  <i>fh</i> at the  <i>offset</i> position a total number of
 <i>count</i> data items having  <i>datatype</i> type into the user&rsquo;s buffer  <i>buf.</i> The
...
of the file specified by the current view. MPI_File_iread_at stores the
number of  <i>datatype</i> elements actually read in  <i>status.</i> All other fields
of  <i>status</i> are undefined.
<p>
<h2><a name='sect7' href='#toc7'>Fortran 77 Notes</a></h2>
The MPI standard prescribes portable
Fortran syntax for the <i>OFFSET</i> argument only for Fortran 90.  Sun FORTRAN
