<?php
$topdir = "../../..";
$title = "MPI_Type_struct(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_TYPE_STRUCT(3)";
...
<a href="../man3/MPI_Type_create_struct.3.php">MPI_Type_create_struct</a> instead.  <p>
This deprecated routine is not available
in C++.  <p>
MPI_Type_struct is the most general type constructor. It further
generalizes <a href="../man3/MPI_Type_hindexed.3.php">MPI_Type_hindexed</a> in that it allows each block to consist of
replications of different datatypes.   <p>
