<?php
$topdir = "../../..";
$title = "MPI_Request_free(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_REQUEST_FREE(3)";
...
possible to check for the successful completion of the associated communication
...
either  <i><a href="../man3/MPI_Recv_init.3.php">MPI_Recv_init</a></i> or  <i><a href="../man3/MPI_Send_init.3.php">MPI_Send_init</a></i> and friends.  However, it can be
used to free a request created with  <i><a href="../man3/MPI_Irecv.3.php">MPI_Irecv</a></i> or  <i><a href="../man3/MPI_Isend.3.php">MPI_Isend</a></i> and friends;
in that case the use can not use the test/wait routines on the request.

<p> It  <b>is</b> permitted to free an active request.  However, once freed, you can
not use the request in a wait or test routine (e.g.,  <i><a href="../man3/MPI_Wait.3.php">MPI_Wait</a></i> ).
<p>
