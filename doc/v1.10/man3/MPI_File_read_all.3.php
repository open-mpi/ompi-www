<?php
$topdir = "../../..";
$title = "MPI_File_read_all(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_FILE_READ_ALL(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp; &lt;type&gt;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;BUF(*)
    <tt> </tt>&nbsp;<tt> </tt>&nbsp; INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;FH, COUNT, DATATYPE, STATUS(MPI_STATUS_SIZE),
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;IERROR
</pre>
...
MPI_File_read_all is
a collective routine that attempts to read from the file associated with
 <i>fh</i> (at the current individual file pointer position maintained by the
system) a total number of  <i>count</i> data items having  <i>datatype</i> type into
the user&rsquo;s buffer  <i>buf.</i> The data is taken out of those parts of the file
specified by the current view. MPI_File_read_all stores the number of data-type
