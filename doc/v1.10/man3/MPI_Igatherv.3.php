<?php
$topdir = "../../..";
$title = "MPI_Igatherv(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_IGATHERV(3)";
...
The outcome is as if each process, including
the root process, sends a message to the root,  <p>
<br>
