<?php
$topdir = "../../..";
$title = "MPI_Exscan(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_EXSCAN(3)";
...
that the definition of MPI_Exscan is unsatisfactory because the output
