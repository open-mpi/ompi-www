<?php
$topdir = "../../..";
$title = "MPI_Unpack_external(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_UNPACK_EXTERNAL(3)";
...
are relaxed for messages sent with type MPI_BYTE. <p>
