<?php
$topdir = "../../..";
$title = "MPI_File_preallocate(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_FILE_PREALLOCATE(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp; INTEGER(KIND=MPI_OFFSET_KIND) SIZE
</pre>
...
<dd>Size to preallocate file, in bytes (integer).
<p> </dd>
</dl>
...
MPI_File_preallocate ensures
that storage space is allocated for the first <i>size</i> bytes of the file associated
...
Sun MPI
I/O does not necessarily allocate file space for such new regions. You may
reserve file space either by using MPI_File_preallocate or by performing
a read or write to certain bytes.
<p>
