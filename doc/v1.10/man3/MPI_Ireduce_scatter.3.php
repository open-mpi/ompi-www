<?php
$topdir = "../../..";
$title = "MPI_Ireduce_scatter(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_IREDUCE_SCATTER(3)";
...
<b><a href="../man3/MPI_Reduce_scatter.3.php">MPI_Reduce_scatter</a>, MPI_Ireduce_scatter</b> - Combines values and
...
an element-wise reduction on vector of <i>count =&nbsp;S(i)<i>recvcounts</i>[i] elements
