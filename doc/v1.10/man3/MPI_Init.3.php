<?php
$topdir = "../../..";
$title = "MPI_Init(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_INIT(3)";
...
called before any other MPI routine (apart from <a href="../man3/MPI_Initialized.3.php">MPI_Initialized</a>) is called.
MPI can be initialized at most once; subsequent calls to MPI_Init or <a href="../man3/MPI_Init_thread.3.php">MPI_Init_thread</a>
are erroneous. <p>
...
modifies, interprets, nor distributes them: <p>
<br>
<pre><tt> </tt>&nbsp;<tt> </tt>&nbsp;{
