<?php
$topdir = "../../..";
$title = "MPI_Waitsome(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_WAITSOME(3)";
...
<dd>Number of completed requests (integer). </dd>

<dt>array_of_indices  </dt>
<dd>Array of indices
of operations that completed (array of integers). </dd>

<dt>array_of_statuses  </dt>
<dd>Array
of status objects for operations that completed (array of status). </dd>
...
handle is set to MPI_REQUEST_NULL.   <p>
If the list contains no active handles,
then the call returns immediately with outcount = MPI_UNDEFINED.  <p>
When one
...
error fields of the statuses.   <p>
