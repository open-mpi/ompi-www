<?php
$topdir = "../../..";
$title = "MPI_Errhandler_create(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_ERRHANDLER_CREATE(3)";
...
<b>MPI_Errhandler_create </b> - Creates an MPI-style error handler -- use
