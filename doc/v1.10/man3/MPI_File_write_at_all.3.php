<?php
$topdir = "../../..";
$title = "MPI_File_write_at_all(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_FILE_WRITE_AT_ALL(3)";
...
<pre>C Syntax
    #include &lt;mpi.h&gt;
    int MPI_File_write_at_all(MPI_File fh, MPI_Offset offset, const void
*buf,
...
having <i>datatype</i>  type from the user&rsquo;s buffer  <i>buf.</i> The offset is in etype
...
by the current view. MPI_File_write_at_all stores the number of  <i>datatype</i>
