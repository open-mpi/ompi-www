<?php
$topdir = "../../..";
$title = "MPI_Rsend_init(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_RSEND_INIT(3)";
...
the arguments of a send operation.   <p>
A communication (send or receive) that
uses a persistent request is initiated by the function <a href="../man3/MPI_Start.3.php">MPI_Start</a>.
<p>
