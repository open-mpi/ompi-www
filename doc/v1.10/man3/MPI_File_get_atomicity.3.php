<?php
$topdir = "../../..";
$title = "MPI_File_get_atomicity(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_FILE_GET_ATOMICITY(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER FIFH, IERRORFP
<tt> </tt>&nbsp;<tt> </tt>&nbsp;LOGICAL FIFLAGFP
</pre>
...
atomic mode is currently enabled; if  <i>flag</i>  is  <i>false,</i> nonatomic mode is
currently enabled.
<p>
