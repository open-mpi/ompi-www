<?php
$topdir = "../../..";
$title = "MPI_Iprobe(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_IPROBE(3)";
...
The <a href="../man3/MPI_Probe.3.php">MPI_Probe</a> and MPI_Iprobe
...
a call to <a href="../man3/MPI_Recv.3.php">MPI_Recv</a>(..., source, tag, comm, status) executed at the same point
in the program, and returns in status the same value that would have been
returned by <a href="../man3/MPI_Recv.3.php">MPI_Recv</a>(). Otherwise, the call returns flag = false, and leaves
status undefined.  <p>
...
length of the probed message. <p>
...
the user&rsquo;s responsibility to ensure that the last condition holds. <p>
The source
argument of <a href="../man3/MPI_Probe.3.php">MPI_Probe</a> can be MPI_ANY_SOURCE, and the tag argument can be
...
must be provided with the comm argument. <p>
If your application does not need
to examine the <i>status</i> field, you can save resources by using the predefined
constant MPI_STATUS_IGNORE as a special value for the <i>status</i> argument.
<p>
