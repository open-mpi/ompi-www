<?php
$topdir = "../../..";
$title = "MPI_File_write_at(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_FILE_WRITE_AT(3)";
...
buffer  <i>buf.</i> The offset is in  <i>etype</i> units relative to the current view.
That is, holes are not counted when locating an offset. The data is written
into those parts of the file specified by the current view. MPI_File_write_at
