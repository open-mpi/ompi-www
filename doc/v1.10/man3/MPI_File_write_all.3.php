<?php
$topdir = "../../..";
$title = "MPI_File_write_all(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_FILE_WRITE_ALL(3)";
...
from the user&rsquo;s buffer  <i>buf.</i> The data is written into those parts of the
file specified by the current view. MPI_File_write_all stores the number
of  <i>datatype</i>  elements actually written in  <i>status.</i>  All other fields of
 <i>status</i>  are undefined. <p>
