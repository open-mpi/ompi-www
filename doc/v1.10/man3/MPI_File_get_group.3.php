<?php
$topdir = "../../..";
$title = "MPI_File_get_group(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_FILE_GET_GROUP(3)";
...
<b>MPI_File_get_group</b> - Returns a duplicate of the process group of
a file.
<p>
...
<dt>group </dt>
<dd>Group
that opened the file (handle). </dd>
...
communicator used to open the file associated with  <i>fh.</i> The group is returned
in  <i>group.</i> The user is responsible for freeing  <i>group,</i>  using <a href="../man3/MPI_Group_free.3.php">MPI_Group_free</a>.
