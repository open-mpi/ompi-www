<?php
$topdir = "../../..";
$title = "MPI_Group_compare(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_GROUP_COMPARE(3)";
...
exactly the same in both groups. This happens for instance if group1 and
group2 are the same handle. MPI_SIMILAR results if the group members are
the same but the order is different. MPI_UNEQUAL results otherwise.
<p>
