<?php
$topdir = "../../..";
$title = "MPI_File_read_ordered(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_FILE_READ_ORDERED(3)";
...
<b>MPI_File_read_ordered</b> - Reads a file at a location specified by
a shared file pointer (blocking, collective).
<p>
...
number of  <i>count</i>  data items having  <i>datatype</i>  type into the user&rsquo;s buffer
 <i>buf.</i> For each process, the location in the file at which data is read is
the position at which the shared file pointer would be after all processes
