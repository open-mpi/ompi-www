<?php
$topdir = "../../..";
$title = "MPI_Get_elements_x(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_GET_ELEMENTS_X(3)";
...
portable Fortran syntax for the <i>COUNT</i> argument of MPI_Get_elements_x only
