<?php
$topdir = "../../..";
$title = "MPI_Raccumulate(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_RACCUMULATE(3)";
...
<b><a href="../man3/MPI_Accumulate.3.php">MPI_Accumulate</a></b> is a function
used for one-sided MPI communication that adds the contents of the origin
buffer (as defined by <i>origin_addr</i>, <i>origin_count</i>, and <i>origin_datatype</i>) to
the buffer specified by the arguments <i>target_count</i> and <i>target_datatype</i>,
at offset <i>target_disp</i>, in the target window specified by <i>target_rank</i> and
<i>win</i>, using the operation <i>op</i>. The target window can only be accessed by processes
within the same node. This is similar to <a href="../man3/MPI_Put.3.php">MPI_Put</a>, except that data is combined
into the target area instead of overwriting it. <p>
