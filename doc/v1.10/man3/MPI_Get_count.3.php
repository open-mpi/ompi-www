<?php
$topdir = "../../..";
$title = "MPI_Get_count(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_GET_COUNT(3)";
...
Also, this allows the same function to be used after a call to <a href="../man3/MPI_Probe.3.php">MPI_Probe</a>.

<p>
<h2><a name='sect8' href='#toc8'>Notes</a></h2>
If the size of the datatype is zero, this routine will return a count
of zero.  If the amount of data in  <i>status</i> is not an exact multiple of the
size of  <i>datatype</i> (so that  <i>count</i> would not be integral), a  <i>count</i> of <i>MPI_UNDEFINED</i>
is returned instead.
<p>
