<?php
$topdir = "../../..";
$title = "MPI_File_set_info(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_FILE_SET_INFO(3)";
...
new values for the hints of the file associated with <i>fh</i>. These hints are
set for each file, using the <a href="../man3/MPI_File_open.3.php">MPI_File_open</a>, <a href="../man3/MPI_File_delete.3.php">MPI_File_delete</a>, <a href="../man3/MPI_File_set_view.3.php">MPI_File_set_view</a>,
and MPI_File_set_info routines. The opaque <i>info</i> object, which allows you
to provide hints for optimization of your code, may be different on each
process, but some <i>info</i> entries are required to be the same on all processes:
In these cases, they must appear with the same value in each process&rsquo;s info
