<?php
$topdir = "../../..";
$title = "MPI_File_seek_shared(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_FILE_SEEK_SHARED(3)";
...
<b>MPI_File_seek_shared</b> - Updates the global shared file pointer (collective).
...
MPI_File_seek_shared updates the shared file
