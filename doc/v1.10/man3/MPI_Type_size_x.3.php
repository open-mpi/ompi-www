<?php
$topdir = "../../..";
$title = "MPI_Type_size_x(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_TYPE_SIZE_X(3)";
...
<b><a href="../man3/MPI_Type_size.3.php">MPI_Type_size</a></b>, <b>MPI_Type_size_x</b> - Returns the number of bytes occupied
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Type_size.3.php">MPI_Type_size</a>(MPI_Datatype datatype, int *size)
int MPI_Type_size_x(MPI_Datatype datatype, MPI_Count *size)
</pre>
<h2><a name='sect3' href='#toc3'>Fortran Syntax</a></h2>
<br>
<pre>INCLUDE &rsquo;mpif.h&rsquo;
<a href="../man3/MPI_Type_size.3.php">MPI_TYPE_SIZE</a>(DATATYPE, SIZE, IERROR)
...
<a href="../man3/MPI_Type_size.3.php">MPI_Type_size</a> returns the total size, in bytes, of the entries
...
syntax for the <i>SIZE</i> argument of MPI_Type_size_x only for Fortran 90. FORTRAN
