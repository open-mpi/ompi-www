<?php
$topdir = "../../..";
$title = "MPI_Buffer_attach(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_BUFFER_ATTACH(3)";
...
you do. For the purposes of calculating size, you should use <a href="../man3/MPI_Pack_size.3.php">MPI_Pack_size</a>.
In other words, in the code <p>
<br>
