<?php
$topdir = "../../..";
$title = "MPI_Address(3) man page (version 1.10.1)";
$meta_desc = "Open MPI v1.10.1 man page: MPI_ADDRESS(3)";
...
MPI_ADDRESS(LOCATION, ADDRESS, IERROR)<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;
<tt> </tt>&nbsp;<tt> </tt>&nbsp;&lt;type&gt;<tt> </tt>&nbsp;<tt> </tt>&nbsp;LOCATION (*) <tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;
...
function. Returns the (byte) address of location. <p>
Example: Using MPI_Address
for an array.  <p>
<br>
<pre>REAL A(100,100)
</pre><br>
