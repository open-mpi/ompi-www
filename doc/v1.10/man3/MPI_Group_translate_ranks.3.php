<?php
$topdir = "../../..";
$title = "MPI_Group_translate_ranks(3) man page (version 1.10.0)";
$meta_desc = "Open MPI v1.10.0 man page: MPI_GROUP_TRANSLATE_RANKS(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int ranks1[], const Group&amp; group2, int ranks2[])
</pre>
