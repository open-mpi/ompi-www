<?php
$topdir = "../../..";
$title = "MPI_Fetch_and_op(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_FETCH_AND_OP(3)";
...
<b>MPI_Fetch_and_op</b> - Combines the contents of the origin buffer with
