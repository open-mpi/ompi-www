<?php
$topdir = "../../..";
$title = "MPI_Iallreduce(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_IALLREDUCE(3)";
...
<a href="../man3/MPI_Allreduce.3.php">MPI_ALLREDUCE</a>(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, COMM, REQUEST, IERROR)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;&lt;type&gt;<tt> </tt>&nbsp;<tt> </tt>&nbsp;SENDBUF(*), RECVBUF(*)
