<?php
$topdir = "../../..";
$title = "MPI_Comm_size(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_COMM_SIZE(3)";
...
<b>MPI_Comm_size </b> - Returns the size of the group associated with a
communicator.
<p>
