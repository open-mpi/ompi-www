<?php
$topdir = "../../..";
$title = "MPI_Put(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_PUT(3)";
...
<b>MPI_Put</b>, <b><a href="../man3/MPI_Rput.3.php">MPI_Rput</a></b> - Copies data from the origin memory to the target.
...
<b>MPI_RputbP is similar to <b>MPI_Put<i>, except that it allocates
a communication request object and associates it with the request handle
(the argument <i>request</i></i></b></b>). The completion of an <a href="../man3/MPI_Rput.3.php">MPI_Rput</a> operation (i.e., after
