<?php
$topdir = "../../..";
$title = "MPI_Bcast(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_BCAST(3)";
...
root. MPI_Bcast and all other data-movement collective routines make this
