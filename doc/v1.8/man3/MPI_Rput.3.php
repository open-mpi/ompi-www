<?php
$topdir = "../../..";
$title = "MPI_Rput(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_RPUT(3)";
...
<b><a href="../man3/MPI_Put.3.php">MPI_Put</a></b>, <b>MPI_Rput</b> - Copies data from the origin memory to the target.
...
<b>MPI_RputbP is similar to <b><a href="../man3/MPI_Put.3.php">MPI_Put</a><i>, except that it allocates
a communication request object and associates it with the request handle
(the argument <i>request</i></i></b></b>). The completion of an MPI_Rput operation (i.e., after
