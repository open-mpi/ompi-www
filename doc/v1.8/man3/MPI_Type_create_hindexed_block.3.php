<?php
$topdir = "../../..";
$title = "MPI_Type_create_hindexed_block(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_TYPE_CREATE_HINDEXED_BLOCK(3)";
...
<a href="../man3/MPI_Type_create_indexed_block.3.php">MPI_Type_create_indexed_block</a> takes displacements in bytes.
<p>
