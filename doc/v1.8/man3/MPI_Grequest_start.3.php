<?php
$topdir = "../../..";
$title = "MPI_Grequest_start(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_GREQUEST_START(3)";
...
<b>MPI_Grequest_start </b> - Starts a generalized request and returns a
handle to it in <i>request</i>.
<p>
