<?php
$topdir = "../../..";
$title = "MPI_Ialltoallv(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_IALLTOALLV(3)";
...
<b><a href="../man3/MPI_Alltoallv.3.php">MPI_Alltoallv</a>, MPI_Ialltoallv</b> - All processes send different amount
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;RECVBUF, RECVCOUNTS, RDISPLS, RECVTYPE, REQUEST, COMM, IERROR)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;&lt;type&gt;<tt> </tt>&nbsp;<tt> </tt>&nbsp;SENDBUF(*), RECVBUF(*)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;SENDCOUNTS(*), SDISPLS(*), SENDTYPE
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;RECVCOUNTS(*), RDISPLS(*), RECVTYPE
...
<dd>Initial number of elements to skip at beginning of buffer (integer, Java-only).
</dd>

<dt>sendcounts </dt>
<dd>Integer array, where entry i specifies the number of elements
to send to rank i. </dd>

<dt>sdispls </dt>
<dd>Integer array, where entry i specifies the displacement
(offset from <i>sendbuf</i>, in units of <i>sendtype</i>) from which to send data to
rank i. </dd>
...
<dt>recvoffset     </dt>
<dd>Initial
number of elements to skip at beginning of buffer (integer, Java-only). </dd>

<dt>recvcounts
</dt>
<dd>Integer array, where entry j specifies the number of elements to receive
from rank j. </dd>

<dt>rdispls </dt>
<dd>Integer array, where entry j specifies the displacement
(offset from <i>recvbuf</i>, in units of <i>recvtype</i>) to which data from rank j should
be written. </dd>
...
<a href="../man3/MPI_Alltoallv.3.php">MPI_Alltoallv</a> is a generalized collective
operation in which all processes send data to and receive data from all
other processes. It adds flexibility to <a href="../man3/MPI_Alltoall.3.php">MPI_Alltoall</a> by allowing the user
...
<i>comm</i>) independent point-to-point communications (including communication
with itself). <p>
<br>
