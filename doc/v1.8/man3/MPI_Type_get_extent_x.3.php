<?php
$topdir = "../../..";
$title = "MPI_Type_get_extent_x(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_TYPE_GET_EXTENT_X(3)";
...
<b><a href="../man3/MPI_Type_get_extent.3.php">MPI_Type_get_extent</a></b>, <b>MPI_Type_get_extent_x</b> - Returns the lower bound
...
<a href="../man3/MPI_Type_get_extent.3.php">MPI_Type_get_extent</a> returns
the lower bound and the extent of <i>datatype</i>. For either function, if either
the <i>lb</i> or <i>extent</i> parameter cannot express the value to be returned (e.g.,
if the parameter is too small to hold the output value), it is set to MPI_UNDEFINED.
