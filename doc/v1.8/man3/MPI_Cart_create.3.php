<?php
$topdir = "../../..";
$title = "MPI_Cart_create(3) man page (version 1.8.1)";
$meta_desc = "Open MPI v1.8.1 man page: MPI_CART_CREATE(3)";
...
<br>
<pre>import mpi.*;
Cartcomm Intracomm.Create_cart(int dims[], const bool periods[], bool reorder)
</pre>
