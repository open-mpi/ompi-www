<?php
$topdir = "../../..";
$title = "MPI_Bsend_init(3) man page (version 4.0.2)";
$meta_desc = "Open MPI v4.0.2 man page: MPI_BSEND_INIT(3)";
...
request for a buffered mode send, and binds to it all the arguments of
a send operation. <p>
