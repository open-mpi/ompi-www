<?php
$topdir = "../../..";
$title = "MPI_Igatherv(3) man page (version 4.0.6)";
$meta_desc = "Open MPI v4.0.6 man page: MPI_IGATHERV(3)";
...
<b><a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>, MPI_Igatherv</b> - Gathers varying amounts of data from
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
...
<a href="../man3/MPI_Gatherv.3.php">MPI_GATHERV</a>(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNTS,
...
<br>
<pre>USE mpi_f08
<a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>(sendbuf, sendcount, sendtype, recvbuf, recvcounts, displs,
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: sendcount, recvcounts(*), displs(*), root
...
set (of 100) stride ints apart at receiving end. Use <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a> and the
...
<pre>      MPI_Comm comm;
  ...
  ...
      ...
      <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>(sendarray, 100, MPI_INT, rbuf, rcounts,
...
<pre>      MPI_Comm comm;
  ...
  ...
      ...
      <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>(sendarray, 1, stype, rbuf, rcounts,
                  displs, MPI_INT, root, comm);
</pre><p>
...
<pre>      MPI_Comm comm;
  ...
  ...
      ...
      <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>(sptr, 1, stype, rbuf, rcounts, displs, MPI_INT,
         root, comm);
</pre><p>
...
<pre>      MPI_Comm comm;
  ...
  ...
      ...
      <a href="../man3/MPI_Type_commit.3.php">MPI_Type_commit</a>( &amp;stype );
      sptr = &amp;sendarray[0][myrank];
      <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>(sptr, 100-myrank, stype, rbuf, rcounts,
                  displs, MPI_INT, root, comm);
</pre><p>
...
<pre>      MPI_Comm comm;
  ...
  /* set up displs and rcounts vectors first
      ...
      <a href="../man3/MPI_Type_commit.3.php">MPI_Type_commit</a>( &amp;stype );
      sptr = &amp;sendarray[0][myrank];
      <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>(sptr, 1, stype, rbuf, rcounts,
                  displs, MPI_INT, root, comm);
</pre><p>
...
<pre>      MPI_Comm comm;
  ...
  /* First, gather nums to root
      ...
      <a href="../man3/MPI_Type_commit.3.php">MPI_Type_commit</a>( &amp;stype );
      sptr = &amp;sendarray[0][myrank];
      <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>(sptr, num, stype, rbuf, rcounts,
                  displs, MPI_INT, root, comm);
</pre>
