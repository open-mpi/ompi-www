<?php
$topdir = "../../..";
$title = "MPI_Type_get_envelope(3) man page (version 4.0.6)";
$meta_desc = "Open MPI v4.0.6 man page: MPI_TYPE_GET_ENVELOPE(3)";
...
MPI_COMBINER_HVECTOR            <a href="../man3/MPI_Type_hvector.3.php">MPI_Type_hvector</a>
MPI_COMBINER_INDEXED            <a href="../man3/MPI_Type_indexed.3.php">MPI_Type_indexed</a>
MPI_COMBINER_HINDEXED           <a href="../man3/MPI_Type_hindexed.3.php">MPI_Type_hindexed</a>
MPI_COMBINER_INDEXED_BLOCK      <a href="../man3/MPI_Type_create_indexed_block.3.php">MPI_Type_create_indexed_block</a>
MPI_COMBINER_STRUCT             <a href="../man3/MPI_Type_struct.3.php">MPI_Type_struct</a>
