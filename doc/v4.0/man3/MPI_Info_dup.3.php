<?php
$topdir = "../../..";
$title = "MPI_Info_dup(3) man page (version 4.0.6)";
$meta_desc = "Open MPI v4.0.6 man page: MPI_INFO_DUP(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;INFO, NEWINFO, IERROR
</pre>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Info), INTENT(OUT) :: newinfo
