<?php
$topdir = "../../..";
$title = "MPI_Igather(3) man page (version 4.0.2)";
$meta_desc = "Open MPI v4.0.2 man page: MPI_IGATHER(3)";
...
<b><a href="../man3/MPI_Gather.3.php">MPI_Gather</a>, MPI_Igather</b> - Gathers values from a group of processes.
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Gather.3.php">MPI_Gather</a>(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
...
<a href="../man3/MPI_Gather.3.php">MPI_GATHER</a>(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT,
...
<br>
<pre>USE mpi_f08
<a href="../man3/MPI_Gather.3.php">MPI_Gather</a>(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype,
...
<pre>  MPI_Comm comm;
      ...
      <a href="../man3/MPI_Gather.3.php">MPI_Gather</a>( sendarray, 100, MPI_INT, rbuf, 100, MPI_INT, root, comm);
</pre><p>
<br>
...
<pre>  MPI_Comm comm;
      ...
      rbuf = (int *)malloc(gsize*100*sizeof(int));
      <a href="../man3/MPI_Gather.3.php">MPI_Gather</a>( sendarray, 100, MPI_INT, rbuf, 1, rtype, root, comm);
</pre>
<p>
