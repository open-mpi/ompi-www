<?php
$topdir = "../../..";
$title = "MPI_Type_free_keyval(3) man page (version 4.0.0)";
$meta_desc = "Open MPI v4.0.0 man page: MPI_TYPE_FREE_KEYVAL(3)";
...
<pre>USE mpi_f08
MPI_Type_free_keyval(type_keyval, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(INOUT) :: type_keyval
