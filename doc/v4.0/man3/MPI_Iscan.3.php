<?php
$topdir = "../../..";
$title = "MPI_Iscan(3) man page (version 4.0.4)";
$meta_desc = "Open MPI v4.0.4 man page: MPI_ISCAN(3)";
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Scan.3.php">MPI_Scan</a>(const void *sendbuf, void *recvbuf, int count,
...
USE mpi_f08 <a href="../man3/MPI_Scan.3.php">MPI_Scan</a>(<i>sendbuf</i>, <i>recvbuf</i>, <i>count</i>, <i>datatype</i>,
...
<p> MPI_Iscan(<i>sendbuf</i>, <i>recvbuf</i>, <i>count</i>, <i>datatype</i>, <i>op</i>, <i>comm</i>, <i>request</i>, <i>ierror</i>)
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<a href="../man3/MPI_Scan.3.php">MPI_Scan</a>(a, answer, 1, sspair, myOp, comm);
</pre>
<p>
