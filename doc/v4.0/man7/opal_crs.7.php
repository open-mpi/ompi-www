<?php
$topdir = "../../..";
$title = "opal_crs(7) man page (version 4.0.3)";
$meta_desc = "Open MPI v4.0.3 man page: opal_crs(7)";
...
Overview of Open PAL&rsquo;s CRS framework, and selected modules.  Open MPI 4.0.3.
