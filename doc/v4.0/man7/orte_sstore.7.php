<?php
$topdir = "../../..";
$title = "orte_sstore(7) man page (version 4.0.3)";
$meta_desc = "Open MPI v4.0.3 man page: orte_sstore(7)";
...
of Open RTE&rsquo;s SStore framework, and selected modules.  Open MPI 4.0.3
