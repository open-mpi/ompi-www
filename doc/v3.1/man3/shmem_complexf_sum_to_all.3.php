<?php
$topdir = "../../..";
$title = "shmem_complexf_sum_to_all(3) man page (version 3.1.1)";
$meta_desc = "Open MPI v3.1.1 man page: shmem_complexf_sum_to_all(3)";
...
<p> <i><i>shmem_comp4_sum_to_all</i>(3)</i>, <i><i>shmem_comp8_sum_to_all</i>(3)</i>, <i><i>shmem_complexd_sum_to_all</i>(3)</i>,
<i><i>shmem_complexf_sum_to_all</i>(3)</i>, <i><i>shmem_double_sum_to_all</i>(3)</i>, <i><i>shmem_float_sum_to_all</i>(3)</i>,
<i><i>shmem_int_sum_to_all</i>(3)</i>, <i><i>shmem_int4_sum_to_all</i>(3)</i>, <i><i>shmem_int8_sum_to_all</i>(3)</i>,
<i><i>shmem_long_sum_to_all</i>(3)</i>, <i><i>shmem_longdouble_sum_to_all</i>(3)</i>, <i><i>shmem_longlong_sum_to_all</i>(3)</i>,
<i><i>shmem_real4_sum_to_all</i>(3)</i>, <i><i>shmem_real8_sum_to_all</i>(3)</i>, <i><i>shmem_real16_sum_to_all</i>(3)</i>,
<i><i>shmem_short_sum_to_all</i>(3)</i> - Performs a sum reduction across a set of processing
elements (PEs)
...
<dt>target </dt>
<dd>The remotely accessible
integer data object to be updated on the remote PE. If you are using C/C++,
the type of target should match that implied in the SYNOPSIS section. If
you are using the Fortran compiler, it must be of type integer with an
element size of 4 bytes for SHMEM_INT4_ADD and 8 bytes for SHMEM_INT8_ADD.
</dd>

<dt>value </dt>
<dd>The value to be atomically added to target. If you are using C/C++,
the type of value should match that implied in the SYNOPSIS section. If
you are using Fortran, it must be of type integer with an element size
of target. </dd>

<dt>pe </dt>
<dd>An integer that indicates the PE number upon which target
is to be updated. If you are using Fortran, it must be a default integer
value. </dd>

<dt>target </dt>
<dd>A symmetric array of length nreduce elements to receive the
results of the reduction operations. <br>
...
target data types are as follows: <blockquote></dd>

<dt><b>shmem_comp4_sum_to_all:</b> COMPLEX(KIND=4).
</dt>
<dd></dd>

<dt><b>shmem_comp8_sum_to_all:</b> Complex. If you are using Fortran, it must be </dt>
<dd>a
default complex value. </dd>

<dt><b>shmem_int4_sum_to_all:</b> INTEGER(KIND=4). </dt>
<dd></dd>

<dt><b>shmem_int8_sum_to_all:</b>
Integer. If you are using Fortran, it must be a </dt>
<dd>default integer value. </dd>

<dt><b>shmem_real4_sum_to_all:</b>
REAL(KIND=4). </dt>
<dd></dd>

<dt><b>shmem_real8_sum_to_all:</b> Real. If you are using Fortran, it
must be a </dt>
<dd>default real value. </dd>

<dt><b>shmem_real16_sum_to_all:</b> Real. If you are using
Fortran, it must be a </dt>
<dd>default real value. </dd>
</dl>
</blockquote>
<blockquote><p>
...
SHMEM_REDUCE_SYNC_SIZE. It must be a default integer value. Every element
...
aligned are defined in <i><i>intro_shmem</i>(3)</i>. <p>
All SHMEM reduction routines reset
...
<p> <b>Example
1:</b> This Fortran example statically initializes the pSync array and finds
the sum of the real variable FOO across all even PEs. <br>
<pre>INCLUDE "mpp/shmem.fh"
INTEGER PSYNC(SHMEM_REDUCE_SYNC_SIZE)
...
IF ( MOD(MY_PE(),2) .EQ. 0) THEN
  ...
  &amp; PWRK, PSYNC)
  PRINT *, &rsquo;Result on PE &rsquo;, MY_PE(), &rsquo; is &rsquo;, FOOSUM
ENDIF
</pre> <b>Example 2:</b> Consider the following C/C++ call: <br>
<pre>shmem_int_sum_to_all( target, source, 3, 0, 0, 8, pwrk, psync );
</pre> The preceding call is more efficient, but semantically equivalent to,
the combination of the following calls: <br>
<pre>shmem_int_sum_to_all(&amp;(target[0]), &amp;(source[0]), 1, 0, 0, 8,
  pwrk1, psync1);
