<?php
$topdir = "../../..";
$title = "MPI_File_get_position_shared(3) man page (version 3.1.5)";
$meta_desc = "Open MPI v3.1.5 man page: MPI_FILE_GET_POSITION_SHARED(3)";
...
<b>MPI_File_get_position_shared</b> - Returns the current position of
the shared file pointer.
<p>
<h2><a name='sect1' href='#toc1'>Syntax</a></h2>
<br>
<pre>C Syntax    #include &lt;mpi.h&gt;
