<?php
$topdir = "../../..";
$title = "shmem_longlong_or_to_all(3) man page (version 3.1.1)";
$meta_desc = "Open MPI v3.1.1 man page: shmem_longlong_or_to_all(3)";
...
<p> <i><i>shmem_int_or_to_all</i>(3)</i>, <i><i>shmem_int4_or_to_all</i>(3)</i>, <i><i>shmem_int8_or_to_all</i>(3)</i>,
<i><i>shmem_long_or_to_all</i>(3)</i>, <i><i>shmem_longlong_or_to_all</i>(3)</i>, <i><i>shmem_short_or_to_all</i>(3)</i>
...
of other SHMEM reduction routines, see <i>intro_shmem(3)</i>. <p>
As with all SHMEM
...
<dt><b>shmem_int8_or_to_all</b> Integer, with an element size of 8
bytes. </dt>
<dd></dd>

<dt><b>shmem_int4_or_to_all</b> Integer, with an element size of 4 bytes. </dt>
<dd></dd>
</dl>
</blockquote>
<blockquote><p>
...
<p> The terms collective, symmetric, and cache aligned are defined in
<i><i>intro_shmem</i>(3)</i>. All SHMEM reduction routines reset the values in pSync before
they return, so a particular pSync buffer need only be initialized the
first time it is used. <p>
...
on successive calls. <p>

<h2><a name='sect4' href='#toc4'>Examples</a></h2>

<p> <b>Example 1:</b> This Fortran example statically
initializes the pSync array and finds the logical OR of the integer variable
FOO across all even PEs. <br>
<pre>INCLUDE "mpp/shmem.fh"
INTEGER PSYNC(SHMEM_REDUCE_SYNC_SIZE)
...
no synchronization is done between calls. <p>
