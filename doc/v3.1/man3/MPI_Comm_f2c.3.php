<?php
$topdir = "../../..";
$title = "MPI_Comm_f2c(3) man page (version 3.1.5)";
$meta_desc = "Open MPI v3.1.5 man page: MPI_COMM_F2C(3)";
...
to a communicator, then MPI_Comm_f2c returns a valid C handle to that same
communicator; if <i>comm</i> = MPI_COMM_NULL (Fortran value), then MPI_Comm_f2c
returns a null C handle; if <i>comm</i> is an invalid Fortran handle, then MPI_Comm_f2c
