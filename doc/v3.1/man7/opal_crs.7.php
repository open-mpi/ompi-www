<?php
$topdir = "../../..";
$title = "opal_crs(7) man page (version 3.1.0)";
$meta_desc = "Open MPI v3.1.0 man page: opal_crs(7)";
...
Overview of Open PAL&rsquo;s CRS framework, and selected modules.  Open MPI 3.1.0.
