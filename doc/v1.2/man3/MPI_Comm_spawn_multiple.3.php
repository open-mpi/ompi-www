<?php
$topdir = "../../..";
$title = "MPI_Comm_spawn_multiple(3) man page (version 1.2.9)";
...
<H2>DESCRIPTION</H2><PRE>
       ...
       Note that in Open MPI 1.2, the first array location in <I>array</I><B>_</B><I>of</I><B>_</B><I>info</I> is
...
<H2>SEE ALSO</H2><PRE>
       <B><a href="../man3/MPI_Comm_spawn.3.php">MPI_Comm_spawn</a>(3)</B>
       <B><a href="../man3/MPI_Comm_get_parent.3.php">MPI_Comm_get_parent</a>(3)</B>
       <B>mpirun(1)</B>

</PRE>
<H2>Open MPI 1.2                    September 200MPI_Comm_spawn_multiple(3OpenMPI)</H2><PRE>
</PRE>
