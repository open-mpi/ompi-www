<?php
$topdir = "../../..";
$title = "MPI_Group_difference(3) man page (version 1.2.9)";
...
<H2>NAME</H2><PRE>
       <B>MPI_Group_difference</B>   -  Makes  a  group  from  the  difference of two
       groups.
...
<H2>C Syntax</H2><PRE>
       #include &lt;mpi.h&gt;
       int MPI_Group_difference(MPI_Group <I>group1</I>, MPI_Group <I>group2</I>,
            MPI_Group <I>*newgroup</I>)

</PRE>
<H2>Fortran Syntax</H2><PRE>
       INCLUDE 'mpif.h'
       MPI_GROUP_DIFFERENCE(<I>GROUP1,</I> <I>GROUP2,</I> <I>NEWGROUP,</I> <I>IERROR</I>)
            INTEGER   <I>GROUP1,</I> <I>GROUP2,</I> <I>NEWGROUP,</I> <I>IERROR</I>

</PRE>
<H2>C++ Syntax</H2><PRE>
       #include &lt;mpi.h&gt;
       static Group Group::Difference(const Group&amp; <I>group1</I>, const Group&amp; <I>group2</I>)
...
<H2>DESCRIPTION</H2><PRE>
       The set-like operations are defined as follows:
         ...
         o    union -- All elements of the first group (group1),  followed  by
              all  elements of second group (group2) that are not in the first
              group
...
Open MPI 1.2                    September 2006  MPI_Group_difference(3OpenMPI)
</PRE>
