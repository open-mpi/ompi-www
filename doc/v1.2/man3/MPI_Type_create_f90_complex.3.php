<?php
$topdir = "../../..";
$title = "MPI_Type_create_f90_complex(3) man page (version 1.2.9)";
...
<H2>NAME</H2><PRE>
       <B>MPI_Type_create_f90_complex</B> - Returns a bounded MPI complex datatype
...
<H2>C Syntax</H2><PRE>
       #include &lt;mpi.h&gt;
       int MPI_Type_create_f90_complex(int <I>p</I>, int <I>r</I>,
            MPI_Datatype *<I>newtype</I>)

</PRE>
<H2>Fortran Syntax</H2><PRE>
       INCLUDE 'mpif.h'
       MPI_TYPE_CREATE_F90_COMPLEX (<I>P,</I> <I>R,</I> <I>NEWTYPE,</I> <I>IERROR</I>)
            INTEGER   <I>P,</I> <I>R,</I> <I>NEWTYPE,</I> <I>IERROR</I>

</PRE>
<H2>C++ Syntax</H2><PRE>
       #include &lt;mpi.h&gt;
       static MPI::Datatype MPI::Datatype::Create_f90_complex(int <I>p</I>, int <I>r</I>)
...
<H2>DESCRIPTION</H2><PRE>
       ...
       ate_f90_complex may be set to MPI_UNDEFINED.
...
<H2>NOTES</H2><PRE>
       ...
       <a href="../man3/MPI_Unpack_external.3.php">MPI_Unpack_external</a>, and many  MPI_File  functions  -  is  subtle.  The
...
<H2>Open MPI 1.2                    SeptemberMPI_Type_create_f90_complex(3OpenMPI)</H2><PRE>
</PRE>
