<?php
$topdir = "../../..";
$title = "MPI_File_write_at_all_begin(3) man page (version 1.2.9)";
...
<H2>SYNTAX</H2><PRE>
       C Syntax
           #include &lt;mpi.h&gt;
           int MPI_File_write_at_all_begin(MPI_File <I>fh</I>, MPI_Offset <I>offset</I>,
                  void <I>*buf</I>, int <I>count</I>, MPI_Datatype <I>datatype</I>)

       Fortran Syntax (see FORTRAN 77 NOTES)
           INCLUDE 'mpif.h'
           MPI_FILE_WRITE_AT_ALL_BEGIN(<I>FH</I>, <I>OFFSET</I>, <I>BUF</I>, <I>COUNT</I>, <I>DATATYPE</I>, <I>IERROR</I>)
                 &lt;TYPE&gt; <I>BUF</I>(*)
...
<H2>C++ Syntax</H2><PRE>
       #include &lt;mpi.h&gt;
       void MPI::File::Write_at_all_begin(MPI::Offset <I>offset</I>,
            const void* <I>buf</I>, int <I>count</I>,
...
<H2>DESCRIPTION</H2><PRE>
       ...
       file associated with <I>fh</I> (at the <I>offset</I>  position)  a  total  number  of
       <I>count</I>  data items having <I>datatype</I> type from the user's buffer <I>buf.</I>  The
...
<H2>Open MPI 1.2                    SeptemberMPI_File_write_at_all_begin(3OpenMPI)</H2><PRE>
</PRE>
