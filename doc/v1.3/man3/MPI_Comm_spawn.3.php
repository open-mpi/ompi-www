<?php
$topdir = "../../..";
$title = "MPI_Comm_spawn(3) man page (version 1.3.4)";
...
<H2>OUTPUT PARAMETER</H2><PRE>
       ...
       The following keys for <I>info</I> are recognized in Open MPI.  (The  reserved
       ...
       host                  char *    Host on which the process should be spawned.
                                       See the <I>orte</I><B>_</B><I>host</I> man page for an
                                       explanation of how this will be used.
       hostfile              char *    Hostfile containing the hosts on which
                                       the processes are to be spawned. See
                                       the <I>orte</I><B>_</B><I>hostfile</I> man page for an
                                       explanation of how this will be used.
...
<H2>SEE ALSO</H2><PRE>
       <B><a href="../man3/MPI_Comm_spawn_multiple.3.php">MPI_Comm_spawn_multiple</a>(3)</B>
       <B><a href="../man3/MPI_Comm_get_parent.3.php">MPI_Comm_get_parent</a>(3)</B>
       <B>mpirun(1)</B>

1.3.4                            Nov 11, 2009                <B>MPI_Comm_spawn(3)</B>
</PRE>
