<?php
$topdir = "../../..";
$title = "MPI_File_close(3) man page (version 1.3.4)";
...
<H2>SYNTAX</H2><PRE>
       C Syntax
           #include &lt;mpi.h&gt;
           int MPI_File_close(MPI_File <I>*fh</I>)

       Fortran Syntax
           INCLUDE 'mpif.h'
           MPI_FILE_CLOSE(<I>FH</I>, <I>IERROR</I>)
                  INTEGER    FH, IERROR
...
<H2>DESCRIPTION</H2><PRE>
       ...
       associated with <I>fh.</I>  MPI_File_close is a collective routine.  The  user
       is  responsible  for  ensuring that all outstanding requests associated
       with <I>fh</I> have completed before calling MPI_File_close.
...
1.3.4                            Nov 11, 2009                <B>MPI_File_close(3)</B>
</PRE>
