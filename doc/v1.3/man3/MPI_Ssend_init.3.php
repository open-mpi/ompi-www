<?php
$topdir = "../../..";
$title = "MPI_Ssend_init(3) man page (version 1.3.4)";
...
<H2>C Syntax</H2><PRE>
       #include &lt;mpi.h&gt;
       int MPI_Ssend_init(void *<I>buf</I>, int <I>count</I>, MPI_Datatype <I>datatype</I>,
            int <I>dest</I>, int <I>tag</I>, MPI_Comm <I>comm</I>, MPI_Request <I>*request</I>)

</PRE>
<H2>Fortran Syntax</H2><PRE>
       INCLUDE 'mpif.h'
       MPI_SSEND_INIT(<I>BUF,</I> <I>COUNT,</I> <I>DATATYPE,</I> <I>DEST,</I> <I>TAG,</I> <I>COMM,</I> <I>REQUEST,</I>
                 <I>IERROR</I>)
            &lt;type&gt;    <I>BUF</I>(*)
...
<H2>C++ Syntax</H2><PRE>
       #include &lt;mpi.h&gt;
       Prequest Comm::Ssend_init(const void* <I>buf</I>, int <I>count</I>, const
...
1.3.4                            Nov 11, 2009                <B>MPI_Ssend_init(3)</B>
</PRE>
