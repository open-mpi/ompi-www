<?php
$topdir = "../../..";
$title = "mpic++(1) man page (version 1.3.4)";
...
<H2>OPTIONS</H2><PRE>
       -showme
              ...
              ple,  both  "mpic++  --showme" and "mpic++ --showme my_source.c"
              will show all the wrapper-supplied flags.  But  "mpic++  -showme
...
<H2>DESCRIPTION</H2><PRE>
   ...
   <B>Background</B>
       ...
       <I>mpic++</I> passes its arguments to the underlying C++ compiler  along  with
       ...
       <I>mpic++</I>.   When  it  is  not  possible to use the wrappers directly, the
...
<H2>FILES</H2><PRE>
       ...
       ated  by  Open  MPI  and installed to <I>$pkgdata/mpic++-wrapper-data.txt</I>,
...
<H2>ENVIRONMENT VARIABLES</H2><PRE>
       ...
       files  containing  this  configuration  information (see the <B>FILES</B> sec-
       LDFLAGS
