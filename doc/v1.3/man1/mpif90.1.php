<?php
$topdir = "../../..";
$title = "mpif90(1) man page (version 1.3.4)";
...
<H2>OPTIONS</H2><PRE>
       -showme
              ...
              ple,  both  "mpif90  --showme" and "mpif90 --showme my_source.c"
              will show all the wrapper-supplied flags.  But  "mpif90  -showme
              -v" will only show the underlying compiler name and "-v".

       -showme:compile
              Do not invoke the underlying Fortran 90 compiler.  Instead, show
              the compiler flags that would be supplied to the Fortran 90 com-
              piler.

       -showme:link
              Do not invoke the underlying Fortran 90 compiler.  Instead, show
              the linker flags that would be supplied to the Fortran  90  com-
              piler.

       See  the  man  page for your underlying compiler for other options that
       can be passed through mpif90
...
<H2>DESCRIPTION</H2><PRE>
   ...
   <B>Background</B>
       ...
       <I>mpif90</I> passes its arguments to the underlying Fortran 90 compiler along
       ...
       <I>mpif90</I>.   When  it  is  not  possible to use the wrappers directly, the
...
<H2>FILES</H2><PRE>
       ...
       ated  by  Open  MPI  and installed to <I>$pkgdata/mpif90-wrapper-data.txt</I>,
...
1.3.4                            Nov 11, 2009                        <B>mpif90(1)</B>
</PRE>
