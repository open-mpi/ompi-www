<?php
$topdir = "../../..";
$title = "mpicxx(1) man page (version 1.3.4)";
...
<H2>OPTIONS</H2><PRE>
       -showme
              ...
              ple,  both  "mpicxx  --showme" and "mpicxx --showme my_source.c"
...
<H2>DESCRIPTION</H2><PRE>
   ...
   <B>Background</B>
       ...
       <I>mpicxx</I> passes its arguments to the underlying C++ compiler  along  with
       ...
       <I>mpicxx</I>.   When  it  is  not  possible to use the wrappers directly, the
...
<H2>FILES</H2><PRE>
       ...
       ated  by  Open  MPI  and installed to <I>$pkgdata/mpicxx-wrapper-data.txt</I>,
...
1.3.4                            Nov 11, 2009                        <B>mpicxx(1)</B>
</PRE>
