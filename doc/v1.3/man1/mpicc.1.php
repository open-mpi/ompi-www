<?php
$topdir = "../../..";
$title = "mpicc(1) man page (version 1.3.4)";
...
<H2>DESCRIPTION</H2><PRE>
   ...
   <B>Background</B>
       ...
       directories  of  <B>ld(1)</B>.  It also often requires the inclusion of header
       files what may also not be found in a standard location.

       <I>mpicc</I> passes its arguments to the underlying C compiler along with  the
       ...
       <I>mpicc</I>.   When  it  is  not  possible  to use the wrappers directly, the
...
<H2>FILES</H2><PRE>
       ...
       ated  by  Open  MPI  and  installed to <I>$pkgdata/mpicc-wrapper-data.txt</I>,
