<?php
$topdir = "../../..";
$title = "mpicxx(1) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: mpicxx(1)";
...
flags.  For example, both "mpicxx --showme" and "mpicxx --showme my_source.c"
will show all the wrapper-supplied flags.  But "mpicxx --showme -v" will only
...
<i>mpicxx</i> is a convenience wrappers for the underlying
...
options required by Open MPI programs.  <p>
...
there are very, very few compelling reasons <i>not</i> to use <i>mpicxx</i>.  When it
