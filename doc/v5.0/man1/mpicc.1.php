<?php
$topdir = "../../..";
$title = "mpicc(1) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: mpicc(1)";
...
<i>mpicc</i> is a convenience wrappers for the underlying
...
<i>mpicc</i> passes its
arguments to the underlying C compiler along with the -I, -L and -l options
required by Open MPI programs.  <p>
The Open MPI Team <i>strongly</i> encourages using
the wrapper compilers instead of attempting to link to the Open MPI libraries
manually.  This allows the specific implementation of Open MPI to change
without forcing changes to linker directives in users&rsquo; Makefiles.  Indeed,
...
different installations of the same version of Open MPI.  <p>
Indeed, since
the wrappers are simply thin shells on top of an underlying compiler, there
are very, very few compelling reasons <i>not</i> to use <i>mpicc</i>.  When it is not
possible to use the wrappers directly, the <i>-showme:compile</i> and <i>-showme:link</i>
