<?php
$topdir = "../../..";
$title = "mpic++(1) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: mpic++(1)";
...
<i>mpic++</i> is a convenience wrappers for the underlying
...
there are very, very few compelling reasons <i>not</i> to use <i>mpic++</i>.  When it
