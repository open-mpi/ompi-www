<?php
$topdir = "../../..";
$title = "MPI_Alloc_mem(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_ALLOC_MEM(3)";
...
of this memory is returned in the variable <i>baseptr</i>. <p>

<p>
<h2><a name='sect8' href='#toc8'>C Notes</a></h2>
The parameter
<i>baseptr</i> is of type <i>void *</i> to allow passing any pointer object for this
parameter. The provided argument should be a pointer to a pointer of arbitrary
type (e.g., <i>void **</i>).
<p>
<h2><a name='sect9' href='#toc9'>Fortran Notes</a></h2>
There is no portable FORTRAN 77 syntax
for using MPI_Alloc_mem. There is no portable Fortran syntax for using pointers
returned from MPI_Alloc_mem. However, MPI_Alloc_mem can be used with Sun
Fortran compilers. <p>
From FORTRAN 77, you can use the following non-standard
declarations for the SIZE and BASEPTR arguments: <br>
<pre>           INCLUDE "mpif.h"
...
<li><a name='toc8' href='#sect8'>C Notes</a></li>
<li><a name='toc9' href='#sect9'>Fortran Notes</a></li>
