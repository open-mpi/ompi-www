<?php
$topdir = "../../..";
$title = "MPI_Init_thread(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_INIT_THREAD(3)";
...
<dt>argc </dt>
<dd>C only: Pointer to the number of arguments. </dd>

<dt>argv </dt>
<dd>C
only: Argument vector. </dd>
...
C <i>argc</i> and <i>argv</i> arguments to main, but neither modifies, interprets, nor
distributes them: <p>
<br>
<pre><tt> </tt>&nbsp;<tt> </tt>&nbsp;{
