<?php
$topdir = "../../..";
$title = "MPI_Type_create_hindexed(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_TYPE_CREATE_HINDEXED(3)";
...
<br>
<pre>USE mpi_f08
<a href="../man3/MPI_Type_indexed.3.php">MPI_Type_indexed</a>(count, array_of_blocklengths, array_of_displacements,
...
<dd>Displacement for each block, in multiples of oldtype extent for <a href="../man3/MPI_Type_indexed.3.php">MPI_Type_indexed</a>
and bytes for MPI_Type_create_hindexed (array of integer for <b><a href="../man3/MPI_Type_indexed.3.php">MPI_TYPE_INDEXED</a></b>,
array of <i>MPI_Aint</i> for <b>MPI_TYPE_CREATE_HINDEXED</b>). </dd>
...
The function <a href="../man3/MPI_Type_indexed.3.php">MPI_Type_indexed</a> allows replication
...
to <a href="../man3/MPI_Type_indexed.3.php">MPI_Type_indexed</a>(2, B, D, oldtype, newtype) returns a datatype with
type map <p>
<br>
