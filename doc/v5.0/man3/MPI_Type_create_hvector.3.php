<?php
$topdir = "../../..";
$title = "MPI_Type_create_hvector(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_TYPE_CREATE_HVECTOR(3)";
...
<b>MPI_Type_create_hvector</b> - Creates a vector (strided) data type
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER(KIND=MPI_ADDRESS_KIND), INTENT(IN) :: stride
...
data type with offset in bytes. <p>
