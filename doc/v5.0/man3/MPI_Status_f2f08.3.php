<?php
$topdir = "../../..";
$title = "MPI_Status_f2f08(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_STATUS_F2F08(3)";
...
<p>
<a href="../man3/MPI_Status_f082f.3.php">MPI_Status_f082f</a>, <a href="../man3/MPI_Status_c2f08.3.php">MPI_Status_c2f08</a> - Translates a Fortran 2008 status
...
<h3><a name='sect3' href='#toc3'>C]#include &lt;mpi.h&gt;int <a href="../man3/MPI_Status_f082f.3.php">MPI_Status_f082f</a>(const MPI_F08_status *f08_status, MPI_Fint
*f_status)int MPI_Status_f2f08(const MPI_Fint *f_status, MPI_F08_status
...
<p>
When using C]<a href="../man3/MPI_Status_f082f.3.php">MPI_Status_f082f</a>()R], if C]f08_statusR] is a valid Fortran
...
or C]MPI_STATUSES_IGNORER] (in Fortran), then C]<a href="../man3/MPI_Status_f082f.3.php">MPI_Status_f082f</a>()R] returns
...
<p>
When using C]MPI_Status_f2f08()R], the opposite conversion is applied. If
...
<li><a name='toc3' href='#sect3'>C]#include <mpi.h>int <a href="../man3/MPI_Status_f082f.3.php">MPI_Status_f082f</a>(const MPI_F08_status *f08_status, MPI_Fint *f_status)int MPI_Status_f2f08(const MPI_Fint *f_status, MPI_F08_status *f08_status)R]Fortran mpi Module Syntax</a></li>
