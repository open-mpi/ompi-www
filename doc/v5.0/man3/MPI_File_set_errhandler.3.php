<?php
$topdir = "../../..";
$title = "MPI_File_set_errhandler(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_FILE_SET_ERRHANDLER(3)";
...
MPI_File_set_errhandler; the predefined error handler MPI_ERRORS_ARE_FATAL
