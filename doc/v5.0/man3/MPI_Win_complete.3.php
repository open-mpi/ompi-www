<?php
$topdir = "../../..";
$title = "MPI_Win_complete(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_WIN_COMPLETE(3)";
...
for I/O function errors. The error handler may be changed with <a href="../man3/MPI_Win_set_errhandler.3.php">MPI_Win_set_errhandler</a>;
