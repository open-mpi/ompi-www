<?php
$topdir = "../../..";
$title = "MPI_Dist_graph_create(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_DIST_GRAPH_CREATE(3)";
...
specifies edges (array of non-negative integers). </dd>
...
<dt>info </dt>
<dd>Hints on optimization and interpretation of weights (handle). </dd>
...
<dd>Communicator with distributed graph topology added (handle). </dd>
...
precisely, if the i-th node in sources is s, this specifies <i>degrees</i>[i] <i>edges</i>
