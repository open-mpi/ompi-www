<?php
$topdir = "../../..";
$title = "MPI_Waitany(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_WAITANY(3)";
...
MPI errors on requests passed to MPI_WAITANY do not set the status.MPI_ERROR
...
MPI_WAITANY if the back-end error handler returns it.  The pre-defined MPI
