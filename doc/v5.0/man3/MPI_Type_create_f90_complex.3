...
.\" $COPYRIGHT$
.TH MPI_Type_create_f90_complex 3 "Sep 30, 2021" "5.0.0rc1" "Open MPI"
...
.nf
USE mpi_f08
MPI_Type_create_f90_complex(\fIp\fP, \fIr\fP, \fInewtype\fP, \fIierror\fP)
	INTEGER, INTENT(IN) :: \fIp\fP, \fIr\fP
