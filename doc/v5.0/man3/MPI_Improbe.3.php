<?php
$topdir = "../../..";
$title = "MPI_Improbe(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_IMPROBE(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(OUT) :: flag
...
the <a href="../man3/MPI_Mprobe.3.php">MPI_Mprobe</a> and MPI_Improbe operations allow incoming messages to be
...
= MPI_MESSAGE_NO_PROC, and the <i>status</i> object returns source = MPI_PROC_NULL,
