<?php
$topdir = "../../..";
$title = "MPI_Attr_delete(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_ATTR_DELETE(3)";
...
routine is <i>deprecated</i> as of MPI-2, and was <i>deleted</i> in MPI-3. Please use <a href="../man3/MPI_Comm_delete_attr.3.php">MPI_Comm_delete_attr</a>.
 This function does not have a mpi_f08 binding. <p>
Delete attribute from cache
by key. This function invokes the attribute delete function delete_fn specified
when the keyval was created. The call will fail if the delete_fn function
returns an error code other than MPI_SUCCESS.
<p> Whenever a communicator is
replicated using the function <a href="../man3/MPI_Comm_dup.3.php">MPI_Comm_dup</a>, all callback copy functions
