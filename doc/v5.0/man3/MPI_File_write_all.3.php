<?php
$topdir = "../../..";
$title = "MPI_File_write_all(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_FILE_WRITE_ALL(3)";
...
<b>MPI_File_write_all</b> - Writes a file starting at the locations
...
the system) a total number of <i>count</i> data items having <i>datatype</i> type from
the user&rsquo;s buffer <i>buf.</i> The data is written into those parts of the file specified
by the current view. MPI_File_write_all stores the number of <i>datatype</i> elements
actually written in <i>status.</i> All other fields of <i>status</i> are undefined. <p>
It
is erroneous to call this function if MPI_MODE_SEQUENTIAL mode was specified
