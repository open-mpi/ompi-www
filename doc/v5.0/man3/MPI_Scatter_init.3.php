<?php
$topdir = "../../..";
$title = "MPI_Scatter_init(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_SCATTER_INIT(3)";
...
<b><a href="../man3/MPI_Scatter.3.php">MPI_Scatter</a>, <a href="../man3/MPI_Iscatter.3.php">MPI_Iscatter</a>, MPI_Scatter_init</b> - Sends data from
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Scatter.3.php">MPI_Scatter</a>(const void *sendbuf, int sendcount, MPI_Datatype sendtype,
...
<a href="../man3/MPI_Scatter.3.php">MPI_SCATTER</a>(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT,
...
<br>
<pre>USE mpi_f08
<a href="../man3/MPI_Scatter.3.php">MPI_Scatter</a>(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype,
...
<pre>        MPI_Comm comm;
        ...
        ...
        <a href="../man3/MPI_Scatter.3.php">MPI_Scatter</a>(sendbuf, 100, MPI_INT, rbuf, 100,
                    MPI_INT, root, comm);
</pre>
<p>
