<?php
$topdir = "../../..";
$title = "MPI_Win_attach(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_WIN_ATTACH(3)";
...
<b>MPI_Win_attach, <a href="../man3/MPI_Win_detach.3.php">MPI_Win_detach</a></b> - One-sided MPI call that attaches
...
<a href="../man3/MPI_Win_detach.3.php">MPI_WIN_DETACH</a>(WIN, BASE, IERROR)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;&lt;type&gt; BASE(*)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER WIN, IERROR
</pre>
...
used by MPI_Win_attach was allocated by <a href="../man3/MPI_Alloc_mem.3.php">MPI_Alloc_mem</a>, the size of the
window can be no larger than the value set by the <a href="../man3/MPI_Alloc_mem.3.php">MPI_ALLOC_MEM</a> function.
<p>
<p>
<a href="../man3/MPI_Win_detach.3.php">MPI_Win_detach</a> can be used to detach a previously attached memory region
