<?php
$topdir = "../../..";
$title = "MPI_File_write_at_all_begin(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_FILE_WRITE_AT_ALL_BEGIN(3)";
...
<i>count</i> data items having <i>datatype</i> type from the user&rsquo;s buffer <i>buf.</i> The offset
...
the current MPI error handler is called. For MPI I/O function errors, the
default error handler is set to MPI_ERRORS_RETURN. The error handler may
be changed with <a href="../man3/MPI_File_set_errhandler.3.php">MPI_File_set_errhandler</a>; the predefined error handler MPI_ERRORS_ARE_FATAL
