<?php
$topdir = "../../..";
$title = "OMPI_Affinity_str(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: OMPI_Affinity_str(3)";
...
<h2><a name='sect5' href='#toc5'>C++ Syntax</a></h2>
There
...
core 0".
<p> OMPI_AFFINITY_LAYOUT_FMT returns ASCII art representing where
...
<p> See
below for more output examples.
<p>  </dd>
</dl>
...
a string indicating that Open MPI did not bind this process.  </dd>
...
<li><a name='toc5' href='#sect5'>C++ Syntax</a></li>
