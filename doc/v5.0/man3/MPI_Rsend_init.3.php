<?php
$topdir = "../../..";
$title = "MPI_Rsend_init(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_RSEND_INIT(3)";
...
object for a ready mode send operation, and binds to it all the arguments
