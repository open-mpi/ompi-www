...
.\" $COPYRIGHT$
.TH MPI_Rsend_init 3 "Sep 30, 2021" "5.0.0rc1" "Open MPI"
.SH NAME
...
MPI_RSEND_INIT(\fIBUF, COUNT, DATATYPE, DEST, TAG, COMM, REQUEST,
		IERROR\fP)
	<type>	\fIBUF\fP(*)
...
.nf
USE mpi_f08
MPI_Rsend_init(\fIbuf\fP, \fIcount\fP, \fIdatatype\fP, \fIdest\fP, \fItag\fP, \fIcomm\fP, \fIrequest\fP, \fIierror\fP)
