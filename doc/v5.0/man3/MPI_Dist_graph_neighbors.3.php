<?php
$topdir = "../../..";
$title = "MPI_Dist_graph_neighbors(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_DIST_GRAPH_NEIGHBORS(3)";
...
<pre>USE mpi_f08
MPI_Dist_Graph_neighbors(comm, maxindegree, sources, sourceweights,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;maxoutdegree, destinations, destweights, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Comm), INTENT(IN) :: comm
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: maxindegree, maxoutdegree
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(OUT) :: sources(maxindegree), destinations(maxoutdegree)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER :: sourceweights(*), destweights(*)
