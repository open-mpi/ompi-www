<?php
$topdir = "../../..";
$title = "MPI_Comm_set_name(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_COMM_SET_NAME(3)";
...
in C (to allow for the null terminator). Attempts to set names longer than
this will result in truncation of the name. MPI_MAX_OBJECT_NAME must have
a value of at least 64.
<p>
<p>
<h2><a name='sect9' href='#toc9'>Notes</a></h2>
Since MPI_Comm_set_name is provided to help
debug code, it is sensible to give the same name to a communicator in all
of the processes where it exists, to avoid confusion. <p>
Regarding name length,
under circumstances of store exhaustion, an attempt to set a name of any
