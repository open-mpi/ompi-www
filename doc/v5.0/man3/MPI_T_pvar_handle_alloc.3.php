<?php
$topdir = "../../..";
$title = "MPI_T_pvar_handle_alloc(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_T_PVAR_HANDLE_ALLOC(3)";
...
int <a href="../man3/MPI_T_pvar_handle_free.3.php">MPI_T_pvar_handle_free</a>(int session, MPI_T_pvar_handle *handle)
...
call to <a href="../man3/MPI_T_pvar_get_info.3.php">MPI_T_PVAR_GET_INFO</a>.  <a href="../man3/MPI_T_pvar_handle_free.3.php">MPI_T_pvar_handle_free</a> frees a handle allocated
...
<a href="../man3/MPI_T_pvar_handle_free.3.php">MPI_T_pvar_handle_free</a>() will fail if: [MPI_T_ERR_NOT_INITIALIZED] The
