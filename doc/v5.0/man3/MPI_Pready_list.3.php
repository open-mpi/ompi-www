<?php
$topdir = "../../..";
$title = "MPI_Pready_list(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_PREADY_LIST(3)";
...
<b>MPI_Pready_list</b> - Indicates that a list given send-side partitions
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;LENGTH, PARTITIONS(*), REQUEST, IERROR
</pre>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: partitions
...
<dt>length </dt>
<dd>The length of the given partition array (integer).
</dd>

<dt>partitions </dt>
<dd>An array of numbers of partitions to mark ready for transfer
(integer). </dd>
...
<a href="../man3/MPI_Pready.3.php">MPI_Pready</a>, <a href="../man3/MPI_Pready_range.3.php">MPI_Pready_range</a>, <a href="../man3/MPI_Parrived.3.php">MPI_Parrived</a>
<br>
<p>
