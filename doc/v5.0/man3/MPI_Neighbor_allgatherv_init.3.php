<?php
$topdir = "../../..";
$title = "MPI_Neighbor_allgatherv_init(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_NEIGHBOR_ALLGATHERV_INIT(3)";
...
<b><a href="../man3/MPI_Neighbor_allgatherv.3.php">MPI_Neighbor_allgatherv</a>, <a href="../man3/MPI_Ineighbor_allgatherv.3.php">MPI_Ineighbor_allgatherv</a>, MPI_Neighbor_allgatherv_init</b>
...
int <a href="../man3/MPI_Ineighbor_allgatherv.3.php">MPI_Ineighbor_allgatherv</a>(const void *sendbuf, int sendcount,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Datatype sendtype, void *recvbuf, const int recvcounts[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int displs[], MPI_Datatype recvtype, MPI_Comm comm,
        MPI_Request *request)
int <a href="../man3/MPI_Neighbor_allgatherv.3.php">MPI_Neighbor_allgatherv</a>(const void *sendbuf, int sendcount,
...
<a href="../man3/MPI_Ineighbor_allgatherv.3.php">MPI_INEIGHBOR_ALLGATHERV</a>(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF,
...
<br>
<pre>USE mpi_f08
<a href="../man3/MPI_Neighbor_allgatherv.3.php">MPI_Neighbor_allgatherv</a>(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;displs, recvtype, comm, ierror)
...
<a href="../man3/MPI_Ineighbor_allgatherv.3.php">MPI_Ineighbor_allgatherv</a>(sendbuf, sendcount, sendtype, recvbuf, recvcounts,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;displs, recvtype, comm, request, ierror)
...
<a href="../man3/MPI_Neighbor_allgatherv.3.php">MPI_Neighbor_allgatherv</a>
