<?php
$topdir = "../../..";
$title = "MPI_Dist_graph_create_adjacent(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_DIST_GRAPH_CREATE_ADJACENT(3)";
...
<dt>info </dt>
<dd>Hints on optimization and interpretation of weights (handle).
</dd>
...
<dd>Communicator with distributed graph topology
added (handle). </dd>
