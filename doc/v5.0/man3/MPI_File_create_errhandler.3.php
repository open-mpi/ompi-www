<?php
$topdir = "../../..";
$title = "MPI_File_create_errhandler(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_FILE_CREATE_ERRHANDLER(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;PROCEDURE(MPI_File_errhandler_function) :: file_errhandler_fn
...
as an MPI error handler. Returns in errhandler a handle to the registered
error handler. <p>
In the C language, the user routine <i>function</i> should be a
C function of type MPI_File_errhandler_function, which is defined as <p>
<br>
