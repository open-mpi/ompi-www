<?php
$topdir = "../../..";
$title = "MPI_Win_create_keyval(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_WIN_CREATE_KEYVAL(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;PROCEDURE(MPI_Win_copy_attr_function) :: win_copy_attr_fn
<tt> </tt>&nbsp;<tt> </tt>&nbsp;PROCEDURE(MPI_Win_delete_attr_function) :: win_delete_attr_fn
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(OUT) :: win_keyval
...
MPI_WIN_NULL_COPY_FN or MPI_WIN_DUP_FN from either C or Fortran. MPI_WIN_NULL_COPY_FN
