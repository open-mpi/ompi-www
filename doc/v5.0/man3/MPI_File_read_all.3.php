<?php
$topdir = "../../..";
$title = "MPI_File_read_all(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_FILE_READ_ALL(3)";
...
handler is called. For MPI I/O function errors, the default error handler
is set to MPI_ERRORS_RETURN. The error handler may be changed with <a href="../man3/MPI_File_set_errhandler.3.php">MPI_File_set_errhandler</a>;
