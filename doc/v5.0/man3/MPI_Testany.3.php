<?php
$topdir = "../../..";
$title = "MPI_Testany(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_TESTANY(3)";
...
<p>
Note that per MPI-1 section 3.2.5, MPI errors on requests passed to MPI_TESTANY
...
caller through the return value of MPI_TESTANY if the back-end error handler
