<?php
$topdir = "../../..";
$title = "MPI_Error_class(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_ERROR_CLASS(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;ERRORCODE, ERRORCLASS, IERROR
</pre>
...
<dt>errorcode </dt>
<dd>Error code returned by an MPI routine.
<p> </dd>
</dl>
...
<dt>errorclass </dt>
<dd>Error class associated with errorcode. </dd>
...
The function MPI_Error_class maps
each standard error code (error class) onto itself.
<p>
