<?php
$topdir = "../../..";
$title = "MPI_T_category_get_categories(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_T_CATEGORY_GET_CATEGORIES(3)";
...
<b>MPI_T_category_get_categories</b> - Query which categories are in
a category
...
len, indicating category indices.
<p> </dd>
</dl>

<h2><a name='sect5' href='#toc5'>Description</a></h2>
MPI_T_category_get_categories
can be used to query which other categories are in a category.
<p>
