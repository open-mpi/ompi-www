<?php
$topdir = "../../..";
$title = "MPI_Test(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_TEST(3)";
...
<p>
Note that per MPI-1 section 3.2.5, MPI errors on requests passed to MPI_TEST
...
caller through the return value of MPI_TEST if the back-end error handler
