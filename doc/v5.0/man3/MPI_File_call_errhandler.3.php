<?php
$topdir = "../../..";
$title = "MPI_File_call_errhandler(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_FILE_CALL_ERRHANDLER(3)";
...
<b>MPI_File_call_errhandler</b> - Passes the supplied error code to

<p>the error handler assigned to a file
<p>
...
for a full list of MPI error codes.
<p>
