<?php
$topdir = "../../..";
$title = "MPI_Neighbor_alltoallv(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_NEIGHBOR_ALLTOALLV(3)";
...
<b>MPI_Neighbor_alltoallv, <a href="../man3/MPI_Ineighbor_alltoallv.3.php">MPI_Ineighbor_alltoallv</a>, <a href="../man3/MPI_Neighbor_alltoallv_init.3.php">MPI_Neighbor_alltoallv_init</a></b>
...
int <a href="../man3/MPI_Ineighbor_alltoallv.3.php">MPI_Ineighbor_alltoallv</a>(const void *sendbuf, const int sendcounts[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int sdispls[], MPI_Datatype sendtype,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;void *recvbuf, const int recvcounts[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int rdispls[], MPI_Datatype recvtype, MPI_Comm comm,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Request *request)
int <a href="../man3/MPI_Neighbor_alltoallv_init.3.php">MPI_Neighbor_alltoallv_init</a>(const void *sendbuf, const int sendcounts[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int sdispls[], MPI_Datatype sendtype,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;void *recvbuf, const int recvcounts[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int rdispls[], MPI_Datatype recvtype, MPI_Comm comm,
...
<a href="../man3/MPI_Ineighbor_alltoallv.3.php">MPI_INEIGHBOR_ALLTOALLV</a>(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPE,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;RECVBUF, RECVCOUNTS, RDISPLS, RECVTYPE, COMM, REQUEST, IERROR)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;&lt;type&gt;<tt> </tt>&nbsp;<tt> </tt>&nbsp;SENDBUF(*), RECVBUF(*)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;SENDCOUNTS(*), SDISPLS(*), SENDTYPE
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;RECVCOUNTS(*), RDISPLS(*), RECVTYPE
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;COMM, REQUEST, IERROR
<a href="../man3/MPI_Neighbor_alltoallv_init.3.php">MPI_NEIGHBOR_ALLTOALLV_INIT</a>(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPE,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;RECVBUF, RECVCOUNTS, RDISPLS, RECVTYPE, COMM, INFO, REQUEST, IERROR)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;&lt;type&gt;<tt> </tt>&nbsp;<tt> </tt>&nbsp;SENDBUF(*), RECVBUF(*)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;SENDCOUNTS(*), SDISPLS(*), SENDTYPE
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;RECVCOUNTS(*), RDISPLS(*), RECVTYPE
...
<a href="../man3/MPI_Ineighbor_alltoallv.3.php">MPI_Ineighbor_alltoallv</a>(sendbuf, sendcounts, sdispls, sendtype, recvbuf,
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, OPTIONAL, INTENT(OUT) :: ierror
<a href="../man3/MPI_Neighbor_alltoallv_init.3.php">MPI_Neighbor_alltoallv_init</a>(sendbuf, sendcounts, sdispls, sendtype, recvbuf,
...
MPI_Neighbor_alltoallv is a generalized
collective operation in which all processes send data to and receive data
from all neighbors. It adds flexibility to <a href="../man3/MPI_Neighbor_alltoall.3.php">MPI_Neighbor_alltoall</a> by allowing
the user to specify data to send and receive vector-style (via a displacement
and element count). The operation of this routine can be thought of as follows,
where each process performs 2n (n being the number of neighbors in to topology
of communicator <i>comm</i>) independent point-to-point communications. The neighbors
