<?php
$topdir = "../../..";
$title = "MPI_Wait(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_WAIT(3)";
...
MPI errors on requests passed to MPI_WAIT do not set the status.MPI_ERROR
...
MPI_WAIT if the back-end error handler returns it.  The pre-defined MPI error
