<?php
$topdir = "../../..";
$title = "MPI_Type_vector(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_TYPE_VECTOR(3)";
...
of 4 elements (4 x 16 bytes) between the blocks. <p>
