<?php
$topdir = "../../..";
$title = "MPI_Comm_idup_with_info(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_COMM_IDUP_WITH_INFO(3)";
...
<b>MPI_Comm_idup_with_info </b> -  Start the nonblocking duplication
of an existing communicator with all its cached information.
<p>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;COMM, INFO, NEWCOMM, REQUEST, IERROR
</pre>
...
<dt>comm </dt>
<dd>Communicator (handle). info Info object (handle).
<p> </dd>
</dl>
...
starts the nonblocking duplication of an existing communicator comm with
...
a new context (see Section 5.7.1 of the MPI-1 Standard, "Functionality"). The
communicator returned in <i>newcomm</i> will not be available until the request
is complete.  The hints provided by the supplied <i>info</i> argument are associated
with the output communicator. <p>
The completion of a communicator duplication
request can be determined by calling any of <a href="../man3/MPI_Wait.3.php">MPI_Wait</a>, <a href="../man3/MPI_Waitany.3.php">MPI_Waitany</a>, <a href="../man3/MPI_Test.3.php">MPI_Test</a>,
or <a href="../man3/MPI_Testany.3.php">MPI_Testany</a> with the request returned by this function.
<p>
<h2><a name='sect8' href='#toc8'>Notes</a></h2>
This operation
is used to provide a parallel library call with a duplicate communication
...
an MPI_Comm_idup_with_info at the beginning of the parallel call, and an
...
<a href="../man3/MPI_Comm_idup.3.php">MPI_Comm_idup</a> <a href="../man3/MPI_Comm_dup_with_info.3.php">MPI_Comm_dup_with_info</a> <p>
