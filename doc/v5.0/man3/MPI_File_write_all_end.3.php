<?php
$topdir = "../../..";
$title = "MPI_File_write_all_end(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_FILE_WRITE_ALL_END(3)";
...
<b>MPI_File_write_all_end</b> - Writes a file starting at the locations
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;FH, STATUS, IERROR
</pre>
...
of elements actually written into the file associated with <i>fh</i> from the
user&rsquo;s buffer <i>buf</i> in <i>status.</i> MPI_File_write_all_end blocks until the operation
initiated by <a href="../man3/MPI_File_write_all_begin.3.php">MPI_File_write_all_begin</a> completes. The data is written into
those parts of the file specified by the current view. All other fields
of <i>status</i> are undefined.
<p>
...
MPI error handler is called. For MPI I/O function errors, the default error
