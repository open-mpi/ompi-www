<?php
$topdir = "../../..";
$title = "MPI_Win_lock(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_WIN_LOCK(3)";
...
terminates abnormally, the server or other clients may hang in a MPI_Win_lock
