<?php
$topdir = "../../..";
$title = "MPI_Keyval_free(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_KEYVAL_FREE(3)";
...
key that is in use, because the actual free does not transpire until after
all references (in other communicators on the process) to the key have
been freed. These references need to be explicitly freed by the program,
either via calls to <a href="../man3/MPI_Attr_delete.3.php">MPI_Attr_delete</a> that free one attribute instance, or
by calls to <a href="../man3/MPI_Comm_free.3.php">MPI_Comm_free</a> that free all attribute instances associated
with the freed communicator.
<p>
<h2><a name='sect7' href='#toc7'>Note</a></h2>
Key values are global (they can be used
with any and all communicators).
<p>
