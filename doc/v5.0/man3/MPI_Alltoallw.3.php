<?php
$topdir = "../../..";
$title = "MPI_Alltoallw(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_ALLTOALLW(3)";
...
<b>MPI_Alltoallw, <a href="../man3/MPI_Ialltoallw.3.php">MPI_Ialltoallw</a>, <a href="../man3/MPI_Alltoallw_init.3.php">MPI_Alltoallw_init</a></b> - All processes
...
int <a href="../man3/MPI_Alltoallw_init.3.php">MPI_Alltoallw_init</a>(const void *sendbuf, const int sendcounts[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int sdispls[], const MPI_Datatype sendtypes[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;void *recvbuf, const int recvcounts[], const int rdispls[],
...
<a href="../man3/MPI_Alltoallw_init.3.php">MPI_ALLTOALLW_INIT</a>(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPES,
...
<a href="../man3/MPI_Ialltoallw.3.php">MPI_Ialltoallw</a>(sendbuf, sendcounts, sdispls, sendtypes, recvbuf,
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, OPTIONAL, INTENT(OUT) :: ierror
<a href="../man3/MPI_Alltoallw_init.3.php">MPI_Alltoallw_init</a>(sendbuf, sendcounts, sdispls, sendtypes, recvbuf,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;recvcounts, rdispls, recvtypes, comm, fIinfo, request, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS :: sendbuf
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(*), DIMENSION(..), ASYNCHRONOUS :: recvbuf
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN), ASYNCHRONOUS :: sendcounts(*), sdispls(*),
<tt> </tt>&nbsp;<tt> </tt>&nbsp;recvcounts(*), rdispls(*)
...
which data is to be exchanged. </dd>
...
MPI_Alltoallw is a
generalized collective operation in which all processes send data to and
receive data from all other processes. It adds flexibility to <a href="../man3/MPI_Alltoallv.3.php">MPI_Alltoallv</a>
