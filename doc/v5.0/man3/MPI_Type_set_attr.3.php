<?php
$topdir = "../../..";
$title = "MPI_Type_set_attr(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_TYPE_SET_ATTR(3)";
...
<b>MPI_Type_set_attr</b> - Sets a key value/attribute pair to a data
type.
<p>
