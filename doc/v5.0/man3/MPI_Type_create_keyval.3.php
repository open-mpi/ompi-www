<?php
$topdir = "../../..";
$title = "MPI_Type_create_keyval(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_TYPE_CREATE_KEYVAL(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;PROCEDURE(MPI_Type_copy_attr_function) :: type_copy_attr_fn
<tt> </tt>&nbsp;<tt> </tt>&nbsp;PROCEDURE(MPI_Type_delete_attr_function) :: type_delete_attr_fn
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(OUT) :: type_keyval
...
or MPI_TYPE_DUP_FN from C or Fortran. MPI_TYPE_NULL_COPY_FN is a function
...
or Fortran. MPI_TYPE_NULL_DELETE_FN is a function that does nothing beyond
returning MPI_SUCCESS. The C callback functions are: <p>
<br>
