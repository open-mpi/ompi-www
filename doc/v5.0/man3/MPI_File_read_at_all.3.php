<?php
$topdir = "../../..";
$title = "MPI_File_read_at_all(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_FILE_READ_AT_ALL(3)";
...
<b>MPI_File_read_at_all</b> - Reads a file at explicitly specified
...
The <i>offset</i> is in etype units relative to the current view. That is, holes
...
the number of <i>datatype</i> elements actually read in <i>status.</i> All other fields
of <i>status</i> are undefined. It is erroneous to call this function if MPI_MODE_SEQUENTIAL
