<?php
$topdir = "../../..";
$title = "MPI_Gather_init(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_GATHER_INIT(3)";
...
sendtype,    void *recvbuf, int recvcount, MPI_Datatype recvtype, int root,
   MPI_Comm comm, MPI_Request *request)int MPI_Gather_init(const void *sendbuf,
...
<li><a name='toc3' href='#sect3'>C]#include <mpi.h>int <a href="../man3/MPI_Gather.3.php">MPI_Gather</a>(const void *sendbuf, int sendcount, MPI_Datatype sendtype,    void *recvbuf, int recvcount, MPI_Datatype recvtype, int root,    MPI_Comm comm)int <a href="../man3/MPI_Igather.3.php">MPI_Igather</a>(const void *sendbuf, int sendcount, MPI_Datatype sendtype,    void *recvbuf, int recvcount, MPI_Datatype recvtype, int root,    MPI_Comm comm, MPI_Request *request)int MPI_Gather_init(const void *sendbuf, int sendcount, MPI_Datatype sendtype,    void *recvbuf, int recvcount, MPI_Datatype recvtype, int root,    MPI_Comm comm, MPI_Info info, MPI_Request *request)R]Fortran Syntax</a></li>
