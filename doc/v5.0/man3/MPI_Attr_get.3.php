<?php
$topdir = "../../..";
$title = "MPI_Attr_get(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_ATTR_GET(3)";
...
Please use <a href="../man3/MPI_Comm_get_attr.3.php">MPI_Comm_get_attr</a>.  This function does not have a mpi_f08 binding.
<p>
...
the call returns flag = false. In particular MPI_KEYVAL_INVALID is an erroneous
key value.
<p>
