<?php
$topdir = "../../..";
$title = "MPI_Errhandler_free(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_ERRHANDLER_FREE(3)";
...
<pre>USE mpi_f08
MPI_Errhandler_free(errhandler, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Errhandler), INTENT(INOUT) :: errhandler
