<?php
$topdir = "../../..";
$title = "MPI_Info_free(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_INFO_FREE(3)";
...
<pre>USE mpi_f08
MPI_Info_free(info, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Info), INTENT(INOUT) :: info
...
MPI_Info_free frees <i>info</i>
and sets it to MPI_INFO_NULL.
<p>
