<?php
$topdir = "../../..";
$title = "MPI_Win_get_attr(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_WIN_GET_ATTR(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: win_keyval
...
<dt>win </dt>
<dd>Window to which the attribute is attached (handle).
</dd>
...
portable Fortran syntax for the <i>ATTRIBUTE_VAL</i> argument only for Fortran
