<?php
$topdir = "../../..";
$title = "MPI_File_write_at_all(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_FILE_WRITE_AT_ALL(3)";
...
<b>MPI_File_write_at_all</b> - Writes a file at explicitly specified
...
<i>datatype</i> type from the user&rsquo;s buffer <i>buf.</i> The offset is in etype units relative
...
view. MPI_File_write_at_all stores the number of <i>datatype</i> elements actually
...
syntax for the <i>OFFSET</i> argument only for Fortran 90.  FORTRAN 77 users may
