<?php
$topdir = "../../..";
$title = "MPI_Type_hindexed(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_TYPE_HINDEXED(3)";
...
<p>
The function is identical to <a href="../man3/MPI_Type_indexed.3.php">MPI_Type_indexed</a>, except that block displacements
in array_of_displacements are specified in bytes, rather than in multiples
of the oldtype extent. <p>
