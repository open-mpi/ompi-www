<?php
$topdir = "../../..";
$title = "MPI_Allgatherv(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_ALLGATHERV(3)";
...
<br>
<pre>   MPI_ALLGATHERV ( MPI_IN_PLACE, 0, MPI_DATATYPE_NULL, recvbuf,
