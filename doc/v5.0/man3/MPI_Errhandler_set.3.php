<?php
$topdir = "../../..";
$title = "MPI_Errhandler_set(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_ERRHANDLER_SET(3)";
...
<p>
Associates the new error handler errhandler with communicator comm at the
calling process. Note that an error handler is always associated with the
communicator.
<p>
