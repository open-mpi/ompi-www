<?php
$topdir = "../../..";
$title = "MPI_Request_f2c(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_REQUEST_F2C(3)";
...
MPI_Request_f2c, <a href="../man3/MPI_Request_c2f.3.php">MPI_Request_c2f</a>, <a href="../man3/MPI_Type_f2c.3.php">MPI_Type_f2c</a>, <a href="../man3/MPI_Type_c2f.3.php">MPI_Type_c2f</a>, <a href="../man3/MPI_Win_f2c.3.php">MPI_Win_f2c</a>,
...
Handles are passed between Fortran and C by using an explicit
C wrapper to convert Fortran handles to C handles. There is no direct access
to C handles in Fortran. The type definition <i>MPI_Fint</i> is provided in C for
an integer of the size that matches a Fortran <i>INTEGER</i>; usually, <i>MPI_Fint</i>
will be equivalent to <i>int</i>. The handle translation functions are provided
in C to convert from a Fortran handle (which is an integer) to a C handle,
and vice versa. <p>
For example, if <i>comm</i> is a valid Fortran handle to a communicator,
then <a href="../man3/MPI_Comm_f2c.3.php">MPI_Comm_f2c</a> returns a valid C handle to that same communicator; if
<i>comm</i> = MPI_COMM_NULL (Fortran value), then <a href="../man3/MPI_Comm_f2c.3.php">MPI_Comm_f2c</a> returns a null
C handle; if <i>comm</i> is an invalid Fortran handle, then <a href="../man3/MPI_Comm_f2c.3.php">MPI_Comm_f2c</a> returns
an invalid C handle.
