<?php
$topdir = "../../..";
$title = "MPI_Ialltoallv(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_IALLTOALLV(3)";
...
<b><a href="../man3/MPI_Alltoallv.3.php">MPI_Alltoallv</a>, MPI_Ialltoallv, <a href="../man3/MPI_Alltoallv_init.3.php">MPI_Alltoallv_init</a></b> - All processes
...
int <a href="../man3/MPI_Alltoallv_init.3.php">MPI_Alltoallv_init</a>(const void *sendbuf, const int sendcounts[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int sdispls[], MPI_Datatype sendtype,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;void *recvbuf, const int recvcounts[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int rdispls[], MPI_Datatype recvtype, MPI_Comm comm,
...
<a href="../man3/MPI_Alltoallv_init.3.php">MPI_ALLTOALLV_INIT</a>(SENDBUF, SENDCOUNTS, SDISPLS, SENDTYPE,
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, OPTIONAL, INTENT(OUT) :: ierror
<a href="../man3/MPI_Alltoallv_init.3.php">MPI_Alltoallv_init</a>(sendbuf, sendcounts, sdispls, sendtype, recvbuf, recvcounts,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;rdispls, recvtype, comm, info, request, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(*), DIMENSION(..), INTENT(IN), ASYNCHRONOUS :: sendbuf
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(*), DIMENSION(..), ASYNCHRONOUS :: recvbuf
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN), ASYNCHRONOUS :: sendcounts(*), sdispls(*),
<tt> </tt>&nbsp;<tt> </tt>&nbsp;recvcounts(*), rdispls(*)
