<?php
$topdir = "../../..";
$title = "MPI_Scatterv_init(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_SCATTERV_INIT(3)";
...
<b><a href="../man3/MPI_Scatterv.3.php">MPI_Scatterv</a>, <a href="../man3/MPI_Iscatterv.3.php">MPI_Iscatterv</a>, MPI_Scatterv_init</b> - Scatters a
...
int MPI_Scatterv_init(const void *sendbuf, const int sendcounts[], const
int displs[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Datatype sendtype, void *recvbuf, int recvcount,
...
<br>
<pre>USE mpi_f08
<a href="../man3/MPI_Scatterv.3.php">MPI_Scatterv</a>(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount,
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: sendcounts(*), displs(*), recvcount, root
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Datatype), INTENT(IN) :: sendtype, recvtype
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Comm), INTENT(IN) :: comm
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, OPTIONAL, INTENT(OUT) :: ierror
<a href="../man3/MPI_Iscatterv.3.php">MPI_Iscatterv</a>(sendbuf, sendcounts, displs, sendtype, recvbuf, recvcount,
...
<a href="../man3/MPI_Scatterv.3.php">MPI_Scatterv</a> is the inverse operation to <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>.
<p>
<a href="../man3/MPI_Scatterv.3.php">MPI_Scatterv</a> extends the functionality of <a href="../man3/MPI_Scatter.3.php">MPI_Scatter</a> by allowing a varying
