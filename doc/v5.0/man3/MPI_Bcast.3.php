<?php
$topdir = "../../..";
$title = "MPI_Bcast(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_BCAST(3)";
...
<h3><a name='sect3' href='#toc3'>C]#include &lt;mpi.h&gt;int MPI_Bcast(void *buffer, int count, MPI_Datatype datatype,
   int root, MPI_Comm comm)int <a href="../man3/MPI_Ibcast.3.php">MPI_Ibcast</a>(void *buffer, int count, MPI_Datatype
datatype,    int root, MPI_Comm comm, MPI_Request *request)R]Fortran Syntax</a></h3>
<br>
<pre>

</pre>
<h3><a name='sect4' href='#toc4'>C]USE MPI! or the older form: INCLUDE [aq]mpif.h[aq]MPI_BCAST(BUFFER, COUNT,
...
<dt>C]MPI_Comm comm;int array[100];int root=0;//...MPI_Bcast( array, 100, MPI_INT,
...
<li><a name='toc3' href='#sect3'>C]#include <mpi.h>int MPI_Bcast(void *buffer, int count, MPI_Datatype datatype,    int root, MPI_Comm comm)int <a href="../man3/MPI_Ibcast.3.php">MPI_Ibcast</a>(void *buffer, int count, MPI_Datatype datatype,    int root, MPI_Comm comm, MPI_Request *request)R]Fortran Syntax</a></li>
<li><a name='toc4' href='#sect4'>C]USE MPI! or the older form: INCLUDE [aq]mpif.h[aq]MPI_BCAST(BUFFER, COUNT, DATATYPE, ROOT, COMM, IERROR)    <type>  BUFFER(*)    INTEGER COUNT, DATATYPE, ROOT, COMM, IERRORMPI_IBCAST(BUFFER, COUNT, DATATYPE, ROOT, COMM, REQUEST, IERROR)    <type>  BUFFER(*)    INTEGER COUNT, DATATYPE, ROOT, COMM, REQUEST, IERRORR]Fortran 2008 Syntax</a></li>
</ul>
