<?php
$topdir = "../../..";
$title = "MPI_Type_get_name(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_TYPE_GET_NAME(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;CHARACTER(LEN=MPI_MAX_OBJECT_NAME), INTENT(OUT) :: type_name
