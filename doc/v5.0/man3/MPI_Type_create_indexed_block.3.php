<?php
$topdir = "../../..";
$title = "MPI_Type_create_indexed_block(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_TYPE_CREATE_INDEXED_BLOCK(3)";
...
<a href="../man3/MPI_Type_create_hindexed_block.3.php">MPI_Type_create_hindexed_block</a>(count, blocklength, array_of_displacements,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;oldtype, newtype, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: count, blocklength
