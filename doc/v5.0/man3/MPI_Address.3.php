<?php
$topdir = "../../..";
$title = "MPI_Address(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_ADDRESS(3)";
...
The address of a location in memory can be
found by invoking this function. Returns the (byte) address of location.
<p>
Example: Using MPI_Address for an array. <p>
<br>
<pre>REAL A(100,100)
</pre><br>
