<?php
$topdir = "../../..";
$title = "MPI_Reduce_init(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_REDUCE_INIT(3)";
...
<b><a href="../man3/MPI_Reduce.3.php">MPI_Reduce</a>, <a href="../man3/MPI_Ireduce.3.php">MPI_Ireduce</a>, MPI_Reduce_init</b> - Reduces values on
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Reduce.3.php">MPI_Reduce</a>(const void *sendbuf, void *recvbuf, int count,
...
<a href="../man3/MPI_Reduce.3.php">MPI_REDUCE</a>(SENDBUF, RECVBUF, COUNT, DATATYPE, OP, ROOT, COMM,
...
<br>
<pre>USE mpi_f08
<a href="../man3/MPI_Reduce.3.php">MPI_Reduce</a>(sendbuf, recvbuf, count, datatype, op, root, comm, ierror)
...
<pre>    SUBROUTINE PAR_BLAS1(m, a, b, c, comm)
    ...
    END DO
    ! global sum
    CALL <a href="../man3/MPI_Reduce.3.php">MPI_REDUCE</a>(sum, c, 1, MPI_REAL, MPI_SUM, 0, comm, ierr)
    RETURN
</pre><p>
...
<pre>        ...
        ...
        <a href="../man3/MPI_Reduce.3.php">MPI_Reduce</a>( in, out, 30, MPI_DOUBLE_INT, MPI_MAXLOC, root, comm
);
...
<pre>    ...
    ...
    <a href="../man3/MPI_Comm_rank.3.php">MPI_COMM_RANK</a>(MPI_COMM_WORLD, myrank);
        ...
        END DO
    <a href="../man3/MPI_Reduce.3.php">MPI_REDUCE</a>( in, out, 30, MPI_2DOUBLE_PRECISION, MPI_MAXLOC, root,
                                                              comm, ierr
);
    ! At this point, the answer resides on process root
...
<pre>    #define  LEN   1000
    ...
    <a href="../man3/MPI_Reduce.3.php">MPI_Reduce</a>( in, out, 1, MPI_FLOAT_INT, MPI_MINLOC, root, comm );
        /* At this point, the answer resides on process root
         */
    if (myrank == root) {
        /* read answer out
