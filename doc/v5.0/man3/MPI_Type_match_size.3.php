<?php
$topdir = "../../..";
$title = "MPI_Type_match_size(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_TYPE_MATCH_SIZE(3)";
...
call MPI_Type_match_size to find a suitable datatype. In C use the sizeof
builtin instead of <a href="../man3/MPI_Sizeof.3.php">MPI_Sizeof</a>. <p>
It is erroneous to specify a size not supported
by the compiler.
<p>
