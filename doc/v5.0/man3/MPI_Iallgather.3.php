<?php
$topdir = "../../..";
$title = "MPI_Iallgather(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_IALLGATHER(3)";
...
<b><a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a>, MPI_Iallgather, <a href="../man3/MPI_Allgather_init.3.php">MPI_Allgather_init</a></b> - Gathers data

<p>from all processes and distributes it to all processes
<p>
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a>(const void *sendbuf, int  sendcount,
...
int <a href="../man3/MPI_Allgather_init.3.php">MPI_Allgather_init</a>(const void *sendbuf, int  sendcount,
<tt> </tt>&nbsp;<tt> </tt>&nbsp; MPI_Datatype sendtype, void *recvbuf, int recvcount,
...
<a href="../man3/MPI_Allgather.3.php">MPI_ALLGATHER</a>(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT,
...
<a href="../man3/MPI_Allgather_init.3.php">MPI_ALLGATHER_INIT</a>(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT,
...
<br>
<pre>USE mpi_f08
<a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a>(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype,
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, OPTIONAL, INTENT(OUT) :: ierror
<a href="../man3/MPI_Allgather_init.3.php">MPI_Allgather_init</a>(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype,
...
<a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a> is similar to <a href="../man3/MPI_Gather.3.php">MPI_Gather</a>,
except that all processes receive the result, instead of just the root.
In other words, all processes contribute to the result, and all processes
receive the result. <p>
The type signature associated with sendcount, sendtype
at a process must be equal to the type signature associated with recvcount,
recvtype at any other process. <p>
The outcome of a call to <a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a>(...)
...
</pre>for root = 0 , ..., n-1. The rules for correct usage of <a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a> are easily
found from the corresponding rules for <a href="../man3/MPI_Gather.3.php">MPI_Gather</a>. <p>
<b>Example:</b> The all-gather
version of Example 1 in <a href="../man3/MPI_Gather.3.php">MPI_Gather</a>. Using  <a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a>, we will gather
...
<pre>MPI_Comm comm;
    ...
    <a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a>( sendarray, 100, MPI_INT, rbuf, 100, MPI_INT, comm);
</pre><p>
...
call to <a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a> that used the in-place option is identical to the
case in which all processes executed <i>n</i> calls to <p>
<br>
<pre>   <a href="../man3/MPI_Allgather.3.php">MPI_ALLGATHER</a> ( MPI_IN_PLACE, 0, MPI_DATATYPE_NULL, recvbuf,
