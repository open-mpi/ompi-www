<?php
$topdir = "../../..";
$title = "MPI_Iallgather(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_IALLGATHER(3)";
...
The outcome of
a call to <a href="../man3/MPI_Allgather.3.php">MPI_Allgather</a>(...) is as if all processes executed n calls to <p>
<br>
