<?php
$topdir = "../../..";
$title = "MPI_File_iread_at(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_FILE_IREAD_AT(3)";
...
<b>MPI_File_iread_at</b> - Reads a file at an explicitly specified
...
<p> MPI_File_iread_at is a nonblocking routine that attempts to read from
...
specified by the current view. MPI_File_iread_at stores the number of <i>datatype</i>
elements actually read in <i>status.</i> All other fields of <i>status</i> are undefined.

<p>
<h2><a name='sect8' href='#toc8'>Fortran 77 Notes</a></h2>
The MPI standard prescribes portable Fortran syntax for
the <i>OFFSET</i> argument only for Fortran 90.  Sun FORTRAN 77 users may use the
