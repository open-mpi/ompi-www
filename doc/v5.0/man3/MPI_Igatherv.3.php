<?php
$topdir = "../../..";
$title = "MPI_Igatherv(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_IGATHERV(3)";
...
MPI_Datatype recvtype,    int root, MPI_Comm comm)int MPI_Igatherv(const
...
<li><a name='toc3' href='#sect3'>C]#include <mpi.h>int <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>(const void *sendbuf, int sendcount, MPI_Datatype sendtype,    void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype,    int root, MPI_Comm comm)int MPI_Igatherv(const void *sendbuf, int sendcount, MPI_Datatype sendtype,    void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype,    int root, MPI_Comm comm, MPI_Request *request)int <a href="../man3/MPI_Gatherv_init.3.php">MPI_Gatherv_init</a>(const void *sendbuf, int sendcount, MPI_Datatype sendtype,    void *recvbuf, const int recvcounts[], const int displs[], MPI_Datatype recvtype,    int root, MPI_Comm comm, MPI_Info info, MPI_Request *request)R]Fortran Syntax</a></li>
