<?php
$topdir = "../../..";
$title = "MPI_T_category_get_pvars(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_T_CATEGORY_GET_PVARS(3)";
...
<b>MPI_T_category_get_pvars</b> - Query which performance variables
are in a category
...
len, indicating performance variable indices.
<p> </dd>
</dl>

<h2><a name='sect5' href='#toc5'>Description</a></h2>
MPI_T_category_get_pvars
can be used to query which performance variables are contained in a particular
category. A category contains zero or more performance variables.
<p>
...
<dd>The category index is invalid  </dd>
</dl>
<p>
