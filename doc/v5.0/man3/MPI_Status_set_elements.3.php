<?php
$topdir = "../../..";
$title = "MPI_Status_set_elements(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_STATUS_SET_ELEMENTS(3)";
...
Fortran syntax for the <i>COUNT</i> argument of <a href="../man3/MPI_Status_set_elements_x.3.php">MPI_Status_set_elements_x</a> only
