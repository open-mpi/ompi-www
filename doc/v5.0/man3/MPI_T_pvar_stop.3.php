<?php
$topdir = "../../..";
$title = "MPI_T_pvar_stop(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_T_PVAR_STOP(3)";
...
<a href="../man3/MPI_T_pvar_start.3.php">MPI_T_pvar_start</a> starts the performance variable
...
<p> MPI_T_pvar_stop stops the performance variable with
...
<a href="../man3/MPI_T_pvar_start.3.php">MPI_T_pvar_start</a>() and MPI_T_pvar_stop() will fail if:
