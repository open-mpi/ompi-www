<?php
$topdir = "../../..";
$title = "MPI_Keyval_create(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_KEYVAL_CREATE(3)";
...
Generates
a new attribute key. Keys are locally unique in a process and opaque to
the user, though they are explicitly stored in integers. Once allocated,
the key value can be used to associate attributes and access them on any
locally defined communicator. <p>
The copy_fn function is invoked when a communicator
is duplicated by <a href="../man3/MPI_Comm_dup.3.php">MPI_COMM_DUP</a>. copy_fn should be of type MPI_Copy_function,
