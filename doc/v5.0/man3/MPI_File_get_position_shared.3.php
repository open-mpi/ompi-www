<?php
$topdir = "../../..";
$title = "MPI_File_get_position_shared(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_FILE_GET_POSITION_SHARED(3)";
...
<b>MPI_File_get_position_shared</b> - Returns the current position
