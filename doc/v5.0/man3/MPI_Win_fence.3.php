<?php
$topdir = "../../..";
$title = "MPI_Win_fence(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_WIN_FENCE(3)";
...
of <i>assert</i> = 0 is always valid. The following assertion value is supported:

<dl>

<dt>MPI_MODE_NOPRECEDE </dt>
<dd>No local RMA calls have been issued before this fence.
This assertion must be provided by all or no members of the group of the
window. It may enable faster fence call by avoiding unnecessary synchronization.
<p>
</dd>

<dt>MPI_MODE_NOSTORE </dt>
<dd>Informs that the local window was not updated by local
stores or get calls in the preceding epoch. </dd>

<dt>MPI_MODE_NOPUT </dt>
<dd>Informs that
the local window will not be updated by any put or accummulate calls in
the ensuing epoch (until next fence call). </dd>

<dt>MPI_MODE_NOSUCCEED </dt>
<dd>No local RMA
calls will be issued after this fence. This assertion must be provided by
all or no members of the group of the window. It may enable faster fence
call by avoiding unnecessary synchronization. <p>
...
Calls to MPI_Win_fence
should both precede and follow calls to put, get or accumulate that are
synchronized with fence calls. <p>
