<?php
$topdir = "../../..";
$title = "MPI_Errhandler_get(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_ERRHANDLER_GET(3)";
...
associated with communicator comm. <p>
<b>Example:</b> A library function may register
at its entry point the current error handler for a communicator, set its
own private error handler for this communicator, and restore before exiting
