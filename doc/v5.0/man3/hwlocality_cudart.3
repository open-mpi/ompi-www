.TH "hwlocality_cudart" 3 "Thu Nov 26 2020" "Version 2.4.0" "Hardware Locality (hwloc)" \" -*- nroff -*-
.ad l
.nh
.SH NAME
...
.PP
Get the CPU set of processors that are physically close to device \fCidx\fP\&. Return the CPU set describing the locality of the CUDA device whose index is \fCidx\fP\&.
.PP
