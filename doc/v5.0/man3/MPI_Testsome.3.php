<?php
$topdir = "../../..";
$title = "MPI_Testsome(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_TESTSOME(3)";
...
<b>MPI_Testsome</b> - Tests for completion of one or more previously
...
requests generate an MPI error, only the <i>first</i> MPI request that caused
an error will be passed to its corresponding error handler.  No other error
handlers will be invoked (even if multiple requests generated errors).
However, <i>all</i> requests that generate an error will have a relevant error
code set in the corresponding status.MPI_ERROR field (unless MPI_STATUSES_IGNORE
was used). <p>
