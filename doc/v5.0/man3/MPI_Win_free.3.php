<?php
$topdir = "../../..";
$title = "MPI_Win_free(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_WIN_FREE(3)";
...
<pre>USE mpi_f08
MPI_Win_free(win, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Win), INTENT(INOUT) :: win
...
If the window was
created through <b><a href="../man3/MPI_Win_allocate.3.php">MPI_Win_allocate</a></b> or <b><a href="../man3/MPI_Win_allocate_shared.3.php">MPI_Win_allocate_shared</a></b> then the memory
buffer allocated in that call will be freed when calling <b>MPI_Win_free</b>.
<p>
...
<a href="../man3/MPI_Win_create.3.php">MPI_Win_create</a> <a href="../man3/MPI_Win_allocate.3.php">MPI_Win_allocate</a> <a href="../man3/MPI_Win_allocate_shared.3.php">MPI_Win_allocate_shared</a>
<br>
