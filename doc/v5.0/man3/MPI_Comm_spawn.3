...
.\" $COPYRIGHT$
.TH MPI_Comm_spawn 3 "Sep 30, 2021" "5.0.0rc1" "Open MPI"
.SH NAME
...
command itself. The argument list is terminated by NULL in C
...
string. The constant MPI_ARGV_NULL may be used in C and Fortran
to indicate an empty argument list. In C, this constant is the
same as NULL.
.sp
