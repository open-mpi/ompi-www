<?php
$topdir = "../../..";
$title = "MPI_Type_create_f90_complex(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_TYPE_CREATE_F90_COMPLEX(3)";
...
<br>
<pre>MPI_Type_create_f90_complex - Returns a bounded MPI complex datatype
</pre>
...
a way to declare KIND-parameterized COMPLEX MPI datatypes. The arguments
are interpreted in a similar fashion to the F90 function SELECTED_REAL_KIND.
...
argument to MPI_Type_create_f90_complex may be set to MPI_UNDEFINED.
<p>
...
defined for datatypes returned by MPI_Type_create_f90_complex. Two MPI datatypes,
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;external32 size = 32
