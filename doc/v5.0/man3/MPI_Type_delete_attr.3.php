<?php
$topdir = "../../..";
$title = "MPI_Type_delete_attr(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_TYPE_DELETE_ATTR(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: type_keyval
...
replaces <a href="../man3/MPI_Attr_delete.3.php">MPI_Attr_delete</a>, which is now deprecated.
<p>
<p>
