<?php
$topdir = "../../..";
$title = "MPI_Bcast_init(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_BCAST_INIT(3)";
...
<li><a name='toc3' href='#sect3'>C]#include <mpi.h>int <a href="../man3/MPI_Bcast.3.php">MPI_Bcast</a>(void *buffer, int count, MPI_Datatype datatype,    int root, MPI_Comm comm)int <a href="../man3/MPI_Ibcast.3.php">MPI_Ibcast</a>(void *buffer, int count, MPI_Datatype datatype,    int root, MPI_Comm comm, MPI_Request *request)R]Fortran Syntax</a></li>
