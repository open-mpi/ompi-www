<?php
$topdir = "../../..";
$title = "MPI_Waitsome(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_WAITSOME(3)";
...
if one or more requests generate an MPI error, only the <i>first</i> MPI request
that caused an error will be passed to its corresponding error handler.
 No other error handlers will be invoked (even if multiple requests generated
errors).  However, <i>all</i> requests that generate an error will have a relevant
...
<p>
If the invoked error handler allows MPI_Waitsome to return to the caller,
