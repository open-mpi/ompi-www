<?php
$topdir = "../../..";
$title = "MPI_Open_port(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_OPEN_PORT(3)";
...
<b>MPI_Open_port</b> - Establishes a network address for a server to
