<?php
$topdir = "../../..";
$title = "MPI_Dist_graph_neighbors_count(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_DIST_GRAPH_NEIGHBORS_COUNT(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: indegree, outdegree
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(OUT) :: weighted
