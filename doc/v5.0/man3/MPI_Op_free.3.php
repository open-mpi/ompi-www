<?php
$topdir = "../../..";
$title = "MPI_Op_free(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_OP_FREE(3)";
...
<pre>USE mpi_f08
MPI_Op_free(op, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Op), INTENT(INOUT) :: op
...
operation for deallocation and sets <i>op</i> to MPI_OP_NULL.
<p>
...
<p><a href="../man3/MPI_Scan.3.php">MPI_Scan</a>
<p> <p>
