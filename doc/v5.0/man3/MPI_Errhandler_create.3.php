<?php
$topdir = "../../..";
$title = "MPI_Errhandler_create(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_ERRHANDLER_CREATE(3)";
...
for use as an MPI error handler. Returns in errhandler a handle to the registered
error handler. <p>
In the C language, the user routine should be a C function
of type MPI_Handler_function, which is defined as <p>
<br>
