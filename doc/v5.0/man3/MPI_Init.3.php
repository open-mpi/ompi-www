<?php
$topdir = "../../..";
$title = "MPI_Init(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_INIT(3)";
...
This routine, or <a href="../man3/MPI_Init_thread.3.php">MPI_Init_thread</a>, must be called
before most other MPI routines are called.  There are a small number of
errors, such as <a href="../man3/MPI_Initialized.3.php">MPI_Initialized</a> and <a href="../man3/MPI_Finalized.3.php">MPI_Finalized</a>.  MPI can be initialized
...
MPI accepts the C <i>argc</i> and <i>argv</i> arguments to main, but neither modifies,
