<?php
$topdir = "../../..";
$title = "MPI_Error_string(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_ERROR_STRING(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;CHARACTER(LEN=MPI_MAX_ERROR_STRING), INTENT(OUT) :: string
