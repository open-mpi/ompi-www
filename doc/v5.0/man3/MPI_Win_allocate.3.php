<?php
$topdir = "../../..";
$title = "MPI_Win_allocate(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_WIN_ALLOCATE(3)";
...
environment. <p>
Calling <b><a href="../man3/MPI_Win_free.3.php">MPI_Win_free</a></b> will deallocate the memory allocated by
<b>MPI_Win_allocate</b>. It is thus erroneous to manually free <i>baseptr</i>.
<p>
<h2><a name='sect9' href='#toc9'>C Notes</a></h2>
While
<i>baseptr</i> is a <i>void *</i> type, this is to allow easy use of any pointer object
for this parameter. This argument is really a <i>void **</i> type. <p>
...
<p>
<a href="../man3/MPI_Alloc_mem.3.php">MPI_Alloc_mem</a> <a href="../man3/MPI_Free_mem.3.php">MPI_Free_mem</a> <a href="../man3/MPI_Win_create.3.php">MPI_Win_create</a> <a href="../man3/MPI_Win_allocate_shared.3.php">MPI_Win_allocate_shared</a>
<a href="../man3/MPI_Win_free.3.php">MPI_Win_free</a> <p>
...
<li><a name='toc9' href='#sect9'>C Notes</a></li>
