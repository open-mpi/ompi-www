<?php
$topdir = "../../..";
$title = "MPI_Type_get_envelope(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_TYPE_GET_ENVELOPE(3)";
...
MPI_COMBINER_HVECTOR            <a href="../man3/MPI_Type_hvector.3.php">MPI_Type_hvector</a> from C
...
MPI_COMBINER_HINDEXED           <a href="../man3/MPI_Type_hindexed.3.php">MPI_Type_hindexed</a> from C
...
MPI_COMBINER_STRUCT             <a href="../man3/MPI_Type_struct.3.php">MPI_Type_struct</a> from C
