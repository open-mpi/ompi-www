<?php
$topdir = "../../..";
$title = "MPI_File_get_amode(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_FILE_GET_AMODE(3)";
...
<b>MPI_File_get_amode</b> - Returns access mode associated with an
open file.
<p>
