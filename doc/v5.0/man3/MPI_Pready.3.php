<?php
$topdir = "../../..";
$title = "MPI_Pready(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_PREADY(3)";
...
<b>MPI_Pready</b> - Indicates that a given send-side partition is ready
to be transferred.
<p>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;PARTITION, REQUEST, IERROR
</pre>
<h2><a name='sect4' href='#toc4'>Fortran 2008 Syntax</a></h2>
<br>
<pre>USE mpi_f08
MPI_Pready(partition, request, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: partition
...
<dt>partition </dt>
<dd>The number of the partition to mark ready for
transfer (integer). </dd>
...
<a href="../man3/MPI_Pready_list.3.php">MPI_Pready_list</a>, <a href="../man3/MPI_Pready_range.3.php">MPI_Pready_range</a>,
<a href="../man3/MPI_Parrived.3.php">MPI_Parrived</a> <br>
<p>
