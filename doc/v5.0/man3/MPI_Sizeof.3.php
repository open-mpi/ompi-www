<?php
$topdir = "../../..";
$title = "MPI_Sizeof(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_SIZEOF(3)";
...
the sizeof builtin in C. However, if given an array argument, it returns
the size of the base element, not the size of the whole array.
<p>
<h2><a name='sect7' href='#toc7'>Notes</a></h2>
This
function is not available in C because it is not necessary.
<p>
