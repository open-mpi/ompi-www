<?php
$topdir = "../../..";
$title = "MPI_Rsend(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_RSEND(3)";
...
<dt>count </dt>
<dd>Number
of elements in send buffer (nonnegative integer). </dd>
...
if the receive is not posted before the ready send is called.
<p>
