<?php
$topdir = "../../..";
$title = "MPI_File_read_ordered(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_FILE_READ_ORDERED(3)";
...
<b>MPI_File_read_ordered</b> - Reads a file at a location specified
...
Each process attempts to read, from the file associated with <i>fh,</i> a total
number of <i>count</i> data items having <i>datatype</i> type into the user&rsquo;s buffer <i>buf.</i>
...
their data. MPI_File_read_ordered returns the actual number of <i>datatype</i>
elements read in <i>status.</i> The shared file pointer is updated by the amounts
