<?php
$topdir = "../../..";
$title = "MPI_Type_create_f90_integer(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_TYPE_CREATE_F90_INTEGER(3)";
...
<br>
<pre>MPI_Type_create_f90_integer - Returns a bounded MPI integer datatype
</pre>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;R, NEWTYPE, IERROR
</pre>
<h2><a name='sect4' href='#toc4'>Fortran 2008 Syntax</a></h2>
<br>
<pre>USE mpi_f08
MPI_Type_create_f90_integer(r, newtype, ierror)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: r
...
<dt>r </dt>
<dd>Precision, in decimal digits (integer).
<p> </dd>
</dl>
...
<i>r</i> must be a scalar integer, and represents the desired level of numerical
precision, in decimal digits.
<p>
<h2><a name='sect8' href='#toc8'>Notes</a></h2>
It is erroneous to supply a value for
<i>r</i> not supported by the compiler. <p>
The Fortran function SELECTED_INT_KIND
maps a large number of <i>r</i> values to a much smaller number of KIND parameters
...
KIND parameters were generated by different <i>r</i> arguments to SELECTED_INT_KIND.
...
if they have identical values for <i>r</i>. <p>
The interaction between the datatypes
returned by this function and the external32 data representation - used
by <a href="../man3/MPI_Pack_external.3.php">MPI_Pack_external</a>, <a href="../man3/MPI_Unpack_external.3.php">MPI_Unpack_external</a> and many MPI_File functions -
is subtle. The external32 representation of returned datatypes is as follows.
<p>
<br>
<pre><tt> </tt>&nbsp;<tt> </tt>&nbsp;if (r &gt; 38):
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;external32 size = n/a (undefined)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;else if (r &gt; 18):
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;external32 size = 16
<tt> </tt>&nbsp;<tt> </tt>&nbsp;else if (r &gt; 9):
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;external32 size = 8
<tt> </tt>&nbsp;<tt> </tt>&nbsp;else if (r &gt; 4):
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;external32 size = 4
<tt> </tt>&nbsp;<tt> </tt>&nbsp;else if (r &gt; 2):
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;external32 size = 2
<tt> </tt>&nbsp;<tt> </tt>&nbsp;else:
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;external32 size = 1
</pre><p>
...
that was not obtained with SELECTED_INT_KIND (i.e., <i>r</i> is unknown), the only
way to obtain a matching MPI datatype is to use the functions <a href="../man3/MPI_Sizeof.3.php">MPI_Sizeof</a>
