<?php
$topdir = "../../..";
$title = "MPI_Reduce_scatter_block_init(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_REDUCE_SCATTER_BLOCK_INIT(3)";
...
<b><a href="../man3/MPI_Reduce_scatter_block.3.php">MPI_Reduce_scatter_block</a>, <a href="../man3/MPI_Ireduce_scatter_block.3.php">MPI_Ireduce_scatter_block</a>, MPI_Reduce_scatter_block_init</b>
...
int MPI_Reduce_scatter_block_init(const void *sendbuf, void *recvbuf, int
recvcount,
...
<br>
<pre>USE mpi_f08
<a href="../man3/MPI_Ireduce_scatter_block.3.php">MPI_Ireduce_scatter_block</a>(sendbuf, recvbuf, recvcount, datatype, op, comm,
