<?php
$topdir = "../../..";
$title = "MPI_Win_get_name(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_WIN_GET_NAME(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER WIN, RESULTLEN, IERROR
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;CHARACTER(LEN=MPI_MAX_OBJECT_NAME), INTENT(OUT) :: win_name
...
<dt>win </dt>
<dd>Window whose name is to be returned (handle).
<p> </dd>
</dl>
