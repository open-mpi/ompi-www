<?php
$topdir = "../../..";
$title = "MPI_Ibarrier(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_IBARRIER(3)";
...
<li><a name='toc3' href='#sect3'>C]#include <mpi.h>int <a href="../man3/MPI_Barrier.3.php">MPI_Barrier</a>(MPI_Comm)int MPI_Ibarrier(MPI_Comm comm, MPI_Request *request)R]Fortran Syntax</a></li>
<li><a name='toc4' href='#sect4'>C]USE MPI! or the older form: INCLUDE [aq]mpif.h[aq]<a href="../man3/MPI_Barrier.3.php">MPI_BARRIER</a>(COMM, IERROR)    INTEGER COMM, IERRORMPI_IBARRIER(COMM, REQUEST, IERROR)    INTEGER COMM, REQUEST, IERRORR]Fortran 2008 Syntax</a></li>
</ul>
