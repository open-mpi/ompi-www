<?php
$topdir = "../../..";
$title = "MPI_Ibarrier(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_IBARRIER(3)";
...
<p>
<a href="../man3/MPI_Barrier.3.php">MPI_Barrier</a>, MPI_Ibarrier - Synchronization between MPI processes
in a group
...
<h3><a name='sect3' href='#toc3'>C]#include &lt;mpi.h&gt;int <a href="../man3/MPI_Barrier.3.php">MPI_Barrier</a>(MPI_Comm)int MPI_Ibarrier(MPI_Comm comm,
...
<li><a name='toc3' href='#sect3'>C]#include <mpi.h>int <a href="../man3/MPI_Barrier.3.php">MPI_Barrier</a>(MPI_Comm)int MPI_Ibarrier(MPI_Comm comm, MPI_Request *request)int <a href="../man3/MPI_Barrier_init.3.php">MPI_barrier_init</a>(MPI_Comm comm, MPI_Info info, MPI_Request *request)R]Fortran Syntax</a></li>
