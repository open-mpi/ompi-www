<?php
$topdir = "../../..";
$title = "MPI_Rget_accumulate(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_RGET_ACCUMULATE(3)";
...
<h3><a name='sect3' href='#toc3'>C]#include &lt;mpi.h&gt;int <a href="../man3/MPI_Get_accumulate.3.php">MPI_Get_accumulate</a>(const void *origin_addr, int origin_count,
   MPI_Datatype origin_datatype, void *result_addr,    int result_count,
MPI_Datatype result_datatype,    int target_rank, MPI_Aint target_disp,
int target_count,    MPI_Datatype target_datatype, MPI_Op op, MPI_Win win)int
MPI_Rget_accumulate(const void *origin_addr, int origin_count,    MPI_Datatype
...
<h3><a name='sect4' href='#toc4'>C]USE MPI! or the older form: INCLUDE [aq]mpif.h[aq]<a href="../man3/MPI_Get_accumulate.3.php">MPI_GET_ACCUMULATE</a>(ORIGIN_ADDR,
