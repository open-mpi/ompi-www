<?php
$topdir = "../../..";
$title = "MPI_Isendrecv(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_ISENDRECV(3)";
...
<b>MPI_Isendrecv</b> - Sends and receives a message.
<p>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;recvcount, recvtype, source, recvtag, comm, request, ierror)
...
The non-blocking
send-receive operations combine in one call the sending of a message to
one destination and the receiving of another message, from another process.
The two (source and destination) are possibly the same. This operation is
useful for executing a shift operation across a chain of processes. The
send-receive operation can be used in conjunction with the functions described
in the "Process Topologies" chapter of the MPI Standard in order to perform
shifts on various logical topologies.  <p>
A message sent by a send-receive operation
can be received by a regular receive operation or probed by a probe operation;
a send-receive operation can receive a message sent by a regular send operation.
<p>
MPI_Isendrecv executes a non-blocking send and receive operation. Both send
...
lengths and datatypes. <p>
A non-blocking send-receive request can be determined
to be completed by calling the <a href="../man3/MPI_Wait.3.php">MPI_Wait</a>, <a href="../man3/MPI_Waitany.3.php">MPI_Waitany</a>, <a href="../man3/MPI_Test.3.php">MPI_Test</a>, or <a href="../man3/MPI_Testany.3.php">MPI_Testany</a>
...
<p>
<a href="../man3/MPI_Isendrecv_replace.3.php">MPI_Isendrecv_replace</a>
