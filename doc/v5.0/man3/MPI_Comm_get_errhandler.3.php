<?php
$topdir = "../../..";
$title = "MPI_Comm_get_errhandler(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_COMM_GET_ERRHANDLER(3)";
...
<b>MPI_Comm_get_errhandler </b> - Retrieves error handler associated
with a communicator.
<p>
...
to <a href="../man3/MPI_Errhandler_get.3.php">MPI_Errhandler_get</a>, the use of which is deprecated.
<p>
