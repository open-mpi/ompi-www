<?php
$topdir = "../../..";
$title = "MPI_Status_set_elements_x(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_STATUS_SET_ELEMENTS_X(3)";
...
<b><a href="../man3/MPI_Status_set_elements.3.php">MPI_Status_set_elements</a></b>, <b>MPI_Status_set_elements_x</b> - Modifies
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Status_set_elements.3.php">MPI_Status_set_elements</a>(MPI_Status *status, MPI_Datatype datatype,
int count)
...
<a href="../man3/MPI_Status_set_elements.3.php">MPI_STATUS_SET_ELEMENTS</a>(STATUS, DATATYPE, COUNT, IERROR)
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Status), INTENT(INOUT) :: status
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(MPI_Datatype), INTENT(IN) :: datatype
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER(KIND = MPI_COUNT_KIND), INTENT(IN) :: count
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, OPTIONAL, INTENT(OUT) :: ierror
</pre>
...
<a href="../man3/MPI_Status_set_elements.3.php">MPI_Status_set_elements</a>
...
argument that was used in the call to <a href="../man3/MPI_Status_set_elements.3.php">MPI_Status_set_elements</a>.
<p>
...
Fortran syntax for the <i>COUNT</i> argument of MPI_Status_set_elements_x only
