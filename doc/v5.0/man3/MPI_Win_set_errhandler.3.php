<?php
$topdir = "../../..";
$title = "MPI_Win_set_errhandler(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_WIN_SET_ERRHANDLER(3)";
...
error handler or an error handler created by a call to <a href="../man3/MPI_Win_create_errhandler.3.php">MPI_Win_create_errhandler</a>.
