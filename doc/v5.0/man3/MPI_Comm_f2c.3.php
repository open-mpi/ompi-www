<?php
$topdir = "../../..";
$title = "MPI_Comm_f2c(3) man page (version 5.0.0rc3)";
$meta_desc = "Open MPI v5.0.0rc3 man page: MPI_COMM_F2C(3)";
...
<b>MPI_Comm_f2c, <a href="../man3/MPI_Comm_c2f.3.php">MPI_Comm_c2f</a>, <a href="../man3/MPI_File_f2c.3.php">MPI_File_f2c</a>, <a href="../man3/MPI_File_c2f.3.php">MPI_File_c2f</a>, <a href="../man3/MPI_Info_f2c.3.php">MPI_Info_f2c</a>,
...
then MPI_Comm_f2c returns a valid C handle to that same communicator; if
<i>comm</i> = MPI_COMM_NULL (Fortran value), then MPI_Comm_f2c returns a null
C handle; if <i>comm</i> is an invalid Fortran handle, then MPI_Comm_f2c returns
an invalid C handle.
