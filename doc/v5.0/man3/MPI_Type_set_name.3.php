<?php
$topdir = "../../..";
$title = "MPI_Type_set_name(3) man page (version 5.0.0rc1)";
$meta_desc = "Open MPI v5.0.0rc1 man page: MPI_TYPE_SET_NAME(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;CHARACTER(LEN=*), INTENT(IN) :: type_name
