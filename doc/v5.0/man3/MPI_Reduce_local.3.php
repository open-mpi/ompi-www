<?php
$topdir = "../../..";
$title = "MPI_Reduce_local(3) man page (version 5.0.0rc2)";
$meta_desc = "Open MPI v5.0.0rc2 man page: MPI_REDUCE_LOCAL(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;TYPE(*), DIMENSION(..) :: inoutbuf
...
The global reduce functions (MPI_Reduce_local, <a href="../man3/MPI_Op_create.3.php">MPI_Op_create</a>,
<a href="../man3/MPI_Op_free.3.php">MPI_Op_free</a>, <a href="../man3/MPI_Allreduce.3.php">MPI_Allreduce</a>, MPI_Reduce_local_scatter, <a href="../man3/MPI_Scan.3.php">MPI_Scan</a>) perform
...
Option</a></h2>
The use of MPI_IN_PLACE is disallowed with MPI_Reduce_local. <p>

<h2><a name='sect9' href='#toc9'>Predefined
Reduce Operations</a></h2>
<p>
...
operations are supplied for MPI_Reduce_local and related functions <a href="../man3/MPI_Allreduce.3.php">MPI_Allreduce</a>,
...
<h2><a name='sect11' href='#toc11'>Notes on Collective
Operations</a></h2>

<p> The reduction operators ( <i>MPI_Op</i> ) do not return an error value.
 As a result, if the functions detect an error, all they can do is either
call <i><a href="../man3/MPI_Abort.3.php">MPI_Abort</a></i> or silently skip the problem.  Thus, if you change the error
handler from <i>MPI_ERRORS_ARE_FATAL</i> to something else, for example, <i>MPI_ERRORS_RETURN</i>
, then no error may be indicated.
<p> The reason for this is the performance
