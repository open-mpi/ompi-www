<?php
$topdir = "../../..";
$title = "orte_snapc(7) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: orte_snapc(7)";
...
<dt>snapc_base_global_snapshot_dir
</dt>
<dd>The directory to store the checkpoint snapshots. Default is <b>/tmp</b>.    </dd>
</dl>

<h3><a name='sect4' href='#toc4'>full
SnapC Component</a></h3>
<p>
The <i>full</i> component gathers together the local snapshots
...
hierarchy of coordinators.  <p>
The <i>full</i> component has the following MCA parameters:

<dl>

<dt>snapc_full_priority </dt>
<dd>The component&rsquo;s priority to use when selecting the
most appropriate component for a run.  </dd>

<dt>snapc_full_verbose </dt>
<dd>Set the verbosity
level for this component. Default is 0, or silent except on error.    </dd>
</dl>

<h3><a name='sect5' href='#toc5'>none
SnapC Component</a></h3>
<p>
The <i>none</i> component simply selects no SnapC component. All
of the SnapC function calls return immediately with ORTE_SUCCESS.   <p>
This
component is the last component to be selected by default. This means that
if another component is available, and the <i>none</i> component was not explicity
...
<i>orte-restart(1)</i>, <i>opal-checkpoint(1)</i>, <i>opal-restart(1)</i>,<br>
