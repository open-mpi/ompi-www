<?php
$topdir = "../../..";
$title = "MPI_Start(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_START(3)";
...
<b>MPI_Start</b> - Initiates a communication using a persistent request handle.
