<?php
$topdir = "../../..";
$title = "MPI_File_write_ordered(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_FILE_WRITE_ORDERED(3)";
...
<b>MPI_File_write_ordered</b> - Writes a file at a location specified by
