<?php
$topdir = "../../..";
$title = "MPI_Alltoall(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_ALLTOALL(3)";
...
being the number of processes in communicator <i>comm</i>) independent point-to-point
communications (including communication with itself). <p>
<br>
...
The
MPI_IN_PLACE option is not available for this function. <p>
All arguments on
all processes are significant. The <i>comm</i> argument, in particular, must describe
the same communicator on all processes. <p>
There are two MPI library functions
that are more general than MPI_Alltoall. <a href="../man3/MPI_Alltoallv.3.php">MPI_Alltoallv</a> allows all-to-all communication
to and from buffers that need not be contiguous; different processes may
send and receive different amounts of data. <a href="../man3/MPI_Alltoallw.3.php">MPI_Alltoallw</a> expands <a href="../man3/MPI_Alltoallv.3.php">MPI_Alltoallv</a>&rsquo;s
