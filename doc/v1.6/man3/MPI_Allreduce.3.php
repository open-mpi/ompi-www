<?php
$topdir = "../../..";
$title = "MPI_Allreduce(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_ALLREDUCE(3)";
...
<b>MPI_Allreduce</b> - Combines values from all processes and distributes
...
Same as <a href="../man3/MPI_Reduce.3.php">MPI_Reduce</a> except
that the result appears in the receive buffer of all the group members.
 <p>
