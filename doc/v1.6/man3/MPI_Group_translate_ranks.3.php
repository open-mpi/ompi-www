<?php
$topdir = "../../..";
$title = "MPI_Group_translate_ranks(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_GROUP_TRANSLATE_RANKS(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int *ranks1, MPI_Group group2, int *ranks2)
</pre>
