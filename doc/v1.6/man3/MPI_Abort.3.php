<?php
$topdir = "../../..";
$title = "MPI_Abort(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_ABORT(3)";
...
all processes in all tasks that contain a process in <i>comm</i>, and the error
code is not returned to the invoking environment. <p>
