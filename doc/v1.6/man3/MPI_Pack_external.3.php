<?php
$topdir = "../../..";
$title = "MPI_Pack_external(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_PACK_EXTERNAL(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const void* inbuf, int incount,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;void* outbuf, MPI::Aint outsize,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI::Aint&amp; position) const
</pre>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;    buf, 1000, &amp;position);
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<a href="../man3/MPI_Send.3.php">MPI_Send</a>(buf, position, MPI_PACKED, 1, 0,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;    MPI_COMM_WORLD);
<tt> </tt>&nbsp;<tt> </tt>&nbsp;} else {<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;/* RECEIVER CODE */
<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<tt> </tt>&nbsp;<a href="../man3/MPI_Recv.3.php">MPI_Recv</a>(buf, 1, MPI_PACKED, 0, 0, MPI_COMM_WORLD,
