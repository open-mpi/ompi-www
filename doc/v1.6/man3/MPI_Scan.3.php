<?php
$topdir = "../../..";
$title = "MPI_Scan(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_SCAN(3)";
...
MPI_Scan
is used to perform an inclusive prefix reduction on data distributed across
...
the values in the <i>sendbuf</i>s of processes with ranks 0, ..., i (inclusive). The
type of operations supported, their semantics, and the constraints on send
and receive buffers are as for <a href="../man3/MPI_Reduce.3.php">MPI_Reduce</a>.
<p>
<h2><a name='sect8' href='#toc8'>Example</a></h2>
This example uses a user-defined
operation to produce a segmented scan. A segmented scan takes, as input,
a set of values and a set of logicals, where the logicals delineate the
various segments of the scan. For example, <p>
<br>
