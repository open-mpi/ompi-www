<?php
$topdir = "../../..";
$title = "MPI_Win_test(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_WIN_TEST(3)";
...
<i>ag = true</i> if <a href="../man3/MPI_Win_wait.3.php">MPI_Win_wait</a> would return, <i>ag = false</i> otherwise. The effect
of return of MPI_Win_test with <i>flag = true</i> is the same as the effect of
a return of <a href="../man3/MPI_Win_wait.3.php">MPI_Win_wait</a>. If <i>ag = false</i> is returned, then the call has no
visible effect. <p>
Invoke MPI_Win_test only where <a href="../man3/MPI_Win_wait.3.php">MPI_Win_wait</a> can be invoked.
Once the call has returned <i>ag = true</i>, it must not be invoked anew, until
