<?php
$topdir = "../../..";
$title = "MPI_Type_create_indexed_block(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_TYPE_CREATE_INDEXED_BLOCK(3)";
...
<b>MPI_Type_create_indexed_block</b> - Creates an indexed data type with
