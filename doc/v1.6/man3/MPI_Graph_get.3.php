<?php
$topdir = "../../..";
$title = "MPI_Graph_get(3) man page (version 1.6.4)";
$meta_desc = "Open MPI v1.6.4 man page: MPI_GRAPH_GET(3)";
...
<b>MPI_Graph_get </b> - Retrieves graph topology information associated with
a communicator.
<p>
