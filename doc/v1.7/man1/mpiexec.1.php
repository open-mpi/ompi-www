<?php
$topdir = "../../..";
$title = "mpiexec(1) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: mpiexec(1)";
...
<dd>Map to the specified object, defaults
to <i>socket</i>. Supported options include slot, hwthread, core, socket, numa,
board, and node.  </dd>
...
<dd>Bind each
process to the specified number of cpus.  </dd>

<dt><b>-cpus-per-rank, --cpus-per-rank &lt;#perrank&gt;</b>
</dt>
<dd>Alias for <i>-cpus-per-proc</i>.  </dd>

<dt><b>-bind-to-core, --bind-to-core</b> </dt>
<dd>Bind processes to cores (deprecated
in favor of --bind-to core)  </dd>

<dt><b>-bind-to-socket, --bind-to-socket</b> </dt>
<dd>Bind processes to
processor sockets  (deprecated in favor of --bind-to socket)  </dd>
