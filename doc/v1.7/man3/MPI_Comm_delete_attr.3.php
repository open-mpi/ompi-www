<?php
$topdir = "../../..";
$title = "MPI_Comm_delete_attr(3) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: MPI_COMM_DELETE_ATTR(3)";
...
<b>MPI_Comm_delete_attr</b> - Deletes attribute value associated with a
key.
<p>
...
delete function delete_fn specified when the <i>comm_keyval</i> was created. The
call will fail if the delete_fn function returns an error code other than
MPI_SUCCESS.
<p> Whenever a communicator is replicated using the function
<a href="../man3/MPI_Comm_dup.3.php">MPI_Comm_dup</a>, all callback copy functions for attributes that are currently
set are invoked (in arbitrary order). Whenever a communicator is deleted
using the function <a href="../man3/MPI_Comm_free.3.php">MPI_Comm_free</a>, all callback delete functions for attributes
that are currently set are invoked.  <p>
This function is the same as <a href="../man3/MPI_Attr_delete.3.php">MPI_Attr_delete</a>
but is needed to match the communicator-specific functions introduced in
the MPI-2 standard. The use of <a href="../man3/MPI_Attr_delete.3.php">MPI_Attr_delete</a> is deprecated.
<p>
<p>
