<?php
$topdir = "../../..";
$title = "MPI_Mprobe(3) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: MPI_MPROBE(3)";
...
and <a href="../man3/MPI_Improbe.3.php">MPI_Improbe</a> opera- tions allow incoming messages to be queried without
...
A
matching probe with MPI_PROC_NULL as <i>source</i> returns <i>message</i> = MPI_MESSAGE_NULL,
