<?php
$topdir = "../../..";
$title = "MPI_Type_create_indexed_block(3) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: MPI_TYPE_CREATE_INDEXED_BLOCK(3)";
...
MPI_Type_create_indexed_block takes displacements in bytes.
<p>
