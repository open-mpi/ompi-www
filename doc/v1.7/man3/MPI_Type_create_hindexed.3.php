<?php
$topdir = "../../..";
$title = "MPI_Type_create_hindexed(3) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: MPI_TYPE_CREATE_HINDEXED(3)";
...
The function <a href="../man3/MPI_Type_indexed.3.php">MPI_Type_indexed</a> allows replication of an old
