<?php
$topdir = "../../..";
$title = "MPI_Bsend_init(3) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: MPI_BSEND_INIT(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER<tt> </tt>&nbsp;<tt> </tt>&nbsp;COUNT, DATATYPE, DEST, TAG,
...
<dt>count </dt>
<dd>Number of elements sent (integer).
</dd>
...
<dt>dest </dt>
<dd>Rank of destination (integer).
</dd>
...
Creates a persistent communication request for a buffered
mode send, and binds to it all the arguments of a send operation.  <p>
A communication
(send or receive) that uses a persistent request is initiated by the function
...
<br>
<pre><a href="../man3/MPI_Send_init.3.php">MPI_Send_init</a>
