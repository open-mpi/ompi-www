<?php
$topdir = "../../..";
$title = "MPI_Win_get_errhandler(3) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: MPI_WIN_GET_ERRHANDLER(3)";
...
<b>MPI_Win_get_errhandler</b> - Retrieves the error handler currently associated
with a window.
<p>
