<?php
$topdir = "../../..";
$title = "MPI_Attr_get(3) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: MPI_ATTR_GET(3)";
...
<br>
<pre>import mpi.*;
int MPI.COMM_WORLD.Attr_get(MPI.keyval)
</pre>
...
Note
that use of this routine is <i>deprecated</i> as of MPI-2. Please use <a href="../man3/MPI_Comm_get_attr.3.php">MPI_Comm_get_attr</a>
instead. <p>
