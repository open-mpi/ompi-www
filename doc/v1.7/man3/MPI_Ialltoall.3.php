<?php
$topdir = "../../..";
$title = "MPI_Ialltoall(3) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: MPI_IALLTOALL(3)";
...
<b><a href="../man3/MPI_Alltoall.3.php">MPI_Alltoall</a>, MPI_Ialltoall</b> - All processes send data to all processes
...
<br>
<pre>#include &lt;mpi.h&gt;
int <a href="../man3/MPI_Alltoall.3.php">MPI_Alltoall</a>(const void *sendbuf, int sendcount,
...
<a href="../man3/MPI_Alltoall.3.php">MPI_ALLTOALL</a>(SENDBUF, SENDCOUNT, SENDTYPE, RECVBUF, RECVCOUNT,
...
<br>
<pre>import mpi.*;
void MPI.COMM_WORLD.Alltoall(Object sendbuf, int sendoffset, int sendcount,
...
<dt>recvcount </dt>
<dd>Number of
elements to receive from each process (integer). </dd>

<dt>recvtype </dt>
<dd>Datatype of receive
...
<dt>recvbuf </dt>
<dd>Starting address of receive buffer (choice).
</dd>
...
<a href="../man3/MPI_Alltoall.3.php">MPI_Alltoall</a> is a collective operation in which
all processes send the same amount of data to each other, and receive the
same amount of data from each other. The operation of this routine can be
represented as follows, where each process performs 2n (n being the number
...
<p>
<h2><a name='sect9' href='#toc9'>Use of
...
than <a href="../man3/MPI_Alltoall.3.php">MPI_Alltoall</a>. <a href="../man3/MPI_Alltoallv.3.php">MPI_Alltoallv</a> allows all-to-all communication to and from
