<?php
$topdir = "../../..";
$title = "MPI_Dist_graph_create_adjacent(3) man page (version 1.7.4)";
$meta_desc = "Open MPI v1.7.4 man page: MPI_DIST_GRAPH_CREATE_ADJACENT(3)";
...
<b>MPI_Dist_graph_create_adjacent </b> - Makes a new communicator to which
