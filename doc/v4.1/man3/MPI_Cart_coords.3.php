<?php
$topdir = "../../..";
$title = "MPI_Cart_coords(3) man page (version 4.1.2)";
$meta_desc = "Open MPI v4.1.2 man page: MPI_CART_COORDS(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: rank, maxdims
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(OUT) :: coords(maxdims)
...
<dt>maxdims </dt>
<dd> Length of vector
coords in the calling program (integer).<br>
