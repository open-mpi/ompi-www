<?php
$topdir = "../../..";
$title = "MPI_Cart_get(3) man page (version 4.1.8)";
$meta_desc = "Open MPI v4.1.8 man page: MPI_CART_GET(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(IN) :: maxdims
<tt> </tt>&nbsp;<tt> </tt>&nbsp;INTEGER, INTENT(OUT) :: dims(maxdims), coords(maxdims)
<tt> </tt>&nbsp;<tt> </tt>&nbsp;LOGICAL, INTENT(OUT) :: periods(maxdims)
