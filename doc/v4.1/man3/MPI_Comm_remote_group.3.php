<?php
$topdir = "../../..";
$title = "MPI_Comm_remote_group(3) man page (version 4.1.4)";
$meta_desc = "Open MPI v4.1.4 man page: MPI_COMM_REMOTE_GROUP(3)";
...
<b>MPI_Comm_remote_group </b> - Accesses the remote group associated with
