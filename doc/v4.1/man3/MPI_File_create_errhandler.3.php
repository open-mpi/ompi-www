<?php
$topdir = "../../..";
$title = "MPI_File_create_errhandler(3) man page (version 4.1.5)";
$meta_desc = "Open MPI v4.1.5 man page: MPI_FILE_CREATE_ERRHANDLER(3)";
...
exception handler. <p>
In the C language, the user routine <i>function</i> should be
a C function of type MPI_File_errhandler_function, which is defined as
<p>
<br>
