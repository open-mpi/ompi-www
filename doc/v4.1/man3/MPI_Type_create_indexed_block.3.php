<?php
$topdir = "../../..";
$title = "MPI_Type_create_indexed_block(3) man page (version 4.1.2)";
$meta_desc = "Open MPI v4.1.2 man page: MPI_TYPE_CREATE_INDEXED_BLOCK(3)";
...
int <a href="../man3/MPI_Type_create_hindexed_block.3.php">MPI_Type_create_hindexed_block</a>(int count, int blocklength, const MPI_Aint
array_of_displacements[], MPI_Datatype oldtype, MPI_Datatype *newtype)
</pre>
...
USE mpi_f08 MPI_Type_create_indexed_block(<i>count</i>, <i>blocklength</i>,
...
<p> <a href="../man3/MPI_Type_create_hindexed_block.3.php">MPI_Type_create_hindexed_block</a>(<i>count</i>, <i>blocklength</i>, <i>array_of_displacements</i>,
