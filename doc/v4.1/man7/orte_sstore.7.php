<?php
$topdir = "../../..";
$title = "orte_sstore(7) man page (version 4.1.4)";
$meta_desc = "Open MPI v4.1.4 man page: orte_sstore(7)";
...
of Open RTE&rsquo;s SStore framework, and selected modules.  Open MPI 4.1.4
