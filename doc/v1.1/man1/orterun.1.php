<?php
$topdir = "../../..";
$title = "orterun(1) man page (version 1.1.5)";
...
<H2>OPTIONS</H2><PRE>
       ...
       <B>-np</B> &lt;#&gt;   Run this many copies of the program on the given nodes.  This
       ...
       <B>-wd</B> &lt;dir&gt; Change  to the directory &lt;dir&gt; before the user's program exe-
                 cutes.  See the "Current Working Directory" section for notes
                 on  relative  paths.  <B>Note:</B> If the <I>-wd</I> option appears both on
...
<H2>DESCRIPTION</H2><PRE>
   ...
   <B>Specifying</B> <B>Hosts</B>
       ...
       mpirun --hostfile my-hostfile -np 3 a.out
              This will  run  one  copy  of  the  executable  <I>a.out</I>  on  hosts
   ...
   <B>Current</B> <B>Working</B> <B>Directory</B>
       If  the <I>-wd</I> option is specified, Open MPI will attempt to change to the
       specified directory on all of the remote nodes. If this  fails,  <I>mpirun</I>
       will abort.

       If  the  <I>-wd</I>  option is <B>not</B> specified, Open MPI will send the directory
   ...
   <B>Process</B> <B>Termination</B> <B>/</B> <B>Signal</B> <B>Handling</B>
       ...
       invoked, if this user handler  attempts  to  invoke  <I>MPI</I><B>_</B><I>FINALIZE</I>,  Bad
       Things  could happen since Open MPI was already "in" MPI when the error
       occurred.  Since <I>mpirun</I> will notice that the process died due to a sig-
   ...
   <B>Remote</B> <B>Execution</B>
       ...
       The  <I>--prefix</I> option is not sufficient if the installation paths on the
...
<H2>RETURN VALUE</H2><PRE>
       ...
       process that <I>mpirun</I> first notices died before calling MPI_FINALIZE will
