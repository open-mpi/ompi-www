<?php
$topdir = "../../..";
$title = "mpicxx(1) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: mpicxx(1)";
...
that can be passed through mpicxx.
<h2><a name='sect3' href='#toc3'>Description</a></h2>
<p>
Conceptually, the role of
these commands is quite simple: transparently add relevant compiler and
linker flags to the user&rsquo;s command line that are necessary to compile /
