<?php
$topdir = "../../..";
$title = "mpif90(1) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: mpif90(1)";
...
flags.  For example, both "mpif90 --showme" and "mpif90 --showme my_source.c"
will show all the wrapper-supplied flags.  But "mpif90 --showme -v" will only
show the underlying compiler name and "-v". </dd>

<dt>--showme:compile </dt>
<dd>Output the compiler
flags that would have been supplied to the Fortran 90 compiler. </dd>

<dt>--showme:link
</dt>
<dd>Output the linker flags that would have been supplied to the Fortran 90
compiler. </dd>

<dt>--showme:command </dt>
<dd>Outputs the underlying Fortran 90 compiler command
...
would have provided to the underlying Fortran 90 compiler to indicate where
...
Fortran 90 compiler for other options that can be passed through mpif90.
