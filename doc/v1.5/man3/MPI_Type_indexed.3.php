<?php
$topdir = "../../..";
$title = "MPI_Type_indexed(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_TYPE_INDEXED(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int *array_of_displacements, MPI_Datatype oldtype,
...
of oldtype extent (array of integer). </dd>
