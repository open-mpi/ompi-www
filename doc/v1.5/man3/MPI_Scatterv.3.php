<?php
$topdir = "../../..";
$title = "MPI_Scatterv(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_SCATTERV(3)";
...
MPI_Scatterv is the inverse operation to <a href="../man3/MPI_Gatherv.3.php">MPI_Gatherv</a>.  <p>
MPI_Scatterv
extends the functionality of <a href="../man3/MPI_Scatter.3.php">MPI_Scatter</a> by allowing a varying count of
data to be sent to each process, since <i>sendcounts</i> is now an array. It also
allows more flexibility as to where the data is taken from on the root,
by providing the new argument, <i>displs</i>. <p>
The outcome is as if the root executed
<i>n</i> send operations, <p>
<br>
