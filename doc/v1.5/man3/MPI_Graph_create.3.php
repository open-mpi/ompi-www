<?php
$topdir = "../../..";
$title = "MPI_Graph_create(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_GRAPH_CREATE(3)";
...
<b>MPI_Graph_create </b> - Makes a new communicator to which topology information
has been attached.
<p>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int *edges, int reorder, MPI_Comm *comm_graph)
</pre>
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;const int edges[], bool reorder) const
</pre>
...
<p>
In Fortran, <i>index(1)</i> is the degree of node zero, and index(i+1) - index(i)
is the degree of node i, i=1, . . . , nnodes-1;  the list of neighbors of node
