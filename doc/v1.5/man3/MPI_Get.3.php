<?php
$topdir = "../../..";
$title = "MPI_Get(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_GET(3)";
...
MPI_Get copies data from the target memory to the origin, similar
to <a href="../man3/MPI_Put.3.php">MPI_Put</a>, except that the direction of data transfer is reversed. The
<i>origin_datatype</i> may not specify overlapping entries in the origin buffer.
The target buffer must be contained within the target window, and the copied
data must fit, without truncation, in the origin buffer. Only processes
within the same node can access the target window. <p>
