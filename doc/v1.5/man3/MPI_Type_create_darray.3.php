<?php
$topdir = "../../..";
$title = "MPI_Type_create_darray(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_TYPE_CREATE_DARRAY(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int array_of_gsizes[], int array_of_distribs[],
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int array_of_dargs[], int array_of_psizes[],
