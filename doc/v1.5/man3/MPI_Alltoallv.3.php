<?php
$topdir = "../../..";
$title = "MPI_Alltoallv(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_ALLTOALLV(3)";
...
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int *sdispls, MPI_Datatype sendtype,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;void *recvbuf, int *recvcounts,
<tt> </tt>&nbsp;<tt> </tt>&nbsp;int *rdispls, MPI_Datatype recvtype, MPI_Comm comm)
</pre>
...
The specification of counts and displacements
...
and <i>rdispls</i> are measured in units of <i>sendtype</i> and <i>recvtype</i>, respectively.
Compare this to <a href="../man3/MPI_Alltoallw.3.php">MPI_Alltoallw</a>, where these offsets are measured in bytes.
