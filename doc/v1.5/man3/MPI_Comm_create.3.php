<?php
$topdir = "../../..";
$title = "MPI_Comm_create(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_COMM_CREATE(3)";
...
MPI_COMM_NULL for processes that are not in the group.   The call is erroneous
if not all group arguments have the same value, or if group is not a subset
of the group associated with comm. Note that the call must be executed by
all processes in comm, even if they do not belong to the new group.  <p>
<p>
...
by MPI_Comm_create, can be used in subsequent calls to MPI_Comm_create
