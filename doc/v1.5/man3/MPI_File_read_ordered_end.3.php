<?php
$topdir = "../../..";
$title = "MPI_File_read_ordered_end(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_FILE_READ_ORDERED_END(3)";
...
<b>MPI_File_read_ordered_end</b> - Reads a file at a location specified by
...
all processes in the communicator group associated with the file handle
 <i>fh.</i>  MPI_File_rad_ordered_end blocks until the operation initiated by <a href="../man3/MPI_File_read_ordered_begin.3.php">MPI_File_read_ordered_begin</a>
completes. It attempts to read the file associated with  <i>fh</i> into the user&rsquo;s
buffer  <i>buf.</i> The shared file pointer is updated by the amounts of data requested
