<?php
$topdir = "../../..";
$title = "MPI_Win_post(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_WIN_POST(3)";
...
<b>MPI_Win_post</b> - Starts an RMA exposure epoch for the local window associated
