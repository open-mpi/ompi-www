<?php
$topdir = "../../..";
$title = "MPI_File_read_at_all_end(3) man page (version 1.5.5)";
$meta_desc = "Open MPI v1.5.5 man page: MPI_FILE_READ_AT_ALL_END(3)";
...
<b>MPI_File_read_at_all_end</b> - Reads a file at explicitly specified offsets;
...
MPI_File_read_at_all_end is a
split collective routine that stores the number of elements actually read
from the file associated with  <i>fh</i> in  <i>status.</i> MPI_File_read_at_all_end blocks
until the operation initiated by <a href="../man3/MPI_File_read_at_all_begin.3.php">MPI_File_read_at_all_begin</a> completes. The
data is taken out of those parts of the file specified by the current view.
All other fields of  <i>status</i> are undefined.
<p>
