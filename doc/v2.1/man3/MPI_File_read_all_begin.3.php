<?php
$topdir = "../../..";
$title = "MPI_File_read_all_begin(3) man page (version 2.1.6)";
$meta_desc = "Open MPI v2.1.6 man page: MPI_FILE_READ_ALL_BEGIN(3)";
...
<b>MPI_File_read_all_begin</b> - Reads a file starting at the locations
specified by individual file pointers; beginning part of a split collective
routine (nonblocking).
<p>
<h2><a name='sect1' href='#toc1'>Syntax</a></h2>
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_read_all_begin(MPI_File fh, void *buf,
...
read from the file associated with <i>fh</i> (at the current individual file pointer
position maintained by the system) a total number of <i>count</i> data items having
<i>datatype</i> type into the user&rsquo;s buffer <i>buf.</i> The data is taken out of those
