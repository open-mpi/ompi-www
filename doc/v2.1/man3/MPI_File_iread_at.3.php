<?php
$topdir = "../../..";
$title = "MPI_File_iread_at(3) man page (version 2.1.4)";
$meta_desc = "Open MPI v2.1.4 man page: MPI_FILE_IREAD_AT(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_iread_at(MPI_File fh, MPI_Offset offset,
