<?php
$topdir = "../../..";
$title = "MPI_File_get_amode(3) man page (version 2.1.3)";
$meta_desc = "Open MPI v2.1.3 man page: MPI_FILE_GET_AMODE(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_get_amode(MPI_File fh, int *amode)
</pre>
