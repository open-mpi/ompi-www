<?php
$topdir = "../../..";
$title = "MPI_File_read_shared(3) man page (version 2.1.3)";
$meta_desc = "Open MPI v2.1.3 man page: MPI_FILE_READ_SHARED(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_read_shared(MPI_File fh, void *buf,
int count, <tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Datatype datatype, MPI_Status *status)
  </pre>
