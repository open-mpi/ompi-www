<?php
$topdir = "../../..";
$title = "MPI_File_write_all_begin(3) man page (version 2.1.1)";
$meta_desc = "Open MPI v2.1.1 man page: MPI_FILE_WRITE_ALL_BEGIN(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write_all_begin(MPI_File fh, const void
