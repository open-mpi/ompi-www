<?php
$topdir = "../../..";
$title = "MPI_File_read_at_all_end(3) man page (version 2.1.3)";
$meta_desc = "Open MPI v2.1.3 man page: MPI_FILE_READ_AT_ALL_END(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_read_at_all_end(MPI_File fh, void *buf,
...
associated with <i>fh</i> in <i>status.</i> MPI_File_read_at_all_end blocks until the
operation initiated by <a href="../man3/MPI_File_read_at_all_begin.3.php">MPI_File_read_at_all_begin</a> completes. The data is
