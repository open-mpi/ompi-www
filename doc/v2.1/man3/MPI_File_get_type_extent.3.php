<?php
$topdir = "../../..";
$title = "MPI_File_get_type_extent(3) man page (version 2.1.3)";
$meta_desc = "Open MPI v2.1.3 man page: MPI_FILE_GET_TYPE_EXTENT(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_get_type_extent(MPI_File fh, MPI_Datatype
