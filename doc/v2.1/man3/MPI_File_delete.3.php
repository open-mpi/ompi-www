<?php
$topdir = "../../..";
$title = "MPI_File_delete(3) man page (version 2.1.3)";
$meta_desc = "Open MPI v2.1.3 man page: MPI_FILE_DELETE(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_delete(const char *filename, MPI_Info
info)  </pre>
