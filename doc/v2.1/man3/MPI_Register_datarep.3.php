<?php
$topdir = "../../..";
$title = "MPI_Register_datarep(3) man page (version 2.1.1)";
$meta_desc = "Open MPI v2.1.1 man page: MPI_REGISTER_DATAREP(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_Register_datarep(const char *datarep, <tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Datarep_conversion_function
*read_conversion_fn,
