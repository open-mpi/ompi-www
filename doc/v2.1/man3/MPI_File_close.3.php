<?php
$topdir = "../../..";
$title = "MPI_File_close(3) man page (version 2.1.5)";
$meta_desc = "Open MPI v2.1.5 man page: MPI_FILE_CLOSE(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_close(MPI_File *fh)  </pre>
...
file state, then closes the file associated with <i>fh.</i> MPI_File_close is a
