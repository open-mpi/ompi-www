<?php
$topdir = "../../..";
$title = "MPI_File_iread_all(3) man page (version 2.1.6)";
$meta_desc = "Open MPI v2.1.6 man page: MPI_FILE_IREAD_ALL(3)";
...
<b>MPI_File_iread_all</b> - Reads a file starting at the location specified
by the individual file pointer (nonblocking, collective).
<p>
<h2><a name='sect1' href='#toc1'>Syntax</a></h2>
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_iread_all(MPI_File fh, void  *buf, int
 count, <tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Datatype  datatype, MPI_Request  *request)
  </pre>
...
<dt>count </dt>
<dd>Number
of elements in the buffer (integer). </dd>
...
MPI_File_iread_all
is a nonblocking version of <a href="../man3/MPI_File_read_all.3.php">MPI_File_read_all</a>. It attempts to read from
the file associated with <i>fh</i> at the current individual file pointer position
maintained by the system in which a total number of <i>count</i> data items having
<i>datatype</i> type  are read into the user&rsquo;s buffer <i>buf.</i> The data is taken out
of those parts of the file specified by the current view. MPI_File_iread_all
stores the number of data-type elements actually read in <i>status.</i> All other
