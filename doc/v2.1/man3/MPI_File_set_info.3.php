<?php
$topdir = "../../..";
$title = "MPI_File_set_info(3) man page (version 2.1.1)";
$meta_desc = "Open MPI v2.1.1 man page: MPI_FILE_SET_INFO(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_set_info(MPI_File fh, MPI_Info info)
 </pre>
