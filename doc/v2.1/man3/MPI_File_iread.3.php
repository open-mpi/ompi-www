<?php
$topdir = "../../..";
$title = "MPI_File_iread(3) man page (version 2.1.1)";
$meta_desc = "Open MPI v2.1.1 man page: MPI_FILE_IREAD(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_iread(MPI_File fh, void  *buf, int
...
MPI_File_iread
is a nonblocking version of <a href="../man3/MPI_File_read.3.php">MPI_File_read</a>. It attempts to read from the
file associated with <i>fh</i> at the current individual file pointer position
...
of those parts of the file specified by the current view. MPI_File_iread
