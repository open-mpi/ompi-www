<?php
$topdir = "../../..";
$title = "MPI_File_write(3) man page (version 2.1.4)";
$meta_desc = "Open MPI v2.1.4 man page: MPI_FILE_WRITE(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write(MPI_File fh, const void *buf,
...
data items having <i>datatype</i> type from the user&rsquo;s buffer <i>buf.</i> The data is written
into those parts of the file specified by the current view. MPI_File_write
