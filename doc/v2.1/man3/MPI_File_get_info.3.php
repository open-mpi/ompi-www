<?php
$topdir = "../../..";
$title = "MPI_File_get_info(3) man page (version 2.1.2)";
$meta_desc = "Open MPI v2.1.2 man page: MPI_FILE_GET_INFO(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_get_info(MPI_File fh, MPI_Info *info_used)
 </pre>
