<?php
$topdir = "../../..";
$title = "MPI_Put(3) man page (version 2.1.6)";
$meta_desc = "Open MPI v2.1.6 man page: MPI_PUT(3)";
...
<b>MPI_Put</b>, <b><a href="../man3/MPI_Rput.3.php">MPI_Rput</a></b> - Copies data from the origin memory to the
target.
<p>
...
<a href="../man3/MPI_Rput.3.php">MPI_Rput</a>(const void *origin_addr, int origin_count, MPI_Datatype
<tt> </tt>&nbsp;<tt> </tt>&nbsp; origin_datatype, int target_rank, MPI_Aint target_disp,
<tt> </tt>&nbsp;<tt> </tt>&nbsp; int target_count, MPI_Datatype target_datatype, MPI_Win win,
...
<a href="../man3/MPI_Rput.3.php">MPI_RPUT</a>(ORIGIN_ADDR, ORIGIN_COUNT, ORIGIN_DATATYPE, TARGET_RANK,
...
<dt>request </dt>
<dd><a href="../man3/MPI_Rput.3.php">MPI_Rput</a>: RMA request </dd>
...
<b>MPI_Put</b> transfers <i>origin_count</i> successive
...
<b><a href="../man3/MPI_Rput.3.php">MPI_Rput</a></b> is similar to <b>MPI_Put</b>, except that it allocates
a communication request object and associates it with the request handle
(the argument <i>request</i>). The completion of an <a href="../man3/MPI_Rput.3.php">MPI_Rput</a> operation (i.e., after
