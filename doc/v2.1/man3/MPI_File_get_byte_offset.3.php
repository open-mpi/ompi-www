<?php
$topdir = "../../..";
$title = "MPI_File_get_byte_offset(3) man page (version 2.1.6)";
$meta_desc = "Open MPI v2.1.6 man page: MPI_FILE_GET_BYTE_OFFSET(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_get_byte_offset(MPI_File fh, MPI_Offset
offset, <tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Offset *disp)
  </pre>
