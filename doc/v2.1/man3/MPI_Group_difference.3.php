<?php
$topdir = "../../..";
$title = "MPI_Group_difference(3) man page (version 2.1.4)";
$meta_desc = "Open MPI v2.1.4 man page: MPI_GROUP_DIFFERENCE(3)";
...
The set-like operations are defined as
follows: <br>
...
of second group (group2) that are not in the first group <br>
</dd>
