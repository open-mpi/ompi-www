<?php
$topdir = "../../..";
$title = "MPI_File_iwrite_shared(3) man page (version 2.1.0)";
$meta_desc = "Open MPI v2.1.0 man page: MPI_FILE_IWRITE_SHARED(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_iwrite_shared(MPI_File fh, const void
*buf, int count, MPI_Datatype <tt> </tt>&nbsp;<tt> </tt>&nbsp;datatype, MPI_Request *request)
  </pre>
