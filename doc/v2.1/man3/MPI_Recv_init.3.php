<?php
$topdir = "../../..";
$title = "MPI_Recv_init(3) man page (version 2.1.4)";
$meta_desc = "Open MPI v2.1.4 man page: MPI_RECV_INIT(3)";
...
request is inactive after it is created -- no active communication is attached
to the request. <p>
