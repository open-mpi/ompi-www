<?php
$topdir = "../../..";
$title = "MPI_File_read_ordered_begin(3) man page (version 2.1.3)";
$meta_desc = "Open MPI v2.1.3 man page: MPI_FILE_READ_ORDERED_BEGIN(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_read_ordered_begin(MPI_File fh, void
*buf, <tt> </tt>&nbsp;<tt> </tt>&nbsp;int count, MPI_Datatype datatype)
  </pre>
...
<i>datatype</i> and <i>count</i> arguments. Each process attempts to read, from the file
associated with <i>fh,</i> a total number of <i>count</i> data items having <i>datatype</i>
type into the user&rsquo;s buffer <i>buf.</i> For each process, the location in the file
