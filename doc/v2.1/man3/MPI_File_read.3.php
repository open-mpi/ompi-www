<?php
$topdir = "../../..";
$title = "MPI_File_read(3) man page (version 2.1.3)";
$meta_desc = "Open MPI v2.1.3 man page: MPI_FILE_READ(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_read(MPI_File fh, void *buf, <tt> </tt>&nbsp;<tt> </tt>&nbsp;int count,
