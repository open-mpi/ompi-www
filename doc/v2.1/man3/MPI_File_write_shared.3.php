<?php
$topdir = "../../..";
$title = "MPI_File_write_shared(3) man page (version 2.1.3)";
$meta_desc = "Open MPI v2.1.3 man page: MPI_FILE_WRITE_SHARED(3)";
...
<b>MPI_File_write_shared</b> - Writes a file using the shared file
pointer (blocking, noncollective).
<p>
<h2><a name='sect1' href='#toc1'>Syntax</a></h2>
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write_shared(MPI_File fh, const void
*buf, int count, <tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Datatype datatype, MPI_Status *status)
  </pre>
