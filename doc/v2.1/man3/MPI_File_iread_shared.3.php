<?php
$topdir = "../../..";
$title = "MPI_File_iread_shared(3) man page (version 2.1.4)";
$meta_desc = "Open MPI v2.1.4 man page: MPI_FILE_IREAD_SHARED(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_iread_shared(MPI_File fh, void *buf,
...
is a nonblocking version of the <a href="../man3/MPI_File_read_shared.3.php">MPI_File_read_shared</a> interface. It uses
