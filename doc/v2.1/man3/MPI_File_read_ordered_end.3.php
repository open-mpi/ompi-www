<?php
$topdir = "../../..";
$title = "MPI_File_read_ordered_end(3) man page (version 2.1.0)";
$meta_desc = "Open MPI v2.1.0 man page: MPI_FILE_READ_ORDERED_END(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_read_ordered_end(MPI_File fh, void *buf,
