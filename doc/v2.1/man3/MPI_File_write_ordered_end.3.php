<?php
$topdir = "../../..";
$title = "MPI_File_write_ordered_end(3) man page (version 2.1.6)";
$meta_desc = "Open MPI v2.1.6 man page: MPI_FILE_WRITE_ORDERED_END(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write_ordered_end(MPI_File fh, const
void *buf, <tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Status *status)
  </pre>
