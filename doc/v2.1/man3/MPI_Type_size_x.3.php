<?php
$topdir = "../../..";
$title = "MPI_Type_size_x(3) man page (version 2.1.1)";
$meta_desc = "Open MPI v2.1.1 man page: MPI_TYPE_SIZE_X(3)";
...
<a href="../man3/MPI_Type_size.3.php">MPI_Type_size</a>
...
portable Fortran syntax for the <i>SIZE</i> argument of MPI_Type_size_x only for
