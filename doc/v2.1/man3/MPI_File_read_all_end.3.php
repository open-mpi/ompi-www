<?php
$topdir = "../../..";
$title = "MPI_File_read_all_end(3) man page (version 2.1.6)";
$meta_desc = "Open MPI v2.1.6 man page: MPI_FILE_READ_ALL_END(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_read_all_end(MPI_File fh, void *buf,
