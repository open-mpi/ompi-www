<?php
$topdir = "../../..";
$title = "MPI_File_get_group(3) man page (version 2.1.4)";
$meta_desc = "Open MPI v2.1.4 man page: MPI_FILE_GET_GROUP(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_get_group(MPI_File fh, MPI_Group *group)
 </pre>
