<?php
$topdir = "../../..";
$title = "MPI_File_iwrite_all(3) man page (version 2.1.5)";
$meta_desc = "Open MPI v2.1.5 man page: MPI_FILE_IWRITE_ALL(3)";
...
<b>MPI_File_iwrite_all</b> - Writes a file starting at the location
specified by the individual file pointer (nonblocking, collective).
<p>
<h2><a name='sect1' href='#toc1'>Syntax</a></h2>
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_iwrite_all(MPI_File fh, const void *buf,
int count, <tt> </tt>&nbsp;<tt> </tt>&nbsp;MPI_Datatype datatype, MPI_Request *request)
  </pre>
...
MPI_File_iwrite_all
is a nonblocking version of the <a href="../man3/MPI_File_write_all.3.php">MPI_File_write_all</a> interface. It attempts
to write into the file associated with <i>fh</i> (at the current individual file
pointer position maintained by the system) a total number of <i>count</i> data
items having <i>datatype</i> type from the user&rsquo;s buffer <i>buf.</i> The data is written
