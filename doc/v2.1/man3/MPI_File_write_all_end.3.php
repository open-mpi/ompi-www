<?php
$topdir = "../../..";
$title = "MPI_File_write_all_end(3) man page (version 2.1.5)";
$meta_desc = "Open MPI v2.1.5 man page: MPI_FILE_WRITE_ALL_END(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write_all_end(MPI_File fh, const void
*buf, MPI_Status *status)  </pre>
