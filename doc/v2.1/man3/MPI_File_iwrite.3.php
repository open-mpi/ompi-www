<?php
$topdir = "../../..";
$title = "MPI_File_iwrite(3) man page (version 2.1.5)";
$meta_desc = "Open MPI v2.1.5 man page: MPI_FILE_IWRITE(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_iwrite(MPI_File fh, const void *buf,
...
MPI_File_iwrite
is a nonblocking version of the <a href="../man3/MPI_File_write.3.php">MPI_File_write</a> interface. It attempts to
write into the file associated with <i>fh</i> (at the current individual file
...
into those parts of the file specified by the current view. MPI_File_iwrite
