<?php
$topdir = "../../..";
$title = "MPI_File_write_all(3) man page (version 2.1.2)";
$meta_desc = "Open MPI v2.1.2 man page: MPI_FILE_WRITE_ALL(3)";
...
<br>
<pre>C Syntax#include &lt;mpi.h&gt; int MPI_File_write_all(MPI_File fh, const void *buf,
