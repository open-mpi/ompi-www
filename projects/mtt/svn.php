<?php
$topdir = "../..";
$title = "MPI Testing Tool (MTT): Subversion Checkout";
...
<li><strong>Trunk:</strong> The trunk is generally the head of MTT
development.  It is located in the directory <code>/trunk</code> in
the repository.</li>

<li><strong>Branches:</strong> Major stable releases are always
branched.  For example, the 3.0 series of the MTT will be available
under the <code>/branches/v3.0/</code> directory; the 3.1 series is
available under </code>/branches/v3.1/</code>, etc.  Hence, the head of
...
<code>/tags</code> directory.  For example, version 3.0.0 is available
under </code>/tags/v3.0.0/</code>, version 3.0.1 is available under
</code>/tags/v3.0.1/</code>, version 3.3.4 is available under
<code>/tags/v3.3.4</code>, etc.
...
<p>The base URL of the MTT Subversion repository is: <?php
print("<a href=\"http://svn.open-mpi.org/svn/mtt/\">");
?>http://svn.open-mpi.org/svn/mtt/</a>.  Use it to obtain a checkout
of any portion of the repository.  For example, to obtain a checkout
of the trunk:</p>

<?php print_code("shell$ svn co http://svn.open-mpi.org/svn/mtt/trunk mtt-trunk
[...lots of output...]"); ?>

<p>The "list" Subversion command can be used to show which branches and
tags are available:</p>

<?php print_code("shell$ svn list http://svn.open-mpi.org/svn/mtt/tags
...
<?php print_code("shell$ svn co https://svn.open-mpi.org/svn/mtt/trunk mtt-trunk
[...lots of output...]"); ?>
...
<?php print_code("Authentication realm: <https://svn.open-mpi.org:443> MTT Subversion Access
...
<?php print_code("Authentication realm: <https://svn.open-mpi.org:443> MTT Subversion Access
Password for 'your_username':
Authentication realm: <https://svn.open-mpi.org:443> MTT Subversion Access
Username:"); ?>
