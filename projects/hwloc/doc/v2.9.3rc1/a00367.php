...
<p >Besides the hierarchy of objects and individual object attributes (see <a class="el" href="a00366.php">Object attributes</a>), hwloc may also expose finer information about the hardware organization.</p>
<p > 
...
<p >The entire API is located in <a class="el" href="a00101_source.php">hwloc/distances.h</a>. See also <a class="el" href="a00185.php">Retrieve distances between objects</a>, as well as <a class="el" href="a00186.php">Helpers for consulting distance matrices</a> and <a class="el" href="a00187.php">Add distances between objects</a>.</p>
<p > 
...
<p >The memory attributes API is located in <a class="el" href="a00104_source.php">hwloc/memattrs.h</a>, see <a class="el" href="a00189.php">Comparing memory node attributes for finding where to allocate on</a> and <a class="el" href="a00190.php">Managing memory attributes</a> for details. See also an example in doc/examples/memory-attributes.c in the source tree.</p>
<p > 
...
<p >If the operating system provides efficiency information (e.g. Windows 10, MacOS X / Darwin and some Linux kernels), it is used to rank hwloc CPU kinds by efficiency. Otherwise, hwloc implements several heuristics based on frequencies and core types (see HWLOC_CPUKINDS_RANKING in <a class="el" href="a00362.php">Environment Variables</a>).</p>
...
<p >See <a class="el" href="a00191.php">Kinds of CPU cores</a> for details. </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<?php
