...
<p >Aside of these generic attribute fields, hwloc annotates many objects with info attributes made of name and value strings. Each object contains a list of such pairs that may be consulted manually (looking at the object <code>infos</code> array field) or using the <a class="el" href="a00166.php#ga415c4e44beada7ea34cd4bad9944b170" title="Search the given name in object infos and return the corresponding value.">hwloc_obj_get_info_by_name()</a>. The user may additionally add new name-value pairs to any object using <a class="el" href="a00166.php#gace7654bb8a9002caae1a4b8a59e7452e" title="Add the given name and value pair to the given object info attributes.">hwloc_obj_add_info()</a> or the <a class="el" href="a00361.php#cli_hwloc_annotate">hwloc-annotate</a> program.</p>
