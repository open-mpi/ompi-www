...
Functions</h2></td></tr>
<tr class="memitem:ga66281a9ba621357b1c7070b4fa19b5b8"><td class="memItemLeft" align="right" valign="top">static int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00202.php#ga66281a9ba621357b1c7070b4fa19b5b8">hwloc_levelzero_get_device_cpuset</a> (<a class="el" href="a00163.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, ze_device_handle_t device, <a class="el" href="a00160.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</td></tr>
<tr class="separator:ga66281a9ba621357b1c7070b4fa19b5b8"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gaf06cb737abcd2dc6db894c8914302d85"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00162.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00202.php#gaf06cb737abcd2dc6db894c8914302d85">hwloc_levelzero_get_device_osdev</a> (<a class="el" href="a00163.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, ze_device_handle_t device)</td></tr>
...
<p >The function only returns the locality of the device. If more information about the device is needed, OS objects should be used instead, see <a class="el" href="a00202.php#gaf06cb737abcd2dc6db894c8914302d85" title="Get the hwloc OS device object corresponding to Level Zero device device.">hwloc_levelzero_get_device_osdev()</a>.</p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00162.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_levelzero_get_device_osdev </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00163.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
