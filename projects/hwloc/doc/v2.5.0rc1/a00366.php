...
<p>Besides the hierarchy of objects and individual object attributes (see <a class="el" href="a00365.php">Object attributes</a>), hwloc may also expose finer information about the hardware organization.</p>
<p> 
...
<dd><p class="startdd">This is matrix of unidirectional XGMI bandwidths between AMD GPUs (in MB/s). It contains 0 when there is no direct XGMI link between objects. Values on the diagonal are artificially set to very high so that local access always appears faster than remote access.</p>
<p class="interdd">GPUs are identified by RSMI OS devices such as "rsmi0". They may be converted into the corresponding OpenCL or PCI devices using <a class="el" href="a00176.php#gab5df3ad1e8565ea0c2cf06412f6f6233" title="Return an object of a different type with same locality.">hwloc_get_obj_with_same_locality()</a> or the hwloc-annotate tool.</p>
<p class="enddd"><a class="el" href="a00184.php#gabcadd041f3072999d68f2d94e38670f7" title="Apply a transformation to a distances structure.">hwloc_distances_transform()</a> or hwloc-annotate may also be used to transform this matrix into something more convenient, for instance by replacing bandwidths with numbers of links between peers.  </p>
</dd>
...
<p>The entire API is located in <a class="el" href="a00101_source.php">hwloc/distances.h</a>. See also <a class="el" href="a00184.php">Retrieve distances between objects</a>, as well as <a class="el" href="a00185.php">Helpers for consulting distance matrices</a> and <a class="el" href="a00186.php">Add distances between objects</a>.</p>
<p> 
...
<p>The memory attributes API is located in <a class="el" href="a00104_source.php">hwloc/memattrs.h</a>, see <a class="el" href="a00188.php">Comparing memory node attributes for finding where to allocate on</a> and <a class="el" href="a00189.php">Managing memory attributes</a> for details.</p>
<p> 
</div><div class="section" id="topoattrs_cpukinds">
 </p>
<h1><a class="anchor" id="topoattrs_cpukinds"></a>
CPU Kinds</h1>
<p>Hybrid CPUs may contain different kinds of cores. The CPU kinds API in <a class="el" href="a00107_source.php">hwloc/cpukinds.h</a> provides a way to list the sets of PUs in each kind and get some optional information about their hardware characteristics and efficiency.</p>
<p>If the operating system provides efficiency information (e.g. Windows 10), it is used to rank hwloc CPU kinds by efficiency. Otherwise, hwloc implements several heuristics based on frequencies and core types (see HWLOC_CPUKINDS_RANKING in <a class="el" href="a00361.php">Environment Variables</a>).</p>
...
<p>See <a class="el" href="a00190.php">Kinds of CPU cores</a> for details. </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<?php
