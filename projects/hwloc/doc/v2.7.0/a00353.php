...
<div class="title">hwloc_backend Struct Reference<div class="ingroups"><a class="el" href="a00207.php">Components and Plugins: Discovery backends</a></div></div>  </div>
</div><!--header-->
<div class="contents">
...
<tr class="memitem:aeca769840a6ff03e96462a9533adbccd"><td class="memItemLeft" align="right" valign="top">unsigned&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00353.php#aeca769840a6ff03e96462a9533adbccd">phases</a></td></tr>
<tr class="separator:aeca769840a6ff03e96462a9533adbccd"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:aaa8eafe495aadd81c2e3c4ec527c10ba"><td class="memItemLeft" align="right" valign="top">unsigned long&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00353.php#aaa8eafe495aadd81c2e3c4ec527c10ba">flags</a></td></tr>
<tr class="separator:aaa8eafe495aadd81c2e3c4ec527c10ba"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ab8806f6db077f1bb2e9d63ec99223f7a"><td class="memItemLeft" align="right" valign="top">int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00353.php#ab8806f6db077f1bb2e9d63ec99223f7a">is_thissystem</a></td></tr>
<tr class="separator:ab8806f6db077f1bb2e9d63ec99223f7a"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a2ea5bd36b7f06efdb65b98b32af16c68"><td class="memItemLeft" align="right" valign="top">void *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00353.php#a2ea5bd36b7f06efdb65b98b32af16c68">private_data</a></td></tr>
<tr class="separator:a2ea5bd36b7f06efdb65b98b32af16c68"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a36c4fa86350525b46340c67b802c69c7"><td class="memItemLeft" align="right" valign="top">void(*&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00353.php#a36c4fa86350525b46340c67b802c69c7">disable</a> )(struct <a class="el" href="a00353.php">hwloc_backend</a> *backend)</td></tr>
<tr class="separator:a36c4fa86350525b46340c67b802c69c7"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:accff2cd8404be43c3b44cec05e6f609b"><td class="memItemLeft" align="right" valign="top">int(*&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00353.php#accff2cd8404be43c3b44cec05e6f609b">discover</a> )(struct <a class="el" href="a00353.php">hwloc_backend</a> *backend, struct <a class="el" href="a00349.php">hwloc_disc_status</a> *status)</td></tr>
<tr class="separator:accff2cd8404be43c3b44cec05e6f609b"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:aaac253491264c20930f44817270bc502"><td class="memItemLeft" align="right" valign="top">int(*&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00353.php#aaac253491264c20930f44817270bc502">get_pci_busid_cpuset</a> )(struct <a class="el" href="a00353.php">hwloc_backend</a> *backend, struct hwloc_pcidev_attr_s *busid, <a class="el" href="a00181.php#gaa3c2bf4c776d603dcebbb61b0c923d84">hwloc_bitmap_t</a> cpuset)</td></tr>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">void(* hwloc_backend::disable) (struct <a class="el" href="a00353.php">hwloc_backend</a> *backend)</td>
        </tr>
      </table>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">int(* hwloc_backend::discover) (struct <a class="el" href="a00353.php">hwloc_backend</a> *backend, struct <a class="el" href="a00349.php">hwloc_disc_status</a> *status)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">int(* hwloc_backend::get_pci_busid_cpuset) (struct <a class="el" href="a00353.php">hwloc_backend</a> *backend, struct hwloc_pcidev_attr_s *busid, <a class="el" href="a00181.php#gaa3c2bf4c776d603dcebbb61b0c923d84">hwloc_bitmap_t</a> cpuset)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<p>Discovery phases performed by this component, possibly without some of them if excluded by other components. OR'ed set of <a class="el" href="a00207.php#ga600bba1a62022d5f516800649b1edb61" title="Discovery phase.">hwloc_disc_phase_t</a>. </p>
