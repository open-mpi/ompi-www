...
</pre><p>If building with the Xeon Phi-specific GCC that comes with the MPSS environment<br />
for instance <code>/usr/linux-k1om-4.7/bin/x86_64-k1om-linux-gcc</code>: </p><pre class="fragment">export PATH=$PATH:/usr/linux-k1om-4.7/bin/
