...
<dd>The vendor and model names, and revision and serial numbers of a Block OS device.  </dd>
<dt>LinuxDeviceID </dt>
...
<dt>Type </dt>
<dd>A better type name than the usual one. This may be used to specify where Groups come from. For instance Linux s390 <em>books</em> appear as Groups of type <em>Book</em>. Block OS devices may have a Type of "Disk", "Tape", "Removable Media Device" or "Other". The Type attribute value is displayed instead of the default object type name in lstopo.  </dd>
<dt>Vendor, AssetTag, PartNumber, DeviceLocation, BankLocation (MemoryDevice Misc objects) </dt>
<dd>Information about memory devices (DIMMs) extracted from SMBIOS.  </dd>
<dt>hwlocVersion </dt>
