...
Functions</h2></td></tr>
<tr class="memitem:gaf939e697e3769c3524255318262b9c29"><td class="memItemLeft" align="right" valign="top">static int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00177.php#gaf939e697e3769c3524255318262b9c29">hwloc_rsmi_get_device_cpuset</a> (<a class="el" href="a00139.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, uint32_t dv_ind, <a class="el" href="a00136.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</td></tr>
<tr class="separator:gaf939e697e3769c3524255318262b9c29"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga507d0acdd5e9ac374a8d120d59604c80"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00138.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00177.php#ga507d0acdd5e9ac374a8d120d59604c80">hwloc_rsmi_get_device_osdev_by_index</a> (<a class="el" href="a00139.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, uint32_t dv_ind)</td></tr>
<tr class="separator:ga507d0acdd5e9ac374a8d120d59604c80"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gaba05bf9710655bb5b1439bee654340ba"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00138.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00177.php#gaba05bf9710655bb5b1439bee654340ba">hwloc_rsmi_get_device_osdev</a> (<a class="el" href="a00139.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, uint32_t dv_ind)</td></tr>
...
<p >The function only returns the locality of the device. If more information about the device is needed, OS objects should be used instead, see <a class="el" href="a00177.php#gaba05bf9710655bb5b1439bee654340ba" title="Get the hwloc OS device object corresponding to AMD GPU device, whose index is dv_ind.">hwloc_rsmi_get_device_osdev()</a> and <a class="el" href="a00177.php#ga507d0acdd5e9ac374a8d120d59604c80" title="Get the hwloc OS device object corresponding to the AMD GPU device whose index is dv_ind.">hwloc_rsmi_get_device_osdev_by_index()</a>.</p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00138.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_rsmi_get_device_osdev </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00139.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00138.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_rsmi_get_device_osdev_by_index </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00139.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
