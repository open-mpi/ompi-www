...
<div class="line"><a id="l00086" name="l00086"></a><span class="lineno"><a class="line" href="a00176.php#ga8517e9e9fbc25561bb82f591b2d4ec4f">   86</a></span><a class="code hl_function" href="a00176.php#ga8517e9e9fbc25561bb82f591b2d4ec4f">hwloc_opencl_get_device_pci_busid</a>(cl_device_id device,</div>
...
<div class="line"><a id="l00156" name="l00156"></a><span class="lineno"><a class="line" href="a00176.php#ga7a440bdd8015737c4970fdcd4349fe7f">  156</a></span><a class="code hl_function" href="a00176.php#ga7a440bdd8015737c4970fdcd4349fe7f">hwloc_opencl_get_device_cpuset</a>(<a class="code hl_typedef" href="a00142.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
...
<div class="line"><a id="l00171" name="l00171"></a><span class="lineno">  171</span>        <span class="keywordflow">if</span> (<a class="code hl_function" href="a00176.php#ga8517e9e9fbc25561bb82f591b2d4ec4f">hwloc_opencl_get_device_pci_busid</a>(device, &amp;pcidomain, &amp;pcibus, &amp;pcidev, &amp;pcifunc) &lt; 0) {</div>
...
<div class="line"><a id="l00203" name="l00203"></a><span class="lineno"><a class="line" href="a00176.php#gae3d1e395ac0208c85860dfafe26c4dfc">  203</a></span><a class="code hl_function" href="a00176.php#gae3d1e395ac0208c85860dfafe26c4dfc">hwloc_opencl_get_device_osdev_by_index</a>(<a class="code hl_typedef" href="a00142.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology,</div>
...
<div class="line"><a id="l00240" name="l00240"></a><span class="lineno"><a class="line" href="a00176.php#gae0c20d8b43763abaff74e500ed4f1162">  240</a></span><a class="code hl_function" href="a00176.php#gae0c20d8b43763abaff74e500ed4f1162">hwloc_opencl_get_device_osdev</a>(<a class="code hl_typedef" href="a00142.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
...
<div class="line"><a id="l00246" name="l00246"></a><span class="lineno">  246</span>        <span class="keywordflow">if</span> (<a class="code hl_function" href="a00176.php#ga8517e9e9fbc25561bb82f591b2d4ec4f">hwloc_opencl_get_device_pci_busid</a>(device, &amp;pcidomain, &amp;pcibus, &amp;pcidevice, &amp;pcifunc) &lt; 0) {</div>
...
<div class="line"><a id="l00252" name="l00252"></a><span class="lineno">  252</span>        <span class="keywordflow">while</span> ((osdev = <a class="code hl_function" href="a00160.php#ga17bba843ffa24978505961f104ee2efb">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
...
<div class="ttc" id="aa00176_php_ga7a440bdd8015737c4970fdcd4349fe7f"><div class="ttname"><a href="a00176.php#ga7a440bdd8015737c4970fdcd4349fe7f">hwloc_opencl_get_device_cpuset</a></div><div class="ttdeci">int hwloc_opencl_get_device_cpuset(hwloc_topology_t topology, cl_device_id device, hwloc_cpuset_t set)</div><div class="ttdoc">Get the CPU set of processors that are physically close to OpenCL device device.</div><div class="ttdef"><b>Definition</b> opencl.h:156</div></div>
<div class="ttc" id="aa00176_php_ga8517e9e9fbc25561bb82f591b2d4ec4f"><div class="ttname"><a href="a00176.php#ga8517e9e9fbc25561bb82f591b2d4ec4f">hwloc_opencl_get_device_pci_busid</a></div><div class="ttdeci">int hwloc_opencl_get_device_pci_busid(cl_device_id device, unsigned *domain, unsigned *bus, unsigned *dev, unsigned *func)</div><div class="ttdoc">Return the domain, bus and device IDs of the OpenCL device device.</div><div class="ttdef"><b>Definition</b> opencl.h:86</div></div>
<div class="ttc" id="aa00176_php_gae0c20d8b43763abaff74e500ed4f1162"><div class="ttname"><a href="a00176.php#gae0c20d8b43763abaff74e500ed4f1162">hwloc_opencl_get_device_osdev</a></div><div class="ttdeci">hwloc_obj_t hwloc_opencl_get_device_osdev(hwloc_topology_t topology, cl_device_id device)</div><div class="ttdoc">Get the hwloc OS device object corresponding to OpenCL device deviceX.</div><div class="ttdef"><b>Definition</b> opencl.h:240</div></div>
<div class="ttc" id="aa00176_php_gae3d1e395ac0208c85860dfafe26c4dfc"><div class="ttname"><a href="a00176.php#gae3d1e395ac0208c85860dfafe26c4dfc">hwloc_opencl_get_device_osdev_by_index</a></div><div class="ttdeci">hwloc_obj_t hwloc_opencl_get_device_osdev_by_index(hwloc_topology_t topology, unsigned platform_index, unsigned device_index)</div><div class="ttdoc">Get the hwloc OS device object corresponding to the OpenCL device for the given indexes.</div><div class="ttdef"><b>Definition</b> opencl.h:203</div></div>
