...
<div class="line"><a name="l00047"></a><span class="lineno"><a class="line" href="a00109.php#gad8b701d9a34923e34bd58defd4c1e704">   47</a></span>&#160;<a class="code" href="a00109.php#gad8b701d9a34923e34bd58defd4c1e704">hwloc_cudart_get_device_pci_ids</a>(<a class="code" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
...
<div class="line"><a name="l00088"></a><span class="lineno"><a class="line" href="a00109.php#ga187ca00c6e12800a25151ce331620980">   88</a></span>&#160;<a class="code" href="a00109.php#ga187ca00c6e12800a25151ce331620980">hwloc_cudart_get_device_cpuset</a>(<a class="code" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
...
<div class="line"><a name="l00098"></a><span class="lineno">   98</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00109.php#gad8b701d9a34923e34bd58defd4c1e704">hwloc_cudart_get_device_pci_ids</a>(topology, idx, &amp;domain, &amp;bus, &amp;dev))</div>
...
<div class="line"><a name="l00111"></a><span class="lineno">  111</span>&#160;  <a class="code" href="a00103.php#gaa5a608236c3c0757b0b79818f1d429fb">hwloc_linux_parse_cpumap_file</a>(sysfile, set);</div>
<div class="line"><a name="l00112"></a><span class="lineno">  112</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00096.php#ga5b64be28f5a7176ed8ad0d6a90bdf108">hwloc_bitmap_iszero</a>(set))</div>
<div class="line"><a name="l00113"></a><span class="lineno">  113</span>&#160;    <a class="code" href="a00096.php#ga036068a22d1aa5cb9ff1df348b525ff3">hwloc_bitmap_copy</a>(set, <a class="code" href="a00092.php#ga69fbad44c685e46d80ecf51a714ba9ce">hwloc_topology_get_complete_cpuset</a>(topology));</div>
...
<div class="line"><a name="l00118"></a><span class="lineno">  118</span>&#160;  <a class="code" href="a00096.php#ga036068a22d1aa5cb9ff1df348b525ff3">hwloc_bitmap_copy</a>(set, <a class="code" href="a00092.php#ga69fbad44c685e46d80ecf51a714ba9ce">hwloc_topology_get_complete_cpuset</a>(topology));</div>
...
<div class="line"><a name="l00134"></a><span class="lineno"><a class="line" href="a00109.php#gaeda4e6efbb36b518b2c286434ad23bb2">  134</a></span>&#160;<a class="code" href="a00109.php#gaeda4e6efbb36b518b2c286434ad23bb2">hwloc_cudart_get_device_pcidev</a>(<a class="code" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <span class="keywordtype">int</span> idx)</div>
...
<div class="line"><a name="l00138"></a><span class="lineno">  138</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00109.php#gad8b701d9a34923e34bd58defd4c1e704">hwloc_cudart_get_device_pci_ids</a>(topology, idx, &amp;domain, &amp;bus, &amp;dev))</div>
<div class="line"><a name="l00139"></a><span class="lineno">  139</span>&#160;    <span class="keywordflow">return</span> NULL;</div>
<div class="line"><a name="l00140"></a><span class="lineno">  140</span>&#160;</div>
<div class="line"><a name="l00141"></a><span class="lineno">  141</span>&#160;  <span class="keywordflow">return</span> <a class="code" href="a00095.php#gacdbaf0db98872e224b7883a84bfb0455">hwloc_get_pcidev_by_busid</a>(topology, domain, bus, dev, 0);</div>
...
<div class="line"><a name="l00162"></a><span class="lineno"><a class="line" href="a00109.php#gac0f3eeaf7712919f298097b1a21307b0">  162</a></span>&#160;<a class="code" href="a00109.php#gac0f3eeaf7712919f298097b1a21307b0">hwloc_cudart_get_device_osdev_by_index</a>(<a class="code" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <span class="keywordtype">unsigned</span> idx)</div>
...
<div class="line"><a name="l00165"></a><span class="lineno">  165</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00095.php#ga8b4584c8949e2c5f1c97ba7fe92b8145">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
