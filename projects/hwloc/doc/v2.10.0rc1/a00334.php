...
<li>
the NVIDIA CUDA Toolkit for CUDA device discovery. See <a class="el" href="a00350.php#faq_cuda_build">How do I enable CUDA and select which CUDA version to use?</a>.  </li>
<li>
...
<li>
the AMD ROCm SMI library for RSMI device discovery. The relevant development package is usually <code>rocm-smi-lib64</code> or <code>librocm-smi-dev</code>. See <a class="el" href="a00350.php#faq_rocm_build">How do I enable ROCm SMI and select which version to use?</a>.  </li>
<li>
...
<p >PCI and XML support may be statically built inside the main hwloc library, or as separate dynamically-loaded plugins (see the <a class="el" href="a00348.php">Components and plugins</a> section).</p>
