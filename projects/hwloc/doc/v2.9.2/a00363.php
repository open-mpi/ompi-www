...
<p >See <a class="el" href="a00167.php">CPU binding</a> and <a class="el" href="a00168.php">Memory binding</a> for hwloc's API functions regarding CPU and memory binding, respectively. There are some examples under doc/examples/ in the source tree. </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<?php
