...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Search the given key name in object infos and return the corresponding value.  <a href="#ga1f41387433f4c9e9c14b9f2e522919e4"></a><br/></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"> void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="group__hwlocality__conversion.php#gaba3afe636940872772ed6dfaf0b3552e">hwloc_obj_add_info</a> (<a class="el" href="structhwloc__obj.php">hwloc_obj_t</a> obj, const char *name, const char *value)</td></tr>
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Add the given info name and value pair to the given object.  <a href="#gaba3afe636940872772ed6dfaf0b3552e"></a><br/></td></tr>
</table>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">static inline char*  hwloc_obj_get_info_by_name </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="structhwloc__obj.php">hwloc_obj_t</a>&#160;</td>
          <td class="paramname"><em>obj</em>, </td>
        </tr>
