...
<a class="el" href="group__hwlocality__tinker.php#gga9d80f08eb25b7ac22f1b998dc8bf521faa95d6985e36ec1e55f68b210297a85cb">HWLOC_RESTRICT_FLAG_ADAPT_IO</a>
 }</td></tr>
...
Functions</h2></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"> int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="group__hwlocality__tinker.php#ga45578d725c66865cfef31d0585dcff70">hwloc_topology_export_xml</a> (<a class="el" href="group__hwlocality__topology.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, const char *xmlpath)</td></tr>
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Export the topology into an XML file.  <a href="#ga45578d725c66865cfef31d0585dcff70"></a><br/></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"> int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="group__hwlocality__tinker.php#ga739330e9402425315e44e5012631fb91">hwloc_topology_export_xmlbuffer</a> (<a class="el" href="group__hwlocality__topology.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, char **xmlbuffer, int *buflen)</td></tr>
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Export the topology into a newly-allocated XML memory buffer.  <a href="#ga739330e9402425315e44e5012631fb91"></a><br/></td></tr>
<tr><td class="memItemLeft" align="right" valign="top"> void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="group__hwlocality__tinker.php#ga5e375acef034bebc1f20ead884697301">hwloc_free_xmlbuffer</a> (<a class="el" href="group__hwlocality__topology.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, char *xmlbuffer)</td></tr>
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Free a buffer allocated by <a class="el" href="group__hwlocality__tinker.php#ga739330e9402425315e44e5012631fb91" title="Export the topology into a newly-allocated XML memory buffer.">hwloc_topology_export_xmlbuffer()</a>  <a href="#ga5e375acef034bebc1f20ead884697301"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Add a MISC object as a leaf of the topology.  <a href="#gadacd7a3d21220fbb30c3256d8b22a294"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Restrict the topology to the given CPU set.  <a href="#gad75fa918e3eb54663bdeab25ed89b648"></a><br/></td></tr>
</table>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">enum <a class="el" href="group__hwlocality__tinker.php#ga9d80f08eb25b7ac22f1b998dc8bf521f">hwloc_restrict_flags_e</a></td>
        </tr>
      </table>
</div>
<div class="memdoc">

<p>Flags to be given to <a class="el" href="group__hwlocality__tinker.php#gad75fa918e3eb54663bdeab25ed89b648" title="Restrict the topology to the given CPU set.">hwloc_topology_restrict()</a>. </p>
...
<p>Free a buffer allocated by <a class="el" href="group__hwlocality__tinker.php#ga739330e9402425315e44e5012631fb91" title="Export the topology into a newly-allocated XML memory buffer.">hwloc_topology_export_xmlbuffer()</a> </p>
...
<p><code>xmlbuffer</code> is allocated by the callee and should be freed with <a class="el" href="group__hwlocality__tinker.php#ga5e375acef034bebc1f20ead884697301" title="Free a buffer allocated by hwloc_topology_export_xmlbuffer()">hwloc_free_xmlbuffer()</a> later in the caller.</p>
<p>This memory buffer may be loaded later through <a class="el" href="group__hwlocality__configuration.php#gae7e4bade144652a2b48f5eaf0309b4ec" title="Enable XML based topology using a memory buffer (instead of a file, as with hwloc_topology_set_xml())...">hwloc_topology_set_xmlbuffer()</a>.</p>
<dl class="return"><dt><b>Returns:</b></dt><dd>-1 if a failure occured. </dd></dl>
...
<p><code>flags</code> is a OR'ed set of <a class="el" href="group__hwlocality__tinker.php#ga9d80f08eb25b7ac22f1b998dc8bf521f" title="Flags to be given to hwloc_topology_restrict().">hwloc_restrict_flags_e</a>.</p>
<dl class="note"><dt><b>Note:</b></dt><dd>This call may not be reverted by restricting back to a larger cpuset. Once dropped during restriction, objects may not be brought back, except by reloading the entire topology with <a class="el" href="group__hwlocality__creation.php#ga91e2e6427b95fb7339c99dbbef996e71" title="Build the actual topology.">hwloc_topology_load()</a>. </dd></dl>
