...
<div class="line"><a name="l00062"></a><span class="lineno"><a class="line" href="a00112.php#gaa8ea979ce3a9b8c70ae80bc5716a0fbe">   62</a></span>&#160;<a class="code" href="a00112.php#gaa8ea979ce3a9b8c70ae80bc5716a0fbe">hwloc_ibv_get_device_cpuset</a>(<a class="code" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
<div class="line"><a name="l00063"></a><span class="lineno">   63</span>&#160;                            <span class="keyword">struct</span> ibv_device *ibdev, <a class="code" href="a00074.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</div>
...
<div class="line"><a name="l00072"></a><span class="lineno">   72</span>&#160;  <span class="keywordflow">if</span> (!<a class="code" href="a00078.php#ga0d109e33fc7990f62f665d336e5e5111">hwloc_topology_is_thissystem</a>(topology)) {</div>
...
<div class="line"><a name="l00109"></a><span class="lineno">  109</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00037.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00110"></a><span class="lineno"><a class="line" href="a00112.php#gaa6139e8ce1279bd91867b31b9ff4316b">  110</a></span>&#160;<a class="code" href="a00112.php#gaa6139e8ce1279bd91867b31b9ff4316b">hwloc_ibv_get_device_osdev_by_name</a>(<a class="code" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology,</div>
...
<div class="line"><a name="l00113"></a><span class="lineno">  113</span>&#160;        <a class="code" href="a00037.php">hwloc_obj_t</a> osdev = NULL;</div>
<div class="line"><a name="l00114"></a><span class="lineno">  114</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00095.php#ga73a5bc6265642e6001f7a10812ab886d">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
<div class="line"><a name="l00115"></a><span class="lineno">  115</span>&#160;                <span class="keywordflow">if</span> (<a class="code" href="a00075.php#gga64f5d539df299c97ae80ce53fc4b56c0a52157d03694fdae82dddd57ca8c973b6">HWLOC_OBJ_OSDEV_OPENFABRICS</a> == osdev-&gt;<a class="code" href="a00037.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00038.php#a22904c25fe44b323bab5c9bc52660fca">osdev</a>.<a class="code" href="a00042.php#a31e019e27e54ac6138d04be639bb96f9">type</a></div>
<div class="line"><a name="l00116"></a><span class="lineno">  116</span>&#160;                    &amp;&amp; osdev-&gt;<a class="code" href="a00037.php#abb709ec38f2970677e4e57d1d30be96d">name</a> &amp;&amp; !strcmp(ibname, osdev-&gt;<a class="code" href="a00037.php#abb709ec38f2970677e4e57d1d30be96d">name</a>))</div>
...
<div class="line"><a name="l00136"></a><span class="lineno">  136</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00037.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00137"></a><span class="lineno"><a class="line" href="a00112.php#ga0b59abbefc3298bb634f1cde2571f338">  137</a></span>&#160;<a class="code" href="a00112.php#ga0b59abbefc3298bb634f1cde2571f338">hwloc_ibv_get_device_osdev</a>(<a class="code" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology,</div>
...
<div class="line"><a name="l00140"></a><span class="lineno">  140</span>&#160;        <span class="keywordflow">if</span> (!<a class="code" href="a00078.php#ga0d109e33fc7990f62f665d336e5e5111">hwloc_topology_is_thissystem</a>(topology)) {</div>
...
<div class="line"><a name="l00144"></a><span class="lineno">  144</span>&#160;        <span class="keywordflow">return</span> <a class="code" href="a00112.php#gaa6139e8ce1279bd91867b31b9ff4316b">hwloc_ibv_get_device_osdev_by_name</a>(topology, ibv_get_device_name(ibdev));</div>
...
<div class="ttc" id="a00075_php_gga64f5d539df299c97ae80ce53fc4b56c0a52157d03694fdae82dddd57ca8c973b6"><div class="ttname"><a href="a00075.php#gga64f5d539df299c97ae80ce53fc4b56c0a52157d03694fdae82dddd57ca8c973b6">HWLOC_OBJ_OSDEV_OPENFABRICS</a></div><div class="ttdoc">Operating system openfabrics device. For instance the &amp;quot;mlx4_0&amp;quot; InfiniBand HCA device on Linux...</div><div class="ttdef"><b>Definition:</b> hwloc.h:266</div></div>
