...
Functions</h2></td></tr>
<tr class="memitem:ga4ee13f105f3d2a359de8ee74b6929863"><td class="memItemLeft" align="right" valign="top">static __hwloc_inline int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00109.php#ga4ee13f105f3d2a359de8ee74b6929863">hwloc_nvml_get_device_cpuset</a> (<a class="el" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused, nvmlDevice_t device, <a class="el" href="a00074.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</td></tr>
<tr class="separator:ga4ee13f105f3d2a359de8ee74b6929863"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga2b5e13914ff9462ed799b3022bc746fc"><td class="memItemLeft" align="right" valign="top">static __hwloc_inline <a class="el" href="a00076.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00109.php#ga2b5e13914ff9462ed799b3022bc746fc">hwloc_nvml_get_device_osdev_by_index</a> (<a class="el" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, unsigned idx)</td></tr>
<tr class="separator:ga2b5e13914ff9462ed799b3022bc746fc"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gadd25999bc0c482c85f6afddd7897b1c1"><td class="memItemLeft" align="right" valign="top">static __hwloc_inline <a class="el" href="a00076.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00109.php#gadd25999bc0c482c85f6afddd7897b1c1">hwloc_nvml_get_device_osdev</a> (<a class="el" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, nvmlDevice_t device)</td></tr>
...
<p>The function only returns the locality of the device. If more information about the device is needed, OS objects should be used instead, see <a class="el" href="a00109.php#gadd25999bc0c482c85f6afddd7897b1c1" title="Get the hwloc OS device object corresponding to NVML device device. ">hwloc_nvml_get_device_osdev()</a> and <a class="el" href="a00109.php#ga2b5e13914ff9462ed799b3022bc746fc" title="Get the hwloc OS device object corresponding to the NVML device whose index is idx. ">hwloc_nvml_get_device_osdev_by_index()</a>.</p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static __hwloc_inline <a class="el" href="a00076.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_nvml_get_device_osdev </td>
          <td>(</td>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static __hwloc_inline <a class="el" href="a00076.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_nvml_get_device_osdev_by_index </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
