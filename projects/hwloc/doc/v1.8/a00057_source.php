...
<div class="line"><a name="l00047"></a><span class="lineno"><a class="line" href="a00107.php#gae45c92fbc7ac538cf69fdfcc73994ed9">   47</a></span>&#160;<a class="code" href="a00107.php#gae45c92fbc7ac538cf69fdfcc73994ed9">hwloc_cuda_get_device_pci_ids</a>(<a class="code" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
...
<div class="line"><a name="l00053"></a><span class="lineno">   53</span>&#160;<span class="preprocessor"></span>  cres = cuDeviceGetAttribute(domain, CU_DEVICE_ATTRIBUTE_PCI_DOMAIN_ID, cudevice);</div>
...
<div class="line"><a name="l00059"></a><span class="lineno">   59</span>&#160;<span class="preprocessor"></span>  *domain = 0;</div>
<div class="line"><a name="l00060"></a><span class="lineno">   60</span>&#160;<span class="preprocessor">#endif</span></div>
<div class="line"><a name="l00061"></a><span class="lineno">   61</span>&#160;<span class="preprocessor"></span>  cres = cuDeviceGetAttribute(bus, CU_DEVICE_ATTRIBUTE_PCI_BUS_ID, cudevice);</div>
...
<div class="line"><a name="l00092"></a><span class="lineno"><a class="line" href="a00107.php#gae06cf330d2f0d9949feb52b146b7d136">   92</a></span>&#160;<a class="code" href="a00107.php#gae06cf330d2f0d9949feb52b146b7d136">hwloc_cuda_get_device_cpuset</a>(<a class="code" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
<div class="line"><a name="l00093"></a><span class="lineno">   93</span>&#160;                             CUdevice cudevice, <a class="code" href="a00074.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</div>
...
<div class="line"><a name="l00096"></a><span class="lineno">   96</span>&#160;<span class="preprocessor"></span>  <span class="comment">/* If we&#39;re on Linux, use the sysfs mechanism to get the local cpus */</span></div>
...
<div class="line"><a name="l00098"></a><span class="lineno">   98</span>&#160;<span class="preprocessor"></span>  <span class="keywordtype">char</span> path[HWLOC_CUDA_DEVICE_SYSFS_PATH_MAX];</div>
...
<div class="line"><a name="l00102"></a><span class="lineno">  102</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00107.php#gae45c92fbc7ac538cf69fdfcc73994ed9">hwloc_cuda_get_device_pci_ids</a>(topology, cudevice, &amp;domainid, &amp;busid, &amp;deviceid))</div>
<div class="line"><a name="l00103"></a><span class="lineno">  103</span>&#160;    <span class="keywordflow">return</span> -1;</div>
<div class="line"><a name="l00104"></a><span class="lineno">  104</span>&#160;</div>
<div class="line"><a name="l00105"></a><span class="lineno">  105</span>&#160;  <span class="keywordflow">if</span> (!<a class="code" href="a00078.php#ga0d109e33fc7990f62f665d336e5e5111">hwloc_topology_is_thissystem</a>(topology)) {</div>
...
<div class="line"><a name="l00115"></a><span class="lineno">  115</span>&#160;  <a class="code" href="a00102.php#gaeacad897c30dbea284948374ad4b010c">hwloc_linux_parse_cpumap_file</a>(sysfile, set);</div>
<div class="line"><a name="l00116"></a><span class="lineno">  116</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00096.php#gaa94fed35d2a598bc4a8657b6955b7bf5">hwloc_bitmap_iszero</a>(set))</div>
<div class="line"><a name="l00117"></a><span class="lineno">  117</span>&#160;    <a class="code" href="a00096.php#gab14743355fa03b36cef521cbcd2fbf64">hwloc_bitmap_copy</a>(set, <a class="code" href="a00092.php#ga418ebb39eaf1eac8f9cf4047cf59a534">hwloc_topology_get_complete_cpuset</a>(topology));</div>
...
<div class="line"><a name="l00121"></a><span class="lineno">  121</span>&#160;<span class="preprocessor"></span>  <span class="comment">/* Non-Linux systems simply get a full cpuset */</span></div>
<div class="line"><a name="l00122"></a><span class="lineno">  122</span>&#160;  <a class="code" href="a00096.php#gab14743355fa03b36cef521cbcd2fbf64">hwloc_bitmap_copy</a>(set, <a class="code" href="a00092.php#ga418ebb39eaf1eac8f9cf4047cf59a534">hwloc_topology_get_complete_cpuset</a>(topology));</div>
<div class="line"><a name="l00123"></a><span class="lineno">  123</span>&#160;<span class="preprocessor">#endif</span></div>
<div class="line"><a name="l00124"></a><span class="lineno">  124</span>&#160;<span class="preprocessor"></span>  <span class="keywordflow">return</span> 0;</div>
<div class="line"><a name="l00125"></a><span class="lineno">  125</span>&#160;}</div>
<div class="line"><a name="l00126"></a><span class="lineno">  126</span>&#160;</div>
<div class="line"><a name="l00137"></a><span class="lineno">  137</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00037.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00138"></a><span class="lineno"><a class="line" href="a00107.php#ga04d1f8bd566a7f0b30d5e498f9228042">  138</a></span>&#160;<a class="code" href="a00107.php#ga04d1f8bd566a7f0b30d5e498f9228042">hwloc_cuda_get_device_pcidev</a>(<a class="code" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, CUdevice cudevice)</div>
...
<div class="line"><a name="l00142"></a><span class="lineno">  142</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00107.php#gae45c92fbc7ac538cf69fdfcc73994ed9">hwloc_cuda_get_device_pci_ids</a>(topology, cudevice, &amp;domain, &amp;bus, &amp;dev))</div>
<div class="line"><a name="l00143"></a><span class="lineno">  143</span>&#160;    <span class="keywordflow">return</span> NULL;</div>
<div class="line"><a name="l00144"></a><span class="lineno">  144</span>&#160;</div>
<div class="line"><a name="l00145"></a><span class="lineno">  145</span>&#160;  <span class="keywordflow">return</span> <a class="code" href="a00095.php#ga546e1d690c63fb24177f3013ed78ceb1">hwloc_get_pcidev_by_busid</a>(topology, domain, bus, dev, 0);</div>
...
<div class="line"><a name="l00162"></a><span class="lineno"><a class="line" href="a00107.php#ga849dad87840346e77d135ecef1593416">  162</a></span>&#160;<a class="code" href="a00107.php#ga849dad87840346e77d135ecef1593416">hwloc_cuda_get_device_osdev</a>(<a class="code" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, CUdevice cudevice)</div>
...
<div class="line"><a name="l00167"></a><span class="lineno">  167</span>&#160;        <span class="keywordflow">if</span> (<a class="code" href="a00107.php#gae45c92fbc7ac538cf69fdfcc73994ed9">hwloc_cuda_get_device_pci_ids</a>(topology, cudevice, &amp;domain, &amp;bus, &amp;dev))</div>
...
<div class="line"><a name="l00171"></a><span class="lineno">  171</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00095.php#ga73a5bc6265642e6001f7a10812ab886d">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
<div class="line"><a name="l00172"></a><span class="lineno">  172</span>&#160;                <a class="code" href="a00037.php">hwloc_obj_t</a> pcidev = osdev-&gt;<a class="code" href="a00037.php#adc494f6aed939992be1c55cca5822900">parent</a>;</div>
<div class="line"><a name="l00173"></a><span class="lineno">  173</span>&#160;                <span class="keywordflow">if</span> (strncmp(osdev-&gt;<a class="code" href="a00037.php#abb709ec38f2970677e4e57d1d30be96d">name</a>, <span class="stringliteral">&quot;cuda&quot;</span>, 4))</div>
...
<div class="line"><a name="l00176"></a><span class="lineno">  176</span>&#160;                    &amp;&amp; pcidev-&gt;<a class="code" href="a00037.php#acc4f0803f244867e68fe0036800be5de">type</a> == <a class="code" href="a00075.php#ggacd37bb612667dc437d66bfb175a8dc55a5d8117a54df1fbd3606ab19e42cb0ea9">HWLOC_OBJ_PCI_DEVICE</a></div>
<div class="line"><a name="l00177"></a><span class="lineno">  177</span>&#160;                    &amp;&amp; (<span class="keywordtype">int</span>) pcidev-&gt;<a class="code" href="a00037.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00038.php#a4203d713ce0f5beaa6ee0e9bdac70828">pcidev</a>.<a class="code" href="a00043.php#a8fba44988deb98613c1505a4019a34dc">domain</a> == domain</div>
<div class="line"><a name="l00178"></a><span class="lineno">  178</span>&#160;                    &amp;&amp; (<span class="keywordtype">int</span>) pcidev-&gt;<a class="code" href="a00037.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00038.php#a4203d713ce0f5beaa6ee0e9bdac70828">pcidev</a>.<a class="code" href="a00043.php#aae99e035e8d1387d7b8768aaa8eceb0a">bus</a> == bus</div>
<div class="line"><a name="l00179"></a><span class="lineno">  179</span>&#160;                    &amp;&amp; (<span class="keywordtype">int</span>) pcidev-&gt;<a class="code" href="a00037.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00038.php#a4203d713ce0f5beaa6ee0e9bdac70828">pcidev</a>.<a class="code" href="a00043.php#a3d70c84a12f7e93d14c8d47bf4fd9dc5">dev</a> == dev</div>
<div class="line"><a name="l00180"></a><span class="lineno">  180</span>&#160;                    &amp;&amp; pcidev-&gt;<a class="code" href="a00037.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00038.php#a4203d713ce0f5beaa6ee0e9bdac70828">pcidev</a>.<a class="code" href="a00043.php#a695f32df53f4ef728670bfcf31b74e0f">func</a> == 0)</div>
...
<div class="line"><a name="l00202"></a><span class="lineno">  202</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00037.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00203"></a><span class="lineno"><a class="line" href="a00107.php#ga108c1a96b356e5a0b236763d4d31fbeb">  203</a></span>&#160;<a class="code" href="a00107.php#ga108c1a96b356e5a0b236763d4d31fbeb">hwloc_cuda_get_device_osdev_by_index</a>(<a class="code" href="a00077.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <span class="keywordtype">unsigned</span> idx)</div>
<div class="line"><a name="l00204"></a><span class="lineno">  204</span>&#160;{</div>
<div class="line"><a name="l00205"></a><span class="lineno">  205</span>&#160;        <a class="code" href="a00037.php">hwloc_obj_t</a> osdev = NULL;</div>
<div class="line"><a name="l00206"></a><span class="lineno">  206</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00095.php#ga73a5bc6265642e6001f7a10812ab886d">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
<div class="line"><a name="l00207"></a><span class="lineno">  207</span>&#160;                <span class="keywordflow">if</span> (<a class="code" href="a00075.php#gga64f5d539df299c97ae80ce53fc4b56c0a46f8927e1c3e137eaa86cc8f6861fb83">HWLOC_OBJ_OSDEV_COPROC</a> == osdev-&gt;<a class="code" href="a00037.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00038.php#a22904c25fe44b323bab5c9bc52660fca">osdev</a>.<a class="code" href="a00042.php#a31e019e27e54ac6138d04be639bb96f9">type</a></div>
<div class="line"><a name="l00208"></a><span class="lineno">  208</span>&#160;                    &amp;&amp; osdev-&gt;<a class="code" href="a00037.php#abb709ec38f2970677e4e57d1d30be96d">name</a></div>
<div class="line"><a name="l00209"></a><span class="lineno">  209</span>&#160;                    &amp;&amp; !strncmp(<span class="stringliteral">&quot;cuda&quot;</span>, osdev-&gt;<a class="code" href="a00037.php#abb709ec38f2970677e4e57d1d30be96d">name</a>, 4)</div>
<div class="line"><a name="l00210"></a><span class="lineno">  210</span>&#160;                    &amp;&amp; atoi(osdev-&gt;<a class="code" href="a00037.php#abb709ec38f2970677e4e57d1d30be96d">name</a> + 4) == (<span class="keywordtype">int</span>) idx)</div>
...
<div class="line"><a name="l00220"></a><span class="lineno">  220</span>&#160;<span class="preprocessor"></span>} <span class="comment">/* extern &quot;C&quot; */</span></div>
...
<div class="ttc" id="a00107_php_ga108c1a96b356e5a0b236763d4d31fbeb"><div class="ttname"><a href="a00107.php#ga108c1a96b356e5a0b236763d4d31fbeb">hwloc_cuda_get_device_osdev_by_index</a></div><div class="ttdeci">static __hwloc_inline hwloc_obj_t hwloc_cuda_get_device_osdev_by_index(hwloc_topology_t topology, unsigned idx)</div><div class="ttdoc">Get the hwloc OS device object corresponding to the CUDA device whose index is idx. </div><div class="ttdef"><b>Definition:</b> cuda.h:203</div></div>
