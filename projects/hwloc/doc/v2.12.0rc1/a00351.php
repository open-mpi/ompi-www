...
<p><b>hwloc set of default nodes</b> (returned by <a class="el" href="a00168.php#gae7ff5d6f04d3bb71a3259cf1ff3afaed" title="Return the set of default NUMA nodes.">hwloc_topology_get_default_nodeset()</a>) <b>was designed for this purpose</b>: it ignores NUMA nodes with overlapping CPU set (only the first one is kept), and also tries to return nodes with similar subtypes.</p>
<p><br  />
</p>
