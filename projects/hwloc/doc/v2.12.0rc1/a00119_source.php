...
<div class="line"><a id="l00066" name="l00066"></a><span class="lineno"><a class="line" href="a00181.php#ga66281a9ba621357b1c7070b4fa19b5b8">   66</a></span><a class="code hl_function" href="a00181.php#ga66281a9ba621357b1c7070b4fa19b5b8">hwloc_levelzero_get_device_cpuset</a>(<a class="code hl_typedef" href="a00142.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
<div class="line"><a id="l00067" name="l00067"></a><span class="lineno">   67</span>                                  ze_device_handle_t device, <a class="code hl_typedef" href="a00139.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</div>
...
<div class="line"><a id="l00076" name="l00076"></a><span class="lineno">   76</span>  <span class="keywordflow">if</span> (!<a class="code hl_function" href="a00149.php#ga68ffdcfd9175cdf40709801092f18017">hwloc_topology_is_thissystem</a>(topology)) {</div>
...
<div class="line"><a id="l00091" name="l00091"></a><span class="lineno">   91</span>  <span class="keywordflow">if</span> (<a class="code hl_function" href="a00171.php#gaf72d83e273803226ce772973e37b85de">hwloc_linux_read_path_as_cpumask</a>(path, set) &lt; 0</div>
<div class="line"><a id="l00092" name="l00092"></a><span class="lineno">   92</span>      || <a class="code hl_function" href="a00161.php#ga5b64be28f5a7176ed8ad0d6a90bdf108">hwloc_bitmap_iszero</a>(set))</div>
...
<div class="line"><a id="l00096" name="l00096"></a><span class="lineno">   96</span>  <a class="code hl_function" href="a00161.php#ga72a29824798b48784b8217471ec8f14c">hwloc_bitmap_copy</a>(set, <a class="code hl_function" href="a00158.php#gaee30e03391c1ed7dfd617fb5c7bbb033">hwloc_topology_get_complete_cpuset</a>(topology));</div>
...
<div class="line"><a id="l00124" name="l00124"></a><span class="lineno"><a class="line" href="a00181.php#ga6b12d19e54b2d0ba4800108122d80d1f">  124</a></span><a class="code hl_function" href="a00181.php#ga6b12d19e54b2d0ba4800108122d80d1f">hwloc_levelzero_get_sysman_device_cpuset</a>(<a class="code hl_typedef" href="a00142.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
<div class="line"><a id="l00125" name="l00125"></a><span class="lineno">  125</span>                                         zes_device_handle_t device, <a class="code hl_typedef" href="a00139.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</div>
...
<div class="line"><a id="l00134" name="l00134"></a><span class="lineno">  134</span>  <span class="keywordflow">if</span> (!<a class="code hl_function" href="a00149.php#ga68ffdcfd9175cdf40709801092f18017">hwloc_topology_is_thissystem</a>(topology)) {</div>
...
<div class="line"><a id="l00147" name="l00147"></a><span class="lineno">  147</span>  <span class="keywordflow">if</span> (<a class="code hl_function" href="a00171.php#gaf72d83e273803226ce772973e37b85de">hwloc_linux_read_path_as_cpumask</a>(path, set) &lt; 0</div>
<div class="line"><a id="l00148" name="l00148"></a><span class="lineno">  148</span>      || <a class="code hl_function" href="a00161.php#ga5b64be28f5a7176ed8ad0d6a90bdf108">hwloc_bitmap_iszero</a>(set))</div>
<div class="line"><a id="l00149" name="l00149"></a><span class="lineno">  149</span>    <a class="code hl_function" href="a00161.php#ga72a29824798b48784b8217471ec8f14c">hwloc_bitmap_copy</a>(set, <a class="code hl_function" href="a00158.php#gaee30e03391c1ed7dfd617fb5c7bbb033">hwloc_topology_get_complete_cpuset</a>(topology));</div>
...
<div class="line"><a id="l00152" name="l00152"></a><span class="lineno">  152</span>  <a class="code hl_function" href="a00161.php#ga72a29824798b48784b8217471ec8f14c">hwloc_bitmap_copy</a>(set, <a class="code hl_function" href="a00158.php#gaee30e03391c1ed7dfd617fb5c7bbb033">hwloc_topology_get_complete_cpuset</a>(topology));</div>
...
<div class="line"><a id="l00178" name="l00178"></a><span class="lineno">  178</span><span class="keyword">static</span> __hwloc_inline <a class="code hl_struct" href="a00196.php">hwloc_obj_t</a></div>
<div class="foldopen" id="foldopen00179" data-start="{" data-end="}">
<div class="line"><a id="l00179" name="l00179"></a><span class="lineno"><a class="line" href="a00181.php#gaf06cb737abcd2dc6db894c8914302d85">  179</a></span><a class="code hl_function" href="a00181.php#gaf06cb737abcd2dc6db894c8914302d85">hwloc_levelzero_get_device_osdev</a>(<a class="code hl_typedef" href="a00142.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, ze_device_handle_t device)</div>
...
<div class="line"><a id="l00183" name="l00183"></a><span class="lineno">  183</span>  <a class="code hl_struct" href="a00196.php">hwloc_obj_t</a> osdev;</div>
<div class="line"><a id="l00184" name="l00184"></a><span class="lineno">  184</span> </div>
<div class="line"><a id="l00185" name="l00185"></a><span class="lineno">  185</span>  <span class="keywordflow">if</span> (!<a class="code hl_function" href="a00149.php#ga68ffdcfd9175cdf40709801092f18017">hwloc_topology_is_thissystem</a>(topology)) {</div>
...
<div class="line"><a id="l00199" name="l00199"></a><span class="lineno">  199</span>  <span class="keywordflow">while</span> ((osdev = <a class="code hl_function" href="a00160.php#ga8b4584c8949e2c5f1c97ba7fe92b8145">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
<div class="line"><a id="l00200" name="l00200"></a><span class="lineno">  200</span>    <a class="code hl_struct" href="a00196.php">hwloc_obj_t</a> pcidev;</div>
<div class="line"><a id="l00201" name="l00201"></a><span class="lineno">  201</span> </div>
<div class="line"><a id="l00202" name="l00202"></a><span class="lineno">  202</span>    <span class="keywordflow">if</span> (strncmp(osdev-&gt;<a class="code hl_variable" href="a00196.php#abb709ec38f2970677e4e57d1d30be96d">name</a>, <span class="stringliteral">&quot;ze&quot;</span>, 2))</div>
...
<div class="line"><a id="l00206" name="l00206"></a><span class="lineno">  206</span>    <span class="keywordflow">while</span> (pcidev &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#acc4f0803f244867e68fe0036800be5de">type</a> != <a class="code hl_enumvalue" href="a00140.php#ggacd37bb612667dc437d66bfb175a8dc55a5d8117a54df1fbd3606ab19e42cb0ea9">HWLOC_OBJ_PCI_DEVICE</a>)</div>
<div class="line"><a id="l00207" name="l00207"></a><span class="lineno">  207</span>      pcidev = pcidev-&gt;<a class="code hl_variable" href="a00196.php#adc494f6aed939992be1c55cca5822900">parent</a>;</div>
...
<div class="line"><a id="l00212" name="l00212"></a><span class="lineno">  212</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#acc4f0803f244867e68fe0036800be5de">type</a> == <a class="code hl_enumvalue" href="a00140.php#ggacd37bb612667dc437d66bfb175a8dc55a5d8117a54df1fbd3606ab19e42cb0ea9">HWLOC_OBJ_PCI_DEVICE</a></div>
<div class="line"><a id="l00213" name="l00213"></a><span class="lineno">  213</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00200.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00220.php#a8fba44988deb98613c1505a4019a34dc">domain</a> == pci.address.domain</div>
<div class="line"><a id="l00214" name="l00214"></a><span class="lineno">  214</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00200.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00220.php#aae99e035e8d1387d7b8768aaa8eceb0a">bus</a> == pci.address.bus</div>
<div class="line"><a id="l00215" name="l00215"></a><span class="lineno">  215</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00200.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00220.php#a3d70c84a12f7e93d14c8d47bf4fd9dc5">dev</a> == pci.address.device</div>
<div class="line"><a id="l00216" name="l00216"></a><span class="lineno">  216</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00200.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00220.php#a695f32df53f4ef728670bfcf31b74e0f">func</a> == pci.address.function)</div>
...
<div class="line"><a id="l00245" name="l00245"></a><span class="lineno">  245</span><span class="keyword">static</span> __hwloc_inline <a class="code hl_struct" href="a00196.php">hwloc_obj_t</a></div>
<div class="foldopen" id="foldopen00246" data-start="{" data-end="}">
<div class="line"><a id="l00246" name="l00246"></a><span class="lineno"><a class="line" href="a00181.php#ga817f3e18350306344a8c1715be95ab22">  246</a></span><a class="code hl_function" href="a00181.php#ga817f3e18350306344a8c1715be95ab22">hwloc_levelzero_get_sysman_device_osdev</a>(<a class="code hl_typedef" href="a00142.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, zes_device_handle_t device)</div>
...
<div class="line"><a id="l00250" name="l00250"></a><span class="lineno">  250</span>  <a class="code hl_struct" href="a00196.php">hwloc_obj_t</a> osdev;</div>
<div class="line"><a id="l00251" name="l00251"></a><span class="lineno">  251</span> </div>
<div class="line"><a id="l00252" name="l00252"></a><span class="lineno">  252</span>  <span class="keywordflow">if</span> (!<a class="code hl_function" href="a00149.php#ga68ffdcfd9175cdf40709801092f18017">hwloc_topology_is_thissystem</a>(topology)) {</div>
...
<div class="line"><a id="l00264" name="l00264"></a><span class="lineno">  264</span>  <span class="keywordflow">while</span> ((osdev = <a class="code hl_function" href="a00160.php#ga8b4584c8949e2c5f1c97ba7fe92b8145">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
<div class="line"><a id="l00265" name="l00265"></a><span class="lineno">  265</span>    <a class="code hl_struct" href="a00196.php">hwloc_obj_t</a> pcidev;</div>
<div class="line"><a id="l00266" name="l00266"></a><span class="lineno">  266</span> </div>
<div class="line"><a id="l00267" name="l00267"></a><span class="lineno">  267</span>    <span class="keywordflow">if</span> (strncmp(osdev-&gt;<a class="code hl_variable" href="a00196.php#abb709ec38f2970677e4e57d1d30be96d">name</a>, <span class="stringliteral">&quot;ze&quot;</span>, 2))</div>
...
<div class="line"><a id="l00271" name="l00271"></a><span class="lineno">  271</span>    <span class="keywordflow">while</span> (pcidev &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#acc4f0803f244867e68fe0036800be5de">type</a> != <a class="code hl_enumvalue" href="a00140.php#ggacd37bb612667dc437d66bfb175a8dc55a5d8117a54df1fbd3606ab19e42cb0ea9">HWLOC_OBJ_PCI_DEVICE</a>)</div>
<div class="line"><a id="l00272" name="l00272"></a><span class="lineno">  272</span>      pcidev = pcidev-&gt;<a class="code hl_variable" href="a00196.php#adc494f6aed939992be1c55cca5822900">parent</a>;</div>
...
<div class="line"><a id="l00277" name="l00277"></a><span class="lineno">  277</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#acc4f0803f244867e68fe0036800be5de">type</a> == <a class="code hl_enumvalue" href="a00140.php#ggacd37bb612667dc437d66bfb175a8dc55a5d8117a54df1fbd3606ab19e42cb0ea9">HWLOC_OBJ_PCI_DEVICE</a></div>
<div class="line"><a id="l00278" name="l00278"></a><span class="lineno">  278</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00200.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00220.php#a8fba44988deb98613c1505a4019a34dc">domain</a> == pci.address.domain</div>
<div class="line"><a id="l00279" name="l00279"></a><span class="lineno">  279</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00200.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00220.php#aae99e035e8d1387d7b8768aaa8eceb0a">bus</a> == pci.address.bus</div>
<div class="line"><a id="l00280" name="l00280"></a><span class="lineno">  280</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00200.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00220.php#a3d70c84a12f7e93d14c8d47bf4fd9dc5">dev</a> == pci.address.device</div>
<div class="line"><a id="l00281" name="l00281"></a><span class="lineno">  281</span>      &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00196.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00200.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00220.php#a695f32df53f4ef728670bfcf31b74e0f">func</a> == pci.address.function)</div>
...
<div class="ttc" id="aa00181_php_ga6b12d19e54b2d0ba4800108122d80d1f"><div class="ttname"><a href="a00181.php#ga6b12d19e54b2d0ba4800108122d80d1f">hwloc_levelzero_get_sysman_device_cpuset</a></div><div class="ttdeci">static int hwloc_levelzero_get_sysman_device_cpuset(hwloc_topology_t topology, zes_device_handle_t device, hwloc_cpuset_t set)</div><div class="ttdoc">Get the CPU set of logical processors that are physically close to the Level Zero Sysman device devic...</div><div class="ttdef"><b>Definition</b> levelzero.h:124</div></div>
<div class="ttc" id="aa00181_php_ga817f3e18350306344a8c1715be95ab22"><div class="ttname"><a href="a00181.php#ga817f3e18350306344a8c1715be95ab22">hwloc_levelzero_get_sysman_device_osdev</a></div><div class="ttdeci">static hwloc_obj_t hwloc_levelzero_get_sysman_device_osdev(hwloc_topology_t topology, zes_device_handle_t device)</div><div class="ttdoc">Get the hwloc OS device object corresponding to Level Zero Sysman device device.</div><div class="ttdef"><b>Definition</b> levelzero.h:246</div></div>
