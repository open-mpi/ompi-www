...
<div class="fragment"><div class="line"><a class="code" href="a00166.php#ga80bc07473a8edf840cae17bd7ec21d48">hwloc_set_cpubind</a>(topology, <span class="keyword">set</span>, 0),</div></div><!-- fragment --><p>If the program may be multithreaded, the following one should be preferred to only bind the current thread:</p>
<div class="fragment"><div class="line"><a class="code" href="a00166.php#ga80bc07473a8edf840cae17bd7ec21d48">hwloc_set_cpubind</a>(topology, <span class="keyword">set</span>, <a class="code" href="a00166.php#gga217dc8d373f8958cc93c154ebce1c71caf1b6bbad00d7b1017b918e3719f4d421">HWLOC_CPUBIND_THREAD</a>),</div></div><!-- fragment --><dl class="section see"><dt>See also</dt><dd>Some example codes are available under doc/examples/ in the source tree.</dd></dl>
