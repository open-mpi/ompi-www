...
<dl>
<dt>Object </dt>
<dd><p class="startdd">Interesting kind of part of the system, such as a Core, a L2Cache, a NUMA memory node, etc. The different types detected by hwloc are detailed in the <a class="el" href="a00160.php#gacd37bb612667dc437d66bfb175a8dc55">hwloc_obj_type_t</a> enumeration.</p>
<p>They are topologically sorted by CPU set into a tree (see <a class="el" href="a00325.php#termsanddefs_tree">Hierarchy, Tree and Levels</a>). </p>
<p class="enddd"></p>
</dd>
