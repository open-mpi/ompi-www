...
<li>
The original hwloc project for describing the internals of computing nodes. It is described in details between sections <a class="el" href="a00324.php">Hardware Locality (hwloc) Introduction</a> and <a class="el" href="a00339.php">Network Locality (netloc)</a>.  </li>
<li>
<p class="startli">The network-oriented companion called netloc (Network Locality), described in details starting at section <a class="el" href="a00339.php">Network Locality (netloc)</a>. Netloc may be disabled, but the original hwloc cannot.  Both hwloc and netloc APIs are documented after these sections.</p>
<p class="endli"> 
...
shell$ make
shell$ make install
</pre><p>hwloc- and netloc-specific configure options and requirements are documented in sections <a class="el" href="a00324.php#hwloc_installation">hwloc Installation</a> and <a class="el" href="a00339.php#netloc_installation">Netloc Installation</a> respectively.</p>
