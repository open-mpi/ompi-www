...
Functions</h2></td></tr>
<tr class="memitem:ga91bafa51abe81527f72437e24ad5944e"><td class="memItemLeft" align="right" valign="top">static int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00196.php#ga91bafa51abe81527f72437e24ad5944e">hwloc_intel_mic_get_device_cpuset</a> (<a class="el" href="a00162.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, int idx, <a class="el" href="a00159.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</td></tr>
<tr class="separator:ga91bafa51abe81527f72437e24ad5944e"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gabce0465e853de74be84cafcb96dd48ab"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00161.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00196.php#gabce0465e853de74be84cafcb96dd48ab">hwloc_intel_mic_get_device_osdev_by_index</a> (<a class="el" href="a00162.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, unsigned idx)</td></tr>
...
<p>The function only returns the locality of the device. If more information about the device is needed, OS objects should be used instead, see <a class="el" href="a00196.php#gabce0465e853de74be84cafcb96dd48ab" title="Get the hwloc OS device object corresponding to the MIC device for the given index. ">hwloc_intel_mic_get_device_osdev_by_index()</a>.</p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00161.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_intel_mic_get_device_osdev_by_index </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00162.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
