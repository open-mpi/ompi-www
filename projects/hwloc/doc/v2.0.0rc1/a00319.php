...
<div class="title">hwloc_backend Struct Reference<div class="ingroups"><a class="el" href="a00201.php">Components and Plugins: Discovery backends</a></div></div>  </div>
</div><!--header-->
<div class="contents">
...
<tr class="memitem:aeb9e1dcf68853a65355082b359a3a2d7"><td class="memItemLeft" align="right" valign="top">int(*&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00319.php#aeb9e1dcf68853a65355082b359a3a2d7">discover</a> )(struct <a class="el" href="a00319.php">hwloc_backend</a> *backend)</td></tr>
...
<p><a class="el" href="a00201.php#ga330a0b581de4817d0cf1e7401db22436" title="Allocate a backend structure, set good default values, initialize backend-&gt;component and topology...">hwloc_backend_alloc()</a> initializes all fields to default values that the component may change (except "component" and "next") before enabling the backend with <a class="el" href="a00201.php#gaa4edf46c5d88eef53b3b8f572d88b9c5" title="Enable a previously allocated and setup backend. ">hwloc_backend_enable()</a>. </p>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">int(* hwloc_backend::discover) (struct <a class="el" href="a00319.php">hwloc_backend</a> *backend)</td>
        </tr>
      </table>
</div><div class="memdoc">
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">int(* hwloc_backend::get_pci_busid_cpuset) (struct <a class="el" href="a00319.php">hwloc_backend</a> *backend, struct hwloc_pcidev_attr_s *busid, <a class="el" href="a00181.php#gaa3c2bf4c776d603dcebbb61b0c923d84">hwloc_bitmap_t</a> cpuset)</td>
        </tr>
      </table>
</div><div class="memdoc">
