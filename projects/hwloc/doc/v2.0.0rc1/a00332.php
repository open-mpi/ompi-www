...
<div class="contents">
<div class="textblock"><p>hwloc offers the ability to export topologies to XML files and reload them later. This is for instance useful for loading topologies faster (see <a class="el" href="a00338.php#faq_xml">I do not want hwloc to rediscover my enormous machine topology every time I rerun a process</a>), manipulating other nodes' topology, or avoiding the need for privileged processes (see <a class="el" href="a00338.php#faq_privileged">Does hwloc require privileged access?</a>).</p>
...
<dd>
hwloc also offers the ability to export/import <a class="el" href="a00198.php">Topology differences</a>.</dd>
<dd>
