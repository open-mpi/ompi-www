...
<div class="line"><a name="l00053"></a><span class="lineno">   53</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00204.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00054"></a><span class="lineno"><a class="line" href="a00189.php#ga4d66a77e4fe4051d6e5b772c1b8fcec5">   54</a></span>&#160;<a class="code" href="a00189.php#ga4d66a77e4fe4051d6e5b772c1b8fcec5">hwloc_gl_get_display_osdev_by_port_device</a>(<a class="code" href="a00153.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology,</div>
...
<div class="line"><a name="l00058"></a><span class="lineno">   58</span>&#160;        <a class="code" href="a00204.php">hwloc_obj_t</a> osdev = NULL;</div>
<div class="line"><a name="l00059"></a><span class="lineno">   59</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00171.php#ga8b4584c8949e2c5f1c97ba7fe92b8145">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
<div class="line"><a name="l00060"></a><span class="lineno">   60</span>&#160;                <span class="keywordflow">if</span> (<a class="code" href="a00151.php#gga64f5d539df299c97ae80ce53fc4b56c0aa3a09798ef2836abb236dc3a645ffc90">HWLOC_OBJ_OSDEV_GPU</a> == osdev-&gt;<a class="code" href="a00204.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00208.php#aaf7a5c38b5185703ff18c46ad2761dcf">osdev</a>.<a class="code" href="a00248.php#a31e019e27e54ac6138d04be639bb96f9">type</a></div>
<div class="line"><a name="l00061"></a><span class="lineno">   61</span>&#160;                    &amp;&amp; osdev-&gt;<a class="code" href="a00204.php#abb709ec38f2970677e4e57d1d30be96d">name</a></div>
<div class="line"><a name="l00062"></a><span class="lineno">   62</span>&#160;                    &amp;&amp; sscanf(osdev-&gt;<a class="code" href="a00204.php#abb709ec38f2970677e4e57d1d30be96d">name</a>, <span class="stringliteral">&quot;:%u.%u&quot;</span>, &amp;x, &amp;y) == 2</div>
...
<div class="line"><a name="l00084"></a><span class="lineno">   84</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00204.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00085"></a><span class="lineno"><a class="line" href="a00189.php#ga2d36ef441d1dfddf49cfb5c01bd58d8e">   85</a></span>&#160;<a class="code" href="a00189.php#ga2d36ef441d1dfddf49cfb5c01bd58d8e">hwloc_gl_get_display_osdev_by_name</a>(<a class="code" href="a00153.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology,</div>
...
<div class="line"><a name="l00088"></a><span class="lineno">   88</span>&#160;        <a class="code" href="a00204.php">hwloc_obj_t</a> osdev = NULL;</div>
<div class="line"><a name="l00089"></a><span class="lineno">   89</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00171.php#ga8b4584c8949e2c5f1c97ba7fe92b8145">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
<div class="line"><a name="l00090"></a><span class="lineno">   90</span>&#160;                <span class="keywordflow">if</span> (<a class="code" href="a00151.php#gga64f5d539df299c97ae80ce53fc4b56c0aa3a09798ef2836abb236dc3a645ffc90">HWLOC_OBJ_OSDEV_GPU</a> == osdev-&gt;<a class="code" href="a00204.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00208.php#aaf7a5c38b5185703ff18c46ad2761dcf">osdev</a>.<a class="code" href="a00248.php#a31e019e27e54ac6138d04be639bb96f9">type</a></div>
<div class="line"><a name="l00091"></a><span class="lineno">   91</span>&#160;                    &amp;&amp; osdev-&gt;<a class="code" href="a00204.php#abb709ec38f2970677e4e57d1d30be96d">name</a></div>
<div class="line"><a name="l00092"></a><span class="lineno">   92</span>&#160;                    &amp;&amp; !strcmp(name, osdev-&gt;<a class="code" href="a00204.php#abb709ec38f2970677e4e57d1d30be96d">name</a>))</div>
...
<div class="line"><a name="l00111"></a><span class="lineno"><a class="line" href="a00189.php#ga936665ab5f0d29a081c4b78d11f4ad07">  111</a></span>&#160;<a class="code" href="a00189.php#ga936665ab5f0d29a081c4b78d11f4ad07">hwloc_gl_get_display_by_osdev</a>(<a class="code" href="a00153.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
<div class="line"><a name="l00112"></a><span class="lineno">  112</span>&#160;                              <a class="code" href="a00204.php">hwloc_obj_t</a> osdev,</div>
...
<div class="line"><a name="l00116"></a><span class="lineno">  116</span>&#160;        <span class="keywordflow">if</span> (<a class="code" href="a00151.php#gga64f5d539df299c97ae80ce53fc4b56c0aa3a09798ef2836abb236dc3a645ffc90">HWLOC_OBJ_OSDEV_GPU</a> == osdev-&gt;<a class="code" href="a00204.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00208.php#aaf7a5c38b5185703ff18c46ad2761dcf">osdev</a>.<a class="code" href="a00248.php#a31e019e27e54ac6138d04be639bb96f9">type</a></div>
<div class="line"><a name="l00117"></a><span class="lineno">  117</span>&#160;            &amp;&amp; sscanf(osdev-&gt;<a class="code" href="a00204.php#abb709ec38f2970677e4e57d1d30be96d">name</a>, <span class="stringliteral">&quot;:%u.%u&quot;</span>, &amp;x, &amp;y) == 2) {</div>
