...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight"><p>Flags to be given to <a class="el" href="group__hwlocality__tinker.php#gad75fa918e3eb54663bdeab25ed89b648" title="Restrict the topology to the given CPU set.">hwloc_topology_restrict()</a>. </p>
 <a href="group__hwlocality__tinker.php#ga9d80f08eb25b7ac22f1b998dc8bf521f">More...</a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Export the topology into a newly-allocated XML memory buffer.  <a href="#gad77e72a2ccf32825511818988a09e5c1"></a><br/></td></tr>
...
<a class="anchor" id="gad77e72a2ccf32825511818988a09e5c1"></a><!-- doxytag: member="hwloc.h::hwloc_topology_export_xmlbuffer" ref="gad77e72a2ccf32825511818988a09e5c1" args="(hwloc_topology_t topology, char **xmlbuffer, int *buflen)" -->
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname"> void hwloc_topology_export_xmlbuffer </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="group__hwlocality__topology.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
...
<p><code>xmlbuffer</code> is allocated by the callee and should be freed with xmlFree later in the caller.</p>
<p>This memory buffer may be loaded later through <a class="el" href="group__hwlocality__configuration.php#gae7e4bade144652a2b48f5eaf0309b4ec" title="Enable XML based topology using a memory buffer instead of a file.">hwloc_topology_set_xmlbuffer()</a>. </p>
