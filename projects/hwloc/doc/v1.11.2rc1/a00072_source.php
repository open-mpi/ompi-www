...
<div class="line"><a name="l00062"></a><span class="lineno"><a class="line" href="a00115.php#ga3ea0d838c1e7f1671b35687aae2da6ae">   62</a></span>&#160;<a class="code" href="a00115.php#ga3ea0d838c1e7f1671b35687aae2da6ae">hwloc_ibv_get_device_cpuset</a>(<a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
...
<div class="line"><a name="l00109"></a><span class="lineno">  109</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00038.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00110"></a><span class="lineno"><a class="line" href="a00115.php#ga31d794567f4420bbdc8baa7bf8bf6138">  110</a></span>&#160;<a class="code" href="a00115.php#ga31d794567f4420bbdc8baa7bf8bf6138">hwloc_ibv_get_device_osdev_by_name</a>(<a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology,</div>
...
<div class="line"><a name="l00113"></a><span class="lineno">  113</span>&#160;        <a class="code" href="a00038.php">hwloc_obj_t</a> osdev = NULL;</div>
<div class="line"><a name="l00114"></a><span class="lineno">  114</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00097.php#ga8b4584c8949e2c5f1c97ba7fe92b8145">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
<div class="line"><a name="l00115"></a><span class="lineno">  115</span>&#160;                <span class="keywordflow">if</span> (<a class="code" href="a00076.php#gga64f5d539df299c97ae80ce53fc4b56c0a52157d03694fdae82dddd57ca8c973b6">HWLOC_OBJ_OSDEV_OPENFABRICS</a> == osdev-&gt;<a class="code" href="a00038.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00039.php#a22904c25fe44b323bab5c9bc52660fca">osdev</a>.<a class="code" href="a00043.php#a31e019e27e54ac6138d04be639bb96f9">type</a></div>
<div class="line"><a name="l00116"></a><span class="lineno">  116</span>&#160;                    &amp;&amp; osdev-&gt;<a class="code" href="a00038.php#abb709ec38f2970677e4e57d1d30be96d">name</a> &amp;&amp; !strcmp(ibname, osdev-&gt;<a class="code" href="a00038.php#abb709ec38f2970677e4e57d1d30be96d">name</a>))</div>
...
<div class="line"><a name="l00136"></a><span class="lineno">  136</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00038.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00137"></a><span class="lineno"><a class="line" href="a00115.php#ga7324cdfd5db6ed2669c051ef7e1b64e1">  137</a></span>&#160;<a class="code" href="a00115.php#ga7324cdfd5db6ed2669c051ef7e1b64e1">hwloc_ibv_get_device_osdev</a>(<a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology,</div>
...
<div class="line"><a name="l00140"></a><span class="lineno">  140</span>&#160;        <span class="keywordflow">if</span> (!<a class="code" href="a00079.php#ga68ffdcfd9175cdf40709801092f18017">hwloc_topology_is_thissystem</a>(topology)) {</div>
...
<div class="line"><a name="l00144"></a><span class="lineno">  144</span>&#160;        <span class="keywordflow">return</span> <a class="code" href="a00115.php#ga31d794567f4420bbdc8baa7bf8bf6138">hwloc_ibv_get_device_osdev_by_name</a>(topology, ibv_get_device_name(ibdev));</div>
