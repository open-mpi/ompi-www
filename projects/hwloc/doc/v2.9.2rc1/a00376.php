...
<div><div class="header">
  <div class="headertitle"><div class="title">Network Locality (netloc) </div></div>
</div><!--header-->
<div class="contents">
...
<li>
<a class="el" href="a00376.php">Network Locality (netloc)</a>, this section below  </li>
<li>
<a class="el" href="a00377.php">Netloc with Scotch</a>  </li>
</ul>
<p > 
...
<p >For now, only InfiniBand (See <a class="el" href="a00376.php#netloc_setup">Setup</a>) is supported, but it is planned to be extended very soon.</p>
<p > 
