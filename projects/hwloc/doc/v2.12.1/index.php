...
<div class="line">    print_children(topology, <a class="code hl_function" href="a00143.php#gae76ac1ab6b8898bfe7667408b84c61d0">hwloc_get_root_obj</a>(topology), 0);</div>
<div class="line"> </div>
<div class="line"><span class="comment">    /*****************************************************************</span></div>
...
<div class="line">    <span class="keywordflow">for</span> (obj = <a class="code hl_function" href="a00143.php#ga1005a33633ddf9f730de692133e83dbd">hwloc_get_obj_by_type</a>(topology, <a class="code hl_enumvalue" href="a00140.php#ggacd37bb612667dc437d66bfb175a8dc55abca6887e80cb291353b0a0c1da83f661">HWLOC_OBJ_PU</a>, 0);</div>
...
<div class="line"><span class="comment">     *****************************************************************/</span></div>
<div class="line">    depth = <a class="code hl_function" href="a00143.php#gae395d32536ecc0fc916737b655d9d7a1">hwloc_get_type_or_below_depth</a>(topology, <a class="code hl_enumvalue" href="a00140.php#ggacd37bb612667dc437d66bfb175a8dc55ac793958f330bca371aa1535de8aff45f">HWLOC_OBJ_CORE</a>);</div>
<div class="line"> </div>
...
<div class="line">    n = <a class="code hl_function" href="a00143.php#ga53caf2bdef1125a2ac4bd792227f86c5">hwloc_get_nbobjs_by_type</a>(topology, <a class="code hl_enumvalue" href="a00140.php#ggacd37bb612667dc437d66bfb175a8dc55a9d917a3e5497950c6d8948b8e183db5a">HWLOC_OBJ_NUMANODE</a>);</div>
<div class="line">    obj = <a class="code hl_function" href="a00143.php#ga1005a33633ddf9f730de692133e83dbd">hwloc_get_obj_by_type</a>(topology, <a class="code hl_enumvalue" href="a00140.php#ggacd37bb612667dc437d66bfb175a8dc55a9d917a3e5497950c6d8948b8e183db5a">HWLOC_OBJ_NUMANODE</a>, n - 1);</div>
<div class="line"> </div>
...
<div class="ttc" id="aa00143_php_ga53caf2bdef1125a2ac4bd792227f86c5"><div class="ttname"><a href="a00143.php#ga53caf2bdef1125a2ac4bd792227f86c5">hwloc_get_nbobjs_by_type</a></div><div class="ttdeci">int hwloc_get_nbobjs_by_type(hwloc_topology_t topology, hwloc_obj_type_t type)</div><div class="ttdoc">Returns the width of level type type.</div></div>
...
<div class="ttc" id="aa00143_php_gae395d32536ecc0fc916737b655d9d7a1"><div class="ttname"><a href="a00143.php#gae395d32536ecc0fc916737b655d9d7a1">hwloc_get_type_or_below_depth</a></div><div class="ttdeci">int hwloc_get_type_or_below_depth(hwloc_topology_t topology, hwloc_obj_type_t type)</div><div class="ttdoc">Returns the depth of objects of type type or below.</div></div>
...
<div class="ttc" id="aa00143_php_gae76ac1ab6b8898bfe7667408b84c61d0"><div class="ttname"><a href="a00143.php#gae76ac1ab6b8898bfe7667408b84c61d0">hwloc_get_root_obj</a></div><div class="ttdeci">hwloc_obj_t hwloc_get_root_obj(hwloc_topology_t topology)</div><div class="ttdoc">Returns the top-object of the topology-tree.</div></div>
