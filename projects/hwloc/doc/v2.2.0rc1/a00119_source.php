...
<div class="line"><a name="l00048"></a><span class="lineno"><a class="line" href="a00178.php#gad8b701d9a34923e34bd58defd4c1e704">   48</a></span>&#160;<a class="code" href="a00178.php#gad8b701d9a34923e34bd58defd4c1e704">hwloc_cudart_get_device_pci_ids</a>(<a class="code" href="a00147.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
...
<div class="line"><a name="l00089"></a><span class="lineno"><a class="line" href="a00178.php#ga187ca00c6e12800a25151ce331620980">   89</a></span>&#160;<a class="code" href="a00178.php#ga187ca00c6e12800a25151ce331620980">hwloc_cudart_get_device_cpuset</a>(<a class="code" href="a00147.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
<div class="line"><a name="l00090"></a><span class="lineno">   90</span>&#160;                               <span class="keywordtype">int</span> idx, <a class="code" href="a00144.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</div>
...
<div class="line"><a name="l00098"></a><span class="lineno">   98</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00178.php#gad8b701d9a34923e34bd58defd4c1e704">hwloc_cudart_get_device_pci_ids</a>(topology, idx, &amp;domain, &amp;bus, &amp;dev))</div>
<div class="line"><a name="l00099"></a><span class="lineno">   99</span>&#160;    <span class="keywordflow">return</span> -1;</div>
<div class="line"><a name="l00100"></a><span class="lineno">  100</span>&#160; </div>
<div class="line"><a name="l00101"></a><span class="lineno">  101</span>&#160;  <span class="keywordflow">if</span> (!<a class="code" href="a00154.php#ga68ffdcfd9175cdf40709801092f18017">hwloc_topology_is_thissystem</a>(topology)) {</div>
...
<div class="line"><a name="l00107"></a><span class="lineno">  107</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00172.php#gaf72d83e273803226ce772973e37b85de">hwloc_linux_read_path_as_cpumask</a>(path, set) &lt; 0</div>
<div class="line"><a name="l00108"></a><span class="lineno">  108</span>&#160;      || <a class="code" href="a00166.php#ga5b64be28f5a7176ed8ad0d6a90bdf108">hwloc_bitmap_iszero</a>(set))</div>
<div class="line"><a name="l00109"></a><span class="lineno">  109</span>&#160;    <a class="code" href="a00166.php#ga72a29824798b48784b8217471ec8f14c">hwloc_bitmap_copy</a>(set, <a class="code" href="a00163.php#gaee30e03391c1ed7dfd617fb5c7bbb033">hwloc_topology_get_complete_cpuset</a>(topology));</div>
...
<div class="line"><a name="l00127"></a><span class="lineno">  127</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00195.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00128"></a><span class="lineno"><a class="line" href="a00178.php#gaeda4e6efbb36b518b2c286434ad23bb2">  128</a></span>&#160;<a class="code" href="a00178.php#gaeda4e6efbb36b518b2c286434ad23bb2">hwloc_cudart_get_device_pcidev</a>(<a class="code" href="a00147.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <span class="keywordtype">int</span> idx)</div>
...
<div class="line"><a name="l00132"></a><span class="lineno">  132</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00178.php#gad8b701d9a34923e34bd58defd4c1e704">hwloc_cudart_get_device_pci_ids</a>(topology, idx, &amp;domain, &amp;bus, &amp;dev))</div>
<div class="line"><a name="l00133"></a><span class="lineno">  133</span>&#160;    <span class="keywordflow">return</span> NULL;</div>
<div class="line"><a name="l00134"></a><span class="lineno">  134</span>&#160; </div>
<div class="line"><a name="l00135"></a><span class="lineno">  135</span>&#160;  <span class="keywordflow">return</span> <a class="code" href="a00165.php#gacdbaf0db98872e224b7883a84bfb0455">hwloc_get_pcidev_by_busid</a>(topology, domain, bus, dev, 0);</div>
<div class="line"><a name="l00136"></a><span class="lineno">  136</span>&#160;}</div>
<div class="line"><a name="l00137"></a><span class="lineno">  137</span>&#160; </div>
<div class="line"><a name="l00155"></a><span class="lineno">  155</span>&#160;<span class="keyword">static</span> __hwloc_inline <a class="code" href="a00195.php">hwloc_obj_t</a></div>
<div class="line"><a name="l00156"></a><span class="lineno"><a class="line" href="a00178.php#gac0f3eeaf7712919f298097b1a21307b0">  156</a></span>&#160;<a class="code" href="a00178.php#gac0f3eeaf7712919f298097b1a21307b0">hwloc_cudart_get_device_osdev_by_index</a>(<a class="code" href="a00147.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <span class="keywordtype">unsigned</span> idx)</div>
<div class="line"><a name="l00157"></a><span class="lineno">  157</span>&#160;{</div>
<div class="line"><a name="l00158"></a><span class="lineno">  158</span>&#160;        <a class="code" href="a00195.php">hwloc_obj_t</a> osdev = NULL;</div>
<div class="line"><a name="l00159"></a><span class="lineno">  159</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00165.php#ga8b4584c8949e2c5f1c97ba7fe92b8145">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
<div class="line"><a name="l00160"></a><span class="lineno">  160</span>&#160;                <span class="keywordflow">if</span> (<a class="code" href="a00145.php#gga64f5d539df299c97ae80ce53fc4b56c0a46f8927e1c3e137eaa86cc8f6861fb83">HWLOC_OBJ_OSDEV_COPROC</a> == osdev-&gt;<a class="code" href="a00195.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00199.php#aaf7a5c38b5185703ff18c46ad2761dcf">osdev</a>.<a class="code" href="a00239.php#a31e019e27e54ac6138d04be639bb96f9">type</a></div>
<div class="line"><a name="l00161"></a><span class="lineno">  161</span>&#160;                    &amp;&amp; osdev-&gt;<a class="code" href="a00195.php#abb709ec38f2970677e4e57d1d30be96d">name</a></div>
<div class="line"><a name="l00162"></a><span class="lineno">  162</span>&#160;                    &amp;&amp; !strncmp(<span class="stringliteral">&quot;cuda&quot;</span>, osdev-&gt;<a class="code" href="a00195.php#abb709ec38f2970677e4e57d1d30be96d">name</a>, 4)</div>
<div class="line"><a name="l00163"></a><span class="lineno">  163</span>&#160;                    &amp;&amp; atoi(osdev-&gt;<a class="code" href="a00195.php#abb709ec38f2970677e4e57d1d30be96d">name</a> + 4) == (<span class="keywordtype">int</span>) idx)</div>
