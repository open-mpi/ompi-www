...
hwloc-annotate</h1>
<p>hwloc-annotate may modify object (and topology) attributes such as string information (see <a class="el" href="a00356.php#attributes_info">Custom string infos</a> for details) or Misc children objects. It may also add distances, memory attributes, etc. to the topology. It reads an input topology from a XML file and outputs the annotated topology as another XML file.</p>
<p> 
...
<p>Currently only used on Intel Xeon Phi processor platforms. See <a class="el" href="a00364.php#faq_knl_dump">Why do I need hwloc-dump-hwdata for memory on Intel Xeon Phi processor?</a>.</p>
