...
<li>
<b>The original hwloc project for describing the internals of computing nodes</b>. It is described in details starting at section <a class="el" href="a00349.php">Hardware Locality (hwloc) Introduction</a>.  </li>
<li>
<b>The network-oriented companion called netloc (Network Locality)</b>, described in details starting with section <a class="el" href="a00366.php">Network Locality (netloc)</a>.  </li>
</ul>
<p> 
...
shell$ make
shell$ make install
</pre><p>hwloc- and netloc-specific configure options and requirements are documented in sections <a class="el" href="a00349.php#hwloc_installation">hwloc Installation</a> and <a class="el" href="a00366.php#netloc_installation">Netloc Installation</a> respectively.</p>
