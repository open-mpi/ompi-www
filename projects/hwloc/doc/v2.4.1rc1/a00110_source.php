...
<div class="line"><a name="l00044"></a><span class="lineno"><a class="line" href="a00184.php#ga630e699c56b5f3d2e534b475944c216e">   44</a></span>&#160;HWLOC_DECLSPEC <span class="keywordtype">int</span> <a class="code" href="a00184.php#ga630e699c56b5f3d2e534b475944c216e">hwloc_linux_set_tid_cpubind</a>(<a class="code" href="a00156.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, pid_t tid, <a class="code" href="a00153.php#ga1f784433e9b606261f62d1134f6a3b25">hwloc_const_cpuset_t</a> set);</div>
<div class="line"><a name="l00045"></a><span class="lineno">   45</span>&#160; </div>
<div class="line"><a name="l00054"></a><span class="lineno"><a class="line" href="a00184.php#gaddcb985cb56337a4d6693cee72e7bf94">   54</a></span>&#160;HWLOC_DECLSPEC <span class="keywordtype">int</span> <a class="code" href="a00184.php#gaddcb985cb56337a4d6693cee72e7bf94">hwloc_linux_get_tid_cpubind</a>(<a class="code" href="a00156.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, pid_t tid, <a class="code" href="a00153.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set);</div>
<div class="line"><a name="l00055"></a><span class="lineno">   55</span>&#160; </div>
<div class="line"><a name="l00061"></a><span class="lineno"><a class="line" href="a00184.php#gacc7945c2d06c6db1e58f8fd953009134">   61</a></span>&#160;HWLOC_DECLSPEC <span class="keywordtype">int</span> <a class="code" href="a00184.php#gacc7945c2d06c6db1e58f8fd953009134">hwloc_linux_get_tid_last_cpu_location</a>(<a class="code" href="a00156.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, pid_t tid, <a class="code" href="a00175.php#gaa3c2bf4c776d603dcebbb61b0c923d84">hwloc_bitmap_t</a> set);</div>
<div class="line"><a name="l00062"></a><span class="lineno">   62</span>&#160; </div>
<div class="line"><a name="l00070"></a><span class="lineno"><a class="line" href="a00184.php#gaf72d83e273803226ce772973e37b85de">   70</a></span>&#160;HWLOC_DECLSPEC <span class="keywordtype">int</span> <a class="code" href="a00184.php#gaf72d83e273803226ce772973e37b85de">hwloc_linux_read_path_as_cpumask</a>(<span class="keyword">const</span> <span class="keywordtype">char</span> *path, <a class="code" href="a00175.php#gaa3c2bf4c776d603dcebbb61b0c923d84">hwloc_bitmap_t</a> set);</div>
...
<div class="ttc" id="aa00184_php_gaddcb985cb56337a4d6693cee72e7bf94"><div class="ttname"><a href="a00184.php#gaddcb985cb56337a4d6693cee72e7bf94">hwloc_linux_get_tid_cpubind</a></div><div class="ttdeci">int hwloc_linux_get_tid_cpubind(hwloc_topology_t topology, pid_t tid, hwloc_cpuset_t set)</div><div class="ttdoc">Get the current binding of thread tid.</div></div>
...
<div class="ttc" id="aa00184_php_gacc7945c2d06c6db1e58f8fd953009134"><div class="ttname"><a href="a00184.php#gacc7945c2d06c6db1e58f8fd953009134">hwloc_linux_get_tid_last_cpu_location</a></div><div class="ttdeci">int hwloc_linux_get_tid_last_cpu_location(hwloc_topology_t topology, pid_t tid, hwloc_bitmap_t set)</div><div class="ttdoc">Get the last physical CPU where thread tid ran.</div></div>
<?php
