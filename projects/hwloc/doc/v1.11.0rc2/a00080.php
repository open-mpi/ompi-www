...
<p>If some objects of the given type exist in different levels, for instance L1 and L2 caches, or L1i and L1d caches, the function returns HWLOC_TYPE_DEPTH_MULTIPLE. See <a class="el" href="a00091.php#gad108a09ce400222fe45545257d575489" title="Find the depth of cache objects matching cache depth and type. ">hwloc_get_cache_type_depth()</a> in <a class="el" href="a00063_source.php" title="High-level hwloc traversal helpers. ">hwloc/helper.h</a> to better handle this case.</p>
