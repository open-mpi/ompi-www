...
<div class="memproto">
      <table class="memname">
        ...
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">union <a class="el" href="a00201.php">hwloc_obj_attr_u</a> *&#160;</td>
...
<p><code>attrp</code> is only filled if not <code>NULL</code> and if its size specified in <code>attrsize</code> is large enough. It should be at least as large as union <a class="el" href="a00201.php" title="Object type-specific Attributes.">hwloc_obj_attr_u</a>.</p>
