...
<div class="contents">
<div class="textblock"><p>Besides the hierarchy of objects and individual object attributes (see <a class="el" href="a00350.php">Object attributes</a>), hwloc may also expose finer information about the hardware organization.</p>
...
<p>Memory attributes are the low-level solution to selecting target memory. hwloc uses them internally to build Memory Tiers which provide an easy way to distinguish NUMA nodes of different kinds, as explained in <a class="el" href="a00352.php">Heterogeneous Memory</a>.</p>
...
<p>If the operating system provides efficiency information (e.g. Windows 10, MacOS X / Darwin and some Linux kernels), it is used to rank hwloc CPU kinds by efficiency. Otherwise, hwloc implements several heuristics based on frequencies and core types (see HWLOC_CPUKINDS_RANKING in <a class="el" href="a00346.php">Environment Variables</a>).</p>
...
<p>See <a class="el" href="a00170.php">Kinds of CPU cores</a> for details. </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<?php
