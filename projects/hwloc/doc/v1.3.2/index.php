...
<span class="keyword">static</span> <span class="keywordtype">void</span> print_children(<a class="code" href="a00038.php#ga9d1e76ee15a7dee158b786c30b6a6e38" title="Topology context.">hwloc_topology_t</a> topology, <a class="code" href="a00015.php" title="Structure of a topology object.">hwloc_obj_t</a> obj, 
                           <span class="keywordtype">int</span> depth)
{
    ...
    <a class="code" href="a00047.php#ga5c6a61a83f4790b421e2f62e9088446f" title="Stringify a given topology object into a human-readable form.">hwloc_obj_snprintf</a>(<span class="keywordtype">string</span>, <span class="keyword">sizeof</span>(<span class="keywordtype">string</span>), topology, obj, <span class="stringliteral">&quot;#&quot;</span>, 0);
    printf(<span class="stringliteral">&quot;%*s%s\n&quot;</span>, 2*depth, <span class="stringliteral">&quot;&quot;</span>, <span class="keywordtype">string</span>);
    <span class="keywordflow">for</span> (i = 0; i &lt; obj-&gt;<a class="code" href="a00015.php#aac3f6da35c9b57599909a44ce2b716c1" title="Number of children.">arity</a>; i++) {
        print_children(topology, obj-&gt;<a class="code" href="a00015.php#a04d05403da37bfe17cd63b7c7dd07b1f" title="Children, children[0 .. arity -1].">children</a>[i], depth + 1);
    }
}
...
<span class="keywordtype">int</span> main(<span class="keywordtype">void</span>)
{
    ...
    <a class="code" href="a00038.php#ga9d1e76ee15a7dee158b786c30b6a6e38" title="Topology context.">hwloc_topology_t</a> topology;
    <a class="code" href="a00039.php#ga4bbf39b68b6f568fb92739e7c0ea7801" title="A CPU set is a bitmap whose bits are set according to CPU physical OS indexes.">hwloc_cpuset_t</a> cpuset;
    <a class="code" href="a00015.php" title="Structure of a topology object.">hwloc_obj_t</a> obj;

    <span class="comment">/* Allocate and initialize topology object. */</span>
    <a class="code" href="a00042.php#ga5c2d6f476af87005c7bd0811d4548b9f" title="Allocate a topology context.">hwloc_topology_init</a>(&amp;topology);
...
<span class="comment">       Detection. */</span>
    ...
    <a class="code" href="a00042.php#ga91e2e6427b95fb7339c99dbbef996e71" title="Build the actual topology.">hwloc_topology_load</a>(topology);
...
<span class="comment">       in case we need the topology depth later. */</span>
    topodepth = <a class="code" href="a00045.php#ga8c30b0cec55074eb3ed34e4f2a1a9937" title="Get the depth of the hierarchical tree of objects.">hwloc_topology_get_depth</a>(topology);
...
<span class="comment">     *****************************************************************/</span>
    <span class="keywordflow">for</span> (depth = 0; depth &lt; topodepth; depth++) {
        ...
        <span class="keywordflow">for</span> (i = 0; i &lt; <a class="code" href="a00045.php#ga20cfe2456f4cfdd789c9aca6d2fdd69f" title="Returns the width of level at depth depth.">hwloc_get_nbobjs_by_depth</a>(topology, depth); 
             i++) {
            <a class="code" href="a00047.php#ga5c6a61a83f4790b421e2f62e9088446f" title="Stringify a given topology object into a human-readable form.">hwloc_obj_snprintf</a>(<span class="keywordtype">string</span>, <span class="keyword">sizeof</span>(<span class="keywordtype">string</span>), topology,
                       <a class="code" href="a00046.php#gaedd78240b0c1108355586a268ec5a697" title="Returns the topology object at logical index idx from depth depth.">hwloc_get_obj_by_depth</a>(topology, depth, i),
...
<span class="comment">     *****************************************************************/</span>
    ...
    print_children(topology, <a class="code" href="a00051.php#ga632edae4a651996895ebde85ea2c1264" title="Returns the top-object of the topology-tree.">hwloc_get_root_obj</a>(topology), 0);

    <span class="comment">/*****************************************************************</span>
<span class="comment">     * Third example:</span>
<span class="comment">     * Print the number of sockets.</span>
<span class="comment">     *****************************************************************/</span>
    depth = <a class="code" href="a00045.php#gaea7c64dd59467f5201ba87712710b14d" title="Returns the depth of objects of type type.">hwloc_get_type_depth</a>(topology, <a class="code" href="a00040.php#ggacd37bb612667dc437d66bfb175a8dc55a1ac6e07775ae4324b3fe9dbd72c785ec" title="Socket, physical package, or chip. In the physical meaning, i.e. that you can add or remove physicall...">HWLOC_OBJ_SOCKET</a>);
    <span class="keywordflow">if</span> (depth == <a class="code" href="a00045.php#ggaf4e663cf42bbe20756b849c6293ef575a0565ab92ab72cb0cec91e23003294aad" title="No object of given type exists in the topology.">HWLOC_TYPE_DEPTH_UNKNOWN</a>) {
        printf(<span class="stringliteral">&quot;*** The number of sockets is unknown\n&quot;</span>);
    } <span class="keywordflow">else</span> {
        printf(<span class="stringliteral">&quot;*** %u socket(s)\n&quot;</span>, 
               <a class="code" href="a00045.php#ga20cfe2456f4cfdd789c9aca6d2fdd69f" title="Returns the width of level at depth depth.">hwloc_get_nbobjs_by_depth</a>(topology, depth));
    }
...
<span class="comment">     *****************************************************************/</span>
    levels = 0;
    size = 0;
    <span class="keywordflow">for</span> (obj = <a class="code" href="a00046.php#ga701f83b2cf0cb8e0acd58cd2dc1c67a2" title="Returns the topology object at logical index idx with type type.">hwloc_get_obj_by_type</a>(topology, <a class="code" href="a00040.php#ggacd37bb612667dc437d66bfb175a8dc55abca6887e80cb291353b0a0c1da83f661" title="Processing Unit, or (Logical) Processor. An execution unit (may share a core with some other logical ...">HWLOC_OBJ_PU</a>, 0);
         obj;
         obj = obj-&gt;<a class="code" href="a00015.php#adc494f6aed939992be1c55cca5822900" title="Parent, NULL if root (system object)">parent</a>)
      <span class="keywordflow">if</span> (obj-&gt;<a class="code" href="a00015.php#acc4f0803f244867e68fe0036800be5de" title="Type of object.">type</a> == <a class="code" href="a00040.php#ggacd37bb612667dc437d66bfb175a8dc55a56ee0b7eca88f363b75b34fdde8c9ddc" title="Data cache. Can be L1, L2, L3, ...">HWLOC_OBJ_CACHE</a>) {
        levels++;
        size += obj-&gt;<a class="code" href="a00015.php#accd40e29f71f19e88db62ea3df02adc8" title="Object type-specific Attributes, may be NULL if no attribute value was found.">attr</a>-&gt;<a class="code" href="a00016.php#ab5a8ae3bf490e6b1071fea53f7382836">cache</a>.<a class="code" href="a00012.php#abe5e788943ed04302976740c829674c0" title="Size of cache in bytes.">size</a>;
      }
...
<span class="comment">     *****************************************************************/</span>
    depth = <a class="code" href="a00050.php#ga0ffafb4c0ae13b9a7541ca820ca34883" title="Returns the depth of objects of type type or below.">hwloc_get_type_or_below_depth</a>(topology, <a class="code" href="a00040.php#ggacd37bb612667dc437d66bfb175a8dc55ac793958f330bca371aa1535de8aff45f" title="Core. A computation unit (may be shared by several logical processors).">HWLOC_OBJ_CORE</a>);

    <span class="comment">/* Get last core. */</span>
    obj = <a class="code" href="a00046.php#gaedd78240b0c1108355586a268ec5a697" title="Returns the topology object at logical index idx from depth depth.">hwloc_get_obj_by_depth</a>(topology, depth,
                   <a class="code" href="a00045.php#ga20cfe2456f4cfdd789c9aca6d2fdd69f" title="Returns the width of level at depth depth.">hwloc_get_nbobjs_by_depth</a>(topology, depth) - 1);
    <span class="keywordflow">if</span> (obj) {
        <span class="comment">/* Get a copy of its cpuset that we may modify. */</span>
        cpuset = <a class="code" href="a00063.php#gaaa4ed76211cd3694dfbea2109fc440be" title="Duplicate bitmap bitmap by allocating a new bitmap and copying bitmap contents.">hwloc_bitmap_dup</a>(obj-&gt;<a class="code" href="a00015.php#a67925e0f2c47f50408fbdb9bddd0790f" title="CPUs covered by this object.">cpuset</a>);

        <span class="comment">/* Get only one logical processor (in case the core is</span>
<span class="comment">           SMT/hyperthreaded). */</span>
        <a class="code" href="a00063.php#ga4630aa1b7e08eac5b41be126194e84a1" title="Keep a single index among those set in bitmap bitmap.">hwloc_bitmap_singlify</a>(cpuset);

        <span class="comment">/* And try to bind ourself there. */</span>
        <span class="keywordflow">if</span> (<a class="code" href="a00048.php#gaf4cc194d5c0d38004a21b9f03522a7e3" title="Bind current process or thread on cpus given in physical bitmap set.">hwloc_set_cpubind</a>(topology, cpuset, 0)) {
            <span class="keywordtype">char</span> *str;
            <span class="keywordtype">int</span> error = errno;
            <a class="code" href="a00063.php#gad3cf87ceb58aa91656756bbb58057320" title="Stringify a bitmap into a newly allocated string.">hwloc_bitmap_asprintf</a>(&amp;str, obj-&gt;<a class="code" href="a00015.php#a67925e0f2c47f50408fbdb9bddd0790f" title="CPUs covered by this object.">cpuset</a>);
        ...
        <a class="code" href="a00063.php#ga8e7035fe555ef96921bfb98e08519bc7" title="Free bitmap bitmap.">hwloc_bitmap_free</a>(cpuset);
    }
...
<span class="comment">     *****************************************************************/</span>
    ...
    n = <a class="code" href="a00045.php#ga0131ab1051011fabfa69d7c1853e716c" title="Returns the width of level type type.">hwloc_get_nbobjs_by_type</a>(topology, <a class="code" href="a00040.php#ggacd37bb612667dc437d66bfb175a8dc55aaf0964881117bdedf1a5e9332cd120dd" title="NUMA node. A set of processors around memory which the processors can directly access.">HWLOC_OBJ_NODE</a>);
    <span class="keywordflow">if</span> (n) {
        <span class="keywordtype">void</span> *m;
        size = 1024*1024;

        obj = <a class="code" href="a00046.php#ga701f83b2cf0cb8e0acd58cd2dc1c67a2" title="Returns the topology object at logical index idx with type type.">hwloc_get_obj_by_type</a>(topology, <a class="code" href="a00040.php#ggacd37bb612667dc437d66bfb175a8dc55aaf0964881117bdedf1a5e9332cd120dd" title="NUMA node. A set of processors around memory which the processors can directly access.">HWLOC_OBJ_NODE</a>, n - 1);
        m = <a class="code" href="a00049.php#gaeaa00714a9c4319bda0a74ca6f8720e8" title="Allocate some memory on the given physical nodeset nodeset.">hwloc_alloc_membind_nodeset</a>(topology, size, obj-&gt;<a class="code" href="a00015.php#a08f0d0e16c619a6e653526cbee4ffea3" title="NUMA nodes covered by this object or containing this object.">nodeset</a>,
                <a class="code" href="a00049.php#ggac9764f79505775d06407b40f5e4661e8a18675bb80ebc1bce5b652e9de8f3998c" title="Reset the memory allocation policy to the system default.">HWLOC_MEMBIND_DEFAULT</a>, 0);
        <a class="code" href="a00049.php#ga986d9b4cc76da592c4b937c6cb7d9d56" title="Free memory that was previously allocated by hwloc_alloc() or hwloc_alloc_membind().">hwloc_free</a>(topology, m, size);

        m = malloc(size);
        <a class="code" href="a00049.php#gade5e2c28ea8475a479bf2b1df36c6ccd" title="Bind the already-allocated memory identified by (addr, len) to the NUMA node(s) in physical nodeset...">hwloc_set_area_membind_nodeset</a>(topology, m, size, obj-&gt;<a class="code" href="a00015.php#a08f0d0e16c619a6e653526cbee4ffea3" title="NUMA nodes covered by this object or containing this object.">nodeset</a>,
                <a class="code" href="a00049.php#ggac9764f79505775d06407b40f5e4661e8a18675bb80ebc1bce5b652e9de8f3998c" title="Reset the memory allocation policy to the system default.">HWLOC_MEMBIND_DEFAULT</a>, 0);
        free(m);
    }

    <span class="comment">/* Destroy topology object. */</span>
    <a class="code" href="a00042.php#ga6040925d3ee4bbb2647f2a321aca5f4b" title="Terminate and free a topology context.">hwloc_topology_destroy</a>(topology);
