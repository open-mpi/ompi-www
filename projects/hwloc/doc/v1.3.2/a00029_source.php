...
<a name="l00050"></a><a class="code" href="a00064.php#ga39454e6013441d32e58ef4c4fcba7e4b">00050</a> <a class="code" href="a00064.php#ga39454e6013441d32e58ef4c4fcba7e4b" title="Convert hwloc CPU set toposet into glibc sched affinity CPU set schedset.">hwloc_cpuset_to_glibc_sched_affinity</a>(<a class="code" href="a00038.php#ga9d1e76ee15a7dee158b786c30b6a6e38" title="Topology context.">hwloc_topology_t</a> topology , <a class="code" href="a00039.php#ga1f784433e9b606261f62d1134f6a3b25" title="A non-modifiable hwloc_cpuset_t.">hwloc_const_cpuset_t</a> hwlocset,
...
<a name="l00056"></a>00056   <a class="code" href="a00063.php#ga3f6861045a8029ade373510ffa727d2a" title="Loop macro iterating on bitmap bitmap.">hwloc_bitmap_foreach_begin</a>(cpu, hwlocset)
<a name="l00057"></a>00057     CPU_SET_S(cpu, schedsetsize, schedset);
<a name="l00058"></a>00058   <a class="code" href="a00063.php#gafcf3246db406218d4e155735b3fa6528" title="End of loop. Needs a terminating &#39;;&#39;.">hwloc_bitmap_foreach_end</a>();
...
<a name="l00063"></a>00063   <a class="code" href="a00063.php#ga3f6861045a8029ade373510ffa727d2a" title="Loop macro iterating on bitmap bitmap.">hwloc_bitmap_foreach_begin</a>(cpu, hwlocset)
<a name="l00064"></a>00064     CPU_SET(cpu, schedset);
<a name="l00065"></a>00065   <a class="code" href="a00063.php#gafcf3246db406218d4e155735b3fa6528" title="End of loop. Needs a terminating &#39;;&#39;.">hwloc_bitmap_foreach_end</a>();
...
<a name="l00078"></a><a class="code" href="a00064.php#ga6df504b2f5440b527be05cdad6b1655e">00078</a> <a class="code" href="a00064.php#ga6df504b2f5440b527be05cdad6b1655e" title="Convert glibc sched affinity CPU set schedset into hwloc CPU set.">hwloc_cpuset_from_glibc_sched_affinity</a>(<a class="code" href="a00038.php#ga9d1e76ee15a7dee158b786c30b6a6e38" title="Topology context.">hwloc_topology_t</a> topology , <a class="code" href="a00039.php#ga4bbf39b68b6f568fb92739e7c0ea7801" title="A CPU set is a bitmap whose bits are set according to CPU physical OS indexes.">hwloc_cpuset_t</a> hwlocset,
...
<a name="l00084"></a>00084 <span class="preprocessor"></span>  <a class="code" href="a00063.php#ga6c540b9fe63b8223b6aba46d56dd63b8" title="Empty the bitmap bitmap.">hwloc_bitmap_zero</a>(hwlocset);
...
<a name="l00090"></a>00090       <a class="code" href="a00063.php#ga497556af0cc34f109ae0277999c074d3" title="Add index id in bitmap bitmap.">hwloc_bitmap_set</a>(hwlocset, cpu);
...
<a name="l00103"></a>00103       <a class="code" href="a00063.php#ga497556af0cc34f109ae0277999c074d3" title="Add index id in bitmap bitmap.">hwloc_bitmap_set</a>(hwlocset, cpu);
