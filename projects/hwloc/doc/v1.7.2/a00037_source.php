...
<div class="line"><a name="l00052"></a><span class="lineno"><a class="code" href="a00082.php#ga39454e6013441d32e58ef4c4fcba7e4b">   52</a></span>&#160;<a class="code" href="a00082.php#ga39454e6013441d32e58ef4c4fcba7e4b" title="Convert hwloc CPU set toposet into glibc sched affinity CPU set schedset. ">hwloc_cpuset_to_glibc_sched_affinity</a>(<a class="code" href="a00050.php#ga9d1e76ee15a7dee158b786c30b6a6e38" title="Topology context. ">hwloc_topology_t</a> topology __hwloc_attribute_unused, <a class="code" href="a00051.php#ga1f784433e9b606261f62d1134f6a3b25" title="A non-modifiable hwloc_cpuset_t. ">hwloc_const_cpuset_t</a> hwlocset,</div>
...
<div class="line"><a name="l00058"></a><span class="lineno">   58</span>&#160;  <a class="code" href="a00077.php#ga3f6861045a8029ade373510ffa727d2a" title="Loop macro iterating on bitmap bitmap. ">hwloc_bitmap_foreach_begin</a>(cpu, hwlocset)</div>
<div class="line"><a name="l00059"></a><span class="lineno">   59</span>&#160;    CPU_SET_S(cpu, schedsetsize, schedset);</div>
<div class="line"><a name="l00060"></a><span class="lineno">   60</span>&#160;  <a class="code" href="a00077.php#gafcf3246db406218d4e155735b3fa6528">hwloc_bitmap_foreach_end</a>();</div>
...
<div class="line"><a name="l00065"></a><span class="lineno">   65</span>&#160;  <a class="code" href="a00077.php#ga3f6861045a8029ade373510ffa727d2a" title="Loop macro iterating on bitmap bitmap. ">hwloc_bitmap_foreach_begin</a>(cpu, hwlocset)</div>
<div class="line"><a name="l00066"></a><span class="lineno">   66</span>&#160;    CPU_SET(cpu, schedset);</div>
<div class="line"><a name="l00067"></a><span class="lineno">   67</span>&#160;  <a class="code" href="a00077.php#gafcf3246db406218d4e155735b3fa6528">hwloc_bitmap_foreach_end</a>();</div>
...
<div class="line"><a name="l00079"></a><span class="lineno">   79</span>&#160;<span class="keyword">static</span> __hwloc_inline <span class="keywordtype">int</span></div>
<div class="line"><a name="l00080"></a><span class="lineno"><a class="code" href="a00082.php#ga6df504b2f5440b527be05cdad6b1655e">   80</a></span>&#160;<a class="code" href="a00082.php#ga6df504b2f5440b527be05cdad6b1655e" title="Convert glibc sched affinity CPU set schedset into hwloc CPU set. ">hwloc_cpuset_from_glibc_sched_affinity</a>(<a class="code" href="a00050.php#ga9d1e76ee15a7dee158b786c30b6a6e38" title="Topology context. ">hwloc_topology_t</a> topology __hwloc_attribute_unused, <a class="code" href="a00051.php#ga4bbf39b68b6f568fb92739e7c0ea7801" title="A CPU set is a bitmap whose bits are set according to CPU physical OS indexes. ">hwloc_cpuset_t</a> hwlocset,</div>
...
<div class="line"><a name="l00087"></a><span class="lineno">   87</span>&#160;<span class="preprocessor"></span>  <a class="code" href="a00077.php#ga6c540b9fe63b8223b6aba46d56dd63b8" title="Empty the bitmap bitmap. ">hwloc_bitmap_zero</a>(hwlocset);</div>
...
<div class="line"><a name="l00093"></a><span class="lineno">   93</span>&#160;      <a class="code" href="a00077.php#ga497556af0cc34f109ae0277999c074d3" title="Add index id in bitmap bitmap. ">hwloc_bitmap_set</a>(hwlocset, cpu);</div>
...
<div class="line"><a name="l00105"></a><span class="lineno">  105</span>&#160;      <a class="code" href="a00077.php#ga497556af0cc34f109ae0277999c074d3" title="Add index id in bitmap bitmap. ">hwloc_bitmap_set</a>(hwlocset, cpu);</div>
