...
Functions</h2></td></tr>
<tr class="memitem:ga2ebf84c6c3469626a3716854bc5a7396"><td class="memItemLeft" align="right" valign="top">static __hwloc_inline void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00074.php#ga2ebf84c6c3469626a3716854bc5a7396">hwloc_cpuset_to_nodeset</a> (<a class="el" href="a00050.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="el" href="a00051.php#ga1f784433e9b606261f62d1134f6a3b25">hwloc_const_cpuset_t</a> _cpuset, <a class="el" href="a00051.php#ga37e35730fa7e775b5bb0afe893d6d508">hwloc_nodeset_t</a> nodeset)</td></tr>
<tr class="separator:ga2ebf84c6c3469626a3716854bc5a7396"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gad0752bad15b76ecce4b1ea2faacacc31"><td class="memItemLeft" align="right" valign="top">static __hwloc_inline void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00074.php#gad0752bad15b76ecce4b1ea2faacacc31">hwloc_cpuset_to_nodeset_strict</a> (struct hwloc_topology *topology, <a class="el" href="a00051.php#ga1f784433e9b606261f62d1134f6a3b25">hwloc_const_cpuset_t</a> _cpuset, <a class="el" href="a00051.php#ga37e35730fa7e775b5bb0afe893d6d508">hwloc_nodeset_t</a> nodeset)</td></tr>
<tr class="separator:gad0752bad15b76ecce4b1ea2faacacc31"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga24a1861482add2e8e6d6f787f1f8a2d4"><td class="memItemLeft" align="right" valign="top">static __hwloc_inline void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00074.php#ga24a1861482add2e8e6d6f787f1f8a2d4">hwloc_cpuset_from_nodeset</a> (<a class="el" href="a00050.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="el" href="a00051.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> _cpuset, <a class="el" href="a00051.php#ga2f5276235841ad66a79bedad16a5a10c">hwloc_const_nodeset_t</a> nodeset)</td></tr>
<tr class="separator:ga24a1861482add2e8e6d6f787f1f8a2d4"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gaf4cf4f965f174babea7ba1c6db0330fb"><td class="memItemLeft" align="right" valign="top">static __hwloc_inline void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00074.php#gaf4cf4f965f174babea7ba1c6db0330fb">hwloc_cpuset_from_nodeset_strict</a> (struct hwloc_topology *topology, <a class="el" href="a00051.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> _cpuset, <a class="el" href="a00051.php#ga2f5276235841ad66a79bedad16a5a10c">hwloc_const_nodeset_t</a> nodeset)</td></tr>
...
<p>This is the strict variant of <a class="el" href="a00074.php#ga24a1861482add2e8e6d6f787f1f8a2d4" title="Convert a NUMA node set into a CPU set and handle non-NUMA cases. ">hwloc_cpuset_from_nodeset</a>. It does not fix non-NUMA cases. If the topology contains some NUMA nodes, behave exactly the same. However, if the topology contains no NUMA nodes, return an empty cpuset. </p>
...
<p>This is the strict variant of <a class="el" href="a00074.php#ga2ebf84c6c3469626a3716854bc5a7396" title="Convert a CPU set into a NUMA node set and handle non-NUMA cases. ">hwloc_cpuset_to_nodeset</a>. It does not fix non-NUMA cases. If the topology contains some NUMA nodes, behave exactly the same. However, if the topology contains no NUMA nodes, return an empty nodeset. </p>
