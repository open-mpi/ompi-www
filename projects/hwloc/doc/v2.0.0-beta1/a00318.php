...
<div class="title">hwloc_disc_component Struct Reference<div class="ingroups"><a class="el" href="a00203.php">Components and Plugins: Discovery components</a></div></div>  </div>
</div><!--header-->
<div class="contents">
...
<tr class="memitem:ad070350354cbd665803fc86fe48cdb3d"><td class="memItemLeft" align="right" valign="top"><a class="el" href="a00203.php#ga5c6112c1a7497e5f481b9634059d47b1">hwloc_disc_component_type_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00318.php#ad070350354cbd665803fc86fe48cdb3d">type</a></td></tr>
<tr class="separator:ad070350354cbd665803fc86fe48cdb3d"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a4064c3b5d9213027e87caebef380a840"><td class="memItemLeft" align="right" valign="top">const char *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00318.php#a4064c3b5d9213027e87caebef380a840">name</a></td></tr>
<tr class="separator:a4064c3b5d9213027e87caebef380a840"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a34144f4d59bf46524e4875194652412b"><td class="memItemLeft" align="right" valign="top">unsigned&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00318.php#a34144f4d59bf46524e4875194652412b">excludes</a></td></tr>
<tr class="separator:a34144f4d59bf46524e4875194652412b"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ab8390b4bc16e44d5dfcbc35f38065eb7"><td class="memItemLeft" align="right" valign="top">struct <a class="el" href="a00322.php">hwloc_backend</a> *(*&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00318.php#ab8390b4bc16e44d5dfcbc35f38065eb7">instantiate</a> )(struct <a class="el" href="a00318.php">hwloc_disc_component</a> *component, const void *data1, const void *data2, const void *data3)</td></tr>
<tr class="separator:ab8390b4bc16e44d5dfcbc35f38065eb7"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ae86d283c272c5ae24073a235efbf6b59"><td class="memItemLeft" align="right" valign="top">unsigned&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00318.php#ae86d283c272c5ae24073a235efbf6b59">priority</a></td></tr>
<tr class="separator:ae86d283c272c5ae24073a235efbf6b59"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ace80cafe2b1732b047b3fc3da47e6517"><td class="memItemLeft" align="right" valign="top">unsigned&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00318.php#ace80cafe2b1732b047b3fc3da47e6517">enabled_by_default</a></td></tr>
...
<p>Component types to exclude, as an OR'ed set of <a class="el" href="a00203.php#ga0dceb95fada01e5e4558429912053ca7" title="Discovery component type. ">hwloc_disc_component_type_e</a>. </p>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">struct <a class="el" href="a00322.php">hwloc_backend</a>*(* hwloc_disc_component::instantiate) (struct <a class="el" href="a00318.php">hwloc_disc_component</a> *component, const void *data1, const void *data2, const void *data3)</td>
        </tr>
      </table>
</div><div class="memdoc">

<p>Instantiate callback to create a backend from the component. Parameters data1, data2, data3 are NULL except for components that have special enabling routines such as <a class="el" href="a00171.php#ga879439b7ee99407ee911b3ac64e9a25e" title="Enable XML-file based topology. ">hwloc_topology_set_xml()</a>. </p>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname"><a class="el" href="a00203.php#ga5c6112c1a7497e5f481b9634059d47b1">hwloc_disc_component_type_t</a> hwloc_disc_component::type</td>
        </tr>
      </table>
</div><div class="memdoc">
