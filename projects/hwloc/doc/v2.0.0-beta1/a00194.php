...
Functions</h2></td></tr>
<tr class="memitem:ga1084285e8ff8b7df91c28917637481c6"><td class="memItemLeft" align="right" valign="top">static int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00194.php#ga1084285e8ff8b7df91c28917637481c6">hwloc_cuda_get_device_pci_ids</a> (<a class="el" href="a00165.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, CUdevice cudevice, int *domain, int *bus, int *dev)</td></tr>
<tr class="separator:ga1084285e8ff8b7df91c28917637481c6"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gaec41c6b4dc3361156beb7dea2a74f5a3"><td class="memItemLeft" align="right" valign="top">static int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00194.php#gaec41c6b4dc3361156beb7dea2a74f5a3">hwloc_cuda_get_device_cpuset</a> (<a class="el" href="a00165.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, CUdevice cudevice, <a class="el" href="a00162.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</td></tr>
<tr class="separator:gaec41c6b4dc3361156beb7dea2a74f5a3"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga11fed607fa404e29e8da010f3ec128e4"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00164.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00194.php#ga11fed607fa404e29e8da010f3ec128e4">hwloc_cuda_get_device_pcidev</a> (<a class="el" href="a00165.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, CUdevice cudevice)</td></tr>
<tr class="separator:ga11fed607fa404e29e8da010f3ec128e4"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga252cb72175f1a2d682f883a0add80a66"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00164.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00194.php#ga252cb72175f1a2d682f883a0add80a66">hwloc_cuda_get_device_osdev</a> (<a class="el" href="a00165.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, CUdevice cudevice)</td></tr>
<tr class="separator:ga252cb72175f1a2d682f883a0add80a66"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga12ee892994ed037e8f64bbffda02cf2e"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00164.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00194.php#ga12ee892994ed037e8f64bbffda02cf2e">hwloc_cuda_get_device_osdev_by_index</a> (<a class="el" href="a00165.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, unsigned idx)</td></tr>
...
<p>The function only returns the locality of the device. If more information about the device is needed, OS objects should be used instead, see <a class="el" href="a00194.php#ga252cb72175f1a2d682f883a0add80a66" title="Get the hwloc OS device object corresponding to CUDA device cudevice. ">hwloc_cuda_get_device_osdev()</a> and <a class="el" href="a00194.php#ga12ee892994ed037e8f64bbffda02cf2e" title="Get the hwloc OS device object corresponding to the CUDA device whose index is idx. ">hwloc_cuda_get_device_osdev_by_index()</a>.</p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00164.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_cuda_get_device_osdev </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00165.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00164.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_cuda_get_device_osdev_by_index </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00165.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
...
<dd>
This function is identical to <a class="el" href="a00195.php#gac0f3eeaf7712919f298097b1a21307b0" title="Get the hwloc OS device object corresponding to the CUDA device whose index is idx. ">hwloc_cudart_get_device_osdev_by_index()</a>. </dd></dl>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00164.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_cuda_get_device_pcidev </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00165.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
