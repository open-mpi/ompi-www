...
<p>For now, only InfiniBand (See <a class="el" href="a00342.php#netloc_setup">Setup</a>) is supported, but it is planned to be extended it very soon.</p>
<p> 
...
<p>Once the JSON file is opened, the rendering is generated by the Javascript vis library for computing the position of the nodes. From the interface, it is possible to search for a specific node, to color the nodes, to expand merged switches, to show statistics, to export as an image...</p>
<div class="image">
