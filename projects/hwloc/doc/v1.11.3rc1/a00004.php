...
hwloc-annotate</h1>
<p>hwloc-annotate may add object attributes such as string information (see <a class="el" href="a00016.php#attributes_info">Custom string infos</a> for details) or Misc children objects. It reads an input topology from a XML file and outputs the annotated topology as another XML file.</p>
...
hwloc-assembler</h1>
<p>hwloc-assembler combines several XML topology files into a single multi-node XML topology. It may then be used later as input with <a class="el" href="a00079.php#ga879439b7ee99407ee911b3ac64e9a25e" title="Enable XML-file based topology. ">hwloc_topology_set_xml()</a> or with the HWLOC_XMLFILE environment variable. See <a class="el" href="a00014.php">Multi-node Topologies</a> for details.</p>
...
<p>Currently only used on Intel Knights Landing Xeon Phi platforms. See <a class="el" href="a00030.php#faq_knl_dump">Why do I need hwloc-dump-hwdata for caches on Intel Knights Landing Xeon Phi?</a>.</p>
