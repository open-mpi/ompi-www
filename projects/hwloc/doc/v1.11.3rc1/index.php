...
<p>Each hwloc object contains a cpuset describing the list of processing units that it contains. These bitmaps may be used for <a class="el" href="a00083.php">CPU binding</a> and <a class="el" href="a00084.php">Memory binding</a>. hwloc offers an extensive bitmap manipulation interface in <a class="el" href="a00057_source.php" title="The bitmap API, for use in hwloc itself. ">hwloc/bitmap.h</a>.</p>
...
<div class="line">        cpuset = <a class="code" href="a00099.php#gae679434c1a5f41d3560a8a7e2c1b0dee">hwloc_bitmap_dup</a>(obj-&gt;<a class="code" href="a00038.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
<div class="line"></div>
...
<div class="line">        <a class="code" href="a00099.php#ga36d802130aa5d96bc1b5a90d2f0f3765">hwloc_bitmap_singlify</a>(cpuset);</div>
<div class="line"></div>
<div class="line">        <span class="comment">/* And try to bind ourself there. */</span></div>
<div class="line">        <span class="keywordflow">if</span> (<a class="code" href="a00083.php#ga80bc07473a8edf840cae17bd7ec21d48">hwloc_set_cpubind</a>(topology, cpuset, 0)) {</div>
<div class="line">            <span class="keywordtype">char</span> *str;</div>
<div class="line">            <span class="keywordtype">int</span> error = errno;</div>
<div class="line">            <a class="code" href="a00099.php#ga0fece972134fdecf2da9bc7a11dd827e">hwloc_bitmap_asprintf</a>(&amp;str, obj-&gt;<a class="code" href="a00038.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
...
<div class="line">        <a class="code" href="a00099.php#ga156130d85b3a0674d6e0e6770fe68fbe">hwloc_bitmap_free</a>(cpuset);</div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
...
<div class="line">        m = <a class="code" href="a00084.php#ga0ff3076f7f3633637699b809bcceceb1">hwloc_alloc_membind_nodeset</a>(topology, size, obj-&gt;<a class="code" href="a00038.php#a08f0d0e16c619a6e653526cbee4ffea3">nodeset</a>,</div>
...
<div class="line">        <a class="code" href="a00084.php#ga32dbd4f54e9e4a7179f2dde37ffe6ad7">hwloc_free</a>(topology, m, size);</div>
<div class="line"></div>
<div class="line">        m = malloc(size);</div>
<div class="line">        <a class="code" href="a00084.php#ga7f11bd709ac0cb93af613e2dd84165ad">hwloc_set_area_membind_nodeset</a>(topology, m, size, obj-&gt;<a class="code" href="a00038.php#a08f0d0e16c619a6e653526cbee4ffea3">nodeset</a>,</div>
<div class="line">                <a class="code" href="a00084.php#ggac9764f79505775d06407b40f5e4661e8ad811fa4b2a6002c4d63695a408ffde2c">HWLOC_MEMBIND_BIND</a>, 0);</div>
