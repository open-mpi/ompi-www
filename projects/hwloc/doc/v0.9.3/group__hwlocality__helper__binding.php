...
<tr><td class="memItemLeft" align="right" valign="top">static inline void&nbsp;</td><td class="memItemRight" valign="bottom"><a class="el" href="group__hwlocality__helper__binding.php#gaea68e92b026930cf5c368e2d98cb6aac">hwloc_distribute</a> (<a class="el" href="group__hwlocality__topology.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="el" href="structhwloc__obj.php">hwloc_obj_t</a> root, <a class="el" href="group__hwlocality__cpuset.php#ga7366332f7090f5b54d4b25a0c2c4b411">hwloc_cpuset_t</a> *cpuset, int n)</td></tr>
<tr><td class="mdescLeft">&nbsp;</td><td class="mdescRight">Distribute <code>n</code> items over the topology under <code>root</code>.  <a href="#gaea68e92b026930cf5c368e2d98cb6aac"></a><br/></td></tr>
</table>
<hr/><h2>Function Documentation</h2>
<a class="anchor" id="gaea68e92b026930cf5c368e2d98cb6aac"></a><!-- doxytag: member="helper.h::hwloc_distribute" ref="gaea68e92b026930cf5c368e2d98cb6aac" args="(hwloc_topology_t topology, hwloc_obj_t root, hwloc_cpuset_t *cpuset, int n)" -->
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<p>The caller may typicall want to additionally call <a class="el" href="group__hwlocality__cpuset.php#ga548a6620cce008fc5b1e2110d25135fe" title="Keep a single CPU among those set in CPU set set.">hwloc_cpuset_singlify()</a> before binding a thread, so that it doesn't move at all. </p>
