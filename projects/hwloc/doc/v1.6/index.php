...
shell$ make
shell$ make install
</pre><p>The hwloc command-line tool "lstopo" produces human-readable topology maps, as mentioned above. It can also export maps to the "fig" file format. Support for PDF, Postscript, and PNG exporting is provided if the "Cairo" development package can be found in "lstopo" when hwloc is configured and build.</p>
<p>The hwloc core may also benefit from the following development packages: </p>
<ul>
<li>
pciutils (libpci) for I/O discovery. </li>
<li>
libnuma for memory binding and migration support on Linux. </li>
<li>
libxml2 for full XML import/export support (otherwise, the internal minimalistic parser will only be able to import XML files that were exported by the same hwloc release). See <a class="el" href="a00008.php#xml">Importing and exporting topologies from/to XML files</a> for details. </li>
</ul>
<p>libpci and libxml2 support may be statically built inside the main hwloc library, or as separate dynamically-loaded plugins (see the <a class="el" href="a00012.php#plugins">Components and plugins</a> section).</p>
