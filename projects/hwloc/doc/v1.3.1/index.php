...
<span class="comment">           SMT/hyperthreaded). */</span>
        ...
        <span class="keywordflow">if</span> (<a class="code" href="a00048.php#gaf4cc194d5c0d38004a21b9f03522a7e3" title="Bind current process or thread on cpus given in bitmap set.">hwloc_set_cpubind</a>(topology, cpuset, 0)) {
...
<span class="comment">     *****************************************************************/</span>
    ...
    <span class="keywordflow">if</span> (n) {
        ...
        m = <a class="code" href="a00049.php#gaeaa00714a9c4319bda0a74ca6f8720e8" title="Allocate some memory on the given nodeset nodeset.">hwloc_alloc_membind_nodeset</a>(topology, size, obj-&gt;<a class="code" href="a00015.php#a08f0d0e16c619a6e653526cbee4ffea3" title="NUMA nodes covered by this object or containing this object.">nodeset</a>,
        ...
        m = malloc(size);
        <a class="code" href="a00049.php#gade5e2c28ea8475a479bf2b1df36c6ccd" title="Bind the already-allocated memory identified by (addr, len) to the NUMA node(s) in nodeset...">hwloc_set_area_membind_nodeset</a>(topology, m, size, obj-&gt;<a class="code" href="a00015.php#a08f0d0e16c619a6e653526cbee4ffea3" title="NUMA nodes covered by this object or containing this object.">nodeset</a>,
                <a class="code" href="a00049.php#ggac9764f79505775d06407b40f5e4661e8a18675bb80ebc1bce5b652e9de8f3998c" title="Reset the memory allocation policy to the system default.">HWLOC_MEMBIND_DEFAULT</a>, 0);
        free(m);
    }
