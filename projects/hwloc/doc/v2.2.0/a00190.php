...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">struct <a class="el" href="a00195.php">hwloc_obj</a>* hwloc_pci_find_parent_by_busid </td>
          <td>(</td>
