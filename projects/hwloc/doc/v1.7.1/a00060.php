...
Functions</h2></td></tr>
<tr class="memitem:ga7c61920feca6fd9006d930dabfc09058"><td class="memItemLeft" align="right" valign="top"> const char *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00060.php#ga7c61920feca6fd9006d930dabfc09058">hwloc_obj_type_string</a> (<a class="el" href="a00052.php#gacd37bb612667dc437d66bfb175a8dc55">hwloc_obj_type_t</a> type) </td></tr>
<tr class="separator:ga7c61920feca6fd9006d930dabfc09058"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gade722091ae392fdc79557e797a16c370"><td class="memItemLeft" align="right" valign="top"> <a class="el" href="a00052.php#gacd37bb612667dc437d66bfb175a8dc55">hwloc_obj_type_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00060.php#gade722091ae392fdc79557e797a16c370">hwloc_obj_type_of_string</a> (const char *string) </td></tr>
<tr class="separator:gade722091ae392fdc79557e797a16c370"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga3ad856e8f3487d340c82a23b8a2a0351"><td class="memItemLeft" align="right" valign="top"> int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00060.php#ga3ad856e8f3487d340c82a23b8a2a0351">hwloc_obj_type_snprintf</a> (char *restrict string, size_t size, <a class="el" href="a00053.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj, int verbose)</td></tr>
<tr class="separator:ga3ad856e8f3487d340c82a23b8a2a0351"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga0db8286d7f3ceda8defd76e3e1e2b284"><td class="memItemLeft" align="right" valign="top"> int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00060.php#ga0db8286d7f3ceda8defd76e3e1e2b284">hwloc_obj_attr_snprintf</a> (char *restrict string, size_t size, <a class="el" href="a00053.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj, const char *restrict separator, int verbose)</td></tr>
<tr class="separator:ga0db8286d7f3ceda8defd76e3e1e2b284"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga5c6a61a83f4790b421e2f62e9088446f"><td class="memItemLeft" align="right" valign="top"> int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00060.php#ga5c6a61a83f4790b421e2f62e9088446f">hwloc_obj_snprintf</a> (char *restrict string, size_t size, <a class="el" href="a00050.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="el" href="a00053.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj, const char *restrict indexprefix, int verbose)</td></tr>
<tr class="separator:ga5c6a61a83f4790b421e2f62e9088446f"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gabbfb92224c992c0e2ecef6b6e45260f2"><td class="memItemLeft" align="right" valign="top"> int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00060.php#gabbfb92224c992c0e2ecef6b6e45260f2">hwloc_obj_cpuset_snprintf</a> (char *restrict str, size_t size, size_t nobj, const <a class="el" href="a00053.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> *restrict objs)</td></tr>
<tr class="separator:gabbfb92224c992c0e2ecef6b6e45260f2"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga2a12b2450489675bd5759dc47cbc51ed"><td class="memItemLeft" align="right" valign="top">static inline const char *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00060.php#ga2a12b2450489675bd5759dc47cbc51ed">hwloc_obj_get_info_by_name</a> (<a class="el" href="a00053.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj, const char *name) </td></tr>
<tr class="separator:ga2a12b2450489675bd5759dc47cbc51ed"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gaba3afe636940872772ed6dfaf0b3552e"><td class="memItemLeft" align="right" valign="top"> void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00060.php#gaba3afe636940872772ed6dfaf0b3552e">hwloc_obj_add_info</a> (<a class="el" href="a00053.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj, const char *name, const char *value)</td></tr>
...
<div class="memproto">
      <table class="memname">
        ...
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">const <a class="el" href="a00053.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> *restrict&#160;</td>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname"> <a class="el" href="a00052.php#gacd37bb612667dc437d66bfb175a8dc55">hwloc_obj_type_t</a> hwloc_obj_type_of_string </td>
          <td>(</td>
          <td class="paramtype">const char *&#160;</td>
