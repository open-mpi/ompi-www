...
<p>Some platforms report similar warnings about conflicting Sockets and NUMANodes. Upgrading the BIOS and/or the operating system may help. Otherwise, the warning may be hidden by setting HWLOC_HIDE_ERRORS=1 in your environment.</p>
...
#endif
</pre><p>You should not try to remain compatible with very old releases such as 1.1.x or earlier because <code>HWLOC_API_VERSION</code> was added in 1.0.0 and <code><a class="el" href="a00072.php#ga9c0b50c98add1adf57ed1ce85bb5190d" title="Indicate at runtime which hwloc API version was used at build time. ">hwloc_get_api_version()</a></code> came only in 1.1.1. Also do not use the old cpuset API since it was deprecated and superseded by the bitmap API in 1.1, and later removed in 1.5.</p>
