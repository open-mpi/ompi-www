...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the default memory binding policy of the current process or thread to prefer the NUMA node(s) specified by <code>nodeset</code>.  <a href="#ga747962cbb16fd12ad6d126011c734a27"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the default memory binding policy of the current process or thread to prefer the NUMA node(s) near the specified <code>cpuset</code>.  <a href="#ga8b6d1d90227aff8e44ef26bc1f8a8f95"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Query the default memory binding policy and locality of the current process or thread.  <a href="#ga7b46a4ca0b2db9723ca73b0c148ccd93"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Query the default memory binding policy and locality of the current process or thread (the locality is returned in <code>cpuset</code> as CPUs near the locality's actual NUMA node(s)).  <a href="#gab07aedba1119f99130e5f0b796b7d8a5"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the default memory binding policy of the specified process to prefer the NUMA node(s) specified by <code>nodeset</code>.  <a href="#gaf10d18cd4703ec980d7440a1c23fa07f"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Set the default memory binding policy of the specified process to prefer the NUMA node(s) near the specified <code>cpuset</code>.  <a href="#gac63c4517e71b3f0d41b3dee3e83dc55c"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Query the default memory binding policy and locality of the specified process.  <a href="#ga22074ed072e1039f74f17f7b16e9e39d"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Query the default memory binding policy and locality of the specified process (the locality is returned in <code>cpuset</code> as CPUs near the locality's actual NUMA node(s)).  <a href="#gabaf9c13f1fa301d6895594cec52226e2"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Bind the already-allocated memory identified by (addr, len) to the NUMA node(s) in <code>nodeset</code>.  <a href="#gade5e2c28ea8475a479bf2b1df36c6ccd"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Bind the already-allocated memory identified by (addr, len) to the NUMA node(s) near <code>cpuset</code>.  <a href="#ga06594edeb4728cb9e014aed924d1e74a"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Query the NUMA node(s) and binding policy of the memory identified by (<code>addr</code>, <code>len</code> ).  <a href="#ga106e6fcd764d17be682faf7a5bc95720"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Query the CPUs near the NUMA node(s) and binding policy of the memory identified by (<code>addr</code>, <code>len</code> ).  <a href="#gac02ee8f7606382ea7855ae4e1656ed0f"></a><br/></td></tr>
...
<div class="fragment"><pre class="fragment"> <a class="code" href="group__hwlocality__helper__binding.php#ga6178c6a9ec1dd88ec9f6a9fcdcc7d634" title="Allocate some memory on the memory nodes near given cpuset cpuset.">hwloc_alloc_membind_policy</a>(topology, size, <span class="keyword">set</span>, 
...
<dl class="note"><dt><b>Note:</b></dt><dd>Not all systems support all kinds of binding. See the "Detailed Description" section of <a class="el" href="group__hwlocality__membinding.php">Memory binding</a> for a description of errors that can occur. </dd></dl>
...
<dl class="note"><dt><b>Note:</b></dt><dd>The allocated memory should be freed with <a class="el" href="group__hwlocality__membinding.php#ga986d9b4cc76da592c4b937c6cb7d9d56" title="Free memory that was previously allocated by hwloc_alloc() or hwloc_alloc_membind().">hwloc_free()</a>. </dd></dl>
...
<p>Free memory that was previously allocated by <a class="el" href="group__hwlocality__membinding.php#gac5586e58cf25c3596b7d4aa31ce13259" title="Allocate some memory.">hwloc_alloc()</a> or <a class="el" href="group__hwlocality__membinding.php#ga221a7edc5d436300374fa16463f607e5" title="Allocate some memory on memory nodes near the given cpuset cpuset.">hwloc_alloc_membind()</a>. </p>
