...
Functions</h2></td></tr>
<tr class="memitem:ga706f71cfea09d547d2cbafa642d6e03b"><td class="memItemLeft" align="right" valign="top">unsigned&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00193.php#ga706f71cfea09d547d2cbafa642d6e03b">hwloc_pcidisc_find_cap</a> (const unsigned char *config, unsigned cap)</td></tr>
<tr class="separator:ga706f71cfea09d547d2cbafa642d6e03b"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga51d1ebcbf9729987c9d17df3aa57d209"><td class="memItemLeft" align="right" valign="top">int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00193.php#ga51d1ebcbf9729987c9d17df3aa57d209">hwloc_pcidisc_find_linkspeed</a> (const unsigned char *config, unsigned offset, float *linkspeed)</td></tr>
<tr class="separator:ga51d1ebcbf9729987c9d17df3aa57d209"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga6c55fb80c3d0c8c8e61078b3f38adde8"><td class="memItemLeft" align="right" valign="top"><a class="el" href="a00148.php#gacd37bb612667dc437d66bfb175a8dc55">hwloc_obj_type_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00193.php#ga6c55fb80c3d0c8c8e61078b3f38adde8">hwloc_pcidisc_check_bridge_type</a> (unsigned device_class, const unsigned char *config)</td></tr>
<tr class="separator:ga6c55fb80c3d0c8c8e61078b3f38adde8"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gaa9c06106be847f94675b56fe3bae5771"><td class="memItemLeft" align="right" valign="top">int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00193.php#gaa9c06106be847f94675b56fe3bae5771">hwloc_pcidisc_setup_bridge_attr</a> (<a class="el" href="a00149.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj, const unsigned char *config)</td></tr>
<tr class="separator:gaa9c06106be847f94675b56fe3bae5771"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gab76ddc4f55db8101ef0d44317965128c"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00193.php#gab76ddc4f55db8101ef0d44317965128c">hwloc_pcidisc_tree_insert_by_busid</a> (struct <a class="el" href="a00199.php">hwloc_obj</a> **treep, struct <a class="el" href="a00199.php">hwloc_obj</a> *obj)</td></tr>
<tr class="separator:gab76ddc4f55db8101ef0d44317965128c"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gabda1d6c1799e50b9226f8a4da9bd29ea"><td class="memItemLeft" align="right" valign="top">int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00193.php#gabda1d6c1799e50b9226f8a4da9bd29ea">hwloc_pcidisc_tree_attach</a> (struct hwloc_topology *topology, struct <a class="el" href="a00199.php">hwloc_obj</a> *tree)</td></tr>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname"><a class="el" href="a00148.php#gacd37bb612667dc437d66bfb175a8dc55">hwloc_obj_type_t</a> hwloc_pcidisc_check_bridge_type </td>
          <td>(</td>
...
<div class="memproto">
      <table class="memname">
        ...
        <tr>
          <td class="paramkey"></td>
          <td></td>
          <td class="paramtype">struct <a class="el" href="a00199.php">hwloc_obj</a> *&#160;</td>
...
<p>In the meantime, other backends lookup PCI objects or localities (for instance to attach OS devices) by using <a class="el" href="a00194.php#gaca16b7b2b5f49661f6325fb976587053" title="Find the PCI object that matches the bus ID. ">hwloc_pcidisc_find_by_busid()</a> or <a class="el" href="a00194.php#gae7bdb4e2edf12e206191c7e95b2fce4a" title="Find the normal parent of a PCI bus ID. ">hwloc_pcidisc_find_busid_parent()</a>. </p>
