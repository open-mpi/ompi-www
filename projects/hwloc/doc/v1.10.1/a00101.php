...
Functions</h2></td></tr>
<tr class="memitem:gafd853fd67e12c32916201d8303ef39d2"><td class="memItemLeft" align="right" valign="top">struct <a class="el" href="a00036.php">hwloc_obj</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00101.php#gafd853fd67e12c32916201d8303ef39d2">hwloc_insert_object_by_cpuset</a> (struct hwloc_topology *topology, <a class="el" href="a00075.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj)</td></tr>
<tr class="separator:gafd853fd67e12c32916201d8303ef39d2"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga3ae154590328522a864f4a7fb453b562"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00101.php#ga3ae154590328522a864f4a7fb453b562">hwloc_report_os_error</a> (const char *msg, int line)</td></tr>
<tr class="separator:ga3ae154590328522a864f4a7fb453b562"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gab527c1e0f243f057d31a724794ad9f88"><td class="memItemLeft" align="right" valign="top">int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00101.php#gab527c1e0f243f057d31a724794ad9f88">hwloc_hide_errors</a> (void)</td></tr>
<tr class="separator:gab527c1e0f243f057d31a724794ad9f88"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga56d4e5fec377bf09f136b4e8e280e30f"><td class="memItemLeft" align="right" valign="top">struct <a class="el" href="a00036.php">hwloc_obj</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00101.php#ga56d4e5fec377bf09f136b4e8e280e30f">hwloc__insert_object_by_cpuset</a> (struct hwloc_topology *topology, <a class="el" href="a00075.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj, <a class="el" href="a00101.php#gac2286a3c84a2417f72400bd65bccb99e">hwloc_report_error_t</a> report_error)</td></tr>
<tr class="separator:ga56d4e5fec377bf09f136b4e8e280e30f"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga0ef97debde503b56367689b07bb3e901"><td class="memItemLeft" align="right" valign="top">void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00101.php#ga0ef97debde503b56367689b07bb3e901">hwloc_insert_object_by_parent</a> (struct hwloc_topology *topology, <a class="el" href="a00075.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> parent, <a class="el" href="a00075.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj)</td></tr>
<tr class="separator:ga0ef97debde503b56367689b07bb3e901"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga64d210fcfd7e517095319420bf40ed0a"><td class="memItemLeft" align="right" valign="top">static struct <a class="el" href="a00036.php">hwloc_obj</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00101.php#ga64d210fcfd7e517095319420bf40ed0a">hwloc_alloc_setup_object</a> (<a class="el" href="a00074.php#gacd37bb612667dc437d66bfb175a8dc55">hwloc_obj_type_t</a> type, signed os_index)</td></tr>
<tr class="separator:ga64d210fcfd7e517095319420bf40ed0a"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gabb240e5b856a34963078ccec9a785ac1"><td class="memItemLeft" align="right" valign="top">int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00101.php#gabb240e5b856a34963078ccec9a785ac1">hwloc_fill_object_sets</a> (<a class="el" href="a00075.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj)</td></tr>
<tr class="separator:gabb240e5b856a34963078ccec9a785ac1"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gac2eaed287bb215cf0bd33014e9e1d374"><td class="memItemLeft" align="right" valign="top">static int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00101.php#gac2eaed287bb215cf0bd33014e9e1d374">hwloc_plugin_check_namespace</a> (const char *pluginname, const char *symbol)</td></tr>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">struct <a class="el" href="a00036.php">hwloc_obj</a>* hwloc__insert_object_by_cpuset </td>
          <td>(</td>
...
<p>Aside from the error callback selection, this function is identical to <a class="el" href="a00101.php#gafd853fd67e12c32916201d8303ef39d2" title="Add an object to the topology. ">hwloc_insert_object_by_cpuset()</a> </p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static struct <a class="el" href="a00036.php">hwloc_obj</a>* hwloc_alloc_setup_object </td>
          <td>(</td>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname">struct <a class="el" href="a00036.php">hwloc_obj</a>* hwloc_insert_object_by_cpuset </td>
          <td>(</td>
          <td class="paramtype">struct hwloc_topology *&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
...
<p>In case of error, <a class="el" href="a00101.php#ga3ae154590328522a864f4a7fb453b562" title="Report an insertion error from a backend. ">hwloc_report_os_error()</a> is called.</p>
