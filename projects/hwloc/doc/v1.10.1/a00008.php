...
<li>
functions that allocate memory bound to specific node set without changing the current memory binding policy (if supported): <a class="el" href="a00081.php#ga1058b0b9216bc6fd9c3734ea9dca1e54" title="Allocate some memory on memory nodes near the given physical cpuset cpuset. ">hwloc_alloc_membind()</a> and <a class="el" href="a00081.php#ga0ff3076f7f3633637699b809bcceceb1" title="Allocate some memory on the given physical nodeset nodeset. ">hwloc_alloc_membind_nodeset()</a>. </li>
<li>
helpers which, if needed, change the current memory binding policy of the process in order to obtain memory binding: <a class="el" href="a00081.php#ga4f7240065719cf923eb0cc078afcdcc2" title="Allocate some memory on the memory nodes near given cpuset cpuset. ">hwloc_alloc_membind_policy()</a> and <a class="el" href="a00081.php#ga7d473e80f11d774421688e36e9926136" title="Allocate some memory on the given nodeset nodeset. ">hwloc_alloc_membind_policy_nodeset()</a> </li>
</ul>
...
<p>See <a class="el" href="a00080.php">CPU binding</a> and <a class="el" href="a00081.php">Memory binding</a> for hwloc's API functions regarding CPU and memory binding, respectively. There are some examples under doc/examples/ in the source tree. </p>
</div></div><!-- contents -->
<?php
