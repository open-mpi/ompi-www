...
API Example</h2>
<p>The following small C example (named ``hwloc-hello.c'') prints the topology of the machine and bring the process to the first logical processor of the second core of the machine. More examples are available in the doc/examples/ directory of the source tree.</p>
...
<div class="line"><span class="comment"> *</span></div>
<div class="line"><span class="comment"> * Copyright © 2009-2014 Inria.  All rights reserved.</span></div>
...
<div class="line">        cpuset = <a class="code" href="a00096.php#gae679434c1a5f41d3560a8a7e2c1b0dee">hwloc_bitmap_dup</a>(obj-&gt;<a class="code" href="a00036.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
<div class="line"></div>
...
<div class="line">        <a class="code" href="a00096.php#ga36d802130aa5d96bc1b5a90d2f0f3765">hwloc_bitmap_singlify</a>(cpuset);</div>
<div class="line"></div>
...
<div class="line">            <a class="code" href="a00096.php#ga0fece972134fdecf2da9bc7a11dd827e">hwloc_bitmap_asprintf</a>(&amp;str, obj-&gt;<a class="code" href="a00036.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
...
<div class="line">        <a class="code" href="a00096.php#ga156130d85b3a0674d6e0e6770fe68fbe">hwloc_bitmap_free</a>(cpuset);</div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
