...
<li>
Each node object has its <code>subtype</code> field set to <code>HBM</code>, <code>DRAM</code> or <code>CXL-DRAM</code> (see other possible values in <a class="el" href="a00349.php#attributes_normal">Normal attributes</a>). </li>
<li>
...
<li>
Then it combines that knowledge with performance metrics exposed by the hardware to guess what's actually DRAM, HBM, etc. These metrics are also exposed in hwloc Memory Attributes, for instance bandwidth and latency, for read and write. See <a class="el" href="a00350.php#topoattrs_memattrs">Memory Attributes</a> and <a class="el" href="a00168.php">Comparing memory node attributes for finding where to allocate on</a> for more details. </li>
</ul>
...
<p>If hwloc fails to build tiers properly, see <code>HWLOC_MEMTIERS</code> and <code>HWLOC_MEMTIERS_GUESS</code> in <a class="el" href="a00345.php">Environment Variables</a>.</p>
