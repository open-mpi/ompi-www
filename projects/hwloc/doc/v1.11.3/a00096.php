...
Functions</h2></td></tr>
<tr class="memitem:ga8fbd641f284673a3e884e8e556044eba"><td class="memItemLeft" align="right" valign="top">static void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00096.php#ga8fbd641f284673a3e884e8e556044eba">hwloc_cpuset_to_nodeset</a> (<a class="el" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="el" href="a00075.php#ga1f784433e9b606261f62d1134f6a3b25">hwloc_const_cpuset_t</a> _cpuset, <a class="el" href="a00075.php#ga37e35730fa7e775b5bb0afe893d6d508">hwloc_nodeset_t</a> nodeset)</td></tr>
<tr class="separator:ga8fbd641f284673a3e884e8e556044eba"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga014490779e7012ffec2b5ccee020c0ae"><td class="memItemLeft" align="right" valign="top">static void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00096.php#ga014490779e7012ffec2b5ccee020c0ae">hwloc_cpuset_to_nodeset_strict</a> (struct hwloc_topology *topology, <a class="el" href="a00075.php#ga1f784433e9b606261f62d1134f6a3b25">hwloc_const_cpuset_t</a> _cpuset, <a class="el" href="a00075.php#ga37e35730fa7e775b5bb0afe893d6d508">hwloc_nodeset_t</a> nodeset)</td></tr>
<tr class="separator:ga014490779e7012ffec2b5ccee020c0ae"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga2ed57313ce5bf85f3ac156932ecf639d"><td class="memItemLeft" align="right" valign="top">static void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00096.php#ga2ed57313ce5bf85f3ac156932ecf639d">hwloc_cpuset_from_nodeset</a> (<a class="el" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="el" href="a00075.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> _cpuset, <a class="el" href="a00075.php#ga2f5276235841ad66a79bedad16a5a10c">hwloc_const_nodeset_t</a> nodeset)</td></tr>
<tr class="separator:ga2ed57313ce5bf85f3ac156932ecf639d"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gacde800e58b8cdb746706b371ca4b97e0"><td class="memItemLeft" align="right" valign="top">static void&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00096.php#gacde800e58b8cdb746706b371ca4b97e0">hwloc_cpuset_from_nodeset_strict</a> (struct hwloc_topology *topology, <a class="el" href="a00075.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> _cpuset, <a class="el" href="a00075.php#ga2f5276235841ad66a79bedad16a5a10c">hwloc_const_nodeset_t</a> nodeset)</td></tr>
...
<a class="anchor" id="ga2ed57313ce5bf85f3ac156932ecf639d"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
...
<a class="anchor" id="gacde800e58b8cdb746706b371ca4b97e0"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
...
<a class="anchor" id="ga014490779e7012ffec2b5ccee020c0ae"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
...
<p>This is the strict variant of <a class="el" href="a00096.php#ga8fbd641f284673a3e884e8e556044eba" title="Convert a CPU set into a NUMA node set and handle non-NUMA cases. ">hwloc_cpuset_to_nodeset()</a>. It does not fix non-NUMA cases. If the topology contains some NUMA nodes, behave exactly the same. However, if the topology contains no NUMA nodes, return an empty nodeset. </p>
