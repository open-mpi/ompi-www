...
<div class="line"><a name="l00047"></a><span class="lineno"><a class="line" href="a00105.php#ga1084285e8ff8b7df91c28917637481c6">   47</a></span>&#160;<a class="code" href="a00105.php#ga1084285e8ff8b7df91c28917637481c6">hwloc_cuda_get_device_pci_ids</a>(<a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
...
<div class="line"><a name="l00092"></a><span class="lineno"><a class="line" href="a00105.php#gaec41c6b4dc3361156beb7dea2a74f5a3">   92</a></span>&#160;<a class="code" href="a00105.php#gaec41c6b4dc3361156beb7dea2a74f5a3">hwloc_cuda_get_device_cpuset</a>(<a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology __hwloc_attribute_unused,</div>
...
<div class="line"><a name="l00102"></a><span class="lineno">  102</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00105.php#ga1084285e8ff8b7df91c28917637481c6">hwloc_cuda_get_device_pci_ids</a>(topology, cudevice, &amp;domainid, &amp;busid, &amp;deviceid))</div>
...
<div class="line"><a name="l00115"></a><span class="lineno">  115</span>&#160;  <a class="code" href="a00100.php#gaa5a608236c3c0757b0b79818f1d429fb">hwloc_linux_parse_cpumap_file</a>(sysfile, set);</div>
<div class="line"><a name="l00116"></a><span class="lineno">  116</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00099.php#ga5b64be28f5a7176ed8ad0d6a90bdf108">hwloc_bitmap_iszero</a>(set))</div>
<div class="line"><a name="l00117"></a><span class="lineno">  117</span>&#160;    <a class="code" href="a00099.php#ga036068a22d1aa5cb9ff1df348b525ff3">hwloc_bitmap_copy</a>(set, <a class="code" href="a00095.php#ga69fbad44c685e46d80ecf51a714ba9ce">hwloc_topology_get_complete_cpuset</a>(topology));</div>
...
<div class="line"><a name="l00122"></a><span class="lineno">  122</span>&#160;  <a class="code" href="a00099.php#ga036068a22d1aa5cb9ff1df348b525ff3">hwloc_bitmap_copy</a>(set, <a class="code" href="a00095.php#ga69fbad44c685e46d80ecf51a714ba9ce">hwloc_topology_get_complete_cpuset</a>(topology));</div>
...
<div class="line"><a name="l00138"></a><span class="lineno"><a class="line" href="a00105.php#ga11fed607fa404e29e8da010f3ec128e4">  138</a></span>&#160;<a class="code" href="a00105.php#ga11fed607fa404e29e8da010f3ec128e4">hwloc_cuda_get_device_pcidev</a>(<a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, CUdevice cudevice)</div>
...
<div class="line"><a name="l00142"></a><span class="lineno">  142</span>&#160;  <span class="keywordflow">if</span> (<a class="code" href="a00105.php#ga1084285e8ff8b7df91c28917637481c6">hwloc_cuda_get_device_pci_ids</a>(topology, cudevice, &amp;domain, &amp;bus, &amp;dev))</div>
<div class="line"><a name="l00143"></a><span class="lineno">  143</span>&#160;    <span class="keywordflow">return</span> NULL;</div>
<div class="line"><a name="l00144"></a><span class="lineno">  144</span>&#160;</div>
<div class="line"><a name="l00145"></a><span class="lineno">  145</span>&#160;  <span class="keywordflow">return</span> <a class="code" href="a00098.php#gacdbaf0db98872e224b7883a84bfb0455">hwloc_get_pcidev_by_busid</a>(topology, domain, bus, dev, 0);</div>
...
<div class="line"><a name="l00162"></a><span class="lineno"><a class="line" href="a00105.php#ga252cb72175f1a2d682f883a0add80a66">  162</a></span>&#160;<a class="code" href="a00105.php#ga252cb72175f1a2d682f883a0add80a66">hwloc_cuda_get_device_osdev</a>(<a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, CUdevice cudevice)</div>
...
<div class="line"><a name="l00167"></a><span class="lineno">  167</span>&#160;        <span class="keywordflow">if</span> (<a class="code" href="a00105.php#ga1084285e8ff8b7df91c28917637481c6">hwloc_cuda_get_device_pci_ids</a>(topology, cudevice, &amp;domain, &amp;bus, &amp;dev))</div>
...
<div class="line"><a name="l00171"></a><span class="lineno">  171</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00098.php#ga8b4584c8949e2c5f1c97ba7fe92b8145">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
...
<div class="line"><a name="l00203"></a><span class="lineno"><a class="line" href="a00105.php#ga12ee892994ed037e8f64bbffda02cf2e">  203</a></span>&#160;<a class="code" href="a00105.php#ga12ee892994ed037e8f64bbffda02cf2e">hwloc_cuda_get_device_osdev_by_index</a>(<a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <span class="keywordtype">unsigned</span> idx)</div>
...
<div class="line"><a name="l00206"></a><span class="lineno">  206</span>&#160;        <span class="keywordflow">while</span> ((osdev = <a class="code" href="a00098.php#ga8b4584c8949e2c5f1c97ba7fe92b8145">hwloc_get_next_osdev</a>(topology, osdev)) != NULL) {</div>
