...
<p>Contrary to <a class="el" href="a00081.php#ga5ca0bf94bbbb080d0eff17a57bd90422" title="Return a constant stringified object type. ">hwloc_obj_type_string()</a>, this function includes object-specific attributes (such as the Group depth, the Bridge type, or OS device type) in the output, and it requires the caller to provide the output buffer.</p>
...
<p>This function is guaranteed to match any string returned by <a class="el" href="a00081.php#ga5ca0bf94bbbb080d0eff17a57bd90422" title="Return a constant stringified object type. ">hwloc_obj_type_string()</a> or <a class="el" href="a00081.php#gadb8765c260edea80c52cd06a76639ba4" title="Stringify the type of a given topology object into a human-readable form. ">hwloc_obj_type_snprintf()</a>.</p>
...
<p><a class="el" href="a00081.php#gadb8765c260edea80c52cd06a76639ba4" title="Stringify the type of a given topology object into a human-readable form. ">hwloc_obj_type_snprintf()</a> may return a more precise output for a specific object, but it requires the caller to provide the output buffer. </p>
