...
<p>The utility <code>hwloc-dump-hwdata</code> is also involved in gathering privileged information at boot time and making it available to non-privileged users. However it only applies to Intel Knights Landing Xeon Phi for now (see <a class="el" href="a00030.php#faq_knl_dump">Why do I need hwloc-dump-hwdata for caches on Intel Knights Landing Xeon Phi?</a>).</p>
