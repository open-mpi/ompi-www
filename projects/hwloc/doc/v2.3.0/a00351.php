...
<p>hwloc topologies may be annotated with Misc objects (of type <code><a class="el" href="a00151.php#ggacd37bb612667dc437d66bfb175a8dc55a19f8a6953fa91efc76bcbcdf2d22de4d" title="Miscellaneous objects (filtered out by default). Objects without particular meaning,...">HWLOC_OBJ_MISC</a></code>) either automatically or by the user. This is an flexible way to annotate topologies with large sets of information since Misc objects may be inserted anywhere in the topology (to annotate specific objects or parts of the topology), even below other Misc objects, and each of them may contain multiple attributes (see also <a class="el" href="a00359.php#faq_annotate">How do I annotate the topology with private notes?</a>).</p>
...
<p>The user may annotate hwloc topologies with its own Misc objects. This can be achieved with <code><a class="el" href="a00161.php#gad980782ade737900c5cf208946768c30" title="Add a MISC object as a leaf of the topology.">hwloc_topology_insert_misc_object()</a></code> as well as hwloc-annotate command-line tool. </p>
</div></div><!-- contents -->
</div><!-- PageDoc -->
<?php
