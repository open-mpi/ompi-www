...
Functions</h2></td></tr>
<tr class="memitem:ga26cf0036d09ec4d7cb692380fac9659d"><td class="memItemLeft" align="right" valign="top">static int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00187.php#ga26cf0036d09ec4d7cb692380fac9659d">hwloc_nvml_get_device_cpuset</a> (<a class="el" href="a00153.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, nvmlDevice_t device, <a class="el" href="a00150.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</td></tr>
<tr class="separator:ga26cf0036d09ec4d7cb692380fac9659d"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gacd50fd0e2766ee05bc13234b46714756"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00152.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00187.php#gacd50fd0e2766ee05bc13234b46714756">hwloc_nvml_get_device_osdev_by_index</a> (<a class="el" href="a00153.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, unsigned idx)</td></tr>
<tr class="separator:gacd50fd0e2766ee05bc13234b46714756"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gaf176159b5760a191871eff23f5a69ee9"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00152.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00187.php#gaf176159b5760a191871eff23f5a69ee9">hwloc_nvml_get_device_osdev</a> (<a class="el" href="a00153.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, nvmlDevice_t device)</td></tr>
...
<p>The function only returns the locality of the device. If more information about the device is needed, OS objects should be used instead, see <a class="el" href="a00187.php#gaf176159b5760a191871eff23f5a69ee9" title="Get the hwloc OS device object corresponding to NVML device device.">hwloc_nvml_get_device_osdev()</a> and <a class="el" href="a00187.php#gacd50fd0e2766ee05bc13234b46714756" title="Get the hwloc OS device object corresponding to the NVML device whose index is idx.">hwloc_nvml_get_device_osdev_by_index()</a>.</p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00152.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_nvml_get_device_osdev </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00153.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
...
<p>Topology <code>topology</code> and device <code>device</code> must match the local machine. I/O devices detection and the NVML component must be enabled in the topology. If not, the locality of the object may still be found using <a class="el" href="a00187.php#ga26cf0036d09ec4d7cb692380fac9659d" title="Get the CPU set of processors that are physically close to NVML device device.">hwloc_nvml_get_device_cpuset()</a>.</p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00152.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_nvml_get_device_osdev_by_index </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00153.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
