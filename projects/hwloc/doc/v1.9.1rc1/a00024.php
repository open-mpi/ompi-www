...
<dt>pci </dt>
<dd>PCI object discovery uses the external pciaccess library (aka libpciaccess), or optionally the pciutils library (libpci), see <a class="el" href="a00010.php">I/O Devices</a>. <b>It may be built as a plugin</b>.  </dd>
<dt>linuxpci </dt>
