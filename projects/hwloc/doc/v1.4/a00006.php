...
<p>One way to manipulate multinode topologies is to retrieve other nodes' topologies as XML files and combine them as a global XML topology. It may then be loaded with <a class="el" href="a00044.php#ga93efcc8a962afe1ed23393700682173f">hwloc_topology_set_xml()</a> or with the HWLOC_XMLFILE environment variable.</p>
