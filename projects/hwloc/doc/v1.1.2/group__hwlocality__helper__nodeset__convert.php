...
<h1>Conversion between cpuset and nodeset</h1>  </div>
</div>
<div class="contents">
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Convert a CPU set into a NUMA node set and handle non-NUMA cases.  <a href="#ga60ecc4ae480c28b5fbd34aca4fc37daa"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Convert a CPU set into a NUMA node set without handling non-NUMA cases.  <a href="#ga9162785e39d7c697f76f99524c4a2fb4"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Convert a NUMA node set into a CPU set and handle non-NUMA cases.  <a href="#gaa677fd588304b5615de4ea78104adfb5"></a><br/></td></tr>
...
<tr><td class="mdescLeft">&#160;</td><td class="mdescRight">Convert a NUMA node set into a CPU set without handling non-NUMA cases.  <a href="#gaa7c3f39802b00a758c58e024a8119979"></a><br/></td></tr>
</table>
...
<p>This is the strict variant of <a class="el" href="group__hwlocality__helper__nodeset__convert.php#gaa677fd588304b5615de4ea78104adfb5" title="Convert a NUMA node set into a CPU set and handle non-NUMA cases.">hwloc_cpuset_from_nodeset</a>. It does not fix non-NUMA cases. If the topology contains some NUMA nodes, behave exactly the same. However, if the topology contains no NUMA nodes, return an empty cpuset. </p>
...
<p>This is the strict variant of <a class="el" href="group__hwlocality__helper__nodeset__convert.php#ga60ecc4ae480c28b5fbd34aca4fc37daa" title="Convert a CPU set into a NUMA node set and handle non-NUMA cases.">hwloc_cpuset_to_nodeset</a>. It does not fix non-NUMA cases. If the topology contains some NUMA nodes, behave exactly the same. However, if the topology contains no NUMA nodes, return an empty nodeset. </p>
