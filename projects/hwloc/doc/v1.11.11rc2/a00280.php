...
hwloc-annotate</h1>
<p>hwloc-annotate may modify object attributes such as string information (see <a class="el" href="a00286.php#attributes_info">Custom string infos</a> for details) or Misc children objects. It reads an input topology from a XML file and outputs the annotated topology as another XML file.</p>
<p> 
...
hwloc-assembler</h1>
<p>hwloc-assembler combines several XML topology files into a single multi-node XML topology. It may then be used later as input with <a class="el" href="a00124.php#ga879439b7ee99407ee911b3ac64e9a25e" title="Enable XML-file based topology. ">hwloc_topology_set_xml()</a> or with the HWLOC_XMLFILE environment variable. See <a class="el" href="a00285.php">Multi-node Topologies</a> for details.</p>
<p> 
...
<p>Currently only used on Intel Xeon Phi processor platforms. See <a class="el" href="a00293.php#faq_knl_dump">Why do I need hwloc-dump-hwdata for memory on Intel Xeon Phi processor?</a>.</p>
