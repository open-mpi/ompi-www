...
<li>
functions that allocate memory bound to specific node set without changing the current memory binding policy (if supported): <a class="el" href="a00054.php#ga221a7edc5d436300374fa16463f607e5" title="Allocate some memory on memory nodes near the given physical cpuset cpuset.">hwloc_alloc_membind()</a> and <a class="el" href="a00054.php#gaeaa00714a9c4319bda0a74ca6f8720e8" title="Allocate some memory on the given physical nodeset nodeset.">hwloc_alloc_membind_nodeset()</a>. </li>
<li>
helpers which, if needed, change the current memory binding policy of the process in order to obtain memory binding: <a class="el" href="a00063.php#ga6178c6a9ec1dd88ec9f6a9fcdcc7d634" title="Allocate some memory on the memory nodes near given cpuset cpuset.">hwloc_alloc_membind_policy()</a> and <a class="el" href="a00063.php#ga3e772fbc4de626ed80f13d332b7d4d03" title="Allocate some memory on the given nodeset nodeset.">hwloc_alloc_membind_policy_nodeset()</a> </li>
</ul>
...
<p>See <a class="el" href="a00053.php">CPU binding</a> and <a class="el" href="a00054.php">Memory binding</a> for hwloc's API functions regarding CPU and memory binding, respectively. </p>
</div></div><!-- contents -->
<?php
