...
Functions</h2></td></tr>
<tr class="memitem:gaa8ea979ce3a9b8c70ae80bc5716a0fbe"><td class="memItemLeft" align="right" valign="top">static inline int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00076.php#gaa8ea979ce3a9b8c70ae80bc5716a0fbe">hwloc_ibv_get_device_cpuset</a> (<a class="el" href="a00042.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology , struct ibv_device *ibdev, <a class="el" href="a00043.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</td></tr>
<tr class="separator:gaa8ea979ce3a9b8c70ae80bc5716a0fbe"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gaa6139e8ce1279bd91867b31b9ff4316b"><td class="memItemLeft" align="right" valign="top">static inline <a class="el" href="a00045.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00076.php#gaa6139e8ce1279bd91867b31b9ff4316b">hwloc_ibv_get_device_osdev_by_name</a> (<a class="el" href="a00042.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, const char *ibname)</td></tr>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static inline <a class="el" href="a00045.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_ibv_get_device_osdev_by_name </td>
          <td>(</td>
...
<p>For the OpenFabrics device whose name is <code>ibname</code>, return the hwloc OS device object describing the device. Returns NULL if there is none.</p>
...
<p>The topology does not necessary have to match the current machine. For instance the topology may be an XML import of a remote host.</p>
