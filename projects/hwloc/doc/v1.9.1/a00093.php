...
Functions</h2></td></tr>
<tr class="memitem:ga07219dc0fd6e4553a658eaa73f038c42"><td class="memItemLeft" align="right" valign="top">static const struct <br class="typebreak" />
<a class="el" href="a00034.php">hwloc_distances_s</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00093.php#ga07219dc0fd6e4553a658eaa73f038c42">hwloc_get_whole_distance_matrix_by_depth</a> (<a class="el" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, unsigned depth)</td></tr>
<tr class="separator:ga07219dc0fd6e4553a658eaa73f038c42"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga64529254be72b3c4343b25926c84b12f"><td class="memItemLeft" align="right" valign="top">static const struct <br class="typebreak" />
<a class="el" href="a00034.php">hwloc_distances_s</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00093.php#ga64529254be72b3c4343b25926c84b12f">hwloc_get_whole_distance_matrix_by_type</a> (<a class="el" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="el" href="a00074.php#gacd37bb612667dc437d66bfb175a8dc55">hwloc_obj_type_t</a> type)</td></tr>
<tr class="separator:ga64529254be72b3c4343b25926c84b12f"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga2d159b21a49964cc629dde03cbf05702"><td class="memItemLeft" align="right" valign="top">static const struct <br class="typebreak" />
<a class="el" href="a00034.php">hwloc_distances_s</a> *&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00093.php#ga2d159b21a49964cc629dde03cbf05702">hwloc_get_distance_matrix_covering_obj_by_depth</a> (<a class="el" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="el" href="a00075.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj, unsigned depth, unsigned *firstp)</td></tr>
<tr class="separator:ga2d159b21a49964cc629dde03cbf05702"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:ga79ed880a55f9d03b4ae58ef5116812d7"><td class="memItemLeft" align="right" valign="top">static int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00093.php#ga79ed880a55f9d03b4ae58ef5116812d7">hwloc_get_latency</a> (<a class="el" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="el" href="a00075.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj1, <a class="el" href="a00075.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> obj2, float *latency, float *reverse_latency)</td></tr>
<tr class="separator:ga79ed880a55f9d03b4ae58ef5116812d7"><td class="memSeparator" colspan="2">&#160;</td></tr>
</table>
<a name="details" id="details"></a><h2 class="groupheader">Detailed Description</h2>
<h2 class="groupheader">Function Documentation</h2>
<a class="anchor" id="ga2d159b21a49964cc629dde03cbf05702"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static const struct <a class="el" href="a00034.php">hwloc_distances_s</a>* hwloc_get_distance_matrix_covering_obj_by_depth </td>
          <td>(</td>
...
<a class="anchor" id="ga79ed880a55f9d03b4ae58ef5116812d7"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
...
<a class="anchor" id="ga07219dc0fd6e4553a658eaa73f038c42"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static const struct <a class="el" href="a00034.php">hwloc_distances_s</a>* hwloc_get_whole_distance_matrix_by_depth </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
...
<a class="anchor" id="ga64529254be72b3c4343b25926c84b12f"></a>
<div class="memitem">
<div class="memproto">
<table class="mlabels">
  <tr>
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static const struct <a class="el" href="a00034.php">hwloc_distances_s</a>* hwloc_get_whole_distance_matrix_by_type </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00076.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
