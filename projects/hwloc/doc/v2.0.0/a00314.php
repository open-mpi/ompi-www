...
hwloc-annotate</h1>
<p>hwloc-annotate may add object attributes such as string information (see <a class="el" href="a00319.php#attributes_info">Custom string infos</a> for details) or Misc children objects. It reads an input topology from a XML file and outputs the annotated topology as another XML file.</p>
<p> 
...
<p>Currently only used on Intel Knights Landing Xeon Phi platforms. See <a class="el" href="a00326.php#faq_knl_dump">Why do I need hwloc-dump-hwdata for memory on Intel Knights Landing Xeon Phi?</a>.</p>
