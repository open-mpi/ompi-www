...
<p>The <a class="el" href="a00144.php#gaa3c2bf4c776d603dcebbb61b0c923d84" title="Set of bits represented as an opaque pointer to an internal bitmap. ">hwloc_bitmap_t</a> type represents a set of objects, typically OS processors &ndash; which may actually be hardware threads (represented by <a class="el" href="a00120.php#ga4bbf39b68b6f568fb92739e7c0ea7801" title="A CPU set is a bitmap whose bits are set according to CPU physical OS indexes. ">hwloc_cpuset_t</a>, which is a typedef for <a class="el" href="a00144.php#gaa3c2bf4c776d603dcebbb61b0c923d84" title="Set of bits represented as an opaque pointer to an internal bitmap. ">hwloc_bitmap_t</a>) &ndash; or memory nodes (represented by <a class="el" href="a00120.php#ga37e35730fa7e775b5bb0afe893d6d508" title="A node set is a bitmap whose bits are set according to NUMA memory node physical OS indexes...">hwloc_nodeset_t</a>, which is also a typedef for <a class="el" href="a00144.php#gaa3c2bf4c776d603dcebbb61b0c923d84" title="Set of bits represented as an opaque pointer to an internal bitmap. ">hwloc_bitmap_t</a>).</p>
<p><em>Both CPU and node sets are always indexed by OS physical number.</em></p>
<dl class="section note"><dt>Note</dt><dd>CPU sets and nodesets are described in <a class="el" href="a00120.php">Object Sets (hwloc_cpuset_t and hwloc_nodeset_t)</a>.</dd></dl>
