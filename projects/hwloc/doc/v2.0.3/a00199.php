...
<p>First I/O child. Bridges, PCI and OS devices are listed here (<code>io_arity</code> and <code>io_first_child</code>) instead of in the normal children list. See also <a class="el" href="a00162.php#gac8a954ed37a4376097234c828068cbef" title="Check whether an object type is Memory. ">hwloc_obj_type_is_io()</a>. </p>
...
<p>First Memory child. NUMA nodes are listed here (<code>memory_arity</code> and <code>memory_first_child</code>) instead of in the normal children list. See also <a class="el" href="a00162.php#ga1d074390c8a3dc3088d84f73fb73f966" title="Check whether an object type is I/O. ">hwloc_obj_type_is_memory()</a>. </p>
