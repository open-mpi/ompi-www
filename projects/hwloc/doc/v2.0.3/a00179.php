...
<p>This function currently only works on AMD OpenCL devices that support the CL_DEVICE_TOPOLOGY_AMD extension. <a class="el" href="a00179.php#gae39352d124cb330eb37b84b418ed6cc5" title="Get the hwloc OS device object corresponding to the OpenCL device for the given indexes. ">hwloc_opencl_get_device_osdev_by_index()</a> should be preferred whenever possible, i.e. when platform and device index are known.</p>
