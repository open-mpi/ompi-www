...
Functions</h2></td></tr>
<tr class="memitem:gacc32737d4648d16b0d292438f210ec90"><td class="memItemLeft" align="right" valign="top">static int&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00149.php#gacc32737d4648d16b0d292438f210ec90">hwloc_opencl_get_device_cpuset</a> (<a class="el" href="a00123.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, cl_device_id device, <a class="el" href="a00120.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> set)</td></tr>
<tr class="separator:gacc32737d4648d16b0d292438f210ec90"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gae39352d124cb330eb37b84b418ed6cc5"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00122.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00149.php#gae39352d124cb330eb37b84b418ed6cc5">hwloc_opencl_get_device_osdev_by_index</a> (<a class="el" href="a00123.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, unsigned platform_index, unsigned device_index)</td></tr>
<tr class="separator:gae39352d124cb330eb37b84b418ed6cc5"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:gadabfa6516aa12e5d8f79b9b4dd9f3cf8"><td class="memItemLeft" align="right" valign="top">static <a class="el" href="a00122.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00149.php#gadabfa6516aa12e5d8f79b9b4dd9f3cf8">hwloc_opencl_get_device_osdev</a> (<a class="el" href="a00123.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, cl_device_id device)</td></tr>
...
<p>The function only returns the locality of the device. If more information about the device is needed, OS objects should be used instead, see <a class="el" href="a00149.php#gadabfa6516aa12e5d8f79b9b4dd9f3cf8" title="Get the hwloc OS device object corresponding to OpenCL device device. ">hwloc_opencl_get_device_osdev()</a> and <a class="el" href="a00149.php#gae39352d124cb330eb37b84b418ed6cc5" title="Get the hwloc OS device object corresponding to the OpenCL device for the given indexes. ">hwloc_opencl_get_device_osdev_by_index()</a>.</p>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00122.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_opencl_get_device_osdev </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00123.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
...
<table class="mlabels">
  ...
  <td class="mlabels-left">
      <table class="memname">
        <tr>
          <td class="memname">static <a class="el" href="a00122.php#ga79b8ab56877ef99ac59b833203391c7d">hwloc_obj_t</a> hwloc_opencl_get_device_osdev_by_index </td>
          <td>(</td>
          <td class="paramtype"><a class="el" href="a00123.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a>&#160;</td>
          <td class="paramname"><em>topology</em>, </td>
        </tr>
