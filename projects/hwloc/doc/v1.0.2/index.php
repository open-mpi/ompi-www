...
<div class="contents">
<h1>Hardware Locality </h1><h3 class="version">1.0.2 </h3><h1 class="sub">Portable abstraction of hierarchical architectures for high-performance computing</h1>
<hr/>
...
shell$ make install
 ...
 <h2><a class="anchor" id="cli_examples">
CLI Examples</a></h2>
<p>On a 4-socket 2-core machine with hyperthreading, the <code>lstopo</code> tool may show the following graphic output:</p>
<div align="center">
...
&lt;topology&gt;
  ...
  &lt;/object&gt;
&lt;/topology&gt;
</pre></div><p>On a 4-socket 2-core Opteron NUMA machine, the <code>lstopo</code> tool may show the following graphic output:</p>
<div align="center">
...
<img src="emmett.png" alt="emmett.png"/>
 ...
 <p>Here's the same output in text form:</p>
<div class="fragment"><pre class="fragment">
Machine (16GB)
  Socket #0
    L2 #0 (4096KB)
...
Portability (especially when using the API or XML)</a></h3>
...
<p>Here's the graphic output from lstopo on this platform when Simultaneous Multi-Threading (SMT) is enabled:</p>
<div align="center">
<img src="ppc64-with-smt.png" alt="ppc64-with-smt.png"/>
</div>
 <p>And here's the graphic output from lstopo on this platform when SMT is disabled:</p>
<div align="center">
...
<h3><a class="anchor" id="interface_example">
API Example</a></h3>
...
<span class="comment">     *****************************************************************/</span>
    ...
    <span class="keywordflow">for</span> (obj = <a class="code" href="group__hwlocality__traversal.php#ga701f83b2cf0cb8e0acd58cd2dc1c67a2" title="Returns the topology object at index index with type type.">hwloc_get_obj_by_type</a>(topology, <a class="code" href="group__hwlocality__types.php#ggacd37bb612667dc437d66bfb175a8dc55abca6887e80cb291353b0a0c1da83f661" title="Processing Unit, or (Logical) Processor. An execution unit (may share a core with...">HWLOC_OBJ_PU</a>, 0);
      ...
      <span class="keywordflow">if</span> (obj-&gt;<a class="code" href="structhwloc__obj.php#acc4f0803f244867e68fe0036800be5de" title="Type of object.">type</a> == <a class="code" href="group__hwlocality__types.php#ggacd37bb612667dc437d66bfb175a8dc55a56ee0b7eca88f363b75b34fdde8c9ddc" title="Data cache. Can be L1, L2, L3, ...">HWLOC_OBJ_CACHE</a>) {
        levels++;
        size += obj-&gt;<a class="code" href="structhwloc__obj.php#accd40e29f71f19e88db62ea3df02adc8" title="Object type-specific Attributes.">attr</a>-&gt;<a class="code" href="unionhwloc__obj__attr__u.php#ab5a8ae3bf490e6b1071fea53f7382836" title="Cache-specific Object Attributes.">cache</a>.<a class="code" href="structhwloc__obj__attr__u_1_1hwloc__cache__attr__s.php#a3c68235220554308f89768f281ad1e62" title="Size of cache in bytes.">size</a>;
      }
...
<span class="comment">     *****************************************************************/</span>
    ...
    <span class="keywordflow">if</span> (obj) {
        ...
        cpuset = <a class="code" href="group__hwlocality__cpuset.php#ga468c6e3fd92a9d0db1fb56634a851be3" title="Duplicate CPU set set by allocating a new CPU set and copying set&amp;#39;s contents...">hwloc_cpuset_dup</a>(obj-&gt;<a class="code" href="structhwloc__obj.php#a67925e0f2c47f50408fbdb9bddd0790f" title="CPUs covered by this object.">cpuset</a>);

        <span class="comment">/* Get only one logical processor (in case the core is</span>
<span class="comment">           SMT/hyperthreaded). */</span>
        <a class="code" href="group__hwlocality__cpuset.php#gace7ad3d2a71d9884e7a28311228931af" title="Keep a single CPU among those set in CPU set set.">hwloc_cpuset_singlify</a>(cpuset);

        <span class="comment">/* And try to bind ourself there. */</span>
        <span class="keywordflow">if</span> (<a class="code" href="group__hwlocality__binding.php#ga42f02baaf7dc0c0f5a6bbeca731fd144" title="Bind current process or thread on cpus given in cpuset set.">hwloc_set_cpubind</a>(topology, cpuset, 0)) {
            <span class="keywordtype">char</span> *str;
            <a class="code" href="group__hwlocality__cpuset.php#ga7a89398cbc58c9095aa094b9aeacbf00" title="Stringify a cpuset into a newly allocated string.">hwloc_cpuset_asprintf</a>(&amp;str, obj-&gt;<a class="code" href="structhwloc__obj.php#a67925e0f2c47f50408fbdb9bddd0790f" title="CPUs covered by this object.">cpuset</a>);
            printf(<span class="stringliteral">&quot;Couldn&#39;t bind to cpuset %s\n&quot;</span>, str);
            free(str);
        }

        <span class="comment">/* Free our cpuset copy */</span>
        <a class="code" href="group__hwlocality__cpuset.php#gaaac6c1536cdcc35f1a1a3a9ab84da80d" title="Free CPU set set.">hwloc_cpuset_free</a>(cpuset);
    }
