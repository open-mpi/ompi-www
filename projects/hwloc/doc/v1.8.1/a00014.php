...
<p>Aside from the <code>name</code> field of each object, hwloc annotates many objects with string attributes that are made of a key and a value. Each object contains a list of such pairs that may be consulted manually (looking at the object <code>infos</code> array field) or using the <a class="el" href="a00079.php#ga7cb58b463d76d5c51a6e4462b2f5da6b" title="Search the given key name in object infos and return the corresponding value. ">hwloc_obj_get_info_by_name()</a>. The user may additionally add new key-value pairs to any object using <a class="el" href="a00079.php#gaba3afe636940872772ed6dfaf0b3552e" title="Add the given info name and value pair to the given object. ">hwloc_obj_add_info()</a> or the <a class="el" href="a00004.php#cli_hwloc_annotate">hwloc-annotate</a> program.</p>
...
<dd>The processor vendor name, model name, model number, family number and a more-general processor type name. CPUVendor, CPUModelNumber and CPUFamilyNumber are currently only added for x86 processors. CPUType is only added on Solaris/Sparc. These attributes are usually added to Socket objects. However, when hwloc cannot detect the number of sockets but still knows their (same) model, the attribute may be added to the Machine object instead.  </dd>
