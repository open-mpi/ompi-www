...
<dd><p class="startdd"><code><a class="el" href="a00076.php#ga5c2d6f476af87005c7bd0811d4548b9f" title="Allocate a topology context. ">hwloc_topology_init()</a>, <a class="el" href="a00076.php#ga91e2e6427b95fb7339c99dbbef996e71" title="Build the actual topology. ">hwloc_topology_load()</a>, <a class="el" href="a00076.php#ga6040925d3ee4bbb2647f2a321aca5f4b" title="Terminate and free a topology context. ">hwloc_topology_destroy()</a></code> (see <a class="el" href="a00076.php">Topology Creation and Destruction</a>) imply major modifications of the structure, including freeing some objects. No other thread cannot access the topology or any of its objects at the same time.</p>
...
<dd><p class="startdd"><code>hwloc_topology_ignore*</code>, <code>hwloc_topology_set*</code> (see <a class="el" href="a00077.php">Topology Detection Configuration and Query</a>) do not modify the topology directly, but they do modify internal structures describing the behavior of the upcoming invocation of <code><a class="el" href="a00076.php#ga91e2e6427b95fb7339c99dbbef996e71" title="Build the actual topology. ">hwloc_topology_load()</a></code>. Hence, all of these functions should not be used concurrently. </p>
<p class="enddd"></p>
</dd>
</dl>
</div></div><!-- contents -->
