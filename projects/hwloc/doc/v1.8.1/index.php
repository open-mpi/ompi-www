...
<div class="line">    <a class="code" href="a00076.php#ga5c2d6f476af87005c7bd0811d4548b9f">hwloc_topology_init</a>(&amp;topology);</div>
<div class="line"></div>
...
<div class="line">    <a class="code" href="a00076.php#ga91e2e6427b95fb7339c99dbbef996e71">hwloc_topology_load</a>(topology);</div>
<div class="line"></div>
...
<div class="line">    topodepth = <a class="code" href="a00078.php#ga8c30b0cec55074eb3ed34e4f2a1a9937">hwloc_topology_get_depth</a>(topology);</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
...
<div class="line">        <span class="keywordflow">for</span> (i = 0; i &lt; <a class="code" href="a00078.php#ga20cfe2456f4cfdd789c9aca6d2fdd69f">hwloc_get_nbobjs_by_depth</a>(topology, depth); </div>
...
<div class="line">                       <a class="code" href="a00078.php#gaedd78240b0c1108355586a268ec5a697">hwloc_get_obj_by_depth</a>(topology, depth, i),</div>
...
<div class="line">    print_children(topology, <a class="code" href="a00078.php#gadbf58f6e187efbdb3cd9a8e30311b7d7">hwloc_get_root_obj</a>(topology), 0);</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
...
<div class="line"><span class="comment">     *****************************************************************/</span></div>
<div class="line">    depth = <a class="code" href="a00078.php#gaea7c64dd59467f5201ba87712710b14d">hwloc_get_type_depth</a>(topology, <a class="code" href="a00074.php#ggacd37bb612667dc437d66bfb175a8dc55a1ac6e07775ae4324b3fe9dbd72c785ec">HWLOC_OBJ_SOCKET</a>);</div>
...
<div class="line">               <a class="code" href="a00078.php#ga20cfe2456f4cfdd789c9aca6d2fdd69f">hwloc_get_nbobjs_by_depth</a>(topology, depth));</div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
...
<div class="line">    <span class="keywordflow">for</span> (obj = <a class="code" href="a00078.php#ga9be4a03488cdd0fb431e4aa1cbdea895">hwloc_get_obj_by_type</a>(topology, <a class="code" href="a00074.php#ggacd37bb612667dc437d66bfb175a8dc55abca6887e80cb291353b0a0c1da83f661">HWLOC_OBJ_PU</a>, 0);</div>
...
<div class="line"><span class="comment">     *****************************************************************/</span></div>
<div class="line">    depth = <a class="code" href="a00078.php#ga081be77905201e9f42318e9974456b45">hwloc_get_type_or_below_depth</a>(topology, <a class="code" href="a00074.php#ggacd37bb612667dc437d66bfb175a8dc55ac793958f330bca371aa1535de8aff45f">HWLOC_OBJ_CORE</a>);</div>
<div class="line"></div>
<div class="line">    <span class="comment">/* Get last core. */</span></div>
<div class="line">    obj = <a class="code" href="a00078.php#gaedd78240b0c1108355586a268ec5a697">hwloc_get_obj_by_depth</a>(topology, depth,</div>
<div class="line">                   <a class="code" href="a00078.php#ga20cfe2456f4cfdd789c9aca6d2fdd69f">hwloc_get_nbobjs_by_depth</a>(topology, depth) - 1);</div>
...
<div class="line">        cpuset = <a class="code" href="a00095.php#gaaa4ed76211cd3694dfbea2109fc440be">hwloc_bitmap_dup</a>(obj-&gt;<a class="code" href="a00036.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
<div class="line"></div>
...
<div class="line">        <a class="code" href="a00095.php#ga4630aa1b7e08eac5b41be126194e84a1">hwloc_bitmap_singlify</a>(cpuset);</div>
<div class="line"></div>
<div class="line">        <span class="comment">/* And try to bind ourself there. */</span></div>
<div class="line">        <span class="keywordflow">if</span> (<a class="code" href="a00080.php#gaf4cc194d5c0d38004a21b9f03522a7e3">hwloc_set_cpubind</a>(topology, cpuset, 0)) {</div>
<div class="line">            <span class="keywordtype">char</span> *str;</div>
<div class="line">            <span class="keywordtype">int</span> error = errno;</div>
<div class="line">            <a class="code" href="a00095.php#gad3cf87ceb58aa91656756bbb58057320">hwloc_bitmap_asprintf</a>(&amp;str, obj-&gt;<a class="code" href="a00036.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
...
<div class="line">        <a class="code" href="a00095.php#ga8e7035fe555ef96921bfb98e08519bc7">hwloc_bitmap_free</a>(cpuset);</div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
...
<div class="line">    n = <a class="code" href="a00078.php#gaba821f84ef64282d14577066e6d6547e">hwloc_get_nbobjs_by_type</a>(topology, <a class="code" href="a00074.php#ggacd37bb612667dc437d66bfb175a8dc55aaf0964881117bdedf1a5e9332cd120dd">HWLOC_OBJ_NODE</a>);</div>
...
<div class="line"></div>
<div class="line">        obj = <a class="code" href="a00078.php#ga9be4a03488cdd0fb431e4aa1cbdea895">hwloc_get_obj_by_type</a>(topology, <a class="code" href="a00074.php#ggacd37bb612667dc437d66bfb175a8dc55aaf0964881117bdedf1a5e9332cd120dd">HWLOC_OBJ_NODE</a>, n - 1);</div>
<div class="line">        m = <a class="code" href="a00081.php#gaeaa00714a9c4319bda0a74ca6f8720e8">hwloc_alloc_membind_nodeset</a>(topology, size, obj-&gt;<a class="code" href="a00036.php#a08f0d0e16c619a6e653526cbee4ffea3">nodeset</a>,</div>
...
<div class="line">        <a class="code" href="a00081.php#ga986d9b4cc76da592c4b937c6cb7d9d56">hwloc_free</a>(topology, m, size);</div>
<div class="line"></div>
<div class="line">        m = malloc(size);</div>
<div class="line">        <a class="code" href="a00081.php#gade5e2c28ea8475a479bf2b1df36c6ccd">hwloc_set_area_membind_nodeset</a>(topology, m, size, obj-&gt;<a class="code" href="a00036.php#a08f0d0e16c619a6e653526cbee4ffea3">nodeset</a>,</div>
<div class="line">                <a class="code" href="a00081.php#ggac9764f79505775d06407b40f5e4661e8a18675bb80ebc1bce5b652e9de8f3998c">HWLOC_MEMBIND_DEFAULT</a>, 0);</div>
<div class="line">        free(m);</div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="comment">/* Destroy topology object. */</span></div>
<div class="line">    <a class="code" href="a00076.php#ga6040925d3ee4bbb2647f2a321aca5f4b">hwloc_topology_destroy</a>(topology);</div>
<div class="line"></div>
