...
Chapters <ul>
<li>
<a class="el" href="a00342.php">Installation</a> </li>
<li>
<a class="el" href="a00343.php">Compiling software on top of hwloc's C API</a> </li>
<li>
<a class="el" href="a00344.php">Terms and Definitions</a> </li>
<li>
<a class="el" href="a00345.php">Command-Line Tools</a> </li>
<li>
<a class="el" href="a00346.php">Environment Variables</a> </li>
<li>
<a class="el" href="a00347.php">CPU and Memory Binding Overview</a> </li>
<li>
<a class="el" href="a00348.php">I/O Devices</a> </li>
<li>
<a class="el" href="a00349.php">Miscellaneous objects</a> </li>
<li>
<a class="el" href="a00350.php">Object attributes</a> </li>
<li>
<a class="el" href="a00351.php">Topology Attributes: Distances, Memory Attributes and CPU Kinds</a> </li>
<li>
<a class="el" href="a00352.php">Heterogeneous Memory</a> </li>
<li>
...
<li>
<a class="el" href="a00359.php">Frequently Asked Questions (FAQ)</a> </li>
<li>
...
<p>To precisely define the vocabulary used by hwloc, a <a class="el" href="a00344.php">Terms and Definitions</a> section is available and should probably be read first.</p>
...
<img src="ppc64-without-smt.png" alt=""/>
 ...
 <p>Notice that hwloc only sees half the PUs when SMT is disabled. PU L#6, for example, seems to change location from NUMA node #0 to #1. In reality, no PUs "moved" &ndash; they were simply re-numbered when hwloc only saw half as many (see also Logical index in <a class="el" href="a00344.php#termsanddefs_indexes">Indexes and Sets</a>). Hence, PU L#6 in the SMT-disabled picture probably corresponds to PU L#12 in the SMT-enabled picture.</p>
...
<div class="line"> </div>
<div class="line"><span class="keyword">static</span> <span class="keywordtype">void</span> print_children(<a class="code hl_typedef" href="a00142.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="code hl_struct" href="a00197.php">hwloc_obj_t</a> obj,</div>
...
<div class="line">    <span class="keywordflow">if</span> (obj-&gt;<a class="code hl_variable" href="a00197.php#a61a7a80a68eaccbaaa28269e678c81a9">os_index</a> != (<span class="keywordtype">unsigned</span>) -1)</div>
<div class="line">      printf(<span class="stringliteral">&quot;#%u&quot;</span>, obj-&gt;<a class="code hl_variable" href="a00197.php#a61a7a80a68eaccbaaa28269e678c81a9">os_index</a>);</div>
...
<div class="line">    <span class="keywordflow">for</span> (i = 0; i &lt; obj-&gt;<a class="code hl_variable" href="a00197.php#aac3f6da35c9b57599909a44ce2b716c1">arity</a>; i++) {</div>
<div class="line">        print_children(topology, obj-&gt;<a class="code hl_variable" href="a00197.php#a04d05403da37bfe17cd63b7c7dd07b1f">children</a>[i], depth + 1);</div>
<div class="line">    }</div>
<div class="line">}</div>
<div class="line"> </div>
...
<div class="line">    <a class="code hl_struct" href="a00197.php">hwloc_obj_t</a> obj;</div>
<div class="line"> </div>
...
<div class="line">         obj = obj-&gt;<a class="code hl_variable" href="a00197.php#adc494f6aed939992be1c55cca5822900">parent</a>)</div>
<div class="line">      <span class="keywordflow">if</span> (<a class="code hl_function" href="a00151.php#ga2ed589bea28711e80b92066510a5607d">hwloc_obj_type_is_cache</a>(obj-&gt;<a class="code hl_variable" href="a00197.php#acc4f0803f244867e68fe0036800be5de">type</a>)) {</div>
<div class="line">        levels++;</div>
<div class="line">        size += obj-&gt;<a class="code hl_variable" href="a00197.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00201.php#a23f553f3252c9d13f2338231cd354ea9">cache</a>.<a class="code hl_variable" href="a00213.php#abe5e788943ed04302976740c829674c0">size</a>;</div>
<div class="line">      }</div>
...
<div class="line">        cpuset = <a class="code hl_function" href="a00161.php#gae679434c1a5f41d3560a8a7e2c1b0dee">hwloc_bitmap_dup</a>(obj-&gt;<a class="code hl_variable" href="a00197.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
<div class="line"> </div>
...
<div class="line">            <a class="code hl_function" href="a00161.php#ga0fece972134fdecf2da9bc7a11dd827e">hwloc_bitmap_asprintf</a>(&amp;str, obj-&gt;<a class="code hl_variable" href="a00197.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
...
<div class="line">    m = <a class="code hl_function" href="a00147.php#gadf87089ef533db40460ccc24b5bc0d65">hwloc_alloc_membind</a>(topology, size, obj-&gt;<a class="code hl_variable" href="a00197.php#a08f0d0e16c619a6e653526cbee4ffea3">nodeset</a>,</div>
...
<div class="line">    <a class="code hl_function" href="a00147.php#gaf881faefe20701229f07dd7dbd0125ed">hwloc_set_area_membind</a>(topology, m, size, obj-&gt;<a class="code hl_variable" href="a00197.php#a08f0d0e16c619a6e653526cbee4ffea3">nodeset</a>,</div>
<div class="line">                           <a class="code hl_enumvalue" href="a00147.php#ggac9764f79505775d06407b40f5e4661e8ad811fa4b2a6002c4d63695a408ffde2c">HWLOC_MEMBIND_BIND</a>, <a class="code hl_enumvalue" href="a00147.php#ggab00475fd98815bf4fb9aaf752030e7d2a71f19fe4505f1c083dc8e6f7bdea6256">HWLOC_MEMBIND_BYNODESET</a>);</div>
...
<div class="ttc" id="aa00197_php_a04d05403da37bfe17cd63b7c7dd07b1f"><div class="ttname"><a href="a00197.php#a04d05403da37bfe17cd63b7c7dd07b1f">hwloc_obj::children</a></div><div class="ttdeci">struct hwloc_obj ** children</div><div class="ttdoc">Normal children, children[0 .. arity -1].</div><div class="ttdef"><b>Definition</b> hwloc.h:491</div></div>
<div class="ttc" id="aa00197_php_a08f0d0e16c619a6e653526cbee4ffea3"><div class="ttname"><a href="a00197.php#a08f0d0e16c619a6e653526cbee4ffea3">hwloc_obj::nodeset</a></div><div class="ttdeci">hwloc_nodeset_t nodeset</div><div class="ttdoc">NUMA nodes covered by this object or containing this object.</div><div class="ttdef"><b>Definition</b> hwloc.h:575</div></div>
...
<div class="ttc" id="aa00197_php_aac3f6da35c9b57599909a44ce2b716c1"><div class="ttname"><a href="a00197.php#aac3f6da35c9b57599909a44ce2b716c1">hwloc_obj::arity</a></div><div class="ttdeci">unsigned arity</div><div class="ttdoc">Number of normal children. Memory, Misc and I/O children are not listed here but rather in their dedi...</div><div class="ttdef"><b>Definition</b> hwloc.h:487</div></div>
...
<div class="ttc" id="aa00201_php_a23f553f3252c9d13f2338231cd354ea9"><div class="ttname"><a href="a00201.php#a23f553f3252c9d13f2338231cd354ea9">hwloc_obj_attr_u::cache</a></div><div class="ttdeci">struct hwloc_obj_attr_u::hwloc_cache_attr_s cache</div></div>
<div class="ttc" id="aa00213_php_abe5e788943ed04302976740c829674c0"><div class="ttname"><a href="a00213.php#abe5e788943ed04302976740c829674c0">hwloc_obj_attr_u::hwloc_cache_attr_s::size</a></div><div class="ttdeci">hwloc_uint64_t size</div><div class="ttdoc">Size of cache in bytes.</div><div class="ttdef"><b>Definition</b> hwloc.h:652</div></div>
</div><!-- fragment --><p>hwloc provides a <code>pkg-config</code> executable to obtain relevant compiler and linker flags. See <a class="el" href="a00343.php">Compiling software on top of hwloc's C API</a> for details on building program on top of hwloc's API using GNU Make or CMake.</p>
