...
<div class="line"><a id="l00045" name="l00045"></a><span class="lineno"><a class="line" href="a00281.php">   45</a></span><span class="keyword">typedef</span> <span class="keyword">struct </span>{</div>
<div class="line"><a id="l00046" name="l00046"></a><span class="lineno"><a class="line" href="a00281.php#a5bdfbcb0dee610f9f6f7f95ace89e298">   46</a></span>    cl_uint <a class="code hl_variable" href="a00281.php#a5bdfbcb0dee610f9f6f7f95ace89e298">pci_domain</a>;</div>
<div class="line"><a id="l00047" name="l00047"></a><span class="lineno"><a class="line" href="a00281.php#a0e4d316b01eee00c3750d1c853be9c01">   47</a></span>    cl_uint <a class="code hl_variable" href="a00281.php#a0e4d316b01eee00c3750d1c853be9c01">pci_bus</a>;</div>
<div class="line"><a id="l00048" name="l00048"></a><span class="lineno"><a class="line" href="a00281.php#a328717bdaeb2d117c550927cf41e6f72">   48</a></span>    cl_uint <a class="code hl_variable" href="a00281.php#a328717bdaeb2d117c550927cf41e6f72">pci_device</a>;</div>
<div class="line"><a id="l00049" name="l00049"></a><span class="lineno"><a class="line" href="a00281.php#ab4032f46a44cf9ffc7b2ddc25001e3f0">   49</a></span>    cl_uint <a class="code hl_variable" href="a00281.php#ab4032f46a44cf9ffc7b2ddc25001e3f0">pci_function</a>;</div>
<div class="line"><a id="l00050" name="l00050"></a><span class="lineno">   50</span>} <a class="code hl_struct" href="a00281.php">hwloc_cl_device_pci_bus_info_khr</a>;</div>
</div>
...
<div class="line"><a id="l00055" name="l00055"></a><span class="lineno"><a class="line" href="a00285.php">   55</a></span><span class="keyword">typedef</span> <span class="keyword">union </span>{</div>
<div class="line"><a id="l00056" name="l00056"></a><span class="lineno"><a class="line" href="a00285.php#afbd6b814607b06fc5b2f36ad14420398">   56</a></span>    <span class="keyword">struct </span>{ cl_uint type; cl_uint data[5]; } raw;</div>
<div class="line"><a id="l00057" name="l00057"></a><span class="lineno"><a class="line" href="a00285.php#a4a23e3cc034b7ab105cab0e863dcab69">   57</a></span>    <span class="keyword">struct </span>{ cl_uint type; cl_char unused[17]; cl_char <a class="code hl_variable" href="a00285.php#a4a23e3cc034b7ab105cab0e863dcab69">bus</a>; cl_char device; cl_char function; } pcie;</div>
<div class="line"><a id="l00058" name="l00058"></a><span class="lineno">   58</span>} <a class="code hl_union" href="a00285.php">hwloc_cl_device_topology_amd</a>;</div>
</div>
...
<div class="line"><a id="l00089" name="l00089"></a><span class="lineno">   89</span>        <a class="code hl_union" href="a00285.php">hwloc_cl_device_topology_amd</a> amdtopo;</div>
<div class="line"><a id="l00090" name="l00090"></a><span class="lineno">   90</span>        <a class="code hl_struct" href="a00281.php">hwloc_cl_device_pci_bus_info_khr</a> khrbusinfo;</div>
...
<div class="line"><a id="l00096" name="l00096"></a><span class="lineno">   96</span>                *domain = (unsigned) khrbusinfo.<a class="code hl_variable" href="a00281.php#a5bdfbcb0dee610f9f6f7f95ace89e298">pci_domain</a>;</div>
<div class="line"><a id="l00097" name="l00097"></a><span class="lineno">   97</span>                *bus = (unsigned) khrbusinfo.<a class="code hl_variable" href="a00281.php#a0e4d316b01eee00c3750d1c853be9c01">pci_bus</a>;</div>
<div class="line"><a id="l00098" name="l00098"></a><span class="lineno">   98</span>                *dev = (unsigned) khrbusinfo.<a class="code hl_variable" href="a00281.php#a328717bdaeb2d117c550927cf41e6f72">pci_device</a>;</div>
<div class="line"><a id="l00099" name="l00099"></a><span class="lineno">   99</span>                *func = (unsigned) khrbusinfo.<a class="code hl_variable" href="a00281.php#ab4032f46a44cf9ffc7b2ddc25001e3f0">pci_function</a>;</div>
...
<div class="line"><a id="l00105" name="l00105"></a><span class="lineno">  105</span>            &amp;&amp; HWLOC_CL_DEVICE_TOPOLOGY_TYPE_PCIE_AMD == amdtopo.<a class="code hl_variable" href="a00285.php#aeb5e5d12bf653f750dafedae6e225c3a">raw</a>.<a class="code hl_variable" href="a00285.php#a8ec4ea89b862bb271845b48063f332b4">type</a>) {</div>
...
<div class="line"><a id="l00108" name="l00108"></a><span class="lineno">  108</span>                *bus = (unsigned) (<span class="keywordtype">unsigned</span> <span class="keywordtype">char</span>) amdtopo.<a class="code hl_variable" href="a00285.php#aef8560f6c359be0c5bdbd2840580d79c">pcie</a>.<a class="code hl_variable" href="a00285.php#a4a23e3cc034b7ab105cab0e863dcab69">bus</a>;</div>
<div class="line"><a id="l00109" name="l00109"></a><span class="lineno">  109</span>                *dev = (unsigned) (<span class="keywordtype">unsigned</span> <span class="keywordtype">char</span>) amdtopo.<a class="code hl_variable" href="a00285.php#aef8560f6c359be0c5bdbd2840580d79c">pcie</a>.<a class="code hl_variable" href="a00285.php#a017033a953d71455b067007cabb92e9c">device</a>;</div>
<div class="line"><a id="l00110" name="l00110"></a><span class="lineno">  110</span>                *func = (unsigned) (<span class="keywordtype">unsigned</span> <span class="keywordtype">char</span>) amdtopo.<a class="code hl_variable" href="a00285.php#aef8560f6c359be0c5bdbd2840580d79c">pcie</a>.<a class="code hl_variable" href="a00285.php#a77a67ac73cff98d330ef7258b240bac3">function</a>;</div>
...
<div class="line"><a id="l00202" name="l00202"></a><span class="lineno">  202</span><span class="keyword">static</span> __hwloc_inline <a class="code hl_struct" href="a00197.php">hwloc_obj_t</a></div>
...
<div class="line"><a id="l00211" name="l00211"></a><span class="lineno">  211</span>                    &amp;&amp; sscanf(osdev-&gt;<a class="code hl_variable" href="a00197.php#abb709ec38f2970677e4e57d1d30be96d">name</a>, <span class="stringliteral">&quot;opencl%ud%u&quot;</span>, &amp;x, &amp;y) == 2</div>
...
<div class="line"><a id="l00239" name="l00239"></a><span class="lineno">  239</span><span class="keyword">static</span> __hwloc_inline <a class="code hl_struct" href="a00197.php">hwloc_obj_t</a></div>
...
<div class="line"><a id="l00243" name="l00243"></a><span class="lineno">  243</span>        <a class="code hl_struct" href="a00197.php">hwloc_obj_t</a> osdev;</div>
...
<div class="line"><a id="l00253" name="l00253"></a><span class="lineno">  253</span>                <a class="code hl_struct" href="a00197.php">hwloc_obj_t</a> pcidev = osdev-&gt;<a class="code hl_variable" href="a00197.php#adc494f6aed939992be1c55cca5822900">parent</a>;</div>
<div class="line"><a id="l00254" name="l00254"></a><span class="lineno">  254</span>                <span class="keywordflow">if</span> (strncmp(osdev-&gt;<a class="code hl_variable" href="a00197.php#abb709ec38f2970677e4e57d1d30be96d">name</a>, <span class="stringliteral">&quot;opencl&quot;</span>, 6))</div>
...
<div class="line"><a id="l00257" name="l00257"></a><span class="lineno">  257</span>                    &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00197.php#acc4f0803f244867e68fe0036800be5de">type</a> == <a class="code hl_enumvalue" href="a00140.php#ggacd37bb612667dc437d66bfb175a8dc55a5d8117a54df1fbd3606ab19e42cb0ea9">HWLOC_OBJ_PCI_DEVICE</a></div>
<div class="line"><a id="l00258" name="l00258"></a><span class="lineno">  258</span>                    &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00197.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00201.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00221.php#a8fba44988deb98613c1505a4019a34dc">domain</a> == pcidomain</div>
<div class="line"><a id="l00259" name="l00259"></a><span class="lineno">  259</span>                    &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00197.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00201.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00221.php#aae99e035e8d1387d7b8768aaa8eceb0a">bus</a> == pcibus</div>
<div class="line"><a id="l00260" name="l00260"></a><span class="lineno">  260</span>                    &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00197.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00201.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00221.php#a3d70c84a12f7e93d14c8d47bf4fd9dc5">dev</a> == pcidevice</div>
<div class="line"><a id="l00261" name="l00261"></a><span class="lineno">  261</span>                    &amp;&amp; pcidev-&gt;<a class="code hl_variable" href="a00197.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code hl_variable" href="a00201.php#a0b66da7ab072f7c016f8ed86701f5a7c">pcidev</a>.<a class="code hl_variable" href="a00221.php#a695f32df53f4ef728670bfcf31b74e0f">func</a> == pcifunc)</div>
...
<div class="ttc" id="aa00281_php"><div class="ttname"><a href="a00281.php">hwloc_cl_device_pci_bus_info_khr</a></div><div class="ttdef"><b>Definition</b> opencl.h:45</div></div>
<div class="ttc" id="aa00281_php_a0e4d316b01eee00c3750d1c853be9c01"><div class="ttname"><a href="a00281.php#a0e4d316b01eee00c3750d1c853be9c01">hwloc_cl_device_pci_bus_info_khr::pci_bus</a></div><div class="ttdeci">cl_uint pci_bus</div><div class="ttdef"><b>Definition</b> opencl.h:47</div></div>
<div class="ttc" id="aa00281_php_a328717bdaeb2d117c550927cf41e6f72"><div class="ttname"><a href="a00281.php#a328717bdaeb2d117c550927cf41e6f72">hwloc_cl_device_pci_bus_info_khr::pci_device</a></div><div class="ttdeci">cl_uint pci_device</div><div class="ttdef"><b>Definition</b> opencl.h:48</div></div>
<div class="ttc" id="aa00281_php_a5bdfbcb0dee610f9f6f7f95ace89e298"><div class="ttname"><a href="a00281.php#a5bdfbcb0dee610f9f6f7f95ace89e298">hwloc_cl_device_pci_bus_info_khr::pci_domain</a></div><div class="ttdeci">cl_uint pci_domain</div><div class="ttdef"><b>Definition</b> opencl.h:46</div></div>
<div class="ttc" id="aa00281_php_ab4032f46a44cf9ffc7b2ddc25001e3f0"><div class="ttname"><a href="a00281.php#ab4032f46a44cf9ffc7b2ddc25001e3f0">hwloc_cl_device_pci_bus_info_khr::pci_function</a></div><div class="ttdeci">cl_uint pci_function</div><div class="ttdef"><b>Definition</b> opencl.h:49</div></div>
<div class="ttc" id="aa00285_php"><div class="ttname"><a href="a00285.php">hwloc_cl_device_topology_amd</a></div><div class="ttdef"><b>Definition</b> opencl.h:55</div></div>
<div class="ttc" id="aa00285_php_a017033a953d71455b067007cabb92e9c"><div class="ttname"><a href="a00285.php#a017033a953d71455b067007cabb92e9c">hwloc_cl_device_topology_amd::device</a></div><div class="ttdeci">cl_char device</div><div class="ttdef"><b>Definition</b> opencl.h:57</div></div>
<div class="ttc" id="aa00285_php_a4a23e3cc034b7ab105cab0e863dcab69"><div class="ttname"><a href="a00285.php#a4a23e3cc034b7ab105cab0e863dcab69">hwloc_cl_device_topology_amd::bus</a></div><div class="ttdeci">cl_char bus</div><div class="ttdef"><b>Definition</b> opencl.h:57</div></div>
<div class="ttc" id="aa00285_php_a77a67ac73cff98d330ef7258b240bac3"><div class="ttname"><a href="a00285.php#a77a67ac73cff98d330ef7258b240bac3">hwloc_cl_device_topology_amd::function</a></div><div class="ttdeci">cl_char function</div><div class="ttdef"><b>Definition</b> opencl.h:57</div></div>
<div class="ttc" id="aa00285_php_a8ec4ea89b862bb271845b48063f332b4"><div class="ttname"><a href="a00285.php#a8ec4ea89b862bb271845b48063f332b4">hwloc_cl_device_topology_amd::type</a></div><div class="ttdeci">cl_uint type</div><div class="ttdef"><b>Definition</b> opencl.h:56</div></div>
<div class="ttc" id="aa00285_php_aeb5e5d12bf653f750dafedae6e225c3a"><div class="ttname"><a href="a00285.php#aeb5e5d12bf653f750dafedae6e225c3a">hwloc_cl_device_topology_amd::raw</a></div><div class="ttdeci">struct hwloc_cl_device_topology_amd::@0 raw</div></div>
<div class="ttc" id="aa00285_php_aef8560f6c359be0c5bdbd2840580d79c"><div class="ttname"><a href="a00285.php#aef8560f6c359be0c5bdbd2840580d79c">hwloc_cl_device_topology_amd::pcie</a></div><div class="ttdeci">struct hwloc_cl_device_topology_amd::@1 pcie</div></div>
