...
<li>
the NVIDIA CUDA Toolkit for CUDA device discovery. See <a class="el" href="a00373.php#faq_cuda_build">How do I enable ROCm SMI and select which version to use?</a>.  </li>
<li>
