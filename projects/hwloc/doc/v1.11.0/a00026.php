...
<p>Registering components to the hwloc core relies on a <code><a class="el" href="a00034.php" title="Generic component structure. ">hwloc_component</a></code> structure. Its <code>data</code> field points to the previously defined <code><a class="el" href="a00035.php" title="Discovery component structure. ">hwloc_disc_component</a></code> structure while its <code>type</code> should be HWLOC_COMPONENT_TYPE_DISC. This structure should be named <code>hwloc_&lt;name&gt;_component</code>.</p>
...
<dt>bgq </dt>
<dd>This component is specific to IBM BlueGene/Q compute node (running CNK). It is built and enabled by default when <code>&ndash;host=powerpc64-bgq-linux</code> is passed to configure (see <a class="el" href="a00030.php#faq_bgq">How do I build hwloc for BlueGene/Q?</a>).  </dd>
<dt>no_os </dt>
