...
<div class="title">hwloc_component Struct Reference<div class="ingroups"><a class="el" href="a00102.php">Components and Plugins: Generic components</a></div></div>  </div>
</div><!--header-->
<div class="contents">
...
<tr class="memitem:aea613546886d9b8221cadba920fe3ebc"><td class="memItemLeft" align="right" valign="top">int(*&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00034.php#aea613546886d9b8221cadba920fe3ebc">init</a> )(unsigned long <a class="el" href="a00034.php#ab8043c5b4cc0e81aabba586ccb194335">flags</a>)</td></tr>
<tr class="separator:aea613546886d9b8221cadba920fe3ebc"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a4612015451a1c706e8ba19114cb8baae"><td class="memItemLeft" align="right" valign="top">void(*&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00034.php#a4612015451a1c706e8ba19114cb8baae">finalize</a> )(unsigned long <a class="el" href="a00034.php#ab8043c5b4cc0e81aabba586ccb194335">flags</a>)</td></tr>
<tr class="separator:a4612015451a1c706e8ba19114cb8baae"><td class="memSeparator" colspan="2">&#160;</td></tr>
<tr class="memitem:a789208ada7e17492cfd3a5a88a6bb0ee"><td class="memItemLeft" align="right" valign="top"><a class="el" href="a00102.php#ga0aebfa65317af10bb18d7d35f6dc05b8">hwloc_component_type_t</a>&#160;</td><td class="memItemRight" valign="bottom"><a class="el" href="a00034.php#a789208ada7e17492cfd3a5a88a6bb0ee">type</a></td></tr>
...
<a class="anchor" id="a4612015451a1c706e8ba19114cb8baae"></a>
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<dl class="section note"><dt>Note</dt><dd>If the component uses ltdl for loading its own plugins, it should load/unload them only in <a class="el" href="a00034.php#aea613546886d9b8221cadba920fe3ebc" title="Process-wide component initialization callback. ">init()</a> and <a class="el" href="a00034.php#a4612015451a1c706e8ba19114cb8baae" title="Process-wide component termination callback. ">finalize()</a>, to avoid race conditions with hwloc's use of ltdl. </dd></dl>
...
<a class="anchor" id="aea613546886d9b8221cadba920fe3ebc"></a>
<div class="memitem">
<div class="memproto">
      <table class="memname">
        <tr>
...
<div class="memproto">
      <table class="memname">
        <tr>
          <td class="memname"><a class="el" href="a00102.php#ga0aebfa65317af10bb18d7d35f6dc05b8">hwloc_component_type_t</a> hwloc_component::type</td>
        </tr>
      </table>
</div><div class="memdoc">
