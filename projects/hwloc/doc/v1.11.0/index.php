...
<p>Since it uses standard Operating System information, hwloc's support is mostly independant from the processor type (x86, powerpc, ...) and just relies on the Operating System support. The only exception to this is kFreeBSD, which does not support topology information, and hwloc thus uses an x86-only CPUID-based backend (which can be used for other OSes too, see the <a class="el" href="a00026.php">Components and plugins</a> section).</p>
...
<p>PCI and XML support may be statically built inside the main hwloc library, or as separate dynamically-loaded plugins (see the <a class="el" href="a00026.php">Components and plugins</a> section).</p>
...
<pre class="fragment">Machine (16GB)
  ...
  Package L#3 + L3 L#3 (4096KB)
    ...
    L2 L#7 (1024KB) + L1 L#7 (16KB) + Core L#7
      PU L#14 (P#7)
      PU L#15 (P#15)
</pre><p>Note that there is also an equivalent output in XML that is meant for exporting/importing topologies but it is hardly readable to human-beings (see <a class="el" href="a00018.php">Importing and exporting topologies from/to XML files</a> for details).</p>
...
<p>The basic interface is available in <a class="el" href="a00065_source.php" title="The hwloc API. ">hwloc.h</a>. Some higher-level functions are available in <a class="el" href="a00063_source.php" title="High-level hwloc traversal helpers. ">hwloc/helper.h</a> to reduce the need to manually manipulate objects and follow links between them. Documentation for all these is provided later in this document. Developers may also want to look at hwloc/inlines.h which contains the actual inline code of some <a class="el" href="a00065_source.php" title="The hwloc API. ">hwloc.h</a> routines, and at this document, which provides good higher-level topology traversal examples.</p>
...
<p>Each hwloc object contains a cpuset describing the list of processing units that it contains. These bitmaps may be used for <a class="el" href="a00082.php">CPU binding</a> and <a class="el" href="a00083.php">Memory binding</a>. hwloc offers an extensive bitmap manipulation interface in <a class="el" href="a00057_source.php" title="The bitmap API, for use in hwloc itself. ">hwloc/bitmap.h</a>.</p>
<p>Moreover, hwloc also comes with additional helpers for interoperability with several commonly used environments. See the <a class="el" href="a00022.php">Interoperability With Other Software</a> section for details.</p>
...
<div class="line"><span class="comment"> *</span></div>
<div class="line"><span class="comment"> * Copyright © 2009-2015 Inria.  All rights reserved.</span></div>
...
<div class="line"></div>
<div class="line"><span class="keyword">static</span> <span class="keywordtype">void</span> print_children(<a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology, <a class="code" href="a00038.php">hwloc_obj_t</a> obj, </div>
<div class="line">                           <span class="keywordtype">int</span> <a class="code" href="a00038.php#a9d82690370275d42d652eccdea5d3ee5">depth</a>)</div>
<div class="line">{</div>
<div class="line">    <span class="keywordtype">char</span> <a class="code" href="a00038.php#acc4f0803f244867e68fe0036800be5de">type</a>[32], <a class="code" href="a00038.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>[1024];</div>
<div class="line">    <span class="keywordtype">unsigned</span> i;</div>
<div class="line"></div>
<div class="line">    <a class="code" href="a00081.php#gadb8765c260edea80c52cd06a76639ba4">hwloc_obj_type_snprintf</a>(type, <span class="keyword">sizeof</span>(type), obj, 0);</div>
<div class="line">    printf(<span class="stringliteral">&quot;%*s%s&quot;</span>, 2*depth, <span class="stringliteral">&quot;&quot;</span>, type);</div>
<div class="line">    <span class="keywordflow">if</span> (obj-&gt;<a class="code" href="a00038.php#a61a7a80a68eaccbaaa28269e678c81a9">os_index</a> != (<span class="keywordtype">unsigned</span>) -1)</div>
<div class="line">      printf(<span class="stringliteral">&quot;#%u&quot;</span>, obj-&gt;<a class="code" href="a00038.php#a61a7a80a68eaccbaaa28269e678c81a9">os_index</a>);</div>
<div class="line">    <a class="code" href="a00081.php#ga870e876931c282a1c7aee2f031912ce3">hwloc_obj_attr_snprintf</a>(attr, <span class="keyword">sizeof</span>(attr), obj, <span class="stringliteral">&quot; &quot;</span>, 0);</div>
...
<div class="line">    <span class="keywordflow">for</span> (i = 0; i &lt; obj-&gt;<a class="code" href="a00038.php#aac3f6da35c9b57599909a44ce2b716c1">arity</a>; i++) {</div>
<div class="line">        print_children(topology, obj-&gt;<a class="code" href="a00038.php#a04d05403da37bfe17cd63b7c7dd07b1f">children</a>[i], depth + 1);</div>
<div class="line">    }</div>
<div class="line">}</div>
<div class="line"></div>
...
<div class="line">    <a class="code" href="a00078.php#ga9d1e76ee15a7dee158b786c30b6a6e38">hwloc_topology_t</a> topology;</div>
<div class="line">    <a class="code" href="a00075.php#ga4bbf39b68b6f568fb92739e7c0ea7801">hwloc_cpuset_t</a> <a class="code" href="a00038.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>;</div>
<div class="line">    <a class="code" href="a00038.php">hwloc_obj_t</a> obj;</div>
<div class="line"></div>
<div class="line">    <span class="comment">/* Allocate and initialize topology object. */</span></div>
<div class="line">    <a class="code" href="a00078.php#ga03fd4a16d8b9ee1ffc32b25fd2f6bdfa">hwloc_topology_init</a>(&amp;topology);</div>
<div class="line"></div>
...
<div class="line">    <a class="code" href="a00078.php#gabdf58d87ad77f6615fccdfe0535ff826">hwloc_topology_load</a>(topology);</div>
<div class="line"></div>
...
<div class="line">    topodepth = <a class="code" href="a00080.php#gafa4f8dbc4c2e74c0da8019446353eed1">hwloc_topology_get_depth</a>(topology);</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
...
<div class="line">        <span class="keywordflow">for</span> (i = 0; i &lt; <a class="code" href="a00080.php#gab17065e3d53455973844568d9f21c72c">hwloc_get_nbobjs_by_depth</a>(topology, depth); </div>
<div class="line">             i++) {</div>
<div class="line">            <a class="code" href="a00081.php#gadb8765c260edea80c52cd06a76639ba4">hwloc_obj_type_snprintf</a>(<span class="keywordtype">string</span>, <span class="keyword">sizeof</span>(<span class="keywordtype">string</span>),</div>
<div class="line">                                    <a class="code" href="a00080.php#gabf8a98ad085460a4982cc7b74c344b71">hwloc_get_obj_by_depth</a>(topology, depth, i), 0);</div>
...
<div class="line">    print_children(topology, <a class="code" href="a00080.php#ga2d4b12fc187dfc53b35f2fa21d21044d">hwloc_get_root_obj</a>(topology), 0);</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
...
<div class="line"><span class="comment">     *****************************************************************/</span></div>
<div class="line">    depth = <a class="code" href="a00080.php#ga8bec782e21be313750da70cf7428b374">hwloc_get_type_depth</a>(topology, <a class="code" href="a00076.php#ggacd37bb612667dc437d66bfb175a8dc55ab16ab8c0dbffc234921d86f3dfb63129">HWLOC_OBJ_PACKAGE</a>);</div>
<div class="line">    <span class="keywordflow">if</span> (depth == <a class="code" href="a00080.php#ggaf4e663cf42bbe20756b849c6293ef575a0565ab92ab72cb0cec91e23003294aad">HWLOC_TYPE_DEPTH_UNKNOWN</a>) {</div>
...
<div class="line">               <a class="code" href="a00080.php#gab17065e3d53455973844568d9f21c72c">hwloc_get_nbobjs_by_depth</a>(topology, depth));</div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
...
<div class="line">    <span class="keywordflow">for</span> (obj = <a class="code" href="a00080.php#ga6f414dd80a2b943967a0ac92da3181a2">hwloc_get_obj_by_type</a>(topology, <a class="code" href="a00076.php#ggacd37bb612667dc437d66bfb175a8dc55abca6887e80cb291353b0a0c1da83f661">HWLOC_OBJ_PU</a>, 0);</div>
<div class="line">         obj;</div>
<div class="line">         obj = obj-&gt;<a class="code" href="a00038.php#adc494f6aed939992be1c55cca5822900">parent</a>)</div>
<div class="line">      <span class="keywordflow">if</span> (obj-&gt;<a class="code" href="a00038.php#acc4f0803f244867e68fe0036800be5de">type</a> == <a class="code" href="a00076.php#ggacd37bb612667dc437d66bfb175a8dc55a56ee0b7eca88f363b75b34fdde8c9ddc">HWLOC_OBJ_CACHE</a>) {</div>
<div class="line">        levels++;</div>
<div class="line">        size += obj-&gt;<a class="code" href="a00038.php#accd40e29f71f19e88db62ea3df02adc8">attr</a>-&gt;<a class="code" href="a00039.php#ab5a8ae3bf490e6b1071fea53f7382836">cache</a>.<a class="code" href="a00033.php#abe5e788943ed04302976740c829674c0">size</a>;</div>
<div class="line">      }</div>
...
<div class="line"><span class="comment">     *****************************************************************/</span></div>
<div class="line">    depth = <a class="code" href="a00080.php#ga8125328e69eba709c33ea8055c12589b">hwloc_get_type_or_below_depth</a>(topology, <a class="code" href="a00076.php#ggacd37bb612667dc437d66bfb175a8dc55ac793958f330bca371aa1535de8aff45f">HWLOC_OBJ_CORE</a>);</div>
<div class="line"></div>
<div class="line">    <span class="comment">/* Get last core. */</span></div>
<div class="line">    obj = <a class="code" href="a00080.php#gabf8a98ad085460a4982cc7b74c344b71">hwloc_get_obj_by_depth</a>(topology, depth,</div>
<div class="line">                   <a class="code" href="a00080.php#gab17065e3d53455973844568d9f21c72c">hwloc_get_nbobjs_by_depth</a>(topology, depth) - 1);</div>
...
<div class="line">        cpuset = <a class="code" href="a00098.php#gae679434c1a5f41d3560a8a7e2c1b0dee">hwloc_bitmap_dup</a>(obj-&gt;<a class="code" href="a00038.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
<div class="line"></div>
...
<div class="line">        <a class="code" href="a00098.php#ga36d802130aa5d96bc1b5a90d2f0f3765">hwloc_bitmap_singlify</a>(cpuset);</div>
<div class="line"></div>
<div class="line">        <span class="comment">/* And try to bind ourself there. */</span></div>
<div class="line">        <span class="keywordflow">if</span> (<a class="code" href="a00082.php#ga80bc07473a8edf840cae17bd7ec21d48">hwloc_set_cpubind</a>(topology, cpuset, 0)) {</div>
<div class="line">            <span class="keywordtype">char</span> *str;</div>
<div class="line">            <span class="keywordtype">int</span> error = errno;</div>
<div class="line">            <a class="code" href="a00098.php#ga0fece972134fdecf2da9bc7a11dd827e">hwloc_bitmap_asprintf</a>(&amp;str, obj-&gt;<a class="code" href="a00038.php#a67925e0f2c47f50408fbdb9bddd0790f">cpuset</a>);</div>
...
<div class="line">        <a class="code" href="a00098.php#ga156130d85b3a0674d6e0e6770fe68fbe">hwloc_bitmap_free</a>(cpuset);</div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="comment">/*****************************************************************</span></div>
...
<div class="line">    n = <a class="code" href="a00080.php#ga789a3f65aedff644be64a18526a03065">hwloc_get_nbobjs_by_type</a>(topology, <a class="code" href="a00076.php#ggacd37bb612667dc437d66bfb175a8dc55a9d917a3e5497950c6d8948b8e183db5a">HWLOC_OBJ_NUMANODE</a>);</div>
...
<div class="line"></div>
<div class="line">        obj = <a class="code" href="a00080.php#ga6f414dd80a2b943967a0ac92da3181a2">hwloc_get_obj_by_type</a>(topology, <a class="code" href="a00076.php#ggacd37bb612667dc437d66bfb175a8dc55a9d917a3e5497950c6d8948b8e183db5a">HWLOC_OBJ_NUMANODE</a>, n - 1);</div>
<div class="line">        m = <a class="code" href="a00083.php#ga0ff3076f7f3633637699b809bcceceb1">hwloc_alloc_membind_nodeset</a>(topology, size, obj-&gt;<a class="code" href="a00038.php#a08f0d0e16c619a6e653526cbee4ffea3">nodeset</a>,</div>
...
<div class="line">        <a class="code" href="a00083.php#ga32dbd4f54e9e4a7179f2dde37ffe6ad7">hwloc_free</a>(topology, m, size);</div>
<div class="line"></div>
<div class="line">        m = malloc(size);</div>
<div class="line">        <a class="code" href="a00083.php#ga7f11bd709ac0cb93af613e2dd84165ad">hwloc_set_area_membind_nodeset</a>(topology, m, size, obj-&gt;<a class="code" href="a00038.php#a08f0d0e16c619a6e653526cbee4ffea3">nodeset</a>,</div>
<div class="line">                <a class="code" href="a00083.php#ggac9764f79505775d06407b40f5e4661e8ad811fa4b2a6002c4d63695a408ffde2c">HWLOC_MEMBIND_BIND</a>, 0);</div>
<div class="line">        free(m);</div>
<div class="line">    }</div>
<div class="line"></div>
<div class="line">    <span class="comment">/* Destroy topology object. */</span></div>
<div class="line">    <a class="code" href="a00078.php#ga9f34a640b6fd28d23699d4d084667b15">hwloc_topology_destroy</a>(topology);</div>
<div class="line"></div>
...
<li>
<a class="el" href="a00012.php">Miscellaneous objects</a> </li>
<li>
<a class="el" href="a00014.php">Multi-node Topologies</a> </li>
<li>
<a class="el" href="a00016.php">Object attributes</a> </li>
<li>
<a class="el" href="a00018.php">Importing and exporting topologies from/to XML files</a> </li>
<li>
<a class="el" href="a00020.php">Synthetic topologies</a> </li>
<li>
<a class="el" href="a00022.php">Interoperability With Other Software</a> </li>
<li>
<a class="el" href="a00024.php">Thread Safety</a> </li>
<li>
<a class="el" href="a00026.php">Components and plugins</a> </li>
<li>
<a class="el" href="a00028.php">Embedding hwloc in Other Software</a> </li>
<li>
<a class="el" href="a00030.php">Frequently Asked Questions</a> </li>
</ul>
