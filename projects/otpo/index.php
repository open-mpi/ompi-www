...
architectures through its runtime parameters. These parameters can be passed
...
<ul>
 <li> Supports for three different benchmarks for the tuning procedure
 ...
 optimization.</li>
 <li> abilit to interrupt an optimization run and resume it later on</li>
</ul>
</p>
